...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/trapeze/TRAPEZE-NETWORKS-TRAP-MIB
...
TrpzApSerialNum, TrpzRadioNum, TrpzApNum, TrpzApFailDetail, TrpzApServiceAvailability, TrpzApPortOrDapNum, TrpzRadioMimoState, TrpzRadioConfigState, TrpzApConnectSecurityType, TrpzAccessType, TrpzRssi, TrpzChannelNum, TrpzApFingerprint, TrpzApWasOperational, TrpzRadioChannelWidth, TrpzPowerLevel, TrpzRadioType, TrpzCryptoType, TrpzChannelChangeType, TrpzApTransition, TrpzRadioPowerChangeType, TrpzApAttachType, TrpzRadioMode, TrpzApRadioIndex = mibBuilder.importSymbols("TRAPEZE-NETWORKS-AP-TC", "TrpzApSerialNum", "TrpzRadioNum", "TrpzApNum", "TrpzApFailDetail", "TrpzApServiceAvailability", "TrpzApPortOrDapNum", "TrpzRadioMimoState", "TrpzRadioConfigState", "TrpzApConnectSecurityType", "TrpzAccessType", "TrpzRssi", "TrpzChannelNum", "TrpzApFingerprint", "TrpzApWasOperational", "TrpzRadioChannelWidth", "TrpzPowerLevel", "TrpzRadioType", "TrpzCryptoType", "TrpzChannelChangeType", "TrpzApTransition", "TrpzRadioPowerChangeType", "TrpzApAttachType", "TrpzRadioMode", "TrpzApRadioIndex")
...
TrpzClientDot1xState, TrpzClientAccessMode, TrpzClientAuthenProtocolType, TrpzClientDeviceGroupName, TrpzUserAccessType, TrpzClientDeviceType, TrpzClientDeviceProfileName, TrpzClientSessionState = mibBuilder.importSymbols("TRAPEZE-NETWORKS-CLIENT-SESSION-TC", "TrpzClientDot1xState", "TrpzClientAccessMode", "TrpzClientAuthenProtocolType", "TrpzClientDeviceGroupName", "TrpzUserAccessType", "TrpzClientDeviceType", "TrpzClientDeviceProfileName", "TrpzClientSessionState")
...
trpzMibs, trpzTraps, trpzTemporary = mibBuilder.importSymbols("TRAPEZE-NETWORKS-ROOT-MIB", "trpzMibs", "trpzTraps", "trpzTemporary")
...
mibBuilder.exportSymbols("TRAPEZE-NETWORKS-TRAP-MIB", trpzRFDetectSpoofedSsidAPTrap=trpzRFDetectSpoofedSsidAPTrap, trpzClientRoamedFromPhysPortNum=trpzClientRoamedFromPhysPortNum, TrpzAssociationFailureType=TrpzAssociationFailureType, trpzRFDetectUnAuthorizedAPTrap=trpzRFDetectUnAuthorizedAPTrap, trpzRFDetectAdhocUserTrap=trpzRFDetectAdhocUserTrap, trpzClientClearedTrap2=trpzClientClearedTrap2, trpzClientDeAuthenticationTrap2=trpzClientDeAuthenticationTrap2, trpzRFNoiseAge=trpzRFNoiseAge, trpzClientAuthenticationFailureTrap=trpzClientAuthenticationFailureTrap, trpzApName=trpzApName, trpzClientClearedReason=trpzClientClearedReason, trpzClientRoamedFromWsAddrType=trpzClientRoamedFromWsAddrType, trpzClientRoamedFromPortNum=trpzClientRoamedFromPortNum, trpzClientDynAuthorChangeSuccessTrap=trpzClientDynAuthorChangeSuccessTrap, trpzConfigSaveInitiatorType=trpzConfigSaveInitiatorType, trpzMobilityDomainIp=trpzMobilityDomainIp, trpzClientDeviceType=trpzClientDeviceType, trpzClientAuthenticationSuccessTrap=trpzClientAuthenticationSuccessTrap, trpzClientAuthorizationFailureCause=trpzClientAuthorizationFailureCause, trpzMobilityDomainResiliencyStatus=trpzMobilityDomainResiliencyStatus, trpzMultimediaRemoteStationPort=trpzMultimediaRemoteStationPort, trpzRFDetectRogueAPTrap=trpzRFDetectRogueAPTrap, trpzRFDetectSuspectDeviceDisappearTrap=trpzRFDetectSuspectDeviceDisappearTrap, trpzClientDeAuthenticationTrap=trpzClientDeAuthenticationTrap, trpzLocalId=trpzLocalId, trpzUserAccessType=trpzUserAccessType, trpzRFDetectXmtrCryptoType=trpzRFDetectXmtrCryptoType, trpzClientRoamedFromWsAddr=trpzClientRoamedFromWsAddr, trpzClientDeviceTypeChangeTrap=trpzClientDeviceTypeChangeTrap, trpzM2UMulticastAddr=trpzM2UMulticastAddr, trpzRFDetectClientViaRogueWiredAPTrap3=trpzRFDetectClientViaRogueWiredAPTrap3, trpzRadioBand=trpzRadioBand, trpzRFDetectClassificationChangeTrap=trpzRFDetectClassificationChangeTrap, trpzBlacklistingCause=trpzBlacklistingCause, trpzClientIpAddrChangeReason=trpzClientIpAddrChangeReason, trpzNumLicensedActiveAPs=trpzNumLicensedActiveAPs, trpzAutoTuneFailureReason=trpzAutoTuneFailureReason, trpzApFailDetail=trpzApFailDetail, trpzClientDeviceProfileName=trpzClientDeviceProfileName, trpzMultimediaRemoteStationEndpointID=trpzMultimediaRemoteStationEndpointID, trpzRadioMACAddress=trpzRadioMACAddress, trpzRadioSSID=trpzRadioSSID, trpzClientAuthorizationFailureTrap=trpzClientAuthorizationFailureTrap, trpzM2UConvNotPossibleTrap=trpzM2UConvNotPossibleTrap, trpzClientDot1xState=trpzClientDot1xState, trpzMpMichaelMICFailure2=trpzMpMichaelMICFailure2, trpzRFDetectSuspectDeviceTrap2=trpzRFDetectSuspectDeviceTrap2, trpzCounterMeasurePerformerListInfo=trpzCounterMeasurePerformerListInfo, trpzClientAssociationSuccessTrap=trpzClientAssociationSuccessTrap, trpzClientRoamingTrap=trpzClientRoamingTrap, trpzCounterMeasureStopTrap=trpzCounterMeasureStopTrap, trpzApWasOperational=trpzApWasOperational, trpzRadioMode=trpzRadioMode, trpzRFDetectInterferingRogueAPTrap=trpzRFDetectInterferingRogueAPTrap, trpzClientDisconnectTrap=trpzClientDisconnectTrap, trpzRFDetectBlacklistedTrap=trpzRFDetectBlacklistedTrap, trpzClientSessionState=trpzClientSessionState, trpzApMgrNewIp=trpzApMgrNewIp, trpzClientFailureCauseDescription=trpzClientFailureCauseDescription, trpzClientVLANName=trpzClientVLANName, trpzAutoTuneRadioChannelChangeTrap=trpzAutoTuneRadioChannelChangeTrap, trpzOldPowerLevel=trpzOldPowerLevel, trpzMobilityDomainFailBackTrap=trpzMobilityDomainFailBackTrap, trpzClientRoamedFromRadioNum=trpzClientRoamedFromRadioNum, TrpzClientDeviceProfileChangeReason=TrpzClientDeviceProfileChangeReason, trpzDeviceSerNum=trpzDeviceSerNum, trpzClientDot1xFailureTrap=trpzClientDot1xFailureTrap, trpzMultimediaSignalingProtocol=trpzMultimediaSignalingProtocol, trpzRFDetectUnAuthorizedOuiTrap=trpzRFDetectUnAuthorizedOuiTrap, TrpzWsTunnelLimitType=TrpzWsTunnelLimitType, trpzClientIpAddrChangeTrap=trpzClientIpAddrChangeTrap, trpzClientDynAuthorClientAddrType=trpzClientDynAuthorClientAddrType, TrpzMultimediaCallDirection=TrpzMultimediaCallDirection, trpzClientDeviceGroup=trpzClientDeviceGroup, trpzRFDetectDoSPortTrap=trpzRFDetectDoSPortTrap, trpzMultimediaLocalStationEndpointID=trpzMultimediaLocalStationEndpointID, trpzRFDetectRogueDeviceDisappearTrap=trpzRFDetectRogueDeviceDisappearTrap, trpzAPAccessType=trpzAPAccessType, TrpzClusterFailureReason=TrpzClusterFailureReason, trpzConfigSaveFileName=trpzConfigSaveFileName, trpzMultimediaCallDataRate=trpzMultimediaCallDataRate, trpzChannelChangeReason=trpzChannelChangeReason, trpzPhysPortNum=trpzPhysPortNum, trpzClientLocationPolicyIndex=trpzClientLocationPolicyIndex, trpzClientAssociationFailureTrap=trpzClientAssociationFailureTrap, trpzClusterFailureTrap=trpzClusterFailureTrap, TrpzApMgrChangeReason=TrpzApMgrChangeReason, trpzRFDetectClassificationReason=trpzRFDetectClassificationReason, trpzMobilityDomainResiliencyStatusTrap=trpzMobilityDomainResiliencyStatusTrap, trpzClientRoamedFromWsIp=trpzClientRoamedFromWsIp, trpzClientRoamedFromRadioIndex=trpzClientRoamedFromRadioIndex, trpzClientAuthServerIp=trpzClientAuthServerIp, trpzDeviceOkayTrap=trpzDeviceOkayTrap, TrpzConfigSaveInitiatorType=TrpzConfigSaveInitiatorType, trpzClientIPv4Addr=trpzClientIPv4Addr, TrpzClientClearedReason=TrpzClientClearedReason, trpzClientDeAssociationTrap2=trpzClientDeAssociationTrap2, trpzClientDeviceTypeOld=trpzClientDeviceTypeOld, TrpzDot1xFailureType=TrpzDot1xFailureType, trpzRadioConfigState=trpzRadioConfigState, trpzRFDetectClientViaRogueWiredAPTrap2=trpzRFDetectClientViaRogueWiredAPTrap2, trpzWsTunnelLimit=trpzWsTunnelLimit, TrpzUserAttributeList=TrpzUserAttributeList, TrpzAutoTuneFailureReason=TrpzAutoTuneFailureReason, trpzRFNoiseChannel=trpzRFNoiseChannel, trpzClientIPv6LinkLocalAddr=trpzClientIPv6LinkLocalAddr, trpzWsTunnelLimitExceededTrap=trpzWsTunnelLimitExceededTrap, trpzApTransition=trpzApTransition, trpzClientVLANtag=trpzClientVLANtag, trpzRFDetectRogueAPMacAddr=trpzRFDetectRogueAPMacAddr, trpzMultimediaCallDirection=trpzMultimediaCallDirection, trpzClientDeviceProfileChangeReason=trpzClientDeviceProfileChangeReason, trpzClientDisconnectDescription=trpzClientDisconnectDescription, trpzUserName=trpzUserName, trpzClientVLANid=trpzClientVLANid, trpzRFDetectDoSTrap=trpzRFDetectDoSTrap, trpzMultimediaCallFailureReason=trpzMultimediaCallFailureReason, trpzClientAuthorizationSuccessTrap4=trpzClientAuthorizationSuccessTrap4, trpzRFDetectListenerListInfo=trpzRFDetectListenerListInfo, trpzClientDisconnectSource=trpzClientDisconnectSource, trpzClientDynAuthorClientIp=trpzClientDynAuthorClientIp, trpzClientRoamedFromDAPNum=trpzClientRoamedFromDAPNum, trpzClientAccessType=trpzClientAccessType, trpzAutoTuneFailureTrap=trpzAutoTuneFailureTrap, trpzRFDetectXmtrMacAddr=trpzRFDetectXmtrMacAddr, trpzClientClearedTrap3=trpzClientClearedTrap3, trpzAutoTuneRadioPowerChangeTrap=trpzAutoTuneRadioPowerChangeTrap, TrpzMultimediaSignalingProtocol=TrpzMultimediaSignalingProtocol, trpzRFNoiseChannelInterferenceMeasure=trpzRFNoiseChannelInterferenceMeasure, trpzRFNoiseDutyCycle=trpzRFNoiseDutyCycle, trpzM2UMulticastAddrType=trpzM2UMulticastAddrType, trpzPortNum=trpzPortNum, trpzMichaelMICFailure=trpzMichaelMICFailure, trpzMobilityDomainJoinTrap=trpzMobilityDomainJoinTrap, trpzClientFailureCause=trpzClientFailureCause, trpzClientDynAuthorClientAddr=trpzClientDynAuthorClientAddr, trpzConfigurationSavedTrap=trpzConfigurationSavedTrap, trpzApOperRadioStatusTrap2=trpzApOperRadioStatusTrap2, trpzUserParams=trpzUserParams, trpzRFDetectRogueDeviceTrap=trpzRFDetectRogueDeviceTrap, trpzClientRoamedFromAccessMode=trpzClientRoamedFromAccessMode, trpzRadioChannelWidth=trpzRadioChannelWidth, trpzRadioType=trpzRadioType, trpzTrapsV2=trpzTrapsV2, trpzClientRoamingTrap2=trpzClientRoamingTrap2, TrpzM2UConvNotPossibleReason=TrpzM2UConvNotPossibleReason, trpzApNum=trpzApNum, trpzRFNoiseRssi=trpzRFNoiseRssi, TrpzMultimediaCallFailureReason=TrpzMultimediaCallFailureReason, trpzApPortOrDapNum=trpzApPortOrDapNum, trpzClientAuthorizationSuccessTrap5=trpzClientAuthorizationSuccessTrap5, trpzClientAuthorizationSuccessTrap2=trpzClientAuthorizationSuccessTrap2, TrpzClientIpAddrChangeReason=TrpzClientIpAddrChangeReason, TrpzAuthenticationFailureType=TrpzAuthenticationFailureType, trpzMultimediaCallBandwidthAndCodec=trpzMultimediaCallBandwidthAndCodec, trpzClientRoamedFromAccessType=trpzClientRoamedFromAccessType, trpzMobilityDomainSecondarySeedIp=trpzMobilityDomainSecondarySeedIp, trpzRFDetectSuspectDeviceTrap=trpzRFDetectSuspectDeviceTrap, trpzDeviceModel=trpzDeviceModel, trpzClientIpAddr=trpzClientIpAddr, trpzMultimediaRemoteStationIp=trpzMultimediaRemoteStationIp, trpzDAPConnectWarningTrap=trpzDAPConnectWarningTrap, trpzRFDetectInterferingRogueDisappearTrap=trpzRFDetectInterferingRogueDisappearTrap, TrpzAuthorizationFailureType=TrpzAuthorizationFailureType, trpzClientAuthenProtocolType=trpzClientAuthenProtocolType, trpzAPBootTrap=trpzAPBootTrap, TrpzSessionDisconnectType=TrpzSessionDisconnectType, trpzRadioMimoState=trpzRadioMimoState, TrpzMichaelMICFailureCause=TrpzMichaelMICFailureCause, trpzM2UConvAvailabilityRestoredTrap=trpzM2UConvAvailabilityRestoredTrap, trpzApConnectSecurityType=trpzApConnectSecurityType, PYSNMP_MODULE_ID=trpzTrapMib, trpzApServiceAvailability=trpzApServiceAvailability, trpzClientSessionElapsedTime=trpzClientSessionElapsedTime, trpzMobilityDomainPrimarySeedIp=trpzMobilityDomainPrimarySeedIp, trpzMichaelMICFailureCause=trpzMichaelMICFailureCause, trpzClientDeAssociationTrap=trpzClientDeAssociationTrap, trpzApRejectLicenseExceededTrap=trpzApRejectLicenseExceededTrap, trpzClientAuthorizationSuccessTrap3=trpzClientAuthorizationSuccessTrap3, trpzClientMACAddress2=trpzClientMACAddress2, trpzClientIpAddrChangeTrap2=trpzClientIpAddrChangeTrap2, trpzApTunnelLimit=trpzApTunnelLimit, trpzChangedUserParamNewValues=trpzChangedUserParamNewValues, trpzClientAuthServerAddr=trpzClientAuthServerAddr, trpzClientClearedTrap=trpzClientClearedTrap, trpzApNonOperStatusTrap2=trpzApNonOperStatusTrap2, trpzRFDetectRogueDeviceTrap2=trpzRFDetectRogueDeviceTrap2, trpzDAPNum=trpzDAPNum, trpzMobilityDomainFailOverTrap=trpzMobilityDomainFailOverTrap, trpzNewChannelNum=trpzNewChannelNum, trpzRFDetectRogueDisappearTrap=trpzRFDetectRogueDisappearTrap, trpzApTunnelLimitExceededTrap=trpzApTunnelLimitExceededTrap, trpzClientDisconnectTrap2=trpzClientDisconnectTrap2, trpzApOperRadioStatusTrap3=trpzApOperRadioStatusTrap3, TrpzBlacklistingCause=TrpzBlacklistingCause, trpzChangedUserParamOldValues=trpzChangedUserParamOldValues, trpzApRadioIndex=trpzApRadioIndex, TrpzMobilityDomainResiliencyStatus=TrpzMobilityDomainResiliencyStatus, trpzApAttachType=trpzApAttachType, trpzMultimediaCallRssi=trpzMultimediaCallRssi, trpzDeviceFailTrap=trpzDeviceFailTrap, trpzMobilityDomainTimeoutTrap=trpzMobilityDomainTimeoutTrap, trpzBlacklistingRemainingTime=trpzBlacklistingRemainingTime, trpzApManagerChangeTrap=trpzApManagerChangeTrap, trpzClientDynAuthorChangeSuccessTrap2=trpzClientDynAuthorChangeSuccessTrap2, trpzRFNoiseSourceType=trpzRFNoiseSourceType, trpzRFDetectAdhocUserDisappearTrap=trpzRFDetectAdhocUserDisappearTrap, trpzAutoTuneSuccessTrap=trpzAutoTuneSuccessTrap, trpzClientDot1xFailureCause=trpzClientDot1xFailureCause, trpzRadioPowerChangeReason=trpzRadioPowerChangeReason, trpzPoEFailTrap=trpzPoEFailTrap, trpzRadiosTunedCount=trpzRadiosTunedCount, trpzSourceWsIp=trpzSourceWsIp, TrpzClientAuthorizationReason=TrpzClientAuthorizationReason, trpzMultimediaCommunicationServerID=trpzMultimediaCommunicationServerID, trpzRsaPubKeyFingerPrint=trpzRsaPubKeyFingerPrint, trpzApMgrOldIp=trpzApMgrOldIp, TrpzRadioBand=TrpzRadioBand, trpzConfigSaveGeneration=trpzConfigSaveGeneration, trpzRFNoiseSourceID=trpzRFNoiseSourceID, trpzClientAuthorizationSuccessTrap=trpzClientAuthorizationSuccessTrap, trpzClientDynAuthorChangeFailureTrap=trpzClientDynAuthorChangeFailureTrap, trpzClientAuthorizationReason=trpzClientAuthorizationReason, trpzMultimediaLocalStationPort=trpzMultimediaLocalStationPort, trpzApNonOperStatusTrap=trpzApNonOperStatusTrap, trpzM2UConvNotPossibleReason=trpzM2UConvNotPossibleReason, trpzClientRoamedFromApNum=trpzClientRoamedFromApNum, trpzRFDetectUnAuthorizedSsidTrap=trpzRFDetectUnAuthorizedSsidTrap, trpzClientAssociationFailureCause=trpzClientAssociationFailureCause, trpzClientTimeSinceLastRoam=trpzClientTimeSinceLastRoam, trpzConfigSaveInitiatorIp=trpzConfigSaveInitiatorIp, trpzRFDetectXmtrRadioType=trpzRFDetectXmtrRadioType, trpzClientDeviceProfileNameOld=trpzClientDeviceProfileNameOld, trpzOldChannelNum=trpzOldChannelNum, trpzClientAccessMode=trpzClientAccessMode, trpzRadioPowerChangeDescription=trpzRadioPowerChangeDescription, trpzRFDetectSpoofedMacAPTrap=trpzRFDetectSpoofedMacAPTrap, trpzClientSessionElapsedSeconds=trpzClientSessionElapsedSeconds, trpzClusterFailureDescription=trpzClusterFailureDescription, trpzNewPowerLevel=trpzNewPowerLevel, trpzMpMichaelMICFailure=trpzMpMichaelMICFailure, trpzMultimediaLocalStationIp=trpzMultimediaLocalStationIp, trpzClientSessionId=trpzClientSessionId, trpzClusterFailureReason=trpzClusterFailureReason, trpzRFDetectClientViaRogueWiredAPTrap=trpzRFDetectClientViaRogueWiredAPTrap, trpzRFDetectDoSType=trpzRFDetectDoSType, trpzApOperRadioStatusTrap=trpzApOperRadioStatusTrap, trpzTrapMib=trpzTrapMib, trpzClientAuthServerAddrType=trpzClientAuthServerAddrType, trpzCounterMeasureStartTrap=trpzCounterMeasureStartTrap, trpzRFNoiseSourceTrap=trpzRFNoiseSourceTrap, trpzClientSessionStartTime=trpzClientSessionStartTime, trpzRadioBSSID=trpzRadioBSSID, trpzApTimeoutTrap=trpzApTimeoutTrap)
mibBuilder.exportSymbols("TRAPEZE-NETWORKS-TRAP-MIB", trpzDAPconnectWarningType=trpzDAPconnectWarningType, trpzClientDeviceProfileChangeTrap=trpzClientDeviceProfileChangeTrap, trpzClientMACAddress=trpzClientMACAddress, trpzRadioRssi=trpzRadioRssi, trpzClientAuthenticationFailureCause=trpzClientAuthenticationFailureCause, trpzConfigSaveInitiatorDetails=trpzConfigSaveInitiatorDetails, trpzClientIpAddrType=trpzClientIpAddrType, trpzAPRadioNum=trpzAPRadioNum, trpzClientIp=trpzClientIp, trpzApMgrChangeReason=trpzApMgrChangeReason, trpzAPMACAddress=trpzAPMACAddress, trpzWsTunnelLimitType=trpzWsTunnelLimitType, trpzClientRadioType=trpzClientRadioType, TrpzRFDetectDoSType=TrpzRFDetectDoSType, trpzMultimediaCallFailureTrap=trpzMultimediaCallFailureTrap, trpzDeviceId=trpzDeviceId)
