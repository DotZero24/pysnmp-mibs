...
TrpzApNum, TrpzApTransition, TrpzApServiceAvailability, TrpzApRadioIndex, TrpzApAttachType, TrpzRadioMimoState, TrpzRadioPowerChangeType, TrpzCryptoType, TrpzChannelNum, TrpzRssi, TrpzRadioType, TrpzPowerLevel, TrpzApPortOrDapNum, TrpzRadioChannelWidth, TrpzRadioConfigState, TrpzRadioMode, TrpzApFailDetail, TrpzChannelChangeType, TrpzApSerialNum, TrpzApFingerprint, TrpzApConnectSecurityType, TrpzApWasOperational, TrpzRadioNum, TrpzAccessType = mibBuilder.importSymbols("TRAPEZE-NETWORKS-AP-TC", "TrpzApNum", "TrpzApTransition", "TrpzApServiceAvailability", "TrpzApRadioIndex", "TrpzApAttachType", "TrpzRadioMimoState", "TrpzRadioPowerChangeType", "TrpzCryptoType", "TrpzChannelNum", "TrpzRssi", "TrpzRadioType", "TrpzPowerLevel", "TrpzApPortOrDapNum", "TrpzRadioChannelWidth", "TrpzRadioConfigState", "TrpzRadioMode", "TrpzApFailDetail", "TrpzChannelChangeType", "TrpzApSerialNum", "TrpzApFingerprint", "TrpzApConnectSecurityType", "TrpzApWasOperational", "TrpzRadioNum", "TrpzAccessType")
...
trpzMibs, trpzTemporary, trpzTraps = mibBuilder.importSymbols("TRAPEZE-NETWORKS-ROOT-MIB", "trpzMibs", "trpzTemporary", "trpzTraps")
...
mibBuilder.exportSymbols("TRAPEZE-NETWORKS-TRAP-MIB", trpzClientAuthorizationFailureCause=trpzClientAuthorizationFailureCause, trpzRFDetectRogueDeviceDisappearTrap=trpzRFDetectRogueDeviceDisappearTrap, trpzMultimediaLocalStationEndpointID=trpzMultimediaLocalStationEndpointID, TrpzAssociationFailureType=TrpzAssociationFailureType, trpzClientDot1xFailureCause=trpzClientDot1xFailureCause, trpzRadioConfigState=trpzRadioConfigState, trpzApPortOrDapNum=trpzApPortOrDapNum, trpzBlacklistingCause=trpzBlacklistingCause, trpzWsTunnelLimitType=trpzWsTunnelLimitType, trpzApConnectSecurityType=trpzApConnectSecurityType, trpzClientSessionId=trpzClientSessionId, trpzClientLocationPolicyIndex=trpzClientLocationPolicyIndex, trpzOldChannelNum=trpzOldChannelNum, TrpzUserAttributeList=TrpzUserAttributeList, trpzRFNoiseChannelInterferenceMeasure=trpzRFNoiseChannelInterferenceMeasure, trpzClientSessionStartTime=trpzClientSessionStartTime, trpzClientDeviceProfileChangeReason=trpzClientDeviceProfileChangeReason, trpzRadioSSID=trpzRadioSSID, trpzRadioChannelWidth=trpzRadioChannelWidth, trpzRFNoiseChannel=trpzRFNoiseChannel, trpzClientVLANName=trpzClientVLANName, trpzMultimediaCallDirection=trpzMultimediaCallDirection, trpzM2UMulticastAddr=trpzM2UMulticastAddr, trpzMichaelMICFailureCause=trpzMichaelMICFailureCause, TrpzClientClearedReason=TrpzClientClearedReason, trpzClientSessionState=trpzClientSessionState, trpzRFDetectUnAuthorizedAPTrap=trpzRFDetectUnAuthorizedAPTrap, trpzTrapMib=trpzTrapMib, trpzMultimediaCallDataRate=trpzMultimediaCallDataRate, trpzRadioPowerChangeDescription=trpzRadioPowerChangeDescription, trpzClientRoamedFromRadioIndex=trpzClientRoamedFromRadioIndex, trpzRFDetectSuspectDeviceTrap=trpzRFDetectSuspectDeviceTrap, trpzClientDisconnectDescription=trpzClientDisconnectDescription, trpzMultimediaLocalStationIp=trpzMultimediaLocalStationIp, trpzRFDetectUnAuthorizedSsidTrap=trpzRFDetectUnAuthorizedSsidTrap, TrpzAuthenticationFailureType=TrpzAuthenticationFailureType, trpzMultimediaCallRssi=trpzMultimediaCallRssi, trpzClientIpAddr=trpzClientIpAddr, trpzApManagerChangeTrap=trpzApManagerChangeTrap, trpzClientDeAuthenticationTrap=trpzClientDeAuthenticationTrap, trpzRFDetectClassificationReason=trpzRFDetectClassificationReason, trpzRFDetectXmtrRadioType=trpzRFDetectXmtrRadioType, trpzClientAuthorizationSuccessTrap5=trpzClientAuthorizationSuccessTrap5, trpzRadioBand=trpzRadioBand, trpzMobilityDomainTimeoutTrap=trpzMobilityDomainTimeoutTrap, TrpzDot1xFailureType=TrpzDot1xFailureType, trpzPoEFailTrap=trpzPoEFailTrap, trpzRFDetectClientViaRogueWiredAPTrap=trpzRFDetectClientViaRogueWiredAPTrap, trpzRFDetectRogueDeviceTrap2=trpzRFDetectRogueDeviceTrap2, trpzAutoTuneSuccessTrap=trpzAutoTuneSuccessTrap, trpzRadioRssi=trpzRadioRssi, trpzUserAccessType=trpzUserAccessType, trpzCounterMeasureStopTrap=trpzCounterMeasureStopTrap, trpzClientAuthServerAddrType=trpzClientAuthServerAddrType, trpzRadioMimoState=trpzRadioMimoState, trpzWsTunnelLimit=trpzWsTunnelLimit, trpzMultimediaRemoteStationPort=trpzMultimediaRemoteStationPort, trpzChannelChangeReason=trpzChannelChangeReason, trpzMobilityDomainSecondarySeedIp=trpzMobilityDomainSecondarySeedIp, trpzDeviceSerNum=trpzDeviceSerNum, trpzClientFailureCauseDescription=trpzClientFailureCauseDescription, TrpzM2UConvNotPossibleReason=TrpzM2UConvNotPossibleReason, trpzRadioMACAddress=trpzRadioMACAddress, trpzRFDetectXmtrCryptoType=trpzRFDetectXmtrCryptoType, trpzClientRoamedFromPhysPortNum=trpzClientRoamedFromPhysPortNum, trpzClientDeviceType=trpzClientDeviceType, trpzMultimediaSignalingProtocol=trpzMultimediaSignalingProtocol, trpzClientIp=trpzClientIp, trpzM2UConvNotPossibleTrap=trpzM2UConvNotPossibleTrap, trpzClientIpAddrChangeTrap2=trpzClientIpAddrChangeTrap2, trpzClientRoamedFromApNum=trpzClientRoamedFromApNum, trpzClientDynAuthorClientAddr=trpzClientDynAuthorClientAddr, trpzClusterFailureDescription=trpzClusterFailureDescription, trpzClientRoamingTrap=trpzClientRoamingTrap, trpzRFDetectDoSTrap=trpzRFDetectDoSTrap, trpzMultimediaLocalStationPort=trpzMultimediaLocalStationPort, trpzMpMichaelMICFailure=trpzMpMichaelMICFailure, TrpzMichaelMICFailureCause=TrpzMichaelMICFailureCause, trpzClientAuthenticationFailureTrap=trpzClientAuthenticationFailureTrap, TrpzClientIpAddrChangeReason=TrpzClientIpAddrChangeReason, trpzClientAuthorizationFailureTrap=trpzClientAuthorizationFailureTrap, trpzRadioMode=trpzRadioMode, trpzAutoTuneRadioPowerChangeTrap=trpzAutoTuneRadioPowerChangeTrap, trpzRFDetectClientViaRogueWiredAPTrap3=trpzRFDetectClientViaRogueWiredAPTrap3, trpzClientDeviceProfileChangeTrap=trpzClientDeviceProfileChangeTrap, trpzClusterFailureReason=trpzClusterFailureReason, trpzClientRoamingTrap2=trpzClientRoamingTrap2, trpzClientClearedTrap=trpzClientClearedTrap, TrpzMobilityDomainResiliencyStatus=TrpzMobilityDomainResiliencyStatus, trpzConfigSaveInitiatorType=trpzConfigSaveInitiatorType, trpzClientDeAssociationTrap=trpzClientDeAssociationTrap, trpzPortNum=trpzPortNum, trpzClientDeviceTypeChangeTrap=trpzClientDeviceTypeChangeTrap, trpzPhysPortNum=trpzPhysPortNum, trpzAPMACAddress=trpzAPMACAddress, trpzRFDetectInterferingRogueDisappearTrap=trpzRFDetectInterferingRogueDisappearTrap, trpzAutoTuneRadioChannelChangeTrap=trpzAutoTuneRadioChannelChangeTrap, trpzApNum=trpzApNum, trpzClientRoamedFromWsAddr=trpzClientRoamedFromWsAddr, trpzDeviceOkayTrap=trpzDeviceOkayTrap, trpzClientDeAssociationTrap2=trpzClientDeAssociationTrap2, trpzNewPowerLevel=trpzNewPowerLevel, TrpzMultimediaCallFailureReason=TrpzMultimediaCallFailureReason, trpzClientAssociationFailureCause=trpzClientAssociationFailureCause, TrpzClientDeviceProfileChangeReason=TrpzClientDeviceProfileChangeReason, trpzRadioBSSID=trpzRadioBSSID, trpzApRejectLicenseExceededTrap=trpzApRejectLicenseExceededTrap, trpzClientDynAuthorClientAddrType=trpzClientDynAuthorClientAddrType, trpzApAttachType=trpzApAttachType, trpzConfigSaveInitiatorDetails=trpzConfigSaveInitiatorDetails, trpzDAPConnectWarningTrap=trpzDAPConnectWarningTrap, trpzDeviceModel=trpzDeviceModel, trpzApName=trpzApName, trpzRFNoiseAge=trpzRFNoiseAge, trpzRFDetectSpoofedSsidAPTrap=trpzRFDetectSpoofedSsidAPTrap, trpzClientRadioType=trpzClientRadioType, TrpzMultimediaCallDirection=TrpzMultimediaCallDirection, trpzClientRoamedFromAccessType=trpzClientRoamedFromAccessType, trpzClientAccessMode=trpzClientAccessMode, trpzCounterMeasureStartTrap=trpzCounterMeasureStartTrap, trpzRFDetectInterferingRogueAPTrap=trpzRFDetectInterferingRogueAPTrap, trpzClientAuthorizationSuccessTrap2=trpzClientAuthorizationSuccessTrap2, trpzApTransition=trpzApTransition, trpzClientDisconnectSource=trpzClientDisconnectSource, trpzApMgrNewIp=trpzApMgrNewIp, trpzClientAuthenProtocolType=trpzClientAuthenProtocolType, trpzClientAuthServerIp=trpzClientAuthServerIp, trpzClusterFailureTrap=trpzClusterFailureTrap, trpzApTunnelLimit=trpzApTunnelLimit, trpzM2UConvAvailabilityRestoredTrap=trpzM2UConvAvailabilityRestoredTrap, trpzClientRoamedFromAccessMode=trpzClientRoamedFromAccessMode, trpzRFNoiseSourceTrap=trpzRFNoiseSourceTrap, trpzClientSessionElapsedSeconds=trpzClientSessionElapsedSeconds, trpzApFailDetail=trpzApFailDetail, trpzClientDeAuthenticationTrap2=trpzClientDeAuthenticationTrap2, trpzClientDynAuthorChangeSuccessTrap2=trpzClientDynAuthorChangeSuccessTrap2, trpzClientRoamedFromWsIp=trpzClientRoamedFromWsIp, TrpzClientAuthorizationReason=TrpzClientAuthorizationReason, trpzClientAuthServerAddr=trpzClientAuthServerAddr, trpzClientDeviceTypeOld=trpzClientDeviceTypeOld, trpzClientVLANid=trpzClientVLANid, trpzClientRoamedFromPortNum=trpzClientRoamedFromPortNum, trpzClientAccessType=trpzClientAccessType, PYSNMP_MODULE_ID=trpzTrapMib, TrpzRadioBand=TrpzRadioBand, trpzM2UConvNotPossibleReason=trpzM2UConvNotPossibleReason, trpzClientAuthenticationSuccessTrap=trpzClientAuthenticationSuccessTrap, trpzConfigSaveGeneration=trpzConfigSaveGeneration, trpzMultimediaRemoteStationEndpointID=trpzMultimediaRemoteStationEndpointID, trpzRFNoiseSourceID=trpzRFNoiseSourceID, trpzAPRadioNum=trpzAPRadioNum, trpzClientDeviceProfileName=trpzClientDeviceProfileName, trpzMobilityDomainFailBackTrap=trpzMobilityDomainFailBackTrap, trpzBlacklistingRemainingTime=trpzBlacklistingRemainingTime, TrpzRFDetectDoSType=TrpzRFDetectDoSType, TrpzClusterFailureReason=TrpzClusterFailureReason, TrpzSessionDisconnectType=TrpzSessionDisconnectType, trpzOldPowerLevel=trpzOldPowerLevel, trpzRFDetectRogueAPMacAddr=trpzRFDetectRogueAPMacAddr, trpzDeviceId=trpzDeviceId, TrpzWsTunnelLimitType=TrpzWsTunnelLimitType, trpzConfigurationSavedTrap=trpzConfigurationSavedTrap, trpzApNonOperStatusTrap=trpzApNonOperStatusTrap, trpzClientIPv6LinkLocalAddr=trpzClientIPv6LinkLocalAddr, trpzUserName=trpzUserName, trpzRadioType=trpzRadioType, trpzMultimediaRemoteStationIp=trpzMultimediaRemoteStationIp, trpzApTimeoutTrap=trpzApTimeoutTrap, trpzMobilityDomainResiliencyStatusTrap=trpzMobilityDomainResiliencyStatusTrap, trpzApOperRadioStatusTrap=trpzApOperRadioStatusTrap, trpzApNonOperStatusTrap2=trpzApNonOperStatusTrap2, trpzRFDetectRogueAPTrap=trpzRFDetectRogueAPTrap, trpzClientTimeSinceLastRoam=trpzClientTimeSinceLastRoam, trpzDeviceFailTrap=trpzDeviceFailTrap, trpzClientClearedTrap3=trpzClientClearedTrap3, trpzMultimediaCallFailureTrap=trpzMultimediaCallFailureTrap, trpzClientClearedReason=trpzClientClearedReason, trpzClientRoamedFromRadioNum=trpzClientRoamedFromRadioNum, trpzDAPconnectWarningType=trpzDAPconnectWarningType, trpzApServiceAvailability=trpzApServiceAvailability, trpzMobilityDomainPrimarySeedIp=trpzMobilityDomainPrimarySeedIp, trpzRFDetectClientViaRogueWiredAPTrap2=trpzRFDetectClientViaRogueWiredAPTrap2, trpzClientAuthorizationSuccessTrap3=trpzClientAuthorizationSuccessTrap3, trpzClientAssociationSuccessTrap=trpzClientAssociationSuccessTrap, trpzRFDetectSuspectDeviceDisappearTrap=trpzRFDetectSuspectDeviceDisappearTrap, trpzClientDeviceGroup=trpzClientDeviceGroup, trpzClientFailureCause=trpzClientFailureCause, trpzNumLicensedActiveAPs=trpzNumLicensedActiveAPs, trpzApMgrOldIp=trpzApMgrOldIp, trpzRFDetectDoSType=trpzRFDetectDoSType, trpzLocalId=trpzLocalId, trpzAPAccessType=trpzAPAccessType, trpzChangedUserParamNewValues=trpzChangedUserParamNewValues, trpzRFNoiseSourceType=trpzRFNoiseSourceType, trpzRadiosTunedCount=trpzRadiosTunedCount, trpzSourceWsIp=trpzSourceWsIp, trpzMobilityDomainFailOverTrap=trpzMobilityDomainFailOverTrap, trpzClientDynAuthorChangeSuccessTrap=trpzClientDynAuthorChangeSuccessTrap, trpzClientDynAuthorChangeFailureTrap=trpzClientDynAuthorChangeFailureTrap, trpzClientAuthenticationFailureCause=trpzClientAuthenticationFailureCause, TrpzBlacklistingCause=TrpzBlacklistingCause, trpzChangedUserParamOldValues=trpzChangedUserParamOldValues, trpzClientIpAddrType=trpzClientIpAddrType, trpzClientClearedTrap2=trpzClientClearedTrap2, trpzClientSessionElapsedTime=trpzClientSessionElapsedTime, TrpzMultimediaSignalingProtocol=TrpzMultimediaSignalingProtocol, TrpzConfigSaveInitiatorType=TrpzConfigSaveInitiatorType, trpzRFNoiseRssi=trpzRFNoiseRssi, trpzClientDot1xState=trpzClientDot1xState, TrpzAutoTuneFailureReason=TrpzAutoTuneFailureReason, trpzClientRoamedFromDAPNum=trpzClientRoamedFromDAPNum, trpzClientAssociationFailureTrap=trpzClientAssociationFailureTrap, trpzClientAuthorizationSuccessTrap4=trpzClientAuthorizationSuccessTrap4, trpzRsaPubKeyFingerPrint=trpzRsaPubKeyFingerPrint, trpzApOperRadioStatusTrap2=trpzApOperRadioStatusTrap2, trpzClientVLANtag=trpzClientVLANtag, trpzMobilityDomainResiliencyStatus=trpzMobilityDomainResiliencyStatus, trpzClientIPv4Addr=trpzClientIPv4Addr, trpzClientAuthorizationReason=trpzClientAuthorizationReason, trpzAutoTuneFailureReason=trpzAutoTuneFailureReason, trpzRFDetectAdhocUserDisappearTrap=trpzRFDetectAdhocUserDisappearTrap, trpzRFDetectRogueDeviceTrap=trpzRFDetectRogueDeviceTrap, trpzRFNoiseDutyCycle=trpzRFNoiseDutyCycle, trpzAutoTuneFailureTrap=trpzAutoTuneFailureTrap, trpzClientRoamedFromWsAddrType=trpzClientRoamedFromWsAddrType, trpzRFDetectSpoofedMacAPTrap=trpzRFDetectSpoofedMacAPTrap, trpzClientAuthorizationSuccessTrap=trpzClientAuthorizationSuccessTrap, trpzClientIpAddrChangeReason=trpzClientIpAddrChangeReason, trpzWsTunnelLimitExceededTrap=trpzWsTunnelLimitExceededTrap, trpzUserParams=trpzUserParams, trpzConfigSaveFileName=trpzConfigSaveFileName, trpzMultimediaCallBandwidthAndCodec=trpzMultimediaCallBandwidthAndCodec, trpzApRadioIndex=trpzApRadioIndex, trpzNewChannelNum=trpzNewChannelNum, trpzM2UMulticastAddrType=trpzM2UMulticastAddrType, trpzMultimediaCommunicationServerID=trpzMultimediaCommunicationServerID, trpzClientMACAddress=trpzClientMACAddress, trpzApWasOperational=trpzApWasOperational, trpzMultimediaCallFailureReason=trpzMultimediaCallFailureReason, trpzMobilityDomainIp=trpzMobilityDomainIp, trpzRFDetectRogueDisappearTrap=trpzRFDetectRogueDisappearTrap, trpzClientDot1xFailureTrap=trpzClientDot1xFailureTrap, trpzTrapsV2=trpzTrapsV2, trpzRFDetectXmtrMacAddr=trpzRFDetectXmtrMacAddr, trpzRFDetectUnAuthorizedOuiTrap=trpzRFDetectUnAuthorizedOuiTrap, trpzClientDynAuthorClientIp=trpzClientDynAuthorClientIp, trpzRFDetectAdhocUserTrap=trpzRFDetectAdhocUserTrap, TrpzApMgrChangeReason=TrpzApMgrChangeReason, trpzClientIpAddrChangeTrap=trpzClientIpAddrChangeTrap, trpzRFDetectSuspectDeviceTrap2=trpzRFDetectSuspectDeviceTrap2, TrpzAuthorizationFailureType=TrpzAuthorizationFailureType, trpzRFDetectListenerListInfo=trpzRFDetectListenerListInfo, trpzApOperRadioStatusTrap3=trpzApOperRadioStatusTrap3, trpzMpMichaelMICFailure2=trpzMpMichaelMICFailure2)
mibBuilder.exportSymbols("TRAPEZE-NETWORKS-TRAP-MIB", trpzDAPNum=trpzDAPNum, trpzRFDetectBlacklistedTrap=trpzRFDetectBlacklistedTrap, trpzMichaelMICFailure=trpzMichaelMICFailure, trpzCounterMeasurePerformerListInfo=trpzCounterMeasurePerformerListInfo, trpzConfigSaveInitiatorIp=trpzConfigSaveInitiatorIp, trpzAPBootTrap=trpzAPBootTrap, trpzClientMACAddress2=trpzClientMACAddress2, trpzApTunnelLimitExceededTrap=trpzApTunnelLimitExceededTrap, trpzMobilityDomainJoinTrap=trpzMobilityDomainJoinTrap, trpzClientDisconnectTrap2=trpzClientDisconnectTrap2, trpzRFDetectClassificationChangeTrap=trpzRFDetectClassificationChangeTrap, trpzApMgrChangeReason=trpzApMgrChangeReason, trpzRFDetectDoSPortTrap=trpzRFDetectDoSPortTrap, trpzClientDisconnectTrap=trpzClientDisconnectTrap, trpzRadioPowerChangeReason=trpzRadioPowerChangeReason, trpzClientDeviceProfileNameOld=trpzClientDeviceProfileNameOld)
