...
rndBootPServerAddress=_RndBootPServerAddress_Object((1,3,6,1,4,1,89,24,1),_RndBootPServerAddress_Type())
...
rndBootPRelaySecThreshold=_RndBootPRelaySecThreshold_Object((1,3,6,1,4,1,89,24,2),_RndBootPRelaySecThreshold_Type())
...
rndBootPActionTable=_RndBootPActionTable_Object((1,3,6,1,4,1,89,24,3))
if mibBuilder.loadTexts:rndBootPActionTable.setStatus(_A)
_RndBootPActionEntry_Object=MibTableRow
rndBootPActionEntry=_RndBootPActionEntry_Object((1,3,6,1,4,1,89,24,3,1))
...
rndBootPActionIfIndex=_RndBootPActionIfIndex_Object((1,3,6,1,4,1,89,24,3,1,1),_RndBootPActionIfIndex_Type())
...
rndBootPActionStatus=_RndBootPActionStatus_Object((1,3,6,1,4,1,89,24,3,1,2),_RndBootPActionStatus_Type())
...
rndBootPActionHostName=_RndBootPActionHostName_Object((1,3,6,1,4,1,89,24,3,1,3),_RndBootPActionHostName_Type())
