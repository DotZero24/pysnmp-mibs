_g='colubrisPublicAccessRetentionNotificationGroup'
_f='colubrisPublicAccessRetentionPeriodicStatsMIBGroup'
_e='colubrisPublicAccessRetentionSessionsMIBGroup'
...
_D='Integer32'
_C='read-only'
_B='COLUBRIS-PUBLIC-ACCESS-RETENTION-MIB'
_A='current'
...
colubrisPublicAccessRetentionMIBObjects=_ColubrisPublicAccessRetentionMIBObjects_ObjectIdentity((1,3,6,1,4,1,8744,5,15,1))
_PublicAccessRetentionSessionsGroup_ObjectIdentity=ObjectIdentity
publicAccessRetentionSessionsGroup=_PublicAccessRetentionSessionsGroup_ObjectIdentity((1,3,6,1,4,1,8744,5,15,1,1))
...
publicAccessRetentionSessionsMaxCount=_PublicAccessRetentionSessionsMaxCount_Object((1,3,6,1,4,1,8744,5,15,1,1,1),_PublicAccessRetentionSessionsMaxCount_Type())
...
publicAccessRetentionSessionsMaxTime=_PublicAccessRetentionSessionsMaxTime_Object((1,3,6,1,4,1,8744,5,15,1,1,2),_PublicAccessRetentionSessionsMaxTime_Type())
...
publicAccessRetentionSessionTable=_PublicAccessRetentionSessionTable_Object((1,3,6,1,4,1,8744,5,15,1,1,3))
...
publicAccessRetentionSessionEntry=_PublicAccessRetentionSessionEntry_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1))
...
publicAccessRetentionSessionIndex=_PublicAccessRetentionSessionIndex_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,1),_PublicAccessRetentionSessionIndex_Type())
...
publicAccessRetentionSessionState=_PublicAccessRetentionSessionState_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,2),_PublicAccessRetentionSessionState_Type())
...
publicAccessRetentionSessionUserName=_PublicAccessRetentionSessionUserName_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,3),_PublicAccessRetentionSessionUserName_Type())
...
publicAccessRetentionSessionStartTime=_PublicAccessRetentionSessionStartTime_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,4),_PublicAccessRetentionSessionStartTime_Type())
...
publicAccessRetentionSessionDuration=_PublicAccessRetentionSessionDuration_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,5),_PublicAccessRetentionSessionDuration_Type())
...
publicAccessRetentionSessionStationIpAddress=_PublicAccessRetentionSessionStationIpAddress_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,6),_PublicAccessRetentionSessionStationIpAddress_Type())
...
publicAccessRetentionSessionPacketsSent=_PublicAccessRetentionSessionPacketsSent_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,7),_PublicAccessRetentionSessionPacketsSent_Type())
...
publicAccessRetentionSessionPacketsReceived=_PublicAccessRetentionSessionPacketsReceived_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,8),_PublicAccessRetentionSessionPacketsReceived_Type())
...
publicAccessRetentionSessionBytesSent=_PublicAccessRetentionSessionBytesSent_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,9),_PublicAccessRetentionSessionBytesSent_Type())
...
publicAccessRetentionSessionBytesReceived=_PublicAccessRetentionSessionBytesReceived_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,10),_PublicAccessRetentionSessionBytesReceived_Type())
...
publicAccessRetentionSessionSSID=_PublicAccessRetentionSessionSSID_Object((1,3,6,1,4,1,8744,5,15,1,1,3,1,11),_PublicAccessRetentionSessionSSID_Type())
...
publicAccessRetentionPeriodicStatsGroup=_PublicAccessRetentionPeriodicStatsGroup_ObjectIdentity((1,3,6,1,4,1,8744,5,15,1,2))
...
publicAccessRetentionPeriodicStatsMaxCount=_PublicAccessRetentionPeriodicStatsMaxCount_Object((1,3,6,1,4,1,8744,5,15,1,2,1),_PublicAccessRetentionPeriodicStatsMaxCount_Type())
...
publicAccessRetentionPeriodicStatsDuration=_PublicAccessRetentionPeriodicStatsDuration_Object((1,3,6,1,4,1,8744,5,15,1,2,2),_PublicAccessRetentionPeriodicStatsDuration_Type())
...
publicAccessRetentionPeriodTable=_PublicAccessRetentionPeriodTable_Object((1,3,6,1,4,1,8744,5,15,1,2,3))
...
publicAccessRetentionPeriodEntry=_PublicAccessRetentionPeriodEntry_Object((1,3,6,1,4,1,8744,5,15,1,2,3,1))
...
publicAccessRetentionPeriodIndex=_PublicAccessRetentionPeriodIndex_Object((1,3,6,1,4,1,8744,5,15,1,2,3,1,1),_PublicAccessRetentionPeriodIndex_Type())
...
publicAccessRetentionPeriodStartTime=_PublicAccessRetentionPeriodStartTime_Object((1,3,6,1,4,1,8744,5,15,1,2,3,1,2),_PublicAccessRetentionPeriodStartTime_Type())
...
publicAccessRetentionPeriodStopTime=_PublicAccessRetentionPeriodStopTime_Object((1,3,6,1,4,1,8744,5,15,1,2,3,1,3),_PublicAccessRetentionPeriodStopTime_Type())
...
publicAccessRetentionPeriodHighestSessionCount=_PublicAccessRetentionPeriodHighestSessionCount_Object((1,3,6,1,4,1,8744,5,15,1,2,3,1,4),_PublicAccessRetentionPeriodHighestSessionCount_Type())
...
publicAccessRetentionPeriodTotalSessionCount=_PublicAccessRetentionPeriodTotalSessionCount_Object((1,3,6,1,4,1,8744,5,15,1,2,3,1,5),_PublicAccessRetentionPeriodTotalSessionCount_Type())
...
publicAccessRetentionMIBNotificationPrefix=_PublicAccessRetentionMIBNotificationPrefix_ObjectIdentity((1,3,6,1,4,1,8744,5,15,2))
_PublicAccessRetentionMIBNotifications_ObjectIdentity=ObjectIdentity
publicAccessRetentionMIBNotifications=_PublicAccessRetentionMIBNotifications_ObjectIdentity((1,3,6,1,4,1,8744,5,15,2,0))
_ColubrisPublicAccessRetentionMIBConformance_ObjectIdentity=ObjectIdentity
colubrisPublicAccessRetentionMIBConformance=_ColubrisPublicAccessRetentionMIBConformance_ObjectIdentity((1,3,6,1,4,1,8744,5,15,3))
_ColubrisPublicAccessRetentionMIBCompliances_ObjectIdentity=ObjectIdentity
colubrisPublicAccessRetentionMIBCompliances=_ColubrisPublicAccessRetentionMIBCompliances_ObjectIdentity((1,3,6,1,4,1,8744,5,15,3,1))
_ColubrisPublicAccessRetentionMIBGroups_ObjectIdentity=ObjectIdentity
colubrisPublicAccessRetentionMIBGroups=_ColubrisPublicAccessRetentionMIBGroups_ObjectIdentity((1,3,6,1,4,1,8744,5,15,3,2))
colubrisPublicAccessRetentionSessionsMIBGroup=ObjectGroup((1,3,6,1,4,1,8744,5,15,3,2,1))
colubrisPublicAccessRetentionSessionsMIBGroup.setObjects(*((_B,_G),(_B,_H),(_B,_N),(_B,_O),(_B,_P),(_B,_Q),(_B,_R),(_B,_S),(_B,_T),(_B,_U),(_B,_V),(_B,_W)))
if mibBuilder.loadTexts:colubrisPublicAccessRetentionSessionsMIBGroup.setStatus(_A)
colubrisPublicAccessRetentionPeriodicStatsMIBGroup=ObjectGroup((1,3,6,1,4,1,8744,5,15,3,2,2))
colubrisPublicAccessRetentionPeriodicStatsMIBGroup.setObjects(*((_B,_X),(_B,_Y),(_B,_Z),(_B,_a),(_B,_b),(_B,_c)))
if mibBuilder.loadTexts:colubrisPublicAccessRetentionPeriodicStatsMIBGroup.setStatus(_A)
publicAccessRetentionSessionMaxCountReachedTrap=NotificationType((1,3,6,1,4,1,8744,5,15,2,0,1))
