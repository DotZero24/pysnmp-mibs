...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DGS3427-L2MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:47:50 2025
...
swL2DevCtrlVLANTrunkState = _SwL2DevCtrlVLANTrunkState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 1, 2, 22),
...
swL2DevCtrlIGMPSnoopingMaxDataDrivenLearningCount = _SwL2DevCtrlIGMPSnoopingMaxDataDrivenLearningCount_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 1, 2, 23),
...
swL2PortStatisTable = _SwL2PortStatisTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 10)
)
if mibBuilder.loadTexts:
...
swL2PortStatisEntry = _SwL2PortStatisEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 10, 1)
)
swL2PortStatisEntry.setIndexNames(
    (0, "DGS3427-L2MGMT-MIB", "swL2PortStatisPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortStatisPortIndex = _SwL2PortStatisPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 10, 1, 1),
...
swL2PortStatisPkts1519to1522Octets = _SwL2PortStatisPkts1519to1522Octets_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 10, 1, 2),
...
swL2PortStatisPkts1519to2047Octets = _SwL2PortStatisPkts1519to2047Octets_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 10, 1, 3),
...
swL2PortStatisPkts2048to4095Octets = _SwL2PortStatisPkts2048to4095Octets_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 10, 1, 4),
...
swL2PortStatisPkts4096to9216Octets = _SwL2PortStatisPkts4096to9216Octets_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 10, 1, 5),
...
swL2PortSfpInfoTable = _SwL2PortSfpInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11)
)
if mibBuilder.loadTexts:
...
swL2PortSfpInfoEntry = _SwL2PortSfpInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1)
)
swL2PortSfpInfoEntry.setIndexNames(
    (0, "DGS3427-L2MGMT-MIB", "swL2PortSfpInfoPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortSfpInfoPortIndex = _SwL2PortSfpInfoPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 1),
...
swL2PortSfpInfoConnectType = _SwL2PortSfpInfoConnectType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 2),
...
swL2PortSfpInfoVendorName = _SwL2PortSfpInfoVendorName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 3),
...
swL2PortSfpInfoVendorPN = _SwL2PortSfpInfoVendorPN_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 4),
...
swL2PortSfpInfoVendorSN = _SwL2PortSfpInfoVendorSN_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 5),
...
swL2PortSfpInfoVendorOUI = _SwL2PortSfpInfoVendorOUI_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 6),
...
swL2PortSfpInfoVendorRev = _SwL2PortSfpInfoVendorRev_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 7),
...
swL2PortSfpInfoDateCode = _SwL2PortSfpInfoDateCode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 8),
...
swL2PortSfpInfoFiberType = _SwL2PortSfpInfoFiberType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 9),
...
swL2PortSfpInfoBaudRate = _SwL2PortSfpInfoBaudRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 10),
...
swL2PortSfpInfoWavelength = _SwL2PortSfpInfoWavelength_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 3, 11, 1, 11),
...
swL2QOSSchedulingEntry.setIndexNames(
    (0, "DGS3427-L2MGMT-MIB", "swL2QOSSchedulingPort"),
    (0, "DGS3427-L2MGMT-MIB", "swL2QOSSchedulingClassID"),
)
if mibBuilder.loadTexts:
...
swL2QOSSchedulingMechanism = _SwL2QOSSchedulingMechanism_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 2, 1, 4),
...
swL2QOSSchedulingMechanismEffec = _SwL2QOSSchedulingMechanismEffec_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 2, 1, 5),
...
swCosBandwidthControlEntry = _SwCosBandwidthControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 7, 1)
)
swCosBandwidthControlEntry.setIndexNames(
    (0, "DGS3427-L2MGMT-MIB", "swCosBandwidthPort"),
    (0, "DGS3427-L2MGMT-MIB", "swCosBandwidthClassID"),
)
if mibBuilder.loadTexts:
...
swCosBandwidthPort = _SwCosBandwidthPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 7, 1, 1),
...
swCosBandwidthClassID = _SwCosBandwidthClassID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 7, 1, 2),
...
swCosBandwidthMinRate = _SwCosBandwidthMinRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 7, 1, 3),
...
swCosBandwidthMaxRate = _SwCosBandwidthMaxRate_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 7, 1, 4),
...
swQosDscpTrustPortCtrlEntry = _SwQosDscpTrustPortCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 8, 1)
)
swQosDscpTrustPortCtrlEntry.setIndexNames(
    (0, "DGS3427-L2MGMT-MIB", "swQosDscpTrustPortCtrlPortIndex"),
)
if mibBuilder.loadTexts:
...
swQosDscpTrustPortCtrlPortIndex = _SwQosDscpTrustPortCtrlPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 8, 1, 1),
...
swQosDscpTrustPortCtrlState = _SwQosDscpTrustPortCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 8, 1, 2),
...
swQosDscpMapGlobalCtrlEntry = _SwQosDscpMapGlobalCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 9, 1)
)
swQosDscpMapGlobalCtrlEntry.setIndexNames(
    (0, "DGS3427-L2MGMT-MIB", "swQosDscpMapGlobalCtrlDscpIndex"),
)
if mibBuilder.loadTexts:
...
swQosDscpMapGlobalCtrlDscpIndex = _SwQosDscpMapGlobalCtrlDscpIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 9, 1, 1),
...
swQosDscpMapGlobalCtrl8021pPriority = _SwQosDscpMapGlobalCtrl8021pPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 9, 1, 2),
...
swQosDscpMapGlobalCtrlNewDscp = _SwQosDscpMapGlobalCtrlNewDscp_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 6, 9, 1, 3),
...
swL2TrunkVLANPort = _SwL2TrunkVLANPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 9, 6, 1, 1),
...
swL2TrunkVLANState = _SwL2TrunkVLANState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 9, 6, 1, 2),
...
swL2MirrorGroupTable = _SwL2MirrorGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 10, 5)
)
if mibBuilder.loadTexts:
...
swL2MirrorGroupEntry = _SwL2MirrorGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 10, 5, 1)
)
swL2MirrorGroupEntry.setIndexNames(
    (0, "DGS3427-L2MGMT-MIB", "swL2MirrorGroupID"),
)
if mibBuilder.loadTexts:
...
swL2MirrorGroupID = _SwL2MirrorGroupID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 10, 5, 1, 1),
...
swL2MirrorGroupRowStatus = _SwL2MirrorGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 10, 5, 1, 2),
...
swL2MirrorGroupState = _SwL2MirrorGroupState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 10, 5, 1, 3),
...
swL2MirrorGroupLogicTargetPort = _SwL2MirrorGroupLogicTargetPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 10, 5, 1, 4),
...
swL2MirrorGroupPortSourceIngress = _SwL2MirrorGroupPortSourceIngress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 10, 5, 1, 5),
...
swL2MirrorGroupPortSourceEngress = _SwL2MirrorGroupPortSourceEngress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 10, 5, 1, 6),
...
swL2IGMPDataDrivenLearningState = _SwL2IGMPDataDrivenLearningState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 3, 1, 16),
...
swL2IGMPDataDrivenLearningAgedOutState = _SwL2IGMPDataDrivenLearningAgedOutState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 3, 1, 17),
...
swL2IGMPDataDrivenGroupExpiryTime = _SwL2IGMPDataDrivenGroupExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 3, 1, 18),
...
swL2IGMPMulticastVlanUntagSourcePort = _SwL2IGMPMulticastVlanUntagSourcePort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 7, 1, 10),
...
swL2IGMPMulticastVlanRemapPriority = _SwL2IGMPMulticastVlanRemapPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 7, 1, 11),
...
swL2IGMPMulticastVlanReplacePriority = _SwL2IGMPMulticastVlanReplacePriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 7, 1, 12),
...
swL2IGMPSnoopingDataDrivenLearningGroupTable = _SwL2IGMPSnoopingDataDrivenLearningGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 20)
)
if mibBuilder.loadTexts:
...
swL2IGMPSnoopingDataDrivenLearningGroupEntry = _SwL2IGMPSnoopingDataDrivenLearningGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 20, 1)
)
swL2IGMPSnoopingDataDrivenLearningGroupEntry.setIndexNames(
    (0, "DGS3427-L2MGMT-MIB", "swL2IGMPSnoopingDataDrivenLearningGrpVID"),
    (0, "DGS3427-L2MGMT-MIB", "swL2IGMPSnoopingDataDrivenLearningGrpGrpAddr"),
)
if mibBuilder.loadTexts:
...
swL2IGMPSnoopingDataDrivenLearningGrpVID = _SwL2IGMPSnoopingDataDrivenLearningGrpVID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 20, 1, 1),
...
swL2IGMPSnoopingDataDrivenLearningGrpGrpAddr = _SwL2IGMPSnoopingDataDrivenLearningGrpGrpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 20, 1, 2),
...
swL2IGMPSnoopingDataDrivenLearningGrpRouterPorts = _SwL2IGMPSnoopingDataDrivenLearningGrpRouterPorts_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 20, 1, 3),
...
swL2IGMPSnoopingDataDrivenLearningGrpClearGrp = _SwL2IGMPSnoopingDataDrivenLearningGrpClearGrp_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 11, 20, 1, 100),
...
swL2DhcpLocalRelayState = _SwL2DhcpLocalRelayState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 24, 1),
...
swL2DhcpLocalRelayVLANTable = _SwL2DhcpLocalRelayVLANTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 24, 2)
)
if mibBuilder.loadTexts:
...
swL2DhcpLocalRelayVLANEntry = _SwL2DhcpLocalRelayVLANEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 24, 2, 1)
)
swL2DhcpLocalRelayVLANEntry.setIndexNames(
    (0, "DGS3427-L2MGMT-MIB", "swL2DhcpLocalRelayVLANID"),
)
if mibBuilder.loadTexts:
...
swL2DhcpLocalRelayVLANID = _SwL2DhcpLocalRelayVLANID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 24, 2, 1, 1),
...
swL2DhcpLocalRelayVLANState = _SwL2DhcpLocalRelayVLANState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 70, 2, 2, 24, 2, 1, 2),
