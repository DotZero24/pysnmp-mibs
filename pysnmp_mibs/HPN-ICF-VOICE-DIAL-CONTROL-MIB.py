...
mibBuilder.exportSymbols("HPN-ICF-VOICE-DIAL-CONTROL-MIB", hpnicfVoEntityCfgDSCP=hpnicfVoEntityCfgDSCP, hpnicfVoEntityCfgFaxProtocol=hpnicfVoEntityCfgFaxProtocol, hpnicfVoEntityNumberEntry=hpnicfVoEntityNumberEntry, hpnicfVoVoIPEntityCfgTargetAddrType=hpnicfVoVoIPEntityCfgTargetAddrType, hpnicfVoPOTSEntityConfigPrefix=hpnicfVoPOTSEntityConfigPrefix, hpnicfVoEntityCfgFaxSendNSFEnable=hpnicfVoEntityCfgFaxSendNSFEnable, hpnicfVoEntityNumberPassword=hpnicfVoEntityNumberPassword, hpnicfVoEntityNumberPasswordType=hpnicfVoEntityNumberPasswordType, hpnicfVoPOTSEntityConfigSendNum=hpnicfVoPOTSEntityConfigSendNum, hpnicfVoEntityCfgCodec4th=hpnicfVoEntityCfgCodec4th, hpnicfVoPOTSEntityConfigTable=hpnicfVoPOTSEntityConfigTable, hpnicfVoPOTSEntityConfigIndex=hpnicfVoPOTSEntityConfigIndex, hpnicfVoEntityNumberExpires=hpnicfVoEntityNumberExpires, HpnicfFaxBaudrateType=HpnicfFaxBaudrateType, hpnicfVoEntityCfgFaxEcm=hpnicfVoEntityCfgFaxEcm, hpnicfVoEntityNumberAuthUser=hpnicfVoEntityNumberAuthUser, hpnicfVoEntityCfgCodec2nd=hpnicfVoEntityCfgCodec2nd, hpnicfVoPOTSEntityConfigSubLine=hpnicfVoPOTSEntityConfigSubLine, hpnicfVoEntityCreateTable=hpnicfVoEntityCreateTable, HpnicfOutBandMode=HpnicfOutBandMode, hpnicfVoEntityCfgFaxHRPackNum=hpnicfVoEntityCfgFaxHRPackNum, HpnicfFaxProtocolType=HpnicfFaxProtocolType, hpnicfVoEntityCfgFaxTrainMode=hpnicfVoEntityCfgFaxTrainMode, hpnicfVoEntityNumberTable=hpnicfVoEntityNumberTable, HpnicfFaxTrainMode=HpnicfFaxTrainMode, hpnicfVoVoIPEntityConfigTable=hpnicfVoVoIPEntityConfigTable, hpnicfVoEntityCfgVADEnable=hpnicfVoEntityCfgVADEnable, hpnicfVoEntityRowStatus=hpnicfVoEntityRowStatus, hpnicfVoEntityCfgIndex=hpnicfVoEntityCfgIndex, hpnicfVoEntityCfgFaxLevel=hpnicfVoEntityCfgFaxLevel, hpnicfVoEntityCommonConfigTable=hpnicfVoEntityCommonConfigTable, hpnicfVoEntityCfgFaxLRPackNum=hpnicfVoEntityCfgFaxLRPackNum, HpnicfCodecType=HpnicfCodecType, hpnicfVoEntityIndex=hpnicfVoEntityIndex, hpnicfVoEntityCfgPriority=hpnicfVoEntityCfgPriority, hpnicfVoVoIPEntityCfgTargetType=hpnicfVoVoIPEntityCfgTargetType, HpnicfRegisterdStatus=HpnicfRegisterdStatus, hpnicfVoEntityType=hpnicfVoEntityType, hpnicfVoVoIPEntityCfgIndex=hpnicfVoVoIPEntityCfgIndex, hpnicfVoVoIPEntityCfgTargetAddr=hpnicfVoVoIPEntityCfgTargetAddr, PYSNMP_MODULE_ID=hpnicfVoiceEntityControl, hpnicfVoEntityCfgOutbandMode=hpnicfVoEntityCfgOutbandMode, hpnicfVoEntityCfgFaxBaudrate=hpnicfVoEntityCfgFaxBaudrate, hpnicfVoEntityCreateEntry=hpnicfVoEntityCreateEntry, hpnicfVoEntityCfgCodec3rd=hpnicfVoEntityCfgCodec3rd, hpnicfVoEntityNumberStatus=hpnicfVoEntityNumberStatus, hpnicfVoVoIPEntityConfigEntry=hpnicfVoVoIPEntityConfigEntry, hpnicfVoEntityCfgFaxLocalTrainPara=hpnicfVoEntityCfgFaxLocalTrainPara, hpnicfVoEntityCfgDescription=hpnicfVoEntityCfgDescription, hpnicfVoiceEntityControl=hpnicfVoiceEntityControl, hpnicfVoPOTSEntityConfigEntry=hpnicfVoPOTSEntityConfigEntry, hpnicfVoEntityCfgCodec1st=hpnicfVoEntityCfgCodec1st, hpnicfVoEntityObjects=hpnicfVoEntityObjects, hpnicfVoEntityCommonConfigEntry=hpnicfVoEntityCommonConfigEntry)
