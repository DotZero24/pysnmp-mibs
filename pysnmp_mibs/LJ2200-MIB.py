...
mibBuilder.exportSymbols("LJ2200-MIB", hrprinterdetectederrorstate=hrprinterdetectederrorstate, prtalertcode=prtalertcode, error7_time_stamp=error7_time_stamp, default_lines_per_page=default_lines_per_page, prtmediapathdefaultindex=prtmediapathdefaultindex, channelifindex=channelifindex, imaging=imaging, channeltype=channeltype, postscript_resource_saving_memory_size=postscript_resource_saving_memory_size, prtmarkerlifecount=prtmarkerlifecount, prtchannelstate=prtchannelstate, prtInputTable=prtInputTable, fw_rom_datecode=fw_rom_datecode, job_info_attr_13=job_info_attr_13, settings_job=settings_job, channelprotocolversion=channelprotocolversion, hrdeviceid=hrdeviceid, system=system, job_info_size=job_info_size, mio1_manufacturing_info=mio1_manufacturing_info, hrDiskStorageEntry=hrDiskStorageEntry, prtalerttraininglevel=prtalerttraininglevel, channelTable=channelTable, prtinterpreterlangversion=prtinterpreterlangversion, errorlog=errorlog, settings_io=settings_io, error4=error4, hrFSTable=hrFSTable, custom_paper_feed_dim=custom_paper_feed_dim, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, error9=error9, prtoutputcapacityunit=prtoutputcapacityunit, prtChannelEntry=prtChannelEntry, prtalerttime=prtalerttime, prtmarkerstatus=prtmarkerstatus, prtMarkerTable=prtMarkerTable, prtconsolenumberofdisplaylines=prtconsolenumberofdisplaylines, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, dark_courier=dark_courier, device=device, default_print_quality=default_print_quality, prtMediaPath=prtMediaPath, job_info_attr_10=job_info_attr_10, default_horizontal_black_resolution=default_horizontal_black_resolution, prtconsoledisable=prtconsoledisable, prtCoverTable=prtCoverTable, prtMarkerEntry=prtMarkerEntry, source_subsystem=source_subsystem, default_duplex_mode=default_duplex_mode, prtalertdescription=prtalertdescription, job_info_attr_15=job_info_attr_15, prtchanneltype=prtchanneltype, prtchannelstatus=prtchannelstatus, form_feed_needed=form_feed_needed, prtconsolelocalization=prtconsolelocalization, mp_tray=mp_tray, prtchannelcurrentjobcntllangindex=prtchannelcurrentjobcntllangindex, job_info_attr_8=job_info_attr_8, prtconsolenumberofdisplaychars=prtconsolenumberofdisplaychars, prtgeneralreset=prtgeneralreset, hrstoragedescr=hrstoragedescr, prtCover=prtCover, destination_subsystem=destination_subsystem, error1_code=error1_code, prtalertseveritylevel=prtalertseveritylevel, prtoutputdefaultindex=prtoutputdefaultindex, channelEntry=channelEntry, on_off_line=on_off_line, prtinputtype=prtinputtype, error5=error5, error5_time_stamp=error5_time_stamp, intray1=intray1, model_name=model_name, job_info_outcome=job_info_outcome, prtMarkerSuppliesTable=prtMarkerSuppliesTable, job_info_attr_5=job_info_attr_5, prtInterpreter=prtInterpreter, prtmarkereastmargin=prtmarkereastmargin, auto_continue=auto_continue, pcl_default_font_number=pcl_default_font_number, error10_code=error10_code, prtInputEntry=prtInputEntry, form_feed=form_feed, simm2_capacity=simm2_capacity, prtLocalization=prtLocalization, pcl_default_font_source=pcl_default_font_source, job_info=job_info, prtinputmodel=prtinputmodel, device_name=device_name, status_system=status_system, settings_prt_eng=settings_prt_eng, intray3=intray3, simm2_type=simm2_type, prtmarkerprocesscolorants=prtmarkerprocesscolorants, asset_number=asset_number, prtinterpreterdefaultorientation=prtinterpreterdefaultorientation, prtmarkersuppliesmaxcapacity=prtmarkersuppliesmaxcapacity, default_bits_per_pixel=default_bits_per_pixel, mio1_type=mio1_type, prtlocalizationcharacterset=prtlocalizationcharacterset, prtmarkerpoweroncount=prtmarkerpoweroncount, device_config_token=device_config_token, prtmediapathminmediaxfeeddir=prtmediapathminmediaxfeeddir, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, hrdeviceindex=hrdeviceindex, postscript_print_errors=postscript_print_errors, prtinterpretertwoway=prtinterpretertwoway, prtinputdimunit=prtinputdimunit, job_info_name1=job_info_name1, prtchannelprotocolversion=prtchannelprotocolversion, hrDeviceEntry=hrDeviceEntry, tray1_media_size_loaded=tray1_media_size_loaded, prtlocalizationlanguage=prtlocalizationlanguage, pdl_pcl=pdl_pcl, channel_bytes_sent=channel_bytes_sent, io_timeout=io_timeout, print_engine_mispick_count=print_engine_mispick_count, prtgeneralprintername=prtgeneralprintername, id=id, simm2=simm2, intrays=intrays, job_info_change_id=job_info_change_id, channel=channel, channel_table=channel_table, hrdevicetype=hrdevicetype, hrPartitionEntry=hrPartitionEntry, job_info_attr_12=job_info_attr_12, error10=error10, pcl_default_font_height=pcl_default_font_height, reprint=reprint, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, hrfsstorageindex=hrfsstorageindex, prtmediapathmaxspeedprintunit=prtmediapathmaxspeedprintunit, hrstorageallocationfailures=hrstorageallocationfailures, prtoutputremainingcapacity=prtoutputremainingcapacity, prtchannelinformation=prtchannelinformation, current_job_parsing_id=current_job_parsing_id, hrFSEntry=hrFSEntry, settings_intray=settings_intray, default_ret=default_ret, prtinterpreterlanglevel=prtinterpreterlanglevel, prtmarkersuppliescolorantindex=prtmarkersuppliescolorantindex, prtinputname=prtinputname, prtOutput=prtOutput, job_info_name2=job_info_name2, prtmediapathminmediafeeddir=prtmediapathminmediafeeddir, error7=error7, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, prtconsoleofftime=prtconsoleofftime, resource_saving=resource_saving, prtlocalizationcountry=prtlocalizationcountry, prtinterpreterversion=prtinterpreterversion, hrfsmountpoint=hrfsmountpoint, hrDiskStorageTable=hrDiskStorageTable, prtinputversion=prtinputversion, prtalertgroup=prtalertgroup, channelstatus=channelstatus, prtoutputtype=prtoutputtype, error1=error1, prtmediapathmediasizeunit=prtmediapathmediasizeunit, prtmarkersouthmargin=prtmarkersouthmargin, print_density=print_density, job_input_auto_continue_mode=job_input_auto_continue_mode, channelnumberofchannels=channelnumberofchannels, prtalertgroupindex=prtalertgroupindex, prtinputcapacityunit=prtinputcapacityunit, error8_code=error8_code, hrdeviceerrors=hrdeviceerrors, job_info_physical_outbins_used=job_info_physical_outbins_used, io_switch=io_switch, hrfstype=hrfstype, prtLocalizationEntry=prtLocalizationEntry, hrdevicedescr=hrdevicedescr, prtConsoleLightEntry=prtConsoleLightEntry, prtmarkermarktech=prtmarkermarktech, hrpartitionsize=hrpartitionsize, hrDevice=hrDevice, hrprinterstatus=hrprinterstatus, tray_lock=tray_lock, simm1_type=simm1_type, tables=tables, hrDeviceTable=hrDeviceTable, prtMarkerSupplies=prtMarkerSupplies, serial_number=serial_number, prtmarkercounterunit=prtmarkercounterunit, prtOutputEntry=prtOutputEntry, prtmarkeraddressabilityfeeddir=prtmarkeraddressabilityfeeddir, settings_file_system=settings_file_system, transfer_setting=transfer_setting, hrstorageused=hrstorageused, job_info_attr_14=job_info_attr_14, job_info_attr_11=job_info_attr_11, hrfsindex=hrfsindex, job_being_parsed=job_being_parsed, tray1_fuser_temperature=tray1_fuser_temperature, pysmi_continue=pysmi_continue, prtmarkerspotcolorants=prtmarkerspotcolorants, hrpartitionfsindex=hrpartitionfsindex, prtGeneralTable=prtGeneralTable, processing_subsystem=processing_subsystem, prtmediapathmaxmediafeeddir=prtmediapathmaxmediafeeddir, prtoutputmaxcapacity=prtoutputmaxcapacity, prtinputcurrentlevel=prtinputcurrentlevel, error1_time_stamp=error1_time_stamp, sleep_mode=sleep_mode, hrPrinterEntry=hrPrinterEntry, prtinputstatus=prtinputstatus, error8=error8, energy_star=energy_star, channelstate=channelstate, job_info_attr_7=job_info_attr_7, mio=mio, job_info_attribute=job_info_attribute, pdl_postscript=pdl_postscript, default_vmi=default_vmi, prtmarkeraddressabilityxfeeddir=prtmarkeraddressabilityxfeeddir, hrPrinterTable=hrPrinterTable, prtconsoledisplaybuffertext=prtconsoledisplaybuffertext, simm1=simm1, prtStorageRefTable=prtStorageRefTable, hrstoragesize=hrstoragesize, hrdiskstoragecapacity=hrdiskstoragecapacity, prtMediaPathEntry=prtMediaPathEntry, channel_jobs_received=channel_jobs_received, default_vertical_black_resolution=default_vertical_black_resolution, prtconsoleontime=prtconsoleontime, simm=simm, prtinputvendorname=prtinputvendorname, error3_code=error3_code, hrstorageallocationunits=hrstorageallocationunits, prtcoverdescription=prtcoverdescription, status_pdl=status_pdl, total_engine_page_count=total_engine_page_count, intray2=intray2, job_info_attr_16=job_info_attr_16, pjl_password=pjl_password, channelinformation=channelinformation, custom_paper_xfeed_dim=custom_paper_xfeed_dim, error3=error3, hrstorageindex=hrstorageindex, prtChannelTable=prtChannelTable, tray3_media_size_loaded=tray3_media_size_loaded, error8_time_stamp=error8_time_stamp, prtOutputTable=prtOutputTable, job_info_io_source=job_info_io_source, prtmarkersupplieslevel=prtmarkersupplieslevel, error9_time_stamp=error9_time_stamp, prtmediapathstatus=prtmediapathstatus, prtoutputstatus=prtoutputstatus, hrfsbootable=hrfsbootable, prtgeneralserviceperson=prtgeneralserviceperson, prtDeviceRefEntry=prtDeviceRefEntry, default_page_protect=default_page_protect, error2_code=error2_code)
mibBuilder.exportSymbols("LJ2200-MIB", prtchannelifindex=prtchannelifindex, prtAlertTable=prtAlertTable, pcl_default_font_width=pcl_default_font_width, hrfslastpartialbackupdate=hrfslastpartialbackupdate, channelprinteralert=channelprinteralert, error_log_clear=error_log_clear, job_info_attr_9=job_info_attr_9, active_print_jobs=active_print_jobs, pdl=pdl, intray=intray, simm1_capacity=simm1_capacity, prtstoragerefindex=prtstoragerefindex, prtinterpreterxfeedaddressability=prtinterpreterxfeedaddressability, custom_paper_dim_unit=custom_paper_dim_unit, test=test, mio1=mio1, hrdiskstoragemedia=hrdiskstoragemedia, hrmemorysize=hrmemorysize, prtConsoleLightTable=prtConsoleLightTable, job_info_stage=job_info_stage, error3_time_stamp=error3_time_stamp, hrpartitionindex=hrpartitionindex, prtgeneralcurrentoperator=prtgeneralcurrentoperator, settings_pdl=settings_pdl, error6_time_stamp=error6_time_stamp, prtinterpreterdefaultcharsetin=prtinterpreterdefaultcharsetin, prtAlert=prtAlert, prtConsoleLights=prtConsoleLights, prtgeneralserialnumber=prtgeneralserialnumber, hrfslastfullbackupdate=hrfslastfullbackupdate, mio1_model_name=mio1_model_name, print_internal_page=print_internal_page, self_test=self_test, job_info_attr_1=job_info_attr_1, prtChannel=prtChannel, prtinputdescription=prtinputdescription, channel_bytes_received=channel_bytes_received, hrStorageTable=hrStorageTable, hrPartitionTable=hrPartitionTable, pcl_resource_saving_memory_size=pcl_resource_saving_memory_size, prtInterpreterEntry=prtInterpreterEntry, hrStorage=hrStorage, interface=interface, hrstoragetype=hrstoragetype, prtAlertEntry=prtAlertEntry, device_location=device_location, error2=error2, job_info_pages_printed=job_info_pages_printed, prtmarkerdefaultindex=prtmarkerdefaultindex, error5_code=error5_code, hp=hp, prtmediapathtype=prtmediapathtype, prtinputsecurity=prtinputsecurity, default_media_size=default_media_size, error6=error6, prtalertallevents=prtalertallevents, prtmediapathmaxmediaxfeeddir=prtmediapathmaxmediaxfeeddir, prtMarker=prtMarker, service_password=service_password, prtmarkersuppliessupplyunit=prtmarkersuppliessupplyunit, printmib=printmib, prtinputmedianame=prtinputmedianame, tray3_fuser_temperature=tray3_fuser_temperature, job_input_auto_continue_timeout=job_input_auto_continue_timeout, prtinputmediadimfeeddirdeclared=prtinputmediadimfeeddirdeclared, install_date=install_date, separation_setting=separation_setting, hrdiskstorageremoveble=hrdiskstorageremoveble, prtinputmaxcapacity=prtinputmaxcapacity, DisplayString=DisplayString, hrdevicestatus=hrdevicestatus, hrStorageEntry=hrStorageEntry, hrfsremotemountpoint=hrfsremotemountpoint, default_copies=default_copies, prtmarkeraddressabilityunit=prtmarkeraddressabilityunit, job_info_attr_2=job_info_attr_2, prtmarkersuppliestype=prtmarkersuppliestype, prtMediaPathTable=prtMediaPathTable, settings_system=settings_system, prtmarkernorthmargin=prtmarkernorthmargin, status_prt_eng=status_prt_eng, prtmediapathdescription=prtmediapathdescription, prtalertlocation=prtalertlocation, prtgeneralcurrentlocalization=prtgeneralcurrentlocalization, prtLocalizationTable=prtLocalizationTable, prtalertcriticalevents=prtalertcriticalevents, prtmarkersuppliesclass=prtmarkersuppliesclass, job_info_attr_3=job_info_attr_3, cold_reset_media_size=cold_reset_media_size, io=io, prtinterpreterdescription=prtinterpreterdescription, error9_code=error9_code, prtcoverstatus=prtcoverstatus, prtmediapathmaxspeed=prtmediapathmaxspeed, pjl=pjl, prtinterpreterfeedaddressability=prtinterpreterfeedaddressability, maximum_resource_saving_memory=maximum_resource_saving_memory, duplex_page_count=duplex_page_count, job=job, prtInput=prtInput, error10_time_stamp=error10_time_stamp, prtgeneralconfigchanges=prtgeneralconfigchanges, prtmarkersuppliesdescription=prtmarkersuppliesdescription, job_info_attr_6=job_info_attr_6, file_system_max_open_files=file_system_max_open_files, prtInterpreterTable=prtInterpreterTable, hrdiskstorageaccess=hrdiskstorageaccess, prtDeviceRefTable=prtDeviceRefTable, prtGeneralEntry=prtGeneralEntry, prtinputdefaultindex=prtinputdefaultindex, job_info_attr_4=job_info_attr_4, prtdevicerefindex=prtdevicerefindex, prtinterpreterlangfamily=prtinterpreterlangfamily, prtinputserialnumber=prtinputserialnumber, tray2_fuser_temperature=tray2_fuser_temperature, tray2_media_size_loaded=tray2_media_size_loaded, hrpartitionlabel=hrpartitionlabel, prtconsolecolor=prtconsolecolor, prtinterpreterdefaultcharsetout=prtinterpreterdefaultcharsetout, prtinputmediadimxfeeddirdeclared=prtinputmediadimxfeeddirdeclared, channel_entry=channel_entry, hrpartitionid=hrpartitionid, error2_time_stamp=error2_time_stamp, prtchanneldefaultpagedesclangindex=prtchanneldefaultpagedesclangindex, wide_a4=wide_a4, error7_code=error7_code, file_system=file_system, hrm=hrm, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, job_info_pages_processed=job_info_pages_processed, prtmarkerwestmargin=prtmarkerwestmargin, error4_time_stamp=error4_time_stamp, error6_code=error6_code, channel_io_errors=channel_io_errors, print_engine_jam_count=print_engine_jam_count, prtStorageRefEntry=prtStorageRefEntry, print_engine=print_engine, error4_code=error4_code, dm=dm, job_info_outbins_used=job_info_outbins_used, prtinputmediadimfeeddirchosen=prtinputmediadimfeeddirchosen, prtCoverEntry=prtCoverEntry, prtmarkersuppliesmarkerindex=prtmarkersuppliesmarkerindex, hrfsaccess=hrfsaccess, job_info_state=job_info_state, prtconsoledescription=prtconsoledescription, prtGeneral=prtGeneral, prtinputmediadimxfeeddirchosen=prtinputmediadimxfeeddirchosen)
