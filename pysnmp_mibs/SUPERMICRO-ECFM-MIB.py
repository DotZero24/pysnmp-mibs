...
fsEcfmSystem=_FsEcfmSystem_ObjectIdentity((1,3,6,1,4,1,10876,101,1,150,1))
...
fsEcfmSystemControl=_FsEcfmSystemControl_Object((1,3,6,1,4,1,10876,101,1,150,1,1),_FsEcfmSystemControl_Type())
...
fsEcfmModuleStatus=_FsEcfmModuleStatus_Object((1,3,6,1,4,1,10876,101,1,150,1,2),_FsEcfmModuleStatus_Type())
...
fsEcfmOui=_FsEcfmOui_Object((1,3,6,1,4,1,10876,101,1,150,1,3),_FsEcfmOui_Type())
...
fsEcfmTraceOption=_FsEcfmTraceOption_Object((1,3,6,1,4,1,10876,101,1,150,1,4),_FsEcfmTraceOption_Type())
...
fsEcfmLtrCacheStatus=_FsEcfmLtrCacheStatus_Object((1,3,6,1,4,1,10876,101,1,150,1,5),_FsEcfmLtrCacheStatus_Type())
...
fsEcfmLtrCacheClear=_FsEcfmLtrCacheClear_Object((1,3,6,1,4,1,10876,101,1,150,1,6),_FsEcfmLtrCacheClear_Type())
...
fsEcfmLtrCacheHoldTime=_FsEcfmLtrCacheHoldTime_Object((1,3,6,1,4,1,10876,101,1,150,1,7),_FsEcfmLtrCacheHoldTime_Type())
...
fsEcfmLtrCacheSize=_FsEcfmLtrCacheSize_Object((1,3,6,1,4,1,10876,101,1,150,1,8),_FsEcfmLtrCacheSize_Type())
...
fsEcfmPortTable=_FsEcfmPortTable_Object((1,3,6,1,4,1,10876,101,1,150,1,9))
if mibBuilder.loadTexts:fsEcfmPortTable.setStatus(_A)
_FsEcfmPortEntry_Object=MibTableRow
fsEcfmPortEntry=_FsEcfmPortEntry_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1))
...
fsEcfmPortIndex=_FsEcfmPortIndex_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,1),_FsEcfmPortIndex_Type())
...
fsEcfmPortLLCEncapStatus=_FsEcfmPortLLCEncapStatus_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,2),_FsEcfmPortLLCEncapStatus_Type())
...
fsEcfmPortModuleStatus=_FsEcfmPortModuleStatus_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,3),_FsEcfmPortModuleStatus_Type())
...
fsEcfmPortTxCfmPduCount=_FsEcfmPortTxCfmPduCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,4),_FsEcfmPortTxCfmPduCount_Type())
...
fsEcfmPortTxCcmCount=_FsEcfmPortTxCcmCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,5),_FsEcfmPortTxCcmCount_Type())
...
fsEcfmPortTxLbmCount=_FsEcfmPortTxLbmCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,6),_FsEcfmPortTxLbmCount_Type())
...
fsEcfmPortTxLbrCount=_FsEcfmPortTxLbrCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,7),_FsEcfmPortTxLbrCount_Type())
...
fsEcfmPortTxLtmCount=_FsEcfmPortTxLtmCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,8),_FsEcfmPortTxLtmCount_Type())
...
fsEcfmPortTxLtrCount=_FsEcfmPortTxLtrCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,9),_FsEcfmPortTxLtrCount_Type())
...
fsEcfmPortTxFailedCount=_FsEcfmPortTxFailedCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,10),_FsEcfmPortTxFailedCount_Type())
...
fsEcfmPortRxCfmPduCount=_FsEcfmPortRxCfmPduCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,11),_FsEcfmPortRxCfmPduCount_Type())
...
fsEcfmPortRxCcmCount=_FsEcfmPortRxCcmCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,12),_FsEcfmPortRxCcmCount_Type())
...
fsEcfmPortRxLbmCount=_FsEcfmPortRxLbmCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,13),_FsEcfmPortRxLbmCount_Type())
...
fsEcfmPortRxLbrCount=_FsEcfmPortRxLbrCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,14),_FsEcfmPortRxLbrCount_Type())
...
fsEcfmPortRxLtmCount=_FsEcfmPortRxLtmCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,15),_FsEcfmPortRxLtmCount_Type())
...
fsEcfmPortRxLtrCount=_FsEcfmPortRxLtrCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,16),_FsEcfmPortRxLtrCount_Type())
...
fsEcfmPortRxBadCfmPduCount=_FsEcfmPortRxBadCfmPduCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,17),_FsEcfmPortRxBadCfmPduCount_Type())
...
fsEcfmPortFrwdCfmPduCount=_FsEcfmPortFrwdCfmPduCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,18),_FsEcfmPortFrwdCfmPduCount_Type())
...
fsEcfmPortDsrdCfmPduCount=_FsEcfmPortDsrdCfmPduCount_Object((1,3,6,1,4,1,10876,101,1,150,1,9,1,19),_FsEcfmPortDsrdCfmPduCount_Type())
...
fsEcfmMipCcmDbStatus=_FsEcfmMipCcmDbStatus_Object((1,3,6,1,4,1,10876,101,1,150,1,10),_FsEcfmMipCcmDbStatus_Type())
...
fsEcfmMipCcmDbClear=_FsEcfmMipCcmDbClear_Object((1,3,6,1,4,1,10876,101,1,150,1,11),_FsEcfmMipCcmDbClear_Type())
...
fsEcfmMipCcmDbSize=_FsEcfmMipCcmDbSize_Object((1,3,6,1,4,1,10876,101,1,150,1,12),_FsEcfmMipCcmDbSize_Type())
...
fsEcfmMipCcmDbHoldTime=_FsEcfmMipCcmDbHoldTime_Object((1,3,6,1,4,1,10876,101,1,150,1,13),_FsEcfmMipCcmDbHoldTime_Type())
...
fsEcfmMemoryFailureCount=_FsEcfmMemoryFailureCount_Object((1,3,6,1,4,1,10876,101,1,150,1,14),_FsEcfmMemoryFailureCount_Type())
...
fsEcfmBufferFailureCount=_FsEcfmBufferFailureCount_Object((1,3,6,1,4,1,10876,101,1,150,1,15),_FsEcfmBufferFailureCount_Type())
...
fsEcfmUpCount=_FsEcfmUpCount_Object((1,3,6,1,4,1,10876,101,1,150,1,16),_FsEcfmUpCount_Type())
...
fsEcfmDownCount=_FsEcfmDownCount_Object((1,3,6,1,4,1,10876,101,1,150,1,17),_FsEcfmDownCount_Type())
...
fsEcfmNoDftCount=_FsEcfmNoDftCount_Object((1,3,6,1,4,1,10876,101,1,150,1,18),_FsEcfmNoDftCount_Type())
...
fsEcfmRdiDftCount=_FsEcfmRdiDftCount_Object((1,3,6,1,4,1,10876,101,1,150,1,19),_FsEcfmRdiDftCount_Type())
...
fsEcfmMacStatusDftCount=_FsEcfmMacStatusDftCount_Object((1,3,6,1,4,1,10876,101,1,150,1,20),_FsEcfmMacStatusDftCount_Type())
...
fsEcfmRemoteCcmDftCount=_FsEcfmRemoteCcmDftCount_Object((1,3,6,1,4,1,10876,101,1,150,1,21),_FsEcfmRemoteCcmDftCount_Type())
...
fsEcfmErrorCcmDftCount=_FsEcfmErrorCcmDftCount_Object((1,3,6,1,4,1,10876,101,1,150,1,22),_FsEcfmErrorCcmDftCount_Type())
...
fsEcfmXconDftCount=_FsEcfmXconDftCount_Object((1,3,6,1,4,1,10876,101,1,150,1,23),_FsEcfmXconDftCount_Type())
...
fsEcfmCrosscheckDelay=_FsEcfmCrosscheckDelay_Object((1,3,6,1,4,1,10876,101,1,150,1,24),_FsEcfmCrosscheckDelay_Type())
...
fsEcfmMipDynamicEvaluationStatus=_FsEcfmMipDynamicEvaluationStatus_Object((1,3,6,1,4,1,10876,101,1,150,1,25),_FsEcfmMipDynamicEvaluationStatus_Type())
...
fsEcfmMipTable=_FsEcfmMipTable_Object((1,3,6,1,4,1,10876,101,1,150,1,26))
if mibBuilder.loadTexts:fsEcfmMipTable.setStatus(_A)
_FsEcfmMipEntry_Object=MibTableRow
fsEcfmMipEntry=_FsEcfmMipEntry_Object((1,3,6,1,4,1,10876,101,1,150,1,26,1))
...
fsEcfmMipIfIndex=_FsEcfmMipIfIndex_Object((1,3,6,1,4,1,10876,101,1,150,1,26,1,1),_FsEcfmMipIfIndex_Type())
...
fsEcfmMipMdLevel=_FsEcfmMipMdLevel_Object((1,3,6,1,4,1,10876,101,1,150,1,26,1,2),_FsEcfmMipMdLevel_Type())
...
fsEcfmMipVid=_FsEcfmMipVid_Object((1,3,6,1,4,1,10876,101,1,150,1,26,1,3),_FsEcfmMipVid_Type())
...
fsEcfmMipActive=_FsEcfmMipActive_Object((1,3,6,1,4,1,10876,101,1,150,1,26,1,4),_FsEcfmMipActive_Type())
...
fsEcfmMipRowStatus=_FsEcfmMipRowStatus_Object((1,3,6,1,4,1,10876,101,1,150,1,26,1,5),_FsEcfmMipRowStatus_Type())
...
fsEcfmMipCcmDbTable=_FsEcfmMipCcmDbTable_Object((1,3,6,1,4,1,10876,101,1,150,1,27))
if mibBuilder.loadTexts:fsEcfmMipCcmDbTable.setStatus(_A)
_FsEcfmMipCcmDbEntry_Object=MibTableRow
fsEcfmMipCcmDbEntry=_FsEcfmMipCcmDbEntry_Object((1,3,6,1,4,1,10876,101,1,150,1,27,1))
...
fsEcfmMipCcmFid=_FsEcfmMipCcmFid_Object((1,3,6,1,4,1,10876,101,1,150,1,27,1,1),_FsEcfmMipCcmFid_Type())
...
fsEcfmMipCcmSrcAddr=_FsEcfmMipCcmSrcAddr_Object((1,3,6,1,4,1,10876,101,1,150,1,27,1,2),_FsEcfmMipCcmSrcAddr_Type())
...
fsEcfmMipCcmIfIndex=_FsEcfmMipCcmIfIndex_Object((1,3,6,1,4,1,10876,101,1,150,1,27,1,3),_FsEcfmMipCcmIfIndex_Type())
...
fsEcfmGlobalCcmOffload=_FsEcfmGlobalCcmOffload_Object((1,3,6,1,4,1,10876,101,1,150,1,28),_FsEcfmGlobalCcmOffload_Type())
...
fsEcfmDynMipPreventionTable=_FsEcfmDynMipPreventionTable_Object((1,3,6,1,4,1,10876,101,1,150,1,29))
if mibBuilder.loadTexts:fsEcfmDynMipPreventionTable.setStatus(_A)
_FsEcfmDynMipPreventionEntry_Object=MibTableRow
fsEcfmDynMipPreventionEntry=_FsEcfmDynMipPreventionEntry_Object((1,3,6,1,4,1,10876,101,1,150,1,29,1))
...
fsEcfmDynMipPreventionRowStatus=_FsEcfmDynMipPreventionRowStatus_Object((1,3,6,1,4,1,10876,101,1,150,1,29,1,1),_FsEcfmDynMipPreventionRowStatus_Type())
...
fsEcfmExObjects=_FsEcfmExObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,1,150,2))
_FsEcfmRemoteMepDbExTable_Object=MibTable
fsEcfmRemoteMepDbExTable=_FsEcfmRemoteMepDbExTable_Object((1,3,6,1,4,1,10876,101,1,150,2,1))
if mibBuilder.loadTexts:fsEcfmRemoteMepDbExTable.setStatus(_A)
_FsEcfmRemoteMepDbExEntry_Object=MibTableRow
fsEcfmRemoteMepDbExEntry=_FsEcfmRemoteMepDbExEntry_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1))
...
fsEcfmMdIndex=_FsEcfmMdIndex_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,1),_FsEcfmMdIndex_Type())
...
fsEcfmMaIndex=_FsEcfmMaIndex_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,2),_FsEcfmMaIndex_Type())
...
fsEcfmMepIdentifier=_FsEcfmMepIdentifier_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,3),_FsEcfmMepIdentifier_Type())
...
fsEcfmRMepIdentifier=_FsEcfmRMepIdentifier_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,4),_FsEcfmRMepIdentifier_Type())
...
fsEcfmRMepCcmSequenceNum=_FsEcfmRMepCcmSequenceNum_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,5),_FsEcfmRMepCcmSequenceNum_Type())
...
fsEcfmRMepPortStatusDefect=_FsEcfmRMepPortStatusDefect_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,6),_FsEcfmRMepPortStatusDefect_Type())
...
fsEcfmRMepInterfaceStatusDefect=_FsEcfmRMepInterfaceStatusDefect_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,7),_FsEcfmRMepInterfaceStatusDefect_Type())
...
fsEcfmRMepCcmDefect=_FsEcfmRMepCcmDefect_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,8),_FsEcfmRMepCcmDefect_Type())
...
fsEcfmRMepRDIDefect=_FsEcfmRMepRDIDefect_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,9),_FsEcfmRMepRDIDefect_Type())
...
fsEcfmRMepMacAddress=_FsEcfmRMepMacAddress_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,10),_FsEcfmRMepMacAddress_Type())
...
fsEcfmRMepRdi=_FsEcfmRMepRdi_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,11),_FsEcfmRMepRdi_Type())
...
fsEcfmRMepPortStatusTlv=_FsEcfmRMepPortStatusTlv_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,12),_FsEcfmRMepPortStatusTlv_Type())
...
fsEcfmRMepInterfaceStatusTlv=_FsEcfmRMepInterfaceStatusTlv_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,13),_FsEcfmRMepInterfaceStatusTlv_Type())
...
fsEcfmRMepChassisIdSubtype=_FsEcfmRMepChassisIdSubtype_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,14),_FsEcfmRMepChassisIdSubtype_Type())
...
fsEcfmMepDbChassisId=_FsEcfmMepDbChassisId_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,15),_FsEcfmMepDbChassisId_Type())
...
fsEcfmRMepManAddressDomain=_FsEcfmRMepManAddressDomain_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,16),_FsEcfmRMepManAddressDomain_Type())
...
fsEcfmRMepManAddress=_FsEcfmRMepManAddress_Object((1,3,6,1,4,1,10876,101,1,150,2,1,1,17),_FsEcfmRMepManAddress_Type())
...
fsEcfmLtmTable=_FsEcfmLtmTable_Object((1,3,6,1,4,1,10876,101,1,150,2,2))
if mibBuilder.loadTexts:fsEcfmLtmTable.setStatus(_A)
_FsEcfmLtmEntry_Object=MibTableRow
fsEcfmLtmEntry=_FsEcfmLtmEntry_Object((1,3,6,1,4,1,10876,101,1,150,2,2,1))
...
fsEcfmLtmSeqNumber=_FsEcfmLtmSeqNumber_Object((1,3,6,1,4,1,10876,101,1,150,2,2,1,1),_FsEcfmLtmSeqNumber_Type())
...
fsEcfmLtmTargetMacAddress=_FsEcfmLtmTargetMacAddress_Object((1,3,6,1,4,1,10876,101,1,150,2,2,1,2),_FsEcfmLtmTargetMacAddress_Type())
...
fsEcfmLtmTtl=_FsEcfmLtmTtl_Object((1,3,6,1,4,1,10876,101,1,150,2,2,1,3),_FsEcfmLtmTtl_Type())
fsEcfmLtmTtl.setMaxAccess(_K)
if mibBuilder.loadTexts:fsEcfmLtmTtl.setStatus(_A)
_FsEcfmMepExTable_Object=MibTable
fsEcfmMepExTable=_FsEcfmMepExTable_Object((1,3,6,1,4,1,10876,101,1,150,2,3))
if mibBuilder.loadTexts:fsEcfmMepExTable.setStatus(_A)
_FsEcfmMepExEntry_Object=MibTableRow
fsEcfmMepExEntry=_FsEcfmMepExEntry_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1))
...
fsEcfmXconnRMepId=_FsEcfmXconnRMepId_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,1),_FsEcfmXconnRMepId_Type())
...
fsEcfmErrorRMepId=_FsEcfmErrorRMepId_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,2),_FsEcfmErrorRMepId_Type())
...
fsEcfmMepDefectRDICcm=_FsEcfmMepDefectRDICcm_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,3),_FsEcfmMepDefectRDICcm_Type())
...
fsEcfmMepDefectMacStatus=_FsEcfmMepDefectMacStatus_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,4),_FsEcfmMepDefectMacStatus_Type())
...
fsEcfmMepDefectRemoteCcm=_FsEcfmMepDefectRemoteCcm_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,5),_FsEcfmMepDefectRemoteCcm_Type())
...
fsEcfmMepDefectErrorCcm=_FsEcfmMepDefectErrorCcm_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,6),_FsEcfmMepDefectErrorCcm_Type())
...
fsEcfmMepDefectXconnCcm=_FsEcfmMepDefectXconnCcm_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,7),_FsEcfmMepDefectXconnCcm_Type())
...
fsEcfmMepCcmOffload=_FsEcfmMepCcmOffload_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,8),_FsEcfmMepCcmOffload_Type())
...
fsEcfmMepLbrIn=_FsEcfmMepLbrIn_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,9),_FsEcfmMepLbrIn_Type())
...
fsEcfmMepLbrInOutOfOrder=_FsEcfmMepLbrInOutOfOrder_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,10),_FsEcfmMepLbrInOutOfOrder_Type())
...
fsEcfmMepLbrBadMsdu=_FsEcfmMepLbrBadMsdu_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,11),_FsEcfmMepLbrBadMsdu_Type())
...
fsEcfmMepUnexpLtrIn=_FsEcfmMepUnexpLtrIn_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,12),_FsEcfmMepUnexpLtrIn_Type())
...
fsEcfmMepLbrOut=_FsEcfmMepLbrOut_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,13),_FsEcfmMepLbrOut_Type())
...
fsEcfmMepCcmSequenceErrors=_FsEcfmMepCcmSequenceErrors_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,14),_FsEcfmMepCcmSequenceErrors_Type())
...
fsEcfmMepCciSentCcms=_FsEcfmMepCciSentCcms_Object((1,3,6,1,4,1,10876,101,1,150,2,3,1,15),_FsEcfmMepCciSentCcms_Type())
...
fsEcfmMdExTable=_FsEcfmMdExTable_Object((1,3,6,1,4,1,10876,101,1,150,2,4))
if mibBuilder.loadTexts:fsEcfmMdExTable.setStatus(_A)
_FsEcfmMdExEntry_Object=MibTableRow
fsEcfmMdExEntry=_FsEcfmMdExEntry_Object((1,3,6,1,4,1,10876,101,1,150,2,4,1))
...
fsEcfmMepArchiveHoldTime=_FsEcfmMepArchiveHoldTime_Object((1,3,6,1,4,1,10876,101,1,150,2,4,1,1),_FsEcfmMepArchiveHoldTime_Type())
...
fsEcfmMaExTable=_FsEcfmMaExTable_Object((1,3,6,1,4,1,10876,101,1,150,2,5))
if mibBuilder.loadTexts:fsEcfmMaExTable.setStatus(_A)
_FsEcfmMaExEntry_Object=MibTableRow
fsEcfmMaExEntry=_FsEcfmMaExEntry_Object((1,3,6,1,4,1,10876,101,1,150,2,5,1))
...
fsEcfmMaCrosscheckStatus=_FsEcfmMaCrosscheckStatus_Object((1,3,6,1,4,1,10876,101,1,150,2,5,1,1),_FsEcfmMaCrosscheckStatus_Type())
...
fsEcfmTrapsControl=_FsEcfmTrapsControl_ObjectIdentity((1,3,6,1,4,1,10876,101,1,150,3))
_FsEcfmTrapControl_Type=FsEcfmSetTraps
_FsEcfmTrapControl_Object=MibScalar
fsEcfmTrapControl=_FsEcfmTrapControl_Object((1,3,6,1,4,1,10876,101,1,150,3,1),_FsEcfmTrapControl_Type())
...
fsEcfmTrapType=_FsEcfmTrapType_Object((1,3,6,1,4,1,10876,101,1,150,3,2),_FsEcfmTrapType_Type())
...
fsEcfmTraps=_FsEcfmTraps_ObjectIdentity((1,3,6,1,4,1,10876,101,1,150,4))
_FutureEcfmTraps_ObjectIdentity=ObjectIdentity
futureEcfmTraps=_FutureEcfmTraps_ObjectIdentity((1,3,6,1,4,1,10876,101,1,150,4,0))
fsEcfmMepDefectTrap=NotificationType((1,3,6,1,4,1,10876,101,1,150,4,0,1))
