...
mibBuilder.exportSymbols("Juniper-IGMP-MIB", juniIgmpCompliance4=juniIgmpCompliance4, juniIgmpMIB=juniIgmpMIB, juniIgmpInterfaceAccessGroup=juniIgmpInterfaceAccessGroup, JuniIgmpProxyInterfaceState=JuniIgmpProxyInterfaceState, juniIgmpProxyCacheEntry=juniIgmpProxyCacheEntry, PYSNMP_MODULE_ID=juniIgmpMIB, JuniIgmpProxyGroupState=JuniIgmpProxyGroupState, juniIgmpProxyInterfaceV2JoinReportCount=juniIgmpProxyInterfaceV2JoinReportCount, juniIgmpInterfaceIoaPacketReplIfIndex=juniIgmpInterfaceIoaPacketReplIfIndex, juniIgmpProxyInterfaceV2QueryReceiveCount=juniIgmpProxyInterfaceV2QueryReceiveCount, juniIgmpGroupsSlot=juniIgmpGroupsSlot, juniIgmpProxyInterfaceMask=juniIgmpProxyInterfaceMask, juniIgmpGroups=juniIgmpGroups, juniIgmpProxyInterfaceEntry=juniIgmpProxyInterfaceEntry, juniIgmpProxyIfIndex=juniIgmpProxyIfIndex, juniIgmpGroupsPort=juniIgmpGroupsPort, juniIgmpInterfaceTable=juniIgmpInterfaceTable, juniIgmpCompliance=juniIgmpCompliance, juniIgmpProxyCacheGroup=juniIgmpProxyCacheGroup, juniIgmpGroupsMaxGroups=juniIgmpGroupsMaxGroups, juniIgmpProxyInterfaceUnsolicitedReportInterval=juniIgmpProxyInterfaceUnsolicitedReportInterval, juniIgmpInterfaceEntry=juniIgmpInterfaceEntry, juniIgmpProxyInterfaceStatus=juniIgmpProxyInterfaceStatus, juniIgmpGroupsTable2=juniIgmpGroupsTable2, juniIgmpMIBObject=juniIgmpMIBObject, juniIgmpProxyInterfaceV1JoinReportCount=juniIgmpProxyInterfaceV1JoinReportCount, juniIgmpCompliance2=juniIgmpCompliance2, juniIgmpGroupsMaxGroups2=juniIgmpGroupsMaxGroups2, juniIgmpProxyInterfaceV2ReportReceiveCount=juniIgmpProxyInterfaceV2ReportReceiveCount, juniIgmpProxyInterfaceWrongVersionCount=juniIgmpProxyInterfaceWrongVersionCount, juniIgmpProxyInterfaceGroup=juniIgmpProxyInterfaceGroup, juniIgmpInterfaceIfIndex=juniIgmpInterfaceIfIndex, juniIgmpInterfacePromiscuous=juniIgmpInterfacePromiscuous, juniIgmpGlobal=juniIgmpGlobal, juniIgmpProxyInterfaceV1ReportReceiveCount=juniIgmpProxyInterfaceV1ReportReceiveCount, juniIgmpConformance=juniIgmpConformance, juniIgmpProxyInterfaceTotalGroupCount=juniIgmpProxyInterfaceTotalGroupCount, juniIgmpProxyInterfaceState=juniIgmpProxyInterfaceState, juniIgmpGroupsGroup=juniIgmpGroupsGroup, juniIgmpIfLocationType=juniIgmpIfLocationType, juniIgmpProxyInterfaceLeaveReportCount=juniIgmpProxyInterfaceLeaveReportCount, juniIgmpGroupsEntry2=juniIgmpGroupsEntry2, juniIgmpInterfaceMaxGroups=juniIgmpInterfaceMaxGroups, juniIgmpInterfaceQuerierTimeout=juniIgmpInterfaceQuerierTimeout, juniIgmpProxy=juniIgmpProxy, juniIgmpProxyInterfaceIfIndex=juniIgmpProxyInterfaceIfIndex, juniIgmpInterfaceImmediateLeave=juniIgmpInterfaceImmediateLeave, juniIgmpProxyInterfaceAddress=juniIgmpProxyInterfaceAddress, juniIgmpProxyInterfaceV1RoutePresentTimeout=juniIgmpProxyInterfaceV1RoutePresentTimeout, juniIgmpProxyStatus=juniIgmpProxyStatus, juniIgmpInterfaceGroup2=juniIgmpInterfaceGroup2, juniIgmpIfLocationIndex=juniIgmpIfLocationIndex, juniIgmpProxyAddress=juniIgmpProxyAddress, juniIgmpProtocol=juniIgmpProtocol, juniIgmpAdminState=juniIgmpAdminState, juniIgmpProxyCacheTable=juniIgmpProxyCacheTable, juniIgmpGroupsGroup2=juniIgmpGroupsGroup2, juniIgmpProxyInterfaceV1QueryReceiveCount=juniIgmpProxyInterfaceV1QueryReceiveCount, juniIgmpProxyInterfaceVersion=juniIgmpProxyInterfaceVersion, juniIgmpCompliances=juniIgmpCompliances, juniIgmpInterfaceGroup=juniIgmpInterfaceGroup, juniIgmpGroupsEntry=juniIgmpGroupsEntry, juniIgmpProxyInterfaceTable=juniIgmpProxyInterfaceTable, juniIgmpCompliance3=juniIgmpCompliance3, juniIgmpRouterPromiscuous=juniIgmpRouterPromiscuous, juniIgmpGroupsTable=juniIgmpGroupsTable)
