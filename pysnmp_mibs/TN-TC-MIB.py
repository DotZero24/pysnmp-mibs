#
# PySNMP MIB module TN-TC-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/nokia/TN-TC-MIB
...
tnModules, = mibBuilder.importSymbols("TROPIC-GLOBAL-REG", "tnModules")
tnTCMIBModule = ModuleIdentity((1, 3, 6, 1, 4, 1, 7483, 5, 1, 2))
tnTCMIBModule.setRevisions(('2020-11-13 00:00', '2019-08-23 00:00', '2019-08-16 00:00', '2019-06-07 00:00', '2019-03-01 00:00', '2018-04-27 00:00', '2016-11-28 00:00', '2015-05-05 00:00', '2015-03-02 00:00', '2013-10-23 00:00', '2013-08-22 00:00', '2009-02-28 00:00', '2008-07-01 00:00', '2008-01-01 00:00', '2007-01-01 00:00', '2006-03-23 00:00', '2005-08-31 00:00', '2005-01-24 00:00', '2004-01-15 00:00', '2003-08-15 00:00', '2003-01-20 00:00', '2001-05-29 00:00',))
if mibBuilder.loadTexts: tnTCMIBModule.setLastUpdated('202011130000Z')
if mibBuilder.loadTexts: tnTCMIBModule.setOrganization('Nokia')
...
class TQPreempt(TextualConvention, Integer32):
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(0, 1))
    namedValues = NamedValues(("express", 0), ("preemptable", 1))
...
class SapLoopbackMode(TextualConvention, Integer32):
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3))
    namedValues = NamedValues(("disabled", 1), ("terminal", 2), ("facility", 3))

mibBuilder.exportSymbols("TN-TC-MIB", TmnxRadiusServerOperState=TmnxRadiusServerOperState, TAdaptationRuleOverride=TAdaptationRuleOverride, TmnxAccessLoopEncapDataLink=TmnxAccessLoopEncapDataLink, TQueueMode=TQueueMode, TmnxMobUeState=TmnxMobUeState, TPIRPercentOverride=TPIRPercentOverride, TmnxSubNasPortSuffixType=TmnxSubNasPortSuffixType, TmnxMobAuthType=TmnxMobAuthType, TProfileUseDEOrNone=TProfileUseDEOrNone, TEgrPolicerId=TEgrPolicerId, TmnxMldGroupFilterMode=TmnxMldGroupFilterMode, TmnxMobDiaPeerHost=TmnxMobDiaPeerHost, ServiceAdminStatus=ServiceAdminStatus, TmnxBsxTransPrefPolicyId=TmnxBsxTransPrefPolicyId, TBurstSizeBytesOverride=TBurstSizeBytesOverride, TmnxSlaProfileStringOrEmpty=TmnxSlaProfileStringOrEmpty, THPolPIRRateOverride=THPolPIRRateOverride, TmnxAncpStringOrZero=TmnxAncpStringOrZero, TPIRRate=TPIRRate, TBurstLimit=TBurstLimit, TFdbTableSizeProfileID=TFdbTableSizeProfileID, TmnxIkePolicyAuthMethod=TmnxIkePolicyAuthMethod, TTmplPolicyID=TTmplPolicyID, TmnxMobBearerType=TmnxMobBearerType, TmnxMobProfMbrRate=TmnxMobProfMbrRate, TmnxMobDiaTransTimer=TmnxMobDiaTransTimer, THPolVirtualSchePIRRate=THPolVirtualSchePIRRate, TAdaptationRule=TAdaptationRule, THsmdaCounterIdOrZero=THsmdaCounterIdOrZero, TSapIngressMeterId=TSapIngressMeterId, TmnxOperGrpHoldUpTime=TmnxOperGrpHoldUpTime, TmnxOperState=TmnxOperState, TmnxMobProfPolMeteringMethod=TmnxMobProfPolMeteringMethod, Dot1PPriorityMask=Dot1PPriorityMask, TmnxQosBytesHex=TmnxQosBytesHex, TmnxEnabledDisabledOrInherit=TmnxEnabledDisabledOrInherit, TEgrRateModType=TEgrRateModType, TmnxIngPolicerStatMode=TmnxIngPolicerStatMode, TmnxMobQci=TmnxMobQci, THPolCIRRateOverride=THPolCIRRateOverride, TIngressQueueId=TIngressQueueId, TmnxMobArp=TmnxMobArp, TmnxActionType=TmnxActionType, TmnxVPNRouteDistinguisher=TmnxVPNRouteDistinguisher, TmnxAccessLoopEncaps2=TmnxAccessLoopEncaps2, TmnxRadiusPendingReqLimit=TmnxRadiusPendingReqLimit, TmnxAdminState=TmnxAdminState, TRateType=TRateType, TEgressHsmdaCounterId=TEgressHsmdaCounterId, TmnxAccPlcyOECounters=TmnxAccPlcyOECounters, TPerPacketOffsetOvr=TPerPacketOffsetOvr, TmnxMobSdfFilterProtocol=TmnxMobSdfFilterProtocol, TmnxVdoOutputFormat=TmnxVdoOutputFormat, TSapEgrEncapGroupType=TSapEgrEncapGroupType, THPolCIRRate=THPolCIRRate, TmnxAccPlcyQICounters=TmnxAccPlcyQICounters, TEgressHsmdaCounterIdOrZero=TEgressHsmdaCounterIdOrZero, TmnxIPsecTunnelTemplateId=TmnxIPsecTunnelTemplateId, TPIRRateOverride=TPIRRateOverride, TmnxVdoAnalyzerAlarmStates=TmnxVdoAnalyzerAlarmStates, TNetworkIngressMeterId=TNetworkIngressMeterId, TBurstSizeBytes=TBurstSizeBytes, TmnxMobServRefPointType=TmnxMobServRefPointType, TmnxMobQciValue=TmnxMobQciValue, TmnxStatus=TmnxStatus, TmnxMsPwPeSignaling=TmnxMsPwPeSignaling, TmnxManagedRouteStatus=TmnxManagedRouteStatus, TmnxMacSpecification=TmnxMacSpecification, TmnxMobChargingLevel=TmnxMobChargingLevel, TmnxAppProfileStringOrEmpty=TmnxAppProfileStringOrEmpty, TCIRRateOverride=TCIRRateOverride, TmnxMobImsi=TmnxMobImsi, TmnxMobApn=TmnxMobApn, TItemDescription=TItemDescription, TmnxVdoGrpId=TmnxVdoGrpId, TmnxVRtrIDOrZero=TmnxVRtrIDOrZero, TIpOption=TIpOption, TmnxMobProfName=TmnxMobProfName, TmnxMobSdfFilterNum=TmnxMobSdfFilterNum, QTagFullRange=QTagFullRange, TEgressQueueId=TEgressQueueId, TmnxMplsTpTunnelType=TmnxMplsTpTunnelType, TmnxVcType=TmnxVcType, TmnxMobServerState=TmnxMobServerState, TmnxSpokeSdpId=TmnxSpokeSdpId, IpAddressPrefixLength=IpAddressPrefixLength, TFCSet=TFCSet, TLspExpValue=TLspExpValue, TDSCPValueOrNone=TDSCPValueOrNone, TmnxMobAccessType=TmnxMobAccessType, TmnxMobUeStrPrefix=TmnxMobUeStrPrefix, THsmdaSchedulerPolicyGroupId=THsmdaSchedulerPolicyGroupId, TDSCPName=TDSCPName, TPerPacketOffset=TPerPacketOffset, TmnxTunnelGroupId=TmnxTunnelGroupId, TmnxMobMccOrEmpty=TmnxMobMccOrEmpty, TItemScope=TItemScope, TmnxPppoeUserNameOrEmpty=TmnxPppoeUserNameOrEmpty, TmnxPppoeSessionId=TmnxPppoeSessionId, BgpPeeringStatus=BgpPeeringStatus, TEgrHsmdaPerPacketOffsetOvr=TEgrHsmdaPerPacketOffsetOvr, TmnxMlpppEpClass=TmnxMlpppEpClass, TmnxMplsTpGlobalID=TmnxMplsTpGlobalID, TmnxMobProfPolReportingLevel=TmnxMobProfPolReportingLevel, TmnxAppProfileString=TmnxAppProfileString, TAdvCfgRate=TAdvCfgRate, TmnxMobPdnSessionState=TmnxMobPdnSessionState, TmnxMobNode=TmnxMobNode, QTag=QTag, TSapIngressPolicyID=TSapIngressPolicyID, TPortSchedulerCIR=TPortSchedulerCIR, TMacFilterType=TMacFilterType, TmnxPwPathHopIdOrZero=TmnxPwPathHopIdOrZero, TmnxSvcOperGrpCreationOrigin=TmnxSvcOperGrpCreationOrigin, TmnxAccessLoopEncaps1=TmnxAccessLoopEncaps1, TIPFilterID=TIPFilterID, TmnxSlaProfileString=TmnxSlaProfileString, TFCType=TFCType, TmnxRsvpDSTEClassType=TmnxRsvpDSTEClassType, TmnxMobStaticPolPrecedenceOrZero=TmnxMobStaticPolPrecedenceOrZero, TmnxSubMgtOrgStrOrZero=TmnxSubMgtOrgStrOrZero, TmnxCdrDiagnosticAction=TmnxCdrDiagnosticAction, TmnxSubRadiusAttrType=TmnxSubRadiusAttrType, TmnxPppoeUserName=TmnxPppoeUserName, QTagFullRangeOrNone=QTagFullRangeOrNone, ServiceAccessPoint=ServiceAccessPoint, TmnxOspfInstance=TmnxOspfInstance, TmnxPppoeSessionType=TmnxPppoeSessionType, TNetworkPolicyID=TNetworkPolicyID, THsmdaWrrWeightOverride=THsmdaWrrWeightOverride, TSiteOperStatus=TSiteOperStatus, TmnxMobChargingProfileOrInherit=TmnxMobChargingProfileOrInherit, TmnxMobLiTarget=TmnxMobLiTarget, THsmdaCIRKRate=THsmdaCIRKRate, TmnxPwGlobalIdOrZero=TmnxPwGlobalIdOrZero, QTagOrZero=QTagOrZero, THsmdaWeight=THsmdaWeight, TWeight=TWeight, TmnxMobProfPolChargingMethod=TmnxMobProfPolChargingMethod, TmnxTunnelType=TmnxTunnelType, TmnxSubMgtOrgString=TmnxSubMgtOrgString, TProfileOrDei=TProfileOrDei, TmnxEnabledDisabled=TmnxEnabledDisabled, TMlpppQoSProfileId=TMlpppQoSProfileId, TDEValue=TDEValue, TmnxLdpFECType=TmnxLdpFECType, TmnxReasContextVal=TmnxReasContextVal, TFCNameOrEmpty=TFCNameOrEmpty, TmnxVwmCardType=TmnxVwmCardType, TPolicyStatementNameOrEmpty=TPolicyStatementNameOrEmpty, TRemarkType=TRemarkType, TLevel=TLevel, TmnxCdrType=TmnxCdrType, TTcpUdpPortOperator=TTcpUdpPortOperator, TPortSchedulerPIRRate=TPortSchedulerPIRRate, TBurstPercentOrDefaultOverride=TBurstPercentOrDefaultOverride, TmnxOperGrpHoldDownTime=TmnxOperGrpHoldDownTime, TIngressHsmdaPerPacketOffset=TIngressHsmdaPerPacketOffset, TmnxAccPlcyAACounters=TmnxAccPlcyAACounters, TmnxMobSdf=TmnxMobSdf, TBurstHundredthsOfPercent=TBurstHundredthsOfPercent, PYSNMP_MODULE_ID=tnTCMIBModule, TmnxTunnelGroupIdOrZero=TmnxTunnelGroupIdOrZero, THsmdaPIRMRate=THsmdaPIRMRate, TAtmTdpDescrType=TAtmTdpDescrType, TPrecValueOrNone=TPrecValueOrNone, TmnxMobUeIdType=TmnxMobUeIdType, TEntryIndicator=TEntryIndicator, THPolPIRRate=THPolPIRRate, SapLoopbackMode=SapLoopbackMode, THsmdaWrrWeight=THsmdaWrrWeight, TmnxTlsGroupId=TmnxTlsGroupId, TmnxMobUeId=TmnxMobUeId, TmnxSubNasPortPrefixType=TmnxSubNasPortPrefixType, TmnxIngPolicerStatModeOverride=TmnxIngPolicerStatModeOverride, THSMDAQueueBurstLimit=THSMDAQueueBurstLimit, TFCName=TFCName, TIngressHsmdaQueueId=TIngressHsmdaQueueId, TPriorityOrUndefined=TPriorityOrUndefined, TBurstPercentOrDefault=TBurstPercentOrDefault, TMcFrQoSProfileId=TMcFrQoSProfileId, TmnxMobSdfFilter=TmnxMobSdfFilter, TmnxMldGroupType=TmnxMldGroupType, InterfaceIndex=InterfaceIndex, TDirection=TDirection, TMaxDecRate=TMaxDecRate, TmnxMobPdnRefPointType=TmnxMobPdnRefPointType, TmnxMobPgwSigProtocol=TmnxMobPgwSigProtocol, TmnxMobArpValue=TmnxMobArpValue, TmnxMobArpValueOrZero=TmnxMobArpValueOrZero, TDEProfile=TDEProfile, TmnxSpbFid=TmnxSpbFid, TmnxVcId=TmnxVcId, TSdpEgressPolicyID=TSdpEgressPolicyID, TPIRRateOrZero=TPIRRateOrZero, TCpmProtPolicyID=TCpmProtPolicyID, TmnxVRtrID=TmnxVRtrID, TmnxMdaQos=TmnxMdaQos, TmnxMobAuthUserName=TmnxMobAuthUserName, TmnxMobQciValueOrZero=TmnxMobQciValueOrZero, TmnxPortID=TmnxPortID, TmnxMobProfGbrRate=TmnxMobProfGbrRate, TmnxSpbFdbState=TmnxSpbFdbState, TLevelOrDefault=TLevelOrDefault, TQGroupType=TQGroupType, TmnxVcIdOrNone=TmnxVcIdOrNone, TCpmProtPolicyIDOrDefault=TCpmProtPolicyIDOrDefault, TmnxVdoStatInt=TmnxVdoStatInt, TmnxSpbFidOrZero=TmnxSpbFidOrZero, TmnxTimeInSec=TmnxTimeInSec, TmnxMulticastAddrFamily=TmnxMulticastAddrFamily, TmnxIpSecIsaOperFlags=TmnxIpSecIsaOperFlags, THsmdaCIRMRateOverride=THsmdaCIRMRateOverride, TmnxMobNai=TmnxMobNai, TmnxMobPeerType=TmnxMobPeerType, TmnxSubRadServAlgorithm=TmnxSubRadServAlgorithm, TmnxMobMncOrEmpty=TmnxMobMncOrEmpty, TmnxSubMgtIntDestId=TmnxSubMgtIntDestId, TmnxMobPdnType=TmnxMobPdnType, TmnxEgrPolicerStatModeOverride=TmnxEgrPolicerStatModeOverride, THsmdaPIRKRate=THsmdaPIRKRate, TmnxCustId=TmnxCustId, TmnxAncpString=TmnxAncpString, TmnxSpbBridgePriority=TmnxSpbBridgePriority, TmnxMobAddrScheme=TmnxMobAddrScheme, TSysResource=TSysResource, TmnxMobDfPeerId=TmnxMobDfPeerId, TmnxMobPdnGyChrgTriggerType=TmnxMobPdnGyChrgTriggerType, THSMDABurstSizeBytesOverride=THSMDABurstSizeBytesOverride, THsmdaCIRMRate=THsmdaCIRMRate, THsmdaPIRKRateOverride=THsmdaPIRKRateOverride, TmnxMobRatingGrpState=TmnxMobRatingGrpState, TClassBurstLimit=TClassBurstLimit, TIngPolicerIdOrNone=TIngPolicerIdOrNone, TmnxMobBearerId=TmnxMobBearerId, TmnxMobDiaRetryCount=TmnxMobDiaRetryCount, TmnxMobUeSubType=TmnxMobUeSubType, TmnxSubRadiusVendorId=TmnxSubRadiusVendorId, TmnxVdoIfName=TmnxVdoIfName, TmnxMobUeRat=TmnxMobUeRat, TmnxMobDualStackPref=TmnxMobDualStackPref, TmnxBsxAarpServiceRefType=TmnxBsxAarpServiceRefType, TmnxStrSapId=TmnxStrSapId, TmnxIgmpGroupType=TmnxIgmpGroupType, TmnxMobRtrAdvtLifeTime=TmnxMobRtrAdvtLifeTime, TmnxDhcpOptionType=TmnxDhcpOptionType, TCIRRate=TCIRRate, TmnxMldVersion=TmnxMldVersion, THPolVirtualScheCIRRate=THPolVirtualScheCIRRate, TFIRRate=TFIRRate, TSdpIngressPolicyID=TSdpIngressPolicyID, TExpSecondaryShaperClassRate=TExpSecondaryShaperClassRate, TmnxBsxTransitIpPolicyId=TmnxBsxTransitIpPolicyId, TmnxMobSdfFilterDirection=TmnxMobSdfFilterDirection)
mibBuilder.exportSymbols("TN-TC-MIB", TmnxMobGwId=TmnxMobGwId, TmnxVRtrMplsLspID=TmnxVRtrMplsLspID, TmnxMobChargingBearerType=TmnxMobChargingBearerType, TmnxMobDiaPathMgmtState=TmnxMobDiaPathMgmtState, TmnxDefSubIdSource=TmnxDefSubIdSource, TmnxDefInterDestIdSource=TmnxDefInterDestIdSource, TmnxSubProfileString=TmnxSubProfileString, TmnxBinarySpecification=TmnxBinarySpecification, TExpSecondaryShaperPIRRate=TExpSecondaryShaperPIRRate, TmnxSrrpPriorityStep=TmnxSrrpPriorityStep, TEgrPolicerIdOrNone=TEgrPolicerIdOrNone, TmnxMobImei=TmnxMobImei, TmnxPppoeSessionInfoOrigin=TmnxPppoeSessionInfoOrigin, TmnxAccPlcyQECounters=TmnxAccPlcyQECounters, TDSCPValue=TDSCPValue, TmnxMobRtrAdvtInterval=TmnxMobRtrAdvtInterval, TIngHsmdaPerPacketOffsetOvr=TIngHsmdaPerPacketOffsetOvr, TmnxMobStaticPolPrecedence=TmnxMobStaticPolPrecedence, TmnxEncapVal=TmnxEncapVal, THsmdaWeightOverride=THsmdaWeightOverride, TmnxPppoePadoDelay=TmnxPppoePadoDelay, TmnxThresholdGroupType=TmnxThresholdGroupType, TmnxMobBufferLimit=TmnxMobBufferLimit, TmnxSpokeSdpIdOrZero=TmnxSpokeSdpIdOrZero, TSubHostId=TSubHostId, TItemMatch=TItemMatch, TOperator=TOperator, TmnxSubIdentStringOrEmpty=TmnxSubIdentStringOrEmpty, TEgressQPerPacketOffset=TEgressQPerPacketOffset, TmnxPwPathHopId=TmnxPwPathHopId, TSecondaryShaper10GPIRRate=TSecondaryShaper10GPIRRate, THsmdaCounterIdOrZeroOrAll=THsmdaCounterIdOrZeroOrAll, TIngPolicerId=TIngPolicerId, TPolicerWeight=TPolicerWeight, TmnxMobRfAcctLevel=TmnxMobRfAcctLevel, TmnxEgrPolicerStatMode=TmnxEgrPolicerStatMode, TmnxTunnelID=TmnxTunnelID, TmnxMobMsisdn=TmnxMobMsisdn, TmnxBgpAutonomousSystem=TmnxBgpAutonomousSystem, TmnxMobDiaDetailPathMgmtState=TmnxMobDiaDetailPathMgmtState, TmnxMobMcc=TmnxMobMcc, TmnxMobApnOrZero=TmnxMobApnOrZero, TPlcyMode=TPlcyMode, TmnxVdoFccServerMode=TmnxVdoFccServerMode, TSapEgrEncapGroupActionType=TSapEgrEncapGroupActionType, TPortSchedulerPIR=TPortSchedulerPIR, TmnxAiiType=TmnxAiiType, TmnxServId=TmnxServId, TFilterID=TFilterID, TQueueIdOrAll=TQueueIdOrAll, TEntryId=TEntryId, TPlcrBurstSizeBytesOverride=TPlcrBurstSizeBytesOverride, tnTCMIBModule=tnTCMIBModule, TTcpUdpPort=TTcpUdpPort, ServObjDesc=ServObjDesc, TLNamedItem=TLNamedItem, TNamedItem=TNamedItem, SdpBindId=SdpBindId, TmnxMplsTpNodeID=TmnxMplsTpNodeID, THsmdaPIRMRateOverride=THsmdaPIRMRateOverride, TProfileOrNone=TProfileOrNone, TQWeight=TQWeight, TmnxSubMgtIntDestIdOrEmpty=TmnxSubMgtIntDestIdOrEmpty, TPlcrBurstSizeBytes=TPlcrBurstSizeBytes, TmnxMobIpCanType=TmnxMobIpCanType, TmnxBsxTransitIpPolicyIdOrZero=TmnxBsxTransitIpPolicyIdOrZero, TPriority=TPriority, TmnxBsxAarpId=TmnxBsxAarpId, TmnxSubIdentString=TmnxSubIdentString, TmnxBgpPreference=TmnxBgpPreference, TFrameType=TFrameType, TIpProtocol=TIpProtocol, TmnxIgmpGroupFilterMode=TmnxIgmpGroupFilterMode, TIngressMeterId=TIngressMeterId, TmnxMobGwType=TmnxMobGwType, TmnxIgmpVersion=TmnxIgmpVersion, TmnxMobMnc=TmnxMobMnc, TQosQGrpInstanceIDorZero=TQosQGrpInstanceIDorZero, TSapEgressPolicyID=TSapEgressPolicyID, TMeterMode=TMeterMode, TIngressHsmdaCounterId=TIngressHsmdaCounterId, TRatePercent=TRatePercent, TmnxPwGlobalId=TmnxPwGlobalId, TmnxIkePolicyOwnAuthMethod=TmnxIkePolicyOwnAuthMethod, TmnxSubAleOffset=TmnxSubAleOffset, TmnxMobChargingProfile=TmnxMobChargingProfile, TmnxVdoGrpIdOrInherit=TmnxVdoGrpIdOrInherit, TmnxIPsecTunnelTemplateIdOrZero=TmnxIPsecTunnelTemplateIdOrZero, TDSCPNameOrEmpty=TDSCPNameOrEmpty, TmnxBgpRouteTarget=TmnxBgpRouteTarget, TBurstSizeOverride=TBurstSizeOverride, THSMDABurstSizeBytes=THSMDABurstSizeBytes, TmnxFilterProfileStringOrEmpty=TmnxFilterProfileStringOrEmpty, TmnxSlopeMap=TmnxSlopeMap, TPIRRatePercent=TPIRRatePercent, Dot1PPriority=Dot1PPriority, TNamedItemOrEmpty=TNamedItemOrEmpty, TmnxBsxTransPrefPolicyIdOrZero=TmnxBsxTransPrefPolicyIdOrZero, TSapEgrEncapGrpQosPolicyIdOrZero=TSapEgrEncapGrpQosPolicyIdOrZero, TDSCPFilterActionValue=TDSCPFilterActionValue, TmnxMobPresenceState=TmnxMobPresenceState, TmnxMobQueueLimit=TmnxMobQueueLimit, TNonZeroWeight=TNonZeroWeight, TQPreempt=TQPreempt, TEgressHsmdaQueueId=TEgressHsmdaQueueId, TmnxSubProfileStringOrEmpty=TmnxSubProfileStringOrEmpty, TmnxMobProfNameOrEmpty=TmnxMobProfNameOrEmpty, TmnxBfdSessOperState=TmnxBfdSessOperState, TLNamedItemOrEmpty=TLNamedItemOrEmpty, TmnxMobPathMgmtState=TmnxMobPathMgmtState, THsmdaCIRKRateOverride=THsmdaCIRKRateOverride, TmnxBsxAarpIdOrZero=TmnxBsxAarpIdOrZero, THsmdaPolicyIncludeQueues=THsmdaPolicyIncludeQueues, TmnxBGPFamilyType=TmnxBGPFamilyType, TPrecValue=TPrecValue, TPolicerRateType=TPolicerRateType, TmnxSpbFdbLocale=TmnxSpbFdbLocale, TBurstSize=TBurstSize, TCIRPercentOverride=TCIRPercentOverride, TPolicyID=TPolicyID, TmnxVdoPortNumber=TmnxVdoPortNumber, TItemLongDescription=TItemLongDescription, TmnxAsciiSpecification=TmnxAsciiSpecification, TMatchCriteria=TMatchCriteria, TQosOverrideType=TQosOverrideType, TmnxMobImsiStr=TmnxMobImsiStr, TEgressHsmdaPerPacketOffset=TEgressHsmdaPerPacketOffset, TmnxVdoGrpIdIndex=TmnxVdoGrpIdIndex, TnSwitchID=TnSwitchID, TmnxDHCP6MsgType=TmnxDHCP6MsgType, TMplsLspExpProfMapID=TMplsLspExpProfMapID, TmnxMobProfIpTtl=TmnxMobProfIpTtl, TQueueId=TQueueId, TmnxMobLiTargetType=TmnxMobLiTargetType, ServiceOperStatus=ServiceOperStatus, TmnxBgpLocalPreference=TmnxBgpLocalPreference, TmnxMobSdfRuleName=TmnxMobSdfRuleName, TmnxAccPlcyOICounters=TmnxAccPlcyOICounters, TPriorityOrDefault=TPriorityOrDefault, TBurstPercent=TBurstPercent, TmnxVpnIpBackupFamily=TmnxVpnIpBackupFamily, TProfile=TProfile, TBWRateType=TBWRateType, TmnxSubNasPortTypeType=TmnxSubNasPortTypeType, TmnxMobPdnSessionEvent=TmnxMobPdnSessionEvent, THsmdaPolicyScheduleClass=THsmdaPolicyScheduleClass, TIngressHsmdaCounterIdOrZero=TIngressHsmdaCounterIdOrZero, TMACFilterID=TMACFilterID, TmnxPppNcpProtocol=TmnxPppNcpProtocol, TmnxVdoAnalyzerAlarm=TmnxVdoAnalyzerAlarm, TDEProfileOrDei=TDEProfileOrDei, THsmdaWeightClass=THsmdaWeightClass, TmnxSubAleOffsetMode=TmnxSubAleOffsetMode)
