...
mibBuilder.exportSymbols("TN-TC-MIB", TBurstPercentOrDefaultOverride=TBurstPercentOrDefaultOverride, TRemarkType=TRemarkType, TmnxMobProfName=TmnxMobProfName, TmnxQosBytesHex=TmnxQosBytesHex, TIngressQueueId=TIngressQueueId, TmnxMobAuthUserName=TmnxMobAuthUserName, TmnxBsxTransitIpPolicyId=TmnxBsxTransitIpPolicyId, THsmdaCIRKRate=THsmdaCIRKRate, THsmdaCIRMRateOverride=THsmdaCIRMRateOverride, THsmdaPIRMRateOverride=THsmdaPIRMRateOverride, TmnxMobUeState=TmnxMobUeState, TmnxMobSdfRuleName=TmnxMobSdfRuleName, TmnxTunnelGroupIdOrZero=TmnxTunnelGroupIdOrZero, TmnxMobChargingBearerType=TmnxMobChargingBearerType, TmnxMobMncOrEmpty=TmnxMobMncOrEmpty, TmnxMobBufferLimit=TmnxMobBufferLimit, TmnxVcType=TmnxVcType, TPolicerWeight=TPolicerWeight, IpAddressPrefixLength=IpAddressPrefixLength, TBurstPercentOrDefault=TBurstPercentOrDefault, TmnxRadiusServerOperState=TmnxRadiusServerOperState, TPortSchedulerCIR=TPortSchedulerCIR, TSapEgrEncapGroupActionType=TSapEgrEncapGroupActionType, TmnxSubMgtOrgStrOrZero=TmnxSubMgtOrgStrOrZero, TmnxSpbFidOrZero=TmnxSpbFidOrZero, TmnxRadiusPendingReqLimit=TmnxRadiusPendingReqLimit, TmnxPwPathHopId=TmnxPwPathHopId, TCIRRate=TCIRRate, THsmdaCIRMRate=THsmdaCIRMRate, TmnxMldGroupFilterMode=TmnxMldGroupFilterMode, TmnxMobBearerType=TmnxMobBearerType, TQGroupType=TQGroupType, TmnxMobApnOrZero=TmnxMobApnOrZero, TmnxIngPolicerStatModeOverride=TmnxIngPolicerStatModeOverride, TTcpUdpPort=TTcpUdpPort, TmnxVPNRouteDistinguisher=TmnxVPNRouteDistinguisher, TIngHsmdaPerPacketOffsetOvr=TIngHsmdaPerPacketOffsetOvr, TmnxMobUeId=TmnxMobUeId, TEgressHsmdaCounterId=TEgressHsmdaCounterId, TQWeight=TQWeight, TPerPacketOffset=TPerPacketOffset, THsmdaPIRKRateOverride=THsmdaPIRKRateOverride, TmnxAncpString=TmnxAncpString, TmnxAccPlcyOECounters=TmnxAccPlcyOECounters, TSdpEgressPolicyID=TSdpEgressPolicyID, TEgressHsmdaCounterIdOrZero=TEgressHsmdaCounterIdOrZero, TmnxMobGwType=TmnxMobGwType, TEgressHsmdaQueueId=TEgressHsmdaQueueId, TmnxIgmpGroupType=TmnxIgmpGroupType, TTcpUdpPortOperator=TTcpUdpPortOperator, TMeterMode=TMeterMode, TmnxSubNasPortSuffixType=TmnxSubNasPortSuffixType, TBurstLimit=TBurstLimit, THPolCIRRateOverride=THPolCIRRateOverride, THSMDABurstSizeBytes=THSMDABurstSizeBytes, TmnxStatus=TmnxStatus, TmnxMobMsisdn=TmnxMobMsisdn, TmnxVdoIfName=TmnxVdoIfName, ServObjDesc=ServObjDesc, TmnxCdrType=TmnxCdrType, TmnxBgpAutonomousSystem=TmnxBgpAutonomousSystem, TmnxEnabledDisabledOrInherit=TmnxEnabledDisabledOrInherit, SdpBindId=SdpBindId, TBurstPercent=TBurstPercent, TmnxMobRtrAdvtInterval=TmnxMobRtrAdvtInterval, TEgressQPerPacketOffset=TEgressQPerPacketOffset, THsmdaCounterIdOrZeroOrAll=THsmdaCounterIdOrZeroOrAll, TPolicyID=TPolicyID, TmnxMsPwPeSignaling=TmnxMsPwPeSignaling, TmnxDefSubIdSource=TmnxDefSubIdSource, TIngressHsmdaPerPacketOffset=TIngressHsmdaPerPacketOffset, TmnxMobPdnSessionState=TmnxMobPdnSessionState, TSapIngressMeterId=TSapIngressMeterId, TmnxMobUeRat=TmnxMobUeRat, TmnxSubMgtIntDestIdOrEmpty=TmnxSubMgtIntDestIdOrEmpty, SapLoopbackMode=SapLoopbackMode, TmnxMobNai=TmnxMobNai, TmnxMobPresenceState=TmnxMobPresenceState, TmnxMobStaticPolPrecedence=TmnxMobStaticPolPrecedence, TEgrPolicerId=TEgrPolicerId, TmnxMobMnc=TmnxMobMnc, TmnxSubMgtOrgString=TmnxSubMgtOrgString, TmnxIkePolicyOwnAuthMethod=TmnxIkePolicyOwnAuthMethod, TmnxBgpRouteTarget=TmnxBgpRouteTarget, TmnxMobProfPolMeteringMethod=TmnxMobProfPolMeteringMethod, PYSNMP_MODULE_ID=tnTCMIBModule, Dot1PPriorityMask=Dot1PPriorityMask, TmnxReasContextVal=TmnxReasContextVal, TmnxMobDualStackPref=TmnxMobDualStackPref, TItemScope=TItemScope, TEgrRateModType=TEgrRateModType, TmnxMobUeSubType=TmnxMobUeSubType, QTagOrZero=QTagOrZero, THsmdaPIRMRate=THsmdaPIRMRate, TmnxMobPdnSessionEvent=TmnxMobPdnSessionEvent, TmnxLdpFECType=TmnxLdpFECType, TBurstHundredthsOfPercent=TBurstHundredthsOfPercent, TmnxMobQueueLimit=TmnxMobQueueLimit, TOperator=TOperator, THPolVirtualSchePIRRate=THPolVirtualSchePIRRate, TEgrPolicerIdOrNone=TEgrPolicerIdOrNone, TLevelOrDefault=TLevelOrDefault, TmnxVdoGrpId=TmnxVdoGrpId, TmnxMobChargingLevel=TmnxMobChargingLevel, TmnxTlsGroupId=TmnxTlsGroupId, TmnxSlopeMap=TmnxSlopeMap, TAdaptationRuleOverride=TAdaptationRuleOverride, TmnxIngPolicerStatMode=TmnxIngPolicerStatMode, QTag=QTag, TRatePercent=TRatePercent, TmnxSlaProfileString=TmnxSlaProfileString, TmnxVdoStatInt=TmnxVdoStatInt, TmnxMldVersion=TmnxMldVersion, TmnxAppProfileStringOrEmpty=TmnxAppProfileStringOrEmpty, TNamedItemOrEmpty=TNamedItemOrEmpty, TmnxIgmpVersion=TmnxIgmpVersion, TmnxDHCP6MsgType=TmnxDHCP6MsgType, TMaxDecRate=TMaxDecRate, TMlpppQoSProfileId=TMlpppQoSProfileId, TmnxSubRadiusAttrType=TmnxSubRadiusAttrType, TCpmProtPolicyIDOrDefault=TCpmProtPolicyIDOrDefault, THSMDAQueueBurstLimit=THSMDAQueueBurstLimit, TmnxPwGlobalIdOrZero=TmnxPwGlobalIdOrZero, TmnxStrSapId=TmnxStrSapId, TmnxMobNode=TmnxMobNode, TmnxVdoAnalyzerAlarmStates=TmnxVdoAnalyzerAlarmStates, TPIRPercentOverride=TPIRPercentOverride, TmnxSpbFdbState=TmnxSpbFdbState, TmnxActionType=TmnxActionType, TmnxOspfInstance=TmnxOspfInstance, TmnxSubNasPortTypeType=TmnxSubNasPortTypeType, TmnxDefInterDestIdSource=TmnxDefInterDestIdSource, TSiteOperStatus=TSiteOperStatus, TmnxSubAleOffset=TmnxSubAleOffset, TmnxMobSdfFilter=TmnxMobSdfFilter, TSapEgressPolicyID=TSapEgressPolicyID, TPIRRatePercent=TPIRRatePercent, TmnxBsxTransitIpPolicyIdOrZero=TmnxBsxTransitIpPolicyIdOrZero, TmnxThresholdGroupType=TmnxThresholdGroupType, TTmplPolicyID=TTmplPolicyID, TmnxSubRadServAlgorithm=TmnxSubRadServAlgorithm, TPortSchedulerPIRRate=TPortSchedulerPIRRate, TClassBurstLimit=TClassBurstLimit, TIPFilterID=TIPFilterID, TmnxMobPathMgmtState=TmnxMobPathMgmtState, TmnxBgpPreference=TmnxBgpPreference, TmnxManagedRouteStatus=TmnxManagedRouteStatus, TmnxMobQciValue=TmnxMobQciValue, TmnxMobDiaPeerHost=TmnxMobDiaPeerHost, TmnxOperGrpHoldUpTime=TmnxOperGrpHoldUpTime, TmnxCustId=TmnxCustId, THsmdaWeightClass=THsmdaWeightClass, TPriorityOrDefault=TPriorityOrDefault, TmnxTunnelType=TmnxTunnelType, TIpOption=TIpOption, TPlcrBurstSizeBytes=TPlcrBurstSizeBytes, TDSCPValue=TDSCPValue, TmnxMobPdnGyChrgTriggerType=TmnxMobPdnGyChrgTriggerType, TmnxMdaQos=TmnxMdaQos, TmnxEnabledDisabled=TmnxEnabledDisabled, TmnxEncapVal=TmnxEncapVal, TmnxAccessLoopEncaps2=TmnxAccessLoopEncaps2, TmnxMplsTpTunnelType=TmnxMplsTpTunnelType, TmnxMobQciValueOrZero=TmnxMobQciValueOrZero, TmnxMacSpecification=TmnxMacSpecification, TIngressMeterId=TIngressMeterId, THsmdaPolicyIncludeQueues=THsmdaPolicyIncludeQueues, TPortSchedulerPIR=TPortSchedulerPIR, TmnxMobArpValue=TmnxMobArpValue, TmnxMobSdfFilterDirection=TmnxMobSdfFilterDirection, THsmdaWrrWeight=THsmdaWrrWeight, TDEValue=TDEValue, TmnxBsxTransPrefPolicyIdOrZero=TmnxBsxTransPrefPolicyIdOrZero, TmnxMobRtrAdvtLifeTime=TmnxMobRtrAdvtLifeTime, TFrameType=TFrameType, TmnxMobProfMbrRate=TmnxMobProfMbrRate, TFIRRate=TFIRRate, TmnxVRtrID=TmnxVRtrID, TmnxSlaProfileStringOrEmpty=TmnxSlaProfileStringOrEmpty, TItemMatch=TItemMatch, TmnxSubNasPortPrefixType=TmnxSubNasPortPrefixType, TmnxPppoePadoDelay=TmnxPppoePadoDelay, TmnxMldGroupType=TmnxMldGroupType, TProfileOrNone=TProfileOrNone, TIngPolicerIdOrNone=TIngPolicerIdOrNone, TmnxAccPlcyOICounters=TmnxAccPlcyOICounters, TIngPolicerId=TIngPolicerId, TmnxMobChargingProfile=TmnxMobChargingProfile, TmnxVdoGrpIdIndex=TmnxVdoGrpIdIndex, TmnxVcIdOrNone=TmnxVcIdOrNone, THPolCIRRate=THPolCIRRate, TMacFilterType=TMacFilterType, TmnxAdminState=TmnxAdminState, TmnxMobIpCanType=TmnxMobIpCanType, TmnxAccessLoopEncaps1=TmnxAccessLoopEncaps1, TmnxVwmCardType=TmnxVwmCardType, TmnxMobDfPeerId=TmnxMobDfPeerId, TDSCPFilterActionValue=TDSCPFilterActionValue, TProfile=TProfile, TmnxMulticastAddrFamily=TmnxMulticastAddrFamily, TQosOverrideType=TQosOverrideType, TmnxMobLiTarget=TmnxMobLiTarget, TDSCPValueOrNone=TDSCPValueOrNone, THsmdaCIRKRateOverride=THsmdaCIRKRateOverride, TmnxMobDiaRetryCount=TmnxMobDiaRetryCount, TmnxVRtrMplsLspID=TmnxVRtrMplsLspID, TmnxAsciiSpecification=TmnxAsciiSpecification, TmnxTunnelGroupId=TmnxTunnelGroupId, TmnxVdoPortNumber=TmnxVdoPortNumber, TFilterID=TFilterID, TQueueId=TQueueId, TPIRRateOverride=TPIRRateOverride, TQueueMode=TQueueMode, TmnxMobPeerType=TmnxMobPeerType, TmnxMobServerState=TmnxMobServerState, TPolicerRateType=TPolicerRateType, TmnxVcId=TmnxVcId, TmnxMobProfIpTtl=TmnxMobProfIpTtl, TmnxMobGwId=TmnxMobGwId, TmnxDhcpOptionType=TmnxDhcpOptionType, TMcFrQoSProfileId=TMcFrQoSProfileId, TmnxAccPlcyQECounters=TmnxAccPlcyQECounters, TmnxSpbBridgePriority=TmnxSpbBridgePriority, THsmdaPIRKRate=THsmdaPIRKRate, TAtmTdpDescrType=TAtmTdpDescrType, TmnxMobLiTargetType=TmnxMobLiTargetType, TLspExpValue=TLspExpValue, TSapEgrEncapGroupType=TSapEgrEncapGroupType, TmnxMplsTpGlobalID=TmnxMplsTpGlobalID, TmnxMlpppEpClass=TmnxMlpppEpClass, TDEProfile=TDEProfile, TmnxMobStaticPolPrecedenceOrZero=TmnxMobStaticPolPrecedenceOrZero, TmnxMobArpValueOrZero=TmnxMobArpValueOrZero, TDSCPNameOrEmpty=TDSCPNameOrEmpty, TmnxBsxTransPrefPolicyId=TmnxBsxTransPrefPolicyId, TCIRRateOverride=TCIRRateOverride, TmnxMobAddrScheme=TmnxMobAddrScheme, TmnxMobImei=TmnxMobImei, TSysResource=TSysResource, TmnxSubRadiusVendorId=TmnxSubRadiusVendorId, TmnxVdoGrpIdOrInherit=TmnxVdoGrpIdOrInherit, TmnxVRtrIDOrZero=TmnxVRtrIDOrZero, TmnxMobUeStrPrefix=TmnxMobUeStrPrefix, TMplsLspExpProfMapID=TMplsLspExpProfMapID, TQosQGrpInstanceIDorZero=TQosQGrpInstanceIDorZero, TmnxOperState=TmnxOperState, TmnxTunnelID=TmnxTunnelID, TSecondaryShaper10GPIRRate=TSecondaryShaper10GPIRRate, TmnxPppoeUserNameOrEmpty=TmnxPppoeUserNameOrEmpty, TIpProtocol=TIpProtocol, QTagFullRange=QTagFullRange, TProfileOrDei=TProfileOrDei, TBurstSize=TBurstSize, TmnxMobProfNameOrEmpty=TmnxMobProfNameOrEmpty)
mibBuilder.exportSymbols("TN-TC-MIB", TmnxRsvpDSTEClassType=TmnxRsvpDSTEClassType, TmnxPppoeUserName=TmnxPppoeUserName, TmnxMobQci=TmnxMobQci, TmnxPppNcpProtocol=TmnxPppNcpProtocol, TBurstSizeBytes=TBurstSizeBytes, TFCNameOrEmpty=TFCNameOrEmpty, TmnxBfdSessOperState=TmnxBfdSessOperState, TProfileUseDEOrNone=TProfileUseDEOrNone, TItemDescription=TItemDescription, TmnxVpnIpBackupFamily=TmnxVpnIpBackupFamily, TmnxMobBearerId=TmnxMobBearerId, TQueueIdOrAll=TQueueIdOrAll, THPolPIRRate=THPolPIRRate, TmnxMplsTpNodeID=TmnxMplsTpNodeID, TFCName=TFCName, ServiceOperStatus=ServiceOperStatus, TRateType=TRateType, TPolicyStatementNameOrEmpty=TPolicyStatementNameOrEmpty, TmnxMobSdfFilterProtocol=TmnxMobSdfFilterProtocol, TmnxSpbFdbLocale=TmnxSpbFdbLocale, TmnxMobProfPolReportingLevel=TmnxMobProfPolReportingLevel, THsmdaPolicyScheduleClass=THsmdaPolicyScheduleClass, ServiceAccessPoint=ServiceAccessPoint, TmnxMobSdfFilterNum=TmnxMobSdfFilterNum, TEgressHsmdaPerPacketOffset=TEgressHsmdaPerPacketOffset, TSapIngressPolicyID=TSapIngressPolicyID, TWeight=TWeight, TDSCPName=TDSCPName, TAdaptationRule=TAdaptationRule, TSdpIngressPolicyID=TSdpIngressPolicyID, TEgressQueueId=TEgressQueueId, TmnxMobProfPolChargingMethod=TmnxMobProfPolChargingMethod, TmnxPortID=TmnxPortID, TPrecValueOrNone=TPrecValueOrNone, TQPreempt=TQPreempt, TmnxBsxAarpId=TmnxBsxAarpId, TmnxPppoeSessionId=TmnxPppoeSessionId, TNonZeroWeight=TNonZeroWeight, TNetworkIngressMeterId=TNetworkIngressMeterId, TmnxPwPathHopIdOrZero=TmnxPwPathHopIdOrZero, TmnxMobMcc=TmnxMobMcc, TmnxBsxAarpServiceRefType=TmnxBsxAarpServiceRefType, TmnxMobDiaTransTimer=TmnxMobDiaTransTimer, TnSwitchID=TnSwitchID, TmnxMobApn=TmnxMobApn, TmnxAccPlcyAACounters=TmnxAccPlcyAACounters, TEntryId=TEntryId, TExpSecondaryShaperPIRRate=TExpSecondaryShaperPIRRate, TmnxPppoeSessionInfoOrigin=TmnxPppoeSessionInfoOrigin, tnTCMIBModule=tnTCMIBModule, TmnxIPsecTunnelTemplateIdOrZero=TmnxIPsecTunnelTemplateIdOrZero, TmnxFilterProfileStringOrEmpty=TmnxFilterProfileStringOrEmpty, THsmdaCounterIdOrZero=THsmdaCounterIdOrZero, TPIRRateOrZero=TPIRRateOrZero, TmnxMobSdf=TmnxMobSdf, TmnxMobDiaDetailPathMgmtState=TmnxMobDiaDetailPathMgmtState, Dot1PPriority=Dot1PPriority, TFdbTableSizeProfileID=TFdbTableSizeProfileID, TMACFilterID=TMACFilterID, TIngressHsmdaCounterIdOrZero=TIngressHsmdaCounterIdOrZero, TmnxMobChargingProfileOrInherit=TmnxMobChargingProfileOrInherit, TmnxEgrPolicerStatMode=TmnxEgrPolicerStatMode, TmnxTimeInSec=TmnxTimeInSec, TmnxMobAccessType=TmnxMobAccessType, TmnxMobImsi=TmnxMobImsi, THsmdaWeight=THsmdaWeight, TCIRPercentOverride=TCIRPercentOverride, TmnxSubProfileStringOrEmpty=TmnxSubProfileStringOrEmpty, TPlcyMode=TPlcyMode, BgpPeeringStatus=BgpPeeringStatus, TmnxSubAleOffsetMode=TmnxSubAleOffsetMode, TLNamedItemOrEmpty=TLNamedItemOrEmpty, TSapEgrEncapGrpQosPolicyIdOrZero=TSapEgrEncapGrpQosPolicyIdOrZero, TmnxMobRatingGrpState=TmnxMobRatingGrpState, TSubHostId=TSubHostId, TmnxSvcOperGrpCreationOrigin=TmnxSvcOperGrpCreationOrigin, QTagFullRangeOrNone=QTagFullRangeOrNone, TmnxAccessLoopEncapDataLink=TmnxAccessLoopEncapDataLink, ServiceAdminStatus=ServiceAdminStatus, TmnxMobPdnType=TmnxMobPdnType, TmnxAppProfileString=TmnxAppProfileString, TmnxMobDiaPathMgmtState=TmnxMobDiaPathMgmtState, TmnxSubIdentStringOrEmpty=TmnxSubIdentStringOrEmpty, TPriorityOrUndefined=TPriorityOrUndefined, TmnxMobPdnRefPointType=TmnxMobPdnRefPointType, TmnxSpokeSdpId=TmnxSpokeSdpId, TItemLongDescription=TItemLongDescription, TPlcrBurstSizeBytesOverride=TPlcrBurstSizeBytesOverride, TmnxMobPgwSigProtocol=TmnxMobPgwSigProtocol, TmnxVdoOutputFormat=TmnxVdoOutputFormat, TDEProfileOrDei=TDEProfileOrDei, TLevel=TLevel, TIngressHsmdaCounterId=TIngressHsmdaCounterId, TmnxSubMgtIntDestId=TmnxSubMgtIntDestId, TBWRateType=TBWRateType, TmnxOperGrpHoldDownTime=TmnxOperGrpHoldDownTime, TmnxPppoeSessionType=TmnxPppoeSessionType, TEntryIndicator=TEntryIndicator, TmnxMobServRefPointType=TmnxMobServRefPointType, TmnxMobArp=TmnxMobArp, THPolVirtualScheCIRRate=THPolVirtualScheCIRRate, TPriority=TPriority, TmnxIPsecTunnelTemplateId=TmnxIPsecTunnelTemplateId, TExpSecondaryShaperClassRate=TExpSecondaryShaperClassRate, TmnxEgrPolicerStatModeOverride=TmnxEgrPolicerStatModeOverride, TmnxSubIdentString=TmnxSubIdentString, TNetworkPolicyID=TNetworkPolicyID, TmnxPwGlobalId=TmnxPwGlobalId, TmnxMobUeIdType=TmnxMobUeIdType, TmnxSubProfileString=TmnxSubProfileString, TmnxBgpLocalPreference=TmnxBgpLocalPreference, TmnxMobRfAcctLevel=TmnxMobRfAcctLevel, TmnxVdoFccServerMode=TmnxVdoFccServerMode, THSMDABurstSizeBytesOverride=THSMDABurstSizeBytesOverride, TPrecValue=TPrecValue, TFCType=TFCType, TmnxMobMccOrEmpty=TmnxMobMccOrEmpty, THsmdaSchedulerPolicyGroupId=THsmdaSchedulerPolicyGroupId, TmnxMobImsiStr=TmnxMobImsiStr, TmnxAccPlcyQICounters=TmnxAccPlcyQICounters, TEgrHsmdaPerPacketOffsetOvr=TEgrHsmdaPerPacketOffsetOvr, TBurstSizeBytesOverride=TBurstSizeBytesOverride, THsmdaWeightOverride=THsmdaWeightOverride, TCpmProtPolicyID=TCpmProtPolicyID, TmnxServId=TmnxServId, THPolPIRRateOverride=THPolPIRRateOverride, TmnxBGPFamilyType=TmnxBGPFamilyType, TmnxBinarySpecification=TmnxBinarySpecification, TPIRRate=TPIRRate, TPerPacketOffsetOvr=TPerPacketOffsetOvr, TFCSet=TFCSet, TLNamedItem=TLNamedItem, TDirection=TDirection, InterfaceIndex=InterfaceIndex, TmnxBsxAarpIdOrZero=TmnxBsxAarpIdOrZero, TMatchCriteria=TMatchCriteria, TIngressHsmdaQueueId=TIngressHsmdaQueueId, TmnxSpokeSdpIdOrZero=TmnxSpokeSdpIdOrZero, TmnxVdoAnalyzerAlarm=TmnxVdoAnalyzerAlarm, TmnxAncpStringOrZero=TmnxAncpStringOrZero, TmnxSpbFid=TmnxSpbFid, THsmdaWrrWeightOverride=THsmdaWrrWeightOverride, TmnxIkePolicyAuthMethod=TmnxIkePolicyAuthMethod, TNamedItem=TNamedItem, TmnxIpSecIsaOperFlags=TmnxIpSecIsaOperFlags, TmnxSrrpPriorityStep=TmnxSrrpPriorityStep, TmnxIgmpGroupFilterMode=TmnxIgmpGroupFilterMode, TmnxMobAuthType=TmnxMobAuthType, TAdvCfgRate=TAdvCfgRate, TmnxCdrDiagnosticAction=TmnxCdrDiagnosticAction, TmnxMobProfGbrRate=TmnxMobProfGbrRate, TmnxAiiType=TmnxAiiType, TBurstSizeOverride=TBurstSizeOverride)
