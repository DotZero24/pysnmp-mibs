...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-WDS-MIB
...
alvarionWdsMIBCompliance.setObjects(
      *(("ALVARION-WDS-MIB", "alvarionWDSInfoMIBGroup"),
        ("ALVARION-WDS-MIB", "alvarionWDSRadioMIBGroup"),
        ("ALVARION-WDS-MIB", "alvarionWDSGroupMIBGroup"),
        ("ALVARION-WDS-MIB", "alvarionWDSLinkMIBGroup"),
        ("ALVARION-WDS-MIB", "alvarionWDSScanMIBGroup"))
)
if mibBuilder.loadTexts:
