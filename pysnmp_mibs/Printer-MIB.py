...
# Notes
# -----
# ASN.1 source file://mibs/rfc/Printer-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:19:31 2025
...
prtMIBCompliance.setObjects(
      *(("Printer-MIB", "prtGeneralGroup"),
        ("Printer-MIB", "prtInputGroup"),
        ("Printer-MIB", "prtOutputGroup"),
        ("Printer-MIB", "prtMarkerGroup"),
        ("Printer-MIB", "prtMediaPathGroup"),
        ("Printer-MIB", "prtChannelGroup"),
        ("Printer-MIB", "prtInterpreterGroup"),
        ("Printer-MIB", "prtConsoleGroup"),
        ("Printer-MIB", "prtAlertTableGroup"))
)
if mibBuilder.loadTexts:
