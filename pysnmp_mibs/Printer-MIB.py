...
PrtMediaPathTypeTC, PrtMarkerMarkTechTC, PrtInputTypeTC, PrtGeneralResetTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtMarkerSuppliesTypeTC, PrtAlertTrainingLevelTC, PrtConsoleColorTC, PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtConsoleDisableTC, PrtChannelTypeTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMediaPathTypeTC", "PrtMarkerMarkTechTC", "PrtInputTypeTC", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtMarkerSuppliesTypeTC", "PrtAlertTrainingLevelTC", "PrtConsoleColorTC", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtConsoleDisableTC", "PrtChannelTypeTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputType=prtOutputType, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInterpreterVersion=prtInterpreterVersion, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, PYSNMP_MODULE_ID=printmib, prtOutputDimUnit=prtOutputDimUnit, prtGeneralConfigChanges=prtGeneralConfigChanges, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleLightTable=prtConsoleLightTable, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtCoverStatus=prtCoverStatus, prtChannelType=prtChannelType, prtAlert=prtAlert, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtAlertTime=prtAlertTime, prtMediaPath=prtMediaPath, prtGeneralSerialNumber=prtGeneralSerialNumber, prtConsoleLightIndex=prtConsoleLightIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInputMediaWeight=prtInputMediaWeight, prtChannelState=prtChannelState, prtOutputVendorName=prtOutputVendorName, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMediaPathStatus=prtMediaPathStatus, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputModel=prtOutputModel, prtMIBCompliance=prtMIBCompliance, prtCoverDescription=prtCoverDescription, prtInput=prtInput, prtDeviceRefEntry=prtDeviceRefEntry, prtInputMediaFormParts=prtInputMediaFormParts, prtMIB2Compliance=prtMIB2Compliance, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtLocalizationTable=prtLocalizationTable, prtInputVersion=prtInputVersion, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleGroup=prtConsoleGroup, prtChannelGroup=prtChannelGroup, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerIndex=prtMarkerIndex, prtMediaPathEntry=prtMediaPathEntry, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannelIndex=prtChannelIndex, prtCoverTable=prtCoverTable, prtOutputDecollating=prtOutputDecollating, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputEntry=prtOutputEntry, prtOutputVersion=prtOutputVersion, prtInputMaxCapacity=prtInputMaxCapacity, prtGeneral=prtGeneral, prtInputSecurity=prtInputSecurity, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutput=prtOutput, prtMediaPathTable=prtMediaPathTable, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMediaPathType=prtMediaPathType, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputStatus=prtOutputStatus, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerColorant=prtMarkerColorant, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerColorantValue=prtMarkerColorantValue, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputDescription=prtInputDescription, prtAlertGroup=prtAlertGroup, PresentOnOff=PresentOnOff, prtInputModel=prtInputModel, prtAlertTimeGroup=prtAlertTimeGroup, prtLocalization=prtLocalization, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleLocalization=prtConsoleLocalization, prtInputEntry=prtInputEntry, prtInputNextIndex=prtInputNextIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, PrtMediaUnitTC=PrtMediaUnitTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, printmib=printmib, prtGeneralTable=prtGeneralTable, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMIB2Groups=prtMIB2Groups, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerColorantEntry=prtMarkerColorantEntry, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerEastMargin=prtMarkerEastMargin, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInputIndex=prtInputIndex, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerTable=prtMarkerTable, prtMarkerColorantTable=prtMarkerColorantTable, prtConsoleDisable=prtConsoleDisable, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInterpreterGroup=prtInterpreterGroup, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInterpreterEntry=prtInterpreterEntry, prtAlertEntry=prtAlertEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtLocalizationIndex=prtLocalizationIndex, prtAlertDescription=prtAlertDescription, prtInputCapacityUnit=prtInputCapacityUnit, prtInputStatus=prtInputStatus, prtChannelInformation=prtChannelInformation, prtOutputStackingOrder=prtOutputStackingOrder, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMIBGroups=prtMIBGroups, prtMarkerMarkTech=prtMarkerMarkTech, prtMIBConformance=prtMIBConformance, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputSecurity=prtOutputSecurity, prtAlertGroupIndex=prtAlertGroupIndex, prtStorageRefEntry=prtStorageRefEntry, prtInputTable=prtInputTable, prtOutputBursting=prtOutputBursting, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerSouthMargin=prtMarkerSouthMargin, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInterpreterTable=prtInterpreterTable, prtMediaPathIndex=prtMediaPathIndex, prtMediaPathGroup=prtMediaPathGroup, prtConsoleColor=prtConsoleColor, prtConsoleOffTime=prtConsoleOffTime, prtExtendedOutputGroup=prtExtendedOutputGroup, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerColorantGroup=prtMarkerColorantGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtAlertIndex=prtAlertIndex, prtLocalizationEntry=prtLocalizationEntry, CodedCharSet=CodedCharSet, prtMarker=prtMarker, prtCover=prtCover, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAlertCode=prtAlertCode, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerColorantRole=prtMarkerColorantRole, PrtChannelStateTC=PrtChannelStateTC, prtAlertLocation=prtAlertLocation, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputPageCollated=prtOutputPageCollated, prtGeneralV2Group=prtGeneralV2Group, printerV2AlertPrefix=printerV2AlertPrefix, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputTable=prtOutputTable, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaColor=prtInputMediaColor, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, printerV2Alert=printerV2Alert, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtGeneralPrinterName=prtGeneralPrinterName, prtCoverEntry=prtCoverEntry, prtChannel=prtChannel, PrtPrintOrientationTC=PrtPrintOrientationTC, MediaUnit=MediaUnit, prtDeviceRefIndex=prtDeviceRefIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputMediaName=prtInputMediaName, prtOutputIndex=prtOutputIndex, prtLocalizationCountry=prtLocalizationCountry, prtMarkerEntry=prtMarkerEntry, prtChannelEntry=prtChannelEntry, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleOnTime=prtConsoleOnTime, prtOutputName=prtOutputName, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInterpreterIndex=prtInterpreterIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputMediaGroup=prtInputMediaGroup, prtMarkerGroup=prtMarkerGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerSupplies=prtMarkerSupplies, prtStorageRefIndex=prtStorageRefIndex, prtInputSerialNumber=prtInputSerialNumber, prtAlertAllEvents=prtAlertAllEvents, prtMarkerStatus=prtMarkerStatus, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtConsoleDescription=prtConsoleDescription, printerV1Alert=printerV1Alert, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertTable=prtAlertTable, prtChannelV2Group=prtChannelV2Group, prtStorageRefTable=prtStorageRefTable, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, CapacityUnit=CapacityUnit, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInterpreter=prtInterpreter, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlertTableGroup=prtAlertTableGroup, prtMediaPathDescription=prtMediaPathDescription, prtInputType=prtInputType, prtConsoleLightEntry=prtConsoleLightEntry, prtDeviceRefTable=prtDeviceRefTable, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerColorantIndex=prtMarkerColorantIndex, prtOutputGroup=prtOutputGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputVendorName=prtInputVendorName, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleLights=prtConsoleLights, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtChannelStatus=prtChannelStatus, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtAlertTrapGroup=prtAlertTrapGroup, prtGeneralReset=prtGeneralReset, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputDefaultIndex=prtInputDefaultIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtCoverIndex=prtCoverIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtChannelTable=prtChannelTable, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputName=prtInputName, prtInputMediaType=prtInputMediaType, prtChannelIfIndex=prtChannelIfIndex, prtInputGroup=prtInputGroup, prtGeneralGroup=prtGeneralGroup, SubUnitStatus=SubUnitStatus, prtGeneralEntry=prtGeneralEntry, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputDescription=prtOutputDescription)
mibBuilder.exportSymbols("Printer-MIB", prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInterpreterDescription=prtInterpreterDescription, prtLocalizationLanguage=prtLocalizationLanguage)
