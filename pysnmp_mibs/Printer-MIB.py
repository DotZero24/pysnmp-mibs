...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/Printer-MIB
...
ModuleIdentity, Counter64, Integer32, ObjectIdentity, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, MibIdentifier, TimeTicks, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "ObjectIdentity", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "Bits", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlertDescription=prtAlertDescription, prtMediaPathDescription=prtMediaPathDescription, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtExtendedInputGroup=prtExtendedInputGroup, prtAlertIndex=prtAlertIndex, prtInputNextIndex=prtInputNextIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtAlertEntry=prtAlertEntry, prtChannelV2Group=prtChannelV2Group, prtGeneralTable=prtGeneralTable, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerLifeCount=prtMarkerLifeCount, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputName=prtOutputName, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMediaPathIndex=prtMediaPathIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputVendorName=prtOutputVendorName, prtConsoleOffTime=prtConsoleOffTime, prtMIBConformance=prtMIBConformance, PrtMediaUnitTC=PrtMediaUnitTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarker=prtMarker, prtStorageRefIndex=prtStorageRefIndex, prtInputTable=prtInputTable, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtAlertCode=prtAlertCode, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputDecollating=prtOutputDecollating, prtMediaPathGroup=prtMediaPathGroup, prtOutputIndex=prtOutputIndex, printmib=printmib, PrtPrintOrientationTC=PrtPrintOrientationTC, PrtCapacityUnitTC=PrtCapacityUnitTC, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerEastMargin=prtMarkerEastMargin, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMIBCompliance=prtMIBCompliance, prtMarkerGroup=prtMarkerGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputBursting=prtOutputBursting, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputMaxCapacity=prtOutputMaxCapacity, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtStorageRefTable=prtStorageRefTable, prtOutputDescription=prtOutputDescription, MediaUnit=MediaUnit, printerV2Alert=printerV2Alert, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputModel=prtOutputModel, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleGroup=prtConsoleGroup, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerStatus=prtMarkerStatus, prtMediaPathEntry=prtMediaPathEntry, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtChannelState=prtChannelState, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputMediaFormParts=prtInputMediaFormParts, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputMaxCapacity=prtInputMaxCapacity, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtGeneralConfigChanges=prtGeneralConfigChanges, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterVersion=prtInterpreterVersion, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelEntry=prtChannelEntry, prtMediaPathTable=prtMediaPathTable, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtConsoleLocalization=prtConsoleLocalization, prtMarkerTable=prtMarkerTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtDeviceRefIndex=prtDeviceRefIndex, printerV1Alert=printerV1Alert, SubUnitStatus=SubUnitStatus, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelStatus=prtChannelStatus, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleDisable=prtConsoleDisable, prtChannelInformation=prtChannelInformation, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInputType=prtInputType, prtLocalizationTable=prtLocalizationTable, prtInputDescription=prtInputDescription, prtGeneralGroup=prtGeneralGroup, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputStatus=prtInputStatus, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputGroup=prtOutputGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, CodedCharSet=CodedCharSet, prtMediaPath=prtMediaPath, prtInputModel=prtInputModel, prtOutput=prtOutput, prtAlertGroup=prtAlertGroup, prtInputGroup=prtInputGroup, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtCoverTable=prtCoverTable, prtInputMediaName=prtInputMediaName, prtMarkerEntry=prtMarkerEntry, prtInterpreterTwoWay=prtInterpreterTwoWay, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtChannelTable=prtChannelTable, prtInputName=prtInputName, prtAlertAllEvents=prtAlertAllEvents, prtAlertTrapGroup=prtAlertTrapGroup, prtInputMediaWeight=prtInputMediaWeight, prtOutputTable=prtOutputTable, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtMIBGroups=prtMIBGroups, prtInput=prtInput, prtOutputSecurity=prtOutputSecurity, prtGeneralReset=prtGeneralReset, prtChannelType=prtChannelType, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, PresentOnOff=PresentOnOff, PrtChannelStateTC=PrtChannelStateTC, prtDeviceRefEntry=prtDeviceRefEntry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInterpreterTable=prtInterpreterTable, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtDeviceRefTable=prtDeviceRefTable, prtMIB2Compliance=prtMIB2Compliance, prtMarkerIndex=prtMarkerIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtGeneralEntry=prtGeneralEntry, prtInputIndex=prtInputIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, CapacityUnit=CapacityUnit, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputType=prtOutputType, prtAlertTable=prtAlertTable, prtCover=prtCover, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMediaPathType=prtMediaPathType, prtInputSerialNumber=prtInputSerialNumber, prtOutputVersion=prtOutputVersion, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputMediaType=prtInputMediaType, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputVersion=prtInputVersion, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputCapacityUnit=prtOutputCapacityUnit, prtChannelGroup=prtChannelGroup, prtConsoleColor=prtConsoleColor, prtAlertLocation=prtAlertLocation, prtInputMediaGroup=prtInputMediaGroup, prtMIB2Groups=prtMIB2Groups, prtMarkerSouthMargin=prtMarkerSouthMargin, prtAlertTimeGroup=prtAlertTimeGroup, prtGeneralServicePerson=prtGeneralServicePerson, prtInputSecurity=prtInputSecurity, prtMarkerWestMargin=prtMarkerWestMargin, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtChannelIndex=prtChannelIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterLangFamily=prtInterpreterLangFamily, prtLocalizationIndex=prtLocalizationIndex, prtMediaPathStatus=prtMediaPathStatus, prtInterpreter=prtInterpreter, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAlertTableGroup=prtAlertTableGroup, prtOutputDimUnit=prtOutputDimUnit, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputStackingOrder=prtOutputStackingOrder, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, printerV2AlertPrefix=printerV2AlertPrefix, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtConsoleOnTime=prtConsoleOnTime, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtLocalizationCharacterSet=prtLocalizationCharacterSet, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtLocalizationEntry=prtLocalizationEntry, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputPageCollated=prtOutputPageCollated, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantValue=prtMarkerColorantValue, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtConsoleLightTable=prtConsoleLightTable, prtChannelIfIndex=prtChannelIfIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInterpreterDescription=prtInterpreterDescription, prtCoverDescription=prtCoverDescription, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtLocalizationCountry=prtLocalizationCountry, PYSNMP_MODULE_ID=printmib, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleDescription=prtConsoleDescription, prtInterpreterGroup=prtInterpreterGroup, prtGeneralV2Group=prtGeneralV2Group, prtInputEntry=prtInputEntry, prtCoverStatus=prtCoverStatus, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtStorageRefEntry=prtStorageRefEntry, prtOutputStatus=prtOutputStatus, prtAlertGroupIndex=prtAlertGroupIndex, prtAlert=prtAlert, prtConsoleLights=prtConsoleLights, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtLocalization=prtLocalization, prtMarkerSupplies=prtMarkerSupplies, prtInputVendorName=prtInputVendorName, prtOutputEntry=prtOutputEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputCapacityUnit=prtInputCapacityUnit, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerColorant=prtMarkerColorant, prtChannel=prtChannel, prtInputDefaultIndex=prtInputDefaultIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtCoverEntry=prtCoverEntry, prtAlertTime=prtAlertTime, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterEntry=prtInterpreterEntry, prtGeneral=prtGeneral)
mibBuilder.exportSymbols("Printer-MIB", prtInputDimUnit=prtInputDimUnit, prtInputMediaColor=prtInputMediaColor, prtInputCurrentLevel=prtInputCurrentLevel, prtCoverIndex=prtCoverIndex)
