...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hwgroup/DAMOCLES-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:22:57 2025
...
info = MibIdentifier((1, 3, 6, 1, 4, 1, 21796, 3, 4, 70))
...
inpValue = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 4, 1, 1, 2), OnOff()).setMaxAccess("readonly")
...
outValue = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 4, 2, 1, 2), OnOff()).setMaxAccess("readwrite")
...
outMode = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 4, 2, 1, 5), OutputMode()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: outMode.setStatus('current')
outInit = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 4, 2, 1, 6), OnOff()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: outInit.setStatus('current')
...
sensUnitString = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 4, 3, 1, 10), SensorUnitString()).setMaxAccess("readonly")
...
tsAlarmDescr = MibTableColumn((1, 3, 6, 1, 4, 1, 21796, 3, 4, 50, 2, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("inputStateAlarm", 1), ("temperatureOutOfRange", 2)))).setMaxAccess("readonly")
...
infoAddressMAC = MibScalar((1, 3, 6, 1, 4, 1, 21796, 3, 4, 70, 1), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 17))).setMaxAccess("readonly")
...
inpAlarmStateChanged = NotificationType((1, 3, 6, 1, 4, 1, 21796, 3, 4) + (0,1)).setObjects(("SNMPv2-MIB", "sysName"), ("DAMOCLES-MIB", "infoAddressMAC"), ("DAMOCLES-MIB", "inpName"), ("DAMOCLES-MIB", "inpValue"), ("DAMOCLES-MIB", "inpAlarmState"))
sensAlarmStateChanged = NotificationType((1, 3, 6, 1, 4, 1, 21796, 3, 4) + (0,2)).setObjects(("SNMPv2-MIB", "sysName"), ("DAMOCLES-MIB", "infoAddressMAC"), ("DAMOCLES-MIB", "sensName"), ("DAMOCLES-MIB", "sensID"), ("DAMOCLES-MIB", "sensState"), ("DAMOCLES-MIB", "sensValue"), ("DAMOCLES-MIB", "sensUnit"))
tsTrapAlarmStart = NotificationType((1, 3, 6, 1, 4, 1, 21796, 3, 4) + (0,3)).setObjects(("SNMPv2-MIB", "sysName"), ("DAMOCLES-MIB", "infoAddressMAC"), ("DAMOCLES-MIB", "tsAlarmId"), ("DAMOCLES-MIB", "tsAlarmDescr"))
tsTrapAlarmEnd = NotificationType((1, 3, 6, 1, 4, 1, 21796, 3, 4) + (0,4)).setObjects(("SNMPv2-MIB", "sysName"), ("DAMOCLES-MIB", "infoAddressMAC"), ("DAMOCLES-MIB", "tsAlarmId"), ("DAMOCLES-MIB", "tsAlarmDescr"))
mibBuilder.exportSymbols("DAMOCLES-MIB", outEntry=outEntry, tsAlarmTime=tsAlarmTime, inpAlarmStateChanged=inpAlarmStateChanged, charonII=charonII, TimeStamp=TimeStamp, SensorUnitString=SensorUnitString, sensString=sensString, sensEntry=sensEntry, inpEntry=inpEntry, sensUnitString=sensUnitString, sensSetupEntry=sensSetupEntry, sensSetupIndex=sensSetupIndex, OutputMode=OutputMode, SensorID=SensorID, sensFlags=sensFlags, sensLimitMax=sensLimitMax, sensState=sensState, unitType=unitType, PositiveInteger=PositiveInteger, sensID=sensID, tsTrapAlarmStart=tsTrapAlarmStart, inpCounter=inpCounter, tsTrapAlarmEnd=tsTrapAlarmEnd, outName=outName, sensSetupName=sensSetupName, SensorString=SensorString, inpAlarmState=inpAlarmState, SensorFlags=SensorFlags, outInit=outInit, sensHysteresis=sensHysteresis, outType=outType, tsAlarmIdx=tsAlarmIdx, infoAddressMAC=infoAddressMAC, InputAlarmSetup=InputAlarmSetup, outValue=outValue, outMode=outMode, sensName=sensName, tsAlarmSensName=tsAlarmSensName, sensSetupTable=sensSetupTable, setup=setup, sensIndex=sensIndex, sensLimitMin=sensLimitMin, inpValue=inpValue, NonNegativeInteger=NonNegativeInteger, outTable=outTable, sensTable=sensTable, outIndex=outIndex, inpAlarmSetup=inpAlarmSetup, sensValueRaw=sensValueRaw, OutputType=OutputType, tsAlarmId=tsAlarmId, SensorName=SensorName, inpTable=inpTable, tsAlarmsPresent=tsAlarmsPresent, sensSetup=sensSetup, SensorState=SensorState, sensValue=sensValue, sensAlarmStateChanged=sensAlarmStateChanged, UnitType=UnitType, IOName=IOName, tsAlarmDescr=tsAlarmDescr, damocles=damocles, inpName=inpName, InputAlarmState=InputAlarmState, inpIndex=inpIndex, SensorValue=SensorValue, info=info, sensUnit=sensUnit, tsAlarmTable=tsAlarmTable, OnOff=OnOff, hwgroup=hwgroup, tsAlarm=tsAlarm, tsAlarmEntry=tsAlarmEntry)
