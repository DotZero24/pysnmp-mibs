# SNMP MIB module (DAMOCLES-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hwgroup/DAMOCLES-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:21:18 2025
...
tsAlarmIdx = _TsAlarmIdx_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 50, 2, 1, 1),
    _TsAlarmIdx_Type()
)
...
tsAlarmId = _TsAlarmId_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 50, 2, 1, 2),
    _TsAlarmId_Type()
)
...
tsAlarmDescr = _TsAlarmDescr_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 50, 2, 1, 3),
    _TsAlarmDescr_Type()
)
...
tsAlarmSensName = _TsAlarmSensName_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 50, 2, 1, 4),
...
tsAlarmTime = _TsAlarmTime_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 50, 2, 1, 5),
    _TsAlarmTime_Type()
)
...
sensSetupIndex = _SensSetupIndex_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 99, 1, 2, 1, 1),
...
sensSetupName = _SensSetupName_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 99, 1, 2, 1, 2),
    _SensSetupName_Type()
)
...
sensLimitMin = _SensLimitMin_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 99, 1, 2, 1, 6),
    _SensLimitMin_Type()
)
...
sensLimitMax = _SensLimitMax_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 99, 1, 2, 1, 7),
    _SensLimitMax_Type()
)
...
sensHysteresis = _SensHysteresis_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 99, 1, 2, 1, 8),
...
inpAlarmStateChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 0, 1)
)
inpAlarmStateChanged.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("DAMOCLES-MIB", "infoAddressMAC"),
        ("DAMOCLES-MIB", "inpName"),
        ("DAMOCLES-MIB", "inpValue"),
        ("DAMOCLES-MIB", "inpAlarmState"))
)
if mibBuilder.loadTexts:
...
sensAlarmStateChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 0, 2)
)
sensAlarmStateChanged.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("DAMOCLES-MIB", "infoAddressMAC"),
        ("DAMOCLES-MIB", "sensName"),
        ("DAMOCLES-MIB", "sensID"),
        ("DAMOCLES-MIB", "sensState"),
        ("DAMOCLES-MIB", "sensValue"),
        ("DAMOCLES-MIB", "sensUnit"))
)
if mibBuilder.loadTexts:
...
tsTrapAlarmStart = NotificationType(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 0, 3)
)
tsTrapAlarmStart.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("DAMOCLES-MIB", "infoAddressMAC"),
        ("DAMOCLES-MIB", "tsAlarmId"),
        ("DAMOCLES-MIB", "tsAlarmDescr"))
)
if mibBuilder.loadTexts:
