_z='vrrpv3StatisticsDiscontinuityGroup'
_y='vrrpv3ProtoError'
_x='vrrpv3NewMaster'
_w='vrrpv3GlobalStatisticsDiscontinuityTime'
_v='vrrpv3StatisticsRefreshRate'
_u='vrrpv3StatisticsRowDiscontinuityTime'
...
_Y='vrrpv3OperationsStatus'
_X='vrrpv3OperationsVirtualMacAddr'
_W='vrrpv3StatisticsEntry'
_V='vrrpv3AssociatedIpAddrAddress'
_U='TimeInterval'
_T='Unsigned32'
_S='InetAddress'
...
if mibBuilder.loadTexts:vrrpv3MIB.setRevisions(('2012-02-12 00:00',))
...
vrrpv3Notifications=_Vrrpv3Notifications_ObjectIdentity((1,3,6,1,2,1,207,0))
_Vrrpv3Objects_ObjectIdentity=ObjectIdentity
vrrpv3Objects=_Vrrpv3Objects_ObjectIdentity((1,3,6,1,2,1,207,1))
_Vrrpv3Operations_ObjectIdentity=ObjectIdentity
vrrpv3Operations=_Vrrpv3Operations_ObjectIdentity((1,3,6,1,2,1,207,1,1))
_Vrrpv3OperationsTable_Object=MibTable
vrrpv3OperationsTable=_Vrrpv3OperationsTable_Object((1,3,6,1,2,1,207,1,1,1))
if mibBuilder.loadTexts:vrrpv3OperationsTable.setStatus(_B)
_Vrrpv3OperationsEntry_Object=MibTableRow
vrrpv3OperationsEntry=_Vrrpv3OperationsEntry_Object((1,3,6,1,2,1,207,1,1,1,1))
...
vrrpv3OperationsVrId=_Vrrpv3OperationsVrId_Object((1,3,6,1,2,1,207,1,1,1,1,1),_Vrrpv3OperationsVrId_Type())
...
vrrpv3OperationsInetAddrType=_Vrrpv3OperationsInetAddrType_Object((1,3,6,1,2,1,207,1,1,1,1,2),_Vrrpv3OperationsInetAddrType_Type())
...
vrrpv3OperationsMasterIpAddr=_Vrrpv3OperationsMasterIpAddr_Object((1,3,6,1,2,1,207,1,1,1,1,3),_Vrrpv3OperationsMasterIpAddr_Type())
...
vrrpv3OperationsPrimaryIpAddr=_Vrrpv3OperationsPrimaryIpAddr_Object((1,3,6,1,2,1,207,1,1,1,1,4),_Vrrpv3OperationsPrimaryIpAddr_Type())
...
vrrpv3OperationsVirtualMacAddr=_Vrrpv3OperationsVirtualMacAddr_Object((1,3,6,1,2,1,207,1,1,1,1,5),_Vrrpv3OperationsVirtualMacAddr_Type())
vrrpv3OperationsVirtualMacAddr.setMaxAccess(_C)
if mibBuilder.loadTexts:vrrpv3OperationsVirtualMacAddr.setStatus(_B)
class _Vrrpv3OperationsStatus_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('initialize',1),('backup',2),('master',3)))
_Vrrpv3OperationsStatus_Type.__name__=_E
_Vrrpv3OperationsStatus_Object=MibTableColumn
vrrpv3OperationsStatus=_Vrrpv3OperationsStatus_Object((1,3,6,1,2,1,207,1,1,1,1,6),_Vrrpv3OperationsStatus_Type())
vrrpv3OperationsStatus.setMaxAccess(_C)
if mibBuilder.loadTexts:vrrpv3OperationsStatus.setStatus(_B)
...
vrrpv3OperationsPriority=_Vrrpv3OperationsPriority_Object((1,3,6,1,2,1,207,1,1,1,1,7),_Vrrpv3OperationsPriority_Type())
...
vrrpv3OperationsAddrCount=_Vrrpv3OperationsAddrCount_Object((1,3,6,1,2,1,207,1,1,1,1,8),_Vrrpv3OperationsAddrCount_Type())
...
vrrpv3OperationsAdvInterval=_Vrrpv3OperationsAdvInterval_Object((1,3,6,1,2,1,207,1,1,1,1,9),_Vrrpv3OperationsAdvInterval_Type())
...
vrrpv3OperationsPreemptMode=_Vrrpv3OperationsPreemptMode_Object((1,3,6,1,2,1,207,1,1,1,1,10),_Vrrpv3OperationsPreemptMode_Type())
...
vrrpv3OperationsAcceptMode=_Vrrpv3OperationsAcceptMode_Object((1,3,6,1,2,1,207,1,1,1,1,11),_Vrrpv3OperationsAcceptMode_Type())
...
vrrpv3OperationsUpTime=_Vrrpv3OperationsUpTime_Object((1,3,6,1,2,1,207,1,1,1,1,12),_Vrrpv3OperationsUpTime_Type())
...
vrrpv3OperationsRowStatus=_Vrrpv3OperationsRowStatus_Object((1,3,6,1,2,1,207,1,1,1,1,13),_Vrrpv3OperationsRowStatus_Type())
...
vrrpv3AssociatedIpAddrTable=_Vrrpv3AssociatedIpAddrTable_Object((1,3,6,1,2,1,207,1,1,2))
if mibBuilder.loadTexts:vrrpv3AssociatedIpAddrTable.setStatus(_B)
_Vrrpv3AssociatedIpAddrEntry_Object=MibTableRow
vrrpv3AssociatedIpAddrEntry=_Vrrpv3AssociatedIpAddrEntry_Object((1,3,6,1,2,1,207,1,1,2,1))
...
class _Vrrpv3AssociatedIpAddrAddress_Type(InetAddress):subtypeSpec=InetAddress.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,0),ValueSizeConstraint(4,4),ValueSizeConstraint(16,16))
_Vrrpv3AssociatedIpAddrAddress_Type.__name__=_S
_Vrrpv3AssociatedIpAddrAddress_Object=MibTableColumn
vrrpv3AssociatedIpAddrAddress=_Vrrpv3AssociatedIpAddrAddress_Object((1,3,6,1,2,1,207,1,1,2,1,1),_Vrrpv3AssociatedIpAddrAddress_Type())
vrrpv3AssociatedIpAddrAddress.setMaxAccess(_M)
if mibBuilder.loadTexts:vrrpv3AssociatedIpAddrAddress.setStatus(_B)
_Vrrpv3AssociatedIpAddrRowStatus_Type=RowStatus
_Vrrpv3AssociatedIpAddrRowStatus_Object=MibTableColumn
vrrpv3AssociatedIpAddrRowStatus=_Vrrpv3AssociatedIpAddrRowStatus_Object((1,3,6,1,2,1,207,1,1,2,1,2),_Vrrpv3AssociatedIpAddrRowStatus_Type())
...
vrrpv3Statistics=_Vrrpv3Statistics_ObjectIdentity((1,3,6,1,2,1,207,1,2))
_Vrrpv3RouterChecksumErrors_Type=Counter64
_Vrrpv3RouterChecksumErrors_Object=MibScalar
vrrpv3RouterChecksumErrors=_Vrrpv3RouterChecksumErrors_Object((1,3,6,1,2,1,207,1,2,1),_Vrrpv3RouterChecksumErrors_Type())
...
vrrpv3RouterVersionErrors=_Vrrpv3RouterVersionErrors_Object((1,3,6,1,2,1,207,1,2,2),_Vrrpv3RouterVersionErrors_Type())
...
vrrpv3RouterVrIdErrors=_Vrrpv3RouterVrIdErrors_Object((1,3,6,1,2,1,207,1,2,3),_Vrrpv3RouterVrIdErrors_Type())
...
vrrpv3GlobalStatisticsDiscontinuityTime=_Vrrpv3GlobalStatisticsDiscontinuityTime_Object((1,3,6,1,2,1,207,1,2,4),_Vrrpv3GlobalStatisticsDiscontinuityTime_Type())
vrrpv3GlobalStatisticsDiscontinuityTime.setMaxAccess(_C)
if mibBuilder.loadTexts:vrrpv3GlobalStatisticsDiscontinuityTime.setStatus(_B)
_Vrrpv3StatisticsTable_Object=MibTable
vrrpv3StatisticsTable=_Vrrpv3StatisticsTable_Object((1,3,6,1,2,1,207,1,2,5))
if mibBuilder.loadTexts:vrrpv3StatisticsTable.setStatus(_B)
_Vrrpv3StatisticsEntry_Object=MibTableRow
vrrpv3StatisticsEntry=_Vrrpv3StatisticsEntry_Object((1,3,6,1,2,1,207,1,2,5,1))
...
vrrpv3StatisticsMasterTransitions=_Vrrpv3StatisticsMasterTransitions_Object((1,3,6,1,2,1,207,1,2,5,1,1),_Vrrpv3StatisticsMasterTransitions_Type())
...
vrrpv3StatisticsNewMasterReason=_Vrrpv3StatisticsNewMasterReason_Object((1,3,6,1,2,1,207,1,2,5,1,2),_Vrrpv3StatisticsNewMasterReason_Type())
...
vrrpv3StatisticsRcvdAdvertisements=_Vrrpv3StatisticsRcvdAdvertisements_Object((1,3,6,1,2,1,207,1,2,5,1,3),_Vrrpv3StatisticsRcvdAdvertisements_Type())
...
vrrpv3StatisticsAdvIntervalErrors=_Vrrpv3StatisticsAdvIntervalErrors_Object((1,3,6,1,2,1,207,1,2,5,1,4),_Vrrpv3StatisticsAdvIntervalErrors_Type())
...
vrrpv3StatisticsIpTtlErrors=_Vrrpv3StatisticsIpTtlErrors_Object((1,3,6,1,2,1,207,1,2,5,1,5),_Vrrpv3StatisticsIpTtlErrors_Type())
...
vrrpv3StatisticsProtoErrReason=_Vrrpv3StatisticsProtoErrReason_Object((1,3,6,1,2,1,207,1,2,5,1,6),_Vrrpv3StatisticsProtoErrReason_Type())
...
vrrpv3StatisticsRcvdPriZeroPackets=_Vrrpv3StatisticsRcvdPriZeroPackets_Object((1,3,6,1,2,1,207,1,2,5,1,7),_Vrrpv3StatisticsRcvdPriZeroPackets_Type())
...
vrrpv3StatisticsSentPriZeroPackets=_Vrrpv3StatisticsSentPriZeroPackets_Object((1,3,6,1,2,1,207,1,2,5,1,8),_Vrrpv3StatisticsSentPriZeroPackets_Type())
...
vrrpv3StatisticsRcvdInvalidTypePackets=_Vrrpv3StatisticsRcvdInvalidTypePackets_Object((1,3,6,1,2,1,207,1,2,5,1,9),_Vrrpv3StatisticsRcvdInvalidTypePackets_Type())
...
vrrpv3StatisticsAddressListErrors=_Vrrpv3StatisticsAddressListErrors_Object((1,3,6,1,2,1,207,1,2,5,1,10),_Vrrpv3StatisticsAddressListErrors_Type())
...
vrrpv3StatisticsPacketLengthErrors=_Vrrpv3StatisticsPacketLengthErrors_Object((1,3,6,1,2,1,207,1,2,5,1,11),_Vrrpv3StatisticsPacketLengthErrors_Type())
...
vrrpv3StatisticsRowDiscontinuityTime=_Vrrpv3StatisticsRowDiscontinuityTime_Object((1,3,6,1,2,1,207,1,2,5,1,12),_Vrrpv3StatisticsRowDiscontinuityTime_Type())
vrrpv3StatisticsRowDiscontinuityTime.setMaxAccess(_C)
if mibBuilder.loadTexts:vrrpv3StatisticsRowDiscontinuityTime.setStatus(_B)
_Vrrpv3StatisticsRefreshRate_Type=Unsigned32
_Vrrpv3StatisticsRefreshRate_Object=MibTableColumn
vrrpv3StatisticsRefreshRate=_Vrrpv3StatisticsRefreshRate_Object((1,3,6,1,2,1,207,1,2,5,1,13),_Vrrpv3StatisticsRefreshRate_Type())
vrrpv3StatisticsRefreshRate.setMaxAccess(_C)
if mibBuilder.loadTexts:vrrpv3StatisticsRefreshRate.setStatus(_B)
if mibBuilder.loadTexts:vrrpv3StatisticsRefreshRate.setUnits('milliseconds')
_Vrrpv3Conformance_ObjectIdentity=ObjectIdentity
vrrpv3Conformance=_Vrrpv3Conformance_ObjectIdentity((1,3,6,1,2,1,207,2))
_Vrrpv3Compliances_ObjectIdentity=ObjectIdentity
vrrpv3Compliances=_Vrrpv3Compliances_ObjectIdentity((1,3,6,1,2,1,207,2,1))
_Vrrpv3Groups_ObjectIdentity=ObjectIdentity
vrrpv3Groups=_Vrrpv3Groups_ObjectIdentity((1,3,6,1,2,1,207,2,2))
vrrpv3OperationsEntry.registerAugmentions((_A,_W))
vrrpv3StatisticsEntry.setIndexNames(*vrrpv3OperationsEntry.getIndexNames())
vrrpv3OperationsGroup=ObjectGroup((1,3,6,1,2,1,207,2,2,1))
...
vrrpv3StatisticsGroup=ObjectGroup((1,3,6,1,2,1,207,2,2,2))
...
vrrpv3StatisticsDiscontinuityGroup=ObjectGroup((1,3,6,1,2,1,207,2,2,3))
vrrpv3StatisticsDiscontinuityGroup.setObjects((_A,_w))
if mibBuilder.loadTexts:vrrpv3StatisticsDiscontinuityGroup.setStatus(_B)
vrrpv3InfoGroup=ObjectGroup((1,3,6,1,2,1,207,2,2,4))
vrrpv3InfoGroup.setObjects(*((_A,_G),(_A,_F)))
if mibBuilder.loadTexts:vrrpv3InfoGroup.setStatus(_B)
vrrpv3NewMaster=NotificationType((1,3,6,1,2,1,207,0,1))
vrrpv3NewMaster.setObjects(*((_A,_N),(_A,_F)))
if mibBuilder.loadTexts:vrrpv3NewMaster.setStatus(_B)
vrrpv3ProtoError=NotificationType((1,3,6,1,2,1,207,0,2))
vrrpv3ProtoError.setObjects((_A,_G))
if mibBuilder.loadTexts:vrrpv3ProtoError.setStatus(_B)
vrrpv3NotificationsGroup=NotificationGroup((1,3,6,1,2,1,207,2,2,5))
vrrpv3NotificationsGroup.setObjects(*((_A,_x),(_A,_y)))
if mibBuilder.loadTexts:vrrpv3NotificationsGroup.setStatus(_B)
vrrpv3FullCompliance=ModuleCompliance((1,3,6,1,2,1,207,2,1,1))
vrrpv3FullCompliance.setObjects(*((_A,_O),(_A,_P),(_A,_Q),(_A,_R)))
if mibBuilder.loadTexts:vrrpv3FullCompliance.setStatus(_B)
vrrpv3ReadOnlyCompliance=ModuleCompliance((1,3,6,1,2,1,207,2,1,2))
vrrpv3ReadOnlyCompliance.setObjects(*((_A,_O),(_A,_P),(_A,_z),(_A,_Q),(_A,_R)))
if mibBuilder.loadTexts:vrrpv3ReadOnlyCompliance.setStatus(_B)
mibBuilder.exportSymbols(_A,**{'Vrrpv3VrIdTC':Vrrpv3VrIdTC,'vrrpv3MIB':vrrpv3MIB,'vrrpv3Notifications':vrrpv3Notifications,_x:vrrpv3NewMaster,_y:vrrpv3ProtoError,'vrrpv3Objects':vrrpv3Objects,'vrrpv3Operations':vrrpv3Operations,'vrrpv3OperationsTable':vrrpv3OperationsTable,'vrrpv3OperationsEntry':vrrpv3OperationsEntry,_K:vrrpv3OperationsVrId,_L:vrrpv3OperationsInetAddrType,_N:vrrpv3OperationsMasterIpAddr,_g:vrrpv3OperationsPrimaryIpAddr,_X:vrrpv3OperationsVirtualMacAddr,_Y:vrrpv3OperationsStatus,_Z:vrrpv3OperationsPriority,_f:vrrpv3OperationsAddrCount,_a:vrrpv3OperationsAdvInterval,_b:vrrpv3OperationsPreemptMode,_c:vrrpv3OperationsAcceptMode,_d:vrrpv3OperationsUpTime,_e:vrrpv3OperationsRowStatus,'vrrpv3AssociatedIpAddrTable':vrrpv3AssociatedIpAddrTable,'vrrpv3AssociatedIpAddrEntry':vrrpv3AssociatedIpAddrEntry,_V:vrrpv3AssociatedIpAddrAddress,_h:vrrpv3AssociatedIpAddrRowStatus,'vrrpv3Statistics':vrrpv3Statistics,_i:vrrpv3RouterChecksumErrors,_j:vrrpv3RouterVersionErrors,_k:vrrpv3RouterVrIdErrors,_w:vrrpv3GlobalStatisticsDiscontinuityTime,'vrrpv3StatisticsTable':vrrpv3StatisticsTable,_W:vrrpv3StatisticsEntry,_l:vrrpv3StatisticsMasterTransitions,_F:vrrpv3StatisticsNewMasterReason,_m:vrrpv3StatisticsRcvdAdvertisements,_n:vrrpv3StatisticsAdvIntervalErrors,_r:vrrpv3StatisticsIpTtlErrors,_G:vrrpv3StatisticsProtoErrReason,_o:vrrpv3StatisticsRcvdPriZeroPackets,_p:vrrpv3StatisticsSentPriZeroPackets,_q:vrrpv3StatisticsRcvdInvalidTypePackets,_s:vrrpv3StatisticsAddressListErrors,_t:vrrpv3StatisticsPacketLengthErrors,_u:vrrpv3StatisticsRowDiscontinuityTime,_v:vrrpv3StatisticsRefreshRate,'vrrpv3Conformance':vrrpv3Conformance,'vrrpv3Compliances':vrrpv3Compliances,'vrrpv3FullCompliance':vrrpv3FullCompliance,'vrrpv3ReadOnlyCompliance':vrrpv3ReadOnlyCompliance,'vrrpv3Groups':vrrpv3Groups,_O:vrrpv3OperationsGroup,_P:vrrpv3StatisticsGroup,_z:vrrpv3StatisticsDiscontinuityGroup,_Q:vrrpv3InfoGroup,_R:vrrpv3NotificationsGroup})