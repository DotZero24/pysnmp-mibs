...
mibBuilder.exportSymbols("CISCO-CALL-HISTORY-MIB", ciscoCallHistoryDisconnectTimeOfDay=ciscoCallHistoryDisconnectTimeOfDay, ciscoCallHistoryMibGroups=ciscoCallHistoryMibGroups, ciscoCallHistoryEntry=ciscoCallHistoryEntry, ciscoCallHistoryRecordedUnits=ciscoCallHistoryRecordedUnits, ciscoCallHistoryRetainTimer=ciscoCallHistoryRetainTimer, ciscoCallHistoryTableMaxLength=ciscoCallHistoryTableMaxLength, ciscoCallHistoryCallDisconnectCause=ciscoCallHistoryCallDisconnectCause, ciscoCallHistoryIndex=ciscoCallHistoryIndex, ciscoCallHistoryCallDisconnectTime=ciscoCallHistoryCallDisconnectTime, ciscoCallHistoryMibGroup=ciscoCallHistoryMibGroup, PYSNMP_MODULE_ID=ciscoCallHistoryMib, ciscoCallHistoryReceivePackets=ciscoCallHistoryReceivePackets, ciscoCallHistoryMibComplianceRev1=ciscoCallHistoryMibComplianceRev1, ciscoCallHistoryCallingNumber=ciscoCallHistoryCallingNumber, ciscoCallHistoryMibGlobalsGroup=ciscoCallHistoryMibGlobalsGroup, ciscoCallHistoryCallConnectionTime=ciscoCallHistoryCallConnectionTime, ciscoCallHistoryMibGroupRev2=ciscoCallHistoryMibGroupRev2, ciscoCallHistoryConnectTimeOfDay=ciscoCallHistoryConnectTimeOfDay, ciscoCallHistoryMibComplianceV11R01=ciscoCallHistoryMibComplianceV11R01, ciscoCallHistoryMibComplianceV11R02=ciscoCallHistoryMibComplianceV11R02, ciscoCallHistoryMibGroupRev1=ciscoCallHistoryMibGroupRev1, ciscoCallHistoryTable=ciscoCallHistoryTable, ciscoCallHistoryStartTime=ciscoCallHistoryStartTime, ciscoCallHistoryMibCompliance=ciscoCallHistoryMibCompliance, ciscoCallHistoryDialReason=ciscoCallHistoryDialReason, ciscoCallHistoryInterfaceNumber=ciscoCallHistoryInterfaceNumber, ciscoCallHistoryCalledNumber=ciscoCallHistoryCalledNumber, ciscoCallHistory=ciscoCallHistory, ciscoCallHistoryMultiplier=ciscoCallHistoryMultiplier, ciscoCallHistoryCurrency=ciscoCallHistoryCurrency, ciscoCallHistoryMib=ciscoCallHistoryMib, ciscoCallHistoryTransmitPackets=ciscoCallHistoryTransmitPackets, ciscoCallHistoryTransmitBytes=ciscoCallHistoryTransmitBytes, ciscoCallHistoryCurrencyAmount=ciscoCallHistoryCurrencyAmount, ciscoCallHistoryMibConformance=ciscoCallHistoryMibConformance, ciscoCallHistoryDestinationAddress=ciscoCallHistoryDestinationAddress, ciscoCallHistoryDestinationHostName=ciscoCallHistoryDestinationHostName, ciscoCallHistoryMibCompliances=ciscoCallHistoryMibCompliances, ciscoCallHistoryReceiveBytes=ciscoCallHistoryReceiveBytes, ciscoCallHistoryMibObjects=ciscoCallHistoryMibObjects)
