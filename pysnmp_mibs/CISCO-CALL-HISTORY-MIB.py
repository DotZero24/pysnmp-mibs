...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CALL-HISTORY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:46 2025
...
ciscoCallHistoryMibCompliance.setObjects(
    ("CISCO-CALL-HISTORY-MIB", "ciscoCallHistoryMibGroup")
)
if mibBuilder.loadTexts:
...
ciscoCallHistoryMibComplianceRev1.setObjects(
    ("CISCO-CALL-HISTORY-MIB", "ciscoCallHistoryMibGroupRev1")
)
if mibBuilder.loadTexts:
...
ciscoCallHistoryMibComplianceV11R01.setObjects(
      *(("CISCO-CALL-HISTORY-MIB", "ciscoCallHistoryMibGroupRev1"),
        ("CISCO-CALL-HISTORY-MIB", "ciscoCallHistoryMibGlobalsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCallHistoryMibComplianceV11R02.setObjects(
      *(("CISCO-CALL-HISTORY-MIB", "ciscoCallHistoryMibGroupRev2"),
        ("CISCO-CALL-HISTORY-MIB", "ciscoCallHistoryMibGlobalsGroup"))
)
if mibBuilder.loadTexts:
