...
mibBuilder.exportSymbols("DES7200-VLAN-MIB", mySystemMaxVID=mySystemMaxVID, myVlanPortConfigTable=myVlanPortConfigTable, myVlanPortNativeVlan=myVlanPortNativeVlan, myVlanIfAllowedVlanList=myVlanIfAllowedVlanList, myVlanConfigName=myVlanConfigName, VlanList=VlanList, myVlanPortConfigIndex=myVlanPortConfigIndex, myVlanMIBObjects=myVlanMIBObjects, myVlanConfigTable=myVlanConfigTable, myVlanMIB=myVlanMIB, myVlanApMemberAction=myVlanApMemberAction, myVlanConfigPortMember=myVlanConfigPortMember, myVlanMIBGroup=myVlanMIBGroup, myVlanEntryStatus=myVlanEntryStatus, myVlanPortMemberAction=myVlanPortMemberAction, myVlanPortConfigEntry=myVlanPortConfigEntry, myVlanConfigAction=myVlanConfigAction, myVlanPortAccessVlan=myVlanPortAccessVlan, myVlanIfAccessVlan=myVlanIfAccessVlan, myVlanMIBCompliance=myVlanMIBCompliance, myVlanConfigEntry=myVlanConfigEntry, myVlanAlias=myVlanAlias, myVlanMaxNumber=myVlanMaxNumber, myVlanIfNativeVlan=myVlanIfNativeVlan, myVlanConfigVID=myVlanConfigVID, myVlanEntry=myVlanEntry, myVlanIfConfigIfIndex=myVlanIfConfigIfIndex, myVlanCurrentNumber=myVlanCurrentNumber, PYSNMP_MODULE_ID=myVlanMIB, myVlanMIBCompliances=myVlanMIBCompliances, myVlanMIBConformance=myVlanMIBConformance, myVlanPortAllowedVlanList=myVlanPortAllowedVlanList, myVlanTable=myVlanTable, myVlanIfConfigEntry=myVlanIfConfigEntry, myVlanPortConfigMode=myVlanPortConfigMode, myVlanIfConfigTable=myVlanIfConfigTable, myVlanMIBGroups=myVlanMIBGroups, myVlanVID=myVlanVID)
