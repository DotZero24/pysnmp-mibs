...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:13:39 2025
...
ruckusSystemSyslogServerProto = _RuckusSystemSyslogServerProto_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 1, 11, 1, 1, 2, 6, 4),
    _RuckusSystemSyslogServerProto_Type()
)
ruckusSystemSyslogServerProto.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ruckusSystemSyslogServerProto.setStatus("current")


class _RuckusSystemSyslogSecondaryServerIP_Type(OctetString):
    """Custom type ruckusSystemSyslogSecondaryServerIP based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(2, 40),
    )
...
_RuckusSystemSyslogSecondaryServerIP_Type.__name__ = "OctetString"
_RuckusSystemSyslogSecondaryServerIP_Object = MibScalar
ruckusSystemSyslogSecondaryServerIP = _RuckusSystemSyslogSecondaryServerIP_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 1, 11, 1, 1, 2, 6, 5),
    _RuckusSystemSyslogSecondaryServerIP_Type()
)
ruckusSystemSyslogSecondaryServerIP.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ruckusSystemSyslogSecondaryServerIP.setStatus("current")
_RuckusSystemSyslogSecondaryServerPort_Type = Integer32
_RuckusSystemSyslogSecondaryServerPort_Object = MibScalar
ruckusSystemSyslogSecondaryServerPort = _RuckusSystemSyslogSecondaryServerPort_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 1, 11, 1, 1, 2, 6, 6),
    _RuckusSystemSyslogSecondaryServerPort_Type()
)
ruckusSystemSyslogSecondaryServerPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ruckusSystemSyslogSecondaryServerPort.setStatus("current")
_RuckusSystemSyslogSecondaryServerProto_Type = DisplayString
_RuckusSystemSyslogSecondaryServerProto_Object = MibScalar
ruckusSystemSyslogSecondaryServerProto = _RuckusSystemSyslogSecondaryServerProto_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 1, 11, 1, 1, 2, 6, 7),
    _RuckusSystemSyslogSecondaryServerProto_Type()
)
ruckusSystemSyslogSecondaryServerProto.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ruckusSystemSyslogSecondaryServerProto.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ruckusSystemMIB": ruckusSystemMIB,
       ...
       "ruckusSystemSyslogSecondaryServerPort": ruckusSystemSyslogSecondaryServerPort,
       "ruckusSystemSyslogSecondaryServerProto": ruckusSystemSyslogSecondaryServerProto,
