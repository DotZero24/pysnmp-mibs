...
# Notes
# -----
# ASN.1 source file://mibs/rfc/DISMAN-TRACEROUTE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:22:37 2025
...
_TraceRouteMaxConcurrentRequests_Type.__name__ = "Unsigned32"
...
_TraceRouteCtlType_Type.__name__ = "ObjectIdentifier"
...
traceRouteCompliance.setObjects(
      *(("DISMAN-TRACEROUTE-MIB", "traceRouteGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteTimeStampGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteNotificationsGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteHopsTableGroup"))
)
if mibBuilder.loadTexts:
...
traceRouteFullCompliance.setObjects(
      *(("DISMAN-TRACEROUTE-MIB", "traceRouteMinimumGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteCtlRowStatusGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteHistoryGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteHopsTableGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
traceRouteMinimumCompliance.setObjects(
      *(("DISMAN-TRACEROUTE-MIB", "traceRouteMinimumGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteCtlRowStatusGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteHistoryGroup"),
        ("DISMAN-TRACEROUTE-MIB", "traceRouteHopsTableGroup"),
