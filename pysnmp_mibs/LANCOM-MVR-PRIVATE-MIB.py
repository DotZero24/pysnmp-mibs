# SNMP MIB module (LANCOM-MVR-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-MVR-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:20:16 2025
...
mvrPortType = _MvrPortType_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 2, 1, 2),
    _MvrPortType_Type()
)
...
mvrPortImmediateLeaveMode = _MvrPortImmediateLeaveMode_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 2, 1, 3),
...
mvrPortStatus = _MvrPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 2, 1, 4),
    _MvrPortStatus_Type()
)
...
mvrGroupIPAddress = _MvrGroupIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 3, 1, 1),
...
mvrGroupStatus = _MvrGroupStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 3, 1, 2),
...
mvrGroupRowStatus = _MvrGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 3, 1, 3),
...
mvrPortMembershipEntry = _MvrPortMembershipEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 4, 1)
)
mvrPortMembershipEntry.setIndexNames(
    (0, "LANCOM-MVR-PRIVATE-MIB", "mvrPortMembershipGroupIPAddress"),
    (0, "LANCOM-MVR-PRIVATE-MIB", "mvrPortMembershipPortIfIndex"),
)
if mibBuilder.loadTexts:
...
mvrPortMembershipGroupIPAddress = _MvrPortMembershipGroupIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 4, 1, 1),
...
mvrPortMembershipPortIfIndex = _MvrPortMembershipPortIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 4, 1, 2),
...
mvrPortMembershipRowStatus = _MvrPortMembershipRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 50, 4, 1, 3),
