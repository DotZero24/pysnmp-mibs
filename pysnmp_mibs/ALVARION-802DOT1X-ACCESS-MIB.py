# SNMP MIB module (ALVARION-802DOT1X-ACCESS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-802DOT1X-ACCESS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:07:00 2025
...
alvarion802Dot1xMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8)
)
...
coDot1xPaeSystemModifyKey = _CoDot1xPaeSystemModifyKey_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 1, 1),
...
coDot1xPaeSystemModifyKeyInterval = _CoDot1xPaeSystemModifyKeyInterval_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 1, 2),
...
coDot1xPaeAuthenticator = _CoDot1xPaeAuthenticator_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2)
)
...
coDot1xAuthQuietPeriod = _CoDot1xAuthQuietPeriod_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2, 1),
...
coDot1xAuthTxPeriod = _CoDot1xAuthTxPeriod_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2, 2),
...
coDot1xAuthSuppTimeout = _CoDot1xAuthSuppTimeout_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2, 3),
...
coDot1xAuthServerTimeout = _CoDot1xAuthServerTimeout_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2, 4),
...
coDot1xAuthMaxReq = _CoDot1xAuthMaxReq_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2, 5),
...
coDot1xAuthReAuthPeriod = _CoDot1xAuthReAuthPeriod_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2, 6),
...
coDot1xAuthReAuthEnabled = _CoDot1xAuthReAuthEnabled_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2, 7),
...
coDot1xAuthKeyTxEnabled = _CoDot1xAuthKeyTxEnabled_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2, 8),
...
coDot1xAuthReAuthMax = _CoDot1xAuthReAuthMax_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 1, 2, 9),
...
coDot1xPaeConformance = _CoDot1xPaeConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 2)
)
_CoDot1xPaeGroups_ObjectIdentity = ObjectIdentity
coDot1xPaeGroups = _CoDot1xPaeGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 2, 1)
)
_CoDot1xPaeCompliances_ObjectIdentity = ObjectIdentity
coDot1xPaeCompliances = _CoDot1xPaeCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 2, 2)
)

# Managed Objects groups

coDot1xPaeSystemGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 2, 1, 1)
)
coDot1xPaeSystemGroup.setObjects(
      *(("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xPaeSystemModifyKey"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xPaeSystemModifyKeyInterval"))
)
if mibBuilder.loadTexts:
    coDot1xPaeSystemGroup.setStatus("current")

coDot1xPaeAuthenticatorGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 2, 1, 2)
)
coDot1xPaeAuthenticatorGroup.setObjects(
      *(("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xAuthQuietPeriod"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xAuthTxPeriod"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xAuthSuppTimeout"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xAuthServerTimeout"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xAuthMaxReq"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xAuthReAuthPeriod"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xAuthReAuthEnabled"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xAuthKeyTxEnabled"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xAuthReAuthMax"))
)
if mibBuilder.loadTexts:
...
coDot1xPaeCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 8, 2, 2, 1)
)
coDot1xPaeCompliance.setObjects(
      *(("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xPaeSystemGroup"),
        ("ALVARION-802DOT1X-ACCESS-MIB", "coDot1xPaeAuthenticatorGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "ALVARION-802DOT1X-ACCESS-MIB",
    **{"alvarion802Dot1xMIB": alvarion802Dot1xMIB,
