...
mibBuilder.exportSymbols("Dell-JUMBOFRAMES-MIB", PYSNMP_MODULE_ID=rlJumboFrames, rlJumboFramesStatusAfterReset=rlJumboFramesStatusAfterReset, rlJumboFrames=rlJumboFrames, rlJumboFramesCurrentStatus=rlJumboFramesCurrentStatus)
