...
mibBuilder.exportSymbols('Dell-JUMBOFRAMES-MIB',**{'rlJumboFrames':rlJumboFrames,'rlJumboFramesCurrentStatus':rlJumboFramesCurrentStatus,'rlJumboFramesStatusAfterReset':rlJumboFramesStatusAfterReset})