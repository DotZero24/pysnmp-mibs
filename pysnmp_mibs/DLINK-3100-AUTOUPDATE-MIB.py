...
mibBuilder.exportSymbols("DLINK-3100-AUTOUPDATE-MIB", PYSNMP_MODULE_ID=rlAutoUpdate, rlAutoUpdateFilesImage=rlAutoUpdateFilesImage, rlAutoUpdateEnable=rlAutoUpdateEnable, rlAutoUpdateFilesBoot=rlAutoUpdateFilesBoot, rlAutoUpdate=rlAutoUpdate, rlAutoUpdatePreserveIP=rlAutoUpdatePreserveIP, rlAutoUpdateFilesConf=rlAutoUpdateFilesConf, rlAutoUpdateCopyEnable=rlAutoUpdateCopyEnable)
