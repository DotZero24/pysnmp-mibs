# SNMP MIB module (DLINK-3100-AUTOUPDATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-3100-AUTOUPDATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:49:31 2025
...
rlAutoUpdateEnable = _RlAutoUpdateEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 123, 1),
...
rlAutoUpdateFilesBoot = _RlAutoUpdateFilesBoot_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 123, 2),
...
rlAutoUpdateFilesImage = _RlAutoUpdateFilesImage_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 123, 3),
...
rlAutoUpdateFilesConf = _RlAutoUpdateFilesConf_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 123, 4),
...
rlAutoUpdateCopyEnable = _RlAutoUpdateCopyEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 123, 5),
...
rlAutoUpdatePreserveIP = _RlAutoUpdatePreserveIP_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 123, 6),
