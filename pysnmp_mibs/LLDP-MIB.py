...
lldpNotifications=_LldpNotifications_ObjectIdentity((1,0,8802,1,1,2,0))
_LldpNotificationPrefix_ObjectIdentity=ObjectIdentity
lldpNotificationPrefix=_LldpNotificationPrefix_ObjectIdentity((1,0,8802,1,1,2,0,0))
_LldpObjects_ObjectIdentity=ObjectIdentity
lldpObjects=_LldpObjects_ObjectIdentity((1,0,8802,1,1,2,1))
_LldpConfiguration_ObjectIdentity=ObjectIdentity
lldpConfiguration=_LldpConfiguration_ObjectIdentity((1,0,8802,1,1,2,1,1))
...
lldpMessageTxInterval=_LldpMessageTxInterval_Object((1,0,8802,1,1,2,1,1,1),_LldpMessageTxInterval_Type())
...
lldpMessageTxHoldMultiplier=_LldpMessageTxHoldMultiplier_Object((1,0,8802,1,1,2,1,1,2),_LldpMessageTxHoldMultiplier_Type())
...
lldpReinitDelay=_LldpReinitDelay_Object((1,0,8802,1,1,2,1,1,3),_LldpReinitDelay_Type())
...
lldpTxDelay=_LldpTxDelay_Object((1,0,8802,1,1,2,1,1,4),_LldpTxDelay_Type())
...
lldpNotificationInterval=_LldpNotificationInterval_Object((1,0,8802,1,1,2,1,1,5),_LldpNotificationInterval_Type())
...
lldpPortConfigTable=_LldpPortConfigTable_Object((1,0,8802,1,1,2,1,1,6))
if mibBuilder.loadTexts:lldpPortConfigTable.setStatus(_A)
_LldpPortConfigEntry_Object=MibTableRow
lldpPortConfigEntry=_LldpPortConfigEntry_Object((1,0,8802,1,1,2,1,1,6,1))
...
lldpPortConfigPortNum=_LldpPortConfigPortNum_Object((1,0,8802,1,1,2,1,1,6,1,1),_LldpPortConfigPortNum_Type())
...
lldpPortConfigAdminStatus=_LldpPortConfigAdminStatus_Object((1,0,8802,1,1,2,1,1,6,1,2),_LldpPortConfigAdminStatus_Type())
...
lldpPortConfigNotificationEnable=_LldpPortConfigNotificationEnable_Object((1,0,8802,1,1,2,1,1,6,1,3),_LldpPortConfigNotificationEnable_Type())
...
lldpPortConfigTLVsTxEnable=_LldpPortConfigTLVsTxEnable_Object((1,0,8802,1,1,2,1,1,6,1,4),_LldpPortConfigTLVsTxEnable_Type())
...
lldpConfigManAddrTable=_LldpConfigManAddrTable_Object((1,0,8802,1,1,2,1,1,7))
if mibBuilder.loadTexts:lldpConfigManAddrTable.setStatus(_A)
_LldpConfigManAddrEntry_Object=MibTableRow
lldpConfigManAddrEntry=_LldpConfigManAddrEntry_Object((1,0,8802,1,1,2,1,1,7,1))
...
lldpConfigManAddrPortsTxEnable=_LldpConfigManAddrPortsTxEnable_Object((1,0,8802,1,1,2,1,1,7,1,1),_LldpConfigManAddrPortsTxEnable_Type())
...
lldpStatistics=_LldpStatistics_ObjectIdentity((1,0,8802,1,1,2,1,2))
_LldpStatsRemTablesLastChangeTime_Type=TimeStamp
_LldpStatsRemTablesLastChangeTime_Object=MibScalar
lldpStatsRemTablesLastChangeTime=_LldpStatsRemTablesLastChangeTime_Object((1,0,8802,1,1,2,1,2,1),_LldpStatsRemTablesLastChangeTime_Type())
...
lldpStatsRemTablesInserts=_LldpStatsRemTablesInserts_Object((1,0,8802,1,1,2,1,2,2),_LldpStatsRemTablesInserts_Type())
...
lldpStatsRemTablesDeletes=_LldpStatsRemTablesDeletes_Object((1,0,8802,1,1,2,1,2,3),_LldpStatsRemTablesDeletes_Type())
...
lldpStatsRemTablesDrops=_LldpStatsRemTablesDrops_Object((1,0,8802,1,1,2,1,2,4),_LldpStatsRemTablesDrops_Type())
...
lldpStatsRemTablesAgeouts=_LldpStatsRemTablesAgeouts_Object((1,0,8802,1,1,2,1,2,5),_LldpStatsRemTablesAgeouts_Type())
...
lldpStatsTxPortTable=_LldpStatsTxPortTable_Object((1,0,8802,1,1,2,1,2,6))
if mibBuilder.loadTexts:lldpStatsTxPortTable.setStatus(_A)
_LldpStatsTxPortEntry_Object=MibTableRow
lldpStatsTxPortEntry=_LldpStatsTxPortEntry_Object((1,0,8802,1,1,2,1,2,6,1))
...
lldpStatsTxPortNum=_LldpStatsTxPortNum_Object((1,0,8802,1,1,2,1,2,6,1,1),_LldpStatsTxPortNum_Type())
...
lldpStatsTxPortFramesTotal=_LldpStatsTxPortFramesTotal_Object((1,0,8802,1,1,2,1,2,6,1,2),_LldpStatsTxPortFramesTotal_Type())
...
lldpStatsRxPortTable=_LldpStatsRxPortTable_Object((1,0,8802,1,1,2,1,2,7))
if mibBuilder.loadTexts:lldpStatsRxPortTable.setStatus(_A)
_LldpStatsRxPortEntry_Object=MibTableRow
lldpStatsRxPortEntry=_LldpStatsRxPortEntry_Object((1,0,8802,1,1,2,1,2,7,1))
...
lldpStatsRxPortNum=_LldpStatsRxPortNum_Object((1,0,8802,1,1,2,1,2,7,1,1),_LldpStatsRxPortNum_Type())
...
lldpStatsRxPortFramesDiscardedTotal=_LldpStatsRxPortFramesDiscardedTotal_Object((1,0,8802,1,1,2,1,2,7,1,2),_LldpStatsRxPortFramesDiscardedTotal_Type())
...
lldpStatsRxPortFramesErrors=_LldpStatsRxPortFramesErrors_Object((1,0,8802,1,1,2,1,2,7,1,3),_LldpStatsRxPortFramesErrors_Type())
...
lldpStatsRxPortFramesTotal=_LldpStatsRxPortFramesTotal_Object((1,0,8802,1,1,2,1,2,7,1,4),_LldpStatsRxPortFramesTotal_Type())
...
lldpStatsRxPortTLVsDiscardedTotal=_LldpStatsRxPortTLVsDiscardedTotal_Object((1,0,8802,1,1,2,1,2,7,1,5),_LldpStatsRxPortTLVsDiscardedTotal_Type())
...
lldpStatsRxPortTLVsUnrecognizedTotal=_LldpStatsRxPortTLVsUnrecognizedTotal_Object((1,0,8802,1,1,2,1,2,7,1,6),_LldpStatsRxPortTLVsUnrecognizedTotal_Type())
...
lldpStatsRxPortAgeoutsTotal=_LldpStatsRxPortAgeoutsTotal_Object((1,0,8802,1,1,2,1,2,7,1,7),_LldpStatsRxPortAgeoutsTotal_Type())
...
lldpLocalSystemData=_LldpLocalSystemData_ObjectIdentity((1,0,8802,1,1,2,1,3))
_LldpLocChassisIdSubtype_Type=LldpChassisIdSubtype
_LldpLocChassisIdSubtype_Object=MibScalar
lldpLocChassisIdSubtype=_LldpLocChassisIdSubtype_Object((1,0,8802,1,1,2,1,3,1),_LldpLocChassisIdSubtype_Type())
...
lldpLocChassisId=_LldpLocChassisId_Object((1,0,8802,1,1,2,1,3,2),_LldpLocChassisId_Type())
...
lldpLocSysName=_LldpLocSysName_Object((1,0,8802,1,1,2,1,3,3),_LldpLocSysName_Type())
...
lldpLocSysDesc=_LldpLocSysDesc_Object((1,0,8802,1,1,2,1,3,4),_LldpLocSysDesc_Type())
...
lldpLocSysCapSupported=_LldpLocSysCapSupported_Object((1,0,8802,1,1,2,1,3,5),_LldpLocSysCapSupported_Type())
...
lldpLocSysCapEnabled=_LldpLocSysCapEnabled_Object((1,0,8802,1,1,2,1,3,6),_LldpLocSysCapEnabled_Type())
...
lldpLocPortTable=_LldpLocPortTable_Object((1,0,8802,1,1,2,1,3,7))
if mibBuilder.loadTexts:lldpLocPortTable.setStatus(_A)
_LldpLocPortEntry_Object=MibTableRow
lldpLocPortEntry=_LldpLocPortEntry_Object((1,0,8802,1,1,2,1,3,7,1))
...
lldpLocPortNum=_LldpLocPortNum_Object((1,0,8802,1,1,2,1,3,7,1,1),_LldpLocPortNum_Type())
...
lldpLocPortIdSubtype=_LldpLocPortIdSubtype_Object((1,0,8802,1,1,2,1,3,7,1,2),_LldpLocPortIdSubtype_Type())
...
lldpLocPortId=_LldpLocPortId_Object((1,0,8802,1,1,2,1,3,7,1,3),_LldpLocPortId_Type())
...
lldpLocPortDesc=_LldpLocPortDesc_Object((1,0,8802,1,1,2,1,3,7,1,4),_LldpLocPortDesc_Type())
lldpLocPortDesc.setMaxAccess(_C)
if mibBuilder.loadTexts:lldpLocPortDesc.setStatus(_A)
_LldpLocManAddrTable_Object=MibTable
lldpLocManAddrTable=_LldpLocManAddrTable_Object((1,0,8802,1,1,2,1,3,8))
if mibBuilder.loadTexts:lldpLocManAddrTable.setStatus(_A)
_LldpLocManAddrEntry_Object=MibTableRow
lldpLocManAddrEntry=_LldpLocManAddrEntry_Object((1,0,8802,1,1,2,1,3,8,1))
...
lldpLocManAddrSubtype=_LldpLocManAddrSubtype_Object((1,0,8802,1,1,2,1,3,8,1,1),_LldpLocManAddrSubtype_Type())
...
lldpLocManAddr=_LldpLocManAddr_Object((1,0,8802,1,1,2,1,3,8,1,2),_LldpLocManAddr_Type())
...
lldpLocManAddrLen=_LldpLocManAddrLen_Object((1,0,8802,1,1,2,1,3,8,1,3),_LldpLocManAddrLen_Type())
...
lldpLocManAddrIfSubtype=_LldpLocManAddrIfSubtype_Object((1,0,8802,1,1,2,1,3,8,1,4),_LldpLocManAddrIfSubtype_Type())
...
lldpLocManAddrIfId=_LldpLocManAddrIfId_Object((1,0,8802,1,1,2,1,3,8,1,5),_LldpLocManAddrIfId_Type())
...
lldpLocManAddrOID=_LldpLocManAddrOID_Object((1,0,8802,1,1,2,1,3,8,1,6),_LldpLocManAddrOID_Type())
...
lldpRemoteSystemsData=_LldpRemoteSystemsData_ObjectIdentity((1,0,8802,1,1,2,1,4))
_LldpRemTable_Object=MibTable
lldpRemTable=_LldpRemTable_Object((1,0,8802,1,1,2,1,4,1))
if mibBuilder.loadTexts:lldpRemTable.setStatus(_A)
_LldpRemEntry_Object=MibTableRow
lldpRemEntry=_LldpRemEntry_Object((1,0,8802,1,1,2,1,4,1,1))
...
lldpRemTimeMark=_LldpRemTimeMark_Object((1,0,8802,1,1,2,1,4,1,1,1),_LldpRemTimeMark_Type())
...
lldpRemLocalPortNum=_LldpRemLocalPortNum_Object((1,0,8802,1,1,2,1,4,1,1,2),_LldpRemLocalPortNum_Type())
...
lldpRemIndex=_LldpRemIndex_Object((1,0,8802,1,1,2,1,4,1,1,3),_LldpRemIndex_Type())
...
lldpRemChassisIdSubtype=_LldpRemChassisIdSubtype_Object((1,0,8802,1,1,2,1,4,1,1,4),_LldpRemChassisIdSubtype_Type())
...
lldpRemChassisId=_LldpRemChassisId_Object((1,0,8802,1,1,2,1,4,1,1,5),_LldpRemChassisId_Type())
...
lldpRemPortIdSubtype=_LldpRemPortIdSubtype_Object((1,0,8802,1,1,2,1,4,1,1,6),_LldpRemPortIdSubtype_Type())
...
lldpRemPortId=_LldpRemPortId_Object((1,0,8802,1,1,2,1,4,1,1,7),_LldpRemPortId_Type())
...
lldpRemPortDesc=_LldpRemPortDesc_Object((1,0,8802,1,1,2,1,4,1,1,8),_LldpRemPortDesc_Type())
...
lldpRemSysName=_LldpRemSysName_Object((1,0,8802,1,1,2,1,4,1,1,9),_LldpRemSysName_Type())
...
lldpRemSysDesc=_LldpRemSysDesc_Object((1,0,8802,1,1,2,1,4,1,1,10),_LldpRemSysDesc_Type())
...
lldpRemSysCapSupported=_LldpRemSysCapSupported_Object((1,0,8802,1,1,2,1,4,1,1,11),_LldpRemSysCapSupported_Type())
...
lldpRemSysCapEnabled=_LldpRemSysCapEnabled_Object((1,0,8802,1,1,2,1,4,1,1,12),_LldpRemSysCapEnabled_Type())
...
lldpRemManAddrTable=_LldpRemManAddrTable_Object((1,0,8802,1,1,2,1,4,2))
if mibBuilder.loadTexts:lldpRemManAddrTable.setStatus(_A)
_LldpRemManAddrEntry_Object=MibTableRow
lldpRemManAddrEntry=_LldpRemManAddrEntry_Object((1,0,8802,1,1,2,1,4,2,1))
...
lldpRemManAddrSubtype=_LldpRemManAddrSubtype_Object((1,0,8802,1,1,2,1,4,2,1,1),_LldpRemManAddrSubtype_Type())
...
lldpRemManAddr=_LldpRemManAddr_Object((1,0,8802,1,1,2,1,4,2,1,2),_LldpRemManAddr_Type())
...
lldpRemManAddrIfSubtype=_LldpRemManAddrIfSubtype_Object((1,0,8802,1,1,2,1,4,2,1,3),_LldpRemManAddrIfSubtype_Type())
...
lldpRemManAddrIfId=_LldpRemManAddrIfId_Object((1,0,8802,1,1,2,1,4,2,1,4),_LldpRemManAddrIfId_Type())
...
lldpRemManAddrOID=_LldpRemManAddrOID_Object((1,0,8802,1,1,2,1,4,2,1,5),_LldpRemManAddrOID_Type())
...
lldpRemUnknownTLVTable=_LldpRemUnknownTLVTable_Object((1,0,8802,1,1,2,1,4,3))
if mibBuilder.loadTexts:lldpRemUnknownTLVTable.setStatus(_A)
_LldpRemUnknownTLVEntry_Object=MibTableRow
lldpRemUnknownTLVEntry=_LldpRemUnknownTLVEntry_Object((1,0,8802,1,1,2,1,4,3,1))
...
lldpRemUnknownTLVType=_LldpRemUnknownTLVType_Object((1,0,8802,1,1,2,1,4,3,1,1),_LldpRemUnknownTLVType_Type())
...
lldpRemUnknownTLVInfo=_LldpRemUnknownTLVInfo_Object((1,0,8802,1,1,2,1,4,3,1,2),_LldpRemUnknownTLVInfo_Type())
...
lldpRemOrgDefInfoTable=_LldpRemOrgDefInfoTable_Object((1,0,8802,1,1,2,1,4,4))
if mibBuilder.loadTexts:lldpRemOrgDefInfoTable.setStatus(_A)
_LldpRemOrgDefInfoEntry_Object=MibTableRow
lldpRemOrgDefInfoEntry=_LldpRemOrgDefInfoEntry_Object((1,0,8802,1,1,2,1,4,4,1))
...
lldpRemOrgDefInfoOUI=_LldpRemOrgDefInfoOUI_Object((1,0,8802,1,1,2,1,4,4,1,1),_LldpRemOrgDefInfoOUI_Type())
...
lldpRemOrgDefInfoSubtype=_LldpRemOrgDefInfoSubtype_Object((1,0,8802,1,1,2,1,4,4,1,2),_LldpRemOrgDefInfoSubtype_Type())
...
lldpRemOrgDefInfoIndex=_LldpRemOrgDefInfoIndex_Object((1,0,8802,1,1,2,1,4,4,1,3),_LldpRemOrgDefInfoIndex_Type())
...
lldpRemOrgDefInfo=_LldpRemOrgDefInfo_Object((1,0,8802,1,1,2,1,4,4,1,4),_LldpRemOrgDefInfo_Type())
...
lldpStatsTxGroup=ObjectGroup((1,0,8802,1,1,2,2,2,5))
lldpStatsTxGroup.setObjects((_B,_A1))
if mibBuilder.loadTexts:lldpStatsTxGroup.setStatus(_A)
lldpLocSysGroup=ObjectGroup((1,0,8802,1,1,2,2,2,6))
...
lldpRemSysGroup=ObjectGroup((1,0,8802,1,1,2,2,2,7))
