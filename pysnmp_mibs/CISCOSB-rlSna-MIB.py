# SNMP MIB module (CISCOSB-rlSna-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-rlSna-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:40:39 2025
...
rlSnaClientAgentPollingEntry.setIndexNames(
    (0, "CISCOSB-rlSna-MIB", "rlSnaClientAgentClientSessionId"),
    (0, "CISCOSB-rlSna-MIB", "rlSnaClientAgentAgentAddressType"),
    (0, "CISCOSB-rlSna-MIB", "rlSnaClientAgentAgentAddress"),
    (1, "CISCOSB-rlSna-MIB", "rlSnaClientAgentMibName"),
)
if mibBuilder.loadTexts:
