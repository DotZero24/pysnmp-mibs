...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-DOT3-EFM-EPON-MIB
...
_HpnicfDot3MpcpAdminState_Type.__name__ = "TruthValue"
...
hpnicfDot3MpcpCompliance.setObjects(
      *(("HPN-ICF-DOT3-EFM-EPON-MIB", "hpnicfDot3MpcpGroupBase"),
        ("HPN-ICF-DOT3-EFM-EPON-MIB", "hpnicfDot3MpcpGroupParam"),
        ("HPN-ICF-DOT3-EFM-EPON-MIB", "hpnicfDot3MpcpGroupStat"))
)
if mibBuilder.loadTexts:
...
hpnicfDot3OmpeCompliance.setObjects(
      *(("HPN-ICF-DOT3-EFM-EPON-MIB", "hpnicfDot3OmpeGroupID"),
        ("HPN-ICF-DOT3-EFM-EPON-MIB", "hpnicfDot3OmpeGroupStat"))
)
if mibBuilder.loadTexts:
...
hpnicfDot3EponMauCompliance.setObjects(
      *(("HPN-ICF-DOT3-EFM-EPON-MIB", "hpnicfDot3EponMauGroupAll"),
        ("HPN-ICF-DOT3-EFM-EPON-MIB", "hpnicfDot3EponMauGroupFEC"))
)
if mibBuilder.loadTexts:
