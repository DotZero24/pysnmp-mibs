...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDControlGroup=tDDControlGroup, ptp500=ptp500, wirelessLinkAvailability=wirelessLinkAvailability, sNTPState=sNTPState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPv3Enable=sNMPv3Enable, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapVersion=sNMPTrapVersion, sNTPServerIPAddress=sNTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntp=sntp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStats=pubStats, aAAControl=aAAControl, telecomGroup=telecomGroup, phyControlGroup=phyControlGroup, transmitModulationMode=transmitModulationMode, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetPortNumber=telnetPortNumber, sNMPPortNumber=sNMPPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, cambium=cambium, dfsGroup=dfsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, accessMethod=accessMethod, linkName=linkName, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, longitude=longitude, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, sMTPEnabledMessages=sMTPEnabledMessages, PYSNMP_MODULE_ID=cambium, receiveChannel=receiveChannel, sNMPTrapTable=sNMPTrapTable, dfsTableNumber=dfsTableNumber, linkModeOptimisation=linkModeOptimisation, userTableEntry=userTableEntry, unitOutOfCalibration=unitOutOfCalibration, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSync=sNTPSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, installStatus=installStatus, daylightSaving=daylightSaving, smtpGroup=smtpGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, bootVersion=bootVersion, userTableIndex=userTableIndex, userPassword=userPassword, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, licensedCapacity=licensedCapacity, sNTPPollInterval=sNTPPollInterval, targetMACAddress=targetMACAddress, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogStateTrap=syslogStateTrap, syslogClient=syslogClient, installStatusTrap=installStatusTrap, syslogControl=syslogControl, sNTPSyncTrap=sNTPSyncTrap, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, supplementary=supplementary, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, timeZone=timeZone, siteName=siteName, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControl=phyControl, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, supplementaryGroup=supplementaryGroup, installArmState=installArmState, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, sntpGroup=sntpGroup, userRole=userRole, dfsTableEntry=dfsTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarmsGroup=alarmsGroup, dfsPeaks=dfsPeaks, tDDControl=tDDControl, phyStatus=phyStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userName=userName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqMHz=receiveFreqMHz, frequencyVariant=frequencyVariant, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsInterface=telecomsInterface, sMTPEmailAlert=sMTPEmailAlert, aAAControlGroup=aAAControlGroup, subnetMask=subnetMask, channelBandwidth=channelBandwidth, sMTPServerIPAddress=sMTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, versions=versions, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortAutoMdix=dataPortAutoMdix, systemClock=systemClock, softwareVersion=softwareVersion, dfsMeans=dfsMeans, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, ptp=ptp, regionCode=regionCode, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, gatewayIPAddress=gatewayIPAddress, latitude=latitude, encryptionGroup=encryptionGroup, syslogClientTrap=syslogClientTrap, telecomsChannelStatus=telecomsChannelStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCodeTrap=regionCodeTrap, transmitDataRate=transmitDataRate, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, channelChangeTrap=channelChangeTrap, snmpControl=snmpControl, transmitChannel=transmitChannel, linkLoss=linkLoss, versionsGroup=versionsGroup, ethernetFiberSupport=ethernetFiberSupport, phyStatusGroup=phyStatusGroup, vLANPriorityTable=vLANPriorityTable, syslogState=syslogState, systemReset=systemReset, alarms=alarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogControlGroup=syslogControlGroup, dfsTableIndex=dfsTableIndex, dfs=dfs, telecomsLineCode=telecomsLineCode, licenceGroup=licenceGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, range=range, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqKHz=receiveFreqKHz, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPPortNumber=hTTPPortNumber, telecomsLoopback=telecomsLoopback, ptpGroups=ptpGroups, userTable=userTable, vectorError=vectorError, cableLoss=cableLoss, ptmp=ptmp, telecom=telecom, pubStatsGroup=pubStatsGroup, altitude=altitude, eIRP=eIRP, bandwidthVariant=bandwidthVariant, incompatibleRegionCodes=incompatibleRegionCodes, smtp=smtp, groupID=groupID, licence=licence, userEnabled=userEnabled, reset=reset, hTTPSPortNumber=hTTPSPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsCableLength=telecomsCableLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, configuration=configuration, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, wirelessLinkStatus=wirelessLinkStatus, receivePower=receivePower, encryption=encryption, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, masterSlaveMode=masterSlaveMode, capacityLicenseMismatch=capacityLicenseMismatch, sNTPLastSync=sNTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, management=management, managementGroup=managementGroup, productName=productName, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteIPAddress=remoteIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, searchState=searchState)
