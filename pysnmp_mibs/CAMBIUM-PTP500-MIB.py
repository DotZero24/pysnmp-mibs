...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cambium/CAMBIUM-PTP500-MIB
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installStatus=installStatus, vLANManagementPriority=vLANManagementPriority, searchState=searchState, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, sntpGroup=sntpGroup, pubStatsGroup=pubStatsGroup, accessMethod=accessMethod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userEnabled=userEnabled, syslogClientTrap=syslogClientTrap, dfsTableNumber=dfsTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatus=telecomsChannelStatus, ptpCompliance=ptpCompliance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, dfs=dfs, regionCode=regionCode, installArmState=installArmState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitDataRate=transmitDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, altitude=altitude, secondarySoftwareVersion=secondarySoftwareVersion, channelBandwidth=channelBandwidth, aAAControl=aAAControl, tFTPServerIPAddress=tFTPServerIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, licence=licence, pubStats=pubStats, telnetPortNumber=telnetPortNumber, installArmStateTrap=installArmStateTrap, userPassword=userPassword, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsMeans=dfsMeans, syslogControl=syslogControl, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPPortNumber=sNMPPortNumber, versions=versions, ptp=ptp, cambium=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, ethernet=ethernet, linkLoss=linkLoss, sntp=sntp, dfsTable=dfsTable, vLANPriorityTableEntry=vLANPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, PYSNMP_MODULE_ID=cambium, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, supplementaryGroup=supplementaryGroup, sNTPLastSync=sNTPLastSync, capacityLicenseMismatch=capacityLicenseMismatch, regionCodeTrap=regionCodeTrap, unitOutOfCalibration=unitOutOfCalibration, dataPortStatus=dataPortStatus, reset=reset, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableIndex=userTableIndex, encryption=encryption, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSyncTrap=sNTPSyncTrap, ptpTrapPrefix=ptpTrapPrefix, longitude=longitude, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, range=range, telecomsCableLength=telecomsCableLength, vLANPriorityTable=vLANPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, encryptionAlgorithm=encryptionAlgorithm, supplementary=supplementary, tDDControl=tDDControl, dfsTableIndex=dfsTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsLineCode=telecomsLineCode, gatewayIPAddress=gatewayIPAddress, sMTPEmailAlert=sMTPEmailAlert, sNTPSync=sNTPSync, phyControlGroup=phyControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecom=telecom, licensedCapacity=licensedCapacity, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, encryptionGroup=encryptionGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userRole=userRole, remoteIPAddress=remoteIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, hardwareVersion=hardwareVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationMode=receiveModulationMode, configuration=configuration, syslogStateTrap=syslogStateTrap, eIRP=eIRP, dfsPeaks=dfsPeaks, antennaGain=antennaGain, telecomsLoopback=telecomsLoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerPortNumber=sNTPServerPortNumber, telecomsInterface=telecomsInterface, cableLoss=cableLoss, transmitFreqKHz=transmitFreqKHz, latitude=latitude, ptpTraps=ptpTraps, smtp=smtp, receiveFreqMHz=receiveFreqMHz, resetGroup=resetGroup, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, dataPortAutoMdix=dataPortAutoMdix, ptpGroups=ptpGroups, alarms=alarms, signalStrengthRatio=signalStrengthRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vectorError=vectorError, licenceGroup=licenceGroup, sNTPPollInterval=sNTPPollInterval, syslogState=syslogState, tDDSynchronizationMode=tDDSynchronizationMode, sNTPState=sNTPState, linkSymmetry=linkSymmetry, productName=productName, incompatibleRegionCodes=incompatibleRegionCodes, siteName=siteName, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp500=ptp500, ethernetGroup=ethernetGroup, masterSlaveMode=masterSlaveMode, userTableEntry=userTableEntry, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, notificationsGroup=notificationsGroup, phyStatus=phyStatus, phyControl=phyControl, userName=userName, syslogControlGroup=syslogControlGroup, versionsGroup=versionsGroup, receiveDataRate=receiveDataRate, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitPower=transmitPower, frequencyVariant=frequencyVariant, tDDControlGroup=tDDControlGroup, systemClock=systemClock, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, userTable=userTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANManagementVID=vLANManagementVID, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptmp=ptmp, transmitChannel=transmitChannel, dfsGroup=dfsGroup, sNMPv3Enable=sNMPv3Enable, installStatusTrap=installStatusTrap, linkName=linkName, receiveChannel=receiveChannel, sNMPTrapVersion=sNMPTrapVersion, sNTPServerIPAddress=sNTPServerIPAddress, telecomGroup=telecomGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortDisabledWarning=dataPortDisabledWarning, byteErrorRatio=byteErrorRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, groupID=groupID, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkAvailability=wirelessLinkAvailability, bandwidthVariant=bandwidthVariant, targetMACAddress=targetMACAddress, linkModeOptimisation=linkModeOptimisation, management=management, configurationGroup=configurationGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, syslogClient=syslogClient, systemReset=systemReset, alarmsGroup=alarmsGroup, receivePower=receivePower, timeZone=timeZone, userTableNumber=userTableNumber, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving)
