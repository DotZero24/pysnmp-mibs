...
myAntiArpcheatMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,41))
...
myAntiArpcheatMIBObjects=_MyAntiArpcheatMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,41,1))
_MyTrustedArpDelete_Type=Integer32
_MyTrustedArpDelete_Object=MibScalar
myTrustedArpDelete=_MyTrustedArpDelete_Object((1,3,6,1,4,1,4881,1,1,10,2,41,1,1),_MyTrustedArpDelete_Type())
...
myTrustedArpTable=_MyTrustedArpTable_Object((1,3,6,1,4,1,4881,1,1,10,2,41,1,2))
if mibBuilder.loadTexts:myTrustedArpTable.setStatus(_A)
_MyTrustedArpEntry_Object=MibTableRow
myTrustedArpEntry=_MyTrustedArpEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,41,1,2,1))
...
trustedArpIfIndex=_TrustedArpIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,41,1,2,1,1),_TrustedArpIfIndex_Type())
...
trustedArpIp=_TrustedArpIp_Object((1,3,6,1,4,1,4881,1,1,10,2,41,1,2,1,2),_TrustedArpIp_Type())
...
trustedArpMediaPhysAddress=_TrustedArpMediaPhysAddress_Object((1,3,6,1,4,1,4881,1,1,10,2,41,1,2,1,3),_TrustedArpMediaPhysAddress_Type())
...
trustedArpVlan=_TrustedArpVlan_Object((1,3,6,1,4,1,4881,1,1,10,2,41,1,2,1,4),_TrustedArpVlan_Type())
...
trustedArpOperationType=_TrustedArpOperationType_Object((1,3,6,1,4,1,4881,1,1,10,2,41,1,2,1,5),_TrustedArpOperationType_Type())
...
myAntiArpcheatMIBConformance=_MyAntiArpcheatMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,41,2))
_MyAntiArpcheatMIBCompliances_ObjectIdentity=ObjectIdentity
myAntiArpcheatMIBCompliances=_MyAntiArpcheatMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,41,2,1))
_MyAntiArpcheatMIBGroups_ObjectIdentity=ObjectIdentity
myAntiArpcheatMIBGroups=_MyAntiArpcheatMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,41,2,2))
myAntiArpcheatMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,41,2,2,1))
...
myAntiArpcheatMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,41,2,1,1))
