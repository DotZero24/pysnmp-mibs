...
mibBuilder.exportSymbols("CIENA-TC", CienaMacAddress=CienaMacAddress, CienaGlobalState=CienaGlobalState, CienaGlobalSeverity=CienaGlobalSeverity, CienaStatsClear=CienaStatsClear)
