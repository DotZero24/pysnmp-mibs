...
dlswTConnConfigIndex, dlswCircuitState, dlswCircuitEntry, dlswTConnOperState, MacAddressNC, TAddress, dlswIfEntry, DlcType, dlswTConnConfigEntry, LFSize, dlswTConnOperEntry, dlswTConnTcpConfigEntry = mibBuilder.importSymbols("DLSW-MIB", "dlswTConnConfigIndex", "dlswCircuitState", "dlswCircuitEntry", "dlswTConnOperState", "MacAddressNC", "TAddress", "dlswIfEntry", "DlcType", "dlswTConnConfigEntry", "LFSize", "dlswTConnOperEntry", "dlswTConnTcpConfigEntry")
...
mibBuilder.exportSymbols("CISCO-DLSW-EXT-MIB", cdeNodePromPeerDefaultsCost=cdeNodePromPeerDefaultsCost, cdeNodeTAddr=cdeNodeTAddr, cdeTConnConfigBackupTAddr=cdeTConnConfigBackupTAddr, cdeInterface=cdeInterface, cdeMIBTConnConfigGroup=cdeMIBTConnConfigGroup, TCPQueueMax=TCPQueueMax, cdeTraps=cdeTraps, cdeTrapControl=cdeTrapControl, cdeNodePeerOnDemandDefaultsPriority=cdeNodePeerOnDemandDefaultsPriority, cdeIfEntry=cdeIfEntry, cdeMIBInterfaceGroup=cdeMIBInterfaceGroup, cdeNodePeerOnDemandDefaultsFst=cdeNodePeerOnDemandDefaultsFst, cdeNodePeerOnDemandDefaultsLFSize=cdeNodePeerOnDemandDefaultsLFSize, cdeFastS2TAddress=cdeFastS2TAddress, cdeTConnOperTDomainType=cdeTConnOperTDomainType, cdeMIBCompliances=cdeMIBCompliances, cdeTConnConfigTable=cdeTConnConfigTable, cdeFastS1Mac=cdeFastS1Mac, cdeCircuitS1Name=cdeCircuitS1Name, cdeTConnOperPartnerBorderPeer=cdeTConnOperPartnerBorderPeer, cdeNodePromPeerDefaultsDestMac=cdeNodePromPeerDefaultsDestMac, cdeFastS2Sap=cdeFastS2Sap, cdeFastS1RouteInfo=cdeFastS1RouteInfo, cdeDirectHdlcDomain=cdeDirectHdlcDomain, cdeTrapsPrefix=cdeTrapsPrefix, cdeTrapCntlCircuit=cdeTrapCntlCircuit, cdeTConnTcp=cdeTConnTcp, cdeTrapTConnUpDown=cdeTrapTConnUpDown, cdeNodeMaxPacingWindow=cdeNodeMaxPacingWindow, cdeDirectFrameRelayDomain=cdeDirectFrameRelayDomain, cdeDomains=cdeDomains, cdeFastS1CacheId=cdeFastS1CacheId, cdeTConnConfigLFSize=cdeTConnConfigLFSize, cdeTConnDirect=cdeTConnDirect, cdeNodeBiuSegment=cdeNodeBiuSegment, cdeTConnConfigKeepaliveInterval=cdeTConnConfigKeepaliveInterval, cdeIfTable=cdeIfTable, cdeNodeKeepaliveInterval=cdeNodeKeepaliveInterval, cdeTConnDirectConfigIfIndex=cdeTConnDirectConfigIfIndex, cdeCircuitTable=cdeCircuitTable, cdeTConn=cdeTConn, cdeTConnDirectConfigTable=cdeTConnDirectConfigTable, PYSNMP_MODULE_ID=ciscoDlswExtMIB, cdeIfType=cdeIfType, cdeMIBCircuitGroup=cdeMIBCircuitGroup, cdeFastTimeToLive=cdeFastTimeToLive, ciscoDlswExtMIB=ciscoDlswExtMIB, cdeTConnOperPartnerGroupNum=cdeTConnOperPartnerGroupNum, cdeTConnDirectConfigEntry=cdeTConnDirectConfigEntry, cdeTConnDirectConfigMediaEncap=cdeTConnDirectConfigMediaEncap, cdeMIBCompliance=cdeMIBCompliance, cdeNodePeerOnDemandDefaultsTCPQueueMax=cdeNodePeerOnDemandDefaultsTCPQueueMax, cdeTConnOperPartnerCost=cdeTConnOperPartnerCost, cdeFastEntry=cdeFastEntry, cdeTrapControlGroup=cdeTrapControlGroup, cdeTConnTcpConfigQueueMax=cdeTConnTcpConfigQueueMax, cdeTConnConfigDestMac=cdeTConnConfigDestMac, Cost=Cost, cdeMIBTConnOperGroup=cdeMIBTConnOperGroup, cdeMIBNodeGroup=cdeMIBNodeGroup, cdeTConnConfigEntry=cdeTConnConfigEntry, cdeMIBConformance=cdeMIBConformance, cdeFastOrigin=cdeFastOrigin, cdeNodePromPeerDefaultsTCPQueueMax=cdeNodePromPeerDefaultsTCPQueueMax, cdeFastS2CacheId=cdeFastS2CacheId, cdeNodeBorder=cdeNodeBorder, cdeNodePromiscuous=cdeNodePromiscuous, cdeMIBFastGroup=cdeMIBFastGroup, cdeFastS1Sap=cdeFastS1Sap, cdeLlc2Domain=cdeLlc2Domain, cdeTConnOperTable=cdeTConnOperTable, TDomainType=TDomainType, cdeTConnTcpConfigEntry=cdeTConnTcpConfigEntry, cdeCircuitEntry=cdeCircuitEntry, cdeTConnConfigPriority=cdeTConnConfigPriority, cdeCircuitS2Name=cdeCircuitS2Name, cdeCircuitS1IdNum=cdeCircuitS1IdNum, cdeMIBTConnDirectConfigGroup=cdeMIBTConnDirectConfigGroup, cdeTrapCircuitUpDown=cdeTrapCircuitUpDown, cdeNodePromPeerDefaultsLFSize=cdeNodePromPeerDefaultsLFSize, cdeTConnConfigBackupLinger=cdeTConnConfigBackupLinger, cdeMIBTConnTcpConfigGroup=cdeMIBTConnTcpConfigGroup, cdeTConnConfigTDomainType=cdeTConnConfigTDomainType, cdeTConnConfigDynamic=cdeTConnConfigDynamic, cdeFastTable=cdeFastTable, cdeTConnOperPartnerPriority=cdeTConnOperPartnerPriority, cdeNodeCost=cdeNodeCost, cdeTConnConfigDynamicNoLlc=cdeTConnConfigDynamicNoLlc, cdeFastS2TDomain=cdeFastS2TDomain, cdeNodeGroup=cdeNodeGroup, cdeTConnConfigCost=cdeTConnConfigCost, cdeTrapCntlTConn=cdeTrapCntlTConn, cdeFastS2Mac=cdeFastS2Mac, KeepaliveInterval=KeepaliveInterval, cdeTConnConfigLocalAck=cdeTConnConfigLocalAck, cdeCircuitS1IdBlock=cdeCircuitS1IdBlock, cdeTConnOperEntry=cdeTConnOperEntry, cdeTConnDirectConfigFrameRelayDlci=cdeTConnDirectConfigFrameRelayDlci, ciscoDlswExtMIBObjects=ciscoDlswExtMIBObjects, cdeNodePeerOnDemandDefaultsInactivityInterval=cdeNodePeerOnDemandDefaultsInactivityInterval, cdeFSTDomain=cdeFSTDomain, cdeNode=cdeNode, cdeTConnConfigBackup=cdeTConnConfigBackup, cdeFast=cdeFast, cdeNodePromPeerDefaultsKeepaliveInterval=cdeNodePromPeerDefaultsKeepaliveInterval, cdeTConnConfigBackupLingerInterval=cdeTConnConfigBackupLingerInterval, cdeTConnSpecific=cdeTConnSpecific, cdeNodeInitPacingWindow=cdeNodeInitPacingWindow, cdeNodePeerOnDemandDefaultsKeepaliveInterval=cdeNodePeerOnDemandDefaultsKeepaliveInterval, cdeNodePeerOnDemandDefaultsCost=cdeNodePeerOnDemandDefaultsCost, cdeFastS1IfIndex=cdeFastS1IfIndex, cdeNodePassiveConnect=cdeNodePassiveConnect, cdeMIBGroups=cdeMIBGroups, cdeTConnConfigDynamicInactivityInterval=cdeTConnConfigDynamicInactivityInterval, cdeTConnTcpConfigTable=cdeTConnTcpConfigTable, cdeCircuit=cdeCircuit)
