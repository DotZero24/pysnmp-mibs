...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-DLSW-EXT-MIB
...
TAddress, dlswTConnOperState, dlswTConnTcpConfigEntry, dlswIfEntry, dlswCircuitEntry, dlswTConnConfigIndex, DlcType, LFSize, dlswCircuitState, dlswTConnConfigEntry, MacAddressNC, dlswTConnOperEntry = mibBuilder.importSymbols("DLSW-MIB", "TAddress", "dlswTConnOperState", "dlswTConnTcpConfigEntry", "dlswIfEntry", "dlswCircuitEntry", "dlswTConnConfigIndex", "DlcType", "LFSize", "dlswCircuitState", "dlswTConnConfigEntry", "MacAddressNC", "dlswTConnOperEntry")
...
mibBuilder.exportSymbols("CISCO-DLSW-EXT-MIB", cdeTConnOperPartnerGroupNum=cdeTConnOperPartnerGroupNum, cdeTConnTcp=cdeTConnTcp, cdeFastS2TAddress=cdeFastS2TAddress, cdeTConnDirect=cdeTConnDirect, cdeInterface=cdeInterface, cdeDirectHdlcDomain=cdeDirectHdlcDomain, cdeTConnConfigLFSize=cdeTConnConfigLFSize, cdeIfType=cdeIfType, cdeFastS2Mac=cdeFastS2Mac, cdeNodePromiscuous=cdeNodePromiscuous, cdeTConnTcpConfigTable=cdeTConnTcpConfigTable, cdeFastTable=cdeFastTable, cdeMIBTConnDirectConfigGroup=cdeMIBTConnDirectConfigGroup, cdeCircuitS2Name=cdeCircuitS2Name, cdeMIBCircuitGroup=cdeMIBCircuitGroup, KeepaliveInterval=KeepaliveInterval, cdeNodeKeepaliveInterval=cdeNodeKeepaliveInterval, cdeTConnDirectConfigEntry=cdeTConnDirectConfigEntry, Cost=Cost, cdeTConnDirectConfigFrameRelayDlci=cdeTConnDirectConfigFrameRelayDlci, cdeMIBFastGroup=cdeMIBFastGroup, cdeTConnConfigBackup=cdeTConnConfigBackup, cdeNodeInitPacingWindow=cdeNodeInitPacingWindow, cdeTConnConfigPriority=cdeTConnConfigPriority, cdeMIBCompliance=cdeMIBCompliance, cdeNodePeerOnDemandDefaultsCost=cdeNodePeerOnDemandDefaultsCost, cdeCircuitTable=cdeCircuitTable, cdeTrapsPrefix=cdeTrapsPrefix, cdeFSTDomain=cdeFSTDomain, cdeTConnConfigTable=cdeTConnConfigTable, cdeTConnConfigCost=cdeTConnConfigCost, cdeTrapControl=cdeTrapControl, cdeTConnDirectConfigIfIndex=cdeTConnDirectConfigIfIndex, cdeNodePromPeerDefaultsDestMac=cdeNodePromPeerDefaultsDestMac, cdeFastS2TDomain=cdeFastS2TDomain, cdeFastOrigin=cdeFastOrigin, cdeTrapTConnUpDown=cdeTrapTConnUpDown, cdeNodePassiveConnect=cdeNodePassiveConnect, cdeMIBTConnConfigGroup=cdeMIBTConnConfigGroup, cdeNodePeerOnDemandDefaultsLFSize=cdeNodePeerOnDemandDefaultsLFSize, cdeNodePeerOnDemandDefaultsFst=cdeNodePeerOnDemandDefaultsFst, cdeIfTable=cdeIfTable, cdeTConnTcpConfigQueueMax=cdeTConnTcpConfigQueueMax, cdeNodeGroup=cdeNodeGroup, cdeTConnSpecific=cdeTConnSpecific, PYSNMP_MODULE_ID=ciscoDlswExtMIB, cdeFastS1CacheId=cdeFastS1CacheId, cdeIfEntry=cdeIfEntry, cdeTConnConfigTDomainType=cdeTConnConfigTDomainType, cdeTConnOperTable=cdeTConnOperTable, cdeLlc2Domain=cdeLlc2Domain, cdeFast=cdeFast, cdeTConnConfigLocalAck=cdeTConnConfigLocalAck, cdeNodeMaxPacingWindow=cdeNodeMaxPacingWindow, cdeCircuitEntry=cdeCircuitEntry, cdeFastS1RouteInfo=cdeFastS1RouteInfo, ciscoDlswExtMIB=ciscoDlswExtMIB, cdeTrapCntlTConn=cdeTrapCntlTConn, cdeTConnConfigBackupTAddr=cdeTConnConfigBackupTAddr, cdeTConnDirectConfigMediaEncap=cdeTConnDirectConfigMediaEncap, cdeMIBInterfaceGroup=cdeMIBInterfaceGroup, cdeTrapCntlCircuit=cdeTrapCntlCircuit, cdeTConnConfigDynamicNoLlc=cdeTConnConfigDynamicNoLlc, cdeMIBTConnOperGroup=cdeMIBTConnOperGroup, cdeTConnConfigBackupLingerInterval=cdeTConnConfigBackupLingerInterval, cdeFastS1IfIndex=cdeFastS1IfIndex, cdeCircuitS1IdNum=cdeCircuitS1IdNum, cdeTConnOperPartnerCost=cdeTConnOperPartnerCost, cdeFastS2Sap=cdeFastS2Sap, cdeTrapControlGroup=cdeTrapControlGroup, cdeTConnOperTDomainType=cdeTConnOperTDomainType, cdeNodePromPeerDefaultsCost=cdeNodePromPeerDefaultsCost, cdeTConnOperEntry=cdeTConnOperEntry, cdeFastEntry=cdeFastEntry, cdeDirectFrameRelayDomain=cdeDirectFrameRelayDomain, cdeTraps=cdeTraps, cdeTConnConfigDestMac=cdeTConnConfigDestMac, cdeTConnOperPartnerBorderPeer=cdeTConnOperPartnerBorderPeer, cdeCircuitS1Name=cdeCircuitS1Name, cdeTConnOperPartnerPriority=cdeTConnOperPartnerPriority, cdeMIBConformance=cdeMIBConformance, cdeMIBCompliances=cdeMIBCompliances, cdeMIBNodeGroup=cdeMIBNodeGroup, cdeDomains=cdeDomains, cdeNodePeerOnDemandDefaultsTCPQueueMax=cdeNodePeerOnDemandDefaultsTCPQueueMax, cdeCircuitS1IdBlock=cdeCircuitS1IdBlock, cdeFastS1Mac=cdeFastS1Mac, cdeNodeCost=cdeNodeCost, cdeFastTimeToLive=cdeFastTimeToLive, cdeNodeTAddr=cdeNodeTAddr, cdeMIBGroups=cdeMIBGroups, cdeMIBTConnTcpConfigGroup=cdeMIBTConnTcpConfigGroup, cdeTConnConfigEntry=cdeTConnConfigEntry, cdeNodePromPeerDefaultsKeepaliveInterval=cdeNodePromPeerDefaultsKeepaliveInterval, cdeNodePeerOnDemandDefaultsInactivityInterval=cdeNodePeerOnDemandDefaultsInactivityInterval, cdeTConnConfigBackupLinger=cdeTConnConfigBackupLinger, cdeCircuit=cdeCircuit, TDomainType=TDomainType, cdeNodePeerOnDemandDefaultsKeepaliveInterval=cdeNodePeerOnDemandDefaultsKeepaliveInterval, cdeNode=cdeNode, cdeTConnConfigDynamicInactivityInterval=cdeTConnConfigDynamicInactivityInterval, cdeNodeBiuSegment=cdeNodeBiuSegment, ciscoDlswExtMIBObjects=ciscoDlswExtMIBObjects, cdeNodeBorder=cdeNodeBorder, cdeNodePromPeerDefaultsTCPQueueMax=cdeNodePromPeerDefaultsTCPQueueMax, cdeTConnConfigDynamic=cdeTConnConfigDynamic, cdeTConnDirectConfigTable=cdeTConnDirectConfigTable, TCPQueueMax=TCPQueueMax, cdeTConnTcpConfigEntry=cdeTConnTcpConfigEntry, cdeTConnConfigKeepaliveInterval=cdeTConnConfigKeepaliveInterval, cdeFastS1Sap=cdeFastS1Sap, cdeFastS2CacheId=cdeFastS2CacheId, cdeTrapCircuitUpDown=cdeTrapCircuitUpDown, cdeNodePeerOnDemandDefaultsPriority=cdeNodePeerOnDemandDefaultsPriority, cdeNodePromPeerDefaultsLFSize=cdeNodePromPeerDefaultsLFSize, cdeTConn=cdeTConn)
