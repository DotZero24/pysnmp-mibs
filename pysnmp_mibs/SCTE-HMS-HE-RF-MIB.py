...
mibBuilder.exportSymbols("SCTE-HMS-HE-RF-MIB", heRFAmplifierGroup=heRFAmplifierGroup, heRFMib=heRFMib, PYSNMP_MODULE_ID=heRFMib, heRFSwitchGroup=heRFSwitchGroup)
