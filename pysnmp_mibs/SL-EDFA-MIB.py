...
# Notes
# -----
# ASN.1 source file://mibs/smartoptics/SL-EDFA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:11:14 2025
...
edfaSigOutputPower = _EdfaSigOutputPower_Object(
    (1, 3, 6, 1, 4, 1, 4515, 1, 9, 1, 1, 1, 36),
    _EdfaSigOutputPower_Type()
)
edfaSigOutputPower.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    edfaSigOutputPower.setStatus("current")


class _EdfaLossPropagation_Type(Integer32):
    """Custom type edfaLossPropagation based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_EdfaLossPropagation_Type.__name__ = "Integer32"
_EdfaLossPropagation_Object = MibTableColumn
edfaLossPropagation = _EdfaLossPropagation_Object(
    (1, 3, 6, 1, 4, 1, 4515, 1, 9, 1, 1, 1, 37),
    _EdfaLossPropagation_Type()
)
edfaLossPropagation.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    edfaLossPropagation.setStatus("current")


class _EdfaConfigAmpMngPort_Type(Integer32):
    """Custom type edfaConfigAmpMngPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_EdfaConfigAmpMngPort_Type.__name__ = "Integer32"
_EdfaConfigAmpMngPort_Object = MibScalar
edfaConfigAmpMngPort = _EdfaConfigAmpMngPort_Object(
    (1, 3, 6, 1, 4, 1, 4515, 1, 9, 1, 2),
    _EdfaConfigAmpMngPort_Type()
)
edfaConfigAmpMngPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    edfaConfigAmpMngPort.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"slEdfa": slEdfa,
       ...
       "edfaSigOutputPower": edfaSigOutputPower,
       "edfaLossPropagation": edfaLossPropagation,
       "edfaConfigAmpMngPort": edfaConfigAmpMngPort,
       "edfaTraps": edfaTraps,
