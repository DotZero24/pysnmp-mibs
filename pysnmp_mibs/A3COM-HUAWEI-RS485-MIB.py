...
h3cRS485Properties=_H3cRS485Properties_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,109,1))
_H3cRS485PropertiesTable_Object=MibTable
h3cRS485PropertiesTable=_H3cRS485PropertiesTable_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1))
if mibBuilder.loadTexts:h3cRS485PropertiesTable.setStatus(_A)
_H3cRS485PropertiesEntry_Object=MibTableRow
h3cRS485PropertiesEntry=_H3cRS485PropertiesEntry_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1))
...
h3cRS485RawSessionNextIndex=_H3cRS485RawSessionNextIndex_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,1),_H3cRS485RawSessionNextIndex_Type())
...
h3cRS485BaudRate=_H3cRS485BaudRate_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,2),_H3cRS485BaudRate_Type())
...
h3cRS485DataBits=_H3cRS485DataBits_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,3),_H3cRS485DataBits_Type())
...
h3cRS485Parity=_H3cRS485Parity_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,4),_H3cRS485Parity_Type())
...
h3cRS485StopBits=_H3cRS485StopBits_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,5),_H3cRS485StopBits_Type())
...
h3cRS485FlowControl=_H3cRS485FlowControl_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,6),_H3cRS485FlowControl_Type())
...
h3cRS485TXCharacters=_H3cRS485TXCharacters_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,7),_H3cRS485TXCharacters_Type())
...
h3cRS485RXCharacters=_H3cRS485RXCharacters_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,8),_H3cRS485RXCharacters_Type())
...
h3cRS485TXErrCharacters=_H3cRS485TXErrCharacters_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,9),_H3cRS485TXErrCharacters_Type())
...
h3cRS485RXErrCharacters=_H3cRS485RXErrCharacters_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,10),_H3cRS485RXErrCharacters_Type())
...
h3cRS485ResetCharacters=_H3cRS485ResetCharacters_Object((1,3,6,1,4,1,43,45,1,10,2,109,1,1,1,11),_H3cRS485ResetCharacters_Type())
...
h3cRS485RawSessions=_H3cRS485RawSessions_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,109,2))
_H3cRS485RawSessionSummary_ObjectIdentity=ObjectIdentity
h3cRS485RawSessionSummary=_H3cRS485RawSessionSummary_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,109,2,1))
...
h3cRS485RawSessionMaxNum=_H3cRS485RawSessionMaxNum_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,1,1),_H3cRS485RawSessionMaxNum_Type())
...
h3cRS485RawSessionTable=_H3cRS485RawSessionTable_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,2))
if mibBuilder.loadTexts:h3cRS485RawSessionTable.setStatus(_A)
_H3cRS485RawSessionEntry_Object=MibTableRow
h3cRS485RawSessionEntry=_H3cRS485RawSessionEntry_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,2,1))
...
h3cRS485SessionIndex=_H3cRS485SessionIndex_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,2,1,1),_H3cRS485SessionIndex_Type())
...
h3cRS485SessionType=_H3cRS485SessionType_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,2,1,2),_H3cRS485SessionType_Type())
...
h3cRS485SessionAddType=_H3cRS485SessionAddType_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,2,1,3),_H3cRS485SessionAddType_Type())
...
h3cRS485SessionRemoteIP=_H3cRS485SessionRemoteIP_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,2,1,4),_H3cRS485SessionRemoteIP_Type())
...
h3cRS485SessionRemotePort=_H3cRS485SessionRemotePort_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,2,1,5),_H3cRS485SessionRemotePort_Type())
...
h3cRS485SessionLocalPort=_H3cRS485SessionLocalPort_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,2,1,6),_H3cRS485SessionLocalPort_Type())
...
h3cRS485SessionStatus=_H3cRS485SessionStatus_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,2,1,7),_H3cRS485SessionStatus_Type())
...
h3cRS485RawSessionErrInfoTable=_H3cRS485RawSessionErrInfoTable_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,3))
if mibBuilder.loadTexts:h3cRS485RawSessionErrInfoTable.setStatus(_A)
_H3cRS485RawSessionErrInfoEntry_Object=MibTableRow
h3cRS485RawSessionErrInfoEntry=_H3cRS485RawSessionErrInfoEntry_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,3,1))
...
h3cRS485RawSessionErrInfo=_H3cRS485RawSessionErrInfo_Object((1,3,6,1,4,1,43,45,1,10,2,109,2,3,1,1),_H3cRS485RawSessionErrInfo_Type())
