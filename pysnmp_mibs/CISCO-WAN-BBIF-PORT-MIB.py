...
mibBuilder.exportSymbols("CISCO-WAN-BBIF-PORT-MIB", bbIfRcvErroredCells=bbIfRcvErroredCells, bbIfRowStatus=bbIfRowStatus, bbIfCntGrpEntry=bbIfCntGrpEntry, nextBbIfNumAvailable=nextBbIfNumAvailable, cwbPortGenearlGroup=cwbPortGenearlGroup, bbStateIfNum=bbStateIfNum, bbIfCnfPortGrpTable=bbIfCnfPortGrpTable, bbIfCnfPortGrpEntry=bbIfCnfPortGrpEntry, bbIfXmtClp1Cells=bbIfXmtClp1Cells, bbIfNum=bbIfNum, bbIfRcvClp1DiscCells=bbIfRcvClp1DiscCells, bbIfIngrPctBandwidth=bbIfIngrPctBandwidth, bbIfSpeed=bbIfSpeed, bbIfLineNum=bbIfLineNum, bbIfRcvRmCells=bbIfRcvRmCells, cwbPortStatsGroup=cwbPortStatsGroup, cwbPortMIBConformance=cwbPortMIBConformance, bbIfStateGrpEntry=bbIfStateGrpEntry, bbIfRcvValidOAMCells=bbIfRcvValidOAMCells, bbIfRcvClp1Cells=bbIfRcvClp1Cells, bbIfCnfPortGrp=bbIfCnfPortGrp, bbIfStateGrpTable=bbIfStateGrpTable, cwbPortMIBGroups=cwbPortMIBGroups, ciscoWanBbifPortMIB=ciscoWanBbifPortMIB, PYSNMP_MODULE_ID=ciscoWanBbifPortMIB, bbIfXmtRmCells=bbIfXmtRmCells, bbIfXmtClp0Cells=bbIfXmtClp0Cells, bbIfOversubscribed=bbIfOversubscribed, cwbPortMIBCompliances=cwbPortMIBCompliances, bbIfEgrPercentUtil=bbIfEgrPercentUtil, bbIfXmtOAMCells=bbIfXmtOAMCells, bbIfTotalCells=bbIfTotalCells, bbIfMaxCellRatePct=bbIfMaxCellRatePct, cwbPortCompliance=cwbPortCompliance, bbIfRcvClp0DiscCells=bbIfRcvClp0DiscCells, cwbPortConfGroup=cwbPortConfGroup, bbIfCntClrButton=bbIfCntClrButton, bbIfAdmin=bbIfAdmin, bbIfIngrPercentUtil=bbIfIngrPercentUtil, bbIfCntGrp=bbIfCntGrp, bbIfCntGrpTable=bbIfCntGrpTable, bbCntIfNum=bbCntIfNum, bbIfEgrPctBandwidth=bbIfEgrPctBandwidth, bbIfMinVpi=bbIfMinVpi, cwbPortStateGroup=cwbPortStateGroup, bbIfRcvClp0Cells=bbIfRcvClp0Cells, bbIfState=bbIfState, bbIfMaxVpi=bbIfMaxVpi)
