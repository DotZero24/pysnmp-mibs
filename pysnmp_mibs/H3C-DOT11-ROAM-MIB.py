...
if mibBuilder.loadTexts:h3cDot11ROAM.setRevisions(('2016-03-11 18:00','2010-08-04 18:00','2009-05-07 20:00','2008-07-23 12:00'))
...
h3cDot11RoamCfgGroup=_H3cDot11RoamCfgGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,75,10,1))
_H3cDot11MobGrpTable_Object=MibTable
h3cDot11MobGrpTable=_H3cDot11MobGrpTable_Object((1,3,6,1,4,1,2011,10,2,75,10,1,1))
if mibBuilder.loadTexts:h3cDot11MobGrpTable.setStatus(_A)
_H3cDot11MobGrpEntry_Object=MibTableRow
h3cDot11MobGrpEntry=_H3cDot11MobGrpEntry_Object((1,3,6,1,4,1,2011,10,2,75,10,1,1,1))
...
h3cDot11MobGrpName=_H3cDot11MobGrpName_Object((1,3,6,1,4,1,2011,10,2,75,10,1,1,1,1),_H3cDot11MobGrpName_Type())
...
h3cdot11MobGrpTunnelType=_H3cdot11MobGrpTunnelType_Object((1,3,6,1,4,1,2011,10,2,75,10,1,1,1,2),_H3cdot11MobGrpTunnelType_Type())
...
h3cDot11MobGrpSrcIPAddr=_H3cDot11MobGrpSrcIPAddr_Object((1,3,6,1,4,1,2011,10,2,75,10,1,1,1,3),_H3cDot11MobGrpSrcIPAddr_Type())
...
h3cDot11MobGrpAuthMode=_H3cDot11MobGrpAuthMode_Object((1,3,6,1,4,1,2011,10,2,75,10,1,1,1,4),_H3cDot11MobGrpAuthMode_Type())
...
h3cDot11MobGrpAuthKey=_H3cDot11MobGrpAuthKey_Object((1,3,6,1,4,1,2011,10,2,75,10,1,1,1,5),_H3cDot11MobGrpAuthKey_Type())
...
h3cDot11MobGrpEnable=_H3cDot11MobGrpEnable_Object((1,3,6,1,4,1,2011,10,2,75,10,1,1,1,6),_H3cDot11MobGrpEnable_Type())
...
h3cDot11MobGrpRowStatus=_H3cDot11MobGrpRowStatus_Object((1,3,6,1,4,1,2011,10,2,75,10,1,1,1,7),_H3cDot11MobGrpRowStatus_Type())
...
h3cDot11MobGrpMemberTable=_H3cDot11MobGrpMemberTable_Object((1,3,6,1,4,1,2011,10,2,75,10,1,2))
if mibBuilder.loadTexts:h3cDot11MobGrpMemberTable.setStatus(_A)
_H3cDot11MobGrpMemberEntry_Object=MibTableRow
h3cDot11MobGrpMemberEntry=_H3cDot11MobGrpMemberEntry_Object((1,3,6,1,4,1,2011,10,2,75,10,1,2,1))
...
h3cDot11MobGrpMemberIpAddr=_H3cDot11MobGrpMemberIpAddr_Object((1,3,6,1,4,1,2011,10,2,75,10,1,2,1,1),_H3cDot11MobGrpMemberIpAddr_Type())
...
h3cDot11MobGrpMemberStatus=_H3cDot11MobGrpMemberStatus_Object((1,3,6,1,4,1,2011,10,2,75,10,1,2,1,2),_H3cDot11MobGrpMemberStatus_Type())
...
h3cDot11MobGrpMemberIf=_H3cDot11MobGrpMemberIf_Object((1,3,6,1,4,1,2011,10,2,75,10,1,2,1,3),_H3cDot11MobGrpMemberIf_Type())
...
h3cDot11MobGrpMemberUpTime=_H3cDot11MobGrpMemberUpTime_Object((1,3,6,1,4,1,2011,10,2,75,10,1,2,1,4),_H3cDot11MobGrpMemberUpTime_Type())
...
h3cDot11MobGrpMemberRowStatus=_H3cDot11MobGrpMemberRowStatus_Object((1,3,6,1,4,1,2011,10,2,75,10,1,2,1,5),_H3cDot11MobGrpMemberRowStatus_Type())
...
h3cDot11RoamStatusGroup=_H3cDot11RoamStatusGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,75,10,2))
_H3cDot11RoamInInfoTable_Object=MibTable
h3cDot11RoamInInfoTable=_H3cDot11RoamInInfoTable_Object((1,3,6,1,4,1,2011,10,2,75,10,2,1))
if mibBuilder.loadTexts:h3cDot11RoamInInfoTable.setStatus(_A)
_H3cDot11RoamInInfoEntry_Object=MibTableRow
h3cDot11RoamInInfoEntry=_H3cDot11RoamInInfoEntry_Object((1,3,6,1,4,1,2011,10,2,75,10,2,1,1))
...
h3cDot11RoamClientMAC=_H3cDot11RoamClientMAC_Object((1,3,6,1,4,1,2011,10,2,75,10,2,1,1,1),_H3cDot11RoamClientMAC_Type())
...
h3cDot11RoamInClientBSSID=_H3cDot11RoamInClientBSSID_Object((1,3,6,1,4,1,2011,10,2,75,10,2,1,1,2),_H3cDot11RoamInClientBSSID_Type())
...
h3cDot11RoamInClientVlanID=_H3cDot11RoamInClientVlanID_Object((1,3,6,1,4,1,2011,10,2,75,10,2,1,1,3),_H3cDot11RoamInClientVlanID_Type())
...
h3cDot11RoamInHomeACIPType=_H3cDot11RoamInHomeACIPType_Object((1,3,6,1,4,1,2011,10,2,75,10,2,1,1,4),_H3cDot11RoamInHomeACIPType_Type())
...
h3cDot11RoamInHomeACIPAddr=_H3cDot11RoamInHomeACIPAddr_Object((1,3,6,1,4,1,2011,10,2,75,10,2,1,1,5),_H3cDot11RoamInHomeACIPAddr_Type())
...
h3cDot11RoamOutInfoTable=_H3cDot11RoamOutInfoTable_Object((1,3,6,1,4,1,2011,10,2,75,10,2,2))
if mibBuilder.loadTexts:h3cDot11RoamOutInfoTable.setStatus(_A)
_H3cDot11RoamOutInfoEntry_Object=MibTableRow
h3cDot11RoamOutInfoEntry=_H3cDot11RoamOutInfoEntry_Object((1,3,6,1,4,1,2011,10,2,75,10,2,2,1))
...
h3cDot11RoamOutClientBSSID=_H3cDot11RoamOutClientBSSID_Object((1,3,6,1,4,1,2011,10,2,75,10,2,2,1,1),_H3cDot11RoamOutClientBSSID_Type())
...
h3cDot11RoamOutClientVlanID=_H3cDot11RoamOutClientVlanID_Object((1,3,6,1,4,1,2011,10,2,75,10,2,2,1,2),_H3cDot11RoamOutClientVlanID_Type())
...
h3cDot11RoamOutForeignACIPType=_H3cDot11RoamOutForeignACIPType_Object((1,3,6,1,4,1,2011,10,2,75,10,2,2,1,3),_H3cDot11RoamOutForeignACIPType_Type())
...
h3cDot11RoamOutForeignACIPAddr=_H3cDot11RoamOutForeignACIPAddr_Object((1,3,6,1,4,1,2011,10,2,75,10,2,2,1,4),_H3cDot11RoamOutForeignACIPAddr_Type())
...
h3cDot11RoamOutClientUpTime=_H3cDot11RoamOutClientUpTime_Object((1,3,6,1,4,1,2011,10,2,75,10,2,2,1,5),_H3cDot11RoamOutClientUpTime_Type())
...
h3cDot11RoamTrackTable=_H3cDot11RoamTrackTable_Object((1,3,6,1,4,1,2011,10,2,75,10,2,3))
if mibBuilder.loadTexts:h3cDot11RoamTrackTable.setStatus(_A)
_H3cDot11RoamTrackEntry_Object=MibTableRow
h3cDot11RoamTrackEntry=_H3cDot11RoamTrackEntry_Object((1,3,6,1,4,1,2011,10,2,75,10,2,3,1))
...
h3cDot11RoamTrackIndex=_H3cDot11RoamTrackIndex_Object((1,3,6,1,4,1,2011,10,2,75,10,2,3,1,1),_H3cDot11RoamTrackIndex_Type())
...
h3cDot11RoamTrackClientMAC=_H3cDot11RoamTrackClientMAC_Object((1,3,6,1,4,1,2011,10,2,75,10,2,3,1,2),_H3cDot11RoamTrackClientMAC_Type())
...
h3cDot11RoamTrackBSSID=_H3cDot11RoamTrackBSSID_Object((1,3,6,1,4,1,2011,10,2,75,10,2,3,1,3),_H3cDot11RoamTrackBSSID_Type())
...
h3cDot11RoamTrackUpTime=_H3cDot11RoamTrackUpTime_Object((1,3,6,1,4,1,2011,10,2,75,10,2,3,1,4),_H3cDot11RoamTrackUpTime_Type())
...
h3cDot11RoamTrackACIPType=_H3cDot11RoamTrackACIPType_Object((1,3,6,1,4,1,2011,10,2,75,10,2,3,1,5),_H3cDot11RoamTrackACIPType_Type())
...
h3cDot11RoamTrackACIPAddr=_H3cDot11RoamTrackACIPAddr_Object((1,3,6,1,4,1,2011,10,2,75,10,2,3,1,6),_H3cDot11RoamTrackACIPAddr_Type())
...
h3cDot11RoamStatisGroup=_H3cDot11RoamStatisGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,75,10,3))
_H3cDot11IntraACRoamingSuccCnt_Type=Integer32
_H3cDot11IntraACRoamingSuccCnt_Object=MibScalar
h3cDot11IntraACRoamingSuccCnt=_H3cDot11IntraACRoamingSuccCnt_Object((1,3,6,1,4,1,2011,10,2,75,10,3,1),_H3cDot11IntraACRoamingSuccCnt_Type())
...
h3cDot11InterACRoamingSuccCnt=_H3cDot11InterACRoamingSuccCnt_Object((1,3,6,1,4,1,2011,10,2,75,10,3,2),_H3cDot11InterACRoamingSuccCnt_Type())
...
h3cDot11InterACRoamOutSuccCnt=_H3cDot11InterACRoamOutSuccCnt_Object((1,3,6,1,4,1,2011,10,2,75,10,3,3),_H3cDot11InterACRoamOutSuccCnt_Type())
h3cDot11InterACRoamOutSuccCnt.setMaxAccess(_B)
if mibBuilder.loadTexts:h3cDot11InterACRoamOutSuccCnt.setStatus(_A)
_H3cDot11InterACRoamInSuccCnt_Type=Integer32
_H3cDot11InterACRoamInSuccCnt_Object=MibScalar
h3cDot11InterACRoamInSuccCnt=_H3cDot11InterACRoamInSuccCnt_Object((1,3,6,1,4,1,2011,10,2,75,10,3,4),_H3cDot11InterACRoamInSuccCnt_Type())
h3cDot11InterACRoamInSuccCnt.setMaxAccess(_B)
if mibBuilder.loadTexts:h3cDot11InterACRoamInSuccCnt.setStatus(_A)
_H3cDot11RoamStatis2Group_ObjectIdentity=ObjectIdentity
h3cDot11RoamStatis2Group=_H3cDot11RoamStatis2Group_ObjectIdentity((1,3,6,1,4,1,2011,10,2,75,10,4))
_H3cDot11IntraACRoamingSuccCnt2_Type=Counter32
_H3cDot11IntraACRoamingSuccCnt2_Object=MibScalar
h3cDot11IntraACRoamingSuccCnt2=_H3cDot11IntraACRoamingSuccCnt2_Object((1,3,6,1,4,1,2011,10,2,75,10,4,1),_H3cDot11IntraACRoamingSuccCnt2_Type())
...
h3cDot11InterACRoamingSuccCnt2=_H3cDot11InterACRoamingSuccCnt2_Object((1,3,6,1,4,1,2011,10,2,75,10,4,2),_H3cDot11InterACRoamingSuccCnt2_Type())
