...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-TUNNEL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:42:07 2025
...
_HpTunnelIfMTU_Type.__name__ = "Unsigned32"
...
hpTunnelMIBCompliance.setObjects(
      *(("HP-TUNNEL-MIB", "hpTunnelProvisionGroup"),
        ("HP-TUNNEL-MIB", "hpTunnelInetConfigGroup"),
        ("HP-TUNNEL-MIB", "hpVlanTunnelMappingGroup"))
)
if mibBuilder.loadTexts:
...
hpTunnelMIBCompliance2.setObjects(
      *(("HP-TUNNEL-MIB", "hpTunnelProvisionGroup2"),
        ("HP-TUNNEL-MIB", "hpTunnelInetConfigGroup"),
        ("HP-TUNNEL-MIB", "hpTunnelNotifyScalarsGroup"),
        ("HP-TUNNEL-MIB", "hpTunnelNotificationsGroup"),
        ("HP-TUNNEL-MIB", "hpVlanTunnelMappingGroup"))
)
if mibBuilder.loadTexts:
