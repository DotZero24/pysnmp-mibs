...
tunnelIfLocalInetAddress, tunnelIfAddressType, tunnelIfRemoteInetAddress, tunnelIfEntry, tunnelInetConfigEntry = mibBuilder.importSymbols("TUNNEL-MIB", "tunnelIfLocalInetAddress", "tunnelIfAddressType", "tunnelIfRemoteInetAddress", "tunnelIfEntry", "tunnelInetConfigEntry")
...
mibBuilder.exportSymbols("HP-TUNNEL-MIB", hpTunnelRowStatus=hpTunnelRowStatus, hpTunnelMTUDropInIfIndex=hpTunnelMTUDropInIfIndex, hpTunnelMIBCompliances=hpTunnelMIBCompliances, hpTunnelIcmpErrorRcvd=hpTunnelIcmpErrorRcvd, hpTunnelIpsecName=hpTunnelIpsecName, hpTunnelID=hpTunnelID, hpVlanTunnelMappingGroup=hpVlanTunnelMappingGroup, hpTunnelIfPMTU=hpTunnelIfPMTU, hpTunnelNotifyScalars=hpTunnelNotifyScalars, hpicfTunnelIfIndex=hpicfTunnelIfIndex, hpTunnelInetConfigEncapsMethod=hpTunnelInetConfigEncapsMethod, hpTunnelMTUDropTunnelDest=hpTunnelMTUDropTunnelDest, hpTunnelNotifications=hpTunnelNotifications, hpTunnelObjects=hpTunnelObjects, hpTunnelIfIndex=hpTunnelIfIndex, hpTunnelMTUDropRouterMTU=hpTunnelMTUDropRouterMTU, hpTunnelMTUDropTunnelDstAddrType=hpTunnelMTUDropTunnelDstAddrType, hpTunnelMTUDropNotifyEnable=hpTunnelMTUDropNotifyEnable, hpicfVLANIndex=hpicfVLANIndex, hpicfUDPTunnelTypeTable=hpicfUDPTunnelTypeTable, hpTunnelInetConfigGroup=hpTunnelInetConfigGroup, hpicfVlanTunnelMappingRowStatus=hpicfVlanTunnelMappingRowStatus, hpTunnelNotifyScalarsGroup=hpTunnelNotifyScalarsGroup, PYSNMP_MODULE_ID=hpTunnelMIB, hpTunnelMIBCompliance2=hpTunnelMIBCompliance2, hpicfVlanTunnelMappingTable=hpicfVlanTunnelMappingTable, hpTunnelMIBGroups=hpTunnelMIBGroups, hpTunnelEncapsMethod=hpTunnelEncapsMethod, hpicfUDPTunnelType=hpicfUDPTunnelType, hpTunnelProvisionGroup=hpTunnelProvisionGroup, hpTunnelIfEntry=hpTunnelIfEntry, hpTunnelConfigTable=hpTunnelConfigTable, hpTunnelIfMTU=hpTunnelIfMTU, hpicfUDPTunnelTypeEntry=hpicfUDPTunnelTypeEntry, HpTunnelType=HpTunnelType, hpTunnelConformance=hpTunnelConformance, hpTunnelIfTable=hpTunnelIfTable, hpTunnelInetConfigEntry=hpTunnelInetConfigEntry, hpTunnelIfNUD=hpTunnelIfNUD, hpTunnelProvisionGroup2=hpTunnelProvisionGroup2, hpTunnelMTUDropTunnelSource=hpTunnelMTUDropTunnelSource, hpTunnelMIB=hpTunnelMIB, hpTunnelInetConfigTable=hpTunnelInetConfigTable, hpTunnelNotificationsGroup=hpTunnelNotificationsGroup, hpTunnelMIBCompliance=hpTunnelMIBCompliance, hpicfVlanTunnelMappingEntry=hpicfVlanTunnelMappingEntry, hpTunnelInterfaceIndex=hpTunnelInterfaceIndex, hpTunnelMTUDropRouterAddrType=hpTunnelMTUDropRouterAddrType, hpTunnelMTUDropTunnelSrcAddrType=hpTunnelMTUDropTunnelSrcAddrType, hpTunnelConfigEntry=hpTunnelConfigEntry, hpTunnelMTUDropRouterAddr=hpTunnelMTUDropRouterAddr)
