...
mibBuilder.exportSymbols("LEXMARK-ROOT-MIB", lexmark=lexmark, PYSNMP_MODULE_ID=lexmarkMIB, lexmarkMIB=lexmarkMIB, lexmarkModules=lexmarkModules, lexmarkMibObjects=lexmarkMibObjects)
