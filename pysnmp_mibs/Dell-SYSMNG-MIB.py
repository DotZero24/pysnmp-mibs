# SNMP MIB module (Dell-SYSMNG-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-SYSMNG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:07:42 2025
...
rlSysmngTcamAllocationsEntry.setIndexNames(
    (0, "Dell-SYSMNG-MIB", "rlSysmngTcamAllocProfileName"),
    (0, "Dell-SYSMNG-MIB", "rlSysmngTcamAllocPoolType"),
)
if mibBuilder.loadTexts:
...
rlSysmngResourceEntry.setIndexNames(
    (0, "Dell-SYSMNG-MIB", "rlSysmngResourceRouteType"),
)
if mibBuilder.loadTexts:
...
rlSysmngResourceUsageEntry.setIndexNames(
    (0, "Dell-SYSMNG-MIB", "rlSysmngResourceUsageType"),
)
if mibBuilder.loadTexts:
...
rlSysmngResourcePerUnitEntry.setIndexNames(
    (0, "Dell-SYSMNG-MIB", "rlSysmngResourcePerUnitRouteType"),
    (0, "Dell-SYSMNG-MIB", "rlSysmngResourcePerUnitUnitId"),
)
if mibBuilder.loadTexts:
