...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:29 2025
...
rlSshServerSessionInetTableEntry.setIndexNames(
    (0, "RADLAN-SSH-MIB", "rlSshServerSessionInetIdentifier"),
)
if mibBuilder.loadTexts:
...
rlSshServerImportExportSelfKeyEntry.setIndexNames(
    (0, "RADLAN-SSH-MIB", "rlSshServerImportExportSelfKeyAlgorithm"),
    (0, "RADLAN-SSH-MIB", "rlSshServerImportExportSelfKeyFormat"),
    (0, "RADLAN-SSH-MIB", "rlSshServerImportExportSelfKeyFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSshClientPasswordChangeEntry.setIndexNames(
    (0, "RADLAN-SSH-MIB", "rlSshClientPasswordChangeInetAddrType"),
    (0, "RADLAN-SSH-MIB", "rlSshClientPasswordChangeInetAddr"),
)
if mibBuilder.loadTexts:
...
rlSshClientImportExportSelfKeyEntry.setIndexNames(
    (0, "RADLAN-SSH-MIB", "rlSshClientImportExportSelfKeyAlgorithm"),
    (0, "RADLAN-SSH-MIB", "rlSshClientImportExportSelfKeyFormat"),
    (0, "RADLAN-SSH-MIB", "rlSshClientImportExportSelfKeyFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSshClientRemoteServerPublicKeyFingerprintEntry.setIndexNames(
    (0, "RADLAN-SSH-MIB", "rlSshClientRemoteServerFingerprintInetAddrType"),
    (0, "RADLAN-SSH-MIB", "rlSshClientRemoteServerFingerprintInetAddr"),
    (0, "RADLAN-SSH-MIB", "rlSshClientRemoteServerFingerprint"),
)
if mibBuilder.loadTexts:
