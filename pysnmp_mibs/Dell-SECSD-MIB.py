# SNMP MIB module (Dell-SECSD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-SECSD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:38 2025
...
rlSecSdRulesEntry.setIndexNames(
    (0, "Dell-SECSD-MIB", "rlSecSdRuleUser"),
    (0, "Dell-SECSD-MIB", "rlSecSdRuleUserName"),
    (0, "Dell-SECSD-MIB", "rlSecSdRuleChannel"),
)
if mibBuilder.loadTexts:
...
rlSecSdMngSessionsEntry.setIndexNames(
    (0, "Dell-SECSD-MIB", "rlSecSdMngSessionId"),
)
if mibBuilder.loadTexts:
