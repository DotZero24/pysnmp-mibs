# SNMP MIB module (SUPERMICRO-FIPS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-FIPS-MIB
...
fsFipsOperMode = _FsFipsOperMode_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 63, 1, 1),
...
fsFipsTestAlgo = _FsFipsTestAlgo_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 63, 1, 2),
...
fsfipsZeroizeCryptoKeys = _FsfipsZeroizeCryptoKeys_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 63, 1, 3),
...
fsFipsTraceLevel = _FsFipsTraceLevel_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 63, 1, 4),
...
fsFipsTestExecutionResult = _FsFipsTestExecutionResult_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 63, 1, 5),
...
fsFipsFailedAlgorithm = _FsFipsFailedAlgorithm_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 63, 1, 6),
...
fsFipsBypassCapability = _FsFipsBypassCapability_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 63, 1, 7),
