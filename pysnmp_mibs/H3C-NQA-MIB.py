...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-NQA-MIB
...
_H3cNqaCtlTTL_Type.__name__ = "Integer32"
...
_H3cNqaCtlJitterAdminNumPackets_Type.__name__ = "Integer32"
...
_H3cNqaCtlICPIFAdvFactor_Type.__name__ = "Integer32"
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsMinOfPositivesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsMaxOfPositivesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsSumOfPositivesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsSum2PositivesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsMinOfNegativesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsMaxOfNegativesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsSumOfNegativesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsSum2NegativesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsMinOfPositivesDS.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsMaxOfPositivesDS.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsSumOfPositivesDS.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsSum2PositivesDS.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsMinOfNegativesDS.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsMaxOfNegativesDS.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsSumOfNegativesDS.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsSum2NegativesDS.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsAvePositivesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsAveNegativesSD.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsAvePositivesDS.setUnits("milliseconds")
...
if mibBuilder.loadTexts:
    h3cNqaJitterStatsAveNegativesDS.setUnits("milliseconds")
...
h3cNqaJitterStatsAveSD = _H3cNqaJitterStatsAveSD_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 4, 1, 31),
    _H3cNqaJitterStatsAveSD_Type()
)
h3cNqaJitterStatsAveSD.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNqaJitterStatsAveSD.setStatus("current")
if mibBuilder.loadTexts:
    h3cNqaJitterStatsAveSD.setUnits("milliseconds")
_H3cNqaJitterStatsAveDS_Type = Gauge32
_H3cNqaJitterStatsAveDS_Object = MibTableColumn
h3cNqaJitterStatsAveDS = _H3cNqaJitterStatsAveDS_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 4, 1, 32),
    _H3cNqaJitterStatsAveDS_Type()
)
h3cNqaJitterStatsAveDS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNqaJitterStatsAveDS.setStatus("current")
if mibBuilder.loadTexts:
    h3cNqaJitterStatsAveDS.setUnits("milliseconds")
...
_H3cNqaCtlStatisticsGroupNumber_Type.__name__ = "Unsigned32"
...
_H3cNqaCtlLifeTime_Type.__name__ = "Unsigned32"
...
_H3cNqaStatResIpTargetAddressType_Type.__name__ = "InetAddressType"
...
_H3cNqaStatResIpTargetAddress_Type.__name__ = "InetAddress"
...
h3cNqaStatJitterAveSD = _H3cNqaStatJitterAveSD_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 12, 1, 33),
    _H3cNqaStatJitterAveSD_Type()
)
h3cNqaStatJitterAveSD.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNqaStatJitterAveSD.setStatus("current")
if mibBuilder.loadTexts:
    h3cNqaStatJitterAveSD.setUnits("milliseconds")
_H3cNqaStatJitterAveDS_Type = Gauge32
_H3cNqaStatJitterAveDS_Object = MibTableColumn
h3cNqaStatJitterAveDS = _H3cNqaStatJitterAveDS_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 12, 1, 34),
    _H3cNqaStatJitterAveDS_Type()
)
h3cNqaStatJitterAveDS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cNqaStatJitterAveDS.setStatus("current")
if mibBuilder.loadTexts:
    h3cNqaStatJitterAveDS.setUnits("milliseconds")
...
_H3cNqaReactThresholdUpperLimit_Type.__name__ = "Unsigned32"
...
_H3cNqaReactThresholdLowerLimit_Type.__name__ = "Unsigned32"
...
_H3cNqaReactThresholdConsecNum_Type.__name__ = "Unsigned32"
...
_H3cNqaReactThresholdAccumNum_Type.__name__ = "Unsigned32"
...
_H3cNqaReactCheckedNum_Type.__name__ = "Unsigned32"
...
_H3cNqaReactThresholdNum_Type.__name__ = "Unsigned32"
...
_H3cNqaStatReactIndex_Type.__name__ = "Unsigned32"
...
_H3cNqaStatReactItemIndex_Type.__name__ = "Unsigned32"
...
_H3cNqaStatReactCheckedNum_Type.__name__ = "Counter32"
...
_H3cNqaStatReactThresholdNum_Type.__name__ = "Counter32"
...
h3cNqaTcpServerExtendTable = _H3cNqaTcpServerExtendTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 15)
)
if mibBuilder.loadTexts:
    h3cNqaTcpServerExtendTable.setStatus("current")
_H3cNqaTcpServerExtendEntry_Object = MibTableRow
h3cNqaTcpServerExtendEntry = _H3cNqaTcpServerExtendEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 15, 1)
)
h3cNqaTcpServerExtendEntry.setIndexNames(
    (0, "H3C-NQA-MIB", "h3cNqaTcpServerExtIpAddress"),
    (0, "H3C-NQA-MIB", "h3cNqaTcpServerExtPort"),
    (0, "H3C-NQA-MIB", "h3cNqaTcpServerExtVPNType"),
    (0, "H3C-NQA-MIB", "h3cNqaTcpServerExtVPNInstance"),
)
if mibBuilder.loadTexts:
    h3cNqaTcpServerExtendEntry.setStatus("current")
_H3cNqaTcpServerExtIpAddress_Type = InetAddress
_H3cNqaTcpServerExtIpAddress_Object = MibTableColumn
h3cNqaTcpServerExtIpAddress = _H3cNqaTcpServerExtIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 15, 1, 1),
    _H3cNqaTcpServerExtIpAddress_Type()
)
h3cNqaTcpServerExtIpAddress.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNqaTcpServerExtIpAddress.setStatus("current")


class _H3cNqaTcpServerExtPort_Type(Integer32):
    """Custom type h3cNqaTcpServerExtPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65536),
    )
...
_H3cNqaTcpServerExtPort_Type.__name__ = "Integer32"
_H3cNqaTcpServerExtPort_Object = MibTableColumn
h3cNqaTcpServerExtPort = _H3cNqaTcpServerExtPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 15, 1, 2),
    _H3cNqaTcpServerExtPort_Type()
)
h3cNqaTcpServerExtPort.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNqaTcpServerExtPort.setStatus("current")
_H3cNqaTcpServerExtVPNType_Type = VpnInstanceType
_H3cNqaTcpServerExtVPNType_Object = MibTableColumn
h3cNqaTcpServerExtVPNType = _H3cNqaTcpServerExtVPNType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 15, 1, 3),
    _H3cNqaTcpServerExtVPNType_Type()
)
h3cNqaTcpServerExtVPNType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNqaTcpServerExtVPNType.setStatus("current")


class _H3cNqaTcpServerExtVPNInstance_Type(OctetString):
    """Custom type h3cNqaTcpServerExtVPNInstance based on OctetString"""
...
_H3cNqaTcpServerExtVPNInstance_Type.__name__ = "OctetString"
_H3cNqaTcpServerExtVPNInstance_Object = MibTableColumn
h3cNqaTcpServerExtVPNInstance = _H3cNqaTcpServerExtVPNInstance_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 15, 1, 4),
    _H3cNqaTcpServerExtVPNInstance_Type()
)
h3cNqaTcpServerExtVPNInstance.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNqaTcpServerExtVPNInstance.setStatus("current")


class _H3cNqaTcpServerExtDSField_Type(Unsigned32):
    """Custom type h3cNqaTcpServerExtDSField based on Unsigned32"""
    defaultValue = 0
...
_H3cNqaTcpServerExtDSField_Type.__name__ = "Unsigned32"
_H3cNqaTcpServerExtDSField_Object = MibTableColumn
h3cNqaTcpServerExtDSField = _H3cNqaTcpServerExtDSField_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 15, 1, 5),
    _H3cNqaTcpServerExtDSField_Type()
)
h3cNqaTcpServerExtDSField.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cNqaTcpServerExtDSField.setStatus("current")
_H3cNqaTcpServerExtRowStatus_Type = RowStatus
_H3cNqaTcpServerExtRowStatus_Object = MibTableColumn
h3cNqaTcpServerExtRowStatus = _H3cNqaTcpServerExtRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 15, 1, 6),
    _H3cNqaTcpServerExtRowStatus_Type()
)
h3cNqaTcpServerExtRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cNqaTcpServerExtRowStatus.setStatus("current")
_H3cNqaUdpServerExtendTable_Object = MibTable
h3cNqaUdpServerExtendTable = _H3cNqaUdpServerExtendTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 16)
)
if mibBuilder.loadTexts:
    h3cNqaUdpServerExtendTable.setStatus("current")
_H3cNqaUdpServerExtendEntry_Object = MibTableRow
h3cNqaUdpServerExtendEntry = _H3cNqaUdpServerExtendEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 16, 1)
)
h3cNqaUdpServerExtendEntry.setIndexNames(
    (0, "H3C-NQA-MIB", "h3cNqaUdpServerExtIpAddress"),
    (0, "H3C-NQA-MIB", "h3cNqaUdpServerExtPort"),
    (0, "H3C-NQA-MIB", "h3cNqaUdpServerExtVPNType"),
    (0, "H3C-NQA-MIB", "h3cNqaUdpServerExtVPNInstance"),
)
if mibBuilder.loadTexts:
    h3cNqaUdpServerExtendEntry.setStatus("current")
_H3cNqaUdpServerExtIpAddress_Type = InetAddress
_H3cNqaUdpServerExtIpAddress_Object = MibTableColumn
h3cNqaUdpServerExtIpAddress = _H3cNqaUdpServerExtIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 16, 1, 1),
    _H3cNqaUdpServerExtIpAddress_Type()
)
h3cNqaUdpServerExtIpAddress.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNqaUdpServerExtIpAddress.setStatus("current")


class _H3cNqaUdpServerExtPort_Type(Integer32):
    """Custom type h3cNqaUdpServerExtPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65536),
    )
...
_H3cNqaUdpServerExtPort_Type.__name__ = "Integer32"
_H3cNqaUdpServerExtPort_Object = MibTableColumn
h3cNqaUdpServerExtPort = _H3cNqaUdpServerExtPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 16, 1, 2),
    _H3cNqaUdpServerExtPort_Type()
)
h3cNqaUdpServerExtPort.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNqaUdpServerExtPort.setStatus("current")
_H3cNqaUdpServerExtVPNType_Type = VpnInstanceType
_H3cNqaUdpServerExtVPNType_Object = MibTableColumn
h3cNqaUdpServerExtVPNType = _H3cNqaUdpServerExtVPNType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 16, 1, 3),
    _H3cNqaUdpServerExtVPNType_Type()
)
h3cNqaUdpServerExtVPNType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNqaUdpServerExtVPNType.setStatus("current")


class _H3cNqaUdpServerExtVPNInstance_Type(OctetString):
    """Custom type h3cNqaUdpServerExtVPNInstance based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 31),
    )
...
_H3cNqaUdpServerExtVPNInstance_Type.__name__ = "OctetString"
_H3cNqaUdpServerExtVPNInstance_Object = MibTableColumn
h3cNqaUdpServerExtVPNInstance = _H3cNqaUdpServerExtVPNInstance_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 16, 1, 4),
    _H3cNqaUdpServerExtVPNInstance_Type()
)
h3cNqaUdpServerExtVPNInstance.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cNqaUdpServerExtVPNInstance.setStatus("current")


class _H3cNqaUdpServerExtDSField_Type(Unsigned32):
    """Custom type h3cNqaUdpServerExtDSField based on Unsigned32"""
    defaultValue = 0
...
_H3cNqaUdpServerExtDSField_Type.__name__ = "Unsigned32"
_H3cNqaUdpServerExtDSField_Object = MibTableColumn
h3cNqaUdpServerExtDSField = _H3cNqaUdpServerExtDSField_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 16, 1, 5),
    _H3cNqaUdpServerExtDSField_Type()
)
h3cNqaUdpServerExtDSField.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cNqaUdpServerExtDSField.setStatus("current")
_H3cNqaUdpServerExtRowStatus_Type = RowStatus
_H3cNqaUdpServerExtRowStatus_Object = MibTableColumn
h3cNqaUdpServerExtRowStatus = _H3cNqaUdpServerExtRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 8, 3, 1, 16, 1, 6),
    _H3cNqaUdpServerExtRowStatus_Type()
)
h3cNqaUdpServerExtRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cNqaUdpServerExtRowStatus.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"VpnInstanceType": VpnInstanceType,
       ...
       "h3cNqaJitterStatsAveSD": h3cNqaJitterStatsAveSD,
       "h3cNqaJitterStatsAveDS": h3cNqaJitterStatsAveDS,
       ...
       "h3cNqaStatJitterAveSD": h3cNqaStatJitterAveSD,
       "h3cNqaStatJitterAveDS": h3cNqaStatJitterAveDS,
       ...
       "h3cNqaTcpServerExtendTable": h3cNqaTcpServerExtendTable,
       "h3cNqaTcpServerExtendEntry": h3cNqaTcpServerExtendEntry,
       "h3cNqaTcpServerExtIpAddress": h3cNqaTcpServerExtIpAddress,
       "h3cNqaTcpServerExtPort": h3cNqaTcpServerExtPort,
       "h3cNqaTcpServerExtVPNType": h3cNqaTcpServerExtVPNType,
       "h3cNqaTcpServerExtVPNInstance": h3cNqaTcpServerExtVPNInstance,
       "h3cNqaTcpServerExtDSField": h3cNqaTcpServerExtDSField,
       "h3cNqaTcpServerExtRowStatus": h3cNqaTcpServerExtRowStatus,
       "h3cNqaUdpServerExtendTable": h3cNqaUdpServerExtendTable,
       "h3cNqaUdpServerExtendEntry": h3cNqaUdpServerExtendEntry,
       "h3cNqaUdpServerExtIpAddress": h3cNqaUdpServerExtIpAddress,
       "h3cNqaUdpServerExtPort": h3cNqaUdpServerExtPort,
       "h3cNqaUdpServerExtVPNType": h3cNqaUdpServerExtVPNType,
       "h3cNqaUdpServerExtVPNInstance": h3cNqaUdpServerExtVPNInstance,
       "h3cNqaUdpServerExtDSField": h3cNqaUdpServerExtDSField,
       "h3cNqaUdpServerExtRowStatus": h3cNqaUdpServerExtRowStatus,
