#
# PySNMP MIB module ALCATEL-ENT1-POLICY-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-POLICY-MIB
...
directoryServerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 1, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-POLICY-MIB", "directoryServerAddress"), (0, "ALCATEL-ENT1-POLICY-MIB", "directoryServerPort"))
...
policyEventEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 1, 5, 1), ).setIndexNames((0, "ALCATEL-ENT1-POLICY-MIB", "policyEventIndex"))
...
policyRuleNamesEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 1, 6, 1), ).setIndexNames((0, "ALCATEL-ENT1-POLICY-MIB", "policyRuleNamesIndex"))
...
policyStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 1, 7, 1), ).setIndexNames((0, "ALCATEL-ENT1-POLICY-MIB", "policyStatsAddress"), (0, "ALCATEL-ENT1-POLICY-MIB", "policyStatsServerPort"))
...
policyNotificationEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 1, 8, 1), ).setIndexNames((0, "ALCATEL-ENT1-POLICY-MIB", "policyNotificationIndex"))
...
policyEventNotification = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 0, 1)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "policyTrapEventDetailString"), ("ALCATEL-ENT1-POLICY-MIB", "policyTrapEventCode"))
...
alcatelIND1PolicyMIBCompliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 2, 2, 1)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "policyMIBGlobalGroup"), ("ALCATEL-ENT1-POLICY-MIB", "policyMIBDirectoryServerGroup"), ("ALCATEL-ENT1-POLICY-MIB", "policyMIBEventTableGroup"), ("ALCATEL-ENT1-POLICY-MIB", "policyMIBRuleNamesGroup"), ("ALCATEL-ENT1-POLICY-MIB", "policyMIBStatsGroup"), ("ALCATEL-ENT1-POLICY-MIB", "policyMIBNotificationGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alcatelIND1PolicyMIBCompliance = alcatelIND1PolicyMIBCompliance.setStatus('current')
policyMIBGlobalGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 2, 1, 1)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "serverPolicyDecision"), ("ALCATEL-ENT1-POLICY-MIB", "policyManagerEventTableSize"), ("ALCATEL-ENT1-POLICY-MIB", "policyManagerSwitchIdentifier"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    policyMIBGlobalGroup = policyMIBGlobalGroup.setStatus('current')
policyMIBDirectoryServerGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 2, 1, 2)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "directoryServerAddress"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerPort"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerPreference"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerAuthenticationType"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerUserId"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerPassword"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerSearchbase"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerCacheChange"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerLastChange"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerAdminStatus"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerOperStatus"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerRowStatus"), ("ALCATEL-ENT1-POLICY-MIB", "directoryServerEnableSSL"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    policyMIBDirectoryServerGroup = policyMIBDirectoryServerGroup.setStatus('current')
policyMIBEventTableGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 2, 1, 3)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "policyEventIndex"), ("ALCATEL-ENT1-POLICY-MIB", "policyEventCode"), ("ALCATEL-ENT1-POLICY-MIB", "policyEventDetailString"), ("ALCATEL-ENT1-POLICY-MIB", "policyEventTime"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    policyMIBEventTableGroup = policyMIBEventTableGroup.setStatus('current')
policyMIBRuleNamesGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 2, 1, 4)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "policyRuleNamesIndex"), ("ALCATEL-ENT1-POLICY-MIB", "policyRuleNamesName"), ("ALCATEL-ENT1-POLICY-MIB", "policyRuleNamesRowStatus"), ("ALCATEL-ENT1-POLICY-MIB", "policyRuleOperStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    policyMIBRuleNamesGroup = policyMIBRuleNamesGroup.setStatus('current')
policyMIBStatsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 2, 1, 5)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "policyStatsAddress"), ("ALCATEL-ENT1-POLICY-MIB", "policyStatsServerPort"), ("ALCATEL-ENT1-POLICY-MIB", "policyStatsAccessCount"), ("ALCATEL-ENT1-POLICY-MIB", "policyStatsSuccessAccessCount"), ("ALCATEL-ENT1-POLICY-MIB", "policyStatsNotFoundCount"), ("ALCATEL-ENT1-POLICY-MIB", "policyStatsQueryCount"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    policyMIBStatsGroup = policyMIBStatsGroup.setStatus('current')
policyMIBNotificationGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 2, 1, 6)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "policyNotificationIndex"), ("ALCATEL-ENT1-POLICY-MIB", "policyNotificationCode"), ("ALCATEL-ENT1-POLICY-MIB", "policyEventCount"), ("ALCATEL-ENT1-POLICY-MIB", "policyTrapEventDetailString"), ("ALCATEL-ENT1-POLICY-MIB", "policyTrapEventCode"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    policyMIBNotificationGroup = policyMIBNotificationGroup.setStatus('current')
policyMIBTrapEventGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 2, 1, 7)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "policyTrapEventDetailString"), ("ALCATEL-ENT1-POLICY-MIB", "policyTrapEventCode"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    policyMIBTrapEventGroup = policyMIBTrapEventGroup.setStatus('current')
policyMIBTrapsGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 14, 1, 2, 1, 8)).setObjects(("ALCATEL-ENT1-POLICY-MIB", "policyEventNotification"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    policyMIBTrapsGroup = policyMIBTrapsGroup.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-POLICY-MIB", directoryServerPort=directoryServerPort, policyNotificationIndex=policyNotificationIndex, policyTrapEventCode=policyTrapEventCode, policyRuleOperStatus=policyRuleOperStatus, policyEventNotification=policyEventNotification, alcatelIND1PolicyMIB=alcatelIND1PolicyMIB, policyRuleNamesRowStatus=policyRuleNamesRowStatus, policyMIBNotificationGroup=policyMIBNotificationGroup, directoryServerLastChange=directoryServerLastChange, policyMIBRuleNamesGroup=policyMIBRuleNamesGroup, directoryServerTable=directoryServerTable, policyMIBTrapsGroup=policyMIBTrapsGroup, policyEventTable=policyEventTable, policyEventDetailString=policyEventDetailString, directoryServerAuthenticationType=directoryServerAuthenticationType, PYSNMP_MODULE_ID=alcatelIND1PolicyMIB, directoryServerOperStatus=directoryServerOperStatus, policyManagerEventTableSize=policyManagerEventTableSize, alcatelIND1PolicyMIBCompliances=alcatelIND1PolicyMIBCompliances, directoryServerRowStatus=directoryServerRowStatus, policyStatsAddress=policyStatsAddress, policyStatsSuccessAccessCount=policyStatsSuccessAccessCount, policyRuleNamesEntry=policyRuleNamesEntry, alcatelIND1PolicyMIBCompliance=alcatelIND1PolicyMIBCompliance, policyMIBDirectoryServerGroup=policyMIBDirectoryServerGroup, serverPolicyDecision=serverPolicyDecision, directoryServerAddress=directoryServerAddress, policyEventTime=policyEventTime, policyRuleNamesName=policyRuleNamesName, alcatelIND1PolicyMIBNotifications=alcatelIND1PolicyMIBNotifications, directoryServerEnableSSL=directoryServerEnableSSL, policyEventEntry=policyEventEntry, policyStatsServerPort=policyStatsServerPort, alcatelIND1PolicyMIBObjects=alcatelIND1PolicyMIBObjects, policyEventCount=policyEventCount, directoryServerCacheChange=directoryServerCacheChange, directoryServerEntry=directoryServerEntry, directoryServerAdminStatus=directoryServerAdminStatus, directoryServerPassword=directoryServerPassword, policyStatsTable=policyStatsTable, policyEventIndex=policyEventIndex, policyMIBEventTableGroup=policyMIBEventTableGroup, policyNotificationEntry=policyNotificationEntry, policyRuleNamesTable=policyRuleNamesTable, policyMIBGlobalGroup=policyMIBGlobalGroup, directoryServerSearchbase=directoryServerSearchbase, alcatelIND1PolicyMIBGroups=alcatelIND1PolicyMIBGroups, policyMIBStatsGroup=policyMIBStatsGroup, policyTrapEventDetailString=policyTrapEventDetailString, policyStatsNotFoundCount=policyStatsNotFoundCount, policyNotificationTable=policyNotificationTable, policyStatsEntry=policyStatsEntry, policyStatsAccessCount=policyStatsAccessCount, policyManagerSwitchIdentifier=policyManagerSwitchIdentifier, policyMIBTrapEventGroup=policyMIBTrapEventGroup, policyRuleNamesIndex=policyRuleNamesIndex, policyStatsQueryCount=policyStatsQueryCount, policyEventCode=policyEventCode, PolicyEventCodes=PolicyEventCodes, directoryServerPreference=directoryServerPreference, rsvpDefaultPolicy=rsvpDefaultPolicy, directoryServerUserId=directoryServerUserId, alcatelIND1PolicyMIBConformance=alcatelIND1PolicyMIBConformance, policyNotificationCode=policyNotificationCode, policyManagerTrapObjs=policyManagerTrapObjs)
