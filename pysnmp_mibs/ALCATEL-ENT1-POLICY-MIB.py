# SNMP MIB module (ALCATEL-ENT1-POLICY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-POLICY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:10:12 2025
...
directoryServerEntry.setIndexNames(
    (0, "ALCATEL-ENT1-POLICY-MIB", "directoryServerAddress"),
    (0, "ALCATEL-ENT1-POLICY-MIB", "directoryServerPort"),
)
if mibBuilder.loadTexts:
...
policyEventEntry.setIndexNames(
    (0, "ALCATEL-ENT1-POLICY-MIB", "policyEventIndex"),
)
if mibBuilder.loadTexts:
...
policyRuleNamesEntry.setIndexNames(
    (0, "ALCATEL-ENT1-POLICY-MIB", "policyRuleNamesIndex"),
)
if mibBuilder.loadTexts:
...
policyStatsEntry.setIndexNames(
    (0, "ALCATEL-ENT1-POLICY-MIB", "policyStatsAddress"),
    (0, "ALCATEL-ENT1-POLICY-MIB", "policyStatsServerPort"),
)
if mibBuilder.loadTexts:
...
policyNotificationEntry.setIndexNames(
    (0, "ALCATEL-ENT1-POLICY-MIB", "policyNotificationIndex"),
)
if mibBuilder.loadTexts:
...
policyMIBGlobalGroup.setObjects(
      *(("ALCATEL-ENT1-POLICY-MIB", "serverPolicyDecision"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyManagerEventTableSize"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyManagerSwitchIdentifier"))
)
if mibBuilder.loadTexts:
...
policyMIBDirectoryServerGroup.setObjects(
      *(("ALCATEL-ENT1-POLICY-MIB", "directoryServerAddress"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerPort"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerPreference"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerAuthenticationType"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerUserId"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerPassword"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerSearchbase"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerCacheChange"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerLastChange"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerAdminStatus"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerOperStatus"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerRowStatus"),
        ("ALCATEL-ENT1-POLICY-MIB", "directoryServerEnableSSL"))
)
if mibBuilder.loadTexts:
...
policyMIBEventTableGroup.setObjects(
      *(("ALCATEL-ENT1-POLICY-MIB", "policyEventIndex"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyEventCode"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyEventDetailString"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyEventTime"))
)
if mibBuilder.loadTexts:
...
policyMIBRuleNamesGroup.setObjects(
      *(("ALCATEL-ENT1-POLICY-MIB", "policyRuleNamesIndex"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyRuleNamesName"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyRuleNamesRowStatus"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyRuleOperStatus"))
)
if mibBuilder.loadTexts:
...
policyMIBStatsGroup.setObjects(
      *(("ALCATEL-ENT1-POLICY-MIB", "policyStatsAddress"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyStatsServerPort"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyStatsAccessCount"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyStatsSuccessAccessCount"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyStatsNotFoundCount"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyStatsQueryCount"))
)
if mibBuilder.loadTexts:
...
policyMIBNotificationGroup.setObjects(
      *(("ALCATEL-ENT1-POLICY-MIB", "policyNotificationIndex"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyNotificationCode"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyEventCount"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyTrapEventDetailString"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyTrapEventCode"))
)
if mibBuilder.loadTexts:
...
policyMIBTrapsGroup.setObjects(
    ("ALCATEL-ENT1-POLICY-MIB", "policyEventNotification")
)
if mibBuilder.loadTexts:
...
alcatelIND1PolicyMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-POLICY-MIB", "policyMIBGlobalGroup"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyMIBDirectoryServerGroup"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyMIBEventTableGroup"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyMIBRuleNamesGroup"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyMIBStatsGroup"),
        ("ALCATEL-ENT1-POLICY-MIB", "policyMIBNotificationGroup"))
)
if mibBuilder.loadTexts:
