_y='policyMIBNotificationGroup'
_x='policyMIBStatsGroup'
_w='policyMIBRuleNamesGroup'
_v='policyMIBEventTableGroup'
_u='policyMIBDirectoryServerGroup'
_t='policyMIBGlobalGroup'
_s='policyEventNotification'
_r='policyEventCount'
...
_U='policyManagerSwitchIdentifier'
_T='policyManagerEventTableSize'
_S='serverPolicyDecision'
_R='policyNotificationIndex'
_Q='policyStatsServerPort'
_P='policyStatsAddress'
_O='policyRuleNamesIndex'
_N='policyEventIndex'
_M='down'
_L='directoryServerPort'
_K='directoryServerAddress'
_J='RowStatus'
_I='policyTrapEventCode'
_H='policyTrapEventDetailString'
_G='read-write'
_F='SnmpAdminString'
_E='read-create'
_D='Integer32'
_C='read-only'
_B='ALCATEL-ENT1-POLICY-MIB'
_A='current'
if'mibBuilder'not in globals():import sys;sys.stderr.write(__doc__);sys.exit(1)
Integer,OctetString,ObjectIdentifier=mibBuilder.importSymbols('ASN1','Integer','OctetString','ObjectIdentifier')
NamedValues,=mibBuilder.importSymbols('ASN1-ENUMERATION','NamedValues')
ConstraintsIntersection,ConstraintsUnion,SingleValueConstraint,ValueRangeConstraint,ValueSizeConstraint=mibBuilder.importSymbols('ASN1-REFINEMENT','ConstraintsIntersection','ConstraintsUnion','SingleValueConstraint','ValueRangeConstraint','ValueSizeConstraint')
softentIND1Policy,=mibBuilder.importSymbols('ALCATEL-ENT1-BASE','softentIND1Policy')
...
if mibBuilder.loadTexts:alcatelIND1PolicyMIB.setRevisions(('2010-05-13 00:00',))
...
alcatelIND1PolicyMIBNotifications=_AlcatelIND1PolicyMIBNotifications_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,14,1,0))
if mibBuilder.loadTexts:alcatelIND1PolicyMIBNotifications.setStatus(_A)
_AlcatelIND1PolicyMIBObjects_ObjectIdentity=ObjectIdentity
alcatelIND1PolicyMIBObjects=_AlcatelIND1PolicyMIBObjects_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,14,1,1))
...
serverPolicyDecision=_ServerPolicyDecision_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,1),_ServerPolicyDecision_Type())
...
rsvpDefaultPolicy=_RsvpDefaultPolicy_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,2),_RsvpDefaultPolicy_Type())
...
policyManagerEventTableSize=_PolicyManagerEventTableSize_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,3),_PolicyManagerEventTableSize_Type())
...
directoryServerTable=_DirectoryServerTable_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4))
if mibBuilder.loadTexts:directoryServerTable.setStatus(_A)
_DirectoryServerEntry_Object=MibTableRow
directoryServerEntry=_DirectoryServerEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1))
directoryServerEntry.setIndexNames((0,_B,_K),(0,_B,_L))
...
directoryServerAddress=_DirectoryServerAddress_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,1),_DirectoryServerAddress_Type())
...
directoryServerPort=_DirectoryServerPort_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,2),_DirectoryServerPort_Type())
...
directoryServerPreference=_DirectoryServerPreference_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,3),_DirectoryServerPreference_Type())
...
directoryServerAuthenticationType=_DirectoryServerAuthenticationType_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,4),_DirectoryServerAuthenticationType_Type())
directoryServerAuthenticationType.setMaxAccess(_E)
if mibBuilder.loadTexts:directoryServerAuthenticationType.setStatus(_A)
class _DirectoryServerUserId_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,31))
_DirectoryServerUserId_Type.__name__=_F
_DirectoryServerUserId_Object=MibTableColumn
directoryServerUserId=_DirectoryServerUserId_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,5),_DirectoryServerUserId_Type())
directoryServerUserId.setMaxAccess(_E)
if mibBuilder.loadTexts:directoryServerUserId.setStatus(_A)
class _DirectoryServerPassword_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,31))
_DirectoryServerPassword_Type.__name__=_F
_DirectoryServerPassword_Object=MibTableColumn
directoryServerPassword=_DirectoryServerPassword_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,6),_DirectoryServerPassword_Type())
directoryServerPassword.setMaxAccess(_E)
if mibBuilder.loadTexts:directoryServerPassword.setStatus(_A)
class _DirectoryServerSearchbase_Type(SnmpAdminString):defaultValue=OctetString('o=Alcatel IND, c=US');subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,31))
_DirectoryServerSearchbase_Type.__name__=_F
_DirectoryServerSearchbase_Object=MibTableColumn
directoryServerSearchbase=_DirectoryServerSearchbase_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,7),_DirectoryServerSearchbase_Type())
...
directoryServerCacheChange=_DirectoryServerCacheChange_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,8),_DirectoryServerCacheChange_Type())
...
directoryServerLastChange=_DirectoryServerLastChange_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,9),_DirectoryServerLastChange_Type())
directoryServerLastChange.setMaxAccess(_C)
if mibBuilder.loadTexts:directoryServerLastChange.setStatus(_A)
class _DirectoryServerAdminStatus_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('up',1),(_M,2)))
_DirectoryServerAdminStatus_Type.__name__=_D
_DirectoryServerAdminStatus_Object=MibTableColumn
directoryServerAdminStatus=_DirectoryServerAdminStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,10),_DirectoryServerAdminStatus_Type())
directoryServerAdminStatus.setMaxAccess(_E)
if mibBuilder.loadTexts:directoryServerAdminStatus.setStatus(_A)
class _DirectoryServerOperStatus_Type(Integer32):defaultValue=3;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('up',1),(_M,2),('unknown',3)))
_DirectoryServerOperStatus_Type.__name__=_D
_DirectoryServerOperStatus_Object=MibTableColumn
directoryServerOperStatus=_DirectoryServerOperStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,11),_DirectoryServerOperStatus_Type())
...
_DirectoryServerRowStatus_Type.__name__=_J
_DirectoryServerRowStatus_Object=MibTableColumn
directoryServerRowStatus=_DirectoryServerRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,12),_DirectoryServerRowStatus_Type())
...
directoryServerEnableSSL=_DirectoryServerEnableSSL_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,4,1,13),_DirectoryServerEnableSSL_Type())
...
policyEventTable=_PolicyEventTable_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,5))
if mibBuilder.loadTexts:policyEventTable.setStatus(_A)
_PolicyEventEntry_Object=MibTableRow
policyEventEntry=_PolicyEventEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,5,1))
policyEventEntry.setIndexNames((0,_B,_N))
...
policyEventIndex=_PolicyEventIndex_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,5,1,1),_PolicyEventIndex_Type())
...
policyEventCode=_PolicyEventCode_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,5,1,2),_PolicyEventCode_Type())
policyEventCode.setMaxAccess(_C)
if mibBuilder.loadTexts:policyEventCode.setStatus(_A)
class _PolicyEventDetailString_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,255))
_PolicyEventDetailString_Type.__name__=_F
_PolicyEventDetailString_Object=MibTableColumn
policyEventDetailString=_PolicyEventDetailString_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,5,1,3),_PolicyEventDetailString_Type())
...
policyEventTime=_PolicyEventTime_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,5,1,4),_PolicyEventTime_Type())
policyEventTime.setMaxAccess(_C)
if mibBuilder.loadTexts:policyEventTime.setStatus(_A)
_PolicyRuleNamesTable_Object=MibTable
policyRuleNamesTable=_PolicyRuleNamesTable_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,6))
if mibBuilder.loadTexts:policyRuleNamesTable.setStatus(_A)
_PolicyRuleNamesEntry_Object=MibTableRow
policyRuleNamesEntry=_PolicyRuleNamesEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,6,1))
policyRuleNamesEntry.setIndexNames((0,_B,_O))
...
policyRuleNamesIndex=_PolicyRuleNamesIndex_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,6,1,1),_PolicyRuleNamesIndex_Type())
policyRuleNamesIndex.setMaxAccess(_C)
if mibBuilder.loadTexts:policyRuleNamesIndex.setStatus(_A)
class _PolicyRuleNamesName_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,31))
_PolicyRuleNamesName_Type.__name__=_F
_PolicyRuleNamesName_Object=MibTableColumn
policyRuleNamesName=_PolicyRuleNamesName_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,6,1,2),_PolicyRuleNamesName_Type())
...
_PolicyRuleNamesRowStatus_Type.__name__=_J
_PolicyRuleNamesRowStatus_Object=MibTableColumn
policyRuleNamesRowStatus=_PolicyRuleNamesRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,6,1,3),_PolicyRuleNamesRowStatus_Type())
policyRuleNamesRowStatus.setMaxAccess(_C)
if mibBuilder.loadTexts:policyRuleNamesRowStatus.setStatus(_A)
class _PolicyRuleOperStatus_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('up',1),(_M,2),('notReady',3)))
_PolicyRuleOperStatus_Type.__name__=_D
_PolicyRuleOperStatus_Object=MibTableColumn
policyRuleOperStatus=_PolicyRuleOperStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,6,1,4),_PolicyRuleOperStatus_Type())
...
policyStatsTable=_PolicyStatsTable_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,7))
if mibBuilder.loadTexts:policyStatsTable.setStatus(_A)
_PolicyStatsEntry_Object=MibTableRow
policyStatsEntry=_PolicyStatsEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,7,1))
policyStatsEntry.setIndexNames((0,_B,_P),(0,_B,_Q))
...
policyStatsAddress=_PolicyStatsAddress_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,7,1,1),_PolicyStatsAddress_Type())
...
policyStatsServerPort=_PolicyStatsServerPort_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,7,1,2),_PolicyStatsServerPort_Type())
...
policyStatsQueryCount=_PolicyStatsQueryCount_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,7,1,3),_PolicyStatsQueryCount_Type())
...
policyStatsAccessCount=_PolicyStatsAccessCount_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,7,1,4),_PolicyStatsAccessCount_Type())
...
policyStatsSuccessAccessCount=_PolicyStatsSuccessAccessCount_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,7,1,5),_PolicyStatsSuccessAccessCount_Type())
...
policyStatsNotFoundCount=_PolicyStatsNotFoundCount_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,7,1,6),_PolicyStatsNotFoundCount_Type())
...
policyNotificationTable=_PolicyNotificationTable_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,8))
if mibBuilder.loadTexts:policyNotificationTable.setStatus(_A)
_PolicyNotificationEntry_Object=MibTableRow
policyNotificationEntry=_PolicyNotificationEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,8,1))
policyNotificationEntry.setIndexNames((0,_B,_R))
...
policyNotificationIndex=_PolicyNotificationIndex_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,8,1,1),_PolicyNotificationIndex_Type())
...
policyNotificationCode=_PolicyNotificationCode_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,8,1,2),_PolicyNotificationCode_Type())
...
policyEventCount=_PolicyEventCount_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,8,1,3),_PolicyEventCount_Type())
policyEventCount.setMaxAccess(_C)
if mibBuilder.loadTexts:policyEventCount.setStatus(_A)
class _PolicyManagerSwitchIdentifier_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,40))
_PolicyManagerSwitchIdentifier_Type.__name__=_F
_PolicyManagerSwitchIdentifier_Object=MibScalar
policyManagerSwitchIdentifier=_PolicyManagerSwitchIdentifier_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,9),_PolicyManagerSwitchIdentifier_Type())
...
policyManagerTrapObjs=_PolicyManagerTrapObjs_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,10))
class _PolicyTrapEventDetailString_Type(SnmpAdminString):subtypeSpec=SnmpAdminString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,255))
_PolicyTrapEventDetailString_Type.__name__=_F
_PolicyTrapEventDetailString_Object=MibScalar
policyTrapEventDetailString=_PolicyTrapEventDetailString_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,10,1),_PolicyTrapEventDetailString_Type())
...
policyTrapEventCode=_PolicyTrapEventCode_Object((1,3,6,1,4,1,6486,801,1,2,1,14,1,1,10,2),_PolicyTrapEventCode_Type())
...
alcatelIND1PolicyMIBConformance=_AlcatelIND1PolicyMIBConformance_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,14,1,2))
...
alcatelIND1PolicyMIBGroups=_AlcatelIND1PolicyMIBGroups_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,1))
...
alcatelIND1PolicyMIBCompliances=_AlcatelIND1PolicyMIBCompliances_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,2))
if mibBuilder.loadTexts:alcatelIND1PolicyMIBCompliances.setStatus(_A)
policyMIBGlobalGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,1,1))
policyMIBGlobalGroup.setObjects(*((_B,_S),(_B,_T),(_B,_U)))
if mibBuilder.loadTexts:policyMIBGlobalGroup.setStatus(_A)
policyMIBDirectoryServerGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,1,2))
policyMIBDirectoryServerGroup.setObjects(*((_B,_K),(_B,_L),(_B,_V),(_B,_W),(_B,_X),(_B,_Y),(_B,_Z),(_B,_a),(_B,_b),(_B,_c),(_B,_d),(_B,_e),(_B,_f)))
if mibBuilder.loadTexts:policyMIBDirectoryServerGroup.setStatus(_A)
policyMIBEventTableGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,1,3))
policyMIBEventTableGroup.setObjects(*((_B,_N),(_B,_g),(_B,_h),(_B,_i)))
if mibBuilder.loadTexts:policyMIBEventTableGroup.setStatus(_A)
policyMIBRuleNamesGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,1,4))
policyMIBRuleNamesGroup.setObjects(*((_B,_O),(_B,_j),(_B,_k),(_B,_l)))
if mibBuilder.loadTexts:policyMIBRuleNamesGroup.setStatus(_A)
policyMIBStatsGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,1,5))
policyMIBStatsGroup.setObjects(*((_B,_P),(_B,_Q),(_B,_m),(_B,_n),(_B,_o),(_B,_p)))
if mibBuilder.loadTexts:policyMIBStatsGroup.setStatus(_A)
policyMIBNotificationGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,1,6))
policyMIBNotificationGroup.setObjects(*((_B,_R),(_B,_q),(_B,_r),(_B,_H),(_B,_I)))
if mibBuilder.loadTexts:policyMIBNotificationGroup.setStatus(_A)
policyMIBTrapEventGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,1,7))
policyMIBTrapEventGroup.setObjects(*((_B,_H),(_B,_I)))
if mibBuilder.loadTexts:policyMIBTrapEventGroup.setStatus(_A)
policyEventNotification=NotificationType((1,3,6,1,4,1,6486,801,1,2,1,14,1,0,1))
policyEventNotification.setObjects(*((_B,_H),(_B,_I)))
if mibBuilder.loadTexts:policyEventNotification.setStatus(_A)
policyMIBTrapsGroup=NotificationGroup((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,1,8))
policyMIBTrapsGroup.setObjects((_B,_s))
if mibBuilder.loadTexts:policyMIBTrapsGroup.setStatus(_A)
alcatelIND1PolicyMIBCompliance=ModuleCompliance((1,3,6,1,4,1,6486,801,1,2,1,14,1,2,2,1))
alcatelIND1PolicyMIBCompliance.setObjects(*((_B,_t),(_B,_u),(_B,_v),(_B,_w),(_B,_x),(_B,_y)))
if mibBuilder.loadTexts:alcatelIND1PolicyMIBCompliance.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'PolicyEventCodes':PolicyEventCodes,'alcatelIND1PolicyMIB':alcatelIND1PolicyMIB,'alcatelIND1PolicyMIBNotifications':alcatelIND1PolicyMIBNotifications,_s:policyEventNotification,'alcatelIND1PolicyMIBObjects':alcatelIND1PolicyMIBObjects,_S:serverPolicyDecision,'rsvpDefaultPolicy':rsvpDefaultPolicy,_T:policyManagerEventTableSize,'directoryServerTable':directoryServerTable,'directoryServerEntry':directoryServerEntry,_K:directoryServerAddress,_L:directoryServerPort,_V:directoryServerPreference,_W:directoryServerAuthenticationType,_X:directoryServerUserId,_Y:directoryServerPassword,_Z:directoryServerSearchbase,_a:directoryServerCacheChange,_b:directoryServerLastChange,_c:directoryServerAdminStatus,_d:directoryServerOperStatus,_e:directoryServerRowStatus,_f:directoryServerEnableSSL,'policyEventTable':policyEventTable,'policyEventEntry':policyEventEntry,_N:policyEventIndex,_g:policyEventCode,_h:policyEventDetailString,_i:policyEventTime,'policyRuleNamesTable':policyRuleNamesTable,'policyRuleNamesEntry':policyRuleNamesEntry,_O:policyRuleNamesIndex,_j:policyRuleNamesName,_k:policyRuleNamesRowStatus,_l:policyRuleOperStatus,'policyStatsTable':policyStatsTable,'policyStatsEntry':policyStatsEntry,_P:policyStatsAddress,_Q:policyStatsServerPort,_p:policyStatsQueryCount,_m:policyStatsAccessCount,_n:policyStatsSuccessAccessCount,_o:policyStatsNotFoundCount,'policyNotificationTable':policyNotificationTable,'policyNotificationEntry':policyNotificationEntry,_R:policyNotificationIndex,_q:policyNotificationCode,_r:policyEventCount,_U:policyManagerSwitchIdentifier,'policyManagerTrapObjs':policyManagerTrapObjs,_H:policyTrapEventDetailString,_I:policyTrapEventCode,'alcatelIND1PolicyMIBConformance':alcatelIND1PolicyMIBConformance,'alcatelIND1PolicyMIBGroups':alcatelIND1PolicyMIBGroups,_t:policyMIBGlobalGroup,_u:policyMIBDirectoryServerGroup,_v:policyMIBEventTableGroup,_w:policyMIBRuleNamesGroup,_x:policyMIBStatsGroup,_y:policyMIBNotificationGroup,'policyMIBTrapEventGroup':policyMIBTrapEventGroup,'policyMIBTrapsGroup':policyMIBTrapsGroup,'alcatelIND1PolicyMIBCompliances':alcatelIND1PolicyMIBCompliances,'alcatelIND1PolicyMIBCompliance':alcatelIND1PolicyMIBCompliance})