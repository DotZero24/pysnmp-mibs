...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-NAT-CGN-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:28:38 2025
...
cNatCgnModuleCompliance.setObjects(
      *(("CISCO-NAT-CGN-EXT-MIB", "cNatCgnConfigGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnCountersGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnNotificationsGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnOptionConfigGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnBulkAllocGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnSessionGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnNetflowLoggingGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnSyslogLoggingGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnFragmentsGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnALGCountersGroup"),
        ("CISCO-NAT-CGN-EXT-MIB", "cNatCgnServiceNameGroup"))
)
if mibBuilder.loadTexts:
