# SNMP MIB module (TPLINK-CLUSTERMANAGE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/tplink/TPLINK-CLUSTERMANAGE-MIB
...
clusterRole.setMaxAccess("read-write")
