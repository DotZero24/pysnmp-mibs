...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-MOBILE-IP-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:30:37 2025
...
faCOAEntry, RegistrationFlags, mnState, mnRegistrationEntry, mnRegAgentAddress, mnHAEntry, haMobilityBindingEntry, mnRegCOA = mibBuilder.importSymbols("MIP-MIB", "faCOAEntry", "RegistrationFlags", "mnState", "mnRegistrationEntry", "mnRegAgentAddress", "mnHAEntry", "haMobilityBindingEntry", "mnRegCOA")
...
mibBuilder.exportSymbols("CISCO-MOBILE-IP-MIB", cmiMrBetterIfDetected=cmiMrBetterIfDetected, cmiFaInterfaceEntry=cmiFaInterfaceEntry, cmiHaInitRegRequestsReceived=cmiHaInitRegRequestsReceived, ciscoMobileIpComplianceV12R02=ciscoMobileIpComplianceV12R02, cmiFaMnAAAAuthFailures=cmiFaMnAAAAuthFailures, cmiMrMaAdvMaxLifetime=cmiMrMaAdvMaxLifetime, ciscoMobileIpComplianceV12R09=ciscoMobileIpComplianceV12R09, cmiMrRegExtendRetry=cmiMrRegExtendRetry, CmiSpi=CmiSpi, cmiHaMobNetAddress=cmiHaMobNetAddress, cmiFaInitRegRequestsRelayed=cmiFaInitRegRequestsRelayed, cmiHaMobNetAddressType=cmiHaMobNetAddressType, cmiMrRegLifetime=cmiMrRegLifetime, cmiMrIfSolicitInterval=cmiMrIfSolicitInterval, ciscoMobileIpMrSystemGroupV1=ciscoMobileIpMrSystemGroupV1, cmiMaReg=cmiMaReg, ciscoMobileIpMIBConformance=ciscoMobileIpMIBConformance, cmiMrIfCCoaRegistration=cmiMrIfCCoaRegistration, cmiHaRedunFailedBUs=cmiHaRedunFailedBUs, cmiFaChallengeEnable=cmiFaChallengeEnable, cmiSecRecentViolationIDLow=cmiSecRecentViolationIDLow, cmiHaMobNetPfxLen=cmiHaMobNetPfxLen, cmiMrIfIndex=cmiMrIfIndex, cmiMrMaAdvTimeReceived=cmiMrMaAdvTimeReceived, cmiHaRegTunnelStatsDestAddr=cmiHaRegTunnelStatsDestAddr, cmiMrMaAddressType=cmiMrMaAddressType, cmiHaMobNetStatus=cmiHaMobNetStatus, ciscoMobileIpCompliance=ciscoMobileIpCompliance, cmiHaReRegRequestsAccepted=cmiHaReRegRequestsAccepted, cmiMrTunnelBytesSent=cmiMrTunnelBytesSent, cmiHaRegMnIdentifier=cmiHaRegMnIdentifier, cmiFaInitRegRequestsReceived=cmiFaInitRegRequestsReceived, ciscoMobileIpMrSystemGroup=ciscoMobileIpMrSystemGroup, cmiHaMnHaAuthFailures=cmiHaMnHaAuthFailures, cmiHaRegOverallServTime=cmiHaRegOverallServTime, cmiHaCvsesFromFaRejected=cmiHaCvsesFromFaRejected, cmiFaReRegRepliesValidRelayToMN=cmiFaReRegRepliesValidRelayToMN, cmiMRIfDescription=cmiMRIfDescription, cmiMrMobNetEntry=cmiMrMobNetEntry, cmiFaReRegRequestsRelayed=cmiFaReRegRequestsRelayed, cmiHaRegDateMaxRegsProcLoc=cmiHaRegDateMaxRegsProcLoc, cmiSecPeerIdentifier=cmiSecPeerIdentifier, cmiMrIfRoamStatus=cmiMrIfRoamStatus, cmiFaRegVisitorChallengeValue=cmiFaRegVisitorChallengeValue, cmiHa=cmiHa, cmiMaInterfaceAddressType=cmiMaInterfaceAddressType, cmiHaMrAddrType=cmiHaMrAddrType, cmiHaRegRequestsReceived=cmiHaRegRequestsReceived, cmiMrCollocatedTunnel=cmiMrCollocatedTunnel, cmiNtRegHomeAddress=cmiNtRegHomeAddress, cmiHaRegTunnelStatsTunnelType=cmiHaRegTunnelStatsTunnelType, cmiMrCoaChange=cmiMrCoaChange, cmiMrIfSolicitRetransLimit=cmiMrIfSolicitRetransLimit, cmiHaRedunTotalSentBIReqs=cmiHaRedunTotalSentBIReqs, cmiHaRegProcLocInLastMinRegs=cmiHaRegProcLocInLastMinRegs, cmiHaInitRegRequestsAccepted=cmiHaInitRegRequestsAccepted, cmiFaCoaTransmitOnly=cmiFaCoaTransmitOnly, ciscoMobileIpHaMobNetGroup=ciscoMobileIpHaMobNetGroup, cmiSecReplayMethod=cmiSecReplayMethod, cmiHaRegIntervalWimaxMaxActiveBindings=cmiHaRegIntervalWimaxMaxActiveBindings, cmiFaCoaEntry=cmiFaCoaEntry, cmiFaMnFaAuthFailures=cmiFaMnFaAuthFailures, cmiHaRegTunnelStatsInPktRate=cmiHaRegTunnelStatsInPktRate, cmiMrMaHoldDownRemaining=cmiMrMaHoldDownRemaining, cmiMaRegInLastMinuteRegs=cmiMaRegInLastMinuteRegs, cmiMrRegExtendInterval=cmiMrRegExtendInterval, ciscoMobileIpHaSystemGroupV1=ciscoMobileIpHaSystemGroupV1, cmiHaRedunReceivedBIReqs=cmiHaRedunReceivedBIReqs, cmiMnRecentAdvReceived=cmiMnRecentAdvReceived, cmiHaMrEntry=cmiHaMrEntry, cmiHaNvsesFromFaNeglected=cmiHaNvsesFromFaNeglected, cmiHaRegRecentServDeniedTime=cmiHaRegRecentServDeniedTime, cmiFaRevTunnelSupported=cmiFaRevTunnelSupported, cmiHaDeRegRequestsDiscarded=cmiHaDeRegRequestsDiscarded, cmiMrDiscovery=cmiMrDiscovery, cmiHaCvsesFromMnRejected=cmiHaCvsesFromMnRejected, cmiHaRegCounterTable=cmiHaRegCounterTable, cmiFaAdvertChallengeValue=cmiFaAdvertChallengeValue, cmiFaInitRegRepliesValidRelayMN=cmiFaInitRegRepliesValidRelayMN, cmiHaInitRegRequestsDenied=cmiHaInitRegRequestsDenied, cmiMrRegNewHa=cmiMrRegNewHa, cmiMnRegistrationEntry=cmiMnRegistrationEntry, ciscoMobileIpHaRegTunnelStatsGroup=ciscoMobileIpHaRegTunnelStatsGroup, cmiMaAdvertisement=cmiMaAdvertisement, cmiHaRegIntervalMaxActiveBindings=cmiHaRegIntervalMaxActiveBindings, cmiHaRegMobilityBindingRegFlags=cmiHaRegMobilityBindingRegFlags, cmiMrIfSolicitRetransCount=cmiMrIfSolicitRetransCount, cmiFaAdvertConfEntry=cmiFaAdvertConfEntry, cmiMrIfRoamPriority=cmiMrIfRoamPriority, cmiHaReRegRequestsDenied=cmiHaReRegRequestsDenied, cmiMaAdvMaxRegLifetime=cmiMaAdvMaxRegLifetime, cmiHaRegMnId=cmiHaRegMnId, cmiFaAdvertChallengeChapSPI=cmiFaAdvertChallengeChapSPI, cmiFaRegTotalVisitors=cmiFaRegTotalVisitors, cmiFa=cmiFa, ciscoMobileIpMIBObjects=ciscoMobileIpMIBObjects, cmiHaRegTunnelStatsDestAddrType=cmiHaRegTunnelStatsDestAddrType, cmiHaRedunSentBUs=cmiHaRedunSentBUs, ciscoMobileIpFaSystemGroup=ciscoMobileIpFaSystemGroup, cmiFaAdvertRegRequired=cmiFaAdvertRegRequired, cmiFaRegVisitorHomeAddress=cmiFaRegVisitorHomeAddress, cmiMrTunnelBytesRcvd=cmiMrTunnelBytesRcvd, cmiHaMaximumBindings=cmiHaMaximumBindings, ciscoMobileIpComplianceRev2=ciscoMobileIpComplianceRev2, cmiHaMrTable=cmiHaMrTable, cmiMrIfRegisteredCoAType=cmiMrIfRegisteredCoAType, cmiMrIfSolicitRetransMax=cmiMrIfSolicitRetransMax, cmiMrIfCCoaRegRetryRemaining=cmiMrIfCCoaRegRetryRemaining, cmiSecAssocTable=cmiSecAssocTable, cmiHaRegTunnelStatsEntry=cmiHaRegTunnelStatsEntry, cmiHaMrStatus=cmiHaMrStatus, cmiFaChallengeSupported=cmiFaChallengeSupported, ciscoMobileIpComplianceV12R11=ciscoMobileIpComplianceV12R11, cmiFaRegVisitorRegFlagsRev1=cmiFaRegVisitorRegFlagsRev1, ciscoMobileIpCompliances=ciscoMobileIpCompliances, cmiMaAdvMaxInterval=cmiMaAdvMaxInterval, ciscoMobileIpSecViolationGroup=ciscoMobileIpSecViolationGroup, cmiHaRegTunnelStatsOutBytes=cmiHaRegTunnelStatsOutBytes, cmiFaInterfaceTable=cmiFaInterfaceTable, cmiMaAdvPrefixLengthInclusion=cmiMaAdvPrefixLengthInclusion, cmiFaInitRegRequestsDenied=cmiFaInitRegRequestsDenied, cmiFaAdvertisement=cmiFaAdvertisement, cmiMrIfRegisteredCoA=cmiMrIfRegisteredCoA, ciscoMobileIpMIBNotifications=ciscoMobileIpMIBNotifications, cmiSecRecentViolationIDHigh=cmiSecRecentViolationIDHigh, cmiFaSystem=cmiFaSystem, cmiHaRegMobilityBindingMacAddress=cmiHaRegMobilityBindingMacAddress, cmiMrIfHaTunnelIfIndex=cmiMrIfHaTunnelIfIndex, cmiHaRegTotalProcLocRegs=cmiHaRegTotalProcLocRegs, cmiNtRegHomeAgent=cmiNtRegHomeAgent, cmiMaAdvertisementGroup=cmiMaAdvertisementGroup, ciscoMobileIpMrDiscoveryGroup=ciscoMobileIpMrDiscoveryGroup, cmiHaMrMultiPath=cmiHaMrMultiPath, cmiFaRegVisitorIdentifierType=cmiFaRegVisitorIdentifierType, cmiSecKey=cmiSecKey, cmiHaDeRegRequestsDenied=cmiHaDeRegRequestsDenied, cmiMrHAPriority=cmiMrHAPriority, cmiMrTunnelPktsSent=cmiMrTunnelPktsSent, cmiMrReverseTunnel=cmiMrReverseTunnel, cmiFaReRegRequestsReceived=cmiFaReRegRequestsReceived, cmiSecRecentViolationReason=cmiSecRecentViolationReason, cmiFaCoaRegAsymLink=cmiFaCoaRegAsymLink, cmiHaRegMaxTimeRegsProcByAAA=cmiHaRegMaxTimeRegsProcByAAA, cmiMrMaAdvFlags=cmiMrMaAdvFlags, cmiMrMobNetTable=cmiMrMobNetTable, cmiMrMobNetIfIndex=cmiMrMobNetIfIndex, cmiHaRegMaxProcLocInMinRegs=cmiHaRegMaxProcLocInMinRegs, cmiFaReg=cmiFaReg, cmiFaAdvertChallengeEntry=cmiFaAdvertChallengeEntry, cmiFaReverseTunnelEnable=cmiFaReverseTunnelEnable, cmiMrMobNetAddrType=cmiMrMobNetAddrType, cmiNtRegNAI=cmiNtRegNAI, cmiMrIfStatus=cmiMrIfStatus, cmiFaNvsesFromMnNeglected=cmiFaNvsesFromMnNeglected, cmiFaEncapDeliveryStyleSupported=cmiFaEncapDeliveryStyleSupported, cmiSecAlgorithmType=cmiSecAlgorithmType, cmiMrMaAddress=cmiMrMaAddress, cmiHaDeRegRequestsReceived=cmiHaDeRegRequestsReceived, cmiHaMaxBindingsNotif=cmiHaMaxBindingsNotif, cmiFaRegVisitorTimeGranted=cmiFaRegVisitorTimeGranted, cmiFaAdvertChallengeIndex=cmiFaAdvertChallengeIndex, cmiMrIfEntry=cmiMrIfEntry, cmiHaRegCounterEntry=cmiHaRegCounterEntry, cmiSecSPI=cmiSecSPI, cmiMrMaAdvLifetimeRemaining=cmiMrMaAdvLifetimeRemaining, cmiFaRegVisitorRegIDLow=cmiFaRegVisitorRegIDLow, cmiMaAdvConfigTable=cmiMaAdvConfigTable, cmiHaRegMnIfBandwidth=cmiHaRegMnIfBandwidth, cmiHaRegIntervalSize=cmiHaRegIntervalSize, cmiMnDiscovery=cmiMnDiscovery, cmiHaRegTunnelStatsTable=cmiHaRegTunnelStatsTable, cmiFaReRegRequestsDenied=cmiFaReRegRequestsDenied, cmiMaAdvStatus=cmiMaAdvStatus, cmiMrIfCCoaDefaultGw=cmiMrIfCCoaDefaultGw, cmiHaRegInterval3gpp2MaxActiveBindings=cmiHaRegInterval3gpp2MaxActiveBindings, cmiFaCvsesFromMnRejected=cmiFaCvsesFromMnRejected, ciscoMobileIpHaMobNetGroupSup1=ciscoMobileIpHaMobNetGroupSup1, CmiRegistrationFlags=CmiRegistrationFlags, cmiSecAssocEntry=cmiSecAssocEntry, cmiMrHATable=cmiMrHATable, cmiMrMaAdvTable=cmiMrMaAdvTable, cmiFaInitRegRequestsDiscarded=cmiFaInitRegRequestsDiscarded, cmiMaAdvAddressType=cmiMaAdvAddressType, ciscoMobileIpHaRegGroupV12R03r2=ciscoMobileIpHaRegGroupV12R03r2, cmiHaSystem=cmiHaSystem, ciscoMobileIpComplianceV12R03r1=ciscoMobileIpComplianceV12R03r1, cmiMrHAEntry=cmiMrHAEntry, cmiMrTunnelPktsRcvd=cmiMrTunnelPktsRcvd, cmiHaReverseTunnelBitNotSet=cmiHaReverseTunnelBitNotSet, cmiMrIfID=cmiMrIfID, cmiHaMrDynamic=cmiHaMrDynamic, cmiMrMaAdvEntry=cmiMrMaAdvEntry, cmiMrHABest=cmiMrHABest, cmiFaRegVisitorRegFlags=cmiFaRegVisitorRegFlags, ciscoMobileIpComplianceV12R04=ciscoMobileIpComplianceV12R04, cmiMnAdvFlags=cmiMnAdvFlags, ciscoMobileIpHaRegGroupV12R02=ciscoMobileIpHaRegGroupV12R02, ciscoMobileIpComplianceRev1=ciscoMobileIpComplianceRev1, ciscoMobileIpMrSystemGroupV3Sup1=ciscoMobileIpMrSystemGroupV3Sup1, cmiHaSystemVersion=cmiHaSystemVersion, cmiHaMnAAAAuthFailures=cmiHaMnAAAAuthFailures, cmiFaAdvertConfTable=cmiFaAdvertConfTable, cmiHaRegServDeniedRequests=cmiHaRegServDeniedRequests, ciscoMobileIpMnDiscoveryGroup=ciscoMobileIpMnDiscoveryGroup, cmiHaRedunFailedBIReps=cmiHaRedunFailedBIReps, cmiHaRegMnIfDescription=cmiHaRegMnIfDescription, ciscoMobileIpFaRegGroupV12R03r2=ciscoMobileIpFaRegGroupV12R03r2, cmiMrRegistration=cmiMrRegistration, cmiSecRecentViolationSPI=cmiSecRecentViolationSPI, ciscoMobileIpSecAssocGroup=ciscoMobileIpSecAssocGroup, ciscoMobileIpMIB=ciscoMobileIpMIB, cmiFaRegVisitorRegIsAccepted=cmiFaRegVisitorRegIsAccepted, cmiMaAdvResponseSolicitationOnly=cmiMaAdvResponseSolicitationOnly, cmiFaRegVisitorTable=cmiFaRegVisitorTable, cmiMaRegMaxInMinuteRegs=cmiMaRegMaxInMinuteRegs, cmiMa=cmiMa, cmiHaRedunDroppedBIReps=cmiHaRedunDroppedBIReps, cmiMrMultiPathMetricType=cmiMrMultiPathMetricType, cmiHaMobNetTable=cmiHaMobNetTable, cmiMrMobNetAddr=cmiMrMobNetAddr, ciscoMobileIpFaRegGroupV12R03=ciscoMobileIpFaRegGroupV12R03, cmiHaRegProcAAAInLastByMinRegs=cmiHaRegProcAAAInLastByMinRegs, cmiHaRegTunnelStatsSrcAddr=cmiHaRegTunnelStatsSrcAddr, ciscoMobileIpHaRegGroupV12R03=ciscoMobileIpHaRegGroupV12R03, CmiMultiPathMetricType=CmiMultiPathMetricType, ciscoMobileIpComplianceV12R05=ciscoMobileIpComplianceV12R05, cmiHaMobNetDynamic=cmiHaMobNetDynamic, cmiFaReverseTunnelUnavailable=cmiFaReverseTunnelUnavailable, cmiHaRedunReceivedBIAcks=cmiHaRedunReceivedBIAcks, ciscoMobileIpTrapObjectsGroupV2=ciscoMobileIpTrapObjectsGroupV2, cmiSecKey2=cmiSecKey2, cmiMrIfCCoaDefaultGwType=cmiMrIfCCoaDefaultGwType, cmiFaCvsesFromHaRejected=cmiFaCvsesFromHaRejected, cmiHaRegTunnelStatsOutBitRate=cmiHaRegTunnelStatsOutBitRate, cmiMrIfSolicitRetransRemaining=cmiMrIfSolicitRetransRemaining, cmiNtRegCOAType=cmiNtRegCOAType, cmiFaReverseTunnelBitNotSet=cmiFaReverseTunnelBitNotSet, cmiHaRegDateMaxRegsProcByAAA=cmiHaRegDateMaxRegsProcByAAA, cmiFaCoaTable=cmiFaCoaTable, cmiFaAdvertIsBusy=cmiFaAdvertIsBusy, cmiHaMobNetEntry=cmiHaMobNetEntry, cmiMrRegRetransInitial=cmiMrRegRetransInitial, cmiFaRegVisitorIdentifier=cmiFaRegVisitorIdentifier, cmiHaRegTunnelStatsSrcAddrType=cmiHaRegTunnelStatsSrcAddrType, cmiHaRedunTotalSentBUs=cmiHaRedunTotalSentBUs, ciscoMobileIpHaRegIntervalStatsGroup=ciscoMobileIpHaRegIntervalStatsGroup, cmiMrHaTunnelIfIndex=cmiMrHaTunnelIfIndex, cmiHaRegRequestsDenied=cmiHaRegRequestsDenied, cmiHaNAICheckFailures=cmiHaNAICheckFailures, cmiSecViolationTable=cmiSecViolationTable, cmiMrRedStatePassive=cmiMrRedStatePassive, cmiFaNvsesFromHaNeglected=cmiFaNvsesFromHaNeglected, cmiHaMrAddr=cmiHaMrAddr, cmiFaCoaInterfaceOnly=cmiFaCoaInterfaceOnly)
mibBuilder.exportSymbols("CISCO-MOBILE-IP-MIB", CmiEntityIdentifier=CmiEntityIdentifier, cmiHaRedunDroppedBIAcks=cmiHaRedunDroppedBIAcks, cmiMrIfRegisteredMaAddrType=cmiMrIfRegisteredMaAddrType, cmiMrMaAdvMaxRegLifetime=cmiMrMaAdvMaxRegLifetime, cmiMrIfCCoaAddressType=cmiMrIfCCoaAddressType, cmiHaRedunReceivedBUs=cmiHaRedunReceivedBUs, cmiMrRedundancyGroup=cmiMrRedundancyGroup, cmiMaAdvInterfaceIndex=cmiMaAdvInterfaceIndex, cmiFaReRegRequestsDiscarded=cmiFaReRegRequestsDiscarded, cmiFaUnknownChallenge=cmiFaUnknownChallenge, cmiMrMaAdvSequence=cmiMrMaAdvSequence, cmiHaRedun=cmiHaRedun, cmiMnRegistrationTable=cmiMnRegistrationTable, cmiHaRegTotalProcByAAARegs=cmiHaRegTotalProcByAAARegs, cmiHaRegMnIdType=cmiHaRegMnIdType, ciscoMobileIpMrSystemGroupV3=ciscoMobileIpMrSystemGroupV3, cmiMrStateChange=cmiMrStateChange, cmiSecurity=cmiSecurity, cmiFaRegVisitorHomeAgentAddress=cmiFaRegVisitorHomeAgentAddress, cmiHaRedunReceivedBUAcks=cmiHaRedunReceivedBUAcks, cmiSecRecentViolationTime=cmiSecRecentViolationTime, cmiSecViolationEntry=cmiSecViolationEntry, cmiMn=cmiMn, cmiMrRedStateActive=cmiMrRedStateActive, cmiMnRegistration=cmiMnRegistration, cmiMaAdvMinInterval=cmiMaAdvMinInterval, cmiHaReg=cmiHaReg, cmiHaRedunSecViolations=cmiHaRedunSecViolations, cmiHaEncapUnavailable=cmiHaEncapUnavailable, cmiMrNewMA=cmiMrNewMA, cmiFaDeliveryStyleUnsupported=cmiFaDeliveryStyleUnsupported, cmiHaRegTunnelStatsInPkts=cmiHaRegTunnelStatsInPkts, cmiHaReverseTunnelUnavailable=cmiHaReverseTunnelUnavailable, cmiHaReRegRequestsReceived=cmiHaReRegRequestsReceived, cmiHaRegServAcceptedRequests=cmiHaRegServAcceptedRequests, cmiMnRegFlags=cmiMnRegFlags, cmiHaRegTunnelStatsOutPkts=cmiHaRegTunnelStatsOutPkts, cmiMrIfCCoaOnly=cmiMrIfCCoaOnly, cmiSecViolatorIdentifier=cmiSecViolatorIdentifier, cmiFaStaleChallenge=cmiFaStaleChallenge, cmiMrIfTable=cmiMrIfTable, cmiMrIfCCoaRegRetry=cmiMrIfCCoaRegRetry, cmiFaMnTooDistant=cmiFaMnTooDistant, ciscoMobileIpHaRedunGroup=ciscoMobileIpHaRedunGroup, ciscoMobileIpTrapObjectsGroup=ciscoMobileIpTrapObjectsGroup, cmiHaRegMnIfID=cmiHaRegMnIfID, ciscoMobileIpHaRegGroupV1=ciscoMobileIpHaRegGroupV1, CmiTunnelType=CmiTunnelType, cmiFaReRegRepliesValidFromHA=cmiFaReRegRepliesValidFromHA, cmiFaDeRegRepliesValidRelayToMN=cmiFaDeRegRepliesValidRelayToMN, cmiHaRegTunnelStatsDataRateInt=cmiHaRegTunnelStatsDataRateInt, cmiHaInitRegRequestsDiscarded=cmiHaInitRegRequestsDiscarded, cmiHaDeRegRequestsAccepted=cmiHaDeRegRequestsAccepted, cmiHaRedunSentBUAcks=cmiHaRedunSentBUAcks, cmiHaNvsesFromMnNeglected=cmiHaNvsesFromMnNeglected, cmiFaTotalRegReplies=cmiFaTotalRegReplies, cmiSecStatus=cmiSecStatus, cmiMrMaAdvTimeFirstHeard=cmiMrMaAdvTimeFirstHeard, ciscoMobileIpComplianceV12R03=ciscoMobileIpComplianceV12R03, cmiHaRedunFailedBIReqs=cmiHaRedunFailedBIReqs, cmiMaAdvConfigEntry=cmiMaAdvConfigEntry, cmiHaRegMobilityBindingTable=cmiHaRegMobilityBindingTable, cmiNtRegCOA=cmiNtRegCOA, cmiHaRegTunnelStatsOutPktRate=cmiHaRegTunnelStatsOutPktRate, PYSNMP_MODULE_ID=ciscoMobileIpMIB, cmiHaRegRequestsDiscarded=cmiHaRegRequestsDiscarded, cmiSecTotalViolations=cmiSecTotalViolations, cmiHaRegTotalMobilityBindings=cmiHaRegTotalMobilityBindings, cmiMrRegRetransMax=cmiMrRegRetransMax, cmiMrIfHoldDown=cmiMrIfHoldDown, cmiMaAdvMaxAdvLifetime=cmiMaAdvMaxAdvLifetime, cmiHaMobNet=cmiHaMobNet, ciscoMobileIpHaRegGroup=ciscoMobileIpHaRegGroup, cmiFaRegVisitorTimeRemaining=cmiFaRegVisitorTimeRemaining, cmiFaTotalRegRequests=cmiFaTotalRegRequests, cmiMrIfCCoaAddress=cmiMrIfCCoaAddress, cmiHaRegMnIfPathMetricType=cmiHaRegMnIfPathMetricType, cmiMaRegDateMaxRegsReceived=cmiMaRegDateMaxRegsReceived, cmiMrMobNetStatus=cmiMrMobNetStatus, cmiMrMobNetPfxLen=cmiMrMobNetPfxLen, ciscoMobileIpComplianceV12R10=ciscoMobileIpComplianceV12R10, ciscoMobileIpFaAdvertisementGroup=ciscoMobileIpFaAdvertisementGroup, cmiHaReRegRequestsDiscarded=cmiHaReRegRequestsDiscarded, cmiSecViolatorIdentifierType=cmiSecViolatorIdentifierType, cmiFaInitRegRepliesValidFromHA=cmiFaInitRegRepliesValidFromHA, ciscoMobileIpGroups=ciscoMobileIpGroups, cmiMrMultiPath=cmiMrMultiPath, cmiMaInterfaceAddress=cmiMaInterfaceAddress, CmiEntityIdentifierType=CmiEntityIdentifierType, cmiMaAdvAddress=cmiMaAdvAddress, cmiFaAdvertChallengeWindow=cmiFaAdvertChallengeWindow, cmiTrapControl=cmiTrapControl, cmiMrIfCCoaEnable=cmiMrIfCCoaEnable, cmiMrSystem=cmiMrSystem, cmiMrIfRegisteredMaAddr=cmiMrIfRegisteredMaAddr, ciscoMobileIpComplianceV12R06=ciscoMobileIpComplianceV12R06, ciscoMobileIpMrNotificationGroupV2=ciscoMobileIpMrNotificationGroupV2, cmiHaRedunSentBIReqs=cmiHaRedunSentBIReqs, cmiTrapObjects=cmiTrapObjects, ciscoMobileIpComplianceV12R08=ciscoMobileIpComplianceV12R08, cmiSecPeerIdentifierType=cmiSecPeerIdentifierType, cmiHaRedunTotalSentBIReps=cmiHaRedunTotalSentBIReps, cmiMrMaIfMacAddress=cmiMrMaIfMacAddress, ciscoMobileIpMaRegGroup=ciscoMobileIpMaRegGroup, cmiHaRegMobilityBindingEntry=cmiHaRegMobilityBindingEntry, cmiNtRegDeniedCode=cmiNtRegDeniedCode, cmiSecAlgorithmMode=cmiSecAlgorithmMode, cmiHaRegTunnelStatsInBytes=cmiHaRegTunnelStatsInBytes, cmiHaRedunReceivedBIReps=cmiHaRedunReceivedBIReps, cmiHaRedunSentBIReps=cmiHaRedunSentBIReps, ciscoMobileIpMrNotificationGroupV3=ciscoMobileIpMrNotificationGroupV3, cmiHaRedunSentBIAcks=cmiHaRedunSentBIAcks, cmiFaDeRegRepliesValidFromHA=cmiFaDeRegRepliesValidFromHA, cmiHaRegRecentServDeniedCode=cmiHaRegRecentServDeniedCode, cmiSecAssocsCount=cmiSecAssocsCount, cmiNtRegHAAddrType=cmiNtRegHAAddrType, cmiHaRegAvgTimeRegsProcByAAA=cmiHaRegAvgTimeRegsProcByAAA, cmiHaRegTunnelStatsInBitRate=cmiHaRegTunnelStatsInBitRate, ciscoMobileIpMnRegistrationGroup=ciscoMobileIpMnRegistrationGroup, ciscoMobileIpFaRegGroup=ciscoMobileIpFaRegGroup, ciscoMobileIpSecAssocGroupV12R02=ciscoMobileIpSecAssocGroupV12R02, cmiHaRegMnIdentifierType=cmiHaRegMnIdentifierType, cmiHaRegMaxProcByAAAInMinRegs=cmiHaRegMaxProcByAAAInMinRegs, ciscoMobileIpFaRegGroupV12R03r1=ciscoMobileIpFaRegGroupV12R03r1, ciscoMobileIpComplianceV12R07=ciscoMobileIpComplianceV12R07, ciscoMobileIpMrNotificationGroup=ciscoMobileIpMrNotificationGroup, cmiHaRegTunnelStatsNumUsers=cmiHaRegTunnelStatsNumUsers, cmiFaRegVisitorEntry=cmiFaRegVisitorEntry, cmiFaDeRegRequestsDiscarded=cmiFaDeRegRequestsDiscarded, cmiMrRegExtendExpire=cmiMrRegExtendExpire, cmiFaAdvertChallengeTable=cmiFaAdvertChallengeTable, ciscoMobileIpHaRegGroupV12R03r2Sup1=ciscoMobileIpHaRegGroupV12R03r2Sup1, cmiFaMissingChallenge=cmiFaMissingChallenge, ciscoMobileIpMrSystemGroupV2=ciscoMobileIpMrSystemGroupV2, cmiMrIfSolicitPeriodic=cmiMrIfSolicitPeriodic, cmiHaMrMultiPathMetricType=cmiHaMrMultiPathMetricType, cmiMrMaAdvRcvIf=cmiMrMaAdvRcvIf, cmiNtRegHomeAddressType=cmiNtRegHomeAddressType, ciscoMobileIpHaRegGroupV12R03r2Sup2=ciscoMobileIpHaRegGroupV12R03r2Sup2, ciscoMobileIpHaRegGroupV12R03r1=ciscoMobileIpHaRegGroupV12R03r1, cmiFaDeRegRequestsRelayed=cmiFaDeRegRequestsRelayed, ciscoMobileIpFaRegGroupV12R02=ciscoMobileIpFaRegGroupV12R02, cmiMrMaIsHa=cmiMrMaIsHa, cmiHaRegRecentServAcceptedTime=cmiHaRegRecentServAcceptedTime, cmiHaMnRegReqFailed=cmiHaMnRegReqFailed, cmiFaDeRegRequestsReceived=cmiFaDeRegRequestsReceived, cmiMrIfSolicitRetransInitial=cmiMrIfSolicitRetransInitial, cmiHaEncapsulationUnavailable=cmiHaEncapsulationUnavailable, cmiFaRegVisitorRegIDHigh=cmiFaRegVisitorRegIDHigh, ciscoMobileIpMrRegistrationGroup=ciscoMobileIpMrRegistrationGroup, cmiMrRegRetransLimit=cmiMrRegRetransLimit, cmiFaDeRegRequestsDenied=cmiFaDeRegRequestsDenied, cmiMrIfSolicitRetransCurrent=cmiMrIfSolicitRetransCurrent)
