...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:15:24 2025
...
haMobilityBindingEntry, mnState, mnRegistrationEntry, mnRegCOA, mnHAEntry, mnRegAgentAddress, RegistrationFlags, faCOAEntry = mibBuilder.importSymbols("MIP-MIB", "haMobilityBindingEntry", "mnState", "mnRegistrationEntry", "mnRegCOA", "mnHAEntry", "mnRegAgentAddress", "RegistrationFlags", "faCOAEntry")
...
mibBuilder.exportSymbols("CISCO-MOBILE-IP-MIB", cmiHaRedunSentBIReps=cmiHaRedunSentBIReps, cmiMrIfSolicitRetransInitial=cmiMrIfSolicitRetransInitial, cmiHaRegIntervalMaxActiveBindings=cmiHaRegIntervalMaxActiveBindings, cmiFaMnAAAAuthFailures=cmiFaMnAAAAuthFailures, cmiHaRegTunnelStatsNumUsers=cmiHaRegTunnelStatsNumUsers, cmiMrIfEntry=cmiMrIfEntry, cmiFaNvsesFromHaNeglected=cmiFaNvsesFromHaNeglected, cmiFaAdvertChallengeIndex=cmiFaAdvertChallengeIndex, cmiHaDeRegRequestsAccepted=cmiHaDeRegRequestsAccepted, cmiMrMaIsHa=cmiMrMaIsHa, cmiHaRegTunnelStatsOutPkts=cmiHaRegTunnelStatsOutPkts, cmiMrIfRegisteredMaAddr=cmiMrIfRegisteredMaAddr, cmiMrMaHoldDownRemaining=cmiMrMaHoldDownRemaining, cmiFaAdvertChallengeValue=cmiFaAdvertChallengeValue, cmiFaCoaTable=cmiFaCoaTable, cmiMaAdvertisementGroup=cmiMaAdvertisementGroup, cmiMaAdvMaxInterval=cmiMaAdvMaxInterval, cmiHaRegDateMaxRegsProcByAAA=cmiHaRegDateMaxRegsProcByAAA, cmiMrIfRegisteredMaAddrType=cmiMrIfRegisteredMaAddrType, ciscoMobileIpComplianceV12R07=ciscoMobileIpComplianceV12R07, ciscoMobileIpSecViolationGroup=ciscoMobileIpSecViolationGroup, cmiMrMaAdvFlags=cmiMrMaAdvFlags, cmiHaRegRecentServAcceptedTime=cmiHaRegRecentServAcceptedTime, cmiSecViolatorIdentifierType=cmiSecViolatorIdentifierType, cmiMaAdvPrefixLengthInclusion=cmiMaAdvPrefixLengthInclusion, cmiHaRedunFailedBUs=cmiHaRedunFailedBUs, cmiFaReRegRepliesValidFromHA=cmiFaReRegRepliesValidFromHA, cmiMaAdvStatus=cmiMaAdvStatus, ciscoMobileIpHaRegGroupV12R03r2Sup2=ciscoMobileIpHaRegGroupV12R03r2Sup2, cmiHaRegTunnelStatsInBytes=cmiHaRegTunnelStatsInBytes, cmiMrHAEntry=cmiMrHAEntry, cmiHaRegInterval3gpp2MaxActiveBindings=cmiHaRegInterval3gpp2MaxActiveBindings, cmiHaRegTunnelStatsOutBitRate=cmiHaRegTunnelStatsOutBitRate, cmiHaRegMnIfDescription=cmiHaRegMnIfDescription, cmiFaNvsesFromMnNeglected=cmiFaNvsesFromMnNeglected, cmiMrRegRetransInitial=cmiMrRegRetransInitial, ciscoMobileIpComplianceV12R08=ciscoMobileIpComplianceV12R08, cmiFaRegVisitorTable=cmiFaRegVisitorTable, cmiHaRegTunnelStatsDestAddr=cmiHaRegTunnelStatsDestAddr, ciscoMobileIpCompliances=ciscoMobileIpCompliances, cmiSecRecentViolationIDLow=cmiSecRecentViolationIDLow, cmiFaDeRegRequestsDiscarded=cmiFaDeRegRequestsDiscarded, cmiMrIfSolicitInterval=cmiMrIfSolicitInterval, cmiFaRegVisitorEntry=cmiFaRegVisitorEntry, cmiMrRegLifetime=cmiMrRegLifetime, cmiHaRedunSecViolations=cmiHaRedunSecViolations, cmiMrMobNetEntry=cmiMrMobNetEntry, cmiMrHABest=cmiMrHABest, cmiMrRedundancyGroup=cmiMrRedundancyGroup, cmiFaChallengeSupported=cmiFaChallengeSupported, cmiMrIfSolicitPeriodic=cmiMrIfSolicitPeriodic, cmiMrCollocatedTunnel=cmiMrCollocatedTunnel, cmiHaRegTunnelStatsEntry=cmiHaRegTunnelStatsEntry, cmiMrTunnelPktsSent=cmiMrTunnelPktsSent, cmiFaSystem=cmiFaSystem, cmiMrIfRoamStatus=cmiMrIfRoamStatus, ciscoMobileIpSecAssocGroup=ciscoMobileIpSecAssocGroup, cmiSecAssocsCount=cmiSecAssocsCount, cmiMrIfCCoaAddressType=cmiMrIfCCoaAddressType, cmiMrIfCCoaDefaultGwType=cmiMrIfCCoaDefaultGwType, cmiFa=cmiFa, cmiMrIfRegisteredCoAType=cmiMrIfRegisteredCoAType, cmiMaAdvConfigTable=cmiMaAdvConfigTable, cmiSecKey=cmiSecKey, cmiFaInitRegRequestsDiscarded=cmiFaInitRegRequestsDiscarded, cmiMrMobNetStatus=cmiMrMobNetStatus, cmiMrIfCCoaRegistration=cmiMrIfCCoaRegistration, cmiFaDeRegRepliesValidFromHA=cmiFaDeRegRepliesValidFromHA, cmiFaAdvertConfEntry=cmiFaAdvertConfEntry, CmiTunnelType=CmiTunnelType, cmiHaRegMaxTimeRegsProcByAAA=cmiHaRegMaxTimeRegsProcByAAA, cmiMrIfSolicitRetransMax=cmiMrIfSolicitRetransMax, cmiFaAdvertConfTable=cmiFaAdvertConfTable, cmiMnRegistration=cmiMnRegistration, cmiHaRegMnId=cmiHaRegMnId, cmiMrRedStateActive=cmiMrRedStateActive, cmiMaAdvMinInterval=cmiMaAdvMinInterval, cmiFaRegVisitorRegIDHigh=cmiFaRegVisitorRegIDHigh, cmiMrTunnelBytesRcvd=cmiMrTunnelBytesRcvd, cmiHaMobNetAddress=cmiHaMobNetAddress, cmiHa=cmiHa, cmiHaEncapsulationUnavailable=cmiHaEncapsulationUnavailable, ciscoMobileIpMrSystemGroupV3Sup1=ciscoMobileIpMrSystemGroupV3Sup1, cmiFaCvsesFromHaRejected=cmiFaCvsesFromHaRejected, cmiFaReverseTunnelEnable=cmiFaReverseTunnelEnable, cmiSecRecentViolationIDHigh=cmiSecRecentViolationIDHigh, cmiSecRecentViolationSPI=cmiSecRecentViolationSPI, cmiFaMissingChallenge=cmiFaMissingChallenge, ciscoMobileIpMrRegistrationGroup=ciscoMobileIpMrRegistrationGroup, cmiHaRegRecentServDeniedTime=cmiHaRegRecentServDeniedTime, ciscoMobileIpHaRegGroupV1=ciscoMobileIpHaRegGroupV1, cmiSecPeerIdentifierType=cmiSecPeerIdentifierType, cmiHaRegTotalProcLocRegs=cmiHaRegTotalProcLocRegs, cmiHaRegCounterTable=cmiHaRegCounterTable, cmiHaRedunTotalSentBIReps=cmiHaRedunTotalSentBIReps, cmiHaRedunReceivedBUAcks=cmiHaRedunReceivedBUAcks, ciscoMobileIpComplianceV12R03=ciscoMobileIpComplianceV12R03, cmiFaRegVisitorRegIDLow=cmiFaRegVisitorRegIDLow, cmiHaRegTunnelStatsInPktRate=cmiHaRegTunnelStatsInPktRate, cmiHaRegServDeniedRequests=cmiHaRegServDeniedRequests, cmiMaAdvConfigEntry=cmiMaAdvConfigEntry, cmiFaStaleChallenge=cmiFaStaleChallenge, cmiFaChallengeEnable=cmiFaChallengeEnable, cmiHaRegDateMaxRegsProcLoc=cmiHaRegDateMaxRegsProcLoc, cmiMrTunnelPktsRcvd=cmiMrTunnelPktsRcvd, cmiFaMnTooDistant=cmiFaMnTooDistant, ciscoMobileIpComplianceV12R02=ciscoMobileIpComplianceV12R02, cmiFaEncapDeliveryStyleSupported=cmiFaEncapDeliveryStyleSupported, PYSNMP_MODULE_ID=ciscoMobileIpMIB, cmiHaRegMnIfID=cmiHaRegMnIfID, cmiHaRegTunnelStatsDestAddrType=cmiHaRegTunnelStatsDestAddrType, cmiFaRegVisitorTimeGranted=cmiFaRegVisitorTimeGranted, cmiSecReplayMethod=cmiSecReplayMethod, cmiFaAdvertisement=cmiFaAdvertisement, ciscoMobileIpMrSystemGroupV3=ciscoMobileIpMrSystemGroupV3, cmiHaMnRegReqFailed=cmiHaMnRegReqFailed, cmiMnRegistrationEntry=cmiMnRegistrationEntry, cmiHaReRegRequestsDenied=cmiHaReRegRequestsDenied, cmiMnRegistrationTable=cmiMnRegistrationTable, cmiFaDeRegRequestsDenied=cmiFaDeRegRequestsDenied, cmiFaDeliveryStyleUnsupported=cmiFaDeliveryStyleUnsupported, cmiHaRedunDroppedBIReps=cmiHaRedunDroppedBIReps, cmiMrIfSolicitRetransCount=cmiMrIfSolicitRetransCount, ciscoMobileIpComplianceV12R04=ciscoMobileIpComplianceV12R04, ciscoMobileIpFaRegGroupV12R03r1=ciscoMobileIpFaRegGroupV12R03r1, cmiFaInitRegRequestsRelayed=cmiFaInitRegRequestsRelayed, cmiMrMaAddress=cmiMrMaAddress, cmiMrHaTunnelIfIndex=cmiMrHaTunnelIfIndex, cmiHaNvsesFromMnNeglected=cmiHaNvsesFromMnNeglected, cmiHaSystem=cmiHaSystem, cmiFaCvsesFromMnRejected=cmiFaCvsesFromMnRejected, cmiHaReRegRequestsAccepted=cmiHaReRegRequestsAccepted, ciscoMobileIpMrSystemGroupV1=ciscoMobileIpMrSystemGroupV1, cmiHaRedunFailedBIReqs=cmiHaRedunFailedBIReqs, cmiMaAdvAddressType=cmiMaAdvAddressType, cmiHaRedunReceivedBIReps=cmiHaRedunReceivedBIReps, cmiHaMrTable=cmiHaMrTable, cmiNtRegDeniedCode=cmiNtRegDeniedCode, ciscoMobileIpComplianceV12R10=ciscoMobileIpComplianceV12R10, cmiHaNAICheckFailures=cmiHaNAICheckFailures, cmiMaAdvertisement=cmiMaAdvertisement, cmiHaRedunSentBUAcks=cmiHaRedunSentBUAcks, cmiMrMaAdvEntry=cmiMrMaAdvEntry, ciscoMobileIpMrDiscoveryGroup=ciscoMobileIpMrDiscoveryGroup, ciscoMobileIpMnRegistrationGroup=ciscoMobileIpMnRegistrationGroup, cmiMrStateChange=cmiMrStateChange, ciscoMobileIpTrapObjectsGroup=ciscoMobileIpTrapObjectsGroup, ciscoMobileIpMrNotificationGroup=ciscoMobileIpMrNotificationGroup, cmiFaReverseTunnelBitNotSet=cmiFaReverseTunnelBitNotSet, ciscoMobileIpMrNotificationGroupV3=ciscoMobileIpMrNotificationGroupV3, cmiFaReRegRequestsDenied=cmiFaReRegRequestsDenied, cmiMrRegistration=cmiMrRegistration, cmiHaReverseTunnelUnavailable=cmiHaReverseTunnelUnavailable, cmiHaRegTunnelStatsTable=cmiHaRegTunnelStatsTable, cmiMn=cmiMn, ciscoMobileIpHaMobNetGroup=ciscoMobileIpHaMobNetGroup, cmiSecAlgorithmType=cmiSecAlgorithmType, cmiFaReRegRequestsDiscarded=cmiFaReRegRequestsDiscarded, cmiMrIfID=cmiMrIfID, cmiSecRecentViolationReason=cmiSecRecentViolationReason, cmiTrapObjects=cmiTrapObjects, cmiHaCvsesFromMnRejected=cmiHaCvsesFromMnRejected, cmiSecAlgorithmMode=cmiSecAlgorithmMode, cmiMrIfHaTunnelIfIndex=cmiMrIfHaTunnelIfIndex, cmiSecTotalViolations=cmiSecTotalViolations, cmiMrMobNetAddrType=cmiMrMobNetAddrType, ciscoMobileIpMaRegGroup=ciscoMobileIpMaRegGroup, ciscoMobileIpCompliance=ciscoMobileIpCompliance, cmiMaInterfaceAddressType=cmiMaInterfaceAddressType, cmiMrRegExtendExpire=cmiMrRegExtendExpire, cmiNtRegHomeAddressType=cmiNtRegHomeAddressType, cmiMrMaAdvRcvIf=cmiMrMaAdvRcvIf, cmiFaDeRegRepliesValidRelayToMN=cmiFaDeRegRepliesValidRelayToMN, cmiMrMaIfMacAddress=cmiMrMaIfMacAddress, cmiMrMaAdvTimeFirstHeard=cmiMrMaAdvTimeFirstHeard, cmiHaRedunSentBIAcks=cmiHaRedunSentBIAcks, cmiHaRegMobilityBindingEntry=cmiHaRegMobilityBindingEntry, cmiNtRegHAAddrType=cmiNtRegHAAddrType, cmiMrIfCCoaAddress=cmiMrIfCCoaAddress, cmiHaDeRegRequestsDiscarded=cmiHaDeRegRequestsDiscarded, cmiMaAdvMaxRegLifetime=cmiMaAdvMaxRegLifetime, cmiFaInterfaceEntry=cmiFaInterfaceEntry, cmiNtRegNAI=cmiNtRegNAI, cmiMrSystem=cmiMrSystem, cmiMrRedStatePassive=cmiMrRedStatePassive, cmiFaInitRegRequestsReceived=cmiFaInitRegRequestsReceived, cmiHaInitRegRequestsDiscarded=cmiHaInitRegRequestsDiscarded, cmiHaMobNetTable=cmiHaMobNetTable, cmiMrNewMA=cmiMrNewMA, cmiHaMrDynamic=cmiHaMrDynamic, cmiMrIfStatus=cmiMrIfStatus, cmiFaRegVisitorHomeAgentAddress=cmiFaRegVisitorHomeAgentAddress, cmiHaRegMobilityBindingRegFlags=cmiHaRegMobilityBindingRegFlags, cmiHaRedunDroppedBIAcks=cmiHaRedunDroppedBIAcks, cmiMrIfSolicitRetransLimit=cmiMrIfSolicitRetransLimit, ciscoMobileIpHaRedunGroup=ciscoMobileIpHaRedunGroup, ciscoMobileIpTrapObjectsGroupV2=ciscoMobileIpTrapObjectsGroupV2, CmiSpi=CmiSpi, cmiFaAdvertChallengeWindow=cmiFaAdvertChallengeWindow, ciscoMobileIpComplianceV12R11=ciscoMobileIpComplianceV12R11, cmiHaDeRegRequestsReceived=cmiHaDeRegRequestsReceived, cmiSecPeerIdentifier=cmiSecPeerIdentifier, cmiMrIfRoamPriority=cmiMrIfRoamPriority, cmiHaInitRegRequestsAccepted=cmiHaInitRegRequestsAccepted, cmiMnDiscovery=cmiMnDiscovery, ciscoMobileIpMrNotificationGroupV2=ciscoMobileIpMrNotificationGroupV2, cmiMrIfRegisteredCoA=cmiMrIfRegisteredCoA, ciscoMobileIpSecAssocGroupV12R02=ciscoMobileIpSecAssocGroupV12R02, cmiHaEncapUnavailable=cmiHaEncapUnavailable, cmiFaRegVisitorIdentifierType=cmiFaRegVisitorIdentifierType, cmiFaRegVisitorChallengeValue=cmiFaRegVisitorChallengeValue, ciscoMobileIpFaRegGroupV12R02=ciscoMobileIpFaRegGroupV12R02, CmiEntityIdentifierType=CmiEntityIdentifierType, cmiHaMnHaAuthFailures=cmiHaMnHaAuthFailures, cmiMrDiscovery=cmiMrDiscovery, cmiHaCvsesFromFaRejected=cmiHaCvsesFromFaRejected, cmiSecAssocEntry=cmiSecAssocEntry, cmiMrMaAdvTable=cmiMrMaAdvTable, cmiTrapControl=cmiTrapControl, cmiHaRedunReceivedBIReqs=cmiHaRedunReceivedBIReqs, cmiHaRegTunnelStatsSrcAddrType=cmiHaRegTunnelStatsSrcAddrType, cmiHaRegMnIfPathMetricType=cmiHaRegMnIfPathMetricType, cmiFaReRegRepliesValidRelayToMN=cmiFaReRegRepliesValidRelayToMN, cmiMaAdvAddress=cmiMaAdvAddress, cmiHaRegMobilityBindingMacAddress=cmiHaRegMobilityBindingMacAddress, cmiMaRegDateMaxRegsReceived=cmiMaRegDateMaxRegsReceived, cmiSecViolationEntry=cmiSecViolationEntry, ciscoMobileIpMIB=ciscoMobileIpMIB, cmiFaReg=cmiFaReg, cmiMaReg=cmiMaReg, cmiFaTotalRegReplies=cmiFaTotalRegReplies, cmiFaAdvertChallengeEntry=cmiFaAdvertChallengeEntry, cmiFaUnknownChallenge=cmiFaUnknownChallenge, cmiMrMaAdvTimeReceived=cmiMrMaAdvTimeReceived, cmiMrIfCCoaEnable=cmiMrIfCCoaEnable, cmiMrRegNewHa=cmiMrRegNewHa, cmiHaRegMaxProcLocInMinRegs=cmiHaRegMaxProcLocInMinRegs, cmiHaRegTunnelStatsOutPktRate=cmiHaRegTunnelStatsOutPktRate, cmiMRIfDescription=cmiMRIfDescription, cmiHaMaxBindingsNotif=cmiHaMaxBindingsNotif, ciscoMobileIpHaRegGroup=ciscoMobileIpHaRegGroup, cmiHaDeRegRequestsDenied=cmiHaDeRegRequestsDenied, cmiHaRegProcAAAInLastByMinRegs=cmiHaRegProcAAAInLastByMinRegs, CmiMultiPathMetricType=CmiMultiPathMetricType, cmiMnRecentAdvReceived=cmiMnRecentAdvReceived, cmiMrMobNetPfxLen=cmiMrMobNetPfxLen, cmiFaReverseTunnelUnavailable=cmiFaReverseTunnelUnavailable, cmiHaNvsesFromFaNeglected=cmiHaNvsesFromFaNeglected, cmiNtRegCOA=cmiNtRegCOA, cmiNtRegCOAType=cmiNtRegCOAType, cmiSecRecentViolationTime=cmiSecRecentViolationTime, cmiHaRegIntervalSize=cmiHaRegIntervalSize, CmiRegistrationFlags=CmiRegistrationFlags, cmiHaRegMnIfBandwidth=cmiHaRegMnIfBandwidth)
mibBuilder.exportSymbols("CISCO-MOBILE-IP-MIB", cmiMaInterfaceAddress=cmiMaInterfaceAddress, cmiMrMultiPathMetricType=cmiMrMultiPathMetricType, cmiMrMaAdvMaxRegLifetime=cmiMrMaAdvMaxRegLifetime, cmiHaInitRegRequestsDenied=cmiHaInitRegRequestsDenied, ciscoMobileIpMIBConformance=ciscoMobileIpMIBConformance, cmiHaRegServAcceptedRequests=cmiHaRegServAcceptedRequests, cmiFaAdvertIsBusy=cmiFaAdvertIsBusy, cmiFaMnFaAuthFailures=cmiFaMnFaAuthFailures, cmiMa=cmiMa, cmiFaReRegRequestsReceived=cmiFaReRegRequestsReceived, cmiMrRegExtendRetry=cmiMrRegExtendRetry, cmiHaMobNetStatus=cmiHaMobNetStatus, ciscoMobileIpHaRegGroupV12R03r1=ciscoMobileIpHaRegGroupV12R03r1, cmiMrReverseTunnel=cmiMrReverseTunnel, cmiHaRegCounterEntry=cmiHaRegCounterEntry, cmiHaRegTunnelStatsInBitRate=cmiHaRegTunnelStatsInBitRate, ciscoMobileIpHaRegGroupV12R03r2=ciscoMobileIpHaRegGroupV12R03r2, cmiHaRegRequestsDenied=cmiHaRegRequestsDenied, ciscoMobileIpMnDiscoveryGroup=ciscoMobileIpMnDiscoveryGroup, cmiFaInitRegRepliesValidRelayMN=cmiFaInitRegRepliesValidRelayMN, cmiMaAdvMaxAdvLifetime=cmiMaAdvMaxAdvLifetime, cmiFaAdvertChallengeTable=cmiFaAdvertChallengeTable, cmiHaRegRequestsDiscarded=cmiHaRegRequestsDiscarded, ciscoMobileIpFaRegGroupV12R03=ciscoMobileIpFaRegGroupV12R03, cmiMnAdvFlags=cmiMnAdvFlags, cmiHaMrAddrType=cmiHaMrAddrType, cmiFaReRegRequestsRelayed=cmiFaReRegRequestsRelayed, cmiHaMobNetAddressType=cmiHaMobNetAddressType, cmiMrMaAdvLifetimeRemaining=cmiMrMaAdvLifetimeRemaining, cmiHaMrEntry=cmiHaMrEntry, cmiHaMrStatus=cmiHaMrStatus, cmiMrMobNetAddr=cmiMrMobNetAddr, ciscoMobileIpComplianceV12R06=ciscoMobileIpComplianceV12R06, ciscoMobileIpHaRegGroupV12R02=ciscoMobileIpHaRegGroupV12R02, ciscoMobileIpHaRegGroupV12R03=ciscoMobileIpHaRegGroupV12R03, cmiFaTotalRegRequests=cmiFaTotalRegRequests, cmiHaRegOverallServTime=cmiHaRegOverallServTime, cmiHaRegRequestsReceived=cmiHaRegRequestsReceived, cmiMaAdvInterfaceIndex=cmiMaAdvInterfaceIndex, cmiMrIfIndex=cmiMrIfIndex, cmiHaMobNetDynamic=cmiHaMobNetDynamic, cmiFaCoaTransmitOnly=cmiFaCoaTransmitOnly, cmiSecSPI=cmiSecSPI, cmiSecAssocTable=cmiSecAssocTable, cmiMrIfCCoaDefaultGw=cmiMrIfCCoaDefaultGw, cmiMrMaAdvSequence=cmiMrMaAdvSequence, cmiMrBetterIfDetected=cmiMrBetterIfDetected, cmiHaRedunSentBUs=cmiHaRedunSentBUs, ciscoMobileIpMIBNotifications=ciscoMobileIpMIBNotifications, cmiMaRegMaxInMinuteRegs=cmiMaRegMaxInMinuteRegs, cmiFaAdvertChallengeChapSPI=cmiFaAdvertChallengeChapSPI, cmiHaMobNet=cmiHaMobNet, cmiFaCoaRegAsymLink=cmiFaCoaRegAsymLink, cmiHaRegMnIdentifier=cmiHaRegMnIdentifier, ciscoMobileIpHaRegIntervalStatsGroup=ciscoMobileIpHaRegIntervalStatsGroup, cmiMrIfTable=cmiMrIfTable, cmiMrMaAddressType=cmiMrMaAddressType, cmiFaInitRegRequestsDenied=cmiFaInitRegRequestsDenied, CmiEntityIdentifier=CmiEntityIdentifier, cmiNtRegHomeAddress=cmiNtRegHomeAddress, ciscoMobileIpFaSystemGroup=ciscoMobileIpFaSystemGroup, cmiMrTunnelBytesSent=cmiMrTunnelBytesSent, cmiHaRedunTotalSentBIReqs=cmiHaRedunTotalSentBIReqs, cmiFaRegVisitorRegFlags=cmiFaRegVisitorRegFlags, cmiMrRegRetransMax=cmiMrRegRetransMax, ciscoMobileIpComplianceRev2=ciscoMobileIpComplianceRev2, cmiHaMaximumBindings=cmiHaMaximumBindings, cmiHaReRegRequestsReceived=cmiHaReRegRequestsReceived, cmiHaRedunTotalSentBUs=cmiHaRedunTotalSentBUs, cmiMnRegFlags=cmiMnRegFlags, cmiHaMobNetEntry=cmiHaMobNetEntry, cmiHaRegAvgTimeRegsProcByAAA=cmiHaRegAvgTimeRegsProcByAAA, cmiHaSystemVersion=cmiHaSystemVersion, cmiMrMultiPath=cmiMrMultiPath, cmiFaRegVisitorTimeRemaining=cmiFaRegVisitorTimeRemaining, cmiMrHATable=cmiMrHATable, cmiHaRegMobilityBindingTable=cmiHaRegMobilityBindingTable, cmiHaRegTunnelStatsInPkts=cmiHaRegTunnelStatsInPkts, cmiHaInitRegRequestsReceived=cmiHaInitRegRequestsReceived, cmiFaCoaEntry=cmiFaCoaEntry, ciscoMobileIpHaSystemGroupV1=ciscoMobileIpHaSystemGroupV1, ciscoMobileIpFaRegGroupV12R03r2=ciscoMobileIpFaRegGroupV12R03r2, ciscoMobileIpComplianceV12R05=ciscoMobileIpComplianceV12R05, cmiSecViolationTable=cmiSecViolationTable, cmiFaRegVisitorIdentifier=cmiFaRegVisitorIdentifier, cmiHaRegTunnelStatsSrcAddr=cmiHaRegTunnelStatsSrcAddr, cmiFaRegTotalVisitors=cmiFaRegTotalVisitors, cmiHaReRegRequestsDiscarded=cmiHaReRegRequestsDiscarded, cmiHaRegMnIdentifierType=cmiHaRegMnIdentifierType, cmiFaRegVisitorRegFlagsRev1=cmiFaRegVisitorRegFlagsRev1, cmiHaRegMnIdType=cmiHaRegMnIdType, ciscoMobileIpHaRegGroupV12R03r2Sup1=ciscoMobileIpHaRegGroupV12R03r2Sup1, cmiHaMrMultiPathMetricType=cmiHaMrMultiPathMetricType, cmiSecKey2=cmiSecKey2, cmiHaRegMaxProcByAAAInMinRegs=cmiHaRegMaxProcByAAAInMinRegs, cmiFaAdvertRegRequired=cmiFaAdvertRegRequired, ciscoMobileIpGroups=ciscoMobileIpGroups, cmiHaRedun=cmiHaRedun, cmiMaAdvResponseSolicitationOnly=cmiMaAdvResponseSolicitationOnly, cmiMaRegInLastMinuteRegs=cmiMaRegInLastMinuteRegs, cmiHaRegTotalMobilityBindings=cmiHaRegTotalMobilityBindings, cmiFaInitRegRepliesValidFromHA=cmiFaInitRegRepliesValidFromHA, cmiHaRegTunnelStatsDataRateInt=cmiHaRegTunnelStatsDataRateInt, cmiHaMrAddr=cmiHaMrAddr, cmiFaInterfaceTable=cmiFaInterfaceTable, cmiMrRegRetransLimit=cmiMrRegRetransLimit, cmiMrMobNetTable=cmiMrMobNetTable, cmiMrHAPriority=cmiMrHAPriority, cmiFaRegVisitorRegIsAccepted=cmiFaRegVisitorRegIsAccepted, cmiSecStatus=cmiSecStatus, ciscoMobileIpComplianceV12R09=ciscoMobileIpComplianceV12R09, ciscoMobileIpMrSystemGroup=ciscoMobileIpMrSystemGroup, cmiHaReg=cmiHaReg, cmiSecurity=cmiSecurity, cmiFaCoaInterfaceOnly=cmiFaCoaInterfaceOnly, cmiHaRedunSentBIReqs=cmiHaRedunSentBIReqs, cmiHaRedunReceivedBIAcks=cmiHaRedunReceivedBIAcks, cmiNtRegHomeAgent=cmiNtRegHomeAgent, ciscoMobileIpMIBObjects=ciscoMobileIpMIBObjects, cmiHaRegRecentServDeniedCode=cmiHaRegRecentServDeniedCode, cmiHaMobNetPfxLen=cmiHaMobNetPfxLen, cmiFaDeRegRequestsReceived=cmiFaDeRegRequestsReceived, ciscoMobileIpFaRegGroup=ciscoMobileIpFaRegGroup, cmiFaRevTunnelSupported=cmiFaRevTunnelSupported, cmiHaMnAAAAuthFailures=cmiHaMnAAAAuthFailures, cmiFaDeRegRequestsRelayed=cmiFaDeRegRequestsRelayed, cmiHaRedunFailedBIReps=cmiHaRedunFailedBIReps, cmiHaRegTotalProcByAAARegs=cmiHaRegTotalProcByAAARegs, ciscoMobileIpHaMobNetGroupSup1=ciscoMobileIpHaMobNetGroupSup1, ciscoMobileIpComplianceV12R03r1=ciscoMobileIpComplianceV12R03r1, cmiMrMobNetIfIndex=cmiMrMobNetIfIndex, cmiFaRegVisitorHomeAddress=cmiFaRegVisitorHomeAddress, cmiHaRegIntervalWimaxMaxActiveBindings=cmiHaRegIntervalWimaxMaxActiveBindings, cmiMrIfSolicitRetransRemaining=cmiMrIfSolicitRetransRemaining, cmiMrIfCCoaOnly=cmiMrIfCCoaOnly, cmiMrIfSolicitRetransCurrent=cmiMrIfSolicitRetransCurrent, cmiHaRegTunnelStatsOutBytes=cmiHaRegTunnelStatsOutBytes, cmiHaRegTunnelStatsTunnelType=cmiHaRegTunnelStatsTunnelType, cmiHaReverseTunnelBitNotSet=cmiHaReverseTunnelBitNotSet, ciscoMobileIpComplianceRev1=ciscoMobileIpComplianceRev1, cmiHaRedunReceivedBUs=cmiHaRedunReceivedBUs, cmiMrRegExtendInterval=cmiMrRegExtendInterval, cmiHaMrMultiPath=cmiHaMrMultiPath, ciscoMobileIpFaAdvertisementGroup=ciscoMobileIpFaAdvertisementGroup, ciscoMobileIpMrSystemGroupV2=ciscoMobileIpMrSystemGroupV2, cmiMrIfCCoaRegRetry=cmiMrIfCCoaRegRetry, cmiMrIfHoldDown=cmiMrIfHoldDown, cmiMrIfCCoaRegRetryRemaining=cmiMrIfCCoaRegRetryRemaining, ciscoMobileIpHaRegTunnelStatsGroup=ciscoMobileIpHaRegTunnelStatsGroup, cmiHaRegProcLocInLastMinRegs=cmiHaRegProcLocInLastMinRegs, cmiMrMaAdvMaxLifetime=cmiMrMaAdvMaxLifetime, cmiMrCoaChange=cmiMrCoaChange, cmiSecViolatorIdentifier=cmiSecViolatorIdentifier)
