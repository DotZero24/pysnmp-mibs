...
mibBuilder.exportSymbols("CISCO-NTP-MIB", ciscoNtpMIB=ciscoNtpMIB, cntpPeersOffset=cntpPeersOffset, cntpPeersConfigured=cntpPeersConfigured, ciscoNtpPeersGroupRev2=ciscoNtpPeersGroupRev2, cntpPeersReceiveTime=cntpPeersReceiveTime, ciscoNtpPeerExtGroup=ciscoNtpPeerExtGroup, cntpPeersHostAddress=cntpPeersHostAddress, cntpPeersReach=cntpPeersReach, cntpPeersPeerName=cntpPeersPeerName, cntpFilter=cntpFilter, cntpPeersEntryStatus=cntpPeersEntryStatus, cntpPeersPrefPeer=cntpPeersPrefPeer, cntpPeersTransmitTime=cntpPeersTransmitTime, cntpPeersUpdateTimeRev1=cntpPeersUpdateTimeRev1, cntpSysPoll=cntpSysPoll, NTPRefId=NTPRefId, ciscoNtpMIBComplianceRev2=ciscoNtpMIBComplianceRev2, ciscoNtpMIBComplianceRev1=ciscoNtpMIBComplianceRev1, cntpPeersVarEntry=cntpPeersVarEntry, ciscoNtpMIBCompliances=ciscoNtpMIBCompliances, ciscoNtpGeneralConnFailure=ciscoNtpGeneralConnFailure, cntpPeersDispersion=cntpPeersDispersion, cntpPeersOrgTime=cntpPeersOrgTime, ciscoNtpMIBComplianceRev4=ciscoNtpMIBComplianceRev4, ciscoNtpMIBCompliance=ciscoNtpMIBCompliance, ciscoNtpMIBObjects=ciscoNtpMIBObjects, ciscoNtpHighPriorityConnRestore=ciscoNtpHighPriorityConnRestore, cntpPeersPrecision=cntpPeersPrecision, cntpPeersPeerPort=cntpPeersPeerPort, ciscoNtpSysExtGroup=ciscoNtpSysExtGroup, NTPUnsignedTimeValue=NTPUnsignedTimeValue, cntpPeersRootDelay=cntpPeersRootDelay, cntpPeersHostPoll=cntpPeersHostPoll, ciscoNtpSysGroup=ciscoNtpSysGroup, cntpSysRefTime=cntpSysRefTime, cntpPeersPeerAddress=cntpPeersPeerAddress, ciscoNtpMIBComplianceRev3=ciscoNtpMIBComplianceRev3, cntpSysPrecision=cntpSysPrecision, cntpPeersPeerType=cntpPeersPeerType, NTPAssocIdentifier=NTPAssocIdentifier, cntpPeersDelay=cntpPeersDelay, cntpFilterIndex=cntpFilterIndex, cntpSysSrvStatus=cntpSysSrvStatus, ciscoNtpMIBConformance=ciscoNtpMIBConformance, ciscoNtpMIBNotifs=ciscoNtpMIBNotifs, NTPSignedTimeValue=NTPSignedTimeValue, cntpPeersVarTable=cntpPeersVarTable, cntpFilterRegisterEntry=cntpFilterRegisterEntry, NTPLeapIndicator=NTPLeapIndicator, cntpPeersRefTime=cntpPeersRefTime, cntpFilterPeersOffset=cntpFilterPeersOffset, ciscoNtpSrvStatusChange=ciscoNtpSrvStatusChange, cntpPeersMode=cntpPeersMode, cntpPeersUpdateTime=cntpPeersUpdateTime, cntpPeersTimer=cntpPeersTimer, cntpSysLeap=cntpSysLeap, cntpFilterPeersDispersion=cntpFilterPeersDispersion, cntpSysClock=cntpSysClock, ciscoNtpSrvNotifGroup=ciscoNtpSrvNotifGroup, NTPTimeStamp=NTPTimeStamp, ciscoNtpPeersGroupRev1=ciscoNtpPeersGroupRev1, cntpSysStratum=cntpSysStratum, cntpFilterPeersDelay=cntpFilterPeersDelay, cntpPeersAssocId=cntpPeersAssocId, NTPPollInterval=NTPPollInterval, cntpPeersStratum=cntpPeersStratum, cntpSysRootDispersion=cntpSysRootDispersion, cntpSysPeer=cntpSysPeer, cntpPeers=cntpPeers, PYSNMP_MODULE_ID=ciscoNtpMIB, cntpPeersRefId=cntpPeersRefId, ciscoNtpPeersGroup=ciscoNtpPeersGroup, cntpPeersLeap=cntpPeersLeap, cntpSysRefId=cntpSysRefId, NTPStratum=NTPStratum, ciscoNtpFilterGroup=ciscoNtpFilterGroup, cntpSysRootDelay=cntpSysRootDelay, ciscoNtpGeneralConnRestore=ciscoNtpGeneralConnRestore, cntpPeersHostPort=cntpPeersHostPort, cntpSystem=cntpSystem, cntpPeersFilterValidEntries=cntpPeersFilterValidEntries, ciscoNtpHighPriorityConnFailure=ciscoNtpHighPriorityConnFailure, ciscoNtpMIBGroups=ciscoNtpMIBGroups, cntpFilterRegisterTable=cntpFilterRegisterTable, cntpPeersPeerPoll=cntpPeersPeerPoll, cntpPeersRootDispersion=cntpPeersRootDispersion)
