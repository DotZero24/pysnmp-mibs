...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-NTP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:57 2025
...
_CntpPeersPrefPeer_Type.__name__ = "TruthValue"
...
_CntpPeersPeerType_Type.__name__ = "InetAddressType"
...
ciscoNtpMIBCompliance.setObjects(
      *(("CISCO-NTP-MIB", "ciscoNtpSysGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpPeersGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpFilterGroup"))
)
if mibBuilder.loadTexts:
...
ciscoNtpMIBComplianceRev1.setObjects(
      *(("CISCO-NTP-MIB", "ciscoNtpSysGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpPeersGroupRev1"),
        ("CISCO-NTP-MIB", "ciscoNtpFilterGroup"))
)
if mibBuilder.loadTexts:
...
ciscoNtpMIBComplianceRev2.setObjects(
      *(("CISCO-NTP-MIB", "ciscoNtpSysGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpPeersGroupRev1"),
        ("CISCO-NTP-MIB", "ciscoNtpFilterGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpPeerExtGroup"))
)
if mibBuilder.loadTexts:
...
ciscoNtpMIBComplianceRev3.setObjects(
      *(("CISCO-NTP-MIB", "ciscoNtpSysGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpPeersGroupRev2"),
        ("CISCO-NTP-MIB", "ciscoNtpFilterGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpPeerExtGroup"))
)
if mibBuilder.loadTexts:
...
ciscoNtpMIBComplianceRev4.setObjects(
      *(("CISCO-NTP-MIB", "ciscoNtpSysGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpPeersGroupRev2"),
        ("CISCO-NTP-MIB", "ciscoNtpFilterGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpPeerExtGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpSysExtGroup"),
        ("CISCO-NTP-MIB", "ciscoNtpSrvNotifGroup"))
)
if mibBuilder.loadTexts:
