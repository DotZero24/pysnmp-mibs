...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-NTP-MIB
...
mibBuilder.exportSymbols("CISCO-NTP-MIB", NTPTimeStamp=NTPTimeStamp, ciscoNtpHighPriorityConnFailure=ciscoNtpHighPriorityConnFailure, ciscoNtpMIBObjects=ciscoNtpMIBObjects, NTPStratum=NTPStratum, cntpPeersRootDelay=cntpPeersRootDelay, ciscoNtpPeersGroupRev1=ciscoNtpPeersGroupRev1, PYSNMP_MODULE_ID=ciscoNtpMIB, cntpPeersConfigured=cntpPeersConfigured, cntpPeersLeap=cntpPeersLeap, cntpPeersUpdateTime=cntpPeersUpdateTime, cntpPeersTimer=cntpPeersTimer, NTPSignedTimeValue=NTPSignedTimeValue, cntpFilter=cntpFilter, ciscoNtpMIBComplianceRev4=ciscoNtpMIBComplianceRev4, cntpSysRootDispersion=cntpSysRootDispersion, cntpSysLeap=cntpSysLeap, ciscoNtpSysGroup=ciscoNtpSysGroup, cntpFilterIndex=cntpFilterIndex, cntpSysRefId=cntpSysRefId, cntpSysPoll=cntpSysPoll, cntpSystem=cntpSystem, ciscoNtpPeersGroup=ciscoNtpPeersGroup, NTPAssocIdentifier=NTPAssocIdentifier, cntpPeersPeerName=cntpPeersPeerName, cntpPeersFilterValidEntries=cntpPeersFilterValidEntries, ciscoNtpFilterGroup=ciscoNtpFilterGroup, cntpSysPrecision=cntpSysPrecision, cntpPeersPeerType=cntpPeersPeerType, cntpPeersRootDispersion=cntpPeersRootDispersion, ciscoNtpPeerExtGroup=ciscoNtpPeerExtGroup, cntpSysStratum=cntpSysStratum, cntpPeersVarEntry=cntpPeersVarEntry, ciscoNtpMIBCompliances=ciscoNtpMIBCompliances, ciscoNtpSysExtGroup=ciscoNtpSysExtGroup, cntpPeersTransmitTime=cntpPeersTransmitTime, cntpFilterPeersDelay=cntpFilterPeersDelay, ciscoNtpMIBComplianceRev3=ciscoNtpMIBComplianceRev3, ciscoNtpMIBComplianceRev2=ciscoNtpMIBComplianceRev2, cntpSysSrvStatus=cntpSysSrvStatus, cntpFilterRegisterTable=cntpFilterRegisterTable, cntpPeersAssocId=cntpPeersAssocId, ciscoNtpGeneralConnFailure=ciscoNtpGeneralConnFailure, cntpSysRootDelay=cntpSysRootDelay, ciscoNtpSrvStatusChange=ciscoNtpSrvStatusChange, cntpSysClock=cntpSysClock, cntpPeersRefId=cntpPeersRefId, cntpPeersPeerPort=cntpPeersPeerPort, cntpPeersPrecision=cntpPeersPrecision, ciscoNtpPeersGroupRev2=ciscoNtpPeersGroupRev2, ciscoNtpMIBNotifs=ciscoNtpMIBNotifs, cntpPeersPeerPoll=cntpPeersPeerPoll, cntpPeersReach=cntpPeersReach, cntpPeersDispersion=cntpPeersDispersion, cntpSysRefTime=cntpSysRefTime, cntpPeersRefTime=cntpPeersRefTime, cntpSysPeer=cntpSysPeer, cntpPeersDelay=cntpPeersDelay, cntpPeersMode=cntpPeersMode, cntpPeersOrgTime=cntpPeersOrgTime, cntpFilterRegisterEntry=cntpFilterRegisterEntry, NTPRefId=NTPRefId, ciscoNtpMIBConformance=ciscoNtpMIBConformance, cntpPeersUpdateTimeRev1=cntpPeersUpdateTimeRev1, ciscoNtpHighPriorityConnRestore=ciscoNtpHighPriorityConnRestore, cntpPeersPeerAddress=cntpPeersPeerAddress, cntpPeersOffset=cntpPeersOffset, cntpPeersVarTable=cntpPeersVarTable, ciscoNtpGeneralConnRestore=ciscoNtpGeneralConnRestore, cntpFilterPeersOffset=cntpFilterPeersOffset, cntpPeersHostPort=cntpPeersHostPort, NTPUnsignedTimeValue=NTPUnsignedTimeValue, ciscoNtpSrvNotifGroup=ciscoNtpSrvNotifGroup, ciscoNtpMIBCompliance=ciscoNtpMIBCompliance, cntpPeersEntryStatus=cntpPeersEntryStatus, ciscoNtpMIBComplianceRev1=ciscoNtpMIBComplianceRev1, NTPLeapIndicator=NTPLeapIndicator, cntpPeers=cntpPeers, cntpPeersReceiveTime=cntpPeersReceiveTime, cntpPeersHostAddress=cntpPeersHostAddress, cntpPeersStratum=cntpPeersStratum, cntpPeersHostPoll=cntpPeersHostPoll, cntpFilterPeersDispersion=cntpFilterPeersDispersion, NTPPollInterval=NTPPollInterval, ciscoNtpMIB=ciscoNtpMIB, cntpPeersPrefPeer=cntpPeersPrefPeer, ciscoNtpMIBGroups=ciscoNtpMIBGroups)
