_v='myTemperatureWarningGroup'
_u='myTemperatureWarningDescGroup'
_t='myFanStateGroup'
_s='myPowerStateGroup'
_r='myModuleTempStateGroup'
_q='myDeviceMIBNotificationGroup'
_p='myEntityChgDescGroup'
_o='myOptionalDevInfoMIBGroup'
_n='myModuleInfoMIBGroup'
_m='myDeviceInfoMIBGroup'
_l='myTemperatureWarning'
_k='myEntityStatusChange'
_j='myFanStateFanDescr'
_i='myFanState'
_h='myPowerStatePowerDescr'
_g='myPowerState'
...
myDeviceMIBObjects=_MyDeviceMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,21,1))
_MyDeviceMaxNumber_Type=Integer32
_MyDeviceMaxNumber_Object=MibScalar
myDeviceMaxNumber=_MyDeviceMaxNumber_Object((1,3,6,1,4,1,171,10,97,2,21,1,1),_MyDeviceMaxNumber_Type())
...
myDeviceInfoTable=_MyDeviceInfoTable_Object((1,3,6,1,4,1,171,10,97,2,21,1,2))
if mibBuilder.loadTexts:myDeviceInfoTable.setStatus(_B)
_MyDeviceInfoEntry_Object=MibTableRow
myDeviceInfoEntry=_MyDeviceInfoEntry_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1))
...
myDeviceInfoIndex=_MyDeviceInfoIndex_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1,1),_MyDeviceInfoIndex_Type())
...
myDeviceInfoDescr=_MyDeviceInfoDescr_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1,2),_MyDeviceInfoDescr_Type())
...
myDeviceInfoSlotNumber=_MyDeviceInfoSlotNumber_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1,3),_MyDeviceInfoSlotNumber_Type())
...
myDevicePowerStatus=_MyDevicePowerStatus_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1,4),_MyDevicePowerStatus_Type())
...
myDeviceMacAddress=_MyDeviceMacAddress_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1,5),_MyDeviceMacAddress_Type())
...
myDevicePriority=_MyDevicePriority_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1,6),_MyDevicePriority_Type())
...
myDeviceAlias=_MyDeviceAlias_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1,7),_MyDeviceAlias_Type())
...
myDeviceSWVersion=_MyDeviceSWVersion_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1,8),_MyDeviceSWVersion_Type())
...
myDeviceHWVersion=_MyDeviceHWVersion_Object((1,3,6,1,4,1,171,10,97,2,21,1,2,1,9),_MyDeviceHWVersion_Type())
myDeviceHWVersion.setMaxAccess(_C)
if mibBuilder.loadTexts:myDeviceHWVersion.setStatus(_B)
_MySlotInfoTable_Object=MibTable
mySlotInfoTable=_MySlotInfoTable_Object((1,3,6,1,4,1,171,10,97,2,21,1,3))
if mibBuilder.loadTexts:mySlotInfoTable.setStatus(_B)
_MySlotInfoEntry_Object=MibTableRow
mySlotInfoEntry=_MySlotInfoEntry_Object((1,3,6,1,4,1,171,10,97,2,21,1,3,1))
...
mySlotInfoDeviceIndex=_MySlotInfoDeviceIndex_Object((1,3,6,1,4,1,171,10,97,2,21,1,3,1,1),_MySlotInfoDeviceIndex_Type())
...
mySlotInfoIndex=_MySlotInfoIndex_Object((1,3,6,1,4,1,171,10,97,2,21,1,3,1,2),_MySlotInfoIndex_Type())
...
mySlotModuleInfoDescr=_MySlotModuleInfoDescr_Object((1,3,6,1,4,1,171,10,97,2,21,1,3,1,3),_MySlotModuleInfoDescr_Type())
...
mySlotInfoPortNumber=_MySlotInfoPortNumber_Object((1,3,6,1,4,1,171,10,97,2,21,1,3,1,4),_MySlotInfoPortNumber_Type())
...
mySlotInfoPortMaxNumber=_MySlotInfoPortMaxNumber_Object((1,3,6,1,4,1,171,10,97,2,21,1,3,1,5),_MySlotInfoPortMaxNumber_Type())
...
mySlotInfoDesc=_MySlotInfoDesc_Object((1,3,6,1,4,1,171,10,97,2,21,1,3,1,6),_MySlotInfoDesc_Type())
mySlotInfoDesc.setMaxAccess(_C)
if mibBuilder.loadTexts:mySlotInfoDesc.setStatus(_B)
_MyModuleTempStateTable_Object=MibTable
myModuleTempStateTable=_MyModuleTempStateTable_Object((1,3,6,1,4,1,171,10,97,2,21,1,4))
if mibBuilder.loadTexts:myModuleTempStateTable.setStatus(_B)
_MyModuleTempStateEntry_Object=MibTableRow
myModuleTempStateEntry=_MyModuleTempStateEntry_Object((1,3,6,1,4,1,171,10,97,2,21,1,4,1))
...
myModuleTempStateDeviceIndex=_MyModuleTempStateDeviceIndex_Object((1,3,6,1,4,1,171,10,97,2,21,1,4,1,1),_MyModuleTempStateDeviceIndex_Type())
...
myModuleTempStateIndex=_MyModuleTempStateIndex_Object((1,3,6,1,4,1,171,10,97,2,21,1,4,1,2),_MyModuleTempStateIndex_Type())
...
myModuleTempState=_MyModuleTempState_Object((1,3,6,1,4,1,171,10,97,2,21,1,4,1,3),_MyModuleTempState_Type())
...
myPowerStateTable=_MyPowerStateTable_Object((1,3,6,1,4,1,171,10,97,2,21,1,5))
if mibBuilder.loadTexts:myPowerStateTable.setStatus(_B)
_MyPowerStateEntry_Object=MibTableRow
myPowerStateEntry=_MyPowerStateEntry_Object((1,3,6,1,4,1,171,10,97,2,21,1,5,1))
...
myPowerStateDeviceIndex=_MyPowerStateDeviceIndex_Object((1,3,6,1,4,1,171,10,97,2,21,1,5,1,1),_MyPowerStateDeviceIndex_Type())
...
myPowerStateIndex=_MyPowerStateIndex_Object((1,3,6,1,4,1,171,10,97,2,21,1,5,1,2),_MyPowerStateIndex_Type())
...
myPowerState=_MyPowerState_Object((1,3,6,1,4,1,171,10,97,2,21,1,5,1,3),_MyPowerState_Type())
myPowerState.setMaxAccess(_C)
if mibBuilder.loadTexts:myPowerState.setStatus(_B)
class _MyPowerStatePowerDescr_Type(DisplayString):subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,32))
_MyPowerStatePowerDescr_Type.__name__=_D
_MyPowerStatePowerDescr_Object=MibTableColumn
myPowerStatePowerDescr=_MyPowerStatePowerDescr_Object((1,3,6,1,4,1,171,10,97,2,21,1,5,1,4),_MyPowerStatePowerDescr_Type())
myPowerStatePowerDescr.setMaxAccess(_C)
if mibBuilder.loadTexts:myPowerStatePowerDescr.setStatus(_B)
_MyFanStateTable_Object=MibTable
myFanStateTable=_MyFanStateTable_Object((1,3,6,1,4,1,171,10,97,2,21,1,6))
if mibBuilder.loadTexts:myFanStateTable.setStatus(_B)
_MyFanStateEntry_Object=MibTableRow
myFanStateEntry=_MyFanStateEntry_Object((1,3,6,1,4,1,171,10,97,2,21,1,6,1))
...
myFanStateDeviceIndex=_MyFanStateDeviceIndex_Object((1,3,6,1,4,1,171,10,97,2,21,1,6,1,1),_MyFanStateDeviceIndex_Type())
...
myFanStateIndex=_MyFanStateIndex_Object((1,3,6,1,4,1,171,10,97,2,21,1,6,1,2),_MyFanStateIndex_Type())
...
myFanState=_MyFanState_Object((1,3,6,1,4,1,171,10,97,2,21,1,6,1,3),_MyFanState_Type())
myFanState.setMaxAccess(_C)
if mibBuilder.loadTexts:myFanState.setStatus(_B)
class _MyFanStateFanDescr_Type(DisplayString):subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,32))
_MyFanStateFanDescr_Type.__name__=_D
_MyFanStateFanDescr_Object=MibTableColumn
myFanStateFanDescr=_MyFanStateFanDescr_Object((1,3,6,1,4,1,171,10,97,2,21,1,6,1,4),_MyFanStateFanDescr_Type())
myFanStateFanDescr.setMaxAccess(_C)
if mibBuilder.loadTexts:myFanStateFanDescr.setStatus(_B)
_MyEntityMIBTraps_ObjectIdentity=ObjectIdentity
myEntityMIBTraps=_MyEntityMIBTraps_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,21,2))
_MyEntityStateChgDesc_Type=DisplayString
_MyEntityStateChgDesc_Object=MibScalar
myEntityStateChgDesc=_MyEntityStateChgDesc_Object((1,3,6,1,4,1,171,10,97,2,21,2,1),_MyEntityStateChgDesc_Type())
myEntityStateChgDesc.setMaxAccess(_R)
if mibBuilder.loadTexts:myEntityStateChgDesc.setStatus(_B)
class _MyTemperatureWarningDesc_Type(DisplayString):subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(0,255))
_MyTemperatureWarningDesc_Type.__name__=_D
_MyTemperatureWarningDesc_Object=MibScalar
myTemperatureWarningDesc=_MyTemperatureWarningDesc_Object((1,3,6,1,4,1,171,10,97,2,21,2,3),_MyTemperatureWarningDesc_Type())
...
myDeviceMIBConformance=_MyDeviceMIBConformance_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,21,3))
_MyDeviceMIBCompliances_ObjectIdentity=ObjectIdentity
myDeviceMIBCompliances=_MyDeviceMIBCompliances_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,21,3,1))
_MyDeviceMIBGroups_ObjectIdentity=ObjectIdentity
myDeviceMIBGroups=_MyDeviceMIBGroups_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,21,3,2))
myDeviceInfoMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,1))
myDeviceInfoMIBGroup.setObjects(*((_A,_S),(_A,_F),(_A,_T),(_A,_U),(_A,_V)))
if mibBuilder.loadTexts:myDeviceInfoMIBGroup.setStatus(_B)
myOptionalDevInfoMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,2))
...
myModuleInfoMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,3))
...
myEntityChgDescGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,4))
myEntityChgDescGroup.setObjects((_A,_O))
if mibBuilder.loadTexts:myEntityChgDescGroup.setStatus(_B)
myModuleTempStateGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,6))
myModuleTempStateGroup.setObjects(*((_A,_I),(_A,_J),(_A,_f)))
if mibBuilder.loadTexts:myModuleTempStateGroup.setStatus(_B)
myPowerStateGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,7))
myPowerStateGroup.setObjects(*((_A,_K),(_A,_L),(_A,_g),(_A,_h)))
if mibBuilder.loadTexts:myPowerStateGroup.setStatus(_B)
myFanStateGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,8))
myFanStateGroup.setObjects(*((_A,_M),(_A,_N),(_A,_i),(_A,_j)))
if mibBuilder.loadTexts:myFanStateGroup.setStatus(_B)
myTemperatureWarningDescGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,9))
myTemperatureWarningDescGroup.setObjects((_A,_P))
if mibBuilder.loadTexts:myTemperatureWarningDescGroup.setStatus(_B)
myEntityStatusChange=NotificationType((1,3,6,1,4,1,171,10,97,2,21,2,2))
myEntityStatusChange.setObjects((_A,_O))
if mibBuilder.loadTexts:myEntityStatusChange.setStatus(_B)
myTemperatureWarning=NotificationType((1,3,6,1,4,1,171,10,97,2,21,2,4))
myTemperatureWarning.setObjects((_A,_P))
if mibBuilder.loadTexts:myTemperatureWarning.setStatus(_B)
myDeviceMIBNotificationGroup=NotificationGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,5))
myDeviceMIBNotificationGroup.setObjects((_A,_k))
if mibBuilder.loadTexts:myDeviceMIBNotificationGroup.setStatus(_B)
myTemperatureWarningGroup=NotificationGroup((1,3,6,1,4,1,171,10,97,2,21,3,2,10))
myTemperatureWarningGroup.setObjects((_A,_l))
if mibBuilder.loadTexts:myTemperatureWarningGroup.setStatus(_B)
myDeviceMIBCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,97,2,21,3,1,1))
myDeviceMIBCompliance.setObjects(*((_A,_m),(_A,_n),(_A,_o),(_A,_p),(_A,_q),(_A,_r),(_A,_s),(_A,_t),(_A,_u),(_A,_v)))
if mibBuilder.loadTexts:myDeviceMIBCompliance.setStatus(_B)
mibBuilder.exportSymbols(_A,**{'myEntityMIB':myEntityMIB,'myDeviceMIBObjects':myDeviceMIBObjects,_S:myDeviceMaxNumber,'myDeviceInfoTable':myDeviceInfoTable,'myDeviceInfoEntry':myDeviceInfoEntry,_F:myDeviceInfoIndex,_T:myDeviceInfoDescr,_U:myDeviceInfoSlotNumber,_V:myDevicePowerStatus,_W:myDeviceMacAddress,_X:myDevicePriority,_Y:myDeviceAlias,_Z:myDeviceSWVersion,_a:myDeviceHWVersion,'mySlotInfoTable':mySlotInfoTable,'mySlotInfoEntry':mySlotInfoEntry,_G:mySlotInfoDeviceIndex,_H:mySlotInfoIndex,_b:mySlotModuleInfoDescr,_c:mySlotInfoPortNumber,_d:mySlotInfoPortMaxNumber,_e:mySlotInfoDesc,'myModuleTempStateTable':myModuleTempStateTable,'myModuleTempStateEntry':myModuleTempStateEntry,_I:myModuleTempStateDeviceIndex,_J:myModuleTempStateIndex,_f:myModuleTempState,'myPowerStateTable':myPowerStateTable,'myPowerStateEntry':myPowerStateEntry,_K:myPowerStateDeviceIndex,_L:myPowerStateIndex,_g:myPowerState,_h:myPowerStatePowerDescr,'myFanStateTable':myFanStateTable,'myFanStateEntry':myFanStateEntry,_M:myFanStateDeviceIndex,_N:myFanStateIndex,_i:myFanState,_j:myFanStateFanDescr,'myEntityMIBTraps':myEntityMIBTraps,_O:myEntityStateChgDesc,_k:myEntityStatusChange,_P:myTemperatureWarningDesc,_l:myTemperatureWarning,'myDeviceMIBConformance':myDeviceMIBConformance,'myDeviceMIBCompliances':myDeviceMIBCompliances,'myDeviceMIBCompliance':myDeviceMIBCompliance,'myDeviceMIBGroups':myDeviceMIBGroups,_m:myDeviceInfoMIBGroup,_o:myOptionalDevInfoMIBGroup,_n:myModuleInfoMIBGroup,_p:myEntityChgDescGroup,_q:myDeviceMIBNotificationGroup,_r:myModuleTempStateGroup,_s:myPowerStateGroup,_t:myFanStateGroup,_u:myTemperatureWarningDescGroup,_v:myTemperatureWarningGroup})