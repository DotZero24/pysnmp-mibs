...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/comet/T3510-MIB
...
historyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 22626, 1, 2, 6, 1, 1), ).setIndexNames((0, "T3510-MIB", "histTemp"))
...
trapTest = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,0)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapNTPError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,1)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapEmailErrLogin = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,2)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapEmailErrAuth = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,3)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapEmailErrSome = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,4)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapEmailErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,5)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapEmailErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,6)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapSOAPErrFile = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,7)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapSOAPErrDNS = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,8)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapSOAPErrSocket = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,9)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapSOAPErrDelivery = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,10)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"))
trapTempHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,11)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "temp"), ("T3510-MIB", "tempAlarmInt"))
trapHumHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,12)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "hum"), ("T3510-MIB", "humAlarmInt"))
trapCompValHighAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,13)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "compVal"), ("T3510-MIB", "compValAlarmInt"))
trapTempLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,21)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "temp"), ("T3510-MIB", "tempAlarmInt"))
trapHumLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,22)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "hum"), ("T3510-MIB", "humAlarmInt"))
trapCompValLowAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,23)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "compVal"), ("T3510-MIB", "compValAlarmInt"))
trapTempClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,31)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "temp"), ("T3510-MIB", "tempAlarmInt"))
trapHumClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,32)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "hum"), ("T3510-MIB", "humAlarmInt"))
trapCompValClrAlarm = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,33)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "compVal"), ("T3510-MIB", "compValAlarmInt"))
trapTempError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,41)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "temp"), ("T3510-MIB", "tempAlarmInt"))
trapHumError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,42)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "hum"), ("T3510-MIB", "humAlarmInt"))
trapCompValError = NotificationType((1, 3, 6, 1, 4, 1, 22626) + (0,43)).setObjects(("T3510-MIB", "sensorName"), ("T3510-MIB", "messageString"), ("T3510-MIB", "compVal"), ("T3510-MIB", "compValAlarmInt"))
mibBuilder.exportSymbols("T3510-MIB", tempLowInt=tempLowInt, trapNTPError=trapNTPError, historyTable=historyTable, temp=temp, humHystInt=humHystInt, comet=comet, settings=settings, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, humHighInt=humHighInt, tempMax=tempMax, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrLogin=trapEmailErrLogin, humInt=humInt, historyEntry=historyEntry, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, sensorName=sensorName, humUnit=humUnit, trapEmailErrAuth=trapEmailErrAuth, humAlarm=humAlarm, compValMin=compValMin, tempMin=tempMin, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, trapHumError=trapHumError, hum=hum, traps=traps, humAlarmInt=humAlarmInt, tables=tables, compValDelayInt=compValDelayInt, trapHumClrAlarm=trapHumClrAlarm, compValInt=compValInt, compValAlarm=compValAlarm, compValUnit=compValUnit, messageString=messageString, humDelayInt=humDelayInt, tempInt=tempInt, tempAlarmInt=tempAlarmInt, values=values, compVal=compVal, humMax=humMax, compValLowInt=compValLowInt, histHum=histHum, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tempHighInt=tempHighInt, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, trapTempLowAlarm=trapTempLowAlarm, compValHighInt=compValHighInt, trapTest=trapTest, tempDelayInt=tempDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, products=products, pysmi_global=pysmi_global, tempUnit=tempUnit, t3510=t3510, trapHumLowAlarm=trapHumLowAlarm, histTemp=histTemp, DisplayString=DisplayString, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile)
