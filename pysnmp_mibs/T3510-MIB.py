# SNMP MIB module (T3510-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T3510-MIB
...
trapTest.setObjects(
      *(("T3510-MIB", "sensorName"),
        ("T3510-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
