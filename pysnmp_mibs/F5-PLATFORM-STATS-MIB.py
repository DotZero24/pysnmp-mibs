...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/f5/F5-PLATFORM-STATS-MIB
...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", platformCPUGroup=platformCPUGroup, platformCpuStatsTable=platformCpuStatsTable, fan_12_speed=fan_12_speed, cpuTotal5secAvg=cpuTotal5secAvg, cpuProcessorStatsTable=cpuProcessorStatsTable, diskVendor=diskVendor, diskWriteMerged=diskWriteMerged, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, diskReadLatencyMs=diskReadLatencyMs, fan_8_speed=fan_8_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, memoryStatsEntry=memoryStatsEntry, cpuStepping=cpuStepping, cpuCurrent=cpuCurrent, memoryStatsTable=memoryStatsTable, fan_4_speed=fan_4_speed, configurable=configurable, tempCurrent=tempCurrent, cpuCacheSize=cpuCacheSize, diskReadMerged=diskReadMerged, memAvailable=memAvailable, diskSerialNo=diskSerialNo, platformFwVersionGroup=platformFwVersionGroup, f5PlatformStats=f5PlatformStats, cpuCoreStatsTable=cpuCoreStatsTable, memPlatformUsed=memPlatformUsed, diskWriteIops=diskWriteIops, cpuCore=cpuCore, PlatformStatsIndex=PlatformStatsIndex, coreCurrent=coreCurrent, diskModel=diskModel, platformFantrayTable=platformFantrayTable, diskTotalIops=diskTotalIops, fpgaVersion=fpgaVersion, platformFpgaGroup=platformFpgaGroup, tempMinimum=tempMinimum, diskReadBytes=diskReadBytes, fantrayStatsEntry=fantrayStatsEntry, diskSize=diskSize, cpuTotal1minAvg=cpuTotal1minAvg, memFree=memFree, fwEntry=fwEntry, platformTemperatureTable=platformTemperatureTable, fwName=fwName, diskInfoEntry=diskInfoEntry, fwVersion=fwVersion, platformMemoryStatsTable=platformMemoryStatsTable, diskInfoTable=diskInfoTable, fpgaTable=fpgaTable, diskWriteBytes=diskWriteBytes, fan_6_speed=fan_6_speed, fan_10_speed=fan_10_speed, temperatureStatsTable=temperatureStatsTable, platformDiskStatsTable=platformDiskStatsTable, cpuCoreStatsEntry=cpuCoreStatsEntry, coreTotal5minAvg=coreTotal5minAvg, fpgaIndex=fpgaIndex, String=String, cpuModelName=cpuModelName, PYSNMP_MODULE_ID=f5PlatformStats, memPlatformTotal=memPlatformTotal, fwUpdateStatus=fwUpdateStatus, platformGroups=platformGroups, platformTempGroup=platformTempGroup, diskPercentageUsed=diskPercentageUsed, coreTotal1minAvg=coreTotal1minAvg, coreIndex=coreIndex, temperatureStatsEntry=temperatureStatsEntry, platformConformance=platformConformance, fantrayStatsTable=fantrayStatsTable, cpuTotal5minAvg=cpuTotal5minAvg, platformCompliance=platformCompliance, diskVersion=diskVersion, memPercentageUsed=memPercentageUsed, platformCompliances=platformCompliances, diskType=diskType, platformFwTable=platformFwTable, cpuFreq=cpuFreq, diskWriteLatencyMs=diskWriteLatencyMs, cpuUtilizationStatsTable=cpuUtilizationStatsTable, platformFantrayGroup=platformFantrayGroup, f5PlatformStatsObjects=f5PlatformStatsObjects, platformMemGroup=platformMemGroup, fan_2_speed=fan_2_speed, fan_11_speed=fan_11_speed, tempAverage=tempAverage, fan_3_speed=fan_3_speed, platformDiskGroup=platformDiskGroup, coreName=coreName, cpuIndex=cpuIndex, fan_1_speed=fan_1_speed, cpuThreadCnt=cpuThreadCnt, fan_7_speed=fan_7_speed, fan_5_speed=fan_5_speed, fpgaEntry=fpgaEntry, fan_9_speed=fan_9_speed, platformFpgaTable=platformFpgaTable, cpuCoreCnt=cpuCoreCnt, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskReadIops=diskReadIops, tempMaximum=tempMaximum, fwTable=fwTable, diskName=diskName, diskUtilizationStatsTable=diskUtilizationStatsTable, index=index, coreTotal5secAvg=coreTotal5secAvg)
