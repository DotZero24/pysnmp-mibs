...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", cpuCoreStatsTable=cpuCoreStatsTable, memoryStatsTable=memoryStatsTable, diskModel=diskModel, fan_9_speed=fan_9_speed, fan_8_speed=fan_8_speed, cpuProcessorStatsEntry=cpuProcessorStatsEntry, coreTotal5minAvg=coreTotal5minAvg, PlatformStatsIndex=PlatformStatsIndex, PYSNMP_MODULE_ID=f5PlatformStats, cpuCoreCnt=cpuCoreCnt, platformFpgaTable=platformFpgaTable, fwName=fwName, fpgaIndex=fpgaIndex, memPlatformTotal=memPlatformTotal, memPercentageUsed=memPercentageUsed, fwEntry=fwEntry, fan_1_speed=fan_1_speed, fantrayStatsEntry=fantrayStatsEntry, fpgaVersion=fpgaVersion, fan_6_speed=fan_6_speed, String=String, coreTotal5secAvg=coreTotal5secAvg, cpuIndex=cpuIndex, platformCompliances=platformCompliances, diskWriteIops=diskWriteIops, fan_4_speed=fan_4_speed, platformFwTable=platformFwTable, tempCurrent=tempCurrent, coreCurrent=coreCurrent, coreName=coreName, memPlatformUsed=memPlatformUsed, temperatureStatsTable=temperatureStatsTable, cpuCurrent=cpuCurrent, platformTemperatureTable=platformTemperatureTable, fantrayStatsTable=fantrayStatsTable, platformMemGroup=platformMemGroup, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, coreIndex=coreIndex, platformFpgaGroup=platformFpgaGroup, cpuCore=cpuCore, diskSerialNo=diskSerialNo, memoryStatsEntry=memoryStatsEntry, fan_2_speed=fan_2_speed, platformFwVersionGroup=platformFwVersionGroup, cpuUtilizationStatsTable=cpuUtilizationStatsTable, diskName=diskName, configurable=configurable, fan_7_speed=fan_7_speed, platformConformance=platformConformance, cpuTotal1minAvg=cpuTotal1minAvg, platformFantrayGroup=platformFantrayGroup, index=index, cpuTotal5minAvg=cpuTotal5minAvg, diskReadBytes=diskReadBytes, memFree=memFree, fan_5_speed=fan_5_speed, diskVendor=diskVendor, f5PlatformStatsObjects=f5PlatformStatsObjects, cpuTotal5secAvg=cpuTotal5secAvg, diskType=diskType, temperatureStatsEntry=temperatureStatsEntry, fwTable=fwTable, diskWriteBytes=diskWriteBytes, platformCompliance=platformCompliance, cpuCoreStatsEntry=cpuCoreStatsEntry, platformCpuStatsTable=platformCpuStatsTable, cpuCacheSize=cpuCacheSize, diskTotalIops=diskTotalIops, diskVersion=diskVersion, fan_11_speed=fan_11_speed, platformCPUGroup=platformCPUGroup, platformDiskGroup=platformDiskGroup, diskUtilizationStatsEntry=diskUtilizationStatsEntry, diskInfoTable=diskInfoTable, platformTempGroup=platformTempGroup, diskPercentageUsed=diskPercentageUsed, tempMinimum=tempMinimum, platformGroups=platformGroups, cpuFreq=cpuFreq, tempMaximum=tempMaximum, cpuStepping=cpuStepping, diskReadIops=diskReadIops, diskInfoEntry=diskInfoEntry, fpgaTable=fpgaTable, diskSize=diskSize, fpgaEntry=fpgaEntry, f5PlatformStats=f5PlatformStats, cpuModelName=cpuModelName, diskReadMerged=diskReadMerged, platformMemoryStatsTable=platformMemoryStatsTable, fwUpdateStatus=fwUpdateStatus, tempAverage=tempAverage, fan_10_speed=fan_10_speed, coreTotal1minAvg=coreTotal1minAvg, cpuProcessorStatsTable=cpuProcessorStatsTable, memAvailable=memAvailable, diskUtilizationStatsTable=diskUtilizationStatsTable, cpuThreadCnt=cpuThreadCnt, fan_12_speed=fan_12_speed, platformDiskStatsTable=platformDiskStatsTable, diskWriteLatencyMs=diskWriteLatencyMs, fan_3_speed=fan_3_speed, platformFantrayTable=platformFantrayTable, diskWriteMerged=diskWriteMerged, fwVersion=fwVersion, diskReadLatencyMs=diskReadLatencyMs)
