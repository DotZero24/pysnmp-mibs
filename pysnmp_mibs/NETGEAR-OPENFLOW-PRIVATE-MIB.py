...
_H='OctetString'
_G='read-create'
_F='NETGEAR-OPENFLOW-PRIVATE-MIB'
_E='read-write'
_D='Unsigned32'
_C='Integer32'
_B='read-only'
...
agentOpenFlowGroup=_AgentOpenFlowGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,56,1))
_AgentOpenFlowGlobalConfigGroup_ObjectIdentity=ObjectIdentity
agentOpenFlowGlobalConfigGroup=_AgentOpenFlowGlobalConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,56,1,1))
...
agentOpenFlowAdminMode=_AgentOpenFlowAdminMode_Object((1,3,6,1,4,1,4526,10,56,1,1,1),_AgentOpenFlowAdminMode_Type())
...
agentOpenFlowVariant=_AgentOpenFlowVariant_Object((1,3,6,1,4,1,4526,10,56,1,1,2),_AgentOpenFlowVariant_Type())
...
agentOpenFlowDefaultTable=_AgentOpenFlowDefaultTable_Object((1,3,6,1,4,1,4526,10,56,1,1,3),_AgentOpenFlowDefaultTable_Type())
agentOpenFlowDefaultTable.setMaxAccess(_E)
if mibBuilder.loadTexts:agentOpenFlowDefaultTable.setStatus(_A)
...
agentOpenFlowStaticIPAssignmentMode=_AgentOpenFlowStaticIPAssignmentMode_Object((1,3,6,1,4,1,4526,10,56,1,1,4),_AgentOpenFlowStaticIPAssignmentMode_Type())
...
agentOpenFlowGlobalConfigIPAddress=_AgentOpenFlowGlobalConfigIPAddress_Object((1,3,6,1,4,1,4526,10,56,1,1,5),_AgentOpenFlowGlobalConfigIPAddress_Type())
...
agentOpenFlowNetworkMTU=_AgentOpenFlowNetworkMTU_Object((1,3,6,1,4,1,4526,10,56,1,1,6),_AgentOpenFlowNetworkMTU_Type())
...
agentOpenFlowIPAssignmentMode=_AgentOpenFlowIPAssignmentMode_Object((1,3,6,1,4,1,4526,10,56,1,1,7),_AgentOpenFlowIPAssignmentMode_Type())
...
agentOpenFlowCfgControllerTable=_AgentOpenFlowCfgControllerTable_Object((1,3,6,1,4,1,4526,10,56,1,3))
if mibBuilder.loadTexts:agentOpenFlowCfgControllerTable.setStatus(_A)
_AgentOpenFlowCfgControllerEntry_Object=MibTableRow
agentOpenFlowCfgControllerEntry=_AgentOpenFlowCfgControllerEntry_Object((1,3,6,1,4,1,4526,10,56,1,3,1))
...
agentOpenFlowCfgCtrlIPAddress=_AgentOpenFlowCfgCtrlIPAddress_Object((1,3,6,1,4,1,4526,10,56,1,3,1,1),_AgentOpenFlowCfgCtrlIPAddress_Type())
...
agentOpenFlowCfgCtrlIPPort=_AgentOpenFlowCfgCtrlIPPort_Object((1,3,6,1,4,1,4526,10,56,1,3,1,2),_AgentOpenFlowCfgCtrlIPPort_Type())
...
agentOpenFlowCfgCtrlConnectionMode=_AgentOpenFlowCfgCtrlConnectionMode_Object((1,3,6,1,4,1,4526,10,56,1,3,1,3),_AgentOpenFlowCfgCtrlConnectionMode_Type())
...
agentOpenFlowCfgCtrlStatus=_AgentOpenFlowCfgCtrlStatus_Object((1,3,6,1,4,1,4526,10,56,1,3,1,4),_AgentOpenFlowCfgCtrlStatus_Type())
...
agentOpenFlowCfgCtrlRole=_AgentOpenFlowCfgCtrlRole_Object((1,3,6,1,4,1,4526,10,56,1,3,1,5),_AgentOpenFlowCfgCtrlRole_Type())
...
agentOpenFlowGlobalStatusParameters=_AgentOpenFlowGlobalStatusParameters_ObjectIdentity((1,3,6,1,4,1,4526,10,56,1,6))
...
agentOpenFlowOperationalStatus=_AgentOpenFlowOperationalStatus_Object((1,3,6,1,4,1,4526,10,56,1,6,1),_AgentOpenFlowOperationalStatus_Type())
...
agentOpenFlowDisableReason=_AgentOpenFlowDisableReason_Object((1,3,6,1,4,1,4526,10,56,1,6,2),_AgentOpenFlowDisableReason_Type())
...
agentOpenFlowGlobalCommands=_AgentOpenFlowGlobalCommands_ObjectIdentity((1,3,6,1,4,1,4526,10,56,1,7))
...
agentOpenFlowEraseOpenFlowManagerCertificates=_AgentOpenFlowEraseOpenFlowManagerCertificates_Object((1,3,6,1,4,1,4526,10,56,1,7,1),_AgentOpenFlowEraseOpenFlowManagerCertificates_Type())
...
agentOpenFlowFlowTableStatusTable=_AgentOpenFlowFlowTableStatusTable_Object((1,3,6,1,4,1,4526,10,56,1,8))
...
agentOpenFlowFlowTableStatusEntry=_AgentOpenFlowFlowTableStatusEntry_Object((1,3,6,1,4,1,4526,10,56,1,8,1))
...
agentOpenFlowFlowTable=_AgentOpenFlowFlowTable_Object((1,3,6,1,4,1,4526,10,56,1,8,1,1),_AgentOpenFlowFlowTable_Type())
...
agentOpenFlowFlowTableName=_AgentOpenFlowFlowTableName_Object((1,3,6,1,4,1,4526,10,56,1,8,1,2),_AgentOpenFlowFlowTableName_Type())
...
agentOpenFlowFlowTableDescription=_AgentOpenFlowFlowTableDescription_Object((1,3,6,1,4,1,4526,10,56,1,8,1,3),_AgentOpenFlowFlowTableDescription_Type())
...
agentOpenFlowMaximumSize=_AgentOpenFlowMaximumSize_Object((1,3,6,1,4,1,4526,10,56,1,8,1,4),_AgentOpenFlowMaximumSize_Type())
...
agentOpenFlowNumberOfEntries=_AgentOpenFlowNumberOfEntries_Object((1,3,6,1,4,1,4526,10,56,1,8,1,5),_AgentOpenFlowNumberOfEntries_Type())
...
agentOpenFlowHardwareEntries=_AgentOpenFlowHardwareEntries_Object((1,3,6,1,4,1,4526,10,56,1,8,1,6),_AgentOpenFlowHardwareEntries_Type())
...
agentOpenFlowSoftwareOnlyEntries=_AgentOpenFlowSoftwareOnlyEntries_Object((1,3,6,1,4,1,4526,10,56,1,8,1,7),_AgentOpenFlowSoftwareOnlyEntries_Type())
...
agentOpenFlowWaitingForSpaceEntries=_AgentOpenFlowWaitingForSpaceEntries_Object((1,3,6,1,4,1,4526,10,56,1,8,1,8),_AgentOpenFlowWaitingForSpaceEntries_Type())
...
agentOpenFlowFlowInsertionCount=_AgentOpenFlowFlowInsertionCount_Object((1,3,6,1,4,1,4526,10,56,1,8,1,9),_AgentOpenFlowFlowInsertionCount_Type())
...
agentOpenFlowFlowDeletionCount=_AgentOpenFlowFlowDeletionCount_Object((1,3,6,1,4,1,4526,10,56,1,8,1,10),_AgentOpenFlowFlowDeletionCount_Type())
...
agentOpenFlowInsertionFailureCount=_AgentOpenFlowInsertionFailureCount_Object((1,3,6,1,4,1,4526,10,56,1,8,1,11),_AgentOpenFlowInsertionFailureCount_Type())
...
agentOpenFlowInstalledGroupEntry=_AgentOpenFlowInstalledGroupEntry_ObjectIdentity((1,3,6,1,4,1,4526,10,56,1,9))
_AgentOpenFlowGrpIndirectMaxEntries_Type=Unsigned32
_AgentOpenFlowGrpIndirectMaxEntries_Object=MibScalar
agentOpenFlowGrpIndirectMaxEntries=_AgentOpenFlowGrpIndirectMaxEntries_Object((1,3,6,1,4,1,4526,10,56,1,9,1),_AgentOpenFlowGrpIndirectMaxEntries_Type())
...
agentOpenFlowGrpIndirectCurrentEntries=_AgentOpenFlowGrpIndirectCurrentEntries_Object((1,3,6,1,4,1,4526,10,56,1,9,2),_AgentOpenFlowGrpIndirectCurrentEntries_Type())
...
agentOpenFlowGrpAllMaxEntries=_AgentOpenFlowGrpAllMaxEntries_Object((1,3,6,1,4,1,4526,10,56,1,9,3),_AgentOpenFlowGrpAllMaxEntries_Type())
...
agentOpenFlowGrpAllCurrentEntries=_AgentOpenFlowGrpAllCurrentEntries_Object((1,3,6,1,4,1,4526,10,56,1,9,4),_AgentOpenFlowGrpAllCurrentEntries_Type())
...
agentOpenFlowGrpSelectMaxEntries=_AgentOpenFlowGrpSelectMaxEntries_Object((1,3,6,1,4,1,4526,10,56,1,9,5),_AgentOpenFlowGrpSelectMaxEntries_Type())
...
agentOpenFlowGrpSelectCurrentEntries=_AgentOpenFlowGrpSelectCurrentEntries_Object((1,3,6,1,4,1,4526,10,56,1,9,6),_AgentOpenFlowGrpSelectCurrentEntries_Type())
...
agentOpenFlowGroupDetailsTable=_AgentOpenFlowGroupDetailsTable_Object((1,3,6,1,4,1,4526,10,56,1,10))
if mibBuilder.loadTexts:agentOpenFlowGroupDetailsTable.setStatus(_A)
_AgentOpenFlowGroupDetailsEntry_Object=MibTableRow
agentOpenFlowGroupDetailsEntry=_AgentOpenFlowGroupDetailsEntry_Object((1,3,6,1,4,1,4526,10,56,1,10,1))
...
agentOpenFlowGroupId=_AgentOpenFlowGroupId_Object((1,3,6,1,4,1,4526,10,56,1,10,1,1),_AgentOpenFlowGroupId_Type())
...
agentOpenFlowGroupType=_AgentOpenFlowGroupType_Object((1,3,6,1,4,1,4526,10,56,1,10,1,2),_AgentOpenFlowGroupType_Type())
...
agentOpenFlowGroupRefCount=_AgentOpenFlowGroupRefCount_Object((1,3,6,1,4,1,4526,10,56,1,10,1,3),_AgentOpenFlowGroupRefCount_Type())
...
agentOpenFlowGroupDuration=_AgentOpenFlowGroupDuration_Object((1,3,6,1,4,1,4526,10,56,1,10,1,4),_AgentOpenFlowGroupDuration_Type())
...
agentOpenFlowGroupBucketCount=_AgentOpenFlowGroupBucketCount_Object((1,3,6,1,4,1,4526,10,56,1,10,1,5),_AgentOpenFlowGroupBucketCount_Type())
...
agentOpenFlowGroupBucketDetailsTable=_AgentOpenFlowGroupBucketDetailsTable_Object((1,3,6,1,4,1,4526,10,56,1,11))
...
agentOpenFlowGroupBucketDetailsEntry=_AgentOpenFlowGroupBucketDetailsEntry_Object((1,3,6,1,4,1,4526,10,56,1,11,1))
...
agentOpenFlowGroupBucketId=_AgentOpenFlowGroupBucketId_Object((1,3,6,1,4,1,4526,10,56,1,11,1,1),_AgentOpenFlowGroupBucketId_Type())
...
agentOpenFlowGroupBucketOutputPort=_AgentOpenFlowGroupBucketOutputPort_Object((1,3,6,1,4,1,4526,10,56,1,11,1,2),_AgentOpenFlowGroupBucketOutputPort_Type())
...
agentOpenFlowGroupBucketVlanId=_AgentOpenFlowGroupBucketVlanId_Object((1,3,6,1,4,1,4526,10,56,1,11,1,3),_AgentOpenFlowGroupBucketVlanId_Type())
...
agentOpenFlowGroupBucketRefGroupId=_AgentOpenFlowGroupBucketRefGroupId_Object((1,3,6,1,4,1,4526,10,56,1,11,1,4),_AgentOpenFlowGroupBucketRefGroupId_Type())
...
agentOpenFlowGroupBucketSrcMac=_AgentOpenFlowGroupBucketSrcMac_Object((1,3,6,1,4,1,4526,10,56,1,11,1,5),_AgentOpenFlowGroupBucketSrcMac_Type())
...
agentOpenFlowGroupBucketDstMac=_AgentOpenFlowGroupBucketDstMac_Object((1,3,6,1,4,1,4526,10,56,1,11,1,6),_AgentOpenFlowGroupBucketDstMac_Type())
...
agentOpenFlowBucketGroupId=_AgentOpenFlowBucketGroupId_Object((1,3,6,1,4,1,4526,10,56,1,11,1,7),_AgentOpenFlowBucketGroupId_Type())
