...
mibBuilder.exportSymbols("CISCO-LEC-EXT-MIB", PYSNMP_MODULE_ID=ciscoLecExtMIB, ciscoLecExtMIBConformance=ciscoLecExtMIBConformance, ciscoLecExtVlanMIBGroup=ciscoLecExtVlanMIBGroup, ciscoLecExtMIB=ciscoLecExtMIB, ciscoLecExtMIBCompliance=ciscoLecExtMIBCompliance, ciscoLecExtMIBNotificationPrefix=ciscoLecExtMIBNotificationPrefix, ciscoLecExtMIBCompliances=ciscoLecExtMIBCompliances, cLecExtVlan=cLecExtVlan, cLecToVlanId=cLecToVlanId, cLecToVlanTable=cLecToVlanTable, ciscoLecExtMIBNotifications=ciscoLecExtMIBNotifications, ciscoLecExtMIBObjects=ciscoLecExtMIBObjects, cLecToVlanEntry=cLecToVlanEntry, ciscoLecExtMIBGroups=ciscoLecExtMIBGroups)
