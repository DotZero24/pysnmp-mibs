# SNMP MIB module (QTECH-POE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-POE-MIB
...
qtechPoeMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110)
)
if mibBuilder.loadTexts:
    qtechPoeMIB.setRevisions(
        ("2012-02-14 00:00",
         "2012-02-14 00:00")
    )
...
qtechPoeConfigMIBObjects = _QtechPoeConfigMIBObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1)
)
_QtechIfPoeTable_Object = MibTable
qtechIfPoeTable = _QtechIfPoeTable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1, 1)
)
if mibBuilder.loadTexts:
    qtechIfPoeTable.setStatus("current")
_QtechIfPoeEntry_Object = MibTableRow
qtechIfPoeEntry = _QtechIfPoeEntry_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1, 1, 1)
)
qtechIfPoeEntry.setIndexNames(
    (0, "QTECH-POE-MIB", "ifPoeIndex"),
)
if mibBuilder.loadTexts:
    qtechIfPoeEntry.setStatus("current")
...
ifPoeIndex = _IfPoeIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1, 1, 1, 1),
    _IfPoeIndex_Type()
)
...
ifIsPoe = _IfIsPoe_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1, 1, 1, 2),
    _IfIsPoe_Type()
)
...
ifPoeEnable = _IfPoeEnable_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1, 1, 1, 3),
    _IfPoeEnable_Type()
)
...
ifPoePwrStatus = _IfPoePwrStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1, 1, 1, 4),
...
ifPoeMaxPwrSet = _IfPoeMaxPwrSet_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1, 1, 1, 5),
...
ifPoePriority = _IfPoePriority_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1, 1, 1, 6),
    _IfPoePriority_Type()
)
...
ifPoeConsumingPwr = _IfPoeConsumingPwr_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 1, 1, 1, 7),
...
qtechPoeTraps = _QtechPoeTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 2)
)
...
ifPoePowerOffTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 2, 1)
)
ifPoePowerOffTrap.setObjects(
    ("QTECH-POE-MIB", "ifPoeIndex")
)
if mibBuilder.loadTexts:
...
ifPoePowerOnTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 110, 2, 2)
)
...
mibBuilder.exportSymbols(
    "QTECH-POE-MIB",
    **{"qtechPoeMIB": qtechPoeMIB,
       "qtechPoeConfigMIBObjects": qtechPoeConfigMIBObjects,
       "qtechIfPoeTable": qtechIfPoeTable,
       "qtechIfPoeEntry": qtechIfPoeEntry,
