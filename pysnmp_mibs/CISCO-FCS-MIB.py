...
DomainIdOrZero, FcNameId, FcPortTxTypes, FcPortModuleTypes, FcAddressId, FcPortTypes, VsanIndex = mibBuilder.importSymbols("CISCO-ST-TC", "DomainIdOrZero", "FcNameId", "FcPortTxTypes", "FcPortModuleTypes", "FcAddressId", "FcPortTypes", "VsanIndex")
...
mibBuilder.exportSymbols("CISCO-FCS-MIB", fcsPlatformNodeNameListIndex=fcsPlatformNodeNameListIndex, fcsIePortListIndex=fcsIePortListIndex, fcsMgmtAddrListEntry=fcsMgmtAddrListEntry, fcsPortType=fcsPortType, fcsPlatformRowStatus=fcsPlatformRowStatus, fcsMgmtAddrChangeIeName=fcsMgmtAddrChangeIeName, fcsPlatformMgmtAddrListIndex=fcsPlatformMgmtAddrListIndex, fcsMIBCompliance=fcsMIBCompliance, fcsNotificationControlGroupRev1=fcsNotificationControlGroupRev1, fcsNodeNameRowStatus=fcsNodeNameRowStatus, fcsDiscoveryCompleteTime=fcsDiscoveryCompleteTime, fcsRxRegReqs=fcsRxRegReqs, fcsMgmtAddrConfigSource=fcsMgmtAddrConfigSource, fcsNotification=fcsNotification, fcsPortListTable=fcsPortListTable, fcsPlatformValidation=fcsPlatformValidation, fcsMgmtAddrChangeNotify=fcsMgmtAddrChangeNotify, fcsIeDomainId=fcsIeDomainId, fcsPortState=fcsPortState, fcsNotificationGroupRev1=fcsNotificationGroupRev1, FcPortState=FcPortState, fcsRxRscns=fcsRxRscns, fcsPortAttachPortNameIndex=fcsPortAttachPortNameIndex, fcsVsanDiscoverySpinLock=fcsVsanDiscoverySpinLock, FcFcsRejReasonExplanation=FcFcsRejReasonExplanation, fcsIeName=fcsIeName, fcsMgmtAddrRowStatus=fcsMgmtAddrRowStatus, fcsPlatformConfigSource=fcsPlatformConfigSource, fcsAttachPortNameListEntry=fcsAttachPortNameListEntry, ciscoFcsMIB=ciscoFcsMIB, fcsMgmtAddrChangeVsanIndex=fcsMgmtAddrChangeVsanIndex, fcsMIBGroups=fcsMIBGroups, fcsMIBComplianceRev1=fcsMIBComplianceRev1, fcsVsanDiscoveryName=fcsVsanDiscoveryName, fcsPortTXType=fcsPortTXType, CreatedBy=CreatedBy, FcPlatformType=FcPlatformType, fcsPlatformValidationResult=fcsPlatformValidationResult, fcsStatsTable=fcsStatsTable, fcsAttachPortNameListTable=fcsAttachPortNameListTable, fcsRejReasonCodeExplanation=fcsRejReasonCodeExplanation, fcsNotificationControlGroup=fcsNotificationControlGroup, fcsAttachPortName=fcsAttachPortName, fcsTotalRejects=fcsTotalRejects, fcsIeEntry=fcsIeEntry, fcsIeMgmtAddrListIndex=fcsIeMgmtAddrListIndex, fcsNotifications=fcsNotifications, fcsMIBConformance=fcsMIBConformance, fcsNodeNameConfigSource=fcsNodeNameConfigSource, fcsDiscoveryStatus=fcsDiscoveryStatus, fcsIeMgmtId=fcsIeMgmtId, fcsPlatformIndex=fcsPlatformIndex, PYSNMP_MODULE_ID=ciscoFcsMIB, fcsPortModuleType=fcsPortModuleType, fcsNodeNameListTable=fcsNodeNameListTable, fcsDiscoveryCompleteNotifyEnable=fcsDiscoveryCompleteNotifyEnable, ciscoFcsMIBObjects=ciscoFcsMIBObjects, fcsVsanDiscoveryTimeOut=fcsVsanDiscoveryTimeOut, fcsRxGetReqs=fcsRxGetReqs, fcsIeNumber=fcsIeNumber, fcsIeFabricName=fcsIeFabricName, fcsTxDeregReqs=fcsTxDeregReqs, fcsConfigurationGroup=fcsConfigurationGroup, fcsNodeNameListIndex=fcsNodeNameListIndex, fcsMgmtAddr=fcsMgmtAddr, fcsPlatformEntry=fcsPlatformEntry, fcsStartDiscovery=fcsStartDiscovery, fcsPortListIndex=fcsPortListIndex, fcsPortEntry=fcsPortEntry, fcsIeType=fcsIeType, fcsReqRejNotifyEnable=fcsReqRejNotifyEnable, fcsPortListEntry=fcsPortListEntry, fcsPlatformType=fcsPlatformType, fcsDiscoveryStatusEntry=fcsDiscoveryStatusEntry, fcsTxGetReqs=fcsTxGetReqs, fcsDiscoveryInvalidateCache2k=fcsDiscoveryInvalidateCache2k, fcsTxRscns=fcsTxRscns, fcsPortPhyPortNum=fcsPortPhyPortNum, fcsRejects=fcsRejects, fcsDiscoveryStatusTable=fcsDiscoveryStatusTable, fcsPlatformTable=fcsPlatformTable, fcsVsanDiscoveryList4k=fcsVsanDiscoveryList4k, fcsStatisticsGroup=fcsStatisticsGroup, fcsRxDeregReqs=fcsRxDeregReqs, fcsReqRejNotify=fcsReqRejNotify, fcsDiscoveryInvalidateCache4k=fcsDiscoveryInvalidateCache4k, fcsPlatformName=fcsPlatformName, fcsStats=fcsStats, fcsPortNumber=fcsPortNumber, fcsStatsEntry=fcsStatsEntry, fcsIeTable=fcsIeTable, fcsInformation=fcsInformation, fcsNodeNameListEntry=fcsNodeNameListEntry, fcsMgmtAddrIndex=fcsMgmtAddrIndex, fcsPlatformNumber=fcsPlatformNumber, fcsNodeName=fcsNodeName, fcsPortName=fcsPortName, fcsNotificationGroup=fcsNotificationGroup, fcsVsanDiscoveryList2k=fcsVsanDiscoveryList2k, FcIeType=FcIeType, fcsMgmtAddrListIndex=fcsMgmtAddrListIndex, fcsMIBCompliances=fcsMIBCompliances, fcsPortTable=fcsPortTable, fcsTxRegReqs=fcsTxRegReqs, fcsRejReasonCode=fcsRejReasonCode, fcsMgmtAddrListTable=fcsMgmtAddrListTable, fcsIeInfoList=fcsIeInfoList, fcsDiscoveryCompleteNotify=fcsDiscoveryCompleteNotify, fcsConfiguration=fcsConfiguration, fcsIeLogicalName=fcsIeLogicalName, fcsAttachPortNameListIndex=fcsAttachPortNameListIndex)
