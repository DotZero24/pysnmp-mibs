...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-FCS-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:26:34 2025
...
FcPortTypes, VsanIndex, FcAddressId, FcPortModuleTypes, FcNameId, FcPortTxTypes, DomainIdOrZero = mibBuilder.importSymbols("CISCO-ST-TC", "FcPortTypes", "VsanIndex", "FcAddressId", "FcPortModuleTypes", "FcNameId", "FcPortTxTypes", "DomainIdOrZero")
...
mibBuilder.exportSymbols("CISCO-FCS-MIB", fcsReqRejNotify=fcsReqRejNotify, fcsStats=fcsStats, fcsPortType=fcsPortType, fcsMgmtAddr=fcsMgmtAddr, fcsNotificationControlGroup=fcsNotificationControlGroup, fcsMgmtAddrListIndex=fcsMgmtAddrListIndex, fcsPlatformMgmtAddrListIndex=fcsPlatformMgmtAddrListIndex, fcsNotification=fcsNotification, fcsPortAttachPortNameIndex=fcsPortAttachPortNameIndex, fcsAttachPortNameListTable=fcsAttachPortNameListTable, fcsRxRegReqs=fcsRxRegReqs, fcsPlatformIndex=fcsPlatformIndex, fcsIeMgmtId=fcsIeMgmtId, fcsDiscoveryStatusTable=fcsDiscoveryStatusTable, fcsStartDiscovery=fcsStartDiscovery, fcsMgmtAddrListTable=fcsMgmtAddrListTable, fcsNodeName=fcsNodeName, fcsPortTable=fcsPortTable, fcsVsanDiscoveryList2k=fcsVsanDiscoveryList2k, fcsVsanDiscoveryName=fcsVsanDiscoveryName, fcsDiscoveryInvalidateCache2k=fcsDiscoveryInvalidateCache2k, fcsPlatformValidation=fcsPlatformValidation, fcsDiscoveryStatusEntry=fcsDiscoveryStatusEntry, fcsMgmtAddrChangeNotify=fcsMgmtAddrChangeNotify, fcsNodeNameListEntry=fcsNodeNameListEntry, fcsConfiguration=fcsConfiguration, fcsMgmtAddrChangeVsanIndex=fcsMgmtAddrChangeVsanIndex, fcsIeType=fcsIeType, fcsIeNumber=fcsIeNumber, fcsMIBCompliances=fcsMIBCompliances, fcsPlatformNodeNameListIndex=fcsPlatformNodeNameListIndex, fcsDiscoveryInvalidateCache4k=fcsDiscoveryInvalidateCache4k, fcsIeMgmtAddrListIndex=fcsIeMgmtAddrListIndex, fcsPlatformNumber=fcsPlatformNumber, fcsPortListEntry=fcsPortListEntry, fcsRejReasonCode=fcsRejReasonCode, fcsStatisticsGroup=fcsStatisticsGroup, fcsIeInfoList=fcsIeInfoList, fcsIeDomainId=fcsIeDomainId, fcsNodeNameListTable=fcsNodeNameListTable, fcsPlatformValidationResult=fcsPlatformValidationResult, fcsPortName=fcsPortName, fcsMgmtAddrRowStatus=fcsMgmtAddrRowStatus, fcsTxGetReqs=fcsTxGetReqs, fcsPortState=fcsPortState, fcsPlatformType=fcsPlatformType, fcsPortTXType=fcsPortTXType, fcsIeName=fcsIeName, fcsIeEntry=fcsIeEntry, FcIeType=FcIeType, fcsStatsTable=fcsStatsTable, fcsDiscoveryCompleteNotifyEnable=fcsDiscoveryCompleteNotifyEnable, fcsIeLogicalName=fcsIeLogicalName, fcsVsanDiscoverySpinLock=fcsVsanDiscoverySpinLock, fcsNotifications=fcsNotifications, fcsDiscoveryStatus=fcsDiscoveryStatus, fcsPlatformName=fcsPlatformName, fcsStatsEntry=fcsStatsEntry, fcsPortNumber=fcsPortNumber, fcsPortListIndex=fcsPortListIndex, fcsIePortListIndex=fcsIePortListIndex, fcsTotalRejects=fcsTotalRejects, FcFcsRejReasonExplanation=FcFcsRejReasonExplanation, fcsConfigurationGroup=fcsConfigurationGroup, fcsNodeNameListIndex=fcsNodeNameListIndex, fcsNotificationGroupRev1=fcsNotificationGroupRev1, fcsMIBCompliance=fcsMIBCompliance, fcsNotificationGroup=fcsNotificationGroup, CreatedBy=CreatedBy, fcsAttachPortNameListEntry=fcsAttachPortNameListEntry, fcsNotificationControlGroupRev1=fcsNotificationControlGroupRev1, PYSNMP_MODULE_ID=ciscoFcsMIB, fcsPlatformConfigSource=fcsPlatformConfigSource, fcsRxGetReqs=fcsRxGetReqs, fcsNodeNameRowStatus=fcsNodeNameRowStatus, fcsVsanDiscoveryList4k=fcsVsanDiscoveryList4k, fcsVsanDiscoveryTimeOut=fcsVsanDiscoveryTimeOut, fcsRxDeregReqs=fcsRxDeregReqs, fcsTxRscns=fcsTxRscns, fcsMIBGroups=fcsMIBGroups, fcsRejReasonCodeExplanation=fcsRejReasonCodeExplanation, fcsInformation=fcsInformation, fcsPortListTable=fcsPortListTable, fcsPortModuleType=fcsPortModuleType, fcsNodeNameConfigSource=fcsNodeNameConfigSource, fcsTxRegReqs=fcsTxRegReqs, fcsReqRejNotifyEnable=fcsReqRejNotifyEnable, fcsAttachPortNameListIndex=fcsAttachPortNameListIndex, fcsPlatformEntry=fcsPlatformEntry, fcsMIBComplianceRev1=fcsMIBComplianceRev1, fcsDiscoveryCompleteTime=fcsDiscoveryCompleteTime, fcsMgmtAddrChangeIeName=fcsMgmtAddrChangeIeName, fcsMIBConformance=fcsMIBConformance, fcsAttachPortName=fcsAttachPortName, fcsPlatformRowStatus=fcsPlatformRowStatus, fcsMgmtAddrListEntry=fcsMgmtAddrListEntry, fcsMgmtAddrConfigSource=fcsMgmtAddrConfigSource, fcsPortEntry=fcsPortEntry, ciscoFcsMIB=ciscoFcsMIB, fcsPlatformTable=fcsPlatformTable, fcsTxDeregReqs=fcsTxDeregReqs, fcsRxRscns=fcsRxRscns, fcsPortPhyPortNum=fcsPortPhyPortNum, fcsIeFabricName=fcsIeFabricName, fcsIeTable=fcsIeTable, FcPlatformType=FcPlatformType, ciscoFcsMIBObjects=ciscoFcsMIBObjects, fcsRejects=fcsRejects, fcsMgmtAddrIndex=fcsMgmtAddrIndex, fcsDiscoveryCompleteNotify=fcsDiscoveryCompleteNotify, FcPortState=FcPortState)
