...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FCS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:42 2025
...
_FcsIeMgmtId_Type.__name__ = "FcAddressId"
...
_FcsIeFabricName_Type.__name__ = "FcNameId"
...
_FcsReqRejNotifyEnable_Type.__name__ = "TruthValue"
...
_FcsDiscoveryCompleteNotifyEnable_Type.__name__ = "TruthValue"
...
fcsMIBCompliance.setObjects(
      *(("CISCO-FCS-MIB", "fcsConfigurationGroup"),
        ("CISCO-FCS-MIB", "fcsStatisticsGroup"),
        ("CISCO-FCS-MIB", "fcsNotificationControlGroup"),
        ("CISCO-FCS-MIB", "fcsNotificationGroup"))
)
if mibBuilder.loadTexts:
...
fcsMIBComplianceRev1.setObjects(
      *(("CISCO-FCS-MIB", "fcsConfigurationGroup"),
        ("CISCO-FCS-MIB", "fcsStatisticsGroup"),
        ("CISCO-FCS-MIB", "fcsNotificationControlGroupRev1"),
        ("CISCO-FCS-MIB", "fcsNotificationGroupRev1"))
)
if mibBuilder.loadTexts:
