...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/PTOPO-MIB
...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, PtopoChassisId=PtopoChassisId, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConnTable=ptopoConnTable, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoGroups=ptopoGroups, PtopoPortId=PtopoPortId, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoConnTimeMark=ptopoConnTimeMark, PtopoAddrSeenState=PtopoAddrSeenState, ptopoData=ptopoData, ptopoConnRowStatus=ptopoConnRowStatus, ptopoConformance=ptopoConformance, PtopoChassisIdType=PtopoChassisIdType, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConfigGroup=ptopoConfigGroup, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, ptopoConfigChange=ptopoConfigChange, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoDataGroup=ptopoDataGroup, ptopoConnRemotePort=ptopoConnRemotePort, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnLocalChassis=ptopoConnLocalChassis, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConnTabDrops=ptopoConnTabDrops, ptopoMIBNotifications=ptopoMIBNotifications, ptopoCompliances=ptopoCompliances, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, PYSNMP_MODULE_ID=ptopoMIB, PtopoGenAddr=PtopoGenAddr, ptopoCompliance=ptopoCompliance, ptopoMIBObjects=ptopoMIBObjects, ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoMIB=ptopoMIB, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, ptopoConfig=ptopoConfig, PtopoPortIdType=PtopoPortIdType, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoGeneral=ptopoGeneral, ptopoConnIndex=ptopoConnIndex, ptopoConnEntry=ptopoConnEntry, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConnTabInserts=ptopoConnTabInserts)
