...
mibBuilder.exportSymbols("PTOPO-MIB", ptopoDiscoveryLocal=ptopoDiscoveryLocal, ptopoConnLastVerifyTime=ptopoConnLastVerifyTime, PtopoGenAddr=PtopoGenAddr, PtopoPortIdType=PtopoPortIdType, ptopoConnTabAgeouts=ptopoConnTabAgeouts, ptopoLastChangeTime=ptopoLastChangeTime, ptopoConnTabDeletes=ptopoConnTabDeletes, ptopoConformance=ptopoConformance, ptopoCompliance=ptopoCompliance, ptopoMIB=ptopoMIB, ptopoDataGroup=ptopoDataGroup, ptopoConfigChange=ptopoConfigChange, ptopoConnRemoteChassis=ptopoConnRemoteChassis, ptopoConnTabDrops=ptopoConnTabDrops, ptopoMIBTrapPrefix=ptopoMIBTrapPrefix, ptopoConnEntry=ptopoConnEntry, ptopoConnLocalPort=ptopoConnLocalPort, ptopoConnLocalChassis=ptopoConnLocalChassis, PtopoChassisId=PtopoChassisId, ptopoConfig=ptopoConfig, PYSNMP_MODULE_ID=ptopoMIB, ptopoRegistrationPoints=ptopoRegistrationPoints, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoMIBNotifications=ptopoMIBNotifications, ptopoConfigTrapInterval=ptopoConfigTrapInterval, ptopoConnRemotePort=ptopoConnRemotePort, ptopoDiscoveryMechanisms=ptopoDiscoveryMechanisms, ptopoGroups=ptopoGroups, ptopoConnRemoteChassisType=ptopoConnRemoteChassisType, ptopoConfigMaxHoldTime=ptopoConfigMaxHoldTime, ptopoConnAgentNetAddr=ptopoConnAgentNetAddr, ptopoData=ptopoData, ptopoConfigGroup=ptopoConfigGroup, ptopoConnRowStatus=ptopoConnRowStatus, PtopoChassisIdType=PtopoChassisIdType, PtopoAddrSeenState=PtopoAddrSeenState, ptopoConnTimeMark=ptopoConnTimeMark, ptopoConnTable=ptopoConnTable, ptopoConnIndex=ptopoConnIndex, ptopoCompliances=ptopoCompliances, ptopoConnMultiMacSASeen=ptopoConnMultiMacSASeen, ptopoConnAgentNetAddrType=ptopoConnAgentNetAddrType, ptopoGeneral=ptopoGeneral, ptopoConnDiscAlgorithm=ptopoConnDiscAlgorithm, PtopoPortId=PtopoPortId, ptopoGeneralGroup=ptopoGeneralGroup, ptopoConnRemotePortType=ptopoConnRemotePortType, ptopoMIBObjects=ptopoMIBObjects, ptopoConnIsStatic=ptopoConnIsStatic, ptopoConnMultiNetSASeen=ptopoConnMultiNetSASeen, ptopoConnTabInserts=ptopoConnTabInserts)
