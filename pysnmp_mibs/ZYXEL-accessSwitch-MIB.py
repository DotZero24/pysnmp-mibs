_U='asRadiusServerIndex'
_T='asDhcpServerIp'
_S='DisplayString'
_R='NotificationType'
_Q='accessSwitchVoltageCurValue'
_P='accessSwitchFanRpmCurValue'
_O='accessSwitchSysTempCurValue'
_N='ifIndex'
_M='IF-MIB'
_L='disable'
_K='enable'
_J='accessSwitchSysTempIndex'
_I='accessSwitchVoltageIndex'
_H='accessSwitchFanRpmIndex'
_G='accessSwitchSystemCurrentStatus'
_F='accessSwitchProblemCause'
_E='Integer32'
_D='read-write'
_C='ZYXEL-accessSwitch-MIB'
_B='read-only'
_A='mandatory'
...
Bits,Counter32,Counter64,Gauge32,Integer32,IpAddress,ModuleIdentity,MibIdentifier,NotificationType,ObjectIdentity,MibScalar,MibTable,MibTableRow,MibTableColumn,NotificationType,TimeTicks,Unsigned32,enterprises,iso=mibBuilder.importSymbols('SNMPv2-SMI','Bits','Counter32','Counter64','Gauge32',_E,'IpAddress','ModuleIdentity','MibIdentifier',_R,'ObjectIdentity','MibScalar','MibTable','MibTableRow','MibTableColumn',_R,'TimeTicks','Unsigned32','enterprises','iso')
DisplayString,PhysAddress,RowStatus,TextualConvention=mibBuilder.importSymbols('SNMPv2-TC',_S,'PhysAddress','RowStatus','TextualConvention')
...
accessSwitchFanRpmEntry.setIndexNames((0,_C,_H))
...
accessSwitchVoltageEntry.setIndexNames((0,_C,_I))
...
accessSwitchSysTempEntry.setIndexNames((0,_C,_J))
...
_AccessSwitchDSLConfProfileName_Type.__name__=_S
...
asPacketForwardingEntry.setIndexNames((0,_M,_N))
...
class _AsDhcpRelayEnable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_K,1),(_L,2)))
...
class _AsDhcpRelayOption82Enable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_K,1),(_L,2)))
...
asDhcpServerEntry.setIndexNames((0,_C,_T))
...
asDhcpServerIp.setMaxAccess(_D)
...
asRadiusServerEntry.setIndexNames((0,_C,_U))
...
class _AsDot1xEnable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_K,1),(_L,2)))
...
asDot1xPortEntry.setIndexNames((0,_M,_N))
if mibBuilder.loadTexts:asDot1xPortEntry.setStatus(_A)
class _AsDot1xPortEnable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_K,1),(_L,2)))
