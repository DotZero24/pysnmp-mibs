...
mibBuilder.exportSymbols("HP-SN-SWITCH-GROUP-MIB", snSwPortStpPortEnable=snSwPortStpPortEnable, snFdpCacheIfIndex=snFdpCacheIfIndex, snFdpCacheAddressType=snFdpCacheAddressType, snFdpCachePlatform=snFdpCachePlatform, snVLanByATCableRouterIntf=snVLanByATCableRouterIntf, snSwPortRouteOnly=snSwPortRouteOnly, snFdbTableCurEntry=snFdbTableCurEntry, snMacFilterFrameTypeNum=snMacFilterFrameTypeNum, snQosBindTable=snQosBindTable, snVLanByProtocolEntry=snVLanByProtocolEntry, snSwPortStatsOutBcastFrames=snSwPortStatsOutBcastFrames, snVLanByPortStpMode=snVLanByPortStpMode, snFdbStationAddr=snFdbStationAddr, snTacacsRetransmit=snTacacsRetransmit, snVLanByPortStpHoldTime=snVLanByPortStpHoldTime, snAccountingCommandLevel=snAccountingCommandLevel, snNetFlowCollectorEntry=snNetFlowCollectorEntry, snVLanByPortCfgStpGroupForwardDelay=snVLanByPortCfgStpGroupForwardDelay, snFdpCacheDevicePort=snFdpCacheDevicePort, snTacacsServerTable=snTacacsServerTable, snVLanByProtocolChassisExcludeMask=snVLanByProtocolChassisExcludeMask, snPortStpSetAll=snPortStpSetAll, snVLanByProtocolVLanName=snVLanByProtocolVLanName, snNetFlowCollectorRowStatus=snNetFlowCollectorRowStatus, snVLanByPortMemberTable=snVLanByPortMemberTable, snMacFilterDestMac=snMacFilterDestMac, snMSTrunkTable=snMSTrunkTable, snSwFastStpMode=snSwFastStpMode, snVLanByPortStpMaxAge=snVLanByPortStpMaxAge, snNetFlowAggregationSourceInterface=snNetFlowAggregationSourceInterface, snSwPortInfoTable=snSwPortInfoTable, snFdpCacheCapabilities=snFdpCacheCapabilities, snVLanByIpxNetFrameType=snVLanByIpxNetFrameType, snFdpCachedAddressTable=snFdpCachedAddressTable, snTrunkTable=snTrunkTable, snVLanByPortRowStatus=snVLanByPortRowStatus, snPortStpInfo=snPortStpInfo, snFdpInterfaceEntry=snFdpInterfaceEntry, snSwPortStatsMultiColliFrames=snSwPortStatsMultiColliFrames, snSwPortStatsOutBitsPerSec=snSwPortStatsOutBitsPerSec, snPortStpPortDesignatedBridge=snPortStpPortDesignatedBridge, snDhcpGatewayListInfo=snDhcpGatewayListInfo, snPortStpVLanId=snPortStpVLanId, snInterfaceLookupTable=snInterfaceLookupTable, snSwProbePortNum=snSwProbePortNum, snNTPGeneral=snNTPGeneral, snVLanByPortCfgStpTimeSinceTopologyChange=snVLanByPortCfgStpTimeSinceTopologyChange, snFdpCachedAddrIfIndex=snFdpCachedAddrIfIndex, snMacFilterAction=snMacFilterAction, snVLanByIpSubnetDynamicMask=snVLanByIpSubnetDynamicMask, snSwIpMcastQuerierMode=snSwIpMcastQuerierMode, snFdpGlobal=snFdpGlobal, snIfIndexLookupInterfaceId=snIfIndexLookupInterfaceId, snSwDefaultVLanId=snSwDefaultVLanId, snSwPortPresent=snSwPortPresent, snVLanByPortVLanName=snVLanByPortVLanName, snIfIndexLookupIfIndex=snIfIndexLookupIfIndex, snVLanByIpxNetRowStatus=snVLanByIpxNetRowStatus, snVLanByIpSubnetIpAddress=snVLanByIpSubnetIpAddress, snFdbVLanId=snFdbVLanId, snVLanByPortRouterIntf=snVLanByPortRouterIntf, snFdpCacheDeviceIndex=snFdpCacheDeviceIndex, snVLanByProtocolChassisStaticMask=snVLanByProtocolChassisStaticMask, snSwPortInfoPortQos=snSwPortInfoPortQos, snSwPortInfoPhysAddress=snSwPortInfoPhysAddress, snVLanByPortQos=snVLanByPortQos, snQosBindEntry=snQosBindEntry, snSwPortLoadInterval=snSwPortLoadInterval, snTacacsServerRowKey=snTacacsServerRowKey, snVLanByIpxNetDynamicPortList=snVLanByIpxNetDynamicPortList, snSwPortInfoLinkStatus=snSwPortInfoLinkStatus, snInterfaceId=snInterfaceId, snMacStationVLanId=snMacStationVLanId, snRadiusServerRowStatus=snRadiusServerRowStatus, snTacacsSNMPAccess=snTacacsSNMPAccess, snRadius=snRadius, snSwPortStatsOutUtilization=snSwPortStatsOutUtilization, snVLanByPortCfgVLanName=snVLanByPortCfgVLanName, snVLanByATCableEntry=snVLanByATCableEntry, snFdpMIBObjects=snFdpMIBObjects, snPortStpPortState=snPortStpPortState, snFdpInterfaceTable=snFdpInterfaceTable, snVLanByProtocolStaticPortList=snVLanByProtocolStaticPortList, snRadiusLoginMethod=snRadiusLoginMethod, snTacacsServerRowStatus=snTacacsServerRowStatus, snVLanByPortCfgQos=snVLanByPortCfgQos, snVLanByPortStpGroupHelloTime=snVLanByPortStpGroupHelloTime, snVLanByIpSubnetSubnetMask=snVLanByIpSubnetSubnetMask, snVLanByIpSubnetChassisDynamicMask=snVLanByIpSubnetChassisDynamicMask, snVLanByIpxNetMaxNetworks=snVLanByIpxNetMaxNetworks, snNTPPollInterval=snNTPPollInterval, snFdbTable=snFdbTable, snMSTrunkRowStatus=snMSTrunkRowStatus, snMacFilterPortAccessFilters=snMacFilterPortAccessFilters, snTacacs=snTacacs, snNetFlow=snNetFlow, snVLanByPortStpDesignatedRoot=snVLanByPortStpDesignatedRoot, snVLanByIpSubnetDynamicPortList=snVLanByIpSubnetDynamicPortList, snFdpGlobalRun=snFdpGlobalRun, snSw8021qTagMode=snSw8021qTagMode, snMacFilterTable=snMacFilterTable, snRadiusGeneral=snRadiusGeneral, snVLanByPortBaseNumPorts=snVLanByPortBaseNumPorts, snSwGroupIpMcastMode=snSwGroupIpMcastMode, snSwPortStatsRxColliFrames=snSwPortStatsRxColliFrames, snVLanByProtocolExcludeMask=snVLanByProtocolExcludeMask, snVLanByPortOperState=snVLanByPortOperState, snSwPortName=snSwPortName, snQosBindPriority=snQosBindPriority, snSwSummary=snSwSummary, snSwPortStatsFrameTooShorts=snSwPortStatsFrameTooShorts, snTacacsGeneral=snTacacsGeneral, snNetFlowIfEntry=snNetFlowIfEntry, snSwPortIfIndex=snSwPortIfIndex, snQosProfileCalculatedBandwidth=snQosProfileCalculatedBandwidth, snMacFilterOperator=snMacFilterOperator, snNTPSync=snNTPSync, snNetFlowCollectorSourceInterface=snNetFlowCollectorSourceInterface, snVsrp=snVsrp, snFdbStationQos=snFdbStationQos, snPortStpTable=snPortStpTable, snSwPortStatsInBcastFrames=snSwPortStatsInBcastFrames, snFdpCachePortTagMode=snFdpCachePortTagMode, snRadiusEnableTelnetAuth=snRadiusEnableTelnetAuth, snSwPortStatsOutFrames=snSwPortStatsOutFrames, snVLanByPortStpRootCost=snVLanByPortStpRootCost, snDnsGatewayIpAddrList=snDnsGatewayIpAddrList, snSwMaxMacFilterPerPort=snSwMaxMacFilterPerPort, snQos=snQos, snVLanInfo=snVLanInfo, snPortStpPortDesignatedRoot=snPortStpPortDesignatedRoot, snVLanGroupVlanCurEntry=snVLanGroupVlanCurEntry, snIfIndexLookupTable=snIfIndexLookupTable, snMacFilterPortAccessEntry=snMacFilterPortAccessEntry, snSwPortDhcpGateListId=snSwPortDhcpGateListId, snAccountingCommandMethods=snAccountingCommandMethods, snSwGroupDefaultCfgMode=snSwGroupDefaultCfgMode, snNetFlowIfTable=snNetFlowIfTable, snMSTrunkPortList=snMSTrunkPortList, snVLanByATCableStaticPortList=snVLanByATCableStaticPortList, snNetFlowGlb=snNetFlowGlb, snRadiusRetransmit=snRadiusRetransmit, snSwPortInfoChnMode=snSwPortInfoChnMode, snSwPortInfoTagMode=snSwPortInfoTagMode, snFdbStationIndex=snFdbStationIndex, snVLanByProtocolDynamic=snVLanByProtocolDynamic, snAuthorizationCommandLevel=snAuthorizationCommandLevel, snVLanByIpxNetEntry=snVLanByIpxNetEntry, snVLanByPortStpPriority=snVLanByPortStpPriority, snMacFilter=snMacFilter, snNetFlowAggregationEnable=snNetFlowAggregationEnable, snNTPSummerTimeEnable=snNTPSummerTimeEnable, snVLanByIpSubnetRowStatus=snVLanByIpSubnetRowStatus, snNTPServerIp=snNTPServerIp, snTrunkIndex=snTrunkIndex, snRadiusServerUsage=snRadiusServerUsage, snSwPortStatsLinkChange=snSwPortStatsLinkChange, snVLanByPortStpGroupForwardDelay=snVLanByPortStpGroupForwardDelay, snSwPortLockAddressCount=snSwPortLockAddressCount, snVLanByPortCfgStpMode=snVLanByPortCfgStpMode, snSwPortInfoMediaType=snSwPortInfoMediaType, snMacFilterSourceMask=snMacFilterSourceMask, snFdpCacheIsAggregateVlan=snFdpCacheIsAggregateVlan, snSwPortInfoFlowControl=snSwPortInfoFlowControl, snFDP=snFDP, snFdpGlobalCdpRun=snFdpGlobalCdpRun, snPortStpPortNum=snPortStpPortNum, snFdpCacheVersion=snFdpCacheVersion, snRadiusKey=snRadiusKey, snSwEnableLockedAddrViolationTrap=snSwEnableLockedAddrViolationTrap, snVLanByATCableIndex=snVLanByATCableIndex, snVLanByPortStpHelloTime=snVLanByPortStpHelloTime, snVLanByATCableVLanId=snVLanByATCableVLanId, snSwGroupOperMode=snSwGroupOperMode, snVLanByIpSubnetEntry=snVLanByIpSubnetEntry, snVLanByIpxNetChassisExcludeMask=snVLanByIpxNetChassisExcludeMask, snVLanByPortCfgStpForwardDelay=snVLanByPortCfgStpForwardDelay, snSwBroadcastLimit=snSwBroadcastLimit, snVLanByIpSubnetRouterIntf=snVLanByIpSubnetRouterIntf, snNetFlowGblInactiveTimeout=snNetFlowGblInactiveTimeout, snSwPortInfoGigType=snSwPortInfoGigType, snTrunkPortMask=snTrunkPortMask, snDhcpGatewayListTable=snDhcpGatewayListTable, snSFlowGlb=snSFlowGlb, snRadiusServerTable=snRadiusServerTable, snFdbStationType=snFdbStationType, snVLanByPortCfgBaseBridgeAddress=snVLanByPortCfgBaseBridgeAddress, snTacacsServerUsage=snTacacsServerUsage, snFdpCachePortVlanMask=snFdpCachePortVlanMask, snTrunkType=snTrunkType, snFdpCacheTable=snFdpCacheTable, snVLanByATCableVLanName=snVLanByATCableVLanName, snSwPortGBICStatus=snSwPortGBICStatus, snMacFilterFrameType=snMacFilterFrameType, snSwPortStatsInFrames=snSwPortStatsInFrames, snNetFlowAggregationTable=snNetFlowAggregationTable, snVLanByIpSubnetTable=snVLanByIpSubnetTable, snVLanByIpSubnetDynamic=snVLanByIpSubnetDynamic, snMacFilterSourceMac=snMacFilterSourceMac, snVLanByPortBaseType=snVLanByPortBaseType, snVLanByIpxNetChassisDynamicMask=snVLanByIpxNetChassisDynamicMask, snTacacsDeadTime=snTacacsDeadTime, snSwPortStatsInBitsPerSec=snSwPortStatsInBitsPerSec, snVLanByPortCfgStpMaxAge=snVLanByPortCfgStpMaxAge, snRadiusServerAcctPort=snRadiusServerAcctPort, snInterfaceLookupEntry=snInterfaceLookupEntry, snSwPortInfoSpeed=snSwPortInfoSpeed, snQosProfileRequestedBandwidth=snQosProfileRequestedBandwidth, snSwGlobalStpMode=snSwGlobalStpMode, snFdpCacheDeviceId=snFdpCacheDeviceId, snMacFilterEntry=snMacFilterEntry, snMacFilterPortAccessTable=snMacFilterPortAccessTable, snQosProfileEntry=snQosProfileEntry, snVLanByIpSubnetExcludeMask=snVLanByIpSubnetExcludeMask, snSwPortStatsOutPktsPerSec=snSwPortStatsOutPktsPerSec, snRadiusSNMPAccess=snRadiusSNMPAccess, snMacFilterDestMask=snMacFilterDestMask, snIfIndexLookupEntry=snIfIndexLookupEntry, snSwQosMechanism=snSwQosMechanism, snNetFlowGblActiveTimeout=snNetFlowGblActiveTimeout, snVLanByPortBaseBridgeAddress=snVLanByPortBaseBridgeAddress, snSflowCollectorIndex=snSflowCollectorIndex, snVLanByIpxNetStaticPortList=snVLanByIpxNetStaticPortList, snVLanByProtocolStaticMask=snVLanByProtocolStaticMask, snFdbTableStationFlush=snFdbTableStationFlush, snSwPortInfoConnectorType=snSwPortInfoConnectorType, snVLanByPortCfgStpProtocolSpecification=snVLanByPortCfgStpProtocolSpecification, PhysAddress=PhysAddress, snSwPortEntrySize=snSwPortEntrySize, snInterfaceLookupInterfaceId=snInterfaceLookupInterfaceId, snVLanByIpxNetNetworkNum=snVLanByIpxNetNetworkNum, snFdbRowStatus=snFdbRowStatus, snVLanByPortCfgRowStatus=snVLanByPortCfgRowStatus, snVLanByATCableChassisStaticMask=snVLanByATCableChassisStaticMask, snSwGroupSwitchAgeTime=snSwGroupSwitchAgeTime, snNTPSystemClock=snNTPSystemClock, snVLanByIpSubnetStaticMask=snVLanByIpSubnetStaticMask, snSwPortStatsInPktsPerSec=snSwPortStatsInPktsPerSec, snDhcpGatewayListRowStatus=snDhcpGatewayListRowStatus, snTrunkInfo=snTrunkInfo, snNetFlowAggregationIndex=snNetFlowAggregationIndex, snVLanByPortPortList=snVLanByPortPortList, snSwPortStatsMacStations=snSwPortStatsMacStations, snFdpInterfaceFdpEnable=snFdpInterfaceFdpEnable, snSwPortInfo=snSwPortInfo, snNTPServerRowStatus=snNTPServerRowStatus, snVLanByPortCfgStpHoldTime=snVLanByPortCfgStpHoldTime, snFdpCacheEntry=snFdpCacheEntry, snRadiusEnableMethod=snRadiusEnableMethod, snDhcpGatewayListAddrList=snDhcpGatewayListAddrList, snVLanByPortPortMask=snVLanByPortPortMask, snFdpInterface=snFdpInterface, snRadiusServerEntry=snRadiusServerEntry, snFdbStationPort=snFdbStationPort)
mibBuilder.exportSymbols("HP-SN-SWITCH-GROUP-MIB", snSwPortDescr=snSwPortDescr, snRadiusWebServerMethod=snRadiusWebServerMethod, snAAA=snAAA, snInterfaceLookupIfIndex=snInterfaceLookupIfIndex, snMacFilterPortAccessPortIndex=snMacFilterPortAccessPortIndex, snSwClearCounters=snSwClearCounters, snVLanByPortStpRootPort=snVLanByPortStpRootPort, snRadiusServerRowKey=snRadiusServerRowKey, snQosProfileName=snQosProfileName, snPortStpPortForwardTransitions=snPortStpPortForwardTransitions, snMSTrunkEntry=snMSTrunkEntry, snSwGlobalAutoNegotiate=snSwGlobalAutoNegotiate, snNetFlowCollectorUdpPort=snNetFlowCollectorUdpPort, snCAR=snCAR, snVLanByPortCfgStpHelloTime=snVLanByPortCfgStpHelloTime, snVLanByIpxNetVLanId=snVLanByIpxNetVLanId, snSwPortInfoPortNum=snSwPortInfoPortNum, snSwPortInfoEntry=snSwPortInfoEntry, snNetFlowAggregationActiveTimeout=snNetFlowAggregationActiveTimeout, snFdpCachedAddrDeviceIndex=snFdpCachedAddrDeviceIndex, snFdpInterfaceCdpEnable=snFdpInterfaceCdpEnable, snVLanByPortCfgStpPriority=snVLanByPortCfgStpPriority, snTacacsKey=snTacacsKey, snVLanByPortChassisPortMask=snVLanByPortChassisPortMask, snSwSummaryMode=snSwSummaryMode, snVLanByPortStpForwardDelay=snVLanByPortStpForwardDelay, snVLanByPortMemberEntry=snVLanByPortMemberEntry, snNetFlowIfFlowSwitching=snNetFlowIfFlowSwitching, snVLanByProtocolRowStatus=snVLanByProtocolRowStatus, snPortStpPortDesignatedPort=snPortStpPortDesignatedPort, snVLanByIpxNetExcludePortList=snVLanByIpxNetExcludePortList, snVLanByIpSubnetChassisExcludeMask=snVLanByIpSubnetChassisExcludeMask, snSwPortStatsInMcastFrames=snSwPortStatsInMcastFrames, snSwViolatorMacAddress=snSwViolatorMacAddress, snSwPortInfoAdminStatus=snSwPortInfoAdminStatus, snVLanByPortCfgStpRootPort=snVLanByPortCfgStpRootPort, snSwPortSetAll=snSwPortSetAll, snNetFlowIfIndex=snNetFlowIfIndex, snVLanByIpSubnetMaxSubnets=snVLanByIpSubnetMaxSubnets, snTacacsServerEntry=snTacacsServerEntry, snVLanByPortCfgTable=snVLanByPortCfgTable, snFdbInfo=snFdbInfo, snNetFlowCollectorTable=snNetFlowCollectorTable, snSwPortStatsFrameTooLongs=snSwPortStatsFrameTooLongs, snFdpCacheVendorId=snFdpCacheVendorId, snFdbEntry=snFdbEntry, snVLanByATCableRowStatus=snVLanByATCableRowStatus, snSwSingleStpMode=snSwSingleStpMode, snNTPServerVersion=snNTPServerVersion, snVLanByPortCfgStpGroupHelloTime=snVLanByPortCfgStpGroupHelloTime, snSwPortFastSpanUplinkEnable=snSwPortFastSpanUplinkEnable, snSwEosBufferSize=snSwEosBufferSize, snVLanByPortStpGroupMaxAge=snVLanByPortStpGroupMaxAge, snMSTrunkType=snMSTrunkType, snVLanByPortCfgEntry=snVLanByPortCfgEntry, snMacFilterPortAccessRowStatus=snMacFilterPortAccessRowStatus, snDnsDomainName=snDnsDomainName, snSwPortStatsAlignErrors=snSwPortStatsAlignErrors, snVLanByIpxNetRouterIntf=snVLanByIpxNetRouterIntf, snFdpCacheTagType=snFdpCacheTagType, snAccountingSystem=snAccountingSystem, snPortStpPortDesignatedCost=snPortStpPortDesignatedCost, snSwPortOutOctets=snSwPortOutOctets, snFdbStationEntrySize=snFdbStationEntrySize, snVLanCAR=snVLanCAR, snRadiusTimeOut=snRadiusTimeOut, snSwPortFastSpanPortEnable=snSwPortFastSpanPortEnable, snSflowCollectorEntry=snSflowCollectorEntry, snVLanByPortCfgVLanId=snVLanByPortCfgVLanId, snPortStpPortPriority=snPortStpPortPriority, snVLanByIpSubnetExcludePortList=snVLanByIpSubnetExcludePortList, snQosBindIndex=snQosBindIndex, snVLanByPortVLanId=snVLanByPortVLanId, snVLanByPortCfgStpTopChanges=snVLanByPortCfgStpTopChanges, snVLanByIpxNetDynamicMask=snVLanByIpxNetDynamicMask, snVLanByProtocolExcludePortList=snVLanByProtocolExcludePortList, snSwPortStatsFCSErrors=snSwPortStatsFCSErrors, snFdpCacheDefaultTrafficeVlanIdForDualMode=snFdpCacheDefaultTrafficeVlanIdForDualMode, snVLanByIpxNetVLanName=snVLanByIpxNetVLanName, snFdpGlobalHoldTime=snFdpGlobalHoldTime, snNetFlowCollectorIp=snNetFlowCollectorIp, snSflowCollectorTable=snSflowCollectorTable, snPortStpEntry=snPortStpEntry, snVLanByIpxNetDynamic=snVLanByIpxNetDynamic, snVLanByPortTable=snVLanByPortTable, snVLanByPortCfgBaseNumPorts=snVLanByPortCfgBaseNumPorts, snNTPTimeZone=snNTPTimeZone, snNetFlowAggregationEntry=snNetFlowAggregationEntry, snNetFlowAggregationUdpPort=snNetFlowAggregationUdpPort, snSwProtocolVLanMode=snSwProtocolVLanMode, snVLanGroupSetAllVLan=snVLanGroupSetAllVLan, snSw8021qTagType=snSw8021qTagType, snSwPortStatsOutKiloBitsPerSec=snSwPortStatsOutKiloBitsPerSec, snVLanByProtocolVLanId=snVLanByProtocolVLanId, snVLanByProtocolDynamicMask=snVLanByProtocolDynamicMask, snAuthorizationCommandMethods=snAuthorizationCommandMethods, snNTPServerTable=snNTPServerTable, snVLanByPortMemberVLanId=snVLanByPortMemberVLanId, snVLanByPortStpTimeSinceTopologyChange=snVLanByPortStpTimeSinceTopologyChange, MacAddress=MacAddress, snMSTrunkPortIndex=snMSTrunkPortIndex, snSflowCollectorUDPPort=snSflowCollectorUDPPort, snRadiusDeadTime=snRadiusDeadTime, snFdpCachedAddr=snFdpCachedAddr, snSwPortVlanId=snSwPortVlanId, snVLanByPortEntry=snVLanByPortEntry, snSflowCollectorIP=snSflowCollectorIP, snSflowCollectorRowStatus=snSflowCollectorRowStatus, snSwPortStatsOutDiscard=snSwPortStatsOutDiscard, snAccounting=snAccounting, snMacFilterIndex=snMacFilterIndex, snTacacsServerIp=snTacacsServerIp, snFdpCache=snFdpCache, snVLanByProtocolTable=snVLanByProtocolTable, DisplayString=DisplayString, snQosBindProfileIndex=snQosBindProfileIndex, snDhcpGatewayListId=snDhcpGatewayListId, snFdpCachedAddressEntry=snFdpCachedAddressEntry, snVLanByPortCfgStpGroupMaxAge=snVLanByPortCfgStpGroupMaxAge, snVLanByPortEntrySize=snVLanByPortEntrySize, snSFlow=snSFlow, snVLanByPortStpProtocolSpecification=snVLanByPortStpProtocolSpecification, snTacacsTimeOut=snTacacsTimeOut, snSwPortStatsInKiloBitsPerSec=snSwPortStatsInKiloBitsPerSec, snSwPortTagType=snSwPortTagType, snVLanByProtocolChassisDynamicMask=snVLanByProtocolChassisDynamicMask, snTacacsServerAuthPort=snTacacsServerAuthPort, snNetFlowCollectorIndex=snNetFlowCollectorIndex, snVLanByATCableTable=snVLanByATCableTable, snSwInfo=snSwInfo, snSwMaxMacFilterPerSystem=snSwMaxMacFilterPerSystem, snNetFlowGblVersion=snNetFlowGblVersion, snNetFlowGblEnable=snNetFlowGblEnable, snVLanByIpSubnetVLanId=snVLanByIpSubnetVLanId, snFdpCachedAddrDeviceAddrEntryIndex=snFdpCachedAddrDeviceAddrEntryIndex, snSwPortStatsInDiscard=snSwPortStatsInDiscard, snSwIpxL3SwMode=snSwIpxL3SwMode, snVLanByIpxNetChassisStaticMask=snVLanByIpxNetChassisStaticMask, snMacFilterRowStatus=snMacFilterRowStatus, snNetFlowAggregationInactiveTimeout=snNetFlowAggregationInactiveTimeout, snVLanByPortMemberPortId=snVLanByPortMemberPortId, PortMask=PortMask, snNTP=snNTP, snPortStpPortEnable=snPortStpPortEnable, snVLanByProtocolRouterIntf=snVLanByProtocolRouterIntf, snNetFlowAggregationIp=snNetFlowAggregationIp, snVLanByPortCfgStpDesignatedRoot=snVLanByPortCfgStpDesignatedRoot, snVLanByPortCfgStpRootCost=snVLanByPortCfgStpRootCost, snVLanByIpxNetExcludeMask=snVLanByIpxNetExcludeMask, snAuthorizationExec=snAuthorizationExec, Timeout=Timeout, snVLanByIpSubnetVLanName=snVLanByIpSubnetVLanName, snSwPortInOctets=snSwPortInOctets, snNetFlowAggregationNumberOfCacheEntries=snNetFlowAggregationNumberOfCacheEntries, snFdpCachedAddrType=snFdpCachedAddrType, snVLanByPortVLanIndex=snVLanByPortVLanIndex, BridgeId=BridgeId, snRadiusSNMPServerMethod=snRadiusSNMPServerMethod, snDnsInfo=snDnsInfo, snDhcpGatewayListEntry=snDhcpGatewayListEntry, snVLanByIpSubnetStaticPortList=snVLanByIpSubnetStaticPortList, snSwGroupIpL3SwMode=snSwGroupIpL3SwMode, InterfaceId=InterfaceId, snSwPortInfoAutoNegotiate=snSwPortInfoAutoNegotiate, snVLanByPortMemberRowStatus=snVLanByPortMemberRowStatus, snAuthorization=snAuthorization, snFdpInterfaceIfIndex=snFdpInterfaceIfIndex, snVLanByIpxNetTable=snVLanByIpxNetTable, snSwEnableBridgeTopoChangeTrap=snSwEnableBridgeTopoChangeTrap, snSwPortStatsOutMcastFrames=snSwPortStatsOutMcastFrames, snAuthentication=snAuthentication, snAccountingExec=snAccountingExec, snVLanByProtocolIndex=snVLanByProtocolIndex, snPortStpPathCost=snPortStpPathCost, snRadiusServerAuthPort=snRadiusServerAuthPort, snSwEnableBridgeNewRootTrap=snSwEnableBridgeNewRootTrap, snVLanByPortStpTopChanges=snVLanByPortStpTopChanges, snVLanByIpxNetStaticMask=snVLanByIpxNetStaticMask, snNetFlowGblProtocolDisable=snNetFlowGblProtocolDisable, snTrunkEntry=snTrunkEntry, snSwPortStatsInUtilization=snSwPortStatsInUtilization, snNTPServerEntry=snNTPServerEntry, snVLanByPortCfgBaseType=snVLanByPortCfgBaseType, snNetFlowAggregationRowStatus=snNetFlowAggregationRowStatus, snVLanGroupVlanMaxEntry=snVLanGroupVlanMaxEntry, snVLanByPortCfgRouterIntf=snVLanByPortCfgRouterIntf, snPortStpEntrySize=snPortStpEntrySize, snPortStpOperState=snPortStpOperState, snSwPortStatsTxColliFrames=snSwPortStatsTxColliFrames, snSwPortInfoMonitorMode=snSwPortInfoMonitorMode, snFdpCachedAddrValue=snFdpCachedAddrValue, snVLanByIpSubnetChassisStaticMask=snVLanByIpSubnetChassisStaticMask, snRadiusServerIp=snRadiusServerIp, snSwPortCacheGroupId=snSwPortCacheGroupId, snFdpGlobalMessageInterval=snFdpGlobalMessageInterval, snQosProfileTable=snQosProfileTable, snFdpCacheAddress=snFdpCacheAddress, snVLanByProtocolDynamicPortList=snVLanByProtocolDynamicPortList, snSwPortTransGroupId=snSwPortTransGroupId, snSwViolatorPortNumber=snSwViolatorPortNumber, snQosProfileIndex=snQosProfileIndex)
