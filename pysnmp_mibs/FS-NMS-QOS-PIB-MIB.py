# SNMP MIB module (FS-NMS-QOS-PIB-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/fscom/FS-NMS-QOS-PIB-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:14:32 2025
...
qosDevicePibIncarnationEntry = _QosDevicePibIncarnationEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 1, 1)
)
qosDevicePibIncarnationEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosDeviceIncarnationId"),
)
if mibBuilder.loadTexts:
...
qosDeviceIncarnationId = _QosDeviceIncarnationId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 1, 1, 1),
...
qosDevicePdpName = _QosDevicePdpName_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 1, 1, 2),
...
qosDevicePibIncarnation = _QosDevicePibIncarnation_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 1, 1, 3),
...
qosDevicePibTtl = _QosDevicePibTtl_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 1, 1, 4),
...
qosDeviceAttributeEntry = _QosDeviceAttributeEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 2, 1)
)
qosDeviceAttributeEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosDeviceAttributeId"),
)
if mibBuilder.loadTexts:
...
qosDeviceAttributeId = _QosDeviceAttributeId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 2, 1, 1),
...
qosDevicePepDomain = _QosDevicePepDomain_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 2, 1, 2),
...
qosDevicePrimaryPdp = _QosDevicePrimaryPdp_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 2, 1, 3),
...
qosDeviceSecondaryPdp = _QosDeviceSecondaryPdp_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 2, 1, 4),
...
qosDeviceMaxMessageSize = _QosDeviceMaxMessageSize_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 2, 1, 5),
...
qosDeviceCapabilities = _QosDeviceCapabilities_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 2, 1, 6),
...
qosInterfaceTypeEntry = _QosInterfaceTypeEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 3, 1)
)
qosInterfaceTypeEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosInterfaceTypeId"),
)
if mibBuilder.loadTexts:
...
qosInterfaceTypeId = _QosInterfaceTypeId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 3, 1, 1),
...
qosInterfaceQueueType = _QosInterfaceQueueType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 2, 3, 1, 2),
...
qosDiffServMappingEntry = _QosDiffServMappingEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 3, 1, 1)
)
qosDiffServMappingEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosDscp"),
)
if mibBuilder.loadTexts:
...
qosDscp = _QosDscp_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 3, 1, 1, 1),
    _QosDscp_Type()
)
...
qosMarkedDscp = _QosMarkedDscp_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 3, 1, 1, 2),
    _QosMarkedDscp_Type()
)
...
qosCosToDscpCos = _QosCosToDscpCos_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 3, 2, 1, 1),
...
qosCosToDscpDscp = _QosCosToDscpDscp_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 3, 2, 1, 2),
...
qosUnmatchedPolicyEntry = _QosUnmatchedPolicyEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 4, 1, 1)
)
qosUnmatchedPolicyEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosUnmatchedPolicyId"),
)
if mibBuilder.loadTexts:
...
qosUnmatchedPolicyRole = _QosUnmatchedPolicyRole_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 4, 1, 1, 2),
...
qosUnmatchedPolicyDirection = _QosUnmatchedPolicyDirection_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 4, 1, 1, 3),
...
qosUnmatchedPolicyDscp = _QosUnmatchedPolicyDscp_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 4, 1, 1, 4),
...
qosUnmatchPolMicroFlowPolicerId = _QosUnmatchPolMicroFlowPolicerId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 4, 1, 1, 6),
...
qosPolicerId = _QosPolicerId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 5, 1, 1, 1),
    _QosPolicerId_Type()
)
...
qosPolicerRate = _QosPolicerRate_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 5, 1, 1, 2),
...
qosPolicerNormalBurst = _QosPolicerNormalBurst_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 5, 1, 1, 3),
...
qosPolicerExcessBurst = _QosPolicerExcessBurst_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 5, 1, 1, 4),
...
qosPolicerAction = _QosPolicerAction_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 5, 1, 1, 5),
...
qosAggregateId = _QosAggregateId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 5, 2, 1, 1),
...
qosAggregatePolicerId = _QosAggregatePolicerId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 5, 2, 1, 2),
...
qosMacClassificationEntry = _QosMacClassificationEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 6, 1, 1)
)
qosMacClassificationEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosMacClassificationId"),
)
if mibBuilder.loadTexts:
...
qosMacClassificationId = _QosMacClassificationId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 6, 1, 1, 1),
...
qosDstMacVlan = _QosDstMacVlan_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 6, 1, 1, 2),
    _QosDstMacVlan_Type()
)
...
qosDstMacAddress = _QosDstMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 6, 1, 1, 3),
...
qosIpAceId = _QosIpAceId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 1),
    _QosIpAceId_Type()
)
...
qosIpAceDstAddr = _QosIpAceDstAddr_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 2),
...
qosIpAceDstAddrMask = _QosIpAceDstAddrMask_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 3),
...
qosIpAceSrcAddr = _QosIpAceSrcAddr_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 4),
...
qosIpAceSrcAddrMask = _QosIpAceSrcAddrMask_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 5),
...
qosIpAceDscpMin = _QosIpAceDscpMin_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 6),
...
qosIpAceDscpMax = _QosIpAceDscpMax_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 7),
...
qosIpAceProtocol = _QosIpAceProtocol_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 8),
...
qosIpAceDstL4PortMin = _QosIpAceDstL4PortMin_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 9),
...
qosIpAceDstL4PortMax = _QosIpAceDstL4PortMax_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 10),
...
qosIpAceSrcL4PortMin = _QosIpAceSrcL4PortMin_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 11),
...
qosIpAceSrcL4PortMax = _QosIpAceSrcL4PortMax_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 12),
...
qosIpAcePermit = _QosIpAcePermit_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 1, 1, 13),
...
qosIpAclDefinitionEntry = _QosIpAclDefinitionEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 2, 1)
)
qosIpAclDefinitionEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosIpAclDefinitionId"),
)
if mibBuilder.loadTexts:
...
qosIpAclDefinitionId = _QosIpAclDefinitionId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 2, 1, 1),
...
qosIpAceOrder = _QosIpAceOrder_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 2, 1, 3),
    _QosIpAceOrder_Type()
)
...
qosIpAclDefAceId = _QosIpAclDefAceId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 2, 1, 4),
...
qosIpAclActionEntry = _QosIpAclActionEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1)
)
qosIpAclActionEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosIpAclActionId"),
)
if mibBuilder.loadTexts:
...
qosIpAclActionId = _QosIpAclActionId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1, 1),
...
qosIpAclActAclId = _QosIpAclActAclId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1, 2),
...
qosIpAclInterfaceRoles = _QosIpAclInterfaceRoles_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1, 3),
...
qosIpAclInterfaceDirection = _QosIpAclInterfaceDirection_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1, 4),
...
qosIpAclOrder = _QosIpAclOrder_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1, 5),
    _QosIpAclOrder_Type()
)
...
qosIpAclDscp = _QosIpAclDscp_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1, 6),
    _QosIpAclDscp_Type()
)
...
qosIpAclDscpTrusted = _QosIpAclDscpTrusted_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1, 7),
...
qosIpAclMicroFlowPolicerId = _QosIpAclMicroFlowPolicerId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1, 8),
...
qosIpAclAggregateId = _QosIpAclAggregateId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 7, 3, 1, 9),
...
qosIfSchedulingPreferenceEntry = _QosIfSchedulingPreferenceEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 1, 1)
)
qosIfSchedulingPreferenceEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosIfSchedulingPreferenceId"),
)
if mibBuilder.loadTexts:
...
qosIfSchedulingPreferenceId = _QosIfSchedulingPreferenceId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 1, 1, 1),
...
qosIfSchedulingRoles = _QosIfSchedulingRoles_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 1, 1, 2),
...
qosIfSchedulingPreference = _QosIfSchedulingPreference_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 1, 1, 3),
...
qosIfSchedulingDiscipline = _QosIfSchedulingDiscipline_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 1, 1, 4),
...
qosIfSchedulingQueueType = _QosIfSchedulingQueueType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 1, 1, 5),
...
qosIfDropPreferenceEntry = _QosIfDropPreferenceEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 2, 1)
)
qosIfDropPreferenceEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosIfDropPreferenceId"),
)
if mibBuilder.loadTexts:
...
qosIfDropPreferenceId = _QosIfDropPreferenceId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 2, 1, 1),
...
qosIfDropRoles = _QosIfDropRoles_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 2, 1, 2),
...
qosIfDropPreference = _QosIfDropPreference_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 2, 1, 3),
...
qosIfDropDiscipline = _QosIfDropDiscipline_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 2, 1, 4),
...
qosIfDscpAssignmentEntry = _QosIfDscpAssignmentEntry_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 3, 1)
)
qosIfDscpAssignmentEntry.setIndexNames(
    (0, "FS-NMS-QOS-PIB-MIB", "qosIfDscpAssignmentId"),
)
if mibBuilder.loadTexts:
...
qosIfDscpAssignmentId = _QosIfDscpAssignmentId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 3, 1, 1),
...
qosIfDscpRoles = _QosIfDscpRoles_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 3, 1, 2),
...
qosIfQueueType = _QosIfQueueType_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 3, 1, 3),
...
qosIfDscp = _QosIfDscp_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 3, 1, 4),
    _QosIfDscp_Type()
)
...
qosIfQueue = _QosIfQueue_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 3, 1, 5),
    _QosIfQueue_Type()
)
...
qosIfThresholdSet = _QosIfThresholdSet_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 3, 1, 6),
...
qosIfRedId = _QosIfRedId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 4, 1, 1),
    _QosIfRedId_Type()
)
...
qosIfRedRoles = _QosIfRedRoles_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 4, 1, 2),
    _QosIfRedRoles_Type()
)
...
qosIfRedThresholdSet = _QosIfRedThresholdSet_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 4, 1, 4),
...
qosIfRedThresholdSetLower = _QosIfRedThresholdSetLower_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 4, 1, 5),
...
qosIfRedThresholdSetUpper = _QosIfRedThresholdSetUpper_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 4, 1, 6),
...
qosIfTailDropId = _QosIfTailDropId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 5, 1, 1),
...
qosIfTailDropRoles = _QosIfTailDropRoles_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 5, 1, 2),
...
qosIfTailDropNumThresholdSets = _QosIfTailDropNumThresholdSets_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 5, 1, 3),
...
qosIfTailDropThresholdSet = _QosIfTailDropThresholdSet_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 5, 1, 4),
...
qosIfTailDropThresholdSetValue = _QosIfTailDropThresholdSetValue_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 5, 1, 5),
...
qosIfWeightsId = _QosIfWeightsId_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 6, 1, 1),
...
qosIfWeightsRoles = _QosIfWeightsRoles_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 6, 1, 2),
...
qosIfWeightsQueue = _QosIfWeightsQueue_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 6, 1, 4),
...
qosIfWeightsDrainSize = _QosIfWeightsDrainSize_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 6, 1, 5),
...
qosIfWeightsQueueSize = _QosIfWeightsQueueSize_Object(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 8, 6, 1, 6),
...
qosDevicePibIncarnationTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 1)
)
qosDevicePibIncarnationTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosDevicePdpName"),
        ("FS-NMS-QOS-PIB-MIB", "qosDevicePibIncarnation"),
        ("FS-NMS-QOS-PIB-MIB", "qosDevicePibTtl"))
)
if mibBuilder.loadTexts:
    qosDevicePibIncarnationTableGroup.setStatus("current")

qosDeviceAttributeTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 2)
)
qosDeviceAttributeTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosDevicePepDomain"),
        ("FS-NMS-QOS-PIB-MIB", "qosDevicePrimaryPdp"),
        ("FS-NMS-QOS-PIB-MIB", "qosDeviceSecondaryPdp"),
        ("FS-NMS-QOS-PIB-MIB", "qosDeviceMaxMessageSize"),
        ("FS-NMS-QOS-PIB-MIB", "qosDeviceCapabilities"))
)
if mibBuilder.loadTexts:
    qosDeviceAttributeTableGroup.setStatus("current")

qosInterfaceTypeTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 3)
)
qosInterfaceTypeTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosInterfaceQueueType"),
        ("FS-NMS-QOS-PIB-MIB", "qosInterfaceTypeRoles"),
        ("FS-NMS-QOS-PIB-MIB", "qosInterfaceTypeCapabilities"))
)
if mibBuilder.loadTexts:
    qosInterfaceTypeTableGroup.setStatus("current")

qosDiffServMappingTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 4)
)
qosDiffServMappingTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosMarkedDscp"),
        ("FS-NMS-QOS-PIB-MIB", "qosL2Cos"))
)
if mibBuilder.loadTexts:
    qosDiffServMappingTableGroup.setStatus("current")

qosCosToDscpTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 5)
)
qosCosToDscpTableGroup.setObjects(
    ("FS-NMS-QOS-PIB-MIB", "qosCosToDscpDscp")
)
if mibBuilder.loadTexts:
    qosCosToDscpTableGroup.setStatus("current")

qosUnmatchedPolicyTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 6)
)
qosUnmatchedPolicyTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosUnmatchedPolicyRole"),
        ("FS-NMS-QOS-PIB-MIB", "qosUnmatchedPolicyDirection"),
        ("FS-NMS-QOS-PIB-MIB", "qosUnmatchedPolicyDscp"),
        ("FS-NMS-QOS-PIB-MIB", "qosUnmatchedPolicyDscpTrusted"),
        ("FS-NMS-QOS-PIB-MIB", "qosUnmatchPolMicroFlowPolicerId"),
        ("FS-NMS-QOS-PIB-MIB", "qosUnmatchedPolicyAggregateId"))
)
if mibBuilder.loadTexts:
    qosUnmatchedPolicyTableGroup.setStatus("current")

qosPolicerTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 7)
)
qosPolicerTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosPolicerRate"),
        ("FS-NMS-QOS-PIB-MIB", "qosPolicerNormalBurst"),
        ("FS-NMS-QOS-PIB-MIB", "qosPolicerExcessBurst"),
        ("FS-NMS-QOS-PIB-MIB", "qosPolicerAction"))
)
if mibBuilder.loadTexts:
    qosPolicerTableGroup.setStatus("current")

qosAggregateTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 8)
)
qosAggregateTableGroup.setObjects(
    ("FS-NMS-QOS-PIB-MIB", "qosAggregatePolicerId")
)
if mibBuilder.loadTexts:
    qosAggregateTableGroup.setStatus("current")

qosMacClassificationTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 9)
)
qosMacClassificationTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosDstMacVlan"),
        ("FS-NMS-QOS-PIB-MIB", "qosDstMacAddress"),
        ("FS-NMS-QOS-PIB-MIB", "qosDstMacCos"))
)
if mibBuilder.loadTexts:
    qosMacClassificationTableGroup.setStatus("current")

qosIpAceTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 10)
)
qosIpAceTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosIpAceDstAddr"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceDstAddrMask"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceSrcAddr"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceSrcAddrMask"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceDscpMin"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceDscpMax"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceProtocol"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceDstL4PortMin"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceDstL4PortMax"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceSrcL4PortMin"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceSrcL4PortMax"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAcePermit"))
)
if mibBuilder.loadTexts:
    qosIpAceTableGroup.setStatus("current")

qosIpAclDefinitionTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 11)
)
qosIpAclDefinitionTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosIpAclId"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAceOrder"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAclDefAceId"))
)
if mibBuilder.loadTexts:
    qosIpAclDefinitionTableGroup.setStatus("current")

qosIpAclActionTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 12)
)
qosIpAclActionTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosIpAclActAclId"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAclInterfaceRoles"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAclInterfaceDirection"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAclOrder"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAclDscp"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAclDscpTrusted"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAclMicroFlowPolicerId"),
        ("FS-NMS-QOS-PIB-MIB", "qosIpAclAggregateId"))
)
if mibBuilder.loadTexts:
    qosIpAclActionTableGroup.setStatus("current")

qosIfSchedulingPreferencesTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 13)
)
qosIfSchedulingPreferencesTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosIfSchedulingRoles"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfSchedulingPreference"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfSchedulingDiscipline"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfSchedulingQueueType"))
)
if mibBuilder.loadTexts:
    qosIfSchedulingPreferencesTableGroup.setStatus("current")

qosIfDropPreferenceTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 14)
)
qosIfDropPreferenceTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosIfDropRoles"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfDropPreference"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfDropDiscipline"))
)
if mibBuilder.loadTexts:
    qosIfDropPreferenceTableGroup.setStatus("current")

qosIfDscpAssignmentTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 15)
)
qosIfDscpAssignmentTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosIfDscpRoles"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfQueueType"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfDscp"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfQueue"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfThresholdSet"))
)
if mibBuilder.loadTexts:
    qosIfDscpAssignmentTableGroup.setStatus("current")

qosIfRedTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 16)
)
qosIfRedTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosIfRedRoles"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfRedNumThresholdSets"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfRedThresholdSet"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfRedThresholdSetLower"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfRedThresholdSetUpper"))
)
if mibBuilder.loadTexts:
    qosIfRedTableGroup.setStatus("current")

qosIfTailDropTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 17)
)
qosIfTailDropTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosIfTailDropRoles"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfTailDropNumThresholdSets"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfTailDropThresholdSet"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfTailDropThresholdSetValue"))
)
if mibBuilder.loadTexts:
    qosIfTailDropTableGroup.setStatus("current")

qosIfWeightsTableGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 2, 18)
)
qosIfWeightsTableGroup.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosIfWeightsRoles"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfWeightsNumQueues"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfWeightsQueue"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfWeightsDrainSize"),
        ("FS-NMS-QOS-PIB-MIB", "qosIfWeightsQueueSize"))
)
if mibBuilder.loadTexts:
...
qosPIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 52642, 18, 2, 1, 1, 1, 1)
)
qosPIBCompliance.setObjects(
      *(("FS-NMS-QOS-PIB-MIB", "qosDevicePibIncarnationTableGroup"),
        ("FS-NMS-QOS-PIB-MIB", "qosDeviceAttributeTableGroup"),
        ("FS-NMS-QOS-PIB-MIB", "qosInterfaceTypeTableGroup"))
)
if mibBuilder.loadTexts:
