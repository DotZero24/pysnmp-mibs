...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-CAPABILITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:26:30 2025
...
cucsCapabilityFeatureLimitsMinUCSMVersion = _CucsCapabilityFeatureLimitsMinUCSMVersion_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 7, 11, 1, 9),
    _CucsCapabilityFeatureLimitsMinUCSMVersion_Type()
)
cucsCapabilityFeatureLimitsMinUCSMVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsCapabilityFeatureLimitsMinUCSMVersion.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsCapabilityObjects": cucsCapabilityObjects,
       ...
       "cucsCapabilityFeatureLimitsMinUCSMVersion": cucsCapabilityFeatureLimitsMinUCSMVersion,
