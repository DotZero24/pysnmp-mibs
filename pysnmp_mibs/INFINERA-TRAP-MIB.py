...
# Notes
# -----
# ASN.1 source file://mibs/infinera/INFINERA-TRAP-MIB
...
emsTCAGroup.setObjects(
      *(("INFINERA-TRAP-MIB", "tcaEmsNotificationId"),
        ...
        ("INFINERA-TRAP-MIB", "tcaProbableCauseDescription"))
)
if mibBuilder.loadTexts:
