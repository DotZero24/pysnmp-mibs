...
mibBuilder.exportSymbols("DGS3120-24TC-LED-MIB", swLedInfoFrontPanelLedStatus=swLedInfoFrontPanelLedStatus, swLedMIBObject=swLedMIBObject, swLedMIB=swLedMIB, swLedInfoTable=swLedInfoTable, PYSNMP_MODULE_ID=swLedMIB, swLedInfoEntry=swLedInfoEntry, swLedInfoUnitId=swLedInfoUnitId)
