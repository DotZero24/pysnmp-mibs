...
# Produced by pysmi-1.6.2 at Fri Oct 10 21:05:56 2025
...
juniDhcpLocalServerPoolName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
juniDhcpLocalServerPoolInUse.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
juniDhcpLocalServerPoolSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
juniDhcpLocalServerPoolGroupName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
juniDhcpLocalServerPoolGroupSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
juniDhcpLocalServerPoolGroupInUse.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
juniDhcpLocalServerPoolGroupUtilPct.setMaxAccess("read-only")
if mibBuilder.loadTexts:
