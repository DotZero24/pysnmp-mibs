...
mibBuilder.exportSymbols("CISCOSMB-MIB", ciscosb=ciscosb, PYSNMP_MODULE_ID=cisco, otherEnterprises=otherEnterprises, rndMib=rndMib, cisco=cisco, switch001=switch001)
