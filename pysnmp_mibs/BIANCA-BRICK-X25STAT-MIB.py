...
mibBuilder.exportSymbols("BIANCA-BRICK-X25STAT-MIB", x25MuxStats=x25MuxStats, x25ToTcpCurrentRestart=x25ToTcpCurrentRestart, x25ToTcpRestart=x25ToTcpRestart, x25ToTcpIncTcpMaxConcPending=x25ToTcpIncTcpMaxConcPending, x25ToTcpX25CanPutEvReset=x25ToTcpX25CanPutEvReset, x25statMIB=x25statMIB, x25SwOutgoingFailed=x25SwOutgoingFailed, x25ToTcpIncTcpSucceeded=x25ToTcpIncTcpSucceeded, x25ToTcpUEvX25Listen=x25ToTcpUEvX25Listen, x25ToTcpTcpCanPutEvDisc=x25ToTcpTcpCanPutEvDisc, x25ToTcpUEvTcpListen=x25ToTcpUEvTcpListen, x25SwOutCurrentPending=x25SwOutCurrentPending, x25SwStats=x25SwStats, x25MuxIncMaxConcCalls=x25MuxIncMaxConcCalls, x25SwIncCurrentPending=x25SwIncCurrentPending, x25=x25, x25MuxOutMaxConcPending=x25MuxOutMaxConcPending, x25MuxIncomingAttempts=x25MuxIncomingAttempts, x25SwIncMaxConcCalls=x25SwIncMaxConcCalls, x25MuxOutgoingAttempts=x25MuxOutgoingAttempts, x25SwIncomingFailed=x25SwIncomingFailed, x25ToTcpIncX25Failed=x25ToTcpIncX25Failed, x25MuxIncCurrentPending=x25MuxIncCurrentPending, x25ToTcpOutTcpSucceeded=x25ToTcpOutTcpSucceeded, x25SwIncCurrentCalls=x25SwIncCurrentCalls, x25SwIncFailedTimeout=x25SwIncFailedTimeout, bibo=bibo, x25ToTcpIncX25CurrentPending=x25ToTcpIncX25CurrentPending, x25ToTcpUEvTcpData=x25ToTcpUEvTcpData, x25MuxOutCurrentPending=x25MuxOutCurrentPending, bintec=bintec, x25ToTcpIncTcpCurrentPending=x25ToTcpIncTcpCurrentPending, x25ToTcpIncX25CurrentCalls=x25ToTcpIncX25CurrentCalls, x25ToTcpX25CanPutEvDisc=x25ToTcpX25CanPutEvDisc, x25MuxIncCurrentCalls=x25MuxIncCurrentCalls, x25SwOutFailedTimeout=x25SwOutFailedTimeout, x25SwIncomingSucceeded=x25SwIncomingSucceeded, x25ToTcpOutTcpAttempts=x25ToTcpOutTcpAttempts, x25SwOutMaxConcPending=x25SwOutMaxConcPending, x25SwOutMaxConcCalls=x25SwOutMaxConcCalls, x25ToTcpTcpCanPutEvTok=x25ToTcpTcpCanPutEvTok, x25ToTcpIncX25MaxConcPending=x25ToTcpIncX25MaxConcPending, x25ToTcpX25CanPutEvTok=x25ToTcpX25CanPutEvTok, x25SwOutgoingAttempts=x25SwOutgoingAttempts, x25MuxIncomingFailed=x25MuxIncomingFailed, x25MuxOutgoingFailed=x25MuxOutgoingFailed, x25ToTcpIncTcpFailed=x25ToTcpIncTcpFailed, x25ToTcpUEvX25Data=x25ToTcpUEvX25Data, x25MuxIncMaxConcPending=x25MuxIncMaxConcPending, x25MuxOutMaxConcCalls=x25MuxOutMaxConcCalls, x25SwOutgoingSucceeded=x25SwOutgoingSucceeded, x25SwOutCurrentCalls=x25SwOutCurrentCalls, x25MuxOutCurrentCalls=x25MuxOutCurrentCalls, x25SwIncomingAttempts=x25SwIncomingAttempts, x25MuxIncResets=x25MuxIncResets, x25ToTcpOutX25Attempts=x25ToTcpOutX25Attempts, x25MuxOutResets=x25MuxOutResets, x25ToTcpStats=x25ToTcpStats, x25ToTcpIncX25Succeeded=x25ToTcpIncX25Succeeded, x25ToTcpOutX25Succeeded=x25ToTcpOutX25Succeeded, x25MuxOutgoingSucceeded=x25MuxOutgoingSucceeded, x25ToTcpIncTcpAttempts=x25ToTcpIncTcpAttempts, x25MuxInstCnt=x25MuxInstCnt, x25ToTcpIncTcpCurrentCalls=x25ToTcpIncTcpCurrentCalls, x25ToTcpIncTcpMaxConcCalls=x25ToTcpIncTcpMaxConcCalls, x25ToTcpOutTcpFailed=x25ToTcpOutTcpFailed, x25SwIncMaxConcPending=x25SwIncMaxConcPending, x25MuxIncomingSucceeded=x25MuxIncomingSucceeded, x25ToTcpIncX25Attempts=x25ToTcpIncX25Attempts, x25ToTcpIncX25MaxConcCalls=x25ToTcpIncX25MaxConcCalls, x25ToTcpOutX25Failed=x25ToTcpOutX25Failed, x25ToTcpTotalRestart=x25ToTcpTotalRestart, x25SwCallCnt=x25SwCallCnt)
