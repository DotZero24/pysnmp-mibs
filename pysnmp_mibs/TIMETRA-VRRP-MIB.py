...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-VRRP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:58:19 2025
...
(LAGInterfaceNumber,
 ...
 TmnxPortID,
 TmnxServId,
 TmnxTunnelGroupId) = mibBuilder.importSymbols(
    "TIMETRA-TC-MIB",
    "LAGInterfaceNumber",
    "TItemDescription",
    "TLNamedItemOrEmpty",
...
_TmnxVrrpOperVirtualMacAddr_Type.__name__ = "MacAddress"
...
_TmnxVrrpOperMismatchDiscard_Type.__name__ = "TruthValue"
...
_TmnxVrrpOperPingReply_Type.__name__ = "TruthValue"
...
_TmnxVrrpOperTelnetReply_Type.__name__ = "TruthValue"
...
_TmnxVrrpOperSshReply_Type.__name__ = "TruthValue"
...
_TmnxVrrpOperPolicyId_Type.__name__ = "Unsigned32"
...
_TmnxVrrpOperOwner_Type.__name__ = "TruthValue"
...
_TmnxVrrpOperAdvIntervalInherit_Type.__name__ = "TruthValue"
...
_TmnxVrrpOperTracerouteReply_Type.__name__ = "TruthValue"
...
_TmnxVrrpOperStandbyFwding_Type.__name__ = "TruthValue"
...
class _TmnxVrrpOperDownReason_Type(Integer32):
    """Custom type tmnxVrrpOperDownReason based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TmnxVrrpOperDownReason_Type.__name__ = "Integer32"
_TmnxVrrpOperDownReason_Object = MibTableColumn
tmnxVrrpOperDownReason = _TmnxVrrpOperDownReason_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 1, 1, 22),
    _TmnxVrrpOperDownReason_Type()
)
tmnxVrrpOperDownReason.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVrrpOperDownReason.setStatus("current")


class _TmnxVrrpOperPassive_Type(TruthValue):
    """Custom type tmnxVrrpOperPassive based on TruthValue"""
    defaultValue = 2


_TmnxVrrpOperPassive_Type.__name__ = "TruthValue"
_TmnxVrrpOperPassive_Object = MibTableColumn
tmnxVrrpOperPassive = _TmnxVrrpOperPassive_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 1, 1, 23),
    _TmnxVrrpOperPassive_Type()
)
tmnxVrrpOperPassive.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpOperPassive.setStatus("current")
_TmnxVrrpOperRowStatus_Type = RowStatus
_TmnxVrrpOperRowStatus_Object = MibTableColumn
tmnxVrrpOperRowStatus = _TmnxVrrpOperRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 1, 1, 24),
    _TmnxVrrpOperRowStatus_Type()
)
tmnxVrrpOperRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpOperRowStatus.setStatus("current")


class _TmnxVrrpOperGroupName_Type(TNamedItemOrEmpty):
    """Custom type tmnxVrrpOperGroupName based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxVrrpOperGroupName_Type.__name__ = "TNamedItemOrEmpty"
_TmnxVrrpOperGroupName_Object = MibTableColumn
tmnxVrrpOperGroupName = _TmnxVrrpOperGroupName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 1, 1, 25),
    _TmnxVrrpOperGroupName_Type()
)
tmnxVrrpOperGroupName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpOperGroupName.setStatus("current")


class _TmnxVrrpOperNtpReply_Type(TruthValue):
    """Custom type tmnxVrrpOperNtpReply based on TruthValue"""
    defaultValue = 2


_TmnxVrrpOperNtpReply_Type.__name__ = "TruthValue"
_TmnxVrrpOperNtpReply_Object = MibTableColumn
tmnxVrrpOperNtpReply = _TmnxVrrpOperNtpReply_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 1, 1, 26),
    _TmnxVrrpOperNtpReply_Type()
)
tmnxVrrpOperNtpReply.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpOperNtpReply.setStatus("current")
...
_TVrrpOpVirtualMacAddr_Type.__name__ = "MacAddress"
...
_TVrrpOpPingReply_Type.__name__ = "TruthValue"
...
_TVrrpOpTelnetReply_Type.__name__ = "TruthValue"
...
_TVrrpOpPolicyId_Type.__name__ = "Unsigned32"
...
_TVrrpOpOwner_Type.__name__ = "TruthValue"
...
_TVrrpOpAdvIntervalInherit_Type.__name__ = "TruthValue"
...
_TVrrpOpTracerouteReply_Type.__name__ = "TruthValue"
...
_TVrrpOpStandbyFwding_Type.__name__ = "TruthValue"
...
class _TVrrpOpPassive_Type(TruthValue):
    """Custom type tVrrpOpPassive based on TruthValue"""
    defaultValue = 2


_TVrrpOpPassive_Type.__name__ = "TruthValue"
_TVrrpOpPassive_Object = MibTableColumn
tVrrpOpPassive = _TVrrpOpPassive_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 7, 1, 20),
    _TVrrpOpPassive_Type()
)
tVrrpOpPassive.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpOpPassive.setStatus("current")
_TVrrpOpRowStatus_Type = RowStatus
_TVrrpOpRowStatus_Object = MibTableColumn
tVrrpOpRowStatus = _TVrrpOpRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 7, 1, 21),
    _TVrrpOpRowStatus_Type()
)
tVrrpOpRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpOpRowStatus.setStatus("current")


class _TVrrpOpOperGroupName_Type(TNamedItemOrEmpty):
    """Custom type tVrrpOpOperGroupName based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TVrrpOpOperGroupName_Type.__name__ = "TNamedItemOrEmpty"
_TVrrpOpOperGroupName_Object = MibTableColumn
tVrrpOpOperGroupName = _TVrrpOpOperGroupName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 7, 1, 25),
    _TVrrpOpOperGroupName_Type()
)
tVrrpOpOperGroupName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpOpOperGroupName.setStatus("current")


class _TVrrpOpNtpReply_Type(TruthValue):
    """Custom type tVrrpOpNtpReply based on TruthValue"""
    defaultValue = 2


_TVrrpOpNtpReply_Type.__name__ = "TruthValue"
_TVrrpOpNtpReply_Object = MibTableColumn
tVrrpOpNtpReply = _TVrrpOpNtpReply_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 7, 1, 26),
    _TVrrpOpNtpReply_Type()
)
tVrrpOpNtpReply.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpOpNtpReply.setStatus("current")
...
_TVrrpIpv6RouterAdvertUseVirtualMac_Type.__name__ = "TruthValue"
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfEntry.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfVrIdIpType.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcId.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfIfName.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfDestIpType.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfDestIp.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfRowStatus.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfLastChgd.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSrcIpType.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSrcIp.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSessOperState.setStatus("obsolete")
_TVrrpAssoBfdIntfSvcTblLastChgd_Type = TimeStamp
_TVrrpAssoBfdIntfSvcTblLastChgd_Object = MibScalar
tVrrpAssoBfdIntfSvcTblLastChgd = _TVrrpAssoBfdIntfSvcTblLastChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 13),
    _TVrrpAssoBfdIntfSvcTblLastChgd_Type()
)
tVrrpAssoBfdIntfSvcTblLastChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcTblLastChgd.setStatus("current")
_TVrrpAssoBfdIntfSvcTable_Object = MibTable
tVrrpAssoBfdIntfSvcTable = _TVrrpAssoBfdIntfSvcTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14)
)
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcTable.setStatus("current")
_TVrrpAssoBfdIntfSvcEntry_Object = MibTableRow
tVrrpAssoBfdIntfSvcEntry = _TVrrpAssoBfdIntfSvcEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1)
)
tVrrpAssoBfdIntfSvcEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcVrIdIpType"),
    (0, "VRRP-MIB", "vrrpOperVrId"),
)
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcEntry.setStatus("current")
_TVrrpAssoBfdIntfSvcVrIdIpType_Type = InetAddressType
_TVrrpAssoBfdIntfSvcVrIdIpType_Object = MibTableColumn
tVrrpAssoBfdIntfSvcVrIdIpType = _TVrrpAssoBfdIntfSvcVrIdIpType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 1),
    _TVrrpAssoBfdIntfSvcVrIdIpType_Type()
)
tVrrpAssoBfdIntfSvcVrIdIpType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcVrIdIpType.setStatus("current")
_TVrrpAssoBfdIntfSvcSvcId_Type = TmnxServId
_TVrrpAssoBfdIntfSvcSvcId_Object = MibTableColumn
tVrrpAssoBfdIntfSvcSvcId = _TVrrpAssoBfdIntfSvcSvcId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 2),
    _TVrrpAssoBfdIntfSvcSvcId_Type()
)
tVrrpAssoBfdIntfSvcSvcId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcSvcId.setStatus("current")
_TVrrpAssoBfdIntfSvcIfName_Type = TNamedItem
_TVrrpAssoBfdIntfSvcIfName_Object = MibTableColumn
tVrrpAssoBfdIntfSvcIfName = _TVrrpAssoBfdIntfSvcIfName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 3),
    _TVrrpAssoBfdIntfSvcIfName_Type()
)
tVrrpAssoBfdIntfSvcIfName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcIfName.setStatus("current")
_TVrrpAssoBfdIntfSvcDestIpType_Type = InetAddressType
_TVrrpAssoBfdIntfSvcDestIpType_Object = MibTableColumn
tVrrpAssoBfdIntfSvcDestIpType = _TVrrpAssoBfdIntfSvcDestIpType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 4),
    _TVrrpAssoBfdIntfSvcDestIpType_Type()
)
tVrrpAssoBfdIntfSvcDestIpType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcDestIpType.setStatus("current")


class _TVrrpAssoBfdIntfSvcDestIp_Type(InetAddress):
    """Custom type tVrrpAssoBfdIntfSvcDestIp based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_TVrrpAssoBfdIntfSvcDestIp_Type.__name__ = "InetAddress"
_TVrrpAssoBfdIntfSvcDestIp_Object = MibTableColumn
tVrrpAssoBfdIntfSvcDestIp = _TVrrpAssoBfdIntfSvcDestIp_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 5),
    _TVrrpAssoBfdIntfSvcDestIp_Type()
)
tVrrpAssoBfdIntfSvcDestIp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcDestIp.setStatus("current")
_TVrrpAssoBfdIntfSvcRowStatus_Type = RowStatus
_TVrrpAssoBfdIntfSvcRowStatus_Object = MibTableColumn
tVrrpAssoBfdIntfSvcRowStatus = _TVrrpAssoBfdIntfSvcRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 6),
    _TVrrpAssoBfdIntfSvcRowStatus_Type()
)
tVrrpAssoBfdIntfSvcRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcRowStatus.setStatus("current")
_TVrrpAssoBfdIntfSvcLastChgd_Type = TimeStamp
_TVrrpAssoBfdIntfSvcLastChgd_Object = MibTableColumn
tVrrpAssoBfdIntfSvcLastChgd = _TVrrpAssoBfdIntfSvcLastChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 7),
    _TVrrpAssoBfdIntfSvcLastChgd_Type()
)
tVrrpAssoBfdIntfSvcLastChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcLastChgd.setStatus("current")
_TVrrpAssoBfdIntfSvcSrcIpType_Type = InetAddressType
_TVrrpAssoBfdIntfSvcSrcIpType_Object = MibTableColumn
tVrrpAssoBfdIntfSvcSrcIpType = _TVrrpAssoBfdIntfSvcSrcIpType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 8),
    _TVrrpAssoBfdIntfSvcSrcIpType_Type()
)
tVrrpAssoBfdIntfSvcSrcIpType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcSrcIpType.setStatus("current")


class _TVrrpAssoBfdIntfSvcSrcIp_Type(InetAddress):
    """Custom type tVrrpAssoBfdIntfSvcSrcIp based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_TVrrpAssoBfdIntfSvcSrcIp_Type.__name__ = "InetAddress"
_TVrrpAssoBfdIntfSvcSrcIp_Object = MibTableColumn
tVrrpAssoBfdIntfSvcSrcIp = _TVrrpAssoBfdIntfSvcSrcIp_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 9),
    _TVrrpAssoBfdIntfSvcSrcIp_Type()
)
tVrrpAssoBfdIntfSvcSrcIp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcSrcIp.setStatus("current")
_TVrrpAssoBfdIntfSvcSessOperState_Type = TmnxVrrpAssoBfdIntfSessOperState
_TVrrpAssoBfdIntfSvcSessOperState_Object = MibTableColumn
tVrrpAssoBfdIntfSvcSessOperState = _TVrrpAssoBfdIntfSvcSessOperState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 10),
    _TVrrpAssoBfdIntfSvcSessOperState_Type()
)
tVrrpAssoBfdIntfSvcSessOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcSessOperState.setStatus("current")


class _TVrrpAssoBfdIntfSvcName_Type(TLNamedItemOrEmpty):
    """Custom type tVrrpAssoBfdIntfSvcName based on TLNamedItemOrEmpty"""
    defaultHexValue = ""


_TVrrpAssoBfdIntfSvcName_Type.__name__ = "TLNamedItemOrEmpty"
_TVrrpAssoBfdIntfSvcName_Object = MibTableColumn
tVrrpAssoBfdIntfSvcName = _TVrrpAssoBfdIntfSvcName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 1, 14, 1, 11),
    _TVrrpAssoBfdIntfSvcName_Type()
)
tVrrpAssoBfdIntfSvcName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpAssoBfdIntfSvcName.setStatus("current")
...
_TmnxVrrpPolicyDescription_Type.__name__ = "TItemDescription"
...
_TmnxVrrpPolicySvcContext_Type.__name__ = "TmnxServId"
...
class _TmnxVrrpPolicyAdminState_Type(TmnxAdminState):
    """Custom type tmnxVrrpPolicyAdminState based on TmnxAdminState"""
    defaultValue = 2


_TmnxVrrpPolicyAdminState_Type.__name__ = "TmnxAdminState"
_TmnxVrrpPolicyAdminState_Object = MibTableColumn
tmnxVrrpPolicyAdminState = _TmnxVrrpPolicyAdminState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 1, 1, 9),
    _TmnxVrrpPolicyAdminState_Type()
)
tmnxVrrpPolicyAdminState.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpPolicyAdminState.setStatus("current")


class _TmnxVrrpPolicySvcNameContext_Type(TLNamedItemOrEmpty):
    """Custom type tmnxVrrpPolicySvcNameContext based on TLNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxVrrpPolicySvcNameContext_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxVrrpPolicySvcNameContext_Object = MibTableColumn
tmnxVrrpPolicySvcNameContext = _TmnxVrrpPolicySvcNameContext_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 1, 1, 10),
    _TmnxVrrpPolicySvcNameContext_Type()
)
tmnxVrrpPolicySvcNameContext.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpPolicySvcNameContext.setStatus("current")
...
_TmnxVrrpPortDownEventPriority_Type.__name__ = "TmnxVrrpPriority"
...
_TmnxVrrpPortDownEventType_Type.__name__ = "TmnxEventType"
...
_TmnxVrrpPortDownEventHoldSet_Type.__name__ = "TmnxEventHoldSet"
...
_TmnxVrrpPortDownEventHoldClear_Type.__name__ = "TmnxEventHoldClear"
...
_TmnxVrrpLagPortDownEventHoldSet_Type.__name__ = "TmnxEventHoldSet"
...
class _TmnxVrrpLagPortDownEventOperState_Type(Integer32):
    """Custom type tmnxVrrpLagPortDownEventOperState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TmnxVrrpLagPortDownEventOperState_Type.__name__ = "Integer32"
...
class _TmnxVrrpLagPortDownEventPrevState_Type(Integer32):
    """Custom type tmnxVrrpLagPortDownEventPrevState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65),
    )
...
_TmnxVrrpLagPortDownEventPrevState_Type.__name__ = "Integer32"
...
_TmnxVrrpLagPortDownEventHoldClear_Type.__name__ = "TmnxEventHoldClear"
...
_TmnxVrrpLagNumberDownEventPriority_Type.__name__ = "TmnxVrrpPriority"
...
_TmnxVrrpLagNumberDownEventType_Type.__name__ = "TmnxEventType"
...
_TmnxVrrpHostUnreachableEventPriority_Type.__name__ = "TmnxVrrpPriority"
...
_TmnxVrrpHostUnreachableEventType_Type.__name__ = "TmnxEventType"
...
_TmnxVrrpHostUnreachableEventHoldSet_Type.__name__ = "TmnxEventHoldSet"
...
_TmnxVrrpHostUnreachableEventHoldClear_Type.__name__ = "TmnxEventHoldClear"
...
class _TmnxVrrpHostUnreachableEvtSize_Type(Unsigned32):
    """Custom type tmnxVrrpHostUnreachableEvtSize based on Unsigned32"""
    defaultValue = 56
...
_TmnxVrrpHostUnreachableEvtSize_Type.__name__ = "Unsigned32"
_TmnxVrrpHostUnreachableEvtSize_Object = MibTableColumn
tmnxVrrpHostUnreachableEvtSize = _TmnxVrrpHostUnreachableEvtSize_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 5, 1, 17),
    _TmnxVrrpHostUnreachableEvtSize_Type()
)
tmnxVrrpHostUnreachableEvtSize.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpHostUnreachableEvtSize.setStatus("current")
if mibBuilder.loadTexts:
    tmnxVrrpHostUnreachableEvtSize.setUnits("bytes")
...
_TmnxVrrpRouteUnknownEventPriority_Type.__name__ = "TmnxVrrpPriority"
...
_TmnxVrrpRouteUnknownEventType_Type.__name__ = "TmnxEventType"
...
_TmnxVrrpRouteUnknownEventHoldSet_Type.__name__ = "TmnxEventHoldSet"
...
_TmnxVrrpRouteUnknownEventLessSpecific_Type.__name__ = "TruthValue"
...
_TmnxVrrpRouteUnknownEventDefaultAllowed_Type.__name__ = "TruthValue"
...
_TmnxVrrpRouteUnknownEventHoldClear_Type.__name__ = "TmnxEventHoldClear"
...
_TVrrpHstUnrchEvtPriority_Type.__name__ = "TmnxVrrpPriority"
...
_TVrrpHstUnrchEvtType_Type.__name__ = "TmnxEventType"
...
_TVrrpHstUnrchEvtHoldSet_Type.__name__ = "TmnxEventHoldSet"
...
_TVrrpHstUnrchEvtHoldClear_Type.__name__ = "TmnxEventHoldClear"
...
class _TVrrpHstUnrchEvtSize_Type(Unsigned32):
    """Custom type tVrrpHstUnrchEvtSize based on Unsigned32"""
    defaultValue = 56
...
_TVrrpHstUnrchEvtSize_Type.__name__ = "Unsigned32"
_TVrrpHstUnrchEvtSize_Object = MibTableColumn
tVrrpHstUnrchEvtSize = _TVrrpHstUnrchEvtSize_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 9, 1, 20),
    _TVrrpHstUnrchEvtSize_Type()
)
tVrrpHstUnrchEvtSize.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpHstUnrchEvtSize.setStatus("current")
if mibBuilder.loadTexts:
    tVrrpHstUnrchEvtSize.setUnits("bytes")
...
_TVrrpRtUnknEvtPriority_Type.__name__ = "TmnxVrrpPriority"
...
_TVrrpRtUnknEvtType_Type.__name__ = "TmnxEventType"
...
_TVrrpRtUnknEvtHoldSet_Type.__name__ = "TmnxEventHoldSet"
...
_TVrrpRtUnknEvtLessSpecific_Type.__name__ = "TruthValue"
...
_TVrrpRtUnknEvtDefaultAllowed_Type.__name__ = "TruthValue"
...
_TVrrpRtUnknEvtHoldClear_Type.__name__ = "TmnxEventHoldClear"
...
_TVrrpPriEvtMcIPsecNoFwdTable_Object = MibTable
tVrrpPriEvtMcIPsecNoFwdTable = _TVrrpPriEvtMcIPsecNoFwdTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14)
)
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdTable.setStatus("current")
_TVrrpPriEvtMcIPsecNoFwdEntry_Object = MibTableRow
tVrrpPriEvtMcIPsecNoFwdEntry = _TVrrpPriEvtMcIPsecNoFwdEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1)
)
tVrrpPriEvtMcIPsecNoFwdEntry.setIndexNames(
    (0, "TIMETRA-VRRP-MIB", "tmnxVrrpPolicyId"),
    (0, "TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdTnlGrpId"),
)
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdEntry.setStatus("current")
_TVrrpPriEvtMcIPsecNoFwdTnlGrpId_Type = TmnxTunnelGroupId
_TVrrpPriEvtMcIPsecNoFwdTnlGrpId_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdTnlGrpId = _TVrrpPriEvtMcIPsecNoFwdTnlGrpId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 1),
    _TVrrpPriEvtMcIPsecNoFwdTnlGrpId_Type()
)
tVrrpPriEvtMcIPsecNoFwdTnlGrpId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdTnlGrpId.setStatus("current")
_TVrrpPriEvtMcIPsecNoFwdRowStatus_Type = RowStatus
_TVrrpPriEvtMcIPsecNoFwdRowStatus_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdRowStatus = _TVrrpPriEvtMcIPsecNoFwdRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 2),
    _TVrrpPriEvtMcIPsecNoFwdRowStatus_Type()
)
tVrrpPriEvtMcIPsecNoFwdRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdRowStatus.setStatus("current")


class _TVrrpPriEvtMcIPsecNoFwdPriority_Type(TmnxVrrpPriority):
    """Custom type tVrrpPriEvtMcIPsecNoFwdPriority based on TmnxVrrpPriority"""
    defaultValue = 0


_TVrrpPriEvtMcIPsecNoFwdPriority_Type.__name__ = "TmnxVrrpPriority"
_TVrrpPriEvtMcIPsecNoFwdPriority_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdPriority = _TVrrpPriEvtMcIPsecNoFwdPriority_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 3),
    _TVrrpPriEvtMcIPsecNoFwdPriority_Type()
)
tVrrpPriEvtMcIPsecNoFwdPriority.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdPriority.setStatus("current")


class _TVrrpPriEvtMcIPsecNoFwdType_Type(TmnxEventType):
    """Custom type tVrrpPriEvtMcIPsecNoFwdType based on TmnxEventType"""
    defaultValue = 1


_TVrrpPriEvtMcIPsecNoFwdType_Type.__name__ = "TmnxEventType"
_TVrrpPriEvtMcIPsecNoFwdType_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdType = _TVrrpPriEvtMcIPsecNoFwdType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 4),
    _TVrrpPriEvtMcIPsecNoFwdType_Type()
)
tVrrpPriEvtMcIPsecNoFwdType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdType.setStatus("current")


class _TVrrpPriEvtMcIPsecNoFwdHoldSet_Type(TmnxEventHoldSet):
    """Custom type tVrrpPriEvtMcIPsecNoFwdHoldSet based on TmnxEventHoldSet"""
    defaultValue = 0


_TVrrpPriEvtMcIPsecNoFwdHoldSet_Type.__name__ = "TmnxEventHoldSet"
_TVrrpPriEvtMcIPsecNoFwdHoldSet_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdHoldSet = _TVrrpPriEvtMcIPsecNoFwdHoldSet_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 5),
    _TVrrpPriEvtMcIPsecNoFwdHoldSet_Type()
)
tVrrpPriEvtMcIPsecNoFwdHoldSet.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdHoldSet.setStatus("current")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdHoldSet.setUnits("seconds")
_TVrrpPriEvtMcIPsecNoFwdOperState_Type = TmnxMcIPsecNoFwdEventOperState
_TVrrpPriEvtMcIPsecNoFwdOperState_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdOperState = _TVrrpPriEvtMcIPsecNoFwdOperState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 6),
    _TVrrpPriEvtMcIPsecNoFwdOperState_Type()
)
tVrrpPriEvtMcIPsecNoFwdOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdOperState.setStatus("current")
_TVrrpPriEvtMcIPsecNoFwdHoldSetR_Type = TmnxEventHoldSet
_TVrrpPriEvtMcIPsecNoFwdHoldSetR_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdHoldSetR = _TVrrpPriEvtMcIPsecNoFwdHoldSetR_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 7),
    _TVrrpPriEvtMcIPsecNoFwdHoldSetR_Type()
)
tVrrpPriEvtMcIPsecNoFwdHoldSetR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdHoldSetR.setStatus("current")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdHoldSetR.setUnits("seconds")
_TVrrpPriEvtMcIPsecNoFwdPrevState_Type = TmnxMcIPsecNoFwdEventOperState
_TVrrpPriEvtMcIPsecNoFwdPrevState_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdPrevState = _TVrrpPriEvtMcIPsecNoFwdPrevState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 8),
    _TVrrpPriEvtMcIPsecNoFwdPrevState_Type()
)
tVrrpPriEvtMcIPsecNoFwdPrevState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdPrevState.setStatus("current")
_TVrrpPriEvtMcIPsecNoFwdTransTm_Type = TimeStamp
_TVrrpPriEvtMcIPsecNoFwdTransTm_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdTransTm = _TVrrpPriEvtMcIPsecNoFwdTransTm_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 9),
    _TVrrpPriEvtMcIPsecNoFwdTransTm_Type()
)
tVrrpPriEvtMcIPsecNoFwdTransTm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdTransTm.setStatus("current")
_TVrrpPriEvtMcIPsecNoFwdSetCntr_Type = Counter32
_TVrrpPriEvtMcIPsecNoFwdSetCntr_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdSetCntr = _TVrrpPriEvtMcIPsecNoFwdSetCntr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 10),
    _TVrrpPriEvtMcIPsecNoFwdSetCntr_Type()
)
tVrrpPriEvtMcIPsecNoFwdSetCntr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdSetCntr.setStatus("current")
_TVrrpPriEvtMcIPsecNoFwdInUse_Type = TruthValue
_TVrrpPriEvtMcIPsecNoFwdInUse_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdInUse = _TVrrpPriEvtMcIPsecNoFwdInUse_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 11),
    _TVrrpPriEvtMcIPsecNoFwdInUse_Type()
)
tVrrpPriEvtMcIPsecNoFwdInUse.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdInUse.setStatus("current")


class _TVrrpPriEvtMcIPsecNoFwdHoldClr_Type(TmnxEventHoldClear):
    """Custom type tVrrpPriEvtMcIPsecNoFwdHoldClr based on TmnxEventHoldClear"""
    defaultValue = 0


_TVrrpPriEvtMcIPsecNoFwdHoldClr_Type.__name__ = "TmnxEventHoldClear"
_TVrrpPriEvtMcIPsecNoFwdHoldClr_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdHoldClr = _TVrrpPriEvtMcIPsecNoFwdHoldClr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 12),
    _TVrrpPriEvtMcIPsecNoFwdHoldClr_Type()
)
tVrrpPriEvtMcIPsecNoFwdHoldClr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdHoldClr.setStatus("current")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdHoldClr.setUnits("seconds")
_TVrrpPriEvtMcIPsecNoFwdHoldClrR_Type = TmnxEventHoldClear
_TVrrpPriEvtMcIPsecNoFwdHoldClrR_Object = MibTableColumn
tVrrpPriEvtMcIPsecNoFwdHoldClrR = _TVrrpPriEvtMcIPsecNoFwdHoldClrR_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 14, 1, 13),
    _TVrrpPriEvtMcIPsecNoFwdHoldClrR_Type()
)
tVrrpPriEvtMcIPsecNoFwdHoldClrR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdHoldClrR.setStatus("current")
if mibBuilder.loadTexts:
    tVrrpPriEvtMcIPsecNoFwdHoldClrR.setUnits("seconds")
_TmnxVrrpLagWtDownEventTblLastChg_Type = TimeStamp
_TmnxVrrpLagWtDownEventTblLastChg_Object = MibScalar
tmnxVrrpLagWtDownEventTblLastChg = _TmnxVrrpLagWtDownEventTblLastChg_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 15),
    _TmnxVrrpLagWtDownEventTblLastChg_Type()
)
tmnxVrrpLagWtDownEventTblLastChg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxVrrpLagWtDownEventTblLastChg.setStatus("current")
_TmnxVrrpLagWtDownEventTable_Object = MibTable
tmnxVrrpLagWtDownEventTable = _TmnxVrrpLagWtDownEventTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 16)
)
if mibBuilder.loadTexts:
    tmnxVrrpLagWtDownEventTable.setStatus("current")
_TmnxVrrpLagWtDownEventEntry_Object = MibTableRow
tmnxVrrpLagWtDownEventEntry = _TmnxVrrpLagWtDownEventEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 16, 1)
)
tmnxVrrpLagWtDownEventEntry.setIndexNames(
    (0, "TIMETRA-VRRP-MIB", "tmnxVrrpPolicyId"),
    (0, "TIMETRA-VRRP-MIB", "tmnxVrrpLagPortDownEventLagId"),
    (0, "TIMETRA-VRRP-MIB", "tmnxVrrpLagWtDown"),
)
if mibBuilder.loadTexts:
    tmnxVrrpLagWtDownEventEntry.setStatus("current")
_TmnxVrrpLagWtDown_Type = Unsigned32
_TmnxVrrpLagWtDown_Object = MibTableColumn
tmnxVrrpLagWtDown = _TmnxVrrpLagWtDown_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 16, 1, 1),
    _TmnxVrrpLagWtDown_Type()
)
tmnxVrrpLagWtDown.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxVrrpLagWtDown.setStatus("current")
_TmnxVrrpLagWtDownEventRowStatus_Type = RowStatus
_TmnxVrrpLagWtDownEventRowStatus_Object = MibTableColumn
tmnxVrrpLagWtDownEventRowStatus = _TmnxVrrpLagWtDownEventRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 16, 1, 2),
    _TmnxVrrpLagWtDownEventRowStatus_Type()
)
tmnxVrrpLagWtDownEventRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpLagWtDownEventRowStatus.setStatus("current")


class _TmnxVrrpLagWtDownEventPriority_Type(TmnxVrrpPriority):
    """Custom type tmnxVrrpLagWtDownEventPriority based on TmnxVrrpPriority"""
    defaultValue = 0


_TmnxVrrpLagWtDownEventPriority_Type.__name__ = "TmnxVrrpPriority"
_TmnxVrrpLagWtDownEventPriority_Object = MibTableColumn
tmnxVrrpLagWtDownEventPriority = _TmnxVrrpLagWtDownEventPriority_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 16, 1, 3),
    _TmnxVrrpLagWtDownEventPriority_Type()
)
tmnxVrrpLagWtDownEventPriority.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpLagWtDownEventPriority.setStatus("current")


class _TmnxVrrpLagWtDownEventType_Type(TmnxEventType):
    """Custom type tmnxVrrpLagWtDownEventType based on TmnxEventType"""
    defaultValue = 1


_TmnxVrrpLagWtDownEventType_Type.__name__ = "TmnxEventType"
_TmnxVrrpLagWtDownEventType_Object = MibTableColumn
tmnxVrrpLagWtDownEventType = _TmnxVrrpLagWtDownEventType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 20, 2, 16, 1, 4),
    _TmnxVrrpLagWtDownEventType_Type()
)
tmnxVrrpLagWtDownEventType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxVrrpLagWtDownEventType.setStatus("current")
...
if mibBuilder.loadTexts:
    tVrrpBfdV9v0Group.setStatus("obsolete")
...
tVrrpMcIPsecGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 24)
)
tVrrpMcIPsecGroup.setObjects(
      *(("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdRowStatus"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdPriority"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdType"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdHoldSet"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdOperState"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdHoldSetR"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdPrevState"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdTransTm"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdSetCntr"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdInUse"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdHoldClr"),
        ("TIMETRA-VRRP-MIB", "tVrrpPriEvtMcIPsecNoFwdHoldClrR"))
)
if mibBuilder.loadTexts:
    tVrrpMcIPsecGroup.setStatus("current")

tVrrpHostUnreachGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 25)
)
tVrrpHostUnreachGroup.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpHostUnreachableEvtSize"),
        ("TIMETRA-VRRP-MIB", "tVrrpHstUnrchEvtSize"))
)
if mibBuilder.loadTexts:
    tVrrpHostUnreachGroup.setStatus("current")

tmnxVrrpLagWtDnEvtGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 26)
)
tmnxVrrpLagWtDnEvtGroup.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpLagWtDownEventTblLastChg"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpLagWtDownEventRowStatus"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpLagWtDownEventPriority"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpLagWtDownEventType"))
)
if mibBuilder.loadTexts:
    tmnxVrrpLagWtDnEvtGroup.setStatus("current")

tmnxVrrpOperV10v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 27)
)
tmnxVrrpOperV10v0Group.setObjects(
    ("TIMETRA-VRRP-MIB", "tmnxVrrpOperDownReason")
)
if mibBuilder.loadTexts:
    tmnxVrrpOperV10v0Group.setStatus("current")

tmnxVrrpPolicyAdminGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 29)
)
tmnxVrrpPolicyAdminGroup.setObjects(
    ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyAdminState")
)
if mibBuilder.loadTexts:
    tmnxVrrpPolicyAdminGroup.setStatus("current")

tmnxVrrpOperV140v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 30)
)
tmnxVrrpOperV140v0Group.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperPassive"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpOperRowStatus"),
        ("TIMETRA-VRRP-MIB", "tVrrpOpRowStatus"),
        ("TIMETRA-VRRP-MIB", "tVrrpOpPassive"))
)
if mibBuilder.loadTexts:
    tmnxVrrpOperV140v0Group.setStatus("current")

tmnxVrrpOperV150v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 31)
)
tmnxVrrpOperV150v0Group.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperGroupName"),
        ("TIMETRA-VRRP-MIB", "tVrrpOpOperGroupName"))
)
if mibBuilder.loadTexts:
    tmnxVrrpOperV150v0Group.setStatus("current")

tmnxVrrpPolicySvcNameGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 32)
)
tmnxVrrpPolicySvcNameGroup.setObjects(
    ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicySvcNameContext")
)
if mibBuilder.loadTexts:
    tmnxVrrpPolicySvcNameGroup.setStatus("current")

tmnxVrrpIfBfdEnableSvcNameGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 33)
)
tmnxVrrpIfBfdEnableSvcNameGroup.setObjects(
      *(("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcSvcId"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcIfName"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcDestIpType"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcDestIp"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcRowStatus"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcLastChgd"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcSrcIpType"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcSrcIp"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcSessOperState"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcName"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSvcTblLastChgd"))
)
if mibBuilder.loadTexts:
    tmnxVrrpIfBfdEnableSvcNameGroup.setStatus("current")

tVrrpBfdObsoletedGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 34)
)
tVrrpBfdObsoletedGroup.setObjects(
      *(("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfLastChgd"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfRowStatus"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSessOperState"),
        ("TIMETRA-VRRP-MIB", "tVrrpAssoBfdIntfSrcIp"),
...
if mibBuilder.loadTexts:
    tVrrpBfdObsoletedGroup.setStatus("current")

tmnxVrrpOperV20v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 35)
)
tmnxVrrpOperV20v0Group.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperNtpReply"),
        ("TIMETRA-VRRP-MIB", "tVrrpOpNtpReply"))
)
if mibBuilder.loadTexts:
    tmnxVrrpOperV20v0Group.setStatus("current")
...
tVrrpOperDownInvalidMac = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 20, 0, 13)
)
tVrrpOperDownInvalidMac.setObjects(
    ("TIMETRA-VRRP-MIB", "tVrrpOpState")
)
if mibBuilder.loadTexts:
    tVrrpOperDownInvalidMac.setStatus(
        "current"
    )

tVrrpOperDownInvalidMacClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 20, 0, 14)
)
tVrrpOperDownInvalidMacClear.setObjects(
    ("TIMETRA-VRRP-MIB", "tVrrpOpState")
)
if mibBuilder.loadTexts:
    tVrrpOperDownInvalidMacClear.setStatus(
        "current"
    )

tmnxVrrpOperDownInvalidMac = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 20, 0, 15)
)
tmnxVrrpOperDownInvalidMac.setObjects(
    ("TIMETRA-VRRP-MIB", "tmnxVrrpOperState")
)
if mibBuilder.loadTexts:
    tmnxVrrpOperDownInvalidMac.setStatus(
        "current"
    )

tmnxVrrpOperDownInvalidMacClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 20, 0, 16)
)
tmnxVrrpOperDownInvalidMacClear.setObjects(
    ("TIMETRA-VRRP-MIB", "tmnxVrrpOperState")
)
if mibBuilder.loadTexts:
    tmnxVrrpOperDownInvalidMacClear.setStatus(
        "current"
    )
...
tVrrpNotificationV10v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 2, 28)
)
tVrrpNotificationV10v0Group.setObjects(
      *(("TIMETRA-VRRP-MIB", "tVrrpOperDownInvalidMac"),
        ("TIMETRA-VRRP-MIB", "tVrrpOperDownInvalidMacClear"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpOperDownInvalidMac"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpOperDownInvalidMacClear"))
)
if mibBuilder.loadTexts:
    tVrrpNotificationV10v0Group.setStatus(
        "current"
    )
...
tmnxVrrpV4v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV4v0Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPriorityEventsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpNotificationGroup"))
)
if mibBuilder.loadTexts:
...
tmnxVrrpV5v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV5v0Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyV5v0Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPriorityEventsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpNotificationGroup"))
)
if mibBuilder.loadTexts:
...
tmnxVrrpV6v1Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpBfdGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyV5v0Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPriorityEventsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpNotificationV6v1Group"))
)
if mibBuilder.loadTexts:
...
tmnxVrrp77x0V7v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpBfdGroup"),
        ...
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPriorityEventsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpNotificationV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpNotificationV7v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpHostUnreachableV7v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpOpV7v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpRouteUnknownV7v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpMasterV7v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpStatV7v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpRouterAdverV7v0Group"))
)
if mibBuilder.loadTexts:
...
tmnxVrrp7450V7v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpBfdGroup"),
...
tmnxVrrp77x0V9v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyV5v0Group"),
        ...
        ("TIMETRA-VRRP-MIB", "tVrrpStatV7v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpRouterAdverV7v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpBfdV9v0Group"))
)
if mibBuilder.loadTexts:
...
tmnxVrrp7450V9v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tVrrpBfdV9v0Group"),
...
tmnxVrrp77x0V10v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 1, 10)
)
tmnxVrrp77x0V10v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyV5v0Group"),
        ...
        ("TIMETRA-VRRP-MIB", "tVrrpRouterAdverV7v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpBfdV9v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpHostUnreachGroup"),
        ("TIMETRA-VRRP-MIB", "tVrrpMcIPsecGroup"))
)
if mibBuilder.loadTexts:
    tmnxVrrp77x0V10v0Compliance.setStatus(
        "obsolete"
    )

tmnxVrrp77x0V12v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 1, 11)
)
tmnxVrrp77x0V12v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyV5v0Group"),
        ...
        ("TIMETRA-VRRP-MIB", "tVrrpHostUnreachGroup"),
        ("TIMETRA-VRRP-MIB", "tVrrpMcIPsecGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpLagWtDnEvtGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpOperV10v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpNotificationV10v0Group"))
)
if mibBuilder.loadTexts:
    tmnxVrrp77x0V12v0Compliance.setStatus(
        "obsolete"
    )

tmnxVrrp77x0V13v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 1, 12)
)
tmnxVrrp77x0V13v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyV5v0Group"),
        ...
        ("TIMETRA-VRRP-MIB", "tmnxVrrpOperV10v0Group"),
        ("TIMETRA-VRRP-MIB", "tVrrpNotificationV10v0Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyAdminGroup"))
)
if mibBuilder.loadTexts:
    tmnxVrrp77x0V13v0Compliance.setStatus(
        "obsolete"
    )

tmnxVrrp77x0V14v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 1, 13)
)
tmnxVrrp77x0V14v0Compliance.setObjects(
    ("TIMETRA-VRRP-MIB", "tmnxVrrpOperV140v0Group")
)
if mibBuilder.loadTexts:
    tmnxVrrp77x0V14v0Compliance.setStatus(
        "obsolete"
    )

tmnxVrrp77x0V15v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 1, 14)
)
tmnxVrrp77x0V15v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV150v0Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicySvcNameGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpIfBfdEnableSvcNameGroup"))
)
if mibBuilder.loadTexts:
    tmnxVrrp77x0V15v0Compliance.setStatus(
        "obsolete"
    )

tmnxVrrp7450V16v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 1, 15)
)
tmnxVrrp7450V16v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyV5v0Group"),
...
if mibBuilder.loadTexts:
    tmnxVrrp7450V16v0Compliance.setStatus(
        "current"
    )

tmnxVrrp77x0V16v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 1, 16)
)
tmnxVrrp77x0V16v0Compliance.setObjects(
      *(("TIMETRA-VRRP-MIB", "tmnxVrrpOperV6v1Group"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpStatsGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpRouteMasterGroup"),
        ("TIMETRA-VRRP-MIB", "tmnxVrrpPolicyV5v0Group"),
...
if mibBuilder.loadTexts:
    tmnxVrrp77x0V16v0Compliance.setStatus(
        "current"
    )

tmnxVrrp77x0V20v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 20, 1, 17)
)
tmnxVrrp77x0V20v0Compliance.setObjects(
    ("TIMETRA-VRRP-MIB", "tmnxVrrpOperV20v0Group")
)
if mibBuilder.loadTexts:
    tmnxVrrp77x0V20v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TmnxVrrpPolicyID": TmnxVrrpPolicyID,
       ...
       "TmnxMcIPsecNoFwdEventOperState": TmnxMcIPsecNoFwdEventOperState,
       ...
       "tmnxVrrp77x0V10v0Compliance": tmnxVrrp77x0V10v0Compliance,
       "tmnxVrrp77x0V12v0Compliance": tmnxVrrp77x0V12v0Compliance,
       "tmnxVrrp77x0V13v0Compliance": tmnxVrrp77x0V13v0Compliance,
       "tmnxVrrp77x0V14v0Compliance": tmnxVrrp77x0V14v0Compliance,
       "tmnxVrrp77x0V15v0Compliance": tmnxVrrp77x0V15v0Compliance,
       "tmnxVrrp7450V16v0Compliance": tmnxVrrp7450V16v0Compliance,
       "tmnxVrrp77x0V16v0Compliance": tmnxVrrp77x0V16v0Compliance,
       "tmnxVrrp77x0V20v0Compliance": tmnxVrrp77x0V20v0Compliance,
       ...
       "tVrrpHostUnreachGroup": tVrrpHostUnreachGroup,
       "tmnxVrrpLagWtDnEvtGroup": tmnxVrrpLagWtDnEvtGroup,
       "tmnxVrrpOperV10v0Group": tmnxVrrpOperV10v0Group,
       "tVrrpNotificationV10v0Group": tVrrpNotificationV10v0Group,
       "tmnxVrrpPolicyAdminGroup": tmnxVrrpPolicyAdminGroup,
       "tmnxVrrpOperV140v0Group": tmnxVrrpOperV140v0Group,
       "tmnxVrrpOperV150v0Group": tmnxVrrpOperV150v0Group,
       "tmnxVrrpPolicySvcNameGroup": tmnxVrrpPolicySvcNameGroup,
       "tmnxVrrpIfBfdEnableSvcNameGroup": tmnxVrrpIfBfdEnableSvcNameGroup,
       "tVrrpBfdObsoletedGroup": tVrrpBfdObsoletedGroup,
       "tmnxVrrpOperV20v0Group": tmnxVrrpOperV20v0Group,
       ...
       "tmnxVrrpOperDownReason": tmnxVrrpOperDownReason,
       "tmnxVrrpOperPassive": tmnxVrrpOperPassive,
       "tmnxVrrpOperRowStatus": tmnxVrrpOperRowStatus,
       "tmnxVrrpOperGroupName": tmnxVrrpOperGroupName,
       "tmnxVrrpOperNtpReply": tmnxVrrpOperNtpReply,
       ...
       "tVrrpOpPassive": tVrrpOpPassive,
       "tVrrpOpRowStatus": tVrrpOpRowStatus,
       "tVrrpOpOperGroupName": tVrrpOpOperGroupName,
       "tVrrpOpNtpReply": tVrrpOpNtpReply,
       ...
       "tVrrpAssoBfdIntfSvcTable": tVrrpAssoBfdIntfSvcTable,
       "tVrrpAssoBfdIntfSvcEntry": tVrrpAssoBfdIntfSvcEntry,
       "tVrrpAssoBfdIntfSvcVrIdIpType": tVrrpAssoBfdIntfSvcVrIdIpType,
       "tVrrpAssoBfdIntfSvcSvcId": tVrrpAssoBfdIntfSvcSvcId,
       "tVrrpAssoBfdIntfSvcIfName": tVrrpAssoBfdIntfSvcIfName,
       "tVrrpAssoBfdIntfSvcDestIpType": tVrrpAssoBfdIntfSvcDestIpType,
       "tVrrpAssoBfdIntfSvcDestIp": tVrrpAssoBfdIntfSvcDestIp,
       "tVrrpAssoBfdIntfSvcRowStatus": tVrrpAssoBfdIntfSvcRowStatus,
       "tVrrpAssoBfdIntfSvcLastChgd": tVrrpAssoBfdIntfSvcLastChgd,
       "tVrrpAssoBfdIntfSvcSrcIpType": tVrrpAssoBfdIntfSvcSrcIpType,
       "tVrrpAssoBfdIntfSvcSrcIp": tVrrpAssoBfdIntfSvcSrcIp,
       "tVrrpAssoBfdIntfSvcSessOperState": tVrrpAssoBfdIntfSvcSessOperState,
       "tVrrpAssoBfdIntfSvcName": tVrrpAssoBfdIntfSvcName,
       ...
       "tmnxVrrpPolicyAdminState": tmnxVrrpPolicyAdminState,
       "tmnxVrrpPolicySvcNameContext": tmnxVrrpPolicySvcNameContext,
       ...
       "tmnxVrrpHostUnreachableEvtSize": tmnxVrrpHostUnreachableEvtSize,
       ...
       "tVrrpHstUnrchEvtSize": tVrrpHstUnrchEvtSize,
       ...
       "tVrrpPriEvtMcIPsecNoFwdTable": tVrrpPriEvtMcIPsecNoFwdTable,
       "tVrrpPriEvtMcIPsecNoFwdEntry": tVrrpPriEvtMcIPsecNoFwdEntry,
       "tVrrpPriEvtMcIPsecNoFwdTnlGrpId": tVrrpPriEvtMcIPsecNoFwdTnlGrpId,
       "tVrrpPriEvtMcIPsecNoFwdRowStatus": tVrrpPriEvtMcIPsecNoFwdRowStatus,
       "tVrrpPriEvtMcIPsecNoFwdPriority": tVrrpPriEvtMcIPsecNoFwdPriority,
       "tVrrpPriEvtMcIPsecNoFwdType": tVrrpPriEvtMcIPsecNoFwdType,
       "tVrrpPriEvtMcIPsecNoFwdHoldSet": tVrrpPriEvtMcIPsecNoFwdHoldSet,
       "tVrrpPriEvtMcIPsecNoFwdOperState": tVrrpPriEvtMcIPsecNoFwdOperState,
       "tVrrpPriEvtMcIPsecNoFwdHoldSetR": tVrrpPriEvtMcIPsecNoFwdHoldSetR,
       "tVrrpPriEvtMcIPsecNoFwdPrevState": tVrrpPriEvtMcIPsecNoFwdPrevState,
       "tVrrpPriEvtMcIPsecNoFwdTransTm": tVrrpPriEvtMcIPsecNoFwdTransTm,
       "tVrrpPriEvtMcIPsecNoFwdSetCntr": tVrrpPriEvtMcIPsecNoFwdSetCntr,
       "tVrrpPriEvtMcIPsecNoFwdInUse": tVrrpPriEvtMcIPsecNoFwdInUse,
       "tVrrpPriEvtMcIPsecNoFwdHoldClr": tVrrpPriEvtMcIPsecNoFwdHoldClr,
       "tVrrpPriEvtMcIPsecNoFwdHoldClrR": tVrrpPriEvtMcIPsecNoFwdHoldClrR,
       "tmnxVrrpLagWtDownEventTblLastChg": tmnxVrrpLagWtDownEventTblLastChg,
       "tmnxVrrpLagWtDownEventTable": tmnxVrrpLagWtDownEventTable,
       "tmnxVrrpLagWtDownEventEntry": tmnxVrrpLagWtDownEventEntry,
       "tmnxVrrpLagWtDown": tmnxVrrpLagWtDown,
       "tmnxVrrpLagWtDownEventRowStatus": tmnxVrrpLagWtDownEventRowStatus,
       "tmnxVrrpLagWtDownEventPriority": tmnxVrrpLagWtDownEventPriority,
       "tmnxVrrpLagWtDownEventType": tmnxVrrpLagWtDownEventType,
       ...
       "tVrrpOperDownInvalidMac": tVrrpOperDownInvalidMac,
       "tVrrpOperDownInvalidMacClear": tVrrpOperDownInvalidMacClear,
       "tmnxVrrpOperDownInvalidMac": tmnxVrrpOperDownInvalidMac,
       "tmnxVrrpOperDownInvalidMacClear": tmnxVrrpOperDownInvalidMacClear}
)
