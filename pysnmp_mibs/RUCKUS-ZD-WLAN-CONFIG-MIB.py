...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:13:49 2025
...
class _RuckusZDWLANConfig802dot11d_Type(Integer32):
    """Custom type ruckusZDWLANConfig802dot11d based on Integer32"""
    defaultValue = 1
...
_RuckusZDWLANConfig802dot11d_Type.__name__ = "Integer32"
_RuckusZDWLANConfig802dot11d_Object = MibTableColumn
ruckusZDWLANConfig802dot11d = _RuckusZDWLANConfig802dot11d_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 2, 2, 2, 1, 1, 1, 1, 47),
    _RuckusZDWLANConfig802dot11d_Type()
)
ruckusZDWLANConfig802dot11d.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ruckusZDWLANConfig802dot11d.setStatus("current")


class _RuckusZDWLANConfigOfdmonly_Type(Integer32):
    """Custom type ruckusZDWLANConfigOfdmonly based on Integer32"""
    defaultValue = 2
...
_RuckusZDWLANConfigOfdmonly_Type.__name__ = "Integer32"
_RuckusZDWLANConfigOfdmonly_Object = MibTableColumn
ruckusZDWLANConfigOfdmonly = _RuckusZDWLANConfigOfdmonly_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 2, 2, 2, 1, 1, 1, 1, 48),
    _RuckusZDWLANConfigOfdmonly_Type()
)
ruckusZDWLANConfigOfdmonly.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ruckusZDWLANConfigOfdmonly.setStatus("current")


class _RuckusZDWLANConfigBSSMinrate_Type(OctetString):
    """Custom type ruckusZDWLANConfigBSSMinrate based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 15),
    )
...
_RuckusZDWLANConfigBSSMinrate_Type.__name__ = "OctetString"
_RuckusZDWLANConfigBSSMinrate_Object = MibTableColumn
ruckusZDWLANConfigBSSMinrate = _RuckusZDWLANConfigBSSMinrate_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 2, 2, 2, 1, 1, 1, 1, 49),
    _RuckusZDWLANConfigBSSMinrate_Type()
)
ruckusZDWLANConfigBSSMinrate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ruckusZDWLANConfigBSSMinrate.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ruckusZDWLANConfigMIB": ruckusZDWLANConfigMIB,
       ...
       "ruckusZDWLANConfig802dot11d": ruckusZDWLANConfig802dot11d,
       "ruckusZDWLANConfigOfdmonly": ruckusZDWLANConfigOfdmonly,
       "ruckusZDWLANConfigBSSMinrate": ruckusZDWLANConfigBSSMinrate,
