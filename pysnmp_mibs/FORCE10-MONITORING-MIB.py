...
F10SlotID, F10ProcessorModuleType, F10QueueID, F10VlanID, F10CycloneVersion, F10PortPipeID = mibBuilder.importSymbols("FORCE10-TC", "F10SlotID", "F10ProcessorModuleType", "F10QueueID", "F10VlanID", "F10CycloneVersion", "F10PortPipeID")
...
mibBuilder.exportSymbols("FORCE10-MONITORING-MIB", f10CpuIngUnicastPacketCount=f10CpuIngUnicastPacketCount, f10WredStatisticsEntry=f10WredStatisticsEntry, f10MonGroup=f10MonGroup, f10InQueueMatchBytes=f10InQueueMatchBytes, f10EgUnicastGreenDrop=f10EgUnicastGreenDrop, f10EgMulticastYellowMin=f10EgMulticastYellowMin, f10EgQueueUnicastStatTable=f10EgQueueUnicastStatTable, f10EgUnicastRedDrop=f10EgUnicastRedDrop, f10IngMulticastYellowMax=f10IngMulticastYellowMax, f10MonMibVersion=f10MonMibVersion, f10OutQueueCycloneVersion=f10OutQueueCycloneVersion, f10NetworkStat=f10NetworkStat, f10IngMulticastQueueId=f10IngMulticastQueueId, f10InQueueMatchPackets=f10InQueueMatchPackets, f10ArpReqRecv=f10ArpReqRecv, f10MacAccVlan=f10MacAccVlan, f10EgUnicastCycloneVersion=f10EgUnicastCycloneVersion, f10ArpStatistic=f10ArpStatistic, f10MacAccounting=f10MacAccounting, f10EgMulticastBytesCount=f10EgMulticastBytesCount, f10CpuIngUnicastSrcPortPipe=f10CpuIngUnicastSrcPortPipe, f10EgUnicastBytes=f10EgUnicastBytes, f10BcastPktSent=f10BcastPktSent, f10OutQueueStatisticsTable=f10OutQueueStatisticsTable, f10CpuIngUnicastGreenDrop=f10CpuIngUnicastGreenDrop, f10MonitoringMib=f10MonitoringMib, f10EgMulticastCycloneVersion=f10EgMulticastCycloneVersion, f10IngQueueUnicastStatTable=f10IngQueueUnicastStatTable, f10WredGreenDropPackets=f10WredGreenDropPackets, f10IngMulticastGreenMin=f10IngMulticastGreenMin, f10EgMulticastGreenDrop=f10EgMulticastGreenDrop, f10EgMulticastYellowMax=f10EgMulticastYellowMax, f10CpuIngUnicastYellowDrop=f10CpuIngUnicastYellowDrop, f10WredYellowThresholdHigh=f10WredYellowThresholdHigh, f10InQueueBytesCount=f10InQueueBytesCount, f10EgMulticastBytes=f10EgMulticastBytes, f10EgMulticastRedDrop=f10EgMulticastRedDrop, f10EgMulticastGreenMax=f10EgMulticastGreenMax, f10IngMulticastBytes=f10IngMulticastBytes, f10WredYellowThresholdLow=f10WredYellowThresholdLow, f10WredRedReserve2=f10WredRedReserve2, f10WredQueueId=f10WredQueueId, f10InQueueBytes=f10InQueueBytes, f10WredRedThresholdLow=f10WredRedThresholdLow, f10MonQueueGroup=f10MonQueueGroup, f10IngUnicastGreenDrop=f10IngUnicastGreenDrop, f10IngUnicastYellowMax=f10IngUnicastYellowMax, f10WredYellowReserve1=f10WredYellowReserve1, f10IngQueueMulticastStatTable=f10IngQueueMulticastStatTable, f10EgQueueMulticastStatTable=f10EgQueueMulticastStatTable, f10CpuIngUnicastGreenMax=f10CpuIngUnicastGreenMax, f10ArpReplyRecv=f10ArpReplyRecv, f10WredYellowName=f10WredYellowName, f10EgUnicastYellowMax=f10EgUnicastYellowMax, f10CpuIngUnicastRedDrop=f10CpuIngUnicastRedDrop, f10InQueueDropPackets=f10InQueueDropPackets, f10MonIfQueueGroup=f10MonIfQueueGroup, f10OutQueueBytesCount=f10OutQueueBytesCount, f10OutQueuePackets=f10OutQueuePackets, f10IngUnicastYellowDrop=f10IngUnicastYellowDrop, PYSNMP_MODULE_ID=f10MonitoringMib, f10MonMaxQueue=f10MonMaxQueue, f10MacAccMacAddr=f10MacAccMacAddr, f10IngUnicastBytesCount=f10IngUnicastBytesCount, f10CpuIngUnicastGreenMin=f10CpuIngUnicastGreenMin, f10ArpProxySent=f10ArpProxySent, f10IpStatistic=f10IpStatistic, f10IngMulticastSrcCard=f10IngMulticastSrcCard, f10IngMulticastGreenMax=f10IngMulticastGreenMax, f10EgUnicastGreenMax=f10EgUnicastGreenMax, f10InQueueMatchBps=f10InQueueMatchBps, f10WredRedDropPackets=f10WredRedDropPackets, f10IngUnicastSrcCard=f10IngUnicastSrcCard, f10CpuIngUnicastCycloneVersion=f10CpuIngUnicastCycloneVersion, f10McastPktSent=f10McastPktSent, f10IngMulticastCycloneVersion=f10IngMulticastCycloneVersion, f10EgMulticastQueueId=f10EgMulticastQueueId, f10EgQueueMulticastStatEntry=f10EgQueueMulticastStatEntry, f10EgQueueUnicastStatEntry=f10EgQueueUnicastStatEntry, f10EgUnicastQueueId=f10EgUnicastQueueId, f10MacAccountingDestTable=f10MacAccountingDestTable, f10IngUnicastDestPortPipe=f10IngUnicastDestPortPipe, f10EgUnicastGreenMin=f10EgUnicastGreenMin, f10MacAccPackets=f10MacAccPackets, f10WredRedThresholdHigh=f10WredRedThresholdHigh, f10IngUnicastRedDrop=f10IngUnicastRedDrop, f10CpuIngUnicastQueueId=f10CpuIngUnicastQueueId, f10IngUnicastBytes=f10IngUnicastBytes, f10WredRedReserve1=f10WredRedReserve1, f10IngMulticastRedDrop=f10IngMulticastRedDrop, f10OutQueueStatisticsEntry=f10OutQueueStatisticsEntry, f10OutQueueId=f10OutQueueId, f10MonMac=f10MonMac, f10MacAccOutIfIndex=f10MacAccOutIfIndex, f10BcastPktRecv=f10BcastPktRecv, f10WredStatisticsTable=f10WredStatisticsTable, f10EgUnicastBytesCount=f10EgUnicastBytesCount, f10IngUnicastYellowMin=f10IngUnicastYellowMin, f10IngUnicastSrcPortPipe=f10IngUnicastSrcPortPipe, f10IngUnicastPacketCount=f10IngUnicastPacketCount, f10CpuIngUnicastBytesCount=f10CpuIngUnicastBytesCount, f10WredYellowReserve2=f10WredYellowReserve2, f10IngUnicastQueueId=f10IngUnicastQueueId, f10InQueueCycloneVersion=f10InQueueCycloneVersion, f10WredGreenReserve1=f10WredGreenReserve1, f10WredRedName=f10WredRedName, f10MacAccInIfIndex=f10MacAccInIfIndex, f10IngQueueMulticastStatEntry=f10IngQueueMulticastStatEntry, f10IngMulticastPacketCount=f10IngMulticastPacketCount, f10CpuIngUnicastYellowMax=f10CpuIngUnicastYellowMax, f10MonIfQueue=f10MonIfQueue, f10MacAccBytes=f10MacAccBytes, f10EgMulticastYellowDrop=f10EgMulticastYellowDrop, f10EgUnicastYellowMin=f10EgUnicastYellowMin, f10CpuIngUnicastSrcCard=f10CpuIngUnicastSrcCard, f10ArpReqSent=f10ArpReqSent, f10InQueueStatisticsEntry=f10InQueueStatisticsEntry, f10MacGroup=f10MacGroup, f10CpuIngUnicastDestCpu=f10CpuIngUnicastDestCpu, f10IngQueueUnicastStatEntry=f10IngQueueUnicastStatEntry, f10InQueuePktsCount=f10InQueuePktsCount, f10CpuIngQueueUnicastStatTable=f10CpuIngQueueUnicastStatTable, f10IngMulticastGreenDrop=f10IngMulticastGreenDrop, f10WredGreenThresholdHigh=f10WredGreenThresholdHigh, f10EgUnicastPacketCount=f10EgUnicastPacketCount, f10IngMulticastYellowMin=f10IngMulticastYellowMin, f10WredGreenReserve2=f10WredGreenReserve2, f10OutQueueBytes=f10OutQueueBytes, f10McastPktRecv=f10McastPktRecv, f10IngUnicastCycloneVersion=f10IngUnicastCycloneVersion, f10IngMulticastYellowDrop=f10IngMulticastYellowDrop, f10IngUnicastDestCard=f10IngUnicastDestCard, f10MonQueue=f10MonQueue, f10EgMulticastPacketCount=f10EgMulticastPacketCount, f10IngUnicastGreenMin=f10IngUnicastGreenMin, f10MacAccountingDestEntry=f10MacAccountingDestEntry, f10IngUnicastGreenMax=f10IngUnicastGreenMax, f10ArpReplySent=f10ArpReplySent, f10IngMulticastBytesCount=f10IngMulticastBytesCount, f10OutQueueBps=f10OutQueueBps, f10WredGreenThresholdLow=f10WredGreenThresholdLow, f10EgUnicastYellowDrop=f10EgUnicastYellowDrop, f10CpuIngQueueUnicastStatEntry=f10CpuIngQueueUnicastStatEntry, f10InQueueId=f10InQueueId, f10CpuIngUnicastYellowMin=f10CpuIngUnicastYellowMin, f10InQueueStatisticsTable=f10InQueueStatisticsTable, f10WredYellowDropPackets=f10WredYellowDropPackets, f10EgMulticastGreenMin=f10EgMulticastGreenMin, f10IngMulticastSrcPortPipe=f10IngMulticastSrcPortPipe, f10WredGreenName=f10WredGreenName)
