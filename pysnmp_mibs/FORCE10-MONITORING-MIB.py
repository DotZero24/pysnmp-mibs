...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/force10/FORCE10-MONITORING-MIB
...
F10PortPipeID, F10QueueID, F10CycloneVersion, F10ProcessorModuleType, F10SlotID, F10VlanID = mibBuilder.importSymbols("FORCE10-TC", "F10PortPipeID", "F10QueueID", "F10CycloneVersion", "F10ProcessorModuleType", "F10SlotID", "F10VlanID")
...
if mibBuilder.loadTexts: f10MonitoringMib.setOrganization('Dell Inc')
...
mibBuilder.exportSymbols("FORCE10-MONITORING-MIB", f10MonGroup=f10MonGroup, f10IngMulticastSrcCard=f10IngMulticastSrcCard, f10EgMulticastGreenMin=f10EgMulticastGreenMin, f10EgUnicastPacketCount=f10EgUnicastPacketCount, f10WredYellowThresholdHigh=f10WredYellowThresholdHigh, f10CpuIngUnicastYellowMax=f10CpuIngUnicastYellowMax, f10EgUnicastQueueId=f10EgUnicastQueueId, f10IngMulticastRedDrop=f10IngMulticastRedDrop, f10MonMibVersion=f10MonMibVersion, f10InQueueMatchPackets=f10InQueueMatchPackets, f10BcastPktRecv=f10BcastPktRecv, f10WredRedReserve1=f10WredRedReserve1, f10WredRedThresholdHigh=f10WredRedThresholdHigh, f10CpuIngUnicastYellowDrop=f10CpuIngUnicastYellowDrop, f10BcastPktSent=f10BcastPktSent, f10EgMulticastPacketCount=f10EgMulticastPacketCount, f10IpStatistic=f10IpStatistic, f10IngMulticastBytesCount=f10IngMulticastBytesCount, f10MonIfQueueGroup=f10MonIfQueueGroup, f10IngMulticastGreenMin=f10IngMulticastGreenMin, f10InQueueDropPackets=f10InQueueDropPackets, f10EgMulticastRedDrop=f10EgMulticastRedDrop, f10EgQueueMulticastStatEntry=f10EgQueueMulticastStatEntry, f10OutQueueBps=f10OutQueueBps, f10ArpReqSent=f10ArpReqSent, f10EgQueueMulticastStatTable=f10EgQueueMulticastStatTable, f10EgUnicastGreenMax=f10EgUnicastGreenMax, f10InQueueStatisticsEntry=f10InQueueStatisticsEntry, PYSNMP_MODULE_ID=f10MonitoringMib, f10IngMulticastGreenDrop=f10IngMulticastGreenDrop, f10WredGreenDropPackets=f10WredGreenDropPackets, f10EgUnicastGreenMin=f10EgUnicastGreenMin, f10CpuIngUnicastSrcCard=f10CpuIngUnicastSrcCard, f10EgUnicastYellowMin=f10EgUnicastYellowMin, f10WredYellowDropPackets=f10WredYellowDropPackets, f10EgUnicastYellowMax=f10EgUnicastYellowMax, f10McastPktRecv=f10McastPktRecv, f10MacAccOutIfIndex=f10MacAccOutIfIndex, f10IngUnicastYellowMin=f10IngUnicastYellowMin, f10MonQueue=f10MonQueue, f10IngMulticastPacketCount=f10IngMulticastPacketCount, f10MacAccPackets=f10MacAccPackets, f10WredStatisticsEntry=f10WredStatisticsEntry, f10OutQueueStatisticsTable=f10OutQueueStatisticsTable, f10WredYellowReserve1=f10WredYellowReserve1, f10MonQueueGroup=f10MonQueueGroup, f10MonMaxQueue=f10MonMaxQueue, f10CpuIngUnicastBytesCount=f10CpuIngUnicastBytesCount, f10WredRedDropPackets=f10WredRedDropPackets, f10WredGreenThresholdHigh=f10WredGreenThresholdHigh, f10IngQueueUnicastStatTable=f10IngQueueUnicastStatTable, f10EgUnicastBytesCount=f10EgUnicastBytesCount, f10MacAccInIfIndex=f10MacAccInIfIndex, f10EgMulticastBytesCount=f10EgMulticastBytesCount, f10MacAccounting=f10MacAccounting, f10IngMulticastBytes=f10IngMulticastBytes, f10OutQueueBytesCount=f10OutQueueBytesCount, f10EgUnicastCycloneVersion=f10EgUnicastCycloneVersion, f10OutQueueId=f10OutQueueId, f10IngMulticastSrcPortPipe=f10IngMulticastSrcPortPipe, f10EgMulticastYellowDrop=f10EgMulticastYellowDrop, f10EgMulticastYellowMax=f10EgMulticastYellowMax, f10IngMulticastYellowDrop=f10IngMulticastYellowDrop, f10InQueueId=f10InQueueId, f10CpuIngUnicastSrcPortPipe=f10CpuIngUnicastSrcPortPipe, f10InQueueMatchBytes=f10InQueueMatchBytes, f10IngMulticastGreenMax=f10IngMulticastGreenMax, f10EgMulticastGreenMax=f10EgMulticastGreenMax, f10EgMulticastYellowMin=f10EgMulticastYellowMin, f10WredRedReserve2=f10WredRedReserve2, f10NetworkStat=f10NetworkStat, f10IngUnicastGreenMin=f10IngUnicastGreenMin, f10IngUnicastDestCard=f10IngUnicastDestCard, f10MonIfQueue=f10MonIfQueue, f10IngMulticastYellowMin=f10IngMulticastYellowMin, f10McastPktSent=f10McastPktSent, f10MonitoringMib=f10MonitoringMib, f10CpuIngUnicastGreenMax=f10CpuIngUnicastGreenMax, f10EgMulticastBytes=f10EgMulticastBytes, f10MacAccountingDestTable=f10MacAccountingDestTable, f10CpuIngUnicastCycloneVersion=f10CpuIngUnicastCycloneVersion, f10IngUnicastSrcPortPipe=f10IngUnicastSrcPortPipe, f10IngUnicastGreenDrop=f10IngUnicastGreenDrop, f10EgMulticastQueueId=f10EgMulticastQueueId, f10EgUnicastGreenDrop=f10EgUnicastGreenDrop, f10EgUnicastYellowDrop=f10EgUnicastYellowDrop, f10InQueueBytes=f10InQueueBytes, f10WredStatisticsTable=f10WredStatisticsTable, f10EgQueueUnicastStatTable=f10EgQueueUnicastStatTable, f10WredGreenReserve2=f10WredGreenReserve2, f10WredYellowThresholdLow=f10WredYellowThresholdLow, f10WredGreenReserve1=f10WredGreenReserve1, f10IngUnicastRedDrop=f10IngUnicastRedDrop, f10CpuIngQueueUnicastStatEntry=f10CpuIngQueueUnicastStatEntry, f10MacAccountingDestEntry=f10MacAccountingDestEntry, f10MonMac=f10MonMac, f10MacGroup=f10MacGroup, f10MacAccBytes=f10MacAccBytes, f10EgMulticastGreenDrop=f10EgMulticastGreenDrop, f10CpuIngQueueUnicastStatTable=f10CpuIngQueueUnicastStatTable, f10MacAccVlan=f10MacAccVlan, f10IngUnicastGreenMax=f10IngUnicastGreenMax, f10EgQueueUnicastStatEntry=f10EgQueueUnicastStatEntry, f10IngUnicastPacketCount=f10IngUnicastPacketCount, f10IngUnicastBytesCount=f10IngUnicastBytesCount, f10InQueueStatisticsTable=f10InQueueStatisticsTable, f10CpuIngUnicastGreenDrop=f10CpuIngUnicastGreenDrop, f10OutQueueBytes=f10OutQueueBytes, f10IngUnicastYellowMax=f10IngUnicastYellowMax, f10WredQueueId=f10WredQueueId, f10IngUnicastBytes=f10IngUnicastBytes, f10IngUnicastDestPortPipe=f10IngUnicastDestPortPipe, f10IngQueueMulticastStatEntry=f10IngQueueMulticastStatEntry, f10IngUnicastQueueId=f10IngUnicastQueueId, f10CpuIngUnicastQueueId=f10CpuIngUnicastQueueId, f10ArpReqRecv=f10ArpReqRecv, f10CpuIngUnicastGreenMin=f10CpuIngUnicastGreenMin, f10IngMulticastCycloneVersion=f10IngMulticastCycloneVersion, f10WredYellowName=f10WredYellowName, f10WredRedName=f10WredRedName, f10WredRedThresholdLow=f10WredRedThresholdLow, f10IngUnicastCycloneVersion=f10IngUnicastCycloneVersion, f10WredYellowReserve2=f10WredYellowReserve2, f10EgUnicastBytes=f10EgUnicastBytes, f10IngQueueUnicastStatEntry=f10IngQueueUnicastStatEntry, f10IngQueueMulticastStatTable=f10IngQueueMulticastStatTable, f10IngUnicastSrcCard=f10IngUnicastSrcCard, f10EgMulticastCycloneVersion=f10EgMulticastCycloneVersion, f10OutQueueStatisticsEntry=f10OutQueueStatisticsEntry, f10IngMulticastYellowMax=f10IngMulticastYellowMax, f10InQueuePktsCount=f10InQueuePktsCount, f10EgUnicastRedDrop=f10EgUnicastRedDrop, f10InQueueBytesCount=f10InQueueBytesCount, f10OutQueueCycloneVersion=f10OutQueueCycloneVersion, f10IngMulticastQueueId=f10IngMulticastQueueId, f10IngUnicastYellowDrop=f10IngUnicastYellowDrop, f10CpuIngUnicastDestCpu=f10CpuIngUnicastDestCpu, f10ArpReplySent=f10ArpReplySent, f10MacAccMacAddr=f10MacAccMacAddr, f10CpuIngUnicastYellowMin=f10CpuIngUnicastYellowMin, f10WredGreenThresholdLow=f10WredGreenThresholdLow, f10InQueueMatchBps=f10InQueueMatchBps, f10CpuIngUnicastPacketCount=f10CpuIngUnicastPacketCount, f10ArpStatistic=f10ArpStatistic, f10WredGreenName=f10WredGreenName, f10ArpReplyRecv=f10ArpReplyRecv, f10InQueueCycloneVersion=f10InQueueCycloneVersion, f10OutQueuePackets=f10OutQueuePackets, f10CpuIngUnicastRedDrop=f10CpuIngUnicastRedDrop, f10ArpProxySent=f10ArpProxySent)
