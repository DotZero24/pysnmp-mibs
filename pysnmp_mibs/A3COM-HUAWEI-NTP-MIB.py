...
mibBuilder.exportSymbols("A3COM-HUAWEI-NTP-MIB", hwNTPPeerFlash=hwNTPPeerFlash, hwNTPPeerPrecision=hwNTPPeerPrecision, hwNTPPeerDelay=hwNTPPeerDelay, hwNTPPeerFiltDelay=hwNTPPeerFiltDelay, hwNTPPeerReceived=hwNTPPeerReceived, hwNTPSysCompliance=hwNTPSysCompliance, PYSNMP_MODULE_ID=hwNTP, hwNTPPeerMIB=hwNTPPeerMIB, hwNTPPeerSent=hwNTPPeerSent, hwNTPPeerRootDelay=hwNTPPeerRootDelay, hwNTPPeerReach=hwNTPPeerReach, hwNTPPeerValid=hwNTPPeerValid, hwNTPPeerKeyId=hwNTPPeerKeyId, hwNTPSystemMIBObjects=hwNTPSystemMIBObjects, hwNTPPeerLeap=hwNTPPeerLeap, hwNTPServerIP=hwNTPServerIP, hwNTPPeerRemPort=hwNTPPeerRemPort, hwNTPSysPeer=hwNTPSysPeer, hwNTPPeerOrg=hwNTPPeerOrg, hwNTPPeerLocAdr=hwNTPPeerLocAdr, hwNTPPeerPPoll=hwNTPPeerPPoll, hwNTPSysPrecision=hwNTPSysPrecision, hwNTPSysClock=hwNTPSysClock, hwNTPSysRefid=hwNTPSysRefid, hwNTPSysReftime=hwNTPSysReftime, hwNTPPeerRefId=hwNTPPeerRefId, hwNTPPeerAuthentic=hwNTPPeerAuthentic, hwNTPSysAuthenticate=hwNTPSysAuthenticate, hwNTPPeerFiltError=hwNTPPeerFiltError, hwNTPSysClockSec=hwNTPSysClockSec, hwNTPSysPoll=hwNTPSysPoll, hwNTPSysLeap=hwNTPSysLeap, hwNTP=hwNTP, hwNTPPeerTable=hwNTPPeerTable, hwNTPPeerStratum=hwNTPPeerStratum, hwNTPPeerRefTime=hwNTPPeerRefTime, hwNTPPeerRec=hwNTPPeerRec, hwNTPPeerMIBObjects=hwNTPPeerMIBObjects, hwNTPSystemMIB=hwNTPSystemMIB, hwNTPPeerHPoll=hwNTPPeerHPoll, hwNTPPeerXmt=hwNTPPeerXmt, hwNTPPeerTimer=hwNTPPeerTimer, hwNTPPeerEntry=hwNTPPeerEntry, hwNTPPeerHMode=hwNTPPeerHMode, hwNTPPeerFiltOffset=hwNTPPeerFiltOffset, hwNTPSysState=hwNTPSysState, hwNTPPeerRowStatus=hwNTPPeerRowStatus, hwNTPPeerLocPort=hwNTPPeerLocPort, hwNTPSysStratum=hwNTPSysStratum, hwNTPPeerRootDispersion=hwNTPPeerRootDispersion, hwNTPPeerConfig=hwNTPPeerConfig, hwNTPSysRootdispersion=hwNTPSysRootdispersion, hwNTPPeerJitter=hwNTPPeerJitter, hwNTPSysStabil=hwNTPSysStabil, hwNTPPeerOffset=hwNTPPeerOffset, hwNTPPeerPMode=hwNTPPeerPMode, hwNTPSysPollSec=hwNTPSysPollSec, hwNTPPeerDispersion=hwNTPPeerDispersion, hwNTPPeerAuthenable=hwNTPPeerAuthenable, hwNTPPeerRemAdr=hwNTPPeerRemAdr, hwNTPSysRootdelay=hwNTPSysRootdelay, hwNTPSysDrift=hwNTPSysDrift, hwNTPSysOffset=hwNTPSysOffset)
