...
mibBuilder.exportSymbols("T5545-MIB", trapNTPError=trapNTPError, historyTable=historyTable, comet=comet, settings=settings, valuesInt=valuesInt, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, histCO2=histCO2, trapSOAPErrDelivery=trapSOAPErrDelivery, t5545=t5545, co2Unit=co2Unit, serialNumber=serialNumber, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, co2HighInt=co2HighInt, traps=traps, tables=tables, co2Min=co2Min, trapSOAPErrFile=trapSOAPErrFile, trapCo2ClrAlarm=trapCo2ClrAlarm, messageString=messageString, co2Int=co2Int, trapCo2LowAlarm=trapCo2LowAlarm, values=values, co2LowInt=co2LowInt, co2HystInt=co2HystInt, trapSOAPErrDNS=trapSOAPErrDNS, co2DelayInt=co2DelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, co2=co2, trapCo2HighAlarm=trapCo2HighAlarm, trapTest=trapTest, trapCo2Error=trapCo2Error, products=products, co2AlarmInt=co2AlarmInt, pysmi_global=pysmi_global, DisplayString=DisplayString, co2Max=co2Max, co2Alarm=co2Alarm)
