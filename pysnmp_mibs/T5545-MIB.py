# SNMP MIB module (T5545-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T5545-MIB
...
trapTest.setObjects(
      *(("T5545-MIB", "sensorName"),
        ("T5545-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
