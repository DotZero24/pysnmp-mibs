...
CIPsecPhase2SaDirection, CIPsecEncapMode, CIPsecSpi, CIPsecEncryptionKeySize, CIPsecPhase2TunnelIndex, CIPsecNATTraversalMode, CIPsecEndPtType, CIPsecPmtu, CIPsecCompAlgorithm, CIPsecControlProtocol, CIPsecTunnelStatus, CIPsecDiffHellmanGrp, CIPsecPhase1TunnelIndexOrZero, CIPsecAuthAlgorithm, CIPsecProtocol, CIPsecEncryptAlgorithm = mibBuilder.importSymbols("CISCO-IPSEC-TC", "CIPsecPhase2SaDirection", "CIPsecEncapMode", "CIPsecSpi", "CIPsecEncryptionKeySize", "CIPsecPhase2TunnelIndex", "CIPsecNATTraversalMode", "CIPsecEndPtType", "CIPsecPmtu", "CIPsecCompAlgorithm", "CIPsecControlProtocol", "CIPsecTunnelStatus", "CIPsecDiffHellmanGrp", "CIPsecPhase1TunnelIndexOrZero", "CIPsecAuthAlgorithm", "CIPsecProtocol", "CIPsecEncryptAlgorithm")
...
mibBuilder.exportSymbols("CISCO-ENHANCED-IPSEC-FLOW-MIB", PYSNMP_MODULE_ID=ciscoEnhancedIpsecFlowMIB, ceipSecFailPktDstAddressType=ceipSecFailPktDstAddressType, ceipSecTunSaDirection=ceipSecTunSaDirection, ceipSecTunHistInDropPkts=ceipSecTunHistInDropPkts, ceipSecGlobalLastThroughputUtilization=ceipSecGlobalLastThroughputUtilization, ceipSecTunOutSaDHGrp=ceipSecTunOutSaDHGrp, ceipSecTunPmtu=ceipSecTunPmtu, ceipSecEndPtEntry=ceipSecEndPtEntry, ceipSecTunRemoteAddressType=ceipSecTunRemoteAddressType, ceipSecTunHistOutSaEncryptKeySz=ceipSecTunHistOutSaEncryptKeySz, ceipSecNotiCntlIpSecAllNotifs=ceipSecNotiCntlIpSecAllNotifs, ceipSecTunInAuths=ceipSecTunInAuths, ciscoEnhIPsecFlowNotifGroupSup01=ciscoEnhIPsecFlowNotifGroupSup01, ceipSecTunHistInSaEspAuthAlgo=ceipSecTunHistInSaEspAuthAlgo, ceipSecNotifCntlIpSecTunnelStart=ceipSecNotifCntlIpSecTunnelStart, ceipSecFailures=ceipSecFailures, ceipSecPhaseTwo=ceipSecPhaseTwo, ceipSecGlobalInOctets=ceipSecGlobalInOctets, ceipSecGlobalOutPkts=ceipSecGlobalOutPkts, ceipSecTunOutDropPkts=ceipSecTunOutDropPkts, ceipSecFailGlobalCntl=ceipSecFailGlobalCntl, ciscoEnhIpsecFlowBadSa=ciscoEnhIpsecFlowBadSa, ceipSecTunSaIfIndex=ceipSecTunSaIfIndex, ceipSecHistTableSize=ceipSecHistTableSize, ceipSecEndPtLocalAddrType1=ceipSecEndPtLocalAddrType1, ciscoEnhIPsecFlowMIBCompliance=ciscoEnhIPsecFlowMIBCompliance, ceipSecEndPtHistRemoteAddr1=ceipSecEndPtHistRemoteAddr1, ceipSecTunActiveTime=ceipSecTunActiveTime, ceipSecEndPtHistLocalType=ceipSecEndPtHistLocalType, ceipSecTunTotalRefreshes=ceipSecTunTotalRefreshes, ceipSecTunSaInPkts=ceipSecTunSaInPkts, ceipSecTunInDecryptFails=ceipSecTunInDecryptFails, ceipSecEndPtHistLocalProtocol=ceipSecEndPtHistLocalProtocol, ceipSecFailSaSpi=ceipSecFailSaSpi, ceipSecTunHistOutAuths=ceipSecTunHistOutAuths, ceipSecTunLocalAddress=ceipSecTunLocalAddress, ceipSecSaIndex=ceipSecSaIndex, ceipSecCertExpiryStatus=ceipSecCertExpiryStatus, ceipSecTunInDecompOctets=ceipSecTunInDecompOctets, ceipSecTunHistInReplayDropPkts=ceipSecTunHistInReplayDropPkts, ceipSecTunHistOutCompFailPkts=ceipSecTunHistOutCompFailPkts, ceipSecSaProtocol=ceipSecSaProtocol, ceipSecTunHistOutCompressedPkts=ceipSecTunHistOutCompressedPkts, ceipSecEndPtHistRemoteProtocol=ceipSecEndPtHistRemoteProtocol, ceipSecTunInSaDecompAlgo=ceipSecTunInSaDecompAlgo, ceipSecEndPtRemotePort=ceipSecEndPtRemotePort, ceipSecTunLifeTime=ceipSecTunLifeTime, ceipSecTunHistLocalAddress=ceipSecTunHistLocalAddress, ceipSecGlobalActiveTunnels=ceipSecGlobalActiveTunnels, ceipSecTunnelEntry=ceipSecTunnelEntry, ceipSecEndPtHistLocalAddr1=ceipSecEndPtHistLocalAddr1, ceipSecGlobalOutCompressedPkts=ceipSecGlobalOutCompressedPkts, ciscoEnhancedIpsecFlowMIBNotifs=ciscoEnhancedIpsecFlowMIBNotifs, ceipSecIfTunnelTable=ceipSecIfTunnelTable, ceipSecEndPtHistEntry=ceipSecEndPtHistEntry, ceipSecTunHistOutEncrypts=ceipSecTunHistOutEncrypts, ceipSecTunSaOutAuths=ceipSecTunSaOutAuths, ceipSecEndPtHistRemoteName=ceipSecEndPtHistRemoteName, ceipSecEndPtRemoteName=ceipSecEndPtRemoteName, ceipSecTunSaOutDropPkts=ceipSecTunSaOutDropPkts, ceipSecTunHistInAuthFails=ceipSecTunHistInAuthFails, ceipSecTunControlProtocol=ceipSecTunControlProtocol, ceipSecTunHistStartTime=ceipSecTunHistStartTime, ceipSecTunSaInDecompOctets=ceipSecTunSaInDecompOctets, ciscoEnhancedIpsecFlowMIB=ciscoEnhancedIpsecFlowMIB, ceipSecTunHistRemoteAddressType=ceipSecTunHistRemoteAddressType, ciscoEnhIPsecFlowMIBComplianceRev2=ciscoEnhIPsecFlowMIBComplianceRev2, ceipSecTunHistOutCompSmallPkts=ceipSecTunHistOutCompSmallPkts, ceipSecTunInSaEspAuthAlgo=ceipSecTunInSaEspAuthAlgo, ceipSecCertIssuerName=ceipSecCertIssuerName, ceipSecTunOutSaEncryptKeySize=ceipSecTunOutSaEncryptKeySize, ceipSecTunnelSaTable=ceipSecTunnelSaTable, ceipSecGlobalInDecrypts=ceipSecGlobalInDecrypts, ceipSecEndPtRemoteType=ceipSecEndPtRemoteType, ceipSecGlobalOutUncompOctets=ceipSecGlobalOutUncompOctets, ceipSecTunSaOutUncompOctets=ceipSecTunSaOutUncompOctets, ceipSecTunHistInSaDecompAlgo=ceipSecTunHistInSaDecompAlgo, ceipSecTunHistInAuths=ceipSecTunHistInAuths, ceipSecGlobalInDrops=ceipSecGlobalInDrops, ceipSecGlobalInDecryptFails=ceipSecGlobalInDecryptFails, ceipSecTunRemoteAddress=ceipSecTunRemoteAddress, ceipSecHistGlobalCntl=ceipSecHistGlobalCntl, ceipSecTunHistInSaEncryptAlgo=ceipSecTunHistInSaEncryptAlgo, ceipSecTunHistInDecrypts=ceipSecTunHistInDecrypts, ciscoEnhIPsecFlowHistoryGroup=ciscoEnhIPsecFlowHistoryGroup, ciscoEnhIPsecFlowPerformanceThroughputGroup=ciscoEnhIPsecFlowPerformanceThroughputGroup, ceipSecEndPtHistLocalAddrType2=ceipSecEndPtHistLocalAddrType2, ceipSecEndPtHistLocalName=ceipSecEndPtHistLocalName, ceipSecGlobalLastThroughputInKpps=ceipSecGlobalLastThroughputInKpps, ceipSecFailTableSize=ceipSecFailTableSize, ceipSecEndPtRemoteAddrType1=ceipSecEndPtRemoteAddrType1, ceipSecFailPktSrcAddressType=ceipSecFailPktSrcAddressType, ceipSecTunSaInReplayDropPkts=ceipSecTunSaInReplayDropPkts, ceipSecTunHistOutEncryptFails=ceipSecTunHistOutEncryptFails, ceipSecTunSaLifeSizeThreshold=ceipSecTunSaLifeSizeThreshold, ceipSecTunHistActiveIndex=ceipSecTunHistActiveIndex, ceipSecTunHistOutDropPkts=ceipSecTunHistOutDropPkts, ceipSecEndPtHistLocalAddr2=ceipSecEndPtHistLocalAddr2, ceipSecEndPtHistRemoteAddrType1=ceipSecEndPtHistRemoteAddrType1, ciscoEnhIPsecFlowNotifCntlGroupSup01=ciscoEnhIPsecFlowNotifCntlGroupSup01, ceipSecTunSaLifeTimeThreshold=ceipSecTunSaLifeTimeThreshold, ceipSecTunInDropPkts=ceipSecTunInDropPkts, ceipSecTunInSaEncryptKeySize=ceipSecTunInSaEncryptKeySize, ceipSecSaStatus=ceipSecSaStatus, ceipSecGlobalInPkts=ceipSecGlobalInPkts, ciscoEnhIpsecFlowCertRenewal=ciscoEnhIpsecFlowCertRenewal, ceipSecTunSaOutCompressedPkts=ceipSecTunSaOutCompressedPkts, ceipSecTunnelHistTable=ceipSecTunnelHistTable, ciscoEnhIpsecFlowSysFailure=ciscoEnhIpsecFlowSysFailure, ceipSecGlobalOutEncryptFails=ceipSecGlobalOutEncryptFails, ceipSecEndPtHistRemotePort=ceipSecEndPtHistRemotePort, ciscoEnhIPsecFlowNotifCntlGroup=ciscoEnhIPsecFlowNotifCntlGroup, ciscoEnhancedIpsecFlowMIBConform=ciscoEnhancedIpsecFlowMIBConform, ceipSecTunEncapMode=ceipSecTunEncapMode, ceipSecTunInOctets=ceipSecTunInOctets, ceipSecTunHistControlTunnelIndex=ceipSecTunHistControlTunnelIndex, ceipSecEndPtHistLocalAddrType1=ceipSecEndPtHistLocalAddrType1, ceipSecNotifCntlCertRenewal=ceipSecNotifCntlCertRenewal, ceipSecTunOutSaCompAlgo=ceipSecTunOutSaCompAlgo, ceipSecTunSaInAuthFails=ceipSecTunSaInAuthFails, ceipSecEndPtLocalProtocol=ceipSecEndPtLocalProtocol, ceipSecTunHistControlProtocol=ceipSecTunHistControlProtocol, ceipSecGlobalProtocolUseFails=ceipSecGlobalProtocolUseFails, ceipSecFailPktDstAddress=ceipSecFailPktDstAddress, ceipSecTunHistInPkts=ceipSecTunHistInPkts, ceipSecTunHistOutAuthFails=ceipSecTunHistOutAuthFails, ceipSecTunSaInDecrypts=ceipSecTunSaInDecrypts, ceipSecTunOutCompressedPkts=ceipSecTunOutCompressedPkts, ceipSecTunHistTotalSas=ceipSecTunHistTotalSas, ceipSecTunHistLifeTime=ceipSecTunHistLifeTime, ceipSecEndPtHistLocalPort=ceipSecEndPtHistLocalPort, ceipSecTunControlTunnelAlive=ceipSecTunControlTunnelAlive, ciscoEnhIpsecFlowSetupFail=ciscoEnhIpsecFlowSetupFail, ceipSecTunHistLocalAddressType=ceipSecTunHistLocalAddressType, ceipSecTunSaOutCompFailPkts=ceipSecTunSaOutCompFailPkts, ciscoEnhIPsecFlowNotifGroup=ciscoEnhIPsecFlowNotifGroup, ceipSecTunOutAuthFails=ceipSecTunOutAuthFails, ceipSecNotifCntlIpSecTunnelStop=ceipSecNotifCntlIpSecTunnelStop, ceipSecEndPtHistActiveIndex=ceipSecEndPtHistActiveIndex, ciscoEnhancedIpsecFlowMIBObjects=ciscoEnhancedIpsecFlowMIBObjects, ceipSecFailGlobal=ceipSecFailGlobal, ceipSecEndPtLocalType=ceipSecEndPtLocalType, ceipSecTunSaStatus=ceipSecTunSaStatus, ceipSecEndPtHistIndex=ceipSecEndPtHistIndex, ceipSecTunHistInSaAhAuthAlgo=ceipSecTunHistInSaAhAuthAlgo, ceipSecGlobalPeakThroughputUtilization=ceipSecGlobalPeakThroughputUtilization, ceipSecEndPtHistRemoteAddr2=ceipSecEndPtHistRemoteAddr2, ceipSecEndPtRemoteProtocol=ceipSecEndPtRemoteProtocol, ceipSecTunSaInOctets=ceipSecTunSaInOctets, ceipSecNotifCntlIpSecSetUpFail=ceipSecNotifCntlIpSecSetUpFail, ceipSecTunCurrentSaInstances=ceipSecTunCurrentSaInstances, ceipSecTunHistRemoteAddress=ceipSecTunHistRemoteAddress, ciscoEnhIPsecFlowCoreHistGroup=ciscoEnhIPsecFlowCoreHistGroup, ceipSecGlobalPeakAvgPacketSize=ceipSecGlobalPeakAvgPacketSize, ceipSecTunHistIndex=ceipSecTunHistIndex, ceipSecTunHistTotalRefreshes=ceipSecTunHistTotalRefreshes, ceipSecTunHistOutSaCompAlgo=ceipSecTunHistOutSaCompAlgo, ceipSecEndPtHistRemoteAddrType2=ceipSecEndPtHistRemoteAddrType2, ciscoEnhIpsecFlowCertExpiry=ciscoEnhIpsecFlowCertExpiry, ceipSecTunHistLifeSize=ceipSecTunHistLifeSize, ciscoEnhIPsecFlowCertObjectGroup=ciscoEnhIPsecFlowCertObjectGroup, ceipSecGlobalStats=ceipSecGlobalStats, ceipSecGlobalOutCompFailPkts=ceipSecGlobalOutCompFailPkts, ceipSecTunIndex=ceipSecTunIndex, ceipSecEndPtIndex=ceipSecEndPtIndex, ceipSecTunOutCompSkippedPkts=ceipSecTunOutCompSkippedPkts, ciscoEnhIPsecFlowFailureGroup=ciscoEnhIPsecFlowFailureGroup, ceipSecCertExpiryTime=ceipSecCertExpiryTime, ceipSecGlobalSysCapFails=ceipSecGlobalSysCapFails, ciscoEnhIPsecFlowMIBCompliances=ciscoEnhIPsecFlowMIBCompliances, ceipSecGlobalNoSaFails=ceipSecGlobalNoSaFails, ceipSecTunHistInSaDHGrp=ceipSecTunHistInSaDHGrp, ceipSecGlobalPeakThroughputInMbps=ceipSecGlobalPeakThroughputInMbps, ceipSecTunSaOutEncryptFails=ceipSecTunSaOutEncryptFails, ceipSecTunSaOutPkts=ceipSecTunSaOutPkts, ceipSecTunInReplayDropPkts=ceipSecTunInReplayDropPkts, ceipSecEndPtLocalName=ceipSecEndPtLocalName, ceipSecTunHistInDecompOctets=ceipSecTunHistInDecompOctets, ceipSecGlobalPeakThroughputDateAndTime=ceipSecGlobalPeakThroughputDateAndTime, ceipSecTunHistPmtu=ceipSecTunHistPmtu, ceipSecIfTunnelEntry=ceipSecIfTunnelEntry, ceipSecEndPtLocalAddrType2=ceipSecEndPtLocalAddrType2, ceipSecEndPtHistTable=ceipSecEndPtHistTable, ceipSecTunSaInAuths=ceipSecTunSaInAuths, ciscoEnhIPsecFlowActivityGroup=ciscoEnhIPsecFlowActivityGroup, ceipSecTunInSaEncryptAlgo=ceipSecTunInSaEncryptAlgo, ceipSecTunExpiredSaInstances=ceipSecTunExpiredSaInstances, ceipSecTunSaOutOctets=ceipSecTunSaOutOctets, ceipSecFailTime=ceipSecFailTime, ceipSecSaValue=ceipSecSaValue, ceipSecFailIndex=ceipSecFailIndex, ceipSecTunInPkts=ceipSecTunInPkts, ceipSecGlobalOutEncrypts=ceipSecGlobalOutEncrypts, ceipSecTunLifeSize=ceipSecTunLifeSize, ceipSecTunSaOutCompTooSmallPkts=ceipSecTunSaOutCompTooSmallPkts, ciscoEnhIpsecFlowTunnelStart=ciscoEnhIpsecFlowTunnelStart, ceipSecTunOutEncryptFails=ceipSecTunOutEncryptFails, ceipSecGlobalInAuths=ceipSecGlobalInAuths, ceipSecTunOutSaEspAuthAlgo=ceipSecTunOutSaEspAuthAlgo, ceipSecSaTable=ceipSecSaTable, ceipSecEndPtLocalAddr1=ceipSecEndPtLocalAddr1, ceipSecTunOutAuths=ceipSecTunOutAuths, ceipSecTunOutCompTooSmallPkts=ceipSecTunOutCompTooSmallPkts, ceipSecIfIndex=ceipSecIfIndex, ceipSecEndPtTable=ceipSecEndPtTable, ceipSecTunInDecrypts=ceipSecTunInDecrypts, ceipSecTunHistEncapMode=ceipSecTunHistEncapMode, ceipSecTunOutCompFailPkts=ceipSecTunOutCompFailPkts, ceipSecCertSubjectName=ceipSecCertSubjectName, ceipSecTunSaValue=ceipSecTunSaValue, ceipSecTunSaInDecryptFails=ceipSecTunSaInDecryptFails, ceipSecGlobalLastThroughputInMbps=ceipSecGlobalLastThroughputInMbps, ceipSecEndPtHistTunIndex=ceipSecEndPtHistTunIndex, ceipSecTunNATTraversalMode=ceipSecTunNATTraversalMode, ceipSecTunOutSaAhAuthAlgo=ceipSecTunOutSaAhAuthAlgo, ceipSecNotifCntlIpSecBadSa=ceipSecNotifCntlIpSecBadSa, ceipSecGlobalInAuthFails=ceipSecGlobalInAuthFails, ceipSecTunHistInDecryptFails=ceipSecTunHistInDecryptFails, ceipSecCertRenewalStatus=ceipSecCertRenewalStatus, ceipSecTunOutEncrypts=ceipSecTunOutEncrypts, ceipSecTunHistInOctets=ceipSecTunHistInOctets, ciscoIPsecFlowMIBGroups=ciscoIPsecFlowMIBGroups, ciscoEnhIPsecFlowCoreFailGroup=ciscoEnhIPsecFlowCoreFailGroup, ceipSecGlobalOutCompSkippedPkts=ceipSecGlobalOutCompSkippedPkts, ceipSecTunHistOutPkts=ceipSecTunHistOutPkts, ceipSecTunHistOutCompSkippedPkts=ceipSecTunHistOutCompSkippedPkts, ceipSecFailPktSrcAddress=ceipSecFailPktSrcAddress, ceipSecSaDirection=ceipSecSaDirection, ceipSecEndPtLocalPort=ceipSecEndPtLocalPort, ciscoEnhIPsecFlowMIBComplianceRev1=ciscoEnhIPsecFlowMIBComplianceRev1, ceipSecTunOutPkts=ceipSecTunOutPkts, ceipSecTunInSaDHGrp=ceipSecTunInSaDHGrp, ceipSecTunOutSaEncryptAlgo=ceipSecTunOutSaEncryptAlgo, ceipSecTunInAuthFails=ceipSecTunInAuthFails, ceipSecEndPtLocalAddr2=ceipSecEndPtLocalAddr2, ceipSecTunHistOutSaEspAuthAlgo=ceipSecTunHistOutSaEspAuthAlgo, ceipSecGlobalOutCompTooSmallPkts=ceipSecGlobalOutCompTooSmallPkts, ceipSecTunnelTable=ceipSecTunnelTable, ceipSecEndPtRemoteAddr2=ceipSecEndPtRemoteAddr2, ceipSecTunSaIndex=ceipSecTunSaIndex, ceipSecTunHistOutOctets=ceipSecTunHistOutOctets, ceipSecGlobalLastAveragePacketSize=ceipSecGlobalLastAveragePacketSize, ceipSecGlobalPreviousTunnels=ceipSecGlobalPreviousTunnels, ceipSecTunOutOctets=ceipSecTunOutOctets, ceipSecFailTunnelIndex=ceipSecFailTunnelIndex, ceipSecEndPtHistRemoteType=ceipSecEndPtHistRemoteType, ceipSecGlobalOutOctets=ceipSecGlobalOutOctets, ceipSecCertNotification=ceipSecCertNotification, ceipSecFailTable=ceipSecFailTable, ceipSecFailEntry=ceipSecFailEntry, ceipSecNotifCntlIpSecSysFailure=ceipSecNotifCntlIpSecSysFailure, ceipSecTunSaOutAuthFails=ceipSecTunSaOutAuthFails, ceipSecGlobalOutAuths=ceipSecGlobalOutAuths, ceipSecGlobalThroughputUtilizatioinTimeInterval=ceipSecGlobalThroughputUtilizatioinTimeInterval)
mibBuilder.exportSymbols("CISCO-ENHANCED-IPSEC-FLOW-MIB", ceipSecGlobalInReplayDrops=ceipSecGlobalInReplayDrops, ceipSecTunnelSaEntry=ceipSecTunnelSaEntry, ceipSecTunHistTermReason=ceipSecTunHistTermReason, ceipSecIfTunnelStatus=ceipSecIfTunnelStatus, ceipSecTunHistInSaEncryptKeySize=ceipSecTunHistInSaEncryptKeySize, ceipSecHistory=ceipSecHistory, ceipSecTunInSaAhAuthAlgo=ceipSecTunInSaAhAuthAlgo, ciscoEnhIpsecFlowTunnelStop=ciscoEnhIpsecFlowTunnelStop, ceipSecTunLocalAddressType=ceipSecTunLocalAddressType, ceipSecEndPtRemoteAddr1=ceipSecEndPtRemoteAddr1, ceipSecGlobalOutDrops=ceipSecGlobalOutDrops, ceipSecTunHistOutUncompOctets=ceipSecTunHistOutUncompOctets, ceipSecTunStatus=ceipSecTunStatus, ceipSecCertSerialNumber=ceipSecCertSerialNumber, ceipSecNotificationCntl=ceipSecNotificationCntl, ceipSecTunnelHistEntry=ceipSecTunnelHistEntry, ceipSecTunSaProtocol=ceipSecTunSaProtocol, ceipSecTunHistOutSaEncryptAlgo=ceipSecTunHistOutSaEncryptAlgo, ceipSecHistGlobal=ceipSecHistGlobal, ceipSecTunHistOutSaAhAuthAlgo=ceipSecTunHistOutSaAhAuthAlgo, ceipSecFailReason=ceipSecFailReason, ceipSecGlobalOutAuthFails=ceipSecGlobalOutAuthFails, ceipSecTunSaOutEncrypts=ceipSecTunSaOutEncrypts, ceipSecTunSaOutCompSkippedPkts=ceipSecTunSaOutCompSkippedPkts, ceipSecTunHistOutSaDHGrp=ceipSecTunHistOutSaDHGrp, ceipSecNotifCntlCertExpiry=ceipSecNotifCntlCertExpiry, ceipSecSaEntry=ceipSecSaEntry, ceipSecTunHistNATTraversalMode=ceipSecTunHistNATTraversalMode, ceipSecTunControlTunnelIndex=ceipSecTunControlTunnelIndex, ceipSecTunOutUncompOctets=ceipSecTunOutUncompOctets, ciscoEnhIPsecFlowTunnelSaGroup=ciscoEnhIPsecFlowTunnelSaGroup, ceipSecTunSaInDropPkts=ceipSecTunSaInDropPkts, ceipSecGlobalInDecompOctets=ceipSecGlobalInDecompOctets, ceipSecEndPtRemoteAddrType2=ceipSecEndPtRemoteAddrType2, ceipSecGlobalThroughputLastUpdatedTime=ceipSecGlobalThroughputLastUpdatedTime, ceipSecTunHistActiveTime=ceipSecTunHistActiveTime)
