...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-ENHANCED-IPSEC-FLOW-MIB
...
CIPsecPhase2TunnelIndex, CIPsecAuthAlgorithm, CIPsecCompAlgorithm, CIPsecPmtu, CIPsecEncapMode, CIPsecControlProtocol, CIPsecEncryptAlgorithm, CIPsecSpi, CIPsecProtocol, CIPsecTunnelStatus, CIPsecPhase2SaDirection, CIPsecNATTraversalMode, CIPsecPhase1TunnelIndexOrZero, CIPsecEncryptionKeySize, CIPsecDiffHellmanGrp, CIPsecEndPtType = mibBuilder.importSymbols("CISCO-IPSEC-TC", "CIPsecPhase2TunnelIndex", "CIPsecAuthAlgorithm", "CIPsecCompAlgorithm", "CIPsecPmtu", "CIPsecEncapMode", "CIPsecControlProtocol", "CIPsecEncryptAlgorithm", "CIPsecSpi", "CIPsecProtocol", "CIPsecTunnelStatus", "CIPsecPhase2SaDirection", "CIPsecNATTraversalMode", "CIPsecPhase1TunnelIndexOrZero", "CIPsecEncryptionKeySize", "CIPsecDiffHellmanGrp", "CIPsecEndPtType")
...
mibBuilder.exportSymbols("CISCO-ENHANCED-IPSEC-FLOW-MIB", ceipSecGlobalThroughputUtilizatioinTimeInterval=ceipSecGlobalThroughputUtilizatioinTimeInterval, ceipSecTunnelSaEntry=ceipSecTunnelSaEntry, ciscoEnhIpsecFlowBadSa=ciscoEnhIpsecFlowBadSa, ceipSecGlobalOutUncompOctets=ceipSecGlobalOutUncompOctets, ceipSecTunSaOutCompFailPkts=ceipSecTunSaOutCompFailPkts, ceipSecEndPtHistRemoteAddr2=ceipSecEndPtHistRemoteAddr2, ceipSecFailGlobal=ceipSecFailGlobal, ceipSecTunHistInSaDHGrp=ceipSecTunHistInSaDHGrp, ceipSecTunHistOutCompSkippedPkts=ceipSecTunHistOutCompSkippedPkts, ceipSecTunInSaDecompAlgo=ceipSecTunInSaDecompAlgo, ceipSecTunOutSaEspAuthAlgo=ceipSecTunOutSaEspAuthAlgo, ceipSecTunOutCompSkippedPkts=ceipSecTunOutCompSkippedPkts, ceipSecTunInDecompOctets=ceipSecTunInDecompOctets, ceipSecEndPtLocalProtocol=ceipSecEndPtLocalProtocol, ceipSecEndPtHistRemoteProtocol=ceipSecEndPtHistRemoteProtocol, ceipSecEndPtHistRemoteAddr1=ceipSecEndPtHistRemoteAddr1, ceipSecPhaseTwo=ceipSecPhaseTwo, ceipSecGlobalPeakThroughputDateAndTime=ceipSecGlobalPeakThroughputDateAndTime, ceipSecGlobalInDecryptFails=ceipSecGlobalInDecryptFails, ceipSecTunSaOutEncrypts=ceipSecTunSaOutEncrypts, ceipSecEndPtHistLocalAddr1=ceipSecEndPtHistLocalAddr1, ceipSecEndPtHistLocalPort=ceipSecEndPtHistLocalPort, ceipSecCertRenewalStatus=ceipSecCertRenewalStatus, ceipSecEndPtHistLocalType=ceipSecEndPtHistLocalType, ceipSecFailIndex=ceipSecFailIndex, ceipSecTunActiveTime=ceipSecTunActiveTime, ceipSecNotifCntlIpSecTunnelStop=ceipSecNotifCntlIpSecTunnelStop, ceipSecTunSaStatus=ceipSecTunSaStatus, ceipSecTunHistOutUncompOctets=ceipSecTunHistOutUncompOctets, ceipSecIfIndex=ceipSecIfIndex, ceipSecGlobalProtocolUseFails=ceipSecGlobalProtocolUseFails, ceipSecEndPtLocalAddr1=ceipSecEndPtLocalAddr1, ceipSecTunOutEncrypts=ceipSecTunOutEncrypts, ceipSecTunOutCompTooSmallPkts=ceipSecTunOutCompTooSmallPkts, ceipSecEndPtRemotePort=ceipSecEndPtRemotePort, ceipSecTunOutUncompOctets=ceipSecTunOutUncompOctets, ceipSecTunSaIfIndex=ceipSecTunSaIfIndex, ceipSecEndPtLocalAddr2=ceipSecEndPtLocalAddr2, ceipSecTunOutDropPkts=ceipSecTunOutDropPkts, ciscoEnhancedIpsecFlowMIBNotifs=ciscoEnhancedIpsecFlowMIBNotifs, ceipSecGlobalOutAuthFails=ceipSecGlobalOutAuthFails, ceipSecTunSaInDecryptFails=ceipSecTunSaInDecryptFails, ceipSecTunHistInSaDecompAlgo=ceipSecTunHistInSaDecompAlgo, ceipSecEndPtHistRemoteAddrType2=ceipSecEndPtHistRemoteAddrType2, ciscoEnhIpsecFlowCertExpiry=ciscoEnhIpsecFlowCertExpiry, ciscoIPsecFlowMIBGroups=ciscoIPsecFlowMIBGroups, ceipSecEndPtTable=ceipSecEndPtTable, ceipSecTunnelEntry=ceipSecTunnelEntry, ceipSecGlobalNoSaFails=ceipSecGlobalNoSaFails, ceipSecGlobalInDecrypts=ceipSecGlobalInDecrypts, ceipSecCertExpiryTime=ceipSecCertExpiryTime, ceipSecGlobalSysCapFails=ceipSecGlobalSysCapFails, ceipSecTunSaLifeSizeThreshold=ceipSecTunSaLifeSizeThreshold, ceipSecTunSaInPkts=ceipSecTunSaInPkts, ceipSecCertExpiryStatus=ceipSecCertExpiryStatus, ceipSecTunnelHistTable=ceipSecTunnelHistTable, ceipSecTunHistLifeSize=ceipSecTunHistLifeSize, ceipSecTunHistOutSaEncryptKeySz=ceipSecTunHistOutSaEncryptKeySz, ceipSecFailGlobalCntl=ceipSecFailGlobalCntl, ceipSecTunSaInAuths=ceipSecTunSaInAuths, ceipSecNotifCntlIpSecSetUpFail=ceipSecNotifCntlIpSecSetUpFail, ceipSecTunSaLifeTimeThreshold=ceipSecTunSaLifeTimeThreshold, ceipSecHistTableSize=ceipSecHistTableSize, ciscoEnhIPsecFlowCoreHistGroup=ciscoEnhIPsecFlowCoreHistGroup, ciscoEnhIPsecFlowNotifCntlGroupSup01=ciscoEnhIPsecFlowNotifCntlGroupSup01, ceipSecGlobalOutCompTooSmallPkts=ceipSecGlobalOutCompTooSmallPkts, ceipSecGlobalOutEncryptFails=ceipSecGlobalOutEncryptFails, ceipSecTunSaOutAuthFails=ceipSecTunSaOutAuthFails, ceipSecGlobalInAuths=ceipSecGlobalInAuths, ceipSecTunSaOutCompSkippedPkts=ceipSecTunSaOutCompSkippedPkts, ceipSecSaValue=ceipSecSaValue, ceipSecTunHistControlTunnelIndex=ceipSecTunHistControlTunnelIndex, ceipSecTunExpiredSaInstances=ceipSecTunExpiredSaInstances, ceipSecEndPtLocalName=ceipSecEndPtLocalName, ceipSecCertNotification=ceipSecCertNotification, ceipSecTunOutEncryptFails=ceipSecTunOutEncryptFails, ceipSecNotifCntlCertRenewal=ceipSecNotifCntlCertRenewal, ceipSecTunHistStartTime=ceipSecTunHistStartTime, ceipSecTunHistInSaEspAuthAlgo=ceipSecTunHistInSaEspAuthAlgo, ceipSecEndPtHistEntry=ceipSecEndPtHistEntry, ceipSecTunHistPmtu=ceipSecTunHistPmtu, ceipSecNotifCntlIpSecBadSa=ceipSecNotifCntlIpSecBadSa, ceipSecTunnelSaTable=ceipSecTunnelSaTable, ciscoEnhIPsecFlowHistoryGroup=ciscoEnhIPsecFlowHistoryGroup, ceipSecTunSaOutOctets=ceipSecTunSaOutOctets, ceipSecSaProtocol=ceipSecSaProtocol, ceipSecEndPtHistLocalAddrType1=ceipSecEndPtHistLocalAddrType1, ceipSecEndPtHistRemoteAddrType1=ceipSecEndPtHistRemoteAddrType1, ceipSecTunHistIndex=ceipSecTunHistIndex, ceipSecTunOutSaEncryptAlgo=ceipSecTunOutSaEncryptAlgo, ceipSecTunHistRemoteAddressType=ceipSecTunHistRemoteAddressType, ceipSecTunInSaEncryptKeySize=ceipSecTunInSaEncryptKeySize, ceipSecTunSaIndex=ceipSecTunSaIndex, ceipSecGlobalInPkts=ceipSecGlobalInPkts, ceipSecEndPtLocalPort=ceipSecEndPtLocalPort, ceipSecTunHistOutCompressedPkts=ceipSecTunHistOutCompressedPkts, ceipSecTunSaInDecompOctets=ceipSecTunSaInDecompOctets, ceipSecEndPtHistLocalProtocol=ceipSecEndPtHistLocalProtocol, ceipSecTunSaDirection=ceipSecTunSaDirection, ceipSecTunHistOutOctets=ceipSecTunHistOutOctets, ceipSecGlobalStats=ceipSecGlobalStats, ceipSecGlobalOutCompSkippedPkts=ceipSecGlobalOutCompSkippedPkts, ceipSecEndPtHistTable=ceipSecEndPtHistTable, ceipSecTunHistOutSaEncryptAlgo=ceipSecTunHistOutSaEncryptAlgo, ceipSecFailTable=ceipSecFailTable, ceipSecTunOutAuths=ceipSecTunOutAuths, ceipSecGlobalLastThroughputUtilization=ceipSecGlobalLastThroughputUtilization, ceipSecTunSaOutUncompOctets=ceipSecTunSaOutUncompOctets, ceipSecFailReason=ceipSecFailReason, ceipSecFailSaSpi=ceipSecFailSaSpi, ceipSecEndPtRemoteAddrType2=ceipSecEndPtRemoteAddrType2, ceipSecGlobalPeakThroughputInMbps=ceipSecGlobalPeakThroughputInMbps, ceipSecEndPtRemoteAddr2=ceipSecEndPtRemoteAddr2, ceipSecTunnelHistEntry=ceipSecTunnelHistEntry, ceipSecTunHistOutSaDHGrp=ceipSecTunHistOutSaDHGrp, ceipSecTunInDropPkts=ceipSecTunInDropPkts, ciscoEnhIPsecFlowMIBCompliances=ciscoEnhIPsecFlowMIBCompliances, ceipSecTunHistInSaEncryptAlgo=ceipSecTunHistInSaEncryptAlgo, ceipSecEndPtRemoteProtocol=ceipSecEndPtRemoteProtocol, ceipSecTunSaInDropPkts=ceipSecTunSaInDropPkts, ceipSecGlobalInDecompOctets=ceipSecGlobalInDecompOctets, ceipSecGlobalActiveTunnels=ceipSecGlobalActiveTunnels, ceipSecTunRemoteAddress=ceipSecTunRemoteAddress, ciscoEnhancedIpsecFlowMIBConform=ciscoEnhancedIpsecFlowMIBConform, ceipSecEndPtEntry=ceipSecEndPtEntry, ceipSecGlobalThroughputLastUpdatedTime=ceipSecGlobalThroughputLastUpdatedTime, ceipSecEndPtHistActiveIndex=ceipSecEndPtHistActiveIndex, ceipSecTunInDecryptFails=ceipSecTunInDecryptFails, ceipSecSaDirection=ceipSecSaDirection, ceipSecTunLocalAddressType=ceipSecTunLocalAddressType, ciscoEnhIPsecFlowCoreFailGroup=ciscoEnhIPsecFlowCoreFailGroup, ciscoEnhIPsecFlowMIBCompliance=ciscoEnhIPsecFlowMIBCompliance, ceipSecTunHistInAuths=ceipSecTunHistInAuths, ceipSecFailTunnelIndex=ceipSecFailTunnelIndex, ceipSecGlobalLastThroughputInKpps=ceipSecGlobalLastThroughputInKpps, ciscoEnhIpsecFlowCertRenewal=ciscoEnhIpsecFlowCertRenewal, ceipSecFailPktDstAddress=ceipSecFailPktDstAddress, ceipSecGlobalOutAuths=ceipSecGlobalOutAuths, ceipSecTunTotalRefreshes=ceipSecTunTotalRefreshes, ceipSecSaEntry=ceipSecSaEntry, ceipSecFailures=ceipSecFailures, ceipSecTunHistActiveIndex=ceipSecTunHistActiveIndex, ceipSecCertSubjectName=ceipSecCertSubjectName, ceipSecTunHistLocalAddressType=ceipSecTunHistLocalAddressType, ceipSecGlobalLastThroughputInMbps=ceipSecGlobalLastThroughputInMbps, ceipSecTunInPkts=ceipSecTunInPkts, ceipSecTunSaOutEncryptFails=ceipSecTunSaOutEncryptFails, ceipSecHistGlobalCntl=ceipSecHistGlobalCntl, ceipSecGlobalPeakAvgPacketSize=ceipSecGlobalPeakAvgPacketSize, ceipSecTunOutSaCompAlgo=ceipSecTunOutSaCompAlgo, ceipSecSaTable=ceipSecSaTable, ceipSecTunHistOutEncrypts=ceipSecTunHistOutEncrypts, ceipSecNotifCntlIpSecTunnelStart=ceipSecNotifCntlIpSecTunnelStart, ceipSecTunStatus=ceipSecTunStatus, ceipSecTunHistOutCompSmallPkts=ceipSecTunHistOutCompSmallPkts, ceipSecTunHistOutPkts=ceipSecTunHistOutPkts, ciscoEnhIPsecFlowActivityGroup=ciscoEnhIPsecFlowActivityGroup, ciscoEnhIpsecFlowSetupFail=ciscoEnhIpsecFlowSetupFail, ceipSecFailPktSrcAddressType=ceipSecFailPktSrcAddressType, ceipSecGlobalPeakThroughputUtilization=ceipSecGlobalPeakThroughputUtilization, ciscoEnhancedIpsecFlowMIBObjects=ciscoEnhancedIpsecFlowMIBObjects, ciscoEnhIPsecFlowMIBComplianceRev1=ciscoEnhIPsecFlowMIBComplianceRev1, ceipSecGlobalOutCompressedPkts=ceipSecGlobalOutCompressedPkts, ceipSecTunSaProtocol=ceipSecTunSaProtocol, ceipSecTunSaInDecrypts=ceipSecTunSaInDecrypts, ceipSecTunOutPkts=ceipSecTunOutPkts, ceipSecTunPmtu=ceipSecTunPmtu, ceipSecTunHistOutSaCompAlgo=ceipSecTunHistOutSaCompAlgo, ceipSecGlobalInReplayDrops=ceipSecGlobalInReplayDrops, ceipSecNotifCntlCertExpiry=ceipSecNotifCntlCertExpiry, ceipSecTunInOctets=ceipSecTunInOctets, ceipSecTunHistInReplayDropPkts=ceipSecTunHistInReplayDropPkts, ceipSecTunSaOutCompressedPkts=ceipSecTunSaOutCompressedPkts, ceipSecTunSaOutAuths=ceipSecTunSaOutAuths, ceipSecEndPtHistLocalAddrType2=ceipSecEndPtHistLocalAddrType2, ceipSecTunOutOctets=ceipSecTunOutOctets, ciscoEnhIPsecFlowTunnelSaGroup=ciscoEnhIPsecFlowTunnelSaGroup, ceipSecTunLifeSize=ceipSecTunLifeSize, ceipSecCertSerialNumber=ceipSecCertSerialNumber, ceipSecTunSaOutCompTooSmallPkts=ceipSecTunSaOutCompTooSmallPkts, ceipSecEndPtHistIndex=ceipSecEndPtHistIndex, ciscoEnhIPsecFlowCertObjectGroup=ciscoEnhIPsecFlowCertObjectGroup, ceipSecTunOutCompFailPkts=ceipSecTunOutCompFailPkts, ceipSecTunHistInOctets=ceipSecTunHistInOctets, ceipSecTunHistOutSaAhAuthAlgo=ceipSecTunHistOutSaAhAuthAlgo, ceipSecTunOutSaDHGrp=ceipSecTunOutSaDHGrp, ceipSecTunControlTunnelAlive=ceipSecTunControlTunnelAlive, ceipSecTunHistActiveTime=ceipSecTunHistActiveTime, ceipSecTunHistInDecompOctets=ceipSecTunHistInDecompOctets, ceipSecTunIndex=ceipSecTunIndex, ceipSecEndPtHistTunIndex=ceipSecEndPtHistTunIndex, ceipSecEndPtIndex=ceipSecEndPtIndex, ceipSecGlobalOutEncrypts=ceipSecGlobalOutEncrypts, ceipSecTunHistInDecrypts=ceipSecTunHistInDecrypts, ceipSecTunHistOutDropPkts=ceipSecTunHistOutDropPkts, ceipSecNotifCntlIpSecSysFailure=ceipSecNotifCntlIpSecSysFailure, ciscoEnhancedIpsecFlowMIB=ciscoEnhancedIpsecFlowMIB, ceipSecTunSaOutDropPkts=ceipSecTunSaOutDropPkts, ceipSecGlobalInAuthFails=ceipSecGlobalInAuthFails, ceipSecFailTime=ceipSecFailTime, ceipSecTunInDecrypts=ceipSecTunInDecrypts, ceipSecTunHistInDropPkts=ceipSecTunHistInDropPkts, ceipSecTunInSaEspAuthAlgo=ceipSecTunInSaEspAuthAlgo, ceipSecTunHistRemoteAddress=ceipSecTunHistRemoteAddress, ceipSecTunHistTermReason=ceipSecTunHistTermReason, ceipSecTunHistOutAuths=ceipSecTunHistOutAuths, ceipSecFailTableSize=ceipSecFailTableSize, ceipSecGlobalInOctets=ceipSecGlobalInOctets, ceipSecTunSaInOctets=ceipSecTunSaInOctets, ceipSecSaStatus=ceipSecSaStatus, ceipSecEndPtHistLocalAddr2=ceipSecEndPtHistLocalAddr2, ceipSecTunHistEncapMode=ceipSecTunHistEncapMode, ceipSecTunHistInDecryptFails=ceipSecTunHistInDecryptFails, ceipSecTunSaInReplayDropPkts=ceipSecTunSaInReplayDropPkts, ciscoEnhIpsecFlowTunnelStop=ciscoEnhIpsecFlowTunnelStop, ceipSecTunOutSaEncryptKeySize=ceipSecTunOutSaEncryptKeySize, ceipSecGlobalLastAveragePacketSize=ceipSecGlobalLastAveragePacketSize, ceipSecIfTunnelEntry=ceipSecIfTunnelEntry, ceipSecEndPtHistRemotePort=ceipSecEndPtHistRemotePort, ceipSecIfTunnelStatus=ceipSecIfTunnelStatus, ceipSecTunInSaEncryptAlgo=ceipSecTunInSaEncryptAlgo, ceipSecTunInReplayDropPkts=ceipSecTunInReplayDropPkts, ceipSecTunOutAuthFails=ceipSecTunOutAuthFails, ceipSecTunEncapMode=ceipSecTunEncapMode, ceipSecGlobalOutCompFailPkts=ceipSecGlobalOutCompFailPkts, ceipSecTunLocalAddress=ceipSecTunLocalAddress, ceipSecHistGlobal=ceipSecHistGlobal, ciscoEnhIPsecFlowNotifGroup=ciscoEnhIPsecFlowNotifGroup, ceipSecGlobalInDrops=ceipSecGlobalInDrops, ceipSecTunCurrentSaInstances=ceipSecTunCurrentSaInstances, ceipSecTunInAuths=ceipSecTunInAuths, ceipSecNotiCntlIpSecAllNotifs=ceipSecNotiCntlIpSecAllNotifs, PYSNMP_MODULE_ID=ciscoEnhancedIpsecFlowMIB, ceipSecTunSaValue=ceipSecTunSaValue, ceipSecSaIndex=ceipSecSaIndex, ceipSecTunLifeTime=ceipSecTunLifeTime, ciscoEnhIpsecFlowTunnelStart=ciscoEnhIpsecFlowTunnelStart, ceipSecCertIssuerName=ceipSecCertIssuerName, ceipSecTunOutSaAhAuthAlgo=ceipSecTunOutSaAhAuthAlgo, ceipSecGlobalOutPkts=ceipSecGlobalOutPkts, ciscoEnhIpsecFlowSysFailure=ciscoEnhIpsecFlowSysFailure, ceipSecTunHistOutEncryptFails=ceipSecTunHistOutEncryptFails, ceipSecTunHistOutSaEspAuthAlgo=ceipSecTunHistOutSaEspAuthAlgo, ceipSecTunOutCompressedPkts=ceipSecTunOutCompressedPkts, ceipSecIfTunnelTable=ceipSecIfTunnelTable, ceipSecTunHistInSaEncryptKeySize=ceipSecTunHistInSaEncryptKeySize, ceipSecEndPtRemoteName=ceipSecEndPtRemoteName, ceipSecHistory=ceipSecHistory, ceipSecTunInSaDHGrp=ceipSecTunInSaDHGrp, ceipSecEndPtRemoteType=ceipSecEndPtRemoteType, ceipSecNotificationCntl=ceipSecNotificationCntl, ceipSecTunControlProtocol=ceipSecTunControlProtocol, ceipSecTunHistNATTraversalMode=ceipSecTunHistNATTraversalMode, ciscoEnhIPsecFlowMIBComplianceRev2=ciscoEnhIPsecFlowMIBComplianceRev2)
mibBuilder.exportSymbols("CISCO-ENHANCED-IPSEC-FLOW-MIB", ceipSecGlobalOutOctets=ceipSecGlobalOutOctets, ceipSecTunSaOutPkts=ceipSecTunSaOutPkts, ceipSecTunHistLocalAddress=ceipSecTunHistLocalAddress, ceipSecEndPtLocalAddrType2=ceipSecEndPtLocalAddrType2, ceipSecTunHistControlProtocol=ceipSecTunHistControlProtocol, ciscoEnhIPsecFlowFailureGroup=ciscoEnhIPsecFlowFailureGroup, ciscoEnhIPsecFlowNotifCntlGroup=ciscoEnhIPsecFlowNotifCntlGroup, ceipSecEndPtHistRemoteType=ceipSecEndPtHistRemoteType, ceipSecTunHistOutAuthFails=ceipSecTunHistOutAuthFails, ceipSecEndPtHistLocalName=ceipSecEndPtHistLocalName, ceipSecFailEntry=ceipSecFailEntry, ceipSecGlobalOutDrops=ceipSecGlobalOutDrops, ceipSecTunSaInAuthFails=ceipSecTunSaInAuthFails, ceipSecTunNATTraversalMode=ceipSecTunNATTraversalMode, ceipSecTunnelTable=ceipSecTunnelTable, ceipSecTunHistInPkts=ceipSecTunHistInPkts, ceipSecTunHistInAuthFails=ceipSecTunHistInAuthFails, ceipSecGlobalPreviousTunnels=ceipSecGlobalPreviousTunnels, ceipSecEndPtLocalType=ceipSecEndPtLocalType, ceipSecFailPktDstAddressType=ceipSecFailPktDstAddressType, ciscoEnhIPsecFlowPerformanceThroughputGroup=ciscoEnhIPsecFlowPerformanceThroughputGroup, ceipSecEndPtHistRemoteName=ceipSecEndPtHistRemoteName, ceipSecTunHistInSaAhAuthAlgo=ceipSecTunHistInSaAhAuthAlgo, ceipSecTunInAuthFails=ceipSecTunInAuthFails, ceipSecTunControlTunnelIndex=ceipSecTunControlTunnelIndex, ceipSecEndPtLocalAddrType1=ceipSecEndPtLocalAddrType1, ceipSecTunInSaAhAuthAlgo=ceipSecTunInSaAhAuthAlgo, ceipSecEndPtRemoteAddrType1=ceipSecEndPtRemoteAddrType1, ceipSecTunHistLifeTime=ceipSecTunHistLifeTime, ceipSecTunHistTotalRefreshes=ceipSecTunHistTotalRefreshes, ceipSecFailPktSrcAddress=ceipSecFailPktSrcAddress, ceipSecEndPtRemoteAddr1=ceipSecEndPtRemoteAddr1, ciscoEnhIPsecFlowNotifGroupSup01=ciscoEnhIPsecFlowNotifGroupSup01, ceipSecTunHistOutCompFailPkts=ceipSecTunHistOutCompFailPkts, ceipSecTunRemoteAddressType=ceipSecTunRemoteAddressType, ceipSecTunHistTotalSas=ceipSecTunHistTotalSas)
