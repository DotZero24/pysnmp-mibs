...
mibBuilder.exportSymbols("TPT-HIGH-AVAIL-MIB", highAvailZeroPowerMode=highAvailZeroPowerMode, tptIhaNotify=tptIhaNotify, tptPerfProtNotifyDeviceID=tptPerfProtNotifyDeviceID, highAvailZeroPowerTable=highAvailZeroPowerTable, tptPerfProtNotifyMissedAlerts=tptPerfProtNotifyMissedAlerts, ConnectionState=ConnectionState, tptTrhaNotifyNewState=tptTrhaNotifyNewState, ZphaPresent=ZphaPresent, tpt_high_avail_objs=tpt_high_avail_objs, tptZphaNotify=tptZphaNotify, FaultState=FaultState, tptIhaNotifyFaultCause=tptIhaNotifyFaultCause, highAvailZeroPowerQuantity=highAvailZeroPowerQuantity, highAvailZeroPowerIndex=highAvailZeroPowerIndex, tptIhaNotifyFaultState=tptIhaNotifyFaultState, ZphaAction=ZphaAction, highAvailFaultCause=highAvailFaultCause, highAvailThresholdEnabled=highAvailThresholdEnabled, tptPerfProtNotifyDuration=tptPerfProtNotifyDuration, tptZphaNotifySegmentName=tptZphaNotifySegmentName, tptZphaNotifyDeviceID=tptZphaNotifyDeviceID, highAvailZeroPowerState=highAvailZeroPowerState, tptZphaNotifyNewState=tptZphaNotifyNewState, ZphaState=ZphaState, tptZphaNotifyTimeStamp=tptZphaNotifyTimeStamp, highAvailFaultState=highAvailFaultState, tptIhaNotifyTimeStamp=tptIhaNotifyTimeStamp, tptPerfProtNotifyTimeStamp=tptPerfProtNotifyTimeStamp, highAvailTransparentState=highAvailTransparentState, tptTrhaNotifyDeviceID=tptTrhaNotifyDeviceID, tptTrhaNotify=tptTrhaNotify, highAvailTransparentPartner=highAvailTransparentPartner, PerfProtPhase=PerfProtPhase, FaultCause=FaultCause, highAvailZeroPowerActive=highAvailZeroPowerActive, ZphaMode=ZphaMode, tptIhaNotifyDeviceID=tptIhaNotifyDeviceID, tptPerfProtNotifyLossThreshold=tptPerfProtNotifyLossThreshold, PYSNMP_MODULE_ID=tpt_high_avail_objs, highAvailTransparentEnabled=highAvailTransparentEnabled, tptPerfProtNotifyPhase=tptPerfProtNotifyPhase, highAvailThresholdPercent=highAvailThresholdPercent, highAvailZeroPowerPresence=highAvailZeroPowerPresence, highAvailZeroPowerAction=highAvailZeroPowerAction, tptPerfProtNotifyPacketLoss=tptPerfProtNotifyPacketLoss, tptTrhaNotifyTimeStamp=tptTrhaNotifyTimeStamp, highAvailTimeStamp=highAvailTimeStamp, tptPerfProtNotify=tptPerfProtNotify, highAvailZeroPowerEntry=highAvailZeroPowerEntry, highAvailZeroPowerSegment=highAvailZeroPowerSegment, highAvailEnabled=highAvailEnabled)
