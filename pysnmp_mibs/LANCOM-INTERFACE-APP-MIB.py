...
agentLinkFlapMIBObjects=_AgentLinkFlapMIBObjects_ObjectIdentity((1,3,6,1,4,1,2356,16,1,70,1))
_AgentLinkFlapGlobal_ObjectIdentity=ObjectIdentity
agentLinkFlapGlobal=_AgentLinkFlapGlobal_ObjectIdentity((1,3,6,1,4,1,2356,16,1,70,1,1))
...
agentLinkFlapAdminMode=_AgentLinkFlapAdminMode_Object((1,3,6,1,4,1,2356,16,1,70,1,1,1),_AgentLinkFlapAdminMode_Type())
...
agentLinkFlapDuration=_AgentLinkFlapDuration_Object((1,3,6,1,4,1,2356,16,1,70,1,1,2),_AgentLinkFlapDuration_Type())
