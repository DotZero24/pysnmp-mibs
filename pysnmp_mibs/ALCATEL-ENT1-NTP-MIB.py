# SNMP MIB module (ALCATEL-ENT1-NTP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-NTP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:09:07 2025
...
alaNtpPeerEntry.setIndexNames(
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpPeerAddressType"),
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpPeerAddress"),
)
if mibBuilder.loadTexts:
...
alaNtpPeerListEntry.setIndexNames(
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListAddressType"),
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListAddress"),
)
if mibBuilder.loadTexts:
...
alaNtpPeerShowEntry.setIndexNames(
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowRemoteAddressType"),
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowRemoteAddress"),
)
if mibBuilder.loadTexts:
...
alaNtpClientListEntry.setIndexNames(
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpClientListAddressType"),
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpClientListAddress"),
)
if mibBuilder.loadTexts:
...
alaNtpStatsPeerEntry.setIndexNames(
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerAddressType"),
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerAddress"),
)
if mibBuilder.loadTexts:
...
alaNtpStatsMonitorEntry.setIndexNames(
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorIndex"),
)
if mibBuilder.loadTexts:
...
alaNtpAccessKeyIdEntry.setIndexNames(
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpAccessKeyIdKeyId"),
)
if mibBuilder.loadTexts:
...
alaNtpAccessRestrictedEntry.setIndexNames(
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpAccessRestrictedIpAddress"),
    (0, "ALCATEL-ENT1-NTP-MIB", "alaNtpAccessRestrictedMask"),
)
if mibBuilder.loadTexts:
...
alaNtpConfigGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpEnable"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpMonitorEnable"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpBroadcastEnable"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerIpAddress"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerType"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerAuth"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerVersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerMinpoll"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerPrefer"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerAdmin"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerName"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerStratum"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpAuthDelay"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpBroadcastDelay"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpKeysFile"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpConfigReqKeyId"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpConfigCtlKeyId"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpConfigCfgKeyId"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPrecision"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerTests"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpSysStratum"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpMaxAssociation"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpAuthenticate"))
)
if mibBuilder.loadTexts:
...
alaNtpInfoGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListIpAddress"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListLocal"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListStratum"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListPoll"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListReach"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListDelay"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListOffset"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListDispersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListSynced"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerListName"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowRemoteIpAddress"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowLocal"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowHmode"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowPmode"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowStratum"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowPrecision"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowLeapIndicator"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowReferenceId"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowRootDistance"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowRootDispersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowPpoll"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowHpoll"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowKeyid"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowVersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowAssociation"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowValid"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowReach"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowUnreach"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowFlash"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowBroadcastOffset"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowTTL"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowTimer"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowFlags"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowReferenceTime"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowOriginateTime"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowReceiveTime"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowTransmitTime"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowOffset"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowDelay"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowDispersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowName"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpPeerShowStatus"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpClientListVersion"),
...
alaNtpStatsGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerIpAddress"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerLocal"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerLastRcv"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerNextSend"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerReachChange"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerPacketsSent"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerPacketsRcvd"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerBadAuth"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerBogusOrigin"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerDuplicate"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerBadDispersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerBadRefTime"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerCandidateOrder"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerReset"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsPeerName"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsReset"))
)
if mibBuilder.loadTexts:
...
alaNtpStatsStatGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatUptime"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatReset"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatBadStratum"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatOldVersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatNewVersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatUnknownVersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatBadLength"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatProcessed"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatBadAuth"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatLimitRejects"))
)
if mibBuilder.loadTexts:
...
alaNtpStatsLoopGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsLoopOffset"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsLoopFrequency"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsLoopPollAdjust"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsLoopWatchdog"))
)
if mibBuilder.loadTexts:
...
alaNtpStatsIoGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoReset"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoRcvBuffers"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoFreeRcvBuffers"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoUsedRcvBuffers"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoRefills"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoDroppedPackets"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoIgnoredPackets"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoRcvPackets"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoSentPackets"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoNotSentPackets"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoInterrupts"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoInterruptsRcv"))
)
if mibBuilder.loadTexts:
...
alaNtpAccessGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpAccessKeyIdTrust"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpAccessRestrictedRestrictions"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpAccessRestrictedCount"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpAccessRestrictedRowStatus"),
...
alaNtpLocalInfoGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoPeer"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoMode"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoLeapIndicator"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoStratum"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoPrecision"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoDistance"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoDispersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoReferenceId"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoReferenceTime"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoFrequency"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoStability"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoBroadcastDelay"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoAuthDelay"))
)
if mibBuilder.loadTexts:
...
alaNtpSrcIpGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpSrcIpConfig"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpSrcIp"),
        ("ALCATEL-ENT1-NTP-MIB", "ntpClientConfig"),
        ("ALCATEL-ENT1-NTP-MIB", "ntpClientIP"))
)
if mibBuilder.loadTexts:
...
alaNtpStatsMonitorGroup.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorAddress"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorPort"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorLocalAddress"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorCount"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorMode"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorVersion"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorDrop"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorLast"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorFirst"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorName"))
)
if mibBuilder.loadTexts:
...
alaNtpEventsGroup.setObjects(
    ("ALCATEL-ENT1-NTP-MIB", "alaNtpMaxAssocTrap")
)
if mibBuilder.loadTexts:
...
alaIND1NtpMonitorMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-NTP-MIB", "alaNtpConfigGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpInfoGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsStatGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsLoopGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsIoGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpAccessGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpLocalInfoGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpEventsGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpSrcIpGroup"),
        ("ALCATEL-ENT1-NTP-MIB", "alaNtpStatsMonitorGroup"))
)
if mibBuilder.loadTexts:
