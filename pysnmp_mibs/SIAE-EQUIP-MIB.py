...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/siaemic/SIAE-EQUIP-MIB
...
equipment.setRevisions(('2018-11-29 00:00', '2018-03-07 00:00', '2015-03-23 00:00', '2014-12-03 00:00', '2014-07-01 00:00', '2014-06-23 00:00', '2014-02-03 00:00', '2013-04-16 00:00',))
if mibBuilder.loadTexts: equipment.setLastUpdated('201811290000Z')
...
equipMngtTable = MibTable((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41), )
if mibBuilder.loadTexts: equipMngtTable.setStatus('current')
equipMngtTableEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1), ).setIndexNames((0, "SIAE-EQUIP-MIB", "equipMngtStatus"))
if mibBuilder.loadTexts: equipMngtTableEntry.setStatus('current')
equipMngtStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("operational", 1), ("administrative", 2)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: equipMngtStatus.setStatus('current')
equipMngtIpAddress = MibTableColumn((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 2), IpAddress()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: equipMngtIpAddress.setStatus('current')
equipMngtIpNetMask = MibTableColumn((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 3), IpAddress()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: equipMngtIpNetMask.setStatus('current')
equipMngtIpDefGateway = MibTableColumn((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 4), IpAddress()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: equipMngtIpDefGateway.setStatus('current')
equipMngtIpDefGatewayIfIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 5), InterfaceIndex().subtype(subtypeSpec=ValueRangeConstraint(1, 999))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: equipMngtIpDefGatewayIfIndex.setStatus('current')
equipMngtIfType = MibTableColumn((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("ethernet", 1), ("loopback", 2), ("vlan", 3)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: equipMngtIfType.setStatus('current')
equipMngtIfId = MibTableColumn((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 7), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 4094))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: equipMngtIfId.setStatus('current')
equipMngtIfPortVlanId = MibTableColumn((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 8), InterfaceIndex()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: equipMngtIfPortVlanId.setStatus('current')
equipLastRestartType = MibScalar((1, 3, 6, 1, 4, 1, 3373, 1103, 1, 42), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 41))).setMaxAccess("readonly")
if mibBuilder.loadTexts: equipLastRestartType.setStatus('current')
...
mibBuilder.exportSymbols("SIAE-EQUIP-MIB", equipLOMConnectedConfig=equipLOMConnectedConfig, equipOperationInProgress=equipOperationInProgress, equipManagerWakeUpIpAddr=equipManagerWakeUpIpAddr, equipMngtStatus=equipMngtStatus, equipMngtIpAddress=equipMngtIpAddress, equipIpEthVlanId=equipIpEthVlanId, equipLongitude=equipLongitude, equipManager1IpAddr=equipManager1IpAddr, equipMngtIpNetMask=equipMngtIpNetMask, equipManager2IpAddr=equipManager2IpAddr, equipMngtIpDefGateway=equipMngtIpDefGateway, equipRequest=equipRequest, equipLatitude=equipLatitude, equipMibVersion=equipMibVersion, equipManagerWakeUpAlarmSeverityCode=equipManagerWakeUpAlarmSeverityCode, equipLocation=equipLocation, equipManagerWakeUpTrapVersion=equipManagerWakeUpTrapVersion, equipMngtIfType=equipMngtIfType, equipManagerWakeUpGosipAddress=equipManagerWakeUpGosipAddress, equipManagerWakeUpTimeout=equipManagerWakeUpTimeout, equipIpEthDefGateway=equipIpEthDefGateway, equipL1L2IsIsRouting=equipL1L2IsIsRouting, equipOperationMngtControl=equipOperationMngtControl, equipMngtTable=equipMngtTable, equipConfigChangeTrapEnable=equipConfigChangeTrapEnable, equipOsiamParameter=equipOsiamParameter, equipLOMDisconnected=equipLOMDisconnected, equipManagerWakeUpAlarm=equipManagerWakeUpAlarm, equipMngtIfPortVlanId=equipMngtIfPortVlanId, PYSNMP_MODULE_ID=equipment, equipLOMConfigEnable=equipLOMConfigEnable, equipStationID=equipStationID, equipGosipAddress=equipGosipAddress, equipIpEthOsiAddress=equipIpEthOsiAddress, equipment=equipment, equipConfigChange=equipConfigChange, equipLOMConnected=equipLOMConnected, equipMngtIpDefGatewayIfIndex=equipMngtIpDefGatewayIfIndex, equipManager1TrapVersion=equipManager1TrapVersion, equipUpTime=equipUpTime, equipOperationMngtInProgress=equipOperationMngtInProgress, equipMngtIfId=equipMngtIfId, equipIpEthOsiNetMask=equipIpEthOsiNetMask, equipLastRestartType=equipLastRestartType, equipCurrentTime=equipCurrentTime, equipLOMConnectedTrapEnable=equipLOMConnectedTrapEnable, equipIpEthNetMask=equipIpEthNetMask, equipType=equipType, equipIpEthDefGatewayIfIndex=equipIpEthDefGatewayIfIndex, equipManager2TrapVersion=equipManager2TrapVersion, equipMngtTableEntry=equipMngtTableEntry, equipDailyPmTimeZone=equipDailyPmTimeZone, equipConfigChangeStatus=equipConfigChangeStatus, equipManagerWakeUpNotify=equipManagerWakeUpNotify, equipLOMConnectedMonitor=equipLOMConnectedMonitor, equipIpEthAddress=equipIpEthAddress, equipIpSnmpAgentAddress=equipIpSnmpAgentAddress)
