...
# Notes
# -----
# ASN.1 source file://mibs/siaemic/SIAE-EQUIP-MIB
...
equipMngtTable = _EquipMngtTable_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41)
)
if mibBuilder.loadTexts:
    equipMngtTable.setStatus("current")
_EquipMngtTableEntry_Object = MibTableRow
equipMngtTableEntry = _EquipMngtTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1)
)
equipMngtTableEntry.setIndexNames(
    (0, "SIAE-EQUIP-MIB", "equipMngtStatus"),
)
if mibBuilder.loadTexts:
    equipMngtTableEntry.setStatus("current")


class _EquipMngtStatus_Type(Integer32):
    """Custom type equipMngtStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_EquipMngtStatus_Type.__name__ = "Integer32"
_EquipMngtStatus_Object = MibTableColumn
equipMngtStatus = _EquipMngtStatus_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 1),
    _EquipMngtStatus_Type()
)
equipMngtStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    equipMngtStatus.setStatus("current")
_EquipMngtIpAddress_Type = IpAddress
_EquipMngtIpAddress_Object = MibTableColumn
equipMngtIpAddress = _EquipMngtIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 2),
    _EquipMngtIpAddress_Type()
)
equipMngtIpAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    equipMngtIpAddress.setStatus("current")
_EquipMngtIpNetMask_Type = IpAddress
_EquipMngtIpNetMask_Object = MibTableColumn
equipMngtIpNetMask = _EquipMngtIpNetMask_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 3),
    _EquipMngtIpNetMask_Type()
)
equipMngtIpNetMask.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    equipMngtIpNetMask.setStatus("current")
_EquipMngtIpDefGateway_Type = IpAddress
_EquipMngtIpDefGateway_Object = MibTableColumn
equipMngtIpDefGateway = _EquipMngtIpDefGateway_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 4),
    _EquipMngtIpDefGateway_Type()
)
equipMngtIpDefGateway.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    equipMngtIpDefGateway.setStatus("current")


class _EquipMngtIpDefGatewayIfIndex_Type(InterfaceIndex):
    """Custom type equipMngtIpDefGatewayIfIndex based on InterfaceIndex"""
    subtypeSpec = InterfaceIndex.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 999),
    )
...
_EquipMngtIpDefGatewayIfIndex_Type.__name__ = "InterfaceIndex"
_EquipMngtIpDefGatewayIfIndex_Object = MibTableColumn
equipMngtIpDefGatewayIfIndex = _EquipMngtIpDefGatewayIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 5),
    _EquipMngtIpDefGatewayIfIndex_Type()
)
equipMngtIpDefGatewayIfIndex.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    equipMngtIpDefGatewayIfIndex.setStatus("current")


class _EquipMngtIfType_Type(Integer32):
    """Custom type equipMngtIfType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_EquipMngtIfType_Type.__name__ = "Integer32"
_EquipMngtIfType_Object = MibTableColumn
equipMngtIfType = _EquipMngtIfType_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 6),
    _EquipMngtIfType_Type()
)
equipMngtIfType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    equipMngtIfType.setStatus("current")


class _EquipMngtIfId_Type(Integer32):
    """Custom type equipMngtIfId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_EquipMngtIfId_Type.__name__ = "Integer32"
_EquipMngtIfId_Object = MibTableColumn
equipMngtIfId = _EquipMngtIfId_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 7),
    _EquipMngtIfId_Type()
)
equipMngtIfId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    equipMngtIfId.setStatus("current")
_EquipMngtIfPortVlanId_Type = InterfaceIndex
_EquipMngtIfPortVlanId_Object = MibTableColumn
equipMngtIfPortVlanId = _EquipMngtIfPortVlanId_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 41, 1, 8),
    _EquipMngtIfPortVlanId_Type()
)
equipMngtIfPortVlanId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    equipMngtIfPortVlanId.setStatus("current")


class _EquipLastRestartType_Type(OctetString):
    """Custom type equipLastRestartType based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 41),
    )
...
_EquipLastRestartType_Type.__name__ = "OctetString"
_EquipLastRestartType_Object = MibScalar
equipLastRestartType = _EquipLastRestartType_Object(
    (1, 3, 6, 1, 4, 1, 3373, 1103, 1, 42),
    _EquipLastRestartType_Type()
)
equipLastRestartType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    equipLastRestartType.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"equipLOMConnectedMonitor": equipLOMConnectedMonitor,
       ...
       "equipMngtTable": equipMngtTable,
       "equipMngtTableEntry": equipMngtTableEntry,
       "equipMngtStatus": equipMngtStatus,
       "equipMngtIpAddress": equipMngtIpAddress,
       "equipMngtIpNetMask": equipMngtIpNetMask,
       "equipMngtIpDefGateway": equipMngtIpDefGateway,
       "equipMngtIpDefGatewayIfIndex": equipMngtIpDefGatewayIfIndex,
       "equipMngtIfType": equipMngtIfType,
       "equipMngtIfId": equipMngtIfId,
       "equipMngtIfPortVlanId": equipMngtIfPortVlanId,
       "equipLastRestartType": equipLastRestartType}
)
