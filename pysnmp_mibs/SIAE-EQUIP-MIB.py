...
mibBuilder.exportSymbols("SIAE-EQUIP-MIB", equipIpEthAddress=equipIpEthAddress, equipRequest=equipRequest, equipDailyPmTimeZone=equipDailyPmTimeZone, equipIpEthNetMask=equipIpEthNetMask, PYSNMP_MODULE_ID=equipment, equipUpTime=equipUpTime, equipMngtIpNetMask=equipMngtIpNetMask, equipMngtIpDefGatewayIfIndex=equipMngtIpDefGatewayIfIndex, equipOsiamParameter=equipOsiamParameter, equipLongitude=equipLongitude, equipManagerWakeUpAlarmSeverityCode=equipManagerWakeUpAlarmSeverityCode, equipMngtTableEntry=equipMngtTableEntry, equipLOMConnected=equipLOMConnected, equipOperationInProgress=equipOperationInProgress, equipManagerWakeUpAlarm=equipManagerWakeUpAlarm, equipMngtIfPortVlanId=equipMngtIfPortVlanId, equipConfigChangeStatus=equipConfigChangeStatus, equipManagerWakeUpIpAddr=equipManagerWakeUpIpAddr, equipment=equipment, equipIpSnmpAgentAddress=equipIpSnmpAgentAddress, equipMngtIpAddress=equipMngtIpAddress, equipLastRestartType=equipLastRestartType, equipConfigChangeTrapEnable=equipConfigChangeTrapEnable, equipLOMDisconnected=equipLOMDisconnected, equipManager1TrapVersion=equipManager1TrapVersion, equipManagerWakeUpGosipAddress=equipManagerWakeUpGosipAddress, equipIpEthDefGateway=equipIpEthDefGateway, equipLOMConfigEnable=equipLOMConfigEnable, equipMngtTable=equipMngtTable, equipIpEthOsiAddress=equipIpEthOsiAddress, equipGosipAddress=equipGosipAddress, equipIpEthVlanId=equipIpEthVlanId, equipLocation=equipLocation, equipStationID=equipStationID, equipManager1IpAddr=equipManager1IpAddr, equipManagerWakeUpTimeout=equipManagerWakeUpTimeout, equipMngtIpDefGateway=equipMngtIpDefGateway, equipMngtIfType=equipMngtIfType, equipCurrentTime=equipCurrentTime, equipMngtIfId=equipMngtIfId, equipLOMConnectedConfig=equipLOMConnectedConfig, equipOperationMngtInProgress=equipOperationMngtInProgress, equipIpEthDefGatewayIfIndex=equipIpEthDefGatewayIfIndex, equipType=equipType, equipManager2IpAddr=equipManager2IpAddr, equipMngtStatus=equipMngtStatus, equipMibVersion=equipMibVersion, equipL1L2IsIsRouting=equipL1L2IsIsRouting, equipLatitude=equipLatitude, equipManager2TrapVersion=equipManager2TrapVersion, equipManagerWakeUpNotify=equipManagerWakeUpNotify, equipIpEthOsiNetMask=equipIpEthOsiNetMask, equipConfigChange=equipConfigChange, equipLOMConnectedMonitor=equipLOMConnectedMonitor, equipManagerWakeUpTrapVersion=equipManagerWakeUpTrapVersion, equipOperationMngtControl=equipOperationMngtControl, equipLOMConnectedTrapEnable=equipLOMConnectedTrapEnable)
