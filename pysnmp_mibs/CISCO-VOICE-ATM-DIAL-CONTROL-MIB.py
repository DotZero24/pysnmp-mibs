...
CvcFaxTransmitRate, CvcSpeechCoderRate, CvcInBandSignaling, CvcGUid = mibBuilder.importSymbols("CISCO-VOICE-COMMON-DIAL-CONTROL-MIB", "CvcFaxTransmitRate", "CvcSpeechCoderRate", "CvcInBandSignaling", "CvcGUid")
...
mibBuilder.exportSymbols("CISCO-VOICE-ATM-DIAL-CONTROL-MIB", ciscoVoiceAtmDialControlMIBNotifications=ciscoVoiceAtmDialControlMIBNotifications, cvAtmCallHistorySubchannelID=cvAtmCallHistorySubchannelID, cvAtmCallHistoryUseSeqNumbers=cvAtmCallHistoryUseSeqNumbers, cvAtmCallHistoryConnectionId=cvAtmCallHistoryConnectionId, cvAtmCallActiveConnectionId=cvAtmCallActiveConnectionId, cvAtmCallActiveVpi=cvAtmCallActiveVpi, cvAtmCallActive=cvAtmCallActive, cvAtmCallHistorySessionProtocol=cvAtmCallHistorySessionProtocol, cvAtmCallHistoryVci=cvAtmCallHistoryVci, cvAtmCallHistoryCalledNumber=cvAtmCallHistoryCalledNumber, ciscoVoiceAtmDialControlMIBObjects=ciscoVoiceAtmDialControlMIBObjects, cvAtmCallHistoryEntry=cvAtmCallHistoryEntry, cvAtmCallActiveSubchannelID=cvAtmCallActiveSubchannelID, cvAtmPeerCfgVci=cvAtmPeerCfgVci, cvAtmPeerCfgDtmfRelay=cvAtmPeerCfgDtmfRelay, cvAtmCallActiveSessionTarget=cvAtmCallActiveSessionTarget, cvAtmCallActiveDtmfRelay=cvAtmCallActiveDtmfRelay, cvAtmPeerCfgVcName=cvAtmPeerCfgVcName, cvAtmPeerCfgFaxBytes=cvAtmPeerCfgFaxBytes, cvAtmPeerCfgInBandSignaling=cvAtmPeerCfgInBandSignaling, cvAtmCallHistorySessionTarget=cvAtmCallHistorySessionTarget, cvAtmCallHistoryVpi=cvAtmCallHistoryVpi, cvAtmPeerCfgVADEnable=cvAtmPeerCfgVADEnable, PYSNMP_MODULE_ID=ciscoVoiceAtmDialControlMIB, cvAtmCallActiveUseSeqNumbers=cvAtmCallActiveUseSeqNumbers, cvAtmPeerCfgSessionProtocol=cvAtmPeerCfgSessionProtocol, CvAtmSessionProtocol=CvAtmSessionProtocol, ciscoVoiceAtmDialControlMIBNotificationPrefix=ciscoVoiceAtmDialControlMIBNotificationPrefix, cvAtmCallHistoryLowerIfName=cvAtmCallHistoryLowerIfName, cvAtmPeerCfgVpi=cvAtmPeerCfgVpi, cvAtmCallHistoryGroup=cvAtmCallHistoryGroup, cvAtmPeerCfgInterfaceName=cvAtmPeerCfgInterfaceName, cvAtmCallHistory=cvAtmCallHistory, ciscoVoiceAtmDialControlMIB=ciscoVoiceAtmDialControlMIB, cvAtmPeerCfgFaxRate=cvAtmPeerCfgFaxRate, cvAtmPeerCfgCoderRate=cvAtmPeerCfgCoderRate, cvAtmDialPeer=cvAtmDialPeer, ciscoVoiceAtmDialControlMIBGroups=ciscoVoiceAtmDialControlMIBGroups, cvAtmPeerCfgUseSeqNumbers=cvAtmPeerCfgUseSeqNumbers, cvAtmCallActiveEntry=cvAtmCallActiveEntry, cvAtmCallActiveCalledNumber=cvAtmCallActiveCalledNumber, cvAtmPeerCfgTable=cvAtmPeerCfgTable, ciscoVoiceAtmDialControlMIBConformance=ciscoVoiceAtmDialControlMIBConformance, ciscoVoiceAtmDialControlMIBCompliance=ciscoVoiceAtmDialControlMIBCompliance, cvAtmCallActiveLowerIfName=cvAtmCallActiveLowerIfName, cvAtmPeerCfgGroup=cvAtmPeerCfgGroup, cvAtmPeerCfgCodecBytes=cvAtmPeerCfgCodecBytes, cvAtmPeerCfgEntry=cvAtmPeerCfgEntry, cvAtmCallActiveGroup=cvAtmCallActiveGroup, cvAtmCallHistoryTable=cvAtmCallHistoryTable, cvAtmCallHistoryDtmfRelay=cvAtmCallHistoryDtmfRelay, cvAtmCallActiveTable=cvAtmCallActiveTable, ciscoVoiceAtmDialControlMIBCompliances=ciscoVoiceAtmDialControlMIBCompliances, cvAtmCallActiveSessionProtocol=cvAtmCallActiveSessionProtocol, cvAtmCallActiveVci=cvAtmCallActiveVci)
