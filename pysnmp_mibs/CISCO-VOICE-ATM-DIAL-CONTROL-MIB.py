...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VOICE-ATM-DIAL-CONTROL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:39:22 2025
...
_CvAtmPeerCfgSessionProtocol_Type.__name__ = "CvAtmSessionProtocol"
...
class _CvAtmPeerCfgInterfaceName_Type(DisplayString):
    """Custom type cvAtmPeerCfgInterfaceName based on DisplayString"""
    defaultValue = OctetString("")


_CvAtmPeerCfgInterfaceName_Type.__name__ = "DisplayString"
...
class _CvAtmPeerCfgVcName_Type(DisplayString):
    """Custom type cvAtmPeerCfgVcName based on DisplayString"""
    defaultValue = OctetString("")


_CvAtmPeerCfgVcName_Type.__name__ = "DisplayString"
...
_CvAtmPeerCfgCoderRate_Type.__name__ = "CvcSpeechCoderRate"
...
_CvAtmPeerCfgFaxRate_Type.__name__ = "CvcFaxTransmitRate"
...
_CvAtmPeerCfgInBandSignaling_Type.__name__ = "CvcInBandSignaling"
...
_CvAtmPeerCfgVADEnable_Type.__name__ = "TruthValue"
...
_CvAtmPeerCfgUseSeqNumbers_Type.__name__ = "TruthValue"
...
_CvAtmPeerCfgDtmfRelay_Type.__name__ = "TruthValue"
...
ciscoVoiceAtmDialControlMIBCompliance.setObjects(
      *(("CISCO-VOICE-ATM-DIAL-CONTROL-MIB", "cvAtmCallHistoryGroup"),
        ("CISCO-VOICE-ATM-DIAL-CONTROL-MIB", "cvAtmCallActiveGroup"),
        ("CISCO-VOICE-ATM-DIAL-CONTROL-MIB", "cvAtmPeerCfgGroup"))
)
if mibBuilder.loadTexts:
