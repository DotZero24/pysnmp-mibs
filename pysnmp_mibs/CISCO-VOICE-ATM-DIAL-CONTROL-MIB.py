...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-VOICE-ATM-DIAL-CONTROL-MIB
...
CvcSpeechCoderRate, CvcFaxTransmitRate, CvcInBandSignaling, CvcGUid = mibBuilder.importSymbols("CISCO-VOICE-COMMON-DIAL-CONTROL-MIB", "CvcSpeechCoderRate", "CvcFaxTransmitRate", "CvcInBandSignaling", "CvcGUid")
...
mibBuilder.exportSymbols("CISCO-VOICE-ATM-DIAL-CONTROL-MIB", cvAtmCallActiveLowerIfName=cvAtmCallActiveLowerIfName, ciscoVoiceAtmDialControlMIBCompliance=ciscoVoiceAtmDialControlMIBCompliance, CvAtmSessionProtocol=CvAtmSessionProtocol, ciscoVoiceAtmDialControlMIBNotifications=ciscoVoiceAtmDialControlMIBNotifications, cvAtmPeerCfgVADEnable=cvAtmPeerCfgVADEnable, ciscoVoiceAtmDialControlMIBCompliances=ciscoVoiceAtmDialControlMIBCompliances, cvAtmPeerCfgFaxRate=cvAtmPeerCfgFaxRate, ciscoVoiceAtmDialControlMIBNotificationPrefix=ciscoVoiceAtmDialControlMIBNotificationPrefix, cvAtmCallHistoryEntry=cvAtmCallHistoryEntry, ciscoVoiceAtmDialControlMIBGroups=ciscoVoiceAtmDialControlMIBGroups, cvAtmPeerCfgGroup=cvAtmPeerCfgGroup, cvAtmPeerCfgTable=cvAtmPeerCfgTable, ciscoVoiceAtmDialControlMIBObjects=ciscoVoiceAtmDialControlMIBObjects, cvAtmPeerCfgVci=cvAtmPeerCfgVci, ciscoVoiceAtmDialControlMIBConformance=ciscoVoiceAtmDialControlMIBConformance, cvAtmCallActiveTable=cvAtmCallActiveTable, cvAtmCallActiveSessionTarget=cvAtmCallActiveSessionTarget, cvAtmCallHistoryUseSeqNumbers=cvAtmCallHistoryUseSeqNumbers, cvAtmCallActiveEntry=cvAtmCallActiveEntry, cvAtmCallHistory=cvAtmCallHistory, cvAtmCallActiveDtmfRelay=cvAtmCallActiveDtmfRelay, cvAtmPeerCfgFaxBytes=cvAtmPeerCfgFaxBytes, cvAtmCallActiveGroup=cvAtmCallActiveGroup, cvAtmCallActive=cvAtmCallActive, PYSNMP_MODULE_ID=ciscoVoiceAtmDialControlMIB, cvAtmPeerCfgVcName=cvAtmPeerCfgVcName, cvAtmCallActiveSessionProtocol=cvAtmCallActiveSessionProtocol, cvAtmCallActiveUseSeqNumbers=cvAtmCallActiveUseSeqNumbers, cvAtmCallHistoryTable=cvAtmCallHistoryTable, cvAtmCallActiveConnectionId=cvAtmCallActiveConnectionId, cvAtmPeerCfgVpi=cvAtmPeerCfgVpi, cvAtmPeerCfgSessionProtocol=cvAtmPeerCfgSessionProtocol, cvAtmPeerCfgCodecBytes=cvAtmPeerCfgCodecBytes, cvAtmCallActiveSubchannelID=cvAtmCallActiveSubchannelID, cvAtmCallHistorySubchannelID=cvAtmCallHistorySubchannelID, cvAtmPeerCfgInBandSignaling=cvAtmPeerCfgInBandSignaling, cvAtmCallHistorySessionTarget=cvAtmCallHistorySessionTarget, cvAtmPeerCfgCoderRate=cvAtmPeerCfgCoderRate, cvAtmPeerCfgUseSeqNumbers=cvAtmPeerCfgUseSeqNumbers, cvAtmCallHistoryVci=cvAtmCallHistoryVci, cvAtmPeerCfgDtmfRelay=cvAtmPeerCfgDtmfRelay, cvAtmPeerCfgInterfaceName=cvAtmPeerCfgInterfaceName, cvAtmCallActiveVpi=cvAtmCallActiveVpi, cvAtmDialPeer=cvAtmDialPeer, cvAtmCallHistoryDtmfRelay=cvAtmCallHistoryDtmfRelay, cvAtmCallHistoryLowerIfName=cvAtmCallHistoryLowerIfName, cvAtmCallHistorySessionProtocol=cvAtmCallHistorySessionProtocol, cvAtmCallHistoryCalledNumber=cvAtmCallHistoryCalledNumber, ciscoVoiceAtmDialControlMIB=ciscoVoiceAtmDialControlMIB, cvAtmCallActiveVci=cvAtmCallActiveVci, cvAtmCallHistoryGroup=cvAtmCallHistoryGroup, cvAtmCallActiveCalledNumber=cvAtmCallActiveCalledNumber, cvAtmCallHistoryConnectionId=cvAtmCallHistoryConnectionId, cvAtmPeerCfgEntry=cvAtmPeerCfgEntry, cvAtmCallHistoryVpi=cvAtmCallHistoryVpi)
