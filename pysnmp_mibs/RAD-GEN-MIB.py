# SNMP MIB module (RAD-GEN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/rad/RAD-GEN-MIB
...
(BfdDiagTC,
 BfdIntervalTC) = mibBuilder.importSymbols(
    "BFD-TC-STD-MIB-R",
    "BfdDiagTC",
    "BfdIntervalTC")
...
(AlarmForwardingCause,
 FileType,
 RadEntityType) = mibBuilder.importSymbols(
    "RAD-TC",
    "AlarmForwardingCause",
    "FileType",
    "RadEntityType")
...
class AlarmEventSourceType(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(
        *(("security", 10000),
          ...
          ("ptpRecovered", 30200),
          ("clockDomain", 30300),
          ("ptpRecoveredMaster", 30400),
          ("clockDomainSource", 30500),
          ("ptpdistributed", 30600),
          ("gnss", 30700),
          ("g82751Recovered", 30800),
          ("g82751Master", 31000),
          ("card", 40000),
          ("smartSfp", 40100),
          ("eth", 50000),
...
class AlarmEventId(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(
        *(("systemLicenseInvalid", 20001),
          ("systemDeviceTemperatureOra", 20002),
          ("systemEmergencyLicenseActive", 20003),
          ("systemConfigurationMismatch", 20004),
          ("systemHardwareFailure", 20005),
          ("systemInterfaceMismatch", 20006),
          ("systemNoInterface", 20007),
          ("systemSwPackCorrupted", 20008),
          ("systemTraceMsgProtoMemAllocErr", 20009),
          ("systemPmProcessDisabled", 20010),
          ("systemMainCardsSync", 20011),
          ("systemSourceClockFailure", 20012),
          ("systemNtpAccuracyOutOfLimit", 20013),
          ("systemLowMemory", 20014),
          ("systemCriticalLowMemory", 20015),
          ("systemPoePowerDeliveryExceeded", 20016),
          ("systemNewSwFromBootMismatch", 20017),
          ("fanFailure", 20101),
          ("powerDeliveryFailure", 20201),
          ("powerInOra", 20202),
          ("powerInLow", 20203),
          ("alarmInput", 20401),
          ("stationClockAis", 30102),
          ("stationClockLof", 30103),
          ("stationClockLos", 30104),
          ("ptpRecoveredNoPtpMaster", 30201),
          ("ptpRecoveredInvalidFreqAccuracy", 30202),
          ("ptpRecoveredInvalidTimeAccuracy", 30203),
          ("ptpRecoveredDisqualifiedMaster", 30204),
          ("clockDomainSystemClockUnlock", 30301),
          ("clockDomainStationClockQlLow", 30302),
          ("clockDomainStationClockUnlock", 30303),
          ("ptpRecoveredMasterSyncFailure", 30401),
          ("ptpRecoveredMasterAnnounceFailure", 30402),
          ("ptpRecoveredMasterDelayResponseFailure", 30403),
          ("clockDomainSourceFailure", 30501),
          ("ptpMasterUnavailableTod", 30601),
          ("ptpMasterUnavailable1pps", 30602),
          ("ptpMasterSlavesLimitReached", 30603),
          ("gnssNotLocked", 30702),
          ("gnssHardwareFailure", 30703),
          ("g82751RecoveredNoMaster", 30801),
          ("g82751RecoveredFreqOutOfSpec", 30802),
          ("g82751RecoveredTimeOutOfSpec", 30803),
          ("g82751RecoveredDisqualMaster", 30804),
          ("g82751RecoveredSyncFail", 30805),
          ("g82751RecoveredAnnounceFail", 30806),
          ("g82751RecoveredDelayRespFail", 30807),
          ("cardHwFailure", 40001),
          ("cardMismatch", 40002),
          ("cardProvisionFailure", 40003),
          ("cardUnsupportedSw", 40004),
          ("cardUnsupportedHw", 40005),
          ("cardImproperRemoval", 40006),
          ("cardTemperatureOra", 40007),
          ("cardNoResponse", 40008),
          ("cardInitFailure", 40009),
          ("cardConfigurationMismatch", 40010),
          ("cardLoading", 40011),
          ("cardUserInitiatedSwitchover", 40012),
          ("cardFaultPropagation", 40013),
          ("smartSfpMismatch", 40101),
          ("ethSfpNoResponse", 50001),
          ("ethSfpMismatch", 50002),
          ("ethLos", 50003),
          ("ethSfpRemoved", 50004),
          ("ethSfpTemperatureOra", 50005),
          ("ethSfpOprOra", 50006),
          ("ethFaultPropagation", 50007),
          ("ethAutoNegotiationFailure", 50008),
          ("ethLfs", 50009),
          ("ethSilentStartNoRx", 50010),
          ("ethDot1xSupplicantAuthFailed", 50011),
          ("ethOamEfmLinkDown", 50012),
          ("ethOamEfmLinkFaultIndication", 50013),
          ("ethOamEfmFeLinkFaultIndication", 50014),
          ("ethOamEfmCriticalLinkIndication", 50015),
          ("ethOamEfmFeCriticalLinkIndication", 50016),
          ("ethOamEfmDyingGaspIndication", 50017),
          ("ethOamEfmFeDyingGaspIndication", 50018),
          ("ethPoePoweredDeviceDisabled", 50019),
          ("ethLagLacpDown", 50020),
          ("ethLagLacpLoopDetected", 50021),
          ("ethLagLacpChurn", 50022),
          ("ethMacsecJoinCaFailed", 50023),
          ("ethFatPipeRateExceededBwp", 50024),
          ("muxEthTdmLof", 60001),
          ("muxEthTdmLos", 60002),
          ("muxEthFaultPropagation", 60003),
          ("muxEthTdmRemoteConnectionFailure", 60005),
          ("muxEthTdmLoopDetection", 60006),
          ("muxEthTdmAis", 60007),
          ("muxEthTdmSfpMismatch", 60008),
          ("muxEthTdmSfpRemoved", 60009),
          ("muxEthTdmSfpTemperatureOra", 60010),
          ("muxEthTdmSfpOprOra", 60011),
          ("shdslPowerFeedingOverCurrent", 70201),
          ("shdslInitializationFailure", 70202),
          ("shdslConfigMismatch", 70203),
          ("shdslManagementLinkDown", 70204),
          ("shdslLoopAttenOra", 70214),
          ("shdslSnrMarginOra", 70216),
          ("shdslLosw", 70218),
          ("shdslExcessiveCrcError", 70220),
          ("shdslLinkDown", 70222),
          ("pcsLinkDown", 70401),
          ("pcsOamEfmLinkDown", 70402),
          ("pcsOamEfmLinkFaultIndication", 70403),
          ("pcsOamEfmFeLinkFaultIndication", 70404),
          ("pcsOamEfmCriticalLinkIndication", 70405),
          ("pcsOamEfmFeCriticalLinkIndication", 70406),
          ("pcsOamEfmDyingGaspIndication", 70407),
          ("pcsOamEfmFeDyingGaspIndication", 70408),
          ("pcsFaultPropagation", 70409),
          ("vdsl2LinkDown", 70601),
          ("voiceHwFailure", 90001),
          ("sdhSonetSfpNoResponse", 100001),
          ("sdhSonetSfpMismatch", 100002),
          ("sdhSonetLof", 100003),
          ("sdhSonetRfi", 100004),
          ("sdhSonetLos", 100005),
          ("sdhSonetSfpRemoved", 100006),
          ("sdhSonetSfpTemperatOra", 100007),
          ("sdhSonetSfpOprOra", 100008),
          ("sdhSonetAisLine", 100009),
          ("sdhSonetTimLine", 100010),
          ("sdhSonetSdLine", 100011),
          ("sdhSonetEedLine", 100012),
          ("sdhSonetFaultPropagation", 100013),
          ("sdhSonetManagementLinkDown", 100014),
          ("sdhSonetApsProtectionByteFailure", 100016),
          ("sdhSonetApsChannelMismatch", 100017),
          ("sdhSonetApsModeMismatch", 100018),
          ("sdhSonetApsProtectionLineFailureFe", 100019),
          ("sdhSonetLicenseMismatch", 100020),
          ("sdhSonetApsInvalidMode", 100021),
          ("vcVtAisVc", 100101),
          ("vcVtLomfVc", 100102),
          ("vcVtUnequipVc", 100103),
          ("vcVtTimVc", 100104),
          ("vcVtPlmVc", 100105),
          ("vcVtLopVc", 100106),
          ("vcVtSdVc", 100107),
          ...
          ("vcVtHg4Lof", 100120),
          ("vcVtHg4Rfi", 100121),
          ("vcVtUserInitiatedSwitchover", 100122),
          ("pathAisPath", 100201),
          ("pathLomfPath", 100202),
          ("pathUnequipPath", 100203),
          ("pathTimPath", 100204),
          ("pathPlmPath", 100205),
          ("pathLopPath", 100206),
          ("pathSdPath", 100207),
          ("pathEedPath", 100208),
          ("pathRfiPath", 100209),
          ("pathUserInitiatedSwitchover", 100210),
          ("e1t1UserInitiatedSwitchover", 110101),
          ("e1t1ManagementLinkDown", 110102),
          ("e1t1ExcessiveBpv", 110103),
          ("e1t1ExcessiveErrorRatio", 110104),
          ("e1t1Ais", 110105),
          ("e1t1Lof", 110106),
          ("e1t1Rai", 110107),
          ("e1t1Lomf", 110108),
          ("e1t1Los", 110110),
          ("e1t1Ds1RingClockFailure", 110111),
          ("e1t1Ds1RingDirectionMismatch", 110112),
          ("e1t1FaultPropagation", 110113),
          ("ds1OptOpticalReceiverLos", 111001),
          ("ds1OptDs1Lof", 111002),
          ("ds1OptC3794Lof", 111003),
          ("ds1OptDs1Rai", 111004),
          ("ds1OptFaultPropagation", 111005),
          ("ds1OptManagementLinkDown", 111006),
          ("ds1OptAis", 111007),
          ("ds1OptExcessiveBpv", 111008),
          ("e3t3Rai", 120101),
          ("e3t3Ais", 120102),
          ("e3t3Lof", 120103),
          ("e3t3Los", 120104),
          ("e3t3UserInitiatedSwitchover", 120105),
          ("ds0BundleLof", 120301),
          ("ds0BundleRdi", 120302),
          ("ds0BundleOutOfService", 120303),
          ("ds0BundleRemoteForce", 120304),
          ("ds0G703Los", 120401),
          ("ds0G703FaultPropagation", 120402),
          ("ds0G703OutOfSequence", 120403),
          ("vcgMinimumMembers", 130001),
          ("vcgFaultPropagation", 130002),
          ("vcgDifferentialDelayExceeded", 130003),
          ("vcgLoa", 130004),
          ("vcgLoopDetection", 130005),
          ("serialHwFail", 150001),
          ("serialLof", 150002),
          ("serialRai", 150003),
          ("serialNoRts", 150004),
          ("serialRs232RateMismatch", 150006),
          ("serialFaultPropagation", 150007),
          ("serialLos", 150009),
          ("serialBundleLof", 150101),
          ("serialBundleRai", 150102),
          ("serialBundleFaultPropagation", 150103),
          ("logicalMacOamEfmLinkDown", 180001),
          ("logicalMacOamEfmLinkFaultIndication", 180002),
          ("logicalMacOamEfmFeLinkFaultIndication", 180003),
          ("logicalMacOamEfmCriticalLinkIndication", 180004),
          ("logicalMacOamEfmFeCriticalLinkIndication", 180005),
          ("logicalMacOamEfmDyingGaspIndication", 180006),
          ("logicalMacOamEfmFeDyingGaspIndication", 180007),
          ("logicalMacFaultPropagation", 180008),
          ("etpPortDown", 200001),
          ("etpEpsConfigurationMismatch", 200101),
          ("flowFaultPropagation", 210001),
          ("gfpLof", 230001),
          ("gfpCsf", 230002),
          ("gfpRxTrailFailure", 230003),
          ("gfpFaultPropagation", 230004),
          ("hdlcRxTrailFailure", 240001),
          ("hdlcFaultPropagation", 240002),
          ("lagLacpDown", 250001),
          ("lagLacpLoopDetection", 250002),
          ("lagLacpChurn", 250003),
          ("lagMinimumMembers", 250004),
          ("lagFailed", 250005),
          ("lagFaultPropagation", 250006),
          ("oamCfmMepAis", 270201),
          ("oamCfmMepLck", 270202),
          ("oamCfmMepMismatch", 270203),
          ("oamCfmMepDefXconCCM", 270204),
          ("oamCfmMepDefErrorCCM", 270205),
          ("oamCfmRmepLoc", 270601),
          ("oamCfmRmepRdi", 270602),
          ("oamCfmRmepDefRemoteCCM", 270603),
          ("oamCfmRmepDefRDICCM", 270604),
          ("oamCfmRmepDefMACstatus", 270605),
          ("pppLcpFailure", 280001),
          ("pppBcpFailure", 280002),
          ("pppLoopDetection", 280003),
          ("mlpppBcpFailure", 280101),
          ("mlpppFaultPropagation", 280102),
          ("epsConfigMismatch", 290201),
          ("erpStateProtected", 290301),
          ("routerNatMappingTableFull", 300001),
          ("routerInterfaceDhcpClientNoLease", 300101),
          ("ospfGracefulRestart", 300201),
          ("ospfNeighborStateChange", 300302),
          ("ospfInterfaceStateChange", 300401),
          ("ospfInterfaceConfigError", 300402),
          ("bgpSessionFailure", 300601),
          ("bgpTcpSessionAuthFailure", 300602),
          ("ipBfdDetectionTimeExpired", 300801),
          ("twampSessionUnavailable", 300901),
          ("twampSessionForwardUnavailable", 300902),
          ("twampSessionBackwardUnavailable", 300903),
          ("twampPeerTodAccuracyOutOfLimit", 301001),
          ("tunnelDown", 301201),
          ("tunnelNhrpRegistrationNoReply", 301202),
          ("tunnelNhrpRegistrationNak", 301203),
          ("pwConfigMismatch", 310001),
          ("pwOamFailure", 310002),
          ("pwRdi", 310003),
          ("pwRxFailure", 310004),
          ("pwFaultPropagation", 310006),
          ("pwRxFailureFe", 310008),
          ("pwRdiFe", 310009),
          ("cmdChannelLof", 320001),
          ("cmdChannelRai", 320002),
          ("cmdChannelAddressMismatch", 320003),
          ("cmdChannelOutOfService", 320004),
          ("cmdInActive", 320101),
          ("cmdOutActive", 320201),
          ("cellularIfDown", 320301),
          ("systemSwInstallStart", 1020001),
          ("systemSwInstallEnd", 1020002),
          ("systemDownloadEnd", 1020003),
          ("systemUserReset", 1020004),
          ("systemAlternativeConfLoaded", 1020005),
          ("systemConfMigration", 1020006),
          ("systemConfSanity", 1020007),
          ("systemTrapHardSyncStart", 1020008),
          ("systemTrapHardSyncEnd", 1020009),
          ("systemPmSpaceOverflow", 1020010),
          ("systemResourceOverflow", 1020011),
          ("systemDyingGasp", 1020012),
          ("systemDyingGaspRecovery", 1020013),
          ("systemTraceMsgFatalError", 1020014),
          ("systemTraceMsgException", 1020015),
          ("systemTraceMsgSwWatchdogReset", 1020016),
          ("systemBackupConfigurationLoaded", 1020017),
          ("systemDeviceStartup", 1020018),
          ("systemItuSatTestStart", 1020019),
          ("systemItuSatConfigurationTestEnd", 1020020),
          ("systemItuSatPerformanceTestEnd", 1020021),
          ("systemSuccessfulLogin", 1020022),
          ("systemFailedLogin", 1020023),
          ("systemLogout", 1020024),
          ("systemRfc2544TestStart", 1020025),
          ("systemRfc2544TestEnd", 1020026),
          ("systemAclLogging", 1020027),
          ("systemStartupConfigUnconfirmed", 1020028),
          ("systemActiveSoftwareChanged", 1020029),
          ("systemRunningConfigSaved", 1020030),
          ("systemItuSatResponderActivated", 1020031),
          ("systemItuSatResponderDeactivated", 1020032),
          ("systemSummerTimeStarted", 1020033),
          ("systemSummerTimeEnded", 1020034),
          ("systemCfmSoamRxPacketDropped", 1020035),
          ("systemRemoteTerminalStarted", 1020036),
          ("systemRemoteTerminalEnded", 1020037),
          ("systemLicenseEnabled", 1020038),
          ("systemLicenseDisabled", 1020039),
          ("systemLicenseViolation", 1020040),
          ("systemLicenseFilesIncompatible", 1020041),
          ("systemLicenseInstallEnd", 1020042),
          ("systemLicenseAboutToExpire", 1020043),
          ("systemLicenseExpired", 1020044),
          ("systemL3SatTestStart", 1020045),
          ("systemL3SatConfigurationTestEnd", 1020046),
          ("systemL3SatPerformanceTestEnd", 1020047),
          ("systemL3SatResponderActivated", 1020048),
          ("systemL3SatResponderDeactivated", 1020049),
          ("systemAbmTestStart", 1020050),
          ("systemAbmTestEnd", 1020051),
          ("systemL3SatPreliminaryTestFailed", 1020052),
          ("systemFileOverflow", 1020053),
          ("systemTimeChanged", 1020054),
          ("systemTimeSourceChanged", 1020055),
          ("systemSerialPortDisabled", 1020056),
          ("systemSerialPortEnabled", 1020057),
          ("systemFactoryDefaultButtonPushed", 1020058),
          ("systemPcRpcapSessionStarted", 1020060),
          ("systemPcRpcapSessionEnded", 1020061),
          ("systemPcRpcapRequestRejected", 1020062),
          ("ptpRecoveredPtpStateChange", 1030201),
          ("ptpRecoveredSevereFrequencyCondition", 1030202),
          ("ptpRecoveredSevereTimeCondition", 1030203),
          ("ptpRecoveredMasterSwitchover", 1030204),
          ("ptpRecoveredTimeStateChange", 1030205),
          ("clockDomainSystemSourceClockChange", 1030301),
          ("clockDomainStationSourceClockChange", 1030302),
          ("ptpRecoveredMasterUnicastNegotiationFailue", 1030401),
          ("ptpMasterGrantedServiceAborted", 1030601),
          ("ptpMasterSlaveRequestDenied", 1030602),
          ("g82751RecoveredFreqStateChange", 1030801),
          ("g82751RecoveredTimeStateChange", 1030802),
          ("g82751RecoveredRxClkClsChange", 1030803),
          ("g82751RecoveredSlavePortChange", 1030804),
          ("g82751RecoveredGMChange", 1030805),
          ("g82751MasterTxClkClassChange", 1031001),
          ("cardReset", 1040001),
          ("cardSwitchover", 1040002),
          ("cardProtectionCommand", 1040003),
          ("cardPluggedIn", 1040004),
          ("cardPluggedOut", 1040005),
          ("cardTraceMsgFatalError", 1040006),
          ("cardTraceMsgException", 1040007),
          ("cardTraceMsgSwWatchdogReset", 1040008),
          ("cardFanOperModeChanged", 1040009),
          ("ethSfpOptOra", 1050001),
          ("ethSfpOptOraOff", 1050002),
          ("ethSfpLbcOra", 1050003),
          ("ethSfpLbcOraOff", 1050004),
          ("ethOamEfmRemoteLoopback", 1050005),
          ("ethOamEfmRemoteLoopbackOff", 1050006),
          ("ethPortSwitchover", 1050007),
          ("ethPoePoweredDeviceConnected", 1050008),
          ("ethPoePoweredDeviceRemoved", 1050009),
          ("ethProtectionCommand", 1050010),
          ("ethLoopback", 1050011),
          ("ethLoopbackOff", 1050012),
          ("ethMacsecTxScCreated", 1050013),
          ("ethMacsecRxScCreated", 1050014),
          ("ethMacsecRxScDeleted", 1050015),
          ("ethMacsecKeyServerElected", 1050016),
          ("ethMacsecMembershipRejected", 1050017),
          ("ethMacsecSaNotInUseDiscarded", 1050018),
          ("ethMacsecLateFrameDiscarded", 1050019),
          ("ethMacsecInvalidFrameDiscarded", 1050020),
          ("ethMacsecNoSecTagDiscarded", 1050021),
          ("ethMacsecBadSecTagDiscarded", 1050022),
          ("ethMacsecUnknownSciDiscarded", 1050023),
          ("ethDot1xSuppAuthorized", 1050024),
          ("ethDot1xSuppUnauthorized", 1050025),
          ("ethDot1xAuthSuppAuthorized", 1050026),
          ("ethDot1xAuthSuppUnauthorized", 1050027),
          ("muxEthTdmSfpOptOra", 1060001),
          ("muxEthTdmSfpOptOraOff", 1060002),
          ("shdslLoopback", 1070204),
          ("shdslLoopbackOff", 1070205),
          ("pcsOamEfmRemoteLoopback", 1070401),
          ("pcsOamEfmRemoteLoopbackOff", 1070402),
          ("briLoopback", 1080001),
          ("briLoopbackOff", 1080002),
          ("sdhSonetSfpOptOra", 1100001),
          ("sdhSonetSfpLbcOra", 1100002),
          ("sdhSonetEsSectionTca", 1100003),
          ("sdhSonetSesSectionTca", 1100004),
          ("sdhSonetSefsSectionTca", 1100005),
          ("sdhSonetCvSectionTca", 1100006),
          ("sdhSonetEsLineTca", 1100007),
          ("sdhSonetSesLineTca", 1100008),
          ("sdhSonetCvLineTca", 1100009),
          ("sdhSonetUasLineTca", 1100010),
          ("sdhSonetEsLineTcaFe", 1100011),
          ("sdhSonetSesLineTcaFe", 1100012),
          ("sdhSonetCvLineTcaFe", 1100013),
          ("sdhSonetUasLineTcaFe", 1100014),
          ("sdhSonetPortSwitchOver", 1100015),
          ("sdhSonetSfpOptOraOff", 1100017),
          ("sdhSonetSfpLbcOraOff", 1100018),
          ("sdhSonetLoopback", 1100019),
          ("sdhSonetLoopbackOff", 1100020),
          ("sdhSonetApsCompatibleCommand", 1100021),
          ("sdhSonetApsOptimizedCommand", 1100022),
          ("vcVtEsVcVtTca", 1100101),
          ("vcVtSesVcVtTca", 1100102),
          ("vcVtCvVcVtTca", 1100103),
          ("vcVtUasVcVtTca", 1100104),
          ("vcVtEsVcVtTcaFe", 1100105),
          ("vcVtSesVcVtTcaFe", 1100106),
          ("vcVtCvVcVtTcaFe", 1100107),
          ("vcVtUasVcVtTcaFe", 1100108),
          ("pathEsPathTca", 1100201),
          ("pathSesPathTca", 1100202),
          ("pathCvPathTca", 1100203),
          ("pathUasPathTca", 1100204),
          ("pathEsPathTcaFe", 1100205),
          ("pathSesPathTcaFe", 1100206),
          ("pathCvPathTcaFe", 1100207),
          ("pathUasPathTcaFe", 1100208),
          ("e1t1FrameSlip", 1110101),
          ("e1t1Bpv", 1110102),
          ("e1t1CrcError", 1110103),
          ("e1t1Loopback", 1110104),
          ("e1t1LoopbackOff", 1110105),
          ("e1t1EsLineTca", 1110106),
          ("e1t1CvPathTca", 1110107),
          ("e1t1EsPathTca", 1110108),
          ("e1t1SesPathTca", 1110109),
          ("e1t1SefsPathTca", 1110110),
          ("e1t1CssPathTca", 1110111),
          ("e1t1UasPathTca", 1110112),
          ("e1t1PortSwitchover", 1110113),
          ("ds1OptFrameSlip", 1111001),
          ("ds1OptBpv", 1111002),
          ("ds1OptCrcError", 1111003),
          ("ds1OptLoopback", 1111004),
          ("ds1OptLoopbackOff", 1111005),
          ("ds1OptEsLineTca", 1111006),
          ("ds1OptCvPathTca", 1111007),
          ("ds1OptEsPathTca", 1111008),
          ("ds1OptSesPathTca", 1111009),
          ("ds1OptSefsPathTca", 1111010),
          ("ds1OptCssPathTca", 1111011),
          ("ds1OptUasPathTca", 1111012),
          ("ds1OptPortSwitchover", 1111013),
          ("e3t3Loopback", 1120101),
          ("e3t3LoopbackOff", 1120102),
          ("ds0BundlePortSwitchover", 1120301),
          ("ds0G703Loopback", 1120401),
          ("ds0G703LoopbackOff", 1120402),
          ("serialBufferSlip", 1150001),
          ("bridgeSpanningTreeNewRoot", 1170001),
          ("bridgeSpanningTreeTopologyChange", 1170002),
          ("bridgeMstpNewRoot", 1170003),
          ("bridgeMstpTopologyChange", 1170004),
          ("bridgeMldSnoopingUnsupportedIp", 1170005),
          ("bridgeMldSnoopingDuplicateIp", 1170006),
          ("logicalMacOamEfmRemoteLoopback", 1180001),
          ("logicalMacOamEfmRemoteLoopbackOff", 1180002),
          ("etpEpsPortSwitchover", 1200101),
          ("lagSubGroupSwitchover", 1250001),
          ("lagFailure", 1250002),
          ("oamCfmDestNeDelayTca", 1270401),
          ("oamCfmDestNeDelayTcaOff", 1270402),
          ("oamCfmDestNeDelayVarTca", 1270403),
          ("oamCfmDestNeDelayVarTcaOff", 1270404),
          ("oamCfmDestNeLossRatioTca", 1270405),
          ("oamCfmDestNeLossRatioTcaOff", 1270406),
          ("oamCfmDestNeLossRatioTcaFe", 1270407),
          ("oamCfmDestNeLossRatioTcaFeOff", 1270408),
          ("oamCfmDestNeUnavailableRatioTca", 1270409),
          ("oamCfmDestNeUnavailableRatioTcaOff", 1270410),
          ("oamCfmDestNeUnavailableRatioTcaFe", 1270411),
          ("oamCfmDestNeUnavailableRatioTcaFeOff", 1270412),
          ("epsPortSwitchOver", 1290201),
          ("erpWtrStart", 1290301),
          ("erpPortStateChange", 1291101),
          ("routerNatPortRangeExhaustion", 1300001),
          ("routerInterfaceDhcpLeaseObtained", 1300102),
          ("routerInterfaceDhcpAdressConflict", 1300103),
          ("ospfNeighborGracefulRestart", 1300301),
          ("bgpSessionPrefixOverflow", 1300601),
          ("ipBfdNeighborShutdown", 1300801),
          ("ipBfdNeighborAddressChange", 1300802),
          ("twampSessionLossRatioTca", 1300901),
          ("twampSessionDelayTca", 1300902),
          ("twampSessionDelayVarTca", 1300903),
          ("twampSessionForwardLossRatioTca", 1300904),
          ("twampSessionForwardDelayTca", 1300905),
          ("twampSessionForwardDelayVarTca", 1300906),
          ("twampSessionBackwardLossRatioTca", 1300907),
          ("twampSessionBackwardDelayTca", 1300908),
          ("twampSessionBackwardDelayVarTca", 1300909),
          ("twampSessionRequestRejected", 1300910),
          ("twampPeerTestStarted", 1301001),
          ("twampPeerTestStopped", 1301002),
          ("twampPeerConnectionRejected", 1301003),
          ("twampPeerTestActivationRejected", 1301004),
          ("twampResponderConnectionExpired", 1301101),
          ("twampResponderSessionExpired", 1301102),
          ("pwSwitchOver", 1310001),
          ("pwJitterBufferOverflow", 1310002),
          ("pwJitterBufferUnderflow", 1310003),
          ("pwOamDelayTca", 1310004),
          ("pwOamDelayTcaOff", 1310005),
          ("cmdChannelCrcError", 1320001),
          ("cmdChannelTxDelayChange", 1320002),
          ("cmdChannelPortSwitchover", 1320003),
          ("cellularIfRssiTca", 1320301),
          ("cellularIfRssiTcaOff", 1320302),
...
_RadFcdE1E_ObjectIdentity = ObjectIdentity
radFcdE1E = _RadFcdE1E_ObjectIdentity(
...
_RadIpMux155_ObjectIdentity = ObjectIdentity
radIpMux155 = _RadIpMux155_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 3, 155)
)
...
_RadSPH4_ObjectIdentity = ObjectIdentity
radSPH4 = _RadSPH4_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 5, 51)
)
...
_RadETX205A_ObjectIdentity = ObjectIdentity
radETX205A = _RadETX205A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 6, 30)
)
_RadETX220A_ObjectIdentity = ObjectIdentity
radETX220A = _RadETX220A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 6, 32)
)
_RadETX203AM_ObjectIdentity = ObjectIdentity
radETX203AM = _RadETX203AM_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 6, 33)
)
_RadETX203AX_ObjectIdentity = ObjectIdentity
radETX203AX = _RadETX203AX_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 6, 34)
)
_RadETX2i_ObjectIdentity = ObjectIdentity
radETX2i = _RadETX2i_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 6, 40)
)
_RadETX2iHalf19Inch_ObjectIdentity = ObjectIdentity
radETX2iHalf19Inch = _RadETX2iHalf19Inch_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 6, 43)
)
_RadETX2iNebs_ObjectIdentity = ObjectIdentity
radETX2iNebs = _RadETX2iNebs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 6, 44)
)
_RadETX2iVENebs_ObjectIdentity = ObjectIdentity
radETX2iVENebs = _RadETX2iVENebs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 6, 45)
)
_RadETX203AXH_ObjectIdentity = ObjectIdentity
radETX203AXH = _RadETX203AXH_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 6, 46)
)
...
_RadAce3220_ObjectIdentity = ObjectIdentity
radAce3220 = _RadAce3220_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 12, 3, 19)
)
...
_RadTest_ObjectIdentity = ObjectIdentity
radTest = _RadTest_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 15)
)
_RadTrace_ObjectIdentity = ObjectIdentity
radTrace = _RadTrace_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16)
)
_RadAgnTrace_ObjectIdentity = ObjectIdentity
radAgnTrace = _RadAgnTrace_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1)
)
_ResetInformationTable_Object = MibTable
resetInformationTable = _ResetInformationTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1, 1)
)
if mibBuilder.loadTexts:
    resetInformationTable.setStatus("current")
_ResetInformationEntry_Object = MibTableRow
resetInformationEntry = _ResetInformationEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1, 1, 1)
)
resetInformationEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "resetInformationId"),
)
if mibBuilder.loadTexts:
    resetInformationEntry.setStatus("current")
_ResetInformationId_Type = Unsigned32
_ResetInformationId_Object = MibTableColumn
resetInformationId = _ResetInformationId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1, 1, 1, 1),
    _ResetInformationId_Type()
)
resetInformationId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    resetInformationId.setStatus("current")


class _ResetInformationLastReset_Type(Integer32):
    """Custom type resetInformationLastReset based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ResetInformationLastReset_Type.__name__ = "Integer32"
_ResetInformationLastReset_Object = MibTableColumn
resetInformationLastReset = _ResetInformationLastReset_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1, 1, 1, 2),
    _ResetInformationLastReset_Type()
)
resetInformationLastReset.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    resetInformationLastReset.setStatus("current")
_ResetInformationFileName_Type = SnmpAdminString
_ResetInformationFileName_Object = MibTableColumn
resetInformationFileName = _ResetInformationFileName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1, 1, 1, 3),
    _ResetInformationFileName_Type()
)
resetInformationFileName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    resetInformationFileName.setStatus("current")
_ResetInformationLineNumber_Type = Unsigned32
_ResetInformationLineNumber_Object = MibTableColumn
resetInformationLineNumber = _ResetInformationLineNumber_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1, 1, 1, 4),
    _ResetInformationLineNumber_Type()
)
resetInformationLineNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    resetInformationLineNumber.setStatus("current")
_ResetInformationPC_Type = Unsigned32
_ResetInformationPC_Object = MibTableColumn
resetInformationPC = _ResetInformationPC_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1, 1, 1, 5),
    _ResetInformationPC_Type()
)
resetInformationPC.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    resetInformationPC.setStatus("current")
_ResetInformationExceptionCause_Type = Unsigned32
_ResetInformationExceptionCause_Object = MibTableColumn
resetInformationExceptionCause = _ResetInformationExceptionCause_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1, 1, 1, 6),
    _ResetInformationExceptionCause_Type()
)
resetInformationExceptionCause.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    resetInformationExceptionCause.setStatus("current")


class _ResetInformationReason_Type(Integer32):
    """Custom type resetInformationReason based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ResetInformationReason_Type.__name__ = "Integer32"
_ResetInformationReason_Object = MibTableColumn
resetInformationReason = _ResetInformationReason_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 16, 1, 1, 1, 7),
    _ResetInformationReason_Type()
)
resetInformationReason.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    resetInformationReason.setStatus("current")
_RadZeroTouch_ObjectIdentity = ObjectIdentity
radZeroTouch = _RadZeroTouch_ObjectIdentity(
...
intSwdlEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "intSwdlObjIdx"),
    (0, "RAD-GEN-MIB", "intSwdlFileIdx"),
)
if mibBuilder.loadTexts:
...
swdlStatusEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "swdlStatusTypeIdx"),
    (0, "RAD-GEN-MIB", "swdlStatusIdx"),
)
if mibBuilder.loadTexts:
...
autoFileTransferEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "autoFileTransferType"),
)
if mibBuilder.loadTexts:
...
_SystemNtpTimeSinceLastPoll_Type = Unsigned32
_SystemNtpTimeSinceLastPoll_Object = MibScalar
systemNtpTimeSinceLastPoll = _SystemNtpTimeSinceLastPoll_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 7),
    _SystemNtpTimeSinceLastPoll_Type()
)
systemNtpTimeSinceLastPoll.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemNtpTimeSinceLastPoll.setStatus("current")


class _SystemNtpModeBITS_Type(Bits):
    """Custom type systemNtpModeBITS based on Bits"""
    namedValues = NamedValues(
        ("broadcastClient", 0)
    )

_SystemNtpModeBITS_Type.__name__ = "Bits"
_SystemNtpModeBITS_Object = MibScalar
systemNtpModeBITS = _SystemNtpModeBITS_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 8),
    _SystemNtpModeBITS_Type()
)
systemNtpModeBITS.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    systemNtpModeBITS.setStatus("current")
_SystemNtpCurrentSourceType_Type = InetAddressType
_SystemNtpCurrentSourceType_Object = MibScalar
systemNtpCurrentSourceType = _SystemNtpCurrentSourceType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 9),
    _SystemNtpCurrentSourceType_Type()
)
systemNtpCurrentSourceType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemNtpCurrentSourceType.setStatus("current")
_SystemNtpCurrentSource_Type = InetAddress
_SystemNtpCurrentSource_Object = MibScalar
systemNtpCurrentSource = _SystemNtpCurrentSource_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 10),
    _SystemNtpCurrentSource_Type()
)
systemNtpCurrentSource.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemNtpCurrentSource.setStatus("current")
_SntpServerTable_Object = MibTable
sntpServerTable = _SntpServerTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11)
)
if mibBuilder.loadTexts:
    sntpServerTable.setStatus("current")
_SntpServerEntry_Object = MibTableRow
sntpServerEntry = _SntpServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1)
)
sntpServerEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "sntpServerID"),
)
if mibBuilder.loadTexts:
    sntpServerEntry.setStatus("current")
_SntpServerID_Type = Unsigned32
_SntpServerID_Object = MibTableColumn
sntpServerID = _SntpServerID_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 1),
    _SntpServerID_Type()
)
sntpServerID.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    sntpServerID.setStatus("current")
...
sntpServerRowStatus = _SntpServerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 2),
    _SntpServerRowStatus_Type()
)
sntpServerRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    sntpServerRowStatus.setStatus("current")
_SntpServerAddressType_Type = InetAddressType
_SntpServerAddressType_Object = MibTableColumn
sntpServerAddressType = _SntpServerAddressType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 3),
    _SntpServerAddressType_Type()
)
sntpServerAddressType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    sntpServerAddressType.setStatus("current")
_SntpServerAddress_Type = InetAddress
_SntpServerAddress_Object = MibTableColumn
sntpServerAddress = _SntpServerAddress_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 4),
    _SntpServerAddress_Type()
)
sntpServerAddress.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    sntpServerAddress.setStatus("current")


class _SntpServerPort_Type(InetPortNumber):
    """Custom type sntpServerPort based on InetPortNumber"""
    defaultValue = 123


_SntpServerPort_Type.__name__ = "InetPortNumber"
_SntpServerPort_Object = MibTableColumn
sntpServerPort = _SntpServerPort_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 5),
    _SntpServerPort_Type()
)
sntpServerPort.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    sntpServerPort.setStatus("current")
_SntpServerPreference_Type = Unsigned32
_SntpServerPreference_Object = MibTableColumn
sntpServerPreference = _SntpServerPreference_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 6),
...
class _SntpServerAdminStatus_Type(Integer32):
    """Custom type sntpServerAdminStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SntpServerAdminStatus_Type.__name__ = "Integer32"
_SntpServerAdminStatus_Object = MibTableColumn
sntpServerAdminStatus = _SntpServerAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 7),
    _SntpServerAdminStatus_Type()
)
sntpServerAdminStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    sntpServerAdminStatus.setStatus("current")
...
sntpServerType = _SntpServerType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 8),
    _SntpServerType_Type()
)
sntpServerType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    sntpServerType.setStatus("current")
_SntpServerLastReceivedTimestamp_Type = DateAndTime
_SntpServerLastReceivedTimestamp_Object = MibTableColumn
sntpServerLastReceivedTimestamp = _SntpServerLastReceivedTimestamp_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 9),
    _SntpServerLastReceivedTimestamp_Type()
)
sntpServerLastReceivedTimestamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    sntpServerLastReceivedTimestamp.setStatus("current")
_SntpServerLastReceivedStratum_Type = Unsigned32
_SntpServerLastReceivedStratum_Object = MibTableColumn
sntpServerLastReceivedStratum = _SntpServerLastReceivedStratum_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 10),
    _SntpServerLastReceivedStratum_Type()
)
sntpServerLastReceivedStratum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    sntpServerLastReceivedStratum.setStatus("current")
_SntpServerTimeSinceLastReceivedMessage_Type = TimeTicks
_SntpServerTimeSinceLastReceivedMessage_Object = MibTableColumn
sntpServerTimeSinceLastReceivedMessage = _SntpServerTimeSinceLastReceivedMessage_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 11),
    _SntpServerTimeSinceLastReceivedMessage_Type()
)
sntpServerTimeSinceLastReceivedMessage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    sntpServerTimeSinceLastReceivedMessage.setStatus("current")


class _SntpServerSendRequestNow_Type(Integer32):
    """Custom type sntpServerSendRequestNow based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_SntpServerSendRequestNow_Type.__name__ = "Integer32"
_SntpServerSendRequestNow_Object = MibTableColumn
sntpServerSendRequestNow = _SntpServerSendRequestNow_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 11, 1, 12),
    _SntpServerSendRequestNow_Type()
)
sntpServerSendRequestNow.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    sntpServerSendRequestNow.setStatus("current")


class _SystemNtpLockingStatus_Type(Integer32):
    """Custom type systemNtpLockingStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SystemNtpLockingStatus_Type.__name__ = "Integer32"
_SystemNtpLockingStatus_Object = MibScalar
systemNtpLockingStatus = _SystemNtpLockingStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 12),
    _SystemNtpLockingStatus_Type()
)
systemNtpLockingStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemNtpLockingStatus.setStatus("current")
_SystemSummerTimeState_Type = Unsigned32
_SystemSummerTimeState_Object = MibScalar
systemSummerTimeState = _SystemSummerTimeState_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 4, 13),
    _SystemSummerTimeState_Type()
)
systemSummerTimeState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemSummerTimeState.setStatus("current")
...
class _SchedXWeek_Type(Bits):
    """Custom type schedXWeek based on Bits"""
    defaultBinValue = "0"
...
_SchedXWeek_Type.__name__ = "Bits"
_SchedXWeek_Object = MibTableColumn
schedXWeek = _SchedXWeek_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 5, 1, 4),
    _SchedXWeek_Type()
)
schedXWeek.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    schedXWeek.setStatus("current")


class _SchedAction_Type(OctetString):
    """Custom type schedAction based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_SchedAction_Type.__name__ = "OctetString"
_SchedAction_Object = MibTableColumn
schedAction = _SchedAction_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 5, 1, 5),
    _SchedAction_Type()
)
schedAction.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    schedAction.setStatus("current")
_SchedControl_ObjectIdentity = ObjectIdentity
schedControl = _SchedControl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 8)
)


class _SchedDeleteFinishedCmd_Type(Integer32):
    """Custom type schedDeleteFinishedCmd based on Integer32"""
    defaultValue = 2
...
_SchedDeleteFinishedCmd_Type.__name__ = "Integer32"
_SchedDeleteFinishedCmd_Object = MibScalar
schedDeleteFinishedCmd = _SchedDeleteFinishedCmd_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 8, 1),
    _SchedDeleteFinishedCmd_Type()
)
schedDeleteFinishedCmd.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    schedDeleteFinishedCmd.setStatus("current")


class _SchedClearLogCmd_Type(Integer32):
    """Custom type schedClearLogCmd based on Integer32"""
    defaultValue = 2
...
_SchedClearLogCmd_Type.__name__ = "Integer32"
_SchedClearLogCmd_Object = MibScalar
schedClearLogCmd = _SchedClearLogCmd_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 8, 2),
    _SchedClearLogCmd_Type()
)
schedClearLogCmd.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    schedClearLogCmd.setStatus("current")
_SystemDateTime_ObjectIdentity = ObjectIdentity
systemDateTime = _SystemDateTime_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 9)
)
_SystemLastTimeChangeOffset_Type = Integer32
_SystemLastTimeChangeOffset_Object = MibScalar
systemLastTimeChangeOffset = _SystemLastTimeChangeOffset_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 9, 1),
    _SystemLastTimeChangeOffset_Type()
)
systemLastTimeChangeOffset.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemLastTimeChangeOffset.setStatus("current")
if mibBuilder.loadTexts:
    systemLastTimeChangeOffset.setUnits("seconds")


class _SystemLastTimeChangeReason_Type(Integer32):
    """Custom type systemLastTimeChangeReason based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SystemLastTimeChangeReason_Type.__name__ = "Integer32"
_SystemLastTimeChangeReason_Object = MibScalar
systemLastTimeChangeReason = _SystemLastTimeChangeReason_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 14, 9, 2),
    _SystemLastTimeChangeReason_Type()
)
systemLastTimeChangeReason.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemLastTimeChangeReason.setStatus("current")
...
class _PhysicalConnectorUsed_Type(Integer32):
    """Custom type physicalConnectorUsed based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PhysicalConnectorUsed_Type.__name__ = "Integer32"
_PhysicalConnectorUsed_Object = MibTableColumn
physicalConnectorUsed = _PhysicalConnectorUsed_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 1, 1, 11),
    _PhysicalConnectorUsed_Type()
)
physicalConnectorUsed.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    physicalConnectorUsed.setStatus("current")
_PhysicalConnectorSfpWaveLength_Type = Unsigned32
_PhysicalConnectorSfpWaveLength_Object = MibTableColumn
physicalConnectorSfpWaveLength = _PhysicalConnectorSfpWaveLength_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 1, 1, 18),
    _PhysicalConnectorSfpWaveLength_Type()
)
physicalConnectorSfpWaveLength.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    physicalConnectorSfpWaveLength.setStatus("current")
if mibBuilder.loadTexts:
    physicalConnectorSfpWaveLength.setUnits("hundredths of nm")
...
prtSpEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "prtSupervisoryIndex"),
)
if mibBuilder.loadTexts:
...
prtPerfEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "prtPerfIdx"),
    (0, "RAD-GEN-MIB", "prtPerfPeriodRef"),
)
if mibBuilder.loadTexts:
...
_PrtTestForceTTL_Type = Unsigned32
_PrtTestForceTTL_Object = MibTableColumn
prtTestForceTTL = _PrtTestForceTTL_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 4, 1, 1, 24),
    _PrtTestForceTTL_Type()
)
prtTestForceTTL.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    prtTestForceTTL.setStatus("current")
...
if mibBuilder.loadTexts:
    prtTestBwProfile.setStatus("deprecated")
_PrtTestSourceIpAddress_Type = IpAddress
_PrtTestSourceIpAddress_Object = MibTableColumn
prtTestSourceIpAddress = _PrtTestSourceIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 4, 1, 1, 26),
    _PrtTestSourceIpAddress_Type()
)
prtTestSourceIpAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    prtTestSourceIpAddress.setStatus("current")
_PrtTestRemainTime_Type = Unsigned32
_PrtTestRemainTime_Object = MibTableColumn
prtTestRemainTime = _PrtTestRemainTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 4, 1, 1, 27),
    _PrtTestRemainTime_Type()
)
prtTestRemainTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    prtTestRemainTime.setStatus("current")
...
class _PrtParamSdBerThreshold_Type(Unsigned32):
    """Custom type prtParamSdBerThreshold based on Unsigned32"""
...
_PrtParamSdBerThreshold_Type.__name__ = "Unsigned32"
_PrtParamSdBerThreshold_Object = MibTableColumn
prtParamSdBerThreshold = _PrtParamSdBerThreshold_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 1, 1, 28),
    _PrtParamSdBerThreshold_Type()
)
prtParamSdBerThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    prtParamSdBerThreshold.setStatus("current")


class _PrtParamLoopDetectStatus_Type(Integer32):
    """Custom type prtParamLoopDetectStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PrtParamLoopDetectStatus_Type.__name__ = "Integer32"
_PrtParamLoopDetectStatus_Object = MibTableColumn
prtParamLoopDetectStatus = _PrtParamLoopDetectStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 1, 1, 29),
    _PrtParamLoopDetectStatus_Type()
)
prtParamLoopDetectStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    prtParamLoopDetectStatus.setStatus("current")
_PrtParamSupportedFeatures_Type = OctetString
_PrtParamSupportedFeatures_Object = MibTableColumn
prtParamSupportedFeatures = _PrtParamSupportedFeatures_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 1, 1, 30),
    _PrtParamSupportedFeatures_Type()
)
prtParamSupportedFeatures.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    prtParamSupportedFeatures.setStatus("current")


class _PrtParamPortStatus_Type(Bits):
    """Custom type prtParamPortStatus based on Bits"""
    namedValues = NamedValues(
        *(("ais", 0),
          ("rdi", 1),
          ("loopDetected", 2),
          ...
          ("notPresent", 6),
          ("lowerLayerDown", 7),
          ("macAccessSecViolation", 8),
          ("signalDegradation", 9),
          ("unknown", 10),
          ("oamCriticalBitOn", 11),
          ("los", 12),
          ("autoNegotiationFailure", 13),
          ("sfpFailure", 14),
          ("lof", 15),
          ("serialRateGeneratorFailure", 16),
          ("serialRs232RateNot64kbps", 17),
          ("voiceComboFailure", 18),
          ("belowMinimumMembers", 19),
          ("allLinksDown", 20),
          ("linkFailSignaling", 21))
    )

_PrtParamPortStatus_Type.__name__ = "Bits"
_PrtParamPortStatus_Object = MibTableColumn
prtParamPortStatus = _PrtParamPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 1, 1, 31),
    _PrtParamPortStatus_Type()
)
prtParamPortStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    prtParamPortStatus.setStatus("current")


class _PrtParamSsmTx_Type(Integer32):
    """Custom type prtParamSsmTx based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_PrtParamSsmTx_Type.__name__ = "Integer32"
_PrtParamSsmTx_Object = MibTableColumn
prtParamSsmTx = _PrtParamSsmTx_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 1, 1, 34),
    _PrtParamSsmTx_Type()
)
prtParamSsmTx.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    prtParamSsmTx.setStatus("current")


class _PrtParamAlias_Type(DisplayString):
    """Custom type prtParamAlias based on DisplayString"""
...
_PrtParamAlias_Type.__name__ = "DisplayString"
_PrtParamAlias_Object = MibTableColumn
prtParamAlias = _PrtParamAlias_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 1, 1, 36),
    _PrtParamAlias_Type()
)
prtParamAlias.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    prtParamAlias.setStatus("current")
_PrtParamTxClockInstance_Type = Unsigned32
_PrtParamTxClockInstance_Object = MibTableColumn
prtParamTxClockInstance = _PrtParamTxClockInstance_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 1, 1, 38),
    _PrtParamTxClockInstance_Type()
)
prtParamTxClockInstance.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    prtParamTxClockInstance.setStatus("current")
_PrtParamEntPhysicalIndex_Type = PhysicalIndexOrZero
_PrtParamEntPhysicalIndex_Object = MibTableColumn
prtParamEntPhysicalIndex = _PrtParamEntPhysicalIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 1, 1, 41),
    _PrtParamEntPhysicalIndex_Type()
)
prtParamEntPhysicalIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    prtParamEntPhysicalIndex.setStatus("current")


class _PrtParamSsmTxType_Type(Integer32):
    """Custom type prtParamSsmTxType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PrtParamSsmTxType_Type.__name__ = "Integer32"
_PrtParamSsmTxType_Object = MibTableColumn
prtParamSsmTxType = _PrtParamSsmTxType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 1, 1, 45),
    _PrtParamSsmTxType_Type()
)
prtParamSsmTxType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    prtParamSsmTxType.setStatus("current")
_PrtXTable_Object = MibTable
prtXTable = _PrtXTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 2)
)
if mibBuilder.loadTexts:
    prtXTable.setStatus("current")
_PrtXEntry_Object = MibTableRow
prtXEntry = _PrtXEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 2, 1)
)
prtXEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    prtXEntry.setStatus("current")
_PrtXCliPortString_Type = SnmpAdminString
_PrtXCliPortString_Object = MibTableColumn
prtXCliPortString = _PrtXCliPortString_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 15, 5, 2, 1, 1),
    _PrtXCliPortString_Type()
)
prtXCliPortString.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    prtXCliPortString.setStatus("current")
...
prtIpParamEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "prtIpParamConfigIdx"),
    (0, "RAD-GEN-MIB", "prtIpParamSlotIdx"),
    (0, "RAD-GEN-MIB", "prtIpParamIdx"),
)
if mibBuilder.loadTexts:
...
prtClkSrcEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "prtClkSrcCnfgIdx"),
    (0, "RAD-GEN-MIB", "prtClkSrcPrtIdx"),
    (0, "RAD-GEN-MIB", "prtClkSrcIdx"),
)
if mibBuilder.loadTexts:
...
optPrtMonitorEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "optPrtMonitorPrtIdx"),
    (0, "RAD-GEN-MIB", "optPrtMonitorSample"),
)
if mibBuilder.loadTexts:
...
optPrtCnfgEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "optPrtCnfgIdx"),
    (0, "RAD-GEN-MIB", "optPrtCnfgPrtIdx"),
)
if mibBuilder.loadTexts:
...
systemPsEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "systemPsIndex1"),
    (0, "RAD-GEN-MIB", "systemPsIndex2"),
)
if mibBuilder.loadTexts:
...
xcEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "xcIndex"),
    (0, "RAD-GEN-MIB", "xcIfIndex1"),
    (0, "RAD-GEN-MIB", "xcVpi"),
    (0, "RAD-GEN-MIB", "xcVci"),
    (0, "RAD-GEN-MIB", "xcIfIndex2"),
)
if mibBuilder.loadTexts:
...
class _AgnTacacsAccess_Type(Integer32):
    """Custom type agnTacacsAccess based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_AgnTacacsAccess_Type.__name__ = "Integer32"
_AgnTacacsAccess_Object = MibScalar
agnTacacsAccess = _AgnTacacsAccess_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 5),
    _AgnTacacsAccess_Type()
)
agnTacacsAccess.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnTacacsAccess.setStatus("current")
_DeviceAccessTable_Object = MibTable
deviceAccessTable = _DeviceAccessTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6)
)
if mibBuilder.loadTexts:
    deviceAccessTable.setStatus("current")
_DeviceAccessEntry_Object = MibTableRow
deviceAccessEntry = _DeviceAccessEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1)
)
deviceAccessEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "deviceAccessIndex"),
)
if mibBuilder.loadTexts:
    deviceAccessEntry.setStatus("current")
_DeviceAccessIndex_Type = Unsigned32
_DeviceAccessIndex_Object = MibTableColumn
deviceAccessIndex = _DeviceAccessIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 1),
    _DeviceAccessIndex_Type()
)
deviceAccessIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    deviceAccessIndex.setStatus("current")
_DeviceAccessLoginTime_Type = DateAndTime
_DeviceAccessLoginTime_Object = MibTableColumn
deviceAccessLoginTime = _DeviceAccessLoginTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 2),
    _DeviceAccessLoginTime_Type()
)
deviceAccessLoginTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessLoginTime.setStatus("current")


class _DeviceAccessLoginStatus_Type(Integer32):
    """Custom type deviceAccessLoginStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_DeviceAccessLoginStatus_Type.__name__ = "Integer32"
_DeviceAccessLoginStatus_Object = MibTableColumn
deviceAccessLoginStatus = _DeviceAccessLoginStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 3),
    _DeviceAccessLoginStatus_Type()
)
deviceAccessLoginStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessLoginStatus.setStatus("current")
_DeviceAccessUserName_Type = SnmpAdminString
_DeviceAccessUserName_Object = MibTableColumn
deviceAccessUserName = _DeviceAccessUserName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 4),
    _DeviceAccessUserName_Type()
)
deviceAccessUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessUserName.setStatus("current")
_DeviceAccessIpAddressType_Type = InetAddressType
_DeviceAccessIpAddressType_Object = MibTableColumn
deviceAccessIpAddressType = _DeviceAccessIpAddressType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 5),
    _DeviceAccessIpAddressType_Type()
)
deviceAccessIpAddressType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessIpAddressType.setStatus("current")
_DeviceAccessIpAddress_Type = InetAddress
_DeviceAccessIpAddress_Object = MibTableColumn
deviceAccessIpAddress = _DeviceAccessIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 6),
    _DeviceAccessIpAddress_Type()
)
deviceAccessIpAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessIpAddress.setStatus("current")


class _DeviceAccessMethod_Type(Integer32):
    """Custom type deviceAccessMethod based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_DeviceAccessMethod_Type.__name__ = "Integer32"
_DeviceAccessMethod_Object = MibTableColumn
deviceAccessMethod = _DeviceAccessMethod_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 7),
    _DeviceAccessMethod_Type()
)
deviceAccessMethod.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessMethod.setStatus("current")


class _DeviceAccessAuthenticationMethod_Type(Integer32):
    """Custom type deviceAccessAuthenticationMethod based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_DeviceAccessAuthenticationMethod_Type.__name__ = "Integer32"
_DeviceAccessAuthenticationMethod_Object = MibTableColumn
deviceAccessAuthenticationMethod = _DeviceAccessAuthenticationMethod_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 8),
    _DeviceAccessAuthenticationMethod_Type()
)
deviceAccessAuthenticationMethod.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessAuthenticationMethod.setStatus("current")
_DeviceAccessSessionId_Type = Unsigned32
_DeviceAccessSessionId_Object = MibTableColumn
deviceAccessSessionId = _DeviceAccessSessionId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 9),
    _DeviceAccessSessionId_Type()
)
deviceAccessSessionId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessSessionId.setStatus("current")
_DeviceAccessLogoutTime_Type = DateAndTime
_DeviceAccessLogoutTime_Object = MibTableColumn
deviceAccessLogoutTime = _DeviceAccessLogoutTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 10),
    _DeviceAccessLogoutTime_Type()
)
deviceAccessLogoutTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessLogoutTime.setStatus("current")


class _DeviceAccessLogoutStatus_Type(Integer32):
    """Custom type deviceAccessLogoutStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_DeviceAccessLogoutStatus_Type.__name__ = "Integer32"
_DeviceAccessLogoutStatus_Object = MibTableColumn
deviceAccessLogoutStatus = _DeviceAccessLogoutStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 11),
    _DeviceAccessLogoutStatus_Type()
)
deviceAccessLogoutStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessLogoutStatus.setStatus("current")


class _DeviceAccessRemoteTerminal_Type(Integer32):
    """Custom type deviceAccessRemoteTerminal based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_DeviceAccessRemoteTerminal_Type.__name__ = "Integer32"
_DeviceAccessRemoteTerminal_Object = MibTableColumn
deviceAccessRemoteTerminal = _DeviceAccessRemoteTerminal_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 13),
    _DeviceAccessRemoteTerminal_Type()
)
deviceAccessRemoteTerminal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessRemoteTerminal.setStatus("current")
_DeviceAccessRemoteIpAddressType_Type = InetAddressType
_DeviceAccessRemoteIpAddressType_Object = MibTableColumn
deviceAccessRemoteIpAddressType = _DeviceAccessRemoteIpAddressType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 14),
    _DeviceAccessRemoteIpAddressType_Type()
)
deviceAccessRemoteIpAddressType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessRemoteIpAddressType.setStatus("current")
_DeviceAccessRemoteIpAddress_Type = InetAddress
_DeviceAccessRemoteIpAddress_Object = MibTableColumn
deviceAccessRemoteIpAddress = _DeviceAccessRemoteIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 15),
    _DeviceAccessRemoteIpAddress_Type()
)
deviceAccessRemoteIpAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessRemoteIpAddress.setStatus("current")
_DeviceAccessRemoteLoginTime_Type = DateAndTime
_DeviceAccessRemoteLoginTime_Object = MibTableColumn
deviceAccessRemoteLoginTime = _DeviceAccessRemoteLoginTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 6, 1, 16),
    _DeviceAccessRemoteLoginTime_Type()
)
deviceAccessRemoteLoginTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceAccessRemoteLoginTime.setStatus("current")


class _AgnTftpAccess_Type(Integer32):
    """Custom type agnTftpAccess based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_AgnTftpAccess_Type.__name__ = "Integer32"
_AgnTftpAccess_Object = MibScalar
agnTftpAccess = _AgnTftpAccess_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 7),
    _AgnTftpAccess_Type()
)
agnTftpAccess.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnTftpAccess.setStatus("current")


class _AgnSftpAccess_Type(Integer32):
    """Custom type agnSftpAccess based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_AgnSftpAccess_Type.__name__ = "Integer32"
_AgnSftpAccess_Object = MibScalar
agnSftpAccess = _AgnSftpAccess_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 8),
    _AgnSftpAccess_Type()
)
agnSftpAccess.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnSftpAccess.setStatus("current")


class _AgnControlPortAccess_Type(Integer32):
    """Custom type agnControlPortAccess based on Integer32"""
    defaultValue = 3
...
_AgnControlPortAccess_Type.__name__ = "Integer32"
_AgnControlPortAccess_Object = MibScalar
agnControlPortAccess = _AgnControlPortAccess_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 9),
    _AgnControlPortAccess_Type()
)
agnControlPortAccess.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnControlPortAccess.setStatus("current")
_BannerTable_Object = MibTable
bannerTable = _BannerTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 11)
)
if mibBuilder.loadTexts:
    bannerTable.setStatus("current")
_BannerEntry_Object = MibTableRow
bannerEntry = _BannerEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 11, 1)
)
bannerEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "bannerType"),
    (0, "RAD-GEN-MIB", "bannerLineNumber"),
)
if mibBuilder.loadTexts:
    bannerEntry.setStatus("current")


class _BannerType_Type(Integer32):
    """Custom type bannerType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_BannerType_Type.__name__ = "Integer32"
_BannerType_Object = MibTableColumn
bannerType = _BannerType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 11, 1, 1),
    _BannerType_Type()
)
bannerType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    bannerType.setStatus("current")
_BannerLineNumber_Type = Unsigned32
_BannerLineNumber_Object = MibTableColumn
bannerLineNumber = _BannerLineNumber_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 11, 1, 2),
    _BannerLineNumber_Type()
)
bannerLineNumber.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    bannerLineNumber.setStatus("current")
_BannerRowStatus_Type = RowStatus
_BannerRowStatus_Object = MibTableColumn
bannerRowStatus = _BannerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 11, 1, 3),
    _BannerRowStatus_Type()
)
bannerRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    bannerRowStatus.setStatus("current")


class _BannerText_Type(SnmpAdminString):
    """Custom type bannerText based on SnmpAdminString"""
...
_BannerText_Type.__name__ = "SnmpAdminString"
_BannerText_Object = MibTableColumn
bannerText = _BannerText_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 34, 11, 1, 4),
    _BannerText_Type()
)
bannerText.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    bannerText.setStatus("current")
...
ifCreateEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "ifCreateEntityType"),
    (0, "RAD-GEN-MIB", "ifCreateEntityIdx"),
    (0, "RAD-GEN-MIB", "ifCreateNumber"),
)
if mibBuilder.loadTexts:
...
ifPerfEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "RAD-GEN-MIB", "ifPerfCounterType"),
)
if mibBuilder.loadTexts:
...
systemOamEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "systemOamCnfgIdx"),
)
if mibBuilder.loadTexts:
...
systemOamDescrEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "systemOamDescrIdx"),
)
if mibBuilder.loadTexts:
...
_SystemBfd_ObjectIdentity = ObjectIdentity
systemBfd = _SystemBfd_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 36, 3)
)
_BfdSessXTable_Object = MibTable
bfdSessXTable = _BfdSessXTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 36, 3, 2)
)
if mibBuilder.loadTexts:
    bfdSessXTable.setStatus("current")
_BfdSessXEntry_Object = MibTableRow
bfdSessXEntry = _BfdSessXEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 36, 3, 2, 1)
)
bfdSessXEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "bfdSessXIndex"),
)
if mibBuilder.loadTexts:
    bfdSessXEntry.setStatus("current")
_BfdSessXIndex_Type = Unsigned32
_BfdSessXIndex_Object = MibTableColumn
bfdSessXIndex = _BfdSessXIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 36, 3, 2, 1, 1),
    _BfdSessXIndex_Type()
)
bfdSessXIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    bfdSessXIndex.setStatus("current")


class _BfdSessXStaticAssociated_Type(Integer32):
    """Custom type bfdSessXStaticAssociated based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_BfdSessXStaticAssociated_Type.__name__ = "Integer32"
_BfdSessXStaticAssociated_Object = MibTableColumn
bfdSessXStaticAssociated = _BfdSessXStaticAssociated_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 36, 3, 2, 1, 5),
    _BfdSessXStaticAssociated_Type()
)
bfdSessXStaticAssociated.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    bfdSessXStaticAssociated.setStatus("current")
_BfdSessXRemoteDiag_Type = BfdDiagTC
_BfdSessXRemoteDiag_Object = MibTableColumn
bfdSessXRemoteDiag = _BfdSessXRemoteDiag_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 36, 3, 2, 1, 6),
    _BfdSessXRemoteDiag_Type()
)
bfdSessXRemoteDiag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bfdSessXRemoteDiag.setStatus("current")


class _BfdSessXClearStatisticsCmd_Type(Integer32):
    """Custom type bfdSessXClearStatisticsCmd based on Integer32"""
    defaultValue = 2
...
_BfdSessXClearStatisticsCmd_Type.__name__ = "Integer32"
_BfdSessXClearStatisticsCmd_Object = MibTableColumn
bfdSessXClearStatisticsCmd = _BfdSessXClearStatisticsCmd_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 36, 3, 2, 1, 7),
    _BfdSessXClearStatisticsCmd_Type()
)
bfdSessXClearStatisticsCmd.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    bfdSessXClearStatisticsCmd.setStatus("current")
_BfdSessXDescription_Type = SnmpAdminString
_BfdSessXDescription_Object = MibTableColumn
bfdSessXDescription = _BfdSessXDescription_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 36, 3, 2, 1, 9),
    _BfdSessXDescription_Type()
)
bfdSessXDescription.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    bfdSessXDescription.setStatus("current")
...
bitMappingEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "bitMappingLocation"),
)
if mibBuilder.loadTexts:
...
_AgnFunctionAttributes_Type = OctetString
_AgnFunctionAttributes_Object = MibTableColumn
agnFunctionAttributes = _AgnFunctionAttributes_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 45, 1, 3),
    _AgnFunctionAttributes_Type()
)
agnFunctionAttributes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnFunctionAttributes.setStatus("current")
_AgnFunctionVersion_Type = Unsigned32
_AgnFunctionVersion_Object = MibTableColumn
agnFunctionVersion = _AgnFunctionVersion_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 45, 1, 4),
    _AgnFunctionVersion_Type()
)
agnFunctionVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnFunctionVersion.setStatus("current")
...
alarmForwardingEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmForwardingFailPort"),
    (0, "RAD-GEN-MIB", "alarmForwardingToPort"),
)
if mibBuilder.loadTexts:
...
class _AlarmForwardingCause_Type(AlarmForwardingCause):
    """Custom type alarmForwardingCause based on AlarmForwardingCause"""
    defaultBinValue = "0"


_AlarmForwardingCause_Type.__name__ = "AlarmForwardingCause"
...
class _AlarmForwardingAction_Type(Bits):
    ...
    namedValues = NamedValues(
        *(("noAction", 0),
          ...
          ("oamSignaling", 2),
          ("interfaceStatusTLV", 3),
          ("oamCfmAis", 4),
          ("dhcpRestart", 5),
          ("vrrpPriorityDecrement", 6),
          ("shaperSwap", 7),
          ("policerSwap", 8),
          ("oamCfmCsfClos", 9),
          ("reset", 10),
...
_AlarmForwardingActiveCause_Type = AlarmForwardingCause
_AlarmForwardingActiveCause_Object = MibTableColumn
alarmForwardingActiveCause = _AlarmForwardingActiveCause_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 50, 1, 12),
    _AlarmForwardingActiveCause_Type()
)
alarmForwardingActiveCause.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmForwardingActiveCause.setStatus("current")


class _AlarmForwardingDescr_Type(SnmpAdminString):
    """Custom type alarmForwardingDescr based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 64),
    )
...
_AlarmForwardingDescr_Type.__name__ = "SnmpAdminString"
_AlarmForwardingDescr_Object = MibTableColumn
alarmForwardingDescr = _AlarmForwardingDescr_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 50, 1, 13),
    _AlarmForwardingDescr_Type()
)
alarmForwardingDescr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    alarmForwardingDescr.setStatus("current")


class _AlarmForwardingPriorityDecrement_Type(Unsigned32):
    """Custom type alarmForwardingPriorityDecrement based on Unsigned32"""
    defaultValue = 253
...
_AlarmForwardingPriorityDecrement_Type.__name__ = "Unsigned32"
_AlarmForwardingPriorityDecrement_Object = MibTableColumn
alarmForwardingPriorityDecrement = _AlarmForwardingPriorityDecrement_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 50, 1, 14),
    _AlarmForwardingPriorityDecrement_Type()
)
alarmForwardingPriorityDecrement.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    alarmForwardingPriorityDecrement.setStatus("current")
...
agnGroupEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "agnGroupCnfgIdx"),
    (0, "RAD-GEN-MIB", "agnGroupIdx"),
    (0, "RAD-GEN-MIB", "agnGroupComponentIdx"),
)
if mibBuilder.loadTexts:
...
_AgnGroupName_Type = SnmpAdminString
_AgnGroupName_Object = MibTableColumn
agnGroupName = _AgnGroupName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 56, 1, 5),
    _AgnGroupName_Type()
)
agnGroupName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agnGroupName.setStatus("current")
_AgnGroupParam_Type = Unsigned32
_AgnGroupParam_Object = MibTableColumn
agnGroupParam = _AgnGroupParam_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 56, 1, 6),
    _AgnGroupParam_Type()
)
agnGroupParam.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agnGroupParam.setStatus("current")
_AgnGroupStatus_Type = Unsigned32
_AgnGroupStatus_Object = MibTableColumn
agnGroupStatus = _AgnGroupStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 56, 1, 7),
    _AgnGroupStatus_Type()
)
agnGroupStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnGroupStatus.setStatus("current")
_AgnGroupStatus2_Type = Unsigned32
_AgnGroupStatus2_Object = MibTableColumn
agnGroupStatus2 = _AgnGroupStatus2_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 56, 1, 8),
    _AgnGroupStatus2_Type()
)
agnGroupStatus2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnGroupStatus2.setStatus("current")
_AgnGroupComponentString_Type = SnmpAdminString
_AgnGroupComponentString_Object = MibTableColumn
agnGroupComponentString = _AgnGroupComponentString_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 56, 1, 9),
    _AgnGroupComponentString_Type()
)
agnGroupComponentString.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agnGroupComponentString.setStatus("current")
_AgnGroupComponentTDomain_Type = TDomain
_AgnGroupComponentTDomain_Object = MibTableColumn
agnGroupComponentTDomain = _AgnGroupComponentTDomain_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 56, 1, 10),
    _AgnGroupComponentTDomain_Type()
)
agnGroupComponentTDomain.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agnGroupComponentTDomain.setStatus("current")
_AgnGroupComponentTAddress_Type = TAddress
_AgnGroupComponentTAddress_Object = MibTableColumn
agnGroupComponentTAddress = _AgnGroupComponentTAddress_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 56, 1, 11),
    _AgnGroupComponentTAddress_Type()
)
agnGroupComponentTAddress.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    agnGroupComponentTAddress.setStatus("current")
...
class _AgnSyslogCmd_Type(Integer32):
    """Custom type agnSyslogCmd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_AgnSyslogCmd_Type.__name__ = "Integer32"
_AgnSyslogCmd_Object = MibScalar
agnSyslogCmd = _AgnSyslogCmd_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 58, 4),
    _AgnSyslogCmd_Type()
)
agnSyslogCmd.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnSyslogCmd.setStatus("current")
...
trapManagement = _TrapManagement_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61)
)
_TrapMngVars_ObjectIdentity = ObjectIdentity
trapMngVars = _TrapMngVars_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 1)
)


class _TrapState_Type(Integer32):
    """Custom type trapState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_TrapState_Type.__name__ = "Integer32"
_TrapState_Object = MibScalar
trapState = _TrapState_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 1, 1),
    _TrapState_Type()
)
trapState.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    trapState.setStatus("current")
_TrapSeqId_Type = Unsigned32
_TrapSeqId_Object = MibScalar
trapSeqId = _TrapSeqId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 1, 2),
    _TrapSeqId_Type()
)
trapSeqId.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    trapSeqId.setStatus("current")
_AlarmSync_ObjectIdentity = ObjectIdentity
alarmSync = _AlarmSync_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2)
)
_AlarmSyncEvents_ObjectIdentity = ObjectIdentity
alarmSyncEvents = _AlarmSyncEvents_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2, 0)
)
_AlarmSyncTable_Object = MibTable
alarmSyncTable = _AlarmSyncTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2, 1)
)
if mibBuilder.loadTexts:
    alarmSyncTable.setStatus("current")
_AlarmSyncEntry_Object = MibTableRow
alarmSyncEntry = _AlarmSyncEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2, 1, 1)
)
alarmSyncEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmSyncGroupId"),
)
if mibBuilder.loadTexts:
    alarmSyncEntry.setStatus("current")
_AlarmSyncGroupId_Type = Unsigned32
_AlarmSyncGroupId_Object = MibTableColumn
alarmSyncGroupId = _AlarmSyncGroupId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2, 1, 1, 1),
    _AlarmSyncGroupId_Type()
)
alarmSyncGroupId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmSyncGroupId.setStatus("current")
_AlarmSyncLastSentSeqId_Type = Counter32
_AlarmSyncLastSentSeqId_Object = MibTableColumn
alarmSyncLastSentSeqId = _AlarmSyncLastSentSeqId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2, 1, 1, 2),
    _AlarmSyncLastSentSeqId_Type()
)
alarmSyncLastSentSeqId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmSyncLastSentSeqId.setStatus("current")


class _AlarmSyncCmd_Type(Integer32):
    """Custom type alarmSyncCmd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AlarmSyncCmd_Type.__name__ = "Integer32"
_AlarmSyncCmd_Object = MibTableColumn
alarmSyncCmd = _AlarmSyncCmd_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2, 1, 1, 3),
    _AlarmSyncCmd_Type()
)
alarmSyncCmd.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmSyncCmd.setStatus("current")
_AlarmSyncStartSeqId_Type = Unsigned32
_AlarmSyncStartSeqId_Object = MibTableColumn
alarmSyncStartSeqId = _AlarmSyncStartSeqId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2, 1, 1, 4),
    _AlarmSyncStartSeqId_Type()
)
alarmSyncStartSeqId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmSyncStartSeqId.setStatus("current")
_AlarmSyncEndSeqId_Type = Unsigned32
_AlarmSyncEndSeqId_Object = MibTableColumn
alarmSyncEndSeqId = _AlarmSyncEndSeqId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2, 1, 1, 5),
    _AlarmSyncEndSeqId_Type()
)
alarmSyncEndSeqId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmSyncEndSeqId.setStatus("current")
...
agnStringToIndexEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "agnStringToIndexTableId"),
    (1, "RAD-GEN-MIB", "agnStringToIndexUserName"),
)
if mibBuilder.loadTexts:
...
agnRowPointerEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "agnRowPointerIndex"),
)
if mibBuilder.loadTexts:
...
_AgnConfigVersion_Type = SnmpAdminString
_AgnConfigVersion_Object = MibScalar
agnConfigVersion = _AgnConfigVersion_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 64),
    _AgnConfigVersion_Type()
)
agnConfigVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnConfigVersion.setStatus("current")
_AgnResources_ObjectIdentity = ObjectIdentity
agnResources = _AgnResources_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65)
)
_AgnMemoryBufferTable_Object = MibTable
agnMemoryBufferTable = _AgnMemoryBufferTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 1)
)
if mibBuilder.loadTexts:
    agnMemoryBufferTable.setStatus("current")
_AgnMemoryBufferEntry_Object = MibTableRow
agnMemoryBufferEntry = _AgnMemoryBufferEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 1, 1)
)
agnMemoryBufferEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "agnMemoryBufferPoolIndex"),
)
if mibBuilder.loadTexts:
    agnMemoryBufferEntry.setStatus("current")
_AgnMemoryBufferPoolIndex_Type = Unsigned32
_AgnMemoryBufferPoolIndex_Object = MibTableColumn
agnMemoryBufferPoolIndex = _AgnMemoryBufferPoolIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 1, 1, 1),
    _AgnMemoryBufferPoolIndex_Type()
)
agnMemoryBufferPoolIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agnMemoryBufferPoolIndex.setStatus("current")
_AgnMemoryBufferName_Type = SnmpAdminString
_AgnMemoryBufferName_Object = MibTableColumn
agnMemoryBufferName = _AgnMemoryBufferName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 1, 1, 2),
    _AgnMemoryBufferName_Type()
)
agnMemoryBufferName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnMemoryBufferName.setStatus("current")
_AgnMemoryBufferTotalNum_Type = Unsigned32
_AgnMemoryBufferTotalNum_Object = MibTableColumn
agnMemoryBufferTotalNum = _AgnMemoryBufferTotalNum_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 1, 1, 3),
    _AgnMemoryBufferTotalNum_Type()
)
agnMemoryBufferTotalNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnMemoryBufferTotalNum.setStatus("current")
_AgnMemoryBufferFree_Type = Unsigned32
_AgnMemoryBufferFree_Object = MibTableColumn
agnMemoryBufferFree = _AgnMemoryBufferFree_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 1, 1, 4),
    _AgnMemoryBufferFree_Type()
)
agnMemoryBufferFree.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnMemoryBufferFree.setStatus("current")
_AgnMemoryBufferSize_Type = Unsigned32
_AgnMemoryBufferSize_Object = MibTableColumn
agnMemoryBufferSize = _AgnMemoryBufferSize_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 1, 1, 5),
    _AgnMemoryBufferSize_Type()
)
agnMemoryBufferSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnMemoryBufferSize.setStatus("current")
_AgnMemoryBufferAllocErrors_Type = Unsigned32
_AgnMemoryBufferAllocErrors_Object = MibTableColumn
agnMemoryBufferAllocErrors = _AgnMemoryBufferAllocErrors_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 1, 1, 6),
    _AgnMemoryBufferAllocErrors_Type()
)
agnMemoryBufferAllocErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnMemoryBufferAllocErrors.setStatus("current")
_AgnMemoryBufferFreeErrors_Type = Unsigned32
_AgnMemoryBufferFreeErrors_Object = MibTableColumn
agnMemoryBufferFreeErrors = _AgnMemoryBufferFreeErrors_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 1, 1, 7),
    _AgnMemoryBufferFreeErrors_Type()
)
agnMemoryBufferFreeErrors.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnMemoryBufferFreeErrors.setStatus("current")
_AgnCpuUtilizationTable_Object = MibTable
agnCpuUtilizationTable = _AgnCpuUtilizationTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 2)
)
if mibBuilder.loadTexts:
    agnCpuUtilizationTable.setStatus("current")
_AgnCpuUtilizationEntry_Object = MibTableRow
agnCpuUtilizationEntry = _AgnCpuUtilizationEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 2, 1)
)
agnCpuUtilizationEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "agnCpuUtilizationCpuIdx"),
    (0, "RAD-GEN-MIB", "agnCpuUtilizationTaskIdx"),
)
if mibBuilder.loadTexts:
    agnCpuUtilizationEntry.setStatus("current")


class _AgnCpuUtilizationCpuIdx_Type(Integer32):
    """Custom type agnCpuUtilizationCpuIdx based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AgnCpuUtilizationCpuIdx_Type.__name__ = "Integer32"
_AgnCpuUtilizationCpuIdx_Object = MibTableColumn
agnCpuUtilizationCpuIdx = _AgnCpuUtilizationCpuIdx_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 2, 1, 1),
    _AgnCpuUtilizationCpuIdx_Type()
)
agnCpuUtilizationCpuIdx.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agnCpuUtilizationCpuIdx.setStatus("current")
_AgnCpuUtilizationTaskIdx_Type = Unsigned32
_AgnCpuUtilizationTaskIdx_Object = MibTableColumn
agnCpuUtilizationTaskIdx = _AgnCpuUtilizationTaskIdx_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 2, 1, 2),
    _AgnCpuUtilizationTaskIdx_Type()
)
agnCpuUtilizationTaskIdx.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agnCpuUtilizationTaskIdx.setStatus("current")
_AgnCpuUtilizationCurrent_Type = Unsigned32
_AgnCpuUtilizationCurrent_Object = MibTableColumn
agnCpuUtilizationCurrent = _AgnCpuUtilizationCurrent_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 2, 1, 3),
    _AgnCpuUtilizationCurrent_Type()
)
agnCpuUtilizationCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnCpuUtilizationCurrent.setStatus("current")
_AgnCpuUtilizationMin_Type = Unsigned32
_AgnCpuUtilizationMin_Object = MibTableColumn
agnCpuUtilizationMin = _AgnCpuUtilizationMin_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 2, 1, 4),
    _AgnCpuUtilizationMin_Type()
)
agnCpuUtilizationMin.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnCpuUtilizationMin.setStatus("current")
_AgnCpuUtilizationMax_Type = Unsigned32
_AgnCpuUtilizationMax_Object = MibTableColumn
agnCpuUtilizationMax = _AgnCpuUtilizationMax_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 2, 1, 5),
    _AgnCpuUtilizationMax_Type()
)
agnCpuUtilizationMax.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnCpuUtilizationMax.setStatus("current")


class _AgnCpuUtilizationClear_Type(Integer32):
    """Custom type agnCpuUtilizationClear based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_AgnCpuUtilizationClear_Type.__name__ = "Integer32"
_AgnCpuUtilizationClear_Object = MibTableColumn
agnCpuUtilizationClear = _AgnCpuUtilizationClear_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 2, 1, 6),
    _AgnCpuUtilizationClear_Type()
)
agnCpuUtilizationClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnCpuUtilizationClear.setStatus("current")
_AgnCpuUtilizationAverage_Type = Unsigned32
_AgnCpuUtilizationAverage_Object = MibTableColumn
agnCpuUtilizationAverage = _AgnCpuUtilizationAverage_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 2, 1, 7),
    _AgnCpuUtilizationAverage_Type()
)
agnCpuUtilizationAverage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnCpuUtilizationAverage.setStatus("current")
_AgnDiskResourcesTable_Object = MibTable
agnDiskResourcesTable = _AgnDiskResourcesTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 3)
)
if mibBuilder.loadTexts:
    agnDiskResourcesTable.setStatus("current")
_AgnDiskResourcesEntry_Object = MibTableRow
agnDiskResourcesEntry = _AgnDiskResourcesEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 3, 1)
)
agnDiskResourcesEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "agnDiskIdx"),
)
if mibBuilder.loadTexts:
    agnDiskResourcesEntry.setStatus("current")
_AgnDiskIdx_Type = Unsigned32
_AgnDiskIdx_Object = MibTableColumn
agnDiskIdx = _AgnDiskIdx_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 3, 1, 1),
    _AgnDiskIdx_Type()
)
agnDiskIdx.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agnDiskIdx.setStatus("current")
_AgnDiskTotalSpace_Type = Unsigned32
_AgnDiskTotalSpace_Object = MibTableColumn
agnDiskTotalSpace = _AgnDiskTotalSpace_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 3, 1, 2),
    _AgnDiskTotalSpace_Type()
)
agnDiskTotalSpace.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnDiskTotalSpace.setStatus("current")
_AgnDiskAvailableSpace_Type = Unsigned32
_AgnDiskAvailableSpace_Object = MibTableColumn
agnDiskAvailableSpace = _AgnDiskAvailableSpace_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 3, 1, 3),
    _AgnDiskAvailableSpace_Type()
)
agnDiskAvailableSpace.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnDiskAvailableSpace.setStatus("current")
_SystemResourcesTable_Object = MibTable
systemResourcesTable = _SystemResourcesTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 4)
)
if mibBuilder.loadTexts:
    systemResourcesTable.setStatus("current")
_SystemResourcesEntry_Object = MibTableRow
systemResourcesEntry = _SystemResourcesEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 4, 1)
)
systemResourcesEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "systemResourceId"),
)
if mibBuilder.loadTexts:
    systemResourcesEntry.setStatus("current")
_SystemResourceId_Type = Unsigned32
_SystemResourceId_Object = MibTableColumn
systemResourceId = _SystemResourceId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 4, 1, 1),
    _SystemResourceId_Type()
)
systemResourceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    systemResourceId.setStatus("current")


class _SystemResourceLastError_Type(Integer32):
    """Custom type systemResourceLastError based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SystemResourceLastError_Type.__name__ = "Integer32"
_SystemResourceLastError_Object = MibTableColumn
systemResourceLastError = _SystemResourceLastError_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 4, 1, 2),
    _SystemResourceLastError_Type()
)
systemResourceLastError.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemResourceLastError.setStatus("current")
_MemoryUsageTable_Object = MibTable
memoryUsageTable = _MemoryUsageTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5)
)
if mibBuilder.loadTexts:
    memoryUsageTable.setStatus("current")
_MemoryUsageEntry_Object = MibTableRow
memoryUsageEntry = _MemoryUsageEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1)
)
memoryUsageEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "memoryUsageEntityId"),
    (0, "RAD-GEN-MIB", "memoryUsagePoolId"),
)
if mibBuilder.loadTexts:
    memoryUsageEntry.setStatus("current")
_MemoryUsageEntityId_Type = Unsigned32
_MemoryUsageEntityId_Object = MibTableColumn
memoryUsageEntityId = _MemoryUsageEntityId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 1),
    _MemoryUsageEntityId_Type()
)
memoryUsageEntityId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    memoryUsageEntityId.setStatus("current")
_MemoryUsagePoolId_Type = Unsigned32
_MemoryUsagePoolId_Object = MibTableColumn
memoryUsagePoolId = _MemoryUsagePoolId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 2),
    _MemoryUsagePoolId_Type()
)
memoryUsagePoolId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    memoryUsagePoolId.setStatus("current")
_MemoryUsagePoolName_Type = SnmpAdminString
_MemoryUsagePoolName_Object = MibTableColumn
memoryUsagePoolName = _MemoryUsagePoolName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 3),
    _MemoryUsagePoolName_Type()
)
memoryUsagePoolName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUsagePoolName.setStatus("current")
_MemoryUsageTotal_Type = Gauge32
_MemoryUsageTotal_Object = MibTableColumn
memoryUsageTotal = _MemoryUsageTotal_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 4),
    _MemoryUsageTotal_Type()
)
memoryUsageTotal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUsageTotal.setStatus("current")
if mibBuilder.loadTexts:
    memoryUsageTotal.setUnits("kilobytes")
_MemoryUsageFree_Type = Gauge32
_MemoryUsageFree_Object = MibTableColumn
memoryUsageFree = _MemoryUsageFree_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 5),
    _MemoryUsageFree_Type()
)
memoryUsageFree.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUsageFree.setStatus("current")
if mibBuilder.loadTexts:
    memoryUsageFree.setUnits("kilobytes")
_MemoryUsageApplicAllocCounter_Type = Counter32
_MemoryUsageApplicAllocCounter_Object = MibTableColumn
memoryUsageApplicAllocCounter = _MemoryUsageApplicAllocCounter_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 6),
    _MemoryUsageApplicAllocCounter_Type()
)
memoryUsageApplicAllocCounter.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUsageApplicAllocCounter.setStatus("current")
_MemoryUsageApplicFreeCounter_Type = Counter32
_MemoryUsageApplicFreeCounter_Object = MibTableColumn
memoryUsageApplicFreeCounter = _MemoryUsageApplicFreeCounter_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 7),
    _MemoryUsageApplicFreeCounter_Type()
)
memoryUsageApplicFreeCounter.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUsageApplicFreeCounter.setStatus("current")
_MemoryUsageApplicMaxUsed_Type = Gauge32
_MemoryUsageApplicMaxUsed_Object = MibTableColumn
memoryUsageApplicMaxUsed = _MemoryUsageApplicMaxUsed_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 8),
    _MemoryUsageApplicMaxUsed_Type()
)
memoryUsageApplicMaxUsed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUsageApplicMaxUsed.setStatus("current")
if mibBuilder.loadTexts:
    memoryUsageApplicMaxUsed.setUnits("kilobytes")
_MemoryUsageApplicAllocSize_Type = Counter64
_MemoryUsageApplicAllocSize_Object = MibTableColumn
memoryUsageApplicAllocSize = _MemoryUsageApplicAllocSize_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 9),
    _MemoryUsageApplicAllocSize_Type()
)
memoryUsageApplicAllocSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUsageApplicAllocSize.setStatus("current")
if mibBuilder.loadTexts:
    memoryUsageApplicAllocSize.setUnits("bytes")
_MemoryUsageApplicFreedSize_Type = Counter64
_MemoryUsageApplicFreedSize_Object = MibTableColumn
memoryUsageApplicFreedSize = _MemoryUsageApplicFreedSize_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 65, 5, 1, 10),
    _MemoryUsageApplicFreedSize_Type()
)
memoryUsageApplicFreedSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUsageApplicFreedSize.setStatus("current")
if mibBuilder.loadTexts:
    memoryUsageApplicFreedSize.setUnits("bytes")
_EntityConvertIndexTable_Object = MibTable
entityConvertIndexTable = _EntityConvertIndexTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66)
)
if mibBuilder.loadTexts:
    entityConvertIndexTable.setStatus("current")
_EntityConvertIndexEntry_Object = MibTableRow
entityConvertIndexEntry = _EntityConvertIndexEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66, 1)
)
entityConvertIndexEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "entityConvertEntityType"),
    (0, "RAD-GEN-MIB", "entityConvertIndex"),
)
if mibBuilder.loadTexts:
    entityConvertIndexEntry.setStatus("current")
_EntityConvertEntityType_Type = RadEntityType
_EntityConvertEntityType_Object = MibTableColumn
entityConvertEntityType = _EntityConvertEntityType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66, 1, 1),
    _EntityConvertEntityType_Type()
)
entityConvertEntityType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    entityConvertEntityType.setStatus("current")
_EntityConvertIndex_Type = Unsigned32
_EntityConvertIndex_Object = MibTableColumn
entityConvertIndex = _EntityConvertIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66, 1, 2),
    _EntityConvertIndex_Type()
)
entityConvertIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    entityConvertIndex.setStatus("current")
_EntityConvertRowStatus_Type = RowStatus
_EntityConvertRowStatus_Object = MibTableColumn
entityConvertRowStatus = _EntityConvertRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66, 1, 3),
    _EntityConvertRowStatus_Type()
)
entityConvertRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    entityConvertRowStatus.setStatus("current")
_EntityConvertParam1_Type = Unsigned32
_EntityConvertParam1_Object = MibTableColumn
entityConvertParam1 = _EntityConvertParam1_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66, 1, 4),
    _EntityConvertParam1_Type()
)
entityConvertParam1.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    entityConvertParam1.setStatus("current")
_EntityConvertParam2_Type = Unsigned32
_EntityConvertParam2_Object = MibTableColumn
entityConvertParam2 = _EntityConvertParam2_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66, 1, 5),
    _EntityConvertParam2_Type()
)
entityConvertParam2.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    entityConvertParam2.setStatus("current")
_EntityConvertParam3_Type = Unsigned32
_EntityConvertParam3_Object = MibTableColumn
entityConvertParam3 = _EntityConvertParam3_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66, 1, 6),
    _EntityConvertParam3_Type()
)
entityConvertParam3.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    entityConvertParam3.setStatus("current")
_EntityConvertParam4_Type = Unsigned32
_EntityConvertParam4_Object = MibTableColumn
entityConvertParam4 = _EntityConvertParam4_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66, 1, 7),
    _EntityConvertParam4_Type()
)
entityConvertParam4.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    entityConvertParam4.setStatus("current")
_EntityConvertParam5_Type = Unsigned32
_EntityConvertParam5_Object = MibTableColumn
entityConvertParam5 = _EntityConvertParam5_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 66, 1, 8),
    _EntityConvertParam5_Type()
)
entityConvertParam5.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    entityConvertParam5.setStatus("current")
_AgnFiles_ObjectIdentity = ObjectIdentity
agnFiles = _AgnFiles_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67)
)
_FileSystemTable_Object = MibTable
fileSystemTable = _FileSystemTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1)
)
if mibBuilder.loadTexts:
    fileSystemTable.setStatus("current")
_FileSystemEntry_Object = MibTableRow
fileSystemEntry = _FileSystemEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1)
)
...
if mibBuilder.loadTexts:
    fileSystemEntry.setStatus("current")
_FileSystemPath_Type = SnmpAdminString
_FileSystemPath_Object = MibTableColumn
fileSystemPath = _FileSystemPath_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 1),
    _FileSystemPath_Type()
)
fileSystemPath.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    fileSystemPath.setStatus("current")
_FileSystemObjType_Type = FileType
_FileSystemObjType_Object = MibTableColumn
fileSystemObjType = _FileSystemObjType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 2),
    _FileSystemObjType_Type()
)
fileSystemObjType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    fileSystemObjType.setStatus("current")


class _FileSystemObjName_Type(SnmpAdminString):
    """Custom type fileSystemObjName based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_FileSystemObjName_Type.__name__ = "SnmpAdminString"
_FileSystemObjName_Object = MibTableColumn
fileSystemObjName = _FileSystemObjName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 3),
    _FileSystemObjName_Type()
)
fileSystemObjName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    fileSystemObjName.setStatus("current")
_FileSystemRowStatus_Type = RowStatus
_FileSystemRowStatus_Object = MibTableColumn
fileSystemRowStatus = _FileSystemRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 4),
    _FileSystemRowStatus_Type()
)
fileSystemRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    fileSystemRowStatus.setStatus("current")
_FileSystemSignatureBoot_Type = Integer32
_FileSystemSignatureBoot_Object = MibTableColumn
fileSystemSignatureBoot = _FileSystemSignatureBoot_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 5),
    _FileSystemSignatureBoot_Type()
)
fileSystemSignatureBoot.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fileSystemSignatureBoot.setStatus("current")
_FileSystemSignatureTime_Type = Integer32
_FileSystemSignatureTime_Object = MibTableColumn
fileSystemSignatureTime = _FileSystemSignatureTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 6),
    _FileSystemSignatureTime_Type()
)
fileSystemSignatureTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fileSystemSignatureTime.setStatus("current")
_FileSystemLastUpdateTime_Type = DateAndTime
_FileSystemLastUpdateTime_Object = MibTableColumn
fileSystemLastUpdateTime = _FileSystemLastUpdateTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 7),
    _FileSystemLastUpdateTime_Type()
)
fileSystemLastUpdateTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fileSystemLastUpdateTime.setStatus("current")
_FileSystemLastUpdateBootSignature_Type = Integer32
_FileSystemLastUpdateBootSignature_Object = MibTableColumn
fileSystemLastUpdateBootSignature = _FileSystemLastUpdateBootSignature_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 8),
    _FileSystemLastUpdateBootSignature_Type()
)
fileSystemLastUpdateBootSignature.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fileSystemLastUpdateBootSignature.setStatus("current")
_FileSystemLastUpdateTimeSignature_Type = Integer32
_FileSystemLastUpdateTimeSignature_Object = MibTableColumn
fileSystemLastUpdateTimeSignature = _FileSystemLastUpdateTimeSignature_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 9),
    _FileSystemLastUpdateTimeSignature_Type()
)
fileSystemLastUpdateTimeSignature.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fileSystemLastUpdateTimeSignature.setStatus("current")
_FileSystemFileSize_Type = Unsigned32
_FileSystemFileSize_Object = MibTableColumn
fileSystemFileSize = _FileSystemFileSize_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 10),
    _FileSystemFileSize_Type()
)
fileSystemFileSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fileSystemFileSize.setStatus("current")


class _FileSystemValidIndication_Type(Bits):
    """Custom type fileSystemValidIndication based on Bits"""
    namedValues = NamedValues(
        *(("runningError", 0),
          ("invalidHeader", 1),
...
_FileSystemValidIndication_Type.__name__ = "Bits"
_FileSystemValidIndication_Object = MibTableColumn
fileSystemValidIndication = _FileSystemValidIndication_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 1, 1, 11),
    _FileSystemValidIndication_Type()
)
fileSystemValidIndication.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fileSystemValidIndication.setStatus("current")


class _FileChangeStatus_Type(Bits):
    """Custom type fileChangeStatus based on Bits"""
    namedValues = NamedValues(
        *(("startupConfigError", 0),
          ("startupConfigChanged", 1),
          ("runningConfigChanged", 2))
    )

_FileChangeStatus_Type.__name__ = "Bits"
_FileChangeStatus_Object = MibScalar
fileChangeStatus = _FileChangeStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 2),
    _FileChangeStatus_Type()
)
fileChangeStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fileChangeStatus.setStatus("current")
_ConfigLoadTable_Object = MibTable
configLoadTable = _ConfigLoadTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3)
)
if mibBuilder.loadTexts:
    configLoadTable.setStatus("current")
_ConfigLoadEntry_Object = MibTableRow
configLoadEntry = _ConfigLoadEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1)
)
configLoadEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "configLoadIndex"),
)
if mibBuilder.loadTexts:
    configLoadEntry.setStatus("current")
_ConfigLoadIndex_Type = Unsigned32
_ConfigLoadIndex_Object = MibTableColumn
configLoadIndex = _ConfigLoadIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1, 1),
    _ConfigLoadIndex_Type()
)
configLoadIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    configLoadIndex.setStatus("current")


class _ConfigLoadConfirmReq_Type(Integer32):
    """Custom type configLoadConfirmReq based on Integer32"""
    defaultValue = 2
...
_ConfigLoadConfirmReq_Type.__name__ = "Integer32"
_ConfigLoadConfirmReq_Object = MibTableColumn
configLoadConfirmReq = _ConfigLoadConfirmReq_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1, 2),
    _ConfigLoadConfirmReq_Type()
)
configLoadConfirmReq.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    configLoadConfirmReq.setStatus("current")


class _ConfigLoadConfirmConf_Type(Integer32):
    """Custom type configLoadConfirmConf based on Integer32"""
    defaultValue = 2
...
_ConfigLoadConfirmConf_Type.__name__ = "Integer32"
_ConfigLoadConfirmConf_Object = MibTableColumn
configLoadConfirmConf = _ConfigLoadConfirmConf_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1, 3),
    _ConfigLoadConfirmConf_Type()
)
configLoadConfirmConf.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    configLoadConfirmConf.setStatus("current")


class _ConfigLoadConfirmTimer_Type(Unsigned32):
    """Custom type configLoadConfirmTimer based on Unsigned32"""
    defaultValue = 300


_ConfigLoadConfirmTimer_Type.__name__ = "Unsigned32"
_ConfigLoadConfirmTimer_Object = MibTableColumn
configLoadConfirmTimer = _ConfigLoadConfirmTimer_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1, 4),
    _ConfigLoadConfirmTimer_Type()
)
configLoadConfirmTimer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    configLoadConfirmTimer.setStatus("current")
_ConfigLoadRollbackFilePath_Type = SnmpAdminString
_ConfigLoadRollbackFilePath_Object = MibTableColumn
configLoadRollbackFilePath = _ConfigLoadRollbackFilePath_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1, 5),
    _ConfigLoadRollbackFilePath_Type()
)
configLoadRollbackFilePath.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    configLoadRollbackFilePath.setStatus("current")
_ConfigLoadRollbackFileName_Type = SnmpAdminString
_ConfigLoadRollbackFileName_Object = MibTableColumn
configLoadRollbackFileName = _ConfigLoadRollbackFileName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1, 6),
    _ConfigLoadRollbackFileName_Type()
)
configLoadRollbackFileName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    configLoadRollbackFileName.setStatus("current")


class _ConfigLoadErrorPolicy_Type(Integer32):
    """Custom type configLoadErrorPolicy based on Integer32"""
    defaultValue = 3
...
_ConfigLoadErrorPolicy_Type.__name__ = "Integer32"
_ConfigLoadErrorPolicy_Object = MibTableColumn
configLoadErrorPolicy = _ConfigLoadErrorPolicy_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1, 7),
    _ConfigLoadErrorPolicy_Type()
)
configLoadErrorPolicy.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    configLoadErrorPolicy.setStatus("current")
_ConfigLoadObjType_Type = FileType
_ConfigLoadObjType_Object = MibTableColumn
configLoadObjType = _ConfigLoadObjType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1, 8),
    _ConfigLoadObjType_Type()
)
configLoadObjType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    configLoadObjType.setStatus("current")
_ConfigLoadZtcStartupConfigVersion_Type = SnmpAdminString
_ConfigLoadZtcStartupConfigVersion_Object = MibTableColumn
configLoadZtcStartupConfigVersion = _ConfigLoadZtcStartupConfigVersion_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 67, 3, 1, 9),
    _ConfigLoadZtcStartupConfigVersion_Type()
)
configLoadZtcStartupConfigVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    configLoadZtcStartupConfigVersion.setStatus("current")
_AgnErrorMessageTable_Object = MibTable
agnErrorMessageTable = _AgnErrorMessageTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 68)
)
if mibBuilder.loadTexts:
    agnErrorMessageTable.setStatus("current")
_AgnErrorMessageEntry_Object = MibTableRow
agnErrorMessageEntry = _AgnErrorMessageEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 68, 1)
)
agnErrorMessageEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "agnErrorMessageSeqId"),
)
if mibBuilder.loadTexts:
    agnErrorMessageEntry.setStatus("current")
_AgnErrorMessageSeqId_Type = Unsigned32
_AgnErrorMessageSeqId_Object = MibTableColumn
agnErrorMessageSeqId = _AgnErrorMessageSeqId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 68, 1, 1),
    _AgnErrorMessageSeqId_Type()
)
agnErrorMessageSeqId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agnErrorMessageSeqId.setStatus("current")
_AgnErrorMessage_Type = SnmpAdminString
_AgnErrorMessage_Object = MibTableColumn
agnErrorMessage = _AgnErrorMessage_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 68, 1, 2),
    _AgnErrorMessage_Type()
)
agnErrorMessage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnErrorMessage.setStatus("current")
_AgnCapabilities_ObjectIdentity = ObjectIdentity
agnCapabilities = _AgnCapabilities_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 70)
)


class _AgnCommonCapabilities_Type(Bits):
    """Custom type agnCommonCapabilities based on Bits"""
    namedValues = NamedValues(
        *(("snmpV3", 0),
          ("cli", 1),
...
_AgnCommonCapabilities_Type.__name__ = "Bits"
_AgnCommonCapabilities_Object = MibScalar
agnCommonCapabilities = _AgnCommonCapabilities_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 70, 1),
    _AgnCommonCapabilities_Type()
)
agnCommonCapabilities.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnCommonCapabilities.setStatus("current")


class _AgnCommonFeatureAvailability_Type(Bits):
    """Custom type agnCommonFeatureAvailability based on Bits"""
    namedValues = NamedValues(
        *(("snmpV3", 0),
          ("cli", 1),
          ("trapSynchronization", 2),
...
_AgnCommonFeatureAvailability_Type.__name__ = "Bits"
_AgnCommonFeatureAvailability_Object = MibScalar
agnCommonFeatureAvailability = _AgnCommonFeatureAvailability_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 70, 2),
    _AgnCommonFeatureAvailability_Type()
)
agnCommonFeatureAvailability.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnCommonFeatureAvailability.setStatus("current")
_AgnThreshold_ObjectIdentity = ObjectIdentity
agnThreshold = _AgnThreshold_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 71)
)
_AgnThresholdTable_Object = MibTable
agnThresholdTable = _AgnThresholdTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 71, 1)
)
if mibBuilder.loadTexts:
    agnThresholdTable.setStatus("current")
_AgnThresholdEntry_Object = MibTableRow
agnThresholdEntry = _AgnThresholdEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 71, 1, 1)
)
agnThresholdEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "agnThresholdIdx"),
)
if mibBuilder.loadTexts:
    agnThresholdEntry.setStatus("current")


class _AgnThresholdIdx_Type(Integer32):
    """Custom type agnThresholdIdx based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgnThresholdIdx_Type.__name__ = "Integer32"
_AgnThresholdIdx_Object = MibTableColumn
agnThresholdIdx = _AgnThresholdIdx_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 71, 1, 1, 1),
    _AgnThresholdIdx_Type()
)
agnThresholdIdx.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    agnThresholdIdx.setStatus("current")


class _AgnThresholdUom_Type(Integer32):
    """Custom type agnThresholdUom based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AgnThresholdUom_Type.__name__ = "Integer32"
_AgnThresholdUom_Object = MibTableColumn
agnThresholdUom = _AgnThresholdUom_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 71, 1, 1, 2),
    _AgnThresholdUom_Type()
)
agnThresholdUom.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnThresholdUom.setStatus("current")
_AgnThresholdMin_Type = Integer32
_AgnThresholdMin_Object = MibTableColumn
agnThresholdMin = _AgnThresholdMin_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 71, 1, 1, 3),
    _AgnThresholdMin_Type()
)
agnThresholdMin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnThresholdMin.setStatus("current")
_AgnThresholdMax_Type = Integer32
_AgnThresholdMax_Object = MibTableColumn
agnThresholdMax = _AgnThresholdMax_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 71, 1, 1, 4),
    _AgnThresholdMax_Type()
)
agnThresholdMax.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnThresholdMax.setStatus("current")
_AgnThresholdHysteresis_Type = Integer32
_AgnThresholdHysteresis_Object = MibTableColumn
agnThresholdHysteresis = _AgnThresholdHysteresis_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 71, 1, 1, 5),
    _AgnThresholdHysteresis_Type()
)
agnThresholdHysteresis.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnThresholdHysteresis.setStatus("current")
_AgnThresholdCurrent_Type = Integer32
_AgnThresholdCurrent_Object = MibTableColumn
agnThresholdCurrent = _AgnThresholdCurrent_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 71, 1, 1, 6),
    _AgnThresholdCurrent_Type()
)
agnThresholdCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnThresholdCurrent.setStatus("current")
_AgnProtection_ObjectIdentity = ObjectIdentity
agnProtection = _AgnProtection_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 72)
)
_AgnLicense_ObjectIdentity = ObjectIdentity
agnLicense = _AgnLicense_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 73)
)
_AgnPerformanceManagement_ObjectIdentity = ObjectIdentity
agnPerformanceManagement = _AgnPerformanceManagement_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 74)
)
_AgnConfigChange_ObjectIdentity = ObjectIdentity
agnConfigChange = _AgnConfigChange_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 75)
)
_AgnLldp_ObjectIdentity = ObjectIdentity
agnLldp = _AgnLldp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 76)
)
_AgnLldpTable_Object = MibTable
agnLldpTable = _AgnLldpTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 76, 1)
)
if mibBuilder.loadTexts:
    agnLldpTable.setStatus("current")
_AgnLldpEntry_Object = MibTableRow
agnLldpEntry = _AgnLldpEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 76, 1, 1)
)
agnLldpEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "lldpIndex"),
)
if mibBuilder.loadTexts:
    agnLldpEntry.setStatus("current")
_LldpIndex_Type = Unsigned32
_LldpIndex_Object = MibTableColumn
lldpIndex = _LldpIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 76, 1, 1, 1),
    _LldpIndex_Type()
)
lldpIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    lldpIndex.setStatus("current")


class _LldpAdminStatus_Type(Integer32):
    """Custom type lldpAdminStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_LldpAdminStatus_Type.__name__ = "Integer32"
_LldpAdminStatus_Object = MibTableColumn
lldpAdminStatus = _LldpAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 76, 1, 1, 2),
...
class _LldpSysBridgeType_Type(Integer32):
    """Custom type lldpSysBridgeType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_LldpSysBridgeType_Type.__name__ = "Integer32"
_LldpSysBridgeType_Object = MibTableColumn
lldpSysBridgeType = _LldpSysBridgeType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 76, 1, 1, 3),
    _LldpSysBridgeType_Type()
)
lldpSysBridgeType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lldpSysBridgeType.setStatus("current")
_AgnPanelType_Type = Unsigned32
_AgnPanelType_Object = MibScalar
agnPanelType = _AgnPanelType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 78),
    _AgnPanelType_Type()
)
agnPanelType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agnPanelType.setStatus("current")
_AgnScalarObjects_ObjectIdentity = ObjectIdentity
agnScalarObjects = _AgnScalarObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 81)
)


class _AgnDscp_Type(Unsigned32):
    """Custom type agnDscp based on Unsigned32"""
    defaultValue = 0
...
_AgnDscp_Type.__name__ = "Unsigned32"
_AgnDscp_Object = MibScalar
agnDscp = _AgnDscp_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 81, 1),
    _AgnDscp_Type()
)
agnDscp.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    agnDscp.setStatus("current")
...
_AlarmEventConfig_ObjectIdentity = ObjectIdentity
alarmEventConfig = _AlarmEventConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1)
)
_AlarmEventAttrTable_Object = MibTable
alarmEventAttrTable = _AlarmEventAttrTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1)
)
if mibBuilder.loadTexts:
    alarmEventAttrTable.setStatus("current")
_AlarmEventAttrEntry_Object = MibTableRow
alarmEventAttrEntry = _AlarmEventAttrEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1, 1)
)
alarmEventAttrEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmEventAttrIndex"),
    (0, "RAD-GEN-MIB", "alarmEventAttrSourceType"),
)
if mibBuilder.loadTexts:
    alarmEventAttrEntry.setStatus("current")
_AlarmEventAttrIndex_Type = AlarmEventId
_AlarmEventAttrIndex_Object = MibTableColumn
alarmEventAttrIndex = _AlarmEventAttrIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1, 1, 1),
    _AlarmEventAttrIndex_Type()
)
alarmEventAttrIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventAttrIndex.setStatus("current")
_AlarmEventAttrSourceType_Type = AlarmEventSourceType
_AlarmEventAttrSourceType_Object = MibTableColumn
alarmEventAttrSourceType = _AlarmEventAttrSourceType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1, 1, 2),
    _AlarmEventAttrSourceType_Type()
)
alarmEventAttrSourceType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventAttrSourceType.setStatus("current")


class _AlarmEventAttrName_Type(SnmpAdminString):
    """Custom type alarmEventAttrName based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AlarmEventAttrName_Type.__name__ = "SnmpAdminString"
_AlarmEventAttrName_Object = MibTableColumn
alarmEventAttrName = _AlarmEventAttrName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1, 1, 3),
    _AlarmEventAttrName_Type()
)
alarmEventAttrName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventAttrName.setStatus("current")


class _AlarmEventAttrDescription_Type(SnmpAdminString):
    """Custom type alarmEventAttrDescription based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AlarmEventAttrDescription_Type.__name__ = "SnmpAdminString"
_AlarmEventAttrDescription_Object = MibTableColumn
alarmEventAttrDescription = _AlarmEventAttrDescription_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1, 1, 4),
    _AlarmEventAttrDescription_Type()
)
alarmEventAttrDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventAttrDescription.setStatus("current")
_AlarmEventAttrDefaultSeverity_Type = AlarmSeverity
_AlarmEventAttrDefaultSeverity_Object = MibTableColumn
alarmEventAttrDefaultSeverity = _AlarmEventAttrDefaultSeverity_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1, 1, 5),
    _AlarmEventAttrDefaultSeverity_Type()
)
alarmEventAttrDefaultSeverity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventAttrDefaultSeverity.setStatus("current")
_AlarmEventAttrDefaultMasking_Type = AlarmEventMasking
_AlarmEventAttrDefaultMasking_Object = MibTableColumn
alarmEventAttrDefaultMasking = _AlarmEventAttrDefaultMasking_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1, 1, 6),
    _AlarmEventAttrDefaultMasking_Type()
)
alarmEventAttrDefaultMasking.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventAttrDefaultMasking.setStatus("current")


class _AlarmEventAttrThresholdSupport_Type(Integer32):
    """Custom type alarmEventAttrThresholdSupport based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_AlarmEventAttrThresholdSupport_Type.__name__ = "Integer32"
_AlarmEventAttrThresholdSupport_Object = MibTableColumn
alarmEventAttrThresholdSupport = _AlarmEventAttrThresholdSupport_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1, 1, 7),
    _AlarmEventAttrThresholdSupport_Type()
)
alarmEventAttrThresholdSupport.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventAttrThresholdSupport.setStatus("current")
_AlarmEventAttrAssociatedNotification_Type = ObjectIdentifier
_AlarmEventAttrAssociatedNotification_Object = MibTableColumn
alarmEventAttrAssociatedNotification = _AlarmEventAttrAssociatedNotification_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 1, 1, 8),
    _AlarmEventAttrAssociatedNotification_Type()
)
alarmEventAttrAssociatedNotification.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventAttrAssociatedNotification.setStatus("current")
_ActiveAlarmTable_Object = MibTable
activeAlarmTable = _ActiveAlarmTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2)
)
if mibBuilder.loadTexts:
    activeAlarmTable.setStatus("current")
_ActiveAlarmEntry_Object = MibTableRow
activeAlarmEntry = _ActiveAlarmEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2, 1)
)
activeAlarmEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "activeAlarmSourceId"),
    (0, "RAD-GEN-MIB", "activeAlarmIndex"),
)
if mibBuilder.loadTexts:
    activeAlarmEntry.setStatus("current")
_ActiveAlarmSourceId_Type = SourceId
_ActiveAlarmSourceId_Object = MibTableColumn
activeAlarmSourceId = _ActiveAlarmSourceId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2, 1, 1),
    _ActiveAlarmSourceId_Type()
)
activeAlarmSourceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    activeAlarmSourceId.setStatus("current")
_ActiveAlarmIndex_Type = Unsigned32
_ActiveAlarmIndex_Object = MibTableColumn
activeAlarmIndex = _ActiveAlarmIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2, 1, 2),
    _ActiveAlarmIndex_Type()
)
activeAlarmIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    activeAlarmIndex.setStatus("current")
_ActiveAlarmDateAndTime_Type = DateAndTime
_ActiveAlarmDateAndTime_Object = MibTableColumn
activeAlarmDateAndTime = _ActiveAlarmDateAndTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2, 1, 3),
    _ActiveAlarmDateAndTime_Type()
)
activeAlarmDateAndTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    activeAlarmDateAndTime.setStatus("current")
_ActiveAlarmId_Type = AlarmEventId
_ActiveAlarmId_Object = MibTableColumn
activeAlarmId = _ActiveAlarmId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2, 1, 4),
    _ActiveAlarmId_Type()
)
...
class _ActiveAlarmDescription_Type(SnmpAdminString):
    """Custom type activeAlarmDescription based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 80),
    )
...
_ActiveAlarmDescription_Type.__name__ = "SnmpAdminString"
_ActiveAlarmDescription_Object = MibTableColumn
activeAlarmDescription = _ActiveAlarmDescription_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2, 1, 5),
    _ActiveAlarmDescription_Type()
)
activeAlarmDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    activeAlarmDescription.setStatus("current")
_ActiveAlarmSourceType_Type = AlarmEventSourceType
_ActiveAlarmSourceType_Object = MibTableColumn
activeAlarmSourceType = _ActiveAlarmSourceType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2, 1, 6),
    _ActiveAlarmSourceType_Type()
)
activeAlarmSourceType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    activeAlarmSourceType.setStatus("current")
...
_ActiveAlarmMasking_Type = AlarmEventMasking
_ActiveAlarmMasking_Object = MibTableColumn
activeAlarmMasking = _ActiveAlarmMasking_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2, 1, 8),
    _ActiveAlarmMasking_Type()
)
activeAlarmMasking.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    activeAlarmMasking.setStatus("current")


class _ActiveAlarmSourceName_Type(SnmpAdminString):
    """Custom type activeAlarmSourceName based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_ActiveAlarmSourceName_Type.__name__ = "SnmpAdminString"
_ActiveAlarmSourceName_Object = MibTableColumn
activeAlarmSourceName = _ActiveAlarmSourceName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 2, 1, 9),
    _ActiveAlarmSourceName_Type()
)
activeAlarmSourceName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    activeAlarmSourceName.setStatus("current")


class _ActiveAlarmRebuild_Type(Integer32):
    """Custom type activeAlarmRebuild based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_ActiveAlarmRebuild_Type.__name__ = "Integer32"
_ActiveAlarmRebuild_Object = MibScalar
activeAlarmRebuild = _ActiveAlarmRebuild_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 3),
    _ActiveAlarmRebuild_Type()
)
activeAlarmRebuild.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    activeAlarmRebuild.setStatus("current")
_AlarmEventConfigTable_Object = MibTable
alarmEventConfigTable = _AlarmEventConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 4)
)
if mibBuilder.loadTexts:
    alarmEventConfigTable.setStatus("current")
_AlarmEventConfigEntry_Object = MibTableRow
alarmEventConfigEntry = _AlarmEventConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 4, 1)
)
alarmEventConfigEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmEventConfigId"),
    (0, "RAD-GEN-MIB", "alarmEventConfigSourceType"),
    (0, "RAD-GEN-MIB", "alarmEventConfigSourceId"),
)
if mibBuilder.loadTexts:
    alarmEventConfigEntry.setStatus("current")
_AlarmEventConfigId_Type = AlarmEventId
_AlarmEventConfigId_Object = MibTableColumn
alarmEventConfigId = _AlarmEventConfigId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 4, 1, 1),
    _AlarmEventConfigId_Type()
)
alarmEventConfigId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventConfigId.setStatus("current")
_AlarmEventConfigSourceType_Type = AlarmEventSourceType
_AlarmEventConfigSourceType_Object = MibTableColumn
alarmEventConfigSourceType = _AlarmEventConfigSourceType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 4, 1, 2),
    _AlarmEventConfigSourceType_Type()
)
alarmEventConfigSourceType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventConfigSourceType.setStatus("current")
_AlarmEventConfigSourceId_Type = SourceId
_AlarmEventConfigSourceId_Object = MibTableColumn
alarmEventConfigSourceId = _AlarmEventConfigSourceId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 4, 1, 3),
    _AlarmEventConfigSourceId_Type()
)
alarmEventConfigSourceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventConfigSourceId.setStatus("current")
_AlarmEventConfigSeverity_Type = AlarmSeverity
_AlarmEventConfigSeverity_Object = MibTableColumn
alarmEventConfigSeverity = _AlarmEventConfigSeverity_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 4, 1, 4),
    _AlarmEventConfigSeverity_Type()
)
alarmEventConfigSeverity.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    alarmEventConfigSeverity.setStatus("current")
_AlarmEventConfigMasking_Type = AlarmEventMasking
_AlarmEventConfigMasking_Object = MibTableColumn
alarmEventConfigMasking = _AlarmEventConfigMasking_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 4, 1, 5),
    _AlarmEventConfigMasking_Type()
)
alarmEventConfigMasking.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    alarmEventConfigMasking.setStatus("current")
_AlarmEventConfigRowStatus_Type = RowStatus
_AlarmEventConfigRowStatus_Object = MibTableColumn
alarmEventConfigRowStatus = _AlarmEventConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 4, 1, 6),
    _AlarmEventConfigRowStatus_Type()
)
alarmEventConfigRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    alarmEventConfigRowStatus.setStatus("current")


class _AlarmEventConfigSourceName_Type(SnmpAdminString):
    """Custom type alarmEventConfigSourceName based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_AlarmEventConfigSourceName_Type.__name__ = "SnmpAdminString"
_AlarmEventConfigSourceName_Object = MibTableColumn
alarmEventConfigSourceName = _AlarmEventConfigSourceName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 4, 1, 7),
    _AlarmEventConfigSourceName_Type()
)
alarmEventConfigSourceName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventConfigSourceName.setStatus("current")


class _AlarmEventLogClear_Type(Integer32):
    """Custom type alarmEventLogClear based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_AlarmEventLogClear_Type.__name__ = "Integer32"
_AlarmEventLogClear_Object = MibScalar
alarmEventLogClear = _AlarmEventLogClear_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 5),
    _AlarmEventLogClear_Type()
)
alarmEventLogClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmEventLogClear.setStatus("current")
_MaskReportTable_Object = MibTable
maskReportTable = _MaskReportTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 6)
)
if mibBuilder.loadTexts:
    maskReportTable.setStatus("current")
_MaskReportEntry_Object = MibTableRow
maskReportEntry = _MaskReportEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 6, 1)
)
maskReportEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "maskReportType"),
)
if mibBuilder.loadTexts:
    maskReportEntry.setStatus("current")


class _MaskReportType_Type(Integer32):
    """Custom type maskReportType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_MaskReportType_Type.__name__ = "Integer32"
_MaskReportType_Object = MibTableColumn
maskReportType = _MaskReportType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 6, 1, 1),
    _MaskReportType_Type()
)
maskReportType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    maskReportType.setStatus("current")


class _MaskReportSeverity_Type(Integer32):
    """Custom type maskReportSeverity based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(3,
...
_MaskReportSeverity_Type.__name__ = "Integer32"
_MaskReportSeverity_Object = MibTableColumn
maskReportSeverity = _MaskReportSeverity_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 6, 1, 2),
    _MaskReportSeverity_Type()
)
maskReportSeverity.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    maskReportSeverity.setStatus("current")
_AlarmLedMinSeverity_Type = AlarmSeverity
_AlarmLedMinSeverity_Object = MibScalar
alarmLedMinSeverity = _AlarmLedMinSeverity_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 7),
    _AlarmLedMinSeverity_Type()
)
alarmLedMinSeverity.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmLedMinSeverity.setStatus("current")
_AlarmEventConvertNameToIdTable_Object = MibTable
alarmEventConvertNameToIdTable = _AlarmEventConvertNameToIdTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 8)
)
if mibBuilder.loadTexts:
    alarmEventConvertNameToIdTable.setStatus("current")
_AlarmEventConvertNameToIdEntry_Object = MibTableRow
alarmEventConvertNameToIdEntry = _AlarmEventConvertNameToIdEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 8, 1)
)
alarmEventConvertNameToIdEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmEventConvertName"),
    (0, "RAD-GEN-MIB", "alarmEventConvertSourceType"),
)
if mibBuilder.loadTexts:
    alarmEventConvertNameToIdEntry.setStatus("current")


class _AlarmEventConvertName_Type(SnmpAdminString):
    """Custom type alarmEventConvertName based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AlarmEventConvertName_Type.__name__ = "SnmpAdminString"
_AlarmEventConvertName_Object = MibTableColumn
alarmEventConvertName = _AlarmEventConvertName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 8, 1, 1),
    _AlarmEventConvertName_Type()
)
alarmEventConvertName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventConvertName.setStatus("current")
_AlarmEventConvertSourceType_Type = AlarmEventSourceType
_AlarmEventConvertSourceType_Object = MibTableColumn
alarmEventConvertSourceType = _AlarmEventConvertSourceType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 8, 1, 2),
    _AlarmEventConvertSourceType_Type()
)
alarmEventConvertSourceType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventConvertSourceType.setStatus("current")
_AlarmEventConvertId_Type = AlarmEventId
_AlarmEventConvertId_Object = MibTableColumn
alarmEventConvertId = _AlarmEventConvertId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 8, 1, 3),
    _AlarmEventConvertId_Type()
)
alarmEventConvertId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventConvertId.setStatus("current")
_AlarmRelayInputTable_Object = MibTable
alarmRelayInputTable = _AlarmRelayInputTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 9)
)
if mibBuilder.loadTexts:
    alarmRelayInputTable.setStatus("current")
_AlarmRelayInputEntry_Object = MibTableRow
alarmRelayInputEntry = _AlarmRelayInputEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 9, 1)
)
alarmRelayInputEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmRelayInputRelayIndex"),
)
if mibBuilder.loadTexts:
    alarmRelayInputEntry.setStatus("current")
_AlarmRelayInputRelayIndex_Type = Unsigned32
_AlarmRelayInputRelayIndex_Object = MibTableColumn
alarmRelayInputRelayIndex = _AlarmRelayInputRelayIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 9, 1, 1),
    _AlarmRelayInputRelayIndex_Type()
)
alarmRelayInputRelayIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmRelayInputRelayIndex.setStatus("current")


class _AlarmRelayInputDescription_Type(SnmpAdminString):
    """Custom type alarmRelayInputDescription based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 80),
    )
...
_AlarmRelayInputDescription_Type.__name__ = "SnmpAdminString"
_AlarmRelayInputDescription_Object = MibTableColumn
alarmRelayInputDescription = _AlarmRelayInputDescription_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 9, 1, 2),
    _AlarmRelayInputDescription_Type()
)
alarmRelayInputDescription.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmRelayInputDescription.setStatus("current")


class _AlarmRelayInputActiveState_Type(Integer32):
    """Custom type alarmRelayInputActiveState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AlarmRelayInputActiveState_Type.__name__ = "Integer32"
_AlarmRelayInputActiveState_Object = MibTableColumn
alarmRelayInputActiveState = _AlarmRelayInputActiveState_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 9, 1, 3),
    _AlarmRelayInputActiveState_Type()
)
alarmRelayInputActiveState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmRelayInputActiveState.setStatus("current")


class _AlarmRelayInputOperState_Type(Integer32):
    """Custom type alarmRelayInputOperState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AlarmRelayInputOperState_Type.__name__ = "Integer32"
_AlarmRelayInputOperState_Object = MibTableColumn
alarmRelayInputOperState = _AlarmRelayInputOperState_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 9, 1, 4),
    _AlarmRelayInputOperState_Type()
)
alarmRelayInputOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmRelayInputOperState.setStatus("current")
_AlarmRelayOutputTable_Object = MibTable
alarmRelayOutputTable = _AlarmRelayOutputTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 10)
)
if mibBuilder.loadTexts:
    alarmRelayOutputTable.setStatus("current")
_AlarmRelayOutputEntry_Object = MibTableRow
alarmRelayOutputEntry = _AlarmRelayOutputEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 10, 1)
)
alarmRelayOutputEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmRelayOutputRelayIndex"),
)
if mibBuilder.loadTexts:
    alarmRelayOutputEntry.setStatus("current")
_AlarmRelayOutputRelayIndex_Type = Unsigned32
_AlarmRelayOutputRelayIndex_Object = MibTableColumn
alarmRelayOutputRelayIndex = _AlarmRelayOutputRelayIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 10, 1, 1),
    _AlarmRelayOutputRelayIndex_Type()
)
alarmRelayOutputRelayIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmRelayOutputRelayIndex.setStatus("current")


class _AlarmRelayOutputEnergized_Type(Integer32):
    """Custom type alarmRelayOutputEnergized based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_AlarmRelayOutputEnergized_Type.__name__ = "Integer32"
_AlarmRelayOutputEnergized_Object = MibTableColumn
alarmRelayOutputEnergized = _AlarmRelayOutputEnergized_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 10, 1, 2),
    _AlarmRelayOutputEnergized_Type()
)
alarmRelayOutputEnergized.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmRelayOutputEnergized.setStatus("current")


class _AlarmRelayOutputOperState_Type(Integer32):
    """Custom type alarmRelayOutputOperState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AlarmRelayOutputOperState_Type.__name__ = "Integer32"
_AlarmRelayOutputOperState_Object = MibTableColumn
alarmRelayOutputOperState = _AlarmRelayOutputOperState_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 10, 1, 3),
    _AlarmRelayOutputOperState_Type()
)
alarmRelayOutputOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmRelayOutputOperState.setStatus("current")


class _AlarmRelayOutputCmd_Type(Integer32):
    """Custom type alarmRelayOutputCmd based on Integer32"""
    defaultValue = 2
...
_AlarmRelayOutputCmd_Type.__name__ = "Integer32"
_AlarmRelayOutputCmd_Object = MibTableColumn
alarmRelayOutputCmd = _AlarmRelayOutputCmd_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 10, 1, 4),
    _AlarmRelayOutputCmd_Type()
)
alarmRelayOutputCmd.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmRelayOutputCmd.setStatus("current")
_AlarmBindToRelayTable_Object = MibTable
alarmBindToRelayTable = _AlarmBindToRelayTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 11)
)
if mibBuilder.loadTexts:
    alarmBindToRelayTable.setStatus("current")
_AlarmBindToRelayEntry_Object = MibTableRow
alarmBindToRelayEntry = _AlarmBindToRelayEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 11, 1)
)
alarmBindToRelayEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmBindToRelayIndex"),
)
if mibBuilder.loadTexts:
    alarmBindToRelayEntry.setStatus("current")
_AlarmBindToRelayIndex_Type = SourceId
_AlarmBindToRelayIndex_Object = MibTableColumn
alarmBindToRelayIndex = _AlarmBindToRelayIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 11, 1, 1),
    _AlarmBindToRelayIndex_Type()
)
alarmBindToRelayIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmBindToRelayIndex.setStatus("current")
_AlarmBindToRelayRowStatus_Type = RowStatus
_AlarmBindToRelayRowStatus_Object = MibTableColumn
alarmBindToRelayRowStatus = _AlarmBindToRelayRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 11, 1, 2),
    _AlarmBindToRelayRowStatus_Type()
)
alarmBindToRelayRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    alarmBindToRelayRowStatus.setStatus("current")
_AlarmBindToRelaySourceType_Type = AlarmEventSourceType
_AlarmBindToRelaySourceType_Object = MibTableColumn
alarmBindToRelaySourceType = _AlarmBindToRelaySourceType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 11, 1, 3),
    _AlarmBindToRelaySourceType_Type()
)
alarmBindToRelaySourceType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    alarmBindToRelaySourceType.setStatus("current")
_AlarmBindToRelaySourceId_Type = SourceId
_AlarmBindToRelaySourceId_Object = MibTableColumn
alarmBindToRelaySourceId = _AlarmBindToRelaySourceId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 11, 1, 4),
    _AlarmBindToRelaySourceId_Type()
)
alarmBindToRelaySourceId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    alarmBindToRelaySourceId.setStatus("current")
_AlarmBindToRelayAlarmId_Type = AlarmEventId
_AlarmBindToRelayAlarmId_Object = MibTableColumn
alarmBindToRelayAlarmId = _AlarmBindToRelayAlarmId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 11, 1, 5),
    _AlarmBindToRelayAlarmId_Type()
)
alarmBindToRelayAlarmId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    alarmBindToRelayAlarmId.setStatus("current")
_DefectSoakTable_Object = MibTable
defectSoakTable = _DefectSoakTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 12)
)
if mibBuilder.loadTexts:
    defectSoakTable.setStatus("current")
_DefectSoakEntry_Object = MibTableRow
defectSoakEntry = _DefectSoakEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 12, 1)
)
defectSoakEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "defectSoakTechnology"),
)
if mibBuilder.loadTexts:
    defectSoakEntry.setStatus("current")


class _DefectSoakTechnology_Type(Integer32):
    """Custom type defectSoakTechnology based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_DefectSoakTechnology_Type.__name__ = "Integer32"
_DefectSoakTechnology_Object = MibTableColumn
defectSoakTechnology = _DefectSoakTechnology_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 12, 1, 1),
    _DefectSoakTechnology_Type()
)
defectSoakTechnology.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    defectSoakTechnology.setStatus("current")
_DefectSoakInterval_Type = Integer32
_DefectSoakInterval_Object = MibTableColumn
defectSoakInterval = _DefectSoakInterval_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 12, 1, 2),
    _DefectSoakInterval_Type()
)
defectSoakInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    defectSoakInterval.setStatus("current")
if mibBuilder.loadTexts:
    defectSoakInterval.setUnits("milliseconds")
_DefectSoakClearInterval_Type = Integer32
_DefectSoakClearInterval_Object = MibTableColumn
defectSoakClearInterval = _DefectSoakClearInterval_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 12, 1, 3),
    _DefectSoakClearInterval_Type()
)
defectSoakClearInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    defectSoakClearInterval.setStatus("current")
if mibBuilder.loadTexts:
    defectSoakClearInterval.setUnits("milliseconds")
_AlarmEventConfiguredTable_Object = MibTable
alarmEventConfiguredTable = _AlarmEventConfiguredTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 13)
)
if mibBuilder.loadTexts:
    alarmEventConfiguredTable.setStatus("current")
_AlarmEventConfiguredEntry_Object = MibTableRow
alarmEventConfiguredEntry = _AlarmEventConfiguredEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 13, 1)
)
alarmEventConfiguredEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmEventConfiguredSourceType"),
    (0, "RAD-GEN-MIB", "alarmEventConfiguredSourceId"),
    (0, "RAD-GEN-MIB", "alarmEventConfiguredId"),
)
if mibBuilder.loadTexts:
    alarmEventConfiguredEntry.setStatus("current")
_AlarmEventConfiguredSourceType_Type = AlarmEventSourceType
_AlarmEventConfiguredSourceType_Object = MibTableColumn
alarmEventConfiguredSourceType = _AlarmEventConfiguredSourceType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 13, 1, 1),
    _AlarmEventConfiguredSourceType_Type()
)
alarmEventConfiguredSourceType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventConfiguredSourceType.setStatus("current")
_AlarmEventConfiguredSourceId_Type = SourceId
_AlarmEventConfiguredSourceId_Object = MibTableColumn
alarmEventConfiguredSourceId = _AlarmEventConfiguredSourceId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 13, 1, 2),
    _AlarmEventConfiguredSourceId_Type()
)
alarmEventConfiguredSourceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventConfiguredSourceId.setStatus("current")
_AlarmEventConfiguredId_Type = AlarmEventId
_AlarmEventConfiguredId_Object = MibTableColumn
alarmEventConfiguredId = _AlarmEventConfiguredId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 13, 1, 3),
    _AlarmEventConfiguredId_Type()
)
alarmEventConfiguredId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventConfiguredId.setStatus("current")
_AlarmEventConfiguredSeverity_Type = AlarmSeverity
_AlarmEventConfiguredSeverity_Object = MibTableColumn
alarmEventConfiguredSeverity = _AlarmEventConfiguredSeverity_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 13, 1, 4),
    _AlarmEventConfiguredSeverity_Type()
)
alarmEventConfiguredSeverity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventConfiguredSeverity.setStatus("current")
_AlarmEventConfiguredMasking_Type = AlarmEventMasking
_AlarmEventConfiguredMasking_Object = MibTableColumn
alarmEventConfiguredMasking = _AlarmEventConfiguredMasking_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 13, 1, 5),
    _AlarmEventConfiguredMasking_Type()
)
alarmEventConfiguredMasking.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventConfiguredMasking.setStatus("current")


class _AlarmEventLogFileTimestampType_Type(Integer32):
    """Custom type alarmEventLogFileTimestampType based on Integer32"""
    defaultValue = 2
...
_AlarmEventLogFileTimestampType_Type.__name__ = "Integer32"
_AlarmEventLogFileTimestampType_Object = MibScalar
alarmEventLogFileTimestampType = _AlarmEventLogFileTimestampType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 1, 14),
    _AlarmEventLogFileTimestampType_Type()
)
alarmEventLogFileTimestampType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmEventLogFileTimestampType.setStatus("current")
_AlarmEventLog_ObjectIdentity = ObjectIdentity
alarmEventLog = _AlarmEventLog_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2)
)
_AlarmEventLogTable_Object = MibTable
alarmEventLogTable = _AlarmEventLogTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1)
)
if mibBuilder.loadTexts:
    alarmEventLogTable.setStatus("current")
_AlarmEventLogEntry_Object = MibTableRow
alarmEventLogEntry = _AlarmEventLogEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1)
)
alarmEventLogEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmEventLogIndex"),
)
if mibBuilder.loadTexts:
    alarmEventLogEntry.setStatus("current")
_AlarmEventLogIndex_Type = Unsigned32
_AlarmEventLogIndex_Object = MibTableColumn
alarmEventLogIndex = _AlarmEventLogIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 1),
    _AlarmEventLogIndex_Type()
)
alarmEventLogIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventLogIndex.setStatus("current")
_AlarmEventLogDateAndTime_Type = DateAndTime
_AlarmEventLogDateAndTime_Object = MibTableColumn
alarmEventLogDateAndTime = _AlarmEventLogDateAndTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 2),
    _AlarmEventLogDateAndTime_Type()
)
alarmEventLogDateAndTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventLogDateAndTime.setStatus("current")
_AlarmEventLogAlarmOrEventId_Type = AlarmEventId
_AlarmEventLogAlarmOrEventId_Object = MibTableColumn
alarmEventLogAlarmOrEventId = _AlarmEventLogAlarmOrEventId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 3),
    _AlarmEventLogAlarmOrEventId_Type()
)
alarmEventLogAlarmOrEventId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventLogAlarmOrEventId.setStatus("current")


class _AlarmEventLogDescription_Type(SnmpAdminString):
    """Custom type alarmEventLogDescription based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 255),
    )
...
_AlarmEventLogDescription_Type.__name__ = "SnmpAdminString"
_AlarmEventLogDescription_Object = MibTableColumn
alarmEventLogDescription = _AlarmEventLogDescription_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 4),
    _AlarmEventLogDescription_Type()
)
alarmEventLogDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventLogDescription.setStatus("current")
_AlarmEventLogSourceId_Type = SourceId
_AlarmEventLogSourceId_Object = MibTableColumn
alarmEventLogSourceId = _AlarmEventLogSourceId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 5),
    _AlarmEventLogSourceId_Type()
)
alarmEventLogSourceId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventLogSourceId.setStatus("current")
_AlarmEventLogSourceType_Type = AlarmEventSourceType
_AlarmEventLogSourceType_Object = MibTableColumn
alarmEventLogSourceType = _AlarmEventLogSourceType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 6),
    _AlarmEventLogSourceType_Type()
)
alarmEventLogSourceType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventLogSourceType.setStatus("current")
_AlarmEventLogSeverity_Type = AlarmSeverity
_AlarmEventLogSeverity_Object = MibTableColumn
alarmEventLogSeverity = _AlarmEventLogSeverity_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 7),
    _AlarmEventLogSeverity_Type()
)
alarmEventLogSeverity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventLogSeverity.setStatus("current")
_AlarmEventProperties_Type = AlarmProperties
_AlarmEventProperties_Object = MibTableColumn
alarmEventProperties = _AlarmEventProperties_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 8),
    _AlarmEventProperties_Type()
)
alarmEventProperties.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventProperties.setStatus("current")
_AlarmEventReason_Type = AlarmReason
_AlarmEventReason_Object = MibTableColumn
alarmEventReason = _AlarmEventReason_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 9),
    _AlarmEventReason_Type()
)
alarmEventReason.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventReason.setStatus("current")


class _AlarmEventLogSourceName_Type(SnmpAdminString):
    """Custom type alarmEventLogSourceName based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_AlarmEventLogSourceName_Type.__name__ = "SnmpAdminString"
_AlarmEventLogSourceName_Object = MibTableColumn
alarmEventLogSourceName = _AlarmEventLogSourceName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 1, 1, 10),
    _AlarmEventLogSourceName_Type()
)
alarmEventLogSourceName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventLogSourceName.setStatus("current")
_AlarmEventLogAckTable_Object = MibTable
alarmEventLogAckTable = _AlarmEventLogAckTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 2)
)
if mibBuilder.loadTexts:
    alarmEventLogAckTable.setStatus("current")
_AlarmEventLogAckEntry_Object = MibTableRow
alarmEventLogAckEntry = _AlarmEventLogAckEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 2, 1)
)
alarmEventLogAckEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmEventLogAckIndex"),
)
if mibBuilder.loadTexts:
    alarmEventLogAckEntry.setStatus("current")
_AlarmEventLogAckIndex_Type = Unsigned32
_AlarmEventLogAckIndex_Object = MibTableColumn
alarmEventLogAckIndex = _AlarmEventLogAckIndex_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 2, 1, 1),
    _AlarmEventLogAckIndex_Type()
)
alarmEventLogAckIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventLogAckIndex.setStatus("current")


class _AlarmEventLogAckCmd_Type(Integer32):
    """Custom type alarmEventLogAckCmd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_AlarmEventLogAckCmd_Type.__name__ = "Integer32"
_AlarmEventLogAckCmd_Object = MibTableColumn
alarmEventLogAckCmd = _AlarmEventLogAckCmd_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 2, 1, 2),
    _AlarmEventLogAckCmd_Type()
)
alarmEventLogAckCmd.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alarmEventLogAckCmd.setStatus("current")
_AlarmEventLogAckTime_Type = DateAndTime
_AlarmEventLogAckTime_Object = MibTableColumn
alarmEventLogAckTime = _AlarmEventLogAckTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 2, 2, 1, 3),
    _AlarmEventLogAckTime_Type()
)
alarmEventLogAckTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventLogAckTime.setStatus("current")
_AlarmEventStatistics_ObjectIdentity = ObjectIdentity
alarmEventStatistics = _AlarmEventStatistics_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3)
)
_AlarmEventBriefLogTable_Object = MibTable
alarmEventBriefLogTable = _AlarmEventBriefLogTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1)
)
if mibBuilder.loadTexts:
    alarmEventBriefLogTable.setStatus("current")
_AlarmEventBriefLogEntry_Object = MibTableRow
alarmEventBriefLogEntry = _AlarmEventBriefLogEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1)
)
alarmEventBriefLogEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmEventBriefLogSourceType"),
    (0, "RAD-GEN-MIB", "alarmEventBriefLogSourceId"),
    (0, "RAD-GEN-MIB", "alarmEventBriefLogAlarmId"),
)
if mibBuilder.loadTexts:
    alarmEventBriefLogEntry.setStatus("current")
_AlarmEventBriefLogSourceType_Type = AlarmEventSourceType
_AlarmEventBriefLogSourceType_Object = MibTableColumn
alarmEventBriefLogSourceType = _AlarmEventBriefLogSourceType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 1),
    _AlarmEventBriefLogSourceType_Type()
)
alarmEventBriefLogSourceType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventBriefLogSourceType.setStatus("current")
_AlarmEventBriefLogSourceId_Type = SourceId
_AlarmEventBriefLogSourceId_Object = MibTableColumn
alarmEventBriefLogSourceId = _AlarmEventBriefLogSourceId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 2),
    _AlarmEventBriefLogSourceId_Type()
)
alarmEventBriefLogSourceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventBriefLogSourceId.setStatus("current")
_AlarmEventBriefLogAlarmId_Type = AlarmEventId
_AlarmEventBriefLogAlarmId_Object = MibTableColumn
alarmEventBriefLogAlarmId = _AlarmEventBriefLogAlarmId_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 3),
    _AlarmEventBriefLogAlarmId_Type()
)
alarmEventBriefLogAlarmId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventBriefLogAlarmId.setStatus("current")
_AlarmEventBriefLogAlarmSeverity_Type = AlarmSeverity
_AlarmEventBriefLogAlarmSeverity_Object = MibTableColumn
alarmEventBriefLogAlarmSeverity = _AlarmEventBriefLogAlarmSeverity_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 4),
    _AlarmEventBriefLogAlarmSeverity_Type()
)
alarmEventBriefLogAlarmSeverity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventBriefLogAlarmSeverity.setStatus("current")
_AlarmEventBriefLogTotalRaised_Type = Counter32
_AlarmEventBriefLogTotalRaised_Object = MibTableColumn
alarmEventBriefLogTotalRaised = _AlarmEventBriefLogTotalRaised_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 5),
    _AlarmEventBriefLogTotalRaised_Type()
)
alarmEventBriefLogTotalRaised.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventBriefLogTotalRaised.setStatus("current")
_AlarmEventBriefLogTotalRaisedSinceAck_Type = Counter32
_AlarmEventBriefLogTotalRaisedSinceAck_Object = MibTableColumn
alarmEventBriefLogTotalRaisedSinceAck = _AlarmEventBriefLogTotalRaisedSinceAck_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 6),
    _AlarmEventBriefLogTotalRaisedSinceAck_Type()
)
alarmEventBriefLogTotalRaisedSinceAck.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventBriefLogTotalRaisedSinceAck.setStatus("current")
_AlarmEventBriefLogLastRaisedTime_Type = DateAndTime
_AlarmEventBriefLogLastRaisedTime_Object = MibTableColumn
alarmEventBriefLogLastRaisedTime = _AlarmEventBriefLogLastRaisedTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 7),
    _AlarmEventBriefLogLastRaisedTime_Type()
)
alarmEventBriefLogLastRaisedTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventBriefLogLastRaisedTime.setStatus("current")
_AlarmEventBriefLogLastRaisedTimeSinceAck_Type = DateAndTime
_AlarmEventBriefLogLastRaisedTimeSinceAck_Object = MibTableColumn
alarmEventBriefLogLastRaisedTimeSinceAck = _AlarmEventBriefLogLastRaisedTimeSinceAck_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 8),
    _AlarmEventBriefLogLastRaisedTimeSinceAck_Type()
)
alarmEventBriefLogLastRaisedTimeSinceAck.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventBriefLogLastRaisedTimeSinceAck.setStatus("current")
_AlarmEventBriefLogLastClearedTime_Type = DateAndTime
_AlarmEventBriefLogLastClearedTime_Object = MibTableColumn
alarmEventBriefLogLastClearedTime = _AlarmEventBriefLogLastClearedTime_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 9),
    _AlarmEventBriefLogLastClearedTime_Type()
)
alarmEventBriefLogLastClearedTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventBriefLogLastClearedTime.setStatus("current")
_AlarmEventBriefLogLastClearedTimeSinceAck_Type = DateAndTime
_AlarmEventBriefLogLastClearedTimeSinceAck_Object = MibTableColumn
alarmEventBriefLogLastClearedTimeSinceAck = _AlarmEventBriefLogLastClearedTimeSinceAck_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 10),
    _AlarmEventBriefLogLastClearedTimeSinceAck_Type()
)
alarmEventBriefLogLastClearedTimeSinceAck.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventBriefLogLastClearedTimeSinceAck.setStatus("current")


class _AlarmEventBriefLogSourceName_Type(SnmpAdminString):
    """Custom type alarmEventBriefLogSourceName based on SnmpAdminString"""
    subtypeSpec = SnmpAdminString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_AlarmEventBriefLogSourceName_Type.__name__ = "SnmpAdminString"
_AlarmEventBriefLogSourceName_Object = MibTableColumn
alarmEventBriefLogSourceName = _AlarmEventBriefLogSourceName_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 1, 1, 11),
    _AlarmEventBriefLogSourceName_Type()
)
alarmEventBriefLogSourceName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventBriefLogSourceName.setStatus("current")
_AlarmEventStatsTable_Object = MibTable
alarmEventStatsTable = _AlarmEventStatsTable_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 2)
)
if mibBuilder.loadTexts:
    alarmEventStatsTable.setStatus("current")
_AlarmEventStatsEntry_Object = MibTableRow
alarmEventStatsEntry = _AlarmEventStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 2, 1)
)
alarmEventStatsEntry.setIndexNames(
    (0, "RAD-GEN-MIB", "alarmEventStatsType"),
)
if mibBuilder.loadTexts:
    alarmEventStatsEntry.setStatus("current")
_AlarmEventStatsType_Type = AlarmEventLogStatsType
_AlarmEventStatsType_Object = MibTableColumn
alarmEventStatsType = _AlarmEventStatsType_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 2, 1, 1),
    _AlarmEventStatsType_Type()
)
alarmEventStatsType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    alarmEventStatsType.setStatus("current")
_AlarmEventStatsTotalCritical_Type = Gauge32
_AlarmEventStatsTotalCritical_Object = MibTableColumn
alarmEventStatsTotalCritical = _AlarmEventStatsTotalCritical_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 2, 1, 2),
    _AlarmEventStatsTotalCritical_Type()
)
alarmEventStatsTotalCritical.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventStatsTotalCritical.setStatus("current")
_AlarmEventStatsTotalMajor_Type = Gauge32
_AlarmEventStatsTotalMajor_Object = MibTableColumn
alarmEventStatsTotalMajor = _AlarmEventStatsTotalMajor_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 2, 1, 3),
    _AlarmEventStatsTotalMajor_Type()
)
alarmEventStatsTotalMajor.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventStatsTotalMajor.setStatus("current")
_AlarmEventStatsTotalMinor_Type = Gauge32
_AlarmEventStatsTotalMinor_Object = MibTableColumn
alarmEventStatsTotalMinor = _AlarmEventStatsTotalMinor_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 2, 1, 4),
    _AlarmEventStatsTotalMinor_Type()
)
alarmEventStatsTotalMinor.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventStatsTotalMinor.setStatus("current")
_AlarmEventStatsTotalEvents_Type = Gauge32
_AlarmEventStatsTotalEvents_Object = MibTableColumn
alarmEventStatsTotalEvents = _AlarmEventStatsTotalEvents_Object(
    (1, 3, 6, 1, 4, 1, 164, 6, 5, 3, 2, 1, 5),
    _AlarmEventStatsTotalEvents_Type()
)
alarmEventStatsTotalEvents.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmEventStatsTotalEvents.setStatus("current")
_Sfp_ObjectIdentity = ObjectIdentity
sfp = _Sfp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 40, 3)
)
_SfpConnector_ObjectIdentity = ObjectIdentity
sfpConnector = _SfpConnector_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 40, 3, 4)
)
_SfpEvents_ObjectIdentity = ObjectIdentity
sfpEvents = _SfpEvents_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 40, 3, 4, 0)
)
...
swdlStatusResult.setObjects(
    ("RAD-GEN-MIB", "swdlStatusFileName")
)
if mibBuilder.loadTexts:
...
agnClkSrcStateChangeTrap.setObjects(
    ("RAD-GEN-MIB", "agnClkSrcPortState")
)
if mibBuilder.loadTexts:
...
agnCurrClkStateChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 30)
)
agnCurrClkStateChangeTrap.setObjects(
    ("RAD-GEN-MIB", "agnCurrClkState")
)
if mibBuilder.loadTexts:
    agnCurrClkStateChangeTrap.setStatus(
        "current"
    )
...
prtLoopDetectTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 32)
)
if mibBuilder.loadTexts:
    prtLoopDetectTrap.setStatus(
        "current"
    )

systemDeviceTemperatureOra = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 41)
)
systemDeviceTemperatureOra.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ...
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "agnThresholdCurrent"),
        ("RAD-GEN-MIB", "agnThresholdMin"),
        ("RAD-GEN-MIB", "agnThresholdMax"),
        ("RAD-GEN-MIB", "agnThresholdUom"))
)
if mibBuilder.loadTexts:
    systemDeviceTemperatureOra.setStatus(
        "current"
    )

systemAlternateConfigLoaded = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 45)
)
systemAlternateConfigLoaded.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "configLoadObjType"))
)
if mibBuilder.loadTexts:
    systemAlternateConfigLoaded.setStatus(
        "current"
    )

systemConfigurationSanity = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 47)
)
systemConfigurationSanity.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "configLoadErrorPolicy"))
)
if mibBuilder.loadTexts:
    systemConfigurationSanity.setStatus(
        "current"
    )

systemDyingGasp = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 49)
)
systemDyingGasp.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemDyingGasp.setStatus(
        "current"
    )

systemDyingGaspRecovery = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 50)
)
systemDyingGaspRecovery.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemDyingGaspRecovery.setStatus(
        "current"
    )

systemTraceMsgFatalError = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 51)
)
systemTraceMsgFatalError.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "resetInformationFileName"),
        ("RAD-GEN-MIB", "resetInformationLineNumber"))
)
if mibBuilder.loadTexts:
    systemTraceMsgFatalError.setStatus(
        "current"
    )

systemTraceMsgException = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 52)
)
systemTraceMsgException.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "resetInformationPC"),
        ("RAD-GEN-MIB", "resetInformationExceptionCause"))
)
if mibBuilder.loadTexts:
    systemTraceMsgException.setStatus(
        "current"
    )

systemDeviceStartup = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 55)
)
systemDeviceStartup.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "resetInformationLastReset"))
)
if mibBuilder.loadTexts:
    systemDeviceStartup.setStatus(
        "current"
    )

systemHardwareFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 58)
)
systemHardwareFailure.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemHardwareFailure.setStatus(
        "current"
    )
...
systemStartupConfigUnconfirmed.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemStartupConfigUnconfirmed.setStatus(
        "current"
    )
...
systemSuccessfulLogin = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 70)
)
systemSuccessfulLogin.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "deviceAccessUserName"),
        ("RAD-GEN-MIB", "deviceAccessIpAddress"),
        ("RAD-GEN-MIB", "deviceAccessMethod"),
        ("RAD-GEN-MIB", "deviceAccessAuthenticationMethod"),
        ("RAD-GEN-MIB", "deviceAccessSessionId"))
)
if mibBuilder.loadTexts:
    systemSuccessfulLogin.setStatus(
        "current"
    )

systemFailedLogin = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 71)
)
systemFailedLogin.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "deviceAccessMethod"),
        ("RAD-GEN-MIB", "deviceAccessAuthenticationMethod"),
        ("RAD-GEN-MIB", "deviceAccessLoginStatus"))
)
if mibBuilder.loadTexts:
    systemFailedLogin.setStatus(
        "current"
    )

systemLogout = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 72)
)
systemLogout.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "deviceAccessAuthenticationMethod"),
        ("RAD-GEN-MIB", "deviceAccessSessionId"),
        ("RAD-GEN-MIB", "deviceAccessLogoutStatus"))
)
if mibBuilder.loadTexts:
    systemLogout.setStatus(
        "current"
    )

systemTrapHardSyncStart = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 77)
)
systemTrapHardSyncStart.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemTrapHardSyncStart.setStatus(
        "current"
    )

systemTrapHardSyncEnd = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 78)
)
systemTrapHardSyncEnd.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemTrapHardSyncEnd.setStatus(
        "current"
    )

systemUserReset = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 82)
)
systemUserReset.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "resetInformationReason"))
)
if mibBuilder.loadTexts:
    systemUserReset.setStatus(
        "current"
    )

faultPropagation = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 87)
)
faultPropagation.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ("RAD-GEN-MIB", "alarmEventLogDateAndTime"),
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("RAD-GEN-MIB", "alarmForwardingDescr"),
        ("RAD-GEN-MIB", "alarmForwardingAction"),
        ("RAD-GEN-MIB", "alarmForwardingActiveCause"))
)
if mibBuilder.loadTexts:
    faultPropagation.setStatus(
        "current"
    )

systemResourceOverflow = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 90)
)
systemResourceOverflow.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "systemResourceLastError"))
)
if mibBuilder.loadTexts:
    systemResourceOverflow.setStatus(
        "current"
    )

systemRemoteTerminalStarted = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 91)
)
systemRemoteTerminalStarted.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "deviceAccessMethod"),
        ("RAD-GEN-MIB", "deviceAccessSessionId"),
        ("RAD-GEN-MIB", "deviceAccessRemoteIpAddress"),
        ("RAD-GEN-MIB", "deviceAccessRemoteTerminal"))
)
if mibBuilder.loadTexts:
    systemRemoteTerminalStarted.setStatus(
        "current"
    )

systemRemoteTerminalEnded = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 92)
)
systemRemoteTerminalEnded.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemRemoteTerminalEnded.setStatus(
        "current"
    )

systemNtpAccuracyOutOfLimit = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 93)
)
systemNtpAccuracyOutOfLimit.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "systemNtpLockingStatus"))
)
if mibBuilder.loadTexts:
    systemNtpAccuracyOutOfLimit.setStatus(
        "current"
    )

systemSummerTimeStarted = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 95)
)
systemSummerTimeStarted.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemSummerTimeStarted.setStatus(
        "deprecated"
    )

systemSummerTimeEnded = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 96)
)
systemSummerTimeEnded.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemSummerTimeEnded.setStatus(
        "deprecated"
    )

systemFileOverflow = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 97)
)
systemFileOverflow.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemFileOverflow.setStatus(
        "current"
    )

systemTimeChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 98)
)
systemTimeChanged.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "systemLastTimeChangeOffset"),
        ("RAD-GEN-MIB", "systemLastTimeChangeReason"))
)
if mibBuilder.loadTexts:
    systemTimeChanged.setStatus(
        "current"
    )

systemTimeSourceChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 99)
)
systemTimeSourceChanged.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
        ...
        ("RAD-GEN-MIB", "alarmEventReason"),
        ("SNMPv2-MIB", "sysName"),
        ("RAD-GEN-MIB", "systemNtpCurrentSource"))
)
if mibBuilder.loadTexts:
    systemTimeSourceChanged.setStatus(
        "current"
    )

systemSerialPortDisabled = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 100)
)
systemSerialPortDisabled.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemSerialPortDisabled.setStatus(
        "current"
    )

systemSerialPortEnabled = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 101)
)
systemSerialPortEnabled.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemSerialPortEnabled.setStatus(
        "current"
    )

systemFactoryDefaultButtonPushed = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 1, 0, 102)
)
systemFactoryDefaultButtonPushed.setObjects(
      *(("RAD-GEN-MIB", "alarmEventLogSourceName"),
        ("RAD-GEN-MIB", "alarmEventLogAlarmOrEventId"),
        ("RAD-GEN-MIB", "alarmEventLogDescription"),
        ("RAD-GEN-MIB", "alarmEventLogSeverity"),
...
if mibBuilder.loadTexts:
    systemFactoryDefaultButtonPushed.setStatus(
        "current"
    )

hardSyncTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 164, 6, 2, 61, 2, 0, 1)
)
hardSyncTrap.setObjects(
    ("RAD-GEN-MIB", "trapState")
)
if mibBuilder.loadTexts:
    hardSyncTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"SysIfEntityType": SysIfEntityType,
       "SourceId": SourceId,
       "AlarmEventSourceType": AlarmEventSourceType,
       "AlarmEventId": AlarmEventId,
       "AlarmSeverity": AlarmSeverity,
       "AlarmEventMasking": AlarmEventMasking,
       ...
       "agnCurrClkStateChangeTrap": agnCurrClkStateChangeTrap,
       "agnClkSrcFrequencyAlarmTrap": agnClkSrcFrequencyAlarmTrap,
       "prtLoopDetectTrap": prtLoopDetectTrap,
       "systemDeviceTemperatureOra": systemDeviceTemperatureOra,
       "systemAlternateConfigLoaded": systemAlternateConfigLoaded,
       "systemConfigurationSanity": systemConfigurationSanity,
       "systemDyingGasp": systemDyingGasp,
       "systemDyingGaspRecovery": systemDyingGaspRecovery,
       "systemTraceMsgFatalError": systemTraceMsgFatalError,
       "systemTraceMsgException": systemTraceMsgException,
       "systemDeviceStartup": systemDeviceStartup,
       "systemHardwareFailure": systemHardwareFailure,
       "systemStartupConfigUnconfirmed": systemStartupConfigUnconfirmed,
       "fanFailure": fanFailure,
       "systemSuccessfulLogin": systemSuccessfulLogin,
       "systemFailedLogin": systemFailedLogin,
       "systemLogout": systemLogout,
       "systemTrapHardSyncStart": systemTrapHardSyncStart,
       "systemTrapHardSyncEnd": systemTrapHardSyncEnd,
       "systemUserReset": systemUserReset,
       "faultPropagation": faultPropagation,
       "systemResourceOverflow": systemResourceOverflow,
       "systemRemoteTerminalStarted": systemRemoteTerminalStarted,
       "systemRemoteTerminalEnded": systemRemoteTerminalEnded,
       "systemNtpAccuracyOutOfLimit": systemNtpAccuracyOutOfLimit,
       "systemSummerTimeStarted": systemSummerTimeStarted,
       "systemSummerTimeEnded": systemSummerTimeEnded,
       "systemFileOverflow": systemFileOverflow,
       "systemTimeChanged": systemTimeChanged,
       "systemTimeSourceChanged": systemTimeSourceChanged,
       "systemSerialPortDisabled": systemSerialPortDisabled,
       "systemSerialPortEnabled": systemSerialPortEnabled,
       "systemFactoryDefaultButtonPushed": systemFactoryDefaultButtonPushed,
       "radSysTR": radSysTR,
       ...
       "radETX205A": radETX205A,
       "radETX220A": radETX220A,
       "radETX203AM": radETX203AM,
       "radETX203AX": radETX203AX,
       "radETX2i": radETX2i,
       "radETX2iHalf19Inch": radETX2iHalf19Inch,
       "radETX2iNebs": radETX2iNebs,
       "radETX2iVENebs": radETX2iVENebs,
       "radETX203AXH": radETX203AXH,
       ...
       "radTest": radTest,
       "radTrace": radTrace,
       "radAgnTrace": radAgnTrace,
       "resetInformationTable": resetInformationTable,
       "resetInformationEntry": resetInformationEntry,
       "resetInformationId": resetInformationId,
       "resetInformationLastReset": resetInformationLastReset,
       "resetInformationFileName": resetInformationFileName,
       "resetInformationLineNumber": resetInformationLineNumber,
       "resetInformationPC": resetInformationPC,
       "resetInformationExceptionCause": resetInformationExceptionCause,
       "resetInformationReason": resetInformationReason,
       ...
       "systemNtpTimeSinceLastPoll": systemNtpTimeSinceLastPoll,
       "systemNtpModeBITS": systemNtpModeBITS,
       "systemNtpCurrentSourceType": systemNtpCurrentSourceType,
       "systemNtpCurrentSource": systemNtpCurrentSource,
       "sntpServerTable": sntpServerTable,
       "sntpServerEntry": sntpServerEntry,
       "sntpServerID": sntpServerID,
       "sntpServerRowStatus": sntpServerRowStatus,
       "sntpServerAddressType": sntpServerAddressType,
       "sntpServerAddress": sntpServerAddress,
       "sntpServerPort": sntpServerPort,
       "sntpServerPreference": sntpServerPreference,
       "sntpServerAdminStatus": sntpServerAdminStatus,
       "sntpServerType": sntpServerType,
       "sntpServerLastReceivedTimestamp": sntpServerLastReceivedTimestamp,
       "sntpServerLastReceivedStratum": sntpServerLastReceivedStratum,
       "sntpServerTimeSinceLastReceivedMessage": sntpServerTimeSinceLastReceivedMessage,
       "sntpServerSendRequestNow": sntpServerSendRequestNow,
       "systemNtpLockingStatus": systemNtpLockingStatus,
       "systemSummerTimeState": systemSummerTimeState,
       "schedXTable": schedXTable,
       "schedXEntry": schedXEntry,
       "schedYear": schedYear,
       "schedWeekInMonth": schedWeekInMonth,
       "schedParam": schedParam,
       "schedXWeek": schedXWeek,
       "schedAction": schedAction,
       "schedControl": schedControl,
       "schedDeleteFinishedCmd": schedDeleteFinishedCmd,
       "schedClearLogCmd": schedClearLogCmd,
       "systemDateTime": systemDateTime,
       "systemLastTimeChangeOffset": systemLastTimeChangeOffset,
       "systemLastTimeChangeReason": systemLastTimeChangeReason,
       ...
       "physicalConnectorUsed": physicalConnectorUsed,
       "physicalConnectorSfpWaveLength": physicalConnectorSfpWaveLength,
       ...
       "prtTestForceTTL": prtTestForceTTL,
       "prtTestBwProfile": prtTestBwProfile,
       "prtTestSourceIpAddress": prtTestSourceIpAddress,
       "prtTestRemainTime": prtTestRemainTime,
       "prtParam": prtParam,
       ...
       "prtParamSdBerThreshold": prtParamSdBerThreshold,
       "prtParamLoopDetectStatus": prtParamLoopDetectStatus,
       "prtParamSupportedFeatures": prtParamSupportedFeatures,
       "prtParamPortStatus": prtParamPortStatus,
       "prtParamSsmTx": prtParamSsmTx,
       "prtParamAlias": prtParamAlias,
       "prtParamTxClockInstance": prtParamTxClockInstance,
       "prtParamEntPhysicalIndex": prtParamEntPhysicalIndex,
       "prtParamSsmTxType": prtParamSsmTxType,
       "prtXTable": prtXTable,
       "prtXEntry": prtXEntry,
       "prtXCliPortString": prtXCliPortString,
       "prtIP": prtIP,
       ...
       "agnTacacsAccess": agnTacacsAccess,
       "deviceAccessTable": deviceAccessTable,
       "deviceAccessEntry": deviceAccessEntry,
       "deviceAccessIndex": deviceAccessIndex,
       "deviceAccessLoginTime": deviceAccessLoginTime,
       "deviceAccessLoginStatus": deviceAccessLoginStatus,
       "deviceAccessUserName": deviceAccessUserName,
       "deviceAccessIpAddressType": deviceAccessIpAddressType,
       "deviceAccessIpAddress": deviceAccessIpAddress,
       "deviceAccessMethod": deviceAccessMethod,
       "deviceAccessAuthenticationMethod": deviceAccessAuthenticationMethod,
       "deviceAccessSessionId": deviceAccessSessionId,
       "deviceAccessLogoutTime": deviceAccessLogoutTime,
       "deviceAccessLogoutStatus": deviceAccessLogoutStatus,
       "deviceAccessRemoteTerminal": deviceAccessRemoteTerminal,
       "deviceAccessRemoteIpAddressType": deviceAccessRemoteIpAddressType,
       "deviceAccessRemoteIpAddress": deviceAccessRemoteIpAddress,
       "deviceAccessRemoteLoginTime": deviceAccessRemoteLoginTime,
       "agnTftpAccess": agnTftpAccess,
       "agnSftpAccess": agnSftpAccess,
       "agnControlPortAccess": agnControlPortAccess,
       "bannerTable": bannerTable,
       "bannerEntry": bannerEntry,
       "bannerType": bannerType,
       "bannerLineNumber": bannerLineNumber,
       "bannerRowStatus": bannerRowStatus,
       ...
       "systemBfd": systemBfd,
       "bfdSessXTable": bfdSessXTable,
       "bfdSessXEntry": bfdSessXEntry,
       "bfdSessXIndex": bfdSessXIndex,
       "bfdSessXStaticAssociated": bfdSessXStaticAssociated,
       "bfdSessXRemoteDiag": bfdSessXRemoteDiag,
       "bfdSessXClearStatisticsCmd": bfdSessXClearStatisticsCmd,
       "bfdSessXDescription": bfdSessXDescription,
       ...
       "agnFunctionAttributes": agnFunctionAttributes,
       "agnFunctionVersion": agnFunctionVersion,
       ...
       "alarmForwardingActiveCause": alarmForwardingActiveCause,
       "alarmForwardingDescr": alarmForwardingDescr,
       "alarmForwardingPriorityDecrement": alarmForwardingPriorityDecrement,
       ...
       "agnGroupName": agnGroupName,
       "agnGroupParam": agnGroupParam,
       "agnGroupStatus": agnGroupStatus,
       "agnGroupStatus2": agnGroupStatus2,
       "agnGroupComponentString": agnGroupComponentString,
       "agnGroupComponentTDomain": agnGroupComponentTDomain,
       "agnGroupComponentTAddress": agnGroupComponentTAddress,
       ...
       "agnSyslogCmd": agnSyslogCmd,
       "agnNetworkInterfaceType": agnNetworkInterfaceType,
       "agnTrapDelay": agnTrapDelay,
       "trapManagement": trapManagement,
       "trapMngVars": trapMngVars,
       "trapState": trapState,
       "trapSeqId": trapSeqId,
       "alarmSync": alarmSync,
       "alarmSyncEvents": alarmSyncEvents,
       "hardSyncTrap": hardSyncTrap,
       "alarmSyncTable": alarmSyncTable,
       "alarmSyncEntry": alarmSyncEntry,
       "alarmSyncGroupId": alarmSyncGroupId,
       "alarmSyncLastSentSeqId": alarmSyncLastSentSeqId,
       "alarmSyncCmd": alarmSyncCmd,
       "alarmSyncStartSeqId": alarmSyncStartSeqId,
       "alarmSyncEndSeqId": alarmSyncEndSeqId,
       ...
       "agnConfigVersion": agnConfigVersion,
       "agnResources": agnResources,
       "agnMemoryBufferTable": agnMemoryBufferTable,
       "agnMemoryBufferEntry": agnMemoryBufferEntry,
       "agnMemoryBufferPoolIndex": agnMemoryBufferPoolIndex,
       "agnMemoryBufferName": agnMemoryBufferName,
       "agnMemoryBufferTotalNum": agnMemoryBufferTotalNum,
       "agnMemoryBufferFree": agnMemoryBufferFree,
       "agnMemoryBufferSize": agnMemoryBufferSize,
       "agnMemoryBufferAllocErrors": agnMemoryBufferAllocErrors,
       "agnMemoryBufferFreeErrors": agnMemoryBufferFreeErrors,
       "agnCpuUtilizationTable": agnCpuUtilizationTable,
       "agnCpuUtilizationEntry": agnCpuUtilizationEntry,
       "agnCpuUtilizationCpuIdx": agnCpuUtilizationCpuIdx,
       "agnCpuUtilizationTaskIdx": agnCpuUtilizationTaskIdx,
       "agnCpuUtilizationCurrent": agnCpuUtilizationCurrent,
       "agnCpuUtilizationMin": agnCpuUtilizationMin,
       "agnCpuUtilizationMax": agnCpuUtilizationMax,
       "agnCpuUtilizationClear": agnCpuUtilizationClear,
       "agnCpuUtilizationAverage": agnCpuUtilizationAverage,
       "agnDiskResourcesTable": agnDiskResourcesTable,
       "agnDiskResourcesEntry": agnDiskResourcesEntry,
       "agnDiskIdx": agnDiskIdx,
       "agnDiskTotalSpace": agnDiskTotalSpace,
       "agnDiskAvailableSpace": agnDiskAvailableSpace,
       "systemResourcesTable": systemResourcesTable,
       "systemResourcesEntry": systemResourcesEntry,
       "systemResourceId": systemResourceId,
       "systemResourceLastError": systemResourceLastError,
       "memoryUsageTable": memoryUsageTable,
       "memoryUsageEntry": memoryUsageEntry,
       "memoryUsageEntityId": memoryUsageEntityId,
       "memoryUsagePoolId": memoryUsagePoolId,
       "memoryUsagePoolName": memoryUsagePoolName,
       "memoryUsageTotal": memoryUsageTotal,
       "memoryUsageFree": memoryUsageFree,
       "memoryUsageApplicAllocCounter": memoryUsageApplicAllocCounter,
       "memoryUsageApplicFreeCounter": memoryUsageApplicFreeCounter,
       "memoryUsageApplicMaxUsed": memoryUsageApplicMaxUsed,
       "memoryUsageApplicAllocSize": memoryUsageApplicAllocSize,
       "memoryUsageApplicFreedSize": memoryUsageApplicFreedSize,
       "entityConvertIndexTable": entityConvertIndexTable,
       "entityConvertIndexEntry": entityConvertIndexEntry,
       "entityConvertEntityType": entityConvertEntityType,
       "entityConvertIndex": entityConvertIndex,
       "entityConvertRowStatus": entityConvertRowStatus,
       "entityConvertParam1": entityConvertParam1,
       "entityConvertParam2": entityConvertParam2,
       "entityConvertParam3": entityConvertParam3,
       "entityConvertParam4": entityConvertParam4,
       "entityConvertParam5": entityConvertParam5,
       "agnFiles": agnFiles,
       "fileSystemTable": fileSystemTable,
       "fileSystemEntry": fileSystemEntry,
       "fileSystemPath": fileSystemPath,
       "fileSystemObjType": fileSystemObjType,
       "fileSystemObjName": fileSystemObjName,
       "fileSystemRowStatus": fileSystemRowStatus,
       "fileSystemSignatureBoot": fileSystemSignatureBoot,
       "fileSystemSignatureTime": fileSystemSignatureTime,
       "fileSystemLastUpdateTime": fileSystemLastUpdateTime,
       "fileSystemLastUpdateBootSignature": fileSystemLastUpdateBootSignature,
       "fileSystemLastUpdateTimeSignature": fileSystemLastUpdateTimeSignature,
       "fileSystemFileSize": fileSystemFileSize,
       "fileSystemValidIndication": fileSystemValidIndication,
       "fileChangeStatus": fileChangeStatus,
       "configLoadTable": configLoadTable,
       "configLoadEntry": configLoadEntry,
       "configLoadIndex": configLoadIndex,
       "configLoadConfirmReq": configLoadConfirmReq,
       "configLoadConfirmConf": configLoadConfirmConf,
       "configLoadConfirmTimer": configLoadConfirmTimer,
       "configLoadRollbackFilePath": configLoadRollbackFilePath,
       "configLoadRollbackFileName": configLoadRollbackFileName,
       "configLoadErrorPolicy": configLoadErrorPolicy,
       "configLoadObjType": configLoadObjType,
       "configLoadZtcStartupConfigVersion": configLoadZtcStartupConfigVersion,
       "agnErrorMessageTable": agnErrorMessageTable,
       "agnErrorMessageEntry": agnErrorMessageEntry,
       "agnErrorMessageSeqId": agnErrorMessageSeqId,
       "agnErrorMessage": agnErrorMessage,
       "agnCapabilities": agnCapabilities,
       "agnCommonCapabilities": agnCommonCapabilities,
       "agnCommonFeatureAvailability": agnCommonFeatureAvailability,
       "agnThreshold": agnThreshold,
       "agnThresholdTable": agnThresholdTable,
       "agnThresholdEntry": agnThresholdEntry,
       "agnThresholdIdx": agnThresholdIdx,
       "agnThresholdUom": agnThresholdUom,
       "agnThresholdMin": agnThresholdMin,
       "agnThresholdMax": agnThresholdMax,
       "agnThresholdHysteresis": agnThresholdHysteresis,
       "agnThresholdCurrent": agnThresholdCurrent,
       ...
       "agnLldp": agnLldp,
       "agnLldpTable": agnLldpTable,
       "agnLldpEntry": agnLldpEntry,
       "lldpIndex": lldpIndex,
       "lldpAdminStatus": lldpAdminStatus,
       "lldpSysBridgeType": lldpSysBridgeType,
       "agnPanelType": agnPanelType,
       "agnScalarObjects": agnScalarObjects,
       "agnDscp": agnDscp,
       ...
       "alarmEventAttrTable": alarmEventAttrTable,
       "alarmEventAttrEntry": alarmEventAttrEntry,
       "alarmEventAttrIndex": alarmEventAttrIndex,
       "alarmEventAttrSourceType": alarmEventAttrSourceType,
       "alarmEventAttrName": alarmEventAttrName,
       "alarmEventAttrDescription": alarmEventAttrDescription,
       "alarmEventAttrDefaultSeverity": alarmEventAttrDefaultSeverity,
       "alarmEventAttrDefaultMasking": alarmEventAttrDefaultMasking,
       "alarmEventAttrThresholdSupport": alarmEventAttrThresholdSupport,
       "alarmEventAttrAssociatedNotification": alarmEventAttrAssociatedNotification,
       "activeAlarmTable": activeAlarmTable,
       "activeAlarmEntry": activeAlarmEntry,
       "activeAlarmSourceId": activeAlarmSourceId,
       "activeAlarmIndex": activeAlarmIndex,
       "activeAlarmDateAndTime": activeAlarmDateAndTime,
       "activeAlarmId": activeAlarmId,
       "activeAlarmDescription": activeAlarmDescription,
       "activeAlarmSourceType": activeAlarmSourceType,
       "activeAlarmSeverity": activeAlarmSeverity,
       "activeAlarmMasking": activeAlarmMasking,
       "activeAlarmSourceName": activeAlarmSourceName,
       "activeAlarmRebuild": activeAlarmRebuild,
       "alarmEventConfigTable": alarmEventConfigTable,
       "alarmEventConfigEntry": alarmEventConfigEntry,
       "alarmEventConfigId": alarmEventConfigId,
       "alarmEventConfigSourceType": alarmEventConfigSourceType,
       "alarmEventConfigSourceId": alarmEventConfigSourceId,
       "alarmEventConfigSeverity": alarmEventConfigSeverity,
       "alarmEventConfigMasking": alarmEventConfigMasking,
       "alarmEventConfigRowStatus": alarmEventConfigRowStatus,
       "alarmEventConfigSourceName": alarmEventConfigSourceName,
       "alarmEventLogClear": alarmEventLogClear,
       "maskReportTable": maskReportTable,
       "maskReportEntry": maskReportEntry,
       "maskReportType": maskReportType,
       "maskReportSeverity": maskReportSeverity,
       "alarmLedMinSeverity": alarmLedMinSeverity,
       "alarmEventConvertNameToIdTable": alarmEventConvertNameToIdTable,
       "alarmEventConvertNameToIdEntry": alarmEventConvertNameToIdEntry,
       "alarmEventConvertName": alarmEventConvertName,
       "alarmEventConvertSourceType": alarmEventConvertSourceType,
       "alarmEventConvertId": alarmEventConvertId,
       "alarmRelayInputTable": alarmRelayInputTable,
       "alarmRelayInputEntry": alarmRelayInputEntry,
       "alarmRelayInputRelayIndex": alarmRelayInputRelayIndex,
       "alarmRelayInputDescription": alarmRelayInputDescription,
       "alarmRelayInputActiveState": alarmRelayInputActiveState,
       "alarmRelayInputOperState": alarmRelayInputOperState,
       "alarmRelayOutputTable": alarmRelayOutputTable,
       "alarmRelayOutputEntry": alarmRelayOutputEntry,
       "alarmRelayOutputRelayIndex": alarmRelayOutputRelayIndex,
       "alarmRelayOutputEnergized": alarmRelayOutputEnergized,
       "alarmRelayOutputOperState": alarmRelayOutputOperState,
       "alarmRelayOutputCmd": alarmRelayOutputCmd,
       "alarmBindToRelayTable": alarmBindToRelayTable,
       "alarmBindToRelayEntry": alarmBindToRelayEntry,
       "alarmBindToRelayIndex": alarmBindToRelayIndex,
       "alarmBindToRelayRowStatus": alarmBindToRelayRowStatus,
       "alarmBindToRelaySourceType": alarmBindToRelaySourceType,
       "alarmBindToRelaySourceId": alarmBindToRelaySourceId,
       "alarmBindToRelayAlarmId": alarmBindToRelayAlarmId,
       "defectSoakTable": defectSoakTable,
       "defectSoakEntry": defectSoakEntry,
       "defectSoakTechnology": defectSoakTechnology,
       "defectSoakInterval": defectSoakInterval,
       "defectSoakClearInterval": defectSoakClearInterval,
       "alarmEventConfiguredTable": alarmEventConfiguredTable,
       "alarmEventConfiguredEntry": alarmEventConfiguredEntry,
       "alarmEventConfiguredSourceType": alarmEventConfiguredSourceType,
       "alarmEventConfiguredSourceId": alarmEventConfiguredSourceId,
       "alarmEventConfiguredId": alarmEventConfiguredId,
       "alarmEventConfiguredSeverity": alarmEventConfiguredSeverity,
       "alarmEventConfiguredMasking": alarmEventConfiguredMasking,
       "alarmEventLogFileTimestampType": alarmEventLogFileTimestampType,
       "alarmEventLog": alarmEventLog,
       "alarmEventLogTable": alarmEventLogTable,
       "alarmEventLogEntry": alarmEventLogEntry,
       "alarmEventLogIndex": alarmEventLogIndex,
       "alarmEventLogDateAndTime": alarmEventLogDateAndTime,
       "alarmEventLogAlarmOrEventId": alarmEventLogAlarmOrEventId,
       "alarmEventLogDescription": alarmEventLogDescription,
       "alarmEventLogSourceId": alarmEventLogSourceId,
       "alarmEventLogSourceType": alarmEventLogSourceType,
       "alarmEventLogSeverity": alarmEventLogSeverity,
       "alarmEventProperties": alarmEventProperties,
       "alarmEventReason": alarmEventReason,
       "alarmEventLogSourceName": alarmEventLogSourceName,
       "alarmEventLogAckTable": alarmEventLogAckTable,
       "alarmEventLogAckEntry": alarmEventLogAckEntry,
       "alarmEventLogAckIndex": alarmEventLogAckIndex,
       "alarmEventLogAckCmd": alarmEventLogAckCmd,
       "alarmEventLogAckTime": alarmEventLogAckTime,
       "alarmEventStatistics": alarmEventStatistics,
       "alarmEventBriefLogTable": alarmEventBriefLogTable,
       "alarmEventBriefLogEntry": alarmEventBriefLogEntry,
       "alarmEventBriefLogSourceType": alarmEventBriefLogSourceType,
       "alarmEventBriefLogSourceId": alarmEventBriefLogSourceId,
       "alarmEventBriefLogAlarmId": alarmEventBriefLogAlarmId,
       "alarmEventBriefLogAlarmSeverity": alarmEventBriefLogAlarmSeverity,
       "alarmEventBriefLogTotalRaised": alarmEventBriefLogTotalRaised,
       "alarmEventBriefLogTotalRaisedSinceAck": alarmEventBriefLogTotalRaisedSinceAck,
       "alarmEventBriefLogLastRaisedTime": alarmEventBriefLogLastRaisedTime,
       "alarmEventBriefLogLastRaisedTimeSinceAck": alarmEventBriefLogLastRaisedTimeSinceAck,
       "alarmEventBriefLogLastClearedTime": alarmEventBriefLogLastClearedTime,
       "alarmEventBriefLogLastClearedTimeSinceAck": alarmEventBriefLogLastClearedTimeSinceAck,
       "alarmEventBriefLogSourceName": alarmEventBriefLogSourceName,
       "alarmEventStatsTable": alarmEventStatsTable,
       "alarmEventStatsEntry": alarmEventStatsEntry,
       "alarmEventStatsType": alarmEventStatsType,
       "alarmEventStatsTotalCritical": alarmEventStatsTotalCritical,
       "alarmEventStatsTotalMajor": alarmEventStatsTotalMajor,
       "alarmEventStatsTotalMinor": alarmEventStatsTotalMinor,
       "alarmEventStatsTotalEvents": alarmEventStatsTotalEvents,
       "radGenAll": radGenAll,
       "sfp": sfp,
