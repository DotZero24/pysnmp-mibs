...
mibBuilder.exportSymbols("EXTREME-STACKING-MIB", extremeStackingPortLinkSpeed=extremeStackingPortLinkSpeed, extremeStackingPortEntry=extremeStackingPortEntry, extremeStackMemberMACAddress=extremeStackMemberMACAddress, extremeStackMemberCurConfig=extremeStackMemberCurConfig, extremeStackMemberOperStatus=extremeStackMemberOperStatus, extremeStackMemberStackStatus=extremeStackMemberStackStatus, PYSNMP_MODULE_ID=extremeStackable, extremeStackMemberAutoConfig=extremeStackMemberAutoConfig, extremeStackMemberMgmtIpAddress=extremeStackMemberMgmtIpAddress, extremeStackMemberSlotId=extremeStackMemberSlotId, extremeStackMemberImageBooted=extremeStackMemberImageBooted, extremeStackableTraps=extremeStackableTraps, extremeStackMemberEntry=extremeStackMemberEntry, extremeStackMemberEntPhysicalIndex=extremeStackMemberEntPhysicalIndex, extremeStackMemberRole=extremeStackMemberRole, extremeStackMemberBootRomVersion=extremeStackMemberBootRomVersion, extremeStackMemberImageSelected=extremeStackMemberImageSelected, extremeStackMemberBootTime=extremeStackMemberBootTime, extremeStackingPortIfIndex=extremeStackingPortIfIndex, extremeStackingPortStatusChanged=extremeStackingPortStatusChanged, extremeStackTrapsPrefix=extremeStackTrapsPrefix, extremeStackMemberSysLocation=extremeStackMemberSysLocation, extremeStackMemberCurImageVersion=extremeStackMemberCurImageVersion, extremeStackMemberPriImageVersion=extremeStackMemberPriImageVersion, extremeStackMemberTable=extremeStackMemberTable, extremeStackingPortTable=extremeStackingPortTable, extremeStackMemberStatusChanged=extremeStackMemberStatusChanged, extremeStackMemberSecImageVersion=extremeStackMemberSecImageVersion, extremeStackDetection=extremeStackDetection, extremeStackable=extremeStackable, extremeStackMemberConfigSelected=extremeStackMemberConfigSelected, extremeStackMemberStackPriority=extremeStackMemberStackPriority, extremeStackMemberOverheat=extremeStackMemberOverheat, extremeStackMemberType=extremeStackMemberType, extremeStackingPortRemoteMac=extremeStackingPortRemoteMac, extremeStackingPortLinkStatus=extremeStackingPortLinkStatus)
