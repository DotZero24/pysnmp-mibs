...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CALL-TRACKER-MIB
...
cctMIBCompliance.setObjects(
      *(("CISCO-CALL-TRACKER-MIB", "cctGeneralGroup"),
        ("CISCO-CALL-TRACKER-MIB", "cctActiveGroup"),
        ("CISCO-CALL-TRACKER-MIB", "cctHistoryGroup"),
        ("CISCO-CALL-TRACKER-MIB", "cctNotificationConfigGroup"),
        ("CISCO-CALL-TRACKER-MIB", "cctNotificationGroup"))
)
if mibBuilder.loadTexts:
...
cctMIBComplianceRev1.setObjects(
      *(("CISCO-CALL-TRACKER-MIB", "cctGeneralGroup"),
        ("CISCO-CALL-TRACKER-MIB", "cctActiveGroupRev1"),
        ("CISCO-CALL-TRACKER-MIB", "cctHistoryGroupRev1"),
        ("CISCO-CALL-TRACKER-MIB", "cctNotificationConfigGroup"),
        ("CISCO-CALL-TRACKER-MIB", "cctNotificationGroup"))
)
if mibBuilder.loadTexts:
