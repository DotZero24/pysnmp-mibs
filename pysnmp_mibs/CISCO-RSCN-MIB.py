...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-RSCN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:24:28 2025
...
_RscnIlsRejectReqNotifyEnable_Type.__name__ = "TruthValue"
...
_RscnElsRejectReqNotifyEnable_Type.__name__ = "TruthValue"
...
_RscnMultiPidEnable_Type.__name__ = "TruthValue"
...
_RscnIlsRxRejectReqNotifyEnable_Type.__name__ = "TruthValue"
...
_RscnElsRxRejectReqNotifyEnable_Type.__name__ = "TruthValue"
...
rscnMIBCompliance.setObjects(
      *(("CISCO-RSCN-MIB", "rscnConfigGroup"),
        ("CISCO-RSCN-MIB", "rscnStatsGroup"),
        ("CISCO-RSCN-MIB", "rscnNotifyControlGroup"),
        ("CISCO-RSCN-MIB", "rscnNotifyGroup"))
)
if mibBuilder.loadTexts:
...
rscnMIBComplianceRev1.setObjects(
      *(("CISCO-RSCN-MIB", "rscnConfigGroupRev1"),
        ("CISCO-RSCN-MIB", "rscnStatsGroup"),
        ("CISCO-RSCN-MIB", "rscnNotifyControlGroup"),
        ("CISCO-RSCN-MIB", "rscnNotifyGroup"))
)
...
rscnMIBComplianceRev2.setObjects(
      *(("CISCO-RSCN-MIB", "rscnConfigGroupRev1"),
        ("CISCO-RSCN-MIB", "rscnStatsGroup"),
        ("CISCO-RSCN-MIB", "rscnNotifyControlGroup"),
        ("CISCO-RSCN-MIB", "rscnNotifyGroup"),
        ("CISCO-RSCN-MIB", "rscnConfigGroupRev1Sup1"))
)
if mibBuilder.loadTexts:
...
rscnMIBComplianceRev3.setObjects(
      *(("CISCO-RSCN-MIB", "rscnConfigGroupRev1"),
        ("CISCO-RSCN-MIB", "rscnStatsGroup"),
        ("CISCO-RSCN-MIB", "rscnNotifyControlGroup"),
        ("CISCO-RSCN-MIB", "rscnNotifyGroup"),
        ("CISCO-RSCN-MIB", "rscnConfigGroupRev1Sup1"),
        ("CISCO-RSCN-MIB", "rscnRejectNotifyGroup"),
        ("CISCO-RSCN-MIB", "rscnNotifyControlGroupSup1"))
)
if mibBuilder.loadTexts:
