...
swPortTrunkPackage=_SwPortTrunkPackage_ObjectIdentity((1,3,6,1,4,1,232,161,3,2,1))
_SwPortTrunkMaxEntries_Type=Integer32
_SwPortTrunkMaxEntries_Object=MibScalar
swPortTrunkMaxEntries=_SwPortTrunkMaxEntries_Object((1,3,6,1,4,1,232,161,3,2,1,1),_SwPortTrunkMaxEntries_Type())
...
swPortTrunkMaxPortMembers=_SwPortTrunkMaxPortMembers_Object((1,3,6,1,4,1,232,161,3,2,1,2),_SwPortTrunkMaxPortMembers_Type())
...
swPortTrunkTable=_SwPortTrunkTable_Object((1,3,6,1,4,1,232,161,3,2,1,3))
if mibBuilder.loadTexts:swPortTrunkTable.setStatus(_A)
_SwPortTrunkEntry_Object=MibTableRow
swPortTrunkEntry=_SwPortTrunkEntry_Object((1,3,6,1,4,1,232,161,3,2,1,3,1))
...
swPortTrunkIndex=_SwPortTrunkIndex_Object((1,3,6,1,4,1,232,161,3,2,1,3,1,1),_SwPortTrunkIndex_Type())
...
swPortTrunkName=_SwPortTrunkName_Object((1,3,6,1,4,1,232,161,3,2,1,3,1,2),_SwPortTrunkName_Type())
...
swPortTrunkMasterPort=_SwPortTrunkMasterPort_Object((1,3,6,1,4,1,232,161,3,2,1,3,1,3),_SwPortTrunkMasterPort_Type())
...
swPortTrunkPortList=_SwPortTrunkPortList_Object((1,3,6,1,4,1,232,161,3,2,1,3,1,4),_SwPortTrunkPortList_Type())
...
swPortTrunkState=_SwPortTrunkState_Object((1,3,6,1,4,1,232,161,3,2,1,3,1,5),_SwPortTrunkState_Type())
...
swPortMirrorPackage=_SwPortMirrorPackage_ObjectIdentity((1,3,6,1,4,1,232,161,3,2,2))
_SwPortMirrorMaxEntries_Type=Integer32
_SwPortMirrorMaxEntries_Object=MibScalar
swPortMirrorMaxEntries=_SwPortMirrorMaxEntries_Object((1,3,6,1,4,1,232,161,3,2,2,1),_SwPortMirrorMaxEntries_Type())
...
swPortMirrorCtrlTable=_SwPortMirrorCtrlTable_Object((1,3,6,1,4,1,232,161,3,2,2,2))
if mibBuilder.loadTexts:swPortMirrorCtrlTable.setStatus(_A)
_SwPortMirrorCtrlEntry_Object=MibTableRow
swPortMirrorCtrlEntry=_SwPortMirrorCtrlEntry_Object((1,3,6,1,4,1,232,161,3,2,2,2,1))
...
swPortMirrorIndex=_SwPortMirrorIndex_Object((1,3,6,1,4,1,232,161,3,2,2,2,1,1),_SwPortMirrorIndex_Type())
...
swPortMirrorSourcePort=_SwPortMirrorSourcePort_Object((1,3,6,1,4,1,232,161,3,2,2,2,1,2),_SwPortMirrorSourcePort_Type())
...
swPortMirrorTargetPort=_SwPortMirrorTargetPort_Object((1,3,6,1,4,1,232,161,3,2,2,2,1,3),_SwPortMirrorTargetPort_Type())
...
swPortMirrorDirection=_SwPortMirrorDirection_Object((1,3,6,1,4,1,232,161,3,2,2,2,1,4),_SwPortMirrorDirection_Type())
...
swPortMirrorState=_SwPortMirrorState_Object((1,3,6,1,4,1,232,161,3,2,2,2,1,5),_SwPortMirrorState_Type())
...
swIGMPPackage=_SwIGMPPackage_ObjectIdentity((1,3,6,1,4,1,232,161,3,2,3))
...
swIGMPCtrlStatus=_SwIGMPCtrlStatus_Object((1,3,6,1,4,1,232,161,3,2,3,1),_SwIGMPCtrlStatus_Type())
...
swIGMPCtrlMaxEntries=_SwIGMPCtrlMaxEntries_Object((1,3,6,1,4,1,232,161,3,2,3,2),_SwIGMPCtrlMaxEntries_Type())
...
swIGMPCtrlTable=_SwIGMPCtrlTable_Object((1,3,6,1,4,1,232,161,3,2,3,3))
if mibBuilder.loadTexts:swIGMPCtrlTable.setStatus(_A)
_SwIGMPCtrlEntry_Object=MibTableRow
swIGMPCtrlEntry=_SwIGMPCtrlEntry_Object((1,3,6,1,4,1,232,161,3,2,3,3,1))
...
swIGMPCtrlVid=_SwIGMPCtrlVid_Object((1,3,6,1,4,1,232,161,3,2,3,3,1,1),_SwIGMPCtrlVid_Type())
...
swIGMPQueryInterval=_SwIGMPQueryInterval_Object((1,3,6,1,4,1,232,161,3,2,3,3,1,2),_SwIGMPQueryInterval_Type())
...
swIGMPQueryMaxResponseTime=_SwIGMPQueryMaxResponseTime_Object((1,3,6,1,4,1,232,161,3,2,3,3,1,3),_SwIGMPQueryMaxResponseTime_Type())
...
swIGMPRobustness=_SwIGMPRobustness_Object((1,3,6,1,4,1,232,161,3,2,3,3,1,4),_SwIGMPRobustness_Type())
...
swIGMPCtrlTimer=_SwIGMPCtrlTimer_Object((1,3,6,1,4,1,232,161,3,2,3,3,1,5),_SwIGMPCtrlTimer_Type())
...
swIGMPQuerierVersion=_SwIGMPQuerierVersion_Object((1,3,6,1,4,1,232,161,3,2,3,3,1,6),_SwIGMPQuerierVersion_Type())
...
swIGMPCtrlState=_SwIGMPCtrlState_Object((1,3,6,1,4,1,232,161,3,2,3,3,1,7),_SwIGMPCtrlState_Type())
...
swIGMPIfnoMaxEntries=_SwIGMPIfnoMaxEntries_Object((1,3,6,1,4,1,232,161,3,2,3,4),_SwIGMPIfnoMaxEntries_Type())
...
swIGMPInfoTable=_SwIGMPInfoTable_Object((1,3,6,1,4,1,232,161,3,2,3,5))
if mibBuilder.loadTexts:swIGMPInfoTable.setStatus(_A)
_SwIGMPInfoEntry_Object=MibTableRow
swIGMPInfoEntry=_SwIGMPInfoEntry_Object((1,3,6,1,4,1,232,161,3,2,3,5,1))
...
swIGMPInfoVid=_SwIGMPInfoVid_Object((1,3,6,1,4,1,232,161,3,2,3,5,1,1),_SwIGMPInfoVid_Type())
...
swIGMPInfoQueryCount=_SwIGMPInfoQueryCount_Object((1,3,6,1,4,1,232,161,3,2,3,5,1,2),_SwIGMPInfoQueryCount_Type())
...
swIGMPInfoTxQueryCount=_SwIGMPInfoTxQueryCount_Object((1,3,6,1,4,1,232,161,3,2,3,5,1,3),_SwIGMPInfoTxQueryCount_Type())
...
swIGMPTableMaxEntries=_SwIGMPTableMaxEntries_Object((1,3,6,1,4,1,232,161,3,2,3,6),_SwIGMPTableMaxEntries_Type())
...
swIGMPTable=_SwIGMPTable_Object((1,3,6,1,4,1,232,161,3,2,3,7))
if mibBuilder.loadTexts:swIGMPTable.setStatus(_A)
_SwIGMPEntry_Object=MibTableRow
swIGMPEntry=_SwIGMPEntry_Object((1,3,6,1,4,1,232,161,3,2,3,7,1))
...
swIGMPVid=_SwIGMPVid_Object((1,3,6,1,4,1,232,161,3,2,3,7,1,1),_SwIGMPVid_Type())
...
swIGMPGroupIpAddr=_SwIGMPGroupIpAddr_Object((1,3,6,1,4,1,232,161,3,2,3,7,1,2),_SwIGMPGroupIpAddr_Type())
...
swIGMPMacAddr=_SwIGMPMacAddr_Object((1,3,6,1,4,1,232,161,3,2,3,7,1,3),_SwIGMPMacAddr_Type())
...
swIGMPPortMap=_SwIGMPPortMap_Object((1,3,6,1,4,1,232,161,3,2,3,7,1,4),_SwIGMPPortMap_Type())
