...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/rfc/VDSL-LINE-MIB
...
HCPerfTimeElapsed, HCPerfCurrentCount, HCPerfIntervalThreshold, HCPerfInvalidIntervals, HCPerfIntervalCount, HCPerfValidIntervals = mibBuilder.importSymbols("HC-PerfHist-TC-MIB", "HCPerfTimeElapsed", "HCPerfCurrentCount", "HCPerfIntervalThreshold", "HCPerfInvalidIntervals", "HCPerfIntervalCount", "HCPerfValidIntervals")
...
mibBuilder.exportSymbols("VDSL-LINE-MIB", vdslPerfDataCurr15MinLofs=vdslPerfDataCurr15MinLofs, vdslLineConfUpRateRatio=vdslLineConfUpRateRatio, vdslPerfIntervalSESs=vdslPerfIntervalSESs, vdslPhysInvVendorID=vdslPhysInvVendorID, vdslLineType=vdslLineType, vdslPerfDataUASs=vdslPerfDataUASs, vdslLineConfDownMaxFastFec=vdslLineConfDownMaxFastFec, vdslPhysCurrOutputPwr=vdslPhysCurrOutputPwr, vdslLineConfDownRateRatio=vdslLineConfDownRateRatio, vdslPerf1DayIntervalEntry=vdslPerf1DayIntervalEntry, vdslPerf1DayIntervalLprs=vdslPerf1DayIntervalLprs, vdslPerfSESsThreshNotification=vdslPerfSESsThreshNotification, vdslLineCoding=vdslLineCoding, vdslLineConfDownMaxInterDelay=vdslLineConfDownMaxInterDelay, vdslPerf1DayIntervalTable=vdslPerf1DayIntervalTable, vdslPerfDataLoss=vdslPerfDataLoss, vdslChanCurr1DayTimeElapsed=vdslChanCurr1DayTimeElapsed, vdslPhysCurrAttainableRate=vdslPhysCurrAttainableRate, vdslLineConfUpTargetSnrMgn=vdslLineConfUpTargetSnrMgn, vdslPerfDataCurr1DayLoss=vdslPerfDataCurr1DayLoss, vdslPhysEntry=vdslPhysEntry, vdslPerfDataSESs=vdslPerfDataSESs, vdslChan1DayIntervalMoniSecs=vdslChan1DayIntervalMoniSecs, vdslPhysSide=vdslPhysSide, vdslPerfDataCurr15MinLoss=vdslPerfDataCurr15MinLoss, vdslPerfDataInits=vdslPerfDataInits, vdslLineConfUpMaxInterDelay=vdslLineConfUpMaxInterDelay, vdslPerfESsThreshNotification=vdslPerfESsThreshNotification, vdslPerf1DayIntervalLols=vdslPerf1DayIntervalLols, vdslNotificationGroup=vdslNotificationGroup, vdslLineConfCustomNotch2Start=vdslLineConfCustomNotch2Start, vdslLineConfDownFastMaxDataRate=vdslLineConfDownFastMaxDataRate, vdslLineConfDownSlowMinDataRate=vdslLineConfDownSlowMinDataRate, vdslLineConfDownMaxPwr=vdslLineConfDownMaxPwr, vdslLineConfDownPboLevel=vdslLineConfDownPboLevel, vdslPerfUASsThreshNotification=vdslPerfUASsThreshNotification, vdslLineAlarmConfProfile=vdslLineAlarmConfProfile, VdslLineEntity=VdslLineEntity, vdslChanBadBlks=vdslChanBadBlks, vdslLineConfHamBandMask=vdslLineConfHamBandMask, vdslMibObjects=vdslMibObjects, vdslGroup=vdslGroup, vdslPhysCurrAtn=vdslPhysCurrAtn, vdslPerfDataCurr1DayTimeElapsed=vdslPerfDataCurr1DayTimeElapsed, vdslLineConfCustomNotch1Start=vdslLineConfCustomNotch1Start, vdslPerfDataCurr15MinLols=vdslPerfDataCurr15MinLols, vdslPerfDataESs=vdslPerfDataESs, vdslChanEntry=vdslChanEntry, vdslPerfData1DayValidIntervals=vdslPerfData1DayValidIntervals, VdslLineCodingType=VdslLineCodingType, vdslLineEntry=vdslLineEntry, vdslLineConfUpPboControl=vdslLineConfUpPboControl, vdslDownMinSnrMgnNotification=vdslDownMinSnrMgnNotification, vdslLineConfDeploymentScenario=vdslLineConfDeploymentScenario, vdslPerf1DayIntervalNumber=vdslPerf1DayIntervalNumber, vdslPerfDataLprs=vdslPerfDataLprs, vdslLineConfUpPsdTemplate=vdslLineConfUpPsdTemplate, vdslChanInterleaveDelay=vdslChanInterleaveDelay, vdslPerf1DayIntervalLofs=vdslPerf1DayIntervalLofs, vdslPerfDataCurr1DaySESs=vdslPerfDataCurr1DaySESs, vdslPerfDataCurr1DayESs=vdslPerfDataCurr1DayESs, vdslChanPerfDataTable=vdslChanPerfDataTable, vdslChan1DayInvalidIntervals=vdslChan1DayInvalidIntervals, vdslPerfDataCurr1DayLols=vdslPerfDataCurr1DayLols, vdslLineConfUpFastMaxDataRate=vdslLineConfUpFastMaxDataRate, vdslPerfDataCurr15MinESs=vdslPerfDataCurr15MinESs, vdslLineMibCompliance=vdslLineMibCompliance, vdslLineAlarmConfThresh15MinLofs=vdslLineAlarmConfThresh15MinLofs, vdslPerfIntervalLoss=vdslPerfIntervalLoss, vdslLineAlarmConfThresh15MinLoss=vdslLineAlarmConfThresh15MinLoss, vdslChanValidIntervals=vdslChanValidIntervals, vdslLineConfDownSlowMaxDataRate=vdslLineConfDownSlowMaxDataRate, vdslChanInvalidIntervals=vdslChanInvalidIntervals, vdslPerfLofsThreshNotification=vdslPerfLofsThreshNotification, vdslLineConfUpMaxFastFec=vdslLineConfUpMaxFastFec, vdslChanIntervalBadBlks=vdslChanIntervalBadBlks, vdslPerfDataLols=vdslPerfDataLols, vdslLineConfUpMaxSnrMgn=vdslLineConfUpMaxSnrMgn, vdslPerfDataValidIntervals=vdslPerfDataValidIntervals, vdslChanPerfDataEntry=vdslChanPerfDataEntry, vdslPerfDataLofs=vdslPerfDataLofs, vdslChanFixedOctets=vdslChanFixedOctets, vdslMIB=vdslMIB, vdslLineAlarmConfThresh15MinESs=vdslLineAlarmConfThresh15MinESs, vdslPhysCurrStatus=vdslPhysCurrStatus, vdslLineConfUpSlowMaxDataRate=vdslLineConfUpSlowMaxDataRate, vdslPerfDataInvalidIntervals=vdslPerfDataInvalidIntervals, vdslChanCurr15MinTimeElapsed=vdslChanCurr15MinTimeElapsed, vdslChanIntervalEntry=vdslChanIntervalEntry, vdslLineConfProfileName=vdslLineConfProfileName, vdslPerfIntervalNumber=vdslPerfIntervalNumber, vdslPerf1DayIntervalUASs=vdslPerf1DayIntervalUASs, vdslPhysTable=vdslPhysTable, vdslLineConfUpRateMode=vdslLineConfUpRateMode, vdslChan1DayIntervalEntry=vdslChan1DayIntervalEntry, vdslLineConfLineType=vdslLineConfLineType, vdslLineConfDownMinSnrMgn=vdslLineConfDownMinSnrMgn, vdslPerfIntervalLofs=vdslPerfIntervalLofs, vdslPerfIntervalLols=vdslPerfIntervalLols, vdslChanCurrTxFastFec=vdslChanCurrTxFastFec, vdslLineConfProfRowStatus=vdslLineConfProfRowStatus, vdslLineAlarmConfProfileName=vdslLineAlarmConfProfileName, vdslPerf1DayIntervalESs=vdslPerf1DayIntervalESs, vdslPhysInvVersionNumber=vdslPhysInvVersionNumber, vdslChanCurr15MinBadBlks=vdslChanCurr15MinBadBlks, vdslChanIntervalFixedOctets=vdslChanIntervalFixedOctets, vdslPerfLossThreshNotification=vdslPerfLossThreshNotification, vdslPerfDataCurr15MinSESs=vdslPerfDataCurr15MinSESs, vdslUpMaxSnrMgnNotification=vdslUpMaxSnrMgnNotification, vdslChan1DayValidIntervals=vdslChan1DayValidIntervals, vdslLineConfUpPboLevel=vdslLineConfUpPboLevel, vdslLineAlarmConfProfileTable=vdslLineAlarmConfProfileTable, vdslLineConfProfileEntry=vdslLineConfProfileEntry, vdslLineConfCustomNotch2Stop=vdslLineConfCustomNotch2Stop, vdslLineAlarmConfThresh15MinLols=vdslLineAlarmConfThresh15MinLols, vdslPerfDataEntry=vdslPerfDataEntry, vdslLineAlarmConfProfileEntry=vdslLineAlarmConfProfileEntry, vdslLineConfBandPlan=vdslLineConfBandPlan, vdslLineConfUpMinSnrMgn=vdslLineConfUpMinSnrMgn, vdslPerfIntervalESs=vdslPerfIntervalESs, vdslLineConfDownRateMode=vdslLineConfDownRateMode, vdslPerfDataCurr15MinInits=vdslPerfDataCurr15MinInits, vdslLineConfApplicableStandard=vdslLineConfApplicableStandard, vdslChan1DayIntervalTable=vdslChan1DayIntervalTable, vdslPerf1DayIntervalMoniSecs=vdslPerf1DayIntervalMoniSecs, vdslPerfIntervalUASs=vdslPerfIntervalUASs, vdslLineAlarmConfProfRowStatus=vdslLineAlarmConfProfRowStatus, vdslLineAlarmConfInitFailure=vdslLineAlarmConfInitFailure, vdslChanCrcBlockLength=vdslChanCrcBlockLength, vdslLineConfBandOptUsage=vdslLineConfBandOptUsage, vdslPhysCurrLineRate=vdslPhysCurrLineRate, vdslLineConfDownFastMinDataRate=vdslLineConfDownFastMinDataRate, vdslPerfIntervalEntry=vdslPerfIntervalEntry, vdslLineConfBandPlanFx=vdslLineConfBandPlanFx, vdslLineConfCustomNotch1Stop=vdslLineConfCustomNotch1Stop, vdslLineAlarmConfThresh15MinLprs=vdslLineAlarmConfThresh15MinLprs, vdslLineMib=vdslLineMib, vdslLineConfDownTargetSnrMgn=vdslLineConfDownTargetSnrMgn, vdslLineTable=vdslLineTable, vdslPerfDataCurr1DayLprs=vdslPerfDataCurr1DayLprs, vdslPerfData1DayInvalidIntervals=vdslPerfData1DayInvalidIntervals, vdslPhysInvSerialNumber=vdslPhysInvSerialNumber, vdslInitFailureNotification=vdslInitFailureNotification, vdslLineConfDownPboControl=vdslLineConfDownPboControl, vdslCompliances=vdslCompliances, vdslPerfIntervalTable=vdslPerfIntervalTable, vdslPhysCurrSnrMgn=vdslPhysCurrSnrMgn, vdslLineConfUpTargetSlowBurst=vdslLineConfUpTargetSlowBurst, vdslChanCurrTxSlowBurstProtect=vdslChanCurrTxSlowBurstProtect, vdslChanCurrTxRate=vdslChanCurrTxRate, vdslChan1DayIntervalNumber=vdslChan1DayIntervalNumber, vdslChan1DayIntervalFixedOctets=vdslChan1DayIntervalFixedOctets, vdslLineConfUpFastMinDataRate=vdslLineConfUpFastMinDataRate, vdslLineConfProfileTable=vdslLineConfProfileTable, vdslChanCurr1DayFixedOctets=vdslChanCurr1DayFixedOctets, vdslChanCurr15MinFixedOctets=vdslChanCurr15MinFixedOctets, vdslPerfDataTable=vdslPerfDataTable, vdslChanIntervalTable=vdslChanIntervalTable, vdslChanTable=vdslChanTable, vdslLineConfDownPsdTemplate=vdslLineConfDownPsdTemplate, vdslUpMinSnrMgnNotification=vdslUpMinSnrMgnNotification, vdslLineAlarmConfThresh15MinSESs=vdslLineAlarmConfThresh15MinSESs, vdslNotifications=vdslNotifications, vdslLineConfAdslPresence=vdslLineConfAdslPresence, vdslPerfDataCurr1DayInits=vdslPerfDataCurr1DayInits, vdslPerfDataCurr15MinLprs=vdslPerfDataCurr15MinLprs, vdslPerf1DayIntervalSESs=vdslPerf1DayIntervalSESs, vdslChanCurr1DayBadBlks=vdslChanCurr1DayBadBlks, vdslConformance=vdslConformance, vdslGroups=vdslGroups, vdslPerfDataCurr15MinTimeElapsed=vdslPerfDataCurr15MinTimeElapsed, vdslPerf1DayIntervalLoss=vdslPerf1DayIntervalLoss, vdslLineConfUpSlowMinDataRate=vdslLineConfUpSlowMinDataRate, vdslLineConfProfile=vdslLineConfProfile, vdslLineAlarmConfThresh15MinUASs=vdslLineAlarmConfThresh15MinUASs, vdslPerfDataCurr15MinUASs=vdslPerfDataCurr15MinUASs, PYSNMP_MODULE_ID=vdslMIB, vdslLineConfDownTargetSlowBurst=vdslLineConfDownTargetSlowBurst, vdslPerfDataCurr1DayUASs=vdslPerfDataCurr1DayUASs, vdslPerfIntervalLprs=vdslPerfIntervalLprs, vdslLineConfUpMaxPwr=vdslLineConfUpMaxPwr, vdslLineConfDownMaxSnrMgn=vdslLineConfDownMaxSnrMgn, vdslPerfLolsThreshNotification=vdslPerfLolsThreshNotification, vdslChanIntervalNumber=vdslChanIntervalNumber, vdslChan1DayIntervalBadBlks=vdslChan1DayIntervalBadBlks, vdslPerfLprsThreshNotification=vdslPerfLprsThreshNotification, vdslPerfIntervalInits=vdslPerfIntervalInits, vdslPerf1DayIntervalInits=vdslPerf1DayIntervalInits, vdslPerfDataCurr1DayLofs=vdslPerfDataCurr1DayLofs, vdslDownMaxSnrMgnNotification=vdslDownMaxSnrMgnNotification)
