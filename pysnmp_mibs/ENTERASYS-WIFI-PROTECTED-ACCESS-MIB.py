...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-WIFI-PROTECTED-ACCESS-MIB
...
etsysWpaCompliance.setObjects(
    ("ENTERASYS-WIFI-PROTECTED-ACCESS-MIB", "etsysWpaBaseGroup")
)
if mibBuilder.loadTexts:
