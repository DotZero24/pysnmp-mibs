...
mibBuilder.exportSymbols("HPN-ICF-POWER-ETH-EXT-MIB", hpnicfPOEDCOutInfoEntry=hpnicfPOEDCOutInfoEntry, hpnicfPsePolicyMode=hpnicfPsePolicyMode, hpnicfPOEDisconnectNotification=hpnicfPOEDisconnectNotification, hpnicfPOEDCOutStateTable=hpnicfPOEDCOutStateTable, SwitchState=SwitchState, hpnicfPOEACSwitchState=hpnicfPOEACSwitchState, hpnicfPOEACSwitchStateModuleNum=hpnicfPOEACSwitchStateModuleNum, hpnicfPOESMFactorName=hpnicfPOESMFactorName, hpnicfPOEACSwitchVolABNotification=hpnicfPOEACSwitchVolABNotification, hpnicfPseProfilePairs=hpnicfPseProfilePairs, hpnicfPOEACSwitchStateTable=hpnicfPOEACSwitchStateTable, hpnicfPseProfileIndex=hpnicfPseProfileIndex, hpnicfPOEModuleInfoTable=hpnicfPOEModuleInfoTable, hpnicfPOEShutdownNotification=hpnicfPOEShutdownNotification, hpnicfPOEDCOutCurNum=hpnicfPOEDCOutCurNum, hpnicfPOEInCurCState=hpnicfPOEInCurCState, hpnicfPOEInCurAState=hpnicfPOEInCurAState, hpnicfPOEACSwitchVolCANotification=hpnicfPOEACSwitchVolCANotification, hpnicfPseScalarGroup=hpnicfPseScalarGroup, hpnicfMainPsePeakPower=hpnicfMainPsePeakPower, hpnicfPOEOverTempNotification=hpnicfPOEOverTempNotification, hpnicfPOEThresholdDCMinimum=hpnicfPOEThresholdDCMinimum, PYSNMP_MODULE_ID=hpnicfPowerEthernetExt, hpnicfPOEPowerSupInfoGroup=hpnicfPOEPowerSupInfoGroup, hpnicfMainPsePriorityMode=hpnicfMainPsePriorityMode, hpnicfPOEACSwitchVolBCNotification=hpnicfPOEACSwitchVolBCNotification, hpnicfPOEAlarmModuleInfoIndex=hpnicfPOEAlarmModuleInfoIndex, hpnicfPOEPowerModuleNum=hpnicfPOEPowerModuleNum, hpnicfPseProfilePriority=hpnicfPseProfilePriority, hpnicfPsePDNotificationGroup=hpnicfPsePDNotificationGroup, hpnicfPOEModuleShutdownNotification=hpnicfPOEModuleShutdownNotification, hpnicfMainGuaranteedPowerRemaining=hpnicfMainGuaranteedPowerRemaining, hpnicfPOEOverVoltageNotification=hpnicfPOEOverVoltageNotification, hpnicfPOEModuleInfoPower=hpnicfPOEModuleInfoPower, hpnicfPOEACInCurANotification=hpnicfPOEACInCurANotification, hpnicfPOESupervisionModuleName=hpnicfPOESupervisionModuleName, hpnicfPOEAlarmStateModuleNum=hpnicfPOEAlarmStateModuleNum, hpnicfPOEPowerAlarmStateGroup=hpnicfPOEPowerAlarmStateGroup, hpnicfPOEThresholdACMimimum=hpnicfPOEThresholdACMimimum, DCAlarmState=DCAlarmState, hpnicfPOEModuleHardVerInfo=hpnicfPOEModuleHardVerInfo, hpnicfPOESwitchStateInVolAB=hpnicfPOESwitchStateInVolAB, hpnicfPOEPowerObjects=hpnicfPOEPowerObjects, hpnicfPOEPowerDCOutInfoGroup=hpnicfPOEPowerDCOutInfoGroup, hpnicfPOEACInCurCNotification=hpnicfPOEACInCurCNotification, hpnicfPOEModuleID=hpnicfPOEModuleID, hpnicfPseGroup=hpnicfPseGroup, hpnicfPOESwitchStateVolExIndex=hpnicfPOESwitchStateVolExIndex, hpnicfPOESMMajorVersion=hpnicfPOESMMajorVersion, hpnicfPOEDCOutDCVolAlarm=hpnicfPOEDCOutDCVolAlarm, hpnicfPsePortFaultDescription=hpnicfPsePortFaultDescription, hpnicfPOEDCOutVolNotification=hpnicfPOEDCOutVolNotification, hpnicfPOEPowerType=hpnicfPOEPowerType, hpnicfPOEModuleOverTemp=hpnicfPOEModuleOverTemp, hpnicfPOECurRestrictedNotification=hpnicfPOECurRestrictedNotification, hpnicfPOEModuleShutdown=hpnicfPOEModuleShutdown, hpnicfPseProfilePowerLimit=hpnicfPseProfilePowerLimit, hpnicfPseProfileApplyNum=hpnicfPseProfileApplyNum, hpnicfMainPseLegacy=hpnicfMainPseLegacy, hpnicfPOEACSwitchStateModuleObjs=hpnicfPOEACSwitchStateModuleObjs, hpnicfPOEDCOutStateEntry=hpnicfPOEDCOutStateEntry, hpnicfPOEACSwitchNotification=hpnicfPOEACSwitchNotification, ModuleAlarmState=ModuleAlarmState, hpnicfPOEAlarmStateInfoEntry=hpnicfPOEAlarmStateInfoEntry, hpnicfPOEModuleCurRestricted=hpnicfPOEModuleCurRestricted, hpnicfPOEDCOutInfoTable=hpnicfPOEDCOutInfoTable, hpnicfPOEDCOutInfoIndex=hpnicfPOEDCOutInfoIndex, hpnicfPOEACInCurBNotification=hpnicfPOEACInCurBNotification, hpnicfPOESwitchStateVolExTable=hpnicfPOESwitchStateVolExTable, hpnicfPsePortPowerLimit=hpnicfPsePortPowerLimit, hpnicfPsePortGroup=hpnicfPsePortGroup, hpnicfPOEPowerDCOutStateGroup=hpnicfPOEPowerDCOutStateGroup, hpnicfPOEDCOutStateIndex=hpnicfPOEDCOutStateIndex, hpnicfpseportNotification=hpnicfpseportNotification, hpnicfPDPolicyMode=hpnicfPDPolicyMode, hpnicfPseProfilePowerMode=hpnicfPseProfilePowerMode, hpnicfMainPseTable=hpnicfMainPseTable, hpnicfPOEModuleInfoEntry=hpnicfPOEModuleInfoEntry, hpnicfPsePowerMaxValue=hpnicfPsePowerMaxValue, hpnicfPOESMMinorVersion=hpnicfPOESMMinorVersion, hpnicfPseComformance=hpnicfPseComformance, hpnicfPOEACSwitchStateEntry=hpnicfPOEACSwitchStateEntry, hpnicfPseProfilesTable=hpnicfPseProfilesTable, hpnicfMainPsePowerLimit=hpnicfMainPsePowerLimit, hpnicfPOEACSwitchStateIndex=hpnicfPOEACSwitchStateIndex, hpnicfPOEAlarmStateObjects=hpnicfPOEAlarmStateObjects, hpnicfPOEModuleOutputError=hpnicfPOEModuleOutputError, hpnicfPOEPowerInCurStateGroup=hpnicfPOEPowerInCurStateGroup, hpnicfMainPsePowerPriority=hpnicfMainPsePowerPriority, hpnicfPsePortTable=hpnicfPsePortTable, hpnicfPOEFanErrorNotification=hpnicfPOEFanErrorNotification, hpnicfPOEAlarmStateInfoTable=hpnicfPOEAlarmStateInfoTable, hpnicfPOEDCOutInfoLoadCur=hpnicfPOEDCOutInfoLoadCur, hpnicfPOEPowerACSwitchStateModuleGroup=hpnicfPOEPowerACSwitchStateModuleGroup, hpnicfPOEDCOutStateObjects=hpnicfPOEDCOutStateObjects, hpnicfPOEInCurBState=hpnicfPOEInCurBState, hpnicfPOESwitchStateInVolCA=hpnicfPOESwitchStateInVolCA, hpnicfPseCompliances=hpnicfPseCompliances, hpnicfPseProfilesEntry=hpnicfPseProfilesEntry, hpnicfPOEThresholdDCMaximum=hpnicfPOEThresholdDCMaximum, hpnicfPsePortEntry=hpnicfPsePortEntry, hpnicfPsePortAveragePower=hpnicfPsePortAveragePower, hpnicfPseCompliance=hpnicfPseCompliance, hpnicfMainPseAveragePower=hpnicfMainPseAveragePower, ACAlarmState=ACAlarmState, hpnicfPseProfileRowStatus=hpnicfPseProfileRowStatus, hpnicfPOEInCurStateModuleNum=hpnicfPOEInCurStateModuleNum, hpnicfPseAutoDetectActive=hpnicfPseAutoDetectActive, hpnicfPOEModuleDisconnect=hpnicfPOEModuleDisconnect, hpnicfPsePortProfileIndex=hpnicfPsePortProfileIndex, hpnicfPOEOutputErrorNotification=hpnicfPOEOutputErrorNotification, hpnicfPOEModuleIndex=hpnicfPOEModuleIndex, hpnicfMainPseEntry=hpnicfMainPseEntry, hpnicfPOESupModuleInfoObjs=hpnicfPOESupModuleInfoObjs, hpnicfPOEDCOutVol=hpnicfPOEDCOutVol, hpnicfPOEDCOutInfoObjects=hpnicfPOEDCOutInfoObjects, hpnicfPsePortPeakPower=hpnicfPsePortPeakPower, hpnicfPOESwitchStateInVolBC=hpnicfPOESwitchStateInVolBC, hpnicfPOEModuleInputError=hpnicfPOEModuleInputError, hpnicfPOEModuleFanError=hpnicfPOEModuleFanError, hpnicfMainPseGroup=hpnicfMainPseGroup, hpnicfPsePortCurrentPower=hpnicfPsePortCurrentPower, hpnicfPOEInCurStateObjects=hpnicfPOEInCurStateObjects, hpnicfPowerEthernetExt=hpnicfPowerEthernetExt, hpnicfpsePDChangeNotification=hpnicfpsePDChangeNotification, hpnicfPOEModuleOverVoltage=hpnicfPOEModuleOverVoltage, hpnicfPOEDCOutStateModuleNum=hpnicfPOEDCOutStateModuleNum, hpnicfPOEThresholdACMaximum=hpnicfPOEThresholdACMaximum, hpnicfPOEInputErrorNotification=hpnicfPOEInputErrorNotification, hpnicfPseProfileName=hpnicfPseProfileName, hpnicfPseProfilesGroup=hpnicfPseProfilesGroup, hpnicfPOEThresholdLimitObjs=hpnicfPOEThresholdLimitObjs, hpnicfPOEPowerThresholdLimitGroup=hpnicfPOEPowerThresholdLimitGroup, hpnicfPOESwitchStateVolExEntry=hpnicfPOESwitchStateVolExEntry)
