...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-POWER-ETH-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:40:20 2025
...
hpnicfPseCompliance.setObjects(
      *(("HPN-ICF-POWER-ETH-EXT-MIB", "hpnicfPsePortGroup"),
        ("HPN-ICF-POWER-ETH-EXT-MIB", "hpnicfMainPseGroup"),
        ("HPN-ICF-POWER-ETH-EXT-MIB", "hpnicfPseScalarGroup"),
        ("HPN-ICF-POWER-ETH-EXT-MIB", "hpnicfPsePDNotificationGroup"),
        ("HPN-ICF-POWER-ETH-EXT-MIB", "hpnicfPseProfilesGroup"))
)
if mibBuilder.loadTexts:
