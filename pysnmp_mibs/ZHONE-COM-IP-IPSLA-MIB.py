...
# Notes
# -----
# ASN.1 source file://mibs/zhone/ZHONE-COM-IP-IPSLA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:11:40 2025
...
zhoneIpSLACompliance.setObjects(
      *(("ZHONE-COM-IP-IPSLA-MIB", "zhoneIpSLAGlobalsGroup"),
        ("ZHONE-COM-IP-IPSLA-MIB", "zhoneIpSLACosActionGroup"),
        ("ZHONE-COM-IP-IPSLA-MIB", "zhoneIpSLACOSMapGroup"),
        ("ZHONE-COM-IP-IPSLA-MIB", "zhoneIpSLAStaticPathGroup"),
        ("ZHONE-COM-IP-IPSLA-MIB", "zhoneIpSLAPathConnectGroup"),
        ("ZHONE-COM-IP-IPSLA-MIB", "zhoneIpSLAPathStatByCOSGroup"),
        ("ZHONE-COM-IP-IPSLA-MIB", "zhoneIpSLANotificationGroup"),
        ("ZHONE-COM-IP-IPSLA-MIB", "zhoneIpSLAPathStatByIntervalGroup"))
)
if mibBuilder.loadTexts:
