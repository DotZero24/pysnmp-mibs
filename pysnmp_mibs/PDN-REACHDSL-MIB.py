...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-REACHDSL-MIB
...
pdnReachDSLCompliance.setObjects(
      *(("PDN-REACHDSL-MIB", "pdnReachDSLConfigurationGroup"),
        ("PDN-REACHDSL-MIB", "pdnReachDSLInformationGroup"))
)
if mibBuilder.loadTexts:
...
pdnReachDSLCompliance1.setObjects(
      *(("PDN-REACHDSL-MIB", "pdnReachDSLGeneralConfigGroup"),
        ("PDN-REACHDSL-MIB", "pdnReachDSLGeneralInformationGroup"),
        ("PDN-REACHDSL-MIB", "pdnReachDSLEWLModeGroup"),
        ("PDN-REACHDSL-MIB", "pdnReachDSLLoopLengthModeGroup"),
