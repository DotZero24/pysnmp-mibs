...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-DHCPSNOOP-MIB
...
h3cDhcpSnoopBindingIP = _H3cDhcpSnoopBindingIP_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 36, 2, 1, 3),
    _H3cDhcpSnoopBindingIP_Type()
)
h3cDhcpSnoopBindingIP.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cDhcpSnoopBindingIP.setStatus("current")
_H3cDhcpSnoopBindingMac_Type = MacAddress
_H3cDhcpSnoopBindingMac_Object = MibScalar
h3cDhcpSnoopBindingMac = _H3cDhcpSnoopBindingMac_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 36, 2, 1, 4),
    _H3cDhcpSnoopBindingMac_Type()
)
h3cDhcpSnoopBindingMac.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cDhcpSnoopBindingMac.setStatus("current")
...
h3cDhcpSnoopNewBinding = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 36, 2, 0, 2)
)
h3cDhcpSnoopNewBinding.setObjects(
      *(("H3C-DHCPSNOOP-MIB", "h3cDhcpSnoopBindingIP"),
        ("H3C-DHCPSNOOP-MIB", "h3cDhcpSnoopBindingMac"))
)
if mibBuilder.loadTexts:
    h3cDhcpSnoopNewBinding.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"h3cDhcpSnoop": h3cDhcpSnoop,
       ...
       "h3cDhcpSnoopNewBinding": h3cDhcpSnoopNewBinding,
       ...
       "h3cDhcpSnoopBindingIP": h3cDhcpSnoopBindingIP,
       "h3cDhcpSnoopBindingMac": h3cDhcpSnoopBindingMac}
)
