...
mibBuilder.exportSymbols("PIM-MIB", pimComponentBSRAddress=pimComponentBSRAddress, pimInterfaceIfIndex=pimInterfaceIfIndex, pimNextHopGroup=pimNextHopGroup, pimInterfaceMode=pimInterfaceMode, pimRPSetGroupMask=pimRPSetGroupMask, pimRPSetHoldTime=pimRPSetHoldTime, pimNeighborLoss=pimNeighborLoss, pimMIBObjects=pimMIBObjects, pimAssertGroup=pimAssertGroup, pimComponentStatus=pimComponentStatus, pimIpMRouteTable=pimIpMRouteTable, pimInterfaceDR=pimInterfaceDR, pimRPSetComponent=pimRPSetComponent, pim=pim, pimIpMRouteAssertMetric=pimIpMRouteAssertMetric, pimInterfaceHelloInterval=pimInterfaceHelloInterval, pimIpMRouteEntry=pimIpMRouteEntry, pimRPSetExpiryTime=pimRPSetExpiryTime, pimIpMRouteNextHopEntry=pimIpMRouteNextHopEntry, pimIpMRouteFlags=pimIpMRouteFlags, pimRPSetGroupAddress=pimRPSetGroupAddress, pimComponentIndex=pimComponentIndex, pimSparseV2MIBCompliance=pimSparseV2MIBCompliance, pimV1MIBGroup=pimV1MIBGroup, pimInterfaceJoinPruneInterval=pimInterfaceJoinPruneInterval, pimNeighborMode=pimNeighborMode, pimMIBCompliances=pimMIBCompliances, pimCandidateRPGroupAddress=pimCandidateRPGroupAddress, pimNeighborIfIndex=pimNeighborIfIndex, pimInterfaceAddress=pimInterfaceAddress, pimComponentTable=pimComponentTable, pimMIB=pimMIB, pimComponentCRPHoldTime=pimComponentCRPHoldTime, pimNeighborAddress=pimNeighborAddress, pimCandidateRPAddress=pimCandidateRPAddress, pimInterfaceNetMask=pimInterfaceNetMask, pimNeighborUpTime=pimNeighborUpTime, pimNeighborExpiryTime=pimNeighborExpiryTime, pimMIBGroups=pimMIBGroups, pimComponentEntry=pimComponentEntry, pimComponentBSRExpiryTime=pimComponentBSRExpiryTime, pimRPEntry=pimRPEntry, pimIpMRouteNextHopTable=pimIpMRouteNextHopTable, PYSNMP_MODULE_ID=pimMIB, pimIpMRouteAssertRPTBit=pimIpMRouteAssertRPTBit, pimRPStateTimer=pimRPStateTimer, pimDenseV2MIBCompliance=pimDenseV2MIBCompliance, pimNotificationGroup=pimNotificationGroup, pimRPSetTable=pimRPSetTable, pimRPSetEntry=pimRPSetEntry, pimIpMRouteUpstreamAssertTimer=pimIpMRouteUpstreamAssertTimer, pimV1MIBCompliance=pimV1MIBCompliance, pimJoinPruneInterval=pimJoinPruneInterval, pimRPAddress=pimRPAddress, pimCandidateRPEntry=pimCandidateRPEntry, pimCandidateRPRowStatus=pimCandidateRPRowStatus, pimInterfaceStatus=pimInterfaceStatus, pimCandidateRPTable=pimCandidateRPTable, pimRPRowStatus=pimRPRowStatus, pimV2CandidateRPMIBGroup=pimV2CandidateRPMIBGroup, pimCandidateRPGroupMask=pimCandidateRPGroupMask, pimTraps=pimTraps, pimInterfaceTable=pimInterfaceTable, pimV2MIBGroup=pimV2MIBGroup, pimRPState=pimRPState, pimIpMRouteAssertMetricPref=pimIpMRouteAssertMetricPref, pimDenseV2MIBGroup=pimDenseV2MIBGroup, pimIpMRouteNextHopPruneReason=pimIpMRouteNextHopPruneReason, pimNeighborTable=pimNeighborTable, pimRPLastChange=pimRPLastChange, pimRPSetAddress=pimRPSetAddress, pimInterfaceEntry=pimInterfaceEntry, pimNeighborEntry=pimNeighborEntry, pimInterfaceCBSRPreference=pimInterfaceCBSRPreference, pimRPTable=pimRPTable, pimMIBConformance=pimMIBConformance, pimRPGroupAddress=pimRPGroupAddress)
