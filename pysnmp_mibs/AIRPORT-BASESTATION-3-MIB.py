...
# Produced by pysmi-1.6.2 at Fri Oct 10 18:52:02 2025
...
sysConfName.setMaxAccess("read-only")
...
sysConfContact.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
sysConfLocation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
