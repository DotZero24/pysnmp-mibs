...
mibBuilder.exportSymbols("AIRPORT-BASESTATION-3-MIB", dhcpPhysAddress=dhcpPhysAddress, dhcpLeaseTime=dhcpLeaseTime, wirelessTimeAssociated=wirelessTimeAssociated, sysConfLocation=sysConfLocation, dhcpIpAddress=dhcpIpAddress, physicalInterfaceState=physicalInterfaceState, physicalInterfaceNumRX=physicalInterfaceNumRX, sysConfUptime=sysConfUptime, physicalInterfaceNumTX=physicalInterfaceNumTX, PYSNMP_MODULE_ID=baseStation3, wirelessNumRX=wirelessNumRX, physicalInterface=physicalInterface, physicalInterfaceSpeed=physicalInterfaceSpeed, wireless=wireless, physicalInterfaceNumRXError=physicalInterfaceNumRXError, wirelessStrength=wirelessStrength, wirelessLastRefreshTime=wirelessLastRefreshTime, wirelessNumber=wirelessNumber, wirelessClientsTable=wirelessClientsTable, wirelessNoise=wirelessNoise, wirelessNumTX=wirelessNumTX, physicalInterfaceUnit=physicalInterfaceUnit, dhcpClientsTable=dhcpClientsTable, dhcpClient=dhcpClient, dhcpClientID=dhcpClientID, airport=airport, wirelessType=wirelessType, baseStation3=baseStation3, abs3SysConf=abs3SysConf, physicalInterfaces=physicalInterfaces, wirelessClient=wirelessClient, sysConfContact=sysConfContact, wirelessNumRXErrors=wirelessNumRXErrors, wirelessNumTXErrors=wirelessNumTXErrors, physicalInterfaceNumTXError=physicalInterfaceNumTXError, apple=apple, sysConfName=sysConfName, wirelessRate=wirelessRate, physicalInterfacesTable=physicalInterfacesTable, physicalInterfaceCount=physicalInterfaceCount, physicalInterfaceName=physicalInterfaceName, physicalInterfaceIndex=physicalInterfaceIndex, wirelessDataRates=wirelessDataRates, dhcpNumber=dhcpNumber, sysConfFirmwareVersion=sysConfFirmwareVersion, wirelessPhysAddress=wirelessPhysAddress, physicalInterfaceDuplex=physicalInterfaceDuplex, dhcpServer=dhcpServer)
