...
_B='A3COM-HUAWEI-ENTRELATION-MIB'
_A='current'
...
h3cEntRelationObjects=_H3cEntRelationObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,15,1))
_H3cEntRelation_ObjectIdentity=ObjectIdentity
h3cEntRelation=_H3cEntRelation_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,15,1,1))
_H3cEntRelationTable_Object=MibTable
h3cEntRelationTable=_H3cEntRelationTable_Object((1,3,6,1,4,1,43,45,1,10,2,15,1,1,1))
if mibBuilder.loadTexts:h3cEntRelationTable.setStatus(_A)
_H3cEntRelationEntry_Object=MibTableRow
h3cEntRelationEntry=_H3cEntRelationEntry_Object((1,3,6,1,4,1,43,45,1,10,2,15,1,1,1,1))
...
h3cEntRelationType=_H3cEntRelationType_Object((1,3,6,1,4,1,43,45,1,10,2,15,1,1,1,1,1),_H3cEntRelationType_Type())
...
h3cEntityIndex=_H3cEntityIndex_Object((1,3,6,1,4,1,43,45,1,10,2,15,1,1,1,1,2),_H3cEntityIndex_Type())
...
h3cRelatedEntityIndex=_H3cRelatedEntityIndex_Object((1,3,6,1,4,1,43,45,1,10,2,15,1,1,1,1,3),_H3cRelatedEntityIndex_Type())
...
h3cEntRelationConformance=_H3cEntRelationConformance_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,15,2))
_H3cEntRelationCompliances_ObjectIdentity=ObjectIdentity
h3cEntRelationCompliances=_H3cEntRelationCompliances_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,15,2,1))
_H3cEntRelationGroups_ObjectIdentity=ObjectIdentity
h3cEntRelationGroups=_H3cEntRelationGroups_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,15,2,2))
h3cEntRelationGroup=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,15,2,2,1))
h3cEntRelationGroup.setObjects((_B,_C))
if mibBuilder.loadTexts:h3cEntRelationGroup.setStatus(_A)
h3cEntRelationCompliance=ModuleCompliance((1,3,6,1,4,1,43,45,1,10,2,15,2,1,1))
