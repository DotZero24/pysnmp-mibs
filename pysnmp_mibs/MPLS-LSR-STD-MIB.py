...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/MPLS-LSR-STD-MIB
...
MplsLSPID, MplsBitRate, mplsStdMIB, MplsLabel, MplsOwner = mibBuilder.importSymbols("MPLS-TC-STD-MIB", "MplsLSPID", "MplsBitRate", "mplsStdMIB", "MplsLabel", "MplsOwner")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
ModuleIdentity, Counter64, Unsigned32, Gauge32, zeroDotZero, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, ObjectIdentity, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "Gauge32", "zeroDotZero", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("MPLS-LSR-STD-MIB", mplsInSegmentIndexNext=mplsInSegmentIndexNext, mplsOutSegmentPerfPackets=mplsOutSegmentPerfPackets, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsXCAdminStatus=mplsXCAdminStatus, mplsInSegmentLabelPtr=mplsInSegmentLabelPtr, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsXCGroup=mplsXCGroup, mplsInterfaceTable=mplsInterfaceTable, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInterfaceIndex=mplsInterfaceIndex, mplsInSegmentLabel=mplsInSegmentLabel, mplsOutSegmentTopLabelPtr=mplsOutSegmentTopLabelPtr, mplsLsrModuleFullCompliance=mplsLsrModuleFullCompliance, mplsInterfacePerfOutFragmentedPkts=mplsInterfacePerfOutFragmentedPkts, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsXCEntry=mplsXCEntry, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInSegmentTable=mplsInSegmentTable, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsLsrModuleReadOnlyCompliance=mplsLsrModuleReadOnlyCompliance, mplsPerfGroup=mplsPerfGroup, mplsXCInSegmentIndex=mplsXCInSegmentIndex, mplsLabelStackIndex=mplsLabelStackIndex, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsXCIndex=mplsXCIndex, mplsInterfacePerfInLabelsInUse=mplsInterfacePerfInLabelsInUse, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsLsrCompliances=mplsLsrCompliances, mplsInSegmentPerfErrors=mplsInSegmentPerfErrors, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInSegmentPerfOctets=mplsInSegmentPerfOctets, mplsOutSegmentNextHopAddr=mplsOutSegmentNextHopAddr, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentMapLabel=mplsInSegmentMapLabel, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInSegmentMapIndex=mplsInSegmentMapIndex, mplsInSegmentInterface=mplsInSegmentInterface, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsXCLspId=mplsXCLspId, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsLsrGroups=mplsLsrGroups, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsLsrConformance=mplsLsrConformance, mplsLsrStdMIB=mplsLsrStdMIB, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsLsrNotifications=mplsLsrNotifications, mplsInSegmentOwner=mplsInSegmentOwner, PYSNMP_MODULE_ID=mplsLsrStdMIB, MplsIndexNextType=MplsIndexNextType, mplsInSegmentPerfDiscards=mplsInSegmentPerfDiscards, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsXCOwner=mplsXCOwner, mplsLabelStackGroup=mplsLabelStackGroup, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsInSegmentMapLabelPtrIndex=mplsInSegmentMapLabelPtrIndex, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInSegmentPerfHCOctets=mplsInSegmentPerfHCOctets, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsOutSegmentTable=mplsOutSegmentTable, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentNextHopAddrType=mplsOutSegmentNextHopAddrType, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsXCUp=mplsXCUp, mplsXCOutSegmentIndex=mplsXCOutSegmentIndex, mplsOutSegmentPerfDiscards=mplsOutSegmentPerfDiscards, mplsInSegmentMapInterface=mplsInSegmentMapInterface, mplsInterfacePerfInLabelLookupFailures=mplsInterfacePerfInLabelLookupFailures, mplsXCDown=mplsXCDown, mplsLabelStackLabel=mplsLabelStackLabel, mplsXCNotificationsEnable=mplsXCNotificationsEnable, mplsInSegmentMapEntry=mplsInSegmentMapEntry, mplsOutSegmentPerfOctets=mplsOutSegmentPerfOctets, mplsInSegmentMapTable=mplsInSegmentMapTable, mplsOutSegmentPerfHCOctets=mplsOutSegmentPerfHCOctets, mplsOutSegmentInterface=mplsOutSegmentInterface, mplsInSegmentIndex=mplsInSegmentIndex, mplsInterfaceEntry=mplsInterfaceEntry, mplsXCTable=mplsXCTable, mplsInterfacePerfOutLabelsInUse=mplsInterfacePerfOutLabelsInUse, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentPerfPackets=mplsInSegmentPerfPackets, mplsLabelStackLabelPtr=mplsLabelStackLabelPtr, mplsLsrObjects=mplsLsrObjects, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsXCOperStatus=mplsXCOperStatus, mplsLabelStackEntry=mplsLabelStackEntry, mplsXCIndexNext=mplsXCIndexNext, mplsLabelStackTable=mplsLabelStackTable, MplsIndexType=MplsIndexType, mplsXCStorageType=mplsXCStorageType, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsOutSegmentPerfErrors=mplsOutSegmentPerfErrors, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentGroup=mplsInSegmentGroup, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsXCRowStatus=mplsXCRowStatus)
