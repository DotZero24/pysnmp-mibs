...
MplsOwner, MplsLabel, mplsStdMIB, MplsLSPID, MplsBitRate = mibBuilder.importSymbols("MPLS-TC-STD-MIB", "MplsOwner", "MplsLabel", "mplsStdMIB", "MplsLSPID", "MplsBitRate")
...
mibBuilder.exportSymbols("MPLS-LSR-STD-MIB", mplsOutSegmentPerfErrors=mplsOutSegmentPerfErrors, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsXCNotificationsEnable=mplsXCNotificationsEnable, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsOutSegmentNextHopAddr=mplsOutSegmentNextHopAddr, mplsXCIndexNext=mplsXCIndexNext, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsLsrModuleFullCompliance=mplsLsrModuleFullCompliance, mplsXCUp=mplsXCUp, mplsInSegmentGroup=mplsInSegmentGroup, mplsInterfacePerfOutLabelsInUse=mplsInterfacePerfOutLabelsInUse, mplsOutSegmentPerfPackets=mplsOutSegmentPerfPackets, mplsLabelStackEntry=mplsLabelStackEntry, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsInSegmentMapEntry=mplsInSegmentMapEntry, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsXCIndex=mplsXCIndex, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInSegmentPerfPackets=mplsInSegmentPerfPackets, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsPerfGroup=mplsPerfGroup, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsXCDown=mplsXCDown, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInSegmentTable=mplsInSegmentTable, mplsInSegmentLabelPtr=mplsInSegmentLabelPtr, mplsOutSegmentTable=mplsOutSegmentTable, mplsOutSegmentInterface=mplsOutSegmentInterface, mplsInSegmentIndex=mplsInSegmentIndex, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentPerfOctets=mplsInSegmentPerfOctets, mplsInterfacePerfInLabelLookupFailures=mplsInterfacePerfInLabelLookupFailures, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsOutSegmentPerfDiscards=mplsOutSegmentPerfDiscards, mplsLabelStackIndex=mplsLabelStackIndex, mplsXCOutSegmentIndex=mplsXCOutSegmentIndex, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsXCGroup=mplsXCGroup, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentPerfHCOctets=mplsInSegmentPerfHCOctets, mplsLsrStdMIB=mplsLsrStdMIB, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsLsrCompliances=mplsLsrCompliances, mplsLabelStackGroup=mplsLabelStackGroup, mplsInterfaceEntry=mplsInterfaceEntry, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInSegmentPerfTable=mplsInSegmentPerfTable, MplsIndexNextType=MplsIndexNextType, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsLabelStackTable=mplsLabelStackTable, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsInSegmentMapLabelPtrIndex=mplsInSegmentMapLabelPtrIndex, mplsOutSegmentNextHopAddrType=mplsOutSegmentNextHopAddrType, mplsInSegmentOwner=mplsInSegmentOwner, mplsInterfaceIndex=mplsInterfaceIndex, mplsInterfacePerfOutFragmentedPkts=mplsInterfacePerfOutFragmentedPkts, mplsInSegmentMapTable=mplsInSegmentMapTable, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsXCRowStatus=mplsXCRowStatus, mplsInSegmentIndexNext=mplsInSegmentIndexNext, mplsInSegmentMapInterface=mplsInSegmentMapInterface, mplsXCTable=mplsXCTable, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsXCStorageType=mplsXCStorageType, mplsOutSegmentPerfHCOctets=mplsOutSegmentPerfHCOctets, mplsInSegmentInterface=mplsInSegmentInterface, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, PYSNMP_MODULE_ID=mplsLsrStdMIB, mplsOutSegmentTopLabelPtr=mplsOutSegmentTopLabelPtr, mplsInterfaceGroup=mplsInterfaceGroup, mplsLsrGroups=mplsLsrGroups, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsLsrModuleReadOnlyCompliance=mplsLsrModuleReadOnlyCompliance, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsLsrConformance=mplsLsrConformance, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsXCEntry=mplsXCEntry, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsXCLspId=mplsXCLspId, mplsInSegmentLabel=mplsInSegmentLabel, mplsInSegmentMapLabel=mplsInSegmentMapLabel, mplsXCInSegmentIndex=mplsXCInSegmentIndex, mplsInterfacePerfInLabelsInUse=mplsInterfacePerfInLabelsInUse, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsLabelStackLabelPtr=mplsLabelStackLabelPtr, mplsXCOwner=mplsXCOwner, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsLabelStackLabel=mplsLabelStackLabel, MplsIndexType=MplsIndexType, mplsInterfaceTable=mplsInterfaceTable, mplsInSegmentPerfErrors=mplsInSegmentPerfErrors, mplsLsrObjects=mplsLsrObjects, mplsXCAdminStatus=mplsXCAdminStatus, mplsInSegmentPerfDiscards=mplsInSegmentPerfDiscards, mplsInSegmentMapIndex=mplsInSegmentMapIndex, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsLsrNotifications=mplsLsrNotifications, mplsXCOperStatus=mplsXCOperStatus, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsOutSegmentPerfOctets=mplsOutSegmentPerfOctets)
