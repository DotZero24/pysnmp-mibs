...
mibBuilder.exportSymbols("TPLINK-PRIVATE-VLAN-MIB", tplinkPrivateVlanMIBNotifications=tplinkPrivateVlanMIBNotifications, portConfigPrimaryVlan=portConfigPrimaryVlan, PYSNMP_MODULE_ID=tplinkPrivateVlanMIB, portConfigsecondaryVlan=portConfigsecondaryVlan, privateVlanTable=privateVlanTable, portType=portType, privateVlanEntry=privateVlanEntry, secondaryVlan=secondaryVlan, privateVlanPort=privateVlanPort, privateVlanType=privateVlanType, portNum=portNum, privateVlanPortTable=privateVlanPortTable, vlanPortStatus=vlanPortStatus, primaryVlan=primaryVlan, privateVlanPortEntry=privateVlanPortEntry, tplinkPrivateVlanMIB=tplinkPrivateVlanMIB, tplinkPrivateVlanMIBObjects=tplinkPrivateVlanMIBObjects, privateVlanStatus=privateVlanStatus)
