# SNMP MIB module (A3COM-HUAWEI-DSP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-DSP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:07 2025
...
h3cVPMIndex = _H3cVPMIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 1, 1, 1),
    _H3cVPMIndex_Type()
)
...
h3cVPMEnPhysicalIndex = _H3cVPMEnPhysicalIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 1, 1, 2),
...
h3cVPMState = _H3cVPMState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 1, 1, 3),
    _H3cVPMState_Type()
)
...
h3cVPMResourceUtilization = _H3cVPMResourceUtilization_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 1, 1, 4),
...
h3cVPMHiWaterUtilization = _H3cVPMHiWaterUtilization_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 1, 1, 5),
...
h3cVPMMaxChannel = _H3cVPMMaxChannel_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 1, 1, 6),
...
h3cDSPIndex = _H3cDSPIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 2, 1, 1),
    _H3cDSPIndex_Type()
)
...
h3cDSPVPMIndex = _H3cDSPVPMIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 2, 1, 2),
...
h3cDSPEnPhysicalIndex = _H3cDSPEnPhysicalIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 2, 1, 3),
...
h3cDSPResetTime = _H3cDSPResetTime_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 2, 1, 4),
...
h3cDSPMaxChannel = _H3cDSPMaxChannel_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 2, 1, 5),
...
h3cDSPState = _H3cDSPState_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 2, 1, 6),
    _H3cDSPState_Type()
)
...
h3cDSPInUseChannel = _H3cDSPInUseChannel_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 2, 1, 7),
...
h3cVPMStateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 3, 0, 1)
)
h3cVPMStateChange.setObjects(
      *(("A3COM-HUAWEI-DSP-MIB", "h3cVPMIndex"),
        ("A3COM-HUAWEI-DSP-MIB", "h3cVPMEnPhysicalIndex"),
        ("A3COM-HUAWEI-DSP-MIB", "h3cVPMState"))
)
if mibBuilder.loadTexts:
...
h3cDSPStateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 89, 3, 0, 2)
)
h3cDSPStateChange.setObjects(
      *(("A3COM-HUAWEI-DSP-MIB", "h3cDSPIndex"),
        ("A3COM-HUAWEI-DSP-MIB", "h3cDSPVPMIndex"),
        ("A3COM-HUAWEI-DSP-MIB", "h3cDSPEnPhysicalIndex"),
        ("A3COM-HUAWEI-DSP-MIB", "h3cDSPState"))
)
if mibBuilder.loadTexts:
