# SNMP MIB module (H3C-BLG-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-BLG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:19:32 2025
...
h3cBlgIndex = _H3cBlgIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 108, 1, 1, 1, 1),
    _H3cBlgIndex_Type()
)
...
h3cBlgGroupTxPacketCount = _H3cBlgGroupTxPacketCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 108, 1, 1, 1, 2),
...
h3cBlgGroupRxPacketCount = _H3cBlgGroupRxPacketCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 108, 1, 1, 1, 3),
...
h3cBlgGroupTxByteCount = _H3cBlgGroupTxByteCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 108, 1, 1, 1, 4),
...
h3cBlgGroupRxByteCount = _H3cBlgGroupRxByteCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 108, 1, 1, 1, 5),
...
h3cBlgGroupCountClear = _H3cBlgGroupCountClear_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 108, 1, 1, 1, 6),
