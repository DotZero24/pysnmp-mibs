...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LATITUDE-MIB
...
ciscoLatitudeMIBComplianceRev1.setObjects(
      *(("CISCO-LATITUDE-MIB", "ciscoLatitudeAlarmGroupRev1"),
        ("CISCO-LATITUDE-MIB", "ciscoLatitudeNotifsGroupRev1"))
)
if mibBuilder.loadTexts:
