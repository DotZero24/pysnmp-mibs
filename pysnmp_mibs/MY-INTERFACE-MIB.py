...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-INTERFACE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:35:23 2025
...
myInterfaceMIBCompliance.setObjects(
      *(("MY-INTERFACE-MIB", "myInterfaceMIBGroup"),
        ("MY-INTERFACE-MIB", "myPortTypeChooseMibGroup"),
        ("MY-INTERFACE-MIB", "myIfMTUMibGroup"),
        ("MY-INTERFACE-MIB", "myIfLineDetectGroup"),
        ("MY-INTERFACE-MIB", "myIfAvailableBWMibGroup"))
)
if mibBuilder.loadTexts:
