_A0='myIfAvailableBWMibGroup'
_z='myIfLineDetectGroup'
_y='myIfMTUMibGroup'
_x='myPortTypeChooseMibGroup'
_w='myInterfaceMIBGroup'
_v='lineDetectPosition'
_u='lineDetectStatus'
_t='myIfAvailableBWIfBW'
_s='myIfLineDetect'
_r='myIfMTU'
_q='myPortTypeChooseType'
_p='myGlobalIfDisableRecovery'
_o='myIfErrorStatus'
_n='myIfStatusLoopBackExamine'
_m='myIfIpEntryStatus'
_l='myIfIpMask'
_k='myIfMediumType'
_j='myIfEntryStatus'
_i='myIfCounterClear'
...
_b='myIfAdminDuplex'
_a='myIfAdminSpeed'
_Z='myIfFlowControlOperStatus'
_Y='myIfFlowControlAdminStatus'
_X='myIfPortType'
...
EnabledStatus,=mibBuilder.importSymbols('P-BRIDGE-MIB',_P)
...
myIfConfigMIBObjects=_MyIfConfigMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,10,1))
_MyIfTable_Object=MibTable
myIfTable=_MyIfTable_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1))
if mibBuilder.loadTexts:myIfTable.setStatus(_A)
_MyIfEntry_Object=MibTableRow
myIfEntry=_MyIfEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1))
...
myIfIndex=_MyIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,1),_MyIfIndex_Type())
...
myIfPortType=_MyIfPortType_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,2),_MyIfPortType_Type())
...
myIfFlowControlAdminStatus=_MyIfFlowControlAdminStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,3),_MyIfFlowControlAdminStatus_Type())
...
myIfFlowControlOperStatus=_MyIfFlowControlOperStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,4),_MyIfFlowControlOperStatus_Type())
myIfFlowControlOperStatus.setMaxAccess(_C)
if mibBuilder.loadTexts:myIfFlowControlOperStatus.setStatus(_A)
class _MyIfAdminSpeed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6)));namedValues=NamedValues(*((_Q,1),(_R,2),(_S,3),(_H,4),(_T,5),(_F,6)))
_MyIfAdminSpeed_Type.__name__=_D
_MyIfAdminSpeed_Object=MibTableColumn
myIfAdminSpeed=_MyIfAdminSpeed_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,5),_MyIfAdminSpeed_Type())
...
myIfAdminDuplex=_MyIfAdminDuplex_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,6),_MyIfAdminDuplex_Type())
myIfAdminDuplex.setMaxAccess(_E)
if mibBuilder.loadTexts:myIfAdminDuplex.setStatus(_A)
class _MyIfOperSpeed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5)));namedValues=NamedValues(*((_Q,1),(_R,2),(_S,3),(_F,4),(_T,5)))
_MyIfOperSpeed_Type.__name__=_D
_MyIfOperSpeed_Object=MibTableColumn
myIfOperSpeed=_MyIfOperSpeed_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,7),_MyIfOperSpeed_Type())
...
myIfOperDuplex=_MyIfOperDuplex_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,8),_MyIfOperDuplex_Type())
...
_MyIfManageStatus_Type.__name__=_P
_MyIfManageStatus_Object=MibTableColumn
myIfManageStatus=_MyIfManageStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,9),_MyIfManageStatus_Type())
...
myIfIpBroadcast=_MyIfIpBroadcast_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,10),_MyIfIpBroadcast_Type())
...
myIfLayer=_MyIfLayer_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,11),_MyIfLayer_Type())
...
myIfMode=_MyIfMode_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,12),_MyIfMode_Type())
...
myIfCounterClear=_MyIfCounterClear_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,13),_MyIfCounterClear_Type())
...
myIfEntryStatus=_MyIfEntryStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,14),_MyIfEntryStatus_Type())
myIfEntryStatus.setMaxAccess(_U)
if mibBuilder.loadTexts:myIfEntryStatus.setStatus(_A)
class _MyIfMediumType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_F,0),(_V,1),('fiber',2)))
_MyIfMediumType_Type.__name__=_D
_MyIfMediumType_Object=MibTableColumn
myIfMediumType=_MyIfMediumType_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,1,1,15),_MyIfMediumType_Type())
myIfMediumType.setMaxAccess(_E)
if mibBuilder.loadTexts:myIfMediumType.setStatus(_A)
_MyIfIpTable_Object=MibTable
myIfIpTable=_MyIfIpTable_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,2))
if mibBuilder.loadTexts:myIfIpTable.setStatus(_A)
_MyIfIpEntry_Object=MibTableRow
myIfIpEntry=_MyIfIpEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,2,1))
...
myIfIpIfIndex=_MyIfIpIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,2,1,1),_MyIfIpIfIndex_Type())
...
myIfIpId=_MyIfIpId_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,2,1,2),_MyIfIpId_Type())
myIfIpId.setMaxAccess(_C)
if mibBuilder.loadTexts:myIfIpId.setStatus(_A)
_MyIfIp_Type=IpAddress
_MyIfIp_Object=MibTableColumn
myIfIp=_MyIfIp_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,2,1,3),_MyIfIp_Type())
...
myIfIpMask=_MyIfIpMask_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,2,1,4),_MyIfIpMask_Type())
...
myIfIpEntryStatus=_MyIfIpEntryStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,2,1,5),_MyIfIpEntryStatus_Type())
myIfIpEntryStatus.setMaxAccess(_U)
if mibBuilder.loadTexts:myIfIpEntryStatus.setStatus(_A)
_MyIfStatusTable_Object=MibTable
myIfStatusTable=_MyIfStatusTable_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,3))
if mibBuilder.loadTexts:myIfStatusTable.setStatus(_A)
_MyIfStatusEntry_Object=MibTableRow
myIfStatusEntry=_MyIfStatusEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,3,1))
...
myIfStatusIndex=_MyIfStatusIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,3,1,1),_MyIfStatusIndex_Type())
...
myIfStatusLoopBackExamine=_MyIfStatusLoopBackExamine_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,3,1,2),_MyIfStatusLoopBackExamine_Type())
...
myIfErrorStatus=_MyIfErrorStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,3,1,3),_MyIfErrorStatus_Type())
...
myIfLineDetect=_MyIfLineDetect_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,3,1,4),_MyIfLineDetect_Type())
...
myGlobalIfDisableRecovery=_MyGlobalIfDisableRecovery_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,4),_MyGlobalIfDisableRecovery_Type())
...
myPortTypeChooseTable=_MyPortTypeChooseTable_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,5))
if mibBuilder.loadTexts:myPortTypeChooseTable.setStatus(_A)
_MyPortTypeChooseEntry_Object=MibTableRow
myPortTypeChooseEntry=_MyPortTypeChooseEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,5,1))
...
myPortTypeChooseIndex=_MyPortTypeChooseIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,5,1,1),_MyPortTypeChooseIndex_Type())
myPortTypeChooseIndex.setMaxAccess(_C)
if mibBuilder.loadTexts:myPortTypeChooseIndex.setStatus(_A)
class _MyPortTypeChooseType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('fiber',1),(_V,2)))
_MyPortTypeChooseType_Type.__name__=_D
_MyPortTypeChooseType_Object=MibTableColumn
myPortTypeChooseType=_MyPortTypeChooseType_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,5,1,2),_MyPortTypeChooseType_Type())
...
myIfMTUTable=_MyIfMTUTable_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,6))
if mibBuilder.loadTexts:myIfMTUTable.setStatus(_A)
_MyIfMTUEntry_Object=MibTableRow
myIfMTUEntry=_MyIfMTUEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,6,1))
...
myIfMTUIndex=_MyIfMTUIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,6,1,1),_MyIfMTUIndex_Type())
...
myIfMTU=_MyIfMTU_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,6,1,2),_MyIfMTU_Type())
myIfMTU.setMaxAccess(_E)
if mibBuilder.loadTexts:myIfMTU.setStatus(_A)
_MyIfAvailableBWTable_Object=MibTable
myIfAvailableBWTable=_MyIfAvailableBWTable_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,7))
if mibBuilder.loadTexts:myIfAvailableBWTable.setStatus(_A)
_MyIfAvailableBWEntry_Object=MibTableRow
myIfAvailableBWEntry=_MyIfAvailableBWEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,7,1))
...
myIfAvailableBWIfIndex=_MyIfAvailableBWIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,7,1,1),_MyIfAvailableBWIfIndex_Type())
...
myIfAvailableBWIfBW=_MyIfAvailableBWIfBW_Object((1,3,6,1,4,1,4881,1,1,10,2,10,1,7,1,2),_MyIfAvailableBWIfBW_Type())
...
myInterfaceTraps=_MyInterfaceTraps_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,10,2))
...
lineDetectStatus=_LineDetectStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,10,2,1),_LineDetectStatus_Type())
lineDetectStatus.setMaxAccess(_W)
...
lineDetectPosition=_LineDetectPosition_Object((1,3,6,1,4,1,4881,1,1,10,2,10,2,2),_LineDetectPosition_Type())
lineDetectPosition.setMaxAccess(_W)
if mibBuilder.loadTexts:lineDetectPosition.setStatus(_A)
_MyInterfaceMIBConformance_ObjectIdentity=ObjectIdentity
myInterfaceMIBConformance=_MyInterfaceMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,10,3))
_MyInterfaceMIBCompliances_ObjectIdentity=ObjectIdentity
myInterfaceMIBCompliances=_MyInterfaceMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,10,3,1))
_MyInterfaceMIBGroups_ObjectIdentity=ObjectIdentity
myInterfaceMIBGroups=_MyInterfaceMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,10,3,2))
myInterfaceMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,10,3,2,1))
myInterfaceMIBGroup.setObjects(*((_B,_G),(_B,_X),(_B,_Y),(_B,_Z),(_B,_a),(_B,_b),(_B,_c),(_B,_d),(_B,_e),(_B,_f),(_B,_g),(_B,_h),(_B,_i),(_B,_j),(_B,_k),(_B,_I),(_B,_J),(_B,_K),(_B,_l),(_B,_m),(_B,_L),(_B,_n),(_B,_o),(_B,_p)))
if mibBuilder.loadTexts:myInterfaceMIBGroup.setStatus(_A)
myPortTypeChooseMibGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,10,3,2,2))
myPortTypeChooseMibGroup.setObjects(*((_B,_M),(_B,_q)))
if mibBuilder.loadTexts:myPortTypeChooseMibGroup.setStatus(_A)
myIfMTUMibGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,10,3,2,3))
myIfMTUMibGroup.setObjects(*((_B,_N),(_B,_r)))
if mibBuilder.loadTexts:myIfMTUMibGroup.setStatus(_A)
myIfLineDetectGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,10,3,2,4))
myIfLineDetectGroup.setObjects((_B,_s))
if mibBuilder.loadTexts:myIfLineDetectGroup.setStatus(_A)
myIfAvailableBWMibGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,10,3,2,5))
myIfAvailableBWMibGroup.setObjects(*((_B,_O),(_B,_t)))
if mibBuilder.loadTexts:myIfAvailableBWMibGroup.setStatus(_A)
lineQualityDetect=NotificationType((1,3,6,1,4,1,4881,1,1,10,2,10,2,3))
lineQualityDetect.setObjects(*((_B,'ifIndex'),(_B,_u),(_B,_v)))
if mibBuilder.loadTexts:lineQualityDetect.setStatus(_A)
myInterfaceMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,10,3,1,1))
myInterfaceMIBCompliance.setObjects(*((_B,_w),(_B,_x),(_B,_y),(_B,_z),(_B,_A0)))
if mibBuilder.loadTexts:myInterfaceMIBCompliance.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'myInterfaceMIB':myInterfaceMIB,'myIfConfigMIBObjects':myIfConfigMIBObjects,'myIfTable':myIfTable,'myIfEntry':myIfEntry,_G:myIfIndex,_X:myIfPortType,_Y:myIfFlowControlAdminStatus,_Z:myIfFlowControlOperStatus,_a:myIfAdminSpeed,_b:myIfAdminDuplex,_c:myIfOperSpeed,_d:myIfOperDuplex,_e:myIfManageStatus,_f:myIfIpBroadcast,_g:myIfLayer,_h:myIfMode,_i:myIfCounterClear,_j:myIfEntryStatus,_k:myIfMediumType,'myIfIpTable':myIfIpTable,'myIfIpEntry':myIfIpEntry,_I:myIfIpIfIndex,_J:myIfIpId,_K:myIfIp,_l:myIfIpMask,_m:myIfIpEntryStatus,'myIfStatusTable':myIfStatusTable,'myIfStatusEntry':myIfStatusEntry,_L:myIfStatusIndex,_n:myIfStatusLoopBackExamine,_o:myIfErrorStatus,_s:myIfLineDetect,_p:myGlobalIfDisableRecovery,'myPortTypeChooseTable':myPortTypeChooseTable,'myPortTypeChooseEntry':myPortTypeChooseEntry,_M:myPortTypeChooseIndex,_q:myPortTypeChooseType,'myIfMTUTable':myIfMTUTable,'myIfMTUEntry':myIfMTUEntry,_N:myIfMTUIndex,_r:myIfMTU,'myIfAvailableBWTable':myIfAvailableBWTable,'myIfAvailableBWEntry':myIfAvailableBWEntry,_O:myIfAvailableBWIfIndex,_t:myIfAvailableBWIfBW,'myInterfaceTraps':myInterfaceTraps,_u:lineDetectStatus,_v:lineDetectPosition,'lineQualityDetect':lineQualityDetect,'myInterfaceMIBConformance':myInterfaceMIBConformance,'myInterfaceMIBCompliances':myInterfaceMIBCompliances,'myInterfaceMIBCompliance':myInterfaceMIBCompliance,'myInterfaceMIBGroups':myInterfaceMIBGroups,_w:myInterfaceMIBGroup,_x:myPortTypeChooseMibGroup,_y:myIfMTUMibGroup,_z:myIfLineDetectGroup,_A0:myIfAvailableBWMibGroup})