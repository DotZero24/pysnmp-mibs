...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MEETINGPLACE-MIB
...
cmpMIBCompliance.setObjects(
      *(("CISCO-MEETINGPLACE-MIB", "cmpAlarmGroup"),
        ("CISCO-MEETINGPLACE-MIB", "cmpNotifsGroup"),
        ("CISCO-MEETINGPLACE-MIB", "cmpInfoGroup"))
)
if mibBuilder.loadTexts:
