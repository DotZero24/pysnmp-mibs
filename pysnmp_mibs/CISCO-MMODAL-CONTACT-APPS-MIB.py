...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-MMODAL-CONTACT-APPS-MIB
...
mibBuilder.exportSymbols("CISCO-MMODAL-CONTACT-APPS-MIB", cmmcaBreIntTotalAbnormalResourceEndings=cmmcaBreIntTotalAbnormalResourceEndings, cmmcaMpaAggFailedInvites=cmmcaMpaAggFailedInvites, cmmcaBreIntMaxConcurrentInstancesDt=cmmcaBreIntMaxConcurrentInstancesDt, cmmcaMpaRtActiveSipControlAddresses=cmmcaMpaRtActiveSipControlAddresses, CmmcaSeverityLevel=CmmcaSeverityLevel, cmmcaMpaAggTotalIMAddressesRegistered=cmmcaMpaAggTotalIMAddressesRegistered, cmmcaWaGroup=cmmcaWaGroup, cmmcaRaAggTaskStateChangeMsgReceived=cmmcaRaAggTaskStateChangeMsgReceived, cmmcaRdaRtNumActiveClients=cmmcaRdaRtNumActiveClients, cmmcaMpaRtActiveInteractions=cmmcaMpaRtActiveInteractions, cmmcaRsIntResourceTaskDetailRecords=cmmcaRsIntResourceTaskDetailRecords, cmmcaNextNodeIpAddr=cmmcaNextNodeIpAddr, cmmcaWaAggOfferTaskCancelledSent=cmmcaWaAggOfferTaskCancelledSent, cmmcaRtCongested=cmmcaRtCongested, cmmcaBreTable=cmmcaBreTable, cmmcaRmIntNumOffersAccept=cmmcaRmIntNumOffersAccept, cmmcaSystemConditionTimeStamp=cmmcaSystemConditionTimeStamp, cmmcaWaRtResourceCount=cmmcaWaRtResourceCount, cmmcaIcmgwRtAqsMonitored=cmmcaIcmgwRtAqsMonitored, cmmcaBreIntTotalInstanceTerminations=cmmcaBreIntTotalInstanceTerminations, cmmcaEventState=cmmcaEventState, cmmcaMpaAggTotalClientsRegistered=cmmcaMpaAggTotalClientsRegistered, cmmcaNotificationInfoGroup=cmmcaNotificationInfoGroup, cmmcaWaAggResyncResourceSent=cmmcaWaAggResyncResourceSent, cmmcaMpaGroup=cmmcaMpaGroup, cmmcaCmRtNumCallTrying=cmmcaCmRtNumCallTrying, cmmcaWaAggTotalConfigErrors=cmmcaWaAggTotalConfigErrors, cmmcaRsRtDBSpaceUsed=cmmcaRsRtDBSpaceUsed, cmmcaEventSeverity=cmmcaEventSeverity, cmmcaMpaAggFailedReinvites=cmmcaMpaAggFailedReinvites, cmmcaOpsConsoleURL=cmmcaOpsConsoleURL, cmmcaNextNodeIpAddrType=cmmcaNextNodeIpAddrType, cmmcaDeviceType=cmmcaDeviceType, cmmcaTimeZoneOffsetMinutes=cmmcaTimeZoneOffsetMinutes, cmmcaIcmgwRtPendingCallTermEvents=cmmcaIcmgwRtPendingCallTermEvents, cmmcaRmGroup=cmmcaRmGroup, cmmcaRtThreadsInUse=cmmcaRtThreadsInUse, cmmcaBreIntAvgConcurrentInstances=cmmcaBreIntAvgConcurrentInstances, cmmcaEnvRtMaxMemAvail=cmmcaEnvRtMaxMemAvail, cmmcaMpaAggPresenceUpdatesBytesRcv=cmmcaMpaAggPresenceUpdatesBytesRcv, cmmcaRmRtAgentsWrapUp=cmmcaRmRtAgentsWrapUp, cmmcaServiceIntPeriod=cmmcaServiceIntPeriod, cmmcaRdaIntNumSuccessPresenceNotifications=cmmcaRdaIntNumSuccessPresenceNotifications, cmmcaRsAggTotalResourceEventDetailRecords=cmmcaRsAggTotalResourceEventDetailRecords, cmmcaRsIntAssignmentQueDetailRecords=cmmcaRsIntAssignmentQueDetailRecords, CmmcaSystemConditionStatus=CmmcaSystemConditionStatus, cmmcaRmRtAgentsLoggedIn=cmmcaRmRtAgentsLoggedIn, cmmcaBreAggTotalAbnormalContactEndings=cmmcaBreAggTotalAbnormalContactEndings, cmmcaClusterInfoEntry=cmmcaClusterInfoEntry, cmmcaNextNodeEntry=cmmcaNextNodeEntry, cmmcaDeviceInetAddressType=cmmcaDeviceInetAddressType, cmmcaRtUptime=cmmcaRtUptime, cmmcaWaAggCancelResourceRequestReceived=cmmcaWaAggCancelResourceRequestReceived, cmmcaBreAggTotalResourceInstanceTerminations=cmmcaBreAggTotalResourceInstanceTerminations, cmmcaRsTable=cmmcaRsTable, cmmcaIcmgwRtACMIOutQueueWait=cmmcaIcmgwRtACMIOutQueueWait, cmmcaEnvRtCurrMemAvail=cmmcaEnvRtCurrMemAvail, cmmcaRaTable=cmmcaRaTable, cmmcaRmAggNumOffersTimedOut=cmmcaRmAggNumOffersTimedOut, cmmcaRsRtDBSpaceFree=cmmcaRsRtDBSpaceFree, cmmcaBreAggTotalInstanceInitiations=cmmcaBreAggTotalInstanceInitiations, cmmcaEventAppName=cmmcaEventAppName, cmmcaIcmgwRtACMIOutQueueDepth=cmmcaIcmgwRtACMIOutQueueDepth, PYSNMP_MODULE_ID=ciscoMmodalContactAppsMIB, cmmcaServiceIndex=cmmcaServiceIndex, cmmcaRsRtDBPercentFree=cmmcaRsRtDBPercentFree, cmmcaWaAggRRIFailureResponseSent=cmmcaWaAggRRIFailureResponseSent, cmmcaRmRtAgentsReserved=cmmcaRmRtAgentsReserved, cmmcaBreAggDistinctScripts=cmmcaBreAggDistinctScripts, cmmcaRaGroup=cmmcaRaGroup, cmmcaIcmgwRtGetContactDetailDelay=cmmcaIcmgwRtGetContactDetailDelay, cmmcaSystemConditionMessage=cmmcaSystemConditionMessage, cmmcaLicenseInfo=cmmcaLicenseInfo, cmmcaEventMessageName=cmmcaEventMessageName, cmmcaCmAggMaxCallArrivalRateDt=cmmcaCmAggMaxCallArrivalRateDt, cmmcaRsAggTotalAssignmentQueDetailRecords=cmmcaRsAggTotalAssignmentQueDetailRecords, cmmcaMpaRtActiveIMAddresses=cmmcaMpaRtActiveIMAddresses, cmmcaRsAggTotalContactSegmentMediaDetailRecords=cmmcaRsAggTotalContactSegmentMediaDetailRecords, cmmcaTPoolRtCoreThreads=cmmcaTPoolRtCoreThreads, cmmcaRdaIntNumMsgProc=cmmcaRdaIntNumMsgProc, cmmcaWaAggResourceResponseCanceledSent=cmmcaWaAggResourceResponseCanceledSent, cmmcaSystemConditionSeverity=cmmcaSystemConditionSeverity, cmmcaServiceInfo=cmmcaServiceInfo, cmmcaCmEntry=cmmcaCmEntry, cmmcaRtLogLevel=cmmcaRtLogLevel, cmmcaBreAggTotalResourceInstanceInitiations=cmmcaBreAggTotalResourceInstanceInitiations, cmmcaTPoolRtMaxThreadsAvail=cmmcaTPoolRtMaxThreadsAvail, ciscoMmodalContactAppsMIBComplianceRev=ciscoMmodalContactAppsMIBComplianceRev, cmmcaBreAggMaxConcurrentInstances=cmmcaBreAggMaxConcurrentInstances, cmmcaMpaRtActivePublishAddresses=cmmcaMpaRtActivePublishAddresses, ciscoMmodalContactAppsMIBObjects=ciscoMmodalContactAppsMIBObjects, cmmcaThreadPoolGroup=cmmcaThreadPoolGroup, cmmcaMpaAggInstantMessagesSent=cmmcaMpaAggInstantMessagesSent, cmmcaIcmgwEntry=cmmcaIcmgwEntry, cmmcaRaAggResourceStateChngMesgReceived=cmmcaRaAggResourceStateChngMesgReceived, cmmcaDescription=cmmcaDescription, cmmcaCmAggAvgCallInQueueTime=cmmcaCmAggAvgCallInQueueTime, cmmcaRmRtAgentsOnCalls=cmmcaRmRtAgentsOnCalls, cmmcaNextNodeIndex=cmmcaNextNodeIndex, cmmcaNextNodeType=cmmcaNextNodeType, cmmcaBreIntMaxConcurrentInstances=cmmcaBreIntMaxConcurrentInstances, cmmcaWaRtResourceCriteriaCount=cmmcaWaRtResourceCriteriaCount, cmmcaTPoolRtRunningThreads=cmmcaTPoolRtRunningThreads, cmmcaIcmgwRtPendingGetContactDetailDlgs=cmmcaIcmgwRtPendingGetContactDetailDlgs, ciscoMmodalContactAppsMIBNotifs=ciscoMmodalContactAppsMIBNotifs, cmmcaRmRtAgentsNoQueue=cmmcaRmRtAgentsNoQueue, cmmcaIcmgwAggSocketConnects=cmmcaIcmgwAggSocketConnects, cmmcaRsDBSizeAllocated=cmmcaRsDBSizeAllocated, cmmcaSystemConditionIndex=cmmcaSystemConditionIndex, cmmcaRsAggTotalDBWrites=cmmcaRsAggTotalDBWrites, cmmcaTotalLicensesConfigured=cmmcaTotalLicensesConfigured, cmmcaStartTime=cmmcaStartTime, cmmcaMIBEvent=cmmcaMIBEvent, cmmcaCmRtNumCallTerminating=cmmcaCmRtNumCallTerminating, cmmcaRsAggTotalContactDetailRecords=cmmcaRsAggTotalContactDetailRecords, cmmcaSystemConditionTable=cmmcaSystemConditionTable, cmmcaCmRtNumCallConnected=cmmcaCmRtNumCallConnected, cmmcaWaAggCancelWorkRequestReceived=cmmcaWaAggCancelWorkRequestReceived, cmmcaRdaRtNumInactiveClients=cmmcaRdaRtNumInactiveClients, cmmcaWaAggWorkRequestReceived=cmmcaWaAggWorkRequestReceived, cmmcaServiceGroup=cmmcaServiceGroup, cmmcaMpaRtOutgoingCalls=cmmcaMpaRtOutgoingCalls, cmmcaRaAggResourceTaskDetailMsgReceived=cmmcaRaAggResourceTaskDetailMsgReceived, cmmcaBreIntTotalContactInstanceTerminations=cmmcaBreIntTotalContactInstanceTerminations, cmmcaRdaRtNumOutStandingOfferTasks=cmmcaRdaRtNumOutStandingOfferTasks, cmmcaRsIntContactSegmentDetailRecords=cmmcaRsIntContactSegmentDetailRecords, cmmcaRaAggContactSegDetailMsgReceived=cmmcaRaAggContactSegDetailMsgReceived, cmmcaRsIntResourceEventDetailRecords=cmmcaRsIntResourceEventDetailRecords, cmmcaEnvRtUpTime=cmmcaEnvRtUpTime, cmmcaMpaTable=cmmcaMpaTable, cmmcaDeviceInetAddress=cmmcaDeviceInetAddress, cmmcaRmRtAgentsReady=cmmcaRmRtAgentsReady, CmmcaNextNodeStatus=CmmcaNextNodeStatus, cmmcaCmRtNumActiveCalls=cmmcaCmRtNumActiveCalls, cmmcaDeviceStatus=cmmcaDeviceStatus, cmmcaWaRtSelectionStrategyAttrCount=cmmcaWaRtSelectionStrategyAttrCount, cmmcaRsIntContactSegmentMediaDetailRecords=cmmcaRsIntContactSegmentMediaDetailRecords, cmmcaRtMsgReceived=cmmcaRtMsgReceived, cmmcaIcmgwRtAgentsMonitored=cmmcaIcmgwRtAgentsMonitored, cmmcaBreAggTotalContactInstanceInitiations=cmmcaBreAggTotalContactInstanceInitiations, cmmcaRmTable=cmmcaRmTable, cmmcaCmIntAvgCallInQueueTime=cmmcaCmIntAvgCallInQueueTime, cmmcaWaAggWRIFailureResponseSent=cmmcaWaAggWRIFailureResponseSent, cmmcaBreIntTotalAbnormalEndings=cmmcaBreIntTotalAbnormalEndings, cmmcaWaAggOfferTaskSent=cmmcaWaAggOfferTaskSent, cmmcaRsAggTotalAssignmentQueAttribRecords=cmmcaRsAggTotalAssignmentQueAttribRecords, cmmcaNextNodeStatus=cmmcaNextNodeStatus, ciscoMmodalContactAppsMIB=ciscoMmodalContactAppsMIB, cmmcaCmIntAvgCallArrivalRate=cmmcaCmIntAvgCallArrivalRate, cmmcaCmAggMaxCallDurationTimeDt=cmmcaCmAggMaxCallDurationTimeDt, cmmcaIcmgwRtPendingQueryAgentStateDlgs=cmmcaIcmgwRtPendingQueryAgentStateDlgs, cmmcaWaAggQueueEventSent=cmmcaWaAggQueueEventSent, cmmcaMaxMsgQMemAvail=cmmcaMaxMsgQMemAvail, CmmcaConditionStatus=CmmcaConditionStatus, cmmcaClusterInfoTable=cmmcaClusterInfoTable, cmmcaBreIntTotalResourceInstanceTerminations=cmmcaBreIntTotalResourceInstanceTerminations, cmmcaServerName=cmmcaServerName, cmmcaDeviceDescription=cmmcaDeviceDescription, cmmcaMpaRtIncomingCalls=cmmcaMpaRtIncomingCalls, cmmcaRaAggVersionRequestDispatched=cmmcaRaAggVersionRequestDispatched, cmmcaLocalDeviceType=cmmcaLocalDeviceType, cmmcaEnableNotifications=cmmcaEnableNotifications, cmmcaWaAggResyncResourceResponseReceived=cmmcaWaAggResyncResourceResponseReceived, cmmcaIcmgwTable=cmmcaIcmgwTable, CmmcaIndex=CmmcaIndex, cmmcaIcmgwAggQueryAgentStateTimeouts=cmmcaIcmgwAggQueryAgentStateTimeouts, cmmcaWaRtTotalResourceManagerCount=cmmcaWaRtTotalResourceManagerCount, cmmcaCmRtNumCallTransferring=cmmcaCmRtNumCallTransferring, cmmcaBreIntTotalInstanceInitiations=cmmcaBreIntTotalInstanceInitiations, cmmcaRsEntry=cmmcaRsEntry, cmmcaRtTraceMask=cmmcaRtTraceMask, cmmcaRaEntry=cmmcaRaEntry, cmmcaBreAggAvgConcurrentInstances=cmmcaBreAggAvgConcurrentInstances, cmmcaWaRtTotalContactManagerCount=cmmcaWaRtTotalContactManagerCount, cmmcaRdaAggNumUnSuccessPresenceNotifications=cmmcaRdaAggNumUnSuccessPresenceNotifications, cmmcaWaAggMessageSentError=cmmcaWaAggMessageSentError, cmmcaServiceTable=cmmcaServiceTable, cmmcaServiceName=cmmcaServiceName, cmmcaEventText=cmmcaEventText, cmmcaEventTimestamp=cmmcaEventTimestamp, cmmcaMpaAggAvgLatency=cmmcaMpaAggAvgLatency, cmmcaMpaAggPresenceUpdatesReceived=cmmcaMpaAggPresenceUpdatesReceived, cmmcaSystemConditionEntry=cmmcaSystemConditionEntry, cmmcaCmIntNumCallArrivals=cmmcaCmIntNumCallArrivals, cmmcaServiceEntry=cmmcaServiceEntry, cmmcaWaAggOfferTaskResponseReceived=cmmcaWaAggOfferTaskResponseReceived, cmmcaCmIntMaxCallInQueueTime=cmmcaCmIntMaxCallInQueueTime, cmmcaRmIntNumOffersReject=cmmcaRmIntNumOffersReject, cmmcaRdaIntNumUnSuccessPresenceNotifications=cmmcaRdaIntNumUnSuccessPresenceNotifications, cmmcaRmEntry=cmmcaRmEntry, cmmcaRsIntContactDetailAttribRecords=cmmcaRsIntContactDetailAttribRecords, cmmcaServiceType=cmmcaServiceType, cmmcaRuntimeInfo=cmmcaRuntimeInfo, cmmcaMpaAggInstantMessagesReceived=cmmcaMpaAggInstantMessagesReceived, cmmcaCmAggAvgCallArrivalRate=cmmcaCmAggAvgCallArrivalRate, cmmcaMpaRtActiveClientSessions=cmmcaMpaRtActiveClientSessions, cmmcaBreAggTotalAbnormalResourceEndings=cmmcaBreAggTotalAbnormalResourceEndings, cmmcaBreAggMaxConcurrentInstancesDt=cmmcaBreAggMaxConcurrentInstancesDt, cmmcaSystemConditionStatus=cmmcaSystemConditionStatus, cmmcaEventHostName=cmmcaEventHostName, cmmcaCmRtNumCallRingBack=cmmcaCmRtNumCallRingBack, cmmcaRdaAggNumMsgProc=cmmcaRdaAggNumMsgProc, cmmcaWaRtTotalContactCount=cmmcaWaRtTotalContactCount, cmmcaWaRtAttributeValueCount=cmmcaWaRtAttributeValueCount, cmmcaMpaAggTotalSipControlAddressesRegistered=cmmcaMpaAggTotalSipControlAddressesRegistered, cmmcaLicenseInfoGroup=cmmcaLicenseInfoGroup, cmmcaRaAggResourceStateChngMsgDispatched=cmmcaRaAggResourceStateChngMsgDispatched, cmmcaRmAggNumOffersAccept=cmmcaRmAggNumOffersAccept, cmmcaRmIntNumOffersTimedOut=cmmcaRmIntNumOffersTimedOut, cmmcaRsAggTotalContactDetailAttributeRecords=cmmcaRsAggTotalContactDetailAttributeRecords, cmmcaWaAggOfferTaskAcceptedSent=cmmcaWaAggOfferTaskAcceptedSent, cmmcaTPoolRtIdleThreads=cmmcaTPoolRtIdleThreads, cmmcaMpaAggTotalCalls=cmmcaMpaAggTotalCalls, cmmcaBreIntTotalAbnormalContactEndings=cmmcaBreIntTotalAbnormalContactEndings, cmmcaRsRtTransactionLogSize=cmmcaRsRtTransactionLogSize, cmmcaWaEntry=cmmcaWaEntry, cmmcaRtLicensesAvailable=cmmcaRtLicensesAvailable, cmmcaMpaRtActiveMonitoredPresenceAddresses=cmmcaMpaRtActiveMonitoredPresenceAddresses, cmmcaGeneralInfo=cmmcaGeneralInfo, cmmcaCmRtNumCallRejecting=cmmcaCmRtNumCallRejecting, cmmcaRaAggContactSegMediaDetailMsgDispatched=cmmcaRaAggContactSegMediaDetailMsgDispatched, cmmcaWaRtSelectionStrategyCount=cmmcaWaRtSelectionStrategyCount, cmmcaRdaAggNumSuccessPresenceNotifications=cmmcaRdaAggNumSuccessPresenceNotifications, cmmcaBreEntry=cmmcaBreEntry, cmmcaIcmgwGroup=cmmcaIcmgwGroup, cmmcaWaRtSkillCompetencyCount=cmmcaWaRtSkillCompetencyCount, cmmcaRaAggContactDetailMesgReceived=cmmcaRaAggContactDetailMesgReceived, cmmcaRmAggNumOffersReject=cmmcaRmAggNumOffersReject, cmmcaRtMsgQMemPercentUsage=cmmcaRtMsgQMemPercentUsage, cmmcaRaAggVersionResponseRecieved=cmmcaRaAggVersionResponseRecieved, cmmcaIcmgwRtRoutesMonitored=cmmcaIcmgwRtRoutesMonitored, cmmcaMpaAggNewCalls=cmmcaMpaAggNewCalls, CmmcaServiceStatus=CmmcaServiceStatus, cmmcaMpaRtTotalPublishAddressesRegistered=cmmcaMpaRtTotalPublishAddressesRegistered, cmmcaWaTable=cmmcaWaTable, ciscoMmodalContactAppsMIBGroups=ciscoMmodalContactAppsMIBGroups, cmmcaCmRtNumCallInitial=cmmcaCmRtNumCallInitial, cmmcaSystemConditionId=cmmcaSystemConditionId, cmmcaCmTable=cmmcaCmTable, cmmcaWaAggResourceRequestReceived=cmmcaWaAggResourceRequestReceived, cmmcaMaxThreadsAvailable=cmmcaMaxThreadsAvailable, cmmcaEnvRtCurrMemUsed=cmmcaEnvRtCurrMemUsed, cmmcaWaAggResyncResourceResponseAckSent=cmmcaWaAggResyncResourceResponseAckSent, cmmcaRsRtNumberActiveDBUserSessions=cmmcaRsRtNumberActiveDBUserSessions, cmmcaSystemConditionDescription=cmmcaSystemConditionDescription, ciscoMmodalContactAppsMIBConform=ciscoMmodalContactAppsMIBConform, cmmcaRaAggContactDetailMesgDispatched=cmmcaRaAggContactDetailMesgDispatched, cmmcaMpaAggConnectsRcv=cmmcaMpaAggConnectsRcv, cmmcaServices=cmmcaServices, cmmcaIcmgwAggSocketDisconnects=cmmcaIcmgwAggSocketDisconnects, cmmcaRsIntAssignmentQueAttribRecords=cmmcaRsIntAssignmentQueAttribRecords, cmmcaWaRtResourceMemberCount=cmmcaWaRtResourceMemberCount, cmmcaCmIntMaxCallInQueueTimeDt=cmmcaCmIntMaxCallInQueueTimeDt, cmmcaWaAggCancelQueueEventSent=cmmcaWaAggCancelQueueEventSent)
mibBuilder.exportSymbols("CISCO-MMODAL-CONTACT-APPS-MIB", cmmcaWaRtAssignmentQueCount=cmmcaWaRtAssignmentQueCount, cmmcaIcmgwAggACMIBytesSent=cmmcaIcmgwAggACMIBytesSent, cmmcaBreAggTotalContactInstanceTerminations=cmmcaBreAggTotalContactInstanceTerminations, cmmcaBreRtActiveScripts=cmmcaBreRtActiveScripts, cmmcaCmGroup=cmmcaCmGroup, cmmcaRaAggMsgSent=cmmcaRaAggMsgSent, cmmcaEventsGroup=cmmcaEventsGroup, cmmcaRdaTable=cmmcaRdaTable, cmmcaIcmgwAggACMIMsgsRcvd=cmmcaIcmgwAggACMIMsgsRcvd, cmmcaBreAggTotalInstanceTerminations=cmmcaBreAggTotalInstanceTerminations, cmmcaRsRtDBPercentUsed=cmmcaRsRtDBPercentUsed, cmmcaClusterId=cmmcaClusterId, cmmcaCmIntMaxCallDurationTimeDt=cmmcaCmIntMaxCallDurationTimeDt, cmmcaRsRtDBStatus=cmmcaRsRtDBStatus, cmmcaCmAggMaxCallInQueueTimeDt=cmmcaCmAggMaxCallInQueueTimeDt, cmmcaWaAggWorkRequestCanceledSent=cmmcaWaAggWorkRequestCanceledSent, cmmcaRdaGroup=cmmcaRdaGroup, cmmcaDeviceIndex=cmmcaDeviceIndex, cmmcaIcmgwAggGetContactDetailTimeouts=cmmcaIcmgwAggGetContactDetailTimeouts, cmmcaMpaEntry=cmmcaMpaEntry, cmmcaBreIntTotalContactInstanceInitiations=cmmcaBreIntTotalContactInstanceInitiations, cmmcaNotificationInfo=cmmcaNotificationInfo, cmmcaIcmgwRtQueryAgentStateDelay=cmmcaIcmgwRtQueryAgentStateDelay, cmmcaRuntimeInfoGroup=cmmcaRuntimeInfoGroup, cmmcaCmIntAvgCallDurationTime=cmmcaCmIntAvgCallDurationTime, cmmcaRtRoutingDomain=cmmcaRtRoutingDomain, cmmcaEventMessageId=cmmcaEventMessageId, cmmcaSystemStatus=cmmcaSystemStatus, CmmcaServiceType=CmmcaServiceType, cmmcaTimeZoneName=cmmcaTimeZoneName, cmmcaWaRtTotalResourceCount=cmmcaWaRtTotalResourceCount, cmmcaIcmgwAggACMIBytesRcvd=cmmcaIcmgwAggACMIBytesRcvd, cmmcaVersion=cmmcaVersion, cmmcaEnvRtCurrThreadsInUse=cmmcaEnvRtCurrThreadsInUse, cmmcaMpaRtActiveRegisteredSipAddresses=cmmcaMpaRtActiveRegisteredSipAddresses, cmmcaServiceStatus=cmmcaServiceStatus, cmmcaNextNodeName=cmmcaNextNodeName, cmmcaRdaEntry=cmmcaRdaEntry, cmmcaRsAggTotalResourceTaskDetailRecords=cmmcaRsAggTotalResourceTaskDetailRecords, cmmcaCmAggAvgCallDurationTime=cmmcaCmAggAvgCallDurationTime, cmmcaRsAggTotalContactSegmentDetailRecords=cmmcaRsAggTotalContactSegmentDetailRecords, cmmcaCmAggMaxCallInQueueTime=cmmcaCmAggMaxCallInQueueTime, cmmcaBreAggLoadedScripts=cmmcaBreAggLoadedScripts, cmmcaWaRtSkillCount=cmmcaWaRtSkillCount, cmmcaRsIntDBWrites=cmmcaRsIntDBWrites, cmmcaRaAggNodeSyncDispatched=cmmcaRaAggNodeSyncDispatched, cmmcaRsIntContactDetailRecords=cmmcaRsIntContactDetailRecords, cmmcaWaRtAttributeDefCount=cmmcaWaRtAttributeDefCount, cmmcaThreadPool=cmmcaThreadPool, cmmcaEnvMaxThreadsUsed=cmmcaEnvMaxThreadsUsed, cmmcaBreRtCurrentInstances=cmmcaBreRtCurrentInstances, cmmcaCmAggMaxCallDurationTime=cmmcaCmAggMaxCallDurationTime, cmmcaBreGroup=cmmcaBreGroup, cmmcaMpaAggTotalRegisteredSipAddresses=cmmcaMpaAggTotalRegisteredSipAddresses, cmmcaTPoolRtMaxThreadsUsed=cmmcaTPoolRtMaxThreadsUsed, cmmcaTimeZoneOffsetHours=cmmcaTimeZoneOffsetHours, cmmcaRsGroup=cmmcaRsGroup, cmmcaIcmgwAggACMIMsgsSent=cmmcaIcmgwAggACMIMsgsSent, cmmcaWaRtAttributeCriteriaCount=cmmcaWaRtAttributeCriteriaCount, cmmcaDeviceName=cmmcaDeviceName, cmmcaRaAggContactDetailAttribMsgDispatched=cmmcaRaAggContactDetailAttribMsgDispatched, cmmcaRtMessageThroughput=cmmcaRtMessageThroughput, cmmcaRaAggResourceTaskDetailMsgDispatched=cmmcaRaAggResourceTaskDetailMsgDispatched, cmmcaCmAggMaxCallArrivalRate=cmmcaCmAggMaxCallArrivalRate, cmmcaMpaAggTotalMonitoredPresenceAddressesRegistered=cmmcaMpaAggTotalMonitoredPresenceAddressesRegistered, cmmcaRaAggMsgReceived=cmmcaRaAggMsgReceived, cmmcaBreIntTotalResourceInstanceInitiations=cmmcaBreIntTotalResourceInstanceInitiations, cmmcaCmIntMaxCallDurationTime=cmmcaCmIntMaxCallDurationTime, cmmcaEnvRtMaxMemUsed=cmmcaEnvRtMaxMemUsed, cmmcaGeneralInfoGroup=cmmcaGeneralInfoGroup, cmmcaNextNodeTable=cmmcaNextNodeTable, cmmcaRaAggContactSegDetailMesgDispatched=cmmcaRaAggContactSegDetailMesgDispatched, cmmcaCmRtNumCallConnecting=cmmcaCmRtNumCallConnecting, ciscoMmodalContactAppsMIBCompliances=ciscoMmodalContactAppsMIBCompliances, cmmcaWaAggResourceResponseSent=cmmcaWaAggResourceResponseSent, cmmcaBreAggTotalAbnormalEndings=cmmcaBreAggTotalAbnormalEndings, cmmcaCmAggNumCallArrivals=cmmcaCmAggNumCallArrivals)
