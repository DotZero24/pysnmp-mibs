...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MMODAL-CONTACT-APPS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:23:10 2025
...
_CmmcaEnableNotifications_Type.__name__ = "TruthValue"
...
ciscoMmodalContactAppsMIBComplianceRev.setObjects(
      *(("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaGeneralInfoGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaLicenseInfoGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaThreadPoolGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaRuntimeInfoGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaServiceGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaRmGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaCmGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaRdaGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaBreGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaWaGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaMpaGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaRaGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaRsGroup"),
        ("CISCO-MMODAL-CONTACT-APPS-MIB", "cmmcaNotificationInfoGroup"),
