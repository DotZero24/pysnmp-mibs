...
mibBuilder.exportSymbols("CISCO-MMODAL-CONTACT-APPS-MIB", cmmcaRaAggContactDetailMesgReceived=cmmcaRaAggContactDetailMesgReceived, cmmcaEventText=cmmcaEventText, cmmcaMaxThreadsAvailable=cmmcaMaxThreadsAvailable, cmmcaWaAggResyncResourceSent=cmmcaWaAggResyncResourceSent, cmmcaWaRtSelectionStrategyAttrCount=cmmcaWaRtSelectionStrategyAttrCount, cmmcaMpaRtTotalPublishAddressesRegistered=cmmcaMpaRtTotalPublishAddressesRegistered, cmmcaWaRtResourceCount=cmmcaWaRtResourceCount, cmmcaRaAggNodeSyncDispatched=cmmcaRaAggNodeSyncDispatched, cmmcaServiceIntPeriod=cmmcaServiceIntPeriod, cmmcaWaAggRRIFailureResponseSent=cmmcaWaAggRRIFailureResponseSent, cmmcaThreadPool=cmmcaThreadPool, cmmcaMpaAggTotalCalls=cmmcaMpaAggTotalCalls, cmmcaNextNodeEntry=cmmcaNextNodeEntry, cmmcaMpaAggTotalClientsRegistered=cmmcaMpaAggTotalClientsRegistered, cmmcaMpaRtActiveMonitoredPresenceAddresses=cmmcaMpaRtActiveMonitoredPresenceAddresses, cmmcaWaAggResyncResourceResponseReceived=cmmcaWaAggResyncResourceResponseReceived, cmmcaServerName=cmmcaServerName, cmmcaRtMessageThroughput=cmmcaRtMessageThroughput, cmmcaMpaAggInstantMessagesSent=cmmcaMpaAggInstantMessagesSent, cmmcaMpaAggNewCalls=cmmcaMpaAggNewCalls, cmmcaWaRtTotalResourceManagerCount=cmmcaWaRtTotalResourceManagerCount, cmmcaCmAggMaxCallArrivalRate=cmmcaCmAggMaxCallArrivalRate, cmmcaRdaEntry=cmmcaRdaEntry, cmmcaRtMsgQMemPercentUsage=cmmcaRtMsgQMemPercentUsage, cmmcaMpaAggTotalSipControlAddressesRegistered=cmmcaMpaAggTotalSipControlAddressesRegistered, cmmcaNextNodeIndex=cmmcaNextNodeIndex, cmmcaMpaTable=cmmcaMpaTable, cmmcaRtLicensesAvailable=cmmcaRtLicensesAvailable, CmmcaConditionStatus=CmmcaConditionStatus, cmmcaRaAggContactSegDetailMesgDispatched=cmmcaRaAggContactSegDetailMesgDispatched, cmmcaMpaRtActivePublishAddresses=cmmcaMpaRtActivePublishAddresses, cmmcaBreAggMaxConcurrentInstances=cmmcaBreAggMaxConcurrentInstances, cmmcaRmRtAgentsReady=cmmcaRmRtAgentsReady, cmmcaRsIntResourceTaskDetailRecords=cmmcaRsIntResourceTaskDetailRecords, cmmcaTimeZoneOffsetMinutes=cmmcaTimeZoneOffsetMinutes, cmmcaBreRtCurrentInstances=cmmcaBreRtCurrentInstances, cmmcaDeviceInetAddressType=cmmcaDeviceInetAddressType, cmmcaMpaAggTotalMonitoredPresenceAddressesRegistered=cmmcaMpaAggTotalMonitoredPresenceAddressesRegistered, cmmcaRaTable=cmmcaRaTable, CmmcaSystemConditionStatus=CmmcaSystemConditionStatus, cmmcaRsAggTotalDBWrites=cmmcaRsAggTotalDBWrites, cmmcaMpaRtActiveSipControlAddresses=cmmcaMpaRtActiveSipControlAddresses, cmmcaTPoolRtMaxThreadsUsed=cmmcaTPoolRtMaxThreadsUsed, cmmcaCmRtNumActiveCalls=cmmcaCmRtNumActiveCalls, cmmcaBreIntMaxConcurrentInstancesDt=cmmcaBreIntMaxConcurrentInstancesDt, cmmcaBreAggAvgConcurrentInstances=cmmcaBreAggAvgConcurrentInstances, cmmcaIcmgwTable=cmmcaIcmgwTable, cmmcaRdaRtNumInactiveClients=cmmcaRdaRtNumInactiveClients, cmmcaWaGroup=cmmcaWaGroup, cmmcaTimeZoneOffsetHours=cmmcaTimeZoneOffsetHours, cmmcaWaAggResourceRequestReceived=cmmcaWaAggResourceRequestReceived, cmmcaMpaRtOutgoingCalls=cmmcaMpaRtOutgoingCalls, cmmcaBreAggTotalAbnormalResourceEndings=cmmcaBreAggTotalAbnormalResourceEndings, cmmcaNotificationInfoGroup=cmmcaNotificationInfoGroup, cmmcaNextNodeIpAddr=cmmcaNextNodeIpAddr, cmmcaRmRtAgentsLoggedIn=cmmcaRmRtAgentsLoggedIn, cmmcaCmAggAvgCallDurationTime=cmmcaCmAggAvgCallDurationTime, cmmcaBreAggTotalAbnormalContactEndings=cmmcaBreAggTotalAbnormalContactEndings, cmmcaCmRtNumCallTransferring=cmmcaCmRtNumCallTransferring, cmmcaRmIntNumOffersReject=cmmcaRmIntNumOffersReject, cmmcaWaRtAttributeCriteriaCount=cmmcaWaRtAttributeCriteriaCount, cmmcaRsIntResourceEventDetailRecords=cmmcaRsIntResourceEventDetailRecords, cmmcaEventHostName=cmmcaEventHostName, cmmcaWaAggResyncResourceResponseAckSent=cmmcaWaAggResyncResourceResponseAckSent, cmmcaRsIntAssignmentQueDetailRecords=cmmcaRsIntAssignmentQueDetailRecords, cmmcaClusterId=cmmcaClusterId, cmmcaWaAggWorkRequestCanceledSent=cmmcaWaAggWorkRequestCanceledSent, cmmcaRtCongested=cmmcaRtCongested, cmmcaMpaRtActiveIMAddresses=cmmcaMpaRtActiveIMAddresses, cmmcaRsIntAssignmentQueAttribRecords=cmmcaRsIntAssignmentQueAttribRecords, cmmcaRaAggVersionResponseRecieved=cmmcaRaAggVersionResponseRecieved, cmmcaWaAggOfferTaskSent=cmmcaWaAggOfferTaskSent, cmmcaCmIntNumCallArrivals=cmmcaCmIntNumCallArrivals, cmmcaWaAggTotalConfigErrors=cmmcaWaAggTotalConfigErrors, cmmcaWaRtAssignmentQueCount=cmmcaWaRtAssignmentQueCount, cmmcaCmRtNumCallRejecting=cmmcaCmRtNumCallRejecting, cmmcaMpaAggTotalIMAddressesRegistered=cmmcaMpaAggTotalIMAddressesRegistered, cmmcaNotificationInfo=cmmcaNotificationInfo, cmmcaRmTable=cmmcaRmTable, cmmcaMpaAggAvgLatency=cmmcaMpaAggAvgLatency, cmmcaWaAggWRIFailureResponseSent=cmmcaWaAggWRIFailureResponseSent, cmmcaRdaRtNumOutStandingOfferTasks=cmmcaRdaRtNumOutStandingOfferTasks, cmmcaServiceName=cmmcaServiceName, cmmcaRsIntContactDetailAttribRecords=cmmcaRsIntContactDetailAttribRecords, cmmcaBreIntTotalAbnormalResourceEndings=cmmcaBreIntTotalAbnormalResourceEndings, cmmcaBreTable=cmmcaBreTable, cmmcaBreRtActiveScripts=cmmcaBreRtActiveScripts, cmmcaServiceStatus=cmmcaServiceStatus, cmmcaMpaRtActiveInteractions=cmmcaMpaRtActiveInteractions, cmmcaClusterInfoEntry=cmmcaClusterInfoEntry, cmmcaRsAggTotalAssignmentQueAttribRecords=cmmcaRsAggTotalAssignmentQueAttribRecords, cmmcaWaRtSelectionStrategyCount=cmmcaWaRtSelectionStrategyCount, cmmcaRdaRtNumActiveClients=cmmcaRdaRtNumActiveClients, cmmcaIcmgwRtACMIOutQueueWait=cmmcaIcmgwRtACMIOutQueueWait, cmmcaDeviceType=cmmcaDeviceType, cmmcaRaAggMsgReceived=cmmcaRaAggMsgReceived, cmmcaDeviceName=cmmcaDeviceName, cmmcaNextNodeName=cmmcaNextNodeName, cmmcaRdaAggNumSuccessPresenceNotifications=cmmcaRdaAggNumSuccessPresenceNotifications, CmmcaServiceStatus=CmmcaServiceStatus, cmmcaCmTable=cmmcaCmTable, cmmcaRtTraceMask=cmmcaRtTraceMask, cmmcaBreAggTotalInstanceTerminations=cmmcaBreAggTotalInstanceTerminations, cmmcaIcmgwAggACMIBytesRcvd=cmmcaIcmgwAggACMIBytesRcvd, cmmcaRmRtAgentsWrapUp=cmmcaRmRtAgentsWrapUp, cmmcaBreIntTotalContactInstanceInitiations=cmmcaBreIntTotalContactInstanceInitiations, cmmcaTPoolRtMaxThreadsAvail=cmmcaTPoolRtMaxThreadsAvail, cmmcaRdaIntNumUnSuccessPresenceNotifications=cmmcaRdaIntNumUnSuccessPresenceNotifications, cmmcaRsEntry=cmmcaRsEntry, cmmcaRaAggResourceStateChngMsgDispatched=cmmcaRaAggResourceStateChngMsgDispatched, cmmcaRmAggNumOffersAccept=cmmcaRmAggNumOffersAccept, cmmcaBreIntTotalInstanceInitiations=cmmcaBreIntTotalInstanceInitiations, cmmcaIcmgwRtGetContactDetailDelay=cmmcaIcmgwRtGetContactDetailDelay, cmmcaBreIntTotalResourceInstanceInitiations=cmmcaBreIntTotalResourceInstanceInitiations, cmmcaIcmgwRtPendingCallTermEvents=cmmcaIcmgwRtPendingCallTermEvents, cmmcaDeviceIndex=cmmcaDeviceIndex, cmmcaNextNodeType=cmmcaNextNodeType, cmmcaWaEntry=cmmcaWaEntry, cmmcaRsIntContactSegmentDetailRecords=cmmcaRsIntContactSegmentDetailRecords, cmmcaCmAggAvgCallArrivalRate=cmmcaCmAggAvgCallArrivalRate, cmmcaRaAggTaskStateChangeMsgReceived=cmmcaRaAggTaskStateChangeMsgReceived, cmmcaRaAggResourceTaskDetailMsgReceived=cmmcaRaAggResourceTaskDetailMsgReceived, CmmcaIndex=CmmcaIndex, cmmcaIcmgwAggGetContactDetailTimeouts=cmmcaIcmgwAggGetContactDetailTimeouts, cmmcaRdaAggNumMsgProc=cmmcaRdaAggNumMsgProc, cmmcaEnvMaxThreadsUsed=cmmcaEnvMaxThreadsUsed, cmmcaRsRtDBStatus=cmmcaRsRtDBStatus, cmmcaMpaEntry=cmmcaMpaEntry, cmmcaEventMessageId=cmmcaEventMessageId, cmmcaTPoolRtRunningThreads=cmmcaTPoolRtRunningThreads, cmmcaRsTable=cmmcaRsTable, cmmcaBreIntMaxConcurrentInstances=cmmcaBreIntMaxConcurrentInstances, cmmcaLicenseInfoGroup=cmmcaLicenseInfoGroup, cmmcaServiceGroup=cmmcaServiceGroup, cmmcaRuntimeInfo=cmmcaRuntimeInfo, cmmcaEventSeverity=cmmcaEventSeverity, cmmcaMpaRtActiveRegisteredSipAddresses=cmmcaMpaRtActiveRegisteredSipAddresses, cmmcaRaAggVersionRequestDispatched=cmmcaRaAggVersionRequestDispatched, cmmcaBreIntTotalInstanceTerminations=cmmcaBreIntTotalInstanceTerminations, CmmcaSeverityLevel=CmmcaSeverityLevel, cmmcaEnableNotifications=cmmcaEnableNotifications, cmmcaRsRtDBSpaceFree=cmmcaRsRtDBSpaceFree, cmmcaIcmgwRtPendingQueryAgentStateDlgs=cmmcaIcmgwRtPendingQueryAgentStateDlgs, cmmcaRsRtNumberActiveDBUserSessions=cmmcaRsRtNumberActiveDBUserSessions, cmmcaRmIntNumOffersAccept=cmmcaRmIntNumOffersAccept, cmmcaRtRoutingDomain=cmmcaRtRoutingDomain, cmmcaBreAggTotalContactInstanceTerminations=cmmcaBreAggTotalContactInstanceTerminations, cmmcaBreIntTotalAbnormalEndings=cmmcaBreIntTotalAbnormalEndings, cmmcaRsIntDBWrites=cmmcaRsIntDBWrites, cmmcaSystemConditionTable=cmmcaSystemConditionTable, cmmcaRmAggNumOffersTimedOut=cmmcaRmAggNumOffersTimedOut, cmmcaGeneralInfoGroup=cmmcaGeneralInfoGroup, cmmcaRmIntNumOffersTimedOut=cmmcaRmIntNumOffersTimedOut, cmmcaCmAggMaxCallDurationTime=cmmcaCmAggMaxCallDurationTime, ciscoMmodalContactAppsMIBObjects=ciscoMmodalContactAppsMIBObjects, cmmcaMpaRtIncomingCalls=cmmcaMpaRtIncomingCalls, cmmcaRsDBSizeAllocated=cmmcaRsDBSizeAllocated, cmmcaRsRtDBSpaceUsed=cmmcaRsRtDBSpaceUsed, cmmcaMpaAggFailedReinvites=cmmcaMpaAggFailedReinvites, cmmcaRuntimeInfoGroup=cmmcaRuntimeInfoGroup, cmmcaWaRtAttributeValueCount=cmmcaWaRtAttributeValueCount, cmmcaEnvRtMaxMemUsed=cmmcaEnvRtMaxMemUsed, cmmcaRtUptime=cmmcaRtUptime, cmmcaRaAggResourceStateChngMesgReceived=cmmcaRaAggResourceStateChngMesgReceived, cmmcaCmIntMaxCallDurationTime=cmmcaCmIntMaxCallDurationTime, cmmcaRaEntry=cmmcaRaEntry, cmmcaCmAggMaxCallInQueueTimeDt=cmmcaCmAggMaxCallInQueueTimeDt, cmmcaMaxMsgQMemAvail=cmmcaMaxMsgQMemAvail, cmmcaBreGroup=cmmcaBreGroup, cmmcaCmIntAvgCallInQueueTime=cmmcaCmIntAvgCallInQueueTime, cmmcaRaAggContactDetailMesgDispatched=cmmcaRaAggContactDetailMesgDispatched, cmmcaRaGroup=cmmcaRaGroup, cmmcaWaAggOfferTaskCancelledSent=cmmcaWaAggOfferTaskCancelledSent, cmmcaBreAggTotalAbnormalEndings=cmmcaBreAggTotalAbnormalEndings, cmmcaSystemConditionStatus=cmmcaSystemConditionStatus, cmmcaRtThreadsInUse=cmmcaRtThreadsInUse, cmmcaIcmgwAggQueryAgentStateTimeouts=cmmcaIcmgwAggQueryAgentStateTimeouts, cmmcaMpaAggTotalRegisteredSipAddresses=cmmcaMpaAggTotalRegisteredSipAddresses, cmmcaMpaAggPresenceUpdatesReceived=cmmcaMpaAggPresenceUpdatesReceived, cmmcaSystemConditionMessage=cmmcaSystemConditionMessage, cmmcaRmRtAgentsOnCalls=cmmcaRmRtAgentsOnCalls, cmmcaEnvRtCurrThreadsInUse=cmmcaEnvRtCurrThreadsInUse, cmmcaIcmgwRtPendingGetContactDetailDlgs=cmmcaIcmgwRtPendingGetContactDetailDlgs, cmmcaEventsGroup=cmmcaEventsGroup, cmmcaSystemConditionSeverity=cmmcaSystemConditionSeverity, cmmcaCmAggMaxCallInQueueTime=cmmcaCmAggMaxCallInQueueTime, cmmcaServiceIndex=cmmcaServiceIndex, CmmcaServiceType=CmmcaServiceType, cmmcaIcmgwAggSocketConnects=cmmcaIcmgwAggSocketConnects, cmmcaServices=cmmcaServices, cmmcaCmEntry=cmmcaCmEntry, ciscoMmodalContactAppsMIBConform=ciscoMmodalContactAppsMIBConform, cmmcaServiceEntry=cmmcaServiceEntry, cmmcaWaRtResourceCriteriaCount=cmmcaWaRtResourceCriteriaCount, cmmcaTotalLicensesConfigured=cmmcaTotalLicensesConfigured, cmmcaEventTimestamp=cmmcaEventTimestamp, cmmcaWaTable=cmmcaWaTable, cmmcaCmIntMaxCallInQueueTime=cmmcaCmIntMaxCallInQueueTime, cmmcaMIBEvent=cmmcaMIBEvent, cmmcaBreAggLoadedScripts=cmmcaBreAggLoadedScripts, cmmcaRsIntContactDetailRecords=cmmcaRsIntContactDetailRecords, cmmcaWaAggResourceResponseCanceledSent=cmmcaWaAggResourceResponseCanceledSent, cmmcaRmRtAgentsNoQueue=cmmcaRmRtAgentsNoQueue, cmmcaSystemConditionIndex=cmmcaSystemConditionIndex, cmmcaTPoolRtIdleThreads=cmmcaTPoolRtIdleThreads, cmmcaWaAggQueueEventSent=cmmcaWaAggQueueEventSent, cmmcaBreAggTotalInstanceInitiations=cmmcaBreAggTotalInstanceInitiations, cmmcaCmIntMaxCallDurationTimeDt=cmmcaCmIntMaxCallDurationTimeDt, cmmcaBreIntTotalResourceInstanceTerminations=cmmcaBreIntTotalResourceInstanceTerminations, cmmcaRsAggTotalAssignmentQueDetailRecords=cmmcaRsAggTotalAssignmentQueDetailRecords, cmmcaSystemStatus=cmmcaSystemStatus, cmmcaRmGroup=cmmcaRmGroup, cmmcaBreAggDistinctScripts=cmmcaBreAggDistinctScripts, cmmcaRsRtTransactionLogSize=cmmcaRsRtTransactionLogSize, cmmcaEventMessageName=cmmcaEventMessageName, cmmcaStartTime=cmmcaStartTime, cmmcaCmGroup=cmmcaCmGroup, cmmcaWaRtAttributeDefCount=cmmcaWaRtAttributeDefCount, cmmcaWaRtSkillCount=cmmcaWaRtSkillCount, cmmcaCmIntMaxCallInQueueTimeDt=cmmcaCmIntMaxCallInQueueTimeDt, cmmcaBreAggTotalResourceInstanceTerminations=cmmcaBreAggTotalResourceInstanceTerminations, cmmcaMpaAggFailedInvites=cmmcaMpaAggFailedInvites, cmmcaMpaAggPresenceUpdatesBytesRcv=cmmcaMpaAggPresenceUpdatesBytesRcv, PYSNMP_MODULE_ID=ciscoMmodalContactAppsMIB, cmmcaRtLogLevel=cmmcaRtLogLevel, cmmcaWaRtTotalResourceCount=cmmcaWaRtTotalResourceCount, cmmcaWaAggOfferTaskAcceptedSent=cmmcaWaAggOfferTaskAcceptedSent, cmmcaIcmgwAggACMIBytesSent=cmmcaIcmgwAggACMIBytesSent, cmmcaNextNodeIpAddrType=cmmcaNextNodeIpAddrType, cmmcaRmRtAgentsReserved=cmmcaRmRtAgentsReserved, cmmcaWaAggOfferTaskResponseReceived=cmmcaWaAggOfferTaskResponseReceived, cmmcaWaAggMessageSentError=cmmcaWaAggMessageSentError, cmmcaIcmgwAggSocketDisconnects=cmmcaIcmgwAggSocketDisconnects, cmmcaWaAggCancelWorkRequestReceived=cmmcaWaAggCancelWorkRequestReceived, cmmcaBreIntTotalAbnormalContactEndings=cmmcaBreIntTotalAbnormalContactEndings, cmmcaLicenseInfo=cmmcaLicenseInfo, cmmcaDeviceStatus=cmmcaDeviceStatus, cmmcaRdaTable=cmmcaRdaTable, cmmcaRmAggNumOffersReject=cmmcaRmAggNumOffersReject, cmmcaCmRtNumCallConnected=cmmcaCmRtNumCallConnected, cmmcaWaRtTotalContactCount=cmmcaWaRtTotalContactCount, cmmcaLocalDeviceType=cmmcaLocalDeviceType, cmmcaWaAggCancelQueueEventSent=cmmcaWaAggCancelQueueEventSent, cmmcaWaRtSkillCompetencyCount=cmmcaWaRtSkillCompetencyCount, cmmcaTPoolRtCoreThreads=cmmcaTPoolRtCoreThreads, cmmcaBreAggTotalResourceInstanceInitiations=cmmcaBreAggTotalResourceInstanceInitiations, cmmcaEnvRtCurrMemUsed=cmmcaEnvRtCurrMemUsed, cmmcaCmAggNumCallArrivals=cmmcaCmAggNumCallArrivals, ciscoMmodalContactAppsMIB=ciscoMmodalContactAppsMIB, cmmcaIcmgwAggACMIMsgsRcvd=cmmcaIcmgwAggACMIMsgsRcvd, cmmcaIcmgwRtAgentsMonitored=cmmcaIcmgwRtAgentsMonitored, cmmcaRsGroup=cmmcaRsGroup, cmmcaCmRtNumCallInitial=cmmcaCmRtNumCallInitial, cmmcaWaRtTotalContactManagerCount=cmmcaWaRtTotalContactManagerCount)
mibBuilder.exportSymbols("CISCO-MMODAL-CONTACT-APPS-MIB", cmmcaTimeZoneName=cmmcaTimeZoneName, cmmcaRsIntContactSegmentMediaDetailRecords=cmmcaRsIntContactSegmentMediaDetailRecords, cmmcaNextNodeTable=cmmcaNextNodeTable, cmmcaRsAggTotalResourceTaskDetailRecords=cmmcaRsAggTotalResourceTaskDetailRecords, cmmcaCmAggMaxCallDurationTimeDt=cmmcaCmAggMaxCallDurationTimeDt, cmmcaServiceInfo=cmmcaServiceInfo, cmmcaRdaGroup=cmmcaRdaGroup, cmmcaRaAggContactSegMediaDetailMsgDispatched=cmmcaRaAggContactSegMediaDetailMsgDispatched, ciscoMmodalContactAppsMIBComplianceRev=ciscoMmodalContactAppsMIBComplianceRev, cmmcaRsAggTotalContactSegmentDetailRecords=cmmcaRsAggTotalContactSegmentDetailRecords, cmmcaCmRtNumCallTerminating=cmmcaCmRtNumCallTerminating, cmmcaSystemConditionTimeStamp=cmmcaSystemConditionTimeStamp, cmmcaSystemConditionId=cmmcaSystemConditionId, cmmcaMpaRtActiveClientSessions=cmmcaMpaRtActiveClientSessions, cmmcaEventState=cmmcaEventState, cmmcaIcmgwAggACMIMsgsSent=cmmcaIcmgwAggACMIMsgsSent, cmmcaThreadPoolGroup=cmmcaThreadPoolGroup, cmmcaSystemConditionEntry=cmmcaSystemConditionEntry, cmmcaRsRtDBPercentUsed=cmmcaRsRtDBPercentUsed, cmmcaIcmgwRtQueryAgentStateDelay=cmmcaIcmgwRtQueryAgentStateDelay, cmmcaEnvRtCurrMemAvail=cmmcaEnvRtCurrMemAvail, ciscoMmodalContactAppsMIBGroups=ciscoMmodalContactAppsMIBGroups, cmmcaEventAppName=cmmcaEventAppName, cmmcaIcmgwRtAqsMonitored=cmmcaIcmgwRtAqsMonitored, cmmcaWaAggWorkRequestReceived=cmmcaWaAggWorkRequestReceived, cmmcaMpaAggConnectsRcv=cmmcaMpaAggConnectsRcv, cmmcaCmRtNumCallRingBack=cmmcaCmRtNumCallRingBack, ciscoMmodalContactAppsMIBCompliances=ciscoMmodalContactAppsMIBCompliances, cmmcaRaAggMsgSent=cmmcaRaAggMsgSent, cmmcaEnvRtUpTime=cmmcaEnvRtUpTime, cmmcaBreIntTotalContactInstanceTerminations=cmmcaBreIntTotalContactInstanceTerminations, cmmcaDeviceDescription=cmmcaDeviceDescription, cmmcaCmRtNumCallConnecting=cmmcaCmRtNumCallConnecting, cmmcaIcmgwRtACMIOutQueueDepth=cmmcaIcmgwRtACMIOutQueueDepth, cmmcaBreAggTotalContactInstanceInitiations=cmmcaBreAggTotalContactInstanceInitiations, cmmcaVersion=cmmcaVersion, cmmcaIcmgwEntry=cmmcaIcmgwEntry, cmmcaBreAggMaxConcurrentInstancesDt=cmmcaBreAggMaxConcurrentInstancesDt, CmmcaNextNodeStatus=CmmcaNextNodeStatus, cmmcaCmAggMaxCallArrivalRateDt=cmmcaCmAggMaxCallArrivalRateDt, cmmcaDeviceInetAddress=cmmcaDeviceInetAddress, cmmcaRsAggTotalContactSegmentMediaDetailRecords=cmmcaRsAggTotalContactSegmentMediaDetailRecords, cmmcaNextNodeStatus=cmmcaNextNodeStatus, cmmcaRsAggTotalContactDetailRecords=cmmcaRsAggTotalContactDetailRecords, cmmcaEnvRtMaxMemAvail=cmmcaEnvRtMaxMemAvail, cmmcaCmAggAvgCallInQueueTime=cmmcaCmAggAvgCallInQueueTime, cmmcaRaAggContactSegDetailMsgReceived=cmmcaRaAggContactSegDetailMsgReceived, cmmcaRdaAggNumUnSuccessPresenceNotifications=cmmcaRdaAggNumUnSuccessPresenceNotifications, cmmcaWaRtResourceMemberCount=cmmcaWaRtResourceMemberCount, cmmcaRaAggContactDetailAttribMsgDispatched=cmmcaRaAggContactDetailAttribMsgDispatched, cmmcaSystemConditionDescription=cmmcaSystemConditionDescription, cmmcaWaAggResourceResponseSent=cmmcaWaAggResourceResponseSent, cmmcaClusterInfoTable=cmmcaClusterInfoTable, cmmcaRaAggResourceTaskDetailMsgDispatched=cmmcaRaAggResourceTaskDetailMsgDispatched, cmmcaServiceType=cmmcaServiceType, cmmcaCmRtNumCallTrying=cmmcaCmRtNumCallTrying, cmmcaDescription=cmmcaDescription, cmmcaMpaGroup=cmmcaMpaGroup, cmmcaCmIntAvgCallDurationTime=cmmcaCmIntAvgCallDurationTime, cmmcaGeneralInfo=cmmcaGeneralInfo, cmmcaRsRtDBPercentFree=cmmcaRsRtDBPercentFree, cmmcaRdaIntNumSuccessPresenceNotifications=cmmcaRdaIntNumSuccessPresenceNotifications, cmmcaRsAggTotalContactDetailAttributeRecords=cmmcaRsAggTotalContactDetailAttributeRecords, cmmcaBreEntry=cmmcaBreEntry, cmmcaServiceTable=cmmcaServiceTable, cmmcaRmEntry=cmmcaRmEntry, cmmcaBreIntAvgConcurrentInstances=cmmcaBreIntAvgConcurrentInstances, ciscoMmodalContactAppsMIBNotifs=ciscoMmodalContactAppsMIBNotifs, cmmcaMpaAggInstantMessagesReceived=cmmcaMpaAggInstantMessagesReceived, cmmcaWaAggCancelResourceRequestReceived=cmmcaWaAggCancelResourceRequestReceived, cmmcaRtMsgReceived=cmmcaRtMsgReceived, cmmcaRdaIntNumMsgProc=cmmcaRdaIntNumMsgProc, cmmcaIcmgwGroup=cmmcaIcmgwGroup, cmmcaRsAggTotalResourceEventDetailRecords=cmmcaRsAggTotalResourceEventDetailRecords, cmmcaCmIntAvgCallArrivalRate=cmmcaCmIntAvgCallArrivalRate, cmmcaOpsConsoleURL=cmmcaOpsConsoleURL, cmmcaIcmgwRtRoutesMonitored=cmmcaIcmgwRtRoutesMonitored)
