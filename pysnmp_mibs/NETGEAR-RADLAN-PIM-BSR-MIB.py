# SNMP MIB module (NETGEAR-RADLAN-PIM-BSR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-PIM-BSR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:25:23 2025
...
rlPimBsrCandidateRPEntry = _RlPimBsrCandidateRPEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 220, 1)
)
rlPimBsrCandidateRPEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-PIM-BSR-MIB", "rlPimBsrCandidateRPAddressType"),
    (0, "NETGEAR-RADLAN-PIM-BSR-MIB", "rlPimBsrCandidateRPAddress"),
)
if mibBuilder.loadTexts:
