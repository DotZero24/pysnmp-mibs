# SNMP MIB module (GSM7324-QOS-ACL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/GSM7324-QOS-ACL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:34 2025
...
gsm7324QOSACL = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2)
)
if mibBuilder.loadTexts:
    gsm7324QOSACL.setRevisions(
        ("2003-05-06 12:00",)
    )
...
aclIndex = _AclIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 1, 1, 1),
    _AclIndex_Type()
)
...
aclStatus = _AclStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 1, 1, 3),
    _AclStatus_Type()
)
...
aclIfTable = _AclIfTable_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 2)
)
if mibBuilder.loadTexts:
    aclIfTable.setStatus("current")
_AclIfEntry_Object = MibTableRow
aclIfEntry = _AclIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 2, 1)
)
aclIfEntry.setIndexNames(
    (0, "GSM7324-QOS-ACL-MIB", "aclIndex"),
    (0, "GSM7324-QOS-ACL-MIB", "aclIfIndex"),
    (0, "GSM7324-QOS-ACL-MIB", "aclIfDirection"),
)
if mibBuilder.loadTexts:
...
aclIfIndex = _AclIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 2, 1, 1),
    _AclIfIndex_Type()
)
...
aclIfDirection = _AclIfDirection_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 2, 1, 2),
...
aclIfStatus = _AclIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 2, 1, 3),
    _AclIfStatus_Type()
)
...
aclRuleIndex = _AclRuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 1),
    _AclRuleIndex_Type()
)
...
aclRuleAction = _AclRuleAction_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 2),
    _AclRuleAction_Type()
)
...
aclRuleProtocol = _AclRuleProtocol_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 3),
...
aclRuleSrcIpAddress = _AclRuleSrcIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 4),
...
aclRuleSrcIpMask = _AclRuleSrcIpMask_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 5),
...
aclRuleSrcL4Port = _AclRuleSrcL4Port_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 6),
...
aclRuleSrcL4PortRangeStart = _AclRuleSrcL4PortRangeStart_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 7),
...
aclRuleSrcL4PortRangeEnd = _AclRuleSrcL4PortRangeEnd_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 8),
...
aclRuleDestIpAddress = _AclRuleDestIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 9),
...
aclRuleDestIpMask = _AclRuleDestIpMask_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 10),
...
aclRuleDestL4Port = _AclRuleDestL4Port_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 11),
...
aclRuleDestL4PortRangeStart = _AclRuleDestL4PortRangeStart_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 12),
...
aclRuleDestL4PortRangeEnd = _AclRuleDestL4PortRangeEnd_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 13),
...
aclRuleIPDSCP = _AclRuleIPDSCP_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 14),
    _AclRuleIPDSCP_Type()
)
...
aclRuleIpPrecedence = _AclRuleIpPrecedence_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 15),
...
aclRuleIpTosBits = _AclRuleIpTosBits_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 16),
...
aclRuleIpTosMask = _AclRuleIpTosMask_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 17),
...
aclRuleStatus = _AclRuleStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 2, 3, 1, 18),
    _AclRuleStatus_Type()
)
