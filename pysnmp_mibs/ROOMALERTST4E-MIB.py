...
ROOMALERTST4E=_ROOMALERTST4E_ObjectIdentity((1,3,6,1,4,1,20916,1,6))
...
room_alert_st4e_snmp_trap=NotificationType((1,3,6,1,4,1,20916,1,6,0,2))
room_alert_st4e_snmp_trap.setObjects((_G,_H))
if mibBuilder.loadTexts:room_alert_st4e_snmp_trap.setStatus('')
mibBuilder.exportSymbols(_G,**{'avtech':avtech,'products':products,'ROOMALERTST4E':ROOMALERTST4E,'room-alert-st4e-snmp-trap':room_alert_st4e_snmp_trap,'sensors':sensors,'internal':internal,'temperature':temperature,'internal-tempf':internal_tempf,'internal-tempc':internal_tempc,'humidity':humidity,'internal-humidity':internal_humidity,'heat-index':heat_index,'internal-heat-index':internal_heat_index,'digital':digital,'digital-sen1':digital_sen1,'digital-sen1-1':digital_sen1_1,'digital-sen1-2':digital_sen1_2,'digital-sen1-3':digital_sen1_3,'digital-sen1-4':digital_sen1_4,'digital-sen2':digital_sen2,'digital-sen2-1':digital_sen2_1,'digital-sen2-2':digital_sen2_2,'digital-sen2-3':digital_sen2_3,'digital-sen2-4':digital_sen2_4,'switch':switch,'switch-sen1':switch_sen1,'signaltower':signaltower,'red-led':red_led,'amber-led':amber_led,'green-led':green_led,'blue-led':blue_led,'white-led':white_led,'alarm1':alarm1,'alarm2':alarm2,'traps':traps,_H:alarmmessage})