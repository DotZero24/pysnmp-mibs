...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-TELEPRESENCE-CALL-MIB
...
DisplayString, VariablePointer, RowStatus, DateAndTime, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "VariablePointer", "RowStatus", "DateAndTime", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-TELEPRESENCE-CALL-MIB", ctpcRxTotalBytes=ctpcRxTotalBytes, ctpcAvgPeriodLatency=ctpcAvgPeriodLatency, ctpcTxCallBitRate=ctpcTxCallBitRate, ctpcMgmtSysConnEventHistory=ctpcMgmtSysConnEventHistory, ctpcRowStatus=ctpcRowStatus, ctpcMaxCallJitter=ctpcMaxCallJitter, ctpcMgmtSysConnEventHistLastIndex=ctpcMgmtSysConnEventHistLastIndex, CtpcStatAlarmMode=CtpcStatAlarmMode, ciscoTpCallInformationGroupSup2=ciscoTpCallInformationGroupSup2, ctpcMgmtSysAddr=ctpcMgmtSysAddr, ctpcStatEventCrossedType=ctpcStatEventCrossedType, ctpcMgmtSysConnStatus=ctpcMgmtSysConnStatus, ctpcStatStartupAlarm=ctpcStatStartupAlarm, ctpcRxLostPackets=ctpcRxLostPackets, ciscoTpCallMIBComplianceRev4=ciscoTpCallMIBComplianceRev4, ctpcTable=ctpcTable, ctpcMgmtSysConnEventHistoryEntry=ctpcMgmtSysConnEventHistoryEntry, ciscoTelepresenceCallMIBConform=ciscoTelepresenceCallMIBConform, ctpcMgmtSysAddrType=ctpcMgmtSysAddrType, ctpcTxDestAddrType=ctpcTxDestAddrType, ctpcLocalDirNumIndex=ctpcLocalDirNumIndex, ctpcTxDscpTelepresenceConfigured=ctpcTxDscpTelepresenceConfigured, ctpcRxCoSPrevious=ctpcRxCoSPrevious, ctpcType=ctpcType, ctpcRxCallLostPackets=ctpcRxCallLostPackets, ctpcMaxPeriodLatency=ctpcMaxPeriodLatency, ctpcIndex=ctpcIndex, ctpcStatNotifyEnable=ctpcStatNotifyEnable, ctpcRxPeriodLostPackets=ctpcRxPeriodLostPackets, ctpcStreamType=ctpcStreamType, ctpcStatRisingThreshold=ctpcStatRisingThreshold, ctpcMediaDestPort=ctpcMediaDestPort, ciscoTpCallStatisticsGroupSup3=ciscoTpCallStatisticsGroupSup3, ctpcStatMonitoredStreamType=ctpcStatMonitoredStreamType, ctpcTableLastIndex=ctpcTableLastIndex, ctpcObjects=ctpcObjects, ctpcAvgPeriodJitter=ctpcAvgPeriodJitter, ctpcRemoteDirNum=ctpcRemoteDirNum, ctpcStatEventCrossedValue=ctpcStatEventCrossedValue, CtpcStreamSourceType=CtpcStreamSourceType, ctpcRxMaxCallLostPackets=ctpcRxMaxCallLostPackets, ctpcTxCodec=ctpcTxCodec, ctpcTxPeriodBitRate=ctpcTxPeriodBitRate, ctpcMgmtSysConnEventStatus=ctpcMgmtSysConnEventStatus, ciscoTpCallInformationGroup=ciscoTpCallInformationGroup, ctpcRxIDRPackets=ctpcRxIDRPackets, ctpcRxDscpCurrent=ctpcRxDscpCurrent, ctpcStatOverallCallTime=ctpcStatOverallCallTime, ctpcTxVideoHorzPixels=ctpcTxVideoHorzPixels, ctpcActiveMgmtSysIndex=ctpcActiveMgmtSysIndex, ctpcMgmtSysConnEventHistoryIndex=ctpcMgmtSysConnEventHistoryIndex, ctpcAvgCallLatency=ctpcAvgCallLatency, ctpcInfoObjects=ctpcInfoObjects, ctpcSecurity=ctpcSecurity, ctpcLocalAddrType=ctpcLocalAddrType, ctpcRxTotalPackets=ctpcRxTotalPackets, ctpcTxFrameRate=ctpcTxFrameRate, ctpcLocalDirNum=ctpcLocalDirNum, ciscoTpCallMIBCompliances=ciscoTpCallMIBCompliances, ctpcStatMonitoredEntry=ctpcStatMonitoredEntry, ctpcEntry=ctpcEntry, ctpcStatEventHistLastIndex=ctpcStatEventHistLastIndex, ctpcRxLatePackets=ctpcRxLatePackets, ctpcRxCallBitRate=ctpcRxCallBitRate, ciscoTpCallMIBComplianceRev3=ciscoTpCallMIBComplianceRev3, ctpcStatTotalCallTime=ctpcStatTotalCallTime, ciscoTpCallStatisticsGroupSup2=ciscoTpCallStatisticsGroupSup2, ctpcStatOverallCalls=ctpcStatOverallCalls, ctpcMediaSrcPort=ctpcMediaSrcPort, CtpcE164Address=CtpcE164Address, ctpcTxVideoVertPixels=ctpcTxVideoVertPixels, ctpcRxDscpPrevious=ctpcRxDscpPrevious, ctpcRxMaxCallLostPacketsRecTime=ctpcRxMaxCallLostPacketsRecTime, ctpcRxPeriodBitRate=ctpcRxPeriodBitRate, ctpcStatEventTimeStamp=ctpcStatEventTimeStamp, ctpcMaxPeriodJitter=ctpcMaxPeriodJitter, ctpcStatMonitoredStatus=ctpcStatMonitoredStatus, ciscoTpCallMIBComplianceRev2=ciscoTpCallMIBComplianceRev2, CtpcStreamMediaType=CtpcStreamMediaType, ciscoTpCallInformationGroupSup1=ciscoTpCallInformationGroupSup1, ciscoTelepresenceCallMIBNotifs=ciscoTelepresenceCallMIBNotifs, ctpcRxCallAuthFailure=ctpcRxCallAuthFailure, ctpcAttributes=ctpcAttributes, ctpcMgmtSysConnNotifyEnable=ctpcMgmtSysConnNotifyEnable, CtpcMgmtSysConnStatusCode=CtpcMgmtSysConnStatusCode, ctpcMgmtSysConnEventNotification=ctpcMgmtSysConnEventNotification, ciscoTelepresenceCallMIB=ciscoTelepresenceCallMIB, ctpcRxShapingWindow=ctpcRxShapingWindow, ctpcTxActive=ctpcTxActive, ciscoTpCallMIBCompliance=ciscoTpCallMIBCompliance, ctpcTxIDRPackets=ctpcTxIDRPackets, ctpcStatStreamTypeEntry=ctpcStatStreamTypeEntry, CtpcStateCode=CtpcStateCode, ctpcRxDuplicatePackets=ctpcRxDuplicatePackets, ciscoTpCallStatisticsGroup=ciscoTpCallStatisticsGroup, ctpcMgmtSysConnEventHistTableSize=ctpcMgmtSysConnEventHistTableSize, ctpcRemoteDevice=ctpcRemoteDevice, ciscoTpCallEventHistoryGroup=ciscoTpCallEventHistoryGroup, ctpcLatestBitRate=ctpcLatestBitRate, ctpcMgmtSysTable=ctpcMgmtSysTable, ctpcStatStreamSourceEntry=ctpcStatStreamSourceEntry, CtpcCallTerminationCode=CtpcCallTerminationCode, ctpcStartDateAndTime=ctpcStartDateAndTime, ctpcStatStreamSourceTable=ctpcStatStreamSourceTable, ctpcStatEventHistoryTable=ctpcStatEventHistoryTable, CtpcCodecType=CtpcCodecType, CtpcAttributes=CtpcAttributes, ctpcState=ctpcState, ctpcStatEventMonObjectInst=ctpcStatEventMonObjectInst, ctpcDuration=ctpcDuration, ctpcStatTotalCalls=ctpcStatTotalCalls, ciscoTpCallNotificationGroup=ciscoTpCallNotificationGroup, ctpcTxTotalPackets=ctpcTxTotalPackets, ctpcRxVideoHorzPixels=ctpcRxVideoHorzPixels, CtpcStatMonitoredAttribute=CtpcStatMonitoredAttribute, ctpcTxCallLostPackets=ctpcTxCallLostPackets, ctpcTxDestAddr=ctpcTxDestAddr, ctpcRxMaxPeriodLostPackets=ctpcRxMaxPeriodLostPackets, ciscoTpCallMIBComplianceRev5=ciscoTpCallMIBComplianceRev5, ctpcLocalDirNumTable=ctpcLocalDirNumTable, ctpcMaxCallLatencyRecTime=ctpcMaxCallLatencyRecTime, ciscoTpCallMIBGroups=ciscoTpCallMIBGroups, ctpcTableSize=ctpcTableSize, ctpcStatMonitoredTable=ctpcStatMonitoredTable, CtpcStatThreshCrossedType=CtpcStatThreshCrossedType, ctpcStatStreamTypeTable=ctpcStatStreamTypeTable, ctpcRxCodec=ctpcRxCodec, ctpcLocalDirNumEntry=ctpcLocalDirNumEntry, ciscoTpCallStatisticsGroupSup1=ciscoTpCallStatisticsGroupSup1, ctpcRxFrameRate=ctpcRxFrameRate, ctpcStatObjects=ctpcStatObjects, ctpcMgmtSysIndex=ctpcMgmtSysIndex, PYSNMP_MODULE_ID=ciscoTelepresenceCallMIB, ctpcStatMonitoredType=ctpcStatMonitoredType, ctpcStatNotificaion=ctpcStatNotificaion, ciscoTpCallMgmtSysConnEventHistGroup=ciscoTpCallMgmtSysConnEventHistGroup, ctpcTxShapingWindow=ctpcTxShapingWindow, ciscoTelepresenceCallMIBObjects=ciscoTelepresenceCallMIBObjects, ctpcExtNumberMask=ctpcExtNumberMask, ctpcInitialBitRate=ctpcInitialBitRate, ctpcTxLostPackets=ctpcTxLostPackets, ciscoTpCallConfigurationGroup=ciscoTpCallConfigurationGroup, ctpcTxTotalBytes=ctpcTxTotalBytes, ciscoTpCallNotificationGroupRev1=ciscoTpCallNotificationGroupRev1, ctpcRxCoSCurrent=ctpcRxCoSCurrent, ctpcMgmtSysConnEventTimeStamp=ctpcMgmtSysConnEventTimeStamp, ctpcMgmtSysConnFailNotification=ctpcMgmtSysConnFailNotification, ctpcLocalAddr=ctpcLocalAddr, ctpcLocalSIPCallId=ctpcLocalSIPCallId, ctpcStreamSource=ctpcStreamSource, CtpcRemoteDeviceType=CtpcRemoteDeviceType, ctpcCallTermReason=ctpcCallTermReason, ctpcStatEventHistory=ctpcStatEventHistory, ctpcDirection=ctpcDirection, ctpcStatEventHistoryEntry=ctpcStatEventHistoryEntry, ctpcSamplePeriod=ctpcSamplePeriod, ctpcTxPeriodLostPackets=ctpcTxPeriodLostPackets, ctpcStatFallingThreshold=ctpcStatFallingThreshold, ctpcMaxCallJitterRecTime=ctpcMaxCallJitterRecTime, ciscoTpCallMIBComplianceRev1=ciscoTpCallMIBComplianceRev1, ctpcMgmtSysConnEventSIPRespCode=ctpcMgmtSysConnEventSIPRespCode, ctpcMgmtSysSIPRespCode=ctpcMgmtSysSIPRespCode, ctpcRxVideoVertPixels=ctpcRxVideoVertPixels, ctpcMgmtSysEntry=ctpcMgmtSysEntry, ctpcRxOutOfOrderPackets=ctpcRxOutOfOrderPackets, ctpcMode=ctpcMode, ctpcTxDscpAudioConfigured=ctpcTxDscpAudioConfigured, ctpcMaxCallLatency=ctpcMaxCallLatency, ctpcRxActive=ctpcRxActive, ctpcStatEventHistTableSize=ctpcStatEventHistTableSize, ctpcMgmtSysConnEventHistoryTable=ctpcMgmtSysConnEventHistoryTable, ctpcAvgCallJitter=ctpcAvgCallJitter, ctpcStatMonitorObjects=ctpcStatMonitorObjects, CtpcStatMonitoredAttributeUnit=CtpcStatMonitoredAttributeUnit, ctpcStatEventHistoryIndex=ctpcStatEventHistoryIndex, ctpcStatMonitoredUnit=ctpcStatMonitoredUnit)
