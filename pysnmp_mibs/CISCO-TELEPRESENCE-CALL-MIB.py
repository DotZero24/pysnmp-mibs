...
RowStatus, DateAndTime, TextualConvention, VariablePointer, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TextualConvention", "VariablePointer", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-TELEPRESENCE-CALL-MIB", ctpcStatStreamTypeTable=ctpcStatStreamTypeTable, ctpcLocalDirNumIndex=ctpcLocalDirNumIndex, ciscoTpCallStatisticsGroup=ciscoTpCallStatisticsGroup, ciscoTpCallNotificationGroup=ciscoTpCallNotificationGroup, ctpcRxDuplicatePackets=ctpcRxDuplicatePackets, ctpcStatEventHistLastIndex=ctpcStatEventHistLastIndex, ciscoTelepresenceCallMIBConform=ciscoTelepresenceCallMIBConform, ctpcRxDscpCurrent=ctpcRxDscpCurrent, ctpcMgmtSysEntry=ctpcMgmtSysEntry, ctpcEntry=ctpcEntry, ctpcTxDscpTelepresenceConfigured=ctpcTxDscpTelepresenceConfigured, ctpcTxVideoVertPixels=ctpcTxVideoVertPixels, ctpcMgmtSysTable=ctpcMgmtSysTable, ctpcRxLatePackets=ctpcRxLatePackets, ctpcMaxCallJitterRecTime=ctpcMaxCallJitterRecTime, ctpcRxIDRPackets=ctpcRxIDRPackets, ctpcRxCodec=ctpcRxCodec, ctpcRxShapingWindow=ctpcRxShapingWindow, ctpcTxPeriodLostPackets=ctpcTxPeriodLostPackets, ctpcRxCoSPrevious=ctpcRxCoSPrevious, ctpcStatMonitoredType=ctpcStatMonitoredType, CtpcStreamMediaType=CtpcStreamMediaType, ctpcState=ctpcState, ctpcStreamSource=ctpcStreamSource, ciscoTelepresenceCallMIB=ciscoTelepresenceCallMIB, ctpcMaxCallLatency=ctpcMaxCallLatency, ctpcLocalDirNumTable=ctpcLocalDirNumTable, CtpcStreamSourceType=CtpcStreamSourceType, ctpcRxPeriodBitRate=ctpcRxPeriodBitRate, ciscoTpCallInformationGroup=ciscoTpCallInformationGroup, ctpcAvgCallJitter=ctpcAvgCallJitter, ciscoTpCallEventHistoryGroup=ciscoTpCallEventHistoryGroup, ctpcAttributes=ctpcAttributes, ctpcAvgPeriodJitter=ctpcAvgPeriodJitter, ctpcMgmtSysConnEventHistory=ctpcMgmtSysConnEventHistory, ctpcRxVideoHorzPixels=ctpcRxVideoHorzPixels, ctpcType=ctpcType, ctpcTxVideoHorzPixels=ctpcTxVideoHorzPixels, ctpcTxCodec=ctpcTxCodec, PYSNMP_MODULE_ID=ciscoTelepresenceCallMIB, ciscoTpCallMIBComplianceRev1=ciscoTpCallMIBComplianceRev1, ctpcTxCallBitRate=ctpcTxCallBitRate, ctpcStatEventHistoryTable=ctpcStatEventHistoryTable, ctpcRemoteDevice=ctpcRemoteDevice, ctpcStatNotifyEnable=ctpcStatNotifyEnable, ctpcCallTermReason=ctpcCallTermReason, ctpcMgmtSysConnEventHistoryTable=ctpcMgmtSysConnEventHistoryTable, ctpcTxDestAddrType=ctpcTxDestAddrType, ctpcStatMonitorObjects=ctpcStatMonitorObjects, ctpcMaxCallLatencyRecTime=ctpcMaxCallLatencyRecTime, ctpcStatTotalCallTime=ctpcStatTotalCallTime, ctpcTxDscpAudioConfigured=ctpcTxDscpAudioConfigured, ciscoTpCallNotificationGroupRev1=ciscoTpCallNotificationGroupRev1, ctpcStatEventHistoryIndex=ctpcStatEventHistoryIndex, ctpcStatMonitoredStatus=ctpcStatMonitoredStatus, ctpcMgmtSysConnEventHistTableSize=ctpcMgmtSysConnEventHistTableSize, ctpcTable=ctpcTable, CtpcStateCode=CtpcStateCode, ctpcTxCallLostPackets=ctpcTxCallLostPackets, ctpcStatEventCrossedType=ctpcStatEventCrossedType, ctpcStatMonitoredStreamType=ctpcStatMonitoredStreamType, ctpcRxMaxCallLostPacketsRecTime=ctpcRxMaxCallLostPacketsRecTime, ctpcTxShapingWindow=ctpcTxShapingWindow, ctpcStatEventHistoryEntry=ctpcStatEventHistoryEntry, ctpcActiveMgmtSysIndex=ctpcActiveMgmtSysIndex, ctpcStatEventHistTableSize=ctpcStatEventHistTableSize, ctpcTxDestAddr=ctpcTxDestAddr, ctpcRxFrameRate=ctpcRxFrameRate, ctpcStartDateAndTime=ctpcStartDateAndTime, ctpcLocalDirNumEntry=ctpcLocalDirNumEntry, ctpcStatStreamSourceTable=ctpcStatStreamSourceTable, ciscoTelepresenceCallMIBNotifs=ciscoTelepresenceCallMIBNotifs, ctpcMgmtSysAddrType=ctpcMgmtSysAddrType, ctpcLocalAddr=ctpcLocalAddr, ctpcDirection=ctpcDirection, CtpcStatThreshCrossedType=CtpcStatThreshCrossedType, ctpcMode=ctpcMode, CtpcCallTerminationCode=CtpcCallTerminationCode, ctpcMgmtSysAddr=ctpcMgmtSysAddr, ctpcTxLostPackets=ctpcTxLostPackets, CtpcStatMonitoredAttribute=CtpcStatMonitoredAttribute, ctpcMgmtSysConnEventHistoryEntry=ctpcMgmtSysConnEventHistoryEntry, ciscoTelepresenceCallMIBObjects=ciscoTelepresenceCallMIBObjects, ctpcMgmtSysConnEventTimeStamp=ctpcMgmtSysConnEventTimeStamp, ctpcLocalAddrType=ctpcLocalAddrType, ctpcRxDscpPrevious=ctpcRxDscpPrevious, ctpcAvgCallLatency=ctpcAvgCallLatency, ciscoTpCallStatisticsGroupSup3=ciscoTpCallStatisticsGroupSup3, ctpcRxActive=ctpcRxActive, CtpcCodecType=CtpcCodecType, ciscoTpCallMIBGroups=ciscoTpCallMIBGroups, ctpcTableSize=ctpcTableSize, ctpcSecurity=ctpcSecurity, ctpcStatEventMonObjectInst=ctpcStatEventMonObjectInst, ctpcTxPeriodBitRate=ctpcTxPeriodBitRate, ctpcMgmtSysIndex=ctpcMgmtSysIndex, ctpcMgmtSysConnEventHistoryIndex=ctpcMgmtSysConnEventHistoryIndex, ctpcStatOverallCallTime=ctpcStatOverallCallTime, ctpcStatMonitoredTable=ctpcStatMonitoredTable, ctpcRxCallBitRate=ctpcRxCallBitRate, ctpcMgmtSysConnEventHistLastIndex=ctpcMgmtSysConnEventHistLastIndex, ctpcRowStatus=ctpcRowStatus, ctpcMediaDestPort=ctpcMediaDestPort, ctpcTxIDRPackets=ctpcTxIDRPackets, ctpcStatObjects=ctpcStatObjects, ctpcDuration=ctpcDuration, ctpcMaxPeriodLatency=ctpcMaxPeriodLatency, ctpcStatFallingThreshold=ctpcStatFallingThreshold, ctpcRxVideoVertPixels=ctpcRxVideoVertPixels, ctpcRemoteDirNum=ctpcRemoteDirNum, ciscoTpCallMIBCompliance=ciscoTpCallMIBCompliance, ctpcStatStreamSourceEntry=ctpcStatStreamSourceEntry, ctpcRxCallLostPackets=ctpcRxCallLostPackets, ctpcStatEventHistory=ctpcStatEventHistory, ctpcLocalDirNum=ctpcLocalDirNum, ctpcExtNumberMask=ctpcExtNumberMask, ctpcLocalSIPCallId=ctpcLocalSIPCallId, ctpcMgmtSysConnEventStatus=ctpcMgmtSysConnEventStatus, ciscoTpCallMIBComplianceRev3=ciscoTpCallMIBComplianceRev3, CtpcE164Address=CtpcE164Address, ctpcStatNotificaion=ctpcStatNotificaion, ctpcAvgPeriodLatency=ctpcAvgPeriodLatency, ctpcRxOutOfOrderPackets=ctpcRxOutOfOrderPackets, CtpcMgmtSysConnStatusCode=CtpcMgmtSysConnStatusCode, ciscoTpCallInformationGroupSup2=ciscoTpCallInformationGroupSup2, ctpcStatRisingThreshold=ctpcStatRisingThreshold, ctpcStatStreamTypeEntry=ctpcStatStreamTypeEntry, ctpcStatEventTimeStamp=ctpcStatEventTimeStamp, ctpcMgmtSysSIPRespCode=ctpcMgmtSysSIPRespCode, ciscoTpCallMgmtSysConnEventHistGroup=ciscoTpCallMgmtSysConnEventHistGroup, ctpcInfoObjects=ctpcInfoObjects, ctpcStatMonitoredUnit=ctpcStatMonitoredUnit, ctpcMaxPeriodJitter=ctpcMaxPeriodJitter, ctpcLatestBitRate=ctpcLatestBitRate, ciscoTpCallMIBCompliances=ciscoTpCallMIBCompliances, ctpcMgmtSysConnNotifyEnable=ctpcMgmtSysConnNotifyEnable, ctpcRxMaxCallLostPackets=ctpcRxMaxCallLostPackets, ctpcObjects=ctpcObjects, ctpcMgmtSysConnStatus=ctpcMgmtSysConnStatus, ctpcTxActive=ctpcTxActive, ctpcTxTotalBytes=ctpcTxTotalBytes, ctpcRxTotalPackets=ctpcRxTotalPackets, ctpcRxLostPackets=ctpcRxLostPackets, CtpcAttributes=CtpcAttributes, ctpcRxPeriodLostPackets=ctpcRxPeriodLostPackets, ctpcTxFrameRate=ctpcTxFrameRate, ciscoTpCallConfigurationGroup=ciscoTpCallConfigurationGroup, CtpcStatAlarmMode=CtpcStatAlarmMode, ciscoTpCallStatisticsGroupSup1=ciscoTpCallStatisticsGroupSup1, ctpcMgmtSysConnEventNotification=ctpcMgmtSysConnEventNotification, ctpcTableLastIndex=ctpcTableLastIndex, ctpcStatStartupAlarm=ctpcStatStartupAlarm, ctpcStreamType=ctpcStreamType, CtpcStatMonitoredAttributeUnit=CtpcStatMonitoredAttributeUnit, ctpcIndex=ctpcIndex, ctpcMediaSrcPort=ctpcMediaSrcPort, ciscoTpCallMIBComplianceRev2=ciscoTpCallMIBComplianceRev2, ctpcRxTotalBytes=ctpcRxTotalBytes, ctpcMaxCallJitter=ctpcMaxCallJitter, ciscoTpCallMIBComplianceRev5=ciscoTpCallMIBComplianceRev5, ctpcMgmtSysConnFailNotification=ctpcMgmtSysConnFailNotification, ctpcStatEventCrossedValue=ctpcStatEventCrossedValue, ctpcInitialBitRate=ctpcInitialBitRate, CtpcRemoteDeviceType=CtpcRemoteDeviceType, ciscoTpCallStatisticsGroupSup2=ciscoTpCallStatisticsGroupSup2, ctpcRxCallAuthFailure=ctpcRxCallAuthFailure, ctpcMgmtSysConnEventSIPRespCode=ctpcMgmtSysConnEventSIPRespCode, ctpcStatTotalCalls=ctpcStatTotalCalls, ctpcStatOverallCalls=ctpcStatOverallCalls, ctpcStatMonitoredEntry=ctpcStatMonitoredEntry, ciscoTpCallInformationGroupSup1=ciscoTpCallInformationGroupSup1, ctpcSamplePeriod=ctpcSamplePeriod, ctpcTxTotalPackets=ctpcTxTotalPackets, ciscoTpCallMIBComplianceRev4=ciscoTpCallMIBComplianceRev4, ctpcRxMaxPeriodLostPackets=ctpcRxMaxPeriodLostPackets, ctpcRxCoSCurrent=ctpcRxCoSCurrent)
