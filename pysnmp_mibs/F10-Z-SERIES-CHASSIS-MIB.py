...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/force10/F10-Z-SERIES-CHASSIS-MIB
...
F10SSeriesPortType, F10ChassisType, F10ProcessorModuleType, F10CardOperStatus, F10HundredthdB, F10MfgDate, F10SwDate = mibBuilder.importSymbols("FORCE10-TC", "F10SSeriesPortType", "F10ChassisType", "F10ProcessorModuleType", "F10CardOperStatus", "F10HundredthdB", "F10MfgDate", "F10SwDate")
...
mibBuilder.exportSymbols("F10-Z-SERIES-CHASSIS-MIB", f10ZSeriesChassisMibCompliance=f10ZSeriesChassisMibCompliance, chNumLineCards=chNumLineCards, f10ZSeriesChassisMibCompliances=f10ZSeriesChassisMibCompliances, chSysPortEntry=chSysPortEntry, chSysProcessorMemSize=chSysProcessorMemSize, chSysPowerSupplyPiecePartID=chSysPowerSupplyPiecePartID, f10ZSerChassisObject=f10ZSerChassisObject, chSysCpuUtil1Min=chSysCpuUtil1Min, chSysPortXfpRxPower=chSysPortXfpRxPower, chSwVersion=chSwVersion, chSysPortXfpRxTemp=chSysPortXfpRxTemp, chSysSwModuleTable=chSysSwModuleTable, chSysCoresFileName=chSysCoresFileName, chSysLineCardType=chSysLineCardType, chSysCpuUtilTable=chSysCpuUtilTable, chSysCpuUtil5Sec=chSysCpuUtil5Sec, chSysPowerSupplyExpressServiceCode=chSysPowerSupplyExpressServiceCode, chSysSwModuleEntry=chSysSwModuleEntry, f10ZSeriesSystemGroup=f10ZSeriesSystemGroup, chSysPortIndex=chSysPortIndex, chSysSwModuleInPartitionBImgVers=chSysSwModuleInPartitionBImgVers, chSysSwModuleBootSelectorImgVersion=chSysSwModuleBootSelectorImgVersion, chPartNum=chPartNum, chSysSwModuleInPartitionAImgVers=chSysSwModuleInPartitionAImgVers, chSysPowerSupplyServiceTag=chSysPowerSupplyServiceTag, chSysPowerSupplyTable=chSysPowerSupplyTable, chPiecePartID=chPiecePartID, PYSNMP_MODULE_ID=f10ZSerChassisMib, chSysObjects=chSysObjects, chPPIDRevision=chPPIDRevision, chObjects=chObjects, f10ZSerChassisMib=f10ZSerChassisMib, chSysSwModuleBootFlashImgVersion=chSysSwModuleBootFlashImgVersion, chSysFanTrayExpressServiceCode=chSysFanTrayExpressServiceCode, chSerialNumber=chSerialNumber, chNum10GigEtherPorts=chNum10GigEtherPorts, chSysFanTrayPPIDRevision=chSysFanTrayPPIDRevision, chSysFanTrayTable=chSysFanTrayTable, chSysLineCardNum10GigEtherPorts=chSysLineCardNum10GigEtherPorts, chSysPowerSupplyType=chSysPowerSupplyType, chExpressServiceCode=chExpressServiceCode, chSysLineCardEntry=chSysLineCardEntry, chSysSwModuleCurrentBootImage=chSysSwModuleCurrentBootImage, chSysPowerSupplyOperStatus=chSysPowerSupplyOperStatus, chSysPortType=chSysPortType, chSysLineCardIndex=chSysLineCardIndex, chType=chType, chNumPowerSupplies=chNumPowerSupplies, chNumFanTrays=chNumFanTrays, chSysCoresTimeCreated=chSysCoresTimeCreated, chSysFanTrayEntry=chSysFanTrayEntry, chSysFanTrayServiceTag=chSysFanTrayServiceTag, chSysPortXfpTxPower=chSysPortXfpTxPower, chSysFanTrayOperStatus=chSysFanTrayOperStatus, chSysPortOperStatus=chSysPortOperStatus, chNum40GigEtherPorts=chNum40GigEtherPorts, chSysPortTable=chSysPortTable, chSysPowerSupplyIndex=chSysPowerSupplyIndex, chSysProcessorType=chSysProcessorType, chSysCoresInstance=chSysCoresInstance, chSysFanTrayPiecePartID=chSysFanTrayPiecePartID, chSysLineCardStatus=chSysLineCardStatus, chServiceTag=chServiceTag, chVendorId=chVendorId, chProductRev=chProductRev, chSysPowerSupplyEntry=chSysPowerSupplyEntry, chSysProcessorEntry=chSysProcessorEntry, chSysLineCardNum40GigEtherPorts=chSysLineCardNum40GigEtherPorts, chSysSwCoresTable=chSysSwCoresTable, chSysCoresProcessorName=chSysCoresProcessorName, f10ZSeriesComponentGroup=f10ZSeriesComponentGroup, chSysLineCardTable=chSysLineCardTable, f10ZSeriesChassisMibGroups=f10ZSeriesChassisMibGroups, chSysSwModuleNextRebootImage=chSysSwModuleNextRebootImage, f10ZSeriesChassisMibConformance=f10ZSeriesChassisMibConformance, chSysProcessorTable=chSysProcessorTable, chSysCoresEntry=chSysCoresEntry, chSysCpuUtilFlashUsage=chSysCpuUtilFlashUsage, chSysProcessorUpTime=chSysProcessorUpTime, chSysSwModuleRuntimeImgDate=chSysSwModuleRuntimeImgDate, chSysSwModuleRuntimeImgVersion=chSysSwModuleRuntimeImgVersion, chSysPortAdminStatus=chSysPortAdminStatus, chSysCpuUtil5Min=chSysCpuUtil5Min, chSysPowerSupplyPPIDRevision=chSysPowerSupplyPPIDRevision, chSysProcessorIndex=chSysProcessorIndex, chMfgDate=chMfgDate, chSysCpuUtilMemUsage=chSysCpuUtilMemUsage, chSysLineCardTemp=chSysLineCardTemp, chSysLineCardDescription=chSysLineCardDescription, chSysPortIfIndex=chSysPortIfIndex, chSysPowerSupplyUsage=chSysPowerSupplyUsage, chMacAddr=chMacAddr, chSysCpuUtilEntry=chSysCpuUtilEntry, chSysFanTrayIndex=chSysFanTrayIndex, chCountryCode=chCountryCode, chSysCoresProcess=chSysCoresProcess)
