...
F10HundredthdB, F10ProcessorModuleType, F10SSeriesPortType, F10CardOperStatus, F10MfgDate, F10ChassisType, F10SwDate = mibBuilder.importSymbols("FORCE10-TC", "F10HundredthdB", "F10ProcessorModuleType", "F10SSeriesPortType", "F10CardOperStatus", "F10MfgDate", "F10ChassisType", "F10SwDate")
...
mibBuilder.exportSymbols("F10-Z-SERIES-CHASSIS-MIB", chSysLineCardTemp=chSysLineCardTemp, chSysPowerSupplyOperStatus=chSysPowerSupplyOperStatus, chSysCoresTimeCreated=chSysCoresTimeCreated, chServiceTag=chServiceTag, chSysCpuUtil1Min=chSysCpuUtil1Min, chSysPowerSupplyTable=chSysPowerSupplyTable, chSysFanTrayEntry=chSysFanTrayEntry, chSysLineCardIndex=chSysLineCardIndex, chSysCpuUtilTable=chSysCpuUtilTable, chSysProcessorEntry=chSysProcessorEntry, chPartNum=chPartNum, chSysSwModuleNextRebootImage=chSysSwModuleNextRebootImage, chSysSwModuleInPartitionBImgVers=chSysSwModuleInPartitionBImgVers, chPPIDRevision=chPPIDRevision, chSysProcessorMemSize=chSysProcessorMemSize, chSysLineCardTable=chSysLineCardTable, chSysPortIndex=chSysPortIndex, chNum40GigEtherPorts=chNum40GigEtherPorts, chProductRev=chProductRev, chSysPortXfpRxTemp=chSysPortXfpRxTemp, chSysPowerSupplyUsage=chSysPowerSupplyUsage, chSysObjects=chSysObjects, chSysFanTrayPPIDRevision=chSysFanTrayPPIDRevision, chNumPowerSupplies=chNumPowerSupplies, chSysFanTrayOperStatus=chSysFanTrayOperStatus, chSysCoresEntry=chSysCoresEntry, f10ZSeriesSystemGroup=f10ZSeriesSystemGroup, chVendorId=chVendorId, chSysFanTrayExpressServiceCode=chSysFanTrayExpressServiceCode, chSysPortIfIndex=chSysPortIfIndex, chSysPowerSupplyExpressServiceCode=chSysPowerSupplyExpressServiceCode, chSysPortTable=chSysPortTable, chSysCpuUtil5Sec=chSysCpuUtil5Sec, chSysPortXfpRxPower=chSysPortXfpRxPower, chSysPortAdminStatus=chSysPortAdminStatus, chSysCoresFileName=chSysCoresFileName, chNum10GigEtherPorts=chNum10GigEtherPorts, chType=chType, chSysSwCoresTable=chSysSwCoresTable, chSysPortType=chSysPortType, chSysCoresProcess=chSysCoresProcess, chSysPortOperStatus=chSysPortOperStatus, chSysPowerSupplyType=chSysPowerSupplyType, f10ZSeriesChassisMibGroups=f10ZSeriesChassisMibGroups, chSysFanTrayTable=chSysFanTrayTable, chSysCoresProcessorName=chSysCoresProcessorName, chNumFanTrays=chNumFanTrays, chExpressServiceCode=chExpressServiceCode, chSysSwModuleInPartitionAImgVers=chSysSwModuleInPartitionAImgVers, chSysLineCardDescription=chSysLineCardDescription, chSysPowerSupplyEntry=chSysPowerSupplyEntry, chSysProcessorType=chSysProcessorType, f10ZSeriesChassisMibCompliance=f10ZSeriesChassisMibCompliance, chSysCpuUtilEntry=chSysCpuUtilEntry, chSysPowerSupplyIndex=chSysPowerSupplyIndex, chObjects=chObjects, f10ZSeriesComponentGroup=f10ZSeriesComponentGroup, chCountryCode=chCountryCode, chMfgDate=chMfgDate, chSysProcessorIndex=chSysProcessorIndex, chNumLineCards=chNumLineCards, f10ZSeriesChassisMibConformance=f10ZSeriesChassisMibConformance, chSysSwModuleRuntimeImgVersion=chSysSwModuleRuntimeImgVersion, chSysSwModuleRuntimeImgDate=chSysSwModuleRuntimeImgDate, chSysLineCardType=chSysLineCardType, chSysLineCardStatus=chSysLineCardStatus, chSysLineCardNum40GigEtherPorts=chSysLineCardNum40GigEtherPorts, chSysProcessorTable=chSysProcessorTable, chSysSwModuleEntry=chSysSwModuleEntry, chSysPowerSupplyPPIDRevision=chSysPowerSupplyPPIDRevision, chSysSwModuleBootSelectorImgVersion=chSysSwModuleBootSelectorImgVersion, f10ZSeriesChassisMibCompliances=f10ZSeriesChassisMibCompliances, chSysLineCardNum10GigEtherPorts=chSysLineCardNum10GigEtherPorts, chSysPortEntry=chSysPortEntry, chSysCpuUtilFlashUsage=chSysCpuUtilFlashUsage, chSysFanTrayServiceTag=chSysFanTrayServiceTag, chSwVersion=chSwVersion, f10ZSerChassisMib=f10ZSerChassisMib, chSysSwModuleBootFlashImgVersion=chSysSwModuleBootFlashImgVersion, PYSNMP_MODULE_ID=f10ZSerChassisMib, chSysSwModuleTable=chSysSwModuleTable, chSysPowerSupplyPiecePartID=chSysPowerSupplyPiecePartID, chMacAddr=chMacAddr, f10ZSerChassisObject=f10ZSerChassisObject, chSysProcessorUpTime=chSysProcessorUpTime, chSysCpuUtil5Min=chSysCpuUtil5Min, chSysFanTrayIndex=chSysFanTrayIndex, chSysSwModuleCurrentBootImage=chSysSwModuleCurrentBootImage, chSysPowerSupplyServiceTag=chSysPowerSupplyServiceTag, chSysCoresInstance=chSysCoresInstance, chSysPortXfpTxPower=chSysPortXfpTxPower, chSerialNumber=chSerialNumber, chSysCpuUtilMemUsage=chSysCpuUtilMemUsage, chPiecePartID=chPiecePartID, chSysFanTrayPiecePartID=chSysFanTrayPiecePartID, chSysLineCardEntry=chSysLineCardEntry)
