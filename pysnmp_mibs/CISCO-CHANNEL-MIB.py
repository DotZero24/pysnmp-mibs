...
mibBuilder.exportSymbols("CISCO-CHANNEL-MIB", cipCardEntryDmaLoad60m=cipCardEntryDmaLoad60m, ciscoChannelMibCompliance=ciscoChannelMibCompliance, cipCardDtrBrdOnline=cipCardDtrBrdOnline, cipCardEntryMajorHwRevisionNr=cipCardEntryMajorHwRevisionNr, cipCardClawDataXferStatsHCBytesWritten=cipCardClawDataXferStatsHCBytesWritten, implicitIncidents=implicitIncidents, cipCardClawConfigDevice=cipCardClawConfigDevice, cipCardSubChannelResetEvent=cipCardSubChannelResetEvent, cipCardEntryMajorSwRevisionNr=cipCardEntryMajorSwRevisionNr, cipCardSubChannelCMDRetry=cipCardSubChannelCMDRetry, ciscoChannelMibConformance=ciscoChannelMibConformance, cipCardClawTable=cipCardClawTable, ciscoChannelMibComplianceRev2=ciscoChannelMibComplianceRev2, PYSNMP_MODULE_ID=channel, cipCardLinkFailure=cipCardLinkFailure, cipCardSubChannelStatPending=cipCardSubChannelStatPending, cipCardClawDataXferStatsBytesWritten=cipCardClawDataXferStatsBytesWritten, ciscoChannelGroup=ciscoChannelGroup, cipCardClawConfigRouterAppl=cipCardClawConfigRouterAppl, cipCardEntryDmaLoad1m=cipCardEntryDmaLoad1m, ciscoChannelGroupRev3=ciscoChannelGroupRev3, ciscoChannelMibGroups=ciscoChannelMibGroups, cipCardDtrBrdChannelLoad5m=cipCardDtrBrdChannelLoad5m, cipCardClawDataXferStatsBytesRead=cipCardClawDataXferStatsBytesRead, cipCardClawConfigHostAppl=cipCardClawConfigHostAppl, cipCardSubChannelSuspend=cipCardSubChannelSuspend, cipCardSubChannelSystemResets=cipCardSubChannelSystemResets, cipCardDtrBrdIndex=cipCardDtrBrdIndex, cipCardSubChannelEntry=cipCardSubChannelEntry, cipCardSubChannelWriteBlocksDropped=cipCardSubChannelWriteBlocksDropped, linkFailureSequenceTimeouts=linkFailureSequenceTimeouts, cipCardDaughterBoardTable=cipCardDaughterBoardTable, cipCardSubChannelIndex=cipCardSubChannelIndex, cipCardEntry=cipCardEntry, cipCardSubChannelSelectiveResets=cipCardSubChannelSelectiveResets, cipCardEntryCpuLoad60m=cipCardEntryCpuLoad60m, cipCardClawDataXferStatsEntry=cipCardClawDataXferStatsEntry, cipCardEntryTimeSinceLastReset=cipCardEntryTimeSinceLastReset, cipCardApplicationCompileInfo=cipCardApplicationCompileInfo, cipCardSubChannelLastSenseDataTime=cipCardSubChannelLastSenseDataTime, cipCardTraps=cipCardTraps, cipCardDtrBrdNextStat=cipCardDtrBrdNextStat, cipCardClawDataXferStatsWriteBlocksDropped=cipCardClawDataXferStatsWriteBlocksDropped, cipCardApplicationEntry=cipCardApplicationEntry, cipCardDaughterBoardEntry=cipCardDaughterBoardEntry, ciscoChannelMibComplianceRev1=ciscoChannelMibComplianceRev1, cipCardClawConfigIpAddr=cipCardClawConfigIpAddr, cipCardEntryName=cipCardEntryName, codeViolationErrors=codeViolationErrors, ciscoChannelGroupRev2=ciscoChannelGroupRev2, cipCardSubChannelCuBusies=cipCardSubChannelCuBusies, cipCardClawDataXferStatsBlocksWritten=cipCardClawDataXferStatsBlocksWritten, cipCardClawIndex=cipCardClawIndex, cipCardClawConnected=cipCardClawConnected, cipCardDtrBrdLastStat=cipCardDtrBrdLastStat, cipCardClawConfigRowStatus=cipCardClawConfigRowStatus, cipCardSubChannelCancels=cipCardSubChannelCancels, cipCardEntryMinorHwRevisionNr=cipCardEntryMinorHwRevisionNr, cipCardSubChannelShortBusy=cipCardSubChannelShortBusy, cipCardEntryMinorSwRevisionNr=cipCardEntryMinorSwRevisionNr, cipCardEntryCpuLoad1m=cipCardEntryCpuLoad1m, ciscoChannelGroupRev1=ciscoChannelGroupRev1, cipCardSubChannelTable=cipCardSubChannelTable, cipCardDtrBrdSignal=cipCardDtrBrdSignal, cipCardEntryCpuLoad5m=cipCardEntryCpuLoad5m, cipCardClawDataXferStatsBufferGetRetryCount=cipCardClawDataXferStatsBufferGetRetryCount, cipCardEntryDmaLoad5m=cipCardEntryDmaLoad5m, cipCardClaw=cipCardClaw, cipCardDtrBrdStatus=cipCardDtrBrdStatus, cipCardSubChannelConnections=cipCardSubChannelConnections, cipCardSubChannelCmdRetries=cipCardSubChannelCmdRetries, cipCardSubChannelLastSenseData=cipCardSubChannelLastSenseData, cipCardEntryIndex=cipCardEntryIndex, cipCardClawConfigTable=cipCardClawConfigTable, cipCardClawDataXferStatsHCBytesRead=cipCardClawDataXferStatsHCBytesRead, cipCardEntryFreeMemory=cipCardEntryFreeMemory, cipCardClawConfigHostName=cipCardClawConfigHostName, cipCardClawConfigEntry=cipCardClawConfigEntry, linkFailureInvalidSequences=linkFailureInvalidSequences, cipCardEntryTotalMemory=cipCardEntryTotalMemory, cipCardSubChannelFBLWait=cipCardSubChannelFBLWait, ciscoChannelMibCompliances=ciscoChannelMibCompliances, cipCardApplicationNameIndex=cipCardApplicationNameIndex, cipCardEntryCpuUtilization=cipCardEntryCpuUtilization, cipCardDtrBrdChannelLoad1m=cipCardDtrBrdChannelLoad1m, cipCard=cipCard, cipCardDtrBrdType=cipCardDtrBrdType, linkIncidentTrapCause=linkIncidentTrapCause, cipCardDtrBrdChannelLoad60m=cipCardDtrBrdChannelLoad60m, cipCardClawConfigPath=cipCardClawConfigPath, cipCardClawConfigBroadcastEnable=cipCardClawConfigBroadcastEnable, cipCardClawDataXferStatsBlocksRead=cipCardClawDataXferStatsBlocksRead, cipCardClawDataXferStatsTable=cipCardClawDataXferStatsTable, channel=channel, cipCardTable=cipCardTable, cipCardSubChannelDeviceErrors=cipCardSubChannelDeviceErrors, cipCardSubChannelBufferWait=cipCardSubChannelBufferWait, cipCardClawDataXferStatsReadBlocksDropped=cipCardClawDataXferStatsReadBlocksDropped, cipCardDtrBrdLinkFailure=cipCardDtrBrdLinkFailure, cipCardClawEntry=cipCardClawEntry, cipCardApplicationTable=cipCardApplicationTable, linkFailureSignalOrSyncLoss=linkFailureSignalOrSyncLoss, linkFailureNOSs=linkFailureNOSs, cipCardApplicationRevision=cipCardApplicationRevision, cipCardClawConfigRouterName=cipCardClawConfigRouterName)
