...
mibBuilder.exportSymbols("CTRON-ISDN-CONFIGURATION-MIB", dialCtlNbrCfgId=dialCtlNbrCfgId, cabletron=cabletron, ctronWan=ctronWan, rmtProfileEntryIndex=rmtProfileEntryIndex, ctISDNcontrol=ctISDNcontrol, isdnDchEntry=isdnDchEntry, rmtProfileEntryMpMoreBWSamples=rmtProfileEntryMpMoreBWSamples, isdnDchRateAccess=isdnDchRateAccess, rmtProfileEntryBchInUse=rmtProfileEntryBchInUse, rmtProfileEntryMpCallsToAdd=rmtProfileEntryMpCallsToAdd, dialCtlNbrCfgAnswerAddress=dialCtlNbrCfgAnswerAddress, rmtProfileEntryMpCallsToRemove=rmtProfileEntryMpCallsToRemove, rmtProfileEntryMaxNeighbor=rmtProfileEntryMaxNeighbor, callHistoryEntry=callHistoryEntry, isdnDchDirNum2=isdnDchDirNum2, rmtProfileEntryState=rmtProfileEntryState, rmtProfileEntryMpHistoryTime=rmtProfileEntryMpHistoryTime, ctDataLink=ctDataLink, dialCtlNbrCfgTable=dialCtlNbrCfgTable, dialCtlNbrCfgOriginateAddress=dialCtlNbrCfgOriginateAddress, callHistoryConnectTime=callHistoryConnectTime, dialCtlNbrCfgIfIndex=dialCtlNbrCfgIfIndex, isdnDchSPID1=isdnDchSPID1, callHistoryDisconnectCause=callHistoryDisconnectCause, isdnDchChInUse=isdnDchChInUse, callHistoryIndex=callHistoryIndex, rmtProfileEntryLinkHead=rmtProfileEntryLinkHead, isdnDchSwitchType=isdnDchSwitchType, rmtProfileTable=rmtProfileTable, rmtProfileEntryNextLink=rmtProfileEntryNextLink, rmtProfileEntryMpRmtBwCtrl=rmtProfileEntryMpRmtBwCtrl, callHistoryReceiveBytes=callHistoryReceiveBytes, rmtProfileEntryMpLessBWSamples=rmtProfileEntryMpLessBWSamples, isdnDchAllowedCh=isdnDchAllowedCh, isdnDchSPID2=isdnDchSPID2, rmtProfileEntryMpMaxCallsAllowed=rmtProfileEntryMpMaxCallsAllowed, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlNbrCfgIndex=dialCtlNbrCfgIndex, isdnDchIndex=isdnDchIndex, rmtProfileEntryName=rmtProfileEntryName, callHistoryTable=callHistoryTable, rmtProfileEntryMpAvgPktSize=rmtProfileEntryMpAvgPktSize, rmtProfileEntryMpLineUtilization=rmtProfileEntryMpLineUtilization, callHistorySetupTime=callHistorySetupTime, isdnDchSupportedSwitches=isdnDchSupportedSwitches, isdnDchTable=isdnDchTable, rmtProfileEntryMpCapable=rmtProfileEntryMpCapable, isdnDchDirNum1=isdnDchDirNum1, ctISDNconfigMib=ctISDNconfigMib, rmtProfileEntryMakerName=rmtProfileEntryMakerName, rmtProfileEntryAction=rmtProfileEntryAction, ctron=ctron, callHistory=callHistory, callHistoryNeighborId=callHistoryNeighborId, callHistoryReceivePackets=callHistoryReceivePackets, callHistoryTransmitBytes=callHistoryTransmitBytes, isdnDchOperStatus=isdnDchOperStatus, rmtProfileEntry=rmtProfileEntry, callHistoryInfoType=callHistoryInfoType, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryPeerAddress=callHistoryPeerAddress, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlNbrCfgEntry=dialCtlNbrCfgEntry, DisplayString=DisplayString, mibs=mibs, callHistoryTransmitPackets=callHistoryTransmitPackets)
