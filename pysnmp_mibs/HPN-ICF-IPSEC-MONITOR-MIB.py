...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-IPSEC-MONITOR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:43:03 2025
...
hpnicfIPSecCompliance.setObjects(
      *(("HPN-ICF-IPSEC-MONITOR-MIB", "hpnicfIPSecTunnelTableGroup"),
        ("HPN-ICF-IPSEC-MONITOR-MIB", "hpnicfIPSecTunnelStatGroup"),
        ("HPN-ICF-IPSEC-MONITOR-MIB", "hpnicfIPSecSaGroup"),
        ("HPN-ICF-IPSEC-MONITOR-MIB", "hpnicfIPSecTrafficTableGroup"),
        ("HPN-ICF-IPSEC-MONITOR-MIB", "hpnicfIPSecGlobalStatsGroup"),
        ("HPN-ICF-IPSEC-MONITOR-MIB", "hpnicfIPSecTrapObjectGroup"),
        ("HPN-ICF-IPSEC-MONITOR-MIB", "hpnicfIPSecTrapCntlGroup"),
        ("HPN-ICF-IPSEC-MONITOR-MIB", "hpnicfIPSecTrapGroup"))
)
if mibBuilder.loadTexts:
