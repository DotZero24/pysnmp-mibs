...
alcatelIND1LLDPMEDMIBObjects=_AlcatelIND1LLDPMEDMIBObjects_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,58,1,1))
...
alaLldpMedLocMediaPolicyAttributes=_AlaLldpMedLocMediaPolicyAttributes_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1))
_AlaLldpXMedLocMediaPolicyTable_Object=MibTable
alaLldpXMedLocMediaPolicyTable=_AlaLldpXMedLocMediaPolicyTable_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1))
if mibBuilder.loadTexts:alaLldpXMedLocMediaPolicyTable.setStatus(_A)
_AlaLldpXMedLocMediaPolicyEntry_Object=MibTableRow
alaLldpXMedLocMediaPolicyEntry=_AlaLldpXMedLocMediaPolicyEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1))
alaLldpXMedLocMediaPolicyEntry.setIndexNames((0,_B,_E))
if mibBuilder.loadTexts:alaLldpXMedLocMediaPolicyEntry.setStatus(_A)
_AlaLldpXMedLocMediaPolicyId_Type=Unsigned32
_AlaLldpXMedLocMediaPolicyId_Object=MibTableColumn
alaLldpXMedLocMediaPolicyId=_AlaLldpXMedLocMediaPolicyId_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1,1),_AlaLldpXMedLocMediaPolicyId_Type())
...
alaLldpXMedLocMediaPolicyAppType=_AlaLldpXMedLocMediaPolicyAppType_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1,2),_AlaLldpXMedLocMediaPolicyAppType_Type())
...
alaLldpXMedLocMediaPolicyVlanType=_AlaLldpXMedLocMediaPolicyVlanType_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1,3),_AlaLldpXMedLocMediaPolicyVlanType_Type())
...
alaLldpXMedLocMediaPolicyVlanID=_AlaLldpXMedLocMediaPolicyVlanID_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1,4),_AlaLldpXMedLocMediaPolicyVlanID_Type())
...
alaLldpXMedLocMediaPolicyPriority=_AlaLldpXMedLocMediaPolicyPriority_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1,5),_AlaLldpXMedLocMediaPolicyPriority_Type())
...
alaLldpXMedLocMediaPolicyDscp=_AlaLldpXMedLocMediaPolicyDscp_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1,6),_AlaLldpXMedLocMediaPolicyDscp_Type())
...
alaLldpXMedLocMediaPolicyUnknown=_AlaLldpXMedLocMediaPolicyUnknown_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1,7),_AlaLldpXMedLocMediaPolicyUnknown_Type())
...
alaLldpXMedLocMediaPolicyTagged=_AlaLldpXMedLocMediaPolicyTagged_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1,8),_AlaLldpXMedLocMediaPolicyTagged_Type())
...
alaLldpXMedLocMediaPolicyRowStatus=_AlaLldpXMedLocMediaPolicyRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,1,1,9),_AlaLldpXMedLocMediaPolicyRowStatus_Type())
...
alaLldpXMedLocMediaPolicyPortTable=_AlaLldpXMedLocMediaPolicyPortTable_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,2))
...
alaLldpXMedLocMediaPolicyPortEntry=_AlaLldpXMedLocMediaPolicyPortEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,2,1))
alaLldpXMedLocMediaPolicyPortEntry.setIndexNames((0,_B,_H),(0,_B,_E))
...
alaLldpXMedLocMediaPolicyPortNumber=_AlaLldpXMedLocMediaPolicyPortNumber_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,2,1,1),_AlaLldpXMedLocMediaPolicyPortNumber_Type())
...
alaLldpXMedLocMediaPolicyPortRowStatus=_AlaLldpXMedLocMediaPolicyPortRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,58,1,1,1,2,1,2),_AlaLldpXMedLocMediaPolicyPortRowStatus_Type())
...
alcatelIND1LLDPMEDMIBConformance=_AlcatelIND1LLDPMEDMIBConformance_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,58,1,2))
_AlcatelIND1LLDPMEDMIBCompliances_ObjectIdentity=ObjectIdentity
alcatelIND1LLDPMEDMIBCompliances=_AlcatelIND1LLDPMEDMIBCompliances_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,58,1,2,1))
_AlcatelIND1LLDPMEDMIBGroups_ObjectIdentity=ObjectIdentity
alcatelIND1LLDPMEDMIBGroups=_AlcatelIND1LLDPMEDMIBGroups_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,58,1,2,2))
alaLldpXMedLocMediaPolicyGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,58,1,2,2,1))
...
alcatelIND1LLDPMEDMIBCompliance=ModuleCompliance((1,3,6,1,4,1,6486,801,1,2,1,58,1,2,1,1))
