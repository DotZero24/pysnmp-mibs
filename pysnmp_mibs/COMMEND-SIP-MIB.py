...
# Notes
# -----
# ASN.1 source file://mibs/commend/COMMEND-SIP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:06:59 2025
...
class _CommendStationCommonStationNtpState_Type(OctetString):
    """Custom type commendStationCommonStationNtpState based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 1024),
    )
...
_CommendStationCommonStationNtpState_Type.__name__ = "OctetString"
_CommendStationCommonStationNtpState_Object = MibScalar
commendStationCommonStationNtpState = _CommendStationCommonStationNtpState_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 1, 25),
    _CommendStationCommonStationNtpState_Type()
)
commendStationCommonStationNtpState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    commendStationCommonStationNtpState.setStatus("current")
...
class _CommendStationConnectivitySipAccount_Type(OctetString):
    """Custom type commendStationConnectivitySipAccount based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 1024),
    )
...
_CommendStationConnectivitySipAccount_Type.__name__ = "OctetString"
_CommendStationConnectivitySipAccount_Object = MibScalar
commendStationConnectivitySipAccount = _CommendStationConnectivitySipAccount_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 2, 5, 5),
    _CommendStationConnectivitySipAccount_Type()
)
commendStationConnectivitySipAccount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    commendStationConnectivitySipAccount.setStatus("current")
...
commendStationConnectivitySipAccountTable = _CommendStationConnectivitySipAccountTable_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 2, 5, 40)
)
if mibBuilder.loadTexts:
    commendStationConnectivitySipAccountTable.setStatus("current")
_AccountTableEntry_Object = MibTableRow
accountTableEntry = _AccountTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 2, 5, 40, 1)
)
accountTableEntry.setIndexNames(
    (0, "COMMEND-SIP-MIB", "accountNumber"),
)
if mibBuilder.loadTexts:
    accountTableEntry.setStatus("current")


class _AccountNumber_Type(OctetString):
    """Custom type accountNumber based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AccountNumber_Type.__name__ = "OctetString"
_AccountNumber_Object = MibTableColumn
accountNumber = _AccountNumber_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 2, 5, 40, 1, 1),
    _AccountNumber_Type()
)
accountNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    accountNumber.setStatus("current")


class _AccountDisplayName_Type(OctetString):
    """Custom type accountDisplayName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_AccountDisplayName_Type.__name__ = "OctetString"
_AccountDisplayName_Object = MibTableColumn
accountDisplayName = _AccountDisplayName_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 2, 5, 40, 1, 2),
    _AccountDisplayName_Type()
)
accountDisplayName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    accountDisplayName.setStatus("current")
_AccountUserId_Type = OctetString
_AccountUserId_Object = MibTableColumn
accountUserId = _AccountUserId_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 2, 5, 40, 1, 3),
    _AccountUserId_Type()
)
accountUserId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    accountUserId.setStatus("current")
_AccountServer_Type = OctetString
_AccountServer_Object = MibTableColumn
accountServer = _AccountServer_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 2, 5, 40, 1, 4),
    _AccountServer_Type()
)
accountServer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    accountServer.setStatus("current")
_AccountState_Type = OctetString
_AccountState_Object = MibTableColumn
accountState = _AccountState_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 2, 5, 40, 1, 5),
    _AccountState_Type()
)
accountState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    accountState.setStatus("current")
...
commendStationAudiomonitoring = _CommendStationAudiomonitoring_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 3, 5)
)


class _CommendStationAudiomonitoringStatus_Type(OctetString):
    """Custom type commendStationAudiomonitoringStatus based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 1024),
    )
...
_CommendStationAudiomonitoringStatus_Type.__name__ = "OctetString"
_CommendStationAudiomonitoringStatus_Object = MibScalar
commendStationAudiomonitoringStatus = _CommendStationAudiomonitoringStatus_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 3, 5, 1),
    _CommendStationAudiomonitoringStatus_Type()
)
commendStationAudiomonitoringStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    commendStationAudiomonitoringStatus.setStatus("current")
...
commendStationInputTable = _CommendStationInputTable_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 4, 20)
)
if mibBuilder.loadTexts:
    commendStationInputTable.setStatus("current")
_InputTableEntry_Object = MibTableRow
inputTableEntry = _InputTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 4, 20, 1)
)
inputTableEntry.setIndexNames(
    (0, "COMMEND-SIP-MIB", "inputName"),
)
if mibBuilder.loadTexts:
    inputTableEntry.setStatus("current")


class _InputName_Type(OctetString):
    """Custom type inputName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_InputName_Type.__name__ = "OctetString"
_InputName_Object = MibTableColumn
inputName = _InputName_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 4, 20, 1, 1),
    _InputName_Type()
)
inputName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    inputName.setStatus("current")


class _InputState_Type(OctetString):
    """Custom type inputState based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_InputState_Type.__name__ = "OctetString"
_InputState_Object = MibTableColumn
inputState = _InputState_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 4, 20, 1, 2),
    _InputState_Type()
)
inputState.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
commendStationOutputTable = _CommendStationOutputTable_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 5, 20)
)
if mibBuilder.loadTexts:
    commendStationOutputTable.setStatus("current")
_OutputTableEntry_Object = MibTableRow
outputTableEntry = _OutputTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 5, 20, 1)
)
outputTableEntry.setIndexNames(
    (0, "COMMEND-SIP-MIB", "outputName"),
)
if mibBuilder.loadTexts:
    outputTableEntry.setStatus("current")


class _OutputName_Type(OctetString):
    """Custom type outputName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_OutputName_Type.__name__ = "OctetString"
_OutputName_Object = MibTableColumn
outputName = _OutputName_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 5, 20, 1, 1),
    _OutputName_Type()
)
outputName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    outputName.setStatus("current")


class _OutputState_Type(OctetString):
    """Custom type outputState based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_OutputState_Type.__name__ = "OctetString"
_OutputState_Object = MibTableColumn
outputState = _OutputState_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 5, 20, 1, 2),
    _OutputState_Type()
)
outputState.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    outputState.setStatus("current")
_CommendStationOutputStatus_ObjectIdentity = ObjectIdentity
commendStationOutputStatus = _CommendStationOutputStatus_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 7)
)


class _CommendStationLastOutputChange_Type(OctetString):
    """Custom type commendStationLastOutputChange based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 1024),
    )
...
_CommendStationLastOutputChange_Type.__name__ = "OctetString"
_CommendStationLastOutputChange_Object = MibScalar
commendStationLastOutputChange = _CommendStationLastOutputChange_Object(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 7, 1),
    _CommendStationLastOutputChange_Type()
)
commendStationLastOutputChange.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    commendStationLastOutputChange.setStatus("current")
...
commendStationCommonStationNtpNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 1, 26)
)
if mibBuilder.loadTexts:
    commendStationCommonStationNtpNotification.setStatus(
        "current"
    )
...
commendStationAudioMonitoringAlarmNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 3, 12)
)
if mibBuilder.loadTexts:
    commendStationAudioMonitoringAlarmNotification.setStatus(
        "current"
    )
...
commendStationOutputNotifications = NotificationType(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 5, 9)
)
if mibBuilder.loadTexts:
    commendStationOutputNotifications.setStatus(
        "current"
    )

commendStationOutputChangedNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 37568, 2, 1, 5, 9, 1)
)
if mibBuilder.loadTexts:
    commendStationOutputChangedNotification.setStatus(
        "current"
    )
...
commendStationApplicationStart = NotificationType(
    (1, 3, 6, 1, 4, 1, 37568, 2, 20)
)
if mibBuilder.loadTexts:
    commendStationApplicationStart.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"commend": commend,
       ...
       "commendStationCommonStationNtpState": commendStationCommonStationNtpState,
       "commendStationCommonStationNtpNotification": commendStationCommonStationNtpNotification,
       ...
       "commendStationConnectivitySipAccountTable": commendStationConnectivitySipAccountTable,
       "accountTableEntry": accountTableEntry,
       ...
       "commendStationAudiomonitoring": commendStationAudiomonitoring,
       "commendStationAudiomonitoringStatus": commendStationAudiomonitoringStatus,
       ...
       "commendStationAudioMonitoringAlarmNotification": commendStationAudioMonitoringAlarmNotification,
       ...
       "commendStationInputTable": commendStationInputTable,
       ...
       "commendStationOutputNotifications": commendStationOutputNotifications,
       "commendStationOutputChangedNotification": commendStationOutputChangedNotification,
       "commendStationOutputTable": commendStationOutputTable,
       "outputTableEntry": outputTableEntry,
       "outputName": outputName,
       "outputState": outputState,
       "commendStationOutputStatus": commendStationOutputStatus,
       ...
       "commendStationApplicationStart": commendStationApplicationStart}
)
