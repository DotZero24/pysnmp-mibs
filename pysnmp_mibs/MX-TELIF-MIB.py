...
mibBuilder.exportSymbols("MX-TELIF-MIB", interopDtmfDetectionEntry=interopDtmfDetectionEntry, countryCustomizationToneTable=countryCustomizationToneTable, countryCustomizationToneTone=countryCustomizationToneTone, specificCountryCustomizationUserGainEntry=specificCountryCustomizationUserGainEntry, specificCountryCustomizationUserGainEnableConfig=specificCountryCustomizationUserGainEnableConfig, interopDtmfDetectionBreakPowerThreshold=interopDtmfDetectionBreakPowerThreshold, defaultMachineDetectionCngToneDetection=defaultMachineDetectionCngToneDetection, telIfMIB=telIfMIB, specificCountryCustomizationDialingInterDtmfDialDelay=specificCountryCustomizationDialingInterDtmfDialDelay, defaultMachineDetectionCedToneDetection=defaultMachineDetectionCedToneDetection, distinctiveCallWaitingTonePattern=distinctiveCallWaitingTonePattern, defaultCountryCustomizationDialingMfR1Duration=defaultCountryCustomizationDialingMfR1Duration, defaultCountryCustomizationDialingInterMfR1DialDelay=defaultCountryCustomizationDialingInterMfR1DialDelay, minSeverity=minSeverity, specificMachineDetectionEntry=specificMachineDetectionEntry, interopDtmfDetectionTable=interopDtmfDetectionTable, specificCountryCustomizationUserGainInterfaceId=specificCountryCustomizationUserGainInterfaceId, countryToneStatusPattern=countryToneStatusPattern, specificCountryCustomizationDialingMfR1Duration=specificCountryCustomizationDialingMfR1Duration, specificCountryCustomizationUserGainInputOffset=specificCountryCustomizationUserGainInputOffset, PYSNMP_MODULE_ID=telIfMIB, distinctiveCallWaitingToneTable=distinctiveCallWaitingToneTable, specificMachineDetectionCedToneDetection=specificMachineDetectionCedToneDetection, specificMachineDetectionV21ModulationDetection=specificMachineDetectionV21ModulationDetection, defaultCountryCustomizationUserGainInputOffset=defaultCountryCustomizationUserGainInputOffset, specificCountryCustomizationDialingInterMfR1DialDelay=specificCountryCustomizationDialingInterMfR1DialDelay, specificCountryCustomizationDialingEnableConfig=specificCountryCustomizationDialingEnableConfig, interopStartCallInVbdEntry=interopStartCallInVbdEntry, defaultMachineDetectionV21ModulationDetection=defaultMachineDetectionV21ModulationDetection, distinctiveCallWaitingToneEntry=distinctiveCallWaitingToneEntry, interopDtmfDetectionMaxPowerThreshold=interopDtmfDetectionMaxPowerThreshold, interopDtmfDetectionNegativeTwist=interopDtmfDetectionNegativeTwist, countryCustomizationToneOverride=countryCustomizationToneOverride, specificMachineDetectionInterfaceId=specificMachineDetectionInterfaceId, interopDtmfDetectionMinPowerThreshold=interopDtmfDetectionMinPowerThreshold, specificCountryCustomizationUserGainTable=specificCountryCustomizationUserGainTable, distinctiveCallWaitingToneToneId=distinctiveCallWaitingToneToneId, specificMachineDetectionBehaviorOnCedToneDetection=specificMachineDetectionBehaviorOnCedToneDetection, musicOnHoldStreamingGroup=musicOnHoldStreamingGroup, interopDtmfDetectionRiseTimeCriteria=interopDtmfDetectionRiseTimeCriteria, countryCustomizationToneGroup=countryCustomizationToneGroup, specificCountryCustomizationDialingDtmfDuration=specificCountryCustomizationDialingDtmfDuration, specificCountryCustomizationDialingTable=specificCountryCustomizationDialingTable, specificCountryCustomizationDialingOverride=specificCountryCustomizationDialingOverride, callWaitingToneGroup=callWaitingToneGroup, interopDtmfDetectionPositiveTwist=interopDtmfDetectionPositiveTwist, specificCountryCustomizationDialingInterfaceId=specificCountryCustomizationDialingInterfaceId, specificMachineDetectionTable=specificMachineDetectionTable, interopStartCallInVbdInterfaceId=interopStartCallInVbdInterfaceId, defaultCountryCustomizationUserGainOutputOffset=defaultCountryCustomizationUserGainOutputOffset, specificCountryCustomizationUserGainOutputOffset=specificCountryCustomizationUserGainOutputOffset, defaultCountryCustomizationDialingOverride=defaultCountryCustomizationDialingOverride, countryToneStatusTone=countryToneStatusTone, countryToneStatusEntry=countryToneStatusEntry, countrySelection=countrySelection, interopDtmfDetectionInterfaceId=interopDtmfDetectionInterfaceId, distinctiveCallWaitingToneIndex=distinctiveCallWaitingToneIndex, countryCustomizationDialingGroup=countryCustomizationDialingGroup, interopGroup=interopGroup, countryToneStatusTable=countryToneStatusTable, notificationsGroup=notificationsGroup, defaultCountryCustomizationDialingDtmfDuration=defaultCountryCustomizationDialingDtmfDuration, specificMachineDetectionCngToneDetection=specificMachineDetectionCngToneDetection, musicOnHoldStreamingEnable=musicOnHoldStreamingEnable, countryCustomizationUserGainGroup=countryCustomizationUserGainGroup, machineDetectionGroup=machineDetectionGroup, interopStartCallInVbdEnable=interopStartCallInVbdEnable, countryCustomizationGroup=countryCustomizationGroup, defaultCountryCustomizationDialingInterDtmfDialDelay=defaultCountryCustomizationDialingInterDtmfDialDelay, defaultMachineDetectionBehaviorOnCedToneDetection=defaultMachineDetectionBehaviorOnCedToneDetection, specificCountryCustomizationDialingEntry=specificCountryCustomizationDialingEntry, telIfMIBObjects=telIfMIBObjects, specificMachineDetectionEnableConfig=specificMachineDetectionEnableConfig, configurationGroup=configurationGroup, needRestartInfo=needRestartInfo, countryCustomizationToneEntry=countryCustomizationToneEntry, interopStartCallInVbdTable=interopStartCallInVbdTable, countryCustomizationTonePattern=countryCustomizationTonePattern)
