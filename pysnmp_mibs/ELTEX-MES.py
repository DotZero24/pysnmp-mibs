...
# Notes
# -----
# ASN.1 source file://mibs/eltex/ELTEX-MES
# Produced by pysmi-1.6.2 at Fri Oct 10 19:51:22 2025
...
eltMesHardwareMib = _EltMesHardwareMib_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 35265, 1, 23, 14)
)
...
eltMesSecuritySuiteMIB = _EltMesSecuritySuiteMIB_ObjectIdentity(
...
eltMesTacacs = _EltMesTacacs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 35265, 1, 23, 81)
)
