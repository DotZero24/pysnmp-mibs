...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-IF-EXT-CONFIG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:01:18 2025
...
pdnIfMultiprotocolEncapCompliance.setObjects(
      *(("PDN-IF-EXT-CONFIG-MIB", "pdnIfMultiprotocolEncapsulationOptionalGroup"),
        ("PDN-IF-EXT-CONFIG-MIB", "pdnIfXLinkConfigOptionalGroup"))
)
if mibBuilder.loadTexts:
