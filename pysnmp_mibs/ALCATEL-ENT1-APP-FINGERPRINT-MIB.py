# SNMP MIB module (ALCATEL-ENT1-APP-FINGERPRINT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-APP-FINGERPRINT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:10:09 2025
...
alaAppFPPortEntry.setIndexNames(
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPPort"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPGroupNameOrPolicyList"),
)
if mibBuilder.loadTexts:
...
alaAppFPAppNameEntry.setIndexNames(
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPAppName"),
)
if mibBuilder.loadTexts:
...
alaAppFPDatabaseEntry.setIndexNames(
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbPort"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbAppGroupName"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbAppName"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbSrcMacAddr"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbVlanId"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbSrcIpAddrType"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbSrcIpAddr"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbSrcPort"),
)
if mibBuilder.loadTexts:
...
appFPAppGrpNameEntry.setIndexNames(
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPAppGroupName"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPGrpAppName"),
)
if mibBuilder.loadTexts:
...
alaAppFPStatsEntry.setIndexNames(
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPStatsPort"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPStatsGroupName"),
    (0, "ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPStatsAppName"),
)
if mibBuilder.loadTexts:
...
alaAppFPModuleConfigGroup.setObjects(
      *(("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPGlobalAdminState"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPGlobalReloadSignatureFile"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPGlobalSignatureFile"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPGlobalTrapConfig"))
)
if mibBuilder.loadTexts:
...
alaAppFPModulePortModeGroup.setObjects(
      *(("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPAppDescription"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPAppSignature"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPPortOperationMode"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPPortStatus"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPPortRowStatus"))
)
if mibBuilder.loadTexts:
...
alaAppFPModulePortDBGroup.setObjects(
      *(("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbDstIpAddrType"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbDstIpAddr"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbDstPort"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbDstMacAddr"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPGrpAppName"))
)
if mibBuilder.loadTexts:
...
alaAppFPModulePortStatsGroup.setObjects(
      *(("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPTotalMatchedLast1Hour"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPTotalMatchedLast1Day"))
)
if mibBuilder.loadTexts:
...
appFPSignatureMatchTrap.setObjects(
      *(("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPPort"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbAppGroupName"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbAppName"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbSrcMacAddr"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbVlanId"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbSrcIpAddrType"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbSrcIpAddr"),
        ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "alaAppFPDbSrcPort"))
)
if mibBuilder.loadTexts:
...
alaAppFPNotificationsGroup.setObjects(
    ("ALCATEL-ENT1-APP-FINGERPRINT-MIB", "appFPSignatureMatchTrap")
)
if mibBuilder.loadTexts:
