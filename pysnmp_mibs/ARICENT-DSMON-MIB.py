...
fsDsmonTrace=_FsDsmonTrace_Object((1,3,6,1,4,1,29601,3,4,1),_FsDsmonTrace_Type())
...
fsDsmonAdminStatus=_FsDsmonAdminStatus_Object((1,3,6,1,4,1,29601,3,4,2),_FsDsmonAdminStatus_Type())
fsDsmonAdminStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:fsDsmonAdminStatus.setStatus(_C)
mibBuilder.exportSymbols('ARICENT-DSMON-MIB',**{'fsdsmon':fsdsmon,'fsDsmonTrace':fsDsmonTrace,'fsDsmonAdminStatus':fsDsmonAdminStatus})