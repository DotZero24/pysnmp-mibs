...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-DOT11-IF-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:29:23 2025
...
mibBuilder.exportSymbols("CISCO-DOT11-IF-MIB", cd11IfDot11UpgradeStatus=cd11IfDot11UpgradeStatus, cd11IfErpOfdmTxPowerLevel4=cd11IfErpOfdmTxPowerLevel4, ciscoDot11IfMIBGroups=ciscoDot11IfMIBGroups, cd11IfWepDefaultKeyLen=cd11IfWepDefaultKeyLen, cd11IfFrequencyBandEntry=cd11IfFrequencyBandEntry, cd11IfVlanWepEncryptKeyHashing=cd11IfVlanWepEncryptKeyHashing, ciscoDot11IfComplianceRev1=ciscoDot11IfComplianceRev1, cd11IfAuthAlgorithmEntry=cd11IfAuthAlgorithmEntry, cd11IfDomainCapabilitySet=cd11IfDomainCapabilitySet, cd11IfAuxSsidAuthAlgRequireEap=cd11IfAuxSsidAuthAlgRequireEap, cd11IfConfigurations=cd11IfConfigurations, ciscoDot11IfComplianceRev3=ciscoDot11IfComplianceRev3, cd11IfDataRatesSensitivityGroup=cd11IfDataRatesSensitivityGroup, cd11IfDesiredSsidMaxAssocSta=cd11IfDesiredSsidMaxAssocSta, cd11IfDesiredBssEntry=cd11IfDesiredBssEntry, cd11IfDomainCapabilityGroup=cd11IfDomainCapabilityGroup, cd11IfSuppDataRatesPrivacyValue=cd11IfSuppDataRatesPrivacyValue, cd11IfRatesSensRequiredSnr=cd11IfRatesSensRequiredSnr, cd11IfSuppDataRatesPrivacyIndex=cd11IfSuppDataRatesPrivacyIndex, cd11IfRogueApName=cd11IfRogueApName, cd11IfAuxSsidAuthAlgDefaultVlan=cd11IfAuxSsidAuthAlgDefaultVlan, cd11IfAuxSsidAuthAlgMacMethod=cd11IfAuxSsidAuthAlgMacMethod, cd11IfAssignedSta=cd11IfAssignedSta, ciscoDot11IfMIBNotifications=ciscoDot11IfMIBNotifications, cd11IfVlanManageGroup=cd11IfVlanManageGroup, cd11IfRadioMonitoringEntry=cd11IfRadioMonitoringEntry, cd11IfErpOfdmCurrentTxPowerLevel=cd11IfErpOfdmCurrentTxPowerLevel, cd11IfVlanSecurityRowStatus=cd11IfVlanSecurityRowStatus, cd11IfPsPacketForwardEnable=cd11IfPsPacketForwardEnable, ciscoDot11IfMIBConformance=ciscoDot11IfMIBConformance, cd11IfDesiredSsidWepPermuteAlg=cd11IfDesiredSsidWepPermuteAlg, cd11IfManagement=cd11IfManagement, cd11IfDot11UpgradeStatusTable=cd11IfDot11UpgradeStatusTable, ciscoDot11IfMIB=ciscoDot11IfMIB, cd11IfClientNumberTxPowerLevels=cd11IfClientNumberTxPowerLevels, cd11IfNativeCurrentPowerLevel=cd11IfNativeCurrentPowerLevel, cd11IfSsidAssociationGroup=cd11IfSsidAssociationGroup, ciscoDot11IfMIBCompliances=ciscoDot11IfMIBCompliances, PYSNMP_MODULE_ID=ciscoDot11IfMIB, cd11IfLocalRadioMonitorStatus=cd11IfLocalRadioMonitorStatus, cd11IfEthernetEncapsulDefault=cd11IfEthernetEncapsulDefault, cd11IfAuxSsidEntry=cd11IfAuxSsidEntry, cd11IfPhyFhssMaxCompatibleRate=cd11IfPhyFhssMaxCompatibleRate, cd11IfClientTxPowerLevel7=cd11IfClientTxPowerLevel7, cd11IfMacLayerCountersEntry=cd11IfMacLayerCountersEntry, cd11IfRadioMonitoringTable=cd11IfRadioMonitoringTable, cd11IfPhyDsssEntry=cd11IfPhyDsssEntry, cd11IfCiscoExtensionsEnable=cd11IfCiscoExtensionsEnable, cd11IfCurrentCarrierSet=cd11IfCurrentCarrierSet, cd11IfPhyOperationEntry=cd11IfPhyOperationEntry, cd11IfSuppDataRatesPrivacyTable=cd11IfSuppDataRatesPrivacyTable, cd11IfAuxSsidAuthAlgEntry=cd11IfAuxSsidAuthAlgEntry, cd11IfAuxSsidTable=cd11IfAuxSsidTable, cd11IfRecFrameMacCrcErrors=cd11IfRecFrameMacCrcErrors, cd11IfClientTxPowerLevel1=cd11IfClientTxPowerLevel1, cd11IfRadioMonitorRowStatus=cd11IfRadioMonitorRowStatus, cd11IfClientCurrentTxPowerLevel=cd11IfClientCurrentTxPowerLevel, cd11IfNativeTxPower=cd11IfNativeTxPower, ciscoDot11IfCompliance=ciscoDot11IfCompliance, cd11IfErpOfdmTxPowerEntry=cd11IfErpOfdmTxPowerEntry, cd11IfErpOfdmNumberTxPowerLevels=cd11IfErpOfdmNumberTxPowerLevels, cd11IfErpOfdmTxPowerLevel2=cd11IfErpOfdmTxPowerLevel2, cd11IfChanSelectChannel=cd11IfChanSelectChannel, cd11IfRogueApDetectedEntry=cd11IfRogueApDetectedEntry, cd11IfStationManageGroup=cd11IfStationManageGroup, cd11IfRatesSensContention=cd11IfRatesSensContention, cd11IfErpOfdmTxPowerLevel8=cd11IfErpOfdmTxPowerLevel8, cd11IfAuxSsidMicAlgorithm=cd11IfAuxSsidMicAlgorithm, cd11IfAuxSsidAuthAlgEnable=cd11IfAuxSsidAuthAlgEnable, cd11IfBridgeSpacing=cd11IfBridgeSpacing, cd11IfMultipleBssidEnable=cd11IfMultipleBssidEnable, ciscoDot11IfComplianceRev2=ciscoDot11IfComplianceRev2, cd11IfVlanSecurityVlanId=cd11IfVlanSecurityVlanId, CDot11IfWepKeyPermuteAlgorithm=CDot11IfWepKeyPermuteAlgorithm, cd11IfRemoteMonitoringGroup=cd11IfRemoteMonitoringGroup, cd11IfPhyConfigGroupRev1=cd11IfPhyConfigGroupRev1, cd11IfPhyDsssCurrentChannel=cd11IfPhyDsssCurrentChannel, cd11IfMobileStationScanParent=cd11IfMobileStationScanParent, cd11IfDesiredBssTable=cd11IfDesiredBssTable, cd11IfAuthAlgEapMethod=cd11IfAuthAlgEapMethod, cd11IfWepDefaultKeyIndex=cd11IfWepDefaultKeyIndex, cd11IfSuppDataRatesPrivacyEntry=cd11IfSuppDataRatesPrivacyEntry, cd11IfErpOfdmTxPowerLevel6=cd11IfErpOfdmTxPowerLevel6, cd11IfRfFrequencyBandType=cd11IfRfFrequencyBandType, cd11IfNativePowerUnits=cd11IfNativePowerUnits, cd11IfAuxSsidWepPermuteAlg=cd11IfAuxSsidWepPermuteAlg, cd11IfAssignedAid=cd11IfAssignedAid, CDot11IfCipherType=CDot11IfCipherType, cd11IfVlanSecurityTable=cd11IfVlanSecurityTable, cd11IfVlanWepEncryptOptions=cd11IfVlanWepEncryptOptions, cd11IfVlanSecurityEntry=cd11IfVlanSecurityEntry, cd11IfAuxSsidBroadcastSsid=cd11IfAuxSsidBroadcastSsid, cd11IfClientTxPowerLevel6=cd11IfClientTxPowerLevel6, cd11IfAssignedAidEntry=cd11IfAssignedAidEntry, cd11IfRadioManageGroup=cd11IfRadioManageGroup, cd11IfErpOfdmTxPowerLevel5=cd11IfErpOfdmTxPowerLevel5, cd11IfPhyConcatenation=cd11IfPhyConcatenation, cd11IfRogueApMacAddr=cd11IfRogueApMacAddr, cd11IfMonitorNotificationGroup=cd11IfMonitorNotificationGroup, cd11IfRemoteRadioMacAddr=cd11IfRemoteRadioMacAddr, cd11IfVlanSecurityVlanEnabled=cd11IfVlanSecurityVlanEnabled, cd11IfRogueApDetectedNotif=cd11IfRogueApDetectedNotif, cd11IfErpOfdmTxPowerTable=cd11IfErpOfdmTxPowerTable, cd11Ifdot11MobileStationScanGroup=cd11Ifdot11MobileStationScanGroup, cd11IfRadioMonitorPollingFreq=cd11IfRadioMonitorPollingFreq, cd11IfPhyFhssTable=cd11IfPhyFhssTable, cd11IfPrivacyOptionMaxRate=cd11IfPrivacyOptionMaxRate, cd11IfClientTxPowerLevel2=cd11IfClientTxPowerLevel2, cd11IfSuppDataRatesPrivacyEnabl=cd11IfSuppDataRatesPrivacyEnabl, cd11IfClientTxPowerEntry=cd11IfClientTxPowerEntry, cd11IfAssociationManageGroup=cd11IfAssociationManageGroup, cd11Ifdot11UpgradeStatusGroup=cd11Ifdot11UpgradeStatusGroup, cd11IfErpOfdmTxPowerLevel7=cd11IfErpOfdmTxPowerLevel7, cd11IfClientTxPowerLevel5=cd11IfClientTxPowerLevel5, cd11IfRogueApDetectedGroup=cd11IfRogueApDetectedGroup, cd11IfAuthAlgRequireEap=cd11IfAuthAlgRequireEap, cd11IfStationConfigTable=cd11IfStationConfigTable, cd11IfVlanId=cd11IfVlanId, cd11IfAuthAlgorithmTable=cd11IfAuthAlgorithmTable, cd11IfPhyConfigGroup=cd11IfPhyConfigGroup, cd11IfVlanEncryptKeyTransmit=cd11IfVlanEncryptKeyTransmit, cd11IfVlanEncryptKeyStatus=cd11IfVlanEncryptKeyStatus, cd11IfVlanWepManageGroup=cd11IfVlanWepManageGroup, cd11IfRfFrequencySpacing=cd11IfRfFrequencySpacing, CDot11IfVlanIdOrZero=CDot11IfVlanIdOrZero, cd11IfNativeTxPowerSupportEntry=cd11IfNativeTxPowerSupportEntry, cd11IfVlanSecurityCiphers=cd11IfVlanSecurityCiphers, cd11IfRadioModulationClass=cd11IfRadioModulationClass, ciscoDot11IfComplianceRev4=ciscoDot11IfComplianceRev4, cd11IfClientTxPowerTable=cd11IfClientTxPowerTable, cd11IfRfNativePowerEntry=cd11IfRfNativePowerEntry, cd11IfPreambleType=cd11IfPreambleType, cd11IfMacLayerCountersTable=cd11IfMacLayerCountersTable, ciscoDot11IfMIBObjects=ciscoDot11IfMIBObjects, cd11IfChanSelectEnable=cd11IfChanSelectEnable, cd11IfMacStatisticsGroup=cd11IfMacStatisticsGroup, cd11IfFrequencyBandTable=cd11IfFrequencyBandTable, cd11IfErpOfdmTxPowerLevel3=cd11IfErpOfdmTxPowerLevel3, WepKeyType128=WepKeyType128, cd11IfPhyBasicRateSet=cd11IfPhyBasicRateSet, cd11IfPhyDsssMaxCompatibleRate=cd11IfPhyDsssMaxCompatibleRate, cd11IfVlanEncryptKeyTable=cd11IfVlanEncryptKeyTable, cd11IfAuxSsidAuthAlgTable=cd11IfAuxSsidAuthAlgTable, cd11IfPhyMacCapabilityGroup=cd11IfPhyMacCapabilityGroup, cd11IfMaxChannelSwitchTime=cd11IfMaxChannelSwitchTime, cd11IfPhyNativePowerUseStandard=cd11IfPhyNativePowerUseStandard, cd11IfErpOfdmTxPowerLevel1=cd11IfErpOfdmTxPowerLevel1, cd11IfVlanBcastKeyClientLeave=cd11IfVlanBcastKeyClientLeave, cd11IfPhyDsssTable=cd11IfPhyDsssTable, cd11IfRadioMonitorPollingTimeOut=cd11IfRadioMonitorPollingTimeOut, cd11IfDot11UpgradeStatusEntry=cd11IfDot11UpgradeStatusEntry, cd11IfRfFrequencyUnits=cd11IfRfFrequencyUnits, cd11IfPhyErpConfigGroup=cd11IfPhyErpConfigGroup, Cd11IfDot11UpgradeStatus=Cd11IfDot11UpgradeStatus, cd11IfPhyConfig=cd11IfPhyConfig, cd11IfClientTxPowerLevel8=cd11IfClientTxPowerLevel8, CDot11RadioModulationClass=CDot11RadioModulationClass, cd11IfAllowBroadcastSsidAssoc=cd11IfAllowBroadcastSsidAssoc, cd11IfWepDefaultKeysTable=cd11IfWepDefaultKeysTable, cd11IfClientTxPowerLevel3=cd11IfClientTxPowerLevel3, cd11IfVlanEncryptKeyLen=cd11IfVlanEncryptKeyLen, cd11IfPhyFhssEntry=cd11IfPhyFhssEntry, cd11IfStatistics=cd11IfStatistics, cd11IfModulationType=cd11IfModulationType, cd11IfChanSelectTable=cd11IfChanSelectTable, cd11IfNativeRadioManageGroup=cd11IfNativeRadioManageGroup, cd11IfRfStartChannelNumber=cd11IfRfStartChannelNumber, cd11IfManagementGroup=cd11IfManagementGroup, cd11IfAuxSsidAuthAlgEapMethod=cd11IfAuxSsidAuthAlgEapMethod, cd11IfPhyOperationTable=cd11IfPhyOperationTable, cd11IfDesiredBssIndex=cd11IfDesiredBssIndex, cd11IfRfEndChannelNumber=cd11IfRfEndChannelNumber, cd11IfVlanWepEncryptMic=cd11IfVlanWepEncryptMic, cd11IfAuxSsidIndex=cd11IfAuxSsidIndex, cd11IfStationConfigEntry=cd11IfStationConfigEntry, cd11IfWorldMode=cd11IfWorldMode, cd11IfStationSwitchOverNotif=cd11IfStationSwitchOverNotif, cd11IfRogueApDetectedTable=cd11IfRogueApDetectedTable, cd11IfVlanEncryptKeyEntry=cd11IfVlanEncryptKeyEntry, cd11IfNativeTxPowerLevel=cd11IfNativeTxPowerLevel, cd11IfVlanEncryptKeyIndex=cd11IfVlanEncryptKeyIndex, cd11IfVlanBcastKeyCapabilChange=cd11IfVlanBcastKeyCapabilChange, cd11IfPhyDsssChannelAutoEnable=cd11IfPhyDsssChannelAutoEnable, cd11IfVlanPsPacketForwardEnable=cd11IfVlanPsPacketForwardEnable, cd11IfAssignedAidTable=cd11IfAssignedAidTable, CDot11RadioFrequencyBandType=CDot11RadioFrequencyBandType, cd11IfChanSelectEntry=cd11IfChanSelectEntry, cd11IfWorldModeCountry=cd11IfWorldModeCountry, cd11IfTransDeferEnerDetects=cd11IfTransDeferEnerDetects, cd11IfClientTxPowerLevel4=cd11IfClientTxPowerLevel4, cd11IfVlanEncryptionMode=cd11IfVlanEncryptionMode, cd11IfWepDefaultKeyValue=cd11IfWepDefaultKeyValue, cd11IfMobileStationListIgnore=cd11IfMobileStationListIgnore, cd11IfAuthAlgMethodListGroup=cd11IfAuthAlgMethodListGroup, cd11IfVlanEncryptKeyValue=cd11IfVlanEncryptKeyValue, cd11IfDataRatesSensitivityTable=cd11IfDataRatesSensitivityTable, cd11IfVlanEncryptKeyConfigGroup=cd11IfVlanEncryptKeyConfigGroup, cd11IfAuthAlgDefaultVlan=cd11IfAuthAlgDefaultVlan, cd11IfAuxSsidMaxAssocSta=cd11IfAuxSsidMaxAssocSta, cd11IfAuxSsidAuthAlgRequireMac=cd11IfAuxSsidAuthAlgRequireMac, cd11IfVlanBcastKeyChangeInterval=cd11IfVlanBcastKeyChangeInterval, cd11IfRfNativePowerTable=cd11IfRfNativePowerTable, cd11IfDesiredBssAddr=cd11IfDesiredBssAddr, CDot11IfMicAlgorithm=CDot11IfMicAlgorithm, cd11IfDesiredSsidMicAlgorithm=cd11IfDesiredSsidMicAlgorithm, cd11IfWepDefaultKeysEntry=cd11IfWepDefaultKeysEntry, cd11IfAuthAlgRequireMacAddr=cd11IfAuthAlgRequireMacAddr, cd11IfRfChannelSpacingNumber=cd11IfRfChannelSpacingNumber, cd11IfNativeTxPowerSupportTable=cd11IfNativeTxPowerSupportTable, cd11IfPhyMacSpecification=cd11IfPhyMacSpecification, cd11IfDataRatesSensitivityEntry=cd11IfDataRatesSensitivityEntry, cd11IfAuthAlgMacAddrMethod=cd11IfAuthAlgMacAddrMethod, cd11IfNativeNumberPowerLevels=cd11IfNativeNumberPowerLevels, cd11IfAuxiliarySsidLength=cd11IfAuxiliarySsidLength, cd11IfVoipExtensionsEnable=cd11IfVoipExtensionsEnable, cd11IfAuxSsid=cd11IfAuxSsid, cd11IfMacStatistics=cd11IfMacStatistics, cd11IfMobileStationScanChannel=cd11IfMobileStationScanChannel, cd11IfSsidMismatches=cd11IfSsidMismatches, cd11IfRfStartChannelFrequency=cd11IfRfStartChannelFrequency, cd11IfStationRole=cd11IfStationRole, cd11IfRfFrequencyBand=cd11IfRfFrequencyBand)
