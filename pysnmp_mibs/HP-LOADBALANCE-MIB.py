...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-LOADBALANCE-MIB
...
hpicfLoadBalanceCompliance.setObjects(
      *(("HP-LOADBALANCE-MIB", "hpicfLoadBalanceGroup"),
        ("HP-LOADBALANCE-MIB", "hpicfLoadBalanceGroup5"))
)
if mibBuilder.loadTexts:
...
hpicfTrunkStatsCompliance.setObjects(
      *(("HP-LOADBALANCE-MIB", "hpicfTrunkStatsClearGroup"),
        ("HP-LOADBALANCE-MIB", "hpicfTrunkStatsGroup"),
        ("HP-LOADBALANCE-MIB", "hpicfTrunkPortStatsGroup"))
)
if mibBuilder.loadTexts:
