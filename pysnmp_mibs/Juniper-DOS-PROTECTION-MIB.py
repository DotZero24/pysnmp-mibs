...
# Produced by pysmi-1.6.2 at Fri Oct 10 21:05:55 2025
...
class JuniDosProtectionProtocolType(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(
        *(("pppEchoRequest", 0),
          ...
          ("ipNull0Interface", 56),
          ("ipNormalPathMtu", 57),
          ("ipNeighborDiscovery", 58),
          ("ipNeighborDiscoveryMiss", 59),
          ("ipSearchError", 60),
          ("ipMld", 61),
          ("ipLocalPimAssert", 62),
          ("ipLocalBfd", 63),
          ...
          ("ipIke", 66),
          ("ipReassembly", 67),
          ("ipLocalIcmpFragment", 68),
          ("ipLocalFragment", 69),
          ("ipAppClassifierHttpRedirect", 70),
          ("ipMulticastDhcpIc", 71),
          ("dhcpTesterIc", 72),
          ("atmDynamicIfPppData", 73),
          ("ipLocalLspPing", 74))
    )
