...
# Produced by pysmi-1.6.2 at Fri Oct 10 20:06:00 2025
...
_BigipNotifyObjHostName_Type = DisplayString
_BigipNotifyObjHostName_Object = MibScalar
bigipNotifyObjHostName = _BigipNotifyObjHostName_Object(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 1, 4),
    _BigipNotifyObjHostName_Type()
)
bigipNotifyObjHostName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bigipNotifyObjHostName.setStatus("current")
_BigipNotifyObjSeverity_Type = DisplayString
_BigipNotifyObjSeverity_Object = MibScalar
bigipNotifyObjSeverity = _BigipNotifyObjSeverity_Object(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 1, 5),
    _BigipNotifyObjSeverity_Type()
)
bigipNotifyObjSeverity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bigipNotifyObjSeverity.setStatus("current")
_BigipNotifyObjEventId_Type = DisplayString
_BigipNotifyObjEventId_Object = MibScalar
bigipNotifyObjEventId = _BigipNotifyObjEventId_Object(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 1, 6),
    _BigipNotifyObjEventId_Type()
)
bigipNotifyObjEventId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bigipNotifyObjEventId.setStatus("current")
_BigipNotifyObjTimestamp_Type = DisplayString
_BigipNotifyObjTimestamp_Object = MibScalar
bigipNotifyObjTimestamp = _BigipNotifyObjTimestamp_Object(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 1, 7),
    _BigipNotifyObjTimestamp_Type()
)
bigipNotifyObjTimestamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bigipNotifyObjTimestamp.setStatus("current")
...
bigipNotifyObjectsGroup.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ...
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjTimestamp"))
)
if mibBuilder.loadTexts:
...
bigipMrfPeerDelayHealthChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 202)
)
bigipMrfPeerDelayHealthChanged.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
...
if mibBuilder.loadTexts:
    bigipMrfPeerDelayHealthChanged.setStatus(
        "current"
    )

bigipMrfPeerOutgoingRateLimitChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 203)
)
bigipMrfPeerOutgoingRateLimitChanged.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
...
if mibBuilder.loadTexts:
    bigipMrfPeerOutgoingRateLimitChanged.setStatus(
        "current"
    )

bigipMrfPeerIncomingRateLimitChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 204)
)
bigipMrfPeerIncomingRateLimitChanged.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
...
if mibBuilder.loadTexts:
    bigipMrfPeerIncomingRateLimitChanged.setStatus(
        "current"
    )

bigipCertExpiration = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 205)
)
bigipCertExpiration.setObjects(
    ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg")
)
if mibBuilder.loadTexts:
    bigipCertExpiration.setStatus(
        "current"
    )

bigipMrfPeerErrorsHealthChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 206)
)
bigipMrfPeerErrorsHealthChanged.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
...
if mibBuilder.loadTexts:
    bigipMrfPeerErrorsHealthChanged.setStatus(
        "current"
    )

bigipMrfPeerTimeoutsHealthChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 207)
)
bigipMrfPeerTimeoutsHealthChanged.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
...
if mibBuilder.loadTexts:
    bigipMrfPeerTimeoutsHealthChanged.setStatus(
        "current"
    )

bigipMrfPeerHealthChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 208)
)
bigipMrfPeerHealthChanged.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
...
if mibBuilder.loadTexts:
    bigipMrfPeerHealthChanged.setStatus(
        "current"
    )

bigipMrfPeerConnectionStateChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 209)
)
bigipMrfPeerConnectionStateChanged.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
...
if mibBuilder.loadTexts:
    bigipMrfPeerConnectionStateChanged.setStatus(
        "current"
    )

bigipSctpActivePathDown = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 210)
)
bigipSctpActivePathDown.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
...
if mibBuilder.loadTexts:
    bigipSctpActivePathDown.setStatus(
        "current"
    )

bigipSctpPathRestored = NotificationType(
    (1, 3, 6, 1, 4, 1, 3375, 2, 4, 0, 211)
)
bigipSctpPathRestored.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipNotifyObjMsg"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjHostName"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjSeverity"),
        ("F5-BIGIP-COMMON-MIB", "bigipNotifyObjEventId"),
...
if mibBuilder.loadTexts:
    bigipSctpPathRestored.setStatus(
        "current"
    )
...
bigipSystemNotifyGroup.setObjects(
      *(("F5-BIGIP-COMMON-MIB", "bigipCpuTempHigh"),
        ...
        ("F5-BIGIP-COMMON-MIB", "bigipMrfPeerDelayHealthChanged"),
        ("F5-BIGIP-COMMON-MIB", "bigipMrfPeerOutgoingRateLimitChanged"),
        ("F5-BIGIP-COMMON-MIB", "bigipMrfPeerIncomingRateLimitChanged"),
        ("F5-BIGIP-COMMON-MIB", "bigipCertExpiration"),
        ("F5-BIGIP-COMMON-MIB", "bigipMrfPeerErrorsHealthChanged"),
        ("F5-BIGIP-COMMON-MIB", "bigipMrfPeerTimeoutsHealthChanged"),
        ("F5-BIGIP-COMMON-MIB", "bigipMrfPeerHealthChanged"),
        ("F5-BIGIP-COMMON-MIB", "bigipMrfPeerConnectionStateChanged"),
        ("F5-BIGIP-COMMON-MIB", "bigipSctpActivePathDown"),
        ("F5-BIGIP-COMMON-MIB", "bigipSctpPathRestored"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"LongDisplayString": LongDisplayString,
       ...
       "bigipMrfPeerDelayHealthChanged": bigipMrfPeerDelayHealthChanged,
       ...
       "bigipMrfPeerTimeoutsHealthChanged": bigipMrfPeerTimeoutsHealthChanged,
       "bigipMrfPeerHealthChanged": bigipMrfPeerHealthChanged,
       "bigipMrfPeerConnectionStateChanged": bigipMrfPeerConnectionStateChanged,
       "bigipSctpActivePathDown": bigipSctpActivePathDown,
       "bigipSctpPathRestored": bigipSctpPathRestored,
       ...
       "bigipNotifyObjTimestamp": bigipNotifyObjTimestamp,
