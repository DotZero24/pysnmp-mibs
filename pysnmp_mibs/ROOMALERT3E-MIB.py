...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/avtech/ROOMALERT3E-MIB
...
digital_sen2_6 = MibScalar((1, 3, 6, 1, 4, 1, 20916, 1, 9, 1, 1, 2, 6), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setLabel("digital-sen2-6").setMaxAccess("readonly")
if mibBuilder.loadTexts: digital_sen2_6.setStatus('mandatory')
digital_sen2_7 = MibScalar((1, 3, 6, 1, 4, 1, 20916, 1, 9, 1, 1, 2, 7), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setLabel("digital-sen2-7").setMaxAccess("readonly")
if mibBuilder.loadTexts: digital_sen2_7.setStatus('mandatory')
digital_sen2_label = MibScalar((1, 3, 6, 1, 4, 1, 20916, 1, 9, 1, 1, 2, 8), OctetString()).setLabel("digital-sen2-label").setMaxAccess("readonly")
...
mibBuilder.exportSymbols("ROOMALERT3E-MIB", switch=switch, digital_sen2_2=digital_sen2_2, green_led=green_led, digital_sen1=digital_sen1, digital=digital, digital_sen1_label=digital_sen1_label, traps=traps, blue_led=blue_led, amber_led=amber_led, digital_sen2_4=digital_sen2_4, alarmmessage=alarmmessage, digital_sen2_3=digital_sen2_3, digital_sen2_5=digital_sen2_5, digital_sen2_7=digital_sen2_7, roomalert3E=roomalert3E, avtech=avtech, red_led=red_led, alarm1=alarm1, sensors=sensors, alarm2=alarm2, room_alert_3e_snmp_trap=room_alert_3e_snmp_trap, switch_label=switch_label, switch_sen1=switch_sen1, digital_sen2=digital_sen2, products=products, digital_sen2_label=digital_sen2_label, digital_sen1_1=digital_sen1_1, white_led=white_led, digital_sen1_2=digital_sen1_2, digital_sen2_6=digital_sen2_6, digital_sen2_1=digital_sen2_1, signaltower=signaltower)
