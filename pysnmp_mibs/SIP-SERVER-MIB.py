...
# Notes
# -----
# ASN.1 source file://mibs/rfc/SIP-SERVER-MIB
...
sipServerProxyServerCompliance.setObjects(
      *(("SIP-SERVER-MIB", "sipServerConfigGroup"),
        ("SIP-SERVER-MIB", "sipServerProxyConfigGroup"),
        ("SIP-SERVER-MIB", "sipServerProxyStatsGroup"))
)
if mibBuilder.loadTexts:
...
sipRedirectServerCompliance.setObjects(
    ("SIP-SERVER-MIB", "sipServerConfigGroup")
)
if mibBuilder.loadTexts:
...
sipServerRegistrarServerCompliance.setObjects(
      *(("SIP-SERVER-MIB", "sipServerConfigGroup"),
        ("SIP-SERVER-MIB", "sipServerRegistrarConfigGroup"),
        ("SIP-SERVER-MIB", "sipServerRegistrarStatsGroup"),
        ("SIP-SERVER-MIB", "sipServerRegistrarUsersGroup"))
)
if mibBuilder.loadTexts:
