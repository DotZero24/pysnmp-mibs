# SNMP MIB module (T7613-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T7613-MIB
...
trapTest.setObjects(
      *(("T7613-MIB", "sensorName"),
        ("T7613-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
