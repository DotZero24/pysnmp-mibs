...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-IETF-PIM-EXT-MIB
...
cPimInetMRouteNextHopEntry, cPimNbrIfIndex, cPimNbrAddressType, cPimIfStatus, cPimNbrEntry, cPimInetMRouteEntry, cPimIfEntry, cPimCRPEntry, cPimNbrAddress = mibBuilder.importSymbols("CISCO-IETF-PIM-MIB", "cPimInetMRouteNextHopEntry", "cPimNbrIfIndex", "cPimNbrAddressType", "cPimIfStatus", "cPimNbrEntry", "cPimInetMRouteEntry", "cPimIfEntry", "cPimCRPEntry", "cPimNbrAddress")
...
mibBuilder.exportSymbols("CISCO-IETF-PIM-EXT-MIB", cpimExtRPMappingChangeNotifEnabled=cpimExtRPMappingChangeNotifEnabled, ciscoIetfPimExtNotificationGroup=ciscoIetfPimExtNotificationGroup, cpimExtIfGraftRetryInterval=cpimExtIfGraftRetryInterval, cpimExtSourceLifetime=cpimExtSourceLifetime, cpimExtIfDRPriority=cpimExtIfDRPriority, cpimExtIfLanDelayEnabled=cpimExtIfLanDelayEnabled, ciscoIetfPimExtNbrGroup=ciscoIetfPimExtNbrGroup, cpimExtBidirDFRPAddressType=cpimExtBidirDFRPAddressType, ciscoIetfPimExtMIBObjects=ciscoIetfPimExtMIBObjects, cpimExtBidirDFWnrMtrcPref=cpimExtBidirDFWnrMtrcPref, ciscoIetfPimExtNotifEnabledGroup=ciscoIetfPimExtNotifEnabledGroup, cpimExtRPSetEntry=cpimExtRPSetEntry, cpimExtInterfaceStateChangeNotifEnabled=cpimExtInterfaceStateChangeNotifEnabled, cpimExtRPSetAddress=cpimExtRPSetAddress, cpimExtMRouteNextHopAssertMetric=cpimExtMRouteNextHopAssertMetric, cpimExtMRouteSourceTimer=cpimExtMRouteSourceTimer, cpimExtRPSetComponent=cpimExtRPSetComponent, cpimExtRPSetGroupAddress=cpimExtRPSetGroupAddress, cpimExtNbrDRPresent=cpimExtNbrDRPresent, cpimExtNbrSecAddressTable=cpimExtNbrSecAddressTable, cpimExtRPSetExpiryTime=cpimExtRPSetExpiryTime, cpimExtIfMaxGraftRetries=cpimExtIfMaxGraftRetries, cpimExtIfOverrideInterval=cpimExtIfOverrideInterval, cpimExtCRPEntry=cpimExtCRPEntry, cpimExtStateRefreshInterval=cpimExtStateRefreshInterval, cpimExtNbrLANPruneDelay=cpimExtNbrLANPruneDelay, ciscoIetfPimExtMIBComplianceRev1=ciscoIetfPimExtMIBComplianceRev1, cpimExtMRouteRPFNeighbor=cpimExtMRouteRPFNeighbor, cpimExtNbrSecAddress=cpimExtNbrSecAddress, ciscoIetfPimExtNotifs=ciscoIetfPimExtNotifs, cpimExtNbrBidirCapable=cpimExtNbrBidirCapable, cpimExtRPSetPriority=cpimExtRPSetPriority, ciscoIetfPimExtBidirGroup=ciscoIetfPimExtBidirGroup, cpimExtNbrEntry=cpimExtNbrEntry, cpimExtStateRefreshLimitInterval=cpimExtStateRefreshLimitInterval, ciscoIetfPimExtMIB=ciscoIetfPimExtMIB, cpimExtRPSetAddrType=cpimExtRPSetAddrType, cpimExtRPSetGroupMask=cpimExtRPSetGroupMask, cpimExtStateRefreshTimeToLive=cpimExtStateRefreshTimeToLive, cpimExtMRouteNextHopAsrtMtrcPref=cpimExtMRouteNextHopAsrtMtrcPref, cpimExtIfHelloHoldtime=cpimExtIfHelloHoldtime, cpimExtRPSetProtocol=cpimExtRPSetProtocol, cpimExtIfGenerationID=cpimExtIfGenerationID, PYSNMP_MODULE_ID=ciscoIetfPimExtMIB, cpimExtMRouteBidirGroup=cpimExtMRouteBidirGroup, cpimExtNbrDRPriority=cpimExtNbrDRPriority, cpimExtMRouteNextHopTable=cpimExtMRouteNextHopTable, cpimExtBidirDFWinnerAddress=cpimExtBidirDFWinnerAddress, cpimExtMRouteNextHopJoinPruneTmr=cpimExtMRouteNextHopJoinPruneTmr, ciscoIetfPimExtGeneralGroup=ciscoIetfPimExtGeneralGroup, cpimExtRPSetRPActive=cpimExtRPSetRPActive, cpimExtRPSetTable=cpimExtRPSetTable, ciscoIetfPimExtInterfaceUp=ciscoIetfPimExtInterfaceUp, ciscoIetfPimExtNextHopGroup=ciscoIetfPimExtNextHopGroup, cpimExtNbrGenId=cpimExtNbrGenId, cpimExtMRouteEntry=cpimExtMRouteEntry, ciscoIetfPimExtMIBCompliance=ciscoIetfPimExtMIBCompliance, cpimExtIfPropagationDelay=cpimExtIfPropagationDelay, cpimExtBidirDFWinnerMetric=cpimExtBidirDFWinnerMetric, cpimExtBidirDFStateTimer=cpimExtBidirDFStateTimer, cpimExtBidirDFRPAddress=cpimExtBidirDFRPAddress, cpimExtIfBidirCapable=cpimExtIfBidirCapable, cpimExtIfTrigHelloInterval=cpimExtIfTrigHelloInterval, cpimExtIfBSRBorder=cpimExtIfBSRBorder, cpimExtIfLanPruneDelay=cpimExtIfLanPruneDelay, ciscoPimExt=ciscoPimExt, cpimExtNbrSecMask=cpimExtNbrSecMask, cpimExtMRouteTable=cpimExtMRouteTable, ciscoIetfPimExtInterfaceDown=ciscoIetfPimExtInterfaceDown, cpimExtNbrTable=cpimExtNbrTable, cpimExtIfEntry=cpimExtIfEntry, ciscoIetfPimExtRPMappingChange=ciscoIetfPimExtRPMappingChange, cpimExtIfSRCapable=cpimExtIfSRCapable, cpimExtBidirDFWinnerUptime=cpimExtBidirDFWinnerUptime, cpimExtBidirDFEntry=cpimExtBidirDFEntry, ciscoIetfPimExtMIBCompliances=ciscoIetfPimExtMIBCompliances, cpimExtIfSRTTLThreshold=cpimExtIfSRTTLThreshold, cpimExtCRPBidir=cpimExtCRPBidir, cpimExtBidirDFTable=cpimExtBidirDFTable, ciscoIetfPimExtMIBConformance=ciscoIetfPimExtMIBConformance, cpimExtNbrTBit=cpimExtNbrTBit, cpimExtMRouteOriginatorSRTTL=cpimExtMRouteOriginatorSRTTL, cpimExtRPSetType=cpimExtRPSetType, cpimExtIfTable=cpimExtIfTable, cpimExtCRPTable=cpimExtCRPTable, ciscoIetfPimExtMIBGroups=ciscoIetfPimExtMIBGroups, cpimExtBidirDFIfIndex=cpimExtBidirDFIfIndex, cpimExtNbrSRCapable=cpimExtNbrSRCapable, cpimExtBidirDFState=cpimExtBidirDFState, cpimExtMRouteNextHopEntry=cpimExtMRouteNextHopEntry, cpimExtMRouteNextHopAssertTimer=cpimExtMRouteNextHopAssertTimer, cpimExtMRouteNextHopAssertWinner=cpimExtMRouteNextHopAssertWinner, cpimExtIfJoinPruneHoldtime=cpimExtIfJoinPruneHoldtime, cpimExtNbrSecAddressEntry=cpimExtNbrSecAddressEntry, cpimExtNbrOverrideInterval=cpimExtNbrOverrideInterval, cpimExtRPSetHoldTime=cpimExtRPSetHoldTime)
