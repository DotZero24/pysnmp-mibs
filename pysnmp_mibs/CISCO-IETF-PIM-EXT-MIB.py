...
cPimIfStatus, cPimInetMRouteNextHopEntry, cPimInetMRouteEntry, cPimNbrEntry, cPimNbrIfIndex, cPimNbrAddress, cPimNbrAddressType, cPimCRPEntry, cPimIfEntry = mibBuilder.importSymbols("CISCO-IETF-PIM-MIB", "cPimIfStatus", "cPimInetMRouteNextHopEntry", "cPimInetMRouteEntry", "cPimNbrEntry", "cPimNbrIfIndex", "cPimNbrAddress", "cPimNbrAddressType", "cPimCRPEntry", "cPimIfEntry")
...
mibBuilder.exportSymbols("CISCO-IETF-PIM-EXT-MIB", cpimExtIfDRPriority=cpimExtIfDRPriority, cpimExtBidirDFWinnerMetric=cpimExtBidirDFWinnerMetric, cpimExtNbrSecAddressEntry=cpimExtNbrSecAddressEntry, cpimExtRPMappingChangeNotifEnabled=cpimExtRPMappingChangeNotifEnabled, cpimExtRPSetHoldTime=cpimExtRPSetHoldTime, cpimExtNbrLANPruneDelay=cpimExtNbrLANPruneDelay, cpimExtIfJoinPruneHoldtime=cpimExtIfJoinPruneHoldtime, cpimExtNbrSecAddressTable=cpimExtNbrSecAddressTable, cpimExtNbrDRPriority=cpimExtNbrDRPriority, cpimExtMRouteTable=cpimExtMRouteTable, cpimExtIfMaxGraftRetries=cpimExtIfMaxGraftRetries, cpimExtIfSRTTLThreshold=cpimExtIfSRTTLThreshold, cpimExtMRouteNextHopJoinPruneTmr=cpimExtMRouteNextHopJoinPruneTmr, cpimExtBidirDFRPAddressType=cpimExtBidirDFRPAddressType, cpimExtNbrDRPresent=cpimExtNbrDRPresent, cpimExtRPSetComponent=cpimExtRPSetComponent, cpimExtCRPEntry=cpimExtCRPEntry, cpimExtRPSetAddress=cpimExtRPSetAddress, cpimExtMRouteOriginatorSRTTL=cpimExtMRouteOriginatorSRTTL, ciscoIetfPimExtMIBObjects=ciscoIetfPimExtMIBObjects, cpimExtRPSetExpiryTime=cpimExtRPSetExpiryTime, ciscoIetfPimExtMIBCompliance=ciscoIetfPimExtMIBCompliance, cpimExtMRouteSourceTimer=cpimExtMRouteSourceTimer, cpimExtIfEntry=cpimExtIfEntry, cpimExtNbrSecAddress=cpimExtNbrSecAddress, ciscoIetfPimExtInterfaceDown=ciscoIetfPimExtInterfaceDown, ciscoIetfPimExtMIBComplianceRev1=ciscoIetfPimExtMIBComplianceRev1, cpimExtCRPTable=cpimExtCRPTable, cpimExtRPSetType=cpimExtRPSetType, cpimExtCRPBidir=cpimExtCRPBidir, cpimExtRPSetTable=cpimExtRPSetTable, PYSNMP_MODULE_ID=ciscoIetfPimExtMIB, ciscoIetfPimExtMIBConformance=ciscoIetfPimExtMIBConformance, cpimExtNbrEntry=cpimExtNbrEntry, cpimExtNbrSecMask=cpimExtNbrSecMask, ciscoIetfPimExtBidirGroup=ciscoIetfPimExtBidirGroup, cpimExtIfGenerationID=cpimExtIfGenerationID, cpimExtMRouteNextHopEntry=cpimExtMRouteNextHopEntry, cpimExtRPSetAddrType=cpimExtRPSetAddrType, cpimExtRPSetGroupAddress=cpimExtRPSetGroupAddress, cpimExtIfPropagationDelay=cpimExtIfPropagationDelay, cpimExtBidirDFWnrMtrcPref=cpimExtBidirDFWnrMtrcPref, cpimExtBidirDFEntry=cpimExtBidirDFEntry, ciscoIetfPimExtNotificationGroup=ciscoIetfPimExtNotificationGroup, ciscoIetfPimExtMIBGroups=ciscoIetfPimExtMIBGroups, ciscoIetfPimExtRPMappingChange=ciscoIetfPimExtRPMappingChange, cpimExtRPSetRPActive=cpimExtRPSetRPActive, cpimExtSourceLifetime=cpimExtSourceLifetime, cpimExtIfHelloHoldtime=cpimExtIfHelloHoldtime, cpimExtIfBSRBorder=cpimExtIfBSRBorder, cpimExtMRouteBidirGroup=cpimExtMRouteBidirGroup, cpimExtNbrGenId=cpimExtNbrGenId, ciscoIetfPimExtGeneralGroup=ciscoIetfPimExtGeneralGroup, ciscoIetfPimExtNextHopGroup=ciscoIetfPimExtNextHopGroup, cpimExtStateRefreshLimitInterval=cpimExtStateRefreshLimitInterval, cpimExtIfOverrideInterval=cpimExtIfOverrideInterval, cpimExtMRouteNextHopAssertWinner=cpimExtMRouteNextHopAssertWinner, cpimExtIfTrigHelloInterval=cpimExtIfTrigHelloInterval, cpimExtMRouteRPFNeighbor=cpimExtMRouteRPFNeighbor, cpimExtIfTable=cpimExtIfTable, cpimExtStateRefreshInterval=cpimExtStateRefreshInterval, ciscoIetfPimExtMIB=ciscoIetfPimExtMIB, ciscoIetfPimExtNotifEnabledGroup=ciscoIetfPimExtNotifEnabledGroup, cpimExtNbrOverrideInterval=cpimExtNbrOverrideInterval, cpimExtBidirDFTable=cpimExtBidirDFTable, cpimExtBidirDFStateTimer=cpimExtBidirDFStateTimer, cpimExtNbrBidirCapable=cpimExtNbrBidirCapable, ciscoPimExt=ciscoPimExt, cpimExtIfLanPruneDelay=cpimExtIfLanPruneDelay, ciscoIetfPimExtInterfaceUp=ciscoIetfPimExtInterfaceUp, cpimExtNbrSRCapable=cpimExtNbrSRCapable, cpimExtBidirDFWinnerAddress=cpimExtBidirDFWinnerAddress, cpimExtMRouteEntry=cpimExtMRouteEntry, cpimExtBidirDFState=cpimExtBidirDFState, cpimExtMRouteNextHopTable=cpimExtMRouteNextHopTable, ciscoIetfPimExtNbrGroup=ciscoIetfPimExtNbrGroup, cpimExtMRouteNextHopAsrtMtrcPref=cpimExtMRouteNextHopAsrtMtrcPref, cpimExtMRouteNextHopAssertTimer=cpimExtMRouteNextHopAssertTimer, cpimExtIfLanDelayEnabled=cpimExtIfLanDelayEnabled, cpimExtNbrTBit=cpimExtNbrTBit, cpimExtBidirDFRPAddress=cpimExtBidirDFRPAddress, ciscoIetfPimExtNotifs=ciscoIetfPimExtNotifs, cpimExtRPSetProtocol=cpimExtRPSetProtocol, ciscoIetfPimExtMIBCompliances=ciscoIetfPimExtMIBCompliances, cpimExtBidirDFIfIndex=cpimExtBidirDFIfIndex, cpimExtNbrTable=cpimExtNbrTable, cpimExtIfSRCapable=cpimExtIfSRCapable, cpimExtIfGraftRetryInterval=cpimExtIfGraftRetryInterval, cpimExtRPSetGroupMask=cpimExtRPSetGroupMask, cpimExtRPSetPriority=cpimExtRPSetPriority, cpimExtMRouteNextHopAssertMetric=cpimExtMRouteNextHopAssertMetric, cpimExtBidirDFWinnerUptime=cpimExtBidirDFWinnerUptime, cpimExtIfBidirCapable=cpimExtIfBidirCapable, cpimExtStateRefreshTimeToLive=cpimExtStateRefreshTimeToLive, cpimExtInterfaceStateChangeNotifEnabled=cpimExtInterfaceStateChangeNotifEnabled, cpimExtRPSetEntry=cpimExtRPSetEntry)
