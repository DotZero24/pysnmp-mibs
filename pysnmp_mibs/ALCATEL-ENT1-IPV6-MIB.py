#
# PySNMP MIB module ALCATEL-ENT1-IPV6-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-IPV6-MIB
...
alaVirtualRouterName, = mibBuilder.importSymbols("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterName")
...
alaIPv6InterfaceAddressEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 4, 1), ).setIndexNames((0, "IPV6-MIB", "ipv6IfIndex"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAddress"))
...
alaIPv6InterfaceEUI64AddressEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 5, 1), ).setIndexNames((0, "IPV6-MIB", "ipv6IfIndex"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceEUI64AddressPrefix"))
...
alaIPv6NeighborEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 6, 1), ).setIndexNames((0, "IPV6-MIB", "ipv6IfIndex"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborNetAddress"))
...
alaIPv6StaticRouteEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 7, 1), ).setIndexNames((0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6StaticRouteDest"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6StaticRoutePfxLength"))
...
alaIPv6HostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 8, 1), ).setIndexNames((0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6HostName"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6HostAddress"))
...
alaIPv6InterfacePrefixEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 9, 1), ).setIndexNames((0, "IPV6-MIB", "ipv6IfIndex"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefix"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixLength"))
...
alaIPv6PMTUEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 10, 1), ).setIndexNames((0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6PMTUDest"))
...
ipv6RouteEntry.registerAugmentions(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsEntry"))
...
alaIPv6LocalUnicastEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 13, 1), ).setIndexNames((0, "IPV6-MIB", "ipv6IfIndex"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6LocalUnicastGlobalID"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6LocalUnicastSubnetID"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6LocalUnicastInterfaceID"))
...
alaIPv6RAFilterTrustedPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 15, 1), ).setIndexNames((0, "IPV6-MIB", "ipv6IfIndex"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterTrustedPortIfIndex"))
...
alaIPv6RAFilterInterfaceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 16, 1), ).setIndexNames((0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterInterfaceVlan"))
...
alaIPv6RAFilterTrustedSourceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 1, 17, 1), ).setIndexNames((0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterInterfaceVlan"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterTrustedSourceType"), (0, "ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterTrustedSourceValue"))
...
alaIPv6NeighborLimitExceeded = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 0, 2)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborLimit"))
if mibBuilder.loadTexts: alaIPv6NeighborLimitExceeded.setStatus('current')
alaIPv6NeighborVRFLimitExceeded = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 0, 3)).setObjects(("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterName"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborVRFLimit"))
if mibBuilder.loadTexts: alaIPv6NeighborVRFLimitExceeded.setStatus('current')
alaIPv6InterfaceNeighborLimitExceeded = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 0, 4)).setObjects(("IPV6-MIB", "ipv6IfIndex"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceNeighborLimit"))
...
alaIPv6Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 1, 1)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6TunnelConfigGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6ConfigGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAddressGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceEUI64AddressGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6PMTUGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6LocalUnicastGroup"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6Compliance = alaIPv6Compliance.setStatus('current')
alaIPv6TunnelConfigGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 1)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6ConfigTunnelV4Source"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6ConfigTunnelV4Dest"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6TunnelConfigGroup = alaIPv6TunnelConfigGroup.setStatus('current')
alaIPv6ConfigGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 2)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6ClearNeighbors"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6ClearTraffic"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6ClearPMTUTable"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6PMTUMinLifetime"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborStaleLifetime"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6GlobalID"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6VirtualSourceMAC"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborLimit"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborVRFLimit"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6ConfigGroup = alaIPv6ConfigGroup.setStatus('current')
alaIPv6NeighborGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 3)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborPhysAddress"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborType"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborLastUpdated"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborRowStatus"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborLifetime"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborReachability"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborPortIfIndex"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6NeighborGroup = alaIPv6NeighborGroup.setStatus('current')
alaIPv6StaticRouteGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 4)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6StaticRouteIfIndex"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6StaticRouteNextHop"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6StaticRouteMetric"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6StaticRouteRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6StaticRouteGroup = alaIPv6StaticRouteGroup.setStatus('obsolete')
alaIPv6InterfaceGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 5)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceRowStatus"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceDescription"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceMtu"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceType"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAdminStatus"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceSendRouterAdvertisements"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceMaxRtrAdvInterval"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAdvManagedFlag"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAdvOtherConfigFlag"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAdvReachableTime"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAdvRetransTimer"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAdvDefaultLifetime"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceName"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAdvSendMtu"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceReachableTime"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceBaseReachableTime"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceMinRtrAdvInterval"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceClockSkew"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceRetransTimer"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceDADTransmits"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAdvHopLimit"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceLPND"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceNeighborLimit"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceRetransBackoff"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceRetransMax"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceRouterPreference"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6InterfaceGroup = alaIPv6InterfaceGroup.setStatus('current')
alaIPv6InterfaceAddressGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 6)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAddressRowStatus"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAddressPrefixLength"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAddressAnycastFlag"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceAddressDADStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6InterfaceAddressGroup = alaIPv6InterfaceAddressGroup.setStatus('current')
alaIPv6InterfaceEUI64AddressGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 7)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceEUI64AddressRowStatus"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceEUI64AddressPrefixLength"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceEUI64AddressIdentifier"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6InterfaceEUI64AddressGroup = alaIPv6InterfaceEUI64AddressGroup.setStatus('current')
alaIPv6InterfacePrefixGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 8)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixRowStatus"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixValidLifetime"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixOnLinkFlag"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixPreferredLifetime"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixAutonomousFlag"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixSource"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixValidLifetimeDecrement"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixValidLifetimeExpire"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixPreferredLifetimeDecrement"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfacePrefixPreferredLifetimeExpire"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6InterfacePrefixGroup = alaIPv6InterfacePrefixGroup.setStatus('current')
alaIPv6PMTUGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 9)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6PMTU"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6PMTUExpire"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6PMTUHits"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6PMTUUpdates"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6PMTUGroup = alaIPv6PMTUGroup.setStatus('current')
alaIPv6RouteFlagsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 10)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsUp"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsGateway"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsHost"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsStatic"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsCloneable"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsDiscard"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsECMP"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RouteFlagsTransient"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6RouteFlagsGroup = alaIPv6RouteFlagsGroup.setStatus('current')
alaIPv6LocalUnicastGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 11)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6LocalUnicastPrefixLength"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6LocalUnicastEUI64"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6LocalUnicastRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6LocalUnicastGroup = alaIPv6LocalUnicastGroup.setStatus('current')
alaIPv6HostGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 12)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6HostRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6HostGroup = alaIPv6HostGroup.setStatus('current')
alcatelIND1IPv6NotificationGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 13)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborLimitExceeded"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborVRFLimitExceeded"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceNeighborLimitExceeded"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alcatelIND1IPv6NotificationGroup = alcatelIND1IPv6NotificationGroup.setStatus('current')
alcatelIND1IPv6DeprecatedObjectGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 14)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborSlot"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborPort"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborState"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6NeighborChassis"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6InterfaceRAFilter"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterTrustedPortRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alcatelIND1IPv6DeprecatedObjectGroup = alcatelIND1IPv6DeprecatedObjectGroup.setStatus('current')
alcatelIND1IPv6DeprecatedNotificationGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 15)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "ndpMaxLimitReached"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alcatelIND1IPv6DeprecatedNotificationGroup = alcatelIND1IPv6DeprecatedNotificationGroup.setStatus('current')
alaIPv6RAFilterGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 29, 1, 2, 2, 16)).setObjects(("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterInterfaceAdminStatus"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterInterfaceRowStatus"), ("ALCATEL-ENT1-IPV6-MIB", "alaIPv6RAFilterTrustedSourceRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIPv6RAFilterGroup = alaIPv6RAFilterGroup.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-IPV6-MIB", alaIPv6RAFilterInterfaceEntry=alaIPv6RAFilterInterfaceEntry, alcatelIND1IPv6MIBConformance=alcatelIND1IPv6MIBConformance, alaIPv6InterfaceType=alaIPv6InterfaceType, alaIPv6StaticRoutePfxLength=alaIPv6StaticRoutePfxLength, alaIPv6HostTable=alaIPv6HostTable, alaIPv6RAFilterInterfaceRowStatus=alaIPv6RAFilterInterfaceRowStatus, alaIPv6InterfaceRetransMax=alaIPv6InterfaceRetransMax, alaIPv6RAFilterGroup=alaIPv6RAFilterGroup, alaIPv6InterfaceAdvDefaultLifetime=alaIPv6InterfaceAdvDefaultLifetime, alaIPv6ConfigTunnelEntry=alaIPv6ConfigTunnelEntry, alaIPv6InterfaceName=alaIPv6InterfaceName, alaIPv6PMTUMinLifetime=alaIPv6PMTUMinLifetime, alaIPv6NeighborPhysAddress=alaIPv6NeighborPhysAddress, AlaIPv6RAFilterTrustedSourceValue=AlaIPv6RAFilterTrustedSourceValue, alaIPv6InterfaceTable=alaIPv6InterfaceTable, alaIPv6InterfaceDADTransmits=alaIPv6InterfaceDADTransmits, alaIPv6InterfaceAddress=alaIPv6InterfaceAddress, alaIPv6TunnelConfig=alaIPv6TunnelConfig, alaIPv6ConfigTunnelTable=alaIPv6ConfigTunnelTable, alaIPv6HostRowStatus=alaIPv6HostRowStatus, ndpMaxLimitReached=ndpMaxLimitReached, alaIPv6ConfigGroup=alaIPv6ConfigGroup, alaIPv6RAFilterTrustedPortRowStatus=alaIPv6RAFilterTrustedPortRowStatus, alaIPv6StaticRouteTable=alaIPv6StaticRouteTable, alaIPv6InterfaceAdvReachableTime=alaIPv6InterfaceAdvReachableTime, alaIPv6StaticRouteEntry=alaIPv6StaticRouteEntry, alaIPv6PMTUUpdates=alaIPv6PMTUUpdates, alaIPv6InterfaceDescription=alaIPv6InterfaceDescription, alaIPv6RouteFlagsStatic=alaIPv6RouteFlagsStatic, alaIPv6RouteFlagsGroup=alaIPv6RouteFlagsGroup, alaIPv6NeighborRowStatus=alaIPv6NeighborRowStatus, alaIPv6RouteFlagsDiscard=alaIPv6RouteFlagsDiscard, alaIPv6ConfigTunnelV4Dest=alaIPv6ConfigTunnelV4Dest, alaIPv6InterfaceNeighborLimit=alaIPv6InterfaceNeighborLimit, alaIPv6InterfaceAdminStatus=alaIPv6InterfaceAdminStatus, alaIPv6InterfaceAddressEntry=alaIPv6InterfaceAddressEntry, alaIPv6NeighborStaleLifetime=alaIPv6NeighborStaleLifetime, alaIPv6NeighborState=alaIPv6NeighborState, alaIPv6LocalUnicastEUI64=alaIPv6LocalUnicastEUI64, alaIPv6StaticRouteMetric=alaIPv6StaticRouteMetric, alcatelIND1IPv6DeprecatedObjectGroup=alcatelIND1IPv6DeprecatedObjectGroup, alaIPv6HostGroup=alaIPv6HostGroup, alaIPv6InterfacePrefixAutonomousFlag=alaIPv6InterfacePrefixAutonomousFlag, alaIPv6NeighborVRFLimitExceeded=alaIPv6NeighborVRFLimitExceeded, alaIPv6InterfaceGroup=alaIPv6InterfaceGroup, alaIPv6RAFilterTrustedPortEntry=alaIPv6RAFilterTrustedPortEntry, alaIPv6RAFilterTrustedPortTable=alaIPv6RAFilterTrustedPortTable, alaIPv6InterfaceAdvRetransTimer=alaIPv6InterfaceAdvRetransTimer, alaIPv6InterfacePrefixSource=alaIPv6InterfacePrefixSource, alaIPv6PMTUExpire=alaIPv6PMTUExpire, alaIPv6InterfaceEUI64AddressTable=alaIPv6InterfaceEUI64AddressTable, alaIPv6InterfaceMinRtrAdvInterval=alaIPv6InterfaceMinRtrAdvInterval, alaIPv6InterfacePrefixTable=alaIPv6InterfacePrefixTable, alaIPv6LocalUnicastEntry=alaIPv6LocalUnicastEntry, alaIPv6RAFilterInterfaceTable=alaIPv6RAFilterInterfaceTable, alaIPv6RouteFlagsHost=alaIPv6RouteFlagsHost, alaIPv6InterfaceAddressGroup=alaIPv6InterfaceAddressGroup, alaIPv6ClearNeighbors=alaIPv6ClearNeighbors, alaIPv6NeighborChassis=alaIPv6NeighborChassis, alcatelIND1IPv6DeprecatedNotificationGroup=alcatelIND1IPv6DeprecatedNotificationGroup, alaIPv6StaticRouteRowStatus=alaIPv6StaticRouteRowStatus, alaIPv6NeighborPort=alaIPv6NeighborPort, alaIPv6Compliance=alaIPv6Compliance, alaIPv6RouteFlagsTransient=alaIPv6RouteFlagsTransient, alaIPv6ConfigTunnelV4Source=alaIPv6ConfigTunnelV4Source, alaIPv6NeighborType=alaIPv6NeighborType, alaIPv6InterfacePrefixLength=alaIPv6InterfacePrefixLength, alaIPv6NeighborNetAddress=alaIPv6NeighborNetAddress, alcatelIND1IPv6MIBGroups=alcatelIND1IPv6MIBGroups, alaIPv6LocalUnicastSubnetID=alaIPv6LocalUnicastSubnetID, alaIPv6RouteFlagsUp=alaIPv6RouteFlagsUp, alaIPv6InterfaceRetransTimer=alaIPv6InterfaceRetransTimer, alaIPv6RouteFlagsECMP=alaIPv6RouteFlagsECMP, alaIPv6InterfaceClockSkew=alaIPv6InterfaceClockSkew, alaIPv6InterfaceReachableTime=alaIPv6InterfaceReachableTime, alaIPv6InterfaceEntry=alaIPv6InterfaceEntry, alaIPv6InterfacePrefixRowStatus=alaIPv6InterfacePrefixRowStatus, AlaIPv6RAFilterTrustedSourceType=AlaIPv6RAFilterTrustedSourceType, alcatelIND1IPv6MIBCompliances=alcatelIND1IPv6MIBCompliances, alaIPv6InterfaceRowStatus=alaIPv6InterfaceRowStatus, alcatelIND1IPv6NotificationGroup=alcatelIND1IPv6NotificationGroup, alaIPv6RouteFlagsCloneable=alaIPv6RouteFlagsCloneable, alaIPv6HostName=alaIPv6HostName, alaIPv6NeighborVRFLimit=alaIPv6NeighborVRFLimit, alaIPv6LocalUnicastInterfaceID=alaIPv6LocalUnicastInterfaceID, alaIPv6InterfacePrefixValidLifetimeExpire=alaIPv6InterfacePrefixValidLifetimeExpire, alaIPv6PMTUEntry=alaIPv6PMTUEntry, alaIPv6ClearTraffic=alaIPv6ClearTraffic, alaIPv6LocalUnicastPrefixLength=alaIPv6LocalUnicastPrefixLength, alaIPv6InterfaceMtu=alaIPv6InterfaceMtu, alaIPv6StaticRouteNextHop=alaIPv6StaticRouteNextHop, alaIPv6RAFilterInterfaceVlan=alaIPv6RAFilterInterfaceVlan, alaIPv6HostAddress=alaIPv6HostAddress, alaIPv6PMTUGroup=alaIPv6PMTUGroup, alaIPv6TunnelConfigGroup=alaIPv6TunnelConfigGroup, alaIPv6InterfaceEUI64AddressPrefix=alaIPv6InterfaceEUI64AddressPrefix, alaIPv6RAFilterTrustedSourceTable=alaIPv6RAFilterTrustedSourceTable, alaIPv6LocalUnicastGroup=alaIPv6LocalUnicastGroup, alaIPv6NeighborPortIfIndex=alaIPv6NeighborPortIfIndex, alaIPv6VirtualSourceMAC=alaIPv6VirtualSourceMAC, alaIPv6InterfaceBaseReachableTime=alaIPv6InterfaceBaseReachableTime, alaIPv6RouteFlagsGateway=alaIPv6RouteFlagsGateway, alaIPv6StaticRouteIfIndex=alaIPv6StaticRouteIfIndex, alaIPv6NeighborLastUpdated=alaIPv6NeighborLastUpdated, alaIPv6InterfaceAdvSendMtu=alaIPv6InterfaceAdvSendMtu, alaIPv6InterfaceMaxRtrAdvInterval=alaIPv6InterfaceMaxRtrAdvInterval, alaIPv6Config=alaIPv6Config, alaIPv6NeighborLimit=alaIPv6NeighborLimit, alaIPv6RouteFlagsEntry=alaIPv6RouteFlagsEntry, alaIPv6LocalUnicastTable=alaIPv6LocalUnicastTable, alaIPv6InterfaceRetransBackoff=alaIPv6InterfaceRetransBackoff, alaIPv6InterfaceAddressRowStatus=alaIPv6InterfaceAddressRowStatus, alaIPv6InterfaceAddressAnycastFlag=alaIPv6InterfaceAddressAnycastFlag, alaIPv6LocalUnicastRowStatus=alaIPv6LocalUnicastRowStatus, alaIPv6NeighborLifetime=alaIPv6NeighborLifetime, alaIPv6InterfacePrefixValidLifetime=alaIPv6InterfacePrefixValidLifetime, alaIPv6InterfaceRAFilter=alaIPv6InterfaceRAFilter, alaIPv6InterfaceAdvManagedFlag=alaIPv6InterfaceAdvManagedFlag, alaIPv6InterfaceEUI64AddressIdentifier=alaIPv6InterfaceEUI64AddressIdentifier, alaIPv6NeighborSlot=alaIPv6NeighborSlot, alaIPv6StaticRouteDest=alaIPv6StaticRouteDest, alaIPv6PMTUHits=alaIPv6PMTUHits, alaIPv6StaticRouteGroup=alaIPv6StaticRouteGroup, alaIPv6PMTUDest=alaIPv6PMTUDest, alaIPv6RouteFlagsTable=alaIPv6RouteFlagsTable, alaIPv6PMTUTable=alaIPv6PMTUTable, alaIPv6NeighborReachability=alaIPv6NeighborReachability, alaIPv6InterfacePrefixPreferredLifetimeExpire=alaIPv6InterfacePrefixPreferredLifetimeExpire, alaIPv6PMTU=alaIPv6PMTU, alcatelIND1IPv6MIBObjects=alcatelIND1IPv6MIBObjects, alaIPv6RAFilterTrustedSourceValue=alaIPv6RAFilterTrustedSourceValue, alaIPv6RAFilterInterfaceAdminStatus=alaIPv6RAFilterInterfaceAdminStatus, alaIPv6InterfaceSendRouterAdvertisements=alaIPv6InterfaceSendRouterAdvertisements, alaIPv6InterfacePrefixOnLinkFlag=alaIPv6InterfacePrefixOnLinkFlag, alaIPv6InterfaceNeighborLimitExceeded=alaIPv6InterfaceNeighborLimitExceeded, AlaIPv6RAFilterTrustedSourceIfIndex=AlaIPv6RAFilterTrustedSourceIfIndex, alaIPv6InterfaceEUI64AddressGroup=alaIPv6InterfaceEUI64AddressGroup, alaIPv6InterfacePrefixGroup=alaIPv6InterfacePrefixGroup, PYSNMP_MODULE_ID=alcatelIND1IPv6MIB, alaIPv6NeighborEntry=alaIPv6NeighborEntry, alaIPv6ClearPMTUTable=alaIPv6ClearPMTUTable, AlaIPv6AddressPrefix=AlaIPv6AddressPrefix, alaIPv6NeighborTable=alaIPv6NeighborTable, alaIPv6RAFilterTrustedSourceEntry=alaIPv6RAFilterTrustedSourceEntry, alaIPv6InterfaceEUI64AddressEntry=alaIPv6InterfaceEUI64AddressEntry, alaIPv6InterfacePrefixPreferredLifetime=alaIPv6InterfacePrefixPreferredLifetime, alaIPv6GlobalID=alaIPv6GlobalID, alaIPv6RAFilterTrustedPortIfIndex=alaIPv6RAFilterTrustedPortIfIndex, alcatelIND1IPv6MIBNotifications=alcatelIND1IPv6MIBNotifications, alaIPv6InterfacePrefixPreferredLifetimeDecrement=alaIPv6InterfacePrefixPreferredLifetimeDecrement, alaIPv6InterfacePrefixValidLifetimeDecrement=alaIPv6InterfacePrefixValidLifetimeDecrement, alaIPv6InterfaceLPND=alaIPv6InterfaceLPND, alaIPv6LocalUnicastGlobalID=alaIPv6LocalUnicastGlobalID, alaIPv6NeighborLimitExceeded=alaIPv6NeighborLimitExceeded, alaIPv6InterfaceAdvHopLimit=alaIPv6InterfaceAdvHopLimit, alaIPv6RAFilterTrustedSourceRowStatus=alaIPv6RAFilterTrustedSourceRowStatus, alaIPv6InterfaceAdvOtherConfigFlag=alaIPv6InterfaceAdvOtherConfigFlag, alaIPv6InterfacePrefixEntry=alaIPv6InterfacePrefixEntry, alaIPv6InterfaceAddressPrefixLength=alaIPv6InterfaceAddressPrefixLength, alaIPv6NeighborGroup=alaIPv6NeighborGroup, alaIPv6InterfaceEUI64AddressPrefixLength=alaIPv6InterfaceEUI64AddressPrefixLength, alaIPv6InterfaceAddressTable=alaIPv6InterfaceAddressTable, alaIPv6InterfaceRouterPreference=alaIPv6InterfaceRouterPreference, alaIPv6RAFilterTrustedSourceType=alaIPv6RAFilterTrustedSourceType, alcatelIND1IPv6MIB=alcatelIND1IPv6MIB, alaIPv6HostEntry=alaIPv6HostEntry, alaIPv6InterfaceAddressDADStatus=alaIPv6InterfaceAddressDADStatus, alaIPv6InterfaceEUI64AddressRowStatus=alaIPv6InterfaceEUI64AddressRowStatus, alaIPv6InterfacePrefix=alaIPv6InterfacePrefix)
