...
fsSecSystem=_FsSecSystem_ObjectIdentity((1,3,6,1,4,1,10876,101,2,64,1))
...
fsSecDebugOption=_FsSecDebugOption_Object((1,3,6,1,4,1,10876,101,2,64,1,1),_FsSecDebugOption_Type())
fsSecDebugOption.setMaxAccess('read-write')
if mibBuilder.loadTexts:fsSecDebugOption.setStatus('current')
mibBuilder.exportSymbols('SUPERMICRO-Sec-MIB',**{'fsSec':fsSec,'fsSecSystem':fsSecSystem,'fsSecDebugOption':fsSecDebugOption})