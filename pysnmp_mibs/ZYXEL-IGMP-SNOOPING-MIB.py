...
# Notes
# -----
# ASN.1 source file://mibs/zyxel/ZYXEL-IGMP-SNOOPING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:01:34 2025
...
class _ZyIgmpSnoopingQuerierVersion_Type(Integer32):
    """Custom type zyIgmpSnoopingQuerierVersion based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(2,
...
_ZyIgmpSnoopingQuerierVersion_Type.__name__ = "Integer32"
_ZyIgmpSnoopingQuerierVersion_Object = MibScalar
zyIgmpSnoopingQuerierVersion = _ZyIgmpSnoopingQuerierVersion_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 31, 1, 11),
    _ZyIgmpSnoopingQuerierVersion_Type()
)
zyIgmpSnoopingQuerierVersion.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyIgmpSnoopingQuerierVersion.setStatus("current")
_ZyIgmpSnoopingSmartForward_Type = EnabledStatus
_ZyIgmpSnoopingSmartForward_Object = MibScalar
zyIgmpSnoopingSmartForward = _ZyIgmpSnoopingSmartForward_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 31, 1, 12),
    _ZyIgmpSnoopingSmartForward_Type()
)
zyIgmpSnoopingSmartForward.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyIgmpSnoopingSmartForward.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"zyxelIgmpSnooping": zyxelIgmpSnooping,
       ...
       "zyIgmpSnoopingQuerierVersion": zyIgmpSnoopingQuerierVersion,
       "zyIgmpSnoopingSmartForward": zyIgmpSnoopingSmartForward,
