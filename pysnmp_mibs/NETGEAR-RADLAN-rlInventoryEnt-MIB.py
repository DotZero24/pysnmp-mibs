# SNMP MIB module (NETGEAR-RADLAN-rlInventoryEnt-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-rlInventoryEnt-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:27:07 2025
...
rlInventoryEntEntry = _RlInventoryEntEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 217, 1)
)
rlInventoryEntEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-rlInventoryEnt-MIB", "rlInventoryEntUnitOrIfindex"),
    (0, "NETGEAR-RADLAN-rlInventoryEnt-MIB", "rlInventoryEntUnitIfindexID"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "NETGEAR-RADLAN-rlInventoryEnt-MIB",
