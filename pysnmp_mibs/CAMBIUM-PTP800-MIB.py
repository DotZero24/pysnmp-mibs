...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cambium/CAMBIUM-PTP800-MIB
...
if mibBuilder.loadTexts: cambium.setLastUpdated('201402281518Z')
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityTableIndex=l2CPPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, sntpGroup=sntpGroup, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitDataRate=transmitDataRate, rFUTxFreqMin=rFUTxFreqMin, aAAControl=aAAControl, rFUVersionBank2=rFUVersionBank2, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, remoteSecondaryIPAddress=remoteSecondaryIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, dataPortFiberStatus=dataPortFiberStatus, sNTPLastSync=sNTPLastSync, maxModulation=maxModulation, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUStatusTrap=rFUStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, encryption=encryption, managementMode=managementMode, neighborInternetAddressType=neighborInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortAutoNegotiation=managementPortAutoNegotiation, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, phyControlGroup=phyControlGroup, localPacketFiltering=localPacketFiltering, rxDiversityVlanTpid=rxDiversityVlanTpid, linkNameMismatchTrap=linkNameMismatchTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, receiveCodeRate=receiveCodeRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, userRole=userRole, radioLicenseBand=radioLicenseBand, rFUActiveFirmwareBank=rFUActiveFirmwareBank, aggregateDataRate=aggregateDataRate, qOSPriorityScheme=qOSPriorityScheme, protectionState=protectionState, tFTPServerInternetAddress=tFTPServerInternetAddress, configuration=configuration, transmitterStatus=transmitterStatus, alignmentModeTrap=alignmentModeTrap, latitude=latitude, neighborInternetAddress=neighborInternetAddress, rFUConnectedPlatform=rFUConnectedPlatform, syslogState=syslogState, iFCableLength=iFCableLength, sNTPServerTimeout=sNTPServerTimeout, productName=productName, vLANManagementVIDValidation=vLANManagementVIDValidation, ethernetGroup=ethernetGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, bootVersion=bootVersion, phyStatus=phyStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, remoteSecondaryMACAddress=remoteSecondaryMACAddress, activeAvailableTime=activeAvailableTime, bridge=bridge, systemClock=systemClock, rFUTxPowerAlarm=rFUTxPowerAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, remotePrimarySecondaryMode=remotePrimarySecondaryMode, userTable=userTable, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTable=mPLSTCPriorityTable, iPVersion=iPVersion, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, primaryRecoveryPeriod=primaryRecoveryPeriod, dataPortDisabledWarning=dataPortDisabledWarning, byteErrorRatio=byteErrorRatio, secureModeAlarm=secureModeAlarm, managementPortStatus=managementPortStatus, iPv6PrefixLength=iPv6PrefixLength, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, enableTransmission=enableTransmission, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receivePower=receivePower, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNTPServerTable=sNTPServerTable, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, vLANManagementPriority=vLANManagementPriority, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, pubStatsGroup=pubStatsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClientTrap=syslogClientTrap, ptpCompliance=ptpCompliance, diverseAntennaGain=diverseAntennaGain, aTPCEnable=aTPCEnable, altitude=altitude, rFUPowerAlarm=rFUPowerAlarm, telnetPortNumber=telnetPortNumber, activeUnit=activeUnit, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, syslogControl=syslogControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, versions=versions, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, managementPortConfigurationMismatch=managementPortConfigurationMismatch, cambium=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, ethernet=ethernet, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sntp=sntp, supplementaryGroup=supplementaryGroup, transmitModulation=transmitModulation, rFUStatus=rFUStatus, rFURpsAlarm=rFURpsAlarm, remotePrimaryIPAddress=remotePrimaryIPAddress, neighborMACAddress=neighborMACAddress, reset=reset, radioLicenseIdentifier=radioLicenseIdentifier, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerRetries=sNTPServerRetries, sNTPSyncTrap=sNTPSyncTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, protectionStateTrap=protectionStateTrap, protectionConfig=protectionConfig, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, endId=endId, ethernetPriorityTableIndex=ethernetPriorityTableIndex, protectionConfigurationStatus=protectionConfigurationStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, supplementary=supplementary, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, sNTPSync=sNTPSync, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUCableAlarm=rFUCableAlarm, sNTPServerTableEntry=sNTPServerTableEntry, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, radioLicenseMinCodeRate=radioLicenseMinCodeRate, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, radioLicenseMinModulation=radioLicenseMinModulation, smtp=smtp, rFUTxPowerMin=rFUTxPowerMin, smtpGroup=smtpGroup, alarms=alarms, protection=protection, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseGroup=radioLicenseGroup, rFUVersionBank1=rFUVersionBank1, maxCodeRate=maxCodeRate, siteName=siteName, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receiveDataRate=receiveDataRate, l2CPPriorityTable=l2CPPriorityTable, protectionStatsGroup=protectionStatsGroup, transmitPower=transmitPower, transmitCapacityLimitDetail=transmitCapacityLimitDetail, radioLicenseRxFreq=radioLicenseRxFreq, transmitCodeRate=transmitCodeRate, rFUPlatformCompatibility=rFUPlatformCompatibility, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, radioLicense=radioLicense, ptp800=ptp800, sMTPServerPortNumber=sMTPServerPortNumber, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, ptmp=ptmp, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPServerResponse=sNTPServerResponse, remoteInternetAddress=remoteInternetAddress, radioLicenseBandwidth=radioLicenseBandwidth, activeByteErrorCount=activeByteErrorCount, dataPortWirelessDownAlert=dataPortWirelessDownAlert, management=management, managementPortStatusTrap=managementPortStatusTrap, softwareVersion=softwareVersion, alignmentMode=alignmentMode, timeZone=timeZone, radioLicenseTxFreq=radioLicenseTxFreq, sNMPEnabledTraps=sNMPEnabledTraps, managementPortForcedConfiguration=managementPortForcedConfiguration, protectionStatus=protectionStatus, maximumTransmitPower=maximumTransmitPower, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, licence=licence, userPassword=userPassword, rFUBranchingConfiguration=rFUBranchingConfiguration, sNMPTrapTableIndex=sNMPTrapTableIndex, minModulation=minModulation, rfu=rfu, rFFeederLoss=rFFeederLoss, transmitCapacity=transmitCapacity, rFUTransceiverLocation=rFUTransceiverLocation, rFUSerial=rFUSerial, sMTPServerInternetAddress=sMTPServerInternetAddress, unitOutOfCalibration=unitOutOfCalibration, activeByteCount=activeByteCount, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, ptpTrapPrefix=ptpTrapPrefix, iPv6Address=iPv6Address, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, faultProtectionSwitching=faultProtectionSwitching, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, gatewayIPAddress=gatewayIPAddress, sMTPEmailAlert=sMTPEmailAlert, radioLicenseRegion=radioLicenseRegion, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFULockoutAlarm=rFULockoutAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortStatusTrap=dataPortStatusTrap, diverseRfFeederLoss=diverseRfFeederLoss, encryptionGroup=encryptionGroup, primaryRecovery=primaryRecovery, hardwareVersion=hardwareVersion, bridgeGroup=bridgeGroup, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUTxFreqMax=rFUTxFreqMax, ptpTraps=ptpTraps, rfuGroup=rfuGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUType=rFUType, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", vectorError=vectorError, sNTPPollInterval=sNTPPollInterval, sNTPState=sNTPState, activeByteErrorRatio=activeByteErrorRatio, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFURxFreqMax=rFURxFreqMax, notificationsGroup=notificationsGroup, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, userName=userName, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, codeWordErrorRatio=codeWordErrorRatio, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNTPServerTableIndex=sNTPServerTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, ethernetPriorityTable=ethernetPriorityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, minCodeRate=minCodeRate, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, linkNameMismatch=linkNameMismatch, protectionSwitchCause=protectionSwitchCause, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFURfBand=rFURfBand, activeCodeWordErrorCount=activeCodeWordErrorCount, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkAvailability=wirelessLinkAvailability, rFUTxMuteStatus=rFUTxMuteStatus, sMTPEnabledMessages=sMTPEnabledMessages, systemReset=systemReset, alarmsGroup=alarmsGroup, userTableNumber=userTableNumber, managementGroup=managementGroup, numberOfAntennas=numberOfAntennas, daylightSaving=daylightSaving, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, userEnabled=userEnabled, requestedProtectionState=requestedProtectionState, protectionConfigGroup=protectionConfigGroup, primarySecondaryMode=primarySecondaryMode, protectionInterfaceStatus=protectionInterfaceStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, radioLicenseModulation=radioLicenseModulation, activeCodeWordErrorRatio=activeCodeWordErrorRatio, pubStats=pubStats, transmitCapacityLimit=transmitCapacityLimit, sNMPPortNumber=sNMPPortNumber, ptp=ptp, rFURxFreqMin=rFURxFreqMin, linkLoss=linkLoss, remoteInternetAddressType=remoteInternetAddressType, remoteMACAddress=remoteMACAddress, hTTPPortNumber=hTTPPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, activeCodeWordCount=activeCodeWordCount, PYSNMP_MODULE_ID=cambium, rFUFreqSpacing=rFUFreqSpacing, subnetMask=subnetMask, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortStatus=dataPortStatus, productVariant=productVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, longitude=longitude, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUTxPowerMax=rFUTxPowerMax, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyStatusGroup=phyStatusGroup, dataPortPauseFrames=dataPortPauseFrames, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, protectionStats=protectionStats, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, remoteIPAddress=remoteIPAddress, syslogStateTrap=syslogStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, resetGroup=resetGroup, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, receiveModulation=receiveModulation, licenceGroup=licenceGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementCommittedInformationRate=managementCommittedInformationRate, iPDSCPPriorityTable=iPDSCPPriorityTable, phyControl=phyControl, syslogControlGroup=syslogControlGroup, radioLicenseCodeRate=radioLicenseCodeRate, versionsGroup=versionsGroup, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv4Address=iPv4Address, sNTPPrimaryServer=sNTPPrimaryServer, fiberY=fiberY, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, securityLevel=securityLevel, linkName=linkName, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sNMPTrapVersion=sNMPTrapVersion, sNTPServerIPAddress=sNTPServerIPAddress, neighborIPAddress=neighborIPAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, protectionStatusGroup=protectionStatusGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityVid=rxDiversityVid, configurationGroup=configurationGroup, syslogClient=syslogClient, tFTPServerInternetAddressType=tFTPServerInternetAddressType)
