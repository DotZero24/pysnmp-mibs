...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", managementPortForcedConfiguration=managementPortForcedConfiguration, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementCommittedInformationRate=managementCommittedInformationRate, primaryRecoveryPeriod=primaryRecoveryPeriod, wirelessLinkAvailability=wirelessLinkAvailability, alignmentMode=alignmentMode, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUSerial=rFUSerial, sNMPPortNumber=sNMPPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, neighborIPAddress=neighborIPAddress, longitude=longitude, rFUPlatformCompatibility=rFUPlatformCompatibility, antennaGain=antennaGain, remoteSecondaryMACAddress=remoteSecondaryMACAddress, userTableEntry=userTableEntry, daylightSaving=daylightSaving, smtpGroup=smtpGroup, bootVersion=bootVersion, userTableIndex=userTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUFreqSpacing=rFUFreqSpacing, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, rFUTxBandAboveRx=rFUTxBandAboveRx, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, sNTPServerResponse=sNTPServerResponse, supplementaryGroup=supplementaryGroup, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUStatus=rFUStatus, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, userName=userName, tFTPServerInternetAddress=tFTPServerInternetAddress, neighborInternetAddress=neighborInternetAddress, managementPortStatus=managementPortStatus, aAAControlGroup=aAAControlGroup, rFUPowerButtonPressed=rFUPowerButtonPressed, linkNameMismatch=linkNameMismatch, managementPortConfigurationMismatch=managementPortConfigurationMismatch, activeAvailableTime=activeAvailableTime, remoteSecondaryIPAddress=remoteSecondaryIPAddress, systemClock=systemClock, rxDiversityVid=rxDiversityVid, softwareVersion=softwareVersion, iPVersion=iPVersion, sNTPServerTable=sNTPServerTable, encryptionEnabledMismatch=encryptionEnabledMismatch, ptp=ptp, rFURfBand=rFURfBand, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUStatusTrap=rFUStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFULockoutAlarm=rFULockoutAlarm, versionsGroup=versionsGroup, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, phyStatusGroup=phyStatusGroup, l2CPPriorityTable=l2CPPriorityTable, remoteMACAddress=remoteMACAddress, syslogControlGroup=syslogControlGroup, numberOfAntennas=numberOfAntennas, sNMPEnabledTraps=sNMPEnabledTraps, radioLicenseRxFreq=radioLicenseRxFreq, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTable=userTable, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, ptmp=ptmp, localPacketFiltering=localPacketFiltering, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, iPv6Address=iPv6Address, receivePower=receivePower, rFUTxFreqMax=rFUTxFreqMax, transmitCapacity=transmitCapacity, dataPortStatusTrap=dataPortStatusTrap, productName=productName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteIPAddress=remoteIPAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, diverseAntennaGain=diverseAntennaGain, rFUVersionBank2=rFUVersionBank2, managementPortDisabledWarning=managementPortDisabledWarning, sNTPState=sNTPState, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, transmitPower=transmitPower, pubStats=pubStats, rFURxFreqMin=rFURxFreqMin, byteErrorRatio=byteErrorRatio, receiveCodeRate=receiveCodeRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetPortNumber=telnetPortNumber, aTPCEnable=aTPCEnable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, diverseRfFeederLoss=diverseRfFeederLoss, linkName=linkName, tFTPServerPortNumber=tFTPServerPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, radioLicenseBand=radioLicenseBand, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, transmitCodeRate=transmitCodeRate, protectionConfigGroup=protectionConfigGroup, sMTPEnabledMessages=sMTPEnabledMessages, linkNameMismatchTrap=linkNameMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSync=sNTPSync, enableTransmission=enableTransmission, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicenseTxFreq=radioLicenseTxFreq, radioLicenseGroup=radioLicenseGroup, activeCodeWordCount=activeCodeWordCount, userPassword=userPassword, ptpTrapPrefix=ptpTrapPrefix, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, sNTPPollInterval=sNTPPollInterval, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, activeByteCount=activeByteCount, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, transmitterStatus=transmitterStatus, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, timeZone=timeZone, securityLevel=securityLevel, faultProtectionSwitching=faultProtectionSwitching, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUType=rFUType, userRole=userRole, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, activeUnit=activeUnit, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, subnetMask=subnetMask, ethernetPriorityTable=ethernetPriorityTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptpCompliance=ptpCompliance, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUTxPowerMin=rFUTxPowerMin, syslogState=syslogState, alarms=alarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenceGroup=licenceGroup, sNTPServerRetries=sNTPServerRetries, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, protection=protection, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressType=remoteInternetAddressType, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortFiberStatus=dataPortFiberStatus, userEnabled=userEnabled, reset=reset, sNTPServerTableEntry=sNTPServerTableEntry, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, dataPortPauseFrames=dataPortPauseFrames, mPLSTCPriorityTable=mPLSTCPriorityTable, endId=endId, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNTPLastSync=sNTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, requestedProtectionState=requestedProtectionState, bridge=bridge, ethernetPriorityTableNumber=ethernetPriorityTableNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, radioLicenseModulation=radioLicenseModulation, protectionConfig=protectionConfig, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, rFURpsAlarm=rFURpsAlarm, sNMPTrapVersion=sNMPTrapVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, sntp=sntp, rxDiversityDataPortStatus=rxDiversityDataPortStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iFCableLength=iFCableLength, productVariant=productVariant, dataPortFiberStatusTrap=dataPortFiberStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUTxPowerMax=rFUTxPowerMax, PYSNMP_MODULE_ID=cambium, sNMPTrapTable=sNMPTrapTable, unitOutOfCalibration=unitOutOfCalibration, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseMaxEIRP=radioLicenseMaxEIRP, codeWordErrorRatio=codeWordErrorRatio, rFUPowerAlarm=rFUPowerAlarm, rFUTxMuteStatus=rFUTxMuteStatus, secureModeAlarm=secureModeAlarm, ptpTraps=ptpTraps, minCodeRate=minCodeRate, ethernet=ethernet, syslogControl=syslogControl, sNTPSyncTrap=sNTPSyncTrap, supplementary=supplementary, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, siteName=siteName, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControl=phyControl, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, rFUTxPowerAlarm=rFUTxPowerAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, protectionAvailabilityStatus=protectionAvailabilityStatus, rFFeederLoss=rFFeederLoss, maxCodeRate=maxCodeRate, sMTPServerIPAddress=sMTPServerIPAddress, ptp800=ptp800, versions=versions, sNTPPrimaryServer=sNTPPrimaryServer, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, radioLicenseCodeRate=radioLicenseCodeRate, gatewayIPAddress=gatewayIPAddress, latitude=latitude, encryptionGroup=encryptionGroup, syslogClientTrap=syslogClientTrap, activeCodeWordErrorCount=activeCodeWordErrorCount, bridgeGroup=bridgeGroup, primarySecondaryMode=primarySecondaryMode, activeByteErrorCount=activeByteErrorCount, neighborInternetAddressType=neighborInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkLoss=linkLoss, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rxDiversityVlanTpid=rxDiversityVlanTpid, rfuGroup=rfuGroup, managementPortStatusTrap=managementPortStatusTrap, systemReset=systemReset)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUTxFreqMin=rFUTxFreqMin, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, rFUActiveFirmwareBank=rFUActiveFirmwareBank, smtp=smtp, licence=licence, alignmentModeTrap=alignmentModeTrap, fiberY=fiberY, radioLicenseMinCodeRate=radioLicenseMinCodeRate, configuration=configuration, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, rFUProtectionCompatibility=rFUProtectionCompatibility, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, snmpControlGroup=snmpControlGroup, activeWirelessLinkAvailability=activeWirelessLinkAvailability, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUVersionBank1=rFUVersionBank1, rFUCableAlarm=rFUCableAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, aAAControl=aAAControl, protectionSwitchCause=protectionSwitchCause, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, phyControlGroup=phyControlGroup, managementMode=managementMode, remotePrimaryMACAddress=remotePrimaryMACAddress, minModulation=minModulation, iPv4Address=iPv4Address, cambium=cambium, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, protectionState=protectionState, rFURFSwitchAlarm=rFURFSwitchAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableIndex=sNTPServerTableIndex, wirelessLinkStatusTrap=wirelessLinkStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, vLANManagementVIDValidation=vLANManagementVIDValidation, protectionConfigurationStatus=protectionConfigurationStatus, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogStateTrap=syslogStateTrap, syslogClient=syslogClient, aggregateDataRate=aggregateDataRate, activeCodeWordErrorRatio=activeCodeWordErrorRatio, rfu=rfu, remoteInternetAddress=remoteInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, neighborMACAddress=neighborMACAddress, activeByteErrorRatio=activeByteErrorRatio, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, alarmsGroup=alarmsGroup, protectionStatus=protectionStatus, phyStatus=phyStatus, protectionStats=protectionStats, radioLicenseMinModulation=radioLicenseMinModulation, sMTPEmailAlert=sMTPEmailAlert, iPv6PrefixLength=iPv6PrefixLength, encryptionAlgorithm=encryptionAlgorithm, rFUTransceiverLocation=rFUTransceiverLocation, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, radioLicenseIdentifier=radioLicenseIdentifier, protectionStatsGroup=protectionStatsGroup, radioLicense=radioLicense, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, transmitModulation=transmitModulation, maxModulation=maxModulation, transmitCapacityLimit=transmitCapacityLimit, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, tFTPServerIPAddress=tFTPServerIPAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, snmpControl=snmpControl, radioLicenseRegion=radioLicenseRegion, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFURxFreqMax=rFURxFreqMax, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetFiberSupport=ethernetFiberSupport, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, radioLicenseBandwidth=radioLicenseBandwidth, protectionInterfaceStatus=protectionInterfaceStatus, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, ptpGroups=ptpGroups, vectorError=vectorError, protectionStateTrap=protectionStateTrap, pubStatsGroup=pubStatsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, altitude=altitude, sNTPServerTableNumber=sNTPServerTableNumber, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, hTTPSPortNumber=hTTPSPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remotePrimarySecondaryMode=remotePrimarySecondaryMode, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, encryption=encryption, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, primaryRecovery=primaryRecovery, managementGroup=managementGroup, protectionStatusGroup=protectionStatusGroup, receiveModulation=receiveModulation)
