...
# Notes
# -----
# ASN.1 source file://mibs/cambium/CAMBIUM-PTP800-MIB
...
class _SoftwareVersionRemoteCompatibility_Type(Integer32):
    """Custom type softwareVersionRemoteCompatibility based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_SoftwareVersionRemoteCompatibility_Type.__name__ = "Integer32"
_SoftwareVersionRemoteCompatibility_Object = MibScalar
softwareVersionRemoteCompatibility = _SoftwareVersionRemoteCompatibility_Object(
    (1, 3, 6, 1, 4, 1, 17713, 8, 13, 10),
    _SoftwareVersionRemoteCompatibility_Type()
)
softwareVersionRemoteCompatibility.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    softwareVersionRemoteCompatibility.setStatus("current")
...
sNMPTrapReceiverEnabled.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
class _RFURfBand_Type(Integer32):
    ...
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(4000, 70000),
    )
...
class _RFURxFreqMin_Type(Integer32):
    ...
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(5725000, 70000000),
    )
...
class _RadioLicenseTxFreq_Type(Integer32):
    ...
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(5925000, 70000000),
    )
...
numberOfAntennas.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
class _NeighborInternetAddressType_Type(Integer32):
    """Custom type neighborInternetAddressType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_NeighborInternetAddressType_Type.__name__ = "Integer32"
_NeighborInternetAddressType_Object = MibScalar
neighborInternetAddressType = _NeighborInternetAddressType_Object(
    (1, 3, 6, 1, 4, 1, 17713, 8, 26, 33),
    _NeighborInternetAddressType_Type()
)
neighborInternetAddressType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    neighborInternetAddressType.setStatus("current")
_NeighborInternetAddress_Type = InetAddress
_NeighborInternetAddress_Object = MibScalar
neighborInternetAddress = _NeighborInternetAddress_Object(
    (1, 3, 6, 1, 4, 1, 17713, 8, 26, 34),
    _NeighborInternetAddress_Type()
)
neighborInternetAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    neighborInternetAddress.setStatus("current")


class _RemotePrimaryInternetAddressType_Type(Integer32):
    """Custom type remotePrimaryInternetAddressType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RemotePrimaryInternetAddressType_Type.__name__ = "Integer32"
_RemotePrimaryInternetAddressType_Object = MibScalar
remotePrimaryInternetAddressType = _RemotePrimaryInternetAddressType_Object(
    (1, 3, 6, 1, 4, 1, 17713, 8, 26, 35),
    _RemotePrimaryInternetAddressType_Type()
)
remotePrimaryInternetAddressType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    remotePrimaryInternetAddressType.setStatus("current")
_RemotePrimaryInternetAddress_Type = InetAddress
_RemotePrimaryInternetAddress_Object = MibScalar
remotePrimaryInternetAddress = _RemotePrimaryInternetAddress_Object(
    (1, 3, 6, 1, 4, 1, 17713, 8, 26, 36),
    _RemotePrimaryInternetAddress_Type()
)
remotePrimaryInternetAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    remotePrimaryInternetAddress.setStatus("current")


class _RemoteSecondaryInternetAddressType_Type(Integer32):
    """Custom type remoteSecondaryInternetAddressType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RemoteSecondaryInternetAddressType_Type.__name__ = "Integer32"
_RemoteSecondaryInternetAddressType_Object = MibScalar
remoteSecondaryInternetAddressType = _RemoteSecondaryInternetAddressType_Object(
    (1, 3, 6, 1, 4, 1, 17713, 8, 26, 37),
    _RemoteSecondaryInternetAddressType_Type()
)
remoteSecondaryInternetAddressType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    remoteSecondaryInternetAddressType.setStatus("current")
_RemoteSecondaryInternetAddress_Type = InetAddress
_RemoteSecondaryInternetAddress_Object = MibScalar
remoteSecondaryInternetAddress = _RemoteSecondaryInternetAddress_Object(
    (1, 3, 6, 1, 4, 1, 17713, 8, 26, 38),
    _RemoteSecondaryInternetAddress_Type()
)
remoteSecondaryInternetAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    remoteSecondaryInternetAddress.setStatus("current")
...
configurationGroup.setObjects(
      *(("CAMBIUM-PTP800-MIB", "iPv4Address"),
        ...
        ("CAMBIUM-PTP800-MIB", "iPVersion"),
        ("CAMBIUM-PTP800-MIB", "iPv6AutoConfiguredLinkLocalAddress"),
        ("CAMBIUM-PTP800-MIB", "iPv6PrefixLength"),
        ("CAMBIUM-PTP800-MIB", "iPv6GatewayAddress"),
        ("CAMBIUM-PTP800-MIB", "remoteInternetAddressType"),
...
managementGroup.setObjects(
      *(("CAMBIUM-PTP800-MIB", "linkNameMismatch"),
        ...
        ("CAMBIUM-PTP800-MIB", "tFTPServerInternetAddressType"),
        ("CAMBIUM-PTP800-MIB", "tFTPServerInternetAddress"))
)
if mibBuilder.loadTexts:
...
alarmsGroup.setObjects(
      *(("CAMBIUM-PTP800-MIB", "unitOutOfCalibration"),
        ...
        ("CAMBIUM-PTP800-MIB", "softwareVersionRemoteCompatibility"),
...
smtpGroup.setObjects(
      *(("CAMBIUM-PTP800-MIB", "sMTPEmailAlert"),
        ...
        ("CAMBIUM-PTP800-MIB", "sMTPServerInternetAddressType"),
        ("CAMBIUM-PTP800-MIB", "sMTPServerInternetAddress"))
)
if mibBuilder.loadTexts:
...
snmpControlGroup.setObjects(
      *(("CAMBIUM-PTP800-MIB", "sNMPPortNumber"),
        ...
        ("CAMBIUM-PTP800-MIB", "sNMPTrapInternetAddressType"),
        ("CAMBIUM-PTP800-MIB", "sNMPTrapInternetAddress"),
        ("CAMBIUM-PTP800-MIB", "sNMPTrapReceiverEnabled"))
)
if mibBuilder.loadTexts:
...
sntpGroup.setObjects(
      *(("CAMBIUM-PTP800-MIB", "sNTPState"),
        ...
        ("CAMBIUM-PTP800-MIB", "sNTPServerInternetAddressType"),
        ("CAMBIUM-PTP800-MIB", "sNTPServerInternetAddress"))
)
if mibBuilder.loadTexts:
...
protectionStatusGroup.setObjects(
      *(("CAMBIUM-PTP800-MIB", "protectionAvailabilityStatus"),
        ...
        ("CAMBIUM-PTP800-MIB", "neighborInternetAddressType"),
        ("CAMBIUM-PTP800-MIB", "neighborInternetAddress"),
        ("CAMBIUM-PTP800-MIB", "remotePrimaryInternetAddressType"),
        ("CAMBIUM-PTP800-MIB", "remotePrimaryInternetAddress"),
        ("CAMBIUM-PTP800-MIB", "remoteSecondaryInternetAddressType"),
        ("CAMBIUM-PTP800-MIB", "remoteSecondaryInternetAddress"))
)
if mibBuilder.loadTexts:
...
aAAControlGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 17713, 8, 98, 29)
)
aAAControlGroup.setObjects(
      *(("CAMBIUM-PTP800-MIB", "userTableNumber"),
        ("CAMBIUM-PTP800-MIB", "userName"),
        ("CAMBIUM-PTP800-MIB", "userRole"),
        ("CAMBIUM-PTP800-MIB", "userEnabled"),
        ("CAMBIUM-PTP800-MIB", "userPassword"))
)
if mibBuilder.loadTexts:
...
softwareVersionRemoteCompatibilityTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 17713, 8, 99, 0, 20)
)
softwareVersionRemoteCompatibilityTrap.setObjects(
    ("CAMBIUM-PTP800-MIB", "softwareVersionRemoteCompatibility")
)
if mibBuilder.loadTexts:
    softwareVersionRemoteCompatibilityTrap.setStatus(
        "current"
    )
...
notificationsGroup.setObjects(
      *(("CAMBIUM-PTP800-MIB", "dataPortStatusTrap"),
        ...
        ("CAMBIUM-PTP800-MIB", "softwareVersionRemoteCompatibilityTrap"),
...
ptpCompliance.setObjects(
      *(("CAMBIUM-PTP800-MIB", "bridgeGroup"),
        ("CAMBIUM-PTP800-MIB", "configurationGroup"),
        ("CAMBIUM-PTP800-MIB", "ethernetGroup"),
        ("CAMBIUM-PTP800-MIB", "licenceGroup"),
        ("CAMBIUM-PTP800-MIB", "managementGroup"),
        ("CAMBIUM-PTP800-MIB", "phyControlGroup"),
        ("CAMBIUM-PTP800-MIB", "phyStatusGroup"),
        ("CAMBIUM-PTP800-MIB", "alarmsGroup"),
        ("CAMBIUM-PTP800-MIB", "smtpGroup"),
        ("CAMBIUM-PTP800-MIB", "snmpControlGroup"),
        ("CAMBIUM-PTP800-MIB", "sntpGroup"),
        ("CAMBIUM-PTP800-MIB", "resetGroup"),
        ("CAMBIUM-PTP800-MIB", "versionsGroup"),
        ("CAMBIUM-PTP800-MIB", "pubStatsGroup"),
        ("CAMBIUM-PTP800-MIB", "encryptionGroup"),
        ("CAMBIUM-PTP800-MIB", "rfuGroup"),
        ("CAMBIUM-PTP800-MIB", "radioLicenseGroup"),
        ("CAMBIUM-PTP800-MIB", "protectionConfigGroup"),
        ("CAMBIUM-PTP800-MIB", "protectionStatusGroup"),
        ("CAMBIUM-PTP800-MIB", "protectionStatsGroup"),
        ("CAMBIUM-PTP800-MIB", "aAAControlGroup"),
        ("CAMBIUM-PTP800-MIB", "syslogControlGroup"),
        ("CAMBIUM-PTP800-MIB", "supplementaryGroup"),
        ("CAMBIUM-PTP800-MIB", "notificationsGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"cambium": cambium,
       ...
       "softwareVersionRemoteCompatibility": softwareVersionRemoteCompatibility,
       ...
       "neighborInternetAddressType": neighborInternetAddressType,
       "neighborInternetAddress": neighborInternetAddress,
       "remotePrimaryInternetAddressType": remotePrimaryInternetAddressType,
       "remotePrimaryInternetAddress": remotePrimaryInternetAddress,
       "remoteSecondaryInternetAddressType": remoteSecondaryInternetAddressType,
       "remoteSecondaryInternetAddress": remoteSecondaryInternetAddress,
       ...
       "softwareVersionRemoteCompatibilityTrap": softwareVersionRemoteCompatibilityTrap,
