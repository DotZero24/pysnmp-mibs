...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-EMBWEB-MIB
...
rlEmWebHttpsLoggingEnable = _RlEmWebHttpsLoggingEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 66, 33),
    _RlEmWebHttpsLoggingEnable_Type()
)
rlEmWebHttpsLoggingEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlEmWebHttpsLoggingEnable.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlEmbWebProtocol": RlEmbWebProtocol,
       ...
       "rlEmWebHttpsLoggingEnable": rlEmWebHttpsLoggingEnable}
)
