# SNMP MIB module (PW-MPLS-STD-R-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/rad/PW-MPLS-STD-R-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:17:17 2025
...
pwMplsStdMIBR = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 12)
)
if mibBuilder.loadTexts:
    pwMplsStdMIBR.setRevisions(
        ("2007-01-31 12:00",)
    )
...
pwMplsNonTeMappingEntry = _PwMplsNonTeMappingEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 12, 1, 4, 1)
)
pwMplsNonTeMappingEntry.setIndexNames(
    (0, "PW-MPLS-STD-R-MIB", "pwMplsNonTeMappingDirection"),
    (0, "PW-MPLS-STD-R-MIB", "pwMplsNonTeMappingXcIndex"),
    (0, "PW-MPLS-STD-R-MIB", "pwMplsNonTeMappingIfIndex"),
    (0, "PW-MPLS-STD-R-MIB", "pwMplsNonTeMappingPwIndex"),
)
if mibBuilder.loadTexts:
...
pwMplsTeMappingEntry = _PwMplsTeMappingEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 12, 1, 5, 1)
)
pwMplsTeMappingEntry.setIndexNames(
    (0, "PW-MPLS-STD-R-MIB", "pwMplsTeMappingTunnelIndex"),
    (0, "PW-MPLS-STD-R-MIB", "pwMplsTeMappingTunnelInstance"),
    (0, "PW-MPLS-STD-R-MIB", "pwMplsTeMappingTunnelPeerLsrID"),
    (0, "PW-MPLS-STD-R-MIB", "pwMplsTeMappingTunnelLocalLsrID"),
    (0, "PW-MPLS-STD-R-MIB", "pwMplsTeMappingPwIndex"),
)
if mibBuilder.loadTexts:
...
pwMplsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 12, 2, 1, 1)
)
pwMplsGroup.setObjects(
      *(("PW-MPLS-STD-R-MIB", "pwMplsMplsType"),
        ("PW-MPLS-STD-R-MIB", "pwMplsExpBitsMode"),
        ("PW-MPLS-STD-R-MIB", "pwMplsExpBits"),
        ("PW-MPLS-STD-R-MIB", "pwMplsTtl"),
        ("PW-MPLS-STD-R-MIB", "pwMplsLocalLdpID"),
        ("PW-MPLS-STD-R-MIB", "pwMplsLocalLdpEntityIndex"),
        ("PW-MPLS-STD-R-MIB", "pwMplsPeerLdpID"),
        ("PW-MPLS-STD-R-MIB", "pwMplsStorageType"))
)
if mibBuilder.loadTexts:
    pwMplsGroup.setStatus("current")

pwMplsOutboundMainGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 12, 2, 1, 2)
)
pwMplsOutboundMainGroup.setObjects(
      *(("PW-MPLS-STD-R-MIB", "pwMplsOutboundLsrXcIndex"),
        ("PW-MPLS-STD-R-MIB", "pwMplsOutboundIfIndex"),
        ("PW-MPLS-STD-R-MIB", "pwMplsOutboundTunnelTypeInUse"))
)
if mibBuilder.loadTexts:
    pwMplsOutboundMainGroup.setStatus("current")

pwMplsOutboundTeGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 12, 2, 1, 3)
)
pwMplsOutboundTeGroup.setObjects(
      *(("PW-MPLS-STD-R-MIB", "pwMplsOutboundTunnelIndex"),
        ("PW-MPLS-STD-R-MIB", "pwMplsOutboundTunnelInstance"),
        ("PW-MPLS-STD-R-MIB", "pwMplsOutboundTunnelLclLSR"),
        ("PW-MPLS-STD-R-MIB", "pwMplsOutboundTunnelPeerLSR"))
)
if mibBuilder.loadTexts:
    pwMplsOutboundTeGroup.setStatus("current")

pwMplsInboundGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 12, 2, 1, 4)
)
pwMplsInboundGroup.setObjects(
    ("PW-MPLS-STD-R-MIB", "pwMplsInboundXcIndex")
)
if mibBuilder.loadTexts:
    pwMplsInboundGroup.setStatus("current")

pwMplsMappingGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 12, 2, 1, 5)
)
pwMplsMappingGroup.setObjects(
      *(("PW-MPLS-STD-R-MIB", "pwMplsNonTeMappingPwIndex"),
        ("PW-MPLS-STD-R-MIB", "pwMplsTeMappingPwIndex"))
)
if mibBuilder.loadTexts:
...
pwMplsModuleFullCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 164, 20, 12, 2, 2, 1)
)
pwMplsModuleFullCompliance.setObjects(
      *(("PW-MPLS-STD-R-MIB", "pwMplsGroup"),
        ("PW-MPLS-STD-R-MIB", "pwMplsOutboundMainGroup"),
        ("PW-MPLS-STD-R-MIB", "pwMplsInboundGroup"),
        ("PW-MPLS-STD-R-MIB", "pwMplsMappingGroup"),
        ("PW-MPLS-STD-R-MIB", "pwMplsOutboundTeGroup"))
)
if mibBuilder.loadTexts:
...
pwMplsModuleReadOnlyCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 164, 20, 12, 2, 2, 2)
)
pwMplsModuleReadOnlyCompliance.setObjects(
      *(("PW-MPLS-STD-R-MIB", "pwMplsGroup"),
        ("PW-MPLS-STD-R-MIB", "pwMplsOutboundMainGroup"),
        ("PW-MPLS-STD-R-MIB", "pwMplsInboundGroup"),
        ("PW-MPLS-STD-R-MIB", "pwMplsMappingGroup"),
