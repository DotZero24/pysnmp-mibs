...
if mibBuilder.loadTexts:pwMplsStdMIBR.setRevisions(('2007-01-31 12:00',))
...
pwMplsNotifications=_PwMplsNotifications_ObjectIdentity((1,3,6,1,4,1,164,20,12,0))
_PwMplsObjects_ObjectIdentity=ObjectIdentity
pwMplsObjects=_PwMplsObjects_ObjectIdentity((1,3,6,1,4,1,164,20,12,1))
_PwMplsTable_Object=MibTable
pwMplsTable=_PwMplsTable_Object((1,3,6,1,4,1,164,20,12,1,1))
if mibBuilder.loadTexts:pwMplsTable.setStatus(_A)
_PwMplsEntry_Object=MibTableRow
pwMplsEntry=_PwMplsEntry_Object((1,3,6,1,4,1,164,20,12,1,1,1))
...
pwMplsMplsType=_PwMplsMplsType_Object((1,3,6,1,4,1,164,20,12,1,1,1,1),_PwMplsMplsType_Type())
...
pwMplsExpBitsMode=_PwMplsExpBitsMode_Object((1,3,6,1,4,1,164,20,12,1,1,1,2),_PwMplsExpBitsMode_Type())
...
pwMplsExpBits=_PwMplsExpBits_Object((1,3,6,1,4,1,164,20,12,1,1,1,3),_PwMplsExpBits_Type())
...
pwMplsTtl=_PwMplsTtl_Object((1,3,6,1,4,1,164,20,12,1,1,1,4),_PwMplsTtl_Type())
...
pwMplsLocalLdpID=_PwMplsLocalLdpID_Object((1,3,6,1,4,1,164,20,12,1,1,1,5),_PwMplsLocalLdpID_Type())
...
pwMplsLocalLdpEntityIndex=_PwMplsLocalLdpEntityIndex_Object((1,3,6,1,4,1,164,20,12,1,1,1,6),_PwMplsLocalLdpEntityIndex_Type())
...
pwMplsPeerLdpID=_PwMplsPeerLdpID_Object((1,3,6,1,4,1,164,20,12,1,1,1,7),_PwMplsPeerLdpID_Type())
...
pwMplsStorageType=_PwMplsStorageType_Object((1,3,6,1,4,1,164,20,12,1,1,1,8),_PwMplsStorageType_Type())
...
pwMplsOutboundTable=_PwMplsOutboundTable_Object((1,3,6,1,4,1,164,20,12,1,2))
if mibBuilder.loadTexts:pwMplsOutboundTable.setStatus(_A)
_PwMplsOutboundEntry_Object=MibTableRow
pwMplsOutboundEntry=_PwMplsOutboundEntry_Object((1,3,6,1,4,1,164,20,12,1,2,1))
...
pwMplsOutboundLsrXcIndex=_PwMplsOutboundLsrXcIndex_Object((1,3,6,1,4,1,164,20,12,1,2,1,1),_PwMplsOutboundLsrXcIndex_Type())
...
pwMplsOutboundTunnelIndex=_PwMplsOutboundTunnelIndex_Object((1,3,6,1,4,1,164,20,12,1,2,1,2),_PwMplsOutboundTunnelIndex_Type())
...
pwMplsOutboundTunnelInstance=_PwMplsOutboundTunnelInstance_Object((1,3,6,1,4,1,164,20,12,1,2,1,3),_PwMplsOutboundTunnelInstance_Type())
...
pwMplsOutboundTunnelLclLSR=_PwMplsOutboundTunnelLclLSR_Object((1,3,6,1,4,1,164,20,12,1,2,1,4),_PwMplsOutboundTunnelLclLSR_Type())
...
pwMplsOutboundTunnelPeerLSR=_PwMplsOutboundTunnelPeerLSR_Object((1,3,6,1,4,1,164,20,12,1,2,1,5),_PwMplsOutboundTunnelPeerLSR_Type())
...
pwMplsOutboundIfIndex=_PwMplsOutboundIfIndex_Object((1,3,6,1,4,1,164,20,12,1,2,1,6),_PwMplsOutboundIfIndex_Type())
...
pwMplsOutboundTunnelTypeInUse=_PwMplsOutboundTunnelTypeInUse_Object((1,3,6,1,4,1,164,20,12,1,2,1,7),_PwMplsOutboundTunnelTypeInUse_Type())
...
pwMplsInboundTable=_PwMplsInboundTable_Object((1,3,6,1,4,1,164,20,12,1,3))
if mibBuilder.loadTexts:pwMplsInboundTable.setStatus(_A)
_PwMplsInboundEntry_Object=MibTableRow
pwMplsInboundEntry=_PwMplsInboundEntry_Object((1,3,6,1,4,1,164,20,12,1,3,1))
...
pwMplsInboundXcIndex=_PwMplsInboundXcIndex_Object((1,3,6,1,4,1,164,20,12,1,3,1,1),_PwMplsInboundXcIndex_Type())
...
pwMplsNonTeMappingTable=_PwMplsNonTeMappingTable_Object((1,3,6,1,4,1,164,20,12,1,4))
if mibBuilder.loadTexts:pwMplsNonTeMappingTable.setStatus(_A)
_PwMplsNonTeMappingEntry_Object=MibTableRow
pwMplsNonTeMappingEntry=_PwMplsNonTeMappingEntry_Object((1,3,6,1,4,1,164,20,12,1,4,1))
...
pwMplsNonTeMappingDirection=_PwMplsNonTeMappingDirection_Object((1,3,6,1,4,1,164,20,12,1,4,1,1),_PwMplsNonTeMappingDirection_Type())
...
pwMplsNonTeMappingXcIndex=_PwMplsNonTeMappingXcIndex_Object((1,3,6,1,4,1,164,20,12,1,4,1,2),_PwMplsNonTeMappingXcIndex_Type())
...
pwMplsNonTeMappingIfIndex=_PwMplsNonTeMappingIfIndex_Object((1,3,6,1,4,1,164,20,12,1,4,1,3),_PwMplsNonTeMappingIfIndex_Type())
...
pwMplsNonTeMappingPwIndex=_PwMplsNonTeMappingPwIndex_Object((1,3,6,1,4,1,164,20,12,1,4,1,4),_PwMplsNonTeMappingPwIndex_Type())
...
pwMplsTeMappingTable=_PwMplsTeMappingTable_Object((1,3,6,1,4,1,164,20,12,1,5))
if mibBuilder.loadTexts:pwMplsTeMappingTable.setStatus(_A)
_PwMplsTeMappingEntry_Object=MibTableRow
pwMplsTeMappingEntry=_PwMplsTeMappingEntry_Object((1,3,6,1,4,1,164,20,12,1,5,1))
...
pwMplsTeMappingTunnelIndex=_PwMplsTeMappingTunnelIndex_Object((1,3,6,1,4,1,164,20,12,1,5,1,1),_PwMplsTeMappingTunnelIndex_Type())
...
pwMplsTeMappingTunnelInstance=_PwMplsTeMappingTunnelInstance_Object((1,3,6,1,4,1,164,20,12,1,5,1,2),_PwMplsTeMappingTunnelInstance_Type())
...
pwMplsTeMappingTunnelPeerLsrID=_PwMplsTeMappingTunnelPeerLsrID_Object((1,3,6,1,4,1,164,20,12,1,5,1,3),_PwMplsTeMappingTunnelPeerLsrID_Type())
...
pwMplsTeMappingTunnelLocalLsrID=_PwMplsTeMappingTunnelLocalLsrID_Object((1,3,6,1,4,1,164,20,12,1,5,1,4),_PwMplsTeMappingTunnelLocalLsrID_Type())
...
pwMplsTeMappingPwIndex=_PwMplsTeMappingPwIndex_Object((1,3,6,1,4,1,164,20,12,1,5,1,5),_PwMplsTeMappingPwIndex_Type())
...
pwMplsModuleReadOnlyCompliance=ModuleCompliance((1,3,6,1,4,1,164,20,12,2,2,2))
