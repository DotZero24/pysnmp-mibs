...
mibBuilder.exportSymbols("CISCO-BSC-MIB", ciscoBscMIB=ciscoBscMIB, bscObjects=bscObjects, bscPortRecoveryRetries=bscPortRecoveryRetries, bscExtAddresses=bscExtAddresses, bscControlUnitTable=bscControlUnitTable, bscExtAddressTable=bscExtAddressTable, bscPorts=bscPorts, bscCUTotalFramesSent=bscCUTotalFramesSent, bscCUDataFramesSent=bscCUDataFramesSent, bscControlUnits=bscControlUnits, bscCUBytesReceived=bscCUBytesReceived, bscExtAddressEntry=bscExtAddressEntry, bscCUProtocolViolations=bscCUProtocolViolations, PYSNMP_MODULE_ID=ciscoBscMIB, bscPortSoftErrors=bscPortSoftErrors, bscPortHardErrors=bscPortHardErrors, bscPortPollTimeout=bscPortPollTimeout, bscPortSpecPoll=bscPortSpecPoll, bscPortUnknownControlUnitsReceived=bscPortUnknownControlUnitsReceived, bscPortCodeSet=bscPortCodeSet, bscControlUnitsGroup=bscControlUnitsGroup, bscPortTable=bscPortTable, bscPortHostTimeout=bscPortHostTimeout, bscCUState=bscCUState, bscPortsGroup=bscPortsGroup, bscCUBytesSent=bscCUBytesSent, bscExtPollAddress=bscExtPollAddress, bscPortContentionDialTimeout=bscPortContentionDialTimeout, bscMibComplianceRev1=bscMibComplianceRev1, bscExtAddressGroup=bscExtAddressGroup, bscMibGroups=bscMibGroups, bscMibConformance=bscMibConformance, bscCUTotalFramesReceived=bscCUTotalFramesReceived, bscPortsGroupRev1=bscPortsGroupRev1, bscMibCompliance=bscMibCompliance, bscCUEntry=bscCUEntry, bscPortRole=bscPortRole, bscPortVirtualAddress=bscPortVirtualAddress, bscCUAddress=bscCUAddress, bscPortPause=bscPortPause, bscCUHardErrors=bscCUHardErrors, bscMibCompliances=bscMibCompliances, bscPortServlim=bscPortServlim, bscPortEntry=bscPortEntry, bscCUSoftErrors=bscCUSoftErrors, bscPortProtocolViolations=bscPortProtocolViolations, bscExtSelectAddress=bscExtSelectAddress, bscCUDataFramesReceived=bscCUDataFramesReceived)
