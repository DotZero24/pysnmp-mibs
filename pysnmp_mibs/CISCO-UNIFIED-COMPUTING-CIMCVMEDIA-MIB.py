...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-CIMCVMEDIA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:24:54 2025
...
cucsCimcvmediaActualMountEntryRemapOnEject = _CucsCimcvmediaActualMountEntryRemapOnEject_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 76, 1, 1, 21),
    _CucsCimcvmediaActualMountEntryRemapOnEject_Type()
)
cucsCimcvmediaActualMountEntryRemapOnEject.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsCimcvmediaActualMountEntryRemapOnEject.setStatus("current")
...
cucsCimcvmediaConfigMountEntryRemapOnEject = _CucsCimcvmediaConfigMountEntryRemapOnEject_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 76, 3, 1, 19),
    _CucsCimcvmediaConfigMountEntryRemapOnEject_Type()
)
cucsCimcvmediaConfigMountEntryRemapOnEject.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsCimcvmediaConfigMountEntryRemapOnEject.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsCimcvmediaObjects": cucsCimcvmediaObjects,
       ...
       "cucsCimcvmediaActualMountEntryRemapOnEject": cucsCimcvmediaActualMountEntryRemapOnEject,
       ...
       "cucsCimcvmediaConfigMountEntryRemapOnEject": cucsCimcvmediaConfigMountEntryRemapOnEject,
