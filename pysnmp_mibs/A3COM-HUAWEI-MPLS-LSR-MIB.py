...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-MPLS-LSR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:46:05 2025
...
mplsLsrModuleCompliance.setObjects(
      *(("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsInSegmentGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsOutSegmentGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsXCGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsInterfaceGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsPerfGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsSegmentDiscontinuityGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsHCInSegmentPerfGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsHCOutSegmentPerfGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsTrafficParamGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsXCIsPersistentGroup"),
        ("A3COM-HUAWEI-MPLS-LSR-MIB", "mplsXCIsNotPersistentGroup"))
)
if mibBuilder.loadTexts:
