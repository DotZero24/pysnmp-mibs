...
cpqRackCommonEnclosureRack, cpqRackCommonEnclosureIndex, cpqRackNetConnectorChassis, cpqRackNetConnectorIndex, cpqRackAssetIndex, cpqRackNetConnectorRack = mibBuilder.importSymbols("CPQRACK-MIB", "cpqRackCommonEnclosureRack", "cpqRackCommonEnclosureIndex", "cpqRackNetConnectorChassis", "cpqRackNetConnectorIndex", "cpqRackAssetIndex", "cpqRackNetConnectorRack")
...
mibBuilder.exportSymbols("COMPAQ-AGENT-MIB", agentIpGetIpFrom=agentIpGetIpFrom, agentSwitchFanCondition=agentSwitchFanCondition, agentBscSwFileStatus=agentBscSwFileStatus, agentBscFileServerTftpPort=agentBscFileServerTftpPort, agentDSTRepeatingStartWhichDay=agentDSTRepeatingStartWhichDay, agentBscSwFileDscr=agentBscSwFileDscr, agentSwitchCubeSpareName=agentSwitchCubeSpareName, agentSwitchPowerSupplyEntry=agentSwitchPowerSupplyEntry, agentSwitchCubeType=agentSwitchCubeType, agentSlipModeManagerLocalIP=agentSlipModeManagerLocalIP, agentSNTPTimeSource=agentSNTPTimeSource, agentSwitchPowerSupplyMaxPwrOutput=agentSwitchPowerSupplyMaxPwrOutput, agentRs232PortConfig=agentRs232PortConfig, agentIpTrapManagerStatus=agentIpTrapManagerStatus, agentIpTrapManagerEntry=agentIpTrapManagerEntry, agentConsoleModeManagerBaudRate=agentConsoleModeManagerBaudRate, agentSwitchCommonMgmt=agentSwitchCommonMgmt, agentSwitchPowerSupplyStatus=agentSwitchPowerSupplyStatus, agentDSTAnnualEndHour=agentDSTAnnualEndHour, agentSNTPUpTime=agentSNTPUpTime, agentBscSwFileTime=agentBscSwFileTime, agentBscSwFileLoadType=agentBscSwFileLoadType, agentSwitchFanEntry=agentSwitchFanEntry, agentSwitchPowerSupply=agentSwitchPowerSupply, agentOutOfBandBaudRateConfig=agentOutOfBandBaudRateConfig, agentMibCapabilityIndex=agentMibCapabilityIndex, endOfMIB=endOfMIB, agentSwitchPowerSupplyIntakeTemp=agentSwitchPowerSupplyIntakeTemp, agentFileTransfer=agentFileTransfer, agentDSTRepeatingStartMonth=agentDSTRepeatingStartMonth, agentBasicConfig=agentBasicConfig, agentSwitchCube=agentSwitchCube, agentSNTPServer2IPAddr=agentSNTPServer2IPAddr, agentConsoleModeManagerStopBits=agentConsoleModeManagerStopBits, agentDSTAnnualStartHour=agentDSTAnnualStartHour, agentGeneralMgmt=agentGeneralMgmt, agentStatusConsoleInUse=agentStatusConsoleInUse, agentSwitchTempSensorTable=agentSwitchTempSensorTable, agentSaveCfg=agentSaveCfg, agentSwitchPowerSupplyCondition=agentSwitchPowerSupplyCondition, agentSNTPPollInterval=agentSNTPPollInterval, agentMibCapabilityVersion=agentMibCapabilityVersion, agentDSTAnnualEndMinute=agentDSTAnnualEndMinute, agentSwitchFanTable=agentSwitchFanTable, agentSwitchPowerSupplyInputLineStatus=agentSwitchPowerSupplyInputLineStatus, agentMibCapabilityEntry=agentMibCapabilityEntry, agentSNTPBootTime=agentSNTPBootTime, agentDSTRepeatingEndMonth=agentDSTRepeatingEndMonth, agentSwitchFirmwareMfgDate=agentSwitchFirmwareMfgDate, agentSystemReset=agentSystemReset, agentIpTrapManagerTable=agentIpTrapManagerTable, agentSwitchTempSensorTempType=agentSwitchTempSensorTempType, agentSwitchPowerSupplyTable=agentSwitchPowerSupplyTable, agentSwitchTempSensor=agentSwitchTempSensor, agentSwitchTempSensorIndex=agentSwitchTempSensorIndex, agentSwitchFan=agentSwitchFan, agentSwitchMfgDate=agentSwitchMfgDate, agentSwitchPowerSupplyCurPwrOutput=agentSwitchPowerSupplyCurPwrOutput, agentDSTStatus=agentDSTStatus, agentDSTAnnualStartMonth=agentDSTAnnualStartMonth, agentDSTAnnualEndDayOfMonth=agentDSTAnnualEndDayOfMonth, agentSlipModeManagerMTU=agentSlipModeManagerMTU, agentSwitchPowerSupplyExhaustTemp=agentSwitchPowerSupplyExhaustTemp, agentBscSwFileCtrl=agentBscSwFileCtrl, agentIpTrapManager=agentIpTrapManager, agentStatusSaveCfg=agentStatusSaveCfg, agentIpTftpServerAddr=agentIpTftpServerAddr, agentDSTRepeatingEndWhichDay=agentDSTRepeatingEndWhichDay, agentMibCapabilityTable=agentMibCapabilityTable, agentIpNumOfIf=agentIpNumOfIf, agentIpTrapManagerComm=agentIpTrapManagerComm, agentDSTOffset=agentDSTOffset, agentDSTRepeatingStartMinute=agentDSTRepeatingStartMinute, agentBscSwFileEntry=agentBscSwFileEntry, agentSwitchCubeEntry=agentSwitchCubeEntry, agentSlipModeManagerBaudRate=agentSlipModeManagerBaudRate, agentIpProtoConfig=agentIpProtoConfig, agentSNTPCurrentTime=agentSNTPCurrentTime, agentBasicInfo=agentBasicInfo, agentBscSwFileLocateId=agentBscSwFileLocateId, agentDSTRepeatingEndDayOfWeek=agentDSTRepeatingEndDayOfWeek, agentSwitchPowerSupplyIndex=agentSwitchPowerSupplyIndex, agentSwitchTempSensorCondition=agentSwitchTempSensorCondition, agentSNTPTimeZone=agentSNTPTimeZone, agentDSTRepeatingStartHour=agentDSTRepeatingStartHour, agentSwitchTempSensorEntry=agentSwitchTempSensorEntry, agentSwitchTempSensorThreshold=agentSwitchTempSensorThreshold, agentSlipModeManager=agentSlipModeManager, agentDSTRepeatingEndHour=agentDSTRepeatingEndHour, agentSNTP=agentSNTP, agentIpTrapManagerIpAddr=agentIpTrapManagerIpAddr, agentDSTAnnualEndMonth=agentDSTAnnualEndMonth, agentBscSwFileAddr=agentBscSwFileAddr, agentSwitchTempSensorCurrent=agentSwitchTempSensorCurrent, agentMibCapabilityDescr=agentMibCapabilityDescr, agentSwitchFanIndex=agentSwitchFanIndex, agentMibCapabilityType=agentMibCapabilityType, agentSwitchCubeSparePartNumber=agentSwitchCubeSparePartNumber, agentSlipModeManagerRemoteIP=agentSlipModeManagerRemoteIP, agentDSTAnnualStartDayOfMonth=agentDSTAnnualStartDayOfMonth, agentSwitchCubeTable=agentSwitchCubeTable, agentBscSwFileTransferType=agentBscSwFileTransferType, agentDSTRepeatingStartDayOfWeek=agentDSTRepeatingStartDayOfWeek, agentDSTRepeatingEndMinute=agentDSTRepeatingEndMinute, agentConsoleModeManagerDataBits=agentConsoleModeManagerDataBits, agentConsoleModeManager=agentConsoleModeManager, agentMgmtProtocolCapability=agentMgmtProtocolCapability, agentSNTPServer1IPAddr=agentSNTPServer1IPAddr, agentDSTAnnualStartMinute=agentDSTAnnualStartMinute, agentBscSwFileIndex=agentBscSwFileIndex, agentConsoleModeManagerParity=agentConsoleModeManagerParity, agentSNTPState=agentSNTPState, agentDST=agentDST, agentBscSwFileTable=agentBscSwFileTable, agentBscSwFile=agentBscSwFile)
