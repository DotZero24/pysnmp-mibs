...
DynamicTemplateTargetId, DynamicTemplateType, DynamicTemplateName, DynamicTemplateTargetType = mibBuilder.importSymbols("CISCO-DYNAMIC-TEMPLATE-TC-MIB", "DynamicTemplateTargetId", "DynamicTemplateType", "DynamicTemplateName", "DynamicTemplateTargetType")
...
mibBuilder.exportSymbols("CISCO-DYNAMIC-TEMPLATE-MIB", cdtTemplateAssociationTable=cdtTemplateAssociationTable, cdtCommonKeepaliveInt=cdtCommonKeepaliveInt, cdtCommonIpv6AccessGroup=cdtCommonIpv6AccessGroup, cdtPppMsChapV2Opts=cdtPppMsChapV2Opts, cdtTemplateTargetId=cdtTemplateTargetId, cdtPppAuthorization=cdtPppAuthorization, cdtTemplateTargetEntry=cdtTemplateTargetEntry, cdtCommonVrf=cdtCommonVrf, cdtBase=cdtBase, cdtPppChapPassword=cdtPppChapPassword, cdtSrvSgSrvGroup=cdtSrvSgSrvGroup, cdtIfCdpEnable=cdtIfCdpEnable, cdtPppTemplateEntry=cdtPppTemplateEntry, cdtIfValid=cdtIfValid, cdtPppMsChapV1Password=cdtPppMsChapV1Password, cdtIfFlowMonitor=cdtIfFlowMonitor, cdtPppMsChapV2Hostname=cdtPppMsChapV2Hostname, cdtPppEapPassword=cdtPppEapPassword, cdtCommonAddrPool=cdtCommonAddrPool, cdtPppMaxTerminate=cdtPppMaxTerminate, cdtIfMtu=cdtIfMtu, cdtPppMaxBadAuth=cdtPppMaxBadAuth, cdtEthernetIpv4PointToPoint=cdtEthernetIpv4PointToPoint, cdtPppPeerIpAddrPoolStorage=cdtPppPeerIpAddrPoolStorage, cdtPppValid=cdtPppValid, cdtCommonGroup=cdtCommonGroup, cdtPppChapOpts=cdtPppChapOpts, cdtPppIpcpWinsOption=cdtPppIpcpWinsOption, cdtIfTemplateTable=cdtIfTemplateTable, cdtPppEapOpts=cdtPppEapOpts, cdtTemplateStatus=cdtTemplateStatus, cdtCommonIpv4Unreachables=cdtCommonIpv4Unreachables, cdtPppMsChapV1Hostname=cdtPppMsChapV1Hostname, cdtPppIpcpWinsPrimary=cdtPppIpcpWinsPrimary, cdtSrvSgSrvType=cdtSrvSgSrvType, cdtSubscriberGroup=cdtSubscriberGroup, cdtPppPeerIpAddrPoolName=cdtPppPeerIpAddrPoolName, cdtPppAuthentication=cdtPppAuthentication, ciscoDynamicTemplateR1Compliance=ciscoDynamicTemplateR1Compliance, ciscoDynamicTemplateMIBObjects=ciscoDynamicTemplateMIBObjects, cdtIfIpv4VerifyUniRpf=cdtIfIpv4VerifyUniRpf, cdtPppTemplateTable=cdtPppTemplateTable, cdtIfIpv4SubEnable=cdtIfIpv4SubEnable, cdtIfIpv6NdNsInterval=cdtIfIpv6NdNsInterval, cdtCommonIpv6Unreachables=cdtCommonIpv6Unreachables, cdtPppIpcpWinsSecondary=cdtPppIpcpWinsSecondary, cdtEthernet=cdtEthernet, cdtIfIpv4VerifyUniRpfOpts=cdtIfIpv4VerifyUniRpfOpts, cdtPppAccounting=cdtPppAccounting, cdtPppMsChapV2Password=cdtPppMsChapV2Password, cdtPppPeerIpAddrPoolTable=cdtPppPeerIpAddrPoolTable, cdtTemplateCommonEntry=cdtTemplateCommonEntry, cdtIfIpv6VerifyUniRpf=cdtIfIpv6VerifyUniRpf, cdtIfGroup=cdtIfGroup, PYSNMP_MODULE_ID=ciscoDynamicTemplateMIB, cdtPppIpcpDnsSecondary=cdtPppIpcpDnsSecondary, cdtEthernetGroup=cdtEthernetGroup, ciscoDynamicTemplateMIB=ciscoDynamicTemplateMIB, cdtTemplateAssociationPrecedence=cdtTemplateAssociationPrecedence, ciscoDynamicTemplateMIBCompliances=ciscoDynamicTemplateMIBCompliances, cdtIfIpv6NdRaIntervalMin=cdtIfIpv6NdRaIntervalMin, cdtTemplateSrc=cdtTemplateSrc, cdtPppTimeoutRetry=cdtPppTimeoutRetry, cdtCommonIf=cdtCommonIf, cdtIfIpv6NdPreferredLife=cdtIfIpv6NdPreferredLife, cdtIfTemplateEntry=cdtIfTemplateEntry, ciscoDynamicTemplateMIBConform=ciscoDynamicTemplateMIBConform, cdtPppIpcpAddrOption=cdtPppIpcpAddrOption, cdtPppPeerDefIpAddrSrc=cdtPppPeerDefIpAddrSrc, cdtIfIpv6VerifyUniRpfAcl=cdtIfIpv6VerifyUniRpfAcl, cdtTemplateUsageEntry=cdtTemplateUsageEntry, cdtPppChapHostname=cdtPppChapHostname, cdtIfIpv6NdOpts=cdtIfIpv6NdOpts, cdtPppPeerDefIpAddrOpts=cdtPppPeerDefIpAddrOpts, cdtCommonSrvSubControl=cdtCommonSrvSubControl, cdtSrvTemplateTable=cdtSrvTemplateTable, cdtTemplateStorage=cdtTemplateStorage, cdtPppPeerDefIpAddr=cdtPppPeerDefIpAddr, cdtCommonValid=cdtCommonValid, cdtPppMaxConfigure=cdtPppMaxConfigure, ciscoDynamicTemplateMIBGroups=ciscoDynamicTemplateMIBGroups, cdtIfIpv4Mtu=cdtIfIpv4Mtu, cdtIfIpv6TcpMssAdjust=cdtIfIpv6TcpMssAdjust, cdtTemplateTargetTable=cdtTemplateTargetTable, cdtPppPeerIpAddrPoolEntry=cdtPppPeerIpAddrPoolEntry, cdtIfIpv6NdValidLife=cdtIfIpv6NdValidLife, ciscoDynamicTemplateMIBNotifs=ciscoDynamicTemplateMIBNotifs, cdtCommonKeepaliveRetries=cdtCommonKeepaliveRetries, cdtTemplateTable=cdtTemplateTable, cdtTemplateAssociationEntry=cdtTemplateAssociationEntry, cdtCommonSrvRedirect=cdtCommonSrvRedirect, cdtPppPeerIpAddrPoolStatus=cdtPppPeerIpAddrPoolStatus, cdtTemplateUsageTable=cdtTemplateUsageTable, cdtPppPapUsername=cdtPppPapUsername, cdtIfIpv4VerifyUniRpfAcl=cdtIfIpv4VerifyUniRpfAcl, cdtCommonSrvAcct=cdtCommonSrvAcct, cdtPppAuthenticationMethods=cdtPppAuthenticationMethods, cdtIfIpv6NdPrefix=cdtIfIpv6NdPrefix, cdtIfIpv6Enable=cdtIfIpv6Enable, cdtIfIpv6NdRaIntervalUnits=cdtIfIpv6NdRaIntervalUnits, cdtPppPapPassword=cdtPppPapPassword, cdtEthernetTemplateTable=cdtEthernetTemplateTable, cdtSrvValid=cdtSrvValid, cdtSrvGroup=cdtSrvGroup, cdtSrvVpdnGroup=cdtSrvVpdnGroup, cdtSrvNetworkSrv=cdtSrvNetworkSrv, cdtTemplateType=cdtTemplateType, cdtTemplateUsageTargetId=cdtTemplateUsageTargetId, cdtCommonSrvQos=cdtCommonSrvQos, cdtPpp=cdtPpp, cdtPppMaxFailure=cdtPppMaxFailure, cdtPppIpcpMask=cdtPppIpcpMask, cdtIfIpv4Unnumbered=cdtIfIpv4Unnumbered, cdtTemplateUsageCount=cdtTemplateUsageCount, cdtSrvTemplateEntry=cdtSrvTemplateEntry, cdtPppIpcpDnsPrimary=cdtPppIpcpDnsPrimary, cdtPppIpcpDnsOption=cdtPppIpcpDnsOption, cdtTemplateName=cdtTemplateName, cdtIfIpv6VerifyUniRpfOpts=cdtIfIpv6VerifyUniRpfOpts, cdtTemplateEntry=cdtTemplateEntry, cdtPppMsChapV1Opts=cdtPppMsChapV1Opts, cdtPppPeerIpAddrPoolPriority=cdtPppPeerIpAddrPoolPriority, cdtCommonDescr=cdtCommonDescr, cdtPppTimeoutAuthentication=cdtPppTimeoutAuthentication, cdtEthernetTemplateEntry=cdtEthernetTemplateEntry, cdtEthernetPppoeEnable=cdtEthernetPppoeEnable, cdtTemplateCommonTable=cdtTemplateCommonTable, cdtTemplateTargetStatus=cdtTemplateTargetStatus, cdtIfIpv6NdRaIntervalMax=cdtIfIpv6NdRaIntervalMax, cdtPppIpcpMaskOption=cdtPppIpcpMaskOption, cdtPppGroup=cdtPppGroup, cdtEthernetMacAddr=cdtEthernetMacAddr, cdtIfIpv6NdReachableTime=cdtIfIpv6NdReachableTime, cdtIfIpv6NdRaLife=cdtIfIpv6NdRaLife, cdtEthernetValid=cdtEthernetValid, cdtIfIpv6NdPrefixLength=cdtIfIpv6NdPrefixLength, cdtCommonSrvNetflow=cdtCommonSrvNetflow, cdtSrvMulticast=cdtSrvMulticast, cdtTemplateTargetStorage=cdtTemplateTargetStorage, cdtIfIpv6NdDadAttempts=cdtIfIpv6NdDadAttempts, cdtTemplateTargetType=cdtTemplateTargetType, cdtEthernetBridgeDomain=cdtEthernetBridgeDomain, cdtIfIpv6NdRouterPreference=cdtIfIpv6NdRouterPreference, cdtTemplateAssociationName=cdtTemplateAssociationName, cdtTemplateUsageTargetType=cdtTemplateUsageTargetType, cdtPppLoopbackIgnore=cdtPppLoopbackIgnore, cdtIfIpv6SubEnable=cdtIfIpv6SubEnable, cdtCommonIpv4AccessGroup=cdtCommonIpv4AccessGroup, cdtBaseGroup=cdtBaseGroup, cdtService=cdtService, cdtIfIpv4TcpMssAdjust=cdtIfIpv4TcpMssAdjust, cdtPppPapOpts=cdtPppPapOpts, cdtPppEapIdentity=cdtPppEapIdentity, cdtIpSubscriber=cdtIpSubscriber)
