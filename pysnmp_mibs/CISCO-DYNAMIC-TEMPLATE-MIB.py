...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-DYNAMIC-TEMPLATE-MIB
...
DynamicTemplateTargetType, DynamicTemplateName, DynamicTemplateTargetId, DynamicTemplateType = mibBuilder.importSymbols("CISCO-DYNAMIC-TEMPLATE-TC-MIB", "DynamicTemplateTargetType", "DynamicTemplateName", "DynamicTemplateTargetId", "DynamicTemplateType")
UnicastRpfType, UnicastRpfOptions = mibBuilder.importSymbols("CISCO-IP-URPF-MIB", "UnicastRpfType", "UnicastRpfOptions")
...
mibBuilder.exportSymbols("CISCO-DYNAMIC-TEMPLATE-MIB", cdtTemplateTargetStatus=cdtTemplateTargetStatus, cdtIfIpv6NdPreferredLife=cdtIfIpv6NdPreferredLife, cdtTemplateAssociationEntry=cdtTemplateAssociationEntry, cdtIfIpv4SubEnable=cdtIfIpv4SubEnable, cdtPppMaxTerminate=cdtPppMaxTerminate, cdtBaseGroup=cdtBaseGroup, cdtCommonSrvQos=cdtCommonSrvQos, cdtPppTimeoutRetry=cdtPppTimeoutRetry, cdtIpSubscriber=cdtIpSubscriber, cdtTemplateCommonEntry=cdtTemplateCommonEntry, cdtEthernetValid=cdtEthernetValid, cdtPppTemplateTable=cdtPppTemplateTable, cdtPppMsChapV1Password=cdtPppMsChapV1Password, cdtPppPeerDefIpAddrOpts=cdtPppPeerDefIpAddrOpts, cdtIfMtu=cdtIfMtu, cdtSrvTemplateTable=cdtSrvTemplateTable, cdtPppMaxBadAuth=cdtPppMaxBadAuth, cdtSrvGroup=cdtSrvGroup, cdtEthernetIpv4PointToPoint=cdtEthernetIpv4PointToPoint, cdtCommonIpv6Unreachables=cdtCommonIpv6Unreachables, cdtPppPeerIpAddrPoolStorage=cdtPppPeerIpAddrPoolStorage, cdtIfIpv6Enable=cdtIfIpv6Enable, cdtIfIpv6VerifyUniRpf=cdtIfIpv6VerifyUniRpf, cdtEthernetTemplateEntry=cdtEthernetTemplateEntry, cdtPppMsChapV1Hostname=cdtPppMsChapV1Hostname, cdtEthernetMacAddr=cdtEthernetMacAddr, cdtPppIpcpWinsSecondary=cdtPppIpcpWinsSecondary, cdtCommonKeepaliveRetries=cdtCommonKeepaliveRetries, cdtCommonSrvNetflow=cdtCommonSrvNetflow, cdtCommonVrf=cdtCommonVrf, ciscoDynamicTemplateMIBNotifs=ciscoDynamicTemplateMIBNotifs, cdtPppIpcpDnsSecondary=cdtPppIpcpDnsSecondary, cdtCommonIpv4AccessGroup=cdtCommonIpv4AccessGroup, cdtIfIpv6VerifyUniRpfAcl=cdtIfIpv6VerifyUniRpfAcl, cdtIfIpv6NdReachableTime=cdtIfIpv6NdReachableTime, cdtPppAccounting=cdtPppAccounting, cdtIfIpv4VerifyUniRpfAcl=cdtIfIpv4VerifyUniRpfAcl, cdtPppAuthenticationMethods=cdtPppAuthenticationMethods, cdtTemplateCommonTable=cdtTemplateCommonTable, cdtPppAuthentication=cdtPppAuthentication, cdtIfIpv6NdRaIntervalUnits=cdtIfIpv6NdRaIntervalUnits, cdtIfValid=cdtIfValid, ciscoDynamicTemplateR1Compliance=ciscoDynamicTemplateR1Compliance, cdtPppIpcpMask=cdtPppIpcpMask, cdtEthernetTemplateTable=cdtEthernetTemplateTable, cdtIfIpv6NdPrefixLength=cdtIfIpv6NdPrefixLength, cdtPppPeerIpAddrPoolName=cdtPppPeerIpAddrPoolName, ciscoDynamicTemplateMIBConform=ciscoDynamicTemplateMIBConform, cdtPppEapIdentity=cdtPppEapIdentity, cdtIfIpv6VerifyUniRpfOpts=cdtIfIpv6VerifyUniRpfOpts, cdtTemplateAssociationName=cdtTemplateAssociationName, cdtEthernetGroup=cdtEthernetGroup, cdtCommonDescr=cdtCommonDescr, cdtTemplateTargetType=cdtTemplateTargetType, cdtPppPapOpts=cdtPppPapOpts, cdtTemplateAssociationTable=cdtTemplateAssociationTable, cdtPppLoopbackIgnore=cdtPppLoopbackIgnore, cdtService=cdtService, cdtIfIpv4VerifyUniRpfOpts=cdtIfIpv4VerifyUniRpfOpts, cdtPppMsChapV1Opts=cdtPppMsChapV1Opts, cdtPppEapOpts=cdtPppEapOpts, cdtTemplateUsageTable=cdtTemplateUsageTable, cdtIfIpv6NdRaIntervalMin=cdtIfIpv6NdRaIntervalMin, cdtPppIpcpAddrOption=cdtPppIpcpAddrOption, cdtIfIpv4TcpMssAdjust=cdtIfIpv4TcpMssAdjust, cdtPppPeerDefIpAddrSrc=cdtPppPeerDefIpAddrSrc, cdtBase=cdtBase, ciscoDynamicTemplateMIBObjects=ciscoDynamicTemplateMIBObjects, cdtSrvVpdnGroup=cdtSrvVpdnGroup, cdtIfIpv6TcpMssAdjust=cdtIfIpv6TcpMssAdjust, cdtPppIpcpDnsOption=cdtPppIpcpDnsOption, ciscoDynamicTemplateMIBCompliances=ciscoDynamicTemplateMIBCompliances, cdtIfIpv6SubEnable=cdtIfIpv6SubEnable, cdtIfIpv4Mtu=cdtIfIpv4Mtu, cdtSubscriberGroup=cdtSubscriberGroup, cdtPppTimeoutAuthentication=cdtPppTimeoutAuthentication, cdtPppChapHostname=cdtPppChapHostname, cdtIfIpv6NdValidLife=cdtIfIpv6NdValidLife, cdtPppMsChapV2Password=cdtPppMsChapV2Password, cdtPppPeerDefIpAddr=cdtPppPeerDefIpAddr, cdtPppPapUsername=cdtPppPapUsername, cdtIfGroup=cdtIfGroup, cdtCommonIf=cdtCommonIf, cdtTemplateUsageCount=cdtTemplateUsageCount, cdtCommonAddrPool=cdtCommonAddrPool, cdtPppTemplateEntry=cdtPppTemplateEntry, cdtTemplateTargetTable=cdtTemplateTargetTable, cdtPppIpcpMaskOption=cdtPppIpcpMaskOption, cdtSrvSgSrvGroup=cdtSrvSgSrvGroup, cdtCommonKeepaliveInt=cdtCommonKeepaliveInt, cdtTemplateTargetId=cdtTemplateTargetId, cdtTemplateUsageTargetId=cdtTemplateUsageTargetId, cdtCommonSrvRedirect=cdtCommonSrvRedirect, cdtPppIpcpWinsPrimary=cdtPppIpcpWinsPrimary, cdtIfFlowMonitor=cdtIfFlowMonitor, cdtIfCdpEnable=cdtIfCdpEnable, cdtIfIpv6NdOpts=cdtIfIpv6NdOpts, cdtTemplateStatus=cdtTemplateStatus, cdtPppMsChapV2Opts=cdtPppMsChapV2Opts, cdtTemplateUsageTargetType=cdtTemplateUsageTargetType, cdtPppChapOpts=cdtPppChapOpts, cdtTemplateTargetStorage=cdtTemplateTargetStorage, cdtEthernetPppoeEnable=cdtEthernetPppoeEnable, cdtIfTemplateEntry=cdtIfTemplateEntry, cdtPppChapPassword=cdtPppChapPassword, cdtSrvSgSrvType=cdtSrvSgSrvType, cdtPppPeerIpAddrPoolTable=cdtPppPeerIpAddrPoolTable, cdtIfTemplateTable=cdtIfTemplateTable, cdtIfIpv6NdRaIntervalMax=cdtIfIpv6NdRaIntervalMax, cdtCommonValid=cdtCommonValid, cdtIfIpv6NdDadAttempts=cdtIfIpv6NdDadAttempts, cdtPppPeerIpAddrPoolPriority=cdtPppPeerIpAddrPoolPriority, ciscoDynamicTemplateMIB=ciscoDynamicTemplateMIB, cdtCommonSrvSubControl=cdtCommonSrvSubControl, cdtSrvNetworkSrv=cdtSrvNetworkSrv, cdtTemplateType=cdtTemplateType, cdtCommonIpv6AccessGroup=cdtCommonIpv6AccessGroup, cdtPppIpcpWinsOption=cdtPppIpcpWinsOption, cdtSrvValid=cdtSrvValid, cdtPppEapPassword=cdtPppEapPassword, cdtTemplateSrc=cdtTemplateSrc, cdtPppMaxConfigure=cdtPppMaxConfigure, PYSNMP_MODULE_ID=ciscoDynamicTemplateMIB, cdtPppIpcpDnsPrimary=cdtPppIpcpDnsPrimary, cdtIfIpv4Unnumbered=cdtIfIpv4Unnumbered, cdtIfIpv6NdRouterPreference=cdtIfIpv6NdRouterPreference, cdtCommonIpv4Unreachables=cdtCommonIpv4Unreachables, cdtTemplateEntry=cdtTemplateEntry, cdtPppAuthorization=cdtPppAuthorization, cdtIfIpv6NdPrefix=cdtIfIpv6NdPrefix, cdtTemplateTargetEntry=cdtTemplateTargetEntry, cdtEthernetBridgeDomain=cdtEthernetBridgeDomain, ciscoDynamicTemplateMIBGroups=ciscoDynamicTemplateMIBGroups, cdtPppPapPassword=cdtPppPapPassword, cdtIfIpv6NdRaLife=cdtIfIpv6NdRaLife, cdtEthernet=cdtEthernet, cdtIfIpv6NdNsInterval=cdtIfIpv6NdNsInterval, cdtPpp=cdtPpp, cdtPppValid=cdtPppValid, cdtPppPeerIpAddrPoolStatus=cdtPppPeerIpAddrPoolStatus, cdtSrvMulticast=cdtSrvMulticast, cdtPppMsChapV2Hostname=cdtPppMsChapV2Hostname, cdtIfIpv4VerifyUniRpf=cdtIfIpv4VerifyUniRpf, cdtTemplateUsageEntry=cdtTemplateUsageEntry, cdtPppGroup=cdtPppGroup, cdtTemplateStorage=cdtTemplateStorage, cdtPppMaxFailure=cdtPppMaxFailure, cdtPppPeerIpAddrPoolEntry=cdtPppPeerIpAddrPoolEntry, cdtTemplateName=cdtTemplateName, cdtTemplateAssociationPrecedence=cdtTemplateAssociationPrecedence, cdtCommonGroup=cdtCommonGroup, cdtCommonSrvAcct=cdtCommonSrvAcct, cdtSrvTemplateEntry=cdtSrvTemplateEntry, cdtTemplateTable=cdtTemplateTable)
