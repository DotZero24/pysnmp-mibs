# SNMP MIB module (SUPERMICRO-IPV6-MLD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-IPV6-MLD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:01:58 2025
...
fsmldNoOfCacheEntries = _FsmldNoOfCacheEntries_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 70, 1, 1),
...
fsmldNoOfRoutingProtocols = _FsmldNoOfRoutingProtocols_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 70, 1, 2),
...
fsmldTraceDebug = _FsmldTraceDebug_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 70, 1, 3),
...
fsmldMode = _FsmldMode_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 70, 1, 4),
    _FsmldMode_Type()
)
...
fsmldProtocolUpDown = _FsmldProtocolUpDown_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 70, 1, 5),
