...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/radlan/MARVELL-LBD-MIB
...
rlLbd.setRevisions(('2015-05-29 00:00', '2007-11-07 00:00',))
if mibBuilder.loadTexts: rlLbd.setLastUpdated('201505290000Z')
...
rlLbdDetectionInterval = MibScalar((1, 3, 6, 1, 4, 1, 89, 127, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 60))).setUnits('seconds').setMaxAccess("readwrite")
if mibBuilder.loadTexts: rlLbdDetectionInterval.setStatus('current')
rlLbdMode = MibScalar((1, 3, 6, 1, 4, 1, 89, 127, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("source-mac-addr", 1), ("base-mac-addr", 2), ("multicast-mac-addr", 3), ("broadcast-mac-addr", 4)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("MARVELL-LBD-MIB", rlLbdPortTable=rlLbdPortTable, rlLbdEnable=rlLbdEnable, rlLbd=rlLbd, rlLbdPortEntry=rlLbdPortEntry, rlLbdPortOperStatus=rlLbdPortOperStatus, PYSNMP_MODULE_ID=rlLbd, rlLbdDetectionInterval=rlLbdDetectionInterval, rlLbdMode=rlLbdMode, rlLbdPortAdminStatus=rlLbdPortAdminStatus)
