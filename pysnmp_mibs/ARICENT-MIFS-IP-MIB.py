# SNMP MIB module (ARICENT-MIFS-IP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MIFS-IP-MIB
...
fsMIFsIpTraceConfigEntry = _FsMIFsIpTraceConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 3, 1)
)
fsMIFsIpTraceConfigEntry.setIndexNames(
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpTraceConfigDest"),
)
if mibBuilder.loadTexts:
...
fsMIFsIpAddressEntry = _FsMIFsIpAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 5, 1)
)
fsMIFsIpAddressEntry.setIndexNames(
    (0, "ARICENT-MISTD-IPVX-MIB", "fsMIStdIpContextId"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpAddrTabAddress"),
)
if mibBuilder.loadTexts:
...
fsMIFsIpRtrLstEntry = _FsMIFsIpRtrLstEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 6, 1)
)
fsMIFsIpRtrLstEntry.setIndexNames(
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpRtrLstAddress"),
)
if mibBuilder.loadTexts:
...
fsMIFsIpPathMtuEntry = _FsMIFsIpPathMtuEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 7, 1)
)
fsMIFsIpPathMtuEntry.setIndexNames(
    (0, "ARICENT-MISTD-IPVX-MIB", "fsMIStdIpContextId"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpPmtuDestination"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpPmtuTos"),
)
if mibBuilder.loadTexts:
...
fsMIFsIpCommonRoutingEntry = _FsMIFsIpCommonRoutingEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 8, 1)
)
fsMIFsIpCommonRoutingEntry.setIndexNames(
    (0, "ARICENT-MISTD-IPVX-MIB", "fsMIStdIpContextId"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpRouteDest"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpRouteMask"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpRouteTos"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpRouteNextHop"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpRouteProto"),
)
if mibBuilder.loadTexts:
...
fsMIFsIcmpDirectQueryEnable = _FsMIFsIcmpDirectQueryEnable_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 10, 1, 10),
...
fsMIFsIcmpDomainName = _FsMIFsIcmpDomainName_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 10, 1, 11),
...
fsMIFsIcmpTimeToLive = _FsMIFsIcmpTimeToLive_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 10, 1, 12),
...
fsMIFsIcmpInSecurityFailures = _FsMIFsIcmpInSecurityFailures_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 10, 1, 13),
...
fsMIFsIcmpOutSecurityFailures = _FsMIFsIcmpOutSecurityFailures_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 10, 1, 14),
...
fsMIFsIcmpSendSecurityFailuresEnable = _FsMIFsIcmpSendSecurityFailuresEnable_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 10, 1, 15),
...
fsMIFsIcmpRecvSecurityFailuresEnable = _FsMIFsIcmpRecvSecurityFailuresEnable_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 10, 1, 16),
...
fsMIFsIpCidrAggEntry = _FsMIFsIpCidrAggEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 12, 1)
)
fsMIFsIpCidrAggEntry.setIndexNames(
    (0, "ARICENT-MISTD-IPVX-MIB", "fsMIStdIpContextId"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpCidrAggAddress"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIpCidrAggAddressMask"),
)
if mibBuilder.loadTexts:
...
fsMIFsCidrAdvertEntry = _FsMIFsCidrAdvertEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 13, 1)
)
fsMIFsCidrAdvertEntry.setIndexNames(
    (0, "ARICENT-MISTD-IPVX-MIB", "fsMIStdIpContextId"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsCidrAdvertAddress"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsCidrAdvertAddressMask"),
)
if mibBuilder.loadTexts:
...
fsMIFsIrdpIfConfEntry = _FsMIFsIrdpIfConfEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 19, 1)
)
fsMIFsIrdpIfConfEntry.setIndexNames(
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIrdpIfConfIfNum"),
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsIrdpIfConfSubref"),
)
if mibBuilder.loadTexts:
...
fsMIFsRarpServerDatabaseEntry = _FsMIFsRarpServerDatabaseEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 38, 26, 1)
)
fsMIFsRarpServerDatabaseEntry.setIndexNames(
    (0, "ARICENT-MIFS-IP-MIB", "fsMIFsHardwareAddress"),
)
if mibBuilder.loadTexts:
