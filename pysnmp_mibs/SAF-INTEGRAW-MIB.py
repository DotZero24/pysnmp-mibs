...
mibBuilder.exportSymbols("SAF-INTEGRAW-MIB", integraWsysLicenseGenStatus=integraWsysLicenseGenStatus, integraWneedStore=integraWneedStore, integraWmodemRxModulation=integraWmodemRxModulation, integraWmodemRxCapacity=integraWmodemRxCapacity, integraWifPortSyncEthPrio=integraWifPortSyncEthPrio, integraWradioTxMuteDuration=integraWradioTxMuteDuration, integraWradio=integraWradio, PYSNMP_MODULE_ID=integraW, integraWnetCfgRemoteIPaddress=integraWnetCfgRemoteIPaddress, integraWmodemBandwidth=integraWmodemBandwidth, integraW=integraW, integraWtxOsizeFrames=integraWtxOsizeFrames, integraWifPortPhysAddress=integraWifPortPhysAddress, integraWrxDropped=integraWrxDropped, integraWtxVlanFrames=integraWtxVlanFrames, integraWCompliances=integraWCompliances, integraWmodemSyncLoss=integraWmodemSyncLoss, integraWtxAlignErrors=integraWtxAlignErrors, integraWifPortSyncEthActive=integraWifPortSyncEthActive, integraWexecuteConfig=integraWexecuteConfig, integraWsysBoardTemperature=integraWsysBoardTemperature, integraWradioTxFrequency=integraWradioTxFrequency, integraWradioRangeTxPower=integraWradioRangeTxPower, integraWtxSingleCollisions=integraWtxSingleCollisions, integraWifPortStcEntry=integraWifPortStcEntry, integraWtxDropped=integraWtxDropped, integraWrxOsizeFrames=integraWrxOsizeFrames, integraWrxPauseFrames=integraWrxPauseFrames, integraWRadioGroup=integraWRadioGroup, integraWsystem=integraWsystem, integraWifStatisticsTable=integraWifStatisticsTable, integraWradioRangeEntryIndex=integraWradioRangeEntryIndex, integraWrxVlanFrames=integraWrxVlanFrames, integraWrxMcastFrames=integraWrxMcastFrames, integraWsysPSUcurrent=integraWsysPSUcurrent, integraWnetCfgIPaddress=integraWnetCfgIPaddress, integraWrxBcastFrames=integraWrxBcastFrames, integraWtxPauseFrames=integraWtxPauseFrames, integraWtxUsizeFrames=integraWtxUsizeFrames, integraWifPortAutoneg=integraWifPortAutoneg, integraWrxDetected=integraWrxDetected, integraWifPortOperStatus=integraWifPortOperStatus, integraWifPortEntry=integraWifPortEntry, integraWtxExcessCollisions=integraWtxExcessCollisions, integraWtimestamp=integraWtimestamp, integraWtxGoodFrames=integraWtxGoodFrames, integraWConformance=integraWConformance, integraWModemGroup=integraWModemGroup, integraWradioSide=integraWradioSide, integraWtxExcessDeferral=integraWtxExcessDeferral, integraWrxFrameErrors=integraWrxFrameErrors, integraWtx512to1023Frames=integraWtx512to1023Frames, integraWnetCfgIPmask=integraWnetCfgIPmask, integraWifPortStcDescr=integraWifPortStcDescr, integraWtxCollisions=integraWtxCollisions, integraWsysCPUidle=integraWsysCPUidle, integraWifPortFlowControl=integraWifPortFlowControl, integraWradioRangeEntry=integraWradioRangeEntry, integraWtx128to255Frames=integraWtx128to255Frames, integraWrxOpErrors=integraWrxOpErrors, integraWtxMultiCollisions=integraWtxMultiCollisions, integraWtxDetected=integraWtxDetected, integraWradioRxLevelState=integraWradioRxLevelState, integraWifPortType=integraWifPortType, integraWmodemAcquireStatus=integraWmodemAcquireStatus, integraWrxCntrlFrames=integraWrxCntrlFrames, integraWradioTxMute=integraWradioTxMute, integraWtxMcastFrames=integraWtxMcastFrames, integraWMiscGroup=integraWMiscGroup, integraWmodem=integraWmodem, integraWGroups=integraWGroups, integraWrxBytes=integraWrxBytes, integraWrx1024toMaxFrames=integraWrx1024toMaxFrames, integraWrxFifoErr=integraWrxFifoErr, integraWradioTxPower=integraWradioTxPower, integraWifTimePassed=integraWifTimePassed, integraWtxUrunErrors=integraWtxUrunErrors, integraWradioRangeTxFrequency=integraWradioRangeTxFrequency, integraWmodemAcmEngine=integraWmodemAcmEngine, integraWifPortStcIndex=integraWifPortStcIndex, integraWrxCRCErrors=integraWrxCRCErrors, integraWifPortStatDescr=integraWifPortStatDescr, integraWsysLicenseExpire=integraWsysLicenseExpire, integraWtxErrors=integraWtxErrors, integraWsysPSUvoltage=integraWsysPSUvoltage, integraWsysPSUpower=integraWsysPSUpower, integraWCompliance=integraWCompliance, integraWtxFifoErr=integraWtxFifoErr, integraWSystemGroup=integraWSystemGroup, integraWtxCarrierErrors=integraWtxCarrierErrors, integraWsysCPUtemperature=integraWsysCPUtemperature, integraWradioPLL=integraWradioPLL, integraWrxLenErrors=integraWrxLenErrors, integraWrx65to127Frames=integraWrx65to127Frames, integraWEthernetGeneralGroup=integraWEthernetGeneralGroup, integraWtxBcastFrames=integraWtxBcastFrames, integraWrx256to511Frames=integraWrx256to511Frames, integraWrx512to1023Frames=integraWrx512to1023Frames, integraWsysFreeMemory=integraWsysFreeMemory, integraWmodemTxCapacity=integraWmodemTxCapacity, integraWstoreConfig=integraWstoreConfig, integraWmodemFecLoad=integraWmodemFecLoad, integraWtxDeferred=integraWtxDeferred, integraWtxLateCollisions=integraWtxLateCollisions, integraWifStatusTable=integraWifStatusTable, integraWtx1024toMaxFrames=integraWtx1024toMaxFrames, integraWradioDuplexShift=integraWradioDuplexShift, integraWrxGoodFrames=integraWrxGoodFrames, integraWradioRxFrequency=integraWradioRxFrequency, integraWtx65to127Frames=integraWtx65to127Frames, integraWethernet=integraWethernet, integraWifPortAdminStatus=integraWifPortAdminStatus, integraWifPortMtu=integraWifPortMtu, integraWrx64Frames=integraWrx64Frames, integraWtx64Frames=integraWtx64Frames, integraWifPortDuplex=integraWifPortDuplex, integraWrx128to255Frames=integraWrx128to255Frames, integraWmodemSignalQuality=integraWmodemSignalQuality, integraWnetCfg=integraWnetCfg, integraWmodemTxModulation=integraWmodemTxModulation, integraWrxUsizeFrames=integraWrxUsizeFrames, integraWradioRangeDescr=integraWradioRangeDescr, integraWtxCntrlFrames=integraWtxCntrlFrames, integraWmodemModulation=integraWmodemModulation, integraWnetCfgIPgateway=integraWnetCfgIPgateway, integraWEthernetMiiPortGroup=integraWEthernetMiiPortGroup, integraWradioTemperature=integraWradioTemperature, integraWtxBytes=integraWtxBytes, integraWifPortStatIndex=integraWifPortStatIndex, integraWtx256to511Frames=integraWtx256to511Frames, integraWmodemMse=integraWmodemMse, integraWifPortLastChange=integraWifPortLastChange, integraWifPortSpeed=integraWifPortSpeed, integraWrxErrors=integraWrxErrors, integraWradioRangesTable=integraWradioRangesTable, integraWradioRxLevel=integraWradioRxLevel)
