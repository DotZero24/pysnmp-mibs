...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FSPF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:00 2025
...
_FspfRegionId_Type.__name__ = "FspfRegionId"
...
_FspfNbrStateChangeNotifyEnable_Type.__name__ = "TruthValue"
...
fspfMIBCompliance.setObjects(
      *(("CISCO-FSPF-MIB", "fspfGenericGroup"),
        ("CISCO-FSPF-MIB", "fspfIfGroup"),
        ("CISCO-FSPF-MIB", "fspfDatabaseGroup"),
        ("CISCO-FSPF-MIB", "fspfNotificationGroup"))
)
if mibBuilder.loadTexts:
...
fspfMIBCompliance1.setObjects(
      *(("CISCO-FSPF-MIB", "fspfGenericGroupRev1"),
        ("CISCO-FSPF-MIB", "fspfIfGroup"),
        ("CISCO-FSPF-MIB", "fspfDatabaseGroup"),
        ("CISCO-FSPF-MIB", "fspfNotificationGroup"))
)
...
fspfMIBCompliance2.setObjects(
      *(("CISCO-FSPF-MIB", "fspfGenericGroupRev1"),
        ("CISCO-FSPF-MIB", "fspfIfGroup"),
        ("CISCO-FSPF-MIB", "fspfDatabaseGroupRev1"),
        ("CISCO-FSPF-MIB", "fspfNotificationGroup"))
)
if mibBuilder.loadTexts:
...
fspfMIBCompliance3.setObjects(
      *(("CISCO-FSPF-MIB", "fspfGenericGroupRev1"),
        ("CISCO-FSPF-MIB", "fspfIfGroup"),
        ("CISCO-FSPF-MIB", "fspfDatabaseGroupRev2"),
        ("CISCO-FSPF-MIB", "fspfNotificationGroup"))
)
if mibBuilder.loadTexts:
