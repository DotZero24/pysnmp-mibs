...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/ciscosb/CISCOSB-CDP-MIB
...
if mibBuilder.loadTexts: rlCdp.setLastUpdated('201603300000Z')
...
rlCdpTlvPowerRequestTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 137, 21), )
if mibBuilder.loadTexts: rlCdpTlvPowerRequestTable.setStatus('current')
rlCdpTlvPowerRequestEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 137, 21, 1), ).setIndexNames((0, "CISCOSB-CDP-MIB", "rlCdpTlvIfIndex"), (0, "CISCOSB-CDP-MIB", "rlCdpTlvPowerRequestPowerLevelIndex"))
if mibBuilder.loadTexts: rlCdpTlvPowerRequestEntry.setStatus('current')
rlCdpTlvPowerRequestPowerLevelIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 137, 21, 1, 2), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 2147483647)))
...
rlCdpSecondaryCacheAddressTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 137, 22), )
if mibBuilder.loadTexts: rlCdpSecondaryCacheAddressTable.setStatus('current')
rlCdpSecondaryCacheAddressEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 137, 22, 1), ).setIndexNames((0, "CISCO-CDP-MIB", "cdpCacheIfIndex"), (0, "CISCO-CDP-MIB", "cdpCacheDeviceIndex"), (0, "CISCOSB-CDP-MIB", "rlCdpSecondaryCacheAddressIndex"))
if mibBuilder.loadTexts: rlCdpSecondaryCacheAddressEntry.setStatus('current')
rlCdpSecondaryCacheAddressIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 137, 22, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 2147483647)))
...
rlCdpSecondaryCacheRequestedPowerTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 137, 23), )
if mibBuilder.loadTexts: rlCdpSecondaryCacheRequestedPowerTable.setStatus('current')
rlCdpSecondaryCacheRequestedPowerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 137, 23, 1), ).setIndexNames((0, "CISCO-CDP-MIB", "cdpCacheIfIndex"), (0, "CISCO-CDP-MIB", "cdpCacheDeviceIndex"), (0, "CISCOSB-CDP-MIB", "rlCdpSecondaryCacheRequestedPowerIndex"))
if mibBuilder.loadTexts: rlCdpSecondaryCacheRequestedPowerEntry.setStatus('current')
rlCdpSecondaryCacheRequestedPowerIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 137, 23, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 2147483647)))
