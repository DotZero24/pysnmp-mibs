...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-ATM-CONN-MIB
...
atmVclVci, atmVclVpi, AtmTrafficDescrParamIndex, atmVplVpi = mibBuilder.importSymbols("ATM-MIB", "atmVclVci", "atmVclVpi", "AtmTrafficDescrParamIndex", "atmVplVpi")
...
mibBuilder.exportSymbols("CISCO-ATM-CONN-MIB", ciscoAtmSvpAddrTable=ciscoAtmSvpAddrTable, ciscoAtmVplRemoteAddr=ciscoAtmVplRemoteAddr, ciscoAtmVplInClp0Cells=ciscoAtmVplInClp0Cells, ciscoAtmSvcVpi=ciscoAtmSvcVpi, ciscoAtmSvcAddrTable=ciscoAtmSvcAddrTable, ciscoAtmVclRemoteVci=ciscoAtmVclRemoteVci, ciscoAtmVplCrossVpi=ciscoAtmVplCrossVpi, ciscoAtmVplLocation=ciscoAtmVplLocation, ConnState=ConnState, ciscoAtmSnoopVcDir=ciscoAtmSnoopVcDir, ciscoAtmConnMIBlsPerVcqGroup2=ciscoAtmConnMIBlsPerVcqGroup2, ciscoAtmVclConnType=ciscoAtmVclConnType, ciscoAtmVplEpdTpdPacketDrops=ciscoAtmVplEpdTpdPacketDrops, ciscoAtmSvcFrameDiscardUsesAal5Ie=ciscoAtmSvcFrameDiscardUsesAal5Ie, ciscoAtmVplOamEndLoopback=ciscoAtmVplOamEndLoopback, ciscoAtmVplOutCells=ciscoAtmVplOutCells, ciscoAtmVclRemoteAddr=ciscoAtmVclRemoteAddr, ciscoAtmSvcDirection=ciscoAtmSvcDirection, ciscoAtmConnMIBCompliance8=ciscoAtmConnMIBCompliance8, ciscoAtmVplDefaultRxUpcVbrCdvt=ciscoAtmVplDefaultRxUpcVbrCdvt, ciscoAtmVclOamEndLoopback=ciscoAtmVclOamEndLoopback, ciscoAtmConnMIBlsPerVcqGroup=ciscoAtmConnMIBlsPerVcqGroup, ciscoAtmSnoopVpSnoopedIfIndex=ciscoAtmSnoopVpSnoopedIfIndex, ciscoAtmVclInClp1Cells=ciscoAtmVclInClp1Cells, ciscoAtmVclVcqClpThreshCellDrops=ciscoAtmVclVcqClpThreshCellDrops, ciscoAtmVclRemoteVpi=ciscoAtmVclRemoteVpi, ciscoAtmConnMIBCompliance4=ciscoAtmConnMIBCompliance4, ciscoAtmSvpVpi=ciscoAtmSvpVpi, ciscoAtmSvcVci=ciscoAtmSvcVci, ciscoAtmConnMIBCompliance2=ciscoAtmConnMIBCompliance2, ciscoAtmVclOamRdiEnable=ciscoAtmVclOamRdiEnable, ciscoAtmVclAalEncapProtocol=ciscoAtmVclAalEncapProtocol, ciscoAtmSnoopVpDir=ciscoAtmSnoopVpDir, ciscoAtmVplSwFabOutCells=ciscoAtmVplSwFabOutCells, ciscoAtmVclCrossIfIndex=ciscoAtmVclCrossIfIndex, CastType=CastType, ciscoAtmVclCrossVci=ciscoAtmVclCrossVci, ciscoAtmVplClp0VcqFullCellDrops=ciscoAtmVplClp0VcqFullCellDrops, ciscoAtmVclTxNegTraffDescrIndex=ciscoAtmVclTxNegTraffDescrIndex, ciscoAtmVclSwFabOutClp1Cells=ciscoAtmVclSwFabOutClp1Cells, ciscoAtmVclCrossVpi=ciscoAtmVclCrossVpi, ciscoAtmVclInClp0Cells=ciscoAtmVclInClp0Cells, ciscoAtmVclEpdTpdCellDrops=ciscoAtmVclEpdTpdCellDrops, ciscoAtmVclNextLeafIfIndex=ciscoAtmVclNextLeafIfIndex, ciscoAtmConnMIBCompliance6=ciscoAtmConnMIBCompliance6, ciscoAtmConnMIBCompliance=ciscoAtmConnMIBCompliance, ciscoAtmConnMIBGroup2=ciscoAtmConnMIBGroup2, SpanType=SpanType, ciscoAtmVplNextLeafIfIndex=ciscoAtmVplNextLeafIfIndex, ciscoAtmVplLsPerVcqWrrWeight=ciscoAtmVplLsPerVcqWrrWeight, ciscoAtmVclNumAttempts=ciscoAtmVclNumAttempts, ciscoAtmSvpAddr=ciscoAtmSvpAddr, EnableStatus=EnableStatus, Location=Location, ciscoAtmSnoopVcTable=ciscoAtmSnoopVcTable, ciscoAtmVplSwFabOutClp1Cells=ciscoAtmVplSwFabOutClp1Cells, ciscoAtmVclOamAisEnable=ciscoAtmVclOamAisEnable, ciscoAtmVplEpdTpdCellDrops=ciscoAtmVplEpdTpdCellDrops, ciscoAtmConnMIBCompliance3=ciscoAtmConnMIBCompliance3, ciscoAtmConnMIBNegTraffGroup=ciscoAtmConnMIBNegTraffGroup, ciscoAtmVplSlowRetryIntv=ciscoAtmVplSlowRetryIntv, ciscoAtmVplLsPerVcqTunnelIsHierarchical=ciscoAtmVplLsPerVcqTunnelIsHierarchical, ciscoAtmVplOamSegmentLoopback=ciscoAtmVplOamSegmentLoopback, ciscoAtmVclTable=ciscoAtmVclTable, ciscoAtmConnMIBGroup4=ciscoAtmConnMIBGroup4, ciscoAtmSvp=ciscoAtmSvp, Direction=Direction, ciscoAtmVplInCells=ciscoAtmVplInCells, UpcStatus=UpcStatus, ciscoAtmVclRxUpcMode=ciscoAtmVclRxUpcMode, ciscoAtmConnMIBGroup3=ciscoAtmConnMIBGroup3, ciscoAtmVclOamSegmentLoopback=ciscoAtmVclOamSegmentLoopback, ciscoAtmVplRxUpcMode=ciscoAtmVplRxUpcMode, ciscoAtmVplLsPerVcqTunnelIsShaped=ciscoAtmVplLsPerVcqTunnelIsShaped, ciscoAtmVclInCells=ciscoAtmVclInCells, ciscoAtmVclAalUserVcType=ciscoAtmVclAalUserVcType, ciscoAtmVplOamAisEnable=ciscoAtmVplOamAisEnable, ciscoAtmVclNextLeafVpi=ciscoAtmVclNextLeafVpi, ciscoAtmSnoopVpEntry=ciscoAtmSnoopVpEntry, ciscoAtmSnoopVcEntry=ciscoAtmSnoopVcEntry, ciscoAtmVclOutClp1Cells=ciscoAtmVclOutClp1Cells, ciscoAtmVplSwFabOutClp0Cells=ciscoAtmVplSwFabOutClp0Cells, ciscoAtmVclConnName=ciscoAtmVclConnName, ciscoAtmVplCastType=ciscoAtmVplCastType, ciscoAtmVplDefaultRxUpcTolerance=ciscoAtmVplDefaultRxUpcTolerance, ciscoAtmVclCastType=ciscoAtmVclCastType, ciscoAtmVclAtmInArpInterval=ciscoAtmVclAtmInArpInterval, ciscoAtmVplOamLoopbkTxInterval=ciscoAtmVplOamLoopbkTxInterval, ciscoAtmVcl=ciscoAtmVcl, ciscoAtmSnoopVcSnoopedVci=ciscoAtmSnoopVcSnoopedVci, ciscoAtmConnMIBlsFcPfqGroup=ciscoAtmConnMIBlsFcPfqGroup, ciscoAtmSnoopVp=ciscoAtmSnoopVp, ciscoAtmVclClp1Drops=ciscoAtmVclClp1Drops, ciscoAtmVplEntry=ciscoAtmVplEntry, ciscoAtmVplConnState=ciscoAtmVplConnState, ciscoAtmVplCellDrops=ciscoAtmVplCellDrops, ciscoAtmVclOamLoopbkTxInterval=ciscoAtmVclOamLoopbkTxInterval, ciscoAtmVclAalEncapFlag=ciscoAtmVclAalEncapFlag, ciscoAtmVplOutClp1Cells=ciscoAtmVplOutClp1Cells, SnoopDirType=SnoopDirType, ciscoAtmVclConfigType=ciscoAtmVclConfigType, ciscoAtmVclEpdTpdPacketDrops=ciscoAtmVclEpdTpdPacketDrops, ciscoAtmVplTable=ciscoAtmVplTable, ciscoAtmConnMIB=ciscoAtmConnMIB, ciscoAtmVclLsPerVcqXmtQueuedCells=ciscoAtmVclLsPerVcqXmtQueuedCells, ciscoAtmVplInClp1Cells=ciscoAtmVplInClp1Cells, ciscoAtmConnMIBGroups=ciscoAtmConnMIBGroups, ciscoAtmVplCrossIfIndex=ciscoAtmVplCrossIfIndex, ciscoAtmConnNmsGroup=ciscoAtmConnNmsGroup, PYSNMP_MODULE_ID=ciscoAtmConnMIB, ciscoAtmVplInstallTime=ciscoAtmVplInstallTime, ciscoAtmVplNumAttempts=ciscoAtmVplNumAttempts, ciscoAtmVclRxNegTraffDescrIndex=ciscoAtmVclRxNegTraffDescrIndex, ciscoAtmVplOutClp0Cells=ciscoAtmVplOutClp0Cells, ciscoAtmConnMIBlsFcPfqGroup1=ciscoAtmConnMIBlsFcPfqGroup1, ConfigType=ConfigType, ciscoAtmVclLsPerVcqWrrWeight=ciscoAtmVclLsPerVcqWrrWeight, ciscoAtmVclLsPerVcQThreshGrp=ciscoAtmVclLsPerVcQThreshGrp, ciscoAtmVclLastReleaseCause=ciscoAtmVclLastReleaseCause, ciscoAtmVclDefaultRxUpcVbrCdvt=ciscoAtmVclDefaultRxUpcVbrCdvt, ciscoAtmSvc=ciscoAtmSvc, ciscoAtmVplVcqClpThreshCellDrops=ciscoAtmVplVcqClpThreshCellDrops, ciscoAtmVclSlowRetryIntv=ciscoAtmVclSlowRetryIntv, ciscoAtmSnoopVcSnoopedVpi=ciscoAtmSnoopVcSnoopedVpi, ciscoAtmVclClp0VcqFullCellDrops=ciscoAtmVclClp0VcqFullCellDrops, ciscoAtmVclSwFabOutCells=ciscoAtmVclSwFabOutCells, ciscoAtmSvcAddrEntry=ciscoAtmSvcAddrEntry, ciscoAtmVclOutCells=ciscoAtmVclOutCells, ciscoAtmConnMIBGroup1=ciscoAtmConnMIBGroup1, ciscoAtmVclInstallTime=ciscoAtmVclInstallTime, ciscoAtmSnoopVpRowStatus=ciscoAtmSnoopVpRowStatus, ciscoAtmConnMIBGroup=ciscoAtmConnMIBGroup, ciscoAtmVclEntry=ciscoAtmVclEntry, ciscoAtmVplConfigType=ciscoAtmVplConfigType, ciscoAtmConnMIBObjects=ciscoAtmConnMIBObjects, ciscoAtmConnMIBCompliances=ciscoAtmConnMIBCompliances, ciscoAtmSnoopVpSnoopedVpi=ciscoAtmSnoopVpSnoopedVpi, ciscoAtmVplLogicalPortIndex=ciscoAtmVplLogicalPortIndex, ciscoAtmSnoopVcSnoopedIfIndex=ciscoAtmSnoopVcSnoopedIfIndex, ciscoAtmVplUpcViolations=ciscoAtmVplUpcViolations, ciscoAtmVplRemoteVpi=ciscoAtmVplRemoteVpi, ciscoAtmVclEpdEnable=ciscoAtmVclEpdEnable, ciscoAtmVclDefaultRxUpcTolerance=ciscoAtmVclDefaultRxUpcTolerance, ciscoAtmSnoopVcRowStatus=ciscoAtmSnoopVcRowStatus, ciscoAtmVplClp1Drops=ciscoAtmVplClp1Drops, ciscoAtmSvcAddr=ciscoAtmSvcAddr, ciscoAtmConnMIBCompliance7=ciscoAtmConnMIBCompliance7, ciscoAtmVplLsPerVcQThreshGrp=ciscoAtmVplLsPerVcQThreshGrp, ciscoAtmVplLastReleaseCause=ciscoAtmVplLastReleaseCause, ciscoAtmSnoopVc=ciscoAtmSnoopVc, ciscoAtmVclNextLeafVci=ciscoAtmVclNextLeafVci, ciscoAtmVplConnName=ciscoAtmVplConnName, ciscoAtmVplNextLeafVpi=ciscoAtmVplNextLeafVpi, ciscoAtmVplSpanType=ciscoAtmVplSpanType, ciscoAtmVplEpdTpdPacketsIn=ciscoAtmVplEpdTpdPacketsIn, ciscoAtmVplRxNegTraffDescrIndex=ciscoAtmVplRxNegTraffDescrIndex, ciscoAtmVclLocation=ciscoAtmVclLocation, ciscoAtmVclOutClp0Cells=ciscoAtmVclOutClp0Cells, ciscoAtmSvpAddrEntry=ciscoAtmSvpAddrEntry, ciscoAtmSnoopVcState=ciscoAtmSnoopVcState, ciscoAtmVplConnType=ciscoAtmVplConnType, ciscoAtmVclUpcViolations=ciscoAtmVclUpcViolations, ciscoAtmVpl=ciscoAtmVpl, ciscoAtmVclConnState=ciscoAtmVclConnState, ciscoAtmSnoopVpTable=ciscoAtmSnoopVpTable, ciscoAtmVclSwFabOutClp0Cells=ciscoAtmVclSwFabOutClp0Cells, ciscoAtmConnMIBCompliance5=ciscoAtmConnMIBCompliance5, ciscoAtmVclCellDrops=ciscoAtmVclCellDrops, ciscoAtmConnMIBConformance=ciscoAtmConnMIBConformance, ciscoAtmSvpDirection=ciscoAtmSvpDirection, ciscoAtmVplOamRdiEnable=ciscoAtmVplOamRdiEnable, ciscoAtmVplLogicalPortDef=ciscoAtmVplLogicalPortDef, ciscoAtmVclSpanType=ciscoAtmVclSpanType, ciscoAtmVclEpdTpdPacketsIn=ciscoAtmVclEpdTpdPacketsIn, ciscoAtmVplLsPerVcqXmtQueuedCells=ciscoAtmVplLsPerVcqXmtQueuedCells, ciscoAtmSnoopVpState=ciscoAtmSnoopVpState, ciscoAtmVplTxNegTraffDescrIndex=ciscoAtmVplTxNegTraffDescrIndex)
