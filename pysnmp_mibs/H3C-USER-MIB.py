...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/h3c/H3C-USER-MIB
...
h3cUser.setRevisions(('2016-11-19 00:00',))
if mibBuilder.loadTexts: h3cUser.setLastUpdated('201611190000Z')
if mibBuilder.loadTexts: h3cUser.setOrganization('Hangzhou H3C Technologies Co., Ltd.')
...
h3cUserName = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 12, 1, 1, 1, 1), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 255))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: h3cUserName.setStatus('current')
h3cUserPassword = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 12, 1, 1, 1, 2), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 255))).setMaxAccess("readcreate")
...
h3cUserGroup = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 12, 1, 2, 1, 17), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 255))).setMaxAccess("readwrite")
...
h3cUserIfIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 12, 1, 2, 1, 22), Integer32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: h3cUserIfIndex.setStatus('current')
...
h3cUserRole = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 12, 1, 6, 1, 1), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 63)))
...
h3cUserGroupName = MibTableColumn((1, 3, 6, 1, 4, 1, 2011, 10, 2, 12, 2, 1, 1, 1), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 255)))
...
mibBuilder.exportSymbols("H3C-USER-MIB", h3cUserPassword=h3cUserPassword, h3cFtpService=h3cFtpService, h3cUserAttributeTable=h3cUserAttributeTable, h3cUserObjects=h3cUserObjects, h3cUserGroupInfoRowStatus=h3cUserGroupInfoRowStatus, h3cUserInfoEntry=h3cUserInfoEntry, h3cSlotNum=h3cSlotNum, h3cUserGroupInfoTable=h3cUserGroupInfoTable, h3cUserGroupInfoEntry=h3cUserGroupInfoEntry, h3cUserLevel=h3cUserLevel, h3cUserMaxNum=h3cUserMaxNum, h3cIPAddress=h3cIPAddress, h3cSubSlotNum=h3cSubSlotNum, h3cUserState=h3cUserState, h3cUserIndexIndicator=h3cUserIndexIndicator, h3cTelnetService=h3cTelnetService, h3cIdleCut=h3cIdleCut, h3cUserInfoTable=h3cUserInfoTable, h3cUserGroupName=h3cUserGroupName, h3cMacAddress=h3cMacAddress, h3cUserIfIndex=h3cUserIfIndex, h3cAuthMode=h3cAuthMode, h3cUserRoleStatus=h3cUserRoleStatus, h3cUserAttributeEntry=h3cUserAttributeEntry, h3cNasIPAddress=h3cNasIPAddress, h3cPPPService=h3cPPPService, h3cSshService=h3cSshService, h3cHttpService=h3cHttpService, h3cUserInfoRowStatus=h3cUserInfoRowStatus, h3cPortalService=h3cPortalService, h3cUserName=h3cUserName, h3cAccessLimit=h3cAccessLimit, h3cUser=h3cUser, h3cUserGroupObjects=h3cUserGroupObjects, h3cUserGroup=h3cUserGroup, h3cHttpsService=h3cHttpsService, h3cVlan=h3cVlan, h3cUserIndex=h3cUserIndex, h3cPortNum=h3cPortNum, h3cLanAccessService=h3cLanAccessService, h3cUserRoleEntry=h3cUserRoleEntry, h3cUserRole=h3cUserRole, h3cFtpDirectory=h3cFtpDirectory, ServiceType=ServiceType, h3cTerminalService=h3cTerminalService, PYSNMP_MODULE_ID=h3cUser, h3cUserRoleTable=h3cUserRoleTable, h3cExpirationDate=h3cExpirationDate, h3cUserCurrNum=h3cUserCurrNum)
