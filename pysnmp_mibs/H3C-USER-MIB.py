...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-USER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:19:26 2025
...
class _H3cUserName_Type(DisplayString):
    """Custom type h3cUserName based on DisplayString"""
...
_H3cUserName_Type.__name__ = "DisplayString"
...
class _H3cUserPassword_Type(DisplayString):
    """Custom type h3cUserPassword based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cUserPassword_Type.__name__ = "DisplayString"
...
class _H3cUserGroup_Type(DisplayString):
    """Custom type h3cUserGroup based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cUserGroup_Type.__name__ = "DisplayString"
...
h3cUserIfIndex = _H3cUserIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 12, 1, 2, 1, 22),
    _H3cUserIfIndex_Type()
)
h3cUserIfIndex.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cUserIfIndex.setStatus("current")
