...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-NAC-NAD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:56 2025
...
_CnnEouAuthIpStorageType_Type.__name__ = "StorageType"
...
_CnnEouAuthMacStorageType_Type.__name__ = "StorageType"
...
_CnnEouAuthDeviceTypeStorageType_Type.__name__ = "StorageType"
...
_CnnEouHostQueryInterface_Type.__name__ = "InterfaceIndexOrZero"
...
_CnnEouHostQueryIpAddrType_Type.__name__ = "InetAddressType"
...
_CnnEouHostQueryIpAddr_Type.__name__ = "InetAddress"
...
_CnnEouHostQueryMacAddr_Type.__name__ = "MacAddress"
...
_CnnEouHostQueryPostureToken_Type.__name__ = "CnnEouPostureToken"
...
ciscoNacNadMIBCompliance.setObjects(
      *(("CISCO-NAC-NAD-MIB", "ciscoNacNadEouGlobalGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouAuthIpGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfConfigGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouHostGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfTimeoutGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfMaxRetryGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouRateLimitGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfAdminGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouAuthMacGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouAuthDeviceTypeGrp"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouHostAgeGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouHostUrlRedir"),
...
ciscoNacNadMIBCompliance2.setObjects(
      *(("CISCO-NAC-NAD-MIB", "ciscoNacNadEouGlobalGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouAuthIpGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfConfigGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouHostGrp"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfTimeoutGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfMaxRetryGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouRateLimitGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfAdminGroup"),
        ...
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouHostUrlRedir"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouHostAclGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfAaaFailPolicyGrp"),
        ("CISCO-NAC-NAD-MIB", "cnnIpDeviceTrackingConfigGrp"),
        ("CISCO-NAC-NAD-MIB", "cnnEouCriticalRecoveryDelayGrp"))
)
if mibBuilder.loadTexts:
...
ciscoNacNadMIBCompliance3.setObjects(
      *(("CISCO-NAC-NAD-MIB", "ciscoNacNadEouGlobalGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouAuthIpGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfConfigGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouHostGrp"),
        ...
        ("CISCO-NAC-NAD-MIB", "cnnIpDeviceTrackingConfigGrp"),
        ("CISCO-NAC-NAD-MIB", "cnnEouCriticalRecoveryDelayGrp"),
        ("CISCO-NAC-NAD-MIB", "cnnEouIfIpDevTrackConfigGrp"))
)
if mibBuilder.loadTexts:
...
ciscoNacNadMIBCompliance4.setObjects(
      *(("CISCO-NAC-NAD-MIB", "ciscoNacNadEouGlobalGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouAuthIpGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfConfigGroup"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouHostGrp"),
        ...
        ("CISCO-NAC-NAD-MIB", "cnnEouCriticalRecoveryDelayGrp"),
        ("CISCO-NAC-NAD-MIB", "cnnEouIfIpDevTrackConfigGrp"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadRevalidateConfigGrp"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouHostGroup1"),
        ("CISCO-NAC-NAD-MIB", "ciscoNacNadEouIfExtGroup"))
)
if mibBuilder.loadTexts:
