# SNMP MIB module (FASTPATH-QOS-COS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-QOS-COS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:08:26 2025
...
agentCosMapIpPrecEntry.setIndexNames(
    (0, "FASTPATH-QOS-COS-MIB", "agentCosMapIpPrecIntfIndex"),
    (0, "FASTPATH-QOS-COS-MIB", "agentCosMapIpPrecValue"),
)
if mibBuilder.loadTexts:
...
agentCosMapIpDscpEntry.setIndexNames(
    (0, "FASTPATH-QOS-COS-MIB", "agentCosMapIpDscpIntfIndex"),
    (0, "FASTPATH-QOS-COS-MIB", "agentCosMapIpDscpValue"),
)
if mibBuilder.loadTexts:
...
agentCosMapIntfTrustEntry.setIndexNames(
    (0, "FASTPATH-QOS-COS-MIB", "agentCosMapIntfTrustIntfIndex"),
)
if mibBuilder.loadTexts:
...
agentCosQueueControlEntry.setIndexNames(
    (0, "FASTPATH-QOS-COS-MIB", "agentCosQueueIntfIndex"),
)
if mibBuilder.loadTexts:
...
agentCosQueueEntry.setIndexNames(
    (0, "FASTPATH-QOS-COS-MIB", "agentCosQueueIntfIndex"),
    (0, "FASTPATH-QOS-COS-MIB", "agentCosQueueIndex"),
)
if mibBuilder.loadTexts:
...
agentCosQueueMgmtEntry.setIndexNames(
    (0, "FASTPATH-QOS-COS-MIB", "agentCosQueueIntfIndex"),
    (0, "FASTPATH-QOS-COS-MIB", "agentCosQueueIndex"),
    (0, "FASTPATH-QOS-COS-MIB", "agentCosQueueDropPrecIndex"),
)
if mibBuilder.loadTexts:
