...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:48:54 2025
...
SipTCMethodName, SipTCTransportProtocol, SipTCEntityRole, SipTCOptionTagHeaders = mibBuilder.importSymbols("SIP-TC-MIB", "SipTCMethodName", "SipTCTransportProtocol", "SipTCEntityRole", "SipTCOptionTagHeaders")
...
mibBuilder.exportSymbols("SIP-COMMON-MIB", sipCommonNotifApplIndex=sipCommonNotifApplIndex, sipCommonStatusCodeNotifSend=sipCommonStatusCodeNotifSend, sipCommonStatusCodeNotif=sipCommonStatusCodeNotif, sipCommonServiceColdStart=sipCommonServiceColdStart, sipCommonStatusCodeNotifInterval=sipCommonStatusCodeNotifInterval, sipCommonOptionTagHeaderField=sipCommonOptionTagHeaderField, sipCommonMethodStatsInbounds=sipCommonMethodStatsInbounds, sipCommonStatusCodeThreshExceededInNotif=sipCommonStatusCodeThreshExceededInNotif, sipCommonStatusCodeNotifEntry=sipCommonStatusCodeNotifEntry, sipCommonStatusCodeThreshExceededOutNotif=sipCommonStatusCodeThreshExceededOutNotif, sipCommonSummaryDisconTime=sipCommonSummaryDisconTime, sipCommonSummaryOutRequests=sipCommonSummaryOutRequests, sipCommonStatsRetries=sipCommonStatsRetries, sipCommonStatusCodeNotifGroup=sipCommonStatusCodeNotifGroup, sipCommonMethodStats=sipCommonMethodStats, sipCommonStatsRetryDisconTime=sipCommonStatsRetryDisconTime, sipCommonCfgTimerT1=sipCommonCfgTimerT1, sipCommonMethodStatsTable=sipCommonMethodStatsTable, sipCommonMethodStatsDisconTime=sipCommonMethodStatsDisconTime, sipCommonCfgServiceOperStatus=sipCommonCfgServiceOperStatus, sipCommonSummaryTotalTransactions=sipCommonSummaryTotalTransactions, sipCommonCfgServiceStartTime=sipCommonCfgServiceStartTime, sipCommonSummaryStatsEntry=sipCommonSummaryStatsEntry, sipCommonStatusCodeOuts=sipCommonStatusCodeOuts, sipCommonStatusCode=sipCommonStatusCode, sipCommonOptionTagIndex=sipCommonOptionTagIndex, sipCommonOtherStatsNumUnsupportedMethods=sipCommonOtherStatsNumUnsupportedMethods, sipCommonStatusCodeNotifCallId=sipCommonStatusCodeNotifCallId, sipCommonCfgServiceNotifEnable=sipCommonCfgServiceNotifEnable, sipCommonInformationalGroup=sipCommonInformationalGroup, sipCommonCfgMaxTransactions=sipCommonCfgMaxTransactions, sipCommonOtherStatsEntry=sipCommonOtherStatsEntry, sipCommonConfigGroup=sipCommonConfigGroup, sipCommonStatsGroup=sipCommonStatsGroup, sipCommonCfgTimerH=sipCommonCfgTimerH, sipCommonStatusCodeNotifCSeq=sipCommonStatusCodeNotifCSeq, sipCommonStatusCodeRowStatus=sipCommonStatusCodeRowStatus, sipCommonStatsRetryGroup=sipCommonStatsRetryGroup, sipCommonPortTable=sipCommonPortTable, sipCommonCfgServiceLastChange=sipCommonCfgServiceLastChange, sipCommonTransCurrentactions=sipCommonTransCurrentactions, sipCommonPortEntry=sipCommonPortEntry, sipCommonOptionTagEntry=sipCommonOptionTagEntry, sipCommonCfgTable=sipCommonCfgTable, sipCommonCfgTimerT4=sipCommonCfgTimerT4, sipCommonSummaryOutResponses=sipCommonSummaryOutResponses, sipCommonOptionTagTable=sipCommonOptionTagTable, sipCommonOtherStatsNumUnsupportedUris=sipCommonOtherStatsNumUnsupportedUris, sipCommonCfgTimerK=sipCommonCfgTimerK, sipCommonStatusCodeNotifFrom=sipCommonStatusCodeNotifFrom, sipCommonCfgTimer=sipCommonCfgTimer, sipCommonCfgTimerT2=sipCommonCfgTimerT2, sipCommonOtherStatsOtherwiseDiscardedMsgs=sipCommonOtherStatsOtherwiseDiscardedMsgs, sipCommonCfgTimerD=sipCommonCfgTimerD, sipCommonNotifObjects=sipCommonNotifObjects, sipCommonStatsRetryFinalResponses=sipCommonStatsRetryFinalResponses, sipCommonCfgProtocolVersion=sipCommonCfgProtocolVersion, sipCommonCfgOrganization=sipCommonCfgOrganization, sipCommonNotifObjectsGroup=sipCommonNotifObjectsGroup, sipCommonSummaryStats=sipCommonSummaryStats, sipCommonStatsTrans=sipCommonStatsTrans, sipCommonTransCurrentTable=sipCommonTransCurrentTable, sipCommonCfgTimerE=sipCommonCfgTimerE, sipCommonPort=sipCommonPort, sipCommonOtherStatsTable=sipCommonOtherStatsTable, sipCommonOtherStats=sipCommonOtherStats, PYSNMP_MODULE_ID=sipCommonMIB, sipCommonCfgTimerI=sipCommonCfgTimerI, sipCommonStatsRetryEntry=sipCommonStatsRetryEntry, sipCommonCfgTimerTable=sipCommonCfgTimerTable, sipCommonSummaryStatsTable=sipCommonSummaryStatsTable, sipCommonCfgTimerA=sipCommonCfgTimerA, sipCommonCfgTimerJ=sipCommonCfgTimerJ, sipCommonNotifSequenceNumber=sipCommonNotifSequenceNumber, sipCommonCfgTimerF=sipCommonCfgTimerF, sipCommonMethodStatsEntry=sipCommonMethodStatsEntry, sipCommonStatsRetryNonFinalResponses=sipCommonStatsRetryNonFinalResponses, sipCommonServiceWarmStart=sipCommonServiceWarmStart, sipCommonNotifGroup=sipCommonNotifGroup, sipCommonStatusCodeMethod=sipCommonStatusCodeMethod, sipCommonStatusCodeNotifEmitMode=sipCommonStatusCodeNotifEmitMode, sipCommonServiceStatusChanged=sipCommonServiceStatusChanged, sipCommonPortTransportRcv=sipCommonPortTransportRcv, sipCommonStatsRetryMethod=sipCommonStatsRetryMethod, sipCommonStatsRetry=sipCommonStatsRetry, sipCommonMIBGroups=sipCommonMIBGroups, sipCommonMIBNotifications=sipCommonMIBNotifications, sipCommonMIBConformance=sipCommonMIBConformance, sipCommonCfgBase=sipCommonCfgBase, sipCommonMethodSupportedName=sipCommonMethodSupportedName, sipCommonMethodSupportedTable=sipCommonMethodSupportedTable, sipCommonCfgTimerB=sipCommonCfgTimerB, sipCommonCfgTimerEntry=sipCommonCfgTimerEntry, sipCommonStatusCodeDisconTime=sipCommonStatusCodeDisconTime, sipCommonStatusCodeNotifTo=sipCommonStatusCodeNotifTo, sipCommonStatusCodeValue=sipCommonStatusCodeValue, sipCommonMethodSupportedIndex=sipCommonMethodSupportedIndex, sipCommonOptionTag=sipCommonOptionTag, sipCommonMIBCompliances=sipCommonMIBCompliances, sipCommonStatusCodeEntry=sipCommonStatusCodeEntry, sipCommonSummaryInRequests=sipCommonSummaryInRequests, sipCommonMIBObjects=sipCommonMIBObjects, sipCommonCfgEntityType=sipCommonCfgEntityType, sipCommonCompliance=sipCommonCompliance, sipCommonMethodStatsName=sipCommonMethodStatsName, sipCommonCfgTimerC=sipCommonCfgTimerC, sipCommonStatsRetryTable=sipCommonStatsRetryTable, sipCommonStatusCodeIns=sipCommonStatusCodeIns, sipCommonMethodSupportedEntry=sipCommonMethodSupportedEntry, sipCommonSummaryInResponses=sipCommonSummaryInResponses, sipCommonMethodStatsOutbounds=sipCommonMethodStatsOutbounds, sipCommonCfgEntry=sipCommonCfgEntry, sipCommonStatusCodeNotifThresh=sipCommonStatusCodeNotifThresh, sipCommonStatusCodeNotifTable=sipCommonStatusCodeNotifTable, sipCommonConfigTimerGroup=sipCommonConfigTimerGroup, sipCommonCfgTimerG=sipCommonCfgTimerG, sipCommonOtherStatsDisconTime=sipCommonOtherStatsDisconTime, sipCommonStatusCodeTable=sipCommonStatusCodeTable, sipCommonTransCurrentEntry=sipCommonTransCurrentEntry, sipCommonMIB=sipCommonMIB)
