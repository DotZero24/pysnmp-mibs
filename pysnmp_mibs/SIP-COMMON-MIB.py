...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/SIP-COMMON-MIB
...
SipTCEntityRole, SipTCMethodName, SipTCTransportProtocol, SipTCOptionTagHeaders = mibBuilder.importSymbols("SIP-TC-MIB", "SipTCEntityRole", "SipTCMethodName", "SipTCTransportProtocol", "SipTCOptionTagHeaders")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
ModuleIdentity, Counter64, Integer32, Gauge32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, MibIdentifier, TimeTicks, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "Gauge32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "Bits", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("SIP-COMMON-MIB", sipCommonMethodStatsOutbounds=sipCommonMethodStatsOutbounds, sipCommonCfgTimerEntry=sipCommonCfgTimerEntry, sipCommonStatusCodeNotifTo=sipCommonStatusCodeNotifTo, sipCommonCfgTimerG=sipCommonCfgTimerG, sipCommonStatusCodeNotifSend=sipCommonStatusCodeNotifSend, sipCommonCfgTimerT4=sipCommonCfgTimerT4, sipCommonMethodSupportedIndex=sipCommonMethodSupportedIndex, sipCommonCfgServiceLastChange=sipCommonCfgServiceLastChange, sipCommonCfgTable=sipCommonCfgTable, sipCommonCfgOrganization=sipCommonCfgOrganization, sipCommonStatusCodeNotifFrom=sipCommonStatusCodeNotifFrom, sipCommonServiceStatusChanged=sipCommonServiceStatusChanged, sipCommonStatusCodeValue=sipCommonStatusCodeValue, sipCommonStatsRetryGroup=sipCommonStatsRetryGroup, sipCommonConfigGroup=sipCommonConfigGroup, sipCommonMethodStatsTable=sipCommonMethodStatsTable, sipCommonStatsTrans=sipCommonStatsTrans, sipCommonMethodStatsInbounds=sipCommonMethodStatsInbounds, sipCommonPortTable=sipCommonPortTable, sipCommonStatsRetryFinalResponses=sipCommonStatsRetryFinalResponses, sipCommonMethodStatsDisconTime=sipCommonMethodStatsDisconTime, sipCommonOptionTagEntry=sipCommonOptionTagEntry, sipCommonStatsRetry=sipCommonStatsRetry, sipCommonSummaryDisconTime=sipCommonSummaryDisconTime, sipCommonSummaryStatsEntry=sipCommonSummaryStatsEntry, sipCommonOtherStats=sipCommonOtherStats, sipCommonCfgTimerI=sipCommonCfgTimerI, sipCommonCfgBase=sipCommonCfgBase, sipCommonSummaryTotalTransactions=sipCommonSummaryTotalTransactions, sipCommonNotifObjects=sipCommonNotifObjects, sipCommonMIBGroups=sipCommonMIBGroups, sipCommonConfigTimerGroup=sipCommonConfigTimerGroup, sipCommonMIBConformance=sipCommonMIBConformance, sipCommonCfgTimerT1=sipCommonCfgTimerT1, sipCommonOptionTagTable=sipCommonOptionTagTable, sipCommonCfgTimerF=sipCommonCfgTimerF, sipCommonStatusCodeOuts=sipCommonStatusCodeOuts, sipCommonCfgTimerA=sipCommonCfgTimerA, sipCommonSummaryOutRequests=sipCommonSummaryOutRequests, sipCommonOtherStatsNumUnsupportedMethods=sipCommonOtherStatsNumUnsupportedMethods, sipCommonStatusCodeMethod=sipCommonStatusCodeMethod, sipCommonStatsRetryDisconTime=sipCommonStatsRetryDisconTime, sipCommonOtherStatsDisconTime=sipCommonOtherStatsDisconTime, sipCommonCfgTimerK=sipCommonCfgTimerK, sipCommonStatusCodeEntry=sipCommonStatusCodeEntry, sipCommonStatusCodeNotifEmitMode=sipCommonStatusCodeNotifEmitMode, sipCommonCfgTimerC=sipCommonCfgTimerC, sipCommonMIBNotifications=sipCommonMIBNotifications, sipCommonOptionTagIndex=sipCommonOptionTagIndex, sipCommonSummaryOutResponses=sipCommonSummaryOutResponses, sipCommonCfgTimerJ=sipCommonCfgTimerJ, sipCommonMethodSupportedEntry=sipCommonMethodSupportedEntry, sipCommonStatusCodeNotifCSeq=sipCommonStatusCodeNotifCSeq, sipCommonMIBCompliances=sipCommonMIBCompliances, sipCommonSummaryInResponses=sipCommonSummaryInResponses, sipCommonStatsRetryTable=sipCommonStatsRetryTable, sipCommonMIB=sipCommonMIB, sipCommonStatusCodeThreshExceededOutNotif=sipCommonStatusCodeThreshExceededOutNotif, sipCommonCfgTimerTable=sipCommonCfgTimerTable, sipCommonMIBObjects=sipCommonMIBObjects, sipCommonSummaryStatsTable=sipCommonSummaryStatsTable, sipCommonInformationalGroup=sipCommonInformationalGroup, sipCommonTransCurrentactions=sipCommonTransCurrentactions, sipCommonCfgServiceNotifEnable=sipCommonCfgServiceNotifEnable, sipCommonStatusCodeNotifThresh=sipCommonStatusCodeNotifThresh, sipCommonPortEntry=sipCommonPortEntry, sipCommonCfgEntityType=sipCommonCfgEntityType, sipCommonMethodSupportedName=sipCommonMethodSupportedName, sipCommonStatsGroup=sipCommonStatsGroup, sipCommonStatusCodeRowStatus=sipCommonStatusCodeRowStatus, sipCommonNotifApplIndex=sipCommonNotifApplIndex, sipCommonCfgProtocolVersion=sipCommonCfgProtocolVersion, sipCommonCfgTimerH=sipCommonCfgTimerH, sipCommonStatusCodeNotifInterval=sipCommonStatusCodeNotifInterval, sipCommonStatusCodeNotifGroup=sipCommonStatusCodeNotifGroup, sipCommonServiceColdStart=sipCommonServiceColdStart, sipCommonStatusCodeNotifCallId=sipCommonStatusCodeNotifCallId, sipCommonStatusCodeIns=sipCommonStatusCodeIns, sipCommonStatusCodeThreshExceededInNotif=sipCommonStatusCodeThreshExceededInNotif, sipCommonCfgTimerE=sipCommonCfgTimerE, sipCommonStatusCodeNotif=sipCommonStatusCodeNotif, sipCommonOtherStatsNumUnsupportedUris=sipCommonOtherStatsNumUnsupportedUris, sipCommonCfgEntry=sipCommonCfgEntry, PYSNMP_MODULE_ID=sipCommonMIB, sipCommonOtherStatsOtherwiseDiscardedMsgs=sipCommonOtherStatsOtherwiseDiscardedMsgs, sipCommonMethodSupportedTable=sipCommonMethodSupportedTable, sipCommonStatusCodeNotifTable=sipCommonStatusCodeNotifTable, sipCommonCfgServiceOperStatus=sipCommonCfgServiceOperStatus, sipCommonSummaryInRequests=sipCommonSummaryInRequests, sipCommonOptionTagHeaderField=sipCommonOptionTagHeaderField, sipCommonCfgTimer=sipCommonCfgTimer, sipCommonPortTransportRcv=sipCommonPortTransportRcv, sipCommonStatsRetryMethod=sipCommonStatsRetryMethod, sipCommonTransCurrentEntry=sipCommonTransCurrentEntry, sipCommonNotifGroup=sipCommonNotifGroup, sipCommonCfgTimerD=sipCommonCfgTimerD, sipCommonStatusCodeNotifEntry=sipCommonStatusCodeNotifEntry, sipCommonStatsRetryEntry=sipCommonStatsRetryEntry, sipCommonStatusCode=sipCommonStatusCode, sipCommonCfgMaxTransactions=sipCommonCfgMaxTransactions, sipCommonMethodStatsEntry=sipCommonMethodStatsEntry, sipCommonCfgServiceStartTime=sipCommonCfgServiceStartTime, sipCommonOtherStatsTable=sipCommonOtherStatsTable, sipCommonMethodStats=sipCommonMethodStats, sipCommonCfgTimerB=sipCommonCfgTimerB, sipCommonTransCurrentTable=sipCommonTransCurrentTable, sipCommonStatsRetryNonFinalResponses=sipCommonStatsRetryNonFinalResponses, sipCommonStatsRetries=sipCommonStatsRetries, sipCommonPort=sipCommonPort, sipCommonCompliance=sipCommonCompliance, sipCommonNotifObjectsGroup=sipCommonNotifObjectsGroup, sipCommonMethodStatsName=sipCommonMethodStatsName, sipCommonOtherStatsEntry=sipCommonOtherStatsEntry, sipCommonOptionTag=sipCommonOptionTag, sipCommonStatusCodeTable=sipCommonStatusCodeTable, sipCommonNotifSequenceNumber=sipCommonNotifSequenceNumber, sipCommonServiceWarmStart=sipCommonServiceWarmStart, sipCommonCfgTimerT2=sipCommonCfgTimerT2, sipCommonSummaryStats=sipCommonSummaryStats, sipCommonStatusCodeDisconTime=sipCommonStatusCodeDisconTime)
