...
mibBuilder.exportSymbols("HOTWIRE-MSDSL-INTERFACE-MIB", msdslFarEndTotalIfIndex=msdslFarEndTotalIfIndex, msdslG703WorstIntervalIfIndex=msdslG703WorstIntervalIfIndex, msdslFracPortVoiceData=msdslFracPortVoiceData, msdslIntervalFEBEs=msdslIntervalFEBEs, msdsldsx1WorstIntervalESs=msdsldsx1WorstIntervalESs, msdslFracPortIfTS=msdslFracPortIfTS, msdslIntervalNumber=msdslIntervalNumber, msdslWorstInterval=msdslWorstInterval, msdslFarEndCurrentESs=msdslFarEndCurrentESs, msdslTestOver=msdslTestOver, msdslMarginNormal=msdslMarginNormal, msdslFracPortTS=msdslFracPortTS, msdsldsx1WorstIntervalUASs=msdsldsx1WorstIntervalUASs, msdslFarEndIntervalTable=msdslFarEndIntervalTable, msdslTotalTable=msdslTotalTable, msdslWorstIntervalFEBEs=msdslWorstIntervalFEBEs, msdslCurrentESs=msdslCurrentESs, msdslG703WorstIntervalTable=msdslG703WorstIntervalTable, msdslFracPortIfIndex=msdslFracPortIfIndex, msdslCurrentPerfRxGain=msdslCurrentPerfRxGain, msdslPerfPayloadRate=msdslPerfPayloadRate, msdslCurrentPerfTxPwr=msdslCurrentPerfTxPwr, msdslFarEndTotalFEBEs=msdslFarEndTotalFEBEs, msdslIntervalIfIndex=msdslIntervalIfIndex, msdslFarEndCurrentPerfTable=msdslFarEndCurrentPerfTable, msdslIntervalPerfTable=msdslIntervalPerfTable, msdslIntervalPerfRxGain=msdslIntervalPerfRxGain, msdslFarEndIntervalEntry=msdslFarEndIntervalEntry, msdslIntervalPerfMargin=msdslIntervalPerfMargin, msdslTotalEntry=msdslTotalEntry, msdslFarEndIntervalNumber=msdslFarEndIntervalNumber, msdslConfiguration=msdslConfiguration, msdslTotalSESs=msdslTotalSESs, msdslErrorRateHigh=msdslErrorRateHigh, msdslFarEndIntervalSESs=msdslFarEndIntervalSESs, msdslG703WorstIntervalBESs=msdslG703WorstIntervalBESs, msdslIntervalEntry=msdslIntervalEntry, msdslG703WorstIntervalEntry=msdslG703WorstIntervalEntry, msdslFarEndTotal=msdslFarEndTotal, msdslCurrentFEBEs=msdslCurrentFEBEs, msdslCurrentPerfMargin=msdslCurrentPerfMargin, msdsldsx1WorstInterval=msdsldsx1WorstInterval, msdslCurrentIfIndex=msdslCurrentIfIndex, msdslG703WorstIntervalSESs=msdslG703WorstIntervalSESs, msdslTimeElapsed=msdslTimeElapsed, msdslCurrentPerf=msdslCurrentPerf, msdslPortConfigAllocMethod=msdslPortConfigAllocMethod, msdslIntervalTable=msdslIntervalTable, msdslFarEndCurrentEntry=msdslFarEndCurrentEntry, msdslFarEndCurrentIfIndex=msdslFarEndCurrentIfIndex, msdsldsx1WorstIntervalBESs=msdsldsx1WorstIntervalBESs, msdslFarEndTotalEntry=msdslFarEndTotalEntry, msdslIntervalPerfNumber=msdslIntervalPerfNumber, msdslFarEndWorstIntervalFEBEs=msdslFarEndWorstIntervalFEBEs, msdslCurrentPerfIfIndex=msdslCurrentPerfIfIndex, msdslFarEndTotalTable=msdslFarEndTotalTable, msdslWorstIntervalESs=msdslWorstIntervalESs, msdslWorstIntervalTable=msdslWorstIntervalTable, msdslCurrentPerfEntry=msdslCurrentPerfEntry, msdslIntervalSESs=msdslIntervalSESs, msdslFarEndCurrentPerfMargin=msdslFarEndCurrentPerfMargin, msdslFarEndIntervalIfIndex=msdslFarEndIntervalIfIndex, msdslIntervalPerfIfIndex=msdslIntervalPerfIfIndex, msdslCurrentTable=msdslCurrentTable, msdslCurrentEntry=msdslCurrentEntry, msdsldsx1WorstIntervalLOFC=msdsldsx1WorstIntervalLOFC, msdslG703WorstIntervalESs=msdslG703WorstIntervalESs, msdslFarEndWorstInterval=msdslFarEndWorstInterval, msdslFarEndTotalESs=msdslFarEndTotalESs, msdslFarEndCurrentPerfIfIndex=msdslFarEndCurrentPerfIfIndex, msdslFarEndWorstIntervalIfIndex=msdslFarEndWorstIntervalIfIndex, msdslValidIntervals=msdslValidIntervals, msdslFarEndCurrentPerfRxGain=msdslFarEndCurrentPerfRxGain, msdslTotalESs=msdslTotalESs, msdslG703WorstInterval=msdslG703WorstInterval, msdslFarEndIntervalPerfTable=msdslFarEndIntervalPerfTable, msdsldsx1WorstIntervalCSSs=msdsldsx1WorstIntervalCSSs, msdslErrValidIntervals=msdslErrValidIntervals, msdslFarEndCurrentPerf=msdslFarEndCurrentPerf, msdsldsx1WorstIntervalEntry=msdsldsx1WorstIntervalEntry, msdslFarEndTotalSESs=msdslFarEndTotalSESs, msdslErrEventsCounter=msdslErrEventsCounter, msdslFarEndWorstIntervalTable=msdslFarEndWorstIntervalTable, msdslFarEndIntervalFEBEs=msdslFarEndIntervalFEBEs, msdslFracTable=msdslFracTable, msdslG703WorstIntervalUASs=msdslG703WorstIntervalUASs, msdslErrorRateNormal=msdslErrorRateNormal, msdslWorstIntervalEntry=msdslWorstIntervalEntry, msdslFarEndIntervalPerfEntry=msdslFarEndIntervalPerfEntry, msdslWorstIntervalSESs=msdslWorstIntervalSESs, msdslFarEndCurrentFEBEs=msdslFarEndCurrentFEBEs, msdslFarEndCurrentPerfTxPwr=msdslFarEndCurrentPerfTxPwr, msdslIntervalPerfTxPwr=msdslIntervalPerfTxPwr, msdslG703WorstIntervalCSSs=msdslG703WorstIntervalCSSs, msdsldsx1WorstIntervalIfIndex=msdsldsx1WorstIntervalIfIndex, msdslInterval=msdslInterval, msdslFarEndWorstIntervalEntry=msdslFarEndWorstIntervalEntry, msdslIntervalPerfEntry=msdslIntervalPerfEntry, msdslFarEndCurrentSESs=msdslFarEndCurrentSESs, msdslPortConfigAllocMethodIfIndex=msdslPortConfigAllocMethodIfIndex, msdslErrTimeElapsed=msdslErrTimeElapsed, msdslIntervalESs=msdslIntervalESs, msdslTotalFEBEs=msdslTotalFEBEs, msdslPortConfigAllocMethodTable=msdslPortConfigAllocMethodTable, msdslFarEndWorstIntervalSESs=msdslFarEndWorstIntervalSESs, msdslFarEndCurrent=msdslFarEndCurrent, msdslFarEndIntervalPerfNumber=msdslFarEndIntervalPerfNumber, msdslMarginLow=msdslMarginLow, msdslFarEndCurrentTable=msdslFarEndCurrentTable, msdslFracEntry=msdslFracEntry, msdslWorstIntervalIfIndex=msdslWorstIntervalIfIndex, msdslFracPortIndex=msdslFracPortIndex, msdslFarEndIntervalPerfTxPwr=msdslFarEndIntervalPerfTxPwr, msdslCurrentPerfTable=msdslCurrentPerfTable, msdslFarEndIntervalESs=msdslFarEndIntervalESs, msdslPortConfigAllocMethodEntry=msdslPortConfigAllocMethodEntry, msdslCurrentSESs=msdslCurrentSESs, msdslDevice=msdslDevice, msdslTotalIfIndex=msdslTotalIfIndex, msdslFarEndCurrentPerfEntry=msdslFarEndCurrentPerfEntry, msdslIntervalPerf=msdslIntervalPerf, msdslFarEndIntervalPerf=msdslFarEndIntervalPerf, msdsldsx1WorstIntervalTable=msdsldsx1WorstIntervalTable, msdslFarEndIntervalPerfRxGain=msdslFarEndIntervalPerfRxGain, msdslTotal=msdslTotal, msdslCurrent=msdslCurrent, msdslFarEndInterval=msdslFarEndInterval, msdslFarEndIntervalPerfIfIndex=msdslFarEndIntervalPerfIfIndex, msdslNTUTypeMismatch=msdslNTUTypeMismatch, msdsldsx1WorstIntervalSESs=msdsldsx1WorstIntervalSESs, msdslG703WorstIntervalLOFC=msdslG703WorstIntervalLOFC, msdslFarEndWorstIntervalESs=msdslFarEndWorstIntervalESs, msdslFarEndIntervalPerfMargin=msdslFarEndIntervalPerfMargin)
