...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DYNAMIC-ARP-INSPECTION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:39:59 2025
...
class _CdaiVlanFilterArpAclName_Type(SnmpAdminString):
    """Custom type cdaiVlanFilterArpAclName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CdaiVlanFilterArpAclName_Type.__name__ = "SnmpAdminString"
...
_CdaiVlanFilterArpAclStatic_Type.__name__ = "TruthValue"
...
_CdaiVlanArpProbeLogging_Type.__name__ = "TruthValue"
...
_CdaiVlanCfgStorageType_Type.__name__ = "StorageType"
...
cdaiMIBCompliance.setObjects(
      *(("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiVlanConfigGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiIfConfigGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiGlobalLoggingGroup"),
...
cdaiMIBCompliance1.setObjects(
      *(("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiVlanCfgGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiIfConfigGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiVlanConfigGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiGlobalLoggingGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiIfRateLimitGroup"),
        ...
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiLogBufferGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiVlanStatisticsGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiVlanExtStatisticsGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiVlanArpProbeGroup"),
        ("CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiLogBufferActionGroup"))
)
if mibBuilder.loadTexts:
