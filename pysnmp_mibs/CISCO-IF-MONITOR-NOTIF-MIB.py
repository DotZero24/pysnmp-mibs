...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IF-MONITOR-NOTIF-MIB
...
cIfMonNotifMIBCompliance.setObjects(
      *(("CISCO-IF-MONITOR-NOTIF-MIB", "cIfMonNotifObjectGroup"),
        ("CISCO-IF-MONITOR-NOTIF-MIB", "cIfMonNotifEventGroup"))
)
if mibBuilder.loadTexts:
