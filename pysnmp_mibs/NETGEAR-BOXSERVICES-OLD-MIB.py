# SNMP MIB module (NETGEAR-BOXSERVICES-OLD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-BOXSERVICES-OLD-MIB
...
boxServicesFansEntry.setIndexNames(
    (0, "NETGEAR-BOXSERVICES-OLD-MIB", "boxServicesFansIndex"),
)
if mibBuilder.loadTexts:
...
boxServicesPowSuppliesEntry.setIndexNames(
    (0, "NETGEAR-BOXSERVICES-OLD-MIB", "boxServicesPowSupplyIndex"),
)
if mibBuilder.loadTexts:
...
boxServicesTempSensorsEntry.setIndexNames(
    (0, "NETGEAR-BOXSERVICES-OLD-MIB", "boxServicesTempSensorIndex"),
)
if mibBuilder.loadTexts:
...
boxServicesCPLDCodeVersion = _BoxServicesCPLDCodeVersion_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 9),
    _BoxServicesCPLDCodeVersion_Type()
)
boxServicesCPLDCodeVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    boxServicesCPLDCodeVersion.setStatus("current")
...
boxsFanStateChange.setObjects(
      *(("NETGEAR-BOXSERVICES-OLD-MIB", "boxServicesFansIndex"),
        ("NETGEAR-BOXSERVICES-OLD-MIB", "boxsItemStateChangeEvent"))
)
if mibBuilder.loadTexts:
...
boxsPowSupplyStateChange.setObjects(
      *(("NETGEAR-BOXSERVICES-OLD-MIB", "boxServicesPowSupplyIndex"),
        ("NETGEAR-BOXSERVICES-OLD-MIB", "boxsItemStateChangeEvent"))
)
if mibBuilder.loadTexts:
...
boxsTemperatureChange.setObjects(
      *(("NETGEAR-BOXSERVICES-OLD-MIB", "boxServicesTempSensorIndex"),
        ("NETGEAR-BOXSERVICES-OLD-MIB", "boxsTemperatureChangeEvent"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"fastPathBoxServices": fastPathBoxServices,
       ...
       "boxServicesCPLDCodeVersion": boxServicesCPLDCodeVersion,
