# SNMP MIB module (T3611-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T3611-MIB
...
trapTest.setObjects(
      *(("T3611-MIB", "sensorName"),
        ("T3611-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
