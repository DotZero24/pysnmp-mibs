...
_E='NETGEAR-DOT1X-AUTHENTICATION-SERVER-MIB'
_D='Integer32'
_C='read-write'
_B='DisplayString'
_A='current'
...
agentDot1xAuthServUserConfigGroup=_AgentDot1xAuthServUserConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,10,49,1))
...
agentDot1xAuthServUserConfigCreate=_AgentDot1xAuthServUserConfigCreate_Object((1,3,6,1,4,1,4526,10,49,1,1),_AgentDot1xAuthServUserConfigCreate_Type())
...
agentDot1xAuthServUserConfigTable=_AgentDot1xAuthServUserConfigTable_Object((1,3,6,1,4,1,4526,10,49,1,2))
...
agentDot1xAuthServUserConfigEntry=_AgentDot1xAuthServUserConfigEntry_Object((1,3,6,1,4,1,4526,10,49,1,2,1))
...
agentDot1xAuthServUserIndex=_AgentDot1xAuthServUserIndex_Object((1,3,6,1,4,1,4526,10,49,1,2,1,1),_AgentDot1xAuthServUserIndex_Type())
...
agentDot1xAuthServUserName=_AgentDot1xAuthServUserName_Object((1,3,6,1,4,1,4526,10,49,1,2,1,2),_AgentDot1xAuthServUserName_Type())
...
agentDot1xAuthServUserPassword=_AgentDot1xAuthServUserPassword_Object((1,3,6,1,4,1,4526,10,49,1,2,1,3),_AgentDot1xAuthServUserPassword_Type())
...
agentDot1xAuthServUserStatus=_AgentDot1xAuthServUserStatus_Object((1,3,6,1,4,1,4526,10,49,1,2,1,4),_AgentDot1xAuthServUserStatus_Type())
