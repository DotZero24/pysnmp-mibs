...
_G='not-accessible'
_F='Integer32'
_E='NETGEAR-RADLAN-SMARTPORTS-MIB'
_D='DisplayString'
_C='read-write'
_B='read-only'
_A='current'
...
rlSmartPortsMacroManageTable=_RlSmartPortsMacroManageTable_Object((1,3,6,1,4,1,4526,17,140,1))
if mibBuilder.loadTexts:rlSmartPortsMacroManageTable.setStatus(_A)
_RlSmartPortsMacroManageEntry_Object=MibTableRow
rlSmartPortsMacroManageEntry=_RlSmartPortsMacroManageEntry_Object((1,3,6,1,4,1,4526,17,140,1,1))
...
rlSmartPortsMacroName=_RlSmartPortsMacroName_Object((1,3,6,1,4,1,4526,17,140,1,1,1),_RlSmartPortsMacroName_Type())
...
rlSmartPortsMacroIndex=_RlSmartPortsMacroIndex_Object((1,3,6,1,4,1,4526,17,140,1,1,2),_RlSmartPortsMacroIndex_Type())
...
rlSmartPortsMacroType=_RlSmartPortsMacroType_Object((1,3,6,1,4,1,4526,17,140,1,1,3),_RlSmartPortsMacroType_Type())
...
rlSmartPortsMacroStatus=_RlSmartPortsMacroStatus_Object((1,3,6,1,4,1,4526,17,140,1,1,4),_RlSmartPortsMacroStatus_Type())
...
rlSmartPortsMacroKeywords=_RlSmartPortsMacroKeywords_Object((1,3,6,1,4,1,4526,17,140,1,1,5),_RlSmartPortsMacroKeywords_Type())
...
rlSmartPortsMacroDesc1=_RlSmartPortsMacroDesc1_Object((1,3,6,1,4,1,4526,17,140,1,1,6),_RlSmartPortsMacroDesc1_Type())
...
rlSmartPortsMacroDesc2=_RlSmartPortsMacroDesc2_Object((1,3,6,1,4,1,4526,17,140,1,1,7),_RlSmartPortsMacroDesc2_Type())
...
rlSmartPortsMacroContentTable=_RlSmartPortsMacroContentTable_Object((1,3,6,1,4,1,4526,17,140,2))
if mibBuilder.loadTexts:rlSmartPortsMacroContentTable.setStatus(_A)
_RlSmartPortsMacroContentEntry_Object=MibTableRow
rlSmartPortsMacroContentEntry=_RlSmartPortsMacroContentEntry_Object((1,3,6,1,4,1,4526,17,140,2,1))
...
rlSmartPortsMacroOctetIndex=_RlSmartPortsMacroOctetIndex_Object((1,3,6,1,4,1,4526,17,140,2,1,1),_RlSmartPortsMacroOctetIndex_Type())
...
rlSmartPortsMacroText=_RlSmartPortsMacroText_Object((1,3,6,1,4,1,4526,17,140,2,1,2),_RlSmartPortsMacroText_Type())
...
rlSmartPortsMacroDescriptionTable=_RlSmartPortsMacroDescriptionTable_Object((1,3,6,1,4,1,4526,17,140,3))
...
rlSmartPortsMacroDescriptionEntry=_RlSmartPortsMacroDescriptionEntry_Object((1,3,6,1,4,1,4526,17,140,3,1))
...
rlSmartPortsMacroDescriptionIndex=_RlSmartPortsMacroDescriptionIndex_Object((1,3,6,1,4,1,4526,17,140,3,1,1),_RlSmartPortsMacroDescriptionIndex_Type())
...
rlSmartPortsMacroDescriptionText=_RlSmartPortsMacroDescriptionText_Object((1,3,6,1,4,1,4526,17,140,3,1,2),_RlSmartPortsMacroDescriptionText_Type())
...
rlSmartPortsMacroDescriptionStatus=_RlSmartPortsMacroDescriptionStatus_Object((1,3,6,1,4,1,4526,17,140,3,1,3),_RlSmartPortsMacroDescriptionStatus_Type())
...
rlSmartPortsFreeIndexes=_RlSmartPortsFreeIndexes_Object((1,3,6,1,4,1,4526,17,140,4),_RlSmartPortsFreeIndexes_Type())
...
rlSmartPortsDiagMacroName=_RlSmartPortsDiagMacroName_Object((1,3,6,1,4,1,4526,17,140,5),_RlSmartPortsDiagMacroName_Type())
...
rlSmartPortsDiagLineNumber=_RlSmartPortsDiagLineNumber_Object((1,3,6,1,4,1,4526,17,140,6),_RlSmartPortsDiagLineNumber_Type())
...
rlSmartPortsDiagCommandLine=_RlSmartPortsDiagCommandLine_Object((1,3,6,1,4,1,4526,17,140,7),_RlSmartPortsDiagCommandLine_Type())
...
rlSmartPortsCondenseMode=_RlSmartPortsCondenseMode_Object((1,3,6,1,4,1,4526,17,140,8),_RlSmartPortsCondenseMode_Type())
