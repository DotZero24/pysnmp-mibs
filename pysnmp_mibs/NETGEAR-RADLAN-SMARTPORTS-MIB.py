# SNMP MIB module (NETGEAR-RADLAN-SMARTPORTS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-SMARTPORTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:27:42 2025
...
rlSmartPortsMacroManageEntry = _RlSmartPortsMacroManageEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 140, 1, 1)
)
rlSmartPortsMacroManageEntry.setIndexNames(
    (1, "NETGEAR-RADLAN-SMARTPORTS-MIB", "rlSmartPortsMacroName"),
)
if mibBuilder.loadTexts:
...
rlSmartPortsMacroContentEntry = _RlSmartPortsMacroContentEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 140, 2, 1)
)
rlSmartPortsMacroContentEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-SMARTPORTS-MIB", "rlSmartPortsMacroIndex"),
    (0, "NETGEAR-RADLAN-SMARTPORTS-MIB", "rlSmartPortsMacroOctetIndex"),
)
if mibBuilder.loadTexts:
...
rlSmartPortsMacroDescriptionEntry = _RlSmartPortsMacroDescriptionEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 140, 3, 1)
)
rlSmartPortsMacroDescriptionEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-SMARTPORTS-MIB", "rlSmartPortsMacroDescriptionIndex"),
)
if mibBuilder.loadTexts:
