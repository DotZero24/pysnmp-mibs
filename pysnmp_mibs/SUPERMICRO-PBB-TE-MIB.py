...
fspbbte=ModuleIdentity((1,3,6,1,4,1,10876,101,2,11))
if mibBuilder.loadTexts:fspbbte.setRevisions(('2012-09-05 00:00',))
_FsPbbTeScalars_ObjectIdentity=ObjectIdentity
fsPbbTeScalars=_FsPbbTeScalars_ObjectIdentity((1,3,6,1,4,1,10876,101,2,11,1))
_FsPbbTeGlobalTraceOption_Type=Unsigned32
_FsPbbTeGlobalTraceOption_Object=MibScalar
fsPbbTeGlobalTraceOption=_FsPbbTeGlobalTraceOption_Object((1,3,6,1,4,1,10876,101,2,11,1,1),_FsPbbTeGlobalTraceOption_Type())
...
fsPbbTeContext=_FsPbbTeContext_ObjectIdentity((1,3,6,1,4,1,10876,101,2,11,2))
_FsPbbTeContextTable_Object=MibTable
fsPbbTeContextTable=_FsPbbTeContextTable_Object((1,3,6,1,4,1,10876,101,2,11,2,1))
if mibBuilder.loadTexts:fsPbbTeContextTable.setStatus(_A)
_FsPbbTeContextEntry_Object=MibTableRow
fsPbbTeContextEntry=_FsPbbTeContextEntry_Object((1,3,6,1,4,1,10876,101,2,11,2,1,1))
...
fsPbbTeContextId=_FsPbbTeContextId_Object((1,3,6,1,4,1,10876,101,2,11,2,1,1,1),_FsPbbTeContextId_Type())
...
fsPbbTeContextSystemControl=_FsPbbTeContextSystemControl_Object((1,3,6,1,4,1,10876,101,2,11,2,1,1,2),_FsPbbTeContextSystemControl_Type())
...
fsPbbTeContextTraceOption=_FsPbbTeContextTraceOption_Object((1,3,6,1,4,1,10876,101,2,11,2,1,1,3),_FsPbbTeContextTraceOption_Type())
...
fsPbbTeContextNoOfActiveEsps=_FsPbbTeContextNoOfActiveEsps_Object((1,3,6,1,4,1,10876,101,2,11,2,1,1,4),_FsPbbTeContextNoOfActiveEsps_Type())
...
fsPbbTeContextNoOfCreatedEsps=_FsPbbTeContextNoOfCreatedEsps_Object((1,3,6,1,4,1,10876,101,2,11,2,1,1,5),_FsPbbTeContextNoOfCreatedEsps_Type())
...
fsPbbTeContextNoOfDeletedEsps=_FsPbbTeContextNoOfDeletedEsps_Object((1,3,6,1,4,1,10876,101,2,11,2,1,1,6),_FsPbbTeContextNoOfDeletedEsps_Type())
...
fsPbbTeEspVidMapping=_FsPbbTeEspVidMapping_ObjectIdentity((1,3,6,1,4,1,10876,101,2,11,3))
_FsPbbTeEspVidTable_Object=MibTable
fsPbbTeEspVidTable=_FsPbbTeEspVidTable_Object((1,3,6,1,4,1,10876,101,2,11,3,1))
if mibBuilder.loadTexts:fsPbbTeEspVidTable.setStatus(_A)
_FsPbbTeEspVidEntry_Object=MibTableRow
fsPbbTeEspVidEntry=_FsPbbTeEspVidEntry_Object((1,3,6,1,4,1,10876,101,2,11,3,1,1))
...
fsPbbTeEspVid=_FsPbbTeEspVid_Object((1,3,6,1,4,1,10876,101,2,11,3,1,1,1),_FsPbbTeEspVid_Type())
...
fsPbbTeEspVidRowStatus=_FsPbbTeEspVidRowStatus_Object((1,3,6,1,4,1,10876,101,2,11,3,1,1,2),_FsPbbTeEspVidRowStatus_Type())
...
fsPbbTeTeSidExtension=_FsPbbTeTeSidExtension_ObjectIdentity((1,3,6,1,4,1,10876,101,2,11,4))
_FsPbbTeTeSidExtTable_Object=MibTable
fsPbbTeTeSidExtTable=_FsPbbTeTeSidExtTable_Object((1,3,6,1,4,1,10876,101,2,11,4,1))
if mibBuilder.loadTexts:fsPbbTeTeSidExtTable.setStatus(_A)
_FsPbbTeTeSidExtEntry_Object=MibTableRow
fsPbbTeTeSidExtEntry=_FsPbbTeTeSidExtEntry_Object((1,3,6,1,4,1,10876,101,2,11,4,1,1))
...
fsPbbTeTeSidExtContextId=_FsPbbTeTeSidExtContextId_Object((1,3,6,1,4,1,10876,101,2,11,4,1,1,1),_FsPbbTeTeSidExtContextId_Type())
...
fsPbbTeTest=_FsPbbTeTest_ObjectIdentity((1,3,6,1,4,1,10876,101,2,11,5))
...
fsPbbTeTestApiContextId=_FsPbbTeTestApiContextId_Object((1,3,6,1,4,1,10876,101,2,11,5,1),_FsPbbTeTestApiContextId_Type())
...
fsPbbTeTestApiTeSid=_FsPbbTeTestApiTeSid_Object((1,3,6,1,4,1,10876,101,2,11,5,2),_FsPbbTeTestApiTeSid_Type())
...
fsPbbTeTestApiDestMacAddr=_FsPbbTeTestApiDestMacAddr_Object((1,3,6,1,4,1,10876,101,2,11,5,3),_FsPbbTeTestApiDestMacAddr_Type())
...
fsPbbTeTestApiSourceMacAddr=_FsPbbTeTestApiSourceMacAddr_Object((1,3,6,1,4,1,10876,101,2,11,5,4),_FsPbbTeTestApiSourceMacAddr_Type())
...
fsPbbTeTestApiEspVlanId=_FsPbbTeTestApiEspVlanId_Object((1,3,6,1,4,1,10876,101,2,11,5,5),_FsPbbTeTestApiEspVlanId_Type())
...
fsPbbTeTestApiEgressPort=_FsPbbTeTestApiEgressPort_Object((1,3,6,1,4,1,10876,101,2,11,5,6),_FsPbbTeTestApiEgressPort_Type())
...
fsPbbTeTestApiEgressPortList=_FsPbbTeTestApiEgressPortList_Object((1,3,6,1,4,1,10876,101,2,11,5,7),_FsPbbTeTestApiEgressPortList_Type())
...
fsPbbTeTestApiAction=_FsPbbTeTestApiAction_Object((1,3,6,1,4,1,10876,101,2,11,5,8),_FsPbbTeTestApiAction_Type())
