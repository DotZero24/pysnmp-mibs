# SNMP MIB module (ARICENT-RMON-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-RMON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:43:06 2025
...
rmonStatsPkts1519to1522Octets = _RmonStatsPkts1519to1522Octets_Object(
    (1, 3, 6, 1, 4, 1, 2076, 44, 10, 1, 2),
    _RmonStatsPkts1519to1522Octets_Type()
)
rmonStatsPkts1519to1522Octets.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rmonStatsPkts1519to1522Octets.setStatus("current")
if mibBuilder.loadTexts:
    rmonStatsPkts1519to1522Octets.setUnits("Packets")
...
mibBuilder.exportSymbols(
    ...
    **{"futrmon": futrmon,
       ...
       "rmonStatsPkts1519to1522Octets": rmonStatsPkts1519to1522Octets}
)
