...
rmonDebugType=_RmonDebugType_Object((1,3,6,1,4,1,2076,44,1),_RmonDebugType_Type())
...
rmonEnableStatus=_RmonEnableStatus_Object((1,3,6,1,4,1,2076,44,2),_RmonEnableStatus_Type())
...
rmonHwStatsSupp=_RmonHwStatsSupp_Object((1,3,6,1,4,1,2076,44,3),_RmonHwStatsSupp_Type())
...
rmonHwHistorySupp=_RmonHwHistorySupp_Object((1,3,6,1,4,1,2076,44,4),_RmonHwHistorySupp_Type())
...
rmonHwAlarmSupp=_RmonHwAlarmSupp_Object((1,3,6,1,4,1,2076,44,5),_RmonHwAlarmSupp_Type())
...
rmonHwHostSupp=_RmonHwHostSupp_Object((1,3,6,1,4,1,2076,44,6),_RmonHwHostSupp_Type())
...
rmonHwHostTopNSupp=_RmonHwHostTopNSupp_Object((1,3,6,1,4,1,2076,44,7),_RmonHwHostTopNSupp_Type())
...
rmonHwMatrixSupp=_RmonHwMatrixSupp_Object((1,3,6,1,4,1,2076,44,8),_RmonHwMatrixSupp_Type())
...
rmonHwEventSupp=_RmonHwEventSupp_Object((1,3,6,1,4,1,2076,44,9),_RmonHwEventSupp_Type())
rmonHwEventSupp.setMaxAccess(_C)
if mibBuilder.loadTexts:rmonHwEventSupp.setStatus(_A)
_RmonStatsTable_Object=MibTable
rmonStatsTable=_RmonStatsTable_Object((1,3,6,1,4,1,2076,44,10))
if mibBuilder.loadTexts:rmonStatsTable.setStatus(_A)
_RmonStatsEntry_Object=MibTableRow
rmonStatsEntry=_RmonStatsEntry_Object((1,3,6,1,4,1,2076,44,10,1))
...
rmonStatsOutFCSErrors=_RmonStatsOutFCSErrors_Object((1,3,6,1,4,1,2076,44,10,1,1),_RmonStatsOutFCSErrors_Type())
rmonStatsOutFCSErrors.setMaxAccess(_F)
if mibBuilder.loadTexts:rmonStatsOutFCSErrors.setStatus(_A)
_RmonStatsPkts1519to1522Octets_Type=Counter32
_RmonStatsPkts1519to1522Octets_Object=MibTableColumn
rmonStatsPkts1519to1522Octets=_RmonStatsPkts1519to1522Octets_Object((1,3,6,1,4,1,2076,44,10,1,2),_RmonStatsPkts1519to1522Octets_Type())
rmonStatsPkts1519to1522Octets.setMaxAccess(_F)
if mibBuilder.loadTexts:rmonStatsPkts1519to1522Octets.setStatus(_A)
if mibBuilder.loadTexts:rmonStatsPkts1519to1522Octets.setUnits('Packets')
etherStatsEntry.registerAugmentions((_G,_H))
rmonStatsEntry.setIndexNames(*etherStatsEntry.getIndexNames())
mibBuilder.exportSymbols(_G,**{'futrmon':futrmon,'rmonDebugType':rmonDebugType,'rmonEnableStatus':rmonEnableStatus,'rmonHwStatsSupp':rmonHwStatsSupp,'rmonHwHistorySupp':rmonHwHistorySupp,'rmonHwAlarmSupp':rmonHwAlarmSupp,'rmonHwHostSupp':rmonHwHostSupp,'rmonHwHostTopNSupp':rmonHwHostTopNSupp,'rmonHwMatrixSupp':rmonHwMatrixSupp,'rmonHwEventSupp':rmonHwEventSupp,'rmonStatsTable':rmonStatsTable,_H:rmonStatsEntry,'rmonStatsOutFCSErrors':rmonStatsOutFCSErrors,'rmonStatsPkts1519to1522Octets':rmonStatsPkts1519to1522Octets})