...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-GSLB-SYSTEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:28:22 2025
...
_CgsPeerEventNotifEnable_Type.__name__ = "TruthValue"
...
_CgsProxPrimaryAddressType_Type.__name__ = "InetAddressType"
...
_CgsProxSecondaryAddressType_Type.__name__ = "InetAddressType"
...
class _CgsProxSecondaryAddress_Type(InetAddress):
    """Custom type cgsProxSecondaryAddress based on InetAddress"""
    defaultValue = OctetString("")


_CgsProxSecondaryAddress_Type.__name__ = "InetAddress"
...
_CgsProxStorageType_Type.__name__ = "StorageType"
...
class _CgsRegionComments_Type(SnmpAdminString):
    """Custom type cgsRegionComments based on SnmpAdminString"""
    defaultValue = OctetString("")


_CgsRegionComments_Type.__name__ = "SnmpAdminString"
...
_CgsRegionStorageType_Type.__name__ = "StorageType"
...
class _CgsLocationZone_Type(SnmpAdminString):
    """Custom type cgsLocationZone based on SnmpAdminString"""
    defaultValue = OctetString("")


_CgsLocationZone_Type.__name__ = "SnmpAdminString"
...
class _CgsLocationComments_Type(SnmpAdminString):
    """Custom type cgsLocationComments based on SnmpAdminString"""
    defaultValue = OctetString("")


_CgsLocationComments_Type.__name__ = "SnmpAdminString"
...
_CgsLocationStorageType_Type.__name__ = "StorageType"
...
class _CgsRegionIdComments_Type(SnmpAdminString):
    """Custom type cgsRegionIdComments based on SnmpAdminString"""
    defaultValue = OctetString("")


_CgsRegionIdComments_Type.__name__ = "SnmpAdminString"
...
_CgsRegionIdStorageType_Type.__name__ = "StorageType"
...
ciscoGslbSystemMIBCompliance.setObjects(
      *(("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemGeneralGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemPeerGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemProxZoneGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemResourceGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemNotifControlGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemNotifObjectsGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemNotifGroup"))
)
if mibBuilder.loadTexts:
...
ciscoGslbSystemMIBComplianceRev1.setObjects(
      *(("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemGeneralGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemPeerGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemProxZoneGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemNotifControlGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemNotifObjectsGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemNotifGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemResourceLocationGroup"),
        ("CISCO-GSLB-SYSTEM-MIB", "ciscoGslbSystemResourceRegionGroup"))
)
if mibBuilder.loadTexts:
