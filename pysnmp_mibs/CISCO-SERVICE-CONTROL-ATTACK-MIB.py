...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SERVICE-CONTROL-ATTACK-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:39 2025
...
cscaMIBCompliance.setObjects(
      *(("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaMIBAttackTypeObjectGroup"),
        ("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaMIBNotificationGroup"),
        ("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaMIBAttackInfoObjectGroup"),
        ("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaFilterObjectGroup"),
        ("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaMIBNotifControlGroup"))
)
if mibBuilder.loadTexts:
...
cscaMIBComplianceRev1.setObjects(
      *(("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaMIBAttackTypeObjectGroup"),
        ("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaMIBNotificationGroupRev1"),
        ("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaMIBAttackInfoObjectGroup"),
        ("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaFilterObjectGroupRev1"),
        ("CISCO-SERVICE-CONTROL-ATTACK-MIB", "cscaMIBNotifControlGroupRev1"))
)
if mibBuilder.loadTexts:
