...
mibBuilder.exportSymbols("CISCO-OPTICAL-IF-CROSS-CONNECT-MIB", coifccCrossConnectGroup=coifccCrossConnectGroup, coifccCcH2LLastChange=coifccCcH2LLastChange, coifccInterfaceGroup=coifccInterfaceGroup, ciscoOpticalIfCrossConnectMIB=ciscoOpticalIfCrossConnectMIB, coifccCcCreationTime=coifccCcCreationTime, coifccCrossConnectTable=coifccCrossConnectTable, coifccMIBObjects=coifccMIBObjects, coifccMIBComplianceRev1=coifccMIBComplianceRev1, coifccCcLowIfIndex=coifccCcLowIfIndex, coifccInterfaceEntry=coifccInterfaceEntry, coifccCcSwitchType=coifccCcSwitchType, coifccAttenuationGroup=coifccAttenuationGroup, PYSNMP_MODULE_ID=ciscoOpticalIfCrossConnectMIB, coifccInterfaceTable=coifccInterfaceTable, coifccCcHighIfIndex=coifccCcHighIfIndex, coifccCcIndexNext=coifccCcIndexNext, coifccCcL2HAttenuation=coifccCcL2HAttenuation, coifccMIBGroups=coifccMIBGroups, coifccMIBCompliance=coifccMIBCompliance, coifccMIBConformance=coifccMIBConformance, coifccCcLastChange=coifccCcLastChange, coifccCcH2LOperStatus=coifccCcH2LOperStatus, coifccCcL2HLastChange=coifccCcL2HLastChange, coifccMIBCompliances=coifccMIBCompliances, coifccCrossConnect=coifccCrossConnect, coifccCrossConnectEntry=coifccCrossConnectEntry, coifccCcL2HOperStatus=coifccCcL2HOperStatus, coifccCcRowStatus=coifccCcRowStatus, CoifccCrossConnectOperStatus=CoifccCrossConnectOperStatus, coifccIfCrossConnectIdentifier=coifccIfCrossConnectIdentifier, coifccInterface=coifccInterface, coifccCcH2LAttenuation=coifccCcH2LAttenuation, coifccCcKind=coifccCcKind, coifccCcIndex=coifccCcIndex)
