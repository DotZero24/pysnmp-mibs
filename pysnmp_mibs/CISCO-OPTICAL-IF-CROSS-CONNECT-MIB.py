...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-OPTICAL-IF-CROSS-CONNECT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:32:15 2025
...
coifccMIBCompliance.setObjects(
      *(("CISCO-OPTICAL-IF-CROSS-CONNECT-MIB", "coifccInterfaceGroup"),
        ("CISCO-OPTICAL-IF-CROSS-CONNECT-MIB", "coifccCrossConnectGroup"))
)
if mibBuilder.loadTexts:
...
coifccMIBComplianceRev1.setObjects(
      *(("CISCO-OPTICAL-IF-CROSS-CONNECT-MIB", "coifccInterfaceGroup"),
        ("CISCO-OPTICAL-IF-CROSS-CONNECT-MIB", "coifccCrossConnectGroup"))
)
if mibBuilder.loadTexts:
