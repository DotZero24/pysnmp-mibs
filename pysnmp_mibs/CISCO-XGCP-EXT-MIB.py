...
mibBuilder.exportSymbols("CISCO-XGCP-EXT-MIB", PYSNMP_MODULE_ID=ciscoXgcpExtMIB, cxeCcProfileMgcAddrType=cxeCcProfileMgcAddrType, cxeCallCtrlMIBCompliances=cxeCallCtrlMIBCompliances, cxeCallCtrlControlServiceType=cxeCallCtrlControlServiceType, cxeCcProfileDlTimeout=cxeCcProfileDlTimeout, cxeCcProfileDnsLookupMax2=cxeCcProfileDnsLookupMax2, cxeCallCtrlRtcpRcvTimer=cxeCallCtrlRtcpRcvTimer, cxeCcProfileRtTimeout=cxeCcProfileRtTimeout, cxeCallCtrlNetNseTimer=cxeCallCtrlNetNseTimer, cxeCcProfileRoTimeout=cxeCcProfileRoTimeout, DtmfRelayMode=DtmfRelayMode, cxeCcProfileBzTimeout=cxeCcProfileBzTimeout, cxeCallCtrlIgnoreAal2LcoCodec=cxeCallCtrlIgnoreAal2LcoCodec, cxeCallCtrlVselDselFselSupport=cxeCallCtrlVselDselFselSupport, cxeCcProfileMgcGrpNum=cxeCcProfileMgcGrpNum, cxeCallCtrlVoIpDtmfCodec=cxeCallCtrlVoIpDtmfCodec, cxeCcProfileMgcAddress=cxeCcProfileMgcAddress, cxeCcProfileRgTimeout=cxeCcProfileRgTimeout, DtmfCodecType=DtmfCodecType, cxeCcProfileCot2Timeout=cxeCcProfileCot2Timeout, cxeCcProfileTcritTimeout=cxeCcProfileTcritTimeout, cxeCcProfileRowStatus=cxeCcProfileRowStatus, cxeCallCtrlMIBConformance=cxeCallCtrlMIBConformance, cxeCcProfileXgcpRetryMethod=cxeCcProfileXgcpRetryMethod, cxeCallCtrlDefaultBearTraffic=cxeCallCtrlDefaultBearTraffic, cxeCcProfileTdmaxTimeout=cxeCcProfileTdmaxTimeout, cxeCcProfileCot1Timeout=cxeCcProfileCot1Timeout, cxeCallCtrlTsePayload=cxeCallCtrlTsePayload, cxeCcProfileNumVifs=cxeCcProfileNumVifs, cxeCallCtrlGroup=cxeCallCtrlGroup, cxeCallCtrlT38HsRedundancy=cxeCallCtrlT38HsRedundancy, cxeCallCtrlLastFailedMgcAddrType=cxeCallCtrlLastFailedMgcAddrType, cxeCallCtrlMIBGroups=cxeCallCtrlMIBGroups, cxeCallCtrlVoAal2DtmfCodec=cxeCallCtrlVoAal2DtmfCodec, cxgcpExtObjects=cxgcpExtObjects, cxeCallCtrlBearerServiceType=cxeCallCtrlBearerServiceType, cxeCcProfileRetryMax2=cxeCcProfileRetryMax2, cxeCcProfileCgTimeout=cxeCcProfileCgTimeout, cxeCallCtrlVoIpDtmfRelayMode=cxeCallCtrlVoIpDtmfRelayMode, cxeCcProfileTdminTimeout=cxeCcProfileTdminTimeout, ciscoXgcpExtMIB=ciscoXgcpExtMIB, cxeCallCtrlMIBCompliance=cxeCallCtrlMIBCompliance, cxeCallCtrlT38NsfCountryCode=cxeCallCtrlT38NsfCountryCode, CxeTerminalProviderCode=CxeTerminalProviderCode, cxeCallCtrlT38Inhibited=cxeCallCtrlT38Inhibited, cxeCcProfileSlTimeout=cxeCcProfileSlTimeout, cxeCallCtrlT38FecEnabled=cxeCallCtrlT38FecEnabled, cxeCcProfileDnsLookupMax1=cxeCcProfileDnsLookupMax1, cxeCallCtrlDigitMapOrder=cxeCallCtrlDigitMapOrder, cxeCallCtrlT38NseRspTimer=cxeCallCtrlT38NseRspTimer, cxeCcProfileThistTimeout=cxeCcProfileThistTimeout, cxeCcProfileRbkTimeout=cxeCcProfileRbkTimeout, cxeCallCtrlT38LsRedundancy=cxeCallCtrlT38LsRedundancy, cxeCallCtrlConfigTable=cxeCallCtrlConfigTable, cxeCcProfileGroup=cxeCcProfileGroup, cxeCallCtrlLastFailedMgcAddress=cxeCallCtrlLastFailedMgcAddress, cxeCcProfileIndex=cxeCcProfileIndex, cxeCallCtrlProfileTable=cxeCallCtrlProfileTable, cxeCcProfileProtocolIdx=cxeCcProfileProtocolIdx, cxgcpExtConfig=cxgcpExtConfig, cxeCcProfileRetryMax1=cxeCcProfileRetryMax1, cxeCcProfileMwiTimeout=cxeCcProfileMwiTimeout, cxeCcProfileTsmaxTimeout=cxeCcProfileTsmaxTimeout, cxeCcProfileTdinitTimeout=cxeCcProfileTdinitTimeout, cxeCcProfileTparTimeout=cxeCcProfileTparTimeout, cxeCallCtrlVoAal2DtmfRelayMode=cxeCallCtrlVoAal2DtmfRelayMode, cxeCallCtrlProfileEntry=cxeCallCtrlProfileEntry, cxeCallCtrlT38NsfVendorCode=cxeCallCtrlT38NsfVendorCode, cxeCallCtrlConfigEntry=cxeCallCtrlConfigEntry, cxeCcProfileName=cxeCcProfileName)
