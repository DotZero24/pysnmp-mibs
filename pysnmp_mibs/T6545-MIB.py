# SNMP MIB module (T6545-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T6545-MIB
...
trapTest.setObjects(
      *(("T6545-MIB", "sensorName"),
        ("T6545-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
