...
# Notes
# -----
# ASN.1 source file://mibs/mrv/DEV-CFG-MIB
...
powerSupplyPresent = NotificationType(
    (1, 3, 6, 1, 4, 1, 629, 1, 50, 11, 1, 8, 0, 4)
)
powerSupplyPresent.setObjects(
    ("DEV-CFG-MIB", "nbsDevPSIndex")
)
if mibBuilder.loadTexts:
    powerSupplyPresent.setStatus(
        ""
    )

powerSupplyNotPresent = NotificationType(
    (1, 3, 6, 1, 4, 1, 629, 1, 50, 11, 1, 8, 0, 5)
)
powerSupplyNotPresent.setObjects(
    ("DEV-CFG-MIB", "nbsDevPSIndex")
)
if mibBuilder.loadTexts:
    powerSupplyNotPresent.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"nbDeviceConfig": nbDeviceConfig,
       ...
       "powerSupplyPresent": powerSupplyPresent,
       "powerSupplyNotPresent": powerSupplyNotPresent,
