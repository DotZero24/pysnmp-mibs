...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-USP-MIB
...
if mibBuilder.loadTexts: ciscoUspMIB.setLastUpdated('201802280000Z')
...
mibBuilder.exportSymbols("CISCO-USP-MIB", cuspSystemState=cuspSystemState, cuspServerGroupStatus=cuspServerGroupStatus, ciscoUspMIBCompliances=ciscoUspMIBCompliances, cuspLicenseExceededAlert=cuspLicenseExceededAlert, cuspDiskSpaceThresholdAlert=cuspDiskSpaceThresholdAlert, ciscoUspMIBNotifyGroup=ciscoUspMIBNotifyGroup, cuspMemoryThresholdAlert=cuspMemoryThresholdAlert, cuspScalar=cuspScalar, cuspElementIndex=cuspElementIndex, cuspConfiguredMemory=cuspConfiguredMemory, cuspMemoryThresholdValue=cuspMemoryThresholdValue, cuspElementTransport=cuspElementTransport, cuspSystemStateAlertEnable=cuspSystemStateAlertEnable, ciscoUspMIBNotifs=ciscoUspMIBNotifs, cuspCallStats=cuspCallStats, cuspNotifControlInfo=cuspNotifControlInfo, cuspMemoryThresholdAlertEnable=cuspMemoryThresholdAlertEnable, cuspElementTable=cuspElementTable, cuspSystemStateAlert=cuspSystemStateAlert, cuspMaxDroppedCPSOneMin=cuspMaxDroppedCPSOneMin, cuspServerGroupLBType=cuspServerGroupLBType, cuspDiskSpaceThresholdAlertEnable=cuspDiskSpaceThresholdAlertEnable, cuspConnectionExceptionAlertEnable=cuspConnectionExceptionAlertEnable, cuspLicenseStateAlert=cuspLicenseStateAlert, ciscoUspMIBConform=ciscoUspMIBConform, cuspNotifDetail=cuspNotifDetail, PYSNMP_MODULE_ID=ciscoUspMIB, cuspLicenseLimit=cuspLicenseLimit, cuspMaxCPSOneMin=cuspMaxCPSOneMin, cuspLicenseState=cuspLicenseState, cuspStrayMessageCount=cuspStrayMessageCount, cuspMessageStats=cuspMessageStats, cuspServerGroupAlert=cuspServerGroupAlert, cuspSystemUpTime=cuspSystemUpTime, cuspAvgDroppedCPSOneMin=cuspAvgDroppedCPSOneMin, cuspTable=cuspTable, cuspBackupProcessFailAlertEnable=cuspBackupProcessFailAlertEnable, cuspMaxCallsRoutedOneMin=cuspMaxCallsRoutedOneMin, cuspConnectionExceptionAlert=cuspConnectionExceptionAlert, cuspTotalFailedCalls=cuspTotalFailedCalls, cuspElementWeight=cuspElementWeight, cuspNoOfMessagesRecieved=cuspNoOfMessagesRecieved, cuspElementStatus=cuspElementStatus, cuspDroppedCallsOneSec=cuspDroppedCallsOneSec, cuspElementQValue=cuspElementQValue, cuspServerGroupAlertEnable=cuspServerGroupAlertEnable, ciscoUspMIBObjects=ciscoUspMIBObjects, cuspMemoryUsed=cuspMemoryUsed, cuspElementTotalCalls=cuspElementTotalCalls, cuspExtensiveLoggingAlertEnable=cuspExtensiveLoggingAlertEnable, cuspSmartAgentState=cuspSmartAgentState, cuspExtensiveLoggingAlert=cuspExtensiveLoggingAlert, cuspServerGroupTable=cuspServerGroupTable, cuspLicenseStateAlertEnable=cuspLicenseStateAlertEnable, cuspServerGroupIndex=cuspServerGroupIndex, cuspNotifSeverity=cuspNotifSeverity, ciscoUspMIBModuleCompliance=ciscoUspMIBModuleCompliance, cuspDiskSpaceThresholdValue=cuspDiskSpaceThresholdValue, cuspServerGroupName=cuspServerGroupName, cuspLicenseExceededAlertEnable=cuspLicenseExceededAlertEnable, cuspAvgCPSOneMin=cuspAvgCPSOneMin, cuspThresholdValues=cuspThresholdValues, cuspAvgCallsRoutedOneMin=cuspAvgCallsRoutedOneMin, cuspServerGroupElementAlertEnable=cuspServerGroupElementAlertEnable, cuspServerGroupElementAlert=cuspServerGroupElementAlert, cuspTotalCalls=cuspTotalCalls, cuspSipMessageQueueOverflowAlertEnable=cuspSipMessageQueueOverflowAlertEnable, ciscoUspMIBGroups=ciscoUspMIBGroups, cuspCallsDroppedExceedingLicense=cuspCallsDroppedExceedingLicense, cuspElementPort=cuspElementPort, cuspServerGroupPingStatus=cuspServerGroupPingStatus, cuspServerGroupNetwork=cuspServerGroupNetwork, cuspElementEntry=cuspElementEntry, cuspDiskSpaceUsed=cuspDiskSpaceUsed, cuspBackupProcessFailAlert=cuspBackupProcessFailAlert, cuspElementFailedCalls=cuspElementFailedCalls, ciscoUspMIBMainObjectGroup=ciscoUspMIBMainObjectGroup, cuspLastCounterResetTime=cuspLastCounterResetTime, cuspServerGroupEntry=cuspServerGroupEntry, cuspCPS=cuspCPS, cuspSipMessageQueueOverflowAlert=cuspSipMessageQueueOverflowAlert, cuspCallsRoutedOneSec=cuspCallsRoutedOneSec, cuspElementName=cuspElementName, ciscoUspMIB=ciscoUspMIB)
