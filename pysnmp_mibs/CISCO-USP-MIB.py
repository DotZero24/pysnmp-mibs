...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-USP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:22:28 2025
...
cuspSipMessageQueueOverflowAlertEnable = _CuspSipMessageQueueOverflowAlertEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 827, 1, 3, 13),
    _CuspSipMessageQueueOverflowAlertEnable_Type()
)
cuspSipMessageQueueOverflowAlertEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cuspSipMessageQueueOverflowAlertEnable.setStatus("current")
...
ciscoUspMIBMainObjectGroup.setObjects(
      *(("CISCO-USP-MIB", "cuspLicenseLimit"),
        ...
        ("CISCO-USP-MIB", "cuspSipMessageQueueOverflowAlertEnable"),
...
cuspSipMessageQueueOverflowAlert = NotificationType(
    (1, 3, 6, 1, 4, 1, 9, 9, 827, 0, 11)
)
cuspSipMessageQueueOverflowAlert.setObjects(
      *(("CISCO-USP-MIB", "cuspNotifSeverity"),
        ("CISCO-USP-MIB", "cuspNotifDetail"))
)
if mibBuilder.loadTexts:
    cuspSipMessageQueueOverflowAlert.setStatus(
        "current"
    )
...
ciscoUspMIBNotifyGroup.setObjects(
      *(("CISCO-USP-MIB", "cuspSystemStateAlert"),
        ...
        ("CISCO-USP-MIB", "cuspSipMessageQueueOverflowAlert"),
...
ciscoUspMIBModuleCompliance.setObjects(
      *(("CISCO-USP-MIB", "ciscoUspMIBMainObjectGroup"),
        ("CISCO-USP-MIB", "ciscoUspMIBNotifyGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ciscoUspMIB": ciscoUspMIB,
       ...
       "cuspSipMessageQueueOverflowAlert": cuspSipMessageQueueOverflowAlert,
