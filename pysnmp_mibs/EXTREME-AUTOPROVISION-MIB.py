...
mibBuilder.exportSymbols("EXTREME-AUTOPROVISION-MIB", extremeAutoProvision=extremeAutoProvision, extremeAutoProvisionIpAddress=extremeAutoProvisionIpAddress, extremeAutoProvisionStatus=extremeAutoProvisionStatus, extremeAutoProvisionTrapPrefix=extremeAutoProvisionTrapPrefix, extremeAutoProvisionGeneral=extremeAutoProvisionGeneral, extremeAutoProvisionNotification=extremeAutoProvisionNotification, extremeAutoProvisionNotificationObjects=extremeAutoProvisionNotificationObjects, PYSNMP_MODULE_ID=extremeAutoProvision, extremeAutoProvisionResult=extremeAutoProvisionResult, extremeAutoProvisionTFTPServer=extremeAutoProvisionTFTPServer, extremeAutoProvisionGateway=extremeAutoProvisionGateway, extremeAutoProvisionConfigFileName=extremeAutoProvisionConfigFileName, extremeAutoProvisionConfig=extremeAutoProvisionConfig)
