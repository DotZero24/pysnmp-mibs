...
fsPbbNotifications=_FsPbbNotifications_ObjectIdentity((1,3,6,1,4,1,29601,2,14,0))
_FsPbbObjects_ObjectIdentity=ObjectIdentity
fsPbbObjects=_FsPbbObjects_ObjectIdentity((1,3,6,1,4,1,29601,2,14,1))
_FsPbbProviderBackboneBridge_ObjectIdentity=ObjectIdentity
fsPbbProviderBackboneBridge=_FsPbbProviderBackboneBridge_ObjectIdentity((1,3,6,1,4,1,29601,2,14,1,1))
_FsPbbBackboneEdgeBridgeObjects_ObjectIdentity=ObjectIdentity
fsPbbBackboneEdgeBridgeObjects=_FsPbbBackboneEdgeBridgeObjects_ObjectIdentity((1,3,6,1,4,1,29601,2,14,1,1,1))
_FsPbbBackboneEdgeBridgeAddress_Type=MacAddress
_FsPbbBackboneEdgeBridgeAddress_Object=MibScalar
fsPbbBackboneEdgeBridgeAddress=_FsPbbBackboneEdgeBridgeAddress_Object((1,3,6,1,4,1,29601,2,14,1,1,1,1),_FsPbbBackboneEdgeBridgeAddress_Type())
...
fsPbbBackboneEdgeBridgeName=_FsPbbBackboneEdgeBridgeName_Object((1,3,6,1,4,1,29601,2,14,1,1,1,2),_FsPbbBackboneEdgeBridgeName_Type())
...
fsPbbNumberOfIComponents=_FsPbbNumberOfIComponents_Object((1,3,6,1,4,1,29601,2,14,1,1,1,3),_FsPbbNumberOfIComponents_Type())
...
fsPbbNumberOfBComponents=_FsPbbNumberOfBComponents_Object((1,3,6,1,4,1,29601,2,14,1,1,1,4),_FsPbbNumberOfBComponents_Type())
...
fsPbbNumberOfBebPorts=_FsPbbNumberOfBebPorts_Object((1,3,6,1,4,1,29601,2,14,1,1,1,5),_FsPbbNumberOfBebPorts_Type())
...
fsPbbNextAvailablePipIfIndex=_FsPbbNextAvailablePipIfIndex_Object((1,3,6,1,4,1,29601,2,14,1,1,1,6),_FsPbbNextAvailablePipIfIndex_Type())
...
fsPbbVipTable=_FsPbbVipTable_Object((1,3,6,1,4,1,29601,2,14,1,1,2))
if mibBuilder.loadTexts:fsPbbVipTable.setStatus(_A)
_FsPbbVipEntry_Object=MibTableRow
fsPbbVipEntry=_FsPbbVipEntry_Object((1,3,6,1,4,1,29601,2,14,1,1,2,1))
...
fsdot1ahContextId=_Fsdot1ahContextId_Object((1,3,6,1,4,1,29601,2,14,1,1,2,1,1),_Fsdot1ahContextId_Type())
...
fsPbbVipPipIfIndex=_FsPbbVipPipIfIndex_Object((1,3,6,1,4,1,29601,2,14,1,1,2,1,2),_FsPbbVipPipIfIndex_Type())
...
fsPbbVipISid=_FsPbbVipISid_Object((1,3,6,1,4,1,29601,2,14,1,1,2,1,3),_FsPbbVipISid_Type())
...
fsPbbVipDefaultDstBMAC=_FsPbbVipDefaultDstBMAC_Object((1,3,6,1,4,1,29601,2,14,1,1,2,1,4),_FsPbbVipDefaultDstBMAC_Type())
...
fsPbbVipType=_FsPbbVipType_Object((1,3,6,1,4,1,29601,2,14,1,1,2,1,5),_FsPbbVipType_Type())
...
fsPbbVipRowStatus=_FsPbbVipRowStatus_Object((1,3,6,1,4,1,29601,2,14,1,1,2,1,6),_FsPbbVipRowStatus_Type())
...
fsPbbISidToVipTable=_FsPbbISidToVipTable_Object((1,3,6,1,4,1,29601,2,14,1,1,3))
if mibBuilder.loadTexts:fsPbbISidToVipTable.setStatus(_A)
_FsPbbISidToVipEntry_Object=MibTableRow
fsPbbISidToVipEntry=_FsPbbISidToVipEntry_Object((1,3,6,1,4,1,29601,2,14,1,1,3,1))
...
fsPbbISidToVipISid=_FsPbbISidToVipISid_Object((1,3,6,1,4,1,29601,2,14,1,1,3,1,1),_FsPbbISidToVipISid_Type())
...
fsPbbISidToVipComponentId=_FsPbbISidToVipComponentId_Object((1,3,6,1,4,1,29601,2,14,1,1,3,1,2),_FsPbbISidToVipComponentId_Type())
...
fsPbbISidToVipPort=_FsPbbISidToVipPort_Object((1,3,6,1,4,1,29601,2,14,1,1,3,1,3),_FsPbbISidToVipPort_Type())
fsPbbISidToVipPort.setMaxAccess(_D)
if mibBuilder.loadTexts:fsPbbISidToVipPort.setStatus(_A)
_FsPbbPipTable_Object=MibTable
fsPbbPipTable=_FsPbbPipTable_Object((1,3,6,1,4,1,29601,2,14,1,1,4))
if mibBuilder.loadTexts:fsPbbPipTable.setStatus(_A)
_FsPbbPipEntry_Object=MibTableRow
fsPbbPipEntry=_FsPbbPipEntry_Object((1,3,6,1,4,1,29601,2,14,1,1,4,1))
...
fsPbbPipIfIndex=_FsPbbPipIfIndex_Object((1,3,6,1,4,1,29601,2,14,1,1,4,1,1),_FsPbbPipIfIndex_Type())
...
fsPbbPipBMACAddress=_FsPbbPipBMACAddress_Object((1,3,6,1,4,1,29601,2,14,1,1,4,1,2),_FsPbbPipBMACAddress_Type())
...
fsPbbPipName=_FsPbbPipName_Object((1,3,6,1,4,1,29601,2,14,1,1,4,1,3),_FsPbbPipName_Type())
...
fsPbbPipIComponentId=_FsPbbPipIComponentId_Object((1,3,6,1,4,1,29601,2,14,1,1,4,1,4),_FsPbbPipIComponentId_Type())
...
fsPbbPipRowStatus=_FsPbbPipRowStatus_Object((1,3,6,1,4,1,29601,2,14,1,1,4,1,5),_FsPbbPipRowStatus_Type())
...
fsPbbVipToPipMappingTable=_FsPbbVipToPipMappingTable_Object((1,3,6,1,4,1,29601,2,14,1,1,5))
if mibBuilder.loadTexts:fsPbbVipToPipMappingTable.setStatus(_A)
_FsPbbVipToPipMappingEntry_Object=MibTableRow
fsPbbVipToPipMappingEntry=_FsPbbVipToPipMappingEntry_Object((1,3,6,1,4,1,29601,2,14,1,1,5,1))
...
fsPbbVipToPipMappingPipIfIndex=_FsPbbVipToPipMappingPipIfIndex_Object((1,3,6,1,4,1,29601,2,14,1,1,5,1,1),_FsPbbVipToPipMappingPipIfIndex_Type())
...
fsPbbVipToPipMappingStorageType=_FsPbbVipToPipMappingStorageType_Object((1,3,6,1,4,1,29601,2,14,1,1,5,1,2),_FsPbbVipToPipMappingStorageType_Type())
...
fsPbbVipToPipMappingRowStatus=_FsPbbVipToPipMappingRowStatus_Object((1,3,6,1,4,1,29601,2,14,1,1,5,1,3),_FsPbbVipToPipMappingRowStatus_Type())
...
fsPbbCBPServiceMappingTable=_FsPbbCBPServiceMappingTable_Object((1,3,6,1,4,1,29601,2,14,1,1,6))
if mibBuilder.loadTexts:fsPbbCBPServiceMappingTable.setStatus(_A)
_FsPbbCBPServiceMappingEntry_Object=MibTableRow
fsPbbCBPServiceMappingEntry=_FsPbbCBPServiceMappingEntry_Object((1,3,6,1,4,1,29601,2,14,1,1,6,1))
...
fsPbbCBPServiceMappingBackboneSid=_FsPbbCBPServiceMappingBackboneSid_Object((1,3,6,1,4,1,29601,2,14,1,1,6,1,1),_FsPbbCBPServiceMappingBackboneSid_Type())
...
fsPbbCBPServiceMappingBVid=_FsPbbCBPServiceMappingBVid_Object((1,3,6,1,4,1,29601,2,14,1,1,6,1,2),_FsPbbCBPServiceMappingBVid_Type())
...
fsPbbCBPServiceMappingDefaultBackboneDest=_FsPbbCBPServiceMappingDefaultBackboneDest_Object((1,3,6,1,4,1,29601,2,14,1,1,6,1,3),_FsPbbCBPServiceMappingDefaultBackboneDest_Type())
...
fsPbbCBPServiceMappingType=_FsPbbCBPServiceMappingType_Object((1,3,6,1,4,1,29601,2,14,1,1,6,1,4),_FsPbbCBPServiceMappingType_Type())
...
fsPbbCBPServiceMappingLocalSid=_FsPbbCBPServiceMappingLocalSid_Object((1,3,6,1,4,1,29601,2,14,1,1,6,1,5),_FsPbbCBPServiceMappingLocalSid_Type())
...
fsPbbCBPServiceMappingRowStatus=_FsPbbCBPServiceMappingRowStatus_Object((1,3,6,1,4,1,29601,2,14,1,1,6,1,6),_FsPbbCBPServiceMappingRowStatus_Type())
...
fsPbbCbpTable=_FsPbbCbpTable_Object((1,3,6,1,4,1,29601,2,14,1,1,7))
if mibBuilder.loadTexts:fsPbbCbpTable.setStatus(_A)
_FsPbbCbpEntry_Object=MibTableRow
fsPbbCbpEntry=_FsPbbCbpEntry_Object((1,3,6,1,4,1,29601,2,14,1,1,7,1))
...
fsPbbCbpRowStatus=_FsPbbCbpRowStatus_Object((1,3,6,1,4,1,29601,2,14,1,1,7,1,1),_FsPbbCbpRowStatus_Type())
...
fsPbbPipToVipMappingTable=_FsPbbPipToVipMappingTable_Object((1,3,6,1,4,1,29601,2,14,1,1,8))
if mibBuilder.loadTexts:fsPbbPipToVipMappingTable.setStatus(_A)
_FsPbbPipToVipMappingEntry_Object=MibTableRow
fsPbbPipToVipMappingEntry=_FsPbbPipToVipMappingEntry_Object((1,3,6,1,4,1,29601,2,14,1,1,8,1))
...
fsPbbPipToVipMappingStatus=_FsPbbPipToVipMappingStatus_Object((1,3,6,1,4,1,29601,2,14,1,1,8,1,1),_FsPbbPipToVipMappingStatus_Type())
...
fsPbbConformance=_FsPbbConformance_ObjectIdentity((1,3,6,1,4,1,29601,2,14,2))
_FsPbbGroups_ObjectIdentity=ObjectIdentity
fsPbbGroups=_FsPbbGroups_ObjectIdentity((1,3,6,1,4,1,29601,2,14,2,1))
_FsPbbCompliances_ObjectIdentity=ObjectIdentity
fsPbbCompliances=_FsPbbCompliances_ObjectIdentity((1,3,6,1,4,1,29601,2,14,2,2))
fsPbbBackboneEdgeBridgeGroup=ObjectGroup((1,3,6,1,4,1,29601,2,14,2,1,1))
...
fsPbbDynamicCbpGroup=ObjectGroup((1,3,6,1,4,1,29601,2,14,2,1,6))
fsPbbDynamicCbpGroup.setObjects((_B,_s))
if mibBuilder.loadTexts:fsPbbDynamicCbpGroup.setStatus(_A)
fsPbbCompliance=ModuleCompliance((1,3,6,1,4,1,29601,2,14,2,2,1))
