...
mibBuilder.exportSymbols("STORMSHIELD-POLICY-MIB", snsPolicyName=snsPolicyName, snsPolicyIndex=snsPolicyIndex, snsPolicyTable=snsPolicyTable, PYSNMP_MODULE_ID=snsPolicy, snsPolicySync=snsPolicySync, snsPolicyEntry=snsPolicyEntry, snsPolicyActive=snsPolicyActive, snsPolicySlotName=snsPolicySlotName, snsPolicy=snsPolicy)
