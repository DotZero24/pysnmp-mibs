...
mibBuilder.exportSymbols("ZHONE-INTERFACE-TRANSLATION-MIB", PYSNMP_MODULE_ID=zhoneInterfaceTrans, ifStkDefRowStatus=ifStkDefRowStatus, ifStackDefaultTable=ifStackDefaultTable, zhoneLineRedStatusFunction=zhoneLineRedStatusFunction, zhoneSubPortIndex=zhoneSubPortIndex, ifStkDefLowerType=ifStkDefLowerType, zhoneIfXEntrySlotAlias=zhoneIfXEntrySlotAlias, zhoneIfIndex=zhoneIfIndex, zhoneSlotNumber=zhoneSlotNumber, zhoneIfXEntryPortAlias=zhoneIfXEntryPortAlias, zhoneShelfNumber=zhoneShelfNumber, zhoneDescriptionEntry=zhoneDescriptionEntry, zhoneLineRedTraps=zhoneLineRedTraps, ifInverseStackLowerLayer=ifInverseStackLowerLayer, physicalFlag=physicalFlag, zhoneDescriptionRowStatus=zhoneDescriptionRowStatus, zhoneIfXEntryRowStatus=zhoneIfXEntryRowStatus, zhoneLineRedundancyUnsafe=zhoneLineRedundancyUnsafe, redundancyParam1=redundancyParam1, pportNumber=pportNumber, zhoneIfXDescriptionIndex=zhoneIfXDescriptionIndex, zhonePortIndex=zhonePortIndex, zhoneInterfaceTrans=zhoneInterfaceTrans, ifStackDefaultEntry=ifStackDefaultEntry, zhoneDescriptionTable=zhoneDescriptionTable, ifaceTypeExtension=ifaceTypeExtension, zhoneIfXEntryIfTypeAlias=zhoneIfXEntryIfTypeAlias, ifStkDefUpperType=ifStkDefUpperType, ifInverseStackEntry=ifInverseStackEntry, subPortIndex=subPortIndex, ifIndexToPhysicalTable=ifIndexToPhysicalTable, ifaceType=ifaceType, physicalToIfIndexTable=physicalToIfIndexTable, zhonePhysicalToIfIndexTable=zhonePhysicalToIfIndexTable, zhoneDescriptionText=zhoneDescriptionText, ifStkDefCardType=ifStkDefCardType, ifStkDefAdminStatus=ifStkDefAdminStatus, pportIndex=pportIndex, ifIndexToPhysicalEntry=ifIndexToPhysicalEntry, ifInverseStackStatus=ifInverseStackStatus, subPortNumber=subPortNumber, zhoneIfXEntry=zhoneIfXEntry, zhoneIfType=zhoneIfType, zhoneIfTypeExtension=zhoneIfTypeExtension, ifStkDefUnits=ifStkDefUnits, zhoneLineRedStatusEntry=zhoneLineRedStatusEntry, physicalToIfIndexEntry=physicalToIfIndexEntry, zhoneIfXDescriptionIndexNext=zhoneIfXDescriptionIndexNext, zhoneIfXEntrySubportAlias=zhoneIfXEntrySubportAlias, zhoneIfXTable=zhoneIfXTable, zhoneLineRedOpStatus=zhoneLineRedOpStatus, zhonePhysicalIfIndex=zhonePhysicalIfIndex, zhoneLineRedundancySafe=zhoneLineRedundancySafe, xxxifTypexxx=xxxifTypexxx, zhonePhysicalToIfIndexEntry=zhonePhysicalToIfIndexEntry, zhoneIfXEntryShelfAlias=zhoneIfXEntryShelfAlias, ifInverseStackHigherLayer=ifInverseStackHigherLayer, ifInverseStackTable=ifInverseStackTable, zhoneLineRedStatusTable=zhoneLineRedStatusTable, ifIndexNext=ifIndexNext, zhoneLineRedTrapsPrefix=zhoneLineRedTrapsPrefix, ifTypeExtension=ifTypeExtension)
