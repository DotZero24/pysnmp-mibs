# SNMP MIB module (A3COM-HUAWEI-PPP-OVER-SONET-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-PPP-OVER-SONET-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:43:50 2025
...
h3cPosParamTableEntry = _H3cPosParamTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1)
)
...
h3cPosCRC = _H3cPosCRC_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 1),
    _H3cPosCRC_Type()
)
...
h3cPosMTU = _H3cPosMTU_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 2),
    _H3cPosMTU_Type()
)
...
_H3cPosScramble_Type.__name__ = "TruthValue"
_H3cPosScramble_Object = MibTableColumn
h3cPosScramble = _H3cPosScramble_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 3),
...
h3cPosClockSource = _H3cPosClockSource_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 4),
...
h3cPosSdhFlagJ0 = _H3cPosSdhFlagJ0_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 5),
...
h3cPosSdhFlagJ1 = _H3cPosSdhFlagJ1_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 6),
...
h3cPosSonetFlagJ0 = _H3cPosSonetFlagJ0_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 7),
...
h3cPosSonetFlagJ1 = _H3cPosSonetFlagJ1_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 8),
...
h3cPosFlagC2 = _H3cPosFlagC2_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 9),
    _H3cPosFlagC2_Type()
)
...
h3cPosFrameType = _H3cPosFrameType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 10),
...
h3cPosBindVlanId = _H3cPosBindVlanId_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 11),
...
h3cPosEncapsulation = _H3cPosEncapsulation_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 12),
...
h3cPoskeepaliveTimeout = _H3cPoskeepaliveTimeout_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 13),
...
h3cPosBERthresholdSF = _H3cPosBERthresholdSF_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 14),
...
h3cPosBERthresholdSD = _H3cPosBERthresholdSD_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 15),
...
h3cPosB1Error = _H3cPosB1Error_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 16),
    _H3cPosB1Error_Type()
)
...
h3cPosB2Error = _H3cPosB2Error_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 17),
    _H3cPosB2Error_Type()
)
...
h3cPosB3Error = _H3cPosB3Error_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 18),
    _H3cPosB3Error_Type()
)
...
h3cPosM1Error = _H3cPosM1Error_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 19),
    _H3cPosM1Error_Type()
)
...
h3cPosG1Error = _H3cPosG1Error_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 20),
    _H3cPosG1Error_Type()
)
...
h3cPosFlagJ0Type = _H3cPosFlagJ0Type_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 21),
...
h3cPosFlagJ1Type = _H3cPosFlagJ1Type_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 22),
...
h3cPosB1TCAThreshold = _H3cPosB1TCAThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 23),
...
h3cPosB2TCAThreshold = _H3cPosB2TCAThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 24),
...
h3cPosB3TCAThreshold = _H3cPosB3TCAThreshold_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 25),
...
h3cPosB1TCAEnable = _H3cPosB1TCAEnable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 26),
...
h3cPosB2TCAEnable = _H3cPosB2TCAEnable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 27),
...
h3cPosB3TCAEnable = _H3cPosB3TCAEnable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 1, 1, 1, 28),
...
h3cPosLOSAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 1)
)
...
h3cPosLOFAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 2)
)
...
h3cPosOOFAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 3)
)
...
h3cPosLAISAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 4)
)
...
h3cPosLRDIAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 5)
)
...
h3cPosPRDIAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 6)
)
...
h3cPosPAISAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 7)
)
...
h3cPosLOPAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 8)
)
...
h3cPosSTIMAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 9)
)
...
h3cPosPTIMAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 10)
)
...
h3cPosPSLMAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 11)
)
...
h3cPosLSDAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 12)
)
...
h3cPosLSFAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 13)
)
...
h3cPosNormalAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 14)
)
...
h3cPosB1TCAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 15)
)
...
h3cPosB2TCAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 16)
)
...
h3cPosB3TCAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 19, 2, 0, 17)
)
...
mibBuilder.exportSymbols(
    "A3COM-HUAWEI-PPP-OVER-SONET-MIB",
    **{"h3cPos": h3cPos,
