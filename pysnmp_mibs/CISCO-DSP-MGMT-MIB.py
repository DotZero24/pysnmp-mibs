...
mibBuilder.exportSymbols("CISCO-DSP-MGMT-MIB", cdspMgmtComplianceRev2=cdspMgmtComplianceRev2, cdspRtcpTimerControl=cdspRtcpTimerControl, cdspVoiceObjects=cdspVoiceObjects, cdspConferenceApplication=cdspConferenceApplication, cdspMtpProfileRowStatus=cdspMtpProfileRowStatus, cdspMIBCardStateNotification=cdspMIBCardStateNotification, cdspCardLastResetTime=cdspCardLastResetTime, cdspTranscodeResourceId=cdspTranscodeResourceId, cdspGlobMaxConfTranscodeSess=cdspGlobMaxConfTranscodeSess, cdspMtpAdminState=cdspMtpAdminState, cdspTranscodeProfileMaxAvailSess=cdspTranscodeProfileMaxAvailSess, cdspSigBearerChannelSplit=cdspSigBearerChannelSplit, cdspVoiceInfoGroup=cdspVoiceInfoGroup, cdspTranscodeProfileTable=cdspTranscodeProfileTable, cdspConferenceProfileMaxCodec=cdspConferenceProfileMaxCodec, cdspTranscodeProfileId=cdspTranscodeProfileId, cdspUtilInfoGroup=cdspUtilInfoGroup, cdspVoiceModeIpIp=cdspVoiceModeIpIp, cdspMgmtGeneralInfoGroupRev1=cdspMgmtGeneralInfoGroupRev1, cdspCardMaxChanPerDSP=cdspCardMaxChanPerDSP, cdspMgmtExtGeneralInfoGroupRev1=cdspMgmtExtGeneralInfoGroupRev1, cdspLastAlarmCauseText=cdspLastAlarmCauseText, cdspRtcpRecvMultiplier=cdspRtcpRecvMultiplier, cdspMtpProfileMaxConfSoftSess=cdspMtpProfileMaxConfSoftSess, cdspTransCodingGroup1=cdspTransCodingGroup1, cdspXNumberOfSigCalls=cdspXNumberOfSigCalls, cdspMtpProfileId=cdspMtpProfileId, cdspConferenceProfileEntry=cdspConferenceProfileEntry, cdspMgmtNotificationsGroupRev1=cdspMgmtNotificationsGroupRev1, cdspCurrentAvlbCap=cdspCurrentAvlbCap, cdspStatusXEntry=cdspStatusXEntry, cdspRtcpXrTransMultiplier=cdspRtcpXrTransMultiplier, cdspConferenceAdminState=cdspConferenceAdminState, cdspConferenceProfileGroup=cdspConferenceProfileGroup, cdspMgmtComplianceRev6=cdspMgmtComplianceRev6, cdspCardIndex=cdspCardIndex, cdspMgmtCompliance=cdspMgmtCompliance, cdspMgmtConformance=cdspMgmtConformance, cdspTranscodeProfileRowStatus=cdspTranscodeProfileRowStatus, cdspMgmtComplianceRev12=cdspMgmtComplianceRev12, cdspRtcpTransInterval=cdspRtcpTransInterval, cdspMtpProfileMaxAvailHardSess=cdspMtpProfileMaxAvailHardSess, cdspConferenceProfileTable=cdspConferenceProfileTable, cdspDspfarmInfoGroup=cdspDspfarmInfoGroup, cdspMtpApplicationStatus=cdspMtpApplicationStatus, cdspLastAlarmTime=cdspLastAlarmTime, cdspUtilObjects=cdspUtilObjects, cdspConferenceProfileId=cdspConferenceProfileId, cdspOperStateNotification=cdspOperStateNotification, cdspVadAdaptive=cdspVadAdaptive, cdspMgmtExtGeneralInfoGroup=cdspMgmtExtGeneralInfoGroup, cdspVoiceParamEntry=cdspVoiceParamEntry, cdspNx64Dsp=cdspNx64Dsp, cdspTotAvailMtpSess=cdspTotAvailMtpSess, cdspGlobMaxAvailTranscodeSess=cdspGlobMaxAvailTranscodeSess, cdspCodecTemplateSupported=cdspCodecTemplateSupported, cdspConferenceDescription=cdspConferenceDescription, cdspEnableOperStateNotification=cdspEnableOperStateNotification, cdspConferenceProfileMaxAvailSess=cdspConferenceProfileMaxAvailSess, cdspVoiceInfoGroupRev1=cdspVoiceInfoGroupRev1, cdspMgmtCompliances=cdspMgmtCompliances, cdspXNumberOfBearerCalls=cdspXNumberOfBearerCalls, cdspCardVideoPoolUtilizationThreshold=cdspCardVideoPoolUtilizationThreshold, cdspRtpSidPayloadType=cdspRtpSidPayloadType, cdspMgmtComplianceRev4=cdspMgmtComplianceRev4, cdspCodecPoolIndex=cdspCodecPoolIndex, cdspChannelExtGroup=cdspChannelExtGroup, cdspDspNum=cdspDspNum, cdspRtcpControl=cdspRtcpControl, cdspMgmtComplianceRev7=cdspMgmtComplianceRev7, cdspMgmtVideoNotificationsGroup=cdspMgmtVideoNotificationsGroup, cdspTotUnusedTranscodeSess=cdspTotUnusedTranscodeSess, cdspMgmtComplianceRev8=cdspMgmtComplianceRev8, cdspNumCongestionOccurrence=cdspNumCongestionOccurrence, cdspCongestedDsp=cdspCongestedDsp, cdspMgmtComplianceRev1=cdspMgmtComplianceRev1, cdspXAvailableSigBandwidth=cdspXAvailableSigBandwidth, cdspTranscodeProfileMaxCodec=cdspTranscodeProfileMaxCodec, cdspMgmtComplianceRev9=cdspMgmtComplianceRev9, cdspDtmfPowerTwist=cdspDtmfPowerTwist, cdspMIBNotifications=cdspMIBNotifications, cdspCardStatusTable=cdspCardStatusTable, cdspNormalDsp=cdspNormalDsp, cdspTransparentIpIp=cdspTransparentIpIp, cdspMgmtGroups=cdspMgmtGroups, cdspVideoUsageNotificationEnable=cdspVideoUsageNotificationEnable, cdspVideoOutOfResourceNotificationEnable=cdspVideoOutOfResourceNotificationEnable, cdspInUseChannels=cdspInUseChannels, cdspTranscodeProfileGroup=cdspTranscodeProfileGroup, cdspConferenceResourceId=cdspConferenceResourceId, cdspMgmtComplianceRev11=cdspMgmtComplianceRev11, cdspMgmtNotificationsGroup=cdspMgmtNotificationsGroup, cdspConferenceProfileRowStatus=cdspConferenceProfileRowStatus, cdspMIBEnableCardStatusNotification=cdspMIBEnableCardStatusNotification, cdspTranscodeApplication=cdspTranscodeApplication, cdspConferenceProfileStorageType=cdspConferenceProfileStorageType, cdspActiveChannels=cdspActiveChannels, cdspTranscodeProfileMaxConfSess=cdspTranscodeProfileMaxConfSess, cdspMIBNotificationPrefix=cdspMIBNotificationPrefix, cdspTranscodeService=cdspTranscodeService, cdspUtilEntry=cdspUtilEntry, cdspTranscodeDescription=cdspTranscodeDescription, cdspDspfarmObjects=cdspDspfarmObjects, cdspMgmtNotifications=cdspMgmtNotifications, cdspMtpService=cdspMtpService, cdspCurrentUtilCap=cdspCurrentUtilCap, cdspDtmfPowerLevel=cdspDtmfPowerLevel, cdspRtcpXrControl=cdspRtcpXrControl, cdspMtpProfileMaxAvailSoftSess=cdspMtpProfileMaxAvailSoftSess, cdspTotalDsp=cdspTotalDsp, cdspStatusTable=cdspStatusTable, cdspMgmtComplianceRev3=cdspMgmtComplianceRev3, cdspCardStatusEntry=cdspCardStatusEntry, cdspMgmtVideoInfoGroup=cdspMgmtVideoInfoGroup, cdspMtpProfileMaxConfHardSess=cdspMtpProfileMaxConfHardSess, cdspTranscodeAdminState=cdspTranscodeAdminState, cdspCardResourceUtilization=cdspCardResourceUtilization, cdspPktLossConcealment=cdspPktLossConcealment, cdspDspfarmUtilObjects=cdspDspfarmUtilObjects, cdspConferenceProfileMaxConfSess=cdspConferenceProfileMaxConfSess, cdspMtpResourceId=cdspMtpResourceId, cdspMgmtGeneralInfoGroup=cdspMgmtGeneralInfoGroup, cdspVoiceParamTable=cdspVoiceParamTable, cdspTotUnusedMtpSess=cdspTotUnusedMtpSess, cdspVqmThreshSES=cdspVqmThreshSES, cdspCardState=cdspCardState, cdspOperState=cdspOperState, cdspTotalChannels=cdspTotalChannels, PYSNMP_MODULE_ID=ciscoDspMgmtMIB, cdspStatusXTable=cdspStatusXTable, cdspVoiceInfoGroupRev2=cdspVoiceInfoGroupRev2, cdspCardLastHiWaterUtilization=cdspCardLastHiWaterUtilization, cdspUtilTable=cdspUtilTable, cdspConferenceService=cdspConferenceService, cdspVqmControl=cdspVqmControl, cdspRtcpXrExtRfactor=cdspRtcpXrExtRfactor, cdspFailedDsp=cdspFailedDsp, cdspMtpDescription=cdspMtpDescription, cdspChannelGroup=cdspChannelGroup, cdspMtpProfileEntry=cdspMtpProfileEntry, cdspCardVideoPoolUtilization=cdspCardVideoPoolUtilization, cdspVideoUsageNotification=cdspVideoUsageNotification, cdspAlarms=cdspAlarms, cdspConferenceApplicationStatus=cdspConferenceApplicationStatus, cdspMIBNotificationEnables=cdspMIBNotificationEnables, cdspMtpProfileTable=cdspMtpProfileTable, cdspLastAlarmCause=cdspLastAlarmCause, cdspMtpApplication=cdspMtpApplication, cdspMtpProfileGroup=cdspMtpProfileGroup, cdspTranscodeProfileEntry=cdspTranscodeProfileEntry, ciscoDspMgmtMIB=ciscoDspMgmtMIB, cdspStatusEntry=cdspStatusEntry, cdspMgmtObjects=cdspMgmtObjects, cdspMgmtComplianceRev10=cdspMgmtComplianceRev10, cdspXAvailableBearerBandwidth=cdspXAvailableBearerBandwidth, cdspVQMGroup=cdspVQMGroup, cdspMtpProfileMaxCodec=cdspMtpProfileMaxCodec, cdspTranscodeApplicationStatus=cdspTranscodeApplicationStatus, cdspMgmtComplianceRev5=cdspMgmtComplianceRev5, cdspVideoOutOfResourceNotification=cdspVideoOutOfResourceNotification, cdspRtcpXrGminDefault=cdspRtcpXrGminDefault, cdspCardObjects=cdspCardObjects, cdspDspSwitchOverThreshold=cdspDspSwitchOverThreshold, cdspTransCodingGroup=cdspTransCodingGroup, cdspTotAvailTranscodeSess=cdspTotAvailTranscodeSess, cdspObjects=cdspObjects)
