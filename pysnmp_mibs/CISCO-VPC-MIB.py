...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:28:00 2025
...
mibBuilder.exportSymbols("CISCO-VPC-MIB", cVpcStatsPeerKeepAliveDomainID=cVpcStatsPeerKeepAliveDomainID, cVpcDualActiveDetectionStatus=cVpcDualActiveDetectionStatus, cVpcStatistics=cVpcStatistics, cVpcSystemOperPriority=cVpcSystemOperPriority, cVpcMIBHostLinkStatusGroup=cVpcMIBHostLinkStatusGroup, cVpcRole=cVpcRole, cVpcPeerKeepAliveConfigDomainID=cVpcPeerKeepAliveConfigDomainID, cVpcPeerKeepAlive=cVpcPeerKeepAlive, cVpcPeerKeepAliveVrfName=cVpcPeerKeepAliveVrfName, cVpcPeerKeepAliveMsgSendInterface=cVpcPeerKeepAliveMsgSendInterface, PYSNMP_MODULE_ID=ciscoVpcMIB, cVpcPeerKeepAliveDestAddrType=cVpcPeerKeepAliveDestAddrType, cVpcSystemOperMacAddress=cVpcSystemOperMacAddress, cVpcPeerKeepAliveSourceAddrType=cVpcPeerKeepAliveSourceAddrType, ciscoVpcMIBGroups=ciscoVpcMIBGroups, cVpcStatusHostLinkConsistencyDetail=cVpcStatusHostLinkConsistencyDetail, ciscoVpcMIBCompliance=ciscoVpcMIBCompliance, cVpcStatusHostLinkConsistencyStatus=cVpcStatusHostLinkConsistencyStatus, cVpcStatusPeerLinkEntry=cVpcStatusPeerLinkEntry, cVpcMIBStatisticsGroup=cVpcMIBStatisticsGroup, cVpcPeerKeepAliveStatus=cVpcPeerKeepAliveStatus, cVpcRoleTable=cVpcRoleTable, cVpcPeerKeepAliveEntry=cVpcPeerKeepAliveEntry, cVpcPeerKeepAliveMsgSendStatus=cVpcPeerKeepAliveMsgSendStatus, cVpcPeerKeepAliveStatusInfoGroup=cVpcPeerKeepAliveStatusInfoGroup, cVpcStatusHostLinkDomainID=cVpcStatusHostLinkDomainID, cVpcPeerKeepAliveSourceAddr=cVpcPeerKeepAliveSourceAddr, cVpcSystemAdminMacAddress=cVpcSystemAdminMacAddress, cVpcStatusHostLinkVpcID=cVpcStatusHostLinkVpcID, cVpcStatusPeerLinkTable=cVpcStatusPeerLinkTable, cVpcMIBRoleGroup=cVpcMIBRoleGroup, cVpcPeerKeepAliveInterval=cVpcPeerKeepAliveInterval, cVpcPeerKeepAliveConfigEntry=cVpcPeerKeepAliveConfigEntry, cVpcStatus=cVpcStatus, cVpcStatsPeerKeepAliveTable=cVpcStatsPeerKeepAliveTable, cVpcStatsPeerKeepAliveMsgsSent=cVpcStatsPeerKeepAliveMsgsSent, cVpcPeerKeepAliveDestAddr=cVpcPeerKeepAliveDestAddr, ciscoVpcMIB=ciscoVpcMIB, cVpcPeerKeepAliveTos=cVpcPeerKeepAliveTos, cVpcPeerKeepAliveMsgRcvrStatus=cVpcPeerKeepAliveMsgRcvrStatus, cVpcPeerKeepAliveTimeout=cVpcPeerKeepAliveTimeout, cVpcSystemAdminPriority=cVpcSystemAdminPriority, cVpcStatusHostLinkEntry=cVpcStatusHostLinkEntry, cVpcPeerKeepAliveHoldTimeout=cVpcPeerKeepAliveHoldTimeout, cVpcPeerKeepAliveTable=cVpcPeerKeepAliveTable, cVpcStatusPeerLinkDomainID=cVpcStatusPeerLinkDomainID, cVpcPeerKeepAliveMsgLastReceiveTime=cVpcPeerKeepAliveMsgLastReceiveTime, cVpcMIBPeerLinkStatusGroup=cVpcMIBPeerLinkStatusGroup, cVpcStatusHostLinkIfIndex=cVpcStatusHostLinkIfIndex, cVpcPeerKeepAliveMsgLastSendTime=cVpcPeerKeepAliveMsgLastSendTime, cVpcLocalRoleAdminPriority=cVpcLocalRoleAdminPriority, cVpcLocalOperMacAddress=cVpcLocalOperMacAddress, cVpcRoleEntry=cVpcRoleEntry, cVpcStatsPeerKeepAliveAvgInterval=cVpcStatsPeerKeepAliveAvgInterval, cVpcPeerKeepAliveTosByte=cVpcPeerKeepAliveTosByte, ciscoVpcMIBNotifs=ciscoVpcMIBNotifs, cVpcStatsPeerStatusChangeCount=cVpcStatsPeerStatusChangeCount, cVpcPeerKeepAliveConfigTable=cVpcPeerKeepAliveConfigTable, cVpcStatusPeerLinkIfIndex=cVpcStatusPeerLinkIfIndex, cVpcStatsPeerKeepAliveMsgsRcved=cVpcStatsPeerKeepAliveMsgsRcved, cVpcPeerKeepAliveTime=cVpcPeerKeepAliveTime, cVpcPeerKeepAliveUdpPort=cVpcPeerKeepAliveUdpPort, cVpcStatusHostLinkStatus=cVpcStatusHostLinkStatus, cVpcPeerKeepAliveConfigInfoGroup=cVpcPeerKeepAliveConfigInfoGroup, cVpcPeerKeepAliveMsgReceiveInterface=cVpcPeerKeepAliveMsgReceiveInterface, ciscoVpcMIBObjects=ciscoVpcMIBObjects, cVpcLocalRoleOperPriority=cVpcLocalRoleOperPriority, cVpcRoleStatus=cVpcRoleStatus, cVpcPeerKeepAliveDomainID=cVpcPeerKeepAliveDomainID, cVpcStatusHostLinkTable=cVpcStatusHostLinkTable, ciscoVpcMIBCompliances=ciscoVpcMIBCompliances, cVpcRoleDomainID=cVpcRoleDomainID, cVpcPeerKeepAlivePrecedence=cVpcPeerKeepAlivePrecedence, ciscoVpcMIBConformance=ciscoVpcMIBConformance, cVpcStatsPeerKeepAliveEntry=cVpcStatsPeerKeepAliveEntry)
