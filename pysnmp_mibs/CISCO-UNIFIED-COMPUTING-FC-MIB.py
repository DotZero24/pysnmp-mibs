...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-FC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:27:29 2025
...
cucsFcPIoIsBreakoutXcvr = _CucsFcPIoIsBreakoutXcvr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 20, 4, 1, 53),
    _CucsFcPIoIsBreakoutXcvr_Type()
)
cucsFcPIoIsBreakoutXcvr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsFcPIoIsBreakoutXcvr.setStatus("current")
_CucsFcPIoPortCapability_Type = CucsPortapiPeerCapability
_CucsFcPIoPortCapability_Object = MibTableColumn
cucsFcPIoPortCapability = _CucsFcPIoPortCapability_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 20, 4, 1, 54),
    _CucsFcPIoPortCapability_Type()
)
cucsFcPIoPortCapability.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsFcPIoPortCapability.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsFcObjects": cucsFcObjects,
       ...
       "cucsFcPIoIsBreakoutXcvr": cucsFcPIoIsBreakoutXcvr,
       "cucsFcPIoPortCapability": cucsFcPIoPortCapability,
