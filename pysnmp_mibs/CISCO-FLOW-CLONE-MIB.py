...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FLOW-CLONE-MIB
...
_CfcCloneProfileStorageType_Type.__name__ = "StorageType"
...
_CfcFlowIpStorageType_Type.__name__ = "StorageType"
...
ciscoCloneFlowCompliance01.setObjects(
      *(("CISCO-FLOW-CLONE-MIB", "cfcCloneProfileGroup"),
        ("CISCO-FLOW-CLONE-MIB", "cfcFlowGroup"),
        ("CISCO-FLOW-CLONE-MIB", "cfcFlowStatsGroup"))
)
if mibBuilder.loadTexts:
