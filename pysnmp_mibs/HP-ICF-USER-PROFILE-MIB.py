...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-USER-PROFILE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:36:42 2025
...
_HpicfUsrProfileConfigTaggedEgressVlanEnable_Type.__name__ = "TruthValue"
...
_HpicfUsrProfileConfigIngressVlanFilterEnable_Type.__name__ = "TruthValue"
...
hpicfUsrProfileCompliance.setObjects(
      *(("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileCapabilityGroup"),
        ("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileConfigGroup"),
        ("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileStatsGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUsrProfileCompliance2.setObjects(
      *(("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileCapabilityGroup"),
        ("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileConfigGroup"),
        ("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileStatsGroup"),
        ("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileConfigGroup2"))
)
if mibBuilder.loadTexts:
...
hpicfUsrProfileCompliance3.setObjects(
      *(("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileCapabilityGroup"),
        ("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileConfigGroup"),
        ("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileStatsGroup1"))
)
if mibBuilder.loadTexts:
...
hpicfUsrProfileCompliance4.setObjects(
    ("HP-ICF-USER-PROFILE-MIB", "hpicfUsrProfileConfigGroup2")
)
if mibBuilder.loadTexts:
