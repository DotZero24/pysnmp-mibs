# SNMP MIB module (ARICENT-MIStdRSTP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-MIStdRSTP-MIB
...
fsRstpBridgeGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2076, 116, 11, 2, 1, 1)
)
fsRstpBridgeGroup.setObjects(
      *(("ARICENT-MIStdRSTP-MIB", "fsDot1dStpVersion"),
        ("ARICENT-MIStdRSTP-MIB", "fsDot1dStpTxHoldCount"))
)
if mibBuilder.loadTexts:
    fsRstpBridgeGroup.setStatus("current")

fsRstpPortGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2076, 116, 11, 2, 1, 2)
)
fsRstpPortGroup.setObjects(
      *(("ARICENT-MIStdRSTP-MIB", "fsDot1dStpPortProtocolMigration"),
        ("ARICENT-MIStdRSTP-MIB", "fsDot1dStpPortAdminEdgePort"),
        ("ARICENT-MIStdRSTP-MIB", "fsDot1dStpPortOperEdgePort"),
        ("ARICENT-MIStdRSTP-MIB", "fsDot1dStpPortAdminPointToPoint"),
        ("ARICENT-MIStdRSTP-MIB", "fsDot1dStpPortOperPointToPoint"))
)
if mibBuilder.loadTexts:
...
fsRstpCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2076, 116, 11, 2, 2, 1)
)
fsRstpCompliance.setObjects(
      *(("ARICENT-MIStdRSTP-MIB", "fsRstpBridgeGroup"),
        ("ARICENT-MIStdRSTP-MIB", "fsRstpPortGroup"))
)
if mibBuilder.loadTexts:
