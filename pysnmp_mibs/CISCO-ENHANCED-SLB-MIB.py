...
slbServerFarmName, SlbServerString, slbEntity, SlbRealServerState = mibBuilder.importSymbols("CISCO-SLB-MIB", "slbServerFarmName", "SlbServerString", "slbEntity", "SlbRealServerState")
...
mibBuilder.exportSymbols("CISCO-ENHANCED-SLB-MIB", ciscoEnhancedSlbMIBComplianceRev5=ciscoEnhancedSlbMIBComplianceRev5, cesRserverTotalConns=cesRserverTotalConns, cesRealServerProbeRowStatus=cesRealServerProbeRowStatus, cesServerFarmName=cesServerFarmName, cesRealServerStateDownRev1=cesRealServerStateDownRev1, cesRserverMaxConns=cesRserverMaxConns, cesRserverProbeGroup=cesRserverProbeGroup, cesRserverProbeTable=cesRserverProbeTable, cesServerFarmRserverDescr=cesServerFarmRserverDescr, cesServerFarmRserverBackupName=cesServerFarmRserverBackupName, ciscoEnhancedSlbMIBComplianceRev1=ciscoEnhancedSlbMIBComplianceRev1, cesRserverProbesPassed=cesRserverProbesPassed, cesRealServerProbeEntry=cesRealServerProbeEntry, cesRealServerStateChangeRev1=cesRealServerStateChangeRev1, cesServerFarmRserverStateDescr=cesServerFarmRserverStateDescr, cesServerFarmRserverDroppedConns=cesServerFarmRserverDroppedConns, cesRserverAdminStatus=cesRserverAdminStatus, ciscoEnhancedSlbMIB=ciscoEnhancedSlbMIB, cesServerFarmRserverStorageType=cesServerFarmRserverStorageType, cesRealServerStateChange=cesRealServerStateChange, cesRserverCurrConns=cesRserverCurrConns, cesServerFarmRserverEntry=cesServerFarmRserverEntry, ciscoEnhancedSlbMIBComplianceRev4=ciscoEnhancedSlbMIBComplianceRev4, cesRserverProbeStorageType=cesRserverProbeStorageType, cesServerFarmRserverMinConns=cesServerFarmRserverMinConns, cesRserverProbeHealthMonState=cesRserverProbeHealthMonState, cesRserverName=cesRserverName, cesRealServerGroup=cesRealServerGroup, cesProbeName=cesProbeName, cesRserverProbeGroupRev1=cesRserverProbeGroupRev1, cesRealServerProbeTable=cesRealServerProbeTable, cesRealServerStateDown=cesRealServerStateDown, cesRserverProbeEntry=cesRserverProbeEntry, cesRealServerNotifGroup=cesRealServerNotifGroup, cesServerFarmRserverTable=cesServerFarmRserverTable, cesRserverAdminWeight=cesRserverAdminWeight, cesServerFarmRserverTotalConns=cesServerFarmRserverTotalConns, cesRealServerGroupRev2=cesRealServerGroupRev2, cesServerFarmRserverRowStatus=cesServerFarmRserverRowStatus, cesRserverProbeLastActiveTime=cesRserverProbeLastActiveTime, cesRserverOperStatus=cesRserverOperStatus, cesRserverProbeName=cesRserverProbeName, cesServerFarmRserverBuddyGroup=cesServerFarmRserverBuddyGroup, ciscoEnhancedSlbMIBConformance=ciscoEnhancedSlbMIBConformance, cesRserverEntry=cesRserverEntry, PYSNMP_MODULE_ID=ciscoEnhancedSlbMIB, cesStickyConfig=cesStickyConfig, ciscoEnhancedSlbMIBComplianceRev2=ciscoEnhancedSlbMIBComplianceRev2, cesNotificationObjects=cesNotificationObjects, cesRserverDescription=cesRserverDescription, cesServerFarmRserverBackupPort=cesServerFarmRserverBackupPort, cesRealServerNotifGroupRev2=cesRealServerNotifGroupRev2, cesRealServerFarmBuddyGroup=cesRealServerFarmBuddyGroup, cesRealServerFarmGroup=cesRealServerFarmGroup, cesRealServer=cesRealServer, ciscoEnhancedSlbMIBGroups=ciscoEnhancedSlbMIBGroups, cesServerFarmRserverAdminWeight=cesServerFarmRserverAdminWeight, cesRealServerNotifGroupRev1=cesRealServerNotifGroupRev1, cesServerFarmRserverOperStatus=cesServerFarmRserverOperStatus, cesRealserverProbeGroup=cesRealserverProbeGroup, ciscoEnhancedSlbMIBNotifs=ciscoEnhancedSlbMIBNotifs, cesServerFarmRserverAdminStatus=cesServerFarmRserverAdminStatus, cesRserverProbeLastFailedTime=cesRserverProbeLastFailedTime, cesServerFarmRserverOperWeight=cesServerFarmRserverOperWeight, cesRserverStateUp=cesRserverStateUp, ciscoEnhancedSlbMIBComplianceRev3=ciscoEnhancedSlbMIBComplianceRev3, cesRserverStorageType=cesRserverStorageType, cesRserverLocalityChange=cesRserverLocalityChange, cesRserverRedirectCode=cesRserverRedirectCode, cesServerFarmRserverCurrentConns=cesServerFarmRserverCurrentConns, cesRserverRowStatus=cesRserverRowStatus, ciscoEnhancedSlbMIBComplianceRev6=ciscoEnhancedSlbMIBComplianceRev6, cesRserverProbeLastProbeTime=cesRserverProbeLastProbeTime, cesRealServerStateUpRev1=cesRealServerStateUpRev1, ciscoEnhancedSlbMIBCompliance=ciscoEnhancedSlbMIBCompliance, cesRealServerGroupRev1=cesRealServerGroupRev1, cesRealServerNotifGroupRev3=cesRealServerNotifGroupRev3, ciscoEnhancedSlbMIBCompliances=ciscoEnhancedSlbMIBCompliances, cesRserverLocality=cesRserverLocality, cesRserverRedirectPort=cesRserverRedirectPort, cesServerFarmRserverFailedConns=cesServerFarmRserverFailedConns, cesRserverRedirectRelocationStr=cesRserverRedirectRelocationStr, cesRserverMinConns=cesRserverMinConns, cesRserverTable=cesRserverTable, cesRealServerProbeStorageType=cesRealServerProbeStorageType, cesRserverIpAddress=cesRserverIpAddress, SlbRserverLocalityState=SlbRserverLocalityState, cesServerFarmRserverPort=cesServerFarmRserverPort, cesRserverIpAddressType=cesRserverIpAddressType, cesRealServerName=cesRealServerName, cesRserverProbeRowStatus=cesRserverProbeRowStatus, cesRserverType=cesRserverType, cesDfpAgent=cesDfpAgent, cesRealServerStateUp=cesRealServerStateUp, cesNotifControl=cesNotifControl, cesRserverStateDown=cesRserverStateDown, cesRserverStateChange=cesRserverStateChange, cesRealServerNotifEnable=cesRealServerNotifEnable, cesRserverStatechangeDescr=cesRserverStatechangeDescr, cesServerFarmRserverMaxConns=cesServerFarmRserverMaxConns, cesRserverFailedConns=cesRserverFailedConns, ciscoEnhancedSlbMIBObjects=ciscoEnhancedSlbMIBObjects, CiscoRserverAdminStatus=CiscoRserverAdminStatus, cesRealServerFarmGroupRev1=cesRealServerFarmGroupRev1, cesRserverProbesFailed=cesRserverProbesFailed, cesNotificationObjectGroup=cesNotificationObjectGroup)
