...
class _Sleep_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_S,1),(_P,2)))
...
class _Direct_connect_ports_enable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_S,1),(_P,2),(_W,3)))
...
class _Remote_upgrade_version_checking_enable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_F,1),(_o,3)))
...
class __pysmi_continue_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(1));namedValues=NamedValues((_y,1))
...
class _Ews_request_control_panel_supplies_status_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_S,1),(_P,2)))
...
class _Usb_host_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_S,1),(_P,2)))
...
class _Mass_storage_resource_changed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(2));namedValues=NamedValues((_P,2))
...
class _Ram_disk_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_F,1),(_o,3)))
...
class _Firmware_download_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_S,1),(_P,2)))
...
class _Upgradable_devices_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_S,1),(_P,2)))
...
class _Default_scan_original_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,15,25,26,45,32767)));namedValues=NamedValues(*((_K,1),(_I,2),(_L,3),(_R,10),(_m,15),(_M,25),(_J,26),(_N,45),(_l,32767)))
...
class _Default_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,11,15,17,19,24,25,26,27,39,44,45,46,72,80,81,90,91,100,101,120,258,282,32767)));namedValues=NamedValues(*((_K,1),(_I,2),(_L,3),(_R,10),(_c,11),(_m,15),(_O,17),(_d,19),('eISOandJISA6',24),(_M,25),(_J,26),(_e,27),('eISORA3',39),('eJISB6',44),(_N,45),(_X,46),(_A4,72),(_g,80),(_h,81),(_i,90),(_j,91),(_k,100),(_Q,101),('eTabloidExtra',120),(_r,258),(_s,282),(_l,32767)))
...
class _Reprint_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_F,1),(_H,2),(_o,3)))
...
class _Form_feed_needed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_S,1),(_P,2)))
...
class _Override_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_K,1),(_I,2),(_L,3),(_c,11),(_O,17),(_p,18),(_d,19),(_M,25),(_J,26),(_e,27),(_N,45),(_X,46),('eISOB5',65),(_A4,72),(_g,80),(_h,81),(_i,90),(_j,91),(_k,100),(_Q,101),(_r,258),(_s,282),(_l,32767)))
...
class _Default_staple_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8,9)));namedValues=NamedValues(*((_n,1),('eNormal',2),('eAngled',3),('eTwoStaples',4),('eThreeStaples',5),('eSixStaples',6),('eCustomStapleMode',7),('eOppositeCorner',8),('eSaddleStitch',9)))
...
class _Tray2_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,17,25,26,45,101,32764)));namedValues=NamedValues(*((_K,1),(_I,2),(_L,3),(_R,10),(_O,17),(_M,25),(_J,26),(_N,45),(_Q,101),(_f,32764)))
...
class _Tray3_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,17,25,26,45,46,101,32764)));namedValues=NamedValues(*((_K,1),(_I,2),(_L,3),(_R,10),(_O,17),(_M,25),(_J,26),(_N,45),(_X,46),(_Q,101),(_f,32764)))
...
class _Tray5_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,11,17,19,25,26,27,45,46,101,32764)));namedValues=NamedValues(*((_K,1),(_I,2),(_L,3),(_R,10),(_c,11),(_O,17),(_d,19),(_M,25),(_J,26),(_e,27),(_N,45),(_X,46),(_Q,101),(_f,32764)))
...
class _Tray6_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,11,17,19,25,26,27,45,46,101,32764)));namedValues=NamedValues(*((_K,1),(_I,2),(_L,3),(_R,10),(_c,11),(_O,17),(_d,19),(_M,25),(_J,26),(_e,27),(_N,45),(_X,46),(_Q,101),(_f,32764)))
...
class _Tray7_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,11,17,19,25,26,27,45,46,101,32764)));namedValues=NamedValues(*((_K,1),(_I,2),(_L,3),(_R,10),(_c,11),(_O,17),(_d,19),(_M,25),(_J,26),(_e,27),(_N,45),(_X,46),(_Q,101),(_f,32764)))
...
class _Default_copier_flip_pages_up_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_S,1),(_P,2)))
...
class _Default_copier_pages_per_sheet_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,6,7,8)));namedValues=NamedValues(*((_n,1),('eTwoUp',6),('eFourUpNOrder',7),('eFourUpZOrder',8)))
...
class _Default_copier_page_borders_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_n,1),('eLine',2)))
...
class _Default_copier_edge_to_edge_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_n,1),('eScale',2),('eClip',3)))
