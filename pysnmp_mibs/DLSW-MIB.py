...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:48:55 2025
...
mibBuilder.exportSymbols("DLSW-MIB", dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswDomains=dlswDomains, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswDirectory=dlswDirectory, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirNBLocation=dlswDirNBLocation, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, TAddress=TAddress, dlswDirMacEntries=dlswDirMacEntries, dlswCompliances=dlswCompliances, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitS1Dlc=dlswCircuitS1Dlc, null=null, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirNBTable=dlswDirNBTable, dlswIfRowStatus=dlswIfRowStatus, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, EndStationLocation=EndStationLocation, dlswDirMacMask=dlswDirMacMask, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswCircuit=dlswCircuit, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacTable=dlswDirMacTable, dlswDirMacMac=dlswDirMacMac, dlswTrapControl=dlswTrapControl, dlswMIB=dlswMIB, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswInterfaceGroup=dlswInterfaceGroup, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswDirNBEntry=dlswDirNBEntry, dlswDirMacIndex=dlswDirMacIndex, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirLocate=dlswDirLocate, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTCPDomain=dlswTCPDomain, dlswTConnOperState=dlswTConnOperState, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirStat=dlswDirStat, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswDirCompliance=dlswDirCompliance, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitS2TDomain=dlswCircuitS2TDomain, LFSize=LFSize, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConn=dlswTConn, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlsw=dlsw, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnOperTable=dlswTConnOperTable, dlswDirNBLFSize=dlswDirNBLFSize, dlswInterface=dlswInterface, dlswNodeUpTime=dlswNodeUpTime, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswNodeVendorID=dlswNodeVendorID, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswIfTable=dlswIfTable, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitEntry=dlswCircuitEntry, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswCircuitS1DlcType=dlswCircuitS1DlcType, PYSNMP_MODULE_ID=dlsw, DlswTCPAddress=DlswTCPAddress, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswNodeGroup=dlswNodeGroup, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswSdlcLsTable=dlswSdlcLsTable, DlcType=DlcType, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswIfEntry=dlswIfEntry, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirNBStatus=dlswDirNBStatus, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswIfSapList=dlswIfSapList, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswCircuitGroup=dlswCircuitGroup, dlswDirMacLFSize=dlswDirMacLFSize, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswTConnTcp=dlswTConnTcp, dlswTConnNBGroup=dlswTConnNBGroup, dlswSdlc=dlswSdlc, dlswTConnSpecific=dlswTConnSpecific, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigTable=dlswTConnConfigTable, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitPriority=dlswCircuitPriority, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswDirMacEntry=dlswDirMacEntry, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNodeVersionString=dlswNodeVersionString, dlswDirMacEntryType=dlswDirMacEntryType, dlswTraps=dlswTraps, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitState=dlswCircuitState, dlswNotificationGroup=dlswNotificationGroup, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswDirNBEntries=dlswDirNBEntries, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirGroup=dlswDirGroup, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswDirNBName=dlswDirNBName, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswCircuitStat=dlswCircuitStat, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperConnectTime=dlswTConnOperConnectTime, NBName=NBName, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswConformance=dlswConformance, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnOperCirCreates=dlswTConnOperCirCreates, MacAddressNC=MacAddressNC, dlswCircuitStatActives=dlswCircuitStatActives, dlswNode=dlswNode, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnStat=dlswTConnStat, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswDirCache=dlswDirCache, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirNBLocationType=dlswDirNBLocationType, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswGroups=dlswGroups, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswCircuitTable=dlswCircuitTable, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirNBGroup=dlswDirNBGroup, dlswNodeStatus=dlswNodeStatus, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswNodeVersion=dlswNodeVersion)
