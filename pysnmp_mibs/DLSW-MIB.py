...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/DLSW-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:26:54 2025
...
ModuleIdentity, Counter64, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, MibIdentifier, TimeTicks, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "Bits", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("DLSW-MIB", EndStationLocation=EndStationLocation, dlswTConn=dlswTConn, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswNotificationGroup=dlswNotificationGroup, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswCircuit=dlswCircuit, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswIfTable=dlswIfTable, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswNodeUpTime=dlswNodeUpTime, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperGroup=dlswTConnOperGroup, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, DlswTCPAddress=DlswTCPAddress, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswGroups=dlswGroups, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswDirLocate=dlswDirLocate, dlswInterface=dlswInterface, LFSize=LFSize, dlswDirCache=dlswDirCache, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswDirMacStatus=dlswDirMacStatus, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTConnOperTable=dlswTConnOperTable, dlswCircuitGroup=dlswCircuitGroup, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswCircuitStat=dlswCircuitStat, dlswIfSapList=dlswIfSapList, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswDirLocateMacMatch=dlswDirLocateMacMatch, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswDirNBName=dlswDirNBName, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirMacEntry=dlswDirMacEntry, dlswTrapTConnUp=dlswTrapTConnUp, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitState=dlswCircuitState, dlswMIB=dlswMIB, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswDirNBIndex=dlswDirNBIndex, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswCircuitStatActives=dlswCircuitStatActives, dlswNode=dlswNode, dlswDirMacEntryType=dlswDirMacEntryType, NBName=NBName, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirCompliance=dlswDirCompliance, dlswDirNBLFSize=dlswDirNBLFSize, null=null, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswInterfaceGroup=dlswInterfaceGroup, dlswSdlcLsEntries=dlswSdlcLsEntries, dlswTrapControl=dlswTrapControl, dlswDirMacMac=dlswDirMacMac, dlswCircuitOrigin=dlswCircuitOrigin, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnStatGroup=dlswTConnStatGroup, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswDirLocateMacTable=dlswDirLocateMacTable, MacAddressNC=MacAddressNC, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswDirStat=dlswDirStat, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirectory=dlswDirectory, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswDirMacMask=dlswDirMacMask, dlswSdlc=dlswSdlc, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswDirNBEntries=dlswDirNBEntries, dlswDirMacTable=dlswDirMacTable, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswDirMacCacheHits=dlswDirMacCacheHits, dlswNodeVendorID=dlswNodeVendorID, dlswDirNBLocationType=dlswDirNBLocationType, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswDirLocateMacLocation=dlswDirLocateMacLocation, PYSNMP_MODULE_ID=dlsw, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswCircuitS2Location=dlswCircuitS2Location, dlswDirNBRowStatus=dlswDirNBRowStatus, TAddress=TAddress, dlswTCPDomain=dlswTCPDomain, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswTConnStat=dlswTConnStat, dlswDomains=dlswDomains, dlswDirNBLocation=dlswDirNBLocation, dlswIfRowStatus=dlswIfRowStatus, dlswDirGroup=dlswDirGroup, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswCircuitEntry=dlswCircuitEntry, DlcType=DlcType, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswTConnTcp=dlswTConnTcp, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswNodeGroup=dlswNodeGroup, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswTraps=dlswTraps, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirNBNameType=dlswDirNBNameType, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswCircuitTable=dlswCircuitTable, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswDirLocateNBName=dlswDirLocateNBName, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswConformance=dlswConformance, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswTConnSpecific=dlswTConnSpecific, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswNodeNBGroup=dlswNodeNBGroup, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnNBGroup=dlswTConnNBGroup, dlswDirLocateGroup=dlswDirLocateGroup, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswDirMacIndex=dlswDirMacIndex, dlswCompliances=dlswCompliances, dlswSdlcCompliance=dlswSdlcCompliance, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswSdlcLsTable=dlswSdlcLsTable, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswDirMacEntries=dlswDirMacEntries, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCoreCompliance=dlswCoreCompliance, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswNodeStatus=dlswNodeStatus, dlswDirNBTable=dlswDirNBTable, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswIfEntry=dlswIfEntry, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswNodeVersionString=dlswNodeVersionString, dlswNodeVersion=dlswNodeVersion, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswCircuitPriority=dlswCircuitPriority, dlsw=dlsw, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirNBGroup=dlswDirNBGroup, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperState=dlswTConnOperState, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted)
