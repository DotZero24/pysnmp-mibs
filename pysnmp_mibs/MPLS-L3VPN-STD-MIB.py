...
# Notes
# -----
# ASN.1 source file://mibs/rfc/MPLS-L3VPN-STD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:23:53 2025
...
_MplsL3VpnNotificationEnable_Type.__name__ = "TruthValue"
...
_MplsL3VpnVrfConfRteMxThrshTime_Type.__name__ = "Unsigned32"
...
_MplsL3VpnIfConfStorageType_Type.__name__ = "StorageType"
...
class _MplsL3VpnVrfDescription_Type(SnmpAdminString):
    """Custom type mplsL3VpnVrfDescription based on SnmpAdminString"""
    defaultValue = OctetString("")


_MplsL3VpnVrfDescription_Type.__name__ = "SnmpAdminString"
...
class _MplsL3VpnVrfRD_Type(MplsL3VpnRouteDistinguisher):
    """Custom type mplsL3VpnVrfRD based on MplsL3VpnRouteDistinguisher"""
    defaultValue = OctetString("")


_MplsL3VpnVrfRD_Type.__name__ = "MplsL3VpnRouteDistinguisher"
...
_MplsL3VpnVrfConfMidRteThresh_Type.__name__ = "Unsigned32"
...
_MplsL3VpnVrfConfHighRteThresh_Type.__name__ = "Unsigned32"
...
_MplsL3VpnVrfConfMaxRoutes_Type.__name__ = "Unsigned32"
...
_MplsL3VpnVrfConfStorageType_Type.__name__ = "StorageType"
...
class _MplsL3VpnVrfRT_Type(MplsL3VpnRouteDistinguisher):
    """Custom type mplsL3VpnVrfRT based on MplsL3VpnRouteDistinguisher"""
    defaultValue = OctetString("")


_MplsL3VpnVrfRT_Type.__name__ = "MplsL3VpnRouteDistinguisher"
...
class _MplsL3VpnVrfRTDescr_Type(SnmpAdminString):
    """Custom type mplsL3VpnVrfRTDescr based on SnmpAdminString"""
    defaultValue = OctetString("")


_MplsL3VpnVrfRTDescr_Type.__name__ = "SnmpAdminString"
...
_MplsL3VpnVrfRTStorageType_Type.__name__ = "StorageType"
...
_MplsL3VpnVrfRteInetCidrIfIndex_Type.__name__ = "InterfaceIndexOrZero"
...
_MplsL3VpnVrfRteInetCidrNextHopAS_Type.__name__ = "InetAutonomousSystemNumber"
...
mplsL3VpnModuleFullCompliance.setObjects(
      *(("MPLS-L3VPN-STD-MIB", "mplsL3VpnScalarGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnVrfGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnIfGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnPerfGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnVrfRteGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnVrfRTGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnSecGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnNotificationGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnPerfRouteGroup"))
)
if mibBuilder.loadTexts:
...
mplsL3VpnModuleReadOnlyCompliance.setObjects(
      *(("MPLS-L3VPN-STD-MIB", "mplsL3VpnScalarGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnVrfGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnIfGroup"),
        ("MPLS-L3VPN-STD-MIB", "mplsL3VpnPerfGroup"),
