# SNMP MIB module (LANCOM-MAB-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-MAB-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:20:45 2025
...
agentMabPortConfigEntry = _AgentMabPortConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 75, 2, 1, 1)
)
agentMabPortConfigEntry.setIndexNames(
    (0, "LANCOM-MAB-MIB", "agentMabIfIndex"),
)
if mibBuilder.loadTexts:
...
agentMabIfIndex = _AgentMabIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 75, 2, 1, 1, 1),
...
agentMABPortEnabled = _AgentMABPortEnabled_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 75, 2, 1, 1, 2),
...
agentMabPortOperational = _AgentMabPortOperational_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 75, 2, 1, 1, 3),
...
agentMabPortAuthType = _AgentMabPortAuthType_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 75, 2, 1, 1, 4),
