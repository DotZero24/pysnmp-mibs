# SNMP MIB module (ALCATEL-ENT1-VIRTUALROUTER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-VIRTUALROUTER-MIB
...
alaVirtualRouterNameEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterName"),
)
if mibBuilder.loadTexts:
...
_AlaVirtualRouterNoAutoLoadVrrp_Type.__name__ = "TruthValue"
...
alaVrConfigEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigIndex"),
)
if mibBuilder.loadTexts:
...
alaVirtualRouterProfileEntry.setIndexNames(
    (0, "ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterProfileName"),
)
if mibBuilder.loadTexts:
...
alaVirtualRouterConfigMIBGroup.setObjects(
      *(("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterNameIndex"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterNameRowStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterProfile"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterMaxRouteMaps"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterMaxSequences"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterMaxTlvs"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterMaxAccessLists"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterMaxAddressBlocks"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterMaxMatchInterfaces"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterNoAutoLoadVrrp"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigRipStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigOspfStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigIsisStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigBgpStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigPimStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigDvmrpStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigRipngStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigOspf3Status"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigMplsLdpStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVrConfigVrrpStatus"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterProfileMaxRouteMaps"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterProfileMaxSequences"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterProfileMaxTlvs"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterProfileMaxAccessLists"),
        ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterProfileMaxAddressBlocks"),
...
alaVirtualRouterCompliance.setObjects(
    ("ALCATEL-ENT1-VIRTUALROUTER-MIB", "alaVirtualRouterConfigMIBGroup")
)
if mibBuilder.loadTexts:
