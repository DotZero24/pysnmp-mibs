...
mibBuilder.exportSymbols("ALCATEL-ENT1-VIRTUALROUTER-MIB", alaVrConfigRipngStatus=alaVrConfigRipngStatus, alaVrConfigPimStatus=alaVrConfigPimStatus, alaVrConfigDvmrpStatus=alaVrConfigDvmrpStatus, alaVrConfigBgpStatus=alaVrConfigBgpStatus, alaVirtualRouterProfileEntry=alaVirtualRouterProfileEntry, alaVirtualRouterNameTable=alaVirtualRouterNameTable, alaVirtualRouterName=alaVirtualRouterName, alaVirtualRouterProfileMaxSequences=alaVirtualRouterProfileMaxSequences, alaVirtualRouterNoAutoLoadVrrp=alaVirtualRouterNoAutoLoadVrrp, alaVirtualRouterProfileName=alaVirtualRouterProfileName, alcatelIND1VirtualRouterMIB=alcatelIND1VirtualRouterMIB, alaVirtualRouterNameIndex=alaVirtualRouterNameIndex, alaVirtualRouterMaxRouteMaps=alaVirtualRouterMaxRouteMaps, alaVrConfigVrrpStatus=alaVrConfigVrrpStatus, alaVirtualRouterProfileMaxAccessLists=alaVirtualRouterProfileMaxAccessLists, alaVrConfigIsisStatus=alaVrConfigIsisStatus, alaVrConfigRipStatus=alaVrConfigRipStatus, alaVirtualRouterProfileMaxAddressBlocks=alaVirtualRouterProfileMaxAddressBlocks, alaVirtualRouterMaxMatchInterfaces=alaVirtualRouterMaxMatchInterfaces, alaVrConfigEntry=alaVrConfigEntry, alcatelIND1VirtualRouterMIBCompliances=alcatelIND1VirtualRouterMIBCompliances, alaVirtualRouterProfile=alaVirtualRouterProfile, alaVirtualRouterMaxAddressBlocks=alaVirtualRouterMaxAddressBlocks, alaVirtualRouterCompliance=alaVirtualRouterCompliance, alaVrConfigOspf3Status=alaVrConfigOspf3Status, alaVirtualRouterProfileTable=alaVirtualRouterProfileTable, alcatelIND1VirtualRouterMIBGroups=alcatelIND1VirtualRouterMIBGroups, alaVirtualRouterConfigMIBGroup=alaVirtualRouterConfigMIBGroup, alaVrConfigIndex=alaVrConfigIndex, alaVirtualRouterProfileMaxRouteMaps=alaVirtualRouterProfileMaxRouteMaps, alaVirtualRouterMaxSequences=alaVirtualRouterMaxSequences, alaVirtualRouterProfileMaxTlvs=alaVirtualRouterProfileMaxTlvs, alaVirtualRouterMaxTlvs=alaVirtualRouterMaxTlvs, alaVirtualRouterProfileMaxMatchInterfaces=alaVirtualRouterProfileMaxMatchInterfaces, alaVrConfigMplsLdpStatus=alaVrConfigMplsLdpStatus, alaVirtualRouterNameEntry=alaVirtualRouterNameEntry, PYSNMP_MODULE_ID=alcatelIND1VirtualRouterMIB, alaVirtualRouterConfig=alaVirtualRouterConfig, alcatelIND1VirtualRouterMIBObjects=alcatelIND1VirtualRouterMIBObjects, alaVirtualRouterNameRowStatus=alaVirtualRouterNameRowStatus, alaVrConfigOspfStatus=alaVrConfigOspfStatus, alcatelIND1VirtualRouterMIBConformance=alcatelIND1VirtualRouterMIBConformance, alaVrConfigTable=alaVrConfigTable, alaVirtualRouterMaxAccessLists=alaVirtualRouterMaxAccessLists)
