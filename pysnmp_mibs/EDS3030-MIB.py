# SNMP MIB module (EDS3030-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/eds/EDS3030-MIB
...
dTrapDeviceEntry.setIndexNames(
    (0, "EDS3030-MIB", "dTrapDeviceIndex"),
)
if mibBuilder.loadTexts:
