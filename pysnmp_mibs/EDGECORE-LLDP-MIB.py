...
_H='TruthValue'
_G='LLDP-MIB'
_F='EDGECORE-DEVICEPARAMS-MIB'
_E='EDGECORE-LLDP-MIB'
_D='Integer32'
_C='read-only'
_B='read-write'
_A='current'
...
rlLldp=ModuleIdentity((1,3,6,1,4,1,259,10,1,14,89,110))
...
rlLldpObjects=_RlLldpObjects_ObjectIdentity((1,3,6,1,4,1,259,10,1,14,89,110,1))
_RlLldpConfig_ObjectIdentity=ObjectIdentity
rlLldpConfig=_RlLldpConfig_ObjectIdentity((1,3,6,1,4,1,259,10,1,14,89,110,1,1))
_RlLldpEnabled_Type=TruthValue
_RlLldpEnabled_Object=MibScalar
rlLldpEnabled=_RlLldpEnabled_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,1),_RlLldpEnabled_Type())
...
rlLldpClearRx=_RlLldpClearRx_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,2),_RlLldpClearRx_Type())
...
rlLldpDuMode=_RlLldpDuMode_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,3),_RlLldpDuMode_Type())
...
rlLldpAutoAdvLocPortManAddrTable=_RlLldpAutoAdvLocPortManAddrTable_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,4))
...
rlLldpAutoAdvLocPortManAddrEntry=_RlLldpAutoAdvLocPortManAddrEntry_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,4,1))
...
rlLldpAutoAdvLocPortNum=_RlLldpAutoAdvLocPortNum_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,4,1,1),_RlLldpAutoAdvLocPortNum_Type())
...
rlLldpAutoAdvManAddrOwnerIfId=_RlLldpAutoAdvManAddrOwnerIfId_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,4,1,2),_RlLldpAutoAdvManAddrOwnerIfId_Type())
...
rlLldpAutoAdvManAddrNone=_RlLldpAutoAdvManAddrNone_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,4,1,3),_RlLldpAutoAdvManAddrNone_Type())
...
rlLldpAutoAdvManAddrSubtype=_RlLldpAutoAdvManAddrSubtype_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,4,1,4),_RlLldpAutoAdvManAddrSubtype_Type())
...
rlLldpAutoAdvManAddr=_RlLldpAutoAdvManAddr_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,4,1,5),_RlLldpAutoAdvManAddr_Type())
...
rlLldpAutoAdvPortsStatus=_RlLldpAutoAdvPortsStatus_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,1,4,1,6),_RlLldpAutoAdvPortsStatus_Type())
...
rlLldpXMedConfig=_RlLldpXMedConfig_ObjectIdentity((1,3,6,1,4,1,259,10,1,14,89,110,1,2))
_RlLldpXMedLocMediaPolicyContainerTable_Object=MibTable
rlLldpXMedLocMediaPolicyContainerTable=_RlLldpXMedLocMediaPolicyContainerTable_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1))
...
rlLldpXMedLocMediaPolicyContainerEntry=_RlLldpXMedLocMediaPolicyContainerEntry_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1))
...
rlLldpXMedLocMediaPolicyContainerIndex=_RlLldpXMedLocMediaPolicyContainerIndex_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1,1),_RlLldpXMedLocMediaPolicyContainerIndex_Type())
...
rlLldpXMedLocMediaPolicyContainerAppType=_RlLldpXMedLocMediaPolicyContainerAppType_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1,2),_RlLldpXMedLocMediaPolicyContainerAppType_Type())
...
rlLldpXMedLocMediaPolicyContainerVlanID=_RlLldpXMedLocMediaPolicyContainerVlanID_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1,3),_RlLldpXMedLocMediaPolicyContainerVlanID_Type())
...
rlLldpXMedLocMediaPolicyContainerPriority=_RlLldpXMedLocMediaPolicyContainerPriority_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1,4),_RlLldpXMedLocMediaPolicyContainerPriority_Type())
...
rlLldpXMedLocMediaPolicyContainerDscp=_RlLldpXMedLocMediaPolicyContainerDscp_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1,5),_RlLldpXMedLocMediaPolicyContainerDscp_Type())
...
rlLldpXMedLocMediaPolicyContainerUnknown=_RlLldpXMedLocMediaPolicyContainerUnknown_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1,6),_RlLldpXMedLocMediaPolicyContainerUnknown_Type())
...
rlLldpXMedLocMediaPolicyContainerTagged=_RlLldpXMedLocMediaPolicyContainerTagged_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1,7),_RlLldpXMedLocMediaPolicyContainerTagged_Type())
...
rlLldpXMedLocMediaPolicyContainerPorts=_RlLldpXMedLocMediaPolicyContainerPorts_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1,8),_RlLldpXMedLocMediaPolicyContainerPorts_Type())
...
rlLldpXMedLocMediaPolicyContainerRowStatus=_RlLldpXMedLocMediaPolicyContainerRowStatus_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,2,1,1,9),_RlLldpXMedLocMediaPolicyContainerRowStatus_Type())
...
rlLldpTLVsTxOverloadingTable=_RlLldpTLVsTxOverloadingTable_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,3))
if mibBuilder.loadTexts:rlLldpTLVsTxOverloadingTable.setStatus(_A)
_RlLldpTLVsTxOverloadingEntry_Object=MibTableRow
rlLldpTLVsTxOverloadingEntry=_RlLldpTLVsTxOverloadingEntry_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,3,1))
...
rlLldpTxOverloadingPortNum=_RlLldpTxOverloadingPortNum_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,3,1,1),_RlLldpTxOverloadingPortNum_Type())
...
rlLldpTxOverloadingIndex=_RlLldpTxOverloadingIndex_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,3,1,2),_RlLldpTxOverloadingIndex_Type())
...
rlLldpTxOverloadingGroupId=_RlLldpTxOverloadingGroupId_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,3,1,3),_RlLldpTxOverloadingGroupId_Type())
...
rlLldpTLVsTxSize=_RlLldpTLVsTxSize_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,3,1,4),_RlLldpTLVsTxSize_Type())
...
rlLldpTLVsTxGroupOverloading=_RlLldpTLVsTxGroupOverloading_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,3,1,5),_RlLldpTLVsTxGroupOverloading_Type())
...
rlLldpTLVsTxLeftSize=_RlLldpTLVsTxLeftSize_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,3,1,6),_RlLldpTLVsTxLeftSize_Type())
...
rlLldpTLVsTxOverloadingSizeTable=_RlLldpTLVsTxOverloadingSizeTable_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,4))
...
rlLldpTLVsTxOverloadingSizeEntry=_RlLldpTLVsTxOverloadingSizeEntry_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,4,1))
...
rlLldpTotalTLVsTxSize=_RlLldpTotalTLVsTxSize_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,4,1,2),_RlLldpTotalTLVsTxSize_Type())
...
rlLldpTLVsTxOverloading=_RlLldpTLVsTxOverloading_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,4,1,3),_RlLldpTLVsTxOverloading_Type())
...
rlLldpLeftTLVsTxSize=_RlLldpLeftTLVsTxSize_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,4,1,4),_RlLldpLeftTLVsTxSize_Type())
...
rlLldpTLVsTxOverloadingPorts=_RlLldpTLVsTxOverloadingPorts_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,5),_RlLldpTLVsTxOverloadingPorts_Type())
...
rlLldpRemTtlTable=_RlLldpRemTtlTable_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,8))
if mibBuilder.loadTexts:rlLldpRemTtlTable.setStatus(_A)
_RlLldpRemTtlEntry_Object=MibTableRow
rlLldpRemTtlEntry=_RlLldpRemTtlEntry_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,8,1))
...
rlLldpRemTtl=_RlLldpRemTtl_Object((1,3,6,1,4,1,259,10,1,14,89,110,1,8,1,1),_RlLldpRemTtl_Type())
...
rlLldpTLVsTxOverloadingStateEnterTrap=NotificationType((1,3,6,1,4,1,259,10,1,14,89,0,209))
...
rlLldpTLVsTxOverloadingStateExitTrap=NotificationType((1,3,6,1,4,1,259,10,1,14,89,0,210))
