...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-MSDP-MIB
...
cMsdpMIBCompliance.setObjects(
      *(("CISCO-IETF-MSDP-MIB", "cMsdpMIBGlobalsGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBPeerGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBNotificationGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBEncapsulationGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBSACacheGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBRequestsGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBRPGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBMeshGroupGroup"))
)
if mibBuilder.loadTexts:
...
cMsdpMIBFullCompliance.setObjects(
      *(("CISCO-IETF-MSDP-MIB", "cMsdpMIBGlobalsGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBPeerGroup2"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBSACacheGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBEncapsulationGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBRPGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBMeshGroupGroup"))
...
cMsdpMIBReadOnlyCompliance.setObjects(
      *(("CISCO-IETF-MSDP-MIB", "cMsdpMIBGlobalsGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBPeerGroup2"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBSACacheGroup"),
        ("CISCO-IETF-MSDP-MIB", "cMsdpMIBEncapsulationGroup"),
