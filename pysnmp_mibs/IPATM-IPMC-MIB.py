...
# Notes
# -----
# ASN.1 source file://mibs/rfc/IPATM-IPMC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:20:19 2025
...
marsClientCompliance.setObjects(
    ("IPATM-IPMC-MIB", "marsClientGroup")
)
if mibBuilder.loadTexts:
...
marsServerCompliance.setObjects(
      *(("IPATM-IPMC-MIB", "marsServerGroup"),
        ("IPATM-IPMC-MIB", "marsServerEventGroup"))
)
if mibBuilder.loadTexts:
...
marsMcsCompliance.setObjects(
    ("IPATM-IPMC-MIB", "marsMcsGroup")
)
if mibBuilder.loadTexts:
