...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-PACKET-CAPTURE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:52 2025
...
_CpcSessionPacketLength_Type.__name__ = "Unsigned32"
...
_CpcSessionPacketLimits_Type.__name__ = "Unsigned32"
...
_CpcSessionPacketRateLimit_Type.__name__ = "Unsigned32"
...
class _CpcSessionDescr_Type(SnmpAdminString):
    """Custom type cpcSessionDescr based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpcSessionDescr_Type.__name__ = "SnmpAdminString"
...
cpcCompliance.setObjects(
      *(("CISCO-PACKET-CAPTURE-MIB", "cpcGenericConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcMacFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcIpFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcDestFileNameConfigGroup"))
)
if mibBuilder.loadTexts:
...
cpcComplianceRev1.setObjects(
      *(("CISCO-PACKET-CAPTURE-MIB", "cpcGenericConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcMacFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcIpFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcDestFileNameConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcPacketLengthFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcEthertypeFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcVlanFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcAccessGroupFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcBufferConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcScheduleConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcSessionStatsGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcMaxMacFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcMaxIpFilterConfigGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcSessionPacketRateLimitGroup"),
        ("CISCO-PACKET-CAPTURE-MIB", "cpcSessionDescrGroup"))
)
if mibBuilder.loadTexts:
