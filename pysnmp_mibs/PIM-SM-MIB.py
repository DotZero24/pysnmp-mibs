...
# Notes
# -----
# ASN.1 source file://mibs/d-link/PIM-SM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:48:14 2025
...
class _SwPimInfoPassiveMode_Type(Integer32):
    """Custom type swPimInfoPassiveMode based on Integer32"""
    defaultValue = 2
...
_SwPimInfoPassiveMode_Type.__name__ = "Integer32"
_SwPimInfoPassiveMode_Object = MibTableColumn
swPimInfoPassiveMode = _SwPimInfoPassiveMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 2, 3, 1, 10),
    _SwPimInfoPassiveMode_Type()
)
swPimInfoPassiveMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPimInfoPassiveMode.setStatus("current")
...
class _SwPimLastHopSptThreshold_Type(Integer32):
    """Custom type swPimLastHopSptThreshold based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_SwPimLastHopSptThreshold_Type.__name__ = "Integer32"
_SwPimLastHopSptThreshold_Object = MibScalar
swPimLastHopSptThreshold = _SwPimLastHopSptThreshold_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 3, 4, 1),
    _SwPimLastHopSptThreshold_Type()
)
swPimLastHopSptThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPimLastHopSptThreshold.setStatus("current")


class _SwPimRPSptThreshold_Type(Integer32):
    """Custom type swPimRPSptThreshold based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65536),
    )
...
_SwPimRPSptThreshold_Type.__name__ = "Integer32"
_SwPimRPSptThreshold_Object = MibScalar
swPimRPSptThreshold = _SwPimRPSptThreshold_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 3, 4, 2),
    _SwPimRPSptThreshold_Type()
)
swPimRPSptThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPimRPSptThreshold.setStatus("current")
...
swPimRPSetHoldTime = _SwPimRPSetHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 3, 8, 2, 1, 6),
    _SwPimRPSetHoldTime_Type()
)
swPimRPSetHoldTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPimRPSetHoldTime.setStatus("current")
_SwPimRPSetUpTime_Type = TimeTicks
_SwPimRPSetUpTime_Object = MibTableColumn
swPimRPSetUpTime = _SwPimRPSetUpTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 3, 8, 2, 1, 7),
    _SwPimRPSetUpTime_Type()
)
swPimRPSetUpTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPimRPSetUpTime.setStatus("current")
_SwPimRPSetExpiryTime_Type = TimeTicks
_SwPimRPSetExpiryTime_Object = MibTableColumn
swPimRPSetExpiryTime = _SwPimRPSetExpiryTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 3, 8, 2, 1, 8),
    _SwPimRPSetExpiryTime_Type()
)
swPimRPSetExpiryTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    swPimRPSetExpiryTime.setStatus("current")
_SwPimSSmMgmt_ObjectIdentity = ObjectIdentity
swPimSSmMgmt = _SwPimSSmMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 4)
)


class _SwPimSSmGlobalState_Type(Integer32):
    """Custom type swPimSSmGlobalState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwPimSSmGlobalState_Type.__name__ = "Integer32"
_SwPimSSmGlobalState_Object = MibScalar
swPimSSmGlobalState = _SwPimSSmGlobalState_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 4, 1),
    _SwPimSSmGlobalState_Type()
)
swPimSSmGlobalState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPimSSmGlobalState.setStatus("current")
_SwPimSSmGroupAddress_Type = IpAddress
_SwPimSSmGroupAddress_Object = MibScalar
swPimSSmGroupAddress = _SwPimSSmGroupAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 4, 2),
    _SwPimSSmGroupAddress_Type()
)
swPimSSmGroupAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPimSSmGroupAddress.setStatus("current")
_SwPimSSmGroupMask_Type = IpAddress
_SwPimSSmGroupMask_Object = MibScalar
swPimSSmGroupMask = _SwPimSSmGroupMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 52, 4, 3),
    _SwPimSSmGroupMask_Type()
)
swPimSSmGroupMask.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swPimSSmGroupMask.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"swPimSmMIB": swPimSmMIB,
       ...
       "swPimInfoPassiveMode": swPimInfoPassiveMode,
       ...
       "swPimLastHopSptThreshold": swPimLastHopSptThreshold,
       "swPimRPSptThreshold": swPimRPSptThreshold,
       ...
       "swPimRPSetHoldTime": swPimRPSetHoldTime,
       "swPimRPSetUpTime": swPimRPSetUpTime,
       "swPimRPSetExpiryTime": swPimRPSetExpiryTime,
       "swPimSSmMgmt": swPimSSmMgmt,
       "swPimSSmGlobalState": swPimSSmGlobalState,
