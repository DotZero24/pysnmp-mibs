...
# Notes
# -----
# ASN.1 source file://mibs/bdcom/NMS-IF-THRESHOLD-MIB
...
nmsIfThresholdMIBCompliance.setObjects(
      *(("NMS-IF-THRESHOLD-MIB", "nmsIfThresholdTemplateGroup"),
        ("NMS-IF-THRESHOLD-MIB", "nmsIfThresholdFiredGroup"),
        ("NMS-IF-THRESHOLD-MIB", "nmsIfThresholdNotifsGroup"))
)
if mibBuilder.loadTexts:
