...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HMRING-MGMT-SNMP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:53:58 2025
...
class _HmSrmRecoveryDelay_Type(Integer32):
    """Custom type hmSrmRecoveryDelay based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_HmSrmRecoveryDelay_Type.__name__ = "Integer32"
_HmSrmRecoveryDelay_Object = MibTableColumn
hmSrmRecoveryDelay = _HmSrmRecoveryDelay_Object(
    (1, 3, 6, 1, 4, 1, 248, 14, 5, 5, 5, 1, 17),
    _HmSrmRecoveryDelay_Type()
)
hmSrmRecoveryDelay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hmSrmRecoveryDelay.setStatus("current")
