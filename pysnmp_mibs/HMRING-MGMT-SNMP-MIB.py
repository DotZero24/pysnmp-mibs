...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hirschmann/HMRING-MGMT-SNMP-MIB
...
hmMrpMRMRecoveryDelay = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 14, 5, 3, 1, 30), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("delay500", 1), ("delay200", 2), ("delay1000", 3)))).setMaxAccess("readwrite")
...
hmSrmRecoveryDelay = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 14, 5, 5, 5, 1, 17), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("delay300", 1), ("delay1000", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hmSrmRecoveryDelay.setStatus('current')
...
mibBuilder.exportSymbols("HMRING-MGMT-SNMP-MIB", hmRingCplPartnerIpAddr=hmRingCplPartnerIpAddr, hmMultiHiperRing=hmMultiHiperRing, hmRingRedundancyEvent=hmRingRedundancyEvent, hmSrmRowStatus=hmSrmRowStatus, hmMrpMRMCheckMediaRedundancy=hmMrpMRMCheckMediaRedundancy, hmRingCouplingTable=hmRingCouplingTable, hmSrmMaxInstances=hmSrmMaxInstances, hmRpcEntry=hmRpcEntry, hmMrpMRMTestMonitoringCount=hmMrpMRMTestMonitoringCount, hmRingCplNetCoupling=hmRingCplNetCoupling, hmRpcRingport2IfIndex=hmRpcRingport2IfIndex, hmMrpRingport1IfIndex=hmMrpRingport1IfIndex, hmMrpRingport2IfIndex=hmMrpRingport2IfIndex, PYSNMP_MODULE_ID=hmRingRedundancy, hmRingRedRedIfOpState=hmRingRedRedIfOpState, hmMrpMRMTopologyChangeInterval=hmMrpMRMTopologyChangeInterval, hmSrmRingport1IfIndex=hmSrmRingport1IfIndex, hmSrmRingID=hmSrmRingID, hmRingRedConfigOperState=hmRingRedConfigOperState, hmRpcVlanID=hmRpcVlanID, hmMrpRedOperState=hmMrpRedOperState, hmSrmMRPDomainID=hmSrmMRPDomainID, hmSrmAdminState=hmSrmAdminState, hmMrpMRMRecoveryDelay=hmMrpMRMRecoveryDelay, hmMrpDomainID=hmMrpDomainID, hmRingRedRecoveryDelay=hmRingRedRecoveryDelay, hmRpcReconfig=hmRpcReconfig, hmSrmRedundancyOperState=hmSrmRedundancyOperState, hmRingRedConfigChanged=hmRingRedConfigChanged, hmRingCplControlIfIndex=hmRingCplControlIfIndex, hmRingCplInterconnIfOpState=hmRingCplInterconnIfOpState, hmRingCouplingEntry=hmRingCouplingEntry, hmRingRedundancy=hmRingRedundancy, hmRpcRingport2GroupID=hmRpcRingport2GroupID, hmRpcRingport1IfIndex=hmRpcRingport1IfIndex, hmRpcRoundTripDelay=hmRpcRoundTripDelay, hmSrmEntry=hmSrmEntry, hmRingCplReconfig=hmRingCplReconfig, hmRingCplInterconnGroupID=hmRingCplInterconnGroupID, hmMrpDomainName=hmMrpDomainName, hmMrpMRCLinkDownInterval=hmMrpMRCLinkDownInterval, hmMrpMRMRealRingState=hmMrpMRMRealRingState, hmMrpMRMReactOnLinkChange=hmMrpMRMReactOnLinkChange, hmMrpMRMTestMonitoringExtendedCount=hmMrpMRMTestMonitoringExtendedCount, hmSrmReconfig=hmSrmReconfig, hmRingRedEntry=hmRingRedEntry, hmSrmRingOperState=hmSrmRingOperState, hmSrmRingProtocol=hmSrmRingProtocol, hmRpcConfigOperState=hmRpcConfigOperState, hmSrmRingName=hmSrmRingName, hmRpcRedundancyOperState=hmRpcRedundancyOperState, hmMrpRowStatus=hmMrpRowStatus, hmSrmRecoveryDelay=hmSrmRecoveryDelay, hmRingCplCouplingLinks=hmRingCplCouplingLinks, hmSrmPartnerMAC=hmSrmPartnerMAC, hmRpcTable=hmRpcTable, hmMrpMRCLinkUpInterval=hmMrpMRCLinkUpInterval, hmRingRedOperState=hmRingRedOperState, hmRingRedPrimGroupID=hmRingRedPrimGroupID, hmMrpRingport2GroupID=hmMrpRingport2GroupID, hmRingCplInterconnIfIndex=hmRingCplInterconnIfIndex, hmSrmRingport1GroupID=hmSrmRingport1GroupID, hmRpcRingOperState=hmRpcRingOperState, hmMrpRingport2OperState=hmMrpRingport2OperState, hmRingRedRedGroupID=hmRingRedRedGroupID, hmMrpRingport1GroupID=hmMrpRingport1GroupID, hmRingCplMode=hmRingCplMode, hmRingCplPartnerInterconnIfIndex=hmRingCplPartnerInterconnIfIndex, hmRingRedMode=hmRingRedMode, hmMrpMRMNonBlockingMRCSupported=hmMrpMRMNonBlockingMRCSupported, hmMrpRingport1OperState=hmMrpRingport1OperState, hmRingCplOperState=hmRingCplOperState, hmMrpConfigOperState=hmMrpConfigOperState, hmSrmTable=hmSrmTable, hmRingRedTable=hmRingRedTable, hmSrmConfigOperState=hmSrmConfigOperState, hmRpcRingID=hmRpcRingID, hmRpcNodes=hmRpcNodes, hmRingRedRedIfIndex=hmRingRedRedIfIndex, hmRingCplConfigOperState=hmRingCplConfigOperState, hmRpcOperState=hmRpcOperState, hmSrmNodes=hmSrmNodes, hmMrpMRMRealRoleState=hmMrpMRMRealRoleState, hmRpcRingport1GroupID=hmRpcRingport1GroupID, hmMrpMRMShortTestInterval=hmMrpMRMShortTestInterval, hmRingRedPrimIfIndex=hmRingRedPrimIfIndex, hmMrpMRCLinkChangeCount=hmMrpMRCLinkChangeCount, hmRingCplControlIfOpState=hmRingCplControlIfOpState, hmRpcRingName=hmRpcRingName, hmRpcRingProtocol=hmRpcRingProtocol, hmRpcAdminState=hmRpcAdminState, hmMrpEntry=hmMrpEntry, hmMrpTable=hmMrpTable, hmRingRedReconfig=hmRingRedReconfig, hmSrmOperState=hmSrmOperState, hmRingCplRowStatus=hmRingCplRowStatus, hmMrpMRMDefaultTestInterval=hmMrpMRMDefaultTestInterval, hmRpcRowStatus=hmRpcRowStatus, hmRingCplPartnerInterconnIfOpState=hmRingCplPartnerInterconnIfOpState, hmRpcRingport1OperState=hmRpcRingport1OperState, hmMrpExpectedRole=hmMrpExpectedRole, hmSrmRingport1OperState=hmSrmRingport1OperState, hmRingRedPrimIfOpState=hmRingRedPrimIfOpState, hmRingCplControlMode=hmRingCplControlMode, hmRpcRingport2OperState=hmRpcRingport2OperState, hmRingCplPartnerInterconnGroupID=hmRingCplPartnerInterconnGroupID, hmRingCplExtendedDiag=hmRingCplExtendedDiag, hmRingCplControlGroupID=hmRingCplControlGroupID, hmSrmVlanID=hmSrmVlanID, hmMrpMRMPriority=hmMrpMRMPriority, hmMrpVlanID=hmMrpVlanID, hmMrpMRCBlockedSupported=hmMrpMRCBlockedSupported, hmRingCplConfigSource=hmRingCplConfigSource, hmMrpMRMTopologyChangeRepeatCount=hmMrpMRMTopologyChangeRepeatCount, hmMrpReconfig=hmMrpReconfig)
