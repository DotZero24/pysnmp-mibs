...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-MACNOTIFY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:37:38 2025
...
_HpicfMacNotifyTrapInterval_Type.__name__ = "Unsigned32"
...
hpicfMacNotifyCompliance.setObjects(
      *(("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyGlobalConfigGroup"),
        ("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyConfigGroup"),
        ("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyStatsGroup"),
        ("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyNotifications"),
        ("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyClearGroup"))
)
if mibBuilder.loadTexts:
...
hpicfMacCountNotifyCompliance.setObjects(
      *(("HP-ICF-MACNOTIFY-MIB", "hpicfMacCountNotifyConfigGroup"),
        ("HP-ICF-MACNOTIFY-MIB", "hpicfMacCountNotifyNotifications"))
)
if mibBuilder.loadTexts:
...
hpicfMacNotifyCompliance2.setObjects(
      *(("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyGlobalConfigGroup"),
        ("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyConfigGroup2"),
        ("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyStatsGroup2"),
        ("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyNotifications"),
        ("HP-ICF-MACNOTIFY-MIB", "hpicfMacNotifyClearGroup"))
)
if mibBuilder.loadTexts:
