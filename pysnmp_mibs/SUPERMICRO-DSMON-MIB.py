...
mibBuilder.exportSymbols("SUPERMICRO-DSMON-MIB", fsdsmon=fsdsmon, PYSNMP_MODULE_ID=fsdsmon, fsDsmonTrace=fsDsmonTrace, fsDsmonAdminStatus=fsDsmonAdminStatus)
