...
mibBuilder.exportSymbols("OS-VIF-MIB", osVifMflgTrustedPorts=osVifMflgTrustedPorts, osVifMflgPortThreshold=osVifMflgPortThreshold, osVifIpTable=osVifIpTable, osVifNatPfInternalMode=osVifNatPfInternalMode, osVifSlaTable=osVifSlaTable, osVifIfIndex=osVifIfIndex, osVifMIBCompliance=osVifMIBCompliance, osVifMgmtAddressType=osVifMgmtAddressType, osVifMflgVbEnabled=osVifMflgVbEnabled, osVifAdminStatus=osVifAdminStatus, osVifMflgMac=osVifMflgMac, osVifAddress=osVifAddress, osDummyIfAddress=osDummyIfAddress, osVifMflgPbEnabled=osVifMflgPbEnabled, osVifEntry=osVifEntry, osVifConfigGrp=osVifConfigGrp, osVifDescr=osVifDescr, osVifSlaEntry=osVifSlaEntry, osVifName=osVifName, osVifNotifications=osVifNotifications, osVifMgmtEntry=osVifMgmtEntry, osVifMgmtAddress=osVifMgmtAddress, VifEntryValidator=VifEntryValidator, osVifNatPfExternalMode=osVifNatPfExternalMode, osDummyIfEntry=osDummyIfEntry, osVifMflgEnabled=osVifMflgEnabled, osVifLocked=osVifLocked, osVifSlaSlaAvailable=osVifSlaSlaAvailable, osVifMflgCfg=osVifMflgCfg, osDummyIfAddressType=osDummyIfAddressType, osVifIsolatedPorts=osVifIsolatedPorts, IfnDevNo=IfnDevNo, osDummyIfPrefixLength=osDummyIfPrefixLength, osVifGen=osVifGen, osVifMgmtPrefixLength=osVifMgmtPrefixLength, osVifPortIsolation=osVifPortIsolation, osVifTag=osVifTag, osVifPortList=osVifPortList, osVifMgmtProtocol=osVifMgmtProtocol, osVifPrefixLength=osVifPrefixLength, osDummyIfIfIndex=osDummyIfIfIndex, osVifNotificationsGroup=osVifNotificationsGroup, osVifDevNo=osVifDevNo, osRtVifEntry=osRtVifEntry, osVifAddrTypesSupported=osVifAddrTypesSupported, osVifMflgThreshold=osVifMflgThreshold, osRtVifTable=osRtVifTable, osVifIpEntry=osVifIpEntry, PYSNMP_MODULE_ID=osVif, osVifIpAdminStatus=osVifIpAdminStatus, osVifIspTag=osVifIspTag, osDummyIfAdminStatus=osDummyIfAdminStatus, IfRowValidator=IfRowValidator, osRtVifLabelSwitching=osRtVifLabelSwitching, osDummyIfName=osDummyIfName, osVifPortDetection=osVifPortDetection, osVifLastChange=osVifLastChange, osVifMIBCompliances=osVifMIBCompliances, osVifMflgDetectOnly=osVifMflgDetectOnly, osVifRecoverPorts=osVifRecoverPorts, osVifAddressType=osVifAddressType, osVifTable=osVifTable, osVifMandatoryGroup=osVifMandatoryGroup, osVifLastError=osVifLastError, osVifMtuProfile=osVifMtuProfile, osVifSlaRespMac=osVifSlaRespMac, osVifPortRecovery=osVifPortRecovery, osVifIspPortList=osVifIspPortList, osVifMgmtTable=osVifMgmtTable, osVifOperState=osVifOperState, osVifMgmtAdminStatus=osVifMgmtAdminStatus, osVifConformance=osVifConformance, osVifMflgRecoveryDelay=osVifMflgRecoveryDelay, osVifMIBGroups=osVifMIBGroups, osDummyIfTable=osDummyIfTable, osDummyIfDevNo=osDummyIfDevNo, osVif=osVif)
