...
mibBuilder.exportSymbols("OS-VIF-MIB", IfnDevNo=IfnDevNo, osVifLastChange=osVifLastChange, osVifPortIsolation=osVifPortIsolation, osRtVifLabelSwitching=osRtVifLabelSwitching, osDummyIfDevNo=osDummyIfDevNo, osVifOperState=osVifOperState, osVifNotificationsGroup=osVifNotificationsGroup, osVifMgmtEntry=osVifMgmtEntry, osVifPortRecovery=osVifPortRecovery, osVifSlaSlaAvailable=osVifSlaSlaAvailable, osVifGen=osVifGen, osVifIpAdminStatus=osVifIpAdminStatus, osVifAdminStatus=osVifAdminStatus, osVifName=osVifName, osVifSlaTable=osVifSlaTable, osVifMtuProfile=osVifMtuProfile, osVifPrefixLength=osVifPrefixLength, osVifConfigGrp=osVifConfigGrp, osDummyIfAddress=osDummyIfAddress, osDummyIfTable=osDummyIfTable, osVifEntry=osVifEntry, osVif=osVif, osVifMgmtAdminStatus=osVifMgmtAdminStatus, osVifAddressType=osVifAddressType, osVifMIBCompliance=osVifMIBCompliance, osVifMandatoryGroup=osVifMandatoryGroup, osRtVifTable=osRtVifTable, osVifMflgTrustedPorts=osVifMflgTrustedPorts, osVifMgmtAddress=osVifMgmtAddress, osVifMgmtProtocol=osVifMgmtProtocol, osVifNotifications=osVifNotifications, osVifMflgMac=osVifMflgMac, osVifIspTag=osVifIspTag, osVifIsolatedPorts=osVifIsolatedPorts, osVifConformance=osVifConformance, osVifMgmtPrefixLength=osVifMgmtPrefixLength, osVifMgmtAddressType=osVifMgmtAddressType, osVifMflgPortThreshold=osVifMflgPortThreshold, osVifPortList=osVifPortList, osVifIfIndex=osVifIfIndex, osVifDescr=osVifDescr, osVifMIBCompliances=osVifMIBCompliances, VifEntryValidator=VifEntryValidator, osVifTag=osVifTag, osVifMflgRecoveryDelay=osVifMflgRecoveryDelay, osVifTable=osVifTable, osVifNatPfInternalMode=osVifNatPfInternalMode, osVifNatPfExternalMode=osVifNatPfExternalMode, osVifRecoverPorts=osVifRecoverPorts, osDummyIfName=osDummyIfName, osRtVifEntry=osRtVifEntry, osVifMflgThreshold=osVifMflgThreshold, osVifMflgPbEnabled=osVifMflgPbEnabled, osVifAddress=osVifAddress, osVifLastError=osVifLastError, osVifMflgDetectOnly=osVifMflgDetectOnly, PYSNMP_MODULE_ID=osVif, osVifLocked=osVifLocked, osVifIpTable=osVifIpTable, osDummyIfAddressType=osDummyIfAddressType, osVifMgmtTable=osVifMgmtTable, osDummyIfIfIndex=osDummyIfIfIndex, osVifMflgEnabled=osVifMflgEnabled, osVifMflgVbEnabled=osVifMflgVbEnabled, osVifMflgCfg=osVifMflgCfg, osVifSlaEntry=osVifSlaEntry, osVifMIBGroups=osVifMIBGroups, osVifPortDetection=osVifPortDetection, osVifIspPortList=osVifIspPortList, osDummyIfAdminStatus=osDummyIfAdminStatus, osDummyIfPrefixLength=osDummyIfPrefixLength, osVifSlaRespMac=osVifSlaRespMac, osVifIpEntry=osVifIpEntry, osVifAddrTypesSupported=osVifAddrTypesSupported, osDummyIfEntry=osDummyIfEntry, IfRowValidator=IfRowValidator, osVifDevNo=osVifDevNo)
