...
# Notes
# -----
# ASN.1 source file://mibs/rfc/SMF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:23:54 2025
...
_SmfNotifDpdMemoryOverflowWindow_Type.__name__ = "TimeTicks"
...
_SmfCfgAdminStatus_Type.__name__ = "SmfStatus"
...
_SmfCfgNhdpRssaMesgTLVIncluded_Type.__name__ = "TruthValue"
...
_SmfCfgNhdpRssaAddrBlockTLVIncluded_Type.__name__ = "TruthValue"
...
_SmfCfgIfAdminStatus_Type.__name__ = "SmfStatus"
...
smfBasicCompliance.setObjects(
      *(("SMF-MIB", "smfCapabObjectsGroup"),
        ("SMF-MIB", "smfConfigObjectsGroup"))
)
if mibBuilder.loadTexts:
...
smfFullCompliance.setObjects(
      *(("SMF-MIB", "smfCapabObjectsGroup"),
        ("SMF-MIB", "smfConfigObjectsGroup"),
        ("SMF-MIB", "smfStateObjectsGroup"),
        ("SMF-MIB", "smfPerfObjectsGroup"),
        ("SMF-MIB", "smfNotifObjectsGroup"),
        ("SMF-MIB", "smfNotificationsGroup"))
)
if mibBuilder.loadTexts:
