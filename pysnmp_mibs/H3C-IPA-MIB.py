# SNMP MIB module (H3C-IPA-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-IPA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:19:19 2025
...
_H3cIpaTimeOutSeconds_Type.__name__ = "Integer32"
...
_H3cIpaIntListMaxItemNum_Type.__name__ = "Integer32"
...
_H3cIpaExtListMaxItemNum_Type.__name__ = "Integer32"
...
h3cIpaIfConfigEntry.setIndexNames(
    (0, "H3C-IPA-MIB", "h3cIpaIfConfigIfIndex"),
)
if mibBuilder.loadTexts:
...
h3cIpaAccountListEntry.setIndexNames(
    (0, "H3C-IPA-MIB", "h3cIpaAccountListIndex"),
)
if mibBuilder.loadTexts:
...
h3cIpaIntListEntry.setIndexNames(
    (0, "H3C-IPA-MIB", "h3cIpaIntListIpSrc"),
    (0, "H3C-IPA-MIB", "h3cIpaIntListIpDst"),
    (0, "H3C-IPA-MIB", "h3cIpaIntListProtocol"),
)
if mibBuilder.loadTexts:
...
h3cIpaExtListEntry.setIndexNames(
    (0, "H3C-IPA-MIB", "h3cIpaExtListIpSrc"),
    (0, "H3C-IPA-MIB", "h3cIpaExtListIpDst"),
    (0, "H3C-IPA-MIB", "h3cIpaExtListProtocol"),
)
if mibBuilder.loadTexts:
...
h3cIpaFWListEntry.setIndexNames(
    (0, "H3C-IPA-MIB", "h3cIpaFWListIpSrc"),
    (0, "H3C-IPA-MIB", "h3cIpaFWListIpDst"),
)
if mibBuilder.loadTexts:
