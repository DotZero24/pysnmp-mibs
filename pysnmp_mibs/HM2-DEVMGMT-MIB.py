...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-DEVMGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:55:25 2025
...
class _Hm2DevMgmtActionFlushMgmtAccessStatistics_Type(Integer32):
    """Custom type hm2DevMgmtActionFlushMgmtAccessStatistics based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
    ...
    namedValues = NamedValues(
        *(("other", 1),
          ("flushMgmtAccessStatistics", 2))
    )


_Hm2DevMgmtActionFlushMgmtAccessStatistics_Type.__name__ = "Integer32"
_Hm2DevMgmtActionFlushMgmtAccessStatistics_Object = MibScalar
hm2DevMgmtActionFlushMgmtAccessStatistics = _Hm2DevMgmtActionFlushMgmtAccessStatistics_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 2, 16),
    _Hm2DevMgmtActionFlushMgmtAccessStatistics_Type()
)
hm2DevMgmtActionFlushMgmtAccessStatistics.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMgmtActionFlushMgmtAccessStatistics.setStatus("current")


class _Hm2DevMgmtActionFlushDiffServ_Type(Integer32):
    """Custom type hm2DevMgmtActionFlushDiffServ based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hm2DevMgmtActionFlushDiffServ_Type.__name__ = "Integer32"
_Hm2DevMgmtActionFlushDiffServ_Object = MibScalar
hm2DevMgmtActionFlushDiffServ = _Hm2DevMgmtActionFlushDiffServ_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 2, 17),
    _Hm2DevMgmtActionFlushDiffServ_Type()
)
hm2DevMgmtActionFlushDiffServ.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMgmtActionFlushDiffServ.setStatus("current")
...
class _Hm2DevMgmtActionLanBypass_Type(HmEnabledStatus):
    """Custom type hm2DevMgmtActionLanBypass based on HmEnabledStatus"""
    defaultValue = 2


_Hm2DevMgmtActionLanBypass_Type.__name__ = "HmEnabledStatus"
_Hm2DevMgmtActionLanBypass_Object = MibScalar
hm2DevMgmtActionLanBypass = _Hm2DevMgmtActionLanBypass_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 2, 102),
    _Hm2DevMgmtActionLanBypass_Type()
)
hm2DevMgmtActionLanBypass.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMgmtActionLanBypass.setStatus("current")


class _Hm2DevMgmtActionSystemoffLanBypass_Type(HmEnabledStatus):
    """Custom type hm2DevMgmtActionSystemoffLanBypass based on HmEnabledStatus"""
    defaultValue = 2


_Hm2DevMgmtActionSystemoffLanBypass_Type.__name__ = "HmEnabledStatus"
_Hm2DevMgmtActionSystemoffLanBypass_Object = MibScalar
hm2DevMgmtActionSystemoffLanBypass = _Hm2DevMgmtActionSystemoffLanBypass_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 2, 103),
    _Hm2DevMgmtActionSystemoffLanBypass_Type()
)
hm2DevMgmtActionSystemoffLanBypass.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMgmtActionSystemoffLanBypass.setStatus("current")
...
class _Hm2DevMgmtSwVersAllowUnsigned_Type(HmEnabledStatus):
    """Custom type hm2DevMgmtSwVersAllowUnsigned based on HmEnabledStatus"""
    defaultValue = 2


_Hm2DevMgmtSwVersAllowUnsigned_Type.__name__ = "HmEnabledStatus"
_Hm2DevMgmtSwVersAllowUnsigned_Object = MibScalar
hm2DevMgmtSwVersAllowUnsigned = _Hm2DevMgmtSwVersAllowUnsigned_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 2),
    _Hm2DevMgmtSwVersAllowUnsigned_Type()
)
hm2DevMgmtSwVersAllowUnsigned.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersAllowUnsigned.setStatus("current")
_Hm2DevMgmtSwVersCertTable_Object = MibTable
hm2DevMgmtSwVersCertTable = _Hm2DevMgmtSwVersCertTable_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 7)
)
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersCertTable.setStatus("current")
_Hm2DevMgmtSwVersCertEntry_Object = MibTableRow
hm2DevMgmtSwVersCertEntry = _Hm2DevMgmtSwVersCertEntry_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 7, 1)
)
hm2DevMgmtSwVersCertEntry.setIndexNames(
    (0, "HM2-DEVMGMT-MIB", "hm2DevMgmtSwVersCertIndex"),
)
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersCertEntry.setStatus("current")
_Hm2DevMgmtSwVersCertIndex_Type = Integer32
_Hm2DevMgmtSwVersCertIndex_Object = MibTableColumn
hm2DevMgmtSwVersCertIndex = _Hm2DevMgmtSwVersCertIndex_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 7, 1, 1),
    _Hm2DevMgmtSwVersCertIndex_Type()
)
hm2DevMgmtSwVersCertIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersCertIndex.setStatus("current")
_Hm2DevMgmtSwVersCertSerialNo_Type = OctetString
_Hm2DevMgmtSwVersCertSerialNo_Object = MibTableColumn
hm2DevMgmtSwVersCertSerialNo = _Hm2DevMgmtSwVersCertSerialNo_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 7, 1, 2),
    _Hm2DevMgmtSwVersCertSerialNo_Type()
)
hm2DevMgmtSwVersCertSerialNo.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersCertSerialNo.setStatus("current")
_Hm2DevMgmtSwVersCertSubject_Type = DisplayString
_Hm2DevMgmtSwVersCertSubject_Object = MibTableColumn
hm2DevMgmtSwVersCertSubject = _Hm2DevMgmtSwVersCertSubject_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 7, 1, 3),
    _Hm2DevMgmtSwVersCertSubject_Type()
)
hm2DevMgmtSwVersCertSubject.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersCertSubject.setStatus("current")
_Hm2DevMgmtSwVersCertSigAlg_Type = DisplayString
_Hm2DevMgmtSwVersCertSigAlg_Object = MibTableColumn
hm2DevMgmtSwVersCertSigAlg = _Hm2DevMgmtSwVersCertSigAlg_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 7, 1, 4),
    _Hm2DevMgmtSwVersCertSigAlg_Type()
)
hm2DevMgmtSwVersCertSigAlg.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersCertSigAlg.setStatus("current")


class _Hm2DevMgmtSwVersCertType_Type(Integer32):
    """Custom type hm2DevMgmtSwVersCertType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hm2DevMgmtSwVersCertType_Type.__name__ = "Integer32"
_Hm2DevMgmtSwVersCertType_Object = MibTableColumn
hm2DevMgmtSwVersCertType = _Hm2DevMgmtSwVersCertType_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 7, 1, 5),
    _Hm2DevMgmtSwVersCertType_Type()
)
hm2DevMgmtSwVersCertType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersCertType.setStatus("current")


class _Hm2DevMgmtSwVersCertStatus_Type(Integer32):
    """Custom type hm2DevMgmtSwVersCertStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hm2DevMgmtSwVersCertStatus_Type.__name__ = "Integer32"
_Hm2DevMgmtSwVersCertStatus_Object = MibTableColumn
hm2DevMgmtSwVersCertStatus = _Hm2DevMgmtSwVersCertStatus_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 7, 1, 6),
    _Hm2DevMgmtSwVersCertStatus_Type()
)
hm2DevMgmtSwVersCertStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersCertStatus.setStatus("current")
_Hm2DevMgmtSwVersCertFingerprint_Type = OctetString
_Hm2DevMgmtSwVersCertFingerprint_Object = MibTableColumn
hm2DevMgmtSwVersCertFingerprint = _Hm2DevMgmtSwVersCertFingerprint_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 3, 1, 7, 1, 7),
    _Hm2DevMgmtSwVersCertFingerprint_Type()
)
hm2DevMgmtSwVersCertFingerprint.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMgmtSwVersCertFingerprint.setStatus("current")
...
hm2DevMgmtTemperatureExtTable = _Hm2DevMgmtTemperatureExtTable_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 5, 10)
)
if mibBuilder.loadTexts:
    hm2DevMgmtTemperatureExtTable.setStatus("current")
_Hm2DevMgmtTemperatureExtEntry_Object = MibTableRow
hm2DevMgmtTemperatureExtEntry = _Hm2DevMgmtTemperatureExtEntry_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 5, 10, 1)
)
hm2DevMgmtTemperatureExtEntry.setIndexNames(
    (0, "HM2-DEVMGMT-MIB", "hm2UnitIndex"),
    (0, "HM2-DEVMGMT-MIB", "hm2DevMgmtTemperatureExtType"),
    (0, "HM2-DEVMGMT-MIB", "hm2DevMgmtTemperatureExtSensorId"),
)
if mibBuilder.loadTexts:
    hm2DevMgmtTemperatureExtEntry.setStatus("current")


class _Hm2DevMgmtTemperatureExtType_Type(Integer32):
    """Custom type hm2DevMgmtTemperatureExtType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hm2DevMgmtTemperatureExtType_Type.__name__ = "Integer32"
_Hm2DevMgmtTemperatureExtType_Object = MibTableColumn
hm2DevMgmtTemperatureExtType = _Hm2DevMgmtTemperatureExtType_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 5, 10, 1, 1),
    _Hm2DevMgmtTemperatureExtType_Type()
)
hm2DevMgmtTemperatureExtType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hm2DevMgmtTemperatureExtType.setStatus("current")


class _Hm2DevMgmtTemperatureExtSensorId_Type(Integer32):
    """Custom type hm2DevMgmtTemperatureExtSensorId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hm2DevMgmtTemperatureExtSensorId_Type.__name__ = "Integer32"
_Hm2DevMgmtTemperatureExtSensorId_Object = MibTableColumn
hm2DevMgmtTemperatureExtSensorId = _Hm2DevMgmtTemperatureExtSensorId_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 5, 10, 1, 2),
    _Hm2DevMgmtTemperatureExtSensorId_Type()
)
hm2DevMgmtTemperatureExtSensorId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMgmtTemperatureExtSensorId.setStatus("current")
_Hm2DevMgmtTemperatureExt_Type = Integer32
_Hm2DevMgmtTemperatureExt_Object = MibTableColumn
hm2DevMgmtTemperatureExt = _Hm2DevMgmtTemperatureExt_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 5, 10, 1, 3),
    _Hm2DevMgmtTemperatureExt_Type()
)
hm2DevMgmtTemperatureExt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMgmtTemperatureExt.setStatus("current")


class _Hm2DevMgmtTemperatureExtUpperLimit_Type(Integer32):
    """Custom type hm2DevMgmtTemperatureExtUpperLimit based on Integer32"""
    defaultValue = 70
...
_Hm2DevMgmtTemperatureExtUpperLimit_Type.__name__ = "Integer32"
_Hm2DevMgmtTemperatureExtUpperLimit_Object = MibTableColumn
hm2DevMgmtTemperatureExtUpperLimit = _Hm2DevMgmtTemperatureExtUpperLimit_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 5, 10, 1, 4),
    _Hm2DevMgmtTemperatureExtUpperLimit_Type()
)
hm2DevMgmtTemperatureExtUpperLimit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMgmtTemperatureExtUpperLimit.setStatus("current")


class _Hm2DevMgmtTemperatureExtLowerLimit_Type(Integer32):
    """Custom type hm2DevMgmtTemperatureExtLowerLimit based on Integer32"""
    defaultValue = 0
...
_Hm2DevMgmtTemperatureExtLowerLimit_Type.__name__ = "Integer32"
_Hm2DevMgmtTemperatureExtLowerLimit_Object = MibTableColumn
hm2DevMgmtTemperatureExtLowerLimit = _Hm2DevMgmtTemperatureExtLowerLimit_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 5, 10, 1, 5),
    _Hm2DevMgmtTemperatureExtLowerLimit_Type()
)
hm2DevMgmtTemperatureExtLowerLimit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMgmtTemperatureExtLowerLimit.setStatus("current")
...
_Hm2IfacePowerState_Type.__name__ = "HmEnabledStatus"
...
_Hm2ExtNvmChooseActive_Type.__name__ = "Hm2DeviceExtNVMType"
...
_Hm2ExtNvmLogDevice_Type.__name__ = "Hm2DeviceExtNVMType"
...
_Hm2ExtNvmAutomaticSoftwareLoad_Type.__name__ = "HmEnabledStatus"
...
_Hm2ExtNvmConfigSave_Type.__name__ = "HmEnabledStatus"
...
_Hm2ExtNvmAutomaticSshKeyLoad_Type.__name__ = "HmEnabledStatus"
...
_Hm2AutoDisableIntfRemainingTime_Type.__name__ = "Unsigned32"
...
_Hm2AutoDisableIntfReset_Type.__name__ = "TruthValue"
...
_Hm2AutoDisableReasonOperation_Type.__name__ = "HmEnabledStatus"
...
_Hm2ModuleInternalID_Type.__name__ = "Integer32"
...
_Hm2ModuleInternalIDVariant_Type.__name__ = "Integer32"
...
_Hm2ModuleAdminState_Type.__name__ = "HmEnabledStatus"
...
hm2DeviceMgmtHumidityGroup = _Hm2DeviceMgmtHumidityGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 12)
)


class _Hm2DevMgmtHumidity_Type(Unsigned32):
    """Custom type hm2DevMgmtHumidity based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hm2DevMgmtHumidity_Type.__name__ = "Unsigned32"
_Hm2DevMgmtHumidity_Object = MibScalar
hm2DevMgmtHumidity = _Hm2DevMgmtHumidity_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 12, 1),
    _Hm2DevMgmtHumidity_Type()
)
hm2DevMgmtHumidity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2DevMgmtHumidity.setStatus("current")
if mibBuilder.loadTexts:
    hm2DevMgmtHumidity.setUnits("percent")


class _Hm2DevMgmtHumidityUpperLimit_Type(Unsigned32):
    """Custom type hm2DevMgmtHumidityUpperLimit based on Unsigned32"""
    defaultValue = 95
...
_Hm2DevMgmtHumidityUpperLimit_Type.__name__ = "Unsigned32"
_Hm2DevMgmtHumidityUpperLimit_Object = MibScalar
hm2DevMgmtHumidityUpperLimit = _Hm2DevMgmtHumidityUpperLimit_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 12, 2),
    _Hm2DevMgmtHumidityUpperLimit_Type()
)
hm2DevMgmtHumidityUpperLimit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMgmtHumidityUpperLimit.setStatus("current")
if mibBuilder.loadTexts:
    hm2DevMgmtHumidityUpperLimit.setUnits("percent")


class _Hm2DevMgmtHumidityLowerLimit_Type(Unsigned32):
    """Custom type hm2DevMgmtHumidityLowerLimit based on Unsigned32"""
    defaultValue = 5
...
_Hm2DevMgmtHumidityLowerLimit_Type.__name__ = "Unsigned32"
_Hm2DevMgmtHumidityLowerLimit_Object = MibScalar
hm2DevMgmtHumidityLowerLimit = _Hm2DevMgmtHumidityLowerLimit_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 10, 1, 12, 3),
    _Hm2DevMgmtHumidityLowerLimit_Type()
)
hm2DevMgmtHumidityLowerLimit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hm2DevMgmtHumidityLowerLimit.setStatus("current")
if mibBuilder.loadTexts:
    hm2DevMgmtHumidityLowerLimit.setUnits("percent")
...
mibBuilder.exportSymbols(
    ...
    **{"Hm2DeviceExtNVMType": Hm2DeviceExtNVMType,
       ...
       "hm2DevMgmtActionFlushMgmtAccessStatistics": hm2DevMgmtActionFlushMgmtAccessStatistics,
       "hm2DevMgmtActionFlushDiffServ": hm2DevMgmtActionFlushDiffServ,
       "hm2DevMgmtActionDelayPreset": hm2DevMgmtActionDelayPreset,
       "hm2DevMgmtActionDelayCurrent": hm2DevMgmtActionDelayCurrent,
       "hm2DevMgmtActionLanBypass": hm2DevMgmtActionLanBypass,
       "hm2DevMgmtActionSystemoffLanBypass": hm2DevMgmtActionSystemoffLanBypass,
       ...
       "hm2DevMgmtSwVersAllowUnsigned": hm2DevMgmtSwVersAllowUnsigned,
       "hm2DevMgmtSwVersCertTable": hm2DevMgmtSwVersCertTable,
       "hm2DevMgmtSwVersCertEntry": hm2DevMgmtSwVersCertEntry,
       "hm2DevMgmtSwVersCertIndex": hm2DevMgmtSwVersCertIndex,
       "hm2DevMgmtSwVersCertSerialNo": hm2DevMgmtSwVersCertSerialNo,
       "hm2DevMgmtSwVersCertSubject": hm2DevMgmtSwVersCertSubject,
       "hm2DevMgmtSwVersCertSigAlg": hm2DevMgmtSwVersCertSigAlg,
       "hm2DevMgmtSwVersCertType": hm2DevMgmtSwVersCertType,
       "hm2DevMgmtSwVersCertStatus": hm2DevMgmtSwVersCertStatus,
       "hm2DevMgmtSwVersCertFingerprint": hm2DevMgmtSwVersCertFingerprint,
       ...
       "hm2DevMgmtTemperatureExtTable": hm2DevMgmtTemperatureExtTable,
       "hm2DevMgmtTemperatureExtEntry": hm2DevMgmtTemperatureExtEntry,
       "hm2DevMgmtTemperatureExtType": hm2DevMgmtTemperatureExtType,
       "hm2DevMgmtTemperatureExtSensorId": hm2DevMgmtTemperatureExtSensorId,
       "hm2DevMgmtTemperatureExt": hm2DevMgmtTemperatureExt,
       "hm2DevMgmtTemperatureExtUpperLimit": hm2DevMgmtTemperatureExtUpperLimit,
       "hm2DevMgmtTemperatureExtLowerLimit": hm2DevMgmtTemperatureExtLowerLimit,
       ...
       "hm2DeviceMgmtHumidityGroup": hm2DeviceMgmtHumidityGroup,
       "hm2DevMgmtHumidity": hm2DevMgmtHumidity,
       "hm2DevMgmtHumidityUpperLimit": hm2DevMgmtHumidityUpperLimit,
       "hm2DevMgmtHumidityLowerLimit": hm2DevMgmtHumidityLowerLimit}
)
