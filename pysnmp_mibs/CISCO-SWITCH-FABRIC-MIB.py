...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SWITCH-FABRIC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:22:32 2025
...
csfSwitchFabricMIBCompliance.setObjects(
    ("CISCO-SWITCH-FABRIC-MIB", "csfFabricUtilGroup")
)
if mibBuilder.loadTexts:
...
csfSwitchFabricMIBCompliance1.setObjects(
      *(("CISCO-SWITCH-FABRIC-MIB", "csfFabricUtilGroup"),
        ("CISCO-SWITCH-FABRIC-MIB", "csfFabricCrcErrorNotifsControlGroup"),
        ("CISCO-SWITCH-FABRIC-MIB", "csfFabricCrcErrorNotifsInfoGroup"),
        ("CISCO-SWITCH-FABRIC-MIB", "csfFabricCrcErrorNotifsGroup"))
)
if mibBuilder.loadTexts:
