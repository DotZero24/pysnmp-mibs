...
mibBuilder.exportSymbols("HPN-ICF-MDC-MIB", hpnicfMDCDISKResourceEntry=hpnicfMDCDISKResourceEntry, hpnicfMDCDISKResourceQuota=hpnicfMDCDISKResourceQuota, hpnicfMDCAllocateMDCId=hpnicfMDCAllocateMDCId, hpnicfMDCIndex=hpnicfMDCIndex, hpnicfMDCAllocateEntry=hpnicfMDCAllocateEntry, hpnicfMDCGroupIfTable=hpnicfMDCGroupIfTable, hpnicfMDCMemoryResourceMinLimit=hpnicfMDCMemoryResourceMinLimit, hpnicfMDCLocationStatus=hpnicfMDCLocationStatus, hpnicfMDCAction=hpnicfMDCAction, hpnicfMDCAllocateTable=hpnicfMDCAllocateTable, hpnicfMDCTables=hpnicfMDCTables, HpnicfMdcActionValue=HpnicfMdcActionValue, hpnicfMDCStateChangeToInactive=hpnicfMDCStateChangeToInactive, hpnicfMDCMaxMDCNum=hpnicfMDCMaxMDCNum, hpnicfMDCControlEntry=hpnicfMDCControlEntry, hpnicfMDCAllocateGroupIndex=hpnicfMDCAllocateGroupIndex, hpnicfMDCCurrentMDCNum=hpnicfMDCCurrentMDCNum, hpnicfMDCMemoryResourceQuota=hpnicfMDCMemoryResourceQuota, hpnicfMDCDISKResourceUsage=hpnicfMDCDISKResourceUsage, hpnicfMDCScalarObjects=hpnicfMDCScalarObjects, hpnicfMDCGroupIdentity=hpnicfMDCGroupIdentity, PYSNMP_MODULE_ID=hpnicfMDC, hpnicfMDCDISKResourceMinLimit=hpnicfMDCDISKResourceMinLimit, HpnicfMdcRunStatus=HpnicfMdcRunStatus, hpnicfMDCDISKResourceReserve=hpnicfMDCDISKResourceReserve, hpnicfMDCDISKResourceAvailable=hpnicfMDCDISKResourceAvailable, hpnicfMDCMemoryResourceEntry=hpnicfMDCMemoryResourceEntry, hpnicfMDC=hpnicfMDC, hpnicfMDCName=hpnicfMDCName, hpnicfMDCMemoryResourceTable=hpnicfMDCMemoryResourceTable, hpnicfMDCMemoryResourceMaxLimit=hpnicfMDCMemoryResourceMaxLimit, hpnicfMDCCPUResourceEntry=hpnicfMDCCPUResourceEntry, hpnicfMDCControlTable=hpnicfMDCControlTable, hpnicfMDCAllocateGroupDescription=hpnicfMDCAllocateGroupDescription, hpnicfMDCMemoryResourceUsage=hpnicfMDCMemoryResourceUsage, hpnicfMDCCPUResourceTable=hpnicfMDCCPUResourceTable, hpnicfMDCDISKResourceInstance=hpnicfMDCDISKResourceInstance, hpnicfMDCRowStatus=hpnicfMDCRowStatus, hpnicfMDCAllocate=hpnicfMDCAllocate, hpnicfMDCDISKResourceMaxLimit=hpnicfMDCDISKResourceMaxLimit, hpnicfMDCControl=hpnicfMDCControl, hpnicfMDCMemoryResourceAvailable=hpnicfMDCMemoryResourceAvailable, hpnicfMDCLocationEntry=hpnicfMDCLocationEntry, hpnicfMDCLocation=hpnicfMDCLocation, hpnicfMDCCPUResourceLimit=hpnicfMDCCPUResourceLimit, hpnicfMDCNotificationObjects=hpnicfMDCNotificationObjects, hpnicfMDCNotification=hpnicfMDCNotification, hpnicfMDCMemoryResourceReserve=hpnicfMDCMemoryResourceReserve, hpnicfMDCDISKResourceInstanceName=hpnicfMDCDISKResourceInstanceName, hpnicfMDCGroupIfEntry=hpnicfMDCGroupIfEntry, hpnicfMDCResource=hpnicfMDCResource, hpnicfMDCLocationTable=hpnicfMDCLocationTable, hpnicfMDCStateChangeToActive=hpnicfMDCStateChangeToActive, hpnicfMDCStatus=hpnicfMDCStatus, hpnicfMDCDISKResourceTable=hpnicfMDCDISKResourceTable, hpnicfMDCCPUResourceUsage=hpnicfMDCCPUResourceUsage)
