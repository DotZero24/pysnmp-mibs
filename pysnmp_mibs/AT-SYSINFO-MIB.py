...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/allied-old/AT-SYSINFO-MIB
...
sysinfo.setRevisions(('2006-06-14 00:00', '2008-02-26 00:00', '2010-06-04 00:00', '2010-06-15 00:15', '2010-08-16 00:16', '2010-08-31 00:31', '2010-09-07 00:00',))
if mibBuilder.loadTexts: sysinfo.setLastUpdated('201009070000Z')
...
mibBuilder.exportSymbols("AT-SYSINFO-MIB", sysinfo=sysinfo, cpuUtilisationMax=cpuUtilisationMax, cpuUtilisationAvgLast10Seconds=cpuUtilisationAvgLast10Seconds, fanAndPsPsuStatusTable=fanAndPsPsuStatusTable, sbTempSettableThreshold=sbTempSettableThreshold, cpuUtilisationAvgLast5Minutes=cpuUtilisationAvgLast5Minutes, PYSNMP_MODULE_ID=sysinfo, acceleratorTemperatureTrap=acceleratorTemperatureTrap, fanAndPsPsuTemperature=fanAndPsPsuTemperature, acceleratorTemperatureSupported=acceleratorTemperatureSupported, acceleratorTemperatureStatusTrap=acceleratorTemperatureStatusTrap, fanAndPsFanTrayStatus=fanAndPsFanTrayStatus, fanAndPsTrap=fanAndPsTrap, restart=restart, sbTempFixedThresholdStatus=sbTempFixedThresholdStatus, sbTemperature=sbTemperature, cpuUtilisationAvgLastMinute=cpuUtilisationAvgLastMinute, sbTempFixedThresholdTrap=sbTempFixedThresholdTrap, fanAndPsFanTrayPresent=fanAndPsFanTrayPresent, fanAndPsMainFanStatus=fanAndPsMainFanStatus, hostId=hostId, fanAndPsRedundantFanStatusTrap=fanAndPsRedundantFanStatusTrap, restartNotification=restartNotification, fanAndPsRpsConnectionTrap=fanAndPsRpsConnectionTrap, fanAndPsRedundantPSUStatusTrap=fanAndPsRedundantPSUStatusTrap, fanAndPsMainMonitoringStatusTrap=fanAndPsMainMonitoringStatusTrap, fanAndPsRpsMonitoringStatus=fanAndPsRpsMonitoringStatus, fanAndPsRedundantPSUStatus=fanAndPsRedundantPSUStatus, cpuUtilisationAvg=cpuUtilisationAvg, cpu=cpu, cpuUtilisationMaxLast5Minutes=cpuUtilisationMaxLast5Minutes, bbrNvs=bbrNvs, atPortInfo=atPortInfo, fanAndPsMainPSUStatusTrap=fanAndPsMainPSUStatusTrap, fanAndPsFanTrayPresentTrap=fanAndPsFanTrayPresentTrap, fanAndPsRpsConnectionStatus=fanAndPsRpsConnectionStatus, fanAndPsTemperatureStatusTrap=fanAndPsTemperatureStatusTrap, sbTempEntry=sbTempEntry, sbTempIndex=sbTempIndex, atPortInfoTransceiverTable=atPortInfoTransceiverTable, freeMemory=freeMemory, fanAndPsTemperatureStatus=fanAndPsTemperatureStatus, sysTemperature=sysTemperature, fanAndPsPsuPresent=fanAndPsPsuPresent, atPortRenumberEvents=atPortRenumberEvents, fanAndPsAccelFanStatusTrap=fanAndPsAccelFanStatusTrap, fanAndPsMainMonitoringStatus=fanAndPsMainMonitoringStatus, fanAndPsPsuStatusEntry=fanAndPsPsuStatusEntry, sbTemperatureTrap=sbTemperatureTrap, fanAndPsAccelFanStatus=fanAndPsAccelFanStatus, generalTemperatureThreshold=generalTemperatureThreshold, atPortInfoTransceiverEntry=atPortInfoTransceiverEntry, generalTemperature=generalTemperature, fanAndPsMainFanStatusTrap=fanAndPsMainFanStatusTrap, sbTempActualTemperature=sbTempActualTemperature, cpuUtilisationAvgLastSecond=cpuUtilisationAvgLastSecond, acceleratorTemperatureStatus=acceleratorTemperatureStatus, sbTempSettableThresholdStatus=sbTempSettableThresholdStatus, fanAndPsFanTrayStatusTrap=fanAndPsFanTrayStatusTrap, generalTemperatureSupported=generalTemperatureSupported, bbrNvsReinitialiseTrap=bbrNvsReinitialiseTrap, fanAndPsPsuNumber=fanAndPsPsuNumber, fanAndPsPsuFan=fanAndPsPsuFan, bbrNvsTrap=bbrNvsTrap, lowMemoryTrap=lowMemoryTrap, sbTempSettableThresholdTrap=sbTempSettableThresholdTrap, fanAndPsPsuType=fanAndPsPsuType, totalBuffers=totalBuffers, generalTemperatureTrap=generalTemperatureTrap, fanAndPsRedundantFanStatus=fanAndPsRedundantFanStatus, generalTemperatureStatusTrap=generalTemperatureStatusTrap, restartLog=restartLog, realTimeClockStatus=realTimeClockStatus, atPortInfoTransceiverType=atPortInfoTransceiverType, fanAndPsPsuPower=fanAndPsPsuPower, fanAndPs=fanAndPs, sbTempTable=sbTempTable, generalTemperatureActualTemp=generalTemperatureActualTemp, memory=memory, restartGroup=restartGroup, restartCause=restartCause, fanAndPsMainPSUStatus=fanAndPsMainPSUStatus, atPortInfoTransceiverifIndex=atPortInfoTransceiverifIndex, sbTempFixedThreshold=sbTempFixedThreshold, acceleratorTemperatureThreshold=acceleratorTemperatureThreshold, generalTemperatureStatus=generalTemperatureStatus, atContactDetails=atContactDetails, acceleratorTemperature=acceleratorTemperature, acceleratorTemperatureActualTemp=acceleratorTemperatureActualTemp)
