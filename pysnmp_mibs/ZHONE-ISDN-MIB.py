...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:19:28 2025
...
mibBuilder.exportSymbols("ZHONE-ISDN-MIB", isdnPerfCurBadAmiViolation=isdnPerfCurBadAmiViolation, isdnPerfTotalErrorSeconds=isdnPerfTotalErrorSeconds, isdnLineLoopBack=isdnLineLoopBack, isdnPerfDataPreviousTable=isdnPerfDataPreviousTable, isdnPerCurFsyncSeconds=isdnPerCurFsyncSeconds, isdnPerPrevFsyncSeconds=isdnPerPrevFsyncSeconds, isdnPerfTotalUnbalancedFrame=isdnPerfTotalUnbalancedFrame, isdnThresholdAmiViolations=isdnThresholdAmiViolations, isdnPerfPrevBadAmiViolation=isdnPerfPrevBadAmiViolation, isdnPerfDataTotalEntry=isdnPerfDataTotalEntry, isdnPerfCurUnbalancedFrame=isdnPerfCurUnbalancedFrame, isdnLineTermClass=isdnLineTermClass, isdnThresholdUnbalancedFrame=isdnThresholdUnbalancedFrame, isdnAlarmProfileTable=isdnAlarmProfileTable, PYSNMP_MODULE_ID=zhoneIsdn, isdnPerfPrevUnbalancedFrame=isdnPerfPrevUnbalancedFrame, isdnPerfTotalTimePeriodsElapsed=isdnPerfTotalTimePeriodsElapsed, isdnTrapFrameSynchLoss=isdnTrapFrameSynchLoss, isdnPerfCurTimeElapsed=isdnPerfCurTimeElapsed, isdnTrapUnbalancedFrame=isdnTrapUnbalancedFrame, isdnPerfDataCurrentEntry=isdnPerfDataCurrentEntry, isdnLinePower=isdnLinePower, isdnPerfTotalBadAmiViolation=isdnPerfTotalBadAmiViolation, isdnPerTotalFsyncSeconds=isdnPerTotalFsyncSeconds, isdnAlarmProfileEntry=isdnAlarmProfileEntry, isdnActivationTimer2=isdnActivationTimer2, isdnPerfDataPreviousEntry=isdnPerfDataPreviousEntry, zhoneIsdnTrap=zhoneIsdnTrap, isdnConfigTable=isdnConfigTable, isdnPerfDataTotalTable=isdnPerfDataTotalTable, zhoneIsdnMib=zhoneIsdnMib, isdnPerfPrevErrorSeconds=isdnPerfPrevErrorSeconds, isdnMibV2Traps=isdnMibV2Traps, zhoneIsdn=zhoneIsdn, isdnTrapFECV=isdnTrapFECV, isdnTrapAmiViolations=isdnTrapAmiViolations, isdnConfigEntry=isdnConfigEntry, isdnPerCurErrorSeconds=isdnPerCurErrorSeconds, isdnPerfDataCurrentTable=isdnPerfDataCurrentTable)
