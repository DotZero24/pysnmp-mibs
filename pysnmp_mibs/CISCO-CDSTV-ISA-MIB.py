...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CDSTV-ISA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:50 2025
...
ciscoCdstvIsaMIBCompliance.setObjects(
      *(("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaGeneralGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaContentServiceGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaStreamServiceGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaNamingServiceGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaNotifyServiceGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaContentStoreGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaFactoryGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaContentFactoryGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaContentChannelGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaStreamChannelGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaEventChannelGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaFtpGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaLscpGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCdstvIsaMIBCompliance2.setObjects(
      *(("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaContentServiceGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaStreamServiceGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaNamingServiceGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaNotifyServiceGroup"),
        ...
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaFtpGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaLscpGroup"),
        ("CISCO-CDSTV-ISA-MIB", "ciscoCdstvIsaGeneralGroup2"))
)
if mibBuilder.loadTexts:
