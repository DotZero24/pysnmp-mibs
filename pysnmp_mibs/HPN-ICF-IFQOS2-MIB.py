...
mibBuilder.exportSymbols("HPN-ICF-IFQOS2-MIB", hpnicfIfQoSQmtokenEntry=hpnicfIfQoSQmtokenEntry, hpnicfQoSIfTraStaConfigQueue=hpnicfQoSIfTraStaConfigQueue, PriorityQueue=PriorityQueue, hpnicfIfQoSPriMapGroupTable=hpnicfIfQoSPriMapGroupTable, hpnicfIfQoSPortPirorityTrustTable=hpnicfIfQoSPortPirorityTrustTable, hpnicfIfQoSQueueID=hpnicfIfQoSQueueID, hpnicfQoSIfTraStaConfigInfoTable=hpnicfQoSIfTraStaConfigInfoTable, hpnicfQoSRemarkProtocolPriTable=hpnicfQoSRemarkProtocolPriTable, hpnicfQoSRemarkTcpPortStart=hpnicfQoSRemarkTcpPortStart, hpnicfIfQoSFIFORunInfoEntry=hpnicfIfQoSFIFORunInfoEntry, hpnicfIfQoSPriMapGroupNextIndex=hpnicfIfQoSPriMapGroupNextIndex, hpnicfIfQoSWredPreRandomDropNum=hpnicfIfQoSWredPreRandomDropNum, hpnicfIfQoSGTSPassedPackets=hpnicfIfQoSGTSPassedPackets, hpnicfIfQoSQSWeightEntry=hpnicfIfQoSQSWeightEntry, hpnicfIfQoSAggregativeCarApplyTable=hpnicfIfQoSAggregativeCarApplyTable, hpnicfIfQoSAggregativeCarYellowBytes=hpnicfIfQoSAggregativeCarYellowBytes, hpnicfIfQoSRTPQConfigEntry=hpnicfIfQoSRTPQConfigEntry, hpnicfIfQoSWredGroupContentSubIndex=hpnicfIfQoSWredGroupContentSubIndex, hpnicfQoSIfTraStaRunInfoTable=hpnicfQoSIfTraStaRunInfoTable, hpnicfQoSRemarkIPv6AddrValue=hpnicfQoSRemarkIPv6AddrValue, hpnicfIfQoSWFQSize=hpnicfIfQoSWFQSize, hpnicfIfQoSWredPreTailDropNum=hpnicfIfQoSWredPreTailDropNum, hpnicfIfQoSTricolorCarGreenActionType=hpnicfIfQoSTricolorCarGreenActionType, hpnicfIfQoSWredDropLPreNTcpBPS=hpnicfIfQoSWredDropLPreNTcpBPS, hpnicfQoSTypeOfServiceObjects=hpnicfQoSTypeOfServiceObjects, hpnicfIfQoSGTSConfigEntry=hpnicfIfQoSGTSConfigEntry, hpnicfIfQoSPQQueueLengthTable=hpnicfIfQoSPQQueueLengthTable, hpnicfIfQoSCQRunInfoSize=hpnicfIfQoSCQRunInfoSize, hpnicfQoSRemarkVlanDot1p=hpnicfQoSRemarkVlanDot1p, hpnicfQoSIfTraStaRunPassBytes=hpnicfQoSIfTraStaRunPassBytes, hpnicfIfQoSWredDropPkts=hpnicfIfQoSWredDropPkts, hpnicfIfQoSPortWredPreDiscardProbability=hpnicfIfQoSPortWredPreDiscardProbability, hpnicfIfQoSQSMinBandwidth=hpnicfIfQoSQSMinBandwidth, hpnicfIfQoSPrePriMapTableDirection=hpnicfIfQoSPrePriMapTableDirection, hpnicfQoSGlobalPriorityObject=hpnicfQoSGlobalPriorityObject, hpnicfIfQoSAggregativeCarNextIndex=hpnicfIfQoSAggregativeCarNextIndex, hpnicfIfQoSWredRowStatus=hpnicfIfQoSWredRowStatus, hpnicfIfQoSCQListNumber=hpnicfIfQoSCQListNumber, hpnicfIfQoSWredApplyIfRunInfoTable=hpnicfIfQoSWredApplyIfRunInfoTable, hpnicfIfQoSCQRunInfoTable=hpnicfIfQoSCQRunInfoTable, hpnicfIfQoSWredGroupApplyName=hpnicfIfQoSWredGroupApplyName, Direction=Direction, hpnicfIfQoSQmtokenGroup=hpnicfIfQoSQmtokenGroup, hpnicfIfQoSWredGroupApplyIfTable=hpnicfIfQoSWredGroupApplyIfTable, hpnicfIfQoSPQClassRuleQueueType=hpnicfIfQoSPQClassRuleQueueType, hpnicfIfQoSCQDefaultTable=hpnicfIfQoSCQDefaultTable, hpnicfQoSIfTraStaRunPassBPS=hpnicfQoSIfTraStaRunPassBPS, hpnicfIfQoSCurQueuePkts=hpnicfIfQoSCurQueuePkts, hpnicfIfQoSWredDropHPreNTcpBytes=hpnicfIfQoSWredDropHPreNTcpBytes, hpnicfIfQoSWredGroupEntry=hpnicfIfQoSWredGroupEntry, hpnicfIfQoSWFQType=hpnicfIfQoSWFQType, hpnicfIfQoSTricolorCarDirection=hpnicfIfQoSTricolorCarDirection, hpnicfIfQoSCQObject=hpnicfIfQoSCQObject, hpnicfIfQoSCQApplyRowStatus=hpnicfIfQoSCQApplyRowStatus, hpnicfIfQoSPortWredGroup=hpnicfIfQoSPortWredGroup, hpnicfIfQoSCQClassRuleTable=hpnicfIfQoSCQClassRuleTable, hpnicfIfQoSTailDropBPS=hpnicfIfQoSTailDropBPS, hpnicfIfQoSWredDropLPreTcpPkts=hpnicfIfQoSWredDropLPreTcpPkts, hpnicfIfQoSCQClassRuleValue=hpnicfIfQoSCQClassRuleValue, hpnicfIfQoSWREDTailDropNum=hpnicfIfQoSWREDTailDropNum, hpnicfQoSTraStaObjects=hpnicfQoSTraStaObjects, hpnicfIfQoSGTSQueueSize=hpnicfIfQoSGTSQueueSize, hpnicfIfQoSWredDropPPS=hpnicfIfQoSWredDropPPS, hpnicfIfQoSBandwidthRowStatus=hpnicfIfQoSBandwidthRowStatus, hpnicfIfQoSPQDefaultQueueType=hpnicfIfQoSPQDefaultQueueType, hpnicfQoSRemarkProtocolRowStatus=hpnicfQoSRemarkProtocolRowStatus, hpnicfIfQoSRTPQDiscardPackets=hpnicfIfQoSRTPQDiscardPackets, hpnicfIfQoSDropBytes=hpnicfIfQoSDropBytes, hpnicfIfQoSSoftwareQueueObjects=hpnicfIfQoSSoftwareQueueObjects, hpnicfQoSRemarkUdpPortEnd=hpnicfQoSRemarkUdpPortEnd, hpnicfIfQoSWREDRandomDropNum=hpnicfIfQoSWREDRandomDropNum, hpnicfQoSRemarkTcpPortDot1p=hpnicfQoSRemarkTcpPortDot1p, hpnicfQoSRemarkIPv6AddrDot1p=hpnicfQoSRemarkIPv6AddrDot1p, hpnicfIfQoSTricolorCarYellowActionValue=hpnicfIfQoSTricolorCarYellowActionValue, hpnicfIfQoSRTPQReservedBandwidth=hpnicfIfQoSRTPQReservedBandwidth, hpnicfIfQoSPQApplyTable=hpnicfIfQoSPQApplyTable, hpnicfIfQoSHardwareQueueObjects=hpnicfIfQoSHardwareQueueObjects, hpnicfIfQoSWredGroupContentIndex=hpnicfIfQoSWredGroupContentIndex, hpnicfIfQoSFIFOMaxQueueLen=hpnicfIfQoSFIFOMaxQueueLen, hpnicfIfQoSTricolorCarGreenPackets=hpnicfIfQoSTricolorCarGreenPackets, hpnicfIfQoSWREDObjects=hpnicfIfQoSWREDObjects, hpnicfIfQoSWredLowLimit=hpnicfIfQoSWredLowLimit, hpnicfIfQoSAggregativeCarRedPackets=hpnicfIfQoSAggregativeCarRedPackets, hpnicfIfQoSPriMapContentEntry=hpnicfIfQoSPriMapContentEntry, hpnicfIfQoSHQueueTcpRunInfoEntry=hpnicfIfQoSHQueueTcpRunInfoEntry, hpnicfIfQoSCQApplyListNumber=hpnicfIfQoSCQApplyListNumber, hpnicfIfQoSWFQTable=hpnicfIfQoSWFQTable, hpnicfQoSRemarkProtocolPriEntry=hpnicfQoSRemarkProtocolPriEntry, hpnicfIfQoSDropPackets=hpnicfIfQoSDropPackets, hpnicfIfQoSWredGroupGroup=hpnicfIfQoSWredGroupGroup, hpnicfIfQoSPQQueueLengthValue=hpnicfIfQoSPQQueueLengthValue, hpnicfQoSRemarkTcpPortPriTable=hpnicfQoSRemarkTcpPortPriTable, hpnicfIfQoSPQQueueLengthType=hpnicfIfQoSPQQueueLengthType, hpnicfIfQoSCarlListNum=hpnicfIfQoSCarlListNum, hpnicfIfQoSPrePriMapEntry=hpnicfIfQoSPrePriMapEntry, hpnicfIfQoSWredGroupContentTable=hpnicfIfQoSWredGroupContentTable, hpnicfIfQoSPQDiscardPackets=hpnicfIfQoSPQDiscardPackets, hpnicfIfQoSFIFOConfigEntry=hpnicfIfQoSFIFOConfigEntry, hpnicfIfQoSPrePriMapTableColor=hpnicfIfQoSPrePriMapTableColor, hpnicfIfQoSQSModeTable=hpnicfIfQoSQSModeTable, hpnicfQoSRemarkIPv4AddrPriEntry=hpnicfQoSRemarkIPv4AddrPriEntry, hpnicfIfQoSWFQHashedActiveQueues=hpnicfIfQoSWFQHashedActiveQueues, hpnicfIfQoSAggregativeCarGreenActionType=hpnicfIfQoSAggregativeCarGreenActionType, hpnicfQoSRemarkProtocolValue=hpnicfQoSRemarkProtocolValue, hpnicfIfQoSGTSCir=hpnicfIfQoSGTSCir, hpnicfQoSRemarkVlanRowStatus=hpnicfQoSRemarkVlanRowStatus, hpnicfIfQoSWFQRowStatus=hpnicfIfQoSWFQRowStatus, hpnicfIfQoSGTSCbs=hpnicfIfQoSGTSCbs, hpnicfIfQoSTricolorCarRunInfoTable=hpnicfIfQoSTricolorCarRunInfoTable, hpnicfQoSIfTraStaRunDropBytes=hpnicfQoSIfTraStaRunDropBytes, hpnicfIfQoSPassBytes=hpnicfIfQoSPassBytes, hpnicfIfQoSAggregativeCarApplyRowStatus=hpnicfIfQoSAggregativeCarApplyRowStatus, hpnicfIfQoSGTSConfigRowStatus=hpnicfIfQoSGTSConfigRowStatus, hpnicfIfQoSPQQueueLengthEntry=hpnicfIfQoSPQQueueLengthEntry, hpnicfIfQoSPortWredWeightConstant=hpnicfIfQoSPortWredWeightConstant, hpnicfIfQoSPrePriMapTableType=hpnicfIfQoSPrePriMapTableType, hpnicfIfQoSCurQueuePPS=hpnicfIfQoSCurQueuePPS, hpnicfIfQoSCQQueueLengthEntry=hpnicfIfQoSCQQueueLengthEntry, hpnicfQoSIfTraStaConfigDot1p=hpnicfQoSIfTraStaConfigDot1p, hpnicfIfQoSGTSClassRuleType=hpnicfIfQoSGTSClassRuleType, hpnicfIfQoSTricolorCarEbs=hpnicfIfQoSTricolorCarEbs, hpnicfIfQoSCQQueueServing=hpnicfIfQoSCQQueueServing, hpnicfIfQoSWredDropHPreNTcpPPS=hpnicfIfQoSWredDropHPreNTcpPPS, hpnicfQoSRemarkIPv6AddrPriEntry=hpnicfQoSRemarkIPv6AddrPriEntry, hpnicfQoSRemarkVlanEnd=hpnicfQoSRemarkVlanEnd, hpnicfQoSRemarkUdpPortDscp=hpnicfQoSRemarkUdpPortDscp, hpnicfIfQoSLRPir=hpnicfIfQoSLRPir, hpnicfQoSIfTraStaRunPassPPS=hpnicfQoSIfTraStaRunPassPPS, hpnicfIfQoSLRRunInfoDelayedBytes=hpnicfIfQoSLRRunInfoDelayedBytes, hpnicfQoSIfTraStaRunObjectType=hpnicfQoSIfTraStaRunObjectType, hpnicfIfQoSPortWredWeightConstantRowStatus=hpnicfIfQoSPortWredWeightConstantRowStatus, hpnicfIfQoSRTPQCbs=hpnicfIfQoSRTPQCbs, hpnicfIfQoSGTSEbs=hpnicfIfQoSGTSEbs, hpnicfIfQoSCarlRowStatus=hpnicfIfQoSCarlRowStatus, hpnicfIfQoSWFQConfigGroup=hpnicfIfQoSWFQConfigGroup, hpnicfIfQoSCQConfigGroup=hpnicfIfQoSCQConfigGroup, hpnicfQoSRemarkVlanPriTable=hpnicfQoSRemarkVlanPriTable, hpnicfQoSIfTraStaRunDirection=hpnicfQoSIfTraStaRunDirection, hpnicfIfQoSQSWeightTable=hpnicfIfQoSQSWeightTable, hpnicfQoSRemarkIPv4AddrDscp=hpnicfQoSRemarkIPv4AddrDscp, hpnicfIfQoSWFQObject=hpnicfIfQoSWFQObject, hpnicfIfQoSQueueLengthInPkts=hpnicfIfQoSQueueLengthInPkts, hpnicfIfQoSPQType=hpnicfIfQoSPQType, hpnicfIfQoSRTPQObject=hpnicfIfQoSRTPQObject, hpnicfIfQoSAggregativeCarApplyCarIndex=hpnicfIfQoSAggregativeCarApplyCarIndex, hpnicfIfQoSAggregativeCarIndex=hpnicfIfQoSAggregativeCarIndex, hpnicfIfQoSCARObjects=hpnicfIfQoSCARObjects, hpnicfQoSRemarkUdpPortType=hpnicfQoSRemarkUdpPortType, hpnicfIfQoSPriMapContentTable=hpnicfIfQoSPriMapContentTable, hpnicfIfQoSWFQQueueLength=hpnicfIfQoSWFQQueueLength, hpnicfIfQoSAggregativeCarConfigTable=hpnicfIfQoSAggregativeCarConfigTable, hpnicfIfQoSLineRateObjects=hpnicfIfQoSLineRateObjects, hpnicfIfQoSPriMapGroupImportValue=hpnicfIfQoSPriMapGroupImportValue, hpnicfQos2=hpnicfQos2, hpnicfIfQoSLRRunInfoDelayedPackets=hpnicfIfQoSLRRunInfoDelayedPackets, hpnicfIfQoSPortPriorityValue=hpnicfIfQoSPortPriorityValue, hpnicfIfQoSWredGroupIfRowStatus=hpnicfIfQoSWredGroupIfRowStatus, hpnicfIfQoCarListGroup=hpnicfIfQoCarListGroup, hpnicfIfQoSCarlParaValue=hpnicfIfQoSCarlParaValue, hpnicfIfQoSWFQRunInfoTable=hpnicfIfQoSWFQRunInfoTable, hpnicfIfQoSPQDefaultTable=hpnicfIfQoSPQDefaultTable, hpnicfIfQoSCarListObject=hpnicfIfQoSCarListObject, hpnicfIfQoSLRRunInfoTable=hpnicfIfQoSLRRunInfoTable, hpnicfIfQoSAggregativeCarConfigEntry=hpnicfIfQoSAggregativeCarConfigEntry, hpnicfIfQoSCQQueueLength=hpnicfIfQoSCQQueueLength, hpnicfIfQoSPortWredPreConfigEntry=hpnicfIfQoSPortWredPreConfigEntry, hpnicfIfQoSMaxBandwidth=hpnicfIfQoSMaxBandwidth, hpnicfIfQoSLRCir=hpnicfIfQoSLRCir, hpnicfIfQoSPortWredRunInfoEntry=hpnicfIfQoSPortWredRunInfoEntry, hpnicfIfQoSTricolorCarCir=hpnicfIfQoSTricolorCarCir, hpnicfIfQoSQmtokenRosStatus=hpnicfIfQoSQmtokenRosStatus, hpnicfIfQoSPortWredPreRowStatus=hpnicfIfQoSPortWredPreRowStatus, hpnicfIfQoSLRDirection=hpnicfIfQoSLRDirection, hpnicfIfQoSPortWredWeightConstantEntry=hpnicfIfQoSPortWredWeightConstantEntry, hpnicfQoSRemarkTcpPortPriEntry=hpnicfQoSRemarkTcpPortPriEntry, hpnicfIfQoSPrePriMapTable=hpnicfIfQoSPrePriMapTable, hpnicfQoSRemarkTcpPortRowStatus=hpnicfQoSRemarkTcpPortRowStatus, hpnicfIfQoSTricolorCarValue=hpnicfIfQoSTricolorCarValue, hpnicfIfQoSPortPriorityConfigGroup=hpnicfIfQoSPortPriorityConfigGroup, hpnicfIfQoSCarlParaType=hpnicfIfQoSCarlParaType, hpnicfIfQoSWredDropBytes=hpnicfIfQoSWredDropBytes, hpnicfIfQoSPriMapGroupType=hpnicfIfQoSPriMapGroupType, hpnicfIfQoSAggregativeCarApplyEntry=hpnicfIfQoSAggregativeCarApplyEntry, hpnicfIfQoSBandwidthEntry=hpnicfIfQoSBandwidthEntry, hpnicfIfQoSTricolorCarPir=hpnicfIfQoSTricolorCarPir, hpnicfIfQoSLRRunInfoPassedPackets=hpnicfIfQoSLRRunInfoPassedPackets, hpnicfIfQoSAggregativeCarRunInfoTable=hpnicfIfQoSAggregativeCarRunInfoTable, hpnicfIfQoSPortWredPreID=hpnicfIfQoSPortWredPreID, hpnicfIfQoSCarlTable=hpnicfIfQoSCarlTable, hpnicfIfQoSHardwareQueueRunInfoGroup=hpnicfIfQoSHardwareQueueRunInfoGroup, hpnicfIfQoSCQRunInfoEntry=hpnicfIfQoSCQRunInfoEntry, hpnicfIfQoSRTPQPacketNumber=hpnicfIfQoSRTPQPacketNumber, hpnicfIfQoSAggregativeCarApplyRuleType=hpnicfIfQoSAggregativeCarApplyRuleType, hpnicfIfQoSCQDefaultEntry=hpnicfIfQoSCQDefaultEntry, hpnicfIfQoSAggregativeCarGreenActionValue=hpnicfIfQoSAggregativeCarGreenActionValue, hpnicfIfQoSCurQueueBPS=hpnicfIfQoSCurQueueBPS, hpnicfIfQoSTricolorCarRedActionValue=hpnicfIfQoSTricolorCarRedActionValue, hpnicfIfQoSAggregativeCarRedActionType=hpnicfIfQoSAggregativeCarRedActionType, hpnicfIfQoSAggregativeCarEbs=hpnicfIfQoSAggregativeCarEbs, hpnicfIfQoSTricolorCarRedBytes=hpnicfIfQoSTricolorCarRedBytes, hpnicfIfQoSLRCbs=hpnicfIfQoSLRCbs, hpnicfIfQoSTricolorCarConfigTable=hpnicfIfQoSTricolorCarConfigTable, hpnicfIfQoSWredGroupName=hpnicfIfQoSWredGroupName, hpnicfIfQoSAggregativeCarCir=hpnicfIfQoSAggregativeCarCir, hpnicfIfQoSWredGroupNextIndex=hpnicfIfQoSWredGroupNextIndex, hpnicfIfQoSLRRunInfoActiveShaping=hpnicfIfQoSLRRunInfoActiveShaping, hpnicfIfQoSAggregativeCarRedActionValue=hpnicfIfQoSAggregativeCarRedActionValue, hpnicfIfQoSAggregativeCarYellowActionValue=hpnicfIfQoSAggregativeCarYellowActionValue, hpnicfQoSRemarkIPv6AddrPriTable=hpnicfQoSRemarkIPv6AddrPriTable, hpnicfIfQoSPortWredPreConfigTable=hpnicfIfQoSPortWredPreConfigTable, hpnicfIfQoSL3PlusObjects=hpnicfIfQoSL3PlusObjects, hpnicfIfQoSPQClassRuleEntry=hpnicfIfQoSPQClassRuleEntry, hpnicfIfQoSPriMapGroupExportValue=hpnicfIfQoSPriMapGroupExportValue, hpnicfIfQoSGTSRunInfoEntry=hpnicfIfQoSGTSRunInfoEntry, hpnicfIfQoSPriMapGroupIndex=hpnicfIfQoSPriMapGroupIndex, hpnicfIfQoSQSMode=hpnicfIfQoSQSMode, hpnicfIfQoSQSMinBandwidthPercent=hpnicfIfQoSQSMinBandwidthPercent, hpnicfIfQoSRTPQRowStatus=hpnicfIfQoSRTPQRowStatus, hpnicfIfQos2=hpnicfIfQos2, hpnicfIfQoSPortPirorityTrustEntry=hpnicfIfQoSPortPirorityTrustEntry, hpnicfIfQoSCQClassRuleType=hpnicfIfQoSCQClassRuleType, hpnicfQoSRemarkIPv4AddrMaskLength=hpnicfQoSRemarkIPv4AddrMaskLength, hpnicfIfQoSLRRunInfoEntry=hpnicfIfQoSLRRunInfoEntry, hpnicfIfQoSHardwareQueueRunInfoEntry=hpnicfIfQoSHardwareQueueRunInfoEntry, hpnicfQoSRemarkUdpPortPriTable=hpnicfQoSRemarkUdpPortPriTable, hpnicfIfQoSWredDropLPreTcpPPS=hpnicfIfQoSWredDropLPreTcpPPS, hpnicfIfQoSBindingIf=hpnicfIfQoSBindingIf, hpnicfIfQoSPQListNumber=hpnicfIfQoSPQListNumber, hpnicfIfQoSCQRunInfoGroup=hpnicfIfQoSCQRunInfoGroup, hpnicfIfQoSWredDropHPreNTcpBPS=hpnicfIfQoSWredDropHPreNTcpBPS, hpnicfIfQoSHQueueTcpRunInfoTable=hpnicfIfQoSHQueueTcpRunInfoTable, hpnicfIfQoSFIFORunInfoTable=hpnicfIfQoSFIFORunInfoTable, hpnicfQoSRemarkUdpPortStart=hpnicfQoSRemarkUdpPortStart, hpnicfIfQoSPriMapGroupEntry=hpnicfIfQoSPriMapGroupEntry, hpnicfIfQoSFIFOConfigTable=hpnicfIfQoSFIFOConfigTable, hpnicfIfQoSWFQQueueNumber=hpnicfIfQoSWFQQueueNumber, hpnicfIfQoSGTSClassRuleValue=hpnicfIfQoSGTSClassRuleValue, hpnicfIfQoSWFQLength=hpnicfIfQoSWFQLength, hpnicfIfQoSPQClassRuleType=hpnicfIfQoSPQClassRuleType, hpnicfQoSRemarkIPv6AddrDscp=hpnicfQoSRemarkIPv6AddrDscp, hpnicfIfQoSWredGroupTable=hpnicfIfQoSWredGroupTable, hpnicfIfQoSAggregativeCarCbs=hpnicfIfQoSAggregativeCarCbs, hpnicfIfQoSWredDropHPreTcpBPS=hpnicfIfQoSWredDropHPreTcpBPS, hpnicfIfQoSCQApplyEntry=hpnicfIfQoSCQApplyEntry, hpnicfIfQoSQSModeEntry=hpnicfIfQoSQSModeEntry, hpnicfQoSIfTraStaRunInfoEntry=hpnicfQoSIfTraStaRunInfoEntry, hpnicfIfQoSAggregativeCarGroup=hpnicfIfQoSAggregativeCarGroup, hpnicfQoSTraStaRunGroup=hpnicfQoSTraStaRunGroup, hpnicfQoSRemarkTcpPortType=hpnicfQoSRemarkTcpPortType, hpnicfIfQoSCQQueueLengthTable=hpnicfIfQoSCQQueueLengthTable, hpnicfQoSRemarkIPv4AddrRowStatus=hpnicfQoSRemarkIPv4AddrRowStatus, hpnicfIfQoSGTSDelayedPackets=hpnicfIfQoSGTSDelayedPackets, hpnicfIfQoSTricolorCarType=hpnicfIfQoSTricolorCarType, hpnicfQoSRemarkVlanPriEntry=hpnicfQoSRemarkVlanPriEntry)
mibBuilder.exportSymbols("HPN-ICF-IFQOS2-MIB", hpnicfIfQoSBindingRowStatus=hpnicfIfQoSBindingRowStatus, hpnicfIfQoSRTPQOutputPackets=hpnicfIfQoSRTPQOutputPackets, hpnicfIfQoSWredDropLPreTcpBytes=hpnicfIfQoSWredDropLPreTcpBytes, hpnicfIfQoSPQConfigGroup=hpnicfIfQoSPQConfigGroup, hpnicfIfQoSPriMapGroupRowStatus=hpnicfIfQoSPriMapGroupRowStatus, hpnicfIfQoSPQRunInfoGroup=hpnicfIfQoSPQRunInfoGroup, hpnicfIfQoSQmtokenTable=hpnicfIfQoSQmtokenTable, hpnicfIfQoSPortWredPreHighLimit=hpnicfIfQoSPortWredPreHighLimit, hpnicfIfQoSHardwareQueueRunInfoTable=hpnicfIfQoSHardwareQueueRunInfoTable, hpnicfIfQoSTricolorCarYellowActionType=hpnicfIfQoSTricolorCarYellowActionType, hpnicfIfQoSPassPPS=hpnicfIfQoSPassPPS, hpnicfIfQoSPriMapConfigGroup=hpnicfIfQoSPriMapConfigGroup, hpnicfIfQoSQSMaxDelay=hpnicfIfQoSQSMaxDelay, hpnicfQoSRemarkIPv4AddrPriTable=hpnicfQoSRemarkIPv4AddrPriTable, hpnicfQoSRemarkProtocolDot1p=hpnicfQoSRemarkProtocolDot1p, PYSNMP_MODULE_ID=hpnicfIfQos2, hpnicfIfQoSPassBPS=hpnicfIfQoSPassBPS, hpnicfIfQoSTailDropPkts=hpnicfIfQoSTailDropPkts, hpnicfIfQoSAggregativeCarPir=hpnicfIfQoSAggregativeCarPir, hpnicfIfQoSTricolorCarGroup=hpnicfIfQoSTricolorCarGroup, hpnicfQoSRemarkIPv6AddrRowStatus=hpnicfQoSRemarkIPv6AddrRowStatus, hpnicfIfQoSTricolorCarYellowBytes=hpnicfIfQoSTricolorCarYellowBytes, hpnicfIfQoSHardwareQueueConfigGroup=hpnicfIfQoSHardwareQueueConfigGroup, hpnicfIfQoSPortPriorityTable=hpnicfIfQoSPortPriorityTable, hpnicfIfQoSCQQueueID=hpnicfIfQoSCQQueueID, hpnicfIfQoSWredDropLPreTcpBPS=hpnicfIfQoSWredDropLPreTcpBPS, hpnicfIfQoSGTSPassedBytes=hpnicfIfQoSGTSPassedBytes, hpnicfIfQoSRTPQPacketSize=hpnicfIfQoSRTPQPacketSize, hpnicfIfQoSPortWredPreLowLimit=hpnicfIfQoSPortWredPreLowLimit, hpnicfIfQoSAggregativeCarApplyRuleValue=hpnicfIfQoSAggregativeCarApplyRuleValue, hpnicfIfQoSPQClassRowStatus=hpnicfIfQoSPQClassRowStatus, hpnicfIfQoSWredGroupType=hpnicfIfQoSWredGroupType, hpnicfQoSRemarkTcpPortEnd=hpnicfQoSRemarkTcpPortEnd, hpnicfIfQoSQmtokenNumber=hpnicfIfQoSQmtokenNumber, hpnicfQoSIfTraStaRunDropPackets=hpnicfQoSIfTraStaRunDropPackets, hpnicfQoSRemarkIPv4AddrDot1p=hpnicfQoSRemarkIPv4AddrDot1p, hpnicfQoSTraStaConfigGroup=hpnicfQoSTraStaConfigGroup, hpnicfIfQoSGTSDiscardPackets=hpnicfIfQoSGTSDiscardPackets, hpnicfIfQoSPortPriorityTrustTrustType=hpnicfIfQoSPortPriorityTrustTrustType, hpnicfQoSTypeOfServiceMode=hpnicfQoSTypeOfServiceMode, hpnicfIfQoSAggregativeCarRedBytes=hpnicfIfQoSAggregativeCarRedBytes, hpnicfIfQosWFQhashedTotalQueues=hpnicfIfQosWFQhashedTotalQueues, hpnicfIfQoSCQDefaultQueueID=hpnicfIfQoSCQDefaultQueueID, hpnicfIfQoSWredHighLimit=hpnicfIfQoSWredHighLimit, hpnicfIfQoSWredDropHPreTcpBytes=hpnicfIfQoSWredDropHPreTcpBytes, hpnicfIfQoSAggregativeCarName=hpnicfIfQoSAggregativeCarName, hpnicfIfQoSAggregativeCarYellowPackets=hpnicfIfQoSAggregativeCarYellowPackets, hpnicfIfQoSWredGroupIndex=hpnicfIfQoSWredGroupIndex, hpnicfIfQoSAggregativeCarGreenBytes=hpnicfIfQoSAggregativeCarGreenBytes, hpnicfIfQoSPrePriMapTableImportValue=hpnicfIfQoSPrePriMapTableImportValue, hpnicfIfQoSLRConfigTable=hpnicfIfQoSLRConfigTable, hpnicfIfQoSTailDropBytes=hpnicfIfQoSTailDropBytes, hpnicfIfQoSLREbs=hpnicfIfQoSLREbs, hpnicfIfQoSCurQueueBytes=hpnicfIfQoSCurQueueBytes, hpnicfIfQoSPQRunInfoEntry=hpnicfIfQoSPQRunInfoEntry, hpnicfQoSRemarkVlanDscp=hpnicfQoSRemarkVlanDscp, hpnicfIfQoSQSValue=hpnicfIfQoSQSValue, hpnicfIfQoSWredDropLPreNTcpBytes=hpnicfIfQoSWredDropLPreNTcpBytes, hpnicfIfQoSBandwidthTable=hpnicfIfQoSBandwidthTable, hpnicfIfQoSPortPriorityTrustOvercastType=hpnicfIfQoSPortPriorityTrustOvercastType, hpnicfIfQoSPriMapGroupName=hpnicfIfQoSPriMapGroupName, hpnicfIfQoSPQApplyRowStatus=hpnicfIfQoSPQApplyRowStatus, hpnicfIfQoSCQRunInfoLength=hpnicfIfQoSCQRunInfoLength, hpnicfIfQoSWredDropBPS=hpnicfIfQoSWredDropBPS, hpnicfIfQoSPortPriorityObjects=hpnicfIfQoSPortPriorityObjects, hpnicfIfQoSPriMapContentRowStatus=hpnicfIfQoSPriMapContentRowStatus, hpnicfQoSIfTraStaConfigVlan=hpnicfQoSIfTraStaConfigVlan, hpnicfIfQoSWFQEntry=hpnicfIfQoSWFQEntry, hpnicfIfQoSCQApplyTable=hpnicfIfQoSCQApplyTable, hpnicfIfQoSLRRunInfoPassedBytes=hpnicfIfQoSLRRunInfoPassedBytes, hpnicfQoSIfTraStaRunPassPackets=hpnicfQoSIfTraStaRunPassPackets, hpnicfIfQoSWredDiscardProb=hpnicfIfQoSWredDiscardProb, hpnicfIfQoSPortWredRunInfoTable=hpnicfIfQoSPortWredRunInfoTable, hpnicfIfQoSPortWredWeightConstantTable=hpnicfIfQoSPortWredWeightConstantTable, hpnicfIfQoSQSType=hpnicfIfQoSQSType, hpnicfIfQoSPassPackets=hpnicfIfQoSPassPackets, hpnicfIfQoSTricolorCarRunInfoEntry=hpnicfIfQoSTricolorCarRunInfoEntry, hpnicfQoSIfTraStaConfigDirection=hpnicfQoSIfTraStaConfigDirection, hpnicfIfQoSReservedBandwidthPct=hpnicfIfQoSReservedBandwidthPct, hpnicfIfQoSFIFOSize=hpnicfIfQoSFIFOSize, hpnicfIfQoSPrePriMapTableExportValue=hpnicfIfQoSPrePriMapTableExportValue, hpnicfIfQoSRowStatus=hpnicfIfQoSRowStatus, hpnicfIfQoSTricolorCarGreenBytes=hpnicfIfQoSTricolorCarGreenBytes, hpnicfQoSIfTraStaConfigStatus=hpnicfQoSIfTraStaConfigStatus, hpnicfIfQoSMapObjects=hpnicfIfQoSMapObjects, hpnicfIfQoSPQClassRuleTable=hpnicfIfQoSPQClassRuleTable, hpnicfIfQoSWredGroupExponent=hpnicfIfQoSWredGroupExponent, hpnicfIfQoSGTSQueueLength=hpnicfIfQoSGTSQueueLength, hpnicfIfQoSWredDropHPreTcpPPS=hpnicfIfQoSWredDropHPreTcpPPS, hpnicfIfQoSTricolorCarCbs=hpnicfIfQoSTricolorCarCbs, hpnicfIfQoSPQDefaultEntry=hpnicfIfQoSPQDefaultEntry, hpnicfQoSRemarkUdpPortRowStatus=hpnicfQoSRemarkUdpPortRowStatus, hpnicfIfQoSWredDropLPreNTcpPkts=hpnicfIfQoSWredDropLPreNTcpPkts, hpnicfIfQoSAggregativeCarApplyDirection=hpnicfIfQoSAggregativeCarApplyDirection, hpnicfIfQoSTricolorCarRedPackets=hpnicfIfQoSTricolorCarRedPackets, hpnicfIfQoSBandwidthGroup=hpnicfIfQoSBandwidthGroup, hpnicfIfQoSAggregativeCarRowStatus=hpnicfIfQoSAggregativeCarRowStatus, hpnicfIfQoSCQRunInfoDiscardPackets=hpnicfIfQoSCQRunInfoDiscardPackets, hpnicfIfQoSWredDropHPreNTcpPkts=hpnicfIfQoSWredDropHPreNTcpPkts, hpnicfIfQoSPQApplyListNumber=hpnicfIfQoSPQApplyListNumber, hpnicfIfQoSRTPQRunInfoGroup=hpnicfIfQoSRTPQRunInfoGroup, hpnicfIfQoSRTPQRunInfoEntry=hpnicfIfQoSRTPQRunInfoEntry, hpnicfIfQoSAggregativeCarYellowActionType=hpnicfIfQoSAggregativeCarYellowActionType, hpnicfIfQoSQueueLengthInBytes=hpnicfIfQoSQueueLengthInBytes, hpnicfQoSIfTraStaConfigInfoEntry=hpnicfQoSIfTraStaConfigInfoEntry, hpnicfQoSRemarkIPv4AddrValue=hpnicfQoSRemarkIPv4AddrValue, hpnicfIfQoSCQClassRuleEntry=hpnicfIfQoSCQClassRuleEntry, hpnicfIfQoSQueueGroupType=hpnicfIfQoSQueueGroupType, hpnicfIfQoSCQClassRowStatus=hpnicfIfQoSCQClassRowStatus, hpnicfIfQoSPortPriorityEntry=hpnicfIfQoSPortPriorityEntry, hpnicfIfQoSTricolorCarConfigEntry=hpnicfIfQoSTricolorCarConfigEntry, hpnicfIfQoSRTPQConfigGroup=hpnicfIfQoSRTPQConfigGroup, hpnicfIfQoSCQClassRuleQueueID=hpnicfIfQoSCQClassRuleQueueID, hpnicfIfQoSAggregativeCarRunInfoEntry=hpnicfIfQoSAggregativeCarRunInfoEntry, hpnicfIfQoSTricolorCarYellowPackets=hpnicfIfQoSTricolorCarYellowPackets, hpnicfIfQoSGTSDelayedBytes=hpnicfIfQoSGTSDelayedBytes, hpnicfIfQoSPQRunInfoTable=hpnicfIfQoSPQRunInfoTable, hpnicfIfQoSCarlEntry=hpnicfIfQoSCarlEntry, hpnicfIfQoSGTSObjects=hpnicfIfQoSGTSObjects, hpnicfIfQoSWFQHashedMaxActiveQueues=hpnicfIfQoSWFQHashedMaxActiveQueues, CarAction=CarAction, hpnicfIfQoSPortBindingGroup=hpnicfIfQoSPortBindingGroup, hpnicfIfQoSPQSize=hpnicfIfQoSPQSize, hpnicfIfQoSAggregativeCarType=hpnicfIfQoSAggregativeCarType, hpnicfQoSIfTraStaConfigDscp=hpnicfQoSIfTraStaConfigDscp, hpnicfQoSRemarkIPv6AddrPrefixLength=hpnicfQoSRemarkIPv6AddrPrefixLength, hpnicfQoSRemarkUdpPortDot1p=hpnicfQoSRemarkUdpPortDot1p, hpnicfIfQoSAggregativeCarGreenPackets=hpnicfIfQoSAggregativeCarGreenPackets, hpnicfQoSRemarkVlanStart=hpnicfQoSRemarkVlanStart, hpnicfIfQoSWredGroupRowStatus=hpnicfIfQoSWredGroupRowStatus, hpnicfIfQoSFIFOObject=hpnicfIfQoSFIFOObject, hpnicfIfQoSTricolorCarRedActionType=hpnicfIfQoSTricolorCarRedActionType, hpnicfIfQoSWFQRunInfoGroup=hpnicfIfQoSWFQRunInfoGroup, hpnicfIfQoSLRConfigEntry=hpnicfIfQoSLRConfigEntry, hpnicfIfQoSRTPQRunInfoTable=hpnicfIfQoSRTPQRunInfoTable, hpnicfIfQoSPQLength=hpnicfIfQoSPQLength, hpnicfIfQoSWredDropHPreTcpPkts=hpnicfIfQoSWredDropHPreTcpPkts, hpnicfIfQoSPortWredEnable=hpnicfIfQoSPortWredEnable, hpnicfIfQoSPortBindingTable=hpnicfIfQoSPortBindingTable, hpnicfIfQoSWredGroupWeightingConstant=hpnicfIfQoSWredGroupWeightingConstant, hpnicfIfQoSGTSRunInfoTable=hpnicfIfQoSGTSRunInfoTable, hpnicfIfQoSLRUnit=hpnicfIfQoSLRUnit, hpnicfIfQoSWredDropLPreNTcpPPS=hpnicfIfQoSWredDropLPreNTcpPPS, hpnicfQoSIfTraStaRunObjectValue=hpnicfQoSIfTraStaRunObjectValue, hpnicfIfQoSFIFODiscardPackets=hpnicfIfQoSFIFODiscardPackets, hpnicfIfQoSRTPQStartPort=hpnicfIfQoSRTPQStartPort, hpnicfIfQoSWFQRunInfoEntry=hpnicfIfQoSWFQRunInfoEntry, hpnicfIfQoSWredApplyIfRunInfoEntry=hpnicfIfQoSWredApplyIfRunInfoEntry, hpnicfQoSRemarkUdpPortPriEntry=hpnicfQoSRemarkUdpPortPriEntry, hpnicfIfQoSGTSDiscardBytes=hpnicfIfQoSGTSDiscardBytes, hpnicfIfQoSWFQDiscardPackets=hpnicfIfQoSWFQDiscardPackets, hpnicfIfQoSWredGroupContentEntry=hpnicfIfQoSWredGroupContentEntry, hpnicfIfQoSPortBindingEntry=hpnicfIfQoSPortBindingEntry, hpnicfIfQoSTailDropPPS=hpnicfIfQoSTailDropPPS, hpnicfIfQoSPQObject=hpnicfIfQoSPQObject, hpnicfIfQoSWredGroupApplyIfEntry=hpnicfIfQoSWredGroupApplyIfEntry, hpnicfQoSRemarkTcpPortDscp=hpnicfQoSRemarkTcpPortDscp, hpnicfIfQoSTricolorCarRowStatus=hpnicfIfQoSTricolorCarRowStatus, hpnicfIfQoSRTPQConfigTable=hpnicfIfQoSRTPQConfigTable, hpnicfIfQoSRTPQEndPort=hpnicfIfQoSRTPQEndPort, hpnicfIfQoSGTSConfigTable=hpnicfIfQoSGTSConfigTable, hpnicfIfQoSPQClassRuleValue=hpnicfIfQoSPQClassRuleValue, hpnicfIfQoSWredGroupApplyIndex=hpnicfIfQoSWredGroupApplyIndex, hpnicfIfQoSPQApplyEntry=hpnicfIfQoSPQApplyEntry, hpnicfIfQoSTricolorCarGreenActionValue=hpnicfIfQoSTricolorCarGreenActionValue, hpnicfQoSRemarkIPv4AddrMask=hpnicfQoSRemarkIPv4AddrMask)
