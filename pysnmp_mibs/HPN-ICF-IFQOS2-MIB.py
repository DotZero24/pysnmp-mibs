...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hp/HPN-ICF-IFQOS2-MIB
...
mibBuilder.exportSymbols("HPN-ICF-IFQOS2-MIB", hpnicfIfQoSLRCir=hpnicfIfQoSLRCir, hpnicfIfQoSWredGroupType=hpnicfIfQoSWredGroupType, hpnicfIfQoSPQApplyEntry=hpnicfIfQoSPQApplyEntry, hpnicfIfQoSBandwidthEntry=hpnicfIfQoSBandwidthEntry, hpnicfIfQoSCQClassRuleEntry=hpnicfIfQoSCQClassRuleEntry, hpnicfIfQoSPQDefaultEntry=hpnicfIfQoSPQDefaultEntry, hpnicfIfQoSLRRunInfoPassedBytes=hpnicfIfQoSLRRunInfoPassedBytes, hpnicfQoSRemarkTcpPortDot1p=hpnicfQoSRemarkTcpPortDot1p, hpnicfIfQoSRTPQCbs=hpnicfIfQoSRTPQCbs, hpnicfIfQoSLRDirection=hpnicfIfQoSLRDirection, hpnicfIfQoSQmtokenTable=hpnicfIfQoSQmtokenTable, hpnicfIfQoSRTPQOutputPackets=hpnicfIfQoSRTPQOutputPackets, hpnicfQoSRemarkUdpPortDscp=hpnicfQoSRemarkUdpPortDscp, hpnicfIfQoSTricolorCarConfigTable=hpnicfIfQoSTricolorCarConfigTable, hpnicfQoSRemarkUdpPortDot1p=hpnicfQoSRemarkUdpPortDot1p, hpnicfIfQoSTricolorCarRunInfoEntry=hpnicfIfQoSTricolorCarRunInfoEntry, hpnicfIfQoSHardwareQueueObjects=hpnicfIfQoSHardwareQueueObjects, hpnicfIfQoSLRCbs=hpnicfIfQoSLRCbs, hpnicfIfQoSRTPQRunInfoEntry=hpnicfIfQoSRTPQRunInfoEntry, hpnicfIfQoSAggregativeCarGreenActionValue=hpnicfIfQoSAggregativeCarGreenActionValue, hpnicfIfQoSAggregativeCarGreenPackets=hpnicfIfQoSAggregativeCarGreenPackets, hpnicfIfQoSQmtokenGroup=hpnicfIfQoSQmtokenGroup, hpnicfIfQoSPortWredPreID=hpnicfIfQoSPortWredPreID, hpnicfIfQoSCQApplyListNumber=hpnicfIfQoSCQApplyListNumber, hpnicfIfQoSWredDropLPreNTcpBytes=hpnicfIfQoSWredDropLPreNTcpBytes, hpnicfIfQoSPQDefaultQueueType=hpnicfIfQoSPQDefaultQueueType, hpnicfQoSRemarkTcpPortType=hpnicfQoSRemarkTcpPortType, hpnicfIfQoSWredGroupApplyName=hpnicfIfQoSWredGroupApplyName, hpnicfQoSIfTraStaRunObjectType=hpnicfQoSIfTraStaRunObjectType, hpnicfIfQoSFIFOSize=hpnicfIfQoSFIFOSize, hpnicfQoSIfTraStaConfigStatus=hpnicfQoSIfTraStaConfigStatus, hpnicfIfQoSPQConfigGroup=hpnicfIfQoSPQConfigGroup, hpnicfIfQoSCQQueueServing=hpnicfIfQoSCQQueueServing, hpnicfIfQoSRTPQRowStatus=hpnicfIfQoSRTPQRowStatus, hpnicfIfQoSTricolorCarPir=hpnicfIfQoSTricolorCarPir, hpnicfIfQoSQmtokenEntry=hpnicfIfQoSQmtokenEntry, hpnicfIfQoSWredDropLPreNTcpPPS=hpnicfIfQoSWredDropLPreNTcpPPS, hpnicfIfQoSWredGroupIndex=hpnicfIfQoSWredGroupIndex, hpnicfQoSIfTraStaConfigInfoEntry=hpnicfQoSIfTraStaConfigInfoEntry, hpnicfIfQoSPortWredEnable=hpnicfIfQoSPortWredEnable, hpnicfIfQoSPQQueueLengthTable=hpnicfIfQoSPQQueueLengthTable, hpnicfIfQoSFIFOObject=hpnicfIfQoSFIFOObject, hpnicfIfQoSWredRowStatus=hpnicfIfQoSWredRowStatus, hpnicfIfQoSPriMapGroupIndex=hpnicfIfQoSPriMapGroupIndex, hpnicfIfQoSPortWredPreConfigEntry=hpnicfIfQoSPortWredPreConfigEntry, hpnicfIfQoSAggregativeCarYellowPackets=hpnicfIfQoSAggregativeCarYellowPackets, hpnicfIfQoSTricolorCarValue=hpnicfIfQoSTricolorCarValue, hpnicfQoSRemarkIPv4AddrDscp=hpnicfQoSRemarkIPv4AddrDscp, hpnicfIfQoSWFQConfigGroup=hpnicfIfQoSWFQConfigGroup, hpnicfIfQoSWredGroupEntry=hpnicfIfQoSWredGroupEntry, hpnicfQoSIfTraStaRunPassBytes=hpnicfQoSIfTraStaRunPassBytes, hpnicfIfQoSQSMinBandwidth=hpnicfIfQoSQSMinBandwidth, hpnicfIfQoSWredDropHPreNTcpBPS=hpnicfIfQoSWredDropHPreNTcpBPS, hpnicfQoSRemarkIPv4AddrPriEntry=hpnicfQoSRemarkIPv4AddrPriEntry, hpnicfIfQoSPrePriMapTableImportValue=hpnicfIfQoSPrePriMapTableImportValue, PYSNMP_MODULE_ID=hpnicfIfQos2, hpnicfIfQoSQSWeightTable=hpnicfIfQoSQSWeightTable, hpnicfQoSRemarkProtocolValue=hpnicfQoSRemarkProtocolValue, hpnicfQoSIfTraStaRunDropBytes=hpnicfQoSIfTraStaRunDropBytes, hpnicfIfQoSAggregativeCarRedBytes=hpnicfIfQoSAggregativeCarRedBytes, hpnicfQoSRemarkProtocolPriEntry=hpnicfQoSRemarkProtocolPriEntry, hpnicfIfQoSGTSDiscardBytes=hpnicfIfQoSGTSDiscardBytes, hpnicfIfQoSWredDropPkts=hpnicfIfQoSWredDropPkts, hpnicfIfQoSRTPQStartPort=hpnicfIfQoSRTPQStartPort, hpnicfIfQoSCQRunInfoGroup=hpnicfIfQoSCQRunInfoGroup, hpnicfIfQoSCQClassRowStatus=hpnicfIfQoSCQClassRowStatus, hpnicfIfQoSPortBindingTable=hpnicfIfQoSPortBindingTable, hpnicfQoSRemarkVlanPriTable=hpnicfQoSRemarkVlanPriTable, hpnicfIfQoSCarlParaType=hpnicfIfQoSCarlParaType, hpnicfIfQoSMaxBandwidth=hpnicfIfQoSMaxBandwidth, hpnicfIfQoSRTPQConfigTable=hpnicfIfQoSRTPQConfigTable, hpnicfIfQoSPortWredWeightConstantRowStatus=hpnicfIfQoSPortWredWeightConstantRowStatus, hpnicfIfQoSAggregativeCarApplyEntry=hpnicfIfQoSAggregativeCarApplyEntry, hpnicfIfQoSLRRunInfoDelayedPackets=hpnicfIfQoSLRRunInfoDelayedPackets, hpnicfIfQoSAggregativeCarYellowActionValue=hpnicfIfQoSAggregativeCarYellowActionValue, hpnicfQoSRemarkProtocolRowStatus=hpnicfQoSRemarkProtocolRowStatus, hpnicfIfQoSWredDropHPreNTcpBytes=hpnicfIfQoSWredDropHPreNTcpBytes, hpnicfIfQoSPrePriMapTableType=hpnicfIfQoSPrePriMapTableType, hpnicfQoSRemarkTcpPortEnd=hpnicfQoSRemarkTcpPortEnd, hpnicfIfQoSFIFORunInfoEntry=hpnicfIfQoSFIFORunInfoEntry, hpnicfIfQoSHardwareQueueRunInfoTable=hpnicfIfQoSHardwareQueueRunInfoTable, hpnicfIfQoSPQApplyListNumber=hpnicfIfQoSPQApplyListNumber, hpnicfIfQoSCQConfigGroup=hpnicfIfQoSCQConfigGroup, hpnicfIfQoSWFQRunInfoEntry=hpnicfIfQoSWFQRunInfoEntry, hpnicfIfQoSCurQueueBytes=hpnicfIfQoSCurQueueBytes, hpnicfIfQoSMapObjects=hpnicfIfQoSMapObjects, hpnicfIfQoSBandwidthRowStatus=hpnicfIfQoSBandwidthRowStatus, hpnicfIfQoSCarlRowStatus=hpnicfIfQoSCarlRowStatus, hpnicfQoSRemarkIPv4AddrMask=hpnicfQoSRemarkIPv4AddrMask, hpnicfIfQoSGTSQueueLength=hpnicfIfQoSGTSQueueLength, hpnicfIfQoSPQRunInfoGroup=hpnicfIfQoSPQRunInfoGroup, hpnicfIfQoSWredDropHPreTcpPPS=hpnicfIfQoSWredDropHPreTcpPPS, hpnicfQoSIfTraStaConfigDot1p=hpnicfQoSIfTraStaConfigDot1p, hpnicfQoSRemarkUdpPortStart=hpnicfQoSRemarkUdpPortStart, hpnicfIfQoSWredDropLPreTcpPPS=hpnicfIfQoSWredDropLPreTcpPPS, hpnicfQoSRemarkIPv4AddrDot1p=hpnicfQoSRemarkIPv4AddrDot1p, hpnicfIfQoSWFQHashedActiveQueues=hpnicfIfQoSWFQHashedActiveQueues, hpnicfIfQoSPriMapContentEntry=hpnicfIfQoSPriMapContentEntry, hpnicfIfQoSPQObject=hpnicfIfQoSPQObject, hpnicfIfQoSPortPirorityTrustEntry=hpnicfIfQoSPortPirorityTrustEntry, hpnicfQoSIfTraStaConfigDscp=hpnicfQoSIfTraStaConfigDscp, hpnicfIfQoSTricolorCarDirection=hpnicfIfQoSTricolorCarDirection, hpnicfIfQoSAggregativeCarConfigEntry=hpnicfIfQoSAggregativeCarConfigEntry, hpnicfIfQoSPQApplyTable=hpnicfIfQoSPQApplyTable, hpnicfIfQoSQueueLengthInPkts=hpnicfIfQoSQueueLengthInPkts, hpnicfIfQoSTailDropPPS=hpnicfIfQoSTailDropPPS, hpnicfIfQoSAggregativeCarRedPackets=hpnicfIfQoSAggregativeCarRedPackets, hpnicfIfQoSPortBindingGroup=hpnicfIfQoSPortBindingGroup, hpnicfIfQoSPortWredWeightConstant=hpnicfIfQoSPortWredWeightConstant, hpnicfIfQoSPortWredRunInfoTable=hpnicfIfQoSPortWredRunInfoTable, hpnicfIfQoSPrePriMapEntry=hpnicfIfQoSPrePriMapEntry, hpnicfQoSRemarkVlanPriEntry=hpnicfQoSRemarkVlanPriEntry, CarAction=CarAction, hpnicfIfQoSPQLength=hpnicfIfQoSPQLength, hpnicfQoSRemarkTcpPortStart=hpnicfQoSRemarkTcpPortStart, hpnicfIfQoSCQDefaultQueueID=hpnicfIfQoSCQDefaultQueueID, hpnicfIfQoSGTSClassRuleValue=hpnicfIfQoSGTSClassRuleValue, hpnicfIfQoSWredLowLimit=hpnicfIfQoSWredLowLimit, hpnicfIfQoSAggregativeCarGreenBytes=hpnicfIfQoSAggregativeCarGreenBytes, hpnicfIfQoSCQRunInfoEntry=hpnicfIfQoSCQRunInfoEntry, hpnicfIfQoSPQSize=hpnicfIfQoSPQSize, hpnicfIfQoSWredGroupNextIndex=hpnicfIfQoSWredGroupNextIndex, hpnicfIfQoSPQRunInfoEntry=hpnicfIfQoSPQRunInfoEntry, hpnicfIfQoSAggregativeCarApplyTable=hpnicfIfQoSAggregativeCarApplyTable, hpnicfQoSRemarkIPv4AddrValue=hpnicfQoSRemarkIPv4AddrValue, hpnicfQoSRemarkIPv6AddrRowStatus=hpnicfQoSRemarkIPv6AddrRowStatus, hpnicfQoSTraStaConfigGroup=hpnicfQoSTraStaConfigGroup, hpnicfIfQoSPrePriMapTable=hpnicfIfQoSPrePriMapTable, hpnicfIfQoSWredGroupContentTable=hpnicfIfQoSWredGroupContentTable, hpnicfIfQoSCQRunInfoLength=hpnicfIfQoSCQRunInfoLength, hpnicfQoSIfTraStaRunObjectValue=hpnicfQoSIfTraStaRunObjectValue, hpnicfIfQoSPQListNumber=hpnicfIfQoSPQListNumber, hpnicfIfQoSQSModeEntry=hpnicfIfQoSQSModeEntry, hpnicfIfQosWFQhashedTotalQueues=hpnicfIfQosWFQhashedTotalQueues, hpnicfIfQoSFIFOConfigEntry=hpnicfIfQoSFIFOConfigEntry, hpnicfIfQoSRTPQRunInfoTable=hpnicfIfQoSRTPQRunInfoTable, hpnicfIfQoSWREDTailDropNum=hpnicfIfQoSWREDTailDropNum, hpnicfIfQoSCarListObject=hpnicfIfQoSCarListObject, hpnicfIfQoSPassBPS=hpnicfIfQoSPassBPS, hpnicfIfQoSWredDropHPreTcpPkts=hpnicfIfQoSWredDropHPreTcpPkts, hpnicfIfQoSPQClassRowStatus=hpnicfIfQoSPQClassRowStatus, hpnicfIfQoSWFQQueueNumber=hpnicfIfQoSWFQQueueNumber, hpnicfIfQoSPrePriMapTableExportValue=hpnicfIfQoSPrePriMapTableExportValue, hpnicfIfQoSTricolorCarYellowActionValue=hpnicfIfQoSTricolorCarYellowActionValue, hpnicfIfQoSTricolorCarRedBytes=hpnicfIfQoSTricolorCarRedBytes, hpnicfIfQoSPortPriorityTrustTrustType=hpnicfIfQoSPortPriorityTrustTrustType, hpnicfIfQoSCQQueueLengthEntry=hpnicfIfQoSCQQueueLengthEntry, hpnicfIfQoSPortWredGroup=hpnicfIfQoSPortWredGroup, hpnicfIfQoSCQQueueID=hpnicfIfQoSCQQueueID, hpnicfQoSRemarkVlanDscp=hpnicfQoSRemarkVlanDscp, hpnicfQos2=hpnicfQos2, hpnicfIfQoSRTPQPacketSize=hpnicfIfQoSRTPQPacketSize, hpnicfQoSRemarkVlanRowStatus=hpnicfQoSRemarkVlanRowStatus, hpnicfIfQoSFIFOConfigTable=hpnicfIfQoSFIFOConfigTable, hpnicfQoSRemarkTcpPortDscp=hpnicfQoSRemarkTcpPortDscp, hpnicfIfQoSCurQueuePPS=hpnicfIfQoSCurQueuePPS, hpnicfIfQoSWredGroupApplyIfTable=hpnicfIfQoSWredGroupApplyIfTable, hpnicfIfQoSGTSDelayedPackets=hpnicfIfQoSGTSDelayedPackets, hpnicfIfQoSHardwareQueueRunInfoGroup=hpnicfIfQoSHardwareQueueRunInfoGroup, hpnicfIfQoSAggregativeCarRedActionType=hpnicfIfQoSAggregativeCarRedActionType, hpnicfIfQoSQueueGroupType=hpnicfIfQoSQueueGroupType, hpnicfIfQoSAggregativeCarApplyRuleType=hpnicfIfQoSAggregativeCarApplyRuleType, hpnicfQoSRemarkProtocolPriTable=hpnicfQoSRemarkProtocolPriTable, hpnicfIfQoSLRRunInfoDelayedBytes=hpnicfIfQoSLRRunInfoDelayedBytes, hpnicfIfQoSCurQueueBPS=hpnicfIfQoSCurQueueBPS, hpnicfIfQoSPQClassRuleType=hpnicfIfQoSPQClassRuleType, hpnicfIfQoSAggregativeCarYellowBytes=hpnicfIfQoSAggregativeCarYellowBytes, hpnicfIfQoSCQClassRuleType=hpnicfIfQoSCQClassRuleType, hpnicfIfQoSGTSConfigEntry=hpnicfIfQoSGTSConfigEntry, hpnicfIfQoSCARObjects=hpnicfIfQoSCARObjects, hpnicfIfQoSGTSRunInfoTable=hpnicfIfQoSGTSRunInfoTable, hpnicfIfQoSAggregativeCarPir=hpnicfIfQoSAggregativeCarPir, hpnicfIfQoSPortWredPreDiscardProbability=hpnicfIfQoSPortWredPreDiscardProbability, hpnicfQoSRemarkIPv6AddrPriEntry=hpnicfQoSRemarkIPv6AddrPriEntry, hpnicfIfQoSCQObject=hpnicfIfQoSCQObject, hpnicfIfQoSPriMapConfigGroup=hpnicfIfQoSPriMapConfigGroup, hpnicfIfQoSGTSObjects=hpnicfIfQoSGTSObjects, hpnicfIfQoSAggregativeCarYellowActionType=hpnicfIfQoSAggregativeCarYellowActionType, hpnicfIfQoSPortPirorityTrustTable=hpnicfIfQoSPortPirorityTrustTable, hpnicfIfQoSAggregativeCarName=hpnicfIfQoSAggregativeCarName, hpnicfIfQoSAggregativeCarNextIndex=hpnicfIfQoSAggregativeCarNextIndex, hpnicfIfQoSTailDropBPS=hpnicfIfQoSTailDropBPS, hpnicfIfQoSAggregativeCarApplyCarIndex=hpnicfIfQoSAggregativeCarApplyCarIndex, hpnicfIfQoSGTSDiscardPackets=hpnicfIfQoSGTSDiscardPackets, hpnicfIfQoSPQClassRuleTable=hpnicfIfQoSPQClassRuleTable, hpnicfIfQoSWredGroupContentEntry=hpnicfIfQoSWredGroupContentEntry, hpnicfIfQoSPortWredWeightConstantEntry=hpnicfIfQoSPortWredWeightConstantEntry, hpnicfQoSIfTraStaRunPassBPS=hpnicfQoSIfTraStaRunPassBPS, hpnicfIfQoSLRConfigEntry=hpnicfIfQoSLRConfigEntry, hpnicfIfQoSPQQueueLengthEntry=hpnicfIfQoSPQQueueLengthEntry, hpnicfIfQoSWredDropHPreNTcpPPS=hpnicfIfQoSWredDropHPreNTcpPPS, hpnicfIfQoSWFQObject=hpnicfIfQoSWFQObject, hpnicfIfQoSPrePriMapTableDirection=hpnicfIfQoSPrePriMapTableDirection, hpnicfIfQoSWredHighLimit=hpnicfIfQoSWredHighLimit, hpnicfIfQoSRTPQObject=hpnicfIfQoSRTPQObject, hpnicfIfQoSTricolorCarGreenBytes=hpnicfIfQoSTricolorCarGreenBytes, hpnicfIfQoSGTSConfigTable=hpnicfIfQoSGTSConfigTable, hpnicfIfQoSWredDropBPS=hpnicfIfQoSWredDropBPS, hpnicfIfQoSWREDRandomDropNum=hpnicfIfQoSWREDRandomDropNum, hpnicfIfQoSGTSPassedBytes=hpnicfIfQoSGTSPassedBytes, hpnicfIfQoSBindingIf=hpnicfIfQoSBindingIf, hpnicfIfQoSWredGroupGroup=hpnicfIfQoSWredGroupGroup, hpnicfIfQoSRowStatus=hpnicfIfQoSRowStatus, hpnicfIfQoSTricolorCarGreenActionValue=hpnicfIfQoSTricolorCarGreenActionValue, hpnicfIfQoSWredDropHPreNTcpPkts=hpnicfIfQoSWredDropHPreNTcpPkts, hpnicfIfQoSWredPreRandomDropNum=hpnicfIfQoSWredPreRandomDropNum, hpnicfIfQoSQSValue=hpnicfIfQoSQSValue, hpnicfIfQoSCQDefaultTable=hpnicfIfQoSCQDefaultTable, hpnicfIfQoSHardwareQueueConfigGroup=hpnicfIfQoSHardwareQueueConfigGroup, hpnicfIfQoSPQQueueLengthType=hpnicfIfQoSPQQueueLengthType, hpnicfIfQoSPortPriorityTrustOvercastType=hpnicfIfQoSPortPriorityTrustOvercastType, hpnicfQoSIfTraStaConfigVlan=hpnicfQoSIfTraStaConfigVlan, hpnicfIfQoSCQApplyTable=hpnicfIfQoSCQApplyTable, hpnicfIfQoSWredGroupTable=hpnicfIfQoSWredGroupTable, hpnicfQoSGlobalPriorityObject=hpnicfQoSGlobalPriorityObject, hpnicfIfQoSQmtokenNumber=hpnicfIfQoSQmtokenNumber, hpnicfIfQoSQueueID=hpnicfIfQoSQueueID, hpnicfIfQoSPrePriMapTableColor=hpnicfIfQoSPrePriMapTableColor, hpnicfIfQoSWredApplyIfRunInfoTable=hpnicfIfQoSWredApplyIfRunInfoTable, hpnicfQoSRemarkIPv4AddrPriTable=hpnicfQoSRemarkIPv4AddrPriTable, hpnicfIfQoSWredGroupWeightingConstant=hpnicfIfQoSWredGroupWeightingConstant, hpnicfIfQoSAggregativeCarType=hpnicfIfQoSAggregativeCarType, hpnicfQoSRemarkProtocolDot1p=hpnicfQoSRemarkProtocolDot1p, hpnicfIfQoSPortPriorityEntry=hpnicfIfQoSPortPriorityEntry, hpnicfIfQoSAggregativeCarRedActionValue=hpnicfIfQoSAggregativeCarRedActionValue, hpnicfQoSIfTraStaRunDropPackets=hpnicfQoSIfTraStaRunDropPackets, hpnicfIfQoSTricolorCarYellowActionType=hpnicfIfQoSTricolorCarYellowActionType, hpnicfQoSIfTraStaRunPassPPS=hpnicfQoSIfTraStaRunPassPPS, hpnicfIfQoSLRUnit=hpnicfIfQoSLRUnit, Direction=Direction, hpnicfIfQoSWredDropLPreNTcpPkts=hpnicfIfQoSWredDropLPreNTcpPkts, hpnicfIfQoSWredDiscardProb=hpnicfIfQoSWredDiscardProb, hpnicfIfQoSQSWeightEntry=hpnicfIfQoSQSWeightEntry, hpnicfIfQoSGTSQueueSize=hpnicfIfQoSGTSQueueSize, hpnicfQoSRemarkIPv6AddrDscp=hpnicfQoSRemarkIPv6AddrDscp, hpnicfIfQoSAggregativeCarRunInfoEntry=hpnicfIfQoSAggregativeCarRunInfoEntry, hpnicfIfQoSQSMinBandwidthPercent=hpnicfIfQoSQSMinBandwidthPercent, hpnicfIfQoSCQListNumber=hpnicfIfQoSCQListNumber, hpnicfIfQoSTricolorCarConfigEntry=hpnicfIfQoSTricolorCarConfigEntry, hpnicfIfQoSWredGroupApplyIndex=hpnicfIfQoSWredGroupApplyIndex, hpnicfIfQoSTricolorCarEbs=hpnicfIfQoSTricolorCarEbs, hpnicfIfQoSGTSDelayedBytes=hpnicfIfQoSGTSDelayedBytes, hpnicfIfQoSAggregativeCarApplyDirection=hpnicfIfQoSAggregativeCarApplyDirection, hpnicfIfQoSPortWredWeightConstantTable=hpnicfIfQoSPortWredWeightConstantTable, hpnicfIfQoSQSMode=hpnicfIfQoSQSMode, hpnicfIfQoSWredGroupContentSubIndex=hpnicfIfQoSWredGroupContentSubIndex, hpnicfIfQoSPortPriorityTable=hpnicfIfQoSPortPriorityTable, hpnicfIfQoSTricolorCarGreenActionType=hpnicfIfQoSTricolorCarGreenActionType, hpnicfIfQoSWredGroupApplyIfEntry=hpnicfIfQoSWredGroupApplyIfEntry, hpnicfQoSRemarkTcpPortRowStatus=hpnicfQoSRemarkTcpPortRowStatus, PriorityQueue=PriorityQueue, hpnicfIfQoSAggregativeCarEbs=hpnicfIfQoSAggregativeCarEbs, hpnicfIfQoSPriMapGroupEntry=hpnicfIfQoSPriMapGroupEntry, hpnicfIfQoSPortWredRunInfoEntry=hpnicfIfQoSPortWredRunInfoEntry)
mibBuilder.exportSymbols("HPN-ICF-IFQOS2-MIB", hpnicfIfQoSPriMapContentRowStatus=hpnicfIfQoSPriMapContentRowStatus, hpnicfIfQoSGTSCbs=hpnicfIfQoSGTSCbs, hpnicfIfQoSReservedBandwidthPct=hpnicfIfQoSReservedBandwidthPct, hpnicfQoSRemarkIPv6AddrPriTable=hpnicfQoSRemarkIPv6AddrPriTable, hpnicfIfQoSWredPreTailDropNum=hpnicfIfQoSWredPreTailDropNum, hpnicfQoSIfTraStaRunDirection=hpnicfQoSIfTraStaRunDirection, hpnicfIfQoSWFQTable=hpnicfIfQoSWFQTable, hpnicfIfQoSWFQRunInfoTable=hpnicfIfQoSWFQRunInfoTable, hpnicfIfQoSWredDropLPreTcpBytes=hpnicfIfQoSWredDropLPreTcpBytes, hpnicfIfQoSLRRunInfoActiveShaping=hpnicfIfQoSLRRunInfoActiveShaping, hpnicfIfQoSTricolorCarYellowPackets=hpnicfIfQoSTricolorCarYellowPackets, hpnicfIfQoSLRPir=hpnicfIfQoSLRPir, hpnicfIfQoSTailDropBytes=hpnicfIfQoSTailDropBytes, hpnicfIfQoSL3PlusObjects=hpnicfIfQoSL3PlusObjects, hpnicfQoSRemarkVlanEnd=hpnicfQoSRemarkVlanEnd, hpnicfIfQoSPQRunInfoTable=hpnicfIfQoSPQRunInfoTable, hpnicfQoSRemarkUdpPortRowStatus=hpnicfQoSRemarkUdpPortRowStatus, hpnicfIfQoSWFQEntry=hpnicfIfQoSWFQEntry, hpnicfIfQoSCQApplyEntry=hpnicfIfQoSCQApplyEntry, hpnicfIfQoSAggregativeCarApplyRowStatus=hpnicfIfQoSAggregativeCarApplyRowStatus, hpnicfIfQoSWFQType=hpnicfIfQoSWFQType, hpnicfIfQoSPortPriorityConfigGroup=hpnicfIfQoSPortPriorityConfigGroup, hpnicfIfQoSWFQHashedMaxActiveQueues=hpnicfIfQoSWFQHashedMaxActiveQueues, hpnicfIfQoSTailDropPkts=hpnicfIfQoSTailDropPkts, hpnicfQoSRemarkVlanStart=hpnicfQoSRemarkVlanStart, hpnicfIfQoSRTPQPacketNumber=hpnicfIfQoSRTPQPacketNumber, hpnicfQoSTypeOfServiceObjects=hpnicfQoSTypeOfServiceObjects, hpnicfIfQoSTricolorCarRunInfoTable=hpnicfIfQoSTricolorCarRunInfoTable, hpnicfIfQoSQueueLengthInBytes=hpnicfIfQoSQueueLengthInBytes, hpnicfIfQoSWredGroupContentIndex=hpnicfIfQoSWredGroupContentIndex, hpnicfIfQoSCQRunInfoDiscardPackets=hpnicfIfQoSCQRunInfoDiscardPackets, hpnicfIfQoSTricolorCarCbs=hpnicfIfQoSTricolorCarCbs, hpnicfIfQoSWredGroupIfRowStatus=hpnicfIfQoSWredGroupIfRowStatus, hpnicfQoSIfTraStaRunInfoEntry=hpnicfQoSIfTraStaRunInfoEntry, hpnicfIfQoSCarlListNum=hpnicfIfQoSCarlListNum, hpnicfIfQoSDropPackets=hpnicfIfQoSDropPackets, hpnicfIfQoSPriMapContentTable=hpnicfIfQoSPriMapContentTable, hpnicfIfQoSAggregativeCarApplyRuleValue=hpnicfIfQoSAggregativeCarApplyRuleValue, hpnicfIfQoCarListGroup=hpnicfIfQoCarListGroup, hpnicfIfQoSWFQLength=hpnicfIfQoSWFQLength, hpnicfIfQoSCQApplyRowStatus=hpnicfIfQoSCQApplyRowStatus, hpnicfIfQoSPriMapGroupName=hpnicfIfQoSPriMapGroupName, hpnicfIfQoSPQDiscardPackets=hpnicfIfQoSPQDiscardPackets, hpnicfIfQoSTricolorCarRedActionType=hpnicfIfQoSTricolorCarRedActionType, hpnicfIfQoSPriMapGroupType=hpnicfIfQoSPriMapGroupType, hpnicfIfQoSPortPriorityObjects=hpnicfIfQoSPortPriorityObjects, hpnicfIfQoSHQueueTcpRunInfoTable=hpnicfIfQoSHQueueTcpRunInfoTable, hpnicfIfQoSTricolorCarGreenPackets=hpnicfIfQoSTricolorCarGreenPackets, hpnicfIfQoSLRConfigTable=hpnicfIfQoSLRConfigTable, hpnicfIfQoSDropBytes=hpnicfIfQoSDropBytes, hpnicfIfQoSPriMapGroupTable=hpnicfIfQoSPriMapGroupTable, hpnicfQoSRemarkIPv6AddrPrefixLength=hpnicfQoSRemarkIPv6AddrPrefixLength, hpnicfIfQoSBindingRowStatus=hpnicfIfQoSBindingRowStatus, hpnicfIfQoSSoftwareQueueObjects=hpnicfIfQoSSoftwareQueueObjects, hpnicfIfQoSPQClassRuleQueueType=hpnicfIfQoSPQClassRuleQueueType, hpnicfQoSRemarkUdpPortType=hpnicfQoSRemarkUdpPortType, hpnicfIfQoSCarlParaValue=hpnicfIfQoSCarlParaValue, hpnicfIfQoSPQType=hpnicfIfQoSPQType, hpnicfIfQoSPriMapGroupImportValue=hpnicfIfQoSPriMapGroupImportValue, hpnicfIfQoSWredGroupName=hpnicfIfQoSWredGroupName, hpnicfIfQoSCQClassRuleValue=hpnicfIfQoSCQClassRuleValue, hpnicfIfQoSFIFOMaxQueueLen=hpnicfIfQoSFIFOMaxQueueLen, hpnicfIfQoSCarlTable=hpnicfIfQoSCarlTable, hpnicfIfQoSPortBindingEntry=hpnicfIfQoSPortBindingEntry, hpnicfQoSTraStaRunGroup=hpnicfQoSTraStaRunGroup, hpnicfIfQoSPriMapGroupExportValue=hpnicfIfQoSPriMapGroupExportValue, hpnicfIfQoSPassBytes=hpnicfIfQoSPassBytes, hpnicfQoSRemarkUdpPortPriEntry=hpnicfQoSRemarkUdpPortPriEntry, hpnicfIfQoSCQClassRuleQueueID=hpnicfIfQoSCQClassRuleQueueID, hpnicfIfQoSPortPriorityValue=hpnicfIfQoSPortPriorityValue, hpnicfIfQoSCQRunInfoSize=hpnicfIfQoSCQRunInfoSize, hpnicfIfQoSPQQueueLengthValue=hpnicfIfQoSPQQueueLengthValue, hpnicfQoSIfTraStaRunPassPackets=hpnicfQoSIfTraStaRunPassPackets, hpnicfQoSTraStaObjects=hpnicfQoSTraStaObjects, hpnicfIfQoSFIFORunInfoTable=hpnicfIfQoSFIFORunInfoTable, hpnicfIfQoSLREbs=hpnicfIfQoSLREbs, hpnicfIfQoSRTPQReservedBandwidth=hpnicfIfQoSRTPQReservedBandwidth, hpnicfIfQoSWredGroupRowStatus=hpnicfIfQoSWredGroupRowStatus, hpnicfIfQoSLRRunInfoEntry=hpnicfIfQoSLRRunInfoEntry, hpnicfIfQoSCQRunInfoTable=hpnicfIfQoSCQRunInfoTable, hpnicfIfQoSWFQRowStatus=hpnicfIfQoSWFQRowStatus, hpnicfIfQoSCQQueueLengthTable=hpnicfIfQoSCQQueueLengthTable, hpnicfIfQoSHardwareQueueRunInfoEntry=hpnicfIfQoSHardwareQueueRunInfoEntry, hpnicfIfQoSWFQRunInfoGroup=hpnicfIfQoSWFQRunInfoGroup, hpnicfIfQoSPortWredPreLowLimit=hpnicfIfQoSPortWredPreLowLimit, hpnicfQoSRemarkUdpPortEnd=hpnicfQoSRemarkUdpPortEnd, hpnicfQoSRemarkUdpPortPriTable=hpnicfQoSRemarkUdpPortPriTable, hpnicfIfQoSWFQSize=hpnicfIfQoSWFQSize, hpnicfIfQoSGTSPassedPackets=hpnicfIfQoSGTSPassedPackets, hpnicfIfQoSTricolorCarType=hpnicfIfQoSTricolorCarType, hpnicfIfQoSPassPPS=hpnicfIfQoSPassPPS, hpnicfIfQoSWFQDiscardPackets=hpnicfIfQoSWFQDiscardPackets, hpnicfIfQoSLineRateObjects=hpnicfIfQoSLineRateObjects, hpnicfIfQoSTricolorCarCir=hpnicfIfQoSTricolorCarCir, hpnicfIfQoSTricolorCarRedActionValue=hpnicfIfQoSTricolorCarRedActionValue, hpnicfIfQoSPortWredPreHighLimit=hpnicfIfQoSPortWredPreHighLimit, hpnicfIfQoSFIFODiscardPackets=hpnicfIfQoSFIFODiscardPackets, hpnicfIfQoSWREDObjects=hpnicfIfQoSWREDObjects, hpnicfIfQoSCQDefaultEntry=hpnicfIfQoSCQDefaultEntry, hpnicfIfQoSAggregativeCarGreenActionType=hpnicfIfQoSAggregativeCarGreenActionType, hpnicfIfQoSPQClassRuleEntry=hpnicfIfQoSPQClassRuleEntry, hpnicfIfQoSWredDropLPreTcpBPS=hpnicfIfQoSWredDropLPreTcpBPS, hpnicfQoSRemarkVlanDot1p=hpnicfQoSRemarkVlanDot1p, hpnicfIfQoSPQClassRuleValue=hpnicfIfQoSPQClassRuleValue, hpnicfIfQoSAggregativeCarIndex=hpnicfIfQoSAggregativeCarIndex, hpnicfIfQoSQSMaxDelay=hpnicfIfQoSQSMaxDelay, hpnicfQoSIfTraStaConfigInfoTable=hpnicfQoSIfTraStaConfigInfoTable, hpnicfQoSRemarkIPv4AddrMaskLength=hpnicfQoSRemarkIPv4AddrMaskLength, hpnicfIfQoSCQQueueLength=hpnicfIfQoSCQQueueLength, hpnicfIfQoSQmtokenRosStatus=hpnicfIfQoSQmtokenRosStatus, hpnicfIfQoSAggregativeCarCbs=hpnicfIfQoSAggregativeCarCbs, hpnicfIfQoSWredDropHPreTcpBytes=hpnicfIfQoSWredDropHPreTcpBytes, hpnicfIfQoSGTSRunInfoEntry=hpnicfIfQoSGTSRunInfoEntry, hpnicfIfQoSGTSEbs=hpnicfIfQoSGTSEbs, hpnicfQoSTypeOfServiceMode=hpnicfQoSTypeOfServiceMode, hpnicfIfQoSWredDropBytes=hpnicfIfQoSWredDropBytes, hpnicfIfQoSRTPQDiscardPackets=hpnicfIfQoSRTPQDiscardPackets, hpnicfIfQoSQSModeTable=hpnicfIfQoSQSModeTable, hpnicfIfQoSTricolorCarRowStatus=hpnicfIfQoSTricolorCarRowStatus, hpnicfIfQoSBandwidthGroup=hpnicfIfQoSBandwidthGroup, hpnicfIfQoSPortWredPreConfigTable=hpnicfIfQoSPortWredPreConfigTable, hpnicfIfQoSAggregativeCarConfigTable=hpnicfIfQoSAggregativeCarConfigTable, hpnicfIfQoSRTPQConfigEntry=hpnicfIfQoSRTPQConfigEntry, hpnicfIfQoSTricolorCarRedPackets=hpnicfIfQoSTricolorCarRedPackets, hpnicfIfQos2=hpnicfIfQos2, hpnicfIfQoSPQDefaultTable=hpnicfIfQoSPQDefaultTable, hpnicfIfQoSTricolorCarGroup=hpnicfIfQoSTricolorCarGroup, hpnicfQoSIfTraStaRunInfoTable=hpnicfQoSIfTraStaRunInfoTable, hpnicfIfQoSWFQQueueLength=hpnicfIfQoSWFQQueueLength, hpnicfIfQoSQSType=hpnicfIfQoSQSType, hpnicfIfQoSHQueueTcpRunInfoEntry=hpnicfIfQoSHQueueTcpRunInfoEntry, hpnicfIfQoSAggregativeCarRunInfoTable=hpnicfIfQoSAggregativeCarRunInfoTable, hpnicfQoSRemarkTcpPortPriEntry=hpnicfQoSRemarkTcpPortPriEntry, hpnicfIfQoSLRRunInfoTable=hpnicfIfQoSLRRunInfoTable, hpnicfIfQoSCQClassRuleTable=hpnicfIfQoSCQClassRuleTable, hpnicfIfQoSPriMapGroupRowStatus=hpnicfIfQoSPriMapGroupRowStatus, hpnicfIfQoSPQApplyRowStatus=hpnicfIfQoSPQApplyRowStatus, hpnicfIfQoSWredDropLPreTcpPkts=hpnicfIfQoSWredDropLPreTcpPkts, hpnicfQoSRemarkIPv6AddrDot1p=hpnicfQoSRemarkIPv6AddrDot1p, hpnicfIfQoSWredDropLPreNTcpBPS=hpnicfIfQoSWredDropLPreNTcpBPS, hpnicfIfQoSPriMapGroupNextIndex=hpnicfIfQoSPriMapGroupNextIndex, hpnicfQoSRemarkIPv6AddrValue=hpnicfQoSRemarkIPv6AddrValue, hpnicfIfQoSRTPQEndPort=hpnicfIfQoSRTPQEndPort, hpnicfIfQoSTricolorCarYellowBytes=hpnicfIfQoSTricolorCarYellowBytes, hpnicfIfQoSRTPQRunInfoGroup=hpnicfIfQoSRTPQRunInfoGroup, hpnicfIfQoSWredDropPPS=hpnicfIfQoSWredDropPPS, hpnicfQoSRemarkIPv4AddrRowStatus=hpnicfQoSRemarkIPv4AddrRowStatus, hpnicfIfQoSAggregativeCarRowStatus=hpnicfIfQoSAggregativeCarRowStatus, hpnicfIfQoSGTSCir=hpnicfIfQoSGTSCir, hpnicfIfQoSRTPQConfigGroup=hpnicfIfQoSRTPQConfigGroup, hpnicfIfQoSWredApplyIfRunInfoEntry=hpnicfIfQoSWredApplyIfRunInfoEntry, hpnicfIfQoSGTSConfigRowStatus=hpnicfIfQoSGTSConfigRowStatus, hpnicfIfQoSGTSClassRuleType=hpnicfIfQoSGTSClassRuleType, hpnicfIfQoSBandwidthTable=hpnicfIfQoSBandwidthTable, hpnicfIfQoSCurQueuePkts=hpnicfIfQoSCurQueuePkts, hpnicfIfQoSCarlEntry=hpnicfIfQoSCarlEntry, hpnicfIfQoSPortWredPreRowStatus=hpnicfIfQoSPortWredPreRowStatus, hpnicfIfQoSAggregativeCarGroup=hpnicfIfQoSAggregativeCarGroup, hpnicfQoSIfTraStaConfigQueue=hpnicfQoSIfTraStaConfigQueue, hpnicfQoSRemarkTcpPortPriTable=hpnicfQoSRemarkTcpPortPriTable, hpnicfIfQoSAggregativeCarCir=hpnicfIfQoSAggregativeCarCir, hpnicfIfQoSWredDropHPreTcpBPS=hpnicfIfQoSWredDropHPreTcpBPS, hpnicfIfQoSWredGroupExponent=hpnicfIfQoSWredGroupExponent, hpnicfQoSIfTraStaConfigDirection=hpnicfQoSIfTraStaConfigDirection, hpnicfIfQoSLRRunInfoPassedPackets=hpnicfIfQoSLRRunInfoPassedPackets, hpnicfIfQoSPassPackets=hpnicfIfQoSPassPackets)
