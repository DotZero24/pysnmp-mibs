...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:26:14 2025
...
ciscoUnityMIBCompliance.setObjects(
      *(("CISCO-UNITY-MIB", "ciscoUnityInfoGroup"),
        ("CISCO-UNITY-MIB", "ciscoUnityNotificationsInfoGroup"),
        ("CISCO-UNITY-MIB", "ciscoUnityNotificationsGroup"),
        ("CISCO-UNITY-MIB", "ciscoUnityPortInfoGroup"))
)
if mibBuilder.loadTexts:
...
ciscoUnityMIBComplianceRev1.setObjects(
      *(("CISCO-UNITY-MIB", "ciscoUnityInfoGroup"),
        ("CISCO-UNITY-MIB", "ciscoUnityNotificationsInfoGroup"),
        ("CISCO-UNITY-MIB", "ciscoUnityNotificationsGroup"),
        ("CISCO-UNITY-MIB", "ciscoUnityLicInfoGroup"),
        ("CISCO-UNITY-MIB", "ciscoUnityPortInfoGroup"),
        ("CISCO-UNITY-MIB", "ciscoUnityPortInfoGroup2"),
        ("CISCO-UNITY-MIB", "ciscoUnityPortInfoGroup3"))
)
if mibBuilder.loadTexts:
