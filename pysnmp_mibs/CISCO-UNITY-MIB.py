...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-UNITY-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:12:16 2025
...
mibBuilder.exportSymbols("CISCO-UNITY-MIB", ciscoUnityLicLanguagesMax=ciscoUnityLicLanguagesMax, ciscoUnityLicUtilSubs=ciscoUnityLicUtilSubs, ciscoUnityMIBNotifs=ciscoUnityMIBNotifs, ciscoUnityTable=ciscoUnityTable, ciscoUnityPortInfoGroup3=ciscoUnityPortInfoGroup3, ciscoUnityNotificationsGroup=ciscoUnityNotificationsGroup, PYSNMP_MODULE_ID=ciscoUnityMIB, ciscoUnityEventComputer=ciscoUnityEventComputer, ciscoUnityMonitoredEvent=ciscoUnityMonitoredEvent, ciscoUnityLicPrimaryServerIsLic=ciscoUnityLicPrimaryServerIsLic, ciscoUnityInfoGroup=ciscoUnityInfoGroup, ciscoUnityPortEnabled=ciscoUnityPortEnabled, ciscoUnityEventEMSNotes=ciscoUnityEventEMSNotes, ciscoUnityLicMaxMsgRecLenIsLic=ciscoUnityLicMaxMsgRecLenIsLic, ciscoUnityMIBComplianceRev1=ciscoUnityMIBComplianceRev1, ciscoUnityPortInfoGroup2=ciscoUnityPortInfoGroup2, ciscoUnityMIB=ciscoUnityMIB, ciscoUnityLicBridgeSessionsMax=ciscoUnityLicBridgeSessionsMax, ciscoUnityMIBGroups=ciscoUnityMIBGroups, ciscoUnityMIBCompliances=ciscoUnityMIBCompliances, ciscoUnityPortActivity=ciscoUnityPortActivity, ciscoUnityPortsOutbound=ciscoUnityPortsOutbound, ciscoUnityLicSubscribersMax=ciscoUnityLicSubscribersMax, ciscoUnityLicSecondServerIsLic=ciscoUnityLicSecondServerIsLic, ciscoUnityPortsInboundActive=ciscoUnityPortsInboundActive, ciscoUnityPortExtension=ciscoUnityPortExtension, ciscoUnityEventDescription=ciscoUnityEventDescription, ciscoUnityEntry=ciscoUnityEntry, ciscoUnityVersion=ciscoUnityVersion, ciscoUnityEventType=ciscoUnityEventType, ciscoUnityPortsOutboundActive=ciscoUnityPortsOutboundActive, ciscoUnityPortAnswerCalls=ciscoUnityPortAnswerCalls, ciscoUnityPortTable=ciscoUnityPortTable, ciscoUnityEventCategory=ciscoUnityEventCategory, ciscoUnityPortsActive=ciscoUnityPortsActive, ciscoUnityPortMessageNotif=ciscoUnityPortMessageNotif, ciscoUnityMIBConform=ciscoUnityMIBConform, ciscoUnityPortNumber=ciscoUnityPortNumber, CiscoUnityServerStatus=CiscoUnityServerStatus, ciscoUnityMIBObjects=ciscoUnityMIBObjects, ciscoUnityPortIndex=ciscoUnityPortIndex, ciscoUnityIndex=ciscoUnityIndex, ciscoUnityPortIntegration=ciscoUnityPortIntegration, ciscoUnityLicPoolingIsEnabled=ciscoUnityLicPoolingIsEnabled, ciscoUnityName=ciscoUnityName, ciscoUnityPortInfoGroup=ciscoUnityPortInfoGroup, ciscoUnityNotificationsInfoGroup=ciscoUnityNotificationsInfoGroup, ciscoUnityLicUtilVMISubs=ciscoUnityLicUtilVMISubs, ciscoUnityMIBCompliance=ciscoUnityMIBCompliance, ciscoUnityPortAMISDelivery=ciscoUnityPortAMISDelivery, ciscoUnityLicAMISIsLicensed=ciscoUnityLicAMISIsLicensed, ciscoUnityLicUMSubscribersMax=ciscoUnityLicUMSubscribersMax, ciscoUnityPortTRAPConnection=ciscoUnityPortTRAPConnection, ciscoUnityServerState=ciscoUnityServerState, ciscoUnityLicUtilSecondServer=ciscoUnityLicUtilSecondServer, ciscoUnityEventSource=ciscoUnityEventSource, ciscoUnityEventId=ciscoUnityEventId, ciscoUnityNotificationsInfo=ciscoUnityNotificationsInfo, ciscoUnityGeneralInfo=ciscoUnityGeneralInfo, ciscoUnityPorts=ciscoUnityPorts, ciscoUnityPortsInbound=ciscoUnityPortsInbound, ciscoUnityLicVMISubscribersMax=ciscoUnityLicVMISubscribersMax, ciscoUnityEventUser=ciscoUnityEventUser, ciscoUnityLicInfoGroup=ciscoUnityLicInfoGroup, ciscoUnityGlobalInfo=ciscoUnityGlobalInfo, ciscoUnityPortDialoutMWI=ciscoUnityPortDialoutMWI, ciscoUnityLicVPIMIsLicensed=ciscoUnityLicVPIMIsLicensed, ciscoUnityLicTTSSessionsMax=ciscoUnityLicTTSSessionsMax, ciscoUnityEventDate=ciscoUnityEventDate, ciscoUnityLicVoicePortsMax=ciscoUnityLicVoicePortsMax, CiscoUnityIndex=CiscoUnityIndex, ciscoUnityPortObjectId=ciscoUnityPortObjectId, ciscoUnityPortEntry=ciscoUnityPortEntry)
