...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:24:40 2025
...
mibBuilder.exportSymbols("CISCO-UNITY-MIB", ciscoUnityPortEnabled=ciscoUnityPortEnabled, ciscoUnityPortNumber=ciscoUnityPortNumber, ciscoUnityLicUtilSecondServer=ciscoUnityLicUtilSecondServer, ciscoUnityEventId=ciscoUnityEventId, ciscoUnityEventDate=ciscoUnityEventDate, ciscoUnityPortActivity=ciscoUnityPortActivity, ciscoUnityNotificationsInfo=ciscoUnityNotificationsInfo, ciscoUnityIndex=ciscoUnityIndex, ciscoUnityMIBNotifs=ciscoUnityMIBNotifs, ciscoUnityServerState=ciscoUnityServerState, ciscoUnityPortEntry=ciscoUnityPortEntry, ciscoUnityMIB=ciscoUnityMIB, ciscoUnityEventUser=ciscoUnityEventUser, ciscoUnityLicTTSSessionsMax=ciscoUnityLicTTSSessionsMax, ciscoUnityTable=ciscoUnityTable, ciscoUnityPortDialoutMWI=ciscoUnityPortDialoutMWI, ciscoUnityEventType=ciscoUnityEventType, ciscoUnityEventSource=ciscoUnityEventSource, ciscoUnityInfoGroup=ciscoUnityInfoGroup, ciscoUnityGlobalInfo=ciscoUnityGlobalInfo, ciscoUnityPortIntegration=ciscoUnityPortIntegration, ciscoUnityNotificationsInfoGroup=ciscoUnityNotificationsInfoGroup, ciscoUnityLicUtilVMISubs=ciscoUnityLicUtilVMISubs, ciscoUnityEventDescription=ciscoUnityEventDescription, ciscoUnityLicUtilSubs=ciscoUnityLicUtilSubs, ciscoUnityLicLanguagesMax=ciscoUnityLicLanguagesMax, ciscoUnityEventEMSNotes=ciscoUnityEventEMSNotes, ciscoUnityPortObjectId=ciscoUnityPortObjectId, ciscoUnityLicVPIMIsLicensed=ciscoUnityLicVPIMIsLicensed, ciscoUnityMonitoredEvent=ciscoUnityMonitoredEvent, ciscoUnityLicPoolingIsEnabled=ciscoUnityLicPoolingIsEnabled, ciscoUnityMIBCompliance=ciscoUnityMIBCompliance, ciscoUnityEventCategory=ciscoUnityEventCategory, ciscoUnityMIBComplianceRev1=ciscoUnityMIBComplianceRev1, ciscoUnityName=ciscoUnityName, CiscoUnityIndex=CiscoUnityIndex, ciscoUnityPortInfoGroup2=ciscoUnityPortInfoGroup2, ciscoUnityPortIndex=ciscoUnityPortIndex, ciscoUnityPortAMISDelivery=ciscoUnityPortAMISDelivery, ciscoUnityVersion=ciscoUnityVersion, ciscoUnityPortTRAPConnection=ciscoUnityPortTRAPConnection, ciscoUnityLicUMSubscribersMax=ciscoUnityLicUMSubscribersMax, ciscoUnityPortAnswerCalls=ciscoUnityPortAnswerCalls, ciscoUnityLicAMISIsLicensed=ciscoUnityLicAMISIsLicensed, ciscoUnityPortInfoGroup=ciscoUnityPortInfoGroup, ciscoUnityLicVoicePortsMax=ciscoUnityLicVoicePortsMax, ciscoUnityLicPrimaryServerIsLic=ciscoUnityLicPrimaryServerIsLic, ciscoUnityLicVMISubscribersMax=ciscoUnityLicVMISubscribersMax, ciscoUnityPortExtension=ciscoUnityPortExtension, ciscoUnityPortsActive=ciscoUnityPortsActive, CiscoUnityServerStatus=CiscoUnityServerStatus, ciscoUnityPortsOutbound=ciscoUnityPortsOutbound, ciscoUnityMIBCompliances=ciscoUnityMIBCompliances, ciscoUnityPortInfoGroup3=ciscoUnityPortInfoGroup3, ciscoUnityPortTable=ciscoUnityPortTable, ciscoUnityLicInfoGroup=ciscoUnityLicInfoGroup, ciscoUnityLicBridgeSessionsMax=ciscoUnityLicBridgeSessionsMax, ciscoUnityPortsInboundActive=ciscoUnityPortsInboundActive, ciscoUnityPortMessageNotif=ciscoUnityPortMessageNotif, ciscoUnityPortsOutboundActive=ciscoUnityPortsOutboundActive, ciscoUnityLicMaxMsgRecLenIsLic=ciscoUnityLicMaxMsgRecLenIsLic, ciscoUnityGeneralInfo=ciscoUnityGeneralInfo, ciscoUnityMIBConform=ciscoUnityMIBConform, ciscoUnityMIBObjects=ciscoUnityMIBObjects, ciscoUnityPortsInbound=ciscoUnityPortsInbound, ciscoUnityLicSubscribersMax=ciscoUnityLicSubscribersMax, ciscoUnityPorts=ciscoUnityPorts, ciscoUnityLicSecondServerIsLic=ciscoUnityLicSecondServerIsLic, ciscoUnityEntry=ciscoUnityEntry, ciscoUnityMIBGroups=ciscoUnityMIBGroups, ciscoUnityNotificationsGroup=ciscoUnityNotificationsGroup, PYSNMP_MODULE_ID=ciscoUnityMIB, ciscoUnityEventComputer=ciscoUnityEventComputer)
