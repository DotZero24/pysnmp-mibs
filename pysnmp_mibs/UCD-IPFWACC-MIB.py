...
mibBuilder.exportSymbols("UCD-IPFWACC-MIB", ipFwAccPort10=ipFwAccPort10, ipFwAccPort3=ipFwAccPort3, ipFwAccNrDstPorts=ipFwAccNrDstPorts, ipFwAccPort4=ipFwAccPort4, ipFwAccPort2=ipFwAccPort2, ipFwAccPort6=ipFwAccPort6, ipFwAccSrcAddr=ipFwAccSrcAddr, ipFwAccPort8=ipFwAccPort8, ipFwAccPort9=ipFwAccPort9, ipFwAccViaName=ipFwAccViaName, ipFwAccSrcIsRange=ipFwAccSrcIsRange, ipFwAccPort7=ipFwAccPort7, PYSNMP_MODULE_ID=ucdIpFwAccMIB, ipFwAccSrcNetMask=ipFwAccSrcNetMask, ipFwAccBidir=ipFwAccBidir, ipFwAccDstIsRange=ipFwAccDstIsRange, ipFwAccDstAddr=ipFwAccDstAddr, ipFwAccBytes=ipFwAccBytes, ipFwAccNrSrcPorts=ipFwAccNrSrcPorts, ipFwAccPort1=ipFwAccPort1, ipFwAccIndex=ipFwAccIndex, ipFwAccPort5=ipFwAccPort5, ipFwAccDir=ipFwAccDir, ipFwAccEntry=ipFwAccEntry, ipFwAccProto=ipFwAccProto, ipFwAccPackets=ipFwAccPackets, ipFwAccViaAddr=ipFwAccViaAddr, ucdIpFwAccMIB=ucdIpFwAccMIB, ipFwAccDstNetMask=ipFwAccDstNetMask, ipFwAccTable=ipFwAccTable)
