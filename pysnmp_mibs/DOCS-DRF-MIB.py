...
# Notes
# -----
# ASN.1 source file://mibs/rfc/DOCS-DRF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:24:08 2025
...
docsDrfChannelBlockTestType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
docsDrfDeviceCompliance.setObjects(
    ("DOCS-DRF-MIB", "docsDrfGroup")
)
if mibBuilder.loadTexts:
...
docsDrfCmtsCompliance.setObjects(
      *(("DOCS-DRF-MIB", "docsDrfGroup"),
        ("DOCS-DRF-MIB", "docsDrfCmtsGroup"))
)
if mibBuilder.loadTexts:
