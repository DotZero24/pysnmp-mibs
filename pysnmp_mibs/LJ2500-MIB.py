# SNMP MIB module (LJ2500-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hp/LJ2500-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:41:17 2025
...
class _Consumable_status_page_count_postcard_Type(Integer32):
    """Custom type consumable_status_page_count_postcard based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Consumable_status_page_count_postcard_Type.__name__ = "Integer32"
_Consumable_status_page_count_postcard_Object = MibScalar
consumable_status_page_count_postcard = _Consumable_status_page_count_postcard_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 10, 1, 1, 35),
    _Consumable_status_page_count_postcard_Type()
)
consumable_status_page_count_postcard.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    consumable_status_page_count_postcard.setStatus("optional")
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "consumable-status-page-count-postcard": consumable_status_page_count_postcard,
