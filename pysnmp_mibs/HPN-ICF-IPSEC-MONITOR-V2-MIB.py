...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-IPSEC-MONITOR-V2-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:39:59 2025
...
hpnicfIPsecComplianceV2.setObjects(
      *(("HPN-ICF-IPSEC-MONITOR-V2-MIB", "hpnicfIPsecScalarObjectsGroupV2"),
        ("HPN-ICF-IPSEC-MONITOR-V2-MIB", "hpnicfIPsecTunnelTableGroupV2"),
        ("HPN-ICF-IPSEC-MONITOR-V2-MIB", "hpnicfIPsecTunnelStatGroupV2"),
        ("HPN-ICF-IPSEC-MONITOR-V2-MIB", "hpnicfIPsecSaGroupV2"),
        ("HPN-ICF-IPSEC-MONITOR-V2-MIB", "hpnicfIPsecTrafficTableGroupV2"),
        ("HPN-ICF-IPSEC-MONITOR-V2-MIB", "hpnicfIPsecGlobalStatsGroupV2"),
        ("HPN-ICF-IPSEC-MONITOR-V2-MIB", "hpnicfIPsecTrapObjectGroupV2"),
        ("HPN-ICF-IPSEC-MONITOR-V2-MIB", "hpnicfIPsecTrapCntlGroupV2"),
        ("HPN-ICF-IPSEC-MONITOR-V2-MIB", "hpnicfIPsecTrapGroupV2"))
)
if mibBuilder.loadTexts:
