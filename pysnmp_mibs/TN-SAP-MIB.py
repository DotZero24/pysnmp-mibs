...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TN-SAP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:02:34 2025
...
class _TnSapAlmProfName_Type(OctetString):
    """Custom type tnSapAlmProfName based on OctetString"""
...
_TnSapAlmProfName_Type.__name__ = "OctetString"
_TnSapAlmProfName_Object = MibTableColumn
tnSapAlmProfName = _TnSapAlmProfName_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 4, 3, 2, 1, 53),
    _TnSapAlmProfName_Type()
)
tnSapAlmProfName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnSapAlmProfName.setStatus("current")
...
class _TnSapTlsFdbTableSizeProfId_Type(TFdbTableSizeProfileID):
    """Custom type tnSapTlsFdbTableSizeProfId based on TFdbTableSizeProfileID"""
    defaultValue = 1


_TnSapTlsFdbTableSizeProfId_Type.__name__ = "TFdbTableSizeProfileID"
_TnSapTlsFdbTableSizeProfId_Object = MibTableColumn
tnSapTlsFdbTableSizeProfId = _TnSapTlsFdbTableSizeProfId_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 4, 3, 3, 1, 83),
    _TnSapTlsFdbTableSizeProfId_Type()
)
tnSapTlsFdbTableSizeProfId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tnSapTlsFdbTableSizeProfId.setStatus("deprecated")
...
class _TnSapEthernetLoopbackMode_Type(SapLoopbackMode):
    """Custom type tnSapEthernetLoopbackMode based on SapLoopbackMode"""
    defaultValue = 1


_TnSapEthernetLoopbackMode_Type.__name__ = "SapLoopbackMode"
_TnSapEthernetLoopbackMode_Object = MibTableColumn
tnSapEthernetLoopbackMode = _TnSapEthernetLoopbackMode_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 4, 3, 43, 1, 4),
    _TnSapEthernetLoopbackMode_Type()
)
tnSapEthernetLoopbackMode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnSapEthernetLoopbackMode.setStatus("current")


class _TnSapEthernetLoopbackMacSwapStaticMac_Type(TruthValue):
    """Custom type tnSapEthernetLoopbackMacSwapStaticMac based on TruthValue"""
    defaultValue = 2


_TnSapEthernetLoopbackMacSwapStaticMac_Type.__name__ = "TruthValue"
_TnSapEthernetLoopbackMacSwapStaticMac_Object = MibTableColumn
tnSapEthernetLoopbackMacSwapStaticMac = _TnSapEthernetLoopbackMacSwapStaticMac_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 4, 3, 43, 1, 5),
    _TnSapEthernetLoopbackMacSwapStaticMac_Type()
)
tnSapEthernetLoopbackMacSwapStaticMac.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnSapEthernetLoopbackMacSwapStaticMac.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"tnSvcSapMIBModule": tnSvcSapMIBModule,
       ...
       "tnSapAlmProfName": tnSapAlmProfName,
       ...
       "tnSapTlsFdbTableSizeProfId": tnSapTlsFdbTableSizeProfId,
       ...
       "tnSapEthernetLoopbackMode": tnSapEthernetLoopbackMode,
       "tnSapEthernetLoopbackMacSwapStaticMac": tnSapEthernetLoopbackMacSwapStaticMac,
