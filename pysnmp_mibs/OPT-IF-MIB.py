...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/rfc/OPT-IF-MIB
...
mibBuilder.exportSymbols("OPT-IF-MIB", optIfOChSrcIntervalNumber=optIfOChSrcIntervalNumber, optIfOMSnSrcPrevDayLastOutputPower=optIfOMSnSrcPrevDayLastOutputPower, optIfPerfMonIntervalNumIntervals=optIfPerfMonIntervalNumIntervals, optIfOChGroupSinkPrevDayTable=optIfOChGroupSinkPrevDayTable, optIfOTSnSrcPrevDayLowInputPower=optIfOTSnSrcPrevDayLowInputPower, optIfOTSnSrcIntervalNumber=optIfOTSnSrcIntervalNumber, optIfOTSnCurrentStatus=optIfOTSnCurrentStatus, optIfOChSrcCurDaySuspectedFlag=optIfOChSrcCurDaySuspectedFlag, optIfODUkBitRateK=optIfODUkBitRateK, optIfOChGroupSrcCurDayTable=optIfOChGroupSrcCurDayTable, optIfGCC12ConfigTable=optIfGCC12ConfigTable, optIfODUkTDEGM=optIfODUkTDEGM, optIfOTSnSrcPrevDayTable=optIfOTSnSrcPrevDayTable, optIfODUkTNimTIMDetMode=optIfODUkTNimTIMDetMode, optIfOChGroupSrcCurDayLowAggregatedInputPower=optIfOChGroupSrcCurDayLowAggregatedInputPower, optIfOMSnCurrentStatus=optIfOMSnCurrentStatus, optIfOMSnSinkCurDayLowOutputPower=optIfOMSnSinkCurDayLowOutputPower, optIfGCC0RowStatus=optIfGCC0RowStatus, optIfOChSinkCurDayEntry=optIfOChSinkCurDayEntry, optIfODUkTConfigTable=optIfODUkTConfigTable, optIfODUkNimDAPIExpected=optIfODUkNimDAPIExpected, optIfOChGroupSrcCurDayHighOutputPower=optIfOChGroupSrcCurDayHighOutputPower, optIfOTSnSinkPrevDayLastOutputPower=optIfOTSnSinkPrevDayLastOutputPower, optIfOTSnSrcCurrentUpperOutputPowerThreshold=optIfOTSnSrcCurrentUpperOutputPowerThreshold, OptIfAcTI=OptIfAcTI, optIfODUkPositionSeqPosition=optIfODUkPositionSeqPosition, optIfOMSnSinkPreOtnPMGroup=optIfOMSnSinkPreOtnPMGroup, optIfOMSnSinkCurrentUpperInputPowerThreshold=optIfOMSnSinkCurrentUpperInputPowerThreshold, optIfOMSnSinkIntervalLastOutputPower=optIfOMSnSinkIntervalLastOutputPower, optIfOTSnDirectionality=optIfOTSnDirectionality, optIfOTSnAprControl=optIfOTSnAprControl, optIfOTSnSinkCurrentInputPower=optIfOTSnSinkCurrentInputPower, optIfOChSinkPrevDayHighInputPower=optIfOChSinkPrevDayHighInputPower, optIfOChConfigTable=optIfOChConfigTable, optIfOMSnSinkPrevDayLowOutputPower=optIfOMSnSinkPrevDayLowOutputPower, optIfOChGroupSrcCurrentHighAggregatedInputPower=optIfOChGroupSrcCurrentHighAggregatedInputPower, optIfOChSinkCurDayHighInputPower=optIfOChSinkCurDayHighInputPower, optIfOMSnSrcIntervalLowOutputPower=optIfOMSnSrcIntervalLowOutputPower, optIfOChGroupCommonGroup=optIfOChGroupCommonGroup, optIfOTSnAPRControlGroup=optIfOTSnAPRControlGroup, optIfODUkTNimTcmField=optIfODUkTNimTcmField, optIfODUkNimGroup=optIfODUkNimGroup, optIfOChSinkIntervalNumber=optIfOChSinkIntervalNumber, optIfOTSnSrcCurrentSuspectedFlag=optIfOTSnSrcCurrentSuspectedFlag, optIfOTSnSinkPrevDayLowInputPower=optIfOTSnSinkPrevDayLowInputPower, optIfOTSnSinkCurrentOutputPower=optIfOTSnSinkCurrentOutputPower, optIfODUkTTIMActEnabled=optIfODUkTTIMActEnabled, optIfOChDirectionality=optIfOChDirectionality, optIfOMSnSinkCurDayTable=optIfOMSnSinkCurDayTable, optIfOMSnSrcCurDayTable=optIfOMSnSrcCurDayTable, optIfOChSrcCurrentLowerOutputPowerThreshold=optIfOChSrcCurrentLowerOutputPowerThreshold, optIfOTSnSrcCurrentHighOutputPower=optIfOTSnSrcCurrentHighOutputPower, optIfOTSnSrcPrevDayLowOutputPower=optIfOTSnSrcPrevDayLowOutputPower, optIfOTSnSinkCurrentUpperOutputPowerThreshold=optIfOTSnSinkCurrentUpperOutputPowerThreshold, optIfOChSinkIntervalSuspectedFlag=optIfOChSinkIntervalSuspectedFlag, optIfOTMnTcmMax=optIfOTMnTcmMax, optIfOMSnSrcCurrentSuspectedFlag=optIfOMSnSrcCurrentSuspectedFlag, optIfOTUkSinkAdaptActive=optIfOTUkSinkAdaptActive, optIfOMSnSinkIntervalLowOutputPower=optIfOMSnSinkIntervalLowOutputPower, optIfOTUkCurrentStatus=optIfOTUkCurrentStatus, optIfGCC0ConfigTable=optIfGCC0ConfigTable, optIfOMSnSinkIntervalTable=optIfOMSnSinkIntervalTable, optIfODUkNimConfigEntry=optIfODUkNimConfigEntry, optIfOChGroupSrcIntervalLastOutputPower=optIfOChGroupSrcIntervalLastOutputPower, optIfOChGroup=optIfOChGroup, OptIfExSAPI=OptIfExSAPI, optIfOChSinkCurrentUpperInputPowerThreshold=optIfOChSinkCurrentUpperInputPowerThreshold, optIfOChGroupSinkCurrentHighOutputPower=optIfOChGroupSinkCurrentHighOutputPower, optIfOTMnInterfaceType=optIfOTMnInterfaceType, OptIfDEGM=OptIfDEGM, optIfOMSnSinkCurrentLowOutputPower=optIfOMSnSinkCurrentLowOutputPower, optIfODUkTNimTraceIdentifierAccepted=optIfODUkTNimTraceIdentifierAccepted, optIfOMSnSrcPrevDayEntry=optIfOMSnSrcPrevDayEntry, optIfOTSnSinkIntervalNumber=optIfOTSnSinkIntervalNumber, optIfOTSnSrcIntervalTable=optIfOTSnSrcIntervalTable, optIfODUkNimDEGM=optIfODUkNimDEGM, optIfODUkNimCurrentStatus=optIfODUkNimCurrentStatus, optIfOMSnSourcePreOtnPMGroup=optIfOMSnSourcePreOtnPMGroup, optIfOChGroupSinkIntervalNumber=optIfOChGroupSinkIntervalNumber, optIfOChSinkCurDaySuspectedFlag=optIfOChSinkCurDaySuspectedFlag, optIfOTSnSinkCurrentLowerOutputPowerThreshold=optIfOTSnSinkCurrentLowerOutputPowerThreshold, optIfOMSnSinkIntervalLowAggregatedInputPower=optIfOMSnSinkIntervalLowAggregatedInputPower, optIfOMSnSrcCurDaySuspectedFlag=optIfOMSnSrcCurDaySuspectedFlag, optIfODUkTNimConfigTable=optIfODUkTNimConfigTable, optIfGCC12Group=optIfGCC12Group, optIfOTUkBitRateK=optIfOTUkBitRateK, optIfOTSnSinkCurrentLowerInputPowerThreshold=optIfOTSnSinkCurrentLowerInputPowerThreshold, optIfOMSnSrcIntervalTable=optIfOMSnSrcIntervalTable, optIfODUkTTIMDetMode=optIfODUkTTIMDetMode, optIfOChSinkPrevDayEntry=optIfOChSinkPrevDayEntry, optIfODUkConfigEntry=optIfODUkConfigEntry, optIfOTSnSinkCurrentTable=optIfOTSnSinkCurrentTable, optIfOTUkCommonGroup=optIfOTUkCommonGroup, optIfOChGroupSinkPrevDayLastAggregatedInputPower=optIfOChGroupSinkPrevDayLastAggregatedInputPower, optIfOChGroupSinkIntervalTable=optIfOChGroupSinkIntervalTable, optIfOMSnSrcCurrentHighAggregatedInputPower=optIfOMSnSrcCurrentHighAggregatedInputPower, optIfOChGroupSrcPrevDayLowOutputPower=optIfOChGroupSrcPrevDayLowOutputPower, optIfODUkTtpSourceGroup=optIfODUkTtpSourceGroup, optIfOChSinkPrevDayLastInputPower=optIfOChSinkPrevDayLastInputPower, optIfOMSn=optIfOMSn, optIfOTSnTraceIdentifierAccepted=optIfOTSnTraceIdentifierAccepted, optIfOTSnSinkCurDayHighOutputPower=optIfOTSnSinkCurDayHighOutputPower, optIfOTSnSourcePreOtnPMGroup=optIfOTSnSourcePreOtnPMGroup, optIfODUkTNimDirectionality=optIfODUkTNimDirectionality, optIfODUk=optIfODUk, optIfOChConfigEntry=optIfOChConfigEntry, optIfOChCommonGroup=optIfOChCommonGroup, optIfOChSinkCurrentHighInputPower=optIfOChSinkCurrentHighInputPower, optIfOChGroupSinkCurDaySuspectedFlag=optIfOChGroupSinkCurDaySuspectedFlag, optIfOChSrcCurrentTable=optIfOChSrcCurrentTable, OptIfDirectionality=OptIfDirectionality, optIfGCC12GCCPassThrough=optIfGCC12GCCPassThrough, optIfOChSourcePreOtnPMGroup=optIfOChSourcePreOtnPMGroup, optIfODUkTSinkLockSignalAdminState=optIfODUkTSinkLockSignalAdminState, optIfOTSnCommonGroup=optIfOTSnCommonGroup, optIfOTSnSrcCurrentUpperInputPowerThreshold=optIfOTSnSrcCurrentUpperInputPowerThreshold, optIfODUkNimDirectionality=optIfODUkNimDirectionality, optIfOChSrcCurrentLowOutputPower=optIfOChSrcCurrentLowOutputPower, optIfOChGroupSinkCurrentAggregatedInputPower=optIfOChGroupSinkCurrentAggregatedInputPower, optIfOChGroupSrcCurrentLowAggregatedInputPower=optIfOChGroupSrcCurrentLowAggregatedInputPower, optIfOChSrcCurDayTable=optIfOChSrcCurDayTable, optIfOChSrcIntervalEntry=optIfOChSrcIntervalEntry, optIfOChGroupSrcPrevDayHighAggregatedInputPower=optIfOChGroupSrcPrevDayHighAggregatedInputPower, optIfODUkTCurrentStatus=optIfODUkTCurrentStatus, optIfODUkTtpCurrentStatus=optIfODUkTtpCurrentStatus, optIfOMSnSrcCurrentEntry=optIfOMSnSrcCurrentEntry, optIfOTSnSinkPrevDayLowOutputPower=optIfOTSnSinkPrevDayLowOutputPower, optIfOMSnSinkIntervalLastAggregatedInputPower=optIfOMSnSinkIntervalLastAggregatedInputPower, optIfODUkNimTIMDetMode=optIfODUkNimTIMDetMode, optIfPerfMonCurrentTimeElapsed=optIfPerfMonCurrentTimeElapsed, optIfOMSnSinkCurrentLowerInputPowerThreshold=optIfOMSnSinkCurrentLowerInputPowerThreshold, OptIfExDAPI=OptIfExDAPI, optIfOMSnSinkPrevDayTable=optIfOMSnSinkPrevDayTable, optIfOMSnSrcCurrentUpperInputPowerThreshold=optIfOMSnSrcCurrentUpperInputPowerThreshold, optIfOTSnSinkCurrentLowOutputPower=optIfOTSnSinkCurrentLowOutputPower, optIfOTSnSinkPrevDayLastInputPower=optIfOTSnSinkPrevDayLastInputPower, optIfODUkTNimRowStatus=optIfODUkTNimRowStatus, optIfOMSnConfigTable=optIfOMSnConfigTable, optIfOTSnSinkCurDayEntry=optIfOTSnSinkCurDayEntry, optIfOMSnSinkPrevDayEntry=optIfOMSnSinkPrevDayEntry, optIfOChSrcIntervalLastOutputPower=optIfOChSrcIntervalLastOutputPower, optIfGCC0Application=optIfGCC0Application, optIfPerfMonIntervalEntry=optIfPerfMonIntervalEntry, optIfODUkTSourceGroup=optIfODUkTSourceGroup, optIfOTSnSrcPrevDayLastInputPower=optIfOTSnSrcPrevDayLastInputPower, optIfOMSnSinkCurrentEntry=optIfOMSnSinkCurrentEntry, optIfOMSnSrcCurrentOutputPower=optIfOMSnSrcCurrentOutputPower, optIfODUkGroup=optIfODUkGroup, optIfOMSnSrcCurrentLowerInputPowerThreshold=optIfOMSnSrcCurrentLowerInputPowerThreshold, optIfOMSnSrcIntervalHighAggregatedInputPower=optIfOMSnSrcIntervalHighAggregatedInputPower, optIfODUkDirectionality=optIfODUkDirectionality, optIfOTSnSinkIntervalSuspectedFlag=optIfOTSnSinkIntervalSuspectedFlag, optIfOTMnGroup=optIfOTMnGroup, optIfOChSrcPrevDayLastOutputPower=optIfOChSrcPrevDayLastOutputPower, optIfOMSnSrcIntervalLastAggregatedInputPower=optIfOMSnSrcIntervalLastAggregatedInputPower, optIfOChCurrentStatus=optIfOChCurrentStatus, optIfOChGroupSinkIntervalHighAggregatedInputPower=optIfOChGroupSinkIntervalHighAggregatedInputPower, optIfOChSinkPrevDayLowInputPower=optIfOChSinkPrevDayLowInputPower, optIfOChGroupSinkIntervalLowOutputPower=optIfOChGroupSinkIntervalLowOutputPower, optIfODUkTNimDAPIExpected=optIfODUkTNimDAPIExpected, optIfODUkTtpDAPIExpected=optIfODUkTtpDAPIExpected, optIfOMSnSrcIntervalEntry=optIfOMSnSrcIntervalEntry, optIfOTSnDAPIExpected=optIfOTSnDAPIExpected, optIfOTSnSinkGroupBasic=optIfOTSnSinkGroupBasic, optIfOChSinkCurrentInputPower=optIfOChSinkCurrentInputPower, optIfODUkNimTraceIdentifierAccepted=optIfODUkNimTraceIdentifierAccepted, optIfOTSnSinkIntervalLowOutputPower=optIfOTSnSinkIntervalLowOutputPower, optIfOTUkDAPIExpected=optIfOTUkDAPIExpected, optIfOTUkDEGM=optIfOTUkDEGM, optIfOChGroupSinkCurrentUpperInputPowerThreshold=optIfOChGroupSinkCurrentUpperInputPowerThreshold, optIfOChGroupSinkCurDayHighOutputPower=optIfOChGroupSinkCurDayHighOutputPower, optIfOChSrcCurDayHighOutputPower=optIfOChSrcCurDayHighOutputPower, optIfOCh=optIfOCh, optIfOMSnSrcCurrentLowerOutputPowerThreshold=optIfOMSnSrcCurrentLowerOutputPowerThreshold, optIfODUkNimDEGThr=optIfODUkNimDEGThr, optIfOChGroupSinkPrevDayLastOutputPower=optIfOChGroupSinkPrevDayLastOutputPower, optIfOChGroupSinkIntervalLastAggregatedInputPower=optIfOChGroupSinkIntervalLastAggregatedInputPower, optIfOChGroupSrcCurrentAggregatedInputPower=optIfOChGroupSrcCurrentAggregatedInputPower, optIfOTSnSrcIntervalEntry=optIfOTSnSrcIntervalEntry, optIfOTSnSrcCurDayLowInputPower=optIfOTSnSrcCurDayLowInputPower, optIfOChSinkCurDayTable=optIfOChSinkCurDayTable, optIfOMSnSinkPrevDayLowAggregatedInputPower=optIfOMSnSinkPrevDayLowAggregatedInputPower, OptIfDEGThr=OptIfDEGThr, optIfODUkTNimTIMActEnabled=optIfODUkTNimTIMActEnabled, optIfODUkTSinkGroup=optIfODUkTSinkGroup, optIfOTSnSinkCurrentHighOutputPower=optIfOTSnSinkCurrentHighOutputPower, optIfOChGroupSrcCurDayLowOutputPower=optIfOChGroupSrcCurDayLowOutputPower, optIfOMSnSrcPrevDayHighAggregatedInputPower=optIfOMSnSrcPrevDayHighAggregatedInputPower, optIfOChGroupSourcePreOtnPMThresholdGroup=optIfOChGroupSourcePreOtnPMThresholdGroup, optIfPreOtnPMCompl=optIfPreOtnPMCompl, optIfOChGroupSrcPrevDayEntry=optIfOChGroupSrcPrevDayEntry, optIfODUkNimRowStatus=optIfODUkNimRowStatus, optIfODUkTNimSAPIExpected=optIfODUkTNimSAPIExpected, optIfOMSnSinkCurrentLowAggregatedInputPower=optIfOMSnSinkCurrentLowAggregatedInputPower, optIfOChGroupSrcIntervalTable=optIfOChGroupSrcIntervalTable, optIfOTMn=optIfOTMn, optIfOTSnAPRStatusGroup=optIfOTSnAPRStatusGroup, optIfOChSrcPrevDayTable=optIfOChSrcPrevDayTable, OptIfBitRateK=OptIfBitRateK, optIfOChGroupSrcPrevDayHighOutputPower=optIfOChGroupSrcPrevDayHighOutputPower, optIfOTSnSinkIntervalLastOutputPower=optIfOTSnSinkIntervalLastOutputPower, optIfOMSnSinkCurrentSuspectedFlag=optIfOMSnSinkCurrentSuspectedFlag, optIfODUkTtpConfigTable=optIfODUkTtpConfigTable, optIfOChSrcPrevDayHighOutputPower=optIfOChSrcPrevDayHighOutputPower, optIfOChGroupSinkIntervalEntry=optIfOChGroupSinkIntervalEntry, optIfOMSnSourcePreOtnPMThresholdGroup=optIfOMSnSourcePreOtnPMThresholdGroup, optIfOChGroupSrcIntervalHighAggregatedInputPower=optIfOChGroupSrcIntervalHighAggregatedInputPower, optIfOMSnSrcCurrentLowAggregatedInputPower=optIfOMSnSrcCurrentLowAggregatedInputPower, optIfOChGroupSrcPrevDayTable=optIfOChGroupSrcPrevDayTable, optIfOChGroupSinkCurrentSuspectedFlag=optIfOChGroupSinkCurrentSuspectedFlag, optIfOTUkTIMActEnabled=optIfOTUkTIMActEnabled, optIfOTSnSrcPrevDaySuspectedFlag=optIfOTSnSrcPrevDaySuspectedFlag, optIfOMSnSinkCurrentLowerOutputPowerThreshold=optIfOMSnSinkCurrentLowerOutputPowerThreshold, optIfOTSnSinkIntervalLowInputPower=optIfOTSnSinkIntervalLowInputPower, optIfOTSnSrcPrevDayHighInputPower=optIfOTSnSrcPrevDayHighInputPower, optIfOMSnSrcPrevDayHighOutputPower=optIfOMSnSrcPrevDayHighOutputPower, optIfGroups=optIfGroups, optIfOChSinkPrevDayTable=optIfOChSinkPrevDayTable, optIfOChSinkCurrentEntry=optIfOChSinkCurrentEntry, optIfOChSrcIntervalHighOutputPower=optIfOChSrcIntervalHighOutputPower, optIfOChGroupSinkCurDayLowOutputPower=optIfOChGroupSinkCurDayLowOutputPower, optIfOTUkTraceIdentifierTransmitted=optIfOTUkTraceIdentifierTransmitted, optIfODUkPositionSeqCurrentSize=optIfODUkPositionSeqCurrentSize, optIfODUkT=optIfODUkT, optIfOChSinkIntervalHighInputPower=optIfOChSinkIntervalHighInputPower, optIfOChGroupSinkCurrentHighAggregatedInputPower=optIfOChGroupSinkCurrentHighAggregatedInputPower, optIfOTSnSinkPrevDaySuspectedFlag=optIfOTSnSinkPrevDaySuspectedFlag, optIfODUkNimSAPIExpected=optIfODUkNimSAPIExpected, optIfOChGroupConfigEntry=optIfOChGroupConfigEntry, optIfODUkTtpTIMDetMode=optIfODUkTtpTIMDetMode, optIfOTUkSinkFECEnabled=optIfOTUkSinkFECEnabled, optIfOMSnSinkIntervalSuspectedFlag=optIfOMSnSinkIntervalSuspectedFlag, optIfOChGroupSrcCurrentOutputPower=optIfOChGroupSrcCurrentOutputPower, optIfODUkTtpDEGThr=optIfODUkTtpDEGThr, optIfOMSnConfigEntry=optIfOMSnConfigEntry, optIfODUkTTraceIdentifierTransmitted=optIfODUkTTraceIdentifierTransmitted, optIfOChSrcCurrentOutputPower=optIfOChSrcCurrentOutputPower, optIfOChSrcCurrentSuspectedFlag=optIfOChSrcCurrentSuspectedFlag, optIfOChGroupSrcCurDayHighAggregatedInputPower=optIfOChGroupSrcCurDayHighAggregatedInputPower, optIfOTSnSourceGroupFull=optIfOTSnSourceGroupFull, optIfOChSinkCurrentTable=optIfOChSinkCurrentTable, optIfOTSnTraceIdentifierTransmitted=optIfOTSnTraceIdentifierTransmitted, optIfOTSnSrcIntervalSuspectedFlag=optIfOTSnSrcIntervalSuspectedFlag, optIfOMSnSrcPrevDayLowOutputPower=optIfOMSnSrcPrevDayLowOutputPower, optIfODUkTNimCurrentStatus=optIfODUkTNimCurrentStatus, optIfOChSrcCurDayLowOutputPower=optIfOChSrcCurDayLowOutputPower, optIfOTSnSrcCurrentInputPower=optIfOTSnSrcCurrentInputPower, optIfOMSnSrcCurDayHighAggregatedInputPower=optIfOMSnSrcCurDayHighAggregatedInputPower, optIfOChGroupSinkCurrentLowOutputPower=optIfOChGroupSinkCurrentLowOutputPower, optIfOMSnSrcCurrentAggregatedInputPower=optIfOMSnSrcCurrentAggregatedInputPower, optIfObjects=optIfObjects, optIfODUkTNimDEGM=optIfODUkTNimDEGM, OptIfTxTI=OptIfTxTI, OptIfTIMDetMode=OptIfTIMDetMode)
mibBuilder.exportSymbols("OPT-IF-MIB", optIfOTSnSinkPrevDayTable=optIfOTSnSinkPrevDayTable, optIfOChGroupSrcCurrentUpperInputPowerThreshold=optIfOChGroupSrcCurrentUpperInputPowerThreshold, optIfOChGroupSinkCurDayEntry=optIfOChGroupSinkCurDayEntry, optIfODUkTTraceIdentifierAccepted=optIfODUkTTraceIdentifierAccepted, optIfOMSnSrcIntervalLowAggregatedInputPower=optIfOMSnSrcIntervalLowAggregatedInputPower, optIfOTSnSrcPrevDayHighOutputPower=optIfOTSnSrcPrevDayHighOutputPower, optIfGCC12RowStatus=optIfGCC12RowStatus, optIfOTSnSrcPrevDayEntry=optIfOTSnSrcPrevDayEntry, optIfOChGroupSinkCurrentUpperOutputPowerThreshold=optIfOChGroupSinkCurrentUpperOutputPowerThreshold, optIfODUkTTcmField=optIfODUkTTcmField, optIfOChGroupConfigTable=optIfOChGroupConfigTable, optIfCompl=optIfCompl, optIfOTMnOrder=optIfOTMnOrder, optIfOtnConfigCompl=optIfOtnConfigCompl, optIfOTSnSrcIntervalLowInputPower=optIfOTSnSrcIntervalLowInputPower, optIfOMSnSinkCurrentUpperOutputPowerThreshold=optIfOMSnSinkCurrentUpperOutputPowerThreshold, optIfOTSnSrcIntervalHighOutputPower=optIfOTSnSrcIntervalHighOutputPower, optIfOMSnSrcCurDayEntry=optIfOMSnSrcCurDayEntry, optIfOMSnSinkCurDayEntry=optIfOMSnSinkCurDayEntry, optIfGCC12GCCAccess=optIfGCC12GCCAccess, optIfOTUkSinkGroup=optIfOTUkSinkGroup, optIfOMSnSinkIntervalEntry=optIfOMSnSinkIntervalEntry, optIfOTSnSrcCurrentLowOutputPower=optIfOTSnSrcCurrentLowOutputPower, optIfOMSnCommonGroup=optIfOMSnCommonGroup, optIfOChSrcPrevDayLowOutputPower=optIfOChSrcPrevDayLowOutputPower, optIfPerfMonCurDayTimeElapsed=optIfPerfMonCurDayTimeElapsed, optIfOTSnSrcCurDayHighInputPower=optIfOTSnSrcCurDayHighInputPower, optIfOChGroupSinkPrevDayLowAggregatedInputPower=optIfOChGroupSinkPrevDayLowAggregatedInputPower, optIfConfs=optIfConfs, optIfODUkTNimDEGThr=optIfODUkTNimDEGThr, optIfODUkTConfigEntry=optIfODUkTConfigEntry, optIfOMSnSrcIntervalNumber=optIfOMSnSrcIntervalNumber, optIfOChGroupSrcIntervalLastAggregatedInputPower=optIfOChGroupSrcIntervalLastAggregatedInputPower, optIfMibModule=optIfMibModule, optIfODUkTDAPIExpected=optIfODUkTDAPIExpected, optIfOMSnDirectionality=optIfOMSnDirectionality, optIfOTSnSrcPrevDayLastOutputPower=optIfOTSnSrcPrevDayLastOutputPower, optIfOTUkConfigTable=optIfOTUkConfigTable, optIfOTSnSinkIntervalLastInputPower=optIfOTSnSinkIntervalLastInputPower, optIfOTSnSinkCurDayHighInputPower=optIfOTSnSinkCurDayHighInputPower, optIfOTSnSrcCurrentEntry=optIfOTSnSrcCurrentEntry, optIfOChGroupSinkCurrentLowerInputPowerThreshold=optIfOChGroupSinkCurrentLowerInputPowerThreshold, optIfODUkTtpTraceIdentifierTransmitted=optIfODUkTtpTraceIdentifierTransmitted, optIfGCC0ConfigEntry=optIfGCC0ConfigEntry, optIfODUkConfigTable=optIfODUkConfigTable, optIfODUkTNimConfigEntry=optIfODUkTNimConfigEntry, optIfODUkTtpSinkGroup=optIfODUkTtpSinkGroup, optIfOTSnSinkCurDayLowOutputPower=optIfOTSnSinkCurDayLowOutputPower, optIfOTSnSrcIntervalLowOutputPower=optIfOTSnSrcIntervalLowOutputPower, optIfOTUk=optIfOTUk, optIfOChGroupSrcCurDayEntry=optIfOChGroupSrcCurDayEntry, optIfOMSnSinkPreOtnPMThresholdGroup=optIfOMSnSinkPreOtnPMThresholdGroup, optIfOMSnSinkIntervalNumber=optIfOMSnSinkIntervalNumber, optIfOTSnSinkCurrentLowInputPower=optIfOTSnSinkCurrentLowInputPower, optIfOChSrcCurrentUpperOutputPowerThreshold=optIfOChSrcCurrentUpperOutputPowerThreshold, optIfOTUkTIMDetMode=optIfOTUkTIMDetMode, optIfOTSnSinkIntervalHighInputPower=optIfOTSnSinkIntervalHighInputPower, optIfOMSnSrcPrevDayTable=optIfOMSnSrcPrevDayTable, optIfOChGroupSrcPrevDayLowAggregatedInputPower=optIfOChGroupSrcPrevDayLowAggregatedInputPower, optIfOMSnSinkCurrentHighOutputPower=optIfOMSnSinkCurrentHighOutputPower, optIfOTSnSinkPrevDayHighInputPower=optIfOTSnSinkPrevDayHighInputPower, optIfOChGroupSrcPrevDayLastAggregatedInputPower=optIfOChGroupSrcPrevDayLastAggregatedInputPower, optIfOTSnSrcCurDayTable=optIfOTSnSrcCurDayTable, optIfOMSnSrcCurrentTable=optIfOMSnSrcCurrentTable, optIfOMSnSinkCurrentAggregatedInputPower=optIfOMSnSinkCurrentAggregatedInputPower, optIfOMSnSinkIntervalHighOutputPower=optIfOMSnSinkIntervalHighOutputPower, optIfOChGroupSrcIntervalLowOutputPower=optIfOChGroupSrcIntervalLowOutputPower, optIfOChGroupSinkCurDayLowAggregatedInputPower=optIfOChGroupSinkCurDayLowAggregatedInputPower, optIfOMSnSrcIntervalHighOutputPower=optIfOMSnSrcIntervalHighOutputPower, optIfODUkTSinkMode=optIfODUkTSinkMode, OptIfSinkOrSource=OptIfSinkOrSource, optIfGCC0Group=optIfGCC0Group, optIfOChSrcCurrentEntry=optIfOChSrcCurrentEntry, optIfOTSnSrcCurrentLowInputPower=optIfOTSnSrcCurrentLowInputPower, optIfODUkNimTIMActEnabled=optIfODUkNimTIMActEnabled, optIfOChSinkCurrentLowerInputPowerThreshold=optIfOChSinkCurrentLowerInputPowerThreshold, optIfOTSnSourcePreOtnPMThresholdGroup=optIfOTSnSourcePreOtnPMThresholdGroup, optIfOTSnConfigEntry=optIfOTSnConfigEntry, optIfGCC12Codirectional=optIfGCC12Codirectional, optIfODUkNimConfigTable=optIfODUkNimConfigTable, optIfODUkTCommonGroup=optIfODUkTCommonGroup, optIfOTSnSrcCurDaySuspectedFlag=optIfOTSnSrcCurDaySuspectedFlag, optIfOMSnSinkCurDayHighAggregatedInputPower=optIfOMSnSinkCurDayHighAggregatedInputPower, optIfOTSnTIMActEnabled=optIfOTSnTIMActEnabled, optIfOTSnSinkCurrentHighInputPower=optIfOTSnSinkCurrentHighInputPower, optIfODUkTSinkGroupCtp=optIfODUkTSinkGroupCtp, optIfOChGroupSrcIntervalEntry=optIfOChGroupSrcIntervalEntry, optIfODUkTSourceLockSignalAdminState=optIfODUkTSourceLockSignalAdminState, optIfODUkTtpSAPIExpected=optIfODUkTtpSAPIExpected, optIfODUkPositionSeqPointer=optIfODUkPositionSeqPointer, optIfOTSnSinkCurrentSuspectedFlag=optIfOTSnSinkCurrentSuspectedFlag, optIfOMSnSinkCurrentOutputPower=optIfOMSnSinkCurrentOutputPower, optIfODUkTCodirectional=optIfODUkTCodirectional, optIfOTSnSinkPreOtnPMThresholdGroup=optIfOTSnSinkPreOtnPMThresholdGroup, optIfOChGroupSrcIntervalNumber=optIfOChGroupSrcIntervalNumber, optIfGCC12ConfigEntry=optIfGCC12ConfigEntry, optIfOTMnOpticalReach=optIfOTMnOpticalReach, optIfOChGroupSinkCurrentLowAggregatedInputPower=optIfOChGroupSinkCurrentLowAggregatedInputPower, optIfOTSnSinkCurDaySuspectedFlag=optIfOTSnSinkCurDaySuspectedFlag, optIfOChGroupSinkIntervalHighOutputPower=optIfOChGroupSinkIntervalHighOutputPower, optIfOTMnTable=optIfOTMnTable, optIfOTUkSourceAdaptActive=optIfOTUkSourceAdaptActive, optIfOChSinkGroupBasic=optIfOChSinkGroupBasic, optIfOMSnSinkCurDaySuspectedFlag=optIfOMSnSinkCurDaySuspectedFlag, optIfOMSnSrcCurrentUpperOutputPowerThreshold=optIfOMSnSrcCurrentUpperOutputPowerThreshold, optIfOChGroupSrcCurrentLowOutputPower=optIfOChGroupSrcCurrentLowOutputPower, optIfOMSnSinkPrevDayLastOutputPower=optIfOMSnSinkPrevDayLastOutputPower, optIfPerfMonGroup=optIfPerfMonGroup, optIfOChGroupSrcCurrentLowerInputPowerThreshold=optIfOChGroupSrcCurrentLowerInputPowerThreshold, optIfOTSnSrcCurDayEntry=optIfOTSnSrcCurDayEntry, optIfOChGroupSrcIntervalLowAggregatedInputPower=optIfOChGroupSrcIntervalLowAggregatedInputPower, optIfOMSnSinkCurDayLowAggregatedInputPower=optIfOMSnSinkCurDayLowAggregatedInputPower, optIfOChSrcCurDayEntry=optIfOChSrcCurDayEntry, optIfOTSnSinkCurrentEntry=optIfOTSnSinkCurrentEntry, optIfOTSnSinkCurDayTable=optIfOTSnSinkCurDayTable, optIfOMSnSrcCurDayLowOutputPower=optIfOMSnSrcCurDayLowOutputPower, optIfOChSinkPreOtnPMThresholdGroup=optIfOChSinkPreOtnPMThresholdGroup, optIfOChGroupSrcCurrentLowerOutputPowerThreshold=optIfOChGroupSrcCurrentLowerOutputPowerThreshold, optIfOChGroupSrcPrevDaySuspectedFlag=optIfOChGroupSrcPrevDaySuspectedFlag, optIfOTUkSourceGroup=optIfOTUkSourceGroup, optIfOChGroupSinkCurDayTable=optIfOChGroupSinkCurDayTable, optIfOChSinkCurrentSuspectedFlag=optIfOChSinkCurrentSuspectedFlag, optIfOTSnSinkPreOtnPMGroup=optIfOTSnSinkPreOtnPMGroup, optIfOTSnSinkIntervalHighOutputPower=optIfOTSnSinkIntervalHighOutputPower, optIfOChGroupSinkPrevDaySuspectedFlag=optIfOChGroupSinkPrevDaySuspectedFlag, optIfOChSrcIntervalTable=optIfOChSrcIntervalTable, optIfOMSnSinkGroupBasic=optIfOMSnSinkGroupBasic, optIfOChGroupSinkIntervalLastOutputPower=optIfOChGroupSinkIntervalLastOutputPower, optIfOTSnSAPIExpected=optIfOTSnSAPIExpected, optIfPerfMon=optIfPerfMon, optIfOTUkConfigEntry=optIfOTUkConfigEntry, optIfGCC12Application=optIfGCC12Application, optIfOChSinkIntervalLastInputPower=optIfOChSinkIntervalLastInputPower, optIfOMSnSrcCurrentHighOutputPower=optIfOMSnSrcCurrentHighOutputPower, optIfODUkTcmFieldsInUse=optIfODUkTcmFieldsInUse, optIfOMSnSrcCurDayHighOutputPower=optIfOMSnSrcCurDayHighOutputPower, optIfODUkPositionSeqTable=optIfODUkPositionSeqTable, optIfOMSnSrcIntervalLastOutputPower=optIfOMSnSrcIntervalLastOutputPower, optIfOChSrcCurrentHighOutputPower=optIfOChSrcCurrentHighOutputPower, optIfOTSnAprStatus=optIfOTSnAprStatus, optIfOTUkDEGThr=optIfOTUkDEGThr, optIfOMSnSrcIntervalSuspectedFlag=optIfOMSnSrcIntervalSuspectedFlag, optIfOMSnSrcPrevDaySuspectedFlag=optIfOMSnSrcPrevDaySuspectedFlag, optIfOTSnSrcCurrentLowerOutputPowerThreshold=optIfOTSnSrcCurrentLowerOutputPowerThreshold, optIfOMSnSrcPrevDayLastAggregatedInputPower=optIfOMSnSrcPrevDayLastAggregatedInputPower, optIfOChGroupSinkIntervalLowAggregatedInputPower=optIfOChGroupSinkIntervalLowAggregatedInputPower, optIfOChSrcPrevDaySuspectedFlag=optIfOChSrcPrevDaySuspectedFlag, optIfOChSinkCurDayLowInputPower=optIfOChSinkCurDayLowInputPower, optIfOChSourcePreOtnPMThresholdGroup=optIfOChSourcePreOtnPMThresholdGroup, optIfPerfMonIntervalTable=optIfPerfMonIntervalTable, optIfOMSnSinkPrevDayLastAggregatedInputPower=optIfOMSnSinkPrevDayLastAggregatedInputPower, optIfOTSnSrcCurrentTable=optIfOTSnSrcCurrentTable, optIfOMSnSinkPrevDayHighAggregatedInputPower=optIfOMSnSinkPrevDayHighAggregatedInputPower, optIfOChSinkPreOtnPMGroup=optIfOChSinkPreOtnPMGroup, optIfODUkTtpTIMActEnabled=optIfODUkTtpTIMActEnabled, optIfOTSnSrcIntervalLastOutputPower=optIfOTSnSrcIntervalLastOutputPower, optIfOChSrcIntervalSuspectedFlag=optIfOChSrcIntervalSuspectedFlag, optIfOTSnConfigTable=optIfOTSnConfigTable, optIfOChGroupSrcCurrentSuspectedFlag=optIfOChGroupSrcCurrentSuspectedFlag, optIfOTSnSrcCurrentOutputPower=optIfOTSnSrcCurrentOutputPower, optIfOTSnSrcCurrentLowerInputPowerThreshold=optIfOTSnSrcCurrentLowerInputPowerThreshold, optIfODUkPositionSeqIndex=optIfODUkPositionSeqIndex, optIfOMSnSrcCurrentLowOutputPower=optIfOMSnSrcCurrentLowOutputPower, optIfOMSnSinkIntervalHighAggregatedInputPower=optIfOMSnSinkIntervalHighAggregatedInputPower, optIfOMSnSinkCurDayHighOutputPower=optIfOMSnSinkCurDayHighOutputPower, optIfOMSnSinkPrevDayHighOutputPower=optIfOMSnSinkPrevDayHighOutputPower, optIfOChGroupSinkCurDayHighAggregatedInputPower=optIfOChGroupSinkCurDayHighAggregatedInputPower, optIfOChGroupSinkPrevDayHighOutputPower=optIfOChGroupSinkPrevDayHighOutputPower, optIfOTMnBitRates=optIfOTMnBitRates, optIfOChGroupSrcPrevDayLastOutputPower=optIfOChGroupSrcPrevDayLastOutputPower, optIfOTUkDirectionality=optIfOTUkDirectionality, optIfGCC0Directionality=optIfGCC0Directionality, optIfOChSinkIntervalLowInputPower=optIfOChSinkIntervalLowInputPower, optIfOTSnSrcCurrentHighInputPower=optIfOTSnSrcCurrentHighInputPower, optIfOChGroupSinkCurrentEntry=optIfOChGroupSinkCurrentEntry, optIfOChSinkIntervalTable=optIfOChSinkIntervalTable, optIfOMSnSrcCurDayLowAggregatedInputPower=optIfOMSnSrcCurDayLowAggregatedInputPower, optIfOTSnSinkPrevDayHighOutputPower=optIfOTSnSinkPrevDayHighOutputPower, optIfODUkTRowStatus=optIfODUkTRowStatus, optIfOTSnSrcCurDayHighOutputPower=optIfOTSnSrcCurDayHighOutputPower, optIfOMSnSinkCurrentTable=optIfOMSnSinkCurrentTable, optIfOChGroupSinkCurrentOutputPower=optIfOChGroupSinkCurrentOutputPower, optIfOChGroupSinkPreOtnPMThresholdGroup=optIfOChGroupSinkPreOtnPMThresholdGroup, optIfOTSn=optIfOTSn, optIfOTUkSAPIExpected=optIfOTUkSAPIExpected, optIfOTSnSinkGroupFull=optIfOTSnSinkGroupFull, optIfOChGroupSrcIntervalHighOutputPower=optIfOChGroupSrcIntervalHighOutputPower, optIfOChGroupSinkPrevDayLowOutputPower=optIfOChGroupSinkPrevDayLowOutputPower, optIfOTSnSrcIntervalHighInputPower=optIfOTSnSrcIntervalHighInputPower, optIfOChGroupSinkCurrentLowerOutputPowerThreshold=optIfOChGroupSinkCurrentLowerOutputPowerThreshold, optIfODUkTtpDEGM=optIfODUkTtpDEGM, optIfODUkTSAPIExpected=optIfODUkTSAPIExpected, optIfOTSnTIMDetMode=optIfOTSnTIMDetMode, optIfOTUkTraceIdentifierAccepted=optIfOTUkTraceIdentifierAccepted, optIfOTSnSinkPrevDayEntry=optIfOTSnSinkPrevDayEntry, optIfOChGroupSrcCurDaySuspectedFlag=optIfOChGroupSrcCurDaySuspectedFlag, optIfOChGroupSinkPrevDayEntry=optIfOChGroupSinkPrevDayEntry, optIfOChGroupSrcIntervalSuspectedFlag=optIfOChGroupSrcIntervalSuspectedFlag, optIfOChSrcPrevDayEntry=optIfOChSrcPrevDayEntry, optIfODUkPositionSeqEntry=optIfODUkPositionSeqEntry, optIfOTSnSinkCurDayLowInputPower=optIfOTSnSinkCurDayLowInputPower, optIfOTMnEntry=optIfOTMnEntry, optIfOMSnSrcPrevDayLowAggregatedInputPower=optIfOMSnSrcPrevDayLowAggregatedInputPower, optIfOTSnSrcIntervalLastInputPower=optIfOTSnSrcIntervalLastInputPower, optIfOChGroupSinkPrevDayHighAggregatedInputPower=optIfOChGroupSinkPrevDayHighAggregatedInputPower, optIfOMSnSinkCurrentHighAggregatedInputPower=optIfOMSnSinkCurrentHighAggregatedInputPower, optIfOChSrcIntervalLowOutputPower=optIfOChSrcIntervalLowOutputPower, optIfOChSinkCurrentLowInputPower=optIfOChSinkCurrentLowInputPower, OptIfIntervalNumber=OptIfIntervalNumber, optIfOChGroupDirectionality=optIfOChGroupDirectionality, optIfOChSinkPrevDaySuspectedFlag=optIfOChSinkPrevDaySuspectedFlag, optIfOMSnSinkPrevDaySuspectedFlag=optIfOMSnSinkPrevDaySuspectedFlag, optIfOTMnReduced=optIfOTMnReduced, optIfOTSnSinkIntervalTable=optIfOTSnSinkIntervalTable, optIfOChSinkIntervalEntry=optIfOChSinkIntervalEntry, optIfOTSnSinkIntervalEntry=optIfOTSnSinkIntervalEntry, optIfOChGroupSinkCurrentTable=optIfOChGroupSinkCurrentTable, optIfOChGroupSrcCurrentEntry=optIfOChGroupSrcCurrentEntry, optIfOTSnSrcCurDayLowOutputPower=optIfOTSnSrcCurDayLowOutputPower, optIfOChGroupSrcCurrentHighOutputPower=optIfOChGroupSrcCurrentHighOutputPower, optIfODUkTtpConfigEntry=optIfODUkTtpConfigEntry, optIfODUkTtpTraceIdentifierAccepted=optIfODUkTtpTraceIdentifierAccepted, optIfOChGroupSrcCurrentUpperOutputPowerThreshold=optIfOChGroupSrcCurrentUpperOutputPowerThreshold, optIfOChGroupSinkPreOtnPMGroup=optIfOChGroupSinkPreOtnPMGroup, optIfOChGroupSourcePreOtnPMGroup=optIfOChGroupSourcePreOtnPMGroup, optIfPerfMonIntervalNumInvalidIntervals=optIfPerfMonIntervalNumInvalidIntervals, optIfOChGroupSrcCurrentTable=optIfOChGroupSrcCurrentTable, PYSNMP_MODULE_ID=optIfMibModule, optIfODUkTNimGroup=optIfODUkTNimGroup, optIfODUkTDEGThr=optIfODUkTDEGThr, optIfODUkTtpPresent=optIfODUkTtpPresent, optIfOTSnSinkCurrentUpperInputPowerThreshold=optIfOTSnSinkCurrentUpperInputPowerThreshold, optIfOChGroupSinkIntervalSuspectedFlag=optIfOChGroupSinkIntervalSuspectedFlag)
