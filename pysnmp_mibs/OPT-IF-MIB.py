...
mibBuilder.exportSymbols("OPT-IF-MIB", optIfOChGroupSinkCurrentOutputPower=optIfOChGroupSinkCurrentOutputPower, optIfOTMnInterfaceType=optIfOTMnInterfaceType, optIfOMSnSinkIntervalLastAggregatedInputPower=optIfOMSnSinkIntervalLastAggregatedInputPower, optIfOTSnSinkPreOtnPMThresholdGroup=optIfOTSnSinkPreOtnPMThresholdGroup, optIfOChSinkIntervalNumber=optIfOChSinkIntervalNumber, optIfOTSnSinkPrevDayHighOutputPower=optIfOTSnSinkPrevDayHighOutputPower, optIfODUkTSinkLockSignalAdminState=optIfODUkTSinkLockSignalAdminState, optIfODUkTtpDEGThr=optIfODUkTtpDEGThr, optIfODUkTtpDEGM=optIfODUkTtpDEGM, optIfOTUk=optIfOTUk, optIfOTSnSinkCurrentLowInputPower=optIfOTSnSinkCurrentLowInputPower, optIfOTMnGroup=optIfOTMnGroup, optIfOTSnSinkCurrentTable=optIfOTSnSinkCurrentTable, optIfOChSrcPrevDayHighOutputPower=optIfOChSrcPrevDayHighOutputPower, optIfOMSnSinkCurrentUpperOutputPowerThreshold=optIfOMSnSinkCurrentUpperOutputPowerThreshold, optIfOTMnOpticalReach=optIfOTMnOpticalReach, optIfOChSourcePreOtnPMThresholdGroup=optIfOChSourcePreOtnPMThresholdGroup, optIfOTSnSinkIntervalSuspectedFlag=optIfOTSnSinkIntervalSuspectedFlag, optIfOChGroupSrcIntervalHighOutputPower=optIfOChGroupSrcIntervalHighOutputPower, optIfGCC0ConfigEntry=optIfGCC0ConfigEntry, optIfOChGroupSinkCurrentLowAggregatedInputPower=optIfOChGroupSinkCurrentLowAggregatedInputPower, optIfODUkTTcmField=optIfODUkTTcmField, optIfODUkConfigTable=optIfODUkConfigTable, optIfOChSrcCurrentLowerOutputPowerThreshold=optIfOChSrcCurrentLowerOutputPowerThreshold, optIfOChGroupSinkPrevDayLowAggregatedInputPower=optIfOChGroupSinkPrevDayLowAggregatedInputPower, optIfOChGroupSinkCurDayEntry=optIfOChGroupSinkCurDayEntry, optIfOTUkSinkGroup=optIfOTUkSinkGroup, optIfConfs=optIfConfs, optIfOChSrcCurrentEntry=optIfOChSrcCurrentEntry, optIfOMSnSrcCurrentEntry=optIfOMSnSrcCurrentEntry, optIfOTSnTraceIdentifierAccepted=optIfOTSnTraceIdentifierAccepted, optIfOTSnSrcPrevDayLowInputPower=optIfOTSnSrcPrevDayLowInputPower, optIfOChGroupSinkPrevDayLastOutputPower=optIfOChGroupSinkPrevDayLastOutputPower, optIfOChGroupSinkPrevDayHighAggregatedInputPower=optIfOChGroupSinkPrevDayHighAggregatedInputPower, optIfODUkTDEGThr=optIfODUkTDEGThr, optIfOTSnAPRStatusGroup=optIfOTSnAPRStatusGroup, optIfGCC12ConfigEntry=optIfGCC12ConfigEntry, optIfODUkTSourceLockSignalAdminState=optIfODUkTSourceLockSignalAdminState, optIfPerfMonCurrentTimeElapsed=optIfPerfMonCurrentTimeElapsed, optIfOChGroupSrcCurrentHighOutputPower=optIfOChGroupSrcCurrentHighOutputPower, optIfOMSnSrcPrevDayLastAggregatedInputPower=optIfOMSnSrcPrevDayLastAggregatedInputPower, optIfOMSnSinkCurDaySuspectedFlag=optIfOMSnSinkCurDaySuspectedFlag, optIfOTSnSrcIntervalEntry=optIfOTSnSrcIntervalEntry, optIfODUkTNimDEGM=optIfODUkTNimDEGM, optIfOTSnSrcCurDayHighInputPower=optIfOTSnSrcCurDayHighInputPower, optIfOChGroupSinkCurDayLowAggregatedInputPower=optIfOChGroupSinkCurDayLowAggregatedInputPower, optIfOTMnReduced=optIfOTMnReduced, optIfOChGroupSinkPrevDayTable=optIfOChGroupSinkPrevDayTable, optIfODUkTNimConfigTable=optIfODUkTNimConfigTable, optIfOChGroupSinkIntervalTable=optIfOChGroupSinkIntervalTable, optIfGroups=optIfGroups, optIfOChGroupSrcCurDayEntry=optIfOChGroupSrcCurDayEntry, optIfODUkTSinkGroupCtp=optIfODUkTSinkGroupCtp, optIfOChGroupConfigTable=optIfOChGroupConfigTable, optIfOChSinkCurrentHighInputPower=optIfOChSinkCurrentHighInputPower, optIfOChGroupSinkIntervalLastOutputPower=optIfOChGroupSinkIntervalLastOutputPower, optIfOMSn=optIfOMSn, optIfOMSnSrcCurrentUpperOutputPowerThreshold=optIfOMSnSrcCurrentUpperOutputPowerThreshold, optIfOChGroupSinkCurDaySuspectedFlag=optIfOChGroupSinkCurDaySuspectedFlag, optIfOTUkSinkAdaptActive=optIfOTUkSinkAdaptActive, optIfOChSourcePreOtnPMGroup=optIfOChSourcePreOtnPMGroup, optIfOTSnSourceGroupFull=optIfOTSnSourceGroupFull, optIfOChSrcCurDayLowOutputPower=optIfOChSrcCurDayLowOutputPower, optIfOTSnSinkIntervalLowOutputPower=optIfOTSnSinkIntervalLowOutputPower, optIfOTSnCommonGroup=optIfOTSnCommonGroup, optIfOMSnSinkIntervalHighAggregatedInputPower=optIfOMSnSinkIntervalHighAggregatedInputPower, optIfOChSinkPrevDaySuspectedFlag=optIfOChSinkPrevDaySuspectedFlag, optIfOChSinkIntervalHighInputPower=optIfOChSinkIntervalHighInputPower, optIfODUkTDEGM=optIfODUkTDEGM, optIfOChGroupSrcPrevDayEntry=optIfOChGroupSrcPrevDayEntry, OptIfDEGM=OptIfDEGM, optIfOChGroupSinkCurDayTable=optIfOChGroupSinkCurDayTable, optIfOTUkDAPIExpected=optIfOTUkDAPIExpected, optIfODUkTtpPresent=optIfODUkTtpPresent, optIfOTSnSinkPreOtnPMGroup=optIfOTSnSinkPreOtnPMGroup, optIfOMSnSinkCurrentLowAggregatedInputPower=optIfOMSnSinkCurrentLowAggregatedInputPower, optIfOTSnSrcPrevDayEntry=optIfOTSnSrcPrevDayEntry, optIfOTSnSinkCurrentHighOutputPower=optIfOTSnSinkCurrentHighOutputPower, optIfOTSnSinkIntervalTable=optIfOTSnSinkIntervalTable, optIfOChGroupSinkCurrentHighOutputPower=optIfOChGroupSinkCurrentHighOutputPower, optIfOTSnAprControl=optIfOTSnAprControl, optIfOChGroupSinkCurrentSuspectedFlag=optIfOChGroupSinkCurrentSuspectedFlag, optIfGCC0Directionality=optIfGCC0Directionality, optIfOChGroupSinkPrevDayLowOutputPower=optIfOChGroupSinkPrevDayLowOutputPower, optIfOTUkTraceIdentifierAccepted=optIfOTUkTraceIdentifierAccepted, optIfOChSinkCurrentLowerInputPowerThreshold=optIfOChSinkCurrentLowerInputPowerThreshold, optIfOMSnSinkCurrentUpperInputPowerThreshold=optIfOMSnSinkCurrentUpperInputPowerThreshold, optIfOTUkCommonGroup=optIfOTUkCommonGroup, optIfOChSrcPrevDayLowOutputPower=optIfOChSrcPrevDayLowOutputPower, optIfOTSnSinkCurDayLowOutputPower=optIfOTSnSinkCurDayLowOutputPower, optIfOChSrcIntervalNumber=optIfOChSrcIntervalNumber, optIfOChGroupSinkCurDayHighOutputPower=optIfOChGroupSinkCurDayHighOutputPower, optIfODUkTTIMActEnabled=optIfODUkTTIMActEnabled, optIfOChSrcIntervalLowOutputPower=optIfOChSrcIntervalLowOutputPower, optIfOTSnSrcPrevDayLastOutputPower=optIfOTSnSrcPrevDayLastOutputPower, optIfOTSnSrcPrevDayLowOutputPower=optIfOTSnSrcPrevDayLowOutputPower, optIfOMSnSinkCurDayHighOutputPower=optIfOMSnSinkCurDayHighOutputPower, optIfOTSnSrcIntervalSuspectedFlag=optIfOTSnSrcIntervalSuspectedFlag, optIfOChGroupSrcCurDayTable=optIfOChGroupSrcCurDayTable, optIfOTSnSinkPrevDayLastOutputPower=optIfOTSnSinkPrevDayLastOutputPower, optIfOTSnSrcPrevDaySuspectedFlag=optIfOTSnSrcPrevDaySuspectedFlag, optIfODUkTtpConfigEntry=optIfODUkTtpConfigEntry, optIfOTSnCurrentStatus=optIfOTSnCurrentStatus, optIfOChSrcCurDaySuspectedFlag=optIfOChSrcCurDaySuspectedFlag, optIfOTSnSrcCurDayTable=optIfOTSnSrcCurDayTable, optIfOMSnSinkPrevDayLastOutputPower=optIfOMSnSinkPrevDayLastOutputPower, optIfOTSnSrcCurrentOutputPower=optIfOTSnSrcCurrentOutputPower, optIfOMSnSinkPrevDayLowAggregatedInputPower=optIfOMSnSinkPrevDayLowAggregatedInputPower, optIfODUkTtpCurrentStatus=optIfODUkTtpCurrentStatus, optIfOChGroupSrcIntervalTable=optIfOChGroupSrcIntervalTable, optIfMibModule=optIfMibModule, optIfOMSnSrcPrevDayTable=optIfOMSnSrcPrevDayTable, optIfOChGroupSrcIntervalNumber=optIfOChGroupSrcIntervalNumber, optIfOTSnSrcCurrentHighInputPower=optIfOTSnSrcCurrentHighInputPower, optIfOMSnSrcCurDayHighAggregatedInputPower=optIfOMSnSrcCurDayHighAggregatedInputPower, optIfOMSnSinkCurrentAggregatedInputPower=optIfOMSnSinkCurrentAggregatedInputPower, optIfODUkPositionSeqEntry=optIfODUkPositionSeqEntry, optIfOChSrcIntervalEntry=optIfOChSrcIntervalEntry, optIfOTSnSinkCurrentLowerOutputPowerThreshold=optIfOTSnSinkCurrentLowerOutputPowerThreshold, optIfOTSnSrcCurrentLowerInputPowerThreshold=optIfOTSnSrcCurrentLowerInputPowerThreshold, OptIfBitRateK=OptIfBitRateK, optIfOMSnSinkCurrentLowerInputPowerThreshold=optIfOMSnSinkCurrentLowerInputPowerThreshold, optIfOChSinkPreOtnPMThresholdGroup=optIfOChSinkPreOtnPMThresholdGroup, optIfOMSnSrcIntervalNumber=optIfOMSnSrcIntervalNumber, optIfODUkTConfigTable=optIfODUkTConfigTable, optIfPerfMon=optIfPerfMon, optIfOChSinkCurrentTable=optIfOChSinkCurrentTable, optIfOMSnSrcCurDaySuspectedFlag=optIfOMSnSrcCurDaySuspectedFlag, optIfOMSnSinkPrevDayEntry=optIfOMSnSinkPrevDayEntry, optIfOTSnSrcCurDayLowInputPower=optIfOTSnSrcCurDayLowInputPower, optIfOMSnSrcCurrentOutputPower=optIfOMSnSrcCurrentOutputPower, optIfPreOtnPMCompl=optIfPreOtnPMCompl, optIfOTSnDAPIExpected=optIfOTSnDAPIExpected, optIfOMSnSinkCurrentTable=optIfOMSnSinkCurrentTable, optIfOChGroupSinkIntervalLowAggregatedInputPower=optIfOChGroupSinkIntervalLowAggregatedInputPower, optIfOMSnSinkIntervalEntry=optIfOMSnSinkIntervalEntry, optIfOMSnSrcPrevDayEntry=optIfOMSnSrcPrevDayEntry, optIfOTMn=optIfOTMn, optIfOChGroupSrcIntervalHighAggregatedInputPower=optIfOChGroupSrcIntervalHighAggregatedInputPower, optIfOChGroup=optIfOChGroup, optIfOMSnSrcPrevDayLowAggregatedInputPower=optIfOMSnSrcPrevDayLowAggregatedInputPower, optIfGCC12ConfigTable=optIfGCC12ConfigTable, optIfOTSnSinkCurrentLowerInputPowerThreshold=optIfOTSnSinkCurrentLowerInputPowerThreshold, optIfOMSnSinkPreOtnPMThresholdGroup=optIfOMSnSinkPreOtnPMThresholdGroup, optIfOMSnSinkCurDayLowAggregatedInputPower=optIfOMSnSinkCurDayLowAggregatedInputPower, optIfOChGroupSrcCurrentSuspectedFlag=optIfOChGroupSrcCurrentSuspectedFlag, optIfOMSnSrcIntervalEntry=optIfOMSnSrcIntervalEntry, optIfGCC12Group=optIfGCC12Group, optIfOChConfigTable=optIfOChConfigTable, optIfOTSnSinkIntervalEntry=optIfOTSnSinkIntervalEntry, optIfOChGroupSinkCurrentUpperInputPowerThreshold=optIfOChGroupSinkCurrentUpperInputPowerThreshold, optIfOMSnSrcCurrentHighOutputPower=optIfOMSnSrcCurrentHighOutputPower, optIfOtnConfigCompl=optIfOtnConfigCompl, optIfOTSnSrcIntervalHighOutputPower=optIfOTSnSrcIntervalHighOutputPower, optIfPerfMonGroup=optIfPerfMonGroup, optIfOChSrcCurDayEntry=optIfOChSrcCurDayEntry, optIfODUkTcmFieldsInUse=optIfODUkTcmFieldsInUse, optIfOTSnSinkCurrentUpperOutputPowerThreshold=optIfOTSnSinkCurrentUpperOutputPowerThreshold, optIfOMSnSrcIntervalHighAggregatedInputPower=optIfOMSnSrcIntervalHighAggregatedInputPower, optIfOChSinkCurDayLowInputPower=optIfOChSinkCurDayLowInputPower, optIfODUkNimTIMDetMode=optIfODUkNimTIMDetMode, optIfGCC12GCCAccess=optIfGCC12GCCAccess, optIfODUkTCurrentStatus=optIfODUkTCurrentStatus, optIfOTSnConfigEntry=optIfOTSnConfigEntry, optIfODUkTNimGroup=optIfODUkTNimGroup, optIfOChGroupSinkCurrentLowerInputPowerThreshold=optIfOChGroupSinkCurrentLowerInputPowerThreshold, optIfOMSnSinkCurrentOutputPower=optIfOMSnSinkCurrentOutputPower, optIfOTUkBitRateK=optIfOTUkBitRateK, optIfOMSnSinkCurrentHighAggregatedInputPower=optIfOMSnSinkCurrentHighAggregatedInputPower, optIfOTUkTraceIdentifierTransmitted=optIfOTUkTraceIdentifierTransmitted, optIfOChSrcIntervalLastOutputPower=optIfOChSrcIntervalLastOutputPower, optIfOTSnConfigTable=optIfOTSnConfigTable, optIfODUkGroup=optIfODUkGroup, optIfPerfMonIntervalNumIntervals=optIfPerfMonIntervalNumIntervals, optIfOChGroupSrcIntervalEntry=optIfOChGroupSrcIntervalEntry, optIfODUkTNimRowStatus=optIfODUkTNimRowStatus, optIfODUkNimCurrentStatus=optIfODUkNimCurrentStatus, optIfObjects=optIfObjects, optIfOTSnSinkPrevDaySuspectedFlag=optIfOTSnSinkPrevDaySuspectedFlag, optIfOMSnSinkIntervalTable=optIfOMSnSinkIntervalTable, optIfOChGroupSrcCurDayHighAggregatedInputPower=optIfOChGroupSrcCurDayHighAggregatedInputPower, optIfODUkNimConfigEntry=optIfODUkNimConfigEntry, optIfOTSnSinkPrevDayLowOutputPower=optIfOTSnSinkPrevDayLowOutputPower, optIfOTSnSrcIntervalTable=optIfOTSnSrcIntervalTable, optIfODUk=optIfODUk, optIfOTSnSinkPrevDayEntry=optIfOTSnSinkPrevDayEntry, optIfOChSinkCurDayHighInputPower=optIfOChSinkCurDayHighInputPower, optIfOTMnEntry=optIfOTMnEntry, optIfODUkTNimTraceIdentifierAccepted=optIfODUkTNimTraceIdentifierAccepted, optIfODUkPositionSeqTable=optIfODUkPositionSeqTable, optIfOMSnSrcIntervalLowAggregatedInputPower=optIfOMSnSrcIntervalLowAggregatedInputPower, optIfODUkTTraceIdentifierTransmitted=optIfODUkTTraceIdentifierTransmitted, optIfOMSnSourcePreOtnPMGroup=optIfOMSnSourcePreOtnPMGroup, optIfOTUkDEGThr=optIfOTUkDEGThr, optIfPerfMonIntervalNumInvalidIntervals=optIfPerfMonIntervalNumInvalidIntervals, optIfGCC0Application=optIfGCC0Application, optIfOChGroupSrcCurrentHighAggregatedInputPower=optIfOChGroupSrcCurrentHighAggregatedInputPower, optIfOTSnSrcCurrentInputPower=optIfOTSnSrcCurrentInputPower, optIfODUkBitRateK=optIfODUkBitRateK, optIfOTSnDirectionality=optIfOTSnDirectionality, optIfOTSnSrcIntervalNumber=optIfOTSnSrcIntervalNumber, optIfODUkNimDirectionality=optIfODUkNimDirectionality, optIfOChGroupSrcCurDayLowAggregatedInputPower=optIfOChGroupSrcCurDayLowAggregatedInputPower, optIfOTSnSrcIntervalHighInputPower=optIfOTSnSrcIntervalHighInputPower, optIfOTSnSinkPrevDayHighInputPower=optIfOTSnSinkPrevDayHighInputPower, optIfOMSnSrcCurrentSuspectedFlag=optIfOMSnSrcCurrentSuspectedFlag, optIfOChGroupSrcCurrentEntry=optIfOChGroupSrcCurrentEntry, optIfOMSnSinkIntervalNumber=optIfOMSnSinkIntervalNumber, optIfOTSnSinkPrevDayTable=optIfOTSnSinkPrevDayTable, optIfODUkTSAPIExpected=optIfODUkTSAPIExpected, optIfOTSnSinkCurrentLowOutputPower=optIfOTSnSinkCurrentLowOutputPower, optIfOTSnSourcePreOtnPMThresholdGroup=optIfOTSnSourcePreOtnPMThresholdGroup, optIfOMSnSinkIntervalLastOutputPower=optIfOMSnSinkIntervalLastOutputPower, optIfOTSnSrcCurrentLowInputPower=optIfOTSnSrcCurrentLowInputPower, optIfOChSrcCurrentSuspectedFlag=optIfOChSrcCurrentSuspectedFlag, OptIfDEGThr=OptIfDEGThr, optIfODUkTNimTcmField=optIfODUkTNimTcmField, optIfOMSnSinkPrevDayLowOutputPower=optIfOMSnSinkPrevDayLowOutputPower, optIfODUkTNimDEGThr=optIfODUkTNimDEGThr, optIfOTSn=optIfOTSn, optIfOChGroupSrcPrevDayLowOutputPower=optIfOChGroupSrcPrevDayLowOutputPower, optIfOTSnTraceIdentifierTransmitted=optIfOTSnTraceIdentifierTransmitted, optIfOTSnSinkCurDayHighOutputPower=optIfOTSnSinkCurDayHighOutputPower, optIfOTSnSrcCurDayHighOutputPower=optIfOTSnSrcCurDayHighOutputPower, optIfODUkTtpSourceGroup=optIfODUkTtpSourceGroup, optIfOTMnTable=optIfOTMnTable, optIfOTSnSinkCurDayHighInputPower=optIfOTSnSinkCurDayHighInputPower, optIfOChGroupSrcCurrentLowerOutputPowerThreshold=optIfOChGroupSrcCurrentLowerOutputPowerThreshold, optIfOMSnSinkCurrentSuspectedFlag=optIfOMSnSinkCurrentSuspectedFlag, optIfOChSinkCurrentInputPower=optIfOChSinkCurrentInputPower, optIfOMSnSrcIntervalLastOutputPower=optIfOMSnSrcIntervalLastOutputPower, OptIfSinkOrSource=OptIfSinkOrSource, optIfOChSinkPrevDayLastInputPower=optIfOChSinkPrevDayLastInputPower, OptIfIntervalNumber=OptIfIntervalNumber, optIfOMSnSourcePreOtnPMThresholdGroup=optIfOMSnSourcePreOtnPMThresholdGroup, optIfOMSnSrcCurrentLowerInputPowerThreshold=optIfOMSnSrcCurrentLowerInputPowerThreshold, optIfOChSinkPrevDayEntry=optIfOChSinkPrevDayEntry, optIfODUkNimRowStatus=optIfODUkNimRowStatus, OptIfTxTI=OptIfTxTI, optIfOTSnSourcePreOtnPMGroup=optIfOTSnSourcePreOtnPMGroup, OptIfExDAPI=OptIfExDAPI, optIfOCh=optIfOCh, optIfODUkNimConfigTable=optIfODUkNimConfigTable, optIfOTUkConfigEntry=optIfOTUkConfigEntry, optIfOMSnSrcPrevDayLastOutputPower=optIfOMSnSrcPrevDayLastOutputPower, optIfOChSinkIntervalTable=optIfOChSinkIntervalTable, optIfODUkT=optIfODUkT, optIfOChCommonGroup=optIfOChCommonGroup, optIfOMSnSinkPrevDayHighAggregatedInputPower=optIfOMSnSinkPrevDayHighAggregatedInputPower, optIfODUkTNimTIMActEnabled=optIfODUkTNimTIMActEnabled, optIfOChGroupSinkCurrentAggregatedInputPower=optIfOChGroupSinkCurrentAggregatedInputPower, optIfOChGroupSinkPrevDayLastAggregatedInputPower=optIfOChGroupSinkPrevDayLastAggregatedInputPower, optIfOChSinkIntervalEntry=optIfOChSinkIntervalEntry, optIfOMSnSrcCurDayEntry=optIfOMSnSrcCurDayEntry)
mibBuilder.exportSymbols("OPT-IF-MIB", optIfOTSnSrcCurrentHighOutputPower=optIfOTSnSrcCurrentHighOutputPower, optIfOChGroupSinkPreOtnPMThresholdGroup=optIfOChGroupSinkPreOtnPMThresholdGroup, optIfOMSnSinkPreOtnPMGroup=optIfOMSnSinkPreOtnPMGroup, optIfOChSinkPrevDayLowInputPower=optIfOChSinkPrevDayLowInputPower, optIfOTSnSinkCurrentOutputPower=optIfOTSnSinkCurrentOutputPower, optIfOMSnSrcPrevDayHighAggregatedInputPower=optIfOMSnSrcPrevDayHighAggregatedInputPower, optIfODUkTSinkMode=optIfODUkTSinkMode, optIfOTMnTcmMax=optIfOTMnTcmMax, optIfPerfMonIntervalTable=optIfPerfMonIntervalTable, optIfOChGroupSinkCurDayHighAggregatedInputPower=optIfOChGroupSinkCurDayHighAggregatedInputPower, optIfOChGroupSourcePreOtnPMThresholdGroup=optIfOChGroupSourcePreOtnPMThresholdGroup, optIfOChGroupSinkPrevDayHighOutputPower=optIfOChGroupSinkPrevDayHighOutputPower, optIfOChSinkCurrentLowInputPower=optIfOChSinkCurrentLowInputPower, optIfODUkTConfigEntry=optIfODUkTConfigEntry, optIfOTUkConfigTable=optIfOTUkConfigTable, optIfOMSnCurrentStatus=optIfOMSnCurrentStatus, optIfOTSnSinkIntervalNumber=optIfOTSnSinkIntervalNumber, optIfOMSnSrcCurrentLowAggregatedInputPower=optIfOMSnSrcCurrentLowAggregatedInputPower, optIfOChGroupSrcIntervalSuspectedFlag=optIfOChGroupSrcIntervalSuspectedFlag, optIfOChSinkCurrentEntry=optIfOChSinkCurrentEntry, optIfOChSinkCurDayEntry=optIfOChSinkCurDayEntry, optIfODUkTNimTIMDetMode=optIfODUkTNimTIMDetMode, optIfODUkTNimCurrentStatus=optIfODUkTNimCurrentStatus, optIfOChGroupSinkPrevDayEntry=optIfOChGroupSinkPrevDayEntry, optIfODUkTNimSAPIExpected=optIfODUkTNimSAPIExpected, optIfOTSnSinkGroupBasic=optIfOTSnSinkGroupBasic, optIfOChSinkIntervalLastInputPower=optIfOChSinkIntervalLastInputPower, optIfOChGroupSrcCurDaySuspectedFlag=optIfOChGroupSrcCurDaySuspectedFlag, optIfODUkTtpTraceIdentifierAccepted=optIfODUkTtpTraceIdentifierAccepted, optIfOMSnSrcIntervalHighOutputPower=optIfOMSnSrcIntervalHighOutputPower, optIfOTUkCurrentStatus=optIfOTUkCurrentStatus, optIfODUkTTIMDetMode=optIfODUkTTIMDetMode, PYSNMP_MODULE_ID=optIfMibModule, optIfOChGroupSinkCurrentEntry=optIfOChGroupSinkCurrentEntry, optIfODUkTtpTIMActEnabled=optIfODUkTtpTIMActEnabled, optIfOTSnSinkCurDayEntry=optIfOTSnSinkCurDayEntry, optIfOTMnBitRates=optIfOTMnBitRates, optIfOTSnSrcCurrentUpperOutputPowerThreshold=optIfOTSnSrcCurrentUpperOutputPowerThreshold, optIfOChGroupSrcPrevDaySuspectedFlag=optIfOChGroupSrcPrevDaySuspectedFlag, optIfODUkPositionSeqCurrentSize=optIfODUkPositionSeqCurrentSize, optIfOChGroupSrcIntervalLowOutputPower=optIfOChGroupSrcIntervalLowOutputPower, optIfOMSnSinkPrevDayLastAggregatedInputPower=optIfOMSnSinkPrevDayLastAggregatedInputPower, optIfOChGroupSinkCurrentUpperOutputPowerThreshold=optIfOChGroupSinkCurrentUpperOutputPowerThreshold, optIfOChSinkCurrentUpperInputPowerThreshold=optIfOChSinkCurrentUpperInputPowerThreshold, optIfOMSnSinkPrevDayHighOutputPower=optIfOMSnSinkPrevDayHighOutputPower, optIfOChSinkIntervalSuspectedFlag=optIfOChSinkIntervalSuspectedFlag, optIfODUkPositionSeqPointer=optIfODUkPositionSeqPointer, optIfODUkConfigEntry=optIfODUkConfigEntry, optIfOChSinkCurDayTable=optIfOChSinkCurDayTable, optIfOMSnSinkIntervalLowOutputPower=optIfOMSnSinkIntervalLowOutputPower, optIfOTSnSrcCurDaySuspectedFlag=optIfOTSnSrcCurDaySuspectedFlag, optIfOTSnSrcCurDayLowOutputPower=optIfOTSnSrcCurDayLowOutputPower, optIfOChGroupSrcCurrentOutputPower=optIfOChGroupSrcCurrentOutputPower, optIfOTSnSrcPrevDayLastInputPower=optIfOTSnSrcPrevDayLastInputPower, optIfOTSnSrcCurDayEntry=optIfOTSnSrcCurDayEntry, optIfODUkTNimConfigEntry=optIfODUkTNimConfigEntry, optIfOChSinkPreOtnPMGroup=optIfOChSinkPreOtnPMGroup, optIfOChSrcCurrentUpperOutputPowerThreshold=optIfOChSrcCurrentUpperOutputPowerThreshold, optIfGCC0ConfigTable=optIfGCC0ConfigTable, optIfOMSnSinkGroupBasic=optIfOMSnSinkGroupBasic, optIfODUkTCodirectional=optIfODUkTCodirectional, optIfOMSnSinkCurrentHighOutputPower=optIfOMSnSinkCurrentHighOutputPower, optIfOMSnSinkIntervalHighOutputPower=optIfOMSnSinkIntervalHighOutputPower, optIfOTSnSrcIntervalLowInputPower=optIfOTSnSrcIntervalLowInputPower, optIfODUkTtpSinkGroup=optIfODUkTtpSinkGroup, optIfGCC12GCCPassThrough=optIfGCC12GCCPassThrough, optIfOTSnSinkCurrentSuspectedFlag=optIfOTSnSinkCurrentSuspectedFlag, optIfOChGroupSinkIntervalSuspectedFlag=optIfOChGroupSinkIntervalSuspectedFlag, optIfOMSnSinkCurrentLowOutputPower=optIfOMSnSinkCurrentLowOutputPower, optIfOChGroupSinkCurrentLowOutputPower=optIfOChGroupSinkCurrentLowOutputPower, optIfOChGroupSrcCurDayHighOutputPower=optIfOChGroupSrcCurDayHighOutputPower, optIfODUkTtpTIMDetMode=optIfODUkTtpTIMDetMode, optIfOMSnCommonGroup=optIfOMSnCommonGroup, optIfODUkTSinkGroup=optIfODUkTSinkGroup, optIfODUkTtpDAPIExpected=optIfODUkTtpDAPIExpected, optIfOChSinkCurDaySuspectedFlag=optIfOChSinkCurDaySuspectedFlag, optIfOTUkTIMDetMode=optIfOTUkTIMDetMode, OptIfExSAPI=OptIfExSAPI, optIfOChGroupCommonGroup=optIfOChGroupCommonGroup, optIfOTSnSrcCurrentLowerOutputPowerThreshold=optIfOTSnSrcCurrentLowerOutputPowerThreshold, optIfOChGroupSrcCurrentLowerInputPowerThreshold=optIfOChGroupSrcCurrentLowerInputPowerThreshold, optIfOTSnSinkIntervalLastInputPower=optIfOTSnSinkIntervalLastInputPower, optIfOMSnSinkCurrentLowerOutputPowerThreshold=optIfOMSnSinkCurrentLowerOutputPowerThreshold, optIfODUkTtpSAPIExpected=optIfODUkTtpSAPIExpected, optIfOTUkSourceGroup=optIfOTUkSourceGroup, optIfOChGroupSinkCurDayLowOutputPower=optIfOChGroupSinkCurDayLowOutputPower, optIfOTSnSrcIntervalLastOutputPower=optIfOTSnSrcIntervalLastOutputPower, optIfOTSnSinkIntervalLastOutputPower=optIfOTSnSinkIntervalLastOutputPower, optIfODUkTRowStatus=optIfODUkTRowStatus, optIfOChSrcIntervalSuspectedFlag=optIfOChSrcIntervalSuspectedFlag, optIfOMSnSinkPrevDaySuspectedFlag=optIfOMSnSinkPrevDaySuspectedFlag, optIfODUkNimDEGThr=optIfODUkNimDEGThr, optIfOMSnSrcIntervalLowOutputPower=optIfOMSnSrcIntervalLowOutputPower, OptIfTIMDetMode=OptIfTIMDetMode, optIfOChSinkGroupBasic=optIfOChSinkGroupBasic, optIfOTSnSinkCurDayTable=optIfOTSnSinkCurDayTable, optIfOChGroupSinkPreOtnPMGroup=optIfOChGroupSinkPreOtnPMGroup, optIfOMSnSinkCurDayEntry=optIfOMSnSinkCurDayEntry, optIfOMSnDirectionality=optIfOMSnDirectionality, optIfOMSnSrcCurrentUpperInputPowerThreshold=optIfOMSnSrcCurrentUpperInputPowerThreshold, optIfOTSnSinkCurrentInputPower=optIfOTSnSinkCurrentInputPower, optIfOTSnSAPIExpected=optIfOTSnSAPIExpected, optIfOMSnSrcCurrentTable=optIfOMSnSrcCurrentTable, optIfOTUkSAPIExpected=optIfOTUkSAPIExpected, optIfOChSinkPrevDayTable=optIfOChSinkPrevDayTable, optIfOTSnSrcCurrentSuspectedFlag=optIfOTSnSrcCurrentSuspectedFlag, optIfOTSnSinkPrevDayLowInputPower=optIfOTSnSinkPrevDayLowInputPower, optIfOTUkSourceAdaptActive=optIfOTUkSourceAdaptActive, OptIfDirectionality=OptIfDirectionality, optIfOMSnSrcIntervalTable=optIfOMSnSrcIntervalTable, optIfOChGroupSinkCurrentTable=optIfOChGroupSinkCurrentTable, optIfPerfMonCurDayTimeElapsed=optIfPerfMonCurDayTimeElapsed, optIfODUkNimTraceIdentifierAccepted=optIfODUkNimTraceIdentifierAccepted, optIfOTSnSrcIntervalLowOutputPower=optIfOTSnSrcIntervalLowOutputPower, optIfOTUkDEGM=optIfOTUkDEGM, optIfOTSnSrcCurrentTable=optIfOTSnSrcCurrentTable, optIfOChGroupSrcPrevDayHighAggregatedInputPower=optIfOChGroupSrcPrevDayHighAggregatedInputPower, optIfODUkTTraceIdentifierAccepted=optIfODUkTTraceIdentifierAccepted, optIfOMSnConfigEntry=optIfOMSnConfigEntry, optIfOChGroupSrcPrevDayHighOutputPower=optIfOChGroupSrcPrevDayHighOutputPower, optIfODUkTCommonGroup=optIfODUkTCommonGroup, optIfPerfMonIntervalEntry=optIfPerfMonIntervalEntry, optIfOChGroupSourcePreOtnPMGroup=optIfOChGroupSourcePreOtnPMGroup, optIfOChGroupSrcIntervalLastOutputPower=optIfOChGroupSrcIntervalLastOutputPower, optIfOTSnSinkCurDayLowInputPower=optIfOTSnSinkCurDayLowInputPower, optIfOChSrcPrevDayTable=optIfOChSrcPrevDayTable, optIfGCC12Application=optIfGCC12Application, optIfODUkTDAPIExpected=optIfODUkTDAPIExpected, optIfOChSrcPrevDayEntry=optIfOChSrcPrevDayEntry, optIfODUkTNimDAPIExpected=optIfODUkTNimDAPIExpected, optIfODUkNimSAPIExpected=optIfODUkNimSAPIExpected, optIfODUkNimDEGM=optIfODUkNimDEGM, optIfOTSnSrcCurrentUpperInputPowerThreshold=optIfOTSnSrcCurrentUpperInputPowerThreshold, optIfOTSnSrcPrevDayHighOutputPower=optIfOTSnSrcPrevDayHighOutputPower, optIfOChSrcCurrentLowOutputPower=optIfOChSrcCurrentLowOutputPower, optIfOChGroupSinkPrevDaySuspectedFlag=optIfOChGroupSinkPrevDaySuspectedFlag, optIfOChGroupSrcCurrentUpperOutputPowerThreshold=optIfOChGroupSrcCurrentUpperOutputPowerThreshold, optIfOTSnAPRControlGroup=optIfOTSnAPRControlGroup, optIfODUkPositionSeqPosition=optIfODUkPositionSeqPosition, optIfOChSrcPrevDaySuspectedFlag=optIfOChSrcPrevDaySuspectedFlag, optIfGCC12RowStatus=optIfGCC12RowStatus, optIfODUkNimTIMActEnabled=optIfODUkNimTIMActEnabled, optIfOTSnSinkPrevDayLastInputPower=optIfOTSnSinkPrevDayLastInputPower, optIfODUkTtpTraceIdentifierTransmitted=optIfODUkTtpTraceIdentifierTransmitted, optIfOTSnTIMActEnabled=optIfOTSnTIMActEnabled, optIfODUkTtpConfigTable=optIfODUkTtpConfigTable, optIfOMSnSrcCurDayHighOutputPower=optIfOMSnSrcCurDayHighOutputPower, optIfOChGroupSrcPrevDayTable=optIfOChGroupSrcPrevDayTable, optIfOTSnSrcPrevDayTable=optIfOTSnSrcPrevDayTable, optIfOChGroupSrcCurDayLowOutputPower=optIfOChGroupSrcCurDayLowOutputPower, optIfOChGroupSinkIntervalLowOutputPower=optIfOChGroupSinkIntervalLowOutputPower, optIfODUkNimGroup=optIfODUkNimGroup, optIfOChGroupSrcCurrentUpperInputPowerThreshold=optIfOChGroupSrcCurrentUpperInputPowerThreshold, optIfOChConfigEntry=optIfOChConfigEntry, optIfOChSrcCurrentOutputPower=optIfOChSrcCurrentOutputPower, optIfOMSnSrcPrevDayHighOutputPower=optIfOMSnSrcPrevDayHighOutputPower, optIfOChSinkIntervalLowInputPower=optIfOChSinkIntervalLowInputPower, optIfOMSnSinkIntervalSuspectedFlag=optIfOMSnSinkIntervalSuspectedFlag, optIfOChGroupSinkCurrentLowerOutputPowerThreshold=optIfOChGroupSinkCurrentLowerOutputPowerThreshold, optIfOChSrcIntervalHighOutputPower=optIfOChSrcIntervalHighOutputPower, optIfOChGroupSinkIntervalHighOutputPower=optIfOChGroupSinkIntervalHighOutputPower, optIfOChGroupSrcIntervalLowAggregatedInputPower=optIfOChGroupSrcIntervalLowAggregatedInputPower, optIfOChGroupSinkIntervalNumber=optIfOChGroupSinkIntervalNumber, optIfOChSrcCurDayHighOutputPower=optIfOChSrcCurDayHighOutputPower, optIfOChGroupSrcPrevDayLastOutputPower=optIfOChGroupSrcPrevDayLastOutputPower, optIfOTSnAprStatus=optIfOTSnAprStatus, optIfOMSnSinkIntervalLowAggregatedInputPower=optIfOMSnSinkIntervalLowAggregatedInputPower, optIfGCC12Codirectional=optIfGCC12Codirectional, optIfOTSnSinkCurDaySuspectedFlag=optIfOTSnSinkCurDaySuspectedFlag, optIfOTSnSrcCurrentLowOutputPower=optIfOTSnSrcCurrentLowOutputPower, optIfOMSnSrcPrevDaySuspectedFlag=optIfOMSnSrcPrevDaySuspectedFlag, optIfOTSnSrcCurrentEntry=optIfOTSnSrcCurrentEntry, optIfOMSnSinkCurDayHighAggregatedInputPower=optIfOMSnSinkCurDayHighAggregatedInputPower, optIfOTSnSinkCurrentEntry=optIfOTSnSinkCurrentEntry, optIfOChGroupSinkIntervalHighAggregatedInputPower=optIfOChGroupSinkIntervalHighAggregatedInputPower, optIfOMSnSrcCurDayLowAggregatedInputPower=optIfOMSnSrcCurDayLowAggregatedInputPower, optIfOMSnSrcIntervalSuspectedFlag=optIfOMSnSrcIntervalSuspectedFlag, optIfOMSnSrcIntervalLastAggregatedInputPower=optIfOMSnSrcIntervalLastAggregatedInputPower, optIfOChSinkCurrentSuspectedFlag=optIfOChSinkCurrentSuspectedFlag, optIfOChSrcCurrentTable=optIfOChSrcCurrentTable, optIfOChGroupSrcCurrentLowAggregatedInputPower=optIfOChGroupSrcCurrentLowAggregatedInputPower, optIfGCC0RowStatus=optIfGCC0RowStatus, optIfOMSnConfigTable=optIfOMSnConfigTable, optIfODUkPositionSeqIndex=optIfODUkPositionSeqIndex, optIfOMSnSinkPrevDayTable=optIfOMSnSinkPrevDayTable, optIfOChGroupSinkCurrentHighAggregatedInputPower=optIfOChGroupSinkCurrentHighAggregatedInputPower, optIfOChGroupSrcCurrentAggregatedInputPower=optIfOChGroupSrcCurrentAggregatedInputPower, optIfOChGroupConfigEntry=optIfOChGroupConfigEntry, optIfOMSnSrcCurrentHighAggregatedInputPower=optIfOMSnSrcCurrentHighAggregatedInputPower, optIfOTSnSinkCurrentHighInputPower=optIfOTSnSinkCurrentHighInputPower, optIfOChGroupSrcCurrentLowOutputPower=optIfOChGroupSrcCurrentLowOutputPower, optIfOMSnSinkCurDayLowOutputPower=optIfOMSnSinkCurDayLowOutputPower, optIfOTSnSrcIntervalLastInputPower=optIfOTSnSrcIntervalLastInputPower, optIfOTSnTIMDetMode=optIfOTSnTIMDetMode, optIfOChGroupSinkIntervalLastAggregatedInputPower=optIfOChGroupSinkIntervalLastAggregatedInputPower, optIfOTMnOrder=optIfOTMnOrder, optIfOChSrcIntervalTable=optIfOChSrcIntervalTable, optIfOChSrcCurDayTable=optIfOChSrcCurDayTable, optIfOChGroupSinkIntervalEntry=optIfOChGroupSinkIntervalEntry, optIfOChSrcCurrentHighOutputPower=optIfOChSrcCurrentHighOutputPower, optIfOChGroupSrcPrevDayLowAggregatedInputPower=optIfOChGroupSrcPrevDayLowAggregatedInputPower, optIfODUkDirectionality=optIfODUkDirectionality, optIfOTSnSinkIntervalHighInputPower=optIfOTSnSinkIntervalHighInputPower, optIfOTSnSinkCurrentUpperInputPowerThreshold=optIfOTSnSinkCurrentUpperInputPowerThreshold, optIfOChCurrentStatus=optIfOChCurrentStatus, optIfOMSnSrcCurrentLowOutputPower=optIfOMSnSrcCurrentLowOutputPower, optIfCompl=optIfCompl, optIfOMSnSrcPrevDayLowOutputPower=optIfOMSnSrcPrevDayLowOutputPower, optIfOChGroupSrcIntervalLastAggregatedInputPower=optIfOChGroupSrcIntervalLastAggregatedInputPower, optIfOChSinkPrevDayHighInputPower=optIfOChSinkPrevDayHighInputPower, optIfOChSrcPrevDayLastOutputPower=optIfOChSrcPrevDayLastOutputPower, optIfODUkTNimDirectionality=optIfODUkTNimDirectionality, optIfOMSnSrcCurDayLowOutputPower=optIfOMSnSrcCurDayLowOutputPower, optIfOChGroupDirectionality=optIfOChGroupDirectionality, optIfOTSnSinkIntervalHighOutputPower=optIfOTSnSinkIntervalHighOutputPower, optIfODUkTSourceGroup=optIfODUkTSourceGroup, optIfOChDirectionality=optIfOChDirectionality, optIfOMSnSinkCurrentEntry=optIfOMSnSinkCurrentEntry, optIfGCC0Group=optIfGCC0Group, optIfOMSnSrcCurDayTable=optIfOMSnSrcCurDayTable, optIfOChGroupSrcPrevDayLastAggregatedInputPower=optIfOChGroupSrcPrevDayLastAggregatedInputPower, optIfOTSnSinkIntervalLowInputPower=optIfOTSnSinkIntervalLowInputPower, optIfOMSnSinkCurDayTable=optIfOMSnSinkCurDayTable, optIfODUkNimDAPIExpected=optIfODUkNimDAPIExpected, optIfOTSnSinkGroupFull=optIfOTSnSinkGroupFull, optIfOTSnSrcPrevDayHighInputPower=optIfOTSnSrcPrevDayHighInputPower, optIfOChGroupSrcCurrentTable=optIfOChGroupSrcCurrentTable, OptIfAcTI=OptIfAcTI, optIfOTUkTIMActEnabled=optIfOTUkTIMActEnabled, optIfOTUkSinkFECEnabled=optIfOTUkSinkFECEnabled, optIfOMSnSrcCurrentAggregatedInputPower=optIfOMSnSrcCurrentAggregatedInputPower, optIfOTUkDirectionality=optIfOTUkDirectionality, optIfOMSnSrcCurrentLowerOutputPowerThreshold=optIfOMSnSrcCurrentLowerOutputPowerThreshold)
