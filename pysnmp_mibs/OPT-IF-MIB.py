...
# Notes
# -----
# ASN.1 source file://mibs/rfc/OPT-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:18:53 2025
...
optIfOtnConfigCompl = ModuleCompliance(
    (1, 3, 6, 1, 2, 1, 10, 133, 2, 2, 1)
)
optIfOtnConfigCompl.setObjects(
      *(("OPT-IF-MIB", "optIfOTMnGroup"),
        ("OPT-IF-MIB", "optIfOTSnCommonGroup"),
        ("OPT-IF-MIB", "optIfOTSnSourceGroupFull"),
        ("OPT-IF-MIB", "optIfOTSnAPRStatusGroup"),
        ("OPT-IF-MIB", "optIfOTSnAPRControlGroup"),
        ("OPT-IF-MIB", "optIfOTSnSinkGroupBasic"),
        ("OPT-IF-MIB", "optIfOTSnSinkGroupFull"),
        ("OPT-IF-MIB", "optIfOMSnCommonGroup"),
        ("OPT-IF-MIB", "optIfOMSnSinkGroupBasic"),
        ("OPT-IF-MIB", "optIfOChGroupCommonGroup"),
        ("OPT-IF-MIB", "optIfOChCommonGroup"),
        ("OPT-IF-MIB", "optIfOChSinkGroupBasic"),
        ("OPT-IF-MIB", "optIfOTUkCommonGroup"),
        ("OPT-IF-MIB", "optIfOTUkSourceGroup"),
        ("OPT-IF-MIB", "optIfOTUkSinkGroup"),
        ("OPT-IF-MIB", "optIfGCC0Group"),
        ("OPT-IF-MIB", "optIfODUkGroup"),
        ("OPT-IF-MIB", "optIfODUkTtpSourceGroup"),
        ("OPT-IF-MIB", "optIfODUkTtpSinkGroup"),
        ("OPT-IF-MIB", "optIfODUkNimGroup"),
        ("OPT-IF-MIB", "optIfGCC12Group"),
        ("OPT-IF-MIB", "optIfODUkTCommonGroup"),
        ("OPT-IF-MIB", "optIfODUkTSourceGroup"),
        ("OPT-IF-MIB", "optIfODUkTSinkGroup"),
        ("OPT-IF-MIB", "optIfODUkTSinkGroupCtp"),
        ("OPT-IF-MIB", "optIfODUkTNimGroup"))
)
if mibBuilder.loadTexts:
    optIfOtnConfigCompl.setStatus(
        "current"
    )

optIfPreOtnPMCompl = ModuleCompliance(
    (1, 3, 6, 1, 2, 1, 10, 133, 2, 2, 2)
)
optIfPreOtnPMCompl.setObjects(
      *(("OPT-IF-MIB", "optIfPerfMonGroup"),
        ("OPT-IF-MIB", "optIfOTSnSinkPreOtnPMGroup"),
        ("OPT-IF-MIB", "optIfOTSnSinkPreOtnPMThresholdGroup"),
        ("OPT-IF-MIB", "optIfOTSnSourcePreOtnPMGroup"),
        ("OPT-IF-MIB", "optIfOTSnSourcePreOtnPMThresholdGroup"),
        ("OPT-IF-MIB", "optIfOMSnSinkPreOtnPMGroup"),
        ("OPT-IF-MIB", "optIfOMSnSinkPreOtnPMThresholdGroup"),
        ("OPT-IF-MIB", "optIfOMSnSourcePreOtnPMGroup"),
        ("OPT-IF-MIB", "optIfOMSnSourcePreOtnPMThresholdGroup"),
        ("OPT-IF-MIB", "optIfOChGroupSinkPreOtnPMGroup"),
        ("OPT-IF-MIB", "optIfOChGroupSinkPreOtnPMThresholdGroup"),
        ("OPT-IF-MIB", "optIfOChGroupSourcePreOtnPMGroup"),
        ("OPT-IF-MIB", "optIfOChGroupSourcePreOtnPMThresholdGroup"),
        ("OPT-IF-MIB", "optIfOChSinkPreOtnPMGroup"),
        ("OPT-IF-MIB", "optIfOChSinkPreOtnPMThresholdGroup"),
...
mibBuilder.exportSymbols(
    ...
    **{"OptIfAcTI": OptIfAcTI,
       ...
       "optIfOtnConfigCompl": optIfOtnConfigCompl,
       "optIfPreOtnPMCompl": optIfPreOtnPMCompl}
)
