...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:27:42 2025
...
ModuleIdentity, Counter64, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, NotificationType, MibIdentifier, TimeTicks, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "Bits", "mib-2", "IpAddress")
DisplayString, TextualConvention, DateAndTime, InstancePointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "DateAndTime", "InstancePointer")
...
mibBuilder.exportSymbols("APPC-MIB", appcLu=appcLu, appcLuPairOperSessSec=appcLuPairOperSessSec, appcCnosResponsible=appcCnosResponsible, appcActSessEntry=appcActSessEntry, appcHistSessUnbindType=appcHistSessUnbindType, appcCnosMinCwinLimit=appcCnosMinCwinLimit, appcActSessMaxSndRuSize=appcActSessMaxSndRuSize, appcModeOperSessLimit=appcModeOperSessLimit, appcActSessSendRpc=appcActSessSendRpc, appcActSessOperState=appcActSessOperState, appcTpAdminConvDuplex=appcTpAdminConvDuplex, appcGroups=appcGroups, appcLluOperOutBoundCompLevel=appcLluOperOutBoundCompLevel, appcTpAdminStartParm=appcTpAdminStartParm, appcLuPairOperState=appcLuPairOperState, appcModeAdminCompression=appcModeAdminCompression, appcActiveConvState=appcActiveConvState, appcTpAdminLongRun=appcTpAdminLongRun, appcSessStatsParLuName=appcSessStatsParLuName, appcActSessMaxRcvRuSize=appcActSessMaxRcvRuSize, appcHistSessEntry=appcHistSessEntry, appcActiveHprSessions=appcActiveHprSessions, appcDefaultLuName=appcDefaultLuName, appcModeOperActCwin=appcModeOperActCwin, appcSessStatsSessIndex=appcSessStatsSessIndex, appcCntrlOperTraceTime=appcCntrlOperTraceTime, appcModeAdminMaxSessLimit=appcModeAdminMaxSessLimit, appcCpicOperParLuAlias=appcCpicOperParLuAlias, appcModeOperInBoundCompLevel=appcModeOperInBoundCompLevel, appcLluOperActiveSessions=appcLluOperActiveSessions, appcSessRtpSessions=appcSessRtpSessions, appcCpicConfGroup=appcCpicConfGroup, appcSessRtpNceId=appcSessRtpNceId, appcModeOperCompRleBeforeLZ=appcModeOperCompRleBeforeLZ, appcModeOperMinCwinLimit=appcModeOperMinCwinLimit, appcActiveConvUpTime=appcActiveConvUpTime, appcModeOperPndClos=appcModeOperPndClos, appcHistConvEndTime=appcHistConvEndTime, appcActSessTransPriority=appcActSessTransPriority, appcModeOperSingSessReinit=appcModeOperSingSessReinit, appcModeOperActClos=appcModeOperActClos, appcLuPairAdminEntry=appcLuPairAdminEntry, appcHistSessType=appcHistSessType, appcModeOperDrainSelf=appcModeOperDrainSelf, appcHistSessParLuName=appcHistSessParLuName, appcHistSessComponentId=appcHistSessComponentId, appcModeOperSessEndTpName=appcModeOperSessEndTpName, appcCpicAdminTable=appcCpicAdminTable, appcModeOperSendPacWinSz=appcModeOperSendPacWinSz, appcLluOperName=appcLluOperName, appcModeAdminInBoundCompLevel=appcModeAdminInBoundCompLevel, appcHistConvTable=appcHistConvTable, appcSessStatsLocLuName=appcSessStatsLocLuName, appcActSessPcid=appcActSessPcid, appcModeOperRecvRuSzLoBnd=appcModeOperRecvRuSzLoBnd, appcDefaultTpConvSecRqd=appcDefaultTpConvSecRqd, appcActiveConvLuwIdSequence=appcActiveConvLuwIdSequence, appcSessRtpTcid=appcSessRtpTcid, appcLuPairOperLinkObjId=appcLuPairOperLinkObjId, appcDefaultMaxMcLlSndSize=appcDefaultMaxMcLlSndSize, appcCnosForce=appcCnosForce, appcHistSessSenseData=appcHistSessSenseData, appcLluAdminInBoundCompLevel=appcLluAdminInBoundCompLevel, appcModeOperLocLuName=appcModeOperLocLuName, appcActiveConvSendBytes=appcActiveConvSendBytes, appcCpicOperUserid=appcCpicOperUserid, appcLluOperCompRleBeforeLZ=appcLluOperCompRleBeforeLZ, appcCntrlAdminTrace=appcCntrlAdminTrace, appcCntrlAdminTraceParm=appcCntrlAdminTraceParm, appcHistConvParLuName=appcHistConvParLuName, appcLluAdminName=appcLluAdminName, appcDefaultTpOperation=appcDefaultTpOperation, appcCpicAdminEntry=appcCpicAdminEntry, appcModeOperCNOSNeg=appcModeOperCNOSNeg, appcSessStatsEntry=appcSessStatsEntry, appcHistConvIndex=appcHistConvIndex, appcActSessSndPacingSize=appcActSessSndPacingSize, appcActiveConvCorrelator=appcActiveConvCorrelator, appcLluAdminDepType=appcLluAdminDepType, appcActSessRtpNceId=appcActSessRtpNceId, appcLuPairAdminParLuName=appcLuPairAdminParLuName, appcLuPairAdminSessSec=appcLuPairAdminSessSec, appcActiveConvType=appcActiveConvType, appcSessionConfGroup=appcSessionConfGroup, appcActiveConvLocLuName=appcActiveConvLocLuName, appcCompliance=appcCompliance, appcCpicAdminUserid=appcCpicAdminUserid, appcSessStatsRcvdFmdRus=appcSessStatsRcvdFmdRus, appcLuPairOperParLuName=appcLuPairOperParLuName, appcModeAdminCrypto=appcModeAdminCrypto, appcCpicAdminModeName=appcCpicAdminModeName, appcCpicAdminSecurity=appcCpicAdminSecurity, appcActSessRcvPacingSize=appcActSessRcvPacingSize, appcSessStatsRcvdFmdBytes=appcSessStatsRcvdFmdBytes, appcModeOperParLuName=appcModeOperParLuName, appcActiveConvDuplex=appcActiveConvDuplex, appcLuPairOperTable=appcLuPairOperTable, appcCpicAdminTpNameType=appcCpicAdminTpNameType, appcModeOperTable=appcModeOperTable, appcSession=appcSession, appcModeAdminConWinAutoActLmt=appcModeAdminConWinAutoActLmt, appcMIB=appcMIB, appcModeOperRecvRuSzUpBnd=appcModeOperRecvRuSzUpBnd, appcModeOperSendRuSzUpBnd=appcModeOperSendRuSzUpBnd, appcLluAdminSessLimit=appcLluAdminSessLimit, appcGlobalObjects=appcGlobalObjects, appcModeAdminSyncLvl=appcModeAdminSyncLvl, appcObjects=appcObjects, appcActiveConvEntry=appcActiveConvEntry, appcLluOperCompression=appcLluOperCompression, appcActSessSendPacingType=appcActSessSendPacingType, appcConformance=appcConformance, appcLluOperAlias=appcLluOperAlias, appcLuPairAdminSecAccept=appcLuPairAdminSecAccept, appcModeAdminEntry=appcModeAdminEntry, appcActSessLinkIndex=appcActSessLinkIndex, appcActSessRtpTcid=appcActSessRtpTcid, appcLuPairOperParLuAlias=appcLuPairOperParLuAlias, appcCntrlAdminRscv=appcCntrlAdminRscv, appcModeAdminSessEndTpName=appcModeAdminSessEndTpName, appcHistConvLogData=appcHistConvLogData, appcLluAdminEntry=appcLluAdminEntry, appcCnosControl=appcCnosControl, appcModeAdminPrefSendRuSz=appcModeAdminPrefSendRuSz, appcModeAdminSendRuSzLoBnd=appcModeAdminSendRuSzLoBnd, appcLluAdminTable=appcLluAdminTable, appcCntrlAdminStat=appcCntrlAdminStat, appcLluOperBindRspMayQ=appcLluOperBindRspMayQ, appcModeOperCrypto=appcModeOperCrypto, appcTpConfGroup=appcTpConfGroup, appcLluOperTable=appcLluOperTable, appcLluOperDepType=appcLluOperDepType, appcHistSessIndex=appcHistSessIndex, appcActSessRecvNxWndwSize=appcActSessRecvNxWndwSize, appcLuPairOperSecAccept=appcLuPairOperSecAccept, appcCpicOperTpNameType=appcCpicOperTpNameType, appcActiveConvParLuName=appcActiveConvParLuName, appcActSessPcidCpName=appcActSessPcidCpName, appcLuPairAdminParaSessSup=appcLuPairAdminParaSessSup, appcCpicOperTpName=appcCpicOperTpName, appcLluAdminOutBoundCompLevel=appcLluAdminOutBoundCompLevel, appcCpicOperEntry=appcCpicOperEntry, appcHistConvPcid=appcHistConvPcid, appcSessStatsSentFmdRus=appcSessStatsSentFmdRus, appcModeOperPtmCwin=appcModeOperPtmCwin, appcCntrlOperGroup=appcCntrlOperGroup, appcModeAdminSendPacWinSz=appcModeAdminSendPacWinSz, appcHistSessTime=appcHistSessTime, appcActiveConvLuwIdInstance=appcActiveConvLuwIdInstance, appcCnosTargetModeName=appcCnosTargetModeName, appcModeOperCompression=appcModeOperCompression, appcGlobal=appcGlobal, appcModeOperPtmClos=appcModeOperPtmClos, appcLluOperEntry=appcLluOperEntry, appcActSessRecvRpc=appcActSessRecvRpc, appcActSessParLuName=appcActSessParLuName, appcTp=appcTp, appcHistSessModeName=appcHistSessModeName, appcActiveConvPcid=appcActiveConvPcid, appcCpicAdminLocLuName=appcCpicAdminLocLuName, appcModeOperMaxSessLimit=appcModeOperMaxSessLimit, appcSessStatsRcvdNonFmdRus=appcSessStatsRcvdNonFmdRus, appcModeAdminMinCwinLimit=appcModeAdminMinCwinLimit, appcCntrlOperStat=appcCntrlOperStat, appcActiveConvUserid=appcActiveConvUserid, appcModeAdminSendRuSzUpBnd=appcModeAdminSendRuSzUpBnd, appcHistConvLocLuName=appcHistConvLocLuName, appcTpAdminTpName=appcTpAdminTpName, appcActSessRecvPacingType=appcActSessRecvPacingType, appcActSessUpTime=appcActSessUpTime, appcModeConfGroup=appcModeConfGroup, appcCpicAdminParLuName=appcCpicAdminParLuName, appcSessStatsSentNonFmdRus=appcSessStatsSentNonFmdRus, appcGlobalConfGroup=appcGlobalConfGroup, appcLuPairAdminLinkObjId=appcLuPairAdminLinkObjId, appcModeAdminCosName=appcModeAdminCosName, appcTpAdminVerPip=appcTpAdminVerPip, appcTpAdminSyncLvl=appcTpAdminSyncLvl, appcHistSessDetectModule=appcHistSessDetectModule, appcCnosCommand=appcCnosCommand, appcCntrlOperRscv=appcCntrlOperRscv, appcActSessPluIndicator=appcActSessPluIndicator, appcTpAdminConvType=appcTpAdminConvType, appcLluOperSessLimit=appcLluOperSessLimit, appcLuPairOperParaSessSupLS=appcLuPairOperParaSessSupLS, appcCpicOperLocLuName=appcCpicOperLocLuName, appcModeOperPrefRecvRuSz=appcModeOperPrefRecvRuSz, appcCntrlOperStatTime=appcCntrlOperStatTime, appcLluAdminCompRleBeforeLZ=appcLluAdminCompRleBeforeLZ, appcActiveConvSyncLvl=appcActiveConvSyncLvl, appcActSessLocLuName=appcActSessLocLuName, appcCntrlOperTrace=appcCntrlOperTrace, appcModeAdminRecvRuSzLoBnd=appcModeAdminRecvRuSzLoBnd, appcModeAdminRecvPacWinSz=appcModeAdminRecvPacWinSz, appcCpicOperSymbDestName=appcCpicOperSymbDestName, appcModeAdminSingSessReinit=appcModeAdminSingSessReinit, appcSessStatsSentFmdBytes=appcSessStatsSentFmdBytes, appcActSessTable=appcActSessTable, appcCnosDrainPart=appcCnosDrainPart, appcLluConfGroup=appcLluConfGroup, appcLluAdminCompression=appcLluAdminCompression, appcHistConvPcidNauName=appcHistConvPcidNauName, appcTpAdminEntry=appcTpAdminEntry, appcModeAdminMinClosLimit=appcModeAdminMinClosLimit, appcModeAdminCompRleBeforeLZ=appcModeAdminCompRleBeforeLZ, appcUpTime=appcUpTime, appcTpAdminFileSpec=appcTpAdminFileSpec, appcModeOperPrefSendRuSz=appcModeOperPrefSendRuSz, appcTpAdminConvSecReq=appcTpAdminConvSecReq, appcModeOperOutBoundCompLevel=appcModeOperOutBoundCompLevel, appcLluOperInBoundCompLevel=appcLluOperInBoundCompLevel, SnaSenseData=SnaSenseData, appcLuPairAdminTable=appcLuPairAdminTable, appcModeOperSyncLvlLastStart=appcModeOperSyncLvlLastStart, appcDefaultModeName=appcDefaultModeName, appcDefaultImplInbndPlu=appcDefaultImplInbndPlu, appcCnosMinClosLimit=appcCnosMinClosLimit, appcActiveConvSessIndex=appcActiveConvSessIndex, appcLuPairAdminLocLuName=appcLuPairAdminLocLuName, appcModeAdminOutBoundCompLevel=appcModeAdminOutBoundCompLevel, appcActSessInUse=appcActSessInUse, appcLuPairOperLocLuName=appcLuPairOperLocLuName, appcActSessIndex=appcActSessIndex, appcModeOperModeName=appcModeOperModeName, appcLluOperLocalAddress=appcLluOperLocalAddress, appcLuPairAdminParLuAlias=appcLuPairAdminParLuAlias, appcTpAdminInAttachTimeout=appcTpAdminInAttachTimeout, appcLocalCpName=appcLocalCpName, appcCnosConfGroup=appcCnosConfGroup, appcConversationConfGroup=appcConversationConfGroup, appcTpAdminTable=appcTpAdminTable, appcModeAdminRecvRuSzUpBnd=appcModeAdminRecvRuSzUpBnd, appcCpicAdminParLuAlias=appcCpicAdminParLuAlias, appcCnosTargetLocLuName=appcCnosTargetLocLuName, appcControlConfGroup=appcControlConfGroup, appcModeOperPndCwin=appcModeOperPndCwin, appcCpicAdminTpName=appcCpicAdminTpName, appcModeOperConWinAutoActLmt=appcModeOperConWinAutoActLmt, appcTpAdminRcvAllocTimeout=appcTpAdminRcvAllocTimeout, appcLluAdminAlias=appcLluAdminAlias, appcHistSessLocLuName=appcHistSessLocLuName, appcModeOperRecvPacWinSz=appcModeOperRecvPacWinSz, appcModeAdminModeName=appcModeAdminModeName, appcParLuConfGroup=appcParLuConfGroup, appcModeAdminLocLuName=appcModeAdminLocLuName, PYSNMP_MODULE_ID=appcMIB, appcSessStatsSentNonFmdBytes=appcSessStatsSentNonFmdBytes, appcLluAdminBindRspMayQ=appcLluAdminBindRspMayQ, appcLuPairOperEntry=appcLuPairOperEntry, appcSessRtpEntry=appcSessRtpEntry, appcModeOperSyncLvl=appcModeOperSyncLvl, appcLuPairOperSessLimit=appcLuPairOperSessLimit, appcTpAdminPipSubNum=appcTpAdminPipSubNum, appcActSessSendNxWndwSize=appcActSessSendNxWndwSize)
mibBuilder.exportSymbols("APPC-MIB", appcActSessModeName=appcActSessModeName, appcCpicOperParLuName=appcCpicOperParLuName, appcTpAdminStatus=appcTpAdminStatus, appcActiveConvLuwIdName=appcActiveConvLuwIdName, appcHistConvEntry=appcHistConvEntry, appcActiveConvModeName=appcActiveConvModeName, appcActiveConvSource=appcActiveConvSource, appcConversation=appcConversation, appcCntrlOperTraceParm=appcCntrlOperTraceParm, appcModeOperEntry=appcModeOperEntry, appcCnosMaxSessLimit=appcCnosMaxSessLimit, appcSessStatsCtrUpTime=appcSessStatsCtrUpTime, appcModeOperCryptoLastStart=appcModeOperCryptoLastStart, appcHistConvTpName=appcHistConvTpName, appcActiveConvRcvBytes=appcActiveConvRcvBytes, appcActiveConvTpName=appcActiveConvTpName, appcModeOperDrainPart=appcModeOperDrainPart, appcActSessCosName=appcActSessCosName, appcActiveSessions=appcActiveSessions, appcCnosDrainSelf=appcCnosDrainSelf, appcCpicAdminSymbDestName=appcCpicAdminSymbDestName, appcCpicOperSecurity=appcCpicOperSecurity, appcActSessRscv=appcActSessRscv, appcSessStatsRcvdNonFmdBytes=appcSessStatsRcvdNonFmdBytes, appcActiveConvId=appcActiveConvId, appcCntrlOperRscvTime=appcCntrlOperRscvTime, appcModeOperMinClosLimit=appcModeOperMinClosLimit, appcTpAdminInstLmt=appcTpAdminInstLmt, appcHistSessTable=appcHistSessTable, appcCpicOperTable=appcCpicOperTable, appcSessStatsTable=appcSessStatsTable, appcModeOperCosName=appcModeOperCosName, appcHistConvSenseData=appcHistConvSenseData, appcTpAdminLocLuName=appcTpAdminLocLuName, appcCntrlAdminGroup=appcCntrlAdminGroup, appcHistConvEndedBy=appcHistConvEndedBy, appcModeAdminTable=appcModeAdminTable, appcModeOperSendRuSzLoBnd=appcModeOperSendRuSzLoBnd, appcDefaultFileSpec=appcDefaultFileSpec, appcModeAdminParLuName=appcModeAdminParLuName, appcActiveConvTable=appcActiveConvTable, appcCnosTargetParLuName=appcCnosTargetParLuName, appcCPIC=appcCPIC, appcModeAdminPrefRecvRuSz=appcModeAdminPrefRecvRuSz, appcTpAdminTpOperation=appcTpAdminTpOperation, appcLluAdminLocalAddress=appcLluAdminLocalAddress, appcActiveConvPcidNauName=appcActiveConvPcidNauName, appcLuPairAdminSessLimit=appcLuPairAdminSessLimit, appcActSessEnhanceSecSup=appcActSessEnhanceSecSup, appcSessRtpTable=appcSessRtpTable, appcCompliances=appcCompliances, appcLuPairOperParaSessSup=appcLuPairOperParaSessSup, appcCpicOperModeName=appcCpicOperModeName)
