...
# Notes
# -----
# ASN.1 source file://mibs/rfc/LLDP-EXT-DOT1-MIB
...
_LldpXdot1ConfigVlanNameTxEnable_Type.__name__ = "TruthValue"
...
lldpXdot1Compliance.setObjects(
      *(("LLDP-EXT-DOT1-MIB", "lldpXdot1ConfigGroup"),
        ("LLDP-EXT-DOT1-MIB", "lldpXdot1LocSysGroup"),
        ("LLDP-EXT-DOT1-MIB", "lldpXdot1RemSysGroup"))
)
if mibBuilder.loadTexts:
