...
mibBuilder.exportSymbols("EXTREME-STP-EXTENSIONS-MIB", extremeStpDomainRowStatus=extremeStpDomainRowStatus, BridgeId=BridgeId, extremeStpDomainForwardDelay=extremeStpDomainForwardDelay, extremeStpDomainStpEnabled=extremeStpDomainStpEnabled, extremeStpNotificationsPrefix=extremeStpNotificationsPrefix, extremeStpPortDesignatedBridge=extremeStpPortDesignatedBridge, extremeStpPortPortState=extremeStpPortPortState, extremeStpDomainStpdName=extremeStpDomainStpdName, extremeStpDomainHelloTime=extremeStpDomainHelloTime, extremeStpPortDesignatedRoot=extremeStpPortDesignatedRoot, extremeStpPortRowStatus=extremeStpPortRowStatus, Timeout=Timeout, extremeStpVlanPortRowStatus=extremeStpVlanPortRowStatus, extremeStpVlanPortPortMask=extremeStpVlanPortPortMask, extremeStpPortLoopProtectEventDetected=extremeStpPortLoopProtectEventDetected, extremeStpDomainBridgeMaxAge=extremeStpDomainBridgeMaxAge, extremeStpDomainRstpEnabled=extremeStpDomainRstpEnabled, extremeStpDomainNumPorts=extremeStpDomainNumPorts, extremeStpDomainBridgeId=extremeStpDomainBridgeId, extremeStpDomainRootCost=extremeStpDomainRootCost, extremeStpDomainStpdInstance=extremeStpDomainStpdInstance, extremeStpPortPortMode=extremeStpPortPortMode, extremeStpPortDesignatedCost=extremeStpPortDesignatedCost, extremeStpDomainRRFailoverEnabled=extremeStpDomainRRFailoverEnabled, extremeStpVlanPortTable=extremeStpVlanPortTable, extremeStpEdgePortLoopDetected=extremeStpEdgePortLoopDetected, extremeStpDomainDesignatedRoot=extremeStpDomainDesignatedRoot, extremeStpDomainPortInstance=extremeStpDomainPortInstance, extremeStp=extremeStp, extremeStpDomainTimeSinceTopologyChange=extremeStpDomainTimeSinceTopologyChange, extremeStpPortTable=extremeStpPortTable, extremeStpPortPortIfIndex=extremeStpPortPortIfIndex, extremeStpDomainTopChanges=extremeStpDomainTopChanges, extremeStpPortPortId=extremeStpPortPortId, PYSNMP_MODULE_ID=extremeStp, extremeStpDomainBridgePriority=extremeStpDomainBridgePriority, extremeStpDomainMaxAge=extremeStpDomainMaxAge, extremeStpVlanPortEntry=extremeStpVlanPortEntry, extremeStpDomainTable=extremeStpDomainTable, extremeStpDomainHoldTime=extremeStpDomainHoldTime, extremeStpDomainBridgeForwardDelay=extremeStpDomainBridgeForwardDelay, extremeStpPortStpEnabled=extremeStpPortStpEnabled, extremeStpDomainStpdDescription=extremeStpDomainStpdDescription, extremeStpPortDesignatedPort=extremeStpPortDesignatedPort, extremeStpPortEntry=extremeStpPortEntry, extremeStpDomainStpdTag=extremeStpDomainStpdTag, extremeStpPortPortPriority=extremeStpPortPortPriority, extremeStpPortPathCost=extremeStpPortPathCost, extremeStpNotifications=extremeStpNotifications, extremeStpDomainRootPortIfIndex=extremeStpDomainRootPortIfIndex, extremeStpDomainBridgeHelloTime=extremeStpDomainBridgeHelloTime, extremeStpDomainEntry=extremeStpDomainEntry)
