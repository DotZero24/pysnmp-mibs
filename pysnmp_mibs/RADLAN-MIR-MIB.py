# SNMP MIB module (RADLAN-MIR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-MIR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:16 2025
...
rlMirInterfaceEntry.setIndexNames(
    (0, "RADLAN-MIR-MIB", "rlMirInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
rlMirVlanBaseReservedPortsEntry.setIndexNames(
    (0, "RADLAN-MIR-MIB", "rlMirVlanBaseReservedPortsIfIndex"),
)
if mibBuilder.loadTexts:
...
rlMirVlanBaseLogicalPortsEntry.setIndexNames(
    (0, "RADLAN-MIR-MIB", "rlMirVlanBaseLogicalPortsIfIndex"),
)
if mibBuilder.loadTexts:
