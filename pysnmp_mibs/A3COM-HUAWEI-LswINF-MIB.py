...
mibBuilder.exportSymbols("A3COM-HUAWEI-LswINF-MIB", hwifUnBoundPort=hwifUnBoundPort, hwifEthernetIsolate=hwifEthernetIsolate, hwifBKbpsUniSuppressionStep=hwifBKbpsUniSuppressionStep, hwifVLANTrunkAllowListLow=hwifVLANTrunkAllowListLow, hwifVlanVPNTPID=hwifVlanVPNTPID, hwifHybridPortIndex=hwifHybridPortIndex, hwethernetEntry=hwethernetEntry, DropDirection=DropDirection, hwifComboPortEntry=hwifComboPortEntry, hwPortIsolateUplinkIfIndex=hwPortIsolateUplinkIfIndex, hwifUnknownPacketDropMul=hwifUnknownPacketDropMul, hwifFlowControl=hwifFlowControl, hwifHybridUnTaggedVlanListLow=hwifHybridUnTaggedVlanListLow, VlanIndex=VlanIndex, hwifInErrorPktsRate=hwifInErrorPktsRate, hwifIsolateGroupID=hwifIsolateGroupID, hwLswL2InfMib=hwLswL2InfMib, hwifHybridTaggedVlanListHigh=hwifHybridTaggedVlanListHigh, hwGlobalBroadcastMaxPps=hwGlobalBroadcastMaxPps, hwifMulSuppression=hwifMulSuppression, hwMaxMacLearn=hwMaxMacLearn, hwifBMbpsUniSuppression=hwifBMbpsUniSuppression, hwifMacAddrLearnMode=hwifMacAddrLearnMode, hwBpduTunnelStatus=hwBpduTunnelStatus, PortList=PortList, hwifVLANTrunkAllowListHigh=hwifVLANTrunkAllowListHigh, hwifBKbpsUniSuppression=hwifBKbpsUniSuppression, hwVlanVPNTPID=hwVlanVPNTPID, hwifUnknownPacketDropUni=hwifUnknownPacketDropUni, hwifOutPayloadOctets=hwifOutPayloadOctets, hwifVLANTrunkStatusTable=hwifVLANTrunkStatusTable, hwVlanVPNTPIDMode=hwVlanVPNTPIDMode, hwifAggregatePortListPorts=hwifAggregatePortListPorts, hwifComboPortTable=hwifComboPortTable, hwifMirrorPort=hwifMirrorPort, hwifPpsMcastControl=hwifPpsMcastControl, hwLswL2InfMibObject=hwLswL2InfMibObject, hwifXXEntry=hwifXXEntry, hwifISPhyPort=hwifISPhyPort, hwifVLANType=hwifVLANType, hwifBMbpsMulSuppressionMax=hwifBMbpsMulSuppressionMax, hwifInPayloadOctets=hwifInPayloadOctets, hwifVLANTrunkGvrpRegistration=hwifVLANTrunkGvrpRegistration, hwifUniSuppression=hwifUniSuppression, hwifEthernetTest=hwifEthernetTest, hwPortIsolateGroupDescription=hwPortIsolateGroupDescription, hwifBMbpsUniSuppressionMax=hwifBMbpsUniSuppressionMax, hwPortIsolateGroupTable=hwPortIsolateGroupTable, hwifMcastControl=hwifMcastControl, hwifEthernetSpeed=hwifEthernetSpeed, hwifSrcMacControl=hwifSrcMacControl, hwifBKbpsMulSuppressionStep=hwifBKbpsMulSuppressionStep, hwifAggregateEntry=hwifAggregateEntry, hwifHybridUnTaggedVlanListHigh=hwifHybridUnTaggedVlanListHigh, hwifMacAddressLearn=hwifMacAddressLearn, hwifHybridPortEntry=hwifHybridPortEntry, hwifXXBasePortIndex=hwifXXBasePortIndex, PYSNMP_MODULE_ID=hwLswL2InfMib, hwLswExtInterface=hwLswExtInterface, hwifXXDevPortIndex=hwifXXDevPortIndex, hwSwitchPortMax=hwSwitchPortMax, hwifBKbpsUniSuppressionMax=hwifBKbpsUniSuppressionMax, hwifVLANTrunkIndex=hwifVLANTrunkIndex, hwifUniSuppressionStep=hwifUniSuppressionStep, hwPortIsolateGroupIndex=hwPortIsolateGroupIndex, SpeedModeFlag=SpeedModeFlag, hwifClearStat=hwifClearStat, hwifComboPortCurActive=hwifComboPortCurActive, hwifVlanVPNStatus=hwifVlanVPNStatus, hwPortIsolateGroupRowStatus=hwPortIsolateGroupRowStatus, hwifAggregatePortName=hwifAggregatePortName, hwIsolateGroupMax=hwIsolateGroupMax, hwifPpsUniSuppressionMax=hwifPpsUniSuppressionMax, hwifAggregatePort=hwifAggregatePort, hwifEthernetAutoSpeedMask=hwifEthernetAutoSpeedMask, hwifInNormalPkts=hwifInNormalPkts, hwifComboActivePort=hwifComboActivePort, hwifEthernetAutoSpeed=hwifEthernetAutoSpeed, hwethernetTable=hwethernetTable, hwifBKbpsMulSuppressionMax=hwifBKbpsMulSuppressionMax, hwifBMbpsMulSuppression=hwifBMbpsMulSuppression, hwifBKbpsMulSuppression=hwifBKbpsMulSuppression, hwifAggregateOperStatus=hwifAggregateOperStatus, hwifVlanVPNUplinkStatus=hwifVlanVPNUplinkStatus, hwifisUplinkPort=hwifisUplinkPort, hwifComboPortIndex=hwifComboPortIndex, hwifEthernetFlowInterval=hwifEthernetFlowInterval, hwifVLANTrunkStatusEntry=hwifVLANTrunkStatusEntry, hwifHybridPortTable=hwifHybridPortTable, hwifVLANTrunkPassListHigh=hwifVLANTrunkPassListHigh, hwifOutPkts=hwifOutPkts, hwifXXTable=hwifXXTable, hwMaxMacLearnRange=hwMaxMacLearnRange, hwifAggregatePortIndex=hwifAggregatePortIndex, hwSlotPortMax=hwSlotPortMax, InterfaceIndex=InterfaceIndex, hwifAggregateTable=hwifAggregateTable, hwifPpsBcastDisValControl=hwifPpsBcastDisValControl, hwGlobalBroadcastMaxRatio=hwGlobalBroadcastMaxRatio, hwifEthernetDuplex=hwifEthernetDuplex, hwifPpsUniSuppression=hwifPpsUniSuppression, hwifAggregateModel=hwifAggregateModel, hwifEthernetMTU=hwifEthernetMTU, hwifMulSuppressionStep=hwifMulSuppressionStep, hwifVLANTrunkPassListLow=hwifVLANTrunkPassListLow, hwifEthernetMdi=hwifEthernetMdi, hwifPpsMulSuppression=hwifPpsMulSuppression, hwifInPkts=hwifInPkts, hwPortIsolateGroupEntry=hwPortIsolateGroupEntry, hwifHybridTaggedVlanListLow=hwifHybridTaggedVlanListLow, hwifPpsMulSuppressionMax=hwifPpsMulSuppressionMax)
