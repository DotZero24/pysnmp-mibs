...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-SAS-ALARM-INPUT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:01:06 2025
...
class _TmnxSasAlarmInputDescription_Type(TItemLongDescription):
    """Custom type tmnxSasAlarmInputDescription based on TItemLongDescription"""
...
_TmnxSasAlarmInputDescription_Type.__name__ = "TItemLongDescription"
...
class _TmnxSasAlarmInputTriggerMessage_Type(OctetString):
    """Custom type tmnxSasAlarmInputTriggerMessage based on OctetString"""
    defaultValue = OctetString("")
...
_TmnxSasAlarmInputTriggerMessage_Type.__name__ = "OctetString"
...
class _TmnxSasAlarmInputClearMessage_Type(OctetString):
    """Custom type tmnxSasAlarmInputClearMessage based on OctetString"""
    defaultValue = OctetString("")
...
_TmnxSasAlarmInputClearMessage_Type.__name__ = "OctetString"
...
class _TmnxSasAlarmInputNotifyMessage_Type(TItemLongDescription):
    """Custom type tmnxSasAlarmInputNotifyMessage based on TItemLongDescription"""
    subtypeSpec = TItemLongDescription.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 160),
    )
...
_TmnxSasAlarmInputNotifyMessage_Type.__name__ = "TItemLongDescription"
...
tmnxAlmInpV2v0NotifyObjsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 6, 2, 2, 1, 6, 2, 3)
)
tmnxAlmInpV2v0NotifyObjsGroup.setObjects(
      *(("TIMETRA-SAS-ALARM-INPUT-MIB", "tmnxSasAlarmInputNotifyId"),
        ("TIMETRA-SAS-ALARM-INPUT-MIB", "tmnxSasAlarmInputNotifyMessage"))
)
if mibBuilder.loadTexts:
    tmnxAlmInpV2v0NotifyObjsGroup.setStatus("current")
...
tmnxAlInpV13v0NotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 6, 2, 2, 1, 6, 2, 5)
)
tmnxAlInpV13v0NotificationGroup.setObjects(
    ("TIMETRA-SAS-ALARM-INPUT-MIB", "tmnxAlarmInputVoltageFailure")
)
if mibBuilder.loadTexts:
    tmnxAlInpV13v0NotificationGroup.setStatus(
        "current"
    )
...
tmnxSASAlarmInputComp7210V2v0.setObjects(
      *(("TIMETRA-SAS-ALARM-INPUT-MIB", "tmnxSASAlarmInputV2v0Group"),
        ("TIMETRA-SAS-ALARM-INPUT-MIB", "tmnxAlmInpV2v0NotifyObjsGroup"),
        ("TIMETRA-SAS-ALARM-INPUT-MIB", "tmnxAlarmInputNotificationV2v0Group"))
)
if mibBuilder.loadTexts:
...
tmnxSASAlarmInputComp7X50V13v0 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 6, 2, 2, 1, 6, 1, 2)
)
tmnxSASAlarmInputComp7X50V13v0.setObjects(
    ("TIMETRA-SAS-ALARM-INPUT-MIB", "tmnxAlInpV13v0NotificationGroup")
)
if mibBuilder.loadTexts:
    tmnxSASAlarmInputComp7X50V13v0.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"timetraServiceAccessSwitches": timetraServiceAccessSwitches,
       ...
       "tmnxSASAlarmInputComp7X50V13v0": tmnxSASAlarmInputComp7X50V13v0,
       ...
       "tmnxAlmInpV2v0NotifyObjsGroup": tmnxAlmInpV2v0NotifyObjsGroup,
       "tmnxAlInpV13v0NotificationGroup": tmnxAlInpV13v0NotificationGroup,
