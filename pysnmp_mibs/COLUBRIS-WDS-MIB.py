...
# Notes
# -----
# ASN.1 source file://mibs/colubris/COLUBRIS-WDS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:29:39 2025
...
coWDSLinkVHT = _CoWDSLinkVHT_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 33, 1, 4, 1, 1, 18),
    _CoWDSLinkVHT_Type()
)
coWDSLinkVHT.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coWDSLinkVHT.setStatus("current")
