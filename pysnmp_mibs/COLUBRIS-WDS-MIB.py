...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/colubris/COLUBRIS-WDS-MIB
...
if mibBuilder.loadTexts: colubrisWdsMIB.setLastUpdated('201306110000Z')
...
coWDSLinkVHT = MibTableColumn((1, 3, 6, 1, 4, 1, 8744, 5, 33, 1, 4, 1, 1, 18), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: coWDSLinkVHT.setStatus('current')
...
colubrisWDSLinkMIBGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 8744, 5, 33, 2, 2, 4)).setObjects(("COLUBRIS-WDS-MIB", "coWDSLinkState"), ("COLUBRIS-WDS-MIB", "coWDSLinkRadio"), ("COLUBRIS-WDS-MIB", "coWDSLinkPeerMacAddress"), ("COLUBRIS-WDS-MIB", "coWDSLinkMaster"), ("COLUBRIS-WDS-MIB", "coWDSLinkAuthorized"), ("COLUBRIS-WDS-MIB", "coWDSLinkEncryption"), ("COLUBRIS-WDS-MIB", "coWDSLinkIdleTime"), ("COLUBRIS-WDS-MIB", "coWDSLinkSNR"), ("COLUBRIS-WDS-MIB", "coWDSLinkTxRate"), ("COLUBRIS-WDS-MIB", "coWDSLinkRxRate"), ("COLUBRIS-WDS-MIB", "coWDSLinkIfIndex"), ("COLUBRIS-WDS-MIB", "coWDSLinkHT"), ("COLUBRIS-WDS-MIB", "coWDSLinkTxMCS"), ("COLUBRIS-WDS-MIB", "coWDSLinkRxMCS"), ("COLUBRIS-WDS-MIB", "coWDSLinkSignal"), ("COLUBRIS-WDS-MIB", "coWDSLinkNoise"), ("COLUBRIS-WDS-MIB", "coWDSLinkVHT"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
mibBuilder.exportSymbols("COLUBRIS-WDS-MIB", coWDSLinkRxMCS=coWDSLinkRxMCS, coWDSScanRadioIndex=coWDSScanRadioIndex, coWDSScanMode=coWDSScanMode, coWDSNetworkScanTable=coWDSNetworkScanTable, coWDSLinkEncryption=coWDSLinkEncryption, colubrisWdsMIBCompliance=colubrisWdsMIBCompliance, coWDSLinkNoise=coWDSLinkNoise, coWDSGroupIndex=coWDSGroupIndex, coWDSLinkRadio=coWDSLinkRadio, coWDSLinkMaster=coWDSLinkMaster, coWDSLinkIndex=coWDSLinkIndex, colubrisWdsMIBObjects=colubrisWdsMIBObjects, coWDSScanPeerMacAddress=coWDSScanPeerMacAddress, coWDSLinkSignal=coWDSLinkSignal, coWDSRadioEntry=coWDSRadioEntry, coWDSGroupSecurity=coWDSGroupSecurity, coWDSLinkVHT=coWDSLinkVHT, coWDSScanPeerIndex=coWDSScanPeerIndex, coWDSRadioQoS=coWDSRadioQoS, coWDSRadioIndex=coWDSRadioIndex, colubrisWDSRadioMIBGroup=colubrisWDSRadioMIBGroup, coWDSNumberOfGroup=coWDSNumberOfGroup, colubrisWdsMIBCompliances=colubrisWdsMIBCompliances, coWDSGroupTable=coWDSGroupTable, coWDSScanSNR=coWDSScanSNR, colubrisWDSInfoMIBGroup=colubrisWDSInfoMIBGroup, coWDSInfoGroup=coWDSInfoGroup, coWDSRadioAckDistance=coWDSRadioAckDistance, colubrisWDSLinkMIBGroup=colubrisWDSLinkMIBGroup, coWDSLinkHT=coWDSLinkHT, coWDSGroupName=coWDSGroupName, coWDSLinkTxMCS=coWDSLinkTxMCS, coWDSNetworkScanEntry=coWDSNetworkScanEntry, colubrisWdsMIBGroups=colubrisWdsMIBGroups, colubrisWdsMIBConformance=colubrisWdsMIBConformance, coWDSLinkState=coWDSLinkState, coWDSRadioTable=coWDSRadioTable, coWDSGroupDynamicMode=coWDSGroupDynamicMode, coWDSGroupGroup=coWDSGroupGroup, coWDSGroupDynamicGroupId=coWDSGroupDynamicGroupId, coWDSGroupEntry=coWDSGroupEntry, coWDSGroupStaticMacAddress=coWDSGroupStaticMacAddress, coWDSLinkIfIndex=coWDSLinkIfIndex, coWDSScanAvailable=coWDSScanAvailable, coWDSNetworkScanGroup=coWDSNetworkScanGroup, coWDSLinkAuthorized=coWDSLinkAuthorized, coWDSLinkTable=coWDSLinkTable, colubrisWDSScanMIBGroup=colubrisWDSScanMIBGroup, coWDSGroupAddressing=coWDSGroupAddressing, coWDSLinkPeerMacAddress=coWDSLinkPeerMacAddress, coWDSLinkRxRate=coWDSLinkRxRate, coWDSScanGroupId=coWDSScanGroupId, coWDSLinkSNR=coWDSLinkSNR, coWDSScanChannel=coWDSScanChannel, PYSNMP_MODULE_ID=colubrisWdsMIB, colubrisWDSGroupMIBGroup=colubrisWDSGroupMIBGroup, coWDSRadioGroup=coWDSRadioGroup, colubrisWdsMIB=colubrisWdsMIB, coWDSLinkGroup=coWDSLinkGroup, coWDSGroupState=coWDSGroupState, coWDSLinkEntry=coWDSLinkEntry, coWDSLinkTxRate=coWDSLinkTxRate, coWDSLinkIdleTime=coWDSLinkIdleTime, coWDSDynamicModeImplemented=coWDSDynamicModeImplemented)
