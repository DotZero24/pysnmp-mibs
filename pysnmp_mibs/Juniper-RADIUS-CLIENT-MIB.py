...
# Produced by pysmi-1.6.2 at Fri Oct 10 21:06:40 2025
...
class _JuniRadiusClientIncludeQosProfileNameInAcctStart_Type(TruthValue):
    """Custom type juniRadiusClientIncludeQosProfileNameInAcctStart based on TruthValue"""
    defaultValue = 2


_JuniRadiusClientIncludeQosProfileNameInAcctStart_Type.__name__ = "TruthValue"
_JuniRadiusClientIncludeQosProfileNameInAcctStart_Object = MibScalar
juniRadiusClientIncludeQosProfileNameInAcctStart = _JuniRadiusClientIncludeQosProfileNameInAcctStart_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 19, 1, 1, 255),
    _JuniRadiusClientIncludeQosProfileNameInAcctStart_Type()
)
juniRadiusClientIncludeQosProfileNameInAcctStart.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    juniRadiusClientIncludeQosProfileNameInAcctStart.setStatus("current")


class _JuniRadiusClientIncludeQosProfileNameInAcctStop_Type(TruthValue):
    """Custom type juniRadiusClientIncludeQosProfileNameInAcctStop based on TruthValue"""
    defaultValue = 2


_JuniRadiusClientIncludeQosProfileNameInAcctStop_Type.__name__ = "TruthValue"
_JuniRadiusClientIncludeQosProfileNameInAcctStop_Object = MibScalar
juniRadiusClientIncludeQosProfileNameInAcctStop = _JuniRadiusClientIncludeQosProfileNameInAcctStop_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 19, 1, 1, 256),
    _JuniRadiusClientIncludeQosProfileNameInAcctStop_Type()
)
juniRadiusClientIncludeQosProfileNameInAcctStop.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    juniRadiusClientIncludeQosProfileNameInAcctStop.setStatus("current")
...
if mibBuilder.loadTexts:
    juniRadiusBrasClientGroup20.setStatus("obsolete")

juniRadiusBrasClientGroup21 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 19, 2, 2, 37)
)
juniRadiusBrasClientGroup21.setObjects(
      *(("Juniper-RADIUS-CLIENT-MIB", "juniRadiusClientDslPortType"),
        ...
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusClientIncludeIpv6VirtualRouterInAcctStart"),
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusClientIncludeIpv6VirtualRouterInAcctStop"),
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusClientIncludeQosProfileNameInAcctStart"),
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusClientIncludeQosProfileNameInAcctStop"))
)
if mibBuilder.loadTexts:
    juniRadiusBrasClientGroup21.setStatus("current")
...
juniRadiusClientCompliance19 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 19, 2, 1, 23)
)
juniRadiusClientCompliance19.setObjects(
      *(("Juniper-RADIUS-CLIENT-MIB", "juniRadiusBasicClientGroup2"),
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusAuthClientGroup3"),
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusAuthNotificationGroup2"),
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusAcctClientGroup4"),
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusAcctNotificationGroup2"),
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusBrasClientGroup21"),
        ("Juniper-RADIUS-CLIENT-MIB", "juniRadiusTunnelClientGroup"))
)
if mibBuilder.loadTexts:
    juniRadiusClientCompliance19.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"JuniRadiusClientRemoterCircuitIdFormatComponents": JuniRadiusClientRemoterCircuitIdFormatComponents,
       ...
       "juniRadiusClientIncludeQosProfileNameInAcctStart": juniRadiusClientIncludeQosProfileNameInAcctStart,
       "juniRadiusClientIncludeQosProfileNameInAcctStop": juniRadiusClientIncludeQosProfileNameInAcctStop,
       ...
       "juniRadiusClientCompliance19": juniRadiusClientCompliance19,
       ...
       "juniRadiusBrasClientGroup21": juniRadiusBrasClientGroup21,
