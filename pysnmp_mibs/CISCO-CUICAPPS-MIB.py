...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CUICAPPS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:26:05 2025
...
_CuicGeneralInfoEnableNotifications_Type.__name__ = "TruthValue"
...
ciscoCuicAppsMIBCompliance.setObjects(
      *(("CISCO-CUICAPPS-MIB", "cuicGeneralInfoTableGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicLicenseInfoTableGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicReportingTableGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicReportSchedulerTableGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicDbInfoTableGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicClusterInfoTableGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicDatasourceInfoTableGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicSecurityTableGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicNotificationInfoGroup"),
        ("CISCO-CUICAPPS-MIB", "ciscoCuicappsMIBEventGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicThreadPoolInfoGroup"),
        ("CISCO-CUICAPPS-MIB", "cuicEnvInfoGroup"))
)
if mibBuilder.loadTexts:
