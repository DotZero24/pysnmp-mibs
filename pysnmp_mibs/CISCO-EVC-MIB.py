...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-EVC-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:23:50 2025
...
mibBuilder.exportSymbols("CISCO-EVC-MIB", cevcMacSecurityViolationGroup=cevcMacSecurityViolationGroup, cevcPortL2ControlProtocolEntry=cevcPortL2ControlProtocolEntry, cevcSIPrimaryVlanBeginningVlan=cevcSIPrimaryVlanBeginningVlan, cevcSIVlanRewriteTable=cevcSIVlanRewriteTable, cevcSISecondaryVlanRowStatus=cevcSISecondaryVlanRowStatus, cevcSIForwardGroup=cevcSIForwardGroup, cevcSIMatchCriteriaType=cevcSIMatchCriteriaType, ciscoEvcMIBComplianceRev1=ciscoEvcMIBComplianceRev1, cevcSIForwardBdNumberBase=cevcSIForwardBdNumberBase, cevcEvcStateTable=cevcEvcStateTable, cevcSIMatchEncapPrimaryCos=cevcSIMatchEncapPrimaryCos, cevcMaxMacConfigLimit=cevcMaxMacConfigLimit, cevcMacSecurityViolationNotification=cevcMacSecurityViolationNotification, cevcSIForwardBdNumber4kBitmap=cevcSIForwardBdNumber4kBitmap, ciscoEvcMIBNotifications=ciscoEvcMIBNotifications, cevcSIPrimaryVlanStorageType=cevcSIPrimaryVlanStorageType, cevcSIForwardBdRowStatus=cevcSIForwardBdRowStatus, cevcEvcGroup=cevcEvcGroup, cevcPortL2ControlProtocolAction=cevcPortL2ControlProtocolAction, cevcSISecondaryVlanEntry=cevcSISecondaryVlanEntry, cevcEvcNotificationConfig=cevcEvcNotificationConfig, cevcSIMatchCriteriaTable=cevcSIMatchCriteriaTable, cevcSIVlanRewriteGroup=cevcSIVlanRewriteGroup, cevcSIType=cevcSIType, cevcSITarget=cevcSITarget, cevcSIMatchEncapValid=cevcSIMatchEncapValid, cevcEvc=cevcEvc, cevcSIID=cevcSIID, cevcUniEvcIndex=cevcUniEvcIndex, cevcSIMatchEncapPriorityCos=cevcSIMatchEncapPriorityCos, cevcSIIndex=cevcSIIndex, cevcSISecondaryVlanEndingVlan=cevcSISecondaryVlanEndingVlan, cevcMacSecurityViolation=cevcMacSecurityViolation, cevcSIForwardGroupRev1=cevcSIForwardGroupRev1, cevcServiceInstance=cevcServiceInstance, ServiceInstanceTargetType=ServiceInstanceTargetType, cevcSIVlanRewriteRowStatus=cevcSIVlanRewriteRowStatus, cevcSIForwardBdStorageType=cevcSIForwardBdStorageType, ServiceInstanceTarget=ServiceInstanceTarget, cevcSICreationType=cevcSICreationType, cevcSIStateEntry=cevcSIStateEntry, cevcSIMatchEncapRowStatus=cevcSIMatchEncapRowStatus, cevcEvcActiveUnis=cevcEvcActiveUnis, cevcEvcNotifyEnabled=cevcEvcNotifyEnabled, cevcSIMatchStorageType=cevcSIMatchStorageType, cevcPort=cevcPort, cevcSIEvcIndex=cevcSIEvcIndex, cevcUniEntry=cevcUniEntry, cevcEvcUniTable=cevcEvcUniTable, cevcSICEVlanEndingVlan=cevcSICEVlanEndingVlan, ciscoEvcMIBComplianceRev2=ciscoEvcMIBComplianceRev2, CevcMacSecurityViolationCauseType=CevcMacSecurityViolationCauseType, cevcSystem=cevcSystem, cevcSIForwardBdEntry=cevcSIForwardBdEntry, cevcSIForwardBdNumber1kBitmap=cevcSIForwardBdNumber1kBitmap, cevcSICEVlanEntry=cevcSICEVlanEntry, cevcSIPrimaryVlanEntry=cevcSIPrimaryVlanEntry, ciscoEvcNotificationPrefix=ciscoEvcNotificationPrefix, cevcEvcType=cevcEvcType, cevcSIPrimaryVlanRowStatus=cevcSIPrimaryVlanRowStatus, cevcUniTable=cevcUniTable, cevcPortMode=cevcPortMode, cevcSICEVlanStorageType=cevcSICEVlanStorageType, cevcSIMatchEncapPayloadTypes=cevcSIMatchEncapPayloadTypes, CevcL2ControlProtocolType=CevcL2ControlProtocolType, cevcSIMatchEncapPayloadType=cevcSIMatchEncapPayloadType, cevcUniServiceAttributes=cevcUniServiceAttributes, ciscoEvcMIB=ciscoEvcMIB, cevcSISecondaryVlanBeginningVlan=cevcSISecondaryVlanBeginningVlan, cevcEvcCfgUnis=cevcEvcCfgUnis, cevcSIVlanRewriteVlan1=cevcSIVlanRewriteVlan1, cevcViolationCause=cevcViolationCause, cevcEvcStateEntry=cevcEvcStateEntry, cevcSIName=cevcSIName, cevcSIL2ControlProtocolEntry=cevcSIL2ControlProtocolEntry, cevcSIMatchCriteriaIndex=cevcSIMatchCriteriaIndex, cevcSITable=cevcSITable, cevcPortGroup=cevcPortGroup, cevcSIMatchEncapSecondaryCos=cevcSIMatchEncapSecondaryCos, cevcPortEntry=cevcPortEntry, cevcSIVlanRewriteVlan2=cevcSIVlanRewriteVlan2, cevcSIMatchCriteriaEntry=cevcSIMatchCriteriaEntry, cevcSIMatchCriteriaGroup=cevcSIMatchCriteriaGroup, cevcSIMatchCriteriaGroupRev1=cevcSIMatchCriteriaGroupRev1, cevcSIVlanRewriteSymmetric=cevcSIVlanRewriteSymmetric, cevcSIL2ControlProtocolType=cevcSIL2ControlProtocolType, cevcEvcNotificationGroupRev1=cevcEvcNotificationGroupRev1, cevcSISecondaryVlanStorageType=cevcSISecondaryVlanStorageType, cevcSICosMatchCriteriaGroup=cevcSICosMatchCriteriaGroup, cevcSIMatchEncapStorageType=cevcSIMatchEncapStorageType, ciscoEvcMIBConformance=ciscoEvcMIBConformance, cevcEvcLocalUniIfIndex=cevcEvcLocalUniIfIndex, cevcMaxNumEvcs=cevcMaxNumEvcs, cevcSIOperStatus=cevcSIOperStatus, CiscoEvcIndexOrZero=CiscoEvcIndexOrZero, cevcSIForwardBdNumber=cevcSIForwardBdNumber, cevcUniCEVlanEvcEndingVlan=cevcUniCEVlanEvcEndingVlan, cevcMacAddress=cevcMacAddress, cevcUniCEVlanEvcBeginningVlan=cevcUniCEVlanEvcBeginningVlan, cevcSIGroup=cevcSIGroup, cevcSIForwardBdNumber2kBitmap=cevcSIForwardBdNumber2kBitmap, ciscoEvcMIBCompliance=ciscoEvcMIBCompliance, cevcUniIdentifier=cevcUniIdentifier, cevcSIVlanRewriteAction=cevcSIVlanRewriteAction, cevcSIForwardBdTable=cevcSIForwardBdTable, cevcPortMaxNumServiceInstances=cevcPortMaxNumServiceInstances, cevcNumCfgEvcs=cevcNumCfgEvcs, cevcSIPrimaryVlanTable=cevcSIPrimaryVlanTable, cevcEvcOperStatus=cevcEvcOperStatus, cevcSIForwardingType=cevcSIForwardingType, cevcEvcRowStatus=cevcEvcRowStatus, cevcEvcEntry=cevcEvcEntry, cevcEvcCreationNotification=cevcEvcCreationNotification, cevcEvcNotificationGroup=cevcEvcNotificationGroup, cevcSystemGroup=cevcSystemGroup, cevcEvcUniEntry=cevcEvcUniEntry, cevcSIEntry=cevcSIEntry, cevcSIMatchEncapEncapsulation=cevcSIMatchEncapEncapsulation, cevcUniPortType=cevcUniPortType, cevcEvcUniIndex=cevcEvcUniIndex, cevcEvcTable=cevcEvcTable, ciscoEvcMIBCompliances=ciscoEvcMIBCompliances, cevcSIL2ControlProtocolAction=cevcSIL2ControlProtocolAction, cevcEvcStorageType=cevcEvcStorageType, cevcEvcIdentifier=cevcEvcIdentifier, cevcSICEVlanRowStatus=cevcSICEVlanRowStatus, cevcSIMatchRowStatus=cevcSIMatchRowStatus, cevcUniCEVlanEvcEntry=cevcUniCEVlanEvcEntry, ciscoEvcMIBObjects=ciscoEvcMIBObjects, cevcSICEVlanBeginningVlan=cevcSICEVlanBeginningVlan, ServiceInstanceInterface=ServiceInstanceInterface, cevcEvcUniOperStatus=cevcEvcUniOperStatus, cevcSIAdminStatus=cevcSIAdminStatus, cevcEvcStatusChangedNotification=cevcEvcStatusChangedNotification, cevcSIL2ControlProtocolTable=cevcSIL2ControlProtocolTable, cevcSIStateTable=cevcSIStateTable, cevcPortMaxNumEVCs=cevcPortMaxNumEVCs, cevcSIRowStatus=cevcSIRowStatus, cevcSISecondaryVlanTable=cevcSISecondaryVlanTable, cevcSITargetType=cevcSITargetType, cevcSIForwardBdNumber3kBitmap=cevcSIForwardBdNumber3kBitmap, cevcEvcIndex=cevcEvcIndex, cevcUniCEVlanEvcTable=cevcUniCEVlanEvcTable, cevcSIVlanRewriteStorageType=cevcSIVlanRewriteStorageType, cevcSIMatchEncapTable=cevcSIMatchEncapTable, cevcPortL2ControlProtocolType=cevcPortL2ControlProtocolType, cevcSIVlanRewriteEntry=cevcSIVlanRewriteEntry, cevcEvcDeletionNotification=cevcEvcDeletionNotification, cevcSIMatchEncapEntry=cevcSIMatchEncapEntry, cevcPortTable=cevcPortTable, cevcSICEVlanTable=cevcSICEVlanTable, PYSNMP_MODULE_ID=ciscoEvcMIB, cevcSIVlanRewriteEncapsulation=cevcSIVlanRewriteEncapsulation, cevcEvcNotificationConfigGroup=cevcEvcNotificationConfigGroup, CiscoEvcIndex=CiscoEvcIndex, cevcSIGroupRev1=cevcSIGroupRev1, ciscoEvcMIBGroups=ciscoEvcMIBGroups, cevcEvcUniId=cevcEvcUniId, cevcPortL2ControlProtocolTable=cevcPortL2ControlProtocolTable, cevcSIPrimaryVlanEndingVlan=cevcSIPrimaryVlanEndingVlan, cevcSIVlanRewriteDirection=cevcSIVlanRewriteDirection, cevcSIStorageType=cevcSIStorageType)
