...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-THREAT-NOTIFICATION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:48:25 2025
...
etsysThreatNotificationCompliance.setObjects(
      *(("ENTERASYS-THREAT-NOTIFICATION-MIB", "etsysThreatNotificationMessage1SystemGroup"),
        ...
        ("ENTERASYS-THREAT-NOTIFICATION-MIB", "etsysThreatNotificationMessage4SystemGroup"),
        ("ENTERASYS-THREAT-NOTIFICATION-MIB", "etsysThreatNotificationMessage1Group"),
        ("ENTERASYS-THREAT-NOTIFICATION-MIB", "etsysThreatNotificationMessage2Group"),
        ("ENTERASYS-THREAT-NOTIFICATION-MIB", "etsysThreatNotificationMessage3Group"),
        ("ENTERASYS-THREAT-NOTIFICATION-MIB", "etsysThreatNotificationMessage4Group"),
        ("ENTERASYS-THREAT-NOTIFICATION-MIB", "etsysThreatUndoNotificationMessageSystemGroup"),
        ("ENTERASYS-THREAT-NOTIFICATION-MIB", "etsysThreatUndoNotificationMessageGroup"),
        ("ENTERASYS-THREAT-NOTIFICATION-MIB", "etsysThreatResponseNotificationMessageGroup"))
)
if mibBuilder.loadTexts:
