...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/nortel/S5-CHASSIS-MIB
...
if mibBuilder.loadTexts: s5ChasMib.setLastUpdated('201908230000Z')
...
s5ChasStoreFilename = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 5, 1, 1, 8), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 255))).setMaxAccess("readwrite")
...
s5ChasPsuInfoTable = MibTable((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2), )
if mibBuilder.loadTexts: s5ChasPsuInfoTable.setStatus('current')
s5ChasPsuInfoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2, 1), ).setIndexNames((0, "S5-CHASSIS-MIB", "s5ChasPsuInfoPsuId"))
if mibBuilder.loadTexts: s5ChasPsuInfoEntry.setStatus('current')
s5ChasPsuInfoPsuId = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2, 1, 1), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: s5ChasPsuInfoPsuId.setStatus('current')
s5ChasPsuInfoOrderCode = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: s5ChasPsuInfoOrderCode.setStatus('current')
s5ChasPsuInfoOrderCodeRev = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2, 1, 3), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: s5ChasPsuInfoOrderCodeRev.setStatus('current')
s5ChasPsuInfoDescription = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2, 1, 4), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: s5ChasPsuInfoDescription.setStatus('current')
s5ChasPsuInfoSerialNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2, 1, 5), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: s5ChasPsuInfoSerialNumber.setStatus('current')
s5ChasPsuInfoSuppPartNum = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2, 1, 6), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: s5ChasPsuInfoSuppPartNum.setStatus('current')
s5ChasPsuInfoModelRevision = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2, 1, 7), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: s5ChasPsuInfoModelRevision.setStatus('current')
s5ChasPsuInfoManufacturer = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 1, 6, 3, 9, 2, 1, 8), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: s5ChasPsuInfoManufacturer.setStatus('current')
...
mibBuilder.exportSymbols("S5-CHASSIS-MIB", s5ChasBrdIndx=s5ChasBrdIndx, s5ChasLocChanIndx=s5ChasLocChanIndx, s5ChasGrpDescr=s5ChasGrpDescr, s5ChasComIpv6Address=s5ChasComIpv6Address, s5ChasGblAttLstChng=s5ChasGblAttLstChng, s5ChasPsuInfoSerialNumber=s5ChasPsuInfoSerialNumber, s5ChasGrpType=s5ChasGrpType, s5ChasStore=s5ChasStore, s5ChasPsuInfoOrderCode=s5ChasPsuInfoOrderCode, s5ChasUtilIndx=s5ChasUtilIndx, s5ChasStoreComIndx=s5ChasStoreComIndx, s5ChasPsRpsuSubIndx=s5ChasPsRpsuSubIndx, s5ChasSm=s5ChasSm, s5ChasComIpMgmtAddress=s5ChasComIpMgmtAddress, s5ChasGblConfChngs=s5ChasGblConfChngs, s5ChasStoreEntry=s5ChasStoreEntry, s5ChasComOperState=s5ChasComOperState, s5ChasDescr=s5ChasDescr, s5ChasPsRpsuEntry=s5ChasPsRpsuEntry, s5ChasGrpTable=s5ChasGrpTable, s5ChasType=s5ChasType, s5ChasStoreGrpIndx=s5ChasStoreGrpIndx, s5ChasNotify=s5ChasNotify, s5ChasSerNum=s5ChasSerNum, s5ChasComRunningSoftwareVer=s5ChasComRunningSoftwareVer, s5ChasSmLeds=s5ChasSmLeds, s5ChasPsRpsuTable=s5ChasPsRpsuTable, s5ChasPsuInfoManufacturer=s5ChasPsuInfoManufacturer, s5ChasUtilTotalCPUUsage=s5ChasUtilTotalCPUUsage, s5ChasAttClusterConnCapability=s5ChasAttClusterConnCapability, s5ChasGrpIndx=s5ChasGrpIndx, s5ChasStoreFilename=s5ChasStoreFilename, s5ChasPsRpsuIndx=s5ChasPsRpsuIndx, s5ChasComIpv6MgmtNetMask=s5ChasComIpv6MgmtNetMask, s5ChasComType=s5ChasComType, s5ChasLocChanBkplMode=s5ChasLocChanBkplMode, s5ChasComBaseNumPorts=s5ChasComBaseNumPorts, s5ChasStoreTable=s5ChasStoreTable, s5ChasComLocation=s5ChasComLocation, s5ChasUtilGrpIndx=s5ChasUtilGrpIndx, s5ChasComIpMgmtLimit=s5ChasComIpMgmtLimit, s5ChasComGroupMap=s5ChasComGroupMap, s5ChasPluggables=s5ChasPluggables, s5ChasComVer=s5ChasComVer, s5ChasStoreCntntVer=s5ChasStoreCntntVer, s5ChasUtilTable=s5ChasUtilTable, s5ChasComSerNum=s5ChasComSerNum, s5ChasComIpMgmtGateway=s5ChasComIpMgmtGateway, s5ChasComMaxSubs=s5ChasComMaxSubs, s5ChasUtilEntry=s5ChasUtilEntry, s5ChasGrpPhysChngs=s5ChasGrpPhysChngs, s5ChasGbicInfoHwOptions=s5ChasGbicInfoHwOptions, s5ChasGen=s5ChasGen, s5ChasUtilCPUUsageLast10Minutes=s5ChasUtilCPUUsageLast10Minutes, s5ChasComIpMgmtShutdown=s5ChasComIpMgmtShutdown, s5ChasGbicInfoVendorOui=s5ChasGbicInfoVendorOui, s5ChasGblConfLstChng=s5ChasGblConfLstChng, s5ChasGbicInfoEntry=s5ChasGbicInfoEntry, s5ChasUtilMemoryMinAvailable=s5ChasUtilMemoryMinAvailable, s5ChasGblAttChngs=s5ChasGblAttChngs, s5ChasLocChanBrdIndx=s5ChasLocChanBrdIndx, s5ChasGbicInfoIfIndex=s5ChasGbicInfoIfIndex, s5ChasComDescr=s5ChasComDescr, s5ChasGbicInfoWavelength=s5ChasGbicInfoWavelength, s5ChasStoreUsedSize=s5ChasStoreUsedSize, s5ChasGbicInfoVendorRevision=s5ChasGbicInfoVendorRevision, s5ChasBrdFanLeds=s5ChasBrdFanLeds, s5ChasStoreIndx=s5ChasStoreIndx, s5ChasStoreCurSize=s5ChasStoreCurSize, s5ChasUtilCPUUsageLast1Minute=s5ChasUtilCPUUsageLast1Minute, s5ChasPsRpsuType=s5ChasPsRpsuType, s5ChasTmpSnrGrpIndx=s5ChasTmpSnrGrpIndx, s5ChasTmpSnrTmpValue=s5ChasTmpSnrTmpValue, s5ChasTmpSnrValue=s5ChasTmpSnrValue, s5ChasGbicInfoVendorPartNo=s5ChasGbicInfoVendorPartNo, s5ChasBrdLeds=s5ChasBrdLeds, s5ChasGbicInfoProductCode=s5ChasGbicInfoProductCode, s5ChasUtilSubIndx=s5ChasUtilSubIndx, s5ChasAttTable=s5ChasAttTable, s5ChasBrdEntry=s5ChasBrdEntry, s5ChasComNumSubs=s5ChasComNumSubs, s5ChasStoreSubIndx=s5ChasStoreSubIndx, s5ChasGblPhysLstChng=s5ChasGblPhysLstChng, s5ChasComTotalNumPorts=s5ChasComTotalNumPorts, s5ChasPsuInfoPsuId=s5ChasPsuInfoPsuId, s5ChasGbicInfoGbicType=s5ChasGbicInfoGbicType, s5ChasGbicInfoVendorName=s5ChasGbicInfoVendorName, s5ChasComLstChng=s5ChasComLstChng, s5ChasComIpv6NetMask=s5ChasComIpv6NetMask, s5ChasGrpNumEnts=s5ChasGrpNumEnts, s5ChasComGrpIndx=s5ChasComGrpIndx, s5ChasBrdCfgChngs=s5ChasBrdCfgChngs, s5ChasSmDateCode=s5ChasSmDateCode, s5ChasNotifyFanDirection=s5ChasNotifyFanDirection, s5ChasComIpv6MgmtAddress=s5ChasComIpv6MgmtAddress, s5ChasComUpTime=s5ChasComUpTime, s5ChasAttDfltAtt=s5ChasAttDfltAtt, s5ChasGrpEncodeFactor=s5ChasGrpEncodeFactor, s5ChasLocChanTable=s5ChasLocChanTable, s5ChasGbicInfoTable=s5ChasGbicInfoTable, s5ChasTmpSnrIndx=s5ChasTmpSnrIndx, s5ChasPsuInfoSuppPartNum=s5ChasPsuInfoSuppPartNum, s5ChasTmpSnrSubIndx=s5ChasTmpSnrSubIndx, s5ChasLocChanEntry=s5ChasLocChanEntry, s5ChasBrdDateCode=s5ChasBrdDateCode, s5ChasAttChngs=s5ChasAttChngs, s5ChasUtil=s5ChasUtil, s5ChasComTable=s5ChasComTable, s5ChasUtilCPUUsageLast24Hours=s5ChasUtilCPUUsageLast24Hours, s5ChasTmpSnrTable=s5ChasTmpSnrTable, s5ChasGrpEntry=s5ChasGrpEntry, s5ChasContact=s5ChasContact, s5ChasComSubIndx=s5ChasComSubIndx, s5ChasGrpPhysLstChng=s5ChasGrpPhysLstChng, s5ChasComAdminState=s5ChasComAdminState, s5ChasGbicInfoCleiCode=s5ChasGbicInfoCleiCode, s5ChasUtilCPUUsageLast1Hour=s5ChasUtilCPUUsageLast1Hour, s5ChasUtilMemoryAvailableMB=s5ChasUtilMemoryAvailableMB, PYSNMP_MODULE_ID=s5ChasMib, s5ChasMib=s5ChasMib, s5ChasTmpSnrEntry=s5ChasTmpSnrEntry, s5ChasCom=s5ChasCom, s5ChasAttEntry=s5ChasAttEntry, s5ChasAttLstChng=s5ChasAttLstChng, s5ChasPsuInfoTable=s5ChasPsuInfoTable, s5ChasComIpAddress=s5ChasComIpAddress, s5ChasBrdAttChngs=s5ChasBrdAttChngs, s5ChasGbicInfoDateCode=s5ChasGbicInfoDateCode, s5ChasPsuInfoModelRevision=s5ChasPsuInfoModelRevision, s5ChasTmpSnr=s5ChasTmpSnr, s5ChasVer=s5ChasVer, s5ChasBrdTable=s5ChasBrdTable, s5ChasPsRpsuGrpIndx=s5ChasPsRpsuGrpIndx, s5ChasUtilMemoryAvailable=s5ChasUtilMemoryAvailable, s5ChasBrdAttLstChng=s5ChasBrdAttLstChng, s5ChasPsRpsuSourceConfig=s5ChasPsRpsuSourceConfig, s5ChasAttBrdIndx=s5ChasAttBrdIndx, s5ChasPsuInfoDescription=s5ChasPsuInfoDescription, s5ChasUtilCPUUsageLast10Seconds=s5ChasUtilCPUUsageLast10Seconds, s5ChasPs=s5ChasPs, s5ChasComEntry=s5ChasComEntry, s5ChasPsuInfoEntry=s5ChasPsuInfoEntry, s5ChasGblPhysChngs=s5ChasGblPhysChngs, s5ChasLocation=s5ChasLocation, s5ChasGrpMaxEnts=s5ChasGrpMaxEnts, s5ChasComIndx=s5ChasComIndx, s5ChasBrdNumAtt=s5ChasBrdNumAtt, s5ChasUtilMemoryTotalMB=s5ChasUtilMemoryTotalMB, s5ChasComIpMgmtNetMask=s5ChasComIpMgmtNetMask, s5ChasComIpMgmtTimeout=s5ChasComIpMgmtTimeout, s5ChasAttCurAtt=s5ChasAttCurAtt, s5ChasStoreDescription=s5ChasStoreDescription, s5ChasGbicInfoVendorSerial=s5ChasGbicInfoVendorSerial, s5ChasAttIndx=s5ChasAttIndx, s5ChasBrdCfgSrc=s5ChasBrdCfgSrc, s5ChasStoreType=s5ChasStoreType, s5ChasStoreAge=s5ChasStoreAge, s5ChasPsuInfoOrderCodeRev=s5ChasPsuInfoOrderCodeRev, s5ChasBrd=s5ChasBrd, s5ChasGrp=s5ChasGrp, s5ChasBrdStatusDsply=s5ChasBrdStatusDsply, s5ChasComRelPos=s5ChasComRelPos)
