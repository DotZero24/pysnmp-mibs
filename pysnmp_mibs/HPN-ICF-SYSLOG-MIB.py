...
mibBuilder.exportSymbols("HPN-ICF-SYSLOG-MIB", hpnicfSyslogTrapState=hpnicfSyslogTrapState, hpnicfSyslogTrap=hpnicfSyslogTrap, hpnicfSyslogModuleEntry=hpnicfSyslogModuleEntry, hpnicfSyslogLoghostIpaddressType=hpnicfSyslogLoghostIpaddressType, hpnicfSyslogModuleName=hpnicfSyslogModuleName, TimeStampType=TimeStampType, hpnicfSyslogLoghostSourceInterface=hpnicfSyslogLoghostSourceInterface, hpnicfSyslogLogGlobalLevel=hpnicfSyslogLogGlobalLevel, PYSNMP_MODULE_ID=hpnicfSyslog, hpnicfSyslogSnmpChannel=hpnicfSyslogSnmpChannel, hpnicfSyslogMaxTrapbufferSize=hpnicfSyslogMaxTrapbufferSize, hpnicfSyslogLogTable=hpnicfSyslogLogTable, hpnicfSyslogTrapbufferSize=hpnicfSyslogTrapbufferSize, hpnicfSyslogLoghost=hpnicfSyslogLoghost, hpnicfSyslogLogbuffer=hpnicfSyslogLogbuffer, hpnicfSyslogLogState=hpnicfSyslogLogState, hpnicfSyslogDebugLevel=hpnicfSyslogDebugLevel, hpnicfSyslogDebugTable=hpnicfSyslogDebugTable, hpnicfSyslogModule=hpnicfSyslogModule, hpnicfSyslogTrapbufferEntry=hpnicfSyslogTrapbufferEntry, hpnicfSyslogTrapRowStatus=hpnicfSyslogTrapRowStatus, hpnicfSyslogLogRowStatus=hpnicfSyslogLogRowStatus, hpnicfSyslogMonitorChannel=hpnicfSyslogMonitorChannel, hpnicfSyslogTrapTimestampType=hpnicfSyslogTrapTimestampType, hpnicfSyslogSnmp=hpnicfSyslogSnmp, hpnicfTrapbufferDroppedMessages=hpnicfTrapbufferDroppedMessages, hpnicfSyslogLog=hpnicfSyslogLog, hpnicfSyslogState2=hpnicfSyslogState2, hpnicfSyslogLoghostIpaddress=hpnicfSyslogLoghostIpaddress, hpnicfSyslogMaxLoghost=hpnicfSyslogMaxLoghost, hpnicfSyslogLogLevel=hpnicfSyslogLogLevel, hpnicfLogbufferOverwrittenMessages=hpnicfLogbufferOverwrittenMessages, hpnicfSyslogChannelEntry=hpnicfSyslogChannelEntry, hpnicfSyslogModuleIndex=hpnicfSyslogModuleIndex, hpnicfLogbufferDroppedMessages=hpnicfLogbufferDroppedMessages, hpnicfSyslogTrapLevel=hpnicfSyslogTrapLevel, hpnicfSyslogLoghostTable=hpnicfSyslogLoghostTable, hpnicfSyslogLogGlobalLevelRfc=hpnicfSyslogLogGlobalLevelRfc, MessageLevelType=MessageLevelType, hpnicfSyslogTrapbufferTable=hpnicfSyslogTrapbufferTable, hpnicfSyslogLogbufferTable=hpnicfSyslogLogbufferTable, hpnicfSyslogTrapTable=hpnicfSyslogTrapTable, FacilityType=FacilityType, hpnicfLogbufferIndex=hpnicfLogbufferIndex, hpnicfSyslogLoghostIpaddressPort=hpnicfSyslogLoghostIpaddressPort, hpnicfTrapbufferOverwrittenMessages=hpnicfTrapbufferOverwrittenMessages, hpnicfSyslogLoghostChannel=hpnicfSyslogLoghostChannel, hpnicfSyslogModuleTable=hpnicfSyslogModuleTable, hpnicfLogbufContDescription=hpnicfLogbufContDescription, hpnicfTrapbufferCurrentMessages=hpnicfTrapbufferCurrentMessages, hpnicfSyslogState=hpnicfSyslogState, hpnicfSyslogMaxChannel=hpnicfSyslogMaxChannel, hpnicfSyslogDebug=hpnicfSyslogDebug, hpnicfSyslogLoghostFacility=hpnicfSyslogLoghostFacility, hpnicfSyslogDebugRowStatus=hpnicfSyslogDebugRowStatus, hpnicfSyslogDebugState=hpnicfSyslogDebugState, hpnicfSyslogChannel=hpnicfSyslogChannel, hpnicfSyslogLogbufferEntry=hpnicfSyslogLogbufferEntry, hpnicfSyslogLoghostTimestampType=hpnicfSyslogLoghostTimestampType, hpnicfSyslogChannelName=hpnicfSyslogChannelName, hpnicfSyslogDebugEntry=hpnicfSyslogDebugEntry, hpnicfSyslogDebugTimestampType=hpnicfSyslogDebugTimestampType, hpnicfSyslogObjects=hpnicfSyslogObjects, hpnicfSyslogLogbufferChannel=hpnicfSyslogLogbufferChannel, hpnicfSyslogLoghostIndex=hpnicfSyslogLoghostIndex, hpnicfSyslogConsole=hpnicfSyslogConsole, hpnicfSyslogMonitor=hpnicfSyslogMonitor, hpnicfTrapbufferIndex=hpnicfTrapbufferIndex, hpnicfSyslogChannelIndex=hpnicfSyslogChannelIndex, hpnicfSyslogLogEntry=hpnicfSyslogLogEntry, hpnicfSyslogLogTimestampType=hpnicfSyslogLogTimestampType, hpnicfSyslogTrapbufferChannel=hpnicfSyslogTrapbufferChannel, hpnicfSyslogLogbufContTable=hpnicfSyslogLogbufContTable, hpnicfSyslogTrapbuffer=hpnicfSyslogTrapbuffer, hpnicfSyslogConsoleChannel=hpnicfSyslogConsoleChannel, hpnicfLogbufferCurrentMessages=hpnicfLogbufferCurrentMessages, hpnicfSyslogLoghostLanguage=hpnicfSyslogLoghostLanguage, hpnicfSyslogLoghostTAddress=hpnicfSyslogLoghostTAddress, hpnicfSyslogLoghostOperateRowStatus=hpnicfSyslogLoghostOperateRowStatus, hpnicfSyslogLogbufferSize=hpnicfSyslogLogbufferSize, hpnicfSyslogLogbufContEntry=hpnicfSyslogLogbufContEntry, hpnicfSyslogObject=hpnicfSyslogObject, hpnicfSyslogChannelTable=hpnicfSyslogChannelTable, hpnicfLogbufContIndex=hpnicfLogbufContIndex, hpnicfSyslogTrapEntry=hpnicfSyslogTrapEntry, hpnicfSyslogLoghostEntry=hpnicfSyslogLoghostEntry, hpnicfSyslog=hpnicfSyslog, hpnicfSyslogMaxLogbufferSize=hpnicfSyslogMaxLogbufferSize)
