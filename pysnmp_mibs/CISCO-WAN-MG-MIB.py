...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-MG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:34:06 2025
...
_MgcDnsResolution_Type.__name__ = "TruthValue"
...
_MgEndpointRepetition_Type.__name__ = "Unsigned32"
...
mgMIBCompliance.setObjects(
      *(("CISCO-WAN-MG-MIB", "mediaGatewayGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayControllerGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayEndpointGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayLineGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayControllerResolutionGroup"))
)
if mibBuilder.loadTexts:
...
mgMIBCompliance1.setObjects(
      *(("CISCO-WAN-MG-MIB", "mediaGatewayGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayControllerGroup1"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayEndpointGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayLineGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayDomainNameGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayControllerResolutionGroup1"))
)
if mibBuilder.loadTexts:
...
mgMIBCompliance2.setObjects(
      *(("CISCO-WAN-MG-MIB", "mediaGatewayGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayControllerGroup2"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayEndpointGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayLineGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayDomainNameGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayControllerResolutionGroup1"))
...
mgMIBCompliance3.setObjects(
      *(("CISCO-WAN-MG-MIB", "mediaGatewayGroup"),
        ...
        ("CISCO-WAN-MG-MIB", "mediaGatewayDomainNameGroup"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayControllerResolutionGroup1"),
        ("CISCO-WAN-MG-MIB", "mediaGatewayEndptRepetitionGroup"))
)
if mibBuilder.loadTexts:
