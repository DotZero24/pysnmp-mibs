...
mibBuilder.exportSymbols("CISCO-WAN-MG-MIB", mgSupportedProtocolEntry=mgSupportedProtocolEntry, channelAssignment=channelAssignment, mediaGatewayLineGroup=mediaGatewayLineGroup, mgDomainNameEntry=mgDomainNameEntry, mgcNumber=mgcNumber, mgEndpointNumber=mgEndpointNumber, mgEndpointTable=mgEndpointTable, mgcResolutionEntry=mgcResolutionEntry, mgcEntry=mgcEntry, mgMIBConformance=mgMIBConformance, ciscoWanMgMIB=ciscoWanMgMIB, mgcName=mgcName, lineAssignmentTable=lineAssignmentTable, mgMIBCompliances=mgMIBCompliances, mgcResolutionName=mgcResolutionName, mgEndpointRowStatus=mgEndpointRowStatus, mediaGatewayEndpoint=mediaGatewayEndpoint, mediaGatewayController=mediaGatewayController, maxConcurrentMgcs=maxConcurrentMgcs, mgcResolutionRowStatus=mgcResolutionRowStatus, PYSNMP_MODULE_ID=ciscoWanMgMIB, mediaGatewayControllerResolutionGroup1=mediaGatewayControllerResolutionGroup1, lineAssignmentEntry=lineAssignmentEntry, mediaGatewayLine=mediaGatewayLine, mgAdministrativeStateControl=mgAdministrativeStateControl, mgDomainNameTable=mgDomainNameTable, mgcAssociationStateControl=mgcAssociationStateControl, mgMIBCompliance1=mgMIBCompliance1, mgcResolutionIndex=mgcResolutionIndex, mgMIBCompliance2=mgMIBCompliance2, mgcTable=mgcTable, mgcProtocolRowStatus=mgcProtocolRowStatus, mediaGatewayControllerResolutionGroup=mediaGatewayControllerResolutionGroup, mgEndpointName=mgEndpointName, mgcAssociationState=mgcAssociationState, mgcResolutionTable=mgcResolutionTable, lineNumber=lineNumber, mgEndpointExtTable=mgEndpointExtTable, mgDomainNameRowStatus=mgDomainNameRowStatus, mgcProtocolTable=mgcProtocolTable, mgShutdownGraceTime=mgShutdownGraceTime, mgcResolutionPreference=mgcResolutionPreference, mgcDnsResolution=mgcDnsResolution, mgcRowStatus=mgcRowStatus, mgEndpointExtEntry=mgEndpointExtEntry, mgEndpointEntry=mgEndpointEntry, mgEndpointChannelMap=mgEndpointChannelMap, mgEndpointState=mgEndpointState, mgMIBCompliance3=mgMIBCompliance3, mgProtocolNumber=mgProtocolNumber, mgMIBGroups=mgMIBGroups, mgDomainNameIndex=mgDomainNameIndex, mediaGateway=mediaGateway, mgcResolutionIpAddress=mgcResolutionIpAddress, mgcProtocolEntry=mgcProtocolEntry, lineName=lineName, mediaGatewayControllerGroup=mediaGatewayControllerGroup, mediaGatewayEndptRepetitionGroup=mediaGatewayEndptRepetitionGroup, mgcUnassociationPolicy=mgcUnassociationPolicy, mediaGatewayControllerResolution=mediaGatewayControllerResolution, mediaGatewayEndpointGroup=mediaGatewayEndpointGroup, mediaGatewayDomainNameGroup=mediaGatewayDomainNameGroup, mgDomainName=mgDomainName, mgName=mgName, mgEndpointLineNumber=mgEndpointLineNumber, mgcResolutionCommState=mgcResolutionCommState, mgEndpointCreationPolicy=mgEndpointCreationPolicy, mgEndpointSpeed=mgEndpointSpeed, ciscoWanMgMIBObjects=ciscoWanMgMIBObjects, mediaGatewayControllerGroup1=mediaGatewayControllerGroup1, mgcCommLossUnassociationTimeout=mgcCommLossUnassociationTimeout, mgcDnsResolutionFlag=mgcDnsResolutionFlag, mediaGatewayControllerGroup2=mediaGatewayControllerGroup2, mediaGatewayDomainName=mediaGatewayDomainName, mediaGatewayGroup=mediaGatewayGroup, mgProtocolName=mgProtocolName, mgSupportedProtocolTable=mgSupportedProtocolTable, mgAdministrativeState=mgAdministrativeState, mgEndpointRepetition=mgEndpointRepetition, mgDnsResolutionType=mgDnsResolutionType, mgMIBCompliance=mgMIBCompliance)
