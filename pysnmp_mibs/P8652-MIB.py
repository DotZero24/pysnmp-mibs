# SNMP MIB module (P8652-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/P8652-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:16:15 2025
...
_P8652_ObjectIdentity = ObjectIdentity
p8652 = _P8652_ObjectIdentity(
...
class _Ch3LimHi_Type(Integer32):
    """Custom type ch3LimHi based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Ch3LimHi_Type.__name__ = "Integer32"
...
class _Ch3LimLo_Type(Integer32):
    """Custom type ch3LimLo based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Ch3LimLo_Type.__name__ = "Integer32"
...
class _Ch3LimHyst_Type(Integer32):
    """Custom type ch3LimHyst based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Ch3LimHyst_Type.__name__ = "Integer32"
...
class _Ch3LimDelay_Type(Integer32):
    """Custom type ch3LimDelay based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65534),
    )
...
_Ch3LimDelay_Type.__name__ = "Integer32"
_Ch3LimDelay_Object = MibScalar
ch3LimDelay = _Ch3LimDelay_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 3, 8),
    _Ch3LimDelay_Type()
)
ch3LimDelay.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch3LimDelay.setStatus("mandatory")


class _Ch3Unit_Type(DisplayString):
    """Custom type ch3Unit based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Ch3Unit_Type.__name__ = "DisplayString"
_Ch3Unit_Object = MibScalar
ch3Unit = _Ch3Unit_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 3, 9),
    _Ch3Unit_Type()
)
ch3Unit.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch3Unit.setStatus("mandatory")


class _Ch3AlarmStr_Type(DisplayString):
    """Custom type ch3AlarmStr based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Ch3AlarmStr_Type.__name__ = "DisplayString"
_Ch3AlarmStr_Object = MibScalar
ch3AlarmStr = _Ch3AlarmStr_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 3, 10),
    _Ch3AlarmStr_Type()
)
ch3AlarmStr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch3AlarmStr.setStatus("mandatory")


class _Ch3Min_Type(DisplayString):
    """Custom type ch3Min based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Ch3Min_Type.__name__ = "DisplayString"
_Ch3Min_Object = MibScalar
ch3Min = _Ch3Min_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 3, 11),
    _Ch3Min_Type()
)
ch3Min.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch3Min.setStatus("mandatory")


class _Ch3Max_Type(DisplayString):
    """Custom type ch3Max based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Ch3Max_Type.__name__ = "DisplayString"
_Ch3Max_Object = MibScalar
ch3Max = _Ch3Max_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 3, 12),
    _Ch3Max_Type()
)
ch3Max.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch3Max.setStatus("mandatory")
...
class _Ch4LimHi_Type(Integer32):
    """Custom type ch4LimHi based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Ch4LimHi_Type.__name__ = "Integer32"
...
class _Ch4LimLo_Type(Integer32):
    """Custom type ch4LimLo based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Ch4LimLo_Type.__name__ = "Integer32"
...
class _Ch4LimHyst_Type(Integer32):
    """Custom type ch4LimHyst based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Ch4LimHyst_Type.__name__ = "Integer32"
...
class _Ch4LimDelay_Type(Integer32):
    """Custom type ch4LimDelay based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65534),
    )
...
_Ch4LimDelay_Type.__name__ = "Integer32"
_Ch4LimDelay_Object = MibScalar
ch4LimDelay = _Ch4LimDelay_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 4, 8),
    _Ch4LimDelay_Type()
)
ch4LimDelay.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch4LimDelay.setStatus("mandatory")


class _Ch4Unit_Type(DisplayString):
    """Custom type ch4Unit based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Ch4Unit_Type.__name__ = "DisplayString"
_Ch4Unit_Object = MibScalar
ch4Unit = _Ch4Unit_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 4, 9),
    _Ch4Unit_Type()
)
ch4Unit.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch4Unit.setStatus("mandatory")


class _Ch4AlarmStr_Type(DisplayString):
    """Custom type ch4AlarmStr based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Ch4AlarmStr_Type.__name__ = "DisplayString"
_Ch4AlarmStr_Object = MibScalar
ch4AlarmStr = _Ch4AlarmStr_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 4, 10),
    _Ch4AlarmStr_Type()
)
ch4AlarmStr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch4AlarmStr.setStatus("mandatory")


class _Ch4Min_Type(DisplayString):
    """Custom type ch4Min based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Ch4Min_Type.__name__ = "DisplayString"
_Ch4Min_Object = MibScalar
ch4Min = _Ch4Min_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 4, 11),
    _Ch4Min_Type()
)
ch4Min.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch4Min.setStatus("mandatory")


class _Ch4Max_Type(DisplayString):
    """Custom type ch4Max based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Ch4Max_Type.__name__ = "DisplayString"
_Ch4Max_Object = MibScalar
ch4Max = _Ch4Max_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 4, 12),
    _Ch4Max_Type()
)
ch4Max.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch4Max.setStatus("mandatory")
_Bin1_ObjectIdentity = ObjectIdentity
bin1 = _Bin1_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 6)
)


class _Bin1Name_Type(DisplayString):
    """Custom type bin1Name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_Bin1Name_Type.__name__ = "DisplayString"
_Bin1Name_Object = MibScalar
bin1Name = _Bin1Name_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 6, 1),
    _Bin1Name_Type()
)
bin1Name.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin1Name.setStatus("mandatory")


class _Bin1Val_Type(DisplayString):
    """Custom type bin1Val based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Bin1Val_Type.__name__ = "DisplayString"
_Bin1Val_Object = MibScalar
bin1Val = _Bin1Val_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 6, 2),
    _Bin1Val_Type()
)
bin1Val.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin1Val.setStatus("mandatory")


class _Bin1IntVal_Type(Integer32):
    """Custom type bin1IntVal based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Bin1IntVal_Type.__name__ = "Integer32"
_Bin1IntVal_Object = MibScalar
bin1IntVal = _Bin1IntVal_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 6, 3),
    _Bin1IntVal_Type()
)
bin1IntVal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin1IntVal.setStatus("mandatory")


class _Bin1AlarmStr_Type(DisplayString):
    """Custom type bin1AlarmStr based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Bin1AlarmStr_Type.__name__ = "DisplayString"
_Bin1AlarmStr_Object = MibScalar
bin1AlarmStr = _Bin1AlarmStr_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 6, 4),
    _Bin1AlarmStr_Type()
)
bin1AlarmStr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin1AlarmStr.setStatus("mandatory")


class _Bin1Alarm_Type(Integer32):
    """Custom type bin1Alarm based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Bin1Alarm_Type.__name__ = "Integer32"
_Bin1Alarm_Object = MibScalar
bin1Alarm = _Bin1Alarm_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 6, 5),
    _Bin1Alarm_Type()
)
...
bin2 = _Bin2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 7)
)


class _Bin2Name_Type(DisplayString):
    """Custom type bin2Name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_Bin2Name_Type.__name__ = "DisplayString"
_Bin2Name_Object = MibScalar
bin2Name = _Bin2Name_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 7, 1),
    _Bin2Name_Type()
)
bin2Name.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin2Name.setStatus("mandatory")


class _Bin2Val_Type(DisplayString):
    """Custom type bin2Val based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Bin2Val_Type.__name__ = "DisplayString"
_Bin2Val_Object = MibScalar
bin2Val = _Bin2Val_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 7, 2),
    _Bin2Val_Type()
)
bin2Val.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin2Val.setStatus("mandatory")


class _Bin2IntVal_Type(Integer32):
    """Custom type bin2IntVal based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Bin2IntVal_Type.__name__ = "Integer32"
_Bin2IntVal_Object = MibScalar
bin2IntVal = _Bin2IntVal_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 7, 3),
    _Bin2IntVal_Type()
)
bin2IntVal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin2IntVal.setStatus("mandatory")


class _Bin2AlarmStr_Type(DisplayString):
    """Custom type bin2AlarmStr based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Bin2AlarmStr_Type.__name__ = "DisplayString"
_Bin2AlarmStr_Object = MibScalar
bin2AlarmStr = _Bin2AlarmStr_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 7, 4),
    _Bin2AlarmStr_Type()
)
bin2AlarmStr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin2AlarmStr.setStatus("mandatory")


class _Bin2Alarm_Type(Integer32):
    """Custom type bin2Alarm based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Bin2Alarm_Type.__name__ = "Integer32"
_Bin2Alarm_Object = MibScalar
bin2Alarm = _Bin2Alarm_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 7, 5),
    _Bin2Alarm_Type()
)
...
bin3 = _Bin3_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 8)
)


class _Bin3Name_Type(DisplayString):
    """Custom type bin3Name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_Bin3Name_Type.__name__ = "DisplayString"
_Bin3Name_Object = MibScalar
bin3Name = _Bin3Name_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 8, 1),
    _Bin3Name_Type()
)
bin3Name.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin3Name.setStatus("mandatory")


class _Bin3Val_Type(DisplayString):
    """Custom type bin3Val based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Bin3Val_Type.__name__ = "DisplayString"
_Bin3Val_Object = MibScalar
bin3Val = _Bin3Val_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 8, 2),
    _Bin3Val_Type()
)
bin3Val.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin3Val.setStatus("mandatory")


class _Bin3IntVal_Type(Integer32):
    """Custom type bin3IntVal based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Bin3IntVal_Type.__name__ = "Integer32"
_Bin3IntVal_Object = MibScalar
bin3IntVal = _Bin3IntVal_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 8, 3),
    _Bin3IntVal_Type()
)
bin3IntVal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin3IntVal.setStatus("mandatory")


class _Bin3AlarmStr_Type(DisplayString):
    """Custom type bin3AlarmStr based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 8),
    )
...
_Bin3AlarmStr_Type.__name__ = "DisplayString"
_Bin3AlarmStr_Object = MibScalar
bin3AlarmStr = _Bin3AlarmStr_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 8, 4),
    _Bin3AlarmStr_Type()
)
bin3AlarmStr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    bin3AlarmStr.setStatus("mandatory")


class _Bin3Alarm_Type(Integer32):
    """Custom type bin3Alarm based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1),
    )
...
_Bin3Alarm_Type.__name__ = "Integer32"
_Bin3Alarm_Object = MibScalar
bin3Alarm = _Bin3Alarm_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 2, 8, 5),
    _Bin3Alarm_Type()
)
...
class _Ch3value_Type(Integer32):
    """Custom type ch3value based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Ch3value_Type.__name__ = "Integer32"
_Ch3value_Object = MibTableColumn
ch3value = _Ch3value_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 4, 1, 1, 3),
    _Ch3value_Type()
)
ch3value.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch3value.setStatus("mandatory")


class _Ch4value_Type(Integer32):
    """Custom type ch4value based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-550, 1250),
    )
...
_Ch4value_Type.__name__ = "Integer32"
_Ch4value_Object = MibTableColumn
ch4value = _Ch4value_Object(
    (1, 3, 6, 1, 4, 1, 22626, 1, 5, 4, 1, 1, 4),
    _Ch4value_Type()
)
ch4value.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ch4value.setStatus("mandatory")
...
trapTest.setObjects(
      *(("P8652-MIB", "sensorName"),
        ("P8652-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
...
trapCh3HighAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 22626, 0, 13)
)
trapCh3HighAlarm.setObjects(
      *(("P8652-MIB", "ch3Name"),
        ("P8652-MIB", "ch3Val"),
        ("P8652-MIB", "ch3Alarm"),
        ("P8652-MIB", "sensorName"),
...
if mibBuilder.loadTexts:
    trapCh3HighAlarm.setStatus(
        ""
    )

trapCh4HighAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 22626, 0, 14)
)
trapCh4HighAlarm.setObjects(
      *(("P8652-MIB", "ch4Name"),
        ("P8652-MIB", "ch4Val"),
        ("P8652-MIB", "ch4Alarm"),
        ("P8652-MIB", "sensorName"),
...
trapCh3LowAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 22626, 0, 23)
)
trapCh3LowAlarm.setObjects(
      *(("P8652-MIB", "ch3Name"),
        ("P8652-MIB", "ch3Val"),
        ("P8652-MIB", "ch3Alarm"),
        ("P8652-MIB", "sensorName"),
...
if mibBuilder.loadTexts:
    trapCh3LowAlarm.setStatus(
        ""
    )

trapCh4LowAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 22626, 0, 24)
)
trapCh4LowAlarm.setObjects(
      *(("P8652-MIB", "ch4Name"),
        ("P8652-MIB", "ch4Val"),
        ("P8652-MIB", "ch4Alarm"),
        ("P8652-MIB", "sensorName"),
...
trapCh3ClrAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 22626, 0, 33)
)
trapCh3ClrAlarm.setObjects(
      *(("P8652-MIB", "ch3Name"),
        ("P8652-MIB", "ch3Val"),
        ("P8652-MIB", "ch3Alarm"),
        ("P8652-MIB", "sensorName"),
...
if mibBuilder.loadTexts:
    trapCh3ClrAlarm.setStatus(
        ""
    )

trapCh4ClrAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 22626, 0, 34)
)
trapCh4ClrAlarm.setObjects(
      *(("P8652-MIB", "ch4Name"),
        ("P8652-MIB", "ch4Val"),
        ("P8652-MIB", "ch4Alarm"),
        ("P8652-MIB", "sensorName"),
...
trapCh3Error = NotificationType(
    (1, 3, 6, 1, 4, 1, 22626, 0, 43)
)
trapCh3Error.setObjects(
      *(("P8652-MIB", "ch3Name"),
        ("P8652-MIB", "ch3Val"),
        ("P8652-MIB", "ch3Alarm"),
        ("P8652-MIB", "sensorName"),
...
if mibBuilder.loadTexts:
    trapCh3Error.setStatus(
        ""
    )

trapCh4Error = NotificationType(
    (1, 3, 6, 1, 4, 1, 22626, 0, 44)
)
trapCh4Error.setObjects(
      *(("P8652-MIB", "ch4Name"),
        ("P8652-MIB", "ch4Val"),
        ("P8652-MIB", "ch4Alarm"),
        ("P8652-MIB", "sensorName"),
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "trapCh3HighAlarm": trapCh3HighAlarm,
       "trapCh4HighAlarm": trapCh4HighAlarm,
       "trapCh1LowAlarm": trapCh1LowAlarm,
       "trapCh2LowAlarm": trapCh2LowAlarm,
       "trapCh3LowAlarm": trapCh3LowAlarm,
       "trapCh4LowAlarm": trapCh4LowAlarm,
       "trapCh1ClrAlarm": trapCh1ClrAlarm,
       "trapCh2ClrAlarm": trapCh2ClrAlarm,
       "trapCh3ClrAlarm": trapCh3ClrAlarm,
       "trapCh4ClrAlarm": trapCh4ClrAlarm,
       "trapCh1Error": trapCh1Error,
       "trapCh2Error": trapCh2Error,
       "trapCh3Error": trapCh3Error,
       "trapCh4Error": trapCh4Error,
       ...
       "ch3LimDelay": ch3LimDelay,
       "ch3Unit": ch3Unit,
       "ch3AlarmStr": ch3AlarmStr,
       "ch3Min": ch3Min,
       "ch3Max": ch3Max,
       "channel4": channel4,
       "ch4Name": ch4Name,
       ...
       "ch4LimDelay": ch4LimDelay,
       "ch4Unit": ch4Unit,
       "ch4AlarmStr": ch4AlarmStr,
       "ch4Min": ch4Min,
       "ch4Max": ch4Max,
       "bin1": bin1,
       "bin1Name": bin1Name,
       "bin1Val": bin1Val,
       "bin1IntVal": bin1IntVal,
       "bin1AlarmStr": bin1AlarmStr,
       "bin1Alarm": bin1Alarm,
       "bin2": bin2,
       "bin2Name": bin2Name,
       "bin2Val": bin2Val,
       "bin2IntVal": bin2IntVal,
       "bin2AlarmStr": bin2AlarmStr,
       "bin2Alarm": bin2Alarm,
       "bin3": bin3,
       "bin3Name": bin3Name,
       "bin3Val": bin3Val,
       "bin3IntVal": bin3IntVal,
       "bin3AlarmStr": bin3AlarmStr,
       "bin3Alarm": bin3Alarm,
       "traps": traps,
