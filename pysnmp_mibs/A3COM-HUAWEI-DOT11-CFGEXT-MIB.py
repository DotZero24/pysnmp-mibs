...
_D='A3COM-HUAWEI-DOT11-CFGEXT-MIB'
_C='Integer32'
_B='read-write'
_A='current'
...
if mibBuilder.loadTexts:h3cDot11CFGEXT.setRevisions(('2010-06-02 14:00','2007-04-25 20:00'))
_H3cDot11LoadBalance_ObjectIdentity=ObjectIdentity
h3cDot11LoadBalance=_H3cDot11LoadBalance_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,6,1))
_H3cDot11LBGlobalGroup_ObjectIdentity=ObjectIdentity
h3cDot11LBGlobalGroup=_H3cDot11LBGlobalGroup_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,75,6,1,1))
_H3cDot11LoadBalanceTrafficEnable_Type=TruthValue
_H3cDot11LoadBalanceTrafficEnable_Object=MibScalar
h3cDot11LoadBalanceTrafficEnable=_H3cDot11LoadBalanceTrafficEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,1,1),_H3cDot11LoadBalanceTrafficEnable_Type())
...
h3cDot11LoadBalanceTrafficThres=_H3cDot11LoadBalanceTrafficThres_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,1,2),_H3cDot11LoadBalanceTrafficThres_Type())
...
h3cDot11LoadBalanceSessionEnable=_H3cDot11LoadBalanceSessionEnable_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,1,3),_H3cDot11LoadBalanceSessionEnable_Type())
...
h3cDot11LoadBalanceSessionThres=_H3cDot11LoadBalanceSessionThres_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,1,4),_H3cDot11LoadBalanceSessionThres_Type())
...
h3cDot11LoadBalanceTrafficGap=_H3cDot11LoadBalanceTrafficGap_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,1,5),_H3cDot11LoadBalanceTrafficGap_Type())
...
h3cDot11LoadBalanceSessionGap=_H3cDot11LoadBalanceSessionGap_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,1,6),_H3cDot11LoadBalanceSessionGap_Type())
...
h3cDot11LBTrafficThresKbps=_H3cDot11LBTrafficThresKbps_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,1,7),_H3cDot11LBTrafficThresKbps_Type())
...
h3cDot11LBTrafficGapKbps=_H3cDot11LBTrafficGapKbps_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,1,8),_H3cDot11LBTrafficGapKbps_Type())
...
h3cDot11LBRadioGroupTable=_H3cDot11LBRadioGroupTable_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,2))
if mibBuilder.loadTexts:h3cDot11LBRadioGroupTable.setStatus(_A)
_H3cDot11LBRadioGroupEntry_Object=MibTableRow
h3cDot11LBRadioGroupEntry=_H3cDot11LBRadioGroupEntry_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,2,1))
...
h3cDot11LBRadioGroupId=_H3cDot11LBRadioGroupId_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,2,1,1),_H3cDot11LBRadioGroupId_Type())
...
h3cDot11LBRadioGroupDesc=_H3cDot11LBRadioGroupDesc_Object((1,3,6,1,4,1,43,45,1,10,2,75,6,1,2,1,2),_H3cDot11LBRadioGroupDesc_Type())
