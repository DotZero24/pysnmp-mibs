...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-APS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:49:28 2025
...
if mibBuilder.loadTexts:
    tApsMcAdvertiseInterval.setUnits("deciseconds")
...
if mibBuilder.loadTexts:
    tApsMcHoldTime.setUnits("deciseconds")
...
if mibBuilder.loadTexts:
    tApsLineSFHoldTime.setUnits("deciseconds")
...
if mibBuilder.loadTexts:
    tApsLineSDHoldTime.setUnits("deciseconds")
...
tApsMIBCompliance.setObjects(
      *(("TIMETRA-APS-MIB", "tmnxApsSwitchCommand"),
        ("TIMETRA-APS-MIB", "tmnxApsChanStatus"),
        ("TIMETRA-APS-MIB", "tmnxApsNotifications"))
)
if mibBuilder.loadTexts:
...
tApsMIBComplianceV4v0.setObjects(
      *(("TIMETRA-APS-MIB", "tmnxApsSwitchCommand"),
        ("TIMETRA-APS-MIB", "tmnxApsChanStatus"),
        ("TIMETRA-APS-MIB", "tmnxApsMcGroup"),
        ("TIMETRA-APS-MIB", "tmnxApsNotificationsV4v0"))
)
if mibBuilder.loadTexts:
...
tApsMIBComplianceV7v0.setObjects(
      *(("TIMETRA-APS-MIB", "tmnxApsSwitchCommand"),
        ("TIMETRA-APS-MIB", "tmnxApsChanStatus"),
        ("TIMETRA-APS-MIB", "tmnxApsMcGroup"),
        ("TIMETRA-APS-MIB", "tmnxApsNotificationsV4v0"),
        ("TIMETRA-APS-MIB", "tmnxApsConfigGroup"))
)
if mibBuilder.loadTexts:
...
tApsMIBComplianceV8v0.setObjects(
      *(("TIMETRA-APS-MIB", "tmnxApsSwitchCommand"),
        ("TIMETRA-APS-MIB", "tmnxApsChanStatus"),
        ("TIMETRA-APS-MIB", "tmnxApsMcGroup"),
        ("TIMETRA-APS-MIB", "tmnxApsNotificationsV4v0"),
        ("TIMETRA-APS-MIB", "tmnxApsConfigGroup"),
        ("TIMETRA-APS-MIB", "tmnxApsConfigV8v0Group"))
)
if mibBuilder.loadTexts:
...
tApsMIBComplianceV9v0.setObjects(
      *(("TIMETRA-APS-MIB", "tmnxApsSwitchCommand"),
        ("TIMETRA-APS-MIB", "tmnxApsChanStatus"),
        ("TIMETRA-APS-MIB", "tmnxApsMcGroup"),
        ("TIMETRA-APS-MIB", "tmnxApsNotificationsV4v0"),
        ("TIMETRA-APS-MIB", "tmnxApsConfigGroup"),
        ("TIMETRA-APS-MIB", "tmnxApsConfigV8v0Group"),
        ("TIMETRA-APS-MIB", "tmnxApsGroupCommandV9v0Group"),
