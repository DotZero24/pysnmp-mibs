# SNMP MIB module (Dell-Physicaldescription-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-Physicaldescription-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:07:29 2025
...
rlPhdModuleEntry.setIndexNames(
    (0, "Dell-Physicaldescription-MIB", "rlPhdModuleStackUnit"),
    (0, "Dell-Physicaldescription-MIB", "rlPhdModuleIndex"),
)
if mibBuilder.loadTexts:
...
rlPhdPortsEntry.setIndexNames(
    (0, "Dell-Physicaldescription-MIB", "rlPhdPortsIfIndex"),
)
if mibBuilder.loadTexts:
...
rlPhdStackEntry.setIndexNames(
    (0, "Dell-Physicaldescription-MIB", "rlPhdStackUnit"),
)
if mibBuilder.loadTexts:
...
rlPhdStackOrderEntry.setIndexNames(
    (0, "Dell-Physicaldescription-MIB", "rlPhdStackOrderCurrentUnitPosition"),
)
if mibBuilder.loadTexts:
...
rlPhdUnitGenParamEntry.setIndexNames(
    (0, "Dell-Physicaldescription-MIB", "rlPhdUnitGenParamStackUnit"),
)
if mibBuilder.loadTexts:
...
rlPhdUnitEnvParamEntry.setIndexNames(
    (0, "Dell-Physicaldescription-MIB", "rlPhdUnitEnvParamStackUnit"),
)
if mibBuilder.loadTexts:
...
rlPhdPoeEntry.setIndexNames(
    (0, "Dell-Physicaldescription-MIB", "rlPhdPoeStackUnit"),
)
if mibBuilder.loadTexts:
...
rlCascadeAfterResetEntry.setIndexNames(
    (0, "Dell-Physicaldescription-MIB", "rlCascadeIfIndexAfterReset"),
)
if mibBuilder.loadTexts:
