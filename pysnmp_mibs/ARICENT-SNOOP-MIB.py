# SNMP MIB module (ARICENT-SNOOP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-SNOOP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:44:56 2025
...
fsSnoopInstanceGlobalEntry = _FsSnoopInstanceGlobalEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 2, 1, 1)
)
fsSnoopInstanceGlobalEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopInstanceGlobalInstId"),
)
if mibBuilder.loadTexts:
...
fsSnoopInstanceConfigEntry = _FsSnoopInstanceConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 2, 2, 1)
)
fsSnoopInstanceConfigEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopInstanceConfigInstId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopInetAddressType"),
)
if mibBuilder.loadTexts:
...
fsSnoopVlanMcastMacFwdEntry = _FsSnoopVlanMcastMacFwdEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 1, 1)
)
fsSnoopVlanMcastMacFwdEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastMacFwdInstId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastMacFwdVlanId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastMacFwdInetAddressType"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastMacFwdGroupAddress"),
)
if mibBuilder.loadTexts:
...
fsSnoopVlanMcastIpFwdEntry = _FsSnoopVlanMcastIpFwdEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 2, 1)
)
fsSnoopVlanMcastIpFwdEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastIpFwdInstId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastIpFwdVlanId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastIpFwdAddressType"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastIpFwdSourceAddress"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastIpFwdGroupAddress"),
)
if mibBuilder.loadTexts:
...
fsSnoopVlanRouterEntry = _FsSnoopVlanRouterEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 3, 1)
)
fsSnoopVlanRouterEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanRouterInstId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanRouterVlanId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanRouterInetAddressType"),
)
if mibBuilder.loadTexts:
...
fsSnoopVlanFilterEntry = _FsSnoopVlanFilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 4, 1)
)
fsSnoopVlanFilterEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanFilterInstId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanFilterVlanId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanFilterInetAddressType"),
)
if mibBuilder.loadTexts:
...
fsSnoopVlanQuerierIpAddress = _FsSnoopVlanQuerierIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 4, 1, 16),
    _FsSnoopVlanQuerierIpAddress_Type()
)
fsSnoopVlanQuerierIpAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsSnoopVlanQuerierIpAddress.setStatus("current")


class _FsSnoopVlanQuerierIpFlag_Type(Integer32):
    """Custom type fsSnoopVlanQuerierIpFlag based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_FsSnoopVlanQuerierIpFlag_Type.__name__ = "Integer32"
_FsSnoopVlanQuerierIpFlag_Object = MibTableColumn
fsSnoopVlanQuerierIpFlag = _FsSnoopVlanQuerierIpFlag_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 4, 1, 17),
    _FsSnoopVlanQuerierIpFlag_Type()
)
fsSnoopVlanQuerierIpFlag.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsSnoopVlanQuerierIpFlag.setStatus("current")
_FsSnoopVlanElectedQuerier_Type = IpAddress
_FsSnoopVlanElectedQuerier_Object = MibTableColumn
fsSnoopVlanElectedQuerier = _FsSnoopVlanElectedQuerier_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 4, 1, 18),
    _FsSnoopVlanElectedQuerier_Type()
)
fsSnoopVlanElectedQuerier.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsSnoopVlanElectedQuerier.setStatus("current")
_FsSnoopVlanMcastGroupTable_Object = MibTable
fsSnoopVlanMcastGroupTable = _FsSnoopVlanMcastGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 5)
)
if mibBuilder.loadTexts:
...
fsSnoopVlanMcastGroupEntry = _FsSnoopVlanMcastGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 5, 1)
)
fsSnoopVlanMcastGroupEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastGroupInstanceId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastGroupOuterVlanId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastGroupInetAddressType"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastGroupAddress"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastGroupInnerVlanId"),
)
if mibBuilder.loadTexts:
...
fsSnoopVlanMcastReceiverEntry.setIndexNames(
    ...
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastGroupAddress"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastGroupInnerVlanId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastReceiverPortIndex"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastReceiverHostAddress"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanMcastReceiverSourceAddress"),
)
if mibBuilder.loadTexts:
...
fsSnoopVlanIpFwdEntry.setIndexNames(
    ...
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanIpFwdInetAddressType"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanIpFwdSourceAddress"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanIpFwdGroupAddress"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanIpFwdInnerVlanId"),
)
if mibBuilder.loadTexts:
...
fsSnoopVlanStaticMcastGrpEntry = _FsSnoopVlanStaticMcastGrpEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 3, 9, 1)
)
fsSnoopVlanStaticMcastGrpEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanStaticMcastGrpInstId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopVlanStaticMcastGrpVlanId"),
...
fsSnoopEnhPortEntry = _FsSnoopEnhPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 5, 2, 1)
)
fsSnoopEnhPortEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopEnhPortIndex"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopEnhPortInnerVlanId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopEnhPortInetAddressType"),
)
if mibBuilder.loadTexts:
...
fsSnoopRtrPortEntry = _FsSnoopRtrPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 105, 5, 3, 1)
)
fsSnoopRtrPortEntry.setIndexNames(
    (0, "ARICENT-SNOOP-MIB", "fsSnoopRtrPortIndex"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopRtrPortVlanId"),
    (0, "ARICENT-SNOOP-MIB", "fsSnoopRtrPortInetAddressType"),
)
if mibBuilder.loadTexts:
...
fsSnoopHwFailureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 105, 7, 0, 1)
)
fsSnoopHwFailureTrap.setObjects(
    ("ARICENT-SNOOP-MIB", "fsSnoopTrapHwErrType")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"InnerVlanIndex": InnerVlanIndex,
       ...
       "fsSnoopDebugOption": fsSnoopDebugOption,
       ...
       "fsSnoopVlanQuerierIpAddress": fsSnoopVlanQuerierIpAddress,
       "fsSnoopVlanQuerierIpFlag": fsSnoopVlanQuerierIpFlag,
       "fsSnoopVlanElectedQuerier": fsSnoopVlanElectedQuerier,
