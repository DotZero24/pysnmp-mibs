...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:08:31 2025
...
mibBuilder.exportSymbols("HP-SWITCH-IMAGE-MIB", hpSwitchFlashImageVersion=hpSwitchFlashImageVersion, hpSwitchMgmtModuleGroup=hpSwitchMgmtModuleGroup, hpSwitchMgmtModuleBootImage=hpSwitchMgmtModuleBootImage, hpSwitchFlashImageTable=hpSwitchFlashImageTable, hpSwitchBuildGroup=hpSwitchBuildGroup, hpSwitchMgmtModuleBuildOptions=hpSwitchMgmtModuleBuildOptions, hpSwitchMgmtModuleID=hpSwitchMgmtModuleID, hpSwitchMgmtModuleBuildNumber=hpSwitchMgmtModuleBuildNumber, hpSwitchMgmtModuleVersionEntry=hpSwitchMgmtModuleVersionEntry, hpSwitchDefaultBoot=hpSwitchDefaultBoot, hpSwitchImageConformance=hpSwitchImageConformance, hpSwitchMgmtModuleVersion=hpSwitchMgmtModuleVersion, hpSwitchMgmtModuleDate=hpSwitchMgmtModuleDate, hpSwitchImage=hpSwitchImage, hpSwitchFlashImageSize=hpSwitchFlashImageSize, hpSwitchFlashImagesGroup=hpSwitchFlashImagesGroup, hpSwitchFlashImageType=hpSwitchFlashImageType, hpSwitchMgmtModuleVersionTable=hpSwitchMgmtModuleVersionTable, hpSwitchImageCompliance=hpSwitchImageCompliance, hpSwitchMgmtModuleDirectory=hpSwitchMgmtModuleDirectory, PYSNMP_MODULE_ID=hpSwitchImage, hpSwitchImageGroups=hpSwitchImageGroups, hpSwitchMgmtModuleWatchDog=hpSwitchMgmtModuleWatchDog, hpSwitchImageObject=hpSwitchImageObject, hpSwitchFlashImageBuildNumber=hpSwitchFlashImageBuildNumber, hpSwitchBootRomVersion=hpSwitchBootRomVersion, hpSwitchFlashImageBuildDate=hpSwitchFlashImageBuildDate, hpSwitchImageCompliances=hpSwitchImageCompliances, hpSwitchFlashImageEntry=hpSwitchFlashImageEntry, hpSwitchMgmtModuleStatus=hpSwitchMgmtModuleStatus)
