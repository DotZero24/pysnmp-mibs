...
# Notes
# -----
# ASN.1 source file://mibs/smartoptics/SL-MAIN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:11:32 2025
...
slmSysMaxExpirationTime = _SlmSysMaxExpirationTime_Object(
    (1, 3, 6, 1, 4, 1, 4515, 1, 3, 1, 52),
    _SlmSysMaxExpirationTime_Type()
)
slmSysMaxExpirationTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    slmSysMaxExpirationTime.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"UserLogin": UserLogin,
       ...
       "slmSysMaxExpirationTime": slmSysMaxExpirationTime,
       "slmAdmin": slmAdmin,
