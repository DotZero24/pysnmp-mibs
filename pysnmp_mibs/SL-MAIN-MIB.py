...
mibBuilder.exportSymbols("SL-MAIN-MIB", AdminAccess=AdminAccess, slmChPassLogin=slmChPassLogin, PYSNMP_MODULE_ID=slMain, slmLicense=slmLicense, slmSysEncryptionCapability=slmSysEncryptionCapability, slmSysSnmpVersion=slmSysSnmpVersion, slmAdminAccess=slmAdminAccess, slmPsuNumber=slmPsuNumber, slmTrapSysLocationChange=slmTrapSysLocationChange, slmSwRevEntry=slmSwRevEntry, slmTrapLogParam6=slmTrapLogParam6, slmTrapDestCommunity=slmTrapDestCommunity, slmSysTrapFormat=slmSysTrapFormat, slmLicenseTable=slmLicenseTable, slmSysMode=slmSysMode, slmRebootDelay=slmRebootDelay, slmAuth=slmAuth, slmSyslogLevel=slmSyslogLevel, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmSysResetPm=slmSysResetPm, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, UserCommunity=UserCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmChPass=slmChPass, slmTrapDestIpAddress=slmTrapDestIpAddress, slmAdminLogin=slmAdminLogin, slmMuxNumber=slmMuxNumber, slmTrapCommunity=slmTrapCommunity, slmChPassTable=slmChPassTable, SoftwareRevision=SoftwareRevision, slmAdminCommunity=slmAdminCommunity, slmAuthCommunity=slmAuthCommunity, slmTopologyEnabled=slmTopologyEnabled, slmLogFile=slmLogFile, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapDestTable=slmTrapDestTable, slmAuthLogin=slmAuthLogin, slmSys=slmSys, slmAdminEntry=slmAdminEntry, UserLogin=UserLogin, slmRstpEnabled=slmRstpEnabled, slmAuthPassword=slmAuthPassword, slmOemType=slmOemType, slmSysLanIpAddr=slmSysLanIpAddr, slmTrapLogName=slmTrapLogName, slmSwRevDate=slmSwRevDate, slmTrapLogId=slmTrapLogId, slmSyslogPort=slmSyslogPort, slmSysActiveSwVersion=slmSysActiveSwVersion, slmSysAdminStatus=slmSysAdminStatus, slmSysName=slmSysName, slmSysSubnetMask=slmSysSubnetMask, slmSysChassisId=slmSysChassisId, slmLicenseExpiration=slmLicenseExpiration, slmEdfaNumber=slmEdfaNumber, slmTrapSysNameChange=slmTrapSysNameChange, slmLicenseEntry=slmLicenseEntry, slmSysCalendarTime=slmSysCalendarTime, slmAdminTable=slmAdminTable, slmSysAlmDeact=slmSysAlmDeact, slmLicenseId=slmLicenseId, slMain=slMain, slmVcatDelay=slmVcatDelay, slmSysMaxExpirationTime=slmSysMaxExpirationTime, slmReadCommunity=slmReadCommunity, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSnmpv3Priv=slmSnmpv3Priv, slmSyslogDestEntry=slmSyslogDestEntry, slmTrapUserLogin=slmTrapUserLogin, slmTrap=slmTrap, slmSnmpv3Password=slmSnmpv3Password, slmSysGatewayAddr=slmSysGatewayAddr, slmConfigSysSignalType=slmConfigSysSignalType, slmAdminPassword=slmAdminPassword, slmSysOperStatus=slmSysOperStatus, slmTrapDestProtVersion=slmTrapDestProtVersion, slmTid=slmTid, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapLogParam3=slmTrapLogParam3, slmSwRevDirectory=slmSwRevDirectory, slmLicenseIndex=slmLicenseIndex, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmTrapLogEntry=slmTrapLogEntry, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestEntry=slmTrapDestEntry, slmSysIpAddr=slmSysIpAddr, slmSysLocation=slmSysLocation, slmSyslogDestTable=slmSyslogDestTable, slmOpticalSwitchExist=slmOpticalSwitchExist, slmSyslogDestAddress=slmSyslogDestAddress, slmPmAvailable=slmPmAvailable, slmLogin=slmLogin, UserPassword=UserPassword, slmTrapDestRowStatus=slmTrapDestRowStatus, slmNetworkMode=slmNetworkMode, slmAuthTable=slmAuthTable, slmTrapDestAddress=slmTrapDestAddress, slmSwRevName=slmSwRevName, slmSwRevStatus=slmSwRevStatus, slmTrapLogParam5=slmTrapLogParam5, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysAlmAct=slmSysAlmAct, slmChPassOldPass=slmChPassOldPass, slmTrapLogParam4=slmTrapLogParam4, slmTrapLogParam1=slmTrapLogParam1, slmTrapPort=slmTrapPort, slmSwRevTable=slmSwRevTable, slmSnmpv3Auth=slmSnmpv3Auth, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmPortsNumber=slmPortsNumber, slmWriteCommunity=slmWriteCommunity, slmTrapLogTable=slmTrapLogTable, slmTrapEnable=slmTrapEnable, slmTrapUserAccess=slmTrapUserAccess, slmAdminRowStatus=slmAdminRowStatus, slm40GConf=slm40GConf, slmSysUplinkRate=slmSysUplinkRate, slmConfigSysUptime=slmConfigSysUptime, slmBoxSize=slmBoxSize, slmAdmin=slmAdmin, slmChPassEntry=slmChPassEntry, slmSysTemperature=slmSysTemperature, slmTrapLogParam2=slmTrapLogParam2, slmAuthEntry=slmAuthEntry, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmChPassNewPass=slmChPassNewPass, slmConfigFile=slmConfigFile)
