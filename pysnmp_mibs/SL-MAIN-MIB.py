...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/smartoptics/SL-MAIN-MIB
...
ModuleIdentity, Counter64, Gauge32, ObjectIdentity, Unsigned32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Counter32, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Gauge32", "ObjectIdentity", "Unsigned32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Counter32", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
if mibBuilder.loadTexts: slMain.setOrganization('SmartOptics AS')
...
slmSysMaxExpirationTime = MibScalar((1, 3, 6, 1, 4, 1, 4515, 1, 3, 1, 52), Integer32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: slmSysMaxExpirationTime.setStatus('current')
...
mibBuilder.exportSymbols("SL-MAIN-MIB", slmAdminEntry=slmAdminEntry, slmSysAdminStatus=slmSysAdminStatus, slmSysTrapFormat=slmSysTrapFormat, slmSyslogDestRowStatus=slmSyslogDestRowStatus, slmSysPmStartOfDay=slmSysPmStartOfDay, slmTrapSysNameChange=slmTrapSysNameChange, slmSysGatewayEffectiveIpAddr=slmSysGatewayEffectiveIpAddr, slmSysActiveSwVersion=slmSysActiveSwVersion, slmRebootDelay=slmRebootDelay, slmTrapDestCommunity=slmTrapDestCommunity, slmSysLanSubnetAddr=slmSysLanSubnetAddr, slmTrapDestProtVersion=slmTrapDestProtVersion, slmSyslogPort=slmSyslogPort, slmSysLanIpAddr=slmSysLanIpAddr, slmVcatDelay=slmVcatDelay, slmLicense=slmLicense, slm40GConf=slm40GConf, slmLicenseIndex=slmLicenseIndex, slmSysMode=slmSysMode, slmPmAvailable=slmPmAvailable, slmConfigSysUptime=slmConfigSysUptime, slmSysEncryptionCapability=slmSysEncryptionCapability, slmTrapDestAddress=slmTrapDestAddress, UserCommunity=UserCommunity, slmSysLanEffectiveSubnetAddr=slmSysLanEffectiveSubnetAddr, slmAuthTable=slmAuthTable, slmSwRevStatus=slmSwRevStatus, slmTrapLogTimeStamp=slmTrapLogTimeStamp, slmTrapLogParam1=slmTrapLogParam1, slmSysEffectiveIpAddr=slmSysEffectiveIpAddr, slmTrapEnable=slmTrapEnable, slmTrapLogTable=slmTrapLogTable, slmSysGatewayAddr=slmSysGatewayAddr, slmSysNetworkPrefix=slmSysNetworkPrefix, slmSysEffectiveSubnetMask=slmSysEffectiveSubnetMask, slmLicenseExpiration=slmLicenseExpiration, slmTrapDestRowStatus=slmTrapDestRowStatus, slmReadCommunity=slmReadCommunity, slmRstpEnabled=slmRstpEnabled, slmTrapLogId=slmTrapLogId, slmSysResetPm=slmSysResetPm, slmChPassTable=slmChPassTable, slmAuth=slmAuth, slmAdminTable=slmAdminTable, SoftwareRevision=SoftwareRevision, slmLogFile=slmLogFile, slmConfigSysSignalType=slmConfigSysSignalType, slmTrapLogParam6=slmTrapLogParam6, slmTrapCommunity=slmTrapCommunity, slmAdminPassword=slmAdminPassword, slmAuthPassword=slmAuthPassword, slmTrapLogParam5=slmTrapLogParam5, slmTrap=slmTrap, slmAuthLogin=slmAuthLogin, slmTrapPort=slmTrapPort, slmBoxSize=slmBoxSize, slmSyslogLevel=slmSyslogLevel, slmAuthCommunity=slmAuthCommunity, slmOemType=slmOemType, PYSNMP_MODULE_ID=slMain, slmPsuNumber=slmPsuNumber, slmSysSubnetMask=slmSysSubnetMask, slmEdfaNumber=slmEdfaNumber, slmSysTemperature=slmSysTemperature, slmChPassNewPass=slmChPassNewPass, UserLogin=UserLogin, slmTrapUserAccess=slmTrapUserAccess, UserPassword=UserPassword, slmSyslogDestTable=slmSyslogDestTable, slmConfigFile=slmConfigFile, slmSysName=slmSysName, slmSysAlmDeact=slmSysAlmDeact, slmTrapLogEntry=slmTrapLogEntry, slmSysLanEffectiveIpAddr=slmSysLanEffectiveIpAddr, slmLicenseEntry=slmLicenseEntry, slmTrapDestTable=slmTrapDestTable, slmTrapLogParam3=slmTrapLogParam3, slmSwRevEntry=slmSwRevEntry, slmSyslogDestAddress=slmSyslogDestAddress, slmSysOperStatus=slmSysOperStatus, slmAdminRowStatus=slmAdminRowStatus, slmSwRevTable=slmSwRevTable, slmSnmpv3Auth=slmSnmpv3Auth, slmSysUplinkRate=slmSysUplinkRate, slmNetworkMode=slmNetworkMode, slmAdmin=slmAdmin, slmSysAlmAct=slmSysAlmAct, slmSys=slmSys, slmOpticalSwitchExist=slmOpticalSwitchExist, slmChPassLogin=slmChPassLogin, slmSysCalendarTime=slmSysCalendarTime, slMain=slMain, slmSwRevDirectory=slmSwRevDirectory, slmTopologyEnabled=slmTopologyEnabled, slmSysMaxExpirationTime=slmSysMaxExpirationTime, slmSwRevDate=slmSwRevDate, slmPortsNumber=slmPortsNumber, slmMuxNumber=slmMuxNumber, slmChPassEntry=slmChPassEntry, slmTid=slmTid, slmSysSnmpVersion=slmSysSnmpVersion, slmTrapUserLogin=slmTrapUserLogin, slmChPass=slmChPass, slmLogin=slmLogin, slmAdminAccess=slmAdminAccess, slmTrapLogParam2=slmTrapLogParam2, slmSysIpAddr=slmSysIpAddr, slmTrapSoftwareStatusChange=slmTrapSoftwareStatusChange, slmSysLocation=slmSysLocation, slmTrapSysLocationChange=slmTrapSysLocationChange, slmLicenseId=slmLicenseId, slmChPassOldPass=slmChPassOldPass, slmTrapDestEntry=slmTrapDestEntry, slmTrapLogParam4=slmTrapLogParam4, AdminAccess=AdminAccess, slmAdminCommunity=slmAdminCommunity, slmSysChassisId=slmSysChassisId, slmSnmpv3Password=slmSnmpv3Password, slmTrapLogName=slmTrapLogName, slmAdminLogin=slmAdminLogin, slmAuthEntry=slmAuthEntry, slmSyslogDestEntry=slmSyslogDestEntry, slmSwRevName=slmSwRevName, slmWriteCommunity=slmWriteCommunity, slmSyslogDestIpAddress=slmSyslogDestIpAddress, slmSnmpv3Priv=slmSnmpv3Priv, slmLicenseTable=slmLicenseTable, slmTrapDestIpAddress=slmTrapDestIpAddress)
