...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-DEVICE-WDS-MIB
...
alvarionDeviceWdsMIBCompliance.setObjects(
      *(("ALVARION-DEVICE-WDS-MIB", "alvarionDeviceWdsInfoMIBGroup"),
        ("ALVARION-DEVICE-WDS-MIB", "alvarionDeviceWdsRadioMIBGroup"),
        ("ALVARION-DEVICE-WDS-MIB", "alvarionDeviceWdsGroupMIBGroup"),
        ("ALVARION-DEVICE-WDS-MIB", "alvarionDeviceWdsLinkMIBGroup"),
