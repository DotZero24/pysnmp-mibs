...
TruthValue, RowPointer, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-AAA-SESSION-MIB", casnNasPort=casnNasPort, casnCallTrackerId=casnCallTrackerId, casnVaiIfIndex=casnVaiIfIndex, casnMIBConformance=casnMIBConformance, casnActiveGroup=casnActiveGroup, casnActiveTableEntries=casnActiveTableEntries, casnMIBComplianceRev1=casnMIBComplianceRev1, casnActive=casnActive, casnSessionId=casnSessionId, casnDisconnectedSessions=casnDisconnectedSessions, casnDisconnect=casnDisconnect, CasnSessionId=CasnSessionId, casnMIBNotificationPrefix=casnMIBNotificationPrefix, casnActiveEntry=casnActiveEntry, CctCallId=CctCallId, casnIdleTime=casnIdleTime, casnMIBNotifications=casnMIBNotifications, casnActiveGroupSup1=casnActiveGroupSup1, casnUserId=casnUserId, casnMIBCompliance=casnMIBCompliance, ciscoAAASessionMIB=ciscoAAASessionMIB, casnActiveTableHighWaterMark=casnActiveTableHighWaterMark, casnMIBCompliances=casnMIBCompliances, casnActiveTable=casnActiveTable, casnGeneral=casnGeneral, PYSNMP_MODULE_ID=ciscoAAASessionMIB, casnMIBObjects=casnMIBObjects, casnMIBGroups=casnMIBGroups, casnGeneralGroup=casnGeneralGroup, casnIpAddr=casnIpAddr, casnTotalSessions=casnTotalSessions)
