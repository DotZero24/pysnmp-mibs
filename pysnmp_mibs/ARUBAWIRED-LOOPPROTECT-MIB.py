...
mibBuilder.exportSymbols("ARUBAWIRED-LOOPPROTECT-MIB", arubaWiredLoopProtectPortVlanList=arubaWiredLoopProtectPortVlanList, arubaWiredLoopProtectCompliances=arubaWiredLoopProtectCompliances, arubaWiredLoopProtectPortEnable=arubaWiredLoopProtectPortEnable, arubaWiredLoopProtectGroups=arubaWiredLoopProtectGroups, arubaWiredLoopProtectMode=arubaWiredLoopProtectMode, arubaWiredLoopProtectVIDList=arubaWiredLoopProtectVIDList, ConfigStatus=ConfigStatus, arubaWiredLoopProtectVLANGroup=arubaWiredLoopProtectVLANGroup, PYSNMP_MODULE_ID=arubaWiredLoopProtectMIB, arubaWiredLoopProtectMIB=arubaWiredLoopProtectMIB, arubaWiredLoopProtectNotificationsGroup=arubaWiredLoopProtectNotificationsGroup, arubaWiredLoopProtect=arubaWiredLoopProtect, arubaWiredLoopProtectBaseGroup=arubaWiredLoopProtectBaseGroup, arubaWiredLoopProtectEnableTimer=arubaWiredLoopProtectEnableTimer, arubaWiredLoopProtectVlanLoopDetectedNotification=arubaWiredLoopProtectVlanLoopDetectedNotification, arubaWiredLoopProtectPortReceiverAction=arubaWiredLoopProtectPortReceiverAction, arubaWiredLoopProtectLoopDetectedVlan=arubaWiredLoopProtectLoopDetectedVlan, arubaWiredLoopProtectObjects=arubaWiredLoopProtectObjects, arubaWiredLoopProtectPortLoopCount=arubaWiredLoopProtectPortLoopCount, arubaWiredLoopProtectConformance=arubaWiredLoopProtectConformance, arubaWiredLoopProtectPortEntry=arubaWiredLoopProtectPortEntry, LoopProtectReceiverAction=LoopProtectReceiverAction, arubaWiredLoopProtectInterval=arubaWiredLoopProtectInterval, arubaWiredLoopProtectPortLastLoopTime=arubaWiredLoopProtectPortLastLoopTime, arubaWiredLoopProtectLoopDetectedNotification=arubaWiredLoopProtectLoopDetectedNotification, arubaWiredLoopProtectNotifications=arubaWiredLoopProtectNotifications, arubaWiredLoopProtectPortTable=arubaWiredLoopProtectPortTable, VidList=VidList, arubaWiredLoopProtectPortInterfaceIndex=arubaWiredLoopProtectPortInterfaceIndex, arubaWiredLoopProtectBase=arubaWiredLoopProtectBase, arubaWiredLoopProtectCompliance=arubaWiredLoopProtectCompliance, arubaWiredLoopProtectPortLoopDetected=arubaWiredLoopProtectPortLoopDetected, arubaWiredLoopProtectTrapLoopDetectEnable=arubaWiredLoopProtectTrapLoopDetectEnable, arubaWiredLoopProtectPort=arubaWiredLoopProtectPort)
