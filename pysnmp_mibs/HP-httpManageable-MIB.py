...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-httpManageable-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:35:06 2025
...
hpHttpMgMinCompliance.setObjects(
    ("HP-httpManageable-MIB", "hpHttpMgDefaultGroup")
)
if mibBuilder.loadTexts:
...
hpHttpMgBasicNetCitizenCompliance.setObjects(
      *(("HP-httpManageable-MIB", "hpHttpMgDefaultGroup"),
        ("HP-httpManageable-MIB", "hpHttpMgBasicNetCitizenGroup"),
        ("HP-httpManageable-MIB", "hpHttpMgBasicNetCitizenTrapGroup"))
)
if mibBuilder.loadTexts:
