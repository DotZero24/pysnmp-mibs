...
mibBuilder.exportSymbols("HP-httpManageable-MIB", hpHttpMgTraps=hpHttpMgTraps, hpHttpMgBasicNetCitizenCompliance=hpHttpMgBasicNetCitizenCompliance, hpHttpMgMinCompliance=hpHttpMgMinCompliance, hpHttpMgMod=hpHttpMgMod, hpHttpMgROMVersion=hpHttpMgROMVersion, hpHttpMgHealth=hpHttpMgHealth, hpHttpMgMgmtSrvrURL=hpHttpMgMgmtSrvrURL, hpHttpMgVersion=hpHttpMgVersion, hpHttpMgSerialNumber=hpHttpMgSerialNumber, hpHttpMgNetCitizen=hpHttpMgNetCitizen, hpHttpMgDefaultURL=hpHttpMgDefaultURL, hpHttpMgHealthTrap=hpHttpMgHealthTrap, hpHttpMgDefaults=hpHttpMgDefaults, hpHttpMgDefaultGroup=hpHttpMgDefaultGroup, hpHttpMgProduct=hpHttpMgProduct, PYSNMP_MODULE_ID=hpHttpMgMod, hpHttpMgGroups=hpHttpMgGroups, hp=hp, hpHttpMgID=hpHttpMgID, hpHttpMgExtendedNetCitizenGroup=hpHttpMgExtendedNetCitizenGroup, hpHttpMgObjects=hpHttpMgObjects, hpHttpMgExtendedNetCitizenTrapGroup=hpHttpMgExtendedNetCitizenTrapGroup, hpHttpMgShutdown=hpHttpMgShutdown, hpHttpMgCompliances=hpHttpMgCompliances, hpHttpMgBasicNetCitizenTrapGroup=hpHttpMgBasicNetCitizenTrapGroup, Utf8String=Utf8String, hpHttpMgManufacturer=hpHttpMgManufacturer, hpHttpMgPhone=hpHttpMgPhone, hpHttpMgAssetNumber=hpHttpMgAssetNumber, hpHttpMgHWVersion=hpHttpMgHWVersion, hpHttpMgBasicNetCitizenGroup=hpHttpMgBasicNetCitizenGroup, nm=nm, hpWebMgmt=hpWebMgmt)
