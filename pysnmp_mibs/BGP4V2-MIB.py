...
# Notes
# -----
# ASN.1 source file://mibs/rfc/BGP4V2-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:18:22 2025
...
bgp4V2PrefixGaugesEntry.setIndexNames(
    ...
    (0, "BGP4V2-MIB", "bgp4V2PeerRemoteAddrType"),
    (0, "BGP4V2-MIB", "bgp4V2PeerRemoteAddr"),
    (0, "BGP4V2-MIB", "bgp4V2PrefixGaugesAfi"),
    (0, "BGP4V2-MIB", "bgp4V2PrefixGaugesSafi"),
)
if mibBuilder.loadTexts:
...
bgp4V2AdjRibsOutEntry.setIndexNames(
    ...
    (0, "BGP4V2-MIB", "bgp4V2PeerRemoteAddrType"),
    (0, "BGP4V2-MIB", "bgp4V2PeerRemoteAddr"),
    (0, "BGP4V2-MIB", "bgp4V2AdjRibsOutIndex"),
)
if mibBuilder.loadTexts:
...
bgp4V2GlobalsGroup.setObjects(
    ("BGP4V2-MIB", "bgp4V2DiscontinuityTime")
)
if mibBuilder.loadTexts:
...
bgp4V2StdMIBTimersGroup.setObjects(
      *(("BGP4V2-MIB", "bgp4V2PeerFsmEstablishedTime"),
        ("BGP4V2-MIB", "bgp4V2PeerInUpdatesElapsedTime"),
        ("BGP4V2-MIB", "bgp4V2PeerConnectRetryInterval"),
        ("BGP4V2-MIB", "bgp4V2PeerHoldTimeConfigured"),
        ("BGP4V2-MIB", "bgp4V2PeerKeepAliveConfigured"),
        ("BGP4V2-MIB", "bgp4V2PeerMinASOrigInterval"),
        ("BGP4V2-MIB", "bgp4V2PeerMinRouteAdverInterval"),
        ("BGP4V2-MIB", "bgp4V2PeerHoldTime"),
...
bgp4V2StdMIBCountersGroup.setObjects(
      *(("BGP4V2-MIB", "bgp4V2PeerInUpdates"),
        ("BGP4V2-MIB", "bgp4V2PeerOutUpdates"),
        ("BGP4V2-MIB", "bgp4V2PeerInTotalMessages"),
        ("BGP4V2-MIB", "bgp4V2PeerOutTotalMessages"),
        ("BGP4V2-MIB", "bgp4V2PeerFsmEstablishedTransitions"),
        ("BGP4V2-MIB", "bgp4V2PrefixInPrefixes"),
        ("BGP4V2-MIB", "bgp4V2PrefixInPrefixesAccepted"),
        ("BGP4V2-MIB", "bgp4V2PrefixOutPrefixes"))
)
if mibBuilder.loadTexts:
...
bgp4V2StdMIBErrorsGroup.setObjects(
      *(("BGP4V2-MIB", "bgp4V2PeerLastErrorCodeReceived"),
        ...
        ("BGP4V2-MIB", "bgp4V2PeerLastErrorReceivedData"),
        ("BGP4V2-MIB", "bgp4V2PeerLastErrorReceivedTime"),
        ("BGP4V2-MIB", "bgp4V2PeerLastErrorReceivedText"),
        ("BGP4V2-MIB", "bgp4V2PeerLastErrorCodeSent"),
        ("BGP4V2-MIB", "bgp4V2PeerLastErrorSubCodeSent"),
        ("BGP4V2-MIB", "bgp4V2PeerLastErrorSentData"),
        ("BGP4V2-MIB", "bgp4V2PeerLastErrorSentTime"),
...
bgp4V2StdMIBPeerGroup.setObjects(
      *(("BGP4V2-MIB", "bgp4V2PeerState"),
        ...
        ("BGP4V2-MIB", "bgp4V2PeerLocalAddrType"),
        ("BGP4V2-MIB", "bgp4V2PeerLocalAddr"),
        ("BGP4V2-MIB", "bgp4V2PeerLocalPort"),
        ("BGP4V2-MIB", "bgp4V2PeerLocalAs"),
        ("BGP4V2-MIB", "bgp4V2PeerRemotePort"),
        ("BGP4V2-MIB", "bgp4V2PeerRemoteAs"),
        ("BGP4V2-MIB", "bgp4V2PeerLocalIdentifier"),
        ("BGP4V2-MIB", "bgp4V2PeerRemoteIdentifier"),
...
bgp4V2StdMIBNlriGroup.setObjects(
      *(("BGP4V2-MIB", "bgp4V2NlriAsPathCalcLength"),
        ("BGP4V2-MIB", "bgp4V2NlriAsPathString"),
        ("BGP4V2-MIB", "bgp4V2NlriBest"),
        ("BGP4V2-MIB", "bgp4V2NlriCalcLocalPref"),
        ("BGP4V2-MIB", "bgp4V2AdjRibsOutRoute"),
        ("BGP4V2-MIB", "bgp4V2NlriAggregatorPresent"),
        ("BGP4V2-MIB", "bgp4V2NlriAggregatorAS"),
        ("BGP4V2-MIB", "bgp4V2NlriAggregatorAddr"),
        ("BGP4V2-MIB", "bgp4V2NlriAtomicAggregate"),
        ("BGP4V2-MIB", "bgp4V2NlriLocalPref"),
        ("BGP4V2-MIB", "bgp4V2NlriLocalPrefPresent"),
        ("BGP4V2-MIB", "bgp4V2NlriMed"),
        ("BGP4V2-MIB", "bgp4V2NlriMedPresent"),
        ("BGP4V2-MIB", "bgp4V2NlriNextHopAddr"),
        ("BGP4V2-MIB", "bgp4V2NlriNextHopAddrType"),
        ("BGP4V2-MIB", "bgp4V2NlriLinkLocalNextHopAddrType"),
        ("BGP4V2-MIB", "bgp4V2NlriLinkLocalNextHopAddr"),
        ("BGP4V2-MIB", "bgp4V2NlriOrigin"),
        ("BGP4V2-MIB", "bgp4V2NlriAsPath"),
        ("BGP4V2-MIB", "bgp4V2NlriPathAttrUnknown"))
)
if mibBuilder.loadTexts:
...
bgp4V2StdMIBNotificationGroup.setObjects(
      *(("BGP4V2-MIB", "bgp4V2EstablishedNotification"),
        ("BGP4V2-MIB", "bgp4V2BackwardTransitionNotification"))
)
if mibBuilder.loadTexts:
...
bgp4V2Compliance.setObjects(
      *(("BGP4V2-MIB", "bgp4V2StdMIBTimersGroup"),
        ("BGP4V2-MIB", "bgp4V2StdMIBCountersGroup"),
        ("BGP4V2-MIB", "bgp4V2StdMIBErrorsGroup"),
        ("BGP4V2-MIB", "bgp4V2StdMIBPeerGroup"),
        ("BGP4V2-MIB", "bgp4V2StdMIBNlriGroup"),
        ("BGP4V2-MIB", "bgp4V2GlobalsGroup"),
