# SNMP MIB module (DES7200-GVRP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-GVRP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:45:29 2025
...
myVlanIfStateEntry.setIndexNames(
    (0, "DES7200-GVRP-MIB", "myVlanIfStateVid"),
    (0, "DES7200-GVRP-MIB", "myVlanIfStateIndex"),
)
if mibBuilder.loadTexts:
...
myVlanDynEntry.setIndexNames(
    (0, "DES7200-GVRP-MIB", "myVlanDynVID"),
)
if mibBuilder.loadTexts:
...
myVlanDynEntryStatus = _MyVlanDynEntryStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 9, 1, 7, 1, 5),
...
myGvrpStatus = _MyGvrpStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 1),
    _MyGvrpStatus_Type()
)
...
myGvrpDynamicVlanCreateStauts = _MyGvrpDynamicVlanCreateStauts_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 2),
...
myGvrpJoinTimer = _MyGvrpJoinTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 3),
...
myGvrpLeaveTimer = _MyGvrpLeaveTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 4),
...
myGvrpLeaveAllTimer = _MyGvrpLeaveAllTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 5),
...
myGvrpIfIndex = _MyGvrpIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 6, 1, 1),
    _MyGvrpIfIndex_Type()
)
...
myGvrpRegistrationMode = _MyGvrpRegistrationMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 6, 1, 2),
...
myGvrpApplicantState = _MyGvrpApplicantState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 6, 1, 3),
...
myGvrpStatsIfIndex = _MyGvrpStatsIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 1),
...
myGvrpRecValidGvrpPdu = _MyGvrpRecValidGvrpPdu_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 2),
...
myGvrpRecInvalidGvrpPdu = _MyGvrpRecInvalidGvrpPdu_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 3),
...
myGvrpRecJoin = _MyGvrpRecJoin_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 4),
    _MyGvrpRecJoin_Type()
)
...
myGvrpRecJoinIn = _MyGvrpRecJoinIn_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 5),
...
myGvrpRecEmpty = _MyGvrpRecEmpty_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 6),
...
myGvrpRecLeaveEmpty = _MyGvrpRecLeaveEmpty_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 7),
...
myGvrpRecLeaveIn = _MyGvrpRecLeaveIn_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 8),
...
myGvrpRecLeaveAll = _MyGvrpRecLeaveAll_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 9),
...
myGvrpSentGvrpPdu = _MyGvrpSentGvrpPdu_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 10),
...
myGvrpSentJoin = _MyGvrpSentJoin_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 11),
...
myGvrpSentJoinIn = _MyGvrpSentJoinIn_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 12),
...
myGvrpSentEmpty = _MyGvrpSentEmpty_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 13),
...
myGvrpSentLeaveEmpty = _MyGvrpSentLeaveEmpty_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 14),
...
myGvrpSentLeaveIn = _MyGvrpSentLeaveIn_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 15),
...
myGvrpSentLeaveAll = _MyGvrpSentLeaveAll_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 16),
...
myGvrpJoinIndicated = _MyGvrpJoinIndicated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 17),
...
myGvrpLeaveIndicated = _MyGvrpLeaveIndicated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 18),
...
myGvrpJoinPropagated = _MyGvrpJoinPropagated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 19),
...
myGvrpLeavePropagated = _MyGvrpLeavePropagated_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 20),
...
myGvrpStatisticsPortClear = _MyGvrpStatisticsPortClear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 7, 1, 21),
...
myGvrpOperVid = _MyGvrpOperVid_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 8),
    _MyGvrpOperVid_Type()
)
...
myGvrpStatisticsClear = _MyGvrpStatisticsClear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 9),
...
myGvrpResetTimer = _MyGvrpResetTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 1, 10),
...
myGvrpMIBConformance = _MyGvrpMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 2)
)
_MyGvrpMIBCompliances_ObjectIdentity = ObjectIdentity
myGvrpMIBCompliances = _MyGvrpMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 2, 1)
)
_MyGvrpMIBGroups_ObjectIdentity = ObjectIdentity
myGvrpMIBGroups = _MyGvrpMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 2, 2)
)

# Managed Objects groups

myGvrpMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 2, 2, 1)
)
myGvrpMIBGroup.setObjects(
      *(("DES7200-GVRP-MIB", "myGvrpStatus"),
        ("DES7200-GVRP-MIB", "myGvrpDynamicVlanCreateStauts"),
        ("DES7200-GVRP-MIB", "myGvrpJoinTimer"),
        ("DES7200-GVRP-MIB", "myGvrpLeaveTimer"),
        ("DES7200-GVRP-MIB", "myGvrpLeaveAllTimer"),
        ("DES7200-GVRP-MIB", "myGvrpIfIndex"),
        ("DES7200-GVRP-MIB", "myGvrpRegistrationMode"),
        ("DES7200-GVRP-MIB", "myGvrpApplicantState"),
        ("DES7200-GVRP-MIB", "myVlanIfStateVid"),
        ("DES7200-GVRP-MIB", "myVlanIfStateIndex"),
        ("DES7200-GVRP-MIB", "myVlanIfState"))
)
if mibBuilder.loadTexts:
    myGvrpMIBGroup.setStatus("current")

myGvrpStatsMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 2, 2, 2)
)
myGvrpStatsMIBGroup.setObjects(
      *(("DES7200-GVRP-MIB", "myGvrpStatsIfIndex"),
        ("DES7200-GVRP-MIB", "myGvrpRecValidGvrpPdu"),
        ("DES7200-GVRP-MIB", "myGvrpRecInvalidGvrpPdu"),
        ("DES7200-GVRP-MIB", "myGvrpRecJoin"),
        ("DES7200-GVRP-MIB", "myGvrpRecJoinIn"),
        ("DES7200-GVRP-MIB", "myGvrpRecEmpty"),
        ("DES7200-GVRP-MIB", "myGvrpRecLeaveEmpty"),
        ("DES7200-GVRP-MIB", "myGvrpRecLeaveIn"),
        ("DES7200-GVRP-MIB", "myGvrpRecLeaveAll"),
        ("DES7200-GVRP-MIB", "myGvrpSentGvrpPdu"),
        ("DES7200-GVRP-MIB", "myGvrpSentJoin"),
        ("DES7200-GVRP-MIB", "myGvrpSentJoinIn"),
        ("DES7200-GVRP-MIB", "myGvrpSentEmpty"),
        ("DES7200-GVRP-MIB", "myGvrpSentLeaveEmpty"),
        ("DES7200-GVRP-MIB", "myGvrpSentLeaveIn"),
        ("DES7200-GVRP-MIB", "myGvrpSentLeaveAll"),
        ("DES7200-GVRP-MIB", "myGvrpJoinIndicated"),
        ("DES7200-GVRP-MIB", "myGvrpLeaveIndicated"),
        ("DES7200-GVRP-MIB", "myGvrpJoinPropagated"),
        ("DES7200-GVRP-MIB", "myGvrpLeavePropagated"),
        ("DES7200-GVRP-MIB", "myGvrpStatisticsPortClear"))
)
if mibBuilder.loadTexts:
...
myGvrpMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 25, 2, 1, 1)
)
myGvrpMIBCompliance.setObjects(
      *(("DES7200-GVRP-MIB", "myGvrpMIBGroup"),
        ("DES7200-GVRP-MIB", "myGvrpStatsMIBGroup"))
)
if mibBuilder.loadTexts:
