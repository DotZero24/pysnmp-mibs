...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:09:45 2025
...
rlCopyInetEntry.setIndexNames(
    (0, "RADLAN-COPY-MIB", "rlCopyInetIndex"),
)
if mibBuilder.loadTexts:
...
rlCopyHistoryInetEntry.setIndexNames(
    (0, "RADLAN-COPY-MIB", "rlCopyHistoryInetHistoryIndex"),
)
if mibBuilder.loadTexts:
...
rlCopyOptionsEntry.setIndexNames(
    (0, "RADLAN-COPY-MIB", "rlCopyOptionsIndex"),
)
if mibBuilder.loadTexts:
...
rlCopySWToUnits.setObjects(
      *(("RADLAN-DEVICEPARAMS-MIB", "rndErrorDesc"),
        ("RADLAN-DEVICEPARAMS-MIB", "rndErrorSeverity"),
        ("RADLAN-COPY-MIB", "rlCopyUnitsList"))
)
if mibBuilder.loadTexts:
