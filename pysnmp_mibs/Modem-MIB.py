...
mibBuilder.exportSymbols("Modem-MIB", mdmGroups=mdmGroups, mdmCCCallSetUpFailTimer=mdmCCCallSetUpFailTimer, mdmLineCapabilitiesMNP3=mdmLineCapabilitiesMNP3, mdmLineCapabilitiesV32bis=mdmLineCapabilitiesV32bis, mdmDTEActionDTROnToOff=mdmDTEActionDTROnToOff, mdmLineCapabilitiesV29=mdmLineCapabilitiesV29, mdmMib=mdmMib, mdmDTEActionDTROffToOn=mdmDTEActionDTROffToOn, mdmIDProductDetails=mdmIDProductDetails, mdmLineCapabilitiesEnableRequested=mdmLineCapabilitiesEnableRequested, mdmDTEInterfaceTable=mdmDTEInterfaceTable, mdmStatsFailedDialAttempts=mdmStatsFailedDialAttempts, mdmLineCapabilitiesMNP8=mdmLineCapabilitiesMNP8, mdmLineCapabilitiesMNP5=mdmLineCapabilitiesMNP5, mdmLineCapabilitiesMNP7=mdmLineCapabilitiesMNP7, mdmCallControlEntry=mdmCallControlEntry, mdmCCStoredDialStringIndex=mdmCCStoredDialStringIndex, mdmNumber=mdmNumber, mdmCCStoredDialString=mdmCCStoredDialString, mdmLineCapabilitiesV22bis=mdmLineCapabilitiesV22bis, mdmStatsSentOctets=mdmStatsSentOctets, mdmStatsErrorFrames=mdmStatsErrorFrames, mdmStatsEntry=mdmStatsEntry, mdmStatsSentDataFrames=mdmStatsSentDataFrames, mdmCCResultCodeEnable=mdmCCResultCodeEnable, mdmLineCapabilitiesV26ter=mdmLineCapabilitiesV26ter, mdmIndex=mdmIndex, mdmStatsIncomingConnectionFailures=mdmStatsIncomingConnectionFailures, mdmLineCapabilitiesV42=mdmLineCapabilitiesV42, mdmDTEInactivityTimeout=mdmDTEInactivityTimeout, mdmCCStoredDialStringEntry=mdmCCStoredDialStringEntry, mdmLineCapabilitiesV42bis=mdmLineCapabilitiesV42bis, mdmDTESyncTimingSource=mdmDTESyncTimingSource, mdmStatsRetrains=mdmStatsRetrains, mdmStatisticsGroup=mdmStatisticsGroup, mdmECEntry=mdmECEntry, mdmIDTable=mdmIDTable, mdmLineCapabilitiesV26bis=mdmLineCapabilitiesV26bis, mdmErrorControlGroup=mdmErrorControlGroup, mdmSCEntry=mdmSCEntry, mdmDCCompressionTypeUsed=mdmDCCompressionTypeUsed, mdmLineCapabilitiesIndex=mdmLineCapabilitiesIndex, mdmCCStoredDialStringTable=mdmCCStoredDialStringTable, mdmStatsRingNoAnswers=mdmStatsRingNoAnswers, mdmLineCapabilitiesMNP6=mdmLineCapabilitiesMNP6, mdmLineCapabilitiesTable=mdmLineCapabilitiesTable, mdmCallControlGroup=mdmCallControlGroup, mdmLineCapabilitiesMNP1=mdmLineCapabilitiesMNP1, mdmDTEInterfaceEntry=mdmDTEInterfaceEntry, mdmECErrorControlUsed=mdmECErrorControlUsed, mdmStatsTable=mdmStatsTable, mdmDTESyncAsyncMode=mdmDTESyncAsyncMode, mdmSCTable=mdmSCTable, mdmLineCapabilitiesVFC=mdmLineCapabilitiesVFC, mdmDTEInterfaceGroup=mdmDTEInterfaceGroup, mdmSCInitialLineTransmitRate=mdmSCInitialLineTransmitRate, mdmLineCapabilitiesV32terbo=mdmLineCapabilitiesV32terbo, mdmLineCapabilitiesBell208=mdmLineCapabilitiesBell208, mdmLineCapabilitiesV33=mdmLineCapabilitiesV33, mdmLineEntry=mdmLineEntry, mdmMIBObjects=mdmMIBObjects, PYSNMP_MODULE_ID=mdmMIB, mdmStatsIncomingConnectionCompletions=mdmStatsIncomingConnectionCompletions, mdmCompliance=mdmCompliance, mdmStatsGreaterThan14400Connections=mdmStatsGreaterThan14400Connections, mdmIDEntry=mdmIDEntry, mdmLineCapabilitiesV27ter=mdmLineCapabilitiesV27ter, mdmStats2400To14400Connections=mdmStats2400To14400Connections, mdmStatsReceivedDataFrames=mdmStatsReceivedDataFrames, mdmCallControlTable=mdmCallControlTable, mdmIDGroup=mdmIDGroup, mdmLineCapabilitiesMNP4=mdmLineCapabilitiesMNP4, mdmDataCompressionGroup=mdmDataCompressionGroup, mdmCCEscapeAction=mdmCCEscapeAction, mdmStatsReceivedOctets=mdmStatsReceivedOctets, mdmLineCapabilitiesV25bis=mdmLineCapabilitiesV25bis, mdmLineCapabilitiesV32=mdmLineCapabilitiesV32, mdmDCTable=mdmDCTable, mdmSCCurrentLineReceiveRate=mdmSCCurrentLineReceiveRate, mdmLineCapabilitiesMNP10=mdmLineCapabilitiesMNP10, mdmLineCapabilitiesV21=mdmLineCapabilitiesV21, mdmLineCapabilitiesV23CC=mdmLineCapabilitiesV23CC, mdmLineCapabilitiesID=mdmLineCapabilitiesID, mdmCCConnectionFailReason=mdmCCConnectionFailReason, mdmLineCapabilities=mdmLineCapabilities, mdmLineCapabilitiesEntry=mdmLineCapabilitiesEntry, mdmStatsCompressedConnections=mdmStatsCompressedConnections, mdmLineCarrierLossTime=mdmLineCarrierLossTime, mdmLineInterfaceGroup=mdmLineInterfaceGroup, mdmStatsOutgoingConnectionFailures=mdmStatsOutgoingConnectionFailures, mdmStats2400OrLessConnections=mdmStats2400OrLessConnections, mdmMIB=mdmMIB, mdmConformance=mdmConformance, mdmLineCapabilitiesMNP9=mdmLineCapabilitiesMNP9, mdmIDManufacturerOID=mdmIDManufacturerOID, mdmCCCallDuration=mdmCCCallDuration, mdmLineCapabilitiesMNP2=mdmLineCapabilitiesMNP2, mdmSCCurrentLineTransmitRate=mdmSCCurrentLineTransmitRate, mdmDCEntry=mdmDCEntry, mdmLineTable=mdmLineTable, mdmStatsErrorControlledConnections=mdmStatsErrorControlledConnections, mdmSCModulationSchemeUsed=mdmSCModulationSchemeUsed, mdmLineCapabilitiesV34=mdmLineCapabilitiesV34, mdmECTable=mdmECTable, mdmCompliances=mdmCompliances, mdmStatsCompressionEfficiency=mdmStatsCompressionEfficiency, mdmLineCapabilitiesV23SC=mdmLineCapabilitiesV23SC, mdmStatsOutgoingConnectionCompletions=mdmStatsOutgoingConnectionCompletions, mdmSignalConvertorGroup=mdmSignalConvertorGroup, mdmStatsResentFrames=mdmStatsResentFrames, mdmLineState=mdmLineState, mdmLineCapabilitiesV22=mdmLineCapabilitiesV22, mdmLineCapabilitiesEnableGranted=mdmLineCapabilitiesEnableGranted, mdmSCInitialLineReceiveRate=mdmSCInitialLineReceiveRate, mdmCCRingsBeforeAnswer=mdmCCRingsBeforeAnswer)
