...
# Notes
# -----
# ASN.1 source file://mibs/rfc/Modem-MIB
...
_MdmCCRingsBeforeAnswer_Type.__name__ = "Integer32"
...
mdmCompliance.setObjects(
      *(("Modem-MIB", "mdmIDGroup"),
        ("Modem-MIB", "mdmLineInterfaceGroup"),
        ("Modem-MIB", "mdmDTEInterfaceGroup"),
        ("Modem-MIB", "mdmCallControlGroup"),
        ("Modem-MIB", "mdmSignalConvertorGroup"),
        ("Modem-MIB", "mdmStatisticsGroup"),
        ("Modem-MIB", "mdmErrorControlGroup"),
        ("Modem-MIB", "mdmDataCompressionGroup"))
)
if mibBuilder.loadTexts:
