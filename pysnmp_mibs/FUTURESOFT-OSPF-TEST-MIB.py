...
futOspfBRRouteTable=_FutOspfBRRouteTable_Object((1,3,6,1,4,1,2076,10,100,1))
if mibBuilder.loadTexts:futOspfBRRouteTable.setStatus(_A)
_FutOspfBRRouteEntry_Object=MibTableRow
futOspfBRRouteEntry=_FutOspfBRRouteEntry_Object((1,3,6,1,4,1,2076,10,100,1,1))
...
futOspfBRRouteIpAddr=_FutOspfBRRouteIpAddr_Object((1,3,6,1,4,1,2076,10,100,1,1,1),_FutOspfBRRouteIpAddr_Type())
...
futOspfBRRouteIpAddrMask=_FutOspfBRRouteIpAddrMask_Object((1,3,6,1,4,1,2076,10,100,1,1,2),_FutOspfBRRouteIpAddrMask_Type())
...
futOspfBRRouteIpTos=_FutOspfBRRouteIpTos_Object((1,3,6,1,4,1,2076,10,100,1,1,3),_FutOspfBRRouteIpTos_Type())
...
futOspfBRRouteIpNextHop=_FutOspfBRRouteIpNextHop_Object((1,3,6,1,4,1,2076,10,100,1,1,4),_FutOspfBRRouteIpNextHop_Type())
...
futOspfBRRouteDestType=_FutOspfBRRouteDestType_Object((1,3,6,1,4,1,2076,10,100,1,1,5),_FutOspfBRRouteDestType_Type())
...
futOspfBRRouteType=_FutOspfBRRouteType_Object((1,3,6,1,4,1,2076,10,100,1,1,6),_FutOspfBRRouteType_Type())
...
futOspfBRRouteAreaId=_FutOspfBRRouteAreaId_Object((1,3,6,1,4,1,2076,10,100,1,1,7),_FutOspfBRRouteAreaId_Type())
...
futOspfBRRouteCost=_FutOspfBRRouteCost_Object((1,3,6,1,4,1,2076,10,100,1,1,8),_FutOspfBRRouteCost_Type())
...
futOspfBRRouteInterfaceIndex=_FutOspfBRRouteInterfaceIndex_Object((1,3,6,1,4,1,2076,10,100,1,1,9),_FutOspfBRRouteInterfaceIndex_Type())
...
futOspfExtRouteTable=_FutOspfExtRouteTable_Object((1,3,6,1,4,1,2076,10,100,2))
if mibBuilder.loadTexts:futOspfExtRouteTable.setStatus(_A)
_FutOspfExtRouteEntry_Object=MibTableRow
futOspfExtRouteEntry=_FutOspfExtRouteEntry_Object((1,3,6,1,4,1,2076,10,100,2,1))
...
futOspfExtRouteDest=_FutOspfExtRouteDest_Object((1,3,6,1,4,1,2076,10,100,2,1,1),_FutOspfExtRouteDest_Type())
...
futOspfExtRouteMask=_FutOspfExtRouteMask_Object((1,3,6,1,4,1,2076,10,100,2,1,2),_FutOspfExtRouteMask_Type())
...
futOspfExtRouteTOS=_FutOspfExtRouteTOS_Object((1,3,6,1,4,1,2076,10,100,2,1,3),_FutOspfExtRouteTOS_Type())
...
futOspfExtRouteMetric=_FutOspfExtRouteMetric_Object((1,3,6,1,4,1,2076,10,100,2,1,4),_FutOspfExtRouteMetric_Type())
futOspfExtRouteMetric.setMaxAccess(_D)
if mibBuilder.loadTexts:futOspfExtRouteMetric.setStatus(_A)
class _FutOspfExtRouteMetricType_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('asexttype1',1),('asexttype2',2)))
_FutOspfExtRouteMetricType_Type.__name__=_E
_FutOspfExtRouteMetricType_Object=MibTableColumn
futOspfExtRouteMetricType=_FutOspfExtRouteMetricType_Object((1,3,6,1,4,1,2076,10,100,2,1,5),_FutOspfExtRouteMetricType_Type())
...
futOspfExtRouteTag=_FutOspfExtRouteTag_Object((1,3,6,1,4,1,2076,10,100,2,1,6),_FutOspfExtRouteTag_Type())
...
futOspfExtRouteFwdAdr=_FutOspfExtRouteFwdAdr_Object((1,3,6,1,4,1,2076,10,100,2,1,7),_FutOspfExtRouteFwdAdr_Type())
...
futOspfExtRouteIfIndex=_FutOspfExtRouteIfIndex_Object((1,3,6,1,4,1,2076,10,100,2,1,8),_FutOspfExtRouteIfIndex_Type())
...
futOspfExtRouteNextHop=_FutOspfExtRouteNextHop_Object((1,3,6,1,4,1,2076,10,100,2,1,9),_FutOspfExtRouteNextHop_Type())
...
futOspfExtRouteStatus=_FutOspfExtRouteStatus_Object((1,3,6,1,4,1,2076,10,100,2,1,10),_FutOspfExtRouteStatus_Type())
...
futOspfGrTestGroup=_FutOspfGrTestGroup_ObjectIdentity((1,3,6,1,4,1,2076,10,100,100))
...
futOspfGrShutdown=_FutOspfGrShutdown_Object((1,3,6,1,4,1,2076,10,100,100,1),_FutOspfGrShutdown_Type())
