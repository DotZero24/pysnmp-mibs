# SNMP MIB module (FUTURESOFT-OSPF-TEST-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/FUTURESOFT-OSPF-TEST-MIB
...
futOspfBRRouteEntry = _FutOspfBRRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 10, 100, 1, 1)
)
futOspfBRRouteEntry.setIndexNames(
    (0, "FUTURESOFT-OSPF-TEST-MIB", "futOspfBRRouteIpAddr"),
    (0, "FUTURESOFT-OSPF-TEST-MIB", "futOspfBRRouteIpAddrMask"),
    (0, "FUTURESOFT-OSPF-TEST-MIB", "futOspfBRRouteIpTos"),
    (0, "FUTURESOFT-OSPF-TEST-MIB", "futOspfBRRouteIpNextHop"),
    (0, "FUTURESOFT-OSPF-TEST-MIB", "futOspfBRRouteDestType"),
)
if mibBuilder.loadTexts:
...
futOspfExtRouteEntry = _FutOspfExtRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 10, 100, 2, 1)
)
futOspfExtRouteEntry.setIndexNames(
    (0, "FUTURESOFT-OSPF-TEST-MIB", "futOspfExtRouteDest"),
    (0, "FUTURESOFT-OSPF-TEST-MIB", "futOspfExtRouteMask"),
    (0, "FUTURESOFT-OSPF-TEST-MIB", "futOspfExtRouteTOS"),
)
if mibBuilder.loadTexts:
...
futOspfExtRouteStatus = _FutOspfExtRouteStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 10, 100, 2, 1, 10),
