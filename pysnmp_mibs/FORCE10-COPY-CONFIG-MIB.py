...
if mibBuilder.loadTexts:f10CopyConfigMib.setRevisions(('2009-05-14 13:00','2007-06-19 12:00','2003-03-01 12:00'))
class F10ConfigFileLocation(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7)));namedValues=NamedValues(*(('flash',1),('slot0',2),('tftp',3),('ftp',4),('scp',5),('usbflash',6),('nfsmount',7)))
class F10ConfigFileType(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('ftosFile',1),('runningConfig',2),('startupConfig',3)))
class F10ConfigCopyState(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('running',1),('successful',2),('failed',3)))
class F10ConfigCopyFailCause(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7)));namedValues=NamedValues(*(('badFileName',1),('copyInProgress',2),('diskFull',3),('fileExist',4),('fileNotFound',5),('timeout',6),('unknown',7)))
_F10CopyConfigObjects_ObjectIdentity=ObjectIdentity
f10CopyConfigObjects=_F10CopyConfigObjects_ObjectIdentity((1,3,6,1,4,1,6027,3,5,1))
_F10CopyConfig_ObjectIdentity=ObjectIdentity
f10CopyConfig=_F10CopyConfig_ObjectIdentity((1,3,6,1,4,1,6027,3,5,1,1))
_F10CopyTable_Object=MibTable
f10CopyTable=_F10CopyTable_Object((1,3,6,1,4,1,6027,3,5,1,1,1))
if mibBuilder.loadTexts:f10CopyTable.setStatus(_A)
_F10CopyEntry_Object=MibTableRow
f10CopyEntry=_F10CopyEntry_Object((1,3,6,1,4,1,6027,3,5,1,1,1,1))
f10CopyEntry.setIndexNames((0,_B,_J))
if mibBuilder.loadTexts:f10CopyEntry.setStatus(_A)
...
f10CopyConfigTraps=_F10CopyConfigTraps_ObjectIdentity((1,3,6,1,4,1,6027,3,5,1,2))
