# SNMP MIB module (ARICENT-RM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-RM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:44:40 2025
...
fsRmHbInterval = _FsRmHbInterval_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 1, 5),
    _FsRmHbInterval_Type()
)
fsRmHbInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsRmHbInterval.setStatus("deprecated")
...
class _FsRmCopyPeerSyLogFile_Type(Integer32):
    """Custom type fsRmCopyPeerSyLogFile based on Integer32"""
    defaultValue = 0
...
_FsRmCopyPeerSyLogFile_Type.__name__ = "Integer32"
_FsRmCopyPeerSyLogFile_Object = MibScalar
fsRmCopyPeerSyLogFile = _FsRmCopyPeerSyLogFile_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 1, 23),
    _FsRmCopyPeerSyLogFile_Type()
)
fsRmCopyPeerSyLogFile.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsRmCopyPeerSyLogFile.setStatus("current")


class _FsRmDynamicSyncAuditTrigger_Type(Unsigned32):
    """Custom type fsRmDynamicSyncAuditTrigger based on Unsigned32"""
    defaultValue = 0


_FsRmDynamicSyncAuditTrigger_Type.__name__ = "Unsigned32"
_FsRmDynamicSyncAuditTrigger_Object = MibScalar
fsRmDynamicSyncAuditTrigger = _FsRmDynamicSyncAuditTrigger_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 1, 24),
    _FsRmDynamicSyncAuditTrigger_Type()
)
fsRmDynamicSyncAuditTrigger.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsRmDynamicSyncAuditTrigger.setStatus("current")
_FsRmTrap_ObjectIdentity = ObjectIdentity
fsRmTrap = _FsRmTrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 99, 2)
)
...
class _FsRmStaticBulkStatus_Type(Integer32):
    """Custom type fsRmStaticBulkStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_FsRmStaticBulkStatus_Type.__name__ = "Integer32"
_FsRmStaticBulkStatus_Object = MibScalar
fsRmStaticBulkStatus = _FsRmStaticBulkStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 3, 7),
    _FsRmStaticBulkStatus_Type()
)
fsRmStaticBulkStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsRmStaticBulkStatus.setStatus("current")


class _FsRmDynamicBulkStatus_Type(Integer32):
    """Custom type fsRmDynamicBulkStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_FsRmDynamicBulkStatus_Type.__name__ = "Integer32"
_FsRmDynamicBulkStatus_Object = MibScalar
fsRmDynamicBulkStatus = _FsRmDynamicBulkStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 3, 8),
    _FsRmDynamicBulkStatus_Type()
)
fsRmDynamicBulkStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsRmDynamicBulkStatus.setStatus("current")


class _FsRmOverallBulkStatus_Type(Integer32):
    """Custom type fsRmOverallBulkStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_FsRmOverallBulkStatus_Type.__name__ = "Integer32"
_FsRmOverallBulkStatus_Object = MibScalar
fsRmOverallBulkStatus = _FsRmOverallBulkStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 3, 9),
    _FsRmOverallBulkStatus_Type()
)
fsRmOverallBulkStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsRmOverallBulkStatus.setStatus("current")
_FsRmTest_ObjectIdentity = ObjectIdentity
fsRmTest = _FsRmTest_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2076, 99, 4)
)
_FsRmSwitchoverTimeTable_Object = MibTable
fsRmSwitchoverTimeTable = _FsRmSwitchoverTimeTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 4, 1)
)
if mibBuilder.loadTexts:
...
fsRmSwitchoverTimeEntry = _FsRmSwitchoverTimeEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 4, 1, 1)
)
fsRmSwitchoverTimeEntry.setIndexNames(
    (0, "ARICENT-RM-MIB", "fsRmAppId"),
)
if mibBuilder.loadTexts:
...
fsRmDynamicSyncAuditTable = _FsRmDynamicSyncAuditTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 4, 2)
)
if mibBuilder.loadTexts:
    fsRmDynamicSyncAuditTable.setStatus("current")
_FsRmDynamicSyncAuditEntry_Object = MibTableRow
fsRmDynamicSyncAuditEntry = _FsRmDynamicSyncAuditEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 4, 2, 1)
)
fsRmDynamicSyncAuditEntry.setIndexNames(
    (0, "ARICENT-RM-MIB", "fsRmDynAuditAppId"),
)
if mibBuilder.loadTexts:
    fsRmDynamicSyncAuditEntry.setStatus("current")


class _FsRmDynAuditAppId_Type(Integer32):
    """Custom type fsRmDynAuditAppId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 128),
    )
...
_FsRmDynAuditAppId_Type.__name__ = "Integer32"
_FsRmDynAuditAppId_Object = MibTableColumn
fsRmDynAuditAppId = _FsRmDynAuditAppId_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 4, 2, 1, 1),
    _FsRmDynAuditAppId_Type()
)
fsRmDynAuditAppId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    fsRmDynAuditAppId.setStatus("current")


class _FsRmDynamicSyncAuditStatus_Type(Integer32):
    """Custom type fsRmDynamicSyncAuditStatus based on Integer32"""
    defaultValue = 0
...
_FsRmDynamicSyncAuditStatus_Type.__name__ = "Integer32"
_FsRmDynamicSyncAuditStatus_Object = MibTableColumn
fsRmDynamicSyncAuditStatus = _FsRmDynamicSyncAuditStatus_Object(
    (1, 3, 6, 1, 4, 1, 2076, 99, 4, 2, 1, 2),
    _FsRmDynamicSyncAuditStatus_Type()
)
fsRmDynamicSyncAuditStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsRmDynamicSyncAuditStatus.setStatus("current")
...
fsRmTrapEvent = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 99, 0, 1)
)
fsRmTrapEvent.setObjects(
      *(("ARICENT-RM-MIB", "fsRmSelfNodeId"),
        ("ARICENT-RM-MIB", "fsRmNodeState"),
        ("ARICENT-RM-MIB", "fsRmTrapModuleId"),
        ("ARICENT-RM-MIB", "fsRmTrapOperation"),
        ("ARICENT-RM-MIB", "fsRmTrapOperationStatus"),
        ("ARICENT-RM-MIB", "fsRmTrapError"),
        ("ARICENT-RM-MIB", "fsRmTrapEventTime"),
        ("ARICENT-RM-MIB", "fsRmTrapErrorStr"),
        ("ARICENT-RM-MIB", "fsRmTrapSwitchId"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"FsRmState": FsRmState,
       ...
       "fsRmCopyPeerSyLogFile": fsRmCopyPeerSyLogFile,
       "fsRmDynamicSyncAuditTrigger": fsRmDynamicSyncAuditTrigger,
       "fsRmTrap": fsRmTrap,
       ...
       "fsRmStaticBulkStatus": fsRmStaticBulkStatus,
       "fsRmDynamicBulkStatus": fsRmDynamicBulkStatus,
       "fsRmOverallBulkStatus": fsRmOverallBulkStatus,
       "fsRmTest": fsRmTest,
       ...
       "fsRmDynamicSyncAuditTable": fsRmDynamicSyncAuditTable,
       "fsRmDynamicSyncAuditEntry": fsRmDynamicSyncAuditEntry,
       "fsRmDynAuditAppId": fsRmDynAuditAppId,
       "fsRmDynamicSyncAuditStatus": fsRmDynamicSyncAuditStatus}
)
