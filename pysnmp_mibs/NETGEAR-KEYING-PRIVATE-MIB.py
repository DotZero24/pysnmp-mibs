# SNMP MIB module (NETGEAR-KEYING-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-KEYING-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:42 2025
...
agentFeatureKeyingEntry = _AgentFeatureKeyingEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 24, 1, 3, 1)
)
agentFeatureKeyingEntry.setIndexNames(
    (0, "NETGEAR-KEYING-PRIVATE-MIB", "agentFeatureKeyingIndex"),
)
if mibBuilder.loadTexts:
...
agentFeatureKeyingIndex = _AgentFeatureKeyingIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 24, 1, 3, 1, 1),
...
agentFeatureKeyingName = _AgentFeatureKeyingName_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 24, 1, 3, 1, 2),
...
agentFeatureKeyingStatus = _AgentFeatureKeyingStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 24, 1, 3, 1, 3),
