...
# Notes
# -----
# ASN.1 source file://mibs/arista/ARISTA-PRODUCTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:56:59 2025
...
_AristaT4048IX8_ObjectIdentity = ObjectIdentity
aristaT4048IX8 = _AristaT4048IX8_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 427, 4048, 575, 8)
)
_AristaT7032IX7_ObjectIdentity = ObjectIdentity
aristaT7032IX7 = _AristaT7032IX7_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 427, 7032, 575, 7)
)
_AristaLY6_ObjectIdentity = ObjectIdentity
aristaLY6 = _AristaLY6_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 447, 6)
)
_AristaIX1_ObjectIdentity = ObjectIdentity
aristaIX1 = _AristaIX1_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 575, 1)
)
_AristaIX7_ObjectIdentity = ObjectIdentity
aristaIX7 = _AristaIX7_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 575, 7)
)
...
_AristaWEDGE100SACF_ObjectIdentity = ObjectIdentity
aristaWEDGE100SACF = _AristaWEDGE100SACF_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 1759, 100, 2301)
)
_AristaWEDGE100S12V_ObjectIdentity = ObjectIdentity
aristaWEDGE100S12V = _AristaWEDGE100S12V_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 1759, 100, 3282, 12, 3753)
)
...
_AristaDX010_ObjectIdentity = ObjectIdentity
aristaDX010 = _AristaDX010_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 2966, 2097, 10)
)
...
_AristaDCS7280CR3MK32D4A_ObjectIdentity = ObjectIdentity
aristaDCS7280CR3MK32D4A = _AristaDCS7280CR3MK32D4A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 3011, 7280, 2727, 3, 1810, 32, 1605, 4, 3648)
)
...
_AristaS4048ON_ObjectIdentity = ObjectIdentity
aristaS4048ON = _AristaS4048ON_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 30065, 1, 3282, 4048, 2463)
)
...
mibBuilder.exportSymbols(
    ...
    **{"aristaQuestoneD3020": aristaQuestoneD3020,
       "aristaT4048IX8": aristaT4048IX8,
       "aristaT7032IX7": aristaT7032IX7,
       "aristaLY6": aristaLY6,
       "aristaIX1": aristaIX1,
       "aristaIX7": aristaIX7,
       ...
       "aristaWEDGE100SACF": aristaWEDGE100SACF,
       "aristaWEDGE100S12V": aristaWEDGE100S12V,
       ...
       "aristaDCS7280CR3MK32D4A": aristaDCS7280CR3MK32D4A,
