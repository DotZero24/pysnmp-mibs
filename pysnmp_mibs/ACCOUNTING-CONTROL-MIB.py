...
# Notes
# -----
# ASN.1 source file://mibs/rfc/ACCOUNTING-CONTROL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:24:39 2025
...
class _AcctngFileDescription_Type(DisplayString):
    """Custom type acctngFileDescription based on DisplayString"""
    defaultValue = OctetString("")


_AcctngFileDescription_Type.__name__ = "DisplayString"
...
acctngCompliance.setObjects(
      *(("ACCOUNTING-CONTROL-MIB", "acctngBasicGroup"),
        ("ACCOUNTING-CONTROL-MIB", "acctngNotificationsGroup"))
)
if mibBuilder.loadTexts:
