# SNMP MIB module (Dell-MNGINF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-MNGINF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:03 2025
...
rlMngInfListEntry.setIndexNames(
    (0, "Dell-MNGINF-MIB", "rlMngInfListName"),
    (0, "Dell-MNGINF-MIB", "rlMngInfListPriority"),
)
if mibBuilder.loadTexts:
...
rlMngInfListInetEntry = _RlMngInfListInetEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 89, 6, 1)
)
rlMngInfListInetEntry.setIndexNames(
    (0, "Dell-MNGINF-MIB", "rlMngInfListInetName"),
    (0, "Dell-MNGINF-MIB", "rlMngInfListInetPriority"),
)
if mibBuilder.loadTexts:
