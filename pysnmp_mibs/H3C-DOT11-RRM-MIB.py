...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-DOT11-RRM-MIB
...
class _H3cDot11RRM11nMultiCastMcs_Type(Unsigned32):
    """Custom type h3cDot11RRM11nMultiCastMcs based on Unsigned32"""
...
_H3cDot11RRM11nMultiCastMcs_Type.__name__ = "Unsigned32"
_H3cDot11RRM11nMultiCastMcs_Object = MibScalar
h3cDot11RRM11nMultiCastMcs = _H3cDot11RRM11nMultiCastMcs_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 1, 1, 11),
    _H3cDot11RRM11nMultiCastMcs_Type()
)
h3cDot11RRM11nMultiCastMcs.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cDot11RRM11nMultiCastMcs.setStatus("current")


class _H3cDot11RRM11acMadtMaxNss_Type(Integer32):
    """Custom type h3cDot11RRM11acMadtMaxNss based on Integer32"""
    defaultValue = 0
...
_H3cDot11RRM11acMadtMaxNss_Type.__name__ = "Integer32"
_H3cDot11RRM11acMadtMaxNss_Object = MibScalar
h3cDot11RRM11acMadtMaxNss = _H3cDot11RRM11acMadtMaxNss_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 1, 1, 12),
    _H3cDot11RRM11acMadtMaxNss_Type()
)
h3cDot11RRM11acMadtMaxNss.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cDot11RRM11acMadtMaxNss.setStatus("current")


class _H3cDot11RRM11acSuptMaxNss_Type(Integer32):
    """Custom type h3cDot11RRM11acSuptMaxNss based on Integer32"""
    defaultValue = 8
...
_H3cDot11RRM11acSuptMaxNss_Type.__name__ = "Integer32"
_H3cDot11RRM11acSuptMaxNss_Object = MibScalar
h3cDot11RRM11acSuptMaxNss = _H3cDot11RRM11acSuptMaxNss_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 1, 1, 13),
    _H3cDot11RRM11acSuptMaxNss_Type()
)
h3cDot11RRM11acSuptMaxNss.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cDot11RRM11acSuptMaxNss.setStatus("current")


class _H3cDot11RRM11acMultiCastNss_Type(Integer32):
    """Custom type h3cDot11RRM11acMultiCastNss based on Integer32"""
    defaultValue = 0
...
_H3cDot11RRM11acMultiCastNss_Type.__name__ = "Integer32"
_H3cDot11RRM11acMultiCastNss_Object = MibScalar
h3cDot11RRM11acMultiCastNss = _H3cDot11RRM11acMultiCastNss_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 1, 1, 14),
    _H3cDot11RRM11acMultiCastNss_Type()
)
h3cDot11RRM11acMultiCastNss.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cDot11RRM11acMultiCastNss.setStatus("current")


class _H3cDot11RRM11acMultiCastVhtMcs_Type(Integer32):
    """Custom type h3cDot11RRM11acMultiCastVhtMcs based on Integer32"""
    defaultValue = 255
...
_H3cDot11RRM11acMultiCastVhtMcs_Type.__name__ = "Integer32"
_H3cDot11RRM11acMultiCastVhtMcs_Object = MibScalar
h3cDot11RRM11acMultiCastVhtMcs = _H3cDot11RRM11acMultiCastVhtMcs_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 1, 1, 15),
    _H3cDot11RRM11acMultiCastVhtMcs_Type()
)
h3cDot11RRM11acMultiCastVhtMcs.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cDot11RRM11acMultiCastVhtMcs.setStatus("current")
...
h3cDot11RrmNbrSNR = _H3cDot11RrmNbrSNR_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 2, 2, 1, 7),
    _H3cDot11RrmNbrSNR_Type()
)
h3cDot11RrmNbrSNR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11RrmNbrSNR.setStatus("current")
if mibBuilder.loadTexts:
    h3cDot11RrmNbrSNR.setUnits("dB")
_H3cDot11RrmNbrNF_Type = Integer32
_H3cDot11RrmNbrNF_Object = MibTableColumn
h3cDot11RrmNbrNF = _H3cDot11RrmNbrNF_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 2, 2, 1, 8),
    _H3cDot11RrmNbrNF_Type()
)
h3cDot11RrmNbrNF.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11RrmNbrNF.setStatus("current")
if mibBuilder.loadTexts:
    h3cDot11RrmNbrNF.setUnits("dBm")
...
h3cDot11RRMRadioNbrInfoTable = _H3cDot11RRMRadioNbrInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 2, 4)
)
if mibBuilder.loadTexts:
    h3cDot11RRMRadioNbrInfoTable.setStatus("current")
_H3cDot11RRMRadioNbrInfoEntry_Object = MibTableRow
h3cDot11RRMRadioNbrInfoEntry = _H3cDot11RRMRadioNbrInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 2, 4, 1)
)
h3cDot11RRMRadioNbrInfoEntry.setIndexNames(
    (0, "H3C-DOT11-RRM-MIB", "h3cDot11RRMRadioNbrAPID"),
    (0, "H3C-DOT11-RRM-MIB", "h3cDot11RRMRadioNbrRadioID"),
)
if mibBuilder.loadTexts:
    h3cDot11RRMRadioNbrInfoEntry.setStatus("current")
_H3cDot11RRMRadioNbrAPID_Type = H3cDot11ObjectIDType
_H3cDot11RRMRadioNbrAPID_Object = MibTableColumn
h3cDot11RRMRadioNbrAPID = _H3cDot11RRMRadioNbrAPID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 2, 4, 1, 1),
    _H3cDot11RRMRadioNbrAPID_Type()
)
h3cDot11RRMRadioNbrAPID.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cDot11RRMRadioNbrAPID.setStatus("current")
_H3cDot11RRMRadioNbrRadioID_Type = H3cDot11RadioScopeType
_H3cDot11RRMRadioNbrRadioID_Object = MibTableColumn
h3cDot11RRMRadioNbrRadioID = _H3cDot11RRMRadioNbrRadioID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 2, 4, 1, 2),
    _H3cDot11RRMRadioNbrRadioID_Type()
)
h3cDot11RRMRadioNbrRadioID.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cDot11RRMRadioNbrRadioID.setStatus("current")
_H3cDot11RRMRadioNbrSSID_Type = OctetString
_H3cDot11RRMRadioNbrSSID_Object = MibTableColumn
h3cDot11RRMRadioNbrSSID = _H3cDot11RRMRadioNbrSSID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 75, 8, 2, 4, 1, 3),
    _H3cDot11RRMRadioNbrSSID_Type()
)
h3cDot11RRMRadioNbrSSID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cDot11RRMRadioNbrSSID.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"h3cDot11RRM": h3cDot11RRM,
       ...
       "h3cDot11RRM11nMultiCastMcs": h3cDot11RRM11nMultiCastMcs,
       "h3cDot11RRM11acMadtMaxNss": h3cDot11RRM11acMadtMaxNss,
       "h3cDot11RRM11acSuptMaxNss": h3cDot11RRM11acSuptMaxNss,
       "h3cDot11RRM11acMultiCastNss": h3cDot11RRM11acMultiCastNss,
       "h3cDot11RRM11acMultiCastVhtMcs": h3cDot11RRM11acMultiCastVhtMcs,
       ...
       "h3cDot11RrmNbrSNR": h3cDot11RrmNbrSNR,
       "h3cDot11RrmNbrNF": h3cDot11RrmNbrNF,
       ...
       "h3cDot11RRMRadioNbrInfoTable": h3cDot11RRMRadioNbrInfoTable,
       "h3cDot11RRMRadioNbrInfoEntry": h3cDot11RRMRadioNbrInfoEntry,
       "h3cDot11RRMRadioNbrAPID": h3cDot11RRMRadioNbrAPID,
       "h3cDot11RRMRadioNbrRadioID": h3cDot11RRMRadioNbrRadioID,
       "h3cDot11RRMRadioNbrSSID": h3cDot11RRMRadioNbrSSID,
