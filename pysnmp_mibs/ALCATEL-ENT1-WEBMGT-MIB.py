# SNMP MIB module (ALCATEL-ENT1-WEBMGT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-WEBMGT-MIB
...
alaIND1WebMgtConfigMIBGroup.setObjects(
      *(("ALCATEL-ENT1-WEBMGT-MIB", "alaIND1WebMgtAdminStatus"),
        ...
        ("ALCATEL-ENT1-WEBMGT-MIB", "alaIND1WebMgtHttpsPort"),
        ("ALCATEL-ENT1-WEBMGT-MIB", "alaIND1WebMgtServerStatus"),
        ("ALCATEL-ENT1-WEBMGT-MIB", "alaIND1WebMgtServerError"),
        ("ALCATEL-ENT1-WEBMGT-MIB", "webMgtServerError"))
)
if mibBuilder.loadTexts:
...
alaIND1WebMgtConfigMIBCertGroup.setObjects(
      *(("ALCATEL-ENT1-WEBMGT-MIB", "alcatelIND1WebMgtCertFile"),
        ("ALCATEL-ENT1-WEBMGT-MIB", "alcatelIND1WebMgtCertMD5"))
)
if mibBuilder.loadTexts:
...
alaIND1WebMgtNotificationGroup.setObjects(
    ("ALCATEL-ENT1-WEBMGT-MIB", "webMgtServerErrorTrap")
)
if mibBuilder.loadTexts:
...
alaIND1WebMgtConfigMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-WEBMGT-MIB", "alaIND1WebMgtConfigMIBGroup"),
        ("ALCATEL-ENT1-WEBMGT-MIB", "alaIND1WebMgtNotificationGroup"),
        ("ALCATEL-ENT1-WEBMGT-MIB", "alaIND1WebMgtConfigMIBCertGroup"))
)
if mibBuilder.loadTexts:
