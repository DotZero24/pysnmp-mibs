...
ipCmnMRouteMIB=ModuleIdentity((1,3,6,1,4,1,2076,126))
...
mfwdCmnMIBObjects=_MfwdCmnMIBObjects_ObjectIdentity((1,3,6,1,4,1,2076,126,1))
_MfwdCmnScalars_ObjectIdentity=ObjectIdentity
mfwdCmnScalars=_MfwdCmnScalars_ObjectIdentity((1,3,6,1,4,1,2076,126,1,1))
...
ipCmnMRouteEnable=_IpCmnMRouteEnable_Object((1,3,6,1,4,1,2076,126,1,1,1),_IpCmnMRouteEnable_Type())
...
ipCmnMRouteEntryCount=_IpCmnMRouteEntryCount_Object((1,3,6,1,4,1,2076,126,1,1,2),_IpCmnMRouteEntryCount_Type())
...
ipCmnMRouteEnableCmdb=_IpCmnMRouteEnableCmdb_Object((1,3,6,1,4,1,2076,126,1,1,3),_IpCmnMRouteEnableCmdb_Type())
...
mfwdCmnGlobalTrace=_MfwdCmnGlobalTrace_Object((1,3,6,1,4,1,2076,126,1,1,4),_MfwdCmnGlobalTrace_Type())
...
mfwdCmnGlobalDebug=_MfwdCmnGlobalDebug_Object((1,3,6,1,4,1,2076,126,1,1,5),_MfwdCmnGlobalDebug_Type())
...
ipCmnMRouteDiscardedPkts=_IpCmnMRouteDiscardedPkts_Object((1,3,6,1,4,1,2076,126,1,1,6),_IpCmnMRouteDiscardedPkts_Type())
...
mfwdCmnAvgDataRate=_MfwdCmnAvgDataRate_Object((1,3,6,1,4,1,2076,126,1,1,7),_MfwdCmnAvgDataRate_Type())
...
mfwdCmnTables=_MfwdCmnTables_ObjectIdentity((1,3,6,1,4,1,2076,126,1,2))
_IpCmnMRouteTable_Object=MibTable
ipCmnMRouteTable=_IpCmnMRouteTable_Object((1,3,6,1,4,1,2076,126,1,2,1))
if mibBuilder.loadTexts:ipCmnMRouteTable.setStatus(_A)
_IpCmnMRouteEntry_Object=MibTableRow
ipCmnMRouteEntry=_IpCmnMRouteEntry_Object((1,3,6,1,4,1,2076,126,1,2,1,1))
...
ipCmnMRouteOwnerId=_IpCmnMRouteOwnerId_Object((1,3,6,1,4,1,2076,126,1,2,1,1,1),_IpCmnMRouteOwnerId_Type())
...
ipCmnMRouteAddrType=_IpCmnMRouteAddrType_Object((1,3,6,1,4,1,2076,126,1,2,1,1,2),_IpCmnMRouteAddrType_Type())
...
ipCmnMRouteGroup=_IpCmnMRouteGroup_Object((1,3,6,1,4,1,2076,126,1,2,1,1,3),_IpCmnMRouteGroup_Type())
...
ipCmnMRouteSource=_IpCmnMRouteSource_Object((1,3,6,1,4,1,2076,126,1,2,1,1,4),_IpCmnMRouteSource_Type())
...
ipCmnMRouteSourceMask=_IpCmnMRouteSourceMask_Object((1,3,6,1,4,1,2076,126,1,2,1,1,5),_IpCmnMRouteSourceMask_Type())
...
ipCmnMRouteUpstreamNeighbor=_IpCmnMRouteUpstreamNeighbor_Object((1,3,6,1,4,1,2076,126,1,2,1,1,6),_IpCmnMRouteUpstreamNeighbor_Type())
...
ipCmnMRouteInIfIndex=_IpCmnMRouteInIfIndex_Object((1,3,6,1,4,1,2076,126,1,2,1,1,7),_IpCmnMRouteInIfIndex_Type())
...
ipCmnMRouteUpTime=_IpCmnMRouteUpTime_Object((1,3,6,1,4,1,2076,126,1,2,1,1,8),_IpCmnMRouteUpTime_Type())
...
ipCmnMRoutePkts=_IpCmnMRoutePkts_Object((1,3,6,1,4,1,2076,126,1,2,1,1,9),_IpCmnMRoutePkts_Type())
...
ipCmnMRouteDifferentInIfPackets=_IpCmnMRouteDifferentInIfPackets_Object((1,3,6,1,4,1,2076,126,1,2,1,1,10),_IpCmnMRouteDifferentInIfPackets_Type())
...
ipCmnMRouteProtocol=_IpCmnMRouteProtocol_Object((1,3,6,1,4,1,2076,126,1,2,1,1,11),_IpCmnMRouteProtocol_Type())
...
ipCmnMRouteRtAddress=_IpCmnMRouteRtAddress_Object((1,3,6,1,4,1,2076,126,1,2,1,1,12),_IpCmnMRouteRtAddress_Type())
...
ipCmnMRouteRtMask=_IpCmnMRouteRtMask_Object((1,3,6,1,4,1,2076,126,1,2,1,1,13),_IpCmnMRouteRtMask_Type())
...
ipCmnMRouteRtType=_IpCmnMRouteRtType_Object((1,3,6,1,4,1,2076,126,1,2,1,1,14),_IpCmnMRouteRtType_Type())
...
ipCmnMRouteNextHopTable=_IpCmnMRouteNextHopTable_Object((1,3,6,1,4,1,2076,126,1,2,2))
if mibBuilder.loadTexts:ipCmnMRouteNextHopTable.setStatus(_A)
_IpCmnMRouteNextHopEntry_Object=MibTableRow
ipCmnMRouteNextHopEntry=_IpCmnMRouteNextHopEntry_Object((1,3,6,1,4,1,2076,126,1,2,2,1))
...
ipCmnMRouteNextHopOwnerId=_IpCmnMRouteNextHopOwnerId_Object((1,3,6,1,4,1,2076,126,1,2,2,1,1),_IpCmnMRouteNextHopOwnerId_Type())
...
ipCmnMRouteNextHopAddrType=_IpCmnMRouteNextHopAddrType_Object((1,3,6,1,4,1,2076,126,1,2,2,1,2),_IpCmnMRouteNextHopAddrType_Type())
...
ipCmnMRouteNextHopGroup=_IpCmnMRouteNextHopGroup_Object((1,3,6,1,4,1,2076,126,1,2,2,1,3),_IpCmnMRouteNextHopGroup_Type())
...
ipCmnMRouteNextHopSource=_IpCmnMRouteNextHopSource_Object((1,3,6,1,4,1,2076,126,1,2,2,1,4),_IpCmnMRouteNextHopSource_Type())
...
ipCmnMRouteNextHopSourceMask=_IpCmnMRouteNextHopSourceMask_Object((1,3,6,1,4,1,2076,126,1,2,2,1,5),_IpCmnMRouteNextHopSourceMask_Type())
...
ipCmnMRouteNextHopIfIndex=_IpCmnMRouteNextHopIfIndex_Object((1,3,6,1,4,1,2076,126,1,2,2,1,6),_IpCmnMRouteNextHopIfIndex_Type())
...
ipCmnMRouteNextHopAddress=_IpCmnMRouteNextHopAddress_Object((1,3,6,1,4,1,2076,126,1,2,2,1,7),_IpCmnMRouteNextHopAddress_Type())
...
ipCmnMRouteNextHopState=_IpCmnMRouteNextHopState_Object((1,3,6,1,4,1,2076,126,1,2,2,1,8),_IpCmnMRouteNextHopState_Type())
...
ipCmnMRouteNextHopUpTime=_IpCmnMRouteNextHopUpTime_Object((1,3,6,1,4,1,2076,126,1,2,2,1,9),_IpCmnMRouteNextHopUpTime_Type())
...
ipCmnMRouteInterfaceTable=_IpCmnMRouteInterfaceTable_Object((1,3,6,1,4,1,2076,126,1,2,3))
if mibBuilder.loadTexts:ipCmnMRouteInterfaceTable.setStatus(_A)
_IpCmnMRouteInterfaceEntry_Object=MibTableRow
ipCmnMRouteInterfaceEntry=_IpCmnMRouteInterfaceEntry_Object((1,3,6,1,4,1,2076,126,1,2,3,1))
...
ipCmnMRouteInterfaceIfIndex=_IpCmnMRouteInterfaceIfIndex_Object((1,3,6,1,4,1,2076,126,1,2,3,1,1),_IpCmnMRouteInterfaceIfIndex_Type())
...
ipCmnMRouteInterfaceAddrType=_IpCmnMRouteInterfaceAddrType_Object((1,3,6,1,4,1,2076,126,1,2,3,1,2),_IpCmnMRouteInterfaceAddrType_Type())
...
ipCmnMRouteInterfaceOwnerId=_IpCmnMRouteInterfaceOwnerId_Object((1,3,6,1,4,1,2076,126,1,2,3,1,3),_IpCmnMRouteInterfaceOwnerId_Type())
...
ipCmnMRouteInterfaceTtl=_IpCmnMRouteInterfaceTtl_Object((1,3,6,1,4,1,2076,126,1,2,3,1,4),_IpCmnMRouteInterfaceTtl_Type())
...
ipCmnMRouteInterfaceProtocol=_IpCmnMRouteInterfaceProtocol_Object((1,3,6,1,4,1,2076,126,1,2,3,1,5),_IpCmnMRouteInterfaceProtocol_Type())
...
ipCmnMRouteInterfaceRateLimit=_IpCmnMRouteInterfaceRateLimit_Object((1,3,6,1,4,1,2076,126,1,2,3,1,6),_IpCmnMRouteInterfaceRateLimit_Type())
...
ipCmnMRouteInterfaceInMcastOctets=_IpCmnMRouteInterfaceInMcastOctets_Object((1,3,6,1,4,1,2076,126,1,2,3,1,7),_IpCmnMRouteInterfaceInMcastOctets_Type())
...
ipCmnMRouteInterfaceCmdbPktCnt=_IpCmnMRouteInterfaceCmdbPktCnt_Object((1,3,6,1,4,1,2076,126,1,2,3,1,8),_IpCmnMRouteInterfaceCmdbPktCnt_Type())
...
ipCmnMRouteInterfaceOutMcastOctets=_IpCmnMRouteInterfaceOutMcastOctets_Object((1,3,6,1,4,1,2076,126,1,2,3,1,9),_IpCmnMRouteInterfaceOutMcastOctets_Type())
...
mfwdCmnTraps=_MfwdCmnTraps_ObjectIdentity((1,3,6,1,4,1,2076,126,1,3))
_IpCmnMRouteMIBConformance_ObjectIdentity=ObjectIdentity
ipCmnMRouteMIBConformance=_IpCmnMRouteMIBConformance_ObjectIdentity((1,3,6,1,4,1,2076,126,2))
_IpCmnMRouteMIBCompliances_ObjectIdentity=ObjectIdentity
ipCmnMRouteMIBCompliances=_IpCmnMRouteMIBCompliances_ObjectIdentity((1,3,6,1,4,1,2076,126,2,1))
_IpCmnMRouteMIBGroups_ObjectIdentity=ObjectIdentity
ipCmnMRouteMIBGroups=_IpCmnMRouteMIBGroups_ObjectIdentity((1,3,6,1,4,1,2076,126,2,2))
ipCmnMRouteMIBBasicGroup=ObjectGroup((1,3,6,1,4,1,2076,126,2,2,1))
