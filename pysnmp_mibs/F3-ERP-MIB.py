...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/adva/F3-ERP-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 11:03:07 2025
...
VlanId, VlanPriority, OperationalState, SecondaryState, AdminState, VlanEthertype = mibBuilder.importSymbols("CM-COMMON-MIB", "VlanId", "VlanPriority", "OperationalState", "SecondaryState", "AdminState", "VlanEthertype")
...
mibBuilder.exportSymbols("F3-ERP-MIB", f3ErpUnitPortRole=f3ErpUnitPortRole, f3ErpGroupRingPort0=f3ErpGroupRingPort0, f3ErpGroupRapsMultipleFailure=f3ErpGroupRapsMultipleFailure, f3ErpGroupUserLabel=f3ErpGroupUserLabel, f3ErpUnitRapsEventPDUsRx=f3ErpUnitRapsEventPDUsRx, f3ErpUnitRapsRsvdEventSubcode=f3ErpUnitRapsRsvdEventSubcode, f3ErpGroupRapsMdLevel=f3ErpGroupRapsMdLevel, f3ErpUnitPortRxRapsRequest=f3ErpUnitPortRxRapsRequest, f3ErpUnitPortRxRapsNodeId=f3ErpUnitPortRxRapsNodeId, RapsMultipleFailure=RapsMultipleFailure, f3ErpUnitRapsPDUsRx=f3ErpUnitRapsPDUsRx, RapsInterconnectionNode=RapsInterconnectionNode, f3ErpUnitRapsSignalFailPDUsRx=f3ErpUnitRapsSignalFailPDUsRx, f3ErpUnitPortRxRapsDNF=f3ErpUnitPortRxRapsDNF, RingNodeState=RingNodeState, f3ErpUnitRapsNoReqRBPDUsRx=f3ErpUnitRapsNoReqRBPDUsRx, f3ErpGroupProtectedFlowTable=f3ErpGroupProtectedFlowTable, f3ErpGroupActionObject=f3ErpGroupActionObject, f3ErpCompliance=f3ErpCompliance, f3ErpGroups=f3ErpGroups, f3ErpUnitIndex=f3ErpUnitIndex, f3ErpUnitRapsPDUsTx=f3ErpUnitRapsPDUsTx, f3ErpGroupTxRapsRplBlocked=f3ErpGroupTxRapsRplBlocked, f3ErpUnitRapsForcedSwitchPDUsRx=f3ErpUnitRapsForcedSwitchPDUsRx, f3ErpGroupRingPort1Role=f3ErpGroupRingPort1Role, f3ErpUnitRapsPDUsDiscarded=f3ErpUnitRapsPDUsDiscarded, f3ErpGroupRapsVlanId=f3ErpGroupRapsVlanId, RingPortStatus=RingPortStatus, f3ErpGroupRapsVlanPrio=f3ErpGroupRapsVlanPrio, f3ErpGroupStorageType=f3ErpGroupStorageType, f3ErpGroupProtectedFlow=f3ErpGroupProtectedFlow, f3ErpUnitStatsGroup=f3ErpUnitStatsGroup, RPLRole=RPLRole, f3ErpUnitPort=f3ErpUnitPort, f3ErpStatsObjects=f3ErpStatsObjects, f3ErpUnitRapsNoReqPDUsTx=f3ErpUnitRapsNoReqPDUsTx, ERPGroupAction=ERPGroupAction, f3ErpGroupRevertive=f3ErpGroupRevertive, f3ErpUnitRapsNoReqRBPDUsTx=f3ErpUnitRapsNoReqRBPDUsTx, RAPSRequest=RAPSRequest, f3ErpGroupWTRRemainingTime=f3ErpGroupWTRRemainingTime, f3ErpGroupInterconnectionErp=f3ErpGroupInterconnectionErp, f3ErpGroupWaitToRestore=f3ErpGroupWaitToRestore, f3ErpUnitEntry=f3ErpUnitEntry, f3ErpGroupRingPort0Role=f3ErpGroupRingPort0Role, f3ErpGroupTxRapsRequest=f3ErpGroupTxRapsRequest, f3ErpGroupRingPort1MEP=f3ErpGroupRingPort1MEP, f3ErpGroupRingPort0MEP=f3ErpGroupRingPort0MEP, f3ErpUnitRapsInvalidOamVersionPDUsRx=f3ErpUnitRapsInvalidOamVersionPDUsRx, G8032Version=G8032Version, f3ErpUnitPortStatus=f3ErpUnitPortStatus, f3ErpGroupSubRingWithoutVirtChan=f3ErpGroupSubRingWithoutVirtChan, f3ErpGroupRapsVirtualChannelMep=f3ErpGroupRapsVirtualChannelMep, f3ErpConformance=f3ErpConformance, f3ErpGroupRowStatus=f3ErpGroupRowStatus, f3ErpGroupRapsRingId=f3ErpGroupRapsRingId, f3ErpGroupHoldOffTime=f3ErpGroupHoldOffTime, f3ErpUnitGroup=f3ErpUnitGroup, f3ErpUnitNumBlockedStateTrans=f3ErpUnitNumBlockedStateTrans, f3ErpUnitRapsManualSwitchPDUsRx=f3ErpUnitRapsManualSwitchPDUsRx, f3ErpGroupRingPort1=f3ErpGroupRingPort1, f3ErpUnitRapsRsvdRequestPDUsRx=f3ErpUnitRapsRsvdRequestPDUsRx, f3ErpUnitRapsEventPDUsTx=f3ErpUnitRapsEventPDUsTx, f3ErpUnitPortMEP=f3ErpUnitPortMEP, f3ErpGroupProtectMgmtTunnel=f3ErpGroupProtectMgmtTunnel, f3ErpConfigObjects=f3ErpConfigObjects, PYSNMP_MODULE_ID=f3ErpMIB, f3ErpGroupOperationalState=f3ErpGroupOperationalState, f3ErpUnitRapsManualSwitchPDUsTx=f3ErpUnitRapsManualSwitchPDUsTx, f3ErpCompliances=f3ErpCompliances, f3ErpUnitTable=f3ErpUnitTable, f3ErpUnitRapsForcedSwitchPDUsTx=f3ErpUnitRapsForcedSwitchPDUsTx, f3ErpMIB=f3ErpMIB, f3ErpGroupTxRapsDNF=f3ErpGroupTxRapsDNF, f3ErpGroupIndex=f3ErpGroupIndex, f3ErpGroupSecondaryState=f3ErpGroupSecondaryState, f3ErpGroupTxRapsBPR=f3ErpGroupTxRapsBPR, f3ErpUnitStatsTable=f3ErpUnitStatsTable, f3ErpUnitRapsSignalFailPDUsTx=f3ErpUnitRapsSignalFailPDUsTx, f3ErpGroupAdminState=f3ErpGroupAdminState, f3ErpUnitPortRxRapsBPR=f3ErpUnitPortRxRapsBPR, f3ErpUnitPortRxRapsRplBlocked=f3ErpUnitPortRxRapsRplBlocked, f3ErpGroupProtectedFlowEntry=f3ErpGroupProtectedFlowEntry, f3ErpGroupMaxFpNum=f3ErpGroupMaxFpNum, f3ErpGroupRapsInterconnectionNode=f3ErpGroupRapsInterconnectionNode, f3ErpGroupRapsVlanEtherType=f3ErpGroupRapsVlanEtherType, f3ErpGroupGroup=f3ErpGroupGroup, f3ErpGroupCompatibleVersion=f3ErpGroupCompatibleVersion, f3ErpUnitPortRapsFp=f3ErpUnitPortRapsFp, f3ErpGroupInterconnectPropagateTc=f3ErpGroupInterconnectPropagateTc, f3ErpGroupTable=f3ErpGroupTable, f3ErpGroupEntry=f3ErpGroupEntry, f3ErpUnitRapsNoReqPDUsRx=f3ErpUnitRapsNoReqPDUsRx, f3ErpGroupAction=f3ErpGroupAction, f3ErpGroupNodeState=f3ErpGroupNodeState, f3ErpGroupGuardTime=f3ErpGroupGuardTime, f3ErpGroupRapsNodeId=f3ErpGroupRapsNodeId, f3ErpUnitStatsEntry=f3ErpUnitStatsEntry)
