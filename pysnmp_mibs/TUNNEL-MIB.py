...
mibBuilder.exportSymbols("TUNNEL-MIB", tunnelConfigRemoteAddress=tunnelConfigRemoteAddress, tunnelInetConfigTable=tunnelInetConfigTable, tunnelMIBInetFullCompliance=tunnelMIBInetFullCompliance, tunnelConfigIfIndex=tunnelConfigIfIndex, tunnelInetConfigAddressType=tunnelInetConfigAddressType, tunnelMIBConformance=tunnelMIBConformance, tunnelMIBCompliances=tunnelMIBCompliances, tunnelIfLocalAddress=tunnelIfLocalAddress, tunnelConfigLocalAddress=tunnelConfigLocalAddress, tunnelInetConfigID=tunnelInetConfigID, tunnelIfEncapsLimit=tunnelIfEncapsLimit, tunnelInetConfigStorageType=tunnelInetConfigStorageType, tunnelInetConfigStatus=tunnelInetConfigStatus, tunnelInetConfigIfIndex=tunnelInetConfigIfIndex, tunnelMIBBasicGroup=tunnelMIBBasicGroup, tunnelConfigStatus=tunnelConfigStatus, tunnelIfFlowLabel=tunnelIfFlowLabel, PYSNMP_MODULE_ID=tunnelMIB, tunnelIfHopLimit=tunnelIfHopLimit, tunnelInetConfigRemoteAddress=tunnelInetConfigRemoteAddress, tunnelIfSecurity=tunnelIfSecurity, tunnelIfTable=tunnelIfTable, tunnelIfEncapsMethod=tunnelIfEncapsMethod, tunnelIfAddressType=tunnelIfAddressType, tunnelIfTOS=tunnelIfTOS, tunnelInetConfigEncapsMethod=tunnelInetConfigEncapsMethod, tunnelMIBInetReadOnlyCompliance=tunnelMIBInetReadOnlyCompliance, tunnelIfEntry=tunnelIfEntry, tunnelIfLocalInetAddress=tunnelIfLocalInetAddress, tunnelConfigEncapsMethod=tunnelConfigEncapsMethod, tunnelMIBObjects=tunnelMIBObjects, tunnelInetConfigEntry=tunnelInetConfigEntry, tunnelMIBGroups=tunnelMIBGroups, tunnelConfigEntry=tunnelConfigEntry, tunnelIfRemoteInetAddress=tunnelIfRemoteInetAddress, tunnelInetConfigLocalAddress=tunnelInetConfigLocalAddress, tunnelMIBInetGroup=tunnelMIBInetGroup, tunnelMIB=tunnelMIB, tunnelMIBCompliance=tunnelMIBCompliance, tunnelConfigID=tunnelConfigID, tunnel=tunnel, tunnelIfRemoteAddress=tunnelIfRemoteAddress, tunnelConfigTable=tunnelConfigTable)
