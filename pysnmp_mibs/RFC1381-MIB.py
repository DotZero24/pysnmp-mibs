...
mibBuilder.exportSymbols("RFC1381-MIB", lapbAdmnIndex=lapbAdmnIndex, lapbAdmnEntry=lapbAdmnEntry, lapbProtocolCcittV1984=lapbProtocolCcittV1984, lapbAdmnT4IdleTimer=lapbAdmnT4IdleTimer, lapbOperTransmitN1FrameSize=lapbOperTransmitN1FrameSize, lapbOperTable=lapbOperTable, lapbAdmnControlField=lapbAdmnControlField, IfIndexType=IfIndexType, lapbOperN2RxmitCount=lapbOperN2RxmitCount, lapbFlowFrmrReceived=lapbFlowFrmrReceived, lapbXidGroupAddress=lapbXidGroupAddress, lapbOperIndex=lapbOperIndex, lapbOperT2AckDelayTimer=lapbOperT2AckDelayTimer, lapbXidUserDataSubfield=lapbXidUserDataSubfield, lapbFlowStateChanges=lapbFlowStateChanges, lapbProtocolCcittV1980=lapbProtocolCcittV1980, lapbOperPortId=lapbOperPortId, lapbFlowChangeReason=lapbFlowChangeReason, lapbAdmnTransmitKWindowSize=lapbAdmnTransmitKWindowSize, lapbAdmnT1AckTimer=lapbAdmnT1AckTimer, lapbOperEntry=lapbOperEntry, lapbOperT1AckTimer=lapbOperT1AckTimer, lapbOperT3DisconnectTimer=lapbOperT3DisconnectTimer, lapbFlowXidReceived=lapbFlowXidReceived, lapbFlowRejInPkts=lapbFlowRejInPkts, lapbAdmnStationType=lapbAdmnStationType, lapbAdmnActionInitiate=lapbAdmnActionInitiate, lapbXidPortNumber=lapbXidPortNumber, lapbAdmnTable=lapbAdmnTable, lapbOperT4IdleTimer=lapbOperT4IdleTimer, lapbProtocolIso7776v1986=lapbProtocolIso7776v1986, lapbOperProtocolVersionId=lapbOperProtocolVersionId, lapbXidEntry=lapbXidEntry, lapbOperReceiveN1FrameSize=lapbOperReceiveN1FrameSize, lapbOperStationType=lapbOperStationType, lapbAdmnTransmitN1FrameSize=lapbAdmnTransmitN1FrameSize, lapbFlowRejOutPkts=lapbFlowRejOutPkts, lapbFlowBusyDefers=lapbFlowBusyDefers, lapbFlowT1Timeouts=lapbFlowT1Timeouts, lapbAdmnT3DisconnectTimer=lapbAdmnT3DisconnectTimer, lapbOperControlField=lapbOperControlField, lapbXidIndex=lapbXidIndex, lapbXidAdRIdentifier=lapbXidAdRIdentifier, lapbAdmnActionRecvDM=lapbAdmnActionRecvDM, lapbProtocolVersion=lapbProtocolVersion, PositiveInteger=PositiveInteger, lapbFlowTable=lapbFlowTable, lapbFlowIfIndex=lapbFlowIfIndex, lapbOperTransmitKWindowSize=lapbOperTransmitKWindowSize, lapbAdmnN2RxmitCount=lapbAdmnN2RxmitCount, lapbAdmnReceiveKWindowSize=lapbAdmnReceiveKWindowSize, lapbOperReceiveKWindowSize=lapbOperReceiveKWindowSize, lapb=lapb, lapbAdmnT2AckDelayTimer=lapbAdmnT2AckDelayTimer, lapbFlowEntry=lapbFlowEntry, lapbFlowCurrentMode=lapbFlowCurrentMode, lapbFlowFrmrSent=lapbFlowFrmrSent, lapbXidTable=lapbXidTable, lapbXidParameterUniqueIdentifier=lapbXidParameterUniqueIdentifier, lapbXidAdRAddress=lapbXidAdRAddress, lapbAdmnReceiveN1FrameSize=lapbAdmnReceiveN1FrameSize)
