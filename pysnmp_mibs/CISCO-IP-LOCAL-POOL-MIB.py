...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IP-LOCAL-POOL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:34:39 2025
...
class _CIpLocalPoolGroupContainedIn_Type(CIpLocalPoolGroupNameOrNull):
    """Custom type cIpLocalPoolGroupContainedIn based on CIpLocalPoolGroupNameOrNull"""
    defaultValue = OctetString("")


_CIpLocalPoolGroupContainedIn_Type.__name__ = "CIpLocalPoolGroupNameOrNull"
...
_CIpLocalPoolPercentAddrThldLo_Type.__name__ = "CIpLocalPoolPercentage"
...
_CIpLocalPoolPercentAddrThldHi_Type.__name__ = "CIpLocalPoolPercentage"
...
ciscoIpLocalPoolMIBCompliance.setObjects(
      *(("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolConfigGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolStatsGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolGroupGroup"))
)
if mibBuilder.loadTexts:
...
ciscoIpLocalPoolMIBCompliance1.setObjects(
      *(("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolConfigGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolStatsGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolNotifGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolGroupGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolStatsGroupSup1"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolNotifGroupSup1"))
)
if mibBuilder.loadTexts:
...
ciscoIpLocalPoolMIBCompliance2.setObjects(
      *(("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolConfigGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolStatsGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolNotifGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolPriorityGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolGroupGroup"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolStatsGroupSup1"),
        ("CISCO-IP-LOCAL-POOL-MIB", "ciscoIpLocalPoolNotifGroupSup1"))
)
