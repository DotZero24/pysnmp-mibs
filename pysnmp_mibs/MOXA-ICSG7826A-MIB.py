# SNMP MIB module (MOXA-ICSG7826A-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/moxa/MOXA-ICSG7826A-MIB
...
icsg7826a = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99)
)
if mibBuilder.loadTexts:
    icsg7826a.setRevisions(
        ("2016-07-20 00:00",
         "2015-06-26 00:00")
    )
...
portIndex = _PortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 9, 1, 1, 1),
    _PortIndex_Type()
)
...
portDesc = _PortDesc_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 9, 1, 1, 2),
    _PortDesc_Type()
)
...
portEnable = _PortEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 9, 1, 1, 3),
    _PortEnable_Type()
)
...
portMDI = _PortMDI_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 9, 1, 1, 5),
    _PortMDI_Type()
)
...
portFDXFlowCtrl = _PortFDXFlowCtrl_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 9, 1, 1, 6),
...
portName = _PortName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 9, 1, 1, 7),
    _PortName_Type()
)
...
monitorLinkStatus = _MonitorLinkStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 3, 1, 2),
...
monitorAutoMDI = _MonitorAutoMDI_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 3, 1, 4),
...
monitorTraffic = _MonitorTraffic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 3, 1, 5),
...
monitorFDXFlowCtrl = _MonitorFDXFlowCtrl_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 3, 1, 6),
...
monitorTxTraffic = _MonitorTxTraffic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 3, 1, 7),
...
monitorRxTraffic = _MonitorRxTraffic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 3, 1, 8),
...
diIndex = _DiIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 4, 1, 1),
    _DiIndex_Type()
)
...
diInputStatus = _DiInputStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 4, 1, 2),
    _DiInputStatus_Type()
)
...
sfpPort = _SfpPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 7, 1, 1),
    _SfpPort_Type()
)
...
sfpModelName = _SfpModelName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 7, 1, 2),
    _SfpModelName_Type()
)
...
sfpTemperature = _SfpTemperature_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 7, 1, 3),
...
sfpVoltage = _SfpVoltage_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 7, 1, 4),
    _SfpVoltage_Type()
)
...
sfpTxPower = _SfpTxPower_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 7, 1, 5),
    _SfpTxPower_Type()
)
...
sfpRxPower = _SfpRxPower_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 10, 7, 1, 6),
    _SfpRxPower_Type()
)
...
emailWarningMailServer = _EmailWarningMailServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 11, 1, 1),
...
emailWarningFirstEmailAddr = _EmailWarningFirstEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 11, 1, 2),
...
emailWarningSecondEmailAddr = _EmailWarningSecondEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 11, 1, 3),
...
emailWarningThirdEmailAddr = _EmailWarningThirdEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 11, 1, 4),
...
emailWarningFourthEmailAddr = _EmailWarningFourthEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 11, 1, 5),
...
emailWarningSMTPPort = _EmailWarningSMTPPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 11, 1, 6),
...
setDevIpIndex = _SetDevIpIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 12, 1, 1, 1),
    _SetDevIpIndex_Type()
)
...
setDevIpCurrentIpofDevice = _SetDevIpCurrentIpofDevice_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 12, 1, 1, 2),
...
setDevIpPresentBy = _SetDevIpPresentBy_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 12, 1, 1, 3),
...
setDevIpDedicatedIp = _SetDevIpDedicatedIp_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 12, 1, 1, 4),
...
trunkSettingIndex = _TrunkSettingIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 14, 1, 1, 1),
...
trunkType = _TrunkType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 14, 1, 1, 2),
    _TrunkType_Type()
)
...
trunkMemberPorts = _TrunkMemberPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 14, 1, 1, 3),
...
trunkTable = _TrunkTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 14, 2)
)
if mibBuilder.loadTexts:
    trunkTable.setStatus("current")
_TrunkEntry_Object = MibTableRow
trunkEntry = _TrunkEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 14, 2, 1)
)
trunkEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "trunkIndex"),
    (0, "MOXA-ICSG7826A-MIB", "trunkPort"),
)
if mibBuilder.loadTexts:
...
trunkIndex = _TrunkIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 14, 2, 1, 1),
    _TrunkIndex_Type()
)
...
trunkPort = _TrunkPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 14, 2, 1, 2),
    _TrunkPort_Type()
)
...
trunkStatus = _TrunkStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 14, 2, 1, 3),
    _TrunkStatus_Type()
)
...
turboRingMaster = _TurboRingMaster_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 1),
...
turboRingMasterSetup = _TurboRingMasterSetup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 2),
...
turboRingPortIndex = _TurboRingPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 3, 1, 1),
...
turboRingPortStatus = _TurboRingPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 3, 1, 2),
...
turboRingPortDesignatedBridge = _TurboRingPortDesignatedBridge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 3, 1, 3),
...
turboRingPortDesignatedPort = _TurboRingPortDesignatedPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 3, 1, 4),
...
turboRingDesignatedMaster = _TurboRingDesignatedMaster_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 6),
...
turboRingRdntPort1 = _TurboRingRdntPort1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 7),
...
turboRingRdntPort2 = _TurboRingRdntPort2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 8),
...
turboRingEnableCoupling = _TurboRingEnableCoupling_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 9),
...
turboRingCouplingPort = _TurboRingCouplingPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 10),
...
turboRingCouplingPortStatus = _TurboRingCouplingPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 11),
...
turboRingControlPort = _TurboRingControlPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 12),
...
turboRingControlPortStatus = _TurboRingControlPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 13),
...
turboRingBrokenStatus = _TurboRingBrokenStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 2, 14),
...
spanningTreeRoot = _SpanningTreeRoot_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 1),
...
spanningTreeBridgePriority = _SpanningTreeBridgePriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 2),
...
spanningTreeHelloTime = _SpanningTreeHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 3),
...
spanningTreeMaxAge = _SpanningTreeMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 4),
...
spanningTreeForwardingDelay = _SpanningTreeForwardingDelay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 5),
...
spanningTreeIndex = _SpanningTreeIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 6, 1, 1),
...
enableSpanningTree = _EnableSpanningTree_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 6, 1, 2),
...
spanningTreePortPriority = _SpanningTreePortPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 6, 1, 3),
...
spanningTreePortCost = _SpanningTreePortCost_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 6, 1, 4),
...
spanningTreePortStatus = _SpanningTreePortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 6, 1, 5),
...
spanningTreePortEdge = _SpanningTreePortEdge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 3, 6, 1, 6),
...
ringIndexRing1 = _RingIndexRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 1),
...
ringEnableRing1 = _RingEnableRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 2),
...
masterSetupRing1 = _MasterSetupRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 3),
...
masterStatusRing1 = _MasterStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 4),
...
designatedMasterRing1 = _DesignatedMasterRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 5),
...
rdnt1stPortRing1 = _Rdnt1stPortRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 6),
...
rdnt1stPortStatusRing1 = _Rdnt1stPortStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 7),
...
rdnt2ndPortRing1 = _Rdnt2ndPortRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 8),
...
rdnt2ndPortStatusRing1 = _Rdnt2ndPortStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 9),
...
brokenStatusRing1 = _BrokenStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 1, 10),
...
turboRingV2Ring2 = _TurboRingV2Ring2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2)
)
...
ringIndexRing2 = _RingIndexRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 1),
...
ringEnableRing2 = _RingEnableRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 2),
...
masterSetupRing2 = _MasterSetupRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 3),
...
masterStatusRing2 = _MasterStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 4),
...
designatedMasterRing2 = _DesignatedMasterRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 5),
...
rdnt1stPortRing2 = _Rdnt1stPortRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 6),
...
rdnt1stPortStatusRing2 = _Rdnt1stPortStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 7),
...
rdnt2ndPortRing2 = _Rdnt2ndPortRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 8),
...
rdnt2ndPortStatusRing2 = _Rdnt2ndPortStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 9),
...
brokenStatusRing2 = _BrokenStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 2, 10),
...
turboRingV2Coupling = _TurboRingV2Coupling_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 3)
)
...
couplingEnable = _CouplingEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 3, 1),
...
couplingMode = _CouplingMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 3, 2),
    _CouplingMode_Type()
)
...
coupling1stPort = _Coupling1stPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 3, 3),
...
coupling1stPortStatus = _Coupling1stPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 3, 4),
...
coupling2ndPort = _Coupling2ndPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 3, 5),
...
coupling2ndPortStatus = _Coupling2ndPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 5, 3, 6),
...
turboChainRole = _TurboChainRole_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 6, 1),
...
turboChainPort1 = _TurboChainPort1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 6, 2),
...
turboChainPort2 = _TurboChainPort2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 6, 3),
...
turboChainPort1Status = _TurboChainPort1Status_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 6, 4),
...
turboChainPort2Status = _TurboChainPort2Status_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 6, 5),
...
turboChainPort1PartnerBridge = _TurboChainPort1PartnerBridge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 6, 6),
...
turboChainPort2PartnerBridge = _TurboChainPort2PartnerBridge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 16, 6, 7),
...
relayAlarmIndex = _RelayAlarmIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 11, 1, 1),
...
relayWarningRelayContact = _RelayWarningRelayContact_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 11, 1, 2),
...
overrideRelayWarningSetting = _OverrideRelayWarningSetting_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 11, 1, 3),
...
relayWarningPower1Off = _RelayWarningPower1Off_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 11, 1, 4),
...
relayWarningPower1OffStatus = _RelayWarningPower1OffStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 11, 1, 5),
...
relayWarningPower2Off = _RelayWarningPower2Off_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 11, 1, 6),
...
relayWarningPower2OffStatus = _RelayWarningPower2OffStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 11, 1, 7),
...
relayWarningTurboRingBreak = _RelayWarningTurboRingBreak_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 11, 1, 8),
...
relayWarningTurboRingBreakStatus = _RelayWarningTurboRingBreakStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 11, 1, 9),
...
portRelayWarningEntry = _PortRelayWarningEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 12, 1)
)
...
relayWarningLinkChanged = _RelayWarningLinkChanged_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 12, 1, 1),
...
relayWarningLinkChangedStatus = _RelayWarningLinkChangedStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 12, 1, 2),
...
relayWarningTrafficOverload = _RelayWarningTrafficOverload_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 12, 1, 3),
...
relayWarningTrafficOverloadStatus = _RelayWarningTrafficOverloadStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 12, 1, 4),
...
relayWarningRxTrafficThreshold = _RelayWarningRxTrafficThreshold_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 12, 1, 5),
...
relayWarningTrafficDuration = _RelayWarningTrafficDuration_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 12, 1, 6),
...
diRelayWarningEntry = _DiRelayWarningEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 13, 1)
)
...
relayWarningDiInputChanged = _RelayWarningDiInputChanged_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 13, 1, 1),
...
relayWarningDiInputChangedStatus = _RelayWarningDiInputChangedStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 17, 13, 1, 2),
...
queuingMechanism = _QueuingMechanism_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 18, 1, 1),
...
inspectTos = _InspectTos_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 18, 1, 2, 1, 1),
    _InspectTos_Type()
)
...
inspectCos = _InspectCos_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 18, 1, 2, 1, 2),
    _InspectCos_Type()
)
...
portPriority = _PortPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 18, 1, 2, 1, 3),
    _PortPriority_Type()
)
...
cosTag = _CosTag_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 18, 2, 1, 1, 1),
    _CosTag_Type()
)
...
cosMappedPriority = _CosMappedPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 18, 2, 1, 1, 2),
...
tosClass = _TosClass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 18, 3, 1, 1, 1),
    _TosClass_Type()
)
...
tosMappedPriority = _TosMappedPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 18, 3, 1, 1, 2),
...
vlanPortSettingEntry = _VlanPortSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 1, 1)
)
...
portVlanType = _PortVlanType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 1, 1, 1),
    _PortVlanType_Type()
)
...
portDefaultVid = _PortDefaultVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 1, 1, 2),
...
portFixedVid = _PortFixedVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 1, 1, 3),
    _PortFixedVid_Type()
)
...
portForbiddenVid = _PortForbiddenVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 1, 1, 4),
...
portFixedVidUntag = _PortFixedVidUntag_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 1, 1, 5),
...
vlanId = _VlanId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 2, 1, 1),
    _VlanId_Type()
)
...
joinedAccessPorts = _JoinedAccessPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 2, 1, 2),
...
joinedTrunkPorts = _JoinedTrunkPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 2, 1, 3),
...
joinedHybridPorts = _JoinedHybridPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 2, 1, 4),
...
qinqSettingTable = _QinqSettingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 7)
)
if mibBuilder.loadTexts:
    qinqSettingTable.setStatus("current")
_QinqSettingEntry_Object = MibTableRow
qinqSettingEntry = _QinqSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 7, 1)
)
qinqSettingEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "portIndex"),
)
if mibBuilder.loadTexts:
    qinqSettingEntry.setStatus("current")


class _QinqEnable_Type(Integer32):
    """Custom type qinqEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_QinqEnable_Type.__name__ = "Integer32"
_QinqEnable_Object = MibTableColumn
qinqEnable = _QinqEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 7, 1, 1),
    _QinqEnable_Type()
)
qinqEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    qinqEnable.setStatus("current")
_QinqTpid_Type = DisplayString
_QinqTpid_Object = MibTableColumn
qinqTpid = _QinqTpid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 19, 7, 1, 2),
    _QinqTpid_Type()
)
qinqTpid.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    qinqTpid.setStatus("current")
_MulticastFiltering_ObjectIdentity = ObjectIdentity
multicastFiltering = _MulticastFiltering_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20)
)
_IgmpSnooping_ObjectIdentity = ObjectIdentity
igmpSnooping = _IgmpSnooping_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1)
)
...
querierQueryInterval = _QuerierQueryInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 1),
...
igmpSnoopingSettingTable = _IgmpSnoopingSettingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 2)
)
if mibBuilder.loadTexts:
...
igmpSnoopingSettingEntry = _IgmpSnoopingSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 2, 1)
)
...
enableIgmpSnooping = _EnableIgmpSnooping_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 2, 1, 1),
...
enableQuerier = _EnableQuerier_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 2, 1, 2),
    _EnableQuerier_Type()
)
...
fixedMulticastQuerierPorts = _FixedMulticastQuerierPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 2, 1, 3),
...
learnedMulticastQuerierPorts = _LearnedMulticastQuerierPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 2, 1, 4),
...
enableGlobalIgmpSnooping = _EnableGlobalIgmpSnooping_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 4),
...
igmpSnoopingStreamTable = _IgmpSnoopingStreamTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 6)
)
if mibBuilder.loadTexts:
    igmpSnoopingStreamTable.setStatus("current")
_IgmpSnoopingStreamEntry_Object = MibTableRow
igmpSnoopingStreamEntry = _IgmpSnoopingStreamEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 6, 1)
)
igmpSnoopingStreamEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "igmpSnoopingStreamIndex"),
)
if mibBuilder.loadTexts:
    igmpSnoopingStreamEntry.setStatus("current")
_IgmpSnoopingStreamIndex_Type = Integer32
_IgmpSnoopingStreamIndex_Object = MibTableColumn
igmpSnoopingStreamIndex = _IgmpSnoopingStreamIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 6, 1, 1),
    _IgmpSnoopingStreamIndex_Type()
)
igmpSnoopingStreamIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    igmpSnoopingStreamIndex.setStatus("current")
_IgmpSnoopingStreamGroup_Type = IpAddress
_IgmpSnoopingStreamGroup_Object = MibTableColumn
igmpSnoopingStreamGroup = _IgmpSnoopingStreamGroup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 6, 1, 2),
    _IgmpSnoopingStreamGroup_Type()
)
igmpSnoopingStreamGroup.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    igmpSnoopingStreamGroup.setStatus("current")
_IgmpSnoopingStreamSource_Type = IpAddress
_IgmpSnoopingStreamSource_Object = MibTableColumn
igmpSnoopingStreamSource = _IgmpSnoopingStreamSource_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 6, 1, 3),
    _IgmpSnoopingStreamSource_Type()
)
igmpSnoopingStreamSource.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    igmpSnoopingStreamSource.setStatus("current")
_IgmpSnoopingStreamPort_Type = Integer32
_IgmpSnoopingStreamPort_Object = MibTableColumn
igmpSnoopingStreamPort = _IgmpSnoopingStreamPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 6, 1, 4),
    _IgmpSnoopingStreamPort_Type()
)
igmpSnoopingStreamPort.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    igmpSnoopingStreamPort.setStatus("current")
_IgmpSnoopingMemberPorts_Type = PortList
_IgmpSnoopingMemberPorts_Object = MibTableColumn
igmpSnoopingMemberPorts = _IgmpSnoopingMemberPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 6, 1, 5),
    _IgmpSnoopingMemberPorts_Type()
)
igmpSnoopingMemberPorts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    igmpSnoopingMemberPorts.setStatus("current")
...
multicastFastForwarding = _MulticastFastForwarding_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 1, 7),
...
staticMulticastEntry = _StaticMulticastEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 2, 1, 1)
)
staticMulticastEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "staticMulticastAddress"),
)
if mibBuilder.loadTexts:
...
staticMulticastAddress = _StaticMulticastAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 2, 1, 1, 1),
...
staticMulticastPorts = _StaticMulticastPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 2, 1, 1, 2),
...
enableGMRP = _EnableGMRP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 3, 1, 1, 1),
    _EnableGMRP_Type()
)
...
gmrpMulticastGroup = _GmrpMulticastGroup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 3, 2, 1, 1),
...
gmrpFixedPorts = _GmrpFixedPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 3, 2, 1, 2),
...
gmrpLearnedPorts = _GmrpLearnedPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 3, 2, 1, 3),
...
filterBehavior = _FilterBehavior_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 20, 4, 1, 1, 1),
...
normalModeRateLimitingIngressEntry = _NormalModeRateLimitingIngressEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 21, 1, 1)
)
...
limitMode = _LimitMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 21, 1, 1, 1),
    _LimitMode_Type()
)
...
ingressLimitRate = _IngressLimitRate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 21, 1, 1, 2),
...
egressLimit = _EgressLimit_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 21, 1, 1, 3),
    _EgressLimit_Type()
)
...
ufbIncludeUnkonwnUcast = _UfbIncludeUnkonwnUcast_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 21, 2, 1, 1),
...
portDisableModePeriod = _PortDisableModePeriod_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 21, 3, 1),
...
portDisableModeTable = _PortDisableModeTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 21, 3, 2)
)
if mibBuilder.loadTexts:
...
portDisableModeEntry = _PortDisableModeEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 21, 3, 2, 1)
)
...
ingressLimit = _IngressLimit_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 21, 3, 2, 1, 1),
    _IngressLimit_Type()
)
...
userLoginServer = _UserLoginServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 1),
...
tacacsServerSetting = _TacacsServerSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 2)
)
...
tacacsLoginAuthServer = _TacacsLoginAuthServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 2, 1),
...
tacacsLoginAuthPort = _TacacsLoginAuthPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 2, 2),
...
tacacsLoginAuthSharedKey = _TacacsLoginAuthSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 2, 3),
...
tacacsLoginAuthAuthType = _TacacsLoginAuthAuthType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 2, 4),
...
tacacsLoginAuthTimeout = _TacacsLoginAuthTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 2, 5),
...
radiusServerSetting = _RadiusServerSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 3)
)
...
radiusLoginAuthServer = _RadiusLoginAuthServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 3, 1),
...
radiusLoginAuthPort = _RadiusLoginAuthPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 3, 2),
...
radiusLoginAuthSharedKey = _RadiusLoginAuthSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 3, 3),
...
radiusLoginAuthAuthType = _RadiusLoginAuthAuthType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 3, 4),
...
radiusLoginAuthTimeout = _RadiusLoginAuthTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 1, 3, 5),
...
staticPortLockAddress = _StaticPortLockAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 1, 1),
...
staticPortLockPort = _StaticPortLockPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 1, 2),
...
staticPortLockStatus = _StaticPortLockStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 1, 3),
...
dot1x = _Dot1x_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2)
)
...
dataBaseOption = _DataBaseOption_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 1),
...
dot1xReauthEnable = _Dot1xReauthEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 5),
...
dot1xReauthPeriod = _Dot1xReauthPeriod_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 6),
...
enableDot1X = _EnableDot1X_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 7, 1, 1),
    _EnableDot1X_Type()
)
...
dot1xReauthPortIndex = _Dot1xReauthPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 8, 1, 1),
...
dot1xReauth = _Dot1xReauth_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 8, 1, 2),
    _Dot1xReauth_Type()
)
...
dot1xRadius = _Dot1xRadius_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 9)
)
...
dot1xSameAsAuthServer = _Dot1xSameAsAuthServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 9, 1),
...
dot1x1stRadiusServer = _Dot1x1stRadiusServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 9, 2),
...
dot1x1stRadiusPort = _Dot1x1stRadiusPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 9, 3),
...
dot1x1stRadiusSharedKey = _Dot1x1stRadiusSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 9, 4),
...
dot1x2ndRadiusServer = _Dot1x2ndRadiusServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 9, 5),
...
dot1x2ndRadiusPort = _Dot1x2ndRadiusPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 9, 6),
...
dot1x2ndRadiusSharedKey = _Dot1x2ndRadiusSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 2, 9, 7),
...
portAccessControlTable = _PortAccessControlTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 3)
)
if mibBuilder.loadTexts:
...
portAccessControlEntry = _PortAccessControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 3, 1)
)
portAccessControlEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "portAccessControlAddress"),
)
if mibBuilder.loadTexts:
...
portAccessControlAddress = _PortAccessControlAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 3, 1, 1),
...
portAccessControlPortNo = _PortAccessControlPortNo_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 3, 1, 2),
...
portAccessControlAccessStatus = _PortAccessControlAccessStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 3, 1, 3),
...
portAccessControlStatus = _PortAccessControlStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 22, 2, 3, 1, 4),
...
accessibleIpAddress = _AccessibleIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 30, 2, 1, 1),
...
accessibleIpNetMask = _AccessibleIpNetMask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 30, 2, 1, 2),
...
accessibleIpStatus = _AccessibleIpStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 30, 2, 1, 3),
...
startMonth = _StartMonth_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 32, 5, 1),
    _StartMonth_Type()
)
...
startWeek = _StartWeek_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 32, 5, 2),
    _StartWeek_Type()
)
...
startHour = _StartHour_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 32, 5, 4),
    _StartHour_Type()
)
...
endMonth = _EndMonth_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 32, 5, 5),
    _EndMonth_Type()
)
...
endWeek = _EndWeek_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 32, 5, 6),
    _EndWeek_Type()
)
...
endDay = _EndDay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 32, 5, 7),
    _EndDay_Type()
)
...
endHour = _EndHour_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 32, 5, 8),
    _EndHour_Type()
)
...
offsetHours = _OffsetHours_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 32, 5, 9),
    _OffsetHours_Type()
)
...
enableOption82 = _EnableOption82_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 39, 5, 1),
...
option82Type = _Option82Type_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 39, 5, 2),
    _Option82Type_Type()
)
...
option82Value = _Option82Value_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 39, 5, 3),
    _Option82Value_Type()
)
...
option82ValueDisplay = _Option82ValueDisplay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 39, 5, 4),
...
dhcpPortIndex = _DhcpPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 39, 6, 1, 1),
    _DhcpPortIndex_Type()
)
...
circuitID = _CircuitID_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 39, 6, 1, 2),
    _CircuitID_Type()
)
...
option82Enable = _Option82Enable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 39, 6, 1, 3),
...
enablePtpv1 = _EnablePtpv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 1, 1),
    _EnablePtpv1_Type()
)
...
clockModev1 = _ClockModev1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 1, 2),
    _ClockModev1_Type()
)
...
syncIntervalv1 = _SyncIntervalv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 1, 3),
...
subDomainNamev1 = _SubDomainNamev1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 1, 4),
...
preferMasterv1 = _PreferMasterv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 1, 5),
...
enablePtp = _EnablePtp_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 1),
    _EnablePtp_Type()
)
...
clockMode = _ClockMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 2),
    _ClockMode_Type()
)
...
transport = _Transport_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 3),
    _Transport_Type()
)
...
syncInterval = _SyncInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 4),
    _SyncInterval_Type()
)
...
logMinDelayReqInterval = _LogMinDelayReqInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 5),
...
logMinPdelayReqInterval = _LogMinPdelayReqInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 6),
...
logAnnounceInterval = _LogAnnounceInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 7),
...
announceReceiptTimeout = _AnnounceReceiptTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 8),
...
priority1 = _Priority1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 9),
    _Priority1_Type()
)
...
priority2 = _Priority2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 10),
    _Priority2_Type()
)
...
clockClass = _ClockClass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 11),
    _ClockClass_Type()
)
...
domainNumber = _DomainNumber_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 12),
    _DomainNumber_Type()
)
...
localUtcOffset = _LocalUtcOffset_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 13),
...
localUtcOffsetValid = _LocalUtcOffsetValid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 14),
...
localLeap59 = _LocalLeap59_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 15),
    _LocalLeap59_Type()
)
...
localLeap61 = _LocalLeap61_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 16),
    _LocalLeap61_Type()
)
...
localPtpTimescale = _LocalPtpTimescale_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 17),
...
localArbTime = _LocalArbTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 2, 18),
    _LocalArbTime_Type()
)
...
meanPathDelayv1 = _MeanPathDelayv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 3, 2),
...
grandMasterUuidv1 = _GrandMasterUuidv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 3, 3),
...
parentUuidv1 = _ParentUuidv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 3, 4),
    _ParentUuidv1_Type()
)
...
clockStratumv1 = _ClockStratumv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 3, 5),
...
clockIdentifierv1 = _ClockIdentifierv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 3, 6),
...
meanPathDelay = _MeanPathDelay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 2),
    _MeanPathDelay_Type()
)
...
parentIdentity = _ParentIdentity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 3),
...
grandmasterIdentity = _GrandmasterIdentity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 4),
...
grandmasterClockClass = _GrandmasterClockClass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 5),
...
grandmasterClockAccuracy = _GrandmasterClockAccuracy_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 6),
...
grandmasterPriority1 = _GrandmasterPriority1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 7),
...
grandmasterPriority2 = _GrandmasterPriority2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 8),
...
stepsRemoved = _StepsRemoved_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 9),
    _StepsRemoved_Type()
)
...
currentUtcOffset = _CurrentUtcOffset_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 10),
...
currentUtcOffsetValid = _CurrentUtcOffsetValid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 11),
...
leap59 = _Leap59_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 12),
    _Leap59_Type()
)
...
leap61 = _Leap61_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 13),
    _Leap61_Type()
)
...
ptpTimescale = _PtpTimescale_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 14),
    _PtpTimescale_Type()
)
...
timesource = _Timesource_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 4, 15),
    _Timesource_Type()
)
...
ptpPortIndex = _PtpPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 5, 1, 1),
    _PtpPortIndex_Type()
)
...
ptpPortEnable = _PtpPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 5, 1, 2),
    _PtpPortEnable_Type()
)
...
ptpPortStatus = _PtpPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 41, 5, 1, 3),
    _PtpPortStatus_Type()
)
...
enableLLDP = _EnableLLDP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 42, 1, 1),
    _EnableLLDP_Type()
)
...
lldpMSGInterval = _LldpMSGInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 42, 1, 2),
...
eventlogIndex = _EventlogIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 46, 1, 1, 1),
    _EventlogIndex_Type()
)
...
eventlogBootup = _EventlogBootup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 46, 1, 1, 2),
...
eventlogDate = _EventlogDate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 46, 1, 1, 3),
    _EventlogDate_Type()
)
...
eventlogTime = _EventlogTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 46, 1, 1, 4),
    _EventlogTime_Type()
)
...
eventlogUptime = _EventlogUptime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 46, 1, 1, 5),
...
eventlogEvent = _EventlogEvent_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 46, 1, 1, 6),
    _EventlogEvent_Type()
)
...
enableEtherNetIP = _EnableEtherNetIP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 47, 1, 1),
...
enableModbusTCP = _EnableModbusTCP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 47, 2, 1),
...
enableProfinetIO = _EnableProfinetIO_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 47, 3, 1),
...
class _EnableJumboFrame_Type(Integer32):
    """Custom type enableJumboFrame based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_EnableJumboFrame_Type.__name__ = "Integer32"
_EnableJumboFrame_Object = MibScalar
enableJumboFrame = _EnableJumboFrame_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 49),
    _EnableJumboFrame_Type()
)
enableJumboFrame.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    enableJumboFrame.setStatus("current")
_MaxJumboFrame_Type = Integer32
_MaxJumboFrame_Object = MibScalar
maxJumboFrame = _MaxJumboFrame_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 50),
    _MaxJumboFrame_Type()
)
maxJumboFrame.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    maxJumboFrame.setStatus("current")
...
aclRuleIndex = _AclRuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 1),
    _AclRuleIndex_Type()
)
...
listID = _ListID_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 2),
    _ListID_Type()
)
...
filterType = _FilterType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 3),
    _FilterType_Type()
)
...
actionFlag = _ActionFlag_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 4),
    _ActionFlag_Type()
)
...
srcMacAddr = _SrcMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 5),
    _SrcMacAddr_Type()
)
...
srcMacMask = _SrcMacMask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 6),
    _SrcMacMask_Type()
)
...
dstMacAddr = _DstMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 7),
    _DstMacAddr_Type()
)
...
dstMacMask = _DstMacMask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 8),
    _DstMacMask_Type()
)
...
etherType = _EtherType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 9),
    _EtherType_Type()
)
...
_VlanID_Object = MibTableColumn
vlanID = _VlanID_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 10),
    _VlanID_Type()
)
...
srcIpAddr = _SrcIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 11),
    _SrcIpAddr_Type()
)
...
srcNetmask = _SrcNetmask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 12),
    _SrcNetmask_Type()
)
...
dstIpAddr = _DstIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 13),
    _DstIpAddr_Type()
)
...
dstNetmask = _DstNetmask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 14),
    _DstNetmask_Type()
)
...
protocolCode = _ProtocolCode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 15),
    _ProtocolCode_Type()
)
...
srcsocketPort = _SrcsocketPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 16),
    _SrcsocketPort_Type()
)
...
dstsocketPort = _DstsocketPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 17),
    _DstsocketPort_Type()
)
...
class _IpDSCP_Type(Integer32):
    """Custom type ipDSCP based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            -1
...
_IpDSCP_Type.__name__ = "Integer32"
_IpDSCP_Object = MibTableColumn
ipDSCP = _IpDSCP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 1, 1, 19),
    _IpDSCP_Type()
)
ipDSCP.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ipDSCP.setStatus("current")


class _OverrideDSCP_Type(Integer32):
    """Custom type overrideDSCP based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            -1
...
aclID = _AclID_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 2, 1, 1),
    _AclID_Type()
)
...
ingressPort = _IngressPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 2, 1, 2),
    _IngressPort_Type()
)
...
egressPort = _EgressPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 2, 1, 3),
    _EgressPort_Type()
)
egressPort.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    egressPort.setStatus("current")
_AclListName_Type = DisplayString
_AclListName_Object = MibTableColumn
aclListName = _AclListName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 52, 2, 1, 4),
    _AclListName_Type()
)
...
systemEventSettingsEntry = _SystemEventSettingsEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 1, 1)
)
systemEventSettingsEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "systemEventIndex"),
)
if mibBuilder.loadTexts:
...
systemEventIndex = _SystemEventIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 1, 1, 1),
...
systemEventActive = _SystemEventActive_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 1, 1, 2),
...
systemEventName = _SystemEventName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 1, 1, 3),
...
systemEventSupport = _SystemEventSupport_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 1, 1, 4),
...
systemEventModuleEnable = _SystemEventModuleEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 1, 1, 5),
...
systemEventSeverity = _SystemEventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 1, 1, 6),
...
portEventSettingsEntry = _PortEventSettingsEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 2, 1)
)
portEventSettingsEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "portEventIndex"),
)
if mibBuilder.loadTexts:
...
portEventIndex = _PortEventIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 2, 1, 1),
...
portEventLabel = _PortEventLabel_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 2, 1, 2),
...
portEventActive = _PortEventActive_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 2, 1, 3),
...
portEventTrafficThreshold = _PortEventTrafficThreshold_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 2, 1, 5),
...
portEventTrafficDuration = _PortEventTrafficDuration_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 2, 1, 6),
...
portEventModuleEnable = _PortEventModuleEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 2, 1, 7),
...
portEventSeverity = _PortEventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 1, 62, 2, 1, 8),
...
l3Mgmt = _L3Mgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3)
)
_IpIfSetting_ObjectIdentity = ObjectIdentity
ipIfSetting = _IpIfSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 1)
)
_IpIfSettingTable_Object = MibTable
ipIfSettingTable = _IpIfSettingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 1, 1)
)
if mibBuilder.loadTexts:
    ipIfSettingTable.setStatus("current")
_IpIfSettingEntry_Object = MibTableRow
ipIfSettingEntry = _IpIfSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 1, 1, 1)
)
ipIfSettingEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "ipIfIndex"),
)
if mibBuilder.loadTexts:
    ipIfSettingEntry.setStatus("current")
_IpIfIndex_Type = Integer32
_IpIfIndex_Object = MibTableColumn
ipIfIndex = _IpIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 1, 1, 1, 1),
    _IpIfIndex_Type()
)
ipIfIndex.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ipIfIndex.setStatus("current")
_IpIfName_Type = DisplayString
_IpIfName_Object = MibTableColumn
ipIfName = _IpIfName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 1, 1, 1, 2),
    _IpIfName_Type()
)
ipIfName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ipIfName.setStatus("current")
_IpIfAddr_Type = IpAddress
_IpIfAddr_Object = MibTableColumn
ipIfAddr = _IpIfAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 1, 1, 1, 3),
    _IpIfAddr_Type()
)
...
ipIfNetmask = _IpIfNetmask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 1, 1, 1, 4),
    _IpIfNetmask_Type()
)
...
class _IpIfVlan_Type(Integer32):
    """Custom type ipIfVlan based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4094),
    )
...
_IpIfVlan_Type.__name__ = "Integer32"
_IpIfVlan_Object = MibTableColumn
ipIfVlan = _IpIfVlan_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 1, 1, 1, 5),
    _IpIfVlan_Type()
)
ipIfVlan.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ipIfVlan.setStatus("current")


class _IpIfProxyArp_Type(Integer32):
    """Custom type ipIfProxyArp based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_IpIfProxyArp_Type.__name__ = "Integer32"
_IpIfProxyArp_Object = MibTableColumn
ipIfProxyArp = _IpIfProxyArp_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 1, 1, 1, 6),
    _IpIfProxyArp_Type()
)
ipIfProxyArp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ipIfProxyArp.setStatus("current")


class _IpIfStatus_Type(Integer32):
    """Custom type ipIfStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
staticRouteIndex = _StaticRouteIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 2, 1, 1, 1),
    _StaticRouteIndex_Type()
)
staticRouteIndex.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    staticRouteIndex.setStatus("current")
_StaticRouteAddr_Type = IpAddress
_StaticRouteAddr_Object = MibTableColumn
staticRouteAddr = _StaticRouteAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 2, 1, 1, 2),
    _StaticRouteAddr_Type()
)
staticRouteAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    staticRouteAddr.setStatus("current")
_StaticRouteNetmask_Type = IpAddress
_StaticRouteNetmask_Object = MibTableColumn
staticRouteNetmask = _StaticRouteNetmask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 2, 1, 1, 3),
    _StaticRouteNetmask_Type()
)
staticRouteNetmask.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
staticRouteNexthop = _StaticRouteNexthop_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 2, 1, 1, 4),
    _StaticRouteNexthop_Type()
)
staticRouteNexthop.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    staticRouteNexthop.setStatus("current")


class _StaticRouteMetric_Type(Integer32):
    """Custom type staticRouteMetric based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
class _StaticRouteStatus_Type(Integer32):
    """Custom type staticRouteStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
rip = _Rip_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3)
)


class _RipEnable_Type(Integer32):
    """Custom type ripEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RipEnable_Type.__name__ = "Integer32"
_RipEnable_Object = MibScalar
ripEnable = _RipEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 1),
    _RipEnable_Type()
)
...
class _RipRedistConnected_Type(Integer32):
    """Custom type ripRedistConnected based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RipRedistConnected_Type.__name__ = "Integer32"
_RipRedistConnected_Object = MibScalar
ripRedistConnected = _RipRedistConnected_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 3),
    _RipRedistConnected_Type()
)
ripRedistConnected.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ripRedistConnected.setStatus("current")


class _RipRedistStatic_Type(Integer32):
    """Custom type ripRedistStatic based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RipRedistStatic_Type.__name__ = "Integer32"
_RipRedistStatic_Object = MibScalar
ripRedistStatic = _RipRedistStatic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 4),
    _RipRedistStatic_Type()
)
ripRedistStatic.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ripRedistStatic.setStatus("current")


class _RipRedistOspf_Type(Integer32):
    """Custom type ripRedistOspf based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RipRedistOspf_Type.__name__ = "Integer32"
_RipRedistOspf_Object = MibScalar
ripRedistOspf = _RipRedistOspf_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 5),
    _RipRedistOspf_Type()
)
ripRedistOspf.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ripRedistOspf.setStatus("current")
_RipInterfaceTable_Object = MibTable
ripInterfaceTable = _RipInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 6)
)
if mibBuilder.loadTexts:
    ripInterfaceTable.setStatus("current")
_RipInterfaceEntry_Object = MibTableRow
ripInterfaceEntry = _RipInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 6, 1)
)
ripInterfaceEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "ipIfIndex"),
)
if mibBuilder.loadTexts:
    ripInterfaceEntry.setStatus("current")
_RipIfName_Type = DisplayString
_RipIfName_Object = MibTableColumn
ripIfName = _RipIfName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 6, 1, 1),
    _RipIfName_Type()
)
ripIfName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ripIfName.setStatus("current")
_RipIfAddr_Type = IpAddress
_RipIfAddr_Object = MibTableColumn
ripIfAddr = _RipIfAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 6, 1, 2),
    _RipIfAddr_Type()
)
ripIfAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ripIfAddr.setStatus("current")
_RipIfVlan_Type = Integer32
_RipIfVlan_Object = MibTableColumn
ripIfVlan = _RipIfVlan_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 6, 1, 3),
    _RipIfVlan_Type()
)
ripIfVlan.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ripIfVlan.setStatus("current")


class _RipIfEnable_Type(Integer32):
    """Custom type ripIfEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RipIfEnable_Type.__name__ = "Integer32"
_RipIfEnable_Object = MibTableColumn
ripIfEnable = _RipIfEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 3, 6, 1, 4),
    _RipIfEnable_Type()
)
ripIfEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ripIfEnable.setStatus("current")
_Ospf_ObjectIdentity = ObjectIdentity
ospf = _Ospf_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4)
)
_OspfGlobal_ObjectIdentity = ObjectIdentity
ospfGlobal = _OspfGlobal_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 1)
)


class _OspfEnable_Type(Integer32):
    """Custom type ospfEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_OspfEnable_Type.__name__ = "Integer32"
_OspfEnable_Object = MibScalar
ospfEnable = _OspfEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 1, 1),
    _OspfEnable_Type()
)
...
ospfCurrentRouterId = _OspfCurrentRouterId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 1, 3),
    _OspfCurrentRouterId_Type()
)
ospfCurrentRouterId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ospfCurrentRouterId.setStatus("current")


class _OspfRedistConnected_Type(Integer32):
    """Custom type ospfRedistConnected based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_OspfRedistConnected_Type.__name__ = "Integer32"
_OspfRedistConnected_Object = MibScalar
ospfRedistConnected = _OspfRedistConnected_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 1, 4),
    _OspfRedistConnected_Type()
)
ospfRedistConnected.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfRedistConnected.setStatus("current")


class _OspfRedistStatic_Type(Integer32):
    """Custom type ospfRedistStatic based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_OspfRedistStatic_Type.__name__ = "Integer32"
_OspfRedistStatic_Object = MibScalar
ospfRedistStatic = _OspfRedistStatic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 1, 5),
    _OspfRedistStatic_Type()
)
ospfRedistStatic.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfRedistStatic.setStatus("current")


class _OspfRedistRip_Type(Integer32):
    """Custom type ospfRedistRip based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
ospfAreaId = _OspfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 2, 1, 1, 1),
    _OspfAreaId_Type()
)
...
ospfAreaType = _OspfAreaType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 2, 1, 1, 2),
    _OspfAreaType_Type()
)
ospfAreaType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ospfAreaType.setStatus("current")


class _OspfAreaMetric_Type(Integer32):
    """Custom type ospfAreaMetric based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_OspfAreaMetric_Type.__name__ = "Integer32"
_OspfAreaMetric_Object = MibTableColumn
ospfAreaMetric = _OspfAreaMetric_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 2, 1, 1, 3),
    _OspfAreaMetric_Type()
)
ospfAreaMetric.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ospfAreaMetric.setStatus("current")


class _OspfAreaStatus_Type(Integer32):
    """Custom type ospfAreaStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
ospfIfIndex = _OspfIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 1),
    _OspfIfIndex_Type()
)
ospfIfIndex.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
ospfIfName = _OspfIfName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 2),
    _OspfIfName_Type()
)
ospfIfName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfIfName.setStatus("current")
_OspfIfAddr_Type = IpAddress
_OspfIfAddr_Object = MibTableColumn
ospfIfAddr = _OspfIfAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 3),
    _OspfIfAddr_Type()
)
ospfIfAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ospfIfAddr.setStatus("current")
_OspfIfAreaId_Type = IpAddress
_OspfIfAreaId_Object = MibTableColumn
ospfIfAreaId = _OspfIfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 4),
    _OspfIfAreaId_Type()
)
...
ospfIfState = _OspfIfState_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 5),
    _OspfIfState_Type()
)
...
class _OspfIfPriority_Type(Integer32):
    """Custom type ospfIfPriority based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_OspfIfPriority_Type.__name__ = "Integer32"
_OspfIfPriority_Object = MibTableColumn
ospfIfPriority = _OspfIfPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 6),
    _OspfIfPriority_Type()
)
ospfIfPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfIfPriority.setStatus("current")
...
ospfIfHelloInterval = _OspfIfHelloInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 7),
...
class _OspfIfDeadInterval_Type(Integer32):
    """Custom type ospfIfDeadInterval based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_OspfIfDeadInterval_Type.__name__ = "Integer32"
_OspfIfDeadInterval_Object = MibTableColumn
ospfIfDeadInterval = _OspfIfDeadInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 8),
    _OspfIfDeadInterval_Type()
)
ospfIfDeadInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfIfDeadInterval.setStatus("current")


class _OspfIfAuthType_Type(Integer32):
    """Custom type ospfIfAuthType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_OspfIfAuthType_Type.__name__ = "Integer32"
_OspfIfAuthType_Object = MibTableColumn
ospfIfAuthType = _OspfIfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 9),
    _OspfIfAuthType_Type()
)
ospfIfAuthType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
ospfIfAuthKey = _OspfIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 10),
    _OspfIfAuthKey_Type()
)
...
class _OspfIfMd5KeyId_Type(Integer32):
    """Custom type ospfIfMd5KeyId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_OspfIfMd5KeyId_Type.__name__ = "Integer32"
_OspfIfMd5KeyId_Object = MibTableColumn
ospfIfMd5KeyId = _OspfIfMd5KeyId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 11),
    _OspfIfMd5KeyId_Type()
)
ospfIfMd5KeyId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfIfMd5KeyId.setStatus("current")


class _OspfIfMetric_Type(Integer32):
    """Custom type ospfIfMetric based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_OspfIfMetric_Type.__name__ = "Integer32"
_OspfIfMetric_Object = MibTableColumn
ospfIfMetric = _OspfIfMetric_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 12),
    _OspfIfMetric_Type()
)
...
class _OspfIfStatus_Type(Integer32):
    """Custom type ospfIfStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_OspfIfStatus_Type.__name__ = "Integer32"
_OspfIfStatus_Object = MibTableColumn
ospfIfStatus = _OspfIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 3, 1, 1, 13),
    _OspfIfStatus_Type()
)
...
ospfVirtualLink = _OspfVirtualLink_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 4)
)
_OspfVlinkTable_Object = MibTable
ospfVlinkTable = _OspfVlinkTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 4, 1)
)
if mibBuilder.loadTexts:
    ospfVlinkTable.setStatus("current")
_OspfVlinkEntry_Object = MibTableRow
ospfVlinkEntry = _OspfVlinkEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 4, 1, 1)
)
ospfVlinkEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "ospfVlinkIndex"),
)
if mibBuilder.loadTexts:
    ospfVlinkEntry.setStatus("current")
_OspfVlinkIndex_Type = Integer32
_OspfVlinkIndex_Object = MibTableColumn
ospfVlinkIndex = _OspfVlinkIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 4, 1, 1, 1),
    _OspfVlinkIndex_Type()
)
ospfVlinkIndex.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ospfVlinkIndex.setStatus("current")
_OspfTransitAreaId_Type = IpAddress
_OspfTransitAreaId_Object = MibTableColumn
ospfTransitAreaId = _OspfTransitAreaId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 4, 1, 1, 2),
    _OspfTransitAreaId_Type()
)
ospfTransitAreaId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfTransitAreaId.setStatus("current")
_OspfNeighborAreaId_Type = IpAddress
_OspfNeighborAreaId_Object = MibTableColumn
ospfNeighborAreaId = _OspfNeighborAreaId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 4, 1, 1, 3),
    _OspfNeighborAreaId_Type()
)
ospfNeighborAreaId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfNeighborAreaId.setStatus("current")


class _OspfVlinkStatus_Type(Integer32):
    """Custom type ospfVlinkStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_OspfVlinkStatus_Type.__name__ = "Integer32"
_OspfVlinkStatus_Object = MibTableColumn
ospfVlinkStatus = _OspfVlinkStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 4, 1, 1, 4),
    _OspfVlinkStatus_Type()
)
ospfVlinkStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ospfVlinkStatus.setStatus("current")
_OspfAggregation_ObjectIdentity = ObjectIdentity
ospfAggregation = _OspfAggregation_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 5)
)
_OspfAggregationTable_Object = MibTable
ospfAggregationTable = _OspfAggregationTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 5, 1)
)
if mibBuilder.loadTexts:
    ospfAggregationTable.setStatus("current")
_OspfAggregationEntry_Object = MibTableRow
ospfAggregationEntry = _OspfAggregationEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 5, 1, 1)
)
ospfAggregationEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "ospfAggrIndex"),
)
if mibBuilder.loadTexts:
    ospfAggregationEntry.setStatus("current")
_OspfAggrIndex_Type = Integer32
_OspfAggrIndex_Object = MibTableColumn
ospfAggrIndex = _OspfAggrIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 5, 1, 1, 1),
    _OspfAggrIndex_Type()
)
ospfAggrIndex.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ospfAggrIndex.setStatus("current")
_OspfAggrAreaId_Type = IpAddress
_OspfAggrAreaId_Object = MibTableColumn
ospfAggrAreaId = _OspfAggrAreaId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 5, 1, 1, 2),
    _OspfAggrAreaId_Type()
)
ospfAggrAreaId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfAggrAreaId.setStatus("current")
_OspfAggrAddr_Type = IpAddress
_OspfAggrAddr_Object = MibTableColumn
ospfAggrAddr = _OspfAggrAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 5, 1, 1, 3),
    _OspfAggrAddr_Type()
)
ospfAggrAddr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfAggrAddr.setStatus("current")
_OspfAggrMask_Type = IpAddress
_OspfAggrMask_Object = MibTableColumn
ospfAggrMask = _OspfAggrMask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 5, 1, 1, 4),
    _OspfAggrMask_Type()
)
ospfAggrMask.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ospfAggrMask.setStatus("current")


class _OspfAggrStatus_Type(Integer32):
    """Custom type ospfAggrStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_OspfAggrStatus_Type.__name__ = "Integer32"
_OspfAggrStatus_Object = MibTableColumn
ospfAggrStatus = _OspfAggrStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 4, 5, 1, 1, 5),
    _OspfAggrStatus_Type()
)
ospfAggrStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    ospfAggrStatus.setStatus("current")
_IpRoutingTable_Object = MibTable
ipRoutingTable = _IpRoutingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 5)
)
if mibBuilder.loadTexts:
    ipRoutingTable.setStatus("current")
_IpRoutingEntry_Object = MibTableRow
ipRoutingEntry = _IpRoutingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 5, 1)
)
ipRoutingEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "ipRoutingIndex"),
)
if mibBuilder.loadTexts:
    ipRoutingEntry.setStatus("current")
_IpRoutingIndex_Type = Integer32
_IpRoutingIndex_Object = MibTableColumn
ipRoutingIndex = _IpRoutingIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 5, 1, 1),
    _IpRoutingIndex_Type()
)
ipRoutingIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ipRoutingIndex.setStatus("current")
_IpRoutingType_Type = DisplayString
_IpRoutingType_Object = MibTableColumn
ipRoutingType = _IpRoutingType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 5, 1, 2),
    _IpRoutingType_Type()
)
ipRoutingType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ipRoutingType.setStatus("current")
_IpRoutingDest_Type = DisplayString
_IpRoutingDest_Object = MibTableColumn
ipRoutingDest = _IpRoutingDest_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 5, 1, 3),
    _IpRoutingDest_Type()
)
ipRoutingDest.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ipRoutingDest.setStatus("current")
_IpRoutingNextHop_Type = IpAddress
_IpRoutingNextHop_Object = MibTableColumn
ipRoutingNextHop = _IpRoutingNextHop_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 5, 1, 4),
    _IpRoutingNextHop_Type()
)
ipRoutingNextHop.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ipRoutingNextHop.setStatus("current")
_IpRoutingIfName_Type = DisplayString
_IpRoutingIfName_Object = MibTableColumn
ipRoutingIfName = _IpRoutingIfName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 5, 1, 5),
    _IpRoutingIfName_Type()
)
ipRoutingIfName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ipRoutingIfName.setStatus("current")
_IpRoutingMetric_Type = Integer32
_IpRoutingMetric_Object = MibTableColumn
ipRoutingMetric = _IpRoutingMetric_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 5, 1, 6),
    _IpRoutingMetric_Type()
)
ipRoutingMetric.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ipRoutingMetric.setStatus("current")
_IpRoutingVlan_Type = Integer32
_IpRoutingVlan_Object = MibTableColumn
ipRoutingVlan = _IpRoutingVlan_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 5, 1, 7),
    _IpRoutingVlan_Type()
)
ipRoutingVlan.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ipRoutingVlan.setStatus("current")
_Vrrp_ObjectIdentity = ObjectIdentity
vrrp = _Vrrp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6)
)
_VrrpInterfaceTable_Object = MibTable
vrrpInterfaceTable = _VrrpInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1)
)
if mibBuilder.loadTexts:
    vrrpInterfaceTable.setStatus("current")
_VrrpInterfaceEntry_Object = MibTableRow
vrrpInterfaceEntry = _VrrpInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1)
)
vrrpInterfaceEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "ipIfIndex"),
)
if mibBuilder.loadTexts:
    vrrpInterfaceEntry.setStatus("current")
_VrrpIfName_Type = DisplayString
_VrrpIfName_Object = MibTableColumn
vrrpIfName = _VrrpIfName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1, 1),
    _VrrpIfName_Type()
)
vrrpIfName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vrrpIfName.setStatus("current")
_VrrpIfAddr_Type = IpAddress
_VrrpIfAddr_Object = MibTableColumn
vrrpIfAddr = _VrrpIfAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1, 2),
    _VrrpIfAddr_Type()
)
vrrpIfAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vrrpIfAddr.setStatus("current")
_VrrpIfVlan_Type = Integer32
_VrrpIfVlan_Object = MibTableColumn
vrrpIfVlan = _VrrpIfVlan_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1, 3),
    _VrrpIfVlan_Type()
)
vrrpIfVlan.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vrrpIfVlan.setStatus("current")


class _VrrpIfEnable_Type(Integer32):
    """Custom type vrrpIfEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VrrpIfEnable_Type.__name__ = "Integer32"
_VrrpIfEnable_Object = MibTableColumn
vrrpIfEnable = _VrrpIfEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1, 4),
    _VrrpIfEnable_Type()
)
vrrpIfEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vrrpIfEnable.setStatus("current")
_VrrpIfVirtualIp_Type = IpAddress
_VrrpIfVirtualIp_Object = MibTableColumn
vrrpIfVirtualIp = _VrrpIfVirtualIp_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1, 5),
    _VrrpIfVirtualIp_Type()
)
vrrpIfVirtualIp.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vrrpIfVirtualIp.setStatus("current")


class _VrrpIfRouterId_Type(Integer32):
    """Custom type vrrpIfRouterId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_VrrpIfRouterId_Type.__name__ = "Integer32"
_VrrpIfRouterId_Object = MibTableColumn
vrrpIfRouterId = _VrrpIfRouterId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1, 6),
    _VrrpIfRouterId_Type()
)
vrrpIfRouterId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vrrpIfRouterId.setStatus("current")


class _VrrpIfPriority_Type(Integer32):
    """Custom type vrrpIfPriority based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_VrrpIfPriority_Type.__name__ = "Integer32"
_VrrpIfPriority_Object = MibTableColumn
vrrpIfPriority = _VrrpIfPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1, 7),
    _VrrpIfPriority_Type()
)
vrrpIfPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vrrpIfPriority.setStatus("current")


class _VrrpIfPreemptionMode_Type(Integer32):
    """Custom type vrrpIfPreemptionMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VrrpIfPreemptionMode_Type.__name__ = "Integer32"
_VrrpIfPreemptionMode_Object = MibTableColumn
vrrpIfPreemptionMode = _VrrpIfPreemptionMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1, 8),
    _VrrpIfPreemptionMode_Type()
)
vrrpIfPreemptionMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vrrpIfPreemptionMode.setStatus("current")
_VrrpIfStatus_Type = DisplayString
_VrrpIfStatus_Object = MibTableColumn
vrrpIfStatus = _VrrpIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 1, 1, 9),
    _VrrpIfStatus_Type()
)
vrrpIfStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vrrpIfStatus.setStatus("current")


class _VrrpEnable_Type(Integer32):
    """Custom type vrrpEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VrrpEnable_Type.__name__ = "Integer32"
_VrrpEnable_Object = MibScalar
vrrpEnable = _VrrpEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 2),
    _VrrpEnable_Type()
)
vrrpEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vrrpEnable.setStatus("current")


class _VrrpAdverInt_Type(Integer32):
    """Custom type vrrpAdverInt based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_VrrpAdverInt_Type.__name__ = "Integer32"
_VrrpAdverInt_Object = MibScalar
vrrpAdverInt = _VrrpAdverInt_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 6, 3),
    _VrrpAdverInt_Type()
)
vrrpAdverInt.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vrrpAdverInt.setStatus("current")
_Dvmrp_ObjectIdentity = ObjectIdentity
dvmrp = _Dvmrp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7)
)


class _DvmrpEnable_Type(Integer32):
    """Custom type dvmrpEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_DvmrpEnable_Type.__name__ = "Integer32"
_DvmrpEnable_Object = MibScalar
dvmrpEnable = _DvmrpEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 1),
    _DvmrpEnable_Type()
)
dvmrpEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dvmrpEnable.setStatus("current")
_DvmrpInterfaceTable_Object = MibTable
dvmrpInterfaceTable = _DvmrpInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 2)
)
if mibBuilder.loadTexts:
...
dvmrpInterfaceEntry = _DvmrpInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 2, 1)
)
dvmrpInterfaceEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "dvmrpIfIndex"),
)
if mibBuilder.loadTexts:
    dvmrpInterfaceEntry.setStatus("current")
_DvmrpIfIndex_Type = Integer32
_DvmrpIfIndex_Object = MibTableColumn
dvmrpIfIndex = _DvmrpIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 2, 1, 1),
    _DvmrpIfIndex_Type()
)
dvmrpIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpIfIndex.setStatus("current")
_DvmrpIfName_Type = DisplayString
_DvmrpIfName_Object = MibTableColumn
dvmrpIfName = _DvmrpIfName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 2, 1, 2),
    _DvmrpIfName_Type()
)
dvmrpIfName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpIfName.setStatus("current")
_DvmrpIfAddr_Type = IpAddress
_DvmrpIfAddr_Object = MibTableColumn
dvmrpIfAddr = _DvmrpIfAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 2, 1, 3),
    _DvmrpIfAddr_Type()
)
dvmrpIfAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpIfAddr.setStatus("current")
_DvmrpIfVlan_Type = Integer32
_DvmrpIfVlan_Object = MibTableColumn
dvmrpIfVlan = _DvmrpIfVlan_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 2, 1, 4),
    _DvmrpIfVlan_Type()
)
dvmrpIfVlan.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpIfVlan.setStatus("current")


class _DvmrpIfEnable_Type(Integer32):
    """Custom type dvmrpIfEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_DvmrpIfEnable_Type.__name__ = "Integer32"
_DvmrpIfEnable_Object = MibTableColumn
dvmrpIfEnable = _DvmrpIfEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 2, 1, 5),
    _DvmrpIfEnable_Type()
)
dvmrpIfEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dvmrpIfEnable.setStatus("current")
_DvmrpMulticastRoutingTable_Object = MibTable
dvmrpMulticastRoutingTable = _DvmrpMulticastRoutingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3)
)
if mibBuilder.loadTexts:
    dvmrpMulticastRoutingTable.setStatus("current")
_DvmrpMulticastRoutingEntry_Object = MibTableRow
dvmrpMulticastRoutingEntry = _DvmrpMulticastRoutingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1)
)
dvmrpMulticastRoutingEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "dvmrpMRIndex"),
)
if mibBuilder.loadTexts:
    dvmrpMulticastRoutingEntry.setStatus("current")
_DvmrpMRIndex_Type = Integer32
_DvmrpMRIndex_Object = MibTableColumn
dvmrpMRIndex = _DvmrpMRIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1, 1),
    _DvmrpMRIndex_Type()
)
dvmrpMRIndex.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    dvmrpMRIndex.setStatus("current")
_DvmrpMRGroup_Type = IpAddress
_DvmrpMRGroup_Object = MibTableColumn
dvmrpMRGroup = _DvmrpMRGroup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1, 2),
    _DvmrpMRGroup_Type()
)
dvmrpMRGroup.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpMRGroup.setStatus("current")
_DvmrpMRSource_Type = IpAddress
_DvmrpMRSource_Object = MibTableColumn
dvmrpMRSource = _DvmrpMRSource_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1, 3),
    _DvmrpMRSource_Type()
)
dvmrpMRSource.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpMRSource.setStatus("current")
_DvmrpMRUpstream_Type = DisplayString
_DvmrpMRUpstream_Object = MibTableColumn
dvmrpMRUpstream = _DvmrpMRUpstream_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1, 4),
    _DvmrpMRUpstream_Type()
)
dvmrpMRUpstream.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpMRUpstream.setStatus("current")
_DvmrpMRIncomingIfname_Type = DisplayString
_DvmrpMRIncomingIfname_Object = MibTableColumn
dvmrpMRIncomingIfname = _DvmrpMRIncomingIfname_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1, 5),
    _DvmrpMRIncomingIfname_Type()
)
dvmrpMRIncomingIfname.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpMRIncomingIfname.setStatus("current")
_DvmrpMRVid_Type = DisplayString
_DvmrpMRVid_Object = MibTableColumn
dvmrpMRVid = _DvmrpMRVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1, 6),
    _DvmrpMRVid_Type()
)
dvmrpMRVid.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpMRVid.setStatus("current")
_DvmrpMRExpiretime_Type = DisplayString
_DvmrpMRExpiretime_Object = MibTableColumn
dvmrpMRExpiretime = _DvmrpMRExpiretime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1, 7),
    _DvmrpMRExpiretime_Type()
)
dvmrpMRExpiretime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpMRExpiretime.setStatus("current")
_DvmrpMRLefttime_Type = DisplayString
_DvmrpMRLefttime_Object = MibTableColumn
dvmrpMRLefttime = _DvmrpMRLefttime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1, 8),
    _DvmrpMRLefttime_Type()
)
dvmrpMRLefttime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpMRLefttime.setStatus("current")
_DvmrpMRDowntreamVid_Type = DisplayString
_DvmrpMRDowntreamVid_Object = MibTableColumn
dvmrpMRDowntreamVid = _DvmrpMRDowntreamVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 7, 3, 1, 9),
    _DvmrpMRDowntreamVid_Type()
)
dvmrpMRDowntreamVid.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    dvmrpMRDowntreamVid.setStatus("current")
_Pimdm_ObjectIdentity = ObjectIdentity
pimdm = _Pimdm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8)
)


class _PimdmEnable_Type(Integer32):
    """Custom type pimdmEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_PimdmEnable_Type.__name__ = "Integer32"
_PimdmEnable_Object = MibScalar
pimdmEnable = _PimdmEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 1),
    _PimdmEnable_Type()
)
pimdmEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    pimdmEnable.setStatus("current")
_PimdmInterfaceTable_Object = MibTable
pimdmInterfaceTable = _PimdmInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 2)
)
if mibBuilder.loadTexts:
    pimdmInterfaceTable.setStatus("current")
_PimdmInterfaceEntry_Object = MibTableRow
pimdmInterfaceEntry = _PimdmInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 2, 1)
)
pimdmInterfaceEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "pimdmIfIndex"),
)
if mibBuilder.loadTexts:
    pimdmInterfaceEntry.setStatus("current")
_PimdmIfIndex_Type = Integer32
_PimdmIfIndex_Object = MibTableColumn
pimdmIfIndex = _PimdmIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 2, 1, 1),
    _PimdmIfIndex_Type()
)
pimdmIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmIfIndex.setStatus("current")
_PimdmIfName_Type = DisplayString
_PimdmIfName_Object = MibTableColumn
pimdmIfName = _PimdmIfName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 2, 1, 2),
    _PimdmIfName_Type()
)
pimdmIfName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmIfName.setStatus("current")
_PimdmIfAddr_Type = IpAddress
_PimdmIfAddr_Object = MibTableColumn
pimdmIfAddr = _PimdmIfAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 2, 1, 3),
    _PimdmIfAddr_Type()
)
pimdmIfAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmIfAddr.setStatus("current")
_PimdmIfVlan_Type = Integer32
_PimdmIfVlan_Object = MibTableColumn
pimdmIfVlan = _PimdmIfVlan_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 2, 1, 4),
    _PimdmIfVlan_Type()
)
pimdmIfVlan.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmIfVlan.setStatus("current")


class _PimdmIfEnable_Type(Integer32):
    """Custom type pimdmIfEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_PimdmIfEnable_Type.__name__ = "Integer32"
_PimdmIfEnable_Object = MibTableColumn
pimdmIfEnable = _PimdmIfEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 2, 1, 5),
    _PimdmIfEnable_Type()
)
pimdmIfEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    pimdmIfEnable.setStatus("current")
_PimdmMulticastRoutingTable_Object = MibTable
pimdmMulticastRoutingTable = _PimdmMulticastRoutingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3)
)
if mibBuilder.loadTexts:
    pimdmMulticastRoutingTable.setStatus("current")
_PimdmMulticastRoutingEntry_Object = MibTableRow
pimdmMulticastRoutingEntry = _PimdmMulticastRoutingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3, 1)
)
pimdmMulticastRoutingEntry.setIndexNames(
    (0, "MOXA-ICSG7826A-MIB", "pimdmMRIndex"),
)
if mibBuilder.loadTexts:
    pimdmMulticastRoutingEntry.setStatus("current")
_PimdmMRIndex_Type = Integer32
_PimdmMRIndex_Object = MibTableColumn
pimdmMRIndex = _PimdmMRIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3, 1, 1),
    _PimdmMRIndex_Type()
)
pimdmMRIndex.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    pimdmMRIndex.setStatus("current")
_PimdmMRGroup_Type = IpAddress
_PimdmMRGroup_Object = MibTableColumn
pimdmMRGroup = _PimdmMRGroup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3, 1, 2),
    _PimdmMRGroup_Type()
)
pimdmMRGroup.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmMRGroup.setStatus("current")
_PimdmMRSource_Type = IpAddress
_PimdmMRSource_Object = MibTableColumn
pimdmMRSource = _PimdmMRSource_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3, 1, 3),
    _PimdmMRSource_Type()
)
pimdmMRSource.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmMRSource.setStatus("current")
_PimdmMRUpstream_Type = DisplayString
_PimdmMRUpstream_Object = MibTableColumn
pimdmMRUpstream = _PimdmMRUpstream_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3, 1, 4),
    _PimdmMRUpstream_Type()
)
pimdmMRUpstream.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmMRUpstream.setStatus("current")
_PimdmMRIncomingIfname_Type = DisplayString
_PimdmMRIncomingIfname_Object = MibTableColumn
pimdmMRIncomingIfname = _PimdmMRIncomingIfname_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3, 1, 5),
    _PimdmMRIncomingIfname_Type()
)
pimdmMRIncomingIfname.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmMRIncomingIfname.setStatus("current")
_PimdmMRVid_Type = Integer32
_PimdmMRVid_Object = MibTableColumn
pimdmMRVid = _PimdmMRVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3, 1, 6),
    _PimdmMRVid_Type()
)
pimdmMRVid.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmMRVid.setStatus("current")
_PimdmMRLefttime_Type = DisplayString
_PimdmMRLefttime_Object = MibTableColumn
pimdmMRLefttime = _PimdmMRLefttime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3, 1, 7),
    _PimdmMRLefttime_Type()
)
pimdmMRLefttime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmMRLefttime.setStatus("current")
_PimdmMRDowntreamVid_Type = DisplayString
_PimdmMRDowntreamVid_Object = MibTableColumn
pimdmMRDowntreamVid = _PimdmMRDowntreamVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 3, 8, 3, 1, 8),
    _PimdmMRDowntreamVid_Type()
)
pimdmMRDowntreamVid.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pimdmMRDowntreamVid.setStatus("current")
...
configChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 1)
)
configChangeTrap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varconfigChangeTrap")
)
if mibBuilder.loadTexts:
...
power1Trap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 2)
)
power1Trap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varpower1Trap")
)
if mibBuilder.loadTexts:
...
power2Trap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 3)
)
power2Trap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varpower2Trap")
)
if mibBuilder.loadTexts:
...
trafficOverloadTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 4)
)
trafficOverloadTrap.setObjects(
    ("MOXA-ICSG7826A-MIB", "vartrafficOverloadTrap")
)
if mibBuilder.loadTexts:
...
redundancyTopologyChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 5)
)
redundancyTopologyChangedTrap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varredundancyTopologyChangedTrap")
)
if mibBuilder.loadTexts:
...
turboRingCouplingPortChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 6)
)
turboRingCouplingPortChangedTrap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varturboRingCouplingPortChangedTrap")
)
if mibBuilder.loadTexts:
...
turboRingMasterChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 7)
)
turboRingMasterChangedTrap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varturboRingMasterChangedTrap")
)
if mibBuilder.loadTexts:
...
portLoopDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 17)
)
portLoopDetectedTrap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varPortLoopDetectedTrap")
)
if mibBuilder.loadTexts:
...
rateLimitedOnTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 18)
)
rateLimitedOnTrap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varRateLimitedOnTrap")
)
if mibBuilder.loadTexts:
...
lldpChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 19)
)
lldpChgTrap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varLLDPChgTrap")
)
if mibBuilder.loadTexts:
...
abc02WarningTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 99, 0, 20)
)
abc02WarningTrap.setObjects(
    ("MOXA-ICSG7826A-MIB", "varABC02WarningTrap")
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"PortList": PortList,
       ...
       "qinqSettingTable": qinqSettingTable,
       "qinqSettingEntry": qinqSettingEntry,
       "qinqEnable": qinqEnable,
       "qinqTpid": qinqTpid,
       ...
       "igmpSnoopingStreamTable": igmpSnoopingStreamTable,
       "igmpSnoopingStreamEntry": igmpSnoopingStreamEntry,
       "igmpSnoopingStreamIndex": igmpSnoopingStreamIndex,
       "igmpSnoopingStreamGroup": igmpSnoopingStreamGroup,
       "igmpSnoopingStreamSource": igmpSnoopingStreamSource,
       "igmpSnoopingStreamPort": igmpSnoopingStreamPort,
       "igmpSnoopingMemberPorts": igmpSnoopingMemberPorts,
       ...
       "l3Mgmt": l3Mgmt,
       "ipIfSetting": ipIfSetting,
       "ipIfSettingTable": ipIfSettingTable,
       "ipIfSettingEntry": ipIfSettingEntry,
       "ipIfIndex": ipIfIndex,
       "ipIfName": ipIfName,
       "ipIfAddr": ipIfAddr,
       "ipIfNetmask": ipIfNetmask,
       "ipIfVlan": ipIfVlan,
       "ipIfProxyArp": ipIfProxyArp,
       "ipIfStatus": ipIfStatus,
       "staticRoute": staticRoute,
       "staticRouteTable": staticRouteTable,
       "staticRouteEntry": staticRouteEntry,
       "staticRouteIndex": staticRouteIndex,
       "staticRouteAddr": staticRouteAddr,
       ...
       "ripRedistConnected": ripRedistConnected,
       "ripRedistStatic": ripRedistStatic,
       "ripRedistOspf": ripRedistOspf,
       "ripInterfaceTable": ripInterfaceTable,
       "ripInterfaceEntry": ripInterfaceEntry,
       "ripIfName": ripIfName,
       "ripIfAddr": ripIfAddr,
       "ripIfVlan": ripIfVlan,
       "ripIfEnable": ripIfEnable,
       "ospf": ospf,
       "ospfGlobal": ospfGlobal,
       "ospfEnable": ospfEnable,
       "ospfRouterId": ospfRouterId,
       "ospfCurrentRouterId": ospfCurrentRouterId,
       "ospfRedistConnected": ospfRedistConnected,
       "ospfRedistStatic": ospfRedistStatic,
       "ospfRedistRip": ospfRedistRip,
       "ospfArea": ospfArea,
       "ospfAreaTable": ospfAreaTable,
       "ospfAreaEntry": ospfAreaEntry,
       "ospfAreaId": ospfAreaId,
       "ospfAreaType": ospfAreaType,
       "ospfAreaMetric": ospfAreaMetric,
       ...
       "ospfIfAddr": ospfIfAddr,
       "ospfIfAreaId": ospfIfAreaId,
       "ospfIfState": ospfIfState,
       "ospfIfPriority": ospfIfPriority,
       "ospfIfHelloInterval": ospfIfHelloInterval,
       "ospfIfDeadInterval": ospfIfDeadInterval,
       "ospfIfAuthType": ospfIfAuthType,
       "ospfIfAuthKey": ospfIfAuthKey,
       "ospfIfMd5KeyId": ospfIfMd5KeyId,
       "ospfIfMetric": ospfIfMetric,
       "ospfIfStatus": ospfIfStatus,
       "ospfVirtualLink": ospfVirtualLink,
       "ospfVlinkTable": ospfVlinkTable,
       "ospfVlinkEntry": ospfVlinkEntry,
       "ospfVlinkIndex": ospfVlinkIndex,
       "ospfTransitAreaId": ospfTransitAreaId,
       "ospfNeighborAreaId": ospfNeighborAreaId,
       "ospfVlinkStatus": ospfVlinkStatus,
       "ospfAggregation": ospfAggregation,
       "ospfAggregationTable": ospfAggregationTable,
       "ospfAggregationEntry": ospfAggregationEntry,
       "ospfAggrIndex": ospfAggrIndex,
       "ospfAggrAreaId": ospfAggrAreaId,
       "ospfAggrAddr": ospfAggrAddr,
       "ospfAggrMask": ospfAggrMask,
       "ospfAggrStatus": ospfAggrStatus,
       "ipRoutingTable": ipRoutingTable,
       "ipRoutingEntry": ipRoutingEntry,
       "ipRoutingIndex": ipRoutingIndex,
       "ipRoutingType": ipRoutingType,
       "ipRoutingDest": ipRoutingDest,
       "ipRoutingNextHop": ipRoutingNextHop,
       "ipRoutingIfName": ipRoutingIfName,
       "ipRoutingMetric": ipRoutingMetric,
       "ipRoutingVlan": ipRoutingVlan,
       "vrrp": vrrp,
       "vrrpInterfaceTable": vrrpInterfaceTable,
       "vrrpInterfaceEntry": vrrpInterfaceEntry,
       "vrrpIfName": vrrpIfName,
       "vrrpIfAddr": vrrpIfAddr,
       "vrrpIfVlan": vrrpIfVlan,
       "vrrpIfEnable": vrrpIfEnable,
       "vrrpIfVirtualIp": vrrpIfVirtualIp,
       "vrrpIfRouterId": vrrpIfRouterId,
       "vrrpIfPriority": vrrpIfPriority,
       "vrrpIfPreemptionMode": vrrpIfPreemptionMode,
       "vrrpIfStatus": vrrpIfStatus,
       "vrrpEnable": vrrpEnable,
       "vrrpAdverInt": vrrpAdverInt,
       "dvmrp": dvmrp,
       "dvmrpEnable": dvmrpEnable,
       "dvmrpInterfaceTable": dvmrpInterfaceTable,
       "dvmrpInterfaceEntry": dvmrpInterfaceEntry,
       "dvmrpIfIndex": dvmrpIfIndex,
       "dvmrpIfName": dvmrpIfName,
       "dvmrpIfAddr": dvmrpIfAddr,
       "dvmrpIfVlan": dvmrpIfVlan,
       "dvmrpIfEnable": dvmrpIfEnable,
       "dvmrpMulticastRoutingTable": dvmrpMulticastRoutingTable,
       "dvmrpMulticastRoutingEntry": dvmrpMulticastRoutingEntry,
       "dvmrpMRIndex": dvmrpMRIndex,
       "dvmrpMRGroup": dvmrpMRGroup,
       "dvmrpMRSource": dvmrpMRSource,
       "dvmrpMRUpstream": dvmrpMRUpstream,
       "dvmrpMRIncomingIfname": dvmrpMRIncomingIfname,
       "dvmrpMRVid": dvmrpMRVid,
       "dvmrpMRExpiretime": dvmrpMRExpiretime,
       "dvmrpMRLefttime": dvmrpMRLefttime,
       "dvmrpMRDowntreamVid": dvmrpMRDowntreamVid,
       "pimdm": pimdm,
       "pimdmEnable": pimdmEnable,
       "pimdmInterfaceTable": pimdmInterfaceTable,
       "pimdmInterfaceEntry": pimdmInterfaceEntry,
       "pimdmIfIndex": pimdmIfIndex,
       "pimdmIfName": pimdmIfName,
       "pimdmIfAddr": pimdmIfAddr,
       "pimdmIfVlan": pimdmIfVlan,
       "pimdmIfEnable": pimdmIfEnable,
       "pimdmMulticastRoutingTable": pimdmMulticastRoutingTable,
       "pimdmMulticastRoutingEntry": pimdmMulticastRoutingEntry,
       "pimdmMRIndex": pimdmMRIndex,
       "pimdmMRGroup": pimdmMRGroup,
       "pimdmMRSource": pimdmMRSource,
       "pimdmMRUpstream": pimdmMRUpstream,
       "pimdmMRIncomingIfname": pimdmMRIncomingIfname,
       "pimdmMRVid": pimdmMRVid,
       "pimdmMRLefttime": pimdmMRLefttime,
       "pimdmMRDowntreamVid": pimdmMRDowntreamVid}
)
