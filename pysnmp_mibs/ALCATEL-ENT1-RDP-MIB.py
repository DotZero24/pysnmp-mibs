# SNMP MIB module (ALCATEL-ENT1-RDP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-RDP-MIB
...
alaRDPIfEntry.setIndexNames(
    (0, "ALCATEL-ENT1-RDP-MIB", "alaRDPIfAddr"),
)
if mibBuilder.loadTexts:
...
alaRDPConfigMIBGroup.setObjects(
      *(("ALCATEL-ENT1-RDP-MIB", "alaRDPStatus"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIfAddr"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIfStatus"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIfAdvtAddress"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIfMaxAdvtInterval"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIfMinAdvtInterval"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIfAdvLifeTime"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIfPrefLevel"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIfRowStatus"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIfName"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPIPIfStatus"),
        ("ALCATEL-ENT1-RDP-MIB", "alaRDPVrrpStatus"))
)
if mibBuilder.loadTexts:
...
alcatelIND1RDPMIBCompliance.setObjects(
    ("ALCATEL-ENT1-RDP-MIB", "alaRDPConfigMIBGroup")
)
if mibBuilder.loadTexts:
