...
alcatelIND1RDPMIBObjects=_AlcatelIND1RDPMIBObjects_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1))
_AlaRDPConfig_ObjectIdentity=ObjectIdentity
alaRDPConfig=_AlaRDPConfig_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1))
...
alaRDPStatus=_AlaRDPStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,1),_AlaRDPStatus_Type())
alaRDPStatus.setMaxAccess('read-write')
if mibBuilder.loadTexts:alaRDPStatus.setStatus(_A)
_AlaRDPIfTable_Object=MibTable
alaRDPIfTable=_AlaRDPIfTable_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20))
if mibBuilder.loadTexts:alaRDPIfTable.setStatus(_A)
_AlaRDPIfEntry_Object=MibTableRow
alaRDPIfEntry=_AlaRDPIfEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1))
...
alaRDPIfAddr=_AlaRDPIfAddr_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,1),_AlaRDPIfAddr_Type())
...
alaRDPIfStatus=_AlaRDPIfStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,2),_AlaRDPIfStatus_Type())
...
alaRDPIfAdvtAddress=_AlaRDPIfAdvtAddress_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,3),_AlaRDPIfAdvtAddress_Type())
...
alaRDPIfMaxAdvtInterval=_AlaRDPIfMaxAdvtInterval_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,4),_AlaRDPIfMaxAdvtInterval_Type())
...
alaRDPIfMinAdvtInterval=_AlaRDPIfMinAdvtInterval_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,5),_AlaRDPIfMinAdvtInterval_Type())
...
alaRDPIfAdvLifeTime=_AlaRDPIfAdvLifeTime_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,6),_AlaRDPIfAdvLifeTime_Type())
...
alaRDPIfPrefLevel=_AlaRDPIfPrefLevel_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,7),_AlaRDPIfPrefLevel_Type())
...
alaRDPIfRowStatus=_AlaRDPIfRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,8),_AlaRDPIfRowStatus_Type())
alaRDPIfRowStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:alaRDPIfRowStatus.setStatus(_A)
_AlaRDPIfName_Type=SnmpAdminString
_AlaRDPIfName_Object=MibTableColumn
alaRDPIfName=_AlaRDPIfName_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,9),_AlaRDPIfName_Type())
...
alaRDPIPIfStatus=_AlaRDPIPIfStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,10),_AlaRDPIPIfStatus_Type())
...
alaRDPVrrpStatus=_AlaRDPVrrpStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,1,1,20,1,11),_AlaRDPVrrpStatus_Type())
...
alcatelIND1RDPMIBConformance=_AlcatelIND1RDPMIBConformance_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,2))
_AlcatelIND1RDPMIBCompliances_ObjectIdentity=ObjectIdentity
alcatelIND1RDPMIBCompliances=_AlcatelIND1RDPMIBCompliances_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,2,1))
_AlcatelIND1RDPMIBGroups_ObjectIdentity=ObjectIdentity
alcatelIND1RDPMIBGroups=_AlcatelIND1RDPMIBGroups_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,2,2))
alaRDPConfigMIBGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,2,2,1))
...
alcatelIND1RDPMIBCompliance=ModuleCompliance((1,3,6,1,4,1,6486,801,1,2,1,10,11,1,2,1,1))
