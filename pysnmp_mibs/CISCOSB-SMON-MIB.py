...
rlPortCopyMibVersion=_RlPortCopyMibVersion_Object((1,3,6,1,4,1,9,6,1,101,84,1),_RlPortCopyMibVersion_Type())
...
rlPortCopySupport=_RlPortCopySupport_Object((1,3,6,1,4,1,9,6,1,101,84,2),_RlPortCopySupport_Type())
...
rlPortCopyVlanTaggingTable=_RlPortCopyVlanTaggingTable_Object((1,3,6,1,4,1,9,6,1,101,84,3))
if mibBuilder.loadTexts:rlPortCopyVlanTaggingTable.setStatus(_A)
_RlPortCopyVlanTaggingEntry_Object=MibTableRow
rlPortCopyVlanTaggingEntry=_RlPortCopyVlanTaggingEntry_Object((1,3,6,1,4,1,9,6,1,101,84,3,1))
...
rlPortCopyVlanTagging=_RlPortCopyVlanTagging_Object((1,3,6,1,4,1,9,6,1,101,84,3,1,1),_RlPortCopyVlanTagging_Type())
...
rlPortCopyMode=_RlPortCopyMode_Object((1,3,6,1,4,1,9,6,1,101,84,4),_RlPortCopyMode_Type())
