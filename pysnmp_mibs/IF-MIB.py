...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Integer32, Gauge32, ModuleIdentity, TimeTicks, mib_2, NotificationType, Counter32, Bits, IpAddress, iso, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Integer32", "Gauge32", "ModuleIdentity", "TimeTicks", "mib-2", "NotificationType", "Counter32", "Bits", "IpAddress", "iso", "ObjectIdentity", "Counter64")
AutonomousType, TestAndIncr, TimeStamp, PhysAddress, TextualConvention, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TestAndIncr", "TimeStamp", "PhysAddress", "TextualConvention", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", PYSNMP_MODULE_ID=ifMIB, InterfaceIndex=InterfaceIndex, ifOldObjectsGroup=ifOldObjectsGroup, ifName=ifName, ifGroups=ifGroups, ifStackGroup=ifStackGroup, OwnerString=OwnerString, ifStackStatus=ifStackStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifMIB=ifMIB, ifStackEntry=ifStackEntry, ifTestTable=ifTestTable, interfaces=interfaces, ifHighSpeed=ifHighSpeed, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifConformance=ifConformance, ifTestType=ifTestType, ifMIBObjects=ifMIBObjects, ifXEntry=ifXEntry, ifOutDiscards=ifOutDiscards, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressTable=ifRcvAddressTable, ifOperStatus=ifOperStatus, ifLastChange=ifLastChange, ifPacketGroup=ifPacketGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestEntry=ifTestEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInErrors=ifInErrors, ifOutOctets=ifOutOctets, ifInOctets=ifInOctets, ifTableLastChange=ifTableLastChange, ifPromiscuousMode=ifPromiscuousMode, ifOutErrors=ifOutErrors, ifInUcastPkts=ifInUcastPkts, ifHCInOctets=ifHCInOctets, ifTestGroup=ifTestGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifOutQLen=ifOutQLen, ifSpecific=ifSpecific, ifCompliance3=ifCompliance3, ifCompliance=ifCompliance, ifTestStatus=ifTestStatus, ifStackGroup2=ifStackGroup2, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressType=ifRcvAddressType, ifTestOwner=ifTestOwner, ifFixedLengthGroup=ifFixedLengthGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifGeneralGroup=ifGeneralGroup, ifCompliance2=ifCompliance2, ifTestId=ifTestId, ifEntry=ifEntry, ifAdminStatus=ifAdminStatus, ifMtu=ifMtu, ifInUnknownProtos=ifInUnknownProtos, ifStackTable=ifStackTable, ifInNUcastPkts=ifInNUcastPkts, ifAlias=ifAlias, ifRcvAddressStatus=ifRcvAddressStatus, ifXTable=ifXTable, ifHCInMulticastPkts=ifHCInMulticastPkts, linkUp=linkUp, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, linkDown=linkDown, ifOutUcastPkts=ifOutUcastPkts, ifTable=ifTable, ifConnectorPresent=ifConnectorPresent, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackHigherLayer=ifStackHigherLayer, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestResult=ifTestResult, ifPhysAddress=ifPhysAddress, ifIndex=ifIndex, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifType=ifType, ifSpeed=ifSpeed, ifHCOutOctets=ifHCOutOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestCode=ifTestCode, ifCompliances=ifCompliances, ifNumber=ifNumber, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackLastChange=ifStackLastChange, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInDiscards=ifInDiscards, ifHCPacketGroup=ifHCPacketGroup, ifDescr=ifDescr)
