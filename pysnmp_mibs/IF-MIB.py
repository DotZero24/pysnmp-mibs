...
mibBuilder.exportSymbols("IF-MIB", ifStackTable=ifStackTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliance3=ifCompliance3, ifEntry=ifEntry, ifTestResult=ifTestResult, ifConformance=ifConformance, ifOutUcastPkts=ifOutUcastPkts, ifTable=ifTable, ifRcvAddressTable=ifRcvAddressTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOperStatus=ifOperStatus, ifPromiscuousMode=ifPromiscuousMode, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifSpeed=ifSpeed, ifOutMulticastPkts=ifOutMulticastPkts, ifStackStatus=ifStackStatus, ifTestOwner=ifTestOwner, ifFixedLengthGroup=ifFixedLengthGroup, ifTestEntry=ifTestEntry, ifTestId=ifTestId, ifHCPacketGroup=ifHCPacketGroup, ifCompliance2=ifCompliance2, ifTestStatus=ifTestStatus, ifHCInOctets=ifHCInOctets, ifGroups=ifGroups, ifHCOutUcastPkts=ifHCOutUcastPkts, ifName=ifName, ifHighSpeed=ifHighSpeed, interfaces=interfaces, ifOutNUcastPkts=ifOutNUcastPkts, ifMIBObjects=ifMIBObjects, ifPacketGroup=ifPacketGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackHigherLayer=ifStackHigherLayer, ifStackLowerLayer=ifStackLowerLayer, ifInUcastPkts=ifInUcastPkts, ifStackGroup2=ifStackGroup2, ifOutErrors=ifOutErrors, ifStackGroup=ifStackGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInMulticastPkts=ifInMulticastPkts, ifXEntry=ifXEntry, ifOutDiscards=ifOutDiscards, ifType=ifType, ifConnectorPresent=ifConnectorPresent, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliances=ifCompliances, PYSNMP_MODULE_ID=ifMIB, ifInUnknownProtos=ifInUnknownProtos, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPhysAddress=ifPhysAddress, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAlias=ifAlias, ifTestType=ifTestType, ifStackEntry=ifStackEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifSpecific=ifSpecific, ifIndex=ifIndex, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressType=ifRcvAddressType, ifCompliance=ifCompliance, ifTestGroup=ifTestGroup, ifStackLastChange=ifStackLastChange, linkDown=linkDown, ifHCOutOctets=ifHCOutOctets, ifAdminStatus=ifAdminStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifOldObjectsGroup=ifOldObjectsGroup, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndex=InterfaceIndex, ifInDiscards=ifInDiscards, ifOutOctets=ifOutOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifMIB=ifMIB, ifTestCode=ifTestCode, ifTestTable=ifTestTable, linkUp=linkUp, OwnerString=OwnerString, ifInNUcastPkts=ifInNUcastPkts, ifInErrors=ifInErrors, ifLastChange=ifLastChange, ifTableLastChange=ifTableLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifGeneralGroup=ifGeneralGroup, ifDescr=ifDescr, ifInOctets=ifInOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMtu=ifMtu, ifXTable=ifXTable, ifOutQLen=ifOutQLen)
