...
ModuleIdentity, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, MibIdentifier, mib_2, Counter64, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "MibIdentifier", "mib-2", "Counter64", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifOldObjectsGroup=ifOldObjectsGroup, ifMtu=ifMtu, ifTestEntry=ifTestEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifStackGroup=ifStackGroup, ifOutUcastPkts=ifOutUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifMIBObjects=ifMIBObjects, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifOutOctets=ifOutOctets, ifSpecific=ifSpecific, ifOutErrors=ifOutErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackLastChange=ifStackLastChange, ifInDiscards=ifInDiscards, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressTable=ifRcvAddressTable, linkDown=linkDown, ifDescr=ifDescr, ifRcvAddressType=ifRcvAddressType, ifCompliances=ifCompliances, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestResult=ifTestResult, ifXEntry=ifXEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPacketGroup=ifPacketGroup, ifNumber=ifNumber, ifStackEntry=ifStackEntry, ifSpeed=ifSpeed, OwnerString=OwnerString, ifHCPacketGroup=ifHCPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifEntry=ifEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifConformance=ifConformance, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifLastChange=ifLastChange, interfaces=interfaces, ifTestTable=ifTestTable, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance=ifCompliance, ifInUnknownProtos=ifInUnknownProtos, ifType=ifType, ifInBroadcastPkts=ifInBroadcastPkts, ifTestOwner=ifTestOwner, ifOutNUcastPkts=ifOutNUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifTestStatus=ifTestStatus, ifInErrors=ifInErrors, ifInNUcastPkts=ifInNUcastPkts, ifTable=ifTable, ifCompliance2=ifCompliance2, ifHCOutOctets=ifHCOutOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifTableLastChange=ifTableLastChange, ifGeneralGroup=ifGeneralGroup, ifInOctets=ifInOctets, ifAdminStatus=ifAdminStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackTable=ifStackTable, ifIndex=ifIndex, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestCode=ifTestCode, ifTestGroup=ifTestGroup, ifStackStatus=ifStackStatus, ifConnectorPresent=ifConnectorPresent, ifOutQLen=ifOutQLen, linkUp=linkUp, ifPromiscuousMode=ifPromiscuousMode, ifHCInUcastPkts=ifHCInUcastPkts, ifAlias=ifAlias, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance3=ifCompliance3, ifStackGroup2=ifStackGroup2, ifTestId=ifTestId, ifTestType=ifTestType, InterfaceIndex=InterfaceIndex, ifPhysAddress=ifPhysAddress, ifXTable=ifXTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHighSpeed=ifHighSpeed, ifName=ifName, ifOperStatus=ifOperStatus, ifMIB=ifMIB, ifOutDiscards=ifOutDiscards, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInUcastPkts=ifInUcastPkts, ifHCInOctets=ifHCInOctets, ifGroups=ifGroups, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressEntry=ifRcvAddressEntry)
