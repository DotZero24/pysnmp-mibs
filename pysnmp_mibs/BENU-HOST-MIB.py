...
mibBuilder.exportSymbols("BENU-HOST-MIB", bSWTaskCPUUsage=bSWTaskCPUUsage, bSWTaskRestartLimit=bSWTaskRestartLimit, bSWProcessName=bSWProcessName, bSWTaskAvgCPUUsage=bSWTaskAvgCPUUsage, bSWTaskRunStateTime=bSWTaskRunStateTime, bSWTaskIndex=bSWTaskIndex, bSysAvgCPUUtil15Sec=bSysAvgCPUUtil15Sec, bSWTaskAvgCPUUsageLowThreshold=bSWTaskAvgCPUUsageLowThreshold, bSWTaskVirtMemUsage=bSWTaskVirtMemUsage, bSWTaskName=bSWTaskName, bSysMemFree=bSysMemFree, bHostNotifObjects=bHostNotifObjects, bSysTotalMem=bSysTotalMem, bSWTaskRestartLimitReached=bSWTaskRestartLimitReached, bHostNotifVariables=bHostNotifVariables, bSWTaskAvgCPUUsageHighThreshold=bSWTaskAvgCPUUsageHighThreshold, bSWProcessID=bSWProcessID, bSWProcessAvgCPUUsageHighThreshold=bSWProcessAvgCPUUsageHighThreshold, bSWTaskDataSegmentSize=bSWTaskDataSegmentSize, bSWTaskRestartability=bSWTaskRestartability, bHostMIBObjects=bHostMIBObjects, bSWTaskResidentPhyMem=bSWTaskResidentPhyMem, bSWTaskCPUUsageLimit=bSWTaskCPUUsageLimit, bSWTaskDiedReason=bSWTaskDiedReason, bSWTaskAvgCPUUsageLow=bSWTaskAvgCPUUsageLow, bSWTaskAvgCPUUsageHigh=bSWTaskAvgCPUUsageHigh, bSWTaskCodeSegmentSize=bSWTaskCodeSegmentSize, bSWTaskInfoEntry=bSWTaskInfoEntry, bSWTaskMaxCPUUsage=bSWTaskMaxCPUUsage, bSWTaskVirtMemPeakUsage=bSWTaskVirtMemPeakUsage, bSWTaskProcessID=bSWTaskProcessID, bSWTaskLoadIntervalDuration=bSWTaskLoadIntervalDuration, bSWProcessAvgCPUUsageLowThreshold=bSWProcessAvgCPUUsageLowThreshold, PYSNMP_MODULE_ID=bHostMIB, bSWTaskSharedMem=bSWTaskSharedMem, bSysMemUsed=bSysMemUsed, bSysAvgCPUUtil5Min=bSysAvgCPUUtil5Min, bCPUMonInterval=bCPUMonInterval, bSWTaskRestartCount=bSWTaskRestartCount, bSysAvgCPUUtil1Min=bSysAvgCPUUtil1Min, bHostMIB=bHostMIB, bSysTotalCPUUtilAvailable=bSysTotalCPUUtilAvailable, bSWTaskInfoTable=bSWTaskInfoTable, bSWTaskDied=bSWTaskDied)
