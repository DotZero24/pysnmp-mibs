...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TN-IEEE8021-CFM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:50:58 2025
...
class _TnDot1agCfmMaMepListSapSubType_Type(Integer32):
    """Custom type tnDot1agCfmMaMepListSapSubType based on Integer32"""
    defaultValue = 0
...
_TnDot1agCfmMaMepListSapSubType_Type.__name__ = "Integer32"
_TnDot1agCfmMaMepListSapSubType_Object = MibTableColumn
tnDot1agCfmMaMepListSapSubType = _TnDot1agCfmMaMepListSapSubType_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 6, 3, 1, 2),
    _TnDot1agCfmMaMepListSapSubType_Type()
)
tnDot1agCfmMaMepListSapSubType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnDot1agCfmMaMepListSapSubType.setStatus("current")
...
class _TnDot1agCfmMepTransmitLbmDataTlvSize_Type(Unsigned32):
    """Custom type tnDot1agCfmMepTransmitLbmDataTlvSize based on Unsigned32"""
    defaultValue = 0

    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 9570),
    )


_TnDot1agCfmMepTransmitLbmDataTlvSize_Type.__name__ = "Unsigned32"
_TnDot1agCfmMepTransmitLbmDataTlvSize_Object = MibTableColumn
tnDot1agCfmMepTransmitLbmDataTlvSize = _TnDot1agCfmMepTransmitLbmDataTlvSize_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 1, 1, 26),
    _TnDot1agCfmMepTransmitLbmDataTlvSize_Type()
)
tnDot1agCfmMepTransmitLbmDataTlvSize.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnDot1agCfmMepTransmitLbmDataTlvSize.setStatus("current")
if mibBuilder.loadTexts:
    tnDot1agCfmMepTransmitLbmDataTlvSize.setUnits("bytes")


class _TnDot1agCfmMepType_Type(Integer32):
    """Custom type tnDot1agCfmMepType based on Integer32"""
    defaultValue = 0
...
_TnDot1agCfmMepType_Type.__name__ = "Integer32"
_TnDot1agCfmMepType_Object = MibTableColumn
tnDot1agCfmMepType = _TnDot1agCfmMepType_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 1, 1, 27),
    _TnDot1agCfmMepType_Type()
)
tnDot1agCfmMepType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnDot1agCfmMepType.setStatus("current")


class _TnDot1agCfmMepFaultPropagation_Type(Integer32):
    """Custom type tnDot1agCfmMepFaultPropagation based on Integer32"""
    defaultValue = 0
...
_TnDot1agCfmMepFaultPropagation_Type.__name__ = "Integer32"
_TnDot1agCfmMepFaultPropagation_Object = MibTableColumn
tnDot1agCfmMepFaultPropagation = _TnDot1agCfmMepFaultPropagation_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 1, 1, 28),
    _TnDot1agCfmMepFaultPropagation_Type()
)
tnDot1agCfmMepFaultPropagation.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnDot1agCfmMepFaultPropagation.setStatus("current")


class _TnDot1agCfmMepOWDTDataSize_Type(Unsigned32):
    """Custom type tnDot1agCfmMepOWDTDataSize based on Unsigned32"""
    defaultValue = 0
...
_TnDot1agCfmMepOWDTDataSize_Type.__name__ = "Unsigned32"
_TnDot1agCfmMepOWDTDataSize_Object = MibTableColumn
tnDot1agCfmMepOWDTDataSize = _TnDot1agCfmMepOWDTDataSize_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 1, 1, 29),
    _TnDot1agCfmMepOWDTDataSize_Type()
)
tnDot1agCfmMepOWDTDataSize.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnDot1agCfmMepOWDTDataSize.setStatus("current")
if mibBuilder.loadTexts:
    tnDot1agCfmMepOWDTDataSize.setUnits("bytes")


class _TnDot1agCfmMepAlmProfName_Type(OctetString):
    """Custom type tnDot1agCfmMepAlmProfName based on OctetString"""
...
_TnDot1agCfmMepAlmProfName_Type.__name__ = "OctetString"
_TnDot1agCfmMepAlmProfName_Object = MibTableColumn
tnDot1agCfmMepAlmProfName = _TnDot1agCfmMepAlmProfName_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 1, 1, 30),
    _TnDot1agCfmMepAlmProfName_Type()
)
tnDot1agCfmMepAlmProfName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnDot1agCfmMepAlmProfName.setStatus("current")
...
tnDot1agCfmMepDelayNearEndTestDelay = _TnDot1agCfmMepDelayNearEndTestDelay_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 3, 1, 5),
    _TnDot1agCfmMepDelayNearEndTestDelay_Type()
)
tnDot1agCfmMepDelayNearEndTestDelay.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnDot1agCfmMepDelayNearEndTestDelay.setStatus("current")
if mibBuilder.loadTexts:
    tnDot1agCfmMepDelayNearEndTestDelay.setUnits("microseconds")
_TnDot1agCfmMepDelayNearEndVariation_Type = Unsigned32
_TnDot1agCfmMepDelayNearEndVariation_Object = MibTableColumn
tnDot1agCfmMepDelayNearEndVariation = _TnDot1agCfmMepDelayNearEndVariation_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 3, 1, 6),
    _TnDot1agCfmMepDelayNearEndVariation_Type()
)
tnDot1agCfmMepDelayNearEndVariation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnDot1agCfmMepDelayNearEndVariation.setStatus("current")
if mibBuilder.loadTexts:
    tnDot1agCfmMepDelayNearEndVariation.setUnits("microseconds")
_TnDot1agCfmMepDelayFarEndTestDelay_Type = Integer32
_TnDot1agCfmMepDelayFarEndTestDelay_Object = MibTableColumn
tnDot1agCfmMepDelayFarEndTestDelay = _TnDot1agCfmMepDelayFarEndTestDelay_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 3, 1, 7),
    _TnDot1agCfmMepDelayFarEndTestDelay_Type()
)
tnDot1agCfmMepDelayFarEndTestDelay.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnDot1agCfmMepDelayFarEndTestDelay.setStatus("current")
if mibBuilder.loadTexts:
    tnDot1agCfmMepDelayFarEndTestDelay.setUnits("microseconds")
_TnDot1agCfmMepDelayFarEndVariation_Type = Unsigned32
_TnDot1agCfmMepDelayFarEndVariation_Object = MibTableColumn
tnDot1agCfmMepDelayFarEndVariation = _TnDot1agCfmMepDelayFarEndVariation_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 3, 1, 8),
    _TnDot1agCfmMepDelayFarEndVariation_Type()
)
tnDot1agCfmMepDelayFarEndVariation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnDot1agCfmMepDelayFarEndVariation.setStatus("current")
if mibBuilder.loadTexts:
    tnDot1agCfmMepDelayFarEndVariation.setUnits("microseconds")
...
class _TnDot1agCfmMepOndemandLmTimeout_Type(Unsigned32):
    """Custom type tnDot1agCfmMepOndemandLmTimeout based on Unsigned32"""
    defaultValue = 1000
...
_TnDot1agCfmMepOndemandLmTimeout_Type.__name__ = "Unsigned32"
_TnDot1agCfmMepOndemandLmTimeout_Object = MibTableColumn
tnDot1agCfmMepOndemandLmTimeout = _TnDot1agCfmMepOndemandLmTimeout_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 8, 1, 6),
    _TnDot1agCfmMepOndemandLmTimeout_Type()
)
tnDot1agCfmMepOndemandLmTimeout.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnDot1agCfmMepOndemandLmTimeout.setStatus("current")
if mibBuilder.loadTexts:
    tnDot1agCfmMepOndemandLmTimeout.setUnits("milliseconds")
...
tnDot1agCfmMepOndemandLmRemoteMacAddr = _TnDot1agCfmMepOndemandLmRemoteMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 52, 7, 9, 1, 6),
    _TnDot1agCfmMepOndemandLmRemoteMacAddr_Type()
)
tnDot1agCfmMepOndemandLmRemoteMacAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnDot1agCfmMepOndemandLmRemoteMacAddr.setStatus("current")
...
mibBuilder.exportSymbols(
    "TN-IEEE8021-CFM-MIB",
    **{"NokiaPmonUnitType": NokiaPmonUnitType,
       ...
       "tnDot1agCfmMepTransmitLbmDataTlvSize": tnDot1agCfmMepTransmitLbmDataTlvSize,
       "tnDot1agCfmMepType": tnDot1agCfmMepType,
       "tnDot1agCfmMepFaultPropagation": tnDot1agCfmMepFaultPropagation,
       "tnDot1agCfmMepOWDTDataSize": tnDot1agCfmMepOWDTDataSize,
       "tnDot1agCfmMepAlmProfName": tnDot1agCfmMepAlmProfName,
       ...
       "tnDot1agCfmMepDelayNearEndTestDelay": tnDot1agCfmMepDelayNearEndTestDelay,
       "tnDot1agCfmMepDelayNearEndVariation": tnDot1agCfmMepDelayNearEndVariation,
       "tnDot1agCfmMepDelayFarEndTestDelay": tnDot1agCfmMepDelayFarEndTestDelay,
       "tnDot1agCfmMepDelayFarEndVariation": tnDot1agCfmMepDelayFarEndVariation,
       ...
       "tnDot1agCfmMepOndemandLmTimeout": tnDot1agCfmMepOndemandLmTimeout,
       ...
       "tnDot1agCfmMepOndemandLmRemoteMacAddr": tnDot1agCfmMepOndemandLmRemoteMacAddr,
