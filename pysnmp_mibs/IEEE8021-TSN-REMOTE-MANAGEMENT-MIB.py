...
# Notes
# -----
# ASN.1 source file://mibs/rfc/IEEE8021-TSN-REMOTE-MANAGEMENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:20:57 2025
...
_Ieee8021TsnRemoteMgmtMsrpMrpExternalControl_Type.__name__ = "TruthValue"
...
class _Ieee8021TsnRemoteMgmtMrpAdminRequestList_Type(OctetString):
    """Custom type ieee8021TsnRemoteMgmtMrpAdminRequestList based on OctetString"""
    defaultValue = OctetString("")


_Ieee8021TsnRemoteMgmtMrpAdminRequestList_Type.__name__ = "OctetString"
...
_Ieee8021TsnRemoteMgmtMrpAdminRequestListLength_Type.__name__ = "Unsigned32"
...
ieee8021TsnRemoteMgmtCompliance.setObjects(
      *(("IEEE8021-TSN-REMOTE-MANAGEMENT-MIB", "ieee8021TsnRemoteMgmtBridgeDelayGroup"),
        ("IEEE8021-TSN-REMOTE-MANAGEMENT-MIB", "ieee8021TsnRemoteMgmtPropagationDelayGroup"),
        ("IEEE8021-TSN-REMOTE-MANAGEMENT-MIB", "ieee8021TsnRemoteMgmtStaticTreesGroup"),
        ("IEEE8021-TSN-REMOTE-MANAGEMENT-MIB", "ieee8021TsnRemoteMgmtMrpExternalControlGroup"))
)
if mibBuilder.loadTexts:
