...
if mibBuilder.loadTexts:cyACS5KInfo.setRevisions(('2010-07-26 00:00',))
_CyInfoSerialTable_Object=MibTable
cyInfoSerialTable=_CyInfoSerialTable_Object((1,3,6,1,4,1,2925,8,3,1))
if mibBuilder.loadTexts:cyInfoSerialTable.setStatus(_A)
_CyisPortEntry_Object=MibTableRow
cyisPortEntry=_CyisPortEntry_Object((1,3,6,1,4,1,2925,8,3,1,1))
...
cyISPortNumber=_CyISPortNumber_Object((1,3,6,1,4,1,2925,8,3,1,1,1),_CyISPortNumber_Type())
...
cyISPortTty=_CyISPortTty_Object((1,3,6,1,4,1,2925,8,3,1,1,2),_CyISPortTty_Type())
...
cyISPortName=_CyISPortName_Object((1,3,6,1,4,1,2925,8,3,1,1,3),_CyISPortName_Type())
...
cyISPortSpeed=_CyISPortSpeed_Object((1,3,6,1,4,1,2925,8,3,1,1,4),_CyISPortSpeed_Type())
...
cyISPortTxBytes=_CyISPortTxBytes_Object((1,3,6,1,4,1,2925,8,3,1,1,5),_CyISPortTxBytes_Type())
...
cyISPortRXBytes=_CyISPortRXBytes_Object((1,3,6,1,4,1,2925,8,3,1,1,6),_CyISPortRXBytes_Type())
...
cyISPortErrFrame=_CyISPortErrFrame_Object((1,3,6,1,4,1,2925,8,3,1,1,7),_CyISPortErrFrame_Type())
...
cyISPortErrParity=_CyISPortErrParity_Object((1,3,6,1,4,1,2925,8,3,1,1,8),_CyISPortErrParity_Type())
...
cyISPortErrBreaks=_CyISPortErrBreaks_Object((1,3,6,1,4,1,2925,8,3,1,1,9),_CyISPortErrBreaks_Type())
...
cyISPortErrOverrun=_CyISPortErrOverrun_Object((1,3,6,1,4,1,2925,8,3,1,1,10),_CyISPortErrOverrun_Type())
...
cyISPortSigDTR=_CyISPortSigDTR_Object((1,3,6,1,4,1,2925,8,3,1,1,11),_CyISPortSigDTR_Type())
...
cyISPortSigCD=_CyISPortSigCD_Object((1,3,6,1,4,1,2925,8,3,1,1,12),_CyISPortSigCD_Type())
...
cyISPortSigDSR=_CyISPortSigDSR_Object((1,3,6,1,4,1,2925,8,3,1,1,13),_CyISPortSigDSR_Type())
...
cyISPortSigRTS=_CyISPortSigRTS_Object((1,3,6,1,4,1,2925,8,3,1,1,14),_CyISPortSigRTS_Type())
...
cyISPortSigCTS=_CyISPortSigCTS_Object((1,3,6,1,4,1,2925,8,3,1,1,15),_CyISPortSigCTS_Type())
