...
mibBuilder.exportSymbols("HPN-ICF-LswARP-MIB", hpnicfLswProxyArpStatus=hpnicfLswProxyArpStatus, hpnicfLswArpMib=hpnicfLswArpMib, hpnicfLswProxyArpEnableTable=hpnicfLswProxyArpEnableTable, hpnicfLswProxyArpEnableEntry=hpnicfLswProxyArpEnableEntry, hpnicfLswProxyArpObject=hpnicfLswProxyArpObject, hpnicfLswIfIndex=hpnicfLswIfIndex, PYSNMP_MODULE_ID=hpnicfLswArpMib)
