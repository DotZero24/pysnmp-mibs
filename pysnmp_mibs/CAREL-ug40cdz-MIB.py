...
mibBuilder.exportSymbols("CAREL-ug40cdz-MIB", analogObjects=analogObjects, hotGasCoil=hotGasCoil, resetStC2=resetStC2, alarmHUHC=alarmHUHC, resetHrH2=resetHrH2, delTempLimit=delTempLimit, coolSetP=coolSetP, alarmHP2=alarmHP2, regExcTime=regExcTime, cwTemp=cwTemp, resetHrC1=resetHrC1, lhAlarmThrsh=lhAlarmThrsh, compr1WorkH=compr1WorkH, compr4WorkH=compr4WorkH, alarmHP1=alarmHP1, baudRate=baudRate, heating1=heating1, sleepmode=sleepmode, alarmCWDHT=alarmCWDHT, alarmC4Hours=alarmC4Hours, roomTemp=roomTemp, heat2SetP=heat2SetP, compr3WorkH=compr3WorkH, smHumidSetp=smHumidSetp, netSize=netSize, dehumidification=dehumidification, compressore2=compressore2, smCoolSetp=smCoolSetp, resetHrsFilt=resetHrsFilt, alarm2ndLevel=alarm2ndLevel, alarmRoomHH=alarmRoomHH, unitNoAnswerCounterGroup=unitNoAnswerCounterGroup, unitSoftwareReleaseGroup=unitSoftwareReleaseGroup, systm=systm, evapPress1=evapPress1, alarmC=alarmC, unit1_ErrorChecksumCounter=unit1_ErrorChecksumCounter, evapPress2=evapPress2, integerObjects=integerObjects, stdbyTime=stdbyTime, unitTimeoutCounterGroup=unitTimeoutCounterGroup, alarmRHS=alarmRHS, alarmDTS=alarmDTS, thrsLT=thrsLT, PYSNMP_MODULE_ID=ug40cdzMIB, alarmAirFlow=alarmAirFlow, systemOn=systemOn, resetStH2=resetStH2, compr2WorkH=compr2WorkH, cool2SetP=cool2SetP, alarmHeater=alarmHeater, alarmCWS=alarmCWS, resetHrH1=resetHrH1, heatDiff=heatDiff, unit1_NoAnswerCounter=unit1_NoAnswerCounter, alarmLAN=alarmLAN, fanSpeed=fanSpeed, alarmC2Hours=alarmC2Hours, thrsHT=thrsHT, alarmUnitHours=alarmUnitHours, resetHrC2=resetHrC2, smDehumSetp=smDehumSetp, unitErrorChecksumCounterGroup=unitErrorChecksumCounterGroup, compressore3=compressore3, resetHrC3=resetHrC3, webGateInfo=webGateInfo, unitCodeGroup=unitCodeGroup, pwOnDelay=pwOnDelay, lanUnit=lanUnit, roomRH=roomRH, alarmRoomLH=alarmRoomLH, carel=carel, smHeatSetp=smHeatSetp, alarmA=alarmA, unit1_Type=unit1_Type, alarmFlood=alarmFlood, alarmFilterHours=alarmFilterHours, unit1_MaxSoftwareRelease=unit1_MaxSoftwareRelease, enablemeanT=enablemeanT, alarmLP2=alarmLP2, agentRelease=agentRelease, unit1_TimeoutCounter=unit1_TimeoutCounter, digitalObjects=digitalObjects, alarmC1Hours=alarmC1Hours, heating2=heating2, unitTypeGroup=unitTypeGroup, systemOnOff=systemOnOff, dehumSetp=dehumSetp, heatSetP=heatSetP, filterWorkH=filterWorkH, humidPband=humidPband, lowPdelay=lowPdelay, compressore4=compressore4, ssh1=ssh1, alarmHeat1Hours=alarmHeat1Hours, resetHrC4=resetHrC4, unit1_MinSoftwareRelease=unit1_MinSoftwareRelease, smCycleTime=smCycleTime, humiWorkH=humiWorkH, hhAlarmThrsh=hhAlarmThrsh, alarmCWF=alarmCWF, alarmSmokeFire=alarmSmokeFire, resetHrACU=resetHrACU, alarmC3Hours=alarmC3Hours, alarmCWFF=alarmCWFF, radcoolSpDX=radcoolSpDX, alarmFilter=alarmFilter, alarmHUWL=alarmHUWL, unit1_Code=unit1_Code, cwHtThrsh=cwHtThrsh, alarmCWHT=alarmCWHT, alarmPSE=alarmPSE, alarmB=alarmB, alarmHumHours=alarmHumHours, selSW=selSW, alarmHeat2Hours=alarmHeat2Hours, coolDiff=coolDiff, agentCode=agentCode, alarmDI6=alarmDI6, alarmLP1=alarmLP1, unitMaxSoftwareReleaseGroup=unitMaxSoftwareReleaseGroup, alarmRTS=alarmRTS, alarmRoomLT=alarmRoomLT, alarmAccess=alarmAccess, compressore1=compressore1, emerg=emerg, cwoTemp=cwoTemp, coolRamp=coolRamp, resetHrHU=resetHrHU, exv2steps=exv2steps, selDXCW=selDXCW, instruments=instruments, outdoorTemp=outdoorTemp, cwDehumSetp=cwDehumSetp, suctTemp1=suctTemp1, thAlarmdelay=thAlarmdelay, radcoolSpES=radcoolSpES, alarmHUPL=alarmHUPL, cwModeSetp=cwModeSetp, dehumPband=dehumPband, evapTemp2=evapTemp2, resetStC3=resetStC3, alarmHWS=alarmHWS, resetStHU=resetStHU, suctTemp2=suctTemp2, alarmEXV1=alarmEXV1, humidification=humidification, unitWorkH=unitWorkH, ug40cdzMIB=ug40cdzMIB, alarmHum=alarmHum, unit1_SoftwareRelease=unit1_SoftwareRelease, alarmEXV2=alarmEXV2, evapTemp1=evapTemp1, heat1WorkH=heat1WorkH, alarmRoomHT=alarmRoomHT, unitMinSoftwareReleaseGroup=unitMinSoftwareReleaseGroup, alarmOTS=alarmOTS, resetAlarm=resetAlarm, deliveryTemp=deliveryTemp, heatRamp=heatRamp, smtest=smtest, dtAutChgMLT=dtAutChgMLT, agentParameters=agentParameters, humidSetp=humidSetp, ssh2=ssh2, regulDelay=regulDelay, heat2WorkH=heat2WorkH, alarmRoomEAP=alarmRoomEAP, resetStC1=resetStC1, exv1steps=exv1steps, alarmDI4=alarmDI4, alarmDI2=alarmDI2, hwTemp=hwTemp, resetStH1=resetStH1, alarmGeneral=alarmGeneral, alarmCWOTS=alarmCWOTS, resetStC4=resetStC4)
