...
fsRmon2Trace=_FsRmon2Trace_Object((1,3,6,1,4,1,10876,101,2,19,1),_FsRmon2Trace_Type())
...
fsRmon2AdminStatus=_FsRmon2AdminStatus_Object((1,3,6,1,4,1,10876,101,2,19,2),_FsRmon2AdminStatus_Type())
fsRmon2AdminStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:fsRmon2AdminStatus.setStatus(_C)
mibBuilder.exportSymbols('SUPERMICRO-RMON2-MIB',**{'fsrmon2':fsrmon2,'fsRmon2Trace':fsRmon2Trace,'fsRmon2AdminStatus':fsRmon2AdminStatus})