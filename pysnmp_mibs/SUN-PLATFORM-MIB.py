...
entPhysicalIndex, entLogicalIndex, entPhysicalEntry, entLogicalEntry = mibBuilder.importSymbols("ENTITY-MIB", "entPhysicalIndex", "entLogicalIndex", "entPhysicalEntry", "entLogicalEntry")
...
TDomain, RowStatus, TAddress, DateAndTime, TextualConvention, VariablePointer, TestAndIncr, RowPointer, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TDomain", "RowStatus", "TAddress", "DateAndTime", "TextualConvention", "VariablePointer", "TestAndIncr", "RowPointer", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SUN-PLATFORM-MIB", sunPlatCircuitPackType=sunPlatCircuitPackType, sunPlatMIBTrapData=sunPlatMIBTrapData, sunPlatPowerSupplyClass=sunPlatPowerSupplyClass, sunPlatNotificationCorrelatedNotifications=sunPlatNotificationCorrelatedNotifications, sunPlatNotificationNewOID=sunPlatNotificationNewOID, sunPlatSensorLatency=sunPlatSensorLatency, PYSNMP_MODULE_ID=sunPlatMIB, sunPlatMIBLogicalObjects=sunPlatMIBLogicalObjects, sunPlatSensorEntry=sunPlatSensorEntry, sunPlatAlarmType=sunPlatAlarmType, sunPlatGeneralGroup=sunPlatGeneralGroup, sunPlatDiscreteSensorStatesAcceptable=sunPlatDiscreteSensorStatesAcceptable, sunPlatLogRecordAdditionalGroup=sunPlatLogRecordAdditionalGroup, sunPlatAlarmUrgency=sunPlatAlarmUrgency, sunPlatSensorClass=sunPlatSensorClass, sunPlatDiscreteSensorStatesInterpretation=sunPlatDiscreteSensorStatesInterpretation, sunPlatWatchdogEntry=sunPlatWatchdogEntry, sunPlatLogRecordAlarmSpecificProblem=sunPlatLogRecordAlarmSpecificProblem, sunPlatNumericSensorNormalMax=sunPlatNumericSensorNormalMax, sunPlatLogRecordChangeOldOID=sunPlatLogRecordChangeOldOID, sunPlatInitialLoadInfoEntry=sunPlatInitialLoadInfoEntry, sunPlatWatchdogTable=sunPlatWatchdogTable, sunFire=sunFire, sunPlatNumericSensorHysteresis=sunPlatNumericSensorHysteresis, sunPlatFanEntry=sunPlatFanEntry, sunPlatPhysicalTable=sunPlatPhysicalTable, sunPlatBatteryEntry=sunPlatBatteryEntry, sunPlatEquipmentHolderStatus=sunPlatEquipmentHolderStatus, SunPlatCircuitPackAvailabilityStatus=SunPlatCircuitPackAvailabilityStatus, sunPlatWatchdogTimeout=sunPlatWatchdogTimeout, SunPlatPercentage=SunPlatPercentage, SunPlatBaseUnits=SunPlatBaseUnits, sunPlatMIBLogs=sunPlatMIBLogs, sunPlatAttributeChangeOID=sunPlatAttributeChangeOID, sunPlatLogRecordChangeNewString=sunPlatLogRecordChangeNewString, sunPlatNumericSensorLowerThresholdCritical=sunPlatNumericSensorLowerThresholdCritical, sunPlatInitialLoadInfoDesiredValue=sunPlatInitialLoadInfoDesiredValue, sunPlatObjectDeletion=sunPlatObjectDeletion, sunPlatFanTable=sunPlatFanTable, sunPlatNotificationAdditionalText=sunPlatNotificationAdditionalText, sunPlatDiscreteSensorEntry=sunPlatDiscreteSensorEntry, sunPlatUnitaryComputerSystemApplySettings=sunPlatUnitaryComputerSystemApplySettings, sunPlatBatteryGroup=sunPlatBatteryGroup, sunPlatCircuitPackTable=sunPlatCircuitPackTable, sunPlatCircuitPackEntry=sunPlatCircuitPackEntry, sunPlatQualityOfServiceAlarm=sunPlatQualityOfServiceAlarm, SunPlatSensorClass=SunPlatSensorClass, sunPlatEquipmentHolderGroup=sunPlatEquipmentHolderGroup, sunPlatEquipmentUnknownStatus=sunPlatEquipmentUnknownStatus, sunPlatWatchdogLastExpired=sunPlatWatchdogLastExpired, sunPlatLogicalClass=sunPlatLogicalClass, sunPlatNotificationTime=sunPlatNotificationTime, sunPlatObjectCreation=sunPlatObjectCreation, sunPlatLogCapacityThreshold=sunPlatLogCapacityThreshold, SunPlatProbableCause=SunPlatProbableCause, SunPlatUnitaryComputerSystemPowerState=SunPlatUnitaryComputerSystemPowerState, sunPlatNumericSensorNormalMin=sunPlatNumericSensorNormalMin, sunPlatLogRecordEntry=sunPlatLogRecordEntry, sunPlatLogicalGroup=sunPlatLogicalGroup, sunPlatEquipmentAdministrativeState=sunPlatEquipmentAdministrativeState, SunPlatSensorType=SunPlatSensorType, sunPlatLogRecordId=sunPlatLogRecordId, sunPlatSensorGroup=sunPlatSensorGroup, sunPlatBinarySensorCurrent=sunPlatBinarySensorCurrent, SunPlatWatchdogMonitoredEntity=SunPlatWatchdogMonitoredEntity, SunPlatEquipmentHolderPower=SunPlatEquipmentHolderPower, sunPlatEquipmentOperationalState=sunPlatEquipmentOperationalState, sunPlatEquipmentAlarmStatus=sunPlatEquipmentAlarmStatus, sunPlatEquipmentEntry=sunPlatEquipmentEntry, sunPlatLogTable=sunPlatLogTable, sunPlatLogRowStatus=sunPlatLogRowStatus, sunPlatMIBTraps=sunPlatMIBTraps, sunPlatNumericSensorAccuracy=sunPlatNumericSensorAccuracy, sunPlatLogEntry=sunPlatLogEntry, sunPlatNotificationNewString=sunPlatNotificationNewString, sunPlatNotificationOldString=sunPlatNotificationOldString, sunPlatNumericSensorGroup=sunPlatNumericSensorGroup, sunPlatNotificationOldOID=sunPlatNotificationOldOID, sunPlatProcessingErrorAlarm=sunPlatProcessingErrorAlarm, sunPlatLogGroup=sunPlatLogGroup, sunPlatEquipmentHolderType=sunPlatEquipmentHolderType, sunPlatEquipmentHolderPowered=sunPlatEquipmentHolderPowered, sunPlatLogRecordAdditionalText=sunPlatLogRecordAdditionalText, sunPlatPowerSupplyGroup=sunPlatPowerSupplyGroup, sunPlatMIBObjects=sunPlatMIBObjects, sunPlatNotificationsGroup=sunPlatNotificationsGroup, sunPlatBinarySensorInterpretFalse=sunPlatBinarySensorInterpretFalse, sunPlatLogRecordChangeNewInteger=sunPlatLogRecordChangeNewInteger, SunPlatNumericSensorThresholdResetAction=SunPlatNumericSensorThresholdResetAction, sunPlatDiscreteSensorGroup=sunPlatDiscreteSensorGroup, sunPlatLogRecordAdditionalTable=sunPlatLogRecordAdditionalTable, sunPlatInitialLoadInfoCurrentValue=sunPlatInitialLoadInfoCurrentValue, sun=sun, sunPlatNotificationObject=sunPlatNotificationObject, sunPlatEquipmentAlarm=sunPlatEquipmentAlarm, sunPlatEquipmentHolderEntry=sunPlatEquipmentHolderEntry, sunPlatDiscreteSensorStatesIndex=sunPlatDiscreteSensorStatesIndex, sunPlatStateChange=sunPlatStateChange, sunPlatUnitaryComputerSystemEntry=sunPlatUnitaryComputerSystemEntry, sunPlatDiscreteSensorTable=sunPlatDiscreteSensorTable, sunPlatBatteryStatus=sunPlatBatteryStatus, SunPlatAlarmType=SunPlatAlarmType, sunPlatNotificationEventId=sunPlatNotificationEventId, SunPlatPowerSupplyClass=SunPlatPowerSupplyClass, sunPlatLogRecordAlarmEntry=sunPlatLogRecordAlarmEntry, sunPlatEquipmentLocationName=sunPlatEquipmentLocationName, sunPlatCommunicationsAlarm=sunPlatCommunicationsAlarm, sunPlatNumericSensorUpperThresholdNonCritical=sunPlatNumericSensorUpperThresholdNonCritical, products=products, SunPlatAdministrativeState=SunPlatAdministrativeState, sunPlatLogRecordAlarmRepairAction=sunPlatLogRecordAlarmRepairAction, sunPlatUnitaryComputerSystemPowerState=sunPlatUnitaryComputerSystemPowerState, SunPlatLogicalClass=SunPlatLogicalClass, sunPlatLogRecordAdditionalEntry=sunPlatLogRecordAdditionalEntry, sunPlatLogOperationalState=sunPlatLogOperationalState, sunPlatBinarySensorGroup=sunPlatBinarySensorGroup, sunPlatMIBGroups=sunPlatMIBGroups, sunPlatUnitaryComputerSystemGroup=sunPlatUnitaryComputerSystemGroup, sunPlatLogicalTable=sunPlatLogicalTable, SunPlatOperationalState=SunPlatOperationalState, sunPlatNumericSensorEnabledThresholds=sunPlatNumericSensorEnabledThresholds, sunPlatNotificationProbableCause=sunPlatNotificationProbableCause, sunPlatMIBPhysicalObjects=sunPlatMIBPhysicalObjects, sunPlatLogRecordAdditionalInfo=sunPlatLogRecordAdditionalInfo, sunPlatEquipmentHolderTable=sunPlatEquipmentHolderTable, SunPlatEquipmentHolderType=SunPlatEquipmentHolderType, sunPlatLogRecordAlarmPerceivedSeverity=sunPlatLogRecordAlarmPerceivedSeverity, sunPlatNotificationOldInteger=sunPlatNotificationOldInteger, SunPlatLogicalStatus=SunPlatLogicalStatus, SunPlatNumericSensorEnabledThresholds=SunPlatNumericSensorEnabledThresholds, sunPlatNumericSensorUpperThresholdFatal=sunPlatNumericSensorUpperThresholdFatal, sunPlatAlarmState=sunPlatAlarmState, sunPlatNotificationRepairAction=sunPlatNotificationRepairAction, SunPlatLogAdministrativeState=SunPlatLogAdministrativeState, sunPlatStartTime=sunPlatStartTime, sunPlatNumericSensorRateUnits=sunPlatNumericSensorRateUnits, sunPlatCircuitPackHotSwappable=sunPlatCircuitPackHotSwappable, sunPlatEnvironmentalAlarm=sunPlatEnvironmentalAlarm, SunPlatRateUnits=SunPlatRateUnits, sunPlatInitialLoadInfoIndex=sunPlatInitialLoadInfoIndex, sunPlatLogRecordChangeOldInteger=sunPlatLogRecordChangeOldInteger, sunPlatEquipmentHolderAcceptableTypes=sunPlatEquipmentHolderAcceptableTypes, sunPlatAttributeChangeString=sunPlatAttributeChangeString, sunPlatAttributeChangeInteger=sunPlatAttributeChangeInteger, sunPlatLogRecordGroup=sunPlatLogRecordGroup, sunPlatPhysicalGroup=sunPlatPhysicalGroup, sunPlatNumericSensorEntry=sunPlatNumericSensorEntry, sunPlatAlarmEntry=sunPlatAlarmEntry, sunPlatLogicalEntry=sunPlatLogicalEntry, sunPlatNumericSensorCurrent=sunPlatNumericSensorCurrent, sunPlatLogRecordRowStatus=sunPlatLogRecordRowStatus, sunPlatCircuitPackReplaceable=sunPlatCircuitPackReplaceable, sunPlatMIBObjectGroups=sunPlatMIBObjectGroups, sunPlatLogRecordTable=sunPlatLogRecordTable, sunPlatLogRecordAlarmProbableCause=sunPlatLogRecordAlarmProbableCause, sunPlatEquipmentTable=sunPlatEquipmentTable, sunPlatLogRecordChangeChangedOID=sunPlatLogRecordChangeChangedOID, sunPlatNumericSensorTable=sunPlatNumericSensorTable, sunPlatIndeterminateAlarm=sunPlatIndeterminateAlarm, sunPlatLogicalStatus=sunPlatLogicalStatus, sunPlatDiscreteSensorCurrent=sunPlatDiscreteSensorCurrent, sunPlatPowerSupplyTable=sunPlatPowerSupplyTable, sunPlatCircuitPackGroup=sunPlatCircuitPackGroup, sunPlatDiscreteSensorStatesTable=sunPlatDiscreteSensorStatesTable, SunPlatAlarmPerceivedSeverity=SunPlatAlarmPerceivedSeverity, SunPlatAlarmStatus=SunPlatAlarmStatus, sunPlatNumericSensorLowerThresholdNonCritical=sunPlatNumericSensorLowerThresholdNonCritical, sunPlatBatteryTable=sunPlatBatteryTable, sunPlatNumericSensorBaseUnits=sunPlatNumericSensorBaseUnits, sunPlatInitialLoadInfoDescr=sunPlatInitialLoadInfoDescr, sunPlatCircuitPackAvailabilityStatus=sunPlatCircuitPackAvailabilityStatus, sunPlatWatchdogGroup=sunPlatWatchdogGroup, sunPlatNumericSensorLowerThresholdFatal=sunPlatNumericSensorLowerThresholdFatal, sunPlatLogFullStatus=sunPlatLogFullStatus, sunPlatMIB=sunPlatMIB, SunPlatBatteryStatus=SunPlatBatteryStatus, sunPlatPhysicalEntry=sunPlatPhysicalEntry, sunPlatNotificationPerceivedSeverity=sunPlatNotificationPerceivedSeverity, SunPlatIndex=SunPlatIndex, SunPlatAlarmState=SunPlatAlarmState, SunPlatAlarmUrgency=SunPlatAlarmUrgency, SunPlatWatchdogAction=SunPlatWatchdogAction, sunPlatMIBConformances=sunPlatMIBConformances, sunPlatBinarySensorInterpretTrue=sunPlatBinarySensorInterpretTrue, sunPlatNumericSensorRestoreDefaultThresholds=sunPlatNumericSensorRestoreDefaultThresholds, sunPlatFanClass=sunPlatFanClass, sunPlatWatchdogMonitoredEntity=sunPlatWatchdogMonitoredEntity, sunPlatMIBCompliances=sunPlatMIBCompliances, sunPlatAlarmTable=sunPlatAlarmTable, SunPlatFanClass=SunPlatFanClass, sunPlatLogRecordChangeNewOID=sunPlatLogRecordChangeNewOID, sunPlatMIBTrapPrefix=sunPlatMIBTrapPrefix, sunPlatBinarySensorExpected=sunPlatBinarySensorExpected, SunPlatEquipmentHolderStatus=SunPlatEquipmentHolderStatus, sunPlatSensorTable=sunPlatSensorTable, sunPlatLogRecordLoggingTime=sunPlatLogRecordLoggingTime, sunPlatLogRecordAlarmGroup=sunPlatLogRecordAlarmGroup, sunPlatBinarySensorEntry=sunPlatBinarySensorEntry, sunPlatBinarySensorTable=sunPlatBinarySensorTable, sunPlatPhysicalClass=sunPlatPhysicalClass, sunPlatLogType=sunPlatLogType, sunPlatNotificationChangedOID=sunPlatNotificationChangedOID, sunPlatFanGroup=sunPlatFanGroup, sunPlatPowerSupplyEntry=sunPlatPowerSupplyEntry, sunPlatEquipmentGroup=sunPlatEquipmentGroup, sunPlatLogRecordCorrelatedNotifications=sunPlatLogRecordCorrelatedNotifications, SunPlatPhysicalClass=SunPlatPhysicalClass, sunPlatAlarmGroup=sunPlatAlarmGroup, sunPlatLogRecordChangeGroup=sunPlatLogRecordChangeGroup, sunPlatCompliance=sunPlatCompliance, sunPlatInitialLoadInfoTable=sunPlatInitialLoadInfoTable, sunPlatNotificationAdditionalInfo=sunPlatNotificationAdditionalInfo, sunPlatLogRecordChangeTable=sunPlatLogRecordChangeTable, sunPlatNumericSensorUpperThresholdCritical=sunPlatNumericSensorUpperThresholdCritical, SunPlatUnitaryComputerSystemApplicableSetting=SunPlatUnitaryComputerSystemApplicableSetting, sunPlatDiscreteSensorStatesEntry=sunPlatDiscreteSensorStatesEntry, sunPlatUnitaryComputerSystemTable=sunPlatUnitaryComputerSystemTable, sunPlatWatchdogAction=sunPlatWatchdogAction, sunPlatLogRecordManagedObjectInstance=sunPlatLogRecordManagedObjectInstance, sunPlatNotificationSpecificProblem=sunPlatNotificationSpecificProblem, sunPlatLogRecordAlarmTable=sunPlatLogRecordAlarmTable, sunPlatMIBNotifGroups=sunPlatMIBNotifGroups, sunPlatSensorType=sunPlatSensorType, sunPlatNumericSensorExponent=sunPlatNumericSensorExponent, sunPlatLogAdministrativeState=sunPlatLogAdministrativeState, sunPlatLogRecordChangeOldString=sunPlatLogRecordChangeOldString, sunPlatNotificationNewInteger=sunPlatNotificationNewInteger, sunPlatNotificationObjectGroup=sunPlatNotificationObjectGroup, sunPlatLogRecordChangeEntry=sunPlatLogRecordChangeEntry)
