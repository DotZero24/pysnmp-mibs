...
# Notes
# -----
# ASN.1 source file://mibs/oracle/SUN-PLATFORM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:07:30 2025
...
_SunPlatEquipmentUnknownStatus_Type.__name__ = "TruthValue"
...
_SunPlatLogAdministrativeState_Type.__name__ = "SunPlatLogAdministrativeState"
...
sunPlatCompliance.setObjects(
      *(("SUN-PLATFORM-MIB", "sunPlatGeneralGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatEquipmentGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatEquipmentHolderGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatCircuitPackGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatPhysicalGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatSensorGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatBinarySensorGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatNumericSensorGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatDiscreteSensorGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatFanGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatAlarmGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatWatchdogGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatPowerSupplyGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatBatteryGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatLogicalGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatUnitaryComputerSystemGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatLogGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatLogRecordGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatLogRecordAdditionalGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatLogRecordAlarmGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatNotificationsGroup"),
        ("SUN-PLATFORM-MIB", "sunPlatLogRecordChangeGroup"))
)
if mibBuilder.loadTexts:
