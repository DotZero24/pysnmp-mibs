...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/oracle/SUN-PLATFORM-MIB
...
entLogicalIndex, entPhysicalIndex, entLogicalEntry, entPhysicalEntry = mibBuilder.importSymbols("ENTITY-MIB", "entLogicalIndex", "entPhysicalIndex", "entLogicalEntry", "entPhysicalEntry")
...
DisplayString, VariablePointer, TDomain, TruthValue, RowStatus, TAddress, TestAndIncr, DateAndTime, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "VariablePointer", "TDomain", "TruthValue", "RowStatus", "TAddress", "TestAndIncr", "DateAndTime", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SUN-PLATFORM-MIB", sunPlatCircuitPackHotSwappable=sunPlatCircuitPackHotSwappable, sunPlatNumericSensorRateUnits=sunPlatNumericSensorRateUnits, sunPlatNumericSensorUpperThresholdNonCritical=sunPlatNumericSensorUpperThresholdNonCritical, sunPlatDiscreteSensorStatesTable=sunPlatDiscreteSensorStatesTable, SunPlatIndex=SunPlatIndex, sunPlatLogRecordLoggingTime=sunPlatLogRecordLoggingTime, sunPlatNotificationAdditionalText=sunPlatNotificationAdditionalText, sunPlatIndeterminateAlarm=sunPlatIndeterminateAlarm, sunPlatEquipmentHolderType=sunPlatEquipmentHolderType, SunPlatFanClass=SunPlatFanClass, sunPlatEquipmentEntry=sunPlatEquipmentEntry, sunPlatEquipmentHolderEntry=sunPlatEquipmentHolderEntry, sunPlatLogRecordAdditionalTable=sunPlatLogRecordAdditionalTable, sunPlatLogRecordAlarmProbableCause=sunPlatLogRecordAlarmProbableCause, sunPlatLogRecordRowStatus=sunPlatLogRecordRowStatus, sunPlatStateChange=sunPlatStateChange, sunPlatAttributeChangeOID=sunPlatAttributeChangeOID, sunPlatBatteryStatus=sunPlatBatteryStatus, sunPlatLogTable=sunPlatLogTable, sunPlatMIBLogs=sunPlatMIBLogs, sunPlatDiscreteSensorStatesEntry=sunPlatDiscreteSensorStatesEntry, SunPlatPercentage=SunPlatPercentage, SunPlatOperationalState=SunPlatOperationalState, sunPlatBinarySensorEntry=sunPlatBinarySensorEntry, sunPlatNotificationProbableCause=sunPlatNotificationProbableCause, sunPlatLogOperationalState=sunPlatLogOperationalState, sunPlatNumericSensorExponent=sunPlatNumericSensorExponent, sunPlatNumericSensorGroup=sunPlatNumericSensorGroup, sunPlatEquipmentAlarm=sunPlatEquipmentAlarm, sunPlatMIBTrapData=sunPlatMIBTrapData, sunPlatFanEntry=sunPlatFanEntry, sunPlatInitialLoadInfoTable=sunPlatInitialLoadInfoTable, sunPlatCircuitPackType=sunPlatCircuitPackType, sunPlatLogRecordAlarmEntry=sunPlatLogRecordAlarmEntry, sunPlatSensorTable=sunPlatSensorTable, sunPlatMIBGroups=sunPlatMIBGroups, sunPlatUnitaryComputerSystemEntry=sunPlatUnitaryComputerSystemEntry, sunPlatLogRecordChangeOldInteger=sunPlatLogRecordChangeOldInteger, sunPlatBinarySensorTable=sunPlatBinarySensorTable, sunPlatNumericSensorUpperThresholdCritical=sunPlatNumericSensorUpperThresholdCritical, sunPlatLogRecordAlarmPerceivedSeverity=sunPlatLogRecordAlarmPerceivedSeverity, sunPlatCircuitPackGroup=sunPlatCircuitPackGroup, sunPlatAlarmEntry=sunPlatAlarmEntry, sunPlatNotificationNewInteger=sunPlatNotificationNewInteger, sunPlatCircuitPackTable=sunPlatCircuitPackTable, sunPlatPowerSupplyGroup=sunPlatPowerSupplyGroup, sunPlatLogCapacityThreshold=sunPlatLogCapacityThreshold, sunPlatMIBConformances=sunPlatMIBConformances, sunPlatUnitaryComputerSystemApplySettings=sunPlatUnitaryComputerSystemApplySettings, sunPlatLogRecordId=sunPlatLogRecordId, sunPlatLogRecordChangeNewString=sunPlatLogRecordChangeNewString, SunPlatSensorType=SunPlatSensorType, sunPlatFanTable=sunPlatFanTable, sunPlatLogRecordAlarmRepairAction=sunPlatLogRecordAlarmRepairAction, SunPlatAlarmType=SunPlatAlarmType, sunPlatMIBTrapPrefix=sunPlatMIBTrapPrefix, SunPlatNumericSensorEnabledThresholds=SunPlatNumericSensorEnabledThresholds, sunPlatNotificationNewString=sunPlatNotificationNewString, sunPlatGeneralGroup=sunPlatGeneralGroup, SunPlatNumericSensorThresholdResetAction=SunPlatNumericSensorThresholdResetAction, sunPlatLogRecordAlarmTable=sunPlatLogRecordAlarmTable, sunPlatNotificationPerceivedSeverity=sunPlatNotificationPerceivedSeverity, sunPlatQualityOfServiceAlarm=sunPlatQualityOfServiceAlarm, sunPlatLogGroup=sunPlatLogGroup, sunPlatNumericSensorEnabledThresholds=sunPlatNumericSensorEnabledThresholds, sunPlatNumericSensorAccuracy=sunPlatNumericSensorAccuracy, sunPlatAttributeChangeInteger=sunPlatAttributeChangeInteger, sunPlatObjectCreation=sunPlatObjectCreation, sunPlatMIBObjects=sunPlatMIBObjects, sunPlatEquipmentGroup=sunPlatEquipmentGroup, sunPlatLogRowStatus=sunPlatLogRowStatus, sunPlatNumericSensorUpperThresholdFatal=sunPlatNumericSensorUpperThresholdFatal, sunPlatEquipmentLocationName=sunPlatEquipmentLocationName, SunPlatWatchdogAction=SunPlatWatchdogAction, sunPlatEquipmentHolderGroup=sunPlatEquipmentHolderGroup, sunPlatNumericSensorNormalMin=sunPlatNumericSensorNormalMin, sunPlatAttributeChangeString=sunPlatAttributeChangeString, sunPlatBinarySensorExpected=sunPlatBinarySensorExpected, sunPlatNotificationAdditionalInfo=sunPlatNotificationAdditionalInfo, sunPlatEquipmentAdministrativeState=sunPlatEquipmentAdministrativeState, sunPlatAlarmState=sunPlatAlarmState, sunPlatWatchdogAction=sunPlatWatchdogAction, sunPlatObjectDeletion=sunPlatObjectDeletion, sunPlatDiscreteSensorGroup=sunPlatDiscreteSensorGroup, SunPlatPowerSupplyClass=SunPlatPowerSupplyClass, sunPlatCompliance=sunPlatCompliance, sunPlatInitialLoadInfoIndex=sunPlatInitialLoadInfoIndex, sunPlatLogRecordChangeGroup=sunPlatLogRecordChangeGroup, SunPlatLogicalClass=SunPlatLogicalClass, SunPlatUnitaryComputerSystemApplicableSetting=SunPlatUnitaryComputerSystemApplicableSetting, sunPlatSensorEntry=sunPlatSensorEntry, sunPlatNotificationRepairAction=sunPlatNotificationRepairAction, sunPlatDiscreteSensorTable=sunPlatDiscreteSensorTable, sunPlatMIBObjectGroups=sunPlatMIBObjectGroups, SunPlatAlarmState=SunPlatAlarmState, sunPlatInitialLoadInfoCurrentValue=sunPlatInitialLoadInfoCurrentValue, sunPlatSensorClass=sunPlatSensorClass, sunPlatDiscreteSensorStatesIndex=sunPlatDiscreteSensorStatesIndex, sunPlatLogicalClass=sunPlatLogicalClass, sunPlatLogRecordAdditionalEntry=sunPlatLogRecordAdditionalEntry, sunPlatInitialLoadInfoDescr=sunPlatInitialLoadInfoDescr, SunPlatEquipmentHolderStatus=SunPlatEquipmentHolderStatus, sunPlatNumericSensorBaseUnits=sunPlatNumericSensorBaseUnits, sunPlatNumericSensorCurrent=sunPlatNumericSensorCurrent, sunPlatPowerSupplyEntry=sunPlatPowerSupplyEntry, sunPlatNotificationOldOID=sunPlatNotificationOldOID, sunPlatNotificationObjectGroup=sunPlatNotificationObjectGroup, sunPlatNotificationCorrelatedNotifications=sunPlatNotificationCorrelatedNotifications, sunPlatLogRecordChangeOldString=sunPlatLogRecordChangeOldString, PYSNMP_MODULE_ID=sunPlatMIB, sunPlatCircuitPackReplaceable=sunPlatCircuitPackReplaceable, sunPlatPowerSupplyTable=sunPlatPowerSupplyTable, sunPlatNumericSensorLowerThresholdCritical=sunPlatNumericSensorLowerThresholdCritical, sunPlatPhysicalTable=sunPlatPhysicalTable, sunPlatMIBTraps=sunPlatMIBTraps, sunPlatDiscreteSensorStatesAcceptable=sunPlatDiscreteSensorStatesAcceptable, sunPlatWatchdogEntry=sunPlatWatchdogEntry, sunPlatLogRecordTable=sunPlatLogRecordTable, sunPlatWatchdogTimeout=sunPlatWatchdogTimeout, sunPlatMIBNotifGroups=sunPlatMIBNotifGroups, SunPlatUnitaryComputerSystemPowerState=SunPlatUnitaryComputerSystemPowerState, sunPlatBinarySensorInterpretFalse=sunPlatBinarySensorInterpretFalse, sunPlatUnitaryComputerSystemGroup=sunPlatUnitaryComputerSystemGroup, sunPlatLogRecordAlarmSpecificProblem=sunPlatLogRecordAlarmSpecificProblem, sunPlatEquipmentHolderTable=sunPlatEquipmentHolderTable, sunPlatEquipmentAlarmStatus=sunPlatEquipmentAlarmStatus, sunPlatSensorLatency=sunPlatSensorLatency, sunPlatPhysicalEntry=sunPlatPhysicalEntry, sunPlatBinarySensorInterpretTrue=sunPlatBinarySensorInterpretTrue, SunPlatSensorClass=SunPlatSensorClass, sunPlatPowerSupplyClass=sunPlatPowerSupplyClass, sunPlatLogRecordAdditionalInfo=sunPlatLogRecordAdditionalInfo, SunPlatAdministrativeState=SunPlatAdministrativeState, sunPlatLogRecordEntry=sunPlatLogRecordEntry, sunPlatLogRecordChangeNewInteger=sunPlatLogRecordChangeNewInteger, sunPlatNotificationObject=sunPlatNotificationObject, sunPlatInitialLoadInfoDesiredValue=sunPlatInitialLoadInfoDesiredValue, sunPlatLogRecordManagedObjectInstance=sunPlatLogRecordManagedObjectInstance, sun=sun, sunPlatLogType=sunPlatLogType, sunPlatPhysicalClass=sunPlatPhysicalClass, sunPlatMIBPhysicalObjects=sunPlatMIBPhysicalObjects, sunPlatLogEntry=sunPlatLogEntry, sunPlatNotificationEventId=sunPlatNotificationEventId, SunPlatRateUnits=SunPlatRateUnits, SunPlatWatchdogMonitoredEntity=SunPlatWatchdogMonitoredEntity, sunPlatAlarmGroup=sunPlatAlarmGroup, sunPlatBatteryTable=sunPlatBatteryTable, sunPlatLogRecordChangeChangedOID=sunPlatLogRecordChangeChangedOID, sunPlatUnitaryComputerSystemTable=sunPlatUnitaryComputerSystemTable, sunPlatLogFullStatus=sunPlatLogFullStatus, sunPlatSensorGroup=sunPlatSensorGroup, sunPlatBatteryGroup=sunPlatBatteryGroup, sunPlatWatchdogMonitoredEntity=sunPlatWatchdogMonitoredEntity, sunPlatMIBCompliances=sunPlatMIBCompliances, sunPlatCommunicationsAlarm=sunPlatCommunicationsAlarm, sunPlatLogicalEntry=sunPlatLogicalEntry, sunPlatLogRecordAdditionalGroup=sunPlatLogRecordAdditionalGroup, sunPlatNotificationOldString=sunPlatNotificationOldString, sunPlatNotificationsGroup=sunPlatNotificationsGroup, sunPlatLogicalGroup=sunPlatLogicalGroup, SunPlatEquipmentHolderType=SunPlatEquipmentHolderType, sunPlatInitialLoadInfoEntry=sunPlatInitialLoadInfoEntry, sunPlatLogRecordChangeEntry=sunPlatLogRecordChangeEntry, sunPlatNumericSensorTable=sunPlatNumericSensorTable, sunPlatLogRecordGroup=sunPlatLogRecordGroup, sunPlatFanClass=sunPlatFanClass, sunPlatNumericSensorLowerThresholdNonCritical=sunPlatNumericSensorLowerThresholdNonCritical, SunPlatCircuitPackAvailabilityStatus=SunPlatCircuitPackAvailabilityStatus, SunPlatLogAdministrativeState=SunPlatLogAdministrativeState, sunPlatEnvironmentalAlarm=sunPlatEnvironmentalAlarm, sunPlatNotificationOldInteger=sunPlatNotificationOldInteger, sunPlatLogRecordAdditionalText=sunPlatLogRecordAdditionalText, sunPlatCircuitPackEntry=sunPlatCircuitPackEntry, sunPlatNumericSensorLowerThresholdFatal=sunPlatNumericSensorLowerThresholdFatal, sunPlatEquipmentHolderPowered=sunPlatEquipmentHolderPowered, sunPlatNumericSensorNormalMax=sunPlatNumericSensorNormalMax, sunPlatDiscreteSensorEntry=sunPlatDiscreteSensorEntry, sunPlatFanGroup=sunPlatFanGroup, sunPlatLogRecordChangeTable=sunPlatLogRecordChangeTable, sunPlatBatteryEntry=sunPlatBatteryEntry, sunPlatMIBLogicalObjects=sunPlatMIBLogicalObjects, sunFire=sunFire, SunPlatLogicalStatus=SunPlatLogicalStatus, sunPlatSensorType=sunPlatSensorType, SunPlatAlarmUrgency=SunPlatAlarmUrgency, SunPlatPhysicalClass=SunPlatPhysicalClass, SunPlatAlarmPerceivedSeverity=SunPlatAlarmPerceivedSeverity, sunPlatWatchdogGroup=sunPlatWatchdogGroup, sunPlatStartTime=sunPlatStartTime, sunPlatLogAdministrativeState=sunPlatLogAdministrativeState, sunPlatEquipmentHolderStatus=sunPlatEquipmentHolderStatus, sunPlatNotificationNewOID=sunPlatNotificationNewOID, SunPlatBaseUnits=SunPlatBaseUnits, sunPlatBinarySensorCurrent=sunPlatBinarySensorCurrent, sunPlatMIB=sunPlatMIB, sunPlatLogicalStatus=sunPlatLogicalStatus, sunPlatCircuitPackAvailabilityStatus=sunPlatCircuitPackAvailabilityStatus, SunPlatBatteryStatus=SunPlatBatteryStatus, sunPlatDiscreteSensorStatesInterpretation=sunPlatDiscreteSensorStatesInterpretation, sunPlatAlarmType=sunPlatAlarmType, sunPlatNumericSensorHysteresis=sunPlatNumericSensorHysteresis, SunPlatProbableCause=SunPlatProbableCause, sunPlatDiscreteSensorCurrent=sunPlatDiscreteSensorCurrent, sunPlatAlarmTable=sunPlatAlarmTable, sunPlatEquipmentOperationalState=sunPlatEquipmentOperationalState, sunPlatWatchdogLastExpired=sunPlatWatchdogLastExpired, sunPlatNotificationChangedOID=sunPlatNotificationChangedOID, sunPlatLogRecordChangeNewOID=sunPlatLogRecordChangeNewOID, sunPlatLogRecordAlarmGroup=sunPlatLogRecordAlarmGroup, sunPlatUnitaryComputerSystemPowerState=sunPlatUnitaryComputerSystemPowerState, SunPlatEquipmentHolderPower=SunPlatEquipmentHolderPower, sunPlatEquipmentTable=sunPlatEquipmentTable, sunPlatEquipmentUnknownStatus=sunPlatEquipmentUnknownStatus, sunPlatNotificationSpecificProblem=sunPlatNotificationSpecificProblem, sunPlatPhysicalGroup=sunPlatPhysicalGroup, sunPlatEquipmentHolderAcceptableTypes=sunPlatEquipmentHolderAcceptableTypes, sunPlatNumericSensorRestoreDefaultThresholds=sunPlatNumericSensorRestoreDefaultThresholds, sunPlatLogRecordChangeOldOID=sunPlatLogRecordChangeOldOID, sunPlatNotificationTime=sunPlatNotificationTime, sunPlatProcessingErrorAlarm=sunPlatProcessingErrorAlarm, sunPlatLogRecordCorrelatedNotifications=sunPlatLogRecordCorrelatedNotifications, products=products, SunPlatAlarmStatus=SunPlatAlarmStatus, sunPlatAlarmUrgency=sunPlatAlarmUrgency, sunPlatBinarySensorGroup=sunPlatBinarySensorGroup, sunPlatNumericSensorEntry=sunPlatNumericSensorEntry, sunPlatWatchdogTable=sunPlatWatchdogTable, sunPlatLogicalTable=sunPlatLogicalTable)
