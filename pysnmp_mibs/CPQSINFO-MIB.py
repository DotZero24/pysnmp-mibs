...
class _CpqSiChassisHoodStatus_Type(Integer32):
    """Custom type cpqSiChassisHoodStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSiChassisHoodStatus_Type.__name__ = "Integer32"
_CpqSiChassisHoodStatus_Object = MibScalar
cpqSiChassisHoodStatus = _CpqSiChassisHoodStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 2, 2, 3, 16),
    _CpqSiChassisHoodStatus_Type()
)
cpqSiChassisHoodStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSiChassisHoodStatus.setStatus("mandatory")
...
class _CpqSiSystemTelemetryMetric_Type(Integer32):
    """Custom type cpqSiSystemTelemetryMetric based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
    ...
    namedValues = NamedValues(
        *(("cpuUtilization", 1),
          ("memoryBusUtilization", 2),
          ("ioBusUtilization", 3),
          ("cpuInterconnectUtilization", 4),
          ("jitterCount", 5),
          ("cpu0PowerUtilization", 6),
          ("cpu1PowerUtilization", 7),
          ("cpu2PowerUtilization", 8),
          ("cpu3PowerUtilization", 9),
          ("cpu0AverageFrequency", 10),
          ("cpu1AverageFrequency", 11),
          ("cpu2AverageFrequency", 12),
          ("cpu3AverageFrequency", 13))
    )


_CpqSiSystemTelemetryMetric_Type.__name__ = "Integer32"
_CpqSiSystemTelemetryMetric_Object = MibScalar
cpqSiSystemTelemetryMetric = _CpqSiSystemTelemetryMetric_Object(
    (1, 3, 6, 1, 4, 1, 232, 2, 2, 4, 26),
    _CpqSiSystemTelemetryMetric_Type()
)
cpqSiSystemTelemetryMetric.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSiSystemTelemetryMetric.setStatus("optional")


class _CpqSiSystemTelemetryThresholdStatus_Type(Integer32):
    """Custom type cpqSiSystemTelemetryThresholdStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
    ...
    namedValues = NamedValues(
        *(("aboveUpperThreshold", 1),
          ("belowLowerThreshold", 2))
    )


_CpqSiSystemTelemetryThresholdStatus_Type.__name__ = "Integer32"
_CpqSiSystemTelemetryThresholdStatus_Object = MibScalar
cpqSiSystemTelemetryThresholdStatus = _CpqSiSystemTelemetryThresholdStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 2, 2, 4, 27),
    _CpqSiSystemTelemetryThresholdStatus_Type()
)
cpqSiSystemTelemetryThresholdStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSiSystemTelemetryThresholdStatus.setStatus("optional")
...
cpqSiIntrusionInstalled = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 2014)
)
cpqSiIntrusionInstalled.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"))
)
if mibBuilder.loadTexts:
    cpqSiIntrusionInstalled.setStatus(
        ""
    )

cpqSiIntrusionRemoved = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 2015)
)
cpqSiIntrusionRemoved.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"))
)
if mibBuilder.loadTexts:
    cpqSiIntrusionRemoved.setStatus(
        ""
    )

cpqSiHoodReplaced = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 2016)
)
cpqSiHoodReplaced.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"))
)
if mibBuilder.loadTexts:
    cpqSiHoodReplaced.setStatus(
        ""
    )

cpqSiHoodRemovedOnPowerOff = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 2017)
)
cpqSiHoodRemovedOnPowerOff.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"))
)
if mibBuilder.loadTexts:
    cpqSiHoodRemovedOnPowerOff.setStatus(
        ""
    )

cpqSiSysTelemetryThresholdAlert = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 2018)
)
cpqSiSysTelemetryThresholdAlert.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSINFO-MIB", "cpqSiSystemTelemetryMetric"),
        ("CPQSINFO-MIB", "cpqSiSystemTelemetryThresholdStatus"))
)
if mibBuilder.loadTexts:
    cpqSiSysTelemetryThresholdAlert.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"cpqSiHoodRemoved": cpqSiHoodRemoved,
       ...
       "cpqSiIntrusionInstalled": cpqSiIntrusionInstalled,
       "cpqSiIntrusionRemoved": cpqSiIntrusionRemoved,
       "cpqSiHoodReplaced": cpqSiHoodReplaced,
       ...
       "cpqSiChassisHoodStatus": cpqSiChassisHoodStatus,
       ...
       "cpqSiSystemTelemetryMetric": cpqSiSystemTelemetryMetric,
       "cpqSiSystemTelemetryThresholdStatus": cpqSiSystemTelemetryThresholdStatus,
