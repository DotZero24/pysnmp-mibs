...
fsdhcpv6srv=ModuleIdentity((1,3,6,1,4,1,29601,2,42))
...
fsDhcp6SrvNotify=_FsDhcp6SrvNotify_ObjectIdentity((1,3,6,1,4,1,29601,2,42,0))
_FsDhcp6SrvSystem_ObjectIdentity=ObjectIdentity
fsDhcp6SrvSystem=_FsDhcp6SrvSystem_ObjectIdentity((1,3,6,1,4,1,29601,2,42,1))
...
fsDhcp6SrvDebugTrace=_FsDhcp6SrvDebugTrace_Object((1,3,6,1,4,1,29601,2,42,1,1),_FsDhcp6SrvDebugTrace_Type())
...
fsDhcp6SrvRealmTableNextIndex=_FsDhcp6SrvRealmTableNextIndex_Object((1,3,6,1,4,1,29601,2,42,1,2),_FsDhcp6SrvRealmTableNextIndex_Type())
...
fsDhcp6SrvClientTableNextIndex=_FsDhcp6SrvClientTableNextIndex_Object((1,3,6,1,4,1,29601,2,42,1,3),_FsDhcp6SrvClientTableNextIndex_Type())
...
fsDhcp6SrvPoolTableNextIndex=_FsDhcp6SrvPoolTableNextIndex_Object((1,3,6,1,4,1,29601,2,42,1,4),_FsDhcp6SrvPoolTableNextIndex_Type())
...
fsDhcp6SrvIncludePrefixTableNextIndex=_FsDhcp6SrvIncludePrefixTableNextIndex_Object((1,3,6,1,4,1,29601,2,42,1,5),_FsDhcp6SrvIncludePrefixTableNextIndex_Type())
...
fsDhcp6SrvTrapAdminControl=_FsDhcp6SrvTrapAdminControl_Object((1,3,6,1,4,1,29601,2,42,1,6),_FsDhcp6SrvTrapAdminControl_Type())
...
fsDhcp6SrvSysLogAdminStatus=_FsDhcp6SrvSysLogAdminStatus_Object((1,3,6,1,4,1,29601,2,42,1,7),_FsDhcp6SrvSysLogAdminStatus_Type())
...
fsDhcp6SrvListenPort=_FsDhcp6SrvListenPort_Object((1,3,6,1,4,1,29601,2,42,1,8),_FsDhcp6SrvListenPort_Type())
...
fsDhcp6SrvClientTransmitPort=_FsDhcp6SrvClientTransmitPort_Object((1,3,6,1,4,1,29601,2,42,1,9),_FsDhcp6SrvClientTransmitPort_Type())
...
fsDhcp6SrvRelayTransmitPort=_FsDhcp6SrvRelayTransmitPort_Object((1,3,6,1,4,1,29601,2,42,1,10),_FsDhcp6SrvRelayTransmitPort_Type())
...
fsDhcp6SrvConfig=_FsDhcp6SrvConfig_ObjectIdentity((1,3,6,1,4,1,29601,2,42,2))
_FsDhcp6SrvPoolTable_Object=MibTable
fsDhcp6SrvPoolTable=_FsDhcp6SrvPoolTable_Object((1,3,6,1,4,1,29601,2,42,2,1))
if mibBuilder.loadTexts:fsDhcp6SrvPoolTable.setStatus(_A)
_FsDhcp6SrvPoolEntry_Object=MibTableRow
fsDhcp6SrvPoolEntry=_FsDhcp6SrvPoolEntry_Object((1,3,6,1,4,1,29601,2,42,2,1,1))
...
fsDhcp6SrvPoolIndex=_FsDhcp6SrvPoolIndex_Object((1,3,6,1,4,1,29601,2,42,2,1,1,1),_FsDhcp6SrvPoolIndex_Type())
...
fsDhcp6SrvPoolName=_FsDhcp6SrvPoolName_Object((1,3,6,1,4,1,29601,2,42,2,1,1,2),_FsDhcp6SrvPoolName_Type())
...
fsDhcp6SrvPoolPreference=_FsDhcp6SrvPoolPreference_Object((1,3,6,1,4,1,29601,2,42,2,1,1,3),_FsDhcp6SrvPoolPreference_Type())
...
fsDhcp6SrvPoolDuidType=_FsDhcp6SrvPoolDuidType_Object((1,3,6,1,4,1,29601,2,42,2,1,1,4),_FsDhcp6SrvPoolDuidType_Type())
...
fsDhcp6SrvPoolDuid=_FsDhcp6SrvPoolDuid_Object((1,3,6,1,4,1,29601,2,42,2,1,1,5),_FsDhcp6SrvPoolDuid_Type())
...
fsDhcp6SrvPoolDuidIfIndex=_FsDhcp6SrvPoolDuidIfIndex_Object((1,3,6,1,4,1,29601,2,42,2,1,1,6),_FsDhcp6SrvPoolDuidIfIndex_Type())
...
fsDhcp6SrvPoolOptionTableNextIndex=_FsDhcp6SrvPoolOptionTableNextIndex_Object((1,3,6,1,4,1,29601,2,42,2,1,1,7),_FsDhcp6SrvPoolOptionTableNextIndex_Type())
...
fsDhcp6SrvPoolRowStatus=_FsDhcp6SrvPoolRowStatus_Object((1,3,6,1,4,1,29601,2,42,2,1,1,8),_FsDhcp6SrvPoolRowStatus_Type())
...
fsDhcp6SrvIncludePrefixTable=_FsDhcp6SrvIncludePrefixTable_Object((1,3,6,1,4,1,29601,2,42,2,2))
if mibBuilder.loadTexts:fsDhcp6SrvIncludePrefixTable.setStatus(_A)
_FsDhcp6SrvIncludePrefixEntry_Object=MibTableRow
fsDhcp6SrvIncludePrefixEntry=_FsDhcp6SrvIncludePrefixEntry_Object((1,3,6,1,4,1,29601,2,42,2,2,1))
...
fsDhcp6SrvIncludePrefixContextId=_FsDhcp6SrvIncludePrefixContextId_Object((1,3,6,1,4,1,29601,2,42,2,2,1,1),_FsDhcp6SrvIncludePrefixContextId_Type())
...
fsDhcp6SrvIncludePrefixIndex=_FsDhcp6SrvIncludePrefixIndex_Object((1,3,6,1,4,1,29601,2,42,2,2,1,2),_FsDhcp6SrvIncludePrefixIndex_Type())
...
fsDhcp6SrvIncludePrefix=_FsDhcp6SrvIncludePrefix_Object((1,3,6,1,4,1,29601,2,42,2,2,1,3),_FsDhcp6SrvIncludePrefix_Type())
...
fsDhcp6SrvIncludePrefixPool=_FsDhcp6SrvIncludePrefixPool_Object((1,3,6,1,4,1,29601,2,42,2,2,1,4),_FsDhcp6SrvIncludePrefixPool_Type())
...
fsDhcp6SrvIncludePrefixRowStatus=_FsDhcp6SrvIncludePrefixRowStatus_Object((1,3,6,1,4,1,29601,2,42,2,2,1,5),_FsDhcp6SrvIncludePrefixRowStatus_Type())
...
fsDhcp6SrvOptionTable=_FsDhcp6SrvOptionTable_Object((1,3,6,1,4,1,29601,2,42,2,3))
if mibBuilder.loadTexts:fsDhcp6SrvOptionTable.setStatus(_A)
_FsDhcp6SrvOptionEntry_Object=MibTableRow
fsDhcp6SrvOptionEntry=_FsDhcp6SrvOptionEntry_Object((1,3,6,1,4,1,29601,2,42,2,3,1))
...
fsDhcp6SrvOptionIndex=_FsDhcp6SrvOptionIndex_Object((1,3,6,1,4,1,29601,2,42,2,3,1,1),_FsDhcp6SrvOptionIndex_Type())
...
fsDhcp6SrvOptionType=_FsDhcp6SrvOptionType_Object((1,3,6,1,4,1,29601,2,42,2,3,1,2),_FsDhcp6SrvOptionType_Type())
...
fsDhcp6SrvOptionLength=_FsDhcp6SrvOptionLength_Object((1,3,6,1,4,1,29601,2,42,2,3,1,3),_FsDhcp6SrvOptionLength_Type())
...
fsDhcp6SrvOptionValue=_FsDhcp6SrvOptionValue_Object((1,3,6,1,4,1,29601,2,42,2,3,1,4),_FsDhcp6SrvOptionValue_Type())
...
fsDhcp6SrvOptionPreference=_FsDhcp6SrvOptionPreference_Object((1,3,6,1,4,1,29601,2,42,2,3,1,5),_FsDhcp6SrvOptionPreference_Type())
...
fsDhcp6SrvOptionRowStatus=_FsDhcp6SrvOptionRowStatus_Object((1,3,6,1,4,1,29601,2,42,2,3,1,6),_FsDhcp6SrvOptionRowStatus_Type())
...
fsDhcp6SrvSubOptionTable=_FsDhcp6SrvSubOptionTable_Object((1,3,6,1,4,1,29601,2,42,2,4))
if mibBuilder.loadTexts:fsDhcp6SrvSubOptionTable.setStatus(_A)
_FsDhcp6SrvSubOptionEntry_Object=MibTableRow
fsDhcp6SrvSubOptionEntry=_FsDhcp6SrvSubOptionEntry_Object((1,3,6,1,4,1,29601,2,42,2,4,1))
...
fsDhcp6SrvSubOptionType=_FsDhcp6SrvSubOptionType_Object((1,3,6,1,4,1,29601,2,42,2,4,1,1),_FsDhcp6SrvSubOptionType_Type())
...
fsDhcp6SrvSubOptionLength=_FsDhcp6SrvSubOptionLength_Object((1,3,6,1,4,1,29601,2,42,2,4,1,2),_FsDhcp6SrvSubOptionLength_Type())
...
fsDhcp6SrvSubOptionValue=_FsDhcp6SrvSubOptionValue_Object((1,3,6,1,4,1,29601,2,42,2,4,1,3),_FsDhcp6SrvSubOptionValue_Type())
...
fsDhcp6SrvSubOptionRowStatus=_FsDhcp6SrvSubOptionRowStatus_Object((1,3,6,1,4,1,29601,2,42,2,4,1,4),_FsDhcp6SrvSubOptionRowStatus_Type())
...
fsDhcp6SrvIfTable=_FsDhcp6SrvIfTable_Object((1,3,6,1,4,1,29601,2,42,2,5))
if mibBuilder.loadTexts:fsDhcp6SrvIfTable.setStatus(_A)
_FsDhcp6SrvIfEntry_Object=MibTableRow
fsDhcp6SrvIfEntry=_FsDhcp6SrvIfEntry_Object((1,3,6,1,4,1,29601,2,42,2,5,1))
...
fsDhcp6SrvIfIndex=_FsDhcp6SrvIfIndex_Object((1,3,6,1,4,1,29601,2,42,2,5,1,1),_FsDhcp6SrvIfIndex_Type())
...
fsDhcp6SrvIfPool=_FsDhcp6SrvIfPool_Object((1,3,6,1,4,1,29601,2,42,2,5,1,2),_FsDhcp6SrvIfPool_Type())
...
fsDhcp6SrvIfInformIn=_FsDhcp6SrvIfInformIn_Object((1,3,6,1,4,1,29601,2,42,2,5,1,3),_FsDhcp6SrvIfInformIn_Type())
...
fsDhcp6SrvIfRelayForwIn=_FsDhcp6SrvIfRelayForwIn_Object((1,3,6,1,4,1,29601,2,42,2,5,1,4),_FsDhcp6SrvIfRelayForwIn_Type())
...
fsDhcp6SrvIfReplyOut=_FsDhcp6SrvIfReplyOut_Object((1,3,6,1,4,1,29601,2,42,2,5,1,5),_FsDhcp6SrvIfReplyOut_Type())
...
fsDhcp6SrvIfRelayReplyOut=_FsDhcp6SrvIfRelayReplyOut_Object((1,3,6,1,4,1,29601,2,42,2,5,1,6),_FsDhcp6SrvIfRelayReplyOut_Type())
...
fsDhcp6SrvIfInvalidPktIn=_FsDhcp6SrvIfInvalidPktIn_Object((1,3,6,1,4,1,29601,2,42,2,5,1,7),_FsDhcp6SrvIfInvalidPktIn_Type())
...
fsDhcp6SrvIfUnknownTlvType=_FsDhcp6SrvIfUnknownTlvType_Object((1,3,6,1,4,1,29601,2,42,2,5,1,8),_FsDhcp6SrvIfUnknownTlvType_Type())
...
fsDhcp6SrvIfHmacFailCount=_FsDhcp6SrvIfHmacFailCount_Object((1,3,6,1,4,1,29601,2,42,2,5,1,9),_FsDhcp6SrvIfHmacFailCount_Type())
...
fsDhcp6SrvIfCounterReset=_FsDhcp6SrvIfCounterReset_Object((1,3,6,1,4,1,29601,2,42,2,5,1,10),_FsDhcp6SrvIfCounterReset_Type())
...
fsDhcp6SrvIfRowStatus=_FsDhcp6SrvIfRowStatus_Object((1,3,6,1,4,1,29601,2,42,2,5,1,11),_FsDhcp6SrvIfRowStatus_Type())
...
fsDhcp6SrvRealmTable=_FsDhcp6SrvRealmTable_Object((1,3,6,1,4,1,29601,2,42,2,6))
if mibBuilder.loadTexts:fsDhcp6SrvRealmTable.setStatus(_A)
_FsDhcp6SrvRealmEntry_Object=MibTableRow
fsDhcp6SrvRealmEntry=_FsDhcp6SrvRealmEntry_Object((1,3,6,1,4,1,29601,2,42,2,6,1))
...
fsDhcp6SrvRealmIndex=_FsDhcp6SrvRealmIndex_Object((1,3,6,1,4,1,29601,2,42,2,6,1,1),_FsDhcp6SrvRealmIndex_Type())
...
fsDhcp6SrvRealmName=_FsDhcp6SrvRealmName_Object((1,3,6,1,4,1,29601,2,42,2,6,1,2),_FsDhcp6SrvRealmName_Type())
...
fsDhcp6SrvRealmKeyTableNextIndex=_FsDhcp6SrvRealmKeyTableNextIndex_Object((1,3,6,1,4,1,29601,2,42,2,6,1,3),_FsDhcp6SrvRealmKeyTableNextIndex_Type())
...
fsDhcp6SrvRealmRowStatus=_FsDhcp6SrvRealmRowStatus_Object((1,3,6,1,4,1,29601,2,42,2,6,1,4),_FsDhcp6SrvRealmRowStatus_Type())
...
fsDhcp6SrvClientTable=_FsDhcp6SrvClientTable_Object((1,3,6,1,4,1,29601,2,42,2,7))
if mibBuilder.loadTexts:fsDhcp6SrvClientTable.setStatus(_A)
_FsDhcp6SrvClientEntry_Object=MibTableRow
fsDhcp6SrvClientEntry=_FsDhcp6SrvClientEntry_Object((1,3,6,1,4,1,29601,2,42,2,7,1))
...
fsDhcp6SrvClientIndex=_FsDhcp6SrvClientIndex_Object((1,3,6,1,4,1,29601,2,42,2,7,1,1),_FsDhcp6SrvClientIndex_Type())
...
fsDhcp6SrvClientId=_FsDhcp6SrvClientId_Object((1,3,6,1,4,1,29601,2,42,2,7,1,2),_FsDhcp6SrvClientId_Type())
...
fsDhcp6SrvClientIdType=_FsDhcp6SrvClientIdType_Object((1,3,6,1,4,1,29601,2,42,2,7,1,3),_FsDhcp6SrvClientIdType_Type())
...
fsDhcp6SrvClientRealm=_FsDhcp6SrvClientRealm_Object((1,3,6,1,4,1,29601,2,42,2,7,1,4),_FsDhcp6SrvClientRealm_Type())
...
fsDhcp6SrvClientRowStatus=_FsDhcp6SrvClientRowStatus_Object((1,3,6,1,4,1,29601,2,42,2,7,1,5),_FsDhcp6SrvClientRowStatus_Type())
...
fsDhcp6SrvKeyTable=_FsDhcp6SrvKeyTable_Object((1,3,6,1,4,1,29601,2,42,2,8))
if mibBuilder.loadTexts:fsDhcp6SrvKeyTable.setStatus(_A)
_FsDhcp6SrvKeyEntry_Object=MibTableRow
fsDhcp6SrvKeyEntry=_FsDhcp6SrvKeyEntry_Object((1,3,6,1,4,1,29601,2,42,2,8,1))
...
fsDhcp6SrvKeyIdentifier=_FsDhcp6SrvKeyIdentifier_Object((1,3,6,1,4,1,29601,2,42,2,8,1,1),_FsDhcp6SrvKeyIdentifier_Type())
...
fsDhcp6SrvKey=_FsDhcp6SrvKey_Object((1,3,6,1,4,1,29601,2,42,2,8,1,2),_FsDhcp6SrvKey_Type())
...
fsDhcp6SrvKeyRowStatus=_FsDhcp6SrvKeyRowStatus_Object((1,3,6,1,4,1,29601,2,42,2,8,1,3),_FsDhcp6SrvKeyRowStatus_Type())
fsDhcp6SrvKeyRowStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:fsDhcp6SrvKeyRowStatus.setStatus(_A)
fsDhcp6SrvUnknownTlvTrap=NotificationType((1,3,6,1,4,1,29601,2,42,0,1))
fsDhcp6SrvUnknownTlvTrap.setObjects((_C,_U))
if mibBuilder.loadTexts:fsDhcp6SrvUnknownTlvTrap.setStatus(_A)
fsDhcp6SrvInvalidPacketTrap=NotificationType((1,3,6,1,4,1,29601,2,42,0,2))
fsDhcp6SrvInvalidPacketTrap.setObjects((_C,_V))
if mibBuilder.loadTexts:fsDhcp6SrvInvalidPacketTrap.setStatus(_A)
fsDhcp6SrvHmacAuthenticationFailTrap=NotificationType((1,3,6,1,4,1,29601,2,42,0,3))
