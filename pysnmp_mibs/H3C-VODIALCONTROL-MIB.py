...
h3cVoPeerObjects=_H3cVoPeerObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,39,5,1))
_H3cVoPeerCommonConfigTable_Object=MibTable
h3cVoPeerCommonConfigTable=_H3cVoPeerCommonConfigTable_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1))
if mibBuilder.loadTexts:h3cVoPeerCommonConfigTable.setStatus(_A)
_H3cVoPeerCommonConfigEntry_Object=MibTableRow
h3cVoPeerCommonConfigEntry=_H3cVoPeerCommonConfigEntry_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1))
...
h3cVoPeerCfgIndex=_H3cVoPeerCfgIndex_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,1),_H3cVoPeerCfgIndex_Type())
...
h3cVoPeerCfgRowStatus=_H3cVoPeerCfgRowStatus_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,2),_H3cVoPeerCfgRowStatus_Type())
...
h3cVoPeerCfgType=_H3cVoPeerCfgType_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,3),_H3cVoPeerCfgType_Type())
...
h3cVoPeerCfgDesPattern=_H3cVoPeerCfgDesPattern_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,4),_H3cVoPeerCfgDesPattern_Type())
...
h3cVoPeerCfgCodec1st=_H3cVoPeerCfgCodec1st_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,5),_H3cVoPeerCfgCodec1st_Type())
...
h3cVoPeerCfgCodec2nd=_H3cVoPeerCfgCodec2nd_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,6),_H3cVoPeerCfgCodec2nd_Type())
...
h3cVoPeerCfgCodec3rd=_H3cVoPeerCfgCodec3rd_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,7),_H3cVoPeerCfgCodec3rd_Type())
...
h3cVoPeerCfgCodec4th=_H3cVoPeerCfgCodec4th_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,8),_H3cVoPeerCfgCodec4th_Type())
...
h3cVoPeerCfgDSCP=_H3cVoPeerCfgDSCP_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,9),_H3cVoPeerCfgDSCP_Type())
...
h3cVoPeerCfgShutDown=_H3cVoPeerCfgShutDown_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,10),_H3cVoPeerCfgShutDown_Type())
...
h3cVoPeerCfgVADEnable=_H3cVoPeerCfgVADEnable_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,11),_H3cVoPeerCfgVADEnable_Type())
...
h3cVoPeerCfgOutbandMode=_H3cVoPeerCfgOutbandMode_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,12),_H3cVoPeerCfgOutbandMode_Type())
...
h3cVoPeerCfgFaxLevel=_H3cVoPeerCfgFaxLevel_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,13),_H3cVoPeerCfgFaxLevel_Type())
...
h3cVoPeerCfgFaxBaudrate=_H3cVoPeerCfgFaxBaudrate_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,14),_H3cVoPeerCfgFaxBaudrate_Type())
...
h3cVoPeerCfgFaxLocalTrainPara=_H3cVoPeerCfgFaxLocalTrainPara_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,15),_H3cVoPeerCfgFaxLocalTrainPara_Type())
...
h3cVoPeerCfgFaxProtocol=_H3cVoPeerCfgFaxProtocol_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,16),_H3cVoPeerCfgFaxProtocol_Type())
...
h3cVoPeerCfgT38FaxHRPackNum=_H3cVoPeerCfgT38FaxHRPackNum_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,17),_H3cVoPeerCfgT38FaxHRPackNum_Type())
...
h3cVoPeerCfgT38FaxLRPackNum=_H3cVoPeerCfgT38FaxLRPackNum_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,18),_H3cVoPeerCfgT38FaxLRPackNum_Type())
...
h3cVoPeerCfgFaxSendNSFEnable=_H3cVoPeerCfgFaxSendNSFEnable_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,19),_H3cVoPeerCfgFaxSendNSFEnable_Type())
...
h3cVoPeerCfgFaxSupportMode=_H3cVoPeerCfgFaxSupportMode_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,20),_H3cVoPeerCfgFaxSupportMode_Type())
...
h3cVoPeerCfgFaxTrainMode=_H3cVoPeerCfgFaxTrainMode_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,21),_H3cVoPeerCfgFaxTrainMode_Type())
...
h3cVoPeerCfgFaxEcm=_H3cVoPeerCfgFaxEcm_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,22),_H3cVoPeerCfgFaxEcm_Type())
...
h3cVoPeerCfgPriority=_H3cVoPeerCfgPriority_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,23),_H3cVoPeerCfgPriority_Type())
...
h3cVoPeerCfgDescription=_H3cVoPeerCfgDescription_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,24),_H3cVoPeerCfgDescription_Type())
...
h3cVoPeerCfgCallingNumberType=_H3cVoPeerCfgCallingNumberType_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,25),_H3cVoPeerCfgCallingNumberType_Type())
...
h3cVoPeerCfgCalledNumberType=_H3cVoPeerCfgCalledNumberType_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,26),_H3cVoPeerCfgCalledNumberType_Type())
...
h3cVoPeerCfgCallingNumberPlan=_H3cVoPeerCfgCallingNumberPlan_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,27),_H3cVoPeerCfgCallingNumberPlan_Type())
...
h3cVoPeerCfgCalledNumberPlan=_H3cVoPeerCfgCalledNumberPlan_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,28),_H3cVoPeerCfgCalledNumberPlan_Type())
...
h3cVoPeerCfgSelectStop=_H3cVoPeerCfgSelectStop_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,29),_H3cVoPeerCfgSelectStop_Type())
...
h3cVoPeerCfgCallingNumSubstRule=_H3cVoPeerCfgCallingNumSubstRule_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,30),_H3cVoPeerCfgCallingNumSubstRule_Type())
...
h3cVoPeerCfgCalledNumSubstRule=_H3cVoPeerCfgCalledNumSubstRule_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,31),_H3cVoPeerCfgCalledNumSubstRule_Type())
...
h3cVoPeerCfgMaxCall=_H3cVoPeerCfgMaxCall_Object((1,3,6,1,4,1,2011,10,2,39,5,1,1,1,32),_H3cVoPeerCfgMaxCall_Type())
...
h3cVoPOTSPeerConfigTable=_H3cVoPOTSPeerConfigTable_Object((1,3,6,1,4,1,2011,10,2,39,5,1,2))
if mibBuilder.loadTexts:h3cVoPOTSPeerConfigTable.setStatus(_A)
_H3cVoPOTSPeerConfigEntry_Object=MibTableRow
h3cVoPOTSPeerConfigEntry=_H3cVoPOTSPeerConfigEntry_Object((1,3,6,1,4,1,2011,10,2,39,5,1,2,1))
...
h3cVoPOTSPeerConfigIndex=_H3cVoPOTSPeerConfigIndex_Object((1,3,6,1,4,1,2011,10,2,39,5,1,2,1,1),_H3cVoPOTSPeerConfigIndex_Type())
...
h3cVoPOTSPeerConfigPrefix=_H3cVoPOTSPeerConfigPrefix_Object((1,3,6,1,4,1,2011,10,2,39,5,1,2,1,2),_H3cVoPOTSPeerConfigPrefix_Type())
...
h3cVoPOTSPeerConfigSubLine=_H3cVoPOTSPeerConfigSubLine_Object((1,3,6,1,4,1,2011,10,2,39,5,1,2,1,3),_H3cVoPOTSPeerConfigSubLine_Type())
...
h3cVoPOTSPeerConfigSendNum=_H3cVoPOTSPeerConfigSendNum_Object((1,3,6,1,4,1,2011,10,2,39,5,1,2,1,4),_H3cVoPOTSPeerConfigSendNum_Type())
...
h3cVoVoIPPeerConfigTable=_H3cVoVoIPPeerConfigTable_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3))
if mibBuilder.loadTexts:h3cVoVoIPPeerConfigTable.setStatus(_A)
_H3cVoVoIPPeerConfigEntry_Object=MibTableRow
h3cVoVoIPPeerConfigEntry=_H3cVoVoIPPeerConfigEntry_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3,1))
...
h3cVoVoIPPeerCfgIndex=_H3cVoVoIPPeerCfgIndex_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3,1,1),_H3cVoVoIPPeerCfgIndex_Type())
...
h3cVoVoIPPeerCfgTargetType=_H3cVoVoIPPeerCfgTargetType_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3,1,2),_H3cVoVoIPPeerCfgTargetType_Type())
...
h3cVoVoIPPeerCfgTargetAddrType=_H3cVoVoIPPeerCfgTargetAddrType_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3,1,3),_H3cVoVoIPPeerCfgTargetAddrType_Type())
...
h3cVoVoIPPeerCfgTargetAddr=_H3cVoVoIPPeerCfgTargetAddr_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3,1,4),_H3cVoVoIPPeerCfgTargetAddr_Type())
...
h3cVoVoIPPeerCfgFastStart=_H3cVoVoIPPeerCfgFastStart_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3,1,5),_H3cVoVoIPPeerCfgFastStart_Type())
...
h3cVoVoIPPeerCfgTunnel=_H3cVoVoIPPeerCfgTunnel_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3,1,6),_H3cVoVoIPPeerCfgTunnel_Type())
...
h3cVoVoIPPeerCfgAreaID=_H3cVoVoIPPeerCfgAreaID_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3,1,7),_H3cVoVoIPPeerCfgAreaID_Type())
...
h3cVoVoIPPeerCfgSendRing=_H3cVoVoIPPeerCfgSendRing_Object((1,3,6,1,4,1,2011,10,2,39,5,1,3,1,8),_H3cVoVoIPPeerCfgSendRing_Type())
...
h3cVoPeerDefaultConfigObjects=_H3cVoPeerDefaultConfigObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,39,5,1,4))
_H3cVoPeerDefault1stCodecLevel_Type=CodecType
_H3cVoPeerDefault1stCodecLevel_Object=MibScalar
h3cVoPeerDefault1stCodecLevel=_H3cVoPeerDefault1stCodecLevel_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,2),_H3cVoPeerDefault1stCodecLevel_Type())
...
h3cVoPeerDefault2ndCodecLevel=_H3cVoPeerDefault2ndCodecLevel_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,3),_H3cVoPeerDefault2ndCodecLevel_Type())
...
h3cVoPeerDefault3rdCodecLevel=_H3cVoPeerDefault3rdCodecLevel_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,4),_H3cVoPeerDefault3rdCodecLevel_Type())
...
h3cVoPeerDefault4thCodecLevel=_H3cVoPeerDefault4thCodecLevel_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,5),_H3cVoPeerDefault4thCodecLevel_Type())
...
h3cVoPeerDefaultVADOn=_H3cVoPeerDefaultVADOn_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,6),_H3cVoPeerDefaultVADOn_Type())
...
h3cVoPeerDefaultFaxTransLevel=_H3cVoPeerDefaultFaxTransLevel_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,7),_H3cVoPeerDefaultFaxTransLevel_Type())
...
h3cVoPeerDefaultFaxLocalTrain=_H3cVoPeerDefaultFaxLocalTrain_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,8),_H3cVoPeerDefaultFaxLocalTrain_Type())
...
h3cVoPeerDefaultFaxProtocol=_H3cVoPeerDefaultFaxProtocol_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,9),_H3cVoPeerDefaultFaxProtocol_Type())
...
h3cVoPeerDefaultFaxHSRedunNum=_H3cVoPeerDefaultFaxHSRedunNum_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,10),_H3cVoPeerDefaultFaxHSRedunNum_Type())
...
h3cVoPeerDefaultFaxLSRedunNum=_H3cVoPeerDefaultFaxLSRedunNum_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,11),_H3cVoPeerDefaultFaxLSRedunNum_Type())
...
h3cVoPeerDefaultFaxBaudrate=_H3cVoPeerDefaultFaxBaudrate_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,12),_H3cVoPeerDefaultFaxBaudrate_Type())
...
h3cVoPeerDefaultFaxNSF=_H3cVoPeerDefaultFaxNSF_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,13),_H3cVoPeerDefaultFaxNSF_Type())
...
h3cVoPeerDefaultFaxSupportMode=_H3cVoPeerDefaultFaxSupportMode_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,14),_H3cVoPeerDefaultFaxSupportMode_Type())
...
h3cVoPeerDefaultFaxTrainMode=_H3cVoPeerDefaultFaxTrainMode_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,15),_H3cVoPeerDefaultFaxTrainMode_Type())
...
h3cVoPeerDefaultFaxECM=_H3cVoPeerDefaultFaxECM_Object((1,3,6,1,4,1,2011,10,2,39,5,1,4,16),_H3cVoPeerDefaultFaxECM_Type())
...
h3cVoPeerCfgCallerPermitTable=_H3cVoPeerCfgCallerPermitTable_Object((1,3,6,1,4,1,2011,10,2,39,5,1,5))
if mibBuilder.loadTexts:h3cVoPeerCfgCallerPermitTable.setStatus(_A)
_H3cVoPeerCfgCallerPermitEntry_Object=MibTableRow
h3cVoPeerCfgCallerPermitEntry=_H3cVoPeerCfgCallerPermitEntry_Object((1,3,6,1,4,1,2011,10,2,39,5,1,5,1))
...
h3cVoPeerCfgCallerPermitNum=_H3cVoPeerCfgCallerPermitNum_Object((1,3,6,1,4,1,2011,10,2,39,5,1,5,1,1),_H3cVoPeerCfgCallerPermitNum_Type())
...
h3cVoPeerCallerPermitRowStatus=_H3cVoPeerCallerPermitRowStatus_Object((1,3,6,1,4,1,2011,10,2,39,5,1,5,1,2),_H3cVoPeerCallerPermitRowStatus_Type())
