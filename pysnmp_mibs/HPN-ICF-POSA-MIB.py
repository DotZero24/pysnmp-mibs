...
mibBuilder.exportSymbols("HPN-ICF-POSA-MIB", hpnicfPosaFcmConfTable=hpnicfPosaFcmConfTable, hpnicfPosaTcpConnectionTrapEnable=hpnicfPosaTcpConnectionTrapEnable, hpnicfPosaFcmStatTransCntsClear=hpnicfPosaFcmStatTransCntsClear, hpnicfPosaAppRowStatus=hpnicfPosaAppRowStatus, hpnicfPosaAppRouterIP=hpnicfPosaAppRouterIP, hpnicfPosaFcmThresholdRlsdOn=hpnicfPosaFcmThresholdRlsdOn, hpnicfPosaTerminalInDiscardedPkts=hpnicfPosaTerminalInDiscardedPkts, hpnicfPosaMapTable=hpnicfPosaMapTable, hpnicfPosaBackupAppID=hpnicfPosaBackupAppID, hpnicfPosaAppSendPkts=hpnicfPosaAppSendPkts, hpnicfPosaFcmNegoHookOff=hpnicfPosaFcmNegoHookOff, hpnicfPosaFcmThresholdRlsdOff=hpnicfPosaFcmThresholdRlsdOff, hpnicfPosaBatchTerminalEntry=hpnicfPosaBatchTerminalEntry, hpnicfPosaTcpTermStatIPType=hpnicfPosaTcpTermStatIPType, HpnicfAppServiceType=HpnicfAppServiceType, hpnicfPosaTerminalRowStatus=hpnicfPosaTerminalRowStatus, hpnicfPosaSrvStateChangeTrapEnable=hpnicfPosaSrvStateChangeTrapEnable, hpnicfPosaAppTable=hpnicfPosaAppTable, hpnicfPosaTpduChangeStrategy=hpnicfPosaTpduChangeStrategy, hpnicfPosaFcmTradeTimeout=hpnicfPosaFcmTradeTimeout, hpnicfPosaCallerMapErrCnts=hpnicfPosaCallerMapErrCnts, hpnicfPosaAppIfIndex=hpnicfPosaAppIfIndex, hpnicfPosaBatchTerminalRowStatus=hpnicfPosaBatchTerminalRowStatus, hpnicfPosaTrapObjects=hpnicfPosaTrapObjects, hpnicfPosaAppRouterPort=hpnicfPosaAppRouterPort, hpnicfPosaFcmStatTransSuccessCnts=hpnicfPosaFcmStatTransSuccessCnts, hpnicfPosaFcmThresholdAnswerTone=hpnicfPosaFcmThresholdAnswerTone, HpnicfTpduChangeStrategy=HpnicfTpduChangeStrategy, hpnicfPosaTcpTradeTrapEnable=hpnicfPosaTcpTradeTrapEnable, hpnicfPosaControl=hpnicfPosaControl, hpnicfPosaCallerStatTable=hpnicfPosaCallerStatTable, hpnicfPosaAppRouterIPType=hpnicfPosaAppRouterIPType, hpnicfPosaTcpConnectionNumber=hpnicfPosaTcpConnectionNumber, hpnicfPosaAppEntry=hpnicfPosaAppEntry, hpnicfPosaMapRowStatus=hpnicfPosaMapRowStatus, hpnicfPosaAppInDiscardedPkts=hpnicfPosaAppInDiscardedPkts, hpnicfPosaAppName=hpnicfPosaAppName, hpnicfPosaTcpTermInDiscardedPkts=hpnicfPosaTcpTermInDiscardedPkts, hpnicfPosaAppKeepAliveCount=hpnicfPosaAppKeepAliveCount, hpnicfPosaFcmStatIfIndex=hpnicfPosaFcmStatIfIndex, HpnicfTerminalAccessType=HpnicfTerminalAccessType, hpnicfPosaTcpTradeTimeout=hpnicfPosaTcpTradeTimeout, hpnicfPosaMapEntry=hpnicfPosaMapEntry, hpnicfPosaTerminalAccessType=hpnicfPosaTerminalAccessType, hpnicfPosaAppDistributeErrCnts=hpnicfPosaAppDistributeErrCnts, hpnicfPosaServerStatusChange=hpnicfPosaServerStatusChange, hpnicfPosaAppStatTable=hpnicfPosaAppStatTable, hpnicfPosaFcmConnectionExceed=hpnicfPosaFcmConnectionExceed, hpnicfPosaTerminalCfgIfIndex=hpnicfPosaTerminalCfgIfIndex, hpnicfPosaFcmConnectionTrapEnable=hpnicfPosaFcmConnectionTrapEnable, hpnicfPosaCallerStatEntry=hpnicfPosaCallerStatEntry, hpnicfPosaTcpTermStatTable=hpnicfPosaTcpTermStatTable, hpnicfPosaFcmConfEntry=hpnicfPosaFcmConfEntry, hpnicfPosaTrap=hpnicfPosaTrap, hpnicfPosaAppHostIP=hpnicfPosaAppHostIP, hpnicfPosaFcmStatEntry=hpnicfPosaFcmStatEntry, hpnicfPosaAppKeepAliveInterval=hpnicfPosaAppKeepAliveInterval, hpnicfPosaAppStateChangeObject=hpnicfPosaAppStateChangeObject, HpnicfPeerState=HpnicfPeerState, hpnicfPosaTerminalHangUpTrapEnable=hpnicfPosaTerminalHangUpTrapEnable, hpnicfPosaAppStateChange=hpnicfPosaAppStateChange, hpnicfPosaTerminalIfIndex=hpnicfPosaTerminalIfIndex, hpnicfPosaFcmStatTransCnts=hpnicfPosaFcmStatTransCnts, hpnicfPosaTcpTermStatIP=hpnicfPosaTcpTermStatIP, hpnicfPosaCallerIDTransEnable=hpnicfPosaCallerIDTransEnable, hpnicfPosaMapAppID=hpnicfPosaMapAppID, hpnicfPosaFcmStatConnectFailCnts=hpnicfPosaFcmStatConnectFailCnts, hpnicfPosaAppHello=hpnicfPosaAppHello, hpnicfPosaServerEnable=hpnicfPosaServerEnable, hpnicfPosaAppHelloInterval=hpnicfPosaAppHelloInterval, hpnicfPosaTcpTradeLimit=hpnicfPosaTcpTradeLimit, hpnicfPosaTcpTermStatIndex=hpnicfPosaTcpTermStatIndex, hpnicfPosaTcpTradeExceed=hpnicfPosaTcpTradeExceed, hpnicfPosaTerminalID=hpnicfPosaTerminalID, hpnicfPosaTcpTermSendPkts=hpnicfPosaTcpTermSendPkts, hpnicfPosaTerminalOutDiscardedPkts=hpnicfPosaTerminalOutDiscardedPkts, hpnicfPosaAppServiceType=hpnicfPosaAppServiceType, hpnicfPosaTerminalErrPkts=hpnicfPosaTerminalErrPkts, hpnicfPosaCallerOutDiscardedPkts=hpnicfPosaCallerOutDiscardedPkts, hpnicfPosaFcmIdleTimeout=hpnicfPosaFcmIdleTimeout, hpnicfPosaFcmStatTimeoutCnts=hpnicfPosaFcmStatTimeoutCnts, hpnicfPosaAppID=hpnicfPosaAppID, hpnicfPosaAppStatEntry=hpnicfPosaAppStatEntry, hpnicfPosaFcmConnectionNumber=hpnicfPosaFcmConnectionNumber, hpnicfPosaTcpTermRecvPkts=hpnicfPosaTcpTermRecvPkts, hpnicfPosaFcmStatTable=hpnicfPosaFcmStatTable, hpnicfPosaTcpTermOutDiscardedPkts=hpnicfPosaTcpTermOutDiscardedPkts, hpnicfPosa=hpnicfPosa, hpnicfPosaCallerSendPkts=hpnicfPosaCallerSendPkts, hpnicfPosaQuietTimeOut=hpnicfPosaQuietTimeOut, hpnicfPosaCallerStatRowStatus=hpnicfPosaCallerStatRowStatus, hpnicfPosaTcpConnectionExceed=hpnicfPosaTcpConnectionExceed, hpnicfPosaTcpTermStatIPMask=hpnicfPosaTcpTermStatIPMask, hpnicfPosaFcmNegoSilence=hpnicfPosaFcmNegoSilence, hpnicfPosaTerminalState=hpnicfPosaTerminalState, hpnicfPosaTcpTermStatEntry=hpnicfPosaTcpTermStatEntry, hpnicfPosaFcmPhyNegoFailTrapEnable=hpnicfPosaFcmPhyNegoFailTrapEnable, hpnicfPosaFcmLnkNegoFailTrapEnable=hpnicfPosaFcmLnkNegoFailTrapEnable, hpnicfPosaTcpConnectionThreshold=hpnicfPosaTcpConnectionThreshold, hpnicfPosaFcmAnswerTimeout=hpnicfPosaFcmAnswerTimeout, hpnicfPosaTerminalSendPkts=hpnicfPosaTerminalSendPkts, hpnicfPosaTcpTermErrPkts=hpnicfPosaTcpTermErrPkts, hpnicfPosaFcmPhyNegoFailed=hpnicfPosaFcmPhyNegoFailed, hpnicfPosaTerminalName=hpnicfPosaTerminalName, HpnicfAppMode=HpnicfAppMode, hpnicfPosaFcmNegoUnscrmbBinary1=hpnicfPosaFcmNegoUnscrmbBinary1, hpnicfPosaAppMode=hpnicfPosaAppMode, hpnicfPosaTerminalTable=hpnicfPosaTerminalTable, hpnicfPosaTcpTermStatRowStatus=hpnicfPosaTcpTermStatRowStatus, hpnicfPosaMapDestCode=hpnicfPosaMapDestCode, hpnicfPosaTables=hpnicfPosaTables, hpnicfPosaAppOutDiscardedPkts=hpnicfPosaAppOutDiscardedPkts, hpnicfPosaFcmLinkNegoFailed=hpnicfPosaFcmLinkNegoFailed, hpnicfPosaCallerRecvPkts=hpnicfPosaCallerRecvPkts, hpnicfPosaTerminalHangUp=hpnicfPosaTerminalHangUp, hpnicfPosaFcmConnectionThreshold=hpnicfPosaFcmConnectionThreshold, hpnicfPosaTerminalTransAppID=hpnicfPosaTerminalTransAppID, hpnicfPosaAppStateChangeTrapEnable=hpnicfPosaAppStateChangeTrapEnable, hpnicfPosaFcmNegoScrmbBinary1=hpnicfPosaFcmNegoScrmbBinary1, hpnicfPosaAppHostIPType=hpnicfPosaAppHostIPType, hpnicfPosaTrapPrex=hpnicfPosaTrapPrex, hpnicfPosaAppConnectTimeout=hpnicfPosaAppConnectTimeout, hpnicfPosaFcmThresholdTxPower=hpnicfPosaFcmThresholdTxPower, hpnicfPosaBatchTerminalTable=hpnicfPosaBatchTerminalTable, hpnicfPosaTerminalMapErrCnts=hpnicfPosaTerminalMapErrCnts, hpnicfPosaTcpTermMapErrCnts=hpnicfPosaTcpTermMapErrCnts, hpnicfPosaTerminalListenPort=hpnicfPosaTerminalListenPort, hpnicfPosaMapSrcCode=hpnicfPosaMapSrcCode, PYSNMP_MODULE_ID=hpnicfPosa, hpnicfPosaAppHostPort=hpnicfPosaAppHostPort, hpnicfPosaCallerInDiscardedPkts=hpnicfPosaCallerInDiscardedPkts, hpnicfPosaTerminalStatEntry=hpnicfPosaTerminalStatEntry, hpnicfPosaTerminalRecvPkts=hpnicfPosaTerminalRecvPkts, hpnicfPosaAppRecvPkts=hpnicfPosaAppRecvPkts, hpnicfPosaCallerStatCallerID=hpnicfPosaCallerStatCallerID, hpnicfPosaTerminalStatTable=hpnicfPosaTerminalStatTable, hpnicfPosaCallerErrPkts=hpnicfPosaCallerErrPkts, hpnicfPosaTerminalEntry=hpnicfPosaTerminalEntry, hpnicfPosaBatchTerminalFirstID=hpnicfPosaBatchTerminalFirstID, hpnicfPosaAppState=hpnicfPosaAppState, hpnicfPosaAppErrPkts=hpnicfPosaAppErrPkts)
