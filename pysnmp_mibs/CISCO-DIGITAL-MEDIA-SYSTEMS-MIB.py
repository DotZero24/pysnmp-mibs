...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-DIGITAL-MEDIA-SYSTEMS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:38:50 2025
...
_CdmsHaClusterEnabled_Type.__name__ = "TruthValue"
...
_CdmsMediaPlayerRegisteredEnable_Type.__name__ = "TruthValue"
...
_CdmsMediaPlayerUpEnable_Type.__name__ = "TruthValue"
...
_CdmsMediaPlayerDownEnable_Type.__name__ = "TruthValue"
...
_CdmsMediaPlayerAddrTakenEnable_Type.__name__ = "TruthValue"
...
_CdmsHaClusterNodeUpEnable_Type.__name__ = "TruthValue"
...
_CdmsHaClusterNodeDownEnable_Type.__name__ = "TruthValue"
...
_CdmsHaClusterConfigChangeEnable_Type.__name__ = "TruthValue"
...
ciscoDmsMonitorMIBCompliance.setObjects(
      *(("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsSystemGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsFeatureGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsInventoryGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsFeatureAdvancedGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsServerGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDamGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsSecurityGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsUserGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsEventGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsHaGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsHaAdvancedGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsNotificationCntlGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsNotificationsGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsAdvancedNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoDmsMonitorMIBComplianceRev1.setObjects(
      *(("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsSystemGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsFeatureGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsInventoryGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsFeatureAdvancedGroup"),
        ...
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsUserGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsEventGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsNotificationCntlGroupRev1"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsNotificationsGroupRev1"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsAdvancedNotificationsGroup"),
        ("CISCO-DIGITAL-MEDIA-SYSTEMS-MIB", "ciscoDmsHaGroup"))
)
if mibBuilder.loadTexts:
