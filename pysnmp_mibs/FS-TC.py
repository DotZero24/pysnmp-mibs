...
mibBuilder.exportSymbols("FS-TC", fsTextualConventions=fsTextualConventions, FSTrapType=FSTrapType, PYSNMP_MODULE_ID=fsTextualConventions, MemberMap=MemberMap, IfIndex=IfIndex, ConfigStatus=ConfigStatus)
