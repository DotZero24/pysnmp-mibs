# SNMP MIB module (ARICENT-BRIDGE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-BRIDGE-MIB
...
dot1dFutureBasePortEntry = _Dot1dFutureBasePortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 26, 1, 1, 7, 1)
)
dot1dFutureBasePortEntry.setIndexNames(
    (0, "ARICENT-BRIDGE-MIB", "dot1dFutureBasePort"),
)
if mibBuilder.loadTexts:
...
dot1dFutureTpPortEntry = _Dot1dFutureTpPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 26, 1, 2, 1, 1)
)
dot1dFutureTpPortEntry.setIndexNames(
    (0, "ARICENT-BRIDGE-MIB", "dot1dFutureTpPort"),
)
if mibBuilder.loadTexts:
