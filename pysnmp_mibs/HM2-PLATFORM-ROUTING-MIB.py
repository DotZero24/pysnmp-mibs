...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hirschmann/HM2-PLATFORM-ROUTING-MIB
...
ospfAreaEntry, ospfVirtIfEntry, RouterID, ospfIfMetricEntry, ospfIfEntry, ospfNbrEntry = mibBuilder.importSymbols("OSPF-MIB", "ospfAreaEntry", "ospfVirtIfEntry", "RouterID", "ospfIfMetricEntry", "ospfIfEntry", "ospfNbrEntry")
...
hm2AgentSwitchIpRouteCount = MibScalar((1, 3, 6, 1, 4, 1, 248, 12, 2, 2, 251), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2AgentSwitchIpRouteCount.setStatus('current')
hm2AgentSwitchIpBestRouteCount = MibScalar((1, 3, 6, 1, 4, 1, 248, 12, 2, 2, 252), Unsigned32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hm2AgentSwitchIpBestRouteCount.setStatus('current')
hm2AgentSwitchIpSourceRoutingMode = MibScalar((1, 3, 6, 1, 4, 1, 248, 12, 2, 2, 253), HmEnabledStatus().clone('disable')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2AgentSwitchIpSourceRoutingMode.setStatus('current')
...
hm2AgentOspfRouteRedistTag = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 12, 2, 4, 8, 1, 6), Unsigned32()).setMaxAccess("readwrite")
...
hm2AgentVrrpExtCfgPriority = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 12, 2, 260, 2, 1, 8), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 254)).clone(100)).setMaxAccess("readwrite")
...
hm2AgentVrrpExtProxyarp = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 12, 2, 260, 2, 1, 14), TruthValue().clone('false')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: hm2AgentVrrpExtProxyarp.setStatus('current')
...
hm2AgentVlanUnawareRoutingErrorReturn = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 41))
if mibBuilder.loadTexts: hm2AgentVlanUnawareRoutingErrorReturn.setStatus('current')
hm2AgentRoutingInvalidNetworkAddress = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 42))
if mibBuilder.loadTexts: hm2AgentRoutingInvalidNetworkAddress.setStatus('current')
hm2AgentRoutingTypeInvalidValue = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 43))
if mibBuilder.loadTexts: hm2AgentRoutingTypeInvalidValue.setStatus('current')
hm2AgentRoutingLocalRoutePreference = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 44))
if mibBuilder.loadTexts: hm2AgentRoutingLocalRoutePreference.setStatus('current')
hm2AgentRoutingMetricInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 45))
if mibBuilder.loadTexts: hm2AgentRoutingMetricInvalid.setStatus('current')
hm2AgentRoutingMetricNotSupported = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 46))
if mibBuilder.loadTexts: hm2AgentRoutingMetricNotSupported.setStatus('current')
hm2AgentRoutingNexthopAtLocalInterface = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 47))
if mibBuilder.loadTexts: hm2AgentRoutingNexthopAtLocalInterface.setStatus('current')
hm2AgentRoutingNexthopInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 48))
if mibBuilder.loadTexts: hm2AgentRoutingNexthopInvalid.setStatus('current')
hm2AgentRoutingMaxEntryCountReached = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 49))
if mibBuilder.loadTexts: hm2AgentRoutingMaxEntryCountReached.setStatus('current')
hm2AgentRoutingNoPreferenceUpdate = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 50))
if mibBuilder.loadTexts: hm2AgentRoutingNoPreferenceUpdate.setStatus('current')
hm2AgentRoutingPortInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 51))
if mibBuilder.loadTexts: hm2AgentRoutingPortInvalid.setStatus('current')
hm2AgentRoutingStaticRoutePreference = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 52))
if mibBuilder.loadTexts: hm2AgentRoutingStaticRoutePreference.setStatus('current')
hm2AgentRoutingSameNetworkAddrErrorReturn = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 53))
if mibBuilder.loadTexts: hm2AgentRoutingSameNetworkAddrErrorReturn.setStatus('current')
hm2AgentRoutingTypeInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 54))
if mibBuilder.loadTexts: hm2AgentRoutingTypeInvalid.setStatus('current')
hm2AgentRoutingMacAddressInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 55))
if mibBuilder.loadTexts: hm2AgentRoutingMacAddressInvalid.setStatus('current')
hm2AgentRoutingIPAddressExist = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 56))
if mibBuilder.loadTexts: hm2AgentRoutingIPAddressExist.setStatus('current')
hm2AgentRoutingPingPortInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 57))
if mibBuilder.loadTexts: hm2AgentRoutingPingPortInvalid.setStatus('current')
hm2AgentRoutingIntervalTimeInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 58))
if mibBuilder.loadTexts: hm2AgentRoutingIntervalTimeInvalid.setStatus('current')
hm2AgentRoutingPingLoseTimeInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 59))
if mibBuilder.loadTexts: hm2AgentRoutingPingLoseTimeInvalid.setStatus('current')
hm2AgentRoutingPingReceiveTimeInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 60))
if mibBuilder.loadTexts: hm2AgentRoutingPingReceiveTimeInvalid.setStatus('current')
hm2AgentRoutingPingTimeoutInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 61))
if mibBuilder.loadTexts: hm2AgentRoutingPingTimeoutInvalid.setStatus('current')
hm2AgentRoutingPingTTLInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 62))
if mibBuilder.loadTexts: hm2AgentRoutingPingTTLInvalid.setStatus('current')
hm2AgentRoutingLogicalOperandInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 63))
if mibBuilder.loadTexts: hm2AgentRoutingLogicalOperandInvalid.setStatus('current')
hm2AgentRoutingOperatorInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 64))
if mibBuilder.loadTexts: hm2AgentRoutingOperatorInvalid.setStatus('current')
hm2AgentRoutingLinkDelayInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 65))
if mibBuilder.loadTexts: hm2AgentRoutingLinkDelayInvalid.setStatus('current')
hm2AgentRoutingL3RelayFunctionInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 66))
if mibBuilder.loadTexts: hm2AgentRoutingL3RelayFunctionInvalid.setStatus('current')
hm2AgentRoutingBootpDhcpHopsInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 67))
if mibBuilder.loadTexts: hm2AgentRoutingBootpDhcpHopsInvalid.setStatus('current')
hm2AgentRoutingBootpDhcpWaitTimeInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 68))
if mibBuilder.loadTexts: hm2AgentRoutingBootpDhcpWaitTimeInvalid.setStatus('current')
hm2AgentRoutingCircuitIDInvalid = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 69))
if mibBuilder.loadTexts: hm2AgentRoutingCircuitIDInvalid.setStatus('current')
hm2AgentRoutingTrackTypeEnableError = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 70))
if mibBuilder.loadTexts: hm2AgentRoutingTrackTypeEnableError.setStatus('current')
hm2AgentRoutingTrackingEnableErrorReturn = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 71))
if mibBuilder.loadTexts: hm2AgentRoutingTrackingEnableErrorReturn.setStatus('current')
hm2AgentRoutingTrackingDisableErrorReturn = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 72))
if mibBuilder.loadTexts: hm2AgentRoutingTrackingDisableErrorReturn.setStatus('current')
hm2AgentRoutingTrackTypeDisableError = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 73))
if mibBuilder.loadTexts: hm2AgentRoutingTrackTypeDisableError.setStatus('current')
hm2AgentRoutingTrackIDCreateError = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 74))
if mibBuilder.loadTexts: hm2AgentRoutingTrackIDCreateError.setStatus('current')
hm2AgentRoutingTrackTypeCreateError = ObjectIdentity((1, 3, 6, 1, 4, 1, 248, 12, 2, 280, 75))
if mibBuilder.loadTexts: hm2AgentRoutingTrackTypeCreateError.setStatus('current')
mibBuilder.exportSymbols("HM2-PLATFORM-ROUTING-MIB", hm2AgentOspfRouteCost=hm2AgentOspfRouteCost, hm2AgentVrrpDomainOperPriority=hm2AgentVrrpDomainOperPriority, hm2AgentOspfAreaNSSADefaultMetricType=hm2AgentOspfAreaNSSADefaultMetricType, hm2AgentSwitchInternalVlanTable=hm2AgentSwitchInternalVlanTable, hm2AgentUdpClientMsgsReceived=hm2AgentUdpClientMsgsReceived, hm2AgentIpHelperInvalidUdpPortErrorReturn=hm2AgentIpHelperInvalidUdpPortErrorReturn, hm2AgentSwitchDhcpOperation=hm2AgentSwitchDhcpOperation, hm2AgentOspfNbrTable=hm2AgentOspfNbrTable, hm2AgentOspfRoutePrefExternal=hm2AgentOspfRoutePrefExternal, hm2AgentRoutingHeapGroup=hm2AgentRoutingHeapGroup, hm2AgentDynamicNeighbourTable=hm2AgentDynamicNeighbourTable, hm2AgentSwitchIpInterfaceClearIp=hm2AgentSwitchIpInterfaceClearIp, hm2AgentVrrpExtDomainStatus=hm2AgentVrrpExtDomainStatus, hm2AgentRoutingPingTTLInvalid=hm2AgentRoutingPingTTLInvalid, hm2AgentUniqueNextHops=hm2AgentUniqueNextHops, hm2AgentOspfCountersCleared=hm2AgentOspfCountersCleared, hm2AgentInternalVlanBase=hm2AgentInternalVlanBase, hm2AgentSwitchIpIcmpRateLimitBurstSize=hm2AgentSwitchIpIcmpRateLimitBurstSize, hm2AgentRoutingMetricNotSupported=hm2AgentRoutingMetricNotSupported, hm2AgentRipRouteRedistTable=hm2AgentRipRouteRedistTable, hm2AgentOspfRouteRedistEntry=hm2AgentOspfRouteRedistEntry, hm2AgentOspfLsAckTx=hm2AgentOspfLsAckTx, hm2AgentOspfRouteRedistMetric=hm2AgentOspfRouteRedistMetric, hm2AgentOspfLocalLsdbTable=hm2AgentOspfLocalLsdbTable, hm2AgentOspfRoutes=hm2AgentOspfRoutes, hm2AgentOspfLsReqRx=hm2AgentOspfLsReqRx, hm2AgentSwitchIpInterfaceBandwidth=hm2AgentSwitchIpInterfaceBandwidth, hm2AgentSwitchIpStaticDefaultPref=hm2AgentSwitchIpStaticDefaultPref, hm2AgentSwitchIpRouterDiscLifeTimeMaxAdvIntErrorRtrn=hm2AgentSwitchIpRouterDiscLifeTimeMaxAdvIntErrorRtrn, hm2AgentUdpClientMsgsTtlExpired=hm2AgentUdpClientMsgsTtlExpired, hm2AgentSwitchIpIcmpRedirectsMode=hm2AgentSwitchIpIcmpRedirectsMode, hm2AgentOspfRouteRedistMetricConfigured=hm2AgentOspfRouteRedistMetricConfigured, hm2AgentSwitchIpGroup=hm2AgentSwitchIpGroup, hm2AgentRipRouteRedistMetric=hm2AgentRipRouteRedistMetric, hm2AgentSwitchLocalProxyArpTable=hm2AgentSwitchLocalProxyArpTable, hm2AgentRouterOspfVirtNbrTableFullErrorReturn=hm2AgentRouterOspfVirtNbrTableFullErrorReturn, hm2AgentOspfAreaNSSAImportSummaries=hm2AgentOspfAreaNSSAImportSummaries, hm2AgentRipRouteRedistMatchInternal=hm2AgentRipRouteRedistMatchInternal, hm2AgentRouterVrrpAdminState=hm2AgentRouterVrrpAdminState, hm2AgentDynamicNeighbourAddress=hm2AgentDynamicNeighbourAddress, hm2AgentRoutingPingLoseTimeInvalid=hm2AgentRoutingPingLoseTimeInvalid, hm2AgentSwitchIpRouterDiscoveryMinAdvertisementInterval=hm2AgentSwitchIpRouterDiscoveryMinAdvertisementInterval, hm2AgentOspfVirtIfEntry=hm2AgentOspfVirtIfEntry, hm2AgentEcmpGroups=hm2AgentEcmpGroups, hm2AgentOspfQueueGroup=hm2AgentOspfQueueGroup, hm2AgentOspfIfFastHelloMode=hm2AgentOspfIfFastHelloMode, hm2AgentRouterOspfMaxAreaErrorReturn=hm2AgentRouterOspfMaxAreaErrorReturn, hm2AgentSwitchIpHelperUdpPort=hm2AgentSwitchIpHelperUdpPort, hm2AgentVrrpExtMethod=hm2AgentVrrpExtMethod, hm2AgentOspfType2LsasRx=hm2AgentOspfType2LsasRx, hm2AgentOspfAsLsdbAdvertisement=hm2AgentOspfAsLsdbAdvertisement, hm2AgentReservedLocals=hm2AgentReservedLocals, hm2AgentSwitchIpVlanRoutingStatus=hm2AgentSwitchIpVlanRoutingStatus, hm2AgentLocalBgpRoutes=hm2AgentLocalBgpRoutes, hm2AgentOspfStubRouterStartupTimeRemaining=hm2AgentOspfStubRouterStartupTimeRemaining, hm2AgentVrrpExtVrid=hm2AgentVrrpExtVrid, hm2AgentOspfSpfStatsReason=hm2AgentOspfSpfStatsReason, hm2AgentSwitchIpInterfaceEntry=hm2AgentSwitchIpInterfaceEntry, hm2AgentRoutingSNMPExtensionGroup=hm2AgentRoutingSNMPExtensionGroup, hm2AgentSwitchSecondaryAddressTable=hm2AgentSwitchSecondaryAddressTable, hm2AgentOspfRouteRedistDistList=hm2AgentOspfRouteRedistDistList, hm2AgentSwitchIpRouterDiscoveryMaxAdvertisementInterval=hm2AgentSwitchIpRouterDiscoveryMaxAdvertisementInterval, hm2AgentOspfAreaOpaqueLsdbEntry=hm2AgentOspfAreaOpaqueLsdbEntry, hm2AgentOspfOpaqueLsaSupport=hm2AgentOspfOpaqueLsaSupport, hm2AgentSwitchIntfArpAge=hm2AgentSwitchIntfArpAge, hm2AgentRoutingIPAddressExist=hm2AgentRoutingIPAddressExist, hm2AgentRouterVrrpNumberOfFastInst=hm2AgentRouterVrrpNumberOfFastInst, hm2AgentSwitchIpRouterDiscoveryEntry=hm2AgentSwitchIpRouterDiscoveryEntry, hm2AgentVrrpExtPreemptionDelay=hm2AgentVrrpExtPreemptionDelay, hm2AgentRoutingIntervalTimeInvalid=hm2AgentRoutingIntervalTimeInvalid, hm2AgentOspfSpfStatsDeltaT=hm2AgentOspfSpfStatsDeltaT, hm2AgentVrrpExtAdvertAddress=hm2AgentVrrpExtAdvertAddress, hm2AgentOspfRoutePrefIntraArea=hm2AgentOspfRoutePrefIntraArea, hm2AgentOspfRouteRedistTag=hm2AgentOspfRouteRedistTag, hm2AgentSwitchIntfArpMacAddress=hm2AgentSwitchIntfArpMacAddress, hm2AgentSwitchIpVlanEntry=hm2AgentSwitchIpVlanEntry, hm2AgentSwitchIntfArpType=hm2AgentSwitchIntfArpType, hm2AgentVrrpAssoIpAddrRowStatusInconsistentAddress=hm2AgentVrrpAssoIpAddrRowStatusInconsistentAddress, hm2AgentOspfStubRouterDuration=hm2AgentOspfStubRouterDuration, hm2AgentSwitchIpVlanTable=hm2AgentSwitchIpVlanTable, hm2AgentSwitchIntfIpHelperAddressTable=hm2AgentSwitchIntfIpHelperAddressTable, hm2AgentRoutingNexthopAtLocalInterface=hm2AgentRoutingNexthopAtLocalInterface, hm2AgentRipRouteRedistDistListConfigured=hm2AgentRipRouteRedistDistListConfigured, hm2AgentSecondaryAddrNoPrimaryErrorReturn=hm2AgentSecondaryAddrNoPrimaryErrorReturn, hm2AgentUdpClientMsgsDiscarded=hm2AgentUdpClientMsgsDiscarded, hm2AgentRoutingMacAddressInvalid=hm2AgentRoutingMacAddressInvalid, hm2AgentSwitchIpHelperAddressEntry=hm2AgentSwitchIpHelperAddressEntry, hm2AgentOspfType9LsasRx=hm2AgentOspfType9LsasRx, hm2AgentOspfSpfStatsSumm=hm2AgentOspfSpfStatsSumm, hm2AgentOspfType4LsasRx=hm2AgentOspfType4LsasRx, hm2AgentOspfSpfStatsEntry=hm2AgentOspfSpfStatsEntry, hm2AgentVrrpDomainTable=hm2AgentVrrpDomainTable, hm2AgentOspfIfPassiveMode=hm2AgentOspfIfPassiveMode, hm2AgentOspfExt1Routes=hm2AgentOspfExt1Routes, hm2AgentRoutingNoPreferenceUpdate=hm2AgentRoutingNoPreferenceUpdate, hm2AgentOspfSpfIndex=hm2AgentOspfSpfIndex, hm2AgentOspfQueueTable=hm2AgentOspfQueueTable, hm2AgentVrrpExtNotifyAddress=hm2AgentVrrpExtNotifyAddress, hm2AgentRipRouteRedistMatchNSSAExternal1=hm2AgentRipRouteRedistMatchNSSAExternal1, hm2AgentOspfAsLsdbLsid=hm2AgentOspfAsLsdbLsid, hm2AgentOspfLsAckRx=hm2AgentOspfLsAckRx, hm2AgentOspfSpfHoldTime=hm2AgentOspfSpfHoldTime, hm2AgentPrimaryAddrNetworkConflictErrorReturn=hm2AgentPrimaryAddrNetworkConflictErrorReturn, hm2AgentNeighbourGroup=hm2AgentNeighbourGroup, hm2AgentOspfRouteRedistSource=hm2AgentOspfRouteRedistSource, hm2AgentRoutingOperatorInvalid=hm2AgentRoutingOperatorInvalid, PYSNMP_MODULE_ID=hm2PlatformRouting, hm2AgentBootpDhcpRelayMaxHopCount=hm2AgentBootpDhcpRelayMaxHopCount, hm2AgentSwitchIpFirstActiveAddress=hm2AgentSwitchIpFirstActiveAddress, hm2AgentSwitchIpRouteCount=hm2AgentSwitchIpRouteCount, hm2AgentEcmpCountTable=hm2AgentEcmpCountTable, hm2AgentPrimaryAddrConflictErrorReturn=hm2AgentPrimaryAddrConflictErrorReturn, hm2AgentSwitchIpIcmpEchoReplyMode=hm2AgentSwitchIpIcmpEchoReplyMode, hm2AgentSwitchArpCacheSize=hm2AgentSwitchArpCacheSize, hm2AgentOspfLsUpdatesRxMax=hm2AgentOspfLsUpdatesRxMax, hm2AgentSwitchIpInterfaceNetMask=hm2AgentSwitchIpInterfaceNetMask, hm2AgentOspfQueueHigh=hm2AgentOspfQueueHigh, hm2AgentDhcpClientMsgsRelayed=hm2AgentDhcpClientMsgsRelayed, hm2AgentDhcpServerMsgsRelayed=hm2AgentDhcpServerMsgsRelayed, hm2AgentSwitchIntfIpHelperHitCount=hm2AgentSwitchIntfIpHelperHitCount, hm2AgentEcmpNextHopCount=hm2AgentEcmpNextHopCount, hm2AgentVrrpExtCfgPriority=hm2AgentVrrpExtCfgPriority, hm2AgentInvalidRouteAdds=hm2AgentInvalidRouteAdds, hm2AgentOspfInterRoutes=hm2AgentOspfInterRoutes, hm2AgentDhcpServerMsgsReceived=hm2AgentDhcpServerMsgsReceived, hm2AgentOspfRedistDistList=hm2AgentOspfRedistDistList, hm2AgentVrrpTrackDecrement=hm2AgentVrrpTrackDecrement, hm2AgentOspfLocalLsdbType=hm2AgentOspfLocalLsdbType, hm2AgentVrrpDomainEntry=hm2AgentVrrpDomainEntry, hm2AgentOspfNbrEntry=hm2AgentOspfNbrEntry, hm2AgentVrrpTrackIfIndex=hm2AgentVrrpTrackIfIndex, hm2AgentIbgpRoutes=hm2AgentIbgpRoutes, hm2AgentRouterRipRoutePref=hm2AgentRouterRipRoutePref, hm2AgentSwitchIpHelperAddress=hm2AgentSwitchIpHelperAddress, hm2AgentVrrpDomainId=hm2AgentVrrpDomainId, hm2AgentSwitchIpInterfaceReUseTime=hm2AgentSwitchIpInterfaceReUseTime, hm2AgentSwitchIpVlanId=hm2AgentSwitchIpVlanId, hm2AgentUdpClientMsgsRelayed=hm2AgentUdpClientMsgsRelayed, hm2AgentSwitchIpRouterDiscMinMaxAdvtIntErrorRtrn=hm2AgentSwitchIpRouterDiscMinMaxAdvtIntErrorRtrn, hm2AgentSwitchIpRouterDiscoveryIfIndex=hm2AgentSwitchIpRouterDiscoveryIfIndex, hm2AgentOspfIfTable=hm2AgentOspfIfTable, hm2AgentOspfLocalLsdbRouterId=hm2AgentOspfLocalLsdbRouterId, hm2AgentOspfIfMetricTable=hm2AgentOspfIfMetricTable, hm2AgentLocalArpDeleteErrorReturn=hm2AgentLocalArpDeleteErrorReturn, hm2AgentTotalRoutes=hm2AgentTotalRoutes, hm2AgentECMPOspfMaxPaths=hm2AgentECMPOspfMaxPaths, hm2AgentSwitchIntfArpEntry=hm2AgentSwitchIntfArpEntry, hm2AgentSecondaryAddrStaticARPErrorReturn=hm2AgentSecondaryAddrStaticARPErrorReturn, hm2AgentRipRouteRedistMatchExternal2=hm2AgentRipRouteRedistMatchExternal2, hm2AgentRoutingTrackingDisableErrorReturn=hm2AgentRoutingTrackingDisableErrorReturn, hm2AgentOspfLocalLsdbSequence=hm2AgentOspfLocalLsdbSequence, hm2AgentOspfDefaultInfoOriginateMetricType=hm2AgentOspfDefaultInfoOriginateMetricType, hm2AgentDynamicNeighbourAction=hm2AgentDynamicNeighbourAction, hm2AgentOspfRouteRedistMode=hm2AgentOspfRouteRedistMode, hm2AgentRoutingTrackTypeEnableError=hm2AgentRoutingTrackTypeEnableError, hm2AgentOspfAreaNSSADefaultInfoOriginate=hm2AgentOspfAreaNSSADefaultInfoOriginate, hm2AgentRipRouteRedistEntry=hm2AgentRipRouteRedistEntry, hm2AgentVrrpTrackVrid=hm2AgentVrrpTrackVrid, hm2AgentSwitchIpInterfaceRoutingMode=hm2AgentSwitchIpInterfaceRoutingMode, hm2AgentSwitchIpHelperStatus=hm2AgentSwitchIpHelperStatus, hm2AgentSwitchArpCacheClear=hm2AgentSwitchArpCacheClear, hm2AgentOspfSpfStatsRibUpdate=hm2AgentOspfSpfStatsRibUpdate, hm2AgentRouterOspfConfigGroup=hm2AgentRouterOspfConfigGroup, hm2AgentRouterRipAutoSummaryMode=hm2AgentRouterRipAutoSummaryMode, hm2AgentOspfType5LsasRx=hm2AgentOspfType5LsasRx, hm2AgentSwitchIpInterfaceTable=hm2AgentSwitchIpInterfaceTable, hm2AgentFailedRouteAdds=hm2AgentFailedRouteAdds, hm2AgentSwitchArpResponseTime=hm2AgentSwitchArpResponseTime, hm2AgentVlanUnawareRoutingErrorReturn=hm2AgentVlanUnawareRoutingErrorReturn, hm2AgentSwitchIpRouterDiscoveryTable=hm2AgentSwitchIpRouterDiscoveryTable, hm2AgentOspfRouteNet=hm2AgentOspfRouteNet, hm2AgentSnmpTrapFlagsConfigGroupLayer3=hm2AgentSnmpTrapFlagsConfigGroupLayer3, hm2AgentSwitchArpStaticEntryCountMax=hm2AgentSwitchArpStaticEntryCountMax, hm2AgentRoutingCircuitIDInvalid=hm2AgentRoutingCircuitIDInvalid, hm2AgentNextHopGroupsHigh=hm2AgentNextHopGroupsHigh, hm2AgentOspfAsLsdbChecksum=hm2AgentOspfAsLsdbChecksum, hm2AgentSwitchArpMaxRetries=hm2AgentSwitchArpMaxRetries, hm2AgentOspfType3LsasRx=hm2AgentOspfType3LsasRx, hm2AgentOspfLsUpdatesTxMax=hm2AgentOspfLsUpdatesTxMax, hm2AgentIpHelperGroup=hm2AgentIpHelperGroup, hm2AgentSwitchProxyArpMaxResponseDelay=hm2AgentSwitchProxyArpMaxResponseDelay, hm2AgentDynamicVlanRoutingErrorReturn=hm2AgentDynamicVlanRoutingErrorReturn, hm2AgentSwitchSecondaryIpAddress=hm2AgentSwitchSecondaryIpAddress, hm2AgentRoutingTrackIDCreateError=hm2AgentRoutingTrackIDCreateError, hm2AgentSwitchSecondaryNetMask=hm2AgentSwitchSecondaryNetMask, hm2AgentSecondaryAddrDifferentPrimaryErrorReturn=hm2AgentSecondaryAddrDifferentPrimaryErrorReturn, hm2PlatformRouting=hm2PlatformRouting, hm2AgentOspfIfAuthKeyId=hm2AgentOspfIfAuthKeyId, hm2AgentOspfLocalLsdbEntry=hm2AgentOspfLocalLsdbEntry, hm2AgentDynamicNeighbourIfIndex=hm2AgentDynamicNeighbourIfIndex, hm2AgentSwitchIpFirstActiveAddressType=hm2AgentSwitchIpFirstActiveAddressType, hm2AgentOspfDefaultMetric=hm2AgentOspfDefaultMetric, hm2AgentSwitchIpInterfaceUnnumberedIfIndex=hm2AgentSwitchIpInterfaceUnnumberedIfIndex, hm2AgentStaticNeighbourTableFullErrorReturn=hm2AgentStaticNeighbourTableFullErrorReturn, hm2AgentPrimaryAddrStaticRouteErrorReturn=hm2AgentPrimaryAddrStaticRouteErrorReturn, hm2AgentVrrpDomainSupervisorOperState=hm2AgentVrrpDomainSupervisorOperState, hm2AgentRoutingTypeInvalidValue=hm2AgentRoutingTypeInvalidValue, hm2AgentOspfQueueName=hm2AgentOspfQueueName, hm2AgentSwitchIpInterfaceIfIndex=hm2AgentSwitchIpInterfaceIfIndex, hm2AgentOspfAreaOpaqueLsdbAdvertisement=hm2AgentOspfAreaOpaqueLsdbAdvertisement, hm2AgentOspfDefaultInfoOriginateMetricConfigured=hm2AgentOspfDefaultInfoOriginateMetricConfigured, hm2AgentSecondaryAddrWrongSubnetErrorReturn=hm2AgentSecondaryAddrWrongSubnetErrorReturn, hm2AgentRouteDeletes=hm2AgentRouteDeletes, hm2AgentSwitchIntfArpIfIndex=hm2AgentSwitchIntfArpIfIndex, hm2AgentOspfLsReqTx=hm2AgentOspfLsReqTx, hm2AgentStaticNeighbourTable=hm2AgentStaticNeighbourTable, hm2AgentSwitchIntfIpHelperStatus=hm2AgentSwitchIntfIpHelperStatus, hm2AgentSwitchInternalVlanId=hm2AgentSwitchInternalVlanId, hm2AgentVrrpExtEntry=hm2AgentVrrpExtEntry, hm2AgentSamePrefRouteErrorReturn=hm2AgentSamePrefRouteErrorReturn, hm2AgentStaticNeighbourEntry=hm2AgentStaticNeighbourEntry, hm2AgentOspfRouteMask=hm2AgentOspfRouteMask, hm2AgentOspfStubRouterGroup=hm2AgentOspfStubRouterGroup, hm2AgentVrrpPrimaryVirtualAddress=hm2AgentVrrpPrimaryVirtualAddress, hm2AgentOspfLocalLsdbAddressLessIf=hm2AgentOspfLocalLsdbAddressLessIf, hm2AgentSwitchIPAddressConfigMethod=hm2AgentSwitchIPAddressConfigMethod, hm2AgentRipRouteRedistMode=hm2AgentRipRouteRedistMode, hm2AgentSwitchIpSourceRoutingMode=hm2AgentSwitchIpSourceRoutingMode, hm2AgentOspfType1LsasRx=hm2AgentOspfType1LsasRx, hm2AgentBestRoutes=hm2AgentBestRoutes, hm2AgentOspfStubRouterReason=hm2AgentOspfStubRouterReason, hm2AgentSwitchIpRouterDiscoveryPreferenceLevel=hm2AgentSwitchIpRouterDiscoveryPreferenceLevel, hm2AgentOspfQueueEntry=hm2AgentOspfQueueEntry, hm2AgentSwitchIpVlanIfIndex=hm2AgentSwitchIpVlanIfIndex, hm2AgentVrrpExtGroup=hm2AgentVrrpExtGroup, hm2AgentSwitchIpRouterDiscoveryAdvertisementLifetime=hm2AgentSwitchIpRouterDiscoveryAdvertisementLifetime, hm2AgentOspfType10LsasRx=hm2AgentOspfType10LsasRx, hm2AgentOspfDefaultMetricConfigured=hm2AgentOspfDefaultMetricConfigured, hm2AgentVrrpAssoIpAddrRowStatusUnknownVRID=hm2AgentVrrpAssoIpAddrRowStatusUnknownVRID, hm2AgentRoutingL3RelayFunctionInvalid=hm2AgentRoutingL3RelayFunctionInvalid, hm2AgentSwitchIpIcmpControlGroup=hm2AgentSwitchIpIcmpControlGroup, hm2AgentSwitchIpRouterDiscoveryAdvertisementAddress=hm2AgentSwitchIpRouterDiscoveryAdvertisementAddress, hm2AgentSecondaryAddrStaticRouteErrorReturn=hm2AgentSecondaryAddrStaticRouteErrorReturn, hm2AgentOspfVirtIfAuthKeyId=hm2AgentOspfVirtIfAuthKeyId, hm2AgentOspfDdRx=hm2AgentOspfDdRx, hm2AgentOspfDefaultPassiveMode=hm2AgentOspfDefaultPassiveMode, hm2AgentSwitchIpIcmpRateLimitInterval=hm2AgentSwitchIpIcmpRateLimitInterval, hm2AgentRipRouteRedistMetricConfigured=hm2AgentRipRouteRedistMetricConfigured, hm2AgentSwitchArpGroup=hm2AgentSwitchArpGroup, hm2AgentStaticRoutes=hm2AgentStaticRoutes, hm2AgentSwitchIpHelperHitCount=hm2AgentSwitchIpHelperHitCount, hm2AgentBestRoutesHigh=hm2AgentBestRoutesHigh, hm2AgentOspfLocalLsdbAge=hm2AgentOspfLocalLsdbAge, hm2AgentSwitchSecondaryStatus=hm2AgentSwitchSecondaryStatus, hm2AgentEbgpRoutes=hm2AgentEbgpRoutes, hm2AgentOspfRoutePrefInterArea=hm2AgentOspfRoutePrefInterArea, hm2AgentRoutingStaticRoutePreference=hm2AgentRoutingStaticRoutePreference, hm2AgentRoutingPortInvalid=hm2AgentRoutingPortInvalid, hm2AgentInternalVlanGroup=hm2AgentInternalVlanGroup, hm2AgentRouterRIPDependenciesNotMet=hm2AgentRouterRIPDependenciesNotMet, hm2AgentRoutingPingTimeoutInvalid=hm2AgentRoutingPingTimeoutInvalid, hm2AgentOspfRouteRedistSubnets=hm2AgentOspfRouteRedistSubnets, hm2AgentSwitchInternalVlanEntry=hm2AgentSwitchInternalVlanEntry, hm2AgentOspfRouteEntry=hm2AgentOspfRouteEntry)
mibBuilder.exportSymbols("HM2-PLATFORM-ROUTING-MIB", hm2AgentOspfExt2Routes=hm2AgentOspfExt2Routes, hm2AgentRouterRipHostRoutesAcceptMode=hm2AgentRouterRipHostRoutesAcceptMode, hm2AgentVrrpDomainStatus=hm2AgentVrrpDomainStatus, hm2AgentSwitchArpAgeoutTime=hm2AgentSwitchArpAgeoutTime, hm2AgentOspfSpfStatsSpfTotal=hm2AgentOspfSpfStatsSpfTotal, hm2AgentDhcpClientMsgsReceived=hm2AgentDhcpClientMsgsReceived, hm2AgentOspfType11LsasRx=hm2AgentOspfType11LsasRx, hm2AgentOspfHellosRx=hm2AgentOspfHellosRx, hm2AgentOspfAutoCostRefBw=hm2AgentOspfAutoCostRefBw, hm2AgentOspfAreaNSSATable=hm2AgentOspfAreaNSSATable, hm2AgentRouterVrrpOperEntry=hm2AgentRouterVrrpOperEntry, hm2AgentSecondaryAddrWrongIpClassErrorReturn=hm2AgentSecondaryAddrWrongIpClassErrorReturn, hm2AgentIpHelperAdminMode=hm2AgentIpHelperAdminMode, hm2AgentOspfLocalLsdbIpAddress=hm2AgentOspfLocalLsdbIpAddress, hm2AgentOspfHellosTx=hm2AgentOspfHellosTx, hm2AgentSwitchArpDynamicRenew=hm2AgentSwitchArpDynamicRenew, hm2AgentBootpDhcpRelayMinWaitTime=hm2AgentBootpDhcpRelayMinWaitTime, hm2AgentOspfAreaOpaqueLsdbLsid=hm2AgentOspfAreaOpaqueLsdbLsid, hm2AgentStaticNeighbourPhysAddress=hm2AgentStaticNeighbourPhysAddress, hm2AgentRoutingHeapInUse=hm2AgentRoutingHeapInUse, hm2AgentIpHelperInvalidServerAddrErrorReturn=hm2AgentIpHelperInvalidServerAddrErrorReturn, hm2AgentVrrpExtDomainRole=hm2AgentVrrpExtDomainRole, hm2AgentSwitchLocalProxyArpEntry=hm2AgentSwitchLocalProxyArpEntry, hm2AgentOspfAreaOpaqueLsdbChecksum=hm2AgentOspfAreaOpaqueLsdbChecksum, hm2AgentOspfSpfStatsIntra=hm2AgentOspfSpfStatsIntra, hm2AgentSwitchIpInterfaceIpAddress=hm2AgentSwitchIpInterfaceIpAddress, hm2AgentOspfAreaNSSAEntry=hm2AgentOspfAreaNSSAEntry, hm2AgentOspfRouteRedistDistListConfigured=hm2AgentOspfRouteRedistDistListConfigured, hm2AgentVrrpExtAdvertTimer=hm2AgentVrrpExtAdvertTimer, hm2AgentRouterRipAdminState=hm2AgentRouterRipAdminState, hm2AgentOspfIfIpMtuIgnoreFlag=hm2AgentOspfIfIpMtuIgnoreFlag, hm2AgentVrrpExtDomainId=hm2AgentVrrpExtDomainId, hm2AgentSwitchIntfIpHelperUdpPort=hm2AgentSwitchIntfIpHelperUdpPort, hm2AgentOspfLsUpdatesTx=hm2AgentOspfLsUpdatesTx, hm2AgentDynamicNeighbourPhysAddress=hm2AgentDynamicNeighbourPhysAddress, hm2AgentSwitchIpInterfaceIcmpUnreachables=hm2AgentSwitchIpInterfaceIcmpUnreachables, hm2AgentSwitchClearIpDefaultGateway=hm2AgentSwitchClearIpDefaultGateway, hm2AgentVrrpOperations=hm2AgentVrrpOperations, hm2AgentRipRouteRedistMatchNSSAExternal2=hm2AgentRipRouteRedistMatchNSSAExternal2, hm2AgentRouterOspfDependenciesNotMet=hm2AgentRouterOspfDependenciesNotMet, hm2AgentRouterRipConfigGroup=hm2AgentRouterRipConfigGroup, hm2AgentSnmpVRRPAuthFailureTrapFlag=hm2AgentSnmpVRRPAuthFailureTrapFlag, hm2AgentOspfRouteRedistMetricType=hm2AgentOspfRouteRedistMetricType, hm2AgentOspfRouteTable=hm2AgentOspfRouteTable, hm2AgentOspfSpfDelayTime=hm2AgentOspfSpfDelayTime, hm2AgentRoutingTableSummaryGroup=hm2AgentRoutingTableSummaryGroup, hm2AgentPrimaryAddrStaticARPErrorReturn=hm2AgentPrimaryAddrStaticARPErrorReturn, hm2AgentInternalVlanPolicy=hm2AgentInternalVlanPolicy, hm2AgentOspfAreaOpaqueLsdbType=hm2AgentOspfAreaOpaqueLsdbType, hm2AgentSwitchIpDefaultGateway=hm2AgentSwitchIpDefaultGateway, hm2AgentOspfAreaOpaqueLsdbRouterId=hm2AgentOspfAreaOpaqueLsdbRouterId, hm2AgentOspfLocalLsdbAdvertisement=hm2AgentOspfLocalLsdbAdvertisement, hm2AgentOspfAsLsdbTable=hm2AgentOspfAsLsdbTable, hm2AgentOspfStubRouterAdvertisement=hm2AgentOspfStubRouterAdvertisement, hm2AgentRoutingLinkDelayInvalid=hm2AgentRoutingLinkDelayInvalid, hm2AgentStaticNeighbourIfIndex=hm2AgentStaticNeighbourIfIndex, hm2AgentOspfAreaNSSADefaultMetric=hm2AgentOspfAreaNSSADefaultMetric, hm2AgentSwitchIntfIpHelperAddressEntry=hm2AgentSwitchIntfIpHelperAddressEntry, hm2AgentStaticNeighbourRowStatus=hm2AgentStaticNeighbourRowStatus, hm2AgentSwitchIpInterfaceIcmpRedirects=hm2AgentSwitchIpInterfaceIcmpRedirects, hm2AgentRoutingLocalRoutePreference=hm2AgentRoutingLocalRoutePreference, hm2AgentospfRouterIdChange=hm2AgentospfRouterIdChange, hm2AgentSwitchArpSparseLearn=hm2AgentSwitchArpSparseLearn, hm2AgentUniqueNextHopsHigh=hm2AgentUniqueNextHopsHigh, hm2AgentSnmpVRRPNewMasterTrapFlag=hm2AgentSnmpVRRPNewMasterTrapFlag, hm2AgentRipRouteRedistSource=hm2AgentRipRouteRedistSource, hm2AgentOspfLocalLsdbChecksum=hm2AgentOspfLocalLsdbChecksum, hm2AgentOspfSpfStatsTable=hm2AgentOspfSpfStatsTable, hm2AgentRip2IfConfAuthKeyId=hm2AgentRip2IfConfAuthKeyId, hm2AgentBootpDhcpRelayGroup=hm2AgentBootpDhcpRelayGroup, hm2AgentSwitchIntfArpStatus=hm2AgentSwitchIntfArpStatus, hm2AgentSwitchIpBestRouteCount=hm2AgentSwitchIpBestRouteCount, hm2AgentOspfAsLsdbAge=hm2AgentOspfAsLsdbAge, hm2AgentOspfType7LsasRx=hm2AgentOspfType7LsasRx, hm2AgentRouterRipDefaultInfoOriginate=hm2AgentRouterRipDefaultInfoOriginate, hm2AgentOspfIntraRoutes=hm2AgentOspfIntraRoutes, hm2AgentSwitchInternalVlanIfIndex=hm2AgentSwitchInternalVlanIfIndex, hm2AgentRoutingHeapHigh=hm2AgentRoutingHeapHigh, hm2AgentVrrpExtIfIndex=hm2AgentVrrpExtIfIndex, hm2AgentPrimaryAddrExistingSecondaryErrorReturn=hm2AgentPrimaryAddrExistingSecondaryErrorReturn, hm2AgentVrrpExtTable=hm2AgentVrrpExtTable, hm2AgentUnresolvedRouteAdds=hm2AgentUnresolvedRouteAdds, hm2AgentVrrpExtProxyarp=hm2AgentVrrpExtProxyarp, hm2AgentRouterRipDefaultMetricConfigured=hm2AgentRouterRipDefaultMetricConfigured, hm2AgentSwitchSecondaryAddressEntry=hm2AgentSwitchSecondaryAddressEntry, hm2AgentStaticNeighbourAddressType=hm2AgentStaticNeighbourAddressType, hm2AgentVrrpTrackOperStatus=hm2AgentVrrpTrackOperStatus, hm2AgentSwitchIpInterfaceCurrentPenalty=hm2AgentSwitchIpInterfaceCurrentPenalty, hm2AgentSwitchIpInterfaceNumberOfFlaps=hm2AgentSwitchIpInterfaceNumberOfFlaps, hm2AgentOspfDefaultInfoOriginateAlways=hm2AgentOspfDefaultInfoOriginateAlways, hm2AgentVrrpTrackId=hm2AgentVrrpTrackId, hm2AgentPrimaryAddrWrongIpClassErrorReturn=hm2AgentPrimaryAddrWrongIpClassErrorReturn, hm2AgentDynamicNeighbourAddressType=hm2AgentDynamicNeighbourAddressType, hm2AgentSwitchIpInterfaceMtuValue=hm2AgentSwitchIpInterfaceMtuValue, hm2AgentRoutingMetricInvalid=hm2AgentRoutingMetricInvalid, hm2AgentOspfDefaultAreaDeleteErrorReturn=hm2AgentOspfDefaultAreaDeleteErrorReturn, hm2AgentRouterVrrpOperPriority=hm2AgentRouterVrrpOperPriority, hm2AgentRipRouteRedistMatchExternal1=hm2AgentRipRouteRedistMatchExternal1, hm2AgentEcmpRoutes=hm2AgentEcmpRoutes, hm2AgentOspfSpfStatsExt=hm2AgentOspfSpfStatsExt, hm2AgentVrrpDomainMemberSendAdv=hm2AgentVrrpDomainMemberSendAdv, hm2AgentOspfLocalLsdbLsid=hm2AgentOspfLocalLsdbLsid, hm2AgentSwitchIpRoutingMode=hm2AgentSwitchIpRoutingMode, hm2AgentEcmpCountEntry=hm2AgentEcmpCountEntry, hm2AgentOspfAreaOpaqueLsdbTable=hm2AgentOspfAreaOpaqueLsdbTable, hm2AgentNextHopGroups=hm2AgentNextHopGroups, hm2AgentRip2IfConfEntry=hm2AgentRip2IfConfEntry, hm2AgentRouterRipDefaultMetric=hm2AgentRouterRipDefaultMetric, hm2AgentVrrpDomainSupervisorVrid=hm2AgentVrrpDomainSupervisorVrid, hm2AgentOspfQueueLength=hm2AgentOspfQueueLength, hm2AgentRoutingHeapSize=hm2AgentRoutingHeapSize, hm2AgentRip2IfConfTable=hm2AgentRip2IfConfTable, hm2AgentRoutingTrackTypeDisableError=hm2AgentRoutingTrackTypeDisableError, hm2AgentRoutingInvalidNetworkAddress=hm2AgentRoutingInvalidNetworkAddress, hm2AgentSwitchLocalProxyArpMode=hm2AgentSwitchLocalProxyArpMode, hm2AgentRouterOspfRFC1583CompatibilityMode=hm2AgentRouterOspfRFC1583CompatibilityMode, hm2AgentEcmpGroupsHigh=hm2AgentEcmpGroupsHigh, hm2AgentRoutingLogicalOperandInvalid=hm2AgentRoutingLogicalOperandInvalid, hm2AgentBgpRoutes=hm2AgentBgpRoutes, hm2AgentSecondaryAddrMaxSystemEntriesErrorReturn=hm2AgentSecondaryAddrMaxSystemEntriesErrorReturn, hm2AgentAlternateRoutes=hm2AgentAlternateRoutes, hm2AgentSecondaryAddrMaxIntfEntriesErrorReturn=hm2AgentSecondaryAddrMaxIntfEntriesErrorReturn, hm2AgentEcmpRetries=hm2AgentEcmpRetries, hm2AgentRoutingTypeInvalid=hm2AgentRoutingTypeInvalid, hm2AgentVrrpDomainSupervisorIfIndex=hm2AgentVrrpDomainSupervisorIfIndex, hm2AgentSwitchIpIcmpRateLimitExceedingRatioErrorReturn=hm2AgentSwitchIpIcmpRateLimitExceedingRatioErrorReturn, hm2AgentSwitchArpStaticEntryCountCurrent=hm2AgentSwitchArpStaticEntryCountCurrent, hm2AgentRouterRipUpdateTimerInterval=hm2AgentRouterRipUpdateTimerInterval, hm2AgentVrrpTrackingTable=hm2AgentVrrpTrackingTable, hm2AgentOspfAreaOpaqueLsdbSequence=hm2AgentOspfAreaOpaqueLsdbSequence, hm2AgentSecondaryAddrAbsentEntryErrorReturn=hm2AgentSecondaryAddrAbsentEntryErrorReturn, hm2AgentOspfIfAdvertiseSecondaries=hm2AgentOspfIfAdvertiseSecondaries, hm2AgentOspfLsaRetxCount=hm2AgentOspfLsaRetxCount, hm2AgentOspfAreaOpaqueLsdbAge=hm2AgentOspfAreaOpaqueLsdbAge, hm2AgentRipRouteRedistDistList=hm2AgentRipRouteRedistDistList, hm2AgentSwitchIpHelperAddressTable=hm2AgentSwitchIpHelperAddressTable, hm2AgentOspfRouteRedistTable=hm2AgentOspfRouteRedistTable, hm2AgentRoutingMaxEntryCountReached=hm2AgentRoutingMaxEntryCountReached, hm2AgentOspfRouteProtoType=hm2AgentOspfRouteProtoType, hm2AgentOspfNbrDeadTime=hm2AgentOspfNbrDeadTime, hm2AgentOspfAreaOpaqueLsdbAreaId=hm2AgentOspfAreaOpaqueLsdbAreaId, hm2AgentOspfQueueDrops=hm2AgentOspfQueueDrops, hm2AgentSwitchIpRouterDiscoveryAdvertiseMode=hm2AgentSwitchIpRouterDiscoveryAdvertiseMode, hm2AgentRoutingTrackingEnableErrorReturn=hm2AgentRoutingTrackingEnableErrorReturn, hm2AgentOspfVirtIfTable=hm2AgentOspfVirtIfTable, hm2AgentOspfIfMetricCalculatedCost=hm2AgentOspfIfMetricCalculatedCost, hm2AgentSwitchIpInterfaceNetdirectedBCMode=hm2AgentSwitchIpInterfaceNetdirectedBCMode, hm2AgentRoutingNexthopInvalid=hm2AgentRoutingNexthopInvalid, hm2AgentOspfDdTx=hm2AgentOspfDdTx, hm2AgentDstAddrHostBitSetErrorReturn=hm2AgentDstAddrHostBitSetErrorReturn, hm2AgentSwitchIntfIpHelperIpAddress=hm2AgentSwitchIntfIpHelperIpAddress, hm2AgentVrrpExtNotifyLinkdown=hm2AgentVrrpExtNotifyLinkdown, hm2AgentSwitchIntfArpIpAddress=hm2AgentSwitchIntfArpIpAddress, hm2AgentRoutingBootpDhcpHopsInvalid=hm2AgentRoutingBootpDhcpHopsInvalid, hm2AgentSwitchIntfArpTable=hm2AgentSwitchIntfArpTable, hm2AgentVrrpTrackRowStatus=hm2AgentVrrpTrackRowStatus, hm2AgentStaticNeighbourAddress=hm2AgentStaticNeighbourAddress, hm2AgentRoutingSameNetworkAddrErrorReturn=hm2AgentRoutingSameNetworkAddrErrorReturn, hm2AgentRoutingTrackTypeCreateError=hm2AgentRoutingTrackTypeCreateError, hm2AgentSwitchIpInterfaceProxyARPMode=hm2AgentSwitchIpInterfaceProxyARPMode, hm2AgentPrimaryAddrRoutingTableFullErrorReturn=hm2AgentPrimaryAddrRoutingTableFullErrorReturn, hm2AgentOspfQueueLimit=hm2AgentOspfQueueLimit, hm2AgentIpHelperTableFullErrorReturn=hm2AgentIpHelperTableFullErrorReturn, hm2AgentSwitchIpInterfaceSuppressed=hm2AgentSwitchIpInterfaceSuppressed, hm2AgentConnectedRoutes=hm2AgentConnectedRoutes, hm2AgentRejectRoutes=hm2AgentRejectRoutes, hm2AgentDynamicNeighbourEntry=hm2AgentDynamicNeighbourEntry, hm2AgentOspfQueueIndex=hm2AgentOspfQueueIndex, hm2AgentOspfAsLsdbType=hm2AgentOspfAsLsdbType, hm2AgentOspfDefaultInfoOriginateMetric=hm2AgentOspfDefaultInfoOriginateMetric, hm2AgentRoutingPingPortInvalid=hm2AgentRoutingPingPortInvalid, hm2AgentTruncEcmpRoutes=hm2AgentTruncEcmpRoutes, hm2AgentRouterOspfRangeTableFullErrorReturn=hm2AgentRouterOspfRangeTableFullErrorReturn, hm2AgentOspfAsLsdbRouterId=hm2AgentOspfAsLsdbRouterId, hm2AgentBootpDhcpRelayCircuitIdOptionMode=hm2AgentBootpDhcpRelayCircuitIdOptionMode, hm2AgentOspfLsUpdatesRx=hm2AgentOspfLsUpdatesRx, hm2AgentOspfAsLsdbSequence=hm2AgentOspfAsLsdbSequence, hm2AgentVrrpAssoIpAddrRowStatusInvalidAddress=hm2AgentVrrpAssoIpAddrRowStatusInvalidAddress, hm2AgentOspfAsLsdbEntry=hm2AgentOspfAsLsdbEntry, hm2AgentRoutingPingReceiveTimeInvalid=hm2AgentRoutingPingReceiveTimeInvalid, hm2AgentOspfIfEntry=hm2AgentOspfIfEntry, hm2AgentOspfPacketStatsGroup=hm2AgentOspfPacketStatsGroup, hm2AgentOspfDefaultInfoOriginate=hm2AgentOspfDefaultInfoOriginate, hm2AgentEcmpRouteCount=hm2AgentEcmpRouteCount, hm2AgentRouterVrrpOperTable=hm2AgentRouterVrrpOperTable, hm2AgentOspfAreaNSSARedistribute=hm2AgentOspfAreaNSSARedistribute, hm2AgentOspfIfMetricEntry=hm2AgentOspfIfMetricEntry, hm2AgentECMPGroup=hm2AgentECMPGroup, hm2AgentRouteModifies=hm2AgentRouteModifies, hm2AgentSwitchArpTotalEntryCountCurrent=hm2AgentSwitchArpTotalEntryCountCurrent, hm2AgentRipRoutes=hm2AgentRipRoutes, hm2AgentVrrpTrackingEntry=hm2AgentVrrpTrackingEntry, hm2AgentRouterVrrpConfigGroup=hm2AgentRouterVrrpConfigGroup, hm2AgentRouteAdds=hm2AgentRouteAdds, hm2AgentRouterRipSplitHorizonMode=hm2AgentRouterRipSplitHorizonMode, hm2AgentSwitchArpTotalEntryCountPeak=hm2AgentSwitchArpTotalEntryCountPeak, hm2AgentRoutingBootpDhcpWaitTimeInvalid=hm2AgentRoutingBootpDhcpWaitTimeInvalid)
