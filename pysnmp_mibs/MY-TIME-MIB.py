# SNMP MIB module (MY-TIME-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-TIME-MIB
...
myTimeRangePeriodicEntry.setIndexNames(
    (0, "MY-TIME-MIB", "myTimeRangePeriodicTRName"),
)
if mibBuilder.loadTexts:
...
myTimeMIBGroup.setObjects(
      *(("MY-TIME-MIB", "myClockDateAndTime"),
        ("MY-TIME-MIB", "myClockWeek"))
)
if mibBuilder.loadTexts:
...
myTimeRangeMIBGroup.setObjects(
      *(("MY-TIME-MIB", "myTimeRangePeriodicTRName"),
        ("MY-TIME-MIB", "myTimeRangePeriodicIndex"),
        ("MY-TIME-MIB", "myTimeRangePeriodicType"),
        ("MY-TIME-MIB", "myTimeRangePeriodicMyWeekDay"),
        ("MY-TIME-MIB", "myTimeRangePeriodicEndWeekDay"),
        ("MY-TIME-MIB", "myTimeRangePeriodicTimeOfDayMy"),
        ("MY-TIME-MIB", "myTimeRangePeriodicTimeOfDayEnd"),
        ("MY-TIME-MIB", "myTimeRangePeriodicRowStatus"))
)
if mibBuilder.loadTexts:
...
myTimeMIBCompliance.setObjects(
      *(("MY-TIME-MIB", "myTimeMIBGroup"),
        ("MY-TIME-MIB", "myTimeRangeMIBGroup"))
)
if mibBuilder.loadTexts:
