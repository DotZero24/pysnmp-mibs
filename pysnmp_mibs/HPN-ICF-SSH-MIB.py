...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-SSH-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:35:27 2025
...
class _HpnicfSSHUserPublicKeyName_Type(DisplayString):
    """Custom type hpnicfSSHUserPublicKeyName based on DisplayString"""
    defaultValue = OctetString("")


_HpnicfSSHUserPublicKeyName_Type.__name__ = "DisplayString"
...
class _HpnicfSSHUserWorkDirectory_Type(DisplayString):
    """Custom type hpnicfSSHUserWorkDirectory based on DisplayString"""
    defaultValue = OctetString("")


_HpnicfSSHUserWorkDirectory_Type.__name__ = "DisplayString"
