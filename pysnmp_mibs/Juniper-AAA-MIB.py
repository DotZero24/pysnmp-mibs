...
# Produced by pysmi-1.6.2 at Fri Oct 10 21:06:21 2025
...
_JuniAaaSubscriberProfileSummaryTable_Object = MibTable
juniAaaSubscriberProfileSummaryTable = _JuniAaaSubscriberProfileSummaryTable_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 18)
)
if mibBuilder.loadTexts:
    juniAaaSubscriberProfileSummaryTable.setStatus("current")
_JuniAaaSubscriberProfileSummaryEntry_Object = MibTableRow
juniAaaSubscriberProfileSummaryEntry = _JuniAaaSubscriberProfileSummaryEntry_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 18, 1)
)
juniAaaSubscriberProfileSummaryEntry.setIndexNames(
    (0, "Juniper-AAA-MIB", "juniAaaSubscriberProfileSummaryProfileName"),
)
if mibBuilder.loadTexts:
    juniAaaSubscriberProfileSummaryEntry.setStatus("current")


class _JuniAaaSubscriberProfileSummaryProfileName_Type(DisplayString):
    """Custom type juniAaaSubscriberProfileSummaryProfileName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_JuniAaaSubscriberProfileSummaryProfileName_Type.__name__ = "DisplayString"
_JuniAaaSubscriberProfileSummaryProfileName_Object = MibTableColumn
juniAaaSubscriberProfileSummaryProfileName = _JuniAaaSubscriberProfileSummaryProfileName_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 18, 1, 1),
    _JuniAaaSubscriberProfileSummaryProfileName_Type()
)
juniAaaSubscriberProfileSummaryProfileName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    juniAaaSubscriberProfileSummaryProfileName.setStatus("current")
_JuniAaaSubscriberProfileSummaryCount_Type = Gauge32
_JuniAaaSubscriberProfileSummaryCount_Object = MibTableColumn
juniAaaSubscriberProfileSummaryCount = _JuniAaaSubscriberProfileSummaryCount_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 18, 1, 2),
    _JuniAaaSubscriberProfileSummaryCount_Type()
)
juniAaaSubscriberProfileSummaryCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    juniAaaSubscriberProfileSummaryCount.setStatus("current")
_JuniAaaSubscriberProfileTable_Object = MibTable
juniAaaSubscriberProfileTable = _JuniAaaSubscriberProfileTable_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 19)
)
if mibBuilder.loadTexts:
    juniAaaSubscriberProfileTable.setStatus("current")
_JuniAaaSubscriberProfileEntry_Object = MibTableRow
juniAaaSubscriberProfileEntry = _JuniAaaSubscriberProfileEntry_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 19, 1)
)
juniAaaSubscriberProfileEntry.setIndexNames(
    (0, "Juniper-AAA-MIB", "juniAaaSubscriberProfileName"),
    (0, "Juniper-AAA-MIB", "juniAaaSubscriberProfileHandle"),
)
if mibBuilder.loadTexts:
    juniAaaSubscriberProfileEntry.setStatus("current")


class _JuniAaaSubscriberProfileName_Type(DisplayString):
    """Custom type juniAaaSubscriberProfileName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 80),
    )
...
_JuniAaaSubscriberProfileName_Type.__name__ = "DisplayString"
_JuniAaaSubscriberProfileName_Object = MibTableColumn
juniAaaSubscriberProfileName = _JuniAaaSubscriberProfileName_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 19, 1, 1),
    _JuniAaaSubscriberProfileName_Type()
)
juniAaaSubscriberProfileName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    juniAaaSubscriberProfileName.setStatus("current")
_JuniAaaSubscriberProfileHandle_Type = Unsigned32
_JuniAaaSubscriberProfileHandle_Object = MibTableColumn
juniAaaSubscriberProfileHandle = _JuniAaaSubscriberProfileHandle_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 19, 1, 2),
    _JuniAaaSubscriberProfileHandle_Type()
)
juniAaaSubscriberProfileHandle.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    juniAaaSubscriberProfileHandle.setStatus("current")
_JuniAaaSubscriberProfileRowStatus_Type = RowStatus
_JuniAaaSubscriberProfileRowStatus_Object = MibTableColumn
juniAaaSubscriberProfileRowStatus = _JuniAaaSubscriberProfileRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 19, 1, 3),
    _JuniAaaSubscriberProfileRowStatus_Type()
)
juniAaaSubscriberProfileRowStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    juniAaaSubscriberProfileRowStatus.setStatus("current")
_JuniAaaSubscriberLagInterfaceSummaryTable_Object = MibTable
juniAaaSubscriberLagInterfaceSummaryTable = _JuniAaaSubscriberLagInterfaceSummaryTable_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 20)
)
if mibBuilder.loadTexts:
    juniAaaSubscriberLagInterfaceSummaryTable.setStatus("current")
_JuniAaaSubscriberLagInterfaceSummaryEntry_Object = MibTableRow
juniAaaSubscriberLagInterfaceSummaryEntry = _JuniAaaSubscriberLagInterfaceSummaryEntry_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 20, 1)
)
juniAaaSubscriberLagInterfaceSummaryEntry.setIndexNames(
    (0, "Juniper-AAA-MIB", "juniAaaSubscriberLagInterfaceSummaryLagName"),
)
if mibBuilder.loadTexts:
    juniAaaSubscriberLagInterfaceSummaryEntry.setStatus("current")


class _JuniAaaSubscriberLagInterfaceSummaryLagName_Type(DisplayString):
    """Custom type juniAaaSubscriberLagInterfaceSummaryLagName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_JuniAaaSubscriberLagInterfaceSummaryLagName_Type.__name__ = "DisplayString"
_JuniAaaSubscriberLagInterfaceSummaryLagName_Object = MibTableColumn
juniAaaSubscriberLagInterfaceSummaryLagName = _JuniAaaSubscriberLagInterfaceSummaryLagName_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 20, 1, 1),
    _JuniAaaSubscriberLagInterfaceSummaryLagName_Type()
)
juniAaaSubscriberLagInterfaceSummaryLagName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    juniAaaSubscriberLagInterfaceSummaryLagName.setStatus("current")
_JuniAaaSubscriberLagInterfaceSummaryCount_Type = Gauge32
_JuniAaaSubscriberLagInterfaceSummaryCount_Object = MibTableColumn
juniAaaSubscriberLagInterfaceSummaryCount = _JuniAaaSubscriberLagInterfaceSummaryCount_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 20, 1, 8, 20, 1, 2),
    _JuniAaaSubscriberLagInterfaceSummaryCount_Type()
)
juniAaaSubscriberLagInterfaceSummaryCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    juniAaaSubscriberLagInterfaceSummaryCount.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"JuniAaaDomainName": JuniAaaDomainName,
       ...
       "juniAaaSubscriberProfileSummaryTable": juniAaaSubscriberProfileSummaryTable,
       "juniAaaSubscriberProfileSummaryEntry": juniAaaSubscriberProfileSummaryEntry,
       "juniAaaSubscriberProfileSummaryProfileName": juniAaaSubscriberProfileSummaryProfileName,
       "juniAaaSubscriberProfileSummaryCount": juniAaaSubscriberProfileSummaryCount,
       "juniAaaSubscriberProfileTable": juniAaaSubscriberProfileTable,
       "juniAaaSubscriberProfileEntry": juniAaaSubscriberProfileEntry,
       "juniAaaSubscriberProfileName": juniAaaSubscriberProfileName,
       "juniAaaSubscriberProfileHandle": juniAaaSubscriberProfileHandle,
       "juniAaaSubscriberProfileRowStatus": juniAaaSubscriberProfileRowStatus,
       "juniAaaSubscriberLagInterfaceSummaryTable": juniAaaSubscriberLagInterfaceSummaryTable,
       "juniAaaSubscriberLagInterfaceSummaryEntry": juniAaaSubscriberLagInterfaceSummaryEntry,
       "juniAaaSubscriberLagInterfaceSummaryLagName": juniAaaSubscriberLagInterfaceSummaryLagName,
       "juniAaaSubscriberLagInterfaceSummaryCount": juniAaaSubscriberLagInterfaceSummaryCount,
