...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:48:46 2025
...
mibBuilder.exportSymbols("NTPv4-MIB", ntpEntNotifObjects=ntpEntNotifObjects, ntpEntStatusLeapSecDirection=ntpEntStatusLeapSecDirection, ntpEntNotifBits=ntpEntNotifBits, ntpEntObjectsGroup1=ntpEntObjectsGroup1, ntpSnmpMIB=ntpSnmpMIB, ntpEntStatusProtocolError=ntpEntStatusProtocolError, ntpAssociationEntry=ntpAssociationEntry, ntpEntStatusNumberOfRefSources=ntpEntStatusNumberOfRefSources, ntpAssociationStatisticsEntry=ntpAssociationStatisticsEntry, ntpEntNotifModeChange=ntpEntNotifModeChange, ntpEntStatusBadVersion=ntpEntStatusBadVersion, ntpEntStatusOutPkts=ntpEntStatusOutPkts, NtpStratum=NtpStratum, ntpEntInfo=ntpEntInfo, NtpDateTime=NtpDateTime, ntpEntStatusDateTime=ntpEntStatusDateTime, ntpAssociationTable=ntpAssociationTable, ntpAssocAddress=ntpAssocAddress, ntpAssocStatProtocolError=ntpAssocStatProtocolError, ntpEntNotifRemoveAssociation=ntpEntNotifRemoveAssociation, ntpEntNTPCompliance=ntpEntNTPCompliance, ntpEntNotifConfigChanged=ntpEntNotifConfigChanged, ntpEntStatPktReceived=ntpEntStatPktReceived, ntpEntControl=ntpEntControl, ntpEntSoftwareVersion=ntpEntSoftwareVersion, ntpEntNotifGroup=ntpEntNotifGroup, ntpEntStatusCurrentMode=ntpEntStatusCurrentMode, ntpAssocStatOutPkts=ntpAssocStatOutPkts, ntpEntStatusInPkts=ntpEntStatusInPkts, ntpAssociation=ntpAssociation, PYSNMP_MODULE_ID=ntpSnmpMIB, ntpEntGroups=ntpEntGroups, ntpEntStatPktMode=ntpEntStatPktMode, ntpEntTimeResolution=ntpEntTimeResolution, ntpEntStatusLeapSecond=ntpEntStatusLeapSecond, ntpEntObjectsGroup2=ntpEntObjectsGroup2, ntpEntStatPktModeTable=ntpEntStatPktModeTable, ntpEntSoftwareName=ntpEntSoftwareName, ntpEntStatusNotifications=ntpEntStatusNotifications, ntpAssocStratum=ntpAssocStratum, ntpEntTimeDistance=ntpEntTimeDistance, ntpAssocOffset=ntpAssocOffset, ntpEntNotifications=ntpEntNotifications, ntpEntSystemType=ntpEntSystemType, ntpEntStatusDispersion=ntpEntStatusDispersion, ntpEntStatusEntityUptime=ntpEntStatusEntityUptime, ntpEntStatusActiveRefSourceName=ntpEntStatusActiveRefSourceName, ntpAssocStatusDispersion=ntpAssocStatusDispersion, ntpEntNotifSyspeerChanged=ntpEntNotifSyspeerChanged, ntpEntConformance=ntpEntConformance, ntpEntSNTPCompliance=ntpEntSNTPCompliance, ntpEntStatusActiveRefSourceId=ntpEntStatusActiveRefSourceId, ntpEntNotifStratumChange=ntpEntNotifStratumChange, ntpEntNotifHeartbeat=ntpEntNotifHeartbeat, ntpEntStatus=ntpEntStatus, ntpAssocStatusJitter=ntpAssocStatusJitter, ntpSnmpMIBObjects=ntpSnmpMIBObjects, ntpAssocName=ntpAssocName, ntpAssocStatusDelay=ntpAssocStatusDelay, ntpEntStatusStratum=ntpEntStatusStratum, ntpAssocAddressType=ntpAssocAddressType, ntpEntStatusActiveOffset=ntpEntStatusActiveOffset, ntpEntHeartbeatInterval=ntpEntHeartbeatInterval, ntpAssocStatInPkts=ntpAssocStatInPkts, ntpEntNotifAddAssociation=ntpEntNotifAddAssociation, ntpEntCompliances=ntpEntCompliances, ntpAssocRefId=ntpAssocRefId, ntpAssociationStatisticsTable=ntpAssociationStatisticsTable, ntpEntNotifMessage=ntpEntNotifMessage, ntpEntTimePrecision=ntpEntTimePrecision, ntpEntStatPktModeEntry=ntpEntStatPktModeEntry, ntpEntNotifLeapSecondAnnounced=ntpEntNotifLeapSecondAnnounced, ntpEntStatPktSent=ntpEntStatPktSent, ntpAssocId=ntpAssocId, ntpEntSoftwareVendor=ntpEntSoftwareVendor)
