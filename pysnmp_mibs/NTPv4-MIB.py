...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/NTPv4-MIB
...
ntpAssocAddressType = MibTableColumn((1, 3, 6, 1, 2, 1, 197, 1, 3, 1, 1, 4), InetAddressType().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("ipv4", 1), ("ipv6", 2), ("ipv4z", 3), ("ipv6z", 4)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("NTPv4-MIB", ntpEntNotifications=ntpEntNotifications, ntpAssociation=ntpAssociation, ntpEntNotifModeChange=ntpEntNotifModeChange, ntpAssocStatOutPkts=ntpAssocStatOutPkts, ntpEntTimeResolution=ntpEntTimeResolution, ntpEntNotifRemoveAssociation=ntpEntNotifRemoveAssociation, ntpEntStatusStratum=ntpEntStatusStratum, ntpEntNotifStratumChange=ntpEntNotifStratumChange, ntpEntNotifAddAssociation=ntpEntNotifAddAssociation, ntpEntStatusActiveOffset=ntpEntStatusActiveOffset, NtpStratum=NtpStratum, ntpEntStatusLeapSecDirection=ntpEntStatusLeapSecDirection, ntpEntSoftwareVersion=ntpEntSoftwareVersion, ntpEntInfo=ntpEntInfo, PYSNMP_MODULE_ID=ntpSnmpMIB, ntpAssocStratum=ntpAssocStratum, ntpEntStatusEntityUptime=ntpEntStatusEntityUptime, ntpEntStatusCurrentMode=ntpEntStatusCurrentMode, ntpAssociationTable=ntpAssociationTable, ntpEntStatusActiveRefSourceName=ntpEntStatusActiveRefSourceName, ntpAssocId=ntpAssocId, ntpEntStatPktMode=ntpEntStatPktMode, ntpEntNotifObjects=ntpEntNotifObjects, ntpEntNotifBits=ntpEntNotifBits, ntpEntStatPktModeEntry=ntpEntStatPktModeEntry, ntpEntStatusDispersion=ntpEntStatusDispersion, ntpEntNotifHeartbeat=ntpEntNotifHeartbeat, ntpEntObjectsGroup2=ntpEntObjectsGroup2, ntpEntStatPktModeTable=ntpEntStatPktModeTable, ntpAssocRefId=ntpAssocRefId, ntpEntTimeDistance=ntpEntTimeDistance, ntpEntNTPCompliance=ntpEntNTPCompliance, ntpEntStatus=ntpEntStatus, ntpEntStatPktSent=ntpEntStatPktSent, ntpAssocStatusDelay=ntpAssocStatusDelay, ntpAssocOffset=ntpAssocOffset, ntpEntTimePrecision=ntpEntTimePrecision, ntpEntStatusLeapSecond=ntpEntStatusLeapSecond, ntpEntStatPktReceived=ntpEntStatPktReceived, ntpAssociationStatisticsTable=ntpAssociationStatisticsTable, ntpEntStatusBadVersion=ntpEntStatusBadVersion, ntpAssociationStatisticsEntry=ntpAssociationStatisticsEntry, ntpAssocStatusJitter=ntpAssocStatusJitter, ntpEntNotifSyspeerChanged=ntpEntNotifSyspeerChanged, ntpSnmpMIB=ntpSnmpMIB, ntpAssocAddressType=ntpAssocAddressType, ntpAssocStatusDispersion=ntpAssocStatusDispersion, ntpEntHeartbeatInterval=ntpEntHeartbeatInterval, ntpEntConformance=ntpEntConformance, ntpEntNotifLeapSecondAnnounced=ntpEntNotifLeapSecondAnnounced, ntpEntSoftwareName=ntpEntSoftwareName, ntpEntStatusActiveRefSourceId=ntpEntStatusActiveRefSourceId, ntpEntObjectsGroup1=ntpEntObjectsGroup1, ntpEntSoftwareVendor=ntpEntSoftwareVendor, ntpEntControl=ntpEntControl, ntpEntNotifGroup=ntpEntNotifGroup, ntpAssocStatInPkts=ntpAssocStatInPkts, ntpEntNotifMessage=ntpEntNotifMessage, ntpEntSystemType=ntpEntSystemType, ntpEntStatusInPkts=ntpEntStatusInPkts, ntpEntStatusNotifications=ntpEntStatusNotifications, ntpEntStatusNumberOfRefSources=ntpEntStatusNumberOfRefSources, ntpEntStatusOutPkts=ntpEntStatusOutPkts, ntpEntSNTPCompliance=ntpEntSNTPCompliance, ntpAssociationEntry=ntpAssociationEntry, ntpAssocName=ntpAssocName, ntpEntNotifConfigChanged=ntpEntNotifConfigChanged, ntpEntStatusProtocolError=ntpEntStatusProtocolError, ntpEntStatusDateTime=ntpEntStatusDateTime, ntpSnmpMIBObjects=ntpSnmpMIBObjects, ntpAssocAddress=ntpAssocAddress, ntpAssocStatProtocolError=ntpAssocStatProtocolError, ntpEntGroups=ntpEntGroups, ntpEntCompliances=ntpEntCompliances, NtpDateTime=NtpDateTime)
