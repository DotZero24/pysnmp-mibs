...
# Notes
# -----
# ASN.1 source file://mibs/rfc/NTPv4-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:20:54 2025
...
class _NtpAssocAddressType_Type(InetAddressType):
    """Custom type ntpAssocAddressType based on InetAddressType"""
...
_NtpAssocAddressType_Type.__name__ = "InetAddressType"
...
_NtpEntHeartbeatInterval_Type.__name__ = "Unsigned32"
...
_NtpEntNotifMessage_Type.__name__ = "Utf8String"
...
ntpEntSNTPCompliance.setObjects(
      *(("NTPv4-MIB", "ntpEntObjectsGroup1"),
        ("NTPv4-MIB", "ntpEntObjectsGroup2"),
        ("NTPv4-MIB", "ntpEntNotifGroup"))
)
if mibBuilder.loadTexts:
