...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HIRSCHMANN-DVMRP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:53:32 2025
...
hmDVMRPMIBCompliance.setObjects(
      *(("HIRSCHMANN-DVMRP-MIB", "hmDVMRPGeneralGroup"),
        ("HIRSCHMANN-DVMRP-MIB", "hmDVMRPInterfaceGroup"),
        ("HIRSCHMANN-DVMRP-MIB", "hmDVMRPNeighborGroup"),
        ("HIRSCHMANN-DVMRP-MIB", "hmDVMRPRoutingGroup"),
        ("HIRSCHMANN-DVMRP-MIB", "hmDVMRPTreeGroup"),
        ("HIRSCHMANN-DVMRP-MIB", "hmDVMRPSecurityGroup"))
)
if mibBuilder.loadTexts:
