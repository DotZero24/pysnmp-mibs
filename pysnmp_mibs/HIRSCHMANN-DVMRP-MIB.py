...
mibBuilder.exportSymbols("HIRSCHMANN-DVMRP-MIB", hmDVMRPRouteNextHopIfIndex=hmDVMRPRouteNextHopIfIndex, hmDVMRPNeighborRcvBadPkts=hmDVMRPNeighborRcvBadPkts, hmDVMRPPruneSource=hmDVMRPPruneSource, hmDVMRPRouteSource=hmDVMRPRouteSource, hmDVMRPMIBCompliances=hmDVMRPMIBCompliances, hmDVMRPNotificationGroup=hmDVMRPNotificationGroup, hmDVMRPPruneTable=hmDVMRPPruneTable, hmDVMRPInterfaceLocalAddress=hmDVMRPInterfaceLocalAddress, hmDVMRP=hmDVMRP, hmDVMRPInterfaceRcvBadPkts=hmDVMRPInterfaceRcvBadPkts, hmDVMRPRouteUpstreamNeighbor=hmDVMRPRouteUpstreamNeighbor, hmDVMRPNeighborLoss=hmDVMRPNeighborLoss, hmDVMRPRoutingGroup=hmDVMRPRoutingGroup, hmDVMRPMIBObjects=hmDVMRPMIBObjects, hmDVMRPRouteNextHopTable=hmDVMRPRouteNextHopTable, hmDVMRPTreeGroup=hmDVMRPTreeGroup, hmDVMRPNeighborTable=hmDVMRPNeighborTable, hmDVMRPNeighborState=hmDVMRPNeighborState, hmDVMRPRouteNextHopSourceMask=hmDVMRPRouteNextHopSourceMask, hmDVMRPMIB=hmDVMRPMIB, hmDVMRPVersionString=hmDVMRPVersionString, hmDVMRPNeighborMinorVersion=hmDVMRPNeighborMinorVersion, hmDVMRPMIBCompliance=hmDVMRPMIBCompliance, hmDVMRPNeighborRcvRoutes=hmDVMRPNeighborRcvRoutes, hmDVMRPNeighborGenerationId=hmDVMRPNeighborGenerationId, hmDVMRPRouteMetric=hmDVMRPRouteMetric, hmDVMRPRouteNextHopSource=hmDVMRPRouteNextHopSource, hmDVMRPGeneralGroup=hmDVMRPGeneralGroup, hmDVMRPInterfaceGenerationId=hmDVMRPInterfaceGenerationId, hmDVMRPPruneSourceMask=hmDVMRPPruneSourceMask, hmDVMRPNeighborAddress=hmDVMRPNeighborAddress, hmDVMRPPruneLifetime=hmDVMRPPruneLifetime, hmDVMRPMIBConformance=hmDVMRPMIBConformance, hmDVMRPNeighborNotPruning=hmDVMRPNeighborNotPruning, hmDVMRPMIBGroups=hmDVMRPMIBGroups, hmDVMRPNeighborExpiryTime=hmDVMRPNeighborExpiryTime, hmDVMRPInterfaceInterfaceKey=hmDVMRPInterfaceInterfaceKey, hmDVMRPInterfaceGroup=hmDVMRPInterfaceGroup, hmDVMRPTraps=hmDVMRPTraps, hmDVMRPRouteNextHopEntry=hmDVMRPRouteNextHopEntry, hmDVMRPNeighborGroup=hmDVMRPNeighborGroup, hmDVMRPReachableRoutes=hmDVMRPReachableRoutes, hmDVMRPNeighborRcvBadRoutes=hmDVMRPNeighborRcvBadRoutes, hmDVMRPRouteTable=hmDVMRPRouteTable, hmDVMRPRouteExpiryTime=hmDVMRPRouteExpiryTime, hmDVMRPPruneEntry=hmDVMRPPruneEntry, hmDVMRPSecurityGroup=hmDVMRPSecurityGroup, hmDVMRPNeighborMajorVersion=hmDVMRPNeighborMajorVersion, hmDVMRPRouteUpTime=hmDVMRPRouteUpTime, hmDVMRPPruneGroup=hmDVMRPPruneGroup, hmDVMRPNeighborUpTime=hmDVMRPNeighborUpTime, PYSNMP_MODULE_ID=hmDVMRPMIB, hmDVMRPInterfaceSentRoutes=hmDVMRPInterfaceSentRoutes, hmDVMRPNeighborEntry=hmDVMRPNeighborEntry, hmDVMRPRouteSourceMask=hmDVMRPRouteSourceMask, hmDVMRPUpdateInterval=hmDVMRPUpdateInterval, hmDVMRPInterfaceInterfaceKeyVersion=hmDVMRPInterfaceInterfaceKeyVersion, hmDVMRPPruneExpiryTime=hmDVMRPPruneExpiryTime, hmDVMRPRouteNextHopType=hmDVMRPRouteNextHopType, hmDVMRPInterfaceMetric=hmDVMRPInterfaceMetric, hmDVMRPScalar=hmDVMRPScalar, hmDVMRPNeighborCapabilities=hmDVMRPNeighborCapabilities, hmDVMRPNumRoutes=hmDVMRPNumRoutes, hmDVMRPInterfaceIfIndex=hmDVMRPInterfaceIfIndex, hmDVMRPInterfaceRcvBadRoutes=hmDVMRPInterfaceRcvBadRoutes, hmDVMRPNeighborIfIndex=hmDVMRPNeighborIfIndex, hmDVMRPInterfaceStatus=hmDVMRPInterfaceStatus, hmDVMRPGenerationId=hmDVMRPGenerationId, hmDVMRPInterfaceEntry=hmDVMRPInterfaceEntry, hmDVMRPInterfaceTable=hmDVMRPInterfaceTable, hmDVMRPRouteIfIndex=hmDVMRPRouteIfIndex, hmDVMRPRouteEntry=hmDVMRPRouteEntry)
