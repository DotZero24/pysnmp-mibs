...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-USAGE-INFORMATION-MIB
...
alvarionUsageInformationMIBCompliance.setObjects(
    ("ALVARION-USAGE-INFORMATION-MIB", "alvarionUsageInformationMIBGroup")
)
if mibBuilder.loadTexts:
