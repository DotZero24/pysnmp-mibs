...
# Produced by pysmi-1.6.2 at Fri Oct 10 19:32:57 2025
...
hpicfXpsCompliance.setObjects(
      *(("POWERSUPPLY-MIB", "hpicfXpsGroup"),
        ("POWERSUPPLY-MIB", "hpicfXpsGroup"))
)
if mibBuilder.loadTexts:
...
hpicfXpsZoneCompliance.setObjects(
      *(("POWERSUPPLY-MIB", "hpicfXpsZoneGroup"),
        ("POWERSUPPLY-MIB", "hpicfXpsZoneGroup"))
)
if mibBuilder.loadTexts:
...
hpicfDcPsCompliance1.setObjects(
      *(("POWERSUPPLY-MIB", "hpicfPsGroup1"),
        ("POWERSUPPLY-MIB", "hpicfPsGroup1"))
)
if mibBuilder.loadTexts:
