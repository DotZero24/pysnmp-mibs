...
mibBuilder.exportSymbols("POWERSUPPLY-MIB", hpicfXpsResetReqStatus=hpicfXpsResetReqStatus, hpicfPsWattageMax=hpicfPsWattageMax, hpicfXpsZoneWattage=hpicfXpsZoneWattage, hpicfXpsZoneState=hpicfXpsZoneState, hpicfXpsSupportedCableVersion=hpicfXpsSupportedCableVersion, hpicfXpsZoneVoltage=hpicfXpsZoneVoltage, hpicfXpsSwitchModType=hpicfXpsSwitchModType, hpicfPsGroups=hpicfPsGroups, HpicfDcPsIndex=HpicfDcPsIndex, hpicfXpsPowerShareReqStatus=hpicfXpsPowerShareReqStatus, hpicfPsGroup1=hpicfPsGroup1, hpicfXpsZonePowerShareForce=hpicfXpsZonePowerShareForce, hpicfXpsCompliance=hpicfXpsCompliance, hpicfPsModel=hpicfPsModel, hpicfXpsType=hpicfXpsType, hpicfPsCompliance=hpicfPsCompliance, hpicfPsGroup=hpicfPsGroup, hpicfPsWattageCur=hpicfPsWattageCur, hpicfXpsConnectionState=hpicfXpsConnectionState, hpicfXpsSwitchConfigEntry=hpicfXpsSwitchConfigEntry, hpicfPsTemp=hpicfPsTemp, hpicfXpsZoneRecordVersion=hpicfXpsZoneRecordVersion, hpicfPsTable=hpicfPsTable, HpicfXpsConnectionStatus=HpicfXpsConnectionStatus, hpicfXpsSwitchConfigTable=hpicfXpsSwitchConfigTable, hpicfXpsZonePowerShareMap=hpicfXpsZonePowerShareMap, hpicfXpsSwitchAdminStatus=hpicfXpsSwitchAdminStatus, HpicfXpsZoneStatus=HpicfXpsZoneStatus, hpicfXpsSwitchIpsWattage=hpicfXpsSwitchIpsWattage, hpicfXpsSwitchIpsVoltage=hpicfXpsSwitchIpsVoltage, hpicfXpsEntry=hpicfXpsEntry, hpicfXpsZoneGroup=hpicfXpsZoneGroup, hpicfPsConformance=hpicfPsConformance, hpicfDcPsCompliance1=hpicfDcPsCompliance1, hpicfPsFailures=hpicfPsFailures, hpicfXpsZoneEntry=hpicfXpsZoneEntry, hpicfPsState=hpicfPsState, hpicfXpsSwitchAutoRecovery=hpicfXpsSwitchAutoRecovery, hpicfPsEntry=hpicfPsEntry, hpicfXpsSwitchOSVersion=hpicfXpsSwitchOSVersion, hpicfXpsPower=hpicfXpsPower, hpicfXpsAllowPortsSupported=hpicfXpsAllowPortsSupported, hpicfXpsSerialNum=hpicfXpsSerialNum, hpicfXpsReset=hpicfXpsReset, hpicfXpsSwitchSerialNo=hpicfXpsSwitchSerialNo, hpicfDcPsCompliance=hpicfDcPsCompliance, HpicfDcPsState=HpicfDcPsState, hpicfPsVoltageInfo=hpicfPsVoltageInfo, hpicfXpsSysName=hpicfXpsSysName, hpicfXpsZoneNo=hpicfXpsZoneNo, hpicfPsBayNum=hpicfPsBayNum, hpicfEntityPs=hpicfEntityPs, hpicfXpsMACAddress=hpicfXpsMACAddress, hpicfPsLastCall=hpicfPsLastCall, hpicfXpsZoneTable=hpicfXpsZoneTable, hpicfXpsPortOperStatus=hpicfXpsPortOperStatus, hpicfXpsPSURev=hpicfXpsPSURev, hpicfXpsPSUModule=hpicfXpsPSUModule, hpicfXpsSupportedZoneVersion=hpicfXpsSupportedZoneVersion, hpicfPsMIB=hpicfPsMIB, hpicfXpsZoneCompliance=hpicfXpsZoneCompliance, PYSNMP_MODULE_ID=hpicfPsMIB, hpicfXpsTable=hpicfXpsTable, hpicfXpsGroup=hpicfXpsGroup, hpicfXpsModuleName=hpicfXpsModuleName, hpicfXpsConnectingPort=hpicfXpsConnectingPort)
