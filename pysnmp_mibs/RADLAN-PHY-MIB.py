...
rlPhyTestSetType=_RlPhyTestSetType_Object((1,3,6,1,4,1,89,90,1,1,1,1),_RlPhyTestSetType_Type())
...
rlPhyTestGetTable=_RlPhyTestGetTable_Object((1,3,6,1,4,1,89,90,1,2))
if mibBuilder.loadTexts:rlPhyTestGetTable.setStatus(_A)
_RlPhyTestGetEntry_Object=MibTableRow
rlPhyTestGetEntry=_RlPhyTestGetEntry_Object((1,3,6,1,4,1,89,90,1,2,1))
...
rlPhyTestGetType=_RlPhyTestGetType_Object((1,3,6,1,4,1,89,90,1,2,1,1),_RlPhyTestGetType_Type())
...
rlPhyTestGetStatus=_RlPhyTestGetStatus_Object((1,3,6,1,4,1,89,90,1,2,1,2),_RlPhyTestGetStatus_Type())
...
rlPhyTestGetResult=_RlPhyTestGetResult_Object((1,3,6,1,4,1,89,90,1,2,1,3),_RlPhyTestGetResult_Type())
...
rlPhyTestGetUnits=_RlPhyTestGetUnits_Object((1,3,6,1,4,1,89,90,1,2,1,4),_RlPhyTestGetUnits_Type())
...
rlPhyTestGetAlarm=_RlPhyTestGetAlarm_Object((1,3,6,1,4,1,89,90,1,2,1,5),_RlPhyTestGetAlarm_Type())
...
rlPhyTestGetTimeStamp=_RlPhyTestGetTimeStamp_Object((1,3,6,1,4,1,89,90,1,2,1,6),_RlPhyTestGetTimeStamp_Type())
