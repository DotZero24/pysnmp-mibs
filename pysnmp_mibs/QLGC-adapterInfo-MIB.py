...
ifControllers=_IfControllers_ObjectIdentity((1,3,6,1,4,1,3873,1,3))
_IfiNumber_Type=Integer32
_IfiNumber_Object=MibScalar
ifiNumber=_IfiNumber_Object((1,3,6,1,4,1,3873,1,3,1),_IfiNumber_Type())
ifiNumber.setMaxAccess(_B)
if mibBuilder.loadTexts:ifiNumber.setStatus(_A)
_IfiTable_Object=MibTable
ifiTable=_IfiTable_Object((1,3,6,1,4,1,3873,1,3,2))
if mibBuilder.loadTexts:ifiTable.setStatus(_A)
_IfiEntry_Object=MibTableRow
ifiEntry=_IfiEntry_Object((1,3,6,1,4,1,3873,1,3,2,1))
...
ifiIndex=_IfiIndex_Object((1,3,6,1,4,1,3873,1,3,2,1,1),_IfiIndex_Type())
...
ifName=_IfName_Object((1,3,6,1,4,1,3873,1,3,2,1,2),_IfName_Type())
...
ifiDescr=_IfiDescr_Object((1,3,6,1,4,1,3873,1,3,2,1,3),_IfiDescr_Type())
...
ifNetworkAddress=_IfNetworkAddress_Object((1,3,6,1,4,1,3873,1,3,2,1,4),_IfNetworkAddress_Type())
...
ifSubnetMask=_IfSubnetMask_Object((1,3,6,1,4,1,3873,1,3,2,1,5),_IfSubnetMask_Type())
...
ifiPhysAddress=_IfiPhysAddress_Object((1,3,6,1,4,1,3873,1,3,2,1,6),_IfiPhysAddress_Type())
...
ifPermPhysAddress=_IfPermPhysAddress_Object((1,3,6,1,4,1,3873,1,3,2,1,7),_IfPermPhysAddress_Type())
...
ifLinkStatus=_IfLinkStatus_Object((1,3,6,1,4,1,3873,1,3,2,1,8),_IfLinkStatus_Type())
...
ifState=_IfState_Object((1,3,6,1,4,1,3873,1,3,2,1,9),_IfState_Type())
...
ifLineSpeed=_IfLineSpeed_Object((1,3,6,1,4,1,3873,1,3,2,1,10),_IfLineSpeed_Type())
...
ifDuplexMode=_IfDuplexMode_Object((1,3,6,1,4,1,3873,1,3,2,1,11),_IfDuplexMode_Type())
...
ifMemBaseLow=_IfMemBaseLow_Object((1,3,6,1,4,1,3873,1,3,2,1,12),_IfMemBaseLow_Type())
...
ifMemBaseHigh=_IfMemBaseHigh_Object((1,3,6,1,4,1,3873,1,3,2,1,13),_IfMemBaseHigh_Type())
...
ifInterrupt=_IfInterrupt_Object((1,3,6,1,4,1,3873,1,3,2,1,14),_IfInterrupt_Type())
...
ifBusNumber=_IfBusNumber_Object((1,3,6,1,4,1,3873,1,3,2,1,15),_IfBusNumber_Type())
...
ifDeviceNumber=_IfDeviceNumber_Object((1,3,6,1,4,1,3873,1,3,2,1,16),_IfDeviceNumber_Type())
...
ifFunctionNumber=_IfFunctionNumber_Object((1,3,6,1,4,1,3873,1,3,2,1,17),_IfFunctionNumber_Type())
...
ifIpv6NetworkAddress=_IfIpv6NetworkAddress_Object((1,3,6,1,4,1,3873,1,3,2,1,18),_IfIpv6NetworkAddress_Type())
ifIpv6NetworkAddress.setMaxAccess(_B)
if mibBuilder.loadTexts:ifIpv6NetworkAddress.setStatus(_A)
mibBuilder.exportSymbols(_D,**{'qlogic':qlogic,'enet':enet,'qlasp':qlasp,'qlaspConfig':qlaspConfig,'qlaspStat':qlaspStat,'qlaspTrap':qlaspTrap,'ifControllers':ifControllers,'ifiNumber':ifiNumber,'ifiTable':ifiTable,'ifiEntry':ifiEntry,_E:ifiIndex,'ifName':ifName,'ifiDescr':ifiDescr,'ifNetworkAddress':ifNetworkAddress,'ifSubnetMask':ifSubnetMask,'ifiPhysAddress':ifiPhysAddress,'ifPermPhysAddress':ifPermPhysAddress,'ifLinkStatus':ifLinkStatus,'ifState':ifState,'ifLineSpeed':ifLineSpeed,'ifDuplexMode':ifDuplexMode,'ifMemBaseLow':ifMemBaseLow,'ifMemBaseHigh':ifMemBaseHigh,'ifInterrupt':ifInterrupt,'ifBusNumber':ifBusNumber,'ifDeviceNumber':ifDeviceNumber,'ifFunctionNumber':ifFunctionNumber,'ifIpv6NetworkAddress':ifIpv6NetworkAddress})