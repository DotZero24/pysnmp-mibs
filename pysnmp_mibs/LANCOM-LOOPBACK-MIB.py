# SNMP MIB module (LANCOM-LOOPBACK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/lancom/LANCOM-LOOPBACK-MIB
...
agentLoopbackID = _AgentLoopbackID_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 22, 1, 1, 1, 1),
...
agentLoopbackIfIndex = _AgentLoopbackIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 22, 1, 1, 1, 2),
...
agentLoopbackIPAddress = _AgentLoopbackIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 22, 1, 1, 1, 3),
...
agentLoopbackIPSubnet = _AgentLoopbackIPSubnet_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 22, 1, 1, 1, 4),
...
agentLoopbackStatus = _AgentLoopbackStatus_Object(
    (1, 3, 6, 1, 4, 1, 2356, 16, 1, 22, 1, 1, 1, 5),
