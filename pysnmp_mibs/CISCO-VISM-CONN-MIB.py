...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VISM-CONN-MIB
...
_VismChanReroute_Type.__name__ = "TruthValue"
...
_VismChanDirectRoute_Type.__name__ = "TruthValue"
...
_VismChanAisSuppression_Type.__name__ = "TruthValue"
...
ciscoVismConnCompliance.setObjects(
      *(("CISCO-VISM-CONN-MIB", "ciscoVismConnGroup"),
        ("CISCO-VISM-CONN-MIB", "ciscoVismConnStateGroup"))
)
if mibBuilder.loadTexts:
...
ciscoVismConnComplianceRev1.setObjects(
      *(("CISCO-VISM-CONN-MIB", "ciscoVismConnGroupRev1"),
        ("CISCO-VISM-CONN-MIB", "ciscoVismConnStateGroup"))
)
if mibBuilder.loadTexts:
