...
mibBuilder.exportSymbols("CISCO-VISM-CONN-MIB", vismChanUserMaxScrIngress=vismChanUserMaxScrIngress, vismFarEndAddressType=vismFarEndAddressType, vismChanCdvt=vismChanCdvt, vismChanUserMaxMbsIngress=vismChanUserMaxMbsIngress, vismStateChanNum=vismStateChanNum, vismChanNumNextAvailable=vismChanNumNextAvailable, vismMastership=vismMastership, ciscoVismConnMIBConformance=ciscoVismConnMIBConformance, ciscoVismConnGroup=ciscoVismConnGroup, vismMaxCost=vismMaxCost, vismChanDirectRoute=vismChanDirectRoute, vismChanRTDResult=vismChanRTDResult, vismChanClrIngress=vismChanClrIngress, vismConnPercentUtil=vismConnPercentUtil, vismChanMbsIngress=vismChanMbsIngress, vismChanReroute=vismChanReroute, vismChanState=vismChanState, ciscoVismConnStateGroup=ciscoVismConnStateGroup, vismCnfChanNum=vismCnfChanNum, vismRemoteNSAP=vismRemoteNSAP, vismConnPCR=vismConnPCR, vismFarEndNSAPAddress=vismFarEndNSAPAddress, ciscoVismConnMIB=ciscoVismConnMIB, vismLocalVpi=vismLocalVpi, vismChanRcvATMState=vismChanRcvATMState, ciscoVismConnMIBGroups=ciscoVismConnMIBGroups, vismChanPvcType=vismChanPvcType, vismChanPortNum=vismChanPortNum, vismChanPrefRouteId=vismChanPrefRouteId, vismChanScrIngress=vismChanScrIngress, vismRestrictTrunkType=vismRestrictTrunkType, vismChanClrEgress=vismChanClrEgress, vismChanMbsEgress=vismChanMbsEgress, vismConnPCREgress=vismConnPCREgress, ciscoVismConnMIBCompliances=ciscoVismConnMIBCompliances, vismChanStateGrp=vismChanStateGrp, vismChanTestType=vismChanTestType, vismConnServiceType=vismConnServiceType, vismChanAisDelayTime=vismChanAisDelayTime, vismChanProtection=vismChanProtection, vismChanUserMinPCRBandwidth=vismChanUserMinPCRBandwidth, vismChanActivityState=vismChanActivityState, vismRemoteVci=vismRemoteVci, vismFarEndE164Address=vismFarEndE164Address, vismChanConnType=vismChanConnType, vismChanPreference=vismChanPreference, vismChanApplication=vismChanApplication, vismChanUserMaxPCRBandwidth=vismChanUserMaxPCRBandwidth, vismFarEndGWIDAddress=vismFarEndGWIDAddress, vismChanCnfGrpTable=vismChanCnfGrpTable, vismChanXmtATMState=vismChanXmtATMState, ciscoVismConnComplianceRev1=ciscoVismConnComplianceRev1, vismVCCI=vismVCCI, vismLocalVci=vismLocalVci, PYSNMP_MODULE_ID=ciscoVismConnMIB, vismChanStateGrpEntry=vismChanStateGrpEntry, vismChanAisSuppression=vismChanAisSuppression, vismChanStatusBitMap=vismChanStatusBitMap, vismVpcFlag=vismVpcFlag, vismChanCnfGrpEntry=vismChanCnfGrpEntry, vismLocalNSAP=vismLocalNSAP, vismConnRemotePercentUtil=vismConnRemotePercentUtil, vismConnAdminStatus=vismConnAdminStatus, vismChanTestState=vismChanTestState, vismChanScrEgress=vismChanScrEgress, vismChanStateGrpTable=vismChanStateGrpTable, vismChanRowStatus=vismChanRowStatus, vismConnRemotePCR=vismConnRemotePCR, vismRoutingPriority=vismRoutingPriority, ciscoVismConnGroupRev1=ciscoVismConnGroupRev1, vismRemoteVpi=vismRemoteVpi, vismChanFallbackLcn=vismChanFallbackLcn, vismChanUserPcrNumber=vismChanUserPcrNumber, ciscoVismConnCompliance=ciscoVismConnCompliance, vismChanLockingState=vismChanLockingState, vismChanLocRmtLpbkState=vismChanLocRmtLpbkState)
