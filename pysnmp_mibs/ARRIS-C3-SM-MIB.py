...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDiskFailed=dcxSMDiskFailed, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMObjects=dcxSMObjects, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMBootGroup=dcxSMBootGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMBootDevice=dcxSMBootDevice, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMRebootAction=dcxSMRebootAction, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileSize=dcxSMConfigFileSize, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval)
