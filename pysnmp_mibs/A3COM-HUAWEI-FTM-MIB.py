...
h3cFtm=_H3cFtm_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,1))
_H3cFtmManMIBObjects_ObjectIdentity=ObjectIdentity
h3cFtmManMIBObjects=_H3cFtmManMIBObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,1,1,1))
_H3cFtmUnitTable_Object=MibTable
h3cFtmUnitTable=_H3cFtmUnitTable_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,1))
if mibBuilder.loadTexts:h3cFtmUnitTable.setStatus(_A)
_H3cFtmUnitEntry_Object=MibTableRow
h3cFtmUnitEntry=_H3cFtmUnitEntry_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,1,1))
...
h3cFtmIndex=_H3cFtmIndex_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,1,1,1),_H3cFtmIndex_Type())
...
h3cFtmUnitID=_H3cFtmUnitID_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,1,1,2),_H3cFtmUnitID_Type())
...
h3cFtmUnitName=_H3cFtmUnitName_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,1,1,3),_H3cFtmUnitName_Type())
...
h3cFtmUnitRole=_H3cFtmUnitRole_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,1,1,4),_H3cFtmUnitRole_Type())
...
h3cFtmNumberMode=_H3cFtmNumberMode_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,1,1,5),_H3cFtmNumberMode_Type())
...
h3cFtmAuthMode=_H3cFtmAuthMode_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,2),_H3cFtmAuthMode_Type())
...
h3cFtmAuthValue=_H3cFtmAuthValue_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,3),_H3cFtmAuthValue_Type())
...
h3cFtmFabricVlanID=_H3cFtmFabricVlanID_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,4),_H3cFtmFabricVlanID_Type())
...
h3cFtmFabricType=_H3cFtmFabricType_Object((1,3,6,1,4,1,43,45,1,10,2,1,1,1,5),_H3cFtmFabricType_Type())
...
h3cFtmManMIBComformance=_H3cFtmManMIBComformance_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,1,1,2))
_H3cFtmMIBCompliances_ObjectIdentity=ObjectIdentity
h3cFtmMIBCompliances=_H3cFtmMIBCompliances_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,1,1,2,1))
_H3cFtmMIBGroups_ObjectIdentity=ObjectIdentity
h3cFtmMIBGroups=_H3cFtmMIBGroups_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,1,1,2,2))
_H3cFtmManMIBNotification_ObjectIdentity=ObjectIdentity
h3cFtmManMIBNotification=_H3cFtmManMIBNotification_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,1,1,3))
h3cFtmConfigGroup=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,1,1,2,2,1))
h3cFtmConfigGroup.setObjects(*((_B,_G),(_B,_H),(_B,_I),(_B,_J),(_B,_K),(_B,_L)))
if mibBuilder.loadTexts:h3cFtmConfigGroup.setStatus(_A)
h3cFtmUnitIDChange=NotificationType((1,3,6,1,4,1,43,45,1,10,2,1,1,3,1))
h3cFtmUnitIDChange.setObjects(*((_B,_E),(_B,_G)))
if mibBuilder.loadTexts:h3cFtmUnitIDChange.setStatus(_A)
h3cFtmUnitNameChange=NotificationType((1,3,6,1,4,1,43,45,1,10,2,1,1,3,2))
h3cFtmUnitNameChange.setObjects(*((_B,_E),(_B,_H)))
if mibBuilder.loadTexts:h3cFtmUnitNameChange.setStatus(_A)
h3cFtmNotificationGroup=NotificationGroup((1,3,6,1,4,1,43,45,1,10,2,1,1,2,2,2))
h3cFtmNotificationGroup.setObjects(*((_B,_M),(_B,_N)))
if mibBuilder.loadTexts:h3cFtmNotificationGroup.setStatus(_A)
h3cFtmMIBCompliance=ModuleCompliance((1,3,6,1,4,1,43,45,1,10,2,1,1,2,1,1))
