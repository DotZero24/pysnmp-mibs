...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/mrv/NBS-ROADM-MIB
...
NbsTcStagingCommit, NbsTcMilliDb, nbs, NbsTcMHz = mibBuilder.importSymbols("NBS-MIB", "NbsTcStagingCommit", "NbsTcMilliDb", "nbs", "NbsTcMHz")
...
mibBuilder.exportSymbols("NBS-ROADM-MIB", nbsRoadmCommittedCenterline=nbsRoadmCommittedCenterline, nbsRoadmStagingDropPort=nbsRoadmStagingDropPort, nbsRoadmFlexgridBandwidthMin=nbsRoadmFlexgridBandwidthMin, nbsRoadmCommittedSecondaryPort=nbsRoadmCommittedSecondaryPort, nbsRoadmEventRedundancyTriggered=nbsRoadmEventRedundancyTriggered, nbsRoadmStagingChannelName=nbsRoadmStagingChannelName, nbsRoadmStagingGrp=nbsRoadmStagingGrp, nbsRoadmCommonIfIndex=nbsRoadmCommonIfIndex, nbsRoadmStagingAddPort=nbsRoadmStagingAddPort, nbsRoadmRedundantMapPort=nbsRoadmRedundantMapPort, nbsRoadmRedundantTable=nbsRoadmRedundantTable, nbsRoadmFlexgridCenterlineMax=nbsRoadmFlexgridCenterlineMax, nbsRoadmStagingTableSize=nbsRoadmStagingTableSize, nbsRoadmRedundantCenterline=nbsRoadmRedundantCenterline, nbsRoadmCommonStagingCommit=nbsRoadmCommonStagingCommit, nbsRoadmRedundantGrp=nbsRoadmRedundantGrp, nbsRoadmCommonTableSize=nbsRoadmCommonTableSize, nbsRoadmCommittedAddPort=nbsRoadmCommittedAddPort, nbsRoadmFlexgridTable=nbsRoadmFlexgridTable, nbsRoadmEvent=nbsRoadmEvent, nbsRoadmRedundantTableSize=nbsRoadmRedundantTableSize, nbsRoadmEventStageAreaCommitted=nbsRoadmEventStageAreaCommitted, nbsRoadmStagingCenterline=nbsRoadmStagingCenterline, nbsRoadmFlexgridCenterlineMin=nbsRoadmFlexgridCenterlineMin, PYSNMP_MODULE_ID=nbsRoadmMib, nbsRoadmCommittedGrp=nbsRoadmCommittedGrp, nbsRoadmCommonStagingDropCaps=nbsRoadmCommonStagingDropCaps, nbsRoadmCommonCommittedGridType=nbsRoadmCommonCommittedGridType, nbsRoadmCommittedDropPort=nbsRoadmCommittedDropPort, nbsRoadmRedundantEntry=nbsRoadmRedundantEntry, nbsRoadmCommonGrp=nbsRoadmCommonGrp, nbsRoadmRedundantCurState=nbsRoadmRedundantCurState, nbsRoadmFlexgridCenterlineIncr=nbsRoadmFlexgridCenterlineIncr, nbsRoadmRedundantItuName=nbsRoadmRedundantItuName, nbsRoadmFlexgridBandwidthMax=nbsRoadmFlexgridBandwidthMax, nbsRoadmMib=nbsRoadmMib, nbsRoadmFlexgridEntry=nbsRoadmFlexgridEntry, nbsRoadmFlexgridIfIndex=nbsRoadmFlexgridIfIndex, nbsRoadmCommittedTableSize=nbsRoadmCommittedTableSize, nbsRoadmCommittedDropAttenu=nbsRoadmCommittedDropAttenu, nbsRoadmFlexgridGrp=nbsRoadmFlexgridGrp, nbsRoadmStagingAddAttenu=nbsRoadmStagingAddAttenu, nbsRoadmStagingEntry=nbsRoadmStagingEntry, nbsRoadmCommittedAddAttenu=nbsRoadmCommittedAddAttenu, nbsRoadmRedundantSecondaryPort=nbsRoadmRedundantSecondaryPort, nbsRoadmCommonCommittedChannels=nbsRoadmCommonCommittedChannels, nbsRoadmCommonEntry=nbsRoadmCommonEntry, nbsRoadmCommittedEntry=nbsRoadmCommittedEntry, nbsRoadmCommittedBandwidth=nbsRoadmCommittedBandwidth, nbsRoadmCommittedSecondAttenu=nbsRoadmCommittedSecondAttenu, nbsRoadmRedundantCurPort=nbsRoadmRedundantCurPort, nbsRoadmRedundantIfIndex=nbsRoadmRedundantIfIndex, nbsRoadmStagingRowStatus=nbsRoadmStagingRowStatus, nbsRoadmTraps=nbsRoadmTraps, nbsRoadmCommittedIfIndex=nbsRoadmCommittedIfIndex, nbsRoadmStagingIfIndex=nbsRoadmStagingIfIndex, nbsRoadmCommonStagingQuickCfg=nbsRoadmCommonStagingQuickCfg, nbsRoadmStagingSecondAttenu=nbsRoadmStagingSecondAttenu, nbsRoadmFlexgridTableSize=nbsRoadmFlexgridTableSize, nbsRoadmRedundantCurAttenu=nbsRoadmRedundantCurAttenu, nbsRoadmCommittedChannelName=nbsRoadmCommittedChannelName, nbsRoadmFlexgridBandwidthIncr=nbsRoadmFlexgridBandwidthIncr, nbsRoadmCommonTable=nbsRoadmCommonTable, nbsRoadmStagingItuName=nbsRoadmStagingItuName, nbsRoadmRedundantChannelName=nbsRoadmRedundantChannelName, nbsRoadmStagingSecondaryPort=nbsRoadmStagingSecondaryPort, nbsRoadmStagingTable=nbsRoadmStagingTable, nbsRoadmStagingDropAttenu=nbsRoadmStagingDropAttenu, nbsRoadmCommittedItuName=nbsRoadmCommittedItuName, nbsRoadmStagingBandwidth=nbsRoadmStagingBandwidth, nbsRoadmCommonStagingAddCaps=nbsRoadmCommonStagingAddCaps, nbsRoadmCommittedTable=nbsRoadmCommittedTable)
