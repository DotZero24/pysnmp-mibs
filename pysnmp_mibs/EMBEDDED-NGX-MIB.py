...
mibBuilder.exportSymbols("EMBEDDED-NGX-MIB", swWStationRate=swWStationRate, swWStationRxFramesOk=swWStationRxFramesOk, swStorageConfigFree=swStorageConfigFree, swLicenseProductName=swLicenseProductName, swHardware=swHardware, swStorageCFFree=swStorageCFFree, swStorageConfigTotal=swStorageConfigTotal, swAvStatus=swAvStatus, swFwActiveComputersTable=swFwActiveComputersTable, swWStationCipher=swWStationCipher, swMemRAM=swMemRAM, swFirmwareDebugMode=swFirmwareDebugMode, swWStationTxPacketErrorRatio=swWStationTxPacketErrorRatio, swFirmwareRunning=swFirmwareRunning, swActCompMac=swActCompMac, swWStationTxFailRatio=swWStationTxFailRatio, swVirtualIpEntry=swVirtualIpEntry, swWStationTxFramesOk=swWStationTxFramesOk, UTM_1X1000=UTM_1X1000, swVirtualIpTable=swVirtualIpTable, DisplayString=DisplayString, SafeAtOffice405=SafeAtOffice405, swStorageCFTotal=swStorageCFTotal, swAvNextUpdate=swAvNextUpdate, swLicense=swLicense, UTM_1X300=UTM_1X300, swStorageFirmFree=swStorageFirmFree, swActCompName=swActCompName, SafeAtOffice225=SafeAtOffice225, swWStationTxFramesManagement=swWStationTxFramesManagement, swWStationSignalDb=swWStationSignalDb, swAvMain=swAvMain, swStorageFirm=swStorageFirm, swActCompAuthSessionExpiresTime=swActCompAuthSessionExpiresTime, swLicenseMacAddress=swLicenseMacAddress, SafeAtOffice500P=SafeAtOffice500P, swMemRamTotal=swMemRamTotal, swMemRamFree=swMemRamFree, swActCompNetwork=swActCompNetwork, swVirtualIpStatus=swVirtualIpStatus, swActCompType=swActCompType, swFwMEMFree=swFwMEMFree, swMemDFA=swMemDFA, swFirmwareBootcodeVersion=swFirmwareBootcodeVersion, swActCompLicense=swActCompLicense, swActCompIpAddress=swActCompIpAddress, swFirmware=swFirmware, swStorageFirmTotal=swStorageFirmTotal, swMemDfaFree=swMemDfaFree, swMem=swMem, UTM1EdgeW=UTM1EdgeW, swWStationMac=swWStationMac, swLicenseUsedNodes=swLicenseUsedNodes, SafeAtOffice500=SafeAtOffice500, UTM_1X400=UTM_1X400, swStorageCF=swStorageCF, swFwActiveComputerEntry=swFwActiveComputerEntry, swHA=swHA, swKernelMemFree=swKernelMemFree, swWirelessStationEntry=swWirelessStationEntry, swVirtualIpAddr=swVirtualIpAddr, swStorage=swStorage, swAV=swAV, swFW=swFW, SafeAtOffice210=SafeAtOffice210, SafeAtOffice205=SafeAtOffice205, swWStationXr=swWStationXr, swActCompAuthUsername=swActCompAuthUsername, swWStationRxFramesControl=swWStationRxFramesControl, swWireless=swWireless, swWirelessStationsTable=swWirelessStationsTable, SafeAtOffice410=SafeAtOffice410, swWStationTxFramesError=swWStationTxFramesError, swWStationRxFramesErrorFrame=swWStationRxFramesErrorFrame, swWStationRxRetryRation=swWStationRxRetryRation, swHardwareVersion=swHardwareVersion, swStorageConfig=swStorageConfig, swLicenseProductKey=swLicenseProductKey, swWStationRxFramesManagement=swWStationRxFramesManagement, UTM1EdgeX=UTM1EdgeX, swWStationRxDupRatio=swWStationRxDupRatio, swMemDfaTest=swMemDfaTest, SafeAtOffice425=SafeAtOffice425, swWStationQos=swWStationQos, swGWType=swGWType, swUserMemFree=swUserMemFree, swAvDaily=swAvDaily, swMemDfaTotal=swMemDfaTotal, products=products, sofaware=sofaware, swFirmwareBackup=swFirmwareBackup, swFirmwarePrimary=swFirmwarePrimary, swActCompAuthStatus=swActCompAuthStatus, swHardwareType=swHardwareType)
