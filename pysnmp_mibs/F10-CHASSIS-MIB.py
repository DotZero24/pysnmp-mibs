...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/force10/F10-CHASSIS-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 11:10:45 2025
...
F10SystemCardType, F10ChassisType, F10ProcessorModuleType, F10ChassisMode, F10HundredthdB, F10CardOperStatus, F10SlotState, F10MfgDate, F10SystemPortType, F10SwDate = mibBuilder.importSymbols("FORCE10-TC", "F10SystemCardType", "F10ChassisType", "F10ProcessorModuleType", "F10ChassisMode", "F10HundredthdB", "F10CardOperStatus", "F10SlotState", "F10MfgDate", "F10SystemPortType", "F10SwDate")
...
mibBuilder.exportSymbols("F10-CHASSIS-MIB", chNumSfmSlots=chNumSfmSlots, chSysSwBackupBootImgStatus=chSysSwBackupBootImgStatus, chSysCardCountryCode=chSysCardCountryCode, chAlarmVariable=chAlarmVariable, chAlarmMinorFanBadClear=chAlarmMinorFanBadClear, chAlarmSfmAdd=chAlarmSfmAdd, chSysCardNumProcessors=chSysCardNumProcessors, f10ChassisNotificationGroup=f10ChassisNotificationGroup, chAlarmClrMemThreshold=chAlarmClrMemThreshold, chLineCardObjects=chLineCardObjects, chSysSfmEntry=chSysSfmEntry, chSysPortEntry=chSysPortEntry, chSysProcessorMemSize=chSysProcessorMemSize, chRpmCpuUtil5Min=chRpmCpuUtil5Min, chSysCardFaultStatus=chSysCardFaultStatus, chSysXfpRecvPower=chSysXfpRecvPower, chAlarmCardProblem=chAlarmCardProblem, chSysSwModuleTable=chSysSwModuleTable, chSysCardType=chSysCardType, chAlarmCardUp=chAlarmCardUp, chSysCardTable=chSysCardTable, chSysCardNumLgcPorts=chSysCardNumLgcPorts, chSysCardParityNonrecovrableError=chSysCardParityNonrecovrableError, PYSNMP_MODULE_ID=f10ChassisMib, chAlarmFanTrayOrPsuClear=chAlarmFanTrayOrPsuClear, chAlarmRpmUp=chAlarmRpmUp, chSysSwCurrentBootImgDate=chSysSwCurrentBootImgDate, chSysSwCurrentBootImage=chSysSwCurrentBootImage, chSysCardParityRecoverableError=chSysCardParityRecoverableError, chAlarmUnsupportedOptic=chAlarmUnsupportedOptic, chSysSwNextRebootImage=chSysSwNextRebootImage, f10ComponentGroup=f10ComponentGroup, chSysSfmEcLevel=chSysSfmEcLevel, f10ChassisMib=f10ChassisMib, chAlarmObjects=chAlarmObjects, chSysSwModuleEntry=chSysSwModuleEntry, chAlarmAcDcMixedPowerSupplyDetect=chAlarmAcDcMixedPowerSupplyDetect, chSysCardProdOrder=chSysCardProdOrder, chAlarmBgpEstb=chAlarmBgpEstb, chLineCardCpuUtil5Sec=chLineCardCpuUtil5Sec, chAlarmMinorSfmDownClr=chAlarmMinorSfmDownClr, chAlarmMinorPSClr=chAlarmMinorPSClr, chSysPortIndex=chSysPortIndex, chSysCardAdminStatus=chSysCardAdminStatus, chPartNum=chPartNum, chSysCardUpperTemp=chSysCardUpperTemp, chSysSwProcessorIndex=chSysSwProcessorIndex, chSysPowerSupplyTable=chSysPowerSupplyTable, chLineCardMemUsageUtil=chLineCardMemUsageUtil, chSysCardMfgDate=chSysCardMfgDate, chAlarmCardDown=chAlarmCardDown, chSysPortSlotIndex=chSysPortSlotIndex, f10ChassisMibGroups=f10ChassisMibGroups, chSysSfmIndex=chSysSfmIndex, chSysSwBackupBootImgVersion=chSysSwBackupBootImgVersion, chSysObjects=chSysObjects, chRpmMemUsageUtil=chRpmMemUsageUtil, chAlarmVrrpGoMaster=chAlarmVrrpGoMaster, chSysProcessorLogStream=chSysProcessorLogStream, chEcLevel=chEcLevel, chSysCardSlotIndex=chSysCardSlotIndex, chObjects=chObjects, chSysSfmMfgDate=chSysSfmMfgDate, chRpmCpuUtil5Sec=chRpmCpuUtil5Sec, chAlarmMajorSfmDown=chAlarmMajorSfmDown, chAlarmSRAMParityErrorDetect=chAlarmSRAMParityErrorDetect, chAlarmSfmDown=chAlarmSfmDown, chAlarmFanTrayOrPsuDown=chAlarmFanTrayOrPsuDown, f10RpmGroup=f10RpmGroup, chNumSlots=chNumSlots, chSerialNumber=chSerialNumber, chChassisMode=chChassisMode, chSysSwRuntimeImgDate=chSysSwRuntimeImgDate, chAlarmMajorTemperatureHigh=chAlarmMajorTemperatureHigh, chSysFanTrayTable=chSysFanTrayTable, chSysCardEntry=chSysCardEntry, chSysSfmOperStatus=chSysSfmOperStatus, chRpmSlotNumber=chRpmSlotNumber, chSysSfmProdOrder=chSysSfmProdOrder, chRpmMinorAlarmStatus=chRpmMinorAlarmStatus, chSysCardSerialNumber=chSysCardSerialNumber, chSfmUtil5Min=chSfmUtil5Min, chAlarmMajorTemperatureClear=chAlarmMajorTemperatureClear, chAlarmFanTrayClear=chAlarmFanTrayClear, chSnmpIpAclDeny=chSnmpIpAclDeny, chSysSwRuntimeImgVersion=chSysSwRuntimeImgVersion, chSysCardLogStream=chSysCardLogStream, chSfmUtil1Min=chSfmUtil1Min, chSysPowerSupplyType=chSysPowerSupplyType, chSysProcessorSlotIndex=chSysProcessorSlotIndex, f10ChassisMibObject=f10ChassisMibObject, f10SystemGroup=f10SystemGroup, chAlarmPowersupplyDown=chAlarmPowersupplyDown, chSysPowerSupplyOperStatus=chSysPowerSupplyOperStatus, chAlarmRpmDown=chAlarmRpmDown, chAlarmTaskSuspend=chAlarmTaskSuspend, chSysPortType=chSysPortType, chAlarmTaskTerm=chAlarmTaskTerm, chSysCardVendorId=chSysCardVendorId, chRpmNumRpms=chRpmNumRpms, chType=chType, chNumPowerSupplies=chNumPowerSupplies, chAlarmMibNotifications=chAlarmMibNotifications, chNumFanTrays=chNumFanTrays, chSysCardOperStatus=chSysCardOperStatus, chSysCardNumPhyPorts=chSysCardNumPhyPorts, f10ChassisMibConformance=f10ChassisMibConformance, chAlarmMajorSfmDownClr=chAlarmMajorSfmDownClr, chSysFanTrayEntry=chSysFanTrayEntry, chAlarmClrCpuThreshold=chAlarmClrCpuThreshold, chAlarmFanTrayDown=chAlarmFanTrayDown, chAlarmMinorTemperatureHigh=chAlarmMinorTemperatureHigh, chSysCardUpTime=chSysCardUpTime, chSysCardPartNum=chSysCardPartNum, chSysProcessorNvramSize=chSysProcessorNvramSize, chAlarmVarPort=chAlarmVarPort, chSysFanTrayOperStatus=chSysFanTrayOperStatus, chAlarmMinorFanBad=chAlarmMinorFanBad, chLineCardUtilTable=chLineCardUtilTable, f10ChassisMibCompliances=f10ChassisMibCompliances, chSysPortOperStatus=chSysPortOperStatus, chLineCardCpuUtil5Min=chLineCardCpuUtil5Min, chAlarmCutoff=chAlarmCutoff, chSysPortTable=chSysPortTable, chSysSfmProductRev=chSysSfmProductRev, f10ChassisMibCompliance=f10ChassisMibCompliance, chSysPowerSupplyIndex=chSysPowerSupplyIndex, chAlarmCardOffline=chAlarmCardOffline, chLineCardCpuUtil1Min=chLineCardCpuUtil1Min, chSysSwSlotIndex=chSysSwSlotIndex, chSysCardParityPhantomError=chSysCardParityPhantomError, chVendorId=chVendorId, chSysPowerSupplyEntry=chSysPowerSupplyEntry, chProductRev=chProductRev, chSysSwBackupBootImgDate=chSysSwBackupBootImgDate, chSysProcessorEntry=chSysProcessorEntry, chRpmFlashStatus=chRpmFlashStatus, chSysCardProductRev=chSysCardProductRev, chRpmCpuIndex=chRpmCpuIndex, chRpmMajorAlarmStatus=chRpmMajorAlarmStatus, chAlarmCardMismatch=chAlarmCardMismatch, chAlarmMinorPS=chAlarmMinorPS, chRpmUptime=chRpmUptime, chAlarmMajorPSClr=chAlarmMajorPSClr, chAlarmVrrpGiveupMaster=chAlarmVrrpGiveupMaster, chSysSfmVendorId=chSysSfmVendorId, chSysSfmGroup=chSysSfmGroup, chRpmLastSwitchDate=chRpmLastSwitchDate, chSysCardLowerTemp=chSysCardLowerTemp, chRpmCOAlarmStatus=chRpmCOAlarmStatus, chSysSfmCountryCode=chSysSfmCountryCode, chSysSfmSerialNumber=chSysSfmSerialNumber, chSysProcessorTable=chSysProcessorTable, chSysSfmPartNum=chSysSfmPartNum, chRpmUtilEntry=chRpmUtilEntry, chAlarmMacStationMove=chAlarmMacStationMove, chAlarmVarSlot=chAlarmVarSlot, chSysProcessorUpTime=chSysProcessorUpTime, chSysSfmTable=chSysSfmTable, chAlarmMinorTemperatureClear=chAlarmMinorTemperatureClear, chAlarmExdMemThreshold=chAlarmExdMemThreshold, chNumAirFilters=chNumAirFilters, chSysPortAdminStatus=chSysPortAdminStatus, chLineCardUtilEntry=chLineCardUtilEntry, chSysCardNumber=chSysCardNumber, chAlarmMinorSfmDown=chAlarmMinorSfmDown, chSlot1to16=chSlot1to16, chRpmUtilTable=chRpmUtilTable, chAlarmSfmRemove=chAlarmSfmRemove, chSysProcessorModule=chSysProcessorModule, chSfmUtil5Sec=chSfmUtil5Sec, chAlarmCardRemove=chAlarmCardRemove, chSysSwCurrentBootImgStatus=chSysSwCurrentBootImgStatus, f10LineCardGroup=f10LineCardGroup, chAlarmRpmPrimary=chAlarmRpmPrimary, chAlarmVarInteger=chAlarmVarInteger, chSysProcessorIndex=chSysProcessorIndex, chAlarmBgpXsition=chAlarmBgpXsition, chSysSfmErrorStatus=chSysSfmErrorStatus, chAlarmExdCpuThreshold=chAlarmExdCpuThreshold, chMfgDate=chMfgDate, chAlarmCardReset=chAlarmCardReset, chAlarmPowersupplyClear=chAlarmPowersupplyClear, chSysCardEcLevel=chSysCardEcLevel, chRpmObjects=chRpmObjects, chAlarmMajorPS=chAlarmMajorPS, chSysSwCurrentBootImgVersion=chSysSwCurrentBootImgVersion, chAlarmVarString=chAlarmVarString, chSysPortIfIndex=chSysPortIfIndex, chRpmCpuUtil1Min=chRpmCpuUtil1Min, chAlarmSfmUp=chAlarmSfmUp, chSysSfmAdminStatus=chSysSfmAdminStatus, chProductOrder=chProductOrder, chAlarmCardVersionMismatch=chAlarmCardVersionMismatch, chSysFanTrayIndex=chSysFanTrayIndex, chCountryCode=chCountryCode, chRpmCpuType=chRpmCpuType)
