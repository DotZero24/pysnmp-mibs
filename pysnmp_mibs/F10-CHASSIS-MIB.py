...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:43:14 2025
...
F10SlotState, F10ChassisMode, F10HundredthdB, F10SystemCardType, F10ProcessorModuleType, F10CardOperStatus, F10MfgDate, F10SystemPortType, F10ChassisType, F10SwDate = mibBuilder.importSymbols("FORCE10-TC", "F10SlotState", "F10ChassisMode", "F10HundredthdB", "F10SystemCardType", "F10ProcessorModuleType", "F10CardOperStatus", "F10MfgDate", "F10SystemPortType", "F10ChassisType", "F10SwDate")
...
mibBuilder.exportSymbols("F10-CHASSIS-MIB", chSysProcessorSlotIndex=chSysProcessorSlotIndex, chSysPowerSupplyOperStatus=chSysPowerSupplyOperStatus, chLineCardCpuUtil1Min=chLineCardCpuUtil1Min, chAlarmFanTrayOrPsuDown=chAlarmFanTrayOrPsuDown, chSysProcessorNvramSize=chSysProcessorNvramSize, chSysPowerSupplyTable=chSysPowerSupplyTable, chSysFanTrayEntry=chSysFanTrayEntry, chAlarmMinorTemperatureClear=chAlarmMinorTemperatureClear, chSysSfmSerialNumber=chSysSfmSerialNumber, chSysCardAdminStatus=chSysCardAdminStatus, chAlarmFanTrayOrPsuClear=chAlarmFanTrayOrPsuClear, chLineCardCpuUtil5Min=chLineCardCpuUtil5Min, chSysSfmPartNum=chSysSfmPartNum, chSysSwProcessorIndex=chSysSwProcessorIndex, chSysCardProdOrder=chSysCardProdOrder, chPartNum=chPartNum, chSysProcessorEntry=chSysProcessorEntry, chAlarmRpmDown=chAlarmRpmDown, chAlarmVariable=chAlarmVariable, chAlarmMinorFanBad=chAlarmMinorFanBad, chSysCardOperStatus=chSysCardOperStatus, chSysProcessorMemSize=chSysProcessorMemSize, chSysSfmCountryCode=chSysSfmCountryCode, chSfmUtil5Min=chSfmUtil5Min, chSfmUtil1Min=chSfmUtil1Min, chSysCardParityRecoverableError=chSysCardParityRecoverableError, chSysXfpRecvPower=chSysXfpRecvPower, chSysPortIndex=chSysPortIndex, chSysCardProductRev=chSysCardProductRev, chAlarmVarPort=chAlarmVarPort, f10ChassisMibCompliance=f10ChassisMibCompliance, f10LineCardGroup=f10LineCardGroup, chSysSfmEntry=chSysSfmEntry, chProductRev=chProductRev, chRpmCOAlarmStatus=chRpmCOAlarmStatus, chAlarmCardRemove=chAlarmCardRemove, chAlarmMinorTemperatureHigh=chAlarmMinorTemperatureHigh, chSysObjects=chSysObjects, chNumPowerSupplies=chNumPowerSupplies, chSysFanTrayOperStatus=chSysFanTrayOperStatus, chAlarmCardReset=chAlarmCardReset, chLineCardUtilEntry=chLineCardUtilEntry, chAlarmSfmUp=chAlarmSfmUp, chAlarmCardUp=chAlarmCardUp, chAlarmTaskSuspend=chAlarmTaskSuspend, chSysProcessorModule=chSysProcessorModule, chRpmUtilEntry=chRpmUtilEntry, chAlarmMajorSfmDown=chAlarmMajorSfmDown, chSysCardVendorId=chSysCardVendorId, chAlarmUnsupportedOptic=chAlarmUnsupportedOptic, chAlarmCardDown=chAlarmCardDown, chVendorId=chVendorId, chAlarmSfmDown=chAlarmSfmDown, chRpmNumRpms=chRpmNumRpms, chRpmSlotNumber=chRpmSlotNumber, chRpmCpuIndex=chRpmCpuIndex, chRpmLastSwitchDate=chRpmLastSwitchDate, chAlarmMinorFanBadClear=chAlarmMinorFanBadClear, chSysPortIfIndex=chSysPortIfIndex, f10ChassisMibConformance=f10ChassisMibConformance, chSysSwBackupBootImgStatus=chSysSwBackupBootImgStatus, chSysPortTable=chSysPortTable, chSysPortAdminStatus=chSysPortAdminStatus, chAlarmMacStationMove=chAlarmMacStationMove, chLineCardMemUsageUtil=chLineCardMemUsageUtil, chAlarmObjects=chAlarmObjects, f10ChassisMibGroups=f10ChassisMibGroups, chAlarmCardOffline=chAlarmCardOffline, chType=chType, chSysSwBackupBootImgDate=chSysSwBackupBootImgDate, chSysCardPartNum=chSysCardPartNum, chSysSwRuntimeImgDate=chSysSwRuntimeImgDate, chRpmObjects=chRpmObjects, chAlarmVarString=chAlarmVarString, chRpmCpuUtil1Min=chRpmCpuUtil1Min, chAlarmBgpEstb=chAlarmBgpEstb, chAlarmMinorPSClr=chAlarmMinorPSClr, chAlarmRpmPrimary=chAlarmRpmPrimary, chSysPortType=chSysPortType, chNumAirFilters=chNumAirFilters, chSnmpIpAclDeny=chSnmpIpAclDeny, chAlarmVarSlot=chAlarmVarSlot, chSysSfmProdOrder=chSysSfmProdOrder, chAlarmPowersupplyClear=chAlarmPowersupplyClear, chAlarmSfmAdd=chAlarmSfmAdd, chSysCardNumLgcPorts=chSysCardNumLgcPorts, chSysPortOperStatus=chSysPortOperStatus, chNumSfmSlots=chNumSfmSlots, chAlarmCardProblem=chAlarmCardProblem, chSysPowerSupplyType=chSysPowerSupplyType, chSysCardType=chSysCardType, chSysCardMfgDate=chSysCardMfgDate, chRpmFlashStatus=chRpmFlashStatus, chRpmCpuUtil5Min=chRpmCpuUtil5Min, chSysFanTrayTable=chSysFanTrayTable, chSysCardTable=chSysCardTable, chAlarmCutoff=chAlarmCutoff, chSysSfmEcLevel=chSysSfmEcLevel, f10SystemGroup=f10SystemGroup, chAlarmExdMemThreshold=chAlarmExdMemThreshold, chAlarmVrrpGiveupMaster=chAlarmVrrpGiveupMaster, chSysCardUpperTemp=chSysCardUpperTemp, f10ChassisNotificationGroup=f10ChassisNotificationGroup, chNumFanTrays=chNumFanTrays, chSysCardNumPhyPorts=chSysCardNumPhyPorts, chAlarmMinorSfmDown=chAlarmMinorSfmDown, chAlarmAcDcMixedPowerSupplyDetect=chAlarmAcDcMixedPowerSupplyDetect, chAlarmRpmUp=chAlarmRpmUp, chAlarmPowersupplyDown=chAlarmPowersupplyDown, chAlarmMajorTemperatureClear=chAlarmMajorTemperatureClear, chSysPowerSupplyEntry=chSysPowerSupplyEntry, chSysCardEcLevel=chSysCardEcLevel, chRpmCpuUtil5Sec=chRpmCpuUtil5Sec, chRpmMemUsageUtil=chRpmMemUsageUtil, chSysSwCurrentBootImgVersion=chSysSwCurrentBootImgVersion, chSysCardFaultStatus=chSysCardFaultStatus, chSysSwCurrentBootImgDate=chSysSwCurrentBootImgDate, chSysSfmGroup=chSysSfmGroup, chSysPowerSupplyIndex=chSysPowerSupplyIndex, chObjects=chObjects, chSysSfmErrorStatus=chSysSfmErrorStatus, chSysSwRuntimeImgVersion=chSysSwRuntimeImgVersion, chCountryCode=chCountryCode, chMfgDate=chMfgDate, chSysSfmMfgDate=chSysSfmMfgDate, chAlarmMibNotifications=chAlarmMibNotifications, chSysSwCurrentBootImage=chSysSwCurrentBootImage, chSysProcessorIndex=chSysProcessorIndex, f10ChassisMibObject=f10ChassisMibObject, chRpmMajorAlarmStatus=chRpmMajorAlarmStatus, chAlarmSRAMParityErrorDetect=chAlarmSRAMParityErrorDetect, chRpmUtilTable=chRpmUtilTable, chAlarmBgpXsition=chAlarmBgpXsition, chRpmUptime=chRpmUptime, chSysSfmIndex=chSysSfmIndex, chEcLevel=chEcLevel, chAlarmClrMemThreshold=chAlarmClrMemThreshold, chProductOrder=chProductOrder, f10ChassisMib=f10ChassisMib, chSysSfmVendorId=chSysSfmVendorId, chSysCardLogStream=chSysCardLogStream, chAlarmTaskTerm=chAlarmTaskTerm, chSysSfmAdminStatus=chSysSfmAdminStatus, chAlarmFanTrayClear=chAlarmFanTrayClear, chSysProcessorTable=chSysProcessorTable, chSysCardNumber=chSysCardNumber, chSysSwModuleEntry=chSysSwModuleEntry, chSysCardParityPhantomError=chSysCardParityPhantomError, chSfmUtil5Sec=chSfmUtil5Sec, chSysCardEntry=chSysCardEntry, chAlarmMajorPS=chAlarmMajorPS, chLineCardObjects=chLineCardObjects, chSysSwCurrentBootImgStatus=chSysSwCurrentBootImgStatus, f10ChassisMibCompliances=f10ChassisMibCompliances, chAlarmClrCpuThreshold=chAlarmClrCpuThreshold, chLineCardCpuUtil5Sec=chLineCardCpuUtil5Sec, chSysPortEntry=chSysPortEntry, chRpmCpuType=chRpmCpuType, f10ComponentGroup=f10ComponentGroup, chAlarmMajorSfmDownClr=chAlarmMajorSfmDownClr, chSysSwNextRebootImage=chSysSwNextRebootImage, chSysPortSlotIndex=chSysPortSlotIndex, chSysCardSlotIndex=chSysCardSlotIndex, PYSNMP_MODULE_ID=f10ChassisMib, chSysCardParityNonrecovrableError=chSysCardParityNonrecovrableError, chAlarmSfmRemove=chAlarmSfmRemove, chAlarmMajorTemperatureHigh=chAlarmMajorTemperatureHigh, chSysSwModuleTable=chSysSwModuleTable, chSysProcessorUpTime=chSysProcessorUpTime, chAlarmCardMismatch=chAlarmCardMismatch, chSysFanTrayIndex=chSysFanTrayIndex, chNumSlots=chNumSlots, chAlarmFanTrayDown=chAlarmFanTrayDown, chChassisMode=chChassisMode, chAlarmMinorSfmDownClr=chAlarmMinorSfmDownClr, chSysSwBackupBootImgVersion=chSysSwBackupBootImgVersion, chAlarmMajorPSClr=chAlarmMajorPSClr, chSysSfmProductRev=chSysSfmProductRev, chRpmMinorAlarmStatus=chRpmMinorAlarmStatus, chSlot1to16=chSlot1to16, chSysCardLowerTemp=chSysCardLowerTemp, chSysSfmOperStatus=chSysSfmOperStatus, chLineCardUtilTable=chLineCardUtilTable, chSysCardSerialNumber=chSysCardSerialNumber, chSysSfmTable=chSysSfmTable, chAlarmVrrpGoMaster=chAlarmVrrpGoMaster, chAlarmMinorPS=chAlarmMinorPS, f10RpmGroup=f10RpmGroup, chSerialNumber=chSerialNumber, chSysCardNumProcessors=chSysCardNumProcessors, chSysCardUpTime=chSysCardUpTime, chAlarmCardVersionMismatch=chAlarmCardVersionMismatch, chSysProcessorLogStream=chSysProcessorLogStream, chAlarmExdCpuThreshold=chAlarmExdCpuThreshold, chSysCardCountryCode=chSysCardCountryCode, chSysSwSlotIndex=chSysSwSlotIndex, chAlarmVarInteger=chAlarmVarInteger)
