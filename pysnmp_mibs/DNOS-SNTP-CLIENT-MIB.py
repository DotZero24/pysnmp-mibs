...
InetAddress,InetAddressType,InetPortNumber=mibBuilder.importSymbols('INET-ADDRESS-MIB',_I,'InetAddressType',_J)
ModuleCompliance,NotificationGroup,ObjectGroup=mibBuilder.importSymbols('SNMPv2-CONF','ModuleCompliance','NotificationGroup','ObjectGroup')
Bits,Counter32,Counter64,Gauge32,Integer32,IpAddress,ModuleIdentity,MibIdentifier,NotificationType,ObjectIdentity,MibScalar,MibTable,MibTableRow,MibTableColumn,TimeTicks,Unsigned32,iso=mibBuilder.importSymbols('SNMPv2-SMI','Bits','Counter32','Counter64',_M,_G,'IpAddress','ModuleIdentity','MibIdentifier','NotificationType','ObjectIdentity','MibScalar','MibTable','MibTableRow','MibTableColumn','TimeTicks',_D,'iso')
...
if mibBuilder.loadTexts:agentSntpClientMIB.setRevisions(('2020-12-07 00:00','2011-12-14 00:00','2011-01-26 00:00','2007-05-23 00:00','2003-12-18 16:29'))
class SntpClientAdminMode(TextualConvention,Bits):status=_A;namedValues=NamedValues(*((_N,0),(_O,1),(_P,2),(_Q,3)))
class SntpClientUpdateStatus(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8)));namedValues=NamedValues(*(('other',1),('success',2),('requestTimedOut',3),('badDateEncoded',4),('versionNotSupported',5),('serverUnsychronized',6),('serverKissOfDeath',7),('serverKoDRateExceeded',8)))
_AgentSntpClientObjects_ObjectIdentity=ObjectIdentity
agentSntpClientObjects=_AgentSntpClientObjects_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1))
_AgentSntpClient_ObjectIdentity=ObjectIdentity
agentSntpClient=_AgentSntpClient_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1))
...
_AgentSntpClientVersion_Type.__name__=_G
_AgentSntpClientVersion_Object=MibScalar
agentSntpClientVersion=_AgentSntpClientVersion_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,1),_AgentSntpClientVersion_Type())
...
agentSntpClientSupportedMode=_AgentSntpClientSupportedMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,2),_AgentSntpClientSupportedMode_Type())
...
_AgentSntpClientMode_Type.__name__=_G
_AgentSntpClientMode_Object=MibScalar
agentSntpClientMode=_AgentSntpClientMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,3),_AgentSntpClientMode_Type())
agentSntpClientMode.setMaxAccess(_E)
if mibBuilder.loadTexts:agentSntpClientMode.setStatus(_A)
class _AgentSntpClientPort_Type(InetPortNumber):defaultValue=0;subtypeSpec=InetPortNumber.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,0),ValueRangeConstraint(123,123),ValueRangeConstraint(1025,65535))
_AgentSntpClientPort_Type.__name__=_J
_AgentSntpClientPort_Object=MibScalar
agentSntpClientPort=_AgentSntpClientPort_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,4),_AgentSntpClientPort_Type())
agentSntpClientPort.setMaxAccess(_E)
...
agentSntpClientLastUpdateTime=_AgentSntpClientLastUpdateTime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,5),_AgentSntpClientLastUpdateTime_Type())
...
agentSntpClientLastAttemptTime=_AgentSntpClientLastAttemptTime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,6),_AgentSntpClientLastAttemptTime_Type())
...
_AgentSntpClientLastAttemptStatus_Type.__name__=_K
_AgentSntpClientLastAttemptStatus_Object=MibScalar
agentSntpClientLastAttemptStatus=_AgentSntpClientLastAttemptStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,7),_AgentSntpClientLastAttemptStatus_Type())
...
agentSntpClientServerAddressType=_AgentSntpClientServerAddressType_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,8),_AgentSntpClientServerAddressType_Type())
agentSntpClientServerAddressType.setMaxAccess(_C)
if mibBuilder.loadTexts:agentSntpClientServerAddressType.setStatus(_A)
class _AgentSntpClientServerAddress_Type(InetAddress):subtypeSpec=InetAddress.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(1,64))
_AgentSntpClientServerAddress_Type.__name__=_I
_AgentSntpClientServerAddress_Object=MibScalar
agentSntpClientServerAddress=_AgentSntpClientServerAddress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,9),_AgentSntpClientServerAddress_Type())
...
_AgentSntpClientServerMode_Type.__name__=_D
_AgentSntpClientServerMode_Object=MibScalar
agentSntpClientServerMode=_AgentSntpClientServerMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,10),_AgentSntpClientServerMode_Type())
...
_AgentSntpClientServerStratum_Type.__name__=_D
_AgentSntpClientServerStratum_Object=MibScalar
agentSntpClientServerStratum=_AgentSntpClientServerStratum_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,11),_AgentSntpClientServerStratum_Type())
...
_AgentSntpClientServerRefClkId_Type.__name__=_L
_AgentSntpClientServerRefClkId_Object=MibScalar
agentSntpClientServerRefClkId=_AgentSntpClientServerRefClkId_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,12),_AgentSntpClientServerRefClkId_Type())
...
_AgentSntpClientPollInterval_Type.__name__=_D
_AgentSntpClientPollInterval_Object=MibScalar
agentSntpClientPollInterval=_AgentSntpClientPollInterval_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,13),_AgentSntpClientPollInterval_Type())
agentSntpClientPollInterval.setMaxAccess(_E)
...
agentSntpClientSourceInterface=_AgentSntpClientSourceInterface_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,14),_AgentSntpClientSourceInterface_Type())
agentSntpClientSourceInterface.setMaxAccess(_E)
if mibBuilder.loadTexts:agentSntpClientSourceInterface.setStatus(_A)
class _AgentSntpClientServicePortSrcInterface_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('servicePortEnable',1),('servicePortDisable',2)))
_AgentSntpClientServicePortSrcInterface_Type.__name__=_G
_AgentSntpClientServicePortSrcInterface_Object=MibScalar
agentSntpClientServicePortSrcInterface=_AgentSntpClientServicePortSrcInterface_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,1,15),_AgentSntpClientServicePortSrcInterface_Type())
agentSntpClientServicePortSrcInterface.setMaxAccess(_E)
if mibBuilder.loadTexts:agentSntpClientServicePortSrcInterface.setStatus(_A)
_AgentSntpClientUnicast_ObjectIdentity=ObjectIdentity
agentSntpClientUnicast=_AgentSntpClientUnicast_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2))
...
_AgentSntpClientUnicastPollInterval_Type.__name__=_D
_AgentSntpClientUnicastPollInterval_Object=MibScalar
agentSntpClientUnicastPollInterval=_AgentSntpClientUnicastPollInterval_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,1),_AgentSntpClientUnicastPollInterval_Type())
agentSntpClientUnicastPollInterval.setMaxAccess(_E)
...
_AgentSntpClientUnicastPollTimeout_Type.__name__=_D
_AgentSntpClientUnicastPollTimeout_Object=MibScalar
agentSntpClientUnicastPollTimeout=_AgentSntpClientUnicastPollTimeout_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,2),_AgentSntpClientUnicastPollTimeout_Type())
agentSntpClientUnicastPollTimeout.setMaxAccess(_E)
...
_AgentSntpClientUnicastPollRetry_Type.__name__=_D
_AgentSntpClientUnicastPollRetry_Object=MibScalar
agentSntpClientUnicastPollRetry=_AgentSntpClientUnicastPollRetry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,3),_AgentSntpClientUnicastPollRetry_Type())
agentSntpClientUnicastPollRetry.setMaxAccess(_E)
...
agentSntpClientUcastServerMaxEntries=_AgentSntpClientUcastServerMaxEntries_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,4),_AgentSntpClientUcastServerMaxEntries_Type())
...
_AgentSntpClientUcastServerCurrEntries_Type.__name__=_M
_AgentSntpClientUcastServerCurrEntries_Object=MibScalar
agentSntpClientUcastServerCurrEntries=_AgentSntpClientUcastServerCurrEntries_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,5),_AgentSntpClientUcastServerCurrEntries_Type())
...
agentSntpClientUcastServerTable=_AgentSntpClientUcastServerTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6))
if mibBuilder.loadTexts:agentSntpClientUcastServerTable.setStatus(_A)
_AgentSntpClientUcastServerEntry_Object=MibTableRow
agentSntpClientUcastServerEntry=_AgentSntpClientUcastServerEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1))
...
agentSntpClientUcastServerIndex=_AgentSntpClientUcastServerIndex_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,1),_AgentSntpClientUcastServerIndex_Type())
...
agentSntpClientUcastServerAddressType=_AgentSntpClientUcastServerAddressType_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,2),_AgentSntpClientUcastServerAddressType_Type())
agentSntpClientUcastServerAddressType.setMaxAccess(_F)
if mibBuilder.loadTexts:agentSntpClientUcastServerAddressType.setStatus(_A)
class _AgentSntpClientUcastServerAddress_Type(InetAddress):subtypeSpec=InetAddress.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(1,64))
_AgentSntpClientUcastServerAddress_Type.__name__=_I
_AgentSntpClientUcastServerAddress_Object=MibTableColumn
agentSntpClientUcastServerAddress=_AgentSntpClientUcastServerAddress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,3),_AgentSntpClientUcastServerAddress_Type())
agentSntpClientUcastServerAddress.setMaxAccess(_F)
if mibBuilder.loadTexts:agentSntpClientUcastServerAddress.setStatus(_A)
class _AgentSntpClientUcastServerPort_Type(InetPortNumber):defaultValue=123;subtypeSpec=InetPortNumber.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,65535))
_AgentSntpClientUcastServerPort_Type.__name__=_J
_AgentSntpClientUcastServerPort_Object=MibTableColumn
agentSntpClientUcastServerPort=_AgentSntpClientUcastServerPort_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,4),_AgentSntpClientUcastServerPort_Type())
agentSntpClientUcastServerPort.setMaxAccess(_F)
...
_AgentSntpClientUcastServerVersion_Type.__name__=_G
_AgentSntpClientUcastServerVersion_Object=MibTableColumn
agentSntpClientUcastServerVersion=_AgentSntpClientUcastServerVersion_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,5),_AgentSntpClientUcastServerVersion_Type())
agentSntpClientUcastServerVersion.setMaxAccess(_F)
...
_AgentSntpClientUcastServerPrecedence_Type.__name__=_D
_AgentSntpClientUcastServerPrecedence_Object=MibTableColumn
agentSntpClientUcastServerPrecedence=_AgentSntpClientUcastServerPrecedence_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,6),_AgentSntpClientUcastServerPrecedence_Type())
agentSntpClientUcastServerPrecedence.setMaxAccess(_F)
...
agentSntpClientUcastServerLastUpdateTime=_AgentSntpClientUcastServerLastUpdateTime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,7),_AgentSntpClientUcastServerLastUpdateTime_Type())
...
agentSntpClientUcastServerLastAttemptTime=_AgentSntpClientUcastServerLastAttemptTime_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,8),_AgentSntpClientUcastServerLastAttemptTime_Type())
...
_AgentSntpClientUcastServerLastAttemptStatus_Type.__name__=_K
_AgentSntpClientUcastServerLastAttemptStatus_Object=MibTableColumn
agentSntpClientUcastServerLastAttemptStatus=_AgentSntpClientUcastServerLastAttemptStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,9),_AgentSntpClientUcastServerLastAttemptStatus_Type())
...
agentSntpClientUcastServerNumRequests=_AgentSntpClientUcastServerNumRequests_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,10),_AgentSntpClientUcastServerNumRequests_Type())
...
agentSntpClientUcastServerNumFailedRequests=_AgentSntpClientUcastServerNumFailedRequests_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,11),_AgentSntpClientUcastServerNumFailedRequests_Type())
...
agentSntpClientUcastServerRowStatus=_AgentSntpClientUcastServerRowStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,2,6,1,12),_AgentSntpClientUcastServerRowStatus_Type())
agentSntpClientUcastServerRowStatus.setMaxAccess(_F)
...
agentSntpClientBroadcast=_AgentSntpClientBroadcast_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,3))
_AgentSntpClientBroadcastCount_Type=Counter32
_AgentSntpClientBroadcastCount_Object=MibScalar
agentSntpClientBroadcastCount=_AgentSntpClientBroadcastCount_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,3,1),_AgentSntpClientBroadcastCount_Type())
...
_AgentSntpClientBroadcastInterval_Type.__name__=_D
_AgentSntpClientBroadcastInterval_Object=MibScalar
agentSntpClientBroadcastInterval=_AgentSntpClientBroadcastInterval_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,1,3,2),_AgentSntpClientBroadcastInterval_Type())
agentSntpClientBroadcastInterval.setMaxAccess(_E)
...
agentSntpClientConformance=_AgentSntpClientConformance_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,2))
_AgentSntpClientGroups_ObjectIdentity=ObjectIdentity
agentSntpClientGroups=_AgentSntpClientGroups_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,2,1))
_AgentSntpClientCompliances_ObjectIdentity=ObjectIdentity
agentSntpClientCompliances=_AgentSntpClientCompliances_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,2,2))
agentSntpClientDeviceGroup=ObjectGroup((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,2,1,1))
...
agentSntpClientUnicastGroup=ObjectGroup((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,17,2,1,2))
