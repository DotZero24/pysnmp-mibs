...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/dell/DNOS-SNTP-CLIENT-MIB
...
agentSntpClientMIB.setRevisions(('2020-12-07 00:00', '2011-12-14 00:00', '2011-01-26 00:00', '2007-05-23 00:00', '2003-12-18 16:29',))
if mibBuilder.loadTexts: agentSntpClientMIB.setLastUpdated('202012070000Z')
if mibBuilder.loadTexts: agentSntpClientMIB.setOrganization('Dell')
...
agentSntpClientServicePortSrcInterface = MibScalar((1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 17, 1, 1, 15), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("servicePortEnable", 1), ("servicePortDisable", 2)))).setMaxAccess("readwrite")
