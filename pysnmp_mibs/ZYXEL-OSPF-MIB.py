...
# Notes
# -----
# ASN.1 source file://mibs/zyxel/ZYXEL-OSPF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:02:14 2025
...
zyOspfAreaDefaultRouteMetric = _ZyOspfAreaDefaultRouteMetric_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 57, 1, 2, 1, 2),
    _ZyOspfAreaDefaultRouteMetric_Type()
)
zyOspfAreaDefaultRouteMetric.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyOspfAreaDefaultRouteMetric.setStatus("current")
...
zyOspfSummaryAddressMaskBits.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
zyOspfDefaultInformationOriginateState = _ZyOspfDefaultInformationOriginateState_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 57, 1, 8),
    _ZyOspfDefaultInformationOriginateState_Type()
)
zyOspfDefaultInformationOriginateState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyOspfDefaultInformationOriginateState.setStatus("current")
_ZyOspfDefaultInformationOriginateAlways_Type = EnabledStatus
_ZyOspfDefaultInformationOriginateAlways_Object = MibScalar
zyOspfDefaultInformationOriginateAlways = _ZyOspfDefaultInformationOriginateAlways_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 57, 1, 9),
    _ZyOspfDefaultInformationOriginateAlways_Type()
)
zyOspfDefaultInformationOriginateAlways.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyOspfDefaultInformationOriginateAlways.setStatus("current")
_ZyOspfDefaultInformationOriginateMetric_Type = Integer32
_ZyOspfDefaultInformationOriginateMetric_Object = MibScalar
zyOspfDefaultInformationOriginateMetric = _ZyOspfDefaultInformationOriginateMetric_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 57, 1, 10),
    _ZyOspfDefaultInformationOriginateMetric_Type()
)
zyOspfDefaultInformationOriginateMetric.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyOspfDefaultInformationOriginateMetric.setStatus("current")
_ZyOspfDefaultInformationOriginateMetricType_Type = Integer32
_ZyOspfDefaultInformationOriginateMetricType_Object = MibScalar
zyOspfDefaultInformationOriginateMetricType = _ZyOspfDefaultInformationOriginateMetricType_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 57, 1, 11),
    _ZyOspfDefaultInformationOriginateMetricType_Type()
)
zyOspfDefaultInformationOriginateMetricType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyOspfDefaultInformationOriginateMetricType.setStatus("current")
...
zyxelOspfNotifications = _ZyxelOspfNotifications_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 57, 3)
)
...
zyOspfExceedMaxDynamicRoutePath = NotificationType(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 57, 3, 1)
)
if mibBuilder.loadTexts:
    zyOspfExceedMaxDynamicRoutePath.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"zyxelOspf": zyxelOspf,
       ...
       "zyOspfAreaDefaultRouteMetric": zyOspfAreaDefaultRouteMetric,
       ...
       "zyOspfDefaultInformationOriginateState": zyOspfDefaultInformationOriginateState,
       "zyOspfDefaultInformationOriginateAlways": zyOspfDefaultInformationOriginateAlways,
       "zyOspfDefaultInformationOriginateMetric": zyOspfDefaultInformationOriginateMetric,
       "zyOspfDefaultInformationOriginateMetricType": zyOspfDefaultInformationOriginateMetricType,
       ...
       "zyxelOspfNotifications": zyxelOspfNotifications,
       "zyOspfExceedMaxDynamicRoutePath": zyOspfExceedMaxDynamicRoutePath}
)
