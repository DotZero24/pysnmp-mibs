...
lumMuxMIB, lumModules = mibBuilder.importSymbols("LUM-REG", "lumMuxMIB", "lumModules")
PortNumber, FaultStatus, LambdaFrequency, MgmtNameString, ObjectProperty, BoardOrInterfaceOperStatus, SlotNumber, SubrackNumber, BoardOrInterfaceAdminStatus = mibBuilder.importSymbols("LUM-TC", "PortNumber", "FaultStatus", "LambdaFrequency", "MgmtNameString", "ObjectProperty", "BoardOrInterfaceOperStatus", "SlotNumber", "SubrackNumber", "BoardOrInterfaceAdminStatus")
...
mibBuilder.exportSymbols("LUM-MUX-MIB", muxIfTraceTransmitted=muxIfTraceTransmitted, muxIfSubrack=muxIfSubrack, muxIfTrxCodeMismatch=muxIfTrxCodeMismatch, muxVc4Table=muxVc4Table, muxVc4ClientDropPort=muxVc4ClientDropPort, muxVc4GroupV2=muxVc4GroupV2, muxVc4AdminStatus=muxVc4AdminStatus, muxIfTable=muxIfTable, muxIfExpectedTxLambda=muxIfExpectedTxLambda, muxIfIllegalFrequency=muxIfIllegalFrequency, muxIfSlot=muxIfSlot, MuxTxDirection=MuxTxDirection, muxVc4ClientAddPort=muxVc4ClientAddPort, lumMuxConfs=lumMuxConfs, muxIfPowerLevelLowRelativeThreshold=muxIfPowerLevelLowRelativeThreshold, muxVc4Group=muxVc4Group, muxVc4Index=muxVc4Index, muxVc4Vc4=muxVc4Vc4, muxGeneral=muxGeneral, muxVc4Subrack=muxVc4Subrack, lumMuxBasicComplV19=lumMuxBasicComplV19, muxVc4GroupV4=muxVc4GroupV4, muxIfOHTransparency=muxIfOHTransparency, muxIfLossOfSignal=muxIfLossOfSignal, muxGeneralLastChangeTime=muxGeneralLastChangeTime, muxIfGroupV3=muxIfGroupV3, muxIfGroupV6=muxIfGroupV6, muxIfTraceMismatch=muxIfTraceMismatch, muxVc4GroupV7=muxVc4GroupV7, muxIfRxPort=muxIfRxPort, muxIfTraceAlarmMode=muxIfTraceAlarmMode, lumMuxBasicComplV17=lumMuxBasicComplV17, lumMuxBasicComplV14=lumMuxBasicComplV14, muxIfTxDirection=muxIfTxDirection, muxIfLaserStatus=muxIfLaserStatus, muxIfOperStatus=muxIfOperStatus, PYSNMP_MODULE_ID=lumMuxMIBModule, muxIfHighSpeedMin=muxIfHighSpeedMin, muxIfReceiverSensitivity=muxIfReceiverSensitivity, lumMuxBasicComplV10=lumMuxBasicComplV10, muxIfPowerLevel=muxIfPowerLevel, muxVc4GroupV6=muxVc4GroupV6, muxIfDescr=muxIfDescr, muxIfHighSpeedMax=muxIfHighSpeedMax, lumMuxBasicComplV21=lumMuxBasicComplV21, muxIfGroupV5=muxIfGroupV5, muxVc4Entry=muxVc4Entry, muxGeneralGroupV3=muxGeneralGroupV3, lumMuxBasicComplV9=lumMuxBasicComplV9, muxIfLossOfFrame=muxIfLossOfFrame, muxIfPowerLevelHighThreshold=muxIfPowerLevelHighThreshold, muxIfGroupV12=muxIfGroupV12, muxIfList=muxIfList, lumMuxBasicComplV6=lumMuxBasicComplV6, muxVc4RxSignalStatus=muxVc4RxSignalStatus, muxIfAdminStatus=muxIfAdminStatus, muxIfEntry=muxIfEntry, muxIfTraceReceived=muxIfTraceReceived, muxVc4Name=muxVc4Name, lumMuxBasicComplV12=lumMuxBasicComplV12, lumMuxCompl=lumMuxCompl, muxIfIndex=muxIfIndex, muxVc4ConnectionStatus=muxVc4ConnectionStatus, lumMuxMIBObjects=lumMuxMIBObjects, muxVc4AuLossOfPointerW2C=muxVc4AuLossOfPointerW2C, muxIfGroupV9=muxIfGroupV9, lumMuxBasicComplV13=lumMuxBasicComplV13, muxVc4ObjectProperty=muxVc4ObjectProperty, muxGeneralMuxIfTableSize=muxGeneralMuxIfTableSize, muxIfTxLambda=muxIfTxLambda, lumMuxBasicComplV4=lumMuxBasicComplV4, lumMuxBasicComplV18=lumMuxBasicComplV18, muxVc4Slot=muxVc4Slot, muxGeneralStateLastChangeTime=muxGeneralStateLastChangeTime, muxIfReceivedPowerLow=muxIfReceivedPowerLow, muxVc4AuAlarmIndicationSignalW2C=muxVc4AuAlarmIndicationSignalW2C, muxIfTxPort=muxIfTxPort, muxIfGroupV4=muxIfGroupV4, muxIfGroupV11=muxIfGroupV11, muxVc4Mode=muxVc4Mode, muxIfTransmitterFailed=muxIfTransmitterFailed, muxIfReceivedPowerHigh=muxIfReceivedPowerHigh, muxVc4ConnectionOverview=muxVc4ConnectionOverview, muxIfGroupV7=muxIfGroupV7, muxVc4PayloadStatus=muxVc4PayloadStatus, lumMuxBasicComplV11=lumMuxBasicComplV11, muxIfGroupV10=muxIfGroupV10, lumMuxBasicComplV16=lumMuxBasicComplV16, muxIfTrxClass=muxIfTrxClass, muxGeneralMuxVc4TableSize=muxGeneralMuxVc4TableSize, lumMuxBasicComplV5=lumMuxBasicComplV5, muxIfTrxMissing=muxIfTrxMissing, muxIfTrxBitrateUnavailable=muxIfTrxBitrateUnavailable, lumMuxBasicComplV1=lumMuxBasicComplV1, muxVc4ConcatenationStatus=muxVc4ConcatenationStatus, muxGeneralGroupV2=muxGeneralGroupV2, muxVc4RxPort=muxVc4RxPort, muxIfLaserTempActual=muxIfLaserTempActual, muxVc4ConnectionMode=muxVc4ConnectionMode, muxVc4Descr=muxVc4Descr, lumMuxBasicComplV8=lumMuxBasicComplV8, muxVc4GroupV5=muxVc4GroupV5, muxIfGroupV2=muxIfGroupV2, muxIfSuppressRemoteAlarms=muxIfSuppressRemoteAlarms, muxIfTraceExpected=muxIfTraceExpected, muxIfLaserBiasThreshold=muxIfLaserBiasThreshold, muxIfBitrateMismatch=muxIfBitrateMismatch, muxIfAlarmIndicationSignal=muxIfAlarmIndicationSignal, muxGeneralGroup=muxGeneralGroup, muxVc4TxDirection=muxVc4TxDirection, muxIfTxPowerLevel=muxIfTxPowerLevel, lumMuxBasicComplV7=lumMuxBasicComplV7, muxIfName=muxIfName, muxIfUnexpectedFrequency=muxIfUnexpectedFrequency, lumMuxGroups=lumMuxGroups, muxIfGroup=muxIfGroup, lumMuxMIBModule=lumMuxMIBModule, muxIfInvPhysIndexOrZero=muxIfInvPhysIndexOrZero, muxVc4List=muxVc4List, muxVc4TxPort=muxVc4TxPort, lumMuxBasicComplV3=lumMuxBasicComplV3, muxIfLaserBias=muxIfLaserBias, lumMuxBasicComplV15=lumMuxBasicComplV15, muxIfPowerLevelLowThreshold=muxIfPowerLevelLowThreshold, muxIfObjectProperty=muxIfObjectProperty, lumMuxBasicComplV20=lumMuxBasicComplV20, muxIfGroupV8=muxIfGroupV8, muxVc4GroupV3=muxVc4GroupV3, muxIfJ0PathTrace=muxIfJ0PathTrace, lumMuxBasicComplV2=lumMuxBasicComplV2, muxIfTraceIntrusionMode=muxIfTraceIntrusionMode)
