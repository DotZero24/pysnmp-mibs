...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-MPE-DSLAM-SYSTEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:59:51 2025
...
mpeSysDevDslamAlarmCompliances.setObjects(
      *(("PDN-MPE-DSLAM-SYSTEM-MIB", "mpeSysDevDslamAlarmStateGroup"),
        ("PDN-MPE-DSLAM-SYSTEM-MIB", "mpeEntityExtNotificationGroup"),
        ("PDN-MPE-DSLAM-SYSTEM-MIB", "mpeSysDevDslamAlarmRelayGroup"),
        ("PDN-MPE-DSLAM-SYSTEM-MIB", "mpeEntPhysicalExtGroup"),
        ("PDN-MPE-DSLAM-SYSTEM-MIB", "mpeEntPhysicalExtNotificationObjectGroup"),
        ("PDN-MPE-DSLAM-SYSTEM-MIB", "mpeEntityExtPowerFailureNotificationGroup"))
)
if mibBuilder.loadTexts:
...
mpeSysDevDslamAlarmDeprecatedCompliances.setObjects(
      *(("PDN-MPE-DSLAM-SYSTEM-MIB", "mpeDslamDeprecatedObjectsGroup"),
        ("PDN-MPE-DSLAM-SYSTEM-MIB", "mpeDslamDeprecatedNotificationsGroup"))
)
if mibBuilder.loadTexts:
