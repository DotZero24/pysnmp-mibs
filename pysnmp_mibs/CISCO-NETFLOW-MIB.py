...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-NETFLOW-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:06 2025
...
cnfMIBCompliance.setObjects(
      *(("CISCO-NETFLOW-MIB", "cnfCacheInfoGroup"),
        ("CISCO-NETFLOW-MIB", "cnfProtocolStatGroup"),
        ("CISCO-NETFLOW-MIB", "cnfExportInfoGroup"),
        ("CISCO-NETFLOW-MIB", "cnfExportStatisticsGroup"),
        ("CISCO-NETFLOW-MIB", "cnfExportTemplateGroup"),
        ("CISCO-NETFLOW-MIB", "cnfTopFlowsGroup"))
)
if mibBuilder.loadTexts:
...
cnfMIBCompliance1.setObjects(
      *(("CISCO-NETFLOW-MIB", "cnfCacheInfoGroup"),
        ("CISCO-NETFLOW-MIB", "cnfProtocolStatGroup"),
        ("CISCO-NETFLOW-MIB", "cnfExportInfoGroup"),
        ("CISCO-NETFLOW-MIB", "cnfExportStatisticsGroup"),
        ("CISCO-NETFLOW-MIB", "cnfExportTemplateGroup"),
        ("CISCO-NETFLOW-MIB", "cnfTopFlowsDataGroup1"),
        ("CISCO-NETFLOW-MIB", "cnfTopFlowsDataGroup2"),
        ("CISCO-NETFLOW-MIB", "cnfTopFlowsVlanGroup"),
        ("CISCO-NETFLOW-MIB", "cnfTopFlowsControlGroup1"),
...
cnfMIBCompliance2.setObjects(
      *(("CISCO-NETFLOW-MIB", "cnfCacheInfoGroup"),
        ...
        ("CISCO-NETFLOW-MIB", "cnfTopFlowsControlGroup1"),
        ("CISCO-NETFLOW-MIB", "cnfTopFlowsControlGroup2"),
        ("CISCO-NETFLOW-MIB", "cnfMcastNetflowControlGroup"),
...
cnfMIBCompliance3.setObjects(
      *(("CISCO-NETFLOW-MIB", "cnfCacheInfoGroup"),
        ...
        ("CISCO-NETFLOW-MIB", "cnfMcastNetflowControlGroup"),
        ("CISCO-NETFLOW-MIB", "cnfBridgedFlowStatsCtrlGroup"),
        ("CISCO-NETFLOW-MIB", "cnfTopFlowsReportGenerateGroup"))
)
if mibBuilder.loadTexts:
