...
# Produced by pysmi-1.6.2 at Fri Oct 10 21:04:50 2025
...
trapIpNeighborLDP = _TrapIpNeighborLDP_Object(
    (1, 3, 6, 1, 4, 1, 3709, 3, 5, 201, 1, 14, 2, 62),
    _TrapIpNeighborLDP_Type()
)
trapIpNeighborLDP.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    trapIpNeighborLDP.setStatus("current")
...
swChangeStatusLDP.setObjects(
      *(("DMswitch-MIB", "trapDevNo"),
        ...
        ("DMswitch-MIB", "trapIpNeighborLDP"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ValidStatus": ValidStatus,
       ...
       "trapIpNeighborLDP": trapIpNeighborLDP,
