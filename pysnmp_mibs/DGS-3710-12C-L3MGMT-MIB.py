...
swL3MgmtMIB=ModuleIdentity((1,3,6,1,4,1,171,11,102,1,5,3))
...
swL3IpMgmt=_SwL3IpMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,5,3,2))
_SwL3IpCtrlMgmt_ObjectIdentity=ObjectIdentity
swL3IpCtrlMgmt=_SwL3IpCtrlMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,5,3,2,1))
_SwL3IpCtrlTable_Object=MibTable
swL3IpCtrlTable=_SwL3IpCtrlTable_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3))
if mibBuilder.loadTexts:swL3IpCtrlTable.setStatus(_A)
_SwL3IpCtrlEntry_Object=MibTableRow
swL3IpCtrlEntry=_SwL3IpCtrlEntry_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1))
...
swL3IpCtrlInterfaceName=_SwL3IpCtrlInterfaceName_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,1),_SwL3IpCtrlInterfaceName_Type())
...
swL3IpCtrlIfIndex=_SwL3IpCtrlIfIndex_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,2),_SwL3IpCtrlIfIndex_Type())
...
swL3IpCtrlIpAddr=_SwL3IpCtrlIpAddr_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,3),_SwL3IpCtrlIpAddr_Type())
...
swL3IpCtrlIpSubnetMask=_SwL3IpCtrlIpSubnetMask_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,4),_SwL3IpCtrlIpSubnetMask_Type())
...
swL3IpCtrlVlanName=_SwL3IpCtrlVlanName_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,5),_SwL3IpCtrlVlanName_Type())
...
swL3IpCtrlMode=_SwL3IpCtrlMode_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,8),_SwL3IpCtrlMode_Type())
...
swL3IpCtrlAdminState=_SwL3IpCtrlAdminState_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,9),_SwL3IpCtrlAdminState_Type())
...
swL3IpCtrlIpv4AdminState=_SwL3IpCtrlIpv4AdminState_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,10),_SwL3IpCtrlIpv4AdminState_Type())
...
swL3IpCtrlIpv6AdminState=_SwL3IpCtrlIpv6AdminState_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,12),_SwL3IpCtrlIpv6AdminState_Type())
...
swL3IpCtrlIpv6LinkLocalAddress=_SwL3IpCtrlIpv6LinkLocalAddress_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,14),_SwL3IpCtrlIpv6LinkLocalAddress_Type())
...
swL3IpCtrlIpv6LinkLocalPrefixLen=_SwL3IpCtrlIpv6LinkLocalPrefixLen_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,15),_SwL3IpCtrlIpv6LinkLocalPrefixLen_Type())
...
swL3IpCtrlState=_SwL3IpCtrlState_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,16),_SwL3IpCtrlState_Type())
...
swL3IpCtrlIpv6LinkLocalAutoState=_SwL3IpCtrlIpv6LinkLocalAutoState_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,17),_SwL3IpCtrlIpv6LinkLocalAutoState_Type())
...
swL3IpCtrlDhcpv6ClientState=_SwL3IpCtrlDhcpv6ClientState_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,3,1,20),_SwL3IpCtrlDhcpv6ClientState_Type())
...
swL3Ipv6CtrlTable=_SwL3Ipv6CtrlTable_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,4))
if mibBuilder.loadTexts:swL3Ipv6CtrlTable.setStatus(_A)
_SwL3Ipv6CtrlEntry_Object=MibTableRow
swL3Ipv6CtrlEntry=_SwL3Ipv6CtrlEntry_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,4,1))
...
swL3Ipv6CtrlInterfaceName=_SwL3Ipv6CtrlInterfaceName_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,4,1,1),_SwL3Ipv6CtrlInterfaceName_Type())
...
swL3Ipv6CtrlNsRetransTimer=_SwL3Ipv6CtrlNsRetransTimer_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,4,1,3),_SwL3Ipv6CtrlNsRetransTimer_Type())
...
swL3Ipv6AddressCtrlTable=_SwL3Ipv6AddressCtrlTable_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,5))
if mibBuilder.loadTexts:swL3Ipv6AddressCtrlTable.setStatus(_A)
_SwL3Ipv6AddressCtrlEntry_Object=MibTableRow
swL3Ipv6AddressCtrlEntry=_SwL3Ipv6AddressCtrlEntry_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,5,1))
...
swL3Ipv6AddressCtrlInterfaceName=_SwL3Ipv6AddressCtrlInterfaceName_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,5,1,1),_SwL3Ipv6AddressCtrlInterfaceName_Type())
...
swL3Ipv6Address=_SwL3Ipv6Address_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,5,1,2),_SwL3Ipv6Address_Type())
...
swL3Ipv6AddressCtrlPrefixLen=_SwL3Ipv6AddressCtrlPrefixLen_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,5,1,3),_SwL3Ipv6AddressCtrlPrefixLen_Type())
...
swL3Ipv6AddressCtrlState=_SwL3Ipv6AddressCtrlState_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,5,1,8),_SwL3Ipv6AddressCtrlState_Type())
...
swL3Ipv6AddressCtrlAddressType=_SwL3Ipv6AddressCtrlAddressType_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,5,1,9),_SwL3Ipv6AddressCtrlAddressType_Type())
...
swL3IpCtrlAllIpIfState=_SwL3IpCtrlAllIpIfState_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,1,7),_SwL3IpCtrlAllIpIfState_Type())
...
swL3IpStaticRouteTable=_SwL3IpStaticRouteTable_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,5))
if mibBuilder.loadTexts:swL3IpStaticRouteTable.setStatus(_A)
_SwL3IpStaticRouteEntry_Object=MibTableRow
swL3IpStaticRouteEntry=_SwL3IpStaticRouteEntry_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,5,1))
...
swL3IpStaticRouteDest=_SwL3IpStaticRouteDest_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,5,1,1),_SwL3IpStaticRouteDest_Type())
...
swL3IpStaticRouteMask=_SwL3IpStaticRouteMask_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,5,1,2),_SwL3IpStaticRouteMask_Type())
...
swL3IpStaticRouteBkupState=_SwL3IpStaticRouteBkupState_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,5,1,3),_SwL3IpStaticRouteBkupState_Type())
...
swL3IpStaticRouteNextHop=_SwL3IpStaticRouteNextHop_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,5,1,4),_SwL3IpStaticRouteNextHop_Type())
...
swL3IpStaticRouteMetric=_SwL3IpStaticRouteMetric_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,5,1,5),_SwL3IpStaticRouteMetric_Type())
...
swL3IpStaticRouteStatus=_SwL3IpStaticRouteStatus_Object((1,3,6,1,4,1,171,11,102,1,5,3,2,5,1,6),_SwL3IpStaticRouteStatus_Type())
...
swL3RelayMgmt=_SwL3RelayMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,5,3,3))
_SwL3RelayDnsMgmt_ObjectIdentity=ObjectIdentity
swL3RelayDnsMgmt=_SwL3RelayDnsMgmt_ObjectIdentity((1,3,6,1,4,1,171,11,102,1,5,3,3,2))
...
swL3RelayDnsState=_SwL3RelayDnsState_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,1),_SwL3RelayDnsState_Type())
...
swL3RelayDnsPrimaryServer=_SwL3RelayDnsPrimaryServer_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,2),_SwL3RelayDnsPrimaryServer_Type())
...
swL3RelayDnsSecondaryServer=_SwL3RelayDnsSecondaryServer_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,3),_SwL3RelayDnsSecondaryServer_Type())
...
swL3RelayDnsCacheState=_SwL3RelayDnsCacheState_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,4),_SwL3RelayDnsCacheState_Type())
...
swL3RelayDnsStaticTableState=_SwL3RelayDnsStaticTableState_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,5),_SwL3RelayDnsStaticTableState_Type())
...
swL3RelayDnsCtrlTable=_SwL3RelayDnsCtrlTable_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,6))
if mibBuilder.loadTexts:swL3RelayDnsCtrlTable.setStatus(_A)
_SwL3RelayDnsCtrlEntry_Object=MibTableRow
swL3RelayDnsCtrlEntry=_SwL3RelayDnsCtrlEntry_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,6,1))
...
swL3RelayDnsCtrlDomainName=_SwL3RelayDnsCtrlDomainName_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,6,1,1),_SwL3RelayDnsCtrlDomainName_Type())
...
swL3RelayDnsCtrlIpAddr=_SwL3RelayDnsCtrlIpAddr_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,6,1,2),_SwL3RelayDnsCtrlIpAddr_Type())
...
swL3RelayDnsCtrlState=_SwL3RelayDnsCtrlState_Object((1,3,6,1,4,1,171,11,102,1,5,3,3,2,6,1,3),_SwL3RelayDnsCtrlState_Type())
