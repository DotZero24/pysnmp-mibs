_Q='obsolete'
_P='rlDhcpSrvConfParamsName'
_O='rlDhcpSrvDynamicPoolName'
_N='rlDhcpSrvIpAddrIpAddr'
_M='rlDhcpRelayInterfaceListIndex'
_L='rlDhcpRelayInterfaceIfindex'
_K='rlDhcpRelayNextServerIpAddr'
_J='SnmpAdminString'
_I='TruthValue'
_H='Unsigned32'
_G='Integer32'
_F='OctetString'
_E='DLINK-3100-DHCP-MIB'
_D='DisplayString'
_C='read-only'
_B='read-write'
_A='current'
...
rsDhcpMibVersion=_RsDhcpMibVersion_Object((1,3,6,1,4,1,171,10,94,89,89,38,14),_RsDhcpMibVersion_Type())
...
rlDhcpRelayEnable=_RlDhcpRelayEnable_Object((1,3,6,1,4,1,171,10,94,89,89,38,25),_RlDhcpRelayEnable_Type())
...
rlDhcpRelayExists=_RlDhcpRelayExists_Object((1,3,6,1,4,1,171,10,94,89,89,38,26),_RlDhcpRelayExists_Type())
...
rlDhcpRelayNextServerTable=_RlDhcpRelayNextServerTable_Object((1,3,6,1,4,1,171,10,94,89,89,38,27))
if mibBuilder.loadTexts:rlDhcpRelayNextServerTable.setStatus(_A)
_RlDhcpRelayNextServerEntry_Object=MibTableRow
rlDhcpRelayNextServerEntry=_RlDhcpRelayNextServerEntry_Object((1,3,6,1,4,1,171,10,94,89,89,38,27,1))
rlDhcpRelayNextServerEntry.setIndexNames((0,_E,_K))
...
rlDhcpRelayNextServerIpAddr=_RlDhcpRelayNextServerIpAddr_Object((1,3,6,1,4,1,171,10,94,89,89,38,27,1,1),_RlDhcpRelayNextServerIpAddr_Type())
...
rlDhcpRelayNextServerSecThreshold=_RlDhcpRelayNextServerSecThreshold_Object((1,3,6,1,4,1,171,10,94,89,89,38,27,1,2),_RlDhcpRelayNextServerSecThreshold_Type())
...
rlDhcpRelayNextServerRowStatus=_RlDhcpRelayNextServerRowStatus_Object((1,3,6,1,4,1,171,10,94,89,89,38,27,1,3),_RlDhcpRelayNextServerRowStatus_Type())
...
rlDhcpRelayInterfaceTable=_RlDhcpRelayInterfaceTable_Object((1,3,6,1,4,1,171,10,94,89,89,38,28))
if mibBuilder.loadTexts:rlDhcpRelayInterfaceTable.setStatus(_A)
_RlDhcpRelayInterfaceEntry_Object=MibTableRow
rlDhcpRelayInterfaceEntry=_RlDhcpRelayInterfaceEntry_Object((1,3,6,1,4,1,171,10,94,89,89,38,28,1))
rlDhcpRelayInterfaceEntry.setIndexNames((0,_E,_L))
...
rlDhcpRelayInterfaceIfindex=_RlDhcpRelayInterfaceIfindex_Object((1,3,6,1,4,1,171,10,94,89,89,38,28,1,1),_RlDhcpRelayInterfaceIfindex_Type())
...
rlDhcpRelayInterfaceUseGiaddr=_RlDhcpRelayInterfaceUseGiaddr_Object((1,3,6,1,4,1,171,10,94,89,89,38,28,1,2),_RlDhcpRelayInterfaceUseGiaddr_Type())
...
rlDhcpRelayInterfaceRowStatus=_RlDhcpRelayInterfaceRowStatus_Object((1,3,6,1,4,1,171,10,94,89,89,38,28,1,3),_RlDhcpRelayInterfaceRowStatus_Type())
...
rlDhcpRelayInterfaceListTable=_RlDhcpRelayInterfaceListTable_Object((1,3,6,1,4,1,171,10,94,89,89,38,29))
if mibBuilder.loadTexts:rlDhcpRelayInterfaceListTable.setStatus(_A)
_RlDhcpRelayInterfaceListEntry_Object=MibTableRow
rlDhcpRelayInterfaceListEntry=_RlDhcpRelayInterfaceListEntry_Object((1,3,6,1,4,1,171,10,94,89,89,38,29,1))
rlDhcpRelayInterfaceListEntry.setIndexNames((0,_E,_M))
...
rlDhcpRelayInterfaceListIndex=_RlDhcpRelayInterfaceListIndex_Object((1,3,6,1,4,1,171,10,94,89,89,38,29,1,1),_RlDhcpRelayInterfaceListIndex_Type())
...
rlDhcpRelayInterfaceListPortList=_RlDhcpRelayInterfaceListPortList_Object((1,3,6,1,4,1,171,10,94,89,89,38,29,1,2),_RlDhcpRelayInterfaceListPortList_Type())
...
rlDhcpRelayInterfaceListVlanId1To1024=_RlDhcpRelayInterfaceListVlanId1To1024_Object((1,3,6,1,4,1,171,10,94,89,89,38,29,1,3),_RlDhcpRelayInterfaceListVlanId1To1024_Type())
...
rlDhcpRelayInterfaceListVlanId1025To2048=_RlDhcpRelayInterfaceListVlanId1025To2048_Object((1,3,6,1,4,1,171,10,94,89,89,38,29,1,4),_RlDhcpRelayInterfaceListVlanId1025To2048_Type())
...
rlDhcpRelayInterfaceListVlanId2049To3072=_RlDhcpRelayInterfaceListVlanId2049To3072_Object((1,3,6,1,4,1,171,10,94,89,89,38,29,1,5),_RlDhcpRelayInterfaceListVlanId2049To3072_Type())
...
rlDhcpRelayInterfaceListVlanId3073To4094=_RlDhcpRelayInterfaceListVlanId3073To4094_Object((1,3,6,1,4,1,171,10,94,89,89,38,29,1,6),_RlDhcpRelayInterfaceListVlanId3073To4094_Type())
...
rlDhcpSrvEnable=_RlDhcpSrvEnable_Object((1,3,6,1,4,1,171,10,94,89,89,38,30),_RlDhcpSrvEnable_Type())
...
rlDhcpSrvExists=_RlDhcpSrvExists_Object((1,3,6,1,4,1,171,10,94,89,89,38,31),_RlDhcpSrvExists_Type())
...
rlDhcpSrvDbLocation=_RlDhcpSrvDbLocation_Object((1,3,6,1,4,1,171,10,94,89,89,38,32),_RlDhcpSrvDbLocation_Type())
rlDhcpSrvDbLocation.setMaxAccess(_C)
if mibBuilder.loadTexts:rlDhcpSrvDbLocation.setStatus(_A)
_RlDhcpSrvMaxNumOfClients_Type=Unsigned32
_RlDhcpSrvMaxNumOfClients_Object=MibScalar
rlDhcpSrvMaxNumOfClients=_RlDhcpSrvMaxNumOfClients_Object((1,3,6,1,4,1,171,10,94,89,89,38,33),_RlDhcpSrvMaxNumOfClients_Type())
...
rlDhcpSrvDbNumOfActiveEntries=_RlDhcpSrvDbNumOfActiveEntries_Object((1,3,6,1,4,1,171,10,94,89,89,38,34),_RlDhcpSrvDbNumOfActiveEntries_Type())
...
rlDhcpSrvDbErase=_RlDhcpSrvDbErase_Object((1,3,6,1,4,1,171,10,94,89,89,38,35),_RlDhcpSrvDbErase_Type())
rlDhcpSrvDbErase.setMaxAccess(_B)
if mibBuilder.loadTexts:rlDhcpSrvDbErase.setStatus(_A)
...
rlDhcpSrvProbeEnable=_RlDhcpSrvProbeEnable_Object((1,3,6,1,4,1,171,10,94,89,89,38,36),_RlDhcpSrvProbeEnable_Type())
...
rlDhcpSrvProbeTimeout=_RlDhcpSrvProbeTimeout_Object((1,3,6,1,4,1,171,10,94,89,89,38,37),_RlDhcpSrvProbeTimeout_Type())
...
rlDhcpSrvProbeRetries=_RlDhcpSrvProbeRetries_Object((1,3,6,1,4,1,171,10,94,89,89,38,38),_RlDhcpSrvProbeRetries_Type())
...
rlDhcpSrvDefaultNetworkPoolName=_RlDhcpSrvDefaultNetworkPoolName_Object((1,3,6,1,4,1,171,10,94,89,89,38,39),_RlDhcpSrvDefaultNetworkPoolName_Type())
...
rlDhcpSrvIpAddrTable=_RlDhcpSrvIpAddrTable_Object((1,3,6,1,4,1,171,10,94,89,89,38,45))
if mibBuilder.loadTexts:rlDhcpSrvIpAddrTable.setStatus(_A)
_RlDhcpSrvIpAddrEntry_Object=MibTableRow
rlDhcpSrvIpAddrEntry=_RlDhcpSrvIpAddrEntry_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1))
rlDhcpSrvIpAddrEntry.setIndexNames((0,_E,_N))
...
rlDhcpSrvIpAddrIpAddr=_RlDhcpSrvIpAddrIpAddr_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,1),_RlDhcpSrvIpAddrIpAddr_Type())
...
rlDhcpSrvIpAddrIpNetMask=_RlDhcpSrvIpAddrIpNetMask_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,2),_RlDhcpSrvIpAddrIpNetMask_Type())
...
rlDhcpSrvIpAddrIdentifier=_RlDhcpSrvIpAddrIdentifier_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,3),_RlDhcpSrvIpAddrIdentifier_Type())
...
rlDhcpSrvIpAddrIdentifierType=_RlDhcpSrvIpAddrIdentifierType_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,4),_RlDhcpSrvIpAddrIdentifierType_Type())
...
rlDhcpSrvIpAddrClnHostName=_RlDhcpSrvIpAddrClnHostName_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,5),_RlDhcpSrvIpAddrClnHostName_Type())
...
rlDhcpSrvIpAddrMechanism=_RlDhcpSrvIpAddrMechanism_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,6),_RlDhcpSrvIpAddrMechanism_Type())
...
rlDhcpSrvIpAddrAgeTime=_RlDhcpSrvIpAddrAgeTime_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,7),_RlDhcpSrvIpAddrAgeTime_Type())
...
rlDhcpSrvIpAddrPoolName=_RlDhcpSrvIpAddrPoolName_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,8),_RlDhcpSrvIpAddrPoolName_Type())
...
rlDhcpSrvIpAddrConfParamsName=_RlDhcpSrvIpAddrConfParamsName_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,9),_RlDhcpSrvIpAddrConfParamsName_Type())
...
rlDhcpSrvIpAddrRowStatus=_RlDhcpSrvIpAddrRowStatus_Object((1,3,6,1,4,1,171,10,94,89,89,38,45,1,10),_RlDhcpSrvIpAddrRowStatus_Type())
...
rlDhcpSrvDynamicTable=_RlDhcpSrvDynamicTable_Object((1,3,6,1,4,1,171,10,94,89,89,38,46))
if mibBuilder.loadTexts:rlDhcpSrvDynamicTable.setStatus(_A)
_RlDhcpSrvDynamicEntry_Object=MibTableRow
rlDhcpSrvDynamicEntry=_RlDhcpSrvDynamicEntry_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1))
rlDhcpSrvDynamicEntry.setIndexNames((0,_E,_O))
...
rlDhcpSrvDynamicPoolName=_RlDhcpSrvDynamicPoolName_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,1),_RlDhcpSrvDynamicPoolName_Type())
...
rlDhcpSrvDynamicIpAddrFrom=_RlDhcpSrvDynamicIpAddrFrom_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,2),_RlDhcpSrvDynamicIpAddrFrom_Type())
...
rlDhcpSrvDynamicIpAddrTo=_RlDhcpSrvDynamicIpAddrTo_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,3),_RlDhcpSrvDynamicIpAddrTo_Type())
...
rlDhcpSrvDynamicIpNetMask=_RlDhcpSrvDynamicIpNetMask_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,4),_RlDhcpSrvDynamicIpNetMask_Type())
...
rlDhcpSrvDynamicLeaseTime=_RlDhcpSrvDynamicLeaseTime_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,5),_RlDhcpSrvDynamicLeaseTime_Type())
...
rlDhcpSrvDynamicProbeEnable=_RlDhcpSrvDynamicProbeEnable_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,6),_RlDhcpSrvDynamicProbeEnable_Type())
...
rlDhcpSrvDynamicTotalNumOfAddr=_RlDhcpSrvDynamicTotalNumOfAddr_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,7),_RlDhcpSrvDynamicTotalNumOfAddr_Type())
...
rlDhcpSrvDynamicFreeNumOfAddr=_RlDhcpSrvDynamicFreeNumOfAddr_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,8),_RlDhcpSrvDynamicFreeNumOfAddr_Type())
...
rlDhcpSrvDynamicConfParamsName=_RlDhcpSrvDynamicConfParamsName_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,9),_RlDhcpSrvDynamicConfParamsName_Type())
...
rlDhcpSrvDynamicRowStatus=_RlDhcpSrvDynamicRowStatus_Object((1,3,6,1,4,1,171,10,94,89,89,38,46,1,10),_RlDhcpSrvDynamicRowStatus_Type())
...
rlDhcpSrvConfParamsTable=_RlDhcpSrvConfParamsTable_Object((1,3,6,1,4,1,171,10,94,89,89,38,47))
if mibBuilder.loadTexts:rlDhcpSrvConfParamsTable.setStatus(_A)
_RlDhcpSrvConfParamsEntry_Object=MibTableRow
rlDhcpSrvConfParamsEntry=_RlDhcpSrvConfParamsEntry_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1))
rlDhcpSrvConfParamsEntry.setIndexNames((0,_E,_P))
...
rlDhcpSrvConfParamsName=_RlDhcpSrvConfParamsName_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,1),_RlDhcpSrvConfParamsName_Type())
...
rlDhcpSrvConfParamsNextServerIp=_RlDhcpSrvConfParamsNextServerIp_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,2),_RlDhcpSrvConfParamsNextServerIp_Type())
...
rlDhcpSrvConfParamsNextServerName=_RlDhcpSrvConfParamsNextServerName_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,3),_RlDhcpSrvConfParamsNextServerName_Type())
...
rlDhcpSrvConfParamsBootfileName=_RlDhcpSrvConfParamsBootfileName_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,4),_RlDhcpSrvConfParamsBootfileName_Type())
...
rlDhcpSrvConfParamsRoutersList=_RlDhcpSrvConfParamsRoutersList_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,5),_RlDhcpSrvConfParamsRoutersList_Type())
...
rlDhcpSrvConfParamsTimeSrvList=_RlDhcpSrvConfParamsTimeSrvList_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,6),_RlDhcpSrvConfParamsTimeSrvList_Type())
...
rlDhcpSrvConfParamsDnsList=_RlDhcpSrvConfParamsDnsList_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,7),_RlDhcpSrvConfParamsDnsList_Type())
...
rlDhcpSrvConfParamsDomainName=_RlDhcpSrvConfParamsDomainName_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,8),_RlDhcpSrvConfParamsDomainName_Type())
...
rlDhcpSrvConfParamsNetbiosNameList=_RlDhcpSrvConfParamsNetbiosNameList_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,9),_RlDhcpSrvConfParamsNetbiosNameList_Type())
...
rlDhcpSrvConfParamsNetbiosNodeType=_RlDhcpSrvConfParamsNetbiosNodeType_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,10),_RlDhcpSrvConfParamsNetbiosNodeType_Type())
...
rlDhcpSrvConfParamsCommunity=_RlDhcpSrvConfParamsCommunity_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,11),_RlDhcpSrvConfParamsCommunity_Type())
rlDhcpSrvConfParamsCommunity.setMaxAccess(_B)
if mibBuilder.loadTexts:rlDhcpSrvConfParamsCommunity.setStatus(_Q)
_RlDhcpSrvConfParamsNmsIp_Type=IpAddress
_RlDhcpSrvConfParamsNmsIp_Object=MibTableColumn
rlDhcpSrvConfParamsNmsIp=_RlDhcpSrvConfParamsNmsIp_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,12),_RlDhcpSrvConfParamsNmsIp_Type())
rlDhcpSrvConfParamsNmsIp.setMaxAccess(_B)
if mibBuilder.loadTexts:rlDhcpSrvConfParamsNmsIp.setStatus(_Q)
_RlDhcpSrvConfParamsOptionsList_Type=DisplayString
_RlDhcpSrvConfParamsOptionsList_Object=MibTableColumn
rlDhcpSrvConfParamsOptionsList=_RlDhcpSrvConfParamsOptionsList_Object((1,3,6,1,4,1,171,10,94,89,89,38,47,1,13),_RlDhcpSrvConfParamsOptionsList_Type())
