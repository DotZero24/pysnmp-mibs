...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-SYS-MAN-MIB
...
_HpnicfSysSetBootImageFileOverWrite_Type.__name__ = "TruthValue"
...
_HpnicfSysSetBootImageRemoveIpeFile_Type.__name__ = "TruthValue"
...
hpnicfSystemManMIBCompliance.setObjects(
      *(("HPN-ICF-SYS-MAN-MIB", "hpnicfSysClockGroup"),
        ("HPN-ICF-SYS-MAN-MIB", "hpnicfSysReloadGroup"),
        ("HPN-ICF-SYS-MAN-MIB", "hpnicfSysImageGroup"),
        ("HPN-ICF-SYS-MAN-MIB", "hpnicfSysCFGFileGroup"),
        ("HPN-ICF-SYS-MAN-MIB", "hpnicfSystemManNotificationGroup"),
        ("HPN-ICF-SYS-MAN-MIB", "hpnicfSysCurGroup"),
        ("HPN-ICF-SYS-MAN-MIB", "hpnicfSystemBtmLoadGroup"))
)
if mibBuilder.loadTexts:
