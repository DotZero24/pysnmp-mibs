...
_D='MARVELL-TrafficSegmentation-MIB'
_C='Unsigned32'
_B='read-write'
_A='current'
...
rlTrafficSegConfigTable=_RlTrafficSegConfigTable_Object((1,3,6,1,4,1,89,138,1))
if mibBuilder.loadTexts:rlTrafficSegConfigTable.setStatus(_A)
_RlTrafficSegConfigEntry_Object=MibTableRow
rlTrafficSegConfigEntry=_RlTrafficSegConfigEntry_Object((1,3,6,1,4,1,89,138,1,1))
...
rlTrafficSegConfigIndex=_RlTrafficSegConfigIndex_Object((1,3,6,1,4,1,89,138,1,1,1),_RlTrafficSegConfigIndex_Type())
...
rlTrafficSegConfigIngressPorts=_RlTrafficSegConfigIngressPorts_Object((1,3,6,1,4,1,89,138,1,1,2),_RlTrafficSegConfigIngressPorts_Type())
...
rlTrafficSegConfigEgressPorts=_RlTrafficSegConfigEgressPorts_Object((1,3,6,1,4,1,89,138,1,1,3),_RlTrafficSegConfigEgressPorts_Type())
...
rlTrafficSegConfigRowStatus=_RlTrafficSegConfigRowStatus_Object((1,3,6,1,4,1,89,138,1,1,4),_RlTrafficSegConfigRowStatus_Type())
...
rlTrafficSegTable=_RlTrafficSegTable_Object((1,3,6,1,4,1,89,138,2))
if mibBuilder.loadTexts:rlTrafficSegTable.setStatus(_A)
_RlTrafficSegEntry_Object=MibTableRow
rlTrafficSegEntry=_RlTrafficSegEntry_Object((1,3,6,1,4,1,89,138,2,1))
...
rlTrafficSegIndex=_RlTrafficSegIndex_Object((1,3,6,1,4,1,89,138,2,1,1),_RlTrafficSegIndex_Type())
...
rlTrafficSegIngressPorts=_RlTrafficSegIngressPorts_Object((1,3,6,1,4,1,89,138,2,1,2),_RlTrafficSegIngressPorts_Type())
...
rlTrafficSegEgressPorts=_RlTrafficSegEgressPorts_Object((1,3,6,1,4,1,89,138,2,1,3),_RlTrafficSegEgressPorts_Type())
...
rlTrafficSegRowStatus=_RlTrafficSegRowStatus_Object((1,3,6,1,4,1,89,138,2,1,4),_RlTrafficSegRowStatus_Type())
