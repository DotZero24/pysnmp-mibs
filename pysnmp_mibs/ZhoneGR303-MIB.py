...
ZhoneShelfValueOrZero, ZhoneRowStatus, ZhoneAdminString, ZhoneSlotValueOrZero = mibBuilder.importSymbols("Zhone-TC", "ZhoneShelfValueOrZero", "ZhoneRowStatus", "ZhoneAdminString", "ZhoneSlotValueOrZero")
...
mibBuilder.exportSymbols("ZhoneGR303-MIB", igIntervalNumber=igIntervalNumber, igCurrentOutboundCalls=igCurrentOutboundCalls, igEocSecondaryStateChange=igEocSecondaryStateChange, igStatsIntervalTable=igStatsIntervalTable, igPeerStatus=igPeerStatus, igStatsTotalTable=igStatsTotalTable, igIntervalEOCLapdRcvdErrs=igIntervalEOCLapdRcvdErrs, igCurrActiveCalls=igCurrActiveCalls, igOperationalStatus=igOperationalStatus, igOperStatusChange=igOperStatusChange, igTotalEOCLapdSent=igTotalEOCLapdSent, igCurrentEOCLapdSent=igCurrentEOCLapdSent, igTotalGR303ProtocolErrors=igTotalGR303ProtocolErrors, igTotalEOCLapdRcvd=igTotalEOCLapdRcvd, igIntervalValidData=igIntervalValidData, igTotalTMCLapdRcvdErrs=igTotalTMCLapdRcvdErrs, ds1LineMappingTable=ds1LineMappingTable, igSapi1N200=igSapi1N200, igIntervalOutboundCallsBlocked=igIntervalOutboundCallsBlocked, igSapi0N200=igSapi0N200, igCrvTmcState=igCrvTmcState, igCrvTable=igCrvTable, igTotalTMCLapdRcvd=igTotalTMCLapdRcvd, igSwitchType=igSwitchType, igPrimaryEocTmcDs1IfIndex=igPrimaryEocTmcDs1IfIndex, igSapi1T203=igSapi1T203, igCurrentOutboundCallsBlocked=igCurrentOutboundCallsBlocked, igEocPrimaryStateChange=igEocPrimaryStateChange, igCurrentTMCLapdRcvdErrs=igCurrentTMCLapdRcvdErrs, igIntervalEOCLapdSent=igIntervalEOCLapdSent, igSapi0PpsMode=igSapi0PpsMode, ds1LineMappingEntry=ds1LineMappingEntry, gr303TrapsPrefix=gr303TrapsPrefix, ds1Role=ds1Role, igControlChannelTmcPrimarySvcState=igControlChannelTmcPrimarySvcState, igNameId=igNameId, igSapi1PpsMode=igSapi1PpsMode, igControlChannelEocSecondarySvcState=igControlChannelEocSecondarySvcState, igCurrentEOCLapdRcvdErrs=igCurrentEOCLapdRcvdErrs, igControlChannelTable=igControlChannelTable, igSapi0T200=igSapi0T200, igIntervalOutboundCalls=igIntervalOutboundCalls, igCrvEntry=igCrvEntry, ds1LogicalId=ds1LogicalId, igSapi1MaxOutstandingFrames=igSapi1MaxOutstandingFrames, igStatsTimeElapsed=igStatsTimeElapsed, igPeerSlot=igPeerSlot, igCurrentGR303ProtocolErrors=igCurrentGR303ProtocolErrors, igStatsInvalidIntervals=igStatsInvalidIntervals, igTotalTMCLapdSent=igTotalTMCLapdSent, igIntervalTMCLapdRcvd=igIntervalTMCLapdRcvd, igTmcPrimaryStateChange=igTmcPrimaryStateChange, igTotalInboundCalls=igTotalInboundCalls, igCurrentTMCLapdSent=igCurrentTMCLapdSent, zhoneGR303=zhoneGR303, igCrvSignalType=igCrvSignalType, gr303Traps=gr303Traps, igintervalTMCLapdRcvdErrs=igintervalTMCLapdRcvdErrs, igSapi0T203=igSapi0T203, igIntervalTMCLapdSent=igIntervalTMCLapdSent, igSystemTimeChange=igSystemTimeChange, igPeerShelf=igPeerShelf, igStatsCurrentTable=igStatsCurrentTable, ds1LineMappingRowStatus=ds1LineMappingRowStatus, igCrvRemoteStateChange=igCrvRemoteStateChange, igIntervalGR303ProtocolErrors=igIntervalGR303ProtocolErrors, igSecondaryEocTmcDs1IfIndex=igSecondaryEocTmcDs1IfIndex, dsnLgId=dsnLgId, igCrvTmcStateChange=igCrvTmcStateChange, igCrvRowStatus=igCrvRowStatus, igCurrentEOCLapdRcvd=igCurrentEOCLapdRcvd, interfaceGroupTable=interfaceGroupTable, igIntervalEOCLapdRcvd=igIntervalEOCLapdRcvd, igCrvLocalAdminState=igCrvLocalAdminState, igTotalEOCLapdRcvdErrs=igTotalEOCLapdRcvdErrs, igStatsTotalEntry=igStatsTotalEntry, igWorkingMode=igWorkingMode, igControlChannelEntry=igControlChannelEntry, igCurrentTMCLapdRcvd=igCurrentTMCLapdRcvd, igControlChannelT396=igControlChannelT396, igIntervalInboundCalls=igIntervalInboundCalls, igControlChannelT303=igControlChannelT303, PYSNMP_MODULE_ID=zhoneGR303, igCrvRemoteAdminState=igCrvRemoteAdminState, ds1ChannelNumber=ds1ChannelNumber, igSapi1T200=igSapi1T200, igControlChannelTmcSecondarySvcState=igControlChannelTmcSecondarySvcState, igCrvOperStatus=igCrvOperStatus, igRowStatus=igRowStatus, igStatsCurrentEntry=igStatsCurrentEntry, igCrv=igCrv, igTmcSecondaryStateChange=igTmcSecondaryStateChange, igMaxConfigCalls=igMaxConfigCalls, interfaceGroupEntry=interfaceGroupEntry, igStatsValidIntervals=igStatsValidIntervals, igCurrentInboundCalls=igCurrentInboundCalls, igSapi0MaxOutstandingFrames=igSapi0MaxOutstandingFrames, igSlot=igSlot, igAdminStatus=igAdminStatus, igStatsIntervalEntry=igStatsIntervalEntry, ds1IfIndex=ds1IfIndex, igControlChannelEocPrimarySvcState=igControlChannelEocPrimarySvcState, igTotalOutboundCalls=igTotalOutboundCalls, igTotalOutboundCallsBlocked=igTotalOutboundCallsBlocked, igShelf=igShelf)
