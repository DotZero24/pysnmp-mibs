...
h3cRCPLeaf=_H3cRCPLeaf_ObjectIdentity((1,3,6,1,4,1,2011,10,2,73,1,1))
_H3cRCPServerEnableStatus_Type=TruthValue
_H3cRCPServerEnableStatus_Object=MibScalar
h3cRCPServerEnableStatus=_H3cRCPServerEnableStatus_Object((1,3,6,1,4,1,2011,10,2,73,1,1,1),_H3cRCPServerEnableStatus_Type())
...
h3cRCPConnTimeout=_H3cRCPConnTimeout_Object((1,3,6,1,4,1,2011,10,2,73,1,1,2),_H3cRCPConnTimeout_Type())
...
h3cRCPRuleTimeout=_H3cRCPRuleTimeout_Object((1,3,6,1,4,1,2011,10,2,73,1,1,3),_H3cRCPRuleTimeout_Type())
...
h3cRCPServerMaxConn=_H3cRCPServerMaxConn_Object((1,3,6,1,4,1,2011,10,2,73,1,1,4),_H3cRCPServerMaxConn_Type())
...
h3cRCPServerCurConn=_H3cRCPServerCurConn_Object((1,3,6,1,4,1,2011,10,2,73,1,1,5),_H3cRCPServerCurConn_Type())
...
h3cRCPConnTimeoutMaxValue=_H3cRCPConnTimeoutMaxValue_Object((1,3,6,1,4,1,2011,10,2,73,1,1,6),_H3cRCPConnTimeoutMaxValue_Type())
...
h3cRCPRuleTimeoutMaxValue=_H3cRCPRuleTimeoutMaxValue_Object((1,3,6,1,4,1,2011,10,2,73,1,1,7),_H3cRCPRuleTimeoutMaxValue_Type())
...
h3cRCPServerMaxConnMaxValue=_H3cRCPServerMaxConnMaxValue_Object((1,3,6,1,4,1,2011,10,2,73,1,1,8),_H3cRCPServerMaxConnMaxValue_Type())
...
h3cRCPBalanceGroupIdMinValue=_H3cRCPBalanceGroupIdMinValue_Object((1,3,6,1,4,1,2011,10,2,73,1,1,9),_H3cRCPBalanceGroupIdMinValue_Type())
...
h3cRCPBalanceGroupIdMaxValue=_H3cRCPBalanceGroupIdMaxValue_Object((1,3,6,1,4,1,2011,10,2,73,1,1,10),_H3cRCPBalanceGroupIdMaxValue_Type())
...
h3cRCPTotalUsers=_H3cRCPTotalUsers_Object((1,3,6,1,4,1,2011,10,2,73,1,1,11),_H3cRCPTotalUsers_Type())
...
h3cRCPTotalClientIPs=_H3cRCPTotalClientIPs_Object((1,3,6,1,4,1,2011,10,2,73,1,1,12),_H3cRCPTotalClientIPs_Type())
...
h3cRCPTable=_H3cRCPTable_ObjectIdentity((1,3,6,1,4,1,2011,10,2,73,1,2))
_H3cRCPUserTable_Object=MibTable
h3cRCPUserTable=_H3cRCPUserTable_Object((1,3,6,1,4,1,2011,10,2,73,1,2,1))
if mibBuilder.loadTexts:h3cRCPUserTable.setStatus(_A)
_H3cRCPUserEntry_Object=MibTableRow
h3cRCPUserEntry=_H3cRCPUserEntry_Object((1,3,6,1,4,1,2011,10,2,73,1,2,1,1))
...
h3cRCPUserName=_H3cRCPUserName_Object((1,3,6,1,4,1,2011,10,2,73,1,2,1,1,1),_H3cRCPUserName_Type())
...
h3cRCPUserPassword=_H3cRCPUserPassword_Object((1,3,6,1,4,1,2011,10,2,73,1,2,1,1,2),_H3cRCPUserPassword_Type())
...
h3cRCPUserRedirectInterface=_H3cRCPUserRedirectInterface_Object((1,3,6,1,4,1,2011,10,2,73,1,2,1,1,3),_H3cRCPUserRedirectInterface_Type())
...
h3cRCPUserRedirectBalanceGroup=_H3cRCPUserRedirectBalanceGroup_Object((1,3,6,1,4,1,2011,10,2,73,1,2,1,1,4),_H3cRCPUserRedirectBalanceGroup_Type())
...
h3cRCPUserRowStatus=_H3cRCPUserRowStatus_Object((1,3,6,1,4,1,2011,10,2,73,1,2,1,1,5),_H3cRCPUserRowStatus_Type())
...
h3cRCPClientIPTable=_H3cRCPClientIPTable_Object((1,3,6,1,4,1,2011,10,2,73,1,2,2))
if mibBuilder.loadTexts:h3cRCPClientIPTable.setStatus(_A)
_H3cRCPClientIPEntry_Object=MibTableRow
h3cRCPClientIPEntry=_H3cRCPClientIPEntry_Object((1,3,6,1,4,1,2011,10,2,73,1,2,2,1))
...
h3cRCPClientIPType=_H3cRCPClientIPType_Object((1,3,6,1,4,1,2011,10,2,73,1,2,2,1,1),_H3cRCPClientIPType_Type())
...
h3cRCPClientIP=_H3cRCPClientIP_Object((1,3,6,1,4,1,2011,10,2,73,1,2,2,1,2),_H3cRCPClientIP_Type())
...
h3cRCPClientIPRowStatus=_H3cRCPClientIPRowStatus_Object((1,3,6,1,4,1,2011,10,2,73,1,2,2,1,3),_H3cRCPClientIPRowStatus_Type())
...
h3cRCPSessionTable=_H3cRCPSessionTable_Object((1,3,6,1,4,1,2011,10,2,73,1,2,3))
if mibBuilder.loadTexts:h3cRCPSessionTable.setStatus(_A)
_H3cRCPSessionEntry_Object=MibTableRow
h3cRCPSessionEntry=_H3cRCPSessionEntry_Object((1,3,6,1,4,1,2011,10,2,73,1,2,3,1))
...
h3cRCPSessionId=_H3cRCPSessionId_Object((1,3,6,1,4,1,2011,10,2,73,1,2,3,1,1),_H3cRCPSessionId_Type())
...
h3cRCPSessionClientIPType=_H3cRCPSessionClientIPType_Object((1,3,6,1,4,1,2011,10,2,73,1,2,3,1,2),_H3cRCPSessionClientIPType_Type())
...
h3cRCPSessionClientIP=_H3cRCPSessionClientIP_Object((1,3,6,1,4,1,2011,10,2,73,1,2,3,1,3),_H3cRCPSessionClientIP_Type())
...
h3cRCPSessionRunningStatus=_H3cRCPSessionRunningStatus_Object((1,3,6,1,4,1,2011,10,2,73,1,2,3,1,4),_H3cRCPSessionRunningStatus_Type())
...
h3cRCPSessionUserName=_H3cRCPSessionUserName_Object((1,3,6,1,4,1,2011,10,2,73,1,2,3,1,5),_H3cRCPSessionUserName_Type())
