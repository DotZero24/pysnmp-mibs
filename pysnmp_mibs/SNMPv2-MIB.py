...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Integer32, Gauge32, ModuleIdentity, TimeTicks, mib_2, NotificationType, snmpModules, Counter32, Bits, IpAddress, iso, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Integer32", "Gauge32", "ModuleIdentity", "TimeTicks", "mib-2", "NotificationType", "snmpModules", "Counter32", "Bits", "IpAddress", "iso", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpInBadCommunityUses=snmpInBadCommunityUses, snmpInASNParseErrs=snmpInASNParseErrs, snmpMIBGroups=snmpMIBGroups, snmpInPkts=snmpInPkts, snmpOutGetResponses=snmpOutGetResponses, snmpOutTraps=snmpOutTraps, snmpMIBCompliances=snmpMIBCompliances, sysLocation=sysLocation, sysServices=sysServices, snmpOutGetRequests=snmpOutGetRequests, snmpInBadCommunityNames=snmpInBadCommunityNames, coldStart=coldStart, snmpProxyDrops=snmpProxyDrops, sysORIndex=sysORIndex, sysORUpTime=sysORUpTime, snmpOutBadValues=snmpOutBadValues, snmpTrap=snmpTrap, snmpSilentDrops=snmpSilentDrops, snmpBasicCompliance=snmpBasicCompliance, snmpTraps=snmpTraps, snmpOutGetNexts=snmpOutGetNexts, snmpInTraps=snmpInTraps, sysUpTime=sysUpTime, warmStart=warmStart, snmpOutGenErrs=snmpOutGenErrs, sysDescr=sysDescr, PYSNMP_MODULE_ID=snmpMIB, sysOREntry=sysOREntry, snmpMIBConformance=snmpMIBConformance, snmpSetGroup=snmpSetGroup, snmpBasicComplianceRev2=snmpBasicComplianceRev2, snmpInGetResponses=snmpInGetResponses, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpInNoSuchNames=snmpInNoSuchNames, snmpTrapEnterprise=snmpTrapEnterprise, snmpInTotalReqVars=snmpInTotalReqVars, system=system, snmpObsoleteGroup=snmpObsoleteGroup, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpGroup=snmpGroup, snmpNotificationGroup=snmpNotificationGroup, sysName=sysName, snmpMIBObjects=snmpMIBObjects, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, snmpInGenErrs=snmpInGenErrs, snmpInTooBigs=snmpInTooBigs, snmpOutTooBigs=snmpOutTooBigs, snmpTrapOID=snmpTrapOID, snmpInSetRequests=snmpInSetRequests, snmpInBadVersions=snmpInBadVersions, sysORLastChange=sysORLastChange, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpSetSerialNo=snmpSetSerialNo, systemGroup=systemGroup, sysObjectID=sysObjectID, snmpInBadValues=snmpInBadValues, sysORDescr=sysORDescr, snmpOutPkts=snmpOutPkts, snmpInTotalSetVars=snmpInTotalSetVars, snmpInReadOnlys=snmpInReadOnlys, sysORTable=sysORTable, snmpCommunityGroup=snmpCommunityGroup, sysORID=sysORID, snmpMIB=snmpMIB, snmpOutSetRequests=snmpOutSetRequests, authenticationFailure=authenticationFailure, snmpInGetNexts=snmpInGetNexts, snmpSet=snmpSet, sysContact=sysContact, snmp=snmp, snmpInGetRequests=snmpInGetRequests)
