...
ModuleIdentity, Counter64, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, snmpModules, iso, MibIdentifier, TimeTicks, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "snmpModules", "iso", "MibIdentifier", "TimeTicks", "Bits", "mib-2", "IpAddress")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpNotificationGroup=snmpNotificationGroup, snmpInTooBigs=snmpInTooBigs, snmpOutPkts=snmpOutPkts, snmpTrapEnterprise=snmpTrapEnterprise, snmpProxyDrops=snmpProxyDrops, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpInBadValues=snmpInBadValues, snmpInNoSuchNames=snmpInNoSuchNames, snmpInTraps=snmpInTraps, snmpOutGetNexts=snmpOutGetNexts, authenticationFailure=authenticationFailure, snmpSetSerialNo=snmpSetSerialNo, snmpBasicComplianceRev2=snmpBasicComplianceRev2, sysObjectID=sysObjectID, snmpMIB=snmpMIB, sysORDescr=sysORDescr, sysORTable=sysORTable, snmp=snmp, snmpSet=snmpSet, snmpInPkts=snmpInPkts, sysOREntry=sysOREntry, snmpInASNParseErrs=snmpInASNParseErrs, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpMIBGroups=snmpMIBGroups, snmpObsoleteGroup=snmpObsoleteGroup, snmpTraps=snmpTraps, sysORIndex=sysORIndex, snmpMIBConformance=snmpMIBConformance, sysLocation=sysLocation, coldStart=coldStart, snmpBasicCompliance=snmpBasicCompliance, snmpInGetResponses=snmpInGetResponses, PYSNMP_MODULE_ID=snmpMIB, sysName=sysName, snmpTrap=snmpTrap, snmpInGetRequests=snmpInGetRequests, sysORID=sysORID, snmpInBadCommunityUses=snmpInBadCommunityUses, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpMIBCompliances=snmpMIBCompliances, snmpOutSetRequests=snmpOutSetRequests, snmpOutTraps=snmpOutTraps, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, snmpSetGroup=snmpSetGroup, sysORLastChange=sysORLastChange, snmpOutGetResponses=snmpOutGetResponses, snmpOutGetRequests=snmpOutGetRequests, snmpMIBObjects=snmpMIBObjects, sysServices=sysServices, snmpTrapOID=snmpTrapOID, snmpOutGenErrs=snmpOutGenErrs, snmpInReadOnlys=snmpInReadOnlys, snmpInSetRequests=snmpInSetRequests, sysContact=sysContact, system=system, sysORUpTime=sysORUpTime, snmpGroup=snmpGroup, snmpInGetNexts=snmpInGetNexts, snmpCommunityGroup=snmpCommunityGroup, snmpInTotalSetVars=snmpInTotalSetVars, systemGroup=systemGroup, sysDescr=sysDescr, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpSilentDrops=snmpSilentDrops, sysUpTime=sysUpTime, snmpInTotalReqVars=snmpInTotalReqVars, snmpOutTooBigs=snmpOutTooBigs, warmStart=warmStart, snmpOutBadValues=snmpOutBadValues, snmpInBadVersions=snmpInBadVersions, snmpInGenErrs=snmpInGenErrs)
