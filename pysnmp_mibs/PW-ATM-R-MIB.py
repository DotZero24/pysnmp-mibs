# SNMP MIB module (PW-ATM-R-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/rad/PW-ATM-R-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:17:31 2025
...
pwAtmMIBR = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 16)
)
if mibBuilder.loadTexts:
    pwAtmMIBR.setRevisions(
        ("2007-02-04 00:00",
         "2006-08-21 00:00",
         "2003-10-16 00:00")
    )
...
pwAtmCfgFarEndMaxCellConcatenation = _PwAtmCfgFarEndMaxCellConcatenation_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 5, 1, 2),
    _PwAtmCfgFarEndMaxCellConcatenation_Type()
)
pwAtmCfgFarEndMaxCellConcatenation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
pwAtmOamCellSupported = _PwAtmOamCellSupported_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 5, 1, 5),
    _PwAtmOamCellSupported_Type()
)
pwAtmOamCellSupported.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    pwAtmOamCellSupported.setStatus("current")
_PwAtmOutboundNto1Table_Object = MibTable
pwAtmOutboundNto1Table = _PwAtmOutboundNto1Table_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 6)
)
if mibBuilder.loadTexts:
...
pwAtmOutboundNto1Entry = _PwAtmOutboundNto1Entry_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 6, 1)
)
pwAtmOutboundNto1Entry.setIndexNames(
    (0, "PW-STD-R-MIB", "pwIndex"),
    (0, "PW-ATM-R-MIB", "pwAtmOutboundNto1AtmIf"),
    (0, "PW-ATM-R-MIB", "pwAtmOutboundNto1Vpi"),
    (0, "PW-ATM-R-MIB", "pwAtmOutboundNto1Vci"),
)
if mibBuilder.loadTexts:
...
pwAtmInboundNto1Entry = _PwAtmInboundNto1Entry_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 7, 1)
)
pwAtmInboundNto1Entry.setIndexNames(
    (0, "PW-STD-R-MIB", "pwIndex"),
    (0, "PW-ATM-R-MIB", "pwAtmInboundNto1AtmIf"),
    (0, "PW-ATM-R-MIB", "pwAtmInboundNto1Vpi"),
    (0, "PW-ATM-R-MIB", "pwAtmInboundNto1Vci"),
)
if mibBuilder.loadTexts:
...
pwAtmPerfIntervalEntry = _PwAtmPerfIntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 9, 1)
)
pwAtmPerfIntervalEntry.setIndexNames(
    (0, "PW-STD-R-MIB", "pwIndex"),
    (0, "PW-ATM-R-MIB", "pwAtmPerfIntervalNumber"),
)
if mibBuilder.loadTexts:
...
pwAtmPerfIntervalCellsReceived = _PwAtmPerfIntervalCellsReceived_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 9, 1, 10),
...
pwAtmPerfIntervalUnknownCells = _PwAtmPerfIntervalUnknownCells_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 9, 1, 11),
...
pwAtmPerf1DayIntervalEntry = _PwAtmPerf1DayIntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1)
)
pwAtmPerf1DayIntervalEntry.setIndexNames(
    (0, "PW-STD-R-MIB", "pwIndex"),
    (0, "PW-ATM-R-MIB", "pwAtmPerf1DayIntervalNumber"),
)
if mibBuilder.loadTexts:
...
pwAtmPerf1DayIntervalNumber = _PwAtmPerf1DayIntervalNumber_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 1),
...
pwAtmPerf1DayIntervalValidData = _PwAtmPerf1DayIntervalValidData_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 2),
...
pwAtmPerf1DayIntervalDuration = _PwAtmPerf1DayIntervalDuration_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 3),
...
pwAtmPerf1DayIntervalMissingPkts = _PwAtmPerf1DayIntervalMissingPkts_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 4),
...
pwAtmPerf1DayIntervalPktsReOrder = _PwAtmPerf1DayIntervalPktsReOrder_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 5),
...
pwAtmPerf1DayIntervalPktsMisOrder = _PwAtmPerf1DayIntervalPktsMisOrder_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 6),
...
pwAtmPerf1DayIntervalPktsTimeout = _PwAtmPerf1DayIntervalPktsTimeout_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 7),
...
pwAtmPerf1DayIntervalCellsXmit = _PwAtmPerf1DayIntervalCellsXmit_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 8),
...
pwAtmPerf1DayIntervalCellsDropped = _PwAtmPerf1DayIntervalCellsDropped_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 9),
...
pwAtmPerf1DayIntervalCellsReceived = _PwAtmPerf1DayIntervalCellsReceived_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 10),
...
pwAtmPerf1DayIntervalUnknownCells = _PwAtmPerf1DayIntervalUnknownCells_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 1, 10, 1, 11),
...
pwAtmConformance = _PwAtmConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2)
)
_PwAtmGroups_ObjectIdentity = ObjectIdentity
pwAtmGroups = _PwAtmGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2, 1)
)
_PwAtmCompliances_ObjectIdentity = ObjectIdentity
pwAtmCompliances = _PwAtmCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2, 2)
)

# Managed Objects groups

pwAtmCfgGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2, 1, 5)
)
pwAtmCfgGroup.setObjects(
      *(("PW-ATM-R-MIB", "pwAtmCfgMaxCellConcatenation"),
        ("PW-ATM-R-MIB", "pwAtmCfgFarEndMaxCellConcatenation"),
        ("PW-ATM-R-MIB", "pwAtmCfgTimeoutMode"),
        ("PW-ATM-R-MIB", "pwAtmClpQosMapping"),
        ("PW-ATM-R-MIB", "pwAtmOamCellSupported"))
)
if mibBuilder.loadTexts:
    pwAtmCfgGroup.setStatus("current")

pwAtmPerfGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2, 1, 6)
)
pwAtmPerfGroup.setObjects(
      *(("PW-ATM-R-MIB", "pwAtmPerfCurrentMissingPkts"),
        ("PW-ATM-R-MIB", "pwAtmPerfCurrentPktsReOrder"),
        ("PW-ATM-R-MIB", "pwAtmPerfCurrentPktsMisOrder"),
        ("PW-ATM-R-MIB", "pwAtmPerfCurrentPktsTimeout"),
        ("PW-ATM-R-MIB", "pwAtmPerfCurrentCellsXmit"),
        ("PW-ATM-R-MIB", "pwAtmPerfCurrentCellsDropped"),
        ("PW-ATM-R-MIB", "pwAtmPerfCurrentCellsReceived"),
        ("PW-ATM-R-MIB", "pwAtmPerfCurrentUnknownCells"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalValidData"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalDuration"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalMissingPkts"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalPktsReOrder"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalPktsMisOrder"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalPktsTimeout"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalCellsXmit"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalCellsDropped"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalCellsReceived"),
        ("PW-ATM-R-MIB", "pwAtmPerfIntervalUnknownCells"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalValidData"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalDuration"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalMissingPkts"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalPktsReOrder"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalPktsMisOrder"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalPktsTimeout"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalCellsXmit"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalCellsDropped"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalCellsReceived"),
        ("PW-ATM-R-MIB", "pwAtmPerf1DayIntervalUnknownCells"))
)
if mibBuilder.loadTexts:
    pwAtmPerfGroup.setStatus("current")

pwAtmOutbound1to1Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2, 1, 7)
)
pwAtmOutbound1to1Group.setObjects(
      *(("PW-ATM-R-MIB", "pwAtmOutboundAtmIf"),
        ("PW-ATM-R-MIB", "pwAtmOutboundVpi"),
        ("PW-ATM-R-MIB", "pwAtmOutboundVci"),
        ("PW-ATM-R-MIB", "pwAtmOutboundTrafficParamDescr"),
        ("PW-ATM-R-MIB", "pwAtmOutboundRowStatus"))
)
if mibBuilder.loadTexts:
    pwAtmOutbound1to1Group.setStatus("current")

pwAtmInbound1to1Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2, 1, 8)
)
pwAtmInbound1to1Group.setObjects(
      *(("PW-ATM-R-MIB", "pwAtmInboundAtmIf"),
        ("PW-ATM-R-MIB", "pwAtmInboundVpi"),
        ("PW-ATM-R-MIB", "pwAtmInboundVci"),
        ("PW-ATM-R-MIB", "pwAtmInboundTrafficParamDescr"),
        ("PW-ATM-R-MIB", "pwAtmInboundRowStatus"))
)
if mibBuilder.loadTexts:
    pwAtmInbound1to1Group.setStatus("current")

pwAtmOutboundNto1Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2, 1, 9)
)
pwAtmOutboundNto1Group.setObjects(
      *(("PW-ATM-R-MIB", "pwAtmOutboundNto1RowStatus"),
        ("PW-ATM-R-MIB", "pwAtmOutboundNto1TrafficParamDescr"),
        ("PW-ATM-R-MIB", "pwAtmOutboundNto1MappedVpi"),
        ("PW-ATM-R-MIB", "pwAtmOutboundNto1MappedVci"))
)
if mibBuilder.loadTexts:
    pwAtmOutboundNto1Group.setStatus("current")

pwAtmInboundNto1Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2, 1, 10)
)
pwAtmInboundNto1Group.setObjects(
      *(("PW-ATM-R-MIB", "pwAtmInboundNto1RowStatus"),
        ("PW-ATM-R-MIB", "pwAtmInboundNto1TrafficParamDescr"),
        ("PW-ATM-R-MIB", "pwAtmInboundNto1MappedVpi"),
        ("PW-ATM-R-MIB", "pwAtmInboundNto1MappedVci"))
)
if mibBuilder.loadTexts:
...
pwAtmCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 164, 20, 16, 2, 2, 2)
)
pwAtmCompliance.setObjects(
      *(("PW-ATM-R-MIB", "pwAtmCfgGroup"),
        ("PW-ATM-R-MIB", "pwAtmPerfGroup"),
        ("PW-ATM-R-MIB", "pwAtmOutbound1to1Group"),
        ("PW-ATM-R-MIB", "pwAtmInbound1to1Group"),
        ("PW-ATM-R-MIB", "pwAtmOutboundNto1Group"),
        ("PW-ATM-R-MIB", "pwAtmInboundNto1Group"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"radExperimental": radExperimental,
       ...
       "pwAtmOamCellSupported": pwAtmOamCellSupported,
