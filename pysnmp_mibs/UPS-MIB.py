...
mibBuilder.exportSymbols("UPS-MIB", upsTrapAlarmEntryRemoved=upsTrapAlarmEntryRemoved, upsBypassVoltage=upsBypassVoltage, upsInput=upsInput, upsSubsetBatteryGroup=upsSubsetBatteryGroup, upsControl=upsControl, upsAlarmBypassBad=upsAlarmBypassBad, PositiveInteger=PositiveInteger, upsBasicOutputGroup=upsBasicOutputGroup, upsBattery=upsBattery, upsAlarmTime=upsAlarmTime, upsOutputPower=upsOutputPower, upsConfigOutputVA=upsConfigOutputVA, upsBatteryVoltage=upsBatteryVoltage, upsAlarmInputBad=upsAlarmInputBad, upsSecondsOnBattery=upsSecondsOnBattery, upsTrapOnBattery=upsTrapOnBattery, upsIdent=upsIdent, upsBatteryStatus=upsBatteryStatus, upsTestStartTime=upsTestStartTime, upsOutputVoltage=upsOutputVoltage, upsSubsetOutputGroup=upsSubsetOutputGroup, upsFullBypassGroup=upsFullBypassGroup, upsConfigInputVoltage=upsConfigInputVoltage, upsFullConfigGroup=upsFullConfigGroup, upsBypass=upsBypass, upsIdentName=upsIdentName, upsAlarmFuseFailure=upsAlarmFuseFailure, NonNegativeInteger=NonNegativeInteger, upsAlarmOutputOverload=upsAlarmOutputOverload, upsAlarmShutdownImminent=upsAlarmShutdownImminent, upsBypassPower=upsBypassPower, upsFullTestGroup=upsFullTestGroup, upsAlarmCommunicationsLost=upsAlarmCommunicationsLost, upsWellKnownTests=upsWellKnownTests, upsInputVoltage=upsInputVoltage, upsBypassLineIndex=upsBypassLineIndex, upsOutput=upsOutput, upsTestNoTestsInitiated=upsTestNoTestsInitiated, upsInputTruePower=upsInputTruePower, upsTestGeneralSystemsTest=upsTestGeneralSystemsTest, upsBypassCurrent=upsBypassCurrent, upsBatteryCurrent=upsBatteryCurrent, upsSubsetConfigGroup=upsSubsetConfigGroup, upsSubsetGroups=upsSubsetGroups, upsShutdownAfterDelay=upsShutdownAfterDelay, upsOutputEntry=upsOutputEntry, upsRebootWithDuration=upsRebootWithDuration, upsSubsetIdentGroup=upsSubsetIdentGroup, upsInputTable=upsInputTable, upsBasicGroups=upsBasicGroups, upsTestResultsSummary=upsTestResultsSummary, upsOutputTable=upsOutputTable, upsConfigOutputVoltage=upsConfigOutputVoltage, upsTestQuickBatteryTest=upsTestQuickBatteryTest, upsConfigLowBattTime=upsConfigLowBattTime, upsOutputLineIndex=upsOutputLineIndex, upsBasicTestGroup=upsBasicTestGroup, upsTestDeepBatteryCalibration=upsTestDeepBatteryCalibration, upsInputCurrent=upsInputCurrent, upsConfigHighVoltageTransferPoint=upsConfigHighVoltageTransferPoint, upsIdentAttachedDevices=upsIdentAttachedDevices, upsInputFrequency=upsInputFrequency, upsAlarmGeneralFault=upsAlarmGeneralFault, upsBypassFrequency=upsBypassFrequency, upsAlarmLowBattery=upsAlarmLowBattery, upsAlarm=upsAlarm, upsOutputCurrent=upsOutputCurrent, upsAlarmUpsSystemOff=upsAlarmUpsSystemOff, upsTestElapsedTime=upsTestElapsedTime, upsOutputFrequency=upsOutputFrequency, upsConfigLowVoltageTransferPoint=upsConfigLowVoltageTransferPoint, upsSubsetInputGroup=upsSubsetInputGroup, upsSubsetAlarmGroup=upsSubsetAlarmGroup, upsStartupAfterDelay=upsStartupAfterDelay, upsAlarmEntry=upsAlarmEntry, upsTest=upsTest, upsGroups=upsGroups, upsBasicIdentGroup=upsBasicIdentGroup, upsMIB=upsMIB, upsObjects=upsObjects, upsAlarmBatteryBad=upsAlarmBatteryBad, upsBasicBypassGroup=upsBasicBypassGroup, upsFullIdentGroup=upsFullIdentGroup, upsInputEntry=upsInputEntry, upsConfigAudibleStatus=upsConfigAudibleStatus, upsShutdownType=upsShutdownType, upsConfigOutputFreq=upsConfigOutputFreq, upsAlarmOnBypass=upsAlarmOnBypass, upsOutputNumLines=upsOutputNumLines, upsBypassTable=upsBypassTable, upsOutputSource=upsOutputSource, upsBypassEntry=upsBypassEntry, upsAutoRestart=upsAutoRestart, upsEstimatedChargeRemaining=upsEstimatedChargeRemaining, upsOutputPercentLoad=upsOutputPercentLoad, upsBatteryTemperature=upsBatteryTemperature, upsBasicCompliance=upsBasicCompliance, upsAlarmDepletedBattery=upsAlarmDepletedBattery, PYSNMP_MODULE_ID=upsMIB, upsSubsetCompliance=upsSubsetCompliance, upsBasicConfigGroup=upsBasicConfigGroup, upsFullGroups=upsFullGroups, upsConformance=upsConformance, upsTestSpinLock=upsTestSpinLock, upsBasicInputGroup=upsBasicInputGroup, upsAlarmDiagnosticTestFailed=upsAlarmDiagnosticTestFailed, upsAlarmUpsOutputOff=upsAlarmUpsOutputOff, upsBasicControlGroup=upsBasicControlGroup, upsConfigOutputPower=upsConfigOutputPower, upsAlarmId=upsAlarmId, upsBasicBatteryGroup=upsBasicBatteryGroup, upsAlarmTempBad=upsAlarmTempBad, upsEstimatedMinutesRemaining=upsEstimatedMinutesRemaining, upsTraps=upsTraps, upsAlarmAwaitingPower=upsAlarmAwaitingPower, upsInputLineBads=upsInputLineBads, upsIdentAgentSoftwareVersion=upsIdentAgentSoftwareVersion, upsAlarmOutputBad=upsAlarmOutputBad, upsAlarmOutputOffAsRequested=upsAlarmOutputOffAsRequested, upsAlarmUpsOffAsRequested=upsAlarmUpsOffAsRequested, upsFullAlarmGroup=upsFullAlarmGroup, upsAlarmOnBattery=upsAlarmOnBattery, upsInputNumLines=upsInputNumLines, upsCompliances=upsCompliances, upsIdentModel=upsIdentModel, upsTrapAlarmEntryAdded=upsTrapAlarmEntryAdded, upsIdentUPSSoftwareVersion=upsIdentUPSSoftwareVersion, upsAlarmFanFailure=upsAlarmFanFailure, upsFullInputGroup=upsFullInputGroup, upsTestAbortTestInProgress=upsTestAbortTestInProgress, upsFullCompliance=upsFullCompliance, upsFullOutputGroup=upsFullOutputGroup, upsAlarmChargerFailed=upsAlarmChargerFailed, upsBypassNumLines=upsBypassNumLines, upsAlarmTable=upsAlarmTable, upsInputLineIndex=upsInputLineIndex, upsFullControlGroup=upsFullControlGroup, upsAlarmsPresent=upsAlarmsPresent, upsAlarmTestInProgress=upsAlarmTestInProgress, upsBasicAlarmGroup=upsBasicAlarmGroup, upsAlarmShutdownPending=upsAlarmShutdownPending, upsFullBatteryGroup=upsFullBatteryGroup, upsTestResultsDetail=upsTestResultsDetail, upsAlarmDescr=upsAlarmDescr, upsIdentManufacturer=upsIdentManufacturer, upsWellKnownAlarms=upsWellKnownAlarms, upsTrapTestCompleted=upsTrapTestCompleted, upsTestId=upsTestId, upsConfig=upsConfig, upsSubsetControlGroup=upsSubsetControlGroup, upsConfigInputFreq=upsConfigInputFreq)
