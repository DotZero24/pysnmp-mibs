...
mbsmIssScalarGroup=_MbsmIssScalarGroup_ObjectIdentity((1,3,6,1,4,1,2076,81,100,1))
...
mbsmMaxNumOfLCSlots=_MbsmMaxNumOfLCSlots_Object((1,3,6,1,4,1,2076,81,100,1,1),_MbsmMaxNumOfLCSlots_Type())
...
mbsmMaxNumOfSlots=_MbsmMaxNumOfSlots_Object((1,3,6,1,4,1,2076,81,100,1,2),_MbsmMaxNumOfSlots_Type())
...
mbsmMaxNumOfPortsPerLC=_MbsmMaxNumOfPortsPerLC_Object((1,3,6,1,4,1,2076,81,100,1,3),_MbsmMaxNumOfPortsPerLC_Type())
...
mbsmLoadSharingFlag=_MbsmLoadSharingFlag_Object((1,3,6,1,4,1,2076,81,100,1,4),_MbsmLoadSharingFlag_Type())
...
mbsmSlotModuleMapTable=_MbsmSlotModuleMapTable_Object((1,3,6,1,4,1,2076,81,100,2))
if mibBuilder.loadTexts:mbsmSlotModuleMapTable.setStatus(_A)
_MbsmSlotModuleMapEntry_Object=MibTableRow
mbsmSlotModuleMapEntry=_MbsmSlotModuleMapEntry_Object((1,3,6,1,4,1,2076,81,100,2,1))
...
mbsmSlotId=_MbsmSlotId_Object((1,3,6,1,4,1,2076,81,100,2,1,1),_MbsmSlotId_Type())
...
mbsmSlotModuleType=_MbsmSlotModuleType_Object((1,3,6,1,4,1,2076,81,100,2,1,2),_MbsmSlotModuleType_Type())
...
mbsmSlotModuleStatus=_MbsmSlotModuleStatus_Object((1,3,6,1,4,1,2076,81,100,2,1,3),_MbsmSlotModuleStatus_Type())
...
mbsmLCTypeTable=_MbsmLCTypeTable_Object((1,3,6,1,4,1,2076,81,100,3))
if mibBuilder.loadTexts:mbsmLCTypeTable.setStatus(_A)
_MbsmLCTypeEntry_Object=MibTableRow
mbsmLCTypeEntry=_MbsmLCTypeEntry_Object((1,3,6,1,4,1,2076,81,100,3,1))
...
mbsmLCIndex=_MbsmLCIndex_Object((1,3,6,1,4,1,2076,81,100,3,1,1),_MbsmLCIndex_Type())
...
mbsmLCName=_MbsmLCName_Object((1,3,6,1,4,1,2076,81,100,3,1,2),_MbsmLCName_Type())
...
mbsmLCMaxPorts=_MbsmLCMaxPorts_Object((1,3,6,1,4,1,2076,81,100,3,1,3),_MbsmLCMaxPorts_Type())
...
mbsmLCRowStatus=_MbsmLCRowStatus_Object((1,3,6,1,4,1,2076,81,100,3,1,4),_MbsmLCRowStatus_Type())
mbsmLCRowStatus.setMaxAccess(_E)
if mibBuilder.loadTexts:mbsmLCRowStatus.setStatus(_A)
_MbsmLCPortInfoTable_Object=MibTable
mbsmLCPortInfoTable=_MbsmLCPortInfoTable_Object((1,3,6,1,4,1,2076,81,100,4))
if mibBuilder.loadTexts:mbsmLCPortInfoTable.setStatus(_A)
_MbsmLCPortInfoEntry_Object=MibTableRow
mbsmLCPortInfoEntry=_MbsmLCPortInfoEntry_Object((1,3,6,1,4,1,2076,81,100,4,1))
...
mbsmLCPortIndex=_MbsmLCPortIndex_Object((1,3,6,1,4,1,2076,81,100,4,1,1),_MbsmLCPortIndex_Type())
...
mbsmLCPortIfType=_MbsmLCPortIfType_Object((1,3,6,1,4,1,2076,81,100,4,1,2),_MbsmLCPortIfType_Type())
...
mbsmLCPortSpeed=_MbsmLCPortSpeed_Object((1,3,6,1,4,1,2076,81,100,4,1,3),_MbsmLCPortSpeed_Type())
...
mbsmLCPortHighSpeed=_MbsmLCPortHighSpeed_Object((1,3,6,1,4,1,2076,81,100,4,1,4),_MbsmLCPortHighSpeed_Type())
...
mbsmLCConfigTable=_MbsmLCConfigTable_Object((1,3,6,1,4,1,2076,81,100,5))
if mibBuilder.loadTexts:mbsmLCConfigTable.setStatus(_A)
_MbsmLCConfigEntry_Object=MibTableRow
mbsmLCConfigEntry=_MbsmLCConfigEntry_Object((1,3,6,1,4,1,2076,81,100,5,1))
...
mbsmLCConfigSlotId=_MbsmLCConfigSlotId_Object((1,3,6,1,4,1,2076,81,100,5,1,1),_MbsmLCConfigSlotId_Type())
...
mbsmLCConfigCardName=_MbsmLCConfigCardName_Object((1,3,6,1,4,1,2076,81,100,5,1,2),_MbsmLCConfigCardName_Type())
...
mbsmLCConfigStatus=_MbsmLCConfigStatus_Object((1,3,6,1,4,1,2076,81,100,5,1,3),_MbsmLCConfigStatus_Type())
...
mbsmIssTrapGroup=_MbsmIssTrapGroup_ObjectIdentity((1,3,6,1,4,1,2076,81,100,6))
mbsmConfigErrTrap=NotificationType((1,3,6,1,4,1,2076,81,100,6,1))
mbsmConfigErrTrap.setObjects(*((_C,_F),(_C,_L),(_C,_M),(_C,_N)))
if mibBuilder.loadTexts:mbsmConfigErrTrap.setStatus(_A)
mbsmCardInsertedTrap=NotificationType((1,3,6,1,4,1,2076,81,100,6,2))
mbsmCardInsertedTrap.setObjects((_C,_F))
if mibBuilder.loadTexts:mbsmCardInsertedTrap.setStatus(_A)
mbsmCardRemovedTrap=NotificationType((1,3,6,1,4,1,2076,81,100,6,3))
