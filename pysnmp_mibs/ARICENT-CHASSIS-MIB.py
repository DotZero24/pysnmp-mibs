# SNMP MIB module (ARICENT-CHASSIS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-CHASSIS-MIB
...
mbsmSlotModuleMapEntry = _MbsmSlotModuleMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 100, 2, 1)
)
mbsmSlotModuleMapEntry.setIndexNames(
    (0, "ARICENT-CHASSIS-MIB", "mbsmSlotId"),
)
if mibBuilder.loadTexts:
...
mbsmLCPortInfoEntry = _MbsmLCPortInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 81, 100, 4, 1)
)
mbsmLCPortInfoEntry.setIndexNames(
    (0, "ARICENT-CHASSIS-MIB", "mbsmLCIndex"),
    (0, "ARICENT-CHASSIS-MIB", "mbsmLCPortIndex"),
)
if mibBuilder.loadTexts:
...
mbsmConfigErrTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 81, 100, 6, 1)
)
mbsmConfigErrTrap.setObjects(
      *(("ARICENT-CHASSIS-MIB", "mbsmSlotId"),
        ("ARICENT-CHASSIS-MIB", "mbsmSlotModuleType"),
        ("ARICENT-CHASSIS-MIB", "mbsmSlotModuleStatus"),
        ("ARICENT-CHASSIS-MIB", "mbsmLCConfigCardName"))
)
if mibBuilder.loadTexts:
