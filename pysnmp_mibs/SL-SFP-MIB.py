...
Float64TC, Float32TC, Float128TC = mibBuilder.importSymbols("FLOAT-TC-MIB", "Float64TC", "Float32TC", "Float128TC")
...
mibBuilder.exportSymbols("SL-SFP-MIB", sfpConfigCohCurrentOSNR=sfpConfigCohCurrentOSNR, sfpDiagRxMeasuredWavelength=sfpDiagRxMeasuredWavelength, sfpConfigCleiCode=sfpConfigCleiCode, sfpConfigQsfppEthernetCode=sfpConfigQsfppEthernetCode, sfpDiagLowTempWrnThreshold=sfpDiagLowTempWrnThreshold, sfpConfigEntry=sfpConfigEntry, sfpConfigInfibandCompliance=sfpConfigInfibandCompliance, sfpConfig8472Compliance=sfpConfig8472Compliance, sfpConfigXfpCalibrationSupported=sfpConfigXfpCalibrationSupported, sfpDiagHighWaveLenWrnThreshold=sfpDiagHighWaveLenWrnThreshold, sfpDiagLowWaveLenWrnThreshold=sfpDiagLowWaveLenWrnThreshold, sfpConfigEsconCompliance=sfpConfigEsconCompliance, sfpConfigInterface=sfpConfigInterface, sfpConfigEnhanceOptions=sfpConfigEnhanceOptions, sfpConfigVdtControl=sfpConfigVdtControl, sfpConfigXfpMinBitRate=sfpConfigXfpMinBitRate, sfpConfigCxpNominalWavelength=sfpConfigCxpNominalWavelength, sfpConfigXfpCalibrationEnabled=sfpConfigXfpCalibrationEnabled, sfpConfigLength9mKm=sfpConfigLength9mKm, sfpConfig1310ExtXcvrId=sfpConfig1310ExtXcvrId, sfpConfigCfpMaxWavelenPerActive=sfpConfigCfpMaxWavelenPerActive, sfpDiagRxInputPower=sfpDiagRxInputPower, sfpConfigXfpDeviceTech=sfpConfigXfpDeviceTech, sfpConfigVendorOUI=sfpConfigVendorOUI, sfpConfigXfpMaxBitRate=sfpConfigXfpMaxBitRate, sfpConfigCfpMaxMmFiberLength=sfpConfigCfpMaxMmFiberLength, sfpConfigCohRxDesiredChannel=sfpConfigCohRxDesiredChannel, sfpDiag=sfpDiag, sfpConfigCfpMediaProperties=sfpConfigCfpMediaProperties, sfpDiagLowRxPowerAlmThreshold=sfpDiagLowRxPowerAlmThreshold, sfpConfigDateCode=sfpConfigDateCode, sfpConfigEncodingCode=sfpConfigEncodingCode, sfpConfigXfpEncodingCode=sfpConfigXfpEncodingCode, sfpConfigCxpDeviceTech=sfpConfigCxpDeviceTech, sfpConfigQsfppSonetCode=sfpConfigQsfppSonetCode, sfpConfigExtendedOptions=sfpConfigExtendedOptions, sfpDiagCxpLowTxTempAlmThreshold=sfpDiagCxpLowTxTempAlmThreshold, sfpConfigVendorPN=sfpConfigVendorPN, sfpDiagLowTxBiasAlmThreshold=sfpDiagLowTxBiasAlmThreshold, sfpConfigLength9m100m=sfpConfigLength9m100m, sfpConfig10GFcCompliance=sfpConfig10GFcCompliance, sfpConfigMaxBitRate=sfpConfigMaxBitRate, sfpConfigCfpSupportedRates=sfpConfigCfpSupportedRates, sfpConfigXfpCapFreqLast10Ghz=sfpConfigXfpCapFreqLast10Ghz, sfpDiagHighTxBiasWrnThreshold=sfpDiagHighTxBiasWrnThreshold, sfpDiagLowVoltWrnThreshold=sfpDiagLowVoltWrnThreshold, sfpConfigNominalBitRate=sfpConfigNominalBitRate, sfpConfigChangeTrap=sfpConfigChangeTrap, sfpDiagRxLaserTemperature=sfpDiagRxLaserTemperature, sfpDiagWarnings=sfpDiagWarnings, sfpConfigGbeCompliance=sfpConfigGbeCompliance, sfpDiagHighVoltWrnThreshold=sfpDiagHighVoltWrnThreshold, sfpConfigNyquist=sfpConfigNyquist, sfpConfigCfpMaxHostLaneRate=sfpConfigCfpMaxHostLaneRate, sfpConfigMaxTemp=sfpConfigMaxTemp, sfpDiagHighWaveLenAlmThreshold=sfpDiagHighWaveLenAlmThreshold, slSfp=slSfp, sfpDiagHighTempWrnThreshold=sfpDiagHighTempWrnThreshold, PYSNMP_MODULE_ID=slSfp, sfpConfigXcvrId=sfpConfigXcvrId, sfpDiagInterface=sfpDiagInterface, sfpDiagConfLowRxPowerAlmThreshold=sfpDiagConfLowRxPowerAlmThreshold, sfpConfigVendorSN=sfpConfigVendorSN, sfpConfigXfpCapFreqFirst10Ghz=sfpConfigXfpCapFreqFirst10Ghz, sfpDiagLowLaserTempAlmThreshold=sfpDiagLowLaserTempAlmThreshold, sfpConfigCfpSupportedLanes=sfpConfigCfpSupportedLanes, sfpConfigXfpDesiredWl=sfpConfigXfpDesiredWl, sfpDiagModuleTemperature=sfpDiagModuleTemperature, sfpDiagHighTempAlmThreshold=sfpDiagHighTempAlmThreshold, sfpConfigCfpExtId=sfpConfigCfpExtId, sfpConfigCxpMaxSupportedRate=sfpConfigCxpMaxSupportedRate, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagLowTempAlmThreshold=sfpDiagLowTempAlmThreshold, sfpDiagOtdrFiberCutRange=sfpDiagOtdrFiberCutRange, sfpConfigDiagnosticMonitoring=sfpConfigDiagnosticMonitoring, sfpDiagWarningsMask=sfpDiagWarningsMask, sfpConfigWaveLength=sfpConfigWaveLength, sfpConfigSonetCompliance=sfpConfigSonetCompliance, sfpConfigCfpMaxLenOpticalWidth=sfpConfigCfpMaxLenOpticalWidth, sfpConfigMaxSupplyCurrent=sfpConfigMaxSupplyCurrent, sfpConfigXfpExtXcvrId=sfpConfigXfpExtXcvrId, sfpDiagEntry=sfpDiagEntry, sfpDiagHighTxPowerWrnThreshold=sfpDiagHighTxPowerWrnThreshold, sfpConfigOptionalWdm=sfpConfigOptionalWdm, sfpDiagLowWaveLenAlmThreshold=sfpDiagLowWaveLenAlmThreshold, sfpDiagTxBias=sfpDiagTxBias, sfpConfigCfpEthernetCode=sfpConfigCfpEthernetCode, sfpConfigCfpMinWavelenPerActive=sfpConfigCfpMinWavelenPerActive, sfpDiagHighTxBiasAlmThreshold=sfpDiagHighTxBiasAlmThreshold, sfpDiagHighVoltAlmThreshold=sfpDiagHighVoltAlmThreshold, sfpConfigXfpCapFreqLastThz=sfpConfigXfpCapFreqLastThz, sfpConfigCfpConnectorType=sfpConfigCfpConnectorType, sfpConfigCfpMaxSmFiberLength=sfpConfigCfpMaxSmFiberLength, sfpConfigLength50m10m=sfpConfigLength50m10m, sfpConfigCohAverageOSNR=sfpConfigCohAverageOSNR, sfpDiagHighLaserTempWrnThreshold=sfpDiagHighLaserTempWrnThreshold, sfpConfigMinTemp=sfpConfigMinTemp, sfpConfigVendorRev=sfpConfigVendorRev, sfpConfigXfpDesiredFreq=sfpConfigXfpDesiredFreq, sfpDiagTable=sfpDiagTable, sfpDiagLowVoltAlmThreshold=sfpDiagLowVoltAlmThreshold, sfpConfigXfpCapFreqFirstThz=sfpConfigXfpCapFreqFirstThz, sfpConfigCfpCopperCode=sfpConfigCfpCopperCode, sfpConfigCxpConnectorType=sfpConfigCxpConnectorType, sfpDiagCxpHighTxTempAlmThreshold=sfpDiagCxpHighTxTempAlmThreshold, sfpConfig10GSonetCompliance=sfpConfig10GSonetCompliance, sfpDiagCxpLowRxTempAlmThreshold=sfpDiagCxpLowRxTempAlmThreshold, sfpDiagHighRxPowerWrnThreshold=sfpDiagHighRxPowerWrnThreshold, sfpConf=sfpConf, sfpConfigTunableWaveLength=sfpConfigTunableWaveLength, sfpDiagHighTecCurrWrnThreshold=sfpDiagHighTecCurrWrnThreshold, sfpConfig10GbeCompliance=sfpConfig10GbeCompliance, sfpConfigXfpTuningSupported=sfpConfigXfpTuningSupported, sfpConfigXfpDitherSupported=sfpConfigXfpDitherSupported, sfpConfigCfpSonetCode=sfpConfigCfpSonetCode, sfpConfigCohMaxCD=sfpConfigCohMaxCD, sfpTune=sfpTune, sfpConfigTable=sfpConfigTable, sfpConfigVoaControl=sfpConfigVoaControl, sfpDiagHighTxPowerAlmThreshold=sfpDiagHighTxPowerAlmThreshold, sfpConfigConnectorCode=sfpConfigConnectorCode, sfpDiagLowTxPowerWrnThreshold=sfpDiagLowTxPowerWrnThreshold, sfpDiagHighTecCurrAlmThreshold=sfpDiagHighTecCurrAlmThreshold, sfpConfigXfpCapMaxSpacing10Ghz=sfpConfigXfpCapMaxSpacing10Ghz, sfpConfigCfpMaxNetworkLaneRate=sfpConfigCfpMaxNetworkLaneRate, sfpDiagCxpTxTemp=sfpDiagCxpTxTemp, sfpDiagLowRxPowerWrnThreshold=sfpDiagLowRxPowerWrnThreshold, sfpConfigCfpMaxCopperCableLength=sfpConfigCfpMaxCopperCableLength, sfpTraps=sfpTraps, sfpConfigLength62m10m=sfpConfigLength62m10m, sfpDiagLowTecCurrAlmThreshold=sfpDiagLowTecCurrAlmThreshold, sfpConfigPilotToneModulation=sfpConfigPilotToneModulation, sfpConfigVendorName=sfpConfigVendorName, sfpConfigCohRxDesiredFreq=sfpConfigCohRxDesiredFreq, sfpConfigWdmExtXcvrId=sfpConfigWdmExtXcvrId, sfpDiagLowTxPowerAlmThreshold=sfpDiagLowTxPowerAlmThreshold, sfpDiagCxpRxTemp=sfpDiagCxpRxTemp, sfpDiagLowTxBiasWrnThreshold=sfpDiagLowTxBiasWrnThreshold, sfpDiagModuleTemperatureCelsius=sfpDiagModuleTemperatureCelsius, sfpDiagCxpHighRxTempAlmThreshold=sfpDiagCxpHighRxTempAlmThreshold, sfpDiagRxTecCurrent=sfpDiagRxTecCurrent, sfpDiagHighLaserTempAlmThreshold=sfpDiagHighLaserTempAlmThreshold, sfpConfigMinBitRate=sfpConfigMinBitRate, sfpConfigCohRxDesiredWl=sfpConfigCohRxDesiredWl, sfpDiagHighRxPowerAlmThreshold=sfpDiagHighRxPowerAlmThreshold, sfpConfigXfpDesiredChannel=sfpConfigXfpDesiredChannel, sfpConfigCfpFcCode=sfpConfigCfpFcCode, sfpDiagLowLaserTempWrnThreshold=sfpDiagLowLaserTempWrnThreshold, sfpConfigXfpDitherAdmin=sfpConfigXfpDitherAdmin, sfpDiagLowTecCurrWrnThreshold=sfpDiagLowTecCurrWrnThreshold, sfpConfigFcCompliance=sfpConfigFcCompliance, sfpDiagAlarmsMask=sfpDiagAlarmsMask, sfpConfigCfpOtnCode=sfpConfigCfpOtnCode, sfpDiagAlarms=sfpDiagAlarms, sfpConfigCohCurrentCD=sfpConfigCohCurrentCD, sfpConfigChannelSpacing=sfpConfigChannelSpacing, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpDiagRxInputPowerFloat=sfpDiagRxInputPowerFloat, sfpConfigCxpExtId=sfpConfigCxpExtId, sfpConfigCfpSpacing=sfpConfigCfpSpacing, sfpConfigXfpFreqError=sfpConfigXfpFreqError, sfpConfigXfpWlError=sfpConfigXfpWlError, sfpDiagChannelRxInputPower=sfpDiagChannelRxInputPower, sfpConfigLengthCopper1m=sfpConfigLengthCopper1m, sfpConfigModulationFormat=sfpConfigModulationFormat)
