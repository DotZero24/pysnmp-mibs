...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/smartoptics/SL-SFP-MIB
...
if mibBuilder.loadTexts: slSfp.setOrganization('Smartoptics AS')
...
sfpConfigModulationFormat = MibTableColumn((1, 3, 6, 1, 4, 1, 4515, 1, 10, 1, 1, 1, 123), Integer32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: sfpConfigModulationFormat.setStatus('current')
...
sfpDiagChannelRxInputPower = MibTableColumn((1, 3, 6, 1, 4, 1, 4515, 1, 10, 2, 1, 1, 48), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
if mibBuilder.loadTexts: sfpDiagChannelRxInputPower.setStatus('current')
...
mibBuilder.exportSymbols("SL-SFP-MIB", sfpConfigCohCurrentOSNR=sfpConfigCohCurrentOSNR, sfpDiagConfLowRxPowerAlmThreshold=sfpDiagConfLowRxPowerAlmThreshold, sfpConfigChangeTrap=sfpConfigChangeTrap, sfpDiagLowWaveLenAlmThreshold=sfpDiagLowWaveLenAlmThreshold, sfpConfigNominalBitRate=sfpConfigNominalBitRate, sfpDiagLowTempAlmThreshold=sfpDiagLowTempAlmThreshold, sfpDiagHighTempAlmThreshold=sfpDiagHighTempAlmThreshold, sfpDiagLowLaserTempWrnThreshold=sfpDiagLowLaserTempWrnThreshold, sfpConfigVendorSN=sfpConfigVendorSN, sfpDiagChannelRxInputPower=sfpDiagChannelRxInputPower, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpDiagLowWaveLenWrnThreshold=sfpDiagLowWaveLenWrnThreshold, sfpConfigWdmExtXcvrId=sfpConfigWdmExtXcvrId, sfpConfigVendorPN=sfpConfigVendorPN, sfpDiagWarnings=sfpDiagWarnings, sfpDiagHighWaveLenAlmThreshold=sfpDiagHighWaveLenAlmThreshold, sfpConfigCfpMaxNetworkLaneRate=sfpConfigCfpMaxNetworkLaneRate, sfpConfigXfpWlError=sfpConfigXfpWlError, sfpDiagLowTempWrnThreshold=sfpDiagLowTempWrnThreshold, sfpConfigEnhanceOptions=sfpConfigEnhanceOptions, sfpConfigGbeCompliance=sfpConfigGbeCompliance, sfpConfigTunableWaveLength=sfpConfigTunableWaveLength, sfpConfigFcCompliance=sfpConfigFcCompliance, sfpConfigEncodingCode=sfpConfigEncodingCode, sfpConfigXfpEncodingCode=sfpConfigXfpEncodingCode, sfpDiagLowRxPowerWrnThreshold=sfpDiagLowRxPowerWrnThreshold, sfpConfigWaveLength=sfpConfigWaveLength, sfpConfigLength9mKm=sfpConfigLength9mKm, sfpConfigNyquist=sfpConfigNyquist, sfpConfigCxpNominalWavelength=sfpConfigCxpNominalWavelength, sfpConfigVendorOUI=sfpConfigVendorOUI, sfpDiagHighVoltWrnThreshold=sfpDiagHighVoltWrnThreshold, sfpConfig10GSonetCompliance=sfpConfig10GSonetCompliance, sfpConfigLength9m100m=sfpConfigLength9m100m, sfpConfigXfpMinBitRate=sfpConfigXfpMinBitRate, sfpConfigXfpDitherAdmin=sfpConfigXfpDitherAdmin, sfpConfigCfpSpacing=sfpConfigCfpSpacing, sfpConfigLengthCopper1m=sfpConfigLengthCopper1m, sfpConfigMaxSupplyCurrent=sfpConfigMaxSupplyCurrent, sfpConfigPilotToneModulation=sfpConfigPilotToneModulation, sfpConfigCfpSupportedLanes=sfpConfigCfpSupportedLanes, sfpDiagLowVoltAlmThreshold=sfpDiagLowVoltAlmThreshold, sfpDiagLowTxPowerWrnThreshold=sfpDiagLowTxPowerWrnThreshold, sfpConfigEsconCompliance=sfpConfigEsconCompliance, sfpConfigXfpExtXcvrId=sfpConfigXfpExtXcvrId, sfpDiagRxInputPowerFloat=sfpDiagRxInputPowerFloat, sfpConfigXfpCalibrationEnabled=sfpConfigXfpCalibrationEnabled, sfpDiagHighTempWrnThreshold=sfpDiagHighTempWrnThreshold, sfpTraps=sfpTraps, sfpConfigVendorName=sfpConfigVendorName, sfpDiagTxBias=sfpDiagTxBias, sfpConfigLength50m10m=sfpConfigLength50m10m, sfpConfig1310ExtXcvrId=sfpConfig1310ExtXcvrId, sfpConfig10GFcCompliance=sfpConfig10GFcCompliance, sfpConfigCohRxDesiredFreq=sfpConfigCohRxDesiredFreq, sfpDiagOtdrFiberCutRange=sfpDiagOtdrFiberCutRange, sfpConfigCxpDeviceTech=sfpConfigCxpDeviceTech, sfpConfigEntry=sfpConfigEntry, sfpConf=sfpConf, sfpConfigConnectorCode=sfpConfigConnectorCode, sfpConfigModulationFormat=sfpConfigModulationFormat, sfpConfigXfpTuningSupported=sfpConfigXfpTuningSupported, sfpDiagHighRxPowerAlmThreshold=sfpDiagHighRxPowerAlmThreshold, sfpConfigXfpCapFreqLast10Ghz=sfpConfigXfpCapFreqLast10Ghz, sfpDiagRxInputPower=sfpDiagRxInputPower, sfpConfigInfibandCompliance=sfpConfigInfibandCompliance, sfpConfig8472Compliance=sfpConfig8472Compliance, sfpDiagHighLaserTempWrnThreshold=sfpDiagHighLaserTempWrnThreshold, sfpConfigXfpDitherSupported=sfpConfigXfpDitherSupported, sfpConfigCfpFcCode=sfpConfigCfpFcCode, sfpDiagHighLaserTempAlmThreshold=sfpDiagHighLaserTempAlmThreshold, sfpDiagHighTecCurrWrnThreshold=sfpDiagHighTecCurrWrnThreshold, sfpConfigQsfppSonetCode=sfpConfigQsfppSonetCode, sfpConfigXfpMaxBitRate=sfpConfigXfpMaxBitRate, sfpConfigXfpFreqError=sfpConfigXfpFreqError, sfpConfigXfpDeviceTech=sfpConfigXfpDeviceTech, sfpDiagHighTxPowerWrnThreshold=sfpDiagHighTxPowerWrnThreshold, sfpDiagLowTecCurrWrnThreshold=sfpDiagLowTecCurrWrnThreshold, sfpDiagRxLaserTemperature=sfpDiagRxLaserTemperature, sfpTune=sfpTune, sfpDiagModuleTemperature=sfpDiagModuleTemperature, sfpConfigXfpDesiredWl=sfpConfigXfpDesiredWl, sfpConfigMinBitRate=sfpConfigMinBitRate, sfpConfigCfpCopperCode=sfpConfigCfpCopperCode, sfpDiagRxTecCurrent=sfpDiagRxTecCurrent, sfpConfigDiagnosticMonitoring=sfpConfigDiagnosticMonitoring, sfpConfigCxpExtId=sfpConfigCxpExtId, sfpConfigCxpConnectorType=sfpConfigCxpConnectorType, sfpConfigXcvrId=sfpConfigXcvrId, sfpConfigVdtControl=sfpConfigVdtControl, sfpConfigCfpOtnCode=sfpConfigCfpOtnCode, sfpConfigCohAverageOSNR=sfpConfigCohAverageOSNR, sfpDiagHighTxBiasWrnThreshold=sfpDiagHighTxBiasWrnThreshold, sfpConfigCfpMaxCopperCableLength=sfpConfigCfpMaxCopperCableLength, sfpDiagLowTxBiasWrnThreshold=sfpDiagLowTxBiasWrnThreshold, sfpConfigExtendedOptions=sfpConfigExtendedOptions, sfpConfigCohCurrentCD=sfpConfigCohCurrentCD, sfpConfigXfpCapMaxSpacing10Ghz=sfpConfigXfpCapMaxSpacing10Ghz, sfpConfigCfpMaxSmFiberLength=sfpConfigCfpMaxSmFiberLength, sfpDiagCxpRxTemp=sfpDiagCxpRxTemp, sfpConfigInterface=sfpConfigInterface, sfpDiagLowTxPowerAlmThreshold=sfpDiagLowTxPowerAlmThreshold, sfpConfigCohRxDesiredChannel=sfpConfigCohRxDesiredChannel, sfpDiagAlarmsMask=sfpDiagAlarmsMask, sfpConfigQsfppEthernetCode=sfpConfigQsfppEthernetCode, sfpConfigCleiCode=sfpConfigCleiCode, sfpConfigXfpCapFreqFirst10Ghz=sfpConfigXfpCapFreqFirst10Ghz, sfpDiagHighTxPowerAlmThreshold=sfpDiagHighTxPowerAlmThreshold, sfpDiagHighTecCurrAlmThreshold=sfpDiagHighTecCurrAlmThreshold, sfpConfigVoaControl=sfpConfigVoaControl, sfpConfigSonetCompliance=sfpConfigSonetCompliance, sfpDiagCxpLowTxTempAlmThreshold=sfpDiagCxpLowTxTempAlmThreshold, sfpConfigXfpCapFreqFirstThz=sfpConfigXfpCapFreqFirstThz, sfpDiagWarningsMask=sfpDiagWarningsMask, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagLowTxBiasAlmThreshold=sfpDiagLowTxBiasAlmThreshold, sfpConfigCfpEthernetCode=sfpConfigCfpEthernetCode, sfpDiagAlarms=sfpDiagAlarms, sfpConfigCfpMediaProperties=sfpConfigCfpMediaProperties, slSfp=slSfp, sfpDiagCxpHighRxTempAlmThreshold=sfpDiagCxpHighRxTempAlmThreshold, sfpDiag=sfpDiag, sfpConfigDateCode=sfpConfigDateCode, sfpConfigMaxTemp=sfpConfigMaxTemp, sfpConfigXfpCalibrationSupported=sfpConfigXfpCalibrationSupported, sfpDiagLowLaserTempAlmThreshold=sfpDiagLowLaserTempAlmThreshold, sfpDiagLowRxPowerAlmThreshold=sfpDiagLowRxPowerAlmThreshold, sfpDiagHighWaveLenWrnThreshold=sfpDiagHighWaveLenWrnThreshold, sfpConfigCfpMinWavelenPerActive=sfpConfigCfpMinWavelenPerActive, sfpConfigVendorRev=sfpConfigVendorRev, sfpDiagHighTxBiasAlmThreshold=sfpDiagHighTxBiasAlmThreshold, sfpConfigCfpMaxWavelenPerActive=sfpConfigCfpMaxWavelenPerActive, sfpConfigXfpCapFreqLastThz=sfpConfigXfpCapFreqLastThz, sfpConfigCfpSupportedRates=sfpConfigCfpSupportedRates, sfpConfigLength62m10m=sfpConfigLength62m10m, sfpDiagLowVoltWrnThreshold=sfpDiagLowVoltWrnThreshold, sfpConfigCohRxDesiredWl=sfpConfigCohRxDesiredWl, sfpDiagCxpLowRxTempAlmThreshold=sfpDiagCxpLowRxTempAlmThreshold, sfpConfigChannelSpacing=sfpConfigChannelSpacing, sfpConfigTable=sfpConfigTable, sfpDiagRxMeasuredWavelength=sfpDiagRxMeasuredWavelength, sfpConfigMaxBitRate=sfpConfigMaxBitRate, PYSNMP_MODULE_ID=slSfp, sfpConfigOptionalWdm=sfpConfigOptionalWdm, sfpConfig10GbeCompliance=sfpConfig10GbeCompliance, sfpDiagCxpTxTemp=sfpDiagCxpTxTemp, sfpDiagEntry=sfpDiagEntry, sfpDiagLowTecCurrAlmThreshold=sfpDiagLowTecCurrAlmThreshold, sfpDiagCxpHighTxTempAlmThreshold=sfpDiagCxpHighTxTempAlmThreshold, sfpDiagHighVoltAlmThreshold=sfpDiagHighVoltAlmThreshold, sfpConfigMinTemp=sfpConfigMinTemp, sfpConfigCfpExtId=sfpConfigCfpExtId, sfpConfigCfpMaxHostLaneRate=sfpConfigCfpMaxHostLaneRate, sfpConfigCfpConnectorType=sfpConfigCfpConnectorType, sfpDiagModuleTemperatureCelsius=sfpDiagModuleTemperatureCelsius, sfpConfigCfpMaxLenOpticalWidth=sfpConfigCfpMaxLenOpticalWidth, sfpConfigXfpDesiredChannel=sfpConfigXfpDesiredChannel, sfpConfigXfpDesiredFreq=sfpConfigXfpDesiredFreq, sfpConfigCfpMaxMmFiberLength=sfpConfigCfpMaxMmFiberLength, sfpConfigCxpMaxSupportedRate=sfpConfigCxpMaxSupportedRate, sfpDiagTable=sfpDiagTable, sfpConfigCohMaxCD=sfpConfigCohMaxCD, sfpDiagHighRxPowerWrnThreshold=sfpDiagHighRxPowerWrnThreshold, sfpDiagInterface=sfpDiagInterface, sfpConfigCfpSonetCode=sfpConfigCfpSonetCode)
