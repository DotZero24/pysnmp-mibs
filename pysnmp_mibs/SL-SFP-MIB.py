...
# Notes
# -----
# ASN.1 source file://mibs/smartoptics/SL-SFP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:11:27 2025
...
sfpConfigModulationFormat = _SfpConfigModulationFormat_Object(
    (1, 3, 6, 1, 4, 1, 4515, 1, 10, 1, 1, 1, 123),
    _SfpConfigModulationFormat_Type()
)
sfpConfigModulationFormat.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    sfpConfigModulationFormat.setStatus("current")
...
class _SfpDiagChannelRxInputPower_Type(Integer32):
    """Custom type sfpDiagChannelRxInputPower based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_SfpDiagChannelRxInputPower_Type.__name__ = "Integer32"
_SfpDiagChannelRxInputPower_Object = MibTableColumn
sfpDiagChannelRxInputPower = _SfpDiagChannelRxInputPower_Object(
    (1, 3, 6, 1, 4, 1, 4515, 1, 10, 2, 1, 1, 48),
    _SfpDiagChannelRxInputPower_Type()
)
sfpDiagChannelRxInputPower.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    sfpDiagChannelRxInputPower.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"slSfp": slSfp,
       ...
       "sfpConfigModulationFormat": sfpConfigModulationFormat,
       "sfpDiag": sfpDiag,
       ...
       "sfpDiagChannelRxInputPower": sfpDiagChannelRxInputPower,
