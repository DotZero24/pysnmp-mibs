# SNMP MIB module (H3530-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/H3530-MIB
...
trapTest.setObjects(
      *(("H3530-MIB", "sensorName"),
        ("H3530-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
