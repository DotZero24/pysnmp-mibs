...
mySPANSession=_MySPANSession_Object((1,3,6,1,4,1,4881,1,1,10,2,23,1,2,1,1),_MySPANSession_Type())
...
mySPANIfIndex=_MySPANIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,23,1,2,1,2),_MySPANIfIndex_Type())
...
mySPANIfRole=_MySPANIfRole_Object((1,3,6,1,4,1,4881,1,1,10,2,23,1,2,1,3),_MySPANIfRole_Type())
...
mySPANEntryStatus=_MySPANEntryStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,23,1,2,1,4),_MySPANEntryStatus_Type())
...
mySPANMIBConformance=_MySPANMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,23,3))
_MySPANMIBCompliances_ObjectIdentity=ObjectIdentity
mySPANMIBCompliances=_MySPANMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,23,3,1))
_MySPANMIBGroups_ObjectIdentity=ObjectIdentity
mySPANMIBGroups=_MySPANMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,23,3,2))
mySPANMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,23,3,2,1))
mySPANMIBGroup.setObjects(*((_B,_D),(_B,_E),(_B,_G),(_B,_H)))
if mibBuilder.loadTexts:mySPANMIBGroup.setStatus(_A)
mySPANMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,23,3,1,1))
