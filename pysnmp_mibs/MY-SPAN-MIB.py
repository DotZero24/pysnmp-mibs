# SNMP MIB module (MY-SPAN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-SPAN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:34:48 2025
...
mySPANEntry.setIndexNames(
    (0, "MY-SPAN-MIB", "mySPANSession"),
    (0, "MY-SPAN-MIB", "mySPANIfIndex"),
)
if mibBuilder.loadTexts:
...
mySPANMIBGroup.setObjects(
      *(("MY-SPAN-MIB", "mySPANSession"),
        ("MY-SPAN-MIB", "mySPANIfIndex"),
        ("MY-SPAN-MIB", "mySPANIfRole"),
        ("MY-SPAN-MIB", "mySPANEntryStatus"))
)
if mibBuilder.loadTexts:
