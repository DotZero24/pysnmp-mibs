# SNMP MIB module (A3COM-HUAWEI-MLSR-SYSTEM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-MLSR-SYSTEM-MIB
...
trap = _Trap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 2)
)
_Log_ObjectIdentity = ObjectIdentity
log = _Log_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3)
)
...
logcontroller = _Logcontroller_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 1),
    _Logcontroller_Type()
)
...
loghostIndex = _LoghostIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 2, 1, 1),
    _LoghostIndex_Type()
)
...
loghostaddress = _Loghostaddress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 2, 1, 2),
...
loghostport = _Loghostport_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 2, 1, 3),
    _Loghostport_Type()
)
...
loghostseverity = _Loghostseverity_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 2, 1, 4),
...
loghostlanguage = _Loghostlanguage_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 2, 1, 5),
...
loghostfacility = _Loghostfacility_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 2, 1, 6),
...
loghostaccess = _Loghostaccess_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 2, 1, 7),
    _Loghostaccess_Type()
)
...
loghoststatus = _Loghoststatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 2, 1, 8),
    _Loghoststatus_Type()
)
...
logfilterTable = _LogfilterTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 3)
)
if mibBuilder.loadTexts:
    logfilterTable.setStatus("mandatory")
_LogfilterEntry_Object = MibTableRow
logfilterEntry = _LogfilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 3, 1)
)
logfilterEntry.setIndexNames(
    (0, "A3COM-HUAWEI-MLSR-SYSTEM-MIB", "logfilterIndex"),
    (0, "A3COM-HUAWEI-MLSR-SYSTEM-MIB", "logdevfacility"),
)
if mibBuilder.loadTexts:
...
logfilterIndex = _LogfilterIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 3, 1, 1),
...
logdevfacility = _Logdevfacility_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 3, 1, 2),
...
logfilterstatus = _Logfilterstatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 1, 1, 3, 3, 1, 3),
...
moduleIndex = _ModuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 2, 1, 1, 1),
    _ModuleIndex_Type()
)
...
moduleSlotNum = _ModuleSlotNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 2, 1, 1, 2),
    _ModuleSlotNum_Type()
)
...
moduleType = _ModuleType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 2, 1, 1, 3),
    _ModuleType_Type()
)
...
moduleFirstPort = _ModuleFirstPort_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 2, 1, 1, 4),
...
moduleNumberOfPorts = _ModuleNumberOfPorts_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 2, 1, 1, 5),
...
moduleVersion = _ModuleVersion_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 2, 1, 1, 6),
    _ModuleVersion_Type()
)
...
moduleSwVersion = _ModuleSwVersion_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 2, 1, 1, 7),
...
moduleHwVersion = _ModuleHwVersion_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 2, 2, 1, 1, 8),
