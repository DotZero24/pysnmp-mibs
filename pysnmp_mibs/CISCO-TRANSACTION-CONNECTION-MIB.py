...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-TRANSACTION-CONNECTION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:27:20 2025
...
_CtcServerIPAddr_Type.__name__ = "IpAddress"
...
_CtcServerWindowSize_Type.__name__ = "Unsigned32"
...
_CtcServerProgNameUpperCase_Type.__name__ = "TruthValue"
...
ciscoTransConnMIBCompliance.setObjects(
      *(("CISCO-TRANSACTION-CONNECTION-MIB", "ciscoTransConnLicenseGroup"),
        ("CISCO-TRANSACTION-CONNECTION-MIB", "ciscoTransConnDestinationGroup"),
        ("CISCO-TRANSACTION-CONNECTION-MIB", "ciscoTransConnRouteGroup"),
        ("CISCO-TRANSACTION-CONNECTION-MIB", "ciscoTransConnServerGroup"),
        ("CISCO-TRANSACTION-CONNECTION-MIB", "ciscoTransConnConnectionGroup"),
        ("CISCO-TRANSACTION-CONNECTION-MIB", "ciscoTransConnTransactionGroup"))
)
if mibBuilder.loadTexts:
