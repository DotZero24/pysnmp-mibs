...
mibBuilder.exportSymbols("CISCO-TRANSACTION-CONNECTION-MIB", ctcConnectionId=ctcConnectionId, ctcRouteEntry=ctcRouteEntry, PYSNMP_MODULE_ID=ciscoTransactionConnectionMIB, ctcLicenseExpiration=ctcLicenseExpiration, ciscoTransactionConnectionMIB=ciscoTransactionConnectionMIB, ctcTransactionConnectionId=ctcTransactionConnectionId, ctcServerIPAddr=ctcServerIPAddr, ctcLicenseKey=ctcLicenseKey, ctcConnectionClientIPAddr=ctcConnectionClientIPAddr, ctcServerHostTimeout=ctcServerHostTimeout, ctcServerConnectionCount=ctcServerConnectionCount, ctcDestinationRemoteLUName=ctcDestinationRemoteLUName, ctcRouteOwningServer=ctcRouteOwningServer, ctcLicenseCurrConn=ctcLicenseCurrConn, ciscoTransConnMIBGroups=ciscoTransConnMIBGroups, ctcServerListening=ctcServerListening, ctcTransactionServer=ctcTransactionServer, ctcConnectionConnectTime=ctcConnectionConnectTime, ciscoTransConnMIBCompliances=ciscoTransConnMIBCompliances, ctcDestinationNumHits=ctcDestinationNumHits, ctcServerWindowSize=ctcServerWindowSize, ctcTransactionState=ctcTransactionState, ctcLicenseMaxConn=ctcLicenseMaxConn, ciscoTransConnConnectionGroup=ciscoTransConnConnectionGroup, ctcConnectionClientPort=ctcConnectionClientPort, ctcTransactionTable=ctcTransactionTable, ctcDestinationName=ctcDestinationName, ctcServerTable=ctcServerTable, ctcServerName=ctcServerName, ctcRouteTable=ctcRouteTable, ctcConnectionTotalBytesRecvd=ctcConnectionTotalBytesRecvd, ctcTransactionUserId=ctcTransactionUserId, ctcDestinationEntry=ctcDestinationEntry, ciscoTransConnTransactionGroup=ciscoTransConnTransactionGroup, ctcTransactionTPName=ctcTransactionTPName, ctcTransactionEntry=ctcTransactionEntry, ctcServerEntry=ctcServerEntry, ctcRouteDestinationName=ctcRouteDestinationName, ctcConnectionEntry=ctcConnectionEntry, ctcConnectionSessionCount=ctcConnectionSessionCount, ctcServerPort=ctcServerPort, ctcServerClientTimeout=ctcServerClientTimeout, ctcRouteTransactionID=ctcRouteTransactionID, ciscoTransConnMIBConformance=ciscoTransConnMIBConformance, ciscoTransConnRouteGroup=ciscoTransConnRouteGroup, ctcConnectionIdleTime=ctcConnectionIdleTime, ctcLicenseState=ctcLicenseState, ctcServerProgNameUpperCase=ctcServerProgNameUpperCase, ctcTransactionSessionId=ctcTransactionSessionId, ctcConnectionTotalConversations=ctcConnectionTotalConversations, ctcConnectionState=ctcConnectionState, ctcServerDestinationName=ctcServerDestinationName, ctcConnectionTable=ctcConnectionTable, ciscoTransConnServerGroup=ciscoTransConnServerGroup, ciscoTransConnMIBCompliance=ciscoTransConnMIBCompliance, ctcServerIndex=ctcServerIndex, ctcDestinationTable=ctcDestinationTable, ciscoTransConnDestinationGroup=ciscoTransConnDestinationGroup, ciscoTransConnMIBObjects=ciscoTransConnMIBObjects, ctcLicense=ctcLicense, ciscoTransConnLicenseGroup=ciscoTransConnLicenseGroup, ctcDestinationModeName=ctcDestinationModeName, ctcConnectionServer=ctcConnectionServer)
