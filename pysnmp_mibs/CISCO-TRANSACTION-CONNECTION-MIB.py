...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-TRANSACTION-CONNECTION-MIB
...
mibBuilder.exportSymbols("CISCO-TRANSACTION-CONNECTION-MIB", ctcTransactionState=ctcTransactionState, ctcDestinationRemoteLUName=ctcDestinationRemoteLUName, ctcRouteEntry=ctcRouteEntry, ctcServerName=ctcServerName, ctcTransactionUserId=ctcTransactionUserId, ctcTransactionServer=ctcTransactionServer, ctcLicenseExpiration=ctcLicenseExpiration, ctcLicenseState=ctcLicenseState, ctcServerPort=ctcServerPort, ctcConnectionTotalConversations=ctcConnectionTotalConversations, ctcRouteTransactionID=ctcRouteTransactionID, ciscoTransConnTransactionGroup=ciscoTransConnTransactionGroup, ctcServerDestinationName=ctcServerDestinationName, ctcServerTable=ctcServerTable, ctcLicenseMaxConn=ctcLicenseMaxConn, ctcTransactionTable=ctcTransactionTable, ciscoTransConnLicenseGroup=ciscoTransConnLicenseGroup, ctcServerIPAddr=ctcServerIPAddr, ciscoTransConnRouteGroup=ciscoTransConnRouteGroup, ctcConnectionEntry=ctcConnectionEntry, ctcConnectionIdleTime=ctcConnectionIdleTime, ctcConnectionClientPort=ctcConnectionClientPort, ctcRouteTable=ctcRouteTable, ciscoTransConnServerGroup=ciscoTransConnServerGroup, ctcRouteOwningServer=ctcRouteOwningServer, ctcConnectionTable=ctcConnectionTable, ctcConnectionConnectTime=ctcConnectionConnectTime, ctcServerClientTimeout=ctcServerClientTimeout, ciscoTransactionConnectionMIB=ciscoTransactionConnectionMIB, ctcConnectionClientIPAddr=ctcConnectionClientIPAddr, ctcServerHostTimeout=ctcServerHostTimeout, ctcServerEntry=ctcServerEntry, ctcServerListening=ctcServerListening, ctcServerIndex=ctcServerIndex, ctcRouteDestinationName=ctcRouteDestinationName, ctcLicense=ctcLicense, ctcConnectionSessionCount=ctcConnectionSessionCount, ciscoTransConnMIBCompliances=ciscoTransConnMIBCompliances, ciscoTransConnMIBCompliance=ciscoTransConnMIBCompliance, ctcConnectionTotalBytesRecvd=ctcConnectionTotalBytesRecvd, ctcConnectionState=ctcConnectionState, ciscoTransConnMIBGroups=ciscoTransConnMIBGroups, ctcServerProgNameUpperCase=ctcServerProgNameUpperCase, ctcDestinationEntry=ctcDestinationEntry, ciscoTransConnMIBConformance=ciscoTransConnMIBConformance, ctcLicenseKey=ctcLicenseKey, ctcTransactionEntry=ctcTransactionEntry, ctcServerConnectionCount=ctcServerConnectionCount, ctcDestinationModeName=ctcDestinationModeName, ctcTransactionTPName=ctcTransactionTPName, PYSNMP_MODULE_ID=ciscoTransactionConnectionMIB, ctcConnectionId=ctcConnectionId, ctcTransactionSessionId=ctcTransactionSessionId, ctcServerWindowSize=ctcServerWindowSize, ctcConnectionServer=ctcConnectionServer, ctcDestinationName=ctcDestinationName, ciscoTransConnMIBObjects=ciscoTransConnMIBObjects, ciscoTransConnDestinationGroup=ciscoTransConnDestinationGroup, ctcDestinationTable=ctcDestinationTable, ctcTransactionConnectionId=ctcTransactionConnectionId, ciscoTransConnConnectionGroup=ciscoTransConnConnectionGroup, ctcLicenseCurrConn=ctcLicenseCurrConn, ctcDestinationNumHits=ctcDestinationNumHits)
