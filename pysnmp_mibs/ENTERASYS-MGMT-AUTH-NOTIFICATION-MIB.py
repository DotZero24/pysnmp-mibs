...
# Notes
# -----
# ASN.1 source file://mibs/enterasys/ENTERASYS-MGMT-AUTH-NOTIFICATION-MIB
...
_EtsysMgmtAuthNotificationsSupported_Type.__name__ = "EtsysMgmtAuthNotificationTypes"
...
_EtsysMgmtAuthNotificationEnabledStatus_Type.__name__ = "EtsysMgmtAuthNotificationTypes"
...
etsysMgmtAuthCompliance.setObjects(
      *(("ENTERASYS-MGMT-AUTH-NOTIFICATION-MIB", "etsysMgmtAuthConfigGroup"),
        ("ENTERASYS-MGMT-AUTH-NOTIFICATION-MIB", "etsysMgmtAuthHistoryGroup"),
...
etsysMgmtAuthUserCompliance.setObjects(
    ("ENTERASYS-MGMT-AUTH-NOTIFICATION-MIB", "etsysMgmtAuthNotificationUserGroup")
)
if mibBuilder.loadTexts:
