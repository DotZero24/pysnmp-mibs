...
mibBuilder.exportSymbols("GUDEADS-ETS-MIB", etsSecPowAvail=etsSecPowAvail, etsTrapCtrl=etsTrapCtrl, etsBasicGroup=etsBasicGroup, etsPowerSelect=etsPowerSelect, etsTrapIPTable=etsTrapIPTable, etsNotificationGroup=etsNotificationGroup, etsTrapIPAddr=etsTrapIPAddr, etsGroups=etsGroups, etsSNMPaccess=etsSNMPaccess, etsSecManualSelect=etsSecManualSelect, gadsETS=gadsETS, etsTrapIPIndex=etsTrapIPIndex, etsPowerSelectEvt=etsPowerSelectEvt, etsConf=etsConf, etsTrapIPPort=etsTrapIPPort, etsManualSelectEvt=etsManualSelectEvt, etsCompls=etsCompls, etsObjects=etsObjects, etsPrimPowAvail=etsPrimPowAvail, gudeads=gudeads, etsPrimaryPowerChangeEvt=etsPrimaryPowerChangeEvt, etsTrapIPEntry=etsTrapIPEntry, etsEvents=etsEvents, PYSNMP_MODULE_ID=gudeads, etsSecondaryPowerChangeEvt=etsSecondaryPowerChangeEvt)
