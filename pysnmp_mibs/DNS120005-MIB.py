...
modelID=_ModelID_ObjectIdentity((1,3,6,1,4,1,171,50,1,1))
_SubmodelID_ObjectIdentity=ObjectIdentity
submodelID=_SubmodelID_ObjectIdentity((1,3,6,1,4,1,171,50,1,1,1))
_NasAgent1200_ObjectIdentity=ObjectIdentity
nasAgent1200=_NasAgent1200_ObjectIdentity((1,3,6,1,4,1,171,50,1,1,1,1))
_NasAgentVer_Type=DisplayString
_NasAgentVer_Object=MibScalar
nasAgentVer=_NasAgentVer_Object((1,3,6,1,4,1,171,50,1,1,1,1,1),_NasAgentVer_Type())
nasAgentVer.setMaxAccess(_B)
if mibBuilder.loadTexts:nasAgentVer.setStatus(_A)
_SysTable_Object=MibTable
sysTable=_SysTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,2))
if mibBuilder.loadTexts:sysTable.setStatus(_A)
_SysEntry_Object=MibTableRow
sysEntry=_SysEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1))
...
sysNum=_SysNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,1),_SysNum_Type())
...
sysName=_SysName_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,2),_SysName_Type())
...
sysFWVer=_SysFWVer_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,3),_SysFWVer_Type())
...
sysNetType=_SysNetType_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,4),_SysNetType_Type())
...
sysFanSpeed=_SysFanSpeed_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,5),_SysFanSpeed_Type())
...
sysTemperature=_SysTemperature_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,6),_SysTemperature_Type())
...
sysPrinterName=_SysPrinterName_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,7),_SysPrinterName_Type())
...
sysCIFS=_SysCIFS_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,8),_SysCIFS_Type())
...
sysFtpServer=_SysFtpServer_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,9),_SysFtpServer_Type())
...
sysNFSServer=_SysNFSServer_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,10),_SysNFSServer_Type())
...
sysDFSServer=_SysDFSServer_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,11),_SysDFSServer_Type())
...
sysQuota=_SysQuota_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,12),_SysQuota_Type())
...
sysAFP=_SysAFP_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,13),_SysAFP_Type())
...
sysWebDAV=_SysWebDAV_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,14),_SysWebDAV_Type())
...
sysWebFileServer=_SysWebFileServer_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,15),_SysWebFileServer_Type())
...
sysiSCSITarget=_SysiSCSITarget_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,16),_SysiSCSITarget_Type())
...
sysiSNS=_SysiSNS_Object((1,3,6,1,4,1,171,50,1,1,1,1,2,1,17),_SysiSNS_Type())
sysiSNS.setMaxAccess(_B)
if mibBuilder.loadTexts:sysiSNS.setStatus(_A)
_DiskTable_Object=MibTable
diskTable=_DiskTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,3))
if mibBuilder.loadTexts:diskTable.setStatus(_A)
_DiskEntry_Object=MibTableRow
diskEntry=_DiskEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,3,1))
...
diskNum=_DiskNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,3,1,1),_DiskNum_Type())
...
diskName=_DiskName_Object((1,3,6,1,4,1,171,50,1,1,1,1,3,1,2),_DiskName_Type())
...
diskModel=_DiskModel_Object((1,3,6,1,4,1,171,50,1,1,1,1,3,1,3),_DiskModel_Type())
...
diskTemperature=_DiskTemperature_Object((1,3,6,1,4,1,171,50,1,1,1,1,3,1,4),_DiskTemperature_Type())
...
diskCapacity=_DiskCapacity_Object((1,3,6,1,4,1,171,50,1,1,1,1,3,1,5),_DiskCapacity_Type())
...
diskStatus=_DiskStatus_Object((1,3,6,1,4,1,171,50,1,1,1,1,3,1,6),_DiskStatus_Type())
diskStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:diskStatus.setStatus(_A)
_VolumeTable_Object=MibTable
volumeTable=_VolumeTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,4))
if mibBuilder.loadTexts:volumeTable.setStatus(_A)
_VolumeEntry_Object=MibTableRow
volumeEntry=_VolumeEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,4,1))
...
volumeNum=_VolumeNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,4,1,1),_VolumeNum_Type())
...
volumeName=_VolumeName_Object((1,3,6,1,4,1,171,50,1,1,1,1,4,1,2),_VolumeName_Type())
...
volumeEncryption=_VolumeEncryption_Object((1,3,6,1,4,1,171,50,1,1,1,1,4,1,3),_VolumeEncryption_Type())
...
volumeFsType=_VolumeFsType_Object((1,3,6,1,4,1,171,50,1,1,1,1,4,1,4),_VolumeFsType_Type())
...
volumeRaidLevel=_VolumeRaidLevel_Object((1,3,6,1,4,1,171,50,1,1,1,1,4,1,5),_VolumeRaidLevel_Type())
...
volumeSize=_VolumeSize_Object((1,3,6,1,4,1,171,50,1,1,1,1,4,1,6),_VolumeSize_Type())
...
volumeFreeSpace=_VolumeFreeSpace_Object((1,3,6,1,4,1,171,50,1,1,1,1,4,1,7),_VolumeFreeSpace_Type())
...
volumeState=_VolumeState_Object((1,3,6,1,4,1,171,50,1,1,1,1,4,1,8),_VolumeState_Type())
volumeState.setMaxAccess(_B)
if mibBuilder.loadTexts:volumeState.setStatus(_A)
_SnapShotTable_Object=MibTable
snapShotTable=_SnapShotTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,5))
if mibBuilder.loadTexts:snapShotTable.setStatus(_A)
_SnapShotEntry_Object=MibTableRow
snapShotEntry=_SnapShotEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,5,1))
...
snapShotNum=_SnapShotNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,5,1,1),_SnapShotNum_Type())
...
snapShotVolume=_SnapShotVolume_Object((1,3,6,1,4,1,171,50,1,1,1,1,5,1,2),_SnapShotVolume_Type())
...
snapShotName=_SnapShotName_Object((1,3,6,1,4,1,171,50,1,1,1,1,5,1,3),_SnapShotName_Type())
...
snapShotSchedule=_SnapShotSchedule_Object((1,3,6,1,4,1,171,50,1,1,1,1,5,1,4),_SnapShotSchedule_Type())
...
snapShotCount=_SnapShotCount_Object((1,3,6,1,4,1,171,50,1,1,1,1,5,1,5),_SnapShotCount_Type())
...
snapShotState=_SnapShotState_Object((1,3,6,1,4,1,171,50,1,1,1,1,5,1,6),_SnapShotState_Type())
...
snapShotPath=_SnapShotPath_Object((1,3,6,1,4,1,171,50,1,1,1,1,5,1,7),_SnapShotPath_Type())
snapShotPath.setMaxAccess(_B)
if mibBuilder.loadTexts:snapShotPath.setStatus(_A)
_DFSTable_Object=MibTable
dFSTable=_DFSTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,6))
if mibBuilder.loadTexts:dFSTable.setStatus(_A)
_DFSEntry_Object=MibTableRow
dFSEntry=_DFSEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,6,1))
...
dFSNum=_DFSNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,6,1,1),_DFSNum_Type())
...
dFSLShareName=_DFSLShareName_Object((1,3,6,1,4,1,171,50,1,1,1,1,6,1,2),_DFSLShareName_Type())
...
dFSHost=_DFSHost_Object((1,3,6,1,4,1,171,50,1,1,1,1,6,1,3),_DFSHost_Type())
...
dFSRSharefolder=_DFSRSharefolder_Object((1,3,6,1,4,1,171,50,1,1,1,1,6,1,4),_DFSRSharefolder_Type())
dFSRSharefolder.setMaxAccess(_B)
if mibBuilder.loadTexts:dFSRSharefolder.setStatus(_A)
_NFSTable_Object=MibTable
nFSTable=_NFSTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,7))
if mibBuilder.loadTexts:nFSTable.setStatus(_A)
_NFSEntry_Object=MibTableRow
nFSEntry=_NFSEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,7,1))
...
nFSNum=_NFSNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,7,1,1),_NFSNum_Type())
...
nFSMountPath=_NFSMountPath_Object((1,3,6,1,4,1,171,50,1,1,1,1,7,1,2),_NFSMountPath_Type())
...
nFSHost=_NFSHost_Object((1,3,6,1,4,1,171,50,1,1,1,1,7,1,3),_NFSHost_Type())
...
nFSPermission=_NFSPermission_Object((1,3,6,1,4,1,171,50,1,1,1,1,7,1,4),_NFSPermission_Type())
...
nFSRootSquash=_NFSRootSquash_Object((1,3,6,1,4,1,171,50,1,1,1,1,7,1,5),_NFSRootSquash_Type())
...
nFSStatus=_NFSStatus_Object((1,3,6,1,4,1,171,50,1,1,1,1,7,1,6),_NFSStatus_Type())
nFSStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:nFSStatus.setStatus(_A)
_ISOTable_Object=MibTable
iSOTable=_ISOTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,8))
if mibBuilder.loadTexts:iSOTable.setStatus(_A)
_ISOEntry_Object=MibTableRow
iSOEntry=_ISOEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,8,1))
...
iSONum=_ISONum_Object((1,3,6,1,4,1,171,50,1,1,1,1,8,1,1),_ISONum_Type())
...
iSOShareName=_ISOShareName_Object((1,3,6,1,4,1,171,50,1,1,1,1,8,1,2),_ISOShareName_Type())
...
iSOPath=_ISOPath_Object((1,3,6,1,4,1,171,50,1,1,1,1,8,1,3),_ISOPath_Type())
...
iSOStatus=_ISOStatus_Object((1,3,6,1,4,1,171,50,1,1,1,1,8,1,4),_ISOStatus_Type())
iSOStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:iSOStatus.setStatus(_A)
_LogServerTable_Object=MibTable
logServerTable=_LogServerTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,9))
if mibBuilder.loadTexts:logServerTable.setStatus(_A)
_LogServerEntry_Object=MibTableRow
logServerEntry=_LogServerEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,9,1))
...
logServerNum=_LogServerNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,9,1,1),_LogServerNum_Type())
...
logServerRuleName=_LogServerRuleName_Object((1,3,6,1,4,1,171,50,1,1,1,1,9,1,2),_LogServerRuleName_Type())
...
logServerLogfiles=_LogServerLogfiles_Object((1,3,6,1,4,1,171,50,1,1,1,1,9,1,3),_LogServerLogfiles_Type())
...
logServerStatus=_LogServerStatus_Object((1,3,6,1,4,1,171,50,1,1,1,1,9,1,4),_LogServerStatus_Type())
logServerStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:logServerStatus.setStatus(_A)
_UPSTable_Object=MibTable
uPSTable=_UPSTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,10))
if mibBuilder.loadTexts:uPSTable.setStatus(_A)
_UPSEntry_Object=MibTableRow
uPSEntry=_UPSEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,10,1))
...
uPSNum=_UPSNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,10,1,1),_UPSNum_Type())
...
uPSDeviceInfo=_UPSDeviceInfo_Object((1,3,6,1,4,1,171,50,1,1,1,1,10,1,2),_UPSDeviceInfo_Type())
...
uPSProduct=_UPSProduct_Object((1,3,6,1,4,1,171,50,1,1,1,1,10,1,3),_UPSProduct_Type())
...
uPSManufacturer=_UPSManufacturer_Object((1,3,6,1,4,1,171,50,1,1,1,1,10,1,4),_UPSManufacturer_Type())
...
uPSBattery=_UPSBattery_Object((1,3,6,1,4,1,171,50,1,1,1,1,10,1,5),_UPSBattery_Type())
...
uPSState=_UPSState_Object((1,3,6,1,4,1,171,50,1,1,1,1,10,1,6),_UPSState_Type())
...
uPSServerIP=_UPSServerIP_Object((1,3,6,1,4,1,171,50,1,1,1,1,10,1,7),_UPSServerIP_Type())
...
uPSAllowedIP=_UPSAllowedIP_Object((1,3,6,1,4,1,171,50,1,1,1,1,10,1,8),_UPSAllowedIP_Type())
uPSAllowedIP.setMaxAccess(_B)
if mibBuilder.loadTexts:uPSAllowedIP.setStatus(_A)
_VVTable_Object=MibTable
vVTable=_VVTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,11))
if mibBuilder.loadTexts:vVTable.setStatus(_A)
_VVEntry_Object=MibTableRow
vVEntry=_VVEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,11,1))
...
vVNum=_VVNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,11,1,1),_VVNum_Type())
...
vVTargetName=_VVTargetName_Object((1,3,6,1,4,1,171,50,1,1,1,1,11,1,2),_VVTargetName_Type())
...
vVSharefolder=_VVSharefolder_Object((1,3,6,1,4,1,171,50,1,1,1,1,11,1,3),_VVSharefolder_Type())
...
vVStatus=_VVStatus_Object((1,3,6,1,4,1,171,50,1,1,1,1,11,1,4),_VVStatus_Type())
...
vVSize=_VVSize_Object((1,3,6,1,4,1,171,50,1,1,1,1,11,1,5),_VVSize_Type())
vVSize.setMaxAccess(_B)
if mibBuilder.loadTexts:vVSize.setStatus(_A)
_ISCSITargetTable_Object=MibTable
iSCSITargetTable=_ISCSITargetTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,12))
if mibBuilder.loadTexts:iSCSITargetTable.setStatus(_A)
_ISCSITargetEntry_Object=MibTableRow
iSCSITargetEntry=_ISCSITargetEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,12,1))
...
iSCSITargetNum=_ISCSITargetNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,12,1,1),_ISCSITargetNum_Type())
...
iSCSITargetIQN=_ISCSITargetIQN_Object((1,3,6,1,4,1,171,50,1,1,1,1,12,1,2),_ISCSITargetIQN_Type())
...
iSCSITargetStatus=_ISCSITargetStatus_Object((1,3,6,1,4,1,171,50,1,1,1,1,12,1,3),_ISCSITargetStatus_Type())
iSCSITargetStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:iSCSITargetStatus.setStatus(_A)
_ISCSILUNTable_Object=MibTable
iSCSILUNTable=_ISCSILUNTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,13))
if mibBuilder.loadTexts:iSCSILUNTable.setStatus(_A)
_ISCSILUNEntry_Object=MibTableRow
iSCSILUNEntry=_ISCSILUNEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,13,1))
...
iSCSILUNNum=_ISCSILUNNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,13,1,1),_ISCSILUNNum_Type())
...
iSCSILUNName=_ISCSILUNName_Object((1,3,6,1,4,1,171,50,1,1,1,1,13,1,2),_ISCSILUNName_Type())
...
iSCSILUNVolume=_ISCSILUNVolume_Object((1,3,6,1,4,1,171,50,1,1,1,1,13,1,3),_ISCSILUNVolume_Type())
...
iSCSILUNSize=_ISCSILUNSize_Object((1,3,6,1,4,1,171,50,1,1,1,1,13,1,4),_ISCSILUNSize_Type())
...
iSCSILUNStatus=_ISCSILUNStatus_Object((1,3,6,1,4,1,171,50,1,1,1,1,13,1,5),_ISCSILUNStatus_Type())
...
iSCSILUNMapping=_ISCSILUNMapping_Object((1,3,6,1,4,1,171,50,1,1,1,1,13,1,6),_ISCSILUNMapping_Type())
iSCSILUNMapping.setMaxAccess(_B)
if mibBuilder.loadTexts:iSCSILUNMapping.setStatus(_A)
_ISCSIACLTable_Object=MibTable
iSCSIACLTable=_ISCSIACLTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,14))
if mibBuilder.loadTexts:iSCSIACLTable.setStatus(_A)
_ISCSIACLEntry_Object=MibTableRow
iSCSIACLEntry=_ISCSIACLEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,14,1))
...
iSCSIACLNum=_ISCSIACLNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,14,1,1),_ISCSIACLNum_Type())
...
iSCSIACLName=_ISCSIACLName_Object((1,3,6,1,4,1,171,50,1,1,1,1,14,1,2),_ISCSIACLName_Type())
...
iSCSIACLInitiator=_ISCSIACLInitiator_Object((1,3,6,1,4,1,171,50,1,1,1,1,14,1,3),_ISCSIACLInitiator_Type())
iSCSIACLInitiator.setMaxAccess(_B)
if mibBuilder.loadTexts:iSCSIACLInitiator.setStatus(_A)
_AMAZONS3Table_Object=MibTable
aMAZONS3Table=_AMAZONS3Table_Object((1,3,6,1,4,1,171,50,1,1,1,1,15))
if mibBuilder.loadTexts:aMAZONS3Table.setStatus(_A)
_AMAZONS3Entry_Object=MibTableRow
aMAZONS3Entry=_AMAZONS3Entry_Object((1,3,6,1,4,1,171,50,1,1,1,1,15,1))
...
aMAZONS3Num=_AMAZONS3Num_Object((1,3,6,1,4,1,171,50,1,1,1,1,15,1,1),_AMAZONS3Num_Type())
...
aMAZONS3Task=_AMAZONS3Task_Object((1,3,6,1,4,1,171,50,1,1,1,1,15,1,2),_AMAZONS3Task_Type())
...
aMAZONS3Schedule=_AMAZONS3Schedule_Object((1,3,6,1,4,1,171,50,1,1,1,1,15,1,3),_AMAZONS3Schedule_Type())
...
aMAZONS3Status=_AMAZONS3Status_Object((1,3,6,1,4,1,171,50,1,1,1,1,15,1,4),_AMAZONS3Status_Type())
...
aMAZONS3Enable=_AMAZONS3Enable_Object((1,3,6,1,4,1,171,50,1,1,1,1,15,1,5),_AMAZONS3Enable_Type())
...
aMAZONS3BackupNow=_AMAZONS3BackupNow_Object((1,3,6,1,4,1,171,50,1,1,1,1,15,1,6),_AMAZONS3BackupNow_Type())
...
aMAZONS3Restore=_AMAZONS3Restore_Object((1,3,6,1,4,1,171,50,1,1,1,1,15,1,7),_AMAZONS3Restore_Type())
aMAZONS3Restore.setMaxAccess(_B)
if mibBuilder.loadTexts:aMAZONS3Restore.setStatus(_A)
_ConnectionTable_Object=MibTable
connectionTable=_ConnectionTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,16))
if mibBuilder.loadTexts:connectionTable.setStatus(_A)
_ConnectionEntry_Object=MibTableRow
connectionEntry=_ConnectionEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,16,1))
connectionEntry.setIndexNames((0,_C,_Q))
if mibBuilder.loadTexts:connectionEntry.setStatus(_A)
_ConnectionNum_Type=Integer32
_ConnectionNum_Object=MibTableColumn
connectionNum=_ConnectionNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,16,1,1),_ConnectionNum_Type())
connectionNum.setMaxAccess(_B)
if mibBuilder.loadTexts:connectionNum.setStatus(_A)
_ConnectionDateTime_Type=DisplayString
_ConnectionDateTime_Object=MibTableColumn
connectionDateTime=_ConnectionDateTime_Object((1,3,6,1,4,1,171,50,1,1,1,1,16,1,2),_ConnectionDateTime_Type())
connectionDateTime.setMaxAccess(_B)
if mibBuilder.loadTexts:connectionDateTime.setStatus(_A)
_ConnectionServiceType_Type=DisplayString
_ConnectionServiceType_Object=MibTableColumn
connectionServiceType=_ConnectionServiceType_Object((1,3,6,1,4,1,171,50,1,1,1,1,16,1,3),_ConnectionServiceType_Type())
connectionServiceType.setMaxAccess(_B)
if mibBuilder.loadTexts:connectionServiceType.setStatus(_A)
_ConnectionIPAddress_Type=DisplayString
_ConnectionIPAddress_Object=MibTableColumn
connectionIPAddress=_ConnectionIPAddress_Object((1,3,6,1,4,1,171,50,1,1,1,1,16,1,4),_ConnectionIPAddress_Type())
connectionIPAddress.setMaxAccess(_B)
if mibBuilder.loadTexts:connectionIPAddress.setStatus(_A)
_ConnectionUser_Type=DisplayString
_ConnectionUser_Object=MibTableColumn
connectionUser=_ConnectionUser_Object((1,3,6,1,4,1,171,50,1,1,1,1,16,1,5),_ConnectionUser_Type())
connectionUser.setMaxAccess(_B)
if mibBuilder.loadTexts:connectionUser.setStatus(_A)
_ConnectionComputerName_Type=DisplayString
_ConnectionComputerName_Object=MibTableColumn
connectionComputerName=_ConnectionComputerName_Object((1,3,6,1,4,1,171,50,1,1,1,1,16,1,6),_ConnectionComputerName_Type())
connectionComputerName.setMaxAccess(_B)
if mibBuilder.loadTexts:connectionComputerName.setStatus(_A)
_ConnectionUsedResources_Type=DisplayString
_ConnectionUsedResources_Object=MibTableColumn
connectionUsedResources=_ConnectionUsedResources_Object((1,3,6,1,4,1,171,50,1,1,1,1,16,1,7),_ConnectionUsedResources_Type())
connectionUsedResources.setMaxAccess(_B)
if mibBuilder.loadTexts:connectionUsedResources.setStatus(_A)
_PortForwardingTable_Object=MibTable
portForwardingTable=_PortForwardingTable_Object((1,3,6,1,4,1,171,50,1,1,1,1,17))
if mibBuilder.loadTexts:portForwardingTable.setStatus(_A)
_PortForwardingEntry_Object=MibTableRow
portForwardingEntry=_PortForwardingEntry_Object((1,3,6,1,4,1,171,50,1,1,1,1,17,1))
portForwardingEntry.setIndexNames((0,_C,_R))
...
portForwardingNum=_PortForwardingNum_Object((1,3,6,1,4,1,171,50,1,1,1,1,17,1,1),_PortForwardingNum_Type())
portForwardingNum.setMaxAccess(_B)
if mibBuilder.loadTexts:portForwardingNum.setStatus(_A)
_PortForwardingEnable_Type=DisplayString
_PortForwardingEnable_Object=MibTableColumn
portForwardingEnable=_PortForwardingEnable_Object((1,3,6,1,4,1,171,50,1,1,1,1,17,1,2),_PortForwardingEnable_Type())
portForwardingEnable.setMaxAccess(_B)
if mibBuilder.loadTexts:portForwardingEnable.setStatus(_A)
_PortForwardingStatus_Type=DisplayString
_PortForwardingStatus_Object=MibTableColumn
portForwardingStatus=_PortForwardingStatus_Object((1,3,6,1,4,1,171,50,1,1,1,1,17,1,3),_PortForwardingStatus_Type())
portForwardingStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:portForwardingStatus.setStatus(_A)
_PortForwardingService_Type=DisplayString
_PortForwardingService_Object=MibTableColumn
portForwardingService=_PortForwardingService_Object((1,3,6,1,4,1,171,50,1,1,1,1,17,1,4),_PortForwardingService_Type())
portForwardingService.setMaxAccess(_B)
if mibBuilder.loadTexts:portForwardingService.setStatus(_A)
_PortForwardingProtocol_Type=DisplayString
_PortForwardingProtocol_Object=MibTableColumn
portForwardingProtocol=_PortForwardingProtocol_Object((1,3,6,1,4,1,171,50,1,1,1,1,17,1,5),_PortForwardingProtocol_Type())
portForwardingProtocol.setMaxAccess(_B)
if mibBuilder.loadTexts:portForwardingProtocol.setStatus(_A)
_PortForwardingExternalPort_Type=DisplayString
_PortForwardingExternalPort_Object=MibTableColumn
portForwardingExternalPort=_PortForwardingExternalPort_Object((1,3,6,1,4,1,171,50,1,1,1,1,17,1,6),_PortForwardingExternalPort_Type())
portForwardingExternalPort.setMaxAccess(_B)
if mibBuilder.loadTexts:portForwardingExternalPort.setStatus(_A)
_PortForwardingInternalPort_Type=DisplayString
_PortForwardingInternalPort_Object=MibTableColumn
portForwardingInternalPort=_PortForwardingInternalPort_Object((1,3,6,1,4,1,171,50,1,1,1,1,17,1,7),_PortForwardingInternalPort_Type())
portForwardingInternalPort.setMaxAccess(_B)
if mibBuilder.loadTexts:portForwardingInternalPort.setStatus(_A)
_NotifyEvts_ObjectIdentity=ObjectIdentity
notifyEvts=_NotifyEvts_ObjectIdentity((1,3,6,1,4,1,171,50,1,1,1,1,200))
