...
# Notes
# -----
# ASN.1 source file://mibs/rfc/MTA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:21:46 2025
...
mtaCompliance.setObjects(
    ("MTA-MIB", "mtaRFC1566Group")
)
if mibBuilder.loadTexts:
...
mtaAssocCompliance.setObjects(
      *(("MTA-MIB", "mtaRFC1566Group"),
        ("MTA-MIB", "mtaRFC1566AssocGroup"))
)
if mibBuilder.loadTexts:
...
mtaRFC2249Compliance.setObjects(
    ("MTA-MIB", "mtaRFC2249Group")
)
if mibBuilder.loadTexts:
...
mtaRFC2249AssocCompliance.setObjects(
      *(("MTA-MIB", "mtaRFC2249Group"),
        ("MTA-MIB", "mtaRFC2249AssocGroup"))
)
if mibBuilder.loadTexts:
...
mtaRFC2249ErrorCompliance.setObjects(
      *(("MTA-MIB", "mtaRFC2249Group"),
        ("MTA-MIB", "mtaRFC2249ErrorGroup"))
)
if mibBuilder.loadTexts:
...
mtaRFC2249FullCompliance.setObjects(
      *(("MTA-MIB", "mtaRFC2249Group"),
        ("MTA-MIB", "mtaRFC2249AssocGroup"),
        ("MTA-MIB", "mtaRFC2249ErrorGroup"))
)
...
mtaRFC2789Compliance.setObjects(
    ("MTA-MIB", "mtaRFC2789Group")
)
if mibBuilder.loadTexts:
...
mtaRFC2789AssocCompliance.setObjects(
      *(("MTA-MIB", "mtaRFC2789Group"),
        ("MTA-MIB", "mtaRFC2789AssocGroup"))
)
if mibBuilder.loadTexts:
...
mtaRFC2789ErrorCompliance.setObjects(
      *(("MTA-MIB", "mtaRFC2789Group"),
        ("MTA-MIB", "mtaRFC2789ErrorGroup"))
)
if mibBuilder.loadTexts:
...
mtaRFC2789FullCompliance.setObjects(
      *(("MTA-MIB", "mtaRFC2789Group"),
        ("MTA-MIB", "mtaRFC2789AssocGroup"),
        ("MTA-MIB", "mtaRFC2789ErrorGroup"))
)
