...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FIREPOWER-IP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:22:39 2025
...
cfprIpIpV4StaticTargetAddrTable = _CfprIpIpV4StaticTargetAddrTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 826, 1, 40, 5)
)
if mibBuilder.loadTexts:
    cfprIpIpV4StaticTargetAddrTable.setStatus("current")
_CfprIpIpV4StaticTargetAddrEntry_Object = MibTableRow
cfprIpIpV4StaticTargetAddrEntry = _CfprIpIpV4StaticTargetAddrEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 826, 1, 40, 5, 1)
)
cfprIpIpV4StaticTargetAddrEntry.setIndexNames(
    (0, "CISCO-FIREPOWER-IP-MIB", "cfprIpIpV4StaticTargetAddrInstanceId"),
)
if mibBuilder.loadTexts:
    cfprIpIpV4StaticTargetAddrEntry.setStatus("current")
...
cfprIpIpV4StaticTargetAddrInstanceId = _CfprIpIpV4StaticTargetAddrInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 826, 1, 40, 5, 1, 1),
    _CfprIpIpV4StaticTargetAddrInstanceId_Type()
)
cfprIpIpV4StaticTargetAddrInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cfprIpIpV4StaticTargetAddrInstanceId.setStatus("current")
_CfprIpIpV4StaticTargetAddrDn_Type = CfprManagedObjectDn
_CfprIpIpV4StaticTargetAddrDn_Object = MibTableColumn
cfprIpIpV4StaticTargetAddrDn = _CfprIpIpV4StaticTargetAddrDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 826, 1, 40, 5, 1, 2),
    _CfprIpIpV4StaticTargetAddrDn_Type()
)
cfprIpIpV4StaticTargetAddrDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cfprIpIpV4StaticTargetAddrDn.setStatus("current")
_CfprIpIpV4StaticTargetAddrRn_Type = SnmpAdminString
_CfprIpIpV4StaticTargetAddrRn_Object = MibTableColumn
cfprIpIpV4StaticTargetAddrRn = _CfprIpIpV4StaticTargetAddrRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 826, 1, 40, 5, 1, 3),
    _CfprIpIpV4StaticTargetAddrRn_Type()
)
cfprIpIpV4StaticTargetAddrRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cfprIpIpV4StaticTargetAddrRn.setStatus("current")
_CfprIpIpV4StaticTargetAddrAddr_Type = InetAddressIPv4
_CfprIpIpV4StaticTargetAddrAddr_Object = MibTableColumn
cfprIpIpV4StaticTargetAddrAddr = _CfprIpIpV4StaticTargetAddrAddr_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 826, 1, 40, 5, 1, 4),
    _CfprIpIpV4StaticTargetAddrAddr_Type()
)
cfprIpIpV4StaticTargetAddrAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cfprIpIpV4StaticTargetAddrAddr.setStatus("current")
_CfprIpIpV4StaticTargetAddrDefGw_Type = InetAddressIPv4
_CfprIpIpV4StaticTargetAddrDefGw_Object = MibTableColumn
cfprIpIpV4StaticTargetAddrDefGw = _CfprIpIpV4StaticTargetAddrDefGw_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 826, 1, 40, 5, 1, 5),
    _CfprIpIpV4StaticTargetAddrDefGw_Type()
)
cfprIpIpV4StaticTargetAddrDefGw.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cfprIpIpV4StaticTargetAddrDefGw.setStatus("current")
_CfprIpIpV4StaticTargetAddrSubnet_Type = InetAddressIPv4
_CfprIpIpV4StaticTargetAddrSubnet_Object = MibTableColumn
cfprIpIpV4StaticTargetAddrSubnet = _CfprIpIpV4StaticTargetAddrSubnet_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 826, 1, 40, 5, 1, 6),
    _CfprIpIpV4StaticTargetAddrSubnet_Type()
)
cfprIpIpV4StaticTargetAddrSubnet.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cfprIpIpV4StaticTargetAddrSubnet.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cfprIpObjects": cfprIpObjects,
       ...
       "cfprIpIpV4StaticTargetAddrTable": cfprIpIpV4StaticTargetAddrTable,
       "cfprIpIpV4StaticTargetAddrEntry": cfprIpIpV4StaticTargetAddrEntry,
       "cfprIpIpV4StaticTargetAddrInstanceId": cfprIpIpV4StaticTargetAddrInstanceId,
       "cfprIpIpV4StaticTargetAddrDn": cfprIpIpV4StaticTargetAddrDn,
       "cfprIpIpV4StaticTargetAddrRn": cfprIpIpV4StaticTargetAddrRn,
       "cfprIpIpV4StaticTargetAddrAddr": cfprIpIpV4StaticTargetAddrAddr,
       "cfprIpIpV4StaticTargetAddrDefGw": cfprIpIpV4StaticTargetAddrDefGw,
       "cfprIpIpV4StaticTargetAddrSubnet": cfprIpIpV4StaticTargetAddrSubnet,
