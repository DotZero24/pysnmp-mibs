...
mibBuilder.exportSymbols("Wellfleet-HARDWARE-MIB", wfHwEntry=wfHwEntry, wfHwBabyBdIdOpt=wfHwBabyBdIdOpt, wfHwModDaughterBd1SerialNumber=wfHwModDaughterBd1SerialNumber, wfHwBootPromRev=wfHwBootPromRev, wfHwDiagPromSource=wfHwDiagPromSource, wfFanStatus1=wfFanStatus1, wfBCNTemperature=wfBCNTemperature, wfHwModDaughterBd1AwRev=wfHwModDaughterBd1AwRev, wfRASNRPSUPresent=wfRASNRPSUPresent, wfHwMotherBdIdOpt=wfHwMotherBdIdOpt, wfHwDaughterBdRev=wfHwDaughterBdRev, wfHwDiagPromDate=wfHwDiagPromDate, wfHwActiveImageDate=wfHwActiveImageDate, wfHwModDaughterBd2Rev=wfHwModDaughterBd2Rev, wfHwCfgSlot=wfHwCfgSlot, wfHwBpRev=wfHwBpRev, wfHwCfgEntry=wfHwCfgEntry, wfRPSUPresent=wfRPSUPresent, wfHwModSerialNumber=wfHwModSerialNumber, wfHwBase=wfHwBase, wfHwDaughterBdSerialNumber=wfHwDaughterBdSerialNumber, wfHwModDaughterBd2AwRev=wfHwModDaughterBd2AwRev, wfHwSparePromSource=wfHwSparePromSource, wfHwBpIdOpt=wfHwBpIdOpt, wfHwFastPacketCacheSize=wfHwFastPacketCacheSize, wfHwMotherBdSerialNumber=wfHwMotherBdSerialNumber, wfHwSparePromRev=wfHwSparePromRev, wfHwConfigDateAndTime=wfHwConfigDateAndTime, wfHwSlot=wfHwSlot, wfBCNFanStatus=wfBCNFanStatus, wfHwFileSysPresent=wfHwFileSysPresent, wfFanStatus2=wfFanStatus2, wfHwBootPromSource=wfHwBootPromSource, wfPowerSupply2=wfPowerSupply2, wfHwTable=wfHwTable, wfHwBabyBdSerialNumber=wfHwBabyBdSerialNumber, wfHwConfigServer=wfHwConfigServer, wfBCNPwrSupply1=wfBCNPwrSupply1, wfHwBpSerialNumber=wfHwBpSerialNumber, wfHwModRev=wfHwModRev, wfHwDaughterBdIdOpt=wfHwDaughterBdIdOpt, wfHwActiveImageSource=wfHwActiveImageSource, wfHwModDaughterBd1Rev=wfHwModDaughterBd1Rev, wfHwBabyBdRev=wfHwBabyBdRev, wfBCNPwrSupply3=wfBCNPwrSupply3, wfHwDiagPromRev=wfHwDiagPromRev, wfBCNPwrSupply4=wfBCNPwrSupply4, wfRASNPwrSupply1=wfRASNPwrSupply1, wfPowerSupply1=wfPowerSupply1, wfHwModDaughterBd2SerialNumber=wfHwModDaughterBd2SerialNumber, wfHwFileSysPresent2=wfHwFileSysPresent2, wfHwMotherBdRev=wfHwMotherBdRev, wfRASNPwrSupply2=wfRASNPwrSupply2, wfHwBootPromDate=wfHwBootPromDate, wfHwModDaughterBd2IdOpt=wfHwModDaughterBd2IdOpt, wfHwModDaughterBd1IdOpt=wfHwModDaughterBd1IdOpt, wfFanSpeed=wfFanSpeed, wfHwMotherBdMemorySize=wfHwMotherBdMemorySize, wfModDiagStatus=wfModDiagStatus, wfBCNPwrSupply2=wfBCNPwrSupply2, wfBCNTemperature2=wfBCNTemperature2, wfHwConfigFile=wfHwConfigFile, wfHwCfgTable=wfHwCfgTable, wfHwSparePromDate=wfHwSparePromDate, wfHwActiveImageName=wfHwActiveImageName, wfHwModIdOpt=wfHwModIdOpt)
