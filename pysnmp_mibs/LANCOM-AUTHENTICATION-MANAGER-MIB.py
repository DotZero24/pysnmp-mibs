_i='agentAuthMgrClientAuthstatus'
_h='agentAuthMgrClientAuthMethod'
_g='agentAuthMgrInterface'
_f='agentAuthMgrPortMethodIndex'
_e='agentAuthMgrAuthHistoryResultIfIndex'
_d='agentAuthMgrAuthHistoryResultIndex'
_c='agentAuthMgrAuthHistoryResultIfaceIndex'
_b='monitorVlan'
_a='voiceVlan'
_Z='radius'
_Y='success'
_X='authorize'
_W='reinitialize'
_V='AuthMgrPortHostMode'
_U='AuthMgrPortControlMode'
_T='agentAuthMgrTimerIfIndex'
_S='read-create'
_R='default'
_Q='agentAuthMgrPortIfaceIndex'
_P='agentAuthMgrClientMacAddress'
_O='methodIndex'
_N='agentAuthMgrIfIndex'
_M='none'
_L='not-accessible'
_K='Unsigned32'
_J='undefined'
...
_G='disable'
_F='enable'
_E='LANCOM-AUTHENTICATION-MANAGER-MIB'
_D='read-write'
_C='Integer32'
_B='read-only'
_A='current'
...
fastPathAuthMgr=ModuleIdentity((1,3,6,1,4,1,2356,16,1,61))
if mibBuilder.loadTexts:fastPathAuthMgr.setRevisions(('2020-10-08 00:00','2018-12-26 00:00','2018-09-24 00:00','2018-05-15 00:00','2017-09-05 00:00','2012-12-28 00:00'))
...
class AuthMgrSessionTerminationAction(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_R,1),('reauthenticate',2)))
_FastpathAuthMgrTraps_ObjectIdentity=ObjectIdentity
fastpathAuthMgrTraps=_FastpathAuthMgrTraps_ObjectIdentity((1,3,6,1,4,1,2356,16,1,61,0))
_AgentAuthMgrGlobalConfigGroup_ObjectIdentity=ObjectIdentity
agentAuthMgrGlobalConfigGroup=_AgentAuthMgrGlobalConfigGroup_ObjectIdentity((1,3,6,1,4,1,2356,16,1,61,1))
...
agentAuthMgrAdminMode=_AgentAuthMgrAdminMode_Object((1,3,6,1,4,1,2356,16,1,61,1,1),_AgentAuthMgrAdminMode_Type())
...
agentAuthMgrRadiusVlanAssignment=_AgentAuthMgrRadiusVlanAssignment_Object((1,3,6,1,4,1,2356,16,1,61,1,2),_AgentAuthMgrRadiusVlanAssignment_Type())
...
agentAuthMgrDynamicVlanCreationMode=_AgentAuthMgrDynamicVlanCreationMode_Object((1,3,6,1,4,1,2356,16,1,61,1,3),_AgentAuthMgrDynamicVlanCreationMode_Type())
...
agentAuthMgrCriticalRecoveryMaxReauth=_AgentAuthMgrCriticalRecoveryMaxReauth_Object((1,3,6,1,4,1,2356,16,1,61,1,4),_AgentAuthMgrCriticalRecoveryMaxReauth_Type())
...
agentAuthMgrInterfaceConfigGroup=_AgentAuthMgrInterfaceConfigGroup_ObjectIdentity((1,3,6,1,4,1,2356,16,1,61,2))
_AgentAuthMgrInterfaceConfigMethodTable_Object=MibTable
agentAuthMgrInterfaceConfigMethodTable=_AgentAuthMgrInterfaceConfigMethodTable_Object((1,3,6,1,4,1,2356,16,1,61,2,1))
...
agentAuthMgrInterfaceConfigMethodEntry=_AgentAuthMgrInterfaceConfigMethodEntry_Object((1,3,6,1,4,1,2356,16,1,61,2,1,1))
agentAuthMgrInterfaceConfigMethodEntry.setIndexNames((0,_E,_N),(0,_E,_O))
...
agentAuthMgrIfIndex=_AgentAuthMgrIfIndex_Object((1,3,6,1,4,1,2356,16,1,61,2,1,1,1),_AgentAuthMgrIfIndex_Type())
agentAuthMgrIfIndex.setMaxAccess(_L)
if mibBuilder.loadTexts:agentAuthMgrIfIndex.setStatus(_A)
_MethodIndex_Type=Unsigned32
_MethodIndex_Object=MibTableColumn
methodIndex=_MethodIndex_Object((1,3,6,1,4,1,2356,16,1,61,2,1,1,2),_MethodIndex_Type())
methodIndex.setMaxAccess(_L)
if mibBuilder.loadTexts:methodIndex.setStatus(_A)
class _AgentAuthMgrMethodOrder_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_J,0),(_H,1),(_I,2)))
_AgentAuthMgrMethodOrder_Type.__name__=_C
_AgentAuthMgrMethodOrder_Object=MibTableColumn
agentAuthMgrMethodOrder=_AgentAuthMgrMethodOrder_Object((1,3,6,1,4,1,2356,16,1,61,2,1,1,3),_AgentAuthMgrMethodOrder_Type())
agentAuthMgrMethodOrder.setMaxAccess(_S)
if mibBuilder.loadTexts:agentAuthMgrMethodOrder.setStatus(_A)
class _AgentAuthMgrMethodPriority_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_J,0),(_H,1),(_I,2)))
_AgentAuthMgrMethodPriority_Type.__name__=_C
_AgentAuthMgrMethodPriority_Object=MibTableColumn
agentAuthMgrMethodPriority=_AgentAuthMgrMethodPriority_Object((1,3,6,1,4,1,2356,16,1,61,2,1,1,4),_AgentAuthMgrMethodPriority_Type())
agentAuthMgrMethodPriority.setMaxAccess(_S)
if mibBuilder.loadTexts:agentAuthMgrMethodPriority.setStatus(_A)
_AgentAuthMgrInterfaceConfigTimerTable_Object=MibTable
agentAuthMgrInterfaceConfigTimerTable=_AgentAuthMgrInterfaceConfigTimerTable_Object((1,3,6,1,4,1,2356,16,1,61,2,2))
...
agentAuthMgrInterfaceConfigTimerEntry=_AgentAuthMgrInterfaceConfigTimerEntry_Object((1,3,6,1,4,1,2356,16,1,61,2,2,1))
agentAuthMgrInterfaceConfigTimerEntry.setIndexNames((0,_E,_T))
...
agentAuthMgrTimerIfIndex=_AgentAuthMgrTimerIfIndex_Object((1,3,6,1,4,1,2356,16,1,61,2,2,1,1),_AgentAuthMgrTimerIfIndex_Type())
agentAuthMgrTimerIfIndex.setMaxAccess(_L)
...
_AgentAuthMgrRestart_Type.__name__=_K
_AgentAuthMgrRestart_Object=MibTableColumn
agentAuthMgrRestart=_AgentAuthMgrRestart_Object((1,3,6,1,4,1,2356,16,1,61,2,2,1,2),_AgentAuthMgrRestart_Type())
...
agentAuthMgrInterfaceConfigAuthenticationTable=_AgentAuthMgrInterfaceConfigAuthenticationTable_Object((1,3,6,1,4,1,2356,16,1,61,2,3))
...
agentAuthMgrInterfaceConfigAuthenticationEntry=_AgentAuthMgrInterfaceConfigAuthenticationEntry_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1))
agentAuthMgrInterfaceConfigAuthenticationEntry.setIndexNames((0,_E,_N))
...
_AgentAuthMgrPortControlMode_Type.__name__=_U
_AgentAuthMgrPortControlMode_Object=MibTableColumn
agentAuthMgrPortControlMode=_AgentAuthMgrPortControlMode_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,1),_AgentAuthMgrPortControlMode_Type())
...
_AgentAuthMgrPortHostMode_Type.__name__=_V
_AgentAuthMgrPortHostMode_Object=MibTableColumn
agentAuthMgrPortHostMode=_AgentAuthMgrPortHostMode_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,2),_AgentAuthMgrPortHostMode_Type())
...
_AgentAuthMgrPortNoResponseVlanId_Type.__name__=_K
_AgentAuthMgrPortNoResponseVlanId_Object=MibTableColumn
agentAuthMgrPortNoResponseVlanId=_AgentAuthMgrPortNoResponseVlanId_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,3),_AgentAuthMgrPortNoResponseVlanId_Type())
...
_AgentAuthMgrPortAuthFailVlanId_Type.__name__=_K
_AgentAuthMgrPortAuthFailVlanId_Object=MibTableColumn
agentAuthMgrPortAuthFailVlanId=_AgentAuthMgrPortAuthFailVlanId_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,4),_AgentAuthMgrPortAuthFailVlanId_Type())
...
agentAuthMgrPortMaxUsers=_AgentAuthMgrPortMaxUsers_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,5),_AgentAuthMgrPortMaxUsers_Type())
...
agentAuthMgrPortAuthViolationMode=_AgentAuthMgrPortAuthViolationMode_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,6),_AgentAuthMgrPortAuthViolationMode_Type())
...
_AgentAuthMgrPortCriticalVlanId_Type.__name__=_K
_AgentAuthMgrPortCriticalVlanId_Object=MibTableColumn
agentAuthMgrPortCriticalVlanId=_AgentAuthMgrPortCriticalVlanId_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,7),_AgentAuthMgrPortCriticalVlanId_Type())
agentAuthMgrPortCriticalVlanId.setMaxAccess(_D)
if mibBuilder.loadTexts:agentAuthMgrPortCriticalVlanId.setStatus(_A)
class _AgentAuthMgrPortAuthServerDeadAction_Type(Integer32):defaultValue=3;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_W,1),(_X,2),(_M,3)))
_AgentAuthMgrPortAuthServerDeadAction_Type.__name__=_C
_AgentAuthMgrPortAuthServerDeadAction_Object=MibTableColumn
agentAuthMgrPortAuthServerDeadAction=_AgentAuthMgrPortAuthServerDeadAction_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,8),_AgentAuthMgrPortAuthServerDeadAction_Type())
...
class _AgentAuthMgrPortAuthServerAliveAction_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_W,1),(_M,2)))
_AgentAuthMgrPortAuthServerAliveAction_Type.__name__=_C
_AgentAuthMgrPortAuthServerAliveAction_Object=MibTableColumn
agentAuthMgrPortAuthServerAliveAction=_AgentAuthMgrPortAuthServerAliveAction_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,9),_AgentAuthMgrPortAuthServerAliveAction_Type())
...
class _AgentAuthMgrPortAuthServerDeadVoiceAction_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_X,1),(_M,2)))
...
agentAuthMgrPortAuthServerDeadVoiceAction=_AgentAuthMgrPortAuthServerDeadVoiceAction_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,10),_AgentAuthMgrPortAuthServerDeadVoiceAction_Type())
...
agentAuthMgrPortInitialize=_AgentAuthMgrPortInitialize_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,11),_AgentAuthMgrPortInitialize_Type())
...
agentAuthMgrPortUnauthDHCPAllow=_AgentAuthMgrPortUnauthDHCPAllow_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,12),_AgentAuthMgrPortUnauthDHCPAllow_Type())
...
agentAuthMgrPortAuthenticationOpen=_AgentAuthMgrPortAuthenticationOpen_Object((1,3,6,1,4,1,2356,16,1,61,2,3,1,13),_AgentAuthMgrPortAuthenticationOpen_Type())
...
agentAuthMgrInterfaceStatusGroup=_AgentAuthMgrInterfaceStatusGroup_ObjectIdentity((1,3,6,1,4,1,2356,16,1,61,3))
_AgentAuthMgrInterfaceStatusTable_Object=MibTable
agentAuthMgrInterfaceStatusTable=_AgentAuthMgrInterfaceStatusTable_Object((1,3,6,1,4,1,2356,16,1,61,3,1))
...
agentAuthMgrInterfaceStatusEntry=_AgentAuthMgrInterfaceStatusEntry_Object((1,3,6,1,4,1,2356,16,1,61,3,1,1))
agentAuthMgrInterfaceStatusEntry.setIndexNames((0,_E,_N),(0,_E,_O))
if mibBuilder.loadTexts:agentAuthMgrInterfaceStatusEntry.setStatus(_A)
class _AgentAuthMgrStatusMethodOrder_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_J,0),(_H,1),(_I,2)))
_AgentAuthMgrStatusMethodOrder_Type.__name__=_C
_AgentAuthMgrStatusMethodOrder_Object=MibTableColumn
agentAuthMgrStatusMethodOrder=_AgentAuthMgrStatusMethodOrder_Object((1,3,6,1,4,1,2356,16,1,61,3,1,1,1),_AgentAuthMgrStatusMethodOrder_Type())
agentAuthMgrStatusMethodOrder.setMaxAccess(_B)
if mibBuilder.loadTexts:agentAuthMgrStatusMethodOrder.setStatus(_A)
class _AgentAuthMgrStatusMethodPriority_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_J,0),(_H,1),(_I,2)))
_AgentAuthMgrStatusMethodPriority_Type.__name__=_C
_AgentAuthMgrStatusMethodPriority_Object=MibTableColumn
agentAuthMgrStatusMethodPriority=_AgentAuthMgrStatusMethodPriority_Object((1,3,6,1,4,1,2356,16,1,61,3,1,1,2),_AgentAuthMgrStatusMethodPriority_Type())
...
agentAuthMgrClientStatusGroup=_AgentAuthMgrClientStatusGroup_ObjectIdentity((1,3,6,1,4,1,2356,16,1,61,4))
_AgentAuthMgrClientStatusTable_Object=MibTable
agentAuthMgrClientStatusTable=_AgentAuthMgrClientStatusTable_Object((1,3,6,1,4,1,2356,16,1,61,4,1))
if mibBuilder.loadTexts:agentAuthMgrClientStatusTable.setStatus(_A)
_AgentAuthMgrClientStatusEntry_Object=MibTableRow
agentAuthMgrClientStatusEntry=_AgentAuthMgrClientStatusEntry_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1))
agentAuthMgrClientStatusEntry.setIndexNames((0,_E,_P))
...
agentAuthMgrClientMacAddress=_AgentAuthMgrClientMacAddress_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,1),_AgentAuthMgrClientMacAddress_Type())
...
agentAuthMgrLogicalPort=_AgentAuthMgrLogicalPort_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,2),_AgentAuthMgrLogicalPort_Type())
...
agentAuthMgrInterface=_AgentAuthMgrInterface_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,3),_AgentAuthMgrInterface_Type())
...
agentAuthMgrClientAuthstatus=_AgentAuthMgrClientAuthstatus_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,4),_AgentAuthMgrClientAuthstatus_Type())
agentAuthMgrClientAuthstatus.setMaxAccess(_B)
if mibBuilder.loadTexts:agentAuthMgrClientAuthstatus.setStatus(_A)
class _AgentAuthMgrClientAuthMethod_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_J,0),(_H,1),(_I,2)))
_AgentAuthMgrClientAuthMethod_Type.__name__=_C
_AgentAuthMgrClientAuthMethod_Object=MibTableColumn
agentAuthMgrClientAuthMethod=_AgentAuthMgrClientAuthMethod_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,5),_AgentAuthMgrClientAuthMethod_Type())
agentAuthMgrClientAuthMethod.setMaxAccess(_B)
if mibBuilder.loadTexts:agentAuthMgrClientAuthMethod.setStatus(_A)
class _AgentAuthMgrClientAuthState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_Y,1),('failed',2),('running',3)))
_AgentAuthMgrClientAuthState_Type.__name__=_C
_AgentAuthMgrClientAuthState_Object=MibTableColumn
agentAuthMgrClientAuthState=_AgentAuthMgrClientAuthState_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,6),_AgentAuthMgrClientAuthState_Type())
...
agentAuthMgrClientUserName=_AgentAuthMgrClientUserName_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,7),_AgentAuthMgrClientUserName_Type())
...
agentAuthMgrClientVlanAssigned=_AgentAuthMgrClientVlanAssigned_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,8),_AgentAuthMgrClientVlanAssigned_Type())
agentAuthMgrClientVlanAssigned.setMaxAccess(_B)
if mibBuilder.loadTexts:agentAuthMgrClientVlanAssigned.setStatus(_A)
class _AgentAuthMgrClientAuthVlanAssignedReason_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7)));namedValues=NamedValues(*((_Z,1),('authFailVlan',2),('noResponseVlan',3),(_a,4),(_b,5),('criticalVlan',6),(_M,7)))
...
agentAuthMgrClientAuthVlanAssignedReason=_AgentAuthMgrClientAuthVlanAssignedReason_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,9),_AgentAuthMgrClientAuthVlanAssignedReason_Type())
...
agentAuthMgrClientSessionTime=_AgentAuthMgrClientSessionTime_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,10),_AgentAuthMgrClientSessionTime_Type())
...
agentAuthMgrClientFilterID=_AgentAuthMgrClientFilterID_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,11),_AgentAuthMgrClientFilterID_Type())
...
agentAuthMgrClientDACL=_AgentAuthMgrClientDACL_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,12),_AgentAuthMgrClientDACL_Type())
...
agentAuthMgrClientSessionTimeout=_AgentAuthMgrClientSessionTimeout_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,13),_AgentAuthMgrClientSessionTimeout_Type())
...
agentAuthMgrClientTerminationAction=_AgentAuthMgrClientTerminationAction_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,14),_AgentAuthMgrClientTerminationAction_Type())
...
agentAuthMgrClientAcctSessionId=_AgentAuthMgrClientAcctSessionId_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,15),_AgentAuthMgrClientAcctSessionId_Type())
...
agentAuthMgrClientRedirectACL=_AgentAuthMgrClientRedirectACL_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,16),_AgentAuthMgrClientRedirectACL_Type())
...
agentAuthMgrClientRedirectURL=_AgentAuthMgrClientRedirectURL_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,17),_AgentAuthMgrClientRedirectURL_Type())
...
agentAuthMgrClientSessionTimeLeft=_AgentAuthMgrClientSessionTimeLeft_Object((1,3,6,1,4,1,2356,16,1,61,4,1,1,19),_AgentAuthMgrClientSessionTimeLeft_Type())
...
agentAuthMgrAuthHistoryResultsGroup=_AgentAuthMgrAuthHistoryResultsGroup_ObjectIdentity((1,3,6,1,4,1,2356,16,1,61,5))
_AgentAuthMgrPortAuthHistoryResultTable_Object=MibTable
agentAuthMgrPortAuthHistoryResultTable=_AgentAuthMgrPortAuthHistoryResultTable_Object((1,3,6,1,4,1,2356,16,1,61,5,1))
...
agentAuthMgrPortAuthHistoryResultEntry=_AgentAuthMgrPortAuthHistoryResultEntry_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1))
agentAuthMgrPortAuthHistoryResultEntry.setIndexNames((0,_E,_c),(0,_E,_d))
...
agentAuthMgrAuthHistoryResultIfaceIndex=_AgentAuthMgrAuthHistoryResultIfaceIndex_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,1),_AgentAuthMgrAuthHistoryResultIfaceIndex_Type())
...
agentAuthMgrAuthHistoryResultIndex=_AgentAuthMgrAuthHistoryResultIndex_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,2),_AgentAuthMgrAuthHistoryResultIndex_Type())
...
agentAuthMgrAuthHistoryResultTimeStamp=_AgentAuthMgrAuthHistoryResultTimeStamp_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,3),_AgentAuthMgrAuthHistoryResultTimeStamp_Type())
...
agentAuthMgrAuthHistoryResultMacAddress=_AgentAuthMgrAuthHistoryResultMacAddress_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,4),_AgentAuthMgrAuthHistoryResultMacAddress_Type())
...
class _AgentAuthMgrAuthHistoryResultAuthMethod_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*((_J,0),(_H,1),(_I,2)))
_AgentAuthMgrAuthHistoryResultAuthMethod_Type.__name__=_C
_AgentAuthMgrAuthHistoryResultAuthMethod_Object=MibTableColumn
agentAuthMgrAuthHistoryResultAuthMethod=_AgentAuthMgrAuthHistoryResultAuthMethod_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,5),_AgentAuthMgrAuthHistoryResultAuthMethod_Type())
...
class _AgentAuthMgrAuthHistoryResultAuthStatus_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_Y,1),('failure',2)))
_AgentAuthMgrAuthHistoryResultAuthStatus_Type.__name__=_C
_AgentAuthMgrAuthHistoryResultAuthStatus_Object=MibTableColumn
agentAuthMgrAuthHistoryResultAuthStatus=_AgentAuthMgrAuthHistoryResultAuthStatus_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,6),_AgentAuthMgrAuthHistoryResultAuthStatus_Type())
...
agentAuthMgrAuthHistoryResultAge=_AgentAuthMgrAuthHistoryResultAge_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,7),_AgentAuthMgrAuthHistoryResultAge_Type())
...
agentAuthMgrAuthHistoryResultVlanId=_AgentAuthMgrAuthHistoryResultVlanId_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,8),_AgentAuthMgrAuthHistoryResultVlanId_Type())
...
agentAuthMgrAuthHistoryResultAccessStatus=_AgentAuthMgrAuthHistoryResultAccessStatus_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,9),_AgentAuthMgrAuthHistoryResultAccessStatus_Type())
...
agentAuthMgrAuthHistoryResultFilterID=_AgentAuthMgrAuthHistoryResultFilterID_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,10),_AgentAuthMgrAuthHistoryResultFilterID_Type())
...
agentAuthMgrAuthHistoryResultDACL=_AgentAuthMgrAuthHistoryResultDACL_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,11),_AgentAuthMgrAuthHistoryResultDACL_Type())
agentAuthMgrAuthHistoryResultDACL.setMaxAccess(_B)
if mibBuilder.loadTexts:agentAuthMgrAuthHistoryResultDACL.setStatus(_A)
class _AgentAuthMgrAuthHistoryResultVlanAssignedType_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7)));namedValues=NamedValues(*((_R,1),(_Z,2),('unauthenticatedVlan',3),('guestVlan',4),(_a,5),(_b,6),('notAssigned',7)))
...
agentAuthMgrAuthHistoryResultVlanAssignedType=_AgentAuthMgrAuthHistoryResultVlanAssignedType_Object((1,3,6,1,4,1,2356,16,1,61,5,1,1,12),_AgentAuthMgrAuthHistoryResultVlanAssignedType_Type())
...
agentAuthMgrPortAuthHistoryResultClearTable=_AgentAuthMgrPortAuthHistoryResultClearTable_Object((1,3,6,1,4,1,2356,16,1,61,5,3))
...
agentAuthMgrPortAuthHistoryResultClearEntry=_AgentAuthMgrPortAuthHistoryResultClearEntry_Object((1,3,6,1,4,1,2356,16,1,61,5,3,1))
agentAuthMgrPortAuthHistoryResultClearEntry.setIndexNames((0,_E,_e))
...
agentAuthMgrAuthHistoryResultIfIndex=_AgentAuthMgrAuthHistoryResultIfIndex_Object((1,3,6,1,4,1,2356,16,1,61,5,3,1,1),_AgentAuthMgrAuthHistoryResultIfIndex_Type())
...
agentAuthMgrPortAuthHistoryResultsClear=_AgentAuthMgrPortAuthHistoryResultsClear_Object((1,3,6,1,4,1,2356,16,1,61,5,3,1,2),_AgentAuthMgrPortAuthHistoryResultsClear_Type())
...
agentAuthMgrAuthStatsGroup=_AgentAuthMgrAuthStatsGroup_ObjectIdentity((1,3,6,1,4,1,2356,16,1,61,6))
_AgentAuthMgrPortStatsTable_Object=MibTable
agentAuthMgrPortStatsTable=_AgentAuthMgrPortStatsTable_Object((1,3,6,1,4,1,2356,16,1,61,6,1))
if mibBuilder.loadTexts:agentAuthMgrPortStatsTable.setStatus(_A)
_AgentAuthMgrPortStatsEntry_Object=MibTableRow
agentAuthMgrPortStatsEntry=_AgentAuthMgrPortStatsEntry_Object((1,3,6,1,4,1,2356,16,1,61,6,1,1))
agentAuthMgrPortStatsEntry.setIndexNames((0,_E,_Q),(0,_E,_f))
...
agentAuthMgrPortIfaceIndex=_AgentAuthMgrPortIfaceIndex_Object((1,3,6,1,4,1,2356,16,1,61,6,1,1,1),_AgentAuthMgrPortIfaceIndex_Type())
agentAuthMgrPortIfaceIndex.setMaxAccess(_L)
if mibBuilder.loadTexts:agentAuthMgrPortIfaceIndex.setStatus(_A)
class _AgentAuthMgrPortMethodIndex_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_H,1),(_I,2)))
_AgentAuthMgrPortMethodIndex_Type.__name__=_C
_AgentAuthMgrPortMethodIndex_Object=MibTableColumn
agentAuthMgrPortMethodIndex=_AgentAuthMgrPortMethodIndex_Object((1,3,6,1,4,1,2356,16,1,61,6,1,1,2),_AgentAuthMgrPortMethodIndex_Type())
agentAuthMgrPortMethodIndex.setMaxAccess(_L)
...
agentAuthMgrPortStatsAttempts=_AgentAuthMgrPortStatsAttempts_Object((1,3,6,1,4,1,2356,16,1,61,6,1,1,3),_AgentAuthMgrPortStatsAttempts_Type())
...
agentAuthMgrPortStatsFailedAttempts=_AgentAuthMgrPortStatsFailedAttempts_Object((1,3,6,1,4,1,2356,16,1,61,6,1,1,4),_AgentAuthMgrPortStatsFailedAttempts_Type())
...
agentAuthMgrPortStatsClearTable=_AgentAuthMgrPortStatsClearTable_Object((1,3,6,1,4,1,2356,16,1,61,6,2))
if mibBuilder.loadTexts:agentAuthMgrPortStatsClearTable.setStatus(_A)
_AgentAuthMgrPortStatsClearEntry_Object=MibTableRow
agentAuthMgrPortStatsClearEntry=_AgentAuthMgrPortStatsClearEntry_Object((1,3,6,1,4,1,2356,16,1,61,6,2,1))
agentAuthMgrPortStatsClearEntry.setIndexNames((0,_E,_Q))
...
agentAuthMgrPortStatsClear=_AgentAuthMgrPortStatsClear_Object((1,3,6,1,4,1,2356,16,1,61,6,2,1,2),_AgentAuthMgrPortStatsClear_Type())
...
agentAuthMgrTrapsConfigGroup=_AgentAuthMgrTrapsConfigGroup_ObjectIdentity((1,3,6,1,4,1,2356,16,1,61,7))
...
authMgrTrapMode=_AuthMgrTrapMode_Object((1,3,6,1,4,1,2356,16,1,61,7,1),_AuthMgrTrapMode_Type())
...
agentAuthMgrMonitorModeConfigGroup=_AgentAuthMgrMonitorModeConfigGroup_ObjectIdentity((1,3,6,1,4,1,2356,16,1,61,8))
...
agentAuthMgrMonitorModeEnabled=_AgentAuthMgrMonitorModeEnabled_Object((1,3,6,1,4,1,2356,16,1,61,8,1),_AgentAuthMgrMonitorModeEnabled_Type())
...
agentAuthMgrMonitorModeClients=_AgentAuthMgrMonitorModeClients_Object((1,3,6,1,4,1,2356,16,1,61,8,2),_AgentAuthMgrMonitorModeClients_Type())
