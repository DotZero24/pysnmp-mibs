...
mibBuilder.exportSymbols("ZTE-DSL-PORT-MIB", zxDslPortEntry=zxDslPortEntry, zxDslPortMibObjects=zxDslPortMibObjects, zxDslPortLockStatus=zxDslPortLockStatus, zxDslPortTable=zxDslPortTable, zxDslPortMib=zxDslPortMib, zxDslPortObjects=zxDslPortObjects, zte=zte, zxDsl=zxDsl, PYSNMP_MODULE_ID=zxDslPortMib, zxDslPortTrapObjects=zxDslPortTrapObjects)
