...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-POE-MIB
...
_Hm2PoeMgmtAdminStatus_Type.__name__ = "HmEnabledStatus"
...
hm2PoeMgmtDeliveredCurrent = _Hm2PoeMgmtDeliveredCurrent_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 12, 1, 1, 1, 3),
    _Hm2PoeMgmtDeliveredCurrent_Type()
)
hm2PoeMgmtDeliveredCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2PoeMgmtDeliveredCurrent.setStatus("current")
...
hm2PoeMgmtPsuDeliveredCurrent = _Hm2PoeMgmtPsuDeliveredCurrent_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 12, 1, 1, 2, 1, 4),
    _Hm2PoeMgmtPsuDeliveredCurrent_Type()
)
hm2PoeMgmtPsuDeliveredCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2PoeMgmtPsuDeliveredCurrent.setStatus("current")
...
_Hm2PoeMgmtPortAdminEnable_Type.__name__ = "HmEnabledStatus"
...
_Hm2PoeMgmtPortAutoShutdown_Type.__name__ = "HmEnabledStatus"
...
_Hm2PoeMgmtPortAutoShutdownTimeStart_Type.__name__ = "HmTimeHHMM24"
...
_Hm2PoeMgmtPortAutoShutdownTimeEnd_Type.__name__ = "HmTimeHHMM24"
...
_Hm2PoeMgmtPortFastStartup_Type.__name__ = "HmEnabledStatus"
...
hm2PoeMgmtPortConsumptionCurrent = _Hm2PoeMgmtPortConsumptionCurrent_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 12, 1, 1, 3, 1, 15),
    _Hm2PoeMgmtPortConsumptionCurrent_Type()
)
hm2PoeMgmtPortConsumptionCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2PoeMgmtPortConsumptionCurrent.setStatus("current")
...
_Hm2PoeMgmtModuleNotificationControlEnable_Type.__name__ = "HmEnabledStatus"
...
hm2PoeMgmtModuleDeliveredCurrent = _Hm2PoeMgmtModuleDeliveredCurrent_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 12, 1, 1, 4, 1, 10),
    _Hm2PoeMgmtModuleDeliveredCurrent_Type()
)
hm2PoeMgmtModuleDeliveredCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2PoeMgmtModuleDeliveredCurrent.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hm2PoeMgmtMib": hm2PoeMgmtMib,
       ...
       "hm2PoeMgmtDeliveredCurrent": hm2PoeMgmtDeliveredCurrent,
       ...
       "hm2PoeMgmtPortConsumptionCurrent": hm2PoeMgmtPortConsumptionCurrent,
       ...
       "hm2PoeMgmtModuleDeliveredCurrent": hm2PoeMgmtModuleDeliveredCurrent}
)
