# SNMP MIB module (DNOS-DENIALOFSERVICE-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/DNOS-DENIALOFSERVICE-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:25 2025
...
agentSwitchDenialOfServiceICMPv6Mode = _AgentSwitchDenialOfServiceICMPv6Mode_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 31, 1, 20),
...
agentSwitchDenialOfServicePortDdisable = _AgentSwitchDenialOfServicePortDdisable_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 31, 1, 21),
...
mibBuilder.exportSymbols(
    "DNOS-DENIALOFSERVICE-PRIVATE-MIB",
