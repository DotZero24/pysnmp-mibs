...
rlStackActiveUnitIdTable=_RlStackActiveUnitIdTable_Object((1,3,6,1,4,1,9,6,1,101,107,1))
if mibBuilder.loadTexts:rlStackActiveUnitIdTable.setStatus(_A)
_RlStackActiveUnitIdEntry_Object=MibTableRow
rlStackActiveUnitIdEntry=_RlStackActiveUnitIdEntry_Object((1,3,6,1,4,1,9,6,1,101,107,1,1))
...
rlStackCurrentUnitId=_RlStackCurrentUnitId_Object((1,3,6,1,4,1,9,6,1,101,107,1,1,1),_RlStackCurrentUnitId_Type())
...
rlStackActiveUnitIdAfterReset=_RlStackActiveUnitIdAfterReset_Object((1,3,6,1,4,1,9,6,1,101,107,1,1,2),_RlStackActiveUnitIdAfterReset_Type())
...
rlStackUnitModeAfterReset=_RlStackUnitModeAfterReset_Object((1,3,6,1,4,1,9,6,1,101,107,2),_RlStackUnitModeAfterReset_Type())
...
rlStackUnitMode=_RlStackUnitMode_Object((1,3,6,1,4,1,9,6,1,101,107,3),_RlStackUnitMode_Type())
...
rlStackUnitMacAddressAfterReset=_RlStackUnitMacAddressAfterReset_Object((1,3,6,1,4,1,9,6,1,101,107,4),_RlStackUnitMacAddressAfterReset_Type())
...
rlStackTopology=_RlStackTopology_Object((1,3,6,1,4,1,9,6,1,101,107,6),_RlStackTopology_Type())
rlStackTopology.setMaxAccess(_G)
if mibBuilder.loadTexts:rlStackTopology.setStatus(_A)
class _RlStackMode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('native',1),('hybrid',2)))
_RlStackMode_Type.__name__=_B
_RlStackMode_Object=MibScalar
rlStackMode=_RlStackMode_Object((1,3,6,1,4,1,9,6,1,101,107,7),_RlStackMode_Type())
rlStackMode.setMaxAccess(_C)
if mibBuilder.loadTexts:rlStackMode.setStatus(_A)
mibBuilder.exportSymbols(_D,**{'rlStack':rlStack,'rlStackActiveUnitIdTable':rlStackActiveUnitIdTable,'rlStackActiveUnitIdEntry':rlStackActiveUnitIdEntry,_E:rlStackCurrentUnitId,'rlStackActiveUnitIdAfterReset':rlStackActiveUnitIdAfterReset,'rlStackUnitModeAfterReset':rlStackUnitModeAfterReset,'rlStackUnitMode':rlStackUnitMode,'rlStackUnitMacAddressAfterReset':rlStackUnitMacAddressAfterReset,'rlStackTopology':rlStackTopology,'rlStackMode':rlStackMode})