...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/dell/DNOS-ISDP-MIB
...
if mibBuilder.loadTexts: fastPathIsdp.setOrganization('Dell EMC')
...
agentIsdpCacheNativeVlan = MibTableColumn((1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 39, 1, 2, 1, 1, 13), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 4093))).setMaxAccess("readonly")
...
agentIsdpGlobalRun = MibScalar((1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 39, 1, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 0))).clone(namedValues=NamedValues(("enable", 1), ("disable", 0))).clone('enable')).setMaxAccess("readwrite")
