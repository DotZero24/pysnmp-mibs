...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-EXT-SCSI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:02 2025
...
_CiscoExtScsiNotificationCntl_Type.__name__ = "TruthValue"
...
_CiscoExtScsiLunDiscOs_Type.__name__ = "LunDiscOS"
...
_CiscoExtScsiLunDiscVsanId_Type.__name__ = "VsanIndex"
...
_CiscoExtScsiLunDiscPortId_Type.__name__ = "FcAddressId"
...
ciscoExtScsiMIBCompliance.setObjects(
      *(("CISCO-EXT-SCSI-MIB", "ciscoExtScsiConfigGroup"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiNotifyControlGroup"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiNotifyGroup"))
)
if mibBuilder.loadTexts:
...
ciscoExtScsiMIBCompliance2.setObjects(
      *(("CISCO-EXT-SCSI-MIB", "ciscoExtScsiConfigGroup"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiPartialDiscGroup"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiNotifyControlGroup"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiNotifyGroup"))
)
if mibBuilder.loadTexts:
...
ciscoExtScsiMIBComplianceRev3.setObjects(
      *(("CISCO-EXT-SCSI-MIB", "ciscoExtScsiConfigGroup1"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiPartialDiscGroup"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiNotifyControlGroup"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiNotifyGroup"))
)
...
ciscoExtScsiMIBComplianceRev4.setObjects(
      *(("CISCO-EXT-SCSI-MIB", "ciscoExtScsiConfigGroup2"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiPartialDiscGroup"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiNotifyControlGroup"),
        ("CISCO-EXT-SCSI-MIB", "ciscoExtScsiNotifyGroup"))
)
