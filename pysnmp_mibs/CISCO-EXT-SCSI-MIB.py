...
VsanIndex, DomainId, FcAddressId = mibBuilder.importSymbols("CISCO-ST-TC", "VsanIndex", "DomainId", "FcAddressId")
...
mibBuilder.exportSymbols("CISCO-EXT-SCSI-MIB", PYSNMP_MODULE_ID=ciscoExtScsiMIB, ciscoExtScsiMIBComplianceRev3=ciscoExtScsiMIBComplianceRev3, ciscoExtScsiIntrDiscLunsTable=ciscoExtScsiIntrDiscLunsTable, ciscoExtScsiMIB=ciscoExtScsiMIB, ciscoExtScsiPartialDiscGroup=ciscoExtScsiPartialDiscGroup, ciscoExtScsiMIBGroups=ciscoExtScsiMIBGroups, LunDiscOS=LunDiscOS, ciscoExtScsiIntrDiscTgtProductId=ciscoExtScsiIntrDiscTgtProductId, ciscoExtScsiIntrDiscTgtDevType=ciscoExtScsiIntrDiscTgtDevType, ciscoExtScsiLineCardOrSup=ciscoExtScsiLineCardOrSup, ciscoExtScsiLunDiscCompleteTime=ciscoExtScsiLunDiscCompleteTime, ciscoExtScsiIntrDiscLunsEntry=ciscoExtScsiIntrDiscLunsEntry, ciscoExtScsiConfiguration=ciscoExtScsiConfiguration, ciscoExtScsiStats=ciscoExtScsiStats, ciscoExtScsiIntrDiscLunCapacity=ciscoExtScsiIntrDiscLunCapacity, ciscoExtScsiIntrDiscLunPortId=ciscoExtScsiIntrDiscLunPortId, ciscoExtScsiDiskGrpId=ciscoExtScsiDiskGrpId, ciscoExtScsiIntrDiscTgtVendorId=ciscoExtScsiIntrDiscTgtVendorId, ciscoExtScsiLunCacheDevIndex=ciscoExtScsiLunCacheDevIndex, ciscoExtScsiNotifyControlGroup=ciscoExtScsiNotifyControlGroup, ciscoExtScsiLunDiscStatus=ciscoExtScsiLunDiscStatus, ciscoExtScsiLunCachePortIndex=ciscoExtScsiLunCachePortIndex, ciscoExtScsiMIBObjects=ciscoExtScsiMIBObjects, ciscoExtScsiGenInstanceEntry=ciscoExtScsiGenInstanceEntry, ciscoExtScsiIntrDiscTgtTable=ciscoExtScsiIntrDiscTgtTable, ciscoExtScsiNotifications=ciscoExtScsiNotifications, ciscoExtScsiPartialLunRowStatus=ciscoExtScsiPartialLunRowStatus, ciscoExtScsiPartialLunDiscEntry=ciscoExtScsiPartialLunDiscEntry, ciscoExtScsiConfigGroup=ciscoExtScsiConfigGroup, ciscoExtScsiConfigGroup2=ciscoExtScsiConfigGroup2, ciscoExtScsiLunDiscVsanId=ciscoExtScsiLunDiscVsanId, ciscoExtScsiPartialLunDomId=ciscoExtScsiPartialLunDomId, ciscoExtScsiNotification=ciscoExtScsiNotification, ciscoExtScsiIntrDiscLunSerialNum=ciscoExtScsiIntrDiscLunSerialNum, ciscoExtScsiMIBConformance=ciscoExtScsiMIBConformance, ciscoExtScsiIntrDiscTgtVsanId=ciscoExtScsiIntrDiscTgtVsanId, ciscoExtScsiLunDiscOs=ciscoExtScsiLunDiscOs, ciscoExtScsiLunCacheScsiIndex=ciscoExtScsiLunCacheScsiIndex, ciscoExtScsiIntrDiscTgtOtherInfo=ciscoExtScsiIntrDiscTgtOtherInfo, ciscoExtScsiNotifyGroup=ciscoExtScsiNotifyGroup, ciscoExtScsiMIBComplianceRev4=ciscoExtScsiMIBComplianceRev4, ciscoExtScsiConfigGroup1=ciscoExtScsiConfigGroup1, ciscoExtScsiIntrDiscTgtRevLevel=ciscoExtScsiIntrDiscTgtRevLevel, ciscoExtScsiMIBCompliance=ciscoExtScsiMIBCompliance, ciscoExtScsiPartialLunDiscTable=ciscoExtScsiPartialLunDiscTable, ciscoExtScsiMIBCompliance2=ciscoExtScsiMIBCompliance2, ciscoExtScsiStartLunDisc=ciscoExtScsiStartLunDisc, ciscoExtScsiNotificationCntl=ciscoExtScsiNotificationCntl, ciscoExtScsiDiscType=ciscoExtScsiDiscType, ciscoExtScsiLunCacheTgtIndex=ciscoExtScsiLunCacheTgtIndex, ciscoExtScsiIntrDiscTgtEntry=ciscoExtScsiIntrDiscTgtEntry, ciscoExtScsiMIBCompliances=ciscoExtScsiMIBCompliances, ciscoExtScsiLunDiscPortId=ciscoExtScsiLunDiscPortId, ciscoExtScsiLunDiscDoneNotify=ciscoExtScsiLunDiscDoneNotify, ciscoExtScsiLunDiscSpinLock=ciscoExtScsiLunDiscSpinLock, ciscoExtScsiGenInstanceTable=ciscoExtScsiGenInstanceTable, ciscoExtScsiIntrDiscLunNumber=ciscoExtScsiIntrDiscLunNumber, ciscoExtScsiIntrDiscLunOs=ciscoExtScsiIntrDiscLunOs)
