...
InterfaceIndexOrZero, ifOperStatus, ifIndex, InterfaceIndex = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero", "ifOperStatus", "ifIndex", "InterfaceIndex")
...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistory=callHistory, callActive=callActive, dialCtlPeerCfgId=dialCtlPeerCfgId, callHistoryInfoType=callHistoryInfoType, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistoryConnectTime=callHistoryConnectTime, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callActiveChargedUnits=callActiveChargedUnits, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryTableMaxLength=callHistoryTableMaxLength, callHistoryDisconnectTime=callHistoryDisconnectTime, callActiveConnectTime=callActiveConnectTime, callHistoryPeerId=callHistoryPeerId, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActiveInfoType=callActiveInfoType, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, AbsoluteCounter32=AbsoluteCounter32, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callActiveSetupTime=callActiveSetupTime, callHistoryTable=callHistoryTable, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, dialControlMibGroups=dialControlMibGroups, dialCtlPeer=dialCtlPeer, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryTransmitPackets=callHistoryTransmitPackets, dialControlMibConformance=dialControlMibConformance, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialControlMibCompliances=dialControlMibCompliances, dialControlGroup=dialControlGroup, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callNotificationsGroup=callNotificationsGroup, callHistoryPeerAddress=callHistoryPeerAddress, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callActiveGroup=callActiveGroup, callActiveReceivePackets=callActiveReceivePackets, callHistoryReceiveBytes=callHistoryReceiveBytes, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, callActiveCallState=callActiveCallState, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveCallOrigin=callActiveCallOrigin, callHistoryTransmitBytes=callHistoryTransmitBytes, callActiveIndex=callActiveIndex, callActiveReceiveBytes=callActiveReceiveBytes, PYSNMP_MODULE_ID=dialControlMib, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActivePeerSubAddress=callActivePeerSubAddress, dialControlMibTraps=dialControlMibTraps, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, dialControlMib=dialControlMib, callActivePeerAddress=callActivePeerAddress, callHistoryGroup=callHistoryGroup, callHistoryReceivePackets=callHistoryReceivePackets, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlAcceptMode=dialCtlAcceptMode, callHistoryEntry=callHistoryEntry, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callActivePeerId=callActivePeerId, callHistoryDisconnectText=callHistoryDisconnectText, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActiveEntry=callActiveEntry, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callActiveTable=callActiveTable, callHistoryRetainTimer=callHistoryRetainTimer)
