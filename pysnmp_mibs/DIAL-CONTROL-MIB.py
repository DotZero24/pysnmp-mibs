...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/DIAL-CONTROL-MIB
...
ifIndex, InterfaceIndexOrZero, InterfaceIndex, ifOperStatus = mibBuilder.importSymbols("IF-MIB", "ifIndex", "InterfaceIndexOrZero", "InterfaceIndex", "ifOperStatus")
...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callActiveCallOrigin=callActiveCallOrigin, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, callHistoryDisconnectText=callHistoryDisconnectText, callHistoryPeerId=callHistoryPeerId, PYSNMP_MODULE_ID=dialControlMib, callHistoryEntry=callHistoryEntry, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callActiveTable=callActiveTable, dialControlMibCompliance=dialControlMibCompliance, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, callActivePeerId=callActivePeerId, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, dialCtlPeerCfgTable=dialCtlPeerCfgTable, callHistoryTable=callHistoryTable, dialControlMibTraps=dialControlMibTraps, dialControlMibConformance=dialControlMibConformance, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryTableMaxLength=callHistoryTableMaxLength, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlAcceptMode=dialCtlAcceptMode, callActiveSetupTime=callActiveSetupTime, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, dialCtlPeerCallInformation=dialCtlPeerCallInformation, callHistoryPeerIfIndex=callHistoryPeerIfIndex, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, callActiveTransmitPackets=callActiveTransmitPackets, dialCtlConfiguration=dialCtlConfiguration, dialControlGroup=dialControlGroup, callActivePeerIfIndex=callActivePeerIfIndex, callHistoryReceiveBytes=callHistoryReceiveBytes, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callActiveReceivePackets=callActiveReceivePackets, callActiveTransmitBytes=callActiveTransmitBytes, callHistoryRetainTimer=callHistoryRetainTimer, callActiveChargedUnits=callActiveChargedUnits, callNotificationsGroup=callNotificationsGroup, callActiveGroup=callActiveGroup, callHistoryInfoType=callHistoryInfoType, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryDisconnectTime=callHistoryDisconnectTime, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, AbsoluteCounter32=AbsoluteCounter32, callHistoryPeerAddress=callHistoryPeerAddress, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, callActiveInfoType=callActiveInfoType, callActiveEntry=callActiveEntry, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCallSetup=dialCtlPeerCallSetup, callActiveLogicalIfIndex=callActiveLogicalIfIndex, callHistoryConnectTime=callHistoryConnectTime, dialControlMibGroups=dialControlMibGroups, dialControlMib=dialControlMib, callActiveConnectTime=callActiveConnectTime, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, callActive=callActive, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryGroup=callHistoryGroup, callHistoryCallOrigin=callHistoryCallOrigin, dialCtlTrapEnable=dialCtlTrapEnable, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, dialCtlPeer=dialCtlPeer, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveIndex=callActiveIndex, callActivePeerAddress=callActivePeerAddress, callHistoryDisconnectCause=callHistoryDisconnectCause, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistory=callHistory, callHistoryReceivePackets=callHistoryReceivePackets, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, callActiveCallState=callActiveCallState, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry)
