...
mibBuilder.exportSymbols("DLINK-MCB-MIB", mcbMCSlotCount=mcbMCSlotCount, mcbMCSlotTable=mcbMCSlotTable, mcbSNMPTrapMCActiveSlotLose=mcbSNMPTrapMCActiveSlotLose, mcbMCRedundantGroupTable=mcbMCRedundantGroupTable, mcbMCSlotExist=mcbMCSlotExist, mcbMCMediaTwoRxPacketCount=mcbMCMediaTwoRxPacketCount, mcbMCMediaTwoSpeedStatus=mcbMCMediaTwoSpeedStatus, mcbMCMediaOneBrokenStatus=mcbMCMediaOneBrokenStatus, mcbMCMediaOneDupStatus=mcbMCMediaOneDupStatus, mcbMCRedundantGroupPrimarySlot=mcbMCRedundantGroupPrimarySlot, mcbFanOneFail=mcbFanOneFail, mcbFrameFanTwoFailStatus=mcbFrameFanTwoFailStatus, mcbMCRedundantGroupEnable=mcbMCRedundantGroupEnable, mcbMCMediaOneType=mcbMCMediaOneType, mcbMCMediaOneLinkStatus=mcbMCMediaOneLinkStatus, mcbMCMediaTwoDupStatus=mcbMCMediaTwoDupStatus, mcbMCRedundantGroupNo=mcbMCRedundantGroupNo, mcbMCMediaTwoLinkStatus=mcbMCMediaTwoLinkStatus, mcbMCMediaOneTxPacketCount=mcbMCMediaOneTxPacketCount, mcbSNMPTrapPowerFail=mcbSNMPTrapPowerFail, mcbFanTwoFail=mcbFanTwoFail, mcbAdministratorFactoryResetCPU=mcbAdministratorFactoryResetCPU, mcbMCRedundantGroupRestart=mcbMCRedundantGroupRestart, mcbMCEnableMediaTwo=mcbMCEnableMediaTwo, mcbMCSetMediaOneLLR=mcbMCSetMediaOneLLR, mcbMCMediaTwoType=mcbMCMediaTwoType, mcbMediaConverterChassis=mcbMediaConverterChassis, mcbMCEnableMediaOne=mcbMCEnableMediaOne, mcbFramePowerTwoFailStatus=mcbFramePowerTwoFailStatus, mcbMediaConverterPlugin=mcbMediaConverterPlugin, mcbMCMediaOneLinkDown=mcbMCMediaOneLinkDown, mcbSNMPTrapMCLinkDown=mcbSNMPTrapMCLinkDown, mcbFramePowerTwoOnStatus=mcbFramePowerTwoOnStatus, mcbAdministratorBiosRev=mcbAdministratorBiosRev, mcbMCSetLLCF=mcbMCSetLLCF, mcbFrameFanOneFailStatus=mcbFrameFanOneFailStatus, mcbMCMediaTwoLinkDown=mcbMCMediaTwoLinkDown, mcbMCSetMediaTwoDuplex=mcbMCSetMediaTwoDuplex, mcbMCMediaTwoLinkUp=mcbMCMediaTwoLinkUp, mcbSNMPTrapMCPlugin=mcbSNMPTrapMCPlugin, mcbMCSetMediaOneAutoNegotiate=mcbMCSetMediaOneAutoNegotiate, mcbSNMPTrapMCPullout=mcbSNMPTrapMCPullout, mcbSNMPMIB=mcbSNMPMIB, mcbAdministratorSoftwareReboot=mcbAdministratorSoftwareReboot, mcbPowerOneFail=mcbPowerOneFail, mcbMCSlotEntry=mcbMCSlotEntry, mcbMCRedundantGroupCount=mcbMCRedundantGroupCount, mcbMCRedundantGroupEntry=mcbMCRedundantGroupEntry, mcbMCSetMediaOneSpeed=mcbMCSetMediaOneSpeed, mcbMCActiveSlotChange=mcbMCActiveSlotChange, mcbMediaConverterPullout=mcbMediaConverterPullout, mcbMCSetMediaOneFlowControl=mcbMCSetMediaOneFlowControl, mcbMCMediaTwoBroken=mcbMCMediaTwoBroken, mcbMCActiveSlotLose=mcbMCActiveSlotLose, mcbMCMediaOneLinkUp=mcbMCMediaOneLinkUp, mcbAdministratorFactoryReset=mcbAdministratorFactoryReset, mcbMCFrame=mcbMCFrame, mcbMCSetMediaOneDuplex=mcbMCSetMediaOneDuplex, mcbMCMediaOneRxPacketCount=mcbMCMediaOneRxPacketCount, mcbMCSlotName=mcbMCSlotName, mcbMCRedundantGroupSecondarySlot=mcbMCRedundantGroupSecondarySlot, mcbSNMPTrapFanFail=mcbSNMPTrapFanFail, mcbFramePowerOneOnStatus=mcbFramePowerOneOnStatus, mcbMCSetMediaTwoLLR=mcbMCSetMediaTwoLLR, mcbMCEnable=mcbMCEnable, mcbMCSlots=mcbMCSlots, mcbAdministrator=mcbAdministrator, mcbMCMediaOneBroken=mcbMCMediaOneBroken, mcbAdministratorSoftwareRev=mcbAdministratorSoftwareRev, mcbAdministratorHardwareRev=mcbAdministratorHardwareRev, mcbMCSetMediaTwoFlowControl=mcbMCSetMediaTwoFlowControl, mcbMCSlotNo=mcbMCSlotNo, mcbMCSetMediaTwoSpeed=mcbMCSetMediaTwoSpeed, mcbSNMPTrapMCLinkBroken=mcbSNMPTrapMCLinkBroken, mcbMCMediaTwoBrokenStatus=mcbMCMediaTwoBrokenStatus, mcbMCMediaTwoTxPacketCount=mcbMCMediaTwoTxPacketCount, mcbMCSetMediaTwoAutoNegotiate=mcbMCSetMediaTwoAutoNegotiate, mcbMCRedundantGroups=mcbMCRedundantGroups, mcbSNMPTrapMCLinkUp=mcbSNMPTrapMCLinkUp, mcbFramePowerOneFailStatus=mcbFramePowerOneFailStatus, mcbPowerTwoFail=mcbPowerTwoFail, mcbMCModelName=mcbMCModelName, mcbMediaConverterFamily=mcbMediaConverterFamily, mcbMCMediaOneSpeedStatus=mcbMCMediaOneSpeedStatus, mcbMCRedundantGroupActiveSlot=mcbMCRedundantGroupActiveSlot, mcbSNMPTrapMCActiveSlotChange=mcbSNMPTrapMCActiveSlotChange)
