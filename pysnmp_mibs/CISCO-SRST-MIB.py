...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-SRST-MIB
...
mibBuilder.exportSymbols("CISCO-SRST-MIB", ciscoSrstMIBNotifications=ciscoSrstMIBNotifications, csrstAliasEntry=csrstAliasEntry, csrstAliasIndex=csrstAliasIndex, csrstSipEndpointEntry=csrstSipEndpointEntry, csrstSipPhoneCurrentRegistered=csrstSipPhoneCurrentRegistered, csrstSipVoRegPoolTag=csrstSipVoRegPoolTag, csrstGlobal=csrstGlobal, csrstSipIp2IpGlobalEnabled=csrstSipIp2IpGlobalEnabled, csrstLimitDNType=csrstLimitDNType, csrstSipVoRegNumberListTable=csrstSipVoRegNumberListTable, csrstSipVoRegPoolAppl=csrstSipVoRegPoolAppl, ciscoSrstMIBObjects=ciscoSrstMIBObjects, csrstSipSend300MultSupport=csrstSipSend300MultSupport, csrstMohMulticastAddrType=csrstMohMulticastAddrType, csrstSipVoRegNumberPref=csrstSipVoRegNumberPref, csrstConf=csrstConf, csrstMohFilename=csrstMohFilename, csrstNotificationEnabled=csrstNotificationEnabled, csrstMohMulticastPort=csrstMohMulticastPort, csrstVoiceMailNumber=csrstVoiceMailNumber, csrstSysNotifSeverity=csrstSysNotifSeverity, csrstCallFwdBusy=csrstCallFwdBusy, csrstSipPhoneUnRegThreshold=csrstSipPhoneUnRegThreshold, ciscoSrstMIBCompliance=ciscoSrstMIBCompliance, csrstSipVoRegPoolEntry=csrstSipVoRegPoolEntry, csrstSipVoRegNumberHuntstopEnabled=csrstSipVoRegNumberHuntstopEnabled, csrstSipEndpointTable=csrstSipEndpointTable, csrstActiveStatsGroup=csrstActiveStatsGroup, ciscoSrstMIBCompliances=ciscoSrstMIBCompliances, csrstSipVoRegPoolTable=csrstSipVoRegPoolTable, PYSNMP_MODULE_ID=ciscoSrstMIB, csrstScriptName=csrstScriptName, csrstTransferSystem=csrstTransferSystem, csrstSipProxySrvPref=csrstSipProxySrvPref, csrstAliasTable=csrstAliasTable, csrstSipConfGroup=csrstSipConfGroup, csrstSipVoRegPoolIpAddrType=csrstSipVoRegPoolIpAddrType, csrstSipDefaultPreference=csrstSipDefaultPreference, csrstSipVoRegNumberListIndex=csrstSipVoRegNumberListIndex, csrstSipCallLegs=csrstSipCallLegs, csrstAliasTag=csrstAliasTag, csrstFailNotif=csrstFailNotif, ciscoSrstMIBConformance=ciscoSrstMIBConformance, csrstXlateCallingNumber=csrstXlateCallingNumber, csrstPortNumber=csrstPortNumber, csrstSipEndpointIpAddress=csrstSipEndpointIpAddress, csrstSipEndpointIpAddrType=csrstSipEndpointIpAddrType, csrstMaxDN=csrstMaxDN, csrstSipEndpointDN=csrstSipEndpointDN, csrstSipRegSrvExpMax=csrstSipRegSrvExpMax, csrstTotalUpTime=csrstTotalUpTime, csrstLimitDN=csrstLimitDN, csrstXlateCalledNumber=csrstXlateCalledNumber, csrstSipVoRegNumberListTag=csrstSipVoRegNumberListTag, ciscoSrstMIBGroups=ciscoSrstMIBGroups, csrstSipPhoneUnRegThresholdExceed=csrstSipPhoneUnRegThresholdExceed, csrstEnabled=csrstEnabled, csrstSipProxySrvIpAddr=csrstSipProxySrvIpAddr, csrstIPAddressType=csrstIPAddressType, csrstInterdigitTo=csrstInterdigitTo, csrstLimitDNEntry=csrstLimitDNEntry, csrstActiveStats=csrstActiveStats, csrstSipPhoneRegFailed=csrstSipPhoneRegFailed, csrstSipVoRegPoolEdptTag=csrstSipVoRegPoolEdptTag, csrstCallFwdNoAnswer=csrstCallFwdNoAnswer, csrstStateChange=csrstStateChange, csrstSipProxySrvAltIpAddr=csrstSipProxySrvAltIpAddr, csrstSipVoRegNumberPattern=csrstSipVoRegNumberPattern, csrstConferenceFailed=csrstConferenceFailed, csrstVersion=csrstVersion, csrstUserLocaleInfo=csrstUserLocaleInfo, csrstAlertTo=csrstAlertTo, csrstSecondaryDialTone=csrstSecondaryDialTone, csrstSystemMessagePrimary=csrstSystemMessagePrimary, csrstSipRegSrvExpMin=csrstSipRegSrvExpMin, ciscoSrstMIB=ciscoSrstMIB, csrstMIBNotifsGroup=csrstMIBNotifsGroup, csrstSystemMessageSecondary=csrstSystemMessageSecondary, csrstAccessCodeTable=csrstAccessCodeTable, csrstSipProxySrvMonitor=csrstSipProxySrvMonitor, csrstConfGroupRev1=csrstConfGroupRev1, csrstAccessCodeDIDEnabled=csrstAccessCodeDIDEnabled, csrstNotifInfoGroup=csrstNotifInfoGroup, csrstSipNetId=csrstSipNetId, csrstAccessCode=csrstAccessCode, csrstAliasNumPattern=csrstAliasNumPattern, csrstAliasAltNumber=csrstAliasAltNumber, csrstSipEndpointTag=csrstSipEndpointTag, csrstMohMulticastAddr=csrstMohMulticastAddr, csrstDateFormat=csrstDateFormat, csrstUserLocaleInfoRev1=csrstUserLocaleInfoRev1, csrstMaxEphones=csrstMaxEphones, csrstState=csrstState, csrstBusyTo=csrstBusyTo, ciscoSrstMIBComplianceRev1=ciscoSrstMIBComplianceRev1, csrstSipConf=csrstSipConf, csrstSysNotifReason=csrstSysNotifReason, csrstCallFwdNoAnswerTo=csrstCallFwdNoAnswerTo, csrstMaxConferences=csrstMaxConferences, SrstOperType=SrstOperType, csrstSipVoRegNumberListEntry=csrstSipVoRegNumberListEntry, csrstIPAddress=csrstIPAddress, csrstAliasPreference=csrstAliasPreference, csrstLimitDNTable=csrstLimitDNTable, csrstSipNetMask=csrstSipNetMask, csrstAliasHuntStopEnabled=csrstAliasHuntStopEnabled, csrstConfGroup=csrstConfGroup, csrstAccessCodeType=csrstAccessCodeType, csrstTimeFormat=csrstTimeFormat, csrstAccessCodeEntry=csrstAccessCodeEntry)
