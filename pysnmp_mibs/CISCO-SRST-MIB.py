...
mibBuilder.exportSymbols("CISCO-SRST-MIB", csrstTimeFormat=csrstTimeFormat, csrstSipEndpointTag=csrstSipEndpointTag, csrstMohMulticastAddrType=csrstMohMulticastAddrType, csrstSipVoRegPoolAppl=csrstSipVoRegPoolAppl, csrstUserLocaleInfoRev1=csrstUserLocaleInfoRev1, csrstMohFilename=csrstMohFilename, csrstMaxConferences=csrstMaxConferences, csrstAliasAltNumber=csrstAliasAltNumber, csrstSipVoRegPoolEntry=csrstSipVoRegPoolEntry, csrstSipEndpointTable=csrstSipEndpointTable, ciscoSrstMIBGroups=ciscoSrstMIBGroups, csrstSipPhoneUnRegThresholdExceed=csrstSipPhoneUnRegThresholdExceed, csrstAccessCodeType=csrstAccessCodeType, csrstSipNetMask=csrstSipNetMask, csrstFailNotif=csrstFailNotif, csrstAliasTable=csrstAliasTable, csrstSipPhoneRegFailed=csrstSipPhoneRegFailed, csrstLimitDNType=csrstLimitDNType, csrstLimitDNTable=csrstLimitDNTable, csrstXlateCalledNumber=csrstXlateCalledNumber, csrstCallFwdNoAnswer=csrstCallFwdNoAnswer, csrstPortNumber=csrstPortNumber, PYSNMP_MODULE_ID=ciscoSrstMIB, csrstSipIp2IpGlobalEnabled=csrstSipIp2IpGlobalEnabled, csrstSipVoRegNumberListTag=csrstSipVoRegNumberListTag, csrstAccessCodeDIDEnabled=csrstAccessCodeDIDEnabled, csrstSipEndpointIpAddress=csrstSipEndpointIpAddress, csrstEnabled=csrstEnabled, csrstSysNotifReason=csrstSysNotifReason, csrstVersion=csrstVersion, csrstBusyTo=csrstBusyTo, csrstActiveStats=csrstActiveStats, csrstConferenceFailed=csrstConferenceFailed, csrstLimitDNEntry=csrstLimitDNEntry, csrstAliasIndex=csrstAliasIndex, csrstAccessCodeTable=csrstAccessCodeTable, csrstSecondaryDialTone=csrstSecondaryDialTone, csrstMaxEphones=csrstMaxEphones, csrstConfGroup=csrstConfGroup, csrstSipVoRegPoolIpAddrType=csrstSipVoRegPoolIpAddrType, ciscoSrstMIBCompliance=ciscoSrstMIBCompliance, csrstAccessCodeEntry=csrstAccessCodeEntry, csrstSipProxySrvIpAddr=csrstSipProxySrvIpAddr, csrstInterdigitTo=csrstInterdigitTo, csrstSipConf=csrstSipConf, csrstSipRegSrvExpMax=csrstSipRegSrvExpMax, csrstStateChange=csrstStateChange, csrstSystemMessagePrimary=csrstSystemMessagePrimary, csrstSystemMessageSecondary=csrstSystemMessageSecondary, csrstAliasPreference=csrstAliasPreference, ciscoSrstMIBCompliances=ciscoSrstMIBCompliances, ciscoSrstMIBObjects=ciscoSrstMIBObjects, ciscoSrstMIBConformance=ciscoSrstMIBConformance, csrstVoiceMailNumber=csrstVoiceMailNumber, ciscoSrstMIB=ciscoSrstMIB, csrstSipVoRegNumberListEntry=csrstSipVoRegNumberListEntry, csrstSipVoRegNumberHuntstopEnabled=csrstSipVoRegNumberHuntstopEnabled, csrstNotifInfoGroup=csrstNotifInfoGroup, csrstAliasNumPattern=csrstAliasNumPattern, ciscoSrstMIBComplianceRev1=ciscoSrstMIBComplianceRev1, csrstSipVoRegPoolEdptTag=csrstSipVoRegPoolEdptTag, csrstSipVoRegNumberListTable=csrstSipVoRegNumberListTable, csrstSipVoRegNumberPattern=csrstSipVoRegNumberPattern, csrstAlertTo=csrstAlertTo, csrstScriptName=csrstScriptName, csrstSipProxySrvMonitor=csrstSipProxySrvMonitor, csrstTransferSystem=csrstTransferSystem, csrstSipCallLegs=csrstSipCallLegs, csrstLimitDN=csrstLimitDN, csrstIPAddressType=csrstIPAddressType, csrstAliasHuntStopEnabled=csrstAliasHuntStopEnabled, csrstSipVoRegPoolTag=csrstSipVoRegPoolTag, csrstCallFwdNoAnswerTo=csrstCallFwdNoAnswerTo, csrstMohMulticastAddr=csrstMohMulticastAddr, SrstOperType=SrstOperType, csrstSipPhoneUnRegThreshold=csrstSipPhoneUnRegThreshold, csrstConfGroupRev1=csrstConfGroupRev1, ciscoSrstMIBNotifications=ciscoSrstMIBNotifications, csrstMIBNotifsGroup=csrstMIBNotifsGroup, csrstTotalUpTime=csrstTotalUpTime, csrstAliasEntry=csrstAliasEntry, csrstSipConfGroup=csrstSipConfGroup, csrstSysNotifSeverity=csrstSysNotifSeverity, csrstAccessCode=csrstAccessCode, csrstSipRegSrvExpMin=csrstSipRegSrvExpMin, csrstNotificationEnabled=csrstNotificationEnabled, csrstCallFwdBusy=csrstCallFwdBusy, csrstMaxDN=csrstMaxDN, csrstSipNetId=csrstSipNetId, csrstSipProxySrvAltIpAddr=csrstSipProxySrvAltIpAddr, csrstAliasTag=csrstAliasTag, csrstSipEndpointEntry=csrstSipEndpointEntry, csrstSipVoRegPoolTable=csrstSipVoRegPoolTable, csrstSipEndpointIpAddrType=csrstSipEndpointIpAddrType, csrstSipVoRegNumberListIndex=csrstSipVoRegNumberListIndex, csrstActiveStatsGroup=csrstActiveStatsGroup, csrstSipPhoneCurrentRegistered=csrstSipPhoneCurrentRegistered, csrstDateFormat=csrstDateFormat, csrstSipProxySrvPref=csrstSipProxySrvPref, csrstSipSend300MultSupport=csrstSipSend300MultSupport, csrstUserLocaleInfo=csrstUserLocaleInfo, csrstSipDefaultPreference=csrstSipDefaultPreference, csrstSipVoRegNumberPref=csrstSipVoRegNumberPref, csrstState=csrstState, csrstGlobal=csrstGlobal, csrstConf=csrstConf, csrstXlateCallingNumber=csrstXlateCallingNumber, csrstMohMulticastPort=csrstMohMulticastPort, csrstIPAddress=csrstIPAddress, csrstSipEndpointDN=csrstSipEndpointDN)
