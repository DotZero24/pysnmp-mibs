...
fsPingMIBObjects=_FsPingMIBObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,1,106,1))
_FsPingTable_Object=MibTable
fsPingTable=_FsPingTable_Object((1,3,6,1,4,1,10876,101,1,106,1,1))
if mibBuilder.loadTexts:fsPingTable.setStatus(_A)
_FsPingEntry_Object=MibTableRow
fsPingEntry=_FsPingEntry_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1))
fsPingEntry.setIndexNames((0,_E,_F))
...
fsPingIndex=_FsPingIndex_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,1),_FsPingIndex_Type())
...
fsPingDest=_FsPingDest_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,2),_FsPingDest_Type())
...
fsPingTimeout=_FsPingTimeout_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,3),_FsPingTimeout_Type())
...
fsPingTries=_FsPingTries_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,4),_FsPingTries_Type())
...
fsPingDataSize=_FsPingDataSize_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,5),_FsPingDataSize_Type())
...
fsPingStatus=_FsPingStatus_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,6),_FsPingStatus_Type())
...
fsPingSendCount=_FsPingSendCount_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,7),_FsPingSendCount_Type())
...
fsPingAverageTime=_FsPingAverageTime_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,8),_FsPingAverageTime_Type())
...
fsPingMaxTime=_FsPingMaxTime_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,9),_FsPingMaxTime_Type())
...
fsPingMinTime=_FsPingMinTime_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,10),_FsPingMinTime_Type())
...
fsPingSuccesses=_FsPingSuccesses_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,11),_FsPingSuccesses_Type())
...
fsPingEntryStatus=_FsPingEntryStatus_Object((1,3,6,1,4,1,10876,101,1,106,1,1,1,12),_FsPingEntryStatus_Type())
fsPingEntryStatus.setMaxAccess(_D)
if mibBuilder.loadTexts:fsPingEntryStatus.setStatus(_A)
mibBuilder.exportSymbols(_E,**{'fsPingMIB':fsPingMIB,'fsPingMIBObjects':fsPingMIBObjects,'fsPingTable':fsPingTable,'fsPingEntry':fsPingEntry,_F:fsPingIndex,'fsPingDest':fsPingDest,'fsPingTimeout':fsPingTimeout,'fsPingTries':fsPingTries,'fsPingDataSize':fsPingDataSize,'fsPingStatus':fsPingStatus,'fsPingSendCount':fsPingSendCount,'fsPingAverageTime':fsPingAverageTime,'fsPingMaxTime':fsPingMaxTime,'fsPingMinTime':fsPingMinTime,'fsPingSuccesses':fsPingSuccesses,'fsPingEntryStatus':fsPingEntryStatus})