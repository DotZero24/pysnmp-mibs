...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-MIB
...
_RlMacro_ObjectIdentity = ObjectIdentity
rlMacro = _RlMacro_ObjectIdentity(
...
_RlAutoSmartportsMib_ObjectIdentity = ObjectIdentity
rlAutoSmartportsMib = _RlAutoSmartportsMib_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 150)
)
_RlPoeBt_ObjectIdentity = ObjectIdentity
rlPoeBt = _RlPoeBt_ObjectIdentity(
...
_RlCloudManager_ObjectIdentity = ObjectIdentity
rlCloudManager = _RlCloudManager_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 236)
)
_RlComponentMapper_ObjectIdentity = ObjectIdentity
rlComponentMapper = _RlComponentMapper_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 243)
)
_RlFwm_ObjectIdentity = ObjectIdentity
rlFwm = _RlFwm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 244)
)
_RlDyGsp_ObjectIdentity = ObjectIdentity
rlDyGsp = _RlDyGsp_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 245)
)
_RlBlth_ObjectIdentity = ObjectIdentity
rlBlth = _RlBlth_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 246)
)
_RlRadiusCoA_ObjectIdentity = ObjectIdentity
rlRadiusCoA = _RlRadiusCoA_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 247)
)
_RlOpc_ObjectIdentity = ObjectIdentity
rlOpc = _RlOpc_ObjectIdentity(
...
mibBuilder.exportSymbols(
    ...
    **{"Percents": Percents,
       ...
       "rlPNP": rlPNP,
       "rlFindit": rlFindit,
       "rlCloudManager": rlCloudManager,
       "rlComponentMapper": rlComponentMapper,
       "rlFwm": rlFwm,
       "rlDyGsp": rlDyGsp,
       "rlBlth": rlBlth,
       "rlRadiusCoA": rlRadiusCoA,
       "rlOpc": rlOpc,
