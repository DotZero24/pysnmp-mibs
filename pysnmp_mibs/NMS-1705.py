...
nms1705Objects=_Nms1705Objects_ObjectIdentity((1,3,6,1,4,1,3320,9,175,1))
_AdslLineTable_Object=MibTable
adslLineTable=_AdslLineTable_Object((1,3,6,1,4,1,3320,9,175,1,1))
if mibBuilder.loadTexts:adslLineTable.setStatus(_A)
_AdslLineEntry_Object=MibTableRow
adslLineEntry=_AdslLineEntry_Object((1,3,6,1,4,1,3320,9,175,1,1,1))
...
adslLineUser=_AdslLineUser_Object((1,3,6,1,4,1,3320,9,175,1,1,1,1),_AdslLineUser_Type())
...
adslProductID=_AdslProductID_Object((1,3,6,1,4,1,3320,9,175,1,1,1,2),_AdslProductID_Type())
...
adslConfigAddr=_AdslConfigAddr_Object((1,3,6,1,4,1,3320,9,175,1,1,1,3),_AdslConfigAddr_Type())
...
adslLineNumber=_AdslLineNumber_Object((1,3,6,1,4,1,3320,9,175,1,1,1,4),_AdslLineNumber_Type())
adslLineNumber.setMaxAccess(_B)
if mibBuilder.loadTexts:adslLineNumber.setStatus(_A)
_AdslPeriodTable_Object=MibTable
adslPeriodTable=_AdslPeriodTable_Object((1,3,6,1,4,1,3320,9,175,1,2))
if mibBuilder.loadTexts:adslPeriodTable.setStatus(_A)
_AdslPeriodEntry_Object=MibTableRow
adslPeriodEntry=_AdslPeriodEntry_Object((1,3,6,1,4,1,3320,9,175,1,2,1))
...
adslMemLoad=_AdslMemLoad_Object((1,3,6,1,4,1,3320,9,175,1,2,1,1),_AdslMemLoad_Type())
...
adslCPULoad=_AdslCPULoad_Object((1,3,6,1,4,1,3320,9,175,1,2,1,2),_AdslCPULoad_Type())
...
adslPtInCRC=_AdslPtInCRC_Object((1,3,6,1,4,1,3320,9,175,1,2,1,3),_AdslPtInCRC_Type())
...
adslPtStatus=_AdslPtStatus_Object((1,3,6,1,4,1,3320,9,175,1,2,1,4),_AdslPtStatus_Type())
...
adslPtSpeed=_AdslPtSpeed_Object((1,3,6,1,4,1,3320,9,175,1,2,1,5),_AdslPtSpeed_Type())
...
adslPtOutPkts=_AdslPtOutPkts_Object((1,3,6,1,4,1,3320,9,175,1,2,1,6),_AdslPtOutPkts_Type())
...
adslPtInPkts=_AdslPtInPkts_Object((1,3,6,1,4,1,3320,9,175,1,2,1,7),_AdslPtInPkts_Type())
...
adslPtOutError=_AdslPtOutError_Object((1,3,6,1,4,1,3320,9,175,1,2,1,8),_AdslPtOutError_Type())
...
adslPtInError=_AdslPtInError_Object((1,3,6,1,4,1,3320,9,175,1,2,1,9),_AdslPtInError_Type())
...
adslPtOutSpeed=_AdslPtOutSpeed_Object((1,3,6,1,4,1,3320,9,175,1,2,1,10),_AdslPtOutSpeed_Type())
...
adslPtInSpeed=_AdslPtInSpeed_Object((1,3,6,1,4,1,3320,9,175,1,2,1,11),_AdslPtInSpeed_Type())
...
adslPtOutDrop=_AdslPtOutDrop_Object((1,3,6,1,4,1,3320,9,175,1,2,1,12),_AdslPtOutDrop_Type())
...
adslPtInDrop=_AdslPtInDrop_Object((1,3,6,1,4,1,3320,9,175,1,2,1,13),_AdslPtInDrop_Type())
