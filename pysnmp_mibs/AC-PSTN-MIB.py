...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/mediant/AC-PSTN-MIB
...
if mibBuilder.loadTexts: acPSTN.setLastUpdated('201209241539Z')
...
acNFASGroupStatusTable = MibTable((1, 3, 6, 1, 4, 1, 5003, 9, 10, 9, 2, 5, 1), )
if mibBuilder.loadTexts: acNFASGroupStatusTable.setStatus('current')
acNFASGroupStatusEntry = MibTableRow((1, 3, 6, 1, 4, 1, 5003, 9, 10, 9, 2, 5, 1, 1), ).setIndexNames((0, "AC-PSTN-MIB", "acNFASGroupStatusIndex"))
if mibBuilder.loadTexts: acNFASGroupStatusEntry.setStatus('current')
acNFASGroupStatusIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 5003, 9, 10, 9, 2, 5, 1, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 12)))
...
mibBuilder.exportSymbols("AC-PSTN-MIB", acTrunkClockMaster=acTrunkClockMaster, acSonetSDHFbrGrpAPSWaitToRestoreTime=acSonetSDHFbrGrpAPSWaitToRestoreTime, acTrunkFramingMethod=acTrunkFramingMethod, acSonetSDHFbrGrpAPSDirectionMode=acSonetSDHFbrGrpAPSDirectionMode, acTrunkStatusV5LinkID=acTrunkStatusV5LinkID, acTrunkV5=acTrunkV5, acTrunkISDN=acTrunkISDN, acNFASGroupStatusActionResult=acNFASGroupStatusActionResult, acSDHKLMNumberingSchemeTU12OrVT15=acSDHKLMNumberingSchemeTU12OrVT15, acNFASGroupStatusGroupStatus=acNFASGroupStatusGroupStatus, acTrunkStatusLedStatusColor=acTrunkStatusLedStatusColor, acMiscISDNQ931RelayMode=acMiscISDNQ931RelayMode, acNFASGroupStatus=acNFASGroupStatus, acDS3ConfigClockSource=acDS3ConfigClockSource, acTrunkLineBuildOutLoss=acTrunkLineBuildOutLoss, acTrunkLineTable=acTrunkLineTable, acTrunkStatusEntry=acTrunkStatusEntry, acDS3ConfigFramingMethod=acDS3ConfigFramingMethod, acTrunkV5Entry=acTrunkV5Entry, acTrunkV5NumberOfCChannels=acTrunkV5NumberOfCChannels, acTrunkISDNCommonRestartBChannel=acTrunkISDNCommonRestartBChannel, acCASFileName=acCASFileName, acTrunkISDNCommonTable=acTrunkISDNCommonTable, acTrunkStatusAlarm=acTrunkStatusAlarm, acDigitalLegsEntry=acDigitalLegsEntry, acTrunkCAS=acTrunkCAS, acTrunkISDNNfasInterfaceId=acTrunkISDNNfasInterfaceId, acTrunkDeactivate=acTrunkDeactivate, acCASFileIndex=acCASFileIndex, acTrunkISDNDpnssBehavior=acTrunkISDNDpnssBehavior, acNFASGroupStatusBackupDChannelActivity=acNFASGroupStatusBackupDChannelActivity, acTrunkISDNCommonEntry=acTrunkISDNCommonEntry, acTrunkProtocolType=acTrunkProtocolType, acTrunkTable=acTrunkTable, acTrunkDialPlanName=acTrunkDialPlanName, acNFASGroupStatusIndex=acNFASGroupStatusIndex, acTrunkISDNDpnss=acTrunkISDNDpnss, acTrunkStatusChannels=acTrunkStatusChannels, acTrunkLineCode=acTrunkLineCode, acTrunkISDNNfas=acTrunkISDNNfas, acTrunkV5ProtocolSide=acTrunkV5ProtocolSide, acDigitalLegsInputGain=acDigitalLegsInputGain, acTrunkLineBuildOutOverwrite=acTrunkLineBuildOutOverwrite, acDigitalLegsEchoCanceller=acDigitalLegsEchoCanceller, acNFASGroupStatusPrimaryDChannelActivity=acNFASGroupStatusPrimaryDChannelActivity, acTrunkStatusTable=acTrunkStatusTable, acSonetSDHFbrGrpMappingType=acSonetSDHFbrGrpMappingType, acNFASGroupStatusEntry=acNFASGroupStatusEntry, acDigitalLegsDTMFDetection=acDigitalLegsDTMFDetection, acDigitalLegsVoiceVolume=acDigitalLegsVoiceVolume, acTrunkStatusLedStatusState=acTrunkStatusLedStatusState, acTrunkLineBuildOutXPM0=acTrunkLineBuildOutXPM0, acTrunkLineBuildOutXPM2=acTrunkLineBuildOutXPM2, acDigitalLegsTable=acDigitalLegsTable, acSDHKLMNumberingSchemeTUG2OrVTG=acSDHKLMNumberingSchemeTUG2OrVTG, acTrunkISDNCommonDuplicateQ931BuffMode=acTrunkISDNCommonDuplicateQ931BuffMode, acTrunkISDNDpnssNumVirtualChannels=acTrunkISDNDpnssNumVirtualChannels, acTrunkLineEntry=acTrunkLineEntry, acTrunkAdministrativeState=acTrunkAdministrativeState, acPSTN=acPSTN, acTrunkAutoClockPriority=acTrunkAutoClockPriority, acPSTNStatus=acPSTNStatus, acCasConfig=acCasConfig, acTrunkCASTablePerChannel=acTrunkCASTablePerChannel, acISDNConfig=acISDNConfig, acTrunkISDNNfasEntry=acTrunkISDNNfasEntry, acDigitalLegsLegName=acDigitalLegsLegName, acTrunkISDNNfasTable=acTrunkISDNNfasTable, acTrunkISDNDpnssEntry=acTrunkISDNDpnssEntry, acTrunkStatusV5InterfaceNum=acTrunkStatusV5InterfaceNum, acSonetSDHFbrGrpKlmNumberingScheme=acSonetSDHFbrGrpKlmNumberingScheme, acTrunkISDNCommonIncomingCallsBehavior=acTrunkISDNCommonIncomingCallsBehavior, acSDHKLMNumberingScheme=acSDHKLMNumberingScheme, acMiscISDN=acMiscISDN, acTrunkISDNCommonTerminationSide=acTrunkISDNCommonTerminationSide, acSonetSDH=acSonetSDH, acTrunkISDNCommonOutgoingCallsBehavior=acTrunkISDNCommonOutgoingCallsBehavior, acSDHKLMNumberingSchemeTUG3OrSTS1=acSDHKLMNumberingSchemeTUG3OrSTS1, acTrunkISDNCommonIuaInterfaceId=acTrunkISDNCommonIuaInterfaceId, acCasConfigEnable=acCasConfigEnable, acTrunkConfig=acTrunkConfig, acDigitalLegs=acDigitalLegs, acTrunkGlobalLifeLineType=acTrunkGlobalLifeLineType, acTrunkEntry=acTrunkEntry, acTrunkGlobalBChannelAlarms=acTrunkGlobalBChannelAlarms, acNFASGroupStatusAction=acNFASGroupStatusAction, acTrunkCASEntry=acTrunkCASEntry, acSDHKLMNumberingSchemeEntry=acSDHKLMNumberingSchemeEntry, acMiscISDNDuplicateQ931BuffMode=acMiscISDNDuplicateQ931BuffMode, acTrunkISDNCommonQ931LayerResponseBehavior=acTrunkISDNCommonQ931LayerResponseBehavior, acTrunkISDNCommonBRILayer2Mode=acTrunkISDNCommonBRILayer2Mode, acTrunkV5Table=acTrunkV5Table, acNFASGroupStatusTable=acNFASGroupStatusTable, acTrunkISDNCommonNSBehaviour2=acTrunkISDNCommonNSBehaviour2, acSDHKLMNumberingSchemeTrunkIndex=acSDHKLMNumberingSchemeTrunkIndex, acTrunkTraceLevel=acTrunkTraceLevel, acTrunkLineBuildOutXPM1=acTrunkLineBuildOutXPM1, acFiberGroupStatus=acFiberGroupStatus, acDigitalLegsBchannel=acDigitalLegsBchannel, acSonetSDHTable=acSonetSDHTable, acSonetSDHFbrGrpAPSRevertMode=acSonetSDHFbrGrpAPSRevertMode, acTrunkStatus=acTrunkStatus, acTrunkISDNCommon=acTrunkISDNCommon, acTrunkLoopbackConfig=acTrunkLoopbackConfig, acTrunkStatusDchannelActivity=acTrunkStatusDchannelActivity, acTrunkISDNCommonGeneralCCBehavior=acTrunkISDNCommonGeneralCCBehavior, acTrunkISDNDpnssTable=acTrunkISDNDpnssTable, acTrunkISDNNfasGroupNumber=acTrunkISDNNfasGroupNumber, acTrunkCASTable=acTrunkCASTable, acDS3ConfigLineBuiltOut=acDS3ConfigLineBuiltOut, acTrunkLineType=acTrunkLineType, acDigitalLegsLegIndex=acDigitalLegsLegIndex, acNFASGroupStatusBackupDChannel=acNFASGroupStatusBackupDChannel, acTrunk=acTrunk, acDigitalLegsTrunk=acDigitalLegsTrunk, acDS3Config=acDS3Config, acDigitalLegsDSPDevice=acDigitalLegsDSPDevice, acPSTNConfiguration=acPSTNConfiguration, acTrunkISDNNfasDchConfig=acTrunkISDNNfasDchConfig, acSonetSDHEntry=acSonetSDHEntry, acCASFile=acCASFile, PYSNMP_MODULE_ID=acPSTN, acDigitalLegsCallIndex=acDigitalLegsCallIndex, acSDHKLMNumberingSchemeTable=acSDHKLMNumberingSchemeTable, acDigitalLegsHighPassFilter=acDigitalLegsHighPassFilter, acTrunkISDNDpnssNumRealChannels=acTrunkISDNDpnssNumRealChannels, acCASFileEntry=acCASFileEntry, acTrunkIndex=acTrunkIndex, acSonetSDHIndex=acSonetSDHIndex, acNFASGroupStatusPrimaryDChannel=acNFASGroupStatusPrimaryDChannel, acTrunkLine=acTrunkLine, acCASFileTable=acCASFileTable, acTrunkStatusDChannel=acTrunkStatusDChannel, acTrunkGlobal=acTrunkGlobal, acTrunkCASTablesIndex=acTrunkCASTablesIndex, acFiberGroupStatusActiveLink=acFiberGroupStatusActiveLink)
