...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CFS-MIB
...
_CfsFeatureOpScopeType_Type.__name__ = "CiscoCFSScopeType"
...
ciscoCFSMIBCompliance.setObjects(
      *(("CISCO-CFS-MIB", "cfsFeatureOpGroup"),
        ("CISCO-CFS-MIB", "cfsPendingConfOwnerGroup"),
        ("CISCO-CFS-MIB", "cfsFeatureActionNotifGroup"),
        ("CISCO-CFS-MIB", "cfsFeatureNotifObjectsGroup"),
        ("CISCO-CFS-MIB", "cfsMergeFailNotifGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCFSMIBComplianceRev1.setObjects(
      *(("CISCO-CFS-MIB", "cfsFeatureOpGroupRev1"),
        ("CISCO-CFS-MIB", "cfsPendingConfOwnerGroup"),
        ("CISCO-CFS-MIB", "cfsFeatureActionNotifGroup"),
        ("CISCO-CFS-MIB", "cfsMembersGroup"),
        ("CISCO-CFS-MIB", "cfsPeerDiscoveryNotifGroup"),
        ("CISCO-CFS-MIB", "cfsFeatureOpExtGroup"),
        ("CISCO-CFS-MIB", "cfsFeatureNotifObjectsGroup"),
        ("CISCO-CFS-MIB", "cfsMergeFailNotifGroup"),
        ("CISCO-CFS-MIB", "cfsDistCtrlGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCFSMIBComplianceRev2.setObjects(
      *(("CISCO-CFS-MIB", "cfsFeatureOpGroupRev2"),
        ("CISCO-CFS-MIB", "cfsPendingConfOwnerGroup"),
        ("CISCO-CFS-MIB", "cfsFeatureActionNotifGroup"),
        ("CISCO-CFS-MIB", "cfsMembersGroup"),
        ("CISCO-CFS-MIB", "cfsPeerDiscoveryNotifGroup"),
        ...
        ("CISCO-CFS-MIB", "cfsMergeFailNotifGroup"),
        ("CISCO-CFS-MIB", "cfsDistCtrlGroup"),
        ("CISCO-CFS-MIB", "cfsDistCtrlInetGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCFSMIBComplianceRev3.setObjects(
      *(("CISCO-CFS-MIB", "cfsFeatureOpGroupRev2"),
        ("CISCO-CFS-MIB", "cfsPendingConfOwnerGroup"),
        ("CISCO-CFS-MIB", "cfsFeatureActionNotifGroup"),
        ("CISCO-CFS-MIB", "cfsMembersGroup"),
        ("CISCO-CFS-MIB", "cfsPeerDiscoveryNotifGroup"),
        ("CISCO-CFS-MIB", "cfsFeatureOpExtGroupRev1"),
        ("CISCO-CFS-MIB", "cfsFeatureNotifObjectsGroup"),
        ("CISCO-CFS-MIB", "cfsMergeFailNotifGroup"),
        ("CISCO-CFS-MIB", "cfsDistCtrlGroup"),
        ("CISCO-CFS-MIB", "cfsDistCtrlInetGroup"))
