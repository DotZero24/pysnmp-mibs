...
mibBuilder.exportSymbols("CISCO-CFS-MIB", cfsFeature=cfsFeature, cfsMergeStatusValue=cfsMergeStatusValue, cfsFeatureOpGroupRev1=cfsFeatureOpGroupRev1, cfsDistCtrl=cfsDistCtrl, ciscoCFSMIBComplianceRev2=ciscoCFSMIBComplianceRev2, cfsFeatureOpLastScopeVal=cfsFeatureOpLastScopeVal, cfsPeersTable=cfsPeersTable, cfsMergeStatusTable=cfsMergeStatusTable, ciscoCFSMIBComplianceRev3=ciscoCFSMIBComplianceRev3, cfsFeatureOpGroup=cfsFeatureOpGroup, cfsFeaturePeersScopeVal=cfsFeaturePeersScopeVal, cfsFeatureOpName=cfsFeatureOpName, cfsPeersEntry=cfsPeersEntry, cfsPendingConfOwnerIDType=cfsPendingConfOwnerIDType, cfsMergeMemberRole=cfsMergeMemberRole, cfsPendingConfOwnerTable=cfsPendingConfOwnerTable, cfsFeatureOpExtEntry=cfsFeatureOpExtEntry, cfsPendingConfOwnerAddrType=cfsPendingConfOwnerAddrType, cfsPeerDiscoveryNotifGroup=cfsPeerDiscoveryNotifGroup, cfsFeatureOpScopeType=cfsFeatureOpScopeType, cfsPeerAddr=cfsPeerAddr, cfsDistCtrlTable=cfsDistCtrlTable, cfsMergeFailNotifGroup=cfsMergeFailNotifGroup, cfsFeatureOpScopeVal=cfsFeatureOpScopeVal, cfsFeatureOpExtGroupRev1=cfsFeatureOpExtGroupRev1, cfsFeatureOpExtLastAction=cfsFeatureOpExtLastAction, CiscoCFSScopeType=CiscoCFSScopeType, cfsFeatureOpShowCfgOption=cfsFeatureOpShowCfgOption, cfsFeaturePeersEntry=cfsFeaturePeersEntry, cfsMergeMemberAddr=cfsMergeMemberAddr, ciscoCFSMIBObjects=ciscoCFSMIBObjects, cfsFeaturePeersTable=cfsFeaturePeersTable, ciscoCFSMergeFailNotif=ciscoCFSMergeFailNotif, ciscoCFSMIBConformance=ciscoCFSMIBConformance, cfsNotifObjects=cfsNotifObjects, ciscoCFSMIBGroups=ciscoCFSMIBGroups, cfsPeersDiscoveryResult=cfsPeersDiscoveryResult, cfsPeerAddrType=cfsPeerAddrType, cfsFeatureOpExtLastActionTime=cfsFeatureOpExtLastActionTime, cfsFeatureOpLastActionResult=cfsFeatureOpLastActionResult, cfsPendingConfOwnerAddr=cfsPendingConfOwnerAddr, cfsPendingConfOwnerGroup=cfsPendingConfOwnerGroup, cfsFeatureOpExtScopeVal=cfsFeatureOpExtScopeVal, cfsFeaturePeersScopeType=cfsFeaturePeersScopeType, cfsMergeStatusScopeVal=cfsMergeStatusScopeVal, cfsFeatureNotifObjectsGroup=cfsFeatureNotifObjectsGroup, cfsFeatureOpTable=cfsFeatureOpTable, cfsDistCtrlObjects=cfsDistCtrlObjects, cfsDistCtrlInetGroup=cfsDistCtrlInetGroup, ciscoCFSMIBCompliance=ciscoCFSMIBCompliance, ciscoCFSMIBNotifs=ciscoCFSMIBNotifs, cfsMergeStatusEntry=cfsMergeStatusEntry, cfsPendingConfOwnerScopeType=cfsPendingConfOwnerScopeType, cfsFeaturePeersAddr=cfsFeaturePeersAddr, ciscoCFSDiscoveryCompleteNotif=ciscoCFSDiscoveryCompleteNotif, ciscoCFSMIB=ciscoCFSMIB, cfsFeatureOpAction=cfsFeatureOpAction, cfsFeatureOpExtGroup=cfsFeatureOpExtGroup, cfsMergeStatusScopeType=cfsMergeStatusScopeType, cfsFeatureOpExtLastActionResult=cfsFeatureOpExtLastActionResult, cfsMergeFailFeatureName=cfsMergeFailFeatureName, cfsMergeMemberAddrType=cfsMergeMemberAddrType, ciscoCFSMIBCompliances=ciscoCFSMIBCompliances, cfsFeatureActionNotifGroup=cfsFeatureActionNotifGroup, cfsStartPeersDiscovery=cfsStartPeersDiscovery, cfsDistCtrlAddrType=cfsDistCtrlAddrType, cfsMergeFailScopeType=cfsMergeFailScopeType, cfsFeatureOpEntry=cfsFeatureOpEntry, cfsFeatureOpStatus=cfsFeatureOpStatus, cfsFeatureOpExtShowCfgOption=cfsFeatureOpExtShowCfgOption, cfsPendingConfOwnerScopeVal=cfsPendingConfOwnerScopeVal, cfsMergeMembersEntry=cfsMergeMembersEntry, cfsFeatureOpExtLastFailureReason=cfsFeatureOpExtLastFailureReason, cfsDistCtrlGroup=cfsDistCtrlGroup, cfsFeatureOpLastAction=cfsFeatureOpLastAction, ciscoCFSMIBComplianceRev1=ciscoCFSMIBComplianceRev1, ciscoCFSFeatureActionNotif=ciscoCFSFeatureActionNotif, cfsFeatureOpGroupRev2=cfsFeatureOpGroupRev2, cfsDistCtrlAddr=cfsDistCtrlAddr, CiscoCFSFeatureStatus=CiscoCFSFeatureStatus, cfsMembersGroup=cfsMembersGroup, cfsDistCtrlEntry=cfsDistCtrlEntry, cfsDistCtrlAction=cfsDistCtrlAction, PYSNMP_MODULE_ID=ciscoCFSMIB, CiscoCFSScopeValue=CiscoCFSScopeValue, cfsMergeMemberFabricType=cfsMergeMemberFabricType, cfsFeatureOpExtScopeType=cfsFeatureOpExtScopeType, cfsMergeFailReasonDescription=cfsMergeFailReasonDescription, cfsFeatureOpLastScopeType=cfsFeatureOpLastScopeType, cfsPendingConfOwnerEntry=cfsPendingConfOwnerEntry, cfsPendingConfOwnerID=cfsPendingConfOwnerID, cfsPeersDiscoveryFailureReason=cfsPeersDiscoveryFailureReason, cfsDiscoveryObjects=cfsDiscoveryObjects, cfsMergeFailScopeVal=cfsMergeFailScopeVal, cfsFeatureOpLastFailureReason=cfsFeatureOpLastFailureReason, cfsFeatureOpAttribs=cfsFeatureOpAttribs, cfsFeaturePeersAddrType=cfsFeaturePeersAddrType, CiscoCFSFeatureActionResult=CiscoCFSFeatureActionResult, cfsMergeMembersTable=cfsMergeMembersTable, CiscoCFSAction=CiscoCFSAction, cfsFeatureOpExtTable=cfsFeatureOpExtTable)
