# SNMP MIB module (Dell-EMBWEB-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-EMBWEB-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:08:24 2025
...
rlEmWebSecurityEntry.setIndexNames(
    (0, "Dell-EMBWEB-MIB", "rlEmWebSecurityUserName"),
)
if mibBuilder.loadTexts:
...
rlEmWebServiceEntry.setIndexNames(
    (0, "Dell-EMBWEB-MIB", "rlEmWebServiceId"),
)
if mibBuilder.loadTexts:
