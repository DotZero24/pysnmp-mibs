...
ModuleIdentity, Counter64, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Counter32, MibIdentifier, TimeTicks, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Counter32", "MibIdentifier", "TimeTicks", "Bits", "mib-2", "IpAddress")
DisplayString, TDomain, TimeStamp, RowStatus, AutonomousType, TAddress, PhysAddress, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TDomain", "TimeStamp", "RowStatus", "AutonomousType", "TAddress", "PhysAddress", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SL-ENTITY-MIB", slEntityNotification=slEntityNotification, slEntPhysicalSysUptime=slEntPhysicalSysUptime, slEntPhysicalProtectionEntity=slEntPhysicalProtectionEntity, slEntPhysicalSysTemp=slEntPhysicalSysTemp, slEntityPhysical=slEntityPhysical, slEntPhysicalHardwareRev=slEntPhysicalHardwareRev, slEntPhysicalSysSubType=slEntPhysicalSysSubType, slEntPhysicalDescr=slEntPhysicalDescr, slEntPhysicalPartNumber=slEntPhysicalPartNumber, slEntPhysicalSoftwareRev=slEntPhysicalSoftwareRev, slEntPhysicalOemSerialNum=slEntPhysicalOemSerialNum, slEntPhysicalProtectState=slEntPhysicalProtectState, slEntPhysicalOperStatus=slEntPhysicalOperStatus, slEntPhysicalTable=slEntPhysicalTable, slEntPhysicalFirmwareRev=slEntPhysicalFirmwareRev, slEntPhysicalProductionDate=slEntPhysicalProductionDate, slEntPhysicalSysAlias=slEntPhysicalSysAlias, PhysicalIndex=PhysicalIndex, slEntPhysicalClass=slEntPhysicalClass, PhysicalType=PhysicalType, CleiCode=CleiCode, slEntPhysicalType=slEntPhysicalType, slEntPhysicalStatus=slEntPhysicalStatus, slEntPhysicalProtectMode=slEntPhysicalProtectMode, slEntPhysicalEntry=slEntPhysicalEntry, PhysicalClass=PhysicalClass, slmEntity=slmEntity, slEntPhysicalAdminStatus=slEntPhysicalAdminStatus, slEntPhysicalCleiCode=slEntPhysicalCleiCode, PYSNMP_MODULE_ID=slmEntity, slEntPhysicalFailureDescription=slEntPhysicalFailureDescription, slEntPhysicalSerialNum=slEntPhysicalSerialNum, slEntPhysicalIndex=slEntPhysicalIndex)
