# SNMP MIB module (RADLAN-DHCPCL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-DHCPCL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:11:09 2025
...
rlDhcpClActionEntry.setIndexNames(
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpClActionIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpApprovalWaitingEntry.setIndexNames(
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpApprovalWaitingIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpApprovalActionEntry.setIndexNames(
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpApprovalActionIfIndex"),
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpApprovalActionAddress"),
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpApprovalActionMask"),
)
if mibBuilder.loadTexts:
...
rlDhcpClManualAutoConfigDataEntry = _RlDhcpClManualAutoConfigDataEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 76, 26, 1)
)
rlDhcpClManualAutoConfigDataEntry.setIndexNames(
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpClManualAutoConfigDataIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpClInformationEntry = _RlDhcpClInformationEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 76, 27, 1)
)
rlDhcpClInformationEntry.setIndexNames(
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpClInformationIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpClInformationDnsServerListEntry = _RlDhcpClInformationDnsServerListEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 76, 28, 1)
)
rlDhcpClInformationDnsServerListEntry.setIndexNames(
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpClInformationDnsServerListIfIndex"),
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpClInformationDnsServerListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpClInformationTftpServerListEntry = _RlDhcpClInformationTftpServerListEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 76, 29, 1)
)
rlDhcpClInformationTftpServerListEntry.setIndexNames(
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpClInformationTftpServerListIfIndex"),
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpClInformationTftpServerListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpClEnabledByDefaultRemovedEntry = _RlDhcpClEnabledByDefaultRemovedEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 76, 32, 1)
)
rlDhcpClEnabledByDefaultRemovedEntry.setIndexNames(
    (0, "RADLAN-DHCPCL-MIB", "rlDhcpClEnabledByDefaultRemovedIfIndex"),
)
if mibBuilder.loadTexts:
