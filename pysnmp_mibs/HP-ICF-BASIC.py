...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-BASIC
...
_HpicfTrapDestTimeout_Type.__name__ = "TimeInterval"
...
_HpicfBasicAlarmStorageType_Type.__name__ = "StorageType"
...
_HpicfBasicEventStorageType_Type.__name__ = "StorageType"
...
_HpicfInetDNSNameServerEntryIsOobm_Type.__name__ = "TruthValue"
...
class _HpicfSwitchSnmpEnabledTrapEventList_Type(OctetString):
    """Custom type hpicfSwitchSnmpEnabledTrapEventList based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_HpicfSwitchSnmpEnabledTrapEventList_Type.__name__ = "OctetString"
_HpicfSwitchSnmpEnabledTrapEventList_Object = MibScalar
hpicfSwitchSnmpEnabledTrapEventList = _HpicfSwitchSnmpEnabledTrapEventList_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 4, 18, 5),
    _HpicfSwitchSnmpEnabledTrapEventList_Type()
)
hpicfSwitchSnmpEnabledTrapEventList.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfSwitchSnmpEnabledTrapEventList.setStatus("current")
...
_HpicfDisplayLogNumbers_Type.__name__ = "TruthValue"
...
class _HpicfIncludeCredClearPassKey_Type(Integer32):
    """Custom type hpicfIncludeCredClearPassKey based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_HpicfIncludeCredClearPassKey_Type.__name__ = "Integer32"
_HpicfIncludeCredClearPassKey_Object = MibScalar
hpicfIncludeCredClearPassKey = _HpicfIncludeCredClearPassKey_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 4, 19, 3),
    _HpicfIncludeCredClearPassKey_Type()
)
hpicfIncludeCredClearPassKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfIncludeCredClearPassKey.setStatus("current")
...
_HpicfperIploggingurlTable_Object = MibTable
hpicfperIploggingurlTable = _HpicfperIploggingurlTable_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 4, 23, 5)
)
if mibBuilder.loadTexts:
    hpicfperIploggingurlTable.setStatus("current")
_HpicfperIploggingurlEntry_Object = MibTableRow
hpicfperIploggingurlEntry = _HpicfperIploggingurlEntry_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 4, 23, 5, 1)
)
hpicfperIploggingurlEntry.setIndexNames(
    (0, "HP-ICF-BASIC", "hpicfperIploggingurlIndex"),
)
if mibBuilder.loadTexts:
    hpicfperIploggingurlEntry.setStatus("current")
_HpicfperIploggingurlIndex_Type = Unsigned32
_HpicfperIploggingurlIndex_Object = MibTableColumn
hpicfperIploggingurlIndex = _HpicfperIploggingurlIndex_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 4, 23, 5, 1, 1),
    _HpicfperIploggingurlIndex_Type()
)
hpicfperIploggingurlIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hpicfperIploggingurlIndex.setStatus("current")


class _HpicfperIploggingurlUrl_Type(OctetString):
    """Custom type hpicfperIploggingurlUrl based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_HpicfperIploggingurlUrl_Type.__name__ = "OctetString"
_HpicfperIploggingurlUrl_Object = MibTableColumn
hpicfperIploggingurlUrl = _HpicfperIploggingurlUrl_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 4, 23, 5, 1, 2),
    _HpicfperIploggingurlUrl_Type()
)
hpicfperIploggingurlUrl.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfperIploggingurlUrl.setStatus("current")
_HpicfperIploggingurlFilterName_Type = SnmpAdminString
_HpicfperIploggingurlFilterName_Object = MibTableColumn
hpicfperIploggingurlFilterName = _HpicfperIploggingurlFilterName_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 4, 23, 5, 1, 3),
    _HpicfperIploggingurlFilterName_Type()
)
hpicfperIploggingurlFilterName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpicfperIploggingurlFilterName.setStatus("current")
_HpicfperIploggingurlRowStatus_Type = RowStatus
_HpicfperIploggingurlRowStatus_Object = MibTableColumn
hpicfperIploggingurlRowStatus = _HpicfperIploggingurlRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 4, 23, 5, 1, 4),
    _HpicfperIploggingurlRowStatus_Type()
)
hpicfperIploggingurlRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpicfperIploggingurlRowStatus.setStatus("current")
...
if mibBuilder.loadTexts:
    hpicfBasicConfigGroup.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    hpicfSNMPConfigGroup1.setStatus("deprecated")
...
hpicfLoggingURLGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 10, 2, 5, 1, 2, 37)
)
hpicfLoggingURLGroup.setObjects(
      *(("HP-ICF-BASIC", "hpicfperIploggingurlUrl"),
        ("HP-ICF-BASIC", "hpicfperIploggingurlFilterName"),
        ("HP-ICF-BASIC", "hpicfperIploggingurlRowStatus"))
)
if mibBuilder.loadTexts:
    hpicfLoggingURLGroup.setStatus("current")

hpicfBasicConfigGroup1 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 10, 2, 5, 1, 2, 38)
)
hpicfBasicConfigGroup1.setObjects(
      *(("HP-ICF-BASIC", "hpicfDisplayLogNumbers"),
        ("HP-ICF-BASIC", "hpicfIncludeCredentials"),
        ("HP-ICF-BASIC", "hpicfIncludeCredClearPassKey"))
)
if mibBuilder.loadTexts:
    hpicfBasicConfigGroup1.setStatus("current")

hpicfSNMPConfigGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 10, 2, 5, 1, 2, 39)
)
hpicfSNMPConfigGroup2.setObjects(
      *(("HP-ICF-BASIC", "hpicfSnmpV2Enable"),
        ("HP-ICF-BASIC", "hpSwitchSnmpViewConfig"),
        ("HP-ICF-BASIC", "hpicfSwitchSnmpAllowUnsecuredAccessToMACsec"),
        ("HP-ICF-BASIC", "hpicfSwitchSnmpAllowUnsecuredAccessToIeee8021Secy"),
        ("HP-ICF-BASIC", "hpicfSwitchSnmpEnabledTrapEventList"))
)
if mibBuilder.loadTexts:
    hpicfSNMPConfigGroup2.setStatus("current")
...
hpicfBasicCompliance.setObjects(
      *(("HP-ICF-BASIC", "hpicfBasicGroup"),
        ("HP-ICF-BASIC", "hpicfTelnetGroup"))
)
if mibBuilder.loadTexts:
...
hpicfNewBasicCompliance.setObjects(
      *(("HP-ICF-BASIC", "hpicfNewBasicGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpConfigGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpxConfigGroup"),
        ("HP-ICF-BASIC", "hpicfBasicFixedTrapGroup"),
        ("HP-ICF-BASIC", "hpicfBasicTrapDestGroup"),
        ("HP-ICF-BASIC", "hpicfBasicRmonNVGroup"),
        ("HP-ICF-BASIC", "hpicfBasicSelfTestNotifyGroup"),
        ("HP-ICF-BASIC", "hpicfDiscoverGroup"))
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance3.setObjects(
      *(("HP-ICF-BASIC", "hpicfNewBasicGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpConfigGroup2"),
        ("HP-ICF-BASIC", "hpicfBasicFixedTrapGroup"),
        ("HP-ICF-BASIC", "hpicfBasicTrapDestGroup"),
        ("HP-ICF-BASIC", "hpicfBasicSelfTestNotifyGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpxConfigGroup"),
        ("HP-ICF-BASIC", "hpicfAnnounceDiscoveryGroup"),
        ("HP-ICF-BASIC", "hpicfBasicRmonNVGroup"))
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance4.setObjects(
      *(("HP-ICF-BASIC", "hpicfNewBasicGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpConfigGroup2"),
        ("HP-ICF-BASIC", "hpicfBasicFixedTrapGroup"),
        ("HP-ICF-BASIC", "hpicfBasicSelfTestNotifyGroup"),
        ...
        ("HP-ICF-BASIC", "hpicfAnnounceDiscoveryGroup"),
        ("HP-ICF-BASIC", "hpicfBasicRmonNVGroup"),
        ("HP-ICF-BASIC", "hpicfSnmpTargetAddrLogFilterGroup"))
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance5.setObjects(
      *(("HP-ICF-BASIC", "hpicfNewBasicGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpConfigGroup3"),
        ("HP-ICF-BASIC", "hpicfBasicFixedTrapGroup"),
        ("HP-ICF-BASIC", "hpicfBasicSelfTestNotifyGroup"),
        ("HP-ICF-BASIC", "hpicfBasicBannerGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpxConfigGroup"),
        ("HP-ICF-BASIC", "hpicfAnnounceDiscoveryGroup"),
        ("HP-ICF-BASIC", "hpicfBasicRmonNVGroup"),
        ("HP-ICF-BASIC", "hpicfSnmpTargetAddrLogFilterGroup"))
...
hpicfBasicCompliance6.setObjects(
      *(("HP-ICF-BASIC", "hpicfNewBasicGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpConfigGroup3"),
        ("HP-ICF-BASIC", "hpicfBasicFixedTrapGroup"),
        ("HP-ICF-BASIC", "hpicfBasicSelfTestNotifyGroup"),
        ...
        ("HP-ICF-BASIC", "hpicfBasicRmonNVGroup"),
        ("HP-ICF-BASIC", "hpicfSnmpTargetAddrLogFilterGroup"),
        ("HP-ICF-BASIC", "hpicfBasicDNSConfigGroup2"))
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance7.setObjects(
      *(("HP-ICF-BASIC", "hpicfBasicGroup1"),
        ("HP-ICF-BASIC", "hpicfBasicIpConfigGroup3"),
        ("HP-ICF-BASIC", "hpicfBasicFixedTrapGroup"),
        ("HP-ICF-BASIC", "hpicfBasicSelfTestNotifyGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpxConfigGroup"),
        ...
        ("HP-ICF-BASIC", "hpicfBasicRmonNVGroup"),
        ("HP-ICF-BASIC", "hpicfSnmpTargetAddrLogFilterGroup"),
        ("HP-ICF-BASIC", "hpicfBasicDNSConfigGroup"))
)
if mibBuilder.loadTexts:
...
hpicfBasicSNMPConfigCompliance.setObjects(
    ("HP-ICF-BASIC", "hpicfSNMPConfigGroup")
)
if mibBuilder.loadTexts:
...
hpicfBasicConfigCompliance.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicConfigGroup")
)
if mibBuilder.loadTexts:
...
hpicfBasicComplianceOobm.setObjects(
    ("HP-ICF-BASIC", "hpicfInetDNSNameServerOobmGroup")
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance8.setObjects(
      *(("HP-ICF-BASIC", "hpicfBasicObjectsGroup"),
        ("HP-ICF-BASIC", "hpicfBasicWebAgentGroup"),
        ("HP-ICF-BASIC", "hpicfBasicProxyArpGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpSecondaryGroup"),
        ("HP-ICF-BASIC", "hpicfBasicObjectsGroup1"))
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance9.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicDNSGroup1")
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance10.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicDNSConfigGroup1")
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance11.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicDNSGroup2")
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance12.setObjects(
      *(("HP-ICF-BASIC", "hpicfBasicObjectsGroup1"),
        ("HP-ICF-BASIC", "hpicfBasicWebAgentGroup"),
        ("HP-ICF-BASIC", "hpicfBasicProxyArpGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpSecondaryGroup"))
...
hpicfBasicLogFilterConfigCompliance.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicLogFilterConfigGroup")
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance13.setObjects(
      *(("HP-ICF-BASIC", "hpicfBasicObjectsGroup1"),
        ("HP-ICF-BASIC", "hpicfBasicProxyArpGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpSecondaryGroup"),
        ("HP-ICF-BASIC", "hpicfBasicWebAgentGroup1"))
)
if mibBuilder.loadTexts:
...
hpicfBasicSNMPConfigCompliance1.setObjects(
    ("HP-ICF-BASIC", "hpicfSNMPConfigGroup1")
)
if mibBuilder.loadTexts:
...
hpicfBasicCompliance19.setObjects(
      *(("HP-ICF-BASIC", "hpicfBasicObjectsGroup1"),
        ("HP-ICF-BASIC", "hpicfBasicProxyArpGroup"),
        ("HP-ICF-BASIC", "hpicfBasicIpSecondaryGroup"))
)
...
hpicfBasicLogFilterConfigCompliance2.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicLogFilterConfigGroup2")
)
if mibBuilder.loadTexts:
...
hpicfBasicWebAgentCompliance1.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicWebAgentGroup2")
)
if mibBuilder.loadTexts:
...
hpicfBasicCurDNSNameServerCompliance1.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicCurDNSNameServerGroup1")
)
if mibBuilder.loadTexts:
...
hpicfBasicLogFilterConfigCompliance3.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicLogFilterConfigGroup3")
)
if mibBuilder.loadTexts:
...
hpicfLoggingURLCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 10, 2, 5, 1, 1, 24)
)
hpicfLoggingURLCompliance.setObjects(
    ("HP-ICF-BASIC", "hpicfLoggingURLGroup")
)
if mibBuilder.loadTexts:
    hpicfLoggingURLCompliance.setStatus(
        "current"
    )

hpicfBasicConfigCompliance1 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 10, 2, 5, 1, 1, 25)
)
hpicfBasicConfigCompliance1.setObjects(
    ("HP-ICF-BASIC", "hpicfBasicConfigGroup1")
)
if mibBuilder.loadTexts:
    hpicfBasicConfigCompliance1.setStatus(
        "current"
    )

hpicfBasicSNMPConfigCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 10, 2, 5, 1, 1, 26)
)
hpicfBasicSNMPConfigCompliance2.setObjects(
    ("HP-ICF-BASIC", "hpicfSNMPConfigGroup2")
)
if mibBuilder.loadTexts:
    hpicfBasicSNMPConfigCompliance2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpicfBasicMib": hpicfBasicMib,
       ...
       "hpicfLoggingURLCompliance": hpicfLoggingURLCompliance,
       "hpicfBasicConfigCompliance1": hpicfBasicConfigCompliance1,
       "hpicfBasicSNMPConfigCompliance2": hpicfBasicSNMPConfigCompliance2,
       ...
       "hpicfLoggingURLGroup": hpicfLoggingURLGroup,
       "hpicfBasicConfigGroup1": hpicfBasicConfigGroup1,
       ...
       "hpicfSwitchSnmpEnabledTrapEventList": hpicfSwitchSnmpEnabledTrapEventList,
       ...
       "hpicfIncludeCredClearPassKey": hpicfIncludeCredClearPassKey,
       ...
       "hpicfperIploggingurlTable": hpicfperIploggingurlTable,
       "hpicfperIploggingurlEntry": hpicfperIploggingurlEntry,
       "hpicfperIploggingurlIndex": hpicfperIploggingurlIndex,
       "hpicfperIploggingurlUrl": hpicfperIploggingurlUrl,
       "hpicfperIploggingurlFilterName": hpicfperIploggingurlFilterName,
       "hpicfperIploggingurlRowStatus": hpicfperIploggingurlRowStatus,
