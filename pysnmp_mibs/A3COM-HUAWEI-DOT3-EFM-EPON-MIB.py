...
_D='frames'
_C='read-only'
_B='A3COM-HUAWEI-DOT3-EFM-EPON-MIB'
_A='current'
...
h3cDot3MpcpMIB=_H3cDot3MpcpMIB_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,1))
_H3cDot3MpcpObjects_ObjectIdentity=ObjectIdentity
h3cDot3MpcpObjects=_H3cDot3MpcpObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1))
_H3cDot3MpcpTable_Object=MibTable
h3cDot3MpcpTable=_H3cDot3MpcpTable_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1))
if mibBuilder.loadTexts:h3cDot3MpcpTable.setStatus(_A)
_H3cDot3MpcpEntry_Object=MibTableRow
h3cDot3MpcpEntry=_H3cDot3MpcpEntry_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1))
...
h3cDot3MpcpID=_H3cDot3MpcpID_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,1),_H3cDot3MpcpID_Type())
...
h3cDot3MpcpOperStatus=_H3cDot3MpcpOperStatus_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,2),_H3cDot3MpcpOperStatus_Type())
...
h3cDot3MpcpMode=_H3cDot3MpcpMode_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,3),_H3cDot3MpcpMode_Type())
...
h3cDot3MpcpLinkID=_H3cDot3MpcpLinkID_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,4),_H3cDot3MpcpLinkID_Type())
...
h3cDot3MpcpRemoteMACAddress=_H3cDot3MpcpRemoteMACAddress_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,5),_H3cDot3MpcpRemoteMACAddress_Type())
...
h3cDot3MpcpRegistrationState=_H3cDot3MpcpRegistrationState_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,6),_H3cDot3MpcpRegistrationState_Type())
...
h3cDot3MpcpTransmitElapsed=_H3cDot3MpcpTransmitElapsed_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,7),_H3cDot3MpcpTransmitElapsed_Type())
...
h3cDot3MpcpReceiveElapsed=_H3cDot3MpcpReceiveElapsed_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,8),_H3cDot3MpcpReceiveElapsed_Type())
...
h3cDot3MpcpRoundTripTime=_H3cDot3MpcpRoundTripTime_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,9),_H3cDot3MpcpRoundTripTime_Type())
...
h3cDot3MpcpMaximumPendingGrants=_H3cDot3MpcpMaximumPendingGrants_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,10),_H3cDot3MpcpMaximumPendingGrants_Type())
...
h3cDot3MpcpAdminState=_H3cDot3MpcpAdminState_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,11),_H3cDot3MpcpAdminState_Type())
...
h3cDot3MpcpOnTime=_H3cDot3MpcpOnTime_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,12),_H3cDot3MpcpOnTime_Type())
...
h3cDot3MpcpOffTime=_H3cDot3MpcpOffTime_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,13),_H3cDot3MpcpOffTime_Type())
...
h3cDot3MpcpSyncTime=_H3cDot3MpcpSyncTime_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,1,1,14),_H3cDot3MpcpSyncTime_Type())
...
h3cDot3MpcpStatTable=_H3cDot3MpcpStatTable_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2))
if mibBuilder.loadTexts:h3cDot3MpcpStatTable.setStatus(_A)
_H3cDot3MpcpStatEntry_Object=MibTableRow
h3cDot3MpcpStatEntry=_H3cDot3MpcpStatEntry_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1))
...
h3cDot3MpcpMACCtrlFramesTransmitted=_H3cDot3MpcpMACCtrlFramesTransmitted_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,1),_H3cDot3MpcpMACCtrlFramesTransmitted_Type())
...
h3cDot3MpcpMACCtrlFramesReceived=_H3cDot3MpcpMACCtrlFramesReceived_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,2),_H3cDot3MpcpMACCtrlFramesReceived_Type())
...
h3cDot3MpcpDiscoveryWindowsSent=_H3cDot3MpcpDiscoveryWindowsSent_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,3),_H3cDot3MpcpDiscoveryWindowsSent_Type())
...
h3cDot3MpcpDiscoveryTimeout=_H3cDot3MpcpDiscoveryTimeout_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,4),_H3cDot3MpcpDiscoveryTimeout_Type())
...
h3cDot3MpcpTxRegRequest=_H3cDot3MpcpTxRegRequest_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,5),_H3cDot3MpcpTxRegRequest_Type())
...
h3cDot3MpcpRxRegRequest=_H3cDot3MpcpRxRegRequest_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,6),_H3cDot3MpcpRxRegRequest_Type())
...
h3cDot3MpcpTxRegAck=_H3cDot3MpcpTxRegAck_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,7),_H3cDot3MpcpTxRegAck_Type())
...
h3cDot3MpcpRxRegAck=_H3cDot3MpcpRxRegAck_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,8),_H3cDot3MpcpRxRegAck_Type())
...
h3cDot3MpcpTxReport=_H3cDot3MpcpTxReport_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,9),_H3cDot3MpcpTxReport_Type())
...
h3cDot3MpcpRxReport=_H3cDot3MpcpRxReport_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,10),_H3cDot3MpcpRxReport_Type())
...
h3cDot3MpcpTxGate=_H3cDot3MpcpTxGate_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,11),_H3cDot3MpcpTxGate_Type())
...
h3cDot3MpcpRxGate=_H3cDot3MpcpRxGate_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,12),_H3cDot3MpcpRxGate_Type())
...
h3cDot3MpcpTxRegister=_H3cDot3MpcpTxRegister_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,13),_H3cDot3MpcpTxRegister_Type())
...
h3cDot3MpcpRxRegister=_H3cDot3MpcpRxRegister_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,14),_H3cDot3MpcpRxRegister_Type())
...
h3cDot3MpcpRxNotSupportedMPCP=_H3cDot3MpcpRxNotSupportedMPCP_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,1,1,2,1,15),_H3cDot3MpcpRxNotSupportedMPCP_Type())
...
h3cDot3MpcpConformance=_H3cDot3MpcpConformance_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,1,2))
_H3cDot3MpcpGroups_ObjectIdentity=ObjectIdentity
h3cDot3MpcpGroups=_H3cDot3MpcpGroups_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,1,2,1))
_H3cDot3MpcpCompliances_ObjectIdentity=ObjectIdentity
h3cDot3MpcpCompliances=_H3cDot3MpcpCompliances_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,1,2,2))
_H3cDot3OmpEmulationMIB_ObjectIdentity=ObjectIdentity
h3cDot3OmpEmulationMIB=_H3cDot3OmpEmulationMIB_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,2))
_H3cDot3OmpEmulationObjects_ObjectIdentity=ObjectIdentity
h3cDot3OmpEmulationObjects=_H3cDot3OmpEmulationObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1))
_H3cDot3OmpEmulationTable_Object=MibTable
h3cDot3OmpEmulationTable=_H3cDot3OmpEmulationTable_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,1))
if mibBuilder.loadTexts:h3cDot3OmpEmulationTable.setStatus(_A)
_H3cDot3OmpEmulationEntry_Object=MibTableRow
h3cDot3OmpEmulationEntry=_H3cDot3OmpEmulationEntry_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,1,1))
...
h3cDot3OmpEmulationID=_H3cDot3OmpEmulationID_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,1,1,1),_H3cDot3OmpEmulationID_Type())
...
h3cDot3OmpEmulationType=_H3cDot3OmpEmulationType_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,1,1,2),_H3cDot3OmpEmulationType_Type())
...
h3cDot3OmpEmulationStatTable=_H3cDot3OmpEmulationStatTable_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2))
if mibBuilder.loadTexts:h3cDot3OmpEmulationStatTable.setStatus(_A)
_H3cDot3OmpEmulationStatEntry_Object=MibTableRow
h3cDot3OmpEmulationStatEntry=_H3cDot3OmpEmulationStatEntry_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1))
...
h3cDot3OmpEmulationSLDErrors=_H3cDot3OmpEmulationSLDErrors_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,1),_H3cDot3OmpEmulationSLDErrors_Type())
...
h3cDot3OmpEmulationCRC8Errors=_H3cDot3OmpEmulationCRC8Errors_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,2),_H3cDot3OmpEmulationCRC8Errors_Type())
...
h3cDot3OmpEmulationBadLLID=_H3cDot3OmpEmulationBadLLID_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,3),_H3cDot3OmpEmulationBadLLID_Type())
...
h3cDot3OmpEmulationGoodLLID=_H3cDot3OmpEmulationGoodLLID_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,4),_H3cDot3OmpEmulationGoodLLID_Type())
...
h3cDot3OmpEmulationOnuPonCastLLID=_H3cDot3OmpEmulationOnuPonCastLLID_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,5),_H3cDot3OmpEmulationOnuPonCastLLID_Type())
...
h3cDot3OmpEmulationOltPonCastLLID=_H3cDot3OmpEmulationOltPonCastLLID_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,6),_H3cDot3OmpEmulationOltPonCastLLID_Type())
...
h3cDot3OmpEmulationBroadcastLLIDNotOnuID=_H3cDot3OmpEmulationBroadcastLLIDNotOnuID_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,7),_H3cDot3OmpEmulationBroadcastLLIDNotOnuID_Type())
...
h3cDot3OmpEmulationOnuLLIDNotBroadcast=_H3cDot3OmpEmulationOnuLLIDNotBroadcast_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,8),_H3cDot3OmpEmulationOnuLLIDNotBroadcast_Type())
...
h3cDot3OmpEmulationBroadcastLLIDPlusOnuId=_H3cDot3OmpEmulationBroadcastLLIDPlusOnuId_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,9),_H3cDot3OmpEmulationBroadcastLLIDPlusOnuId_Type())
...
h3cDot3OmpEmulationNotBroadcastLLIDNotOnuId=_H3cDot3OmpEmulationNotBroadcastLLIDNotOnuId_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,2,1,2,1,10),_H3cDot3OmpEmulationNotBroadcastLLIDNotOnuId_Type())
...
h3cDot3OmpeConformance=_H3cDot3OmpeConformance_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,2,2))
_H3cDot3OmpeGroups_ObjectIdentity=ObjectIdentity
h3cDot3OmpeGroups=_H3cDot3OmpeGroups_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,2,2,1))
_H3cDot3OmpeCompliances_ObjectIdentity=ObjectIdentity
h3cDot3OmpeCompliances=_H3cDot3OmpeCompliances_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,2,2,2))
_H3cDot3EponMauMIB_ObjectIdentity=ObjectIdentity
h3cDot3EponMauMIB=_H3cDot3EponMauMIB_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3))
_H3cDot3EponMauObjects_ObjectIdentity=ObjectIdentity
h3cDot3EponMauObjects=_H3cDot3EponMauObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,1))
_H3cDot3EponMauTable_Object=MibTable
h3cDot3EponMauTable=_H3cDot3EponMauTable_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,3,1,1))
if mibBuilder.loadTexts:h3cDot3EponMauTable.setStatus(_A)
_H3cDot3EponMauEntry_Object=MibTableRow
h3cDot3EponMauEntry=_H3cDot3EponMauEntry_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,3,1,1,1))
...
h3cDot3EponMauPCSCodingViolation=_H3cDot3EponMauPCSCodingViolation_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,3,1,1,1,1),_H3cDot3EponMauPCSCodingViolation_Type())
...
h3cDot3EponMauFecAbility=_H3cDot3EponMauFecAbility_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,3,1,1,1,2),_H3cDot3EponMauFecAbility_Type())
...
h3cDot3EponMauFecMode=_H3cDot3EponMauFecMode_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,3,1,1,1,3),_H3cDot3EponMauFecMode_Type())
...
h3cDot3EponMauFECCorrectedBlocks=_H3cDot3EponMauFECCorrectedBlocks_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,3,1,1,1,4),_H3cDot3EponMauFECCorrectedBlocks_Type())
...
h3cDot3EponMauFECUncorrectableBlocks=_H3cDot3EponMauFECUncorrectableBlocks_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,3,1,1,1,5),_H3cDot3EponMauFECUncorrectableBlocks_Type())
...
h3cDot3EponMauBufferHeadCodingViolation=_H3cDot3EponMauBufferHeadCodingViolation_Object((1,3,6,1,4,1,43,45,1,10,2,42,2,3,1,1,1,6),_H3cDot3EponMauBufferHeadCodingViolation_Type())
...
h3cDot3EponMauConformance=_H3cDot3EponMauConformance_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,2))
_H3cDot3EponMauGroups_ObjectIdentity=ObjectIdentity
h3cDot3EponMauGroups=_H3cDot3EponMauGroups_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,2,1))
_H3cDot3EponMauCompliances_ObjectIdentity=ObjectIdentity
h3cDot3EponMauCompliances=_H3cDot3EponMauCompliances_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,2,2))
_H3cDot3EponMauType_ObjectIdentity=ObjectIdentity
h3cDot3EponMauType=_H3cDot3EponMauType_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3))
_H3cEponMauType1000BasePXOLT_ObjectIdentity=ObjectIdentity
h3cEponMauType1000BasePXOLT=_H3cEponMauType1000BasePXOLT_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,1))
...
h3cEponMauType1000BasePXONU=_H3cEponMauType1000BasePXONU_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,2))
...
h3cEponMauType1000BasePX10DOLT=_H3cEponMauType1000BasePX10DOLT_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,3))
...
h3cEponMauType1000BasePX10DONU=_H3cEponMauType1000BasePX10DONU_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,4))
...
h3cEponMauType1000BasePX10UOLT=_H3cEponMauType1000BasePX10UOLT_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,5))
...
h3cEponMauType1000BasePX10UONU=_H3cEponMauType1000BasePX10UONU_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,6))
...
h3cEponMauType1000BasePX20DOLT=_H3cEponMauType1000BasePX20DOLT_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,7))
...
h3cEponMauType1000BasePX20DONU=_H3cEponMauType1000BasePX20DONU_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,8))
...
h3cEponMauType1000BasePX20UOLT=_H3cEponMauType1000BasePX20UOLT_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,9))
...
h3cEponMauType1000BasePX20UONU=_H3cEponMauType1000BasePX20UONU_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,42,2,3,3,10))
if mibBuilder.loadTexts:h3cEponMauType1000BasePX20UONU.setStatus(_A)
h3cDot3MpcpGroupBase=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,42,2,1,2,1,1))
...
h3cDot3MpcpGroupParam=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,42,2,1,2,1,2))
...
h3cDot3MpcpGroupStat=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,42,2,1,2,1,3))
...
h3cDot3OmpeGroupID=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,42,2,2,2,1,1))
h3cDot3OmpeGroupID.setObjects(*((_B,_p),(_B,_q)))
if mibBuilder.loadTexts:h3cDot3OmpeGroupID.setStatus(_A)
h3cDot3OmpeGroupStat=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,42,2,2,2,1,2))
...
h3cDot3EponMauGroupAll=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,42,2,3,2,1,1))
h3cDot3EponMauGroupAll.setObjects((_B,_A1))
if mibBuilder.loadTexts:h3cDot3EponMauGroupAll.setStatus(_A)
h3cDot3EponMauGroupFEC=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,42,2,3,2,1,2))
...
h3cDot3MpcpCompliance=ModuleCompliance((1,3,6,1,4,1,43,45,1,10,2,42,2,1,2,2,1))
h3cDot3MpcpCompliance.setObjects(*((_B,_A7),(_B,_A8),(_B,_A9)))
if mibBuilder.loadTexts:h3cDot3MpcpCompliance.setStatus(_A)
h3cDot3OmpeCompliance=ModuleCompliance((1,3,6,1,4,1,43,45,1,10,2,42,2,2,2,2,1))
h3cDot3OmpeCompliance.setObjects(*((_B,_AA),(_B,_AB)))
if mibBuilder.loadTexts:h3cDot3OmpeCompliance.setStatus(_A)
h3cDot3EponMauCompliance=ModuleCompliance((1,3,6,1,4,1,43,45,1,10,2,42,2,3,2,2,1))
