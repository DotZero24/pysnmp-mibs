...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-DOT3-EFM-EPON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:30 2025
...
h3cDot3MpcpCompliance.setObjects(
      *(("A3COM-HUAWEI-DOT3-EFM-EPON-MIB", "h3cDot3MpcpGroupBase"),
        ("A3COM-HUAWEI-DOT3-EFM-EPON-MIB", "h3cDot3MpcpGroupParam"),
        ("A3COM-HUAWEI-DOT3-EFM-EPON-MIB", "h3cDot3MpcpGroupStat"))
)
if mibBuilder.loadTexts:
...
h3cDot3OmpeCompliance.setObjects(
      *(("A3COM-HUAWEI-DOT3-EFM-EPON-MIB", "h3cDot3OmpeGroupID"),
        ("A3COM-HUAWEI-DOT3-EFM-EPON-MIB", "h3cDot3OmpeGroupStat"))
)
if mibBuilder.loadTexts:
...
h3cDot3EponMauCompliance.setObjects(
      *(("A3COM-HUAWEI-DOT3-EFM-EPON-MIB", "h3cDot3EponMauGroupAll"),
        ("A3COM-HUAWEI-DOT3-EFM-EPON-MIB", "h3cDot3EponMauGroupFEC"))
)
if mibBuilder.loadTexts:
