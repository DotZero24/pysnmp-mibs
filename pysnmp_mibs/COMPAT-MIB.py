...
mibBuilder.exportSymbols("COMPAT-MIB", failedSecurID=failedSecurID, compatVars=compatVars, DisplayString=DisplayString, vpnLoginTable=vpnLoginTable, vpnTunnelTableUserName=vpnTunnelTableUserName, vpnTunnelTableAppletalkBytesSent=vpnTunnelTableAppletalkBytesSent, vpnTunnelTableUptime=vpnTunnelTableUptime, vpnTunnelTableAssignedIpAddress=vpnTunnelTableAssignedIpAddress, vpnTunnelTableIpAddress=vpnTunnelTableIpAddress, compatVPN=compatVPN, vpnTunnelTableLatency=vpnTunnelTableLatency, vpnTunnelTableGroupName=vpnTunnelTableGroupName, vPNTunnelTable=vPNTunnelTable, processorUtilizationPercentage=processorUtilizationPercentage, vpnTunnelTableIpxBytesRcvd=vpnTunnelTableIpxBytesRcvd, vpnTunnelTableIpxBytesSent=vpnTunnelTableIpxBytesSent, vpnTunnelTableBandwidthReturn=vpnTunnelTableBandwidthReturn, compatible=compatible, vpnTunnelTableIndex=vpnTunnelTableIndex, vpnTunnelTableBandwidthOut=vpnTunnelTableBandwidthOut, failedLogins=failedLogins, failedRadiusAuth=failedRadiusAuth, vpnTunnelTableIpBytesRcvd=vpnTunnelTableIpBytesRcvd, vpnTunnelTableAppletalkBytesRcvd=vpnTunnelTableAppletalkBytesRcvd, vpnTunnelTableEntry=vpnTunnelTableEntry, vpnTunnelTableIpBytesSent=vpnTunnelTableIpBytesSent, vpnTunnelTable=vpnTunnelTable)
