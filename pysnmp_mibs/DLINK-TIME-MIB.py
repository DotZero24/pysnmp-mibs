...
swTimeCapacity.setMaxAccess(_D)
...
swClockLostOnReboot.setMaxAccess(_D)
...
_SwSystemCurrentTime_Type.__name__=_F
...
swSystemCurrentTime.setMaxAccess(_D)
...
_SwSystemBootTime_Type.__name__=_F
...
swSystemBootTime.setMaxAccess(_D)
...
class _SwSNTPTimeSource_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*(('system',0),('server1',1),('server2',2)))
...
swSNTPTimeSource.setMaxAccess(_D)
...
_SwRepeatSummerTimeStart_Type.__name__=_E
...
_SwRepeatSummerTimeEnd_Type.__name__=_E
...
_SwAnnualSummerTimeStart_Type.__name__=_E
...
_SwAnnualSummerTimeEnd_Type.__name__=_E
