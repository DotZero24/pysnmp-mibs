...
rlTelnetMibVersion=_RlTelnetMibVersion_Object((1,3,6,1,4,1,9,6,1,101,58,1),_RlTelnetMibVersion_Type())
...
rlTelnetPassword=_RlTelnetPassword_Object((1,3,6,1,4,1,9,6,1,101,58,2),_RlTelnetPassword_Type())
...
rlTelnetTimeout=_RlTelnetTimeout_Object((1,3,6,1,4,1,9,6,1,101,58,3),_RlTelnetTimeout_Type())
rlTelnetTimeout.setMaxAccess(_B)
if mibBuilder.loadTexts:rlTelnetTimeout.setStatus(_A)
_RlTelnetUsersTable_Object=MibTable
rlTelnetUsersTable=_RlTelnetUsersTable_Object((1,3,6,1,4,1,9,6,1,101,58,4))
if mibBuilder.loadTexts:rlTelnetUsersTable.setStatus(_A)
_RlTelnetUsersEntry_Object=MibTableRow
rlTelnetUsersEntry=_RlTelnetUsersEntry_Object((1,3,6,1,4,1,9,6,1,101,58,4,1))
...
rlTelnetSessionId=_RlTelnetSessionId_Object((1,3,6,1,4,1,9,6,1,101,58,4,1,1),_RlTelnetSessionId_Type())
...
rlTelnetSessionClientAddressType=_RlTelnetSessionClientAddressType_Object((1,3,6,1,4,1,9,6,1,101,58,4,1,2),_RlTelnetSessionClientAddressType_Type())
...
rlTelnetSessionClientAddress=_RlTelnetSessionClientAddress_Object((1,3,6,1,4,1,9,6,1,101,58,4,1,3),_RlTelnetSessionClientAddress_Type())
...
rlTelnetSessionLoginTime=_RlTelnetSessionLoginTime_Object((1,3,6,1,4,1,9,6,1,101,58,4,1,4),_RlTelnetSessionLoginTime_Type())
...
rlTelnetSessionStatus=_RlTelnetSessionStatus_Object((1,3,6,1,4,1,9,6,1,101,58,4,1,5),_RlTelnetSessionStatus_Type())
...
rlTelnetLoginBanner=_RlTelnetLoginBanner_Object((1,3,6,1,4,1,9,6,1,101,58,5),_RlTelnetLoginBanner_Type())
...
rlTelnetSecondLoginBanner=_RlTelnetSecondLoginBanner_Object((1,3,6,1,4,1,9,6,1,101,58,6),_RlTelnetSecondLoginBanner_Type())
...
rlTelnetEnable=_RlTelnetEnable_Object((1,3,6,1,4,1,9,6,1,101,58,7),_RlTelnetEnable_Type())
