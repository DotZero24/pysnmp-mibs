...
mibBuilder.exportSymbols("A3COM-HUAWEI-LswARP-MIB", hwLswProxyArpEnableEntry=hwLswProxyArpEnableEntry, hwLswProxyArpEnableTable=hwLswProxyArpEnableTable, PYSNMP_MODULE_ID=hwLswArpMib, hwLswProxyArpObject=hwLswProxyArpObject, hwLswIfIndex=hwLswIfIndex, hwLswProxyArpStatus=hwLswProxyArpStatus, hwLswArpMib=hwLswArpMib)
