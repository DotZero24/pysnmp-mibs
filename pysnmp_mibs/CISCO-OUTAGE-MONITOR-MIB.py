...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-OUTAGE-MONITOR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:00 2025
...
_COutageNotificationsEnabled_Type.__name__ = "TruthValue"
...
_COutageNotificationFilterEnabled_Type.__name__ = "TruthValue"
...
_COutageHistTableSize_Type.__name__ = "Unsigned32"
...
ciscoOutageMIBCompliance.setObjects(
      *(("CISCO-OUTAGE-MONITOR-MIB", "ciscoOutageBasicGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoEventHistoryGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoEventDescrGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoObjectOutageGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoCpmMappingGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoRmtMappingGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoOutageNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
ciscoOutageMIBComplianceRev1.setObjects(
      *(("CISCO-OUTAGE-MONITOR-MIB", "ciscoOutageBasicGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoEventHistoryGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoEventDescrGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoObjectOutageGroupRev"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoCpmMappingGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoRmtMappingGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoLntMappingGroup"),
        ("CISCO-OUTAGE-MONITOR-MIB", "ciscoOutageNotificationsGroup"))
)
if mibBuilder.loadTexts:
