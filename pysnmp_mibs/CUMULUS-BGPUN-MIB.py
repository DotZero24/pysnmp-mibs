...
mibBuilder.exportSymbols("CUMULUS-BGPUN-MIB", bgp4PathAttrCalcLocalPref=bgp4PathAttrCalcLocalPref, bgpPeerLocalAddr=bgpPeerLocalAddr, bgpPeerFsmEstablishedTime=bgpPeerFsmEstablishedTime, bgpPeerKeepAlive=bgpPeerKeepAlive, bgpPeerFsmEstablishedTransitions=bgpPeerFsmEstablishedTransitions, bgpPeerMinRouteAdvertisementInterval=bgpPeerMinRouteAdvertisementInterval, bgpPeerOutTotalMessages=bgpPeerOutTotalMessages, bgp4PathAttrOrigin=bgp4PathAttrOrigin, bgp4PathAttrAggregatorAddr=bgp4PathAttrAggregatorAddr, bgpPeerInUpdates=bgpPeerInUpdates, bgpPeerIface=bgpPeerIface, bgpLocalAs=bgpLocalAs, bgpPeerKeepAliveConfigured=bgpPeerKeepAliveConfigured, bgpTraps=bgpTraps, bgpPeerTable=bgpPeerTable, bgpPeerRemoteAddr=bgpPeerRemoteAddr, bgp4PathAttrASPathSegment=bgp4PathAttrASPathSegment, bgpPeerRemoteAs=bgpPeerRemoteAs, bgpOuterTable=bgpOuterTable, bgpPeerState=bgpPeerState, bgp4PathAttrTable=bgp4PathAttrTable, bgpPeerDesc=bgpPeerDesc, bgpPeerNegotiatedVersion=bgpPeerNegotiatedVersion, bgpPeerAdminStatus=bgpPeerAdminStatus, bgp4PathAttrNextHop=bgp4PathAttrNextHop, bgp4PathAttrMultiExitDisc=bgp4PathAttrMultiExitDisc, bgp4PathAttrPeer=bgp4PathAttrPeer, bgp4PathAttrLocalPref=bgp4PathAttrLocalPref, bgpBackwardTransition=bgpBackwardTransition, bgpIdentifier=bgpIdentifier, bgp4PathAttrIpAddrPrefixLen=bgp4PathAttrIpAddrPrefixLen, bgp4PathAttrBest=bgp4PathAttrBest, bgpVersion=bgpVersion, bgp4PathAttrAtomicAggregate=bgp4PathAttrAtomicAggregate, bgpPeerHoldTime=bgpPeerHoldTime, bgpPeerLastError=bgpPeerLastError, bgpPeerInTotalMessages=bgpPeerInTotalMessages, bgp4PathAttrAggregatorAS=bgp4PathAttrAggregatorAS, bgpPeerLocalPort=bgpPeerLocalPort, bgp4PathAttrIpAddrPrefix=bgp4PathAttrIpAddrPrefix, bgp4PathAttrEntry=bgp4PathAttrEntry, bgpEstablished=bgpEstablished, bgpPeerIdentifier=bgpPeerIdentifier, PYSNMP_MODULE_ID=bgp, bgpPeerOutUpdates=bgpPeerOutUpdates, bgpPeerEntry=bgpPeerEntry, bgpPeerInUpdateElapsedTime=bgpPeerInUpdateElapsedTime, bgpPeerRemotePort=bgpPeerRemotePort, bgpPeerHoldTimeConfigured=bgpPeerHoldTimeConfigured, bgpPeerMinASOriginationInterval=bgpPeerMinASOriginationInterval, bgp=bgp, bgpPeerConnectRetryInterval=bgpPeerConnectRetryInterval, bgp4PathAttrUnknown=bgp4PathAttrUnknown)
