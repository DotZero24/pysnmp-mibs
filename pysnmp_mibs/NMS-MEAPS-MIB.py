...
nmsMEAPS=_NmsMEAPS_ObjectIdentity((1,3,6,1,4,1,3320,2,234))
_NmsMEAPSDomains_Type=Integer32
_NmsMEAPSDomains_Object=MibScalar
nmsMEAPSDomains=_NmsMEAPSDomains_Object((1,3,6,1,4,1,3320,2,234,1),_NmsMEAPSDomains_Type())
...
nmsMEAPSPduRx=_NmsMEAPSPduRx_Object((1,3,6,1,4,1,3320,2,234,2),_NmsMEAPSPduRx_Type())
...
nmsMEAPSPduTx=_NmsMEAPSPduTx_Object((1,3,6,1,4,1,3320,2,234,3),_NmsMEAPSPduTx_Type())
nmsMEAPSPduTx.setMaxAccess(_B)
if mibBuilder.loadTexts:nmsMEAPSPduTx.setStatus(_A)
_NmsMEAPSDomainTable_Object=MibTable
nmsMEAPSDomainTable=_NmsMEAPSDomainTable_Object((1,3,6,1,4,1,3320,2,234,4))
if mibBuilder.loadTexts:nmsMEAPSDomainTable.setStatus(_A)
_NmsMEAPSDomainTableEntry_Object=MibTableRow
nmsMEAPSDomainTableEntry=_NmsMEAPSDomainTableEntry_Object((1,3,6,1,4,1,3320,2,234,4,1))
...
nmsMEAPSDomainID=_NmsMEAPSDomainID_Object((1,3,6,1,4,1,3320,2,234,4,1,1),_NmsMEAPSDomainID_Type())
...
nmsMEAPSRings=_NmsMEAPSRings_Object((1,3,6,1,4,1,3320,2,234,4,1,2),_NmsMEAPSRings_Type())
...
nmsMEAPSRowStatus=_NmsMEAPSRowStatus_Object((1,3,6,1,4,1,3320,2,234,4,1,3),_NmsMEAPSRowStatus_Type())
...
nmsMEAPSRingTable=_NmsMEAPSRingTable_Object((1,3,6,1,4,1,3320,2,234,5))
if mibBuilder.loadTexts:nmsMEAPSRingTable.setStatus(_A)
_NmsMEAPSRingTableEntry_Object=MibTableRow
nmsMEAPSRingTableEntry=_NmsMEAPSRingTableEntry_Object((1,3,6,1,4,1,3320,2,234,5,1))
...
nmsMEAPSRingID=_NmsMEAPSRingID_Object((1,3,6,1,4,1,3320,2,234,5,1,1),_NmsMEAPSRingID_Type())
...
nmsMEAPSRingLevel=_NmsMEAPSRingLevel_Object((1,3,6,1,4,1,3320,2,234,5,1,2),_NmsMEAPSRingLevel_Type())
...
nmsMEAPSRingNodeType=_NmsMEAPSRingNodeType_Object((1,3,6,1,4,1,3320,2,234,5,1,3),_NmsMEAPSRingNodeType_Type())
...
nmsMEAPSRingControlVlanMajor=_NmsMEAPSRingControlVlanMajor_Object((1,3,6,1,4,1,3320,2,234,5,1,4),_NmsMEAPSRingControlVlanMajor_Type())
...
nmsMEAPSRingControlVlanSub=_NmsMEAPSRingControlVlanSub_Object((1,3,6,1,4,1,3320,2,234,5,1,5),_NmsMEAPSRingControlVlanSub_Type())
...
nmsMEAPSRingPorts=_NmsMEAPSRingPorts_Object((1,3,6,1,4,1,3320,2,234,5,1,6),_NmsMEAPSRingPorts_Type())
...
nmsMEAPSRingState=_NmsMEAPSRingState_Object((1,3,6,1,4,1,3320,2,234,5,1,7),_NmsMEAPSRingState_Type())
...
nmsMEAPSRingHealthCheck=_NmsMEAPSRingHealthCheck_Object((1,3,6,1,4,1,3320,2,234,5,1,8),_NmsMEAPSRingHealthCheck_Type())
...
nmsMEAPSRingHelloTime=_NmsMEAPSRingHelloTime_Object((1,3,6,1,4,1,3320,2,234,5,1,9),_NmsMEAPSRingHelloTime_Type())
...
nmsMEAPSRingFailTime=_NmsMEAPSRingFailTime_Object((1,3,6,1,4,1,3320,2,234,5,1,10),_NmsMEAPSRingFailTime_Type())
...
nmsMEAPSRingPreforwardTime=_NmsMEAPSRingPreforwardTime_Object((1,3,6,1,4,1,3320,2,234,5,1,11),_NmsMEAPSRingPreforwardTime_Type())
...
nmsMEAPSRingEdgeHelloTime=_NmsMEAPSRingEdgeHelloTime_Object((1,3,6,1,4,1,3320,2,234,5,1,12),_NmsMEAPSRingEdgeHelloTime_Type())
...
nmsMEAPSRingEdgeFailTime=_NmsMEAPSRingEdgeFailTime_Object((1,3,6,1,4,1,3320,2,234,5,1,13),_NmsMEAPSRingEdgeFailTime_Type())
...
nmsMEAPSRingAdminStatus=_NmsMEAPSRingAdminStatus_Object((1,3,6,1,4,1,3320,2,234,5,1,14),_NmsMEAPSRingAdminStatus_Type())
...
nmsMEAPSRingPrimaryPort=_NmsMEAPSRingPrimaryPort_Object((1,3,6,1,4,1,3320,2,234,5,1,15),_NmsMEAPSRingPrimaryPort_Type())
...
nmsMEAPSRingPrimaryPortState=_NmsMEAPSRingPrimaryPortState_Object((1,3,6,1,4,1,3320,2,234,5,1,16),_NmsMEAPSRingPrimaryPortState_Type())
...
nmsMEAPSRingPrimaryPortStatus=_NmsMEAPSRingPrimaryPortStatus_Object((1,3,6,1,4,1,3320,2,234,5,1,17),_NmsMEAPSRingPrimaryPortStatus_Type())
...
nmsMEAPSRingSecondaryPort=_NmsMEAPSRingSecondaryPort_Object((1,3,6,1,4,1,3320,2,234,5,1,18),_NmsMEAPSRingSecondaryPort_Type())
...
nmsMEAPSRingSecondaryPortState=_NmsMEAPSRingSecondaryPortState_Object((1,3,6,1,4,1,3320,2,234,5,1,19),_NmsMEAPSRingSecondaryPortState_Type())
...
nmsMEAPSRingSecondaryPortStatus=_NmsMEAPSRingSecondaryPortStatus_Object((1,3,6,1,4,1,3320,2,234,5,1,20),_NmsMEAPSRingSecondaryPortStatus_Type())
...
nmsMEAPSRingPortTable=_NmsMEAPSRingPortTable_Object((1,3,6,1,4,1,3320,2,234,6))
if mibBuilder.loadTexts:nmsMEAPSRingPortTable.setStatus(_A)
_NmsMEAPSRingPortTableEntry_Object=MibTableRow
nmsMEAPSRingPortTableEntry=_NmsMEAPSRingPortTableEntry_Object((1,3,6,1,4,1,3320,2,234,6,1))
...
nmsMEAPSRingPortRingID=_NmsMEAPSRingPortRingID_Object((1,3,6,1,4,1,3320,2,234,6,1,1),_NmsMEAPSRingPortRingID_Type())
...
nmsMEAPSRingPort=_NmsMEAPSRingPort_Object((1,3,6,1,4,1,3320,2,234,6,1,2),_NmsMEAPSRingPort_Type())
...
nmsMEAPSRingPortType=_NmsMEAPSRingPortType_Object((1,3,6,1,4,1,3320,2,234,6,1,3),_NmsMEAPSRingPortType_Type())
...
nmsMEAPSRingPortState=_NmsMEAPSRingPortState_Object((1,3,6,1,4,1,3320,2,234,6,1,4),_NmsMEAPSRingPortState_Type())
...
nmsMEAPSRingPortForwards=_NmsMEAPSRingPortForwards_Object((1,3,6,1,4,1,3320,2,234,6,1,5),_NmsMEAPSRingPortForwards_Type())
...
nmsMEAPSRingPortRx=_NmsMEAPSRingPortRx_Object((1,3,6,1,4,1,3320,2,234,6,1,6),_NmsMEAPSRingPortRx_Type())
...
nmsMEAPSRingPortTx=_NmsMEAPSRingPortTx_Object((1,3,6,1,4,1,3320,2,234,6,1,7),_NmsMEAPSRingPortTx_Type())
...
nmsMEAPSRingPortStatus=_NmsMEAPSRingPortStatus_Object((1,3,6,1,4,1,3320,2,234,6,1,8),_NmsMEAPSRingPortStatus_Type())
...
nmsMEAPSRingNotifications=_NmsMEAPSRingNotifications_ObjectIdentity((1,3,6,1,4,1,3320,2,234,7))
nmsMEAPSRingNotification=NotificationType((1,3,6,1,4,1,3320,2,234,7,1))
