...
futureElmiMIB=ModuleIdentity((1,3,6,1,4,1,2076,159))
...
futureElmi=_FutureElmi_ObjectIdentity((1,3,6,1,4,1,2076,159,1))
...
fsElmiSystemControl=_FsElmiSystemControl_Object((1,3,6,1,4,1,2076,159,1,1),_FsElmiSystemControl_Type())
...
fsElmiModuleStatus=_FsElmiModuleStatus_Object((1,3,6,1,4,1,2076,159,1,2),_FsElmiModuleStatus_Type())
...
fsElmiActivePortCount=_FsElmiActivePortCount_Object((1,3,6,1,4,1,2076,159,1,3),_FsElmiActivePortCount_Type())
...
fsElmiTraceOption=_FsElmiTraceOption_Object((1,3,6,1,4,1,2076,159,1,4),_FsElmiTraceOption_Type())
...
fsElmiBufferOverFlowCount=_FsElmiBufferOverFlowCount_Object((1,3,6,1,4,1,2076,159,1,5),_FsElmiBufferOverFlowCount_Type())
...
fsElmiMemAllocFailureCount=_FsElmiMemAllocFailureCount_Object((1,3,6,1,4,1,2076,159,1,6),_FsElmiMemAllocFailureCount_Type())
...
fsElmiPortTable=_FsElmiPortTable_Object((1,3,6,1,4,1,2076,159,1,7))
if mibBuilder.loadTexts:fsElmiPortTable.setStatus(_A)
_FsElmiPortEntry_Object=MibTableRow
fsElmiPortEntry=_FsElmiPortEntry_Object((1,3,6,1,4,1,2076,159,1,7,1))
...
fsElmiPort=_FsElmiPort_Object((1,3,6,1,4,1,2076,159,1,7,1,1),_FsElmiPort_Type())
...
fsElmiPortElmiStatus=_FsElmiPortElmiStatus_Object((1,3,6,1,4,1,2076,159,1,7,1,2),_FsElmiPortElmiStatus_Type())
...
fsElmiUniSide=_FsElmiUniSide_Object((1,3,6,1,4,1,2076,159,1,7,1,3),_FsElmiUniSide_Type())
...
fsElmiOperStatus=_FsElmiOperStatus_Object((1,3,6,1,4,1,2076,159,1,7,1,4),_FsElmiOperStatus_Type())
...
fsElmiStatusCounter=_FsElmiStatusCounter_Object((1,3,6,1,4,1,2076,159,1,7,1,5),_FsElmiStatusCounter_Type())
...
fsElmiPollingVerificationTimerValue=_FsElmiPollingVerificationTimerValue_Object((1,3,6,1,4,1,2076,159,1,7,1,6),_FsElmiPollingVerificationTimerValue_Type())
...
fsElmiPollingTimerValue=_FsElmiPollingTimerValue_Object((1,3,6,1,4,1,2076,159,1,7,1,7),_FsElmiPollingTimerValue_Type())
...
fsElmiPollingCounterValue=_FsElmiPollingCounterValue_Object((1,3,6,1,4,1,2076,159,1,7,1,8),_FsElmiPollingCounterValue_Type())
...
fsElmiNoOfConfiguredEvcs=_FsElmiNoOfConfiguredEvcs_Object((1,3,6,1,4,1,2076,159,1,7,1,9),_FsElmiNoOfConfiguredEvcs_Type())
...
fsElmiRxElmiCheckEnqMsgCount=_FsElmiRxElmiCheckEnqMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,10),_FsElmiRxElmiCheckEnqMsgCount_Type())
...
fsElmiRxFullStatusEnqMsgCount=_FsElmiRxFullStatusEnqMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,11),_FsElmiRxFullStatusEnqMsgCount_Type())
...
fsElmiRxFullStatusContEnqMsgCount=_FsElmiRxFullStatusContEnqMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,12),_FsElmiRxFullStatusContEnqMsgCount_Type())
...
fsElmiTxElmiCheckMsgCount=_FsElmiTxElmiCheckMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,13),_FsElmiTxElmiCheckMsgCount_Type())
...
fsElmiTxFullStatusMsgCount=_FsElmiTxFullStatusMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,14),_FsElmiTxFullStatusMsgCount_Type())
...
fsElmiTxFullStatusContMsgCount=_FsElmiTxFullStatusContMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,15),_FsElmiTxFullStatusContMsgCount_Type())
...
fsElmiTxAsyncStatusMsgCount=_FsElmiTxAsyncStatusMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,16),_FsElmiTxAsyncStatusMsgCount_Type())
...
fsElmiRxElmiCheckMsgCount=_FsElmiRxElmiCheckMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,17),_FsElmiRxElmiCheckMsgCount_Type())
...
fsElmiRxFullStatusMsgCount=_FsElmiRxFullStatusMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,18),_FsElmiRxFullStatusMsgCount_Type())
...
fsElmiRxFullStatusContMsgCount=_FsElmiRxFullStatusContMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,19),_FsElmiRxFullStatusContMsgCount_Type())
...
fsElmiRxAsyncStatusMsgCount=_FsElmiRxAsyncStatusMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,20),_FsElmiRxAsyncStatusMsgCount_Type())
...
fsElmiTxElmiCheckEnqMsgCount=_FsElmiTxElmiCheckEnqMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,21),_FsElmiTxElmiCheckEnqMsgCount_Type())
...
fsElmiTxFullStatusEnqMsgCount=_FsElmiTxFullStatusEnqMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,22),_FsElmiTxFullStatusEnqMsgCount_Type())
...
fsElmiTxFullStatusContEnqMsgCount=_FsElmiTxFullStatusContEnqMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,23),_FsElmiTxFullStatusContEnqMsgCount_Type())
...
fsElmiRxValidMsgCount=_FsElmiRxValidMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,24),_FsElmiRxValidMsgCount_Type())
...
fsElmiRxInvalidMsgCount=_FsElmiRxInvalidMsgCount_Object((1,3,6,1,4,1,2076,159,1,7,1,25),_FsElmiRxInvalidMsgCount_Type())
...
fsElmiRelErrStatusTimeOutCount=_FsElmiRelErrStatusTimeOutCount_Object((1,3,6,1,4,1,2076,159,1,7,1,26),_FsElmiRelErrStatusTimeOutCount_Type())
...
fsElmiRelErrInvalidSeqNumCount=_FsElmiRelErrInvalidSeqNumCount_Object((1,3,6,1,4,1,2076,159,1,7,1,27),_FsElmiRelErrInvalidSeqNumCount_Type())
...
fsElmiRelErrInvalidStatusRespCount=_FsElmiRelErrInvalidStatusRespCount_Object((1,3,6,1,4,1,2076,159,1,7,1,28),_FsElmiRelErrInvalidStatusRespCount_Type())
...
fsElmiRelErrRxUnSolicitedStatusCount=_FsElmiRelErrRxUnSolicitedStatusCount_Object((1,3,6,1,4,1,2076,159,1,7,1,29),_FsElmiRelErrRxUnSolicitedStatusCount_Type())
...
fsElmiProErrInvalidProtVerCount=_FsElmiProErrInvalidProtVerCount_Object((1,3,6,1,4,1,2076,159,1,7,1,30),_FsElmiProErrInvalidProtVerCount_Type())
...
fsElmiProErrInvalidEvcRefIdCount=_FsElmiProErrInvalidEvcRefIdCount_Object((1,3,6,1,4,1,2076,159,1,7,1,31),_FsElmiProErrInvalidEvcRefIdCount_Type())
...
fsElmiProErrInvalidMessageTypeCount=_FsElmiProErrInvalidMessageTypeCount_Object((1,3,6,1,4,1,2076,159,1,7,1,32),_FsElmiProErrInvalidMessageTypeCount_Type())
...
fsElmiProErrOutOfSequenceInfoEleCount=_FsElmiProErrOutOfSequenceInfoEleCount_Object((1,3,6,1,4,1,2076,159,1,7,1,33),_FsElmiProErrOutOfSequenceInfoEleCount_Type())
...
fsElmiProErrDuplicateInfoEleCount=_FsElmiProErrDuplicateInfoEleCount_Object((1,3,6,1,4,1,2076,159,1,7,1,34),_FsElmiProErrDuplicateInfoEleCount_Type())
...
fsElmiProErrMandatoryInfoEleMissingCount=_FsElmiProErrMandatoryInfoEleMissingCount_Object((1,3,6,1,4,1,2076,159,1,7,1,35),_FsElmiProErrMandatoryInfoEleMissingCount_Type())
...
fsElmiProErrInvalidMandatoryInfoEleCount=_FsElmiProErrInvalidMandatoryInfoEleCount_Object((1,3,6,1,4,1,2076,159,1,7,1,36),_FsElmiProErrInvalidMandatoryInfoEleCount_Type())
...
fsElmiProErrInvalidNonMandatoryInfoEleCount=_FsElmiProErrInvalidNonMandatoryInfoEleCount_Object((1,3,6,1,4,1,2076,159,1,7,1,37),_FsElmiProErrInvalidNonMandatoryInfoEleCount_Type())
...
fsElmiProErrUnrecognizedInfoEleCount=_FsElmiProErrUnrecognizedInfoEleCount_Object((1,3,6,1,4,1,2076,159,1,7,1,38),_FsElmiProErrUnrecognizedInfoEleCount_Type())
...
fsElmiProErrUnexpectedInfoEleCount=_FsElmiProErrUnexpectedInfoEleCount_Object((1,3,6,1,4,1,2076,159,1,7,1,39),_FsElmiProErrUnexpectedInfoEleCount_Type())
...
fsElmiProErrShortMessageCount=_FsElmiProErrShortMessageCount_Object((1,3,6,1,4,1,2076,159,1,7,1,40),_FsElmiProErrShortMessageCount_Type())
...
futureElmiTrapsControl=_FutureElmiTrapsControl_ObjectIdentity((1,3,6,1,4,1,2076,159,2))
...
fsElmiSetGlobalTrapOption=_FsElmiSetGlobalTrapOption_Object((1,3,6,1,4,1,2076,159,2,1),_FsElmiSetGlobalTrapOption_Type())
...
fsElmiSetTraps=_FsElmiSetTraps_Object((1,3,6,1,4,1,2076,159,2,2),_FsElmiSetTraps_Type())
...
fsElmiErrTrapType=_FsElmiErrTrapType_Object((1,3,6,1,4,1,2076,159,2,3),_FsElmiErrTrapType_Type())
...
fsElmiPortTrapNotificationTable=_FsElmiPortTrapNotificationTable_Object((1,3,6,1,4,1,2076,159,2,4))
if mibBuilder.loadTexts:fsElmiPortTrapNotificationTable.setStatus(_A)
_FsElmiPortTrapNotificationEntry_Object=MibTableRow
fsElmiPortTrapNotificationEntry=_FsElmiPortTrapNotificationEntry_Object((1,3,6,1,4,1,2076,159,2,4,1))
...
fsElmiPortTrapIndex=_FsElmiPortTrapIndex_Object((1,3,6,1,4,1,2076,159,2,4,1,1),_FsElmiPortTrapIndex_Type())
...
fsElmiPvtExpired=_FsElmiPvtExpired_Object((1,3,6,1,4,1,2076,159,2,4,1,2),_FsElmiPvtExpired_Type())
...
fsElmiPtExpired=_FsElmiPtExpired_Object((1,3,6,1,4,1,2076,159,2,4,1,3),_FsElmiPtExpired_Type())
...
fsElmiEvcStatus=_FsElmiEvcStatus_Object((1,3,6,1,4,1,2076,159,2,4,1,4),_FsElmiEvcStatus_Type())
...
fsElmiUniStatus=_FsElmiUniStatus_Object((1,3,6,1,4,1,2076,159,2,4,1,5),_FsElmiUniStatus_Type())
...
fsElmiEvcId=_FsElmiEvcId_Object((1,3,6,1,4,1,2076,159,2,4,1,6),_FsElmiEvcId_Type())
...
fsElmiErrType=_FsElmiErrType_Object((1,3,6,1,4,1,2076,159,2,4,1,7),_FsElmiErrType_Type())
...
fsElmiOperStatusStatus=_FsElmiOperStatusStatus_Object((1,3,6,1,4,1,2076,159,2,4,1,8),_FsElmiOperStatusStatus_Type())
