...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/ciena/CIENA-WS-SOFTWARE-MIB
...
StringMaxl64, StringMaxl256, StringMaxl32, StringMaxl128 = mibBuilder.importSymbols("CIENA-WS-TYPEDEFS-MIB", "StringMaxl64", "StringMaxl256", "StringMaxl32", "StringMaxl128")
...
cienaWsSoftwareMIB.setRevisions(('2017-07-18 00:00', '2017-03-02 00:00', '2016-11-03 00:00', '2016-06-14 00:00', '2015-09-29 00:00',))
if mibBuilder.loadTexts: cienaWsSoftwareMIB.setLastUpdated('201707180000Z')
...
cwsSoftwareUpgradeServerIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 1271, 3, 4, 14, 5, 1, 2), Unsigned32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: cwsSoftwareUpgradeServerIndex.setStatus('current')
cwsSoftwareUpgradeServerServer = MibTableColumn((1, 3, 6, 1, 4, 1, 1271, 3, 4, 14, 5, 1, 3), StringMaxl64()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: cwsSoftwareUpgradeServerServer.setStatus('current')
cwsSoftwareUpgradeServerMode = MibTableColumn((1, 3, 6, 1, 4, 1, 1271, 3, 4, 14, 5, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3))).clone(namedValues=NamedValues(("tftp", 0), ("ftp", 1), ("sftp", 2), ("scp", 3)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: cwsSoftwareUpgradeServerMode.setStatus('current')
cwsSoftwareUpgradeServerRemotePath = MibTableColumn((1, 3, 6, 1, 4, 1, 1271, 3, 4, 14, 5, 1, 5), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 256))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: cwsSoftwareUpgradeServerRemotePath.setStatus('current')
cwsSoftwareUpgradeServerLoginId = MibTableColumn((1, 3, 6, 1, 4, 1, 1271, 3, 4, 14, 5, 1, 6), StringMaxl32()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: cwsSoftwareUpgradeServerLoginId.setStatus('current')
cwsSoftwareUpgradeServerPassword = MibTableColumn((1, 3, 6, 1, 4, 1, 1271, 3, 4, 14, 5, 1, 7), StringMaxl32()).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("CIENA-WS-SOFTWARE-MIB", cwsSoftwareActiveSoftwareCatalogName=cwsSoftwareActiveSoftwareCatalogName, cwsSoftwareCheckStatusReportCheckUpgradeState=cwsSoftwareCheckStatusReportCheckUpgradeState, cwsSoftwareVersionsBuildTag=cwsSoftwareVersionsBuildTag, cwsSoftwareCheckStatusReportServiceInterruptionActivation=cwsSoftwareCheckStatusReportServiceInterruptionActivation, cwsSoftwareStatusActiveVersion=cwsSoftwareStatusActiveVersion, cwsSoftwareVersionsBuildNumber=cwsSoftwareVersionsBuildNumber, cwsSoftwareUpgradeServerRemotePath=cwsSoftwareUpgradeServerRemotePath, cwsSoftwareUpgradeServerEntry=cwsSoftwareUpgradeServerEntry, cwsSoftwareActiveSoftwareNumberOfComponents=cwsSoftwareActiveSoftwareNumberOfComponents, cwsSoftwareActivecomponentsName=cwsSoftwareActivecomponentsName, cwsSoftwareUpgradeServerTableSnmpKey=cwsSoftwareUpgradeServerTableSnmpKey, UpgradeOpState=UpgradeOpState, cwsSoftwareActiveSoftwareBuildDate=cwsSoftwareActiveSoftwareBuildDate, cwsSoftwareStatusSoftwareOperationalState=cwsSoftwareStatusSoftwareOperationalState, cwsSoftwareVersionsNumberOfComponents=cwsSoftwareVersionsNumberOfComponents, cwsSoftwareBootPartitionListVersion=cwsSoftwareBootPartitionListVersion, cwsSoftwareVersionsIndex=cwsSoftwareVersionsIndex, cwsSoftwareStatusUpgradeToVersion=cwsSoftwareStatusUpgradeToVersion, cwsSoftwareStatusCommittedVersion=cwsSoftwareStatusCommittedVersion, cienaWsSoftwareCompliance=cienaWsSoftwareCompliance, cienaWsSoftwareGroup=cienaWsSoftwareGroup, cwsSoftwareStatusUpgradeOperationalState=cwsSoftwareStatusUpgradeOperationalState, SoftwareRtncode=SoftwareRtncode, cwsSoftwareInstalledcomponentsBuildNumber=cwsSoftwareInstalledcomponentsBuildNumber, cwsSoftwareActiveSoftwareTableSnmpKey=cwsSoftwareActiveSoftwareTableSnmpKey, cwsSoftwareCheckStatusReportTable=cwsSoftwareCheckStatusReportTable, cwsSoftwareCheckStatusReportCheckOperationalState=cwsSoftwareCheckStatusReportCheckOperationalState, cwsSoftwareCheckStatusReportServerReleaseVersion=cwsSoftwareCheckStatusReportServerReleaseVersion, cwsSoftwareActivecomponentsEntry=cwsSoftwareActivecomponentsEntry, cwsSoftwareInstalledcomponentsName=cwsSoftwareInstalledcomponentsName, cwsSoftwareActiveSoftwareBuildNumber=cwsSoftwareActiveSoftwareBuildNumber, cwsSoftwareUpgradeServerPassword=cwsSoftwareUpgradeServerPassword, cwsSoftwareUpgradeLogListEntry=cwsSoftwareUpgradeLogListEntry, cwsSoftwareUpgradeLogListText=cwsSoftwareUpgradeLogListText, cwsSoftwareUpgradeServerMode=cwsSoftwareUpgradeServerMode, cwsSoftwareInstalledcomponentsBuildTag=cwsSoftwareInstalledcomponentsBuildTag, cwsSoftwareActiveSoftwareEntry=cwsSoftwareActiveSoftwareEntry, cwsSoftwareActivecomponentsTable=cwsSoftwareActivecomponentsTable, cienaWsSoftwareCompliances=cienaWsSoftwareCompliances, cwsSoftwareActiveSoftwareTable=cwsSoftwareActiveSoftwareTable, cwsSoftwareCheckStatusReportTableSnmpKey=cwsSoftwareCheckStatusReportTableSnmpKey, cwsSoftwareBootPartitionListName=cwsSoftwareBootPartitionListName, cwsSoftwareStatusTable=cwsSoftwareStatusTable, cwsSoftwareVersionsTable=cwsSoftwareVersionsTable, cwsSoftwareUpgradeLogListTable=cwsSoftwareUpgradeLogListTable, cwsSoftwareInstalledcomponentsComponentIndex=cwsSoftwareInstalledcomponentsComponentIndex, cwsSoftwareUpgradeLogListLogIndex=cwsSoftwareUpgradeLogListLogIndex, cwsSoftwareVersionsVersion=cwsSoftwareVersionsVersion, cwsSoftwareBootPartitionListDate=cwsSoftwareBootPartitionListDate, cwsSoftwareActivecomponentsVersion=cwsSoftwareActivecomponentsVersion, cwsSoftwareVersionsSize=cwsSoftwareVersionsSize, cwsSoftwareBootPartitionListEntry=cwsSoftwareBootPartitionListEntry, cwsSoftwareInstalledcomponentsBuildSize=cwsSoftwareInstalledcomponentsBuildSize, cwsSoftwareActivecomponentsStatus=cwsSoftwareActivecomponentsStatus, cwsSoftwareCheckStatusReportLocalReleaseVersion=cwsSoftwareCheckStatusReportLocalReleaseVersion, SoftwareOpState=SoftwareOpState, cwsSoftwareCheckStatusReportTimestamp=cwsSoftwareCheckStatusReportTimestamp, cwsSoftwareBootPartitionListTable=cwsSoftwareBootPartitionListTable, cwsSoftwareCheckStatusReportRequiredActivationType=cwsSoftwareCheckStatusReportRequiredActivationType, cwsSoftwareCheckStatusReportServerHostname=cwsSoftwareCheckStatusReportServerHostname, cwsSoftwareInstalledcomponentsVersion=cwsSoftwareInstalledcomponentsVersion, cwsSoftwareStatusEntry=cwsSoftwareStatusEntry, cwsSoftwareCheckStatusReportEntry=cwsSoftwareCheckStatusReportEntry, cwsSoftwareCheckStatusReportServerPath=cwsSoftwareCheckStatusReportServerPath, cwsSoftwareBootPartitionListIntegrityCheck=cwsSoftwareBootPartitionListIntegrityCheck, cwsSoftwareInstalledcomponentsEntry=cwsSoftwareInstalledcomponentsEntry, cwsSoftwareUpgradeServerTable=cwsSoftwareUpgradeServerTable, cienaWsSoftwareMIB=cienaWsSoftwareMIB, cwsSoftwareStatusLastOperation=cwsSoftwareStatusLastOperation, cwsSoftwareVersionsBuildDate=cwsSoftwareVersionsBuildDate, cwsSoftwareInstalledcomponentsTable=cwsSoftwareInstalledcomponentsTable, cwsSoftwareUpgradeServerServer=cwsSoftwareUpgradeServerServer, cwsSoftwareBootPartitionListState=cwsSoftwareBootPartitionListState, cwsSoftwareVersionsEntry=cwsSoftwareVersionsEntry, cwsSoftwareActivecomponentsBuildNumber=cwsSoftwareActivecomponentsBuildNumber, cwsSoftwareUpgradeServerLoginId=cwsSoftwareUpgradeServerLoginId, cienaWsSoftwareObjects=cienaWsSoftwareObjects, cwsSoftwareActivecomponentsComponentIndex=cwsSoftwareActivecomponentsComponentIndex, cwsSoftwareBootPartitionListIndex=cwsSoftwareBootPartitionListIndex, cienaWsSoftwareConformance=cienaWsSoftwareConformance, cienaWsSoftwareGroups=cienaWsSoftwareGroups, cwsSoftwareStatusTableSnmpKey=cwsSoftwareStatusTableSnmpKey, cwsSoftwareCheckStatusReportActiveReleaseVersion=cwsSoftwareCheckStatusReportActiveReleaseVersion, cwsSoftwareUpgradeLogListDateAndTime=cwsSoftwareUpgradeLogListDateAndTime, cwsSoftwareActiveSoftwareVersion=cwsSoftwareActiveSoftwareVersion, cwsSoftwareUpgradeServerIndex=cwsSoftwareUpgradeServerIndex, cwsSoftwareInstalledcomponentsBuildTimestamp=cwsSoftwareInstalledcomponentsBuildTimestamp, PYSNMP_MODULE_ID=cienaWsSoftwareMIB)
