...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-MEMORY-MIB
...
myMemoryPoolWarning.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
myMemoryPoolCritical.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
myMemoryMIBCompliance.setObjects(
    ("MY-MEMORY-MIB", "myMemoryPoolUtilizationMIBGroup")
)
if mibBuilder.loadTexts:
