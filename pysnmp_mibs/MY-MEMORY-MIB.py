...
_G='myMemoryPoolName'
_F='read-write'
_E='myNodeMemoryPoolIndex'
_D='myMemoryPoolIndex'
_C='read-only'
_B='MY-MEMORY-MIB'
_A='current'
...
myMemoryMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,35))
if mibBuilder.loadTexts:myMemoryMIB.setRevisions(('2003-10-14 00:00','2019-10-09 00:00'))
...
myMemoryPoolMIBObjects=_MyMemoryPoolMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,35,1))
_MyMemoryPoolUtilizationTable_Object=MibTable
myMemoryPoolUtilizationTable=_MyMemoryPoolUtilizationTable_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1))
if mibBuilder.loadTexts:myMemoryPoolUtilizationTable.setStatus(_A)
_MyMemoryPoolUtilizationEntry_Object=MibTableRow
myMemoryPoolUtilizationEntry=_MyMemoryPoolUtilizationEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1))
myMemoryPoolUtilizationEntry.setIndexNames((0,_B,_D))
...
myMemoryPoolIndex=_MyMemoryPoolIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,1),_MyMemoryPoolIndex_Type())
...
myMemoryPoolName=_MyMemoryPoolName_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,2),_MyMemoryPoolName_Type())
...
myMemoryPoolCurrentUtilization=_MyMemoryPoolCurrentUtilization_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,3),_MyMemoryPoolCurrentUtilization_Type())
...
myMemoryPoolLowestUtilization=_MyMemoryPoolLowestUtilization_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,4),_MyMemoryPoolLowestUtilization_Type())
...
myMemoryPoolLargestUtilization=_MyMemoryPoolLargestUtilization_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,5),_MyMemoryPoolLargestUtilization_Type())
...
_MyMemoryPoolSize_Object=MibScalar
myMemoryPoolSize=_MyMemoryPoolSize_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,6),_MyMemoryPoolSize_Type())
myMemoryPoolSize.setMaxAccess(_C)
if mibBuilder.loadTexts:myMemoryPoolSize.setStatus(_A)
_MyMemoryPoolUsed_Type=Integer32
_MyMemoryPoolUsed_Object=MibScalar
myMemoryPoolUsed=_MyMemoryPoolUsed_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,7),_MyMemoryPoolUsed_Type())
myMemoryPoolUsed.setMaxAccess(_C)
if mibBuilder.loadTexts:myMemoryPoolUsed.setStatus(_A)
_MyMemoryPoolFree_Type=Integer32
_MyMemoryPoolFree_Object=MibScalar
myMemoryPoolFree=_MyMemoryPoolFree_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,8),_MyMemoryPoolFree_Type())
myMemoryPoolFree.setMaxAccess(_C)
if mibBuilder.loadTexts:myMemoryPoolFree.setStatus(_A)
_MyMemoryPoolWarning_Type=Percent
_MyMemoryPoolWarning_Object=MibScalar
myMemoryPoolWarning=_MyMemoryPoolWarning_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,9),_MyMemoryPoolWarning_Type())
myMemoryPoolWarning.setMaxAccess(_C)
if mibBuilder.loadTexts:myMemoryPoolWarning.setStatus(_A)
_MyMemoryPoolCritical_Type=Percent
_MyMemoryPoolCritical_Object=MibScalar
myMemoryPoolCritical=_MyMemoryPoolCritical_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,1,1,10),_MyMemoryPoolCritical_Type())
myMemoryPoolCritical.setMaxAccess(_C)
if mibBuilder.loadTexts:myMemoryPoolCritical.setStatus(_A)
_MyNodeMemoryPoolTable_Object=MibTable
myNodeMemoryPoolTable=_MyNodeMemoryPoolTable_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2))
if mibBuilder.loadTexts:myNodeMemoryPoolTable.setStatus(_A)
_MyNodeMemoryPoolEntry_Object=MibTableRow
myNodeMemoryPoolEntry=_MyNodeMemoryPoolEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1))
myNodeMemoryPoolEntry.setIndexNames((0,_B,_E))
...
myNodeMemoryPoolIndex=_MyNodeMemoryPoolIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,1),_MyNodeMemoryPoolIndex_Type())
...
myNodeMemoryPoolName=_MyNodeMemoryPoolName_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,2),_MyNodeMemoryPoolName_Type())
...
myNodeMemoryPoolCurrentUtilization=_MyNodeMemoryPoolCurrentUtilization_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,3),_MyNodeMemoryPoolCurrentUtilization_Type())
...
myNodeMemoryPoolLowestUtilization=_MyNodeMemoryPoolLowestUtilization_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,4),_MyNodeMemoryPoolLowestUtilization_Type())
...
myNodeMemoryPoolLargestUtilization=_MyNodeMemoryPoolLargestUtilization_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,5),_MyNodeMemoryPoolLargestUtilization_Type())
...
myNodeMemoryPoolSize=_MyNodeMemoryPoolSize_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,6),_MyNodeMemoryPoolSize_Type())
...
myNodeMemoryPoolUsed=_MyNodeMemoryPoolUsed_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,7),_MyNodeMemoryPoolUsed_Type())
...
myNodeMemoryPoolFree=_MyNodeMemoryPoolFree_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,8),_MyNodeMemoryPoolFree_Type())
...
myNodeMemoryPoolWarning=_MyNodeMemoryPoolWarning_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,9),_MyNodeMemoryPoolWarning_Type())
myNodeMemoryPoolWarning.setMaxAccess(_F)
...
myNodeMemoryPoolCritical=_MyNodeMemoryPoolCritical_Object((1,3,6,1,4,1,4881,1,1,10,2,35,1,2,1,10),_MyNodeMemoryPoolCritical_Type())
myNodeMemoryPoolCritical.setMaxAccess(_F)
if mibBuilder.loadTexts:myNodeMemoryPoolCritical.setStatus(_A)
_MyMemoryMIBConformance_ObjectIdentity=ObjectIdentity
myMemoryMIBConformance=_MyMemoryMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,35,2))
_MyMemoryMIBCompliances_ObjectIdentity=ObjectIdentity
myMemoryMIBCompliances=_MyMemoryMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,35,2,1))
_MyMemoryMIBGroups_ObjectIdentity=ObjectIdentity
myMemoryMIBGroups=_MyMemoryMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,35,2,2))
myMemoryPoolUtilizationMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,35,2,2,1))
myMemoryPoolUtilizationMIBGroup.setObjects(*((_B,_D),(_B,_G),(_B,_H),(_B,_I),(_B,_J),(_B,_K),(_B,_L),(_B,_M),(_B,_N),(_B,_O)))
if mibBuilder.loadTexts:myMemoryPoolUtilizationMIBGroup.setStatus(_A)
myNodeMemoryPoolMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,35,2,2,2))
myNodeMemoryPoolMIBGroup.setObjects(*((_B,_E),(_B,_P),(_B,_Q),(_B,_R),(_B,_S),(_B,_T),(_B,_U),(_B,_V),(_B,_W),(_B,_X)))
if mibBuilder.loadTexts:myNodeMemoryPoolMIBGroup.setStatus(_A)
myMemoryMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,35,2,1,1))
myMemoryMIBCompliance.setObjects((_B,_Y))
if mibBuilder.loadTexts:myMemoryMIBCompliance.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'Percent':Percent,'myMemoryMIB':myMemoryMIB,'myMemoryPoolMIBObjects':myMemoryPoolMIBObjects,'myMemoryPoolUtilizationTable':myMemoryPoolUtilizationTable,'myMemoryPoolUtilizationEntry':myMemoryPoolUtilizationEntry,_D:myMemoryPoolIndex,_G:myMemoryPoolName,_H:myMemoryPoolCurrentUtilization,_I:myMemoryPoolLowestUtilization,_J:myMemoryPoolLargestUtilization,_K:myMemoryPoolSize,_L:myMemoryPoolUsed,_M:myMemoryPoolFree,_N:myMemoryPoolWarning,_O:myMemoryPoolCritical,'myNodeMemoryPoolTable':myNodeMemoryPoolTable,'myNodeMemoryPoolEntry':myNodeMemoryPoolEntry,_E:myNodeMemoryPoolIndex,_P:myNodeMemoryPoolName,_Q:myNodeMemoryPoolCurrentUtilization,_R:myNodeMemoryPoolLowestUtilization,_S:myNodeMemoryPoolLargestUtilization,_T:myNodeMemoryPoolSize,_U:myNodeMemoryPoolUsed,_V:myNodeMemoryPoolFree,_W:myNodeMemoryPoolWarning,_X:myNodeMemoryPoolCritical,'myMemoryMIBConformance':myMemoryMIBConformance,'myMemoryMIBCompliances':myMemoryMIBCompliances,'myMemoryMIBCompliance':myMemoryMIBCompliance,'myMemoryMIBGroups':myMemoryMIBGroups,_Y:myMemoryPoolUtilizationMIBGroup,'myNodeMemoryPoolMIBGroup':myNodeMemoryPoolMIBGroup})