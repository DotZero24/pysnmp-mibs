...
class CableLengthRange(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3,4,5)));namedValues=NamedValues(*(('lengthUnknown',0),('lengthLessThan50M',1),('length50MTo80M',2),('length80MTo110M',3),('length110MTo140M',4),('lengthMoreThan140M',5)))
_RlGreenEthEnergyDetectEnable_Type=TruthValue
_RlGreenEthEnergyDetectEnable_Object=MibScalar
rlGreenEthEnergyDetectEnable=_RlGreenEthEnergyDetectEnable_Object((1,3,6,1,4,1,9,6,1,101,134,1),_RlGreenEthEnergyDetectEnable_Type())
...
rlGreenEthShortReachEnable=_RlGreenEthShortReachEnable_Object((1,3,6,1,4,1,9,6,1,101,134,2),_RlGreenEthShortReachEnable_Type())
...
rlGreenEthCurrentEnergyConsumption=_RlGreenEthCurrentEnergyConsumption_Object((1,3,6,1,4,1,9,6,1,101,134,3),_RlGreenEthCurrentEnergyConsumption_Type())
...
rlGreenEthCurrentMaxEnergyConsumption=_RlGreenEthCurrentMaxEnergyConsumption_Object((1,3,6,1,4,1,9,6,1,101,134,4),_RlGreenEthCurrentMaxEnergyConsumption_Type())
...
rlGreenEthCumulativePowerSaveMeter=_RlGreenEthCumulativePowerSaveMeter_Object((1,3,6,1,4,1,9,6,1,101,134,5),_RlGreenEthCumulativePowerSaveMeter_Type())
...
rlGreenEthShortReachThreshold=_RlGreenEthShortReachThreshold_Object((1,3,6,1,4,1,9,6,1,101,134,6),_RlGreenEthShortReachThreshold_Type())
...
rlGreenEthCumulativePowerSaveMeterReset=_RlGreenEthCumulativePowerSaveMeterReset_Object((1,3,6,1,4,1,9,6,1,101,134,7),_RlGreenEthCumulativePowerSaveMeterReset_Type())
...
rlGreenEthPortTable=_RlGreenEthPortTable_Object((1,3,6,1,4,1,9,6,1,101,134,8))
if mibBuilder.loadTexts:rlGreenEthPortTable.setStatus(_A)
_RlGreenEthPortEntry_Object=MibTableRow
rlGreenEthPortEntry=_RlGreenEthPortEntry_Object((1,3,6,1,4,1,9,6,1,101,134,8,1))
...
rlGreenEthPortSavingTypeValue=_RlGreenEthPortSavingTypeValue_Object((1,3,6,1,4,1,9,6,1,101,134,8,1,1),_RlGreenEthPortSavingTypeValue_Type())
...
rlGreenEthPortAdminState=_RlGreenEthPortAdminState_Object((1,3,6,1,4,1,9,6,1,101,134,8,1,2),_RlGreenEthPortAdminState_Type())
...
rlGreenEthPortOperState=_RlGreenEthPortOperState_Object((1,3,6,1,4,1,9,6,1,101,134,8,1,3),_RlGreenEthPortOperState_Type())
...
rlGreenEthPortNonOperReason=_RlGreenEthPortNonOperReason_Object((1,3,6,1,4,1,9,6,1,101,134,8,1,4),_RlGreenEthPortNonOperReason_Type())
...
rlGreenEthPortCableLength=_RlGreenEthPortCableLength_Object((1,3,6,1,4,1,9,6,1,101,134,8,1,5),_RlGreenEthPortCableLength_Type())
rlGreenEthPortCableLength.setMaxAccess(_C)
if mibBuilder.loadTexts:rlGreenEthPortCableLength.setStatus(_A)
...
rlGreenEthForceShortReachIfIndexList=_RlGreenEthForceShortReachIfIndexList_Object((1,3,6,1,4,1,9,6,1,101,134,9),_RlGreenEthForceShortReachIfIndexList_Type())
rlGreenEthForceShortReachIfIndexList.setMaxAccess(_B)
if mibBuilder.loadTexts:rlGreenEthForceShortReachIfIndexList.setStatus('deprecated')
