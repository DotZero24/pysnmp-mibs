...
# Notes
# -----
# ASN.1 source file://mibs/rfc/FCIP-MGMT-MIB
...
_FcipEntityTcpConnPort_Type.__name__ = "InetPortNumber"
...
_FcipLinkCost_Type.__name__ = "Unsigned32"
...
fcipCompliance.setObjects(
      *(("FCIP-MGMT-MIB", "fcipEntityScalarGroup"),
        ("FCIP-MGMT-MIB", "fcipEntityInstanceGroup"),
        ("FCIP-MGMT-MIB", "fcipLinkGroup"),
        ("FCIP-MGMT-MIB", "fcipTcpConnGroup"),
        ("FCIP-MGMT-MIB", "fcipDiscoveryDomainGroup"),
        ("FCIP-MGMT-MIB", "fcipLinkErrorsGroup"),
