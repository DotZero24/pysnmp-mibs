...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cabletron/CTRON-SFPS-MCAST-MIB
...
sfpsMcastCnxAPI, sfpsMcastIPRouter, sfpsMcastIPReceiverInfoBase, sfpsMcastCnx, sfpsMcastIPSIBApi, sfpsMcastConfigApi, sfpsMcastIPSenderInfoBase, sfpsMcastIPRIBApi = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "sfpsMcastCnxAPI", "sfpsMcastIPRouter", "sfpsMcastIPReceiverInfoBase", "sfpsMcastCnx", "sfpsMcastIPSIBApi", "sfpsMcastConfigApi", "sfpsMcastIPSenderInfoBase", "sfpsMcastIPRIBApi")
...
mibBuilder.exportSymbols("CTRON-SFPS-MCAST-MIB", sfpsMcastCnxAPIGroup=sfpsMcastCnxAPIGroup, sfpsMcastIPRouterRouterIP=sfpsMcastIPRouterRouterIP, sfpsMcastIPRIBAge=sfpsMcastIPRIBAge, sfpsMcastIPSIBInclusion=sfpsMcastIPSIBInclusion, sfpsMcastIPRouterTable=sfpsMcastIPRouterTable, sfpsMcastCnxNextSw=sfpsMcastCnxNextSw, sfpsMcastIPSIBTable=sfpsMcastIPSIBTable, sfpsMcastCnxAPIOutPort=sfpsMcastCnxAPIOutPort, sfpsMcastCnxSenderSw=sfpsMcastCnxSenderSw, sfpsMcastIPRIBTable=sfpsMcastIPRIBTable, sfpsMcastIPRouterIfNum=sfpsMcastIPRouterIfNum, sfpsMcastIPRIBEntry=sfpsMcastIPRIBEntry, sfpsMcastConfigApiRDPktBuffs=sfpsMcastConfigApiRDPktBuffs, sfpsMcastIPRouterAPIRouterIP=sfpsMcastIPRouterAPIRouterIP, sfpsMcastConfigApiRemapDelay=sfpsMcastConfigApiRemapDelay, sfpsMcastIPSIBSender=sfpsMcastIPSIBSender, sfpsMcastIPSibApiGroup=sfpsMcastIPSibApiGroup, sfpsMcastConfigApiMcribSize=sfpsMcastConfigApiMcribSize, sfpsMcastConfigApiDynamicQuery=sfpsMcastConfigApiDynamicQuery, sfpsMcastCnxAge=sfpsMcastCnxAge, sfpsMcastIPSIBEntry=sfpsMcastIPSIBEntry, sfpsMcastIPRIBApiPort=sfpsMcastIPRIBApiPort, sfpsMcastConfigApiQHighLimit=sfpsMcastConfigApiQHighLimit, sfpsMcastIPSibApiVerb=sfpsMcastIPSibApiVerb, sfpsMcastCnxSource=sfpsMcastCnxSource, sfpsMcastConfigApiMaxNonFilters=sfpsMcastConfigApiMaxNonFilters, sfpsMcastIPRouterEntry=sfpsMcastIPRouterEntry, sfpsMcastCnxAPISenderSw=sfpsMcastCnxAPISenderSw, sfpsMcastIPRIBApiGroup=sfpsMcastIPRIBApiGroup, sfpsMcastCnxAPISource=sfpsMcastCnxAPISource, sfpsMcastCnxOutPorts=sfpsMcastCnxOutPorts, sfpsMcastConfigApiStaticTblSize=sfpsMcastConfigApiStaticTblSize, sfpsMcastIPSIBAge=sfpsMcastIPSIBAge, sfpsMcastIPRouterVlanId=sfpsMcastIPRouterVlanId, sfpsMcastCnxAPITTL=sfpsMcastCnxAPITTL, sfpsMcastConfigApiSenderTableSize=sfpsMcastConfigApiSenderTableSize, sfpsMcastConfigApiDebugLog=sfpsMcastConfigApiDebugLog, sfpsMcastIPSibApiSender=sfpsMcastIPSibApiSender, sfpsMcastCnxGroup=sfpsMcastCnxGroup, SfpsAddress=SfpsAddress, sfpsMcastCnxAPIFilters=sfpsMcastCnxAPIFilters, sfpsMcastCnxAPIInPort=sfpsMcastCnxAPIInPort, sfpsMcastCnxAPIVerb=sfpsMcastCnxAPIVerb, sfpsMcastIPRouterAPIVlanId=sfpsMcastIPRouterAPIVlanId, sfpsMcastConfigApiRefreshInterval=sfpsMcastConfigApiRefreshInterval, sfpsMcastIPRIBRcvPorts=sfpsMcastIPRIBRcvPorts, sfpsMcastIPRIBApiVerb=sfpsMcastIPRIBApiVerb, sfpsMcastConfigApiQLowLimit=sfpsMcastConfigApiQLowLimit, sfpsMcastConfigApiMcastMode=sfpsMcastConfigApiMcastMode, sfpsMcastConfigApiSndrAgeOut=sfpsMcastConfigApiSndrAgeOut, sfpsMcastConfigApiSndersPerAncmt=sfpsMcastConfigApiSndersPerAncmt, sfpsMcastCnxTTL=sfpsMcastCnxTTL, sfpsMcastCnxInPort=sfpsMcastCnxInPort, sfpsMcastIPRouterAPIIFNum=sfpsMcastIPRouterAPIIFNum, sfpsMcastIPRIBGroup=sfpsMcastIPRIBGroup, sfpsMcastIPSIBGroup=sfpsMcastIPSIBGroup, sfpsMcastIPRIBInclusion=sfpsMcastIPRIBInclusion, sfpsMcastIPRouterAPITTLScope=sfpsMcastIPRouterAPITTLScope, sfpsMcastIPRIBOrigin=sfpsMcastIPRIBOrigin, sfpsMcastCnxStatus=sfpsMcastCnxStatus, sfpsMcastIPRouterTTL=sfpsMcastIPRouterTTL, sfpsMcastConfigApiPendingMaps=sfpsMcastConfigApiPendingMaps, sfpsMcastCnxAPINonFilters=sfpsMcastCnxAPINonFilters, sfpsMcastCnxDestination=sfpsMcastCnxDestination, sfpsMcastCnxAPIDestination=sfpsMcastCnxAPIDestination, sfpsMcastIPRouterAPIVerb=sfpsMcastIPRouterAPIVerb, sfpsMcastConfigApiRDRetryBuffs=sfpsMcastConfigApiRDRetryBuffs)
