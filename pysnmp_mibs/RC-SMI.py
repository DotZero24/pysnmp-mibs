#
# PySNMP MIB module RC-SMI (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/huawei/RC-SMI
...
rc = ModuleIdentity((1, 3, 6, 1, 4, 1, 65000))
rc.setRevisions(('2012-12-12 00:00',))
if mibBuilder.loadTexts: rc.setLastUpdated('201212120000Z')
if mibBuilder.loadTexts: rc.setOrganization('Resource Control System')
mibBuilder.exportSymbols("RC-SMI", rc=rc, PYSNMP_MODULE_ID=rc)
