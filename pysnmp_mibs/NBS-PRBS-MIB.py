...
mibBuilder.exportSymbols("NBS-PRBS-MIB", nbsPrbsCheckErrors=nbsPrbsCheckErrors, nbsPrbsCheckIfIndex=nbsPrbsCheckIfIndex, nbsPrbsPatternGrp=nbsPrbsPatternGrp, nbsPrbsGenGrp=nbsPrbsGenGrp, nbsPrbsGenAction=nbsPrbsGenAction, nbsPrbsGenTableSize=nbsPrbsGenTableSize, nbsPrbsGenPatternCaps=nbsPrbsGenPatternCaps, nbsPrbsGenIfIndex=nbsPrbsGenIfIndex, nbsPrbsCheckGrp=nbsPrbsCheckGrp, nbsPrbsGenProgress=nbsPrbsGenProgress, nbsPrbsCheckAction=nbsPrbsCheckAction, nbsPrbsTrapCheckerErrorDetected=nbsPrbsTrapCheckerErrorDetected, nbsPrbsGenStatus=nbsPrbsGenStatus, nbsPrbsTrapGrp=nbsPrbsTrapGrp, nbsPrbsCheckPatternIndex=nbsPrbsCheckPatternIndex, nbsPrbsCheckEntry=nbsPrbsCheckEntry, nbsPrbsTrapGeneratorStarted=nbsPrbsTrapGeneratorStarted, nbsPrbsGenEntry=nbsPrbsGenEntry, nbsPrbsTraps0=nbsPrbsTraps0, nbsPrbsGenDuration=nbsPrbsGenDuration, nbsPrbsCheckStatus=nbsPrbsCheckStatus, nbsPrbsCheckDurationMax=nbsPrbsCheckDurationMax, nbsPrbsTrapCheckerOverflowed=nbsPrbsTrapCheckerOverflowed, nbsPrbsCheckDuration=nbsPrbsCheckDuration, nbsPrbsTrapCheckerStarted=nbsPrbsTrapCheckerStarted, nbsPrbsTrapCheckerStopped=nbsPrbsTrapCheckerStopped, nbsPrbsCheckTable=nbsPrbsCheckTable, nbsPrbsMib=nbsPrbsMib, nbsPrbsTrapCheckerStatusUpdate=nbsPrbsTrapCheckerStatusUpdate, nbsPrbsGenTable=nbsPrbsGenTable, nbsPrbsPatternTableSize=nbsPrbsPatternTableSize, nbsPrbsPatternName=nbsPrbsPatternName, nbsPrbsCheckPatternCaps=nbsPrbsCheckPatternCaps, nbsPrbsCheckProgress=nbsPrbsCheckProgress, nbsPrbsTrapCheckerSyncOut=nbsPrbsTrapCheckerSyncOut, nbsPrbsCheckUpdateFreq=nbsPrbsCheckUpdateFreq, nbsPrbsCheckTableSize=nbsPrbsCheckTableSize, PYSNMP_MODULE_ID=nbsPrbsMib, nbsPrbsPatternIndex=nbsPrbsPatternIndex, nbsPrbsGenDurationMax=nbsPrbsGenDurationMax, nbsPrbsPatternTable=nbsPrbsPatternTable, nbsPrbsTrapCheckerSyncIn=nbsPrbsTrapCheckerSyncIn, nbsPrbsGenPatternIndex=nbsPrbsGenPatternIndex, nbsPrbsTrapGeneratorStopped=nbsPrbsTrapGeneratorStopped, nbsPrbsPatternDesc=nbsPrbsPatternDesc, nbsPrbsPatternEntry=nbsPrbsPatternEntry)
