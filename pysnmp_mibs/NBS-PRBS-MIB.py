...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/mrv/NBS-PRBS-MIB
...
nbsCmmcChassisIndex, nbsCmmcPortName, nbsCmmcPortIndex, nbsCmmcSlotIndex = mibBuilder.importSymbols("NBS-CMMC-MIB", "nbsCmmcChassisIndex", "nbsCmmcPortName", "nbsCmmcPortIndex", "nbsCmmcSlotIndex")
...
mibBuilder.exportSymbols("NBS-PRBS-MIB", nbsPrbsCheckProgress=nbsPrbsCheckProgress, nbsPrbsGenEntry=nbsPrbsGenEntry, nbsPrbsPatternDesc=nbsPrbsPatternDesc, nbsPrbsGenDuration=nbsPrbsGenDuration, nbsPrbsCheckPatternCaps=nbsPrbsCheckPatternCaps, nbsPrbsCheckEntry=nbsPrbsCheckEntry, nbsPrbsTrapCheckerErrorDetected=nbsPrbsTrapCheckerErrorDetected, nbsPrbsCheckUpdateFreq=nbsPrbsCheckUpdateFreq, nbsPrbsGenAction=nbsPrbsGenAction, nbsPrbsCheckErrors=nbsPrbsCheckErrors, nbsPrbsTrapCheckerOverflowed=nbsPrbsTrapCheckerOverflowed, nbsPrbsCheckTableSize=nbsPrbsCheckTableSize, nbsPrbsPatternTableSize=nbsPrbsPatternTableSize, nbsPrbsTrapGrp=nbsPrbsTrapGrp, nbsPrbsCheckGrp=nbsPrbsCheckGrp, nbsPrbsPatternEntry=nbsPrbsPatternEntry, nbsPrbsGenIfIndex=nbsPrbsGenIfIndex, nbsPrbsCheckPatternIndex=nbsPrbsCheckPatternIndex, nbsPrbsGenPatternCaps=nbsPrbsGenPatternCaps, nbsPrbsTrapGeneratorStopped=nbsPrbsTrapGeneratorStopped, nbsPrbsCheckIfIndex=nbsPrbsCheckIfIndex, nbsPrbsCheckDuration=nbsPrbsCheckDuration, nbsPrbsTrapGeneratorStarted=nbsPrbsTrapGeneratorStarted, nbsPrbsTraps0=nbsPrbsTraps0, nbsPrbsTrapCheckerSyncOut=nbsPrbsTrapCheckerSyncOut, nbsPrbsPatternName=nbsPrbsPatternName, nbsPrbsGenStatus=nbsPrbsGenStatus, nbsPrbsPatternIndex=nbsPrbsPatternIndex, nbsPrbsGenGrp=nbsPrbsGenGrp, nbsPrbsTrapCheckerStatusUpdate=nbsPrbsTrapCheckerStatusUpdate, nbsPrbsTrapCheckerStopped=nbsPrbsTrapCheckerStopped, nbsPrbsGenPatternIndex=nbsPrbsGenPatternIndex, PYSNMP_MODULE_ID=nbsPrbsMib, nbsPrbsCheckStatus=nbsPrbsCheckStatus, nbsPrbsGenTable=nbsPrbsGenTable, nbsPrbsCheckDurationMax=nbsPrbsCheckDurationMax, nbsPrbsTrapCheckerStarted=nbsPrbsTrapCheckerStarted, nbsPrbsCheckAction=nbsPrbsCheckAction, nbsPrbsPatternTable=nbsPrbsPatternTable, nbsPrbsCheckTable=nbsPrbsCheckTable, nbsPrbsTrapCheckerSyncIn=nbsPrbsTrapCheckerSyncIn, nbsPrbsMib=nbsPrbsMib, nbsPrbsPatternGrp=nbsPrbsPatternGrp, nbsPrbsGenTableSize=nbsPrbsGenTableSize, nbsPrbsGenDurationMax=nbsPrbsGenDurationMax, nbsPrbsGenProgress=nbsPrbsGenProgress)
