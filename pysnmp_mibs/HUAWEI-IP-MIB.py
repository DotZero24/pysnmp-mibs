...
rIp=_RIp_ObjectIdentity((1,3,6,1,4,1,2011,1,3,1))
_IpTooShorts_Type=Counter32
_IpTooShorts_Object=MibScalar
ipTooShorts=_IpTooShorts_Object((1,3,6,1,4,1,2011,1,3,1,1),_IpTooShorts_Type())
...
ipTooSmalls=_IpTooSmalls_Object((1,3,6,1,4,1,2011,1,3,1,2),_IpTooSmalls_Type())
...
ipBadVersions=_IpBadVersions_Object((1,3,6,1,4,1,2011,1,3,1,3),_IpBadVersions_Type())
...
ipBadChecksums=_IpBadChecksums_Object((1,3,6,1,4,1,2011,1,3,1,4),_IpBadChecksums_Type())
...
ipBadLens=_IpBadLens_Object((1,3,6,1,4,1,2011,1,3,1,5),_IpBadLens_Type())
...
ipBadHeadLens=_IpBadHeadLens_Object((1,3,6,1,4,1,2011,1,3,1,6),_IpBadHeadLens_Type())
...
ipBadOptions=_IpBadOptions_Object((1,3,6,1,4,1,2011,1,3,1,7),_IpBadOptions_Type())
...
ipFragDroppeds=_IpFragDroppeds_Object((1,3,6,1,4,1,2011,1,3,1,8),_IpFragDroppeds_Type())
...
ipRawOuts=_IpRawOuts_Object((1,3,6,1,4,1,2011,1,3,1,9),_IpRawOuts_Type())
...
ipRouteBadRedirects=_IpRouteBadRedirects_Object((1,3,6,1,4,1,2011,1,3,1,10),_IpRouteBadRedirects_Type())
...
ipRouteDynamics=_IpRouteDynamics_Object((1,3,6,1,4,1,2011,1,3,1,11),_IpRouteDynamics_Type())
...
ipRouteNewGateways=_IpRouteNewGateways_Object((1,3,6,1,4,1,2011,1,3,1,12),_IpRouteNewGateways_Type())
...
ipRouteUnreachs=_IpRouteUnreachs_Object((1,3,6,1,4,1,2011,1,3,1,13),_IpRouteUnreachs_Type())
