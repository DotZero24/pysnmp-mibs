...
mibBuilder.exportSymbols("HPN-ICF-NTP-MIB", hpnicfNTPPeerLeap=hpnicfNTPPeerLeap, hpnicfNTPSysPeer=hpnicfNTPSysPeer, hpnicfNTPPeerRowStatus=hpnicfNTPPeerRowStatus, hpnicfNTPSysRootdispersion=hpnicfNTPSysRootdispersion, hpnicfNTPSysClock=hpnicfNTPSysClock, hpnicfNTPSysStabil=hpnicfNTPSysStabil, hpnicfNTPPeerStratum=hpnicfNTPPeerStratum, hpnicfNTPPeerRootDispersion=hpnicfNTPPeerRootDispersion, hpnicfNTPPeerFlash=hpnicfNTPPeerFlash, hpnicfNTPPeerValid=hpnicfNTPPeerValid, hpnicfNTPSysOffset=hpnicfNTPSysOffset, hpnicfNTPPeerRemAdr=hpnicfNTPPeerRemAdr, hpnicfNTPPeerFiltError=hpnicfNTPPeerFiltError, hpnicfNTPPeerHPoll=hpnicfNTPPeerHPoll, hpnicfNTPServerIP=hpnicfNTPServerIP, hpnicfNTPPeerRec=hpnicfNTPPeerRec, hpnicfNTPPeerFiltDelay=hpnicfNTPPeerFiltDelay, hpnicfNTPPeerTimer=hpnicfNTPPeerTimer, hpnicfNTPSysPollSec=hpnicfNTPSysPollSec, hpnicfNTPPeerReceived=hpnicfNTPPeerReceived, hpnicfNTPSysPrecision=hpnicfNTPSysPrecision, hpnicfNTPPeerAuthentic=hpnicfNTPPeerAuthentic, hpnicfNTPSystemMIBObjects=hpnicfNTPSystemMIBObjects, hpnicfNTP=hpnicfNTP, hpnicfNTPPeerLocPort=hpnicfNTPPeerLocPort, hpnicfNTPPeerXmt=hpnicfNTPPeerXmt, hpnicfNTPPeerRootDelay=hpnicfNTPPeerRootDelay, hpnicfNTPSysLeap=hpnicfNTPSysLeap, hpnicfNTPPeerHMode=hpnicfNTPPeerHMode, hpnicfNTPPeerDelay=hpnicfNTPPeerDelay, hpnicfNTPPeerRemPort=hpnicfNTPPeerRemPort, hpnicfNTPPeerTable=hpnicfNTPPeerTable, hpnicfNTPPeerSent=hpnicfNTPPeerSent, hpnicfNTPSysReftime=hpnicfNTPSysReftime, hpnicfNTPPeerKeyId=hpnicfNTPPeerKeyId, hpnicfNTPSysStratum=hpnicfNTPSysStratum, hpnicfNTPPeerMIB=hpnicfNTPPeerMIB, hpnicfNTPPeerFiltOffset=hpnicfNTPPeerFiltOffset, hpnicfNTPPeerDispersion=hpnicfNTPPeerDispersion, hpnicfNTPSysClockSec=hpnicfNTPSysClockSec, hpnicfNTPSysCompliance=hpnicfNTPSysCompliance, hpnicfNTPPeerRefTime=hpnicfNTPPeerRefTime, hpnicfNTPPeerMIBObjects=hpnicfNTPPeerMIBObjects, hpnicfNTPSysSrcPeer=hpnicfNTPSysSrcPeer, hpnicfNTPPeerConfig=hpnicfNTPPeerConfig, hpnicfNTPPeerOffset=hpnicfNTPPeerOffset, hpnicfNTPPeerAuthenable=hpnicfNTPPeerAuthenable, hpnicfNTPSysAuthenticate=hpnicfNTPSysAuthenticate, hpnicfNTPPeerOrg=hpnicfNTPPeerOrg, hpnicfNTPSysDrift=hpnicfNTPSysDrift, hpnicfNTPPeerLocAdr=hpnicfNTPPeerLocAdr, hpnicfNTPPeerPPoll=hpnicfNTPPeerPPoll, hpnicfNTPSystemMIB=hpnicfNTPSystemMIB, hpnicfNTPPeerRefId=hpnicfNTPPeerRefId, hpnicfNTPSysRootdelay=hpnicfNTPSysRootdelay, hpnicfNTPPeerEntry=hpnicfNTPPeerEntry, hpnicfNTPPeerReach=hpnicfNTPPeerReach, hpnicfNTPSysState=hpnicfNTPSysState, hpnicfNTPPeerJitter=hpnicfNTPPeerJitter, hpnicfNTPSysPoll=hpnicfNTPSysPoll, hpnicfNTPPeerPMode=hpnicfNTPPeerPMode, PYSNMP_MODULE_ID=hpnicfNTP, hpnicfNTPPeerPrecision=hpnicfNTPPeerPrecision, hpnicfNTPSysRefid=hpnicfNTPSysRefid)
