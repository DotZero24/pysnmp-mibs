...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-SYSLOG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:17:46 2025
...
class _H3cSyslogState2_Type(Integer32):
    """Custom type h3cSyslogState2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_H3cSyslogState2_Type.__name__ = "Integer32"
_H3cSyslogState2_Object = MibScalar
h3cSyslogState2 = _H3cSyslogState2_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 63, 1, 1, 6),
    _H3cSyslogState2_Type()
)
h3cSyslogState2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cSyslogState2.setStatus("current")
...
h3cSyslogLogbufContTable = _H3cSyslogLogbufContTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 63, 1, 5, 4)
)
if mibBuilder.loadTexts:
    h3cSyslogLogbufContTable.setStatus("current")
_H3cSyslogLogbufContEntry_Object = MibTableRow
h3cSyslogLogbufContEntry = _H3cSyslogLogbufContEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 63, 1, 5, 4, 1)
)
h3cSyslogLogbufContEntry.setIndexNames(
    (0, "H3C-SYSLOG-MIB", "h3cLogbufContIndex"),
)
if mibBuilder.loadTexts:
    h3cSyslogLogbufContEntry.setStatus("current")


class _H3cLogbufContIndex_Type(Integer32):
    """Custom type h3cLogbufContIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cLogbufContIndex_Type.__name__ = "Integer32"
_H3cLogbufContIndex_Object = MibTableColumn
h3cLogbufContIndex = _H3cLogbufContIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 63, 1, 5, 4, 1, 1),
    _H3cLogbufContIndex_Type()
)
h3cLogbufContIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cLogbufContIndex.setStatus("current")


class _H3cLogbufContDescription_Type(DisplayString):
    """Custom type h3cLogbufContDescription based on DisplayString"""
...
_H3cLogbufContDescription_Type.__name__ = "DisplayString"
_H3cLogbufContDescription_Object = MibTableColumn
h3cLogbufContDescription = _H3cLogbufContDescription_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 63, 1, 5, 4, 1, 2),
    _H3cLogbufContDescription_Type()
)
h3cLogbufContDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cLogbufContDescription.setStatus("current")
...
h3cSyslogLoghostTAddress = _H3cSyslogLoghostTAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 63, 1, 7, 3, 1, 9),
...
h3cSyslogLogGlobalLevel = _H3cSyslogLogGlobalLevel_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 63, 1, 10, 3),
    _H3cSyslogLogGlobalLevel_Type()
)
h3cSyslogLogGlobalLevel.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cSyslogLogGlobalLevel.setStatus("obsolete")


class _H3cSyslogLogGlobalLevelRfc_Type(Integer32):
    """Custom type h3cSyslogLogGlobalLevelRfc based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_H3cSyslogLogGlobalLevelRfc_Type.__name__ = "Integer32"
_H3cSyslogLogGlobalLevelRfc_Object = MibScalar
h3cSyslogLogGlobalLevelRfc = _H3cSyslogLogGlobalLevelRfc_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 63, 1, 10, 4),
    _H3cSyslogLogGlobalLevelRfc_Type()
)
h3cSyslogLogGlobalLevelRfc.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cSyslogLogGlobalLevelRfc.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"MessageLevelType": MessageLevelType,
       ...
       "h3cSyslogState2": h3cSyslogState2,
       ...
       "h3cSyslogLogbufContTable": h3cSyslogLogbufContTable,
       "h3cSyslogLogbufContEntry": h3cSyslogLogbufContEntry,
       "h3cLogbufContIndex": h3cLogbufContIndex,
       "h3cLogbufContDescription": h3cLogbufContDescription,
