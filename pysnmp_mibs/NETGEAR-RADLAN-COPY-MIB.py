# SNMP MIB module (NETGEAR-RADLAN-COPY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-COPY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:27:09 2025
...
rlCopyMessagesEntry = _RlCopyMessagesEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 87, 6, 1)
)
rlCopyMessagesEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-COPY-MIB", "rlCopyMessagesCopyIndex"),
    (0, "NETGEAR-RADLAN-COPY-MIB", "rlCopyMessagesMessageIndex"),
)
if mibBuilder.loadTexts:
...
rlCopyHistoryInetEntry = _RlCopyHistoryInetEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 87, 9, 1)
)
rlCopyHistoryInetEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-COPY-MIB", "rlCopyHistoryInetHistoryIndex"),
)
if mibBuilder.loadTexts:
...
rlCopySWToUnits = NotificationType(
    (1, 3, 6, 1, 4, 1, 4526, 17, 0, 212)
)
rlCopySWToUnits.setObjects(
      *(("NETGEAR-RADLAN-DEVICEPARAMS-MIB", "rndErrorDesc"),
        ("NETGEAR-RADLAN-DEVICEPARAMS-MIB", "rndErrorSeverity"),
        ("NETGEAR-RADLAN-COPY-MIB", "rlCopyUnitsList"))
)
if mibBuilder.loadTexts:
