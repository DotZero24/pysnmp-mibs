...
# Notes
# -----
# ASN.1 source file://mibs/rfc/SNMP-TLS-TM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:18:52 2025
...
_SnmpTlstmCertToTSNMapType_Type.__name__ = "AutonomousType"
...
_SnmpTlstmCertToTSNStorageType_Type.__name__ = "StorageType"
...
_SnmpTlstmParamsStorageType_Type.__name__ = "StorageType"
...
class _SnmpTlstmAddrServerFingerprint_Type(SnmpTLSFingerprint):
    """Custom type snmpTlstmAddrServerFingerprint based on SnmpTLSFingerprint"""
    defaultValue = OctetString("")


_SnmpTlstmAddrServerFingerprint_Type.__name__ = "SnmpTLSFingerprint"
...
class _SnmpTlstmAddrServerIdentity_Type(SnmpAdminString):
    """Custom type snmpTlstmAddrServerIdentity based on SnmpAdminString"""
    defaultValue = OctetString("")


_SnmpTlstmAddrServerIdentity_Type.__name__ = "SnmpAdminString"
...
_SnmpTlstmAddrStorageType_Type.__name__ = "StorageType"
...
snmpTlstmCompliance.setObjects(
      *(("SNMP-TLS-TM-MIB", "snmpTlstmStatsGroup"),
        ("SNMP-TLS-TM-MIB", "snmpTlstmIncomingGroup"),
        ("SNMP-TLS-TM-MIB", "snmpTlstmOutgoingGroup"),
        ("SNMP-TLS-TM-MIB", "snmpTlstmNotificationGroup"))
)
if mibBuilder.loadTexts:
