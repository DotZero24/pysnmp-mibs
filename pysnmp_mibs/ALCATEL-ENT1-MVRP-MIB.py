#
# PySNMP MIB module ALCATEL-ENT1-MVRP-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-MVRP-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 09:59:42 2025
...
alaMvrpVlanLimitReachedEvent = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 0, 1)).setObjects(("ALCATEL-ENT1-MVRP-MIB", "alaMvrpMaxVlanLimit"))
if mibBuilder.loadTexts: alaMvrpVlanLimitReachedEvent.setStatus('current')
alaMvrpE2eVlanConflict = NotificationType((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 0, 2)).setObjects(("ALCATEL-ENT1-MVRP-MIB", "alaMvrpVlanConflictInfo"))
...
alaMvrpPortConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 1, 7, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortConfigIfIndex"))
...
alaMvrpPortStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 1, 8, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsIfIndex"))
...
alaMvrpPortRestrictVlanConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 1, 9, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortRestrictVlanIfIndex"), (0, "ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortRestrictVlanID"))
...
alcatelIND1MVRPMIBCompliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 2, 2, 1)).setObjects(("ALCATEL-ENT1-MVRP-MIB", "alaMvrpBaseGroup"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortConfigGroup"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsGroup"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortRestrictVlanConfigGroup"), ("ALCATEL-ENT1-MVRP-MIB", "alaIND1MvrpNotificationGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alcatelIND1MVRPMIBCompliance = alcatelIND1MVRPMIBCompliance.setStatus('current')
alaMvrpBaseGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 2, 1, 1)).setObjects(("ALCATEL-ENT1-MVRP-MIB", "alaMvrpGlobalStatus"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpGlobalClearStats"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpTransparentSwitching"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpMaxVlanLimit"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpVlanConflictInfo"), ("ALCATEL-ENT1-MVRP-MIB", "alaVlanRegistrationProtocolType"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaMvrpBaseGroup = alaMvrpBaseGroup.setStatus('current')
alaMvrpPortConfigGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 2, 1, 2)).setObjects(("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatus"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortConfigRegistrarMode"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortConfigApplicantMode"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortConfigJoinTimer"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortConfigLeaveTimer"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortConfigLeaveAllTimer"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortConfigPeriodicTimer"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortConfigPeriodicTransmissionStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaMvrpPortConfigGroup = alaMvrpPortConfigGroup.setStatus('current')
alaMvrpPortStatsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 2, 1, 3)).setObjects(("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsNewReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsJoinInReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsJoinEmptyReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsLeaveReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsInReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsEmptyReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsLeaveAllReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsNewTransmitted"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsJoinInTransmitted"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsJoinEmptyTransmitted"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsLeaveTransmitted"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsInTransmitted"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsEmptyTransmitted"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsLeaveAllTransmitted"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsTotalPDUReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsTotalPDUTransmitted"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsTotalMsgsReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsTotalMsgsTransmitted"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsInvalidMsgsReceived"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortFailedRegistrations"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortLastPduOrigin"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortStatsClearStats"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaMvrpPortStatsGroup = alaMvrpPortStatsGroup.setStatus('current')
alaMvrpPortRestrictVlanConfigGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 2, 1, 4)).setObjects(("ALCATEL-ENT1-MVRP-MIB", "alaMvrpPortVlanRestrictions"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaMvrpPortRestrictVlanConfigGroup = alaMvrpPortRestrictVlanConfigGroup.setStatus('current')
alaIND1MvrpNotificationGroup = NotificationGroup((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 62, 1, 2, 1, 5)).setObjects(("ALCATEL-ENT1-MVRP-MIB", "alaMvrpVlanLimitReachedEvent"), ("ALCATEL-ENT1-MVRP-MIB", "alaMvrpE2eVlanConflict"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    alaIND1MvrpNotificationGroup = alaIND1MvrpNotificationGroup.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-MVRP-MIB", alaMvrpPortStatsJoinEmptyTransmitted=alaMvrpPortStatsJoinEmptyTransmitted, alaMvrpPortStatsInTransmitted=alaMvrpPortStatsInTransmitted, alcatelIND1MVRPMIB=alcatelIND1MVRPMIB, alaMvrpPortStatsIfIndex=alaMvrpPortStatsIfIndex, alaMvrpPortConfigGroup=alaMvrpPortConfigGroup, alaMvrpPortConfigJoinTimer=alaMvrpPortConfigJoinTimer, alaMvrpPortStatsClearStats=alaMvrpPortStatsClearStats, alaMvrpPortStatsEntry=alaMvrpPortStatsEntry, alcatelIND1MVRPMIBObjects=alcatelIND1MVRPMIBObjects, MvrpPortVlanRestrictBitmap=MvrpPortVlanRestrictBitmap, alaMvrpPortRestrictVlanConfigTable=alaMvrpPortRestrictVlanConfigTable, alaMvrpPortRestrictVlanConfigEntry=alaMvrpPortRestrictVlanConfigEntry, alaMvrpPortRestrictVlanConfigGroup=alaMvrpPortRestrictVlanConfigGroup, alaMvrpBaseGroup=alaMvrpBaseGroup, alaMvrpPortStatsJoinInTransmitted=alaMvrpPortStatsJoinInTransmitted, alcatelIND1MVRPMIBGroups=alcatelIND1MVRPMIBGroups, alaMvrpGlobalStatus=alaMvrpGlobalStatus, alaMvrpPortStatsLeaveAllReceived=alaMvrpPortStatsLeaveAllReceived, alcatelIND1MVRPMIBCompliance=alcatelIND1MVRPMIBCompliance, alaMvrpPortStatsInvalidMsgsReceived=alaMvrpPortStatsInvalidMsgsReceived, alcatelIND1MVRPMIBNotifications=alcatelIND1MVRPMIBNotifications, alaMvrpPortConfigTable=alaMvrpPortConfigTable, alaMvrpPortFailedRegistrations=alaMvrpPortFailedRegistrations, alaMvrpPortStatsLeaveAllTransmitted=alaMvrpPortStatsLeaveAllTransmitted, alaMvrpPortStatsGroup=alaMvrpPortStatsGroup, alcatelIND1MVRPMIBCompliances=alcatelIND1MVRPMIBCompliances, alaMvrpPortStatus=alaMvrpPortStatus, alaMvrpPortConfigEntry=alaMvrpPortConfigEntry, alaMvrpPortConfigRegistrarMode=alaMvrpPortConfigRegistrarMode, alaMvrpPortConfigPeriodicTimer=alaMvrpPortConfigPeriodicTimer, alaMvrpPortVlanRestrictions=alaMvrpPortVlanRestrictions, alaMvrpPortStats=alaMvrpPortStats, alaMvrpPortRestrictVlanID=alaMvrpPortRestrictVlanID, alaMvrpPortStatsNewTransmitted=alaMvrpPortStatsNewTransmitted, alaMvrpPortStatsLeaveReceived=alaMvrpPortStatsLeaveReceived, alaIND1MvrpNotificationGroup=alaIND1MvrpNotificationGroup, alaMvrpPortStatsNewReceived=alaMvrpPortStatsNewReceived, alaMvrpPortLastPduOrigin=alaMvrpPortLastPduOrigin, alaMvrpPortStatsEmptyReceived=alaMvrpPortStatsEmptyReceived, PYSNMP_MODULE_ID=alcatelIND1MVRPMIB, alaMvrpPortConfig=alaMvrpPortConfig, alaMvrpPortStatsTotalMsgsTransmitted=alaMvrpPortStatsTotalMsgsTransmitted, alaMvrpVlanConflictInfo=alaMvrpVlanConflictInfo, alaMvrpPortStatsLeaveTransmitted=alaMvrpPortStatsLeaveTransmitted, alaMvrpPortStatsTotalPDUReceived=alaMvrpPortStatsTotalPDUReceived, alaVlanRegistrationProtocolType=alaVlanRegistrationProtocolType, alaMvrpVlanLimitReachedEvent=alaMvrpVlanLimitReachedEvent, alaMvrpE2eVlanConflict=alaMvrpE2eVlanConflict, alaMvrpPortConfigPeriodicTransmissionStatus=alaMvrpPortConfigPeriodicTransmissionStatus, alaMvrpGlobalClearStats=alaMvrpGlobalClearStats, alaMvrpPortConfigLeaveAllTimer=alaMvrpPortConfigLeaveAllTimer, alaMvrpPortStatsTotalMsgsReceived=alaMvrpPortStatsTotalMsgsReceived, alaMvrpPortRestrictVlanIfIndex=alaMvrpPortRestrictVlanIfIndex, alaMvrpMaxVlanLimit=alaMvrpMaxVlanLimit, alaMvrpPortRestrictVlanConfig=alaMvrpPortRestrictVlanConfig, alaMvrpPortStatsEmptyTransmitted=alaMvrpPortStatsEmptyTransmitted, alaMvrpPortStatsTotalPDUTransmitted=alaMvrpPortStatsTotalPDUTransmitted, alaMvrpPortStatsTable=alaMvrpPortStatsTable, alaMvrpTransparentSwitching=alaMvrpTransparentSwitching, alaMvrpPortConfigLeaveTimer=alaMvrpPortConfigLeaveTimer, alaMvrpPortStatsJoinInReceived=alaMvrpPortStatsJoinInReceived, alaMvrpPortStatsInReceived=alaMvrpPortStatsInReceived, alaMvrpPortStatsJoinEmptyReceived=alaMvrpPortStatsJoinEmptyReceived, alaMvrpPortConfigIfIndex=alaMvrpPortConfigIfIndex, alaMvrpPortConfigApplicantMode=alaMvrpPortConfigApplicantMode, alcatelIND1MVRPMIBConformance=alcatelIND1MVRPMIBConformance)
