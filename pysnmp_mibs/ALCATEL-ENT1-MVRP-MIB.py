...
_D='read-write'
_C='read-only'
_B='ALCATEL-ENT1-MVRP-MIB'
_A='current'
if'mibBuilder'not in globals():import sys;sys.stderr.write(__doc__);sys.exit(1)
Integer,OctetString,ObjectIdentifier=mibBuilder.importSymbols('ASN1','Integer',_K,'ObjectIdentifier')
NamedValues,=mibBuilder.importSymbols('ASN1-ENUMERATION','NamedValues')
ConstraintsIntersection,ConstraintsUnion,SingleValueConstraint,ValueRangeConstraint,ValueSizeConstraint=mibBuilder.importSymbols('ASN1-REFINEMENT','ConstraintsIntersection','ConstraintsUnion','SingleValueConstraint','ValueRangeConstraint','ValueSizeConstraint')
softentIND1Mvrp,=mibBuilder.importSymbols('ALCATEL-ENT1-BASE','softentIND1Mvrp')
...
if mibBuilder.loadTexts:alcatelIND1MVRPMIB.setRevisions(('2010-05-13 00:00','2009-08-07 00:00'))
...
_AlcatelIND1MVRPMIBNotifications_ObjectIdentity=ObjectIdentity
alcatelIND1MVRPMIBNotifications=_AlcatelIND1MVRPMIBNotifications_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,62,1,0))
if mibBuilder.loadTexts:alcatelIND1MVRPMIBNotifications.setStatus(_A)
_AlcatelIND1MVRPMIBObjects_ObjectIdentity=ObjectIdentity
alcatelIND1MVRPMIBObjects=_AlcatelIND1MVRPMIBObjects_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,62,1,1))
...
alaMvrpGlobalStatus=_AlaMvrpGlobalStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,1),_AlaMvrpGlobalStatus_Type())
...
alaMvrpGlobalClearStats=_AlaMvrpGlobalClearStats_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,2),_AlaMvrpGlobalClearStats_Type())
...
alaMvrpTransparentSwitching=_AlaMvrpTransparentSwitching_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,3),_AlaMvrpTransparentSwitching_Type())
...
alaMvrpMaxVlanLimit=_AlaMvrpMaxVlanLimit_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,4),_AlaMvrpMaxVlanLimit_Type())
...
alaMvrpVlanConflictInfo=_AlaMvrpVlanConflictInfo_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,5),_AlaMvrpVlanConflictInfo_Type())
...
alaVlanRegistrationProtocolType=_AlaVlanRegistrationProtocolType_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,6),_AlaVlanRegistrationProtocolType_Type())
...
alaMvrpPortConfig=_AlaMvrpPortConfig_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7))
_AlaMvrpPortConfigTable_Object=MibTable
alaMvrpPortConfigTable=_AlaMvrpPortConfigTable_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1))
if mibBuilder.loadTexts:alaMvrpPortConfigTable.setStatus(_A)
_AlaMvrpPortConfigEntry_Object=MibTableRow
alaMvrpPortConfigEntry=_AlaMvrpPortConfigEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1))
...
alaMvrpPortConfigIfIndex=_AlaMvrpPortConfigIfIndex_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1,1),_AlaMvrpPortConfigIfIndex_Type())
...
alaMvrpPortStatus=_AlaMvrpPortStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1,2),_AlaMvrpPortStatus_Type())
...
alaMvrpPortConfigRegistrarMode=_AlaMvrpPortConfigRegistrarMode_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1,3),_AlaMvrpPortConfigRegistrarMode_Type())
...
alaMvrpPortConfigApplicantMode=_AlaMvrpPortConfigApplicantMode_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1,4),_AlaMvrpPortConfigApplicantMode_Type())
alaMvrpPortConfigApplicantMode.setMaxAccess(_D)
if mibBuilder.loadTexts:alaMvrpPortConfigApplicantMode.setStatus(_A)
class _AlaMvrpPortConfigJoinTimer_Type(Integer32):defaultValue=600;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(250,2147483647))
_AlaMvrpPortConfigJoinTimer_Type.__name__=_E
_AlaMvrpPortConfigJoinTimer_Object=MibTableColumn
alaMvrpPortConfigJoinTimer=_AlaMvrpPortConfigJoinTimer_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1,5),_AlaMvrpPortConfigJoinTimer_Type())
...
alaMvrpPortConfigLeaveTimer=_AlaMvrpPortConfigLeaveTimer_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1,6),_AlaMvrpPortConfigLeaveTimer_Type())
...
alaMvrpPortConfigLeaveAllTimer=_AlaMvrpPortConfigLeaveAllTimer_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1,7),_AlaMvrpPortConfigLeaveAllTimer_Type())
...
alaMvrpPortConfigPeriodicTimer=_AlaMvrpPortConfigPeriodicTimer_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1,8),_AlaMvrpPortConfigPeriodicTimer_Type())
...
alaMvrpPortConfigPeriodicTransmissionStatus=_AlaMvrpPortConfigPeriodicTransmissionStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,7,1,1,9),_AlaMvrpPortConfigPeriodicTransmissionStatus_Type())
...
alaMvrpPortStats=_AlaMvrpPortStats_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8))
_AlaMvrpPortStatsTable_Object=MibTable
alaMvrpPortStatsTable=_AlaMvrpPortStatsTable_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1))
if mibBuilder.loadTexts:alaMvrpPortStatsTable.setStatus(_A)
_AlaMvrpPortStatsEntry_Object=MibTableRow
alaMvrpPortStatsEntry=_AlaMvrpPortStatsEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1))
...
alaMvrpPortStatsIfIndex=_AlaMvrpPortStatsIfIndex_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,1),_AlaMvrpPortStatsIfIndex_Type())
...
alaMvrpPortStatsNewReceived=_AlaMvrpPortStatsNewReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,2),_AlaMvrpPortStatsNewReceived_Type())
...
alaMvrpPortStatsJoinInReceived=_AlaMvrpPortStatsJoinInReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,3),_AlaMvrpPortStatsJoinInReceived_Type())
...
alaMvrpPortStatsJoinEmptyReceived=_AlaMvrpPortStatsJoinEmptyReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,4),_AlaMvrpPortStatsJoinEmptyReceived_Type())
...
alaMvrpPortStatsLeaveReceived=_AlaMvrpPortStatsLeaveReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,5),_AlaMvrpPortStatsLeaveReceived_Type())
...
alaMvrpPortStatsInReceived=_AlaMvrpPortStatsInReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,6),_AlaMvrpPortStatsInReceived_Type())
...
alaMvrpPortStatsEmptyReceived=_AlaMvrpPortStatsEmptyReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,7),_AlaMvrpPortStatsEmptyReceived_Type())
...
alaMvrpPortStatsLeaveAllReceived=_AlaMvrpPortStatsLeaveAllReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,8),_AlaMvrpPortStatsLeaveAllReceived_Type())
...
alaMvrpPortStatsNewTransmitted=_AlaMvrpPortStatsNewTransmitted_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,9),_AlaMvrpPortStatsNewTransmitted_Type())
...
alaMvrpPortStatsJoinInTransmitted=_AlaMvrpPortStatsJoinInTransmitted_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,10),_AlaMvrpPortStatsJoinInTransmitted_Type())
...
alaMvrpPortStatsJoinEmptyTransmitted=_AlaMvrpPortStatsJoinEmptyTransmitted_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,11),_AlaMvrpPortStatsJoinEmptyTransmitted_Type())
...
alaMvrpPortStatsLeaveTransmitted=_AlaMvrpPortStatsLeaveTransmitted_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,12),_AlaMvrpPortStatsLeaveTransmitted_Type())
...
alaMvrpPortStatsInTransmitted=_AlaMvrpPortStatsInTransmitted_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,13),_AlaMvrpPortStatsInTransmitted_Type())
...
alaMvrpPortStatsEmptyTransmitted=_AlaMvrpPortStatsEmptyTransmitted_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,14),_AlaMvrpPortStatsEmptyTransmitted_Type())
...
alaMvrpPortStatsLeaveAllTransmitted=_AlaMvrpPortStatsLeaveAllTransmitted_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,15),_AlaMvrpPortStatsLeaveAllTransmitted_Type())
...
alaMvrpPortStatsTotalPDUReceived=_AlaMvrpPortStatsTotalPDUReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,16),_AlaMvrpPortStatsTotalPDUReceived_Type())
...
alaMvrpPortStatsTotalPDUTransmitted=_AlaMvrpPortStatsTotalPDUTransmitted_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,17),_AlaMvrpPortStatsTotalPDUTransmitted_Type())
...
alaMvrpPortStatsTotalMsgsReceived=_AlaMvrpPortStatsTotalMsgsReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,18),_AlaMvrpPortStatsTotalMsgsReceived_Type())
...
alaMvrpPortStatsTotalMsgsTransmitted=_AlaMvrpPortStatsTotalMsgsTransmitted_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,19),_AlaMvrpPortStatsTotalMsgsTransmitted_Type())
...
alaMvrpPortStatsInvalidMsgsReceived=_AlaMvrpPortStatsInvalidMsgsReceived_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,20),_AlaMvrpPortStatsInvalidMsgsReceived_Type())
...
alaMvrpPortFailedRegistrations=_AlaMvrpPortFailedRegistrations_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,21),_AlaMvrpPortFailedRegistrations_Type())
...
alaMvrpPortLastPduOrigin=_AlaMvrpPortLastPduOrigin_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,22),_AlaMvrpPortLastPduOrigin_Type())
...
alaMvrpPortStatsClearStats=_AlaMvrpPortStatsClearStats_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,8,1,1,23),_AlaMvrpPortStatsClearStats_Type())
...
alaMvrpPortRestrictVlanConfig=_AlaMvrpPortRestrictVlanConfig_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,9))
_AlaMvrpPortRestrictVlanConfigTable_Object=MibTable
alaMvrpPortRestrictVlanConfigTable=_AlaMvrpPortRestrictVlanConfigTable_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,9,1))
...
alaMvrpPortRestrictVlanConfigEntry=_AlaMvrpPortRestrictVlanConfigEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,9,1,1))
...
alaMvrpPortRestrictVlanIfIndex=_AlaMvrpPortRestrictVlanIfIndex_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,9,1,1,1),_AlaMvrpPortRestrictVlanIfIndex_Type())
...
alaMvrpPortRestrictVlanID=_AlaMvrpPortRestrictVlanID_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,9,1,1,2),_AlaMvrpPortRestrictVlanID_Type())
...
alaMvrpPortVlanRestrictions=_AlaMvrpPortVlanRestrictions_Object((1,3,6,1,4,1,6486,801,1,2,1,62,1,1,9,1,1,3),_AlaMvrpPortVlanRestrictions_Type())
...
alcatelIND1MVRPMIBConformance=_AlcatelIND1MVRPMIBConformance_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,62,1,2))
...
alcatelIND1MVRPMIBGroups=_AlcatelIND1MVRPMIBGroups_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,62,1,2,1))
...
alcatelIND1MVRPMIBCompliances=_AlcatelIND1MVRPMIBCompliances_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,62,1,2,2))
if mibBuilder.loadTexts:alcatelIND1MVRPMIBCompliances.setStatus(_A)
alaMvrpBaseGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,62,1,2,1,1))
alaMvrpBaseGroup.setObjects(*((_B,_R),(_B,_S),(_B,_T),(_B,_I),(_B,_J),(_B,_U)))
if mibBuilder.loadTexts:alaMvrpBaseGroup.setStatus(_A)
alaMvrpPortConfigGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,62,1,2,1,2))
...
alaMvrpPortStatsGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,62,1,2,1,3))
...
alaMvrpPortRestrictVlanConfigGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,62,1,2,1,4))
...
alaMvrpVlanLimitReachedEvent=NotificationType((1,3,6,1,4,1,6486,801,1,2,1,62,1,0,1))
alaMvrpVlanLimitReachedEvent.setObjects((_B,_I))
if mibBuilder.loadTexts:alaMvrpVlanLimitReachedEvent.setStatus(_A)
alaMvrpE2eVlanConflict=NotificationType((1,3,6,1,4,1,6486,801,1,2,1,62,1,0,2))
alaMvrpE2eVlanConflict.setObjects((_B,_J))
if mibBuilder.loadTexts:alaMvrpE2eVlanConflict.setStatus(_A)
alaIND1MvrpNotificationGroup=NotificationGroup((1,3,6,1,4,1,6486,801,1,2,1,62,1,2,1,5))
alaIND1MvrpNotificationGroup.setObjects(*((_B,_A0),(_B,_A1)))
if mibBuilder.loadTexts:alaIND1MvrpNotificationGroup.setStatus(_A)
alcatelIND1MVRPMIBCompliance=ModuleCompliance((1,3,6,1,4,1,6486,801,1,2,1,62,1,2,2,1))
