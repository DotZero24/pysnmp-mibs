...
Dot1PPriority, TTcpUdpPortOperator, TPIRRateOrZero, TSapIngressPolicyID, TPortSchedulerPIR, TFCNameOrEmpty, TSapEgressPolicyID, TNamedItem, TIngressQueueId, TItemDescription, TWeight, TIpProtocol, TPIRRate, TPortSchedulerCIR, IpAddressPrefixLength, TDSCPValue, TLspExpValue, TDSCPName, TTcpUdpPort, TDSCPNameOrEmpty, TQueueId, ServiceAccessPoint, TNamedItemOrEmpty, TFrameType, TPolicyID, TmnxEnabledDisabled, TEgressQueueId, TCIRRate, TFCName = mibBuilder.importSymbols("ALCATEL-ENT1-TIMETRA-TC-MIB", "Dot1PPriority", "TTcpUdpPortOperator", "TPIRRateOrZero", "TSapIngressPolicyID", "TPortSchedulerPIR", "TFCNameOrEmpty", "TSapEgressPolicyID", "TNamedItem", "TIngressQueueId", "TItemDescription", "TWeight", "TIpProtocol", "TPIRRate", "TPortSchedulerCIR", "IpAddressPrefixLength", "TDSCPValue", "TLspExpValue", "TDSCPName", "TTcpUdpPort", "TDSCPNameOrEmpty", "TQueueId", "ServiceAccessPoint", "TNamedItemOrEmpty", "TFrameType", "TPolicyID", "TmnxEnabledDisabled", "TEgressQueueId", "TCIRRate", "TFCName")
...
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-QOS-MIB", tQosNotifications=tQosNotifications, tSapIngressFCTable=tSapIngressFCTable, tDSCPNameLastChanged=tDSCPNameLastChanged, TQueueMode=TQueueMode, tSlopeObjects=tSlopeObjects, tmnxQos7450V6v0Compliance=tmnxQos7450V6v0Compliance, tSapIngressDefaultFC=tSapIngressDefaultFC, tSapEgressFCRowStatus=tSapEgressFCRowStatus, tSapEgressQueueTableLastChanged=tSapEgressQueueTableLastChanged, tSapIngressQueueAdminCIR=tSapIngressQueueAdminCIR, tSharedQueuePolicyDescription=tSharedQueuePolicyDescription, tNetworkQueueLevel=tNetworkQueueLevel, tSapEgressQueueMBS=tSapEgressQueueMBS, tSapEgressFCLastChanged=tSapEgressFCLastChanged, tSapIngressQueuePoolName=tSapIngressQueuePoolName, tSharedQueueHiPrioOnly=tSharedQueueHiPrioOnly, tVirtualSchedulerUsePortParent=tVirtualSchedulerUsePortParent, tSapIngressIPCriteriaDestPortOperator=tSapIngressIPCriteriaDestPortOperator, tSapIngressIPCriteriaDestPortValue1=tSapIngressIPCriteriaDestPortValue1, tNetworkQueueCIRLevel=tNetworkQueueCIRLevel, tAtmTdpIndexNext=tAtmTdpIndexNext, tNetworkQueueMBS=tNetworkQueueMBS, tQ1NamedPoolLastChanged=tQ1NamedPoolLastChanged, TAdaptationRule=TAdaptationRule, tNetworkEgressFCForceDEValue=tNetworkEgressFCForceDEValue, tAtmTdpsMaxSupported=tAtmTdpsMaxSupported, tmnxQosSapIpv6FilterR4r0Group=tmnxQosSapIpv6FilterR4r0Group, tVirtualSchedulerTable=tVirtualSchedulerTable, tSapIngressQueuePIRAdaptation=tSapIngressQueuePIRAdaptation, tmnxQosSapEgressV5v0Group=tmnxQosSapEgressV5v0Group, tSapIngressMacCriteriaDstMacMask=tSapIngressMacCriteriaDstMacMask, tSharedQueuePolicyLastChanged=tSharedQueuePolicyLastChanged, tmnxQosSapEgressR2r1Group=tmnxQosSapEgressR2r1Group, tSharedQueuePoolName=tSharedQueuePoolName, tNetworkQueueHiPrioOnly=tNetworkQueueHiPrioOnly, tSapIngressIPCriteriaDescription=tSapIngressIPCriteriaDescription, tVirtualSchedulerEntry=tVirtualSchedulerEntry, tSchedulerPolicyEntry=tSchedulerPolicyEntry, tAtmTdpServCat=tAtmTdpServCat, tNetworkQueuePortAvgOverhead=tNetworkQueuePortAvgOverhead, tQ1NamedPoolDescription=tQ1NamedPoolDescription, tSapIngressFCLastChanged=tSapIngressFCLastChanged, tSapIngressMacCriteriaFrameType=tSapIngressMacCriteriaFrameType, tNetworkQueueFCRowStatus=tNetworkQueueFCRowStatus, tVirtualSchedulerSummedCIR=tVirtualSchedulerSummedCIR, tSapEgressQueueUsePortParent=tSapEgressQueueUsePortParent, tSapIngressPrecTable=tSapIngressPrecTable, tSapEgressQueuePortCIRLvl=tSapEgressQueuePortCIRLvl, tNetworkIngressDSCPFC=tNetworkIngressDSCPFC, tNetworkQueuePortCIRLvl=tNetworkQueuePortCIRLvl, tSapIngressIPv6CriteriaActionPriority=tSapIngressIPv6CriteriaActionPriority, tNetworkIngressDot1pLastChanged=tNetworkIngressDot1pLastChanged, tSlopePolicyTableLastChanged=tSlopePolicyTableLastChanged, tNetworkQueueMCast=tNetworkQueueMCast, tNetworkIngressLSPEXPTableLastChanged=tNetworkIngressLSPEXPTableLastChanged, tSapIngressFCDE1OutOfProfile=tSapIngressFCDE1OutOfProfile, tFCValue=tFCValue, tNetworkEgressFCTableLastChanged=tNetworkEgressFCTableLastChanged, tPortSchedulerPlcyEntry=tPortSchedulerPlcyEntry, tPortSchedulerPlcyLvl6CIR=tPortSchedulerPlcyLvl6CIR, tmnxQosConformance=tmnxQosConformance, tNetworkIngressDot1pProfile=tNetworkIngressDot1pProfile, tSharedQueueObjects=tSharedQueueObjects, tSapEgressQueueCIRWeight=tSapEgressQueueCIRWeight, tmnxQos7450V4v0Compliance=tmnxQos7450V4v0Compliance, tPortSchedulerPlcyLvl5PIR=tPortSchedulerPlcyLvl5PIR, tQosTimeStampObjects=tQosTimeStampObjects, PYSNMP_MODULE_ID=timetraQosMIBModule, tSapEgressQueuePortLvl=tSapEgressQueuePortLvl, tPortSchedulerPlcyLvl2PIR=tPortSchedulerPlcyLvl2PIR, tNetworkPolicyIndex=tNetworkPolicyIndex, tAtmTdpDescription=tAtmTdpDescription, tAtmTdpMir=tAtmTdpMir, tAtmTdpCdvt=tAtmTdpCdvt, tSapIngressQueueRowStatus=tSapIngressQueueRowStatus, tSapEgressFCTable=tSapEgressFCTable, tDSCPNameDscpValue=tDSCPNameDscpValue, tSapEgressQueuePortAvgOverhead=tSapEgressQueuePortAvgOverhead, tNetworkIngressLSPEXPEntry=tNetworkIngressLSPEXPEntry, tNetworkEgressFCDot1pOutProfile=tNetworkEgressFCDot1pOutProfile, tSharedQueuePolicy=tSharedQueuePolicy, tSapEgressFCEntry=tSapEgressFCEntry, tSapIngressIPCriteriaDestIpAddr=tSapIngressIPCriteriaDestIpAddr, tAtmTdpLastChanged=tAtmTdpLastChanged, tSapIngressDSCPTableLastChanged=tSapIngressDSCPTableLastChanged, tSapEgressTable=tSapEgressTable, tSharedQueuePIR=tSharedQueuePIR, tPortSchedulerPlcyLvl6PIR=tPortSchedulerPlcyLvl6PIR, tAtmTdpObjects=tAtmTdpObjects, tSapIngressTable=tSapIngressTable, tNetworkIngressDSCPEntry=tNetworkIngressDSCPEntry, tAtmTdpTable=tAtmTdpTable, tSlopeHiMaxAverage=tSlopeHiMaxAverage, tSapEgressQueueAdminPIR=tSapEgressQueueAdminPIR, tSharedQueueTableLastChanged=tSharedQueueTableLastChanged, tNetworkObjects=tNetworkObjects, tSapIngressDSCPRowStatus=tSapIngressDSCPRowStatus, tSapIngressMacCriteriaRowStatus=tSapIngressMacCriteriaRowStatus, tPortSchedulerPlcyOrphanCIRWght=tPortSchedulerPlcyOrphanCIRWght, tmnxQos7750V5v0Compliance=tmnxQos7750V5v0Compliance, tSapIngressMacCriteriaDstMacAddr=tSapIngressMacCriteriaDstMacAddr, tPoolObjects=tPoolObjects, tSapIngressQueueMBS=tSapIngressQueueMBS, tPortSchedulerPlcyMaxRate=tPortSchedulerPlcyMaxRate, tSapIngressMacCriteriaEntry=tSapIngressMacCriteriaEntry, tSapIngressDot1pFC=tSapIngressDot1pFC, tSapEgressQueueOperPIR=tSapEgressQueueOperPIR, tSapIngressMacCriteriaSSAPMask=tSapIngressMacCriteriaSSAPMask, tNetworkQueueRowStatus=tNetworkQueueRowStatus, TItemScope=TItemScope, tSharedQueueFCName=tSharedQueueFCName, tSapIngressQueueTableLastChanged=tSapIngressQueueTableLastChanged, tVirtualSchedulerName=tVirtualSchedulerName, tSapIngressMacCriteriaSnapOui=tSapIngressMacCriteriaSnapOui, tSapIngressIPv6CriteriaSourcePortValue2=tSapIngressIPv6CriteriaSourcePortValue2, tSharedQueueExpedite=tSharedQueueExpedite, tAtmTdpShaping=tAtmTdpShaping, tPortSchedulerPlcyTable=tPortSchedulerPlcyTable, tNetworkQueueLastChanged=tNetworkQueueLastChanged, tAtmTdpDescrType=tAtmTdpDescrType, tSharedQueueParent=tSharedQueueParent, tNetworkQueueTable=tNetworkQueueTable, tSapEgressTableLastChanged=tSapEgressTableLastChanged, tSapEgressQueueCIRLevel=tSapEgressQueueCIRLevel, tSchedulerPolicyLastChanged=tSchedulerPolicyLastChanged, tmnxQosNetworkV5v0Group=tmnxQosNetworkV5v0Group, tNamedPoolPolicyDescription=tNamedPoolPolicyDescription, tNetworkEgressFCDSCPOutProfile=tNetworkEgressFCDSCPOutProfile, tSapEgressQueueAdminCIR=tSapEgressQueueAdminCIR, tNetworkQueueParent=tNetworkQueueParent, tSapEgressIndex=tSapEgressIndex, tSapIngressDSCP=tSapIngressDSCP, tSapIngressIPv6CriteriaDestPortValue2=tSapIngressIPv6CriteriaDestPortValue2, tNetworkPolicyRowStatus=tNetworkPolicyRowStatus, tAtmTdpCLPTagging=tAtmTdpCLPTagging, tVirtualSchedulerLevel=tVirtualSchedulerLevel, tNetworkQueueFCTable=tNetworkQueueFCTable, tSapIngressMacCriteriaActionFC=tSapIngressMacCriteriaActionFC, tSapIngressDSCPTable=tSapIngressDSCPTable, tSapEgressFCName=tSapEgressFCName, tSapIngressIPv6CriteriaSourceIpMask=tSapIngressIPv6CriteriaSourceIpMask, tPortSchedulerPlcyOrphanWeight=tPortSchedulerPlcyOrphanWeight, tPortSchedulerPlcyLvl3PIR=tPortSchedulerPlcyLvl3PIR, tSapEgressScope=tSapEgressScope, tSapEgressFCInProfPrec=tSapEgressFCInProfPrec, tSapIngressObjects=tSapIngressObjects, tSlopeLastChanged=tSlopeLastChanged, tSharedQueueFCUnknownQueue=tSharedQueueFCUnknownQueue, tNetworkIngressDSCPRowStatus=tNetworkIngressDSCPRowStatus, tSchedulerPolicyFrameBasedAccnt=tSchedulerPolicyFrameBasedAccnt, tSapIngressMacCriteriaSrcMacAddr=tSapIngressMacCriteriaSrcMacAddr, tSapEgressFCDot1PValue=tSapEgressFCDot1PValue, tNetworkEgressFCDSCPInProfile=tNetworkEgressFCDSCPInProfile, tNetworkPolicyIngressLerUseDscp=tNetworkPolicyIngressLerUseDscp, tNetworkIngressDSCPTable=tNetworkIngressDSCPTable, tSapIngressMacCriteriaSSAP=tSapIngressMacCriteriaSSAP, tNetworkEgressFCName=tNetworkEgressFCName, tSapIngressQueueHiPrioOnly=tSapIngressQueueHiPrioOnly, tmnxQosSlopeGroup=tmnxQosSlopeGroup, tVirtualSchedulerPortWght=tVirtualSchedulerPortWght, TNetworkPolicyID=TNetworkPolicyID, tNetworkPolicyLastChanged=tNetworkPolicyLastChanged, tNetworkQueuePortLvl=tNetworkQueuePortLvl, tSharedQueueFCTable=tSharedQueueFCTable, tSchedulerPolicyRowStatus=tSchedulerPolicyRowStatus, tPortSchedulerPlcyLvl8PIR=tPortSchedulerPlcyLvl8PIR, tNetworkIngressDot1pTableLastChanged=tNetworkIngressDot1pTableLastChanged, tQosObjects=tQosObjects, tSapIngressTableLastChanged=tSapIngressTableLastChanged, tNamedPoolPolicyQ1MdaWeight=tNamedPoolPolicyQ1MdaWeight, tNetworkPolicyDescription=tNetworkPolicyDescription, tSapIngressQueueExpedite=tSapIngressQueueExpedite, tSapEgressQueueEntry=tSapEgressQueueEntry, TDEValue=TDEValue, tNetworkIngressLSPEXP=tNetworkIngressLSPEXP, tSapIngressEntry=tSapIngressEntry, tVirtualSchedulerPortLvl=tVirtualSchedulerPortLvl, tVirtualSchedulerLastChanged=tVirtualSchedulerLastChanged, tPortSchedulerPlcyLvl4PIR=tPortSchedulerPlcyLvl4PIR, tSapIngressIPv6CriteriaTable=tSapIngressIPv6CriteriaTable, tNetworkQueuePolicyRowStatus=tNetworkQueuePolicyRowStatus, tPortSchedulerPlcyDescription=tPortSchedulerPlcyDescription, tSapEgressQueuePortCIRWght=tSapEgressQueuePortCIRWght, tSharedQueueTable=tSharedQueueTable, tSapIngressIPv6CriteriaDestPortValue1=tSapIngressIPv6CriteriaDestPortValue1, tQ1NamedPoolNetworkAllocWeight=tQ1NamedPoolNetworkAllocWeight, tNetworkEgressFCDEMark=tNetworkEgressFCDEMark, tSapIngressMacCriteriaTable=tSapIngressMacCriteriaTable, tSapIngressPrecTableLastChanged=tSapIngressPrecTableLastChanged, tSapIngressFCUnknownQueue=tSapIngressFCUnknownQueue, tSapIngressDot1pEntry=tSapIngressDot1pEntry, TRemarkType=TRemarkType, tSapEgressFCForceDEValue=tSapEgressFCForceDEValue, tSharedQueuePolicyTableLastChanged=tSharedQueuePolicyTableLastChanged, TLevel=TLevel, tSapIngressFCOutProfRemark=tSapIngressFCOutProfRemark, tNetworkQueueFCTableLastChanged=tNetworkQueueFCTableLastChanged, tmnxQosNetworkV6v0Group=tmnxQosNetworkV6v0Group, tSapIngressQueueWeight=tSapIngressQueueWeight, tSapEgressQueueExpedite=tSapEgressQueueExpedite, tSapEgressQueueCBS=tSapEgressQueueCBS, tSlopeHiStartAverage=tSlopeHiStartAverage, tNetworkQueueWeight=tNetworkQueueWeight, tNetworkQueuePIR=tNetworkQueuePIR, tmnxQosSapIngressV6v0Group=tmnxQosSapIngressV6v0Group, tNetworkQueueFCMCast=tNetworkQueueFCMCast, tSharedQueueFCMCastQueue=tSharedQueueFCMCastQueue, tNetworkEgressFCLspExpOutProfile=tNetworkEgressFCLspExpOutProfile, tNetworkPolicyTable=tNetworkPolicyTable, tAtmTdpTableLastChanged=tAtmTdpTableLastChanged, tSapEgressLastChanged=tSapEgressLastChanged, tSapIngressIPCriteriaTable=tSapIngressIPCriteriaTable, tNamedPoolPolicyTableLastChanged=tNamedPoolPolicyTableLastChanged, tSharedQueueLevel=tSharedQueueLevel, tNetworkIngressLSPEXPFC=tNetworkIngressLSPEXPFC, TBurstHundredthsOfPercent=TBurstHundredthsOfPercent, tSapIngressMacCriteriaDot1PValue=tSapIngressMacCriteriaDot1PValue, tmnxQosSapIngressV4v0Group=tmnxQosSapIngressV4v0Group, tSapIngressIPv6CriteriaDestPortOperator=tSapIngressIPv6CriteriaDestPortOperator, TAtmTdpDescrType=TAtmTdpDescrType, TPrecValueOrNone=TPrecValueOrNone, tPortSchedulerPlcyLvl5CIR=tPortSchedulerPlcyLvl5CIR, TEntryIndicator=TEntryIndicator, tSapIngressFCTableLastChanged=tSapIngressFCTableLastChanged, tSapIngressFCProfile=tSapIngressFCProfile, tNetworkIngressDSCP=tNetworkIngressDSCP, tSapIngressIPCriteriaSourcePortOperator=tSapIngressIPCriteriaSourcePortOperator, tSharedQueuePolicyRowStatus=tSharedQueuePolicyRowStatus, tSapIngressIPCriteriaActionFC=tSapIngressIPCriteriaActionFC, tFCName=tFCName, tSlopeHiMaxProbability=tSlopeHiMaxProbability, tFCRowStatus=tFCRowStatus, tSapIngressQueuePoliced=tSapIngressQueuePoliced, tmnxQosFCGroup=tmnxQosFCGroup, tQ1NamedPoolTableLastChanged=tQ1NamedPoolTableLastChanged, tSapIngressRowStatus=tSapIngressRowStatus, tSapIngressMacCriteriaIndex=tSapIngressMacCriteriaIndex, tSapIngressQueue=tSapIngressQueue, tNetworkQueue=tNetworkQueue, tSapIngressPrecValue=tSapIngressPrecValue, tSapEgressQueueTable=tSapEgressQueueTable, tSapIngressIPv6CriteriaDescription=tSapIngressIPv6CriteriaDescription, tSharedQueueFCTableLastChanged=tSharedQueueFCTableLastChanged, tNetworkQueueObjects=tNetworkQueueObjects, tSapIngressQueueCIRLevel=tSapIngressQueueCIRLevel, tSapIngressMacCriteriaDescription=tSapIngressMacCriteriaDescription, tSapIngressQueueCBS=tSapIngressQueueCBS, TBurstPercentOrDefault=TBurstPercentOrDefault, tNamedPoolPolicyQ1PortWeight=tNamedPoolPolicyQ1PortWeight, tFCStorageType=tFCStorageType, tSapEgressQueueLevel=tSapEgressQueueLevel, tSapIngressMacCriteriaDot1PMask=tSapIngressMacCriteriaDot1PMask, tSapEgressQueueIndex=tSapEgressQueueIndex, tSlopeLoMaxAverage=tSlopeLoMaxAverage)
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-QOS-MIB", tSchedulerPolicyTableLastChanged=tSchedulerPolicyTableLastChanged, tNetworkQueuePortCIRWght=tNetworkQueuePortCIRWght, tSapEgressFCDot1POutProfile=tSapEgressFCDot1POutProfile, tAtmTdpPolicing=tAtmTdpPolicing, tVirtualSchedulerParent=tVirtualSchedulerParent, tPortSchedulerPlcyLvl2CIR=tPortSchedulerPlcyLvl2CIR, tSapEgressFCTableLastChanged=tSapEgressFCTableLastChanged, tSapIngressIPv6CriteriaSourceIpAddr=tSapIngressIPv6CriteriaSourceIpAddr, TDEProfile=TDEProfile, tSharedQueueLastChanged=tSharedQueueLastChanged, tAtmTdpEntry=tAtmTdpEntry, tPortSchedulerPlcyLvl1PIR=tPortSchedulerPlcyLvl1PIR, tSapIngressFCRowStatus=tSapIngressFCRowStatus, tmnxQos7750V6v0Compliance=tmnxQos7750V6v0Compliance, tSapIngressPrecRowStatus=tSapIngressPrecRowStatus, tSapIngressDescription=tSapIngressDescription, tSapIngressMacCriteriaEthernetType=tSapIngressMacCriteriaEthernetType, tVirtualSchedulerCIRWeight=tVirtualSchedulerCIRWeight, tmnxQosAtmTdpV3v0Group=tmnxQosAtmTdpV3v0Group, tNetworkIngressDSCPProfile=tNetworkIngressDSCPProfile, tSharedQueueFCRowStatus=tSharedQueueFCRowStatus, tSapIngressIPv6CriteriaLastChanged=tSapIngressIPv6CriteriaLastChanged, tDSCPNameRowStatus=tDSCPNameRowStatus, tNamedPoolPolicyEntry=tNamedPoolPolicyEntry, tVirtualSchedulerPortCIRWght=tVirtualSchedulerPortCIRWght, tSapIngressDot1pTable=tSapIngressDot1pTable, tNetworkEgressFCEntry=tNetworkEgressFCEntry, tNetworkQueueFCName=tNetworkQueueFCName, tFCNameEntry=tFCNameEntry, tSchedulerPolicyTable=tSchedulerPolicyTable, tQ1NamedPoolEntry=tQ1NamedPoolEntry, tSapIngressIPCriteriaEntry=tSapIngressIPCriteriaEntry, tSapEgressFCQueue=tSapEgressFCQueue, tSharedQueueCIRLevel=tSharedQueueCIRLevel, tPortSchedulerPlcyLvl7PIR=tPortSchedulerPlcyLvl7PIR, tSapIngressQueueTable=tSapIngressQueueTable, tNamedPoolPolicyQ1DefaultWeight=tNamedPoolPolicyQ1DefaultWeight, tSapIngressIPv6CriteriaDSCP=tSapIngressIPv6CriteriaDSCP, TLevelOrDefault=TLevelOrDefault, tSapIngressQueueAdminPIR=tSapIngressQueueAdminPIR, tNetworkQueueCIRWeight=tNetworkQueueCIRWeight, tSapIngressIPv6CriteriaRowStatus=tSapIngressIPv6CriteriaRowStatus, tSapIngressQueueMCast=tSapIngressQueueMCast, tAtmTdpsCurrentlyConfigured=tAtmTdpsCurrentlyConfigured, tSapIngressIPCriteriaActionPriority=tSapIngressIPCriteriaActionPriority, tSapEgressQueueLastChanged=tSapEgressQueueLastChanged, tNetworkQueuePortWght=tNetworkQueuePortWght, tSharedQueuePolicyTable=tSharedQueuePolicyTable, tNetworkPolicyScope=tNetworkPolicyScope, tNetworkIngressDot1pEntry=tNetworkIngressDot1pEntry, tSapIngressIPCriteriaSourceIpAddr=tSapIngressIPCriteriaSourceIpAddr, tSapIngressMacCriteriaTableLastChanged=tSapIngressMacCriteriaTableLastChanged, tSlopeTimeAvgFactor=tSlopeTimeAvgFactor, tSapIngressMacCriteriaDSAP=tSapIngressMacCriteriaDSAP, tSapEgressDescription=tSapEgressDescription, tSapIngressFCOutProfDscp=tSapIngressFCOutProfDscp, tSapEgressFCOutProfPrec=tSapEgressFCOutProfPrec, tSapIngressDot1pRowStatus=tSapIngressDot1pRowStatus, tSapIngressDSCPPriority=tSapIngressDSCPPriority, tSapEgressFCDEMark=tSapEgressFCDEMark, tmnxQos7750V4v0Compliance=tmnxQos7750V4v0Compliance, tNetworkQueueCIRAdaptation=tNetworkQueueCIRAdaptation, tQ1NamedPoolSlopePolicy=tQ1NamedPoolSlopePolicy, tSapIngressIPCriteriaProtocol=tSapIngressIPCriteriaProtocol, tSapIngressDot1pValue=tSapIngressDot1pValue, tSapIngressDot1pTableLastChanged=tSapIngressDot1pTableLastChanged, tSapIngressFCName=tSapIngressFCName, tSapIngressQueueOperPIR=tSapIngressQueueOperPIR, tSapEgressFCInProfDscp=tSapEgressFCInProfDscp, tNetworkIngressDot1pFC=tNetworkIngressDot1pFC, tSapIngressIPv6CriteriaEntry=tSapIngressIPv6CriteriaEntry, tVirtualSchedulerPortCIRLvl=tVirtualSchedulerPortCIRLvl, tPortSchedulerPlcyLvl7CIR=tPortSchedulerPlcyLvl7CIR, tAtmTdpSir=tAtmTdpSir, tSapIngressIPCriteriaSourcePortValue2=tSapIngressIPCriteriaSourcePortValue2, tNamedPoolPolicyLastChanged=tNamedPoolPolicyLastChanged, tSapIngressIPCriteriaSourceIpMask=tSapIngressIPCriteriaSourceIpMask, tNamedPoolPolicyRowStatus=tNamedPoolPolicyRowStatus, tmnxQosSchedulerV5v0Group=tmnxQosSchedulerV5v0Group, tSapIngressDSCPLastChanged=tSapIngressDSCPLastChanged, tDSCPName=tDSCPName, tSapIngressIPCriteriaDestPortValue2=tSapIngressIPCriteriaDestPortValue2, tNetworkPolicyIngressDefaultActionProfile=tNetworkPolicyIngressDefaultActionProfile, tSapIngressIPCriteriaRowStatus=tSapIngressIPCriteriaRowStatus, tDSCPNameStorageType=tDSCPNameStorageType, tSharedQueueFCBCastQueue=tSharedQueueFCBCastQueue, tNetworkIngressLSPEXPProfile=tNetworkIngressLSPEXPProfile, tPortSchedulerPlcyLvl4CIR=tPortSchedulerPlcyLvl4CIR, tSapIngressMacCriteriaActionPriority=tSapIngressMacCriteriaActionPriority, tFCNameLastChanged=tFCNameLastChanged, tSapIngressIPv6CriteriaIndex=tSapIngressIPv6CriteriaIndex, tSharedQueueCIRWeight=tSharedQueueCIRWeight, tSapIngressDSCPFC=tSapIngressDSCPFC, tSapEgressEntry=tSapEgressEntry, tSlopeHiAdminStatus=tSlopeHiAdminStatus, tSapEgressQueueOperCIR=tSapEgressQueueOperCIR, tNetworkQueueFCEntry=tNetworkQueueFCEntry, tSlopePolicyEntry=tSlopePolicyEntry, tNetworkQueuePolicyDescription=tNetworkQueuePolicyDescription, tVirtualSchedulerDescription=tVirtualSchedulerDescription, tAtmTdpRowStatus=tAtmTdpRowStatus, tmnxQos7450V5v0Compliance=tmnxQos7450V5v0Compliance, tSapIngressQueueMode=tSapIngressQueueMode, tNetworkQueuePolicyLastChanged=tNetworkQueuePolicyLastChanged, tDSCPNameTableLastChanged=tDSCPNameTableLastChanged, tSapIngressFCQueue=tSapIngressFCQueue, tSapEgressQueueWeight=tSapEgressQueueWeight, tQosDomainLastChanged=tQosDomainLastChanged, tVirtualSchedulerCIR=tVirtualSchedulerCIR, tSapIngressQueueCIRAdaptation=tSapIngressQueueCIRAdaptation, tSapIngressDefaultFCPriority=tSapIngressDefaultFCPriority, tSapEgressQueuePoolName=tSapEgressQueuePoolName, tVirtualSchedulerTier=tVirtualSchedulerTier, tSlopeLoAdminStatus=tSlopeLoAdminStatus, tSapIngressMacCriteriaSrcMacMask=tSapIngressMacCriteriaSrcMacMask, tSapIngressQueueParent=tSapIngressQueueParent, tNetworkEgressFCLspExpInProfile=tNetworkEgressFCLspExpInProfile, tSapEgressObjects=tSapEgressObjects, TItemMatch=TItemMatch, tSapIngressFCMCastQueue=tSapIngressFCMCastQueue, tSapIngressIPCriteriaLastChanged=tSapIngressIPCriteriaLastChanged, tNetworkIngressDot1pTable=tNetworkIngressDot1pTable, tmnxQosSchedulerGroup=tmnxQosSchedulerGroup, tSapIngressIPCriteriaFragment=tSapIngressIPCriteriaFragment, tNetworkEgressFCLastChanged=tNetworkEgressFCLastChanged, tSapEgressRowStatus=tSapEgressRowStatus, timetraQosMIBModule=timetraQosMIBModule, tSlopeRowStatus=tSlopeRowStatus, tQ1NamedPoolReservedCbs=tQ1NamedPoolReservedCbs, tQosNotifyPrefix=tQosNotifyPrefix, tSapIngressPrecLastChanged=tSapIngressPrecLastChanged, tSapIngressPrecFCPriority=tSapIngressPrecFCPriority, tNetworkQueueFC=tNetworkQueueFC, tNetworkIngressDot1pRowStatus=tNetworkIngressDot1pRowStatus, tmnxQosNetworkR2r1Group=tmnxQosNetworkR2r1Group, tNetworkIngressLSPEXPRowStatus=tNetworkIngressLSPEXPRowStatus, tSapIngressQueueOperCIR=tSapIngressQueueOperCIR, tSapEgressQueueCIRAdaptation=tSapEgressQueueCIRAdaptation, tSapIngressMacCriteriaSnapPid=tSapIngressMacCriteriaSnapPid, tSapEgressQueuePortWght=tSapEgressQueuePortWght, tSapIngressIPv6CriteriaDestIpAddr=tSapIngressIPv6CriteriaDestIpAddr, tPortSchedulerPlcyOrphanLvl=tPortSchedulerPlcyOrphanLvl, tNetworkQueuePIRAdaptation=tNetworkQueuePIRAdaptation, tmnxQosAtmTdpV5v0Group=tmnxQosAtmTdpV5v0Group, tNetworkPolicyTableLastChanged=tNetworkPolicyTableLastChanged, tDSCPNameTable=tDSCPNameTable, tAtmTdpMbs=tAtmTdpMbs, tPortSchedulerPlcyRowStatus=tPortSchedulerPlcyRowStatus, tNetworkQueueEntry=tNetworkQueueEntry, TEntryId=TEntryId, tSapIngressQueueEntry=tSapIngressQueueEntry, tSapIngressIPCriteriaIndex=tSapIngressIPCriteriaIndex, tmnxQosSapEgressV6v0Group=tmnxQosSapEgressV6v0Group, tSharedQueueWeight=tSharedQueueWeight, tSharedQueueFCEntry=tSharedQueueFCEntry, TProfileOrNone=TProfileOrNone, tSharedQueueId=tSharedQueueId, tSapIngressIPv6CriteriaDestIpMask=tSapIngressIPv6CriteriaDestIpMask, tPortSchedulerPlcyLvl8CIR=tPortSchedulerPlcyLvl8CIR, tSapIngressIPCriteriaDestIpMask=tSapIngressIPCriteriaDestIpMask, TPriority=TPriority, tSapIngressQueueLastChanged=tSapIngressQueueLastChanged, tSharedQueueRowStatus=tSharedQueueRowStatus, tSharedQueueCIR=tSharedQueueCIR, tPortSchedulerPlcyName=tPortSchedulerPlcyName, tVirtualSchedulerWeight=tVirtualSchedulerWeight, tNetworkPolicyIngressDefaultActionFC=tNetworkPolicyIngressDefaultActionFC, tSchedulerPolicyDescription=tSchedulerPolicyDescription, tNetworkIngressDot1pValue=tNetworkIngressDot1pValue, tSchedulerPolicyName=tSchedulerPolicyName, tSapIngressIPv6CriteriaSourcePortValue1=tSapIngressIPv6CriteriaSourcePortValue1, tVirtualSchedulerTableLastChanged=tVirtualSchedulerTableLastChanged, tFCNameTable=tFCNameTable, tNetworkPolicyEntry=tNetworkPolicyEntry, tNetworkQueueCIR=tNetworkQueueCIR, tSapIngressFCBCastQueue=tSapIngressFCBCastQueue, tSapIngressPrecEntry=tSapIngressPrecEntry, tNetworkQueuePolicyEntry=tNetworkQueuePolicyEntry, tAtmTdpIndex=tAtmTdpIndex, tNetworkIngressLSPEXPLastChanged=tNetworkIngressLSPEXPLastChanged, tSapIngressIPCriteriaTableLastChanged=tSapIngressIPCriteriaTableLastChanged, tSapIngressFCEntry=tSapIngressFCEntry, tNetworkQueueTableLastChanged=tNetworkQueueTableLastChanged, tmnxQosCompliances=tmnxQosCompliances, tmnxQosObsoletedV6v0Group=tmnxQosObsoletedV6v0Group, TRatePercent=TRatePercent, tSapIngressIPCriteriaDSCP=tSapIngressIPCriteriaDSCP, tSapIngressQueueLevel=tSapIngressQueueLevel, tNamedPoolPolicyTable=tNamedPoolPolicyTable, tSapEgressQueuePIRAdaptation=tSapEgressQueuePIRAdaptation, tPortSchedulerPlcyLastChanged=tPortSchedulerPlcyLastChanged, tQ1NamedPoolAccessAllocWeight=tQ1NamedPoolAccessAllocWeight, tSharedQueueEntry=tSharedQueueEntry, tSapIngressFCInProfPrec=tSapIngressFCInProfPrec, tDSCPNameEntry=tDSCPNameEntry, tSapIngressQueueCIRWeight=tSapIngressQueueCIRWeight, tSharedQueueFCLastChanged=tSharedQueueFCLastChanged, tSlopeLoMaxProbability=tSlopeLoMaxProbability, TPIRRatePercent=TPIRRatePercent, tPortSchedulerPlcyLvl1CIR=tPortSchedulerPlcyLvl1CIR, tSlopeDescription=tSlopeDescription, tNetworkIngressDSCPLastChanged=tNetworkIngressDSCPLastChanged, tSlopePolicy=tSlopePolicy, tVirtualSchedulerRowStatus=tVirtualSchedulerRowStatus, tSlopePolicyTable=tSlopePolicyTable, tSapIngressIndex=tSapIngressIndex, tFCObjects=tFCObjects, tNetworkEgressFCDot1pInProfile=tNetworkEgressFCDot1pInProfile, tNetworkQueuePoolName=tNetworkQueuePoolName, tSapIngressLastChanged=tSapIngressLastChanged, tNetworkQueuePolicyTable=tNetworkQueuePolicyTable, tQosObsoleteObjectsGroup=tQosObsoleteObjectsGroup, tNetworkQueueExpedite=tNetworkQueueExpedite, tmnxQosFrameBasedV6v0Group=tmnxQosFrameBasedV6v0Group, tSharedQueueMBS=tSharedQueueMBS, tmnxQosGroups=tmnxQosGroups, TPrecValue=TPrecValue, tSharedQueueCBS=tSharedQueueCBS, tNetworkEgressFCTable=tNetworkEgressFCTable, tSharedQueueFCQueue=tSharedQueueFCQueue, tSapEgressQueueParent=tSapEgressQueueParent, tNetworkQueueFCLastChanged=tNetworkQueueFCLastChanged, TBurstSize=TBurstSize, tQ1NamedPoolTable=tQ1NamedPoolTable, tSchedulerObjects=tSchedulerObjects, tSapIngressIPv6CriteriaNextHeader=tSapIngressIPv6CriteriaNextHeader, tNetworkQueuePolicy=tNetworkQueuePolicy, tVirtualSchedulerPIR=tVirtualSchedulerPIR, tNetworkQueuePolicyTableLastChanged=tNetworkQueuePolicyTableLastChanged, tmnxQosQueueV4v0Group=tmnxQosQueueV4v0Group, tSharedQueueIsMultipoint=tSharedQueueIsMultipoint, tQ1NamedPoolRowStatus=tQ1NamedPoolRowStatus, tNetworkQueueCBS=tNetworkQueueCBS, tSapIngressIPv6CriteriaSourcePortOperator=tSapIngressIPv6CriteriaSourcePortOperator, tNetworkIngressLSPEXPTable=tNetworkIngressLSPEXPTable, TMatchCriteria=TMatchCriteria, tSapEgressFCDot1PInProfile=tSapEgressFCDot1PInProfile, tNetworkPolicyEgressRemark=tNetworkPolicyEgressRemark, tSlopeLoStartAverage=tSlopeLoStartAverage, tSharedQueuePolicyEntry=tSharedQueuePolicyEntry, tSapIngressMatchCriteria=tSapIngressMatchCriteria, tSapIngressIPCriteriaSourcePortValue1=tSapIngressIPCriteriaSourcePortValue1, tAtmTdpPir=tAtmTdpPir, tSapIngressDot1pPriority=tSapIngressDot1pPriority, tSapEgressQueueRowStatus=tSapEgressQueueRowStatus, tNetworkQueueUsePortParent=tNetworkQueueUsePortParent, tmnxQosGlobalGroup=tmnxQosGlobalGroup, tmnxQosNamedPoolPolicyV6v0Group=tmnxQosNamedPoolPolicyV6v0Group, tSapIngressDot1pLastChanged=tSapIngressDot1pLastChanged, tNetworkIngressDSCPTableLastChanged=tNetworkIngressDSCPTableLastChanged, tSapIngressIPv6CriteriaActionFC=tSapIngressIPv6CriteriaActionFC, tSapIngressIPv6CriteriaTableLastChanged=tSapIngressIPv6CriteriaTableLastChanged, tSapIngressMacCriteriaLastChanged=tSapIngressMacCriteriaLastChanged, tmnxQosDSCPGroup=tmnxQosDSCPGroup)
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-QOS-MIB", tSapEgressQueueHiPrioOnly=tSapEgressQueueHiPrioOnly, tQ1NamedPoolPolicyName=tQ1NamedPoolPolicyName, tSapIngressFCInProfDscp=tSapIngressFCInProfDscp, TPriorityOrDefault=TPriorityOrDefault, tPortSchedulerPlcyLvl3CIR=tPortSchedulerPlcyLvl3CIR, TBurstPercent=TBurstPercent, tNamedPoolPolicyName=tNamedPoolPolicyName, TProfile=TProfile, tSapIngressPrecFC=tSapIngressPrecFC, tFCNameTableLastChanged=tFCNameTableLastChanged, tSapIngressFCOutProfPrec=tSapIngressFCOutProfPrec, tVirtualSchedulerCIRLevel=tVirtualSchedulerCIRLevel, tPortSchedulerPlcyOrphanCIRLvl=tPortSchedulerPlcyOrphanCIRLvl, tSapIngressScope=tSapIngressScope, tQ1NamedPoolName=tQ1NamedPoolName, tSapEgressFCOutProfDscp=tSapEgressFCOutProfDscp, tDSCPObjects=tDSCPObjects, tSapIngressFCInProfRemark=tSapIngressFCInProfRemark, tSapIngressDSCPEntry=tSapIngressDSCPEntry, tSapIngressMacCriteriaDSAPMask=tSapIngressMacCriteriaDSAPMask)
