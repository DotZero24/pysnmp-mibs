#
# PySNMP MIB module ALCATEL-ENT1-TIMETRA-QOS-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/alcatel-ent1/ALCATEL-ENT1-TIMETRA-QOS-MIB
...
TPIRRate, TWeight, TPIRRateOrZero, TTcpUdpPortOperator, TEgressQueueId, TmnxEnabledDisabled, TLspExpValue, TDSCPValue, TFrameType, TPolicyID, TFCNameOrEmpty, TPortSchedulerCIR, TItemDescription, TFCName, TDSCPNameOrEmpty, TIngressQueueId, TDSCPName, TPortSchedulerPIR, TSapEgressPolicyID, TTcpUdpPort, TSapIngressPolicyID, TIpProtocol, TNamedItem, Dot1PPriority, TQueueId, IpAddressPrefixLength, ServiceAccessPoint, TCIRRate, TNamedItemOrEmpty = mibBuilder.importSymbols("ALCATEL-ENT1-TIMETRA-TC-MIB", "TPIRRate", "TWeight", "TPIRRateOrZero", "TTcpUdpPortOperator", "TEgressQueueId", "TmnxEnabledDisabled", "TLspExpValue", "TDSCPValue", "TFrameType", "TPolicyID", "TFCNameOrEmpty", "TPortSchedulerCIR", "TItemDescription", "TFCName", "TDSCPNameOrEmpty", "TIngressQueueId", "TDSCPName", "TPortSchedulerPIR", "TSapEgressPolicyID", "TTcpUdpPort", "TSapIngressPolicyID", "TIpProtocol", "TNamedItem", "Dot1PPriority", "TQueueId", "IpAddressPrefixLength", "ServiceAccessPoint", "TCIRRate", "TNamedItemOrEmpty")
...
tDSCPNameEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 1, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tDSCPName"))
...
tFCNameEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 2, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tFCName"))
...
tSapIngressEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 3, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIndex"))
...
tSapIngressQueueEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 3, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueue"))
...
tSapIngressDSCPEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 3, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCP"))
...
tSapIngressDot1pEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 3, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pValue"))
...
tSapIngressIPCriteriaEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 3, 5, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaIndex"))
...
tSapIngressMacCriteriaEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 3, 6, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaIndex"))
...
tSapIngressFCEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 3, 7, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCName"))
...
tSapIngressPrecEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 3, 8, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecValue"))
...
tSapIngressIPv6CriteriaEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 3, 9, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaIndex"))
...
tSapEgressEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 4, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressIndex"))
...
tSapEgressQueueEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 4, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueIndex"))
...
tSapEgressFCEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 4, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCName"))
...
tNetworkPolicyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 5, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIndex"))
...
tNetworkIngressDSCPEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 5, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCP"))
...
tNetworkIngressDot1pEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 5, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pValue"))
...
tNetworkIngressLSPEXPEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 5, 4, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXP"))
...
tNetworkEgressFCEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 5, 7, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIndex"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCName"))
...
tNetworkQueuePolicyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 6, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicy"))
...
tNetworkQueueEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 6, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicy"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueue"))
...
tNetworkQueueFCEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 6, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicy"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCName"))
...
tSharedQueuePolicyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 7, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueuePolicy"))
...
tSharedQueueEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 7, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueuePolicy"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueId"))
...
tSharedQueueFCEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 7, 3, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueuePolicy"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueFCName"))
...
tSlopePolicyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 10, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopePolicy"))
...
tSchedulerPolicyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 12, 1, 1), ).setIndexNames((1, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyName"))
...
tVirtualSchedulerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 12, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyName"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerTier"), (1, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerName"))
...
tPortSchedulerPlcyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 12, 3, 1), ).setIndexNames((1, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyName"))
...
tAtmTdpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 21, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpIndex"))
...
tNamedPoolPolicyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 22, 1, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNamedPoolPolicyName"))
...
tQ1NamedPoolEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 16, 22, 2, 1), ).setIndexNames((0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolPolicyName"), (0, "ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolName"))
...
tmnxQos7450V4v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 1, 4)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosGlobalGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosDSCPGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosFCGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapIngressV4v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapEgressR2r1Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosNetworkR2r1Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSlopeGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSchedulerGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosQueueV4v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQos7450V4v0Compliance = tmnxQos7450V4v0Compliance.setStatus('obsolete')
tmnxQos7750V4v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 1, 5)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosGlobalGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosDSCPGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosFCGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapIngressV4v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapEgressR2r1Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosNetworkR2r1Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSlopeGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSchedulerGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosAtmTdpV3v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosQueueV4v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapIpv6FilterR4r0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQos7750V4v0Compliance = tmnxQos7750V4v0Compliance.setStatus('obsolete')
tmnxQos7450V5v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 1, 6)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosGlobalGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosDSCPGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosFCGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapIngressV4v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapEgressV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosNetworkV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSlopeGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSchedulerV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosQueueV4v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQos7450V5v0Compliance = tmnxQos7450V5v0Compliance.setStatus('obsolete')
tmnxQos7750V5v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 1, 7)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosGlobalGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosDSCPGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosFCGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapIngressV4v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapEgressV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosNetworkV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSlopeGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSchedulerV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosAtmTdpV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosQueueV4v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapIpv6FilterR4r0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQos7750V5v0Compliance = tmnxQos7750V5v0Compliance.setStatus('obsolete')
tmnxQos7450V6v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 1, 8)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosGlobalGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosDSCPGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosFCGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapIngressV6v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapEgressV6v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosNetworkV6v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSlopeGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSchedulerV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosQueueV4v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosFrameBasedV6v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosNamedPoolPolicyV6v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQos7450V6v0Compliance = tmnxQos7450V6v0Compliance.setStatus('current')
tmnxQos7750V6v0Compliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 1, 9)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosGlobalGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosDSCPGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosFCGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapIngressV6v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapEgressV6v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosNetworkV6v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSlopeGroup"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSchedulerV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosAtmTdpV5v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosQueueV4v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosSapIpv6FilterR4r0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosFrameBasedV6v0Group"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tmnxQosNamedPoolPolicyV6v0Group"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQos7750V6v0Compliance = tmnxQos7750V6v0Compliance.setStatus('current')
tmnxQosGlobalGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 1)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQosDomainLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosGlobalGroup = tmnxQosGlobalGroup.setStatus('current')
tmnxQosDSCPGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 2)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tDSCPNameRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tDSCPNameStorageType"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tDSCPNameDscpValue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tDSCPNameLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tDSCPNameTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosDSCPGroup = tmnxQosDSCPGroup.setStatus('current')
tmnxQosFCGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 3)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tFCStorageType"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tFCValue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tFCNameLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tFCNameTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosFCGroup = tmnxQosFCGroup.setStatus('current')
tmnxQosSlopeGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 7)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeHiAdminStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeHiStartAverage"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeHiMaxAverage"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeHiMaxProbability"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeLoAdminStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeLoStartAverage"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeLoMaxAverage"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeLoMaxProbability"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeTimeAvgFactor"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopeLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSlopePolicyTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosSlopeGroup = tmnxQosSlopeGroup.setStatus('current')
tmnxQosSchedulerGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 8)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerPIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerSummedCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosSchedulerGroup = tmnxQosSchedulerGroup.setStatus('obsolete')
tQosObsoleteObjectsGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 10)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueOperPIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueOperCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueOperPIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueOperCIR"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tQosObsoleteObjectsGroup = tQosObsoleteObjectsGroup.setStatus('current')
tmnxQosSapEgressR2r1Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 12)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressScope"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueExpedite"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueMBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueHiPrioOnly"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueAdminPIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueAdminCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCDot1PValue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosSapEgressR2r1Group = tmnxQosSapEgressR2r1Group.setStatus('obsolete')
tmnxQosNetworkR2r1Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 13)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyScope"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIngressDefaultActionFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIngressDefaultActionProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyEgressRemark"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIngressLerUseDscp"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDSCPInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDSCPOutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCLspExpInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCLspExpOutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDot1pInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDot1pOutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePoolName"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueMCast"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueExpedite"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueMBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueHiPrioOnly"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCMCast"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosNetworkR2r1Group = tmnxQosNetworkR2r1Group.setStatus('obsolete')
tmnxQosAtmTdpV3v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 15)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpSir"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpPir"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpMbs"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpMir"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpShaping"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpServCat"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpDescrType"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpCdvt"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpPolicing"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpIndexNext"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpsMaxSupported"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpsCurrentlyConfigured"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosAtmTdpV3v0Group = tmnxQosAtmTdpV3v0Group.setStatus('obsolete')
tmnxQosSapIpv6FilterR4r0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 16)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaActionFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaActionPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaSourceIpAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaSourceIpMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaDestIpAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaDestIpMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaNextHeader"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaSourcePortValue1"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaSourcePortValue2"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaSourcePortOperator"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaDestPortValue1"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaDestPortValue2"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaDestPortOperator"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaDSCP"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPv6CriteriaTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosSapIpv6FilterR4r0Group = tmnxQosSapIpv6FilterR4r0Group.setStatus('current')
tmnxQosQueueV4v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 18)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueuePolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueuePolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueuePolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueuePolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueuePoolName"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueExpedite"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueuePIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueCBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueMBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueHiPrioOnly"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueIsMultipoint"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueFCQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueFCTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueFCMCastQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueFCBCastQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSharedQueueFCUnknownQueue"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosQueueV4v0Group = tmnxQosQueueV4v0Group.setStatus('current')
tmnxQosSapIngressV4v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 19)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressScope"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDefaultFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDefaultFCPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMatchCriteria"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueMCast"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueExpedite"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueCBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueMBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueHiPrioOnly"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueCIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueuePIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueAdminPIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueAdminCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueMode"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueuePoliced"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaActionFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaActionPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourceIpAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourceIpMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestIpAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestIpMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaProtocol"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourcePortValue1"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourcePortValue2"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourcePortOperator"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestPortValue1"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestPortValue2"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestPortOperator"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDSCP"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaFragment"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaActionFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaActionPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaFrameType"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSrcMacAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSrcMacMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDstMacAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDstMacMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDot1PValue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDot1PMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaEthernetType"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDSAP"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDSAPMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSSAP"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSSAPMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSnapPid"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSnapOui"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCMCastQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCBCastQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCUnknownQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCInProfRemark"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCInProfDscp"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCInProfPrec"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCOutProfRemark"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCOutProfDscp"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCOutProfPrec"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecFCPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosSapIngressV4v0Group = tmnxQosSapIngressV4v0Group.setStatus('obsolete')
tmnxQosSchedulerV5v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 20)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerPIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerSummedCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerUsePortParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerPortLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerPortWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerPortCIRLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerPortCIRWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tVirtualSchedulerTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyMaxRate"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl1PIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl1CIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl2PIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl2CIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl3PIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl3CIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl4PIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl4CIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl5PIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl5CIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl6PIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl6CIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl7PIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl7CIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl8PIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyLvl8CIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyOrphanLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyOrphanWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyOrphanCIRLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tPortSchedulerPlcyOrphanCIRWght"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosSchedulerV5v0Group = tmnxQosSchedulerV5v0Group.setStatus('current')
tmnxQosSapEgressV5v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 21)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressScope"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueExpedite"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueMBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueHiPrioOnly"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueAdminPIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueAdminCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCDot1PValue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueUsePortParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortCIRLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortCIRWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortAvgOverhead"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosSapEgressV5v0Group = tmnxQosSapEgressV5v0Group.setStatus('obsolete')
tmnxQosNetworkV5v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 22)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyScope"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIngressDefaultActionFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIngressDefaultActionProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyEgressRemark"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIngressLerUseDscp"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDSCPInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDSCPOutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCLspExpInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCLspExpOutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDot1pInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDot1pOutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePoolName"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueMCast"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueExpedite"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueMBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueHiPrioOnly"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueUsePortParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortCIRLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortCIRWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortAvgOverhead"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCMCast"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosNetworkV5v0Group = tmnxQosNetworkV5v0Group.setStatus('obsolete')
tmnxQosAtmTdpV5v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 24)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpSir"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpPir"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpMbs"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpMir"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpShaping"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpServCat"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpDescrType"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpCdvt"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpPolicing"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpCLPTagging"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpIndexNext"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpsMaxSupported"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpsCurrentlyConfigured"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tAtmTdpTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosAtmTdpV5v0Group = tmnxQosAtmTdpV5v0Group.setStatus('current')
tmnxQosSapIngressV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 25)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressScope"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDefaultFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDefaultFCPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMatchCriteria"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueMCast"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueExpedite"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueCBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueMBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueHiPrioOnly"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueCIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueuePIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueAdminPIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueAdminCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueMode"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueuePoolName"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueueTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressQueuePoliced"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDSCPTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressDot1pTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaActionFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaActionPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourceIpAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourceIpMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestIpAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestIpMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaProtocol"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourcePortValue1"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourcePortValue2"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaSourcePortOperator"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestPortValue1"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestPortValue2"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDestPortOperator"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaDSCP"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaFragment"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressIPCriteriaTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaActionFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaActionPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaFrameType"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSrcMacAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSrcMacMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDstMacAddr"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDstMacMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDot1PValue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDot1PMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaEthernetType"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDSAP"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaDSAPMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSSAP"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSSAPMask"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSnapPid"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaSnapOui"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressMacCriteriaTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCMCastQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCBCastQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCUnknownQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCInProfRemark"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCInProfDscp"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCInProfPrec"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCOutProfRemark"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCOutProfDscp"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCOutProfPrec"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecFCPriority"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressPrecTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapIngressFCDE1OutOfProfile"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosSapIngressV6v0Group = tmnxQosSapIngressV6v0Group.setStatus('current')
tmnxQosSapEgressV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 26)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressScope"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueExpedite"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueMBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueHiPrioOnly"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueCIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueAdminPIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueAdminCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCQueue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCDot1PInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCDot1POutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCForceDEValue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCDEMark"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCInProfDscp"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCOutProfDscp"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCInProfPrec"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCOutProfPrec"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueueUsePortParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortCIRLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortCIRWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePortAvgOverhead"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressQueuePoolName"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosSapEgressV6v0Group = tmnxQosSapEgressV6v0Group.setStatus('current')
tmnxQosNetworkV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 27)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyScope"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIngressDefaultActionFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIngressDefaultActionProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyEgressRemark"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyIngressLerUseDscp"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkPolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDSCPTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressDot1pTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkIngressLSPEXPTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDSCPInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDSCPOutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCLspExpInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCLspExpOutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDot1pInProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDot1pOutProfile"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCForceDEValue"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCDEMark"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkEgressFCTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePoolName"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIRLevel"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIRWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueMCast"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueExpedite"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePIR"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueMBS"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueHiPrioOnly"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueUsePortParent"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortCIRLvl"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortCIRWght"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePortAvgOverhead"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueuePIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueCIRAdaptation"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFC"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCMCast"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNetworkQueueFCTableLastChanged"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosNetworkV6v0Group = tmnxQosNetworkV6v0Group.setStatus('current')
tmnxQosFrameBasedV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 28)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSchedulerPolicyFrameBasedAccnt"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosFrameBasedV6v0Group = tmnxQosFrameBasedV6v0Group.setStatus('current')
tmnxQosObsoletedV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 29)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tSapEgressFCDot1PValue"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosObsoletedV6v0Group = tmnxQosObsoletedV6v0Group.setStatus('current')
tmnxQosNamedPoolPolicyV6v0Group = ObjectGroup((1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 16, 2, 30)).setObjects(("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNamedPoolPolicyTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNamedPoolPolicyRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNamedPoolPolicyLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNamedPoolPolicyDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNamedPoolPolicyQ1DefaultWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNamedPoolPolicyQ1MdaWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tNamedPoolPolicyQ1PortWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolTableLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolRowStatus"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolLastChanged"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolDescription"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolNetworkAllocWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolAccessAllocWeight"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolSlopePolicy"), ("ALCATEL-ENT1-TIMETRA-QOS-MIB", "tQ1NamedPoolReservedCbs"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    tmnxQosNamedPoolPolicyV6v0Group = tmnxQosNamedPoolPolicyV6v0Group.setStatus('current')
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-QOS-MIB", tSlopeLoAdminStatus=tSlopeLoAdminStatus, tSharedQueuePolicyTableLastChanged=tSharedQueuePolicyTableLastChanged, tSapIngressIPCriteriaDestIpMask=tSapIngressIPCriteriaDestIpMask, tNetworkEgressFCTableLastChanged=tNetworkEgressFCTableLastChanged, tNetworkIngressDot1pFC=tNetworkIngressDot1pFC, TRemarkType=TRemarkType, tSapEgressQueueCIRAdaptation=tSapEgressQueueCIRAdaptation, tSapIngressMacCriteriaActionFC=tSapIngressMacCriteriaActionFC, tAtmTdpDescription=tAtmTdpDescription, tSapIngressDSCPRowStatus=tSapIngressDSCPRowStatus, tVirtualSchedulerDescription=tVirtualSchedulerDescription, tSapEgressQueuePortWght=tSapEgressQueuePortWght, tSapIngressDot1pPriority=tSapIngressDot1pPriority, tNamedPoolPolicyLastChanged=tNamedPoolPolicyLastChanged, tVirtualSchedulerCIRLevel=tVirtualSchedulerCIRLevel, tNetworkEgressFCEntry=tNetworkEgressFCEntry, tQosTimeStampObjects=tQosTimeStampObjects, tSharedQueuePolicy=tSharedQueuePolicy, tNetworkQueueRowStatus=tNetworkQueueRowStatus, tNamedPoolPolicyTableLastChanged=tNamedPoolPolicyTableLastChanged, tSapIngressQueueOperPIR=tSapIngressQueueOperPIR, tPortSchedulerPlcyOrphanCIRWght=tPortSchedulerPlcyOrphanCIRWght, tSapEgressFCLastChanged=tSapEgressFCLastChanged, tSapIngressDot1pLastChanged=tSapIngressDot1pLastChanged, tAtmTdpsCurrentlyConfigured=tAtmTdpsCurrentlyConfigured, tAtmTdpRowStatus=tAtmTdpRowStatus, tSapEgressQueueWeight=tSapEgressQueueWeight, tSapIngressIPCriteriaProtocol=tSapIngressIPCriteriaProtocol, tPortSchedulerPlcyLvl6CIR=tPortSchedulerPlcyLvl6CIR, tSapEgressQueuePoolName=tSapEgressQueuePoolName, TBurstPercentOrDefault=TBurstPercentOrDefault, tSapIngressIPCriteriaSourcePortValue1=tSapIngressIPCriteriaSourcePortValue1, tNetworkIngressDSCPTableLastChanged=tNetworkIngressDSCPTableLastChanged, tNetworkIngressLSPEXPProfile=tNetworkIngressLSPEXPProfile, tAtmTdpDescrType=tAtmTdpDescrType, tPortSchedulerPlcyLvl2PIR=tPortSchedulerPlcyLvl2PIR, tSapIngressFCOutProfRemark=tSapIngressFCOutProfRemark, tNetworkQueueUsePortParent=tNetworkQueueUsePortParent, tPoolObjects=tPoolObjects, tNetworkQueueEntry=tNetworkQueueEntry, tSapEgressQueueHiPrioOnly=tSapEgressQueueHiPrioOnly, tSharedQueuePolicyEntry=tSharedQueuePolicyEntry, tDSCPObjects=tDSCPObjects, tNetworkPolicyScope=tNetworkPolicyScope, tSlopeLoMaxProbability=tSlopeLoMaxProbability, tVirtualSchedulerCIR=tVirtualSchedulerCIR, tSharedQueueFCTableLastChanged=tSharedQueueFCTableLastChanged, tNetworkQueuePortAvgOverhead=tNetworkQueuePortAvgOverhead, tSapIngressIPv6CriteriaIndex=tSapIngressIPv6CriteriaIndex, tPortSchedulerPlcyLvl2CIR=tPortSchedulerPlcyLvl2CIR, tNetworkQueuePolicyRowStatus=tNetworkQueuePolicyRowStatus, tFCName=tFCName, tDSCPNameEntry=tDSCPNameEntry, tQ1NamedPoolPolicyName=tQ1NamedPoolPolicyName, tVirtualSchedulerLastChanged=tVirtualSchedulerLastChanged, tSlopePolicyTableLastChanged=tSlopePolicyTableLastChanged, tNetworkQueuePortWght=tNetworkQueuePortWght, tSharedQueueFCEntry=tSharedQueueFCEntry, tSapEgressFCOutProfDscp=tSapEgressFCOutProfDscp, tSapIngressIPCriteriaTable=tSapIngressIPCriteriaTable, tNamedPoolPolicyEntry=tNamedPoolPolicyEntry, tVirtualSchedulerTableLastChanged=tVirtualSchedulerTableLastChanged, tSchedulerPolicyEntry=tSchedulerPolicyEntry, tVirtualSchedulerRowStatus=tVirtualSchedulerRowStatus, tSapIngressMacCriteriaActionPriority=tSapIngressMacCriteriaActionPriority, tSapEgressFCInProfDscp=tSapEgressFCInProfDscp, tSapEgressQueuePortLvl=tSapEgressQueuePortLvl, tSapIngressIPv6CriteriaLastChanged=tSapIngressIPv6CriteriaLastChanged, tVirtualSchedulerTier=tVirtualSchedulerTier, tmnxQosSapIngressV4v0Group=tmnxQosSapIngressV4v0Group, tNamedPoolPolicyQ1MdaWeight=tNamedPoolPolicyQ1MdaWeight, tSapEgressQueueOperCIR=tSapEgressQueueOperCIR, tPortSchedulerPlcyLvl8PIR=tPortSchedulerPlcyLvl8PIR, tmnxQosNetworkV5v0Group=tmnxQosNetworkV5v0Group, tSapEgressQueueLastChanged=tSapEgressQueueLastChanged, TBurstPercent=TBurstPercent, tSapIngressTableLastChanged=tSapIngressTableLastChanged, tPortSchedulerPlcyLvl5CIR=tPortSchedulerPlcyLvl5CIR, tDSCPNameTableLastChanged=tDSCPNameTableLastChanged, tSapEgressScope=tSapEgressScope, tSlopeLastChanged=tSlopeLastChanged, tmnxQosNetworkV6v0Group=tmnxQosNetworkV6v0Group, tNetworkIngressLSPEXPLastChanged=tNetworkIngressLSPEXPLastChanged, tmnxQosConformance=tmnxQosConformance, tNetworkEgressFCLastChanged=tNetworkEgressFCLastChanged, tNetworkIngressLSPEXPEntry=tNetworkIngressLSPEXPEntry, tSapIngressIPv6CriteriaDescription=tSapIngressIPv6CriteriaDescription, tSapIngressIPCriteriaSourcePortOperator=tSapIngressIPCriteriaSourcePortOperator, tNetworkQueueExpedite=tNetworkQueueExpedite, tSapEgressTableLastChanged=tSapEgressTableLastChanged, tSharedQueueObjects=tSharedQueueObjects, tNetworkQueuePolicyEntry=tNetworkQueuePolicyEntry, tNetworkQueuePortLvl=tNetworkQueuePortLvl, tSharedQueueFCBCastQueue=tSharedQueueFCBCastQueue, tSapEgressFCTable=tSapEgressFCTable, tSchedulerPolicyLastChanged=tSchedulerPolicyLastChanged, tFCNameTableLastChanged=tFCNameTableLastChanged, tSapIngressQueueLevel=tSapIngressQueueLevel, tSharedQueueTable=tSharedQueueTable, tAtmTdpMbs=tAtmTdpMbs, tNetworkQueueFCTable=tNetworkQueueFCTable, tAtmTdpLastChanged=tAtmTdpLastChanged, TItemScope=TItemScope, tSchedulerPolicyDescription=tSchedulerPolicyDescription, tmnxQosNetworkR2r1Group=tmnxQosNetworkR2r1Group, tSharedQueuePolicyRowStatus=tSharedQueuePolicyRowStatus, tVirtualSchedulerLevel=tVirtualSchedulerLevel, tNetworkIngressLSPEXP=tNetworkIngressLSPEXP, tSapIngressIPCriteriaSourcePortValue2=tSapIngressIPCriteriaSourcePortValue2, tSapIngressMatchCriteria=tSapIngressMatchCriteria, tSapIngressMacCriteriaSrcMacAddr=tSapIngressMacCriteriaSrcMacAddr, tAtmTdpsMaxSupported=tAtmTdpsMaxSupported, tSapEgressFCTableLastChanged=tSapEgressFCTableLastChanged, tSapIngressLastChanged=tSapIngressLastChanged, tmnxQos7450V5v0Compliance=tmnxQos7450V5v0Compliance, tSapEgressQueuePortCIRLvl=tSapEgressQueuePortCIRLvl, TBurstHundredthsOfPercent=TBurstHundredthsOfPercent, tNetworkQueueWeight=tNetworkQueueWeight, tNetworkQueuePIRAdaptation=tNetworkQueuePIRAdaptation, tmnxQos7750V6v0Compliance=tmnxQos7750V6v0Compliance, tPortSchedulerPlcyOrphanCIRLvl=tPortSchedulerPlcyOrphanCIRLvl, tSharedQueueFCUnknownQueue=tSharedQueueFCUnknownQueue, tAtmTdpShaping=tAtmTdpShaping, tSapIngressIPCriteriaFragment=tSapIngressIPCriteriaFragment, tPortSchedulerPlcyMaxRate=tPortSchedulerPlcyMaxRate, TLevelOrDefault=TLevelOrDefault, tSapIngressMacCriteriaDstMacMask=tSapIngressMacCriteriaDstMacMask, tSapIngressMacCriteriaSrcMacMask=tSapIngressMacCriteriaSrcMacMask, tmnxQosAtmTdpV3v0Group=tmnxQosAtmTdpV3v0Group, TRatePercent=TRatePercent, tmnxQos7750V5v0Compliance=tmnxQos7750V5v0Compliance, tSapEgressFCDot1PValue=tSapEgressFCDot1PValue, tSapIngressIPv6CriteriaDestIpMask=tSapIngressIPv6CriteriaDestIpMask, tSapEgressFCOutProfPrec=tSapEgressFCOutProfPrec, tSapIngressFCTable=tSapIngressFCTable, tSapIngressFCInProfRemark=tSapIngressFCInProfRemark, tSharedQueueMBS=tSharedQueueMBS, tPortSchedulerPlcyRowStatus=tPortSchedulerPlcyRowStatus, tVirtualSchedulerPortLvl=tVirtualSchedulerPortLvl, tSapIngressMacCriteriaSSAPMask=tSapIngressMacCriteriaSSAPMask, tNetworkQueueCIRWeight=tNetworkQueueCIRWeight, tPortSchedulerPlcyLvl3PIR=tPortSchedulerPlcyLvl3PIR, tSapIngressDSCPFC=tSapIngressDSCPFC, tSapIngressDot1pTable=tSapIngressDot1pTable, tSlopeTimeAvgFactor=tSlopeTimeAvgFactor, tNetworkEgressFCDot1pInProfile=tNetworkEgressFCDot1pInProfile, tFCObjects=tFCObjects, tSharedQueueId=tSharedQueueId, tAtmTdpPolicing=tAtmTdpPolicing, tNetworkQueuePolicy=tNetworkQueuePolicy, tmnxQosObsoletedV6v0Group=tmnxQosObsoletedV6v0Group, tAtmTdpMir=tAtmTdpMir, tSapIngressMacCriteriaIndex=tSapIngressMacCriteriaIndex, tSlopeLoMaxAverage=tSlopeLoMaxAverage, tmnxQosSchedulerGroup=tmnxQosSchedulerGroup, tSapIngressDefaultFCPriority=tSapIngressDefaultFCPriority, tmnxQosSlopeGroup=tmnxQosSlopeGroup, tSlopeLoStartAverage=tSlopeLoStartAverage, tSapEgressQueueLevel=tSapEgressQueueLevel, tSapEgressQueuePIRAdaptation=tSapEgressQueuePIRAdaptation, tSapIngressIPv6CriteriaActionFC=tSapIngressIPv6CriteriaActionFC, tSapIngressQueueMCast=tSapIngressQueueMCast, tNetworkQueueLevel=tNetworkQueueLevel, tSapIngressMacCriteriaDstMacAddr=tSapIngressMacCriteriaDstMacAddr, TPIRRatePercent=TPIRRatePercent, tDSCPName=tDSCPName, tNetworkQueueFCLastChanged=tNetworkQueueFCLastChanged, tSharedQueueEntry=tSharedQueueEntry, tSapEgressFCRowStatus=tSapEgressFCRowStatus, tSapIngressDSCPLastChanged=tSapIngressDSCPLastChanged, tNetworkPolicyIndex=tNetworkPolicyIndex, tSapEgressQueueParent=tSapEgressQueueParent, tNetworkQueueFCRowStatus=tNetworkQueueFCRowStatus, tSapIngressIPCriteriaDestPortValue1=tSapIngressIPCriteriaDestPortValue1, tSharedQueueFCName=tSharedQueueFCName, tSapIngressIPv6CriteriaNextHeader=tSapIngressIPv6CriteriaNextHeader, tSapIngressQueueHiPrioOnly=tSapIngressQueueHiPrioOnly, tSapIngressMacCriteriaSnapOui=tSapIngressMacCriteriaSnapOui, tSapIngressIPv6CriteriaDSCP=tSapIngressIPv6CriteriaDSCP, tNetworkIngressLSPEXPFC=tNetworkIngressLSPEXPFC, TPriorityOrDefault=TPriorityOrDefault, tSapIngressQueueMBS=tSapIngressQueueMBS, tmnxQosSapEgressV6v0Group=tmnxQosSapEgressV6v0Group, tSapIngressFCUnknownQueue=tSapIngressFCUnknownQueue, tSapIngressDot1pValue=tSapIngressDot1pValue, tSlopeHiAdminStatus=tSlopeHiAdminStatus, tSapIngressQueueCIRLevel=tSapIngressQueueCIRLevel, tNetworkIngressLSPEXPTableLastChanged=tNetworkIngressLSPEXPTableLastChanged, tSapIngressIPv6CriteriaTableLastChanged=tSapIngressIPv6CriteriaTableLastChanged, tSlopeHiMaxProbability=tSlopeHiMaxProbability, tNetworkPolicyRowStatus=tNetworkPolicyRowStatus, tNetworkEgressFCTable=tNetworkEgressFCTable, tNetworkQueuePolicyDescription=tNetworkQueuePolicyDescription, tSapIngressIPCriteriaDescription=tSapIngressIPCriteriaDescription, tSapEgressFCQueue=tSapEgressFCQueue, tSchedulerPolicyTable=tSchedulerPolicyTable, tSapEgressDescription=tSapEgressDescription, tSapIngressQueueCBS=tSapIngressQueueCBS, tNetworkQueueMBS=tNetworkQueueMBS, tSapEgressFCInProfPrec=tSapEgressFCInProfPrec, timetraQosMIBModule=timetraQosMIBModule, tSapIngressFCOutProfPrec=tSapIngressFCOutProfPrec, tAtmTdpObjects=tAtmTdpObjects, tVirtualSchedulerPIR=tVirtualSchedulerPIR, tSapEgressTable=tSapEgressTable, tNetworkPolicyIngressDefaultActionProfile=tNetworkPolicyIngressDefaultActionProfile, tSapIngressFCProfile=tSapIngressFCProfile, tNetworkIngressDSCPProfile=tNetworkIngressDSCPProfile, tNetworkQueueFCTableLastChanged=tNetworkQueueFCTableLastChanged, tAtmTdpTable=tAtmTdpTable, tSapIngressFCOutProfDscp=tSapIngressFCOutProfDscp, tSapIngressIPv6CriteriaDestIpAddr=tSapIngressIPv6CriteriaDestIpAddr, tSapIngressFCBCastQueue=tSapIngressFCBCastQueue, tNetworkQueuePoolName=tNetworkQueuePoolName, tSapIngressIPCriteriaActionFC=tSapIngressIPCriteriaActionFC, tSharedQueueFCMCastQueue=tSharedQueueFCMCastQueue, tSapIngressQueuePoolName=tSapIngressQueuePoolName, tSapIngressMacCriteriaTableLastChanged=tSapIngressMacCriteriaTableLastChanged, tSapIngressDot1pEntry=tSapIngressDot1pEntry, tSapEgressQueueIndex=tSapEgressQueueIndex, tPortSchedulerPlcyLvl1PIR=tPortSchedulerPlcyLvl1PIR, tPortSchedulerPlcyLvl4PIR=tPortSchedulerPlcyLvl4PIR, tSapIngressDSCPPriority=tSapIngressDSCPPriority, tSapIngressMacCriteriaDSAPMask=tSapIngressMacCriteriaDSAPMask, tQ1NamedPoolName=tQ1NamedPoolName, tmnxQosDSCPGroup=tmnxQosDSCPGroup, TDEValue=TDEValue, tNetworkIngressDot1pTable=tNetworkIngressDot1pTable, tSapIngressIPCriteriaEntry=tSapIngressIPCriteriaEntry, tAtmTdpTableLastChanged=tAtmTdpTableLastChanged, tNetworkIngressDot1pRowStatus=tNetworkIngressDot1pRowStatus, tSapIngressIPCriteriaDestIpAddr=tSapIngressIPCriteriaDestIpAddr, tNetworkIngressDot1pTableLastChanged=tNetworkIngressDot1pTableLastChanged, tNetworkIngressDot1pLastChanged=tNetworkIngressDot1pLastChanged, tNetworkEgressFCDEMark=tNetworkEgressFCDEMark, TItemMatch=TItemMatch, tSapIngressIPv6CriteriaSourcePortValue2=tSapIngressIPv6CriteriaSourcePortValue2, tVirtualSchedulerUsePortParent=tVirtualSchedulerUsePortParent, tSapIngressFCRowStatus=tSapIngressFCRowStatus, tQ1NamedPoolLastChanged=tQ1NamedPoolLastChanged, TProfileOrNone=TProfileOrNone, tSchedulerPolicyRowStatus=tSchedulerPolicyRowStatus, tVirtualSchedulerCIRWeight=tVirtualSchedulerCIRWeight, tSapIngressFCInProfPrec=tSapIngressFCInProfPrec, tAtmTdpPir=tAtmTdpPir, tNetworkQueuePortCIRLvl=tNetworkQueuePortCIRLvl, tDSCPNameLastChanged=tDSCPNameLastChanged, tSapIngressPrecFCPriority=tSapIngressPrecFCPriority, tSapIngressDefaultFC=tSapIngressDefaultFC, tNetworkQueueMCast=tNetworkQueueMCast, tQosNotifications=tQosNotifications, tNetworkQueueFCName=tNetworkQueueFCName, TProfile=TProfile, tSapEgressQueueAdminPIR=tSapEgressQueueAdminPIR)
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-QOS-MIB", tNetworkQueuePolicyTable=tNetworkQueuePolicyTable, tVirtualSchedulerSummedCIR=tVirtualSchedulerSummedCIR, tNetworkQueuePIR=tNetworkQueuePIR, tSharedQueueTableLastChanged=tSharedQueueTableLastChanged, tmnxQosSchedulerV5v0Group=tmnxQosSchedulerV5v0Group, tNetworkPolicyTable=tNetworkPolicyTable, tSapEgressQueueOperPIR=tSapEgressQueueOperPIR, tmnxQos7750V4v0Compliance=tmnxQos7750V4v0Compliance, tSapEgressFCEntry=tSapEgressFCEntry, tSapIngressFCQueue=tSapIngressFCQueue, TQueueMode=TQueueMode, tNetworkQueueCIRLevel=tNetworkQueueCIRLevel, tSapEgressQueueCBS=tSapEgressQueueCBS, tNetworkQueue=tNetworkQueue, tQ1NamedPoolTable=tQ1NamedPoolTable, tNetworkQueueHiPrioOnly=tNetworkQueueHiPrioOnly, tSapIngressQueueEntry=tSapIngressQueueEntry, tSapIngressMacCriteriaSnapPid=tSapIngressMacCriteriaSnapPid, tNetworkEgressFCDSCPOutProfile=tNetworkEgressFCDSCPOutProfile, tSlopePolicyEntry=tSlopePolicyEntry, tSapEgressIndex=tSapEgressIndex, tNetworkPolicyIngressDefaultActionFC=tNetworkPolicyIngressDefaultActionFC, tSharedQueuePolicyDescription=tSharedQueuePolicyDescription, tSapEgressQueueCIRWeight=tSapEgressQueueCIRWeight, tSapIngressQueueAdminPIR=tSapIngressQueueAdminPIR, tNetworkEgressFCLspExpOutProfile=tNetworkEgressFCLspExpOutProfile, tQ1NamedPoolNetworkAllocWeight=tQ1NamedPoolNetworkAllocWeight, TAtmTdpDescrType=TAtmTdpDescrType, tNetworkIngressDot1pEntry=tNetworkIngressDot1pEntry, tmnxQosCompliances=tmnxQosCompliances, tPortSchedulerPlcyDescription=tPortSchedulerPlcyDescription, tNetworkQueueParent=tNetworkQueueParent, tVirtualSchedulerTable=tVirtualSchedulerTable, tSchedulerObjects=tSchedulerObjects, tPortSchedulerPlcyOrphanLvl=tPortSchedulerPlcyOrphanLvl, TDEProfile=TDEProfile, tSapIngressQueueCIRAdaptation=tSapIngressQueueCIRAdaptation, tmnxQos7450V4v0Compliance=tmnxQos7450V4v0Compliance, tNetworkQueueFCMCast=tNetworkQueueFCMCast, tSapIngressIPCriteriaTableLastChanged=tSapIngressIPCriteriaTableLastChanged, tNamedPoolPolicyDescription=tNamedPoolPolicyDescription, tNetworkEgressFCDSCPInProfile=tNetworkEgressFCDSCPInProfile, tQosNotifyPrefix=tQosNotifyPrefix, tVirtualSchedulerPortCIRLvl=tVirtualSchedulerPortCIRLvl, tNetworkQueueObjects=tNetworkQueueObjects, tSapEgressFCDot1POutProfile=tSapEgressFCDot1POutProfile, tAtmTdpEntry=tAtmTdpEntry, tAtmTdpServCat=tAtmTdpServCat, tSapIngressDot1pTableLastChanged=tSapIngressDot1pTableLastChanged, tmnxQos7450V6v0Compliance=tmnxQos7450V6v0Compliance, tNetworkIngressDot1pProfile=tNetworkIngressDot1pProfile, TBurstSize=TBurstSize, tNetworkQueueTable=tNetworkQueueTable, tPortSchedulerPlcyLvl6PIR=tPortSchedulerPlcyLvl6PIR, tFCNameLastChanged=tFCNameLastChanged, tSapIngressQueuePoliced=tSapIngressQueuePoliced, tSapIngressPrecTable=tSapIngressPrecTable, tSapEgressQueueTableLastChanged=tSapEgressQueueTableLastChanged, tSharedQueueParent=tSharedQueueParent, tmnxQosSapIngressV6v0Group=tmnxQosSapIngressV6v0Group, tSapEgressRowStatus=tSapEgressRowStatus, tSapIngressDot1pFC=tSapIngressDot1pFC, tAtmTdpIndex=tAtmTdpIndex, tmnxQosQueueV4v0Group=tmnxQosQueueV4v0Group, tNetworkPolicyEgressRemark=tNetworkPolicyEgressRemark, tDSCPNameTable=tDSCPNameTable, tSapEgressFCName=tSapEgressFCName, tSharedQueueFCLastChanged=tSharedQueueFCLastChanged, tSlopeRowStatus=tSlopeRowStatus, tDSCPNameRowStatus=tDSCPNameRowStatus, tmnxQosSapEgressR2r1Group=tmnxQosSapEgressR2r1Group, tPortSchedulerPlcyEntry=tPortSchedulerPlcyEntry, tNamedPoolPolicyQ1PortWeight=tNamedPoolPolicyQ1PortWeight, tNetworkObjects=tNetworkObjects, tSlopeHiMaxAverage=tSlopeHiMaxAverage, tSapIngressQueueCIRWeight=tSapIngressQueueCIRWeight, PYSNMP_MODULE_ID=timetraQosMIBModule, tPortSchedulerPlcyLvl7PIR=tPortSchedulerPlcyLvl7PIR, tNamedPoolPolicyQ1DefaultWeight=tNamedPoolPolicyQ1DefaultWeight, tSapIngressIPv6CriteriaDestPortValue1=tSapIngressIPv6CriteriaDestPortValue1, tSapIngressPrecEntry=tSapIngressPrecEntry, tSapEgressQueueExpedite=tSapEgressQueueExpedite, tSapIngressMacCriteriaDot1PValue=tSapIngressMacCriteriaDot1PValue, tSharedQueueIsMultipoint=tSharedQueueIsMultipoint, tSapIngressQueue=tSapIngressQueue, tSapIngressIPCriteriaDSCP=tSapIngressIPCriteriaDSCP, tSapIngressQueueAdminCIR=tSapIngressQueueAdminCIR, tSapEgressQueueAdminCIR=tSapEgressQueueAdminCIR, tPortSchedulerPlcyLvl8CIR=tPortSchedulerPlcyLvl8CIR, tSapIngressFCMCastQueue=tSapIngressFCMCastQueue, tSapEgressQueueTable=tSapEgressQueueTable, tSapIngressQueueWeight=tSapIngressQueueWeight, tSapEgressQueueRowStatus=tSapEgressQueueRowStatus, tQ1NamedPoolAccessAllocWeight=tQ1NamedPoolAccessAllocWeight, tNetworkQueueFC=tNetworkQueueFC, tSapIngressTable=tSapIngressTable, tSapIngressIPCriteriaIndex=tSapIngressIPCriteriaIndex, tFCNameTable=tFCNameTable, tSharedQueuePoolName=tSharedQueuePoolName, tSapIngressIPv6CriteriaSourceIpMask=tSapIngressIPv6CriteriaSourceIpMask, tVirtualSchedulerEntry=tVirtualSchedulerEntry, tSharedQueueHiPrioOnly=tSharedQueueHiPrioOnly, tSapIngressIPv6CriteriaEntry=tSapIngressIPv6CriteriaEntry, tSapIngressIPCriteriaActionPriority=tSapIngressIPCriteriaActionPriority, tSapIngressMacCriteriaSSAP=tSapIngressMacCriteriaSSAP, tSapIngressDSCP=tSapIngressDSCP, tNetworkQueueCBS=tNetworkQueueCBS, tSapIngressMacCriteriaDSAP=tSapIngressMacCriteriaDSAP, tSharedQueueLastChanged=tSharedQueueLastChanged, tSapIngressPrecTableLastChanged=tSapIngressPrecTableLastChanged, tmnxQosFCGroup=tmnxQosFCGroup, tSapEgressFCDEMark=tSapEgressFCDEMark, tSharedQueueLevel=tSharedQueueLevel, TAdaptationRule=TAdaptationRule, tPortSchedulerPlcyLvl1CIR=tPortSchedulerPlcyLvl1CIR, tSapIngressPrecValue=tSapIngressPrecValue, tPortSchedulerPlcyLvl7CIR=tPortSchedulerPlcyLvl7CIR, tSapIngressFCDE1OutOfProfile=tSapIngressFCDE1OutOfProfile, TPrecValueOrNone=TPrecValueOrNone, tSapIngressFCEntry=tSapIngressFCEntry, tSapEgressEntry=tSapEgressEntry, tNetworkEgressFCForceDEValue=tNetworkEgressFCForceDEValue, tSapIngressQueueLastChanged=tSapIngressQueueLastChanged, tPortSchedulerPlcyLastChanged=tPortSchedulerPlcyLastChanged, tNetworkQueueCIRAdaptation=tNetworkQueueCIRAdaptation, tSapEgressQueueCIRLevel=tSapEgressQueueCIRLevel, tNetworkIngressDSCPRowStatus=tNetworkIngressDSCPRowStatus, TEntryId=TEntryId, tQ1NamedPoolRowStatus=tQ1NamedPoolRowStatus, tPortSchedulerPlcyLvl3CIR=tPortSchedulerPlcyLvl3CIR, tNetworkQueueCIR=tNetworkQueueCIR, tSharedQueuePolicyLastChanged=tSharedQueuePolicyLastChanged, tSapIngressFCInProfDscp=tSapIngressFCInProfDscp, tNetworkQueuePolicyLastChanged=tNetworkQueuePolicyLastChanged, tQ1NamedPoolDescription=tQ1NamedPoolDescription, tSapEgressFCForceDEValue=tSapEgressFCForceDEValue, tSapIngressQueueExpedite=tSapIngressQueueExpedite, tmnxQosFrameBasedV6v0Group=tmnxQosFrameBasedV6v0Group, tNetworkIngressDot1pValue=tNetworkIngressDot1pValue, tSapEgressLastChanged=tSapEgressLastChanged, tSapEgressQueuePortAvgOverhead=tSapEgressQueuePortAvgOverhead, tSlopePolicyTable=tSlopePolicyTable, tSlopeHiStartAverage=tSlopeHiStartAverage, tNetworkPolicyTableLastChanged=tNetworkPolicyTableLastChanged, tSharedQueueFCRowStatus=tSharedQueueFCRowStatus, tSharedQueueCIRLevel=tSharedQueueCIRLevel, tAtmTdpIndexNext=tAtmTdpIndexNext, tNetworkQueuePortCIRWght=tNetworkQueuePortCIRWght, tFCStorageType=tFCStorageType, tSharedQueueCIRWeight=tSharedQueueCIRWeight, tSapIngressIPCriteriaLastChanged=tSapIngressIPCriteriaLastChanged, tSapIngressMacCriteriaFrameType=tSapIngressMacCriteriaFrameType, tNetworkEgressFCDot1pOutProfile=tNetworkEgressFCDot1pOutProfile, tSharedQueueFCQueue=tSharedQueueFCQueue, tNetworkQueueLastChanged=tNetworkQueueLastChanged, tPortSchedulerPlcyLvl5PIR=tPortSchedulerPlcyLvl5PIR, tmnxQosNamedPoolPolicyV6v0Group=tmnxQosNamedPoolPolicyV6v0Group, tSapIngressIPCriteriaRowStatus=tSapIngressIPCriteriaRowStatus, tSapEgressFCDot1PInProfile=tSapEgressFCDot1PInProfile, tPortSchedulerPlcyName=tPortSchedulerPlcyName, tSapIngressFCName=tSapIngressFCName, tSapIngressPrecFC=tSapIngressPrecFC, tSapIngressDSCPTable=tSapIngressDSCPTable, tSapIngressIPv6CriteriaActionPriority=tSapIngressIPv6CriteriaActionPriority, tNetworkIngressDSCP=tNetworkIngressDSCP, tVirtualSchedulerParent=tVirtualSchedulerParent, tPortSchedulerPlcyTable=tPortSchedulerPlcyTable, tVirtualSchedulerPortWght=tVirtualSchedulerPortWght, tVirtualSchedulerName=tVirtualSchedulerName, tNamedPoolPolicyTable=tNamedPoolPolicyTable, tSapIngressIPv6CriteriaSourcePortOperator=tSapIngressIPv6CriteriaSourcePortOperator, tSapIngressIPv6CriteriaDestPortOperator=tSapIngressIPv6CriteriaDestPortOperator, tSapIngressQueueOperCIR=tSapIngressQueueOperCIR, tQ1NamedPoolEntry=tQ1NamedPoolEntry, tNetworkPolicyEntry=tNetworkPolicyEntry, tNetworkIngressDSCPLastChanged=tNetworkIngressDSCPLastChanged, tSapIngressMacCriteriaDot1PMask=tSapIngressMacCriteriaDot1PMask, TLevel=TLevel, tSapEgressQueueUsePortParent=tSapEgressQueueUsePortParent, tSlopePolicy=tSlopePolicy, tSapIngressFCTableLastChanged=tSapIngressFCTableLastChanged, tSapIngressPrecLastChanged=tSapIngressPrecLastChanged, tNetworkPolicyLastChanged=tNetworkPolicyLastChanged, tFCRowStatus=tFCRowStatus, tSapIngressQueuePIRAdaptation=tSapIngressQueuePIRAdaptation, tQ1NamedPoolSlopePolicy=tQ1NamedPoolSlopePolicy, tmnxQosAtmTdpV5v0Group=tmnxQosAtmTdpV5v0Group, tNetworkIngressLSPEXPRowStatus=tNetworkIngressLSPEXPRowStatus, tSapIngressIPCriteriaDestPortValue2=tSapIngressIPCriteriaDestPortValue2, TEntryIndicator=TEntryIndicator, TPriority=TPriority, tDSCPNameDscpValue=tDSCPNameDscpValue, tPortSchedulerPlcyLvl4CIR=tPortSchedulerPlcyLvl4CIR, tAtmTdpSir=tAtmTdpSir, tNetworkPolicyDescription=tNetworkPolicyDescription, TNetworkPolicyID=TNetworkPolicyID, tNamedPoolPolicyRowStatus=tNamedPoolPolicyRowStatus, tSharedQueueExpedite=tSharedQueueExpedite, tSapIngressFCLastChanged=tSapIngressFCLastChanged, tNetworkIngressDSCPFC=tNetworkIngressDSCPFC, tNetworkQueueFCEntry=tNetworkQueueFCEntry, tSharedQueuePolicyTable=tSharedQueuePolicyTable, tQ1NamedPoolTableLastChanged=tQ1NamedPoolTableLastChanged, tSapIngressMacCriteriaEntry=tSapIngressMacCriteriaEntry, tSapIngressRowStatus=tSapIngressRowStatus, tSapIngressMacCriteriaTable=tSapIngressMacCriteriaTable, tSapIngressIPv6CriteriaDestPortValue2=tSapIngressIPv6CriteriaDestPortValue2, TPrecValue=TPrecValue, tSharedQueueCBS=tSharedQueueCBS, tSapIngressIPCriteriaSourceIpMask=tSapIngressIPCriteriaSourceIpMask, tmnxQosGlobalGroup=tmnxQosGlobalGroup, tNetworkIngressDSCPEntry=tNetworkIngressDSCPEntry, tSapIngressScope=tSapIngressScope, tNetworkIngressLSPEXPTable=tNetworkIngressLSPEXPTable, tNetworkPolicyIngressLerUseDscp=tNetworkPolicyIngressLerUseDscp, tNetworkQueuePolicyTableLastChanged=tNetworkQueuePolicyTableLastChanged, tSapIngressMacCriteriaLastChanged=tSapIngressMacCriteriaLastChanged, tSharedQueueRowStatus=tSharedQueueRowStatus, tmnxQosGroups=tmnxQosGroups, tFCNameEntry=tFCNameEntry, tSapIngressQueueRowStatus=tSapIngressQueueRowStatus, tSapIngressIPv6CriteriaTable=tSapIngressIPv6CriteriaTable, tSapIngressDescription=tSapIngressDescription, tSapIngressIPv6CriteriaRowStatus=tSapIngressIPv6CriteriaRowStatus, tSchedulerPolicyTableLastChanged=tSchedulerPolicyTableLastChanged, tSlopeDescription=tSlopeDescription, tmnxQosSapEgressV5v0Group=tmnxQosSapEgressV5v0Group, tSapEgressObjects=tSapEgressObjects, tSapIngressIPv6CriteriaSourcePortValue1=tSapIngressIPv6CriteriaSourcePortValue1, tSapEgressQueueEntry=tSapEgressQueueEntry, tSharedQueueFCTable=tSharedQueueFCTable, tSapIngressQueueMode=tSapIngressQueueMode, tSapIngressIPCriteriaDestPortOperator=tSapIngressIPCriteriaDestPortOperator, tSapIngressObjects=tSapIngressObjects, tNetworkEgressFCName=tNetworkEgressFCName, tAtmTdpCLPTagging=tAtmTdpCLPTagging, tSapEgressQueueMBS=tSapEgressQueueMBS, TMatchCriteria=TMatchCriteria, tSapIngressQueueTable=tSapIngressQueueTable, tSapIngressPrecRowStatus=tSapIngressPrecRowStatus, tSapIngressDot1pRowStatus=tSapIngressDot1pRowStatus, tVirtualSchedulerPortCIRWght=tVirtualSchedulerPortCIRWght, tNetworkQueueTableLastChanged=tNetworkQueueTableLastChanged, tSchedulerPolicyFrameBasedAccnt=tSchedulerPolicyFrameBasedAccnt, tSapIngressQueueTableLastChanged=tSapIngressQueueTableLastChanged, tQosObsoleteObjectsGroup=tQosObsoleteObjectsGroup, tQosObjects=tQosObjects, tmnxQosSapIpv6FilterR4r0Group=tmnxQosSapIpv6FilterR4r0Group, tSapIngressIPCriteriaSourceIpAddr=tSapIngressIPCriteriaSourceIpAddr, tVirtualSchedulerWeight=tVirtualSchedulerWeight, tNetworkIngressDSCPTable=tNetworkIngressDSCPTable, tSapIngressDSCPEntry=tSapIngressDSCPEntry, tSapIngressDSCPTableLastChanged=tSapIngressDSCPTableLastChanged, tAtmTdpCdvt=tAtmTdpCdvt)
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-QOS-MIB", tQ1NamedPoolReservedCbs=tQ1NamedPoolReservedCbs, tSharedQueueWeight=tSharedQueueWeight, tQosDomainLastChanged=tQosDomainLastChanged, tSapIngressIndex=tSapIngressIndex, tSapIngressMacCriteriaRowStatus=tSapIngressMacCriteriaRowStatus, tSapIngressEntry=tSapIngressEntry, tDSCPNameStorageType=tDSCPNameStorageType, tSapIngressMacCriteriaEthernetType=tSapIngressMacCriteriaEthernetType, tFCValue=tFCValue, tSapIngressQueueParent=tSapIngressQueueParent, tSapEgressQueuePortCIRWght=tSapEgressQueuePortCIRWght, tNamedPoolPolicyName=tNamedPoolPolicyName, tSapIngressIPv6CriteriaSourceIpAddr=tSapIngressIPv6CriteriaSourceIpAddr, tSchedulerPolicyName=tSchedulerPolicyName, tPortSchedulerPlcyOrphanWeight=tPortSchedulerPlcyOrphanWeight, tSapIngressMacCriteriaDescription=tSapIngressMacCriteriaDescription, tNetworkEgressFCLspExpInProfile=tNetworkEgressFCLspExpInProfile, tSharedQueuePIR=tSharedQueuePIR, tSlopeObjects=tSlopeObjects, tSharedQueueCIR=tSharedQueueCIR)
