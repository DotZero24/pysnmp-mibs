...
tmnxPortNotifyPortId, tmnxPortType = mibBuilder.importSymbols("ALCATEL-ENT1-TIMETRA-PORT-MIB", "tmnxPortNotifyPortId", "tmnxPortType")
...
TmnxTunnelType, TmnxPortID, TmnxVRtrIDOrZero, TFCType, TmnxEncapVal, TmnxVRtrID, TmnxCustId, TDSCPValueOrNone, TmnxDHCP6MsgType, TDSCPValue, TItemDescription, TCpmProtPolicyID, TPolicyStatementNameOrEmpty, TmnxVPNRouteDistinguisher, TmnxAdminState, TmnxBgpAutonomousSystem, TNamedItem, TmnxTunnelID, Dot1PPriority, TmnxOperState, IpAddressPrefixLength, TmnxStatus, TItemLongDescription, TNamedItemOrEmpty, TmnxServId = mibBuilder.importSymbols("ALCATEL-ENT1-TIMETRA-TC-MIB", "TmnxTunnelType", "TmnxPortID", "TmnxVRtrIDOrZero", "TFCType", "TmnxEncapVal", "TmnxVRtrID", "TmnxCustId", "TDSCPValueOrNone", "TmnxDHCP6MsgType", "TDSCPValue", "TItemDescription", "TCpmProtPolicyID", "TPolicyStatementNameOrEmpty", "TmnxVPNRouteDistinguisher", "TmnxAdminState", "TmnxBgpAutonomousSystem", "TNamedItem", "TmnxTunnelID", "Dot1PPriority", "TmnxOperState", "IpAddressPrefixLength", "TmnxStatus", "TItemLongDescription", "TNamedItemOrEmpty", "TmnxServId")
ObjectIdentifier, OctetString, Integer = mibBuilder.importSymbols("ASN1", "ObjectIdentifier", "OctetString", "Integer")
NamedValues, = mibBuilder.importSymbols("ASN1-ENUMERATION", "NamedValues")
ValueRangeConstraint, SingleValueConstraint, ConstraintsUnion, ConstraintsIntersection, ValueSizeConstraint = mibBuilder.importSymbols("ASN1-REFINEMENT", "ValueRangeConstraint", "SingleValueConstraint", "ConstraintsUnion", "ConstraintsIntersection", "ValueSizeConstraint")
InterfaceIndexOrZero, InterfaceIndex = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero", "InterfaceIndex")
InetAddressPrefixLength, InetAddressIPv6, InetAddressType, InetAddress, InetAddressIPv6z = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddressPrefixLength", "InetAddressIPv6", "InetAddressType", "InetAddress", "InetAddressIPv6z")
...
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-VRTR-MIB", vRtrAS=vRtrAS, vRtrISISRoutes=vRtrISISRoutes, vRtrAggregationLastChanged=vRtrAggregationLastChanged, vRiaInetOperAddress=vRiaInetOperAddress, vRtrAggregationSummaryOnly=vRtrAggregationSummaryOnly, vRtrConfTable=vRtrConfTable, vRtrV6StatCurrNumRoutes=vRtrV6StatCurrNumRoutes, vRtrIpCidrRouteMetric=vRtrIpCidrRouteMetric, vRtrV6StatActiveLdpTunnels=vRtrV6StatActiveLdpTunnels, timetraVRtrMIBModule=timetraVRtrMIBModule, tmnxVRtrHighRouteCleared=tmnxVRtrHighRouteCleared, vRtrSubMgmtActiveRoutes=vRtrSubMgmtActiveRoutes, vRtrRouterId=vRtrRouterId, vRtrIfIcmpUnreachablesTime=vRtrIfIcmpUnreachablesTime, vRtrInetStatRteCpeChkDownTrans=vRtrInetStatRteCpeChkDownTrans, vRtrMaxMcastNumRoutes=vRtrMaxMcastNumRoutes, vRiaIndex=vRiaIndex, vRtrIfIcmp6OutRtrSolicits=vRtrIfIcmp6OutRtrSolicits, vRtrExportPolicy3=vRtrExportPolicy3, vRtrV6DirectRoutes=vRtrV6DirectRoutes, vRtrServiceId=vRtrServiceId, vRtrIfBfdSessionOperState=vRtrIfBfdSessionOperState, vRtrIfDHCP6PfxdPrefLifetime=vRtrIfDHCP6PfxdPrefLifetime, vRtrIfDHCPRelayServerPktsDiscarded=vRtrIfDHCPRelayServerPktsDiscarded, vRtrInstanceAggregationTableLastChanged=vRtrInstanceAggregationTableLastChanged, tmnxVRtrMaxArpEntriesCleared=tmnxVRtrMaxArpEntriesCleared, vRtrName=vRtrName, vRtrAdminState=vRtrAdminState, vRtrInetStaticRouteCpeDropCnt=vRtrInetStaticRouteCpeDropCnt, tmnxVRtrDHCPSuspiciousPcktRcvd=tmnxVRtrDHCPSuspiciousPcktRcvd, vRtrMsdpStatus=vRtrMsdpStatus, vRtrDhcpRestoreLseStateCiAddr=vRtrDhcpRestoreLseStateCiAddr, vRtrDHCP6ClientNetAddr=vRtrDHCP6ClientNetAddr, tmnxVRtrNotificationV6v0Group=tmnxVRtrNotificationV6v0Group, vRtrSvcIpRangeExclusive=vRtrSvcIpRangeExclusive, vRtrIpNetToMediaTimer=vRtrIpNetToMediaTimer, vRtrAggregationAggregatorIPAddr=vRtrAggregationAggregatorIPAddr, tmnxVRtrV6v0Group=tmnxVRtrV6v0Group, vRtrIfAlias=vRtrIfAlias, tmnxVRtrIfCpmProtectGroup=tmnxVRtrIfCpmProtectGroup, vRtrOspfv3Status=vRtrOspfv3Status, vRtrIfIpcpPriDnsAddrType=vRtrIfIpcpPriDnsAddrType, tmnxDot1pAppLastChanged=tmnxDot1pAppLastChanged, vRtrDHCP6LeaseOverrideResult=vRtrDHCP6LeaseOverrideResult, vRtrIfDHCP6LastChanged=vRtrIfDHCP6LastChanged, vRtrSvcIpRangeEntry=vRtrSvcIpRangeEntry, vRtrInetStaticRouteTag=vRtrInetStaticRouteTag, vRtrIfBfdSessionRemAddr=vRtrIfBfdSessionRemAddr, vRtrInetStaticRouteStaticType=vRtrInetStaticRouteStaticType, vRtrStaticRouteIndexMask=vRtrStaticRouteIndexMask, vRtrBGPActiveRoutes=vRtrBGPActiveRoutes, vRtrIfIcmpV6NumTimeExceeded=vRtrIfIcmpV6NumTimeExceeded, vRtrIfPortID=vRtrIfPortID, vRtrIfDHCPVendorIncludeOptions=vRtrIfDHCPVendorIncludeOptions, vRtrV6StatActiveIfs=vRtrV6StatActiveIfs, vRtrInetStatRteCpeChkTTL=vRtrInetStatRteCpeChkTTL, tmnxVRtrBfdSessionProtChange=tmnxVRtrBfdSessionProtChange, vRtrConfEntry=vRtrConfEntry, vRtrIcmp6OutParmProblems=vRtrIcmp6OutParmProblems, vRtrPolicyTable=vRtrPolicyTable, vRtrIPv6MidRouteThreshold=vRtrIPv6MidRouteThreshold, vRtrVrfExportTarget=vRtrVrfExportTarget, vRtrV6ISISRoutes=vRtrV6ISISRoutes, tmnxVRtrIPv6V4v0Group=tmnxVRtrIPv6V4v0Group, vRtrIfIcmp6OutRtrSolicitsTime=vRtrIfIcmp6OutRtrSolicitsTime, vRtrDHCP6ServerNetAddr=vRtrDHCP6ServerNetAddr, vRtrIllegalLabelThreshold=vRtrIllegalLabelThreshold, vRtrIfIcmp6InEchoReplies=vRtrIfIcmp6InEchoReplies, vRtrInetStaticRouteIndex=vRtrInetStaticRouteIndex, vRtrInetStaticRouteLastEnabledTime=vRtrInetStaticRouteLastEnabledTime, vRtrImportPolicy2=vRtrImportPolicy2, vRtrIfNameEntry=vRtrIfNameEntry, vRtrIfDHCP6RelayServer7=vRtrIfDHCP6RelayServer7, vRtrIfIcmpV6NumRedirects=vRtrIfIcmpV6NumRedirects, vRtrInetStaticRouteMetric=vRtrInetStaticRouteMetric, vRtrVrfTarget=vRtrVrfTarget, vRtrIfIpcpEntry=vRtrIfIpcpEntry, vRtrIfDHCPLeaseStateTable=vRtrIfDHCPLeaseStateTable, vRtrImportPolicy1=vRtrImportPolicy1, vRtrIfBfdSessionLclAddrType=vRtrIfBfdSessionLclAddrType, vRtrFailureDescription=vRtrFailureDescription, tmnxDscpAppTable=tmnxDscpAppTable, vRtrIfIcmp6OutEchoReplies=vRtrIfIcmp6OutEchoReplies, vRtrIfDHCPRelayServerPktsSnooped=vRtrIfDHCPRelayServerPktsSnooped, tmnxVRtrDHCPIfLseStatesExceeded=tmnxVRtrDHCPIfLseStatesExceeded, vRtrAdvPrefixAutonomousFlag=vRtrAdvPrefixAutonomousFlag, vRtrIfDHCPRelayInfoAction=vRtrIfDHCPRelayInfoAction, vRtrHostActiveRoutes=vRtrHostActiveRoutes, tmnxVRtr77x0V6v0Compliance=tmnxVRtr77x0V6v0Compliance, vRtrSvcIpRangeTable=vRtrSvcIpRangeTable, vRtrIfIcmp6OutGrpMembResponses=vRtrIfIcmp6OutGrpMembResponses, vRtrOSPFActiveRoutes=vRtrOSPFActiveRoutes, vRtrIfOperState=vRtrIfOperState, vRtrStatActiveSdpTunnels=vRtrStatActiveSdpTunnels, vRtrV6StatIllegalLabels=vRtrV6StatIllegalLabels, vRtrIfDelaySeconds=vRtrIfDelaySeconds, vRtrIfProxyArpPolicy4=vRtrIfProxyArpPolicy4, vRtrInetStatRteCpeChkOutPktCnt=vRtrInetStatRteCpeChkOutPktCnt, vRtrTunnelDest=vRtrTunnelDest, tmnxVRtrBfdSessionUp=tmnxVRtrBfdSessionUp, vRiaInetEui64=vRiaInetEui64, tmnxDscpAppDscpValue=tmnxDscpAppDscpValue, vRtrManagedRouteInetAddr=vRtrManagedRouteInetAddr, tmnxDscpFCDscpValue=tmnxDscpFCDscpValue, tmnxVRtrIPv6IfV4v0Group=tmnxVRtrIPv6IfV4v0Group, vRtrStaticRouteTable=vRtrStaticRouteTable, vRtrIfBfdSessionRemDisc=vRtrIfBfdSessionRemDisc, vRtrIfLdpSyncTimer=vRtrIfLdpSyncTimer, vRtrIfDHCPRelayStatsTable=vRtrIfDHCPRelayStatsTable, vRtrIfServiceId=vRtrIfServiceId, vRtrIfIcmpV6Unreachables=vRtrIfIcmpV6Unreachables, vRtrIfIcmp6InGrpMembResponses=vRtrIfIcmp6InGrpMembResponses, vRtrAdvPrefixPrefix=vRtrAdvPrefixPrefix, vRtrStaticRouteIgpShortcut=vRtrStaticRouteIgpShortcut, vRtrIfDHCPRelayRemoteId=vRtrIfDHCPRelayRemoteId, vRtrInetStatRteCpeNotifyAddrType=vRtrInetStatRteCpeNotifyAddrType, tmnxVRtr7750V4v0Compliance=tmnxVRtr7750V4v0Compliance, vRtrV6ISISActiveRoutes=vRtrV6ISISActiveRoutes, tmnxVRtrIfSubscrAuthV3v0Group=tmnxVRtrIfSubscrAuthV3v0Group, vRtrIfDHCPMatchOption82=vRtrIfDHCPMatchOption82, vRtrIfDHCPRelayClientPktsSnooped=vRtrIfDHCPRelayClientPktsSnooped, vRtrInetStaticRouteNextHop=vRtrInetStaticRouteNextHop, tmnxVRtrBfdMaxSessionOnSlot=tmnxVRtrBfdMaxSessionOnSlot, vRtrIfIcmp6OutNbrSolicitsTime=vRtrIfIcmp6OutNbrSolicitsTime, vRtrIfIPv6ConfigAllowed=vRtrIfIPv6ConfigAllowed, vRtrIfBfdSessionUpCount=vRtrIfBfdSessionUpCount, vRtrStatDynamicARPEntries=vRtrStatDynamicARPEntries, vRtrOspfStatus=vRtrOspfStatus, tmnxVRtrConformance=tmnxVRtrConformance, tmnxDscpAppV6v0Group=tmnxDscpAppV6v0Group, vRtrISISActiveRoutes=vRtrISISActiveRoutes, vRtrIgmpStatus=vRtrIgmpStatus, vRtrStaticRouteNextHop=vRtrStaticRouteNextHop, vRtrIfIcmp6OutMsgs=vRtrIfIcmp6OutMsgs, vRtrExportPolicy1=vRtrExportPolicy1, vRtrIfIngressFilterId=vRtrIfIngressFilterId, vRtrTunnelID=vRtrTunnelID, vRtrIfBfdEchoInterval=vRtrIfBfdEchoInterval, vRtrIfDHCP6PfxdAdminState=vRtrIfDHCP6PfxdAdminState, vRtrInetStaticRouteEgressIfIndex=vRtrInetStaticRouteEgressIfIndex, vRtrIfDHCP6PfxdValidLifetime=vRtrIfDHCP6PfxdValidLifetime, vRtrDHCP6OldAssignedNetAddrType=vRtrDHCP6OldAssignedNetAddrType, vRtrDHCP6NewClientId=vRtrDHCP6NewClientId, tmnxVRtrMcastMaxRoutesCleared=tmnxVRtrMcastMaxRoutesCleared, vRtrIfTable=vRtrIfTable, vRtrAggregationOperState=vRtrAggregationOperState, tmnxVRtrDHCPLseStRestoreProblem=tmnxVRtrDHCPLseStRestoreProblem, vRtrSecondaryVrfId=vRtrSecondaryVrfId, vRtrNewIfIndex=vRtrNewIfIndex, vRtrIfDHCP6EnableNgbrResolution=vRtrIfDHCP6EnableNgbrResolution, vRtrIfIcmp6OutRtrAdvTime=vRtrIfIcmp6OutRtrAdvTime, vRtrIfProxyArpPolicy3=vRtrIfProxyArpPolicy3, vRtrInetInstAggrTblLastChged=vRtrInetInstAggrTblLastChged, vRtrInetStaticRouteEnableBfd=vRtrInetStaticRouteEnableBfd, vRtrIfIcmpMaskReply=vRtrIfIcmpMaskReply, vRtrGracefulRestartType=vRtrGracefulRestartType, vRtrIgnoreIcmpRedirect=vRtrIgnoreIcmpRedirect, vRtrIfDHCP6AdminState=vRtrIfDHCP6AdminState, tmnxVRtrStaticRteCPEChkV6v0Group=tmnxVRtrStaticRteCPEChkV6v0Group, vRtrStaticRouteIndexDest=vRtrStaticRouteIndexDest, vRtrIfDHCPRelayTxPkts=vRtrIfDHCPRelayTxPkts, tmnxVRtrGlobalR2r1Group=tmnxVRtrGlobalR2r1Group, vRtrIcmp6OutRtrAdvertisements=vRtrIcmp6OutRtrAdvertisements, vRtrAdvPrefixPreferredLifetime=vRtrAdvPrefixPreferredLifetime, vRtrExportPolicy5=vRtrExportPolicy5, vRtrStaticRouteStaticType=vRtrStaticRouteStaticType, tmnxVRtrV4v0Group=tmnxVRtrV4v0Group, vRtrIfPhysicalAddress=vRtrIfPhysicalAddress, tmnxDot1pAppTableLastChanged=tmnxDot1pAppTableLastChanged, vRtrV6HostRoutes=vRtrV6HostRoutes, vRtrIfType=vRtrIfType, vRtrInetStaticRouteCpeAddrType=vRtrInetStaticRouteCpeAddrType, vRtrIfUnnumbered=vRtrIfUnnumbered, vRtrRouteDistinguisher=vRtrRouteDistinguisher, tmnxVRtrIfV4v0Group=tmnxVRtrIfV4v0Group, vRtrIfDHCPRelayAuthPktsDiscarded=vRtrIfDHCPRelayAuthPktsDiscarded, tmnxDot1pAppTable=tmnxDot1pAppTable, vRtrInetStatRteCpeChkUpTrans=vRtrInetStatRteCpeChkUpTrans, vRtrDHCP6MsgStatEntry=vRtrDHCP6MsgStatEntry, tmnxVRtr7450V6v0Compliance=tmnxVRtr7450V6v0Compliance, vRtrDhcpRestoreLseStateProblem=vRtrDhcpRestoreLseStateProblem, vRtrStatBGPVpnRoutes=vRtrStatBGPVpnRoutes, vRtrAdvPrefixLength=vRtrAdvPrefixLength, tmnxVRtrObsoleteV5v0Group=tmnxVRtrObsoleteV5v0Group, vRtrIfDHCP6Entry=vRtrIfDHCP6Entry, tmnxVRtrIPv6MidRouteTCA=tmnxVRtrIPv6MidRouteTCA, vRtrIfMplsStatus=vRtrIfMplsStatus, vRtrIfNameTable=vRtrIfNameTable, vRtrInetStatRteCpeChkInPktCnt=vRtrInetStatRteCpeChkInPktCnt, vRtrInetStaticRouteAvailIndex=vRtrInetStaticRouteAvailIndex, vRtrIfProxyNDLocal=vRtrIfProxyNDLocal, vRtrIfIcmp6InErrors=vRtrIfIcmp6InErrors, vRtrStatLocalARPEntries=vRtrStatLocalARPEntries, vRtrIfIcmp6OutPktTooBigs=vRtrIfIcmp6OutPktTooBigs, vRtrInetStaticRouteCpeStatus=vRtrInetStaticRouteCpeStatus, vRtrConfiguredVRtrs=vRtrConfiguredVRtrs, vRtrIPv6HighRouteThreshold=vRtrIPv6HighRouteThreshold, vRtrIfProxyArpTable=vRtrIfProxyArpTable, vRtrIfIcmp6InRedirects=vRtrIfIcmp6InRedirects, vRtrMcPathMgmtPlcyName=vRtrMcPathMgmtPlcyName, vRtrIPv6RouteThresholdSoakTime=vRtrIPv6RouteThresholdSoakTime, vRtrIfDHCPLseStatePersistKey=vRtrIfDHCPLseStatePersistKey, vRtrIfDHCPRelayServer3=vRtrIfDHCPRelayServer3, vRtrIfIcmpV6UnreachablesTime=vRtrIfIcmpV6UnreachablesTime, vRtrIfBfdSessionLclAddr=vRtrIfBfdSessionLclAddr, vRtrInetAggrAggregatorAS=vRtrInetAggrAggregatorAS, vRtrRowStatus=vRtrRowStatus, vRiaInetPrefixLen=vRiaInetPrefixLen, tmnxVRtrMaxArpEntriesTCA=tmnxVRtrMaxArpEntriesTCA, tmnxDscpAppEntry=tmnxDscpAppEntry, vRtrIfIcmp6OutDestUnreachs=vRtrIfIcmp6OutDestUnreachs, vRtrV6BGPActiveRoutes=vRtrV6BGPActiveRoutes, vRtrStaticRouteIndexTable=vRtrStaticRouteIndexTable, vRtrRsvpStatus=vRtrRsvpStatus, vRtrIcmp6InEchos=vRtrIcmp6InEchos, vRtrV6StatTotalRsvpTunnels=vRtrV6StatTotalRsvpTunnels, vRtrSvcIpRangeRowStatus=vRtrSvcIpRangeRowStatus, vRtrIfEncapValue=vRtrIfEncapValue, vRtrIfDHCPRelayServer6=vRtrIfDHCPRelayServer6, vRtrInstanceAggregationTable=vRtrInstanceAggregationTable, vRtrDHCP6MsgStatsRcvd=vRtrDHCP6MsgStatsRcvd, vRtrIfDHCPClientApplications=vRtrIfDHCPClientApplications, vRtrDescription=vRtrDescription, vRtrVpnId=vRtrVpnId, vRtrIfIPv6OperState=vRtrIfIPv6OperState, vRtrEcmpMaxRoutes=vRtrEcmpMaxRoutes, vRtrIfDHCPLseStateRemainLseTime=vRtrIfDHCPLseStateRemainLseTime, vRtrIPv6MaxNumRoutes=vRtrIPv6MaxNumRoutes, vRtrDhcpLseStateNewChAddr=vRtrDhcpLseStateNewChAddr, vRtrMldStatus=vRtrMldStatus, vRtrDirectRoutes=vRtrDirectRoutes, vRtrIfUnnumberedIf=vRtrIfUnnumberedIf, vRtrIcmp6InRtrAdvertisements=vRtrIcmp6InRtrAdvertisements, vRtrIcmp6InNbrSolicits=vRtrIcmp6InNbrSolicits, vRtrTunnelPreference=vRtrTunnelPreference, vRtrIsIsStatus=vRtrIsIsStatus, vRtrIfDHCPOperLeasePopulate=vRtrIfDHCPOperLeasePopulate, vRtrAutoFilterDHCPClientAddress=vRtrAutoFilterDHCPClientAddress, tmnxDot1pAppId=tmnxDot1pAppId, tmnxVRtrGlobalObjs=tmnxVRtrGlobalObjs, vRtrIPv6IgnoreIcmpRedirect=vRtrIPv6IgnoreIcmpRedirect, vRtrIfBfdSessionDownCount=vRtrIfBfdSessionDownCount, vRtrIfCpmProtUncfgdProtoDropCnt=vRtrIfCpmProtUncfgdProtoDropCnt, tmnxVRtrIPv6IpV4v0Group=tmnxVRtrIPv6IpV4v0Group, vRtrIcmp6InGrpMembQueries=vRtrIcmp6InGrpMembQueries, vRtrIfIpcpTable=vRtrIfIpcpTable, vRtrV6StatConfiguredIfs=vRtrV6StatConfiguredIfs, vRtrIpCidrRouteLastEnabledTime=vRtrIpCidrRouteLastEnabledTime, vRtrMaxNumRoutesLogOnly=vRtrMaxNumRoutesLogOnly, vRtrIfIcmp6InGrpMembQueries=vRtrIfIcmp6InGrpMembQueries, tmnxVRtrDHCP6LseStateOverride=tmnxVRtrDHCP6LseStateOverride, vRtrDHCP6ClientNetAddrType=vRtrDHCP6ClientNetAddrType, vRtrInetSvcIpRangePfxLen=vRtrInetSvcIpRangePfxLen, vRtrV6StatActiveRsvpTunnels=vRtrV6StatActiveRsvpTunnels)
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-VRTR-MIB", vRtrIfDHCPAdminState=vRtrIfDHCPAdminState, tmnxVRtrIPv6IpV5v0Group=tmnxVRtrIPv6IpV5v0Group, vRtrHostRoutes=vRtrHostRoutes, vRtrDHCP6MsgStatsMsgType=vRtrDHCP6MsgStatsMsgType, tmnxVRtrDHCPAFEntriesExceeded=tmnxVRtrDHCPAFEntriesExceeded, vRtrIcmp6OutAdminProhibs=vRtrIcmp6OutAdminProhibs, vRtrIcmp6OutNbrSolicits=vRtrIcmp6OutNbrSolicits, vRtrIfDHCPLseStateOption82=vRtrIfDHCPLseStateOption82, vRtrIfDHCP6CurrLeasePopulate=vRtrIfDHCP6CurrLeasePopulate, tmnxDscpAppLastChanged=tmnxDscpAppLastChanged, vRtrIfDHCP6ServerMaxLeaseStates=vRtrIfDHCP6ServerMaxLeaseStates, vRtrIpCidrRouteTable=vRtrIpCidrRouteTable, vRtrIfChannelID=vRtrIfChannelID, vRtrStatManagedARPEntries=vRtrStatManagedARPEntries, vRtrIfDHCPRelayRxUntrustedPkts=vRtrIfDHCPRelayRxUntrustedPkts, vRiaIgpInhibit=vRiaIgpInhibit, vRtrIpCidrRouteEntry=vRtrIpCidrRouteEntry, vRtrIfDHCP6ItfIdString=vRtrIfDHCP6ItfIdString, vRtrAggregationASSet=vRtrAggregationASSet, vRtrIfGlobalIndexvRtrID=vRtrIfGlobalIndexvRtrID, vRtrIfIcmpV6RedirectsTime=vRtrIfIcmpV6RedirectsTime, vRtrIfDHCPRelayTrusted=vRtrIfDHCPRelayTrusted, vRtrV6StaticRoutes=vRtrV6StaticRoutes, vRtrIfBfdSessionProtocols=vRtrIfBfdSessionProtocols, vRtrIfDHCPProxyServerAddr=vRtrIfDHCPProxyServerAddr, vRtrIfDHCPAntiSpoofMacAddr=vRtrIfDHCPAntiSpoofMacAddr, tmnxVRtrIPv6HighRouteCleared=tmnxVRtrIPv6HighRouteCleared, vRtrIfDHCPRelayServerPktsRelayed=vRtrIfDHCPRelayServerPktsRelayed, vRtrIfCflowd=vRtrIfCflowd, vRtrIfDHCPLseStateCiAddr=vRtrIfDHCPLseStateCiAddr, tmnxVRtrDHCP6ServerLseStExceeded=tmnxVRtrDHCP6ServerLseStExceeded, vRtrIfIcmpV6NumPktTooBig=vRtrIfIcmpV6NumPktTooBig, PYSNMP_MODULE_ID=timetraVRtrMIBModule, vRtrOSPFRoutes=vRtrOSPFRoutes, vRtrIfIcmpV6Redirects=vRtrIfIcmpV6Redirects, vRtrIfDescription=vRtrIfDescription, vRtrIcmp6OutGrpMembResponses=vRtrIcmp6OutGrpMembResponses, vRtrStatActiveRsvpTunnels=vRtrStatActiveRsvpTunnels, tmnxDscpFCEntry=tmnxDscpFCEntry, vRtrIfIcmp6OutErrors=vRtrIfIcmp6OutErrors, vRtrMcastMidRouteThreshold=vRtrMcastMidRouteThreshold, vRtrIcmp6InMsgs=vRtrIcmp6InMsgs, vRtrStaticRouteEntry=vRtrStaticRouteEntry, tmnxVRtrIpV4v0Group=tmnxVRtrIpV4v0Group, vRtrIfBfdTransmitInterval=vRtrIfBfdTransmitInterval, vRtrInetAggrIpPrefixLen=vRtrInetAggrIpPrefixLen, vRtrSvcIpRangeAddress=vRtrSvcIpRangeAddress, vRtrIfNameIndex=vRtrIfNameIndex, vRtrIfOperMtu=vRtrIfOperMtu, vRtrIfBfdSessionOperFlags=vRtrIfBfdSessionOperFlags, vRtrIfDHCP6LeasePopulate=vRtrIfDHCP6LeasePopulate, vRtrInetStaticRouteRowStatus=vRtrInetStaticRouteRowStatus, vRtrDhcpRestoreLseStateIfIndex=vRtrDhcpRestoreLseStateIfIndex, vRtrIfDHCPRelayInfoOption=vRtrIfDHCPRelayInfoOption, vRtrIfIcmpTtlExpiredTime=vRtrIfIcmpTtlExpiredTime, vRtrIfDelayUpTimer=vRtrIfDelayUpTimer, vRtrAdvPrefixTable=vRtrAdvPrefixTable, vRtrV6StatTotalLdpTunnels=vRtrV6StatTotalLdpTunnels, vRtrIfBfdSessionLclDisc=vRtrIfBfdSessionLclDisc, tmnxVRtrDHCPLeaseStateOverride=tmnxVRtrDHCPLeaseStateOverride, vRtrIfIcmpUnreachables=vRtrIfIcmpUnreachables, vRtrIfDHCPLeasePopulate=vRtrIfDHCPLeasePopulate, vRtrManagedActiveRoutes=vRtrManagedActiveRoutes, vRtrIfProtocol=vRtrIfProtocol, vRtrIfBfdTable=vRtrIfBfdTable, vRtrIcmp6OutEchos=vRtrIcmp6OutEchos, vRtrV6StatTotalNbrEntries=vRtrV6StatTotalNbrEntries, vRtrIfEgressFilterId=vRtrIfEgressFilterId, vRtrIfProxyArpPolicy2=vRtrIfProxyArpPolicy2, vRtrIfProxyArpPolicy5=vRtrIfProxyArpPolicy5, vRiaInetAddress=vRiaInetAddress, vRtrRouteThresholdSoakTime=vRtrRouteThresholdSoakTime, vRtrIfGlobalIndexTable=vRtrIfGlobalIndexTable, vRtrInetStaticRouteIndexTable=vRtrInetStaticRouteIndexTable, tmnxVRtrBfdV6v0Group=tmnxVRtrBfdV6v0Group, tmnxVRtrDHCP6RelayReplyStripUni=tmnxVRtrDHCP6RelayReplyStripUni, vRtrIfDHCPOperAutoFilter=vRtrIfDHCPOperAutoFilter, vRtrAggregationIpPrefixMask=vRtrAggregationIpPrefixMask, vRtrInetAggrIpPrefixType=vRtrInetAggrIpPrefixType, vRtrV6AggregateActiveRoutes=vRtrV6AggregateActiveRoutes, vRtrMaxARPEntries=vRtrMaxARPEntries, vRtrAdvPrefixOnLinkFlag=vRtrAdvPrefixOnLinkFlag, vRtrIfIcmp6InEchos=vRtrIfIcmp6InEchos, vRtrIfBfdSessionState=vRtrIfBfdSessionState, vRtrIfBfdReceiveInterval=vRtrIfBfdReceiveInterval, vRtrIfIcmpV6ParamProblem=vRtrIfIcmpV6ParamProblem, vRtrStaticRoutePreference=vRtrStaticRoutePreference, vRtrIfDHCPAutoFilter=vRtrIfDHCPAutoFilter, vRtrStaticRouteTag=vRtrStaticRouteTag, vRtrIfIcmp6OutNbrSolicits=vRtrIfIcmp6OutNbrSolicits, vRtrIfIcmp6OutNbrAdvertisements=vRtrIfIcmp6OutNbrAdvertisements, vRtrIfProxyNDEntry=vRtrIfProxyNDEntry, vRtrIfIcmpV6TimeExceededTime=vRtrIfIcmpV6TimeExceededTime, tmnxVRtrDHCPLseStatePopulateErr=tmnxVRtrDHCPLseStatePopulateErr, vRtrIfDHCP6Description=vRtrIfDHCP6Description, vRtrIcmp6OutGrpMembQueries=vRtrIcmp6OutGrpMembQueries, vRtrStaticRouteRowStatus=vRtrStaticRouteRowStatus, vRtrIcmp6OutErrors=vRtrIcmp6OutErrors, vRtrInstanceAggregationEntry=vRtrInstanceAggregationEntry, vRtrIfIpcpSecDnsAddrType=vRtrIfIpcpSecDnsAddrType, vRtrStaticRouteIndexEntry=vRtrStaticRouteIndexEntry, vRiaInetAddrState=vRiaInetAddrState, tmnxVRtrCompliances=tmnxVRtrCompliances, vRtrIcmp6OutPktTooBigs=vRtrIcmp6OutPktTooBigs, vRtrInetSvcIpRangeAddr=vRtrInetSvcIpRangeAddr, vRtrIpNetToMediaEntry=vRtrIpNetToMediaEntry, vRtrStatInternalARPEntries=vRtrStatInternalARPEntries, vRtrIfBfdSessionLastUpTime=vRtrIfBfdSessionLastUpTime, vRtrHighRouteThreshold=vRtrHighRouteThreshold, vRtrTunnelType=vRtrTunnelType, vRtrIfDHCP6PfxDelegationTable=vRtrIfDHCP6PfxDelegationTable, vRtrIfDHCPLseStateChAddr=vRtrIfDHCPLseStateChAddr, vRtrIfBfdSessionMesgSent=vRtrIfBfdSessionMesgSent, vRtrIcmp6OutEchoReplies=vRtrIcmp6OutEchoReplies, vRtrBGPRoutes=vRtrBGPRoutes, vRiaInetGwAddressType=vRiaInetGwAddressType, vRtrIfDHCPGiAddress=vRtrIfDHCPGiAddress, vRtrInetStaticRouteIndexEntry=vRtrInetStaticRouteIndexEntry, vRtrIfDHCP6RelayServer1=vRtrIfDHCP6RelayServer1, vRtrStatActiveIfs=vRtrStatActiveIfs, vRtrAggregateActiveRoutes=vRtrAggregateActiveRoutes, vRtrIcmp6InAdminProhibs=vRtrIcmp6InAdminProhibs, vRtrIfDHCPRelayServer7=vRtrIfDHCPRelayServer7, vRtrIfDHCPRelayClientPktsProxLS=vRtrIfDHCPRelayClientPktsProxLS, vRtrStaticRouteStatus=vRtrStaticRouteStatus, vRtrIfProxyNDPolicy3=vRtrIfProxyNDPolicy3, vRtrIfIpcpSecDnsAddr=vRtrIfIpcpSecDnsAddr, tmnxVRtrHighRouteTCA=tmnxVRtrHighRouteTCA, vRtrV6AggregateRoutes=vRtrV6AggregateRoutes, vRtrIfDHCP6PfxdLastChanged=vRtrIfDHCP6PfxdLastChanged, vRtrAdvPrefixIfIndex=vRtrAdvPrefixIfIndex, vRtrV6StatTotalSdpTunnels=vRtrV6StatTotalSdpTunnels, vRtrIfIcmp6InMsgs=vRtrIfIcmp6InMsgs, tmnxDot1pAppValue=tmnxDot1pAppValue, vRiaInetRemoteIpType=vRiaInetRemoteIpType, tmnxVRtrDHCPLseStsExceeded=tmnxVRtrDHCPLseStsExceeded, vRtrIcmp6InParmProblems=vRtrIcmp6InParmProblems, tmnxVRtrIfDHCPRelayGroup=tmnxVRtrIfDHCPRelayGroup, vRtrIpNetToMediaTable=vRtrIpNetToMediaTable, vRtrStaticRouteAvailableIndex=vRtrStaticRouteAvailableIndex, vRtrDHCP6OldClientId=vRtrDHCP6OldClientId, vRtrIfIcmp6OutNbrAdvTime=vRtrIfIcmp6OutNbrAdvTime, vRtrIfBfdAdminState=vRtrIfBfdAdminState, vRtrLdpStatus=vRtrLdpStatus, vRtrVrfImportTarget=vRtrVrfImportTarget, vRtrInetStaticRouteEntry=vRtrInetStaticRouteEntry, vRtrIfIcmp6OutTimeExcds=vRtrIfIcmp6OutTimeExcds, vRtrInetAggrAggregatorIPAddr=vRtrInetAggrAggregatorIPAddr, vRtrConfederationAS=vRtrConfederationAS, vRtrNumberOfBfdSessionsOnSlot=vRtrNumberOfBfdSessionsOnSlot, vRtrIfDHCP6PfxDelegationLstChgd=vRtrIfDHCP6PfxDelegationLstChgd, vRtrIcmp6InNbrAdvertisements=vRtrIcmp6InNbrAdvertisements, vRtrStatActiveLdpTunnels=vRtrStatActiveLdpTunnels, vRtrIcmp6InErrors=vRtrIcmp6InErrors, vRtrID=vRtrID, vRtrIfIpcpPeerAddrType=vRtrIfIpcpPeerAddrType, vRtrInetStatRteCpeNotifyAddr=vRtrInetStatRteCpeNotifyAddr, tmnxVRtrIfV5v0Group=tmnxVRtrIfV5v0Group, vRtrV6OSPFRoutes=vRtrV6OSPFRoutes, vRtrTunnelAge=vRtrTunnelAge, vRtrStaticRouteEgressIfIndex=vRtrStaticRouteEgressIfIndex, vRtrDHCP6DropStatReason=vRtrDHCP6DropStatReason, tmnxVRtrStaticRouteCPEStatus=tmnxVRtrStaticRouteCPEStatus, vRtrIfGlobalIndexvRtrIfIndex=vRtrIfGlobalIndexvRtrIfIndex, tmnxVRtrV5v0Group=tmnxVRtrV5v0Group, vRtrStatTotalLdpTunnels=vRtrStatTotalLdpTunnels, vRtrIfDHCPSnooping=vRtrIfDHCPSnooping, vRtrIfDHCPRelayRxPkts=vRtrIfDHCPRelayRxPkts, vRtrDHCP6AssignedNetAddrType=vRtrDHCP6AssignedNetAddrType, vRtrIfIcmpRedirects=vRtrIfIcmpRedirects, vRtrDHCP6DropStatEntry=vRtrDHCP6DropStatEntry, vRtrInetStatRteCpeChkUpTime=vRtrInetStatRteCpeChkUpTime, vRtrIfDHCPLayer2Header=vRtrIfDHCPLayer2Header, vRtrV6RIPRoutes=vRtrV6RIPRoutes, vRiaInetGwAddress=vRiaInetGwAddress, vRtrIfBfdSessionRemAddrType=vRtrIfBfdSessionRemAddrType, vRtrIfDHCP6Table=vRtrIfDHCP6Table, vRtrStaticRouteMask=vRtrStaticRouteMask, TmnxInetAddrState=TmnxInetAddrState, vRtrIfDHCP6RelayServer6=vRtrIfDHCP6RelayServer6, vRtrIfTotalNumber=vRtrIfTotalNumber, vRtrSvcIpRangeMask=vRtrSvcIpRangeMask, vRtrDhcpPacketProblem=vRtrDhcpPacketProblem, tmnxVRtrNotificationObjV5v0Group=tmnxVRtrNotificationObjV5v0Group, vRtrIfDHCPGiAddressType=vRtrIfDHCPGiAddressType, vRtrInetStaticRouteNextHopIf=vRtrInetStaticRouteNextHopIf, vRtrStaticRouteNumber=vRtrStaticRouteNumber, vRtrPolicyEntry=vRtrPolicyEntry, vRtrV6StaticActiveRoutes=vRtrV6StaticActiveRoutes, vRtrStaticRouteNextHopUnnumberedIf=vRtrStaticRouteNextHopUnnumberedIf, vRtrIfIcmp6OutGrpMembQueries=vRtrIfIcmp6OutGrpMembQueries, tmnxVRtrBfdSessionDeleted=tmnxVRtrBfdSessionDeleted, tmnxVRtrMcastMidRouteTCA=tmnxVRtrMcastMidRouteTCA, vRtrIfDHCPEntry=vRtrIfDHCPEntry, vRtrIfProxyNDPolicy4=vRtrIfProxyNDPolicy4, TmnxVPNId=TmnxVPNId, vRtrDhcpRestoreLseStateVRtrId=vRtrDhcpRestoreLseStateVRtrId, tmnxVRtrBfdSessionDown=tmnxVRtrBfdSessionDown, vRtrIcmp6OutGrpMembReductions=vRtrIcmp6OutGrpMembReductions, vRtrIfIPv6IngressFilterId=vRtrIfIPv6IngressFilterId, vRtrIfIcmpV6PktTooBigTime=vRtrIfIcmpV6PktTooBigTime, vRtrInetStaticRouteDest=vRtrInetStaticRouteDest, vRtrImportPolicy3=vRtrImportPolicy3, vRtrIcmp6Entry=vRtrIcmp6Entry, vRtrSubMgmtRoutes=vRtrSubMgmtRoutes, vRtrIfArpTimeout=vRtrIfArpTimeout, vRtrIfIcmp6InRtrSolicits=vRtrIfIcmp6InRtrSolicits, vRtrInetStaticRouteDestType=vRtrInetStaticRouteDestType, vRtrImportPolicy4=vRtrImportPolicy4, vRtrDHCP6DropStatLastCleared=vRtrDHCP6DropStatLastCleared, vRtrDhcpLseStateOldChAddr=vRtrDhcpLseStateOldChAddr, vRtrNextVRtrID=vRtrNextVRtrID, vRtrTunnelNexthop=vRtrTunnelNexthop, vRtrStatBGPVpnActiveRoutes=vRtrStatBGPVpnActiveRoutes, vRtrIcmp6InDestUnreachs=vRtrIcmp6InDestUnreachs, vRtrIfBfdSessionTxInterval=vRtrIfBfdSessionTxInterval, vRtrIfGlobalIndexEntry=vRtrIfGlobalIndexEntry, vRtrInetAggrIpPrefix=vRtrInetAggrIpPrefix, vRtrIfIcmp6OutRedirects=vRtrIfIcmp6OutRedirects, vRtrIpAddrTable=vRtrIpAddrTable, tmnxDscpAppId=tmnxDscpAppId, vRtrIfIcmpNumRedirects=vRtrIfIcmpNumRedirects, vRtrIfIcmp6OutAdminProhibs=vRtrIfIcmp6OutAdminProhibs, vRtrStatTotalRsvpTunnels=vRtrStatTotalRsvpTunnels, vRtrIfDHCPAutoFilterId=vRtrIfDHCPAutoFilterId, vRtrIcmp6OutTimeExcds=vRtrIcmp6OutTimeExcds, vRtrIfDHCP6PfxDelegationEntry=vRtrIfDHCP6PfxDelegationEntry, vRtrIfLinkLocalAddress=vRtrIfLinkLocalAddress, vRtrStatTotalSdpTunnels=vRtrStatTotalSdpTunnels, vRtrDirectActiveRoutes=vRtrDirectActiveRoutes, vRtrCustId=vRtrCustId, vRtrStatCurrNumRoutes=vRtrStatCurrNumRoutes, vRtrInetStatRteCpeChkStatsTable=vRtrInetStatRteCpeChkStatsTable, vRtrIfIcmpV6NumUnreachables=vRtrIfIcmpV6NumUnreachables, vRtrIfDirectedBroadcast=vRtrIfDirectedBroadcast, vRtrIcmp6InGrpMembResponses=vRtrIcmp6InGrpMembResponses, vRtrPimStatus=vRtrPimStatus, vRtrIfDHCPRelayServer1=vRtrIfDHCPRelayServer1, vRtrAggregationAggregatorAS=vRtrAggregationAggregatorAS, vRtrDHCP6DropStatTable=vRtrDHCP6DropStatTable, vRtrIcmp6InRtrSolicits=vRtrIcmp6InRtrSolicits, tmnxVRtrNotificationV5v0Group=tmnxVRtrNotificationV5v0Group, vRtrV6HostActiveRoutes=vRtrV6HostActiveRoutes, vRtrIcmp6Table=vRtrIcmp6Table, vRtrDhcpLseStateOldCiAddr=vRtrDhcpLseStateOldCiAddr, vRtrIfDHCPRelayPktsGenRelease=vRtrIfDHCPRelayPktsGenRelease, vRtrInetSvcIpRangeAddrType=vRtrInetSvcIpRangeAddrType, vRtrIfDHCPRelayServer4=vRtrIfDHCPRelayServer4, vRtrInetSvcIpRangeTable=vRtrInetSvcIpRangeTable, vRtrAggregateRoutes=vRtrAggregateRoutes, vRtrInetStaticRouteCpeInterval=vRtrInetStaticRouteCpeInterval, vRtrAggregationRowStatus=vRtrAggregationRowStatus, vRtrIPv6MaxNumRoutesLogOnly=vRtrIPv6MaxNumRoutesLogOnly, vRtrIfDHCPRelayServer8=vRtrIfDHCPRelayServer8)
mibBuilder.exportSymbols("ALCATEL-ENT1-TIMETRA-VRTR-MIB", vRtrInetAggrOperState=vRtrInetAggrOperState, vRtrIfMtu=vRtrIfMtu, vRtrIfIcmp6InAdminProhibs=vRtrIfIcmp6InAdminProhibs, vRtrInetStaticRouteCpeEnableLog=vRtrInetStaticRouteCpeEnableLog, vRtrIfCpmProtPolicyId=vRtrIfCpmProtPolicyId, vRtrIfDHCP6SourceAddress=vRtrIfDHCP6SourceAddress, vRtrDHCP6OldAssignedNetAddr=vRtrDHCP6OldAssignedNetAddr, vRtrIfDHCP6PfxdPrefix=vRtrIfDHCP6PfxdPrefix, vRtrIcmp6OutMsgs=vRtrIcmp6OutMsgs, vRtrTunnelMask=vRtrTunnelMask, vRiaNetMask=vRiaNetMask, vRtrIfIcmp6InRtrAdvertisements=vRtrIfIcmp6InRtrAdvertisements, vRtrStatIllegalLabels=vRtrStatIllegalLabels, vRtrInetInstAggrEntry=vRtrInetInstAggrEntry, tmnxDscpFCTableLastChanged=tmnxDscpFCTableLastChanged, vRtrGracefulRestart=vRtrGracefulRestart, vRtrIfDHCP6OperState=vRtrIfDHCP6OperState, vRtrTriggeredPolicy=vRtrTriggeredPolicy, vRtrIfDHCPRelayRxMalformedPkts=vRtrIfDHCPRelayRxMalformedPkts, vRtrIfProxyNDPolicy1=vRtrIfProxyNDPolicy1, vRtrBfdMaxSessionReason=vRtrBfdMaxSessionReason, vRtrIfArpPopulate=vRtrIfArpPopulate, vRtrDHCP6ServerNetAddrType=vRtrDHCP6ServerNetAddrType, vRtrIfDHCP6RelayServer2=vRtrIfDHCP6RelayServer2, vRtrIfIcmpV6ParamProblemTime=vRtrIfIcmpV6ParamProblemTime, vRtrInetStatRteCpeChkStatsEntry=vRtrInetStatRteCpeChkStatsEntry, vRtrIfBfdEntry=vRtrIfBfdEntry, vRtrIfBfdSessionTable=vRtrIfBfdSessionTable, vRtrIcmp6OutRedirects=vRtrIcmp6OutRedirects, vRtrIfIcmp6InNbrAdvertisements=vRtrIfIcmp6InNbrAdvertisements, vRtrIfDHCPRelayCircuitId=vRtrIfDHCPRelayCircuitId, vRtrInetStaticRouteIgpShortcut=vRtrInetStaticRouteIgpShortcut, tmnxVRtrIfDhcpServerGroup=tmnxVRtrIfDhcpServerGroup, vRtrIfDHCPProxyLeaseTime=vRtrIfDHCPProxyLeaseTime, tmnxVRtr7750V5v0Compliance=tmnxVRtr7750V5v0Compliance, vRtrIfIpcpPriDnsAddr=vRtrIfIpcpPriDnsAddr, vRtrIfLinkLocalAddressState=vRtrIfLinkLocalAddressState, vRtrIcmp6InPktTooBigs=vRtrIcmp6InPktTooBigs, vRtrIfDHCPRelayClientPktsRelayed=vRtrIfDHCPRelayClientPktsRelayed, vRtrInetAggrLastChanged=vRtrInetAggrLastChanged, vRtrStaticRouteDest=vRtrStaticRouteDest, vRtrIfIcmp6InParmProblems=vRtrIfIcmp6InParmProblems, vRtrTunnelEntry=vRtrTunnelEntry, vRtrIfDHCPVendorOptionString=vRtrIfDHCPVendorOptionString, vRtrIfDHCPRelayPktsGenForceRenew=vRtrIfDHCPRelayPktsGenForceRenew, vRtrIfProxyNDPolicy2=vRtrIfProxyNDPolicy2, vRtrIfQosPolicyId=vRtrIfQosPolicyId, vRtrRIPRoutes=vRtrRIPRoutes, vRiaBcastAddrFormat=vRiaBcastAddrFormat, tmnxVRtrMcastMaxRoutesTCA=tmnxVRtrMcastMaxRoutesTCA, vRtrDHCPClientLease=vRtrDHCPClientLease, vRtrIfDHCPTable=vRtrIfDHCPTable, vRtrIfIcmp6OutRtrAdvertisements=vRtrIfIcmp6OutRtrAdvertisements, vRtrIfIcmp6InNbrSolicits=vRtrIfIcmp6InNbrSolicits, vRtrIfDHCP6TableLastChanged=vRtrIfDHCP6TableLastChanged, vRtrV6StatBGPVpnRoutes=vRtrV6StatBGPVpnRoutes, vRtrIfDHCP6PfxdRowStatus=vRtrIfDHCP6PfxdRowStatus, tmnxVRtrMidRouteTCA=tmnxVRtrMidRouteTCA, vRtrStaticRoutes=vRtrStaticRoutes, vRtrIcmp6OutNbrAdvertisements=vRtrIcmp6OutNbrAdvertisements, vRtrDHCP6MsgStatTable=vRtrDHCP6MsgStatTable, vRtrManagedRoutePrefixLen=vRtrManagedRoutePrefixLen, vRtrIfTosMarkingTrusted=vRtrIfTosMarkingTrusted, tmnxDscpFCValue=tmnxDscpFCValue, vRtrIfDHCPRelayClientPktsDiscarded=vRtrIfDHCPRelayClientPktsDiscarded, tmnxDscpFCLastChanged=tmnxDscpFCLastChanged, vRtrIfIcmpV6TimeExceeded=vRtrIfIcmpV6TimeExceeded, tmnxVRtrNotificationV4v0Group=tmnxVRtrNotificationV4v0Group, tmnxVRtrDHCP6IllegalClientAddr=tmnxVRtrDHCP6IllegalClientAddr, vRtrIfLocalDhcpServerName=vRtrIfLocalDhcpServerName, vRtrManagedRoutes=vRtrManagedRoutes, tmnxVRtr7450V4v0Compliance=tmnxVRtr7450V4v0Compliance, vRtrV6StatActiveNbrEntries=vRtrV6StatActiveNbrEntries, vRtrIfProxyArpPolicy1=vRtrIfProxyArpPolicy1, vRtrIfDHCPGiAddressAsSrc=vRtrIfDHCPGiAddressAsSrc, vRtrIfIcmpRedirectsTime=vRtrIfIcmpRedirectsTime, vRtrIfDHCP6RelayServer5=vRtrIfDHCP6RelayServer5, vRtrIfIcmp6OutGrpMembReductions=vRtrIfIcmp6OutGrpMembReductions, vRtrIfProxyArp=vRtrIfProxyArp, vRtrInetAggrSummaryOnly=vRtrInetAggrSummaryOnly, vRtrIfBfdSessionLastDownTime=vRtrIfBfdSessionLastDownTime, vRtrIfIcmpNumTtlExpired=vRtrIfIcmpNumTtlExpired, tmnxVRtrNotificationObjV6v0Group=tmnxVRtrNotificationObjV6v0Group, vRtrInetAggrASSet=vRtrInetAggrASSet, vRtrInetStaticRouteDestPfxLen=vRtrInetStaticRouteDestPfxLen, vRtrInetStaticRouteStatus=vRtrInetStaticRouteStatus, vRtrInetStaticRoutePreference=vRtrInetStaticRoutePreference, tmnxDot1pAppEntry=tmnxDot1pAppEntry, vRtrIfGlobalIndex=vRtrIfGlobalIndex, tmnxVRtrNotificationObjects=tmnxVRtrNotificationObjects, vRtrIfInitDelayEnable=vRtrIfInitDelayEnable, vRtrIfDHCPRelayStatsEntry=vRtrIfDHCPRelayStatsEntry, tmnxVRtrIpV5v0Group=tmnxVRtrIpV5v0Group, vRtrIfBfdSessionRxInterval=vRtrIfBfdSessionRxInterval, vRtrInetSvcIpRangeExclusive=vRtrInetSvcIpRangeExclusive, vRtrIpNetToMediaOperState=vRtrIpNetToMediaOperState, vRtrDHCP6AssignedNetAddr=vRtrDHCP6AssignedNetAddr, vRtrExportPolicy4=vRtrExportPolicy4, vRtrIfBfdSessionMesgRecv=vRtrIfBfdSessionMesgRecv, vRtrRipStatus=vRtrRipStatus, vRtrStatActiveARPEntries=vRtrStatActiveARPEntries, vRtrIfRowStatus=vRtrIfRowStatus, vRtrBfdSlotNumber=vRtrBfdSlotNumber, vRtrActiveVRtrs=vRtrActiveVRtrs, vRtrDHCP6MsgStatsLstClrd=vRtrDHCP6MsgStatsLstClrd, vRtrV6StatActiveSdpTunnels=vRtrV6StatActiveSdpTunnels, vRtrV6BGPRoutes=vRtrV6BGPRoutes, vRtrV6StatBGPVpnActiveRoutes=vRtrV6StatBGPVpnActiveRoutes, TDSCPAppId=TDSCPAppId, vRtrIfIcmp6InDestUnreachs=vRtrIfIcmp6InDestUnreachs, vRtrIfDHCPProxyLTRadiusOverride=vRtrIfDHCPProxyLTRadiusOverride, vRtrIfDHCP6RelayServer8=vRtrIfDHCP6RelayServer8, vRtrIfDHCPRelayServer2=vRtrIfDHCPRelayServer2, vRiaInetAddressType=vRiaInetAddressType, vRtrMaxMcastNumRoutesLogOnly=vRtrMaxMcastNumRoutesLogOnly, vRtrIcmp6OutDestUnreachs=vRtrIcmp6OutDestUnreachs, vRtrInetSvcIpRangeEntry=vRtrInetSvcIpRangeEntry, vRtrAutoFilterDHCPClientLease=vRtrAutoFilterDHCPClientLease, vRtrStaticRouteMetric=vRtrStaticRouteMetric, vRtrIfDHCPRelayClientPktsProxRad=vRtrIfDHCPRelayClientPktsProxRad, vRtrIfIcmp6OutParmProblems=vRtrIfIcmp6OutParmProblems, vRtrIfBfdSessionEntry=vRtrIfBfdSessionEntry, vRtrIfProxyNDPolicy5=vRtrIfProxyNDPolicy5, tmnxDscpAppTableLastChanged=tmnxDscpAppTableLastChanged, vRtrStatTotalARPEntries=vRtrStatTotalARPEntries, vRtrStaticRouteLastEnabledTime=vRtrStaticRouteLastEnabledTime, vRtrIfIcmpV6PktTooBig=vRtrIfIcmpV6PktTooBig, vRtrTunnelMetric=vRtrTunnelMetric, vRtrDhcpLseStateNewCiAddr=vRtrDhcpLseStateNewCiAddr, vRtrV6DirectActiveRoutes=vRtrV6DirectActiveRoutes, vRtrIfNtpBroadcast=vRtrIfNtpBroadcast, vRtrIfProxyArpLocal=vRtrIfProxyArpLocal, tmnxVRtrNotifyPrefix=tmnxVRtrNotifyPrefix, vRtrIfDHCP6RelayServer3=vRtrIfDHCP6RelayServer3, vRtrIfIcmp6Entry=vRtrIfIcmp6Entry, vRtrAdvPrefixValidLifetime=vRtrAdvPrefixValidLifetime, vRtrIfDHCP6RemoteIdOption=vRtrIfDHCP6RemoteIdOption, vRiaInetRemoteIp=vRiaInetRemoteIp, vRtrIfDHCPRelayAuthPktsSuccess=vRtrIfDHCPRelayAuthPktsSuccess, vRtrMplsStatus=vRtrMplsStatus, tmnxVRtrIfIpcpV6v0Group=tmnxVRtrIfIpcpV6v0Group, vRtrManagedRouteInetAddrType=vRtrManagedRouteInetAddrType, vRtrAdvPrefixEntry=vRtrAdvPrefixEntry, vRiaReasmMaxSize=vRiaReasmMaxSize, vRtrDHCP6MsgStatsSent=vRtrDHCP6MsgStatsSent, vRtrIfBfdMultiplier=vRtrIfBfdMultiplier, vRtrMulticastRoutes=vRtrMulticastRoutes, tmnxDscpFCTable=tmnxDscpFCTable, vRtrIfDHCPProxyAdminState=vRtrIfDHCPProxyAdminState, vRtrIfIcmp6InTimeExcds=vRtrIfIcmp6InTimeExcds, vRtrV6RIPActiveRoutes=vRtrV6RIPActiveRoutes, vRtrStatTable=vRtrStatTable, vRtrStatConfiguredIfs=vRtrStatConfiguredIfs, vRtrIfIcmpTtlExpired=vRtrIfIcmpTtlExpired, vRtrIcmp6InGrpMembReductions=vRtrIcmp6InGrpMembReductions, vRtrIfIcmp6InGrpMembReductions=vRtrIfIcmp6InGrpMembReductions, vRtrInetStaticRouteTable=vRtrInetStaticRouteTable, tmnxVRtrNotifications=tmnxVRtrNotifications, vRtrIpCidrRoutePreference=vRtrIpCidrRoutePreference, tmnxVRtrIllegalLabelTCA=tmnxVRtrIllegalLabelTCA, vRtrInetStaticRouteDisallowIgp=vRtrInetStaticRouteDisallowIgp, tmnxVRtrGlobalV6v0Group=tmnxVRtrGlobalV6v0Group, vRtrIfLinkLocalAddressType=vRtrIfLinkLocalAddressType, vRiaRowStatus=vRiaRowStatus, vRtrIfIcmpV6NumParamProblem=vRtrIfIcmpV6NumParamProblem, vRtrIfIcmpNumUnreachables=vRtrIfIcmpNumUnreachables, vRtrInetAggrRowStatus=vRtrInetAggrRowStatus, vRtrIfProxyNDTable=vRtrIfProxyNDTable, tmnxVRtrBfdPortTypeNotSupported=tmnxVRtrBfdPortTypeNotSupported, tmnxVRtrDHCP6RelayLseStExceeded=tmnxVRtrDHCP6RelayLseStExceeded, vRtrIfIPv6EgressFilterId=vRtrIfIPv6EgressFilterId, vRtrAdvPrefixRowStatus=vRtrAdvPrefixRowStatus, tmnxVRtrIPv6HighRouteTCA=tmnxVRtrIPv6HighRouteTCA, vRtrInetInstAggrTable=vRtrInetInstAggrTable, vRtrDHCP6MsgStatsDropped=vRtrDHCP6MsgStatsDropped, tmnxVRtrObsoletedObjectsV4v0Group=tmnxVRtrObsoletedObjectsV4v0Group, vRtrVprnType=vRtrVprnType, vRtrStaticRouteAdminState=vRtrStaticRouteAdminState, vRtrIfDHCP6PfxdDUID=vRtrIfDHCP6PfxdDUID, vRtrIfDHCP6RelayItfIdOption=vRtrIfDHCP6RelayItfIdOption, vRtrDHCP6OldAssignedPrefixLen=vRtrDHCP6OldAssignedPrefixLen, vRtrAggregationIpPrefix=vRtrAggregationIpPrefix, vRtrTunnelTable=vRtrTunnelTable, vRtrIfDHCP6PfxdIAID=vRtrIfDHCP6PfxdIAID, tmnxVRtrMaxRoutes=tmnxVRtrMaxRoutes, vRtrMidRouteThreshold=vRtrMidRouteThreshold, vRtrExportPolicy2=vRtrExportPolicy2, vRtrIfVPNClass=vRtrIfVPNClass, vRtrIfDHCPLeaseStateEntry=vRtrIfDHCPLeaseStateEntry, vRtrIfProxyArpEntry=vRtrIfProxyArpEntry, vRtrDHCP6DropStatPktsDropped=vRtrDHCP6DropStatPktsDropped, vRtrIfDHCPAuthPolicy=vRtrIfDHCPAuthPolicy, vRtrIfIpcpPeerAddr=vRtrIfIpcpPeerAddr, vRtrIfDHCPRelayServer5=vRtrIfDHCPRelayServer5, vRtrStatStaticARPEntries=vRtrStatStaticARPEntries, vRtrIpAddrEntry=vRtrIpAddrEntry, vRtrIfDHCPRelayRemoteIdStr=vRtrIfDHCPRelayRemoteIdStr, vRtrIfEntry=vRtrIfEntry, vRtrIcmp6InRedirects=vRtrIcmp6InRedirects, vRtrIfName=vRtrIfName, vRtrV6OSPFActiveRoutes=vRtrV6OSPFActiveRoutes, vRtrImportPolicy5=vRtrImportPolicy5, vRtrIfIndex=vRtrIfIndex, vRtrInetStaticRouteCpeAddr=vRtrInetStaticRouteCpeAddr, tmnxVRtr7450V5v0Compliance=tmnxVRtr7450V5v0Compliance, vRtrOperState=vRtrOperState, vRtrIfIcmp6OutEchos=vRtrIfIcmp6OutEchos, vRtrStaticRouteIndex=vRtrStaticRouteIndex, vRtrIfIcmp6InPktTooBigs=vRtrIfIcmp6InPktTooBigs, vRtrIfLastOperStateChange=vRtrIfLastOperStateChange, vRtrType=vRtrType, vRtrIfDHCP6CurrServerLeaseStates=vRtrIfDHCP6CurrServerLeaseStates, vRtrBgpStatus=vRtrBgpStatus, vRtrStaticActiveRoutes=vRtrStaticActiveRoutes, vRtrIfDHCPDescription=vRtrIfDHCPDescription, tmnxVRtrManagedRouteAddFailed=tmnxVRtrManagedRouteAddFailed, tmnxVRtrObsoleteNotificationGroup=tmnxVRtrObsoleteNotificationGroup, vRtrStaticRouteDisallowIgp=vRtrStaticRouteDisallowIgp, vRtrRIPActiveRoutes=vRtrRIPActiveRoutes, vRtrIcmp6InTimeExcds=vRtrIcmp6InTimeExcds, vRtrIcmp6InEchoReplies=vRtrIcmp6InEchoReplies, vRtrMaxNumRoutes=vRtrMaxNumRoutes, vRtrStatEntry=vRtrStatEntry, vRtrIfBfdSessionType=vRtrIfBfdSessionType, vRtrDHCP6AssignedPrefixLen=vRtrDHCP6AssignedPrefixLen, tmnxVRtrDHCP6ClientMacUnresolved=tmnxVRtrDHCP6ClientMacUnresolved, vRtrDhcpLseStatePopulateError=vRtrDhcpLseStatePopulateError, vRtrIfDHCP6RelayServer4=vRtrIfDHCP6RelayServer4, tmnxVRtrBfdV4v0Group=tmnxVRtrBfdV4v0Group, vRiaIpAddress=vRiaIpAddress, vRtrInetStaticRouteAdminState=vRtrInetStaticRouteAdminState, vRtrInetSvcIpRangeRowStatus=vRtrInetSvcIpRangeRowStatus, vRtrIfIcmp6Table=vRtrIfIcmp6Table, vRtrIfAdminState=vRtrIfAdminState, vRtrV6MulticastRoutes=vRtrV6MulticastRoutes, vRtrIcmp6OutRtrSolicits=vRtrIcmp6OutRtrSolicits, tmnxVRtrDHCP6AssignedIllegSubnet=tmnxVRtrDHCP6AssignedIllegSubnet, tmnxVRtrGroups=tmnxVRtrGroups, vRtrInetStaticRouteNextHopType=vRtrInetStaticRouteNextHopType, TDot1pAppId=TDot1pAppId, tmnxVRtrObjs=tmnxVRtrObjs, vRtrIfDHCP6PfxdPrefixLen=vRtrIfDHCP6PfxdPrefixLen)
