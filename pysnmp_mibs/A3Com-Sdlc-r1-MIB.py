...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/a3com/A3Com-Sdlc-r1-MIB
...
MibIdentifier, enterprises, NotificationType, Integer32, Bits, Unsigned32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, Counter64, TimeTicks, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "NotificationType", "Integer32", "Bits", "Unsigned32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "Counter64", "TimeTicks", "ModuleIdentity", "Gauge32")
...
pysmiFakeCol1026 = MibTableColumn((1, 3, 6, 1, 4, 1, 43, 2, 25, 3, 1, 1) + (1026, ), Integer32())
sdlcMapEntry = MibTableRow((1, 3, 6, 1, 4, 1, 43, 2, 25, 3, 1, 1), ).setIndexNames((0, "A3Com-Sdlc-r1-MIB", "pysmiFakeCol1026"))
...
mibBuilder.exportSymbols("A3Com-Sdlc-r1-MIB", sdlcMapTable=sdlcMapTable, sdlcLSStatsTESTsOut=sdlcLSStatsTESTsOut, sdlcLSStatsUIFramesOut=sdlcLSStatsUIFramesOut, sdlcLSOperEntry=sdlcLSOperEntry, sdlcMapName=sdlcMapName, sdlcLSOperMODULO=sdlcLSOperMODULO, sdlcLSAdminMAXIN=sdlcLSAdminMAXIN, sdlcLSOperLastFailREPLYTOs=sdlcLSOperLastFailREPLYTOs, sdlcPortOperLastFailCause=sdlcPortOperLastFailCause, sdlc=sdlc, sdlcLSAddress=sdlcLSAddress, sdlcPortStatsDwarfFrames=sdlcPortStatsDwarfFrames, sdlcLSOperMAXOUT=sdlcLSOperMAXOUT, sdlcMapEntry=sdlcMapEntry, sdlcPortOperName=sdlcPortOperName, sdlcMapPortState=sdlcMapPortState, sdlcLSOperLastFailTime=sdlcLSOperLastFailTime, sdlcLSStatsREJsIn=sdlcLSStatsREJsIn, sdlcPortOperTable=sdlcPortOperTable, sdlcLSStatsRNRLIMITs=sdlcLSStatsRNRLIMITs, sdlcLSOperGPoll=sdlcLSOperGPoll, sdlcLSStatsTESTsIn=sdlcLSStatsTESTsIn, sdlcLSStatsRetriesExps=sdlcLSStatsRetriesExps, sdlcLSStatsLocalBusies=sdlcLSStatsLocalBusies, pysmiFakeCol1026=pysmiFakeCol1026, sdlcLSStatsActivityTOs=sdlcLSStatsActivityTOs, sdlcLSOperRETRIESm=sdlcLSOperRETRIESm, sdlcLSOperLastFailFRMRInfo=sdlcLSOperLastFailFRMRInfo, sdlcPortAdminRole=sdlcPortAdminRole, sdlcLSStatsIFramesOut=sdlcLSStatsIFramesOut, sdlcLSStatsIOctetsOut=sdlcLSStatsIOctetsOut, sdlcPortAdminPAUSE=sdlcPortAdminPAUSE, sdlcMapRemoteMacAddress=sdlcMapRemoteMacAddress, sdlcPortStatusChange=sdlcPortStatusChange, sdlcPortOperRole=sdlcPortOperRole, sdlcPortAdminTopology=sdlcPortAdminTopology, sdlcPortOperSlowPollTimer=sdlcPortOperSlowPollTimer, sdlcLSStatsIOctetsIn=sdlcLSStatsIOctetsIn, sdlcPortStatsEntry=sdlcPortStatsEntry, sdlcLSAdminMAXDATA=sdlcLSAdminMAXDATA, sdlcPortOperACTIVTO=sdlcPortOperACTIVTO, sdlcLSStatsRetransmits=sdlcLSStatsRetransmits, sdlcLSAdminMAXOUT=sdlcLSAdminMAXOUT, sdlcLSAdminEntry=sdlcLSAdminEntry, sdlcLSOperName=sdlcLSOperName, sdlcMapGroup=sdlcMapGroup, sdlcLSOperLastFailCtrlOut=sdlcLSOperLastFailCtrlOut, sdlcLSStatsBLUsOut=sdlcLSStatsBLUsOut, sdlcLSOperState=sdlcLSOperState, sdlcLSAdminRNRLIMIT=sdlcLSAdminRNRLIMIT, sdlcLSStatsXIDsOut=sdlcLSStatsXIDsOut, MacAddress=MacAddress, sdlcLSStatsSIMsIn=sdlcLSStatsSIMsIn, sdlcPortOperSlowPollMethod=sdlcPortOperSlowPollMethod, sdlcPortGroup=sdlcPortGroup, sdlcMapPollAddress=sdlcMapPollAddress, sdlcMapLocalMacAddress=sdlcMapLocalMacAddress, sdlcPortAdminEntry=sdlcPortAdminEntry, sdlcPortOperPAUSE=sdlcPortOperPAUSE, sdlcLSAdminState=sdlcLSAdminState, sdlcLSOperRNRLIMIT=sdlcLSOperRNRLIMIT, sdlcLSOperMAXIN=sdlcLSOperMAXIN, sdlcLSStatsREJsOut=sdlcLSStatsREJsOut, sdlcLSStatsSIMsOut=sdlcLSStatsSIMsOut, sdlcLSOperDATMODE=sdlcLSOperDATMODE, sdlcLSAdminRETRIESn=sdlcLSAdminRETRIESn, sdlcLSAdminMODULO=sdlcLSAdminMODULO, sdlcPortAdminName=sdlcPortAdminName, sdlcLSOperRole=sdlcLSOperRole, sdlcPortAdminTable=sdlcPortAdminTable, sdlcLSAdminGPoll=sdlcLSAdminGPoll, sdlcLSStatsEntry=sdlcLSStatsEntry, sdlcLSAdminRETRIESm=sdlcLSAdminRETRIESm, sdlcLSOperRETRIESt=sdlcLSOperRETRIESt, sdlcPortAdminType=sdlcPortAdminType, sdlcLSStatsRIMsOut=sdlcLSStatsRIMsOut, sdlcLSAdminDATMODE=sdlcLSAdminDATMODE, sdlcPortAdminSlowPollTimer=sdlcPortAdminSlowPollTimer, sdlcLSStatsOctetsOut=sdlcLSStatsOctetsOut, sdlcLSStatsPollsOut=sdlcLSStatsPollsOut, sdlcLSOperREPLYTO=sdlcLSOperREPLYTO, sdlcLSStatsRemoteBusies=sdlcLSStatsRemoteBusies, sdlcMapLSState=sdlcMapLSState, sdlcLSAdminREPLYTO=sdlcLSAdminREPLYTO, sdlcLSStatsRIMsIn=sdlcLSStatsRIMsIn, sdlcPortOperTopology=sdlcPortOperTopology, sdlcPortOperType=sdlcPortOperType, sdlcLSStatsXIDsIn=sdlcLSStatsXIDsIn, sdlcLSAdminSimRim=sdlcLSAdminSimRim, sdlcPortAdminACTIVTO=sdlcPortAdminACTIVTO, sdlcLSStatsFRMRsOut=sdlcLSStatsFRMRsOut, sdlcLSStatsFRMRsIn=sdlcLSStatsFRMRsIn, sdlcLSOperSimRim=sdlcLSOperSimRim, sdlcLSOperLastFailCtrlIn=sdlcLSOperLastFailCtrlIn, sdlcLSOperMAXDATA=sdlcLSOperMAXDATA, a3com=a3com, sdlcLSAdminTable=sdlcLSAdminTable, sdlcPortOperEntry=sdlcPortOperEntry, sdlcMapLocalSap=sdlcMapLocalSap, brouterMIB=brouterMIB, sdlcLSStatsProtocolErrs=sdlcLSStatsProtocolErrs, sdlcPortStatsPhysicalFailures=sdlcPortStatsPhysicalFailures, sdlcLSStatsBLUsIn=sdlcLSStatsBLUsIn, sdlcLSStatsIFramesIn=sdlcLSStatsIFramesIn, sdlcLSStatsPollRspsOut=sdlcLSStatsPollRspsOut, sdlcLSAdminRETRIESt=sdlcLSAdminRETRIESt, sdlcLSOperRETRIESn=sdlcLSOperRETRIESn, sdlcPortStatsTable=sdlcPortStatsTable, sdlcMapRemoteSap=sdlcMapRemoteSap, sdlcLSGroup=sdlcLSGroup, sdlcLSStatsUIFramesIn=sdlcLSStatsUIFramesIn, sdlcPortOperLastFailTime=sdlcPortOperLastFailTime, sdlcLSOperLastFailCause=sdlcLSOperLastFailCause, sdlcLSStatusChange=sdlcLSStatusChange, sdlcLSAdminName=sdlcLSAdminName, sdlcLSStatsTable=sdlcLSStatsTable, sdlcPortStatsInvalidAddresses=sdlcPortStatsInvalidAddresses, sdlcLSStatsOctetsIn=sdlcLSStatsOctetsIn, sdlcLSOperTable=sdlcLSOperTable)
