...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3Com-Sdlc-r1-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:20 2025
...
_SdlcPortAdminACTIVTO_Type.__name__ = "TimeTicks"
...
_SdlcPortAdminPAUSE_Type.__name__ = "TimeTicks"
...
_SdlcPortAdminSlowPollTimer_Type.__name__ = "TimeTicks"
...
_SdlcLSAdminREPLYTO_Type.__name__ = "TimeTicks"
...
_SdlcLSAdminRETRIESt_Type.__name__ = "TimeTicks"
...
_SdlcLSAdminRNRLIMIT_Type.__name__ = "TimeTicks"
...
sdlcMapEntry.setIndexNames(
    (0, "A3Com-Sdlc-r1-MIB", "pysmiFakeCol27"),
)
if mibBuilder.loadTexts:
...
_PysmiFakeCol27_Type = Integer32
_PysmiFakeCol27_Object = MibTableColumn
pysmiFakeCol27 = _PysmiFakeCol27_Object(
    (1, 3, 6, 1, 4, 1, 43, 2, 25, 3, 1, 1, 4294967295),
    _PysmiFakeCol27_Type()
)
pysmiFakeCol27.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    pysmiFakeCol27.setStatus("mandatory")
