...
mibBuilder.exportSymbols("A3Com-Sdlc-r1-MIB", sdlcPortAdminSlowPollTimer=sdlcPortAdminSlowPollTimer, sdlcMapTable=sdlcMapTable, sdlcPortOperLastFailCause=sdlcPortOperLastFailCause, sdlcLSStatsIOctetsOut=sdlcLSStatsIOctetsOut, sdlcPortOperACTIVTO=sdlcPortOperACTIVTO, sdlcLSStatsOctetsIn=sdlcLSStatsOctetsIn, sdlcLSStatsSIMsIn=sdlcLSStatsSIMsIn, a3com=a3com, sdlcLSAdminMAXOUT=sdlcLSAdminMAXOUT, sdlcLSOperLastFailREPLYTOs=sdlcLSOperLastFailREPLYTOs, sdlcPortOperSlowPollTimer=sdlcPortOperSlowPollTimer, sdlcLSAdminMODULO=sdlcLSAdminMODULO, MacAddress=MacAddress, sdlcPortAdminPAUSE=sdlcPortAdminPAUSE, sdlcLSOperLastFailTime=sdlcLSOperLastFailTime, sdlcLSStatsTESTsIn=sdlcLSStatsTESTsIn, sdlcPortStatsInvalidAddresses=sdlcPortStatsInvalidAddresses, sdlcLSStatsUIFramesIn=sdlcLSStatsUIFramesIn, sdlcMapRemoteSap=sdlcMapRemoteSap, sdlcLSOperName=sdlcLSOperName, sdlcLSAdminName=sdlcLSAdminName, sdlcPortStatusChange=sdlcPortStatusChange, sdlcLSStatsRIMsIn=sdlcLSStatsRIMsIn, sdlcLSStatsTable=sdlcLSStatsTable, sdlcLSOperState=sdlcLSOperState, sdlcLSOperDATMODE=sdlcLSOperDATMODE, sdlcLSStatsPollRspsOut=sdlcLSStatsPollRspsOut, sdlcLSStatsRemoteBusies=sdlcLSStatsRemoteBusies, sdlcLSOperLastFailCtrlOut=sdlcLSOperLastFailCtrlOut, sdlcLSStatsBLUsOut=sdlcLSStatsBLUsOut, sdlcPortOperType=sdlcPortOperType, sdlcPortOperName=sdlcPortOperName, sdlcLSAdminGPoll=sdlcLSAdminGPoll, sdlcMapPortState=sdlcMapPortState, sdlcLSOperLastFailFRMRInfo=sdlcLSOperLastFailFRMRInfo, sdlcLSOperMAXOUT=sdlcLSOperMAXOUT, sdlcLSOperEntry=sdlcLSOperEntry, sdlcLSGroup=sdlcLSGroup, sdlcMapLocalSap=sdlcMapLocalSap, sdlcPortStatsEntry=sdlcPortStatsEntry, sdlcLSOperRETRIESm=sdlcLSOperRETRIESm, sdlcPortOperPAUSE=sdlcPortOperPAUSE, sdlcLSAdminState=sdlcLSAdminState, sdlcMapEntry=sdlcMapEntry, sdlcLSStatsRNRLIMITs=sdlcLSStatsRNRLIMITs, sdlcLSStatsXIDsOut=sdlcLSStatsXIDsOut, sdlcLSStatsPollsOut=sdlcLSStatsPollsOut, sdlcLSStatsEntry=sdlcLSStatsEntry, sdlcLSStatsTESTsOut=sdlcLSStatsTESTsOut, sdlcMapPollAddress=sdlcMapPollAddress, sdlcLSAdminMAXDATA=sdlcLSAdminMAXDATA, sdlcLSAdminDATMODE=sdlcLSAdminDATMODE, sdlcLSStatsIFramesIn=sdlcLSStatsIFramesIn, sdlcLSOperRETRIESn=sdlcLSOperRETRIESn, sdlcLSStatsIFramesOut=sdlcLSStatsIFramesOut, sdlcLSStatsActivityTOs=sdlcLSStatsActivityTOs, sdlcPortAdminName=sdlcPortAdminName, sdlcMapRemoteMacAddress=sdlcMapRemoteMacAddress, sdlcMapLocalMacAddress=sdlcMapLocalMacAddress, sdlcPortAdminTable=sdlcPortAdminTable, sdlcLSStatsOctetsOut=sdlcLSStatsOctetsOut, sdlcLSOperMODULO=sdlcLSOperMODULO, sdlcPortOperTable=sdlcPortOperTable, sdlcPortStatsPhysicalFailures=sdlcPortStatsPhysicalFailures, sdlcLSStatsRetransmits=sdlcLSStatsRetransmits, sdlcLSAdminTable=sdlcLSAdminTable, sdlcLSOperLastFailCause=sdlcLSOperLastFailCause, sdlcLSStatsRIMsOut=sdlcLSStatsRIMsOut, sdlcLSStatsBLUsIn=sdlcLSStatsBLUsIn, sdlcLSStatsIOctetsIn=sdlcLSStatsIOctetsIn, sdlcPortAdminEntry=sdlcPortAdminEntry, sdlcMapGroup=sdlcMapGroup, sdlcPortOperTopology=sdlcPortOperTopology, sdlcLSStatsXIDsIn=sdlcLSStatsXIDsIn, sdlcLSAdminRETRIESm=sdlcLSAdminRETRIESm, sdlcLSStatsREJsIn=sdlcLSStatsREJsIn, sdlcPortAdminType=sdlcPortAdminType, sdlcLSAddress=sdlcLSAddress, sdlcLSOperLastFailCtrlIn=sdlcLSOperLastFailCtrlIn, sdlcLSAdminEntry=sdlcLSAdminEntry, sdlcLSOperTable=sdlcLSOperTable, sdlc=sdlc, sdlcMapLSState=sdlcMapLSState, sdlcPortGroup=sdlcPortGroup, sdlcLSOperRETRIESt=sdlcLSOperRETRIESt, sdlcPortAdminRole=sdlcPortAdminRole, sdlcLSOperRole=sdlcLSOperRole, sdlcLSStatsRetriesExps=sdlcLSStatsRetriesExps, sdlcLSAdminMAXIN=sdlcLSAdminMAXIN, sdlcLSStatsUIFramesOut=sdlcLSStatsUIFramesOut, sdlcPortOperEntry=sdlcPortOperEntry, sdlcLSStatsFRMRsIn=sdlcLSStatsFRMRsIn, sdlcMapName=sdlcMapName, sdlcPortStatsDwarfFrames=sdlcPortStatsDwarfFrames, sdlcPortOperRole=sdlcPortOperRole, sdlcLSOperMAXDATA=sdlcLSOperMAXDATA, sdlcPortAdminTopology=sdlcPortAdminTopology, sdlcLSOperGPoll=sdlcLSOperGPoll, sdlcLSStatsProtocolErrs=sdlcLSStatsProtocolErrs, sdlcPortAdminACTIVTO=sdlcPortAdminACTIVTO, sdlcPortStatsTable=sdlcPortStatsTable, sdlcLSStatsLocalBusies=sdlcLSStatsLocalBusies, sdlcLSOperREPLYTO=sdlcLSOperREPLYTO, sdlcLSStatusChange=sdlcLSStatusChange, sdlcLSAdminREPLYTO=sdlcLSAdminREPLYTO, sdlcPortOperLastFailTime=sdlcPortOperLastFailTime, sdlcLSStatsFRMRsOut=sdlcLSStatsFRMRsOut, sdlcLSOperSimRim=sdlcLSOperSimRim, sdlcLSAdminRNRLIMIT=sdlcLSAdminRNRLIMIT, sdlcLSStatsSIMsOut=sdlcLSStatsSIMsOut, sdlcLSAdminRETRIESt=sdlcLSAdminRETRIESt, brouterMIB=brouterMIB, sdlcLSAdminRETRIESn=sdlcLSAdminRETRIESn, sdlcLSAdminSimRim=sdlcLSAdminSimRim, sdlcPortOperSlowPollMethod=sdlcPortOperSlowPollMethod, sdlcLSStatsREJsOut=sdlcLSStatsREJsOut, sdlcLSOperMAXIN=sdlcLSOperMAXIN, sdlcLSOperRNRLIMIT=sdlcLSOperRNRLIMIT, pysmiFakeCol1026=pysmiFakeCol1026)
