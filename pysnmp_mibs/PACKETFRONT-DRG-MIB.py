...
mibBuilder.exportSymbols("PACKETFRONT-DRG-MIB", vlanStaticTable=vlanStaticTable, systemConfigSave=systemConfigSave, vlanTpFdbEntry=vlanTpFdbEntry, downloadResultCode=downloadResultCode, snmpConfig=snmpConfig, vlanMaxVlanId=vlanMaxVlanId, vlanTp=vlanTp, productProductionWeek=productProductionWeek, productSerialNo=productSerialNo, vlanTpFdbPort=vlanTpFdbPort, snmpTrapDestHostsMax=snmpTrapDestHostsMax, productMacAddress=productMacAddress, snmpReadCommunityName=snmpReadCommunityName, vlanTpFdbStatus=vlanTpFdbStatus, notifyDownloadResult=notifyDownloadResult, vlanStaticPriority=vlanStaticPriority, drgCompliance=drgCompliance, systemConfigRestartControl=systemConfigRestartControl, hostIfMode=hostIfMode, hostConfig=hostConfig, hostIfIndex=hostIfIndex, hostIfTable=hostIfTable, vlanStaticUntaggedPorts=vlanStaticUntaggedPorts, hostIfDefaultRouter=hostIfDefaultRouter, hostIfDnsServer2=hostIfDnsServer2, productOpDefRev=productOpDefRev, hostIfDomainName=hostIfDomainName, vlanStaticUnmodifiedPorts=vlanStaticUnmodifiedPorts, hostIfAddress=hostIfAddress, downloadMethod=downloadMethod, systemConfigRestartControlNotify=systemConfigRestartControlNotify, hostIfDnsServer1=hostIfDnsServer1, hostIfDefined=hostIfDefined, hostIfDiffservCodePoint=hostIfDiffservCodePoint, productPlatform=productPlatform, snmpTrapDestName=snmpTrapDestName, drgGroups=drgGroups, snmpTrapDestinationEntry=snmpTrapDestinationEntry, productIdentity=productIdentity, snmpTrapDestRowStatus=snmpTrapDestRowStatus, hostIfVlan=hostIfVlan, vlanStatic=vlanStatic, vlanStaticEntry=vlanStaticEntry, pfDrgMib=pfDrgMib, vlanStaticEgressPorts=vlanStaticEgressPorts, productHardwareRev=productHardwareRev, snmpTrapDestAddress=snmpTrapDestAddress, downloadAction=downloadAction, downloadRetryCount=downloadRetryCount, snmpTrapDestTagList=snmpTrapDestTagList, systemConfigSaveNotify=systemConfigSaveNotify, vlanTpFdbAddress=vlanTpFdbAddress, notifyRestart=notifyRestart, productInfo=productInfo, hostIfHostName=hostIfHostName, downloadResultNotify=downloadResultNotify, vlanBase=vlanBase, drgCompatibility=drgCompatibility, hostIfEntry=hostIfEntry, downloadFile=downloadFile, drgNotification=drgNotification, snmpTrapCommunityName=snmpTrapCommunityName, vlanVersionNumber=vlanVersionNumber, productSwImageRev=productSwImageRev, hostIfDhcpClientID=hostIfDhcpClientID, downloadServer=downloadServer, systemConfig=systemConfig, hostIfSecurePing=hostIfSecurePing, vlanFdbEntry=vlanFdbEntry, vlanTpFdbTable=vlanTpFdbTable, hostIfDhcpVendorClassID=hostIfDhcpVendorClassID, hostIfMax=hostIfMax, snmpDiffservCodePoint=snmpDiffservCodePoint, systemConfigFactoryReset=systemConfigFactoryReset, vlanNumVlans=vlanNumVlans, drgConfig=drgConfig, vlanStaticIndex=vlanStaticIndex, vlanStaticVlanId=vlanStaticVlanId, snmpTrapDestIndex=snmpTrapDestIndex, vlanFdbId=vlanFdbId, vlanStaticName=vlanStaticName, vlanStaticRowStatus=vlanStaticRowStatus, hostIfSubnetMask=hostIfSubnetMask, vlanFdbTable=vlanFdbTable, productHardwarePCBARevision=productHardwarePCBARevision, downloadConfig=downloadConfig, vlanFdbDynamicCount=vlanFdbDynamicCount, productDefaultRevision=productDefaultRevision, productFwImageRev=productFwImageRev, productFunctionIdentity=productFunctionIdentity, hostIfVlanPriority=hostIfVlanPriority, snmpTrapDestinationTable=snmpTrapDestinationTable, snmpWriteCommunityName=snmpWriteCommunityName, snmpTrapDestHostsDefined=snmpTrapDestHostsDefined, drgConformance=drgConformance, PYSNMP_MODULE_ID=pfDrgMib, snmpAtomicSet=snmpAtomicSet, notifyConfigSaveResult=notifyConfigSaveResult, productName=productName, vlanConfig=vlanConfig, vlanMaxSupportedVlans=vlanMaxSupportedVlans)
