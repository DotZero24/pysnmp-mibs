...
if mibBuilder.loadTexts:f10BmpMib.setRevisions(('2014-07-21 12:00','2011-12-07 12:48'))
_F10Bmp_ObjectIdentity=ObjectIdentity
f10Bmp=_F10Bmp_ObjectIdentity((1,3,6,1,4,1,6027,3,23,1))
...
mibBuilder.exportSymbols('F10-BMP-MIB',**{'f10BmpMib':f10BmpMib,'f10Bmp':f10Bmp,'bmpReloadType':bmpReloadType,'bmpAutoSave':bmpAutoSave,'bmpConfigDownload':bmpConfigDownload,'bmpDhcpTimeout':bmpDhcpTimeout,'bmpRetryCount':bmpRetryCount,'bmpUserDefinedString':bmpUserDefinedString,'bmpRelay':bmpRelay,'bmpRelayRemoteId':bmpRelayRemoteId})