...
# Notes
# -----
# ASN.1 source file://mibs/rfc/PKTC-IETF-MTA-MIB
...
_PktcMtaDevDhcpServerAddressType_Type.__name__ = "InetAddressType"
...
_PktcMtaDevDnsServerAddressType_Type.__name__ = "InetAddressType"
...
_PktcMtaDevTimeServerAddressType_Type.__name__ = "InetAddressType"
...
_PktcMtaDevProvConfigEncryptAlg_Type.__name__ = "PktcMtaDevProvEncryptAlg"
...
pktcMtaBasicCompliance.setObjects(
      *(("PKTC-IETF-MTA-MIB", "pktcMtaGroup"),
        ("PKTC-IETF-MTA-MIB", "pktcMtaNotificationGroup"))
)
if mibBuilder.loadTexts:
...
pktcMtaBasicSmtaCompliance.setObjects(
      *(("PKTC-IETF-MTA-MIB", "pktcMtaGroup"),
        ("PKTC-IETF-MTA-MIB", "pktcMtaNotificationGroup"),
        ("DOCS-IETF-BPI2-MIB", "docsBpi2CodeDownloadGroup"))
)
if mibBuilder.loadTexts:
