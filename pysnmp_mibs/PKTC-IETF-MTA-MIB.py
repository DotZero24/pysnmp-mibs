...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/PKTC-IETF-MTA-MIB
...
ModuleIdentity, Counter64, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, TimeTicks, MibIdentifier, Integer32, Bits, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "mib-2", "IpAddress")
...
pktcMtaDevRealmOrgName = MibTableColumn((1, 3, 6, 1, 2, 1, 140, 1, 3, 6, 1, 5), SnmpAdminString()).setMaxAccess("readcreate")
...
pktcMtaBasicSmtaCompliance = ModuleCompliance((1, 3, 6, 1, 2, 1, 140, 2, 1, 2)).setObjects(("PKTC-IETF-MTA-MIB", "pktcMtaGroup"), ("PKTC-IETF-MTA-MIB", "pktcMtaNotificationGroup"), ("DOCS-IETF-BPI2-MIB", "docsBpi2CodeDownloadGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    pktcMtaBasicSmtaCompliance = pktcMtaBasicSmtaCompliance.setStatus('current')
mibBuilder.exportSymbols("PKTC-IETF-MTA-MIB", pktcMtaDevManufacturerCertificate=pktcMtaDevManufacturerCertificate, pktcMtaDevCmsSolicitedKeyTimeout=pktcMtaDevCmsSolicitedKeyTimeout, pktcMtaDevDhcpServerAddressType=pktcMtaDevDhcpServerAddressType, pktcMtaBasicSmtaCompliance=pktcMtaBasicSmtaCompliance, pktcMtaDevCmsStatus=pktcMtaDevCmsStatus, pktcMtaDevSwCurrentVers=pktcMtaDevSwCurrentVers, pktcMtaDevRealmTable=pktcMtaDevRealmTable, pktcMtaDevCmsUnsolicitedKeyMaxRetries=pktcMtaDevCmsUnsolicitedKeyMaxRetries, pktcMtaGroup=pktcMtaGroup, pktcMtaDevRealmTgsGracePeriod=pktcMtaDevRealmTgsGracePeriod, pktcMtaDevProvisioningCounter=pktcMtaDevProvisioningCounter, pktcMtaCompliances=pktcMtaCompliances, pktcMtaDevHttpAccess=pktcMtaDevHttpAccess, pktcMtaDevSerialNumber=pktcMtaDevSerialNumber, pktcMtaDevProvisioningState=pktcMtaDevProvisioningState, pktcMtaDevServerDns1=pktcMtaDevServerDns1, pktcMtaDevProvState=pktcMtaDevProvState, pktcMtaDevBase=pktcMtaDevBase, pktcMtaDevRealmOrgName=pktcMtaDevRealmOrgName, pktcMtaDevServerDns2=pktcMtaDevServerDns2, pktcMtaDevRealmUnsolicitedKeyMaxRetries=pktcMtaDevRealmUnsolicitedKeyMaxRetries, PYSNMP_MODULE_ID=pktcIetfMtaMib, pktcMtaDevRealmIndex=pktcMtaDevRealmIndex, pktcMtaDevErrorOid=pktcMtaDevErrorOid, pktcMtaDevProvUnsolicitedKeyMaxRetries=pktcMtaDevProvUnsolicitedKeyMaxRetries, pktcMtaDevProvSolicitedKeyTimeout=pktcMtaDevProvSolicitedKeyTimeout, pktcMtaDevServerDhcp1=pktcMtaDevServerDhcp1, pktcIetfMtaMib=pktcIetfMtaMib, pktcMtaDevRealmPkinitGracePeriod=pktcMtaDevRealmPkinitGracePeriod, pktcMtaDevResetNow=pktcMtaDevResetNow, pktcMtaDevErrorValue=pktcMtaDevErrorValue, PktcMtaDevProvEncryptAlg=PktcMtaDevProvEncryptAlg, pktcMtaDevErrorsTooManyErrors=pktcMtaDevErrorsTooManyErrors, pktcMtaDevProvKerbRealmName=pktcMtaDevProvKerbRealmName, pktcMtaDevTypeIdentifier=pktcMtaDevTypeIdentifier, pktcMtaBasicCompliance=pktcMtaBasicCompliance, pktcMtaDevProvisioningStatus=pktcMtaDevProvisioningStatus, pktcMtaDevFQDN=pktcMtaDevFQDN, pktcMtaDevRealmEntry=pktcMtaDevRealmEntry, pktcMtaDevProvUnsolicitedKeyMaxTimeout=pktcMtaDevProvUnsolicitedKeyMaxTimeout, pktcMtaDevProvisioningTimer=pktcMtaDevProvisioningTimer, pktcMtaDevProvConfigKey=pktcMtaDevProvConfigKey, pktcMtaDevCmsFqdn=pktcMtaDevCmsFqdn, pktcMtaMibObjects=pktcMtaMibObjects, pktcMtaDevRealmName=pktcMtaDevRealmName, pktcMtaDevCmsTable=pktcMtaDevCmsTable, pktcMtaDevProvisioningEnrollment=pktcMtaDevProvisioningEnrollment, pktcMtaDevCorrelationId=pktcMtaDevCorrelationId, pktcMtaNotificationGroup=pktcMtaNotificationGroup, pktcMtaDevErrors=pktcMtaDevErrors, pktcMtaDevSecurity=pktcMtaDevSecurity, pktcMtaDevRealmUnsolicitedKeyNomTimeout=pktcMtaDevRealmUnsolicitedKeyNomTimeout, pktcMtaDevProvUnsolicitedKeyNomTimeout=pktcMtaDevProvUnsolicitedKeyNomTimeout, pktcMtaDevErrorOidIndex=pktcMtaDevErrorOidIndex, pktcMtaDevCmsAvailSlot=pktcMtaDevCmsAvailSlot, pktcMtaDevRealmAvailSlot=pktcMtaDevRealmAvailSlot, pktcMtaConformance=pktcMtaConformance, pktcMtaDevErrorOidsTable=pktcMtaDevErrorOidsTable, pktcMtaDevDnsServerAddressType=pktcMtaDevDnsServerAddressType, pktcMtaDevTimeServer=pktcMtaDevTimeServer, pktcMtaDevCmsIpsecCtrl=pktcMtaDevCmsIpsecCtrl, pktcMtaDevErrorReason=pktcMtaDevErrorReason, pktcMtaDevProvConfigEncryptAlg=pktcMtaDevProvConfigEncryptAlg, pktcMtaDevConfigFile=pktcMtaDevConfigFile, pktcMtaNotification=pktcMtaNotification, pktcMtaDevTimeServerAddressType=pktcMtaDevTimeServerAddressType, pktcMtaDevCmsEntry=pktcMtaDevCmsEntry, pktcMtaDevCmsMaxClockSkew=pktcMtaDevCmsMaxClockSkew, pktcMtaDevErrorOidsEntry=pktcMtaDevErrorOidsEntry, pktcMtaDevEndPntCount=pktcMtaDevEndPntCount, pktcMtaDevRealmUnsolicitedKeyMaxTimeout=pktcMtaDevRealmUnsolicitedKeyMaxTimeout, pktcMtaDevServer=pktcMtaDevServer, pktcMtaDevSnmpEntity=pktcMtaDevSnmpEntity, pktcMtaDevProvConfigHash=pktcMtaDevProvConfigHash, pktcMtaDevCmsKerbRealmName=pktcMtaDevCmsKerbRealmName, pktcMtaDevCertificate=pktcMtaDevCertificate, pktcMtaDevServerDhcp2=pktcMtaDevServerDhcp2, pktcMtaDevCmsUnsolicitedKeyMaxTimeout=pktcMtaDevCmsUnsolicitedKeyMaxTimeout, pktcMtaDevTelephonyRootCertificate=pktcMtaDevTelephonyRootCertificate, pktcMtaGroups=pktcMtaGroups, pktcMtaDevRealmStatus=pktcMtaDevRealmStatus, pktcMtaDevCmsUnsolicitedKeyNomTimeout=pktcMtaDevCmsUnsolicitedKeyNomTimeout, pktcMtaDevCmsIndex=pktcMtaDevCmsIndex, pktcMtaDevEnabled=pktcMtaDevEnabled, pktcMtaDevResetKrbTickets=pktcMtaDevResetKrbTickets)
