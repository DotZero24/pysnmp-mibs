...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-PFR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:57 2025
...
_CpfrMCStorageType_Type.__name__ = "StorageType"
...
_CpfrMCMapIndex_Type.__name__ = "PfrMapIndexOrZero"
...
_CpfrMCPortNumber_Type.__name__ = "InetPortNumber"
...
class _CpfrMCNetflowExporter_Type(SnmpAdminString):
    """Custom type cpfrMCNetflowExporter based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrMCNetflowExporter_Type.__name__ = "SnmpAdminString"
...
_CpfrMapStorageType_Type.__name__ = "StorageType"
...
_CpfrMapPrefixForwardInterface_Type.__name__ = "InterfaceIndexOrZero"
...
class _CpfrMapLinkGroupName_Type(SnmpAdminString):
    """Custom type cpfrMapLinkGroupName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrMapLinkGroupName_Type.__name__ = "SnmpAdminString"
...
class _CpfrMapFallbackLinkGroupName_Type(SnmpAdminString):
    """Custom type cpfrMapFallbackLinkGroupName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrMapFallbackLinkGroupName_Type.__name__ = "SnmpAdminString"
...
_CpfrMapUnreachableType_Type.__name__ = "PfrMetricPolicyType"
...
_CpfrMapUnreachableRelativeAvg_Type.__name__ = "Unsigned32"
...
_CpfrMapEventNotifCtrlType_Type.__name__ = "PfrMetricPolicyType"
...
class _CpfrMatchAddrAccessList_Type(SnmpAdminString):
    """Custom type cpfrMatchAddrAccessList based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrMatchAddrAccessList_Type.__name__ = "SnmpAdminString"
...
class _CpfrMatchAddrPrefixList_Type(SnmpAdminString):
    """Custom type cpfrMatchAddrPrefixList based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrMatchAddrPrefixList_Type.__name__ = "SnmpAdminString"
...
_CpfrMatchAddrPrefixInside_Type.__name__ = "TruthValue"
...
class _CpfrMatchLearnListName_Type(SnmpAdminString):
    """Custom type cpfrMatchLearnListName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrMatchLearnListName_Type.__name__ = "SnmpAdminString"
...
class _CpfrMatchTCNbarListName_Type(SnmpAdminString):
    """Custom type cpfrMatchTCNbarListName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrMatchTCNbarListName_Type.__name__ = "SnmpAdminString"
...
class _CpfrMatchTCNbarApplPfxList_Type(SnmpAdminString):
    """Custom type cpfrMatchTCNbarApplPfxList based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrMatchTCNbarApplPfxList_Type.__name__ = "SnmpAdminString"
...
_CpfrMatchTCPfxInside_Type.__name__ = "TruthValue"
...
_CpfrResolveStorageType_Type.__name__ = "StorageType"
...
_CpfrResolvePolicyType_Type.__name__ = "PfrResolvePolicyType"
...
_CpfrResolveMapIndex_Type.__name__ = "PfrMapIndexOrZero"
...
class _CpfrLearnAggAccesslistName_Type(SnmpAdminString):
    """Custom type cpfrLearnAggAccesslistName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrLearnAggAccesslistName_Type.__name__ = "SnmpAdminString"
...
class _CpfrLearnFilterAccessListName_Type(SnmpAdminString):
    """Custom type cpfrLearnFilterAccessListName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrLearnFilterAccessListName_Type.__name__ = "SnmpAdminString"
...
_CpfrLearnListStorageType_Type.__name__ = "StorageType"
...
class _CpfrLearnListReferenceName_Type(SnmpAdminString):
    """Custom type cpfrLearnListReferenceName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrLearnListReferenceName_Type.__name__ = "SnmpAdminString"
...
class _CpfrLearnListAclName_Type(SnmpAdminString):
    """Custom type cpfrLearnListAclName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrLearnListAclName_Type.__name__ = "SnmpAdminString"
...
class _CpfrLearnListPfxName_Type(SnmpAdminString):
    """Custom type cpfrLearnListPfxName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrLearnListPfxName_Type.__name__ = "SnmpAdminString"
...
_CpfrLearnListPfxInside_Type.__name__ = "TruthValue"
...
class _CpfrLearnListNbarAppl_Type(SnmpAdminString):
    """Custom type cpfrLearnListNbarAppl based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrLearnListNbarAppl_Type.__name__ = "SnmpAdminString"
...
class _CpfrLearnListFilterPfxName_Type(SnmpAdminString):
    """Custom type cpfrLearnListFilterPfxName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrLearnListFilterPfxName_Type.__name__ = "SnmpAdminString"
...
_CpfrActiveProbeStorageType_Type.__name__ = "StorageType"
...
_CpfrBRStorageType_Type.__name__ = "StorageType"
...
class _CpfrBRKeyName_Type(SnmpAdminString):
    """Custom type cpfrBRKeyName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrBRKeyName_Type.__name__ = "SnmpAdminString"
...
_CpfrExitStorageType_Type.__name__ = "StorageType"
...
class _CpfrExitName_Type(SnmpAdminString):
    """Custom type cpfrExitName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrExitName_Type.__name__ = "SnmpAdminString"
...
_CpfrExitMaxUtilRxType_Type.__name__ = "PfrMetricPolicyType"
...
_CpfrExitMaxUtilTxType_Type.__name__ = "PfrMetricPolicyType"
...
class _CpfrExitCostNickName_Type(SnmpAdminString):
    """Custom type cpfrExitCostNickName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CpfrExitCostNickName_Type.__name__ = "SnmpAdminString"
...
_CpfrExitCostTierStorageType_Type.__name__ = "StorageType"
...
_CpfrLinkGroupStorageType_Type.__name__ = "StorageType"
...
_CpfrNbarApplListStorageType_Type.__name__ = "StorageType"
...
ciscoPfrMIBCompliance.setObjects(
      *(("CISCO-PFR-MIB", "cpfrMasterControllerGroup"),
        ("CISCO-PFR-MIB", "cpfrBorderRouterGroup"),
        ("CISCO-PFR-MIB", "cpfrTrafficClassGroup"))
)
if mibBuilder.loadTexts:
...
ciscoPfrMIBComplianceRev1.setObjects(
      *(("CISCO-PFR-MIB", "cpfrMasterControllerGroup"),
        ("CISCO-PFR-MIB", "cpfrBorderRouterGroup"),
        ("CISCO-PFR-MIB", "cpfrTrafficClassGroup"),
        ("CISCO-PFR-MIB", "cpfrMasterControllerGroupRev1"),
        ("CISCO-PFR-MIB", "cpfrBorderRouterGroupRev1"),
        ("CISCO-PFR-MIB", "cpfrMCNotificationGroup"))
)
if mibBuilder.loadTexts:
