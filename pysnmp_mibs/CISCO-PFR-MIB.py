...
mibBuilder.exportSymbols("CISCO-PFR-MIB", cpfrMapDelayThresholdMax=cpfrMapDelayThresholdMax, cpfrMapActiveProbeFrequency=cpfrMapActiveProbeFrequency, cpfrActiveProbeOperStatus=cpfrActiveProbeOperStatus, cpfrBRUpTime=cpfrBRUpTime, cpfrTCBRExitIndex=cpfrTCBRExitIndex, cpfrLearnAggregationType=cpfrLearnAggregationType, cpfrBRAddress=cpfrBRAddress, cpfrExitCost2=cpfrExitCost2, cpfrMasterControllerGroup=cpfrMasterControllerGroup, cpfrTCDstMinPort=cpfrTCDstMinPort, cpfrMapPrefixForwardInterface=cpfrMapPrefixForwardInterface, cpfrMCRowStatus=cpfrMCRowStatus, cpfrLinkGroupExitTable=cpfrLinkGroupExitTable, cpfrExitCostTierTable=cpfrExitCostTierTable, cpfrActiveProbePfrMapIndex=cpfrActiveProbePfrMapIndex, cpfrMapMOSPercentage=cpfrMapMOSPercentage, cpfrMCNumofBorderRouters=cpfrMCNumofBorderRouters, cpfrBRConnStatus=cpfrBRConnStatus, cpfrMCTable=cpfrMCTable, cpfrLearnAggAccesslistName=cpfrLearnAggAccesslistName, cpfrMatchAddrAccessList=cpfrMatchAddrAccessList, cpfrMatchTable=cpfrMatchTable, cpfrMCPrefixLearned=cpfrMCPrefixLearned, cpfrResolveIndex=cpfrResolveIndex, cpfrTCSrcMaxPort=cpfrTCSrcMaxPort, cpfrResolveStorageType=cpfrResolveStorageType, cpfrExitCostTierRowStatus=cpfrExitCostTierRowStatus, cpfrExitRollupCumTxBytes=cpfrExitRollupCumTxBytes, cpfrLearnTable=cpfrLearnTable, cpfrMCChangeConfigValue=cpfrMCChangeConfigValue, cpfrExitCapacity=cpfrExitCapacity, cpfrLearnFilterAccessListName=cpfrLearnFilterAccessListName, cpfrTCSLastRouteChangeReason=cpfrTCSLastRouteChangeReason, cpfrExitStorageType=cpfrExitStorageType, cpfrExitCostFixedFeeCost=cpfrExitCostFixedFeeCost, cpfrTCInpolicyThresholdBelowNotify=cpfrTCInpolicyThresholdBelowNotify, cpfrLinkGroupExitEntry=cpfrLinkGroupExitEntry, cpfrExitCostDiscardPercent=cpfrExitCostDiscardPercent, cpfrMatchTCNbarApplPfxList=cpfrMatchTCNbarApplPfxList, cpfrExitCostTierEntry=cpfrExitCostTierEntry, ciscoPfrMIBNotifs=ciscoPfrMIBNotifs, cpfrMCLoggingAdminStatus=cpfrMCLoggingAdminStatus, ciscoPfrMIBGroups=ciscoPfrMIBGroups, cpfrExitRollupTimeRemain=cpfrExitRollupTimeRemain, cpfrExitRollupCurrentTgtUtil=cpfrExitRollupCurrentTgtUtil, cpfrLinkGroupType=cpfrLinkGroupType, cpfrNbarApplListName=cpfrNbarApplListName, cpfrMCEntry=cpfrMCEntry, cpfrTCMActiveSTJitterAvg=cpfrTCMActiveSTJitterAvg, cpfrBRTable=cpfrBRTable, cpfrLinkGroupExitIndex=cpfrLinkGroupExitIndex, cpfrMapDelayType=cpfrMapDelayType, cpfrMCExitLinksMaxUtil=cpfrMCExitLinksMaxUtil, cpfrActiveProbeMapPolicyIndex=cpfrActiveProbeMapPolicyIndex, cpfrExitSustainedUtil3=cpfrExitSustainedUtil3, cpfrMCPrefixConfigured=cpfrMCPrefixConfigured, cpfrActiveProbeType=cpfrActiveProbeType, cpfrMapUnreachableRelativeAvg=cpfrMapUnreachableRelativeAvg, cpfrActiveProbeAssignedPfxLen=cpfrActiveProbeAssignedPfxLen, cpfrTrafficClassEntry=cpfrTrafficClassEntry, cpfrTrafficClassMetricTable=cpfrTrafficClassMetricTable, cpfrLinkGroupIndex=cpfrLinkGroupIndex, cpfrMapUnreachableThresholdMax=cpfrMapUnreachableThresholdMax, cpfrTrafficClassStatusEntry=cpfrTrafficClassStatusEntry, cpfrResolveVariance=cpfrResolveVariance, cpfrMapModeMonitor=cpfrMapModeMonitor, cpfrMapLossRelativeAvg=cpfrMapLossRelativeAvg, cpfrTCMActiveSTUnreachableAvg=cpfrTCMActiveSTUnreachableAvg, cpfrMCEntranceLinksMaxUtil=cpfrMCEntranceLinksMaxUtil, cpfrExitRollupStartingTgtUtil=cpfrExitRollupStartingTgtUtil, cpfrMapNextHopAddress=cpfrMapNextHopAddress, cpfrLearnExpireType=cpfrLearnExpireType, cpfrActiveProbeAdminStatus=cpfrActiveProbeAdminStatus, cpfrTCMAge=cpfrTCMAge, cpfrMatchLearnListName=cpfrMatchLearnListName, cpfrMapModeRouteOpts=cpfrMapModeRouteOpts, cpfrMapUnreachableType=cpfrMapUnreachableType, cpfrExitCostCalcMethod=cpfrExitCostCalcMethod, cpfrActiveProbeTable=cpfrActiveProbeTable, PfrLearnListIndex=PfrLearnListIndex, cpfrLinkGroupStorageType=cpfrLinkGroupStorageType, cpfrMapIndex=cpfrMapIndex, cpfrExitCostEndOffsetType=cpfrExitCostEndOffsetType, cpfrMCPortNumber=cpfrMCPortNumber, PfrLastUncontrolReason=PfrLastUncontrolReason, cpfrExitStatusChangeNotify=cpfrExitStatusChangeNotify, cpfrActiveProbeTargetAddressType=cpfrActiveProbeTargetAddressType, cpfrExitCostTierFee=cpfrExitCostTierFee, cpfrExitRxLoad=cpfrExitRxLoad, cpfrExitCostDiscardType=cpfrExitCostDiscardType, cpfrTCMPassiveLTLossAvg=cpfrTCMPassiveLTLossAvg, cpfrMapBackoffMinTimer=cpfrMapBackoffMinTimer, cpfrMCTracerouteProbeDelay=cpfrMCTracerouteProbeDelay, cpfrExitRsvpBandwidthPool=cpfrExitRsvpBandwidthPool, PfrBorderRouterIndex=PfrBorderRouterIndex, PfrMapPolicyIndex=PfrMapPolicyIndex, cpfrExitSustainedUtil1=cpfrExitSustainedUtil1, cpfrLinkGroupBRIndex=cpfrLinkGroupBRIndex, cpfrDowngradeBgpCommunity=cpfrDowngradeBgpCommunity, cpfrExitRollupTotal=cpfrExitRollupTotal, cpfrLinkGroupRowStatus=cpfrLinkGroupRowStatus, cpfrActiveProbeAssignedPfxAddressType=cpfrActiveProbeAssignedPfxAddressType, cpfrMCNetflowExporter=cpfrMCNetflowExporter, PfrMetricPolicyType=PfrMetricPolicyType, cpfrTCMPassiveSTDelayAvg=cpfrTCMPassiveSTDelayAvg, cpfrMapStorageType=cpfrMapStorageType, cpfrMCPbrMet=cpfrMCPbrMet, cpfrBRRowStatus=cpfrBRRowStatus, cpfrExitMaxUtilRxPercentage=cpfrExitMaxUtilRxPercentage, cpfrBRStatusChangeNotify=cpfrBRStatusChangeNotify, cpfrMCMaxPrefixTotal=cpfrMCMaxPrefixTotal, cpfrTCMLastUpdateTime=cpfrTCMLastUpdateTime, cpfrTCSLastOOPReason=cpfrTCSLastOOPReason, cpfrExitRollupCollected=cpfrExitRollupCollected, cpfrMapJitterThresholdMax=cpfrMapJitterThresholdMax, cpfrExitCost3=cpfrExitCost3, ciscoPfrMIBComplianceRev1=ciscoPfrMIBComplianceRev1, cpfrNbarApplListRowStatus=cpfrNbarApplListRowStatus, PfrExitIndex=PfrExitIndex, cpfrExitMaxUtilTxPercentage=cpfrExitMaxUtilTxPercentage, cpfrMCKeepAliveTimer=cpfrMCKeepAliveTimer, cpfrLearnListStorageType=cpfrLearnListStorageType, cpfrLearnExpireTime=cpfrLearnExpireTime, cpfrNbarApplIndex=cpfrNbarApplIndex, cpfrTrafficClassIndex=cpfrTrafficClassIndex, cpfrTCMActiveLTDelayAvg=cpfrTCMActiveLTDelayAvg, cpfrMatchEntry=cpfrMatchEntry, cpfrMapEventNotifCtrlThreshold=cpfrMapEventNotifCtrlThreshold, cpfrExitRollupDiscard=cpfrExitRollupDiscard, cpfrExitCostEndOffset=cpfrExitCostEndOffset, cpfrTCSLearnListIndex=cpfrTCSLearnListIndex, cpfrMapLossType=cpfrMapLossType, cpfrTrafficClassValid=cpfrTrafficClassValid, cpfrMCNotificationGroup=cpfrMCNotificationGroup, cpfrExitEntry=cpfrExitEntry, cpfrTCStatus=cpfrTCStatus, cpfrTCMPassiveSTLossAvg=cpfrTCMPassiveSTLossAvg, cpfrTrafficClassTable=cpfrTrafficClassTable, cpfrExitMaxUtilRxType=cpfrExitMaxUtilRxType, cpfrActiveProbeTargetPortNumber=cpfrActiveProbeTargetPortNumber, cpfrMCControlMode=cpfrMCControlMode, cpfrBREntry=cpfrBREntry, cpfrTCMMOSPercentage=cpfrTCMMOSPercentage, cpfrExitRollupLeft=cpfrExitRollupLeft, cpfrResolveEntry=cpfrResolveEntry, PfrMapIndex=PfrMapIndex, cpfrBRKeyName=cpfrBRKeyName, cpfrMapLinkGroupName=cpfrMapLinkGroupName, cpfrResolveTable=cpfrResolveTable, cpfrTrafficClassEventNotify=cpfrTrafficClassEventNotify, cpfrTCMActiveSTDelayAvg=cpfrTCMActiveSTDelayAvg, cpfrMapEventTCCount=cpfrMapEventTCCount, cpfrLearnListIndex=cpfrLearnListIndex, cpfrLearnMethod=cpfrLearnMethod, cpfrTrafficClassMetricEntry=cpfrTrafficClassMetricEntry, cpfrMapRoundRobinResolver=cpfrMapRoundRobinResolver, ciscoPfrMIBCompliance=ciscoPfrMIBCompliance, PfRMasterControllerIndex=PfRMasterControllerIndex, cpfrNbarApplPdIndex=cpfrNbarApplPdIndex, cpfrMapTable=cpfrMapTable, cpfrLearnListRowStatus=cpfrLearnListRowStatus, ciscoPfrMIBCompliances=ciscoPfrMIBCompliances, cpfrMapTracerouteReporting=cpfrMapTracerouteReporting, cpfrLearnPrefixesNumber=cpfrLearnPrefixesNumber, cpfrMapHolddownTimer=cpfrMapHolddownTimer, cpfrTCDstMaxPort=cpfrTCDstMaxPort, cpfrMapEventNotifCtrlType=cpfrMapEventNotifCtrlType, cpfrMatchLearnMode=cpfrMatchLearnMode, cpfrTCMetricsValid=cpfrTCMetricsValid, cpfrActiveProbeRowStatus=cpfrActiveProbeRowStatus, cpfrLearnEntry=cpfrLearnEntry, cpfrExitCostNickName=cpfrExitCostNickName, cpfrLearnAggregationPrefixLen=cpfrLearnAggregationPrefixLen, cpfrMCMaxPrefixLearn=cpfrMCMaxPrefixLearn, cpfrExitCostDiscardAbsolute=cpfrExitCostDiscardAbsolute, cpfrTCMActiveLTUnreachableAvg=cpfrTCMActiveLTUnreachableAvg, cpfrMatchAddrPrefixInside=cpfrMatchAddrPrefixInside, cpfrExitRollupMomTgtUtil=cpfrExitRollupMomTgtUtil, cpfrMCNumofExits=cpfrMCNumofExits, cpfrExitRowStatus=cpfrExitRowStatus, cpfrExitName=cpfrExitName, cpfrMCAdminStatus=cpfrMCAdminStatus, ciscoPfrMIBObjects=ciscoPfrMIBObjects, cpfrResolveMapPolicyIndex=cpfrResolveMapPolicyIndex, cpfrLearnListReferenceName=cpfrLearnListReferenceName, cpfrTCMPackets=cpfrTCMPackets, cpfrTCDscpValue=cpfrTCDscpValue, cpfrResolvePriority=cpfrResolvePriority, cpfrExitMaxUtilRxAbsolute=cpfrExitMaxUtilRxAbsolute, cpfrExitCost1=cpfrExitCost1, cpfrBRAddressType=cpfrBRAddressType, cpfrTCPrimaryThresholdBelowNotify=cpfrTCPrimaryThresholdBelowNotify, cpfrMapRowStatus=cpfrMapRowStatus, cpfrMapRouteMetricEigrpTagCommunity=cpfrMapRouteMetricEigrpTagCommunity, cpfrMCConnStatus=cpfrMCConnStatus, cpfrActiveProbeStorageType=cpfrActiveProbeStorageType, cpfrMCOperStatus=cpfrMCOperStatus, cpfrExitCostTierIndex=cpfrExitCostTierIndex, cpfrTCMPassiveLTUnreachableAvg=cpfrTCMPassiveLTUnreachableAvg, cpfrExitCostRollupPeriod=cpfrExitCostRollupPeriod, cpfrTCBRIndex=cpfrTCBRIndex, cpfrTCSType=cpfrTCSType, cpfrMCLearnState=cpfrMCLearnState, cpfrTCSControlBy=cpfrTCSControlBy, cpfrLearnListFilterPfxName=cpfrLearnListFilterPfxName, cpfrLearnListSequenceNum=cpfrLearnListSequenceNum, cpfrTCSTimeRemainCurrState=cpfrTCSTimeRemainCurrState, cpfrBROperStatus=cpfrBROperStatus, cpfrTCMPassiveSTUnreachableAvg=cpfrTCMPassiveSTUnreachableAvg, cpfrLearnListMethod=cpfrLearnListMethod, cpfrExitSustainedUtil2=cpfrExitSustainedUtil2, cpfrMatchValid=cpfrMatchValid, cpfrMapBackoffMaxTimer=cpfrMapBackoffMaxTimer, cpfrExitIndex=cpfrExitIndex, PYSNMP_MODULE_ID=ciscoPfrMIB, cpfrResolvePolicyType=cpfrResolvePolicyType, cpfrNbarApplListStorageType=cpfrNbarApplListStorageType, cpfrExitMaxUtilTxType=cpfrExitMaxUtilTxType, cpfrResolveMapIndex=cpfrResolveMapIndex, cpfrTCDstPrefixType=cpfrTCDstPrefixType, PfrLearnListIndexOrZero=PfrLearnListIndexOrZero, cpfrMapFallbackLinkGroupName=cpfrMapFallbackLinkGroupName, cpfrBRConnFailureReason=cpfrBRConnFailureReason, cpfrExitType=cpfrExitType, cpfrTCDstPrefixLen=cpfrTCDstPrefixLen, cpfrMapPeriodicTimer=cpfrMapPeriodicTimer, cpfrTCSLastRouteChangeEvent=cpfrTCSLastRouteChangeEvent, cpfrTCMapIndex=cpfrTCMapIndex, cpfrMapModeSelectExitType=cpfrMapModeSelectExitType, cpfrTCSrcPrefix=cpfrTCSrcPrefix, cpfrLearnListPfxName=cpfrLearnListPfxName, cpfrTCSControlState=cpfrTCSControlState, cpfrMCStatusChangeNotify=cpfrMCStatusChangeNotify, cpfrExitCostTierStorageType=cpfrExitCostTierStorageType, cpfrMCRsvpPostDialDelay=cpfrMCRsvpPostDialDelay, cpfrExitMaxUtilTxAbsolute=cpfrExitMaxUtilTxAbsolute, cpfrActiveProbeAssignedPfxAddress=cpfrActiveProbeAssignedPfxAddress, ciscoPfrMIB=ciscoPfrMIB, cpfrLearnExpireSessionNum=cpfrLearnExpireSessionNum, cpfrMCIndex=cpfrMCIndex, cpfrMCClear=cpfrMCClear, cpfrMapLossThresholdMax=cpfrMapLossThresholdMax, cpfrLinkGroupName=cpfrLinkGroupName, cpfrLearnMonitorPeriod=cpfrLearnMonitorPeriod, cpfrActiveProbeIndex=cpfrActiveProbeIndex, cpfrMatchAddrPrefixList=cpfrMatchAddrPrefixList, cpfrActiveProbeTargetAddress=cpfrActiveProbeTargetAddress, cpfrExitRxBandwidth=cpfrExitRxBandwidth, cpfrBorderRouterGroup=cpfrBorderRouterGroup, cpfrMapActiveProbePackets=cpfrMapActiveProbePackets, ciscoPfrMIBConform=ciscoPfrMIBConform, cpfrMapRouteMetricStaticTag=cpfrMapRouteMetricStaticTag, cpfrExitRollupCumRxBytes=cpfrExitRollupCumRxBytes, cpfrNbarApplListEntry=cpfrNbarApplListEntry)
mibBuilder.exportSymbols("CISCO-PFR-MIB", cpfrExitTxLoad=cpfrExitTxLoad, cpfrLearnListNbarAppl=cpfrLearnListNbarAppl, cpfrMCMapIndex=cpfrMCMapIndex, cpfrMapRouteMetricBgpLocalPref=cpfrMapRouteMetricBgpLocalPref, cpfrActiveProbeEntry=cpfrActiveProbeEntry, cpfrMatchTCPfxInside=cpfrMatchTCPfxInside, cpfrMCChangeConfigType=cpfrMCChangeConfigType, cpfrMapBackoffStepTimer=cpfrMapBackoffStepTimer, cpfrTCMapPolicyIndex=cpfrTCMapPolicyIndex, cpfrNbarApplListTable=cpfrNbarApplListTable, cpfrExitCostSummerTimeStart=cpfrExitCostSummerTimeStart, cpfrTCProtocol=cpfrTCProtocol, cpfrLearnListAclName=cpfrLearnListAclName, cpfrTCSrcPrefixType=cpfrTCSrcPrefixType, cpfrTCNbarApplication=cpfrTCNbarApplication, cpfrMapPolicyIndex=cpfrMapPolicyIndex, cpfrTCSTimeOnCurrExit=cpfrTCSTimeOnCurrExit, cpfrTCSrcMinPort=cpfrTCSrcMinPort, cpfrExitCostSummerTimeEnd=cpfrExitCostSummerTimeEnd, cpfrMapName=cpfrMapName, cpfrMapEntry=cpfrMapEntry, cpfrMapMOSThresholdMin=cpfrMapMOSThresholdMin, cpfrMapNextHopAddressType=cpfrMapNextHopAddressType, cpfrLearnListEntry=cpfrLearnListEntry, cpfrExitCostSamplingPeriod=cpfrExitCostSamplingPeriod, cpfrMapDelayRelativePercent=cpfrMapDelayRelativePercent, cpfrTCSLastOOPEventTime=cpfrTCSLastOOPEventTime, cpfrMatchTCNbarListName=cpfrMatchTCNbarListName, cpfrLearnListTable=cpfrLearnListTable, cpfrTCMPassiveLTDelayAvg=cpfrTCMPassiveLTDelayAvg, cpfrBorderRouterGroupRev1=cpfrBorderRouterGroupRev1, cpfrExitNickName=cpfrExitNickName, cpfrMCStorageType=cpfrMCStorageType, cpfrExitCostDiscard=cpfrExitCostDiscard, cpfrTrafficClassStatusTable=cpfrTrafficClassStatusTable, cpfrBRStorageType=cpfrBRStorageType, cpfrTCMAttempts=cpfrTCMAttempts, cpfrActiveProbeDscpValue=cpfrActiveProbeDscpValue, cpfrMCRsvpSignalingRetries=cpfrMCRsvpSignalingRetries, cpfrTrafficClassGroup=cpfrTrafficClassGroup, cpfrExitTxBandwidth=cpfrExitTxBandwidth, cpfrActiveProbeMethod=cpfrActiveProbeMethod, cpfrMCLearnStateTimeRemain=cpfrMCLearnStateTimeRemain, cpfrMCNotifisControl=cpfrMCNotifisControl, cpfrLearnPeriodInterval=cpfrLearnPeriodInterval, cpfrMCPrefixCount=cpfrMCPrefixCount, cpfrTCDstPrefix=cpfrTCDstPrefix, cpfrExitCostSummerTimeOffset=cpfrExitCostSummerTimeOffset, cpfrBRAuthFailCount=cpfrBRAuthFailCount, cpfrExitTable=cpfrExitTable, cpfrActiveProbeMapIndex=cpfrActiveProbeMapIndex, cpfrActiveProbeCodecName=cpfrActiveProbeCodecName, PfrMapIndexOrZero=PfrMapIndexOrZero, cpfrBRIndex=cpfrBRIndex, cpfrResolveRowStatus=cpfrResolveRowStatus, cpfrExitCostEndDayOfMonth=cpfrExitCostEndDayOfMonth, cpfrMasterControllerGroupRev1=cpfrMasterControllerGroupRev1, cpfrTCSrcPrefixLen=cpfrTCSrcPrefixLen, PfrResolvePolicyType=PfrResolvePolicyType, cpfrLearnListPfxInside=cpfrLearnListPfxInside, cpfrExitOperStatus=cpfrExitOperStatus, cpfrMCLastClearTime=cpfrMCLastClearTime)
