...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-PFR-MIB
...
InterfaceIndexOrZero, CiscoPort = mibBuilder.importSymbols("CISCO-TC", "InterfaceIndexOrZero", "CiscoPort")
...
mibBuilder.exportSymbols("CISCO-PFR-MIB", PYSNMP_MODULE_ID=ciscoPfrMIB, cpfrLearnListEntry=cpfrLearnListEntry, cpfrResolveVariance=cpfrResolveVariance, cpfrMapNextHopAddress=cpfrMapNextHopAddress, cpfrTCMPackets=cpfrTCMPackets, cpfrNbarApplListTable=cpfrNbarApplListTable, cpfrTCMActiveSTJitterAvg=cpfrTCMActiveSTJitterAvg, cpfrExitEntry=cpfrExitEntry, cpfrMCNotificationGroup=cpfrMCNotificationGroup, cpfrExitCostDiscardAbsolute=cpfrExitCostDiscardAbsolute, cpfrActiveProbeTargetPortNumber=cpfrActiveProbeTargetPortNumber, cpfrMapFallbackLinkGroupName=cpfrMapFallbackLinkGroupName, cpfrMapRoundRobinResolver=cpfrMapRoundRobinResolver, cpfrLinkGroupExitTable=cpfrLinkGroupExitTable, cpfrBRAddress=cpfrBRAddress, cpfrMCClear=cpfrMCClear, cpfrExitCost2=cpfrExitCost2, cpfrBRRowStatus=cpfrBRRowStatus, cpfrTCSLearnListIndex=cpfrTCSLearnListIndex, cpfrExitMaxUtilTxAbsolute=cpfrExitMaxUtilTxAbsolute, cpfrMapModeMonitor=cpfrMapModeMonitor, cpfrMCPrefixLearned=cpfrMCPrefixLearned, cpfrTrafficClassTable=cpfrTrafficClassTable, cpfrActiveProbeTable=cpfrActiveProbeTable, cpfrLearnListFilterPfxName=cpfrLearnListFilterPfxName, cpfrExitCostTierIndex=cpfrExitCostTierIndex, cpfrExitName=cpfrExitName, cpfrTCMLastUpdateTime=cpfrTCMLastUpdateTime, cpfrMapUnreachableType=cpfrMapUnreachableType, cpfrLearnListSequenceNum=cpfrLearnListSequenceNum, cpfrLearnListIndex=cpfrLearnListIndex, cpfrLearnPrefixesNumber=cpfrLearnPrefixesNumber, cpfrLearnAggregationType=cpfrLearnAggregationType, cpfrTCSControlState=cpfrTCSControlState, cpfrActiveProbeAssignedPfxAddressType=cpfrActiveProbeAssignedPfxAddressType, cpfrExitCostFixedFeeCost=cpfrExitCostFixedFeeCost, cpfrMapRouteMetricBgpLocalPref=cpfrMapRouteMetricBgpLocalPref, cpfrExitTxBandwidth=cpfrExitTxBandwidth, cpfrTCBRIndex=cpfrTCBRIndex, cpfrMCLearnStateTimeRemain=cpfrMCLearnStateTimeRemain, cpfrMCPrefixConfigured=cpfrMCPrefixConfigured, cpfrMCAdminStatus=cpfrMCAdminStatus, cpfrMCLearnState=cpfrMCLearnState, cpfrMCOperStatus=cpfrMCOperStatus, cpfrMapStorageType=cpfrMapStorageType, cpfrExitCostTierTable=cpfrExitCostTierTable, cpfrLearnListReferenceName=cpfrLearnListReferenceName, cpfrResolveRowStatus=cpfrResolveRowStatus, cpfrMapBackoffStepTimer=cpfrMapBackoffStepTimer, cpfrTCDstMinPort=cpfrTCDstMinPort, cpfrTrafficClassGroup=cpfrTrafficClassGroup, cpfrExitCost1=cpfrExitCost1, cpfrTrafficClassMetricTable=cpfrTrafficClassMetricTable, cpfrBRAddressType=cpfrBRAddressType, cpfrLinkGroupName=cpfrLinkGroupName, cpfrActiveProbeRowStatus=cpfrActiveProbeRowStatus, cpfrExitCostEndOffsetType=cpfrExitCostEndOffsetType, cpfrMapMOSThresholdMin=cpfrMapMOSThresholdMin, cpfrMapPeriodicTimer=cpfrMapPeriodicTimer, cpfrTCSrcPrefix=cpfrTCSrcPrefix, cpfrExitTxLoad=cpfrExitTxLoad, cpfrTrafficClassEntry=cpfrTrafficClassEntry, cpfrTCMActiveLTUnreachableAvg=cpfrTCMActiveLTUnreachableAvg, cpfrTCMapPolicyIndex=cpfrTCMapPolicyIndex, cpfrMapTracerouteReporting=cpfrMapTracerouteReporting, cpfrTCMAge=cpfrTCMAge, cpfrMapEventNotifCtrlThreshold=cpfrMapEventNotifCtrlThreshold, cpfrBRAuthFailCount=cpfrBRAuthFailCount, cpfrMapRouteMetricStaticTag=cpfrMapRouteMetricStaticTag, cpfrActiveProbeAdminStatus=cpfrActiveProbeAdminStatus, cpfrTCMapIndex=cpfrTCMapIndex, cpfrExitCostSamplingPeriod=cpfrExitCostSamplingPeriod, cpfrBRConnFailureReason=cpfrBRConnFailureReason, cpfrExitRollupCurrentTgtUtil=cpfrExitRollupCurrentTgtUtil, cpfrMCConnStatus=cpfrMCConnStatus, cpfrTCStatus=cpfrTCStatus, ciscoPfrMIBCompliances=ciscoPfrMIBCompliances, cpfrMasterControllerGroup=cpfrMasterControllerGroup, cpfrResolvePriority=cpfrResolvePriority, cpfrExitMaxUtilRxAbsolute=cpfrExitMaxUtilRxAbsolute, cpfrExitTable=cpfrExitTable, cpfrExitSustainedUtil2=cpfrExitSustainedUtil2, cpfrExitRollupCollected=cpfrExitRollupCollected, cpfrActiveProbeEntry=cpfrActiveProbeEntry, cpfrExitCostSummerTimeStart=cpfrExitCostSummerTimeStart, cpfrTCSLastOOPEventTime=cpfrTCSLastOOPEventTime, cpfrMCNotifisControl=cpfrMCNotifisControl, cpfrResolveMapIndex=cpfrResolveMapIndex, cpfrTCSType=cpfrTCSType, cpfrMapBackoffMinTimer=cpfrMapBackoffMinTimer, cpfrTCMMOSPercentage=cpfrTCMMOSPercentage, cpfrActiveProbeCodecName=cpfrActiveProbeCodecName, cpfrExitCostDiscardPercent=cpfrExitCostDiscardPercent, cpfrExitRowStatus=cpfrExitRowStatus, cpfrNbarApplIndex=cpfrNbarApplIndex, cpfrExitMaxUtilTxType=cpfrExitMaxUtilTxType, cpfrExitCostTierFee=cpfrExitCostTierFee, cpfrTCProtocol=cpfrTCProtocol, cpfrMapBackoffMaxTimer=cpfrMapBackoffMaxTimer, cpfrTCSControlBy=cpfrTCSControlBy, cpfrNbarApplListStorageType=cpfrNbarApplListStorageType, cpfrExitSustainedUtil3=cpfrExitSustainedUtil3, PfrMapIndexOrZero=PfrMapIndexOrZero, cpfrNbarApplListName=cpfrNbarApplListName, cpfrTCMetricsValid=cpfrTCMetricsValid, cpfrTCSrcMinPort=cpfrTCSrcMinPort, cpfrMCTracerouteProbeDelay=cpfrMCTracerouteProbeDelay, cpfrLearnListPfxName=cpfrLearnListPfxName, cpfrMCTable=cpfrMCTable, ciscoPfrMIBObjects=ciscoPfrMIBObjects, cpfrMapLossType=cpfrMapLossType, PfrMapPolicyIndex=PfrMapPolicyIndex, cpfrMapDelayRelativePercent=cpfrMapDelayRelativePercent, cpfrMCStorageType=cpfrMCStorageType, cpfrMCMaxPrefixTotal=cpfrMCMaxPrefixTotal, cpfrResolveStorageType=cpfrResolveStorageType, cpfrExitCostEndDayOfMonth=cpfrExitCostEndDayOfMonth, cpfrLearnExpireSessionNum=cpfrLearnExpireSessionNum, cpfrMapHolddownTimer=cpfrMapHolddownTimer, PfrResolvePolicyType=PfrResolvePolicyType, cpfrLearnExpireTime=cpfrLearnExpireTime, cpfrTCMAttempts=cpfrTCMAttempts, cpfrLearnMethod=cpfrLearnMethod, cpfrExitStatusChangeNotify=cpfrExitStatusChangeNotify, cpfrTCDstMaxPort=cpfrTCDstMaxPort, PfrLearnListIndexOrZero=PfrLearnListIndexOrZero, cpfrMCNetflowExporter=cpfrMCNetflowExporter, cpfrExitCost3=cpfrExitCost3, cpfrMapMOSPercentage=cpfrMapMOSPercentage, cpfrDowngradeBgpCommunity=cpfrDowngradeBgpCommunity, cpfrActiveProbeAssignedPfxAddress=cpfrActiveProbeAssignedPfxAddress, cpfrExitRxBandwidth=cpfrExitRxBandwidth, cpfrExitSustainedUtil1=cpfrExitSustainedUtil1, cpfrLinkGroupStorageType=cpfrLinkGroupStorageType, ciscoPfrMIBGroups=ciscoPfrMIBGroups, cpfrExitMaxUtilRxType=cpfrExitMaxUtilRxType, cpfrMapIndex=cpfrMapIndex, cpfrMapJitterThresholdMax=cpfrMapJitterThresholdMax, cpfrActiveProbeTargetAddress=cpfrActiveProbeTargetAddress, cpfrLearnAggAccesslistName=cpfrLearnAggAccesslistName, cpfrMapPolicyIndex=cpfrMapPolicyIndex, ciscoPfrMIBConform=ciscoPfrMIBConform, cpfrLinkGroupExitIndex=cpfrLinkGroupExitIndex, PfrMapIndex=PfrMapIndex, cpfrTCMPassiveSTUnreachableAvg=cpfrTCMPassiveSTUnreachableAvg, cpfrActiveProbeStorageType=cpfrActiveProbeStorageType, cpfrTCDstPrefixType=cpfrTCDstPrefixType, cpfrExitType=cpfrExitType, cpfrLearnExpireType=cpfrLearnExpireType, cpfrBRIndex=cpfrBRIndex, ciscoPfrMIB=ciscoPfrMIB, cpfrExitCostDiscard=cpfrExitCostDiscard, cpfrLearnMonitorPeriod=cpfrLearnMonitorPeriod, cpfrMapName=cpfrMapName, PfrExitIndex=PfrExitIndex, cpfrExitIndex=cpfrExitIndex, cpfrTCMPassiveLTDelayAvg=cpfrTCMPassiveLTDelayAvg, cpfrMasterControllerGroupRev1=cpfrMasterControllerGroupRev1, cpfrExitCostTierEntry=cpfrExitCostTierEntry, cpfrLinkGroupBRIndex=cpfrLinkGroupBRIndex, cpfrBorderRouterGroupRev1=cpfrBorderRouterGroupRev1, cpfrMCPortNumber=cpfrMCPortNumber, cpfrExitMaxUtilRxPercentage=cpfrExitMaxUtilRxPercentage, cpfrTCMPassiveLTUnreachableAvg=cpfrTCMPassiveLTUnreachableAvg, cpfrTCSrcMaxPort=cpfrTCSrcMaxPort, cpfrTCSrcPrefixType=cpfrTCSrcPrefixType, cpfrBRConnStatus=cpfrBRConnStatus, ciscoPfrMIBCompliance=ciscoPfrMIBCompliance, cpfrResolvePolicyType=cpfrResolvePolicyType, cpfrActiveProbeOperStatus=cpfrActiveProbeOperStatus, cpfrMatchTCNbarListName=cpfrMatchTCNbarListName, cpfrLearnListTable=cpfrLearnListTable, cpfrMapDelayType=cpfrMapDelayType, cpfrLinkGroupType=cpfrLinkGroupType, cpfrTCDstPrefix=cpfrTCDstPrefix, cpfrMCChangeConfigValue=cpfrMCChangeConfigValue, cpfrLearnListPfxInside=cpfrLearnListPfxInside, cpfrExitCostCalcMethod=cpfrExitCostCalcMethod, cpfrExitRollupLeft=cpfrExitRollupLeft, cpfrMatchTable=cpfrMatchTable, cpfrMCExitLinksMaxUtil=cpfrMCExitLinksMaxUtil, cpfrTCBRExitIndex=cpfrTCBRExitIndex, cpfrNbarApplListRowStatus=cpfrNbarApplListRowStatus, cpfrLearnListMethod=cpfrLearnListMethod, cpfrActiveProbeIndex=cpfrActiveProbeIndex, cpfrMapRouteMetricEigrpTagCommunity=cpfrMapRouteMetricEigrpTagCommunity, cpfrExitNickName=cpfrExitNickName, cpfrMapPrefixForwardInterface=cpfrMapPrefixForwardInterface, cpfrBROperStatus=cpfrBROperStatus, cpfrMapUnreachableRelativeAvg=cpfrMapUnreachableRelativeAvg, cpfrExitStorageType=cpfrExitStorageType, cpfrTCPrimaryThresholdBelowNotify=cpfrTCPrimaryThresholdBelowNotify, cpfrTCMPassiveSTLossAvg=cpfrTCMPassiveSTLossAvg, cpfrMapEntry=cpfrMapEntry, cpfrActiveProbeType=cpfrActiveProbeType, cpfrResolveEntry=cpfrResolveEntry, cpfrLearnPeriodInterval=cpfrLearnPeriodInterval, ciscoPfrMIBComplianceRev1=ciscoPfrMIBComplianceRev1, cpfrMatchEntry=cpfrMatchEntry, cpfrTCMPassiveSTDelayAvg=cpfrTCMPassiveSTDelayAvg, ciscoPfrMIBNotifs=ciscoPfrMIBNotifs, cpfrMatchValid=cpfrMatchValid, cpfrMCIndex=cpfrMCIndex, cpfrTrafficClassValid=cpfrTrafficClassValid, cpfrMCPrefixCount=cpfrMCPrefixCount, cpfrBorderRouterGroup=cpfrBorderRouterGroup, PfrMetricPolicyType=PfrMetricPolicyType, cpfrLearnTable=cpfrLearnTable, cpfrActiveProbeTargetAddressType=cpfrActiveProbeTargetAddressType, cpfrTrafficClassStatusTable=cpfrTrafficClassStatusTable, cpfrExitCostDiscardType=cpfrExitCostDiscardType, cpfrActiveProbeDscpValue=cpfrActiveProbeDscpValue, cpfrBRStorageType=cpfrBRStorageType, cpfrMCControlMode=cpfrMCControlMode, cpfrMapRowStatus=cpfrMapRowStatus, cpfrResolveTable=cpfrResolveTable, cpfrMCRsvpPostDialDelay=cpfrMCRsvpPostDialDelay, cpfrTCMPassiveLTLossAvg=cpfrTCMPassiveLTLossAvg, cpfrMapLinkGroupName=cpfrMapLinkGroupName, cpfrMapLossRelativeAvg=cpfrMapLossRelativeAvg, cpfrTCNbarApplication=cpfrTCNbarApplication, cpfrMapModeSelectExitType=cpfrMapModeSelectExitType, cpfrResolveIndex=cpfrResolveIndex, cpfrExitRollupCumTxBytes=cpfrExitRollupCumTxBytes, cpfrActiveProbeMapPolicyIndex=cpfrActiveProbeMapPolicyIndex, cpfrMapActiveProbeFrequency=cpfrMapActiveProbeFrequency, cpfrExitRollupDiscard=cpfrExitRollupDiscard, cpfrExitCapacity=cpfrExitCapacity, cpfrTCSTimeRemainCurrState=cpfrTCSTimeRemainCurrState, cpfrExitOperStatus=cpfrExitOperStatus, cpfrLearnListStorageType=cpfrLearnListStorageType, cpfrExitRollupTimeRemain=cpfrExitRollupTimeRemain, cpfrExitCostSummerTimeOffset=cpfrExitCostSummerTimeOffset, cpfrTCSLastRouteChangeReason=cpfrTCSLastRouteChangeReason, cpfrActiveProbePfrMapIndex=cpfrActiveProbePfrMapIndex, cpfrTrafficClassEventNotify=cpfrTrafficClassEventNotify, cpfrExitCostNickName=cpfrExitCostNickName, cpfrTCMActiveSTUnreachableAvg=cpfrTCMActiveSTUnreachableAvg, cpfrMCChangeConfigType=cpfrMCChangeConfigType, cpfrExitRxLoad=cpfrExitRxLoad, cpfrMCEntry=cpfrMCEntry, cpfrTCSLastOOPReason=cpfrTCSLastOOPReason, cpfrMapModeRouteOpts=cpfrMapModeRouteOpts, PfrLastUncontrolReason=PfrLastUncontrolReason, cpfrMCLoggingAdminStatus=cpfrMCLoggingAdminStatus, cpfrExitCostTierRowStatus=cpfrExitCostTierRowStatus, cpfrMCNumofBorderRouters=cpfrMCNumofBorderRouters, cpfrLinkGroupRowStatus=cpfrLinkGroupRowStatus, cpfrNbarApplListEntry=cpfrNbarApplListEntry, cpfrMapUnreachableThresholdMax=cpfrMapUnreachableThresholdMax, cpfrMCMapIndex=cpfrMCMapIndex, PfRMasterControllerIndex=PfRMasterControllerIndex, cpfrMCPbrMet=cpfrMCPbrMet, cpfrBRStatusChangeNotify=cpfrBRStatusChangeNotify)
mibBuilder.exportSymbols("CISCO-PFR-MIB", cpfrMapNextHopAddressType=cpfrMapNextHopAddressType, cpfrMCStatusChangeNotify=cpfrMCStatusChangeNotify, cpfrMapDelayThresholdMax=cpfrMapDelayThresholdMax, cpfrMatchTCNbarApplPfxList=cpfrMatchTCNbarApplPfxList, cpfrMCEntranceLinksMaxUtil=cpfrMCEntranceLinksMaxUtil, cpfrTCDscpValue=cpfrTCDscpValue, cpfrMCRowStatus=cpfrMCRowStatus, cpfrExitCostSummerTimeEnd=cpfrExitCostSummerTimeEnd, cpfrTrafficClassIndex=cpfrTrafficClassIndex, cpfrBRUpTime=cpfrBRUpTime, cpfrBRTable=cpfrBRTable, cpfrExitCostTierStorageType=cpfrExitCostTierStorageType, cpfrMapLossThresholdMax=cpfrMapLossThresholdMax, cpfrExitRsvpBandwidthPool=cpfrExitRsvpBandwidthPool, cpfrMCNumofExits=cpfrMCNumofExits, cpfrActiveProbeAssignedPfxLen=cpfrActiveProbeAssignedPfxLen, cpfrLearnFilterAccessListName=cpfrLearnFilterAccessListName, cpfrTrafficClassStatusEntry=cpfrTrafficClassStatusEntry, cpfrMapTable=cpfrMapTable, cpfrMatchAddrPrefixList=cpfrMatchAddrPrefixList, cpfrLinkGroupIndex=cpfrLinkGroupIndex, cpfrLinkGroupExitEntry=cpfrLinkGroupExitEntry, cpfrMatchTCPfxInside=cpfrMatchTCPfxInside, PfrLearnListIndex=PfrLearnListIndex, cpfrMatchLearnListName=cpfrMatchLearnListName, cpfrMatchAddrPrefixInside=cpfrMatchAddrPrefixInside, cpfrNbarApplPdIndex=cpfrNbarApplPdIndex, cpfrLearnListNbarAppl=cpfrLearnListNbarAppl, cpfrTCSTimeOnCurrExit=cpfrTCSTimeOnCurrExit, cpfrMCLastClearTime=cpfrMCLastClearTime, cpfrExitCostEndOffset=cpfrExitCostEndOffset, cpfrTCSrcPrefixLen=cpfrTCSrcPrefixLen, cpfrTCMActiveSTDelayAvg=cpfrTCMActiveSTDelayAvg, cpfrExitRollupMomTgtUtil=cpfrExitRollupMomTgtUtil, cpfrBREntry=cpfrBREntry, cpfrMatchAddrAccessList=cpfrMatchAddrAccessList, cpfrMapEventTCCount=cpfrMapEventTCCount, cpfrExitRollupStartingTgtUtil=cpfrExitRollupStartingTgtUtil, cpfrMCKeepAliveTimer=cpfrMCKeepAliveTimer, cpfrExitRollupTotal=cpfrExitRollupTotal, cpfrTrafficClassMetricEntry=cpfrTrafficClassMetricEntry, cpfrExitRollupCumRxBytes=cpfrExitRollupCumRxBytes, cpfrMCMaxPrefixLearn=cpfrMCMaxPrefixLearn, cpfrTCSLastRouteChangeEvent=cpfrTCSLastRouteChangeEvent, cpfrLearnAggregationPrefixLen=cpfrLearnAggregationPrefixLen, cpfrMCRsvpSignalingRetries=cpfrMCRsvpSignalingRetries, cpfrMapActiveProbePackets=cpfrMapActiveProbePackets, cpfrMapEventNotifCtrlType=cpfrMapEventNotifCtrlType, cpfrExitMaxUtilTxPercentage=cpfrExitMaxUtilTxPercentage, cpfrActiveProbeMapIndex=cpfrActiveProbeMapIndex, cpfrLearnListRowStatus=cpfrLearnListRowStatus, cpfrActiveProbeMethod=cpfrActiveProbeMethod, cpfrMatchLearnMode=cpfrMatchLearnMode, cpfrTCInpolicyThresholdBelowNotify=cpfrTCInpolicyThresholdBelowNotify, cpfrTCMActiveLTDelayAvg=cpfrTCMActiveLTDelayAvg, cpfrExitCostRollupPeriod=cpfrExitCostRollupPeriod, cpfrLearnListAclName=cpfrLearnListAclName, cpfrLearnEntry=cpfrLearnEntry, PfrBorderRouterIndex=PfrBorderRouterIndex, cpfrResolveMapPolicyIndex=cpfrResolveMapPolicyIndex, cpfrBRKeyName=cpfrBRKeyName, cpfrTCDstPrefixLen=cpfrTCDstPrefixLen)
