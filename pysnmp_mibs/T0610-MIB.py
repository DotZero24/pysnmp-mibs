# SNMP MIB module (T0610-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/T0610-MIB
...
trapTest.setObjects(
      *(("T0610-MIB", "sensorName"),
        ("T0610-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
