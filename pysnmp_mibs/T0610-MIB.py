...
mibBuilder.exportSymbols("T0610-MIB", tempHystInt=tempHystInt, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, DisplayString=DisplayString, values=values, trapEmailErrAuth=trapEmailErrAuth, tempInt=tempInt, tempHighInt=tempHighInt, messageString=messageString, t0610=t0610, trapEmailErrSocket=trapEmailErrSocket, traps=traps, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, sensorName=sensorName, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, serialNumber=serialNumber, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, comet=comet, pysmi_global=pysmi_global, valuesInt=valuesInt, tempAlarmInt=tempAlarmInt, deviceType=deviceType, tempUnit=tempUnit, trapTest=trapTest, tempMin=tempMin, tempDelayInt=tempDelayInt, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, historyEntry=historyEntry, histTemp=histTemp, products=products, tables=tables, trapEmailErrDNS=trapEmailErrDNS, trapTempError=trapTempError, tempLowInt=tempLowInt, tempMax=tempMax, settings=settings, trapEmailErrLogin=trapEmailErrLogin)
