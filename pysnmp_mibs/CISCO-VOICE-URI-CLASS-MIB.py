...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VOICE-URI-CLASS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:41:25 2025
...
class _CvSIPUriClassCfgUserIDPattern_Type(CvUriClassPattern):
    """Custom type cvSIPUriClassCfgUserIDPattern based on CvUriClassPattern"""
    defaultValue = OctetString("")


_CvSIPUriClassCfgUserIDPattern_Type.__name__ = "CvUriClassPattern"
...
class _CvSIPUriClassCfgHostPattern_Type(CvUriClassPattern):
    """Custom type cvSIPUriClassCfgHostPattern based on CvUriClassPattern"""
    defaultValue = OctetString("")


_CvSIPUriClassCfgHostPattern_Type.__name__ = "CvUriClassPattern"
...
class _CvSIPUriClassCfgPhoneCtxtPattern_Type(CvUriClassPattern):
    """Custom type cvSIPUriClassCfgPhoneCtxtPattern based on CvUriClassPattern"""
    defaultValue = OctetString("")


_CvSIPUriClassCfgPhoneCtxtPattern_Type.__name__ = "CvUriClassPattern"
...
class _CvTELUriClassCfgPhoneNumPattern_Type(CvUriClassPattern):
    """Custom type cvTELUriClassCfgPhoneNumPattern based on CvUriClassPattern"""
    defaultValue = OctetString("")


_CvTELUriClassCfgPhoneNumPattern_Type.__name__ = "CvUriClassPattern"
...
class _CvTELUriClassCfgPhoneCtxtPattern_Type(CvUriClassPattern):
    """Custom type cvTELUriClassCfgPhoneCtxtPattern based on CvUriClassPattern"""
    defaultValue = OctetString("")


_CvTELUriClassCfgPhoneCtxtPattern_Type.__name__ = "CvUriClassPattern"
...
_CvUriClassSIPHostPreference_Type.__name__ = "CvUriClassPreference"
...
_CvUriClassSIPUserIDPreference_Type.__name__ = "CvUriClassPreference"
...
cvUriClassMIBCompliance.setObjects(
    ("CISCO-VOICE-URI-CLASS-MIB", "cvUriClassGroup")
)
if mibBuilder.loadTexts:
