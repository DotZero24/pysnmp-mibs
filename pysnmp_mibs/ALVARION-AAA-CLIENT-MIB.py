...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-AAA-CLIENT-MIB
...
alvarionAAAClientMIBCompliance.setObjects(
      *(("ALVARION-AAA-CLIENT-MIB", "alvarionAAAProfileMIBGroup"),
        ("ALVARION-AAA-CLIENT-MIB", "alvarionAAAClientMIBGroup"))
)
if mibBuilder.loadTexts:
