...
mibBuilder.exportSymbols("CISCO-VLAN-MEMBERSHIP-MIB", vmPortStatus=vmPortStatus, vmStatistics=vmStatistics, vmVoiceVlanGroup=vmVoiceVlanGroup, vmMembershipSummaryExtPorts=vmMembershipSummaryExtPorts, vmVmpsTable=vmVmpsTable, vmVlan=vmVlan, vmMembershipEntry=vmMembershipEntry, vmMembership=vmMembership, vmVQPResponses=vmVQPResponses, vmVoiceVlanExtGroup=vmVoiceVlanExtGroup, vmVoiceVlanTable=vmVoiceVlanTable, vmInsufficientResources=vmInsufficientResources, vmVoiceVlanCdpVerifyEnable=vmVoiceVlanCdpVerifyEnable, vmVlans2k=vmVlans2k, vmVlans3k=vmVlans3k, vmMIBGroups=vmMIBGroups, vmNotifications=vmNotifications, vmNotificationsPrefix=vmNotificationsPrefix, vmMIBCompliance3=vmMIBCompliance3, vmVmpsChanges=vmVmpsChanges, vmVoiceVlanId=vmVoiceVlanId, vmVoiceVlan=vmVoiceVlan, vmVmpsRetries=vmVmpsRetries, vmMembershipSummaryVlanIndex=vmMembershipSummaryVlanIndex, vmVQPQueries=vmVQPQueries, vmVQPShutdown=vmVQPShutdown, vmVlanCreationMode=vmVlanCreationMode, vmVQPWrongVersion=vmVQPWrongVersion, vmVmpsEntry=vmVmpsEntry, vmVlans4k=vmVlans4k, vmMembershipSummaryMember2kPorts=vmMembershipSummaryMember2kPorts, ciscoVlanMembershipMIB=ciscoVlanMembershipMIB, ciscoVlanMembershipMIBObjects=ciscoVlanMembershipMIBObjects, vmMembershipSummaryEntry=vmMembershipSummaryEntry, vmMIBCompliance7=vmMIBCompliance7, vmVmpsChange=vmVmpsChange, vmMembershipTable=vmMembershipTable, vm4kVlanGroup=vm4kVlanGroup, vmVmpsIpAddress=vmVmpsIpAddress, vmVlanType=vmVlanType, vmMIBConformance=vmMIBConformance, vmMIBCompliance6=vmMIBCompliance6, vmVmpsReconfirmInterval=vmVmpsReconfirmInterval, vmVmpsReconfirm=vmVmpsReconfirm, vmVlans=vmVlans, vmNotificationsEnabled=vmNotificationsEnabled, vmMembershipSummaryExtEntry=vmMembershipSummaryExtEntry, vmMembershipSummaryExtTable=vmMembershipSummaryExtTable, vmVoiceVlanEntry=vmVoiceVlanEntry, vmVQPNotificationsGroup=vmVQPNotificationsGroup, vmMIBCompliance5=vmMIBCompliance5, vm1kVlanGroup=vm1kVlanGroup, vmMembershipExtGroup=vmMembershipExtGroup, vmStatusGroup=vmStatusGroup, vmMembershipSummaryMemberPorts=vmMembershipSummaryMemberPorts, vmVmpsReconfirmResult=vmVmpsReconfirmResult, vmVmpsCurrent=vmVmpsCurrent, vmVmpsVQPVersion=vmVmpsVQPVersion, vmMIBCompliances=vmMIBCompliances, vmVQPDenied=vmVQPDenied, vmMIBCompliance2=vmMIBCompliance2, vmVlanCreationGroup=vmVlanCreationGroup, vmVmpsPrimary=vmVmpsPrimary, vmMembershipSummaryTable=vmMembershipSummaryTable, vmVQPWrongDomain=vmVQPWrongDomain, vmMembershipGroup=vmMembershipGroup, vmVQPClientGroup=vmVQPClientGroup, vmMembershipGroup2=vmMembershipGroup2, vmMIBCompliance4=vmMIBCompliance4, vmMIBCompliance=vmMIBCompliance, vmVmpsRowStatus=vmVmpsRowStatus, vmVmps=vmVmps, vmMembershipPortRangeIndex=vmMembershipPortRangeIndex, PYSNMP_MODULE_ID=ciscoVlanMembershipMIB, vmMembershipGroup3=vmMembershipGroup3, vmStatus=vmStatus)
