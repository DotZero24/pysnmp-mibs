...
mibBuilder.exportSymbols("SNIA-SML-MIB", subChassis_SerialNumber=subChassis_SerialNumber, fCPort_Caption=fCPort_Caption, libraryOpStatusChangedTrap=libraryOpStatusChangedTrap, mediaAccessDevice_Availability=mediaAccessDevice_Availability, storageLibraryGroup=storageLibraryGroup, fCPortController_OperationalStatus=fCPortController_OperationalStatus, scsiProtocolController_Realizes_MediaAccessDeviceIndex=scsiProtocolController_Realizes_MediaAccessDeviceIndex, limitedAccessPort_ElementName=limitedAccessPort_ElementName, numberOfChangerDevices=numberOfChangerDevices, numberOfStorageMediaLocations=numberOfStorageMediaLocations, trapChangerAlertSummary=trapChangerAlertSummary, trapPerceivedSeverity=trapPerceivedSeverity, changerDeviceEntry=changerDeviceEntry, product_ElementName=product_ElementName, storageMediaLocation_LocationCoordinates=storageMediaLocation_LocationCoordinates, storageLibrary_Name=storageLibrary_Name, numberOfMediaAccessDevices=numberOfMediaAccessDevices, computerSystem_ElementName=computerSystem_ElementName, physicalPackageIndex=physicalPackageIndex, changerDevice_ElementName=changerDevice_ElementName, mediaAccessDevice_Name=mediaAccessDevice_Name, limitedAccessPortTable=limitedAccessPortTable, numberOfSoftwareElements=numberOfSoftwareElements, mediaAccessDevice_TotalPowerOnHours=mediaAccessDevice_TotalPowerOnHours, subChassis_IsLocked=subChassis_IsLocked, chassis_Manufacturer=chassis_Manufacturer, storageMediaLocation_PhysicalMedia_Replaceable=storageMediaLocation_PhysicalMedia_Replaceable, mediaAccessDeviceIndex=mediaAccessDeviceIndex, fCPort_PermanentAddress=fCPort_PermanentAddress, experimental=experimental, scsiProtocolController_Realizes_ChangerDeviceIndex=scsiProtocolController_Realizes_ChangerDeviceIndex, storageMediaLocation_PhysicalMedia_MediaDescription=storageMediaLocation_PhysicalMedia_MediaDescription, softwareElementTable=softwareElementTable, fCPortIndex=fCPortIndex, scsiProtocolController_Availability=scsiProtocolController_Availability, softwareElement_Manufacturer=softwareElement_Manufacturer, subChassis_ElementName=subChassis_ElementName, numberOffCPorts=numberOffCPorts, softwareElement_CodeSet=softwareElement_CodeSet, physicalPackageEntry=physicalPackageEntry, softwareElement_Name=softwareElement_Name, UINT64=UINT64, softwareElement_SoftwareElementID=softwareElement_SoftwareElementID, scsiProtocolController_Description=scsiProtocolController_Description, snia=snia, softwareElementEntry=softwareElementEntry, subChassisEntry=subChassisEntry, physicalMediaDeletedTrap=physicalMediaDeletedTrap, scsiProtocolController_DeviceID=scsiProtocolController_DeviceID, storageMediaLocation_LocationType=storageMediaLocation_LocationType, storageMediaLocation_PhysicalMedia_MediaType=storageMediaLocation_PhysicalMedia_MediaType, changerDevice_Realizes_StorageLocationIndex=changerDevice_Realizes_StorageLocationIndex, limitedAccessPortIndex=limitedAccessPortIndex, numberOfTrapDestinations=numberOfTrapDestinations, libraryAddedTrap=libraryAddedTrap, changerDevice_Description=changerDevice_Description, storageMediaLocationTable=storageMediaLocationTable, scsiProtocolControllerIndex=scsiProtocolControllerIndex, trapsEnabled=trapsEnabled, subChassis_SecurityBreach=subChassis_SecurityBreach, product_Name=product_Name, storageMediaLocation_PhysicalMedia_DualSided=storageMediaLocation_PhysicalMedia_DualSided, storageMediaLocation_PhysicalMedia_Tag=storageMediaLocation_PhysicalMedia_Tag, mediaAccessDevice_Realizes_StorageLocationIndex=mediaAccessDevice_Realizes_StorageLocationIndex, subChassis_Tag=subChassis_Tag, mediaAccessDevice_NeedsCleaning=mediaAccessDevice_NeedsCleaning, trapDestinationPort=trapDestinationPort, driveAddedTrap=driveAddedTrap, numberOfPhysicalMedias=numberOfPhysicalMedias, changerDeviceTable=changerDeviceTable, UINT32=UINT32, product_Version=product_Version, limitedAccessPort_Extended=limitedAccessPort_Extended, storageMediaLocation_PhysicalMedia_PhysicalLabel=storageMediaLocation_PhysicalMedia_PhysicalLabel, storageMediaLocation_PhysicalMedia_HotSwappable=storageMediaLocation_PhysicalMedia_HotSwappable, CimDateTime=CimDateTime, physicalPackageTable=physicalPackageTable, softwareElement_BuildNumber=softwareElement_BuildNumber, chassisGroup=chassisGroup, changerDevice_MediaFlipSupported=changerDevice_MediaFlipSupported, storageMediaLocationGroup=storageMediaLocationGroup, changerAlert=changerAlert, physicalPackage_Model=physicalPackage_Model, subChassisTable=subChassisTable, storageLibrary_Status=storageLibrary_Status, physicalPackageGroup=physicalPackageGroup, fCPort_ElementName=fCPort_ElementName, endOfSmlMib=endOfSmlMib, changerDevice_DeviceID=changerDevice_DeviceID, numberOflimitedAccessPorts=numberOflimitedAccessPorts, computerSystem_Description=computerSystem_Description, subChassis_LockPresent=subChassis_LockPresent, scsiProtocolControllerGroup=scsiProtocolControllerGroup, limitedAccessPortEntry=limitedAccessPortEntry, mediaAccessDevice_OperationalStatus=mediaAccessDevice_OperationalStatus, currentOperationalStatus=currentOperationalStatus, driveAlert=driveAlert, storageLibrary_Caption=storageLibrary_Caption, computerSystem_PrimaryOwnerName=computerSystem_PrimaryOwnerName, smlMibVersion=smlMibVersion, storageLibrary_Description=storageLibrary_Description, changerDeviceIndex=changerDeviceIndex, storageMediaLocationIndex=storageMediaLocationIndex, fCPortTable=fCPortTable, UINT16=UINT16, chassis_ElementName=chassis_ElementName, fCPortGroup=fCPortGroup, storageMediaLocation_MediaCapacity=storageMediaLocation_MediaCapacity, computerSystem_OperationalStatus=computerSystem_OperationalStatus, UShortReal=UShortReal, mediaAccessDeviceObjectType=mediaAccessDeviceObjectType, softwareElementGroup=softwareElementGroup, softwareElement_Version=softwareElement_Version, storageMediaLocation_MediaTypesSupported=storageMediaLocation_MediaTypesSupported, limitedAccessPortGroup=limitedAccessPortGroup, computerSystem_Realizes_softwareElementIndex=computerSystem_Realizes_softwareElementIndex, oldOperationalStatus=oldOperationalStatus, limitedAccessPort_Realizes_StorageLocationIndex=limitedAccessPort_Realizes_StorageLocationIndex, libraryDeletedTrap=libraryDeletedTrap, changerDeviceGroup=changerDeviceGroup, trap_Association_ChangerDeviceIndex=trap_Association_ChangerDeviceIndex, trapDestinationEntry=trapDestinationEntry, physicalPackage_Manufacturer=physicalPackage_Manufacturer, storageMediaLocationEntry=storageMediaLocationEntry, fCPort_DeviceID=fCPort_DeviceID, mediaAccessDevice_PowerOnHours=mediaAccessDevice_PowerOnHours, product_IdentifyingNumber=product_IdentifyingNumber, subChassis_Manufacturer=subChassis_Manufacturer, mediaAccessDevice_DeviceID=mediaAccessDevice_DeviceID, chassis_LockPresent=chassis_LockPresent, physicalPackage_SerialNumber=physicalPackage_SerialNumber, computerSystem_Dedicated=computerSystem_Dedicated, physicalPackage_Realizes_MediaAccessDeviceIndex=physicalPackage_Realizes_MediaAccessDeviceIndex, fCPortEntry=fCPortEntry, subChassis_OperationalStatus=subChassis_OperationalStatus, mediaAccessDevice_MountCount=mediaAccessDevice_MountCount, limitedAccessPort_Caption=limitedAccessPort_Caption, limitedAccessPort_Description=limitedAccessPort_Description, numberOfsubChassis=numberOfsubChassis, storageMediaLocation_PhysicalMediaPresent=storageMediaLocation_PhysicalMediaPresent, trapDestinationTable=trapDestinationTable, product_Vendor=product_Vendor, storageMediaLocation_PhysicalMedia_CleanerMedia=storageMediaLocation_PhysicalMedia_CleanerMedia, driveOpStatusChangedTrap=driveOpStatusChangedTrap, numberOfPhysicalPackages=numberOfPhysicalPackages, softwareElementIndex=softwareElementIndex, smlCimVersion=smlCimVersion, trap_Association_MediaAccessDeviceIndex=trap_Association_MediaAccessDeviceIndex, mediaAccessDevice_Realizes_softwareElementIndex=mediaAccessDevice_Realizes_softwareElementIndex, driveDeletedTrap=driveDeletedTrap, chassis_Model=chassis_Model, libraries=libraries, trapDriveAlertSummary=trapDriveAlertSummary, chassis_SerialNumber=chassis_SerialNumber, softwareElement_IdentificationCode=softwareElement_IdentificationCode, computerSystem_Caption=computerSystem_Caption, common=common, computerSystem_Name=computerSystem_Name, trapDestinationHostAddr=trapDestinationHostAddr, scsiProtocolController_OperationalStatus=scsiProtocolController_OperationalStatus, physicalMediaAddedTrap=physicalMediaAddedTrap, chassis_IsLocked=chassis_IsLocked, limitedAccessPort_DeviceID=limitedAccessPort_DeviceID, changerDevice_Caption=changerDevice_Caption, computerSystemGroup=computerSystemGroup, physicalPackage_Tag=physicalPackage_Tag, smlRoot=smlRoot, computerSystem_PrimaryOwnerContact=computerSystem_PrimaryOwnerContact, scsiProtocolControllerEntry=scsiProtocolControllerEntry, fCPort_Description=fCPort_Description, subChassis_Model=subChassis_Model, computerSystem_NameFormat=computerSystem_NameFormat, chassis_SecurityBreach=chassis_SecurityBreach, mediaAccessDeviceEntry=mediaAccessDeviceEntry, softwareElement_LanguageEdition=softwareElement_LanguageEdition, changerDevice_OperationalStatus=changerDevice_OperationalStatus, mediaAccessDeviceTable=mediaAccessDeviceTable, subChassisIndex=subChassisIndex, changerAddedTrap=changerAddedTrap, trapGroup=trapGroup, storageMediaLocation_PhysicalMedia_Capacity=storageMediaLocation_PhysicalMedia_Capacity, storageMediaLocation_PhysicalMedia_Removable=storageMediaLocation_PhysicalMedia_Removable, changerDevice_Availability=changerDevice_Availability, chassis_Tag=chassis_Tag, trapDestinationHostType=trapDestinationHostType, softwareElement_SerialNumber=softwareElement_SerialNumber, mediaAccessDeviceGroup=mediaAccessDeviceGroup, storageMediaLocation_Association_ChangerDeviceIndex=storageMediaLocation_Association_ChangerDeviceIndex, subChassis_PackageType=subChassis_PackageType, mediaAccessDevice_Status=mediaAccessDevice_Status, softwareElement_InstanceID=softwareElement_InstanceID, changerOpStatusChangedTrap=changerOpStatusChangedTrap, storageMediaLocation_Tag=storageMediaLocation_Tag, scsiProtocolControllerTable=scsiProtocolControllerTable, changerDeletedTrap=changerDeletedTrap, trapObjects=trapObjects, productGroup=productGroup, numberOfSCSIProtocolControllers=numberOfSCSIProtocolControllers, scsiProtocolController_ElementName=scsiProtocolController_ElementName, storageLibrary_InstallDate=storageLibrary_InstallDate, fCPort_Realizes_scsiProtocolControllerIndex=fCPort_Realizes_scsiProtocolControllerIndex)
