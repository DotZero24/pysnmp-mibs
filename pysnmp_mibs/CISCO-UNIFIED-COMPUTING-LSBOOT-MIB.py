...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-LSBOOT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:30:45 2025
...
cucsLsbootEFIShellTable = _CucsLsbootEFIShellTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 29)
)
if mibBuilder.loadTexts:
    cucsLsbootEFIShellTable.setStatus("current")
_CucsLsbootEFIShellEntry_Object = MibTableRow
cucsLsbootEFIShellEntry = _CucsLsbootEFIShellEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 29, 1)
)
cucsLsbootEFIShellEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-LSBOOT-MIB", "cucsLsbootEFIShellInstanceId"),
)
if mibBuilder.loadTexts:
    cucsLsbootEFIShellEntry.setStatus("current")
_CucsLsbootEFIShellInstanceId_Type = CucsManagedObjectId
_CucsLsbootEFIShellInstanceId_Object = MibTableColumn
cucsLsbootEFIShellInstanceId = _CucsLsbootEFIShellInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 29, 1, 1),
    _CucsLsbootEFIShellInstanceId_Type()
)
cucsLsbootEFIShellInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsLsbootEFIShellInstanceId.setStatus("current")
_CucsLsbootEFIShellDn_Type = CucsManagedObjectDn
_CucsLsbootEFIShellDn_Object = MibTableColumn
cucsLsbootEFIShellDn = _CucsLsbootEFIShellDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 29, 1, 2),
    _CucsLsbootEFIShellDn_Type()
)
cucsLsbootEFIShellDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootEFIShellDn.setStatus("current")
_CucsLsbootEFIShellRn_Type = SnmpAdminString
_CucsLsbootEFIShellRn_Object = MibTableColumn
cucsLsbootEFIShellRn = _CucsLsbootEFIShellRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 29, 1, 3),
    _CucsLsbootEFIShellRn_Type()
)
cucsLsbootEFIShellRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootEFIShellRn.setStatus("current")
_CucsLsbootEFIShellAccess_Type = CucsLsbootEFIShellAccess
_CucsLsbootEFIShellAccess_Object = MibTableColumn
cucsLsbootEFIShellAccess = _CucsLsbootEFIShellAccess_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 29, 1, 4),
    _CucsLsbootEFIShellAccess_Type()
)
cucsLsbootEFIShellAccess.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootEFIShellAccess.setStatus("current")
_CucsLsbootEFIShellOrder_Type = Gauge32
_CucsLsbootEFIShellOrder_Object = MibTableColumn
cucsLsbootEFIShellOrder = _CucsLsbootEFIShellOrder_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 29, 1, 5),
    _CucsLsbootEFIShellOrder_Type()
)
cucsLsbootEFIShellOrder.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootEFIShellOrder.setStatus("current")
_CucsLsbootEFIShellType_Type = CucsLsbootEFIShellType
_CucsLsbootEFIShellType_Object = MibTableColumn
cucsLsbootEFIShellType = _CucsLsbootEFIShellType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 29, 1, 6),
    _CucsLsbootEFIShellType_Type()
)
cucsLsbootEFIShellType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootEFIShellType.setStatus("current")
_CucsLsbootNvmeTable_Object = MibTable
cucsLsbootNvmeTable = _CucsLsbootNvmeTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 30)
)
if mibBuilder.loadTexts:
    cucsLsbootNvmeTable.setStatus("current")
_CucsLsbootNvmeEntry_Object = MibTableRow
cucsLsbootNvmeEntry = _CucsLsbootNvmeEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 30, 1)
)
cucsLsbootNvmeEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-LSBOOT-MIB", "cucsLsbootNvmeInstanceId"),
)
if mibBuilder.loadTexts:
    cucsLsbootNvmeEntry.setStatus("current")
_CucsLsbootNvmeInstanceId_Type = CucsManagedObjectId
_CucsLsbootNvmeInstanceId_Object = MibTableColumn
cucsLsbootNvmeInstanceId = _CucsLsbootNvmeInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 30, 1, 1),
    _CucsLsbootNvmeInstanceId_Type()
)
cucsLsbootNvmeInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsLsbootNvmeInstanceId.setStatus("current")
_CucsLsbootNvmeDn_Type = CucsManagedObjectDn
_CucsLsbootNvmeDn_Object = MibTableColumn
cucsLsbootNvmeDn = _CucsLsbootNvmeDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 30, 1, 2),
    _CucsLsbootNvmeDn_Type()
)
cucsLsbootNvmeDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmeDn.setStatus("current")
_CucsLsbootNvmeRn_Type = SnmpAdminString
_CucsLsbootNvmeRn_Object = MibTableColumn
cucsLsbootNvmeRn = _CucsLsbootNvmeRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 30, 1, 3),
    _CucsLsbootNvmeRn_Type()
)
cucsLsbootNvmeRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmeRn.setStatus("current")
_CucsLsbootNvmeOrder_Type = Gauge32
_CucsLsbootNvmeOrder_Object = MibTableColumn
cucsLsbootNvmeOrder = _CucsLsbootNvmeOrder_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 30, 1, 4),
    _CucsLsbootNvmeOrder_Type()
)
cucsLsbootNvmeOrder.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmeOrder.setStatus("current")
_CucsLsbootNvmeType_Type = CucsLsbootNvmeType
_CucsLsbootNvmeType_Object = MibTableColumn
cucsLsbootNvmeType = _CucsLsbootNvmeType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 30, 1, 5),
    _CucsLsbootNvmeType_Type()
)
cucsLsbootNvmeType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmeType.setStatus("current")
_CucsLsbootNvmeDiskSsdTable_Object = MibTable
cucsLsbootNvmeDiskSsdTable = _CucsLsbootNvmeDiskSsdTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 31)
)
if mibBuilder.loadTexts:
    cucsLsbootNvmeDiskSsdTable.setStatus("current")
_CucsLsbootNvmeDiskSsdEntry_Object = MibTableRow
cucsLsbootNvmeDiskSsdEntry = _CucsLsbootNvmeDiskSsdEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 31, 1)
)
cucsLsbootNvmeDiskSsdEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-LSBOOT-MIB", "cucsLsbootNvmeDiskSsdInstanceId"),
)
if mibBuilder.loadTexts:
    cucsLsbootNvmeDiskSsdEntry.setStatus("current")
_CucsLsbootNvmeDiskSsdInstanceId_Type = CucsManagedObjectId
_CucsLsbootNvmeDiskSsdInstanceId_Object = MibTableColumn
cucsLsbootNvmeDiskSsdInstanceId = _CucsLsbootNvmeDiskSsdInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 31, 1, 1),
    _CucsLsbootNvmeDiskSsdInstanceId_Type()
)
cucsLsbootNvmeDiskSsdInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsLsbootNvmeDiskSsdInstanceId.setStatus("current")
_CucsLsbootNvmeDiskSsdDn_Type = CucsManagedObjectDn
_CucsLsbootNvmeDiskSsdDn_Object = MibTableColumn
cucsLsbootNvmeDiskSsdDn = _CucsLsbootNvmeDiskSsdDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 31, 1, 2),
    _CucsLsbootNvmeDiskSsdDn_Type()
)
cucsLsbootNvmeDiskSsdDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmeDiskSsdDn.setStatus("current")
_CucsLsbootNvmeDiskSsdRn_Type = SnmpAdminString
_CucsLsbootNvmeDiskSsdRn_Object = MibTableColumn
cucsLsbootNvmeDiskSsdRn = _CucsLsbootNvmeDiskSsdRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 31, 1, 3),
    _CucsLsbootNvmeDiskSsdRn_Type()
)
cucsLsbootNvmeDiskSsdRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmeDiskSsdRn.setStatus("current")
_CucsLsbootNvmeDiskSsdOrder_Type = Gauge32
_CucsLsbootNvmeDiskSsdOrder_Object = MibTableColumn
cucsLsbootNvmeDiskSsdOrder = _CucsLsbootNvmeDiskSsdOrder_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 31, 1, 4),
    _CucsLsbootNvmeDiskSsdOrder_Type()
)
cucsLsbootNvmeDiskSsdOrder.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmeDiskSsdOrder.setStatus("current")
_CucsLsbootNvmeDiskSsdSlotId_Type = Gauge32
_CucsLsbootNvmeDiskSsdSlotId_Object = MibTableColumn
cucsLsbootNvmeDiskSsdSlotId = _CucsLsbootNvmeDiskSsdSlotId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 31, 1, 5),
    _CucsLsbootNvmeDiskSsdSlotId_Type()
)
cucsLsbootNvmeDiskSsdSlotId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmeDiskSsdSlotId.setStatus("current")
_CucsLsbootNvmeDiskSsdType_Type = CucsLsbootNvmeDiskSsdType
_CucsLsbootNvmeDiskSsdType_Object = MibTableColumn
cucsLsbootNvmeDiskSsdType = _CucsLsbootNvmeDiskSsdType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 31, 1, 6),
    _CucsLsbootNvmeDiskSsdType_Type()
)
cucsLsbootNvmeDiskSsdType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmeDiskSsdType.setStatus("current")
_CucsLsbootNvmePciSsdTable_Object = MibTable
cucsLsbootNvmePciSsdTable = _CucsLsbootNvmePciSsdTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 32)
)
if mibBuilder.loadTexts:
    cucsLsbootNvmePciSsdTable.setStatus("current")
_CucsLsbootNvmePciSsdEntry_Object = MibTableRow
cucsLsbootNvmePciSsdEntry = _CucsLsbootNvmePciSsdEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 32, 1)
)
cucsLsbootNvmePciSsdEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-LSBOOT-MIB", "cucsLsbootNvmePciSsdInstanceId"),
)
if mibBuilder.loadTexts:
    cucsLsbootNvmePciSsdEntry.setStatus("current")
_CucsLsbootNvmePciSsdInstanceId_Type = CucsManagedObjectId
_CucsLsbootNvmePciSsdInstanceId_Object = MibTableColumn
cucsLsbootNvmePciSsdInstanceId = _CucsLsbootNvmePciSsdInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 32, 1, 1),
    _CucsLsbootNvmePciSsdInstanceId_Type()
)
cucsLsbootNvmePciSsdInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsLsbootNvmePciSsdInstanceId.setStatus("current")
_CucsLsbootNvmePciSsdDn_Type = CucsManagedObjectDn
_CucsLsbootNvmePciSsdDn_Object = MibTableColumn
cucsLsbootNvmePciSsdDn = _CucsLsbootNvmePciSsdDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 32, 1, 2),
    _CucsLsbootNvmePciSsdDn_Type()
)
cucsLsbootNvmePciSsdDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmePciSsdDn.setStatus("current")
_CucsLsbootNvmePciSsdRn_Type = SnmpAdminString
_CucsLsbootNvmePciSsdRn_Object = MibTableColumn
cucsLsbootNvmePciSsdRn = _CucsLsbootNvmePciSsdRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 32, 1, 3),
    _CucsLsbootNvmePciSsdRn_Type()
)
cucsLsbootNvmePciSsdRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmePciSsdRn.setStatus("current")
_CucsLsbootNvmePciSsdOrder_Type = Gauge32
_CucsLsbootNvmePciSsdOrder_Object = MibTableColumn
cucsLsbootNvmePciSsdOrder = _CucsLsbootNvmePciSsdOrder_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 32, 1, 4),
    _CucsLsbootNvmePciSsdOrder_Type()
)
cucsLsbootNvmePciSsdOrder.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmePciSsdOrder.setStatus("current")
_CucsLsbootNvmePciSsdSlotId_Type = Gauge32
_CucsLsbootNvmePciSsdSlotId_Object = MibTableColumn
cucsLsbootNvmePciSsdSlotId = _CucsLsbootNvmePciSsdSlotId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 32, 1, 5),
    _CucsLsbootNvmePciSsdSlotId_Type()
)
cucsLsbootNvmePciSsdSlotId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmePciSsdSlotId.setStatus("current")
_CucsLsbootNvmePciSsdType_Type = CucsLsbootNvmePciSsdType
_CucsLsbootNvmePciSsdType_Object = MibTableColumn
cucsLsbootNvmePciSsdType = _CucsLsbootNvmePciSsdType_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 27, 32, 1, 6),
    _CucsLsbootNvmePciSsdType_Type()
)
cucsLsbootNvmePciSsdType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsLsbootNvmePciSsdType.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsLsbootObjects": cucsLsbootObjects,
       ...
       "cucsLsbootEFIShellTable": cucsLsbootEFIShellTable,
       "cucsLsbootEFIShellEntry": cucsLsbootEFIShellEntry,
       "cucsLsbootEFIShellInstanceId": cucsLsbootEFIShellInstanceId,
       "cucsLsbootEFIShellDn": cucsLsbootEFIShellDn,
       "cucsLsbootEFIShellRn": cucsLsbootEFIShellRn,
       "cucsLsbootEFIShellAccess": cucsLsbootEFIShellAccess,
       "cucsLsbootEFIShellOrder": cucsLsbootEFIShellOrder,
       "cucsLsbootEFIShellType": cucsLsbootEFIShellType,
       "cucsLsbootNvmeTable": cucsLsbootNvmeTable,
       "cucsLsbootNvmeEntry": cucsLsbootNvmeEntry,
       "cucsLsbootNvmeInstanceId": cucsLsbootNvmeInstanceId,
       "cucsLsbootNvmeDn": cucsLsbootNvmeDn,
       "cucsLsbootNvmeRn": cucsLsbootNvmeRn,
       "cucsLsbootNvmeOrder": cucsLsbootNvmeOrder,
       "cucsLsbootNvmeType": cucsLsbootNvmeType,
       "cucsLsbootNvmeDiskSsdTable": cucsLsbootNvmeDiskSsdTable,
       "cucsLsbootNvmeDiskSsdEntry": cucsLsbootNvmeDiskSsdEntry,
       "cucsLsbootNvmeDiskSsdInstanceId": cucsLsbootNvmeDiskSsdInstanceId,
       "cucsLsbootNvmeDiskSsdDn": cucsLsbootNvmeDiskSsdDn,
       "cucsLsbootNvmeDiskSsdRn": cucsLsbootNvmeDiskSsdRn,
       ...
       "cucsLsbootNvmePciSsdTable": cucsLsbootNvmePciSsdTable,
       "cucsLsbootNvmePciSsdEntry": cucsLsbootNvmePciSsdEntry,
       "cucsLsbootNvmePciSsdInstanceId": cucsLsbootNvmePciSsdInstanceId,
       "cucsLsbootNvmePciSsdDn": cucsLsbootNvmePciSsdDn,
       "cucsLsbootNvmePciSsdRn": cucsLsbootNvmePciSsdRn,
       "cucsLsbootNvmePciSsdOrder": cucsLsbootNvmePciSsdOrder,
       "cucsLsbootNvmePciSsdSlotId": cucsLsbootNvmePciSsdSlotId,
