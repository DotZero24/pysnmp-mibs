...
mibBuilder.exportSymbols("CISCO-MPLS-TC-EXT-STD-MIB", CMplsIccId=CMplsIccId, CMplsLocalId=CMplsLocalId, CMplsNodeId=CMplsNodeId, PYSNMP_MODULE_ID=cmplsTcExtStdMIB, CMplsGlobalId=CMplsGlobalId, cmplsTcExtStdMIB=cmplsTcExtStdMIB)
