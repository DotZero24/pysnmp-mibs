...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-SECURITY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:35:04 2025
...
mySecurityAddressMIBGroup.setObjects(
      *(("MY-SECURITY-MIB", "mySecurityAddressFdbId"),
        ("MY-SECURITY-MIB", "mySecurityAddressAddress"),
        ("MY-SECURITY-MIB", "mySecurityAddressPort"),
        ("MY-SECURITY-MIB", "mySecurityAddressIpAddr"),
        ...
        ("MY-SECURITY-MIB", "myBindAddressIpAddr"),
...
mySecurityMIBCompliance.setObjects(
      *(("MY-SECURITY-MIB", "myUserManageMIBGroup"),
        ("MY-SECURITY-MIB", "mySecurityAddressMIBGroup"),
        ("MY-SECURITY-MIB", "myPortSecurityMIBGroup"))
)
if mibBuilder.loadTexts:
