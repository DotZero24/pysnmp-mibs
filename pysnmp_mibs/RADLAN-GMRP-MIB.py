...
rlGmrpSupported=_RlGmrpSupported_Object((1,3,6,1,4,1,89,75,1),_RlGmrpSupported_Type())
...
rlGmrpMibVersion=_RlGmrpMibVersion_Object((1,3,6,1,4,1,89,75,2),_RlGmrpMibVersion_Type())
...
rlPortGmrpTimersTable=_RlPortGmrpTimersTable_Object((1,3,6,1,4,1,89,75,3))
if mibBuilder.loadTexts:rlPortGmrpTimersTable.setStatus(_A)
_RlPortGmrpTimersEntry_Object=MibTableRow
rlPortGmrpTimersEntry=_RlPortGmrpTimersEntry_Object((1,3,6,1,4,1,89,75,3,1))
...
rlPortGmrpJoinTime=_RlPortGmrpJoinTime_Object((1,3,6,1,4,1,89,75,3,1,1),_RlPortGmrpJoinTime_Type())
...
rlPortGmrpLeaveTime=_RlPortGmrpLeaveTime_Object((1,3,6,1,4,1,89,75,3,1,2),_RlPortGmrpLeaveTime_Type())
...
rlPortGmrpLeaveAllTime=_RlPortGmrpLeaveAllTime_Object((1,3,6,1,4,1,89,75,3,1,3),_RlPortGmrpLeaveAllTime_Type())
...
rlPortGmrpOverrideGarp=_RlPortGmrpOverrideGarp_Object((1,3,6,1,4,1,89,75,3,1,4),_RlPortGmrpOverrideGarp_Type())
...
rlGmrpVlanTable=_RlGmrpVlanTable_Object((1,3,6,1,4,1,89,75,4))
if mibBuilder.loadTexts:rlGmrpVlanTable.setStatus(_A)
_RlGmrpVlanEntry_Object=MibTableRow
rlGmrpVlanEntry=_RlGmrpVlanEntry_Object((1,3,6,1,4,1,89,75,4,1))
...
rlGmrpVlanTag=_RlGmrpVlanTag_Object((1,3,6,1,4,1,89,75,4,1,1),_RlGmrpVlanTag_Type())
...
rlGmrpVlanEnable=_RlGmrpVlanEnable_Object((1,3,6,1,4,1,89,75,4,1,2),_RlGmrpVlanEnable_Type())
