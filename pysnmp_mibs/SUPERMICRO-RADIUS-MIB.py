...
radiusExtClient=_RadiusExtClient_ObjectIdentity((1,3,6,1,4,1,10876,101,1,25,1))
_RadiusExtDebugMask_Type=Integer32
_RadiusExtDebugMask_Object=MibScalar
radiusExtDebugMask=_RadiusExtDebugMask_Object((1,3,6,1,4,1,10876,101,1,25,1,1),_RadiusExtDebugMask_Type())
...
radiusMaxNoOfUserEntries=_RadiusMaxNoOfUserEntries_Object((1,3,6,1,4,1,10876,101,1,25,1,2),_RadiusMaxNoOfUserEntries_Type())
...
radiusExtServerTable=_RadiusExtServerTable_Object((1,3,6,1,4,1,10876,101,1,25,1,3))
if mibBuilder.loadTexts:radiusExtServerTable.setStatus(_A)
_RadiusExtServerEntry_Object=MibTableRow
radiusExtServerEntry=_RadiusExtServerEntry_Object((1,3,6,1,4,1,10876,101,1,25,1,3,1))
...
radiusExtServerIndex=_RadiusExtServerIndex_Object((1,3,6,1,4,1,10876,101,1,25,1,3,1,1),_RadiusExtServerIndex_Type())
...
radiusExtServerAddress=_RadiusExtServerAddress_Object((1,3,6,1,4,1,10876,101,1,25,1,3,1,2),_RadiusExtServerAddress_Type())
...
radiusExtServerType=_RadiusExtServerType_Object((1,3,6,1,4,1,10876,101,1,25,1,3,1,3),_RadiusExtServerType_Type())
...
radiusExtServerSharedSecret=_RadiusExtServerSharedSecret_Object((1,3,6,1,4,1,10876,101,1,25,1,3,1,4),_RadiusExtServerSharedSecret_Type())
...
radiusExtServerEnabled=_RadiusExtServerEnabled_Object((1,3,6,1,4,1,10876,101,1,25,1,3,1,5),_RadiusExtServerEnabled_Type())
...
radiusExtServerResponseTime=_RadiusExtServerResponseTime_Object((1,3,6,1,4,1,10876,101,1,25,1,3,1,6),_RadiusExtServerResponseTime_Type())
...
radiusExtServerMaximumRetransmission=_RadiusExtServerMaximumRetransmission_Object((1,3,6,1,4,1,10876,101,1,25,1,3,1,7),_RadiusExtServerMaximumRetransmission_Type())
...
radiusExtServerEntryStatus=_RadiusExtServerEntryStatus_Object((1,3,6,1,4,1,10876,101,1,25,1,3,1,8),_RadiusExtServerEntryStatus_Type())
