...
# Notes
# -----
# ASN.1 source file://mibs/nortel/QOS-POLICY-IP-PIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:18:43 2025
...
_QosInterfaceTypeStorageType_Type.__name__ = "StorageType"
...
_QosIfQueueStorageType_Type.__name__ = "StorageType"
...
_QosIfDscpAssignmentStorageType_Type.__name__ = "StorageType"
...
_QosMeterStorageType_Type.__name__ = "StorageType"
...
_QosActionStorageType_Type.__name__ = "StorageType"
...
_QosTargetStorageType_Type.__name__ = "StorageType"
...
_QosTargetShapingParams_Type.__name__ = "PolicyInstanceIdOrZero"
...
_QosTargetShapingGroup_Type.__name__ = "Unsigned32"
...
_QosTargetInProfileAction_Type.__name__ = "PolicyInstanceIdOrZero"
...
_QosTargetOutOfProfileAction_Type.__name__ = "PolicyInstanceIdOrZero"
...
class _QosTargetUserGroupSession_Type(Unsigned32):
    """Custom type qosTargetUserGroupSession based on Unsigned32"""
    defaultValue = 0


_QosTargetUserGroupSession_Type.__name__ = "Unsigned32"
_QosTargetUserGroupSession_Object = MibTableColumn
qosTargetUserGroupSession = _QosTargetUserGroupSession_Object(
    (1, 3, 6, 1, 4, 1, 45, 4, 2, 1, 3, 2, 1, 15),
    _QosTargetUserGroupSession_Type()
)
qosTargetUserGroupSession.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    qosTargetUserGroupSession.setStatus("current")
...
_QosIpAceStorageType_Type.__name__ = "StorageType"
...
_QosIpAclDefinitionStorageType_Type.__name__ = "StorageType"
...
qosTargetGroup.setObjects(
      *(("QOS-POLICY-IP-PIB", "qosTargetAclId"),
        ...
        ("QOS-POLICY-IP-PIB", "qosTargetUserGroupSession"))
)
if mibBuilder.loadTexts:
...
qosPolicyIpPibCompliance.setObjects(
      *(("QOS-POLICY-IP-PIB", "qosInterfaceTypeGroup"),
        ("QOS-POLICY-IP-PIB", "qosIfQueueGroup"),
        ("QOS-POLICY-IP-PIB", "qosMeterGroup"),
        ("QOS-POLICY-IP-PIB", "qosActionGroup"),
        ("QOS-POLICY-IP-PIB", "qosTargetGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"Dscp": Dscp,
       ...
       "qosTargetUserGroupSession": qosTargetUserGroupSession,
