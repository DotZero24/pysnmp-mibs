...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/nortel/QOS-POLICY-IP-PIB
...
qosPolicyIpPib.setRevisions(('2004-07-20 00:00',))
if mibBuilder.loadTexts: qosPolicyIpPib.setLastUpdated('200407200000Z')
if mibBuilder.loadTexts: qosPolicyIpPib.setOrganization('IETF RAP WG - Nortel Networks, Inc.')
...
qosMeterDataSpecification = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 4, 2, 1, 2, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("noMeterData", 1), ("committedData", 2), ("peakData", 3), ("committedRestricted", 4)))).setMaxAccess("readcreate")
...
qosTargetUserGroupSession = MibTableColumn((1, 3, 6, 1, 4, 1, 45, 4, 2, 1, 3, 2, 1, 15), Unsigned32()).setMaxAccess("readcreate")
if mibBuilder.loadTexts: qosTargetUserGroupSession.setStatus('current')
...
qosTargetGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 45, 4, 2, 3, 2, 6)).setObjects(("QOS-POLICY-IP-PIB", "qosTargetAclId"), ("QOS-POLICY-IP-PIB", "qosTargetAclType"), ("QOS-POLICY-IP-PIB", "qosTargetInterfaceRoles"), ("QOS-POLICY-IP-PIB", "qosTargetInterfaceDirection"), ("QOS-POLICY-IP-PIB", "qosTargetOrder"), ("QOS-POLICY-IP-PIB", "qosTargetMeter"), ("QOS-POLICY-IP-PIB", "qosTargetStorageType"), ("QOS-POLICY-IP-PIB", "qosTargetStatus"), ("QOS-POLICY-IP-PIB", "qosTargetShapingParams"), ("QOS-POLICY-IP-PIB", "qosTargetShapingGroup"), ("QOS-POLICY-IP-PIB", "qosTargetLabel"), ("QOS-POLICY-IP-PIB", "qosTargetInProfileAction"), ("QOS-POLICY-IP-PIB", "qosTargetOutOfProfileAction"), ("QOS-POLICY-IP-PIB", "qosTargetUserGroupSession"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
mibBuilder.exportSymbols("QOS-POLICY-IP-PIB", qosPolicyIpPibGroups=qosPolicyIpPibGroups, qosActionEntry=qosActionEntry, qosInterfaceTypeEntry=qosInterfaceTypeEntry, qosIpAceDscp=qosIpAceDscp, qosMeterMedConfAction=qosMeterMedConfAction, qosIfQueueIndex=qosIfQueueIndex, qosIfDscpAssignmentDscp=qosIfDscpAssignmentDscp, qosIfDscpAssignmentStorageType=qosIfDscpAssignmentStorageType, qosMeterLowConfAction=qosMeterLowConfAction, qosTargetOutOfProfileAction=qosTargetOutOfProfileAction, qosMeterCommittedRate=qosMeterCommittedRate, Dscp=Dscp, qosIfDscpAssignmentEntry=qosIfDscpAssignmentEntry, qosIpAclDefinitionTable=qosIpAclDefinitionTable, qosIfDscpAssignmentId=qosIfDscpAssignmentId, qosIpAceDstAddrMask=qosIpAceDstAddrMask, qosActionId=qosActionId, qosTargetEntry=qosTargetEntry, qosIfDscpAssignmentRoles=qosIfDscpAssignmentRoles, qosMeterStatus=qosMeterStatus, qosIfDscpAssignmentStatus=qosIfDscpAssignmentStatus, qosMeterHighConfAction=qosMeterHighConfAction, qosActionUpdateDSCP=qosActionUpdateDSCP, qosIpAceSrcL4PortMax=qosIpAceSrcL4PortMax, qosAction=qosAction, qosIfDscpAssignmentGroup=qosIfDscpAssignmentGroup, qosActionLabel=qosActionLabel, qosInterfaceTypeTable=qosInterfaceTypeTable, qosInterfaceTypeId=qosInterfaceTypeId, qosTargetUserGroupSession=qosTargetUserGroupSession, qosIfQueueGroup=qosIfQueueGroup, qosIfParameters=qosIfParameters, qosIfQueueStorageType=qosIfQueueStorageType, qosMeterPeakRate=qosMeterPeakRate, qosIpQos=qosIpQos, qosIpAclDefinitionId=qosIpAclDefinitionId, qosIpAceDstL4PortMin=qosIpAceDstL4PortMin, qosIfQueueAbsBandwidth=qosIfQueueAbsBandwidth, qosMeterPeakBurst=qosMeterPeakBurst, qosIfDscpAssignmentQueue=qosIfDscpAssignmentQueue, qosTargetId=qosTargetId, qosIpAclDefinitionAceOrder=qosIpAclDefinitionAceOrder, qosInterfaceTypeCapabilities=qosInterfaceTypeCapabilities, qosMeterId=qosMeterId, qosIfQueueSetId=qosIfQueueSetId, qosPolicyIpPibConformance=qosPolicyIpPibConformance, qosPolicyIpPibClasses=qosPolicyIpPibClasses, qosIpAclDefinitionLabel=qosIpAclDefinitionLabel, qosIfQueueBandwidthAllocation=qosIfQueueBandwidthAllocation, PolicyInstanceIdOrZero=PolicyInstanceIdOrZero, qosIfQueueEntry=qosIfQueueEntry, qosTargetStatus=qosTargetStatus, qosMeterGroup=qosMeterGroup, qosTargetShapingParams=qosTargetShapingParams, qosInterfaceTypeStatus=qosInterfaceTypeStatus, qosTargetTable=qosTargetTable, qosActionGroup=qosActionGroup, QosInterfaceQueueCount=QosInterfaceQueueCount, qosIfDscpAssignmentTable=qosIfDscpAssignmentTable, qosPolicyIpPibCompliance=qosPolicyIpPibCompliance, qosIpAclDefinitionAclId=qosIpAclDefinitionAclId, qosIpAceSrcAddrMask=qosIpAceSrcAddrMask, qosInterfaceTypeGroup=qosInterfaceTypeGroup, qosIpAclDefinitionEntry=qosIpAclDefinitionEntry, qosMeterTable=qosMeterTable, qosIpAceDstL4PortMax=qosIpAceDstL4PortMax, qosTargetInterfaceRoles=qosTargetInterfaceRoles, qosInterfaceTypeQueueSet=qosInterfaceTypeQueueSet, qosIpAceProtocol=qosIpAceProtocol, qosInterfaceTypeRoles=qosInterfaceTypeRoles, qosIfQueueStatus=qosIfQueueStatus, qosIpAceTable=qosIpAceTable, qosIpAceId=qosIpAceId, qosActionDrop=qosActionDrop, qosIpAclDefinitionStorageType=qosIpAclDefinitionStorageType, qosIfQueueTable=qosIfQueueTable, qosTargetShapingGroup=qosTargetShapingGroup, qosTargetStorageType=qosTargetStorageType, qosTargetInProfileAction=qosTargetInProfileAction, qosMeterLabel=qosMeterLabel, qosMeterEntry=qosMeterEntry, qosMeterStorageType=qosMeterStorageType, qosTargetMeter=qosTargetMeter, PYSNMP_MODULE_ID=qosPolicyIpPib, qosIfQueueServiceOrder=qosIfQueueServiceOrder, qosIpAceGroup=qosIpAceGroup, qosIpAceDstAddr=qosIpAceDstAddr, qosPolicyIpPibCompliances=qosPolicyIpPibCompliances, qosMeter=qosMeter, qosTargetAclId=qosTargetAclId, qosIpAceSrcAddr=qosIpAceSrcAddr, qosIfQueueDrainSize=qosIfQueueDrainSize, qosIpAclDefinitionStatus=qosIpAclDefinitionStatus, qosIpAceEntry=qosIpAceEntry, qosPolicyGenPibClasses=qosPolicyGenPibClasses, qosTargetInterfaceDirection=qosTargetInterfaceDirection, qosIfQueueSize=qosIfQueueSize, qosMeterDataSpecification=qosMeterDataSpecification, qosInterfaceTypeStorageType=qosInterfaceTypeStorageType, qosIpAclDefinitionAceId=qosIpAclDefinitionAceId, qosPolicyIpPib=qosPolicyIpPib, qosTargetAclType=qosTargetAclType, qosIfQueueGenDiscipline=qosIfQueueGenDiscipline, qosIfQueueId=qosIfQueueId, qosActionStatus=qosActionStatus, qosTargetGroup=qosTargetGroup, qosActionStorageType=qosActionStorageType, qosIfQueueExtDiscipline=qosIfQueueExtDiscipline, qosTargetOrder=qosTargetOrder, qosMeterCommittedBurst=qosMeterCommittedBurst, qosActionMeter=qosActionMeter, qosIpAceSrcL4PortMin=qosIpAceSrcL4PortMin, qosIpAcePermit=qosIpAcePermit, qosIpAclDefinitionGroup=qosIpAclDefinitionGroup, qosActionTable=qosActionTable, qosTargetLabel=qosTargetLabel, qosIpAceStorageType=qosIpAceStorageType, qosIpAceStatus=qosIpAceStatus)
