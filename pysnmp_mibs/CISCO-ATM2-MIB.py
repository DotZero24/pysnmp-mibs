...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ATM2-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:35:03 2025
...
ciscoatm2MIBCompliance.setObjects(
      *(("CISCO-ATM2-MIB", "ciscoAtmSwitchServcHostGroup"),
        ("CISCO-ATM2-MIB", "ciscoAtmSwitchServcGroup"))
)
if mibBuilder.loadTexts:
...
ciscoatm2MIBCompliance2.setObjects(
      *(("CISCO-ATM2-MIB", "ciscoAtmSwitchServcHostGroup"),
        ("CISCO-ATM2-MIB", "ciscoAtmSwitchServcHostGroup2"),
        ("CISCO-ATM2-MIB", "ciscoAtmSwitchServcGroup"))
)
if mibBuilder.loadTexts:
