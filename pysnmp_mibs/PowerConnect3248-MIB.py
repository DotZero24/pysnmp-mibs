...
ModuleIdentity, Counter64, internet, Unsigned32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, iso, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "internet", "Unsigned32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "iso", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("PowerConnect3248-MIB", prioIpPortValue=prioIpPortValue, prioIpPrecRestoreDefault=prioIpPrecRestoreDefault, sshDisconnect=sshDisconnect, ipMgt=ipMgt, xstMgt=xstMgt, switchProductId=switchProductId, remoteLogLevel=remoteLogLevel, dell=dell, swServiceTag=swServiceTag, switchOperState=switchOperState, xstInstanceCfgBridgeMaxAge=xstInstanceCfgBridgeMaxAge, ipHttpsState=ipHttpsState, bcastStormPktRate=bcastStormPktRate, netDefaultGateway=netDefaultGateway, prioIpDscpValue=prioIpDscpValue, xstInstancePortState=xstInstancePortState, trapDestMgt=trapDestMgt, consoleMgt=consoleMgt, xstInstanceCfgBridgeHelloTime=xstInstanceCfgBridgeHelloTime, mirrorDestinationPort=mirrorDestinationPort, igmpSnoopQueryInterval=igmpSnoopQueryInterval, prioCopyIpDscp=prioCopyIpDscp, mirrorEntry=mirrorEntry, portSecAction=portSecAction, portType=portType, xstInstancePortDesignatedBridge=xstInstancePortDesignatedBridge, portTable=portTable, bcastStormSampleType=bcastStormSampleType, vlanPortIndex=vlanPortIndex, prioIpPortTable=prioIpPortTable, xstInstanceCfgPathCostMethod=xstInstanceCfgPathCostMethod, swRoleInSystem=swRoleInSystem, mirrorTable=mirrorTable, private=private, powerConnect3248MIBObjects=powerConnect3248MIBObjects, portIndex=portIndex, prioWrrEntry=prioWrrEntry, sshMgt=sshMgt, portTrunkIndex=portTrunkIndex, xstInstancePortTable=xstInstancePortTable, tftpDestFile=tftpDestFile, igmpSnoopRouterStaticVlanIndex=igmpSnoopRouterStaticVlanIndex, radiusServerAddress=radiusServerAddress, enterprises=enterprises, prioIpPortEnableStatus=prioIpPortEnableStatus, swPortSecurityTrap=swPortSecurityTrap, prioCopyIpPort=prioCopyIpPort, staPortOperEdgePort=staPortOperEdgePort, prioIpPrecCos=prioIpPrecCos, xstInstancePortEntry=xstInstancePortEntry, prioWrrWeight=prioWrrWeight, netConfigTable=netConfigTable, igmpSnoopMulticastStaticEntry=igmpSnoopMulticastStaticEntry, xstInstanceCfgEntry=xstInstanceCfgEntry, consoleSilentTime=consoleSilentTime, lacpMgt=lacpMgt, staPortIndex=staPortIndex, remoteLogStatus=remoteLogStatus, sshConnInfoTable=sshConnInfoTable, swMicrocodeVer=swMicrocodeVer, igmpSnoopRouterStaticPorts=igmpSnoopRouterStaticPorts, dellLan=dellLan, vlanIndex=vlanIndex, xstInstancePortPathCost=xstInstancePortPathCost, powerConnect3248Notifications=powerConnect3248Notifications, portCapabilities=portCapabilities, trunkCreation=trunkCreation, staPortEntry=staPortEntry, xstInstancePortInstance=xstInstancePortInstance, prioIpDscpEntry=prioIpDscpEntry, mirrorSourcePort=mirrorSourcePort, prioIpDscpPort=prioIpDscpPort, xstInstanceCfgHelloTime=xstInstanceCfgHelloTime, trapDestEntry=trapDestEntry, sshConnInfoEntry=sshConnInfoEntry, igmpSnoopStatus=igmpSnoopStatus, igmpSnoopMulticastCurrentIpAddress=igmpSnoopMulticastCurrentIpAddress, swIdentifier=swIdentifier, vlanPortEntry=vlanPortEntry, prioIpPrecTable=prioIpPrecTable, xstInstanceCfgRootPort=xstInstanceCfgRootPort, priorityMgt=priorityMgt, swPortNumber=swPortNumber, portSecPortEntry=portSecPortEntry, sshTimeout=sshTimeout, igmpSnoopMulticastCurrentEntry=igmpSnoopMulticastCurrentEntry, igmpSnoopMulticastCurrentTable=igmpSnoopMulticastCurrentTable, xstInstancePortPort=xstInstancePortPort, bcastStormEntry=bcastStormEntry, vlanAddressMethod=vlanAddressMethod, netConfigIPAddress=netConfigIPAddress, swPowerStatusChangeTrap=swPowerStatusChangeTrap, prioIpPortStatus=prioIpPortStatus, trunkPorts=trunkPorts, igmpSnoopMulticastStaticVlanIndex=igmpSnoopMulticastStaticVlanIndex, vlanTable=vlanTable, sshConnMajorVersion=sshConnMajorVersion, igmpSnoopRouterCurrentEntry=igmpSnoopRouterCurrentEntry, ipHttpPort=ipHttpPort, switchMgt=switchMgt, tacacsServerKey=tacacsServerKey, igmpSnoopRouterCurrentPorts=igmpSnoopRouterCurrentPorts, igmpSnoopRouterCurrentVlanIndex=igmpSnoopRouterCurrentVlanIndex, prioIpPrecEntry=prioIpPrecEntry, sshConnEncryptionType=sshConnEncryptionType, powerConnect3248MIB=powerConnect3248MIB, swProdName=swProdName, igmpSnoopQueryMaxResponseTime=igmpSnoopQueryMaxResponseTime, lineMgt=lineMgt, xstInstanceCfgTxHoldCount=xstInstanceCfgTxHoldCount, swChassisServiceTag=swChassisServiceTag, securityMgt=securityMgt, swBootRomVer=swBootRomVer, prioIpDscpTable=prioIpDscpTable, telnetMgt=telnetMgt, igmpSnoopMulticastStaticTable=igmpSnoopMulticastStaticTable, bcastStormOctetRate=bcastStormOctetRate, netConfigUnnumbered=netConfigUnnumbered, telnetExecTimeout=telnetExecTimeout, consoleDataBits=consoleDataBits, mirrorMgt=mirrorMgt, vlanEntry=vlanEntry, remoteLogServerStatus=remoteLogServerStatus, restartConfigFile=restartConfigFile, radiusServerPortNumber=radiusServerPortNumber, trunkStatus=trunkStatus, switchManagementVlan=switchManagementVlan, sysLogHistoryRamLevel=sysLogHistoryRamLevel, igmpSnoopMulticastStaticPorts=igmpSnoopMulticastStaticPorts, restartOpCodeFile=restartOpCodeFile, prioCopy=prioCopy, prioIpDscpRestoreDefault=prioIpDscpRestoreDefault, trunkValidNumber=trunkValidNumber, trapDestTable=trapDestTable, swProdManufacturer=swProdManufacturer, xstInstanceCfgTopChanges=xstInstanceCfgTopChanges, xstInstanceCfgForwardDelay=xstInstanceCfgForwardDelay, swProdDescription=swProdDescription, igmpSnoopMulticastStaticStatus=igmpSnoopMulticastStaticStatus, portSecPortIndex=portSecPortIndex, bcastStormMgt=bcastStormMgt, xstInstancePortForwardTransitions=xstInstancePortForwardTransitions, igmpSnoopRouterStaticStatus=igmpSnoopRouterStaticStatus, xstInstancePortEnable=xstInstancePortEnable, bcastStormPercent=bcastStormPercent, swIndivPowerUnitIndex=swIndivPowerUnitIndex, radiusMgt=radiusMgt, portSecPortTable=portSecPortTable, sshConnMinorVersion=sshConnMinorVersion, lacpPortTable=lacpPortTable, trunkMgt=trunkMgt, remoteLogFacilityType=remoteLogFacilityType, consoleParity=consoleParity, swExpansionSlot2=swExpansionSlot2, sysLogStatus=sysLogStatus, switchNumber=switchNumber, staPortAdminPointToPoint=staPortAdminPointToPoint, vlanPortMode=vlanPortMode, trapDestStatus=trapDestStatus, tftpMgt=tftpMgt, xstInstanceCfgRootCost=xstInstanceCfgRootCost, tftpServer=tftpServer, netConfigEntry=netConfigEntry, portFlowCtrlCfg=portFlowCtrlCfg, portFlowCtrlStatus=portFlowCtrlStatus, igmpSnoopRouterStaticTable=igmpSnoopRouterStaticTable, tacacsMgt=tacacsMgt, prioIpPortEntry=prioIpPortEntry, restartMgt=restartMgt, prioIpPrecPort=prioIpPrecPort, staPortTable=staPortTable, trunkIndex=trunkIndex, mirrorStatus=mirrorStatus, igmpSnoopMulticastCurrentPorts=igmpSnoopMulticastCurrentPorts, portSecPortStatus=portSecPortStatus, portAutonegotiation=portAutonegotiation, netConfigSubnetMask=netConfigSubnetMask, sshServerStatus=sshServerStatus, bcastStormTable=bcastStormTable, trapDestVersion=trapDestVersion, netConfigPrimaryInterface=netConfigPrimaryInterface, swExpansionSlot1=swExpansionSlot1, staTxHoldCount=staTxHoldCount, staProtocolType=staProtocolType, igmpSnoopRouterStaticEntry=igmpSnoopRouterStaticEntry, powerConnect3248TrapsPrefix=powerConnect3248TrapsPrefix, trunkTable=trunkTable, staPortFastForward=staPortFastForward, staPortLongPathCost=staPortLongPathCost, sshServerMinorVersion=sshServerMinorVersion, igmpSnoopMulticastStaticIpAddress=igmpSnoopMulticastStaticIpAddress, netConfigIfIndex=netConfigIfIndex, lacpPortEntry=lacpPortEntry, vlanMgt=vlanMgt, restartControl=restartControl, staPortProtocolMigration=staPortProtocolMigration, prioWrrTrafficClass=prioWrrTrafficClass, remoteLogMgt=remoteLogMgt, swProdUrl=swProdUrl, xstInstanceCfgPriority=xstInstanceCfgPriority, igmpSnoopMgt=igmpSnoopMgt, portMgt=portMgt, xstInstanceCfgIndex=xstInstanceCfgIndex, prioIpPrecDscpStatus=prioIpPrecDscpStatus, switchIndivPowerEntry=switchIndivPowerEntry, sshConnStatus=sshConnStatus, swSerialNumber=swSerialNumber, xstInstanceCfgHoldTime=xstInstanceCfgHoldTime, consolePasswordThreshold=consolePasswordThreshold, mirrorType=mirrorType, igmpSnoopQuerier=igmpSnoopQuerier, xstInstanceCfgTable=xstInstanceCfgTable, lacpPortStatus=lacpPortStatus, xstInstanceCfgTimeSinceTopologyChange=xstInstanceCfgTimeSinceTopologyChange, sshConnID=sshConnID, xstInstanceCfgBridgeForwardDelay=xstInstanceCfgBridgeForwardDelay, prioIpPrecValue=prioIpPrecValue, igmpSnoopQueryTimeout=igmpSnoopQueryTimeout, lacpPortIndex=lacpPortIndex, tftpSrcFile=tftpSrcFile, tftpStatus=tftpStatus, igmpSnoopMulticastCurrentVlanIndex=igmpSnoopMulticastCurrentVlanIndex, ipDhcpRestart=ipDhcpRestart, tacacsServerPortNumber=tacacsServerPortNumber, prioIpPortCos=prioIpPortCos, staMgt=staMgt, PYSNMP_MODULE_ID=powerConnect3248MIB, swProdVersion=swProdVersion, prioIpPortPhysPort=prioIpPortPhysPort, sshServerMajorVersion=sshServerMajorVersion, swHardwareVer=swHardwareVer, telnetPasswordThreshold=telnetPasswordThreshold, netConfigStatus=netConfigStatus, swLoaderVer=swLoaderVer, staPortOperPointToPoint=staPortOperPointToPoint, portEntry=portEntry, bcastStormStatus=bcastStormStatus, trunkMaxId=trunkMaxId, vlanPortTable=vlanPortTable, staSystemStatus=staSystemStatus, igmpSnoopMulticastCurrentStatus=igmpSnoopMulticastCurrentStatus, consoleStopBits=consoleStopBits, swOpCodeVer=swOpCodeVer, ValidStatus=ValidStatus, radiusServerTimeout=radiusServerTimeout, portName=portName, staPortAdminEdgePort=staPortAdminEdgePort, swIndivPowerStatus=swIndivPowerStatus, trunkEntry=trunkEntry, ipHttpsPort=ipHttpsPort, xstInstancePortDesignatedCost=xstInstancePortDesignatedCost, prioIpDscpCos=prioIpDscpCos, radiusServerKey=radiusServerKey, xstInstancePortPriority=xstInstancePortPriority)
mibBuilder.exportSymbols("PowerConnect3248-MIB", xstInstanceCfgDesignatedRoot=xstInstanceCfgDesignatedRoot, xstInstancePortDesignatedPort=xstInstancePortDesignatedPort, sshConnUserName=sshConnUserName, consoleBaudRate=consoleBaudRate, swPowerStatus=swPowerStatus, portSecurityMgt=portSecurityMgt, remoteLogServerTable=remoteLogServerTable, consoleExecTimeout=consoleExecTimeout, radiusServerRetransmit=radiusServerRetransmit, sshAuthRetries=sshAuthRetries, portSpeedDpxStatus=portSpeedDpxStatus, xstInstancePortPortRole=xstInstancePortPortRole, igmpSnoopRouterCurrentStatus=igmpSnoopRouterCurrentStatus, portSpeedDpxCfg=portSpeedDpxCfg, igmpSnoopQueryCount=igmpSnoopQueryCount, swUnitIndex=swUnitIndex, ipHttpState=ipHttpState, switchInfoEntry=switchInfoEntry, powerConnect3248Conformance=powerConnect3248Conformance, swIndivPowerIndex=swIndivPowerIndex, tftpFileType=tftpFileType, prioCopyIpPrec=prioCopyIpPrec, remoteLogServerIp=remoteLogServerIp, switchIndivPowerTable=switchIndivPowerTable, xstInstanceCfgMaxAge=xstInstanceCfgMaxAge, igmpSnoopRouterCurrentTable=igmpSnoopRouterCurrentTable, xstInstancePortDesignatedRoot=xstInstancePortDesignatedRoot, bcastStormIfIndex=bcastStormIfIndex, prioWrrTable=prioWrrTable, tacacsServerAddress=tacacsServerAddress, powerConnect3248Traps=powerConnect3248Traps, staPathCostMethod=staPathCostMethod, sysLogHistoryFlashLevel=sysLogHistoryFlashLevel, remoteLogServerEntry=remoteLogServerEntry, tftpAction=tftpAction, switchInfoTable=switchInfoTable, sysLogMgt=sysLogMgt, igmpSnoopVersion=igmpSnoopVersion, trapDestAddress=trapDestAddress, trapDestCommunity=trapDestCommunity)
