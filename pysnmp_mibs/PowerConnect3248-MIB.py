...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/dell/PowerConnect3248-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:43:41 2025
...
MibIdentifier, NotificationType, Integer32, Bits, Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, internet, ObjectIdentity, Counter32, ModuleIdentity, TimeTicks, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Integer32", "Bits", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "internet", "ObjectIdentity", "Counter32", "ModuleIdentity", "TimeTicks", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("PowerConnect3248-MIB", bcastStormOctetRate=bcastStormOctetRate, sshConnID=sshConnID, remoteLogLevel=remoteLogLevel, dellLan=dellLan, restartMgt=restartMgt, swServiceTag=swServiceTag, securityMgt=securityMgt, igmpSnoopMulticastStaticTable=igmpSnoopMulticastStaticTable, netConfigEntry=netConfigEntry, sshConnMajorVersion=sshConnMajorVersion, staPortFastForward=staPortFastForward, sshConnUserName=sshConnUserName, remoteLogServerIp=remoteLogServerIp, bcastStormPktRate=bcastStormPktRate, restartOpCodeFile=restartOpCodeFile, trunkEntry=trunkEntry, mirrorTable=mirrorTable, trunkIndex=trunkIndex, igmpSnoopMulticastCurrentIpAddress=igmpSnoopMulticastCurrentIpAddress, netConfigSubnetMask=netConfigSubnetMask, sysLogMgt=sysLogMgt, trapDestAddress=trapDestAddress, portFlowCtrlStatus=portFlowCtrlStatus, igmpSnoopMulticastCurrentTable=igmpSnoopMulticastCurrentTable, prioCopyIpPrec=prioCopyIpPrec, dell=dell, portSpeedDpxCfg=portSpeedDpxCfg, tacacsMgt=tacacsMgt, netConfigIPAddress=netConfigIPAddress, swIndivPowerStatus=swIndivPowerStatus, netConfigTable=netConfigTable, netConfigIfIndex=netConfigIfIndex, sshServerStatus=sshServerStatus, swProdVersion=swProdVersion, portType=portType, ipHttpPort=ipHttpPort, ipHttpsState=ipHttpsState, xstInstanceCfgTimeSinceTopologyChange=xstInstanceCfgTimeSinceTopologyChange, portSpeedDpxStatus=portSpeedDpxStatus, switchManagementVlan=switchManagementVlan, igmpSnoopRouterStaticEntry=igmpSnoopRouterStaticEntry, switchProductId=switchProductId, portTable=portTable, lineMgt=lineMgt, lacpPortTable=lacpPortTable, vlanPortEntry=vlanPortEntry, swBootRomVer=swBootRomVer, prioCopyIpDscp=prioCopyIpDscp, remoteLogServerEntry=remoteLogServerEntry, staProtocolType=staProtocolType, staPortIndex=staPortIndex, portSecPortStatus=portSecPortStatus, tftpFileType=tftpFileType, trunkCreation=trunkCreation, igmpSnoopRouterCurrentPorts=igmpSnoopRouterCurrentPorts, portSecPortEntry=portSecPortEntry, swIndivPowerIndex=swIndivPowerIndex, sshAuthRetries=sshAuthRetries, prioIpPortValue=prioIpPortValue, prioWrrTable=prioWrrTable, ipDhcpRestart=ipDhcpRestart, consoleSilentTime=consoleSilentTime, swProdName=swProdName, swIndivPowerUnitIndex=swIndivPowerUnitIndex, portName=portName, xstInstancePortDesignatedRoot=xstInstancePortDesignatedRoot, trapDestVersion=trapDestVersion, radiusServerRetransmit=radiusServerRetransmit, portAutonegotiation=portAutonegotiation, switchInfoTable=switchInfoTable, sysLogStatus=sysLogStatus, staSystemStatus=staSystemStatus, xstInstancePortTable=xstInstancePortTable, prioIpPrecTable=prioIpPrecTable, xstInstancePortPathCost=xstInstancePortPathCost, prioIpPrecCos=prioIpPrecCos, consoleBaudRate=consoleBaudRate, priorityMgt=priorityMgt, mirrorMgt=mirrorMgt, igmpSnoopVersion=igmpSnoopVersion, trapDestCommunity=trapDestCommunity, PYSNMP_MODULE_ID=powerConnect3248MIB, swSerialNumber=swSerialNumber, powerConnect3248MIBObjects=powerConnect3248MIBObjects, xstInstancePortInstance=xstInstancePortInstance, staPortProtocolMigration=staPortProtocolMigration, trunkStatus=trunkStatus, swHardwareVer=swHardwareVer, igmpSnoopStatus=igmpSnoopStatus, igmpSnoopRouterStaticStatus=igmpSnoopRouterStaticStatus, swLoaderVer=swLoaderVer, igmpSnoopQueryInterval=igmpSnoopQueryInterval, igmpSnoopMulticastCurrentPorts=igmpSnoopMulticastCurrentPorts, igmpSnoopRouterCurrentEntry=igmpSnoopRouterCurrentEntry, prioIpPrecDscpStatus=prioIpPrecDscpStatus, igmpSnoopQueryCount=igmpSnoopQueryCount, sshTimeout=sshTimeout, powerConnect3248Notifications=powerConnect3248Notifications, mirrorStatus=mirrorStatus, igmpSnoopMulticastCurrentEntry=igmpSnoopMulticastCurrentEntry, portIndex=portIndex, prioIpDscpPort=prioIpDscpPort, xstInstanceCfgDesignatedRoot=xstInstanceCfgDesignatedRoot, remoteLogFacilityType=remoteLogFacilityType, swProdManufacturer=swProdManufacturer, staPortAdminEdgePort=staPortAdminEdgePort, prioIpPortStatus=prioIpPortStatus, lacpPortStatus=lacpPortStatus, lacpMgt=lacpMgt, igmpSnoopRouterCurrentStatus=igmpSnoopRouterCurrentStatus, staPortTable=staPortTable, staPortEntry=staPortEntry, igmpSnoopRouterCurrentTable=igmpSnoopRouterCurrentTable, sshMgt=sshMgt, sshConnMinorVersion=sshConnMinorVersion, xstInstanceCfgBridgeMaxAge=xstInstanceCfgBridgeMaxAge, xstInstanceCfgPathCostMethod=xstInstanceCfgPathCostMethod, swProdUrl=swProdUrl, igmpSnoopMulticastStaticIpAddress=igmpSnoopMulticastStaticIpAddress, ipHttpsPort=ipHttpsPort, portEntry=portEntry, swOpCodeVer=swOpCodeVer, prioIpDscpValue=prioIpDscpValue, powerConnect3248Conformance=powerConnect3248Conformance, swMicrocodeVer=swMicrocodeVer, vlanPortIndex=vlanPortIndex, xstInstancePortDesignatedBridge=xstInstancePortDesignatedBridge, sshServerMajorVersion=sshServerMajorVersion, remoteLogServerTable=remoteLogServerTable, vlanAddressMethod=vlanAddressMethod, remoteLogStatus=remoteLogStatus, prioIpDscpTable=prioIpDscpTable, bcastStormTable=bcastStormTable, restartConfigFile=restartConfigFile, staPortOperPointToPoint=staPortOperPointToPoint, trunkValidNumber=trunkValidNumber, switchNumber=switchNumber, trunkTable=trunkTable, staPortOperEdgePort=staPortOperEdgePort, xstInstancePortState=xstInstancePortState, swUnitIndex=swUnitIndex, igmpSnoopQueryMaxResponseTime=igmpSnoopQueryMaxResponseTime, consoleParity=consoleParity, switchOperState=switchOperState, xstInstanceCfgPriority=xstInstanceCfgPriority, igmpSnoopMulticastStaticPorts=igmpSnoopMulticastStaticPorts, xstInstancePortPort=xstInstancePortPort, prioIpPrecEntry=prioIpPrecEntry, bcastStormIfIndex=bcastStormIfIndex, prioIpDscpCos=prioIpDscpCos, tacacsServerAddress=tacacsServerAddress, igmpSnoopMgt=igmpSnoopMgt, prioIpPrecValue=prioIpPrecValue, tacacsServerPortNumber=tacacsServerPortNumber, xstInstanceCfgBridgeHelloTime=xstInstanceCfgBridgeHelloTime, radiusMgt=radiusMgt, sshConnStatus=sshConnStatus, consoleExecTimeout=consoleExecTimeout, portFlowCtrlCfg=portFlowCtrlCfg, igmpSnoopRouterStaticTable=igmpSnoopRouterStaticTable, consolePasswordThreshold=consolePasswordThreshold, xstInstanceCfgForwardDelay=xstInstanceCfgForwardDelay, tftpMgt=tftpMgt, igmpSnoopQueryTimeout=igmpSnoopQueryTimeout, tftpSrcFile=tftpSrcFile, prioIpPortTable=prioIpPortTable, staPortAdminPointToPoint=staPortAdminPointToPoint, portCapabilities=portCapabilities, xstInstancePortEntry=xstInstancePortEntry, tacacsServerKey=tacacsServerKey, vlanPortMode=vlanPortMode, lacpPortIndex=lacpPortIndex, radiusServerPortNumber=radiusServerPortNumber, netConfigUnnumbered=netConfigUnnumbered, prioWrrTrafficClass=prioWrrTrafficClass, bcastStormMgt=bcastStormMgt, xstInstancePortPortRole=xstInstancePortPortRole, staTxHoldCount=staTxHoldCount, igmpSnoopMulticastCurrentVlanIndex=igmpSnoopMulticastCurrentVlanIndex, ValidStatus=ValidStatus, powerConnect3248TrapsPrefix=powerConnect3248TrapsPrefix, radiusServerTimeout=radiusServerTimeout, remoteLogMgt=remoteLogMgt, enterprises=enterprises, prioIpPrecPort=prioIpPrecPort, tftpAction=tftpAction, tftpServer=tftpServer, prioCopy=prioCopy, trapDestEntry=trapDestEntry, powerConnect3248MIB=powerConnect3248MIB, prioIpPortEntry=prioIpPortEntry, xstInstanceCfgIndex=xstInstanceCfgIndex, xstInstancePortPriority=xstInstancePortPriority, prioIpPortPhysPort=prioIpPortPhysPort, portSecPortTable=portSecPortTable, xstInstancePortEnable=xstInstancePortEnable, remoteLogServerStatus=remoteLogServerStatus, switchInfoEntry=switchInfoEntry, igmpSnoopMulticastStaticStatus=igmpSnoopMulticastStaticStatus, bcastStormSampleType=bcastStormSampleType, swExpansionSlot1=swExpansionSlot1, trunkMgt=trunkMgt, xstInstanceCfgHelloTime=xstInstanceCfgHelloTime, igmpSnoopRouterCurrentVlanIndex=igmpSnoopRouterCurrentVlanIndex, radiusServerKey=radiusServerKey, restartControl=restartControl, portSecPortIndex=portSecPortIndex, sysLogHistoryRamLevel=sysLogHistoryRamLevel, trapDestTable=trapDestTable, mirrorType=mirrorType, netConfigStatus=netConfigStatus, swExpansionSlot2=swExpansionSlot2, mirrorDestinationPort=mirrorDestinationPort, swIdentifier=swIdentifier, prioIpDscpEntry=prioIpDscpEntry, telnetPasswordThreshold=telnetPasswordThreshold, xstInstanceCfgHoldTime=xstInstanceCfgHoldTime, vlanMgt=vlanMgt, vlanPortTable=vlanPortTable, xstInstanceCfgTxHoldCount=xstInstanceCfgTxHoldCount, swPowerStatusChangeTrap=swPowerStatusChangeTrap, tftpDestFile=tftpDestFile, trapDestMgt=trapDestMgt, powerConnect3248Traps=powerConnect3248Traps, igmpSnoopMulticastCurrentStatus=igmpSnoopMulticastCurrentStatus, xstInstancePortForwardTransitions=xstInstancePortForwardTransitions, lacpPortEntry=lacpPortEntry, telnetMgt=telnetMgt, xstInstanceCfgTopChanges=xstInstanceCfgTopChanges, switchIndivPowerTable=switchIndivPowerTable, igmpSnoopMulticastStaticVlanIndex=igmpSnoopMulticastStaticVlanIndex, consoleStopBits=consoleStopBits, private=private, mirrorEntry=mirrorEntry, xstInstanceCfgMaxAge=xstInstanceCfgMaxAge, trunkMaxId=trunkMaxId, radiusServerAddress=radiusServerAddress, sshConnInfoTable=sshConnInfoTable, staPortLongPathCost=staPortLongPathCost, bcastStormStatus=bcastStormStatus, igmpSnoopRouterStaticVlanIndex=igmpSnoopRouterStaticVlanIndex, consoleMgt=consoleMgt, vlanEntry=vlanEntry, switchIndivPowerEntry=switchIndivPowerEntry, sshServerMinorVersion=sshServerMinorVersion, prioIpPrecRestoreDefault=prioIpPrecRestoreDefault, swPortNumber=swPortNumber, xstInstanceCfgRootPort=xstInstanceCfgRootPort, bcastStormPercent=bcastStormPercent, portSecAction=portSecAction, xstInstanceCfgBridgeForwardDelay=xstInstanceCfgBridgeForwardDelay, prioWrrEntry=prioWrrEntry, trunkPorts=trunkPorts, vlanIndex=vlanIndex)
mibBuilder.exportSymbols("PowerConnect3248-MIB", staPathCostMethod=staPathCostMethod, igmpSnoopMulticastStaticEntry=igmpSnoopMulticastStaticEntry, xstMgt=xstMgt, sshConnInfoEntry=sshConnInfoEntry, switchMgt=switchMgt, staMgt=staMgt, swRoleInSystem=swRoleInSystem, vlanTable=vlanTable, swPowerStatus=swPowerStatus, sysLogHistoryFlashLevel=sysLogHistoryFlashLevel, telnetExecTimeout=telnetExecTimeout, igmpSnoopRouterStaticPorts=igmpSnoopRouterStaticPorts, portTrunkIndex=portTrunkIndex, ipMgt=ipMgt, swChassisServiceTag=swChassisServiceTag, xstInstanceCfgTable=xstInstanceCfgTable, consoleDataBits=consoleDataBits, trapDestStatus=trapDestStatus, sshConnEncryptionType=sshConnEncryptionType, swPortSecurityTrap=swPortSecurityTrap, bcastStormEntry=bcastStormEntry, swProdDescription=swProdDescription, prioCopyIpPort=prioCopyIpPort, tftpStatus=tftpStatus, portSecurityMgt=portSecurityMgt, netDefaultGateway=netDefaultGateway, prioWrrWeight=prioWrrWeight, ipHttpState=ipHttpState, prioIpDscpRestoreDefault=prioIpDscpRestoreDefault, prioIpPortCos=prioIpPortCos, xstInstanceCfgEntry=xstInstanceCfgEntry, portMgt=portMgt, prioIpPortEnableStatus=prioIpPortEnableStatus, sshDisconnect=sshDisconnect, xstInstancePortDesignatedPort=xstInstancePortDesignatedPort, igmpSnoopQuerier=igmpSnoopQuerier, netConfigPrimaryInterface=netConfigPrimaryInterface, xstInstanceCfgRootCost=xstInstanceCfgRootCost, xstInstancePortDesignatedCost=xstInstancePortDesignatedCost, mirrorSourcePort=mirrorSourcePort)
