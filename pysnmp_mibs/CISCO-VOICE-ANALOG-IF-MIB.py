...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VOICE-ANALOG-IF-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:34 2025
...
_CvaIfEMCfgDialType_Type.__name__ = "InterfaceDialType"
...
_CvaIfEMCfgAutoGainControl_Type.__name__ = "TruthValue"
...
_CvaIfFXOCfgSupDisconnect_Type.__name__ = "TruthValue"
...
_CvaIfFXOCfgDialType_Type.__name__ = "InterfaceDialType"
...
cvaIfMIBCompliance.setObjects(
      *(("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfGeneralGroup"),
        ("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfEMGroup"),
        ("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfFXOGroup"),
        ("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfFXSGroup"))
)
if mibBuilder.loadTexts:
...
cvaIfMIBCompliance2.setObjects(
      *(("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfGeneralGroup"),
        ("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfEMGroupRev1"),
        ("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfFXOGroup2"),
        ("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfFXSGroup"))
)
if mibBuilder.loadTexts:
...
cvaIfMIBCompliance3.setObjects(
      *(("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfGeneralGroup"),
        ("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfEMGroupRev2"),
        ("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfFXOGroup2"),
        ("CISCO-VOICE-ANALOG-IF-MIB", "cvaIfFXSGroup"))
)
if mibBuilder.loadTexts:
