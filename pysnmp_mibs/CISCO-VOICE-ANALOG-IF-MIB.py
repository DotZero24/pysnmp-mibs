...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-VOICE-ANALOG-IF-MIB
...
mibBuilder.exportSymbols("CISCO-VOICE-ANALOG-IF-MIB", cvaIfFXOCfgSupDisconnect2=cvaIfFXOCfgSupDisconnect2, cvaIfFXOTimingPulseRate=cvaIfFXOTimingPulseRate, cvaIfFXOStatusTable=cvaIfFXOStatusTable, cvaIfFXSCfgTable=cvaIfFXSCfgTable, cvaIfEMGroupRev1=cvaIfEMGroupRev1, cvaIfEMTimingDelayStart=cvaIfEMTimingDelayStart, cvaIfEMTimingClearWaitDuration=cvaIfEMTimingClearWaitDuration, cvaIfEMTimingInterDigitDuration=cvaIfEMTimingInterDigitDuration, cvaIfFXOCfgSignalType=cvaIfFXOCfgSignalType, cvaIfEMCfgType=cvaIfEMCfgType, cvaIfEMCfgLmrMCap=cvaIfEMCfgLmrMCap, cvaIfEMTimeoutPttRcv=cvaIfEMTimeoutPttRcv, cvaIfEMTimingMaxDelayDuration=cvaIfEMTimingMaxDelayDuration, cvaIfGeneralGroup=cvaIfGeneralGroup, cvaIfCfgTable=cvaIfCfgTable, cvaIfMIBCompliances=cvaIfMIBCompliances, cvaIfFXOStatusEntry=cvaIfFXOStatusEntry, cvaIfEMTimingDigitDuration=cvaIfEMTimingDigitDuration, cvaIfMIBGroups=cvaIfMIBGroups, cvaIfEMOutSeizureActive=cvaIfEMOutSeizureActive, cvaIfEMCfgLmrECap=cvaIfEMCfgLmrECap, cvaIfEMTimingMinDelayPulseWidth=cvaIfEMTimingMinDelayPulseWidth, cvaIfFXOCfgDialType=cvaIfFXOCfgDialType, cvaIfFXORingGround=cvaIfFXORingGround, cvaIfGeneralObjects=cvaIfGeneralObjects, cvaIfEMTimeoutLmrTeardown=cvaIfEMTimeoutLmrTeardown, cvaIfEMStatusEntry=cvaIfEMStatusEntry, cvaIfEMGroup=cvaIfEMGroup, cvaIfFXORingDetect=cvaIfFXORingDetect, cvaIfEMTimingDelayVoice=cvaIfEMTimingDelayVoice, cvaIfMIBCompliance=cvaIfMIBCompliance, cvaIfObjects=cvaIfObjects, cvaIfMaintenanceMode=cvaIfMaintenanceMode, cvaIfFXSTipGround=cvaIfFXSTipGround, cvaIfEMTimeoutPttXmt=cvaIfEMTimeoutPttXmt, cvaIfEMTimingPulseRate=cvaIfEMTimingPulseRate, cvaIfCfgIntegratedDSP=cvaIfCfgIntegratedDSP, cvaIfEMCfgEntry=cvaIfEMCfgEntry, cvaIfFXOTimingEntry=cvaIfFXOTimingEntry, cvaIfEMGroupRev2=cvaIfEMGroupRev2, cvaIfFXOTipGround=cvaIfFXOTipGround, cvaIfFXSRingFrequency=cvaIfFXSRingFrequency, cvaIfEMTimingTable=cvaIfEMTimingTable, cvaIfFXOCfgEntry=cvaIfFXOCfgEntry, cvaIfMIBCompliance3=cvaIfMIBCompliance3, cvaIfFXSRingGround=cvaIfFXSRingGround, cvaIfFXSTimingDigitDuration=cvaIfFXSTimingDigitDuration, cvaIfFXOTimingPulseInterDigitDuration=cvaIfFXOTimingPulseInterDigitDuration, cvaIfFXOCfgTable=cvaIfFXOCfgTable, cvaIfStatusEntry=cvaIfStatusEntry, cvaIfEMTimingVoiceHangover=cvaIfEMTimingVoiceHangover, cvaIfFXOTimingDigitDuration=cvaIfFXOTimingDigitDuration, cvaIfFXSTimingTable=cvaIfFXSTimingTable, cvaIfFXSGroup=cvaIfFXSGroup, cvaIfFXOObjects=cvaIfFXOObjects, cvaIfEMCfgSignalType=cvaIfEMCfgSignalType, InterfaceDialType=InterfaceDialType, cvaIfStatusInfoType=cvaIfStatusInfoType, cvaIfFXSCfgEntry=cvaIfFXSCfgEntry, cvaIfFXOHookStatus=cvaIfFXOHookStatus, PYSNMP_MODULE_ID=ciscoVoiceAnalogIfMIB, cvaIfFXOCfgSupDisconnect=cvaIfFXOCfgSupDisconnect, cvaIfEMTimingMaxWinkDuration=cvaIfEMTimingMaxWinkDuration, cvaIfEMCfgAutoGainControl=cvaIfEMCfgAutoGainControl, cvaIfEMTimingMaxWinkWaitDuration=cvaIfEMTimingMaxWinkWaitDuration, cvaIfMIBCompliance2=cvaIfMIBCompliance2, cvaIfFXSStatusEntry=cvaIfFXSStatusEntry, cvaIfFXOCfgNumberRings=cvaIfFXOCfgNumberRings, ciscoVoiceAnalogIfMIB=ciscoVoiceAnalogIfMIB, cvaIfCfgImpedance=cvaIfCfgImpedance, cvaIfEMTimingEntry=cvaIfEMTimingEntry, cvaIfFXSHookStatus=cvaIfFXSHookStatus, cvaIfEMTimingPulseInterDigitDuration=cvaIfEMTimingPulseInterDigitDuration, cvaIfEMCfgTable=cvaIfEMCfgTable, cvaIfStatusSignalErrors=cvaIfStatusSignalErrors, cvaIfFXOTimingTable=cvaIfFXOTimingTable, cvaIfEMInSeizureActive=cvaIfEMInSeizureActive, cvaIfStatusTable=cvaIfStatusTable, cvaIfFXOGroup=cvaIfFXOGroup, cvaIfEMStatusTable=cvaIfEMStatusTable, cvaIfEMObjects=cvaIfEMObjects, cvaIfCfgEntry=cvaIfCfgEntry, cvaIfEMCfgOperation=cvaIfEMCfgOperation, cvaIfFXSTimingEntry=cvaIfFXSTimingEntry, cvaIfFXSTimingInterDigitDuration=cvaIfFXSTimingInterDigitDuration, cvaIfFXSStatusTable=cvaIfFXSStatusTable, cvaIfFXSObjects=cvaIfFXSObjects, cvaIfFXSRingActive=cvaIfFXSRingActive, cvaIfFXOGroup2=cvaIfFXOGroup2, cvaIfFXSCfgSignalType=cvaIfFXSCfgSignalType, cvaIfEMCfgDialType=cvaIfEMCfgDialType, cvaIfFXOTimingInterDigitDuration=cvaIfFXOTimingInterDigitDuration, cvaIfMIBConformance=cvaIfMIBConformance)
