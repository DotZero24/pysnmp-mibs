...
mibBuilder.exportSymbols("CISCO-VOICE-ANALOG-IF-MIB", cvaIfMIBCompliance=cvaIfMIBCompliance, cvaIfFXOTimingInterDigitDuration=cvaIfFXOTimingInterDigitDuration, cvaIfFXOCfgSupDisconnect=cvaIfFXOCfgSupDisconnect, cvaIfFXSTimingInterDigitDuration=cvaIfFXSTimingInterDigitDuration, cvaIfFXOTipGround=cvaIfFXOTipGround, cvaIfFXOTimingPulseInterDigitDuration=cvaIfFXOTimingPulseInterDigitDuration, cvaIfGeneralObjects=cvaIfGeneralObjects, PYSNMP_MODULE_ID=ciscoVoiceAnalogIfMIB, cvaIfFXOCfgDialType=cvaIfFXOCfgDialType, cvaIfMIBCompliance3=cvaIfMIBCompliance3, InterfaceDialType=InterfaceDialType, cvaIfFXSTipGround=cvaIfFXSTipGround, cvaIfFXOObjects=cvaIfFXOObjects, cvaIfFXOGroup=cvaIfFXOGroup, cvaIfEMTimeoutPttXmt=cvaIfEMTimeoutPttXmt, cvaIfEMOutSeizureActive=cvaIfEMOutSeizureActive, cvaIfCfgImpedance=cvaIfCfgImpedance, cvaIfEMTimingMaxWinkWaitDuration=cvaIfEMTimingMaxWinkWaitDuration, cvaIfEMObjects=cvaIfEMObjects, cvaIfFXORingGround=cvaIfFXORingGround, cvaIfFXSRingFrequency=cvaIfFXSRingFrequency, cvaIfFXORingDetect=cvaIfFXORingDetect, cvaIfFXSRingActive=cvaIfFXSRingActive, cvaIfFXSTimingTable=cvaIfFXSTimingTable, cvaIfFXOTimingEntry=cvaIfFXOTimingEntry, cvaIfFXSStatusTable=cvaIfFXSStatusTable, cvaIfFXOStatusTable=cvaIfFXOStatusTable, cvaIfEMCfgType=cvaIfEMCfgType, cvaIfEMCfgOperation=cvaIfEMCfgOperation, cvaIfFXOHookStatus=cvaIfFXOHookStatus, cvaIfFXSHookStatus=cvaIfFXSHookStatus, cvaIfEMGroupRev2=cvaIfEMGroupRev2, cvaIfCfgEntry=cvaIfCfgEntry, cvaIfFXSCfgSignalType=cvaIfFXSCfgSignalType, cvaIfFXOTimingTable=cvaIfFXOTimingTable, cvaIfEMTimingMaxDelayDuration=cvaIfEMTimingMaxDelayDuration, cvaIfStatusSignalErrors=cvaIfStatusSignalErrors, cvaIfEMTimingDelayStart=cvaIfEMTimingDelayStart, cvaIfFXSCfgTable=cvaIfFXSCfgTable, cvaIfFXOTimingPulseRate=cvaIfFXOTimingPulseRate, cvaIfEMTimingMinDelayPulseWidth=cvaIfEMTimingMinDelayPulseWidth, cvaIfFXSTimingDigitDuration=cvaIfFXSTimingDigitDuration, cvaIfEMTimeoutLmrTeardown=cvaIfEMTimeoutLmrTeardown, cvaIfEMTimingPulseRate=cvaIfEMTimingPulseRate, cvaIfEMCfgSignalType=cvaIfEMCfgSignalType, cvaIfEMInSeizureActive=cvaIfEMInSeizureActive, cvaIfEMCfgTable=cvaIfEMCfgTable, cvaIfFXOCfgTable=cvaIfFXOCfgTable, cvaIfFXSGroup=cvaIfFXSGroup, cvaIfEMTimingVoiceHangover=cvaIfEMTimingVoiceHangover, cvaIfFXOStatusEntry=cvaIfFXOStatusEntry, cvaIfEMTimingDelayVoice=cvaIfEMTimingDelayVoice, cvaIfFXSObjects=cvaIfFXSObjects, cvaIfStatusEntry=cvaIfStatusEntry, cvaIfMIBCompliance2=cvaIfMIBCompliance2, cvaIfStatusTable=cvaIfStatusTable, cvaIfFXOGroup2=cvaIfFXOGroup2, cvaIfEMTimingTable=cvaIfEMTimingTable, cvaIfEMStatusEntry=cvaIfEMStatusEntry, cvaIfFXSTimingEntry=cvaIfFXSTimingEntry, ciscoVoiceAnalogIfMIB=ciscoVoiceAnalogIfMIB, cvaIfCfgTable=cvaIfCfgTable, cvaIfEMCfgLmrECap=cvaIfEMCfgLmrECap, cvaIfMIBGroups=cvaIfMIBGroups, cvaIfEMCfgEntry=cvaIfEMCfgEntry, cvaIfCfgIntegratedDSP=cvaIfCfgIntegratedDSP, cvaIfEMTimingEntry=cvaIfEMTimingEntry, cvaIfStatusInfoType=cvaIfStatusInfoType, cvaIfFXOCfgNumberRings=cvaIfFXOCfgNumberRings, cvaIfObjects=cvaIfObjects, cvaIfEMCfgAutoGainControl=cvaIfEMCfgAutoGainControl, cvaIfFXOTimingDigitDuration=cvaIfFXOTimingDigitDuration, cvaIfMaintenanceMode=cvaIfMaintenanceMode, cvaIfEMGroup=cvaIfEMGroup, cvaIfEMCfgLmrMCap=cvaIfEMCfgLmrMCap, cvaIfFXOCfgEntry=cvaIfFXOCfgEntry, cvaIfEMTimingMaxWinkDuration=cvaIfEMTimingMaxWinkDuration, cvaIfEMTimingClearWaitDuration=cvaIfEMTimingClearWaitDuration, cvaIfFXSCfgEntry=cvaIfFXSCfgEntry, cvaIfEMTimeoutPttRcv=cvaIfEMTimeoutPttRcv, cvaIfFXSStatusEntry=cvaIfFXSStatusEntry, cvaIfEMTimingInterDigitDuration=cvaIfEMTimingInterDigitDuration, cvaIfMIBConformance=cvaIfMIBConformance, cvaIfFXOCfgSignalType=cvaIfFXOCfgSignalType, cvaIfMIBCompliances=cvaIfMIBCompliances, cvaIfEMTimingPulseInterDigitDuration=cvaIfEMTimingPulseInterDigitDuration, cvaIfEMStatusTable=cvaIfEMStatusTable, cvaIfEMCfgDialType=cvaIfEMCfgDialType, cvaIfGeneralGroup=cvaIfGeneralGroup, cvaIfEMGroupRev1=cvaIfEMGroupRev1, cvaIfFXSRingGround=cvaIfFXSRingGround, cvaIfFXOCfgSupDisconnect2=cvaIfFXOCfgSupDisconnect2, cvaIfEMTimingDigitDuration=cvaIfEMTimingDigitDuration)
