...
ipNetToMediaIfIndex, ipNetToMediaPhysAddress, ipNetToMediaNetAddress, ipAdEntAddr = mibBuilder.importSymbols("IP-MIB", "ipNetToMediaIfIndex", "ipNetToMediaPhysAddress", "ipNetToMediaNetAddress", "ipAdEntAddr")
...
mibBuilder.exportSymbols("IPOA-MIB", ipoaGroups=ipoaGroups, ipoaArpSrvrInArpOutReplies=ipoaArpSrvrInArpOutReplies, ipoaSrvrGroup=ipoaSrvrGroup, ipoaDuplicateIpAddress=ipoaDuplicateIpAddress, ipoaConfigPvcVci=ipoaConfigPvcVci, ipoaArpClientInArpOutReqs=ipoaArpClientInArpOutReqs, ipoaConfigPvcIfIndex=ipoaConfigPvcIfIndex, ipoaLisSubnetAddr=ipoaLisSubnetAddr, ipoaArpClientTable=ipoaArpClientTable, ipoaArpClientArpOutReplies=ipoaArpClientArpOutReplies, ipoaLisActiveVcs=ipoaLisActiveVcs, ipoaArpSrvrEntry=ipoaArpSrvrEntry, ipoaConfigPvcRowStatus=ipoaConfigPvcRowStatus, ipoaArpSrvrArpInReqs=ipoaArpSrvrArpInReqs, ipoaArpClientInArpInvalidInReqs=ipoaArpClientInArpInvalidInReqs, ipoaVcEntry=ipoaVcEntry, ipoaArpClientAtmAddr=ipoaArpClientAtmAddr, ipoaLisIfMappingIfIndex=ipoaLisIfMappingIfIndex, ipoaArpSrvrInArpInvalidOutReqs=ipoaArpSrvrInArpInvalidOutReqs, ipoaArpClientArpNoSrvrResps=ipoaArpClientArpNoSrvrResps, ipoaArpRemoteSrvrAdminStatus=ipoaArpRemoteSrvrAdminStatus, ipoaArpClientArpOutReqs=ipoaArpClientArpOutReqs, ipoaMtuExceeded=ipoaMtuExceeded, IpoaAtmConnKind=IpoaAtmConnKind, ipoaArpClientInArpOutReplies=ipoaArpClientInArpOutReplies, ipoaLisMinHoldingTime=ipoaLisMinHoldingTime, ipoaClientGroup=ipoaClientGroup, ipoaConfigPvcDefaultMtu=ipoaConfigPvcDefaultMtu, ipoaArpRemoteSrvrAtmAddr=ipoaArpRemoteSrvrAtmAddr, ipoaArpSrvrAddr=ipoaArpSrvrAddr, ipoaVcType=ipoaVcType, ipoaLisTableGroup=ipoaLisTableGroup, ipoaObjects=ipoaObjects, ipoaArpSrvrArpDupIpAddrs=ipoaArpSrvrArpDupIpAddrs, ipoaLisNotificationsGroup=ipoaLisNotificationsGroup, ipoaArpClientInArpInReplies=ipoaArpClientInArpInReplies, ipoaArpSrvrRowStatus=ipoaArpSrvrRowStatus, ipoaCompliance=ipoaCompliance, ipoaNotifications=ipoaNotifications, ipoaVcTable=ipoaVcTable, ipoaLisRetries=ipoaLisRetries, ipoaLisDelete=ipoaLisDelete, ipoaLisIfMappingTable=ipoaLisIfMappingTable, ipoaGeneralGroup=ipoaGeneralGroup, ipoaArpSrvrArpUnknownOps=ipoaArpSrvrArpUnknownOps, ipoaVcNegotiatedEncapsType=ipoaVcNegotiatedEncapsType, ipoaArpSrvrLis=ipoaArpSrvrLis, ipoaArpSrvrArpOutNaks=ipoaArpSrvrArpOutNaks, ipoaLisTimeout=ipoaLisTimeout, ipoaArpRemoteSrvrRowStatus=ipoaArpRemoteSrvrRowStatus, ipoaArpClientRowStatus=ipoaArpClientRowStatus, ipoaLisDefaultMtu=ipoaLisDefaultMtu, ipoaArpRemoteSrvrTable=ipoaArpRemoteSrvrTable, ipoaLisDefaultPeakCellRate=ipoaLisDefaultPeakCellRate, ipoaConfigPvcVpi=ipoaConfigPvcVpi, ipoaVcVci=ipoaVcVci, ipoaArpClientArpInReqs=ipoaArpClientArpInReqs, ipoaTrapPrefix=ipoaTrapPrefix, ipoaArpClientSrvrInUse=ipoaArpClientSrvrInUse, ipoaLisDefaultEncapsType=ipoaLisDefaultEncapsType, ipoaArpRemoteSrvrIfIndex=ipoaArpRemoteSrvrIfIndex, ipoaArpSrvrInArpInReplies=ipoaArpSrvrInArpInReplies, ipoaVcVpi=ipoaVcVpi, ipoaMIB=ipoaMIB, ipoaLisQDepth=ipoaLisQDepth, ipoaConfigPvcTable=ipoaConfigPvcTable, ipoaConformance=ipoaConformance, ipoaArpClientInArpInvalidOutReqs=ipoaArpClientInArpInvalidOutReqs, ipoaLisCacheEntryAge=ipoaLisCacheEntryAge, ipoaLisIfMappingEntry=ipoaLisIfMappingEntry, ipoaArpClientInArpInReqs=ipoaArpClientInArpInReqs, ipoaArpSrvrArpOutReplies=ipoaArpSrvrArpOutReplies, ipoaSrvrNotificationsGroup=ipoaSrvrNotificationsGroup, ipoaLisTable=ipoaLisTable, IpoaVpiInteger=IpoaVpiInteger, ipoaArpClientEntry=ipoaArpClientEntry, ipoaArpClientArpInReplies=ipoaArpClientArpInReplies, ipoaArpSrvrInArpInvalidInReqs=ipoaArpSrvrInArpInvalidInReqs, ipoaArpRemoteSrvrEntry=ipoaArpRemoteSrvrEntry, ipoaCompliances=ipoaCompliances, ipoaLisIfMappingRowStatus=ipoaLisIfMappingRowStatus, ipoaLisTrapEnable=ipoaLisTrapEnable, ipoaLisRowStatus=ipoaLisRowStatus, ipoaLisEntry=ipoaLisEntry, IpoaVciInteger=IpoaVciInteger, IpoaAtmAddr=IpoaAtmAddr, ipoaArpClientArpOutNaks=ipoaArpClientArpOutNaks, ipoaArpSrvrInArpInReqs=ipoaArpSrvrInArpInReqs, ipoaArpSrvrInArpOutReqs=ipoaArpSrvrInArpOutReqs, ipoaVcNegotiatedMtu=ipoaVcNegotiatedMtu, ipoaArpSrvrTable=ipoaArpSrvrTable, ipoaArpRemoteSrvrOperStatus=ipoaArpRemoteSrvrOperStatus, IpoaEncapsType=IpoaEncapsType, ipoaArpClientArpUnknownOps=ipoaArpClientArpUnknownOps, ipoaLisInactivityTimer=ipoaLisInactivityTimer, ipoaLisMaxCalls=ipoaLisMaxCalls, ipoaConfigPvcEntry=ipoaConfigPvcEntry, ipoaArpClientArpInNaks=ipoaArpClientArpInNaks, ipoaArpRemoteSrvrIpAddr=ipoaArpRemoteSrvrIpAddr, ipoaLisCreate=ipoaLisCreate, PYSNMP_MODULE_ID=ipoaMIB, ipoaBasicNotificationsGroup=ipoaBasicNotificationsGroup)
