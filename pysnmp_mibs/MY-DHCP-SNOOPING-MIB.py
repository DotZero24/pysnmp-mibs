...
myDhcpSnoopingMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,42))
...
myDhcpSnoopingMIBObjects=_MyDhcpSnoopingMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,42,1))
_MySNDhcpGlobal_ObjectIdentity=ObjectIdentity
mySNDhcpGlobal=_MySNDhcpGlobal_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,42,1,1))
_MySNDhcpFeatureEnable_Type=TruthValue
_MySNDhcpFeatureEnable_Object=MibScalar
mySNDhcpFeatureEnable=_MySNDhcpFeatureEnable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,1,1),_MySNDhcpFeatureEnable_Type())
...
mySNDhcpDatabaseUpdateInterval=_MySNDhcpDatabaseUpdateInterval_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,1,2),_MySNDhcpDatabaseUpdateInterval_Type())
...
mySNDhcpRelayAgentInfoOptEnable=_MySNDhcpRelayAgentInfoOptEnable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,1,3),_MySNDhcpRelayAgentInfoOptEnable_Type())
...
mySNDhcpMatchMacAddressEnable=_MySNDhcpMatchMacAddressEnable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,1,4),_MySNDhcpMatchMacAddressEnable_Type())
...
mySNDhcpInterface=_MySNDhcpInterface_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,42,1,2))
_MySNDhcpIfTrustTable_Object=MibTable
mySNDhcpIfTrustTable=_MySNDhcpIfTrustTable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,1))
if mibBuilder.loadTexts:mySNDhcpIfTrustTable.setStatus(_A)
_MySNDhcpIfTrustEntry_Object=MibTableRow
mySNDhcpIfTrustEntry=_MySNDhcpIfTrustEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,1,1))
...
mySNDhcpIfTrustIndex=_MySNDhcpIfTrustIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,1,1,1),_MySNDhcpIfTrustIndex_Type())
...
mySNDhcpIfTrustEnable=_MySNDhcpIfTrustEnable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,1,1,2),_MySNDhcpIfTrustEnable_Type())
...
mySNDhcpIfSuppressionTable=_MySNDhcpIfSuppressionTable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,2))
if mibBuilder.loadTexts:mySNDhcpIfSuppressionTable.setStatus(_A)
_MySNDhcpIfSuppressionEntry_Object=MibTableRow
mySNDhcpIfSuppressionEntry=_MySNDhcpIfSuppressionEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,2,1))
...
mySNDhcpIfSuppressionIndex=_MySNDhcpIfSuppressionIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,2,1,1),_MySNDhcpIfSuppressionIndex_Type())
...
mySNDhcpIfSuppressionEnable=_MySNDhcpIfSuppressionEnable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,2,1,2),_MySNDhcpIfSuppressionEnable_Type())
...
mySNDhcpAddressBindTable=_MySNDhcpAddressBindTable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,3))
if mibBuilder.loadTexts:mySNDhcpAddressBindTable.setStatus(_A)
_MySNDhcpAddressBindEntry_Object=MibTableRow
mySNDhcpAddressBindEntry=_MySNDhcpAddressBindEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,3,1))
...
mySNDhcpAddressBindIndex=_MySNDhcpAddressBindIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,3,1,1),_MySNDhcpAddressBindIndex_Type())
...
mySNDhcpAddressBindEnable=_MySNDhcpAddressBindEnable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,2,3,1,2),_MySNDhcpAddressBindEnable_Type())
...
mySNDhcpBindings=_MySNDhcpBindings_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,42,1,3))
_MySNDhcpBindingsTable_Object=MibTable
mySNDhcpBindingsTable=_MySNDhcpBindingsTable_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,3,1))
if mibBuilder.loadTexts:mySNDhcpBindingsTable.setStatus(_A)
_MySNDhcpBindingsEntry_Object=MibTableRow
mySNDhcpBindingsEntry=_MySNDhcpBindingsEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,3,1,1))
...
mySNDhcpBindingsVlan=_MySNDhcpBindingsVlan_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,3,1,1,1),_MySNDhcpBindingsVlan_Type())
...
mySNDhcpBindingsMacAddress=_MySNDhcpBindingsMacAddress_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,3,1,1,2),_MySNDhcpBindingsMacAddress_Type())
...
mySNDhcpBindingsAddrType=_MySNDhcpBindingsAddrType_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,3,1,1,3),_MySNDhcpBindingsAddrType_Type())
...
mySNDhcpBindingsIpAddress=_MySNDhcpBindingsIpAddress_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,3,1,1,4),_MySNDhcpBindingsIpAddress_Type())
...
mySNDhcpBindingsInterface=_MySNDhcpBindingsInterface_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,3,1,1,5),_MySNDhcpBindingsInterface_Type())
...
mySNDhcpBindingsLeasedTime=_MySNDhcpBindingsLeasedTime_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,3,1,1,6),_MySNDhcpBindingsLeasedTime_Type())
...
mySNDhcpBindingsStatus=_MySNDhcpBindingsStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,42,1,3,1,1,7),_MySNDhcpBindingsStatus_Type())
...
myDhcpSnoopingMIBConformance=_MyDhcpSnoopingMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,42,2))
_MyDhcpSnoopingMIBCompliances_ObjectIdentity=ObjectIdentity
myDhcpSnoopingMIBCompliances=_MyDhcpSnoopingMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,42,2,1))
_MyDhcpSnoopingMIBGroups_ObjectIdentity=ObjectIdentity
myDhcpSnoopingMIBGroups=_MyDhcpSnoopingMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,42,2,2))
myDhcpSnoopingMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,42,2,2,1))
...
myDhcpSnoopingMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,42,2,1,1))
