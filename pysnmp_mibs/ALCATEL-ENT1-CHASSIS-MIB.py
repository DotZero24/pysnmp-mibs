# SNMP MIB module (ALCATEL-ENT1-CHASSIS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-CHASSIS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:09:49 2025
...
class _ChasEntPhysPowerType_Type(Integer32):
    """Custom type chasEntPhysPowerType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
class _ChasPowerSupplyRedundancyReserve_Type(Integer32):
    """Custom type chasPowerSupplyRedundancyReserve based on Integer32"""
    defaultValue = 1
...
_ChasPowerSupplyRedundancyReserve_Type.__name__ = "Integer32"
_ChasPowerSupplyRedundancyReserve_Object = MibTableColumn
chasPowerSupplyRedundancyReserve = _ChasPowerSupplyRedundancyReserve_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 3, 1, 1, 3, 1, 25),
    _ChasPowerSupplyRedundancyReserve_Type()
)
chasPowerSupplyRedundancyReserve.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    chasPowerSupplyRedundancyReserve.setStatus("current")
...
chasSupervisionRfsLsEntry.setIndexNames(
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsFileIndex"),
)
if mibBuilder.loadTexts:
...
chasControlReloadEntry.setIndexNames(
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "chasControlReloadIndex"),
)
if mibBuilder.loadTexts:
...
chasSupervisionRfsDfEntry.setIndexNames(
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsDfSlot"),
)
if mibBuilder.loadTexts:
...
chasSupervisionFlashMemEntry.setIndexNames(
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionSlot"),
)
if mibBuilder.loadTexts:
...
chasSupervisionCmmCertifiedEntry.setIndexNames(
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionCmmNum"),
)
if mibBuilder.loadTexts:
...
alaChasEntPhysFanEntry.setIndexNames(
    (0, "ENTITY-MIB", "entPhysicalIndex"),
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "alaChasEntPhysFanLocalIndex"),
)
if mibBuilder.loadTexts:
...
_AlaChasEntPhysFanSpeed_Type = Unsigned32
_AlaChasEntPhysFanSpeed_Object = MibTableColumn
alaChasEntPhysFanSpeed = _AlaChasEntPhysFanSpeed_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 3, 1, 1, 11, 1, 4),
    _AlaChasEntPhysFanSpeed_Type()
)
alaChasEntPhysFanSpeed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alaChasEntPhysFanSpeed.setStatus("current")
if mibBuilder.loadTexts:
    alaChasEntPhysFanSpeed.setUnits("rpm")
...
class _ChasTrapsBPSFwVersion_Type(Integer32):
    """Custom type chasTrapsBPSFwVersion based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ChasTrapsBPSFwVersion_Type.__name__ = "Integer32"
_ChasTrapsBPSFwVersion_Object = MibScalar
chasTrapsBPSFwVersion = _ChasTrapsBPSFwVersion_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 3, 1, 1, 13, 21),
    _ChasTrapsBPSFwVersion_Type()
)
chasTrapsBPSFwVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chasTrapsBPSFwVersion.setStatus("current")
_ChasTrapsBPSFwType_Type = ChasTrapsBPSFwType
_ChasTrapsBPSFwType_Object = MibScalar
chasTrapsBPSFwType = _ChasTrapsBPSFwType_Object(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 3, 1, 1, 13, 22),
    _ChasTrapsBPSFwType_Type()
)
chasTrapsBPSFwType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chasTrapsBPSFwType.setStatus("current")
...
alaChasBpsFwEntry.setIndexNames(
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsShelfId"),
)
if mibBuilder.loadTexts:
...
class _AlaChasBpsCpldRev_Type(Integer32):
    """Custom type alaChasBpsCpldRev based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_AlaChasBpsCpldRev_Type.__name__ = "Integer32"
...
class _AlaChasBpsMmcuRev_Type(Integer32):
    """Custom type alaChasBpsMmcuRev based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_AlaChasBpsMmcuRev_Type.__name__ = "Integer32"
...
class _AlaChasBpsCmcuRev_Type(Integer32):
    """Custom type alaChasBpsCmcuRev based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_AlaChasBpsCmcuRev_Type.__name__ = "Integer32"
...
alaChasBpsConnectorPriorityEntry.setIndexNames(
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsChassisId"),
)
if mibBuilder.loadTexts:
...
class _AlaChasBpsConnectorNum_Type(Integer32):
    """Custom type alaChasBpsConnectorNum based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AlaChasBpsConnectorNum_Type.__name__ = "Integer32"
...
alaChasBpsPowerSupplyEntry.setIndexNames(
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyShelfId"),
    (0, "ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyIndex"),
)
if mibBuilder.loadTexts:
...
alaChasBpsPowerSupplySerialNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
chasEntPhysicalGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysAdminStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysOperStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysPower"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysModuleType"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysPartNumber"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusOk1"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusOk2"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusPrimaryCMM"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusSecondaryCMM"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusTemperature"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusFan"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusBackupPS"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusInternalPS"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusControl"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusFabric"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysLedStatusPS"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysAsic1Rev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysAsic2Rev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysAsic3Rev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysAsic4Rev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysAsic5Rev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysAsic6Rev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysCpldRev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysDaughterFpga1Rev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysDaughterFpga2Rev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysNiNum"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysGbicNum"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysWaveLen"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysUbootRev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysUbootMinibootRev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysMacAddress"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysCpuModel"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysAirflow"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysPowerUsed"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysPowerType"))
)
if mibBuilder.loadTexts:
...
chassisTemperatureGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasEntTempCurrent"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntTempDangerThreshold"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntTempStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasEntTempThreshold"))
)
if mibBuilder.loadTexts:
...
chasControlModuleGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasControlActivateTimeout"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlVersionMngt"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlDelayedActivateTimer"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlCertifyStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlSynchronizationStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlAcrossCmmWorkingSynchroStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlAcrossCmmCertifiedSynchroStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlNextRunningVersion"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlCurrentRunningVersion"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlWorkingVersion"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlRedundancyTime"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlEmpIpAddress"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlEmpIpMask"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlChassisId"))
)
if mibBuilder.loadTexts:
...
chasControlRedundantGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasControlNumberOfTakeover"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlDelayedRebootTimer"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlDelayedResetAll"))
)
if mibBuilder.loadTexts:
...
chasChassisGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasFreeSlots"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasPowerLeft"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasNumberOfResets"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTempRange"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTempThreshold"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasDangerTempThreshold"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasPrimaryPhysicalIndex"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasCPMAHardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasCFMAHardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasCPMBHardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasCFMBHardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasCFMCHardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasCFMDHardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasFTAHardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasFTBHardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasNI1HardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasNI2HardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasNI3HardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasNI4HardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasNI5HardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasNI6HardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasNI7HardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasNI8HardwareBoardTemp"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasPowerSupplyRedundancy"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasPowerSupplyRedundancyReserve"))
)
if mibBuilder.loadTexts:
...
chasControlReloadStatusGroup.setObjects(
    ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlReloadStatus")
)
if mibBuilder.loadTexts:
...
chasGlobalControlGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlDelayedResetAll"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlLongCommand"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlLongCommandStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlUpdateFirmware"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlUpdateSlot"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlUpdateFilename"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlUpdateStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlConfirmOperation"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlConfirmMessage"))
)
if mibBuilder.loadTexts:
...
alaChasEntPhysFanGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "alaChasEntPhysFanStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasEntPhysFanAirflow"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasEntPhysFanSpeed"))
)
if mibBuilder.loadTexts:
...
alaChasNotificationObjectGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStrLevel"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStrAppID"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStrSnapID"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStrfileName"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStrfileLineNb"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStrErrorNb"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStrcomments"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStrdataInfo"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsObjectType"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsObjectNumber"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsAlertNumber"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsAlertDescr"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "physicalIndex"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsNiRqstdBpsSysPower"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsNiGrantdBpsSysPower"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapBPSShelfId"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSPowerSupply"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSEventAlert"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSSystemFETChange"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSPoeFETChange"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSFwVersion"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSFwType"))
)
if mibBuilder.loadTexts:
...
chassisSupervisionRfsCommandsGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsCommandsSlot"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsCommandsCommand"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsCommandsSrcFileName"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsCommandsDestFileName"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsCommandsRlsDirName"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsCommandsRlsFileName"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsCommandsProcessingState"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsCommandsStatusCode"))
)
if mibBuilder.loadTexts:
...
chasSupervisionCmmCertifiedEntryGroup.setObjects(
    ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionCmmCertifiedStatus")
)
if mibBuilder.loadTexts:
...
chasSupervisionFlashMemEntryGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionFlashSize"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionFlashFree"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionFlashUsed"))
)
if mibBuilder.loadTexts:
...
chasSupervisionRfsDfEntryGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsDfFlashFree"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsDfFlashSize"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsDfUsbFree"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsDfUsbSize"))
)
if mibBuilder.loadTexts:
...
chasSupervisionRfsLsEntryGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsFileIndex"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsSlot"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsDirName"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsFileName"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsFileType"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsFileSize"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsFileAttr"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsFileDateTime"))
)
if mibBuilder.loadTexts:
...
alaChasBpsFwGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsUpdateFirmware"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsCpldRev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsMmcuRev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsCmcuRev"))
)
if mibBuilder.loadTexts:
...
alaChasBpsConnectorPriorityGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsConnectorShelfId"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsConnectorPriority"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsConnectorNum"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsSerialNum"))
)
if mibBuilder.loadTexts:
...
alaChasBpsModeGroup.setObjects(
    ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsMode")
)
if mibBuilder.loadTexts:
...
alaChasBpsPowerSupplyGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyName"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyDescr"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyModuleType"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyPartNumber"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyHardwareRev"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplySerialNum"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyMfgDate"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyOperStatus"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyPowerProv"))
)
if mibBuilder.loadTexts:
...
alaChasBpsTotalPowerAllocGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsSysTotalAvailablePower"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsSysTotalAllocation"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPoeTotalAvailablePower"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPoeTotalAllocation"))
)
if mibBuilder.loadTexts:
...
chasTrapsBPSFwUpgradeAlert = NotificationType(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 1, 1, 3, 1, 0, 7)
)
chasTrapsBPSFwUpgradeAlert.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapBPSShelfId"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSFwType"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSFwVersion"))
)
if mibBuilder.loadTexts:
    chasTrapsBPSFwUpgradeAlert.setStatus(
        "current"
    )
...
chassisPhysNotificationGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStr"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsAlert"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStateChange"))
)
if mibBuilder.loadTexts:
...
chassisNotificationGroup.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsStr"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisTrapsAlert"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSLessAllocSysPwr"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSStateChange"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsNiBPSFETStateChange"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasTrapsBPSFwUpgradeAlert"))
)
if mibBuilder.loadTexts:
...
alcatelIND1ChassisPhysMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasEntPhysicalGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisPhysNotificationGroup"))
)
if mibBuilder.loadTexts:
...
alcatelIND1ChassisMIBCompliance.setObjects(
      *(("ALCATEL-ENT1-CHASSIS-MIB", "chasControlModuleGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlRedundantGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasChassisGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasControlReloadStatusGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasGlobalControlGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisNotificationGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasEntPhysFanGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasNotificationObjectGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chassisSupervisionRfsCommandsGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionCmmCertifiedEntryGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionFlashMemEntryGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsDfEntryGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "chasSupervisionRfsLsEntryGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsFwGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsConnectorPriorityGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsModeGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsPowerSupplyGroup"),
        ("ALCATEL-ENT1-CHASSIS-MIB", "alaChasBpsTotalPowerAllocGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"AlaChasBpsShelfId": AlaChasBpsShelfId,
       ...
       "chasTrapsBPSFwUpgradeAlert": chasTrapsBPSFwUpgradeAlert,
       ...
       "alaChasEntPhysFanSpeed": alaChasEntPhysFanSpeed,
       ...
       "chasTrapsBPSFwVersion": chasTrapsBPSFwVersion,
       "chasTrapsBPSFwType": chasTrapsBPSFwType,
