...
#
hardentIND1Physical, hardentIND1Chassis = mibBuilder.importSymbols("ALCATEL-ENT1-BASE", "hardentIND1Physical", "hardentIND1Chassis")
...
mibBuilder.exportSymbols("ALCATEL-ENT1-CHASSIS-MIB", chasEntTempThreshold=chasEntTempThreshold, alcatelIND1ChassisPhysMIBCompliances=alcatelIND1ChassisPhysMIBCompliances, chasGlobalControlLongCommand=chasGlobalControlLongCommand, chasNI1HardwareBoardTemp=chasNI1HardwareBoardTemp, alaChasBpsPowerSupplyPowerProv=alaChasBpsPowerSupplyPowerProv, chasControlDelayedActivateTimer=chasControlDelayedActivateTimer, chasSupervisionRfsLsFileAttr=chasSupervisionRfsLsFileAttr, chasTrapsBPSEventAlert=chasTrapsBPSEventAlert, alaChasBpsPowerSupplyShelfId=alaChasBpsPowerSupplyShelfId, alaChasNotificationObjectGroup=alaChasNotificationObjectGroup, alaChasBpsMmcuRev=alaChasBpsMmcuRev, chasControlVersionMngt=chasControlVersionMngt, chassisTrapsStrfileName=chassisTrapsStrfileName, alaChasEntPhysFanGroup=alaChasEntPhysFanGroup, chasCPMAHardwareBoardTemp=chasCPMAHardwareBoardTemp, chasSupervisionFlashFree=chasSupervisionFlashFree, chassisTrapsStrdataInfo=chassisTrapsStrdataInfo, alaChasBpsConnectorPriority=alaChasBpsConnectorPriority, chasControlRedundantTable=chasControlRedundantTable, chasTrapsBPSSystemFETChange=chasTrapsBPSSystemFETChange, chasSupervisionSlot=chasSupervisionSlot, physicalIndex=physicalIndex, chasControlNumberOfTakeover=chasControlNumberOfTakeover, chasEntPhysLedStatusPrimaryCMM=chasEntPhysLedStatusPrimaryCMM, chasPrimaryPhysicalIndex=chasPrimaryPhysicalIndex, chasControlAcrossCmmCertifiedSynchroStatus=chasControlAcrossCmmCertifiedSynchroStatus, chasGlobalControlConfirmOperation=chasGlobalControlConfirmOperation, chasGlobalControlConfirmMessage=chasGlobalControlConfirmMessage, chasSupervisionRfsDfEntryGroup=chasSupervisionRfsDfEntryGroup, chasControlEmpIpMask=chasControlEmpIpMask, chasChassisTable=chasChassisTable, chasGlobalControlUpdateFilename=chasGlobalControlUpdateFilename, chasEntPhysAirflow=chasEntPhysAirflow, chasNI5HardwareBoardTemp=chasNI5HardwareBoardTemp, chasControlReloadStatusTable=chasControlReloadStatusTable, chasGlobalControlUpdateStatus=chasGlobalControlUpdateStatus, chasSupervisionRfsCommandsRlsDirName=chasSupervisionRfsCommandsRlsDirName, chasTempThreshold=chasTempThreshold, chasNumberOfResets=chasNumberOfResets, chasTempRange=chasTempRange, chasControlReloadIndex=chasControlReloadIndex, chasSupervisionRfsLsFileIndex=chasSupervisionRfsLsFileIndex, alcatelIND1ChassisSupervisionRfsCommands=alcatelIND1ChassisSupervisionRfsCommands, chasSupervisionRfsDfFlashFree=chasSupervisionRfsDfFlashFree, alaChasBpsSysTotalAllocation=alaChasBpsSysTotalAllocation, chasEntPhysLedStatusOk2=chasEntPhysLedStatusOk2, chasControlCurrentRunningVersion=chasControlCurrentRunningVersion, chasEntPhysAsic2Rev=chasEntPhysAsic2Rev, alaChasBpsPowerSupplyIndex=alaChasBpsPowerSupplyIndex, alaChasBpsPowerSupplyOperStatus=alaChasBpsPowerSupplyOperStatus, chasSupervisionFlashMemEntryGroup=chasSupervisionFlashMemEntryGroup, chasNI3HardwareBoardTemp=chasNI3HardwareBoardTemp, chasEntPhysModuleType=chasEntPhysModuleType, chasEntPhysCpldRev=chasEntPhysCpldRev, chasEntPhysLedStatusControl=chasEntPhysLedStatusControl, chasSupervisionRfsLsFileDateTime=chasSupervisionRfsLsFileDateTime, alaChasBpsUpdateFirmware=alaChasBpsUpdateFirmware, chasEntPhysLedStatusTemperature=chasEntPhysLedStatusTemperature, chasGlobalControlLongCommandStatus=chasGlobalControlLongCommandStatus, chasControlWorkingVersion=chasControlWorkingVersion, chasTrapsBPSFwUpgradeAlert=chasTrapsBPSFwUpgradeAlert, chassisTrapsStrfileLineNb=chassisTrapsStrfileLineNb, chasEntTemperatureEntry=chasEntTemperatureEntry, chassisTrapsStrErrorNb=chassisTrapsStrErrorNb, alcatelIND1ChassisMIBObjects=alcatelIND1ChassisMIBObjects, chasNI7HardwareBoardTemp=chasNI7HardwareBoardTemp, chasChassisGroup=chasChassisGroup, chasEntPhysLedStatusFabric=chasEntPhysLedStatusFabric, alaChasEntPhysFanSpeed=alaChasEntPhysFanSpeed, chasEntPhysicalEntry=chasEntPhysicalEntry, alaChasEntPhysFanAirflow=alaChasEntPhysFanAirflow, alaChasBpsModeTable=alaChasBpsModeTable, chasTrapsBPSPoeFETChange=chasTrapsBPSPoeFETChange, alaChasBpsPowerSupplyHardwareRev=alaChasBpsPowerSupplyHardwareRev, chasEntPhysicalGroup=chasEntPhysicalGroup, alaChasBpsConnectorPriorityGroup=alaChasBpsConnectorPriorityGroup, chasSupervisionFlashMemEntry=chasSupervisionFlashMemEntry, alcatelIND1ChassisMIBConformance=alcatelIND1ChassisMIBConformance, chasControlReloadStatusGroup=chasControlReloadStatusGroup, alaChasBpsFwTable=alaChasBpsFwTable, alaChasBpsSysTotalAvailablePower=alaChasBpsSysTotalAvailablePower, chasControlDelayedRebootTimer=chasControlDelayedRebootTimer, chasSupervisionRfsLsFileSize=chasSupervisionRfsLsFileSize, ChassisTrapsObjectNumber=ChassisTrapsObjectNumber, alaChasBpsTotalPowerAllocTable=alaChasBpsTotalPowerAllocTable, ChassisTrapsStrdataInfo=ChassisTrapsStrdataInfo, chasControlModuleEntry=chasControlModuleEntry, alcatelIND1ChassisMIBCompliances=alcatelIND1ChassisMIBCompliances, chasControlAcrossCmmWorkingSynchroStatus=chasControlAcrossCmmWorkingSynchroStatus, alaChasBpsChassisId=alaChasBpsChassisId, alaChasBpsPowerSupplyEntry=alaChasBpsPowerSupplyEntry, alaChasBpsPowerSupplySerialNum=alaChasBpsPowerSupplySerialNum, alaChasBpsPowerSupplyTable=alaChasBpsPowerSupplyTable, chasDangerTempThreshold=chasDangerTempThreshold, chasControlActivateTimeout=chasControlActivateTimeout, chasEntPhysLedStatusOk1=chasEntPhysLedStatusOk1, chassisTrapsStrSnapID=chassisTrapsStrSnapID, chasPowerSupplyRedundancy=chasPowerSupplyRedundancy, chasSupervisionFlashMemTable=chasSupervisionFlashMemTable, chasGlobalControlUpdateSlot=chasGlobalControlUpdateSlot, alaChasBpsConnectorPriorityEntry=alaChasBpsConnectorPriorityEntry, chassisTrapsStrAppID=chassisTrapsStrAppID, chasSupervisionRfsLsEntryGroup=chasSupervisionRfsLsEntryGroup, chasSupervisionRfsCommandsCommand=chasSupervisionRfsCommandsCommand, alcatelIND1ChassisPhysMIBCompliance=alcatelIND1ChassisPhysMIBCompliance, chasSupervisionRfsCommandsSlot=chasSupervisionRfsCommandsSlot, chasCFMBHardwareBoardTemp=chasCFMBHardwareBoardTemp, chasNI2HardwareBoardTemp=chasNI2HardwareBoardTemp, chasEntPhysGbicNum=chasEntPhysGbicNum, chasSupervisionRfsDfUsbSize=chasSupervisionRfsDfUsbSize, chasNI4HardwareBoardTemp=chasNI4HardwareBoardTemp, chassisTrapsAlert=chassisTrapsAlert, chasTrapsBPSLessAllocSysPwr=chasTrapsBPSLessAllocSysPwr, chasTrapsBPSPowerSupply=chasTrapsBPSPowerSupply, chasControlModuleGroup=chasControlModuleGroup, chassisTrapsStrcomments=chassisTrapsStrcomments, alaChasBpsCmcuRev=alaChasBpsCmcuRev, chasEntPhysPartNumber=chasEntPhysPartNumber, alaChasBpsTotalPowerAllocEntry=alaChasBpsTotalPowerAllocEntry, chasSupervisionRfsCommandsStatusCode=chasSupervisionRfsCommandsStatusCode, chasControlReloadEntry=chasControlReloadEntry, chasGlobalControlGroup=chasGlobalControlGroup, ChasEntPhysLed=ChasEntPhysLed, chasEntPhysPowerUsed=chasEntPhysPowerUsed, chasTrapsBPSFwType=chasTrapsBPSFwType, chasSupervisionRfsDfUsbFree=chasSupervisionRfsDfUsbFree, alaChasBpsPowerSupplyModuleType=alaChasBpsPowerSupplyModuleType, chasSupervisionCmmCertifiedStatus=chasSupervisionCmmCertifiedStatus, chasControlRedundancyTime=chasControlRedundancyTime, chasNI6HardwareBoardTemp=chasNI6HardwareBoardTemp, alcatelIND1ChassisMIBNotifications=alcatelIND1ChassisMIBNotifications, chasEntPhysNiNum=chasEntPhysNiNum, ChasTrapsBPSFwType=ChasTrapsBPSFwType, chasSupervisionRfsDfEntry=chasSupervisionRfsDfEntry, chasEntTempDangerThreshold=chasEntTempDangerThreshold, chassisTrapsObjectNumber=chassisTrapsObjectNumber, chasControlNextRunningVersion=chasControlNextRunningVersion, chasControlCertifyStatus=chasControlCertifyStatus, ChasTrapsBPSEventAlert=ChasTrapsBPSEventAlert, chasControlModuleTable=chasControlModuleTable, chasCFMDHardwareBoardTemp=chasCFMDHardwareBoardTemp, chasSupervisionRfsLsTable=chasSupervisionRfsLsTable, AlaChasBpsShelfId=AlaChasBpsShelfId, chasSupervisionRfsLsDirName=chasSupervisionRfsLsDirName, chasSupervisionRfsDfSlot=chasSupervisionRfsDfSlot, chasGlobalControl=chasGlobalControl, alaChasBpsConnectorShelfId=alaChasBpsConnectorShelfId, chassisTrapsStateChange=chassisTrapsStateChange, alaChasBpsConnectorNum=alaChasBpsConnectorNum, chasControlSynchronizationStatus=chasControlSynchronizationStatus, alaChasBpsPowerSupplyName=alaChasBpsPowerSupplyName, chasEntPhysUbootRev=chasEntPhysUbootRev, chassisPhysNotificationGroup=chassisPhysNotificationGroup, alaChasBpsShelfId=alaChasBpsShelfId, chasEntPhysPower=chasEntPhysPower, PYSNMP_MODULE_ID=alcatelIND1ChassisMIB, chassisTrapsStrLevel=chassisTrapsStrLevel, chasControlReloadStatus=chasControlReloadStatus, chassisTrapsObjectType=chassisTrapsObjectType, chassisTrapsAlertNumber=chassisTrapsAlertNumber, chasCFMAHardwareBoardTemp=chasCFMAHardwareBoardTemp, alaChasBpsPoeTotalAvailablePower=alaChasBpsPoeTotalAvailablePower, alaChasBpsModeEntry=alaChasBpsModeEntry, chassisTrapsObj=chassisTrapsObj, chasControlRedundantEntry=chasControlRedundantEntry, chasEntPhysLedStatusFan=chasEntPhysLedStatusFan, chasCPMBHardwareBoardTemp=chasCPMBHardwareBoardTemp, chasSupervisionRfsCommandsSrcFileName=chasSupervisionRfsCommandsSrcFileName, alaChasBpsFwEntry=alaChasBpsFwEntry, ChassisTrapsStrLevel=ChassisTrapsStrLevel, chasEntPhysLedStatusPS=chasEntPhysLedStatusPS, chasEntPhysPowerType=chasEntPhysPowerType, chasEntPhysicalTable=chasEntPhysicalTable, alaChasEntPhysFanEntry=alaChasEntPhysFanEntry, alcatelIND1ChassisMIBCompliance=alcatelIND1ChassisMIBCompliance, chasFTAHardwareBoardTemp=chasFTAHardwareBoardTemp, chasEntPhysAsic5Rev=chasEntPhysAsic5Rev, ChassisTrapsAlertNumber=ChassisTrapsAlertNumber, alcatelIND1ChassisMIBGroups=alcatelIND1ChassisMIBGroups, chasEntPhysAsic3Rev=chasEntPhysAsic3Rev, chasEntTempStatus=chasEntTempStatus, chasGlobalControlDelayedResetAll=chasGlobalControlDelayedResetAll, ChassisTrapsStrAppID=ChassisTrapsStrAppID, chasTrapsBPSStateChange=chasTrapsBPSStateChange, chasControlChassisId=chasControlChassisId, chasTrapsNiBPSFETStateChange=chasTrapsNiBPSFETStateChange, chasSupervisionCmmCertifiedTable=chasSupervisionCmmCertifiedTable, alcatelIND1ChassisPhysMIBConformance=alcatelIND1ChassisPhysMIBConformance, chasSupervisionRfsCommandsRlsFileName=chasSupervisionRfsCommandsRlsFileName, chasEntPhysCpuModel=chasEntPhysCpuModel, chasEntPhysWaveLen=chasEntPhysWaveLen, ChassisTrapsObjectType=ChassisTrapsObjectType, chasTrapsNiRqstdBpsSysPower=chasTrapsNiRqstdBpsSysPower, chasEntPhysLedStatusBackupPS=chasEntPhysLedStatusBackupPS, alaChasBpsSerialNum=alaChasBpsSerialNum, alaChasBpsTotalPowerAllocGroup=alaChasBpsTotalPowerAllocGroup, chasSupervisionRfsCommandsProcessingState=chasSupervisionRfsCommandsProcessingState, alaChasBpsPowerSupplyDescr=alaChasBpsPowerSupplyDescr, alaChasEntPhysFanTable=alaChasEntPhysFanTable, alaChasBpsConnectorPriorityTable=alaChasBpsConnectorPriorityTable, chasSupervisionRfsDfTable=chasSupervisionRfsDfTable, chasTrapsNiGrantdBpsSysPower=chasTrapsNiGrantdBpsSysPower, chasSupervisionRfsLsFileType=chasSupervisionRfsLsFileType, chassisTemperatureGroup=chassisTemperatureGroup, chasEntPhysAsic6Rev=chasEntPhysAsic6Rev, chasSupervisionCmmCertifiedEntry=chasSupervisionCmmCertifiedEntry, chasSupervisionRfsLsEntry=chasSupervisionRfsLsEntry, alaChasBpsPowerSupplyPartNumber=alaChasBpsPowerSupplyPartNumber, alaChasBpsPoeTotalAllocation=alaChasBpsPoeTotalAllocation, chasEntTempCurrent=chasEntTempCurrent, alcatelIND1ChassisMIB=alcatelIND1ChassisMIB, chasEntPhysMacAddress=chasEntPhysMacAddress, chasTrapsBPSFwVersion=chasTrapsBPSFwVersion, chasSupervisionRfsLsFileName=chasSupervisionRfsLsFileName, chasEntPhysLedStatusSecondaryCMM=chasEntPhysLedStatusSecondaryCMM, chasSupervisionRfsDfFlashSize=chasSupervisionRfsDfFlashSize, chasControlEmpIpAddress=chasControlEmpIpAddress, chasEntPhysOperStatus=chasEntPhysOperStatus, chasSupervisionFlashUsed=chasSupervisionFlashUsed, chasNI8HardwareBoardTemp=chasNI8HardwareBoardTemp, alaChasBpsObjects=alaChasBpsObjects, ChasTrapsBPSPowerSupply=ChasTrapsBPSPowerSupply, chasEntPhysAsic1Rev=chasEntPhysAsic1Rev, chasPowerSupplyRedundancyReserve=chasPowerSupplyRedundancyReserve, chasGlobalControlUpdateFirmware=chasGlobalControlUpdateFirmware, alaChasBpsPowerSupplyGroup=alaChasBpsPowerSupplyGroup, chasFreeSlots=chasFreeSlots, chasTrapBPSShelfId=chasTrapBPSShelfId, chassisNotificationGroup=chassisNotificationGroup, chassisTrapsStr=chassisTrapsStr, alaChasBpsFwGroup=alaChasBpsFwGroup, ChassisTrapsStrErrorNb=ChassisTrapsStrErrorNb, chasEntPhysAdminStatus=chasEntPhysAdminStatus, alcatelIND1ChassisPhysMIBObjects=alcatelIND1ChassisPhysMIBObjects, chasControlDelayedResetAll=chasControlDelayedResetAll, chasCFMCHardwareBoardTemp=chasCFMCHardwareBoardTemp, ChasTrapsBPSFetState=ChasTrapsBPSFetState, chasFTBHardwareBoardTemp=chasFTBHardwareBoardTemp, chasEntPhysLedStatusInternalPS=chasEntPhysLedStatusInternalPS, chasEntPhysUbootMinibootRev=chasEntPhysUbootMinibootRev, chasEntPhysDaughterFpga1Rev=chasEntPhysDaughterFpga1Rev, ChassisTrapsStrSnapID=ChassisTrapsStrSnapID, chassisTrapsAlertDescr=chassisTrapsAlertDescr, chasEntPhysAsic4Rev=chasEntPhysAsic4Rev, alaChasEntPhysFanStatus=alaChasEntPhysFanStatus, alaChasBpsPowerSupplyMfgDate=alaChasBpsPowerSupplyMfgDate, chasPowerLeft=chasPowerLeft, ChassisTrapsStrfileLineNb=ChassisTrapsStrfileLineNb, alaChasBpsCpldRev=alaChasBpsCpldRev, alcatelIND1ChassisPhysMIBGroups=alcatelIND1ChassisPhysMIBGroups, chasEntTemperatureTable=chasEntTemperatureTable, chasControlRedundantGroup=chasControlRedundantGroup, chassisSupervisionRfsCommandsGroup=chassisSupervisionRfsCommandsGroup, chasChassisEntry=chasChassisEntry)
mibBuilder.exportSymbols("ALCATEL-ENT1-CHASSIS-MIB", chasSupervisionCmmCertifiedEntryGroup=chasSupervisionCmmCertifiedEntryGroup, alaChasEntPhysFanLocalIndex=alaChasEntPhysFanLocalIndex, chasSupervisionRfsLsSlot=chasSupervisionRfsLsSlot, chasSupervisionRfsCommandsDestFileName=chasSupervisionRfsCommandsDestFileName, alaChasBpsModeGroup=alaChasBpsModeGroup, chasEntPhysDaughterFpga2Rev=chasEntPhysDaughterFpga2Rev, chasSupervisionCmmNum=chasSupervisionCmmNum, alaChasBpsMode=alaChasBpsMode, chasSupervisionFlashSize=chasSupervisionFlashSize)
