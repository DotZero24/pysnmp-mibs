...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MODEM-MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:23:24 2025
...
_CmSystemWatchdogTime_Type.__name__ = "Integer32"
...
_CmATModePermit_Type.__name__ = "TruthValue"
...
_CmStatusPolling_Type.__name__ = "TruthValue"
...
_CmBusyOutRequest_Type.__name__ = "TruthValue"
...
_CmShutdown_Type.__name__ = "TruthValue"
...
_CmHoldReset_Type.__name__ = "TruthValue"
...
_CmBad_Type.__name__ = "TruthValue"
...
ciscoModemMgmtMIBCompliance.setObjects(
      *(("CISCO-MODEM-MGMT-MIB", "cmSystemInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmGroupInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmManagedLineInfoGroup"))
)
if mibBuilder.loadTexts:
...
ciscoModemMgmtMIBComplianceRev1.setObjects(
      *(("CISCO-MODEM-MGMT-MIB", "cmSystemInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmGroupInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmManagedLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineSpeedInfoGroup"))
)
if mibBuilder.loadTexts:
...
ciscoModemMgmtMIBComplianceRev2.setObjects(
      *(("CISCO-MODEM-MGMT-MIB", "cmSystemInfoGroupRev1"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmGroupInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmManagedLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineSpeedInfoGroup"))
...
ciscoModemMgmtMIBComplianceRev3.setObjects(
      *(("CISCO-MODEM-MGMT-MIB", "cmSystemInfoGroupRev1"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmGroupInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmManagedLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineSpeedInfoGroupRev1"))
)
if mibBuilder.loadTexts:
...
ciscoModemMgmtMIBComplianceRev4.setObjects(
      *(("CISCO-MODEM-MGMT-MIB", "cmGroupInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineSpeedInfoGroupRev1"),
        ("CISCO-MODEM-MGMT-MIB", "cmManagedLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineInfoGroup"),
...
ciscoModemMgmtMIBComplianceRev5.setObjects(
      *(("CISCO-MODEM-MGMT-MIB", "cmGroupInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineSpeedInfoGroupRev1"),
        ("CISCO-MODEM-MGMT-MIB", "cmManagedLineInfoGroupRev1"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmSystemInfoGroupRev1"),
        ("CISCO-MODEM-MGMT-MIB", "cmNotificationConfigGroup"),
...
ciscoModemMgmtMIBComplianceRev6.setObjects(
      *(("CISCO-MODEM-MGMT-MIB", "cmGroupInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineSpeedInfoGroupRev2"),
        ("CISCO-MODEM-MGMT-MIB", "cmManagedLineInfoGroupRev2"),
        ("CISCO-MODEM-MGMT-MIB", "cmLineInfoGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmSystemInfoGroupRev1"),
        ("CISCO-MODEM-MGMT-MIB", "cmNotificationConfigGroup"),
        ("CISCO-MODEM-MGMT-MIB", "cmNotificationGroup"))
