...
mibBuilder.exportSymbols("CISCO-MODEM-MGMT-MIB", ciscoModemMgmtMIBObjects=ciscoModemMgmtMIBObjects, cmGroupTable=cmGroupTable, cmBad=cmBad, cmInitialLineSpeed=cmInitialLineSpeed, cmNotificationConfigGroup=cmNotificationConfigGroup, cmSlotIndex=cmSlotIndex, cmLineStatusEntry=cmLineStatusEntry, cmGroupMemberTable=cmGroupMemberTable, cmRingNoAnswers=cmRingNoAnswers, cmLineStatisticsEntry=cmLineStatisticsEntry, cmLineSpeedStatisticsEntry=cmLineSpeedStatisticsEntry, cmTotalCallDuration=cmTotalCallDuration, cmSystemModemsOffline=cmSystemModemsOffline, cmWatchdogTimeouts=cmWatchdogTimeouts, cmLineSpeedStatisticsTable=cmLineSpeedStatisticsTable, cmLineSpeedInfoGroupRev1=cmLineSpeedInfoGroupRev1, cmSystemModemsInUse=cmSystemModemsInUse, cmInitialTxLineConnections=cmInitialTxLineConnections, cmStateNotification=cmStateNotification, cmStateNotifyEnable=cmStateNotifyEnable, cmGroupInfo=cmGroupInfo, cmLineConfigEntry=cmLineConfigEntry, cmIncomingConnectionCompletions=cmIncomingConnectionCompletions, cmSystemInfoGroupRev1=cmSystemInfoGroupRev1, cmNoCarriers=cmNoCarriers, cmSystemModemsUnavailable=cmSystemModemsUnavailable, cmState=cmState, cmProtocolUsed=cmProtocolUsed, cmMIBNotifications=cmMIBNotifications, ciscoModemMgmtMIBCompliances=ciscoModemMgmtMIBCompliances, cmRXRate=cmRXRate, cmIncomingConnectionFailures=cmIncomingConnectionFailures, ciscoModemMgmtMIBComplianceRev6=ciscoModemMgmtMIBComplianceRev6, cmSystemStatusPollTime=cmSystemStatusPollTime, cmManagedLineInfoGroupRev1=cmManagedLineInfoGroupRev1, cmDialTimeouts=cmDialTimeouts, ciscoModemMgmtMIBComplianceRev2=ciscoModemMgmtMIBComplianceRev2, cmProductDetails=cmProductDetails, cm2400OrLessConnections=cm2400OrLessConnections, cmHoldReset=cmHoldReset, cmOutgoingConnectionCompletions=cmOutgoingConnectionCompletions, cmManageable=cmManageable, cmSystemConfiguredGroup=cmSystemConfiguredGroup, cmSystemInstalledModem=cmSystemInstalledModem, cmDisconnectReason=cmDisconnectReason, cmATModePermit=cmATModePermit, cmGroup=cmGroup, cmBusyOutRequest=cmBusyOutRequest, ciscoModemMgmtMIBComplianceRev4=ciscoModemMgmtMIBComplianceRev4, cmLineStatisticsTable=cmLineStatisticsTable, cmLineConfigTable=cmLineConfigTable, cmInitialLineConnections=cmInitialLineConnections, cmOutgoingConnectionFailures=cmOutgoingConnectionFailures, cmSystemModemsDead=cmSystemModemsDead, ciscoModemMgmtMIBComplianceRev1=ciscoModemMgmtMIBComplianceRev1, ciscoModemMgmtMIBComplianceRev5=ciscoModemMgmtMIBComplianceRev5, cmInterface=cmInterface, cmLineSpeedInfoGroup=cmLineSpeedInfoGroup, cmLineStatusTable=cmLineStatusTable, cmCallDuration=cmCallDuration, cmNotificationGroup=cmNotificationGroup, cmNoDialTones=cmNoDialTones, cmShutdown=cmShutdown, cmCallDirection=cmCallDirection, cmSystemModemsAvailable=cmSystemModemsAvailable, cmCallPhoneNumber=cmCallPhoneNumber, ciscoModemMgmtMIBCompliance=ciscoModemMgmtMIBCompliance, cmTXAnalogSignalLevel=cmTXAnalogSignalLevel, cmLinkFailures=cmLinkFailures, cmManufacturerID=cmManufacturerID, cmMIBNotificationPrefix=cmMIBNotificationPrefix, cmManagedLineInfoGroup=cmManagedLineInfoGroup, cmGroupInfoGroup=cmGroupInfoGroup, cmPortIndex=cmPortIndex, cmLineInfo=cmLineInfo, cmModulationSchemeUsed=cmModulationSchemeUsed, ciscoModemMgmtMIBGroups=ciscoModemMgmtMIBGroups, cmProtocolErrors=cmProtocolErrors, cmFailedDialAttempts=cmFailedDialAttempts, cmGroupEntry=cmGroupEntry, PYSNMP_MODULE_ID=ciscoModemMgmtMIB, cmRXAnalogSignalLevel=cmRXAnalogSignalLevel, cmManagedLineInfoGroupRev2=cmManagedLineInfoGroupRev2, cmTXRate=cmTXRate, cmGreaterThan14400Connections=cmGreaterThan14400Connections, ciscoModemMgmtMIBComplianceRev3=ciscoModemMgmtMIBComplianceRev3, cmSystemWatchdogTime=cmSystemWatchdogTime, cmNotificationConfig=cmNotificationConfig, cmLineInfoGroup=cmLineInfoGroup, cmInitialRxLineConnections=cmInitialRxLineConnections, cmGroupTotalDevices=cmGroupTotalDevices, ciscoModemMgmtMIB=ciscoModemMgmtMIB, cmGroupIndex=cmGroupIndex, cm2400To14400Connections=cm2400To14400Connections, cmLineSpeedInfoGroupRev2=cmLineSpeedInfoGroupRev2, cmSystemInfo=cmSystemInfo, cmSystemInfoGroup=cmSystemInfoGroup, cmGroupMemberEntry=cmGroupMemberEntry, cmCallerID=cmCallerID, cmSystemMaxRetries=cmSystemMaxRetries, ciscoModemMgmtMIBConformance=ciscoModemMgmtMIBConformance, cmPollingTimeouts=cmPollingTimeouts, cmStatusPolling=cmStatusPolling)
