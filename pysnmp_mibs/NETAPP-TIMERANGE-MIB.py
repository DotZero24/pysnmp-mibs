...
fastPathTimeRangeGroup=_FastPathTimeRangeGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,53,1))
...
timeRangeAdminMode=_TimeRangeAdminMode_Object((1,3,6,1,4,1,789,4413,1,1,53,1,1),_TimeRangeAdminMode_Type())
...
timeRangeIndexNextFree=_TimeRangeIndexNextFree_Object((1,3,6,1,4,1,789,4413,1,1,53,1,2),_TimeRangeIndexNextFree_Type())
...
timeRangeTable=_TimeRangeTable_Object((1,3,6,1,4,1,789,4413,1,1,53,1,3))
if mibBuilder.loadTexts:timeRangeTable.setStatus(_A)
_TimeRangeEntry_Object=MibTableRow
timeRangeEntry=_TimeRangeEntry_Object((1,3,6,1,4,1,789,4413,1,1,53,1,3,1))
...
timeRangeIndex=_TimeRangeIndex_Object((1,3,6,1,4,1,789,4413,1,1,53,1,3,1,1),_TimeRangeIndex_Type())
...
timeRangeName=_TimeRangeName_Object((1,3,6,1,4,1,789,4413,1,1,53,1,3,1,2),_TimeRangeName_Type())
...
timeRangeOperState=_TimeRangeOperState_Object((1,3,6,1,4,1,789,4413,1,1,53,1,3,1,3),_TimeRangeOperState_Type())
...
timeRangeStatus=_TimeRangeStatus_Object((1,3,6,1,4,1,789,4413,1,1,53,1,3,1,4),_TimeRangeStatus_Type())
...
timeRangeAbsoluteEntryTable=_TimeRangeAbsoluteEntryTable_Object((1,3,6,1,4,1,789,4413,1,1,53,1,4))
if mibBuilder.loadTexts:timeRangeAbsoluteEntryTable.setStatus(_A)
_TimeRangeAbsoluteEntry_Object=MibTableRow
timeRangeAbsoluteEntry=_TimeRangeAbsoluteEntry_Object((1,3,6,1,4,1,789,4413,1,1,53,1,4,1))
...
timeRangeAbsoluteEntryIndex=_TimeRangeAbsoluteEntryIndex_Object((1,3,6,1,4,1,789,4413,1,1,53,1,4,1,1),_TimeRangeAbsoluteEntryIndex_Type())
...
timeRangeAbsoluteStartDateAndTime=_TimeRangeAbsoluteStartDateAndTime_Object((1,3,6,1,4,1,789,4413,1,1,53,1,4,1,2),_TimeRangeAbsoluteStartDateAndTime_Type())
...
timeRangeAbsoluteEndDateAndTime=_TimeRangeAbsoluteEndDateAndTime_Object((1,3,6,1,4,1,789,4413,1,1,53,1,4,1,3),_TimeRangeAbsoluteEndDateAndTime_Type())
...
timeRangeAbsoluteStatus=_TimeRangeAbsoluteStatus_Object((1,3,6,1,4,1,789,4413,1,1,53,1,4,1,4),_TimeRangeAbsoluteStatus_Type())
...
timeRangePeriodicEntryTable=_TimeRangePeriodicEntryTable_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5))
if mibBuilder.loadTexts:timeRangePeriodicEntryTable.setStatus(_A)
_TimeRangePeriodicEntry_Object=MibTableRow
timeRangePeriodicEntry=_TimeRangePeriodicEntry_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1))
...
timeRangePeriodicEntryIndex=_TimeRangePeriodicEntryIndex_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,1),_TimeRangePeriodicEntryIndex_Type())
...
timeRangePeriodicFrequency=_TimeRangePeriodicFrequency_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,2),_TimeRangePeriodicFrequency_Type())
...
timeRangePeriodicPattern=_TimeRangePeriodicPattern_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,3),_TimeRangePeriodicPattern_Type())
...
timeRangePeriodicDayMask=_TimeRangePeriodicDayMask_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,4),_TimeRangePeriodicDayMask_Type())
...
timeRangePeriodicStartDate=_TimeRangePeriodicStartDate_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,5),_TimeRangePeriodicStartDate_Type())
...
timeRangePeriodicStartDay=_TimeRangePeriodicStartDay_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,6),_TimeRangePeriodicStartDay_Type())
...
timeRangePeriodicStartTime=_TimeRangePeriodicStartTime_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,7),_TimeRangePeriodicStartTime_Type())
...
timeRangePeriodicEndDate=_TimeRangePeriodicEndDate_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,8),_TimeRangePeriodicEndDate_Type())
...
timeRangePeriodicEndDay=_TimeRangePeriodicEndDay_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,9),_TimeRangePeriodicEndDay_Type())
...
timeRangePeriodicEndTime=_TimeRangePeriodicEndTime_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,10),_TimeRangePeriodicEndTime_Type())
...
timeRangePeriodicStatus=_TimeRangePeriodicStatus_Object((1,3,6,1,4,1,789,4413,1,1,53,1,5,1,11),_TimeRangePeriodicStatus_Type())
