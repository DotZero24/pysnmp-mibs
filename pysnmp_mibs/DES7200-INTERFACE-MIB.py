...
ModuleIdentity, Gauge, Counter64, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, iso, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge", "Counter64", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "iso", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("DES7200-INTERFACE-MIB", myIfIpEntryStatus=myIfIpEntryStatus, myIfManageStatus=myIfManageStatus, myInterfaceMIBCompliances=myInterfaceMIBCompliances, myPortTypeChooseEntry=myPortTypeChooseEntry, myPortTypeChooseTable=myPortTypeChooseTable, myIfMode=myIfMode, myInterfaceMIBConformance=myInterfaceMIBConformance, lineDetectPosition=lineDetectPosition, myPortTypeChooseType=myPortTypeChooseType, myIfFlowControlOperStatus=myIfFlowControlOperStatus, myIfErrorStatus=myIfErrorStatus, myIfMTUEntry=myIfMTUEntry, myInterfaceMIBGroup=myInterfaceMIBGroup, myPortTypeChooseMibGroup=myPortTypeChooseMibGroup, myIfMTUMibGroup=myIfMTUMibGroup, myIfAdminDuplex=myIfAdminDuplex, myIfMediumType=myIfMediumType, myIfLineDetect=myIfLineDetect, myIfTable=myIfTable, myIfIpIfIndex=myIfIpIfIndex, myIfConfigMIBObjects=myIfConfigMIBObjects, myIfAvailableBWEntry=myIfAvailableBWEntry, myInterfaceTraps=myInterfaceTraps, myIfMTU=myIfMTU, myIfLineDetectGroup=myIfLineDetectGroup, myIfAdminSpeed=myIfAdminSpeed, myIfMTUIndex=myIfMTUIndex, myIfIndex=myIfIndex, myIfStatusLoopBackExamine=myIfStatusLoopBackExamine, lineDetectStatus=lineDetectStatus, myInterfaceMIBGroups=myInterfaceMIBGroups, myInterfaceMIB=myInterfaceMIB, myIfEntry=myIfEntry, myIfStatusEntry=myIfStatusEntry, myIfOperSpeed=myIfOperSpeed, lineQualityDetect=lineQualityDetect, myIfLayer=myIfLayer, myIfFlowControlAdminStatus=myIfFlowControlAdminStatus, PYSNMP_MODULE_ID=myInterfaceMIB, myIfAvailableBWMibGroup=myIfAvailableBWMibGroup, myGlobalIfDisableRecovery=myGlobalIfDisableRecovery, myPortTypeChooseIndex=myPortTypeChooseIndex, myIfAvailableBWIfBW=myIfAvailableBWIfBW, myInterfaceMIBCompliance=myInterfaceMIBCompliance, myIfCounterClear=myIfCounterClear, myIfIpMask=myIfIpMask, myIfEntryStatus=myIfEntryStatus, myIfMTUTable=myIfMTUTable, myIfAvailableBWIfIndex=myIfAvailableBWIfIndex, myIfIpId=myIfIpId, myIfIpTable=myIfIpTable, myIfIpBroadcast=myIfIpBroadcast, myIfAvailableBWTable=myIfAvailableBWTable, myIfIpEntry=myIfIpEntry, myIfStatusTable=myIfStatusTable, myIfOperDuplex=myIfOperDuplex, myIfPortType=myIfPortType, myIfStatusIndex=myIfStatusIndex, myIfIp=myIfIp)
