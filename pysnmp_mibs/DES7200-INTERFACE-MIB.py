#
# PySNMP MIB module DES7200-INTERFACE-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/d-link/DES7200-INTERFACE-MIB
...
MibIdentifier, NotificationType, Integer32, Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, TimeTicks, Counter64, Gauge, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Integer32", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "TimeTicks", "Counter64", "Gauge", "Gauge32")
...
myIfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 1, 1, 1), ).setIndexNames((0, "DES7200-INTERFACE-MIB", "myIfIndex"))
...
myIfIpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 1, 2, 1), ).setIndexNames((0, "DES7200-INTERFACE-MIB", "myIfIpIfIndex"), (0, "DES7200-INTERFACE-MIB", "myIfIpId"), (0, "DES7200-INTERFACE-MIB", "myIfIp"))
...
myIfStatusEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 1, 3, 1), ).setIndexNames((0, "DES7200-INTERFACE-MIB", "myIfStatusIndex"))
...
myPortTypeChooseEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 1, 5, 1), ).setIndexNames((0, "DES7200-INTERFACE-MIB", "myPortTypeChooseIndex"))
...
myIfMTUEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 1, 6, 1), ).setIndexNames((0, "DES7200-INTERFACE-MIB", "myIfMTUIndex"))
...
myIfAvailableBWEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 1, 7, 1), ).setIndexNames((0, "DES7200-INTERFACE-MIB", "myIfAvailableBWIfIndex"))
...
lineQualityDetect = NotificationType((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 2, 3)).setObjects(("IF-MIB", "ifIndex"), ("DES7200-INTERFACE-MIB", "lineDetectStatus"), ("DES7200-INTERFACE-MIB", "lineDetectPosition"))
...
myInterfaceMIBCompliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 3, 1, 1)).setObjects(("DES7200-INTERFACE-MIB", "myInterfaceMIBGroup"), ("DES7200-INTERFACE-MIB", "myPortTypeChooseMibGroup"), ("DES7200-INTERFACE-MIB", "myIfMTUMibGroup"), ("DES7200-INTERFACE-MIB", "myIfLineDetectGroup"), ("DES7200-INTERFACE-MIB", "myIfAvailableBWMibGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    myInterfaceMIBCompliance = myInterfaceMIBCompliance.setStatus('current')
myInterfaceMIBGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 3, 2, 1)).setObjects(("DES7200-INTERFACE-MIB", "myIfIndex"), ("DES7200-INTERFACE-MIB", "myIfPortType"), ("DES7200-INTERFACE-MIB", "myIfFlowControlAdminStatus"), ("DES7200-INTERFACE-MIB", "myIfFlowControlOperStatus"), ("DES7200-INTERFACE-MIB", "myIfAdminSpeed"), ("DES7200-INTERFACE-MIB", "myIfAdminDuplex"), ("DES7200-INTERFACE-MIB", "myIfOperSpeed"), ("DES7200-INTERFACE-MIB", "myIfOperDuplex"), ("DES7200-INTERFACE-MIB", "myIfManageStatus"), ("DES7200-INTERFACE-MIB", "myIfIpBroadcast"), ("DES7200-INTERFACE-MIB", "myIfLayer"), ("DES7200-INTERFACE-MIB", "myIfMode"), ("DES7200-INTERFACE-MIB", "myIfCounterClear"), ("DES7200-INTERFACE-MIB", "myIfEntryStatus"), ("DES7200-INTERFACE-MIB", "myIfMediumType"), ("DES7200-INTERFACE-MIB", "myIfIpIfIndex"), ("DES7200-INTERFACE-MIB", "myIfIpId"), ("DES7200-INTERFACE-MIB", "myIfIp"), ("DES7200-INTERFACE-MIB", "myIfIpMask"), ("DES7200-INTERFACE-MIB", "myIfIpEntryStatus"), ("DES7200-INTERFACE-MIB", "myIfStatusIndex"), ("DES7200-INTERFACE-MIB", "myIfStatusLoopBackExamine"), ("DES7200-INTERFACE-MIB", "myIfErrorStatus"), ("DES7200-INTERFACE-MIB", "myGlobalIfDisableRecovery"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    myInterfaceMIBGroup = myInterfaceMIBGroup.setStatus('current')
myPortTypeChooseMibGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 3, 2, 2)).setObjects(("DES7200-INTERFACE-MIB", "myPortTypeChooseIndex"), ("DES7200-INTERFACE-MIB", "myPortTypeChooseType"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    myPortTypeChooseMibGroup = myPortTypeChooseMibGroup.setStatus('current')
myIfMTUMibGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 3, 2, 3)).setObjects(("DES7200-INTERFACE-MIB", "myIfMTUIndex"), ("DES7200-INTERFACE-MIB", "myIfMTU"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    myIfMTUMibGroup = myIfMTUMibGroup.setStatus('current')
myIfLineDetectGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 3, 2, 4)).setObjects(("DES7200-INTERFACE-MIB", "myIfLineDetect"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    myIfLineDetectGroup = myIfLineDetectGroup.setStatus('current')
myIfAvailableBWMibGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 171, 10, 97, 2, 10, 3, 2, 5)).setObjects(("DES7200-INTERFACE-MIB", "myIfAvailableBWIfIndex"), ("DES7200-INTERFACE-MIB", "myIfAvailableBWIfBW"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    myIfAvailableBWMibGroup = myIfAvailableBWMibGroup.setStatus('current')
mibBuilder.exportSymbols("DES7200-INTERFACE-MIB", myIfLineDetectGroup=myIfLineDetectGroup, lineDetectStatus=lineDetectStatus, myInterfaceMIBConformance=myInterfaceMIBConformance, myIfAdminDuplex=myIfAdminDuplex, myIfMTUTable=myIfMTUTable, myInterfaceMIBGroup=myInterfaceMIBGroup, myIfFlowControlOperStatus=myIfFlowControlOperStatus, myIfIpTable=myIfIpTable, myIfAvailableBWIfIndex=myIfAvailableBWIfIndex, myIfCounterClear=myIfCounterClear, myGlobalIfDisableRecovery=myGlobalIfDisableRecovery, myIfAvailableBWIfBW=myIfAvailableBWIfBW, myIfStatusLoopBackExamine=myIfStatusLoopBackExamine, myIfStatusEntry=myIfStatusEntry, myIfAdminSpeed=myIfAdminSpeed, myIfPortType=myIfPortType, PYSNMP_MODULE_ID=myInterfaceMIB, myIfFlowControlAdminStatus=myIfFlowControlAdminStatus, myIfIpId=myIfIpId, myIfIndex=myIfIndex, myPortTypeChooseType=myPortTypeChooseType, myIfMTUIndex=myIfMTUIndex, myIfAvailableBWMibGroup=myIfAvailableBWMibGroup, myIfStatusTable=myIfStatusTable, myIfMediumType=myIfMediumType, myPortTypeChooseMibGroup=myPortTypeChooseMibGroup, myIfOperSpeed=myIfOperSpeed, myIfIpIfIndex=myIfIpIfIndex, myPortTypeChooseIndex=myPortTypeChooseIndex, myIfAvailableBWTable=myIfAvailableBWTable, myIfLayer=myIfLayer, myIfIpMask=myIfIpMask, myIfEntryStatus=myIfEntryStatus, myInterfaceMIB=myInterfaceMIB, myIfMTUMibGroup=myIfMTUMibGroup, myInterfaceTraps=myInterfaceTraps, lineQualityDetect=lineQualityDetect, myIfOperDuplex=myIfOperDuplex, myPortTypeChooseEntry=myPortTypeChooseEntry, myInterfaceMIBGroups=myInterfaceMIBGroups, myIfIp=myIfIp, myIfErrorStatus=myIfErrorStatus, myIfEntry=myIfEntry, myIfIpEntry=myIfIpEntry, myIfIpEntryStatus=myIfIpEntryStatus, myInterfaceMIBCompliances=myInterfaceMIBCompliances, myIfStatusIndex=myIfStatusIndex, myIfMTUEntry=myIfMTUEntry, myIfLineDetect=myIfLineDetect, myIfMTU=myIfMTU, myIfConfigMIBObjects=myIfConfigMIBObjects, myIfAvailableBWEntry=myIfAvailableBWEntry, myInterfaceMIBCompliance=myInterfaceMIBCompliance, lineDetectPosition=lineDetectPosition, myIfTable=myIfTable, myIfMode=myIfMode, myIfIpBroadcast=myIfIpBroadcast, myIfManageStatus=myIfManageStatus, myPortTypeChooseTable=myPortTypeChooseTable)
