...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/nokia/TIMETRA-SAS-SYSTEM-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:37:10 2025
...
tmnxChassisEntry, tmnxChassisPowerSupplyEntry, TmnxSlotNumOrZero, tmnxHwEntry, tmnxChassisPowerSupplyInputStatus, tmnxHwName, tmnxCpmCardEntry, tmnxHwTemperature, tmnxChassisIndex, tmnxCardEntry, tmnxChassisNotifyHwIndex, tmnxHwClass, tmnxHwOperState, tmnxChassisPowerSupplyOutputStatus, TmnxLEDState, tmnxHwID, tmnxChassisFanEntry = mibBuilder.importSymbols("TIMETRA-CHASSIS-MIB", "tmnxChassisEntry", "tmnxChassisPowerSupplyEntry", "TmnxSlotNumOrZero", "tmnxHwEntry", "tmnxChassisPowerSupplyInputStatus", "tmnxHwName", "tmnxCpmCardEntry", "tmnxHwTemperature", "tmnxChassisIndex", "tmnxCardEntry", "tmnxChassisNotifyHwIndex", "tmnxHwClass", "tmnxHwOperState", "tmnxChassisPowerSupplyOutputStatus", "TmnxLEDState", "tmnxHwID", "tmnxChassisFanEntry")
...
TmnxAdminState, TTcpUdpPort, TPolicyID, TSysResource, TmnxActionType, TPIRRate, TmnxPortID, TNamedItem, TmnxVwmCardType, TItemDescription, TmnxOperState, IpAddressPrefixLength, ServiceOperStatus, TCIRRate, TmnxOperGrpHoldUpTime, TmnxOperGrpHoldDownTime, TNamedItemOrEmpty, TBurstSize = mibBuilder.importSymbols("TN-TC-MIB", "TmnxAdminState", "TTcpUdpPort", "TPolicyID", "TSysResource", "TmnxActionType", "TPIRRate", "TmnxPortID", "TNamedItem", "TmnxVwmCardType", "TItemDescription", "TmnxOperState", "IpAddressPrefixLength", "ServiceOperStatus", "TCIRRate", "TmnxOperGrpHoldUpTime", "TmnxOperGrpHoldDownTime", "TNamedItemOrEmpty", "TBurstSize")
...
mibBuilder.exportSymbols("TIMETRA-SAS-SYSTEM-MIB", sysResEgrSapEgrClassIpv4Ipv6=sysResEgrSapEgrClassIpv4Ipv6, tResDecommEntry=tResDecommEntry, tmnxLoginUserSrcIPAddress=tmnxLoginUserSrcIPAddress, sysG8032FastFlood=sysG8032FastFlood, tmnxVwmShelfCardCfgError=tmnxVwmShelfCardCfgError, tmnxHwExtnTable=tmnxHwExtnTable, sysTestHdNoServPort=sysTestHdNoServPort, sbiEthMgmtStaticRouteTable=sbiEthMgmtStaticRouteTable, sysResEgrTcamEgrAcl64bitIpv6Only=sysResEgrTcamEgrAcl64bitIpv6Only, sysResRouterEcmpMaxRoutesDstOperVal=sysResRouterEcmpMaxRoutesDstOperVal, sysOperGrpHoldUpTimeRemain=sysOperGrpHoldUpTimeRemain, tmnxSASSysSecConformance=tmnxSASSysSecConformance, sbiEthMgmtActiveIpMask=sbiEthMgmtActiveIpMask, sbiEthMgmtStaticRouteNextHop=sbiEthMgmtStaticRouteNextHop, tmnxChassisUpdateGoldenBootstrapImage=tmnxChassisUpdateGoldenBootstrapImage, tResPlcyLastChanged=tResPlcyLastChanged, sysResIngTcamIngAcl128bitIpv4Ipv6=sysResIngTcamIngAcl128bitIpv4Ipv6, tmnxSASSysSecNotifyV4v0Group=tmnxSASSysSecNotifyV4v0Group, tResPlcyTable=tResPlcyTable, sysOperGrpHoldDownTimeRemain=sysOperGrpHoldDownTimeRemain, tmnxFabricPolicyCIR=tmnxFabricPolicyCIR, tCardResOperIngTcamQosSapIngIpv4Ipv6=tCardResOperIngTcamQosSapIngIpv4Ipv6, tmnxSASChassisNotificationV3v0Group=tmnxSASChassisNotificationV3v0Group, tmnxSSHUserLoginMaxAttempts=tmnxSSHUserLoginMaxAttempts, tCardResOperIngTcamIpMulticast=tCardResOperIngTcamIpMulticast, sysOperGrpRowStatus=sysOperGrpRowStatus, tmnxSASSecurityObjects=tmnxSASSecurityObjects, tmnxChassisPowerSupplyExtnTable=tmnxChassisPowerSupplyExtnTable, tmnxVwmshelfTypeConnected=tmnxVwmshelfTypeConnected, tmnxSASChassisV61Group=tmnxSASChassisV61Group, sysResIngSapIngClass=sysResIngSapIngClass, tCardResOperG8032CtrlSapEndVlan=tCardResOperG8032CtrlSapEndVlan, sbiEthMgmtSpeed=sbiEthMgmtSpeed, sysOperGrpTable=sysOperGrpTable, tmnxVwmShelfCardRemoved=tmnxVwmShelfCardRemoved, tResPlcyIngTcamQosSapIng=tResPlcyIngTcamQosSapIng, sysQosPortSchedModeEnable=sysQosPortSchedModeEnable, tResPlcyIngTcamEthCfmDownMep=tResPlcyIngTcamEthCfmDownMep, tResPlcyId=tResPlcyId, tmnxPtpTimeUsePtp=tmnxPtpTimeUsePtp, tResPlcyEgrTcamAclSapEgr64MacIpv6=tResPlcyEgrTcamAclSapEgr64MacIpv6, tmnxSASSysConsoleV6v0Group=tmnxSASSysConsoleV6v0Group, sbiEthMgmtDisabled=sbiEthMgmtDisabled, sysResIngTcamEthCfmDownMep=sysResIngTcamEthCfmDownMep, tmnxVwmShelfPSInputFailure=tmnxVwmShelfPSInputFailure, tmnxFabricPolicyPIR=tmnxFabricPolicyPIR, sysResIngTcamSapAggMeterOperVal=sysResIngTcamSapAggMeterOperVal, sbiUplinkAorB=sbiUplinkAorB, sysResQosMbsPool=sysResQosMbsPool, tResDecommOperTable=tResDecommOperTable, tmnxVwmShelfAdminState=tmnxVwmShelfAdminState, sysMpointMgmtInfo=sysMpointMgmtInfo, sysQosObjs=sysQosObjs, tResPlcyIngTcamAclSapIngIpv4=tResPlcyIngTcamAclSapIngIpv4, tmnxChassisLowTempState=tmnxChassisLowTempState, TmnxFanCfgMode=TmnxFanCfgMode, tmnxUsbUnknownDev=tmnxUsbUnknownDev, tResDecommId=tResDecommId, tmnxFabricPolicyMpointFabricPort=tmnxFabricPolicyMpointFabricPort, sysResQosSapIngQOperMode=sysResQosSapIngQOperMode, tmnxVwmShelfCardOperState=tmnxVwmShelfCardOperState, sbiUplinkBPort=sbiUplinkBPort, tResPlcyEntry=tResPlcyEntry, tResDecommOperToPortMap=tResDecommOperToPortMap, tmnxSASChassisObjs=tmnxSASChassisObjs, sysResMaxIPv6RoutesOperVal=sysResMaxIPv6RoutesOperVal, tResPlcyEgrTcamAclSapEgrMac=tResPlcyEgrTcamAclSapEgrMac, tmnxVwmShelfEntry=tmnxVwmShelfEntry, tmnxSASSysQosV5v0Group=tmnxSASSysQosV5v0Group, tmnxChassisNotifyMDACfgFailReason=tmnxChassisNotifyMDACfgFailReason, tmnxSASSysSecV4v0Group=tmnxSASSysSecV4v0Group, tmnxCardSysResPlcyId=tmnxCardSysResPlcyId, sbiPassword=sbiPassword, sbiUplinkRouteRowStatus=sbiUplinkRouteRowStatus, tResPlcyIngTcamSapAggMeter=tResPlcyIngTcamSapAggMeter, tmnxSysConsoleAlarmInput=tmnxSysConsoleAlarmInput, sysOperGrpNumMonitoring=sysOperGrpNumMonitoring, tCardResOperG8032CtrlSapStartVlan=tCardResOperG8032CtrlSapStartVlan, tmnxFabricPolicyEntry=tmnxFabricPolicyEntry, sysEthMgmtBofInfo=sysEthMgmtBofInfo, tmnxSASChassisNotificationObjs=tmnxSASChassisNotificationObjs, tmnxSASSysCompliances=tmnxSASSysCompliances, sysResMaxIPv6Routes=sysResMaxIPv6Routes, sbiUplinkBMask=sbiUplinkBMask, tCardResOperTable=tCardResOperTable, sbiPingAddress=sbiPingAddress, tmnxVwmShelfPSOutputFailure=tmnxVwmShelfPSOutputFailure, sbiUplinkBAutoNegotiate=sbiUplinkBAutoNegotiate, tResPlcyIngTcamEthCfm=tResPlcyIngTcamEthCfm, aluExtPoeExternalPowerSupplyStatus=aluExtPoeExternalPowerSupplyStatus, tCardResOperEgrTcamAclSapEgr128Ipv6=tCardResOperEgrTcamAclSapEgr128Ipv6, tCardResOperEgrTcamAclSapEgr=tCardResOperEgrTcamAclSapEgr, tmnxSASSysObjsV6v0Group=tmnxSASSysObjsV6v0Group, tmnxChassisRebootAutoInit=tmnxChassisRebootAutoInit, tmnxChassisGoldenBootstrapImageVersion=tmnxChassisGoldenBootstrapImageVersion, sysResEgrTcamEgrAcl64bitIpv4Ipv6=sysResEgrTcamEgrAcl64bitIpv4Ipv6, sysDhcpSnoopingEnable=sysDhcpSnoopingEnable, sysLoopBackInfo=sysLoopBackInfo, sysOperGrpEntry=sysOperGrpEntry, tCardResOperEgrTcamAclSapEgr64MacIpv6=tCardResOperEgrTcamAclSapEgr64MacIpv6, sbiEthMgmtActiveIpAddr=sbiEthMgmtActiveIpAddr, sbiEthMgmtStaticRouteEntry=sbiEthMgmtStaticRouteEntry, sbiNoServicePortTwo=sbiNoServicePortTwo, sysResIngSapIngClassIpv4=sysResIngSapIngClassIpv4, sbiUplinkAIpAddr=sbiUplinkAIpAddr, tResPlcyDescription=tResPlcyDescription, sysResIngTcamIngAclIpv4=sysResIngTcamIngAclIpv4, tCardResOperIngTcamAclSapIng64Ipv6=tCardResOperIngTcamAclSapIng64Ipv6, aluExtPoePowerMode=aluExtPoePowerMode, tmnxCardExtnEntry=tmnxCardExtnEntry, tCardResOperEntry=tCardResOperEntry, sbiUplinkAdminMode=sbiUplinkAdminMode, tResPlcyRowStatus=tResPlcyRowStatus, tmnxCpmCardBootImageSource=tmnxCpmCardBootImageSource, tResPlcyIngTcamQosSapIngIpv4=tResPlcyIngTcamQosSapIngIpv4, tmnxSASSysNotifications=tmnxSASSysNotifications, tmnxVwmShelfCardEqType=tmnxVwmShelfCardEqType, tmnxVwmShelfInputLoss=tmnxVwmShelfInputLoss, tmnxEqPowerOutputFailure=tmnxEqPowerOutputFailure, tmnxFabricPolicyMBS=tmnxFabricPolicyMBS, PYSNMP_MODULE_ID=timetraSASysMIBModule, tmnxFabricPolicyRowStatus=tmnxFabricPolicyRowStatus, tmnxChassisGoldenBootstrapImageSrc=tmnxChassisGoldenBootstrapImageSrc, sysResEgrTcamEgrAclMac=sysResEgrTcamEgrAclMac, aluExtTmnxChassisEntry=aluExtTmnxChassisEntry, sysResEgrTcamEgrAcl128bitIpv4Ipv6=sysResEgrTcamEgrAcl128bitIpv4Ipv6, tCardResOperIngTcamAclSapIngMac=tCardResOperIngTcamAclSapIngMac, sysResIpMacMatchEnable=sysResIpMacMatchEnable, tCardResOperIngTcamQosSapIngMac=tCardResOperIngTcamQosSapIngMac, tResPlcyIngTcamAclSapIngMac=tResPlcyIngTcamAclSapIngMac, tmnxVwmShelfCardTable=tmnxVwmShelfCardTable, tmnxVwmShelfCardType=tmnxVwmShelfCardType, sysResRouterMaxIPSubnets=sysResRouterMaxIPSubnets, sysOperGrpTblLastChanged=sysOperGrpTblLastChanged, tCardResOperIngTcamSapAggMeter=tCardResOperIngTcamSapAggMeter, sbiNoServicePortOne=sbiNoServicePortOne, sysResIngSapIngClassMac=sysResIngSapIngClassMac, tmnxVwmShelfCardInserted=tmnxVwmShelfCardInserted, sbiUplinkAAutoNegotiate=sbiUplinkAAutoNegotiate, sysG8032FastFloodEnable=sysG8032FastFloodEnable, tResDecommRowStatus=tResDecommRowStatus, sysResIngTcamSapAggMeter=sysResIngTcamSapAggMeter, tResPlcyEgrTcamAclSapEgrMacIpv4=tResPlcyEgrTcamAclSapEgrMacIpv4, tmnxHwExtnEntry=tmnxHwExtnEntry, tResPlcyIngTcamQosSapIngIpv4Ipv6=tResPlcyIngTcamQosSapIngIpv4Ipv6, sysOperGrpObjs=sysOperGrpObjs, tmnxVwmShelfVwmType=tmnxVwmShelfVwmType, tmnxChassisPowerSupplyAssignedDCType=tmnxChassisPowerSupplyAssignedDCType, sysOperGrpOperStatus=sysOperGrpOperStatus, sbiUplinkBDuplex=sbiUplinkBDuplex, tmnxSASChassisNotification=tmnxSASChassisNotification, tmnxVwmShelfIdMismatch=tmnxVwmShelfIdMismatch, tmnxChassisFanCfgMode=tmnxChassisFanCfgMode, tmnxChassisFanOperMode=tmnxChassisFanOperMode, tmnxVwmShelfOperState=tmnxVwmShelfOperState, tmnxVwmShelfRemoved=tmnxVwmShelfRemoved, tmnxRootDirFull=tmnxRootDirFull, sysResIngTcamEthCfmUpMep=sysResIngTcamEthCfmUpMep, tmnxDyingGasp=tmnxDyingGasp, sbiUplinkAPort=sbiUplinkAPort, tmnxChassisValidateGoldenBootstrapImage=tmnxChassisValidateGoldenBootstrapImage, tResDecommOperId=tResDecommOperId, tmnxChassisSystemLEDState=tmnxChassisSystemLEDState, sysOperGrpLastChange=sysOperGrpLastChange, tCardResOperEgrTcamAclSapEgrMac=tCardResOperEgrTcamAclSapEgrMac, sbiEthMgmtStaticRouteMask=sbiEthMgmtStaticRouteMask, sbiUplinkRouteNextHop=sbiUplinkRouteNextHop, tmnxCpmCardExtnEntry=tmnxCpmCardExtnEntry, sbiExpansionCardType=sbiExpansionCardType, tmnxChassisFanExtnTable=tmnxChassisFanExtnTable, tmnxVwmShelfCardIdMismatch=tmnxVwmShelfCardIdMismatch, tmnxSASChassisGroup=tmnxSASChassisGroup, tResDecommOperFromPortMap=tResDecommOperFromPortMap, tmnxVwmShelfTable=tmnxVwmShelfTable, tResDecommTable=tResDecommTable, tResPlcyIngTcamEthCfmUpMep=tResPlcyIngTcamEthCfmUpMep, tmnxEnvTempTooLow=tmnxEnvTempTooLow, aluExtPoePowerSupplyStatus=aluExtPoePowerSupplyStatus, sbiUplinkADuplex=sbiUplinkADuplex, tmnxSASSecurityNotifications=tmnxSASSecurityNotifications, tmnxVwmShelfCardAdminState=tmnxVwmShelfCardAdminState, tResPlcyG8032CtrlSapEndVlan=tResPlcyG8032CtrlSapEndVlan, sysLoopbackNoServPort=sysLoopbackNoServPort, tResPlcyIngTcamEthCfmDownMepEnable=tResPlcyIngTcamEthCfmDownMepEnable, sysQosWredSlopes=sysQosWredSlopes, tmnxVwmShelfCardId=tmnxVwmShelfCardId, sysClockInfo=sysClockInfo, tResPlcyIngTcamAclSapIng128Ipv4Ipv6=tResPlcyIngTcamAclSapIng128Ipv4Ipv6, tCardResOperIngTcamAclSapIngIpv4=tCardResOperIngTcamAclSapIngIpv4, tmnxLoginUserName=tmnxLoginUserName, tmnxSASSysGroups=tmnxSASSysGroups, TmnxPtpTime=TmnxPtpTime, tmnxSASSysV2v0Group=tmnxSASSysV2v0Group, sysResIngTcamEthCfm=sysResIngTcamEthCfm, sbiUplinkAMask=sbiUplinkAMask, sysResQosSapIngQMode=sysResQosSapIngQMode, tmnxVwmShelfId=tmnxVwmShelfId, tmnxFabricPolicyCBS=tmnxFabricPolicyCBS, tmnxVwmShelfRowStatus=tmnxVwmShelfRowStatus, sysResEgrTcamSapEgrAcl=sysResEgrTcamSapEgrAcl, sysSASObjs=sysSASObjs, sysResourceProfInfo=sysResourceProfInfo, sbiUplinkBSpeed=sbiUplinkBSpeed, tmnxVwmShelfEquippedType=tmnxVwmShelfEquippedType, timetraSASysMIBModule=timetraSASysMIBModule, sbiUplinkBIpAddr=sbiUplinkBIpAddr, sysMirrorLoopbackNoServPort=sysMirrorLoopbackNoServPort, tResDecommFromPortMap=tResDecommFromPortMap, tmnxSASSysV5v0Group=tmnxSASSysV5v0Group, sysOperGrpNumMembers=sysOperGrpNumMembers, tResPlcyG8032CtrlSapStartVlan=tResPlcyG8032CtrlSapStartVlan, tCardResOperIngTcamAclSapIng128Ipv4Ipv6=tCardResOperIngTcamAclSapIng128Ipv4Ipv6, sysResFabricPathBandwidth=sysResFabricPathBandwidth, aluExtTmnxChassisTable=aluExtTmnxChassisTable, tCardResOperResIpMacMatchEnable=tCardResOperResIpMacMatchEnable, tmnxChassisExtnEntry=tmnxChassisExtnEntry, tmnxChassisFanExtnEntry=tmnxChassisFanExtnEntry, tmnxFabricPolicyTable=tmnxFabricPolicyTable, tCardResOperIngTcamQosSapIngIpv4=tCardResOperIngTcamQosSapIngIpv4, tmnxSASSysResPlcyV6v1Group=tmnxSASSysResPlcyV6v1Group, tmnxUserLoginMaxAttempts=tmnxUserLoginMaxAttempts, tmnxSASCardObjs=tmnxSASCardObjs, sysOperGrpCreationOrigin=sysOperGrpCreationOrigin, sbiConsoleDisabled=sbiConsoleDisabled, tmnxSASSysV6v0Group=tmnxSASSysV6v0Group, sbiEthMgmtStaticRouteRowStatus=sbiEthMgmtStaticRouteRowStatus, tResDecommOperEntry=tResDecommOperEntry, tmnxChassisExtnTable=tmnxChassisExtnTable, tResPlcyIngTcamAclSapIng64Ipv6=tResPlcyIngTcamAclSapIng64Ipv6, tmnxSASSysObjs=tmnxSASSysObjs, tmnxSASSysConformance=tmnxSASSysConformance, tmnxSASChassisGroups=tmnxSASChassisGroups, sysResProfPlcyObjs=sysResProfPlcyObjs, sysOperGrpHoldUpTime=sysOperGrpHoldUpTime, sysSASVwmObjs=sysSASVwmObjs, sbiUplinkRouteMask=sbiUplinkRouteMask, sysResIngTcamEthCfmUpMepPrimaryVlan=sysResIngTcamEthCfmUpMepPrimaryVlan, sysResIngTcamIngAcl64bitIpv6Only=sysResIngTcamIngAcl64bitIpv6Only, tmnxSASSysV1v0Group=tmnxSASSysV1v0Group, sysResRouterEcmpMaxRoutesDst=sysResRouterEcmpMaxRoutesDst, tCardResOperEgrTcamAclSapEgrMacIpv4=tCardResOperEgrTcamAclSapEgrMacIpv4, sysResIngTcamIngAcl64bitIpv4Ipv6=sysResIngTcamIngAcl64bitIpv4Ipv6, tCardResOperIngTcamEthCfm=tCardResOperIngTcamEthCfm, tmnxChassisPowerSupplyExtnEntry=tmnxChassisPowerSupplyExtnEntry, sbiUplinkRouteDest=sbiUplinkRouteDest, tmnxFabricPolicyIndex=tmnxFabricPolicyIndex, tResPlcyEgrTcamAclSapEgr=tResPlcyEgrTcamAclSapEgr, sbiUplinkASpeed=sbiUplinkASpeed, tResPlcyEgrTcamAclSapEgr128Ipv6=tResPlcyEgrTcamAclSapEgr128Ipv6, tmnxVwmShelfCardEntry=tmnxVwmShelfCardEntry, tmnxAlarmInputVoltageFailure=tmnxAlarmInputVoltageFailure, tmnxSASSysV3v0Group=tmnxSASSysV3v0Group, sbiEthMgmtDuplex=sbiEthMgmtDuplex, sysResIngTcamIngAclMac=sysResIngTcamIngAclMac)
mibBuilder.exportSymbols("TIMETRA-SAS-SYSTEM-MIB", tmnxSASSecurityNotificationObjs=tmnxSASSecurityNotificationObjs, tmnxHwLowTempThreshold=tmnxHwLowTempThreshold, sysOperGrpHoldDownTime=sysOperGrpHoldDownTime, tmnxSASSysV4v0Group=tmnxSASSysV4v0Group, sysResIngTcamSapIngAcl=sysResIngTcamSapIngAcl, tResPlcyResIpMacMatchEnable=tResPlcyResIpMacMatchEnable, tCardResOperIngTcamEthCfmUpMep=tCardResOperIngTcamEthCfmUpMep, tResPlcyIngTcamEthCfmUpMepEnable=tResPlcyIngTcamEthCfmUpMepEnable, tCardResOperIngTcamQosSapIng=tCardResOperIngTcamQosSapIng, tSASMpointBwPlcy=tSASMpointBwPlcy, TmnxSysOperGrpCreationOrigin=TmnxSysOperGrpCreationOrigin, sysResIngTcamEthCfmDownMepPrimaryVlan=sysResIngTcamEthCfmDownMepPrimaryVlan, sbiUplinkRouteTable=sbiUplinkRouteTable, sbiUplinkRouteEntry=sbiUplinkRouteEntry, sysResEgrSapEgrClass=sysResEgrSapEgrClass, tmnxSASSysMIBNotifyPrefix=tmnxSASSysMIBNotifyPrefix, sbiEthMgmtAutoNegotiate=sbiEthMgmtAutoNegotiate, sysResIngSapIngClassIpv4Ipv6=sysResIngSapIngClassIpv4Ipv6, sysResEgrSapEgrClassIpv4=sysResEgrSapEgrClassIpv4, tResPlcyIngTcamQosSapIngMac=tResPlcyIngTcamQosSapIngMac, tmnxSASSecurityNotifyPrefix=tmnxSASSecurityNotifyPrefix, sysOperGrpName=sysOperGrpName, tmnxVwmShelfInserted=tmnxVwmShelfInserted, sbiUplinkBVlan=sbiUplinkBVlan, tmnxVwmShelfOutputLoss=tmnxVwmShelfOutputLoss, tmnxSASSysSecGroups=tmnxSASSysSecGroups, sysResProfDecommObjs=sysResProfDecommObjs, sbiEthMgmtStaticRouteDest=sbiEthMgmtStaticRouteDest, tmnxCpmCardExtnTable=tmnxCpmCardExtnTable, tResPlcyIngTcamAclSapIng=tResPlcyIngTcamAclSapIng, tmnxCardExtnTable=tmnxCardExtnTable, sysResEgrTcamEgrAclIpv4=sysResEgrTcamEgrAclIpv4, sysOperGrpOperStatusChanged=sysOperGrpOperStatusChanged, sysG8032FastFloodEnableOperVal=sysG8032FastFloodEnableOperVal, sysSASBofInfo=sysSASBofInfo, sysResEgrSapEgrClassMac=sysResEgrSapEgrClassMac, sbiUplinkOperMode=sbiUplinkOperMode, tmnxEqMDACfgMissing=tmnxEqMDACfgMissing, tCardResOperIngTcamAclSapIng=tCardResOperIngTcamAclSapIng, tResDecommToPortMap=tResDecommToPortMap, sysDhcpSnoopingSdpEnable=sysDhcpSnoopingSdpEnable, tmnxEqPowerInputFailure=tmnxEqPowerInputFailure, tCardResOperIngTcamEthCfmDownMep=tCardResOperIngTcamEthCfmDownMep, sbiUplinkAVlan=sbiUplinkAVlan, tmnxLoginMaxAttempts=tmnxLoginMaxAttempts)
