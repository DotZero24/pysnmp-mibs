...
mibBuilder.exportSymbols("ALCATEL-ENT1-BFD-MIB", alaBfdIntfTable=alaBfdIntfTable, alaBfdSessIfIndex=alaBfdSessIfIndex, alaBfdGlobalObjects=alaBfdGlobalObjects, alaBfdSessNegotiatedRxInterval=alaBfdSessNegotiatedRxInterval, alaBfdSessPerfGroup=alaBfdSessPerfGroup, alaBfdIntfAdminStatus=alaBfdIntfAdminStatus, alaBfdSessTable=alaBfdSessTable, alaBfdSessNeighborAddr=alaBfdSessNeighborAddr, alaBfdIntfAuthenticationType=alaBfdIntfAuthenticationType, alaBfdIntfRowStatus=alaBfdIntfRowStatus, alaBfdSessProtocolApps=alaBfdSessProtocolApps, alaBfdSessNeighborAddrType=alaBfdSessNeighborAddrType, alaBfdIntfReqMinRxInterval=alaBfdIntfReqMinRxInterval, alaBfdIntfOperStatus=alaBfdIntfOperStatus, alaBfdIntfReqMinEchoRxInterval=alaBfdIntfReqMinEchoRxInterval, alaBfdGlobalProtocolApps=alaBfdGlobalProtocolApps, alaBfdSessPerfPktIn=alaBfdSessPerfPktIn, alaBfdSessEchoRxInterval=alaBfdSessEchoRxInterval, alaBfdSessPerfLastCommLostDiag=alaBfdSessPerfLastCommLostDiag, alaBfdSessPerfDiscTime=alaBfdSessPerfDiscTime, alaBfdSessPerfTable=alaBfdSessPerfTable, alaBfdIntfDetectMult=alaBfdIntfDetectMult, alcatelIND1BfdMIBGroups=alcatelIND1BfdMIBGroups, alaBfdIntfDesiredMinTxInterval=alaBfdIntfDesiredMinTxInterval, alaBfdSessOperMode=alaBfdSessOperMode, alaBfdGlobalRxInterval=alaBfdGlobalRxInterval, alaBfdSessRemoteDiscr=alaBfdSessRemoteDiscr, alaBfdIntfAddr=alaBfdIntfAddr, alaBfdSessDiag=alaBfdSessDiag, alaBfdBasicGroup=alaBfdBasicGroup, alcatelIND1BfdMIB=alcatelIND1BfdMIB, alaBfdSessNegotiatedTxInterval=alaBfdSessNegotiatedTxInterval, alaBfdSessPerfSessUpCount=alaBfdSessPerfSessUpCount, alaBfdGlobalDetectMult=alaBfdGlobalDetectMult, alaBfdSessPerfUpTime=alaBfdSessPerfUpTime, alaBfdGlobalAdminStatus=alaBfdGlobalAdminStatus, AlaBfdInterval=AlaBfdInterval, alaBfdSessControlPlanIndepFlag=alaBfdSessControlPlanIndepFlag, alaBfdSessPerfLastSessDownTime=alaBfdSessPerfLastSessDownTime, alaBfdIntfIndex=alaBfdIntfIndex, alaBfdIntfIfName=alaBfdIntfIfName, alaBfdSessUdpPort=alaBfdSessUdpPort, alaBfdSessPerfPktOut=alaBfdSessPerfPktOut, AlaBfdDiag=AlaBfdDiag, alaBfdIntfAuthPresFlag=alaBfdIntfAuthPresFlag, alaBfdSessPerfEchoOut=alaBfdSessPerfEchoOut, alaBfdGlobalTxInterval=alaBfdGlobalTxInterval, alaBfdSessSessionType=alaBfdSessSessionType, PYSNMP_MODULE_ID=alcatelIND1BfdMIB, alaBfdIntfEntry=alaBfdIntfEntry, alaBfdObjects=alaBfdObjects, alcatelIND1BfdMIBCompliances=alcatelIND1BfdMIBCompliances, alaBfdSessState=alaBfdSessState, alaBfdSessPerfEchoIn=alaBfdSessPerfEchoIn, alcatelIND1BfdMIBConformance=alcatelIND1BfdMIBConformance, alaBfdSessPerfEntry=alaBfdSessPerfEntry, alaBfdSessGroup=alaBfdSessGroup, alaBfdIntfAddrType=alaBfdIntfAddrType, alcatelIND1BfdMIBCompliance=alcatelIND1BfdMIBCompliance, AlaBfdStatus=AlaBfdStatus, alaBfdIntfCfgGroup=alaBfdIntfCfgGroup, alaBfdGlobalEchoRxInterval=alaBfdGlobalEchoRxInterval, alaBfdGlobalVersionNumber=alaBfdGlobalVersionNumber, alaBfdSessEntry=alaBfdSessEntry, alaBfdSessDiscriminator=alaBfdSessDiscriminator)
