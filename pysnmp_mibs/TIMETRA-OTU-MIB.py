...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-OTU-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:53:46 2025
...
_TmnxOtuGroupsV11v0_ObjectIdentity = ObjectIdentity
tmnxOtuGroupsV11v0 = _TmnxOtuGroupsV11v0_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 62, 2, 7)
)
_TmnxOtuGroupsV13v0_ObjectIdentity = ObjectIdentity
tmnxOtuGroupsV13v0 = _TmnxOtuGroupsV13v0_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 62, 2, 8)
)
_TmnxOtuGroupsV19v0_ObjectIdentity = ObjectIdentity
tmnxOtuGroupsV19v0 = _TmnxOtuGroupsV19v0_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 62, 2, 9)
)
...
_TmnxOtuIfFecMode_Type.__name__ = "TmnxOtuFecMode"
...
_TmnxOtuIfSfSdMethod_Type.__name__ = "TmnxOtuSFSDMethod"
...
if mibBuilder.loadTexts:
    tmnxOtuIfOtuOperDataRate.setUnits("megabps")
...
_TmnxOtuIfOtu2LanDataRate_Type.__name__ = "TmnxOtu2LanDataRate"
...
if mibBuilder.loadTexts:
    tmnxOtuIfOtu2LanDataRate.setUnits("gigabps")
...
_TmnxOtuIfCfgAlarms_Type.__name__ = "TmnxOtuAlarms"
...
if mibBuilder.loadTexts:
    tmnxOtuIfHoldTimeUp.setUnits("deciseconds")
...
if mibBuilder.loadTexts:
    tmnxOtuIfHoldTimeDown.setUnits("deciseconds")
...
if mibBuilder.loadTexts:
    tmnxOtuIfPsiTtiTxMode.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxOtuIfPsiTtiTx.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxOtuIfPsiTtiRx.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxOtuIfPsiTtiExpMode.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxOtuIfPsiTtiExpCopyRx.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxOtuIfPsiTtiExp.setStatus("obsolete")
...
_TmnxOtuIfGfpMappingEnable_Type.__name__ = "TruthValue"
...
_TmnxOtuIfAsyncMappingEnable_Type.__name__ = "TruthValue"
...
_TmnxOtuIfSmTimReaction_Type.__name__ = "TmnxOtuTimReaction"
...
_TmnxOtuIfPmTimReaction_Type.__name__ = "TmnxOtuTimReaction"
...
_TmnxOtuIfPsiTimReaction_Type.__name__ = "TmnxOtuTimReaction"
...
if mibBuilder.loadTexts:
    tmnxOtuIfPsiTimReaction.setStatus("obsolete")
...
_TmnxOtuIfPsiPlmReaction_Type.__name__ = "TmnxOtuTimReaction"
...
_TmnxOtuIfFineGrBerTable_Object = MibTable
tmnxOtuIfFineGrBerTable = _TmnxOtuIfFineGrBerTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2)
)
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerTable.setStatus("current")
_TmnxOtuIfFineGrBerEntry_Object = MibTableRow
tmnxOtuIfFineGrBerEntry = _TmnxOtuIfFineGrBerEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1)
)
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerEntry.setStatus("current")
_TmnxOtuIfFineGrBerSupported_Type = TruthValue
_TmnxOtuIfFineGrBerSupported_Object = MibTableColumn
tmnxOtuIfFineGrBerSupported = _TmnxOtuIfFineGrBerSupported_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1, 1),
    _TmnxOtuIfFineGrBerSupported_Type()
)
tmnxOtuIfFineGrBerSupported.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSupported.setStatus("current")


class _TmnxOtuIfFineGrBerSfThresh_Type(Unsigned32):
    """Custom type tmnxOtuIfFineGrBerSfThresh based on Unsigned32"""
    defaultValue = 5
...
_TmnxOtuIfFineGrBerSfThresh_Type.__name__ = "Unsigned32"
_TmnxOtuIfFineGrBerSfThresh_Object = MibTableColumn
tmnxOtuIfFineGrBerSfThresh = _TmnxOtuIfFineGrBerSfThresh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1, 2),
    _TmnxOtuIfFineGrBerSfThresh_Type()
)
tmnxOtuIfFineGrBerSfThresh.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSfThresh.setStatus("current")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSfThresh.setUnits("error bits in 1/10e-n bits received")


class _TmnxOtuIfFineGrBerSdThresh_Type(Unsigned32):
    """Custom type tmnxOtuIfFineGrBerSdThresh based on Unsigned32"""
    defaultValue = 7
...
_TmnxOtuIfFineGrBerSdThresh_Type.__name__ = "Unsigned32"
_TmnxOtuIfFineGrBerSdThresh_Object = MibTableColumn
tmnxOtuIfFineGrBerSdThresh = _TmnxOtuIfFineGrBerSdThresh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1, 3),
    _TmnxOtuIfFineGrBerSdThresh_Type()
)
tmnxOtuIfFineGrBerSdThresh.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSdThresh.setStatus("current")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSdThresh.setUnits("error bits in 1/10e-n bits received")


class _TmnxOtuIfFineGrBerSfThrCoef_Type(Unsigned32):
    """Custom type tmnxOtuIfFineGrBerSfThrCoef based on Unsigned32"""
    defaultValue = 10
...
_TmnxOtuIfFineGrBerSfThrCoef_Type.__name__ = "Unsigned32"
_TmnxOtuIfFineGrBerSfThrCoef_Object = MibTableColumn
tmnxOtuIfFineGrBerSfThrCoef = _TmnxOtuIfFineGrBerSfThrCoef_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1, 4),
    _TmnxOtuIfFineGrBerSfThrCoef_Type()
)
tmnxOtuIfFineGrBerSfThrCoef.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSfThrCoef.setStatus("current")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSfThrCoef.setUnits("tenths")


class _TmnxOtuIfFineGrBerSdThrCoef_Type(Unsigned32):
    """Custom type tmnxOtuIfFineGrBerSdThrCoef based on Unsigned32"""
    defaultValue = 10
...
_TmnxOtuIfFineGrBerSdThrCoef_Type.__name__ = "Unsigned32"
_TmnxOtuIfFineGrBerSdThrCoef_Object = MibTableColumn
tmnxOtuIfFineGrBerSdThrCoef = _TmnxOtuIfFineGrBerSdThrCoef_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1, 5),
    _TmnxOtuIfFineGrBerSdThrCoef_Type()
)
tmnxOtuIfFineGrBerSdThrCoef.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSdThrCoef.setStatus("current")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSdThrCoef.setUnits("tenths")


class _TmnxOtuIfFineGrBerSfThreshClr_Type(Unsigned32):
    """Custom type tmnxOtuIfFineGrBerSfThreshClr based on Unsigned32"""
    defaultValue = 6
...
_TmnxOtuIfFineGrBerSfThreshClr_Type.__name__ = "Unsigned32"
_TmnxOtuIfFineGrBerSfThreshClr_Object = MibTableColumn
tmnxOtuIfFineGrBerSfThreshClr = _TmnxOtuIfFineGrBerSfThreshClr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1, 6),
    _TmnxOtuIfFineGrBerSfThreshClr_Type()
)
tmnxOtuIfFineGrBerSfThreshClr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSfThreshClr.setStatus("current")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSfThreshClr.setUnits("error bits in 1/10e-n bits received")


class _TmnxOtuIfFineGrBerSdThreshClr_Type(Unsigned32):
    """Custom type tmnxOtuIfFineGrBerSdThreshClr based on Unsigned32"""
    defaultValue = 8
...
_TmnxOtuIfFineGrBerSdThreshClr_Type.__name__ = "Unsigned32"
_TmnxOtuIfFineGrBerSdThreshClr_Object = MibTableColumn
tmnxOtuIfFineGrBerSdThreshClr = _TmnxOtuIfFineGrBerSdThreshClr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1, 7),
    _TmnxOtuIfFineGrBerSdThreshClr_Type()
)
tmnxOtuIfFineGrBerSdThreshClr.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSdThreshClr.setStatus("current")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSdThreshClr.setUnits("error bits in 1/10e-n bits received")


class _TmnxOtuIfFineGrBerSfThrClrCoef_Type(Unsigned32):
    """Custom type tmnxOtuIfFineGrBerSfThrClrCoef based on Unsigned32"""
    defaultValue = 10
...
_TmnxOtuIfFineGrBerSfThrClrCoef_Type.__name__ = "Unsigned32"
_TmnxOtuIfFineGrBerSfThrClrCoef_Object = MibTableColumn
tmnxOtuIfFineGrBerSfThrClrCoef = _TmnxOtuIfFineGrBerSfThrClrCoef_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1, 8),
    _TmnxOtuIfFineGrBerSfThrClrCoef_Type()
)
tmnxOtuIfFineGrBerSfThrClrCoef.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSfThrClrCoef.setStatus("current")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSfThrClrCoef.setUnits("tenths")


class _TmnxOtuIfFineGrBerSdThrClrCoef_Type(Unsigned32):
    """Custom type tmnxOtuIfFineGrBerSdThrClrCoef based on Unsigned32"""
    defaultValue = 10
...
_TmnxOtuIfFineGrBerSdThrClrCoef_Type.__name__ = "Unsigned32"
_TmnxOtuIfFineGrBerSdThrClrCoef_Object = MibTableColumn
tmnxOtuIfFineGrBerSdThrClrCoef = _TmnxOtuIfFineGrBerSdThrClrCoef_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 62, 1, 2, 1, 9),
    _TmnxOtuIfFineGrBerSdThrClrCoef_Type()
)
tmnxOtuIfFineGrBerSdThrClrCoef.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSdThrClrCoef.setStatus("current")
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerSdThrClrCoef.setUnits("tenths")
...
tmnxOtuIfEntry.registerAugmentions(
    ("TIMETRA-OTU-MIB",
...
tmnxOtuIfFineGrBerGroupV11v0 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 62, 2, 7, 1)
)
tmnxOtuIfFineGrBerGroupV11v0.setObjects(
      *(("TIMETRA-OTU-MIB", "tmnxOtuIfFineGrBerSupported"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfFineGrBerSfThresh"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfFineGrBerSdThresh"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfFineGrBerSfThrCoef"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfFineGrBerSdThrCoef"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfFineGrBerSfThreshClr"),
...
if mibBuilder.loadTexts:
    tmnxOtuIfFineGrBerGroupV11v0.setStatus("current")

tmnxOtuObsoleteGroupV19v0 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 62, 2, 9, 1)
)
tmnxOtuObsoleteGroupV19v0.setObjects(
      *(("TIMETRA-OTU-MIB", "tmnxOtuIfPsiTtiTxMode"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfPsiTtiTx"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfPsiTtiRx"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfPsiTtiExpMode"),
...
if mibBuilder.loadTexts:
    tmnxOtuObsoleteGroupV19v0.setStatus("current")
...
tmnxOtuCompliance.setObjects(
      *(("TIMETRA-OTU-MIB", "tmnxOtuIfBaseConfigGroup"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfBaseConfigGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfSMGroup"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfSMGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfPMGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfPSIGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuStatsGroup"),
        ("TIMETRA-OTU-MIB", "tmnxOtuStatsGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuNotificationGroup"))
)
if mibBuilder.loadTexts:
...
tmnxOtuComplianceV8v0.setObjects(
      *(("TIMETRA-OTU-MIB", "tmnxOtuIfBaseConfigGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfSMGroup"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfSMGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfPMGroupV8v0"),
        ...
        ("TIMETRA-OTU-MIB", "tmnxOtuStatsGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuNotificationGroup"),
        ("TIMETRA-OTU-MIB", "tmnxOtuObsoleteV8v0Group"))
)
if mibBuilder.loadTexts:
...
tmnxOtuComplianceV11v0 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 62, 1, 3)
)
tmnxOtuComplianceV11v0.setObjects(
      *(("TIMETRA-OTU-MIB", "tmnxOtuIfBaseConfigGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfSMGroup"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfSMGroupV8v0"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfPMGroupV8v0"),
        ...
        ("TIMETRA-OTU-MIB", "tmnxOtuNotificationGroup"),
        ("TIMETRA-OTU-MIB", "tmnxOtuObsoleteV8v0Group"),
        ("TIMETRA-OTU-MIB", "tmnxOtuIfFineGrBerGroupV11v0"))
)
if mibBuilder.loadTexts:
    tmnxOtuComplianceV11v0.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TmnxOtuFecMode": TmnxOtuFecMode,
       ...
       "TmnxOtuIfOtu4SignalType": TmnxOtuIfOtu4SignalType,
       ...
       "tmnxOtuComplianceV11v0": tmnxOtuComplianceV11v0,
       ...
       "tmnxOtuGroupsV11v0": tmnxOtuGroupsV11v0,
       "tmnxOtuIfFineGrBerGroupV11v0": tmnxOtuIfFineGrBerGroupV11v0,
       "tmnxOtuGroupsV13v0": tmnxOtuGroupsV13v0,
       "tmnxOtuGroupsV19v0": tmnxOtuGroupsV19v0,
       "tmnxOtuObsoleteGroupV19v0": tmnxOtuObsoleteGroupV19v0,
       ...
       "tmnxOtuIfFineGrBerTable": tmnxOtuIfFineGrBerTable,
       "tmnxOtuIfFineGrBerEntry": tmnxOtuIfFineGrBerEntry,
       "tmnxOtuIfFineGrBerSupported": tmnxOtuIfFineGrBerSupported,
       "tmnxOtuIfFineGrBerSfThresh": tmnxOtuIfFineGrBerSfThresh,
       "tmnxOtuIfFineGrBerSdThresh": tmnxOtuIfFineGrBerSdThresh,
       "tmnxOtuIfFineGrBerSfThrCoef": tmnxOtuIfFineGrBerSfThrCoef,
       "tmnxOtuIfFineGrBerSdThrCoef": tmnxOtuIfFineGrBerSdThrCoef,
       "tmnxOtuIfFineGrBerSfThreshClr": tmnxOtuIfFineGrBerSfThreshClr,
       "tmnxOtuIfFineGrBerSdThreshClr": tmnxOtuIfFineGrBerSdThreshClr,
       "tmnxOtuIfFineGrBerSfThrClrCoef": tmnxOtuIfFineGrBerSfThrClrCoef,
       "tmnxOtuIfFineGrBerSdThrClrCoef": tmnxOtuIfFineGrBerSdThrClrCoef,
