# SNMP MIB module (FASTPATH-DNS-RESOLVER-CONTROL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/broadcom/FASTPATH-DNS-RESOLVER-CONTROL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:07:44 2025
...
agentResCtlDomainListEntry.setIndexNames(
    (0, "FASTPATH-DNS-RESOLVER-CONTROL-MIB", "agentResCtlDomainListName"),
)
if mibBuilder.loadTexts:
...
agentResCtlConfigIPEntry.setIndexNames(
    (0, "FASTPATH-DNS-RESOLVER-CONTROL-MIB", "agentResCtlDnsNameServerIP"),
)
if mibBuilder.loadTexts:
...
agentResCtlStaticServEntry.setIndexNames(
    (0, "FASTPATH-DNS-RESOLVER-CONTROL-MIB", "agentResCtlStaticHostName"),
    (0, "FASTPATH-DNS-RESOLVER-CONTROL-MIB", "agentResCtlStaticIPAddress"),
)
if mibBuilder.loadTexts:
