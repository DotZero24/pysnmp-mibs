_K='agentResCtlStaticIPAddress'
_J='agentResCtlStaticHostName'
_I='agentResCtlDnsNameServerIP'
_H='agentResCtlDomainListName'
_G='not-accessible'
_F='read-create'
_E='OctetString'
_D='Integer32'
_C='FASTPATH-DNS-RESOLVER-CONTROL-MIB'
_B='read-write'
_A='current'
...
if mibBuilder.loadTexts:fastPathDnsResControlMIB.setRevisions(('2007-05-23 00:00','2005-03-28 11:00'))
...
fastPathDnsResCtlMIBObjects=_FastPathDnsResCtlMIBObjects_ObjectIdentity((1,3,6,1,4,1,4413,1,1,37,1))
_AgentResCtlglobal_ObjectIdentity=ObjectIdentity
agentResCtlglobal=_AgentResCtlglobal_ObjectIdentity((1,3,6,1,4,1,4413,1,1,37,1,1))
_AgentResCtlAdminMode_Type=TruthValue
_AgentResCtlAdminMode_Object=MibScalar
agentResCtlAdminMode=_AgentResCtlAdminMode_Object((1,3,6,1,4,1,4413,1,1,37,1,1,1),_AgentResCtlAdminMode_Type())
...
_AgentResCtlDefDomainName_Type.__name__=_E
_AgentResCtlDefDomainName_Object=MibScalar
agentResCtlDefDomainName=_AgentResCtlDefDomainName_Object((1,3,6,1,4,1,4413,1,1,37,1,1,2),_AgentResCtlDefDomainName_Type())
...
agentResCtlCacheFlushStatus=_AgentResCtlCacheFlushStatus_Object((1,3,6,1,4,1,4413,1,1,37,1,1,3),_AgentResCtlCacheFlushStatus_Type())
...
agentResCtlRequestTimeout=_AgentResCtlRequestTimeout_Object((1,3,6,1,4,1,4413,1,1,37,1,1,4),_AgentResCtlRequestTimeout_Type())
...
agentResCtlRequestRetransmits=_AgentResCtlRequestRetransmits_Object((1,3,6,1,4,1,4413,1,1,37,1,1,5),_AgentResCtlRequestRetransmits_Type())
...
agentResCtlDomainListTable=_AgentResCtlDomainListTable_Object((1,3,6,1,4,1,4413,1,1,37,1,1,6))
if mibBuilder.loadTexts:agentResCtlDomainListTable.setStatus(_A)
_AgentResCtlDomainListEntry_Object=MibTableRow
agentResCtlDomainListEntry=_AgentResCtlDomainListEntry_Object((1,3,6,1,4,1,4413,1,1,37,1,1,6,1))
agentResCtlDomainListEntry.setIndexNames((0,_C,_H))
...
agentResCtlDomainListName=_AgentResCtlDomainListName_Object((1,3,6,1,4,1,4413,1,1,37,1,1,6,1,1),_AgentResCtlDomainListName_Type())
...
agentResCtlDomainListNameStatus=_AgentResCtlDomainListNameStatus_Object((1,3,6,1,4,1,4413,1,1,37,1,1,6,1,2),_AgentResCtlDomainListNameStatus_Type())
agentResCtlDomainListNameStatus.setMaxAccess(_F)
if mibBuilder.loadTexts:agentResCtlDomainListNameStatus.setStatus(_A)
_AgentResCtlServConfig_ObjectIdentity=ObjectIdentity
agentResCtlServConfig=_AgentResCtlServConfig_ObjectIdentity((1,3,6,1,4,1,4413,1,1,37,1,2))
_AgentResCtlServConfigTable_Object=MibTable
agentResCtlServConfigTable=_AgentResCtlServConfigTable_Object((1,3,6,1,4,1,4413,1,1,37,1,2,1))
if mibBuilder.loadTexts:agentResCtlServConfigTable.setStatus(_A)
_AgentResCtlConfigIPEntry_Object=MibTableRow
agentResCtlConfigIPEntry=_AgentResCtlConfigIPEntry_Object((1,3,6,1,4,1,4413,1,1,37,1,2,1,1))
agentResCtlConfigIPEntry.setIndexNames((0,_C,_I))
if mibBuilder.loadTexts:agentResCtlConfigIPEntry.setStatus(_A)
_AgentResCtlDnsNameServerIP_Type=IpAddress
_AgentResCtlDnsNameServerIP_Object=MibTableColumn
agentResCtlDnsNameServerIP=_AgentResCtlDnsNameServerIP_Object((1,3,6,1,4,1,4413,1,1,37,1,2,1,1,1),_AgentResCtlDnsNameServerIP_Type())
agentResCtlDnsNameServerIP.setMaxAccess(_G)
...
agentResCtlDnsNameServerStatus=_AgentResCtlDnsNameServerStatus_Object((1,3,6,1,4,1,4413,1,1,37,1,2,1,1,2),_AgentResCtlDnsNameServerStatus_Type())
agentResCtlDnsNameServerStatus.setMaxAccess(_F)
...
agentResCtlStaticServConfig=_AgentResCtlStaticServConfig_ObjectIdentity((1,3,6,1,4,1,4413,1,1,37,1,3))
_AgentResCtlStaticServConfigTable_Object=MibTable
agentResCtlStaticServConfigTable=_AgentResCtlStaticServConfigTable_Object((1,3,6,1,4,1,4413,1,1,37,1,3,1))
if mibBuilder.loadTexts:agentResCtlStaticServConfigTable.setStatus(_A)
_AgentResCtlStaticServEntry_Object=MibTableRow
agentResCtlStaticServEntry=_AgentResCtlStaticServEntry_Object((1,3,6,1,4,1,4413,1,1,37,1,3,1,1))
agentResCtlStaticServEntry.setIndexNames((0,_C,_J),(0,_C,_K))
...
_AgentResCtlStaticHostName_Type.__name__=_E
_AgentResCtlStaticHostName_Object=MibTableColumn
agentResCtlStaticHostName=_AgentResCtlStaticHostName_Object((1,3,6,1,4,1,4413,1,1,37,1,3,1,1,1),_AgentResCtlStaticHostName_Type())
agentResCtlStaticHostName.setMaxAccess(_G)
...
agentResCtlStaticIPAddress=_AgentResCtlStaticIPAddress_Object((1,3,6,1,4,1,4413,1,1,37,1,3,1,1,2),_AgentResCtlStaticIPAddress_Type())
agentResCtlStaticIPAddress.setMaxAccess(_G)
