...
mibBuilder.exportSymbols("CISCO-IETF-PW-TDM-MIB", cpwCTDMPerfIntervalESs=cpwCTDMPerfIntervalESs, cpwCTDMPerfIntervalDuration=cpwCTDMPerfIntervalDuration, cpwCTDMTimeElapsed=cpwCTDMTimeElapsed, cpwCTDMPerf1DayIntervalEntry=cpwCTDMPerf1DayIntervalEntry, cpwCGenTDMCfgIndex=cpwCGenTDMCfgIndex, cpwCTDMCfgPktReorder=cpwCTDMCfgPktReorder, cpwCTDMPerfCurrentESs=cpwCTDMPerfCurrentESs, cpwCTDMPerfIntervalTable=cpwCTDMPerfIntervalTable, cpwCTDMCurrentIndications=cpwCTDMCurrentIndications, cpwCTDMPerf1DayIntervalNumber=cpwCTDMPerf1DayIntervalNumber, cpwCTDMCfgIndexNext=cpwCTDMCfgIndexNext, cpwCTDMPerf1DayIntervalUASs=cpwCTDMPerf1DayIntervalUASs, cpwCTDMPerfCurrentJtrBfrUnderruns=cpwCTDMPerfCurrentJtrBfrUnderruns, cpwCTDMNotifications=cpwCTDMNotifications, CpwTDMCfgIndex=CpwTDMCfgIndex, cpwCTDMPerf1DayIntervalValidData=cpwCTDMPerf1DayIntervalValidData, cpwCTDMCfgAlarmThreshold=cpwCTDMCfgAlarmThreshold, cpwCTDMValidDayIntervals=cpwCTDMValidDayIntervals, cpwCTDMCfgExcessivePktLossThreshold=cpwCTDMCfgExcessivePktLossThreshold, cpwCTDMPerfIntervalNumber=cpwCTDMPerfIntervalNumber, cpwCTDMMIB=cpwCTDMMIB, cpwCTDMValidIntervals=cpwCTDMValidIntervals, cpwCTDMPerf1DayIntervalJtrBfrUnderruns=cpwCTDMPerf1DayIntervalJtrBfrUnderruns, cpwCTDMPerfCurrentMissingPkts=cpwCTDMPerfCurrentMissingPkts, cpwCTDMPerf1DayIntervalDuration=cpwCTDMPerf1DayIntervalDuration, cpwCTDMPerf1DayIntervalTable=cpwCTDMPerf1DayIntervalTable, cpwCTDMCfgConfErr=cpwCTDMCfgConfErr, cpwCTDMPerfIntervalGroup=cpwCTDMPerfIntervalGroup, cpwCTDMCfgEntry=cpwCTDMCfgEntry, cpwCTDMPerfCurrentGroup=cpwCTDMPerfCurrentGroup, cpwCTDMCfgPayloadSuppression=cpwCTDMCfgPayloadSuppression, cpwCTDMPerfIntervalJtrBfrUnderruns=cpwCTDMPerfIntervalJtrBfrUnderruns, cpwCTDMPerfCurrentMisOrderDropped=cpwCTDMPerfCurrentMisOrderDropped, cpwCTDMEntry=cpwCTDMEntry, cpwCTDMGroup=cpwCTDMGroup, cpwCTDMCfgTimestampMode=cpwCTDMCfgTimestampMode, cpwCRelTDMCfgIndex=cpwCRelTDMCfgIndex, cpwCTDMPerfCurrentTable=cpwCTDMPerfCurrentTable, cpwCTDMPerfCurrentFC=cpwCTDMPerfCurrentFC, cpwCTDMGroups=cpwCTDMGroups, cpwCTDMCompliances=cpwCTDMCompliances, cpwCTDMPerf1DayIntervalMisOrderDropped=cpwCTDMPerf1DayIntervalMisOrderDropped, cpwCTDMRate=cpwCTDMRate, cpwCTDMPerfCurrentMalformedPkt=cpwCTDMPerfCurrentMalformedPkt, cpwCTDMCfgPktReplacePolicy=cpwCTDMCfgPktReplacePolicy, cpwCTDMCfgAvePktLossTimeWindow=cpwCTDMCfgAvePktLossTimeWindow, cpwCTDMPerfIntervalMissingPkts=cpwCTDMPerfIntervalMissingPkts, cpwCTDMIfIndex=cpwCTDMIfIndex, cpwCTDMPerfCurrentUASs=cpwCTDMPerfCurrentUASs, cpwCTDMPerf1DayIntervalMissingPkts=cpwCTDMPerf1DayIntervalMissingPkts, cpwCTDMPerfCurrentSESs=cpwCTDMPerfCurrentSESs, cpwCTDMConformance=cpwCTDMConformance, cpwCTDMCfgIndex=cpwCTDMCfgIndex, cpwCTDMLastEsTimeStamp=cpwCTDMLastEsTimeStamp, cpwCTDMCfgStorageType=cpwCTDMCfgStorageType, cpwCTDMPerf1DayIntervalMalformedPkt=cpwCTDMPerf1DayIntervalMalformedPkt, cpwTDMModuleCompliance=cpwTDMModuleCompliance, cpwCTDMCfgRtpHdrUsed=cpwCTDMCfgRtpHdrUsed, cpwCTDMCfgPayloadSize=cpwCTDMCfgPayloadSize, cpwCTDMPerfIntervalValidData=cpwCTDMPerfIntervalValidData, cpwCTDMCfgTable=cpwCTDMCfgTable, cpwCTDMPerfIntervalMisOrderDropped=cpwCTDMPerfIntervalMisOrderDropped, cpwCTDMPerfCurrentEntry=cpwCTDMPerfCurrentEntry, cpwCTDMLatchedIndications=cpwCTDMLatchedIndications, cpwCTDMPerf1DayIntervalPktsReOrder=cpwCTDMPerf1DayIntervalPktsReOrder, cpwCTDMPerfIntervalUASs=cpwCTDMPerfIntervalUASs, cpwCTDMPerfCurrentPktsReOrder=cpwCTDMPerfCurrentPktsReOrder, cpwCTDMTable=cpwCTDMTable, cpwCTDMPerf1DayIntervalGroup=cpwCTDMPerf1DayIntervalGroup, cpwCTDMCfgConsecPktsInSynch=cpwCTDMCfgConsecPktsInSynch, cpwCTDMConfigError=cpwCTDMConfigError, cpwCTDMObjects=cpwCTDMObjects, cpwCTDMPerfIntervalEntry=cpwCTDMPerfIntervalEntry, cpwCTDMCfgMissingPktsToSes=cpwCTDMCfgMissingPktsToSes, cpwCTDMPerfIntervalSESs=cpwCTDMPerfIntervalSESs, cpwCTDMPerfIntervalMalformedPkt=cpwCTDMPerfIntervalMalformedPkt, cpwCTDMPerf1DayIntervalESs=cpwCTDMPerf1DayIntervalESs, cpwCTDMPerfIntervalFC=cpwCTDMPerfIntervalFC, cpwCTDMCfgRowStatus=cpwCTDMCfgRowStatus, cpwCTDMPerfIntervalPktsReOrder=cpwCTDMPerfIntervalPktsReOrder, cpwCTDMPerf1DayIntervalFC=cpwCTDMPerf1DayIntervalFC, cpwCTDMCfgConsecMissPktsOutSynch=cpwCTDMCfgConsecMissPktsOutSynch, cpwCTDMCfgClearAlarmThreshold=cpwCTDMCfgClearAlarmThreshold, cpwCTDMPerf1DayIntervalSESs=cpwCTDMPerf1DayIntervalSESs, cpwCTDMCfgJtrBfrDepth=cpwCTDMCfgJtrBfrDepth, cpwCTDMCfgSetUp2SynchTimeOut=cpwCTDMCfgSetUp2SynchTimeOut, PYSNMP_MODULE_ID=cpwCTDMMIB)
