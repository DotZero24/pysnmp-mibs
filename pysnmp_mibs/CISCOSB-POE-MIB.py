...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-POE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:41:13 2025
...
class _RlPethPsePortClassLimit_Type(Integer32):
    """Custom type rlPethPsePortClassLimit based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RlPethPsePortClassLimit_Type.__name__ = "Integer32"
_RlPethPsePortClassLimit_Object = MibTableColumn
rlPethPsePortClassLimit = _RlPethPsePortClassLimit_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 108, 1, 1, 24),
    _RlPethPsePortClassLimit_Type()
)
rlPethPsePortClassLimit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlPethPsePortClassLimit.setStatus("current")
_RlPethPsePortNegotiation_Type = TruthValue
_RlPethPsePortNegotiation_Object = MibTableColumn
rlPethPsePortNegotiation = _RlPethPsePortNegotiation_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 108, 1, 1, 25),
    _RlPethPsePortNegotiation_Type()
)
rlPethPsePortNegotiation.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlPethPsePortNegotiation.setStatus("current")
...
rlPethPdPortNegotiationEnable = _RlPethPdPortNegotiationEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 108, 4, 1, 8),
    _RlPethPdPortNegotiationEnable_Type()
)
rlPethPdPortNegotiationEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlPethPdPortNegotiationEnable.setStatus("current")


class _RlPethPdPortPoweredStatus_Type(Integer32):
    """Custom type rlPethPdPortPoweredStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
    ...
    namedValues = NamedValues(
        *(("poweredStatusNA", 0),
          ("poweredStatusPowered", 1),
          ("poweredStatusAbsent", 2))
    )


_RlPethPdPortPoweredStatus_Type.__name__ = "Integer32"
_RlPethPdPortPoweredStatus_Object = MibTableColumn
rlPethPdPortPoweredStatus = _RlPethPdPortPoweredStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 108, 4, 1, 9),
    _RlPethPdPortPoweredStatus_Type()
)
rlPethPdPortPoweredStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlPethPdPortPoweredStatus.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlPoeType": RlPoeType,
       ...
       "rlPethPsePortClassLimit": rlPethPsePortClassLimit,
       "rlPethPsePortNegotiation": rlPethPsePortNegotiation,
       ...
       "rlPethPdPortNegotiationEnable": rlPethPdPortNegotiationEnable,
       "rlPethPdPortPoweredStatus": rlPethPdPortPoweredStatus,
