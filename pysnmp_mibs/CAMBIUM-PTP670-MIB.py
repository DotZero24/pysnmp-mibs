...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsGroup=cableDiagnosticsGroup, wirelessLinkAvailability=wirelessLinkAvailability, configurationInstancedTable=configurationInstancedTable, capacityVariantMismatch=capacityVariantMismatch, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vectorErrorLinked=vectorErrorLinked, rawReceivePower=rawReceivePower, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, transmitPowerLinked=transmitPowerLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, authorizationControlTableEntry=authorizationControlTableEntry, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNMPPortNumber=sNMPPortNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, noWirelessChannelAvailable=noWirelessChannelAvailable, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, mainPSUPortAllocation=mainPSUPortAllocation, packetsToInternalStack=packetsToInternalStack, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, longitude=longitude, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, antennaGain=antennaGain, tDMInterfaceStatus=tDMInterfaceStatus, transparentClockPort=transparentClockPort, licenseCapacity=licenseCapacity, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, userTableEntry=userTableEntry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, alarmInstancedTableIndex=alarmInstancedTableIndex, smtpGroup=smtpGroup, daylightSaving=daylightSaving, auxPortQLTx=auxPortQLTx, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, bootVersion=bootVersion, userTableIndex=userTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, alarmInstancedTableNumber=alarmInstancedTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitterChannels=transmitterChannels, sNMPCommunityString=sNMPCommunityString, aggregateDataRateLinked=aggregateDataRateLinked, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, phyControlInstancedTableEntry=phyControlInstancedTableEntry, resetGroup=resetGroup, unitIdentificationGroup=unitIdentificationGroup, vLANManagementVID=vLANManagementVID, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, supplementaryGroup=supplementaryGroup, phyControlInstancedTable=phyControlInstancedTable, licenseInstancedTable=licenseInstancedTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, dfsPeaks=dfsPeaks, nIDULanPortStatus=nIDULanPortStatus, userName=userName, tFTPServerInternetAddress=tFTPServerInternetAddress, frequencyVariant=frequencyVariant, aAAControlGroup=aAAControlGroup, channelBandwidth=channelBandwidth, mABTransmissionInterval=mABTransmissionInterval, licenseMaxLinkRange=licenseMaxLinkRange, wirelessOutOctets=wirelessOutOctets, systemClock=systemClock, softwareVersion=softwareVersion, iPVersion=iPVersion, tDM=tDM, sNTPServerTable=sNTPServerTable, ptp=ptp, targetRange=targetRange, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, apcGroup=apcGroup, portAllocationMismatch=portAllocationMismatch, tDMChannelLoopback=tDMChannelLoopback, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortStatusTrap=sFPPortStatusTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsControl=cableDiagnosticsControl, cableDiagPair2Distance=cableDiagPair2Distance, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transmitChannel=transmitChannel, dNSGroup=dNSGroup, mABHoldoffPeriod=mABHoldoffPeriod, cableDiagPair3Distance=cableDiagPair3Distance, versionsGroup=versionsGroup, phyStatusGroup=phyStatusGroup, txMABFrames=txMABFrames, mainPSUPortStatus=mainPSUPortStatus, dNSServerInternetAddressType=dNSServerInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, remoteMACAddress=remoteMACAddress, mainPSUPortAutoMdix=mainPSUPortAutoMdix, syslogControlGroup=syslogControlGroup, transparentClock=transparentClock, sFPPortAutoMdix=sFPPortAutoMdix, transmitModulationModeLinked=transmitModulationModeLinked, mABState=mABState, sNMPEnabledTraps=sNMPEnabledTraps, alarmInstancedTableEntry=alarmInstancedTableEntry, maxLinkRangeExceeded=maxLinkRangeExceeded, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTable=userTable, ethernetStatisticsTable=ethernetStatisticsTable, receiveModulationModeLinked=receiveModulationModeLinked, ptmp=ptmp, localPacketFiltering=localPacketFiltering, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, rawReceivePowerLinked=rawReceivePowerLinked, routerProtocols=routerProtocols, mainPSUPortQLRx=mainPSUPortQLRx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, deviceMACAddress=deviceMACAddress, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsTable=dfsTable, wirelessLinkStatus=wirelessLinkStatus, iPv6Address=iPv6Address, receivePower=receivePower, masterSlaveMode=masterSlaveMode, unavailableSeconds=unavailableSeconds, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, configurationInstancedTableEntry=configurationInstancedTableEntry, productName=productName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, lowestTDMModulationMode=lowestTDMModulationMode, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, searchStateLinked=searchStateLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNTPState=sNTPState, wirelessLinkStatusLinked=wirelessLinkStatusLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkLossLinked=linkLossLinked, mABNominalTransmitCapacity=mABNominalTransmitCapacity, pubStats=pubStats, mgmtInstancedTableEntry=mgmtInstancedTableEntry, byteErrorRatio=byteErrorRatio, phyInstancedStatusTable=phyInstancedStatusTable, auxPortSyncERxStatus=auxPortSyncERxStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetPortNumber=telnetPortNumber, sFPPortSSMTx=sFPPortSSMTx, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, pubInstancedStatsTable=pubInstancedStatsTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkName=linkName, syncETracking=syncETracking, tFTPServerPortNumber=tFTPServerPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseIPv6Support=licenseIPv6Support, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sMTPEnabledMessages=sMTPEnabledMessages, dSCPManagementPriority=dSCPManagementPriority, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSync=sNTPSync, enableTransmission=enableTransmission, cableDiagPair2Results=cableDiagPair2Results, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPError=sFPError, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, userPassword=userPassword, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationMode=tDDSynchronizationMode, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, receiveDataRate=receiveDataRate, licenseEncryption=licenseEncryption, notificationsGroup=notificationsGroup, sNTPPollInterval=sNTPPollInterval, tDMChannelStatus=tDMChannelStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, licenseTLSRekey=licenseTLSRekey, installStatusTrap=installStatusTrap, cableDiagPair1Distance=cableDiagPair1Distance, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, timeZone=timeZone, auxPortSSMTx=auxPortSSMTx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseIssueNumber=licenseIssueNumber, installArmState=installArmState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, subbandHighestFrequency=subbandHighestFrequency, portAllocationMismatchTrap=portAllocationMismatchTrap, ptp670=ptp670, userRole=userRole, vLANManagementPriority=vLANManagementPriority, licenseGroup=licenseGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseVersion=licenseVersion, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, subnetMask=subnetMask, transmitDataRateLinked=transmitDataRateLinked, cableDiagPair3Results=cableDiagPair3Results, extendedSpectrumScanning=extendedSpectrumScanning, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTable=ethernetPriorityTable, dfsMeans=dfsMeans, dNSResolver=dNSResolver, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetStatisticsDataSource=ethernetStatisticsDataSource, maximumNumberOfSlaves=maximumNumberOfSlaves, antennaSelection=antennaSelection, unitName=unitName, licenseSyncESupport=licenseSyncESupport, packetsFromInternalStack=packetsFromInternalStack, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dataBridgingStatus=dataBridgingStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, syslogState=syslogState, rangingMode=rangingMode, alarms=alarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, lowestDataModulationMode=lowestDataModulationMode, dNS=dNS, sNTPServerRetries=sNTPServerRetries, tDDSynchronizationStatus=tDDSynchronizationStatus, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, rangeLinked=rangeLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", severelyErroredSeconds=severelyErroredSeconds, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressType=remoteInternetAddressType, cableLoss=cableLoss, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sFPPortAllocation=sFPPortAllocation, ethernetInstancedTable=ethernetInstancedTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseTrialPeriod=licenseTrialPeriod, reset=reset, ethernetInstancedTableEntry=ethernetInstancedTableEntry, userEnabled=userEnabled, sNTPServerStatus=sNTPServerStatus, cableDiagPair4Distance=cableDiagPair4Distance, sNTPServerTableEntry=sNTPServerTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortPauseFrames=dataPortPauseFrames, dNSServerTableIndex=dNSServerTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, license=license, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, subbandLowestFrequency=subbandLowestFrequency, sNTPLastSync=sNTPLastSync, transmitFreqMHz=transmitFreqMHz, bridge=bridge, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, searchState=searchState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseSecurityLevel=licenseSecurityLevel, licenseRARSupport=licenseRARSupport, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, blacklistRMEnabled=blacklistRMEnabled, linkSymmetry=linkSymmetry, auxPortStatus=auxPortStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, secureModeAlarmTrap=secureModeAlarmTrap, sntp=sntp, tdmTable=tdmTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, regulatoryBand=regulatoryBand, transmitModulationMode=transmitModulationMode, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, phyControlInstancedTableNumber=phyControlInstancedTableNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, licenseGasGroup=licenseGasGroup, receivePowerLinked=receivePowerLinked, productVariant=productVariant, syncESlavePort=syncESlavePort, l2CPPriorityTableIndex=l2CPPriorityTableIndex, auxPortStatusTrap=auxPortStatusTrap, PYSNMP_MODULE_ID=cambium, sNMPTrapTable=sNMPTrapTable, unitOutOfCalibration=unitOutOfCalibration, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, authorizationControlTableNumber=authorizationControlTableNumber, linkModeOptimization=linkModeOptimization, unitIdentification=unitIdentification, licenseIEEE1588Support=licenseIEEE1588Support, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseInstancedTableEntry=licenseInstancedTableEntry, secureModeAlarm=secureModeAlarm, ptpTraps=ptpTraps, syncEEquipmentClock=syncEEquipmentClock, txColorCode=txColorCode, targetMACAddress=targetMACAddress, dNSPrimaryServer=dNSPrimaryServer, ethernet=ethernet, remoteUnitName=remoteUnitName, syslogControl=syslogControl, sNTPSyncTrap=sNTPSyncTrap, mgmtInstancedTable=mgmtInstancedTable, supplementary=supplementary, dNSServerTable=dNSServerTable, signalStrengthRatio=signalStrengthRatio, dataBridgingStatusLinked=dataBridgingStatusLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyControlInstancedTableIndex=phyControlInstancedTableIndex, siteName=siteName, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDMEnabledChannels=tDMEnabledChannels, blacklistRMMacAddress=blacklistRMMacAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControl=phyControl, sMTPServerPortNumber=sMTPServerPortNumber, regulatoryBandTrap=regulatoryBandTrap, hardwareVersion=hardwareVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, wirelessOutEthernetOctets=wirelessOutEthernetOctets, capacityVariantMismatchLinked=capacityVariantMismatchLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDMChannelCableLength=tDMChannelCableLength, tDDControl=tDDControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqMHz=receiveFreqMHz, remoteMACAddressLinked=remoteMACAddressLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, apc=apc, versions=versions, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortAllocation=auxPortAllocation, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, authorizationControl=authorizationControl, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, gatewayIPAddress=gatewayIPAddress, latitude=latitude, encryptionGroup=encryptionGroup, mainPSUPortQLTx=mainPSUPortQLTx, syslogClientTrap=syslogClientTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cableDiagPair1Results=cableDiagPair1Results, cableDiagnostics=cableDiagnostics, nIDULanPortAutoMdix=nIDULanPortAutoMdix, channelChangeTrap=channelChangeTrap, bridgeGroup=bridgeGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkLoss=linkLoss, sFPErrorTrap=sFPErrorTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortQLTx=sFPPortQLTx, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, systemReset=systemReset, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, receiveDataRateLinked=receiveDataRateLinked, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, range=range, licenseTDDSyncSupport=licenseTDDSyncSupport, dNSServerTableNumber=dNSServerTableNumber, installStatusLinked=installStatusLinked, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, authorizationControlTableIndex=authorizationControlTableIndex, eIRP=eIRP, smtp=smtp, dNSServerInternetAddress=dNSServerInternetAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, configuration=configuration, configurationGroup=configurationGroup, authorizationControlGroup=authorizationControlGroup, telnetAccessEnabled=telnetAccessEnabled, managementNetworkAccessEnabled=managementNetworkAccessEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDMInterfaceControl=tDMInterfaceControl, receiveModulationModeDetail=receiveModulationModeDetail, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, snmpControlGroup=snmpControlGroup, wirelessOutAllOctets=wirelessOutAllOctets, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, authorizationMethod=authorizationMethod, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDDControlGroup=tDDControlGroup, erroredSeconds=erroredSeconds, tdmTableNumber=tdmTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagnosticsPorts=cableDiagnosticsPorts, tFTPClient=tFTPClient, remoteUnitNameLinked=remoteUnitNameLinked, remoteInternetAddressLinked=remoteInternetAddressLinked, aAAControl=aAAControl, transparentClockVLAN=transparentClockVLAN, licenseRegulatoryBandsList=licenseRegulatoryBandsList, transparentClockVID=transparentClockVID, phyControlGroup=phyControlGroup, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, deviceESN=deviceESN, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mgmtInstancedTableNumber=mgmtInstancedTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, portAllocationMismatchLinked=portAllocationMismatchLinked, iPv4Address=iPv4Address, cambium=cambium, dfsGroup=dfsGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, whitelistRMEnabled=whitelistRMEnabled, accessMethod=accessMethod, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortDisabledWarning=auxPortDisabledWarning, installArmStateTrap=installArmStateTrap, cableDiagPair4Results=cableDiagPair4Results, receiveChannel=receiveChannel, dfsTableNumber=dfsTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, installStatus=installStatus, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dNSServerPortNumber=dNSServerPortNumber, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortStatus=sFPPortStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, iPDSCPPriorityTable=iPDSCPPriorityTable, rxColorCode=rxColorCode, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, syslogClient=syslogClient, syslogStateTrap=syslogStateTrap, aggregateDataRate=aggregateDataRate, wirelessTopology=wirelessTopology, tDMGroup=tDMGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mABNominalModulationMode=mABNominalModulationMode, tdmTableEntry=tdmTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, remoteInternetAddress=remoteInternetAddress, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseHCMPSupport=licenseHCMPSupport, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ethernetGroup=ethernetGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sntpGroup=sntpGroup, receiveModulationMode=receiveModulationMode, dfsTableEntry=dfsTableEntry, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, alarmsGroup=alarmsGroup, phyStatus=phyStatus, licenseCountry=licenseCountry, alarmInstancedTable=alarmInstancedTable, auxPortQLRx=auxPortQLRx, sMTPEmailAlert=sMTPEmailAlert, byteErrorRatioLinked=byteErrorRatioLinked, iPv6PrefixLength=iPv6PrefixLength, encryptionAlgorithm=encryptionAlgorithm)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", routerProtocolsGroup=routerProtocolsGroup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, syncETrackingState=syncETrackingState, dNSServerTableEntry=dNSServerTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, transmitFreqKHz=transmitFreqKHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, snmpControl=snmpControl, oOBPriorityQueueMapping=oOBPriorityQueueMapping, authorizationControlTable=authorizationControlTable, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseBandwidthCap=licenseBandwidthCap, tdmTableIndex=tdmTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mABProtocolVID=mABProtocolVID, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tDMChannelLineCode=tDMChannelLineCode, licenseGroupAccess=licenseGroupAccess, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dfsTableIndex=dfsTableIndex, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dfs=dfs, lbtDetectedTrap=lbtDetectedTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sFPPortQLRx=sFPPortQLRx, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installationMode=installationMode, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dataBridgingAvailability=dataBridgingAvailability, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ptpGroups=ptpGroups, vectorError=vectorError, pubStatsGroup=pubStatsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, altitude=altitude, groupID=groupID, sNTPServerTableNumber=sNTPServerTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, deviceMSN=deviceMSN, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, encryption=encryption, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, tempPcb=tempPcb, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, managementGroup=managementGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch)
