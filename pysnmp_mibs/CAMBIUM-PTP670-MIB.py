...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cambium/CAMBIUM-PTP670-MIB
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityTableIndex=l2CPPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagPair2Results=cableDiagPair2Results, sntpGroup=sntpGroup, remoteUnitNameLinked=remoteUnitNameLinked, accessMethod=accessMethod, dfsTableNumber=dfsTableNumber, packetsFromInternalStack=packetsFromInternalStack, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfs=dfs, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitDataRate=transmitDataRate, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, channelBandwidth=channelBandwidth, aAAControl=aAAControl, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, transparentClock=transparentClock, installArmStateTrap=installArmStateTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, rawReceivePowerLinked=rawReceivePowerLinked, license=license, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, authorizationControlGroup=authorizationControlGroup, auxPortAllocation=auxPortAllocation, mgmtInstancedTableIndex=mgmtInstancedTableIndex, authorizationMethod=authorizationMethod, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPLastSync=sNTPLastSync, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPServerTableNumber=sNTPServerTableNumber, encryption=encryption, transparentClockVLAN=transparentClockVLAN, whitelistRMEnabled=whitelistRMEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, packetsToInternalStack=packetsToInternalStack, sFPPortStatus=sFPPortStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syncETracking=syncETracking, alarmInstancedTableIndex=alarmInstancedTableIndex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sFPPortAutoMdix=sFPPortAutoMdix, channelChangeTrap=channelChangeTrap, linkModeOptimization=linkModeOptimization, phyControlGroup=phyControlGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, localPacketFiltering=localPacketFiltering, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataBridgingAvailability=dataBridgingAvailability, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, userRole=userRole, licenseMaxLinkRange=licenseMaxLinkRange, aggregateDataRate=aggregateDataRate, qOSPriorityScheme=qOSPriorityScheme, tFTPServerInternetAddress=tFTPServerInternetAddress, configuration=configuration, cableLoss=cableLoss, tDMEnabledChannels=tDMEnabledChannels, licenseGroupAccess=licenseGroupAccess, latitude=latitude, licenseSFPPortSupport=licenseSFPPortSupport, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, rangingMode=rangingMode, syslogState=syslogState, deviceMACAddress=deviceMACAddress, sNTPServerTimeout=sNTPServerTimeout, productName=productName, ethernetGroup=ethernetGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mABMaintenanceLevel=mABMaintenanceLevel, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitPowerLinked=transmitPowerLinked, bootVersion=bootVersion, severelyErroredSeconds=severelyErroredSeconds, phyStatus=phyStatus, licenseInstancedTableEntry=licenseInstancedTableEntry, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mABProtocolVID=mABProtocolVID, bridge=bridge, tDDControlGroup=tDDControlGroup, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, systemClock=systemClock, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, unitName=unitName, capacityVariantMismatchLinked=capacityVariantMismatchLinked, authorizationControlTableNumber=authorizationControlTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, userTable=userTable, vLANManagementVID=vLANManagementVID, dNSGroup=dNSGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, dNSServerInternetAddress=dNSServerInternetAddress, iPVersion=iPVersion, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, dfsGroup=dfsGroup, installStatusTrap=installStatusTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, signalStrengthRatioLinked=signalStrengthRatioLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, byteErrorRatio=byteErrorRatio, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, secureModeAlarm=secureModeAlarm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPv6PrefixLength=iPv6PrefixLength, rangeLinked=rangeLinked, tDMChannelLoopback=tDMChannelLoopback, enableTransmission=enableTransmission, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseTLSRekey=licenseTLSRekey, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receivePower=receivePower, sNTPServerTable=sNTPServerTable, dNS=dNS, installStatus=installStatus, vLANManagementPriority=vLANManagementPriority, searchState=searchState, snmpControl=snmpControl, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, aAAControlGroup=aAAControlGroup, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, cableDiagPair3Distance=cableDiagPair3Distance, wirelessOutOctets=wirelessOutOctets, pubStatsGroup=pubStatsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClientTrap=syslogClientTrap, byteErrorRatioLinked=byteErrorRatioLinked, ptpCompliance=ptpCompliance, licenseGroup=licenseGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, lowestDataModulationMode=lowestDataModulationMode, tDMChannelLineCode=tDMChannelLineCode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, installArmState=installArmState, altitude=altitude, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, telnetPortNumber=telnetPortNumber, rawReceivePower=rawReceivePower, syslogControl=syslogControl, tdmTable=tdmTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, versions=versions, cambium=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, ethernetInstancedTable=ethernetInstancedTable, ethernet=ethernet, transparentClockVID=transparentClockVID, sntp=sntp, dfsTable=dfsTable, cableDiagPair4Distance=cableDiagPair4Distance, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseCapacity=licenseCapacity, supplementaryGroup=supplementaryGroup, sFPPortSSMTx=sFPPortSSMTx, mgmtInstancedTable=mgmtInstancedTable, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dNSServerTableNumber=dNSServerTableNumber, reset=reset, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dNSServerTableIndex=dNSServerTableIndex, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, rxColorCode=rxColorCode, sNTPServerRetries=sNTPServerRetries, sMTPServerInternetAddressType=sMTPServerInternetAddressType, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sNTPSyncTrap=sNTPSyncTrap, tDM=tDM, range=range, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, supplementary=supplementary, tDDControl=tDDControl, dfsTableIndex=dfsTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, auxPortDisabledWarning=auxPortDisabledWarning, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transparentClockPort=transparentClockPort, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sNTPSync=sNTPSync, sNTPServerStatus=sNTPServerStatus, unavailableSeconds=unavailableSeconds, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPError=sFPError, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, alarmInstancedTableNumber=alarmInstancedTableNumber, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, cableDiagPair1Distance=cableDiagPair1Distance, receivePowerLinked=receivePowerLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, installationMode=installationMode, tDMChannelCableLength=tDMChannelCableLength, transmitFreqKHz=transmitFreqKHz, licenseGasGroup=licenseGasGroup, receiveFreqMHz=receiveFreqMHz, smtp=smtp, licenseVersion=licenseVersion, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, smtpGroup=smtpGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, alarms=alarms, mABState=mABState, tDDSynchronizationMode=tDDSynchronizationMode, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, siteName=siteName, masterSlaveMode=masterSlaveMode, lowestTDMModulationMode=lowestTDMModulationMode, userTableEntry=userTableEntry, licenseSecurityLevel=licenseSecurityLevel, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, nIDULanPortStatus=nIDULanPortStatus, receiveDataRate=receiveDataRate, l2CPPriorityTable=l2CPPriorityTable, transmitPower=transmitPower, frequencyVariant=frequencyVariant, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseCountry=licenseCountry, transmitDataRateLinked=transmitDataRateLinked, ptmp=ptmp, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagPair4Results=cableDiagPair4Results, receiveChannel=receiveChannel, authorizationControlTableEntry=authorizationControlTableEntry, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, remoteInternetAddress=remoteInternetAddress, mainPSUPortQLTx=mainPSUPortQLTx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagnostics=cableDiagnostics, groupID=groupID, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddressLinked=remoteInternetAddressLinked, targetMACAddress=targetMACAddress, management=management, aggregateDataRateLinked=aggregateDataRateLinked, softwareVersion=softwareVersion, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMGroup=tDMGroup, hCMPLinkSymmetry=hCMPLinkSymmetry, timeZone=timeZone, dNSPrimaryServer=dNSPrimaryServer, cableDiagPair3Results=cableDiagPair3Results, auxPortQLTx=auxPortQLTx, sNMPEnabledTraps=sNMPEnabledTraps, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ptp670=ptp670, maximumTransmitPower=maximumTransmitPower, tdmTableNumber=tdmTableNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, secondarySoftwareVersion=secondarySoftwareVersion, dNSServerTable=dNSServerTable, userPassword=userPassword, ethernetStatisticsTable=ethernetStatisticsTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMInterfaceStatus=tDMInterfaceStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, receiveDataRateLinked=receiveDataRateLinked, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sFPPortQLRx=sFPPortQLRx, tDDSynchronizationAlarm=tDDSynchronizationAlarm, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, unitOutOfCalibration=unitOutOfCalibration, deviceMSN=deviceMSN, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortStatusTrap=sFPPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortStatusTrap=mainPSUPortStatusTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tdmTableIndex=tdmTableIndex, licenseIPv6Support=licenseIPv6Support, iPv6Address=iPv6Address, licenseInstancedTableNumber=licenseInstancedTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, authorizationControl=authorizationControl, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsResultTable=cableDiagnosticsResultTable, transmitterChannels=transmitterChannels, gatewayIPAddress=gatewayIPAddress, sMTPEmailAlert=sMTPEmailAlert, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, alarmInstancedTableEntry=alarmInstancedTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installStatusLinked=installStatusLinked, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mABHoldoffPeriod=mABHoldoffPeriod, encryptionGroup=encryptionGroup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dNSResolver=dNSResolver, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hardwareVersion=hardwareVersion, bridgeGroup=bridgeGroup, eIRP=eIRP, dfsPeaks=dfsPeaks, ptpTraps=ptpTraps, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, blacklistRMEnabled=blacklistRMEnabled, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseRARSupport=licenseRARSupport, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNMPCommunityString=sNMPCommunityString, sFPPortAllocation=sFPPortAllocation, ptpGroups=ptpGroups, unitIdentification=unitIdentification, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tDMChannelStatusTrap=tDMChannelStatusTrap, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, sNTPPollInterval=sNTPPollInterval, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseEncryption=licenseEncryption, sNTPState=sNTPState, subbandLowestFrequency=subbandLowestFrequency, notificationsGroup=notificationsGroup, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, wirelessOutEthernetOctets=wirelessOutEthernetOctets, userName=userName, portAllocationMismatchLinked=portAllocationMismatchLinked, auxPortAcceptedQLRx=auxPortAcceptedQLRx, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, apc=apc, apcGroup=apcGroup, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNTPServerTableIndex=sNTPServerTableIndex, configurationInstancedTableIndex=configurationInstancedTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ethernetPriorityTable=ethernetPriorityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, dNSServerPortNumber=dNSServerPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, erroredSeconds=erroredSeconds, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagnosticsControl=cableDiagnosticsControl, sNMPv3Enable=sNMPv3Enable, auxPortQLRx=auxPortQLRx, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, ethernetInstancedTableIndex=ethernetInstancedTableIndex, tDMChannelStatus=tDMChannelStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sMTPEnabledMessages=sMTPEnabledMessages, routerProtocolsGroup=routerProtocolsGroup, systemReset=systemReset, alarmsGroup=alarmsGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortQLTx=sFPPortQLTx, userTableNumber=userTableNumber, managementGroup=managementGroup, cableDiagPair1Results=cableDiagPair1Results, daylightSaving=daylightSaving, vectorErrorLinked=vectorErrorLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, syncETrackingState=syncETrackingState, wirelessOutAllOctets=wirelessOutAllOctets, mainPSUPortQLRx=mainPSUPortQLRx, userEnabled=userEnabled, remoteMACAddressLinked=remoteMACAddressLinked, transmitFreqMHz=transmitFreqMHz, txColorCode=txColorCode, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, syncEEquipmentClock=syncEEquipmentClock, capacityVariantMismatch=capacityVariantMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regulatoryBand=regulatoryBand, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sFPErrorTrap=sFPErrorTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, alarmInstancedTable=alarmInstancedTable, pubStats=pubStats, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dfsMeans=dfsMeans, transmitModulationModeLinked=transmitModulationModeLinked, portAllocationMismatch=portAllocationMismatch, mABNominalModulationMode=mABNominalModulationMode, tFTPClient=tFTPClient, dataBridgingStatus=dataBridgingStatus, sNMPPortNumber=sNMPPortNumber, ptp=ptp, licenseInstancedTableIndex=licenseInstancedTableIndex, capacityVariantMismatchTrap=capacityVariantMismatchTrap, linkLoss=linkLoss, remoteInternetAddressType=remoteInternetAddressType, remoteMACAddress=remoteMACAddress, auxPortSSMTx=auxPortSSMTx, hTTPPortNumber=hTTPPortNumber, extendedSpectrumScanning=extendedSpectrumScanning, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, PYSNMP_MODULE_ID=cambium, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, auxPortStatus=auxPortStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, unitIdentificationGroup=unitIdentificationGroup, productVariant=productVariant, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, authorizationControlTable=authorizationControlTable, whitelistRMMacAddress=whitelistRMMacAddress, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, longitude=longitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseIssueNumber=licenseIssueNumber, useVLANForMABProtocol=useVLANForMABProtocol, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, lbtDetectedTrap=lbtDetectedTrap, phyControlInstancedTable=phyControlInstancedTable, dataPortPauseFrames=dataPortPauseFrames, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseSyncESupport=licenseSyncESupport, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, txMABFrames=txMABFrames, authorizationControlTableIndex=authorizationControlTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configurationInstancedTable=configurationInstancedTable, mainPSUPortStatus=mainPSUPortStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, phyInstancedStatusTable=phyInstancedStatusTable, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tDMInterfaceControl=tDMInterfaceControl, antennaSelection=antennaSelection, targetRange=targetRange, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationMode=receiveModulationMode, syslogStateTrap=syslogStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, licenseInstancedTable=licenseInstancedTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkLossLinked=linkLossLinked, dNSServerTableEntry=dNSServerTableEntry, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, resetGroup=resetGroup, tdmTableEntry=tdmTableEntry, phyControlInstancedTableNumber=phyControlInstancedTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataBridgingStatusLinked=dataBridgingStatusLinked, linkSymmetry=linkSymmetry, syncESlavePort=syncESlavePort, regulatoryBandTrap=regulatoryBandTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, phyControl=phyControl, syslogControlGroup=syslogControlGroup, versionsGroup=versionsGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, mABProtocolVLANPriority=mABProtocolVLANPriority, routerProtocols=routerProtocols, mainPSUPortAllocation=mainPSUPortAllocation, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, receiveModulationModeLinked=receiveModulationModeLinked, subbandHighestFrequency=subbandHighestFrequency, licenseBandwidthCap=licenseBandwidthCap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, snmpControlGroup=snmpControlGroup, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv4Address=iPv4Address, licenseTrialPeriod=licenseTrialPeriod, tempPcb=tempPcb, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNTPPrimaryServer=sNTPPrimaryServer, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitChannel=transmitChannel, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, linkName=linkName, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, searchStateLinked=searchStateLinked, pubInstancedStatsTable=pubInstancedStatsTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteUnitName=remoteUnitName, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, deviceESN=deviceESN, syslogClient=syslogClient, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortStatusTrap=auxPortStatusTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, dNSServerInternetAddressType=dNSServerInternetAddressType, wirelessTopology=wirelessTopology, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseHCMPSupport=licenseHCMPSupport, dataBridgingStatusAlarm=dataBridgingStatusAlarm)
