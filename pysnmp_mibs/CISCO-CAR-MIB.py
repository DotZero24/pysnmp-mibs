...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CAR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:41:00 2025
...
ciscoCarMIBCompliance.setObjects(
    ("CISCO-CAR-MIB", "ciscoCarMIBGroup")
)
if mibBuilder.loadTexts:
...
ciscoCarMIBComplianceHCCounters.setObjects(
      *(("CISCO-CAR-MIB", "ciscoCarMIBGroup"),
        ("CISCO-CAR-MIB", "ciscoCarMIBHCGroup"))
)
if mibBuilder.loadTexts:
