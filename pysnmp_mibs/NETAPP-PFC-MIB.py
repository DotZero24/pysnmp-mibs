...
agentPfcCfgGroup=_AgentPfcCfgGroup_ObjectIdentity((1,3,6,1,4,1,789,4413,1,1,47,1))
_AgentPfcTable_Object=MibTable
agentPfcTable=_AgentPfcTable_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1))
if mibBuilder.loadTexts:agentPfcTable.setStatus(_A)
_AgentPfcEntry_Object=MibTableRow
agentPfcEntry=_AgentPfcEntry_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1))
...
agentPfcIntfIndex=_AgentPfcIntfIndex_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,1),_AgentPfcIntfIndex_Type())
...
agentPfcIntfAdminMode=_AgentPfcIntfAdminMode_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,2),_AgentPfcIntfAdminMode_Type())
...
agentPfcIntfPfcStatus=_AgentPfcIntfPfcStatus_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,3),_AgentPfcIntfPfcStatus_Type())
...
agentPfcTotalIntfPfcFramesRx=_AgentPfcTotalIntfPfcFramesRx_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,4),_AgentPfcTotalIntfPfcFramesRx_Type())
...
agentPfcTotalIntfPfcFramesTx=_AgentPfcTotalIntfPfcFramesTx_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,5),_AgentPfcTotalIntfPfcFramesTx_Type())
...
agentPfcIntfLinkDelayAllowance=_AgentPfcIntfLinkDelayAllowance_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,6),_AgentPfcIntfLinkDelayAllowance_Type())
...
agentPfcIntfAdvWilling=_AgentPfcIntfAdvWilling_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,7),_AgentPfcIntfAdvWilling_Type())
...
agentPfcIntfPeerDetected=_AgentPfcIntfPeerDetected_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,8),_AgentPfcIntfPeerDetected_Type())
...
agentPfcIntfPeerMacAddr=_AgentPfcIntfPeerMacAddr_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,9),_AgentPfcIntfPeerMacAddr_Type())
...
agentPfcIntfPeerWilling=_AgentPfcIntfPeerWilling_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,10),_AgentPfcIntfPeerWilling_Type())
...
agentPfcIntfPeerMBCStatus=_AgentPfcIntfPeerMBCStatus_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,11),_AgentPfcIntfPeerMBCStatus_Type())
...
agentPfcIntfPeerCapability=_AgentPfcIntfPeerCapability_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,12),_AgentPfcIntfPeerCapability_Type())
...
agentPfcIntfPeerCfgCompatible=_AgentPfcIntfPeerCfgCompatible_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,13),_AgentPfcIntfPeerCfgCompatible_Type())
...
agentPfcIntfPeerCompatibleCfgCount=_AgentPfcIntfPeerCompatibleCfgCount_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,14),_AgentPfcIntfPeerCompatibleCfgCount_Type())
...
agentPfcIntfPeerIncompatibleCfgCount=_AgentPfcIntfPeerIncompatibleCfgCount_Object((1,3,6,1,4,1,789,4413,1,1,47,1,1,1,15),_AgentPfcIntfPeerIncompatibleCfgCount_Type())
...
agentPfcActionTable=_AgentPfcActionTable_Object((1,3,6,1,4,1,789,4413,1,1,47,1,2))
if mibBuilder.loadTexts:agentPfcActionTable.setStatus(_A)
_AgentPfcActionEntry_Object=MibTableRow
agentPfcActionEntry=_AgentPfcActionEntry_Object((1,3,6,1,4,1,789,4413,1,1,47,1,2,1))
...
agentPfcPriority=_AgentPfcPriority_Object((1,3,6,1,4,1,789,4413,1,1,47,1,2,1,1),_AgentPfcPriority_Type())
...
agentPfcAction=_AgentPfcAction_Object((1,3,6,1,4,1,789,4413,1,1,47,1,2,1,2),_AgentPfcAction_Type())
...
agentPfcOperAction=_AgentPfcOperAction_Object((1,3,6,1,4,1,789,4413,1,1,47,1,2,1,3),_AgentPfcOperAction_Type())
...
agentPfcAdvAction=_AgentPfcAdvAction_Object((1,3,6,1,4,1,789,4413,1,1,47,1,2,1,4),_AgentPfcAdvAction_Type())
...
agentPfcPeerAction=_AgentPfcPeerAction_Object((1,3,6,1,4,1,789,4413,1,1,47,1,2,1,5),_AgentPfcPeerAction_Type())
...
agentPfcIntfStatsPerPriorityTable=_AgentPfcIntfStatsPerPriorityTable_Object((1,3,6,1,4,1,789,4413,1,1,47,1,3))
...
agentPfcIntfStatsPerPriorityEntry=_AgentPfcIntfStatsPerPriorityEntry_Object((1,3,6,1,4,1,789,4413,1,1,47,1,3,1))
...
agentPfcIntfPfcPriorityFramesRx=_AgentPfcIntfPfcPriorityFramesRx_Object((1,3,6,1,4,1,789,4413,1,1,47,1,3,1,1),_AgentPfcIntfPfcPriorityFramesRx_Type())
...
agentPfcIntfPfcPriorityFramesTx=_AgentPfcIntfPfcPriorityFramesTx_Object((1,3,6,1,4,1,789,4413,1,1,47,1,3,1,2),_AgentPfcIntfPfcPriorityFramesTx_Type())
