...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-AP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:34:46 2025
...
class _MyApFlowBanlance_Type(Integer32):
    """Custom type myApFlowBanlance based on Integer32"""
...
_MyApFlowBanlance_Type.__name__ = "Integer32"
_MyApFlowBanlance_Object = MibScalar
myApFlowBanlance = _MyApFlowBanlance_Object(
    (1, 3, 6, 1, 4, 1, 4881, 1, 1, 10, 2, 7, 1, 5),
    _MyApFlowBanlance_Type()
)
myApFlowBanlance.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    myApFlowBanlance.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"myApMIB": myApMIB,
       ...
       "myApFlowBanlance": myApFlowBanlance,
