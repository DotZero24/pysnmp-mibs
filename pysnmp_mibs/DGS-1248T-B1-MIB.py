...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/d-link/DGS-1248T-B1-MIB
...
mibBuilder.exportSymbols("DGS-1248T-B1-MIB", portTrunkMember=portTrunkMember, commTrapTrapAbnormalTPTXError=commTrapTrapAbnormalTPTXError, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, configPasswordAdmin=configPasswordAdmin, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, configRestoreDefaults=configRestoreDefaults, commSetStatus=commSetStatus, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, configPhysAddress=configPhysAddress, configPortTable=configPortTable, staticMac=staticMac, configPortFlowControlOper=configPortFlowControlOper, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, configVerSwPrimary=configVerSwPrimary, tvlanName=tvlanName, commSetTable=commSetTable, igsVlanFilterStatus=igsVlanFilterStatus, igsSharedSegmentAggregationInterval=igsSharedSegmentAggregationInterval, d_link=d_link, igsMcastEntryAgeingInterval=igsMcastEntryAgeingInterval, radiusServerAddress=radiusServerAddress, companyTVlanGroup=companyTVlanGroup, igsQueryInterval=igsQueryInterval, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, igsVlanFilterTable=igsVlanFilterTable, MacAddress=MacAddress, commTrapTrapAbnormalFiberTXError=commTrapTrapAbnormalFiberTXError, igsSystem=igsSystem, swTPAbnormalRXError=swTPAbnormalRXError, configMirrorEntry=configMirrorEntry, swTPAbnormalTXError=swTPAbnormalTXError, staticOnOff=staticOnOff, configPortOperStatus=configPortOperStatus, igsVlan=igsVlan, igsRobustnessValue=igsRobustnessValue, staticPort=staticPort, tvlanTable=tvlanTable, igsv3Processing=igsv3Processing, commTrapName=commTrapName, igsVlanMcastFwdPortListMac=igsVlanMcastFwdPortListMac, configNetMask=configNetMask, tvlanStatus=tvlanStatus, PortList=PortList, dlink_products=dlink_products, companyMiscGroup=companyMiscGroup, configPort=configPort, swFiberAbnormalTXError=swFiberAbnormalTXError, configIpAssignmentMode=configIpAssignmentMode, configMirrorMon=configMirrorMon, configVLANMode=configVLANMode, configMirrorRXSrc=configMirrorRXSrc, companyDot1xGroup=companyDot1xGroup, staticStatus=staticStatus, staticId=staticId, igsVlanMcastFwdVlanIdMac=igsVlanMcastFwdVlanIdMac, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, configMirrorStatus=configMirrorStatus, swFiberRemove=swFiberRemove, configIpAddress=configIpAddress, companyConfigGroup=companyConfigGroup, staticTable=staticTable, commTrapIndex=commTrapIndex, dlink_DGS12XXTSeriesProd=dlink_DGS12XXTSeriesProd, spanOnOff=spanOnOff, commTrapTrapAbnormalFiberRXError=commTrapTrapAbnormalFiberRXError, configMirrorId=configMirrorId, companyCommGroup=companyCommGroup, OwnerString=OwnerString, dot1xAuth=dot1xAuth, commGetTable=commGetTable, tvlanUntaggedPorts=tvlanUntaggedPorts, configPortSpeed=configPortSpeed, configPortEntry=configPortEntry, commGetEntry=commGetEntry, commTrapSNMPBootup=commTrapSNMPBootup, commTrapSNMPTPLinkUpDown=commTrapSNMPTPLinkUpDown, igsNextMcastFwdMode=igsNextMcastFwdMode, swFiberInsert=swFiberInsert, commGetIndex=commGetIndex, portTrunkEntry=portTrunkEntry, igsVlanRouterPortList=igsVlanRouterPortList, dot1xAuthMaxReq=dot1xAuthMaxReq, commSetName=commSetName, swFiberAbnormalRXError=swFiberAbnormalRXError, igsVlanMcastFwdGroupAddress=igsVlanMcastFwdGroupAddress, companyStaticGroup=companyStaticGroup, dot1xAuthServerTimeout=dot1xAuthServerTimeout, igsLeaveProcessInterval=igsLeaveProcessInterval, commGetStatus=commGetStatus, configGateway=configGateway, configPortPriority=configPortPriority, tvlanMember=tvlanMember, igsVlanMcastFwdEntry=igsVlanMcastFwdEntry, staticEntry=staticEntry, commTrapStatus=commTrapStatus, igsGblReportFwdOnAllPorts=igsGblReportFwdOnAllPorts, igsVlanMcastFwdTable=igsVlanMcastFwdTable, commTrapIpAddress=commTrapIpAddress, igsVlanRouterPortListTable=igsVlanRouterPortListTable, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, igsVlanRouterPortListVlanId=igsVlanRouterPortListVlanId, igsHostPortPurgeInterval=igsHostPortPurgeInterval, igsReportForwardInterval=igsReportForwardInterval, RowStatus=RowStatus, companyIgsGroup=companyIgsGroup, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, radiusServerPort=radiusServerPort, configMirrorTable=configMirrorTable, configVerHwChipSet=configVerHwChipSet, igsVlanRouterPortListEntry=igsVlanRouterPortListEntry, portTrunkTable=portTrunkTable, dot1xAuthTxPeriod=dot1xAuthTxPeriod, dot1xAuthSystemControl=dot1xAuthSystemControl, staticVlanID=staticVlanID, commTrapSNMPFiberLinkUpDown=commTrapSNMPFiberLinkUpDown, igsVlanFilterEntry=igsVlanFilterEntry, companySpanGroup=companySpanGroup, igsStatus=igsStatus, commSetEntry=commSetEntry, configPortFlowControl=configPortFlowControl, commTrapTable=commTrapTable, configMirrorTXSrc=configMirrorTXSrc, configSNMPEnable=configSNMPEnable, igsVlanId=igsVlanId, dgs_1248tb1=dgs_1248tb1, portTrunkName=portTrunkName, commSetIndex=commSetIndex, commTrapTrapAbnormalTPRXError=commTrapTrapAbnormalTPRXError, commTrapEntry=commTrapEntry, portTrunkId=portTrunkId, igsQueryMaxResponseTime=igsQueryMaxResponseTime, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, companyPortTrunkGroup=companyPortTrunkGroup, miscStatisticsReset=miscStatisticsReset, configSave=configSave, radiusServerSharedSecret=radiusServerSharedSecret, commGetName=commGetName, tvlanEntry=tvlanEntry, tvlanId=tvlanId, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, staticAutoLearning=staticAutoLearning, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, radius=radius, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, miscReset=miscReset, igsLastMembQueryInterval=igsLastMembQueryInterval)
