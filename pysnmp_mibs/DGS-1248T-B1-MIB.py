...
mibBuilder.exportSymbols("DGS-1248T-B1-MIB", configMirrorStatus=configMirrorStatus, tvlanUntaggedPorts=tvlanUntaggedPorts, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, commTrapStatus=commTrapStatus, swTPAbnormalTXError=swTPAbnormalTXError, igsMcastEntryAgeingInterval=igsMcastEntryAgeingInterval, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, igsVlanMcastFwdPortListMac=igsVlanMcastFwdPortListMac, configPortOperStatus=configPortOperStatus, dlink_products=dlink_products, commSetTable=commSetTable, commTrapIpAddress=commTrapIpAddress, igsQueryInterval=igsQueryInterval, radiusServerPort=radiusServerPort, miscReset=miscReset, igsQueryMaxResponseTime=igsQueryMaxResponseTime, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, configPortSpeed=configPortSpeed, staticOnOff=staticOnOff, configNetMask=configNetMask, commTrapTrapAbnormalTPTXError=commTrapTrapAbnormalTPTXError, staticStatus=staticStatus, RowStatus=RowStatus, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, configVerHwChipSet=configVerHwChipSet, dot1xAuthServerTimeout=dot1xAuthServerTimeout, companyMiscGroup=companyMiscGroup, commTrapSNMPTPLinkUpDown=commTrapSNMPTPLinkUpDown, staticTable=staticTable, dot1xAuth=dot1xAuth, igsGblReportFwdOnAllPorts=igsGblReportFwdOnAllPorts, tvlanId=tvlanId, staticEntry=staticEntry, igsRobustnessValue=igsRobustnessValue, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, commTrapEntry=commTrapEntry, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, dlink_DGS12XXTSeriesProd=dlink_DGS12XXTSeriesProd, tvlanTable=tvlanTable, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, commTrapTrapAbnormalFiberRXError=commTrapTrapAbnormalFiberRXError, configMirrorMon=configMirrorMon, igsVlanMcastFwdGroupAddress=igsVlanMcastFwdGroupAddress, commGetIndex=commGetIndex, igsVlanId=igsVlanId, commTrapTrapAbnormalTPRXError=commTrapTrapAbnormalTPRXError, configPortTable=configPortTable, swFiberInsert=swFiberInsert, igsVlanFilterStatus=igsVlanFilterStatus, commGetStatus=commGetStatus, configPasswordAdmin=configPasswordAdmin, swFiberAbnormalTXError=swFiberAbnormalTXError, configPortFlowControl=configPortFlowControl, commTrapIndex=commTrapIndex, companyDot1xGroup=companyDot1xGroup, MacAddress=MacAddress, radiusServerSharedSecret=radiusServerSharedSecret, igsv3Processing=igsv3Processing, companyTVlanGroup=companyTVlanGroup, configMirrorId=configMirrorId, configSave=configSave, commTrapTable=commTrapTable, commTrapTrapAbnormalFiberTXError=commTrapTrapAbnormalFiberTXError, commGetTable=commGetTable, dot1xAuthMaxReq=dot1xAuthMaxReq, igsVlanMcastFwdEntry=igsVlanMcastFwdEntry, igsVlanFilterTable=igsVlanFilterTable, dot1xAuthSystemControl=dot1xAuthSystemControl, portTrunkName=portTrunkName, igsVlanRouterPortList=igsVlanRouterPortList, configMirrorTXSrc=configMirrorTXSrc, staticPort=staticPort, configMirrorEntry=configMirrorEntry, tvlanStatus=tvlanStatus, configMirrorTable=configMirrorTable, configSNMPEnable=configSNMPEnable, companyStaticGroup=companyStaticGroup, configPhysAddress=configPhysAddress, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, staticAutoLearning=staticAutoLearning, dgs_1248tb1=dgs_1248tb1, configGateway=configGateway, configIpAssignmentMode=configIpAssignmentMode, configPortPriority=configPortPriority, d_link=d_link, igsVlanMcastFwdVlanIdMac=igsVlanMcastFwdVlanIdMac, companyIgsGroup=companyIgsGroup, portTrunkTable=portTrunkTable, igsSharedSegmentAggregationInterval=igsSharedSegmentAggregationInterval, igsVlanRouterPortListVlanId=igsVlanRouterPortListVlanId, companyPortTrunkGroup=companyPortTrunkGroup, radius=radius, tvlanName=tvlanName, commSetEntry=commSetEntry, miscStatisticsReset=miscStatisticsReset, swTPAbnormalRXError=swTPAbnormalRXError, staticMac=staticMac, PortList=PortList, companyConfigGroup=companyConfigGroup, commGetName=commGetName, commSetIndex=commSetIndex, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, companyCommGroup=companyCommGroup, spanOnOff=spanOnOff, commTrapSNMPFiberLinkUpDown=commTrapSNMPFiberLinkUpDown, igsSystem=igsSystem, configVerSwPrimary=configVerSwPrimary, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, configMirrorRXSrc=configMirrorRXSrc, staticId=staticId, configIpAddress=configIpAddress, staticVlanID=staticVlanID, radiusServerAddress=radiusServerAddress, tvlanMember=tvlanMember, commSetName=commSetName, OwnerString=OwnerString, commTrapName=commTrapName, igsHostPortPurgeInterval=igsHostPortPurgeInterval, tvlanEntry=tvlanEntry, companySpanGroup=companySpanGroup, configRestoreDefaults=configRestoreDefaults, igsLeaveProcessInterval=igsLeaveProcessInterval, igsVlan=igsVlan, igsReportForwardInterval=igsReportForwardInterval, igsStatus=igsStatus, igsVlanFilterEntry=igsVlanFilterEntry, configPort=configPort, commGetEntry=commGetEntry, configPortEntry=configPortEntry, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, swFiberAbnormalRXError=swFiberAbnormalRXError, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, igsVlanMcastFwdTable=igsVlanMcastFwdTable, igsVlanRouterPortListTable=igsVlanRouterPortListTable, dot1xAuthTxPeriod=dot1xAuthTxPeriod, igsNextMcastFwdMode=igsNextMcastFwdMode, commSetStatus=commSetStatus, portTrunkEntry=portTrunkEntry, igsVlanRouterPortListEntry=igsVlanRouterPortListEntry, configVLANMode=configVLANMode, commTrapSNMPBootup=commTrapSNMPBootup, portTrunkId=portTrunkId, igsLastMembQueryInterval=igsLastMembQueryInterval, swFiberRemove=swFiberRemove, configPortFlowControlOper=configPortFlowControlOper, portTrunkMember=portTrunkMember)
