...
fsLspp=ModuleIdentity((1,3,6,1,4,1,2076,13,11))
...
fsLsppGlobals=_FsLsppGlobals_ObjectIdentity((1,3,6,1,4,1,2076,13,11,1))
_FsLsppGlobalConfigTable_Object=MibTable
fsLsppGlobalConfigTable=_FsLsppGlobalConfigTable_Object((1,3,6,1,4,1,2076,13,11,1,1))
if mibBuilder.loadTexts:fsLsppGlobalConfigTable.setStatus(_A)
_FsLsppGlobalConfigTableEntry_Object=MibTableRow
fsLsppGlobalConfigTableEntry=_FsLsppGlobalConfigTableEntry_Object((1,3,6,1,4,1,2076,13,11,1,1,1))
...
fsLsppContextId=_FsLsppContextId_Object((1,3,6,1,4,1,2076,13,11,1,1,1,1),_FsLsppContextId_Type())
...
fsLsppSystemControl=_FsLsppSystemControl_Object((1,3,6,1,4,1,2076,13,11,1,1,1,2),_FsLsppSystemControl_Type())
...
fsLsppTrapStatus=_FsLsppTrapStatus_Object((1,3,6,1,4,1,2076,13,11,1,1,1,3),_FsLsppTrapStatus_Type())
...
fsLsppTraceLevel=_FsLsppTraceLevel_Object((1,3,6,1,4,1,2076,13,11,1,1,1,4),_FsLsppTraceLevel_Type())
...
fsLsppAgeOutTime=_FsLsppAgeOutTime_Object((1,3,6,1,4,1,2076,13,11,1,1,1,5),_FsLsppAgeOutTime_Type())
...
fsLsppAgeOutTmrUnit=_FsLsppAgeOutTmrUnit_Object((1,3,6,1,4,1,2076,13,11,1,1,1,6),_FsLsppAgeOutTmrUnit_Type())
...
fsLsppClearEchoStats=_FsLsppClearEchoStats_Object((1,3,6,1,4,1,2076,13,11,1,1,1,7),_FsLsppClearEchoStats_Type())
...
fsLsppBfdBtStrapRespReq=_FsLsppBfdBtStrapRespReq_Object((1,3,6,1,4,1,2076,13,11,1,1,1,8),_FsLsppBfdBtStrapRespReq_Type())
...
fsLsppBfdBtStrapAgeOutTime=_FsLsppBfdBtStrapAgeOutTime_Object((1,3,6,1,4,1,2076,13,11,1,1,1,9),_FsLsppBfdBtStrapAgeOutTime_Type())
...
fsLsppBfdBtStrapAgeOutTmrUnit=_FsLsppBfdBtStrapAgeOutTmrUnit_Object((1,3,6,1,4,1,2076,13,11,1,1,1,10),_FsLsppBfdBtStrapAgeOutTmrUnit_Type())
...
fsLsppGlobalStatsTable=_FsLsppGlobalStatsTable_Object((1,3,6,1,4,1,2076,13,11,1,2))
if mibBuilder.loadTexts:fsLsppGlobalStatsTable.setStatus(_A)
_FsLsppGlobalStatsTableEntry_Object=MibTableRow
fsLsppGlobalStatsTableEntry=_FsLsppGlobalStatsTableEntry_Object((1,3,6,1,4,1,2076,13,11,1,2,1))
...
fsLsppGlbStatReqTx=_FsLsppGlbStatReqTx_Object((1,3,6,1,4,1,2076,13,11,1,2,1,1),_FsLsppGlbStatReqTx_Type())
...
fsLsppGlbStatReqRx=_FsLsppGlbStatReqRx_Object((1,3,6,1,4,1,2076,13,11,1,2,1,2),_FsLsppGlbStatReqRx_Type())
...
fsLsppGlbStatReqTimedOut=_FsLsppGlbStatReqTimedOut_Object((1,3,6,1,4,1,2076,13,11,1,2,1,3),_FsLsppGlbStatReqTimedOut_Type())
...
fsLsppGlbStatReqUnSent=_FsLsppGlbStatReqUnSent_Object((1,3,6,1,4,1,2076,13,11,1,2,1,4),_FsLsppGlbStatReqUnSent_Type())
...
fsLsppGlbStatReplyTx=_FsLsppGlbStatReplyTx_Object((1,3,6,1,4,1,2076,13,11,1,2,1,5),_FsLsppGlbStatReplyTx_Type())
...
fsLsppGlbStatReplyRx=_FsLsppGlbStatReplyRx_Object((1,3,6,1,4,1,2076,13,11,1,2,1,6),_FsLsppGlbStatReplyRx_Type())
...
fsLsppGlbStatReplyDropped=_FsLsppGlbStatReplyDropped_Object((1,3,6,1,4,1,2076,13,11,1,2,1,7),_FsLsppGlbStatReplyDropped_Type())
...
fsLsppGlbStatReplyUnSent=_FsLsppGlbStatReplyUnSent_Object((1,3,6,1,4,1,2076,13,11,1,2,1,8),_FsLsppGlbStatReplyUnSent_Type())
...
fsLsppGlbStatReplyFromEgr=_FsLsppGlbStatReplyFromEgr_Object((1,3,6,1,4,1,2076,13,11,1,2,1,9),_FsLsppGlbStatReplyFromEgr_Type())
...
fsLsppGlbStatUnLbldOutIf=_FsLsppGlbStatUnLbldOutIf_Object((1,3,6,1,4,1,2076,13,11,1,2,1,10),_FsLsppGlbStatUnLbldOutIf_Type())
...
fsLsppGlbStatDsMapMismatch=_FsLsppGlbStatDsMapMismatch_Object((1,3,6,1,4,1,2076,13,11,1,2,1,11),_FsLsppGlbStatDsMapMismatch_Type())
...
fsLsppGlbStatFecLblMismatch=_FsLsppGlbStatFecLblMismatch_Object((1,3,6,1,4,1,2076,13,11,1,2,1,12),_FsLsppGlbStatFecLblMismatch_Type())
...
fsLsppGlbStatNoFecMapping=_FsLsppGlbStatNoFecMapping_Object((1,3,6,1,4,1,2076,13,11,1,2,1,13),_FsLsppGlbStatNoFecMapping_Type())
...
fsLsppGlbStatUnKUpstreamIf=_FsLsppGlbStatUnKUpstreamIf_Object((1,3,6,1,4,1,2076,13,11,1,2,1,14),_FsLsppGlbStatUnKUpstreamIf_Type())
...
fsLsppGlbStatReqLblSwitched=_FsLsppGlbStatReqLblSwitched_Object((1,3,6,1,4,1,2076,13,11,1,2,1,15),_FsLsppGlbStatReqLblSwitched_Type())
...
fsLsppGlbStatReqUnSupptdTlv=_FsLsppGlbStatReqUnSupptdTlv_Object((1,3,6,1,4,1,2076,13,11,1,2,1,16),_FsLsppGlbStatReqUnSupptdTlv_Type())
...
fsLsppGlbStatMalformedReq=_FsLsppGlbStatMalformedReq_Object((1,3,6,1,4,1,2076,13,11,1,2,1,17),_FsLsppGlbStatMalformedReq_Type())
...
fsLsppGlbStatNoLblEntry=_FsLsppGlbStatNoLblEntry_Object((1,3,6,1,4,1,2076,13,11,1,2,1,18),_FsLsppGlbStatNoLblEntry_Type())
...
fsLsppGlbStatPreTermReq=_FsLsppGlbStatPreTermReq_Object((1,3,6,1,4,1,2076,13,11,1,2,1,19),_FsLsppGlbStatPreTermReq_Type())
...
fsLsppGlbStatProtMismatch=_FsLsppGlbStatProtMismatch_Object((1,3,6,1,4,1,2076,13,11,1,2,1,20),_FsLsppGlbStatProtMismatch_Type())
...
fsLsppGlbStatRsvdRetCode=_FsLsppGlbStatRsvdRetCode_Object((1,3,6,1,4,1,2076,13,11,1,2,1,21),_FsLsppGlbStatRsvdRetCode_Type())
...
fsLsppGlbStatNoRetCode=_FsLsppGlbStatNoRetCode_Object((1,3,6,1,4,1,2076,13,11,1,2,1,22),_FsLsppGlbStatNoRetCode_Type())
...
fsLsppGlbStatUndefRetCode=_FsLsppGlbStatUndefRetCode_Object((1,3,6,1,4,1,2076,13,11,1,2,1,23),_FsLsppGlbStatUndefRetCode_Type())
...
fsLsppGlbStatInvalidPktDropped=_FsLsppGlbStatInvalidPktDropped_Object((1,3,6,1,4,1,2076,13,11,1,2,1,24),_FsLsppGlbStatInvalidPktDropped_Type())
...
fsLsppPingTrace=_FsLsppPingTrace_ObjectIdentity((1,3,6,1,4,1,2076,13,11,2))
_FsLsppPingTraceTable_Object=MibTable
fsLsppPingTraceTable=_FsLsppPingTraceTable_Object((1,3,6,1,4,1,2076,13,11,2,1))
if mibBuilder.loadTexts:fsLsppPingTraceTable.setStatus(_A)
_FsLsppPingTraceTableEntry_Object=MibTableRow
fsLsppPingTraceTableEntry=_FsLsppPingTraceTableEntry_Object((1,3,6,1,4,1,2076,13,11,2,1,1))
...
fsLsppSenderHandle=_FsLsppSenderHandle_Object((1,3,6,1,4,1,2076,13,11,2,1,1,1),_FsLsppSenderHandle_Type())
...
fsLsppRequestType=_FsLsppRequestType_Object((1,3,6,1,4,1,2076,13,11,2,1,1,2),_FsLsppRequestType_Type())
...
fsLsppRequestOwner=_FsLsppRequestOwner_Object((1,3,6,1,4,1,2076,13,11,2,1,1,3),_FsLsppRequestOwner_Type())
...
fsLsppPathType=_FsLsppPathType_Object((1,3,6,1,4,1,2076,13,11,2,1,1,4),_FsLsppPathType_Type())
...
fsLsppPathPointer=_FsLsppPathPointer_Object((1,3,6,1,4,1,2076,13,11,2,1,1,5),_FsLsppPathPointer_Type())
...
fsLsppTgtMipGlobalId=_FsLsppTgtMipGlobalId_Object((1,3,6,1,4,1,2076,13,11,2,1,1,6),_FsLsppTgtMipGlobalId_Type())
...
fsLsppTgtMipNodeId=_FsLsppTgtMipNodeId_Object((1,3,6,1,4,1,2076,13,11,2,1,1,7),_FsLsppTgtMipNodeId_Type())
...
fsLsppTgtMipIfNum=_FsLsppTgtMipIfNum_Object((1,3,6,1,4,1,2076,13,11,2,1,1,8),_FsLsppTgtMipIfNum_Type())
...
fsLsppReplyMode=_FsLsppReplyMode_Object((1,3,6,1,4,1,2076,13,11,2,1,1,9),_FsLsppReplyMode_Type())
...
fsLsppRepeatCount=_FsLsppRepeatCount_Object((1,3,6,1,4,1,2076,13,11,2,1,1,10),_FsLsppRepeatCount_Type())
fsLsppRepeatCount.setMaxAccess(_C)
if mibBuilder.loadTexts:fsLsppRepeatCount.setStatus(_A)
class _FsLsppPacketSize_Type(Unsigned32):defaultValue=200;subtypeSpec=Unsigned32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(100,1450))
_FsLsppPacketSize_Type.__name__=_E
_FsLsppPacketSize_Object=MibTableColumn
fsLsppPacketSize=_FsLsppPacketSize_Object((1,3,6,1,4,1,2076,13,11,2,1,1,11),_FsLsppPacketSize_Type())
...
fsLsppPadPattern=_FsLsppPadPattern_Object((1,3,6,1,4,1,2076,13,11,2,1,1,12),_FsLsppPadPattern_Type())
...
fsLsppTTLValue=_FsLsppTTLValue_Object((1,3,6,1,4,1,2076,13,11,2,1,1,13),_FsLsppTTLValue_Type())
...
fsLsppWFRInterval=_FsLsppWFRInterval_Object((1,3,6,1,4,1,2076,13,11,2,1,1,14),_FsLsppWFRInterval_Type())
...
fsLsppWFRTmrUnit=_FsLsppWFRTmrUnit_Object((1,3,6,1,4,1,2076,13,11,2,1,1,15),_FsLsppWFRTmrUnit_Type())
...
fsLsppWTSInterval=_FsLsppWTSInterval_Object((1,3,6,1,4,1,2076,13,11,2,1,1,16),_FsLsppWTSInterval_Type())
...
fsLsppWTSTmrUnit=_FsLsppWTSTmrUnit_Object((1,3,6,1,4,1,2076,13,11,2,1,1,17),_FsLsppWTSTmrUnit_Type())
...
fsLsppReplyDscpValue=_FsLsppReplyDscpValue_Object((1,3,6,1,4,1,2076,13,11,2,1,1,18),_FsLsppReplyDscpValue_Type())
...
fsLsppSweepOption=_FsLsppSweepOption_Object((1,3,6,1,4,1,2076,13,11,2,1,1,19),_FsLsppSweepOption_Type())
...
fsLsppSweepMinimum=_FsLsppSweepMinimum_Object((1,3,6,1,4,1,2076,13,11,2,1,1,20),_FsLsppSweepMinimum_Type())
...
fsLsppSweepMaximum=_FsLsppSweepMaximum_Object((1,3,6,1,4,1,2076,13,11,2,1,1,21),_FsLsppSweepMaximum_Type())
...
fsLsppSweepIncrement=_FsLsppSweepIncrement_Object((1,3,6,1,4,1,2076,13,11,2,1,1,22),_FsLsppSweepIncrement_Type())
...
fsLsppBurstOption=_FsLsppBurstOption_Object((1,3,6,1,4,1,2076,13,11,2,1,1,23),_FsLsppBurstOption_Type())
...
fsLsppBurstSize=_FsLsppBurstSize_Object((1,3,6,1,4,1,2076,13,11,2,1,1,24),_FsLsppBurstSize_Type())
...
fsLsppEXPValue=_FsLsppEXPValue_Object((1,3,6,1,4,1,2076,13,11,2,1,1,25),_FsLsppEXPValue_Type())
...
fsLsppDsMap=_FsLsppDsMap_Object((1,3,6,1,4,1,2076,13,11,2,1,1,26),_FsLsppDsMap_Type())
...
fsLsppFecValidate=_FsLsppFecValidate_Object((1,3,6,1,4,1,2076,13,11,2,1,1,27),_FsLsppFecValidate_Type())
...
fsLsppReplyPadTlv=_FsLsppReplyPadTlv_Object((1,3,6,1,4,1,2076,13,11,2,1,1,28),_FsLsppReplyPadTlv_Type())
...
fsLsppForceExplicitNull=_FsLsppForceExplicitNull_Object((1,3,6,1,4,1,2076,13,11,2,1,1,29),_FsLsppForceExplicitNull_Type())
...
fsLsppInterfaceLabelTlv=_FsLsppInterfaceLabelTlv_Object((1,3,6,1,4,1,2076,13,11,2,1,1,30),_FsLsppInterfaceLabelTlv_Type())
...
fsLsppSameSeqNumOption=_FsLsppSameSeqNumOption_Object((1,3,6,1,4,1,2076,13,11,2,1,1,31),_FsLsppSameSeqNumOption_Type())
...
fsLsppVerbose=_FsLsppVerbose_Object((1,3,6,1,4,1,2076,13,11,2,1,1,32),_FsLsppVerbose_Type())
...
fsLsppReversePathVerify=_FsLsppReversePathVerify_Object((1,3,6,1,4,1,2076,13,11,2,1,1,33),_FsLsppReversePathVerify_Type())
...
fsLsppEncapType=_FsLsppEncapType_Object((1,3,6,1,4,1,2076,13,11,2,1,1,34),_FsLsppEncapType_Type())
...
fsLsppStatus=_FsLsppStatus_Object((1,3,6,1,4,1,2076,13,11,2,1,1,35),_FsLsppStatus_Type())
...
fsLsppActualHopCount=_FsLsppActualHopCount_Object((1,3,6,1,4,1,2076,13,11,2,1,1,36),_FsLsppActualHopCount_Type())
...
fsLsppResponderAddrType=_FsLsppResponderAddrType_Object((1,3,6,1,4,1,2076,13,11,2,1,1,37),_FsLsppResponderAddrType_Type())
...
fsLsppResponderAddr=_FsLsppResponderAddr_Object((1,3,6,1,4,1,2076,13,11,2,1,1,38),_FsLsppResponderAddr_Type())
...
fsLsppResponderGlobalId=_FsLsppResponderGlobalId_Object((1,3,6,1,4,1,2076,13,11,2,1,1,39),_FsLsppResponderGlobalId_Type())
...
fsLsppResponderId=_FsLsppResponderId_Object((1,3,6,1,4,1,2076,13,11,2,1,1,40),_FsLsppResponderId_Type())
...
fsLsppMaxRtt=_FsLsppMaxRtt_Object((1,3,6,1,4,1,2076,13,11,2,1,1,41),_FsLsppMaxRtt_Type())
...
fsLsppMinRtt=_FsLsppMinRtt_Object((1,3,6,1,4,1,2076,13,11,2,1,1,42),_FsLsppMinRtt_Type())
...
fsLsppAverageRtt=_FsLsppAverageRtt_Object((1,3,6,1,4,1,2076,13,11,2,1,1,43),_FsLsppAverageRtt_Type())
...
fsLsppPktsTx=_FsLsppPktsTx_Object((1,3,6,1,4,1,2076,13,11,2,1,1,44),_FsLsppPktsTx_Type())
...
fsLsppPktsRx=_FsLsppPktsRx_Object((1,3,6,1,4,1,2076,13,11,2,1,1,45),_FsLsppPktsRx_Type())
...
fsLsppPktsUnSent=_FsLsppPktsUnSent_Object((1,3,6,1,4,1,2076,13,11,2,1,1,46),_FsLsppPktsUnSent_Type())
...
fsLsppRowStatus=_FsLsppRowStatus_Object((1,3,6,1,4,1,2076,13,11,2,1,1,47),_FsLsppRowStatus_Type())
...
fsLsppStatusPathDirection=_FsLsppStatusPathDirection_Object((1,3,6,1,4,1,2076,13,11,2,1,1,48),_FsLsppStatusPathDirection_Type())
...
fsLsppResponderIcc=_FsLsppResponderIcc_Object((1,3,6,1,4,1,2076,13,11,2,1,1,49),_FsLsppResponderIcc_Type())
...
fsLsppResponderUMC=_FsLsppResponderUMC_Object((1,3,6,1,4,1,2076,13,11,2,1,1,50),_FsLsppResponderUMC_Type())
...
fsLsppResponderMepIndex=_FsLsppResponderMepIndex_Object((1,3,6,1,4,1,2076,13,11,2,1,1,51),_FsLsppResponderMepIndex_Type())
...
fsLsppEchoSequenceTable=_FsLsppEchoSequenceTable_Object((1,3,6,1,4,1,2076,13,11,2,2))
if mibBuilder.loadTexts:fsLsppEchoSequenceTable.setStatus(_A)
_FsLsppEchoSequenceTableEntry_Object=MibTableRow
fsLsppEchoSequenceTableEntry=_FsLsppEchoSequenceTableEntry_Object((1,3,6,1,4,1,2076,13,11,2,2,1))
...
fsLsppSequenceNumber=_FsLsppSequenceNumber_Object((1,3,6,1,4,1,2076,13,11,2,2,1,1),_FsLsppSequenceNumber_Type())
...
fsLsppReturnCode=_FsLsppReturnCode_Object((1,3,6,1,4,1,2076,13,11,2,2,1,2),_FsLsppReturnCode_Type())
...
fsLsppReturnSubCode=_FsLsppReturnSubCode_Object((1,3,6,1,4,1,2076,13,11,2,2,1,3),_FsLsppReturnSubCode_Type())
...
fsLsppReturnCodeStr=_FsLsppReturnCodeStr_Object((1,3,6,1,4,1,2076,13,11,2,2,1,4),_FsLsppReturnCodeStr_Type())
...
fsLsppHopTable=_FsLsppHopTable_Object((1,3,6,1,4,1,2076,13,11,2,3))
if mibBuilder.loadTexts:fsLsppHopTable.setStatus(_A)
_FsLsppHopTableEntry_Object=MibTableRow
fsLsppHopTableEntry=_FsLsppHopTableEntry_Object((1,3,6,1,4,1,2076,13,11,2,3,1))
...
fsLsppHopIndex=_FsLsppHopIndex_Object((1,3,6,1,4,1,2076,13,11,2,3,1,1),_FsLsppHopIndex_Type())
...
fsLsppHopAddrType=_FsLsppHopAddrType_Object((1,3,6,1,4,1,2076,13,11,2,3,1,2),_FsLsppHopAddrType_Type())
...
fsLsppHopAddr=_FsLsppHopAddr_Object((1,3,6,1,4,1,2076,13,11,2,3,1,3),_FsLsppHopAddr_Type())
...
fsLsppHopGlobalId=_FsLsppHopGlobalId_Object((1,3,6,1,4,1,2076,13,11,2,3,1,4),_FsLsppHopGlobalId_Type())
...
fsLsppHopId=_FsLsppHopId_Object((1,3,6,1,4,1,2076,13,11,2,3,1,5),_FsLsppHopId_Type())
...
fsLsppHopIfNum=_FsLsppHopIfNum_Object((1,3,6,1,4,1,2076,13,11,2,3,1,6),_FsLsppHopIfNum_Type())
...
fsLsppHopReturnCode=_FsLsppHopReturnCode_Object((1,3,6,1,4,1,2076,13,11,2,3,1,7),_FsLsppHopReturnCode_Type())
...
fsLsppHopReturnSubCode=_FsLsppHopReturnSubCode_Object((1,3,6,1,4,1,2076,13,11,2,3,1,8),_FsLsppHopReturnSubCode_Type())
...
fsLsppHopReturnCodeStr=_FsLsppHopReturnCodeStr_Object((1,3,6,1,4,1,2076,13,11,2,3,1,9),_FsLsppHopReturnCodeStr_Type())
...
fsLsppHopRxAddrType=_FsLsppHopRxAddrType_Object((1,3,6,1,4,1,2076,13,11,2,3,1,10),_FsLsppHopRxAddrType_Type())
...
fsLsppHopRxIPAddr=_FsLsppHopRxIPAddr_Object((1,3,6,1,4,1,2076,13,11,2,3,1,11),_FsLsppHopRxIPAddr_Type())
...
fsLsppHopRxIfAddr=_FsLsppHopRxIfAddr_Object((1,3,6,1,4,1,2076,13,11,2,3,1,12),_FsLsppHopRxIfAddr_Type())
...
fsLsppHopRxIfNum=_FsLsppHopRxIfNum_Object((1,3,6,1,4,1,2076,13,11,2,3,1,13),_FsLsppHopRxIfNum_Type())
...
fsLsppHopRxLabelStack=_FsLsppHopRxLabelStack_Object((1,3,6,1,4,1,2076,13,11,2,3,1,14),_FsLsppHopRxLabelStack_Type())
...
fsLsppHopRxLabelExp=_FsLsppHopRxLabelExp_Object((1,3,6,1,4,1,2076,13,11,2,3,1,15),_FsLsppHopRxLabelExp_Type())
...
fsLsppHopRtt=_FsLsppHopRtt_Object((1,3,6,1,4,1,2076,13,11,2,3,1,16),_FsLsppHopRtt_Type())
...
fsLsppHopDsMtu=_FsLsppHopDsMtu_Object((1,3,6,1,4,1,2076,13,11,2,3,1,17),_FsLsppHopDsMtu_Type())
...
fsLsppHopDsAddrType=_FsLsppHopDsAddrType_Object((1,3,6,1,4,1,2076,13,11,2,3,1,18),_FsLsppHopDsAddrType_Type())
...
fsLsppHopDsIPAddr=_FsLsppHopDsIPAddr_Object((1,3,6,1,4,1,2076,13,11,2,3,1,19),_FsLsppHopDsIPAddr_Type())
...
fsLsppHopDsIfAddr=_FsLsppHopDsIfAddr_Object((1,3,6,1,4,1,2076,13,11,2,3,1,20),_FsLsppHopDsIfAddr_Type())
...
fsLsppHopDsIfNum=_FsLsppHopDsIfNum_Object((1,3,6,1,4,1,2076,13,11,2,3,1,21),_FsLsppHopDsIfNum_Type())
...
fsLsppHopDsLabelStack=_FsLsppHopDsLabelStack_Object((1,3,6,1,4,1,2076,13,11,2,3,1,22),_FsLsppHopDsLabelStack_Type())
...
fsLsppHopDsLabelExp=_FsLsppHopDsLabelExp_Object((1,3,6,1,4,1,2076,13,11,2,3,1,23),_FsLsppHopDsLabelExp_Type())
...
fsLsppHopIcc=_FsLsppHopIcc_Object((1,3,6,1,4,1,2076,13,11,2,3,1,24),_FsLsppHopIcc_Type())
...
fsLsppHopUMC=_FsLsppHopUMC_Object((1,3,6,1,4,1,2076,13,11,2,3,1,25),_FsLsppHopUMC_Type())
...
fsLsppHopMepIndex=_FsLsppHopMepIndex_Object((1,3,6,1,4,1,2076,13,11,2,3,1,26),_FsLsppHopMepIndex_Type())
...
fsLsppNotifications=_FsLsppNotifications_ObjectIdentity((1,3,6,1,4,1,2076,13,11,3))
_FsLsppTraps_ObjectIdentity=ObjectIdentity
fsLsppTraps=_FsLsppTraps_ObjectIdentity((1,3,6,1,4,1,2076,13,11,3,0))
