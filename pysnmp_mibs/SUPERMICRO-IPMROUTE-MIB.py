# SNMP MIB module (SUPERMICRO-IPMROUTE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-IPMROUTE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:04:27 2025
...
ipMRouteEnable = _IpMRouteEnable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 1, 1),
...
ipMRouteEntryCount = _IpMRouteEntryCount_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 1, 2),
...
ipMRouteEnableCmdb = _IpMRouteEnableCmdb_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 1, 3),
...
mfwdGlobalTrace = _MfwdGlobalTrace_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 1, 4),
...
mfwdGlobalDebug = _MfwdGlobalDebug_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 1, 5),
...
ipMRouteDiscardedPkts = _IpMRouteDiscardedPkts_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 1, 6),
...
mfwdAvgDataRate = _MfwdAvgDataRate_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 1, 7),
...
mfwdTables = _MfwdTables_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2)
)
_IpMRouteTable_Object = MibTable
ipMRouteTable = _IpMRouteTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1)
)
if mibBuilder.loadTexts:
    ipMRouteTable.setStatus("current")
_IpMRouteEntry_Object = MibTableRow
ipMRouteEntry = _IpMRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1)
)
ipMRouteEntry.setIndexNames(
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteOwnerId"),
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteGroup"),
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteSource"),
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteSourceMask"),
)
if mibBuilder.loadTexts:
...
ipMRouteOwnerId = _IpMRouteOwnerId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 1),
...
ipMRouteGroup = _IpMRouteGroup_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 2),
    _IpMRouteGroup_Type()
)
...
ipMRouteSource = _IpMRouteSource_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 3),
...
ipMRouteSourceMask = _IpMRouteSourceMask_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 4),
...
ipMRouteUpstreamNeighbor = _IpMRouteUpstreamNeighbor_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 5),
...
ipMRouteInIfIndex = _IpMRouteInIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 6),
...
ipMRouteUpTime = _IpMRouteUpTime_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 7),
...
ipMRoutePkts = _IpMRoutePkts_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 8),
    _IpMRoutePkts_Type()
)
...
ipMRouteDifferentInIfPackets = _IpMRouteDifferentInIfPackets_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 9),
...
ipMRouteProtocol = _IpMRouteProtocol_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 10),
...
ipMRouteRtAddress = _IpMRouteRtAddress_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 11),
...
ipMRouteRtMask = _IpMRouteRtMask_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 1, 1, 12),
...
ipMRouteNextHopTable = _IpMRouteNextHopTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2)
)
if mibBuilder.loadTexts:
...
ipMRouteNextHopEntry = _IpMRouteNextHopEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2, 1)
)
ipMRouteNextHopEntry.setIndexNames(
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteNextHopOwnerId"),
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteNextHopGroup"),
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteNextHopSource"),
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteNextHopSourceMask"),
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteNextHopIfIndex"),
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteNextHopAddress"),
)
if mibBuilder.loadTexts:
...
ipMRouteNextHopOwnerId = _IpMRouteNextHopOwnerId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2, 1, 1),
...
ipMRouteNextHopGroup = _IpMRouteNextHopGroup_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2, 1, 2),
...
ipMRouteNextHopSource = _IpMRouteNextHopSource_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2, 1, 3),
...
ipMRouteNextHopSourceMask = _IpMRouteNextHopSourceMask_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2, 1, 4),
...
ipMRouteNextHopIfIndex = _IpMRouteNextHopIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2, 1, 5),
...
ipMRouteNextHopAddress = _IpMRouteNextHopAddress_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2, 1, 6),
...
ipMRouteNextHopState = _IpMRouteNextHopState_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2, 1, 7),
...
ipMRouteNextHopUpTime = _IpMRouteNextHopUpTime_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 2, 1, 8),
...
ipMRouteInterfaceTable = _IpMRouteInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3)
)
if mibBuilder.loadTexts:
...
ipMRouteInterfaceEntry = _IpMRouteInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3, 1)
)
ipMRouteInterfaceEntry.setIndexNames(
    (0, "SUPERMICRO-IPMROUTE-MIB", "ipMRouteInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
ipMRouteInterfaceIfIndex = _IpMRouteInterfaceIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3, 1, 1),
...
ipMRouteInterfaceOwnerId = _IpMRouteInterfaceOwnerId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3, 1, 2),
...
ipMRouteInterfaceTtl = _IpMRouteInterfaceTtl_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3, 1, 3),
...
ipMRouteInterfaceProtocol = _IpMRouteInterfaceProtocol_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3, 1, 4),
...
ipMRouteInterfaceRateLimit = _IpMRouteInterfaceRateLimit_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3, 1, 5),
...
ipMRouteInterfaceInMcastOctets = _IpMRouteInterfaceInMcastOctets_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3, 1, 6),
...
ipMRouteInterfaceCmdbPktCnt = _IpMRouteInterfaceCmdbPktCnt_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3, 1, 7),
...
ipMRouteInterfaceOutMcastOctets = _IpMRouteInterfaceOutMcastOctets_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 2, 3, 1, 8),
...
mfwdTraps = _MfwdTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 1, 3)
)
_IpMRouteMIBConformance_ObjectIdentity = ObjectIdentity
ipMRouteMIBConformance = _IpMRouteMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 2)
)
_IpMRouteMIBCompliances_ObjectIdentity = ObjectIdentity
ipMRouteMIBCompliances = _IpMRouteMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 2, 1)
)
_IpMRouteMIBGroups_ObjectIdentity = ObjectIdentity
ipMRouteMIBGroups = _IpMRouteMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 2, 2)
)

# Managed Objects groups

ipMRouteMIBBasicGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 2, 2, 1)
)
ipMRouteMIBBasicGroup.setObjects(
      *(("SUPERMICRO-IPMROUTE-MIB", "ipMRouteEnable"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteEntryCount"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteUpstreamNeighbor"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteInIfIndex"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteUpTime"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteNextHopState"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteNextHopUpTime"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteInterfaceTtl"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteInterfaceProtocol"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteInterfaceRateLimit"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteProtocol"))
)
if mibBuilder.loadTexts:
    ipMRouteMIBBasicGroup.setStatus("current")

ipMRouteMIBRouteGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 2, 2, 2)
)
ipMRouteMIBRouteGroup.setObjects(
      *(("SUPERMICRO-IPMROUTE-MIB", "ipMRouteRtAddress"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteRtMask"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteRtType"))
)
if mibBuilder.loadTexts:
    ipMRouteMIBRouteGroup.setStatus("current")

ipMRouteMIBPktsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 2, 2, 3)
)
ipMRouteMIBPktsGroup.setObjects(
      *(("SUPERMICRO-IPMROUTE-MIB", "ipMRoutePkts"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteDifferentInIfPackets"))
)
if mibBuilder.loadTexts:
...
ipMRouteMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 10876, 101, 1, 71, 2, 1, 1)
)
ipMRouteMIBCompliance.setObjects(
      *(("SUPERMICRO-IPMROUTE-MIB", "ipMRouteMIBBasicGroup"),
        ("SUPERMICRO-IPMROUTE-MIB", "ipMRouteMIBRouteGroup"))
)
if mibBuilder.loadTexts:
