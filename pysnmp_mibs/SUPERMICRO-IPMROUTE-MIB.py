...
mfwdMIBObjects=_MfwdMIBObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,1,71,1))
_MfwdScalars_ObjectIdentity=ObjectIdentity
mfwdScalars=_MfwdScalars_ObjectIdentity((1,3,6,1,4,1,10876,101,1,71,1,1))
...
ipMRouteEnable=_IpMRouteEnable_Object((1,3,6,1,4,1,10876,101,1,71,1,1,1),_IpMRouteEnable_Type())
...
ipMRouteEntryCount=_IpMRouteEntryCount_Object((1,3,6,1,4,1,10876,101,1,71,1,1,2),_IpMRouteEntryCount_Type())
...
ipMRouteEnableCmdb=_IpMRouteEnableCmdb_Object((1,3,6,1,4,1,10876,101,1,71,1,1,3),_IpMRouteEnableCmdb_Type())
...
mfwdGlobalTrace=_MfwdGlobalTrace_Object((1,3,6,1,4,1,10876,101,1,71,1,1,4),_MfwdGlobalTrace_Type())
...
mfwdGlobalDebug=_MfwdGlobalDebug_Object((1,3,6,1,4,1,10876,101,1,71,1,1,5),_MfwdGlobalDebug_Type())
...
ipMRouteDiscardedPkts=_IpMRouteDiscardedPkts_Object((1,3,6,1,4,1,10876,101,1,71,1,1,6),_IpMRouteDiscardedPkts_Type())
...
mfwdAvgDataRate=_MfwdAvgDataRate_Object((1,3,6,1,4,1,10876,101,1,71,1,1,7),_MfwdAvgDataRate_Type())
...
mfwdTables=_MfwdTables_ObjectIdentity((1,3,6,1,4,1,10876,101,1,71,1,2))
_IpMRouteTable_Object=MibTable
ipMRouteTable=_IpMRouteTable_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1))
if mibBuilder.loadTexts:ipMRouteTable.setStatus(_A)
_IpMRouteEntry_Object=MibTableRow
ipMRouteEntry=_IpMRouteEntry_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1))
...
ipMRouteOwnerId=_IpMRouteOwnerId_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,1),_IpMRouteOwnerId_Type())
...
ipMRouteGroup=_IpMRouteGroup_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,2),_IpMRouteGroup_Type())
...
ipMRouteSource=_IpMRouteSource_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,3),_IpMRouteSource_Type())
...
ipMRouteSourceMask=_IpMRouteSourceMask_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,4),_IpMRouteSourceMask_Type())
...
ipMRouteUpstreamNeighbor=_IpMRouteUpstreamNeighbor_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,5),_IpMRouteUpstreamNeighbor_Type())
...
ipMRouteInIfIndex=_IpMRouteInIfIndex_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,6),_IpMRouteInIfIndex_Type())
...
ipMRouteUpTime=_IpMRouteUpTime_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,7),_IpMRouteUpTime_Type())
...
ipMRoutePkts=_IpMRoutePkts_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,8),_IpMRoutePkts_Type())
...
ipMRouteDifferentInIfPackets=_IpMRouteDifferentInIfPackets_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,9),_IpMRouteDifferentInIfPackets_Type())
...
ipMRouteProtocol=_IpMRouteProtocol_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,10),_IpMRouteProtocol_Type())
...
ipMRouteRtAddress=_IpMRouteRtAddress_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,11),_IpMRouteRtAddress_Type())
...
ipMRouteRtMask=_IpMRouteRtMask_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,12),_IpMRouteRtMask_Type())
...
ipMRouteRtType=_IpMRouteRtType_Object((1,3,6,1,4,1,10876,101,1,71,1,2,1,1,13),_IpMRouteRtType_Type())
ipMRouteRtType.setMaxAccess(_C)
if mibBuilder.loadTexts:ipMRouteRtType.setStatus(_A)
_IpMRouteNextHopTable_Object=MibTable
ipMRouteNextHopTable=_IpMRouteNextHopTable_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2))
if mibBuilder.loadTexts:ipMRouteNextHopTable.setStatus(_A)
_IpMRouteNextHopEntry_Object=MibTableRow
ipMRouteNextHopEntry=_IpMRouteNextHopEntry_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2,1))
...
ipMRouteNextHopOwnerId=_IpMRouteNextHopOwnerId_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2,1,1),_IpMRouteNextHopOwnerId_Type())
...
ipMRouteNextHopGroup=_IpMRouteNextHopGroup_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2,1,2),_IpMRouteNextHopGroup_Type())
...
ipMRouteNextHopSource=_IpMRouteNextHopSource_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2,1,3),_IpMRouteNextHopSource_Type())
...
ipMRouteNextHopSourceMask=_IpMRouteNextHopSourceMask_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2,1,4),_IpMRouteNextHopSourceMask_Type())
...
ipMRouteNextHopIfIndex=_IpMRouteNextHopIfIndex_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2,1,5),_IpMRouteNextHopIfIndex_Type())
...
ipMRouteNextHopAddress=_IpMRouteNextHopAddress_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2,1,6),_IpMRouteNextHopAddress_Type())
...
ipMRouteNextHopState=_IpMRouteNextHopState_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2,1,7),_IpMRouteNextHopState_Type())
...
ipMRouteNextHopUpTime=_IpMRouteNextHopUpTime_Object((1,3,6,1,4,1,10876,101,1,71,1,2,2,1,8),_IpMRouteNextHopUpTime_Type())
...
ipMRouteInterfaceTable=_IpMRouteInterfaceTable_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3))
if mibBuilder.loadTexts:ipMRouteInterfaceTable.setStatus(_A)
_IpMRouteInterfaceEntry_Object=MibTableRow
ipMRouteInterfaceEntry=_IpMRouteInterfaceEntry_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3,1))
...
ipMRouteInterfaceIfIndex=_IpMRouteInterfaceIfIndex_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3,1,1),_IpMRouteInterfaceIfIndex_Type())
...
ipMRouteInterfaceOwnerId=_IpMRouteInterfaceOwnerId_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3,1,2),_IpMRouteInterfaceOwnerId_Type())
...
ipMRouteInterfaceTtl=_IpMRouteInterfaceTtl_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3,1,3),_IpMRouteInterfaceTtl_Type())
...
ipMRouteInterfaceProtocol=_IpMRouteInterfaceProtocol_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3,1,4),_IpMRouteInterfaceProtocol_Type())
...
ipMRouteInterfaceRateLimit=_IpMRouteInterfaceRateLimit_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3,1,5),_IpMRouteInterfaceRateLimit_Type())
...
ipMRouteInterfaceInMcastOctets=_IpMRouteInterfaceInMcastOctets_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3,1,6),_IpMRouteInterfaceInMcastOctets_Type())
...
ipMRouteInterfaceCmdbPktCnt=_IpMRouteInterfaceCmdbPktCnt_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3,1,7),_IpMRouteInterfaceCmdbPktCnt_Type())
...
ipMRouteInterfaceOutMcastOctets=_IpMRouteInterfaceOutMcastOctets_Object((1,3,6,1,4,1,10876,101,1,71,1,2,3,1,8),_IpMRouteInterfaceOutMcastOctets_Type())
...
mfwdTraps=_MfwdTraps_ObjectIdentity((1,3,6,1,4,1,10876,101,1,71,1,3))
_IpMRouteMIBConformance_ObjectIdentity=ObjectIdentity
ipMRouteMIBConformance=_IpMRouteMIBConformance_ObjectIdentity((1,3,6,1,4,1,10876,101,1,71,2))
_IpMRouteMIBCompliances_ObjectIdentity=ObjectIdentity
ipMRouteMIBCompliances=_IpMRouteMIBCompliances_ObjectIdentity((1,3,6,1,4,1,10876,101,1,71,2,1))
_IpMRouteMIBGroups_ObjectIdentity=ObjectIdentity
ipMRouteMIBGroups=_IpMRouteMIBGroups_ObjectIdentity((1,3,6,1,4,1,10876,101,1,71,2,2))
ipMRouteMIBBasicGroup=ObjectGroup((1,3,6,1,4,1,10876,101,1,71,2,2,1))
