...
mibBuilder.exportSymbols("HPN-ICF-MPLS-LSR-MIB", hpnicfmplsInterfaceConfTable=hpnicfmplsInterfaceConfTable, hpnicfmplsInterfaceLabelMinOut=hpnicfmplsInterfaceLabelMinOut, hpnicfmplsInterfacePerfTable=hpnicfmplsInterfacePerfTable, hpnicfmplsOutSegmentPackets=hpnicfmplsOutSegmentPackets, hpnicfmplsTrafficParamRowStatus=hpnicfmplsTrafficParamRowStatus, hpnicfmplsOutSegmentNextHopIpAddrType=hpnicfmplsOutSegmentNextHopIpAddrType, hpnicfmplsLabelStackEntry=hpnicfmplsLabelStackEntry, hpnicfmplsLsrModuleCompliance=hpnicfmplsLsrModuleCompliance, hpnicfmplsOutSegmentNextHopIpv4Addr=hpnicfmplsOutSegmentNextHopIpv4Addr, hpnicfmplsTrafficParamMeanRate=hpnicfmplsTrafficParamMeanRate, hpnicfMplsLsr=hpnicfMplsLsr, hpnicfmplsLabelStackLabel=hpnicfmplsLabelStackLabel, hpnicfmplsXCTable=hpnicfmplsXCTable, hpnicfmplsLabelStackIndexNext=hpnicfmplsLabelStackIndexNext, hpnicfmplsOutSegmentErrors=hpnicfmplsOutSegmentErrors, hpnicfmplsOutSegmentIfIndex=hpnicfmplsOutSegmentIfIndex, hpnicfmplsInSegmentOctets=hpnicfmplsInSegmentOctets, hpnicfmplsSegmentDiscontinuityGroup=hpnicfmplsSegmentDiscontinuityGroup, HpnicfMplsBitRate=HpnicfMplsBitRate, hpnicfmplsXCOperStatus=hpnicfmplsXCOperStatus, hpnicfmplsOutSegmentTable=hpnicfmplsOutSegmentTable, hpnicfmplsInSegmentNPop=hpnicfmplsInSegmentNPop, hpnicfmplsTrafficParamMaxBurstSize=hpnicfmplsTrafficParamMaxBurstSize, hpnicfmplsXCLspId=hpnicfmplsXCLspId, hpnicfmplsInSegmentStorageType=hpnicfmplsInSegmentStorageType, hpnicfmplsInterfacePerfEntry=hpnicfmplsInterfacePerfEntry, hpnicfmplsOutSegmentStorageType=hpnicfmplsOutSegmentStorageType, hpnicfmplsInterfaceOutLabelsUsed=hpnicfmplsInterfaceOutLabelsUsed, hpnicfmplsLabelStackLabelIndex=hpnicfmplsLabelStackLabelIndex, hpnicfmplsXCDown=hpnicfmplsXCDown, hpnicfmplsXCEntry=hpnicfmplsXCEntry, HpnicfMplsLabel=HpnicfMplsLabel, hpnicfmplsTrafficParamIndexNext=hpnicfmplsTrafficParamIndexNext, hpnicfmplsLsrObjects=hpnicfmplsLsrObjects, hpnicfmplsInSegmentAddrFamily=hpnicfmplsInSegmentAddrFamily, hpnicfmplsXCIndexNext=hpnicfmplsXCIndexNext, hpnicfmplsInSegmentPerfTable=hpnicfmplsInSegmentPerfTable, hpnicfmplsOutSegmentPerfDiscontinuityTime=hpnicfmplsOutSegmentPerfDiscontinuityTime, hpnicfmplsInSegmentPerfEntry=hpnicfmplsInSegmentPerfEntry, hpnicfmplsInSegmentErrors=hpnicfmplsInSegmentErrors, hpnicfmplsOutSegmentIndexNext=hpnicfmplsOutSegmentIndexNext, hpnicfmplsLsrCompliances=hpnicfmplsLsrCompliances, hpnicfmplsTrafficParamEntry=hpnicfmplsTrafficParamEntry, hpnicfmplsTrafficParamGroup=hpnicfmplsTrafficParamGroup, HpnicfMplsLSPID=HpnicfMplsLSPID, hpnicfmplsOutSegmentNextHopIpv6Addr=hpnicfmplsOutSegmentNextHopIpv6Addr, hpnicfmplsInterfaceLabelMinIn=hpnicfmplsInterfaceLabelMinIn, hpnicfmplsInterfaceLabelParticipationType=hpnicfmplsInterfaceLabelParticipationType, hpnicfmplsMaxLabelStackDepth=hpnicfmplsMaxLabelStackDepth, hpnicfmplsInSegmentOwner=hpnicfmplsInSegmentOwner, hpnicfmplsLabelStackStorageType=hpnicfmplsLabelStackStorageType, hpnicfmplsInterfaceConfStorageType=hpnicfmplsInterfaceConfStorageType, hpnicfmplsXCOptionalGroup=hpnicfmplsXCOptionalGroup, hpnicfmplsXCOwner=hpnicfmplsXCOwner, hpnicfmplsOutSegmentPerfEntry=hpnicfmplsOutSegmentPerfEntry, hpnicfmplsInSegmentGroup=hpnicfmplsInSegmentGroup, hpnicfmplsLsrNotifications=hpnicfmplsLsrNotifications, hpnicfmplsLabelStackTable=hpnicfmplsLabelStackTable, PYSNMP_MODULE_ID=hpnicfMplsLsr, hpnicfmplsInterfaceConfEntry=hpnicfmplsInterfaceConfEntry, hpnicfmplsXCStorageType=hpnicfmplsXCStorageType, hpnicfmplsInSegmentIfIndex=hpnicfmplsInSegmentIfIndex, hpnicfmplsOutSegmentPushTopLabel=hpnicfmplsOutSegmentPushTopLabel, hpnicfmplsOutSegmentPerfTable=hpnicfmplsOutSegmentPerfTable, hpnicfmplsInSegmentTrafficParamPtr=hpnicfmplsInSegmentTrafficParamPtr, hpnicfmplsXCTrapEnable=hpnicfmplsXCTrapEnable, hpnicfmplsInterfaceLabelMaxIn=hpnicfmplsInterfaceLabelMaxIn, hpnicfmplsLabelStackIndex=hpnicfmplsLabelStackIndex, hpnicfmplsTrafficParamMaxRate=hpnicfmplsTrafficParamMaxRate, hpnicfmplsOutSegmentIndex=hpnicfmplsOutSegmentIndex, hpnicfmplsInterfaceInLabelsUsed=hpnicfmplsInterfaceInLabelsUsed, hpnicfmplsOutSegmentTopLabel=hpnicfmplsOutSegmentTopLabel, hpnicfmplsOutSegmentHCOctets=hpnicfmplsOutSegmentHCOctets, hpnicfmplsTrafficParamTable=hpnicfmplsTrafficParamTable, hpnicfmplsInSegmentTable=hpnicfmplsInSegmentTable, hpnicfmplsXCAdminStatus=hpnicfmplsXCAdminStatus, hpnicfmplsInSegmentDiscards=hpnicfmplsInSegmentDiscards, hpnicfmplsXCGroup=hpnicfmplsXCGroup, hpnicfmplsInSegmentPackets=hpnicfmplsInSegmentPackets, hpnicfmplsXCIndex=hpnicfmplsXCIndex, hpnicfmplsXCRowStatus=hpnicfmplsXCRowStatus, hpnicfmplsOutSegmentOwner=hpnicfmplsOutSegmentOwner, hpnicfmplsTrafficParamIndex=hpnicfmplsTrafficParamIndex, hpnicfmplsInSegmentLabel=hpnicfmplsInSegmentLabel, hpnicfmplsOutSegmentXCIndex=hpnicfmplsOutSegmentXCIndex, hpnicfmplsOutSegmentRowStatus=hpnicfmplsOutSegmentRowStatus, hpnicfmplsInSegmentEntry=hpnicfmplsInSegmentEntry, hpnicfmplsTrafficParamStorageType=hpnicfmplsTrafficParamStorageType, HpnicfMplsBurstSize=HpnicfMplsBurstSize, hpnicfmplsLsrNotificationGroup=hpnicfmplsLsrNotificationGroup, hpnicfmplsOutSegmentGroup=hpnicfmplsOutSegmentGroup, hpnicfmplsXCUp=hpnicfmplsXCUp, hpnicfmplsXCIsNotPersistentGroup=hpnicfmplsXCIsNotPersistentGroup, hpnicfmplsInterfaceAvailableBandwidth=hpnicfmplsInterfaceAvailableBandwidth, hpnicfmplsOutSegmentOctets=hpnicfmplsOutSegmentOctets, hpnicfmplsInterfaceGroup=hpnicfmplsInterfaceGroup, hpnicfmplsInSegmentRowStatus=hpnicfmplsInSegmentRowStatus, HpnicfMplsObjectOwner=HpnicfMplsObjectOwner, hpnicfmplsOutSegmentTrafficParamPtr=hpnicfmplsOutSegmentTrafficParamPtr, hpnicfmplsPerfGroup=hpnicfmplsPerfGroup, hpnicfmplsInterfaceTotalBandwidth=hpnicfmplsInterfaceTotalBandwidth, hpnicfmplsXCIsPersistentGroup=hpnicfmplsXCIsPersistentGroup, hpnicfmplsXCIsPersistent=hpnicfmplsXCIsPersistent, hpnicfmplsLsrNotifyPrefix=hpnicfmplsLsrNotifyPrefix, hpnicfmplsLabelStackRowStatus=hpnicfmplsLabelStackRowStatus, hpnicfmplsLsrConformance=hpnicfmplsLsrConformance, hpnicfmplsInSegmentPerfDiscontinuityTime=hpnicfmplsInSegmentPerfDiscontinuityTime, hpnicfmplsInterfaceOutFragments=hpnicfmplsInterfaceOutFragments, hpnicfmplsInSegmentHCOctets=hpnicfmplsInSegmentHCOctets, hpnicfmplsInterfaceConfIndex=hpnicfmplsInterfaceConfIndex, hpnicfmplsInterfaceFailedLabelLookup=hpnicfmplsInterfaceFailedLabelLookup, hpnicfmplsHCOutSegmentPerfGroup=hpnicfmplsHCOutSegmentPerfGroup, hpnicfmplsXCLabelStackIndex=hpnicfmplsXCLabelStackIndex, hpnicfmplsLsrGroups=hpnicfmplsLsrGroups, hpnicfmplsLabelStackGroup=hpnicfmplsLabelStackGroup, hpnicfmplsInterfaceLabelMaxOut=hpnicfmplsInterfaceLabelMaxOut, hpnicfmplsHCInSegmentPerfGroup=hpnicfmplsHCInSegmentPerfGroup, hpnicfmplsOutSegmentEntry=hpnicfmplsOutSegmentEntry, hpnicfmplsOutSegmentDiscards=hpnicfmplsOutSegmentDiscards, hpnicfmplsInSegmentXCIndex=hpnicfmplsInSegmentXCIndex)
