# SNMP MIB module (RADLAN-SYSMNG-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-SYSMNG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:55 2025
...
rlSysmngTcamAllocationsEntry = _RlSysmngTcamAllocationsEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 204, 1, 1, 1)
)
rlSysmngTcamAllocationsEntry.setIndexNames(
    (0, "RADLAN-SYSMNG-MIB", "rlSysmngTcamAllocProfileName"),
    (0, "RADLAN-SYSMNG-MIB", "rlSysmngTcamAllocPoolType"),
)
if mibBuilder.loadTexts:
...
rlSysmngResourceEntry = _RlSysmngResourceEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 204, 2, 1, 1)
)
rlSysmngResourceEntry.setIndexNames(
    (0, "RADLAN-SYSMNG-MIB", "rlSysmngResourceRouteType"),
)
if mibBuilder.loadTexts:
...
rlSysmngResourceUsageEntry = _RlSysmngResourceUsageEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 204, 4, 1, 1)
)
rlSysmngResourceUsageEntry.setIndexNames(
    (0, "RADLAN-SYSMNG-MIB", "rlSysmngResourceUsageType"),
)
if mibBuilder.loadTexts:
...
rlSysmngResourcePerUnitEntry = _RlSysmngResourcePerUnitEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 204, 5, 1, 1)
)
rlSysmngResourcePerUnitEntry.setIndexNames(
    (0, "RADLAN-SYSMNG-MIB", "rlSysmngResourcePerUnitRouteType"),
    (0, "RADLAN-SYSMNG-MIB", "rlSysmngResourcePerUnitUnitId"),
)
if mibBuilder.loadTexts:
