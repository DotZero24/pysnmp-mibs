# SNMP MIB module (DES7200-SYSTEM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-SYSTEM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:48:35 2025
...
mySystemElectricalSourceIsNormalEntry.setIndexNames(
    (0, "DES7200-SYSTEM-MIB", "mySystemElectricalSourceIsNormalIndex"),
)
if mibBuilder.loadTexts:
...
mySystemFanIsNormalEntry.setIndexNames(
    (0, "DES7200-SYSTEM-MIB", "mySystemFanIsNormalIndex"),
)
if mibBuilder.loadTexts:
...
mySystemTemperatureEntry.setIndexNames(
    (0, "DES7200-SYSTEM-MIB", "mySystemTemperatureIndex"),
)
if mibBuilder.loadTexts:
...
mySystemVersionEntry.setIndexNames(
    (0, "DES7200-SYSTEM-MIB", "mySystemVersionIndex"),
)
if mibBuilder.loadTexts:
...
mySystemMIBGroup.setObjects(
      *(("DES7200-SYSTEM-MIB", "mySystemHwVersion"),
        ("DES7200-SYSTEM-MIB", "mySystemSwVersion"),
        ("DES7200-SYSTEM-MIB", "mySystemBootVersion"),
        ("DES7200-SYSTEM-MIB", "mySystemSysCtrlVersion"),
        ("DES7200-SYSTEM-MIB", "mySystemParametersSave"),
        ("DES7200-SYSTEM-MIB", "mySystemReset"),
        ("DES7200-SYSTEM-MIB", "mySystemOutBandRate"),
        ("DES7200-SYSTEM-MIB", "mySwitchLayer"))
)
if mibBuilder.loadTexts:
...
mySystemHardChangeDetected.setObjects(
    ("DES7200-SYSTEM-MIB", "mySystemHardChangeDesc")
)
if mibBuilder.loadTexts:
...
mySystemPowerStateChange.setObjects(
    ("DES7200-SYSTEM-MIB", "mySystemHwPower")
)
if mibBuilder.loadTexts:
...
mySystemFanStateChange.setObjects(
    ("DES7200-SYSTEM-MIB", "mySystemHwFan")
)
if mibBuilder.loadTexts:
...
mySystemMIBCompliance.setObjects(
    ("DES7200-SYSTEM-MIB", "mySystemMIBGroup")
)
if mibBuilder.loadTexts:
