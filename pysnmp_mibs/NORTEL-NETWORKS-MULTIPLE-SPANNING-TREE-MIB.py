...
# Notes
# -----
# ASN.1 source file://mibs/nortel/NORTEL-NETWORKS-MULTIPLE-SPANNING-TREE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:19:51 2025
...
class _NnMstBridgeMappedVlans_Type(OctetString):
    """Custom type nnMstBridgeMappedVlans based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_NnMstBridgeMappedVlans_Type.__name__ = "OctetString"
_NnMstBridgeMappedVlans_Object = MibTableColumn
nnMstBridgeMappedVlans = _NnMstBridgeMappedVlans_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 5, 1, 2, 1, 15),
    _NnMstBridgeMappedVlans_Type()
)
nnMstBridgeMappedVlans.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    nnMstBridgeMappedVlans.setStatus("current")


class _NnMstBridgeMappedVlansAction_Type(Integer32):
    """Custom type nnMstBridgeMappedVlansAction based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_NnMstBridgeMappedVlansAction_Type.__name__ = "Integer32"
_NnMstBridgeMappedVlansAction_Object = MibTableColumn
nnMstBridgeMappedVlansAction = _NnMstBridgeMappedVlansAction_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 5, 1, 2, 1, 16),
    _NnMstBridgeMappedVlansAction_Type()
)
nnMstBridgeMappedVlansAction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    nnMstBridgeMappedVlansAction.setStatus("current")
...
nnMstCistPortRxTcBpduCount = _NnMstCistPortRxTcBpduCount_Object(
    (1, 3, 6, 1, 4, 1, 45, 5, 5, 1, 3, 1, 43),
    _NnMstCistPortRxTcBpduCount_Type()
)
nnMstCistPortRxTcBpduCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    nnMstCistPortRxTcBpduCount.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"nnMultipleSpanningTreeMib": nnMultipleSpanningTreeMib,
       ...
       "nnMstBridgeMappedVlans": nnMstBridgeMappedVlans,
       "nnMstBridgeMappedVlansAction": nnMstBridgeMappedVlansAction,
       ...
       "nnMstCistPortRxTcBpduCount": nnMstCistPortRxTcBpduCount,
