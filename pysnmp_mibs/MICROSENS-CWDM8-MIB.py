...
mibBuilder.exportSymbols("MICROSENS-CWDM8-MIB", localModuleConnector=localModuleConnector, lineModuleVendorSN=lineModuleVendorSN, localModuleReceivedPower=localModuleReceivedPower, localModuleTrCodeFbSpeed=localModuleTrCodeFbSpeed, localModuleLengthCopper=localModuleLengthCopper, localModuleLaserCurrent=localModuleLaserCurrent, devicePowerSupplyTrap=devicePowerSupplyTrap, cwdm=cwdm, portChannelEnabled=portChannelEnabled, lineModuleId=lineModuleId, deviceTemperature=deviceTemperature, deviceTempShutdown=deviceTempShutdown, lineIfWestLinkStatus=lineIfWestLinkStatus, microsens=microsens, passiveArtNo=passiveArtNo, deviceTempAlarm=deviceTempAlarm, passiveSerNo=passiveSerNo, localModuleBrNominal=localModuleBrNominal, portTable=portTable, localModuleVendorSN=localModuleVendorSN, lineModuleTrCodeGigabit=lineModuleTrCodeGigabit, portLocalModuleInstalled=portLocalModuleInstalled, deviceMinorAlarm=deviceMinorAlarm, passiveTable=passiveTable, localModuleLength9km=localModuleLength9km, localModuleTrCodeFbLinkLength=localModuleTrCodeFbLinkLength, localModuleTableEntry=localModuleTableEntry, localModuleTrCodeFbTrMedia=localModuleTrCodeFbTrMedia, deviceSerNo=deviceSerNo, lineModuleTableEntry=lineModuleTableEntry, powerLoad=powerLoad, powerTemperature=powerTemperature, deviceTable=deviceTable, lineIfTableEntry=lineIfTableEntry, majorAlarmRelayTrap=majorAlarmRelayTrap, passiveTableEntry=passiveTableEntry, portLocalLink=portLocalLink, powerSuppliedPower=powerSuppliedPower, powerSerNo=powerSerNo, portLineLinkChangeTrap=portLineLinkChangeTrap, deviceTempAlarmThreshold=deviceTempAlarmThreshold, passiveId=passiveId, powerId=powerId, portLinkThroughLineLocal=portLinkThroughLineLocal, powerArtNo=powerArtNo, localModuleVoltage=localModuleVoltage, powerStatus=powerStatus, lineModuleLength9m=lineModuleLength9m, portId=portId, minorAlarmRelayTrap=minorAlarmRelayTrap, lineModuleTransmittedPower=lineModuleTransmittedPower, fanAlarmTrap=fanAlarmTrap, portLinkThroughLocalLine=portLinkThroughLocalLine, localModuleTrCodeGigabit=localModuleTrCodeGigabit, portLocalPowerFault=portLocalPowerFault, lineModuleTrCodeFbTrMedia=lineModuleTrCodeFbTrMedia, powerTable=powerTable, portLinePowerFault=portLinePowerFault, portRateSelect=portRateSelect, portLineTxFault=portLineTxFault, lineIfSerNo=lineIfSerNo, lineModuleTrCodeSonet=lineModuleTrCodeSonet, portLocalTxFault=portLocalTxFault, localModuleLength50=localModuleLength50, lineModuleTable=lineModuleTable, channelCount=channelCount, portLocalLinkChangeTrap=portLocalLinkChangeTrap, powerTableEntry=powerTableEntry, portTableEntry=portTableEntry, lineModuleBrNominal=lineModuleBrNominal, deviceArtNo=deviceArtNo, localModuleDateCode=localModuleDateCode, lineIfId=lineIfId, deviceDesc=deviceDesc, lineModuleConnector=lineModuleConnector, lineModuleReceivedPower=lineModuleReceivedPower, lineModuleTrCodeFbSpeed=lineModuleTrCodeFbSpeed, lineModuleTrCodeFbLinkLength=lineModuleTrCodeFbLinkLength, powerFanStatus=powerFanStatus, deviceTableEntry=deviceTableEntry, lineModuleTrCodeFbTrTech=lineModuleTrCodeFbTrTech, localModuleTransmittedPower=localModuleTransmittedPower, localModuleTable=localModuleTable, lineIfEastLinkRcvPower=lineIfEastLinkRcvPower, deviceMajorAlarm=deviceMajorAlarm, lineIfArtNo=lineIfArtNo, deviceId=deviceId, lineModuleLength9km=lineModuleLength9km, localModuleId=localModuleId, portLineModuleInstalled=portLineModuleInstalled, lineIfWestLinkRcvPower=lineIfWestLinkRcvPower, localModuleLength9m=localModuleLength9m, lineModuleLength62=lineModuleLength62, lineIfWestChannelStatus=lineIfWestChannelStatus, lineIfEastLinkStatus=lineIfEastLinkStatus, deviceTrPowerFailureAlarm=deviceTrPowerFailureAlarm, localModuleLaserTemperature=localModuleLaserTemperature, deviceTemperatureAlarmTrap=deviceTemperatureAlarmTrap, lineModuleLaserCurrent=lineModuleLaserCurrent, powerDesc=powerDesc, lineModuleVoltage=lineModuleVoltage, eightChannelCwdm=eightChannelCwdm, lineModuleLength50=lineModuleLength50, lineIfEastChannelStatus=lineIfEastChannelStatus, localModuleTrCodeFbTrTech=localModuleTrCodeFbTrTech, lineModuleLaserTemperature=lineModuleLaserTemperature, localModuleTrCodeSonet=localModuleTrCodeSonet, lineIfTable=lineIfTable, lineModuleLengthCopper=lineModuleLengthCopper, localModuleLength62=localModuleLength62, lineModuleDateCode=lineModuleDateCode, deviceTemperatureShutdownTrap=deviceTemperatureShutdownTrap, portLineLink=portLineLink)
