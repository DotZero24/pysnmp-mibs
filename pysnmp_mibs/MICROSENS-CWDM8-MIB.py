...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/microsens/MICROSENS-CWDM8-MIB
...
mibBuilder.exportSymbols("MICROSENS-CWDM8-MIB", microsens=microsens, lineIfWestLinkRcvPower=lineIfWestLinkRcvPower, lineModuleTransmittedPower=lineModuleTransmittedPower, portTable=portTable, channelCount=channelCount, powerSuppliedPower=powerSuppliedPower, lineModuleLength62=lineModuleLength62, lineModuleTrCodeGigabit=lineModuleTrCodeGigabit, lineModuleReceivedPower=lineModuleReceivedPower, deviceTempAlarmThreshold=deviceTempAlarmThreshold, deviceMajorAlarm=deviceMajorAlarm, powerStatus=powerStatus, lineModuleVoltage=lineModuleVoltage, localModuleTrCodeFbTrMedia=localModuleTrCodeFbTrMedia, lineIfArtNo=lineIfArtNo, localModuleTable=localModuleTable, passiveId=passiveId, localModuleDateCode=localModuleDateCode, minorAlarmRelayTrap=minorAlarmRelayTrap, portLocalModuleInstalled=portLocalModuleInstalled, deviceDesc=deviceDesc, portLineTxFault=portLineTxFault, portLocalLink=portLocalLink, portLocalPowerFault=portLocalPowerFault, majorAlarmRelayTrap=majorAlarmRelayTrap, lineModuleTrCodeFbTrMedia=lineModuleTrCodeFbTrMedia, lineIfWestChannelStatus=lineIfWestChannelStatus, powerArtNo=powerArtNo, localModuleLengthCopper=localModuleLengthCopper, portLinkThroughLocalLine=portLinkThroughLocalLine, deviceTableEntry=deviceTableEntry, localModuleLaserCurrent=localModuleLaserCurrent, localModuleTrCodeFbSpeed=localModuleTrCodeFbSpeed, deviceTable=deviceTable, lineModuleVendorSN=lineModuleVendorSN, portLocalTxFault=portLocalTxFault, localModuleTrCodeSonet=localModuleTrCodeSonet, deviceMinorAlarm=deviceMinorAlarm, localModuleTrCodeFbTrTech=localModuleTrCodeFbTrTech, portLineModuleInstalled=portLineModuleInstalled, powerFanStatus=powerFanStatus, lineModuleLength9km=lineModuleLength9km, lineIfSerNo=lineIfSerNo, lineModuleLength9m=lineModuleLength9m, portLinePowerFault=portLinePowerFault, localModuleLength50=localModuleLength50, lineIfEastLinkRcvPower=lineIfEastLinkRcvPower, powerTable=powerTable, localModuleTrCodeFbLinkLength=localModuleTrCodeFbLinkLength, lineModuleTrCodeSonet=lineModuleTrCodeSonet, lineModuleTable=lineModuleTable, lineModuleTableEntry=lineModuleTableEntry, lineModuleLengthCopper=lineModuleLengthCopper, deviceTemperatureShutdownTrap=deviceTemperatureShutdownTrap, lineModuleBrNominal=lineModuleBrNominal, lineIfEastChannelStatus=lineIfEastChannelStatus, portTableEntry=portTableEntry, lineModuleDateCode=lineModuleDateCode, fanAlarmTrap=fanAlarmTrap, portLocalLinkChangeTrap=portLocalLinkChangeTrap, powerSerNo=powerSerNo, portLinkThroughLineLocal=portLinkThroughLineLocal, lineModuleId=lineModuleId, lineIfEastLinkStatus=lineIfEastLinkStatus, lineIfTable=lineIfTable, localModuleTableEntry=localModuleTableEntry, lineModuleLaserCurrent=lineModuleLaserCurrent, deviceTempShutdown=deviceTempShutdown, localModuleLaserTemperature=localModuleLaserTemperature, lineIfId=lineIfId, deviceArtNo=deviceArtNo, portLineLinkChangeTrap=portLineLinkChangeTrap, localModuleTransmittedPower=localModuleTransmittedPower, localModuleReceivedPower=localModuleReceivedPower, powerTemperature=powerTemperature, lineModuleLength50=lineModuleLength50, powerDesc=powerDesc, portChannelEnabled=portChannelEnabled, deviceId=deviceId, powerId=powerId, lineModuleTrCodeFbTrTech=lineModuleTrCodeFbTrTech, localModuleLength9km=localModuleLength9km, localModuleConnector=localModuleConnector, deviceTemperature=deviceTemperature, devicePowerSupplyTrap=devicePowerSupplyTrap, passiveArtNo=passiveArtNo, deviceSerNo=deviceSerNo, lineIfTableEntry=lineIfTableEntry, portRateSelect=portRateSelect, portId=portId, lineModuleTrCodeFbSpeed=lineModuleTrCodeFbSpeed, deviceTrPowerFailureAlarm=deviceTrPowerFailureAlarm, powerLoad=powerLoad, passiveSerNo=passiveSerNo, deviceTempAlarm=deviceTempAlarm, localModuleVoltage=localModuleVoltage, passiveTable=passiveTable, cwdm=cwdm, localModuleBrNominal=localModuleBrNominal, powerTableEntry=powerTableEntry, lineIfWestLinkStatus=lineIfWestLinkStatus, lineModuleLaserTemperature=lineModuleLaserTemperature, passiveTableEntry=passiveTableEntry, localModuleTrCodeGigabit=localModuleTrCodeGigabit, deviceTemperatureAlarmTrap=deviceTemperatureAlarmTrap, eightChannelCwdm=eightChannelCwdm, localModuleId=localModuleId, localModuleVendorSN=localModuleVendorSN, lineModuleConnector=lineModuleConnector, portLineLink=portLineLink, lineModuleTrCodeFbLinkLength=lineModuleTrCodeFbLinkLength, localModuleLength62=localModuleLength62, localModuleLength9m=localModuleLength9m)
