...
AtmConnCastType, AtmConnKind, AtmVorXLastChange, AtmTrafficDescrParamIndex, AtmVpIdentifier, AtmAddr, AtmVcIdentifier, AtmVorXOperStatus, atmNoClpNoScr, AtmVorXAdminStatus, AtmServiceCategory = mibBuilder.importSymbols("ATM-TC-MIB", "AtmConnCastType", "AtmConnKind", "AtmVorXLastChange", "AtmTrafficDescrParamIndex", "AtmVpIdentifier", "AtmAddr", "AtmVcIdentifier", "AtmVorXOperStatus", "atmNoClpNoScr", "AtmVorXAdminStatus", "AtmServiceCategory")
...
mibBuilder.exportSymbols("ATM-MIB", atmVcCrossConnectTable=atmVcCrossConnectTable, atmInterfaceCurrentMaxVciBits=atmInterfaceCurrentMaxVciBits, atmMIBCompliance2=atmMIBCompliance2, aal5VccTable=aal5VccTable, atmVpCrossConnectLowVpi=atmVpCrossConnectLowVpi, atmVclConnKind=atmVclConnKind, atmInterfaceConfEntry=atmInterfaceConfEntry, atmVcCrossConnectH2LLastChange=atmVcCrossConnectH2LLastChange, atmInterfaceAddressType=atmInterfaceAddressType, atmVplLastChange=atmVplLastChange, atmVclLastChange=atmVclLastChange, atmInterfaceConfGroup=atmInterfaceConfGroup, PYSNMP_MODULE_ID=atmMIB, atmVplReceiveTrafficDescrIndex=atmVplReceiveTrafficDescrIndex, atmVpcTerminationGroup2=atmVpcTerminationGroup2, atmTrafficDescrParam1=atmTrafficDescrParam1, atmVplTransmitTrafficDescrIndex=atmVplTransmitTrafficDescrIndex, atmInterfaceSubscrAddress=atmInterfaceSubscrAddress, atmVclRowStatus=atmVclRowStatus, atmTrafficDescrParam5=atmTrafficDescrParam5, atmVpCrossConnectH2LOperStatus=atmVpCrossConnectH2LOperStatus, atmVpCrossConnectTable=atmVpCrossConnectTable, atmMIBCompliance=atmMIBCompliance, atmVclVci=atmVclVci, atmVclOperStatus=atmVclOperStatus, atmInterfaceAdminAddress=atmInterfaceAdminAddress, atmVpPvcCrossConnectGroup=atmVpPvcCrossConnectGroup, atmTrafficFrameDiscard=atmTrafficFrameDiscard, atmVclCrossConnectIdentifier=atmVclCrossConnectIdentifier, atmVcCrossConnectHighVci=atmVcCrossConnectHighVci, atmVcCrossConnectHighVpi=atmVcCrossConnectHighVpi, aal5VccEntry=aal5VccEntry, atmInterfaceMaxVpcs=atmInterfaceMaxVpcs, atmTrafficDescrParamIndex=atmTrafficDescrParamIndex, atmInterfaceConfTable=atmInterfaceConfTable, atmVclCastType=atmVclCastType, atmVpCrossConnectRowStatus=atmVpCrossConnectRowStatus, atmVpCrossConnectIndex=atmVpCrossConnectIndex, atmInterfaceTCEntry=atmInterfaceTCEntry, atmVpCrossConnectIndexNext=atmVpCrossConnectIndexNext, atmVpCrossConnectGroup=atmVpCrossConnectGroup, atmVcCrossConnectEntry=atmVcCrossConnectEntry, atmInterfaceIlmiVci=atmInterfaceIlmiVci, atmInterfaceMaxActiveVpiBits=atmInterfaceMaxActiveVpiBits, atmInterfaceConfGroup2=atmInterfaceConfGroup2, atmVcCrossConnectAdminStatus=atmVcCrossConnectAdminStatus, atmVcCrossConnectH2LOperStatus=atmVcCrossConnectH2LOperStatus, atmVccAal5EncapsType=atmVccAal5EncapsType, aal5VccCrcErrors=aal5VccCrcErrors, atmServiceCategory=atmServiceCategory, atmInterfaceTCGroup=atmInterfaceTCGroup, atmVcCrossConnectL2HOperStatus=atmVcCrossConnectL2HOperStatus, atmInterfaceDs3PlcpUASs=atmInterfaceDs3PlcpUASs, atmMIBCompliances=atmMIBCompliances, atmVccAal5CpcsTransmitSduSize=atmVccAal5CpcsTransmitSduSize, atmVplVpi=atmVplVpi, atmVccTerminationGroup2=atmVccTerminationGroup2, atmVcCrossConnectLowVci=atmVcCrossConnectLowVci, atmVcPvcCrossConnectGroup=atmVcPvcCrossConnectGroup, atmVpCrossConnectHighIfIndex=atmVpCrossConnectHighIfIndex, atmMIBGroups=atmMIBGroups, atmTrafficQoSClass=atmTrafficQoSClass, atmVcCrossConnectIndexNext=atmVcCrossConnectIndexNext, atmVcCrossConnectRowStatus=atmVcCrossConnectRowStatus, atmVclCrossConnectGroup=atmVclCrossConnectGroup, atmInterfaceDs3PlcpEntry=atmInterfaceDs3PlcpEntry, aal5VccGroup=aal5VccGroup, atmVcCrossConnectLowIfIndex=atmVcCrossConnectLowIfIndex, atmVpCrossConnectH2LLastChange=atmVpCrossConnectH2LLastChange, atmVplEntry=atmVplEntry, atmVcCrossConnectLowVpi=atmVcCrossConnectLowVpi, atmVclTransmitTrafficDescrIndex=atmVclTransmitTrafficDescrIndex, atmVplCrossConnectIdentifier=atmVplCrossConnectIdentifier, atmInterfaceTCTable=atmInterfaceTCTable, aal5VccSarTimeOuts=aal5VccSarTimeOuts, atmTrafficDescrParamTable=atmTrafficDescrParamTable, atmVpCrossConnectLowIfIndex=atmVpCrossConnectLowIfIndex, atmInterfaceMaxVccs=atmInterfaceMaxVccs, atmVpCrossConnectAdminStatus=atmVpCrossConnectAdminStatus, atmTrafficDescrParamIndexNext=atmTrafficDescrParamIndexNext, atmVclTable=atmVclTable, atmTrafficDescrRowStatus=atmTrafficDescrRowStatus, atmVplCrossConnectGroup=atmVplCrossConnectGroup, atmInterfaceMyNeighborIpAddress=atmInterfaceMyNeighborIpAddress, atmVclReceiveTrafficDescrIndex=atmVclReceiveTrafficDescrIndex, atmVccTerminationGroup=atmVccTerminationGroup, atmVpCrossConnectL2HLastChange=atmVpCrossConnectL2HLastChange, atmVpcTerminationGroup=atmVpcTerminationGroup, atmInterfaceDs3PlcpTable=atmInterfaceDs3PlcpTable, atmVclVpi=atmVclVpi, atmVcCrossConnectGroup=atmVcCrossConnectGroup, atmTrafficDescrParam2=atmTrafficDescrParam2, atmVclEntry=atmVclEntry, aal5VccVci=aal5VccVci, atmInterfaceConfVccs=atmInterfaceConfVccs, atmInterfaceConfVpcs=atmInterfaceConfVpcs, atmInterfaceCurrentMaxVpiBits=atmInterfaceCurrentMaxVpiBits, atmVccAalType=atmVccAalType, atmVpCrossConnectEntry=atmVpCrossConnectEntry, atmVccAal5CpcsReceiveSduSize=atmVccAal5CpcsReceiveSduSize, atmInterfaceDs3PlcpGroup=atmInterfaceDs3PlcpGroup, aal5VccOverSizedSDUs=aal5VccOverSizedSDUs, atmInterfaceDs3PlcpSEFSs=atmInterfaceDs3PlcpSEFSs, atmInterfaceDs3PlcpAlarmState=atmInterfaceDs3PlcpAlarmState, atmInterfaceMaxActiveVciBits=atmInterfaceMaxActiveVciBits, atmVcCrossConnectHighIfIndex=atmVcCrossConnectHighIfIndex, atmTrafficDescrGroup2=atmTrafficDescrGroup2, atmTrafficDescrGroup=atmTrafficDescrGroup, atmMIBConformance=atmMIBConformance, atmTrafficDescrParamEntry=atmTrafficDescrParamEntry, atmTrafficDescrType=atmTrafficDescrType, atmTrafficDescrParam3=atmTrafficDescrParam3, atmVpCrossConnectL2HOperStatus=atmVpCrossConnectL2HOperStatus, atmVplConnKind=atmVplConnKind, atmVplTable=atmVplTable, atmMIBObjects=atmMIBObjects, atmVplRowStatus=atmVplRowStatus, atmVplCastType=atmVplCastType, atmVplOperStatus=atmVplOperStatus, atmInterfaceTCAlarmState=atmInterfaceTCAlarmState, atmVplAdminStatus=atmVplAdminStatus, aal5VccVpi=aal5VccVpi, atmVclAdminStatus=atmVclAdminStatus, atmInterfaceOCDEvents=atmInterfaceOCDEvents, atmVpCrossConnectHighVpi=atmVpCrossConnectHighVpi, atmMIB=atmMIB, atmInterfaceIlmiVpi=atmInterfaceIlmiVpi, atmVcCrossConnectL2HLastChange=atmVcCrossConnectL2HLastChange, atmTrafficDescrParam4=atmTrafficDescrParam4, atmVcCrossConnectIndex=atmVcCrossConnectIndex, atmInterfaceMyNeighborIfName=atmInterfaceMyNeighborIfName)
