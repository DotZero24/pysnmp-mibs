...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/rfc/ATM-MIB
...
AtmVorXLastChange, AtmServiceCategory, AtmAddr, atmNoClpNoScr, AtmVorXOperStatus, AtmConnKind, AtmTrafficDescrParamIndex, AtmVpIdentifier, AtmVcIdentifier, AtmVorXAdminStatus, AtmConnCastType = mibBuilder.importSymbols("ATM-TC-MIB", "AtmVorXLastChange", "AtmServiceCategory", "AtmAddr", "atmNoClpNoScr", "AtmVorXOperStatus", "AtmConnKind", "AtmTrafficDescrParamIndex", "AtmVpIdentifier", "AtmVcIdentifier", "AtmVorXAdminStatus", "AtmConnCastType")
...
mibBuilder.exportSymbols("ATM-MIB", atmServiceCategory=atmServiceCategory, atmMIB=atmMIB, atmVcCrossConnectTable=atmVcCrossConnectTable, atmVcCrossConnectGroup=atmVcCrossConnectGroup, atmInterfaceConfVpcs=atmInterfaceConfVpcs, atmInterfaceCurrentMaxVpiBits=atmInterfaceCurrentMaxVpiBits, atmVclTable=atmVclTable, atmInterfaceIlmiVpi=atmInterfaceIlmiVpi, atmVccAalType=atmVccAalType, aal5VccOverSizedSDUs=aal5VccOverSizedSDUs, atmVccAal5CpcsTransmitSduSize=atmVccAal5CpcsTransmitSduSize, atmVpCrossConnectH2LLastChange=atmVpCrossConnectH2LLastChange, atmInterfaceTCTable=atmInterfaceTCTable, atmVclEntry=atmVclEntry, atmTrafficDescrParam3=atmTrafficDescrParam3, atmVpCrossConnectRowStatus=atmVpCrossConnectRowStatus, atmInterfaceMyNeighborIfName=atmInterfaceMyNeighborIfName, atmInterfaceDs3PlcpEntry=atmInterfaceDs3PlcpEntry, atmInterfaceConfGroup=atmInterfaceConfGroup, atmTrafficDescrParam4=atmTrafficDescrParam4, atmInterfaceMaxVpcs=atmInterfaceMaxVpcs, atmVplRowStatus=atmVplRowStatus, atmVplOperStatus=atmVplOperStatus, atmTrafficDescrRowStatus=atmTrafficDescrRowStatus, atmVclCastType=atmVclCastType, atmVplCastType=atmVplCastType, atmVpPvcCrossConnectGroup=atmVpPvcCrossConnectGroup, PYSNMP_MODULE_ID=atmMIB, atmVcCrossConnectLowIfIndex=atmVcCrossConnectLowIfIndex, atmVclCrossConnectGroup=atmVclCrossConnectGroup, atmVpCrossConnectHighVpi=atmVpCrossConnectHighVpi, atmTrafficDescrGroup=atmTrafficDescrGroup, atmVclVci=atmVclVci, atmTrafficDescrParamTable=atmTrafficDescrParamTable, atmTrafficFrameDiscard=atmTrafficFrameDiscard, atmVcCrossConnectEntry=atmVcCrossConnectEntry, atmInterfaceMaxActiveVpiBits=atmInterfaceMaxActiveVpiBits, aal5VccTable=aal5VccTable, atmMIBConformance=atmMIBConformance, atmVcCrossConnectH2LLastChange=atmVcCrossConnectH2LLastChange, atmInterfaceAddressType=atmInterfaceAddressType, atmMIBCompliance2=atmMIBCompliance2, atmVclVpi=atmVclVpi, atmVpCrossConnectIndex=atmVpCrossConnectIndex, atmVpCrossConnectIndexNext=atmVpCrossConnectIndexNext, atmTrafficDescrParam5=atmTrafficDescrParam5, atmVplLastChange=atmVplLastChange, atmInterfaceTCGroup=atmInterfaceTCGroup, atmVcCrossConnectLowVpi=atmVcCrossConnectLowVpi, atmVcCrossConnectIndexNext=atmVcCrossConnectIndexNext, atmVclRowStatus=atmVclRowStatus, atmVpCrossConnectTable=atmVpCrossConnectTable, atmInterfaceConfEntry=atmInterfaceConfEntry, atmVccAal5EncapsType=atmVccAal5EncapsType, aal5VccVci=aal5VccVci, atmTrafficQoSClass=atmTrafficQoSClass, atmVplVpi=atmVplVpi, atmVclTransmitTrafficDescrIndex=atmVclTransmitTrafficDescrIndex, atmVccAal5CpcsReceiveSduSize=atmVccAal5CpcsReceiveSduSize, atmInterfaceOCDEvents=atmInterfaceOCDEvents, atmVclOperStatus=atmVclOperStatus, atmVpCrossConnectH2LOperStatus=atmVpCrossConnectH2LOperStatus, atmVclReceiveTrafficDescrIndex=atmVclReceiveTrafficDescrIndex, atmInterfaceMaxActiveVciBits=atmInterfaceMaxActiveVciBits, atmVcCrossConnectHighVci=atmVcCrossConnectHighVci, atmInterfaceDs3PlcpSEFSs=atmInterfaceDs3PlcpSEFSs, atmTrafficDescrParamIndex=atmTrafficDescrParamIndex, atmTrafficDescrParam1=atmTrafficDescrParam1, atmVcCrossConnectHighIfIndex=atmVcCrossConnectHighIfIndex, atmInterfaceMaxVccs=atmInterfaceMaxVccs, atmVcCrossConnectRowStatus=atmVcCrossConnectRowStatus, atmVpcTerminationGroup2=atmVpcTerminationGroup2, atmVplCrossConnectGroup=atmVplCrossConnectGroup, atmInterfaceIlmiVci=atmInterfaceIlmiVci, aal5VccEntry=aal5VccEntry, atmVpCrossConnectHighIfIndex=atmVpCrossConnectHighIfIndex, atmTrafficDescrParamIndexNext=atmTrafficDescrParamIndexNext, atmMIBCompliance=atmMIBCompliance, atmMIBObjects=atmMIBObjects, atmVplTable=atmVplTable, atmVcCrossConnectLowVci=atmVcCrossConnectLowVci, atmVcCrossConnectL2HLastChange=atmVcCrossConnectL2HLastChange, atmInterfaceDs3PlcpGroup=atmInterfaceDs3PlcpGroup, atmTrafficDescrGroup2=atmTrafficDescrGroup2, atmVclCrossConnectIdentifier=atmVclCrossConnectIdentifier, atmVclAdminStatus=atmVclAdminStatus, atmVpCrossConnectL2HLastChange=atmVpCrossConnectL2HLastChange, atmInterfaceCurrentMaxVciBits=atmInterfaceCurrentMaxVciBits, aal5VccSarTimeOuts=aal5VccSarTimeOuts, aal5VccVpi=aal5VccVpi, atmInterfaceMyNeighborIpAddress=atmInterfaceMyNeighborIpAddress, aal5VccGroup=aal5VccGroup, atmInterfaceConfGroup2=atmInterfaceConfGroup2, atmMIBCompliances=atmMIBCompliances, atmVplCrossConnectIdentifier=atmVplCrossConnectIdentifier, atmInterfaceTCAlarmState=atmInterfaceTCAlarmState, atmVplReceiveTrafficDescrIndex=atmVplReceiveTrafficDescrIndex, atmVclConnKind=atmVclConnKind, atmVcCrossConnectHighVpi=atmVcCrossConnectHighVpi, atmVpcTerminationGroup=atmVpcTerminationGroup, atmVcPvcCrossConnectGroup=atmVcPvcCrossConnectGroup, atmVccTerminationGroup=atmVccTerminationGroup, atmTrafficDescrParamEntry=atmTrafficDescrParamEntry, atmTrafficDescrType=atmTrafficDescrType, atmInterfaceConfTable=atmInterfaceConfTable, atmInterfaceTCEntry=atmInterfaceTCEntry, atmVpCrossConnectL2HOperStatus=atmVpCrossConnectL2HOperStatus, atmTrafficDescrParam2=atmTrafficDescrParam2, atmVpCrossConnectEntry=atmVpCrossConnectEntry, aal5VccCrcErrors=aal5VccCrcErrors, atmInterfaceDs3PlcpUASs=atmInterfaceDs3PlcpUASs, atmInterfaceAdminAddress=atmInterfaceAdminAddress, atmVpCrossConnectLowIfIndex=atmVpCrossConnectLowIfIndex, atmVpCrossConnectGroup=atmVpCrossConnectGroup, atmMIBGroups=atmMIBGroups, atmVplEntry=atmVplEntry, atmInterfaceConfVccs=atmInterfaceConfVccs, atmVcCrossConnectIndex=atmVcCrossConnectIndex, atmInterfaceDs3PlcpTable=atmInterfaceDs3PlcpTable, atmVcCrossConnectAdminStatus=atmVcCrossConnectAdminStatus, atmInterfaceDs3PlcpAlarmState=atmInterfaceDs3PlcpAlarmState, atmVccTerminationGroup2=atmVccTerminationGroup2, atmInterfaceSubscrAddress=atmInterfaceSubscrAddress, atmVpCrossConnectLowVpi=atmVpCrossConnectLowVpi, atmVpCrossConnectAdminStatus=atmVpCrossConnectAdminStatus, atmVplConnKind=atmVplConnKind, atmVplAdminStatus=atmVplAdminStatus, atmVclLastChange=atmVclLastChange, atmVcCrossConnectH2LOperStatus=atmVcCrossConnectH2LOperStatus, atmVcCrossConnectL2HOperStatus=atmVcCrossConnectL2HOperStatus, atmVplTransmitTrafficDescrIndex=atmVplTransmitTrafficDescrIndex)
