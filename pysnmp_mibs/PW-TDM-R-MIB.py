# SNMP MIB module (PW-TDM-R-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/rad/PW-TDM-R-MIB
...
pwTDMMIBR = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 13)
)
if mibBuilder.loadTexts:
    pwTDMMIBR.setRevisions(
        ("2007-02-04 00:00",
         "2006-09-10 00:00",
         "2006-03-01 00:00",
         "2005-10-23 00:00",
...
_PwTDMRate_Type.__name__ = "Integer32"
_PwTDMRate_Object = MibTableColumn
pwTDMRate = _PwTDMRate_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 1, 1, 1),
    _PwTDMRate_Type()
)
...
class _PwTDMCurrentIndications_Type(Bits):
    """Custom type pwTDMCurrentIndications based on Bits"""
    namedValues = NamedValues(
        *(("other", 0),
          ("strayPacket", 1),
          ("malformedPacket", 2),
...
_PwTDMCurrentIndications_Type.__name__ = "Bits"
_PwTDMCurrentIndications_Object = MibTableColumn
pwTDMCurrentIndications = _PwTDMCurrentIndications_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 1, 1, 9),
    _PwTDMCurrentIndications_Type()
)
pwTDMCurrentIndications.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pwTDMCurrentIndications.setStatus("deprecated")


class _PwTDMLatchedIndications_Type(Bits):
    """Custom type pwTDMLatchedIndications based on Bits"""
    namedValues = NamedValues(
        *(("other", 0),
          ("strayPacket", 1),
          ("malformedPacket", 2),
...
_PwTDMLatchedIndications_Type.__name__ = "Bits"
_PwTDMLatchedIndications_Object = MibTableColumn
pwTDMLatchedIndications = _PwTDMLatchedIndications_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 1, 1, 10),
    _PwTDMLatchedIndications_Type()
)
pwTDMLatchedIndications.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pwTDMLatchedIndications.setStatus("deprecated")
...
pwTDMLastEsTimeStamp = _PwTDMLastEsTimeStamp_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 1, 1, 11),
...
class _PwTDMCfgConfErr_Type(Bits):
    """Custom type pwTDMCfgConfErr based on Bits"""
    namedValues = NamedValues(
        *(("notApplicable", 0),
          ("payloadSize", 1),
          ("jtrBfrDepth", 2))
...
_PwTDMCfgConfErr_Type.__name__ = "Bits"
_PwTDMCfgConfErr_Object = MibTableColumn
pwTDMCfgConfErr = _PwTDMCfgConfErr_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 3, 1, 3),
    _PwTDMCfgConfErr_Type()
)
pwTDMCfgConfErr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pwTDMCfgConfErr.setStatus("deprecated")
...
pwTDMCfgConsecMissPktsOutSynch = _PwTDMCfgConsecMissPktsOutSynch_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 3, 1, 10),
...
pwTDMCfgAvePktLossTimeWindow = _PwTDMCfgAvePktLossTimeWindow_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 3, 1, 13),
...
pwTDMCfgExcessivePktLossThreshold = _PwTDMCfgExcessivePktLossThreshold_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 3, 1, 14),
...
pwTDMCfgTimestampMode = _PwTDMCfgTimestampMode_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 3, 1, 18),
...
pwTDMCfgStorageType = _PwTDMCfgStorageType_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 3, 1, 19),
...
pwTDMCfgPktFiller = _PwTDMCfgPktFiller_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 3, 1, 20),
...
pwTDMCfgName = _PwTDMCfgName_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 3, 1, 21),
    _PwTDMCfgName_Type()
)
...
pwTDMPerfIntervalEntry = _PwTDMPerfIntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 6, 1)
)
pwTDMPerfIntervalEntry.setIndexNames(
    (0, "PW-STD-R-MIB", "pwIndex"),
    (0, "PW-TDM-R-MIB", "pwTDMPerfIntervalNumber"),
)
if mibBuilder.loadTexts:
...
pwTDMPerfIntervalSESs = _PwTDMPerfIntervalSESs_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 6, 1, 10),
...
pwTDMPerfIntervalUASs = _PwTDMPerfIntervalUASs_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 6, 1, 11),
...
pwTDMPerfIntervalFC = _PwTDMPerfIntervalFC_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 6, 1, 12),
...
pwTDMPerf1DayIntervalEntry = _PwTDMPerf1DayIntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 7, 1)
)
pwTDMPerf1DayIntervalEntry.setIndexNames(
    (0, "PW-STD-R-MIB", "pwIndex"),
    (0, "PW-TDM-R-MIB", "pwTDMPerf1DayIntervalNumber"),
)
if mibBuilder.loadTexts:
...
pwTDMPerf1DayIntervalSESs = _PwTDMPerf1DayIntervalSESs_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 7, 1, 10),
...
pwTDMPerf1DayIntervalUASs = _PwTDMPerf1DayIntervalUASs_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 7, 1, 11),
...
pwTDMPerf1DayIntervalFC = _PwTDMPerf1DayIntervalFC_Object(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 1, 7, 1, 12),
...
pwTDMNotifications = _PwTDMNotifications_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 2)
)
_PwTDMConformance_ObjectIdentity = ObjectIdentity
pwTDMConformance = _PwTDMConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 3)
)
_PwTDMGroups_ObjectIdentity = ObjectIdentity
pwTDMGroups = _PwTDMGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 3, 1)
)
_PwTDMCompliances_ObjectIdentity = ObjectIdentity
pwTDMCompliances = _PwTDMCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 3, 2)
)

# Managed Objects groups

pwTDMGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 3, 1, 1)
)
pwTDMGroup.setObjects(
      *(("PW-TDM-R-MIB", "pwTDMRate"),
        ("PW-TDM-R-MIB", "pwTDMIfIndex"),
        ("PW-TDM-R-MIB", "pwGenTDMCfgIndex"),
        ("PW-TDM-R-MIB", "pwRelTDMCfgIndex"),
        ("PW-TDM-R-MIB", "pwTDMConfigError"),
        ("PW-TDM-R-MIB", "pwTDMTimeElapsed"),
        ("PW-TDM-R-MIB", "pwTDMValidIntervals"),
        ("PW-TDM-R-MIB", "pwTDMValidDayIntervals"),
        ("PW-TDM-R-MIB", "pwTDMLastEsTimeStamp"),
        ("PW-TDM-R-MIB", "pwTDMCfgIndexNext"),
        ("PW-TDM-R-MIB", "pwTDMCfgRowStatus"),
        ("PW-TDM-R-MIB", "pwTDMCfgPayloadSize"),
        ("PW-TDM-R-MIB", "pwTDMCfgPktReorder"),
        ("PW-TDM-R-MIB", "pwTDMCfgRtpHdrUsed"),
        ("PW-TDM-R-MIB", "pwTDMCfgJtrBfrDepth"),
        ("PW-TDM-R-MIB", "pwTDMCfgPayloadSuppression"),
        ("PW-TDM-R-MIB", "pwTDMCfgConsecPktsInSynch"),
        ("PW-TDM-R-MIB", "pwTDMCfgConsecMissPktsOutSynch"),
        ("PW-TDM-R-MIB", "pwTDMCfgSetUp2SynchTimeOut"),
        ("PW-TDM-R-MIB", "pwTDMCfgPktReplacePolicy"),
        ("PW-TDM-R-MIB", "pwTDMCfgAvePktLossTimeWindow"),
        ("PW-TDM-R-MIB", "pwTDMCfgExcessivePktLossThreshold"),
        ("PW-TDM-R-MIB", "pwTDMCfgAlarmThreshold"),
        ("PW-TDM-R-MIB", "pwTDMCfgClearAlarmThreshold"),
        ("PW-TDM-R-MIB", "pwTDMCfgMissingPktsToSes"),
        ("PW-TDM-R-MIB", "pwTDMCfgTimestampMode"),
        ("PW-TDM-R-MIB", "pwTDMCfgStorageType"),
        ("PW-TDM-R-MIB", "pwTDMCfgPktFiller"),
        ("PW-TDM-R-MIB", "pwTDMCfgName"),
        ("PW-TDM-R-MIB", "pwTDMCurrentIndications"),
        ("PW-TDM-R-MIB", "pwTDMLatchedIndications"),
        ("PW-TDM-R-MIB", "pwTDMCfgConfErr"))
)
if mibBuilder.loadTexts:
    pwTDMGroup.setStatus("current")

pwTDMPerfCurrentGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 3, 1, 2)
)
pwTDMPerfCurrentGroup.setObjects(
      *(("PW-TDM-R-MIB", "pwTDMPerfCurrentMissingPkts"),
        ("PW-TDM-R-MIB", "pwTDMPerfCurrentPktsReOrder"),
        ("PW-TDM-R-MIB", "pwTDMPerfCurrentJtrBfrUnderruns"),
        ("PW-TDM-R-MIB", "pwTDMPerfCurrentMisOrderDropped"),
        ("PW-TDM-R-MIB", "pwTDMPerfCurrentMalformedPkt"),
        ("PW-TDM-R-MIB", "pwTDMPerfCurrentESs"),
        ("PW-TDM-R-MIB", "pwTDMPerfCurrentSESs"),
        ("PW-TDM-R-MIB", "pwTDMPerfCurrentUASs"),
        ("PW-TDM-R-MIB", "pwTDMPerfCurrentFC"))
)
if mibBuilder.loadTexts:
    pwTDMPerfCurrentGroup.setStatus("current")

pwTDMPerfIntervalGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 3, 1, 3)
)
pwTDMPerfIntervalGroup.setObjects(
      *(("PW-TDM-R-MIB", "pwTDMPerfIntervalValidData"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalDuration"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalMissingPkts"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalPktsReOrder"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalJtrBfrUnderruns"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalMisOrderDropped"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalMalformedPkt"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalESs"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalSESs"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalUASs"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalFC"))
)
if mibBuilder.loadTexts:
    pwTDMPerfIntervalGroup.setStatus("current")

pwTDMPerf1DayIntervalGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 3, 1, 4)
)
pwTDMPerf1DayIntervalGroup.setObjects(
      *(("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalValidData"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalDuration"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalMissingPkts"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalPktsReOrder"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalJtrBfrUnderruns"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalMisOrderDropped"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalMalformedPkt"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalESs"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalSESs"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalUASs"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalFC"))
)
if mibBuilder.loadTexts:
...
pwTDMModuleCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 164, 20, 13, 3, 2, 1)
)
pwTDMModuleCompliance.setObjects(
      *(("PW-TDM-R-MIB", "pwTDMGroup"),
        ("PW-TDM-R-MIB", "pwTDMPerfCurrentGroup"),
        ("PW-TDM-R-MIB", "pwTDMPerfIntervalGroup"),
        ("PW-TDM-R-MIB", "pwTDMPerf1DayIntervalGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"PwTDMCfgIndex": PwTDMCfgIndex,
       ...
       "pwTDMCurrentIndications": pwTDMCurrentIndications,
       "pwTDMLatchedIndications": pwTDMLatchedIndications,
       ...
       "pwTDMCfgConfErr": pwTDMCfgConfErr,
