...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CDSTV-CS-STATS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:50 2025
...
ciscoCdstvStatsMIBModuleCompliance.setObjects(
      *(("CISCO-CDSTV-CS-STATS-MIB", "ciscoCdstvStatsMIBCacheObjectGroup"),
        ("CISCO-CDSTV-CS-STATS-MIB", "ciscoCdstvStatsMIBStreamObjectGroup"))
)
if mibBuilder.loadTexts:
...
ciscoCdstvStatsMIBModuleCompliance2.setObjects(
      *(("CISCO-CDSTV-CS-STATS-MIB", "ciscoCdstvStatsMIBCacheObjectGroup"),
        ("CISCO-CDSTV-CS-STATS-MIB", "ciscoCdstvStatsMIBStreamObjectGroup2"))
)
if mibBuilder.loadTexts:
...
ciscoCdstvStatsMIBModuleCompliance3.setObjects(
      *(("CISCO-CDSTV-CS-STATS-MIB", "ciscoCdstvStatsMIBCacheObjectGroup"),
        ("CISCO-CDSTV-CS-STATS-MIB", "ciscoCdstvStatsMIBStreamObjectGroup3"))
)
if mibBuilder.loadTexts:
