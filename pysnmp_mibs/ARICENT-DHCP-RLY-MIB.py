...
dhcpRelay=_DhcpRelay_ObjectIdentity((1,3,6,1,4,1,2076,24,1))
...
dhcpRelaying=_DhcpRelaying_Object((1,3,6,1,4,1,2076,24,1,1),_DhcpRelaying_Type())
...
dhcpRelayServersOnly=_DhcpRelayServersOnly_Object((1,3,6,1,4,1,2076,24,1,2),_DhcpRelayServersOnly_Type())
...
dhcpRelaySecsThreshold=_DhcpRelaySecsThreshold_Object((1,3,6,1,4,1,2076,24,1,3),_DhcpRelaySecsThreshold_Type())
...
dhcpRelayHopsThreshold=_DhcpRelayHopsThreshold_Object((1,3,6,1,4,1,2076,24,1,4),_DhcpRelayHopsThreshold_Type())
...
dhcpRelayRAIOptionControl=_DhcpRelayRAIOptionControl_Object((1,3,6,1,4,1,2076,24,1,5),_DhcpRelayRAIOptionControl_Type())
...
dhcpRelayRAICircuitIDSubOptionControl=_DhcpRelayRAICircuitIDSubOptionControl_Object((1,3,6,1,4,1,2076,24,1,6),_DhcpRelayRAICircuitIDSubOptionControl_Type())
...
dhcpRelayRAIRemoteIDSubOptionControl=_DhcpRelayRAIRemoteIDSubOptionControl_Object((1,3,6,1,4,1,2076,24,1,7),_DhcpRelayRAIRemoteIDSubOptionControl_Type())
...
dhcpRelayRAISubnetMaskSubOptionControl=_DhcpRelayRAISubnetMaskSubOptionControl_Object((1,3,6,1,4,1,2076,24,1,8),_DhcpRelayRAISubnetMaskSubOptionControl_Type())
...
dhcpRelayRAIOptionInserted=_DhcpRelayRAIOptionInserted_Object((1,3,6,1,4,1,2076,24,1,9),_DhcpRelayRAIOptionInserted_Type())
...
dhcpRelayRAICircuitIDSubOptionInserted=_DhcpRelayRAICircuitIDSubOptionInserted_Object((1,3,6,1,4,1,2076,24,1,10),_DhcpRelayRAICircuitIDSubOptionInserted_Type())
...
dhcpRelayRAIRemoteIDSubOptionInserted=_DhcpRelayRAIRemoteIDSubOptionInserted_Object((1,3,6,1,4,1,2076,24,1,11),_DhcpRelayRAIRemoteIDSubOptionInserted_Type())
...
dhcpRelayRAISubnetMaskSubOptionInserted=_DhcpRelayRAISubnetMaskSubOptionInserted_Object((1,3,6,1,4,1,2076,24,1,12),_DhcpRelayRAISubnetMaskSubOptionInserted_Type())
...
dhcpRelayRAIOptionWronglySet=_DhcpRelayRAIOptionWronglySet_Object((1,3,6,1,4,1,2076,24,1,13),_DhcpRelayRAIOptionWronglySet_Type())
...
dhcpRelayRAISpaceConstraint=_DhcpRelayRAISpaceConstraint_Object((1,3,6,1,4,1,2076,24,1,14),_DhcpRelayRAISpaceConstraint_Type())
...
dhcpConfigTraceLevel=_DhcpConfigTraceLevel_Object((1,3,6,1,4,1,2076,24,1,15),_DhcpConfigTraceLevel_Type())
...
dhcpConfigDhcpCircuitOption=_DhcpConfigDhcpCircuitOption_Object((1,3,6,1,4,1,2076,24,1,16),_DhcpConfigDhcpCircuitOption_Type())
...
dhcpRelayCounterReset=_DhcpRelayCounterReset_Object((1,3,6,1,4,1,2076,24,1,17),_DhcpRelayCounterReset_Type())
...
dhcpRelayTable=_DhcpRelayTable_ObjectIdentity((1,3,6,1,4,1,2076,24,2))
_DhcpRelaySrvAddressTable_Object=MibTable
dhcpRelaySrvAddressTable=_DhcpRelaySrvAddressTable_Object((1,3,6,1,4,1,2076,24,2,1))
if mibBuilder.loadTexts:dhcpRelaySrvAddressTable.setStatus(_A)
_DhcpRelaySrvAddressEntry_Object=MibTableRow
dhcpRelaySrvAddressEntry=_DhcpRelaySrvAddressEntry_Object((1,3,6,1,4,1,2076,24,2,1,1))
...
dhcpRelaySrvIpAddress=_DhcpRelaySrvIpAddress_Object((1,3,6,1,4,1,2076,24,2,1,1,1),_DhcpRelaySrvIpAddress_Type())
...
dhcpRelaySrvAddressRowStatus=_DhcpRelaySrvAddressRowStatus_Object((1,3,6,1,4,1,2076,24,2,1,1,2),_DhcpRelaySrvAddressRowStatus_Type())
...
dhcpRelayIfTable=_DhcpRelayIfTable_Object((1,3,6,1,4,1,2076,24,2,2))
if mibBuilder.loadTexts:dhcpRelayIfTable.setStatus(_A)
_DhcpRelayIfEntry_Object=MibTableRow
dhcpRelayIfEntry=_DhcpRelayIfEntry_Object((1,3,6,1,4,1,2076,24,2,2,1))
...
dhcpRelayIfCircuitId=_DhcpRelayIfCircuitId_Object((1,3,6,1,4,1,2076,24,2,2,1,1),_DhcpRelayIfCircuitId_Type())
...
dhcpRelayIfRemoteId=_DhcpRelayIfRemoteId_Object((1,3,6,1,4,1,2076,24,2,2,1,2),_DhcpRelayIfRemoteId_Type())
...
dhcpRelayIfRowStatus=_DhcpRelayIfRowStatus_Object((1,3,6,1,4,1,2076,24,2,2,1,3),_DhcpRelayIfRowStatus_Type())
