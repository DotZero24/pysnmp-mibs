# SNMP MIB module (ARICENT-DHCP-RLY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-DHCP-RLY-MIB
...
dhcpRelaySrvAddressEntry = _DhcpRelaySrvAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 24, 2, 1, 1)
)
dhcpRelaySrvAddressEntry.setIndexNames(
    (0, "ARICENT-DHCP-RLY-MIB", "dhcpRelaySrvIpAddress"),
)
if mibBuilder.loadTexts:
