...
# Notes
# -----
# ASN.1 source file://mibs/paradyne/PDN-PPP-LCP-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:01:46 2025
...
pdnPppLcpExtCompliance.setObjects(
      *(("PDN-PPP-LCP-EXT-MIB", "pdnPppLcpExtStateMachineGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPppLcpExtEstablishFailedGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPppLcpExtMagicNumberGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPppLcpExtPacketCountersGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPppLcpExtKeepAliveCountersGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPppLcpExtPFCGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPppLcpExtACFCGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPppLcpExtKeepAliveConfGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPppLcpExtEchoTestGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPpppLcpExtDiscardTestGroup"),
        ("PDN-PPP-LCP-EXT-MIB", "pdnPpppLcpExtLinkStateCounterGroup"))
)
if mibBuilder.loadTexts:
