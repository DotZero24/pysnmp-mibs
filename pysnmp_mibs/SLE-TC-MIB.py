...
mibBuilder.exportSymbols("SLE-TC-MIB", SleScopeType=SleScopeType, SleControlRequestResultType=SleControlRequestResultType, SleSystemFileIndexType=SleSystemFileIndexType, SleTrafficType=SleTrafficType, SleAdminStateType=SleAdminStateType, SleControlStatusType=SleControlStatusType, PYSNMP_MODULE_ID=sleTcMib, sleTcMib=sleTcMib, SlePermissionType=SlePermissionType, SleCardType=SleCardType, SleOperStateType=SleOperStateType)
