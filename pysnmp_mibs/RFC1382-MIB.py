...
mibBuilder.exportSymbols("RFC1382-MIB", x25ClearedCircuitOutPdus=x25ClearedCircuitOutPdus, x25CircuitDescr=x25CircuitDescr, x25StatOutDataPackets=x25StatOutDataPackets, x25ChannelLTC=x25ChannelLTC, x25ClearedCircuitInPdus=x25ClearedCircuitInPdus, x25CircuitCalledDteAddress=x25CircuitCalledDteAddress, x25OperMinimumRecallTimer=x25OperMinimumRecallTimer, x25AdmnRejectTimer=x25AdmnRejectTimer, x25CallParmOutThruPutClasSize=x25CallParmOutThruPutClasSize, x25AdmnRejectCount=x25AdmnRejectCount, x25CallParmBcug=x25CallParmBcug, x25=x25, x25OperMaxActiveCircuits=x25OperMaxActiveCircuits, x25ClearedCircuitEntriesGranted=x25ClearedCircuitEntriesGranted, x25OperIndex=x25OperIndex, x25ClearedCircuitCalledAddress=x25ClearedCircuitCalledAddress, x25CircuitOutInterrupts=x25CircuitOutInterrupts, x25CircuitInInterrupts=x25CircuitInInterrupts, x25AdmnClearCount=x25AdmnClearCount, x25AdmnDataRxmtCount=x25AdmnDataRxmtCount, x25ClearedCircuitTimeEstablished=x25ClearedCircuitTimeEstablished, x25OperRejectCount=x25OperRejectCount, x25AdmnEntry=x25AdmnEntry, x25OperTable=x25OperTable, x25CallParmEndTrnsDly=x25CallParmEndTrnsDly, x25OperDataLinkId=x25OperDataLinkId, x25StatInAccusedOfProtocolErrors=x25StatInAccusedOfProtocolErrors, x25CircuitOutOctets=x25CircuitOutOctets, x25CallParmFastSelect=x25CallParmFastSelect, x25CallParmChargingInfo=x25CallParmChargingInfo, x25ClearedCircuitIndex=x25ClearedCircuitIndex, x25CallParmOutMinThuPutCls=x25CallParmOutMinThuPutCls, x25AdmnRegistrationRequestCount=x25AdmnRegistrationRequestCount, x25StatRetryCountExceededs=x25StatRetryCountExceededs, x25StatInCallRefusals=x25StatInCallRefusals, x25AdmnProtocolVersionSupported=x25AdmnProtocolVersionSupported, x25CallParmAcceptReverseCharging=x25CallParmAcceptReverseCharging, x25protocolCcittV1980=x25protocolCcittV1980, x25CallParmCug=x25CallParmCug, x25StatIndex=x25StatIndex, x25OperPacketSequencing=x25OperPacketSequencing, x25ChannelHIC=x25ChannelHIC, x25CircuitInProviderInitiatedResets=x25CircuitInProviderInitiatedResets, x25ClearedCircuitChannel=x25ClearedCircuitChannel, x25protocolIso8208V1987=x25protocolIso8208V1987, x25ClearedCircuitEntry=x25ClearedCircuitEntry, x25CallParmCalledNetworkFacilities=x25CallParmCalledNetworkFacilities, x25CircuitDataRetransmissionTimeouts=x25CircuitDataRetransmissionTimeouts, x25CallParmInPacketSize=x25CallParmInPacketSize, x25OperInterruptTimer=x25OperInterruptTimer, x25StatOutCallAttempts=x25StatOutCallAttempts, x25CircuitOutPdus=x25CircuitOutPdus, x25CallParmCalledExt=x25CallParmCalledExt, x25CallParmInThruPutClasSize=x25CallParmInThruPutClasSize, x25StatIncomingCircuits=x25StatIncomingCircuits, x25CircuitChannel=x25CircuitChannel, x25CallParmUserData=x25CallParmUserData, x25OperDefCallParamId=x25OperDefCallParamId, x25StatInRemotelyInitiatedResets=x25StatInRemotelyInitiatedResets, x25AdmnMinimumRecallTimer=x25AdmnMinimumRecallTimer, x25CallParmCugoa=x25CallParmCugoa, x25AdmnRestartTimer=x25AdmnRestartTimer, x25ClearedCircuitEntriesRequested=x25ClearedCircuitEntriesRequested, x25CircuitEstablishTime=x25CircuitEstablishTime, x25protocolCcittV1976=x25protocolCcittV1976, x25OperResetCount=x25OperResetCount, X121Address=X121Address, x25OperClearCount=x25OperClearCount, x25StatCallTimeouts=x25StatCallTimeouts, x25ChannelTable=x25ChannelTable, x25StatTable=x25StatTable, x25ClearedCircuitDiagnosticCode=x25ClearedCircuitDiagnosticCode, x25AdmnIndex=x25AdmnIndex, x25CallParmCallingNetworkFacilities=x25CallParmCallingNetworkFacilities, x25CallParmEntry=x25CallParmEntry, x25CircuitInPdus=x25CircuitInPdus, x25CircuitDirection=x25CircuitDirection, x25StatClearCountExceededs=x25StatClearCountExceededs, x25StatInCalls=x25StatInCalls, x25StatTwowayCircuits=x25StatTwowayCircuits, x25StatOutCallFailures=x25StatOutCallFailures, x25CallParmTable=x25CallParmTable, x25CallParmIndex=x25CallParmIndex, x25ProtocolVersion=x25ProtocolVersion, x25AdmnResetCount=x25AdmnResetCount, x25StatResetTimeouts=x25StatResetTimeouts, x25CircuitCallParamId=x25CircuitCallParamId, x25OperClearTimer=x25OperClearTimer, x25ChannelLIC=x25ChannelLIC, x25CallParmCallingExt=x25CallParmCallingExt, x25AdmnRegistrationRequestTimer=x25AdmnRegistrationRequestTimer, x25AdmnPacketSequencing=x25AdmnPacketSequencing, x25CallParmProposeReverseCharging=x25CallParmProposeReverseCharging, x25OperDataRxmtTimer=x25OperDataRxmtTimer, x25StatInProviderInitiatedClears=x25StatInProviderInitiatedClears, x25ClearedCircuitClearingCause=x25ClearedCircuitClearingCause, x25AdmnInterruptTimer=x25AdmnInterruptTimer, x25OperRestartCount=x25OperRestartCount, x25CallParmPriority=x25CallParmPriority, x25CallParmRpoa=x25CallParmRpoa, x25ClearedCircuitTable=x25ClearedCircuitTable, x25ChannelLOC=x25ChannelLOC, x25ClearedCircuitTimeCleared=x25ClearedCircuitTimeCleared, x25CallParmOutWindowSize=x25CallParmOutWindowSize, x25CircuitIndex=x25CircuitIndex, x25AdmnInterfaceMode=x25AdmnInterfaceMode, x25OperCallTimer=x25OperCallTimer, x25CallParmInWindowSize=x25CallParmInWindowSize, x25AdmnResetTimer=x25AdmnResetTimer, x25Reset=x25Reset, x25CircuitTable=x25CircuitTable, x25CallParmTrnstDly=x25CallParmTrnstDly, x25ChannelEntry=x25ChannelEntry, x25Restart=x25Restart, x25protocolIso8208V1989=x25protocolIso8208V1989, x25OperRejectTimer=x25OperRejectTimer, x25StatOutInterrupts=x25StatOutInterrupts, x25CallParmRefCount=x25CallParmRefCount, x25OperProtocolVersionSupported=x25OperProtocolVersionSupported, x25OperNumberPVCs=x25OperNumberPVCs, x25AdmnDefCallParamId=x25AdmnDefCallParamId, x25AdmnTable=x25AdmnTable, x25AdmnCallTimer=x25AdmnCallTimer, x25ChannelHTC=x25ChannelHTC, x25CircuitInOctets=x25CircuitInOctets, x25protocolCcittV1988=x25protocolCcittV1988, x25OperResetTimer=x25OperResetTimer, x25StatInProviderInitiatedResets=x25StatInProviderInitiatedResets, x25AdmnDataRxmtTimer=x25AdmnDataRxmtTimer, x25OperRegistrationRequestCount=x25OperRegistrationRequestCount, x25StatInterruptTimeouts=x25StatInterruptTimeouts, x25protocolCcittV1984=x25protocolCcittV1984, x25OperEntry=x25OperEntry, x25ClearedCircuitPleIndex=x25ClearedCircuitPleIndex, x25CallParmStatus=x25CallParmStatus, x25StatClearTimeouts=x25StatClearTimeouts, x25AdmnNumberPVCs=x25AdmnNumberPVCs, x25CircuitCallingDteAddress=x25CircuitCallingDteAddress, x25CircuitStatus=x25CircuitStatus, x25StatEntry=x25StatEntry, x25StatRestartTimeouts=x25StatRestartTimeouts, x25CallParmNui=x25CallParmNui, x25CallParmProtection=x25CallParmProtection, x25OperRestartTimer=x25OperRestartTimer, x25CallParmInMinThuPutCls=x25CallParmInMinThuPutCls, x25AdmnLocalAddress=x25AdmnLocalAddress, x25CircuitInRemotelyInitiatedResets=x25CircuitInRemotelyInitiatedResets, x25AdmnWindowTimer=x25AdmnWindowTimer, x25AdmnClearTimer=x25AdmnClearTimer, x25StatInRestarts=x25StatInRestarts, x25OperInterfaceMode=x25OperInterfaceMode, x25ChannelIndex=x25ChannelIndex, x25ClearedCircuitCallingAddress=x25ClearedCircuitCallingAddress, x25OperDataRxmtCount=x25OperDataRxmtCount, x25CircuitResetTimeouts=x25CircuitResetTimeouts, x25OperLocalAddress=x25OperLocalAddress, x25StatInInterrupts=x25StatInInterrupts, x25CallParmOutPacketSize=x25CallParmOutPacketSize, x25ChannelHOC=x25ChannelHOC, x25OperRegistrationRequestTimer=x25OperRegistrationRequestTimer, x25StatDataRxmtTimeouts=x25StatDataRxmtTimeouts, x25CircuitEntry=x25CircuitEntry, x25AdmnMaxActiveCircuits=x25AdmnMaxActiveCircuits, x25ClearedCircuitClearFacilities=x25ClearedCircuitClearFacilities, x25CallParmExptData=x25CallParmExptData, x25StatInDataPackets=x25StatInDataPackets, x25CircuitOriginallyCalledAddress=x25CircuitOriginallyCalledAddress, x25OperWindowTimer=x25OperWindowTimer, x25StatOutgoingCircuits=x25StatOutgoingCircuits, x25AdmnRestartCount=x25AdmnRestartCount, x25CircuitInterruptTimeouts=x25CircuitInterruptTimeouts)
