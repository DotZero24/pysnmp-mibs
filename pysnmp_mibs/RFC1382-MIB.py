...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/rfc/RFC1382-MIB
...
PositiveInteger, IfIndexType = mibBuilder.importSymbols("RFC1381-MIB", "PositiveInteger", "IfIndexType")
...
mibBuilder.exportSymbols("RFC1382-MIB", x25StatTable=x25StatTable, x25CallParmInPacketSize=x25CallParmInPacketSize, x25OperEntry=x25OperEntry, x25CircuitOutInterrupts=x25CircuitOutInterrupts, x25StatInProviderInitiatedClears=x25StatInProviderInitiatedClears, x25CircuitInPdus=x25CircuitInPdus, x25StatCallTimeouts=x25StatCallTimeouts, x25StatInCallRefusals=x25StatInCallRefusals, x25StatOutCallAttempts=x25StatOutCallAttempts, x25CircuitDataRetransmissionTimeouts=x25CircuitDataRetransmissionTimeouts, x25CallParmOutMinThuPutCls=x25CallParmOutMinThuPutCls, x25StatEntry=x25StatEntry, x25CircuitOriginallyCalledAddress=x25CircuitOriginallyCalledAddress, x25ClearedCircuitClearingCause=x25ClearedCircuitClearingCause, x25AdmnRestartTimer=x25AdmnRestartTimer, x25AdmnResetTimer=x25AdmnResetTimer, x25CircuitOutPdus=x25CircuitOutPdus, x25OperInterruptTimer=x25OperInterruptTimer, x25ClearedCircuitEntriesGranted=x25ClearedCircuitEntriesGranted, x25ChannelTable=x25ChannelTable, x25OperCallTimer=x25OperCallTimer, x25CallParmRefCount=x25CallParmRefCount, x25protocolCcittV1988=x25protocolCcittV1988, x25CallParmAcceptReverseCharging=x25CallParmAcceptReverseCharging, x25ChannelHOC=x25ChannelHOC, x25OperIndex=x25OperIndex, x25OperRestartTimer=x25OperRestartTimer, x25AdmnMinimumRecallTimer=x25AdmnMinimumRecallTimer, x25AdmnIndex=x25AdmnIndex, x25CircuitEstablishTime=x25CircuitEstablishTime, x25CallParmInThruPutClasSize=x25CallParmInThruPutClasSize, x25CircuitTable=x25CircuitTable, x25OperMinimumRecallTimer=x25OperMinimumRecallTimer, x25ChannelLTC=x25ChannelLTC, x25CallParmOutPacketSize=x25CallParmOutPacketSize, x25OperLocalAddress=x25OperLocalAddress, x25ClearedCircuitInPdus=x25ClearedCircuitInPdus, x25StatInRestarts=x25StatInRestarts, x25CircuitResetTimeouts=x25CircuitResetTimeouts, x25OperNumberPVCs=x25OperNumberPVCs, x25CallParmProtection=x25CallParmProtection, x25ChannelHTC=x25ChannelHTC, x25ClearedCircuitEntriesRequested=x25ClearedCircuitEntriesRequested, x25AdmnTable=x25AdmnTable, x25StatRetryCountExceededs=x25StatRetryCountExceededs, x25ClearedCircuitTimeCleared=x25ClearedCircuitTimeCleared, x25CallParmExptData=x25CallParmExptData, x25CallParmCug=x25CallParmCug, x25CallParmFastSelect=x25CallParmFastSelect, x25CallParmTable=x25CallParmTable, x25StatInRemotelyInitiatedResets=x25StatInRemotelyInitiatedResets, x25AdmnDataRxmtCount=x25AdmnDataRxmtCount, x25CallParmCallingNetworkFacilities=x25CallParmCallingNetworkFacilities, x25CallParmUserData=x25CallParmUserData, x25StatOutDataPackets=x25StatOutDataPackets, x25CallParmOutWindowSize=x25CallParmOutWindowSize, x25AdmnClearCount=x25AdmnClearCount, x25StatInDataPackets=x25StatInDataPackets, x25AdmnNumberPVCs=x25AdmnNumberPVCs, x25AdmnPacketSequencing=x25AdmnPacketSequencing, x25OperWindowTimer=x25OperWindowTimer, x25ChannelLOC=x25ChannelLOC, x25=x25, x25StatInProviderInitiatedResets=x25StatInProviderInitiatedResets, x25CircuitInRemotelyInitiatedResets=x25CircuitInRemotelyInitiatedResets, x25StatClearTimeouts=x25StatClearTimeouts, x25AdmnInterruptTimer=x25AdmnInterruptTimer, x25OperResetCount=x25OperResetCount, x25AdmnRestartCount=x25AdmnRestartCount, x25OperRegistrationRequestCount=x25OperRegistrationRequestCount, x25OperDataRxmtTimer=x25OperDataRxmtTimer, x25AdmnProtocolVersionSupported=x25AdmnProtocolVersionSupported, x25ClearedCircuitChannel=x25ClearedCircuitChannel, x25CallParmInMinThuPutCls=x25CallParmInMinThuPutCls, x25CallParmNui=x25CallParmNui, x25AdmnRejectTimer=x25AdmnRejectTimer, x25CallParmStatus=x25CallParmStatus, x25CallParmEntry=x25CallParmEntry, x25CircuitInInterrupts=x25CircuitInInterrupts, x25protocolCcittV1984=x25protocolCcittV1984, x25protocolIso8208V1987=x25protocolIso8208V1987, x25StatInCalls=x25StatInCalls, x25OperTable=x25OperTable, x25CircuitCallParamId=x25CircuitCallParamId, x25CallParmInWindowSize=x25CallParmInWindowSize, x25OperClearTimer=x25OperClearTimer, x25CircuitIndex=x25CircuitIndex, x25CircuitEntry=x25CircuitEntry, x25ClearedCircuitTable=x25ClearedCircuitTable, x25OperRejectCount=x25OperRejectCount, x25OperDefCallParamId=x25OperDefCallParamId, x25ClearedCircuitPleIndex=x25ClearedCircuitPleIndex, x25CallParmChargingInfo=x25CallParmChargingInfo, x25CallParmOutThruPutClasSize=x25CallParmOutThruPutClasSize, x25ClearedCircuitIndex=x25ClearedCircuitIndex, x25CallParmRpoa=x25CallParmRpoa, x25ChannelEntry=x25ChannelEntry, x25CircuitInProviderInitiatedResets=x25CircuitInProviderInitiatedResets, x25CircuitDescr=x25CircuitDescr, x25OperDataLinkId=x25OperDataLinkId, x25OperProtocolVersionSupported=x25OperProtocolVersionSupported, x25AdmnCallTimer=x25AdmnCallTimer, x25AdmnResetCount=x25AdmnResetCount, x25CallParmProposeReverseCharging=x25CallParmProposeReverseCharging, x25AdmnInterfaceMode=x25AdmnInterfaceMode, x25StatTwowayCircuits=x25StatTwowayCircuits, x25StatInAccusedOfProtocolErrors=x25StatInAccusedOfProtocolErrors, x25ClearedCircuitEntry=x25ClearedCircuitEntry, x25OperPacketSequencing=x25OperPacketSequencing, x25AdmnRegistrationRequestCount=x25AdmnRegistrationRequestCount, x25AdmnMaxActiveCircuits=x25AdmnMaxActiveCircuits, x25CallParmEndTrnsDly=x25CallParmEndTrnsDly, x25CallParmCalledNetworkFacilities=x25CallParmCalledNetworkFacilities, x25CircuitChannel=x25CircuitChannel, x25ClearedCircuitCallingAddress=x25ClearedCircuitCallingAddress, x25OperResetTimer=x25OperResetTimer, x25OperRejectTimer=x25OperRejectTimer, x25StatOutCallFailures=x25StatOutCallFailures, x25CircuitInOctets=x25CircuitInOctets, x25AdmnClearTimer=x25AdmnClearTimer, x25AdmnLocalAddress=x25AdmnLocalAddress, x25ClearedCircuitDiagnosticCode=x25ClearedCircuitDiagnosticCode, x25ChannelIndex=x25ChannelIndex, x25AdmnRegistrationRequestTimer=x25AdmnRegistrationRequestTimer, x25ClearedCircuitOutPdus=x25ClearedCircuitOutPdus, x25Restart=x25Restart, x25StatInterruptTimeouts=x25StatInterruptTimeouts, x25OperInterfaceMode=x25OperInterfaceMode, x25AdmnDefCallParamId=x25AdmnDefCallParamId, x25StatDataRxmtTimeouts=x25StatDataRxmtTimeouts, x25StatOutgoingCircuits=x25StatOutgoingCircuits, x25CallParmCalledExt=x25CallParmCalledExt, x25ProtocolVersion=x25ProtocolVersion, x25protocolIso8208V1989=x25protocolIso8208V1989, x25AdmnEntry=x25AdmnEntry, x25CircuitInterruptTimeouts=x25CircuitInterruptTimeouts, x25CircuitOutOctets=x25CircuitOutOctets, x25ClearedCircuitTimeEstablished=x25ClearedCircuitTimeEstablished, x25protocolCcittV1980=x25protocolCcittV1980, x25StatRestartTimeouts=x25StatRestartTimeouts, x25CircuitCalledDteAddress=x25CircuitCalledDteAddress, x25CallParmIndex=x25CallParmIndex, x25OperRegistrationRequestTimer=x25OperRegistrationRequestTimer, x25StatOutInterrupts=x25StatOutInterrupts, x25ChannelLIC=x25ChannelLIC, x25AdmnRejectCount=x25AdmnRejectCount, x25CallParmTrnstDly=x25CallParmTrnstDly, x25OperDataRxmtCount=x25OperDataRxmtCount, x25StatInInterrupts=x25StatInInterrupts, x25StatIndex=x25StatIndex, x25CallParmPriority=x25CallParmPriority, x25CircuitCallingDteAddress=x25CircuitCallingDteAddress, x25CallParmBcug=x25CallParmBcug, x25OperRestartCount=x25OperRestartCount, x25OperClearCount=x25OperClearCount, x25protocolCcittV1976=x25protocolCcittV1976, x25ClearedCircuitClearFacilities=x25ClearedCircuitClearFacilities, X121Address=X121Address, x25AdmnWindowTimer=x25AdmnWindowTimer, x25StatResetTimeouts=x25StatResetTimeouts, x25StatIncomingCircuits=x25StatIncomingCircuits, x25CallParmCugoa=x25CallParmCugoa, x25OperMaxActiveCircuits=x25OperMaxActiveCircuits, x25CallParmCallingExt=x25CallParmCallingExt, x25Reset=x25Reset, x25ChannelHIC=x25ChannelHIC, x25CircuitStatus=x25CircuitStatus, x25CircuitDirection=x25CircuitDirection, x25ClearedCircuitCalledAddress=x25ClearedCircuitCalledAddress, x25StatClearCountExceededs=x25StatClearCountExceededs, x25AdmnDataRxmtTimer=x25AdmnDataRxmtTimer)
