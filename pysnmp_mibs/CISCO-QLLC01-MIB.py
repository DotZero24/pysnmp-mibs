...
mibBuilder.exportSymbols("CISCO-QLLC01-MIB", qllcLSAdminModulo=qllcLSAdminModulo, qllcLSOperIfIndex=qllcLSOperIfIndex, qllcLSAdminIfIndex=qllcLSAdminIfIndex, qllcLSStatsTable=qllcLSStatsTable, qllcLSStatsXidIn=qllcLSStatsXidIn, qllcLSStatsNumRcvDms=qllcLSStatsNumRcvDms, qllcLSOperEntry=qllcLSOperEntry, qllc=qllc, qllcLSStatsQuenchOff=qllcLSStatsQuenchOff, qllcLSAdminRole=qllcLSAdminRole, PYSNMP_MODULE_ID=snaqllc01, qllcLSStatsIfIndex=qllcLSStatsIfIndex, qllcLSOperLciVcIndex=qllcLSOperLciVcIndex, qllcLSStatsEntry=qllcLSStatsEntry, qllcLSStatsGroup=qllcLSStatsGroup, qllcLSAdminTable=qllcLSAdminTable, qllcLSStatsLciVcIndex=qllcLSStatsLciVcIndex, qllcLSStatsNumSndDiscs=qllcLSStatsNumSndDiscs, qllcLSAdminGroup=qllcLSAdminGroup, IfIndexType=IfIndexType, qllcLSOperCircuitType=qllcLSOperCircuitType, qllcLSAdminX25Add=qllcLSAdminX25Add, qllcLSStatsQuenchOn=qllcLSStatsQuenchOn, qllcLSStatsNumRcvDiscs=qllcLSStatsNumRcvDiscs, qllcMibConformance=qllcMibConformance, qllcLSOperState=qllcLSOperState, qllcLSOperGroup=qllcLSOperGroup, snaqllc01=snaqllc01, qllcLSStatsOutPaks=qllcLSStatsOutPaks, qllcLSStatsTestOut=qllcLSStatsTestOut, qllcLSStatsXidOut=qllcLSStatsXidOut, qllcLSOperModulo=qllcLSOperModulo, qllcLSStatsNumRcvFrmrs=qllcLSStatsNumRcvFrmrs, qllcLSOperTable=qllcLSOperTable, qllcMibCompliance=qllcMibCompliance, qllcLSStatsNumSndDms=qllcLSStatsNumSndDms, qllcLSStatsNumSndQsms=qllcLSStatsNumSndQsms, qllcLSStatsOutBytes=qllcLSStatsOutBytes, qllcLSOperLgX25=qllcLSOperLgX25, qllcLSStatsTestIn=qllcLSStatsTestIn, qllcLSStatsInBytes=qllcLSStatsInBytes, qllcLSAdminLgX25=qllcLSAdminLgX25, qllcLSAdminLciVcIndex=qllcLSAdminLciVcIndex, qllcLSStatsNumRcvQsms=qllcLSStatsNumRcvQsms, qllcLSAdminCircuitType=qllcLSAdminCircuitType, X121Address=X121Address, qllcLSStatsInPaks=qllcLSStatsInPaks, qllcMibGroups=qllcMibGroups, qllcLSAdminEntry=qllcLSAdminEntry, qllcLSStatsNumErrs=qllcLSStatsNumErrs, qllcLSStatsNumDrops=qllcLSStatsNumDrops, qllcLSStatsNumSndFrmrs=qllcLSStatsNumSndFrmrs, qllcMibCompliances=qllcMibCompliances, qllcLSOperX25Add=qllcLSOperX25Add, qllcLSOperRole=qllcLSOperRole)
