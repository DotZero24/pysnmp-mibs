...
mibBuilder.exportSymbols("CISCO-AUTH-FRAMEWORK-MIB", cafPortAuthorizeControl=cafPortAuthorizeControl, CiscoAuthHostMode=CiscoAuthHostMode, cafSessionMethodInfoGroup=cafSessionMethodInfoGroup, cafServerDeadRemainAuthorized=cafServerDeadRemainAuthorized, cafAuthFailNotif=cafAuthFailNotif, cafClientNoRespEventPortEntry=cafClientNoRespEventPortEntry, cafServerEventPortEntry=cafServerEventPortEntry, cafSessionAuthUserName=cafSessionAuthUserName, cafAuthFailedEventPortEntry=cafAuthFailedEventPortEntry, ciscoAuthFrameworkSession=ciscoAuthFrameworkSession, cafAuthFailedAuthorizedVlan=cafAuthFailedAuthorizedVlan, ciscoAuthFrameworkMIBCompliance2=ciscoAuthFrameworkMIBCompliance2, cafAuthFailClientGroup=cafAuthFailClientGroup, cafSessionId=cafSessionId, cafClientNoRespAuthorizedVlan=cafClientNoRespAuthorizedVlan, cafAuthMethodRegTable=cafAuthMethodRegTable, cafServerEventPortTable=cafServerEventPortTable, cafSessionPostureToken=cafSessionPostureToken, cafSecurityViolationNotifEnable=cafSecurityViolationNotifEnable, cafPortReauthInterval=cafPortReauthInterval, cafPortRestartInterval=cafPortRestartInterval, cafPortMethodGroup=cafPortMethodGroup, ciscoAuthFrameworkMIB=ciscoAuthFrameworkMIB, cafServerEventGroup=cafServerEventGroup, cafSecurityViolationClientGroup=cafSecurityViolationClientGroup, ciscoAuthFrameworkMIBCompliance4=ciscoAuthFrameworkMIBCompliance4, ciscoAuthFrameworkSystem=ciscoAuthFrameworkSystem, cafCoABouncePortCommandIgnoreEnabled=cafCoABouncePortCommandIgnoreEnabled, cafSessionEntry=cafSessionEntry, cafSessionDomain=cafSessionDomain, cafSessionGroup=cafSessionGroup, cafAuthMethodRegGroup=cafAuthMethodRegGroup, cafSessionAuthHostMode=cafSessionAuthHostMode, cafAuthFailedEventPortTable=cafAuthFailedEventPortTable, cafServerAliveAction=cafServerAliveAction, cafSecViolationNotifEnableGroup=cafSecViolationNotifEnableGroup, cafClientNoRespEventGroup=cafClientNoRespEventGroup, cafAuthFailNotifGroup=cafAuthFailNotifGroup, ciscoAuthFrwkNotifInfo=ciscoAuthFrwkNotifInfo, cafPortMethodTable=cafPortMethodTable, ciscoAuthFrameworkMIBCompliance3=ciscoAuthFrameworkMIBCompliance3, cafPortReauthEnabled=cafPortReauthEnabled, CiscoAuthControlledDirections=CiscoAuthControlledDirections, cafServerDeadNoActionEnabled=cafServerDeadNoActionEnabled, cafSessionMethod=cafSessionMethod, cafAuthFailNotifEnable=cafAuthFailNotifEnable, cafSessionClientAddress=cafSessionClientAddress, cafSessionVlanGroupName=cafSessionVlanGroupName, cafPortMethodOperExecOrder=cafPortMethodOperExecOrder, cafClientNoRespNoActionEnabled=cafClientNoRespNoActionEnabled, cafAuthFailClient=cafAuthFailClient, cafPortConfigTable=cafPortConfigTable, cafSessionMethodsInfoTable=cafSessionMethodsInfoTable, cafSessionInactivityTimeout=cafSessionInactivityTimeout, cafAuthPortConfigGroup=cafAuthPortConfigGroup, ciscoAuthFrameworkMIBConform=ciscoAuthFrameworkMIBConform, ciscoAuthFrameworkEvent=ciscoAuthFrameworkEvent, cafAuthFailedEventGroup=cafAuthFailedEventGroup, cafSessionStatus=cafSessionStatus, ciscoAuthFrameworkMIBObjects=ciscoAuthFrameworkMIBObjects, cafAuthMethodDefaultExecOrder=cafAuthMethodDefaultExecOrder, cafSecurityViolationClient=cafSecurityViolationClient, cafSessionControlledDirection=cafSessionControlledDirection, ciscoAuthFrameworkMIBGroups=ciscoAuthFrameworkMIBGroups, cafClientNoRespEventPortTable=cafClientNoRespEventPortTable, cafAuthFailedMaxRetry=cafAuthFailedMaxRetry, cafSessionTimeLeft=cafSessionTimeLeft, cafSessionClientMacAddress=cafSessionClientMacAddress, CiscoAuthMethodList=CiscoAuthMethodList, cafAaaNoRespRecoveryDelayGroup=cafAaaNoRespRecoveryDelayGroup, cafCoADisablePortCommandIgnoreEnabled=cafCoADisablePortCommandIgnoreEnabled, PYSNMP_MODULE_ID=ciscoAuthFrameworkMIB, cafSessionReauth=cafSessionReauth, cafSessionCriticalTimeLeft=cafSessionCriticalTimeLeft, cafAuthMethodRegEntry=cafAuthMethodRegEntry, cafCoACommandConfigGroup=cafCoACommandConfigGroup, cafPortAuthHostMode=cafPortAuthHostMode, cafPortFallBackProfile=cafPortFallBackProfile, ciscoAuthFrameworkMIBNotifs=ciscoAuthFrameworkMIBNotifs, cafSessionAuthorizedBy=cafSessionAuthorizedBy, cafServerDeadAuthorizedVlan=cafServerDeadAuthorizedVlan, cafAuthFailedNoActionEnabled=cafAuthFailedNoActionEnabled, cafSessionMethodsInfoEntry=cafSessionMethodsInfoEntry, cafPortMethodAdminExecOrder=cafPortMethodAdminExecOrder, cafPortMethodEntry=cafPortMethodEntry, cafMacMoveMode=cafMacMoveMode, ciscoAuthFrameworkMIBCompliance=ciscoAuthFrameworkMIBCompliance, cafSessionClientFramedIpPool=cafSessionClientFramedIpPool, cafPortMethodAdminPriority=cafPortMethodAdminPriority, cafSessionVlanGroupNameGroup=cafSessionVlanGroupNameGroup, cafSessionAuthVlan=cafSessionAuthVlan, cafSessionClientAddrType=cafSessionClientAddrType, cafSecurityViolationNotif=cafSecurityViolationNotif, cafPortMethodAvailable=cafPortMethodAvailable, cafSessionTimeout=cafSessionTimeout, cafSessionTimeoutAction=cafSessionTimeoutAction, CiscoAuthMethod=CiscoAuthMethod, cafSessionInactivityTimeLeft=cafSessionInactivityTimeLeft, cafSessionMethodState=cafSessionMethodState, cafMacMoveConfigGroup=cafMacMoveConfigGroup, cafSecurityViolationNotifGroup=cafSecurityViolationNotifGroup, cafSessionTable=cafSessionTable, cafAaaNoRespRecoveryDelay=cafAaaNoRespRecoveryDelay, cafAuthFailNotifEnableGroup=cafAuthFailNotifEnableGroup, cafAuthMethodDefaultPriority=cafAuthMethodDefaultPriority, cafAuthMethod=cafAuthMethod, cafPortMethodOperPriority=cafPortMethodOperPriority, cafSessionTerminate=cafSessionTerminate, ciscoAuthFrwkAuthenticator=ciscoAuthFrwkAuthenticator, cafPortControlledDirection=cafPortControlledDirection, cafAuthFailedNextMethodEnabled=cafAuthFailedNextMethodEnabled, cafPortPreAuthOpenAccess=cafPortPreAuthOpenAccess, ciscoAuthFrameworkMIBCompliances=ciscoAuthFrameworkMIBCompliances, cafPortViolationAction=cafPortViolationAction, CiscoAuthControlledPortControl=CiscoAuthControlledPortControl, cafPortConfigEntry=cafPortConfigEntry, ciscoAuthFrwkNotifControl=ciscoAuthFrwkNotifControl, cafPortInactivityTimeout=cafPortInactivityTimeout)
