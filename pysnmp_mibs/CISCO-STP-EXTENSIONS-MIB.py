...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-STP-EXTENSIONS-MIB
...
VlanIndex, vlanTrunkPortEntry, vtpVlanEntry, vtpVlanEditEntry = mibBuilder.importSymbols("CISCO-VTP-MIB", "VlanIndex", "vlanTrunkPortEntry", "vtpVlanEntry", "vtpVlanEditEntry")
...
if mibBuilder.loadTexts: ciscoStpExtensionsMIB.setLastUpdated('201708240000Z')
...
stpxMstInconsistencyTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 82, 1, 3, 2), )
if mibBuilder.loadTexts: stpxMstInconsistencyTable.setStatus('current')
stpxMstInconsistencyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 82, 1, 3, 2, 1), ).setIndexNames((0, "CISCO-STP-EXTENSIONS-MIB", "stpxMstInconsistencyIndex"), (0, "CISCO-STP-EXTENSIONS-MIB", "stpxMstInconsistencyPortIndex"))
if mibBuilder.loadTexts: stpxMstInconsistencyEntry.setStatus('current')
stpxMstInconsistencyIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 82, 1, 3, 2, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535)))
if mibBuilder.loadTexts: stpxMstInconsistencyIndex.setStatus('current')
stpxMstInconsistencyPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 82, 1, 3, 2, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 65535)))
...
mibBuilder.exportSymbols("CISCO-STP-EXTENSIONS-MIB", stpxInconsistencyTable=stpxInconsistencyTable, stpxMSTPortOperLinkType=stpxMSTPortOperLinkType, stpxSMSTGroup=stpxSMSTGroup, stpxNotifications=stpxNotifications, stpxSMSTInstanceCISTIntRootCost=stpxSMSTInstanceCISTIntRootCost, stpxMISTPGroup2=stpxMISTPGroup2, stpxSMSTConfigPreStandardDigest=stpxSMSTConfigPreStandardDigest, stpxSMSTPortIndex=stpxSMSTPortIndex, stpxMIBCompliance7=stpxMIBCompliance7, stpxFastStartGroup=stpxFastStartGroup, stpxLoopGuardGroup2=stpxLoopGuardGroup2, stpxLoopGuardConfigEnabled=stpxLoopGuardConfigEnabled, stpxFastStartOperModeInstIndex=stpxFastStartOperModeInstIndex, stpxRootGuardConfigEntry=stpxRootGuardConfigEntry, stpxMIBCompliances=stpxMIBCompliances, stpxMSTInstanceVlansMapped4k=stpxMSTInstanceVlansMapped4k, stpxSpanningTreeObjects=stpxSpanningTreeObjects, stpxRSTPPortRoleEntry=stpxRSTPPortRoleEntry, stpxPVSTVlanEnable=stpxPVSTVlanEnable, stpxRSTPPortRolePortIndex=stpxRSTPPortRolePortIndex, stpxSMSTRegionRevision=stpxSMSTRegionRevision, stpxLoopGuardConfigMode=stpxLoopGuardConfigMode, stpxSMSTInstanceEditVlansMap1k2k=stpxSMSTInstanceEditVlansMap1k2k, stpx4kVlanGroup=stpx4kVlanGroup, stpxUplinkFastObjects=stpxUplinkFastObjects, stpxLoopGuardConfigTable=stpxLoopGuardConfigTable, stpxSMSTInstanceEditIndex=stpxSMSTInstanceEditIndex, stpxSpanningTreePathCostMode=stpxSpanningTreePathCostMode, stpxMSTInstanceVlansMapped=stpxMSTInstanceVlansMapped, stpxMSTPortEntry=stpxMSTPortEntry, stpxLongPathCostModeGroup=stpxLongPathCostModeGroup, stpxPreferredVlansMap4k=stpxPreferredVlansMap4k, stpxRootGuardGroup=stpxRootGuardGroup, stpxSMSTConfigDigestGroup=stpxSMSTConfigDigestGroup, stpxVlanMISTPInstMapEditInstIndex=stpxVlanMISTPInstMapEditInstIndex, stpxRSTPTransmitHoldCountGroup=stpxRSTPTransmitHoldCountGroup, stpxMISTPInstanceNumber=stpxMISTPInstanceNumber, stpxMSTPortRolePortIndex=stpxMSTPortRolePortIndex, stpxVlanMISTPInstMapEditTable=stpxVlanMISTPInstMapEditTable, stpxFastStartOperMode=stpxFastStartOperMode, stpxNotificationsPrefix=stpxNotificationsPrefix, stpxSMSTPortStatus=stpxSMSTPortStatus, stpxMSTInstanceEditVlansMap=stpxMSTInstanceEditVlansMap, stpxMISTPObjects=stpxMISTPObjects, stpxUplinkStationLearningGenRate=stpxUplinkStationLearningGenRate, stpxPortIndex=stpxPortIndex, stpxLoopInconsistencyNotificationsGroup=stpxLoopInconsistencyNotificationsGroup, stpxMIBCompliance13=stpxMIBCompliance13, stpxFastStartPortTable=stpxFastStartPortTable, stpxRSTPPortRoleValue=stpxRSTPPortRoleValue, stpxSMSTInstanceVlansMapped3k4k=stpxSMSTInstanceVlansMapped3k4k, stpxSMSTPortOperMSTMode=stpxSMSTPortOperMSTMode, stpxLoopGuardConfigEntry=stpxLoopGuardConfigEntry, stpxRootInconsistencyState=stpxRootInconsistencyState, stpxLoopInconsistencyState=stpxLoopInconsistencyState, stpxRPVSTGroup=stpxRPVSTGroup, stpxSMSTPortMSTModeGroup=stpxSMSTPortMSTModeGroup, stpxFastStartPortBpduGuardMode=stpxFastStartPortBpduGuardMode, stpxBackboneFastOutRLQResponsePDUs=stpxBackboneFastOutRLQResponsePDUs, stpxPreferredMISTPInstancesEntry=stpxPreferredMISTPInstancesEntry, stpxMSTInstanceRemainingHopCount=stpxMSTInstanceRemainingHopCount, stpxRSTPPortRoleInstanceIndex=stpxRSTPPortRoleInstanceIndex, stpxMSTGroup3=stpxMSTGroup3, stpxRSTPTransmitHoldCount=stpxRSTPTransmitHoldCount, stpxFastStartObjects=stpxFastStartObjects, stpxSpanningTreeGroup=stpxSpanningTreeGroup, stpxMISTPInstanceTable=stpxMISTPInstanceTable, stpxMSTInstanceEditTable=stpxMSTInstanceEditTable, stpxMIBCompliance3=stpxMIBCompliance3, stpxFastStartGroup3=stpxFastStartGroup3, stpxMSTInstanceTable=stpxMSTInstanceTable, stpxSMSTMaxInstances=stpxSMSTMaxInstances, stpxRSTPPortAdminLinkType=stpxRSTPPortAdminLinkType, stpxRSTPGroup=stpxRSTPGroup, stpxPreferredMSTInstancesMap=stpxPreferredMSTInstancesMap, stpxMISTPInstanceIndex=stpxMISTPInstanceIndex, stpxMSTPortRoleValue=stpxMSTPortRoleValue, stpxSMSTInstanceRemainingHopCount=stpxSMSTInstanceRemainingHopCount, PYSNMP_MODULE_ID=ciscoStpExtensionsMIB, stpxMSTInstanceIndex=stpxMSTInstanceIndex, stpxRPVSTPortStatus=stpxRPVSTPortStatus, stpxRSTPPortOperLinkType=stpxRSTPPortOperLinkType, stpxRootGuardConfigTable=stpxRootGuardConfigTable, stpxUplinkStationLearningFrames=stpxUplinkStationLearningFrames, stpxSMSTInstanceEditRowStatus=stpxSMSTInstanceEditRowStatus, stpxPreferredVlansGroup=stpxPreferredVlansGroup, stpxRootInconsistencyNotificationsGroup=stpxRootInconsistencyNotificationsGroup, stpxPVSTVlanGroup=stpxPVSTVlanGroup, stpxFastStartOperModeGroup=stpxFastStartOperModeGroup, stpxMSTPortAdminLinkType=stpxMSTPortAdminLinkType, stpxVlanMISTPInstMapInstIndex=stpxVlanMISTPInstMapInstIndex, stpxSpanningTreeType=stpxSpanningTreeType, stpxMISTPInstanceEnable=stpxMISTPInstanceEnable, stpxVlanMISTPInstMapEditEntry=stpxVlanMISTPInstMapEditEntry, stpxNotificationEnableGroup=stpxNotificationEnableGroup, stpxMISTPInstanceEntry=stpxMISTPInstanceEntry, stpxRootGuardConfigPortIndex=stpxRootGuardConfigPortIndex, stpxPreferredVlansMap2k=stpxPreferredVlansMap2k, stpxSpanningTreePathCostOperMode=stpxSpanningTreePathCostOperMode, stpxBpduSkewingLastSkewDuration=stpxBpduSkewingLastSkewDuration, stpxMSTInstanceEditEntry=stpxMSTInstanceEditEntry, stpxSMSTRegionEditRevision=stpxSMSTRegionEditRevision, stpxSMSTInstanceIndex=stpxSMSTInstanceIndex, stpxBackboneGroup=stpxBackboneGroup, stpxMSTRegionEditRevision=stpxMSTRegionEditRevision, stpxMSTNotificationGroup=stpxMSTNotificationGroup, stpxMstInconsistencyUpdate=stpxMstInconsistencyUpdate, stpxRPVSTPortTable=stpxRPVSTPortTable, stpxNotificationEnable=stpxNotificationEnable, stpxRSTPPortProtocolMigration=stpxRSTPPortProtocolMigration, stpxMIBCompliance11=stpxMIBCompliance11, stpxSMSTInstanceCISTGroup=stpxSMSTInstanceCISTGroup, stpxBackboneFastInRLQRequestPDUs=stpxBackboneFastInRLQRequestPDUs, stpxInconsistentState=stpxInconsistentState, stpxRootInconsistencyEntry=stpxRootInconsistencyEntry, stpxFastStartPortMode=stpxFastStartPortMode, stpxMSTPortTable=stpxMSTPortTable, stpxLoopInconsistencyUpdate=stpxLoopInconsistencyUpdate, stpxSMSTInstanceEditGroup=stpxSMSTInstanceEditGroup, stpxMSTPortRoleEntry=stpxMSTPortRoleEntry, stpxPVSTVlanIndex=stpxPVSTVlanIndex, stpxMSTGroup=stpxMSTGroup, stpxPreferredVlansMap3k=stpxPreferredVlansMap3k, stpxPreferredMSTInstancesEntry=stpxPreferredMSTInstancesEntry, stpxUplinkGroup=stpxUplinkGroup, stpxInconsistencyUpdate=stpxInconsistencyUpdate, ciscoStpExtensionsMIB=ciscoStpExtensionsMIB, stpxRootInconsistencyIndex=stpxRootInconsistencyIndex, stpxRootInconsistencyPortIndex=stpxRootInconsistencyPortIndex, stpxMSTRegionEditName=stpxMSTRegionEditName, stpxBpduSkewingPortIndex=stpxBpduSkewingPortIndex, stpxPreferredMSTInstancesTable=stpxPreferredMSTInstancesTable, stpxSMSTInstanceCISTRegionalRoot=stpxSMSTInstanceCISTRegionalRoot, stpxLoopInconsistencyEntry=stpxLoopInconsistencyEntry, stpxPathCostOperModeGroup=stpxPathCostOperModeGroup, stpxUplinkFastTransitions=stpxUplinkFastTransitions, stpxSMSTInstanceEntry=stpxSMSTInstanceEntry, stpxSMSTInstanceVlansMapped1k2k=stpxSMSTInstanceVlansMapped1k2k, stpxSMSTMaxHopCount=stpxSMSTMaxHopCount, stpxFastStartGlobalDefaultMode=stpxFastStartGlobalDefaultMode, stpxVlanObjects=stpxVlanObjects, stpxLoopInconsistencyTable=stpxLoopInconsistencyTable, stpxMSTInstanceEntry=stpxMSTInstanceEntry, stpxMSTMaxHopCount=stpxMSTMaxHopCount, stpxMSTInstanceEditIndex=stpxMSTInstanceEditIndex, stpxRSTPPortIndex=stpxRSTPPortIndex, stpxSMSTConfigDigest=stpxSMSTConfigDigest, stpxVlanMISTPInstMapTable=stpxVlanMISTPInstMapTable, stpxMSTRegionEditBufferStatus=stpxMSTRegionEditBufferStatus, stpxMIBCompliance12=stpxMIBCompliance12, stpxBackboneFastObjects=stpxBackboneFastObjects, stpxBpduSkewingTable=stpxBpduSkewingTable, stpxLoopInconsistencyPortIndex=stpxLoopInconsistencyPortIndex, stpxSMSTPortStatusGroup=stpxSMSTPortStatusGroup, StpxMSTConfigurationDigest=StpxMSTConfigurationDigest, stpxRootGuardObjects=stpxRootGuardObjects, stpxMSTPortStatus=stpxMSTPortStatus, stpxRPVSTPortVlanIndex=stpxRPVSTPortVlanIndex, stpxSMSTPortTable=stpxSMSTPortTable, stpxL2GatewayDomainId=stpxL2GatewayDomainId, stpxPVSTVlanTable=stpxPVSTVlanTable, stpxFastStartOperModeEntry=stpxFastStartOperModeEntry, stpxRootInconsistencyTable=stpxRootInconsistencyTable, stpxMSTGroup4=stpxMSTGroup4, stpxMISTPInstanceVlansMapped3k=stpxMISTPInstanceVlansMapped3k, stpxMIBCompliance2=stpxMIBCompliance2, stpxFastStartGroup2=stpxFastStartGroup2, stpxSMSTMaxHopCountGroup=stpxSMSTMaxHopCountGroup, stpxMSTInconsistencyGroup=stpxMSTInconsistencyGroup, stpxMstInconsistencyPortIndex=stpxMstInconsistencyPortIndex, stpxMISTPInstanceVlansMapped2k=stpxMISTPInstanceVlansMapped2k, stpxRSTPPortRoleTable=stpxRSTPPortRoleTable, stpxMIBCompliance4=stpxMIBCompliance4, stpxLoopGuardObjects=stpxLoopGuardObjects, stpxSMSTInstanceGroup=stpxSMSTInstanceGroup, stpxMstInconsistencyIndex=stpxMstInconsistencyIndex, stpxMSTRegionRevision=stpxMSTRegionRevision, stpxPreferredVlansEntry=stpxPreferredVlansEntry, stpxBackboneFastEnabled=stpxBackboneFastEnabled, stpxMSTPortProtocolMigration=stpxMSTPortProtocolMigration, stpxUplinkFastEnabled=stpxUplinkFastEnabled, stpxRootInconsistencyUpdate=stpxRootInconsistencyUpdate, stpxFastStartOperModeTable=stpxFastStartOperModeTable, stpxBackboneGroup2=stpxBackboneGroup2, stpxBpduSkewingInstanceIndex=stpxBpduSkewingInstanceIndex, stpxBackboneFastInRLQResponsePDUs=stpxBackboneFastInRLQResponsePDUs, stpxMSTPortIndex=stpxMSTPortIndex, stpxMIBConformance=stpxMIBConformance, stpxMSTInstanceVlansMapped3k=stpxMSTInstanceVlansMapped3k, stpxLongStpPortPathCostTable=stpxLongStpPortPathCostTable, stpxNotificationsGroup=stpxNotificationsGroup, stpxInconsistencyObjects=stpxInconsistencyObjects, stpxLoopGuardGlobalDefaultMode=stpxLoopGuardGlobalDefaultMode, stpxSMSTInstanceTable=stpxSMSTInstanceTable, stpxMSTRegionEditBufferOperation=stpxMSTRegionEditBufferOperation, stpxFastStartPortBpduFilterMode=stpxFastStartPortBpduFilterMode, stpxMSTInstanceEditVlansMap2k=stpxMSTInstanceEditVlansMap2k, stpxRPVSTPortEntry=stpxRPVSTPortEntry, stpxSMSTPortEntry=stpxSMSTPortEntry, stpxMIBCompliance=stpxMIBCompliance, stpxBackboneFastOutRLQRequestPDUs=stpxBackboneFastOutRLQRequestPDUs, stpxFastStartBpduFilterEnable=stpxFastStartBpduFilterEnable, stpxPVSTVlanEntry=stpxPVSTVlanEntry, stpxRSTPObjects=stpxRSTPObjects, stpxMISTPGroup=stpxMISTPGroup, stpxExtendedSysIDAdminEnabled=stpxExtendedSysIDAdminEnabled, stpxInconsistencyEntry=stpxInconsistencyEntry, stpxBpduSkewingDetectionEnable=stpxBpduSkewingDetectionEnable, stpxSMSTPortAdminHelloTime=stpxSMSTPortAdminHelloTime, stpxRootGuardConfigEnabled=stpxRootGuardConfigEnabled, stpxSstpGroup=stpxSstpGroup, stpxSMSTPortOperHelloTime=stpxSMSTPortOperHelloTime, stpxMstInconsistencyState=stpxMstInconsistencyState, stpxLoopGuardGroup=stpxLoopGuardGroup, stpxL2GatewayObjects=stpxL2GatewayObjects, stpxMSTGroup2=stpxMSTGroup2, stpxL2GatewayDomainIdGroup=stpxL2GatewayDomainIdGroup, stpxSMSTInstanceEditEntry=stpxSMSTInstanceEditEntry, stpxLongStpPortPathCost=stpxLongStpPortPathCost, stpxRSTPPortEntry=stpxRSTPPortEntry, stpxMISTPInstanceVlansMapped=stpxMISTPInstanceVlansMapped, stpxExtendedSysIDGroup=stpxExtendedSysIDGroup, stpxMSTMaxInstanceNumber=stpxMSTMaxInstanceNumber, stpxMIBCompliance6=stpxMIBCompliance6, stpxSMSTPortHelloTimeGroup=stpxSMSTPortHelloTimeGroup, stpxRPVSTPortIndex=stpxRPVSTPortIndex, stpxMSTPortRoleInstanceIndex=stpxMSTPortRoleInstanceIndex, stpxFastStartPortIndex=stpxFastStartPortIndex, stpxPreferredMISTPInstancesTable=stpxPreferredMISTPInstancesTable, stpxMSTInstanceEditVlansMap4k=stpxMSTInstanceEditVlansMap4k, stpxVlanMISTPInstMapEntry=stpxVlanMISTPInstMapEntry, stpxRSTPPortTable=stpxRSTPPortTable, stpxObjects=stpxObjects, stpxVlanIndex=stpxVlanIndex, stpxMIBCompliance5=stpxMIBCompliance5, stpxPreferredVlansMap=stpxPreferredVlansMap, stpxBpduSkewingEntry=stpxBpduSkewingEntry, stpxUplinkFastOperEnabled=stpxUplinkFastOperEnabled, stpxSMSTPortConfigedHelloTime=stpxSMSTPortConfigedHelloTime, stpxSMSTPortAdminMSTMode=stpxSMSTPortAdminMSTMode, stpxMIBCompliance9=stpxMIBCompliance9, stpxFastStartBpduGuardEnable=stpxFastStartBpduGuardEnable, stpxExtendedSysIDOperEnabled=stpxExtendedSysIDOperEnabled, stpxBackboneFastOperEnabled=stpxBackboneFastOperEnabled, stpxBpduSkewingWorstSkewDuration=stpxBpduSkewingWorstSkewDuration, stpxBpduSkewingWorstSkewTime=stpxBpduSkewingWorstSkewTime, stpxSMSTInstanceEditTable=stpxSMSTInstanceEditTable, stpxLongStpPortPathCostEntry=stpxLongStpPortPathCostEntry, stpxRPVSTObjects=stpxRPVSTObjects, stpxMSTRegionName=stpxMSTRegionName, stpxBpduSkewingGroup=stpxBpduSkewingGroup, stpxPreferredMSTInstancesGroup=stpxPreferredMSTInstancesGroup, stpxFastStartOperModePortIndex=stpxFastStartOperModePortIndex, stpxFastStartPortEnable=stpxFastStartPortEnable)
mibBuilder.exportSymbols("CISCO-STP-EXTENSIONS-MIB", stpxMIBCompliance10=stpxMIBCompliance10, stpxMSTPortRoleTable=stpxMSTPortRoleTable, stpxMIBCompliance8=stpxMIBCompliance8, stpxMstInconsistencyTable=stpxMstInconsistencyTable, stpxBackboneFastInInferiorBPDUs=stpxBackboneFastInInferiorBPDUs, stpxMstInconsistencyEntry=stpxMstInconsistencyEntry, stpxMISTPInstanceVlansMapped4k=stpxMISTPInstanceVlansMapped4k, stpxPreferredVlansTable=stpxPreferredVlansTable, stpxMSTObjects=stpxMSTObjects, stpxFastStartPortEntry=stpxFastStartPortEntry, stpxMSTInstanceEditVlansMap3k=stpxMSTInstanceEditVlansMap3k, stpxSMSTMaxInstanceID=stpxSMSTMaxInstanceID, stpxLoopInconsistencyIndex=stpxLoopInconsistencyIndex, stpxMSTInstanceVlansMapped2k=stpxMSTInstanceVlansMapped2k, stpxSMSTObjects=stpxSMSTObjects, stpxUplinkGroup2=stpxUplinkGroup2, stpxBpduSkewingObjects=stpxBpduSkewingObjects, stpxPreferredMISTPInstancesMap=stpxPreferredMISTPInstancesMap, stpxSMSTInstanceEditVlansMap3k4k=stpxSMSTInstanceEditVlansMap3k4k, stpxLoopGuardConfigPortIndex=stpxLoopGuardConfigPortIndex, stpxMIBGroups=stpxMIBGroups)
