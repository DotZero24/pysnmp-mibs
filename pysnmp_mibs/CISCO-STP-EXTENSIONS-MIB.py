...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:56:02 2025
...
vtpVlanEditEntry, VlanIndex, vlanTrunkPortEntry, vtpVlanEntry = mibBuilder.importSymbols("CISCO-VTP-MIB", "vtpVlanEditEntry", "VlanIndex", "vlanTrunkPortEntry", "vtpVlanEntry")
...
mibBuilder.exportSymbols("CISCO-STP-EXTENSIONS-MIB", stpxPVSTVlanEnable=stpxPVSTVlanEnable, stpxMSTPortStatus=stpxMSTPortStatus, stpxSMSTInstanceEditGroup=stpxSMSTInstanceEditGroup, stpxMSTInstanceEditVlansMap2k=stpxMSTInstanceEditVlansMap2k, stpxSMSTInstanceTable=stpxSMSTInstanceTable, stpxRSTPPortRoleTable=stpxRSTPPortRoleTable, stpxExtendedSysIDGroup=stpxExtendedSysIDGroup, stpxBackboneFastObjects=stpxBackboneFastObjects, stpxFastStartOperModeGroup=stpxFastStartOperModeGroup, stpxSMSTPortHelloTimeGroup=stpxSMSTPortHelloTimeGroup, stpxPVSTVlanEntry=stpxPVSTVlanEntry, stpxInconsistencyObjects=stpxInconsistencyObjects, stpxRPVSTPortTable=stpxRPVSTPortTable, stpxSMSTInstanceEditEntry=stpxSMSTInstanceEditEntry, stpxSMSTInstanceEditVlansMap3k4k=stpxSMSTInstanceEditVlansMap3k4k, stpxPreferredMISTPInstancesMap=stpxPreferredMISTPInstancesMap, stpxUplinkFastEnabled=stpxUplinkFastEnabled, stpxSstpGroup=stpxSstpGroup, stpxNotificationEnableGroup=stpxNotificationEnableGroup, stpxVlanMISTPInstMapTable=stpxVlanMISTPInstMapTable, stpxMSTInstanceVlansMapped=stpxMSTInstanceVlansMapped, stpxFastStartOperModePortIndex=stpxFastStartOperModePortIndex, stpxRootInconsistencyState=stpxRootInconsistencyState, stpxLoopGuardGroup=stpxLoopGuardGroup, stpxInconsistentState=stpxInconsistentState, stpxMIBGroups=stpxMIBGroups, stpxSMSTInstanceCISTIntRootCost=stpxSMSTInstanceCISTIntRootCost, stpxMIBCompliance=stpxMIBCompliance, stpxMSTMaxHopCount=stpxMSTMaxHopCount, stpxRSTPPortRoleInstanceIndex=stpxRSTPPortRoleInstanceIndex, stpxLoopGuardGroup2=stpxLoopGuardGroup2, stpxLoopGuardObjects=stpxLoopGuardObjects, stpxBpduSkewingObjects=stpxBpduSkewingObjects, stpxVlanMISTPInstMapEditTable=stpxVlanMISTPInstMapEditTable, stpxMSTInconsistencyGroup=stpxMSTInconsistencyGroup, stpxLoopInconsistencyState=stpxLoopInconsistencyState, stpxLoopInconsistencyUpdate=stpxLoopInconsistencyUpdate, stpxRootGuardGroup=stpxRootGuardGroup, stpxLoopGuardConfigEntry=stpxLoopGuardConfigEntry, stpxMIBCompliance5=stpxMIBCompliance5, stpxBackboneFastInRLQRequestPDUs=stpxBackboneFastInRLQRequestPDUs, stpxSMSTPortTable=stpxSMSTPortTable, stpxPreferredVlansMap2k=stpxPreferredVlansMap2k, stpxMISTPInstanceVlansMapped3k=stpxMISTPInstanceVlansMapped3k, stpxFastStartOperModeInstIndex=stpxFastStartOperModeInstIndex, stpxFastStartOperMode=stpxFastStartOperMode, stpxMSTRegionEditRevision=stpxMSTRegionEditRevision, stpxSMSTInstanceRemainingHopCount=stpxSMSTInstanceRemainingHopCount, stpxLongStpPortPathCost=stpxLongStpPortPathCost, stpxLoopInconsistencyTable=stpxLoopInconsistencyTable, stpxFastStartPortEnable=stpxFastStartPortEnable, stpxLongStpPortPathCostEntry=stpxLongStpPortPathCostEntry, stpxMSTInstanceVlansMapped2k=stpxMSTInstanceVlansMapped2k, stpxSMSTMaxInstances=stpxSMSTMaxInstances, stpxUplinkGroup2=stpxUplinkGroup2, stpxBackboneFastOperEnabled=stpxBackboneFastOperEnabled, stpxPVSTVlanGroup=stpxPVSTVlanGroup, stpxUplinkFastOperEnabled=stpxUplinkFastOperEnabled, stpxSMSTInstanceEditIndex=stpxSMSTInstanceEditIndex, stpxPreferredVlansMap=stpxPreferredVlansMap, stpxL2GatewayDomainIdGroup=stpxL2GatewayDomainIdGroup, stpxSpanningTreeGroup=stpxSpanningTreeGroup, stpxBpduSkewingInstanceIndex=stpxBpduSkewingInstanceIndex, stpxFastStartPortIndex=stpxFastStartPortIndex, stpxPreferredMSTInstancesEntry=stpxPreferredMSTInstancesEntry, stpxRSTPPortTable=stpxRSTPPortTable, stpxSMSTPortIndex=stpxSMSTPortIndex, stpxSMSTObjects=stpxSMSTObjects, stpxMSTPortRoleEntry=stpxMSTPortRoleEntry, stpxFastStartGroup3=stpxFastStartGroup3, stpxSMSTPortEntry=stpxSMSTPortEntry, stpxBpduSkewingEntry=stpxBpduSkewingEntry, stpxMISTPGroup=stpxMISTPGroup, stpxPVSTVlanIndex=stpxPVSTVlanIndex, stpxMSTInstanceEditVlansMap=stpxMSTInstanceEditVlansMap, stpxFastStartBpduGuardEnable=stpxFastStartBpduGuardEnable, stpxBackboneFastOutRLQRequestPDUs=stpxBackboneFastOutRLQRequestPDUs, stpxVlanIndex=stpxVlanIndex, stpxUplinkStationLearningGenRate=stpxUplinkStationLearningGenRate, stpxRootGuardConfigTable=stpxRootGuardConfigTable, stpxPortIndex=stpxPortIndex, stpxSMSTConfigDigest=stpxSMSTConfigDigest, stpxPreferredVlansEntry=stpxPreferredVlansEntry, stpxPVSTVlanTable=stpxPVSTVlanTable, stpxRootInconsistencyIndex=stpxRootInconsistencyIndex, stpxMSTPortRolePortIndex=stpxMSTPortRolePortIndex, stpxSMSTInstanceVlansMapped1k2k=stpxSMSTInstanceVlansMapped1k2k, stpxMSTPortAdminLinkType=stpxMSTPortAdminLinkType, stpxMstInconsistencyEntry=stpxMstInconsistencyEntry, stpxMSTPortProtocolMigration=stpxMSTPortProtocolMigration, stpxMstInconsistencyUpdate=stpxMstInconsistencyUpdate, stpxFastStartGroup=stpxFastStartGroup, stpxMIBCompliance7=stpxMIBCompliance7, stpxFastStartPortTable=stpxFastStartPortTable, stpxSMSTInstanceEntry=stpxSMSTInstanceEntry, stpxExtendedSysIDAdminEnabled=stpxExtendedSysIDAdminEnabled, stpxSMSTPortStatusGroup=stpxSMSTPortStatusGroup, stpxMSTPortTable=stpxMSTPortTable, stpxSpanningTreePathCostMode=stpxSpanningTreePathCostMode, stpxLoopInconsistencyIndex=stpxLoopInconsistencyIndex, stpxSMSTPortStatus=stpxSMSTPortStatus, stpxMSTInstanceVlansMapped3k=stpxMSTInstanceVlansMapped3k, stpxPreferredVlansMap4k=stpxPreferredVlansMap4k, stpxLoopGuardConfigTable=stpxLoopGuardConfigTable, StpxMSTConfigurationDigest=StpxMSTConfigurationDigest, stpxSMSTInstanceEditVlansMap1k2k=stpxSMSTInstanceEditVlansMap1k2k, stpxMIBCompliance8=stpxMIBCompliance8, stpxLongPathCostModeGroup=stpxLongPathCostModeGroup, stpxMSTGroup4=stpxMSTGroup4, stpxMSTInstanceTable=stpxMSTInstanceTable, stpxBpduSkewingWorstSkewDuration=stpxBpduSkewingWorstSkewDuration, stpxBpduSkewingLastSkewDuration=stpxBpduSkewingLastSkewDuration, stpxMSTPortRoleInstanceIndex=stpxMSTPortRoleInstanceIndex, stpxRPVSTPortEntry=stpxRPVSTPortEntry, stpxSMSTMaxHopCount=stpxSMSTMaxHopCount, stpxPreferredMSTInstancesGroup=stpxPreferredMSTInstancesGroup, stpxRootGuardConfigEntry=stpxRootGuardConfigEntry, stpxSMSTPortConfigedHelloTime=stpxSMSTPortConfigedHelloTime, stpxRSTPPortIndex=stpxRSTPPortIndex, stpxMISTPInstanceEnable=stpxMISTPInstanceEnable, stpxMSTGroup3=stpxMSTGroup3, stpxRootInconsistencyUpdate=stpxRootInconsistencyUpdate, stpxMIBCompliance11=stpxMIBCompliance11, stpxRSTPPortRolePortIndex=stpxRSTPPortRolePortIndex, stpxBackboneFastEnabled=stpxBackboneFastEnabled, stpxMISTPInstanceVlansMapped4k=stpxMISTPInstanceVlansMapped4k, stpxMSTInstanceEditEntry=stpxMSTInstanceEditEntry, stpxSMSTPortAdminMSTMode=stpxSMSTPortAdminMSTMode, stpxMIBCompliance2=stpxMIBCompliance2, stpxLoopInconsistencyNotificationsGroup=stpxLoopInconsistencyNotificationsGroup, stpxMSTGroup=stpxMSTGroup, stpxMIBConformance=stpxMIBConformance, stpxMSTPortEntry=stpxMSTPortEntry, stpxLoopGuardConfigMode=stpxLoopGuardConfigMode, stpxVlanObjects=stpxVlanObjects, stpxRPVSTObjects=stpxRPVSTObjects, PYSNMP_MODULE_ID=ciscoStpExtensionsMIB, stpxMSTPortOperLinkType=stpxMSTPortOperLinkType, stpxRPVSTPortStatus=stpxRPVSTPortStatus, stpxSpanningTreePathCostOperMode=stpxSpanningTreePathCostOperMode, stpxMSTInstanceIndex=stpxMSTInstanceIndex, stpxPreferredMISTPInstancesTable=stpxPreferredMISTPInstancesTable, stpxRSTPPortAdminLinkType=stpxRSTPPortAdminLinkType, stpxPreferredVlansGroup=stpxPreferredVlansGroup, stpxMIBCompliance9=stpxMIBCompliance9, stpxPreferredMISTPInstancesEntry=stpxPreferredMISTPInstancesEntry, stpxPreferredMSTInstancesMap=stpxPreferredMSTInstancesMap, stpxUplinkGroup=stpxUplinkGroup, stpxMSTMaxInstanceNumber=stpxMSTMaxInstanceNumber, stpxUplinkFastTransitions=stpxUplinkFastTransitions, stpxMISTPInstanceVlansMapped2k=stpxMISTPInstanceVlansMapped2k, stpxRSTPObjects=stpxRSTPObjects, stpxSMSTInstanceVlansMapped3k4k=stpxSMSTInstanceVlansMapped3k4k, stpxRootGuardObjects=stpxRootGuardObjects, stpxMIBCompliance10=stpxMIBCompliance10, stpxFastStartGroup2=stpxFastStartGroup2, stpxSMSTInstanceEditRowStatus=stpxSMSTInstanceEditRowStatus, stpxFastStartOperModeTable=stpxFastStartOperModeTable, stpxPreferredVlansMap3k=stpxPreferredVlansMap3k, stpxMSTInstanceEntry=stpxMSTInstanceEntry, stpxFastStartBpduFilterEnable=stpxFastStartBpduFilterEnable, stpxRPVSTGroup=stpxRPVSTGroup, stpxSMSTPortMSTModeGroup=stpxSMSTPortMSTModeGroup, stpxMISTPInstanceNumber=stpxMISTPInstanceNumber, stpxRSTPPortEntry=stpxRSTPPortEntry, stpxMIBCompliances=stpxMIBCompliances, stpxMSTGroup2=stpxMSTGroup2, stpxExtendedSysIDOperEnabled=stpxExtendedSysIDOperEnabled, stpxL2GatewayDomainId=stpxL2GatewayDomainId, stpxInconsistencyEntry=stpxInconsistencyEntry, stpxMSTPortIndex=stpxMSTPortIndex, stpxUplinkStationLearningFrames=stpxUplinkStationLearningFrames, stpxRootInconsistencyTable=stpxRootInconsistencyTable, stpxRootGuardConfigPortIndex=stpxRootGuardConfigPortIndex, stpxRSTPPortProtocolMigration=stpxRSTPPortProtocolMigration, stpxMstInconsistencyIndex=stpxMstInconsistencyIndex, stpxSMSTConfigPreStandardDigest=stpxSMSTConfigPreStandardDigest, stpxLoopInconsistencyPortIndex=stpxLoopInconsistencyPortIndex, stpxRootGuardConfigEnabled=stpxRootGuardConfigEnabled, stpxBpduSkewingWorstSkewTime=stpxBpduSkewingWorstSkewTime, stpxBackboneFastInInferiorBPDUs=stpxBackboneFastInInferiorBPDUs, stpxSpanningTreeType=stpxSpanningTreeType, stpxLoopGuardGlobalDefaultMode=stpxLoopGuardGlobalDefaultMode, stpxRPVSTPortVlanIndex=stpxRPVSTPortVlanIndex, stpxMstInconsistencyPortIndex=stpxMstInconsistencyPortIndex, stpxVlanMISTPInstMapInstIndex=stpxVlanMISTPInstMapInstIndex, stpxMSTRegionEditName=stpxMSTRegionEditName, stpxRSTPPortRoleValue=stpxRSTPPortRoleValue, stpxNotificationsPrefix=stpxNotificationsPrefix, ciscoStpExtensionsMIB=ciscoStpExtensionsMIB, stpxBackboneFastInRLQResponsePDUs=stpxBackboneFastInRLQResponsePDUs, stpxSMSTPortAdminHelloTime=stpxSMSTPortAdminHelloTime, stpxSMSTPortOperHelloTime=stpxSMSTPortOperHelloTime, stpxFastStartPortBpduGuardMode=stpxFastStartPortBpduGuardMode, stpxFastStartOperModeEntry=stpxFastStartOperModeEntry, stpxMIBCompliance6=stpxMIBCompliance6, stpxMSTInstanceEditTable=stpxMSTInstanceEditTable, stpxBpduSkewingTable=stpxBpduSkewingTable, stpxMISTPGroup2=stpxMISTPGroup2, stpxMIBCompliance4=stpxMIBCompliance4, stpxBackboneFastOutRLQResponsePDUs=stpxBackboneFastOutRLQResponsePDUs, stpxSMSTPortOperMSTMode=stpxSMSTPortOperMSTMode, stpxMSTPortRoleValue=stpxMSTPortRoleValue, stpxLoopGuardConfigEnabled=stpxLoopGuardConfigEnabled, stpxBpduSkewingDetectionEnable=stpxBpduSkewingDetectionEnable, stpxSMSTInstanceIndex=stpxSMSTInstanceIndex, stpxSMSTInstanceEditTable=stpxSMSTInstanceEditTable, stpxBackboneGroup2=stpxBackboneGroup2, stpxRPVSTPortIndex=stpxRPVSTPortIndex, stpxPreferredMSTInstancesTable=stpxPreferredMSTInstancesTable, stpxBpduSkewingGroup=stpxBpduSkewingGroup, stpxMSTRegionEditBufferOperation=stpxMSTRegionEditBufferOperation, stpxMSTInstanceEditVlansMap4k=stpxMSTInstanceEditVlansMap4k, stpxVlanMISTPInstMapEditInstIndex=stpxVlanMISTPInstMapEditInstIndex, stpxRSTPGroup=stpxRSTPGroup, stpxMstInconsistencyState=stpxMstInconsistencyState, stpxMSTRegionRevision=stpxMSTRegionRevision, stpxRSTPPortRoleEntry=stpxRSTPPortRoleEntry, stpxMISTPInstanceVlansMapped=stpxMISTPInstanceVlansMapped, stpxMISTPInstanceTable=stpxMISTPInstanceTable, stpxSMSTGroup=stpxSMSTGroup, stpxFastStartGlobalDefaultMode=stpxFastStartGlobalDefaultMode, stpxMSTNotificationGroup=stpxMSTNotificationGroup, stpxMISTPInstanceEntry=stpxMISTPInstanceEntry, stpxMSTPortRoleTable=stpxMSTPortRoleTable, stpxMSTInstanceEditIndex=stpxMSTInstanceEditIndex, stpx4kVlanGroup=stpx4kVlanGroup, stpxMSTObjects=stpxMSTObjects, stpxVlanMISTPInstMapEditEntry=stpxVlanMISTPInstMapEditEntry, stpxPreferredVlansTable=stpxPreferredVlansTable, stpxMstInconsistencyTable=stpxMstInconsistencyTable, stpxLongStpPortPathCostTable=stpxLongStpPortPathCostTable, stpxLoopGuardConfigPortIndex=stpxLoopGuardConfigPortIndex, stpxRSTPTransmitHoldCount=stpxRSTPTransmitHoldCount, stpxSMSTRegionRevision=stpxSMSTRegionRevision, stpxMISTPInstanceIndex=stpxMISTPInstanceIndex, stpxFastStartPortEntry=stpxFastStartPortEntry, stpxNotifications=stpxNotifications, stpxFastStartPortMode=stpxFastStartPortMode, stpxMSTInstanceRemainingHopCount=stpxMSTInstanceRemainingHopCount, stpxInconsistencyUpdate=stpxInconsistencyUpdate, stpxMSTInstanceVlansMapped4k=stpxMSTInstanceVlansMapped4k, stpxRootInconsistencyEntry=stpxRootInconsistencyEntry, stpxMISTPObjects=stpxMISTPObjects, stpxBpduSkewingPortIndex=stpxBpduSkewingPortIndex, stpxSMSTInstanceCISTRegionalRoot=stpxSMSTInstanceCISTRegionalRoot, stpxRootInconsistencyPortIndex=stpxRootInconsistencyPortIndex, stpxPathCostOperModeGroup=stpxPathCostOperModeGroup, stpxNotificationsGroup=stpxNotificationsGroup, stpxInconsistencyTable=stpxInconsistencyTable, stpxMSTRegionEditBufferStatus=stpxMSTRegionEditBufferStatus, stpxMSTRegionName=stpxMSTRegionName, stpxUplinkFastObjects=stpxUplinkFastObjects, stpxMIBCompliance12=stpxMIBCompliance12)
mibBuilder.exportSymbols("CISCO-STP-EXTENSIONS-MIB", stpxRSTPPortOperLinkType=stpxRSTPPortOperLinkType, stpxSMSTMaxHopCountGroup=stpxSMSTMaxHopCountGroup, stpxLoopInconsistencyEntry=stpxLoopInconsistencyEntry, stpxFastStartObjects=stpxFastStartObjects, stpxSMSTMaxInstanceID=stpxSMSTMaxInstanceID, stpxObjects=stpxObjects, stpxMSTInstanceEditVlansMap3k=stpxMSTInstanceEditVlansMap3k, stpxMIBCompliance3=stpxMIBCompliance3, stpxFastStartPortBpduFilterMode=stpxFastStartPortBpduFilterMode, stpxMIBCompliance13=stpxMIBCompliance13, stpxL2GatewayObjects=stpxL2GatewayObjects, stpxSMSTInstanceGroup=stpxSMSTInstanceGroup, stpxSMSTRegionEditRevision=stpxSMSTRegionEditRevision, stpxNotificationEnable=stpxNotificationEnable, stpxSpanningTreeObjects=stpxSpanningTreeObjects, stpxRSTPTransmitHoldCountGroup=stpxRSTPTransmitHoldCountGroup, stpxSMSTInstanceCISTGroup=stpxSMSTInstanceCISTGroup, stpxBackboneGroup=stpxBackboneGroup, stpxRootInconsistencyNotificationsGroup=stpxRootInconsistencyNotificationsGroup, stpxSMSTConfigDigestGroup=stpxSMSTConfigDigestGroup, stpxVlanMISTPInstMapEntry=stpxVlanMISTPInstMapEntry)
