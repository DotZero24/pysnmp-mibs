...
CyanOpStateTc, CyanOpStateQualTc, CyanTimezoneTc, CyanEnDisabledTc, CyanNationalizationTc, CyanAdminStateTc, CyanSecServiceStateTc = mibBuilder.importSymbols("CYAN-TC-MIB", "CyanOpStateTc", "CyanOpStateQualTc", "CyanTimezoneTc", "CyanEnDisabledTc", "CyanNationalizationTc", "CyanAdminStateTc", "CyanSecServiceStateTc")
...
mibBuilder.exportSymbols("CYAN-NODE-MIB", cyanNodeMacBlockSize=cyanNodeMacBlockSize, cyanNodeMibObjects=cyanNodeMibObjects, cyanNodeOssLabel=cyanNodeOssLabel, cyanNodeOperState=cyanNodeOperState, cyanNodeStreet=cyanNodeStreet, cyanNodeLongitude=cyanNodeLongitude, cyanNodePartNumber=cyanNodePartNumber, cyanNodeMfgModuleId=cyanNodeMfgModuleId, cyanNodeAssetTag=cyanNodeAssetTag, cyanNodeAdminState=cyanNodeAdminState, cyanNodeRelayRack=cyanNodeRelayRack, PYSNMP_MODULE_ID=cyanNodeModule, cyanNodeCurrentTimeZone=cyanNodeCurrentTimeZone, cyanNodeMfgCleiCode=cyanNodeMfgCleiCode, cyanNodeIdentifier=cyanNodeIdentifier, cyanNodePostalCode=cyanNodePostalCode, cyanNodeNodeId=cyanNodeNodeId, cyanNodeOwner=cyanNodeOwner, cyanNodeRegion=cyanNodeRegion, cyanNodeName=cyanNodeName, cyanNodeCity=cyanNodeCity, cyanNodeOperStateQual=cyanNodeOperStateQual, cyanNodeSecServState=cyanNodeSecServState, cyanNodeLatitude=cyanNodeLatitude, cyanNodeRackUnits=cyanNodeRackUnits, cyanNodeObjectGroup=cyanNodeObjectGroup, cyanNodeCompliance=cyanNodeCompliance, cyanNodeMfgEciCode=cyanNodeMfgEciCode, cyanNodeDescription=cyanNodeDescription, cyanNodeType=cyanNodeType, cyanNodeMfgSerialNumber=cyanNodeMfgSerialNumber, cyanNodeBay=cyanNodeBay, cyanNodeDhcpOnConsolePort=cyanNodeDhcpOnConsolePort, cyanNodeMfgPartNumber=cyanNodeMfgPartNumber, cyanNodeMfgRevision=cyanNodeMfgRevision, cyanNodeNationalization=cyanNodeNationalization, cyanNodeCountry=cyanNodeCountry, cyanNodeOidClass=cyanNodeOidClass, cyanNodeModule=cyanNodeModule, cyanNodeBaseMacAddress=cyanNodeBaseMacAddress)
