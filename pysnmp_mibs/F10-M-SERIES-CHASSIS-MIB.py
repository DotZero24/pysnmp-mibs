...
F10ChassisType, F10ProcessorModuleType, F10MSeriesPortType, F10HundredthdB, F10MfgDate, F10SwDate = mibBuilder.importSymbols("FORCE10-TC", "F10ChassisType", "F10ProcessorModuleType", "F10MSeriesPortType", "F10HundredthdB", "F10MfgDate", "F10SwDate")
...
mibBuilder.exportSymbols("F10-M-SERIES-CHASSIS-MIB", chAlarmStackUnitCodeMismatch=chAlarmStackUnitCodeMismatch, chSysSwBackupBootImgStatus=chSysSwBackupBootImgStatus, chStackUnitEntry=chStackUnitEntry, chStackUnitCpuUtil5Sec=chStackUnitCpuUtil5Sec, chStackUnitCpuUtil5Min=chStackUnitCpuUtil5Min, chStackUnitUpTime=chStackUnitUpTime, chStackUnitCpuUtil1Min=chStackUnitCpuUtil1Min, chSysPortEntry=chSysPortEntry, chSysProcessorMemSize=chSysProcessorMemSize, chStackUnitFlashUsageUtil=chStackUnitFlashUsageUtil, chStackUnitCodeVersionInFlash=chStackUnitCodeVersionInFlash, chNumMaxStackableUnits=chNumMaxStackableUnits, chStackUnitNumFanTrays=chStackUnitNumFanTrays, chStackUnitAdmMgmtPreference=chStackUnitAdmMgmtPreference, chStackUnitIndexNext=chStackUnitIndexNext, chStackUnitModelID=chStackUnitModelID, chSysSwModuleTable=chSysSwModuleTable, chStackUnitMacAddress=chStackUnitMacAddress, chStackUnitPiecePartID=chStackUnitPiecePartID, chSysCoresFileName=chSysCoresFileName, chStackUnitPartNum=chStackUnitPartNum, chStackUnitNum40GigEtherPorts=chStackUnitNum40GigEtherPorts, chSysSwCurrentBootImgDate=chSysSwCurrentBootImgDate, chSysSwCurrentBootImage=chSysSwCurrentBootImage, chStackUnitSID=chStackUnitSID, chSysStackPortLinkSpeed=chSysStackPortLinkSpeed, chSysSwNextRebootImage=chSysSwNextRebootImage, chStackUnitSysType=chStackUnitSysType, chAlarmObjects=chAlarmObjects, chSysSwModuleEntry=chSysSwModuleEntry, chSysPortIndex=chSysPortIndex, f10mSeriesNotificationGroup=f10mSeriesNotificationGroup, chSysPowerSupplyTable=chSysPowerSupplyTable, chSysStackPortTxDataRate=chSysStackPortTxDataRate, chSysStackPortRunningMode=chSysStackPortRunningMode, chSysSwBackupBootImgVersion=chSysSwBackupBootImgVersion, chStackUnitExpressServiceCode=chStackUnitExpressServiceCode, chSysObjects=chSysObjects, PYSNMP_MODULE_ID=f10MSerChassisMib, chObjects=chObjects, chNumStackUnits=chNumStackUnits, f10mSeriesMibGroups=f10mSeriesMibGroups, chStackUnitVendorId=chStackUnitVendorId, chStackUnitNumGigEtherPorts=chStackUnitNumGigEtherPorts, f10mSeriesSystemGroup=f10mSeriesSystemGroup, chSysStackPortRxErrorRate=chSysStackPortRxErrorRate, chSysSwRuntimeImgDate=chSysSwRuntimeImgDate, chSysStackPortEntry=chSysStackPortEntry, chSysFanTrayTable=chSysFanTrayTable, chSysPortXfpRecvTemp=chSysPortXfpRecvTemp, chSysSwInPartitionBImgVers=chSysSwInPartitionBImgVers, chStackUnitTable=chStackUnitTable, chSysStackPortTxErrorRate=chSysStackPortTxErrorRate, chStackUnitTemp=chStackUnitTemp, chStackUnitMgmtStatus=chStackUnitMgmtStatus, chStackUnitCountryCode=chStackUnitCountryCode, chAlarmStackUnitOffline=chAlarmStackUnitOffline, chStackUnitIndex=chStackUnitIndex, chSysSwRuntimeImgVersion=chSysSwRuntimeImgVersion, chSysPowerSupplyType=chSysPowerSupplyType, chSysSwInPartitionAImgVers=chSysSwInPartitionAImgVers, chSysPowerSupplyOperStatus=chSysPowerSupplyOperStatus, chSysPortType=chSysPortType, f10MSerChassisObject=f10MSerChassisObject, chSysPortXfpRecvPower=chSysPortXfpRecvPower, chAlarmMibNotifications=chAlarmMibNotifications, chAlarmStackPortLinkDown=chAlarmStackPortLinkDown, chSysStackPortTable=chSysStackPortTable, chSysCoresTimeCreated=chSysCoresTimeCreated, chAlarmStackUnitDown=chAlarmStackUnitDown, chSysFanTrayEntry=chSysFanTrayEntry, f10MSerChassisMib=f10MSerChassisMib, chSysPortXfpTxPower=chSysPortXfpTxPower, chStackUnitType=chStackUnitType, chSysProcessorNvramSize=chSysProcessorNvramSize, chSysFanTrayOperStatus=chSysFanTrayOperStatus, chStackUnitNumFastEtherPorts=chStackUnitNumFastEtherPorts, chStackUnitSerialNumber=chStackUnitSerialNumber, chSysPortOperStatus=chSysPortOperStatus, chStackUnitProductRev=chStackUnitProductRev, chStackUnitUtilTable=chStackUnitUtilTable, chSysPortTable=chSysPortTable, chSysPowerSupplyIndex=chSysPowerSupplyIndex, chSysStackPortRxTotalErrors=chSysStackPortRxTotalErrors, chStackUnitCpuType=chStackUnitCpuType, chAlarmStackPortLinkUp=chAlarmStackPortLinkUp, chStackUnitServiceTag=chStackUnitServiceTag, chStackUnitMfgDate=chStackUnitMfgDate, chSysCoresInstance=chSysCoresInstance, chSysStackPortTxTotalErrors=chSysStackPortTxTotalErrors, chSysCoresStackUnitNumber=chSysCoresStackUnitNumber, chStackUnitNumPowerSupplies=chStackUnitNumPowerSupplies, chStackUnitMemUsageUtil=chStackUnitMemUsageUtil, chSysStackPortLinkStatus=chSysStackPortLinkStatus, chSysPowerSupplyEntry=chSysPowerSupplyEntry, chSysSwBackupBootImgDate=chSysSwBackupBootImgDate, chSysProcessorEntry=chSysProcessorEntry, chStackUnitNum10GigEtherPorts=chStackUnitNum10GigEtherPorts, chAlarmStackUnitRoleChanged=chAlarmStackUnitRoleChanged, chStackUnitUtilEntry=chStackUnitUtilEntry, chSysSwCoresTable=chSysSwCoresTable, chStackUnitNumPluggableModules=chStackUnitNumPluggableModules, chStackUnitPPIDRevision=chStackUnitPPIDRevision, chSysProcessorTable=chSysProcessorTable, chAlarmStackUnitUp=chAlarmStackUnitUp, chStackUnitProductOrder=chStackUnitProductOrder, chSysCoresEntry=chSysCoresEntry, CodeType=CodeType, chSysProcessorUpTime=chSysProcessorUpTime, chSysStackPortRxDataRate=chSysStackPortRxDataRate, chStackUnitCodeVersion=chStackUnitCodeVersion, chStackUnitRowStatus=chStackUnitRowStatus, chSysPortAdminStatus=chSysPortAdminStatus, chStackUnitHwMgmtPreference=chStackUnitHwMgmtPreference, chStackUnitDescription=chStackUnitDescription, chSysProcessorModule=chSysProcessorModule, chSysSwCurrentBootImgStatus=chSysSwCurrentBootImgStatus, chSysStackPortIndex=chSysStackPortIndex, f10mSeriesComponentGroup=f10mSeriesComponentGroup, chStackUnitStatus=chStackUnitStatus, chSysStackPortConfiguredMode=chSysStackPortConfiguredMode, UnitType=UnitType, chSysSwCurrentBootImgVersion=chSysSwCurrentBootImgVersion, f10mSeriesMibCompliance=f10mSeriesMibCompliance, chStackUnitNumber=chStackUnitNumber, chSysPortIfIndex=chSysPortIfIndex, chAlarmStackUnitReset=chAlarmStackUnitReset, f10mSeriesMibConformance=f10mSeriesMibConformance, chSysFanTrayIndex=chSysFanTrayIndex, f10mSeriesMibCompliances=f10mSeriesMibCompliances, chSysCoresProcess=chSysCoresProcess)
