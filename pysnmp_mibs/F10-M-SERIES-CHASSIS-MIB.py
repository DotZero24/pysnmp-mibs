...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/force10/F10-M-SERIES-CHASSIS-MIB
...
F10HundredthdB, F10ProcessorModuleType, F10MfgDate, F10MSeriesPortType, F10ChassisType, F10SwDate = mibBuilder.importSymbols("FORCE10-TC", "F10HundredthdB", "F10ProcessorModuleType", "F10MfgDate", "F10MSeriesPortType", "F10ChassisType", "F10SwDate")
...
mibBuilder.exportSymbols("F10-M-SERIES-CHASSIS-MIB", chSysPowerSupplyOperStatus=chSysPowerSupplyOperStatus, chSysCoresTimeCreated=chSysCoresTimeCreated, chAlarmStackPortLinkUp=chAlarmStackPortLinkUp, chStackUnitMgmtStatus=chStackUnitMgmtStatus, chSysProcessorNvramSize=chSysProcessorNvramSize, chStackUnitSerialNumber=chStackUnitSerialNumber, chSysPowerSupplyTable=chSysPowerSupplyTable, chSysFanTrayEntry=chSysFanTrayEntry, chStackUnitEntry=chStackUnitEntry, f10mSeriesComponentGroup=f10mSeriesComponentGroup, chSysStackPortRunningMode=chSysStackPortRunningMode, chStackUnitVendorId=chStackUnitVendorId, chSysProcessorEntry=chSysProcessorEntry, chStackUnitSID=chStackUnitSID, chStackUnitCpuType=chStackUnitCpuType, chSysProcessorMemSize=chSysProcessorMemSize, chSysStackPortLinkSpeed=chSysStackPortLinkSpeed, chStackUnitTemp=chStackUnitTemp, chNumStackUnits=chNumStackUnits, chSysSwInPartitionBImgVers=chSysSwInPartitionBImgVers, chSysPortIndex=chSysPortIndex, f10MSerChassisObject=f10MSerChassisObject, chStackUnitCodeVersion=chStackUnitCodeVersion, chStackUnitFlashUsageUtil=chStackUnitFlashUsageUtil, chSysObjects=chSysObjects, chStackUnitDescription=chStackUnitDescription, chNumMaxStackableUnits=chNumMaxStackableUnits, chSysFanTrayOperStatus=chSysFanTrayOperStatus, chSysCoresEntry=chSysCoresEntry, chAlarmStackUnitCodeMismatch=chAlarmStackUnitCodeMismatch, chSysProcessorModule=chSysProcessorModule, chStackUnitUpTime=chStackUnitUpTime, chAlarmStackPortLinkDown=chAlarmStackPortLinkDown, chSysStackPortConfiguredMode=chSysStackPortConfiguredMode, chSysStackPortTxErrorRate=chSysStackPortTxErrorRate, chStackUnitNumPluggableModules=chStackUnitNumPluggableModules, chStackUnitMacAddress=chStackUnitMacAddress, chSysPortIfIndex=chSysPortIfIndex, chSysSwBackupBootImgStatus=chSysSwBackupBootImgStatus, chSysPortTable=chSysPortTable, chSysPortAdminStatus=chSysPortAdminStatus, chSysCoresFileName=chSysCoresFileName, f10MSerChassisMib=f10MSerChassisMib, chAlarmObjects=chAlarmObjects, chStackUnitPPIDRevision=chStackUnitPPIDRevision, chSysStackPortRxDataRate=chSysStackPortRxDataRate, chStackUnitIndex=chStackUnitIndex, chStackUnitAdmMgmtPreference=chStackUnitAdmMgmtPreference, f10mSeriesMibConformance=f10mSeriesMibConformance, f10mSeriesSystemGroup=f10mSeriesSystemGroup, chStackUnitPartNum=chStackUnitPartNum, chSysPortXfpRecvTemp=chSysPortXfpRecvTemp, chStackUnitCpuUtil5Sec=chStackUnitCpuUtil5Sec, chStackUnitCountryCode=chStackUnitCountryCode, chSysSwBackupBootImgDate=chSysSwBackupBootImgDate, chStackUnitMemUsageUtil=chStackUnitMemUsageUtil, chSysSwRuntimeImgDate=chSysSwRuntimeImgDate, chStackUnitExpressServiceCode=chStackUnitExpressServiceCode, chSysSwCoresTable=chSysSwCoresTable, chStackUnitNumFastEtherPorts=chStackUnitNumFastEtherPorts, chSysPortType=chSysPortType, chSysStackPortIndex=chSysStackPortIndex, chSysCoresProcess=chSysCoresProcess, chSysCoresStackUnitNumber=chSysCoresStackUnitNumber, chStackUnitProductOrder=chStackUnitProductOrder, chSysPortOperStatus=chSysPortOperStatus, chSysStackPortEntry=chSysStackPortEntry, chSysPowerSupplyType=chSysPowerSupplyType, chStackUnitRowStatus=chStackUnitRowStatus, f10mSeriesMibCompliances=f10mSeriesMibCompliances, chStackUnitHwMgmtPreference=chStackUnitHwMgmtPreference, chStackUnitType=chStackUnitType, chSysFanTrayTable=chSysFanTrayTable, chSysStackPortRxTotalErrors=chSysStackPortRxTotalErrors, chStackUnitNumFanTrays=chStackUnitNumFanTrays, chStackUnitNum10GigEtherPorts=chStackUnitNum10GigEtherPorts, chSysStackPortTxDataRate=chSysStackPortTxDataRate, chSysPowerSupplyEntry=chSysPowerSupplyEntry, chSysSwCurrentBootImgVersion=chSysSwCurrentBootImgVersion, UnitType=UnitType, chStackUnitProductRev=chStackUnitProductRev, chSysSwCurrentBootImgDate=chSysSwCurrentBootImgDate, chSysPowerSupplyIndex=chSysPowerSupplyIndex, CodeType=CodeType, chAlarmStackUnitReset=chAlarmStackUnitReset, chSysStackPortTable=chSysStackPortTable, chObjects=chObjects, chStackUnitCpuUtil1Min=chStackUnitCpuUtil1Min, chStackUnitMfgDate=chStackUnitMfgDate, chSysSwRuntimeImgVersion=chSysSwRuntimeImgVersion, chStackUnitCpuUtil5Min=chStackUnitCpuUtil5Min, chStackUnitIndexNext=chStackUnitIndexNext, PYSNMP_MODULE_ID=f10MSerChassisMib, chAlarmMibNotifications=chAlarmMibNotifications, chSysSwCurrentBootImage=chSysSwCurrentBootImage, chSysStackPortTxTotalErrors=chSysStackPortTxTotalErrors, chAlarmStackUnitDown=chAlarmStackUnitDown, chStackUnitNumGigEtherPorts=chStackUnitNumGigEtherPorts, chAlarmStackUnitOffline=chAlarmStackUnitOffline, chStackUnitServiceTag=chStackUnitServiceTag, chStackUnitCodeVersionInFlash=chStackUnitCodeVersionInFlash, chStackUnitTable=chStackUnitTable, chSysProcessorTable=chSysProcessorTable, chSysSwModuleEntry=chSysSwModuleEntry, chStackUnitUtilTable=chStackUnitUtilTable, chSysPortXfpRecvPower=chSysPortXfpRecvPower, chSysSwCurrentBootImgStatus=chSysSwCurrentBootImgStatus, chSysPortEntry=chSysPortEntry, chSysSwNextRebootImage=chSysSwNextRebootImage, chSysStackPortLinkStatus=chSysStackPortLinkStatus, chAlarmStackUnitRoleChanged=chAlarmStackUnitRoleChanged, chStackUnitStatus=chStackUnitStatus, chStackUnitNum40GigEtherPorts=chStackUnitNum40GigEtherPorts, chSysStackPortRxErrorRate=chSysStackPortRxErrorRate, chSysSwModuleTable=chSysSwModuleTable, chSysProcessorUpTime=chSysProcessorUpTime, chStackUnitModelID=chStackUnitModelID, f10mSeriesMibGroups=f10mSeriesMibGroups, f10mSeriesNotificationGroup=f10mSeriesNotificationGroup, chSysFanTrayIndex=chSysFanTrayIndex, chStackUnitNumPowerSupplies=chStackUnitNumPowerSupplies, chStackUnitNumber=chStackUnitNumber, chStackUnitUtilEntry=chStackUnitUtilEntry, chSysSwBackupBootImgVersion=chSysSwBackupBootImgVersion, f10mSeriesMibCompliance=f10mSeriesMibCompliance, chStackUnitSysType=chStackUnitSysType, chSysSwInPartitionAImgVers=chSysSwInPartitionAImgVers, chSysCoresInstance=chSysCoresInstance, chSysPortXfpTxPower=chSysPortXfpTxPower, chAlarmStackUnitUp=chAlarmStackUnitUp, chStackUnitPiecePartID=chStackUnitPiecePartID)
