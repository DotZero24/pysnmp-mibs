...
systemServicesDate, systemServicesTime = mibBuilder.importSymbols("ALCATEL-ENT1-SYSTEM-MIB", "systemServicesDate", "systemServicesTime")
...
mibBuilder.exportSymbols("ALCATEL-ENT1-LPS-MIB", lpsLearningWindowTime=lpsLearningWindowTime, lpsLearningWindowNoAging=lpsLearningWindowNoAging, alcatelIND1LearnedPortSecurityMIBNotifications=alcatelIND1LearnedPortSecurityMIBNotifications, alcatelIND1LearnedPortSecurityMIBCompliances=alcatelIND1LearnedPortSecurityMIBCompliances, lpsLearningWindowLearnAsStatic=lpsLearningWindowLearnAsStatic, lpsLearningWindowPseudoMacMove=lpsLearningWindowPseudoMacMove, lpsTrapSwitchPort=lpsTrapSwitchPort, alcatelIND1LearnedPortSecurityMIBCompliance=alcatelIND1LearnedPortSecurityMIBCompliance, lpsAgL2MacAddressLearnType=lpsAgL2MacAddressLearnType, learnedPortSecurityAgL2MacAddressEntry=learnedPortSecurityAgL2MacAddressEntry, lpsLearningWindowTimeWithStaticConversion=lpsLearningWindowTimeWithStaticConversion, lpsLearningWindowBootupStatus=lpsLearningWindowBootupStatus, lpsL2MacAddress=lpsL2MacAddress, lpsTrapSwitchName=lpsTrapSwitchName, lpsRowStatus=lpsRowStatus, lpsMaxMacNum=lpsMaxMacNum, alcatelIND1LearnedPortSecurityMIB=alcatelIND1LearnedPortSecurityMIB, lpsLoMacRange=lpsLoMacRange, lpsHiMacRange=lpsHiMacRange, learnedPortSecurityL2MacAddressTable=learnedPortSecurityL2MacAddressTable, lpsViolationOption=lpsViolationOption, lpsTrapIfIndex=lpsTrapIfIndex, lpsL2MacAddressRowStatus=lpsL2MacAddressRowStatus, lpsLearnMac=lpsLearnMac, learnedPortSecurityNotificationGroup=learnedPortSecurityNotificationGroup, learnedPortSecurityGlobalGroup=learnedPortSecurityGlobalGroup, learnedPortSecurityAgL2MacAddressTable=learnedPortSecurityAgL2MacAddressTable, lpsTrapSwitchVlan=lpsTrapSwitchVlan, lpsTrapBridgeMac=lpsTrapBridgeMac, learnedPortSecurityTrapsObjGroup=learnedPortSecurityTrapsObjGroup, lpsTrapViolationType=lpsTrapViolationType, PYSNMP_MODULE_ID=alcatelIND1LearnedPortSecurityMIB, lpsLearningWindowTimeRemaining=lpsLearningWindowTimeRemaining, learnedPortSecurityTrapsGroup=learnedPortSecurityTrapsGroup, lpsL2VlanId=lpsL2VlanId, lpsConvertToStatic=lpsConvertToStatic, alcatelIND1LearnedPortSecurityMIBGroups=alcatelIND1LearnedPortSecurityMIBGroups, lpsViolationTrap=lpsViolationTrap, lpsOperStatus=lpsOperStatus, lpsAgL2MacAddress=lpsAgL2MacAddress, lpsTrapViolatingMac=lpsTrapViolatingMac, learnedPortSecurityL2MacAddressGroup=learnedPortSecurityL2MacAddressGroup, lpsRelease=lpsRelease, alcatelIND1LearnedPortSecurityMIBObjects=alcatelIND1LearnedPortSecurityMIBObjects, lpsTrapSwitchSlice=lpsTrapSwitchSlice, lpsPortUpAfterLearningWindowExpiredTrap=lpsPortUpAfterLearningWindowExpiredTrap, learnedPortSecurityGroup=learnedPortSecurityGroup, lpsMaxFilteredMacNum=lpsMaxFilteredMacNum, lpsAdminStatus=lpsAdminStatus, learnedPortSecurityL2MacAddressEntry=learnedPortSecurityL2MacAddressEntry, lpsAgL2VlanId=lpsAgL2VlanId, alcatelIND1LearnedPortSecurityMIBConformance=alcatelIND1LearnedPortSecurityMIBConformance, lpsAgL2MacAddressRowStatus=lpsAgL2MacAddressRowStatus, lpsTrapsObj=lpsTrapsObj, lpsTrapSwitchIpAddr=lpsTrapSwitchIpAddr, lpsViolatingMac=lpsViolatingMac, lpsL2MacAddressLearnType=lpsL2MacAddressLearnType, lpsLearnTrapThreshold=lpsLearnTrapThreshold, learnedPortSecurityEntry=learnedPortSecurityEntry, learnedPortSecurityTable=learnedPortSecurityTable, learnedPortSecurityGlobGroup=learnedPortSecurityGlobGroup)
