...
mibBuilder.exportSymbols("CIENA-GLOBAL-MIB", cienaGlobalMacAddress=cienaGlobalMacAddress, PYSNMP_MODULE_ID=cienaGlobal, cienaGlobalSeverity=cienaGlobalSeverity, cienaGlobal=cienaGlobal)
