...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hp/HP-SWITCH-BASIC-CONFIG-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:02:58 2025
...
if mibBuilder.loadTexts: hpSwitchBasicConfigMIB.setLastUpdated('201810160000Z')
...
mibBuilder.exportSymbols("HP-SWITCH-BASIC-CONFIG-MIB", hpSwitchChassisLocateTable=hpSwitchChassisLocateTable, hpSwitchBasicConfigGroup4=hpSwitchBasicConfigGroup4, hpSwitchBasicConfigCompliance4=hpSwitchBasicConfigCompliance4, hpSwitchAclLogtimeoutConfig=hpSwitchAclLogtimeoutConfig, hpSwitchSecureModeLevel=hpSwitchSecureModeLevel, hpSwitchModuleInfoEntry=hpSwitchModuleInfoEntry, hpSwitchCdpObjects=hpSwitchCdpObjects, hpSwitchRunningCfgChgObjects=hpSwitchRunningCfgChgObjects, hpSwitchRESTSessionIdleTimeout=hpSwitchRESTSessionIdleTimeout, hpicfPortCopyNameGroup=hpicfPortCopyNameGroup, hpSwitchModuleConfigGroup=hpSwitchModuleConfigGroup, hpicfBridgeFilterName=hpicfBridgeFilterName, hpSwitchIgmpProxyMcastUpperIp=hpSwitchIgmpProxyMcastUpperIp, hpSwitchBasicConfigGroup2=hpSwitchBasicConfigGroup2, hpSwitchBasicConfigCompliance=hpSwitchBasicConfigCompliance, hpSwitchACLConfig=hpSwitchACLConfig, hpSwitchBasicConfigCompliance7=hpSwitchBasicConfigCompliance7, hpSwitchImplicitConfigSave=hpSwitchImplicitConfigSave, hpSwitchRunningCfgChgEventDateAndTime=hpSwitchRunningCfgChgEventDateAndTime, hpSwitchBasicConfigObjects=hpSwitchBasicConfigObjects, hpSwitchModuleConfigTable=hpSwitchModuleConfigTable, hpSwitchBasicNotificationGroups=hpSwitchBasicNotificationGroups, hpSwitchRunningCfgChgGroup=hpSwitchRunningCfgChgGroup, hpSwitchAclIpv4DenyFragmentedTcpHeader=hpSwitchAclIpv4DenyFragmentedTcpHeader, hpSwitchBasicConfigCompliance11=hpSwitchBasicConfigCompliance11, hpSwitchFPModuleConfigType=hpSwitchFPModuleConfigType, hpSwitchRunningConfigChange=hpSwitchRunningConfigChange, hpSwitchBasicConfigCompliance12=hpSwitchBasicConfigCompliance12, PYSNMP_MODULE_ID=hpSwitchBasicConfigMIB, hpSwitchBasicNotificationGroup=hpSwitchBasicNotificationGroup, hpSwitchStartupConfigSourceIPAddr=hpSwitchStartupConfigSourceIPAddr, hpSwitchRunningCfgChgEventTableIndex=hpSwitchRunningCfgChgEventTableIndex, hpSwitchIgmpProxyDomainName=hpSwitchIgmpProxyDomainName, hpSwitchAclIpv6DenyNonClassifiableL4Header=hpSwitchAclIpv6DenyNonClassifiableL4Header, hpSwitchModuleInfoTable=hpSwitchModuleInfoTable, hpSwitchBasicConfigCompliance5=hpSwitchBasicConfigCompliance5, hpSwitchAclGroupingEnableGroup=hpSwitchAclGroupingEnableGroup, hpSwitchFPModuleConfigName=hpSwitchFPModuleConfigName, hpSwitchBasicConfigGroup=hpSwitchBasicConfigGroup, hpSwitchIgnoreUntagMacConfigGroup=hpSwitchIgnoreUntagMacConfigGroup, hpSwitchChassisLocateWhen=hpSwitchChassisLocateWhen, hpSwitchBasicConfigCompliance2=hpSwitchBasicConfigCompliance2, hpSwitchCdpConfigGroup=hpSwitchCdpConfigGroup, hpSwitchModuleConfigModName=hpSwitchModuleConfigModName, hpSwitchBasicConfigCompliance8=hpSwitchBasicConfigCompliance8, hpSwitchIgmpProxyDomainConfigGroup=hpSwitchIgmpProxyDomainConfigGroup, hpSwitchIgmpProxyDomainStatus=hpSwitchIgmpProxyDomainStatus, hpSwitchRunningCfgChgNotifyEnable=hpSwitchRunningCfgChgNotifyEnable, hpSwitchIgmpProxyDomainIp=hpSwitchIgmpProxyDomainIp, hpSwitchCdpPreStdVoiceStatus=hpSwitchCdpPreStdVoiceStatus, hpicfBridgeFilterConfigTable=hpicfBridgeFilterConfigTable, hpSwitchRunningCfgChgEventEntry=hpSwitchRunningCfgChgEventEntry, hpSwitchRunningCfgChgEventMethod=hpSwitchRunningCfgChgEventMethod, hpSwitchStartupConfigNotifyEnable=hpSwitchStartupConfigNotifyEnable, hpSwitchBasicConfigGroups=hpSwitchBasicConfigGroups, hpicfPortCopyNameEntry=hpicfPortCopyNameEntry, hpicfPortCopyNameTable=hpicfPortCopyNameTable, hpSwitchModuleConfigModType=hpSwitchModuleConfigModType, hpSwitchBasicConfigCompliance6=hpSwitchBasicConfigCompliance6, hpSwitchBasicConfigConformance=hpSwitchBasicConfigConformance, hpSwitchCdpPreStdVoiceIfIndex=hpSwitchCdpPreStdVoiceIfIndex, hpSwitchModuleInfoModId=hpSwitchModuleInfoModId, hpicfBridgeFilterConfigGroup=hpicfBridgeFilterConfigGroup, hpSwitchFPModuleGroup=hpSwitchFPModuleGroup, hpSwitchCdpRunMode=hpSwitchCdpRunMode, hpSwitchStartupConfigSeqNum=hpSwitchStartupConfigSeqNum, hpicfPortCopyName=hpicfPortCopyName, hpSwitchRunningCfgChgEventId=hpSwitchRunningCfgChgEventId, hpSwitchDefaultLogon=hpSwitchDefaultLogon, hpSwitchCdpPreStdVoiceTable=hpSwitchCdpPreStdVoiceTable, hpSwitchAliasConfigRowStatus=hpSwitchAliasConfigRowStatus, hpSwitchModuleConfigEntry=hpSwitchModuleConfigEntry, hpSwitchIgmpProxyDomainId=hpSwitchIgmpProxyDomainId, hpSwitchCdpPreStdVoiceEntry=hpSwitchCdpPreStdVoiceEntry, hpSwitchBasicConfigCompliance10=hpSwitchBasicConfigCompliance10, hpSwitchAliasTable=hpSwitchAliasTable, hpSwitchRunningCfgChgEventSourceIPAddrType=hpSwitchRunningCfgChgEventSourceIPAddrType, hpSwitchBasicConfigMIB=hpSwitchBasicConfigMIB, hpSwitchRunningCfgChgEventTable=hpSwitchRunningCfgChgEventTable, hpSwitchStartupConfigSourceIPAddrType=hpSwitchStartupConfigSourceIPAddrType, hpSwitchIgmpProxyMcastLowerIp=hpSwitchIgmpProxyMcastLowerIp, hpSwitchFPModuleConfigTable=hpSwitchFPModuleConfigTable, hpSwitchRESTInterfaceStatus=hpSwitchRESTInterfaceStatus, hpSwitchStartupConfigSourceUsername=hpSwitchStartupConfigSourceUsername, hpSwitchRunningCfgChgEventSourceIPAddr=hpSwitchRunningCfgChgEventSourceIPAddr, hpSwitchAclGroup=hpSwitchAclGroup, hpSwitchBasicConfigCompliance3=hpSwitchBasicConfigCompliance3, hpSwitchModules=hpSwitchModules, hpSwitchAliasEntry=hpSwitchAliasEntry, hpSwitchNotificationObjects=hpSwitchNotificationObjects, hpSwitchRunningCfgChgEventUsername=hpSwitchRunningCfgChgEventUsername, hpSwitchStartupConfigThrottled=hpSwitchStartupConfigThrottled, hpSwitchIgmpProxyDomainConfigTable=hpSwitchIgmpProxyDomainConfigTable, hpSwitchRunningCfgChgEntriesBumped=hpSwitchRunningCfgChgEntriesBumped, hpSwitchAclLogtimeoutGroup=hpSwitchAclLogtimeoutGroup, hpicfBridgeFilterDropPortMask=hpicfBridgeFilterDropPortMask, hpSwitchStartupConfigChangeGroup=hpSwitchStartupConfigChangeGroup, hpSwitchRESTInterfaceGroup=hpSwitchRESTInterfaceGroup, hpSwitchAliasName=hpSwitchAliasName, hpicfBridgeFilterEntryStatus=hpicfBridgeFilterEntryStatus, hpSwitchFPModuleConfigEntry=hpSwitchFPModuleConfigEntry, hpSwitchStartupConfigSource=hpSwitchStartupConfigSource, hpSwitchSaveConfig=hpSwitchSaveConfig, hpicfBridgeFilterConfigEntry=hpicfBridgeFilterConfigEntry, hpSwitchModuleConfigModRemove=hpSwitchModuleConfigModRemove, hpSwitchChassisLocateDuration=hpSwitchChassisLocateDuration, hpSwitchAliasCommand=hpSwitchAliasCommand, hpSwitchIgmpProxyDomainConfigEntry=hpSwitchIgmpProxyDomainConfigEntry, hpSwitchChassisLocateGroup=hpSwitchChassisLocateGroup, hpSwitchAliasGroup=hpSwitchAliasGroup, hpSwitchChassisLocateState=hpSwitchChassisLocateState, hpSwitchCdpPreStdVoiceGroup=hpSwitchCdpPreStdVoiceGroup, hpSwitchAclGroupingEnable=hpSwitchAclGroupingEnable, hpSwitchRunningCfgChgCount=hpSwitchRunningCfgChgCount, hpSwitchControlPlaneProtectionAdminStatus=hpSwitchControlPlaneProtectionAdminStatus, hpSwitchStartupConfigChange=hpSwitchStartupConfigChange, hpSwitchRunningCfgChgLatestDateAndTime=hpSwitchRunningCfgChgLatestDateAndTime, hpSwitchIgnoreUntagMacPortList=hpSwitchIgnoreUntagMacPortList, hpSwitchBasicConfigGroup3=hpSwitchBasicConfigGroup3, hpSwitchFPModules=hpSwitchFPModules, hpSwitchRunningCfgChgTransmitInterval=hpSwitchRunningCfgChgTransmitInterval, hpSwitchWebSupportUrl=hpSwitchWebSupportUrl, hpSwitchModuleGroup=hpSwitchModuleGroup, hpSwitchBasicConfigCompliances=hpSwitchBasicConfigCompliances, hpSwitchModuleInfoModType=hpSwitchModuleInfoModType, hpSwitchChassisLocateEntry=hpSwitchChassisLocateEntry)
