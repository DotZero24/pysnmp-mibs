...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-SWITCH-BASIC-CONFIG-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:38:58 2025
...
_HpSwitchStartupConfigThrottled_Type.__name__ = "TruthValue"
...
_HpSwitchAclGroupingEnable_Type.__name__ = "TruthValue"
...
_HpSwitchChassisLocateDuration_Type.__name__ = "Integer32"
...
_HpSwitchRunningCfgChgTransmitInterval_Type.__name__ = "Unsigned32"
...
hpSwitchBasicConfigCompliance.setObjects(
      *(("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchBasicConfigGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchAliasGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpicfBridgeFilterConfigGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpicfPortCopyNameGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchAclLogtimeoutGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchIgmpProxyDomainConfigGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchChassisLocateGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchModuleGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchBasicNotificationGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchRunningCfgChgGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchStartupConfigChangeGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchAclGroup"))
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance2.setObjects(
    ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchBasicConfigGroup2")
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance3.setObjects(
    ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchBasicConfigGroup3")
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance4.setObjects(
    ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchCdpConfigGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance5.setObjects(
    ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchCdpPreStdVoiceGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance6.setObjects(
    ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchIgnoreUntagMacConfigGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance7.setObjects(
    ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchModuleConfigGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance8.setObjects(
    ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchBasicConfigGroup4")
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance10.setObjects(
    ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchFPModuleGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance11.setObjects(
    ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchRESTInterfaceGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchBasicConfigCompliance12.setObjects(
      *(("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchBasicConfigGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchAliasGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpicfBridgeFilterConfigGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpicfPortCopyNameGroup"),
        ...
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchStartupConfigChangeGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchAclGroup"),
        ("HP-SWITCH-BASIC-CONFIG-MIB", "hpSwitchAclGroupingEnableGroup"))
)
if mibBuilder.loadTexts:
