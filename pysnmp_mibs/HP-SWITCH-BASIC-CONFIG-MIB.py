...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:09:04 2025
...
mibBuilder.exportSymbols("HP-SWITCH-BASIC-CONFIG-MIB", hpSwitchRunningCfgChgEventUsername=hpSwitchRunningCfgChgEventUsername, hpSwitchFPModuleConfigEntry=hpSwitchFPModuleConfigEntry, hpSwitchAclLogtimeoutGroup=hpSwitchAclLogtimeoutGroup, hpSwitchModuleInfoModType=hpSwitchModuleInfoModType, hpSwitchModuleInfoTable=hpSwitchModuleInfoTable, hpSwitchStartupConfigSourceUsername=hpSwitchStartupConfigSourceUsername, hpSwitchBasicConfigGroup=hpSwitchBasicConfigGroup, hpSwitchRESTInterfaceStatus=hpSwitchRESTInterfaceStatus, hpicfBridgeFilterEntryStatus=hpicfBridgeFilterEntryStatus, hpSwitchRunningCfgChgTransmitInterval=hpSwitchRunningCfgChgTransmitInterval, hpSwitchRunningCfgChgEventSourceIPAddrType=hpSwitchRunningCfgChgEventSourceIPAddrType, hpSwitchModuleGroup=hpSwitchModuleGroup, hpSwitchBasicConfigGroups=hpSwitchBasicConfigGroups, hpSwitchModuleConfigModType=hpSwitchModuleConfigModType, hpSwitchCdpObjects=hpSwitchCdpObjects, hpicfPortCopyNameGroup=hpicfPortCopyNameGroup, hpSwitchStartupConfigThrottled=hpSwitchStartupConfigThrottled, hpicfPortCopyNameEntry=hpicfPortCopyNameEntry, hpSwitchRunningCfgChgEventDateAndTime=hpSwitchRunningCfgChgEventDateAndTime, hpSwitchAclLogtimeoutConfig=hpSwitchAclLogtimeoutConfig, hpSwitchModuleConfigEntry=hpSwitchModuleConfigEntry, hpSwitchCdpPreStdVoiceEntry=hpSwitchCdpPreStdVoiceEntry, hpSwitchCdpPreStdVoiceIfIndex=hpSwitchCdpPreStdVoiceIfIndex, hpSwitchBasicConfigCompliance=hpSwitchBasicConfigCompliance, hpSwitchCdpPreStdVoiceGroup=hpSwitchCdpPreStdVoiceGroup, hpSwitchAliasGroup=hpSwitchAliasGroup, hpSwitchImplicitConfigSave=hpSwitchImplicitConfigSave, hpSwitchModuleConfigModRemove=hpSwitchModuleConfigModRemove, hpSwitchIgmpProxyDomainIp=hpSwitchIgmpProxyDomainIp, hpSwitchChassisLocateGroup=hpSwitchChassisLocateGroup, hpSwitchDefaultLogon=hpSwitchDefaultLogon, hpSwitchIgmpProxyDomainName=hpSwitchIgmpProxyDomainName, hpSwitchAliasName=hpSwitchAliasName, hpSwitchControlPlaneProtectionAdminStatus=hpSwitchControlPlaneProtectionAdminStatus, hpSwitchIgmpProxyDomainStatus=hpSwitchIgmpProxyDomainStatus, hpSwitchNotificationObjects=hpSwitchNotificationObjects, hpSwitchChassisLocateTable=hpSwitchChassisLocateTable, hpSwitchModuleConfigModName=hpSwitchModuleConfigModName, hpSwitchAliasConfigRowStatus=hpSwitchAliasConfigRowStatus, hpSwitchIgmpProxyDomainConfigEntry=hpSwitchIgmpProxyDomainConfigEntry, hpSwitchBasicConfigGroup3=hpSwitchBasicConfigGroup3, hpSwitchStartupConfigSeqNum=hpSwitchStartupConfigSeqNum, hpSwitchModuleConfigGroup=hpSwitchModuleConfigGroup, hpSwitchBasicConfigCompliance3=hpSwitchBasicConfigCompliance3, hpicfBridgeFilterConfigGroup=hpicfBridgeFilterConfigGroup, hpSwitchBasicConfigGroup2=hpSwitchBasicConfigGroup2, hpicfPortCopyName=hpicfPortCopyName, hpSwitchCdpPreStdVoiceStatus=hpSwitchCdpPreStdVoiceStatus, hpSwitchIgmpProxyMcastUpperIp=hpSwitchIgmpProxyMcastUpperIp, hpSwitchBasicConfigConformance=hpSwitchBasicConfigConformance, hpSwitchSecureModeLevel=hpSwitchSecureModeLevel, hpSwitchAliasTable=hpSwitchAliasTable, hpSwitchAliasEntry=hpSwitchAliasEntry, hpSwitchACLConfig=hpSwitchACLConfig, hpSwitchIgmpProxyMcastLowerIp=hpSwitchIgmpProxyMcastLowerIp, hpSwitchRunningCfgChgLatestDateAndTime=hpSwitchRunningCfgChgLatestDateAndTime, hpSwitchRunningCfgChgObjects=hpSwitchRunningCfgChgObjects, hpSwitchIgnoreUntagMacConfigGroup=hpSwitchIgnoreUntagMacConfigGroup, hpSwitchCdpPreStdVoiceTable=hpSwitchCdpPreStdVoiceTable, hpSwitchChassisLocateState=hpSwitchChassisLocateState, hpSwitchBasicConfigMIB=hpSwitchBasicConfigMIB, hpSwitchBasicConfigCompliance6=hpSwitchBasicConfigCompliance6, hpSwitchRunningCfgChgCount=hpSwitchRunningCfgChgCount, hpSwitchRESTSessionIdleTimeout=hpSwitchRESTSessionIdleTimeout, hpicfBridgeFilterName=hpicfBridgeFilterName, hpicfBridgeFilterConfigEntry=hpicfBridgeFilterConfigEntry, hpSwitchAclIpv6DenyNonClassifiableL4Header=hpSwitchAclIpv6DenyNonClassifiableL4Header, hpSwitchWebSupportUrl=hpSwitchWebSupportUrl, hpSwitchRunningCfgChgEntriesBumped=hpSwitchRunningCfgChgEntriesBumped, hpSwitchIgmpProxyDomainConfigGroup=hpSwitchIgmpProxyDomainConfigGroup, hpSwitchFPModuleConfigName=hpSwitchFPModuleConfigName, hpSwitchAclIpv4DenyFragmentedTcpHeader=hpSwitchAclIpv4DenyFragmentedTcpHeader, hpSwitchFPModuleConfigTable=hpSwitchFPModuleConfigTable, hpSwitchBasicConfigObjects=hpSwitchBasicConfigObjects, hpSwitchRunningCfgChgEventMethod=hpSwitchRunningCfgChgEventMethod, hpSwitchRunningCfgChgEventSourceIPAddr=hpSwitchRunningCfgChgEventSourceIPAddr, hpSwitchAclGroup=hpSwitchAclGroup, hpSwitchFPModules=hpSwitchFPModules, PYSNMP_MODULE_ID=hpSwitchBasicConfigMIB, hpSwitchAclGroupingEnableGroup=hpSwitchAclGroupingEnableGroup, hpicfBridgeFilterDropPortMask=hpicfBridgeFilterDropPortMask, hpSwitchBasicConfigGroup4=hpSwitchBasicConfigGroup4, hpSwitchBasicConfigCompliance2=hpSwitchBasicConfigCompliance2, hpSwitchIgmpProxyDomainConfigTable=hpSwitchIgmpProxyDomainConfigTable, hpSwitchRunningCfgChgEventEntry=hpSwitchRunningCfgChgEventEntry, hpSwitchStartupConfigChangeGroup=hpSwitchStartupConfigChangeGroup, hpSwitchBasicConfigCompliance11=hpSwitchBasicConfigCompliance11, hpSwitchStartupConfigSourceIPAddrType=hpSwitchStartupConfigSourceIPAddrType, hpSwitchIgmpProxyDomainId=hpSwitchIgmpProxyDomainId, hpSwitchModules=hpSwitchModules, hpSwitchChassisLocateEntry=hpSwitchChassisLocateEntry, hpSwitchChassisLocateWhen=hpSwitchChassisLocateWhen, hpSwitchRESTInterfaceGroup=hpSwitchRESTInterfaceGroup, hpSwitchBasicConfigCompliances=hpSwitchBasicConfigCompliances, hpSwitchRunningConfigChange=hpSwitchRunningConfigChange, hpSwitchBasicConfigCompliance7=hpSwitchBasicConfigCompliance7, hpSwitchStartupConfigSource=hpSwitchStartupConfigSource, hpSwitchRunningCfgChgGroup=hpSwitchRunningCfgChgGroup, hpSwitchModuleInfoEntry=hpSwitchModuleInfoEntry, hpSwitchCdpConfigGroup=hpSwitchCdpConfigGroup, hpSwitchStartupConfigNotifyEnable=hpSwitchStartupConfigNotifyEnable, hpicfBridgeFilterConfigTable=hpicfBridgeFilterConfigTable, hpSwitchModuleConfigTable=hpSwitchModuleConfigTable, hpSwitchRunningCfgChgNotifyEnable=hpSwitchRunningCfgChgNotifyEnable, hpSwitchBasicConfigCompliance12=hpSwitchBasicConfigCompliance12, hpSwitchBasicConfigCompliance8=hpSwitchBasicConfigCompliance8, hpSwitchFPModuleGroup=hpSwitchFPModuleGroup, hpSwitchModuleInfoModId=hpSwitchModuleInfoModId, hpicfPortCopyNameTable=hpicfPortCopyNameTable, hpSwitchCdpRunMode=hpSwitchCdpRunMode, hpSwitchBasicNotificationGroups=hpSwitchBasicNotificationGroups, hpSwitchStartupConfigChange=hpSwitchStartupConfigChange, hpSwitchRunningCfgChgEventId=hpSwitchRunningCfgChgEventId, hpSwitchFPModuleConfigType=hpSwitchFPModuleConfigType, hpSwitchAclGroupingEnable=hpSwitchAclGroupingEnable, hpSwitchRunningCfgChgEventTable=hpSwitchRunningCfgChgEventTable, hpSwitchChassisLocateDuration=hpSwitchChassisLocateDuration, hpSwitchBasicConfigCompliance10=hpSwitchBasicConfigCompliance10, hpSwitchBasicConfigCompliance5=hpSwitchBasicConfigCompliance5, hpSwitchStartupConfigSourceIPAddr=hpSwitchStartupConfigSourceIPAddr, hpSwitchIgnoreUntagMacPortList=hpSwitchIgnoreUntagMacPortList, hpSwitchRunningCfgChgEventTableIndex=hpSwitchRunningCfgChgEventTableIndex, hpSwitchBasicNotificationGroup=hpSwitchBasicNotificationGroup, hpSwitchSaveConfig=hpSwitchSaveConfig, hpSwitchBasicConfigCompliance4=hpSwitchBasicConfigCompliance4, hpSwitchAliasCommand=hpSwitchAliasCommand)
