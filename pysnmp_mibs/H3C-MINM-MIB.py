# SNMP MIB module (H3C-MINM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-MINM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:18:45 2025
...
h3cMinmConnectionEntry.setIndexNames(
    (0, "H3C-VSI-MIB", "h3cVsiIndex"),
    (0, "H3C-MINM-MIB", "h3cMinmConnectionLinkId"),
)
if mibBuilder.loadTexts:
