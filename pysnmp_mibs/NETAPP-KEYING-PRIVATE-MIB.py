# SNMP MIB module (NETAPP-KEYING-PRIVATE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netapp/NETAPP-KEYING-PRIVATE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:07:35 2025
...
agentFeatureKeyingEnableKey = _AgentFeatureKeyingEnableKey_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 24, 1, 1),
...
agentFeatureKeyingDisableKey = _AgentFeatureKeyingDisableKey_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 24, 1, 2),
...
agentFeatureKeyingTable = _AgentFeatureKeyingTable_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 24, 1, 3)
)
if mibBuilder.loadTexts:
...
agentFeatureKeyingEntry = _AgentFeatureKeyingEntry_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 24, 1, 3, 1)
)
agentFeatureKeyingEntry.setIndexNames(
    (0, "NETAPP-KEYING-PRIVATE-MIB", "agentFeatureKeyingIndex"),
)
if mibBuilder.loadTexts:
...
agentFeatureKeyingIndex = _AgentFeatureKeyingIndex_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 24, 1, 3, 1, 1),
...
agentFeatureKeyingName = _AgentFeatureKeyingName_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 24, 1, 3, 1, 2),
...
agentFeatureKeyingStatus = _AgentFeatureKeyingStatus_Object(
    (1, 3, 6, 1, 4, 1, 789, 4413, 1, 1, 24, 1, 3, 1, 3),
