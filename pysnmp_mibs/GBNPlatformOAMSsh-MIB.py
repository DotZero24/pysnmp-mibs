...
sshVersion=_SshVersion_Object((1,3,6,1,4,1,13464,1,2,1,1,11,1),_SshVersion_Type())
...
sshState=_SshState_Object((1,3,6,1,4,1,13464,1,2,1,1,11,2),_SshState_Type())
...
sshKeyAvailable=_SshKeyAvailable_Object((1,3,6,1,4,1,13464,1,2,1,1,11,3),_SshKeyAvailable_Type())
sshKeyAvailable.setMaxAccess(_C)
if mibBuilder.loadTexts:sshKeyAvailable.setStatus(_B)
mibBuilder.exportSymbols('GBNPlatformOAMSsh-MIB',**{'gbnPlatformOAMSsh':gbnPlatformOAMSsh,'sshVersion':sshVersion,'sshState':sshState,'sshKeyAvailable':sshKeyAvailable})