...
mibBuilder.exportSymbols("GBNPlatformOAMSsh-MIB", sshState=sshState, gbnPlatformOAMSsh=gbnPlatformOAMSsh, PYSNMP_MODULE_ID=gbnPlatformOAMSsh, sshVersion=sshVersion, sshKeyAvailable=sshKeyAvailable)
