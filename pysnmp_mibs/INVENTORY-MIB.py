# SNMP MIB module (INVENTORY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/quanta/INVENTORY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:13:10 2025
...
inventory = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13)
)
...
agentInventorySupportedUnitEntry = _AgentInventorySupportedUnitEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 1, 1)
)
agentInventorySupportedUnitEntry.setIndexNames(
    (0, "INVENTORY-MIB", "agentInventorySupportedUnitIndex"),
)
if mibBuilder.loadTexts:
...
agentInventoryUnitEntry = _AgentInventoryUnitEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1)
)
agentInventoryUnitEntry.setIndexNames(
    (0, "INVENTORY-MIB", "agentInventoryUnitNumber"),
)
if mibBuilder.loadTexts:
...
agentInventoryUnitAdminMgmtPrefValue = _AgentInventoryUnitAdminMgmtPrefValue_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 10),
...
agentInventoryUnitStatus = _AgentInventoryUnitStatus_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 11),
...
agentInventoryUnitDetectedCodeVer = _AgentInventoryUnitDetectedCodeVer_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 12),
...
agentInventoryUnitDetectedCodeInFlashVer = _AgentInventoryUnitDetectedCodeInFlashVer_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 13),
...
agentInventoryUnitUpTime = _AgentInventoryUnitUpTime_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 14),
...
agentInventoryUnitDescription = _AgentInventoryUnitDescription_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 15),
...
agentInventoryUnitReplicateSTK = _AgentInventoryUnitReplicateSTK_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 16),
...
agentInventoryUnitReload = _AgentInventoryUnitReload_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 17),
...
agentInventoryUnitRowStatus = _AgentInventoryUnitRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 18),
...
agentInventoryUnitSerialNumber = _AgentInventoryUnitSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 19),
...
agentInventoryUnitImage1Version = _AgentInventoryUnitImage1Version_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 20),
...
agentInventoryUnitImage2Version = _AgentInventoryUnitImage2Version_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 21),
...
agentInventoryUnitSTKname = _AgentInventoryUnitSTKname_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 22),
...
agentInventoryUnitActivateSTK = _AgentInventoryUnitActivateSTK_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 23),
...
agentInventoryUnitDeleteSTK = _AgentInventoryUnitDeleteSTK_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 24),
...
agentInventoryUnitReplicateSTKStatus = _AgentInventoryUnitReplicateSTKStatus_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 25),
...
agentInventoryUnitSFSTransferStatus = _AgentInventoryUnitSFSTransferStatus_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 2, 2, 1, 27),
...
agentInventorySlotEntry = _AgentInventorySlotEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 3, 1, 1)
)
agentInventorySlotEntry.setIndexNames(
    (0, "INVENTORY-MIB", "agentInventoryUnitNumber"),
    (0, "INVENTORY-MIB", "agentInventorySlotNumber"),
)
if mibBuilder.loadTexts:
...
agentInventoryCardTypeEntry = _AgentInventoryCardTypeEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 4, 1, 1)
)
agentInventoryCardTypeEntry.setIndexNames(
    (0, "INVENTORY-MIB", "agentInventoryCardIndex"),
)
if mibBuilder.loadTexts:
...
agentInventoryComponentEntry = _AgentInventoryComponentEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 5, 1, 1)
)
agentInventoryComponentEntry.setIndexNames(
    (0, "INVENTORY-MIB", "agentInventoryComponentIndex"),
)
if mibBuilder.loadTexts:
...
inventoryConformance = _InventoryConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6)
)
_InventoryCompliances_ObjectIdentity = ObjectIdentity
inventoryCompliances = _InventoryCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6, 1)
)
_InventoryGroups_ObjectIdentity = ObjectIdentity
inventoryGroups = _InventoryGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6, 2)
)
...
agentInventoryStackPortEntry = _AgentInventoryStackPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 7, 2, 1)
)
agentInventoryStackPortEntry.setIndexNames(
    (0, "INVENTORY-MIB", "agentInventoryStackPortIndex"),
)
if mibBuilder.loadTexts:
...
agentInventoryStackPortTotalErrors = _AgentInventoryStackPortTotalErrors_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 7, 2, 1, 10),
...
inventorySupportedUnitGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6, 2, 1)
)
inventorySupportedUnitGroup.setObjects(
      *(("INVENTORY-MIB", "agentInventorySupportedUnitIndex"),
        ("INVENTORY-MIB", "agentInventorySupportedUnitModelIdentifier"),
        ("INVENTORY-MIB", "agentInventorySupportedUnitDescription"),
        ("INVENTORY-MIB", "agentInventorySupportedUnitExpectedCodeVer"))
)
if mibBuilder.loadTexts:
    inventorySupportedUnitGroup.setStatus("current")

inventoryUnitGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6, 2, 2)
)
inventoryUnitGroup.setObjects(
      *(("INVENTORY-MIB", "agentInventoryUnitNumber"),
        ("INVENTORY-MIB", "agentInventoryUnitAssignNumber"),
        ("INVENTORY-MIB", "agentInventoryUnitType"),
        ("INVENTORY-MIB", "agentInventoryUnitMgmtAdmin"),
        ("INVENTORY-MIB", "agentInventoryUnitHWMgmtPref"),
        ("INVENTORY-MIB", "agentInventoryUnitAdminMgmtPref"),
        ("INVENTORY-MIB", "agentInventoryUnitStatus"),
        ("INVENTORY-MIB", "agentInventoryUnitDetectedCodeVer"),
        ("INVENTORY-MIB", "agentInventoryUnitDetectedCodeInFlashVer"),
        ("INVENTORY-MIB", "agentInventoryUnitUpTime"),
        ("INVENTORY-MIB", "agentInventoryUnitDescription"),
        ("INVENTORY-MIB", "agentInventoryUnitReplicateSTK"),
        ("INVENTORY-MIB", "agentInventoryUnitRowStatus"),
        ("INVENTORY-MIB", "agentInventoryUnitImage1Version"),
        ("INVENTORY-MIB", "agentInventoryUnitImage2Version"),
        ("INVENTORY-MIB", "agentInventoryUnitSTKname"),
        ("INVENTORY-MIB", "agentInventoryUnitActivateSTK"),
        ("INVENTORY-MIB", "agentInventoryUnitDeleteSTK"),
        ("INVENTORY-MIB", "agentInventoryUnitSTKname"))
)
if mibBuilder.loadTexts:
    inventoryUnitGroup.setStatus("current")

inventorySlotGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6, 2, 3)
)
inventorySlotGroup.setObjects(
      *(("INVENTORY-MIB", "agentInventorySlotNumber"),
        ("INVENTORY-MIB", "agentInventorySlotStatus"),
        ("INVENTORY-MIB", "agentInventorySlotPowerMode"),
        ("INVENTORY-MIB", "agentInventorySlotAdminMode"),
        ("INVENTORY-MIB", "agentInventorySlotInsertedCardType"),
        ("INVENTORY-MIB", "agentInventorySlotConfiguredCardType"))
)
if mibBuilder.loadTexts:
    inventorySlotGroup.setStatus("current")

inventoryCardGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6, 2, 4)
)
inventoryCardGroup.setObjects(
      *(("INVENTORY-MIB", "agentInventoryCardIndex"),
        ("INVENTORY-MIB", "agentInventoryCardType"),
        ("INVENTORY-MIB", "agentInventoryCardModelIdentifier"),
        ("INVENTORY-MIB", "agentInventoryCardDescription"))
)
if mibBuilder.loadTexts:
    inventoryCardGroup.setStatus("current")


# Notification objects

agentInventoryCardMismatch = NotificationType(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 0, 1)
)
...
agentInventoryStackPortLinkUp = NotificationType(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 0, 3)
)
agentInventoryStackPortLinkUp.setObjects(
      *(("INVENTORY-MIB", "agentInventoryStackPortUnit"),
        ("INVENTORY-MIB", "agentInventoryStackPortTag"))
)
if mibBuilder.loadTexts:
...
agentInventorySFSStart = NotificationType(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 0, 5)
)
agentInventorySFSStart.setObjects(
    ("INVENTORY-MIB", "agentInventoryStackUnitNumber")
)
if mibBuilder.loadTexts:
...
inventoryNotificationsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6, 2, 5)
)
inventoryNotificationsGroup.setObjects(
      *(("INVENTORY-MIB", "agentInventoryCardMismatch"),
        ("INVENTORY-MIB", "agentInventoryCardUnsupported"))
)
if mibBuilder.loadTexts:
    inventoryNotificationsGroup.setStatus(
        "current"
    )
...
inventoryCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6, 1, 1)
)
inventoryCompliance.setObjects(
      *(("INVENTORY-MIB", "inventorySlotGroup"),
        ("INVENTORY-MIB", "inventoryCardGroup"),
        ("INVENTORY-MIB", "inventoryCardGroup"),
        ("INVENTORY-MIB", "inventoryUnitGroup"))
)
if mibBuilder.loadTexts:
    inventoryCompliance.setStatus(
        "obsolete"
    )

inventoryCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 7244, 2, 13, 6, 1, 2)
)
inventoryCompliance2.setObjects(
      *(("INVENTORY-MIB", "inventorySlotGroup"),
        ("INVENTORY-MIB", "inventoryCardGroup"),
        ("INVENTORY-MIB", "inventoryCardGroup"),
        ("INVENTORY-MIB", "inventoryUnitGroup"))
...
if mibBuilder.loadTexts:
    inventoryCompliance2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"AgentInventoryUnitPreference": AgentInventoryUnitPreference,
       ...
       "inventoryConformance": inventoryConformance,
       "inventoryCompliances": inventoryCompliances,
       "inventoryCompliance": inventoryCompliance,
       "inventoryCompliance2": inventoryCompliance2,
       "inventoryGroups": inventoryGroups,
       "inventorySupportedUnitGroup": inventorySupportedUnitGroup,
       "inventoryUnitGroup": inventoryUnitGroup,
       "inventorySlotGroup": inventorySlotGroup,
       "inventoryCardGroup": inventoryCardGroup,
       "inventoryNotificationsGroup": inventoryNotificationsGroup,
