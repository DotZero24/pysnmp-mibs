...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-CCM-MIB
...
mibBuilder.exportSymbols("CISCO-CCM-MIB", ccmPhoneFailedIndex=ccmPhoneFailedIndex, ccmPhoneStatusUpdateIndex=ccmPhoneStatusUpdateIndex, ccmVMailDevName=ccmVMailDevName, ccmH323DeviceInfoGroup=ccmH323DeviceInfoGroup, ciscoCcmMIBGroups=ciscoCcmMIBGroups, ccmGatewayRegFailCauseCode=ccmGatewayRegFailCauseCode, CcmDeviceLineStatus=CcmDeviceLineStatus, ccmPhoneInfoGroupRev1=ccmPhoneInfoGroupRev1, ccmPhoneFailedName=ccmPhoneFailedName, ccmInetAddress2=ccmInetAddress2, ccmPhoneStatusUpdateTable=ccmPhoneStatusUpdateTable, ccmPhoneDescription=ccmPhoneDescription, ccmRegisteredCTIDevices=ccmRegisteredCTIDevices, ccmMediaDeviceInfoGroupRev2=ccmMediaDeviceInfoGroupRev2, ccmPhoneStatusReason=ccmPhoneStatusReason, ccmTimeZoneOffset=ccmTimeZoneOffset, ccmNotificationsGroupRev2=ccmNotificationsGroupRev2, ccmRejectedVoiceMailDevices=ccmRejectedVoiceMailDevices, ccmDevicePoolEntry=ccmDevicePoolEntry, ccmClusterId=ccmClusterId, ccmPhoneFailedStorePeriod=ccmPhoneFailedStorePeriod, ccmFailCauseCode=ccmFailCauseCode, ccmH323DevCnfgGKInetAddressType=ccmH323DevCnfgGKInetAddressType, ccmPhoneExtensionEntry=ccmPhoneExtensionEntry, ccmPhoneExtensionInetAddressType=ccmPhoneExtensionInetAddressType, ccmSystemVersion=ccmSystemVersion, ccmMaliciousCall=ccmMaliciousCall, CcmDevFailCauseCode=CcmDevFailCauseCode, ccmMaliCallTime=ccmMaliCallTime, ccmGatewayTimeLastStatusUpdt=ccmGatewayTimeLastStatusUpdt, ccmUnregisteredCTIDevices=ccmUnregisteredCTIDevices, ccmVMailDevTimeLastRegistered=ccmVMailDevTimeLastRegistered, ccmName=ccmName, ccmSIPDeviceInfoGroup=ccmSIPDeviceInfoGroup, ccmRegionPairEntry=ccmRegionPairEntry, ccmH323DeviceInfoGroupRev3=ccmH323DeviceInfoGroupRev3, ccmPhoneStatusUpdateStorePeriod=ccmPhoneStatusUpdateStorePeriod, ccmGatekeeperInetAddress=ccmGatekeeperInetAddress, ccmRegisteredPhones=ccmRegisteredPhones, ccmCTIDeviceInetAddress=ccmCTIDeviceInetAddress, ccmPhoneExtension=ccmPhoneExtension, ciscoCcmMIBObjects=ciscoCcmMIBObjects, ccmProductType=ccmProductType, ccmAlarmSeverity=ccmAlarmSeverity, ccmH323DeviceEntry=ccmH323DeviceEntry, ccmPhoneStatusPhoneIndex=ccmPhoneStatusPhoneIndex, ccmUnregisteredGateways=ccmUnregisteredGateways, ccmVMailDevDescription=ccmVMailDevDescription, ccmVMailDevInetAddress=ccmVMailDevInetAddress, ccmDevicePoolTimeZoneIndex=ccmDevicePoolTimeZoneIndex, ccmCallManagerAlarmEnable=ccmCallManagerAlarmEnable, ccmGatekeeperInetAddressType=ccmGatekeeperInetAddressType, ccmNotificationsInfoGroupRev1=ccmNotificationsInfoGroupRev1, ccmPhoneStatusUpdateAlarmInterv=ccmPhoneStatusUpdateAlarmInterv, CcmDeviceProductId=CcmDeviceProductId, ccmGroupName=ccmGroupName, ccmVMailDevTimeLastStatusUpdt=ccmVMailDevTimeLastStatusUpdt, ccmPhoneInfoGroupRev6=ccmPhoneInfoGroupRev6, ccmH323DevIndex=ccmH323DevIndex, ccmH323TableEntries=ccmH323TableEntries, ccmPhFailedTblLastAddedIndex=ccmPhFailedTblLastAddedIndex, ccmGatewayIndex=ccmGatewayIndex, ciscoCcmMIBConformance=ciscoCcmMIBConformance, ccmGatewayUnregReason=ccmGatewayUnregReason, ccmSIPDevInetAddressIPv4=ccmSIPDevInetAddressIPv4, ccmGatewayAlarmEnable=ccmGatewayAlarmEnable, ccmPhoneExtnInetAddressType=ccmPhoneExtnInetAddressType, ccmMediaDeviceEntry=ccmMediaDeviceEntry, ccmProductCategory=ccmProductCategory, ccmVersion=ccmVersion, ccmGatekeeperName=ccmGatekeeperName, ccmCTIDeviceInetAddressIPv4=ccmCTIDeviceInetAddressIPv4, ccmPhoneInfo=ccmPhoneInfo, ccmMaliCallCallingPartyNumber=ccmMaliCallCallingPartyNumber, ccmH323DevAltGK3InetAddressType=ccmH323DevAltGK3InetAddressType, ccmNotificationsGroupRev3=ccmNotificationsGroupRev3, ccmPhoneUnregReason=ccmPhoneUnregReason, ccmGatewayInetAddress=ccmGatewayInetAddress, CcmDevRegFailCauseCode=CcmDevRegFailCauseCode, ccmRegionTable=ccmRegionTable, ciscoCcmMIB=ciscoCcmMIB, CcmIndexOrZero=CcmIndexOrZero, ccmEntry=ccmEntry, ccmCTIDeviceEntry=ccmCTIDeviceEntry, ccmInstallationId=ccmInstallationId, ccmTable=ccmTable, ccmGatewayTableStateId=ccmGatewayTableStateId, ccmGatewayTrunkName=ccmGatewayTrunkName, ccmPhoneType=ccmPhoneType, ccmH323DevName=ccmH323DevName, ccmPhoneExtnInetAddress=ccmPhoneExtnInetAddress, ccmPhoneStatusUpdate=ccmPhoneStatusUpdate, ccmPhoneInfoGroupRev3=ccmPhoneInfoGroupRev3, ccmDevicePoolName=ccmDevicePoolName, ccmQualityReportAlarmEnable=ccmQualityReportAlarmEnable, ccmPhoneTimeLastRegistered=ccmPhoneTimeLastRegistered, ccmMediaDeviceRegFailReason=ccmMediaDeviceRegFailReason, ccmMediaDeviceIndex=ccmMediaDeviceIndex, ccmH323DevAltGK5InetAddressType=ccmH323DevAltGK5InetAddressType, ccmH323DevStatus=ccmH323DevStatus, ccmRegionSrcIndex=ccmRegionSrcIndex, ccmPhoneFailed=ccmPhoneFailed, ccmCTIDeviceInfoGroupRev4=ccmCTIDeviceInfoGroupRev4, ccmPhoneE911Location=ccmPhoneE911Location, ccmPhoneExtnStatus=ccmPhoneExtnStatus, ccmPhoneExtn=ccmPhoneExtn, ccmCTIDeviceTableStateId=ccmCTIDeviceTableStateId, ccmIndex=ccmIndex, ccmGroupEntry=ccmGroupEntry, ccmCTIDeviceDirNum=ccmCTIDeviceDirNum, ccmGatewayDChannelNumber=ccmGatewayDChannelNumber, ccmH323DevInetAddress=ccmH323DevInetAddress, ccmMaliCallCalledPartyName=ccmMaliCallCalledPartyName, ccmPhoneLoadID=ccmPhoneLoadID, ccmGatewayFailed=ccmGatewayFailed, ccmGatewayTrunkStatus=ccmGatewayTrunkStatus, ccmMediaResourceType=ccmMediaResourceType, ccmMediaDeviceInetAddressType=ccmMediaDeviceInetAddressType, ccmPhoneStatusRegFailReason=ccmPhoneStatusRegFailReason, ccmGeneralInfo=ccmGeneralInfo, ccmSIPDevInetAddress=ccmSIPDevInetAddress, ccmMediaDeviceInfoGroupRev3=ccmMediaDeviceInfoGroupRev3, ccmGatewayProductTypeIndex=ccmGatewayProductTypeIndex, ccmMediaDeviceUnregReason=ccmMediaDeviceUnregReason, ccmPhoneStatus=ccmPhoneStatus, ccmDevicePoolGroupIndex=ccmDevicePoolGroupIndex, ccmCMGroupMappingCMPriority=ccmCMGroupMappingCMPriority, ccmNotificationsGroupRev1=ccmNotificationsGroupRev1, ccmSIPDevInetAddressType=ccmSIPDevInetAddressType, ccmQualityReportAlarmConfigInfo=ccmQualityReportAlarmConfigInfo, ccmSIPDevName=ccmSIPDevName, ccmPhoneIpAddress=ccmPhoneIpAddress, ciscoCcmMIBComplianceRev5=ciscoCcmMIBComplianceRev5, ccmMediaDeviceInetAddressIPv6=ccmMediaDeviceInetAddressIPv6, ccmUnregisteredPhones=ccmUnregisteredPhones, ccmSIPOutTransportProtocolType=ccmSIPOutTransportProtocolType, ciscoCcmMIBComplianceRev2=ciscoCcmMIBComplianceRev2, ciscoCcmMIBCompliances=ciscoCcmMIBCompliances, ccmPhoneFailedInetAddress=ccmPhoneFailedInetAddress, ccmTLSConnectionFailReasonCode=ccmTLSConnectionFailReasonCode, ccmPhoneStatusUpdateReason=ccmPhoneStatusUpdateReason, ccmCTIDeviceDescription=ccmCTIDeviceDescription, ccmH323DeviceInfoGroupRev1=ccmH323DeviceInfoGroupRev1, ccmGatewayTrunkInfo=ccmGatewayTrunkInfo, ccmCTIDeviceInfo=ccmCTIDeviceInfo, ccmPhoneStatusUpdateTime=ccmPhoneStatusUpdateTime, ccmSIPDevIndex=ccmSIPDevIndex, ccmH323DevProductTypeIndex=ccmH323DevProductTypeIndex, ccmProductTypeTable=ccmProductTypeTable, ccmSIPDeviceEntry=ccmSIPDeviceEntry, ccmCTIDeviceTimeLastRegistered=ccmCTIDeviceTimeLastRegistered, ccmH323DevCnfgGKInetAddress=ccmH323DevCnfgGKInetAddress, ccmMaliciousCallAlarmEnable=ccmMaliciousCallAlarmEnable, ccmPhoneTimeLastStatusUpdt=ccmPhoneTimeLastStatusUpdt, ccmH323DevStatusReason=ccmH323DevStatusReason, ccmSIPDeviceInfo=ccmSIPDeviceInfo, ccmH323DevAltGK3InetAddress=ccmH323DevAltGK3InetAddress, ccmH323DevProductId=ccmH323DevProductId, ccmVoiceMailDeviceInfoGroupRev2=ccmVoiceMailDeviceInfoGroupRev2, ccmCTIDeviceTable=ccmCTIDeviceTable, ccmH323DevAltGK4InetAddressType=ccmH323DevAltGK4InetAddressType, CcmDevUnregCauseCode=CcmDevUnregCauseCode, ccmQualityRprtCategory=ccmQualityRprtCategory, ccmInActiveGateways=ccmInActiveGateways, ccmDevicePoolIndex=ccmDevicePoolIndex, ccmH323DevRmtCM3InetAddressType=ccmH323DevRmtCM3InetAddressType, ccmH323DevAltGK5InetAddress=ccmH323DevAltGK5InetAddress, ccmGatewayPhysIfL2Status=ccmGatewayPhysIfL2Status, ccmMediaDeviceTable=ccmMediaDeviceTable, ccmVMailDevInetAddressType=ccmVMailDevInetAddressType, ccmGatewayEntry=ccmGatewayEntry, ccmPhoneFailedInetAddressIPv6=ccmPhoneFailedInetAddressIPv6, ccmProductTypeEntry=ccmProductTypeEntry, ccmRegionIndex=ccmRegionIndex, ccmVoiceMailDeviceInfoGroupRev1=ccmVoiceMailDeviceInfoGroupRev1, ccmGatewayDevicePoolIndex=ccmGatewayDevicePoolIndex, ccmPhoneDevicePoolIndex=ccmPhoneDevicePoolIndex, ccmH323DevUnregReason=ccmH323DevUnregReason, ccmCTIDevicePoolIndex=ccmCTIDevicePoolIndex, ccmH323DevAltGK1InetAddressType=ccmH323DevAltGK1InetAddressType, ccmVMailDevStatusReason=ccmVMailDevStatusReason, ccmMediaDeviceType=ccmMediaDeviceType, ccmPhoneProductTypeIndex=ccmPhoneProductTypeIndex, ccmVMailDevStatus=ccmVMailDevStatus, ccmGatekeeperEntry=ccmGatekeeperEntry, ccmPhoneFailedRegFailReason=ccmPhoneFailedRegFailReason, ccmInfoGroupRev1=ccmInfoGroupRev1, ccmGatewayTrunkTable=ccmGatewayTrunkTable, ccmGroupIndex=ccmGroupIndex, ccmGatewayInfoGroupRev1=ccmGatewayInfoGroupRev1, ccmVMailDevDirNumIndex=ccmVMailDevDirNumIndex, ccmPhoneFailedEntry=ccmPhoneFailedEntry, ccmMIBNotifications=ccmMIBNotifications, ccmInActivePhones=ccmInActivePhones, ccmPhoneInetAddressIPv4=ccmPhoneInetAddressIPv4, ccmPhoneExtensionTableStateId=ccmPhoneExtensionTableStateId, ccmH323DeviceInfoGroupRev2=ccmH323DeviceInfoGroupRev2, ccmMediaDeviceInetAddressIPv4=ccmMediaDeviceInetAddressIPv4, ccmGatewayStatusReason=ccmGatewayStatusReason, ccmVMailDevProductTypeIndex=ccmVMailDevProductTypeIndex, ccmRegionEntry=ccmRegionEntry, ccmH323DevAltGK2InetAddress=ccmH323DevAltGK2InetAddress, ccmNotificationsInfoGroup=ccmNotificationsInfoGroup, ccmCallManagerStartTime=ccmCallManagerStartTime, ccmPhoneExtensionInetAddress=ccmPhoneExtensionInetAddress, ccmH323DevDescription=ccmH323DevDescription, ccmVoiceMailDeviceInfoGroup=ccmVoiceMailDeviceInfoGroup, ccmDescription=ccmDescription, ccmCTIDeviceDirNumIndex=ccmCTIDeviceDirNumIndex, ccmMediaDeviceStatus=ccmMediaDeviceStatus, CcmSIPTransportProtocolType=CcmSIPTransportProtocolType, ccmQualityRprtClusterId=ccmQualityRprtClusterId, ccmGatewayStatus=ccmGatewayStatus, CcmDeviceStatus=CcmDeviceStatus, ccmMediaDeviceInfoGroup=ccmMediaDeviceInfoGroup, ccmActiveGateways=ccmActiveGateways, ccmCTIDeviceUnregReason=ccmCTIDeviceUnregReason, ccmPhoneFailedTable=ccmPhoneFailedTable, ccmRegisteredMediaDevices=ccmRegisteredMediaDevices, ccmGroupTable=ccmGroupTable, ccmPhoneIPv6Attribute=ccmPhoneIPv6Attribute, ccmCTIDeviceInfoGroupRev2=ccmCTIDeviceInfoGroupRev2, ccmGatewayInfoGroup=ccmGatewayInfoGroup, ccmPhoneFailedIPv6Attribute=ccmPhoneFailedIPv6Attribute, ccmCTIDeviceName=ccmCTIDeviceName, ccmTimeZoneName=ccmTimeZoneName, ccmPhoneName=ccmPhoneName, ccmH323DevAltGK4InetAddress=ccmH323DevAltGK4InetAddress, ccmGatekeeperStatus=ccmGatekeeperStatus, ccmQualityReport=ccmQualityReport, ccmCTIDeviceDirNumEntry=ccmCTIDeviceDirNumEntry, ccmUnregisteredVoiceMailDevices=ccmUnregisteredVoiceMailDevices, ciscoCcmMIBCompliance=ciscoCcmMIBCompliance, ccmQualityRprtTime=ccmQualityRprtTime, ccmCTIDeviceInfoGroupRev3=ccmCTIDeviceInfoGroupRev3, ccmMediaDeviceDevicePoolIndex=ccmMediaDeviceDevicePoolIndex, ccmH323DeviceTable=ccmH323DeviceTable, ccmTimeZoneTable=ccmTimeZoneTable, ccmVoiceMailDeviceTable=ccmVoiceMailDeviceTable, ccmSIPDevInetAddressIPv6=ccmSIPDevInetAddressIPv6, ccmPhoneInfoGroupRev5=ccmPhoneInfoGroupRev5, ccmAlarmConfigInfo=ccmAlarmConfigInfo, ccmPhoneUpdates=ccmPhoneUpdates, ccmUnregisteredMediaDevices=ccmUnregisteredMediaDevices, ccmGatewayRegFailReason=ccmGatewayRegFailReason, ccmH323DeviceInfo=ccmH323DeviceInfo, PYSNMP_MODULE_ID=ciscoCcmMIB, ccmVMailDevDirNum=ccmVMailDevDirNum, ccmPhoneLastError=ccmPhoneLastError, ccmPhoneUserName=ccmPhoneUserName, ccmMediaDeviceDescription=ccmMediaDeviceDescription, ccmGatewayType=ccmGatewayType, ccmH323DevInetAddressType=ccmH323DevInetAddressType, ccmPhoneExtensionIpAddress=ccmPhoneExtensionIpAddress)
mibBuilder.exportSymbols("CISCO-CCM-MIB", ccmNotificationsInfo=ccmNotificationsInfo, ccmGatekeeperDescription=ccmGatekeeperDescription, ccmInetAddress2Type=ccmInetAddress2Type, ccmH323DevRegFailReason=ccmH323DevRegFailReason, ccmGatewayTrunkEntry=ccmGatewayTrunkEntry, ccmGatewayProductId=ccmGatewayProductId, ccmMediaResourceListName=ccmMediaResourceListName, ccmVoiceMailDeviceDirNumTable=ccmVoiceMailDeviceDirNumTable, ccmPhoneStatusUpdateType=ccmPhoneStatusUpdateType, ccmSIPInPortNumber=ccmSIPInPortNumber, ccmMaliCallCalledDeviceName=ccmMaliCallCalledDeviceName, ccmNotificationsInfoGroupRev3=ccmNotificationsInfoGroupRev3, ccmNotificationsInfoGroupRev2=ccmNotificationsInfoGroupRev2, ccmNotificationsInfoGroupRev4=ccmNotificationsInfoGroupRev4, ccmMaliCallCallingPartyName=ccmMaliCallCallingPartyName, ccmGatewayDChannelStatus=ccmGatewayDChannelStatus, ccmCTIDeviceStatusReason=ccmCTIDeviceStatusReason, ccmPhoneExtensionTable=ccmPhoneExtensionTable, ccmVMailDevIndex=ccmVMailDevIndex, ccmMediaDeviceTimeLastStatusUpdt=ccmMediaDeviceTimeLastStatusUpdt, ccmH323DevRmtCM2InetAddress=ccmH323DevRmtCM2InetAddress, ccmGatewayInetAddressType=ccmGatewayInetAddressType, ccmGatewayPhysIfIndex=ccmGatewayPhysIfIndex, ccmH323DevTimeLastRegistered=ccmH323DevTimeLastRegistered, ccmRejectedGateways=ccmRejectedGateways, ccmRegionAvailableBandWidth=ccmRegionAvailableBandWidth, ccmVoiceMailDeviceInfo=ccmVoiceMailDeviceInfo, ccmRegisteredGateways=ccmRegisteredGateways, ccmGatewayFailCauseCode=ccmGatewayFailCauseCode, ccmMIBNotificationPrefix=ccmMIBNotificationPrefix, ccmH323DevRmtCM2InetAddressType=ccmH323DevRmtCM2InetAddressType, ccmVMailDevUnregReason=ccmVMailDevUnregReason, ciscoCcmMIBComplianceRev1=ciscoCcmMIBComplianceRev1, ccmGatekeeperInfo=ccmGatekeeperInfo, ccmSIPTableEntries=ccmSIPTableEntries, ccmInfoGroupRev2=ccmInfoGroupRev2, ccmMediaDeviceTimeLastRegistered=ccmMediaDeviceTimeLastRegistered, ciscoCcmMIBComplianceRev4=ciscoCcmMIBComplianceRev4, ccmInfoGroup=ccmInfoGroup, ccmSIPOutPortNumber=ccmSIPOutPortNumber, ccmPhoneRegFailReason=ccmPhoneRegFailReason, ccmPhoneExtnTable=ccmPhoneExtnTable, ccmCTIDeviceType=ccmCTIDeviceType, ccmRegionDestIndex=ccmRegionDestIndex, ccmPhoneExtnIndex=ccmPhoneExtnIndex, ccmCTIDeviceTimeLastStatusUpdt=ccmCTIDeviceTimeLastStatusUpdt, ccmH323DevRmtCM1InetAddressType=ccmH323DevRmtCM1InetAddressType, ccmPhoneTable=ccmPhoneTable, ccmActivePhones=ccmActivePhones, ccmGatewayDescription=ccmGatewayDescription, ccmRejectedCTIDevices=ccmRejectedCTIDevices, ccmPhoneFailures=ccmPhoneFailures, ccmPhoneStatusUpdateEntry=ccmPhoneStatusUpdateEntry, ccmPhoneExtnMultiLines=ccmPhoneExtnMultiLines, ccmPhoneExtensionIndex=ccmPhoneExtensionIndex, ccmCTIDeviceInfoGroup=ccmCTIDeviceInfoGroup, ccmRegionName=ccmRegionName, ccmInfoGroupRev4=ccmInfoGroupRev4, ccmPhoneIndex=ccmPhoneIndex, ccmRejectedMediaDevices=ccmRejectedMediaDevices, CcmIndex=CcmIndex, ccmStatus=ccmStatus, ccmRejectedPhones=ccmRejectedPhones, ccmProductName=ccmProductName, ccmRouteListName=ccmRouteListName, ccmGatewayInfoGroupRev3=ccmGatewayInfoGroupRev3, ccmNotificationsGroup=ccmNotificationsGroup, ccmDevicePoolRegionIndex=ccmDevicePoolRegionIndex, ccmPhoneFailedAlarmInterval=ccmPhoneFailedAlarmInterval, ccmTrunkGatewayIndex=ccmTrunkGatewayIndex, ccmPhoneTimeLastError=ccmPhoneTimeLastError, ccmGatekeeperInfoGroup=ccmGatekeeperInfoGroup, ccmSIPDeviceInfoGroupRev1=ccmSIPDeviceInfoGroupRev1, ccmGatewayTrunkIndex=ccmGatewayTrunkIndex, ccmCTIDeviceInetAddressIPv6=ccmCTIDeviceInetAddressIPv6, ccmInetAddress=ccmInetAddress, ccmVoiceMailDeviceEntry=ccmVoiceMailDeviceEntry, ccmGatekeeperIndex=ccmGatekeeperIndex, ccmProductTypeIndex=ccmProductTypeIndex, ccmH323DevRmtCM1InetAddress=ccmH323DevRmtCM1InetAddress, ccmCTIDeviceInfoGroupRev1=ccmCTIDeviceInfoGroupRev1, ccmPhoneInetAddress=ccmPhoneInetAddress, ccmPhoneInetAddressType=ccmPhoneInetAddressType, ccmCTIDeviceIndex=ccmCTIDeviceIndex, ccmInetAddressType=ccmInetAddressType, ccmPhoneFailedIPv4Attribute=ccmPhoneFailedIPv4Attribute, ccmPhoneInfoGroupRev4=ccmPhoneInfoGroupRev4, ccmMaliCallCalledPartyNumber=ccmMaliCallCalledPartyNumber, ccmDevicePoolTable=ccmDevicePoolTable, ccmSIPDevDescription=ccmSIPDevDescription, ccmMediaResourceListExhausted=ccmMediaResourceListExhausted, ccmGatewayTrunkType=ccmGatewayTrunkType, ccmPhoneFailedMacAddress=ccmPhoneFailedMacAddress, ccmMaliCallCallingDeviceName=ccmMaliCallCallingDeviceName, ccmGroupMappingEntry=ccmGroupMappingEntry, ccmSIPInTransportProtocolType=ccmSIPInTransportProtocolType, ccmQualityRprtReasonCode=ccmQualityRprtReasonCode, ccmRegionPairTable=ccmRegionPairTable, ccmCTIDeviceStatus=ccmCTIDeviceStatus, ccmGlobalInfo=ccmGlobalInfo, ccmMediaDeviceProductTypeIndex=ccmMediaDeviceProductTypeIndex, ccmPhonePhysicalAddress=ccmPhonePhysicalAddress, ccmPhoneInfoGroupRev2=ccmPhoneInfoGroupRev2, ccmPhStatUpdtTblLastAddedIndex=ccmPhStatUpdtTblLastAddedIndex, ccmTLSDevName=ccmTLSDevName, ccmCTIDeviceAppInfo=ccmCTIDeviceAppInfo, ccmPhoneIPv4Attribute=ccmPhoneIPv4Attribute, ccmTimeZoneEntry=ccmTimeZoneEntry, ccmVMailDevRegFailReason=ccmVMailDevRegFailReason, ciscoCcmMIBComplianceRev7=ciscoCcmMIBComplianceRev7, ccmPhoneExtensionMultiLines=ccmPhoneExtensionMultiLines, ccmRegisteredVoiceMailDevices=ccmRegisteredVoiceMailDevices, ccmCTIDeviceProductTypeIndex=ccmCTIDeviceProductTypeIndex, ccmTimeZoneOffsetMinutes=ccmTimeZoneOffsetMinutes, ccmMediaDeviceStatusReason=ccmMediaDeviceStatusReason, ccmGatekeeperTable=ccmGatekeeperTable, ccmSIPDeviceTable=ccmSIPDeviceTable, ccmMediaDeviceInfo=ccmMediaDeviceInfo, ccmTimeZoneOffsetHours=ccmTimeZoneOffsetHours, ccmMediaDeviceInfoGroupRev1=ccmMediaDeviceInfoGroupRev1, ccmTLSDevInetAddressType=ccmTLSDevInetAddressType, ccmPhoneExtnEntry=ccmPhoneExtnEntry, ccmSIPDeviceInfoGroupRev2=ccmSIPDeviceInfoGroupRev2, ccmQualityRprtSourceDevName=ccmQualityRprtSourceDevName, ccmGroupMappingTable=ccmGroupMappingTable, ccmPhoneTableStateId=ccmPhoneTableStateId, ccmGatewayName=ccmGatewayName, ccmH323DevAltGK1InetAddress=ccmH323DevAltGK1InetAddress, ccmPhoneFailedTime=ccmPhoneFailedTime, ccmGatewayInfo=ccmGatewayInfo, ccmTLSConnectionFailure=ccmTLSConnectionFailure, ccmMediaDeviceInetAddress=ccmMediaDeviceInetAddress, ccmCTIDeviceRegFailReason=ccmCTIDeviceRegFailReason, ccmCTIDeviceDirNumTable=ccmCTIDeviceDirNumTable, ccmPhoneFailedInetAddressType=ccmPhoneFailedInetAddressType, ccmCallManagerFailed=ccmCallManagerFailed, ccmPartiallyRegisteredPhones=ccmPartiallyRegisteredPhones, ccmMediaDeviceName=ccmMediaDeviceName, ccmVoiceMailDeviceDirNumEntry=ccmVoiceMailDeviceDirNumEntry, ccmPhoneActiveLoadID=ccmPhoneActiveLoadID, ccmTimeZoneIndex=ccmTimeZoneIndex, ccmPhoneProtocol=ccmPhoneProtocol, ccmGroupTftpDefault=ccmGroupTftpDefault, ccmMediaDeviceInfoGroupRev4=ccmMediaDeviceInfoGroupRev4, ccmPhoneFailCauseCode=ccmPhoneFailCauseCode, ccmPhoneInetAddressIPv6=ccmPhoneInetAddressIPv6, ccmVMailDevProductId=ccmVMailDevProductId, ciscoCcmMIBComplianceRev3=ciscoCcmMIBComplianceRev3, CcmPhoneProtocolType=CcmPhoneProtocolType, ccmPhoneStatusUnregReason=ccmPhoneStatusUnregReason, ccmInfoGroupRev3=ccmInfoGroupRev3, ccmNotificationsInfoGroupRev5=ccmNotificationsInfoGroupRev5, ccmGatewayInfoGroupRev4=ccmGatewayInfoGroupRev4, ccmGatewayTimeLastRegistered=ccmGatewayTimeLastRegistered, ccmPhoneEntry=ccmPhoneEntry, ccmGatewayTable=ccmGatewayTable, ccmGatewayFailedReason=ccmGatewayFailedReason, ccmPhoneFailedInetAddressIPv4=ccmPhoneFailedInetAddressIPv4, ccmCTIDeviceDirNumTableStateId=ccmCTIDeviceDirNumTableStateId, ccmH323DevActGKInetAddressType=ccmH323DevActGKInetAddressType, ccmCTIDeviceInetAddressType=ccmCTIDeviceInetAddressType, ccmPhoneInfoGroup=ccmPhoneInfoGroup, ciscoCcmMIBComplianceRev6=ciscoCcmMIBComplianceRev6, ccmGatewayInfoGroupRev2=ccmGatewayInfoGroupRev2, ccmTLSDevInetAddress=ccmTLSDevInetAddress, ccmPhoneStatusUpdateTableStateId=ccmPhoneStatusUpdateTableStateId, ccmH323DevAltGK2InetAddressType=ccmH323DevAltGK2InetAddressType, ccmGatewayLayer2Change=ccmGatewayLayer2Change, ccmH323DevActGKInetAddress=ccmH323DevActGKInetAddress, ccmTLSConnFailTime=ccmTLSConnFailTime, ccmGatekeeperType=ccmGatekeeperType, ccmRouteListExhausted=ccmRouteListExhausted, ccmH323DevRmtCM3InetAddress=ccmH323DevRmtCM3InetAddress, ccmSIPDevProductTypeIndex=ccmSIPDevProductTypeIndex, ccmH323DevTimeLastStatusUpdt=ccmH323DevTimeLastStatusUpdt, ccmGatekeeperDevicePoolIndex=ccmGatekeeperDevicePoolIndex)
