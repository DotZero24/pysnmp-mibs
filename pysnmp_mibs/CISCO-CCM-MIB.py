...
mibBuilder.exportSymbols("CISCO-CCM-MIB", ccmGatekeeperInetAddress=ccmGatekeeperInetAddress, ccmCTIDeviceInfoGroupRev4=ccmCTIDeviceInfoGroupRev4, ccmRejectedPhones=ccmRejectedPhones, ccmH323DevStatus=ccmH323DevStatus, ccmPhoneExtnInetAddress=ccmPhoneExtnInetAddress, ccmPhoneInetAddressIPv4=ccmPhoneInetAddressIPv4, ccmRegionPairTable=ccmRegionPairTable, ccmCTIDeviceTable=ccmCTIDeviceTable, ccmH323DevActGKInetAddress=ccmH323DevActGKInetAddress, ccmQualityRprtReasonCode=ccmQualityRprtReasonCode, ccmGatewayTrunkName=ccmGatewayTrunkName, ccmH323DevAltGK2InetAddress=ccmH323DevAltGK2InetAddress, ccmCTIDeviceInetAddress=ccmCTIDeviceInetAddress, ccmPhoneFailedEntry=ccmPhoneFailedEntry, ccmCTIDeviceInetAddressType=ccmCTIDeviceInetAddressType, ccmH323DevAltGK4InetAddressType=ccmH323DevAltGK4InetAddressType, ccmSIPOutTransportProtocolType=ccmSIPOutTransportProtocolType, ccmSIPDevInetAddress=ccmSIPDevInetAddress, ccmPhoneIPv6Attribute=ccmPhoneIPv6Attribute, ccmMediaDeviceInfoGroupRev3=ccmMediaDeviceInfoGroupRev3, ccmPhoneFailedIndex=ccmPhoneFailedIndex, ccmGatekeeperInfoGroup=ccmGatekeeperInfoGroup, ciscoCcmMIB=ciscoCcmMIB, ccmSIPDevName=ccmSIPDevName, ccmGatekeeperInetAddressType=ccmGatekeeperInetAddressType, ciscoCcmMIBComplianceRev2=ciscoCcmMIBComplianceRev2, ccmVoiceMailDeviceInfoGroupRev2=ccmVoiceMailDeviceInfoGroupRev2, ccmGatekeeperEntry=ccmGatekeeperEntry, CcmIndexOrZero=CcmIndexOrZero, ccmDescription=ccmDescription, ccmPhoneStatusUnregReason=ccmPhoneStatusUnregReason, ccmQualityRprtTime=ccmQualityRprtTime, ccmMediaDeviceInfoGroupRev2=ccmMediaDeviceInfoGroupRev2, ccmH323DevRmtCM2InetAddressType=ccmH323DevRmtCM2InetAddressType, ccmSIPDevIndex=ccmSIPDevIndex, ccmTimeZoneName=ccmTimeZoneName, ccmPhoneInfoGroupRev4=ccmPhoneInfoGroupRev4, ccmDevicePoolTable=ccmDevicePoolTable, ccmQualityRprtSourceDevName=ccmQualityRprtSourceDevName, ccmAlarmSeverity=ccmAlarmSeverity, ccmH323DevProductId=ccmH323DevProductId, ccmPhoneE911Location=ccmPhoneE911Location, ccmQualityRprtCategory=ccmQualityRprtCategory, ccmTLSConnFailTime=ccmTLSConnFailTime, ccmGatewayAlarmEnable=ccmGatewayAlarmEnable, ccmGatewayTable=ccmGatewayTable, ccmH323DevRmtCM3InetAddressType=ccmH323DevRmtCM3InetAddressType, ccmGatekeeperName=ccmGatekeeperName, ccmQualityRprtClusterId=ccmQualityRprtClusterId, ccmMediaResourceListExhausted=ccmMediaResourceListExhausted, ccmPhoneExtn=ccmPhoneExtn, ccmInetAddressType=ccmInetAddressType, ccmUnregisteredCTIDevices=ccmUnregisteredCTIDevices, ccmVMailDevTimeLastRegistered=ccmVMailDevTimeLastRegistered, ccmMIBNotifications=ccmMIBNotifications, ccmMediaDeviceStatus=ccmMediaDeviceStatus, ccmRegionPairEntry=ccmRegionPairEntry, ccmTLSConnectionFailure=ccmTLSConnectionFailure, ccmGatewayInfoGroup=ccmGatewayInfoGroup, ccmInfoGroup=ccmInfoGroup, ccmGroupName=ccmGroupName, ccmGatewayStatusReason=ccmGatewayStatusReason, ciscoCcmMIBObjects=ciscoCcmMIBObjects, ccmMediaDeviceUnregReason=ccmMediaDeviceUnregReason, ccmMediaDeviceInetAddressType=ccmMediaDeviceInetAddressType, ccmPhoneIndex=ccmPhoneIndex, ccmH323DevInetAddress=ccmH323DevInetAddress, ccmInetAddress2=ccmInetAddress2, ccmPhoneFailedAlarmInterval=ccmPhoneFailedAlarmInterval, ccmCallManagerStartTime=ccmCallManagerStartTime, ccmH323DevTimeLastRegistered=ccmH323DevTimeLastRegistered, ccmGatewayTimeLastStatusUpdt=ccmGatewayTimeLastStatusUpdt, ccmGroupEntry=ccmGroupEntry, ccmRegionAvailableBandWidth=ccmRegionAvailableBandWidth, ccmGatewayIndex=ccmGatewayIndex, ccmSIPOutPortNumber=ccmSIPOutPortNumber, ccmGatewayType=ccmGatewayType, ccmNotificationsGroupRev2=ccmNotificationsGroupRev2, ccmH323DevAltGK3InetAddress=ccmH323DevAltGK3InetAddress, ccmPhoneExtnTable=ccmPhoneExtnTable, ccmCTIDeviceInetAddressIPv4=ccmCTIDeviceInetAddressIPv4, ccmInetAddress=ccmInetAddress, ccmGatewayDChannelStatus=ccmGatewayDChannelStatus, CcmPhoneProtocolType=CcmPhoneProtocolType, ccmMaliCallCallingDeviceName=ccmMaliCallCallingDeviceName, ccmPhoneFailedInetAddress=ccmPhoneFailedInetAddress, ccmQualityReport=ccmQualityReport, ccmGatewayInfo=ccmGatewayInfo, ccmCallManagerAlarmEnable=ccmCallManagerAlarmEnable, ccmSIPDeviceInfoGroupRev1=ccmSIPDeviceInfoGroupRev1, ccmRegionDestIndex=ccmRegionDestIndex, ccmPhoneFailedTable=ccmPhoneFailedTable, ccmInActivePhones=ccmInActivePhones, ccmGatewayTrunkInfo=ccmGatewayTrunkInfo, ccmGroupMappingTable=ccmGroupMappingTable, ccmProductCategory=ccmProductCategory, CcmIndex=CcmIndex, ccmPhoneStatusUpdateTable=ccmPhoneStatusUpdateTable, ccmNotificationsGroupRev3=ccmNotificationsGroupRev3, ccmCTIDeviceInfo=ccmCTIDeviceInfo, ccmNotificationsInfoGroupRev2=ccmNotificationsInfoGroupRev2, ccmNotificationsGroupRev1=ccmNotificationsGroupRev1, ccmDevicePoolGroupIndex=ccmDevicePoolGroupIndex, ciscoCcmMIBConformance=ciscoCcmMIBConformance, ccmGroupTable=ccmGroupTable, ccmH323DevStatusReason=ccmH323DevStatusReason, ccmProductTypeTable=ccmProductTypeTable, ccmPhoneStatusUpdate=ccmPhoneStatusUpdate, ccmSystemVersion=ccmSystemVersion, ccmGroupMappingEntry=ccmGroupMappingEntry, ccmNotificationsGroup=ccmNotificationsGroup, ccmPhoneFailedStorePeriod=ccmPhoneFailedStorePeriod, ccmCTIDeviceInfoGroupRev3=ccmCTIDeviceInfoGroupRev3, ccmNotificationsInfo=ccmNotificationsInfo, ccmRegisteredGateways=ccmRegisteredGateways, ccmPhStatUpdtTblLastAddedIndex=ccmPhStatUpdtTblLastAddedIndex, ccmVMailDevIndex=ccmVMailDevIndex, ccmPhoneExtensionIpAddress=ccmPhoneExtensionIpAddress, ccmPhoneFailedIPv6Attribute=ccmPhoneFailedIPv6Attribute, ccmActivePhones=ccmActivePhones, ccmMaliCallCalledPartyNumber=ccmMaliCallCalledPartyNumber, ccmGatekeeperTable=ccmGatekeeperTable, ccmCTIDevicePoolIndex=ccmCTIDevicePoolIndex, ccmSIPDeviceInfo=ccmSIPDeviceInfo, ccmSIPDeviceEntry=ccmSIPDeviceEntry, ccmVMailDevTimeLastStatusUpdt=ccmVMailDevTimeLastStatusUpdt, ccmMediaDeviceInetAddressIPv4=ccmMediaDeviceInetAddressIPv4, ccmGatewayLayer2Change=ccmGatewayLayer2Change, ccmMediaResourceType=ccmMediaResourceType, ccmPhoneStatusPhoneIndex=ccmPhoneStatusPhoneIndex, ccmH323DeviceInfo=ccmH323DeviceInfo, ccmH323DevTimeLastStatusUpdt=ccmH323DevTimeLastStatusUpdt, ccmH323DevRmtCM3InetAddress=ccmH323DevRmtCM3InetAddress, ccmGatewayTrunkIndex=ccmGatewayTrunkIndex, ccmCTIDeviceIndex=ccmCTIDeviceIndex, ccmGatewayRegFailReason=ccmGatewayRegFailReason, ccmPhoneProductTypeIndex=ccmPhoneProductTypeIndex, ccmMediaDeviceInfoGroup=ccmMediaDeviceInfoGroup, ccmMediaDeviceInfo=ccmMediaDeviceInfo, ccmPhoneExtnMultiLines=ccmPhoneExtnMultiLines, ccmGatewayTrunkStatus=ccmGatewayTrunkStatus, ccmRegisteredCTIDevices=ccmRegisteredCTIDevices, CcmDevRegFailCauseCode=CcmDevRegFailCauseCode, ccmRejectedCTIDevices=ccmRejectedCTIDevices, ccmCTIDeviceInfoGroupRev1=ccmCTIDeviceInfoGroupRev1, ccmMediaDeviceEntry=ccmMediaDeviceEntry, ccmH323DevAltGK4InetAddress=ccmH323DevAltGK4InetAddress, ccmPhoneStatusRegFailReason=ccmPhoneStatusRegFailReason, ccmVMailDevInetAddressType=ccmVMailDevInetAddressType, ccmMediaDeviceInetAddress=ccmMediaDeviceInetAddress, ccmAlarmConfigInfo=ccmAlarmConfigInfo, ccmMaliCallCallingPartyName=ccmMaliCallCallingPartyName, ccmCTIDeviceName=ccmCTIDeviceName, ccmVoiceMailDeviceEntry=ccmVoiceMailDeviceEntry, ccmPhoneExtnIndex=ccmPhoneExtnIndex, ccmSIPDevProductTypeIndex=ccmSIPDevProductTypeIndex, ccmMediaDeviceTable=ccmMediaDeviceTable, ccmH323TableEntries=ccmH323TableEntries, ccmPhoneFailedName=ccmPhoneFailedName, ccmH323DevInetAddressType=ccmH323DevInetAddressType, ccmTimeZoneIndex=ccmTimeZoneIndex, ccmH323DevRmtCM1InetAddressType=ccmH323DevRmtCM1InetAddressType, ccmPhoneExtensionInetAddress=ccmPhoneExtensionInetAddress, ccmVersion=ccmVersion, ccmPhoneIpAddress=ccmPhoneIpAddress, ccmSIPDeviceTable=ccmSIPDeviceTable, ccmPhoneStatusUpdateEntry=ccmPhoneStatusUpdateEntry, ccmVoiceMailDeviceInfoGroupRev1=ccmVoiceMailDeviceInfoGroupRev1, ccmMaliciousCallAlarmEnable=ccmMaliciousCallAlarmEnable, ccmRouteListName=ccmRouteListName, ccmTimeZoneOffset=ccmTimeZoneOffset, ccmPhoneInetAddressType=ccmPhoneInetAddressType, ccmPhoneDescription=ccmPhoneDescription, ccmProductName=ccmProductName, ccmRejectedGateways=ccmRejectedGateways, ccmVoiceMailDeviceDirNumEntry=ccmVoiceMailDeviceDirNumEntry, ccmStatus=ccmStatus, ccmH323DevAltGK5InetAddressType=ccmH323DevAltGK5InetAddressType, ccmPhoneType=ccmPhoneType, ccmGatewayProductId=ccmGatewayProductId, ccmH323DevIndex=ccmH323DevIndex, ccmUnregisteredMediaDevices=ccmUnregisteredMediaDevices, ccmInetAddress2Type=ccmInetAddress2Type, ccmRegionTable=ccmRegionTable, ccmPhoneTimeLastRegistered=ccmPhoneTimeLastRegistered, ccmPhoneFailed=ccmPhoneFailed, ccmGlobalInfo=ccmGlobalInfo, ccmGatewayInetAddress=ccmGatewayInetAddress, ccmTLSDevName=ccmTLSDevName, ccmRejectedMediaDevices=ccmRejectedMediaDevices, ccmPhFailedTblLastAddedIndex=ccmPhFailedTblLastAddedIndex, ccmPhoneInfo=ccmPhoneInfo, ccmMediaDeviceTimeLastStatusUpdt=ccmMediaDeviceTimeLastStatusUpdt, ccmFailCauseCode=ccmFailCauseCode, ccmUnregisteredVoiceMailDevices=ccmUnregisteredVoiceMailDevices, ccmPhoneExtensionTable=ccmPhoneExtensionTable, ccmTable=ccmTable, ccmH323DevAltGK1InetAddress=ccmH323DevAltGK1InetAddress, ccmPhoneInfoGroupRev5=ccmPhoneInfoGroupRev5, ccmPhoneFailedRegFailReason=ccmPhoneFailedRegFailReason, ccmGatewayRegFailCauseCode=ccmGatewayRegFailCauseCode, ccmMediaDeviceIndex=ccmMediaDeviceIndex, ccmPhoneStatusUpdateIndex=ccmPhoneStatusUpdateIndex, ccmVMailDevDirNum=ccmVMailDevDirNum, ccmPhoneProtocol=ccmPhoneProtocol, ccmUnregisteredPhones=ccmUnregisteredPhones, ccmPhoneTimeLastStatusUpdt=ccmPhoneTimeLastStatusUpdt, ccmActiveGateways=ccmActiveGateways, ccmInActiveGateways=ccmInActiveGateways, ccmGatekeeperDevicePoolIndex=ccmGatekeeperDevicePoolIndex, ccmGatewayTrunkTable=ccmGatewayTrunkTable, ccmInstallationId=ccmInstallationId, ccmDevicePoolIndex=ccmDevicePoolIndex, ccmGatekeeperType=ccmGatekeeperType, ccmCTIDeviceDirNumTableStateId=ccmCTIDeviceDirNumTableStateId, ccmPhoneStatus=ccmPhoneStatus, ccmClusterId=ccmClusterId, ccmPhoneEntry=ccmPhoneEntry, ccmSIPDeviceInfoGroupRev2=ccmSIPDeviceInfoGroupRev2, ccmMediaDeviceDevicePoolIndex=ccmMediaDeviceDevicePoolIndex, ccmPhoneInetAddressIPv6=ccmPhoneInetAddressIPv6, ccmSIPInTransportProtocolType=ccmSIPInTransportProtocolType, ccmVMailDevDescription=ccmVMailDevDescription, ccmMediaDeviceProductTypeIndex=ccmMediaDeviceProductTypeIndex, ccmRegisteredVoiceMailDevices=ccmRegisteredVoiceMailDevices, ccmPhoneStatusUpdateAlarmInterv=ccmPhoneStatusUpdateAlarmInterv, ccmMediaDeviceStatusReason=ccmMediaDeviceStatusReason, ccmGatewayTimeLastRegistered=ccmGatewayTimeLastRegistered, ccmQualityReportAlarmEnable=ccmQualityReportAlarmEnable, ccmGroupIndex=ccmGroupIndex, ccmGatewayInfoGroupRev4=ccmGatewayInfoGroupRev4, ccmNotificationsInfoGroup=ccmNotificationsInfoGroup, ccmPhoneInfoGroup=ccmPhoneInfoGroup, ccmH323DeviceInfoGroupRev2=ccmH323DeviceInfoGroupRev2, ccmMaliCallCallingPartyNumber=ccmMaliCallCallingPartyNumber, ccmVMailDevStatusReason=ccmVMailDevStatusReason, ccmNotificationsInfoGroupRev4=ccmNotificationsInfoGroupRev4, CcmDeviceProductId=CcmDeviceProductId, ccmH323DevRegFailReason=ccmH323DevRegFailReason, ccmGatewayFailed=ccmGatewayFailed, ciscoCcmMIBComplianceRev4=ciscoCcmMIBComplianceRev4, ccmGatewayDescription=ccmGatewayDescription, ccmPhoneExtensionTableStateId=ccmPhoneExtensionTableStateId, ccmH323DevAltGK3InetAddressType=ccmH323DevAltGK3InetAddressType, ccmH323DevCnfgGKInetAddressType=ccmH323DevCnfgGKInetAddressType, ccmPhoneFailures=ccmPhoneFailures, ccmTLSConnectionFailReasonCode=ccmTLSConnectionFailReasonCode, ccmPhoneInfoGroupRev1=ccmPhoneInfoGroupRev1, ccmPhoneStatusReason=ccmPhoneStatusReason, ccmPhoneExtension=ccmPhoneExtension, ccmCTIDeviceDirNumIndex=ccmCTIDeviceDirNumIndex, ccmTimeZoneOffsetHours=ccmTimeZoneOffsetHours, ccmCTIDeviceTableStateId=ccmCTIDeviceTableStateId, ccmMaliCallCalledPartyName=ccmMaliCallCalledPartyName)
mibBuilder.exportSymbols("CISCO-CCM-MIB", ciscoCcmMIBComplianceRev6=ciscoCcmMIBComplianceRev6, ciscoCcmMIBComplianceRev7=ciscoCcmMIBComplianceRev7, ccmVMailDevName=ccmVMailDevName, ccmSIPDevInetAddressType=ccmSIPDevInetAddressType, ccmPhoneExtnStatus=ccmPhoneExtnStatus, ciscoCcmMIBCompliance=ciscoCcmMIBCompliance, ccmVoiceMailDeviceDirNumTable=ccmVoiceMailDeviceDirNumTable, ccmPhoneStatusUpdateType=ccmPhoneStatusUpdateType, CcmDevUnregCauseCode=CcmDevUnregCauseCode, CcmSIPTransportProtocolType=CcmSIPTransportProtocolType, CcmDeviceLineStatus=CcmDeviceLineStatus, ccmCMGroupMappingCMPriority=ccmCMGroupMappingCMPriority, ccmGatewayUnregReason=ccmGatewayUnregReason, ccmVMailDevProductId=ccmVMailDevProductId, ccmProductTypeIndex=ccmProductTypeIndex, ccmH323DeviceEntry=ccmH323DeviceEntry, ccmQualityReportAlarmConfigInfo=ccmQualityReportAlarmConfigInfo, ccmPhoneFailCauseCode=ccmPhoneFailCauseCode, ccmGatewayInetAddressType=ccmGatewayInetAddressType, ccmMaliciousCall=ccmMaliciousCall, ccmCTIDeviceEntry=ccmCTIDeviceEntry, ccmSIPDevInetAddressIPv4=ccmSIPDevInetAddressIPv4, ccmNotificationsInfoGroupRev5=ccmNotificationsInfoGroupRev5, CcmDeviceStatus=CcmDeviceStatus, ccmSIPInPortNumber=ccmSIPInPortNumber, ccmMediaDeviceTimeLastRegistered=ccmMediaDeviceTimeLastRegistered, ccmPhoneFailedMacAddress=ccmPhoneFailedMacAddress, ccmMaliCallTime=ccmMaliCallTime, ccmPhoneRegFailReason=ccmPhoneRegFailReason, ccmDevicePoolRegionIndex=ccmDevicePoolRegionIndex, ccmGatewayPhysIfL2Status=ccmGatewayPhysIfL2Status, ccmPhoneExtensionInetAddressType=ccmPhoneExtensionInetAddressType, ccmNotificationsInfoGroupRev3=ccmNotificationsInfoGroupRev3, ccmRegionSrcIndex=ccmRegionSrcIndex, ccmCTIDeviceInetAddressIPv6=ccmCTIDeviceInetAddressIPv6, ccmH323DevCnfgGKInetAddress=ccmH323DevCnfgGKInetAddress, ccmNotificationsInfoGroupRev1=ccmNotificationsInfoGroupRev1, ccmCTIDeviceDescription=ccmCTIDeviceDescription, ccmPhoneInetAddress=ccmPhoneInetAddress, ccmGatewayTrunkEntry=ccmGatewayTrunkEntry, ccmPhoneStatusUpdateStorePeriod=ccmPhoneStatusUpdateStorePeriod, ccmCTIDeviceTimeLastStatusUpdt=ccmCTIDeviceTimeLastStatusUpdt, ccmDevicePoolTimeZoneIndex=ccmDevicePoolTimeZoneIndex, ccmRegionEntry=ccmRegionEntry, ccmPhoneLastError=ccmPhoneLastError, ccmEntry=ccmEntry, ccmGatekeeperStatus=ccmGatekeeperStatus, ccmPhoneIPv4Attribute=ccmPhoneIPv4Attribute, ccmGatewayInfoGroupRev3=ccmGatewayInfoGroupRev3, ccmH323DevUnregReason=ccmH323DevUnregReason, ccmH323DevProductTypeIndex=ccmH323DevProductTypeIndex, ccmPhonePhysicalAddress=ccmPhonePhysicalAddress, ccmPhoneExtnInetAddressType=ccmPhoneExtnInetAddressType, ccmH323DevAltGK5InetAddress=ccmH323DevAltGK5InetAddress, ccmPhoneName=ccmPhoneName, ccmPhoneStatusUpdateReason=ccmPhoneStatusUpdateReason, ccmGatewayInfoGroupRev2=ccmGatewayInfoGroupRev2, ciscoCcmMIBCompliances=ciscoCcmMIBCompliances, ccmMediaDeviceInfoGroupRev4=ccmMediaDeviceInfoGroupRev4, ccmCTIDeviceStatus=ccmCTIDeviceStatus, ccmInfoGroupRev1=ccmInfoGroupRev1, ccmTrunkGatewayIndex=ccmTrunkGatewayIndex, ccmTimeZoneTable=ccmTimeZoneTable, ccmCTIDeviceType=ccmCTIDeviceType, ccmTLSDevInetAddress=ccmTLSDevInetAddress, ccmH323DevAltGK1InetAddressType=ccmH323DevAltGK1InetAddressType, ccmCTIDeviceDirNumEntry=ccmCTIDeviceDirNumEntry, ccmPhoneTableStateId=ccmPhoneTableStateId, ccmCTIDeviceProductTypeIndex=ccmCTIDeviceProductTypeIndex, ccmPhoneLoadID=ccmPhoneLoadID, ccmPhoneFailedInetAddressType=ccmPhoneFailedInetAddressType, ccmMediaDeviceRegFailReason=ccmMediaDeviceRegFailReason, ccmVMailDevProductTypeIndex=ccmVMailDevProductTypeIndex, ccmH323DeviceTable=ccmH323DeviceTable, ccmMediaResourceListName=ccmMediaResourceListName, ccmDevicePoolName=ccmDevicePoolName, ccmUnregisteredGateways=ccmUnregisteredGateways, ccmSIPDevDescription=ccmSIPDevDescription, ccmMediaDeviceType=ccmMediaDeviceType, ccmCTIDeviceInfoGroupRev2=ccmCTIDeviceInfoGroupRev2, ccmPhoneUserName=ccmPhoneUserName, ccmRegionIndex=ccmRegionIndex, ccmPhoneDevicePoolIndex=ccmPhoneDevicePoolIndex, ciscoCcmMIBGroups=ciscoCcmMIBGroups, ccmVoiceMailDeviceTable=ccmVoiceMailDeviceTable, ccmMIBNotificationPrefix=ccmMIBNotificationPrefix, ccmGeneralInfo=ccmGeneralInfo, ccmH323DevDescription=ccmH323DevDescription, ccmH323DeviceInfoGroupRev3=ccmH323DeviceInfoGroupRev3, ccmGatewayPhysIfIndex=ccmGatewayPhysIfIndex, ccmGatewayEntry=ccmGatewayEntry, ccmCTIDeviceAppInfo=ccmCTIDeviceAppInfo, ccmVMailDevUnregReason=ccmVMailDevUnregReason, ccmProductType=ccmProductType, ccmName=ccmName, ccmCTIDeviceInfoGroup=ccmCTIDeviceInfoGroup, ccmInfoGroupRev4=ccmInfoGroupRev4, ccmMaliCallCalledDeviceName=ccmMaliCallCalledDeviceName, ccmH323DeviceInfoGroupRev1=ccmH323DeviceInfoGroupRev1, ccmCTIDeviceUnregReason=ccmCTIDeviceUnregReason, ccmPartiallyRegisteredPhones=ccmPartiallyRegisteredPhones, ccmPhoneStatusUpdateTime=ccmPhoneStatusUpdateTime, ccmH323DevRmtCM2InetAddress=ccmH323DevRmtCM2InetAddress, ccmVoiceMailDeviceInfoGroup=ccmVoiceMailDeviceInfoGroup, ccmRegisteredMediaDevices=ccmRegisteredMediaDevices, ccmGatewayTableStateId=ccmGatewayTableStateId, ccmRegisteredPhones=ccmRegisteredPhones, ccmH323DevAltGK2InetAddressType=ccmH323DevAltGK2InetAddressType, ccmGatekeeperIndex=ccmGatekeeperIndex, ccmGatewayDChannelNumber=ccmGatewayDChannelNumber, ccmMediaDeviceName=ccmMediaDeviceName, ccmGatewayStatus=ccmGatewayStatus, ccmProductTypeEntry=ccmProductTypeEntry, ccmPhoneStatusUpdateTableStateId=ccmPhoneStatusUpdateTableStateId, ccmGatewayTrunkType=ccmGatewayTrunkType, ccmRegionName=ccmRegionName, ccmIndex=ccmIndex, ccmPhoneInfoGroupRev2=ccmPhoneInfoGroupRev2, ciscoCcmMIBComplianceRev5=ciscoCcmMIBComplianceRev5, ccmInfoGroupRev3=ccmInfoGroupRev3, ccmTimeZoneEntry=ccmTimeZoneEntry, ccmRouteListExhausted=ccmRouteListExhausted, ccmPhoneExtnEntry=ccmPhoneExtnEntry, ccmGatewayFailCauseCode=ccmGatewayFailCauseCode, ccmGatekeeperDescription=ccmGatekeeperDescription, ccmPhoneUnregReason=ccmPhoneUnregReason, ccmPhoneFailedInetAddressIPv4=ccmPhoneFailedInetAddressIPv4, ccmH323DeviceInfoGroup=ccmH323DeviceInfoGroup, ccmPhoneFailedIPv4Attribute=ccmPhoneFailedIPv4Attribute, ccmGatewayName=ccmGatewayName, ccmPhoneExtensionMultiLines=ccmPhoneExtensionMultiLines, ccmVMailDevInetAddress=ccmVMailDevInetAddress, ccmGatewayFailedReason=ccmGatewayFailedReason, ccmCTIDeviceRegFailReason=ccmCTIDeviceRegFailReason, ciscoCcmMIBComplianceRev3=ciscoCcmMIBComplianceRev3, ccmGatekeeperInfo=ccmGatekeeperInfo, ccmCTIDeviceDirNum=ccmCTIDeviceDirNum, ccmCallManagerFailed=ccmCallManagerFailed, ciscoCcmMIBComplianceRev1=ciscoCcmMIBComplianceRev1, ccmPhoneTimeLastError=ccmPhoneTimeLastError, ccmGroupTftpDefault=ccmGroupTftpDefault, ccmH323DevRmtCM1InetAddress=ccmH323DevRmtCM1InetAddress, ccmH323DevName=ccmH323DevName, ccmVMailDevStatus=ccmVMailDevStatus, ccmSIPDevInetAddressIPv6=ccmSIPDevInetAddressIPv6, ccmVoiceMailDeviceInfo=ccmVoiceMailDeviceInfo, ccmCTIDeviceDirNumTable=ccmCTIDeviceDirNumTable, ccmMediaDeviceInetAddressIPv6=ccmMediaDeviceInetAddressIPv6, ccmInfoGroupRev2=ccmInfoGroupRev2, ccmPhoneExtensionIndex=ccmPhoneExtensionIndex, ccmPhoneInfoGroupRev3=ccmPhoneInfoGroupRev3, PYSNMP_MODULE_ID=ciscoCcmMIB, ccmPhoneUpdates=ccmPhoneUpdates, ccmPhoneFailedTime=ccmPhoneFailedTime, CcmDevFailCauseCode=CcmDevFailCauseCode, ccmGatewayDevicePoolIndex=ccmGatewayDevicePoolIndex, ccmPhoneInfoGroupRev6=ccmPhoneInfoGroupRev6, ccmPhoneActiveLoadID=ccmPhoneActiveLoadID, ccmTimeZoneOffsetMinutes=ccmTimeZoneOffsetMinutes, ccmGatewayInfoGroupRev1=ccmGatewayInfoGroupRev1, ccmMediaDeviceDescription=ccmMediaDeviceDescription, ccmRejectedVoiceMailDevices=ccmRejectedVoiceMailDevices, ccmSIPTableEntries=ccmSIPTableEntries, ccmPhoneTable=ccmPhoneTable, ccmPhoneExtensionEntry=ccmPhoneExtensionEntry, ccmVMailDevRegFailReason=ccmVMailDevRegFailReason, ccmTLSDevInetAddressType=ccmTLSDevInetAddressType, ccmPhoneFailedInetAddressIPv6=ccmPhoneFailedInetAddressIPv6, ccmCTIDeviceTimeLastRegistered=ccmCTIDeviceTimeLastRegistered, ccmH323DevActGKInetAddressType=ccmH323DevActGKInetAddressType, ccmSIPDeviceInfoGroup=ccmSIPDeviceInfoGroup, ccmCTIDeviceStatusReason=ccmCTIDeviceStatusReason, ccmGatewayProductTypeIndex=ccmGatewayProductTypeIndex, ccmVMailDevDirNumIndex=ccmVMailDevDirNumIndex, ccmMediaDeviceInfoGroupRev1=ccmMediaDeviceInfoGroupRev1, ccmDevicePoolEntry=ccmDevicePoolEntry)
