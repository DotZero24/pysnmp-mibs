...
mibBuilder.exportSymbols("AXIS-VIDEO-MIB", PYSNMP_MODULE_ID=video, videoBased=videoBased, videoNotificationPrefix=videoNotificationPrefix, alarmText=alarmText, alarmName=alarmName, powerSupplyStatus=powerSupplyStatus, audioChannelTable=audioChannelTable, videoSignalStatus=videoSignalStatus, videoChannelEntry=videoChannelEntry, fanEntry=fanEntry, casingName=casingName, tempSensorTable=tempSensorTable, tempSensorType=tempSensorType, alarmSingle=alarmSingle, tempSensorValue=tempSensorValue, storageId=storageId, fanType=fanType, videoGroups=videoGroups, videoObjectGroup=videoObjectGroup, fanStatus=fanStatus, videoCompliance=videoCompliance, powerSupplyId=powerSupplyId, casingTable=casingTable, tempSensorStatus=tempSensorStatus, tempSensorGroup=tempSensorGroup, powerSupplyType=powerSupplyType, tempSensorEntry=tempSensorEntry, storageEntry=storageEntry, videoNotifications=videoNotifications, casingEntry=casingEntry, storageTable=storageTable, videoConformance=videoConformance, audioSignalStatus=audioSignalStatus, storageGroup=storageGroup, storageDisruptionDetected=storageDisruptionDetected, audioChannelEntry=audioChannelEntry, audioChannelId=audioChannelId, alarmNew=alarmNew, powerSupplyEntry=powerSupplyEntry, videoNotificationGroup=videoNotificationGroup, storageName=storageName, fanId=fanId, videoCompliances=videoCompliances, casingStatus=casingStatus, videoObjects=videoObjects, alarmCleared=alarmCleared, videoComplianceRev2=videoComplianceRev2, casingId=casingId, fanTable=fanTable, tempSensorId=tempSensorId, videoChannelTable=videoChannelTable, powerSupplyTable=powerSupplyTable, video=video, videoChannelId=videoChannelId, casingGroup=casingGroup, alarmID=alarmID)
