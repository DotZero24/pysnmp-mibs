...
_G='A3COM-HUAWEI-VOAAACLIENT-MIB'
_F='OctetString'
_E='read-write'
_D='Integer32'
_C='TruthValue'
...
h3cVoAAAClientObjects=_H3cVoAAAClientObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,9,1))
_H3cVoAAAClientCfgObjects_ObjectIdentity=ObjectIdentity
h3cVoAAAClientCfgObjects=_H3cVoAAAClientCfgObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,9,1,1))
...
h3cVoAAAGwAuthenDid=_H3cVoAAAGwAuthenDid_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,1,1),_H3cVoAAAGwAuthenDid_Type())
...
h3cVoAAAGwAuthorDid=_H3cVoAAAGwAuthorDid_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,1,2),_H3cVoAAAGwAuthorDid_Type())
...
h3cVoAAAGwAccountingDid=_H3cVoAAAGwAccountingDid_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,1,3),_H3cVoAAAGwAccountingDid_Type())
...
h3cVoAAAGwAccountMethod=_H3cVoAAAGwAccountMethod_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,1,4),_H3cVoAAAGwAccountMethod_Type())
...
h3cVoAAAGwAccessNumberTable=_H3cVoAAAGwAccessNumberTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2))
if mibBuilder.loadTexts:h3cVoAAAGwAccessNumberTable.setStatus(_A)
_H3cVoAAAGwAccessNumberEntry_Object=MibTableRow
h3cVoAAAGwAccessNumberEntry=_H3cVoAAAGwAccessNumberEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1))
...
h3cVoAAAGwAccessNumber=_H3cVoAAAGwAccessNumber_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1,1),_H3cVoAAAGwAccessNumber_Type())
...
h3cVoAAAGwAuthentication=_H3cVoAAAGwAuthentication_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1,2),_H3cVoAAAGwAuthentication_Type())
...
h3cVoAAAGwAuthorization=_H3cVoAAAGwAuthorization_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1,3),_H3cVoAAAGwAuthorization_Type())
...
h3cVoAAAGwAccounting=_H3cVoAAAGwAccounting_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1,4),_H3cVoAAAGwAccounting_Type())
...
h3cVoAAAGwProcessConfig=_H3cVoAAAGwProcessConfig_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1,5),_H3cVoAAAGwProcessConfig_Type())
...
h3cVoAAAGwCardDigit=_H3cVoAAAGwCardDigit_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1,6),_H3cVoAAAGwCardDigit_Type())
...
h3cVoAAAGwPasswordDigit=_H3cVoAAAGwPasswordDigit_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1,7),_H3cVoAAAGwPasswordDigit_Type())
...
h3cVoAAAGwRedialTimes=_H3cVoAAAGwRedialTimes_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1,8),_H3cVoAAAGwRedialTimes_Type())
...
h3cVoAAAGwRowStatus=_H3cVoAAAGwRowStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,9,1,2,1,9),_H3cVoAAAGwRowStatus_Type())
