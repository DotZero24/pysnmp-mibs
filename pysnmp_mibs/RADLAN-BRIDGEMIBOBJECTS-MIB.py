# SNMP MIB module (RADLAN-BRIDGEMIBOBJECTS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-BRIDGEMIBOBJECTS-MIB
...
rldot1dStpVlanEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1dStpVlan"),
)
if mibBuilder.loadTexts:
...
rldot1dStpVlanPortEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1dStpVlanPortVlan"),
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1dStpVlanPortPort"),
)
if mibBuilder.loadTexts:
...
rldot1dStpPortEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1dStpPortPort"),
)
if mibBuilder.loadTexts:
...
rldot1wRStpVlanEdgePortEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1wRStpVlanEdgePortVlan"),
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1wRStpVlanEdgePortPort"),
)
if mibBuilder.loadTexts:
...
rldot1wRStpForceVersionEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1wRStpForceVersionVlan"),
)
if mibBuilder.loadTexts:
...
rldot1pPriorityMapEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1pPriorityMapName"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpInstanceEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpInstanceId"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpInstancePortEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpInstancePortMstiId"),
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpInstancePortPort"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpVlanEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpVlan"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpExtPortEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpExtPortPort"),
)
if mibBuilder.loadTexts:
...
rldot1sMstpInstanceVlanEntry.setIndexNames(
    (0, "RADLAN-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpInstanceVlanId"),
)
if mibBuilder.loadTexts:
