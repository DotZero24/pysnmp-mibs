...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cabletron/CTRON-CDP-MIB
...
mibBuilder.exportSymbols("CTRON-CDP-MIB", ctCDPConformance=ctCDPConformance, ctCDPNeighborLastDelete=ctCDPNeighborLastDelete, ctCDPNeighborIP=ctCDPNeighborIP, ctCDPNeighborDescription=ctCDPNeighborDescription, ctCdpGroupV10=ctCdpGroupV10, ctCDPStats=ctCDPStats, ctCDPNeighborEntry=ctCDPNeighborEntry, ctCDPNeighborType=ctCDPNeighborType, ctronCdpMIB=ctronCdpMIB, ctCDPPortStatus=ctCDPPortStatus, ctCDPOutPackets=ctCDPOutPackets, ctCDPNeighborTable=ctCDPNeighborTable, ctCDPTransmitFrequency=ctCDPTransmitFrequency, ctCDPMemoryErrors=ctCDPMemoryErrors, ctCDPHoldTime=ctCDPHoldTime, ctCDPStatus=ctCDPStatus, ctCDPPortTableEntry=ctCDPPortTableEntry, ctCDPInvalidVersionPackets=ctCDPInvalidVersionPackets, ctCDPPortTable=ctCDPPortTable, ctCDPNeighborChassisMAC=ctCDPNeighborChassisMAC, ctCDPCompliances=ctCDPCompliances, ctCDPGroups=ctCDPGroups, ctCDPNeighborChassisIP=ctCDPNeighborChassisIP, ctCDPNeighborPort=ctCDPNeighborPort, CTCDPCapability=CTCDPCapability, ctCDPNeighborLastChange=ctCDPNeighborLastChange, ctCDPNeighborPortName=ctCDPNeighborPortName, ctCDPTransmitErrors=ctCDPTransmitErrors, ctCDPComplianceV10=ctCDPComplianceV10, ctCDPVersion=ctCDPVersion, ctCDPAuthenticationCode=ctCDPAuthenticationCode, ctCDPParseErrorPackets=ctCDPParseErrorPackets, ctCDPNeighborCapability=ctCDPNeighborCapability, ctCDPPort=ctCDPPort, ctCDPNeighbor=ctCDPNeighbor, ctCDPNeighborMAC=ctCDPNeighborMAC, ctCDPInPackets=ctCDPInPackets, ctCDPGlobalStatus=ctCDPGlobalStatus, PYSNMP_MODULE_ID=ctronCdpMIB, ctCDPNeighborTimeMark=ctCDPNeighborTimeMark)
