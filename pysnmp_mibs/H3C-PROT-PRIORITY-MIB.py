...
h3cProtocolPriorityObjects=_H3cProtocolPriorityObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,37,1))
_H3cPPri_ObjectIdentity=ObjectIdentity
h3cPPri=_H3cPPri_ObjectIdentity((1,3,6,1,4,1,2011,10,2,37,1,1))
_H3cProtocolPriorityTable_Object=MibTable
h3cProtocolPriorityTable=_H3cProtocolPriorityTable_Object((1,3,6,1,4,1,2011,10,2,37,1,1,1))
if mibBuilder.loadTexts:h3cProtocolPriorityTable.setStatus(_A)
_H3cProtocolPriorityEntry_Object=MibTableRow
h3cProtocolPriorityEntry=_H3cProtocolPriorityEntry_Object((1,3,6,1,4,1,2011,10,2,37,1,1,1,1))
...
h3cPPriProtocolType=_H3cPPriProtocolType_Object((1,3,6,1,4,1,2011,10,2,37,1,1,1,1,1),_H3cPPriProtocolType_Type())
...
h3cPPriPriorityType=_H3cPPriPriorityType_Object((1,3,6,1,4,1,2011,10,2,37,1,1,1,1,2),_H3cPPriPriorityType_Type())
...
h3cPPriPriorityVlaue=_H3cPPriPriorityVlaue_Object((1,3,6,1,4,1,2011,10,2,37,1,1,1,1,3),_H3cPPriPriorityVlaue_Type())
...
h3cPPriRowStatus=_H3cPPriRowStatus_Object((1,3,6,1,4,1,2011,10,2,37,1,1,1,1,4),_H3cPPriRowStatus_Type())
