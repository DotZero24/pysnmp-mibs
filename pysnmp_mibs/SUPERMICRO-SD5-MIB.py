...
mibBuilder.exportSymbols("SUPERMICRO-SD5-MIB", raidVDId=raidVDId, raidPDSlotNumber=raidPDSlotNumber, cpuEntry=cpuEntry, diskModel=diskModel, osEntry=osEntry, memTag=memTag, mbTable=mbTable, cpuCoreCount=cpuCoreCount, memTable=memTable, raidAdapterProductName=raidAdapterProductName, raidAdapterDeviceId=raidAdapterDeviceId, raidAdapterId_PD=raidAdapterId_PD, raidVDTable=raidVDTable, trapMemoryUeccWarning=trapMemoryUeccWarning, sysBIOSVersion=sysBIOSVersion, raidAdapterGroup_BBU=raidAdapterGroup_BBU, cpuLogTable=cpuLogTable, raidBBUEntry=raidBBUEntry, trapPowerSupplyCritical=trapPowerSupplyCritical, raidPDNCQSetting=raidPDNCQSetting, trapStorageSMARTCheckCritical=trapStorageSMARTCheckCritical, raidPDAllinoneMsg=raidPDAllinoneMsg, trapPowerSupplyWarning=trapPowerSupplyWarning, raidVDDefaultCachePolicy=raidVDDefaultCachePolicy, trapStorageAdapterStatusCritical=trapStorageAdapterStatusCritical, raidVDSpanDepth=raidVDSpanDepth, trapFanCritical=trapFanCritical, diskSlotID=diskSlotID, memDeviceStatus=memDeviceStatus, memUECCErrorCount=memUECCErrorCount, raidPDModel=raidPDModel, trapChassisIntrusion=trapChassisIntrusion, raidPDSpan=raidPDSpan, raidBBUTable=raidBBUTable, raidVDStripSize=raidVDStripSize, raidVDNumDrives=raidVDNumDrives, raidAdapterGroup_VD=raidAdapterGroup_VD, raidPDLinkSpeed=raidPDLinkSpeed, raidAdapterIndex=raidAdapterIndex, sysBIOSTable=sysBIOSTable, trapVoltageCritical=trapVoltageCritical, raidAdapterAllinoneMsg=raidAdapterAllinoneMsg, raidVDName=raidVDName, trapBatteryStatusNormal=trapBatteryStatusNormal, raidPDEntry=raidPDEntry, trapBatteryStatusWarning=trapBatteryStatusWarning, cpuDeviceVersion=cpuDeviceVersion, ueccLogDatetime=ueccLogDatetime, raidVDDiskCachePolicy=raidVDDiskCachePolicy, memEntry=memEntry, trapGenericCritical=trapGenericCritical, trapStorageAdapterStatusWarning=trapStorageAdapterStatusWarning, raidAdapterTable=raidAdapterTable, raidVDSupportsMaxPS=raidVDSupportsMaxPS, osTable=osTable, trapGenericNormal=trapGenericNormal, trapMemoryCeccWarning=trapMemoryCeccWarning, trapMemoryUeccNormal=trapMemoryUeccNormal, raidPDEnclosureDeviceID=raidPDEnclosureDeviceID, cpuCoreEnabled=cpuCoreEnabled, cpuIndex=cpuIndex, cpuLoadingPercentage=cpuLoadingPercentage, sysBIOSIndex=sysBIOSIndex, osCSDVersion=osCSDVersion, ceccLogDatetime=ceccLogDatetime, raidPDOpProgress=raidPDOpProgress, raidAdapterSubDeviceId=raidAdapterSubDeviceId, trapCpuFaultNormal=trapCpuFaultNormal, mbProductName=mbProductName, raidPDOtherErrorCount=raidPDOtherErrorCount, postLogDatetime=postLogDatetime, raidIsBBUAbsentIgnored=raidIsBBUAbsentIgnored, raidAdapterVendorId=raidAdapterVendorId, raidPDFirmwareRevision=raidPDFirmwareRevision, trapVoltageNormal=trapVoltageNormal, raidPDTable=raidPDTable, osSerialNumber=osSerialNumber, trapGenericWarning=trapGenericWarning, cpuMaxSpeed=cpuMaxSpeed, raidAdapterSerialNumber=raidAdapterSerialNumber, trapTemperatureWarning=trapTemperatureWarning, raidVDAllinoneMsg=raidVDAllinoneMsg, mbSerialNumber=mbSerialNumber, raidBBUAllinoneMsg=raidBBUAllinoneMsg, trapFanWarning=trapFanWarning, raidAdapterId=raidAdapterId, cpuID=cpuID, raidPDPort0Linkspeed=raidPDPort0Linkspeed, mbAssetTag=mbAssetTag, raidPDDeviceSpeed=raidPDDeviceSpeed, raidVDDefaultAccessPolicy=raidVDDefaultAccessPolicy, mbEntry=mbEntry, mbIndex=mbIndex, raidPDAllinoneStatus=raidPDAllinoneStatus, sysBIOSManufacturer=sysBIOSManufacturer, ueccLogEntry=ueccLogEntry, raidDiskGroupId=raidDiskGroupId, raidVDBadBlocksExist=raidVDBadBlocksExist, diskInterfaceType=diskInterfaceType, raidPDPredFailCount=raidPDPredFailCount, mbManufacturer=mbManufacturer, cpuDeviceStatus=cpuDeviceStatus, diskName=diskName, memManufacturer=memManufacturer, postLogIndex=postLogIndex, raidVDAllinoneStatus=raidVDAllinoneStatus, trapStorageSMARTCheckWarning=trapStorageSMARTCheckWarning, raidVDMirrorDataSize=raidVDMirrorDataSize, raidAdapterId_BBU=raidAdapterId_BBU, raidBBUAllinoneStatus=raidBBUAllinoneStatus, raidPDPort1Status=raidPDPort1Status, diskSerialNumber=diskSerialNumber, raidAdapterId_VD=raidAdapterId_VD, cpuName=cpuName, cpuLogEntry=cpuLogEntry, raidPDDeviceFwLevel=raidPDDeviceFwLevel, raidPDFirmwareState=raidPDFirmwareState, trapVoltageWarning=trapVoltageWarning, raidVDRaidLevel=raidVDRaidLevel, raidVDSupportT10Power=raidVDSupportT10Power, raidIsBBUAbsent=raidIsBBUAbsent, diskVendor=diskVendor, cpuThreadCount=cpuThreadCount, raidAdapterBIOSVersion=raidAdapterBIOSVersion, osManufacturer=osManufacturer, memDataWidth=memDataWidth, trapMemoryUeccCritical=trapMemoryUeccCritical, trapCpuFaultCritical=trapCpuFaultCritical, raidPDLastPredFailEventSeqNo=raidPDLastPredFailEventSeqNo, cpuLogIndex=cpuLogIndex, raidVDCanSpinUpIn1Min=raidVDCanSpinUpIn1Min, postLogInfo=postLogInfo, raidBBUIndex=raidBBUIndex, raidVDCurrentPSPolicy=raidVDCurrentPSPolicy, sd5Table=sd5Table, raidBBUStatus=raidBBUStatus, raidVDCurrentCachePolicy=raidVDCurrentCachePolicy, raidPDWriteCache=raidPDWriteCache, smSD5TrapMIB=smSD5TrapMIB, raidPDSerialNumber=raidPDSerialNumber, trapMemoryCeccNormal=trapMemoryCeccNormal, raidAdapterGroup_PD=raidAdapterGroup_PD, raidAdapterFWVersion=raidAdapterFWVersion, memSerialNumber=memSerialNumber, raidAdapterFWPackageBuild=raidAdapterFWPackageBuild, raidAdapterGroup=raidAdapterGroup, cpuLogInfo=cpuLogInfo, diskEntry=diskEntry, cpuDescription=cpuDescription, memModel=memModel, memCapacity=memCapacity, trapMemoryCeccCritical=trapMemoryCeccCritical, raidPDInquiryData=raidPDInquiryData, memErrorCount=memErrorCount, raidVDState=raidVDState, cpuTable=cpuTable, cpuLogDatetime=cpuLogDatetime, ceccLogTable=ceccLogTable, memDescription=memDescription, memLabeledBank=memLabeledBank, diskTable=diskTable, osIndex=osIndex, memECCErrorCount=memECCErrorCount, trapChassisIntrusionCleared=trapChassisIntrusionCleared, memTotalWidth=memTotalWidth, raidVDTargetId=raidVDTargetId, trapPowerSupplyNormal=trapPowerSupplyNormal, sysBIOSEntry=sysBIOSEntry, trapBbpStatusNormal=trapBbpStatusNormal, smSuperDoctor5MIB=smSuperDoctor5MIB, raidPDPort0Status=raidPDPort0Status, trapTemperatureCritical=trapTemperatureCritical, sd5Entry=sd5Entry, raidAdapterAllinoneStatus=raidAdapterAllinoneStatus, raidVDEntry=raidVDEntry, trapFanNormal=trapFanNormal, sd5Version=sd5Version, cpuCurrentSpeed=cpuCurrentSpeed, dmiLogTable=dmiLogTable, memPartNumber=memPartNumber, raidDiskGroupId_PD=raidDiskGroupId_PD, osVersion=osVersion, raidAdapterSubVendorId=raidAdapterSubVendorId, raidPDIndex=raidPDIndex, raidAdapterEntry=raidAdapterEntry, sysBIOSReleaseDate=sysBIOSReleaseDate, ueccLogTable=ueccLogTable, memDeviceLocator=memDeviceLocator, diskController=diskController, raidVDIndex=raidVDIndex, diskSize=diskSize, PYSNMP_MODULE_ID=smSuperDoctor5MIB, postLogEntry=postLogEntry, raidVDSize=raidVDSize, cpuDeviceID=cpuDeviceID, postLogTable=postLogTable, osName=osName, sd5Idx=sd5Idx, ceccLogEntry=ceccLogEntry, ueccLogIndex=ueccLogIndex, raidPDMediaType=raidPDMediaType, sd5MIBVersion=sd5MIBVersion, cpuSocketDesignation=cpuSocketDesignation, mbVersionName=mbVersionName, raidVDCurrentAccessPolicy=raidVDCurrentAccessPolicy, raidVDCached=raidVDCached, ceccLogInfo=ceccLogInfo, diskMediaType=diskMediaType, diskSmartStatus=diskSmartStatus, trapStorageAdapterStatusNormal=trapStorageAdapterStatusNormal, trapCpuFaultWarning=trapCpuFaultWarning, raidVDEncryptionType=raidVDEncryptionType, trapStorageSMARTCheckNormal=trapStorageSMARTCheckNormal, raidPDPort1Linkspeed=raidPDPort1Linkspeed, raidVDDefaultPSPolicy=raidVDDefaultPSPolicy, ueccLogInfo=ueccLogInfo, ceccLogIndex=ceccLogIndex, trapBbpStatusCritical=trapBbpStatusCritical, raidPDRawSize=raidPDRawSize, trapTemperatureNormal=trapTemperatureNormal, cpuManufacturer=cpuManufacturer, trapBbpStatusWarning=trapBbpStatusWarning, trapBatteryStatusCritical=trapBatteryStatusCritical, raidPDMediaErrorCount=raidPDMediaErrorCount)
