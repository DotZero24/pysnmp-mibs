...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-RPM-CONN-EXT-MIB
...
_CwrChanOamManage_Type.__name__ = "TruthValue"
...
ciscoWanRpmConnExtMIBCompliance.setObjects(
    ("CISCO-WAN-RPM-CONN-EXT-MIB", "ciscoWanRpmConnExtMIBGroup")
)
if mibBuilder.loadTexts:
