...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-SNMP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:40:33 2025
...
class _RlSnmpLocalEngineIDState_Type(Integer32):
    """Custom type rlSnmpLocalEngineIDState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_RlSnmpLocalEngineIDState_Type.__name__ = "Integer32"
_RlSnmpLocalEngineIDState_Object = MibScalar
rlSnmpLocalEngineIDState = _RlSnmpLocalEngineIDState_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 98, 1, 9),
    _RlSnmpLocalEngineIDState_Type()
)
rlSnmpLocalEngineIDState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlSnmpLocalEngineIDState.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlSnmpUDPMridAddress": RlSnmpUDPMridAddress,
       ...
       "rlSnmpLocalEngineIDState": rlSnmpLocalEngineIDState,
