...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/arbor/PEAKFLOW-TMS-MIB
...
peakflowTmsMIB.setRevisions(('2019-08-29 00:00', '2019-08-27 00:00', '2014-03-12 00:00', '2013-09-19 00:00', '2013-08-19 00:00', '2012-03-29 12:00', '2012-01-12 12:00', '2011-06-14 16:00', '2011-06-03 16:00', '2011-06-03 00:00', '2011-05-23 00:00', '2011-01-21 00:00', '2010-10-28 00:00', '2010-09-07 00:00', '2009-05-27 00:00', '2009-05-08 00:00', '2009-03-11 00:00', '2009-02-13 00:00', '2008-11-13 00:00', '2008-04-07 00:00', '2007-11-20 00:00', '2007-04-27 00:00',))
if mibBuilder.loadTexts: peakflowTmsMIB.setLastUpdated('201908290000Z')
if mibBuilder.loadTexts: peakflowTmsMIB.setOrganization('NETSCOUT Systems, Inc.')
...
tmsOverrunDropRatePps = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 5, 2, 39), Gauge32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: tmsOverrunDropRatePps.setStatus('current')
...
mibBuilder.exportSymbols("PEAKFLOW-TMS-MIB", tmsIpv6GreTunnelDown=tmsIpv6GreTunnelDown, TmsTableIndex=TmsTableIndex, tmsConfigMissing=tmsConfigMissing, tmsDestinationPrefix=tmsDestinationPrefix, tmsHwDeviceUp=tmsHwDeviceUp, tmsAutomitigationBgpSuspended=tmsAutomitigationBgpSuspended, tmsIpv6GreTunnelUp=tmsIpv6GreTunnelUp, tmsTrapSubhostName=tmsTrapSubhostName, tmsHostUpTime=tmsHostUpTime, tmsMitigationError=tmsMitigationError, tmsTrapDetail=tmsTrapDetail, tmsSwComponentDown=tmsSwComponentDown, tmsSystemPrefixesMissing=tmsSystemPrefixesMissing, deviceDiskUsage=deviceDiskUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, tmsFilesystemNominal=tmsFilesystemNominal, tmsHwSensorCritical=tmsHwSensorCritical, TmsHundredths=TmsHundredths, tmsSpCommunicationDown=tmsSpCommunicationDown, tmsMitigationId=tmsMitigationId, tmsSpCommunicationDegraded=tmsSpCommunicationDegraded, tmsMitigationNumber=tmsMitigationNumber, tmsHwSensorUnknown=tmsHwSensorUnknown, tmsIpv6BgpNeighborUp=tmsIpv6BgpNeighborUp, tmsMitigationConfig=tmsMitigationConfig, tmsDpiConfig=tmsDpiConfig, tmsVersion=tmsVersion, tmsHwSensorOk=tmsHwSensorOk, tmsTrapIpv6BgpPeer=tmsTrapIpv6BgpPeer, tmsAutomitigationBgpEnabled=tmsAutomitigationBgpEnabled, deviceSwapSpaceUsage=deviceSwapSpaceUsage, tmsSystemStatusCritical=tmsSystemStatusCritical, tmsSystemStatusNominal=tmsSystemStatusNominal, tmsConfigError=tmsConfigError, tmsSystemPrefixesOk=tmsSystemPrefixesOk, tmsIpv6BgpNeighborDown=tmsIpv6BgpNeighborDown, tmsTrapNexthop=tmsTrapNexthop, PYSNMP_MODULE_ID=peakflowTmsMIB, peakflowTmsTrapsEnumerate=peakflowTmsTrapsEnumerate, tmsHostFault=tmsHostFault, subHostUp=subHostUp, tmsTrapGreDestination=tmsTrapGreDestination, tmsMitigationName=tmsMitigationName, tmsSwComponentUp=tmsSwComponentUp, tmsTrapGreName=tmsTrapGreName, tmsTrapBgpPeer=tmsTrapBgpPeer, tmsTrapIpv6Nexthop=tmsTrapIpv6Nexthop, greTunnelUp=greTunnelUp, tmsIpv6NexthopDown=tmsIpv6NexthopDown, subHostDown=subHostDown, tmsMitigationSuspended=tmsMitigationSuspended, tmsSystemStatusError=tmsSystemStatusError, tmsTrapGreSource=tmsTrapGreSource, greTunnelDown=greTunnelDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, tmsMitigationRunning=tmsMitigationRunning, tmsTrapString=tmsTrapString, tmsIpv6NexthopUp=tmsIpv6NexthopUp, tmsAutomitigationBgpDisabled=tmsAutomitigationBgpDisabled, tmsMitigationLastUpdate=tmsMitigationLastUpdate, tmsMitigationEntry=tmsMitigationEntry, hostFault=hostFault, tmsPerformanceLossy=tmsPerformanceLossy, tmsBgpNeighborUp=tmsBgpNeighborUp, tmsLinkDown=tmsLinkDown, peakflowTmsMIB=peakflowTmsMIB, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, tmsMitigationTable=tmsMitigationTable, tmsIpv6DestinationPrefix=tmsIpv6DestinationPrefix, tmsTrapComponentName=tmsTrapComponentName, tmsMitigationIndex=tmsMitigationIndex, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, tmsDestinationPrefixMask=tmsDestinationPrefixMask, tmsLastUpdate=tmsLastUpdate, tmsTrapIpv6GreDestination=tmsTrapIpv6GreDestination, tmsNexthopDown=tmsNexthopDown, TmsPercentage=TmsPercentage, peakflowTmsObj=peakflowTmsObj, tmsIpv6DestinationPrefixMask=tmsIpv6DestinationPrefixMask, tmsNexthopUp=tmsNexthopUp, tmsOverrunDropRatePps=tmsOverrunDropRatePps, tmsConfigOk=tmsConfigOk, tmsLinkUp=tmsLinkUp, tmsHwDeviceDown=tmsHwDeviceDown, TmsTableIndexOrZero=TmsTableIndexOrZero, peakflowTmsMgr=peakflowTmsMgr, tmsSystemStatusDegraded=tmsSystemStatusDegraded, tmsBgpNeighborDown=tmsBgpNeighborDown, tmsPerformanceOk=tmsPerformanceOk, peakflowTmsTraps=peakflowTmsTraps, tmsSpCommunicationUp=tmsSpCommunicationUp, tmsTrapIpv6GreSource=tmsTrapIpv6GreSource, tmsFilesystemCritical=tmsFilesystemCritical)
