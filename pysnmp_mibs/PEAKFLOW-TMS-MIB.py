...
# Notes
# -----
# ASN.1 source file://mibs/arbor/PEAKFLOW-TMS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:48 2025
...
tmsOverrunDropRatePps = _TmsOverrunDropRatePps_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 5, 2, 39),
    _TmsOverrunDropRatePps_Type()
)
tmsOverrunDropRatePps.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmsOverrunDropRatePps.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"TmsTableIndex": TmsTableIndex,
       ...
       "tmsOverrunDropRatePps": tmsOverrunDropRatePps,
