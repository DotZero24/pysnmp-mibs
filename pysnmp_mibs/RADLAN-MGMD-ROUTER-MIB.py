...
rlMgmdInterfaceExtTable=_RlMgmdInterfaceExtTable_Object((1,3,6,1,4,1,89,225,1))
if mibBuilder.loadTexts:rlMgmdInterfaceExtTable.setStatus(_A)
_RlMgmdInterfaceExtEntry_Object=MibTableRow
rlMgmdInterfaceExtEntry=_RlMgmdInterfaceExtEntry_Object((1,3,6,1,4,1,89,225,1,1))
...
rlMgmdRouterInterfaceExtStatsUpTime=_RlMgmdRouterInterfaceExtStatsUpTime_Object((1,3,6,1,4,1,89,225,1,1,1),_RlMgmdRouterInterfaceExtStatsUpTime_Type())
...
rlMgmdRouterInterfaceExtEnableStats=_RlMgmdRouterInterfaceExtEnableStats_Object((1,3,6,1,4,1,89,225,1,1,2),_RlMgmdRouterInterfaceExtEnableStats_Type())
...
rlMgmdRouterInterfaceExtNumFailedJoins=_RlMgmdRouterInterfaceExtNumFailedJoins_Object((1,3,6,1,4,1,89,225,1,1,3),_RlMgmdRouterInterfaceExtNumFailedJoins_Type())
...
rlMgmdRouterInterfaceExtNumIgmpV1Msgs=_RlMgmdRouterInterfaceExtNumIgmpV1Msgs_Object((1,3,6,1,4,1,89,225,1,1,4),_RlMgmdRouterInterfaceExtNumIgmpV1Msgs_Type())
...
rlMgmdRouterInterfaceExtNumIgmpV2MldV1Msgs=_RlMgmdRouterInterfaceExtNumIgmpV2MldV1Msgs_Object((1,3,6,1,4,1,89,225,1,1,5),_RlMgmdRouterInterfaceExtNumIgmpV2MldV1Msgs_Type())
...
rlMgmdRouterInterfaceExtNumIgmpV3MldV2Msgs=_RlMgmdRouterInterfaceExtNumIgmpV3MldV2Msgs_Object((1,3,6,1,4,1,89,225,1,1,6),_RlMgmdRouterInterfaceExtNumIgmpV3MldV2Msgs_Type())
...
rlMgmdRouterInterfaceExtNumInvalidMsgsRcvd=_RlMgmdRouterInterfaceExtNumInvalidMsgsRcvd_Object((1,3,6,1,4,1,89,225,1,1,7),_RlMgmdRouterInterfaceExtNumInvalidMsgsRcvd_Type())
...
rlMgmdRouterInterfaceExtNumGenQueriesSent=_RlMgmdRouterInterfaceExtNumGenQueriesSent_Object((1,3,6,1,4,1,89,225,1,1,8),_RlMgmdRouterInterfaceExtNumGenQueriesSent_Type())
...
rlMgmdRouterInterfaceExtNumSpecQueriesSent=_RlMgmdRouterInterfaceExtNumSpecQueriesSent_Object((1,3,6,1,4,1,89,225,1,1,9),_RlMgmdRouterInterfaceExtNumSpecQueriesSent_Type())
...
rlmgmdRouterInterfaceQrRobustness=_RlmgmdRouterInterfaceQrRobustness_Object((1,3,6,1,4,1,89,225,1,1,10),_RlmgmdRouterInterfaceQrRobustness_Type())
...
rlmgmdRouterInterfaceQrQueryInterval=_RlmgmdRouterInterfaceQrQueryInterval_Object((1,3,6,1,4,1,89,225,1,1,11),_RlmgmdRouterInterfaceQrQueryInterval_Type())
...
rlmgmdRouterInterfaceQrQueryMaxResponseTime=_RlmgmdRouterInterfaceQrQueryMaxResponseTime_Object((1,3,6,1,4,1,89,225,1,1,12),_RlmgmdRouterInterfaceQrQueryMaxResponseTime_Type())
...
rlmgmdRouterInterfaceQrLastMembQueryIntvl=_RlmgmdRouterInterfaceQrLastMembQueryIntvl_Object((1,3,6,1,4,1,89,225,1,1,13),_RlmgmdRouterInterfaceQrLastMembQueryIntvl_Type())
...
rlmgmdRouterInterfaceExtSrcAndGrpFilter=_RlmgmdRouterInterfaceExtSrcAndGrpFilter_Object((1,3,6,1,4,1,89,225,1,1,14),_RlmgmdRouterInterfaceExtSrcAndGrpFilter_Type())
...
rlMgmdRouterInterfaceExtAdminStatus=_RlMgmdRouterInterfaceExtAdminStatus_Object((1,3,6,1,4,1,89,225,1,1,15),_RlMgmdRouterInterfaceExtAdminStatus_Type())
...
rlMgmdRouterInterfaceExtOperStatus=_RlMgmdRouterInterfaceExtOperStatus_Object((1,3,6,1,4,1,89,225,1,1,16),_RlMgmdRouterInterfaceExtOperStatus_Type())
...
rlMgmdRouterInterfaceExtIsQuerier=_RlMgmdRouterInterfaceExtIsQuerier_Object((1,3,6,1,4,1,89,225,1,1,17),_RlMgmdRouterInterfaceExtIsQuerier_Type())
...
rlMgmdRouterInterfaceExtProxyDownProtected=_RlMgmdRouterInterfaceExtProxyDownProtected_Object((1,3,6,1,4,1,89,225,1,1,18),_RlMgmdRouterInterfaceExtProxyDownProtected_Type())
