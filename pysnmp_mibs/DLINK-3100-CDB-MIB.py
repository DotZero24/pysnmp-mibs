# SNMP MIB module (DLINK-3100-CDB-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-3100-CDB-MIB
...
rlStartupCDBChanged = _RlStartupCDBChanged_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 94, 1),
...
rlManualReboot = _RlManualReboot_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 94, 2),
