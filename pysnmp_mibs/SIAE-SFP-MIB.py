...
mibBuilder.exportSymbols("SIAE-SFP-MIB", sfpLinkLength62u5=sfpLinkLength62u5, sfpSerialIdValid=sfpSerialIdValid, sfpWavelength=sfpWavelength, sfpLinkLengthCopper=sfpLinkLengthCopper, sfpTxDisablePinIn=sfpTxDisablePinIn, sfpThresholdHighAlarm=sfpThresholdHighAlarm, sfpLowAlarmSeverityCode=sfpLowAlarmSeverityCode, sfpInternalAlarms=sfpInternalAlarms, sfpSerialIdTable=sfpSerialIdTable, sfpLinkLength9u=sfpLinkLength9u, sfpTxPower=sfpTxPower, sfpAlarmEntry=sfpAlarmEntry, sfpLabel=sfpLabel, sfpTemperature=sfpTemperature, sfpDiagnosticTable=sfpDiagnosticTable, sfpHighWarningAlarm=sfpHighWarningAlarm, sfpEnhancedOptionsCode=sfpEnhancedOptionsCode, sfpVendorSN=sfpVendorSN, sfpLowWarningAlarmSeverityCode=sfpLowWarningAlarmSeverityCode, sfpTxBias=sfpTxBias, sfpFailAlarmSeverityCode=sfpFailAlarmSeverityCode, PhysicalQuantity=PhysicalQuantity, sfpCompliance=sfpCompliance, sfpHighAlarm=sfpHighAlarm, sfpVendorName=sfpVendorName, sfpDiagnosticValid=sfpDiagnosticValid, sfpModuleId=sfpModuleId, sfpLOSPinOut=sfpLOSPinOut, sfpNominalBitRate=sfpNominalBitRate, sfpVendorPartNumber=sfpVendorPartNumber, sfpTxFaultPinOut=sfpTxFaultPinOut, sfpRxPower=sfpRxPower, sfpAlarmTable=sfpAlarmTable, sfpDiagnosticEntry=sfpDiagnosticEntry, sfpMibVersion=sfpMibVersion, sfpDiagMonitorCode=sfpDiagMonitorCode, sfpHighWarningAlarmSeverityCode=sfpHighWarningAlarmSeverityCode, PYSNMP_MODULE_ID=sfp, sfpVoltage=sfpVoltage, sfpHighAlarmSeverityCode=sfpHighAlarmSeverityCode, sfpFibreChannelMedia=sfpFibreChannelMedia, sfpLinkLength50u=sfpLinkLength50u, sfpRateSelectPinIn=sfpRateSelectPinIn, sfpThresholdLowAlarm=sfpThresholdLowAlarm, sfp=sfp, sfpLowWarningAlarm=sfpLowWarningAlarm, sfpPhysicalQuantity=sfpPhysicalQuantity, sfpThresholdLowWarning=sfpThresholdLowWarning, Temperature=Temperature, sfpOptions=sfpOptions, sfpFailAlarm=sfpFailAlarm, sfpThresholdHighWarning=sfpThresholdHighWarning, sfpInternalWarnings=sfpInternalWarnings, sfpLowAlarm=sfpLowAlarm, sfpSerialIdEntry=sfpSerialIdEntry, sfpVendorDateCode=sfpVendorDateCode, sfpVendorRev=sfpVendorRev)
