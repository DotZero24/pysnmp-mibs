...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/siaemic/SIAE-SFP-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:24:51 2025
...
mibBuilder.exportSymbols("SIAE-SFP-MIB", sfpTxBias=sfpTxBias, sfpVendorName=sfpVendorName, sfpNominalBitRate=sfpNominalBitRate, sfpCompliance=sfpCompliance, sfpThresholdHighWarning=sfpThresholdHighWarning, sfpTxDisablePinIn=sfpTxDisablePinIn, sfpPhysicalQuantity=sfpPhysicalQuantity, sfpTxFaultPinOut=sfpTxFaultPinOut, sfpVendorSN=sfpVendorSN, PYSNMP_MODULE_ID=sfp, sfpDiagMonitorCode=sfpDiagMonitorCode, sfpVendorPartNumber=sfpVendorPartNumber, sfpEnhancedOptionsCode=sfpEnhancedOptionsCode, sfpLinkLength9u=sfpLinkLength9u, sfpTxPower=sfpTxPower, sfpAlarmTable=sfpAlarmTable, sfpInternalWarnings=sfpInternalWarnings, sfpFailAlarmSeverityCode=sfpFailAlarmSeverityCode, sfpLowAlarmSeverityCode=sfpLowAlarmSeverityCode, sfpRateSelectPinIn=sfpRateSelectPinIn, sfpLabel=sfpLabel, sfpHighWarningAlarmSeverityCode=sfpHighWarningAlarmSeverityCode, sfpLowWarningAlarmSeverityCode=sfpLowWarningAlarmSeverityCode, sfpLinkLengthCopper=sfpLinkLengthCopper, sfpLOSPinOut=sfpLOSPinOut, PhysicalQuantity=PhysicalQuantity, sfpTemperature=sfpTemperature, sfpHighWarningAlarm=sfpHighWarningAlarm, sfpRxPower=sfpRxPower, sfpLinkLength50u=sfpLinkLength50u, sfpDiagnosticTable=sfpDiagnosticTable, sfp=sfp, sfpDiagnosticEntry=sfpDiagnosticEntry, sfpHighAlarmSeverityCode=sfpHighAlarmSeverityCode, sfpLowAlarm=sfpLowAlarm, sfpLowWarningAlarm=sfpLowWarningAlarm, sfpMibVersion=sfpMibVersion, sfpModuleId=sfpModuleId, sfpDiagnosticValid=sfpDiagnosticValid, sfpSerialIdTable=sfpSerialIdTable, sfpThresholdLowWarning=sfpThresholdLowWarning, sfpLinkLength62u5=sfpLinkLength62u5, sfpVendorDateCode=sfpVendorDateCode, sfpSerialIdValid=sfpSerialIdValid, sfpThresholdHighAlarm=sfpThresholdHighAlarm, sfpAlarmEntry=sfpAlarmEntry, sfpThresholdLowAlarm=sfpThresholdLowAlarm, sfpVoltage=sfpVoltage, Temperature=Temperature, sfpFailAlarm=sfpFailAlarm, sfpHighAlarm=sfpHighAlarm, sfpVendorRev=sfpVendorRev, sfpWavelength=sfpWavelength, sfpInternalAlarms=sfpInternalAlarms, sfpSerialIdEntry=sfpSerialIdEntry, sfpFibreChannelMedia=sfpFibreChannelMedia, sfpOptions=sfpOptions)
