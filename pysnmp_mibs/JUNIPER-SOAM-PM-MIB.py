...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:31:20 2025
...
Dot1agCfmMepIdOrZero, Dot1afCfmIndexIntegerNextFree, dot1agCfmMdIndex, dot1agCfmMaIndex, dot1agCfmMepIdentifier, dot1agCfmMepEntry = mibBuilder.importSymbols("IEEE8021-CFM-MIB", "Dot1agCfmMepIdOrZero", "Dot1afCfmIndexIntegerNextFree", "dot1agCfmMdIndex", "dot1agCfmMaIndex", "dot1agCfmMepIdentifier", "dot1agCfmMepEntry")
...
DisplayString, MacAddress, TimeInterval, TimeStamp, TDomain, RowStatus, TAddress, DateAndTime, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "MacAddress", "TimeInterval", "TimeStamp", "TDomain", "RowStatus", "TAddress", "DateAndTime", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("JUNIPER-SOAM-PM-MIB", jnxSoamLmCfgSessionType=jnxSoamLmCfgSessionType, jnxSoamDmCfgHistoryClear=jnxSoamDmCfgHistoryClear, jnxSoamDmCfgFrameSize=jnxSoamDmCfgFrameSize, jnxSoamLmCurrentStatsBackwardMaxFlr=jnxSoamLmCurrentStatsBackwardMaxFlr, jnxSoamDmMeasuredStatsFrameDelayBackward=jnxSoamDmMeasuredStatsFrameDelayBackward, jnxSoamLmHistoryStatsSoamPdusSent=jnxSoamLmHistoryStatsSoamPdusSent, jnxSoamDmHistoryStatsIfdvForwardMax=jnxSoamDmHistoryStatsIfdvForwardMax, jnxSoamLmHistoryAvailStatsTable=jnxSoamLmHistoryAvailStatsTable, jnxSoamLmHistoryAvailStatsForwardUnavailable=jnxSoamLmHistoryAvailStatsForwardUnavailable, jnxSoamLmThresholdCfgEnable=jnxSoamLmThresholdCfgEnable, jnxSoamDmCfgType=jnxSoamDmCfgType, jnxSoamLmHistoryAvailStatsBackwardMinFlr=jnxSoamLmHistoryAvailStatsBackwardMinFlr, jnxSoamLmHistoryAvailStatsForwardConsecutiveHighLoss=jnxSoamLmHistoryAvailStatsForwardConsecutiveHighLoss, jnxSoamLmCurrentAvailStatsBackwardMaxFlr=jnxSoamLmCurrentAvailStatsBackwardMaxFlr, jnxSoamLmCurrentStatsForwardTransmittedFrames=jnxSoamLmCurrentStatsForwardTransmittedFrames, jnxSoamDmCurrentStatsFrameDelayForwardMin=jnxSoamDmCurrentStatsFrameDelayForwardMin, jnxSoamLmCfgTable=jnxSoamLmCfgTable, jnxSoamLmCfgRowStatus=jnxSoamLmCfgRowStatus, jnxSoamLmHistoryStatsIndex=jnxSoamLmHistoryStatsIndex, jnxSoamLmCurrentAvailStatsForwardAvailable=jnxSoamLmCurrentAvailStatsForwardAvailable, jnxSoamLmHistoryStatsEntry=jnxSoamLmHistoryStatsEntry, jnxSoamLmCfgNumIntervalsStored=jnxSoamLmCfgNumIntervalsStored, JnxSoamTcAvailabilityType=JnxSoamTcAvailabilityType, jnxSoamLmCfgRelativeStartTime=jnxSoamLmCfgRelativeStartTime, jnxSoamDmHistoryStatsSoamPdusReceived=jnxSoamDmHistoryStatsSoamPdusReceived, jnxSoamLmCfgMessagePeriod=jnxSoamLmCfgMessagePeriod, jnxSoamLmHistoryStatsBackwardAvgFlr=jnxSoamLmHistoryStatsBackwardAvgFlr, jnxSoamLmCfgTestTlvIncluded=jnxSoamLmCfgTestTlvIncluded, jnxSoamDmHistoryStatsIfdvBackwardMin=jnxSoamDmHistoryStatsIfdvBackwardMin, jnxSoamLmHistoryAvailStatsBackwardHighLoss=jnxSoamLmHistoryAvailStatsBackwardHighLoss, jnxSoamDmCfgFixedStopDateAndTime=jnxSoamDmCfgFixedStopDateAndTime, jnxSoamLmCurrentAvailStatsTable=jnxSoamLmCurrentAvailStatsTable, jnxSoamPmNotificationObjCurrentState=jnxSoamPmNotificationObjCurrentState, jnxSoamDmMeasuredStatsIfdvBackward=jnxSoamDmMeasuredStatsIfdvBackward, jnxSoamDmCfgDestIsMepId=jnxSoamDmCfgDestIsMepId, jnxSoamLmCurrentAvailStatsIndex=jnxSoamLmCurrentAvailStatsIndex, jnxSoamDmMeasuredStatsFrameDelayTwoWay=jnxSoamDmMeasuredStatsFrameDelayTwoWay, jnxSoamDmCfgEnabled=jnxSoamDmCfgEnabled, jnxSoamLmSessionStartStopAlarm=jnxSoamLmSessionStartStopAlarm, jnxSoamDmHistoryStatsBinsEntry=jnxSoamDmHistoryStatsBinsEntry, jnxSoamDmHistoryStatsFrameDelayBackwardMax=jnxSoamDmHistoryStatsFrameDelayBackwardMax, jnxSoamLmCfgEnabled=jnxSoamLmCfgEnabled, jnxSoamDmCfgTestTlvPattern=jnxSoamDmCfgTestTlvPattern, jnxSoamDmHistoryStatsIfdvTwoWayAvg=jnxSoamDmHistoryStatsIfdvTwoWayAvg, jnxSoamLmHistoryStatsSuspect=jnxSoamLmHistoryStatsSuspect, jnxSoamDmHistoryStatsFrameDelayForwardMax=jnxSoamDmHistoryStatsFrameDelayForwardMax, jnxSoamLmHistoryAvailStatsElapsedTime=jnxSoamLmHistoryAvailStatsElapsedTime, jnxSoamPmNotificationObjThresholdLastValue=jnxSoamPmNotificationObjThresholdLastValue, jnxSoamLmCfgDataPattern=jnxSoamLmCfgDataPattern, jnxSoamDmCurrentStatsFrameDelayBackwardMin=jnxSoamDmCurrentStatsFrameDelayBackwardMin, jnxSoamPmMib=jnxSoamPmMib, jnxSoamLmHistoryStatsForwardReceivedFrames=jnxSoamLmHistoryStatsForwardReceivedFrames, jnxSoamLmCfgStartTimeType=jnxSoamLmCfgStartTimeType, jnxSoamLmHistoryStatsBackwardMaxFlr=jnxSoamLmHistoryStatsBackwardMaxFlr, jnxSoamDmCurrentStatsFrameDelayTwoWayAvg=jnxSoamDmCurrentStatsFrameDelayTwoWayAvg, jnxSoamLmCfgFixedStartDateAndTime=jnxSoamLmCfgFixedStartDateAndTime, jnxSoamDmCurrentStatsFrameDelayForwardAvg=jnxSoamDmCurrentStatsFrameDelayForwardAvg, jnxSoamDmCurrentStatsIfdvForwardMax=jnxSoamDmCurrentStatsIfdvForwardMax, jnxSoamLmCfgFrameSize=jnxSoamLmCfgFrameSize, jnxSoamDmThresholdCfgEntry=jnxSoamDmThresholdCfgEntry, jnxSoamPmNotificationObjThresholdConfig=jnxSoamPmNotificationObjThresholdConfig, jnxSoamDmCurrentStatsEntry=jnxSoamDmCurrentStatsEntry, jnxSoamDmThresholdCfgIndex=jnxSoamDmThresholdCfgIndex, jnxSoamPmNotificationObjPriority=jnxSoamPmNotificationObjPriority, jnxSoamDmCfgInterFrameDelayVariationSelectionOffset=jnxSoamDmCfgInterFrameDelayVariationSelectionOffset, jnxSoamLmMeasuredStatsBackwardFlr=jnxSoamLmMeasuredStatsBackwardFlr, jnxSoamLmHistoryStatsForwardMaxFlr=jnxSoamLmHistoryStatsForwardMaxFlr, jnxSoamDmHistoryStatsEndTime=jnxSoamDmHistoryStatsEndTime, jnxSoamDmHistoryStatsIfdvTwoWayMax=jnxSoamDmHistoryStatsIfdvTwoWayMax, jnxSoamLmThresholdCfgTable=jnxSoamLmThresholdCfgTable, jnxSoamDmCurrentStatsFrameDelayRangeTwoWayAvg=jnxSoamDmCurrentStatsFrameDelayRangeTwoWayAvg, jnxSoamLmCurrentStatsSoamPdusSent=jnxSoamLmCurrentStatsSoamPdusSent, jnxSoamPmNotificationObjDestinationMep=jnxSoamPmNotificationObjDestinationMep, jnxSoamDmCurrentStatsFrameDelayRangeForwardMax=jnxSoamDmCurrentStatsFrameDelayRangeForwardMax, jnxSoamLmCurrentStatsBackwardAvgFlr=jnxSoamLmCurrentStatsBackwardAvgFlr, jnxSoamDmHistoryStatsSoamPdusSent=jnxSoamDmHistoryStatsSoamPdusSent, jnxSoamPmMepDmSingleEndedResponder=jnxSoamPmMepDmSingleEndedResponder, jnxSoamLmHistoryAvailStatsForwardAvgFlr=jnxSoamLmHistoryAvailStatsForwardAvgFlr, jnxSoamDmCfgMessagePeriod=jnxSoamDmCfgMessagePeriod, jnxSoamDmHistoryStatsSuspect=jnxSoamDmHistoryStatsSuspect, jnxSoamDmThresholdCfgAvgFrameDelayTwoWayThreshold=jnxSoamDmThresholdCfgAvgFrameDelayTwoWayThreshold, jnxSoamDmCfgRepetitionTime=jnxSoamDmCfgRepetitionTime, jnxSoamLmCurrentStatsElapsedTime=jnxSoamLmCurrentStatsElapsedTime, jnxSoamDmCurrentStatsIndex=jnxSoamDmCurrentStatsIndex, jnxSoamLmHistoryAvailStatsSuspect=jnxSoamLmHistoryAvailStatsSuspect, jnxSoamPmMepLmSingleEndedResponder=jnxSoamPmMepLmSingleEndedResponder, jnxSoamDmCfgNumIntervalsStored=jnxSoamDmCfgNumIntervalsStored, jnxSoamDmMeasuredStatsIfdvForward=jnxSoamDmMeasuredStatsIfdvForward, jnxSoamDmHistoryStatsFrameDelayRangeBackwardAvg=jnxSoamDmHistoryStatsFrameDelayRangeBackwardAvg, jnxSoamDmCfgTable=jnxSoamDmCfgTable, jnxSoamDmCfgNumMeasBinsPerFrameDelayInterval=jnxSoamDmCfgNumMeasBinsPerFrameDelayInterval, jnxSoamLmMeasuredStatsAvailForwardStatus=jnxSoamLmMeasuredStatsAvailForwardStatus, jnxSoamDmCurrentStatsFrameDelayBackwardAvg=jnxSoamDmCurrentStatsFrameDelayBackwardAvg, jnxSoamDmHistoryStatsEntry=jnxSoamDmHistoryStatsEntry, jnxSoamLmHistoryStatsBackwardMinFlr=jnxSoamLmHistoryStatsBackwardMinFlr, jnxSoamLmCurrentAvailStatsBackwardAvailable=jnxSoamLmCurrentAvailStatsBackwardAvailable, jnxSoamDmThresholdCfgEnable=jnxSoamDmThresholdCfgEnable, jnxSoamLmCurrentStatsSuspect=jnxSoamLmCurrentStatsSuspect, jnxSoamPmDmObjects=jnxSoamPmDmObjects, jnxSoamDmHistoryStatsFrameDelayTwoWayAvg=jnxSoamDmHistoryStatsFrameDelayTwoWayAvg, jnxSoamDmHistoryStatsFrameDelayForwardAvg=jnxSoamDmHistoryStatsFrameDelayForwardAvg, jnxSoamDmCfgSessionType=jnxSoamDmCfgSessionType, jnxSoamDmCfgRelativeStopTime=jnxSoamDmCfgRelativeStopTime, jnxSoamLmCurrentAvailStatsForwardHighLoss=jnxSoamLmCurrentAvailStatsForwardHighLoss, jnxSoamDmCurrentStatsSoamPdusSent=jnxSoamDmCurrentStatsSoamPdusSent, jnxSoamLmCfgRepetitionTime=jnxSoamLmCfgRepetitionTime, jnxSoamLmCfgDestMacAddress=jnxSoamLmCfgDestMacAddress, jnxSoamLmCurrentStatsForwardMinFlr=jnxSoamLmCurrentStatsForwardMinFlr, jnxSoamPmNotificationObjLastDateAndTime=jnxSoamPmNotificationObjLastDateAndTime, jnxSoamDmCurrentStatsIfdvBackwardMin=jnxSoamDmCurrentStatsIfdvBackwardMin, jnxSoamLmHistoryAvailStatsBackwardUnavailable=jnxSoamLmHistoryAvailStatsBackwardUnavailable, jnxSoamDmCfgMeasBinLowerBound=jnxSoamDmCfgMeasBinLowerBound, jnxSoamLmCfgAvailabilityFlrThreshold=jnxSoamLmCfgAvailabilityFlrThreshold, jnxSoamLmCurrentAvailStatsForwardConsecutiveHighLoss=jnxSoamLmCurrentAvailStatsForwardConsecutiveHighLoss, jnxSoamDmMeasuredStatsEntry=jnxSoamDmMeasuredStatsEntry, jnxSoamLmCurrentStatsTable=jnxSoamLmCurrentStatsTable, jnxSoamDmCurrentStatsIfdvBackwardMax=jnxSoamDmCurrentStatsIfdvBackwardMax, jnxSoamPmThresholdCrossingAlarm=jnxSoamPmThresholdCrossingAlarm, jnxSoamLmHistoryStatsSoamPdusReceived=jnxSoamLmHistoryStatsSoamPdusReceived, JnxSoamTcDataPatternType=JnxSoamTcDataPatternType, jnxSoamDmHistoryStatsFrameDelayTwoWayMin=jnxSoamDmHistoryStatsFrameDelayTwoWayMin, jnxSoamPmNotifications=jnxSoamPmNotifications, jnxSoamLmHistoryAvailStatsBackwardAvgFlr=jnxSoamLmHistoryAvailStatsBackwardAvgFlr, jnxSoamLmHistoryAvailStatsBackwardAvailable=jnxSoamLmHistoryAvailStatsBackwardAvailable, jnxSoamLmHistoryStatsForwardAvgFlr=jnxSoamLmHistoryStatsForwardAvgFlr, jnxSoamDmCfgStopTimeType=jnxSoamDmCfgStopTimeType, jnxSoamDmHistoryStatsTable=jnxSoamDmHistoryStatsTable, jnxSoamPmNotificationCfg=jnxSoamPmNotificationCfg, jnxSoamDmCfgMeasBinNumber=jnxSoamDmCfgMeasBinNumber, jnxSoamDmCurrentStatsSoamPdusReceived=jnxSoamDmCurrentStatsSoamPdusReceived, jnxSoamLmCurrentAvailStatsBackwardMinFlr=jnxSoamLmCurrentAvailStatsBackwardMinFlr, jnxSoamPmNotificationObjThresholdValue=jnxSoamPmNotificationObjThresholdValue, jnxSoamDmHistoryStatsFrameDelayRangeForwardAvg=jnxSoamDmHistoryStatsFrameDelayRangeForwardAvg, jnxSoamDmCfgNumMeasBinsPerFrameDelayRangeInterval=jnxSoamDmCfgNumMeasBinsPerFrameDelayRangeInterval, jnxSoamLmCfgEntry=jnxSoamLmCfgEntry, jnxSoamLmMeasuredStatsEntry=jnxSoamLmMeasuredStatsEntry, jnxSoamDmCfgIndex=jnxSoamDmCfgIndex, jnxSoamLmHistoryAvailStatsForwardAvailable=jnxSoamLmHistoryAvailStatsForwardAvailable, jnxSoamPmMibObjects=jnxSoamPmMibObjects, jnxSoamDmHistoryStatsBinsCounter=jnxSoamDmHistoryStatsBinsCounter, jnxSoamLmCfgIndex=jnxSoamLmCfgIndex, jnxSoamLmCurrentAvailStatsForwardMinFlr=jnxSoamLmCurrentAvailStatsForwardMinFlr, jnxSoamDmCfgSourceMacAddress=jnxSoamDmCfgSourceMacAddress, jnxSoamLmCurrentAvailStatsBackwardConsecutiveHighLoss=jnxSoamLmCurrentAvailStatsBackwardConsecutiveHighLoss, jnxSoamPmNotificationObjCrossingType=jnxSoamPmNotificationObjCrossingType, jnxSoamDmCurrentStatsFrameDelayRangeForwardAvg=jnxSoamDmCurrentStatsFrameDelayRangeForwardAvg, jnxSoamPmNotificationObj=jnxSoamPmNotificationObj, jnxSoamDmCurrentStatsIfdvTwoWayMin=jnxSoamDmCurrentStatsIfdvTwoWayMin, jnxSoamLmHistoryAvailStatsForwardHighLoss=jnxSoamLmHistoryAvailStatsForwardHighLoss, jnxSoamDmCfgFixedStartDateAndTime=jnxSoamDmCfgFixedStartDateAndTime, jnxSoamLmHistoryStatsBackwardReceivedFrames=jnxSoamLmHistoryStatsBackwardReceivedFrames, jnxSoamDmCfgMeasBinTable=jnxSoamDmCfgMeasBinTable, jnxSoamDmCurrentStatsSuspect=jnxSoamDmCurrentStatsSuspect, JnxSoamTcDelayMeasurementBinType=JnxSoamTcDelayMeasurementBinType, jnxSoamLmCurrentStatsSoamPdusReceived=jnxSoamLmCurrentStatsSoamPdusReceived, jnxSoamPmMepSlmSingleEndedResponder=jnxSoamPmMepSlmSingleEndedResponder, jnxSoamLmCurrentStatsBackwardTransmittedFrames=jnxSoamLmCurrentStatsBackwardTransmittedFrames, jnxSoamDmCfgStartTimeType=jnxSoamDmCfgStartTimeType, jnxSoamLmCfgFixedStopDateAndTime=jnxSoamLmCfgFixedStopDateAndTime, jnxSoamDmCfgSessionStatus=jnxSoamDmCfgSessionStatus, jnxSoamLmCfgRelativeStopTime=jnxSoamLmCfgRelativeStopTime, jnxSoamDmHistoryStatsIfdvBackwardAvg=jnxSoamDmHistoryStatsIfdvBackwardAvg, jnxSoamLmCfgStopTimeType=jnxSoamLmCfgStopTimeType, jnxSoamDmCurrentStatsStartTime=jnxSoamDmCurrentStatsStartTime, jnxSoamLmHistoryStatsEndTime=jnxSoamLmHistoryStatsEndTime, jnxSoamDmMeasuredStatsTable=jnxSoamDmMeasuredStatsTable, jnxSoamLmCurrentAvailStatsForwardMaxFlr=jnxSoamLmCurrentAvailStatsForwardMaxFlr, jnxSoamLmCurrentStatsBackwardReceivedFrames=jnxSoamLmCurrentStatsBackwardReceivedFrames, jnxSoamLmCfgMeasurementInterval=jnxSoamLmCfgMeasurementInterval, jnxSoamDmHistoryStatsFrameDelayRangeTwoWayAvg=jnxSoamDmHistoryStatsFrameDelayRangeTwoWayAvg, jnxSoamLmCurrentAvailStatsEntry=jnxSoamLmCurrentAvailStatsEntry, jnxSoamDmThresholdCfgAvgIfdvTwoWayThreshold=jnxSoamDmThresholdCfgAvgIfdvTwoWayThreshold, jnxSoamDmCurrentStatsFrameDelayForwardMax=jnxSoamDmCurrentStatsFrameDelayForwardMax, jnxSoamDmHistoryStatsFrameDelayRangeBackwardMax=jnxSoamDmHistoryStatsFrameDelayRangeBackwardMax, jnxSoamDmThresholdCfgRowStatus=jnxSoamDmThresholdCfgRowStatus, jnxSoamDmHistoryStatsFrameDelayRangeTwoWayMax=jnxSoamDmHistoryStatsFrameDelayRangeTwoWayMax, jnxSoamLmCfgAlignMeasurementOffset=jnxSoamLmCfgAlignMeasurementOffset, jnxSoamLmHistoryStatsForwardMinFlr=jnxSoamLmHistoryStatsForwardMinFlr, jnxSoamDmCfgRowStatus=jnxSoamDmCfgRowStatus, JnxSoamTcOperationTimeType=JnxSoamTcOperationTimeType, jnxSoamPmNotificationObjThresholdId=jnxSoamPmNotificationObjThresholdId, jnxSoamDmCfgAlignMeasurementIntervals=jnxSoamDmCfgAlignMeasurementIntervals, jnxSoamLmCfgAvailabilityNumConsecutiveHighFlr=jnxSoamLmCfgAvailabilityNumConsecutiveHighFlr, jnxSoamLmCurrentStatsBackwardMinFlr=jnxSoamLmCurrentStatsBackwardMinFlr, jnxSoamLmCfgAvailabilityNumConsecutiveMeasPdus=jnxSoamLmCfgAvailabilityNumConsecutiveMeasPdus, jnxSoamLmCfgVersion=jnxSoamLmCfgVersion, jnxSoamDmCfgMeasBinEntry=jnxSoamDmCfgMeasBinEntry, jnxSoamLmHistoryAvailStatsForwardMaxFlr=jnxSoamLmHistoryAvailStatsForwardMaxFlr, jnxSoamDmCurrentStatsFrameDelayBackwardMax=jnxSoamDmCurrentStatsFrameDelayBackwardMax, jnxSoamDmCfgPriority=jnxSoamDmCfgPriority, jnxSoamLmCurrentStatsForwardAvgFlr=jnxSoamLmCurrentStatsForwardAvgFlr, jnxSoamDmHistoryStatsFrameDelayForwardMin=jnxSoamDmHistoryStatsFrameDelayForwardMin, jnxSoamLmThresholdCfgAvgFlrForwardThreshold=jnxSoamLmThresholdCfgAvgFlrForwardThreshold, jnxSoamLmHistoryAvailStatsBackwardMaxFlr=jnxSoamLmHistoryAvailStatsBackwardMaxFlr, JnxSoamTcTestPatternType=JnxSoamTcTestPatternType, jnxSoamDmCurrentStatsIfdvTwoWayMax=jnxSoamDmCurrentStatsIfdvTwoWayMax, jnxSoamDmHistoryStatsFrameDelayBackwardMin=jnxSoamDmHistoryStatsFrameDelayBackwardMin, jnxSoamLmCurrentAvailStatsStartTime=jnxSoamLmCurrentAvailStatsStartTime, jnxSoamDmCfgMeasurementEnable=jnxSoamDmCfgMeasurementEnable, jnxSoamLmHistoryStatsTable=jnxSoamLmHistoryStatsTable, jnxSoamLmCfgPriority=jnxSoamLmCfgPriority, jnxSoamDmCfgAlignMeasurementOffset=jnxSoamDmCfgAlignMeasurementOffset, jnxSoamDmCurrentStatsIfdvTwoWayAvg=jnxSoamDmCurrentStatsIfdvTwoWayAvg, jnxSoamLmCfgAvailabilityNumConsecutiveIntervals=jnxSoamLmCfgAvailabilityNumConsecutiveIntervals, jnxSoamDmHistoryStatsIfdvForwardAvg=jnxSoamDmHistoryStatsIfdvForwardAvg, jnxSoamLmCfgMeasurementEnable=jnxSoamLmCfgMeasurementEnable, jnxSoamDmCurrentStatsTable=jnxSoamDmCurrentStatsTable, jnxSoamDmCurrentStatsFrameDelayTwoWayMin=jnxSoamDmCurrentStatsFrameDelayTwoWayMin, jnxSoamDmHistoryStatsElapsedTime=jnxSoamDmHistoryStatsElapsedTime, jnxSoamLmCfgAlignMeasurementIntervals=jnxSoamLmCfgAlignMeasurementIntervals, jnxSoamLmMeasuredStatsAvailBackwardLastTransitionTime=jnxSoamLmMeasuredStatsAvailBackwardLastTransitionTime, jnxSoamLmHistoryAvailStatsBackwardConsecutiveHighLoss=jnxSoamLmHistoryAvailStatsBackwardConsecutiveHighLoss, jnxSoamDmCurrentStatsBinsCounter=jnxSoamDmCurrentStatsBinsCounter, jnxSoamPmMepEntry=jnxSoamPmMepEntry, jnxSoamLmCfgDestIsMepId=jnxSoamLmCfgDestIsMepId, jnxSoamDmCurrentStatsFrameDelayTwoWayMax=jnxSoamDmCurrentStatsFrameDelayTwoWayMax, jnxSoamDmHistoryStatsFrameDelayRangeForwardMax=jnxSoamDmHistoryStatsFrameDelayRangeForwardMax, jnxSoamDmCfgRelativeStartTime=jnxSoamDmCfgRelativeStartTime, jnxSoamLmCurrentAvailStatsElapsedTime=jnxSoamLmCurrentAvailStatsElapsedTime, jnxSoamDmMeasuredStatsIfdvTwoWay=jnxSoamDmMeasuredStatsIfdvTwoWay, jnxSoamLmCurrentAvailStatsForwardAvgFlr=jnxSoamLmCurrentAvailStatsForwardAvgFlr, jnxSoamLmCfgDestMepId=jnxSoamLmCfgDestMepId, jnxSoamLmCurrentStatsStartTime=jnxSoamLmCurrentStatsStartTime, jnxSoamLmCfgSessionStatus=jnxSoamLmCfgSessionStatus, jnxSoamDmCurrentStatsFrameDelayRangeBackwardAvg=jnxSoamDmCurrentStatsFrameDelayRangeBackwardAvg, PYSNMP_MODULE_ID=jnxSoamPmMib, jnxSoamDmHistoryStatsIfdvForwardMin=jnxSoamDmHistoryStatsIfdvForwardMin, jnxSoamLmThresholdCfgAvgFlrBackwardThreshold=jnxSoamLmThresholdCfgAvgFlrBackwardThreshold, jnxSoamLmCurrentStatsIndex=jnxSoamLmCurrentStatsIndex, jnxSoamLmCurrentStatsForwardMaxFlr=jnxSoamLmCurrentStatsForwardMaxFlr, jnxSoamDmCfgMeasBinType=jnxSoamDmCfgMeasBinType, jnxSoamDmCfgMeasurementInterval=jnxSoamDmCfgMeasurementInterval, jnxSoamDmCurrentStatsIfdvBackwardAvg=jnxSoamDmCurrentStatsIfdvBackwardAvg, jnxSoamDmMeasuredStatsFrameDelayForward=jnxSoamDmMeasuredStatsFrameDelayForward, jnxSoamDmThresholdCfgTable=jnxSoamDmThresholdCfgTable, jnxSoamPmNotificationObjDateAndTime=jnxSoamPmNotificationObjDateAndTime, jnxSoamDmCurrentStatsIfdvForwardMin=jnxSoamDmCurrentStatsIfdvForwardMin, jnxSoamDmHistoryStatsFrameDelayTwoWayMax=jnxSoamDmHistoryStatsFrameDelayTwoWayMax, jnxSoamLmMeasuredStatsAvailForwardLastTransitionTime=jnxSoamLmMeasuredStatsAvailForwardLastTransitionTime, jnxSoamDmCurrentStatsIfdvForwardAvg=jnxSoamDmCurrentStatsIfdvForwardAvg, jnxSoamLmMeasuredStatsTable=jnxSoamLmMeasuredStatsTable, jnxSoamDmCfgVersion=jnxSoamDmCfgVersion, jnxSoamDmHistoryStatsFrameDelayBackwardAvg=jnxSoamDmHistoryStatsFrameDelayBackwardAvg, jnxSoamLmThresholdCfgEntry=jnxSoamLmThresholdCfgEntry, jnxSoamLmThresholdCfgIndex=jnxSoamLmThresholdCfgIndex, jnxSoamLmHistoryAvailStatsForwardMinFlr=jnxSoamLmHistoryAvailStatsForwardMinFlr, jnxSoamDmCurrentStatsBinsTable=jnxSoamDmCurrentStatsBinsTable, jnxSoamDmHistoryStatsBinsTable=jnxSoamDmHistoryStatsBinsTable, jnxSoamDmCfgNumMeasBinsPerInterFrameDelayVariationInterval=jnxSoamDmCfgNumMeasBinsPerInterFrameDelayVariationInterval, jnxSoamLmCurrentAvailStatsBackwardUnavailable=jnxSoamLmCurrentAvailStatsBackwardUnavailable, jnxSoamDmSessionStartStopAlarm=jnxSoamDmSessionStartStopAlarm, jnxSoamDmCfgDestMacAddress=jnxSoamDmCfgDestMacAddress, jnxSoamPmMepOperNextIndex=jnxSoamPmMepOperNextIndex, jnxSoamLmCfgType=jnxSoamLmCfgType)
mibBuilder.exportSymbols("JUNIPER-SOAM-PM-MIB", jnxSoamDmCurrentStatsElapsedTime=jnxSoamDmCurrentStatsElapsedTime, jnxSoamLmCurrentAvailStatsBackwardAvgFlr=jnxSoamLmCurrentAvailStatsBackwardAvgFlr, jnxSoamPmMep=jnxSoamPmMep, jnxSoamPmNotificationAccTotalFlaps=jnxSoamPmNotificationAccTotalFlaps, jnxSoamDmCfgDataPattern=jnxSoamDmCfgDataPattern, jnxSoamDmCurrentStatsFrameDelayRangeTwoWayMax=jnxSoamDmCurrentStatsFrameDelayRangeTwoWayMax, jnxSoamLmCfgTestTlvPattern=jnxSoamLmCfgTestTlvPattern, jnxSoamLmCurrentStatsEntry=jnxSoamLmCurrentStatsEntry, jnxSoamLmCurrentStatsForwardReceivedFrames=jnxSoamLmCurrentStatsForwardReceivedFrames, jnxSoamDmCfgTestTlvIncluded=jnxSoamDmCfgTestTlvIncluded, jnxSoamDmHistoryStatsIfdvTwoWayMin=jnxSoamDmHistoryStatsIfdvTwoWayMin, jnxSoamLmCurrentAvailStatsSuspect=jnxSoamLmCurrentAvailStatsSuspect, jnxSoamLmCurrentAvailStatsForwardUnavailable=jnxSoamLmCurrentAvailStatsForwardUnavailable, jnxSoamDmCurrentStatsBinsEntry=jnxSoamDmCurrentStatsBinsEntry, jnxSoamLmCfgAvailabilityMeasurementInterval=jnxSoamLmCfgAvailabilityMeasurementInterval, jnxSoamPmNotificationObjSuspect=jnxSoamPmNotificationObjSuspect, jnxSoamPmThresholdFlapAlarm=jnxSoamPmThresholdFlapAlarm, jnxSoamLmMeasuredStatsForwardFlr=jnxSoamLmMeasuredStatsForwardFlr, jnxSoamLmCfgHistoryClear=jnxSoamLmCfgHistoryClear, jnxSoamDmHistoryStatsIfdvBackwardMax=jnxSoamDmHistoryStatsIfdvBackwardMax, jnxSoamLmHistoryAvailStatsIndex=jnxSoamLmHistoryAvailStatsIndex, jnxSoamLmHistoryStatsForwardTransmittedFrames=jnxSoamLmHistoryStatsForwardTransmittedFrames, jnxSoamLmHistoryAvailStatsEntry=jnxSoamLmHistoryAvailStatsEntry, jnxSoamLmThresholdCfgRowStatus=jnxSoamLmThresholdCfgRowStatus, jnxSoamPmNotificationTotalFlaps=jnxSoamPmNotificationTotalFlaps, jnxSoamDmCfgEntry=jnxSoamDmCfgEntry, jnxSoamDmHistoryStatsIndex=jnxSoamDmHistoryStatsIndex, jnxSoamLmHistoryAvailStatsEndTime=jnxSoamLmHistoryAvailStatsEndTime, jnxSoamPmMibConformance=jnxSoamPmMibConformance, jnxSoamLmHistoryStatsBackwardTransmittedFrames=jnxSoamLmHistoryStatsBackwardTransmittedFrames, jnxSoamLmHistoryStatsElapsedTime=jnxSoamLmHistoryStatsElapsedTime, jnxSoamLmCurrentAvailStatsBackwardHighLoss=jnxSoamLmCurrentAvailStatsBackwardHighLoss, jnxSoamLmMeasuredStatsAvailBackwardStatus=jnxSoamLmMeasuredStatsAvailBackwardStatus, jnxSoamPmMepTable=jnxSoamPmMepTable, jnxSoamDmCurrentStatsFrameDelayRangeBackwardMax=jnxSoamDmCurrentStatsFrameDelayRangeBackwardMax, jnxSoamPmLmObjects=jnxSoamPmLmObjects, jnxSoamDmCfgDestMepId=jnxSoamDmCfgDestMepId)
