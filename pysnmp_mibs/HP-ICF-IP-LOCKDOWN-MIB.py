...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-IP-LOCKDOWN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:42:43 2025
...
_HpicfIpLockTrapCtrl_Type.__name__ = "TruthValue"
...
hpicfIpLockCompliance.setObjects(
    ("HP-ICF-IP-LOCKDOWN-MIB", "hpicfIpLockBaseGroup")
)
if mibBuilder.loadTexts:
...
hpicfIpLockTrapCompliance.setObjects(
      *(("HP-ICF-IP-LOCKDOWN-MIB", "hpicfIpLockTrapObjectsGroup"),
        ("HP-ICF-IP-LOCKDOWN-MIB", "hpicfIpLockTrapsGroup"))
)
if mibBuilder.loadTexts:
