...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-BULK-FILE-MIB
...
_CbfDefineFileNotifyOnCompletion_Type.__name__ = "TruthValue"
...
_CbfDefineObjectID_Type.__name__ = "ObjectIdentifier"
...
_CbfDefineObjectTableInstance_Type.__name__ = "ObjectIdentifier"
...
ciscoBulkFileMIBCompliance.setObjects(
      *(("CISCO-BULK-FILE-MIB", "ciscoBulkFileDefineGroup"),
        ("CISCO-BULK-FILE-MIB", "ciscoBulkFileStatusGroup"),
        ("CISCO-BULK-FILE-MIB", "ciscoBulkFileNotiGroup"))
)
if mibBuilder.loadTexts:
...
ciscoBulkFileMIBComplianceRev1.setObjects(
      *(("CISCO-BULK-FILE-MIB", "ciscoBulkFileDefineGroupRev1"),
        ("CISCO-BULK-FILE-MIB", "ciscoBulkFileStatusGroup"),
        ("CISCO-BULK-FILE-MIB", "ciscoBulkFileNotiGroup"))
)
if mibBuilder.loadTexts:
