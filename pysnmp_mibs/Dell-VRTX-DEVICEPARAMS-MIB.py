# SNMP MIB module (Dell-VRTX-DEVICEPARAMS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-VRTX-DEVICEPARAMS-MIB
...
rndCommunityEntry.setIndexNames(
    (0, "Dell-VRTX-DEVICEPARAMS-MIB", "rndCommunityMngStationAddr"),
    (1, "Dell-VRTX-DEVICEPARAMS-MIB", "rndCommunityString"),
)
if mibBuilder.loadTexts:
...
rndActiveSoftwareFileEntry.setIndexNames(
    (0, "Dell-VRTX-DEVICEPARAMS-MIB", "rndUnitNumber"),
)
if mibBuilder.loadTexts:
...
rndImageInfoEntry.setIndexNames(
    (0, "Dell-VRTX-DEVICEPARAMS-MIB", "rndStackUnitNumber"),
)
if mibBuilder.loadTexts:
...
rlComponentsInfoEntry.setIndexNames(
    (0, "Dell-VRTX-DEVICEPARAMS-MIB", "rlComponentsInfoStackUnitNumber"),
    (0, "Dell-VRTX-DEVICEPARAMS-MIB", "rlComponentsInfoImageId"),
    (1, "Dell-VRTX-DEVICEPARAMS-MIB", "rlComponentsInfoComponent"),
)
if mibBuilder.loadTexts:
