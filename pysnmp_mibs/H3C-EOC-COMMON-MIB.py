...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-EOC-COMMON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:18:13 2025
...
_H3cEOCCommonCltAutoAuthorize_Type.__name__ = "TruthValue"
...
_H3cEOCCommonCltMaxAllowToAccess_Type.__name__ = "Integer32"
...
h3cEOCComCnuTempIndex = _H3cEOCComCnuTempIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 83, 3, 3, 1, 3),
    _H3cEOCComCnuTempIndex_Type()
)
h3cEOCComCnuTempIndex.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cEOCComCnuTempIndex.setStatus("current")
...
_H3cEOCComUniFlowControl_Type.__name__ = "TruthValue"
...
h3cEOCLoopbackDetectTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 83, 5, 0, 23)
)
h3cEOCLoopbackDetectTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-EOC-COMMON-MIB", "h3cEOCComCnuMacAddress"))
)
if mibBuilder.loadTexts:
    h3cEOCLoopbackDetectTrap.setStatus(
        "current"
    )

h3cEOCLoopbackRecoverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 83, 5, 0, 24)
)
h3cEOCLoopbackRecoverTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("H3C-EOC-COMMON-MIB", "h3cEOCComCnuMacAddress"))
)
if mibBuilder.loadTexts:
    h3cEOCLoopbackRecoverTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"h3cEOCCommon": h3cEOCCommon,
       ...
       "h3cEOCComCnuTempIndex": h3cEOCComCnuTempIndex,
       ...
       "h3cEOCLoopbackDetectTrap": h3cEOCLoopbackDetectTrap,
       "h3cEOCLoopbackRecoverTrap": h3cEOCLoopbackRecoverTrap,
