...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cabletron/CTRON-SFPS-DIRECTORY-MIB
...
sfpsTopologyDirStats, sfpsTopologyNodes, sfpsDirFilterAPI, sfpsTopologyDAPITest, sfpsTopologyAliases, sfpsTopologyRemoteNodes, sfpsTopologyDAPI, sfpsServiceCenter = mibBuilder.importSymbols("CTRON-SFPS-INCLUDE-MIB", "sfpsTopologyDirStats", "sfpsTopologyNodes", "sfpsDirFilterAPI", "sfpsTopologyDAPITest", "sfpsTopologyAliases", "sfpsTopologyRemoteNodes", "sfpsTopologyDAPI", "sfpsServiceCenter")
...
mibBuilder.exportSymbols("CTRON-SFPS-DIRECTORY-MIB", sfpsDirFilterNodeNodeAge=sfpsDirFilterNodeNodeAge, HexInteger=HexInteger, sfpsDAPITestOutputSwitchMac=sfpsDAPITestOutputSwitchMac, sfpsTopologyDirStatsAliasRemotesReplaced=sfpsTopologyDirStatsAliasRemotesReplaced, sfpsTopologyDirStatsSwitchCacheHits=sfpsTopologyDirStatsSwitchCacheHits, sfpsDirAliasStatsNumOfAliases=sfpsDirAliasStatsNumOfAliases, sfpsAliasTableSelf=sfpsAliasTableSelf, sfpsDirFilterNodeSwitchType=sfpsDirFilterNodeSwitchType, sfpsAliasDeltaTablePort=sfpsAliasDeltaTablePort, sfpsDirFilterNodeBaseLoad=sfpsDirFilterNodeBaseLoad, sfpsDirFilterNodeLinkLock=sfpsDirFilterNodeLinkLock, sfpsNodeTableAliasCount=sfpsNodeTableAliasCount, sfpsServiceCenterDirectoryStatusTime=sfpsServiceCenterDirectoryStatusTime, sfpsDirFilterNodeSwitchLoad=sfpsDirFilterNodeSwitchLoad, sfpsAliasDeltaTable=sfpsAliasDeltaTable, sfpsTopologyDirStatsNumOfNodes=sfpsTopologyDirStatsNumOfNodes, sfpsNodeTableNodeLocal=sfpsNodeTableNodeLocal, sfpsAliasTableAliasAge=sfpsAliasTableAliasAge, sfpsDirFilterNodeLinkIndex=sfpsDirFilterNodeLinkIndex, sfpsDirFilterNodeNodeOctets=sfpsDirFilterNodeNodeOctets, sfpsTopologyDirStatsNodeAliasMax=sfpsTopologyDirStatsNodeAliasMax, sfpsTopologyDirStatsSwitchUsage=sfpsTopologyDirStatsSwitchUsage, sfpsDirFilterNodeLinkCount=sfpsDirFilterNodeLinkCount, sfpsAliasTableAliasAddress=sfpsAliasTableAliasAddress, sfpsTopologyDirStatsMaxRemoteNodes=sfpsTopologyDirStatsMaxRemoteNodes, sfpsDirFilterNodeLockCount=sfpsDirFilterNodeLockCount, sfpsDAPITestAddrTwoValue=sfpsDAPITestAddrTwoValue, sfpsDirFilterNodeNodeState=sfpsDirFilterNodeNodeState, sfpsNodeTableBaseType=sfpsNodeTableBaseType, sfpsTopologyDirStatsAliasTableUsage=sfpsTopologyDirStatsAliasTableUsage, sfpsTopologyDirStatsSwitchTableUsage=sfpsTopologyDirStatsSwitchTableUsage, sfpsNodeTablePort=sfpsNodeTablePort, sfpsDirFilterAliasLinkOctets=sfpsDirFilterAliasLinkOctets, sfpsServiceCenterDirectoryName=sfpsServiceCenterDirectoryName, sfpsAliasDeltaTableAliasLock=sfpsAliasDeltaTableAliasLock, sfpsDirFilterNodeInPort=sfpsDirFilterNodeInPort, sfpsDirFilterNodeNodeIndex=sfpsDirFilterNodeNodeIndex, sfpsTopologyDirStatsDynamicUsage=sfpsTopologyDirStatsDynamicUsage, sfpsAliasTableOpaqueTag=sfpsAliasTableOpaqueTag, sfpsAliasTableBaseHash=sfpsAliasTableBaseHash, sfpsAliasTableEntry=sfpsAliasTableEntry, sfpsDAPIPort=sfpsDAPIPort, sfpsTopologyDirStatsNodeTableSize=sfpsTopologyDirStatsNodeTableSize, sfpsTopologyDirStatsMaxLocalNodes=sfpsTopologyDirStatsMaxLocalNodes, sfpsTopologyDirStatsRemoteNodeUsage=sfpsTopologyDirStatsRemoteNodeUsage, sfpsDirFilterAliasVlanLearned=sfpsDirFilterAliasVlanLearned, sfpsTopologyDirStatsObjectsUsage=sfpsTopologyDirStatsObjectsUsage, sfpsNodeTableEntryType=sfpsNodeTableEntryType, sfpsDirFilterNodeLinkState=sfpsDirFilterNodeLinkState, sfpsAliasTableNext=sfpsAliasTableNext, sfpsServiceCenterDirectoryHashLeaf=sfpsServiceCenterDirectoryHashLeaf, sfpsDirFilterAliasLinkLoad=sfpsDirFilterAliasLinkLoad, sfpsDirFilterAPIValue=sfpsDirFilterAPIValue, sfpsTopologyDirStatsVlanUsage=sfpsTopologyDirStatsVlanUsage, sfpsNodeTableHashIndex=sfpsNodeTableHashIndex, sfpsTopologyDirStatsStaticUsage=sfpsTopologyDirStatsStaticUsage, sfpsDirFilterAPILockAdmin=sfpsDirFilterAPILockAdmin, sfpsDirFilterNodeEntry=sfpsDirFilterNodeEntry, sfpsTopologyDirStatsAliasCollisions=sfpsTopologyDirStatsAliasCollisions, sfpsAliasDeltaTableAlias=sfpsAliasDeltaTableAlias, sfpsTopologyDirStatsVlanTableSize=sfpsTopologyDirStatsVlanTableSize, sfpsAliasTableSwitchOctets=sfpsAliasTableSwitchOctets, sfpsNodeTableAge=sfpsNodeTableAge, sfpsAliasDeltaTableTimestamp=sfpsAliasDeltaTableTimestamp, sfpsTopologyDirStatsNumOfAliases=sfpsTopologyDirStatsNumOfAliases, sfpsDAPINodeValue=sfpsDAPINodeValue, sfpsDirFilterAliasTable=sfpsDirFilterAliasTable, sfpsDirFilterAliasInPort=sfpsDirFilterAliasInPort, sfpsDirFilterAliasHashIndex=sfpsDirFilterAliasHashIndex, sfpsTopologyDirStatsSwitchTableSize=sfpsTopologyDirStatsSwitchTableSize, sfpsTopologyDirStatsNumRemoteNodes=sfpsTopologyDirStatsNumRemoteNodes, sfpsDirFilterNodeNodeLocal=sfpsDirFilterNodeNodeLocal, sfpsDirFilterAliasChassisOctets=sfpsDirFilterAliasChassisOctets, sfpsTopologyDirStatsNumSwitches=sfpsTopologyDirStatsNumSwitches, sfpsDirFilterAPILockTimeOut=sfpsDirFilterAPILockTimeOut, sfpsDirFilterAliasSwitchLoad=sfpsDirFilterAliasSwitchLoad, sfpsDirFilterNodeTable=sfpsDirFilterNodeTable, sfpsDirAliasStatsEntry=sfpsDirAliasStatsEntry, sfpsTopologyDirStatsNodeUsage=sfpsTopologyDirStatsNodeUsage, sfpsTopologyDirStatsLocalAddsRefused=sfpsTopologyDirStatsLocalAddsRefused, sfpsAliasTableBaseOctets=sfpsAliasTableBaseOctets, sfpsDirFilterNodeLinkLoad=sfpsDirFilterNodeLinkLoad, sfpsAliasDeltaTableAliasLength=sfpsAliasDeltaTableAliasLength, sfpsAliasTableAliasLock=sfpsAliasTableAliasLock, sfpsDirAliasStatsMaxAliases=sfpsDirAliasStatsMaxAliases, sfpsTopologyDirStatsNodeLongestChain=sfpsTopologyDirStatsNodeLongestChain, sfpsDirFilterNodeLinkType=sfpsDirFilterNodeLinkType, sfpsAliasDeltaTableNodeLock=sfpsAliasDeltaTableNodeLock, sfpsDAPITestOutputIndex=sfpsDAPITestOutputIndex, sfpsTopologyDirStatsAliasLongestChain=sfpsTopologyDirStatsAliasLongestChain, sfpsDirFilterAliasBaseHash=sfpsDirFilterAliasBaseHash, sfpsDirFilterAliasOpaqueTag=sfpsDirFilterAliasOpaqueTag, sfpsDirFilterNodeLinkAge=sfpsDirFilterNodeLinkAge, sfpsDirFilterAliasSwitchType=sfpsDirFilterAliasSwitchType, sfpsDirFilterAliasChassisType=sfpsDirFilterAliasChassisType, sfpsAliasDeltaTableEntry=sfpsAliasDeltaTableEntry, sfpsDAPITestAddrOneValue=sfpsDAPITestAddrOneValue, sfpsDirFilterAPILockTimeElapsed=sfpsDirFilterAPILockTimeElapsed, sfpsDAPITestSwitchMac=sfpsDAPITestSwitchMac, sfpsNodeTable=sfpsNodeTable, sfpsDirFilterAliasLinkType=sfpsDirFilterAliasLinkType, sfpsAliasTablePort=sfpsAliasTablePort, sfpsTopologyDirStatsNodeCollisions=sfpsTopologyDirStatsNodeCollisions, SfpsSwitchPort=SfpsSwitchPort, sfpsDAPITestOutputAddrOneValue=sfpsDAPITestOutputAddrOneValue, sfpsNodeTableLastHeard=sfpsNodeTableLastHeard, sfpsDirFilterAliasEntry=sfpsDirFilterAliasEntry, sfpsServiceCenterDirectoryTable=sfpsServiceCenterDirectoryTable, sfpsDirFilterNodeNodeCount=sfpsDirFilterNodeNodeCount, sfpsDirAliasStatsAliasUsage=sfpsDirAliasStatsAliasUsage, sfpsDirFilterAliasLinkState=sfpsDirFilterAliasLinkState, sfpsDirFilterAliasNodeAge=sfpsDirFilterAliasNodeAge, sfpsNodeTableBaseAddress=sfpsNodeTableBaseAddress, sfpsNodeTableSelf=sfpsNodeTableSelf, sfpsAliasTableBaseAddress=sfpsAliasTableBaseAddress, sfpsDAPITestOutputPort=sfpsDAPITestOutputPort, sfpsServiceCenterDirectoryMetric=sfpsServiceCenterDirectoryMetric, sfpsDirAliasStatsAliasName=sfpsDirAliasStatsAliasName, sfpsDAPIVerb=sfpsDAPIVerb, sfpsDirFilterAliasNodeState=sfpsDirFilterAliasNodeState, sfpsNodeTableVlanCount=sfpsNodeTableVlanCount, sfpsDirAliasStatsAliasType=sfpsDirAliasStatsAliasType, sfpsDirFilterNodeChassisOctets=sfpsDirFilterNodeChassisOctets, sfpsNodeTableEntry=sfpsNodeTableEntry, sfpsDAPITestOutputAddrTwoTag=sfpsDAPITestOutputAddrTwoTag, sfpsDirFilterAliasChassisLoad=sfpsDirFilterAliasChassisLoad, sfpsDAPINodeType=sfpsDAPINodeType, sfpsNodeTableSwitchType=sfpsNodeTableSwitchType, sfpsDirAliasStatsTable=sfpsDirAliasStatsTable, sfpsDirFilterAliasBaseType=sfpsDirFilterAliasBaseType, sfpsDAPITestOutputAddrTwoValue=sfpsDAPITestOutputAddrTwoValue, sfpsTopologyDirStatsNodeTableUsage=sfpsTopologyDirStatsNodeTableUsage, sfpsAliasTableHashIndex=sfpsAliasTableHashIndex, sfpsDirFilterAliasBaseLoad=sfpsDirFilterAliasBaseLoad, SfpsAddress=SfpsAddress, sfpsTopologyDirStatsNumVlans=sfpsTopologyDirStatsNumVlans, sfpsAliasTableVlanPolicy=sfpsAliasTableVlanPolicy, sfpsAliasTableBaseLock=sfpsAliasTableBaseLock, sfpsTopologyDirStatsTotalUsage=sfpsTopologyDirStatsTotalUsage, sfpsAliasTableAliasOctets=sfpsAliasTableAliasOctets, sfpsTopologyDirStatsReservedForRemoteNodes=sfpsTopologyDirStatsReservedForRemoteNodes, sfpsNodeTableSwitchAddress=sfpsNodeTableSwitchAddress, sfpsDirFilterNodeNodeLock=sfpsDirFilterNodeNodeLock, sfpsDirFilterNodeBaseType=sfpsDirFilterNodeBaseType, sfpsDAPITestOutputTable=sfpsDAPITestOutputTable, sfpsDAPITestOutputEntry=sfpsDAPITestOutputEntry, sfpsTopologyDirStatsLocalAliasRefused=sfpsTopologyDirStatsLocalAliasRefused, sfpsTopologyDirStatsAliasMultiPortClears=sfpsTopologyDirStatsAliasMultiPortClears, sfpsDAPIAliasValue=sfpsDAPIAliasValue, sfpsDirFilterAPIValueType=sfpsDirFilterAPIValueType, sfpsNodeTableCallTag=sfpsNodeTableCallTag, sfpsAliasTableBaseType=sfpsAliasTableBaseType, sfpsAliasDeltaCount=sfpsAliasDeltaCount, sfpsServiceCenterDirectoryRequests=sfpsServiceCenterDirectoryRequests, sfpsDirFilterNodeVlanLearned=sfpsDirFilterNodeVlanLearned, sfpsNodeTableNext=sfpsNodeTableNext, sfpsTopologyDirStatsAliasUsage=sfpsTopologyDirStatsAliasUsage, sfpsDAPITestOutputAddrOneTag=sfpsDAPITestOutputAddrOneTag, sfpsServiceCenterDirectoryAdminStatus=sfpsServiceCenterDirectoryAdminStatus, sfpsAliasDeltaTableOpaqueTag=sfpsAliasDeltaTableOpaqueTag, sfpsDirFilterAliasSwitchOctets=sfpsDirFilterAliasSwitchOctets, sfpsDirFilterAPILockCount=sfpsDirFilterAPILockCount, sfpsTopologyDirStatsVlanTableUsage=sfpsTopologyDirStatsVlanTableUsage, sfpsTopologyDirStatsAliasTableSize=sfpsTopologyDirStatsAliasTableSize, sfpsServiceCenterDirectoryResponses=sfpsServiceCenterDirectoryResponses, sfpsDirFilterAliasDomain=sfpsDirFilterAliasDomain, sfpsAliasTableAliasState=sfpsAliasTableAliasState, sfpsAliasTableSwitchAddress=sfpsAliasTableSwitchAddress, sfpsTopologyDirStatsLocalNodeUsage=sfpsTopologyDirStatsLocalNodeUsage, sfpsNodeTableNodeLocked=sfpsNodeTableNodeLocked, sfpsDirFilterAliasNodeLocal=sfpsDirFilterAliasNodeLocal, sfpsNodeTableBaseHash=sfpsNodeTableBaseHash, sfpsDAPITestPort=sfpsDAPITestPort, sfpsTopologyDirStatsNumLocalNodes=sfpsTopologyDirStatsNumLocalNodes, sfpsDirFilterAliasAliasHash=sfpsDirFilterAliasAliasHash, sfpsDirFilterAliasLinkAge=sfpsDirFilterAliasLinkAge, sfpsAliasTableAliasType=sfpsAliasTableAliasType, sfpsDAPITestAddrTwoTag=sfpsDAPITestAddrTwoTag, sfpsAliasTableSwitchType=sfpsAliasTableSwitchType, sfpsDAPIAge=sfpsDAPIAge, sfpsDirFilterAliasNodeLock=sfpsDirFilterAliasNodeLock, sfpsAliasDeltaTableIndex=sfpsAliasDeltaTableIndex, sfpsDAPITestCallTag=sfpsDAPITestCallTag, sfpsAliasDeltaTableBase=sfpsAliasDeltaTableBase, sfpsDirFilterNodeChassisLoad=sfpsDirFilterNodeChassisLoad, sfpsDAPITestAddrOneTag=sfpsDAPITestAddrOneTag, sfpsTopologyDirStatsMaxSwitches=sfpsTopologyDirStatsMaxSwitches, sfpsDAPITestOutputCallTag=sfpsDAPITestOutputCallTag, sfpsDirFilterAPILockStatus=sfpsDirFilterAPILockStatus, sfpsDirFilterAliasLinkLock=sfpsDirFilterAliasLinkLock, sfpsDAPIAliasType=sfpsDAPIAliasType, sfpsAliasTablePrev=sfpsAliasTablePrev, sfpsAliasDeltaFullFlag=sfpsAliasDeltaFullFlag, sfpsAliasDeltaTableAliasState=sfpsAliasDeltaTableAliasState, sfpsTopologyDirStatsRemoteAliasRemoved=sfpsTopologyDirStatsRemoteAliasRemoved, sfpsTopologyDirStatsSwitchLookups=sfpsTopologyDirStatsSwitchLookups, sfpsAliasTableAliasHash=sfpsAliasTableAliasHash, sfpsAliasDeltaSetBack=sfpsAliasDeltaSetBack, sfpsDirFilterNodeDomainName=sfpsDirFilterNodeDomainName, sfpsTopologyDirStatsMaxVlans=sfpsTopologyDirStatsMaxVlans, sfpsDirFilterNodeLinkOctets=sfpsDirFilterNodeLinkOctets, sfpsDirFilterNodeOpaqueTag=sfpsDirFilterNodeOpaqueTag, sfpsServiceCenterDirectoryEntry=sfpsServiceCenterDirectoryEntry, sfpsDirFilterNodeSwitchOctets=sfpsDirFilterNodeSwitchOctets, sfpsNodeTablePrev=sfpsNodeTablePrev, sfpsTopologyDirStatsVlanCacheHits=sfpsTopologyDirStatsVlanCacheHits, sfpsDAPITestVerb=sfpsDAPITestVerb, sfpsDirFilterNodeChassisType=sfpsDirFilterNodeChassisType, sfpsTopologyDirStatsVlanLookups=sfpsTopologyDirStatsVlanLookups, sfpsDirFilterAliasLockCount=sfpsDirFilterAliasLockCount, sfpsDirFilterAliasNodeOctets=sfpsDirFilterAliasNodeOctets, sfpsAliasTable=sfpsAliasTable, sfpsServiceCenterDirectoryOperStatus=sfpsServiceCenterDirectoryOperStatus)
