# SNMP MIB module (CISCOSB-VRRPV3-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-VRRPV3-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:39:48 2025
...
vrrpv3OperationsEntry = _Vrrpv3OperationsEntry_Object(
    (1, 3, 6, 1, 2, 1, 68, 1, 1, 1, 1)
)
vrrpv3OperationsEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "CISCOSB-VRRPV3-MIB", "vrrpv3OperationsVrId"),
    (0, "CISCOSB-VRRPV3-MIB", "vrrpv3OperationsInetAddrType"),
)
if mibBuilder.loadTexts:
...
class _Vrrpv3OperStatus_Type(Integer32):
    """Custom type vrrpv3OperStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Vrrpv3OperStatus_Type.__name__ = "Integer32"
_Vrrpv3OperStatus_Object = MibTableColumn
vrrpv3OperStatus = _Vrrpv3OperStatus_Object(
    (1, 3, 6, 1, 2, 1, 68, 1, 1, 1, 1, 6),
    _Vrrpv3OperStatus_Type()
)
vrrpv3OperStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vrrpv3OperStatus.setStatus("current")
...
vrrpv3AssociatedIpAddrEntry = _Vrrpv3AssociatedIpAddrEntry_Object(
    (1, 3, 6, 1, 2, 1, 68, 1, 1, 2, 1)
)
vrrpv3AssociatedIpAddrEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "CISCOSB-VRRPV3-MIB", "vrrpv3OperationsVrId"),
    (0, "CISCOSB-VRRPV3-MIB", "vrrpv3OperationsInetAddrType"),
    (0, "CISCOSB-VRRPV3-MIB", "vrrpv3AssociatedIpAddr"),
)
if mibBuilder.loadTexts:
    vrrpv3AssociatedIpAddrEntry.setStatus("current")


class _Vrrpv3AssociatedIpAddr_Type(InetAddress):
    """Custom type vrrpv3AssociatedIpAddr based on InetAddress"""
...
_Vrrpv3AssociatedIpAddr_Type.__name__ = "InetAddress"
_Vrrpv3AssociatedIpAddr_Object = MibTableColumn
vrrpv3AssociatedIpAddr = _Vrrpv3AssociatedIpAddr_Object(
    (1, 3, 6, 1, 2, 1, 68, 1, 1, 2, 1, 1),
    _Vrrpv3AssociatedIpAddr_Type()
)
vrrpv3AssociatedIpAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    vrrpv3AssociatedIpAddr.setStatus("current")
...
vrrpv3StatisticsDiscontinuityTime = _Vrrpv3StatisticsDiscontinuityTime_Object(
    (1, 3, 6, 1, 2, 1, 68, 1, 2, 4, 1, 12),
    _Vrrpv3StatisticsDiscontinuityTime_Type()
)
vrrpv3StatisticsDiscontinuityTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vrrpv3StatisticsDiscontinuityTime.setStatus("current")
...
if mibBuilder.loadTexts:
    vrrpv3StatisticsRefreshRate.setUnits("milli-seconds")
...
vrrpv3OperationsGroup = ObjectGroup(
    (1, 3, 6, 1, 2, 1, 68, 2, 2, 1)
)
vrrpv3OperationsGroup.setObjects(
      *(("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsVirtualMacAddr"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperStatus"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsPriority"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsMasterIpAddr"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsAdvInterval"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsPreemptMode"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsAcceptMode"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsUpTime"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsRowStatus"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsAddrCount"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsPrimaryIpAddr"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3AssociatedIpAddrRowStatus"))
)
if mibBuilder.loadTexts:
    vrrpv3OperationsGroup.setStatus("current")

vrrpv3StatisticsGroup = ObjectGroup(
    (1, 3, 6, 1, 2, 1, 68, 2, 2, 2)
)
vrrpv3StatisticsGroup.setObjects(
      *(("CISCOSB-VRRPV3-MIB", "vrrpv3RouterChecksumErrors"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3RouterVersionErrors"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3RouterVrIdErrors"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsMasterTransitions"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsNewMasterReason"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsRcvdAdvertisements"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsAdvIntervalErrors"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsRcvdPriZeroPackets"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsSentPriZeroPackets"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsRcvdInvalidTypePackets"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsIpTtlErrors"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsProtoErrReason"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsAddressListErrors"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsPacketLengthErrors"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsDiscontinuityTime"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsRefreshRate"))
)
if mibBuilder.loadTexts:
    vrrpv3StatisticsGroup.setStatus("current")

vrrpv3InfoGroup = ObjectGroup(
    (1, 3, 6, 1, 2, 1, 68, 2, 2, 3)
)
...
vrrpv3NotificationsGroup = NotificationGroup(
    (1, 3, 6, 1, 2, 1, 68, 2, 2, 4)
)
vrrpv3NotificationsGroup.setObjects(
      *(("CISCOSB-VRRPV3-MIB", "vrrpv3NewMaster"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3ProtoError"))
)
if mibBuilder.loadTexts:
...
vrrpv3FullCompliance = ModuleCompliance(
    (1, 3, 6, 1, 2, 1, 68, 2, 1, 1)
)
vrrpv3FullCompliance.setObjects(
      *(("CISCOSB-VRRPV3-MIB", "vrrpv3OperationsGroup"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3StatisticsGroup"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3InfoGroup"),
        ("CISCOSB-VRRPV3-MIB", "vrrpv3NotificationsGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"Vrrpv3VrIdTC": Vrrpv3VrIdTC,
       ...
       "vrrpv3OperStatus": vrrpv3OperStatus,
       ...
       "vrrpv3AssociatedIpAddr": vrrpv3AssociatedIpAddr,
       ...
       "vrrpv3StatisticsDiscontinuityTime": vrrpv3StatisticsDiscontinuityTime,
