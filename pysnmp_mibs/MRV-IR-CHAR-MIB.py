...
mrvLx, TrapSeverity = mibBuilder.importSymbols("MRV-IR-SYSTEM-MIB", "mrvLx", "TrapSeverity")
...
mibBuilder.exportSymbols("MRV-IR-CHAR-MIB", irInternalModemType=irInternalModemType, irLdAlarmTimestamp=irLdAlarmTimestamp, irHumidityValue=irHumidityValue, irCharPortTransparent=irCharPortTransparent, irModemInitString=irModemInitString, irUpsLoad=irUpsLoad, irHumidityThresholdHigh=irHumidityThresholdHigh, irModemPooling=irModemPooling, irLdAlarmContactFaultState=irLdAlarmContactFaultState, irHumiditySensorEntry=irHumiditySensorEntry, irCharPortOverrunErrors=irCharPortOverrunErrors, irLdControlConfigTable=irLdControlConfigTable, irModemDialNumber=irModemDialNumber, irModem=irModem, irInternalModemPort=irInternalModemPort, irRs485PortTable=irRs485PortTable, irUpsType=irUpsType, irCharPortTelnetPort=irCharPortTelnetPort, irTcpPipeTable=irTcpPipeTable, PortSpeed=PortSpeed, irLdAlarmConfigEntry=irLdAlarmConfigEntry, irLdControlConfigEntry=irLdControlConfigEntry, irCharPortAutobaud=irCharPortAutobaud, irTempHysteresis=irTempHysteresis, irCharMib=irCharMib, irCharPortBitsPerChar=irCharPortBitsPerChar, irRs485PortEchoMode=irRs485PortEchoMode, irCharPortParity=irCharPortParity, irCharPortDataBufferTimeStamp=irCharPortDataBufferTimeStamp, irTempThresholdLow=irTempThresholdLow, irCharPortDataBufferDisplay=irCharPortDataBufferDisplay, irHumiditySensorTable=irHumiditySensorTable, irTcpPipeConnRetryCount=irTcpPipeConnRetryCount, irPowerOutletStatus=irPowerOutletStatus, irCharPortOutSignalRts=irCharPortOutSignalRts, irTempSensorEntry=irTempSensorEntry, irPowerPortIndex=irPowerPortIndex, irPowerCurrentLoadA=irPowerCurrentLoadA, irLdAlarmConfigTable=irLdAlarmConfigTable, irTempValue=irTempValue, irHumidityTrapSeverity=irHumidityTrapSeverity, irUpsLife=irUpsLife, irTempTrapSeverity=irTempTrapSeverity, irGsmPortBitErrorRate=irGsmPortBitErrorRate, irCharPortOutboundAuth=irCharPortOutboundAuth, irTempPortIndex=irTempPortIndex, irModemRetry=irModemRetry, irCharPortSpecialBreakString=irCharPortSpecialBreakString, irCharNumber=irCharNumber, irRs485PortIndex=irRs485PortIndex, PYSNMP_MODULE_ID=irCharMib, irCharPortTable=irCharPortTable, irPowerOutletCurrentLoad=irPowerOutletCurrentLoad, irCharPortAuthFallback=irCharPortAuthFallback, PortAccessType=PortAccessType, irRs485PortDuplexMode=irRs485PortDuplexMode, irGsmPortEntry=irGsmPortEntry, PortAuthType=PortAuthType, irCharPortEntry=irCharPortEntry, irCharPortReceiveBytes=irCharPortReceiveBytes, irTcpPipeRemoteIpAddress=irTcpPipeRemoteIpAddress, irPowerModuleType=irPowerModuleType, irCharPortFrameErrors=irCharPortFrameErrors, irHumiditySensorIndex=irHumiditySensorIndex, irHumidityHysteresis=irHumidityHysteresis, irLdAlarmTrapSeverity=irLdAlarmTrapSeverity, irUpsStatus=irUpsStatus, irUpsTable=irUpsTable, irCharPortPrompt=irCharPortPrompt, irCharPortInSignalCts=irCharPortInSignalCts, irCharPortSshPort=irCharPortSshPort, irLdAlarmPortIndex=irLdAlarmPortIndex, irRs485PortTransmitter=irRs485PortTransmitter, irPowerOutletCount=irPowerOutletCount, irPowerTable=irPowerTable, irLdAlarmTrapStatus=irLdAlarmTrapStatus, irCharPortAutoHangup=irCharPortAutoHangup, irGsmPortIndex=irGsmPortIndex, irModemIndex=irModemIndex, irCharPortFlowControl=irCharPortFlowControl, irPowerCurrentLoadB=irPowerCurrentLoadB, irCharPortIndex=irCharPortIndex, irCharPortAutobaudRetry=irCharPortAutobaudRetry, irCharPortAutoDial=irCharPortAutoDial, irCharPortBreak=irCharPortBreak, irTcpPipeRemoteTcpPort=irTcpPipeRemoteTcpPort, IrControlState=IrControlState, irCharPortInSignalDcd=irCharPortInSignalDcd, irLdAlarmCount=irLdAlarmCount, irTempThresholdHigh=irTempThresholdHigh, irTcpPipeConnStatus=irTcpPipeConnStatus, irCharPortTransmitBytes=irCharPortTransmitBytes, irLdControlDescription=irLdControlDescription, irPowerOutletTable=irPowerOutletTable, irGsmPortRcvSigStrength=irGsmPortRcvSigStrength, irLdAlarmDescription=irLdAlarmDescription, irLdControlPointIndex=irLdControlPointIndex, irCharPortInboundAuth=irCharPortInboundAuth, irCharPortDataBufferSize=irCharPortDataBufferSize, irPowerCurrentLoadC=irPowerCurrentLoadC, irUpsCharge=irUpsCharge, irModemCfgTable=irModemCfgTable, irPowerOutletIndex=irPowerOutletIndex, irCharPortRadiusAcct=irCharPortRadiusAcct, irCharPortStopBits=irCharPortStopBits, irCharPortOutSignalDtr=irCharPortOutSignalDtr, irHumidityThresholdLow=irHumidityThresholdLow, irCharPortSpecialBreak=irCharPortSpecialBreak, irCharPortStatsEntry=irCharPortStatsEntry, irPowerOutletAction=irPowerOutletAction, SignalStatus=SignalStatus, irHumidityPortIndex=irHumidityPortIndex, irCharPortSpeed=irCharPortSpeed, irCharPortDataBufferSyslog=irCharPortDataBufferSyslog, irUpsModel=irUpsModel, irCharPortParityErrors=irCharPortParityErrors, irTcpPipeEntry=irTcpPipeEntry, irLdAlarmPointIndex=irLdAlarmPointIndex, irLdControlState=irLdControlState, irModemState=irModemState, irLdControlEnergizedState=irLdControlEnergizedState, irGsmPortTable=irGsmPortTable, irUpsEntry=irUpsEntry, irCharPortAccessType=irCharPortAccessType, irModemCfgEntry=irModemCfgEntry, irCharPortInSignalDsr=irCharPortInSignalDsr, irRs485PortEntry=irRs485PortEntry, IrContactState=IrContactState, irTempValueUnits=irTempValueUnits, irLdAlarmName=irLdAlarmName, irCharPortTacacsAcct=irCharPortTacacsAcct, irTcpPipeWindowSize=irTcpPipeWindowSize, irTempSensorTable=irTempSensorTable, irModemTimeout=irModemTimeout, irLdAlarmContactState=irLdAlarmContactState, irPowerOutletEntry=irPowerOutletEntry, irLdControlName=irLdControlName, irPowerCurrentLoad=irPowerCurrentLoad, irCharPortStatsTable=irCharPortStatsTable, irPowerOutletName=irPowerOutletName, irLdControlPortIndex=irLdControlPortIndex, irPowerEntry=irPowerEntry, irTempSensorIndex=irTempSensorIndex)
