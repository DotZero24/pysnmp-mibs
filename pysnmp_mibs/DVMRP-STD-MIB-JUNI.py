...
# Notes
# -----
# ASN.1 source file://mibs/junose/DVMRP-STD-MIB-JUNI
# Produced by pysmi-1.6.2 at Fri Oct 10 21:06:43 2025
...
junidDvmrpMIBCompliance.setObjects(
      *(("DVMRP-STD-MIB-JUNI", "junidDvmrpGeneralGroup"),
        ("DVMRP-STD-MIB-JUNI", "junidDvmrpInterfaceGroup"),
        ("DVMRP-STD-MIB-JUNI", "junidDvmrpNeighborGroup"),
        ("DVMRP-STD-MIB-JUNI", "junidDvmrpRoutingGroup"),
        ("DVMRP-STD-MIB-JUNI", "junidDvmrpTreeGroup"),
        ("DVMRP-STD-MIB-JUNI", "junidDvmrpSecurityGroup"))
)
if mibBuilder.loadTexts:
