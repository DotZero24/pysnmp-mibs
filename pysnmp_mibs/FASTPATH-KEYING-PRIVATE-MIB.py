#
# PySNMP MIB module FASTPATH-KEYING-PRIVATE-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/broadcom/FASTPATH-KEYING-PRIVATE-MIB
...
fastPathKeyingPrivate.setRevisions(('2007-05-23 00:00',))
if mibBuilder.loadTexts: fastPathKeyingPrivate.setLastUpdated('200705230000Z')
...
agentFeatureKeyingEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4413, 1, 1, 24, 1, 3, 1), ).setIndexNames((0, "FASTPATH-KEYING-PRIVATE-MIB", "agentFeatureKeyingIndex"))
