...
mibBuilder.exportSymbols("HPN-ICF-L2VPN-PWE3-MIB", hpnicfPwVcOutboundLabel=hpnicfPwVcOutboundLabel, hpnicfPwVcUp=hpnicfPwVcUp, hpnicfL2VpnPwe3=hpnicfL2VpnPwe3, hpnicfPwVcIfIndex=hpnicfPwVcIfIndex, hpnicfPwVcID=hpnicfPwVcID, hpnicfPwVcIndex=hpnicfPwVcIndex, hpnicfPwVcPeerAddr=hpnicfPwVcPeerAddr, hpnicfPwVcType=hpnicfPwVcType, hpnicfL2VpnPwe3ScalarGroup=hpnicfL2VpnPwe3ScalarGroup, hpnicfPwVcTrapOpen=hpnicfPwVcTrapOpen, hpnicfPwVcInboundLabel=hpnicfPwVcInboundLabel, hpnicfPwVcMtu=hpnicfPwVcMtu, PYSNMP_MODULE_ID=hpnicfL2VpnPwe3, hpnicfPwVcStatus=hpnicfPwVcStatus, hpnicfPwVcCfgType=hpnicfPwVcCfgType, hpnicfPwVcEntry=hpnicfPwVcEntry, hpnicfPwVcSwitchWtoP=hpnicfPwVcSwitchWtoP, hpnicfPwVcTable=hpnicfPwVcTable, hpnicfPwVcDeleted=hpnicfPwVcDeleted, hpnicfL2VpnPwe3Table=hpnicfL2VpnPwe3Table, HpnicfL2VpnVcEncapsType=HpnicfL2VpnVcEncapsType, hpnicfPwVcDown=hpnicfPwVcDown, hpnicfPwVcRowStatus=hpnicfPwVcRowStatus, hpnicfPwVcSwitchPtoW=hpnicfPwVcSwitchPtoW, hpnicfPwVcAcStatus=hpnicfPwVcAcStatus, hpnicfL2VpnPwe3Notifications=hpnicfL2VpnPwe3Notifications)
