...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/junose/Juniper-System-Clock-MIB
...
juniSysClockMIB.setRevisions(('2014-09-15 14:00', '2007-03-22 14:00', '2005-12-14 14:01', '2003-09-15 14:01', '2003-09-12 13:37', '2002-04-04 14:56',))
if mibBuilder.loadTexts: juniSysClockMIB.setLastUpdated('201409151400Z')
...
mibBuilder.exportSymbols("Juniper-System-Clock-MIB", juniNtpSysClockOffsetError=juniNtpSysClockOffsetError, juniNtpPeerLastUpdateTime=juniNtpPeerLastUpdateTime, juniNtpPeerFilterOffset=juniNtpPeerFilterOffset, juniSysClockDstGroup=juniSysClockDstGroup, juniNtpObjects=juniNtpObjects, juniNtpPeerRootTimeUpdateServer=juniNtpPeerRootTimeUpdateServer, juniNtpPeerState=juniNtpPeerState, juniNtpPeerStratumNumber=juniNtpPeerStratumNumber, juniNtpFrequencyCalibrationEnd=juniNtpFrequencyCalibrationEnd, juniNtpSysClockOffsetErrorNew=juniNtpSysClockOffsetErrorNew, juniSysClockDstRecurStartDay=juniSysClockDstRecurStartDay, juniNtpPeers=juniNtpPeers, juniNtpFrequencyCalibrationStart=juniNtpFrequencyCalibrationStart, juniNtpClientIfRouterIndex=juniNtpClientIfRouterIndex, juniSysClockDstRecurStartMonth=juniSysClockDstRecurStartMonth, juniNtpFirstSystemClockSet=juniNtpFirstSystemClockSet, juniNtpClientIfEntry=juniNtpClientIfEntry, juniNtpAccessGroupGroup=juniNtpAccessGroupGroup, juniNtpTimeSynUp=juniNtpTimeSynUp, juniNtpPeerEntry=juniNtpPeerEntry, juniNtpPeersGroup1=juniNtpPeersGroup1, juniNtpPeerPollingInterval=juniNtpPeerPollingInterval, juniNtpServerStratumNumber=juniNtpServerStratumNumber, juniNtpRouterAccessGroupServeOnly=juniNtpRouterAccessGroupServeOnly, juniNtpRouterAccessGroupPeer=juniNtpRouterAccessGroupPeer, juniNtpPeerRootDispersion=juniNtpPeerRootDispersion, juniSysClockDstRecurStopMonth=juniSysClockDstRecurStopMonth, JuniSysClockDayOfTheWeek=JuniSysClockDayOfTheWeek, juniNtpClientAdminStatus=juniNtpClientAdminStatus, juniSysClockTime=juniSysClockTime, juniNtpPeerCfgEntry=juniNtpPeerCfgEntry, juniSysClockCompliance=juniSysClockCompliance, juniNtpPeerFilterRegisterEntry=juniNtpPeerFilterRegisterEntry, juniNtpSysClockGroup=juniNtpSysClockGroup, juniNtpSysClockState=juniNtpSysClockState, juniNtpPeerFilterDispersion=juniNtpPeerFilterDispersion, juniNtpPeerCfgRowStatus=juniNtpPeerCfgRowStatus, juniSysClockTimeGroup=juniSysClockTimeGroup, juniSysClockDst=juniSysClockDst, juniNtpPeerFilterIndex=juniNtpPeerFilterIndex, juniSysClockDstStatus=juniSysClockDstStatus, juniSysClockDstRecurStopDay=juniSysClockDstRecurStopDay, juniNtpTimeServerSynDown=juniNtpTimeServerSynDown, juniSysClockDstAbsoluteStartTime=juniSysClockDstAbsoluteStartTime, juniSysClockCompliance2=juniSysClockCompliance2, juniSysClockTimeZoneName=juniSysClockTimeZoneName, juniSysClockDstRecurStopWeek=juniSysClockDstRecurStopWeek, juniNtpRouterAccessGroupQueryOnly=juniNtpRouterAccessGroupQueryOnly, juniSysClockCompliances=juniSysClockCompliances, PYSNMP_MODULE_ID=juniSysClockMIB, juniNtpPeerDelay=juniNtpPeerDelay, juniNtpPeerRootDelay=juniNtpPeerRootDelay, juniNtpSysClockDeprecatedGroup=juniNtpSysClockDeprecatedGroup, juniNtpClientIfIsBroadcastServerDelay=juniNtpClientIfIsBroadcastServerDelay, juniNtpPeerPolledInterval=juniNtpPeerPolledInterval, juniNtpPeerCfgPacketSourceIfIndex=juniNtpPeerCfgPacketSourceIfIndex, juniNtpClientSystemRouterIndex=juniNtpClientSystemRouterIndex, juniSysClockDstRecurStopMinute=juniSysClockDstRecurStopMinute, juniNtpPeerRootTime=juniNtpPeerRootTime, JuniNtpClockUnsignedTime=JuniNtpClockUnsignedTime, juniNtpTraps=juniNtpTraps, juniSysClockDstRecurStopHour=juniSysClockDstRecurStopHour, juniNtpSysClock=juniNtpSysClock, juniSysClockDstRecurStartHour=juniSysClockDstRecurStartHour, juniNtpSysClockStratumNumber=juniNtpSysClockStratumNumber, juniNtpSysClockGroup2=juniNtpSysClockGroup2, juniNtpPeerCfgNtpVersion=juniNtpPeerCfgNtpVersion, juniNtpClientIfTable=juniNtpClientIfTable, JuniNtpClockSignedTime=JuniNtpClockSignedTime, juniNtpPeersGroup=juniNtpPeersGroup, juniSysClockDateAndTime=juniSysClockDateAndTime, juniSysClockObjects=juniSysClockObjects, juniNtpPeerOffsetError=juniNtpPeerOffsetError, juniSysClockDstAbsoluteStopTime=juniSysClockDstAbsoluteStopTime, juniSysClockConformance=juniSysClockConformance, juniNtpSysClockRootDispersion=juniNtpSysClockRootDispersion, juniNtpPeerCfgIpAddress=juniNtpPeerCfgIpAddress, juniNtpRouterAccessGroupServe=juniNtpRouterAccessGroupServe, juniSysClockDstOffset=juniSysClockDstOffset, juniNtpPeerCfgTable=juniNtpPeerCfgTable, juniNtpTimeSynDown=juniNtpTimeSynDown, juniNtpClientIfDisable=juniNtpClientIfDisable, juniNtpNotificationGroup=juniNtpNotificationGroup, JuniSysClockMonth=JuniSysClockMonth, juniNtpPeerRootSyncDistance=juniNtpPeerRootSyncDistance, juniNtpClientIfIsBroadcastServer=juniNtpClientIfIsBroadcastServer, juniNtpTimeServerSynUp=juniNtpTimeServerSynUp, juniNtpClient=juniNtpClient, juniNtpAccessGroup=juniNtpAccessGroup, juniNtpClockOffSetLimitCrossed=juniNtpClockOffSetLimitCrossed, juniNtpPeerTable=juniNtpPeerTable, juniNtpClientIfIfIndex=juniNtpClientIfIfIndex, juniNtpPeerFilterRegisterTable=juniNtpPeerFilterRegisterTable, juniSysClockGroups=juniSysClockGroups, juniSysClockMIB=juniSysClockMIB, juniNtpSysClockLastUpdateTime=juniNtpSysClockLastUpdateTime, juniNtpSysClockFrequencyError=juniNtpSysClockFrequencyError, juniSysClockCompliance3=juniSysClockCompliance3, juniNtpClientIfIsBroadcastClient=juniNtpClientIfIsBroadcastClient, juniNtpClientPacketSourceIfIndex=juniNtpClientPacketSourceIfIndex, juniSysClockDstRecurStartWeek=juniSysClockDstRecurStartWeek, juniSysClockDstName=juniSysClockDstName, juniNtpPeerAssociationMode=juniNtpPeerAssociationMode, juniNtpSysClockLastUpdateServer=juniNtpSysClockLastUpdateServer, juniNtpClientIfIsBroadcastServerVersion=juniNtpClientIfIsBroadcastServerVersion, juniNtpPeerCfgIsPreferred=juniNtpPeerCfgIsPreferred, juniNtpClientBroadcastDelay=juniNtpClientBroadcastDelay, juniNtpPeerReachability=juniNtpPeerReachability, JuniNtpTimeStamp=JuniNtpTimeStamp, juniNtpPeerRequestTime=juniNtpPeerRequestTime, juniNtpClientGroup=juniNtpClientGroup, juniNtpSysClockRootDelay=juniNtpSysClockRootDelay, JuniSysClockWeekOfTheMonth=JuniSysClockWeekOfTheMonth, juniNtpServer=juniNtpServer, juniNtpPeerDispersion=juniNtpPeerDispersion, juniNtpServerGroup=juniNtpServerGroup, juniNtpPeerReceiveTime=juniNtpPeerReceiveTime, juniNtpServerAdminStatus=juniNtpServerAdminStatus, juniNtpPeerPrecision=juniNtpPeerPrecision, juniSysClockDstRecurStartMinute=juniSysClockDstRecurStartMinute, juniNtpSysClockFrequencyErrorNew=juniNtpSysClockFrequencyErrorNew, juniNtpPeerBroadcastInterval=juniNtpPeerBroadcastInterval, JuniSysClockMinute=JuniSysClockMinute, juniNtpPeerTransmitTime=juniNtpPeerTransmitTime, juniNtpPeerFilterDelay=juniNtpPeerFilterDelay, JuniSysClockHour=JuniSysClockHour)
