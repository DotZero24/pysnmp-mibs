...
mibBuilder.exportSymbols("Juniper-System-Clock-MIB", JuniSysClockDayOfTheWeek=JuniSysClockDayOfTheWeek, juniNtpPeerCfgEntry=juniNtpPeerCfgEntry, juniNtpAccessGroupGroup=juniNtpAccessGroupGroup, juniSysClockTimeGroup=juniSysClockTimeGroup, juniNtpClockOffSetLimitCrossed=juniNtpClockOffSetLimitCrossed, juniNtpTimeServerSynDown=juniNtpTimeServerSynDown, juniNtpPeerCfgPacketSourceIfIndex=juniNtpPeerCfgPacketSourceIfIndex, juniNtpFirstSystemClockSet=juniNtpFirstSystemClockSet, JuniSysClockMonth=JuniSysClockMonth, juniNtpClientBroadcastDelay=juniNtpClientBroadcastDelay, juniNtpSysClockGroup=juniNtpSysClockGroup, juniNtpClientIfDisable=juniNtpClientIfDisable, juniNtpClientIfIsBroadcastServerDelay=juniNtpClientIfIsBroadcastServerDelay, juniNtpPeerFilterOffset=juniNtpPeerFilterOffset, juniNtpPeersGroup=juniNtpPeersGroup, juniSysClockDstRecurStartDay=juniSysClockDstRecurStartDay, juniSysClockMIB=juniSysClockMIB, PYSNMP_MODULE_ID=juniSysClockMIB, juniNtpPeers=juniNtpPeers, juniNtpServer=juniNtpServer, juniNtpPeerTable=juniNtpPeerTable, juniSysClockCompliance3=juniSysClockCompliance3, juniSysClockDstRecurStartMinute=juniSysClockDstRecurStartMinute, juniNtpClientIfRouterIndex=juniNtpClientIfRouterIndex, juniNtpServerAdminStatus=juniNtpServerAdminStatus, juniNtpPeerEntry=juniNtpPeerEntry, juniNtpPeerLastUpdateTime=juniNtpPeerLastUpdateTime, juniSysClockTimeZoneName=juniSysClockTimeZoneName, juniNtpSysClockDeprecatedGroup=juniNtpSysClockDeprecatedGroup, juniNtpClientIfEntry=juniNtpClientIfEntry, JuniSysClockMinute=JuniSysClockMinute, juniNtpPeerPolledInterval=juniNtpPeerPolledInterval, juniNtpRouterAccessGroupServeOnly=juniNtpRouterAccessGroupServeOnly, juniNtpNotificationGroup=juniNtpNotificationGroup, juniNtpPeerDispersion=juniNtpPeerDispersion, juniSysClockDstRecurStartMonth=juniSysClockDstRecurStartMonth, juniSysClockCompliance=juniSysClockCompliance, juniNtpPeerOffsetError=juniNtpPeerOffsetError, juniSysClockDstRecurStartWeek=juniSysClockDstRecurStartWeek, juniNtpTraps=juniNtpTraps, juniNtpClientPacketSourceIfIndex=juniNtpClientPacketSourceIfIndex, juniNtpPeerReachability=juniNtpPeerReachability, juniSysClockDateAndTime=juniSysClockDateAndTime, juniNtpPeerCfgNtpVersion=juniNtpPeerCfgNtpVersion, juniSysClockCompliances=juniSysClockCompliances, juniNtpSysClock=juniNtpSysClock, JuniSysClockHour=JuniSysClockHour, juniNtpPeerFilterDelay=juniNtpPeerFilterDelay, juniSysClockTime=juniSysClockTime, juniNtpSysClockLastUpdateServer=juniNtpSysClockLastUpdateServer, juniSysClockDstRecurStopMinute=juniSysClockDstRecurStopMinute, juniNtpSysClockFrequencyError=juniNtpSysClockFrequencyError, JuniSysClockWeekOfTheMonth=JuniSysClockWeekOfTheMonth, juniNtpPeerRootTimeUpdateServer=juniNtpPeerRootTimeUpdateServer, juniSysClockDstAbsoluteStartTime=juniSysClockDstAbsoluteStartTime, juniNtpServerStratumNumber=juniNtpServerStratumNumber, juniNtpSysClockFrequencyErrorNew=juniNtpSysClockFrequencyErrorNew, juniNtpTimeServerSynUp=juniNtpTimeServerSynUp, juniNtpPeerCfgRowStatus=juniNtpPeerCfgRowStatus, JuniNtpClockUnsignedTime=JuniNtpClockUnsignedTime, juniNtpSysClockState=juniNtpSysClockState, juniNtpPeerAssociationMode=juniNtpPeerAssociationMode, juniNtpTimeSynDown=juniNtpTimeSynDown, juniSysClockDst=juniSysClockDst, juniNtpClientGroup=juniNtpClientGroup, juniNtpClientAdminStatus=juniNtpClientAdminStatus, JuniNtpTimeStamp=JuniNtpTimeStamp, juniNtpSysClockStratumNumber=juniNtpSysClockStratumNumber, juniNtpRouterAccessGroupServe=juniNtpRouterAccessGroupServe, juniNtpRouterAccessGroupQueryOnly=juniNtpRouterAccessGroupQueryOnly, juniNtpPeerPrecision=juniNtpPeerPrecision, juniNtpClientIfIfIndex=juniNtpClientIfIfIndex, juniNtpSysClockRootDelay=juniNtpSysClockRootDelay, juniNtpPeerCfgTable=juniNtpPeerCfgTable, juniNtpPeerRootDispersion=juniNtpPeerRootDispersion, juniSysClockDstGroup=juniSysClockDstGroup, juniNtpClientSystemRouterIndex=juniNtpClientSystemRouterIndex, juniNtpPeerBroadcastInterval=juniNtpPeerBroadcastInterval, juniNtpSysClockGroup2=juniNtpSysClockGroup2, juniNtpSysClockOffsetErrorNew=juniNtpSysClockOffsetErrorNew, juniNtpPeerState=juniNtpPeerState, juniSysClockCompliance2=juniSysClockCompliance2, juniNtpClientIfTable=juniNtpClientIfTable, juniNtpClientIfIsBroadcastServerVersion=juniNtpClientIfIsBroadcastServerVersion, juniSysClockDstRecurStopWeek=juniSysClockDstRecurStopWeek, JuniNtpClockSignedTime=JuniNtpClockSignedTime, juniSysClockGroups=juniSysClockGroups, juniNtpPeerCfgIpAddress=juniNtpPeerCfgIpAddress, juniNtpPeersGroup1=juniNtpPeersGroup1, juniNtpClientIfIsBroadcastServer=juniNtpClientIfIsBroadcastServer, juniNtpPeerFilterRegisterTable=juniNtpPeerFilterRegisterTable, juniNtpSysClockLastUpdateTime=juniNtpSysClockLastUpdateTime, juniNtpPeerFilterRegisterEntry=juniNtpPeerFilterRegisterEntry, juniNtpFrequencyCalibrationEnd=juniNtpFrequencyCalibrationEnd, juniNtpObjects=juniNtpObjects, juniNtpPeerRootDelay=juniNtpPeerRootDelay, juniNtpSysClockRootDispersion=juniNtpSysClockRootDispersion, juniNtpPeerTransmitTime=juniNtpPeerTransmitTime, juniNtpSysClockOffsetError=juniNtpSysClockOffsetError, juniNtpServerGroup=juniNtpServerGroup, juniSysClockDstRecurStopHour=juniSysClockDstRecurStopHour, juniSysClockConformance=juniSysClockConformance, juniNtpRouterAccessGroupPeer=juniNtpRouterAccessGroupPeer, juniNtpPeerRootSyncDistance=juniNtpPeerRootSyncDistance, juniSysClockDstRecurStopMonth=juniSysClockDstRecurStopMonth, juniNtpPeerDelay=juniNtpPeerDelay, juniNtpTimeSynUp=juniNtpTimeSynUp, juniNtpFrequencyCalibrationStart=juniNtpFrequencyCalibrationStart, juniSysClockDstRecurStartHour=juniSysClockDstRecurStartHour, juniSysClockDstOffset=juniSysClockDstOffset, juniSysClockObjects=juniSysClockObjects, juniNtpClientIfIsBroadcastClient=juniNtpClientIfIsBroadcastClient, juniSysClockDstStatus=juniSysClockDstStatus, juniNtpAccessGroup=juniNtpAccessGroup, juniNtpClient=juniNtpClient, juniNtpPeerRequestTime=juniNtpPeerRequestTime, juniSysClockDstRecurStopDay=juniSysClockDstRecurStopDay, juniNtpPeerPollingInterval=juniNtpPeerPollingInterval, juniSysClockDstName=juniSysClockDstName, juniSysClockDstAbsoluteStopTime=juniSysClockDstAbsoluteStopTime, juniNtpPeerCfgIsPreferred=juniNtpPeerCfgIsPreferred, juniNtpPeerRootTime=juniNtpPeerRootTime, juniNtpPeerStratumNumber=juniNtpPeerStratumNumber, juniNtpPeerFilterIndex=juniNtpPeerFilterIndex, juniNtpPeerReceiveTime=juniNtpPeerReceiveTime, juniNtpPeerFilterDispersion=juniNtpPeerFilterDispersion)
