...
mibBuilder.exportSymbols("CISCO-SNMP-TARGET-EXT-MIB", ciscoSnmpTargetExtMIBCompliances=ciscoSnmpTargetExtMIBCompliances, cExtSnmpTargetAuthAddr=cExtSnmpTargetAuthAddr, cExtSnmpTargetVrfName=cExtSnmpTargetVrfName, cExtSnmpTargetVrfRoute=cExtSnmpTargetVrfRoute, cExtSnmpTargetAddrEntry=cExtSnmpTargetAddrEntry, cExtSnmpTargetVrfStatus=cExtSnmpTargetVrfStatus, cExtSnmpTargetAuthInetAddr=cExtSnmpTargetAuthInetAddr, ciscoSnmpTargetExtMIBObjects=ciscoSnmpTargetExtMIBObjects, cExtSnmpTargetAddrTable=cExtSnmpTargetAddrTable, ciscoSnmpTargetExtMIBConformance=ciscoSnmpTargetExtMIBConformance, ciscoSnmpTargetExtMIBGroup=ciscoSnmpTargetExtMIBGroup, cExtSnmpTargetVrfStorage=cExtSnmpTargetVrfStorage, ciscoSnmpTargetExtMIBCompliance=ciscoSnmpTargetExtMIBCompliance, PYSNMP_MODULE_ID=ciscoSnmpTargetExtMIB, cExtSnmpTargetAddrIntIfIndex=cExtSnmpTargetAddrIntIfIndex, ciscoSnmpTargetExtMIBComplianceRev2=ciscoSnmpTargetExtMIBComplianceRev2, ciscoSnmpTargetExtVrfMIBGroup=ciscoSnmpTargetExtVrfMIBGroup, cExtSnmpTargetVrfFilter=cExtSnmpTargetVrfFilter, ciscoSnmpTargetExtMIBGroups=ciscoSnmpTargetExtMIBGroups, cExtSnmpTargetVrfTable=cExtSnmpTargetVrfTable, cExtSnmpNotifGblTrapSrcIfIndex=cExtSnmpNotifGblTrapSrcIfIndex, cExtSnmpTargetAuthInetType=cExtSnmpTargetAuthInetType, ciscoSnmpTargetExtMIB=ciscoSnmpTargetExtMIB, ciscoSnmpTargetExtMIBComplianceRev1=ciscoSnmpTargetExtMIBComplianceRev1, cExtSnmpTargetVrfEntry=cExtSnmpTargetVrfEntry, ciscoSnmpTargetNotifSrcIntGroup=ciscoSnmpTargetNotifSrcIntGroup, cExtSnmpNotifGblInformSrcIfIndex=cExtSnmpNotifGblInformSrcIfIndex, ciscoSnmpTargetAuthFailureGroup=ciscoSnmpTargetAuthFailureGroup)
