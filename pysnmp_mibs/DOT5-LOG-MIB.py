...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cabletron/DOT5-LOG-MIB
...
mibBuilder.exportSymbols("DOT5-LOG-MIB", tRingPortStn=tRingPortStn, tRingAlarmsStnThrshEntry=tRingAlarmsStnThrshEntry, tRingStatsRingTotalErrors=tRingStatsRingTotalErrors, tRingPortStnPortMappedMacAddr=tRingPortStnPortMappedMacAddr, tRingPortRingPortGrpId=tRingPortRingPortGrpId, tRingMgmtBcnRecBrdBypassRetryDelay=tRingMgmtBcnRecBrdBypassRetryDelay, tRingMgmtBcnRecBrdWrapRetryDelay=tRingMgmtBcnRecBrdWrapRetryDelay, tRingPortRingEntry=tRingPortRingEntry, tRingStatsStnCongestErrors=tRingStatsStnCongestErrors, tRingAlarmsRingLostFramesEnable=tRingAlarmsRingLostFramesEnable, tRingMgmtStnFuncClasses=tRingMgmtStnFuncClasses, tRingMgmtRingPollRecovery=tRingMgmtRingPollRecovery, tRingAlarmsRingEnbl=tRingAlarmsRingEnbl, tRingStatsStnTable=tRingStatsStnTable, tRingPortRingPortMediaSelect=tRingPortRingPortMediaSelect, tRingMgmtRing=tRingMgmtRing, tRingStatsStnBytes=tRingStatsStnBytes, tRingIfIndex=tRingIfIndex, tRingStatsRingFramesize64To127Bytes=tRingStatsRingFramesize64To127Bytes, tRingPortRingFaultStatus=tRingPortRingFaultStatus, tRingStatsRingProtocolIpxFrames=tRingStatsRingProtocolIpxFrames, tRingStatsRingLineErrors=tRingStatsRingLineErrors, tRingAlarmsRingFrameCountEnable=tRingAlarmsRingFrameCountEnable, tRingPortStnPortMapEnable=tRingPortStnPortMapEnable, tRingMgmtHostTErrorReport=tRingMgmtHostTErrorReport, tRingPortGrpRingPortsEnable=tRingPortGrpRingPortsEnable, tRingStatsReset=tRingStatsReset, tRingPortGrpSpeedFault=tRingPortGrpSpeedFault, tRingStatsStn=tRingStatsStn, tRingAlarmsStnThrshTable=tRingAlarmsStnThrshTable, tRingAlarmsStnThrsh=tRingAlarmsStnThrsh, tRingStatsRingLastBeaconType=tRingStatsRingLastBeaconType, tRingStatsRingAMChanges=tRingStatsRingAMChanges, tRingAlarmsRingClaimTknThreshold=tRingAlarmsRingClaimTknThreshold, tRingPortRingPortType=tRingPortRingPortType, tRingMgmtSecurityAddressRemove=tRingMgmtSecurityAddressRemove, tRingMgmtBcnRecBrdWrapRetryCount=tRingMgmtBcnRecBrdWrapRetryCount, tRingMgmtHostAMContention=tRingMgmtHostAMContention, tRingPortMgmtPortOperState=tRingPortMgmtPortOperState, tRingAlarmsRing=tRingAlarmsRing, tRingMgmtRingPortCount=tRingMgmtRingPortCount, tRingMgmtStnPhysLocation=tRingMgmtStnPhysLocation, tRingAlarmsRingBeaconStateThreshold=tRingAlarmsRingBeaconStateThreshold, tRingMgmtBcnRecBrdBypassRetryCount=tRingMgmtBcnRecBrdBypassRetryCount, tRingAlarmsRingRingPurgesThreshold=tRingAlarmsRingRingPurgesThreshold, tRingPortMgmtRingOutEnable=tRingPortMgmtRingOutEnable, tRingMgmtStnTable=tRingMgmtStnTable, tRingPortMgmtTable=tRingPortMgmtTable, tRingStatsRingACErrors=tRingStatsRingACErrors, tRingStatsRingCongestErrors=tRingStatsRingCongestErrors, tRingPortGrpMode=tRingPortGrpMode, tRingMgmtSecurityIfIndex=tRingMgmtSecurityIfIndex, tRingStatsRingAbortSequences=tRingStatsRingAbortSequences, tRingMgmtBcnRecStnPortRetryDelay=tRingMgmtBcnRecStnPortRetryDelay, tRingAlarmsRingFrameCountThreshold=tRingAlarmsRingFrameCountThreshold, tRingStatsRingPollFailureNoRecovery=tRingStatsRingPollFailureNoRecovery, tRingPortRing=tRingPortRing, tRingMgmtBcnRecStnPortRetryCount=tRingMgmtBcnRecStnPortRetryCount, tRingPortGrpSpeed=tRingPortGrpSpeed, tRingStatsRingProtocolOtherFrames=tRingStatsRingProtocolOtherFrames, tRingStatsRingLostFrames=tRingStatsRingLostFrames, tRingAlarmsStnEnblLineErrsEnable=tRingAlarmsStnEnblLineErrsEnable, tRingPortGrpTable=tRingPortGrpTable, tRingAlarmsStnThrshBurstErrsThreshold=tRingAlarmsStnThrshBurstErrsThreshold, tRingMgmtRingState=tRingMgmtRingState, tRingStatsRingBeaconEvents=tRingStatsRingBeaconEvents, tRingStatsRingPollFailureLastDNAAddress=tRingStatsRingPollFailureLastDNAAddress, tRingStatsStnLineErrors=tRingStatsStnLineErrors, tRingStatsStnTokenErrors=tRingStatsStnTokenErrors, tRingPortGrpStnPortsOn=tRingPortGrpStnPortsOn, tRingStatsRingFramesize1024To2047Bytes=tRingStatsRingFramesize1024To2047Bytes, tRingAlarmsStnEnblEntry=tRingAlarmsStnEnblEntry, tRingMgmtStnAddress=tRingMgmtStnAddress, tRingMgmtStnRemoveStn=tRingMgmtStnRemoveStn, tRingMgmtStnPortsOn=tRingMgmtStnPortsOn, tRingMgmtBeaconRecovery=tRingMgmtBeaconRecovery, tRingPortStnPortLinkState=tRingPortStnPortLinkState, tRingPortRingTable=tRingPortRingTable, tRingAlarmsStnEnbl=tRingAlarmsStnEnbl, tRingStats=tRingStats, tRingPortMgmt=tRingPortMgmt, tRingStatsStnFrames=tRingStatsStnFrames, tRingMgmtStn=tRingMgmtStn, tRingPort=tRingPort, tRingMgmtStnPort=tRingMgmtStnPort, tRingStatsStnFreqErrors=tRingStatsStnFreqErrors, tRingStatsRingPollFailureNNIFrameCount=tRingStatsRingPollFailureNNIFrameCount, tRingAlarmsRingTimebase=tRingAlarmsRingTimebase, tRingStatsRingSizes=tRingStatsRingSizes, tRingPortRingPhantomCurrent=tRingPortRingPhantomCurrent, tRingMgmtSecurityEntry=tRingMgmtSecurityEntry, tRingStatsStnAddress=tRingStatsStnAddress, tRingPortMgmtPortAdminState=tRingPortMgmtPortAdminState, tRingStatsStnErrors=tRingStatsStnErrors, tRingMgmtStnPriority=tRingMgmtStnPriority, tRingStatsRingInternalErrors=tRingStatsRingInternalErrors, tRingStatsRingFramesizeUpTo63Bytes=tRingStatsRingFramesizeUpTo63Bytes, tRingMgmtHostErrorStatus=tRingMgmtHostErrorStatus, tRingMgmtRingNumber=tRingMgmtRingNumber, tRingPortMgmtEntry=tRingPortMgmtEntry, tRingStatsRingRingPurges=tRingStatsRingRingPurges, tRingMgmtStnEntry=tRingMgmtStnEntry, tRingPortMgmtPortType=tRingPortMgmtPortType, tRingStatsRingKBytes=tRingStatsRingKBytes, tRingAlarmsStnThrshACErrsThreshold=tRingAlarmsStnThrshACErrsThreshold, tRingMgmtStnDNA=tRingMgmtStnDNA, tRingStatsStnEntry=tRingStatsStnEntry, tRingStatsRingFramesize256To511Bytes=tRingStatsRingFramesize256To511Bytes, tRingAlarmsRingRingPurgesEnable=tRingAlarmsRingRingPurgesEnable, tRingPortGrpId=tRingPortGrpId, tRingPortGrpStnPortsEnable=tRingPortGrpStnPortsEnable, dot5Rev1=dot5Rev1, tRingPortStnPortLinkStateTime=tRingPortStnPortLinkStateTime, tRing=tRing, tRingStatsResetCounters=tRingStatsResetCounters, tRingPortGrpSpeedFaultLocation=tRingPortGrpSpeedFaultLocation, tRingPortMgmtPortName=tRingPortMgmtPortName, tRingMgmtSecurity=tRingMgmtSecurity, tRingStatsRingPollFailureNNIFrameAddress=tRingStatsRingPollFailureNNIFrameAddress, tRingMgmtSecurityStnCount=tRingMgmtSecurityStnCount, tRingMgmtSecurityAddressAdd=tRingMgmtSecurityAddressAdd, tRingPortStnPortId=tRingPortStnPortId, tRingIf=tRingIf, tRingAlarmsRingAMPErrsThreshold=tRingAlarmsRingAMPErrsThreshold, tRingStatsRingFramesize128To255Bytes=tRingStatsRingFramesize128To255Bytes, tRingPortStnEntry=tRingPortStnEntry, tRingStatsStnACErrors=tRingStatsStnACErrors, tRingStatsRingFreqErrors=tRingStatsRingFreqErrors, tRingStatsRingProtocolXnsFrames=tRingStatsRingProtocolXnsFrames, tRingStatsRingFCErrors=tRingStatsRingFCErrors, tRingStatsRingBurstErrors=tRingStatsRingBurstErrors, tRingPortGrpRingPortsOn=tRingPortGrpRingPortsOn, tRingAlarmsStnThrshAddress=tRingAlarmsStnThrshAddress, tRingStatsStnLostFrames=tRingStatsStnLostFrames, tRingAlarmsStnThrshInternalErrsThreshold=tRingAlarmsStnThrshInternalErrsThreshold, tRingStatsStnInternalErrors=tRingStatsStnInternalErrors, tRingAlarmsRingLostFramesThreshold=tRingAlarmsRingLostFramesThreshold, tRingPortRingPortClass=tRingPortRingPortClass, tRingAlarmsRingTokenErrsThreshold=tRingAlarmsRingTokenErrsThreshold, tRingStatsRingLastBeacon=tRingStatsRingLastBeacon, tRingMgmtHostOpenStatus=tRingMgmtHostOpenStatus, tRingStatsRingProtocolLanNetMgrFrames=tRingStatsRingProtocolLanNetMgrFrames, tRingPortGrpRingPortCount=tRingPortGrpRingPortCount, tRingStatsStnBurstErrors=tRingStatsStnBurstErrors, tRingAlarmsStnThrshRcvrCongestThreshold=tRingAlarmsStnThrshRcvrCongestThreshold, tRingPortRingPortId=tRingPortRingPortId, tRingAlarmsStnEnblAddress=tRingAlarmsStnEnblAddress, tRingMgmtStnPortsEnable=tRingMgmtStnPortsEnable, tRingAlarmsRingBeaconStateEnable=tRingAlarmsRingBeaconStateEnable, tRingMgmtBcnRecRingPortRetryCount=tRingMgmtBcnRecRingPortRetryCount, tRingStatsRingTokenErrors=tRingStatsRingTokenErrors, tRingStatsRingProtocolBanyanFrames=tRingStatsRingProtocolBanyanFrames, tRingMgmtRingSpeed=tRingMgmtRingSpeed, tRingPortMgmtPortId=tRingPortMgmtPortId, tRingMgmtStnBoard=tRingMgmtStnBoard, tRingMgmtSecurityAdminState=tRingMgmtSecurityAdminState, tRingMgmtSecurityStnAddress=tRingMgmtSecurityStnAddress, tRingAlarmsRingTokenErrsEnable=tRingAlarmsRingTokenErrsEnable, tRingPortStnPortGrpId=tRingPortStnPortGrpId, tRingAlarmsRingClaimTknErrsEnable=tRingAlarmsRingClaimTknErrsEnable, tRingStatsRingFramesize4096AndUpBytes=tRingStatsRingFramesize4096AndUpBytes, tRingAlarmsRingThrsh=tRingAlarmsRingThrsh, tRingMgmtStations=tRingMgmtStations, tRingStatsRingPollFailureLastNNIFrameTime=tRingStatsRingPollFailureLastNNIFrameTime, tRingAlarmsRingAMPErrsEnable=tRingAlarmsRingAMPErrsEnable, tRingStatsRingProtos=tRingStatsRingProtos, tRingMgmtRingPortsEnable=tRingMgmtRingPortsEnable, tRingStatsRingErrs=tRingStatsRingErrs, tRingAlarmsStnEnblTable=tRingAlarmsStnEnblTable, tRingPortGrpBypassRingPortState=tRingPortGrpBypassRingPortState, tRingPortStnInsertionTrapEnable=tRingPortStnInsertionTrapEnable, tRingAlarmsStnEnblACErrsEnable=tRingAlarmsStnEnblACErrsEnable, tRingMgmtHostLocalAdminMac=tRingMgmtHostLocalAdminMac, tRingPortRingFaultStateTime=tRingPortRingFaultStateTime, tRingMgmtStnPortCount=tRingMgmtStnPortCount, tRingMgmtBcnRecRingPortRetryDelay=tRingMgmtBcnRecRingPortRetryDelay, tRingStatsResetTime=tRingStatsResetTime, tRingPortGrpStnPortCount=tRingPortGrpStnPortCount, tRingStatsRingFramesize512To1023Bytes=tRingStatsRingFramesize512To1023Bytes, tRingPortStnTable=tRingPortStnTable, tRingMgmtRingName=tRingMgmtRingName, tRingStatsRingLongestBeacon=tRingStatsRingLongestBeacon, tRingMgmtStnUNA=tRingMgmtStnUNA, tRingAlarmsStnEnblBurstErrsEnable=tRingAlarmsStnEnblBurstErrsEnable, tRingPortGrpEntry=tRingPortGrpEntry, tRingStatsRingFrames=tRingStatsRingFrames, tRingMgmtRingPortsOn=tRingMgmtRingPortsOn, tRingStatsStnAbortSequences=tRingStatsStnAbortSequences, tRingPortGrpName=tRingPortGrpName, tRingMgmt=tRingMgmt, tRingStatsStnFCErrors=tRingStatsStnFCErrors, tRingStatsRing=tRingStatsRing, tRingAlarms=tRingAlarms, tRingPortMgmtPortGrpId=tRingPortMgmtPortGrpId, tRingPortMgmtSpeedFaultDetect=tRingPortMgmtSpeedFaultDetect, tRingMgmtSecurityTable=tRingMgmtSecurityTable, tRingAlarmsStnThrshLineErrsThreshold=tRingAlarmsStnThrshLineErrsThreshold, tRingAlarmsStnEnblRcvrCongestEnable=tRingAlarmsStnEnblRcvrCongestEnable, tRingStatsRingProtocolTcpIpFrames=tRingStatsRingProtocolTcpIpFrames, tRingMgmtActiveMonitor=tRingMgmtActiveMonitor, tRingStatsRingFramesize2048To4095Bytes=tRingStatsRingFramesize2048To4095Bytes, tRingAlarmsStn=tRingAlarmsStn, tRingPortGrp=tRingPortGrp, tRingStatsRingProtocolNetbiosFrames=tRingStatsRingProtocolNetbiosFrames, tRingMgmtStnName=tRingMgmtStnName, tRingMgmtHostCommands=tRingMgmtHostCommands, tRingMgmtHost=tRingMgmtHost, tRingAlarmsStnEnblInternalErrsEnable=tRingAlarmsStnEnblInternalErrsEnable, tRingStatsRingProtocolSnaFrames=tRingStatsRingProtocolSnaFrames)
