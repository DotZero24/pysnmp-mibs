...
# Notes
# -----
# ASN.1 source file://mibs/rfc/BATTERY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:25:10 2025
...
batteryCompliance.setObjects(
      *(("BATTERY-MIB", "batteryDescriptionGroup"),
        ("BATTERY-MIB", "batteryStatusGroup"),
        ("BATTERY-MIB", "batteryAlarmThresholdsGroup"),
        ("BATTERY-MIB", "batteryNotificationsGroup"),
        ("BATTERY-MIB", "batteryPerCellNotificationsGroup"),
        ("BATTERY-MIB", "batteryAdminGroup"))
)
if mibBuilder.loadTexts:
