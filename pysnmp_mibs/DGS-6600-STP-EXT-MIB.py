# SNMP MIB module (DGS-6600-STP-EXT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DGS-6600-STP-EXT-MIB
...
dgs6600StpExtMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2)
)
...
swMSTPGblMgmt = _SwMSTPGblMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1)
)
...
swMSTPStpAdminState = _SwMSTPStpAdminState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 1),
...
swMSTPStpVersion = _SwMSTPStpVersion_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 2),
...
swMSTPStpMaxAge = _SwMSTPStpMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 3),
...
swMSTPStpHelloTime = _SwMSTPStpHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 4),
...
swMSTPStpForwardDelay = _SwMSTPStpForwardDelay_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 5),
...
swMSTPStpMaxHops = _SwMSTPStpMaxHops_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 6),
...
swMSTPStpTxHoldCount = _SwMSTPStpTxHoldCount_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 7),
...
swMSTPStpForwardBPDU = _SwMSTPStpForwardBPDU_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 8),
...
swMSTPStpLBD = _SwMSTPStpLBD_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 9),
    _SwMSTPStpLBD_Type()
)
...
swMSTPStpLBDRecoverTime = _SwMSTPStpLBDRecoverTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 10),
...
class _SwMSTPNniBPDUAddress_Type(Integer32):
    """Custom type swMSTPNniBPDUAddress based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwMSTPNniBPDUAddress_Type.__name__ = "Integer32"
_SwMSTPNniBPDUAddress_Object = MibScalar
swMSTPNniBPDUAddress = _SwMSTPNniBPDUAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 1, 11),
    _SwMSTPNniBPDUAddress_Type()
)
swMSTPNniBPDUAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swMSTPNniBPDUAddress.setStatus("current")
_SwMSTPCtrl_ObjectIdentity = ObjectIdentity
swMSTPCtrl = _SwMSTPCtrl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2)
)
...
swMSTPName = _SwMSTPName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 1),
    _SwMSTPName_Type()
)
...
swMSTPRevisionLevel = _SwMSTPRevisionLevel_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 2),
...
swMSTPInstanceCtrlTable = _SwMSTPInstanceCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3)
)
if mibBuilder.loadTexts:
...
swMSTPInstanceCtrlEntry = _SwMSTPInstanceCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1)
)
swMSTPInstanceCtrlEntry.setIndexNames(
    (0, "DGS-6600-STP-EXT-MIB", "swMSTPInstId"),
)
if mibBuilder.loadTexts:
...
swMSTPInstId = _SwMSTPInstId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 1),
    _SwMSTPInstId_Type()
)
...
swMSTPInstVlanRangeList1to64 = _SwMSTPInstVlanRangeList1to64_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 2),
...
swMSTPInstVlanRangeList65to128 = _SwMSTPInstVlanRangeList65to128_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 3),
...
swMSTPInstVlanRangeList129to192 = _SwMSTPInstVlanRangeList129to192_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 4),
...
swMSTPInstVlanRangeList193to256 = _SwMSTPInstVlanRangeList193to256_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 5),
...
swMSTPInstVlanRangeList257to320 = _SwMSTPInstVlanRangeList257to320_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 6),
...
swMSTPInstVlanRangeList321to384 = _SwMSTPInstVlanRangeList321to384_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 7),
...
swMSTPInstVlanRangeList385to448 = _SwMSTPInstVlanRangeList385to448_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 8),
...
swMSTPInstVlanRangeList449to512 = _SwMSTPInstVlanRangeList449to512_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 9),
...
swMSTPInstType = _SwMSTPInstType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 10),
...
swMSTPInstStatus = _SwMSTPInstStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 11),
...
swMSTPInstPriority = _SwMSTPInstPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 12),
...
swMSTPInstDesignatedRootBridge = _SwMSTPInstDesignatedRootBridge_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 13),
...
swMSTPInstExternalRootCost = _SwMSTPInstExternalRootCost_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 14),
...
swMSTPInstRegionalRootBridge = _SwMSTPInstRegionalRootBridge_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 15),
...
swMSTPInstInternalRootCost = _SwMSTPInstInternalRootCost_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 16),
...
swMSTPInstDesignatedBridge = _SwMSTPInstDesignatedBridge_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 17),
...
swMSTPInstRootPort = _SwMSTPInstRootPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 18),
...
swMSTPInstMaxAge = _SwMSTPInstMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 19),
...
swMSTPInstForwardDelay = _SwMSTPInstForwardDelay_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 20),
...
swMSTPInstLastTopologyChange = _SwMSTPInstLastTopologyChange_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 21),
...
swMSTPInstTopChangesCount = _SwMSTPInstTopChangesCount_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 22),
...
swMSTPInstRemainHops = _SwMSTPInstRemainHops_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 23),
...
swMSTPInstRowStatus = _SwMSTPInstRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 3, 1, 24),
...
swMSTPPort = _SwMSTPPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 1),
    _SwMSTPPort_Type()
)
...
swMSTPPortAdminHelloTime = _SwMSTPPortAdminHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 2),
...
swMSTPPortOperHelloTime = _SwMSTPPortOperHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 3),
...
swMSTPSTPPortEnable = _SwMSTPSTPPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 4),
...
swMSTPPortExternalPathCost = _SwMSTPPortExternalPathCost_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 5),
...
swMSTPPortMigration = _SwMSTPPortMigration_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 6),
...
swMSTPPortAdminEdgePort = _SwMSTPPortAdminEdgePort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 7),
...
swMSTPPortOperEdgePort = _SwMSTPPortOperEdgePort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 8),
...
swMSTPPortAdminP2P = _SwMSTPPortAdminP2P_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 9),
...
swMSTPPortOperP2P = _SwMSTPPortOperP2P_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 10),
...
swMSTPPortLBD = _SwMSTPPortLBD_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 11),
    _SwMSTPPortLBD_Type()
)
...
swMSTPPortBPDUFiltering = _SwMSTPPortBPDUFiltering_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 12),
...
swMSTPPortRestrictedRole = _SwMSTPPortRestrictedRole_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 13),
...
swMSTPPortRestrictedTCN = _SwMSTPPortRestrictedTCN_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 14),
...
class _SwMSTPPortOperFilterBpdu_Type(Integer32):
    """Custom type swMSTPPortOperFilterBpdu based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwMSTPPortOperFilterBpdu_Type.__name__ = "Integer32"
_SwMSTPPortOperFilterBpdu_Object = MibTableColumn
swMSTPPortOperFilterBpdu = _SwMSTPPortOperFilterBpdu_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 15),
    _SwMSTPPortOperFilterBpdu_Type()
)
swMSTPPortOperFilterBpdu.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
swMSTPPortRecoverFilterBpdu = _SwMSTPPortRecoverFilterBpdu_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 4, 1, 16),
    _SwMSTPPortRecoverFilterBpdu_Type()
)
swMSTPPortRecoverFilterBpdu.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
swMSTPMstPort = _SwMSTPMstPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 5, 1, 1),
    _SwMSTPMstPort_Type()
)
...
swMSTPMstPortInsID = _SwMSTPMstPortInsID_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 5, 1, 2),
...
swMSTPMstPortDesignatedBridge = _SwMSTPMstPortDesignatedBridge_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 5, 1, 3),
...
swMSTPMstPortInternalPathCost = _SwMSTPMstPortInternalPathCost_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 5, 1, 4),
...
swMSTPMstPortPriority = _SwMSTPMstPortPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 5, 1, 5),
...
swMSTPMstPortStatus = _SwMSTPMstPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 5, 1, 6),
...
swMSTPMstPortRole = _SwMSTPMstPortRole_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 2, 5, 1, 7),
...
swMSTPTraps = _SwMSTPTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 11)
)
_SwMSTPNotify_ObjectIdentity = ObjectIdentity
swMSTPNotify = _SwMSTPNotify_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 11, 1)
)
_SwMSTPNotifyPrefix_ObjectIdentity = ObjectIdentity
swMSTPNotifyPrefix = _SwMSTPNotifyPrefix_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 11, 1, 0)
)
...
swMSTPPortLBDTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 11, 1, 0, 1)
)
swMSTPPortLBDTrap.setObjects(
    ("DGS-6600-STP-EXT-MIB", "swMSTPPort")
)
if mibBuilder.loadTexts:
    swMSTPPortLBDTrap.setStatus(
        "current"
    )

swMSTPPortBackupTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 11, 1, 0, 2)
)
swMSTPPortBackupTrap.setObjects(
      *(("DGS-6600-STP-EXT-MIB", "swMSTPMstPort"),
        ("DGS-6600-STP-EXT-MIB", "swMSTPMstPortInsID"))
)
if mibBuilder.loadTexts:
    swMSTPPortBackupTrap.setStatus(
        "current"
    )

swMSTPPortAlternateTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 11, 1, 0, 3)
)
swMSTPPortAlternateTrap.setObjects(
      *(("DGS-6600-STP-EXT-MIB", "swMSTPMstPort"),
        ("DGS-6600-STP-EXT-MIB", "swMSTPMstPortInsID"))
)
if mibBuilder.loadTexts:
    swMSTPPortAlternateTrap.setStatus(
        "current"
    )

swMSTPHwFilterStatusChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 11, 1, 0, 4)
)
swMSTPHwFilterStatusChange.setObjects(
      *(("DGS-6600-STP-EXT-MIB", "swMSTPPort"),
        ("DGS-6600-STP-EXT-MIB", "swMSTPPortOperFilterBpdu"))
)
if mibBuilder.loadTexts:
    swMSTPHwFilterStatusChange.setStatus(
        "current"
    )

swMSTPRootRestrictedChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 171, 10, 120, 100, 2, 2, 11, 1, 0, 5)
)
swMSTPRootRestrictedChange.setObjects(
      *(("DGS-6600-STP-EXT-MIB", "swMSTPPort"),
        ("DGS-6600-STP-EXT-MIB", "swMSTPPortRestrictedRole"))
)
if mibBuilder.loadTexts:
    swMSTPRootRestrictedChange.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    "DGS-6600-STP-EXT-MIB",
    **{"BridgeId": BridgeId,
       "dgs6600StpExtMIB": dgs6600StpExtMIB,
       ...
       "swMSTPNniBPDUAddress": swMSTPNniBPDUAddress,
       ...
       "swMSTPPortOperFilterBpdu": swMSTPPortOperFilterBpdu,
       "swMSTPPortRecoverFilterBpdu": swMSTPPortRecoverFilterBpdu,
       ...
       "swMSTPTraps": swMSTPTraps,
       "swMSTPNotify": swMSTPNotify,
       "swMSTPNotifyPrefix": swMSTPNotifyPrefix,
       "swMSTPPortLBDTrap": swMSTPPortLBDTrap,
       "swMSTPPortBackupTrap": swMSTPPortBackupTrap,
       "swMSTPPortAlternateTrap": swMSTPPortAlternateTrap,
