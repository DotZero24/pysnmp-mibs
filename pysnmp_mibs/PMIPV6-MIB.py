...
# Notes
# -----
# ASN.1 source file://mibs/rfc/PMIPV6-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:22:43 2025
...
_Pmip6MobileNodeGeneratedTimestampInUse_Type.__name__ = "TruthValue"
...
_Pmip6MagEnableMagLocalRouting_Type.__name__ = "TruthValue"
...
pmip6CoreCompliance.setObjects(
    ("PMIPV6-MIB", "pmip6SystemGroup")
)
if mibBuilder.loadTexts:
...
pmip6Compliance2.setObjects(
      *(("PMIPV6-MIB", "pmip6SystemGroup"),
        ("PMIPV6-MIB", "pmip6BindingCacheGroup"),
        ("PMIPV6-MIB", "pmip6StatsGroup"))
)
if mibBuilder.loadTexts:
...
pmip6CoreReadOnlyCompliance.setObjects(
    ("PMIPV6-MIB", "pmip6SystemGroup")
)
if mibBuilder.loadTexts:
...
pmip6ReadOnlyCompliance2.setObjects(
      *(("PMIPV6-MIB", "pmip6SystemGroup"),
        ("PMIPV6-MIB", "pmip6BindingCacheGroup"),
        ("PMIPV6-MIB", "pmip6StatsGroup"))
)
...
pmip6MagCoreCompliance.setObjects(
    ("PMIPV6-MIB", "pmip6MagSystemGroup")
)
if mibBuilder.loadTexts:
...
pmip6MagCompliance2.setObjects(
      *(("PMIPV6-MIB", "pmip6MagSystemGroup"),
        ("PMIPV6-MIB", "pmip6MagConfigurationGroup"),
        ("PMIPV6-MIB", "pmip6MagRegistrationGroup"))
)
if mibBuilder.loadTexts:
...
pmip6MagCoreReadOnlyCompliance.setObjects(
    ("PMIPV6-MIB", "pmip6MagSystemGroup")
)
if mibBuilder.loadTexts:
...
pmip6MagReadOnlyCompliance2.setObjects(
      *(("PMIPV6-MIB", "pmip6MagSystemGroup"),
        ("PMIPV6-MIB", "pmip6MagConfigurationGroup"),
        ("PMIPV6-MIB", "pmip6MagRegistrationGroup"))
)
...
pmip6LmaCoreCompliance.setObjects(
    ("PMIPV6-MIB", "pmip6LmaSystemGroup")
)
if mibBuilder.loadTexts:
...
pmip6LmaCompliance2.setObjects(
      *(("PMIPV6-MIB", "pmip6LmaSystemGroup"),
        ("PMIPV6-MIB", "pmip6LmaConfigurationGroup"))
)
if mibBuilder.loadTexts:
...
pmip6LmaReadOnlyCompliance.setObjects(
    ("PMIPV6-MIB", "pmip6LmaSystemGroup")
)
if mibBuilder.loadTexts:
...
pmip6LmaReadOnlyCompliance2.setObjects(
      *(("PMIPV6-MIB", "pmip6LmaSystemGroup"),
        ("PMIPV6-MIB", "pmip6LmaConfigurationGroup"))
)
if mibBuilder.loadTexts:
...
pmip6MagNotificationCompliance.setObjects(
    ("PMIPV6-MIB", "pmip6MagNotificationGroup")
)
if mibBuilder.loadTexts:
...
pmip6LmaNotificationCompliance.setObjects(
    ("PMIPV6-MIB", "pmip6LmaNotificationGroup")
)
if mibBuilder.loadTexts:
