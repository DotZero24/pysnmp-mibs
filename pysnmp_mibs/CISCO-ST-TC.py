...
mibBuilder.exportSymbols("CISCO-ST-TC", FcNameId=FcNameId, storageTextualConventions=storageTextualConventions, PortMemberList=PortMemberList, FcIfSfpDiagLevelType=FcIfSfpDiagLevelType, FcNameIdOrZero=FcNameIdOrZero, FcPortTypes=FcPortTypes, FcPortModuleTypes=FcPortModuleTypes, InterfaceOperMode=InterfaceOperMode, FcAddress=FcAddress, FcIfServiceStateType=FcIfServiceStateType, FcAddressType=FcAddressType, VsanIndex=VsanIndex, DomainIdOrZero=DomainIdOrZero, DomainId=DomainId, FcClassOfServices=FcClassOfServices, PYSNMP_MODULE_ID=storageTextualConventions, FcPortTxTypes=FcPortTxTypes, FcAddressId=FcAddressId, FcIfSpeed=FcIfSpeed)
