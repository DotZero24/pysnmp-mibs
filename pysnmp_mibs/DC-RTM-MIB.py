...
# Notes
# -----
# ASN.1 source file://mibs/mrv/DC-RTM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:09:25 2025
...
class _RtmEntityDsGgp_Type(AdminDistance):
    """Custom type rtmEntityDsGgp based on AdminDistance"""
    defaultValue = 210


_RtmEntityDsGgp_Type.__name__ = "AdminDistance"
_RtmEntityDsGgp_Object = MibTableColumn
rtmEntityDsGgp = _RtmEntityDsGgp_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 1, 1, 17),
    _RtmEntityDsGgp_Type()
)
rtmEntityDsGgp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    rtmEntityDsGgp.setStatus("current")
...
_RtmEntityEqlCostOpt_Type.__name__ = "EqualCostRouteOpts"
...
_RtmEntityDeadRpmTmr_Type.__name__ = "Integer32"
...
_RtmEntityStartupTime_Type.__name__ = "Integer32"
...
_RtmEntityRestartTime_Type.__name__ = "Integer32"
...
_RtmEntityUseUnidirectionalLinks_Type.__name__ = "TruthValue"
...
class _RtmEntityDisplayLocalAddrs_Type(TruthValue):
    """Custom type rtmEntityDisplayLocalAddrs based on TruthValue"""
    defaultValue = 1


_RtmEntityDisplayLocalAddrs_Type.__name__ = "TruthValue"
_RtmEntityDisplayLocalAddrs_Object = MibTableColumn
rtmEntityDisplayLocalAddrs = _RtmEntityDisplayLocalAddrs_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 1, 1, 43),
    _RtmEntityDisplayLocalAddrs_Type()
)
rtmEntityDisplayLocalAddrs.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    rtmEntityDisplayLocalAddrs.setStatus("current")
_RtmEntityRestarting_Type = TruthValue
_RtmEntityRestarting_Object = MibTableColumn
rtmEntityRestarting = _RtmEntityRestarting_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 1, 1, 44),
    _RtmEntityRestarting_Type()
)
rtmEntityRestarting.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmEntityRestarting.setStatus("current")
_RtmEntityRestartTimeLeft_Type = Unsigned32
_RtmEntityRestartTimeLeft_Object = MibTableColumn
rtmEntityRestartTimeLeft = _RtmEntityRestartTimeLeft_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 1, 1, 45),
    _RtmEntityRestartTimeLeft_Type()
)
rtmEntityRestartTimeLeft.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmEntityRestartTimeLeft.setStatus("current")
_RtmEntityRestartExitReason_Type = RtmEntityRestartExit
_RtmEntityRestartExitReason_Object = MibTableColumn
rtmEntityRestartExitReason = _RtmEntityRestartExitReason_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 1, 1, 46),
    _RtmEntityRestartExitReason_Type()
)
rtmEntityRestartExitReason.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmEntityRestartExitReason.setStatus("current")
_RtmRedistTable_Object = MibTable
rtmRedistTable = _RtmRedistTable_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 2)
)
if mibBuilder.loadTexts:
    rtmRedistTable.setStatus("current")
_RtmRedistEntry_Object = MibTableRow
rtmRedistEntry = _RtmRedistEntry_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 2, 1)
)
...
_RtmRedistAdminStat_Type.__name__ = "AdminStatus"
...
rtmRedistAdminStat.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
_RtmRedistInfoSrc_Type.__name__ = "InfoSourceDest"
...
_RtmRedistAddrFltLen_Type.__name__ = "Integer32"
...
_RtmRedistExtComm_Type.__name__ = "BgpExtendedCommunity"
_RtmRedistExtComm_Object = MibTableColumn
rtmRedistExtComm = _RtmRedistExtComm_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 2, 1, 29),
...
_RtmRedistMetricValue_Type.__name__ = "Unsigned32"
...
_RtmRedistAddLocalPref_Type.__name__ = "TruthValue"
...
_RtmStaticRtAdminStat_Type.__name__ = "AdminStatus"
_RtmStaticRtAdminStat_Object = MibTableColumn
rtmStaticRtAdminStat = _RtmStaticRtAdminStat_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 3, 1, 9),
    _RtmStaticRtAdminStat_Type()
)
rtmStaticRtAdminStat.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
_RtmStaticRtAction_Type.__name__ = "RouteAction"
...
class _RtmStaticRtPathType_Type(PathType):
    """Custom type rtmStaticRtPathType based on PathType"""
    defaultValue = 196608


_RtmStaticRtPathType_Type.__name__ = "PathType"
_RtmStaticRtPathType_Object = MibTableColumn
rtmStaticRtPathType = _RtmStaticRtPathType_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 3, 1, 15),
    _RtmStaticRtPathType_Type()
)
rtmStaticRtPathType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
_RtmStaticRtBfdSupport_Type.__name__ = "RtmBfdSupport"
...
rtmStaticRtBfdStatus = _RtmStaticRtBfdStatus_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 3, 1, 21),
    _RtmStaticRtBfdStatus_Type()
)
rtmStaticRtBfdStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmStaticRtBfdStatus.setStatus("current")
_RtmStaticRtInterfaceName_Type = DisplayString
_RtmStaticRtInterfaceName_Object = MibTableColumn
rtmStaticRtInterfaceName = _RtmStaticRtInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 3, 1, 22),
    _RtmStaticRtInterfaceName_Type()
)
rtmStaticRtInterfaceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    rtmStaticRtInterfaceName.setStatus("current")
_RtmMjTable_Object = MibTable
rtmMjTable = _RtmMjTable_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 4)
)
if mibBuilder.loadTexts:
    rtmMjTable.setStatus("current")
_RtmMjEntry_Object = MibTableRow
rtmMjEntry = _RtmMjEntry_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 4, 1)
)
...
_RtmMjSafi_Type.__name__ = "InetSubAddressType"
_RtmMjSafi_Object = MibTableColumn
rtmMjSafi = _RtmMjSafi_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 4, 1, 9),
    _RtmMjSafi_Type()
)
...
_RtmRouteAge_Type.__name__ = "Integer32"
_RtmRouteAge_Object = MibTableColumn
rtmRouteAge = _RtmRouteAge_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 6, 1, 12),
    _RtmRouteAge_Type()
)
...
_RtmRouteInfo_Type.__name__ = "RouteInfo"
...
rtmRouteLocalDestIfIndex = _RtmRouteLocalDestIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 6, 1, 22),
    _RtmRouteLocalDestIfIndex_Type()
)
rtmRouteLocalDestIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmRouteLocalDestIfIndex.setStatus("current")
_RtmRouteAdminDistance_Type = AdminDistance
_RtmRouteAdminDistance_Object = MibTableColumn
rtmRouteAdminDistance = _RtmRouteAdminDistance_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 6, 1, 23),
    _RtmRouteAdminDistance_Type()
)
rtmRouteAdminDistance.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmRouteAdminDistance.setStatus("current")
_RtmRoutePathType_Type = PathType
_RtmRoutePathType_Object = MibTableColumn
rtmRoutePathType = _RtmRoutePathType_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 6, 1, 24),
    _RtmRoutePathType_Type()
)
rtmRoutePathType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmRoutePathType.setStatus("current")
_RtmRibTable_Object = MibTable
rtmRibTable = _RtmRibTable_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 7)
)
if mibBuilder.loadTexts:
    rtmRibTable.setStatus("current")
_RtmRibEntry_Object = MibTableRow
rtmRibEntry = _RtmRibEntry_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 7, 1)
)
...
_RtmRibAge_Type.__name__ = "Integer32"
_RtmRibAge_Object = MibTableColumn
rtmRibAge = _RtmRibAge_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 7, 1, 12),
    _RtmRibAge_Type()
)
...
_RtmRibInfo_Type.__name__ = "RouteInfo"
_RtmRibInfo_Object = MibTableColumn
rtmRibInfo = _RtmRibInfo_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 7, 1, 13),
    _RtmRibInfo_Type()
)
...
rtmRibLocalDestIfIndex = _RtmRibLocalDestIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 7, 1, 24),
    _RtmRibLocalDestIfIndex_Type()
)
rtmRibLocalDestIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmRibLocalDestIfIndex.setStatus("current")
_RtmRibAdminDistance_Type = AdminDistance
_RtmRibAdminDistance_Object = MibTableColumn
rtmRibAdminDistance = _RtmRibAdminDistance_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 7, 1, 25),
    _RtmRibAdminDistance_Type()
)
rtmRibAdminDistance.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmRibAdminDistance.setStatus("current")
_RtmRibPathType_Type = PathType
_RtmRibPathType_Object = MibTableColumn
rtmRibPathType = _RtmRibPathType_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 7, 1, 26),
    _RtmRibPathType_Type()
)
rtmRibPathType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rtmRibPathType.setStatus("current")
_RtmRdstSetFieldTable_Object = MibTable
rtmRdstSetFieldTable = _RtmRdstSetFieldTable_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 8)
)
if mibBuilder.loadTexts:
...
rtmRdstSetFieldValue = _RtmRdstSetFieldValue_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 8, 1, 6),
    _RtmRdstSetFieldValue_Type()
)
rtmRdstSetFieldValue.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    rtmRdstSetFieldValue.setStatus("current")
_RtmRouterDefinitionTable_Object = MibTable
rtmRouterDefinitionTable = _RtmRouterDefinitionTable_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 9)
)
if mibBuilder.loadTexts:
    rtmRouterDefinitionTable.setStatus("current")
_RtmRouterDefinitionEntry_Object = MibTableRow
rtmRouterDefinitionEntry = _RtmRouterDefinitionEntry_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 9, 1)
)
rtmRouterDefinitionEntry.setIndexNames(
    (0, "DC-RTM-MIB", "rtmEntityFteIndex"),
)
if mibBuilder.loadTexts:
    rtmRouterDefinitionEntry.setStatus("current")
_RtmRouterDefinitionFteIndex_Type = FteIndex
_RtmRouterDefinitionFteIndex_Object = MibTableColumn
rtmRouterDefinitionFteIndex = _RtmRouterDefinitionFteIndex_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 9, 1, 1),
    _RtmRouterDefinitionFteIndex_Type()
)
rtmRouterDefinitionFteIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    rtmRouterDefinitionFteIndex.setStatus("current")
_RtmRouterDefinitionRowStatus_Type = RowStatus
_RtmRouterDefinitionRowStatus_Object = MibTableColumn
rtmRouterDefinitionRowStatus = _RtmRouterDefinitionRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 9, 1, 2),
    _RtmRouterDefinitionRowStatus_Type()
)
rtmRouterDefinitionRowStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rtmRouterDefinitionRowStatus.setStatus("current")


class _RtmRouterDefinitionRouterId_Type(RouterID):
    """Custom type rtmRouterDefinitionRouterId based on RouterID"""
    defaultHexValue = "00000000"


_RtmRouterDefinitionRouterId_Type.__name__ = "RouterID"
_RtmRouterDefinitionRouterId_Object = MibTableColumn
rtmRouterDefinitionRouterId = _RtmRouterDefinitionRouterId_Object(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 1, 9, 1, 3),
    _RtmRouterDefinitionRouterId_Type()
)
rtmRouterDefinitionRouterId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rtmRouterDefinitionRouterId.setStatus("current")
_RtmTrap_ObjectIdentity = ObjectIdentity
rtmTrap = _RtmTrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 2)
)
_RtmTraps_ObjectIdentity = ObjectIdentity
rtmTraps = _RtmTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 2, 0)
)
_RtmTrapControl_ObjectIdentity = ObjectIdentity
rtmTrapControl = _RtmTrapControl_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 2, 1)
)
...
rtmEntityGroup.setObjects(
      *(("DC-RTM-MIB", "rtmEntityAdminStat"),
        ...
        ("DC-RTM-MIB", "rtmEntityDisplayLocalAddrs"),
        ("DC-RTM-MIB", "rtmEntityRestarting"),
        ("DC-RTM-MIB", "rtmEntityRestartTimeLeft"),
...
rtmStaticRtGroup.setObjects(
      *(("DC-RTM-MIB", "rtmStaticRtAdminStat"),
        ...
        ("DC-RTM-MIB", "rtmStaticRtPathType"),
...
rtmRouteGroup.setObjects(
      *(("DC-RTM-MIB", "rtmRouteStatus"),
        ...
        ("DC-RTM-MIB", "rtmRouteAdminDistance"),
        ("DC-RTM-MIB", "rtmRoutePathType"))
)
if mibBuilder.loadTexts:
    rtmRouteGroup.setStatus("current")

rtmRibGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 3, 2, 12)
)
rtmRibGroup.setObjects(
      *(("DC-RTM-MIB", "rtmRibStatus"),
        ...
        ("DC-RTM-MIB", "rtmRibAdminDistance"),
        ("DC-RTM-MIB", "rtmRibPathType"))
)
if mibBuilder.loadTexts:
    rtmRibGroup.setStatus("current")

rtmObsoleteGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 3, 2, 13)
)
...
rtmRouterDefinitionMandatoryGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 3, 2, 17)
)
rtmRouterDefinitionMandatoryGroup.setObjects(
      *(("DC-RTM-MIB", "rtmRouterDefinitionRowStatus"),
        ("DC-RTM-MIB", "rtmRouterDefinitionRouterId"))
)
if mibBuilder.loadTexts:
    rtmRouterDefinitionMandatoryGroup.setStatus("current")


# Notification objects

rtmOperStateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 2, 0, 1)
)
...
rtmCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 629, 10, 7, 3, 1, 1)
)
rtmCompliance.setObjects(
      *(("DC-RTM-MIB", "rtmEntityMandatoryGroup"),
        ("DC-RTM-MIB", "rtmRedistMandatoryGroup"),
        ("DC-RTM-MIB", "rtmStaticRtMandatoryGroup"),
        ("DC-RTM-MIB", "rtmMjMandatoryGroup"),
        ("DC-RTM-MIB", "rtmSjMandatoryGroup"),
        ("DC-RTM-MIB", "rtmRdstSetFieldMandatoryGroup"),
        ("DC-RTM-MIB", "rtmNotificationObjectGroup"),
        ("DC-RTM-MIB", "rtmNotificationEventGroup"),
        ("DC-RTM-MIB", "rtmRouterDefinitionMandatoryGroup"),
        ("DC-RTM-MIB", "rtmEntityGroup"),
        ("DC-RTM-MIB", "rtmRedistGroup"),
        ("DC-RTM-MIB", "rtmStaticRtGroup"),
        ("DC-RTM-MIB", "rtmMjGroup"),
        ("DC-RTM-MIB", "rtmSjGroup"),
        ("DC-RTM-MIB", "rtmRouteGroup"),
        ("DC-RTM-MIB", "rtmRibGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"FteIndex": FteIndex,
       ...
       "RtmEntityRestartExit": RtmEntityRestartExit,
       "nbase": nbase,
       "opx": opx,
       "rtmMib": rtmMib,
       ...
       "rtmEntityDisplayLocalAddrs": rtmEntityDisplayLocalAddrs,
       "rtmEntityRestarting": rtmEntityRestarting,
       "rtmEntityRestartTimeLeft": rtmEntityRestartTimeLeft,
       "rtmEntityRestartExitReason": rtmEntityRestartExitReason,
       ...
       "rtmStaticRtInterfaceName": rtmStaticRtInterfaceName,
       ...
       "rtmRouteAdminDistance": rtmRouteAdminDistance,
       "rtmRoutePathType": rtmRoutePathType,
       ...
       "rtmRibAdminDistance": rtmRibAdminDistance,
       "rtmRibPathType": rtmRibPathType,
       ...
       "rtmRouterDefinitionTable": rtmRouterDefinitionTable,
       "rtmRouterDefinitionEntry": rtmRouterDefinitionEntry,
       "rtmRouterDefinitionFteIndex": rtmRouterDefinitionFteIndex,
       "rtmRouterDefinitionRowStatus": rtmRouterDefinitionRowStatus,
       "rtmRouterDefinitionRouterId": rtmRouterDefinitionRouterId,
       "rtmTrap": rtmTrap,
       "rtmTraps": rtmTraps,
       ...
       "rtmRouterDefinitionMandatoryGroup": rtmRouterDefinitionMandatoryGroup}
)
