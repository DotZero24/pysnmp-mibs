...
if mibBuilder.loadTexts:qtechMplsLdpMIB.setRevisions(('2011-05-15 00:00',))
_QtechMplsLdpMIBObjects_ObjectIdentity=ObjectIdentity
qtechMplsLdpMIBObjects=_QtechMplsLdpMIBObjects_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,99,1))
_QtechMplsLdpObjects_ObjectIdentity=ObjectIdentity
qtechMplsLdpObjects=_QtechMplsLdpObjects_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,99,1,1))
_QtechMplsLdpMplsGernalMibObjects_ObjectIdentity=ObjectIdentity
qtechMplsLdpMplsGernalMibObjects=_QtechMplsLdpMplsGernalMibObjects_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1))
_MplsLdpThreadName_Type=SnmpAdminString
_MplsLdpThreadName_Object=MibScalar
mplsLdpThreadName=_MplsLdpThreadName_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,1),_MplsLdpThreadName_Type())
...
mplsLdpSessionUpCount=_MplsLdpSessionUpCount_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,2),_MplsLdpSessionUpCount_Type())
...
mplsLdpSessionCreatCount=_MplsLdpSessionCreatCount_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,3),_MplsLdpSessionCreatCount_Type())
...
mplsLdpSessionDownCount=_MplsLdpSessionDownCount_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,4),_MplsLdpSessionDownCount_Type())
...
mplsLdpSessionDownCauseByInf=_MplsLdpSessionDownCauseByInf_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,5),_MplsLdpSessionDownCauseByInf_Type())
mplsLdpSessionDownCauseByInf.setMaxAccess(_B)
if mibBuilder.loadTexts:mplsLdpSessionDownCauseByInf.setStatus(_A)
_QtechMplsLdpFecTable_Object=MibTable
qtechMplsLdpFecTable=_QtechMplsLdpFecTable_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6))
if mibBuilder.loadTexts:qtechMplsLdpFecTable.setStatus(_A)
_QtechMplsLdpFecEntry_Object=MibTableRow
qtechMplsLdpFecEntry=_QtechMplsLdpFecEntry_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1))
qtechMplsLdpFecEntry.setIndexNames((0,_E,_F))
if mibBuilder.loadTexts:qtechMplsLdpFecEntry.setStatus(_A)
_MplsFecIndex_Type=Integer32
_MplsFecIndex_Object=MibTableColumn
mplsFecIndex=_MplsFecIndex_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,1),_MplsFecIndex_Type())
...
mplsFecType=_MplsFecType_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,2),_MplsFecType_Type())
...
mplsFecAddrType=_MplsFecAddrType_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,3),_MplsFecAddrType_Type())
...
mplsFecAddr=_MplsFecAddr_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,4),_MplsFecAddr_Type())
...
mplsFecAddrPrefixLength=_MplsFecAddrPrefixLength_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,5),_MplsFecAddrPrefixLength_Type())
...
mplsFecStatus=_MplsFecStatus_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,6),_MplsFecStatus_Type())
...
mplsFecLspActivity=_MplsFecLspActivity_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,7),_MplsFecLspActivity_Type())
...
mplsFecLspDisconnect=_MplsFecLspDisconnect_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,8),_MplsFecLspDisconnect_Type())
...
mplsFecLspDisconnectType=_MplsFecLspDisconnectType_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,9),_MplsFecLspDisconnectType_Type())
...
mplsFecSession=_MplsFecSession_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,10),_MplsFecSession_Type())
...
mplsLdpSessionCloseType=_MplsLdpSessionCloseType_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,11),_MplsLdpSessionCloseType_Type())
...
mplsFecIngressBytes=_MplsFecIngressBytes_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,12),_MplsFecIngressBytes_Type())
...
mplsFecIngressPackets=_MplsFecIngressPackets_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,13),_MplsFecIngressPackets_Type())
...
mplsFecTransmitBytes=_MplsFecTransmitBytes_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,14),_MplsFecTransmitBytes_Type())
...
mplsFecTransmitPackets=_MplsFecTransmitPackets_Object((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,1,6,1,15),_MplsFecTransmitPackets_Type())
mplsFecTransmitPackets.setMaxAccess(_B)
if mibBuilder.loadTexts:mplsFecTransmitPackets.setStatus(_A)
_QtechMplsLdpConfigMibObjects_ObjectIdentity=ObjectIdentity
qtechMplsLdpConfigMibObjects=_QtechMplsLdpConfigMibObjects_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,99,1,1,2))
_QtechMplsLdpConformance_ObjectIdentity=ObjectIdentity
qtechMplsLdpConformance=_QtechMplsLdpConformance_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,99,1,2))
mibBuilder.exportSymbols(_E,**{'qtechMplsLdpMIB':qtechMplsLdpMIB,'qtechMplsLdpMIBObjects':qtechMplsLdpMIBObjects,'qtechMplsLdpObjects':qtechMplsLdpObjects,'qtechMplsLdpMplsGernalMibObjects':qtechMplsLdpMplsGernalMibObjects,'mplsLdpThreadName':mplsLdpThreadName,'mplsLdpSessionUpCount':mplsLdpSessionUpCount,'mplsLdpSessionCreatCount':mplsLdpSessionCreatCount,'mplsLdpSessionDownCount':mplsLdpSessionDownCount,'mplsLdpSessionDownCauseByInf':mplsLdpSessionDownCauseByInf,'qtechMplsLdpFecTable':qtechMplsLdpFecTable,'qtechMplsLdpFecEntry':qtechMplsLdpFecEntry,_F:mplsFecIndex,'mplsFecType':mplsFecType,'mplsFecAddrType':mplsFecAddrType,'mplsFecAddr':mplsFecAddr,'mplsFecAddrPrefixLength':mplsFecAddrPrefixLength,'mplsFecStatus':mplsFecStatus,'mplsFecLspActivity':mplsFecLspActivity,'mplsFecLspDisconnect':mplsFecLspDisconnect,'mplsFecLspDisconnectType':mplsFecLspDisconnectType,'mplsFecSession':mplsFecSession,'mplsLdpSessionCloseType':mplsLdpSessionCloseType,'mplsFecIngressBytes':mplsFecIngressBytes,'mplsFecIngressPackets':mplsFecIngressPackets,'mplsFecTransmitBytes':mplsFecTransmitBytes,'mplsFecTransmitPackets':mplsFecTransmitPackets,'qtechMplsLdpConfigMibObjects':qtechMplsLdpConfigMibObjects,'qtechMplsLdpConformance':qtechMplsLdpConformance})