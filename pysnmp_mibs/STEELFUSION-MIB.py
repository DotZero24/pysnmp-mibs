# SNMP MIB module (STEELFUSION-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/riverbed/STEELFUSION-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:16:10 2025
...
steelfusion = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52)
)
if mibBuilder.loadTexts:
    steelfusion.setRevisions(
        ("2015-01-28 00:00",
         "2014-12-09 00:00",
         "2014-11-11 00:00",
         "2014-09-18 00:00",
...
system = _System_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 1)
)
_Model_Type = OctetString
_Model_Object = MibScalar
model = _Model_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 1, 1),
    _Model_Type()
)
...
procIndex = _ProcIndex_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 5, 1, 1),
    _ProcIndex_Type()
)
...
procName = _ProcName_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 5, 1, 2),
    _ProcName_Type()
)
...
procNumFailures = _ProcNumFailures_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 5, 1, 4),
...
peerIndex = _PeerIndex_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 6, 1, 1, 1),
    _PeerIndex_Type()
)
...
peerHostname = _PeerHostname_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 6, 1, 1, 2),
    _PeerHostname_Type()
)
...
peerVersion = _PeerVersion_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 6, 1, 1, 3),
    _PeerVersion_Type()
)
...
peerAddress = _PeerAddress_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 6, 1, 1, 4),
    _PeerAddress_Type()
)
...
peerModel = _PeerModel_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 6, 1, 1, 5),
    _PeerModel_Type()
)
...
crlIndex = _CrlIndex_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 11, 1, 1, 1),
    _CrlIndex_Type()
)
...
crlFeatureName = _CrlFeatureName_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 11, 1, 1, 2),
...
crlNumCdpErr = _CrlNumCdpErr_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 11, 1, 1, 3),
    _CrlNumCdpErr_Type()
)
...
crlErrMsg = _CrlErrMsg_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 11, 1, 1, 4),
    _CrlErrMsg_Type()
)
...
neighborIndex = _NeighborIndex_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 1),
    _NeighborIndex_Type()
)
...
neighborAddress = _NeighborAddress_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 2),
...
neighborState = _NeighborState_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 3),
    _NeighborState_Type()
)
...
neighborNatReqSent = _NeighborNatReqSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 4),
...
neighborNatDelSent = _NeighborNatDelSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 5),
...
neighborNatAckRcvd = _NeighborNatAckRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 6),
...
neighborNatReqRcvd = _NeighborNatReqRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 7),
...
neighborNatDelRcvd = _NeighborNatDelRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 8),
...
neighborNatAckSent = _NeighborNatAckSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 9),
...
neighborDynReqSent = _NeighborDynReqSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 10),
...
neighborDynDelSent = _NeighborDynDelSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 11),
...
neighborDynAckRcvd = _NeighborDynAckRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 12),
...
neighborDynReqRcvd = _NeighborDynReqRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 13),
...
neighborDynDelRcvd = _NeighborDynDelRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 14),
...
neighborDynAckSent = _NeighborDynAckSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 15),
...
neighborRedirReqSent = _NeighborRedirReqSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 16),
...
neighborRedirDelSent = _NeighborRedirDelSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 17),
...
neighborRedirAckRcvd = _NeighborRedirAckRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 18),
...
neighborRedirReqRcvd = _NeighborRedirReqRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 19),
...
neighborRedirDelRcvd = _NeighborRedirDelRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 20),
...
neighborRedirAckSent = _NeighborRedirAckSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 21),
...
neighborConnFailures = _NeighborConnFailures_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 22),
...
neighborKeepaliveTimeouts = _NeighborKeepaliveTimeouts_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 23),
...
neighborRequestTimeouts = _NeighborRequestTimeouts_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 24),
...
neighborMaxLatency = _NeighborMaxLatency_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 1, 1, 25),
...
nghAggrConnected = _NghAggrConnected_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 2),
...
nghAggrConnFailures = _NghAggrConnFailures_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 3),
...
nghAggrKeepaliveTimouts = _NghAggrKeepaliveTimouts_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 4),
...
nghAggrRequestTimeouts = _NghAggrRequestTimeouts_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 5),
...
nghAggrMaxLatency = _NghAggrMaxLatency_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 6),
...
nghAggrNatReqSent = _NghAggrNatReqSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 7),
...
nghAggrNatDelSent = _NghAggrNatDelSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 8),
...
nghAggrNatAckRcvd = _NghAggrNatAckRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 9),
...
nghAggrNatReqRcvd = _NghAggrNatReqRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 10),
...
nghAggrNatDelRcvd = _NghAggrNatDelRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 11),
...
nghAggrNatAckSent = _NghAggrNatAckSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 12),
...
nghAggrDynReqSent = _NghAggrDynReqSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 13),
...
nghAggrDynDelSent = _NghAggrDynDelSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 14),
...
nghAggrDynAckRcvd = _NghAggrDynAckRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 15),
...
nghAggrDynReqRcvd = _NghAggrDynReqRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 16),
...
nghAggrDynDelRcvd = _NghAggrDynDelRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 17),
...
nghAggrDynAckSent = _NghAggrDynAckSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 18),
...
nghAggrRedirReqSent = _NghAggrRedirReqSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 19),
...
nghAggrRedirDelSent = _NghAggrRedirDelSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 20),
...
nghAggrRedirAckRcvd = _NghAggrRedirAckRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 21),
...
nghAggrRedirReqRcvd = _NghAggrRedirReqRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 22),
...
nghAggrRedirDelRcvd = _NghAggrRedirDelRcvd_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 23),
...
nghAggrRedirAckSent = _NghAggrRedirAckSent_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 12, 2, 24),
...
hypervisorHardwareTemperatureTable = _HypervisorHardwareTemperatureTable_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 300)
)
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureTable.setStatus("current")
_HypervisorHardwareTemperatureEntry_Object = MibTableRow
hypervisorHardwareTemperatureEntry = _HypervisorHardwareTemperatureEntry_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 300, 1)
)
hypervisorHardwareTemperatureEntry.setIndexNames(
    (0, "STEELFUSION-MIB", "hypervisorHardwareTemperatureIndex"),
)
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureEntry.setStatus("current")
_HypervisorHardwareTemperatureIndex_Type = Unsigned32
_HypervisorHardwareTemperatureIndex_Object = MibTableColumn
hypervisorHardwareTemperatureIndex = _HypervisorHardwareTemperatureIndex_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 300, 1, 1),
    _HypervisorHardwareTemperatureIndex_Type()
)
hypervisorHardwareTemperatureIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureIndex.setStatus("current")
_HypervisorHardwareTemperatureName_Type = OctetString
_HypervisorHardwareTemperatureName_Object = MibTableColumn
hypervisorHardwareTemperatureName = _HypervisorHardwareTemperatureName_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 300, 1, 2),
    _HypervisorHardwareTemperatureName_Type()
)
hypervisorHardwareTemperatureName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureName.setStatus("current")
_HypervisorHardwareTemperatureStatus_Type = OctetString
_HypervisorHardwareTemperatureStatus_Object = MibTableColumn
hypervisorHardwareTemperatureStatus = _HypervisorHardwareTemperatureStatus_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 300, 1, 3),
    _HypervisorHardwareTemperatureStatus_Type()
)
hypervisorHardwareTemperatureStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureStatus.setStatus("current")
_HypervisorHardwareTemperatureReading_Type = OctetString
_HypervisorHardwareTemperatureReading_Object = MibTableColumn
hypervisorHardwareTemperatureReading = _HypervisorHardwareTemperatureReading_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 300, 1, 4),
    _HypervisorHardwareTemperatureReading_Type()
)
hypervisorHardwareTemperatureReading.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureReading.setStatus("current")
...
hypervisorHardwareTemperatureMaxCritical = _HypervisorHardwareTemperatureMaxCritical_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 300, 1, 5),
    _HypervisorHardwareTemperatureMaxCritical_Type()
)
hypervisorHardwareTemperatureMaxCritical.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureMaxCritical.setStatus("current")
...
hypervisorHardwareTemperatureDescription = _HypervisorHardwareTemperatureDescription_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 300, 1, 6),
    _HypervisorHardwareTemperatureDescription_Type()
)
hypervisorHardwareTemperatureDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureDescription.setStatus("current")
_HypervisorHardwareTemperatureId_Type = OctetString
_HypervisorHardwareTemperatureId_Object = MibTableColumn
hypervisorHardwareTemperatureId = _HypervisorHardwareTemperatureId_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 300, 1, 7),
    _HypervisorHardwareTemperatureId_Type()
)
hypervisorHardwareTemperatureId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureId.setStatus("current")
_BlockstoreUncommittedBytes_Type = Counter64
_BlockstoreUncommittedBytes_Object = MibScalar
blockstoreUncommittedBytes = _BlockstoreUncommittedBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10000),
    _BlockstoreUncommittedBytes_Type()
)
blockstoreUncommittedBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreUncommittedBytes.setStatus("current")
_LunTable_Object = MibTable
lunTable = _LunTable_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10001)
)
if mibBuilder.loadTexts:
    lunTable.setStatus("current")
_LunEntry_Object = MibTableRow
lunEntry = _LunEntry_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10001, 1)
)
lunEntry.setIndexNames(
    (0, "STEELFUSION-MIB", "lunIndex"),
)
if mibBuilder.loadTexts:
...
lunIndex = _LunIndex_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10001, 1, 1),
    _LunIndex_Type()
)
...
lunId = _LunId_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10001, 1, 2),
    _LunId_Type()
)
...
lunUncommittedBytes = _LunUncommittedBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10001, 1, 3),
    _LunUncommittedBytes_Type()
)
lunUncommittedBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lunUncommittedBytes.setStatus("current")
_BlockstoreNotAvailableForWritesBytes_Type = Counter64
_BlockstoreNotAvailableForWritesBytes_Object = MibScalar
blockstoreNotAvailableForWritesBytes = _BlockstoreNotAvailableForWritesBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10002),
    _BlockstoreNotAvailableForWritesBytes_Type()
)
blockstoreNotAvailableForWritesBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreNotAvailableForWritesBytes.setStatus("current")
_BlockstoreAvailableForWritesBytes_Type = Counter64
_BlockstoreAvailableForWritesBytes_Object = MibScalar
blockstoreAvailableForWritesBytes = _BlockstoreAvailableForWritesBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10003),
    _BlockstoreAvailableForWritesBytes_Type()
)
blockstoreAvailableForWritesBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreAvailableForWritesBytes.setStatus("current")
_BlockstoreUnevictableBytes_Type = Counter64
_BlockstoreUnevictableBytes_Object = MibScalar
blockstoreUnevictableBytes = _BlockstoreUnevictableBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10004),
    _BlockstoreUnevictableBytes_Type()
)
blockstoreUnevictableBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreUnevictableBytes.setStatus("current")
_BlockstoreCachedPinnedBytes_Type = Counter64
_BlockstoreCachedPinnedBytes_Object = MibScalar
blockstoreCachedPinnedBytes = _BlockstoreCachedPinnedBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10005),
    _BlockstoreCachedPinnedBytes_Type()
)
blockstoreCachedPinnedBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreCachedPinnedBytes.setStatus("current")
_BlockstoreCachedUnpinnedBytes_Type = Counter64
_BlockstoreCachedUnpinnedBytes_Object = MibScalar
blockstoreCachedUnpinnedBytes = _BlockstoreCachedUnpinnedBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10006),
    _BlockstoreCachedUnpinnedBytes_Type()
)
blockstoreCachedUnpinnedBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreCachedUnpinnedBytes.setStatus("current")
_BlockstoreFreeBytes_Type = Counter64
_BlockstoreFreeBytes_Object = MibScalar
blockstoreFreeBytes = _BlockstoreFreeBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10007),
    _BlockstoreFreeBytes_Type()
)
blockstoreFreeBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreFreeBytes.setStatus("current")
_BlockstoreUsableBytes_Type = Counter64
_BlockstoreUsableBytes_Object = MibScalar
blockstoreUsableBytes = _BlockstoreUsableBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10008),
    _BlockstoreUsableBytes_Type()
)
blockstoreUsableBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreUsableBytes.setStatus("current")
_BlockstoreMaximumPinnableBytes_Type = Counter64
_BlockstoreMaximumPinnableBytes_Object = MibScalar
blockstoreMaximumPinnableBytes = _BlockstoreMaximumPinnableBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10009),
    _BlockstoreMaximumPinnableBytes_Type()
)
blockstoreMaximumPinnableBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreMaximumPinnableBytes.setStatus("current")
_BlockstoreRemainingPinnableBytes_Type = Counter64
_BlockstoreRemainingPinnableBytes_Object = MibScalar
blockstoreRemainingPinnableBytes = _BlockstoreRemainingPinnableBytes_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 2, 10010),
    _BlockstoreRemainingPinnableBytes_Type()
)
blockstoreRemainingPinnableBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    blockstoreRemainingPinnableBytes.setStatus("current")
_Config_ObjectIdentity = ObjectIdentity
config = _Config_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 3)
)
_ActiveConfig_Type = OctetString
_ActiveConfig_Object = MibScalar
activeConfig = _ActiveConfig_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 3, 1),
    _ActiveConfig_Type()
)
...
cpuIndivIndex = _CpuIndivIndex_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 1, 5, 1, 1),
    _CpuIndivIndex_Type()
)
...
cpuIndivId = _CpuIndivId_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 1, 5, 1, 2),
    _CpuIndivId_Type()
)
...
cpuIndivIdleTime = _CpuIndivIdleTime_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 1, 5, 1, 3),
...
cpuIndivSystemTime = _CpuIndivSystemTime_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 1, 5, 1, 4),
...
cpuIndivUserTime = _CpuIndivUserTime_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 1, 5, 1, 5),
...
bwAggInWan = _BwAggInWan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 1, 2),
    _BwAggInWan_Type()
)
...
bwAggOutLan = _BwAggOutLan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 1, 3),
    _BwAggOutLan_Type()
)
...
bwAggOutWan = _BwAggOutWan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 1, 4),
    _BwAggOutWan_Type()
)
...
bwPortNumber = _BwPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 2, 1, 1, 1),
    _BwPortNumber_Type()
)
...
bwPortInLan = _BwPortInLan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 2, 1, 1, 2),
    _BwPortInLan_Type()
)
...
bwPortInWan = _BwPortInWan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 2, 1, 1, 3),
    _BwPortInWan_Type()
)
...
bwPortOutLan = _BwPortOutLan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 2, 1, 1, 4),
    _BwPortOutLan_Type()
)
...
bwPortOutWan = _BwPortOutWan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 2, 1, 1, 5),
    _BwPortOutWan_Type()
)
...
bwPassThroughOut = _BwPassThroughOut_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 3, 2),
...
bwPassThroughTotal = _BwPassThroughTotal_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 3, 3, 3),
...
ttTalkerId = _TtTalkerId_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 1, 1, 1),
    _TtTalkerId_Type()
)
...
ttTalkerIp1 = _TtTalkerIp1_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 1, 1, 2),
    _TtTalkerIp1_Type()
)
...
ttTalkerPort1 = _TtTalkerPort1_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 1, 1, 3),
    _TtTalkerPort1_Type()
)
...
ttTalkerIp2 = _TtTalkerIp2_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 1, 1, 4),
    _TtTalkerIp2_Type()
)
...
ttTalkerPort2 = _TtTalkerPort2_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 1, 1, 5),
    _TtTalkerPort2_Type()
)
...
ttTalkerByteCount = _TtTalkerByteCount_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 1, 1, 6),
...
ttSrcHostId = _TtSrcHostId_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 2, 1, 1),
    _TtSrcHostId_Type()
)
...
ttSrcHostIp = _TtSrcHostIp_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 2, 1, 2),
    _TtSrcHostIp_Type()
)
...
ttSrcHostByteCount = _TtSrcHostByteCount_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 2, 1, 3),
...
ttDestHostId = _TtDestHostId_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 3, 1, 1),
    _TtDestHostId_Type()
)
...
ttDestHostIp = _TtDestHostIp_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 3, 1, 2),
    _TtDestHostIp_Type()
)
...
ttDestHostByteCount = _TtDestHostByteCount_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 3, 1, 3),
...
ttAppPortId = _TtAppPortId_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 4, 1, 1),
    _TtAppPortId_Type()
)
...
ttAppPort = _TtAppPort_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 4, 1, 2),
    _TtAppPort_Type()
)
...
ttAppPortByteCount = _TtAppPortByteCount_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 5, 4, 1, 3),
...
bwHCAggInWan = _BwHCAggInWan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 6, 1, 2),
    _BwHCAggInWan_Type()
)
...
bwHCAggOutLan = _BwHCAggOutLan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 6, 1, 3),
    _BwHCAggOutLan_Type()
)
...
bwAggHCOutWan = _BwAggHCOutWan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 6, 1, 4),
    _BwAggHCOutWan_Type()
)
...
bwHCPortNumber = _BwHCPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 6, 2, 1, 1, 1),
...
bwHCPortInLan = _BwHCPortInLan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 6, 2, 1, 1, 2),
    _BwHCPortInLan_Type()
)
...
bwHCPortInWan = _BwHCPortInWan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 6, 2, 1, 1, 3),
    _BwHCPortInWan_Type()
)
...
bwHCPortOutLan = _BwHCPortOutLan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 6, 2, 1, 1, 4),
...
bwHCPortOutWan = _BwHCPortOutWan_Object(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 5, 6, 2, 1, 1, 5),
...
procCrash = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1)
)
procCrash.setObjects(
    ("STEELFUSION-MIB", "procName")
)
if mibBuilder.loadTexts:
    procCrash.setStatus(
        "current"
...
peerVersionMismatch = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 6)
)
peerVersionMismatch.setObjects(
    ("STEELFUSION-MIB", "systemVersion")
)
if mibBuilder.loadTexts:
...
asymRouteError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 20)
)
asymRouteError.setObjects(
    ("STEELFUSION-MIB", "asymRouteCount")
)
if mibBuilder.loadTexts:
...
cfConnFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 28)
)
cfConnFailure.setObjects(
    ("STEELFUSION-MIB", "neighborAddress")
)
if mibBuilder.loadTexts:
...
crlError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 36)
)
crlError.setObjects(
      *(("STEELFUSION-MIB", "crlFeatureName"),
        ("STEELFUSION-MIB", "crlErrMsg"))
)
if mibBuilder.loadTexts:
    crlError.setStatus(
        "current"
...
secureTransportControllerUnreachable = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 81)
)
if mibBuilder.loadTexts:
    secureTransportControllerUnreachable.setStatus(
        "current"
    )

secureTransportRegistrationFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 82)
)
if mibBuilder.loadTexts:
    secureTransportRegistrationFailed.setStatus(
        "current"
    )

pathSelectionPathProbingError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 83)
)
if mibBuilder.loadTexts:
...
webProxyConfigAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 84)
)
if mibBuilder.loadTexts:
    webProxyConfigAlarm.setStatus(
        "current"
    )

webProxyServiceAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 85)
)
if mibBuilder.loadTexts:
    webProxyServiceAlarm.setStatus(
        "current"
    )

cpuUtilClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1003)
)
if mibBuilder.loadTexts:
...
pagingActivityClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1004)
)
if mibBuilder.loadTexts:
...
peerVersionMismatchClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1006)
)
...
bypassModeClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1007)
)
if mibBuilder.loadTexts:
...
raidErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1008)
)
if mibBuilder.loadTexts:
...
storeCorruptionClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1009)
)
if mibBuilder.loadTexts:
...
admissionMemErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1010)
)
if mibBuilder.loadTexts:
...
admissionConnErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1011)
)
if mibBuilder.loadTexts:
...
haltErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1012)
)
if mibBuilder.loadTexts:
...
serviceErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1013)
)
if mibBuilder.loadTexts:
...
linkErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1017)
)
if mibBuilder.loadTexts:
...
nfsV2V4Clear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1018)
)
if mibBuilder.loadTexts:
...
powerSupplyErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1019)
)
if mibBuilder.loadTexts:
...
asymRouteErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1020)
)
if mibBuilder.loadTexts:
...
fanErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1021)
)
if mibBuilder.loadTexts:
...
memoryErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1022)
)
if mibBuilder.loadTexts:
...
ipmiClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1023)
)
if mibBuilder.loadTexts:
    ipmiClear.setStatus(
        "current"
...
temperatureNormal = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1026)
)
if mibBuilder.loadTexts:
...
temperatureNonCritical = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1027)
)
if mibBuilder.loadTexts:
...
cfConnRestored = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1028)
)
...
cfConnLostEosClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1029)
)
...
cfConnLostErrClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1030)
)
...
cfKeepaliveTimeoutClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1031)
)
...
cfAckTimeoutClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1032)
)
...
cfReadInfoTimeoutClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1033)
)
...
cfLatencyExceededClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1034)
)
...
sslPeeringSCEPAutoReenrollClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1035)
)
if mibBuilder.loadTexts:
...
crlClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1036)
)
if mibBuilder.loadTexts:
    crlClear.setStatus(
        "current"
...
datastoreSyncFailureClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1037)
)
if mibBuilder.loadTexts:
...
secureVaultClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1040)
)
if mibBuilder.loadTexts:
...
diskErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1045)
)
if mibBuilder.loadTexts:
...
admissionCpuErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1052)
)
if mibBuilder.loadTexts:
...
admissionTcpErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1053)
)
if mibBuilder.loadTexts:
...
systemDiskFullErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1054)
)
if mibBuilder.loadTexts:
...
domainJoinErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1055)
)
if mibBuilder.loadTexts:
...
certsExpiringErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1056)
)
if mibBuilder.loadTexts:
...
licenseErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1057)
)
if mibBuilder.loadTexts:
...
hardwareErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1058)
)
if mibBuilder.loadTexts:
...
sysdetailErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1059)
)
if mibBuilder.loadTexts:
...
admissionMapiErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1060)
)
if mibBuilder.loadTexts:
...
neighborIncompatibilityClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1061)
)
if mibBuilder.loadTexts:
...
flashErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1062)
)
if mibBuilder.loadTexts:
...
lanWanLoopClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1063)
)
if mibBuilder.loadTexts:
...
optimizationServiceStatusClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1064)
)
if mibBuilder.loadTexts:
...
upgradeFailureClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1065)
)
if mibBuilder.loadTexts:
...
clusterDisconnectedSHAlertClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1068)
)
if mibBuilder.loadTexts:
...
smbAlertClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1069)
)
if mibBuilder.loadTexts:
...
linkDuplexClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1070)
)
if mibBuilder.loadTexts:
...
linkIoErrorsClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1071)
)
if mibBuilder.loadTexts:
...
clusterIpv6IncompatiblePeerClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1074)
)
if mibBuilder.loadTexts:
...
pathSelectionPathDownClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1077)
)
if mibBuilder.loadTexts:
...
clusterNeighborIncompatibleClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1080)
)
if mibBuilder.loadTexts:
...
secureTransportControllerConnected = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1081)
)
if mibBuilder.loadTexts:
    secureTransportControllerConnected.setStatus(
        "current"
    )

secureTransportRegistrationSucceeded = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1082)
)
if mibBuilder.loadTexts:
    secureTransportRegistrationSucceeded.setStatus(
        "current"
    )

pathSelectionPathProbingErrorClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1083)
)
if mibBuilder.loadTexts:
...
webProxyConfigAlarmClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1084)
)
if mibBuilder.loadTexts:
    webProxyConfigAlarmClear.setStatus(
        "current"
    )

webProxyServiceAlarmClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 1085)
)
if mibBuilder.loadTexts:
    webProxyServiceAlarmClear.setStatus(
        "current"
    )

graniteLunError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 10000)
)
if mibBuilder.loadTexts:
    graniteLunError.setStatus(
        "current"
    )

graniteISCSIError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 10001)
)
if mibBuilder.loadTexts:
    graniteISCSIError.setStatus(
        "current"
    )

graniteSnapshotError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 10003)
)
if mibBuilder.loadTexts:
    graniteSnapshotError.setStatus(
        "current"
    )

graniteBlockstoreError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 10004)
)
if mibBuilder.loadTexts:
    graniteBlockstoreError.setStatus(
        "current"
    )

graniteCoreError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 10005)
)
if mibBuilder.loadTexts:
    graniteCoreError.setStatus(
        "current"
    )

graniteUncommittedDataError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 10006)
)
if mibBuilder.loadTexts:
    graniteUncommittedDataError.setStatus(
        "current"
    )

graniteHighAvailabilityError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 10007)
)
if mibBuilder.loadTexts:
    graniteHighAvailabilityError.setStatus(
        "current"
    )

graniteApplianceUnlicensedError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 10009)
)
if mibBuilder.loadTexts:
    graniteApplianceUnlicensedError.setStatus(
        "current"
    )

graniteLunClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 11000)
)
if mibBuilder.loadTexts:
    graniteLunClear.setStatus(
        "current"
    )

graniteISCSIClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 11001)
)
if mibBuilder.loadTexts:
    graniteISCSIClear.setStatus(
        "current"
    )

graniteSnapshotClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 11003)
)
if mibBuilder.loadTexts:
    graniteSnapshotClear.setStatus(
        "current"
    )

graniteBlockstoreClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 11004)
)
if mibBuilder.loadTexts:
    graniteBlockstoreClear.setStatus(
        "current"
    )

graniteCoreClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 11005)
)
if mibBuilder.loadTexts:
    graniteCoreClear.setStatus(
        "current"
    )

graniteUncommittedDataClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 11006)
)
if mibBuilder.loadTexts:
    graniteUncommittedDataClear.setStatus(
        "current"
    )

graniteHighAvailabilityClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 11007)
)
if mibBuilder.loadTexts:
    graniteHighAvailabilityClear.setStatus(
        "current"
    )

graniteApplianceUnlicensedClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 11009)
)
if mibBuilder.loadTexts:
    graniteApplianceUnlicensedClear.setStatus(
        "current"
    )

hypervisorHardwareMgmtConnectionError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30002)
)
if mibBuilder.loadTexts:
    hypervisorHardwareMgmtConnectionError.setStatus(
        "current"
    )

hypervisorHardwarePowerError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30003)
)
if mibBuilder.loadTexts:
    hypervisorHardwarePowerError.setStatus(
        "current"
    )

hypervisorHardwareMemoryError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30005)
)
if mibBuilder.loadTexts:
    hypervisorHardwareMemoryError.setStatus(
        "current"
    )

hypervisorHardwareOtherHardwareError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30006)
)
if mibBuilder.loadTexts:
    hypervisorHardwareOtherHardwareError.setStatus(
        "current"
    )

hypervisorHardwareTemperatureError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30007)
)
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureError.setStatus(
        "current"
    )

hypervisorLicenseError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30008)
)
if mibBuilder.loadTexts:
    hypervisorLicenseError.setStatus(
        "current"
    )

hypervisorOperationError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30009)
)
if mibBuilder.loadTexts:
    hypervisorOperationError.setStatus(
        "current"
    )

vspConnectionError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30010)
)
if mibBuilder.loadTexts:
    vspConnectionError.setStatus(
        "current"
    )

vspInstallationError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30011)
)
if mibBuilder.loadTexts:
    vspInstallationError.setStatus(
        "current"
    )

vspLicenseError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30012)
)
if mibBuilder.loadTexts:
    vspLicenseError.setStatus(
        "current"
    )

vspBaseLicenseError = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 30013)
)
if mibBuilder.loadTexts:
    vspBaseLicenseError.setStatus(
        "current"
    )

hypervisorHardwareMgmtConnectionClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31002)
)
if mibBuilder.loadTexts:
    hypervisorHardwareMgmtConnectionClear.setStatus(
        "current"
    )

hypervisorHardwarePowerClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31003)
)
if mibBuilder.loadTexts:
    hypervisorHardwarePowerClear.setStatus(
        "current"
    )

hypervisorHardwareMemoryClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31005)
)
if mibBuilder.loadTexts:
    hypervisorHardwareMemoryClear.setStatus(
        "current"
    )

hypervisorHardwareOtherHardwareClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31006)
)
if mibBuilder.loadTexts:
    hypervisorHardwareOtherHardwareClear.setStatus(
        "current"
    )

hypervisorHardwareTemperatureClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31007)
)
if mibBuilder.loadTexts:
    hypervisorHardwareTemperatureClear.setStatus(
        "current"
    )

hypervisorLicenseClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31008)
)
if mibBuilder.loadTexts:
    hypervisorLicenseClear.setStatus(
        "current"
    )

hypervisorOperationClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31009)
)
if mibBuilder.loadTexts:
    hypervisorOperationClear.setStatus(
        "current"
    )

vspConnectionClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31010)
)
if mibBuilder.loadTexts:
    vspConnectionClear.setStatus(
        "current"
    )

vspInstallationClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31011)
)
if mibBuilder.loadTexts:
    vspInstallationClear.setStatus(
        "current"
    )

vspLicenseClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31012)
)
if mibBuilder.loadTexts:
    vspLicenseClear.setStatus(
        "current"
    )

vspBaseLicenseClear = NotificationType(
    (1, 3, 6, 1, 4, 1, 17163, 1, 52, 4, 0, 31013)
)
if mibBuilder.loadTexts:
    vspBaseLicenseClear.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"steelfusion": steelfusion,
       ...
       "hypervisorHardwareTemperatureTable": hypervisorHardwareTemperatureTable,
       "hypervisorHardwareTemperatureEntry": hypervisorHardwareTemperatureEntry,
       "hypervisorHardwareTemperatureIndex": hypervisorHardwareTemperatureIndex,
       "hypervisorHardwareTemperatureName": hypervisorHardwareTemperatureName,
       "hypervisorHardwareTemperatureStatus": hypervisorHardwareTemperatureStatus,
       "hypervisorHardwareTemperatureReading": hypervisorHardwareTemperatureReading,
       "hypervisorHardwareTemperatureMaxCritical": hypervisorHardwareTemperatureMaxCritical,
       "hypervisorHardwareTemperatureDescription": hypervisorHardwareTemperatureDescription,
       "hypervisorHardwareTemperatureId": hypervisorHardwareTemperatureId,
       "blockstoreUncommittedBytes": blockstoreUncommittedBytes,
       "lunTable": lunTable,
       "lunEntry": lunEntry,
       "lunIndex": lunIndex,
       "lunId": lunId,
       "lunUncommittedBytes": lunUncommittedBytes,
       "blockstoreNotAvailableForWritesBytes": blockstoreNotAvailableForWritesBytes,
       "blockstoreAvailableForWritesBytes": blockstoreAvailableForWritesBytes,
       "blockstoreUnevictableBytes": blockstoreUnevictableBytes,
       "blockstoreCachedPinnedBytes": blockstoreCachedPinnedBytes,
       "blockstoreCachedUnpinnedBytes": blockstoreCachedUnpinnedBytes,
       "blockstoreFreeBytes": blockstoreFreeBytes,
       "blockstoreUsableBytes": blockstoreUsableBytes,
       "blockstoreMaximumPinnableBytes": blockstoreMaximumPinnableBytes,
       "blockstoreRemainingPinnableBytes": blockstoreRemainingPinnableBytes,
       "config": config,
       ...
       "secureTransportControllerUnreachable": secureTransportControllerUnreachable,
       "secureTransportRegistrationFailed": secureTransportRegistrationFailed,
       "pathSelectionPathProbingError": pathSelectionPathProbingError,
       "webProxyConfigAlarm": webProxyConfigAlarm,
       "webProxyServiceAlarm": webProxyServiceAlarm,
       ...
       "secureTransportControllerConnected": secureTransportControllerConnected,
       "secureTransportRegistrationSucceeded": secureTransportRegistrationSucceeded,
       "pathSelectionPathProbingErrorClear": pathSelectionPathProbingErrorClear,
       "webProxyConfigAlarmClear": webProxyConfigAlarmClear,
       "webProxyServiceAlarmClear": webProxyServiceAlarmClear,
       "graniteLunError": graniteLunError,
       "graniteISCSIError": graniteISCSIError,
       "graniteSnapshotError": graniteSnapshotError,
       "graniteBlockstoreError": graniteBlockstoreError,
       "graniteCoreError": graniteCoreError,
       "graniteUncommittedDataError": graniteUncommittedDataError,
       "graniteHighAvailabilityError": graniteHighAvailabilityError,
       "graniteApplianceUnlicensedError": graniteApplianceUnlicensedError,
       "graniteLunClear": graniteLunClear,
       "graniteISCSIClear": graniteISCSIClear,
       "graniteSnapshotClear": graniteSnapshotClear,
       "graniteBlockstoreClear": graniteBlockstoreClear,
       "graniteCoreClear": graniteCoreClear,
       "graniteUncommittedDataClear": graniteUncommittedDataClear,
       "graniteHighAvailabilityClear": graniteHighAvailabilityClear,
       "graniteApplianceUnlicensedClear": graniteApplianceUnlicensedClear,
       "hypervisorHardwareMgmtConnectionError": hypervisorHardwareMgmtConnectionError,
       "hypervisorHardwarePowerError": hypervisorHardwarePowerError,
       "hypervisorHardwareMemoryError": hypervisorHardwareMemoryError,
       "hypervisorHardwareOtherHardwareError": hypervisorHardwareOtherHardwareError,
       "hypervisorHardwareTemperatureError": hypervisorHardwareTemperatureError,
       "hypervisorLicenseError": hypervisorLicenseError,
       "hypervisorOperationError": hypervisorOperationError,
       "vspConnectionError": vspConnectionError,
       "vspInstallationError": vspInstallationError,
       "vspLicenseError": vspLicenseError,
       "vspBaseLicenseError": vspBaseLicenseError,
       "hypervisorHardwareMgmtConnectionClear": hypervisorHardwareMgmtConnectionClear,
       "hypervisorHardwarePowerClear": hypervisorHardwarePowerClear,
       "hypervisorHardwareMemoryClear": hypervisorHardwareMemoryClear,
       "hypervisorHardwareOtherHardwareClear": hypervisorHardwareOtherHardwareClear,
       "hypervisorHardwareTemperatureClear": hypervisorHardwareTemperatureClear,
       "hypervisorLicenseClear": hypervisorLicenseClear,
       "hypervisorOperationClear": hypervisorOperationClear,
       "vspConnectionClear": vspConnectionClear,
       "vspInstallationClear": vspInstallationClear,
       "vspLicenseClear": vspLicenseClear,
       "vspBaseLicenseClear": vspBaseLicenseClear,
