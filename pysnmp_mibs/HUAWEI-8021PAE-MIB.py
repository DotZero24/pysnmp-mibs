...
hwpaeExtMibObjects=_HwpaeExtMibObjects_ObjectIdentity((1,3,6,1,4,1,2011,5,22,1))
_Hwdot1xPaeTraps_ObjectIdentity=ObjectIdentity
hwdot1xPaeTraps=_Hwdot1xPaeTraps_ObjectIdentity((1,3,6,1,4,1,2011,5,22,1,0))
_ProxycheckVlanId_Type=Integer32
_ProxycheckVlanId_Object=MibScalar
proxycheckVlanId=_ProxycheckVlanId_Object((1,3,6,1,4,1,2011,5,22,1,0,2),_ProxycheckVlanId_Type())
...
proxycheckPortName=_ProxycheckPortName_Object((1,3,6,1,4,1,2011,5,22,1,0,3),_ProxycheckPortName_Type())
...
proxycheckMacAddr=_ProxycheckMacAddr_Object((1,3,6,1,4,1,2011,5,22,1,0,4),_ProxycheckMacAddr_Type())
...
proxycheckIpaddr=_ProxycheckIpaddr_Object((1,3,6,1,4,1,2011,5,22,1,0,5),_ProxycheckIpaddr_Type())
...
proxycheckUsrName=_ProxycheckUsrName_Object((1,3,6,1,4,1,2011,5,22,1,0,6),_ProxycheckUsrName_Type())
...
hwdot1xPaeSystem=_Hwdot1xPaeSystem_ObjectIdentity((1,3,6,1,4,1,2011,5,22,1,1))
...
hwdot1xAuthQuietPeriod=_Hwdot1xAuthQuietPeriod_Object((1,3,6,1,4,1,2011,5,22,1,1,1),_Hwdot1xAuthQuietPeriod_Type())
...
hwdot1xAuthTxPeriod=_Hwdot1xAuthTxPeriod_Object((1,3,6,1,4,1,2011,5,22,1,1,2),_Hwdot1xAuthTxPeriod_Type())
...
hwdot1xAuthSuppTimeout=_Hwdot1xAuthSuppTimeout_Object((1,3,6,1,4,1,2011,5,22,1,1,3),_Hwdot1xAuthSuppTimeout_Type())
...
hwdot1xAuthServerTimeout=_Hwdot1xAuthServerTimeout_Object((1,3,6,1,4,1,2011,5,22,1,1,4),_Hwdot1xAuthServerTimeout_Type())
...
hwdot1xAuthMaxReq=_Hwdot1xAuthMaxReq_Object((1,3,6,1,4,1,2011,5,22,1,1,5),_Hwdot1xAuthMaxReq_Type())
...
hwdot1xAuthReAuthPeriod=_Hwdot1xAuthReAuthPeriod_Object((1,3,6,1,4,1,2011,5,22,1,1,6),_Hwdot1xAuthReAuthPeriod_Type())
...
hwdot1xAuthMethod=_Hwdot1xAuthMethod_Object((1,3,6,1,4,1,2011,5,22,1,1,7),_Hwdot1xAuthMethod_Type())
...
hwdot1xPaeAuthenticator=_Hwdot1xPaeAuthenticator_ObjectIdentity((1,3,6,1,4,1,2011,5,22,1,2))
_Hwdot1xAuthConfigExtTable_Object=MibTable
hwdot1xAuthConfigExtTable=_Hwdot1xAuthConfigExtTable_Object((1,3,6,1,4,1,2011,5,22,1,2,1))
if mibBuilder.loadTexts:hwdot1xAuthConfigExtTable.setStatus(_A)
_Hwdot1xAuthConfigExtEntry_Object=MibTableRow
hwdot1xAuthConfigExtEntry=_Hwdot1xAuthConfigExtEntry_Object((1,3,6,1,4,1,2011,5,22,1,2,1,1))
...
hwdot1xpaeportAuthAdminStatus=_Hwdot1xpaeportAuthAdminStatus_Object((1,3,6,1,4,1,2011,5,22,1,2,1,1,1),_Hwdot1xpaeportAuthAdminStatus_Type())
...
hwdot1xpaeportControlledType=_Hwdot1xpaeportControlledType_Object((1,3,6,1,4,1,2011,5,22,1,2,1,1,2),_Hwdot1xpaeportControlledType_Type())
...
hwdot1xpaeportMaxUserNum=_Hwdot1xpaeportMaxUserNum_Object((1,3,6,1,4,1,2011,5,22,1,2,1,1,3),_Hwdot1xpaeportMaxUserNum_Type())
...
hwdot1xpaeportUserNumNow=_Hwdot1xpaeportUserNumNow_Object((1,3,6,1,4,1,2011,5,22,1,2,1,1,4),_Hwdot1xpaeportUserNumNow_Type())
...
hwdot1xpaeportClearStatistics=_Hwdot1xpaeportClearStatistics_Object((1,3,6,1,4,1,2011,5,22,1,2,1,1,5),_Hwdot1xpaeportClearStatistics_Type())
...
hwdot1xpaeportMcastTrigStatus=_Hwdot1xpaeportMcastTrigStatus_Object((1,3,6,1,4,1,2011,5,22,1,2,1,1,6),_Hwdot1xpaeportMcastTrigStatus_Type())
...
hwdot1xpaeportHandshakeStatus=_Hwdot1xpaeportHandshakeStatus_Object((1,3,6,1,4,1,2011,5,22,1,2,1,1,7),_Hwdot1xpaeportHandshakeStatus_Type())
hwdot1xpaeportHandshakeStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:hwdot1xpaeportHandshakeStatus.setStatus(_A)
supplicantproxycheck=NotificationType((1,3,6,1,4,1,2011,5,22,1,0,1))
