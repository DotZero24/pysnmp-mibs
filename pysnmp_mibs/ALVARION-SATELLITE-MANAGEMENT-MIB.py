...
mibBuilder.exportSymbols("ALVARION-SATELLITE-MANAGEMENT-MIB", satelliteInfo=satelliteInfo, satelliteMasterTrafficOnly=satelliteMasterTrafficOnly, alvarionSatelliteManagementMIBObjects=alvarionSatelliteManagementMIBObjects, satelliteDeviceMacAddress=satelliteDeviceMacAddress, satelliteNumber=satelliteNumber, satelliteDownNotification=satelliteDownNotification, satelliteUpNotificationEnabled=satelliteUpNotificationEnabled, satelliteProductName=satelliteProductName, satelliteGroupName=satelliteGroupName, alvarionSatelliteManagementMIBGroups=alvarionSatelliteManagementMIBGroups, alvarionSatelliteNotificationControlGroup=alvarionSatelliteNotificationControlGroup, satelliteFirmwareRevision=satelliteFirmwareRevision, satelliteTable=satelliteTable, satelliteChannelNumber=satelliteChannelNumber, alvarionSatelliteNotificationGroup=alvarionSatelliteNotificationGroup, alvarionSatelliteManagementMIBConformance=alvarionSatelliteManagementMIBConformance, satelliteIpAddress=satelliteIpAddress, alvarionSatelliteManagementMIBGroup=alvarionSatelliteManagementMIBGroup, satelliteIndex=satelliteIndex, satelliteSecureWebPort=satelliteSecureWebPort, satelliteMacAddress=satelliteMacAddress, satelliteEntry=satelliteEntry, alvarionSatelliteManagementMIBNotifications=alvarionSatelliteManagementMIBNotifications, satelliteDeviceId=satelliteDeviceId, satelliteUpNotification=satelliteUpNotification, masterSettings=masterSettings, satelliteForwardWirelessToWireless=satelliteForwardWirelessToWireless, satelliteDetectionPort=satelliteDetectionPort, PYSNMP_MODULE_ID=alvarionSatelliteManagementMIB, alvarionSatelliteManagementMIBNotificationPrefix=alvarionSatelliteManagementMIBNotificationPrefix, satelliteSNMPPort=satelliteSNMPPort, satelliteSSID=satelliteSSID, alvarionSatelliteManagementMIBCompliance=alvarionSatelliteManagementMIBCompliance, satelliteDownNotificationEnabled=satelliteDownNotificationEnabled, alvarionSatelliteManagementMIB=alvarionSatelliteManagementMIB, satelliteVLAN=satelliteVLAN, alvarionSatelliteManagementMIBCompliances=alvarionSatelliteManagementMIBCompliances, satelliteName=satelliteName, satelliteChannelNumberRadio2=satelliteChannelNumberRadio2)
