# SNMP MIB module (ALVARION-SATELLITE-MANAGEMENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-SATELLITE-MANAGEMENT-MIB
...
alvarionSatelliteManagementMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7)
)
...
satelliteIndex = _SatelliteIndex_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 1),
...
satelliteDeviceId = _SatelliteDeviceId_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 2),
...
satelliteMacAddress = _SatelliteMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 3),
...
satelliteIpAddress = _SatelliteIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 4),
...
satelliteName = _SatelliteName_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 5),
    _SatelliteName_Type()
)
...
satelliteSSID = _SatelliteSSID_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 6),
    _SatelliteSSID_Type()
)
...
satelliteChannelNumber = _SatelliteChannelNumber_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 7),
...
satelliteForwardWirelessToWireless = _SatelliteForwardWirelessToWireless_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 8),
...
satelliteMasterTrafficOnly = _SatelliteMasterTrafficOnly_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 9),
...
satelliteSNMPPort = _SatelliteSNMPPort_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 10),
...
satelliteSecureWebPort = _SatelliteSecureWebPort_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 11),
...
satelliteDeviceMacAddress = _SatelliteDeviceMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 12),
...
satelliteProductName = _SatelliteProductName_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 13),
...
satelliteFirmwareRevision = _SatelliteFirmwareRevision_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 14),
...
satelliteGroupName = _SatelliteGroupName_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 15),
...
satelliteChannelNumberRadio2 = _SatelliteChannelNumberRadio2_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 16),
...
satelliteVLAN = _SatelliteVLAN_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 17),
    _SatelliteVLAN_Type()
)
...
satelliteDetectionPort = _SatelliteDetectionPort_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 1, 1, 18),
...
satelliteNumber = _SatelliteNumber_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 1, 2),
...
masterSettings = _MasterSettings_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 2)
)


class _SatelliteUpNotificationEnabled_Type(AlvarionNotificationEnable):
    """Custom type satelliteUpNotificationEnabled based on AlvarionNotificationEnable"""
    defaultValue = 1


_SatelliteUpNotificationEnabled_Type.__name__ = "AlvarionNotificationEnable"
_SatelliteUpNotificationEnabled_Object = MibScalar
satelliteUpNotificationEnabled = _SatelliteUpNotificationEnabled_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 2, 1),
...
class _SatelliteDownNotificationEnabled_Type(AlvarionNotificationEnable):
    """Custom type satelliteDownNotificationEnabled based on AlvarionNotificationEnable"""
    defaultValue = 1


_SatelliteDownNotificationEnabled_Type.__name__ = "AlvarionNotificationEnable"
...
satelliteDownNotificationEnabled = _SatelliteDownNotificationEnabled_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 1, 2, 2),
...
alvarionSatelliteManagementMIBNotificationPrefix = _AlvarionSatelliteManagementMIBNotificationPrefix_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 2)
)
_AlvarionSatelliteManagementMIBNotifications_ObjectIdentity = ObjectIdentity
alvarionSatelliteManagementMIBNotifications = _AlvarionSatelliteManagementMIBNotifications_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 2, 0)
)
_AlvarionSatelliteManagementMIBConformance_ObjectIdentity = ObjectIdentity
alvarionSatelliteManagementMIBConformance = _AlvarionSatelliteManagementMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 3)
)
_AlvarionSatelliteManagementMIBCompliances_ObjectIdentity = ObjectIdentity
alvarionSatelliteManagementMIBCompliances = _AlvarionSatelliteManagementMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 3, 1)
)
_AlvarionSatelliteManagementMIBGroups_ObjectIdentity = ObjectIdentity
alvarionSatelliteManagementMIBGroups = _AlvarionSatelliteManagementMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 3, 2)
)

# Managed Objects groups

alvarionSatelliteManagementMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 3, 2, 1)
)
alvarionSatelliteManagementMIBGroup.setObjects(
      *(("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteDeviceId"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteMacAddress"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteIpAddress"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteName"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteSSID"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteChannelNumber"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteForwardWirelessToWireless"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteMasterTrafficOnly"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteSNMPPort"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteSecureWebPort"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteDeviceMacAddress"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteProductName"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteFirmwareRevision"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteGroupName"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteNumber"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteChannelNumberRadio2"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteVLAN"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteDetectionPort"))
)
if mibBuilder.loadTexts:
    alvarionSatelliteManagementMIBGroup.setStatus("current")

alvarionSatelliteNotificationControlGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 3, 2, 2)
)
alvarionSatelliteNotificationControlGroup.setObjects(
      *(("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteUpNotificationEnabled"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteDownNotificationEnabled"))
)
if mibBuilder.loadTexts:
    alvarionSatelliteNotificationControlGroup.setStatus("current")


# Notification objects

satelliteUpNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 2, 0, 1)
)
...
satelliteDownNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 2, 0, 2)
)
...
alvarionSatelliteNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 3, 2, 3)
)
alvarionSatelliteNotificationGroup.setObjects(
      *(("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteUpNotification"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "satelliteDownNotification"))
)
if mibBuilder.loadTexts:
    alvarionSatelliteNotificationGroup.setStatus(
        "current"
    )
...
alvarionSatelliteManagementMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 7, 3, 1, 1)
)
alvarionSatelliteManagementMIBCompliance.setObjects(
      *(("ALVARION-SATELLITE-MANAGEMENT-MIB", "alvarionSatelliteManagementMIBGroup"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "alvarionSatelliteNotificationControlGroup"),
        ("ALVARION-SATELLITE-MANAGEMENT-MIB", "alvarionSatelliteNotificationGroup"))
)
if mibBuilder.loadTexts:
    alvarionSatelliteManagementMIBCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"alvarionSatelliteManagementMIB": alvarionSatelliteManagementMIB,
       "alvarionSatelliteManagementMIBObjects": alvarionSatelliteManagementMIBObjects,
       ...
       "alvarionSatelliteManagementMIBNotificationPrefix": alvarionSatelliteManagementMIBNotificationPrefix,
       "alvarionSatelliteManagementMIBNotifications": alvarionSatelliteManagementMIBNotifications,
       "satelliteUpNotification": satelliteUpNotification,
       "satelliteDownNotification": satelliteDownNotification,
       "alvarionSatelliteManagementMIBConformance": alvarionSatelliteManagementMIBConformance,
       "alvarionSatelliteManagementMIBCompliances": alvarionSatelliteManagementMIBCompliances,
       "alvarionSatelliteManagementMIBCompliance": alvarionSatelliteManagementMIBCompliance,
       "alvarionSatelliteManagementMIBGroups": alvarionSatelliteManagementMIBGroups,
       "alvarionSatelliteManagementMIBGroup": alvarionSatelliteManagementMIBGroup,
       "alvarionSatelliteNotificationControlGroup": alvarionSatelliteNotificationControlGroup,
       "alvarionSatelliteNotificationGroup": alvarionSatelliteNotificationGroup}
)
