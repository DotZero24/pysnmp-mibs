...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/aruba/WLSX-TRAP-MIB
...
ArubaPortalServerDownReason, ArubaAPMasterStatus, ArubaHTMode, ArubaVrrpState, ArubaBlackListReason, ArubaAPUplinkType, ArubaStationType, ArubaStackIfTopoJoined, ArubaConfigurationChangeType, ArubaARMChangeReason, ArubaAddressType, ArubaThresholdResourceType, ArubaHTExtChannel, InterfaceIndex, ArubaDenyListReason, ArubaDBType, ArubaAuthenticationMethods, ArubaFrameType, ArubaPhyType, ArubaIfState, ArubaOperStateValue, ArubaEnableValue, ArubaIfStateChangeReason, ArubaAPConductorStatus, ArubaSwitchRole, ArubaStackState, ArubaAPUplinkChangeReason, ArubaStackChangeEvent, ArubaConfigurationState, ArubaAccessPointMode = mibBuilder.importSymbols("ARUBA-TC", "ArubaPortalServerDownReason", "ArubaAPMasterStatus", "ArubaHTMode", "ArubaVrrpState", "ArubaBlackListReason", "ArubaAPUplinkType", "ArubaStationType", "ArubaStackIfTopoJoined", "ArubaConfigurationChangeType", "ArubaARMChangeReason", "ArubaAddressType", "ArubaThresholdResourceType", "ArubaHTExtChannel", "InterfaceIndex", "ArubaDenyListReason", "ArubaDBType", "ArubaAuthenticationMethods", "ArubaFrameType", "ArubaPhyType", "ArubaIfState", "ArubaOperStateValue", "ArubaEnableValue", "ArubaIfStateChangeReason", "ArubaAPConductorStatus", "ArubaSwitchRole", "ArubaStackState", "ArubaAPUplinkChangeReason", "ArubaStackChangeEvent", "ArubaConfigurationState", "ArubaAccessPointMode")
...
DisplayString, MacAddress, TDomain, TimeInterval, RowStatus, StorageType, TAddress, TestAndIncr, DateAndTime, PhysAddress, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "MacAddress", "TDomain", "TimeInterval", "RowStatus", "StorageType", "TAddress", "TestAndIncr", "DateAndTime", "PhysAddress", "TruthValue", "TextualConvention")
wlsrTrapMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11))
wlsrTrapMIB.setRevisions(('1923-09-12 03:15',))
if mibBuilder.loadTexts: wlsrTrapMIB.setLastUpdated('2309120315Z')
...
mibBuilder.exportSymbols("WLSX-TRAP-MIB", wlsxUnsecureAPResolved=wlsxUnsecureAPResolved, wlsxTrapPeerIpAddress=wlsxTrapPeerIpAddress, wlsxTrapPrimaryControllerIp=wlsxTrapPrimaryControllerIp, wlsxTrapDefinitionsGroup=wlsxTrapDefinitionsGroup, wlsxIfStateChangeReason=wlsxIfStateChangeReason, wlsxPowerSupplyOKTrap=wlsxPowerSupplyOKTrap, wlsxTrapAPPrevTxPower=wlsxTrapAPPrevTxPower, wlsxNSignatureMatchDeauthBcast=wlsxNSignatureMatchDeauthBcast, wlsxTrapExpiredCertName=wlsxTrapExpiredCertName, wlsxNOutOfRangeVoltage=wlsxNOutOfRangeVoltage, wlsxSignAPDeauthBcast=wlsxSignAPDeauthBcast, wlsxTrapDBType=wlsxTrapDBType, wlsxTrapUserName=wlsxTrapUserName, wlsxNSignatureMatch=wlsxNSignatureMatch, wlsxAPUp=wlsxAPUp, wlsxAPNumDown=wlsxAPNumDown, wlsxTrapAPUplinkChangeReason=wlsxTrapAPUplinkChangeReason, wlsxPowerSupplyMissingTrap=wlsxPowerSupplyMissingTrap, wlsxTKIPReplayAttack=wlsxTKIPReplayAttack, wlsxFanTrayInsertedTrap=wlsxFanTrayInsertedTrap, wlsxMonAPEntryChanged=wlsxMonAPEntryChanged, wlsxTrapUpdateFailureReason=wlsxTrapUpdateFailureReason, wlsxTrapTargetAPChannel=wlsxTrapTargetAPChannel, wlsxTrapHostIp=wlsxTrapHostIp, wlsxNumColdStart=wlsxNumColdStart, wlsxMalformedFrameLargeDurationDetected=wlsxMalformedFrameLargeDurationDetected, wlsxAPNumColdStarts=wlsxAPNumColdStarts, wlsxTunnelUp=wlsxTunnelUp, wlsxNAuthServerTimedOut=wlsxNAuthServerTimedOut, wlsxNFanTrayInserted=wlsxNFanTrayInserted, wlsxTrapInterferingAPInfoURL=wlsxTrapInterferingAPInfoURL, wlsxNUserEntryDeAuthenticated=wlsxNUserEntryDeAuthenticated, wlsxVlanInterfaceEntryChanged=wlsxVlanInterfaceEntryChanged, wlsxConfigurationLicenseMismatch=wlsxConfigurationLicenseMismatch, wlsxStackMemberSlotNumber=wlsxStackMemberSlotNumber, wlsxVlanEntryChanged=wlsxVlanEntryChanged, wlsxTarpitContainment=wlsxTarpitContainment, wlsxNSignatureMatchDisassocBcast=wlsxNSignatureMatchDisassocBcast, wlsxNChannelChanged=wlsxNChannelChanged, wlsxReservedChannelViolation=wlsxReservedChannelViolation, wlsxTrapAPBSSID=wlsxTrapAPBSSID, wlsxNSuspectRogueAPResolved=wlsxNSuspectRogueAPResolved, wlsxTrapLocalIp=wlsxTrapLocalIp, wlsxNPowerSupplyFailure=wlsxNPowerSupplyFailure, wlsxFlashSpaceOK=wlsxFlashSpaceOK, wlsxAPDeauthContainment=wlsxAPDeauthContainment, wlsxTrapRogueInfoURL=wlsxTrapRogueInfoURL, wlsxTrapCTSTransferType=wlsxTrapCTSTransferType, wlsxPortDown=wlsxPortDown, wlsxTrapAPHTMode=wlsxTrapAPHTMode, wlsxRepeatWEPIVViolation=wlsxRepeatWEPIVViolation, wlsxValidClientMisassociation=wlsxValidClientMisassociation, wlsxProcessRestart=wlsxProcessRestart, wlsxTrapProcessName=wlsxTrapProcessName, wlsxTrapCardSlot=wlsxTrapCardSlot, wlsxAPTaggedWiredContainment=wlsxAPTaggedWiredContainment, wlsxCTSTransferError=wlsxCTSTransferError, wlsxTrapClientClassification=wlsxTrapClientClassification, wlsxTrapAPChannelSec=wlsxTrapAPChannelSec, wlsxCoverageHoleResolved=wlsxCoverageHoleResolved, wlsxPhonyBSSIDDetected=wlsxPhonyBSSIDDetected, wlsxWEPMisconfiguration=wlsxWEPMisconfiguration, wlsxTrapStationBlackListReason=wlsxTrapStationBlackListReason, wlsxSSIDMisconfiguration=wlsxSSIDMisconfiguration, wlsxFanOK=wlsxFanOK, wlsxTrapRogueIfoURL=wlsxTrapRogueIfoURL, wlsxNLowOnFlashSpace=wlsxNLowOnFlashSpace, wlsxMonStationEntryChanged=wlsxMonStationEntryChanged, wlsxTrapVlanId=wlsxTrapVlanId, wlsxTrapAPPrevMode=wlsxTrapAPPrevMode, wlsxNAceUsageThreshold=wlsxNAceUsageThreshold, wlsxConfigurationUpdateSucceeded=wlsxConfigurationUpdateSucceeded, wlsxUserEntryAttributesChanged=wlsxUserEntryAttributesChanged, wlsxChannelRateAnomaly=wlsxChannelRateAnomaly, wlsxInvalidAddressCombination=wlsxInvalidAddressCombination, wlsxMemoryUsageOK=wlsxMemoryUsageOK, wlsxTrapUserAttributeChangeType=wlsxTrapUserAttributeChangeType, wlsxFlash1SpaceOK=wlsxFlash1SpaceOK, wlsxThresholdCleared=wlsxThresholdCleared, wlsxTrapVrrpOperState=wlsxTrapVrrpOperState, wlsxDisconnectStationAttackSta=wlsxDisconnectStationAttackSta, wlsxTrapVoltageType=wlsxTrapVoltageType, wlsxAPImpersonation=wlsxAPImpersonation, wlsxSignStaNetstumbler=wlsxSignStaNetstumbler, wlsxTrapPortNumber=wlsxTrapPortNumber, wlsxSignAPNullProbeResp=wlsxSignAPNullProbeResp, wlsxCertExpired=wlsxCertExpired, wlsxNAdhocUsingValidSSID=wlsxNAdhocUsingValidSSID, wlsxNSignatureMatchAsleap=wlsxNSignatureMatchAsleap, wlsxNProcessDied=wlsxNProcessDied, wlsxAPInterferenceCleared=wlsxAPInterferenceCleared, wlsxNSCInserted=wlsxNSCInserted, wlsxTrapPortalServerName=wlsxTrapPortalServerName, wlsxAPBssidEntryChanged=wlsxAPBssidEntryChanged, wlsxTrapSourceMac=wlsxTrapSourceMac, wlsxTrapDeviceIpv6Address=wlsxTrapDeviceIpv6Address, wlsxStaPolicyViolation=wlsxStaPolicyViolation, wlsxNConnectionBackfromLocal=wlsxNConnectionBackfromLocal, wlsxTrapTunnelUpReason=wlsxTrapTunnelUpReason, wlsxChannelInterferenceDetected=wlsxChannelInterferenceDetected, wlsxNAdhocUsingValidSSIDContainment=wlsxNAdhocUsingValidSSIDContainment, wlsxDisconnectStationAttack=wlsxDisconnectStationAttack, wlsxSignAPAirjack=wlsxSignAPAirjack, wlsxNAuthMaxBWContracts=wlsxNAuthMaxBWContracts, wlsxTrapPhyType=wlsxTrapPhyType, wlsxClientDeauthContainment=wlsxClientDeauthContainment, wlsxSequenceNumberAnomalySta=wlsxSequenceNumberAnomalySta, wlsxNRogueAPDetected=wlsxNRogueAPDetected, wlsxTrapStationDenyListReason=wlsxTrapStationDenyListReason, wlsxInRangeVoltage=wlsxInRangeVoltage, wlsxTHERMALSHUTDOWN=wlsxTHERMALSHUTDOWN, wlsxTrapAPChannel=wlsxTrapAPChannel, wlsxNVpnMaxSessions=wlsxNVpnMaxSessions, wlsxNRogueAPResolved=wlsxNRogueAPResolved, wlsxTrapFailedVlan=wlsxTrapFailedVlan, wlsxHT40MHzIntoleranceAP=wlsxHT40MHzIntoleranceAP, wlsxTrapUserPhyAddress=wlsxTrapUserPhyAddress, wlsxNDot1xThresholdLimitHit=wlsxNDot1xThresholdLimitHit, wlsxFrameFragmentationRateExceeded=wlsxFrameFragmentationRateExceeded, wlsxStackPrevState=wlsxStackPrevState, wlsxWindowsBridgeDetected=wlsxWindowsBridgeDetected, wlsxTrapApConductorStatus=wlsxTrapApConductorStatus, wlsxTrapHostPort=wlsxTrapHostPort, wlsxTrapMissingLicenses=wlsxTrapMissingLicenses, wlsxTrapGlobalConfigObj=wlsxTrapGlobalConfigObj, wlsxAPNumWarmStarts=wlsxAPNumWarmStarts, wlsxChannelFrameFragmentationRateExceeded=wlsxChannelFrameFragmentationRateExceeded, wlsxTrapPowerSupplyNumber=wlsxTrapPowerSupplyNumber, wlsxHtGreenfieldSupported=wlsxHtGreenfieldSupported, wlsxTrapAPPrevChannelSec=wlsxTrapAPPrevChannelSec, wlsxTrapLocalName=wlsxTrapLocalName, wlsxNSignatureMatchNetstumbler=wlsxNSignatureMatchNetstumbler, wlsxMalformedAuthFrame=wlsxMalformedAuthFrame, wlsxNSuspectRogueAPDetected=wlsxNSuspectRogueAPDetected, wlsxNSwitchIPChanged=wlsxNSwitchIPChanged, wlsxTrapESIServerGrpName=wlsxTrapESIServerGrpName, wlsxTrapEssid=wlsxTrapEssid, wlsxCertExpiringSoon=wlsxCertExpiringSoon, wlsxFanTrayRemovedTrap=wlsxFanTrayRemovedTrap, wlsxChopChopAttack=wlsxChopChopAttack, wlsxTrapSwitchIp=wlsxTrapSwitchIp, wlsxTrapAPARMChangeReason=wlsxTrapAPARMChangeReason, wlsxLicenseServerExpiry=wlsxLicenseServerExpiry, wlsxTrapExpiringCertName=wlsxTrapExpiringCertName, wlsxSignatureMatchSta=wlsxSignatureMatchSta, wlsxClientFloodAttack=wlsxClientFloodAttack, wlsxAdhocNetworkDetected=wlsxAdhocNetworkDetected, wlsxIfState=wlsxIfState, wlsxTrapVrrpMasterIp=wlsxTrapVrrpMasterIp, wlsxClientTaggedWiredContainment=wlsxClientTaggedWiredContainment, wlsxAPChannelChange=wlsxAPChannelChange, wlsxNDot1xTotalLimitHit=wlsxNDot1xTotalLimitHit, wlsxStaAssociatedToUnsecureAP=wlsxStaAssociatedToUnsecureAP, wlsxNVrrpStateChange=wlsxNVrrpStateChange, wlsxLicenseThresholdLimitHit=wlsxLicenseThresholdLimitHit, wlsxTrapSwitchRole=wlsxTrapSwitchRole, wlsxTrapBackupControllerIp=wlsxTrapBackupControllerIp, wlsxNLCRemoved=wlsxNLCRemoved, wlsxTrapESIServerName=wlsxTrapESIServerName, wlsxAPBROADCASTSTORM=wlsxAPBROADCASTSTORM, wlsxIfIndex=wlsxIfIndex, wlsxNApOnBackupController=wlsxNApOnBackupController, wlsxNAdhocNetworkBridgeDetectedAP=wlsxNAdhocNetworkBridgeDetectedAP, wlsxWeakWEPIVViolation=wlsxWeakWEPIVViolation, wlsxPortalServerUp=wlsxPortalServerUp, wlsxNSwitchIPv6Changed=wlsxNSwitchIPv6Changed, wlsxOverflowEAPOLKeyDetected=wlsxOverflowEAPOLKeyDetected, wlsxOmertaAttack=wlsxOmertaAttack, wlsxNUserEntryCreated=wlsxNUserEntryCreated, wlsxThresholdValue=wlsxThresholdValue, wlsxPowerSupplyOK=wlsxPowerSupplyOK, wlsxNLowOnFlash1Space=wlsxNLowOnFlash1Space, wlsxWindowsBridgeDetectedSta=wlsxWindowsBridgeDetectedSta, wlsxMitMDetected=wlsxMitMDetected, wlsxPeerAssociatedToWifiDirectGoContainment=wlsxPeerAssociatedToWifiDirectGoContainment, wlsxTrapTunnelStatus=wlsxTrapTunnelStatus, wlsxTrapTargetAPBand=wlsxTrapTargetAPBand, wlsxTrapAuthServerName=wlsxTrapAuthServerName, wlsxThresholdResourceName=wlsxThresholdResourceName, wlsxValidSSIDViolation=wlsxValidSSIDViolation, wlsxNIpSpoofingDetected=wlsxNIpSpoofingDetected, wlsxWPAFTAttack=wlsxWPAFTAttack, wlsxHotspotterAttackDetected=wlsxHotspotterAttackDetected, wlsxAdhocNetwork=wlsxAdhocNetwork, wlsxVoiceCdrBufferThresholdReached=wlsxVoiceCdrBufferThresholdReached, wlsxTrapAuthServerAddress=wlsxTrapAuthServerAddress, wlsxNLicenseExpiry=wlsxNLicenseExpiry, wlsxNStationAddedToDenyList=wlsxNStationAddedToDenyList, wlsxNGBICInserted=wlsxNGBICInserted, wlsxTrapAuthServerTimeout=wlsxTrapAuthServerTimeout, wlsxNFanTrayRemoved=wlsxNFanTrayRemoved, wlsxWarmStart=wlsxWarmStart, wlsxTrapAPSecChannel=wlsxTrapAPSecChannel, wlsxTrapsGroup=wlsxTrapsGroup, wlsxWirelessBridge=wlsxWirelessBridge, wlsxNeighborAPDetected=wlsxNeighborAPDetected, wlsxResourceValue=wlsxResourceValue, wlsxTrapSwitchIpv6=wlsxTrapSwitchIpv6, wlsxAPSpoofingDetected=wlsxAPSpoofingDetected, wlsxTrapUserRole=wlsxTrapUserRole, wlsxStackCurrentSlot=wlsxStackCurrentSlot, wlsxTrapAPRadioNumber=wlsxTrapAPRadioNumber, wlsxStaUnAssociatedFromUnsecureAP=wlsxStaUnAssociatedFromUnsecureAP, wlsxTrapConfigurationState=wlsxTrapConfigurationState, wlsxSignStaDeauthBcast=wlsxSignStaDeauthBcast, wlsxNFanAbsent=wlsxNFanAbsent, wlsxNLowMemory=wlsxNLowMemory, wlsxTrapFanTrayNumber=wlsxTrapFanTrayNumber, wlsxTrapDBUserName=wlsxTrapDBUserName, wlsxTrapDBName=wlsxTrapDBName, wlsxFataJackAttack=wlsxFataJackAttack, wlsxStaInterferenceDetected=wlsxStaInterferenceDetected, wlsxHostOfWirelessNetworkContainment=wlsxHostOfWirelessNetworkContainment, wlsxNodeRateAnomaly=wlsxNodeRateAnomaly, wlsxTrapSpoofedFrameType=wlsxTrapSpoofedFrameType, wlsxSignalAnomaly=wlsxSignalAnomaly, wlsxAPPortDown=wlsxAPPortDown, wlsxTrapAPLocation=wlsxTrapAPLocation, wlsxNRadioAttributesChanged=wlsxNRadioAttributesChanged, wlsxStackMemberMacAddress=wlsxStackMemberMacAddress, wlsxTrapAPPreviousUplinkActiveTime=wlsxTrapAPPreviousUplinkActiveTime, wlsxVoiceClientLocationUpdate=wlsxVoiceClientLocationUpdate, wlsxTrapApSerialNumber=wlsxTrapApSerialNumber, wlsxStaImpersonation=wlsxStaImpersonation, wlsxChannelInterferenceCleared=wlsxChannelInterferenceCleared, wlsxAdhocNetworkBridgeDetectedAP=wlsxAdhocNetworkBridgeDetectedAP, wlsxConfigurationUpdateError=wlsxConfigurationUpdateError, wlsxSequenceNumberAnomalyAP=wlsxSequenceNumberAnomalyAP, wlsxTrapMasterName=wlsxTrapMasterName, wlsxStackIfStateChangeTrap=wlsxStackIfStateChangeTrap, wlsxCTSRateAnomaly=wlsxCTSRateAnomaly, wlsxNAuthServerAllInService=wlsxNAuthServerAllInService, wlsxNProcessExceedsMemoryLimits=wlsxNProcessExceedsMemoryLimits, wlsxTrapAPTxPower=wlsxTrapAPTxPower, wlsxTrapAPPhyType=wlsxTrapAPPhyType, wlsxAPIPConflict=wlsxAPIPConflict, wlsxTrapTargetAPSSID=wlsxTrapTargetAPSSID, wlsxStaRepeatWEPIVViolation=wlsxStaRepeatWEPIVViolation, wlsxTrapTransmitterMac=wlsxTrapTransmitterMac, wlsxThresholdResourceType=wlsxThresholdResourceType, wlsxNormalTemperature=wlsxNormalTemperature, wlsxVlanLinkUp=wlsxVlanLinkUp, wlsxTrapLicenseDaysRemaining=wlsxTrapLicenseDaysRemaining, wlsxFrameNonUnicastRateExceeded=wlsxFrameNonUnicastRateExceeded, wlsxAPPowerChange=wlsxAPPowerChange, wlsxAPInterferenceDetected=wlsxAPInterferenceDetected, wlsxNAPConductorStatusChange=wlsxNAPConductorStatusChange, wlsxTrapAdminStatus=wlsxTrapAdminStatus, wlsxNodeRateAnomalyAP=wlsxNodeRateAnomalyAP, wlsxWMSOffloadRecommended=wlsxWMSOffloadRecommended, wlsxTrapTargetAPBSSID=wlsxTrapTargetAPBSSID, wlsxTrapUpdateFailedObj=wlsxTrapUpdateFailedObj, wlsxFrameRetryRateExceeded=wlsxFrameRetryRateExceeded, wlsxAPRadioEntryChanged=wlsxAPRadioEntryChanged)
mibBuilder.exportSymbols("WLSX-TRAP-MIB", wlsxTrapAPPrevChannel=wlsxTrapAPPrevChannel, wlsxTrapVrrpID=wlsxTrapVrrpID, wlsxInformQueueOverFlow=wlsxInformQueueOverFlow, wlsxNDisconnectStationAttack=wlsxNDisconnectStationAttack, wlsxClientPskAuthenticationFailed=wlsxClientPskAuthenticationFailed, wlsxTrapApMasterStatus=wlsxTrapApMasterStatus, wlsxCLEARPASSSERVERINVALID=wlsxCLEARPASSSERVERINVALID, wlsxNAPMasterStatusChange=wlsxNAPMasterStatusChange, wlsxAPActiveUplinkChanged=wlsxAPActiveUplinkChanged, wlsxTrapUserIpAddress=wlsxTrapUserIpAddress, wlsxNSignatureMatchAirjack=wlsxNSignatureMatchAirjack, wlsxSignAPAsleap=wlsxSignAPAsleap, wlsxBSSIDIsDown=wlsxBSSIDIsDown, wlsxTrapMasterIp=wlsxTrapMasterIp, wlsxWindowsBridgeDetectedAP=wlsxWindowsBridgeDetectedAP, wlsxClientAssociatedToHostedNetwork=wlsxClientAssociatedToHostedNetwork, wlsxNUserAuthenticationFailed=wlsxNUserAuthenticationFailed, wlsxPortEntryChanged=wlsxPortEntryChanged, wlsxColdStart=wlsxColdStart, wlsxNDBCommunicationFailure=wlsxNDBCommunicationFailure, wlsxNRapExpiredPSK=wlsxNRapExpiredPSK, wlsxTrapSpoofedNewPhyAddress=wlsxTrapSpoofedNewPhyAddress, wlsxTunnelDown=wlsxTunnelDown, wlsxTrapAuthFailureReason=wlsxTrapAuthFailureReason, wlsxNAdhocNetwork=wlsxNAdhocNetwork, wlsxNSignatureMatchNullProbeResp=wlsxNSignatureMatchNullProbeResp, wlsxPortalServerDown=wlsxPortalServerDown, wlsxAPManagedModeConfigFailureTrap=wlsxAPManagedModeConfigFailureTrap, wlsxOUIMisconfiguration=wlsxOUIMisconfiguration, wlsxTrapTargetAPName=wlsxTrapTargetAPName, wlsxNWebCCLicenseEnforcement=wlsxNWebCCLicenseEnforcement, wlsxTrapLicenseId=wlsxTrapLicenseId, wlsxNOutOfRangeTemperature=wlsxNOutOfRangeTemperature, wlsxAdhocNetworkBridgeDetectedSta=wlsxAdhocNetworkBridgeDetectedSta, wlsxNStationRemovedFromBlackList=wlsxNStationRemovedFromBlackList, wlsxSignatureMatch=wlsxSignatureMatch, wlsxTrapMatchedIp=wlsxTrapMatchedIp, wlsxNESIServerDown=wlsxNESIServerDown, wlsxTrapTargetAPMac=wlsxTrapTargetAPMac, wlsxNLCInserted=wlsxNLCInserted, wlsxMgmtUserAuthenticationFailed=wlsxMgmtUserAuthenticationFailed, wlsxNumClockSyncErrors=wlsxNumClockSyncErrors, wlsxTrapAPActiveUplinkType=wlsxTrapAPActiveUplinkType, wlsxTrapConfidenceLevel=wlsxTrapConfidenceLevel, wlsxStackCurrentState=wlsxStackCurrentState, wlsxSuspectUnsecureAPDetected=wlsxSuspectUnsecureAPDetected, wlsxGlobalConfigurationChangeNotification=wlsxGlobalConfigurationChangeNotification, wlsxTrapFrameType=wlsxTrapFrameType, wlsxTrapObjectsGroup=wlsxTrapObjectsGroup, wlsxAdhocNetworkBridgeDetected=wlsxAdhocNetworkBridgeDetected, wlsxTrapCrlName=wlsxTrapCrlName, wlsxPowerSaveDosAttack=wlsxPowerSaveDosAttack, wlsxCRLExpired=wlsxCRLExpired, wlsxGhostTunnelclientAttack=wlsxGhostTunnelclientAttack, wlsxFrameReceiveErrorRateExceeded=wlsxFrameReceiveErrorRateExceeded, wlsxTrapTableGenNumber=wlsxTrapTableGenNumber, wlsxNodeRateAnomalySta=wlsxNodeRateAnomalySta, wlsxNAccessPointIsUp=wlsxNAccessPointIsUp, wlsxAPNumUpgradeFailure=wlsxAPNumUpgradeFailure, wlsxFrameBandWidthRateExceeded=wlsxFrameBandWidthRateExceeded, wlsxTrapTimeStr=wlsxTrapTimeStr, wlsxBSSIDIsUp=wlsxBSSIDIsUp, wlsxStackProtoIfTopoJoined=wlsxStackProtoIfTopoJoined, wlsxStackTopologyChangeTrap=wlsxStackTopologyChangeTrap, wlsxNSignatureMatchWellenreiter=wlsxNSignatureMatchWellenreiter, wlsxSignAPNetstumbler=wlsxSignAPNetstumbler, wlsxIfStateChangeTrap=wlsxIfStateChangeTrap, wlsxMeshNodeEntryChanged=wlsxMeshNodeEntryChanged, wlsxTrapAPIpAddress=wlsxTrapAPIpAddress, wlsxInvalidMacOUIAP=wlsxInvalidMacOUIAP, wlsxTrapStationBlackListReasonStr=wlsxTrapStationBlackListReasonStr, wlsxApFloodAttack=wlsxApFloodAttack, wlsxNRapWarnExpiredPSK=wlsxNRapWarnExpiredPSK, wlsxAPEntryChanged=wlsxAPEntryChanged, wlsxTrapDBIpAddress=wlsxTrapDBIpAddress, wlsxLoadbalancingDisabled=wlsxLoadbalancingDisabled, PYSNMP_MODULE_ID=wlsrTrapMIB, wlsxEAPRateAnomaly=wlsxEAPRateAnomaly, wlsxNumWarmStart=wlsxNumWarmStart, wlsxNAuthMaxAclEntries=wlsxNAuthMaxAclEntries, wlsxNCoverageHoleDetected=wlsxNCoverageHoleDetected, wlsxTrapCaName=wlsxTrapCaName, wlsxTrapConnectionStatus=wlsxTrapConnectionStatus, wlsxPowerSupplyFailureTrap=wlsxPowerSupplyFailureTrap, wlsxTrapLicenseClientDaysRemaining=wlsxTrapLicenseClientDaysRemaining, wlsxSignatureMatchAP=wlsxSignatureMatchAP, wlsxPortUp=wlsxPortUp, wlsxTrapTunnelDownReason=wlsxTrapTunnelDownReason, wlsxAPLoopDetected=wlsxAPLoopDetected, wlsxCTSTransferSucceeded=wlsxCTSTransferSucceeded, wlsxBlockAckAttackDetected=wlsxBlockAckAttackDetected, wlsxTrapAPName=wlsxTrapAPName, wlsxTrapConfigurationId=wlsxTrapConfigurationId, wlsxTrapSnr=wlsxTrapSnr, wlsxTrapVcIpAddress=wlsxTrapVcIpAddress, wlsxWPAMisconfiguration=wlsxWPAMisconfiguration, wlsxTrapVoltageValue=wlsxTrapVoltageValue, wlsxTrapMatchedIpv6=wlsxTrapMatchedIpv6, wlsxTrapAPMacAddress=wlsxTrapAPMacAddress, wlsxAdhocUsingValidSSID=wlsxAdhocUsingValidSSID, wlsxEsiServerChanged=wlsxEsiServerChanged, wlsxTrapTime=wlsxTrapTime, wlsxAPWiredContainment=wlsxAPWiredContainment, wlsxAPNumRadioDown=wlsxAPNumRadioDown, wlsxTrapAddressType=wlsxTrapAddressType, wlsxMalformedHTIEDetected=wlsxMalformedHTIEDetected, wlsxInterferingApDetected=wlsxInterferingApDetected, wlsxNAuthMaxXsecUserEntries=wlsxNAuthMaxXsecUserEntries, wlsxTrapSpoofedIpAddress=wlsxTrapSpoofedIpAddress, wlsxNUserEntryDeleted=wlsxNUserEntryDeleted, wlsxTrapUSBVendorProductID=wlsxTrapUSBVendorProductID, wlsxNAuthMaxUserEntries=wlsxNAuthMaxUserEntries, wlsxTrapNodeMac=wlsxTrapNodeMac, wlsxClientWiredContainment=wlsxClientWiredContainment, wlsxStackIfName=wlsxStackIfName, wlsxTrapESIServerIpAddress=wlsxTrapESIServerIpAddress, wlsxLoadbalancingEnabled=wlsxLoadbalancingEnabled, wlsxTrapReceiverMac=wlsxTrapReceiverMac, wlsxSwitchListEntryChanged=wlsxSwitchListEntryChanged, wlsxTrapAPManagedModeConfigFailure=wlsxTrapAPManagedModeConfigFailure, wlsxNAccessPointIsDown=wlsxNAccessPointIsDown, wlsxTrapTableEntryChangeType=wlsxTrapTableEntryChangeType, wlsxTrapDeviceIpAddress=wlsxTrapDeviceIpAddress, wlsxSignStaAirjack=wlsxSignStaAirjack, wlsxTrapAPUSBStatus=wlsxTrapAPUSBStatus, wlsxSignStaNullProbeResp=wlsxSignStaNullProbeResp, wlsxNAuthServerIsUp=wlsxNAuthServerIsUp, wlsxTrapAPPreviousUplinkType=wlsxTrapAPPreviousUplinkType, wlsxAPModeChange=wlsxAPModeChange, wlsxTrapPortalServerDownReason=wlsxTrapPortalServerDownReason, wlsxClientRejectedByMaxClientCount=wlsxClientRejectedByMaxClientCount, wlsxTrapTemperatureValue=wlsxTrapTemperatureValue, wlsxVlanLinkDown=wlsxVlanLinkDown, wlsxUnsecureAPDetected=wlsxUnsecureAPDetected, wlsxTrapLicenseServerDaysRemaining=wlsxTrapLicenseServerDaysRemaining, wlsxRTSRateAnomaly=wlsxRTSRateAnomaly, wlsxPeerAssociatedToWifiDirectGo=wlsxPeerAssociatedToWifiDirectGo, wlsxStaWeakWEPIVViolation=wlsxStaWeakWEPIVViolation, wlsxTrapDeviceMac=wlsxTrapDeviceMac, wlsxTrapAPCurMode=wlsxTrapAPCurMode, wlsxWirelessHostedNetworkContainment=wlsxWirelessHostedNetworkContainment, wlsxTrapStationDenyListReasonStr=wlsxTrapStationDenyListReasonStr, wlsxLicenseEntryChanged=wlsxLicenseEntryChanged, wlsxFrameLowSpeedRateExceeded=wlsxFrameLowSpeedRateExceeded, wlsxChannelMisconfiguration=wlsxChannelMisconfiguration, wlsxAPDown=wlsxAPDown, wlsxTrapApControllerIp=wlsxTrapApControllerIp, wlsxStaInterferenceCleared=wlsxStaInterferenceCleared, wlsxClientAssociatingOnWrongChannel=wlsxClientAssociatingOnWrongChannel, wlsxStackPrevSlot=wlsxStackPrevSlot, wlsxNAuthServerAcctTimedOut=wlsxNAuthServerAcctTimedOut, wlsxMalformedFrameWrongChannelDetected=wlsxMalformedFrameWrongChannelDetected, wlsxTrapFanNumber=wlsxTrapFanNumber, wlsxTrapMatchedMac=wlsxTrapMatchedMac, wlsxLicenseClientExpiry=wlsxLicenseClientExpiry, wlsxTrapCount=wlsxTrapCount, wlsxShortPreableMisconfiguration=wlsxShortPreableMisconfiguration, wlsxTrapLicensePlatformMismatchKey=wlsxTrapLicensePlatformMismatchKey, wlsxWirelessHostedNetworkDetected=wlsxWirelessHostedNetworkDetected, wlsxNAuthServerIsDown=wlsxNAuthServerIsDown, wlsxLicenseType=wlsxLicenseType, wlsxLicensePlatformMismatch=wlsxLicensePlatformMismatch, wlsxNStationRemovedFromDenyList=wlsxNStationRemovedFromDenyList, wlsxTrapApMode=wlsxTrapApMode, wlsxChannelFrameRetryRateExceeded=wlsxChannelFrameRetryRateExceeded, wlsrTrapMIB=wlsrTrapMIB, wlsxAPUSBPLUGALARM=wlsxAPUSBPLUGALARM, wlsxNSwitchRoleChange=wlsxNSwitchRoleChange, wlsxSignStaAsleap=wlsxSignStaAsleap, wlsxStackChangeEvent=wlsxStackChangeEvent, wlsxTrapSpoofedOldPhyAddress=wlsxTrapSpoofedOldPhyAddress, wlsxEnhancedAdhocContainment=wlsxEnhancedAdhocContainment, wlsxTrapPortalServerAddress=wlsxTrapPortalServerAddress, wlsxTrapAPPrevPhyType=wlsxTrapAPPrevPhyType, wlsxTrapHTMode=wlsxTrapHTMode, wlsxNPowerSupplyMissing=wlsxNPowerSupplyMissing, wlsxTrapOperStatus=wlsxTrapOperStatus, wlsxValidClientNotUsingEncryption=wlsxValidClientNotUsingEncryption, wlsxReceiverMac=wlsxReceiverMac, wlsxUserEntryChanged=wlsxUserEntryChanged, wlsxNUserEntryAuthenticated=wlsxNUserEntryAuthenticated, wlsxNAdhocNetworkBridgeDetectedSta=wlsxNAdhocNetworkBridgeDetectedSta, wlsxVoiceCurrentNumCdr=wlsxVoiceCurrentNumCdr, wlsxInvalidMacOUISta=wlsxInvalidMacOUISta, wlsxDisconnectStationAttackAP=wlsxDisconnectStationAttackAP, wlsxClusterVlanProbeStatus=wlsxClusterVlanProbeStatus, wlsxLicensePoolName=wlsxLicensePoolName, wlsxTrapCTSURL=wlsxTrapCTSURL, wlsxNESIServerUp=wlsxNESIServerUp, wlsxSuspectUnsecureAPResolved=wlsxSuspectUnsecureAPResolved, wlsxAPPortUp=wlsxAPPortUp, wlsxHT40MHzIntoleranceSta=wlsxHT40MHzIntoleranceSta, wlsxTrapAPPrevHTMode=wlsxTrapAPPrevHTMode, wlsxGhostTunnelserverAttack=wlsxGhostTunnelserverAttack, wlsxTrapAssociationType=wlsxTrapAssociationType, wlsxNInterferingAPDetected=wlsxNInterferingAPDetected, wlsxTrapVcMacAddress=wlsxTrapVcMacAddress, wlsxThresholdExceeded=wlsxThresholdExceeded, wlsxIAPVoiceClientLocationUpdate=wlsxIAPVoiceClientLocationUpdate, wlsxTrapSignatureName=wlsxTrapSignatureName, wlsxNAuthServerReqTimedOut=wlsxNAuthServerReqTimedOut, wlsxNConnectionResetWithLocal=wlsxNConnectionResetWithLocal, wlsxChannelFrameErrorRateExceeded=wlsxChannelFrameErrorRateExceeded, wlsxAdhocNetworkRemoved=wlsxAdhocNetworkRemoved, wlsxNFanFailure=wlsxNFanFailure, wlsxOverflowIEDetected=wlsxOverflowIEDetected, wlsxTrapAPBand=wlsxTrapAPBand, wlsxTrapTunnelId=wlsxTrapTunnelId, wlsxNStationAddedToBlackList=wlsxNStationAddedToBlackList, wlsxNStaUnAssociatedFromUnsecureAP=wlsxNStaUnAssociatedFromUnsecureAP, wlsxMalformedAssocReqDetected=wlsxMalformedAssocReqDetected, wlsxTrapUserAuthenticationMethod=wlsxTrapUserAuthenticationMethod)
