...
# Notes
# -----
# ASN.1 source file://mibs/aruba/WLSX-TRAP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:22:38 2025
...
if mibBuilder.loadTexts:
    wlsxTrapStationBlackListReason.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    wlsxTrapMasterIp.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    wlsxTrapLocalIp.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    wlsxTrapMasterName.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    wlsxTrapLocalName.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    wlsxTrapApMasterStatus.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    wlsxTrapStationBlackListReasonStr.setStatus("obsolete")
...
wlsxTrapAPPhyType = _WlsxTrapAPPhyType_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 156),
    _WlsxTrapAPPhyType_Type()
)
wlsxTrapAPPhyType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapAPPhyType.setStatus("current")
_WlsxTrapAPSecChannel_Type = Integer32
_WlsxTrapAPSecChannel_Object = MibScalar
wlsxTrapAPSecChannel = _WlsxTrapAPSecChannel_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 157),
    _WlsxTrapAPSecChannel_Type()
)
wlsxTrapAPSecChannel.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapAPSecChannel.setStatus("current")
_WlsxTrapAPHTMode_Type = ArubaHTMode
_WlsxTrapAPHTMode_Object = MibScalar
wlsxTrapAPHTMode = _WlsxTrapAPHTMode_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 158),
    _WlsxTrapAPHTMode_Type()
)
wlsxTrapAPHTMode.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapAPHTMode.setStatus("current")


class _WlsxTrapAPBand_Type(DisplayString):
    """Custom type wlsxTrapAPBand based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_WlsxTrapAPBand_Type.__name__ = "DisplayString"
_WlsxTrapAPBand_Object = MibScalar
wlsxTrapAPBand = _WlsxTrapAPBand_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 159),
    _WlsxTrapAPBand_Type()
)
wlsxTrapAPBand.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapAPBand.setStatus("current")


class _WlsxTrapTargetAPBand_Type(DisplayString):
    """Custom type wlsxTrapTargetAPBand based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_WlsxTrapTargetAPBand_Type.__name__ = "DisplayString"
_WlsxTrapTargetAPBand_Object = MibScalar
wlsxTrapTargetAPBand = _WlsxTrapTargetAPBand_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 160),
    _WlsxTrapTargetAPBand_Type()
)
wlsxTrapTargetAPBand.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapTargetAPBand.setStatus("current")
_WlsxTrapStationDenyListReason_Type = ArubaDenyListReason
_WlsxTrapStationDenyListReason_Object = MibScalar
wlsxTrapStationDenyListReason = _WlsxTrapStationDenyListReason_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 161),
    _WlsxTrapStationDenyListReason_Type()
)
wlsxTrapStationDenyListReason.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapStationDenyListReason.setStatus("current")


class _WlsxTrapStationDenyListReasonStr_Type(DisplayString):
    """Custom type wlsxTrapStationDenyListReasonStr based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_WlsxTrapStationDenyListReasonStr_Type.__name__ = "DisplayString"
_WlsxTrapStationDenyListReasonStr_Object = MibScalar
wlsxTrapStationDenyListReasonStr = _WlsxTrapStationDenyListReasonStr_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 162),
    _WlsxTrapStationDenyListReasonStr_Type()
)
wlsxTrapStationDenyListReasonStr.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapStationDenyListReasonStr.setStatus("current")
_WlsxTrapApConductorStatus_Type = ArubaAPConductorStatus
_WlsxTrapApConductorStatus_Object = MibScalar
wlsxTrapApConductorStatus = _WlsxTrapApConductorStatus_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 163),
    _WlsxTrapApConductorStatus_Type()
)
wlsxTrapApConductorStatus.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapApConductorStatus.setStatus("current")
_WlsxTrapAPPrevPhyType_Type = ArubaPhyType
_WlsxTrapAPPrevPhyType_Object = MibScalar
wlsxTrapAPPrevPhyType = _WlsxTrapAPPrevPhyType_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 164),
    _WlsxTrapAPPrevPhyType_Type()
)
wlsxTrapAPPrevPhyType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapAPPrevPhyType.setStatus("current")
_WlsxTrapAPPrevHTMode_Type = ArubaHTMode
_WlsxTrapAPPrevHTMode_Object = MibScalar
wlsxTrapAPPrevHTMode = _WlsxTrapAPPrevHTMode_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 165),
    _WlsxTrapAPPrevHTMode_Type()
)
wlsxTrapAPPrevHTMode.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxTrapAPPrevHTMode.setStatus("current")


class _WlsxLicenseType_Type(DisplayString):
    """Custom type wlsxLicenseType based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_WlsxLicenseType_Type.__name__ = "DisplayString"
_WlsxLicenseType_Object = MibScalar
wlsxLicenseType = _WlsxLicenseType_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 166),
    _WlsxLicenseType_Type()
)
wlsxLicenseType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxLicenseType.setStatus("current")


class _WlsxLicensePoolName_Type(DisplayString):
    """Custom type wlsxLicensePoolName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_WlsxLicensePoolName_Type.__name__ = "DisplayString"
_WlsxLicensePoolName_Object = MibScalar
wlsxLicensePoolName = _WlsxLicensePoolName_Object(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 1, 167),
    _WlsxLicensePoolName_Type()
)
wlsxLicensePoolName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    wlsxLicensePoolName.setStatus("current")
...
wlsxNRadioAttributesChanged.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ...
        ("WLSX-TRAP-MIB", "wlsxTrapAPSecChannel"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPPhyType"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPHTMode"))
)
if mibBuilder.loadTexts:
...
wlsxMalformedFrameWrongChannelDetected.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ...
        ("WLSX-TRAP-MIB", "wlsxTrapSnr"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPBand"),
        ("WLSX-TRAP-MIB", "wlsxTrapTargetAPBand"))
)
if mibBuilder.loadTexts:
...
wlsxAPChannelChange.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ...
        ("WLSX-TRAP-MIB", "wlsxTrapAPHTMode"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPPhyType"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPPrevHTMode"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPPrevPhyType"))
)
if mibBuilder.loadTexts:
...
wlsxNStationAddedToDenyList = NotificationType(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 2, 1286)
)
wlsxNStationAddedToDenyList.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ("WLSX-TRAP-MIB", "wlsxTrapNodeMac"),
        ("WLSX-TRAP-MIB", "wlsxTrapStationDenyListReason"),
        ("WLSX-TRAP-MIB", "wlsxTrapStationDenyListReasonStr"))
)
if mibBuilder.loadTexts:
    wlsxNStationAddedToDenyList.setStatus(
        "current"
    )

wlsxNStationRemovedFromDenyList = NotificationType(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 2, 1287)
)
wlsxNStationRemovedFromDenyList.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ("WLSX-TRAP-MIB", "wlsxTrapNodeMac"))
)
if mibBuilder.loadTexts:
    wlsxNStationRemovedFromDenyList.setStatus(
        "current"
    )

wlsxNAPConductorStatusChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 2, 1288)
)
wlsxNAPConductorStatusChange.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPMacAddress"),
        ("WLSX-TRAP-MIB", "wlsxTrapApControllerIp"),
        ("WLSX-TRAP-MIB", "wlsxTrapApConductorStatus"))
)
if mibBuilder.loadTexts:
    wlsxNAPConductorStatusChange.setStatus(
        "current"
    )

wlsxGhostTunnelserverAttack = NotificationType(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 2, 1289)
)
wlsxGhostTunnelserverAttack.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPMacAddress"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPRadioNumber"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPLocation"))
...
if mibBuilder.loadTexts:
    wlsxGhostTunnelserverAttack.setStatus(
        "current"
    )

wlsxGhostTunnelclientAttack = NotificationType(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 2, 1290)
)
wlsxGhostTunnelclientAttack.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPMacAddress"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPRadioNumber"),
        ("WLSX-TRAP-MIB", "wlsxTrapAPLocation"))
...
if mibBuilder.loadTexts:
    wlsxGhostTunnelclientAttack.setStatus(
        "current"
    )

wlsxPeerAssociatedToWifiDirectGo = NotificationType(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 2, 1291)
)
wlsxPeerAssociatedToWifiDirectGo.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ("WLSX-TRAP-MIB", "wlsxTrapTargetAPBSSID"),
        ("WLSX-TRAP-MIB", "wlsxTrapTargetAPSSID"),
        ("WLSX-TRAP-MIB", "wlsxTrapNodeMac"),
...
if mibBuilder.loadTexts:
    wlsxPeerAssociatedToWifiDirectGo.setStatus(
        "current"
    )

wlsxPeerAssociatedToWifiDirectGoContainment = NotificationType(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 2, 1292)
)
wlsxPeerAssociatedToWifiDirectGoContainment.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ("WLSX-TRAP-MIB", "wlsxTrapTargetAPBSSID"),
        ("WLSX-TRAP-MIB", "wlsxTrapTargetAPSSID"),
        ("WLSX-TRAP-MIB", "wlsxTrapNodeMac"),
...
if mibBuilder.loadTexts:
    wlsxPeerAssociatedToWifiDirectGoContainment.setStatus(
        "current"
    )

wlsxLicenseThresholdLimitHit = NotificationType(
    (1, 3, 6, 1, 4, 1, 14823, 2, 3, 1, 11, 1, 2, 1293)
)
wlsxLicenseThresholdLimitHit.setObjects(
      *(("WLSX-TRAP-MIB", "wlsxTrapTime"),
        ("WLSX-TRAP-MIB", "wlsxLicensePoolName"),
        ("WLSX-TRAP-MIB", "wlsxLicenseType"))
)
if mibBuilder.loadTexts:
    wlsxLicenseThresholdLimitHit.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"wlsrTrapMIB": wlsrTrapMIB,
       ...
       "wlsxTrapAPPhyType": wlsxTrapAPPhyType,
       "wlsxTrapAPSecChannel": wlsxTrapAPSecChannel,
       "wlsxTrapAPHTMode": wlsxTrapAPHTMode,
       "wlsxTrapAPBand": wlsxTrapAPBand,
       "wlsxTrapTargetAPBand": wlsxTrapTargetAPBand,
       "wlsxTrapStationDenyListReason": wlsxTrapStationDenyListReason,
       "wlsxTrapStationDenyListReasonStr": wlsxTrapStationDenyListReasonStr,
       "wlsxTrapApConductorStatus": wlsxTrapApConductorStatus,
       "wlsxTrapAPPrevPhyType": wlsxTrapAPPrevPhyType,
       "wlsxTrapAPPrevHTMode": wlsxTrapAPPrevHTMode,
       "wlsxLicenseType": wlsxLicenseType,
       "wlsxLicensePoolName": wlsxLicensePoolName,
       ...
       "wlsxNStationAddedToDenyList": wlsxNStationAddedToDenyList,
       "wlsxNStationRemovedFromDenyList": wlsxNStationRemovedFromDenyList,
       "wlsxNAPConductorStatusChange": wlsxNAPConductorStatusChange,
       "wlsxGhostTunnelserverAttack": wlsxGhostTunnelserverAttack,
       "wlsxGhostTunnelclientAttack": wlsxGhostTunnelclientAttack,
       "wlsxPeerAssociatedToWifiDirectGo": wlsxPeerAssociatedToWifiDirectGo,
       "wlsxPeerAssociatedToWifiDirectGoContainment": wlsxPeerAssociatedToWifiDirectGoContainment,
       "wlsxLicenseThresholdLimitHit": wlsxLicenseThresholdLimitHit}
)
