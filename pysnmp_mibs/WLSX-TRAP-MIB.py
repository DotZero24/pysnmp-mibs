...
ArubaPortalServerDownReason, ArubaSwitchRole, ArubaFrameType, ArubaHTExtChannel, ArubaConfigurationState, ArubaAPUplinkChangeReason, InterfaceIndex, ArubaThresholdResourceType, ArubaIfState, ArubaPhyType, ArubaOperStateValue, ArubaDenyListReason, ArubaIfStateChangeReason, ArubaStackChangeEvent, ArubaStackState, ArubaConfigurationChangeType, ArubaStackIfTopoJoined, ArubaVrrpState, ArubaAddressType, ArubaStationType, ArubaHTMode, ArubaAPUplinkType, ArubaAuthenticationMethods, ArubaDBType, ArubaAPMasterStatus, ArubaAPConductorStatus, ArubaARMChangeReason, ArubaAccessPointMode, ArubaBlackListReason, ArubaEnableValue = mibBuilder.importSymbols("ARUBA-TC", "ArubaPortalServerDownReason", "ArubaSwitchRole", "ArubaFrameType", "ArubaHTExtChannel", "ArubaConfigurationState", "ArubaAPUplinkChangeReason", "InterfaceIndex", "ArubaThresholdResourceType", "ArubaIfState", "ArubaPhyType", "ArubaOperStateValue", "ArubaDenyListReason", "ArubaIfStateChangeReason", "ArubaStackChangeEvent", "ArubaStackState", "ArubaConfigurationChangeType", "ArubaStackIfTopoJoined", "ArubaVrrpState", "ArubaAddressType", "ArubaStationType", "ArubaHTMode", "ArubaAPUplinkType", "ArubaAuthenticationMethods", "ArubaDBType", "ArubaAPMasterStatus", "ArubaAPConductorStatus", "ArubaARMChangeReason", "ArubaAccessPointMode", "ArubaBlackListReason", "ArubaEnableValue")
...
TDomain, TAddress, RowStatus, DateAndTime, TextualConvention, TimeInterval, MacAddress, StorageType, TestAndIncr, PhysAddress, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TDomain", "TAddress", "RowStatus", "DateAndTime", "TextualConvention", "TimeInterval", "MacAddress", "StorageType", "TestAndIncr", "PhysAddress", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("WLSX-TRAP-MIB", wlsxWarmStart=wlsxWarmStart, wlsxHT40MHzIntoleranceAP=wlsxHT40MHzIntoleranceAP, wlsxNSwitchRoleChange=wlsxNSwitchRoleChange, wlsxIfIndex=wlsxIfIndex, wlsxNProcessExceedsMemoryLimits=wlsxNProcessExceedsMemoryLimits, wlsxTrapTableGenNumber=wlsxTrapTableGenNumber, wlsxNLicenseExpiry=wlsxNLicenseExpiry, wlsxHotspotterAttackDetected=wlsxHotspotterAttackDetected, wlsxTrapHostPort=wlsxTrapHostPort, wlsxNDot1xThresholdLimitHit=wlsxNDot1xThresholdLimitHit, wlsxTunnelUp=wlsxTunnelUp, wlsxTrapMatchedIpv6=wlsxTrapMatchedIpv6, wlsxLicenseEntryChanged=wlsxLicenseEntryChanged, wlsxLicensePlatformMismatch=wlsxLicensePlatformMismatch, wlsxTrapAuthServerName=wlsxTrapAuthServerName, wlsxInRangeVoltage=wlsxInRangeVoltage, wlsxSignalAnomaly=wlsxSignalAnomaly, wlsxNDot1xTotalLimitHit=wlsxNDot1xTotalLimitHit, wlsxTrapOperStatus=wlsxTrapOperStatus, wlsxTrapPortalServerName=wlsxTrapPortalServerName, wlsxTrapAPPreviousUplinkType=wlsxTrapAPPreviousUplinkType, wlsxTrapProcessName=wlsxTrapProcessName, wlsxTrapTargetAPMac=wlsxTrapTargetAPMac, wlsxAPManagedModeConfigFailureTrap=wlsxAPManagedModeConfigFailureTrap, wlsxTrapDBType=wlsxTrapDBType, wlsxSequenceNumberAnomalySta=wlsxSequenceNumberAnomalySta, wlsxFataJackAttack=wlsxFataJackAttack, wlsxTrapHostIp=wlsxTrapHostIp, wlsxTrapAPChannel=wlsxTrapAPChannel, wlsxSignatureMatchSta=wlsxSignatureMatchSta, wlsxNSignatureMatchNullProbeResp=wlsxNSignatureMatchNullProbeResp, wlsxCLEARPASSSERVERINVALID=wlsxCLEARPASSSERVERINVALID, wlsxNOutOfRangeVoltage=wlsxNOutOfRangeVoltage, wlsxTrapESIServerGrpName=wlsxTrapESIServerGrpName, wlsxTrapTunnelId=wlsxTrapTunnelId, wlsxTrapSpoofedNewPhyAddress=wlsxTrapSpoofedNewPhyAddress, wlsxNVrrpStateChange=wlsxNVrrpStateChange, wlsxChannelFrameFragmentationRateExceeded=wlsxChannelFrameFragmentationRateExceeded, wlsxNAdhocNetworkBridgeDetectedAP=wlsxNAdhocNetworkBridgeDetectedAP, wlsxAPSpoofingDetected=wlsxAPSpoofingDetected, wlsxStackPrevSlot=wlsxStackPrevSlot, wlsxStaInterferenceDetected=wlsxStaInterferenceDetected, wlsxTrapSourceMac=wlsxTrapSourceMac, wlsxStackCurrentState=wlsxStackCurrentState, wlsxFlashSpaceOK=wlsxFlashSpaceOK, wlsxThresholdCleared=wlsxThresholdCleared, wlsxTrapPowerSupplyNumber=wlsxTrapPowerSupplyNumber, wlsxMemoryUsageOK=wlsxMemoryUsageOK, wlsxNCoverageHoleDetected=wlsxNCoverageHoleDetected, wlsxNLCRemoved=wlsxNLCRemoved, wlsxTrapDBIpAddress=wlsxTrapDBIpAddress, wlsxTrapEssid=wlsxTrapEssid, wlsxNodeRateAnomalySta=wlsxNodeRateAnomalySta, wlsxNWebCCLicenseEnforcement=wlsxNWebCCLicenseEnforcement, wlsxTrapPortalServerDownReason=wlsxTrapPortalServerDownReason, wlsxTrapAPPrevMode=wlsxTrapAPPrevMode, wlsxVlanLinkDown=wlsxVlanLinkDown, wlsxIfStateChangeReason=wlsxIfStateChangeReason, wlsxTrapAPSecChannel=wlsxTrapAPSecChannel, wlsxNAceUsageThreshold=wlsxNAceUsageThreshold, wlsxVoiceCurrentNumCdr=wlsxVoiceCurrentNumCdr, wlsxNDBCommunicationFailure=wlsxNDBCommunicationFailure, wlsxAPNumUpgradeFailure=wlsxAPNumUpgradeFailure, wlsxCoverageHoleResolved=wlsxCoverageHoleResolved, wlsxNLowMemory=wlsxNLowMemory, wlsxValidClientMisassociation=wlsxValidClientMisassociation, wlsxMonStationEntryChanged=wlsxMonStationEntryChanged, wlsxPortDown=wlsxPortDown, wlsxAPBROADCASTSTORM=wlsxAPBROADCASTSTORM, wlsxNFanFailure=wlsxNFanFailure, wlsxAPLoopDetected=wlsxAPLoopDetected, wlsxNFanTrayRemoved=wlsxNFanTrayRemoved, wlsxStackIfStateChangeTrap=wlsxStackIfStateChangeTrap, wlsxSignAPAirjack=wlsxSignAPAirjack, wlsxFanTrayInsertedTrap=wlsxFanTrayInsertedTrap, wlsxGlobalConfigurationChangeNotification=wlsxGlobalConfigurationChangeNotification, wlsxNPowerSupplyMissing=wlsxNPowerSupplyMissing, wlsxAPBssidEntryChanged=wlsxAPBssidEntryChanged, wlsxNUserEntryCreated=wlsxNUserEntryCreated, wlsxTrapTunnelDownReason=wlsxTrapTunnelDownReason, wlsxTrapAPPrevPhyType=wlsxTrapAPPrevPhyType, wlsxPortEntryChanged=wlsxPortEntryChanged, wlsxNUserEntryDeAuthenticated=wlsxNUserEntryDeAuthenticated, wlsxUserEntryAttributesChanged=wlsxUserEntryAttributesChanged, wlsxNAccessPointIsDown=wlsxNAccessPointIsDown, wlsxNeighborAPDetected=wlsxNeighborAPDetected, wlsxLicensePoolName=wlsxLicensePoolName, wlsxTrapDeviceIpv6Address=wlsxTrapDeviceIpv6Address, wlsxClusterVlanProbeStatus=wlsxClusterVlanProbeStatus, wlsxTrapPhyType=wlsxTrapPhyType, wlsxTrapPeerIpAddress=wlsxTrapPeerIpAddress, wlsxTrapTargetAPSSID=wlsxTrapTargetAPSSID, wlsxChannelFrameRetryRateExceeded=wlsxChannelFrameRetryRateExceeded, wlsxFrameLowSpeedRateExceeded=wlsxFrameLowSpeedRateExceeded, wlsxWindowsBridgeDetectedAP=wlsxWindowsBridgeDetectedAP, wlsxTrapConfigurationId=wlsxTrapConfigurationId, wlsxNAdhocNetwork=wlsxNAdhocNetwork, wlsxEAPRateAnomaly=wlsxEAPRateAnomaly, wlsxTrapDeviceIpAddress=wlsxTrapDeviceIpAddress, wlsxTrapObjectsGroup=wlsxTrapObjectsGroup, wlsxHT40MHzIntoleranceSta=wlsxHT40MHzIntoleranceSta, wlsxTrapVrrpMasterIp=wlsxTrapVrrpMasterIp, wlsxVlanEntryChanged=wlsxVlanEntryChanged, wlsxTrapAuthFailureReason=wlsxTrapAuthFailureReason, wlsxNVpnMaxSessions=wlsxNVpnMaxSessions, wlsxTrapSpoofedIpAddress=wlsxTrapSpoofedIpAddress, wlsxConfigurationLicenseMismatch=wlsxConfigurationLicenseMismatch, wlsxMonAPEntryChanged=wlsxMonAPEntryChanged, wlsxTrapLicenseId=wlsxTrapLicenseId, wlsxTrapUserRole=wlsxTrapUserRole, wlsxAPPowerChange=wlsxAPPowerChange, wlsxTrapSpoofedOldPhyAddress=wlsxTrapSpoofedOldPhyAddress, wlsxSignStaNullProbeResp=wlsxSignStaNullProbeResp, wlsxAdhocNetworkDetected=wlsxAdhocNetworkDetected, wlsxVlanLinkUp=wlsxVlanLinkUp, wlsxWirelessBridge=wlsxWirelessBridge, wlsxFrameRetryRateExceeded=wlsxFrameRetryRateExceeded, wlsxNGBICInserted=wlsxNGBICInserted, wlsxTrapBackupControllerIp=wlsxTrapBackupControllerIp, wlsxTrapAPCurMode=wlsxTrapAPCurMode, wlsxNAuthServerReqTimedOut=wlsxNAuthServerReqTimedOut, wlsxCTSTransferError=wlsxCTSTransferError, wlsxAPEntryChanged=wlsxAPEntryChanged, wlsxTrapMasterName=wlsxTrapMasterName, wlsxNUserEntryDeleted=wlsxNUserEntryDeleted, wlsxStackMemberMacAddress=wlsxStackMemberMacAddress, wlsxNRadioAttributesChanged=wlsxNRadioAttributesChanged, wlsxTrapTemperatureValue=wlsxTrapTemperatureValue, wlsxNUserAuthenticationFailed=wlsxNUserAuthenticationFailed, wlsxAPUSBPLUGALARM=wlsxAPUSBPLUGALARM, wlsxTrapLocalIp=wlsxTrapLocalIp, wlsxTrapAPUSBStatus=wlsxTrapAPUSBStatus, wlsxTrapInterferingAPInfoURL=wlsxTrapInterferingAPInfoURL, wlsxTrapMissingLicenses=wlsxTrapMissingLicenses, wlsxNAuthServerTimedOut=wlsxNAuthServerTimedOut, wlsxTrapAPPreviousUplinkActiveTime=wlsxTrapAPPreviousUplinkActiveTime, wlsxInterferingApDetected=wlsxInterferingApDetected, wlsxStaWeakWEPIVViolation=wlsxStaWeakWEPIVViolation, wlsxSignAPNetstumbler=wlsxSignAPNetstumbler, wlsxInformQueueOverFlow=wlsxInformQueueOverFlow, wlsxWirelessHostedNetworkDetected=wlsxWirelessHostedNetworkDetected, wlsxAPDeauthContainment=wlsxAPDeauthContainment, wlsxTrapSwitchIpv6=wlsxTrapSwitchIpv6, wlsxNRapExpiredPSK=wlsxNRapExpiredPSK, wlsxTrapTransmitterMac=wlsxTrapTransmitterMac, wlsxSignAPNullProbeResp=wlsxSignAPNullProbeResp, wlsxNProcessDied=wlsxNProcessDied, wlsxBSSIDIsUp=wlsxBSSIDIsUp, wlsxDisconnectStationAttackSta=wlsxDisconnectStationAttackSta, wlsxThresholdResourceName=wlsxThresholdResourceName, wlsxTrapAPPrevTxPower=wlsxTrapAPPrevTxPower, wlsxFrameNonUnicastRateExceeded=wlsxFrameNonUnicastRateExceeded, wlsxAPPortDown=wlsxAPPortDown, wlsxTrapAPActiveUplinkType=wlsxTrapAPActiveUplinkType, wlsxChannelFrameErrorRateExceeded=wlsxChannelFrameErrorRateExceeded, wlsxTrapTime=wlsxTrapTime, wlsxNodeRateAnomalyAP=wlsxNodeRateAnomalyAP, wlsxNSuspectRogueAPResolved=wlsxNSuspectRogueAPResolved, wlsxAPTaggedWiredContainment=wlsxAPTaggedWiredContainment, wlsxAPInterferenceCleared=wlsxAPInterferenceCleared, wlsxWPAFTAttack=wlsxWPAFTAttack, wlsxNAuthMaxUserEntries=wlsxNAuthMaxUserEntries, wlsxNLCInserted=wlsxNLCInserted, wlsxNAuthMaxAclEntries=wlsxNAuthMaxAclEntries, wlsxTrapsGroup=wlsxTrapsGroup, wlsxIfState=wlsxIfState, wlsxTrapSpoofedFrameType=wlsxTrapSpoofedFrameType, wlsxNStationAddedToBlackList=wlsxNStationAddedToBlackList, wlsxTrapAPTxPower=wlsxTrapAPTxPower, wlsxAdhocNetwork=wlsxAdhocNetwork, wlsxCTSRateAnomaly=wlsxCTSRateAnomaly, wlsxSignAPAsleap=wlsxSignAPAsleap, wlsxTrapESIServerName=wlsxTrapESIServerName, wlsxTrapAPPrevChannel=wlsxTrapAPPrevChannel, wlsxStaInterferenceCleared=wlsxStaInterferenceCleared, wlsxTrapApMasterStatus=wlsxTrapApMasterStatus, wlsxAPNumRadioDown=wlsxAPNumRadioDown, wlsxPortalServerUp=wlsxPortalServerUp, wlsxTrapCount=wlsxTrapCount, wlsxPeerAssociatedToWifiDirectGo=wlsxPeerAssociatedToWifiDirectGo, wlsxEsiServerChanged=wlsxEsiServerChanged, wlsxNApOnBackupController=wlsxNApOnBackupController, wlsxTrapPortalServerAddress=wlsxTrapPortalServerAddress, wlsxNStationRemovedFromDenyList=wlsxNStationRemovedFromDenyList, wlsxNSCInserted=wlsxNSCInserted, wlsxTrapVoltageValue=wlsxTrapVoltageValue, wlsxAdhocNetworkBridgeDetected=wlsxAdhocNetworkBridgeDetected, wlsxInvalidAddressCombination=wlsxInvalidAddressCombination, wlsxConfigurationUpdateSucceeded=wlsxConfigurationUpdateSucceeded, wlsxNAPConductorStatusChange=wlsxNAPConductorStatusChange, wlsxTunnelDown=wlsxTunnelDown, wlsxTrapCardSlot=wlsxTrapCardSlot, wlsxTrapSnr=wlsxTrapSnr, wlsxStackIfName=wlsxStackIfName, wlsxTrapStationBlackListReasonStr=wlsxTrapStationBlackListReasonStr, wlsxStackMemberSlotNumber=wlsxStackMemberSlotNumber, wlsxTrapTableEntryChangeType=wlsxTrapTableEntryChangeType, wlsxApFloodAttack=wlsxApFloodAttack, wlsxAdhocUsingValidSSID=wlsxAdhocUsingValidSSID, wlsxAPModeChange=wlsxAPModeChange, wlsxNDisconnectStationAttack=wlsxNDisconnectStationAttack, wlsxAPImpersonation=wlsxAPImpersonation, wlsxTrapRogueInfoURL=wlsxTrapRogueInfoURL, wlsxHtGreenfieldSupported=wlsxHtGreenfieldSupported, wlsxTrapESIServerIpAddress=wlsxTrapESIServerIpAddress, wlsxTrapApMode=wlsxTrapApMode, wlsxChannelMisconfiguration=wlsxChannelMisconfiguration, wlsxTrapConfidenceLevel=wlsxTrapConfidenceLevel, wlsxNESIServerDown=wlsxNESIServerDown, wlsxStackProtoIfTopoJoined=wlsxStackProtoIfTopoJoined, wlsxTrapExpiredCertName=wlsxTrapExpiredCertName, wlsxStaImpersonation=wlsxStaImpersonation, wlsxSignatureMatchAP=wlsxSignatureMatchAP, wlsxStackTopologyChangeTrap=wlsxStackTopologyChangeTrap, wlsxThresholdValue=wlsxThresholdValue, wlsxPeerAssociatedToWifiDirectGoContainment=wlsxPeerAssociatedToWifiDirectGoContainment, wlsxReservedChannelViolation=wlsxReservedChannelViolation, wlsxFanTrayRemovedTrap=wlsxFanTrayRemovedTrap, wlsxTrapUserIpAddress=wlsxTrapUserIpAddress, wlsxNSwitchIPChanged=wlsxNSwitchIPChanged, wlsxAPNumColdStarts=wlsxAPNumColdStarts, wlsxFrameFragmentationRateExceeded=wlsxFrameFragmentationRateExceeded, wlsxTrapAPIpAddress=wlsxTrapAPIpAddress, wlsxTrapExpiringCertName=wlsxTrapExpiringCertName, wlsxNAuthMaxXsecUserEntries=wlsxNAuthMaxXsecUserEntries, wlsxNESIServerUp=wlsxNESIServerUp, wlsxNStationAddedToDenyList=wlsxNStationAddedToDenyList, wlsxTrapTunnelStatus=wlsxTrapTunnelStatus, wlsxTrapAPName=wlsxTrapAPName, wlsxPortUp=wlsxPortUp, wlsxNumColdStart=wlsxNumColdStart, wlsxAPPortUp=wlsxAPPortUp, wlsxPhonyBSSIDDetected=wlsxPhonyBSSIDDetected, wlsxTrapAPUplinkChangeReason=wlsxTrapAPUplinkChangeReason, wlsxNRogueAPDetected=wlsxNRogueAPDetected, wlsxTrapApConductorStatus=wlsxTrapApConductorStatus, wlsxTrapUpdateFailureReason=wlsxTrapUpdateFailureReason, wlsxTrapLicenseServerDaysRemaining=wlsxTrapLicenseServerDaysRemaining, wlsxNumClockSyncErrors=wlsxNumClockSyncErrors, wlsxChannelInterferenceCleared=wlsxChannelInterferenceCleared, wlsxTrapVrrpID=wlsxTrapVrrpID, wlsxAdhocNetworkBridgeDetectedAP=wlsxAdhocNetworkBridgeDetectedAP, wlsxUnsecureAPResolved=wlsxUnsecureAPResolved, wlsxTrapAPMacAddress=wlsxTrapAPMacAddress, wlsxSuspectUnsecureAPResolved=wlsxSuspectUnsecureAPResolved, wlsxWindowsBridgeDetected=wlsxWindowsBridgeDetected, wlsxTrapLicensePlatformMismatchKey=wlsxTrapLicensePlatformMismatchKey, wlsxTrapGlobalConfigObj=wlsxTrapGlobalConfigObj, PYSNMP_MODULE_ID=wlsrTrapMIB, wlsxNChannelChanged=wlsxNChannelChanged, wlsxAPWiredContainment=wlsxAPWiredContainment, wlsxStackPrevState=wlsxStackPrevState, wlsxOUIMisconfiguration=wlsxOUIMisconfiguration, wlsxTrapTargetAPName=wlsxTrapTargetAPName)
mibBuilder.exportSymbols("WLSX-TRAP-MIB", wlsxTrapAPChannelSec=wlsxTrapAPChannelSec, wlsxNAccessPointIsUp=wlsxNAccessPointIsUp, wlsxNAuthServerIsDown=wlsxNAuthServerIsDown, wlsxSignAPDeauthBcast=wlsxSignAPDeauthBcast, wlsxTrapTargetAPChannel=wlsxTrapTargetAPChannel, wlsxNAdhocUsingValidSSIDContainment=wlsxNAdhocUsingValidSSIDContainment, wlsxClientFloodAttack=wlsxClientFloodAttack, wlsxTHERMALSHUTDOWN=wlsxTHERMALSHUTDOWN, wlsxTrapAPBSSID=wlsxTrapAPBSSID, wlsxTrapCTSURL=wlsxTrapCTSURL, wlsxTrapLicenseDaysRemaining=wlsxTrapLicenseDaysRemaining, wlsxTrapAPARMChangeReason=wlsxTrapAPARMChangeReason, wlsxHostOfWirelessNetworkContainment=wlsxHostOfWirelessNetworkContainment, wlsxPowerSupplyOKTrap=wlsxPowerSupplyOKTrap, wlsxTarpitContainment=wlsxTarpitContainment, wlsxTrapConnectionStatus=wlsxTrapConnectionStatus, wlsxClientWiredContainment=wlsxClientWiredContainment, wlsxClientAssociatingOnWrongChannel=wlsxClientAssociatingOnWrongChannel, wlsxTrapStationDenyListReason=wlsxTrapStationDenyListReason, wlsxTrapStationDenyListReasonStr=wlsxTrapStationDenyListReasonStr, wlsxNSwitchIPv6Changed=wlsxNSwitchIPv6Changed, wlsxWMSOffloadRecommended=wlsxWMSOffloadRecommended, wlsxNSignatureMatchDeauthBcast=wlsxNSignatureMatchDeauthBcast, wlsxTrapAPRadioNumber=wlsxTrapAPRadioNumber, wlsxPowerSupplyOK=wlsxPowerSupplyOK, wlsxTrapSwitchIp=wlsxTrapSwitchIp, wlsxTrapUserName=wlsxTrapUserName, wlsxMeshNodeEntryChanged=wlsxMeshNodeEntryChanged, wlsxStaRepeatWEPIVViolation=wlsxStaRepeatWEPIVViolation, wlsxIfStateChangeTrap=wlsxIfStateChangeTrap, wlsxCTSTransferSucceeded=wlsxCTSTransferSucceeded, wlsxTrapFailedVlan=wlsxTrapFailedVlan, wlsxTrapFanTrayNumber=wlsxTrapFanTrayNumber, wlsxConfigurationUpdateError=wlsxConfigurationUpdateError, wlsxTrapDeviceMac=wlsxTrapDeviceMac, wlsxStackCurrentSlot=wlsxStackCurrentSlot, wlsxVoiceClientLocationUpdate=wlsxVoiceClientLocationUpdate, wlsxTrapDBUserName=wlsxTrapDBUserName, wlsxTrapVcIpAddress=wlsxTrapVcIpAddress, wlsxNumWarmStart=wlsxNumWarmStart, wlsxWirelessHostedNetworkContainment=wlsxWirelessHostedNetworkContainment, wlsxSignStaAirjack=wlsxSignStaAirjack, wlsxValidSSIDViolation=wlsxValidSSIDViolation, wlsxTrapApSerialNumber=wlsxTrapApSerialNumber, wlsxTrapLicenseClientDaysRemaining=wlsxTrapLicenseClientDaysRemaining, wlsxNStationRemovedFromBlackList=wlsxNStationRemovedFromBlackList, wlsxNConnectionResetWithLocal=wlsxNConnectionResetWithLocal, wlsxClientAssociatedToHostedNetwork=wlsxClientAssociatedToHostedNetwork, wlsxTrapTunnelUpReason=wlsxTrapTunnelUpReason, wlsxNSignatureMatchAsleap=wlsxNSignatureMatchAsleap, wlsxNInterferingAPDetected=wlsxNInterferingAPDetected, wlsxTrapConfigurationState=wlsxTrapConfigurationState, wlsxTrapAPPrevChannelSec=wlsxTrapAPPrevChannelSec, wlsxOverflowIEDetected=wlsxOverflowIEDetected, wlsxTrapCrlName=wlsxTrapCrlName, wlsxNOutOfRangeTemperature=wlsxNOutOfRangeTemperature, wlsxThresholdResourceType=wlsxThresholdResourceType, wlsxTrapAssociationType=wlsxTrapAssociationType, wlsxMalformedFrameLargeDurationDetected=wlsxMalformedFrameLargeDurationDetected, wlsxChannelRateAnomaly=wlsxChannelRateAnomaly, wlsxClientDeauthContainment=wlsxClientDeauthContainment, wlsxMalformedAuthFrame=wlsxMalformedAuthFrame, wlsxNFanAbsent=wlsxNFanAbsent, wlsxTrapCaName=wlsxTrapCaName, wlsxUnsecureAPDetected=wlsxUnsecureAPDetected, wlsxTrapUserAuthenticationMethod=wlsxTrapUserAuthenticationMethod, wlsxNAPMasterStatusChange=wlsxNAPMasterStatusChange, wlsxWeakWEPIVViolation=wlsxWeakWEPIVViolation, wlsxFrameReceiveErrorRateExceeded=wlsxFrameReceiveErrorRateExceeded, wlsxNAuthServerAcctTimedOut=wlsxNAuthServerAcctTimedOut, wlsxReceiverMac=wlsxReceiverMac, wlsxTrapAPManagedModeConfigFailure=wlsxTrapAPManagedModeConfigFailure, wlsxAdhocNetworkRemoved=wlsxAdhocNetworkRemoved, wlsxLicenseType=wlsxLicenseType, wlsxTrapSignatureName=wlsxTrapSignatureName, wlsxTrapVoltageType=wlsxTrapVoltageType, wlsxLicenseClientExpiry=wlsxLicenseClientExpiry, wlsxEnhancedAdhocContainment=wlsxEnhancedAdhocContainment, wlsxNSignatureMatchNetstumbler=wlsxNSignatureMatchNetstumbler, wlsxNPowerSupplyFailure=wlsxNPowerSupplyFailure, wlsxNSignatureMatch=wlsxNSignatureMatch, wlsxNFanTrayInserted=wlsxNFanTrayInserted, wlsxBlockAckAttackDetected=wlsxBlockAckAttackDetected, wlsxTrapAuthServerAddress=wlsxTrapAuthServerAddress, wlsxPortalServerDown=wlsxPortalServerDown, wlsxTrapMatchedIp=wlsxTrapMatchedIp, wlsxTrapFrameType=wlsxTrapFrameType, wlsxDisconnectStationAttackAP=wlsxDisconnectStationAttackAP, wlsxTrapStationBlackListReason=wlsxTrapStationBlackListReason, wlsxNSuspectRogueAPDetected=wlsxNSuspectRogueAPDetected, wlsxPowerSupplyMissingTrap=wlsxPowerSupplyMissingTrap, wlsxTKIPReplayAttack=wlsxTKIPReplayAttack, wlsxNSignatureMatchWellenreiter=wlsxNSignatureMatchWellenreiter, wlsxTrapUserAttributeChangeType=wlsxTrapUserAttributeChangeType, wlsxSignatureMatch=wlsxSignatureMatch, wlsxOmertaAttack=wlsxOmertaAttack, wlsxNLowOnFlashSpace=wlsxNLowOnFlashSpace, wlsxRTSRateAnomaly=wlsxRTSRateAnomaly, wlsxTrapDBName=wlsxTrapDBName, wlsxTrapDefinitionsGroup=wlsxTrapDefinitionsGroup, wlsxStackChangeEvent=wlsxStackChangeEvent, wlsxAPChannelChange=wlsxAPChannelChange, wlsxNRapWarnExpiredPSK=wlsxNRapWarnExpiredPSK, wlsxAPNumDown=wlsxAPNumDown, wlsxNAuthServerAllInService=wlsxNAuthServerAllInService, wlsxMgmtUserAuthenticationFailed=wlsxMgmtUserAuthenticationFailed, wlsxFanOK=wlsxFanOK, wlsxCRLExpired=wlsxCRLExpired, wlsxMitMDetected=wlsxMitMDetected, wlsxPowerSupplyFailureTrap=wlsxPowerSupplyFailureTrap, wlsxTrapUserPhyAddress=wlsxTrapUserPhyAddress, wlsxNormalTemperature=wlsxNormalTemperature, wlsxTrapAPPrevHTMode=wlsxTrapAPPrevHTMode, wlsxTrapAPPhyType=wlsxTrapAPPhyType, wlsxTrapLocalName=wlsxTrapLocalName, wlsxNUserEntryAuthenticated=wlsxNUserEntryAuthenticated, wlsrTrapMIB=wlsrTrapMIB, wlsxValidClientNotUsingEncryption=wlsxValidClientNotUsingEncryption, wlsxNAdhocUsingValidSSID=wlsxNAdhocUsingValidSSID, wlsxTrapTargetAPBSSID=wlsxTrapTargetAPBSSID, wlsxThresholdExceeded=wlsxThresholdExceeded, wlsxGhostTunnelserverAttack=wlsxGhostTunnelserverAttack, wlsxStaUnAssociatedFromUnsecureAP=wlsxStaUnAssociatedFromUnsecureAP, wlsxTrapRogueIfoURL=wlsxTrapRogueIfoURL, wlsxTrapVcMacAddress=wlsxTrapVcMacAddress, wlsxUserEntryChanged=wlsxUserEntryChanged, wlsxTrapAPBand=wlsxTrapAPBand, wlsxSignStaAsleap=wlsxSignStaAsleap, wlsxCertExpiringSoon=wlsxCertExpiringSoon, wlsxMalformedHTIEDetected=wlsxMalformedHTIEDetected, wlsxTrapCTSTransferType=wlsxTrapCTSTransferType, wlsxTrapTargetAPBand=wlsxTrapTargetAPBand, wlsxTrapAuthServerTimeout=wlsxTrapAuthServerTimeout, wlsxResourceValue=wlsxResourceValue, wlsxMalformedAssocReqDetected=wlsxMalformedAssocReqDetected, wlsxClientTaggedWiredContainment=wlsxClientTaggedWiredContainment, wlsxTrapPortNumber=wlsxTrapPortNumber, wlsxLoadbalancingEnabled=wlsxLoadbalancingEnabled, wlsxWEPMisconfiguration=wlsxWEPMisconfiguration, wlsxNAdhocNetworkBridgeDetectedSta=wlsxNAdhocNetworkBridgeDetectedSta, wlsxTrapHTMode=wlsxTrapHTMode, wlsxSuspectUnsecureAPDetected=wlsxSuspectUnsecureAPDetected, wlsxAPActiveUplinkChanged=wlsxAPActiveUplinkChanged, wlsxTrapAPHTMode=wlsxTrapAPHTMode, wlsxTrapMatchedMac=wlsxTrapMatchedMac, wlsxAPUp=wlsxAPUp, wlsxAPInterferenceDetected=wlsxAPInterferenceDetected, wlsxNStaUnAssociatedFromUnsecureAP=wlsxNStaUnAssociatedFromUnsecureAP, wlsxAPIPConflict=wlsxAPIPConflict, wlsxSequenceNumberAnomalyAP=wlsxSequenceNumberAnomalyAP, wlsxBSSIDIsDown=wlsxBSSIDIsDown, wlsxAPRadioEntryChanged=wlsxAPRadioEntryChanged, wlsxOverflowEAPOLKeyDetected=wlsxOverflowEAPOLKeyDetected, wlsxCertExpired=wlsxCertExpired, wlsxSSIDMisconfiguration=wlsxSSIDMisconfiguration, wlsxFrameBandWidthRateExceeded=wlsxFrameBandWidthRateExceeded, wlsxTrapSwitchRole=wlsxTrapSwitchRole, wlsxNLowOnFlash1Space=wlsxNLowOnFlash1Space, wlsxTrapReceiverMac=wlsxTrapReceiverMac, wlsxColdStart=wlsxColdStart, wlsxStaAssociatedToUnsecureAP=wlsxStaAssociatedToUnsecureAP, wlsxTrapFanNumber=wlsxTrapFanNumber, wlsxNAuthServerIsUp=wlsxNAuthServerIsUp, wlsxStaPolicyViolation=wlsxStaPolicyViolation, wlsxTrapUpdateFailedObj=wlsxTrapUpdateFailedObj, wlsxNRogueAPResolved=wlsxNRogueAPResolved, wlsxTrapVlanId=wlsxTrapVlanId, wlsxTrapNodeMac=wlsxTrapNodeMac, wlsxSignStaNetstumbler=wlsxSignStaNetstumbler, wlsxVoiceCdrBufferThresholdReached=wlsxVoiceCdrBufferThresholdReached, wlsxClientRejectedByMaxClientCount=wlsxClientRejectedByMaxClientCount, wlsxChannelInterferenceDetected=wlsxChannelInterferenceDetected, wlsxNConnectionBackfromLocal=wlsxNConnectionBackfromLocal, wlsxTrapUSBVendorProductID=wlsxTrapUSBVendorProductID, wlsxInvalidMacOUIAP=wlsxInvalidMacOUIAP, wlsxTrapPrimaryControllerIp=wlsxTrapPrimaryControllerIp, wlsxShortPreableMisconfiguration=wlsxShortPreableMisconfiguration, wlsxMalformedFrameWrongChannelDetected=wlsxMalformedFrameWrongChannelDetected, wlsxIAPVoiceClientLocationUpdate=wlsxIAPVoiceClientLocationUpdate, wlsxTrapAPLocation=wlsxTrapAPLocation, wlsxNAuthMaxBWContracts=wlsxNAuthMaxBWContracts, wlsxNIpSpoofingDetected=wlsxNIpSpoofingDetected, wlsxTrapTimeStr=wlsxTrapTimeStr, wlsxVlanInterfaceEntryChanged=wlsxVlanInterfaceEntryChanged, wlsxNodeRateAnomaly=wlsxNodeRateAnomaly, wlsxTrapAdminStatus=wlsxTrapAdminStatus, wlsxSwitchListEntryChanged=wlsxSwitchListEntryChanged, wlsxChopChopAttack=wlsxChopChopAttack, wlsxNSignatureMatchDisassocBcast=wlsxNSignatureMatchDisassocBcast, wlsxProcessRestart=wlsxProcessRestart, wlsxTrapClientClassification=wlsxTrapClientClassification, wlsxWindowsBridgeDetectedSta=wlsxWindowsBridgeDetectedSta, wlsxAdhocNetworkBridgeDetectedSta=wlsxAdhocNetworkBridgeDetectedSta, wlsxDisconnectStationAttack=wlsxDisconnectStationAttack, wlsxTrapApControllerIp=wlsxTrapApControllerIp, wlsxTrapVrrpOperState=wlsxTrapVrrpOperState, wlsxPowerSaveDosAttack=wlsxPowerSaveDosAttack, wlsxInvalidMacOUISta=wlsxInvalidMacOUISta, wlsxLicenseServerExpiry=wlsxLicenseServerExpiry, wlsxWPAMisconfiguration=wlsxWPAMisconfiguration, wlsxClientPskAuthenticationFailed=wlsxClientPskAuthenticationFailed, wlsxAPDown=wlsxAPDown, wlsxGhostTunnelclientAttack=wlsxGhostTunnelclientAttack, wlsxRepeatWEPIVViolation=wlsxRepeatWEPIVViolation, wlsxFlash1SpaceOK=wlsxFlash1SpaceOK, wlsxSignStaDeauthBcast=wlsxSignStaDeauthBcast, wlsxLicenseThresholdLimitHit=wlsxLicenseThresholdLimitHit, wlsxAPNumWarmStarts=wlsxAPNumWarmStarts, wlsxNSignatureMatchAirjack=wlsxNSignatureMatchAirjack, wlsxTrapMasterIp=wlsxTrapMasterIp, wlsxLoadbalancingDisabled=wlsxLoadbalancingDisabled, wlsxTrapAddressType=wlsxTrapAddressType)
