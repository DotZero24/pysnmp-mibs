# SNMP MIB module (QTECH-NMS-LOG-SERVER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-NMS-LOG-SERVER-MIB
...
logServerTableEntry = _LogServerTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 34751, 2, 235, 1, 1)
)
logServerTableEntry.setIndexNames(
    (0, "QTECH-NMS-LOG-SERVER-MIB", "logServerLevel"),
    (0, "QTECH-NMS-LOG-SERVER-MIB", "logServerAddr"),
)
if mibBuilder.loadTexts:
