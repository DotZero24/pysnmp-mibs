...
logServer=_LogServer_ObjectIdentity((1,3,6,1,4,1,34751,2,235))
_LogServerTable_Object=MibTable
logServerTable=_LogServerTable_Object((1,3,6,1,4,1,34751,2,235,1))
if mibBuilder.loadTexts:logServerTable.setStatus(_A)
_LogServerTableEntry_Object=MibTableRow
logServerTableEntry=_LogServerTableEntry_Object((1,3,6,1,4,1,34751,2,235,1,1))
...
logServerLevel=_LogServerLevel_Object((1,3,6,1,4,1,34751,2,235,1,1,1),_LogServerLevel_Type())
...
logServerAddr=_LogServerAddr_Object((1,3,6,1,4,1,34751,2,235,1,1,2),_LogServerAddr_Type())
...
logServerRowStatus=_LogServerRowStatus_Object((1,3,6,1,4,1,34751,2,235,1,1,3),_LogServerRowStatus_Type())
...
logServerOff=_LogServerOff_Object((1,3,6,1,4,1,34751,2,235,2),_LogServerOff_Type())
logServerOff.setMaxAccess(_D)
if mibBuilder.loadTexts:logServerOff.setStatus(_A)
_LogTrapTable_Object=MibTable
logTrapTable=_LogTrapTable_Object((1,3,6,1,4,1,34751,2,235,3))
if mibBuilder.loadTexts:logTrapTable.setStatus(_A)
_LogTrapTableEntry_Object=MibTableRow
logTrapTableEntry=_LogTrapTableEntry_Object((1,3,6,1,4,1,34751,2,235,3,1))
logTrapTableEntry.setIndexNames((0,_C,'logTrapLevel'),(0,_C,_K))
if mibBuilder.loadTexts:logTrapTableEntry.setStatus(_A)
_LogTrapAddr_Type=IpAddress
_LogTrapAddr_Object=MibTableColumn
logTrapAddr=_LogTrapAddr_Object((1,3,6,1,4,1,34751,2,235,3,1,1),_LogTrapAddr_Type())
...
logTrapRowStatus=_LogTrapRowStatus_Object((1,3,6,1,4,1,34751,2,235,3,1,2),_LogTrapRowStatus_Type())
...
logTrapRfcVer=_LogTrapRfcVer_Object((1,3,6,1,4,1,34751,2,235,3,1,3),_LogTrapRfcVer_Type())
logTrapRfcVer.setMaxAccess(_D)
if mibBuilder.loadTexts:logTrapRfcVer.setStatus(_A)
class _LogTrap_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2,3,4,5,6,7)));namedValues=NamedValues(*(('emerg',0),('alert',1),(_G,2),('error',3),(_H,4),(_I,5),('info',6),('debug',7)))
_LogTrap_Type.__name__=_B
_LogTrap_Object=MibScalar
logTrap=_LogTrap_Object((1,3,6,1,4,1,34751,2,235,4),_LogTrap_Type())
logTrap.setMaxAccess(_D)
if mibBuilder.loadTexts:logTrap.setStatus(_A)
mibBuilder.exportSymbols(_C,**{'logServer':logServer,'logServerTable':logServerTable,'logServerTableEntry':logServerTableEntry,_E:logServerLevel,_F:logServerAddr,'logServerRowStatus':logServerRowStatus,'logServerOff':logServerOff,'logTrapTable':logTrapTable,'logTrapTableEntry':logTrapTableEntry,_K:logTrapAddr,'logTrapRowStatus':logTrapRowStatus,'logTrapRfcVer':logTrapRfcVer,'logTrap':logTrap})