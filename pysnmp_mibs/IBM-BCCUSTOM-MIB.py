...
mibBuilder.exportSymbols("IBM-BCCUSTOM-MIB", systemFileActivation=systemFileActivation, portInformation=portInformation, iomSnmpv3Cfg=iomSnmpv3Cfg, firmwareAction=firmwareAction, portModuleCableManufacturer=portModuleCableManufacturer, portModuleMedia=portModuleMedia, portModuleType=portModuleType, fwImageIndex=fwImageIndex, licenseKeyInformationTable=licenseKeyInformationTable, systemFileOpStatusString=systemFileOpStatusString, portModuleReal=portModuleReal, iomCapability=iomCapability, systemFileInformationEntry=systemFileInformationEntry, ibm=ibm, license=license, ntpUpdateFrequency=ntpUpdateFrequency, iomSnmpv3UserPrivacyProtocol=iomSnmpv3UserPrivacyProtocol, systemFile=systemFile, iomSnmpv3UserIPv6TrapAddress=iomSnmpv3UserIPv6TrapAddress, iomSnmpv3UserState=iomSnmpv3UserState, systemFileIndex=systemFileIndex, systemFileCmdUri=systemFileCmdUri, licenseKeyIndex=licenseKeyIndex, fwImageIsUpdateable=fwImageIsUpdateable, iomSnmpv3UserAuthPassword=iomSnmpv3UserAuthPassword, portModuleLabel=portModuleLabel, fwUpdateOperationStatus=fwUpdateOperationStatus, portInformationEntry=portInformationEntry, fwUpdateImageSftpRsaKey=fwUpdateImageSftpRsaKey, portModuleCableLength=portModuleCableLength, ntpSrvIpv4Address=ntpSrvIpv4Address, portModuleCableType=portModuleCableType, bcCustom=bcCustom, iomSnmpv3TestTrap=iomSnmpv3TestTrap, portModuleRelative=portModuleRelative, PYSNMP_MODULE_ID=bcCustom, portInformationTable=portInformationTable, licenseKeyInformationEntry=licenseKeyInformationEntry, iomSnmpv3UserAuthProtocol=iomSnmpv3UserAuthProtocol, firmwareImageCnt=firmwareImageCnt, ports=ports, fwUpdateImageUri=fwUpdateImageUri, fwUpdateImageActivation=fwUpdateImageActivation, portModuleLaneCount=portModuleLaneCount, iomSnmpv3UserStateStatusString=iomSnmpv3UserStateStatusString, firmwareServer=firmwareServer, mibCustomVersion=mibCustomVersion, portModuleLinkState=portModuleLinkState, ntpEnable=ntpEnable, systemFileInformationProtocols=systemFileInformationProtocols, iomSnmpv3tResetUser=iomSnmpv3tResetUser, fwImageProtocols=fwImageProtocols, bcCustomMibVersion=bcCustomMibVersion, portModuleSpeed=portModuleSpeed, portModuleLicensedState=portModuleLicensedState, licenseKeyDescStringInformation=licenseKeyDescStringInformation, portModuleSpeedList=portModuleSpeedList, portModuleProtocol=portModuleProtocol, firmware=firmware, licenseKeyCurrentState=licenseKeyCurrentState, ntpv3AuthEnable=ntpv3AuthEnable, systemFileInformation=systemFileInformation, portModuleCableCompatiblity=portModuleCableCompatiblity, systemFileCmdFilename=systemFileCmdFilename, systemFileCmdSftpRsaKey=systemFileCmdSftpRsaKey, fwImageInformation=fwImageInformation, systemFileCmdExecuteOp=systemFileCmdExecuteOp, fwImageFileLocation=fwImageFileLocation, systemFileOperationStatus=systemFileOperationStatus, systemFileCmd=systemFileCmd, iomSnmpv3UserPrivacyPassword=iomSnmpv3UserPrivacyPassword, iomSnmpv3UserIPv4TrapAddress=iomSnmpv3UserIPv4TrapAddress, ntpSrvIpv6Address=ntpSrvIpv6Address, ntpv3AuthConfig=ntpv3AuthConfig, systemFileCmdMaxSize=systemFileCmdMaxSize, protocols=protocols, firmwareOps=firmwareOps, portModuleDataRate=portModuleDataRate, systemFileInformationTable=systemFileInformationTable, ibmProd=ibmProd, firmwareImageNum=firmwareImageNum, portModuleTotal=portModuleTotal, mibMajorMinor=mibMajorMinor, iomSnmpv3UserAccessType=iomSnmpv3UserAccessType, files=files, ntpConfig=ntpConfig, firmwareCmd=firmwareCmd, iomMode=iomMode, snmpuser=snmpuser, portModuleIndex=portModuleIndex, systemFileCmdCnt=systemFileCmdCnt, iomSnmpv3UserName=iomSnmpv3UserName, fwInformationEntry=fwInformationEntry, iomGlobal=iomGlobal, fwInformationTable=fwInformationTable)
