...
if mibBuilder.loadTexts:fsm7326Radius.setRevisions(('2003-11-10 12:00',))
_AgentRadiusConfigGroup_ObjectIdentity=ObjectIdentity
agentRadiusConfigGroup=_AgentRadiusConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,1,9,8,1))
...
agentRadiusMaxTransmit=_AgentRadiusMaxTransmit_Object((1,3,6,1,4,1,4526,1,9,8,1,1),_AgentRadiusMaxTransmit_Type())
...
agentRadiusTimeout=_AgentRadiusTimeout_Object((1,3,6,1,4,1,4526,1,9,8,1,2),_AgentRadiusTimeout_Type())
...
agentRadiusAccountingMode=_AgentRadiusAccountingMode_Object((1,3,6,1,4,1,4526,1,9,8,1,3),_AgentRadiusAccountingMode_Type())
...
agentRadiusStatsClear=_AgentRadiusStatsClear_Object((1,3,6,1,4,1,4526,1,9,8,1,4),_AgentRadiusStatsClear_Type())
...
agentRadiusAccountingIndexNextValid=_AgentRadiusAccountingIndexNextValid_Object((1,3,6,1,4,1,4526,1,9,8,1,5),_AgentRadiusAccountingIndexNextValid_Type())
...
agentRadiusAccountingConfigTable=_AgentRadiusAccountingConfigTable_Object((1,3,6,1,4,1,4526,1,9,8,1,6))
...
agentRadiusAccountingConfigEntry=_AgentRadiusAccountingConfigEntry_Object((1,3,6,1,4,1,4526,1,9,8,1,6,1))
...
agentRadiusAccountingServerIndex=_AgentRadiusAccountingServerIndex_Object((1,3,6,1,4,1,4526,1,9,8,1,6,1,1),_AgentRadiusAccountingServerIndex_Type())
...
agentRadiusAccountingServerAddress=_AgentRadiusAccountingServerAddress_Object((1,3,6,1,4,1,4526,1,9,8,1,6,1,2),_AgentRadiusAccountingServerAddress_Type())
...
agentRadiusAccountingPort=_AgentRadiusAccountingPort_Object((1,3,6,1,4,1,4526,1,9,8,1,6,1,3),_AgentRadiusAccountingPort_Type())
...
agentRadiusAccountingSecret=_AgentRadiusAccountingSecret_Object((1,3,6,1,4,1,4526,1,9,8,1,6,1,4),_AgentRadiusAccountingSecret_Type())
...
agentRadiusAccountingStatus=_AgentRadiusAccountingStatus_Object((1,3,6,1,4,1,4526,1,9,8,1,6,1,5),_AgentRadiusAccountingStatus_Type())
...
agentRadiusServerIndexNextValid=_AgentRadiusServerIndexNextValid_Object((1,3,6,1,4,1,4526,1,9,8,1,7),_AgentRadiusServerIndexNextValid_Type())
...
agentRadiusServerConfigTable=_AgentRadiusServerConfigTable_Object((1,3,6,1,4,1,4526,1,9,8,1,8))
if mibBuilder.loadTexts:agentRadiusServerConfigTable.setStatus(_A)
_AgentRadiusServerConfigEntry_Object=MibTableRow
agentRadiusServerConfigEntry=_AgentRadiusServerConfigEntry_Object((1,3,6,1,4,1,4526,1,9,8,1,8,1))
...
agentRadiusServerIndex=_AgentRadiusServerIndex_Object((1,3,6,1,4,1,4526,1,9,8,1,8,1,1),_AgentRadiusServerIndex_Type())
...
agentRadiusServerAddress=_AgentRadiusServerAddress_Object((1,3,6,1,4,1,4526,1,9,8,1,8,1,2),_AgentRadiusServerAddress_Type())
...
agentRadiusServerPort=_AgentRadiusServerPort_Object((1,3,6,1,4,1,4526,1,9,8,1,8,1,3),_AgentRadiusServerPort_Type())
...
agentRadiusServerSecret=_AgentRadiusServerSecret_Object((1,3,6,1,4,1,4526,1,9,8,1,8,1,4),_AgentRadiusServerSecret_Type())
...
agentRadiusServerPrimaryMode=_AgentRadiusServerPrimaryMode_Object((1,3,6,1,4,1,4526,1,9,8,1,8,1,5),_AgentRadiusServerPrimaryMode_Type())
...
agentRadiusServerCurrentMode=_AgentRadiusServerCurrentMode_Object((1,3,6,1,4,1,4526,1,9,8,1,8,1,6),_AgentRadiusServerCurrentMode_Type())
...
agentRadiusServerMsgAuth=_AgentRadiusServerMsgAuth_Object((1,3,6,1,4,1,4526,1,9,8,1,8,1,7),_AgentRadiusServerMsgAuth_Type())
