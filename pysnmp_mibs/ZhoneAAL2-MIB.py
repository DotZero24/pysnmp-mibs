...
AtmVorXLastChange, AtmVpIdentifier, AtmVcIdentifier, AtmVorXOperStatus, AtmVorXAdminStatus = mibBuilder.importSymbols("ATM-TC-MIB", "AtmVorXLastChange", "AtmVpIdentifier", "AtmVcIdentifier", "AtmVorXOperStatus", "AtmVorXAdminStatus")
...
mibBuilder.exportSymbols("ZhoneAAL2-MIB", aal2AlarmConfigEntry=aal2AlarmConfigEntry, aal2ElcpPortAudioService=aal2ElcpPortAudioService, aal2InternalAIS=aal2InternalAIS, aal2CidMfR2DialedDigits=aal2CidMfR2DialedDigits, aal2CidPreferredApIndex=aal2CidPreferredApIndex, aal2vpi=aal2vpi, aal2ElcpIgOperStatusChangeCount=aal2ElcpIgOperStatusChangeCount, aal2SscsI3661PerfEntry=aal2SscsI3661PerfEntry, aal2UserDefinedAudioProfileNextIndexEntry=aal2UserDefinedAudioProfileNextIndexEntry, aal2ElcpIgLapvSent=aal2ElcpIgLapvSent, aal2ApSduMultiples=aal2ApSduMultiples, aal2AlarmConfigTable=aal2AlarmConfigTable, aal2CidLastChange=aal2CidLastChange, aal2CidRasTimer=aal2CidRasTimer, aal2ApMinUUI=aal2ApMinUUI, aal2ElcpPortId=aal2ElcpPortId, aal2ElcpPortType=aal2ElcpPortType, PYSNMP_MODULE_ID=zhoneAtmAAl2, aal2CidMaxLengthFrame=aal2CidMaxLengthFrame, aal2CpsPerformanceEntry=aal2CpsPerformanceEntry, zhoneAtmAAl2=zhoneAtmAAl2, aal2CidEntry=aal2CidEntry, aal2AudioProfileEntry=aal2AudioProfileEntry, aal2ApPacketLength=aal2ApPacketLength, aal2CpsPerfSTFParity=aal2CpsPerfSTFParity, aal2VclCellsSent=aal2VclCellsSent, aal2CpsPerfBadCPSLength=aal2CpsPerfBadCPSLength, aal2CidCellsReceived=aal2CidCellsReceived, aal2PvcDown=aal2PvcDown, aal2VclStatsTimeElapsed=aal2VclStatsTimeElapsed, aal2ExternalAIS=aal2ExternalAIS, aal2CpsPerfCongestion=aal2CpsPerfCongestion, aal2SscsI3662Type3CRC=aal2SscsI3662Type3CRC, aal2ElcpIgEntry=aal2ElcpIgEntry, aal2ElcpPortTable=aal2ElcpPortTable, aal2CidAdminStatus=aal2CidAdminStatus, aal2ApAlgorithm=aal2ApAlgorithm, aal2ApIndex=aal2ApIndex, aal2SscsI3662ProfileError=aal2SscsI3662ProfileError, aal2SscsI3661MsgTooLong=aal2SscsI3661MsgTooLong, aal2VclCAS=aal2VclCAS, aal2ElcpIgLapvReceived=aal2ElcpIgLapvReceived, aal2VclPCMEncoding=aal2VclPCMEncoding, aal2Cid=aal2Cid, atmVccAal2SigVccI=atmVccAal2SigVccI, aal2InternalRDI=aal2InternalRDI, aal2ApSilenceSupression=aal2ApSilenceSupression, aal2ElcpPortPCMEncoding=aal2ElcpPortPCMEncoding, aal2CidCAS=aal2CidCAS, aal2CidDTMFDialedDigits=aal2CidDTMFDialedDigits, aal2VclMaxCidForAal2UserChannels=aal2VclMaxCidForAal2UserChannels, aal2VclEntry=aal2VclEntry, aal2ElcpIgOperStatusChange=aal2ElcpIgOperStatusChange, aal2VclNextCid=aal2VclNextCid, aal2SscsI3661MsgTooShort=aal2SscsI3661MsgTooShort, aal2CpsPerfPayloadTooLong=aal2CpsPerfPayloadTooLong, aal2UserDefinedAudioProfileNextIndexTable=aal2UserDefinedAudioProfileNextIndexTable, aal2PerfCongestionThreshTrap=aal2PerfCongestionThreshTrap, aal2ElcpPortMaxLengthFrame=aal2ElcpPortMaxLengthFrame, aal2SscsI3662IllegalUUI=aal2SscsI3662IllegalUUI, aal2AlarmConfigThreshCellLoss=aal2AlarmConfigThreshCellLoss, aal2CidFrameModeData=aal2CidFrameModeData, aal2CpsPerfIllegalUUI=aal2CpsPerfIllegalUUI, aal2VclCellsReceived=aal2VclCellsReceived, aal2CidPCMEncoding=aal2CidPCMEncoding, atmVccAal2VccI=atmVccAal2VccI, aal2VclDTMFDialedDigits=aal2VclDTMFDialedDigits, aal2SscsI3661RasTimerExpired=aal2SscsI3661RasTimerExpired, aal2AudioProfileTable=aal2AudioProfileTable, aal2CidBlockedCallsNoBandwidth=aal2CidBlockedCallsNoBandwidth, aal2VclCircuitModeData=aal2VclCircuitModeData, aal2CidMfR1DialedDigits=aal2CidMfR1DialedDigits, aal2CidFaxDemoRemo=aal2CidFaxDemoRemo, aal2CpsPerfBadPayloadLength=aal2CpsPerfBadPayloadLength, aal2ElcpIgOperStatus=aal2ElcpIgOperStatus, aal2VclSscsDefaultType=aal2VclSscsDefaultType, aal2CidSscsType=aal2CidSscsType, aal2VclAudioService=aal2VclAudioService, aal2VclTable=aal2VclTable, aal2AlarmConfigThreshCongestion=aal2AlarmConfigThreshCongestion, aal2VclFrameModeData=aal2VclFrameModeData, aal2ApPktTime=aal2ApPktTime, aal2CpsPerfRessError=aal2CpsPerfRessError, aal2Vci=aal2Vci, aal2ExternalRAI=aal2ExternalRAI, aal2VclRasTimer=aal2VclRasTimer, aal2VclAudioProfileIdentifier=aal2VclAudioProfileIdentifier, aal2VclMaxCpsSduSize=aal2VclMaxCpsSduSize, aal2Traps=aal2Traps, aal2VclMaxLengthFrame=aal2VclMaxLengthFrame, aal2ApRowStatus=aal2ApRowStatus, aal2ApMaxUUI=aal2ApMaxUUI, aal2ElcpPortRowStatus=aal2ElcpPortRowStatus, aal2VclMaxNumberMultiplexChannels=aal2VclMaxNumberMultiplexChannels, aal2VclMaxSDULength=aal2VclMaxSDULength, aal2SscsI3661PerfTable=aal2SscsI3661PerfTable, aal2ElcpIgTable=aal2ElcpIgTable, aal2VclTrunkType=aal2VclTrunkType, aal2PerfCellLossThreshTrap=aal2PerfCellLossThreshTrap, aal2VclFaxDemoRemo=aal2VclFaxDemoRemo, aal2CidCircuitModeData=aal2CidCircuitModeData, aal2UdApNextIndex=aal2UdApNextIndex, aal2CpsPerfHEC=aal2CpsPerfHEC, aal2SscsI3662PerfEntry=aal2SscsI3662PerfEntry, aal2CidAudioService=aal2CidAudioService, aal2CidMaxSDULength=aal2CidMaxSDULength, aal2VclMinCidForAal2UserChannels=aal2VclMinCidForAal2UserChannels, aal2CpsPerfSTFBadSeq=aal2CpsPerfSTFBadSeq, aal2ElcpPortMaxSDULength=aal2ElcpPortMaxSDULength, aal2CpsPerfIllegalCID=aal2CpsPerfIllegalCID, aal2VclTimerCU=aal2VclTimerCU, aal2CidTable=aal2CidTable, aal2CidOperStatus=aal2CidOperStatus, aal2CpsPerfTransError=aal2CpsPerfTransError, aal2ElcpPortEntry=aal2ElcpPortEntry, aal2CpsPerformanceTable=aal2CpsPerformanceTable, aal2CidStatsTimeElapsed=aal2CidStatsTimeElapsed, aal2ApSequence=aal2ApSequence, aal2ElcpPortPreferredApIndex=aal2ElcpPortPreferredApIndex, atmVccAal2AppId=atmVccAal2AppId, aal2VclMfR1DialedDigits=aal2VclMfR1DialedDigits, aal2CidCellsSent=aal2CidCellsSent, aal2VclMfR2DialedDigits=aal2VclMfR2DialedDigits, aal2SscsI3661BadLength=aal2SscsI3661BadLength, aal2SscsI3661CRC=aal2SscsI3661CRC, aal2CidRowStatus=aal2CidRowStatus, aal2SscsI3662PerfTable=aal2SscsI3662PerfTable, aal2CidCompletedCalls=aal2CidCompletedCalls)
