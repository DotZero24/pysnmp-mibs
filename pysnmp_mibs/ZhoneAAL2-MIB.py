...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/zhone/ZhoneAAL2-MIB
...
AtmVorXLastChange, AtmVorXOperStatus, AtmVcIdentifier, AtmVpIdentifier, AtmVorXAdminStatus = mibBuilder.importSymbols("ATM-TC-MIB", "AtmVorXLastChange", "AtmVorXOperStatus", "AtmVcIdentifier", "AtmVpIdentifier", "AtmVorXAdminStatus")
...
mibBuilder.exportSymbols("ZhoneAAL2-MIB", aal2SscsI3662PerfEntry=aal2SscsI3662PerfEntry, aal2CpsPerfTransError=aal2CpsPerfTransError, aal2VclNextCid=aal2VclNextCid, aal2CpsPerfIllegalUUI=aal2CpsPerfIllegalUUI, aal2UserDefinedAudioProfileNextIndexTable=aal2UserDefinedAudioProfileNextIndexTable, aal2CpsPerformanceEntry=aal2CpsPerformanceEntry, aal2SscsI3661BadLength=aal2SscsI3661BadLength, aal2ElcpPortRowStatus=aal2ElcpPortRowStatus, aal2ApSilenceSupression=aal2ApSilenceSupression, aal2SscsI3662IllegalUUI=aal2SscsI3662IllegalUUI, aal2CidCellsReceived=aal2CidCellsReceived, aal2CidBlockedCallsNoBandwidth=aal2CidBlockedCallsNoBandwidth, aal2CpsPerfBadCPSLength=aal2CpsPerfBadCPSLength, aal2ElcpPortMaxSDULength=aal2ElcpPortMaxSDULength, aal2ApIndex=aal2ApIndex, aal2VclCellsSent=aal2VclCellsSent, aal2CidOperStatus=aal2CidOperStatus, aal2SscsI3661RasTimerExpired=aal2SscsI3661RasTimerExpired, aal2VclRasTimer=aal2VclRasTimer, aal2ElcpIgEntry=aal2ElcpIgEntry, aal2CidTable=aal2CidTable, aal2CidCellsSent=aal2CidCellsSent, aal2VclDTMFDialedDigits=aal2VclDTMFDialedDigits, aal2CidMaxLengthFrame=aal2CidMaxLengthFrame, aal2ApAlgorithm=aal2ApAlgorithm, aal2VclMinCidForAal2UserChannels=aal2VclMinCidForAal2UserChannels, aal2AudioProfileEntry=aal2AudioProfileEntry, aal2CidAdminStatus=aal2CidAdminStatus, aal2ElcpIgOperStatusChangeCount=aal2ElcpIgOperStatusChangeCount, aal2InternalRDI=aal2InternalRDI, aal2ElcpIgLapvSent=aal2ElcpIgLapvSent, aal2VclCellsReceived=aal2VclCellsReceived, aal2CidFrameModeData=aal2CidFrameModeData, aal2ElcpPortPreferredApIndex=aal2ElcpPortPreferredApIndex, aal2ElcpIgLapvReceived=aal2ElcpIgLapvReceived, aal2AlarmConfigEntry=aal2AlarmConfigEntry, aal2ApPacketLength=aal2ApPacketLength, aal2ExternalRAI=aal2ExternalRAI, aal2SscsI3662PerfTable=aal2SscsI3662PerfTable, atmVccAal2AppId=atmVccAal2AppId, aal2CpsPerfHEC=aal2CpsPerfHEC, aal2CidMaxSDULength=aal2CidMaxSDULength, aal2UdApNextIndex=aal2UdApNextIndex, aal2SscsI3661MsgTooShort=aal2SscsI3661MsgTooShort, aal2InternalAIS=aal2InternalAIS, aal2ElcpIgTable=aal2ElcpIgTable, aal2VclMaxLengthFrame=aal2VclMaxLengthFrame, aal2AlarmConfigThreshCongestion=aal2AlarmConfigThreshCongestion, aal2ApPktTime=aal2ApPktTime, aal2CpsPerfCongestion=aal2CpsPerfCongestion, aal2AlarmConfigThreshCellLoss=aal2AlarmConfigThreshCellLoss, aal2VclCAS=aal2VclCAS, aal2SscsI3661PerfTable=aal2SscsI3661PerfTable, aal2CidRasTimer=aal2CidRasTimer, aal2CidRowStatus=aal2CidRowStatus, aal2CidDTMFDialedDigits=aal2CidDTMFDialedDigits, aal2SscsI3661MsgTooLong=aal2SscsI3661MsgTooLong, aal2SscsI3662Type3CRC=aal2SscsI3662Type3CRC, aal2vpi=aal2vpi, aal2VclMaxCidForAal2UserChannels=aal2VclMaxCidForAal2UserChannels, aal2CpsPerfPayloadTooLong=aal2CpsPerfPayloadTooLong, aal2SscsI3661PerfEntry=aal2SscsI3661PerfEntry, atmVccAal2VccI=atmVccAal2VccI, aal2VclMaxSDULength=aal2VclMaxSDULength, aal2Traps=aal2Traps, aal2CpsPerfSTFBadSeq=aal2CpsPerfSTFBadSeq, aal2Vci=aal2Vci, aal2VclCircuitModeData=aal2VclCircuitModeData, aal2VclPCMEncoding=aal2VclPCMEncoding, aal2AlarmConfigTable=aal2AlarmConfigTable, aal2ElcpPortPCMEncoding=aal2ElcpPortPCMEncoding, aal2VclFaxDemoRemo=aal2VclFaxDemoRemo, aal2CidSscsType=aal2CidSscsType, aal2ElcpPortType=aal2ElcpPortType, aal2VclStatsTimeElapsed=aal2VclStatsTimeElapsed, aal2AudioProfileTable=aal2AudioProfileTable, aal2VclMaxCpsSduSize=aal2VclMaxCpsSduSize, aal2ElcpPortId=aal2ElcpPortId, PYSNMP_MODULE_ID=zhoneAtmAAl2, aal2ExternalAIS=aal2ExternalAIS, aal2CidCAS=aal2CidCAS, aal2PvcDown=aal2PvcDown, aal2VclAudioProfileIdentifier=aal2VclAudioProfileIdentifier, aal2CpsPerformanceTable=aal2CpsPerformanceTable, aal2VclTable=aal2VclTable, aal2VclEntry=aal2VclEntry, aal2ApSequence=aal2ApSequence, aal2CidLastChange=aal2CidLastChange, aal2VclAudioService=aal2VclAudioService, aal2CidStatsTimeElapsed=aal2CidStatsTimeElapsed, aal2ElcpPortTable=aal2ElcpPortTable, aal2CidFaxDemoRemo=aal2CidFaxDemoRemo, aal2CpsPerfBadPayloadLength=aal2CpsPerfBadPayloadLength, aal2ElcpPortAudioService=aal2ElcpPortAudioService, aal2CidCircuitModeData=aal2CidCircuitModeData, aal2CpsPerfIllegalCID=aal2CpsPerfIllegalCID, aal2VclMfR2DialedDigits=aal2VclMfR2DialedDigits, aal2CidPreferredApIndex=aal2CidPreferredApIndex, aal2SscsI3661CRC=aal2SscsI3661CRC, atmVccAal2SigVccI=atmVccAal2SigVccI, aal2VclTimerCU=aal2VclTimerCU, aal2ApRowStatus=aal2ApRowStatus, aal2UserDefinedAudioProfileNextIndexEntry=aal2UserDefinedAudioProfileNextIndexEntry, aal2CidMfR2DialedDigits=aal2CidMfR2DialedDigits, aal2ApMinUUI=aal2ApMinUUI, aal2Cid=aal2Cid, aal2CidPCMEncoding=aal2CidPCMEncoding, aal2ElcpPortMaxLengthFrame=aal2ElcpPortMaxLengthFrame, aal2CidEntry=aal2CidEntry, aal2VclFrameModeData=aal2VclFrameModeData, aal2PerfCongestionThreshTrap=aal2PerfCongestionThreshTrap, aal2ElcpIgOperStatusChange=aal2ElcpIgOperStatusChange, aal2CidMfR1DialedDigits=aal2CidMfR1DialedDigits, aal2PerfCellLossThreshTrap=aal2PerfCellLossThreshTrap, aal2ApSduMultiples=aal2ApSduMultiples, aal2CpsPerfSTFParity=aal2CpsPerfSTFParity, aal2CpsPerfRessError=aal2CpsPerfRessError, aal2ElcpPortEntry=aal2ElcpPortEntry, aal2VclTrunkType=aal2VclTrunkType, zhoneAtmAAl2=zhoneAtmAAl2, aal2SscsI3662ProfileError=aal2SscsI3662ProfileError, aal2VclMfR1DialedDigits=aal2VclMfR1DialedDigits, aal2CidAudioService=aal2CidAudioService, aal2VclMaxNumberMultiplexChannels=aal2VclMaxNumberMultiplexChannels, aal2ApMaxUUI=aal2ApMaxUUI, aal2ElcpIgOperStatus=aal2ElcpIgOperStatus, aal2CidCompletedCalls=aal2CidCompletedCalls, aal2VclSscsDefaultType=aal2VclSscsDefaultType)
