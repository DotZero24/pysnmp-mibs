...
mibBuilder.exportSymbols("NetWare-Server-MIB", EngineType=EngineType, nwQJobControlFlags=nwQJobControlFlags, nwUserAcctTable=nwUserAcctTable, nwNLMCopyright=nwNLMCopyright, nwConnectionTransportDomain=nwConnectionTransportDomain, nwSysServerUpTime=nwSysServerUpTime, nwSysDaylightSavingsStatus=nwSysDaylightSavingsStatus, nwNLMName=nwNLMName, nwVolFileSystemID=nwVolFileSystemID, nwFSOpenFiles=nwFSOpenFiles, nwFSReads=nwFSReads, nwUserBadLoginAttempts=nwUserBadLoginAttempts, nwSetCategoryIndex=nwSetCategoryIndex, nwSft3EngineName=nwSft3EngineName, nwSetDescription=nwSetDescription, nwQueueTable=nwQueueTable, nwNCPNoAvailConns=nwNCPNoAvailConns, nwNLMProtectionDomain=nwNLMProtectionDomain, nwNLMMajorVer=nwNLMMajorVer, nwQJobEntryDateTime=nwQJobEntryDateTime, nwSetCategoryTable=nwSetCategoryTable, nwOfileVolumeName=nwOfileVolumeName, nwConnectionReadKBytes=nwConnectionReadKBytes, nwNCP=nwNCP, nwVolUsedDirEntries=nwVolUsedDirEntries, nwQueueServerTable=nwQueueServerTable, nwVolPhysicalName=nwVolPhysicalName, nwUserFullName=nwUserFullName, nwSetParamMode=nwSetParamMode, TransportAddress=TransportAddress, nwSetDescrEntry=nwSetDescrEntry, nwOfileDirectoryNumber=nwOfileDirectoryNumber, nwSysTimeZone=nwSysTimeZone, nwQID=nwQID, nwQServerStatus=nwQServerStatus, nwWDTimeBetweenPkts=nwWDTimeBetweenPkts, nwSetParamName=nwSetParamName, nwNLMRevision=nwNLMRevision, nwSetParamValueInteger=nwSetParamValueInteger, nwVolUsageSpaceUsed=nwVolUsageSpaceUsed, nwVolTotalDirEntries=nwVolTotalDirEntries, nwServer=nwServer, nwQJobQID=nwQJobQID, nwSysDirectoryTree=nwSysDirectoryTree, nwNCPPacketSignatures=nwNCPPacketSignatures, nwVolUsageUserID=nwVolUsageUserID, nwSetParamUpperLimit=nwSetParamUpperLimit, nwNLM=nwNLM, nwConnectionPrivilege=nwConnectionPrivilege, nwFSVolCount=nwFSVolCount, nwNLMDescription=nwNLMDescription, nwFSMaxPercentOfVolumeUsedByDir=nwFSMaxPercentOfVolumeUsedByDir, nwConnectionCount=nwConnectionCount, nwSft3EngineInternalNetNum=nwSft3EngineInternalNetNum, nwSetParamValueString=nwSetParamValueString, nwSysOSReleaseDate=nwSysOSReleaseDate, nwQJobServerName=nwQJobServerName, nwSetDescrTable=nwSetDescrTable, novell=novell, nwSysLoginState=nwSysLoginState, nwSysOSCopyright=nwSysOSCopyright, nwOdiLslEnqSendCount=nwOdiLslEnqSendCount, nwSetDescrIndex=nwSetDescrIndex, nwOdiOsMinPktRcvBuffers=nwOdiOsMinPktRcvBuffers, nwConnectionWrittenKBytes=nwConnectionWrittenKBytes, nwSetParamType=nwSetParamType, nwSft3=nwSft3, nwQNumJobEntries=nwQNumJobEntries, nwOfileVolID=nwOfileVolID, nwUserBadLoginTransport=nwUserBadLoginTransport, nwSysOSMajorVer=nwSysOSMajorVer, nwVolID=nwVolID, nwQType=nwQType, nwVolFree=nwVolFree, nwNCPExtInvalidReqs=nwNCPExtInvalidReqs, DSTType=DSTType, nwSysOSMinorVer=nwSysOSMinorVer, nwSetParamDescrLength=nwSetParamDescrLength, nwUserVolUsageVolume=nwUserVolUsageVolume, nwSft3EngineTable=nwSft3EngineTable, nwNCPInvalidPacketSigs=nwNCPInvalidPacketSigs, nwUserVolVolID=nwUserVolVolID, nwUserID=nwUserID, TransportDomain=TransportDomain, nwQueue=nwQueue, nwFSMaxOpenFiles=nwFSMaxOpenFiles, nwNCPIPXChecksumErrs=nwNCPIPXChecksumErrs, nwUserName=nwUserName, nwSysBinderyContext=nwSysBinderyContext, nwUserLastLoginTime=nwUserLastLoginTime, nwSysOSDescription=nwSysOSDescription, nwOdiOsMaxPktRcvBuffers=nwOdiOsMaxPktRcvBuffers, nwQAttachState=nwQAttachState, nwUserVolUserID=nwUserVolUserID, nwVolFileSystemName=nwVolFileSystemName, nwQJobSize=nwQJobSize, nwSft3EngineState=nwSft3EngineState, nwWDNotifyConsoleFlag=nwWDNotifyConsoleFlag, nwNLMReleaseDate=nwNLMReleaseDate, nwConnectionFilesOpen=nwConnectionFilesOpen, nwQNumAssignedServers=nwQNumAssignedServers, nwOfileLoginName=nwOfileLoginName, nwFSMaxRecordLocks=nwFSMaxRecordLocks, nwVolNameSpaces=nwVolNameSpaces, nwQAddJobState=nwQAddJobState, nwFSVolEntry=nwFSVolEntry, nwQJobPosition=nwQJobPosition, nwNLMTable=nwNLMTable, nwSetDescrParamIndex=nwSetDescrParamIndex, nwFSOpenFileEntry=nwFSOpenFileEntry, nwNCPBeingProcesseds=nwNCPBeingProcesseds, nwVolUsageEntry=nwVolUsageEntry, nwSysDaylightSavingsOffset=nwSysDaylightSavingsOffset, nwNCPIPXChecksums=nwNCPIPXChecksums, nwVolNonFreeable=nwVolNonFreeable, nwVolSize=nwVolSize, nwSft3EngineEntry=nwSft3EngineEntry, nwSetDescrCategoryIndex=nwSetDescrCategoryIndex, nwVolSegmentCount=nwVolSegmentCount, nwQueueEntry=nwQueueEntry, nwUserBadLoginAddress=nwUserBadLoginAddress, nwQJobTargetServerName=nwQJobTargetServerName, nwConnectionNcpRequests=nwConnectionNcpRequests, nwFSWrites=nwFSWrites, nwConnectionStatus=nwConnectionStatus, nwFSOpenFileTable=nwFSOpenFileTable, nwFSMaxSubdirectoryTreeDepth=nwFSMaxSubdirectoryTreeDepth, nwSetCategoryEntry=nwSetCategoryEntry, nwQueueJobTable=nwQueueJobTable, mibDoc=mibDoc, nwConnectionNumber=nwConnectionNumber, nwQueueJobEntry=nwQueueJobEntry, nwSetParamTable=nwSetParamTable, nwNCPUseCount=nwNCPUseCount, nwSysLanguageID=nwSysLanguageID, nwFSRecordLocks=nwFSRecordLocks, nwOdiOsPktRcvBuffer=nwOdiOsPktRcvBuffer, nwUserVolUsageEntry=nwUserVolUsageEntry, nwNLMEntry=nwNLMEntry, nwVolUsageUser=nwVolUsageUser, nwMaxConnections=nwMaxConnections, nwSft3EngineType=nwSft3EngineType, nwQJobDescription=nwQJobDescription, nwSetCategoryName=nwSetCategoryName, nwUserVolUsageTable=nwUserVolUsageTable, nwFSCacheChecks=nwFSCacheChecks, nwVolUsageTable=nwVolUsageTable, nwVolMounted=nwVolMounted, nwUserVolUsageLimit=nwUserVolUsageLimit, nwFSVolTable=nwFSVolTable, nwConnectionRecordsLocked=nwConnectionRecordsLocked, nwQJobUserName=nwQJobUserName, nwSysNMASerialNumber=nwSysNMASerialNumber, nwSetParamIndex=nwSetParamIndex, nwSysOSSFTLevel=nwSysOSSFTLevel, Seconds=Seconds, nwWDTimeBeforeFirstPkt=nwWDTimeBeforeFirstPkt, nwVolUsageVolume=nwVolUsageVolume, nwVolAttributes=nwVolAttributes, nwMaxLogins=nwMaxLogins, nwNCPExtNumReg=nwNCPExtNumReg, nwFileSystem=nwFileSystem, nwSystem=nwSystem, nwUserAccounts=nwUserAccounts, nwConnectionLoginName=nwConnectionLoginName, nwQJobTargetDateTime=nwQJobTargetDateTime, nwLoginCount=nwLoginCount, nwQueueCount=nwQueueCount, nwQName=nwQName, nwVolDSName=nwVolDSName, nwQServerID=nwQServerID, nwOfileConnection=nwOfileConnection, nwQDirVolName=nwQDirVolName, nwUserVolUsageUser=nwUserVolUsageUser, IPXNetNumber=IPXNetNumber, nwVolBlockSize=nwVolBlockSize, nwSft3Engine=nwSft3Engine, nwSysInternalNetNum=nwSysInternalNetNum, nwSysDaylightSavingsStart=nwSysDaylightSavingsStart, nwQServerName=nwQServerName, nwFSWrittenKBytes=nwFSWrittenKBytes, nwSetParamEntry=nwSetParamEntry, nwVolUsageLimit=nwVolUsageLimit, nwSysTime=nwSysTime, nwUserDiskUsage=nwUserDiskUsage, nwOdi=nwOdi, nwFSCacheHits=nwFSCacheHits, nwSysDaylightSavingsEnd=nwSysDaylightSavingsEnd, nwSysSerialNumber=nwSysSerialNumber, nwNLMConnections=nwNLMConnections, nwVolFreeable=nwVolFreeable, nwConnectionEntry=nwConnectionEntry, nwQueueServerEntry=nwQueueServerEntry, nwConnectionTime=nwConnectionTime, nwNCPPeakUseCount=nwNCPPeakUseCount, nwUserPasswordStatus=nwUserPasswordStatus, nwUserCount=nwUserCount, nwQServerQID=nwQServerQID, nwSetParamCategoryIndex=nwSetParamCategoryIndex, nwUserAccountStatus=nwUserAccountStatus, nwSetParams=nwSetParams, nwSysServerName=nwSysServerName, nwUserAcctEntry=nwUserAcctEntry, nwSysServerDSName=nwSysServerDSName, nwNCPNumNCPReqs=nwNCPNumNCPReqs, nwSetParamLowerLimit=nwSetParamLowerLimit, nwQJobNumber=nwQJobNumber, nwSysNMACopiesAllowed=nwSysNMACopiesAllowed, nwConnectionTransportAddress=nwConnectionTransportAddress, nwNLMTotalMemory=nwNLMTotalMemory, nwNCPForgedPkts=nwNCPForgedPkts, nwConnectionTable=nwConnectionTable, nwNLMMinorVer=nwNLMMinorVer, nwWDCurrentState=nwWDCurrentState, nwPeakRemoteConnections=nwPeakRemoteConnections, nwWatchdog=nwWatchdog, nwUserVolUsageSpaceUsed=nwUserVolUsageSpaceUsed, nwFSReadKBytes=nwFSReadKBytes, nwUsers=nwUsers, nwNLMIndex=nwNLMIndex, nwVolUsageVolID=nwVolUsageVolID, nwOfileName=nwOfileName, nwWDNumPktsToSend=nwWDNumPktsToSend, nwQServiceJobState=nwQServiceJobState)
