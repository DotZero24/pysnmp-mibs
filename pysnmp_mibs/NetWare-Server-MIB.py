...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/novell/NetWare-Server-MIB
...
mibBuilder.exportSymbols("NetWare-Server-MIB", nwVolAttributes=nwVolAttributes, nwOdiOsMinPktRcvBuffers=nwOdiOsMinPktRcvBuffers, nwNCPForgedPkts=nwNCPForgedPkts, nwConnectionTable=nwConnectionTable, nwSetParams=nwSetParams, nwNCP=nwNCP, nwSysBinderyContext=nwSysBinderyContext, nwSetParamUpperLimit=nwSetParamUpperLimit, nwNLMConnections=nwNLMConnections, nwNCPBeingProcesseds=nwNCPBeingProcesseds, nwQJobPosition=nwQJobPosition, nwSysOSReleaseDate=nwSysOSReleaseDate, nwQAddJobState=nwQAddJobState, nwUserID=nwUserID, nwVolPhysicalName=nwVolPhysicalName, nwSysNMACopiesAllowed=nwSysNMACopiesAllowed, nwQJobControlFlags=nwQJobControlFlags, EngineType=EngineType, nwSetDescrTable=nwSetDescrTable, nwQueueJobTable=nwQueueJobTable, nwSysDaylightSavingsEnd=nwSysDaylightSavingsEnd, nwQueueServerEntry=nwQueueServerEntry, nwOfileVolumeName=nwOfileVolumeName, nwConnectionNcpRequests=nwConnectionNcpRequests, DSTType=DSTType, nwNLMName=nwNLMName, nwQServerStatus=nwQServerStatus, nwSysOSCopyright=nwSysOSCopyright, nwFSVolEntry=nwFSVolEntry, nwSft3EngineName=nwSft3EngineName, nwConnectionWrittenKBytes=nwConnectionWrittenKBytes, nwNCPExtNumReg=nwNCPExtNumReg, nwNLMReleaseDate=nwNLMReleaseDate, nwVolFileSystemName=nwVolFileSystemName, nwUserVolUsageVolume=nwUserVolUsageVolume, nwQServiceJobState=nwQServiceJobState, nwVolMounted=nwVolMounted, nwWDNumPktsToSend=nwWDNumPktsToSend, nwMaxConnections=nwMaxConnections, nwWDNotifyConsoleFlag=nwWDNotifyConsoleFlag, nwFSVolTable=nwFSVolTable, nwSetCategoryIndex=nwSetCategoryIndex, IPXNetNumber=IPXNetNumber, nwSysServerDSName=nwSysServerDSName, nwNLMTable=nwNLMTable, nwUserAcctTable=nwUserAcctTable, nwUserAccountStatus=nwUserAccountStatus, nwNLMEntry=nwNLMEntry, nwUserDiskUsage=nwUserDiskUsage, nwOfileDirectoryNumber=nwOfileDirectoryNumber, nwSysLanguageID=nwSysLanguageID, nwSft3EngineState=nwSft3EngineState, nwFSVolCount=nwFSVolCount, nwSysLoginState=nwSysLoginState, nwSysServerName=nwSysServerName, nwSetParamValueInteger=nwSetParamValueInteger, nwUserLastLoginTime=nwUserLastLoginTime, nwQJobQID=nwQJobQID, nwSft3=nwSft3, nwSft3EngineTable=nwSft3EngineTable, nwSetParamMode=nwSetParamMode, nwSetDescrIndex=nwSetDescrIndex, nwQJobTargetDateTime=nwQJobTargetDateTime, nwVolDSName=nwVolDSName, nwUserCount=nwUserCount, nwQueueEntry=nwQueueEntry, nwVolFreeable=nwVolFreeable, nwQJobEntryDateTime=nwQJobEntryDateTime, nwSysOSSFTLevel=nwSysOSSFTLevel, nwVolSize=nwVolSize, nwVolUsageTable=nwVolUsageTable, nwSetParamType=nwSetParamType, nwUserBadLoginAddress=nwUserBadLoginAddress, nwUserVolUserID=nwUserVolUserID, nwVolUsageUserID=nwVolUsageUserID, nwUserAccounts=nwUserAccounts, nwUserPasswordStatus=nwUserPasswordStatus, nwSysOSMajorVer=nwSysOSMajorVer, nwUserBadLoginAttempts=nwUserBadLoginAttempts, nwSetParamIndex=nwSetParamIndex, nwSysServerUpTime=nwSysServerUpTime, nwSetDescrEntry=nwSetDescrEntry, nwOfileLoginName=nwOfileLoginName, nwQJobDescription=nwQJobDescription, nwQJobTargetServerName=nwQJobTargetServerName, nwConnectionLoginName=nwConnectionLoginName, nwFSMaxOpenFiles=nwFSMaxOpenFiles, nwUserAcctEntry=nwUserAcctEntry, nwSysInternalNetNum=nwSysInternalNetNum, nwQID=nwQID, nwSetCategoryTable=nwSetCategoryTable, nwFSWrittenKBytes=nwFSWrittenKBytes, nwQServerID=nwQServerID, nwNCPIPXChecksums=nwNCPIPXChecksums, nwSysDaylightSavingsStatus=nwSysDaylightSavingsStatus, nwOfileVolID=nwOfileVolID, nwSft3EngineType=nwSft3EngineType, nwUsers=nwUsers, nwSft3EngineInternalNetNum=nwSft3EngineInternalNetNum, nwConnectionPrivilege=nwConnectionPrivilege, nwFSCacheChecks=nwFSCacheChecks, TransportAddress=TransportAddress, nwConnectionRecordsLocked=nwConnectionRecordsLocked, nwUserVolUsageUser=nwUserVolUsageUser, nwSetParamName=nwSetParamName, nwQJobNumber=nwQJobNumber, nwSysNMASerialNumber=nwSysNMASerialNumber, nwSysDaylightSavingsOffset=nwSysDaylightSavingsOffset, nwConnectionReadKBytes=nwConnectionReadKBytes, nwFSWrites=nwFSWrites, nwQJobSize=nwQJobSize, nwNLMMajorVer=nwNLMMajorVer, nwSetCategoryName=nwSetCategoryName, nwOdi=nwOdi, nwVolUsageVolume=nwVolUsageVolume, nwNCPNoAvailConns=nwNCPNoAvailConns, nwQAttachState=nwQAttachState, nwServer=nwServer, nwNCPExtInvalidReqs=nwNCPExtInvalidReqs, nwNLMCopyright=nwNLMCopyright, nwConnectionTime=nwConnectionTime, nwOfileConnection=nwOfileConnection, nwUserVolUsageTable=nwUserVolUsageTable, nwUserVolUsageEntry=nwUserVolUsageEntry, nwVolBlockSize=nwVolBlockSize, nwQueueTable=nwQueueTable, nwOdiOsMaxPktRcvBuffers=nwOdiOsMaxPktRcvBuffers, nwFSOpenFileTable=nwFSOpenFileTable, nwSetParamDescrLength=nwSetParamDescrLength, nwUserFullName=nwUserFullName, nwVolNameSpaces=nwVolNameSpaces, nwWatchdog=nwWatchdog, nwUserVolVolID=nwUserVolVolID, nwQueueServerTable=nwQueueServerTable, nwVolUsageEntry=nwVolUsageEntry, nwQDirVolName=nwQDirVolName, nwVolFree=nwVolFree, nwSetDescrParamIndex=nwSetDescrParamIndex, novell=novell, nwSetDescription=nwSetDescription, nwConnectionEntry=nwConnectionEntry, nwQJobUserName=nwQJobUserName, nwNLMRevision=nwNLMRevision, nwVolUsageSpaceUsed=nwVolUsageSpaceUsed, nwVolUsageLimit=nwVolUsageLimit, nwVolFileSystemID=nwVolFileSystemID, nwSetParamLowerLimit=nwSetParamLowerLimit, nwPeakRemoteConnections=nwPeakRemoteConnections, nwVolNonFreeable=nwVolNonFreeable, nwFSRecordLocks=nwFSRecordLocks, nwFSCacheHits=nwFSCacheHits, nwVolUsageVolID=nwVolUsageVolID, nwSysSerialNumber=nwSysSerialNumber, nwNCPInvalidPacketSigs=nwNCPInvalidPacketSigs, nwSysTimeZone=nwSysTimeZone, nwFSReads=nwFSReads, nwVolSegmentCount=nwVolSegmentCount, nwNLMDescription=nwNLMDescription, nwQNumJobEntries=nwQNumJobEntries, nwSystem=nwSystem, nwUserVolUsageLimit=nwUserVolUsageLimit, nwConnectionTransportDomain=nwConnectionTransportDomain, nwVolID=nwVolID, nwMaxLogins=nwMaxLogins, nwWDTimeBetweenPkts=nwWDTimeBetweenPkts, nwQueueJobEntry=nwQueueJobEntry, nwFileSystem=nwFileSystem, nwOdiLslEnqSendCount=nwOdiLslEnqSendCount, nwQueueCount=nwQueueCount, nwOdiOsPktRcvBuffer=nwOdiOsPktRcvBuffer, nwNLMTotalMemory=nwNLMTotalMemory, nwWDCurrentState=nwWDCurrentState, nwSysOSMinorVer=nwSysOSMinorVer, nwSysTime=nwSysTime, nwSetCategoryEntry=nwSetCategoryEntry, nwQueue=nwQueue, nwConnectionNumber=nwConnectionNumber, nwSft3EngineEntry=nwSft3EngineEntry, nwQName=nwQName, nwFSOpenFileEntry=nwFSOpenFileEntry, nwUserVolUsageSpaceUsed=nwUserVolUsageSpaceUsed, nwFSMaxRecordLocks=nwFSMaxRecordLocks, nwNCPIPXChecksumErrs=nwNCPIPXChecksumErrs, nwConnectionFilesOpen=nwConnectionFilesOpen, nwSft3Engine=nwSft3Engine, nwFSMaxPercentOfVolumeUsedByDir=nwFSMaxPercentOfVolumeUsedByDir, TransportDomain=TransportDomain, nwVolUsedDirEntries=nwVolUsedDirEntries, nwVolTotalDirEntries=nwVolTotalDirEntries, nwUserName=nwUserName, nwSysDaylightSavingsStart=nwSysDaylightSavingsStart, nwQJobServerName=nwQJobServerName, nwSetDescrCategoryIndex=nwSetDescrCategoryIndex, nwUserBadLoginTransport=nwUserBadLoginTransport, nwNLMIndex=nwNLMIndex, nwLoginCount=nwLoginCount, mibDoc=mibDoc, nwSysOSDescription=nwSysOSDescription, nwNCPNumNCPReqs=nwNCPNumNCPReqs, nwNLMProtectionDomain=nwNLMProtectionDomain, nwNCPPacketSignatures=nwNCPPacketSignatures, nwFSMaxSubdirectoryTreeDepth=nwFSMaxSubdirectoryTreeDepth, nwWDTimeBeforeFirstPkt=nwWDTimeBeforeFirstPkt, nwNLMMinorVer=nwNLMMinorVer, nwConnectionTransportAddress=nwConnectionTransportAddress, nwConnectionStatus=nwConnectionStatus, nwConnectionCount=nwConnectionCount, nwQType=nwQType, nwVolUsageUser=nwVolUsageUser, nwSetParamEntry=nwSetParamEntry, nwNLM=nwNLM, nwOfileName=nwOfileName, nwSetParamCategoryIndex=nwSetParamCategoryIndex, nwNCPPeakUseCount=nwNCPPeakUseCount, nwFSOpenFiles=nwFSOpenFiles, nwFSReadKBytes=nwFSReadKBytes, nwQNumAssignedServers=nwQNumAssignedServers, Seconds=Seconds, nwQServerQID=nwQServerQID, nwQServerName=nwQServerName, nwNCPUseCount=nwNCPUseCount, nwSetParamValueString=nwSetParamValueString, nwSetParamTable=nwSetParamTable, nwSysDirectoryTree=nwSysDirectoryTree)
