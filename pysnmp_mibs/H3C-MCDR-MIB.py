...
h3cMultCDRCfgObject=_H3cMultCDRCfgObject_ObjectIdentity((1,3,6,1,4,1,2011,10,2,86,1))
...
h3cMultCDRStatus=_H3cMultCDRStatus_Object((1,3,6,1,4,1,2011,10,2,86,1,1),_H3cMultCDRStatus_Type())
...
h3cMultCDRReportInterval=_H3cMultCDRReportInterval_Object((1,3,6,1,4,1,2011,10,2,86,1,2),_H3cMultCDRReportInterval_Type())
...
h3cMultCDRCacheLimit=_H3cMultCDRCacheLimit_Object((1,3,6,1,4,1,2011,10,2,86,1,3),_H3cMultCDRCacheLimit_Type())
...
h3cMultCDRRecordDelay=_H3cMultCDRRecordDelay_Object((1,3,6,1,4,1,2011,10,2,86,1,4),_H3cMultCDRRecordDelay_Type())
...
h3cMultCDRRecordSend=_H3cMultCDRRecordSend_Object((1,3,6,1,4,1,2011,10,2,86,1,5),_H3cMultCDRRecordSend_Type())
...
h3cMultUserOnlineInfoTable=_H3cMultUserOnlineInfoTable_Object((1,3,6,1,4,1,2011,10,2,86,2))
if mibBuilder.loadTexts:h3cMultUserOnlineInfoTable.setStatus(_A)
_H3cMultUserOnlineInfoEntry_Object=MibTableRow
h3cMultUserOnlineInfoEntry=_H3cMultUserOnlineInfoEntry_Object((1,3,6,1,4,1,2011,10,2,86,2,1))
...
h3cMultUserRecordID=_H3cMultUserRecordID_Object((1,3,6,1,4,1,2011,10,2,86,2,1,1),_H3cMultUserRecordID_Type())
...
h3cMultUserSubIfIndex=_H3cMultUserSubIfIndex_Object((1,3,6,1,4,1,2011,10,2,86,2,1,2),_H3cMultUserSubIfIndex_Type())
...
h3cMultUserVlanID=_H3cMultUserVlanID_Object((1,3,6,1,4,1,2011,10,2,86,2,1,3),_H3cMultUserVlanID_Type())
...
h3cMultUserJoinGAddrType=_H3cMultUserJoinGAddrType_Object((1,3,6,1,4,1,2011,10,2,86,2,1,4),_H3cMultUserJoinGAddrType_Type())
...
h3cMultUserJoinGAddr=_H3cMultUserJoinGAddr_Object((1,3,6,1,4,1,2011,10,2,86,2,1,5),_H3cMultUserJoinGAddr_Type())
...
h3cMultUserJoinSAddrType=_H3cMultUserJoinSAddrType_Object((1,3,6,1,4,1,2011,10,2,86,2,1,6),_H3cMultUserJoinSAddrType_Type())
...
h3cMultUserJoinSAddr=_H3cMultUserJoinSAddr_Object((1,3,6,1,4,1,2011,10,2,86,2,1,7),_H3cMultUserJoinSAddr_Type())
...
h3cMultUserStatus=_H3cMultUserStatus_Object((1,3,6,1,4,1,2011,10,2,86,2,1,8),_H3cMultUserStatus_Type())
...
h3cMultUserJoinTime=_H3cMultUserJoinTime_Object((1,3,6,1,4,1,2011,10,2,86,2,1,9),_H3cMultUserJoinTime_Type())
...
h3cMultUserPreviewTimes=_H3cMultUserPreviewTimes_Object((1,3,6,1,4,1,2011,10,2,86,2,1,10),_H3cMultUserPreviewTimes_Type())
...
h3cMultUserPreviewRemain=_H3cMultUserPreviewRemain_Object((1,3,6,1,4,1,2011,10,2,86,2,1,11),_H3cMultUserPreviewRemain_Type())
