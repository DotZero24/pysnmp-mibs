...
# Notes
# -----
# ASN.1 source file://mibs/schleifenbauer/SDEVICE-MIB
...
compliance.setObjects(
      *(("SDEVICE-MIB", "sensorsGroup"),
        ("SDEVICE-MIB", "outputMeasuresGroup"),
        ("SDEVICE-MIB", "inputMeasuresGroup"),
        ("SDEVICE-MIB", "switchedOutletsGroup"),
        ("SDEVICE-MIB", "settingsGroup"),
        ("SDEVICE-MIB", "systemStatusGroup"),
        ("SDEVICE-MIB", "configurationGroup"),
        ("SDEVICE-MIB", "identificationGroup"),
        ("SDEVICE-MIB", "resetGroup"))
)
if mibBuilder.loadTexts:
