...
class SpanDestinationReflectorType(TextualConvention,Integer32):status=_A;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*(('span',1),('rspan-start',2),('rspan-final',3)))
_RlSpanMibVersion_Type=Integer32
_RlSpanMibVersion_Object=MibScalar
rlSpanMibVersion=_RlSpanMibVersion_Object((1,3,6,1,4,1,9,6,1,101,219,1),_RlSpanMibVersion_Type())
...
rlSpanDestinationTable=_RlSpanDestinationTable_Object((1,3,6,1,4,1,9,6,1,101,219,2))
if mibBuilder.loadTexts:rlSpanDestinationTable.setStatus(_A)
_RlSpanDestinationEntry_Object=MibTableRow
rlSpanDestinationEntry=_RlSpanDestinationEntry_Object((1,3,6,1,4,1,9,6,1,101,219,2,1))
...
rlSpanDestinationSessionId=_RlSpanDestinationSessionId_Object((1,3,6,1,4,1,9,6,1,101,219,2,1,1),_RlSpanDestinationSessionId_Type())
...
rlSpanDestinationIfIndex=_RlSpanDestinationIfIndex_Object((1,3,6,1,4,1,9,6,1,101,219,2,1,2),_RlSpanDestinationIfIndex_Type())
...
rlSpanDestinationIsReflector=_RlSpanDestinationIsReflector_Object((1,3,6,1,4,1,9,6,1,101,219,2,1,3),_RlSpanDestinationIsReflector_Type())
...
rlSpanDestinationPortType=_RlSpanDestinationPortType_Object((1,3,6,1,4,1,9,6,1,101,219,2,1,4),_RlSpanDestinationPortType_Type())
...
rlSpanDestinationRemoteVlanId=_RlSpanDestinationRemoteVlanId_Object((1,3,6,1,4,1,9,6,1,101,219,2,1,5),_RlSpanDestinationRemoteVlanId_Type())
rlSpanDestinationRemoteVlanId.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSpanDestinationRemoteVlanId.setStatus(_A)
_RlSpanDestinationRowStatus_Type=RowStatus
_RlSpanDestinationRowStatus_Object=MibTableColumn
rlSpanDestinationRowStatus=_RlSpanDestinationRowStatus_Object((1,3,6,1,4,1,9,6,1,101,219,2,1,6),_RlSpanDestinationRowStatus_Type())
...
rlSpanSourceTable=_RlSpanSourceTable_Object((1,3,6,1,4,1,9,6,1,101,219,3))
if mibBuilder.loadTexts:rlSpanSourceTable.setStatus(_A)
_RlSpanSourceEntry_Object=MibTableRow
rlSpanSourceEntry=_RlSpanSourceEntry_Object((1,3,6,1,4,1,9,6,1,101,219,3,1))
...
rlSpanSourceSessionId=_RlSpanSourceSessionId_Object((1,3,6,1,4,1,9,6,1,101,219,3,1,1),_RlSpanSourceSessionId_Type())
...
rlSpanSourceType=_RlSpanSourceType_Object((1,3,6,1,4,1,9,6,1,101,219,3,1,2),_RlSpanSourceType_Type())
...
rlSpanSourceIndex=_RlSpanSourceIndex_Object((1,3,6,1,4,1,9,6,1,101,219,3,1,3),_RlSpanSourceIndex_Type())
...
rlSpanSourceDirection=_RlSpanSourceDirection_Object((1,3,6,1,4,1,9,6,1,101,219,3,1,4),_RlSpanSourceDirection_Type())
...
rlSpanSourceRowStatus=_RlSpanSourceRowStatus_Object((1,3,6,1,4,1,9,6,1,101,219,3,1,5),_RlSpanSourceRowStatus_Type())
rlSpanSourceRowStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:rlSpanSourceRowStatus.setStatus(_A)
mibBuilder.exportSymbols(_C,**{'SpanDestinationPortType':SpanDestinationPortType,'SpanSourceType':SpanSourceType,'SpanSourceDirection':SpanSourceDirection,'SpanDestinationReflectorType':SpanDestinationReflectorType,'rlSpan':rlSpan,'rlSpanMibVersion':rlSpanMibVersion,'rlSpanDestinationTable':rlSpanDestinationTable,'rlSpanDestinationEntry':rlSpanDestinationEntry,_E:rlSpanDestinationSessionId,'rlSpanDestinationIfIndex':rlSpanDestinationIfIndex,'rlSpanDestinationIsReflector':rlSpanDestinationIsReflector,'rlSpanDestinationPortType':rlSpanDestinationPortType,'rlSpanDestinationRemoteVlanId':rlSpanDestinationRemoteVlanId,'rlSpanDestinationRowStatus':rlSpanDestinationRowStatus,'rlSpanSourceTable':rlSpanSourceTable,'rlSpanSourceEntry':rlSpanSourceEntry,_F:rlSpanSourceSessionId,_G:rlSpanSourceType,_H:rlSpanSourceIndex,'rlSpanSourceDirection':rlSpanSourceDirection,'rlSpanSourceRowStatus':rlSpanSourceRowStatus})