...
rlTraceRouteMibVersion=_RlTraceRouteMibVersion_Object((1,3,6,1,4,1,4526,17,81,1),_RlTraceRouteMibVersion_Type())
rlTraceRouteMibVersion.setMaxAccess('read-only')
if mibBuilder.loadTexts:rlTraceRouteMibVersion.setStatus('current')
mibBuilder.exportSymbols('NETGEAR-RADLAN-TRACEROUTE-MIB',**{'rlTraceRoute':rlTraceRoute,'rlTraceRouteMibVersion':rlTraceRouteMibVersion})