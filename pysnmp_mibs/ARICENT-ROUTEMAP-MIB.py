# SNMP MIB module (ARICENT-ROUTEMAP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-ROUTEMAP-MIB
...
fsRouteMapMatchEntry = _FsRouteMapMatchEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 155, 1, 2, 1)
)
fsRouteMapMatchEntry.setIndexNames(
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapName"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapSeqNum"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchInterface"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchIpAddress"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchIpAddrMask"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchIpNextHop"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchMetric"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchTag"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchRouteType"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchMetricType"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchASPathTag"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchCommunity"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchOrigin"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRouteMapMatchLocalPreference"),
)
if mibBuilder.loadTexts:
...
fsRMapMatchTable = _FsRMapMatchTable_Object(
    (1, 3, 6, 1, 4, 1, 2076, 155, 2, 2)
)
if mibBuilder.loadTexts:
    fsRMapMatchTable.setStatus("current")
_FsRMapMatchEntry_Object = MibTableRow
fsRMapMatchEntry = _FsRMapMatchEntry_Object(
    (1, 3, 6, 1, 4, 1, 2076, 155, 2, 2, 1)
)
fsRMapMatchEntry.setIndexNames(
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapName"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapSeqNum"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchDestInetType"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchDestInetAddress"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchDestInetPrefix"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchSourceInetType"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchSourceInetAddress"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchSourceInetPrefix"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchNextHopInetType"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchNextHopInetAddr"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchInterface"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchMetric"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchTag"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchMetricType"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchRouteType"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchASPathTag"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchCommunity"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchLocalPref"),
    (0, "ARICENT-ROUTEMAP-MIB", "fsRMapMatchOrigin"),
)
if mibBuilder.loadTexts:
...
fsRMapTrapMatch = NotificationType(
    (1, 3, 6, 1, 4, 1, 2076, 155, 4, 0, 1)
)
fsRMapTrapMatch.setObjects(
      *(("ARICENT-ROUTEMAP-MIB", "fsRMapTrapName"),
        ("ARICENT-ROUTEMAP-MIB", "fsRMapTrapSeqNum"))
)
if mibBuilder.loadTexts:
