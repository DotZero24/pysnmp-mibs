# SNMP MIB module (H3C-LI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-LI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:17:28 2025
...
h3cLIMediationEntry.setIndexNames(
    (0, "H3C-LI-MIB", "h3cLIMediationIndex"),
)
if mibBuilder.loadTexts:
...
_H3cLIMediationDscp_Type.__name__ = "Integer32"
...
_H3cLIMediationNotificationEnable_Type.__name__ = "TruthValue"
...
_H3cLIStreamEnable_Type.__name__ = "TruthValue"
...
_H3cLIIPStreamAddrType_Type.__name__ = "InetAddressType"
...
_H3cLIIPStreamDestAddr_Type.__name__ = "InetAddress"
...
_H3cLIIPStreamDestAddrLength_Type.__name__ = "InetAddressPrefixLength"
...
_H3cLIIPStreamSrcAddr_Type.__name__ = "InetAddress"
...
_H3cLIIPStreamSrcAddrLength_Type.__name__ = "InetAddressPrefixLength"
...
_H3cLIIPStreamDestL4PortMin_Type.__name__ = "InetPortNumber"
...
_H3cLIIPStreamDestL4PortMax_Type.__name__ = "InetPortNumber"
...
_H3cLIIPStreamSrcL4PortMin_Type.__name__ = "InetPortNumber"
...
_H3cLIIPStreamSrcL4PortMax_Type.__name__ = "InetPortNumber"
...
class _H3cLIIPStreamVRF_Type(SnmpAdminString):
    """Custom type h3cLIIPStreamVRF based on SnmpAdminString"""
    defaultValue = OctetString("")


_H3cLIIPStreamVRF_Type.__name__ = "SnmpAdminString"
...
h3cLITimeOut.setObjects(
    ("H3C-LI-MIB", "h3cLIMediationRowStatus")
)
if mibBuilder.loadTexts:
...
h3cLIFailureInformation.setObjects(
      *(("H3C-LI-MIB", "h3cLIStreamtype"),
        ("H3C-LI-MIB", "h3cLIBoardInformation"))
)
if mibBuilder.loadTexts:
