...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/arbor/PEAKFLOW-SP-MIB
...
spSmartAlertSettingName = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 86), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 64))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spSmartAlertSettingName.setStatus('current')
spSmartAlertThreshold = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 87), CounterBasedGauge64()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spSmartAlertThreshold.setStatus('current')
spSmartAlertObserved = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 88), CounterBasedGauge64()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spSmartAlertObserved.setStatus('current')
spImportance = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 89), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 64))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spImportance.setStatus('current')
spThresholdHC = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 90), CounterBasedGauge64()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spThresholdHC.setStatus('current')
spUsageHC = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 91), CounterBasedGauge64()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spUsageHC.setStatus('current')
spImpactBpsHC = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 92), CounterBasedGauge64()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spImpactBpsHC.setStatus('current')
spImpactPpsHC = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 93), CounterBasedGauge64()).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spImpactPpsHC.setStatus('current')
spMitOrchestrationSrcTMSGroup = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 94), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 64))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spMitOrchestrationSrcTMSGroup.setStatus('current')
spMitOrchestrationDestTMSGroup = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 95), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 64))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spMitOrchestrationDestTMSGroup.setStatus('current')
spSightlineSignalingClientName = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 96), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 128))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spSightlineSignalingClientName.setStatus('current')
spSightlineSignalingMessage = MibScalar((1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 97), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 1024))).setMaxAccess("accessiblefornotify")
if mibBuilder.loadTexts: spSightlineSignalingMessage.setStatus('current')
...
managedObjectUsage = NotificationType((1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 20)).setObjects(("PEAKFLOW-SP-MIB", "spAlertID"), ("PEAKFLOW-SP-MIB", "spManagedObject"), ("PEAKFLOW-SP-MIB", "spManagedObjectFamily"), ("PEAKFLOW-SP-MIB", "spUsageType"), ("PEAKFLOW-SP-MIB", "spThreshold"), ("PEAKFLOW-SP-MIB", "spUsage"), ("PEAKFLOW-SP-MIB", "spThresholdHC"), ("PEAKFLOW-SP-MIB", "spUsageHC"), ("PEAKFLOW-SP-MIB", "spUnit"))
...
fingerprintUsage = NotificationType((1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 40)).setObjects(("PEAKFLOW-SP-MIB", "spAlertID"), ("PEAKFLOW-SP-MIB", "spFingerprintName"), ("PEAKFLOW-SP-MIB", "spUsageType"), ("PEAKFLOW-SP-MIB", "spThreshold"), ("PEAKFLOW-SP-MIB", "spUsage"), ("PEAKFLOW-SP-MIB", "spThresholdHC"), ("PEAKFLOW-SP-MIB", "spUsageHC"), ("PEAKFLOW-SP-MIB", "spUnit"))
...
serviceUsage = NotificationType((1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 42)).setObjects(("PEAKFLOW-SP-MIB", "spAlertID"), ("PEAKFLOW-SP-MIB", "spServiceName"), ("PEAKFLOW-SP-MIB", "spUsageType"), ("PEAKFLOW-SP-MIB", "spApplicationName"), ("PEAKFLOW-SP-MIB", "spServiceElement"), ("PEAKFLOW-SP-MIB", "spThreshold"), ("PEAKFLOW-SP-MIB", "spUsage"), ("PEAKFLOW-SP-MIB", "spThresholdHC"), ("PEAKFLOW-SP-MIB", "spUsageHC"))
...
if mibBuilder.loadTexts: aifTemplatesUpdated.setStatus('current')
smartThresholdAlert = NotificationType((1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 59)).setObjects(("PEAKFLOW-SP-MIB", "spAlertID"), ("PEAKFLOW-SP-MIB", "spSmartAlertSettingName"), ("PEAKFLOW-SP-MIB", "spSmartAlertThreshold"), ("PEAKFLOW-SP-MIB", "spSmartAlertObserved"), ("PEAKFLOW-SP-MIB", "spUnit"), ("PEAKFLOW-SP-MIB", "spImportance"))
if mibBuilder.loadTexts: smartThresholdAlert.setStatus('current')
smartThresholdAlertDone = NotificationType((1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 60)).setObjects(("PEAKFLOW-SP-MIB", "spAlertID"), ("PEAKFLOW-SP-MIB", "spSmartAlertSettingName"), ("PEAKFLOW-SP-MIB", "spSmartAlertThreshold"), ("PEAKFLOW-SP-MIB", "spSmartAlertObserved"), ("PEAKFLOW-SP-MIB", "spUnit"), ("PEAKFLOW-SP-MIB", "spImportance"))
if mibBuilder.loadTexts: smartThresholdAlertDone.setStatus('current')
mitigationOrchestrationAlert = NotificationType((1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 61)).setObjects(("PEAKFLOW-SP-MIB", "spAlertID"), ("PEAKFLOW-SP-MIB", "spCollector"), ("PEAKFLOW-SP-MIB", "spMitigationName"), ("PEAKFLOW-SP-MIB", "spMitOrchestrationSrcTMSGroup"), ("PEAKFLOW-SP-MIB", "spMitOrchestrationDestTMSGroup"))
if mibBuilder.loadTexts: mitigationOrchestrationAlert.setStatus('current')
sightlineSignalingAlert = NotificationType((1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 62)).setObjects(("PEAKFLOW-SP-MIB", "spAlertID"), ("PEAKFLOW-SP-MIB", "spSightlineSignalingClientName"), ("PEAKFLOW-SP-MIB", "spManagedObjects"), ("PEAKFLOW-SP-MIB", "spAlertDetectionSignatures"), ("PEAKFLOW-SP-MIB", "spInetAddress"), ("PEAKFLOW-SP-MIB", "spInetAddressType"), ("PEAKFLOW-SP-MIB", "spSightlineSignalingMessage"))
if mibBuilder.loadTexts: sightlineSignalingAlert.setStatus('current')
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", fingerprintUsageDone=fingerprintUsageDone, reportDone=reportDone, spImportance=spImportance, spImpactPpsHC=spImpactPpsHC, spSightlineSignalingClientName=spSightlineSignalingClientName, spDetector=spDetector, spInterfaceUsage=spInterfaceUsage, spThresholdHC=spThresholdHC, spLicenseErrDescription=spLicenseErrDescription, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spScriptPort=spScriptPort, dnsBaseline=dnsBaseline, spHijackRoute=spHijackRoute, spFlowspecTimeout=spFlowspecTimeout, fingerprintUsage=fingerprintUsage, deviceHealth=deviceHealth, spInterfaceSpeed=spInterfaceSpeed, smartThresholdAlertDone=smartThresholdAlertDone, spFingerprintFeedback=spFingerprintFeedback, mitigationTMSStartV2=mitigationTMSStartV2, deviceSwapSpace=deviceSwapSpace, peakflowSPCMI=peakflowSPCMI, devicePhysicalMemory=devicePhysicalMemory, dnsBaselineDone=dnsBaselineDone, spBGPEvent=spBGPEvent, spScriptStart=spScriptStart, spTMSMultiPrefix=spTMSMultiPrefix, spInterfaceUsageHC=spInterfaceUsageHC, spcommFailureDone=spcommFailureDone, spImpactPps=spImpactPps, cloudSignalingFault=cloudSignalingFault, spMitigationStart=spMitigationStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, greDown=greDown, spInterfaceIndex=spInterfaceIndex, snmpUp=snmpUp, spScriptHost=spScriptHost, deviceDiskUsage=deviceDiskUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, collectorStart=collectorStart, spLicenseErrType=spLicenseErrType, spImpactBpsHC=spImpactBpsHC, deviceSystemErrorDone=deviceSystemErrorDone, bgpDown=bgpDown, spDNSObserved=spDNSObserved, spUsageHC=spUsageHC, smartThresholdAlert=smartThresholdAlert, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spSmartAlertThreshold=spSmartAlertThreshold, spReportURL=spReportURL, fingerprintReceive=fingerprintReceive, spMitigationName=spMitigationName, sightlineSignalingAlert=sightlineSignalingAlert, spBlackholeCommunity=spBlackholeCommunity, spBlackholeTimeout=spBlackholeTimeout, managedObjectUsage=managedObjectUsage, spPravail=spPravail, bgpHijack=bgpHijack, spHardwareFailureDescription=spHardwareFailureDescription, interfaceUsage=interfaceUsage, spAlertID=spAlertID, flowDown=flowDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spSystemErrorDescription=spSystemErrorDescription, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spGreTunnelDestination=spGreTunnelDestination, spLicenseErrCount=spLicenseErrCount, spDNSExpected=spDNSExpected, spAlertDetectionSignatures=spAlertDetectionSignatures, spCommFailureDescription=spCommFailureDescription, cloudSignalingFaultDone=cloudSignalingFaultDone, collectorUp=collectorUp, spFingerprintName=spFingerprintName, spFingerprintSender=spFingerprintSender, spThirdPartyAddr=spThirdPartyAddr, bgpInstabilityDone=bgpInstabilityDone, spTMSCommunity=spTMSCommunity, spServiceName=spServiceName, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spSmartAlertSettingName=spSmartAlertSettingName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spDNSObservedMean=spDNSObservedMean, spCollector=spCollector, spInetAddress=spInetAddress, spUsername=spUsername, spManagedObjectFamily=spManagedObjectFamily, configChange=configChange, mitigationOrchestrationAlert=mitigationOrchestrationAlert, managedObjectUsageDone=managedObjectUsageDone, spDNSName=spDNSName, dosHostDetectionAlertDone=dosHostDetectionAlertDone, fingerprintFeedback=fingerprintFeedback, mitigationDone=mitigationDone, spDNSObservedMax=spDNSObservedMax, spSightlineSignalingMessage=spSightlineSignalingMessage, mitigationFlowspecStart=mitigationFlowspecStart, spUsageType=spUsageType, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, flowUp=flowUp, interfaceUsageDone=interfaceUsageDone, licenseErrorDone=licenseErrorDone, greDownDone=greDownDone, alertScript=alertScript, spBGPTrapEvent=spBGPTrapEvent, spFingerprintMessage=spFingerprintMessage, spManagedObjects=spManagedObjects, spInetAddressType=spInetAddressType, spMitOrchestrationSrcTMSGroup=spMitOrchestrationSrcTMSGroup, notificationLimit=notificationLimit, spLicenseErrLimit=spLicenseErrLimit, spVersion=spVersion, spInterface=spInterface, spHijackAttr=spHijackAttr, spDuration=spDuration, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spScriptCommand=spScriptCommand, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceSystemError=deviceSystemError, serviceUsageDone=serviceUsageDone, spBGPTrapPrefix=spBGPTrapPrefix, spDetectedCountries=spDetectedCountries, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spUsage=spUsage, dosHostDetectionAlert=dosHostDetectionAlert, bgpTrap=bgpTrap, spApplicationName=spApplicationName, spRouter=spRouter, licenseError=licenseError, peakflowSPTraps=peakflowSPTraps, spManagedObject=spManagedObject, spUnit=spUnit, spMitOrchestrationDestTMSGroup=spMitOrchestrationDestTMSGroup, spHijackLocal=spHijackLocal, bgpUp=bgpUp, spMitigationID=spMitigationID, snmpDown=snmpDown, mitigationTMSStart=mitigationTMSStart, routingFailover=routingFailover, deviceTotalFlowsHC=deviceTotalFlowsHC, hardwareFailureDone=hardwareFailureDone, spImpactBps=spImpactBps, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPInstability=spBGPInstability, spSystemErrorType=spSystemErrorType, spFlowspecCommunity=spFlowspecCommunity, spSmartAlertObserved=spSmartAlertObserved, autoclassifyStart=autoclassifyStart, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, aifTemplatesUpdated=aifTemplatesUpdated, spBGPTrapName=spBGPTrapName, spReportName=spReportName, spTMSTimeout=spTMSTimeout, trafficAutoMitigation=trafficAutoMitigation, serviceUsage=serviceUsage, spcommFailure=spcommFailure, spThirdPartyZone=spThirdPartyZone, spBlackholePrefix=spBlackholePrefix, spTMSPrefix=spTMSPrefix, spReportID=spReportID, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBlackholeNexthop=spBlackholeNexthop, peakflowSPMIB=peakflowSPMIB, spInterfaceSpeedHC=spInterfaceSpeedHC, PYSNMP_MODULE_ID=peakflowSPMIB, spThreshold=spThreshold, spServiceElement=spServiceElement, hardwareFailure=hardwareFailure, bgpInstability=bgpInstability, spGreTunnelName=spGreTunnelName, peakflowSPMgr=peakflowSPMgr, spCommFailureDestination=spCommFailureDestination, collectorDown=collectorDown, mitigationBlackholeStart=mitigationBlackholeStart, deviceTotalFlows=deviceTotalFlows, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationThirdPartyStart=mitigationThirdPartyStart)
