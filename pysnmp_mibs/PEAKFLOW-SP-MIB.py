...
# Notes
# -----
# ASN.1 source file://mibs/arbor/PEAKFLOW-SP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:47 2025
...
class _SpSmartAlertSettingName_Type(DisplayString):
    """Custom type spSmartAlertSettingName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 64),
    )
...
_SpSmartAlertSettingName_Type.__name__ = "DisplayString"
_SpSmartAlertSettingName_Object = MibScalar
spSmartAlertSettingName = _SpSmartAlertSettingName_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 86),
    _SpSmartAlertSettingName_Type()
)
spSmartAlertSettingName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spSmartAlertSettingName.setStatus("current")
_SpSmartAlertThreshold_Type = CounterBasedGauge64
_SpSmartAlertThreshold_Object = MibScalar
spSmartAlertThreshold = _SpSmartAlertThreshold_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 87),
    _SpSmartAlertThreshold_Type()
)
spSmartAlertThreshold.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spSmartAlertThreshold.setStatus("current")
_SpSmartAlertObserved_Type = CounterBasedGauge64
_SpSmartAlertObserved_Object = MibScalar
spSmartAlertObserved = _SpSmartAlertObserved_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 88),
    _SpSmartAlertObserved_Type()
)
spSmartAlertObserved.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spSmartAlertObserved.setStatus("current")


class _SpImportance_Type(DisplayString):
    """Custom type spImportance based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 64),
    )
...
_SpImportance_Type.__name__ = "DisplayString"
_SpImportance_Object = MibScalar
spImportance = _SpImportance_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 89),
    _SpImportance_Type()
)
spImportance.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spImportance.setStatus("current")
_SpThresholdHC_Type = CounterBasedGauge64
_SpThresholdHC_Object = MibScalar
spThresholdHC = _SpThresholdHC_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 90),
    _SpThresholdHC_Type()
)
spThresholdHC.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spThresholdHC.setStatus("current")
_SpUsageHC_Type = CounterBasedGauge64
_SpUsageHC_Object = MibScalar
spUsageHC = _SpUsageHC_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 91),
    _SpUsageHC_Type()
)
spUsageHC.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spUsageHC.setStatus("current")
_SpImpactBpsHC_Type = CounterBasedGauge64
_SpImpactBpsHC_Object = MibScalar
spImpactBpsHC = _SpImpactBpsHC_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 92),
    _SpImpactBpsHC_Type()
)
spImpactBpsHC.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spImpactBpsHC.setStatus("current")
_SpImpactPpsHC_Type = CounterBasedGauge64
_SpImpactPpsHC_Object = MibScalar
spImpactPpsHC = _SpImpactPpsHC_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 93),
    _SpImpactPpsHC_Type()
)
spImpactPpsHC.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spImpactPpsHC.setStatus("current")


class _SpMitOrchestrationSrcTMSGroup_Type(DisplayString):
    """Custom type spMitOrchestrationSrcTMSGroup based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 64),
    )
...
_SpMitOrchestrationSrcTMSGroup_Type.__name__ = "DisplayString"
_SpMitOrchestrationSrcTMSGroup_Object = MibScalar
spMitOrchestrationSrcTMSGroup = _SpMitOrchestrationSrcTMSGroup_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 94),
    _SpMitOrchestrationSrcTMSGroup_Type()
)
spMitOrchestrationSrcTMSGroup.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spMitOrchestrationSrcTMSGroup.setStatus("current")


class _SpMitOrchestrationDestTMSGroup_Type(DisplayString):
    """Custom type spMitOrchestrationDestTMSGroup based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 64),
    )
...
_SpMitOrchestrationDestTMSGroup_Type.__name__ = "DisplayString"
_SpMitOrchestrationDestTMSGroup_Object = MibScalar
spMitOrchestrationDestTMSGroup = _SpMitOrchestrationDestTMSGroup_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 95),
    _SpMitOrchestrationDestTMSGroup_Type()
)
spMitOrchestrationDestTMSGroup.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spMitOrchestrationDestTMSGroup.setStatus("current")


class _SpSightlineSignalingClientName_Type(DisplayString):
    """Custom type spSightlineSignalingClientName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 128),
    )
...
_SpSightlineSignalingClientName_Type.__name__ = "DisplayString"
_SpSightlineSignalingClientName_Object = MibScalar
spSightlineSignalingClientName = _SpSightlineSignalingClientName_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 96),
    _SpSightlineSignalingClientName_Type()
)
spSightlineSignalingClientName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spSightlineSignalingClientName.setStatus("current")


class _SpSightlineSignalingMessage_Type(DisplayString):
    """Custom type spSightlineSignalingMessage based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 1024),
    )
...
_SpSightlineSignalingMessage_Type.__name__ = "DisplayString"
_SpSightlineSignalingMessage_Object = MibScalar
spSightlineSignalingMessage = _SpSightlineSignalingMessage_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 97),
    _SpSightlineSignalingMessage_Type()
)
spSightlineSignalingMessage.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spSightlineSignalingMessage.setStatus("current")
...
managedObjectUsage.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertID"),
        ...
        ("PEAKFLOW-SP-MIB", "spThresholdHC"),
        ("PEAKFLOW-SP-MIB", "spUsageHC"),
...
dosNetworkProfiledAlert.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertID"),
        ...
        ("PEAKFLOW-SP-MIB", "spImpactBpsHC"),
        ("PEAKFLOW-SP-MIB", "spImpactPpsHC"),
        ("PEAKFLOW-SP-MIB", "spManagedObject"),
...
aifTemplatesUpdated = NotificationType(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 58)
)
if mibBuilder.loadTexts:
    aifTemplatesUpdated.setStatus(
        "current"
    )

smartThresholdAlert = NotificationType(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 59)
)
smartThresholdAlert.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertID"),
        ("PEAKFLOW-SP-MIB", "spSmartAlertSettingName"),
        ("PEAKFLOW-SP-MIB", "spSmartAlertThreshold"),
        ("PEAKFLOW-SP-MIB", "spSmartAlertObserved"),
        ("PEAKFLOW-SP-MIB", "spUnit"),
        ("PEAKFLOW-SP-MIB", "spImportance"))
)
if mibBuilder.loadTexts:
    smartThresholdAlert.setStatus(
        "current"
    )

smartThresholdAlertDone = NotificationType(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 60)
)
smartThresholdAlertDone.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertID"),
        ("PEAKFLOW-SP-MIB", "spSmartAlertSettingName"),
        ("PEAKFLOW-SP-MIB", "spSmartAlertThreshold"),
        ("PEAKFLOW-SP-MIB", "spSmartAlertObserved"),
...
if mibBuilder.loadTexts:
    smartThresholdAlertDone.setStatus(
        "current"
    )

mitigationOrchestrationAlert = NotificationType(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 61)
)
mitigationOrchestrationAlert.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertID"),
        ("PEAKFLOW-SP-MIB", "spCollector"),
        ("PEAKFLOW-SP-MIB", "spMitigationName"),
        ("PEAKFLOW-SP-MIB", "spMitOrchestrationSrcTMSGroup"),
        ("PEAKFLOW-SP-MIB", "spMitOrchestrationDestTMSGroup"))
)
if mibBuilder.loadTexts:
    mitigationOrchestrationAlert.setStatus(
        "current"
    )

sightlineSignalingAlert = NotificationType(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 62)
)
sightlineSignalingAlert.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertID"),
        ("PEAKFLOW-SP-MIB", "spSightlineSignalingClientName"),
        ("PEAKFLOW-SP-MIB", "spManagedObjects"),
        ("PEAKFLOW-SP-MIB", "spAlertDetectionSignatures"),
        ("PEAKFLOW-SP-MIB", "spInetAddress"),
        ("PEAKFLOW-SP-MIB", "spInetAddressType"),
        ("PEAKFLOW-SP-MIB", "spSightlineSignalingMessage"))
)
if mibBuilder.loadTexts:
    sightlineSignalingAlert.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"peakflowSPMIB": peakflowSPMIB,
       ...
       "spSmartAlertSettingName": spSmartAlertSettingName,
       "spSmartAlertThreshold": spSmartAlertThreshold,
       "spSmartAlertObserved": spSmartAlertObserved,
       "spImportance": spImportance,
       "spThresholdHC": spThresholdHC,
       "spUsageHC": spUsageHC,
       "spImpactBpsHC": spImpactBpsHC,
       "spImpactPpsHC": spImpactPpsHC,
       "spMitOrchestrationSrcTMSGroup": spMitOrchestrationSrcTMSGroup,
       "spMitOrchestrationDestTMSGroup": spMitOrchestrationDestTMSGroup,
       "spSightlineSignalingClientName": spSightlineSignalingClientName,
       "spSightlineSignalingMessage": spSightlineSignalingMessage,
       ...
       "aifTemplatesUpdated": aifTemplatesUpdated,
       "smartThresholdAlert": smartThresholdAlert,
       "smartThresholdAlertDone": smartThresholdAlertDone,
       "mitigationOrchestrationAlert": mitigationOrchestrationAlert,
       "sightlineSignalingAlert": sightlineSignalingAlert}
)
