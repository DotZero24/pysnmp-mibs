...
mibBuilder.exportSymbols("CISCO-SYSLOG-MIB", clogHistMsgText=clogHistMsgText, clogHistTimestamp=clogHistTimestamp, PYSNMP_MODULE_ID=ciscoSyslogMIB, ciscoSyslogMIBConformance=ciscoSyslogMIBConformance, clogNotificationsGroup=clogNotificationsGroup, clogHistoryEntry=clogHistoryEntry, ciscoSyslogMIB=ciscoSyslogMIB, clogMaxServers=clogMaxServers, clogMaxSeverity=clogMaxSeverity, clogMsgIgnores=clogMsgIgnores, clogHistSeverity=clogHistSeverity, clogHistIndex=clogHistIndex, clogServerGroup=clogServerGroup, clogServer=clogServer, clogHistFacility=clogHistFacility, ciscoSyslogMIBObjects=ciscoSyslogMIBObjects, clogHistoryTable=clogHistoryTable, clogOriginID=clogOriginID, clogHistory=clogHistory, clogOriginIDType=clogOriginIDType, clogHistMsgsFlushed=clogHistMsgsFlushed, clogMessageGenerated=clogMessageGenerated, ciscoSyslogMIBNotifications=ciscoSyslogMIBNotifications, ciscoSyslogMIBCompliance=ciscoSyslogMIBCompliance, clogNotificationsEnabled=clogNotificationsEnabled, ciscoSyslogMIBGroup=ciscoSyslogMIBGroup, clogMsgDrops=clogMsgDrops, clogServerAddr=clogServerAddr, ciscoSyslogMIBCompliances=ciscoSyslogMIBCompliances, clogServerStatus=clogServerStatus, ciscoSyslogMIBGroups=ciscoSyslogMIBGroups, SyslogSeverity=SyslogSeverity, clogBasic=clogBasic, ciscoSyslogMIBNotificationPrefix=ciscoSyslogMIBNotificationPrefix, clogOriginIDGroup=clogOriginIDGroup, clogHistTableMaxLength=clogHistTableMaxLength, clogServerConfigEntry=clogServerConfigEntry, ciscoSyslogMIBComplianceRev1=ciscoSyslogMIBComplianceRev1, clogServerConfigTable=clogServerConfigTable, clogHistMsgName=clogHistMsgName, clogServerAddrType=clogServerAddrType, clogNotificationsSent=clogNotificationsSent)
