...
if mibBuilder.loadTexts:console.setRevisions(('2019-01-29 16:00',))
...
portEntry.setIndexNames((0,_C,_I))
...
_PortBufferThreshold_Type.__name__=_F
...
portBufferThreshold.setMaxAccess(_B)
...
plugEntry.setIndexNames((0,_C,_J))
...
plugGroupEntry.setIndexNames((0,_C,_K))
...
userEntry.setIndexNames((0,_C,_L))
...
userPlugAccess.setMaxAccess(_E)
...
_UserOutboundTelAccess_Type.__name__=_F
...
userOutboundTelAccess.setMaxAccess(_E)
...
userCurrentPowerMetering=_UserCurrentPowerMetering_Object((1,3,6,1,4,1,2634,1,100,400,1,15),_UserCurrentPowerMetering_Type())
...
userCallbackNum1=_UserCallbackNum1_Object((1,3,6,1,4,1,2634,1,100,400,1,16),_UserCallbackNum1_Type())
...
userCallbackNum2=_UserCallbackNum2_Object((1,3,6,1,4,1,2634,1,100,400,1,17),_UserCallbackNum2_Type())
...
userCallbackNum3=_UserCallbackNum3_Object((1,3,6,1,4,1,2634,1,100,400,1,18),_UserCallbackNum3_Type())
...
userCallbackNum4=_UserCallbackNum4_Object((1,3,6,1,4,1,2634,1,100,400,1,19),_UserCallbackNum4_Type())
...
userCallbackNum5=_UserCallbackNum5_Object((1,3,6,1,4,1,2634,1,100,400,1,20),_UserCallbackNum5_Type())
...
environmentUnitEntry.setIndexNames((0,_C,_M))
...
environmentUnitCurrentA=_EnvironmentUnitCurrentA_Object((1,3,6,1,4,1,2634,1,200,10,1,4),_EnvironmentUnitCurrentA_Type())
...
environmentUnitVoltageA=_EnvironmentUnitVoltageA_Object((1,3,6,1,4,1,2634,1,200,10,1,5),_EnvironmentUnitVoltageA_Type())
...
environmentUnitPowerA=_EnvironmentUnitPowerA_Object((1,3,6,1,4,1,2634,1,200,10,1,6),_EnvironmentUnitPowerA_Type())
...
environmentUnitCurrentB=_EnvironmentUnitCurrentB_Object((1,3,6,1,4,1,2634,1,200,10,1,7),_EnvironmentUnitCurrentB_Type())
...
environmentUnitVoltageB=_EnvironmentUnitVoltageB_Object((1,3,6,1,4,1,2634,1,200,10,1,8),_EnvironmentUnitVoltageB_Type())
...
environmentUnitPowerB=_EnvironmentUnitPowerB_Object((1,3,6,1,4,1,2634,1,200,10,1,9),_EnvironmentUnitPowerB_Type())
...
environmentUnitCurrentC=_EnvironmentUnitCurrentC_Object((1,3,6,1,4,1,2634,1,200,10,1,10),_EnvironmentUnitCurrentC_Type())
...
environmentUnitVoltageC=_EnvironmentUnitVoltageC_Object((1,3,6,1,4,1,2634,1,200,10,1,11),_EnvironmentUnitVoltageC_Type())
...
environmentUnitPowerC=_EnvironmentUnitPowerC_Object((1,3,6,1,4,1,2634,1,200,10,1,12),_EnvironmentUnitPowerC_Type())
...
environmentUnitCurrentD=_EnvironmentUnitCurrentD_Object((1,3,6,1,4,1,2634,1,200,10,1,13),_EnvironmentUnitCurrentD_Type())
...
environmentUnitVoltageD=_EnvironmentUnitVoltageD_Object((1,3,6,1,4,1,2634,1,200,10,1,14),_EnvironmentUnitVoltageD_Type())
...
environmentUnitPowerD=_EnvironmentUnitPowerD_Object((1,3,6,1,4,1,2634,1,200,10,1,15),_EnvironmentUnitPowerD_Type())
...
environmentInputPower1=_EnvironmentInputPower1_Object((1,3,6,1,4,1,2634,1,200,10,1,22),_EnvironmentInputPower1_Type())
...
environmentInputPower2=_EnvironmentInputPower2_Object((1,3,6,1,4,1,2634,1,200,10,1,23),_EnvironmentInputPower2_Type())
...
environmentInputPower3=_EnvironmentInputPower3_Object((1,3,6,1,4,1,2634,1,200,10,1,24),_EnvironmentInputPower3_Type())
...
environmentInputPower4=_EnvironmentInputPower4_Object((1,3,6,1,4,1,2634,1,200,10,1,25),_EnvironmentInputPower4_Type())
...
environmentModemPhoneNumber=_EnvironmentModemPhoneNumber_Object((1,3,6,1,4,1,2634,1,200,10,1,26),_EnvironmentModemPhoneNumber_Type())
...
environmentSerialNumber=_EnvironmentSerialNumber_Object((1,3,6,1,4,1,2634,1,200,10,1,27),_EnvironmentSerialNumber_Type())
...
environmentSoftwareVersion=_EnvironmentSoftwareVersion_Object((1,3,6,1,4,1,2634,1,200,10,1,28),_EnvironmentSoftwareVersion_Type())
...
environmentSystemTotalCurrent=_EnvironmentSystemTotalCurrent_Object((1,3,6,1,4,1,2634,1,200,60),_EnvironmentSystemTotalCurrent_Type())
...
environmentSystemTotalPower=_EnvironmentSystemTotalPower_Object((1,3,6,1,4,1,2634,1,200,70),_EnvironmentSystemTotalPower_Type())
...
environmentMonthlyPowerLog=_EnvironmentMonthlyPowerLog_Object((1,3,6,1,4,1,2634,1,200,80),_EnvironmentMonthlyPowerLog_Type())
...
alarmLostVoltage=_AlarmLostVoltage_Object((1,3,6,1,4,1,2634,1,280,7),_AlarmLostVoltage_Type())
...
alarmBufferThreshold.setMaxAccess(_B)
...
alarmWakeupOnFailure=_AlarmWakeupOnFailure_Object((1,3,6,1,4,1,2634,1,280,17),_AlarmWakeupOnFailure_Type())
...
alarmIpPassthroughDataUsage=_AlarmIpPassthroughDataUsage_Object((1,3,6,1,4,1,2634,1,280,18),_AlarmIpPassthroughDataUsage_Type())
...
alarmBufferFiltering=_AlarmBufferFiltering_Object((1,3,6,1,4,1,2634,1,280,19),_AlarmBufferFiltering_Type())
...
lostVoltageTraps=_LostVoltageTraps_ObjectIdentity((1,3,6,1,4,1,2634,1,300,10))
...
wakeupOnFailureTraps=_WakeupOnFailureTraps_ObjectIdentity((1,3,6,1,4,1,2634,1,300,19))
_IpPassthroughDataUsageTraps_ObjectIdentity=ObjectIdentity
ipPassthroughDataUsageTraps=_IpPassthroughDataUsageTraps_ObjectIdentity((1,3,6,1,4,1,2634,1,300,20))
_BufferFilteringTraps_ObjectIdentity=ObjectIdentity
bufferFilteringTraps=_BufferFilteringTraps_ObjectIdentity((1,3,6,1,4,1,2634,1,300,21))
...
bufferThresholdCrossedSetTrap.setObjects((_C,_D))
...
bufferThresholdCrossedClearTrap.setObjects((_C,_D))
...
lostVoltageSetTrap=NotificationType((1,3,6,1,4,1,2634,1,300,10,0,1))
lostVoltageSetTrap.setObjects((_C,_D))
if mibBuilder.loadTexts:lostVoltageSetTrap.setStatus('')
lostVoltageClearTrap=NotificationType((1,3,6,1,4,1,2634,1,300,10,0,2))
