...
fsMIRtm6Scalar=_FsMIRtm6Scalar_ObjectIdentity((1,3,6,1,4,1,29601,2,32,1))
_FsMIRtm6GlobalTrace_Type=Unsigned32
_FsMIRtm6GlobalTrace_Object=MibScalar
fsMIRtm6GlobalTrace=_FsMIRtm6GlobalTrace_Object((1,3,6,1,4,1,29601,2,32,1,1),_FsMIRtm6GlobalTrace_Type())
...
fsMIRtm6ThrotLimit=_FsMIRtm6ThrotLimit_Object((1,3,6,1,4,1,29601,2,32,1,2),_FsMIRtm6ThrotLimit_Type())
fsMIRtm6ThrotLimit.setMaxAccess(_B)
if mibBuilder.loadTexts:fsMIRtm6ThrotLimit.setStatus(_A)
_FsMIRtm6MaximumBgpRoutes_Type=Unsigned32
_FsMIRtm6MaximumBgpRoutes_Object=MibScalar
fsMIRtm6MaximumBgpRoutes=_FsMIRtm6MaximumBgpRoutes_Object((1,3,6,1,4,1,29601,2,32,1,3),_FsMIRtm6MaximumBgpRoutes_Type())
fsMIRtm6MaximumBgpRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsMIRtm6MaximumBgpRoutes.setStatus(_A)
_FsMIRtm6MaximumOspfRoutes_Type=Unsigned32
_FsMIRtm6MaximumOspfRoutes_Object=MibScalar
fsMIRtm6MaximumOspfRoutes=_FsMIRtm6MaximumOspfRoutes_Object((1,3,6,1,4,1,29601,2,32,1,4),_FsMIRtm6MaximumOspfRoutes_Type())
fsMIRtm6MaximumOspfRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsMIRtm6MaximumOspfRoutes.setStatus(_A)
_FsMIRtm6MaximumRipRoutes_Type=Unsigned32
_FsMIRtm6MaximumRipRoutes_Object=MibScalar
fsMIRtm6MaximumRipRoutes=_FsMIRtm6MaximumRipRoutes_Object((1,3,6,1,4,1,29601,2,32,1,5),_FsMIRtm6MaximumRipRoutes_Type())
fsMIRtm6MaximumRipRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsMIRtm6MaximumRipRoutes.setStatus(_A)
_FsMIRtm6MaximumStaticRoutes_Type=Unsigned32
_FsMIRtm6MaximumStaticRoutes_Object=MibScalar
fsMIRtm6MaximumStaticRoutes=_FsMIRtm6MaximumStaticRoutes_Object((1,3,6,1,4,1,29601,2,32,1,6),_FsMIRtm6MaximumStaticRoutes_Type())
fsMIRtm6MaximumStaticRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsMIRtm6MaximumStaticRoutes.setStatus(_A)
_FsMIRtm6MaximumISISRoutes_Type=Unsigned32
_FsMIRtm6MaximumISISRoutes_Object=MibScalar
fsMIRtm6MaximumISISRoutes=_FsMIRtm6MaximumISISRoutes_Object((1,3,6,1,4,1,29601,2,32,1,7),_FsMIRtm6MaximumISISRoutes_Type())
fsMIRtm6MaximumISISRoutes.setMaxAccess(_B)
if mibBuilder.loadTexts:fsMIRtm6MaximumISISRoutes.setStatus(_A)
_FsMIRtm6Table_Object=MibTable
fsMIRtm6Table=_FsMIRtm6Table_Object((1,3,6,1,4,1,29601,2,32,2))
if mibBuilder.loadTexts:fsMIRtm6Table.setStatus(_A)
_FsMIRtm6Entry_Object=MibTableRow
fsMIRtm6Entry=_FsMIRtm6Entry_Object((1,3,6,1,4,1,29601,2,32,2,1))
...
fsMIRtm6ContextId=_FsMIRtm6ContextId_Object((1,3,6,1,4,1,29601,2,32,2,1,1),_FsMIRtm6ContextId_Type())
...
fsMIRrd6RouterId=_FsMIRrd6RouterId_Object((1,3,6,1,4,1,29601,2,32,2,1,2),_FsMIRrd6RouterId_Type())
...
fsMIRrd6FilterByOspfTag=_FsMIRrd6FilterByOspfTag_Object((1,3,6,1,4,1,29601,2,32,2,1,3),_FsMIRrd6FilterByOspfTag_Type())
...
fsMIRrd6FilterOspfTag=_FsMIRrd6FilterOspfTag_Object((1,3,6,1,4,1,29601,2,32,2,1,4),_FsMIRrd6FilterOspfTag_Type())
...
fsMIRrd6FilterOspfTagMask=_FsMIRrd6FilterOspfTagMask_Object((1,3,6,1,4,1,29601,2,32,2,1,5),_FsMIRrd6FilterOspfTagMask_Type())
...
fsMIRrd6RouterASNumber=_FsMIRrd6RouterASNumber_Object((1,3,6,1,4,1,29601,2,32,2,1,6),_FsMIRrd6RouterASNumber_Type())
...
fsMIRrd6AdminStatus=_FsMIRrd6AdminStatus_Object((1,3,6,1,4,1,29601,2,32,2,1,7),_FsMIRrd6AdminStatus_Type())
...
fsMIRrd6Trace=_FsMIRrd6Trace_Object((1,3,6,1,4,1,29601,2,32,2,1,8),_FsMIRrd6Trace_Type())
fsMIRrd6Trace.setMaxAccess(_B)
if mibBuilder.loadTexts:fsMIRrd6Trace.setStatus(_A)
class _FsMIRtm6StaticRouteDistance_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,255))
_FsMIRtm6StaticRouteDistance_Type.__name__=_C
_FsMIRtm6StaticRouteDistance_Object=MibTableColumn
fsMIRtm6StaticRouteDistance=_FsMIRtm6StaticRouteDistance_Object((1,3,6,1,4,1,29601,2,32,2,1,9),_FsMIRtm6StaticRouteDistance_Type())
fsMIRtm6StaticRouteDistance.setMaxAccess(_B)
if mibBuilder.loadTexts:fsMIRtm6StaticRouteDistance.setStatus(_A)
_FsMIRrd6ControlTable_Object=MibTable
fsMIRrd6ControlTable=_FsMIRrd6ControlTable_Object((1,3,6,1,4,1,29601,2,32,3))
if mibBuilder.loadTexts:fsMIRrd6ControlTable.setStatus(_A)
_FsMIRrd6ControlEntry_Object=MibTableRow
fsMIRrd6ControlEntry=_FsMIRrd6ControlEntry_Object((1,3,6,1,4,1,29601,2,32,3,1))
...
fsMIRrd6ControlDestIpAddress=_FsMIRrd6ControlDestIpAddress_Object((1,3,6,1,4,1,29601,2,32,3,1,1),_FsMIRrd6ControlDestIpAddress_Type())
...
fsMIRrd6ControlNetMaskLen=_FsMIRrd6ControlNetMaskLen_Object((1,3,6,1,4,1,29601,2,32,3,1,2),_FsMIRrd6ControlNetMaskLen_Type())
...
fsMIRrd6ControlSourceProto=_FsMIRrd6ControlSourceProto_Object((1,3,6,1,4,1,29601,2,32,3,1,3),_FsMIRrd6ControlSourceProto_Type())
...
fsMIRrd6ControlDestProto=_FsMIRrd6ControlDestProto_Object((1,3,6,1,4,1,29601,2,32,3,1,4),_FsMIRrd6ControlDestProto_Type())
...
fsMIRrd6ControlRouteExportFlag=_FsMIRrd6ControlRouteExportFlag_Object((1,3,6,1,4,1,29601,2,32,3,1,5),_FsMIRrd6ControlRouteExportFlag_Type())
...
fsMIRrd6ControlRowStatus=_FsMIRrd6ControlRowStatus_Object((1,3,6,1,4,1,29601,2,32,3,1,6),_FsMIRrd6ControlRowStatus_Type())
...
fsMIRrd6RoutingProtoTable=_FsMIRrd6RoutingProtoTable_Object((1,3,6,1,4,1,29601,2,32,4))
if mibBuilder.loadTexts:fsMIRrd6RoutingProtoTable.setStatus(_A)
_FsMIRrd6RoutingProtoEntry_Object=MibTableRow
fsMIRrd6RoutingProtoEntry=_FsMIRrd6RoutingProtoEntry_Object((1,3,6,1,4,1,29601,2,32,4,1))
...
fsMIRrd6RoutingProtoId=_FsMIRrd6RoutingProtoId_Object((1,3,6,1,4,1,29601,2,32,4,1,1),_FsMIRrd6RoutingProtoId_Type())
...
fsMIRrd6RoutingRegnId=_FsMIRrd6RoutingRegnId_Object((1,3,6,1,4,1,29601,2,32,4,1,2),_FsMIRrd6RoutingRegnId_Type())
...
fsMIRrd6RoutingProtoTaskIdent=_FsMIRrd6RoutingProtoTaskIdent_Object((1,3,6,1,4,1,29601,2,32,4,1,3),_FsMIRrd6RoutingProtoTaskIdent_Type())
...
fsMIRrd6RoutingProtoQueueIdent=_FsMIRrd6RoutingProtoQueueIdent_Object((1,3,6,1,4,1,29601,2,32,4,1,4),_FsMIRrd6RoutingProtoQueueIdent_Type())
...
fsMIRrd6AllowOspfAreaRoutes=_FsMIRrd6AllowOspfAreaRoutes_Object((1,3,6,1,4,1,29601,2,32,4,1,5),_FsMIRrd6AllowOspfAreaRoutes_Type())
...
fsMIRrd6AllowOspfExtRoutes=_FsMIRrd6AllowOspfExtRoutes_Object((1,3,6,1,4,1,29601,2,32,4,1,6),_FsMIRrd6AllowOspfExtRoutes_Type())
...
fsMIRtm6RedTest=_FsMIRtm6RedTest_ObjectIdentity((1,3,6,1,4,1,29601,2,32,5))
_FsMIRtm6RedEntryTime_Type=Integer32
_FsMIRtm6RedEntryTime_Object=MibScalar
fsMIRtm6RedEntryTime=_FsMIRtm6RedEntryTime_Object((1,3,6,1,4,1,29601,2,32,5,1),_FsMIRtm6RedEntryTime_Type())
...
fsMIRtm6RedExitTime=_FsMIRtm6RedExitTime_Object((1,3,6,1,4,1,29601,2,32,5,2),_FsMIRtm6RedExitTime_Type())
fsMIRtm6RedExitTime.setMaxAccess(_E)
if mibBuilder.loadTexts:fsMIRtm6RedExitTime.setStatus(_A)
mibBuilder.exportSymbols(_D,**{'fsMIRtm6':fsMIRtm6,'fsMIRtm6Scalar':fsMIRtm6Scalar,'fsMIRtm6GlobalTrace':fsMIRtm6GlobalTrace,'fsMIRtm6ThrotLimit':fsMIRtm6ThrotLimit,'fsMIRtm6MaximumBgpRoutes':fsMIRtm6MaximumBgpRoutes,'fsMIRtm6MaximumOspfRoutes':fsMIRtm6MaximumOspfRoutes,'fsMIRtm6MaximumRipRoutes':fsMIRtm6MaximumRipRoutes,'fsMIRtm6MaximumStaticRoutes':fsMIRtm6MaximumStaticRoutes,'fsMIRtm6MaximumISISRoutes':fsMIRtm6MaximumISISRoutes,'fsMIRtm6Table':fsMIRtm6Table,'fsMIRtm6Entry':fsMIRtm6Entry,_F:fsMIRtm6ContextId,'fsMIRrd6RouterId':fsMIRrd6RouterId,'fsMIRrd6FilterByOspfTag':fsMIRrd6FilterByOspfTag,'fsMIRrd6FilterOspfTag':fsMIRrd6FilterOspfTag,'fsMIRrd6FilterOspfTagMask':fsMIRrd6FilterOspfTagMask,'fsMIRrd6RouterASNumber':fsMIRrd6RouterASNumber,'fsMIRrd6AdminStatus':fsMIRrd6AdminStatus,'fsMIRrd6Trace':fsMIRrd6Trace,'fsMIRtm6StaticRouteDistance':fsMIRtm6StaticRouteDistance,'fsMIRrd6ControlTable':fsMIRrd6ControlTable,'fsMIRrd6ControlEntry':fsMIRrd6ControlEntry,_L:fsMIRrd6ControlDestIpAddress,_M:fsMIRrd6ControlNetMaskLen,'fsMIRrd6ControlSourceProto':fsMIRrd6ControlSourceProto,'fsMIRrd6ControlDestProto':fsMIRrd6ControlDestProto,'fsMIRrd6ControlRouteExportFlag':fsMIRrd6ControlRouteExportFlag,'fsMIRrd6ControlRowStatus':fsMIRrd6ControlRowStatus,'fsMIRrd6RoutingProtoTable':fsMIRrd6RoutingProtoTable,'fsMIRrd6RoutingProtoEntry':fsMIRrd6RoutingProtoEntry,_O:fsMIRrd6RoutingProtoId,'fsMIRrd6RoutingRegnId':fsMIRrd6RoutingRegnId,'fsMIRrd6RoutingProtoTaskIdent':fsMIRrd6RoutingProtoTaskIdent,'fsMIRrd6RoutingProtoQueueIdent':fsMIRrd6RoutingProtoQueueIdent,'fsMIRrd6AllowOspfAreaRoutes':fsMIRrd6AllowOspfAreaRoutes,'fsMIRrd6AllowOspfExtRoutes':fsMIRrd6AllowOspfExtRoutes,'fsMIRtm6RedTest':fsMIRtm6RedTest,'fsMIRtm6RedEntryTime':fsMIRtm6RedEntryTime,'fsMIRtm6RedExitTime':fsMIRtm6RedExitTime})