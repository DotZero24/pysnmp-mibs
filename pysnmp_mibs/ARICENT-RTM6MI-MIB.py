# SNMP MIB module (ARICENT-RTM6MI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-RTM6MI-MIB
...
fsMIRtm6MaximumBgpRoutes = _FsMIRtm6MaximumBgpRoutes_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 1, 3),
    _FsMIRtm6MaximumBgpRoutes_Type()
)
fsMIRtm6MaximumBgpRoutes.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIRtm6MaximumBgpRoutes.setStatus("current")
_FsMIRtm6MaximumOspfRoutes_Type = Unsigned32
_FsMIRtm6MaximumOspfRoutes_Object = MibScalar
fsMIRtm6MaximumOspfRoutes = _FsMIRtm6MaximumOspfRoutes_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 1, 4),
    _FsMIRtm6MaximumOspfRoutes_Type()
)
fsMIRtm6MaximumOspfRoutes.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIRtm6MaximumOspfRoutes.setStatus("current")
_FsMIRtm6MaximumRipRoutes_Type = Unsigned32
_FsMIRtm6MaximumRipRoutes_Object = MibScalar
fsMIRtm6MaximumRipRoutes = _FsMIRtm6MaximumRipRoutes_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 1, 5),
    _FsMIRtm6MaximumRipRoutes_Type()
)
fsMIRtm6MaximumRipRoutes.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIRtm6MaximumRipRoutes.setStatus("current")
_FsMIRtm6MaximumStaticRoutes_Type = Unsigned32
_FsMIRtm6MaximumStaticRoutes_Object = MibScalar
fsMIRtm6MaximumStaticRoutes = _FsMIRtm6MaximumStaticRoutes_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 1, 6),
    _FsMIRtm6MaximumStaticRoutes_Type()
)
fsMIRtm6MaximumStaticRoutes.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIRtm6MaximumStaticRoutes.setStatus("current")
_FsMIRtm6MaximumISISRoutes_Type = Unsigned32
_FsMIRtm6MaximumISISRoutes_Object = MibScalar
fsMIRtm6MaximumISISRoutes = _FsMIRtm6MaximumISISRoutes_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 1, 7),
    _FsMIRtm6MaximumISISRoutes_Type()
)
fsMIRtm6MaximumISISRoutes.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIRtm6MaximumISISRoutes.setStatus("current")
_FsMIRtm6Table_Object = MibTable
fsMIRtm6Table = _FsMIRtm6Table_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 2)
)
if mibBuilder.loadTexts:
    fsMIRtm6Table.setStatus("current")
_FsMIRtm6Entry_Object = MibTableRow
fsMIRtm6Entry = _FsMIRtm6Entry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 2, 1)
)
fsMIRtm6Entry.setIndexNames(
    (0, "ARICENT-RTM6MI-MIB", "fsMIRtm6ContextId"),
)
if mibBuilder.loadTexts:
...
class _FsMIRtm6StaticRouteDistance_Type(Integer32):
    """Custom type fsMIRtm6StaticRouteDistance based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_FsMIRtm6StaticRouteDistance_Type.__name__ = "Integer32"
_FsMIRtm6StaticRouteDistance_Object = MibTableColumn
fsMIRtm6StaticRouteDistance = _FsMIRtm6StaticRouteDistance_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 2, 1, 9),
    _FsMIRtm6StaticRouteDistance_Type()
)
fsMIRtm6StaticRouteDistance.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsMIRtm6StaticRouteDistance.setStatus("current")
_FsMIRrd6ControlTable_Object = MibTable
fsMIRrd6ControlTable = _FsMIRrd6ControlTable_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 3)
)
if mibBuilder.loadTexts:
...
fsMIRrd6ControlEntry = _FsMIRrd6ControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 3, 1)
)
fsMIRrd6ControlEntry.setIndexNames(
    (0, "ARICENT-RTM6MI-MIB", "fsMIRtm6ContextId"),
    (0, "ARICENT-RTM6MI-MIB", "fsMIRrd6ControlDestIpAddress"),
    (0, "ARICENT-RTM6MI-MIB", "fsMIRrd6ControlNetMaskLen"),
)
if mibBuilder.loadTexts:
...
fsMIRrd6RoutingProtoEntry = _FsMIRrd6RoutingProtoEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 32, 4, 1)
)
fsMIRrd6RoutingProtoEntry.setIndexNames(
    (0, "ARICENT-RTM6MI-MIB", "fsMIRtm6ContextId"),
    (0, "ARICENT-RTM6MI-MIB", "fsMIRrd6RoutingProtoId"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"fsMIRtm6": fsMIRtm6,
       ...
       "fsMIRtm6MaximumBgpRoutes": fsMIRtm6MaximumBgpRoutes,
       "fsMIRtm6MaximumOspfRoutes": fsMIRtm6MaximumOspfRoutes,
       "fsMIRtm6MaximumRipRoutes": fsMIRtm6MaximumRipRoutes,
       "fsMIRtm6MaximumStaticRoutes": fsMIRtm6MaximumStaticRoutes,
       "fsMIRtm6MaximumISISRoutes": fsMIRtm6MaximumISISRoutes,
       ...
       "fsMIRtm6StaticRouteDistance": fsMIRtm6StaticRouteDistance,
