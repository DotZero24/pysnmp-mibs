...
rlOpenFlow=_RlOpenFlow_ObjectIdentity((1,3,6,1,4,1,4526,17,319))
_RlOpenFlowSupported_Type=TruthValue
_RlOpenFlowSupported_Object=MibScalar
rlOpenFlowSupported=_RlOpenFlowSupported_Object((1,3,6,1,4,1,4526,17,319,1),_RlOpenFlowSupported_Type())
...
rlOpenFlowTcpPort=_RlOpenFlowTcpPort_Object((1,3,6,1,4,1,4526,17,319,2),_RlOpenFlowTcpPort_Type())
...
rlOpenFlowServerIpAddr=_RlOpenFlowServerIpAddr_Object((1,3,6,1,4,1,4526,17,319,3),_RlOpenFlowServerIpAddr_Type())
...
rlOpenFlowProtocolType=_RlOpenFlowProtocolType_Object((1,3,6,1,4,1,4526,17,319,4),_RlOpenFlowProtocolType_Type())
...
rlOpenFlowDefaultForwardAction=_RlOpenFlowDefaultForwardAction_Object((1,3,6,1,4,1,4526,17,319,5),_RlOpenFlowDefaultForwardAction_Type())
...
rlOpenFlowEnable=_RlOpenFlowEnable_Object((1,3,6,1,4,1,4526,17,319,6),_RlOpenFlowEnable_Type())
