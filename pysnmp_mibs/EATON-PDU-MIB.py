...
# Notes
# -----
# ASN.1 source file://mibs/eaton/EATON-PDU-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:56:34 2025
...
pdu3phaseCompliance.setObjects(
      *(("EATON-PDU-MIB", "pduNameplateGroup"),
        ("EATON-PDU-MIB", "pduInputGroup"),
        ("EATON-PDU-MIB", "pduOutputGroup"),
        ("EATON-PDU-MIB", "panelRatingsGroup"),
        ("EATON-PDU-MIB", "panelMetersGroup"),
        ("EATON-PDU-MIB", "panelPhaseMetersGroup"),
        ("EATON-PDU-MIB", "breakerRatingsGroup"),
        ("EATON-PDU-MIB", "breakerMetersGroup"),
        ("EATON-PDU-MIB", "breakerPhaseMetersGroup"))
)
if mibBuilder.loadTexts:
