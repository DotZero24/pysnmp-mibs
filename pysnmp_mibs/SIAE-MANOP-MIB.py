...
# Produced by pysmi-1.1.12 at Wed Oct  8 10:45:56 2025
...
mibBuilder.exportSymbols("SIAE-MANOP-MIB", manualOpEventTime=manualOpEventTime, manualOpRecord=manualOpRecord, manualOpId=manualOpId, manualOpTimeOut=manualOpTimeOut, manualOperation=manualOperation, manualOpIntegerVal=manualOpIntegerVal, manualOpMibVersion=manualOpMibVersion, manualOpTrap=manualOpTrap, manualOpActiveSeverityCode=manualOpActiveSeverityCode, manualOpTable=manualOpTable, manualOpValueType=manualOpValueType, manualOpActive=manualOpActive, manualOpObjectId=manualOpObjectId, manualOpOidVal=manualOpOidVal, PYSNMP_MODULE_ID=manualOperation)
