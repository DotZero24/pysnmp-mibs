...
h3cVoiceIfObjects=_H3cVoiceIfObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,39,13,1))
_H3cVoiceIfConfigTable_Object=MibTable
h3cVoiceIfConfigTable=_H3cVoiceIfConfigTable_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1))
if mibBuilder.loadTexts:h3cVoiceIfConfigTable.setStatus(_A)
_H3cVoiceIfConfigEntry_Object=MibTableRow
h3cVoiceIfConfigEntry=_H3cVoiceIfConfigEntry_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1))
...
h3cVoiceIfCfgCngOn=_H3cVoiceIfCfgCngOn_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1,1),_H3cVoiceIfCfgCngOn_Type())
...
h3cVoiceIfCfgNonLinearSwitch=_H3cVoiceIfCfgNonLinearSwitch_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1,2),_H3cVoiceIfCfgNonLinearSwitch_Type())
...
h3cVoiceIfCfgInputGain=_H3cVoiceIfCfgInputGain_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1,3),_H3cVoiceIfCfgInputGain_Type())
...
h3cVoiceIfCfgOutputGain=_H3cVoiceIfCfgOutputGain_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1,4),_H3cVoiceIfCfgOutputGain_Type())
...
h3cVoiceIfCfgEchoCancelSwitch=_H3cVoiceIfCfgEchoCancelSwitch_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1,5),_H3cVoiceIfCfgEchoCancelSwitch_Type())
...
h3cVoiceIfCfgEchoCancelDelay=_H3cVoiceIfCfgEchoCancelDelay_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1,6),_H3cVoiceIfCfgEchoCancelDelay_Type())
...
h3cVoiceIfCfgTimerDialInterval=_H3cVoiceIfCfgTimerDialInterval_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1,7),_H3cVoiceIfCfgTimerDialInterval_Type())
...
h3cVoiceIfCfgTimerFirstDial=_H3cVoiceIfCfgTimerFirstDial_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1,8),_H3cVoiceIfCfgTimerFirstDial_Type())
...
h3cVoiceIfCfgPrivateline=_H3cVoiceIfCfgPrivateline_Object((1,3,6,1,4,1,2011,10,2,39,13,1,1,1,9),_H3cVoiceIfCfgPrivateline_Type())
