...
# Notes
# -----
# ASN.1 source file://mibs/scte/SCTE-HMS-PROPERTY-MIB
...
propertyModuleIdentity = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 5591, 1, 1, 4)
)
if mibBuilder.loadTexts:
    propertyModuleIdentity.setRevisions(
        ("2004-03-29 00:00",)
    )
...
propertyMIBConformance = _PropertyMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 5591, 1, 1, 4, 1)
)
_PropertyMIBCompliances_ObjectIdentity = ObjectIdentity
propertyMIBCompliances = _PropertyMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 5591, 1, 1, 4, 1, 1)
)
_PropertyMIBGroups_ObjectIdentity = ObjectIdentity
propertyMIBGroups = _PropertyMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 5591, 1, 1, 4, 1, 2)
)

# Managed Objects groups

analogAlarmsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5591, 1, 1, 4, 1, 2, 1)
)
analogAlarmsGroup.setObjects(
...
if mibBuilder.loadTexts:
    analogAlarmsGroup.setStatus("current")

discreteAlarmsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5591, 1, 1, 4, 1, 2, 2)
)
discreteAlarmsGroup.setObjects(
...
if mibBuilder.loadTexts:
    discreteAlarmsGroup.setStatus("current")

currentAlarmsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 5591, 1, 1, 4, 1, 2, 3)
)
currentAlarmsGroup.setObjects(
...
if mibBuilder.loadTexts:
    currentAlarmsGroup.setStatus("current")
...
propertyMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 5591, 1, 1, 4, 1, 1, 1)
)
propertyMIBCompliance.setObjects(
      *(("SCTE-HMS-PROPERTY-MIB", "analogAlarmsGroup"),
        ("SCTE-HMS-PROPERTY-MIB", "currentAlarmsGroup"),
        ("SCTE-HMS-PROPERTY-MIB", "discreteAlarmsGroup"))
)
if mibBuilder.loadTexts:
    propertyMIBCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"propertyTable": propertyTable,
       ...
       "propertyModuleIdentity": propertyModuleIdentity,
       "propertyMIBConformance": propertyMIBConformance,
       "propertyMIBCompliances": propertyMIBCompliances,
       "propertyMIBCompliance": propertyMIBCompliance,
       "propertyMIBGroups": propertyMIBGroups,
       "analogAlarmsGroup": analogAlarmsGroup,
       "discreteAlarmsGroup": discreteAlarmsGroup,
       "currentAlarmsGroup": currentAlarmsGroup}
)
