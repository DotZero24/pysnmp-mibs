...
adGenMonitorSessionID, adGenMonitorSession = mibBuilder.importSymbols("ADTRAN-SHARED-CND-SYSTEM-MIB", "adGenMonitorSessionID", "adGenMonitorSession")
...
mibBuilder.exportSymbols("ADTRAN-GEN-MONITOR-SESSION-MIB", adGenMonitorSessionSrcProvEntry=adGenMonitorSessionSrcProvEntry, adGenMonitorSessionSrcDirection=adGenMonitorSessionSrcDirection, adGenMonitorSessionTable=adGenMonitorSessionTable, adGenMonitorSessionProv=adGenMonitorSessionProv, adGenMonitorSessionDestProvEntry=adGenMonitorSessionDestProvEntry, adGenMonitorSessionNum=adGenMonitorSessionNum, adGenMonitorSessionSrcProvTable=adGenMonitorSessionSrcProvTable, adGenMonitorSessionSrcRowStatus=adGenMonitorSessionSrcRowStatus, adGenMonitorSessionLastError=adGenMonitorSessionLastError, adGenMonitorSessionDestRowStatus=adGenMonitorSessionDestRowStatus, PYSNMP_MODULE_ID=adGenMonitorSessionMIB, adGenMonitorSessionSrcifIndex=adGenMonitorSessionSrcifIndex, adGenMonitorSessionEntry=adGenMonitorSessionEntry, adGenMonitorSessionDestLastError=adGenMonitorSessionDestLastError, adGenMonitorSessionAdminState=adGenMonitorSessionAdminState, adGenMonitorSessionMIB=adGenMonitorSessionMIB, adGenMonitorSessionDestifIndex=adGenMonitorSessionDestifIndex, adGenMonitorSessionRowStatus=adGenMonitorSessionRowStatus, adGenMonitorSessionDestProvTable=adGenMonitorSessionDestProvTable, adGenMonitorSessionSrcLastError=adGenMonitorSessionSrcLastError)
