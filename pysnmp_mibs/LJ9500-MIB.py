...
class _Sleep_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_j,1),(_f,2)))
...
class _Powersave_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('eEnergyStar',1),('eBlueAngel',2)))
_Powersave_mode_Type.__name__=_C
_Powersave_mode_Object=MibScalar
powersave_mode=_Powersave_mode_Object((1,3,6,1,4,1,11,2,3,9,4,2,1,1,1,33),_Powersave_mode_Type())
powersave_mode.setMaxAccess(_D)
if mibBuilder.loadTexts:powersave_mode.setStatus(_A)
...
class _Auto_continue_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_R,2)))
...
class _Show_address_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_O,1),(_x,3)))
...
class _Mio1_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_I,1),(_G,2),(_y,8),(_z,12)))
...
class _Mio2_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_I,1),(_G,2),(_y,8),(_z,12)))
...
class _Mio3_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,8,12)));namedValues=NamedValues(*((_I,1),(_G,2),(_y,8),(_z,12)))
...
class _Phd2_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(2,10,11,13)));namedValues=NamedValues(*((_G,2),(_A7,10),(_A8,11),(_A9,13)))
...
class _Phd3_type_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(2,10,11,13)));namedValues=NamedValues(*((_G,2),(_A7,10),(_A8,11),(_A9,13)))
...
class _Clearable_warning_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(2,3)));namedValues=NamedValues(*((_R,2),('eJob',3)))
...
class _Job_info_accounting_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_S,1),(_P,2),(_T,3),(_U,11),(_V,17),(_W,18),(_X,19),(_d,25),(_Q,26),(_Y,27),(_e,45),(_Z,46),(_g,65),('eJapansePostcardDouble',72),(_k,80),(_l,81),(_m,90),(_n,91),(_o,100),(_a,101),(_b,258),(_c,282),(_A0,32767)))
...
class _Ram_disk_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,3)));namedValues=NamedValues(*((_O,1),(_x,3)))
...
class _Firmware_download_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_j,1),(_f,2)))
...
class _Upgradable_devices_write_status_supported_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_j,1),(_f,2)))
...
class _Remote_upgrade_enable_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_R,2)))
...
class _Mopy_mode_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,4,5)));namedValues=NamedValues(*((_O,1),('eStandard',4),('eEnhanced',5)))
...
class _Default_page_protect_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(2));namedValues=NamedValues((_R,2))
...
class _Default_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,11,17,18,19,25,26,27,45,46,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_S,1),(_P,2),(_T,3),(_i,10),(_U,11),(_V,17),(_W,18),(_X,19),(_d,25),(_Q,26),(_Y,27),(_e,45),(_Z,46),(_A2,72),(_k,80),(_l,81),(_m,90),(_n,91),(_o,100),(_a,101),(_b,258),(_c,282),(_A0,32767)))
...
class _Reprint_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3)));namedValues=NamedValues(*((_O,1),(_R,2),(_x,3)))
...
class _Form_feed_needed_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_j,1),(_f,2)))
...
class _Postscript_print_errors_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_R,2)))
...
class _Override_media_size_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32767)));namedValues=NamedValues(*((_S,1),(_P,2),(_T,3),(_U,11),(_V,17),(_W,18),(_X,19),(_d,25),(_Q,26),(_Y,27),(_e,45),(_Z,46),(_g,65),(_A2,72),(_k,80),(_l,81),(_m,90),(_n,91),(_o,100),(_a,101),(_b,258),(_c,282),(_A0,32767)))
...
class _Input_tray_auto_select_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_O,1),(_R,2)))
...
class _Tray1_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,11,17,18,19,25,26,27,45,46,65,72,80,81,90,91,100,101,258,282,32764,32765)));namedValues=NamedValues(*((_S,1),(_P,2),(_T,3),(_i,10),(_U,11),(_V,17),(_W,18),(_X,19),(_d,25),(_Q,26),(_Y,27),(_e,45),(_Z,46),(_g,65),(_A2,72),(_k,80),(_l,81),(_m,90),(_n,91),(_o,100),(_a,101),(_b,258),(_c,282),(_A3,32764),(_A4,32765)))
...
class _Tray2_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,11,17,18,19,25,26,27,45,46,65,101,258,282,32764,32765)));namedValues=NamedValues(*((_S,1),(_P,2),(_T,3),(_i,10),(_U,11),(_V,17),(_W,18),(_X,19),(_d,25),(_Q,26),(_Y,27),(_e,45),(_Z,46),(_g,65),(_a,101),(_b,258),(_c,282),(_A3,32764),(_A4,32765)))
...
class _Tray6_media_size_loaded_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,10,11,17,18,19,26,27,46,101,258,282)));namedValues=NamedValues(*((_S,1),(_P,2),(_T,3),(_i,10),(_U,11),(_V,17),(_W,18),(_X,19),(_Q,26),(_Y,27),(_Z,46),(_a,101),(_b,258),(_c,282)))
...
class _Out_marking_agent_processing_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(1));namedValues=NamedValues(('eStop',1))
...
class _Media24_short_name_Type(DisplayString):subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(1,9))
...
media24_engine_media_mode.setMaxAccess(_D)
...
_Consumable_status_page_count_a3_ledger_Type.__name__=_C
...
_Consumable_status_page_count_envelope_Type.__name__=_C
...
_Consumable_status_total_equiv_mono_page_count_Type.__name__=_C
...
_Consumable_status_total_equiv_color_page_count_Type.__name__=_C
