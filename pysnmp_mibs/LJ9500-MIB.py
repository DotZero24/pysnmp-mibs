# SNMP MIB module (LJ9500-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hp/LJ9500-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:38:38 2025
...
class _Powersave_mode_Type(Integer32):
    """Custom type powersave_mode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Powersave_mode_Type.__name__ = "Integer32"
_Powersave_mode_Object = MibScalar
powersave_mode = _Powersave_mode_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 1, 33),
    _Powersave_mode_Type()
)
powersave_mode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    powersave_mode.setStatus("optional")
