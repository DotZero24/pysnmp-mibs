...
agentUdldMIBObjects=_AgentUdldMIBObjects_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1))
_AgentUdldGlobal_ObjectIdentity=ObjectIdentity
agentUdldGlobal=_AgentUdldGlobal_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,1))
...
agentUdldGlobalMode=_AgentUdldGlobalMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,1,1),_AgentUdldGlobalMode_Type())
agentUdldGlobalMode.setMaxAccess(_C)
if mibBuilder.loadTexts:agentUdldGlobalMode.setStatus(_A)
class _AgentUdldMessageInterval_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,90))
_AgentUdldMessageInterval_Type.__name__=_B
_AgentUdldMessageInterval_Object=MibScalar
agentUdldMessageInterval=_AgentUdldMessageInterval_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,1,2),_AgentUdldMessageInterval_Type())
...
class _AgentUdldTimeoutInterval_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(3,60))
_AgentUdldTimeoutInterval_Type.__name__=_B
_AgentUdldTimeoutInterval_Object=MibScalar
agentUdldTimeoutInterval=_AgentUdldTimeoutInterval_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,1,3),_AgentUdldTimeoutInterval_Type())
...
agentUdldReset=_AgentUdldReset_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,1,4),_AgentUdldReset_Type())
...
agentUdldInterface=_AgentUdldInterface_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,2))
_AgentUdldInterfaceTable_Object=MibTable
agentUdldInterfaceTable=_AgentUdldInterfaceTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,2,1))
if mibBuilder.loadTexts:agentUdldInterfaceTable.setStatus(_A)
_AgentUdldInterfaceEntry_Object=MibTableRow
agentUdldInterfaceEntry=_AgentUdldInterfaceEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,2,1,1))
...
agentUdldInterfaceOperStatus=_AgentUdldInterfaceOperStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,2,1,1,1),_AgentUdldInterfaceOperStatus_Type())
...
agentUdldInterfaceAdminMode=_AgentUdldInterfaceAdminMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,54,1,2,1,1,2),_AgentUdldInterfaceAdminMode_Type())
