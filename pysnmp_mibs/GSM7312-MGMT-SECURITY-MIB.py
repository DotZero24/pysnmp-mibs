...
if mibBuilder.loadTexts:gsm7312MgmtSecurity.setRevisions(('2003-11-21 00:00',))
_AgentSSLConfigGroup_ObjectIdentity=ObjectIdentity
agentSSLConfigGroup=_AgentSSLConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,1,6,11,1))
...
agentSSLAdminMode=_AgentSSLAdminMode_Object((1,3,6,1,4,1,4526,1,6,11,1,1),_AgentSSLAdminMode_Type())
...
agentSSLSecurePort=_AgentSSLSecurePort_Object((1,3,6,1,4,1,4526,1,6,11,1,2),_AgentSSLSecurePort_Type())
...
agentSSLProtocolLevel=_AgentSSLProtocolLevel_Object((1,3,6,1,4,1,4526,1,6,11,1,3),_AgentSSLProtocolLevel_Type())
...
agentSSHConfigGroup=_AgentSSHConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,1,6,11,2))
...
agentSSHAdminMode=_AgentSSHAdminMode_Object((1,3,6,1,4,1,4526,1,6,11,2,1),_AgentSSHAdminMode_Type())
...
agentSSHProtocolLevel=_AgentSSHProtocolLevel_Object((1,3,6,1,4,1,4526,1,6,11,2,2),_AgentSSHProtocolLevel_Type())
