...
mibBuilder.exportSymbols("NIMBLE-MIB", volIoWriteTimeMicrosec=volIoWriteTimeMicrosec, volIoReadLatency10mTo20m=volIoReadLatency10mTo20m, volIoNonseqReadTotalHits=volIoNonseqReadTotalHits, ioWrites=ioWrites, volIoNonseqReadMemHits=volIoNonseqReadMemHits, volIndex=volIndex, volIoReadLatency20mTo50m=volIoReadLatency20mTo50m, volIoWriteBytes=volIoWriteBytes, volSizeHigh=volSizeHigh, variables=variables, volIoReadLatency100uTo200u=volIoReadLatency100uTo200u, volDiskVolBytesUsedHigh=volDiskVolBytesUsedHigh, volIoWriteLatency100mTo200m=volIoWriteLatency100mTo200m, volReserveLow=volReserveLow, volIoWriteLatency10mTo20m=volIoWriteLatency10mTo20m, arrayEntry=arrayEntry, volIoWriteLatency200mTo500m=volIoWriteLatency200mTo500m, ioSeqReads=ioSeqReads, ioWriteBytes=ioWriteBytes, volUsageLow=volUsageLow, volIoWriteLatency100uTo200u=volIoWriteLatency100uTo200u, volIoReadLatency100mTo200m=volIoReadLatency100mTo200m, volDiskVolBytesUsedLow=volDiskVolBytesUsedLow, volIoReadLatency0uTo100u=volIoReadLatency0uTo100u, volIoReadBytes=volIoReadBytes, volIoWriteLatency20mTo50m=volIoWriteLatency20mTo50m, statTimeEpochSeconds=statTimeEpochSeconds, volStatTimeEpochSeconds=volStatTimeEpochSeconds, volIoWriteLatency2mTo5m=volIoWriteLatency2mTo5m, ioReads=ioReads, ioReadTimeMicrosec=ioReadTimeMicrosec, volIoReadLatency200mTo500m=volIoReadLatency200mTo500m, volDiskSnapBytesUsedHigh=volDiskSnapBytesUsedHigh, volIoWriteLatency500uTo1m=volIoWriteLatency500uTo1m, volIoWriteLatency500mTomax=volIoWriteLatency500mTomax, globalStats=globalStats, volIoWriteLatency1mTo2m=volIoWriteLatency1mTo2m, PYSNMP_MODULE_ID=nimble, volIoSeqReadBytes=volIoSeqReadBytes, ioNonseqReadHits=ioNonseqReadHits, ioSeqReadBytes=ioSeqReadBytes, volIoWrites=volIoWrites, volIoSeqReads=volIoSeqReads, volIoReadLatency1mTo2m=volIoReadLatency1mTo2m, diskSnapBytesUsedHigh=diskSnapBytesUsedHigh, volIoWriteLatency200uTo500u=volIoWriteLatency200uTo500u, volNumberOfVolumes=volNumberOfVolumes, volIoSeqWrites=volIoSeqWrites, volIoReadLatency500uTo1m=volIoReadLatency500uTo1m, volIoSeqWriteBytes=volIoSeqWriteBytes, volIoReadLatency500mTomax=volIoReadLatency500mTomax, volEntry=volEntry, volNumConnections=volNumConnections, arrays=arrays, volIoReadTimeMicrosec=volIoReadTimeMicrosec, volName=volName, diskSnapBytesUsedLow=diskSnapBytesUsedLow, ioSeqWriteBytes=ioSeqWriteBytes, ioSeqWrites=ioSeqWrites, diskVolBytesUsedHigh=diskVolBytesUsedHigh, ioWriteTimeMicrosec=ioWriteTimeMicrosec, volIoReadLatency2mTo5m=volIoReadLatency2mTo5m, volIoReadLatency50mTo100m=volIoReadLatency50mTo100m, volSizeLow=volSizeLow, volIoWriteLatency5mTo10m=volIoWriteLatency5mTo10m, volIoWriteLatency0uTo100u=volIoWriteLatency0uTo100u, volIoNonseqReadSSDHits=volIoNonseqReadSSDHits, volOnline=volOnline, volUsageHigh=volUsageHigh, nimble=nimble, volDiskSnapBytesUsedLow=volDiskSnapBytesUsedLow, ioReadBytes=ioReadBytes, volReserveHigh=volReserveHigh, volTable=volTable, volIoReads=volIoReads, volIoWriteLatency50mTo100m=volIoWriteLatency50mTo100m, diskVolBytesUsedLow=diskVolBytesUsedLow, volID=volID, volIoReadLatency5mTo10m=volIoReadLatency5mTo10m, volIoReadLatency200uTo500u=volIoReadLatency200uTo500u)
