# SNMP MIB module (QTECH-PTOPO-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/qtech/QTECH-PTOPO-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:59:33 2025
...
qtechPotopoMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33)
)
if mibBuilder.loadTexts:
    qtechPotopoMIB.setRevisions(
        ("2003-04-28 00:00",)
    )
...
ptopoConnIndex = _PtopoConnIndex_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 1, 1, 1, 1),
...
ptopoConnLocalDevice = _PtopoConnLocalDevice_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 1, 1, 1, 2),
...
ptopoConnLocalPort = _PtopoConnLocalPort_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 1, 1, 1, 3),
...
ptopoConnRemoteDevice = _PtopoConnRemoteDevice_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 1, 1, 1, 4),
...
ptopoConnRemotePort = _PtopoConnRemotePort_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 1, 1, 1, 5),
...
ptopoConnIsUpStream = _PtopoConnIsUpStream_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 1, 1, 1, 6),
...
ptopoDevID = _PtopoDevID_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 2, 1, 1, 1),
    _PtopoDevID_Type()
)
...
ptopoDevHostname = _PtopoDevHostname_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 2, 1, 1, 2),
...
ptopoDevClusStatus = _PtopoDevClusStatus_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 2, 1, 1, 3),
...
ptopoDevClusMode = _PtopoDevClusMode_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 2, 1, 1, 4),
...
ptopoDevClusName = _PtopoDevClusName_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 2, 1, 1, 5),
...
ptopoDevCSMac = _PtopoDevCSMac_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 2, 1, 1, 6),
    _PtopoDevCSMac_Type()
)
...
ptopoDevHopsToCs = _PtopoDevHopsToCs_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 2, 1, 1, 7),
...
ptopoDevLastVerifyTime = _PtopoDevLastVerifyTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 2, 1, 1, 8),
...
ptopoConfig = _PtopoConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 3)
)
...
ptopoConfigInterval = _PtopoConfigInterval_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 3, 1),
...
ptopoConfigMaxHoldTime = _PtopoConfigMaxHoldTime_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 3, 2),
...
ptopoConfigHopCount = _PtopoConfigHopCount_Object(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 1, 3, 3),
...
qtechptopoMIBConformance = _QtechptopoMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 2)
)
_QtechptopoMIBCompliances_ObjectIdentity = ObjectIdentity
qtechptopoMIBCompliances = _QtechptopoMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 2, 1)
)
_QtechptopoMIBGroups_ObjectIdentity = ObjectIdentity
qtechptopoMIBGroups = _QtechptopoMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 2, 2)
)

# Managed Objects groups

qtechptopoMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 2, 2, 1)
)
qtechptopoMIBGroup.setObjects(
      *(("QTECH-PTOPO-MIB", "ptopoConnRemoteDevice"),
        ("QTECH-PTOPO-MIB", "ptopoConnRemotePort"),
        ("QTECH-PTOPO-MIB", "ptopoConnIsUpStream"),
        ("QTECH-PTOPO-MIB", "ptopoDevHostname"),
        ("QTECH-PTOPO-MIB", "ptopoDevClusStatus"),
        ("QTECH-PTOPO-MIB", "ptopoDevClusMode"),
        ("QTECH-PTOPO-MIB", "ptopoDevClusName"),
        ("QTECH-PTOPO-MIB", "ptopoDevCSMac"),
        ("QTECH-PTOPO-MIB", "ptopoDevHopsToCs"),
        ("QTECH-PTOPO-MIB", "ptopoDevLastVerifyTime"),
        ("QTECH-PTOPO-MIB", "ptopoConfigInterval"),
        ("QTECH-PTOPO-MIB", "ptopoConfigMaxHoldTime"),
        ("QTECH-PTOPO-MIB", "ptopoConfigHopCount"))
)
if mibBuilder.loadTexts:
    qtechptopoMIBGroup.setStatus("current")
...
qtechptopoMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 27514, 1, 1, 10, 2, 33, 2, 1, 1)
)
qtechptopoMIBCompliance.setObjects(
    ("QTECH-PTOPO-MIB", "qtechptopoMIBGroup")
)
if mibBuilder.loadTexts:
    qtechptopoMIBCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"qtechPotopoMIB": qtechPotopoMIB,
       ...
       "qtechptopoMIBConformance": qtechptopoMIBConformance,
       "qtechptopoMIBCompliances": qtechptopoMIBCompliances,
       "qtechptopoMIBCompliance": qtechptopoMIBCompliance,
       "qtechptopoMIBGroups": qtechptopoMIBGroups,
       "qtechptopoMIBGroup": qtechptopoMIBGroup}
)
