...
if mibBuilder.loadTexts:qtechPotopoMIB.setRevisions(('2003-04-28 00:00',))
_PtopoMIBObjects_ObjectIdentity=ObjectIdentity
ptopoMIBObjects=_PtopoMIBObjects_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,33,1))
_PtopoConnData_ObjectIdentity=ObjectIdentity
ptopoConnData=_PtopoConnData_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,33,1,1))
_PtopoConnTable_Object=MibTable
ptopoConnTable=_PtopoConnTable_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,1,1))
if mibBuilder.loadTexts:ptopoConnTable.setStatus(_A)
_PtopoConnEntry_Object=MibTableRow
ptopoConnEntry=_PtopoConnEntry_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,1,1,1))
...
ptopoConnIndex=_PtopoConnIndex_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,1,1,1,1),_PtopoConnIndex_Type())
...
ptopoConnLocalDevice=_PtopoConnLocalDevice_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,1,1,1,2),_PtopoConnLocalDevice_Type())
...
ptopoConnLocalPort=_PtopoConnLocalPort_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,1,1,1,3),_PtopoConnLocalPort_Type())
...
ptopoConnRemoteDevice=_PtopoConnRemoteDevice_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,1,1,1,4),_PtopoConnRemoteDevice_Type())
...
ptopoConnRemotePort=_PtopoConnRemotePort_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,1,1,1,5),_PtopoConnRemotePort_Type())
...
ptopoConnIsUpStream=_PtopoConnIsUpStream_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,1,1,1,6),_PtopoConnIsUpStream_Type())
...
ptopoDevData=_PtopoDevData_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,33,1,2))
_PtopoDevTable_Object=MibTable
ptopoDevTable=_PtopoDevTable_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1))
if mibBuilder.loadTexts:ptopoDevTable.setStatus(_A)
_PtopoDevEntry_Object=MibTableRow
ptopoDevEntry=_PtopoDevEntry_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1,1))
...
ptopoDevID=_PtopoDevID_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1,1,1),_PtopoDevID_Type())
...
ptopoDevHostname=_PtopoDevHostname_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1,1,2),_PtopoDevHostname_Type())
...
ptopoDevClusStatus=_PtopoDevClusStatus_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1,1,3),_PtopoDevClusStatus_Type())
...
ptopoDevClusMode=_PtopoDevClusMode_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1,1,4),_PtopoDevClusMode_Type())
...
ptopoDevClusName=_PtopoDevClusName_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1,1,5),_PtopoDevClusName_Type())
...
ptopoDevCSMac=_PtopoDevCSMac_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1,1,6),_PtopoDevCSMac_Type())
...
ptopoDevHopsToCs=_PtopoDevHopsToCs_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1,1,7),_PtopoDevHopsToCs_Type())
...
ptopoDevLastVerifyTime=_PtopoDevLastVerifyTime_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,2,1,1,8),_PtopoDevLastVerifyTime_Type())
...
ptopoConfig=_PtopoConfig_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,33,1,3))
...
ptopoConfigInterval=_PtopoConfigInterval_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,3,1),_PtopoConfigInterval_Type())
...
ptopoConfigMaxHoldTime=_PtopoConfigMaxHoldTime_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,3,2),_PtopoConfigMaxHoldTime_Type())
...
ptopoConfigHopCount=_PtopoConfigHopCount_Object((1,3,6,1,4,1,27514,1,1,10,2,33,1,3,3),_PtopoConfigHopCount_Type())
ptopoConfigHopCount.setMaxAccess(_G)
if mibBuilder.loadTexts:ptopoConfigHopCount.setStatus(_A)
_QtechptopoMIBConformance_ObjectIdentity=ObjectIdentity
qtechptopoMIBConformance=_QtechptopoMIBConformance_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,33,2))
_QtechptopoMIBCompliances_ObjectIdentity=ObjectIdentity
qtechptopoMIBCompliances=_QtechptopoMIBCompliances_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,33,2,1))
_QtechptopoMIBGroups_ObjectIdentity=ObjectIdentity
qtechptopoMIBGroups=_QtechptopoMIBGroups_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,33,2,2))
qtechptopoMIBGroup=ObjectGroup((1,3,6,1,4,1,27514,1,1,10,2,33,2,2,1))
qtechptopoMIBGroup.setObjects(*((_B,_K),(_B,_L),(_B,_M),(_B,_N),(_B,_O),(_B,_P),(_B,_Q),(_B,_R),(_B,_S),(_B,_T),(_B,_U),(_B,_V),(_B,_W)))
if mibBuilder.loadTexts:qtechptopoMIBGroup.setStatus(_A)
qtechptopoMIBCompliance=ModuleCompliance((1,3,6,1,4,1,27514,1,1,10,2,33,2,1,1))
qtechptopoMIBCompliance.setObjects((_B,_X))
if mibBuilder.loadTexts:qtechptopoMIBCompliance.setStatus(_A)
mibBuilder.exportSymbols(_B,**{'qtechPotopoMIB':qtechPotopoMIB,'ptopoMIBObjects':ptopoMIBObjects,'ptopoConnData':ptopoConnData,'ptopoConnTable':ptopoConnTable,'ptopoConnEntry':ptopoConnEntry,_H:ptopoConnIndex,'ptopoConnLocalDevice':ptopoConnLocalDevice,'ptopoConnLocalPort':ptopoConnLocalPort,_K:ptopoConnRemoteDevice,_L:ptopoConnRemotePort,_M:ptopoConnIsUpStream,'ptopoDevData':ptopoDevData,'ptopoDevTable':ptopoDevTable,'ptopoDevEntry':ptopoDevEntry,_I:ptopoDevID,_N:ptopoDevHostname,_O:ptopoDevClusStatus,_P:ptopoDevClusMode,_Q:ptopoDevClusName,_R:ptopoDevCSMac,_S:ptopoDevHopsToCs,_T:ptopoDevLastVerifyTime,'ptopoConfig':ptopoConfig,_U:ptopoConfigInterval,_V:ptopoConfigMaxHoldTime,_W:ptopoConfigHopCount,'qtechptopoMIBConformance':qtechptopoMIBConformance,'qtechptopoMIBCompliances':qtechptopoMIBCompliances,'qtechptopoMIBCompliance':qtechptopoMIBCompliance,'qtechptopoMIBGroups':qtechptopoMIBGroups,_X:qtechptopoMIBGroup})