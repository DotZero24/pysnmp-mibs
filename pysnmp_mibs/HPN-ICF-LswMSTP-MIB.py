...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/HPN-ICF-LswMSTP-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:09:41 2025
...
hpnicfdot1sMstiPortIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 14, 20, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
...
hpnicfPortMstiBpduGuarded = NotificationType((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 14, 0, 5)).setObjects(("BRIDGE-MIB", "dot1dStpPort"), ("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sMstiDesignatedBridge"))
...
hpnicfMstiNewRoot = NotificationType((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 14, 0, 7)).setObjects(("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sInstanceID"), ("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sMstiDesignedRoot"), ("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sMstiDesignedRoot"))
if mibBuilder.loadTexts: hpnicfMstiNewRoot.setStatus('current')
hpnicfPortPvstBpduProtection = NotificationType((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 14, 0, 8)).setObjects(("BRIDGE-MIB", "dot1dStpPort"), ("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sMstiDesignatedBridge"))
if mibBuilder.loadTexts: hpnicfPortPvstBpduProtection.setStatus('current')
mibBuilder.exportSymbols("HPN-ICF-LswMSTP-MIB", hpnicfPortMstiBpduGuarded=hpnicfPortMstiBpduGuarded, hpnicfPortPvstBpduProtection=hpnicfPortPvstBpduProtection, hpnicfdot1sMstiStpTXTCNBPDU=hpnicfdot1sMstiStpTXTCNBPDU, hpnicfdot1sMstiStpTransLimit=hpnicfdot1sMstiStpTransLimit, hpnicfdot1sMstiDesignatedCost=hpnicfdot1sMstiDesignatedCost, hpnicfdot1sPortEntry=hpnicfdot1sPortEntry, EnabledStatus=EnabledStatus, hpnicfdot1sMstDefaultRegionName=hpnicfdot1sMstDefaultRegionName, PYSNMP_MODULE_ID=hpnicfdot1sMstp, hpnicfdot1sStpForceVersion=hpnicfdot1sStpForceVersion, hpnicfdot1sMstiAdminMappedVlanListLow=hpnicfdot1sMstiAdminMappedVlanListLow, hpnicfdot1sMstiStpStatus=hpnicfdot1sMstiStpStatus, hpnicfPortMstiStateForwarding=hpnicfPortMstiStateForwarding, hpnicfdot1sStpStatus=hpnicfdot1sStpStatus, hpnicfdot1sMstMasterBridgeID=hpnicfdot1sMstMasterBridgeID, hpnicfdot1sMstiAdminMappedVlanListHigh=hpnicfdot1sMstiAdminMappedVlanListHigh, hpnicfdot1sMstiMasterPortCost=hpnicfdot1sMstiMasterPortCost, hpnicfdot1sMstiBridgePriority=hpnicfdot1sMstiBridgePriority, hpnicfdot1sMstiRootPathCost=hpnicfdot1sMstiRootPathCost, hpnicfdot1sMstiStpTXRSTPBPDU=hpnicfdot1sMstiStpTXRSTPBPDU, hpnicfdot1sMstOperConfigDigest=hpnicfdot1sMstOperConfigDigest, hpnicfPortMstiRootGuarded=hpnicfPortMstiRootGuarded, hpnicfdot1sMstOperFormatSelector=hpnicfdot1sMstOperFormatSelector, hpnicfdot1sMstiBridgeID=hpnicfdot1sMstiBridgeID, hpnicfMstpEventsV2=hpnicfMstpEventsV2, hpnicfdot1sInstanceEntry=hpnicfdot1sInstanceEntry, hpnicfdot1sMstiDesignedRoot=hpnicfdot1sMstiDesignedRoot, hpnicfdot1sInstanceTable=hpnicfdot1sInstanceTable, hpnicfdot1sMstiStpRXStpBPDU=hpnicfdot1sMstiStpRXStpBPDU, hpnicfdot1sMstiPortLoopGuard=hpnicfdot1sMstiPortLoopGuard, hpnicfdot1sMstiOperMappedVlanListHigh=hpnicfdot1sMstiOperMappedVlanListHigh, hpnicfdot1sMstiStpDefaultPortCost=hpnicfdot1sMstiStpDefaultPortCost, hpnicfdot1sMstiStpPortAdminBPDUFmt=hpnicfdot1sMstiStpPortAdminBPDUFmt, hpnicfdot1sMstiStpPortEdgeport=hpnicfdot1sMstiStpPortEdgeport, hpnicfdot1sMstVID=hpnicfdot1sMstVID, hpnicfdot1sMstDefaultVlanAllo=hpnicfdot1sMstDefaultVlanAllo, hpnicfdot1sMstiStpPortTcRestriction=hpnicfdot1sMstiStpPortTcRestriction, hpnicfdot1sStpPathCostStandard=hpnicfdot1sStpPathCostStandard, hpnicfdot1sMstiStpMcheck=hpnicfdot1sMstiStpMcheck, hpnicfdot1sStpDiameter=hpnicfdot1sStpDiameter, hpnicfdot1sMstiPortIndex=hpnicfdot1sMstiPortIndex, hpnicfdot1sMstp=hpnicfdot1sMstp, hpnicfdot1sMstOperRegionName=hpnicfdot1sMstOperRegionName, hpnicfdot1sMstMasterPathCost=hpnicfdot1sMstMasterPathCost, hpnicfdot1sMstiStpPortSendingBPDUType=hpnicfdot1sMstiStpPortSendingBPDUType, hpnicfdot1sVIDAllocationTable=hpnicfdot1sVIDAllocationTable, hpnicfdot1sMstiStpPortDisputed=hpnicfdot1sMstiStpPortDisputed, BridgeId=BridgeId, hpnicfdot1sMstiMasterBridgeID=hpnicfdot1sMstiMasterBridgeID, hpnicfdot1sMstiStpRXMSTPBPDU=hpnicfdot1sMstiStpRXMSTPBPDU, hpnicfdot1sMstiStpTXMSTPBPDU=hpnicfdot1sMstiStpTXMSTPBPDU, hpnicfdot1sMstiPortRootGuard=hpnicfdot1sMstiPortRootGuard, hpnicfdot1sMstiRootType=hpnicfdot1sMstiRootType, hpnicfdot1sPortTable=hpnicfdot1sPortTable, hpnicfdot1sMstiState=hpnicfdot1sMstiState, hpnicfdot1sMstOperRevisionLevel=hpnicfdot1sMstOperRevisionLevel, hpnicfdot1sMstAdminRegionName=hpnicfdot1sMstAdminRegionName, hpnicfdot1sMstiOperMappedVlanListLow=hpnicfdot1sMstiOperMappedVlanListLow, hpnicfdot1sVIDAllocationEntry=hpnicfdot1sVIDAllocationEntry, hpnicfdot1sMstiPortPriority=hpnicfdot1sMstiPortPriority, hpnicfBridgeLostRootPrimary=hpnicfBridgeLostRootPrimary, hpnicfdot1sMstiDesignatedRoot=hpnicfdot1sMstiDesignatedRoot, hpnicfdot1sMstiStpRXTCNBPDU=hpnicfdot1sMstiStpRXTCNBPDU, hpnicfdot1sMstiRemainingHops=hpnicfdot1sMstiRemainingHops, hpnicfPortMstiLoopGuarded=hpnicfPortMstiLoopGuarded, hpnicfdot1sMstiRootPort=hpnicfdot1sMstiRootPort, hpnicfdot1sMstBpduGuard=hpnicfdot1sMstBpduGuard, hpnicfdot1sMstiPathCost=hpnicfdot1sMstiPathCost, hpnicfdot1sMstBridgeMaxHops=hpnicfdot1sMstBridgeMaxHops, hpnicfdot1sMstRegionConfActive=hpnicfdot1sMstRegionConfActive, hpnicfdot1sMstiStpPortOperBPDUFmt=hpnicfdot1sMstiStpPortOperBPDUFmt, hpnicfdot1sMstiStpPortRoleRestriction=hpnicfdot1sMstiStpPortRoleRestriction, hpnicfdot1sMstiStpPortPointToPoint=hpnicfdot1sMstiStpPortPointToPoint, hpnicfMstiNewRoot=hpnicfMstiNewRoot, hpnicfdot1sMstiStpOperPortPointToPoint=hpnicfdot1sMstiStpOperPortPointToPoint, hpnicfPortMstiStateDiscarding=hpnicfPortMstiStateDiscarding, hpnicfdot1sAdminMstID=hpnicfdot1sAdminMstID, hpnicfdot1sMstAdminRevisionLevel=hpnicfdot1sMstAdminRevisionLevel, hpnicfdot1sMstiStpClearStatistics=hpnicfdot1sMstiStpClearStatistics, hpnicfdot1sMstiStpRXRSTPBPDU=hpnicfdot1sMstiStpRXRSTPBPDU, hpnicfdot1sMstAdminFormatSelector=hpnicfdot1sMstAdminFormatSelector, hpnicfdot1sOperMstID=hpnicfdot1sOperMstID, Hpnicfdot1sFormatStatus=Hpnicfdot1sFormatStatus, hpnicfdot1sMstiStpTXStpBPDU=hpnicfdot1sMstiStpTXStpBPDU, hpnicfdot1sMstiDesignatedPort=hpnicfdot1sMstiDesignatedPort, hpnicfdot1sInstanceID=hpnicfdot1sInstanceID, hpnicfdot1sMstiDesignatedBridge=hpnicfdot1sMstiDesignatedBridge)
