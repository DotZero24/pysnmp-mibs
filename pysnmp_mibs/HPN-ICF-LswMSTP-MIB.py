...
# Notes
# -----
# ASN.1 source file://mibs/hp/HPN-ICF-LswMSTP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:41:45 2025
...
_Hpnicfdot1sStpStatus_Type.__name__ = "EnabledStatus"
...
_Hpnicfdot1sMstMasterPathCost_Type.__name__ = "Integer32"
...
_Hpnicfdot1sMstBpduGuard_Type.__name__ = "EnabledStatus"
...
_Hpnicfdot1sMstAdminFormatSelector_Type.__name__ = "Integer32"
...
_Hpnicfdot1sMstOperFormatSelector_Type.__name__ = "Integer32"
...
class _Hpnicfdot1sMstiPortIndex_Type(Integer32):
    """Custom type hpnicfdot1sMstiPortIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Hpnicfdot1sMstiPortIndex_Type.__name__ = "Integer32"
...
_Hpnicfdot1sMstiStpPortEdgeport_Type.__name__ = "EnabledStatus"
...
_Hpnicfdot1sMstiStpStatus_Type.__name__ = "EnabledStatus"
...
_Hpnicfdot1sMstiPortRootGuard_Type.__name__ = "EnabledStatus"
...
_Hpnicfdot1sMstiPortLoopGuard_Type.__name__ = "EnabledStatus"
...
_Hpnicfdot1sMstiStpPortRoleRestriction_Type.__name__ = "EnabledStatus"
...
_Hpnicfdot1sMstiStpPortTcRestriction_Type.__name__ = "EnabledStatus"
...
hpnicfPortMstiBpduGuarded.setObjects(
      *(("BRIDGE-MIB", "dot1dStpPort"),
        ("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sMstiDesignatedBridge"))
)
if mibBuilder.loadTexts:
...
hpnicfMstiNewRoot = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 14, 0, 7)
)
hpnicfMstiNewRoot.setObjects(
      *(("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sInstanceID"),
        ("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sMstiDesignedRoot"),
        ("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sMstiDesignedRoot"))
)
if mibBuilder.loadTexts:
    hpnicfMstiNewRoot.setStatus(
        "current"
    )

hpnicfPortPvstBpduProtection = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 15, 8, 35, 14, 0, 8)
)
hpnicfPortPvstBpduProtection.setObjects(
      *(("BRIDGE-MIB", "dot1dStpPort"),
        ("HPN-ICF-LswMSTP-MIB", "hpnicfdot1sMstiDesignatedBridge"))
)
if mibBuilder.loadTexts:
    hpnicfPortPvstBpduProtection.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"EnabledStatus": EnabledStatus,
       ...
       "hpnicfMstiNewRoot": hpnicfMstiNewRoot,
       "hpnicfPortPvstBpduProtection": hpnicfPortPvstBpduProtection,
