...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-CAM-MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:52:12 2025
...
_Hm2CamConfigAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2CamClientServerAddrType_Type.__name__ = "InetAddressType"
...
_Hm2CamClientServerAddr_Type.__name__ = "InetAddress"
...
_Hm2CamClientServerPort_Type.__name__ = "InetPortNumber"
...
if mibBuilder.loadTexts:
    hm2CamClientServerReplicationInterval.setStatus("obsolete")
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    hm2CamClientServerReplicationStatus.setStatus("obsolete")
...
class _Hm2CamClientServerSslTls_Type(HmEnabledStatus):
    """Custom type hm2CamClientServerSslTls based on HmEnabledStatus"""
    defaultValue = 2


_Hm2CamClientServerSslTls_Type.__name__ = "HmEnabledStatus"
_Hm2CamClientServerSslTls_Object = MibTableColumn
hm2CamClientServerSslTls = _Hm2CamClientServerSslTls_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 200, 1, 1, 10, 1, 12),
    _Hm2CamClientServerSslTls_Type()
)
hm2CamClientServerSslTls.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hm2CamClientServerSslTls.setStatus("current")
...
if mibBuilder.loadTexts:
    hm2CamActionReplicationStatus.setStatus("obsolete")
...
hm2CamMgmtMibSnmpExtensionGroup = _Hm2CamMgmtMibSnmpExtensionGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 200, 3)
)
_Hm2CamConfigSESGroup_ObjectIdentity = ObjectIdentity
hm2CamConfigSESGroup = _Hm2CamConfigSESGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 200, 3, 1)
)
_Hm2CamMgmtNoCaCertErrorReturn_ObjectIdentity = ObjectIdentity
hm2CamMgmtNoCaCertErrorReturn = _Hm2CamMgmtNoCaCertErrorReturn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 200, 3, 1, 1)
)
if mibBuilder.loadTexts:
    hm2CamMgmtNoCaCertErrorReturn.setStatus("current")
_Hm2CamMgmtTestConnErrorReturn_ObjectIdentity = ObjectIdentity
hm2CamMgmtTestConnErrorReturn = _Hm2CamMgmtTestConnErrorReturn_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 200, 3, 1, 2)
)
if mibBuilder.loadTexts:
    hm2CamMgmtTestConnErrorReturn.setStatus("current")
_Hm2CamActionSESGroup_ObjectIdentity = ObjectIdentity
hm2CamActionSESGroup = _Hm2CamActionSESGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 200, 3, 10)
)
_Hm2CamPwdChangeSESGroup_ObjectIdentity = ObjectIdentity
hm2CamPwdChangeSESGroup = _Hm2CamPwdChangeSESGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 200, 3, 20)
)
_Hm2CamCertInfoSESGroup_ObjectIdentity = ObjectIdentity
hm2CamCertInfoSESGroup = _Hm2CamCertInfoSESGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 200, 3, 30)
)
...
mibBuilder.exportSymbols(
    ...
    **{"hm2CamMgmtMib": hm2CamMgmtMib,
       ...
       "hm2CamClientServerSslTls": hm2CamClientServerSslTls,
       ...
       "hm2CamMgmtMibSnmpExtensionGroup": hm2CamMgmtMibSnmpExtensionGroup,
       "hm2CamConfigSESGroup": hm2CamConfigSESGroup,
       "hm2CamMgmtNoCaCertErrorReturn": hm2CamMgmtNoCaCertErrorReturn,
       "hm2CamMgmtTestConnErrorReturn": hm2CamMgmtTestConnErrorReturn,
       "hm2CamActionSESGroup": hm2CamActionSESGroup,
       "hm2CamPwdChangeSESGroup": hm2CamPwdChangeSESGroup,
