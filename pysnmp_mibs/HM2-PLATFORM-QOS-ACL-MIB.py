...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hirschmann/HM2-PLATFORM-QOS-ACL-MIB
...
hm2AgentAclMacRuleCos = MibTableColumn((1, 3, 6, 1, 4, 1, 248, 12, 3, 2, 7, 1, 3), Unsigned32()).setMaxAccess("readcreate")
...
mibBuilder.exportSymbols("HM2-PLATFORM-QOS-ACL-MIB", hm2AgentAclRuleTcpFlagBits=hm2AgentAclRuleTcpFlagBits, hm2AgentAclMacRuleIndexNextFree=hm2AgentAclMacRuleIndexNextFree, hm2AgentAclVlanIndex=hm2AgentAclVlanIndex, hm2AgentAclTrapFlag=hm2AgentAclTrapFlag, hm2AgentAclMacTable=hm2AgentAclMacTable, hm2AgentAclIfIndex=hm2AgentAclIfIndex, hm2AgentAclTrapRuleIndex=hm2AgentAclTrapRuleIndex, hm2AgentAclMacRuleSrcMacMask=hm2AgentAclMacRuleSrcMacMask, hm2AgentAclRuleTable=hm2AgentAclRuleTable, hm2AgentAclRuleRateLimitCburst=hm2AgentAclRuleRateLimitCburst, hm2AgentAclTrapRuleTimeRangeEvent=hm2AgentAclTrapRuleTimeRangeEvent, hm2AgentAclIndex=hm2AgentAclIndex, hm2AgentAclIfEntry=hm2AgentAclIfEntry, hm2AgentAclMacRuleIndex=hm2AgentAclMacRuleIndex, hm2AgentAclVlanEntry=hm2AgentAclVlanEntry, hm2AgentAclRuleSrcL4PortRangeEnd=hm2AgentAclRuleSrcL4PortRangeEnd, hm2AgentAclRuleMatchEvery=hm2AgentAclRuleMatchEvery, hm2AgentAclTrapRuleTimeRangeName=hm2AgentAclTrapRuleTimeRangeName, hm2AgentAclIfAclType=hm2AgentAclIfAclType, hm2AgentAclRuleStatsAction=hm2AgentAclRuleStatsAction, hm2AgentAclRuleIpPrecedence=hm2AgentAclRuleIpPrecedence, EtypeValue=EtypeValue, hm2AgentAclRuleIgmpType=hm2AgentAclRuleIgmpType, hm2AgentAclMacIndexNextFree=hm2AgentAclMacIndexNextFree, hm2AgentAclMacRuleAction=hm2AgentAclMacRuleAction, hm2AgentAclMacRuleMatchEvery=hm2AgentAclMacRuleMatchEvery, hm2AgentAclRuleSrcL4PortRangeStart=hm2AgentAclRuleSrcL4PortRangeStart, Ipv6AddressPrefix=Ipv6AddressPrefix, hm2AgentAclTrapRuleLogEvent=hm2AgentAclTrapRuleLogEvent, hm2AgentAclIfAclId=hm2AgentAclIfAclId, hm2AgentAclRuleAssignQueueId=hm2AgentAclRuleAssignQueueId, hm2AgentAclMacRuleTimeRangeName=hm2AgentAclMacRuleTimeRangeName, hm2AgentAclRuleProtocol=hm2AgentAclRuleProtocol, hm2AgentAclMacRuleTable=hm2AgentAclMacRuleTable, hm2AgentAclRuleIpTosBits=hm2AgentAclRuleIpTosBits, hm2AgentAclRuleIcmpType=hm2AgentAclRuleIcmpType, hm2AgentAclMacRuleRateLimitCrate=hm2AgentAclMacRuleRateLimitCrate, hm2AgentAclVlanStatus=hm2AgentAclVlanStatus, hm2AgentAclRuleTimeRangeStatus=hm2AgentAclRuleTimeRangeStatus, hm2AgentAclVlanTable=hm2AgentAclVlanTable, hm2AgentAclMacRuleSrcMacAddr=hm2AgentAclMacRuleSrcMacAddr, hm2AgentAclMacName=hm2AgentAclMacName, hm2AgentAclMacRuleLogging=hm2AgentAclMacRuleLogging, hm2AgentAclRuleDstL4PortOperator=hm2AgentAclRuleDstL4PortOperator, hm2AgentAclVlanDirection=hm2AgentAclVlanDirection, hm2AgentAclMacRuleRedirectIntf=hm2AgentAclMacRuleRedirectIntf, hm2AgentAclRuleSrcL4Port=hm2AgentAclRuleSrcL4Port, hm2AgentAclRuleTcpFlagMask=hm2AgentAclRuleTcpFlagMask, hm2AgentAclTrapRuleHitCountHigh=hm2AgentAclTrapRuleHitCountHigh, PYSNMP_MODULE_ID=hm2PlatformQosAcl, hm2AgentAclLoggingGroup=hm2AgentAclLoggingGroup, hm2PlatformQosAcl=hm2PlatformQosAcl, hm2AgentAclTrapRuleAction=hm2AgentAclTrapRuleAction, hm2AgentAclStatus=hm2AgentAclStatus, hm2AgentAclRuleSrcL4PortOperator=hm2AgentAclRuleSrcL4PortOperator, hm2AgentAclMacIndex=hm2AgentAclMacIndex, hm2AgentAclMacRuleCos2=hm2AgentAclMacRuleCos2, hm2AgentAclMacRuleVlanId=hm2AgentAclMacRuleVlanId, hm2AgentAclRuleHitCountDiscontinuityTime=hm2AgentAclRuleHitCountDiscontinuityTime, hm2AgentAclRuleIPDSCP=hm2AgentAclRuleIPDSCP, hm2AgentAclMacStatus=hm2AgentAclMacStatus, hm2AgentAclRuleRateLimitCrate=hm2AgentAclRuleRateLimitCrate, hm2AgentAclRuleRateLimitCrateUnit=hm2AgentAclRuleRateLimitCrateUnit, hm2AgentAclName=hm2AgentAclName, hm2AgentAclNotifications=hm2AgentAclNotifications, AclBurstSize=AclBurstSize, hm2AgentAclRuleIpTosMask=hm2AgentAclRuleIpTosMask, hm2AgentAclRuleDestIpAddress=hm2AgentAclRuleDestIpAddress, hm2AgentAclRuleSrcIpMask=hm2AgentAclRuleSrcIpMask, hm2AgentAclMacRuleRateLimitCrateUnit=hm2AgentAclMacRuleRateLimitCrateUnit, hm2AgentAclMacRuleHitCountDiscontinuityTime=hm2AgentAclMacRuleHitCountDiscontinuityTime, hm2AgentAclMacRuleVlanId2=hm2AgentAclMacRuleVlanId2, hm2AgentAclMacRuleVlanIdRangeEnd=hm2AgentAclMacRuleVlanIdRangeEnd, hm2AgentAclRuleIndexNextFree=hm2AgentAclRuleIndexNextFree, hm2AgentAclMacRuleVlanIdRangeStart=hm2AgentAclMacRuleVlanIdRangeStart, hm2AgentAclMacRuleDestMacMask=hm2AgentAclMacRuleDestMacMask, hm2AgentAclVlanAclId=hm2AgentAclVlanAclId, hm2AgentAclRuleMirrorIntf=hm2AgentAclRuleMirrorIntf, hm2AgentAclRuleLogging=hm2AgentAclRuleLogging, hm2AgentAclMacRuleTimeRangeStatus=hm2AgentAclMacRuleTimeRangeStatus, hm2AgentAclRuleAction=hm2AgentAclRuleAction, hm2AgentAclIfDirection=hm2AgentAclIfDirection, hm2AgentAclRuleStatus=hm2AgentAclRuleStatus, hm2AgentAclMacRuleAssignQueueId=hm2AgentAclMacRuleAssignQueueId, hm2AgentAclMacRuleHitCount=hm2AgentAclMacRuleHitCount, hm2AgentOperatorRuleAssignOutboundInvalid=hm2AgentOperatorRuleAssignOutboundInvalid, hm2AgentAclRuleEstablished=hm2AgentAclRuleEstablished, hm2AgentAclTable=hm2AgentAclTable, hm2AgentAclNamedIpv4IndexNextFree=hm2AgentAclNamedIpv4IndexNextFree, hm2AgentAclMacRuleVlanId2RangeStart=hm2AgentAclMacRuleVlanId2RangeStart, hm2AgentAclMacRuleVlanId2RangeEnd=hm2AgentAclMacRuleVlanId2RangeEnd, hm2AgentAclRuleFragments=hm2AgentAclRuleFragments, hm2AgentAclRuleSrcIpAddress=hm2AgentAclRuleSrcIpAddress, hm2AgentAclRuleDestL4PortRangeStart=hm2AgentAclRuleDestL4PortRangeStart, hm2AgentAclRuleIcmpCode=hm2AgentAclRuleIcmpCode, hm2AgentAclVlanAclType=hm2AgentAclVlanAclType, hm2AgentAclEntry=hm2AgentAclEntry, hm2AgentAclMacRuleStatsAction=hm2AgentAclMacRuleStatsAction, hm2AgentAclTrapRuleLogEventV1=hm2AgentAclTrapRuleLogEventV1, hm2AgentAclRuleTimeRangeName=hm2AgentAclRuleTimeRangeName, hm2AgentAclTrapRuleHitCount=hm2AgentAclTrapRuleHitCount, hm2AgentAclRuleEntry=hm2AgentAclRuleEntry, hm2AgentAclStatsAction=hm2AgentAclStatsAction, hm2AgentAclRuleIndex=hm2AgentAclRuleIndex, hm2AgentAclMacRuleEntry=hm2AgentAclMacRuleEntry, hm2AgentAclIfSequence=hm2AgentAclIfSequence, Hm2PortOperator=Hm2PortOperator, hm2AgentAclMacRuleEtypeKey=hm2AgentAclMacRuleEtypeKey, hm2AgentAclTrapRuleInstallationStatus=hm2AgentAclTrapRuleInstallationStatus, hm2AgentAclMacStatsAction=hm2AgentAclMacStatsAction, hm2AgentAclMacRuleMirrorIntf=hm2AgentAclMacRuleMirrorIntf, hm2AgentAclRuleDestIpMask=hm2AgentAclRuleDestIpMask, hm2AgentAclIfStatus=hm2AgentAclIfStatus, hm2AgentAclRuleDestL4PortRangeEnd=hm2AgentAclRuleDestL4PortRangeEnd, hm2AgentAclTrapRuleHitCountLow=hm2AgentAclTrapRuleHitCountLow, hm2AgentAclRuleHitCount=hm2AgentAclRuleHitCount, hm2AgentAclMacRuleEtypeValue=hm2AgentAclMacRuleEtypeValue, hm2AgentAclMacRuleDestMacAddr=hm2AgentAclMacRuleDestMacAddr, hm2AgentAclMacRuleCos=hm2AgentAclMacRuleCos, hm2AgentAclTrapRuleTimeRangeNotification=hm2AgentAclTrapRuleTimeRangeNotification, hm2AgentAclRuleDestL4Port=hm2AgentAclRuleDestL4Port, hm2AgentAclRuleRedirectIntf=hm2AgentAclRuleRedirectIntf, hm2AgentAclMacEntry=hm2AgentAclMacEntry, hm2AgentAclMacRuleRateLimitCburst=hm2AgentAclMacRuleRateLimitCburst, hm2AgentAclRuleRedirectExtAgentId=hm2AgentAclRuleRedirectExtAgentId, hm2AgentAclMacRuleStatus=hm2AgentAclMacRuleStatus, hm2AgentAclIfTable=hm2AgentAclIfTable, hm2AgentAclVlanSequence=hm2AgentAclVlanSequence)
