...
_G='seconds'
_F='not-accessible'
_E='RADLAN-TIMESYNCHRONIZATION-MIB'
_D='Integer32'
_C='read-write'
_B='read-only'
_A='current'
...
rlTimeSyncMethodMode=_RlTimeSyncMethodMode_ObjectIdentity((1,3,6,1,4,1,89,92,1))
_RlTimeSyncMibVersion_Type=Integer32
_RlTimeSyncMibVersion_Object=MibScalar
rlTimeSyncMibVersion=_RlTimeSyncMibVersion_Object((1,3,6,1,4,1,89,92,1,1),_RlTimeSyncMibVersion_Type())
...
rndTimeSyncManagedTime=_RndTimeSyncManagedTime_Object((1,3,6,1,4,1,89,92,1,2),_RndTimeSyncManagedTime_Type())
...
rndTimeSyncManagedDate=_RndTimeSyncManagedDate_Object((1,3,6,1,4,1,89,92,1,3),_RndTimeSyncManagedDate_Type())
...
rndTimeSyncManagedDateTime=_RndTimeSyncManagedDateTime_Object((1,3,6,1,4,1,89,92,1,4),_RndTimeSyncManagedDateTime_Type())
...
rlTimeSyncMethod=_RlTimeSyncMethod_Object((1,3,6,1,4,1,89,92,1,5),_RlTimeSyncMethod_Type())
...
rlTimeZone=_RlTimeZone_Object((1,3,6,1,4,1,89,92,1,6),_RlTimeZone_Type())
...
rlTimeZoneCode=_RlTimeZoneCode_Object((1,3,6,1,4,1,89,92,1,7),_RlTimeZoneCode_Type())
...
rlDaylightSavingTimeMode=_RlDaylightSavingTimeMode_Object((1,3,6,1,4,1,89,92,1,8),_RlDaylightSavingTimeMode_Type())
...
rlDaylightSavingTimeStart=_RlDaylightSavingTimeStart_Object((1,3,6,1,4,1,89,92,1,9),_RlDaylightSavingTimeStart_Type())
...
rlDaylightSavingTimeEnd=_RlDaylightSavingTimeEnd_Object((1,3,6,1,4,1,89,92,1,10),_RlDaylightSavingTimeEnd_Type())
...
rlDaylightSavingTimeOffset=_RlDaylightSavingTimeOffset_Object((1,3,6,1,4,1,89,92,1,11),_RlDaylightSavingTimeOffset_Type())
...
rlDaylightSavingTimeCode=_RlDaylightSavingTimeCode_Object((1,3,6,1,4,1,89,92,1,12),_RlDaylightSavingTimeCode_Type())
...
rlTZDSTOffset=_RlTZDSTOffset_Object((1,3,6,1,4,1,89,92,1,13),_RlTZDSTOffset_Type())
...
rlTimeZoneName=_RlTimeZoneName_Object((1,3,6,1,4,1,89,92,1,14),_RlTimeZoneName_Type())
rlTimeZoneName.setMaxAccess(_C)
if mibBuilder.loadTexts:rlTimeZoneName.setStatus(_A)
_RlTimeZoneTable_Object=MibTable
rlTimeZoneTable=_RlTimeZoneTable_Object((1,3,6,1,4,1,89,92,1,15))
if mibBuilder.loadTexts:rlTimeZoneTable.setStatus(_A)
_RlTimeZoneEntry_Object=MibTableRow
rlTimeZoneEntry=_RlTimeZoneEntry_Object((1,3,6,1,4,1,89,92,1,15,1))
...
rlTimeZoneIndex=_RlTimeZoneIndex_Object((1,3,6,1,4,1,89,92,1,15,1,1),_RlTimeZoneIndex_Type())
...
rlTimeZoneTimeSyncMethod=_RlTimeZoneTimeSyncMethod_Object((1,3,6,1,4,1,89,92,1,15,1,2),_RlTimeZoneTimeSyncMethod_Type())
...
rlTimeZoneTimeZoneOffset=_RlTimeZoneTimeZoneOffset_Object((1,3,6,1,4,1,89,92,1,15,1,3),_RlTimeZoneTimeZoneOffset_Type())
...
rlTimeZoneTimeZoneCode=_RlTimeZoneTimeZoneCode_Object((1,3,6,1,4,1,89,92,1,15,1,4),_RlTimeZoneTimeZoneCode_Type())
...
rlTimeZoneDaylightSavingTimeMode=_RlTimeZoneDaylightSavingTimeMode_Object((1,3,6,1,4,1,89,92,1,15,1,5),_RlTimeZoneDaylightSavingTimeMode_Type())
...
rlTimeZoneDaylightSavingTimeStart=_RlTimeZoneDaylightSavingTimeStart_Object((1,3,6,1,4,1,89,92,1,15,1,6),_RlTimeZoneDaylightSavingTimeStart_Type())
...
rlTimeZoneDaylightSavingTimeEnd=_RlTimeZoneDaylightSavingTimeEnd_Object((1,3,6,1,4,1,89,92,1,15,1,7),_RlTimeZoneDaylightSavingTimeEnd_Type())
...
rlTimeZoneDaylightSavingTimeOffset=_RlTimeZoneDaylightSavingTimeOffset_Object((1,3,6,1,4,1,89,92,1,15,1,8),_RlTimeZoneDaylightSavingTimeOffset_Type())
...
rlTimeZoneDaylightSavingTimeCode=_RlTimeZoneDaylightSavingTimeCode_Object((1,3,6,1,4,1,89,92,1,15,1,9),_RlTimeZoneDaylightSavingTimeCode_Type())
...
rlTimeZoneTZDSTOffset=_RlTimeZoneTZDSTOffset_Object((1,3,6,1,4,1,89,92,1,15,1,10),_RlTimeZoneTZDSTOffset_Type())
...
rlTimeZoneTimeZoneName=_RlTimeZoneTimeZoneName_Object((1,3,6,1,4,1,89,92,1,15,1,11),_RlTimeZoneTimeZoneName_Type())
...
rlTimeZoneDataType=_RlTimeZoneDataType_Object((1,3,6,1,4,1,89,92,1,15,1,12),_RlTimeZoneDataType_Type())
...
rlTimeZoneDataSourceIfIndex=_RlTimeZoneDataSourceIfIndex_Object((1,3,6,1,4,1,89,92,1,15,1,13),_RlTimeZoneDataSourceIfIndex_Type())
...
rlTimeZoneDataDynamicConfSource=_RlTimeZoneDataDynamicConfSource_Object((1,3,6,1,4,1,89,92,1,15,1,14),_RlTimeZoneDataDynamicConfSource_Type())
...
rlClockStatus=_RlClockStatus_Object((1,3,6,1,4,1,89,92,1,16),_RlClockStatus_Type())
...
rlDhcpTimezoneOptionEnabled=_RlDhcpTimezoneOptionEnabled_Object((1,3,6,1,4,1,89,92,1,17),_RlDhcpTimezoneOptionEnabled_Type())
...
rlAutomaticClockSetFromPCEnabled=_RlAutomaticClockSetFromPCEnabled_Object((1,3,6,1,4,1,89,92,1,18),_RlAutomaticClockSetFromPCEnabled_Type())
...
rlTimeAndDateHaveBeenSet=_RlTimeAndDateHaveBeenSet_Object((1,3,6,1,4,1,89,92,1,19),_RlTimeAndDateHaveBeenSet_Type())
...
rlSntpNtpClient=_RlSntpNtpClient_ObjectIdentity((1,3,6,1,4,1,89,92,2))
_RlSntpNtpConfig_ObjectIdentity=ObjectIdentity
rlSntpNtpConfig=_RlSntpNtpConfig_ObjectIdentity((1,3,6,1,4,1,89,92,2,1))
_RlSntpNtpMibVersion_Type=Integer32
_RlSntpNtpMibVersion_Object=MibScalar
rlSntpNtpMibVersion=_RlSntpNtpMibVersion_Object((1,3,6,1,4,1,89,92,2,1,1),_RlSntpNtpMibVersion_Type())
...
rlSntpNtpConfigMode=_RlSntpNtpConfigMode_Object((1,3,6,1,4,1,89,92,2,1,2),_RlSntpNtpConfigMode_Type())
...
rlSntpNtpConfigSysStratum=_RlSntpNtpConfigSysStratum_Object((1,3,6,1,4,1,89,92,2,1,3),_RlSntpNtpConfigSysStratum_Type())
...
rlSntpNtpConfigPollInterval=_RlSntpNtpConfigPollInterval_Object((1,3,6,1,4,1,89,92,2,1,4),_RlSntpNtpConfigPollInterval_Type())
...
rlSntpNtpConfigPrimaryPollSrvAddr=_RlSntpNtpConfigPrimaryPollSrvAddr_Object((1,3,6,1,4,1,89,92,2,1,5),_RlSntpNtpConfigPrimaryPollSrvAddr_Type())
...
rlSntpNtpConfigPrimaryPollSrvMrid=_RlSntpNtpConfigPrimaryPollSrvMrid_Object((1,3,6,1,4,1,89,92,2,1,6),_RlSntpNtpConfigPrimaryPollSrvMrid_Type())
...
rlSntpNtpConfigPrimaryPollSrvIfIndex=_RlSntpNtpConfigPrimaryPollSrvIfIndex_Object((1,3,6,1,4,1,89,92,2,1,7),_RlSntpNtpConfigPrimaryPollSrvIfIndex_Type())
...
rlSntpNtpConfigPrimaryPollSrvStratum=_RlSntpNtpConfigPrimaryPollSrvStratum_Object((1,3,6,1,4,1,89,92,2,1,8),_RlSntpNtpConfigPrimaryPollSrvStratum_Type())
...
rlSntpNtpConfigSyncSrvAddr=_RlSntpNtpConfigSyncSrvAddr_Object((1,3,6,1,4,1,89,92,2,1,9),_RlSntpNtpConfigSyncSrvAddr_Type())
...
rlSntpNtpConfigSyncSrvMrid=_RlSntpNtpConfigSyncSrvMrid_Object((1,3,6,1,4,1,89,92,2,1,10),_RlSntpNtpConfigSyncSrvMrid_Type())
...
rlSntpNtpConfigSyncSrvIfIndex=_RlSntpNtpConfigSyncSrvIfIndex_Object((1,3,6,1,4,1,89,92,2,1,11),_RlSntpNtpConfigSyncSrvIfIndex_Type())
...
rlSntpNtpConfigSyncSrvType=_RlSntpNtpConfigSyncSrvType_Object((1,3,6,1,4,1,89,92,2,1,12),_RlSntpNtpConfigSyncSrvType_Type())
...
rlSntpNtpConfigSyncSrvStratum=_RlSntpNtpConfigSyncSrvStratum_Object((1,3,6,1,4,1,89,92,2,1,13),_RlSntpNtpConfigSyncSrvStratum_Type())
...
rlSntpNtpConfigRetryTimeout=_RlSntpNtpConfigRetryTimeout_Object((1,3,6,1,4,1,89,92,2,1,14),_RlSntpNtpConfigRetryTimeout_Type())
...
rlSntpNtpConfigRetryCnt=_RlSntpNtpConfigRetryCnt_Object((1,3,6,1,4,1,89,92,2,1,15),_RlSntpNtpConfigRetryCnt_Type())
...
rlSntpNtpConfigSrvTable=_RlSntpNtpConfigSrvTable_Object((1,3,6,1,4,1,89,92,2,1,16))
if mibBuilder.loadTexts:rlSntpNtpConfigSrvTable.setStatus(_A)
_RlSntpNtpConfigSrvEntry_Object=MibTableRow
rlSntpNtpConfigSrvEntry=_RlSntpNtpConfigSrvEntry_Object((1,3,6,1,4,1,89,92,2,1,16,1))
...
rlSntpNtpConfigSrvEntryType=_RlSntpNtpConfigSrvEntryType_Object((1,3,6,1,4,1,89,92,2,1,16,1,1),_RlSntpNtpConfigSrvEntryType_Type())
...
rlSntpNtpConfigSrvInetAddressType=_RlSntpNtpConfigSrvInetAddressType_Object((1,3,6,1,4,1,89,92,2,1,16,1,2),_RlSntpNtpConfigSrvInetAddressType_Type())
...
rlSntpNtpConfigSrvInetAddress=_RlSntpNtpConfigSrvInetAddress_Object((1,3,6,1,4,1,89,92,2,1,16,1,3),_RlSntpNtpConfigSrvInetAddress_Type())
...
rlSntpNtpConfigSrvMrid=_RlSntpNtpConfigSrvMrid_Object((1,3,6,1,4,1,89,92,2,1,16,1,4),_RlSntpNtpConfigSrvMrid_Type())
...
rlSntpNtpConfigSrvIfIndex=_RlSntpNtpConfigSrvIfIndex_Object((1,3,6,1,4,1,89,92,2,1,16,1,5),_RlSntpNtpConfigSrvIfIndex_Type())
...
rlSntpNtpConfigSrvSyncType=_RlSntpNtpConfigSrvSyncType_Object((1,3,6,1,4,1,89,92,2,1,16,1,6),_RlSntpNtpConfigSrvSyncType_Type())
...
rlSntpNtpConfigSrvStratum=_RlSntpNtpConfigSrvStratum_Object((1,3,6,1,4,1,89,92,2,1,16,1,7),_RlSntpNtpConfigSrvStratum_Type())
...
rlSntpConfig=_RlSntpConfig_ObjectIdentity((1,3,6,1,4,1,89,92,2,2))
...
rlSntpClientMode=_RlSntpClientMode_Object((1,3,6,1,4,1,89,92,2,2,1),_RlSntpClientMode_Type())
...
rlSntpUnicastAdminState=_RlSntpUnicastAdminState_Object((1,3,6,1,4,1,89,92,2,2,2),_RlSntpUnicastAdminState_Type())
...
rlSntpBroadcastAdminState=_RlSntpBroadcastAdminState_Object((1,3,6,1,4,1,89,92,2,2,3),_RlSntpBroadcastAdminState_Type())
...
rlSntpAnycastAdminState=_RlSntpAnycastAdminState_Object((1,3,6,1,4,1,89,92,2,2,4),_RlSntpAnycastAdminState_Type())
...
rlSntpUnicastPollState=_RlSntpUnicastPollState_Object((1,3,6,1,4,1,89,92,2,2,5),_RlSntpUnicastPollState_Type())
...
rlSntpBroadcastPollState=_RlSntpBroadcastPollState_Object((1,3,6,1,4,1,89,92,2,2,6),_RlSntpBroadcastPollState_Type())
...
rlSntpAnycastPollState=_RlSntpAnycastPollState_Object((1,3,6,1,4,1,89,92,2,2,7),_RlSntpAnycastPollState_Type())
...
rlSntpAuthenticationState=_RlSntpAuthenticationState_Object((1,3,6,1,4,1,89,92,2,2,8),_RlSntpAuthenticationState_Type())
...
rlTimeValidFlag=_RlTimeValidFlag_Object((1,3,6,1,4,1,89,92,2,2,9),_RlTimeValidFlag_Type())
...
rlSntpConfigBroadcastTable=_RlSntpConfigBroadcastTable_Object((1,3,6,1,4,1,89,92,2,2,10))
if mibBuilder.loadTexts:rlSntpConfigBroadcastTable.setStatus(_A)
_RlSntpBroadcastEntry_Object=MibTableRow
rlSntpBroadcastEntry=_RlSntpBroadcastEntry_Object((1,3,6,1,4,1,89,92,2,2,10,1))
...
rlSntpBroadcastIfIndex=_RlSntpBroadcastIfIndex_Object((1,3,6,1,4,1,89,92,2,2,10,1,1),_RlSntpBroadcastIfIndex_Type())
...
rlSntpBroadcastIfAdminState=_RlSntpBroadcastIfAdminState_Object((1,3,6,1,4,1,89,92,2,2,10,1,2),_RlSntpBroadcastIfAdminState_Type())
...
rlSntpBroadcastMode=_RlSntpBroadcastMode_Object((1,3,6,1,4,1,89,92,2,2,10,1,3),_RlSntpBroadcastMode_Type())
...
rlSntpBroadcastPolled=_RlSntpBroadcastPolled_Object((1,3,6,1,4,1,89,92,2,2,10,1,4),_RlSntpBroadcastPolled_Type())
...
rlSntpBroadcastAddress=_RlSntpBroadcastAddress_Object((1,3,6,1,4,1,89,92,2,2,10,1,5),_RlSntpBroadcastAddress_Type())
...
rlSntpBroadcastStratum=_RlSntpBroadcastStratum_Object((1,3,6,1,4,1,89,92,2,2,10,1,6),_RlSntpBroadcastStratum_Type())
...
rlSntpBroadcastLastResp=_RlSntpBroadcastLastResp_Object((1,3,6,1,4,1,89,92,2,2,10,1,7),_RlSntpBroadcastLastResp_Type())
...
rlSntpBroadcastStatus=_RlSntpBroadcastStatus_Object((1,3,6,1,4,1,89,92,2,2,10,1,8),_RlSntpBroadcastStatus_Type())
...
rlSntpBroadcastOffset=_RlSntpBroadcastOffset_Object((1,3,6,1,4,1,89,92,2,2,10,1,9),_RlSntpBroadcastOffset_Type())
...
rlSntpBroadcastDelay=_RlSntpBroadcastDelay_Object((1,3,6,1,4,1,89,92,2,2,10,1,10),_RlSntpBroadcastDelay_Type())
...
rlSntpBroadcastRowStatus=_RlSntpBroadcastRowStatus_Object((1,3,6,1,4,1,89,92,2,2,10,1,11),_RlSntpBroadcastRowStatus_Type())
...
rlSntpConfigAnycastTable=_RlSntpConfigAnycastTable_Object((1,3,6,1,4,1,89,92,2,2,11))
if mibBuilder.loadTexts:rlSntpConfigAnycastTable.setStatus(_A)
_RlSntpAnycastEntry_Object=MibTableRow
rlSntpAnycastEntry=_RlSntpAnycastEntry_Object((1,3,6,1,4,1,89,92,2,2,11,1))
...
rlSntpAnycastIfIndex=_RlSntpAnycastIfIndex_Object((1,3,6,1,4,1,89,92,2,2,11,1,1),_RlSntpAnycastIfIndex_Type())
...
rlSntpAnycastAddress=_RlSntpAnycastAddress_Object((1,3,6,1,4,1,89,92,2,2,11,1,2),_RlSntpAnycastAddress_Type())
...
rlSntpAnycastStratum=_RlSntpAnycastStratum_Object((1,3,6,1,4,1,89,92,2,2,11,1,3),_RlSntpAnycastStratum_Type())
...
rlSntpAnycastLastResp=_RlSntpAnycastLastResp_Object((1,3,6,1,4,1,89,92,2,2,11,1,4),_RlSntpAnycastLastResp_Type())
...
rlSntpAnycastStatus=_RlSntpAnycastStatus_Object((1,3,6,1,4,1,89,92,2,2,11,1,5),_RlSntpAnycastStatus_Type())
...
rlSntpAnycastOffset=_RlSntpAnycastOffset_Object((1,3,6,1,4,1,89,92,2,2,11,1,6),_RlSntpAnycastOffset_Type())
...
rlSntpAnycastDelay=_RlSntpAnycastDelay_Object((1,3,6,1,4,1,89,92,2,2,11,1,7),_RlSntpAnycastDelay_Type())
...
rlSntpAnycastRowStatus=_RlSntpAnycastRowStatus_Object((1,3,6,1,4,1,89,92,2,2,11,1,8),_RlSntpAnycastRowStatus_Type())
...
rlSntpConfigServerTable=_RlSntpConfigServerTable_Object((1,3,6,1,4,1,89,92,2,2,12))
if mibBuilder.loadTexts:rlSntpConfigServerTable.setStatus(_A)
_RlSntpServerEntry_Object=MibTableRow
rlSntpServerEntry=_RlSntpServerEntry_Object((1,3,6,1,4,1,89,92,2,2,12,1))
...
rlSntpServerAddress=_RlSntpServerAddress_Object((1,3,6,1,4,1,89,92,2,2,12,1,1),_RlSntpServerAddress_Type())
...
rlSntpServerPolled=_RlSntpServerPolled_Object((1,3,6,1,4,1,89,92,2,2,12,1,2),_RlSntpServerPolled_Type())
...
rlSntpServerStratum=_RlSntpServerStratum_Object((1,3,6,1,4,1,89,92,2,2,12,1,3),_RlSntpServerStratum_Type())
...
rlSntpServerLastResp=_RlSntpServerLastResp_Object((1,3,6,1,4,1,89,92,2,2,12,1,4),_RlSntpServerLastResp_Type())
...
rlSntpServerStatus=_RlSntpServerStatus_Object((1,3,6,1,4,1,89,92,2,2,12,1,5),_RlSntpServerStatus_Type())
...
rlSntpServersOffset=_RlSntpServersOffset_Object((1,3,6,1,4,1,89,92,2,2,12,1,6),_RlSntpServersOffset_Type())
...
rlSntpServersDelay=_RlSntpServersDelay_Object((1,3,6,1,4,1,89,92,2,2,12,1,7),_RlSntpServersDelay_Type())
...
rlSntpServersKeyIdentifier=_RlSntpServersKeyIdentifier_Object((1,3,6,1,4,1,89,92,2,2,12,1,8),_RlSntpServersKeyIdentifier_Type())
...
rlSntpServerRowStatus=_RlSntpServerRowStatus_Object((1,3,6,1,4,1,89,92,2,2,12,1,9),_RlSntpServerRowStatus_Type())
...
rlSntpConfigAuthenticationTable=_RlSntpConfigAuthenticationTable_Object((1,3,6,1,4,1,89,92,2,2,13))
if mibBuilder.loadTexts:rlSntpConfigAuthenticationTable.setStatus(_A)
_RlSntpAuthenticationEntry_Object=MibTableRow
rlSntpAuthenticationEntry=_RlSntpAuthenticationEntry_Object((1,3,6,1,4,1,89,92,2,2,13,1))
...
rlSntpAuthenticationKeyID=_RlSntpAuthenticationKeyID_Object((1,3,6,1,4,1,89,92,2,2,13,1,1),_RlSntpAuthenticationKeyID_Type())
...
rlSntpAuthenticationKeyValue=_RlSntpAuthenticationKeyValue_Object((1,3,6,1,4,1,89,92,2,2,13,1,2),_RlSntpAuthenticationKeyValue_Type())
...
rlSntpAuthenticationKeyState=_RlSntpAuthenticationKeyState_Object((1,3,6,1,4,1,89,92,2,2,13,1,3),_RlSntpAuthenticationKeyState_Type())
...
rlSntpAuthenticationRowStatus=_RlSntpAuthenticationRowStatus_Object((1,3,6,1,4,1,89,92,2,2,13,1,4),_RlSntpAuthenticationRowStatus_Type())
...
rlSntpPort=_RlSntpPort_Object((1,3,6,1,4,1,89,92,2,2,14),_RlSntpPort_Type())
rlSntpPort.setMaxAccess(_C)
if mibBuilder.loadTexts:rlSntpPort.setStatus(_A)
_RlSntpConfigBroadcastInetTable_Object=MibTable
rlSntpConfigBroadcastInetTable=_RlSntpConfigBroadcastInetTable_Object((1,3,6,1,4,1,89,92,2,2,15))
if mibBuilder.loadTexts:rlSntpConfigBroadcastInetTable.setStatus(_A)
_RlSntpBroadcastInetEntry_Object=MibTableRow
rlSntpBroadcastInetEntry=_RlSntpBroadcastInetEntry_Object((1,3,6,1,4,1,89,92,2,2,15,1))
...
rlSntpBroadcastInetIfIndex=_RlSntpBroadcastInetIfIndex_Object((1,3,6,1,4,1,89,92,2,2,15,1,1),_RlSntpBroadcastInetIfIndex_Type())
...
rlSntpBroadcastInetIfAdminState=_RlSntpBroadcastInetIfAdminState_Object((1,3,6,1,4,1,89,92,2,2,15,1,2),_RlSntpBroadcastInetIfAdminState_Type())
...
rlSntpBroadcastInetMode=_RlSntpBroadcastInetMode_Object((1,3,6,1,4,1,89,92,2,2,15,1,3),_RlSntpBroadcastInetMode_Type())
...
rlSntpBroadcastInetPolled=_RlSntpBroadcastInetPolled_Object((1,3,6,1,4,1,89,92,2,2,15,1,4),_RlSntpBroadcastInetPolled_Type())
...
rlSntpBroadcastInetAddressType=_RlSntpBroadcastInetAddressType_Object((1,3,6,1,4,1,89,92,2,2,15,1,5),_RlSntpBroadcastInetAddressType_Type())
...
rlSntpBroadcastInetAddress=_RlSntpBroadcastInetAddress_Object((1,3,6,1,4,1,89,92,2,2,15,1,6),_RlSntpBroadcastInetAddress_Type())
...
rlSntpBroadcastInetStratum=_RlSntpBroadcastInetStratum_Object((1,3,6,1,4,1,89,92,2,2,15,1,7),_RlSntpBroadcastInetStratum_Type())
...
rlSntpBroadcastInetLastResp=_RlSntpBroadcastInetLastResp_Object((1,3,6,1,4,1,89,92,2,2,15,1,8),_RlSntpBroadcastInetLastResp_Type())
...
rlSntpBroadcastInetStatus=_RlSntpBroadcastInetStatus_Object((1,3,6,1,4,1,89,92,2,2,15,1,9),_RlSntpBroadcastInetStatus_Type())
...
rlSntpBroadcastInetOffset=_RlSntpBroadcastInetOffset_Object((1,3,6,1,4,1,89,92,2,2,15,1,10),_RlSntpBroadcastInetOffset_Type())
...
rlSntpBroadcastInetDelay=_RlSntpBroadcastInetDelay_Object((1,3,6,1,4,1,89,92,2,2,15,1,11),_RlSntpBroadcastInetDelay_Type())
...
rlSntpBroadcastInetRowStatus=_RlSntpBroadcastInetRowStatus_Object((1,3,6,1,4,1,89,92,2,2,15,1,12),_RlSntpBroadcastInetRowStatus_Type())
...
rlSntpConfigAnycastInetTable=_RlSntpConfigAnycastInetTable_Object((1,3,6,1,4,1,89,92,2,2,16))
if mibBuilder.loadTexts:rlSntpConfigAnycastInetTable.setStatus(_A)
_RlSntpAnycastInetEntry_Object=MibTableRow
rlSntpAnycastInetEntry=_RlSntpAnycastInetEntry_Object((1,3,6,1,4,1,89,92,2,2,16,1))
...
rlSntpAnycastInetIfIndex=_RlSntpAnycastInetIfIndex_Object((1,3,6,1,4,1,89,92,2,2,16,1,1),_RlSntpAnycastInetIfIndex_Type())
...
rlSntpAnycastInetAddressType=_RlSntpAnycastInetAddressType_Object((1,3,6,1,4,1,89,92,2,2,16,1,2),_RlSntpAnycastInetAddressType_Type())
...
rlSntpAnycastInetAddress=_RlSntpAnycastInetAddress_Object((1,3,6,1,4,1,89,92,2,2,16,1,3),_RlSntpAnycastInetAddress_Type())
...
rlSntpAnycastInetStratum=_RlSntpAnycastInetStratum_Object((1,3,6,1,4,1,89,92,2,2,16,1,4),_RlSntpAnycastInetStratum_Type())
...
rlSntpAnycastInetLastResp=_RlSntpAnycastInetLastResp_Object((1,3,6,1,4,1,89,92,2,2,16,1,5),_RlSntpAnycastInetLastResp_Type())
...
rlSntpAnycastInetStatus=_RlSntpAnycastInetStatus_Object((1,3,6,1,4,1,89,92,2,2,16,1,6),_RlSntpAnycastInetStatus_Type())
...
rlSntpAnycastInetOffset=_RlSntpAnycastInetOffset_Object((1,3,6,1,4,1,89,92,2,2,16,1,7),_RlSntpAnycastInetOffset_Type())
...
rlSntpAnycastInetDelay=_RlSntpAnycastInetDelay_Object((1,3,6,1,4,1,89,92,2,2,16,1,8),_RlSntpAnycastInetDelay_Type())
...
rlSntpAnycastInetRowStatus=_RlSntpAnycastInetRowStatus_Object((1,3,6,1,4,1,89,92,2,2,16,1,9),_RlSntpAnycastInetRowStatus_Type())
...
rlSntpConfigServerInetTable=_RlSntpConfigServerInetTable_Object((1,3,6,1,4,1,89,92,2,2,17))
if mibBuilder.loadTexts:rlSntpConfigServerInetTable.setStatus(_A)
_RlSntpServerInetEntry_Object=MibTableRow
rlSntpServerInetEntry=_RlSntpServerInetEntry_Object((1,3,6,1,4,1,89,92,2,2,17,1))
...
rlSntpServerInetAddressType=_RlSntpServerInetAddressType_Object((1,3,6,1,4,1,89,92,2,2,17,1,1),_RlSntpServerInetAddressType_Type())
...
rlSntpServerInetAddress=_RlSntpServerInetAddress_Object((1,3,6,1,4,1,89,92,2,2,17,1,2),_RlSntpServerInetAddress_Type())
...
rlSntpServerInetPolled=_RlSntpServerInetPolled_Object((1,3,6,1,4,1,89,92,2,2,17,1,3),_RlSntpServerInetPolled_Type())
...
rlSntpServerInetStratum=_RlSntpServerInetStratum_Object((1,3,6,1,4,1,89,92,2,2,17,1,4),_RlSntpServerInetStratum_Type())
...
rlSntpServerInetLastResp=_RlSntpServerInetLastResp_Object((1,3,6,1,4,1,89,92,2,2,17,1,5),_RlSntpServerInetLastResp_Type())
...
rlSntpServerInetStatus=_RlSntpServerInetStatus_Object((1,3,6,1,4,1,89,92,2,2,17,1,6),_RlSntpServerInetStatus_Type())
...
rlSntpServerInetOffset=_RlSntpServerInetOffset_Object((1,3,6,1,4,1,89,92,2,2,17,1,7),_RlSntpServerInetOffset_Type())
...
rlSntpServerInetDelay=_RlSntpServerInetDelay_Object((1,3,6,1,4,1,89,92,2,2,17,1,8),_RlSntpServerInetDelay_Type())
...
rlSntpServerInetKeyIdentifier=_RlSntpServerInetKeyIdentifier_Object((1,3,6,1,4,1,89,92,2,2,17,1,9),_RlSntpServerInetKeyIdentifier_Type())
...
rlSntpServerInetRowStatus=_RlSntpServerInetRowStatus_Object((1,3,6,1,4,1,89,92,2,2,17,1,10),_RlSntpServerInetRowStatus_Type())
...
rlSntpAllServerInetTable=_RlSntpAllServerInetTable_Object((1,3,6,1,4,1,89,92,2,2,18))
if mibBuilder.loadTexts:rlSntpAllServerInetTable.setStatus(_A)
_RlSntpAllServerInetEntry_Object=MibTableRow
rlSntpAllServerInetEntry=_RlSntpAllServerInetEntry_Object((1,3,6,1,4,1,89,92,2,2,18,1))
...
rlSntpAllServerSource=_RlSntpAllServerSource_Object((1,3,6,1,4,1,89,92,2,2,18,1,1),_RlSntpAllServerSource_Type())
...
rlSntpAllServerIfIndex=_RlSntpAllServerIfIndex_Object((1,3,6,1,4,1,89,92,2,2,18,1,2),_RlSntpAllServerIfIndex_Type())
...
rlSntpAllServerPreference=_RlSntpAllServerPreference_Object((1,3,6,1,4,1,89,92,2,2,18,1,3),_RlSntpAllServerPreference_Type())
...
rlSntpAllServerInetAddressType=_RlSntpAllServerInetAddressType_Object((1,3,6,1,4,1,89,92,2,2,18,1,4),_RlSntpAllServerInetAddressType_Type())
...
rlSntpAllServerInetAddress=_RlSntpAllServerInetAddress_Object((1,3,6,1,4,1,89,92,2,2,18,1,5),_RlSntpAllServerInetAddress_Type())
...
rlSntpAllServerInetPolled=_RlSntpAllServerInetPolled_Object((1,3,6,1,4,1,89,92,2,2,18,1,6),_RlSntpAllServerInetPolled_Type())
...
rlSntpAllServerInetStratum=_RlSntpAllServerInetStratum_Object((1,3,6,1,4,1,89,92,2,2,18,1,7),_RlSntpAllServerInetStratum_Type())
...
rlSntpAllServerInetLastResp=_RlSntpAllServerInetLastResp_Object((1,3,6,1,4,1,89,92,2,2,18,1,8),_RlSntpAllServerInetLastResp_Type())
...
rlSntpAllServerInetStatus=_RlSntpAllServerInetStatus_Object((1,3,6,1,4,1,89,92,2,2,18,1,9),_RlSntpAllServerInetStatus_Type())
...
rlSntpAllServerInetOffset=_RlSntpAllServerInetOffset_Object((1,3,6,1,4,1,89,92,2,2,18,1,10),_RlSntpAllServerInetOffset_Type())
...
rlSntpAllServerInetDelay=_RlSntpAllServerInetDelay_Object((1,3,6,1,4,1,89,92,2,2,18,1,11),_RlSntpAllServerInetDelay_Type())
...
rlSntpAllServerInetKeyIdentifier=_RlSntpAllServerInetKeyIdentifier_Object((1,3,6,1,4,1,89,92,2,2,18,1,12),_RlSntpAllServerInetKeyIdentifier_Type())
...
rlSntpRestoreDefaultServers=_RlSntpRestoreDefaultServers_Object((1,3,6,1,4,1,89,92,2,2,19),_RlSntpRestoreDefaultServers_Type())
...
rlNtpConfig=_RlNtpConfig_ObjectIdentity((1,3,6,1,4,1,89,92,2,3))
