...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/radlan/RADLAN-TIMESYNCHRONIZATION-MIB
...
rlSntpAuthenticationKeyValue = MibTableColumn((1, 3, 6, 1, 4, 1, 89, 92, 2, 2, 13, 1, 2), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 32))).setMaxAccess("readwrite")
