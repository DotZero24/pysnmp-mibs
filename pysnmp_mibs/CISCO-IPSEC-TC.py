...
mibBuilder.exportSymbols("CISCO-IPSEC-TC", CIPsecIkeHashAlgorithm=CIPsecIkeHashAlgorithm, CIPsecControlProtocol=CIPsecControlProtocol, CIPsecIkeAuthMethod=CIPsecIkeAuthMethod, CIPsecPhase1PeerIdentityType=CIPsecPhase1PeerIdentityType, CIPsecPhase2SaDirection=CIPsecPhase2SaDirection, CCryptoMD5Hash=CCryptoMD5Hash, CIPsecNumCryptoMaps=CIPsecNumCryptoMaps, CIPsecPhase1TunnelIndexOrZero=CIPsecPhase1TunnelIndexOrZero, CIKELifetime=CIKELifetime, CIPsecTunnelIdleTime=CIPsecTunnelIdleTime, CIPsecProtocol=CIPsecProtocol, CIPsecPhase1TunnelIndex=CIPsecPhase1TunnelIndex, CIPsecLifesize=CIPsecLifesize, CIPsecSecuritySuite=CIPsecSecuritySuite, CIPsecEndPtType=CIPsecEndPtType, CIPsecIkeNegoMode=CIPsecIkeNegoMode, CIPsecEncryptAlgorithm=CIPsecEncryptAlgorithm, CIPsecEncryptionKeySize=CIPsecEncryptionKeySize, CIPsecSpi=CIPsecSpi, CIPsecCryptomapType=CIPsecCryptomapType, CIPsecCompAlgorithm=CIPsecCompAlgorithm, CIPsecTunnelStatus=CIPsecTunnelStatus, PYSNMP_MODULE_ID=ciscoIPsecTc, CIPsecTransform=CIPsecTransform, CIKELifesize=CIKELifesize, CIPsecIkePRFAlgorithm=CIPsecIkePRFAlgorithm, CIPsecEncapMode=CIPsecEncapMode, CIPsecPhase2TunnelIndex=CIPsecPhase2TunnelIndex, CIPsecCryptomapSetBindStatus=CIPsecCryptomapSetBindStatus, CIPsecAuthAlgorithm=CIPsecAuthAlgorithm, CIPsecPmtu=CIPsecPmtu, CIPsecLifetime=CIPsecLifetime, CIPsecDiffHellmanGrp=CIPsecDiffHellmanGrp, CIKEIsakmpDoi=CIKEIsakmpDoi, ciscoIPsecTc=ciscoIPsecTc, CIPsecNATTraversalMode=CIPsecNATTraversalMode)
