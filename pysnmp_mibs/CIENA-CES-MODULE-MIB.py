...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/ciena/CIENA-CES-MODULE-MIB
...
cienaCesModuleLatchLocation = MibTableColumn((1, 3, 6, 1, 4, 1, 1271, 2, 1, 2, 1, 2, 1, 1, 21), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: cienaCesModuleLatchLocation.setStatus('current')
...
cienaCesModuleBladeInsertedNotification = NotificationType((1, 3, 6, 1, 4, 1, 1271, 2, 2, 3, 0, 20)).setObjects(("CIENA-GLOBAL-MIB", "cienaGlobalSeverity"), ("CIENA-GLOBAL-MIB", "cienaGlobalMacAddress"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleChassisNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleShelfNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleModel"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotName"))
if mibBuilder.loadTexts: cienaCesModuleBladeInsertedNotification.setStatus('current')
cienaCesModuleBladeRemovedNotification = NotificationType((1, 3, 6, 1, 4, 1, 1271, 2, 2, 3, 0, 21)).setObjects(("CIENA-GLOBAL-MIB", "cienaGlobalSeverity"), ("CIENA-GLOBAL-MIB", "cienaGlobalMacAddress"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleChassisNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleShelfNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleModel"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotName"))
if mibBuilder.loadTexts: cienaCesModuleBladeRemovedNotification.setStatus('current')
cienaCesModuleSwitchFabricDisruptedRecoverableClrNotification = NotificationType((1, 3, 6, 1, 4, 1, 1271, 2, 2, 3, 0, 22)).setObjects(("CIENA-GLOBAL-MIB", "cienaGlobalSeverity"), ("CIENA-GLOBAL-MIB", "cienaGlobalMacAddress"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleChassisNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleShelfNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotNotifIndx"))
if mibBuilder.loadTexts: cienaCesModuleSwitchFabricDisruptedRecoverableClrNotification.setStatus('current')
cienaCesModuleConfigEntryCreatedNotification = NotificationType((1, 3, 6, 1, 4, 1, 1271, 2, 2, 3, 0, 23)).setObjects(("CIENA-GLOBAL-MIB", "cienaGlobalSeverity"), ("CIENA-GLOBAL-MIB", "cienaGlobalMacAddress"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleChassisNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleShelfNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleModel"))
if mibBuilder.loadTexts: cienaCesModuleConfigEntryCreatedNotification.setStatus('current')
cienaCesModuleConfigEntryDeletedNotification = NotificationType((1, 3, 6, 1, 4, 1, 1271, 2, 2, 3, 0, 24)).setObjects(("CIENA-GLOBAL-MIB", "cienaGlobalSeverity"), ("CIENA-GLOBAL-MIB", "cienaGlobalMacAddress"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleChassisNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleShelfNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleModel"))
if mibBuilder.loadTexts: cienaCesModuleConfigEntryDeletedNotification.setStatus('current')
cienaCesClockRateMismatchNotification = NotificationType((1, 3, 6, 1, 4, 1, 1271, 2, 2, 3, 0, 25)).setObjects(("CIENA-GLOBAL-MIB", "cienaGlobalSeverity"), ("CIENA-GLOBAL-MIB", "cienaGlobalMacAddress"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleChassisNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleShelfNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotNotifIndx"))
if mibBuilder.loadTexts: cienaCesClockRateMismatchNotification.setStatus('current')
cienaCesModuleIncompatibilityNotification = NotificationType((1, 3, 6, 1, 4, 1, 1271, 2, 2, 3, 0, 26)).setObjects(("CIENA-GLOBAL-MIB", "cienaGlobalSeverity"), ("CIENA-GLOBAL-MIB", "cienaGlobalMacAddress"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleChassisNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleShelfNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleModel"))
if mibBuilder.loadTexts: cienaCesModuleIncompatibilityNotification.setStatus('current')
cienaCesModuleLatchOpenNotification = NotificationType((1, 3, 6, 1, 4, 1, 1271, 2, 2, 3, 0, 27)).setObjects(("CIENA-GLOBAL-MIB", "cienaGlobalSeverity"), ("CIENA-GLOBAL-MIB", "cienaGlobalMacAddress"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleChassisNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleShelfNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleSlotNotifIndx"), ("CIENA-CES-MODULE-MIB", "cienaCesModuleLatchLocation"))
if mibBuilder.loadTexts: cienaCesModuleLatchOpenNotification.setStatus('current')
...
mibBuilder.exportSymbols("CIENA-CES-MODULE-MIB", cienaCesModuleSlotName=cienaCesModuleSlotName, cienaCesModuleResourceHealthMaxThreshold=cienaCesModuleResourceHealthMaxThreshold, cienaCesModuleHealthStatusFaultedNotification=cienaCesModuleHealthStatusFaultedNotification, cienaCesModuleHealthStatusGoodNotification=cienaCesModuleHealthStatusGoodNotification, cienaCesModuleTable=cienaCesModuleTable, cienaCesModulePOSTErrorScope=cienaCesModulePOSTErrorScope, cienaCesModuleLatchLocation=cienaCesModuleLatchLocation, cienaCesModuleIDPModuleSerialNumber=cienaCesModuleIDPModuleSerialNumber, cienaCesModuleSwBank1UbootVersion=cienaCesModuleSwBank1UbootVersion, cienaCesModuleHealthOriginType=cienaCesModuleHealthOriginType, moduleSensorGroup=moduleSensorGroup, cienaCesModuleSensorHighTemp=cienaCesModuleSensorHighTemp, cienaCesModuleSwMIBVer=cienaCesModuleSwMIBVer, cienaCesModuleSystemProtectionMode=cienaCesModuleSystemProtectionMode, cienaCesModuleHealthStatusDegradedNotification=cienaCesModuleHealthStatusDegradedNotification, cienaCesModuleShelfIndx=cienaCesModuleShelfIndx, cienaCesModuleIDPEthBaseMac=cienaCesModuleIDPEthBaseMac, cienaCesModuleGlobal=cienaCesModuleGlobal, TceHealthCategory=TceHealthCategory, cienaCesModuleSlotNotifIndx=cienaCesModuleSlotNotifIndx, cienaCesModuleSwitchFabricDisruptedRecoverableClrNotification=cienaCesModuleSwitchFabricDisruptedRecoverableClrNotification, cienaCesModuleTempSensorTable=cienaCesModuleTempSensorTable, cienaCesModuleProtectionModeUnprotectedNotification=cienaCesModuleProtectionModeUnprotectedNotification, cienaCesModuleResourceHealthCurrMeasurement=cienaCesModuleResourceHealthCurrMeasurement, cienaCesModuleMIBGroups=cienaCesModuleMIBGroups, cienaCesModuleIDPModelPartNumber=cienaCesModuleIDPModelPartNumber, cienaCesModuleSwitchOverReason=cienaCesModuleSwitchOverReason, cienaCesModuleSwitchFabricDisruptedRecoverableNotification=cienaCesModuleSwitchFabricDisruptedRecoverableNotification, cienaCesModuleIDPSWCompat=cienaCesModuleIDPSWCompat, cienaCesModuleGlobalPostState=cienaCesModuleGlobalPostState, cienaCesModuleType=cienaCesModuleType, cienaCesModuleMIBObjects=cienaCesModuleMIBObjects, cienaCesModuleSensorLowTempThreshold=cienaCesModuleSensorLowTempThreshold, cienaCesModuleDescriptionUpTime=cienaCesModuleDescriptionUpTime, cienaCesModuleHealthStatusUnknownNotification=cienaCesModuleHealthStatusUnknownNotification, cienaCesModuleDescriptionBoardSerialNum=cienaCesModuleDescriptionBoardSerialNum, cienaCesModuleHealthStatusWarningNotification=cienaCesModuleHealthStatusWarningNotification, cienaCesModuleIDPModelRevision=cienaCesModuleIDPModelRevision, cienaCesModuleHealthCategory=cienaCesModuleHealthCategory, cienaCesModuleConfigEntryDeletedNotification=cienaCesModuleConfigEntryDeletedNotification, cienaCesModuleResourceHealthSubCategory=cienaCesModuleResourceHealthSubCategory, cienaCesModuleSwBank0KernelStatus=cienaCesModuleSwBank0KernelStatus, cienaCesModuleSwReleasePartition0Pkg=cienaCesModuleSwReleasePartition0Pkg, cienaCesModulePostErrorNotification=cienaCesModulePostErrorNotification, cienaCesModuleIDPTable=cienaCesModuleIDPTable, moduleNotifGroup=moduleNotifGroup, cienaCesModuleChassisNotifIndx=cienaCesModuleChassisNotifIndx, cienaCesModuleAdminState=cienaCesModuleAdminState, cienaCesModuleProtectionModeHotNotification=cienaCesModuleProtectionModeHotNotification, cienaCesModuleSensorDescription=cienaCesModuleSensorDescription, cienaCesModuleSwRunningReleasePartition=cienaCesModuleSwRunningReleasePartition, cienaCesModuleSensorNotifIndx=cienaCesModuleSensorNotifIndx, cienaCesModuleProtectionModeColdNotification=cienaCesModuleProtectionModeColdNotification, cienaCesModuleSwReleasePartition0PkgStatus=cienaCesModuleSwReleasePartition0PkgStatus, cienaCesModuleHitlessModeUnsuccessfulNotification=cienaCesModuleHitlessModeUnsuccessfulNotification, cienaCesModuleMIBNotifications=cienaCesModuleMIBNotifications, cienaCesModuleSensorLowTempNotification=cienaCesModuleSensorLowTempNotification, cienaCesModuleLastRebootReason=cienaCesModuleLastRebootReason, cienaCesGlobalSwState=cienaCesGlobalSwState, cienaCesModuleSwBank1KernelVersion=cienaCesModuleSwBank1KernelVersion, cienaCesModuleHealthStatusLast=cienaCesModuleHealthStatusLast, cienaCesModuleIDPCleiCode=cienaCesModuleIDPCleiCode, cienaCesModuleMIB=cienaCesModuleMIB, cienaCesModuleDescriptionBoardPartNum=cienaCesModuleDescriptionBoardPartNum, cienaCesModuleResourceHealthTable=cienaCesModuleResourceHealthTable, cienaCesModuleSwUbootGoldVersion=cienaCesModuleSwUbootGoldVersion, cienaCesModuleResourceHealthEntry=cienaCesModuleResourceHealthEntry, moduleDescriptionGroup=moduleDescriptionGroup, cienaCesModuleMIBCompliances=cienaCesModuleMIBCompliances, cienaCesModuleSwBank1KernelStatus=cienaCesModuleSwBank1KernelStatus, cienaCesModuleFastReloadUnsuccessfulNotification=cienaCesModuleFastReloadUnsuccessfulNotification, cienaCesModuleDescriptionMfgDate=cienaCesModuleDescriptionMfgDate, cienaCesModuleIDPBarcode=cienaCesModuleIDPBarcode, cienaCesSwModule=cienaCesSwModule, cienaCesModulePOSTErrorDescription=cienaCesModulePOSTErrorDescription, cienaCesModuleDescriptionBoardDesc=cienaCesModuleDescriptionBoardDesc, cienaCesModuleTempSensorEntry=cienaCesModuleTempSensorEntry, cienaCesModuleIDPEthBaseMacRange=cienaCesModuleIDPEthBaseMacRange, cienaCesModuleSwReleasePartition1Pkg=cienaCesModuleSwReleasePartition1Pkg, cienaCesModuleSwReleasePartition2Pkg=cienaCesModuleSwReleasePartition2Pkg, cienaCesModuleResourceHealthState=cienaCesModuleResourceHealthState, cienaCesModuleIDPFTC=cienaCesModuleIDPFTC, cienaCesModuleSwState=cienaCesModuleSwState, cienaCesModuleConfigEntryCreatedNotification=cienaCesModuleConfigEntryCreatedNotification, cienaCesModuleDescription=cienaCesModuleDescription, cienaCesModuleMIBNotificationPrefix=cienaCesModuleMIBNotificationPrefix, cienaCesModulePOSTErrorTable=cienaCesModulePOSTErrorTable, cienaCesModuleOperState=cienaCesModuleOperState, cienaCesModule=cienaCesModule, cienaCesModuleStandbyStatus=cienaCesModuleStandbyStatus, cienaCesModuleHealthSubCategory=cienaCesModuleHealthSubCategory, cienaCesModuleSlotIndx=cienaCesModuleSlotIndx, cienaCesModuleLatchOpenNotification=cienaCesModuleLatchOpenNotification, cienaCesModuleHealthStatus=cienaCesModuleHealthStatus, cienaCesModulePOSTErrorIndex=cienaCesModulePOSTErrorIndex, cienaCesModuleSensorIndx=cienaCesModuleSensorIndx, cienaCesModuleSwRunningRelease=cienaCesModuleSwRunningRelease, cienaCesModuleTrapState=cienaCesModuleTrapState, cienaCesModuleIDPMfgDate=cienaCesModuleIDPMfgDate, cienaCesModuleSensorHighTempThreshold=cienaCesModuleSensorHighTempThreshold, cienaCesModuleNotifTable=cienaCesModuleNotifTable, cienaCesModuleSensorCurrentTemp=cienaCesModuleSensorCurrentTemp, SwModuleState=SwModuleState, cienaCesModuleSensorHighTempNotification=cienaCesModuleSensorHighTempNotification, cienaCesModuleEntry=cienaCesModuleEntry, cienaCesModuleBladeRemovedNotification=cienaCesModuleBladeRemovedNotification, cienaCesModuleBladeInsertedNotification=cienaCesModuleBladeInsertedNotification, cienaCesModuleDescriptionBoardName=cienaCesModuleDescriptionBoardName, cienaCesModuleIncompatibilityNotification=cienaCesModuleIncompatibilityNotification, cienaCesModuleHealthOriginName=cienaCesModuleHealthOriginName, cienaCesModuleChassisIndx=cienaCesModuleChassisIndx, cienaCesModuleHealthOriginUnitId=cienaCesModuleHealthOriginUnitId, cienaCesModuleDescriptionTotalNumPorts=cienaCesModuleDescriptionTotalNumPorts, cienaCesModuleIDPProductID=cienaCesModuleIDPProductID, cienaCesModuleSwUbootGoldStatus=cienaCesModuleSwUbootGoldStatus, cienaCesClockRateMismatchNotification=cienaCesClockRateMismatchNotification, cienaCesModulePOSTErrorEntry=cienaCesModulePOSTErrorEntry, cienaCesModuleHASwitchOverNotification=cienaCesModuleHASwitchOverNotification, cienaCesModuleSwTable=cienaCesModuleSwTable, SwPkgStatus=SwPkgStatus, cienaCesModuleSwReleasePartition2PkgStatus=cienaCesModuleSwReleasePartition2PkgStatus, cienaCesModuleProtectionRole=cienaCesModuleProtectionRole, cienaCesModulePOSTScopeIndex=cienaCesModulePOSTScopeIndex, cienaCesModuleNotifEntry=cienaCesModuleNotifEntry, cienaCesModuleResourceHealthMaxMeasurement=cienaCesModuleResourceHealthMaxMeasurement, cienaCesModuleSensorNormalTempNotification=cienaCesModuleSensorNormalTempNotification, cienaCesModuleStateChangeNotification=cienaCesModuleStateChangeNotification, cienaCesModuleDescriptionEntry=cienaCesModuleDescriptionEntry, cienaCesModuleResourceDeviceIndx=cienaCesModuleResourceDeviceIndx, cienaCesModuleSwBank1UbootStatus=cienaCesModuleSwBank1UbootStatus, cienaCesModuleSwEntry=cienaCesModuleSwEntry, TceHealthStatus=TceHealthStatus, cienaCesModuleNotifAttrs=cienaCesModuleNotifAttrs, cienaCesModuleSwBank0UbootStatus=cienaCesModuleSwBank0UbootStatus, HealthOriginType=HealthOriginType, cienaCesModuleDescriptionHwVersion=cienaCesModuleDescriptionHwVersion, cienaCesModuleOperPostState=cienaCesModuleOperPostState, moduleConfigGroup=moduleConfigGroup, cienaCesModuleIDPEntry=cienaCesModuleIDPEntry, modulePostErrorGroup=modulePostErrorGroup, cienaCesModuleDescriptionTable=cienaCesModuleDescriptionTable, cienaCesModulePOSTErrorSeverity=cienaCesModulePOSTErrorSeverity, cienaCesModuleProtectionModeWarmNotification=cienaCesModuleProtectionModeWarmNotification, cienaCesModuleShelfNotifIndx=cienaCesModuleShelfNotifIndx, cienaCesModuleDescriptionBaseMac=cienaCesModuleDescriptionBaseMac, cienaCesModuleAdminPostState=cienaCesModuleAdminPostState, cienaCesModuleSensorLowTemp=cienaCesModuleSensorLowTemp, cienaCesModuleSwitchFabricDisruptedUnrecoverableNotification=cienaCesModuleSwitchFabricDisruptedUnrecoverableNotification, cienaCesModuleModel=cienaCesModuleModel, cienaCesModuleSwReleasePartition1PkgStatus=cienaCesModuleSwReleasePartition1PkgStatus, cienaCesModuleSwBank0KernelVersion=cienaCesModuleSwBank0KernelVersion, cienaCesModuleConformance=cienaCesModuleConformance, PYSNMP_MODULE_ID=cienaCesModuleMIB, cienaCesModuleSwBank0UbootVersion=cienaCesModuleSwBank0UbootVersion)
