# SNMP MIB module (LJM9050mfp-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/hp/LJM9050mfp-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:36:59 2025
...
mio2_ip_address = _Mio2_ip_address_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 3, 2, 6),
    _Mio2_ip_address_Type()
)
mio2_ip_address.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mio2_ip_address.setStatus("optional")
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "mio2-type": mio2_type,
       "mio2-ip-address": mio2_ip_address,
       "mio4": mio4,
