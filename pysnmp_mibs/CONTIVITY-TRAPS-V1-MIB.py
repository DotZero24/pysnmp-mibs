...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/nortel/CONTIVITY-TRAPS-V1-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:02:25 2025
...
sysObjectID, snmp, sysName = mibBuilder.importSymbols("SNMPv2-MIB", "sysObjectID", "snmp", "sysName")
...
mibBuilder.exportSymbols("CONTIVITY-TRAPS-V1-MIB", ifPhysRelPos_ces=ifPhysRelPos_ces, cpuTwoStatus=cpuTwoStatus, snmpAgentInterfaceInfo_ces=snmpAgentInterfaceInfo_ces, powerUpTrap=powerUpTrap, loginCESTrapInfo=loginCESTrapInfo, vrrpStatusTrap=vrrpStatusTrap, firewallRuleTriggeredTrap=firewallRuleTriggeredTrap, briWANStatusTrap=briWANStatusTrap, firewallRuleType_ces=firewallRuleType_ces, adslWANStatus=adslWANStatus, hwAccelStatus=hwAccelStatus, periodicHeartbeat=periodicHeartbeat, hardDisk0Status=hardDisk0Status, twelveVoltsPositveTrap=twelveVoltsPositveTrap, gdsServerTrap=gdsServerTrap, securityIntrusion=securityIntrusion, chassisIntrusionTrap=chassisIntrusionTrap, FirewallPolicyType_ces=FirewallPolicyType_ces, ospfServerTrap=ospfServerTrap, t1WANStatus=t1WANStatus, chassisFanStatusTrap=chassisFanStatusTrap, snmpAgentTrapInfo_ces=snmpAgentTrapInfo_ces, fireWall=fireWall, hardwareCESTrapInfo=hardwareCESTrapInfo, routePolicyStatusTrap=routePolicyStatusTrap, briWANStatus=briWANStatus, licensingStatus=licensingStatus, serverCESTrapInfo=serverCESTrapInfo, contivityTrapsV1=contivityTrapsV1, systemDate=systemDate, criticalTemperatureTrap=criticalTemperatureTrap, FirewallRuleType_ces=FirewallRuleType_ces, extLDAPServer=extLDAPServer, sshServerTrap=sshServerTrap, ripStatusTrap=ripStatusTrap, ifTunnelRemoteIpAddr_ces=ifTunnelRemoteIpAddr_ces, intLDAPServerTrap=intLDAPServerTrap, intrusionCESTrapInfo=intrusionCESTrapInfo, chassisIntrusion=chassisIntrusion, IfReasonForStatus_ces=IfReasonForStatus_ces, tunnelGuardStatusTrap=tunnelGuardStatusTrap, radiusAcctServerTrap=radiusAcctServerTrap, ipAddressPoolTrap=ipAddressPoolTrap, cRoutesMStatus=cRoutesMStatus, v90WANStatusTrap=v90WANStatusTrap, usrIpAddrStatus=usrIpAddrStatus, usrIpAddrStatusTrap=usrIpAddrStatusTrap, ocspServer=ocspServer, ospfServer=ospfServer, hwAccelTrap=hwAccelTrap, firewallProtocolID_ces=firewallProtocolID_ces, memoryUsage=memoryUsage, crlServer=crlServer, antiSpoofingStatus=antiSpoofingStatus, firewallPolicyType_ces=firewallPolicyType_ces, certificateServer=certificateServer, snmpAgentFirewallInfo_ces=snmpAgentFirewallInfo_ces, backupServerTrap=backupServerTrap, natStatus=natStatus, snmpServer=snmpServer, gdsServer=gdsServer, twelveVoltsMinus=twelveVoltsMinus, t3WANStatus=t3WANStatus, sslVpnStatusTrap=sslVpnStatusTrap, ntpServerTrap=ntpServerTrap, fipsStatusTrap=fipsStatusTrap, dhcpServerTrap=dhcpServerTrap, systemTime=systemTime, ipsecFailoverStatusTrap=ipsecFailoverStatusTrap, periodicHeartbeatTrap=periodicHeartbeatTrap, snmpAuthenCommString_ces=snmpAuthenCommString_ces, demandintfServer=demandintfServer, diskRedundencyTrap=diskRedundencyTrap, serUartStatus=serUartStatus, securityIntrusionTrap=securityIntrusionTrap, twoDotFiveVA=twoDotFiveVA, threeVoltsPositiveTrap=threeVoltsPositiveTrap, radiusAcctServer=radiusAcctServer, ipsecFailoverStatus=ipsecFailoverStatus, loadBalancingServer=loadBalancingServer, fiveVoltsMinus=fiveVoltsMinus, fiveVoltsPosStatusTrap=fiveVoltsPosStatusTrap, mcastRelayStatusTrap=mcastRelayStatusTrap, fiveVoltsMinusTrap=fiveVoltsMinusTrap, ocspServerTrap=ocspServerTrap, igmpStatusTrap=igmpStatusTrap, dualPowerSupply=dualPowerSupply, ripStatus=ripStatus, ipAddressPool=ipAddressPool, firewallRuleAction_ces=firewallRuleAction_ces, normalTemperatureTrap=normalTemperatureTrap, extLDAPServerTrap=extLDAPServerTrap, sslVpnStatus=sslVpnStatus, dhcprelayServer=dhcprelayServer, dlswStatus=dlswStatus, dlswStatusTrap=dlswStatusTrap, mcastRelayStatus=mcastRelayStatus, tunnelGuardStatus=tunnelGuardStatus, PYSNMP_MODULE_ID=contivityTrapsV1, powerUpTrapEntry=powerUpTrapEntry, diskRedundency=diskRedundency, certificateServerTrap=certificateServerTrap, chassisFanStatus=chassisFanStatus, sshServer=sshServer, netBuffers=netBuffers, cpuTwoStatusTrap=cpuTwoStatusTrap, hardDisk1Status=hardDisk1Status, radiusAuthServerTrap=radiusAuthServerTrap, extLDAPAuthServerTrap=extLDAPAuthServerTrap, ifPhysLocation_ces=ifPhysLocation_ces, dnsServerTrap=dnsServerTrap, t3WANStatusTrap=t3WANStatusTrap, FirewallRuleAction_ces=FirewallRuleAction_ces, ifReasonForStatus_ces=ifReasonForStatus_ces, firewallSrcAddr_ces=firewallSrcAddr_ces, intLDAPServer=intLDAPServer, v90WANStatus=v90WANStatus, serviceCESTrapInfo=serviceCESTrapInfo, clipServer=clipServer, dhcprelayServerTrap=dhcprelayServerTrap, cmpServerTrap=cmpServerTrap, crlServerTrap=crlServerTrap, authenticationFailure=authenticationFailure, fanTwoStatus=fanTwoStatus, natStatusTrap=natStatusTrap, ifName_ces=ifName_ces, fiveVoltsPositive=fiveVoltsPositive, hardDisk0StatusTrap=hardDisk0StatusTrap, PortLocation_ces=PortLocation_ces, adslWANStatusTrap=adslWANStatusTrap, loadBalancingServerTrap=loadBalancingServerTrap, firewallSrcPort_ces=firewallSrcPort_ces, ifIpAddr_ces=ifIpAddr_ces, igmpStatus=igmpStatus, twoDotFiveVB=twoDotFiveVB, linkDown=linkDown, licensingStatusTrap=licensingStatusTrap, backupServer=backupServer, memoryUsageTrap=memoryUsageTrap, severityLevel=severityLevel, hardDisk1StatusTrap=hardDisk1StatusTrap, dhcpServer=dhcpServer, twelveVoltsMinsTrap=twelveVoltsMinsTrap, normalTemperature=normalTemperature, cmpServer=cmpServer, systemName=systemName, snmpServerTrap=snmpServerTrap, failedLogin=failedLogin, linkUp=linkUp, dnsServer=dnsServer, threeVoltsPositive=threeVoltsPositive, clipServerTrap=clipServerTrap, systemUpTime=systemUpTime, fanOneStatusTrap=fanOneStatusTrap, fanTwoStatusTrap=fanTwoStatusTrap, routePolicyStatus=routePolicyStatus, antiSpoofingStatusTrap=antiSpoofingStatusTrap, twelveVoltsPositive=twelveVoltsPositive, fireWallTrap=fireWallTrap, criticalTemperature=criticalTemperature, ntpServer=ntpServer, netBuffersTrap=netBuffersTrap, firewallRuleNumber_ces=firewallRuleNumber_ces, demandintfServerTrap=demandintfServerTrap, lanCardStatusTrap=lanCardStatusTrap, radiusAuthServer=radiusAuthServer, t1WANStatusTrap=t1WANStatusTrap, cRoutesMStatusTrap=cRoutesMStatusTrap, twoDotFiveVBTrap=twoDotFiveVBTrap, snmpAuthenOperation_ces=snmpAuthenOperation_ces, snmpAgentAuthTrapInfo_ces=snmpAgentAuthTrapInfo_ces, twoDotFiveVATrap=twoDotFiveVATrap, extLDAPAuthServer=extLDAPAuthServer, fanOneStatus=fanOneStatus, coldStart=coldStart, failedLoginTrap=failedLoginTrap, firewallDestPort_ces=firewallDestPort_ces, vrrpStatus=vrrpStatus, snmpAuthenIpAddress_ces=snmpAuthenIpAddress_ces, firewallDestAddr_ces=firewallDestAddr_ces, dualPowerSupplyTrap=dualPowerSupplyTrap, lanCardStatus=lanCardStatus, serUartStatusTrap=serUartStatusTrap, fipsStatus=fipsStatus)
