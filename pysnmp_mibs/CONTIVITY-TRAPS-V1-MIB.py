...
sysName, snmp, sysObjectID = mibBuilder.importSymbols("SNMPv2-MIB", "sysName", "snmp", "sysObjectID")
...
mibBuilder.exportSymbols("CONTIVITY-TRAPS-V1-MIB", briWANStatus=briWANStatus, radiusAcctServer=radiusAcctServer, ipAddressPool=ipAddressPool, clipServer=clipServer, ripStatus=ripStatus, dnsServer=dnsServer, FirewallPolicyType_ces=FirewallPolicyType_ces, fireWall=fireWall, crlServer=crlServer, firewallRuleNumber_ces=firewallRuleNumber_ces, radiusAuthServerTrap=radiusAuthServerTrap, natStatus=natStatus, ifIpAddr_ces=ifIpAddr_ces, sshServerTrap=sshServerTrap, ripStatusTrap=ripStatusTrap, t3WANStatusTrap=t3WANStatusTrap, backupServer=backupServer, certificateServerTrap=certificateServerTrap, mcastRelayStatus=mcastRelayStatus, ocspServerTrap=ocspServerTrap, licensingStatus=licensingStatus, loadBalancingServer=loadBalancingServer, hardwareCESTrapInfo=hardwareCESTrapInfo, sslVpnStatus=sslVpnStatus, threeVoltsPositiveTrap=threeVoltsPositiveTrap, adslWANStatus=adslWANStatus, ospfServer=ospfServer, cRoutesMStatus=cRoutesMStatus, periodicHeartbeatTrap=periodicHeartbeatTrap, netBuffersTrap=netBuffersTrap, firewallSrcAddr_ces=firewallSrcAddr_ces, serviceCESTrapInfo=serviceCESTrapInfo, fanOneStatusTrap=fanOneStatusTrap, criticalTemperature=criticalTemperature, fiveVoltsMinus=fiveVoltsMinus, threeVoltsPositive=threeVoltsPositive, twelveVoltsPositive=twelveVoltsPositive, hardDisk1StatusTrap=hardDisk1StatusTrap, severityLevel=severityLevel, serverCESTrapInfo=serverCESTrapInfo, igmpStatus=igmpStatus, linkDown=linkDown, fanTwoStatus=fanTwoStatus, crlServerTrap=crlServerTrap, antiSpoofingStatusTrap=antiSpoofingStatusTrap, intLDAPServerTrap=intLDAPServerTrap, IfReasonForStatus_ces=IfReasonForStatus_ces, extLDAPServer=extLDAPServer, systemUpTime=systemUpTime, hwAccelStatus=hwAccelStatus, firewallRuleAction_ces=firewallRuleAction_ces, firewallSrcPort_ces=firewallSrcPort_ces, twelveVoltsMinus=twelveVoltsMinus, authenticationFailure=authenticationFailure, snmpAuthenCommString_ces=snmpAuthenCommString_ces, dhcprelayServerTrap=dhcprelayServerTrap, securityIntrusionTrap=securityIntrusionTrap, igmpStatusTrap=igmpStatusTrap, powerUpTrapEntry=powerUpTrapEntry, ifPhysLocation_ces=ifPhysLocation_ces, ifPhysRelPos_ces=ifPhysRelPos_ces, snmpAgentAuthTrapInfo_ces=snmpAgentAuthTrapInfo_ces, dlswStatusTrap=dlswStatusTrap, firewallDestAddr_ces=firewallDestAddr_ces, cpuTwoStatusTrap=cpuTwoStatusTrap, systemName=systemName, sslVpnStatusTrap=sslVpnStatusTrap, firewallPolicyType_ces=firewallPolicyType_ces, snmpAgentInterfaceInfo_ces=snmpAgentInterfaceInfo_ces, chassisIntrusionTrap=chassisIntrusionTrap, dlswStatus=dlswStatus, dhcprelayServer=dhcprelayServer, cmpServerTrap=cmpServerTrap, fanOneStatus=fanOneStatus, t3WANStatus=t3WANStatus, fanTwoStatusTrap=fanTwoStatusTrap, dualPowerSupply=dualPowerSupply, radiusAuthServer=radiusAuthServer, loadBalancingServerTrap=loadBalancingServerTrap, antiSpoofingStatus=antiSpoofingStatus, usrIpAddrStatus=usrIpAddrStatus, ifName_ces=ifName_ces, fiveVoltsPositive=fiveVoltsPositive, gdsServer=gdsServer, licensingStatusTrap=licensingStatusTrap, dnsServerTrap=dnsServerTrap, firewallRuleTriggeredTrap=firewallRuleTriggeredTrap, cpuTwoStatus=cpuTwoStatus, snmpAgentTrapInfo_ces=snmpAgentTrapInfo_ces, twelveVoltsPositveTrap=twelveVoltsPositveTrap, hwAccelTrap=hwAccelTrap, certificateServer=certificateServer, snmpAuthenOperation_ces=snmpAuthenOperation_ces, firewallProtocolID_ces=firewallProtocolID_ces, hardDisk0StatusTrap=hardDisk0StatusTrap, snmpAgentFirewallInfo_ces=snmpAgentFirewallInfo_ces, intrusionCESTrapInfo=intrusionCESTrapInfo, loginCESTrapInfo=loginCESTrapInfo, normalTemperature=normalTemperature, netBuffers=netBuffers, firewallRuleType_ces=firewallRuleType_ces, dhcpServer=dhcpServer, FirewallRuleAction_ces=FirewallRuleAction_ces, mcastRelayStatusTrap=mcastRelayStatusTrap, natStatusTrap=natStatusTrap, intLDAPServer=intLDAPServer, sshServer=sshServer, serUartStatus=serUartStatus, coldStart=coldStart, tunnelGuardStatus=tunnelGuardStatus, serUartStatusTrap=serUartStatusTrap, ipsecFailoverStatusTrap=ipsecFailoverStatusTrap, backupServerTrap=backupServerTrap, contivityTrapsV1=contivityTrapsV1, adslWANStatusTrap=adslWANStatusTrap, demandintfServer=demandintfServer, hardDisk0Status=hardDisk0Status, vrrpStatus=vrrpStatus, v90WANStatus=v90WANStatus, twoDotFiveVBTrap=twoDotFiveVBTrap, ifTunnelRemoteIpAddr_ces=ifTunnelRemoteIpAddr_ces, lanCardStatusTrap=lanCardStatusTrap, chassisIntrusion=chassisIntrusion, ospfServerTrap=ospfServerTrap, powerUpTrap=powerUpTrap, linkUp=linkUp, dhcpServerTrap=dhcpServerTrap, twelveVoltsMinsTrap=twelveVoltsMinsTrap, demandintfServerTrap=demandintfServerTrap, systemDate=systemDate, fiveVoltsPosStatusTrap=fiveVoltsPosStatusTrap, fireWallTrap=fireWallTrap, ntpServerTrap=ntpServerTrap, systemTime=systemTime, twoDotFiveVB=twoDotFiveVB, tunnelGuardStatusTrap=tunnelGuardStatusTrap, chassisFanStatus=chassisFanStatus, normalTemperatureTrap=normalTemperatureTrap, periodicHeartbeat=periodicHeartbeat, routePolicyStatusTrap=routePolicyStatusTrap, twoDotFiveVA=twoDotFiveVA, v90WANStatusTrap=v90WANStatusTrap, fiveVoltsMinusTrap=fiveVoltsMinusTrap, extLDAPAuthServerTrap=extLDAPAuthServerTrap, fipsStatus=fipsStatus, vrrpStatusTrap=vrrpStatusTrap, ifReasonForStatus_ces=ifReasonForStatus_ces, snmpServerTrap=snmpServerTrap, clipServerTrap=clipServerTrap, extLDAPServerTrap=extLDAPServerTrap, criticalTemperatureTrap=criticalTemperatureTrap, diskRedundency=diskRedundency, routePolicyStatus=routePolicyStatus, ntpServer=ntpServer, PortLocation_ces=PortLocation_ces, extLDAPAuthServer=extLDAPAuthServer, dualPowerSupplyTrap=dualPowerSupplyTrap, ipAddressPoolTrap=ipAddressPoolTrap, twoDotFiveVATrap=twoDotFiveVATrap, snmpAuthenIpAddress_ces=snmpAuthenIpAddress_ces, cmpServer=cmpServer, t1WANStatusTrap=t1WANStatusTrap, FirewallRuleType_ces=FirewallRuleType_ces, failedLogin=failedLogin, t1WANStatus=t1WANStatus, ocspServer=ocspServer, failedLoginTrap=failedLoginTrap, hardDisk1Status=hardDisk1Status, fipsStatusTrap=fipsStatusTrap, ipsecFailoverStatus=ipsecFailoverStatus, PYSNMP_MODULE_ID=contivityTrapsV1, cRoutesMStatusTrap=cRoutesMStatusTrap, briWANStatusTrap=briWANStatusTrap, snmpServer=snmpServer, usrIpAddrStatusTrap=usrIpAddrStatusTrap, lanCardStatus=lanCardStatus, memoryUsage=memoryUsage, gdsServerTrap=gdsServerTrap, radiusAcctServerTrap=radiusAcctServerTrap, diskRedundencyTrap=diskRedundencyTrap, firewallDestPort_ces=firewallDestPort_ces, memoryUsageTrap=memoryUsageTrap, securityIntrusion=securityIntrusion, chassisFanStatusTrap=chassisFanStatusTrap)
