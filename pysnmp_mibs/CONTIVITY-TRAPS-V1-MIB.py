...
# Notes
# -----
# ASN.1 source file://mibs/nortel/CONTIVITY-TRAPS-V1-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:18:05 2025
...
linkDown.setObjects(
      *(("IF-MIB", "ifIndex"),
        ...
        ("IF-MIB", "ifDescr"),
        ("IF-MIB", "ifType"),
        ("CONTIVITY-TRAPS-V1-MIB", "ifReasonForStatus-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "ifPhysLocation-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "ifPhysRelPos-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "ifIpAddr-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "ifName-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "ifTunnelRemoteIpAddr-ces"),
...
authenticationFailure.setObjects(
      *(("CONTIVITY-TRAPS-V1-MIB", "snmpAuthenOperation-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "snmpAuthenIpAddress-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "snmpAuthenCommString-ces"),
        ("SNMPv2-MIB", "sysObjectID"),
        ("SNMPv2-MIB", "sysName"))
)
if mibBuilder.loadTexts:
...
firewallRuleTriggeredTrap.setObjects(
      *(("CONTIVITY-TRAPS-V1-MIB", "firewallPolicyType-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "firewallRuleType-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "firewallRuleNumber-ces"),
        ("IF-MIB", "ifIndex"),
        ("CONTIVITY-TRAPS-V1-MIB", "ifName-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "firewallSrcAddr-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "firewallSrcPort-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "firewallDestAddr-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "firewallDestPort-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "firewallProtocolID-ces"),
        ("CONTIVITY-TRAPS-V1-MIB", "firewallRuleAction-ces"),
        ("SNMPv2-MIB", "sysObjectID"),
        ("SNMPv2-MIB", "sysName"))
)
if mibBuilder.loadTexts:
