...
mibBuilder.exportSymbols("CISCO-ENTITY-SENSOR-MIB", entSensorThresholdIndex=entSensorThresholdIndex, entitySensorMIBComplianceV04=entitySensorMIBComplianceV04, entSensorScale=entSensorScale, entSensorThresholdRecoveryNotification=entSensorThresholdRecoveryNotification, entitySensorMIBGroups=entitySensorMIBGroups, entSensorValueTimeStamp=entSensorValueTimeStamp, entSensorThreshNotifGlobalEnable=entSensorThreshNotifGlobalEnable, SensorThresholdSeverity=SensorThresholdSeverity, entSensorThresholdNotificationEnable=entSensorThresholdNotificationEnable, entSensorType=entSensorType, entitySensorMIBComplianceV01=entitySensorMIBComplianceV01, entSensorValueTable=entSensorValueTable, SensorValue=SensorValue, entSensorThresholdRelation=entSensorThresholdRelation, entSensorValues=entSensorValues, entSensorValueEntry=entSensorValueEntry, ciscoEntitySensorMIB=ciscoEntitySensorMIB, entSensorThresholds=entSensorThresholds, entitySensorMIBObjects=entitySensorMIBObjects, entSensorGlobalObjects=entSensorGlobalObjects, entSensorThresholdEntry=entSensorThresholdEntry, SensorPrecision=SensorPrecision, entitySensorThresholdGroup=entitySensorThresholdGroup, entitySensorMIBComplianceV05=entitySensorMIBComplianceV05, entSensorValueUpdateRate=entSensorValueUpdateRate, entitySensorMIBComplianceV02=entitySensorMIBComplianceV02, PYSNMP_MODULE_ID=ciscoEntitySensorMIB, entitySensorMIBConformance=entitySensorMIBConformance, entSensorThresholdNotification=entSensorThresholdNotification, entitySensorMIBComplianceV03=entitySensorMIBComplianceV03, entitySensorNotifCtrlGlobalGroup=entitySensorNotifCtrlGlobalGroup, entSensorStatus=entSensorStatus, entSensorThresholdEvaluation=entSensorThresholdEvaluation, entSensorThresholdTable=entSensorThresholdTable, entSensorThresholdValue=entSensorThresholdValue, entitySensorMIBNotifications=entitySensorMIBNotifications, entitySensorThresholdNotificationGroup=entitySensorThresholdNotificationGroup, entSensorMeasuredEntity=entSensorMeasuredEntity, entSensorThresholdSeverity=entSensorThresholdSeverity, entitySensorValueGroupSup1=entitySensorValueGroupSup1, SensorDataType=SensorDataType, entSensorValue=entSensorValue, entitySensorMIBCompliances=entitySensorMIBCompliances, entitySensorValueGroup=entitySensorValueGroup, SensorStatus=SensorStatus, SensorThresholdRelation=SensorThresholdRelation, entitySensorNotificationGroup=entitySensorNotificationGroup, SensorValueUpdateRate=SensorValueUpdateRate, entSensorPrecision=entSensorPrecision, entitySensorMIBNotificationPrefix=entitySensorMIBNotificationPrefix, SensorDataScale=SensorDataScale)
