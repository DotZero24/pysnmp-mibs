...
zhoneShelfSlotGroup, zhoneModules, zhonePtp, zhoneGroups = mibBuilder.importSymbols("Zhone", "zhoneShelfSlotGroup", "zhoneModules", "zhonePtp", "zhoneGroups")
...
mibBuilder.exportSymbols("Zhone-PTP-MIB", zhonePtpConfigClockMode=zhonePtpConfigClockMode, zhonePtpObjectID=zhonePtpObjectID, zhonePtpConfigTable=zhonePtpConfigTable, zhonePtpConfigAcceptableMaster2=zhonePtpConfigAcceptableMaster2, PYSNMP_MODULE_ID=zhonePtpModule, zhonePtpStatusEntry=zhonePtpStatusEntry, zhonePtpConfigTimeSource=zhonePtpConfigTimeSource, zhonePtpGroup=zhonePtpGroup, zhonePtpConfigDelayReqInterval=zhonePtpConfigDelayReqInterval, zhonePtpModule=zhonePtpModule, zhonePtpConfigIfIndex=zhonePtpConfigIfIndex, zhonePtpConfigSyncMsgInterval=zhonePtpConfigSyncMsgInterval, zhonePtpConfigClockAccuracy=zhonePtpConfigClockAccuracy, zhonePtpConfigIpIfIndex=zhonePtpConfigIpIfIndex, zhonePtpStatusTxMode=zhonePtpStatusTxMode, zhonePtpConfigVariance=zhonePtpConfigVariance, zhonePtpConfigPriority2=zhonePtpConfigPriority2, zhonePtpConfigPriority1=zhonePtpConfigPriority1, zhonePtpConfigAcceptableMaster1=zhonePtpConfigAcceptableMaster1, zhonePtpConfigDomain1MS=zhonePtpConfigDomain1MS, zhonePtpConfigEntry=zhonePtpConfigEntry, zhonePtpConfigAnnounceInterval=zhonePtpConfigAnnounceInterval, zhonePtpConfigDomain2M=zhonePtpConfigDomain2M, zhonePtpConfigRowStatus=zhonePtpConfigRowStatus, zhonePtpConfigClockStratum=zhonePtpConfigClockStratum, zhonePtpStatusMacAddress=zhonePtpStatusMacAddress, zhonePtpStatusTable=zhonePtpStatusTable)
