...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/radlan/RADLAN-DHCP-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:40:31 2025
...
rlDhcpRelayInterfaceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 38, 28, 1), ).setIndexNames((0, "RADLAN-DHCP-MIB", "rlDhcpRelayInterfaceIfindex"))
...
rlDhcpRelayInterfaceListEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 38, 29, 1), ).setIndexNames((0, "RADLAN-DHCP-MIB", "rlDhcpRelayInterfaceListIndex"))
...
rlDhcpSrvConfParamsAutoDefaultRouter = MibTableColumn((1, 3, 6, 1, 4, 1, 89, 38, 47, 1, 15), TruthValue().clone('true')).setMaxAccess("readwrite")
...
rlDhcpSrvOptionParamsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 38, 57, 1), ).setIndexNames((0, "RADLAN-DHCP-MIB", "rlDhcpSrvOptionParamsName"), (0, "RADLAN-DHCP-MIB", "rlDhcpSrvOptionParamsCode"))
...
rlDhcpSrvOptionParamsOrigString = MibTableColumn((1, 3, 6, 1, 4, 1, 89, 38, 57, 1, 4), OctetString()).setMaxAccess("readwrite")
...
rlDhcpSrvAuxOptionEntry = MibTableRow((1, 3, 6, 1, 4, 1, 89, 38, 58, 1), ).setIndexNames((0, "RADLAN-DHCP-MIB", "rlDhcpSrvAuxOptionCode"), (0, "RADLAN-DHCP-MIB", "rlDhcpSrvAuxOptionType"))
