...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-DHCP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:09 2025
...
rlDhcpRelayInterfaceEntry.setIndexNames(
    (0, "RADLAN-DHCP-MIB", "rlDhcpRelayInterfaceIfindex"),
)
if mibBuilder.loadTexts:
...
rlDhcpRelayInterfaceListEntry.setIndexNames(
    (0, "RADLAN-DHCP-MIB", "rlDhcpRelayInterfaceListIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpSrvOptionParamsEntry.setIndexNames(
    (0, "RADLAN-DHCP-MIB", "rlDhcpSrvOptionParamsName"),
    (0, "RADLAN-DHCP-MIB", "rlDhcpSrvOptionParamsCode"),
)
if mibBuilder.loadTexts:
...
rlDhcpSrvAuxOptionEntry.setIndexNames(
    (0, "RADLAN-DHCP-MIB", "rlDhcpSrvAuxOptionCode"),
    (0, "RADLAN-DHCP-MIB", "rlDhcpSrvAuxOptionType"),
)
if mibBuilder.loadTexts:
