...
mibBuilder.exportSymbols("BRCM-SNMP-MGMT-MIB", snmpNotifyUdpPort=snmpNotifyUdpPort, snmpUdpPort=snmpUdpPort, snmpDscpTag=snmpDscpTag, PYSNMP_MODULE_ID=snmpMgmt, snmpMgmt=snmpMgmt)
