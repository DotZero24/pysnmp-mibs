...
mibBuilder.exportSymbols("CISCO-CIPTG-MIB", cipTgCmgrOperRemoteVcToken=cipTgCmgrOperRemoteVcToken, cipTgCmgrOperConnStatus=cipTgCmgrOperConnStatus, cipTgCmgrOperRemoteGrToken=cipTgCmgrOperRemoteGrToken, cipTgIpAdminRemoteIpAddr=cipTgIpAdminRemoteIpAddr, cipTgIpAdminType=cipTgIpAdminType, cipTgLlcOperMaxOut=cipTgLlcOperMaxOut, cipTgLlcOperLocalCP=cipTgLlcOperLocalCP, ciscoCipTgMibCompliance=ciscoCipTgMibCompliance, ciscoCipTgMIB=ciscoCipTgMIB, ciscoCipTgMibComplianceRev1=ciscoCipTgMibComplianceRev1, cipTgLlcAdminName=cipTgLlcAdminName, cipTgIpOperConnStatus=cipTgIpOperConnStatus, cipTgIpAdminLocalIpAddr=cipTgIpAdminLocalIpAddr, cipTgIpOperLocalVcToken=cipTgIpOperLocalVcToken, ciscoCipTgLlcGroup=ciscoCipTgLlcGroup, cipTgLlcStatsTable=cipTgLlcStatsTable, cipTgCmgrOperRemoteConnToken=cipTgCmgrOperRemoteConnToken, cipTgIpStatsPacketsOut=cipTgIpStatsPacketsOut, cipTgLlcAdminRowStatus=cipTgLlcAdminRowStatus, cipTgLlcOperEntry=cipTgLlcOperEntry, cipTgIpAdminTable=cipTgIpAdminTable, cipTgIpOperEntry=cipTgIpOperEntry, cipTgLlcStatsXidCmdsOut=cipTgLlcStatsXidCmdsOut, cipTgLlcOperHprLSAP=cipTgLlcOperHprLSAP, cipTgLlcOperMaxIn=cipTgLlcOperMaxIn, cipTgLlcStatsHCIFrameBytesOut=cipTgLlcStatsHCIFrameBytesOut, cipTgLlc=cipTgLlc, cipTgCmgrOperLocalGrToken=cipTgCmgrOperLocalGrToken, cipTgCmgrOperType=cipTgCmgrOperType, cipTgIpAdminBroadcast=cipTgIpAdminBroadcast, cipTgIpAdminEntry=cipTgIpAdminEntry, ciscoCipTgMibCompliances=ciscoCipTgMibCompliances, cipTgIpStatsHCBytesOut=cipTgIpStatsHCBytesOut, cipTgIpStatsHCBytesIn=cipTgIpStatsHCBytesIn, cipTgLlcStatsIFrameBytesOut=cipTgLlcStatsIFrameBytesOut, cipTgCmgrOperLocalVcToken=cipTgCmgrOperLocalVcToken, cipTgIpStatsBytesIn=cipTgIpStatsBytesIn, cipTgLlcStatsUIFrameBytesOut=cipTgLlcStatsUIFrameBytesOut, cipTgLlcStatsIFramesOut=cipTgLlcStatsIFramesOut, cipTgLlcStatsTestRspsIn=cipTgLlcStatsTestRspsIn, ciscoCipTgCmgrGroup=ciscoCipTgCmgrGroup, cipTgLlcAdminTable=cipTgLlcAdminTable, cipTgLlcAdminRMAC=cipTgLlcAdminRMAC, cipTgLlcOperHpr=cipTgLlcOperHpr, cipTgIpStatsBytesOut=cipTgIpStatsBytesOut, cipTgLlcOperRemoteConnToken=cipTgLlcOperRemoteConnToken, cipTgLlcOperRemoteVcToken=cipTgLlcOperRemoteVcToken, cipTgLlcStatsXidRspsOut=cipTgLlcStatsXidRspsOut, cipTgLlcOperTGN=cipTgLlcOperTGN, cipTgLlcStatsHCIFrameBytesIn=cipTgLlcStatsHCIFrameBytesIn, cipTgLlcOperLocalVcToken=cipTgLlcOperLocalVcToken, ciscoCipTgLlcGroupRev1=ciscoCipTgLlcGroupRev1, cipTgLlcStatsEntry=cipTgLlcStatsEntry, cipTgLlcStatsTestCmdsOut=cipTgLlcStatsTestCmdsOut, cipTgLlcOperRIF=cipTgLlcOperRIF, cipTgIpOperVcStatus=cipTgIpOperVcStatus, cipTgLlcStatsXidRspsIn=cipTgLlcStatsXidRspsIn, cipTgLlcStatsHCUIFrameBytesOut=cipTgLlcStatsHCUIFrameBytesOut, cipTgIpOperRemoteConnToken=cipTgIpOperRemoteConnToken, cipTgCmgrOperEntry=cipTgCmgrOperEntry, cipTgLlcStatsConnNumberSent=cipTgLlcStatsConnNumberSent, cipTgLlcOperLocalConnToken=cipTgLlcOperLocalConnToken, cipTgLlcStatsConnNumberRecv=cipTgLlcStatsConnNumberRecv, cipTgLlcOperConnStatus=cipTgLlcOperConnStatus, cipTgLlcOperVcStatus=cipTgLlcOperVcStatus, cipTgLlcStatsIFramesIn=cipTgLlcStatsIFramesIn, ciscoCipTgMibConformance=ciscoCipTgMibConformance, cipTgCmgrOperName=cipTgCmgrOperName, cipTgLlcOperState=cipTgLlcOperState, cipTgLlcStatsUIFramesIn=cipTgLlcStatsUIFramesIn, ChannelTgToken=ChannelTgToken, cipTgLlcAdminAdaptNo=cipTgLlcAdminAdaptNo, cipTgLlcAdminRSAP=cipTgLlcAdminRSAP, cipTgLlcAdminLanType=cipTgLlcAdminLanType, cipTgLlcStatsHCUIFrameBytesIn=cipTgLlcStatsHCUIFrameBytesIn, cipTgObjects=cipTgObjects, cipTgCmgrOperVcStatus=cipTgCmgrOperVcStatus, cipTgCmgrOperLocalConnToken=cipTgCmgrOperLocalConnToken, cipTgCmgr=cipTgCmgr, ChannelTgName=ChannelTgName, cipTgLlcStatsUIFrameBytesIn=cipTgLlcStatsUIFrameBytesIn, cipTgIpOperTable=cipTgIpOperTable, cipTgLlcAdminEntry=cipTgLlcAdminEntry, cipTgIpOperLocalConnToken=cipTgIpOperLocalConnToken, cipTgIpStatsTable=cipTgIpStatsTable, cipTgIpAdminName=cipTgIpAdminName, PYSNMP_MODULE_ID=ciscoCipTgMIB, cipTgIp=cipTgIp, cipTgLlcStatsUIFramesOut=cipTgLlcStatsUIFramesOut, cipTgCmgrOperTable=cipTgCmgrOperTable, cipTgIpStatsEntry=cipTgIpStatsEntry, cipTgLlcAdminLSAP=cipTgLlcAdminLSAP, cipTgIpStatsPacketsIn=cipTgIpStatsPacketsIn, cipTgLlcOperRemoteCP=cipTgLlcOperRemoteCP, ciscoCipTgMibGroups=ciscoCipTgMibGroups, cipTgLlcOperHprRSAP=cipTgLlcOperHprRSAP, cipTgIpOperRemoteVcToken=cipTgIpOperRemoteVcToken, ciscoCipTgIpGroup=ciscoCipTgIpGroup, cipTgLlcOperTable=cipTgLlcOperTable, cipTgIpAdminRowStatus=cipTgIpAdminRowStatus, cipTgLlcStatsIFrameBytesIn=cipTgLlcStatsIFrameBytesIn, cipTgLlcStatsXidCmdsIn=cipTgLlcStatsXidCmdsIn)
