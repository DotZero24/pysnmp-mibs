# SNMP MIB module (LLDP-STD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/raisecom/LLDP-STD-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:36:56 2025
...
rcLldpStandard = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1)
)
if mibBuilder.loadTexts:
    rcLldpStandard.setRevisions(
        ("2005-05-06 00:00",)
    )
...
lldpReinitDelay = _LldpReinitDelay_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 3),
    _LldpReinitDelay_Type()
)
lldpReinitDelay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lldpReinitDelay.setStatus("obsolete")
if mibBuilder.loadTexts:
...
lldpTxDelay = _LldpTxDelay_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 4),
    _LldpTxDelay_Type()
)
lldpTxDelay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lldpTxDelay.setStatus("obsolete")
if mibBuilder.loadTexts:
...
lldpPortConfigTable = _LldpPortConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 6)
)
if mibBuilder.loadTexts:
    lldpPortConfigTable.setStatus("obsolete")
_LldpPortConfigEntry_Object = MibTableRow
lldpPortConfigEntry = _LldpPortConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 6, 1)
)
lldpPortConfigEntry.setIndexNames(
    (0, "LLDP-STD-MIB", "lldpPortConfigPortNum"),
)
if mibBuilder.loadTexts:
    lldpPortConfigEntry.setStatus("obsolete")
...
lldpPortConfigAdminStatus = _LldpPortConfigAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 6, 1, 2),
    _LldpPortConfigAdminStatus_Type()
)
lldpPortConfigAdminStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpPortConfigAdminStatus.setStatus("obsolete")
...
lldpPortConfigNotificationEnable = _LldpPortConfigNotificationEnable_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 6, 1, 3),
    _LldpPortConfigNotificationEnable_Type()
)
lldpPortConfigNotificationEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpPortConfigNotificationEnable.setStatus("obsolete")
...
lldpPortConfigTLVsTxEnable = _LldpPortConfigTLVsTxEnable_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 6, 1, 4),
    _LldpPortConfigTLVsTxEnable_Type()
)
lldpPortConfigTLVsTxEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpPortConfigTLVsTxEnable.setStatus("obsolete")
_LldpConfigManAddrTable_Object = MibTable
lldpConfigManAddrTable = _LldpConfigManAddrTable_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 7)
)
if mibBuilder.loadTexts:
    lldpConfigManAddrTable.setStatus("obsolete")
_LldpConfigManAddrEntry_Object = MibTableRow
lldpConfigManAddrEntry = _LldpConfigManAddrEntry_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 7, 1)
)
if mibBuilder.loadTexts:
    lldpConfigManAddrEntry.setStatus("obsolete")
...
lldpConfigManAddrPortsTxEnable = _LldpConfigManAddrPortsTxEnable_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 1, 7, 1, 1),
    _LldpConfigManAddrPortsTxEnable_Type()
)
lldpConfigManAddrPortsTxEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpConfigManAddrPortsTxEnable.setStatus("obsolete")
_LldpStatistics_ObjectIdentity = ObjectIdentity
lldpStatistics = _LldpStatistics_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 2)
)
...
lldpStatsTxPortNum = _LldpStatsTxPortNum_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 2, 6, 1, 1),
    _LldpStatsTxPortNum_Type()
)
lldpStatsTxPortNum.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    lldpStatsTxPortNum.setStatus("obsolete")
...
lldpStatsRxPortNum = _LldpStatsRxPortNum_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 2, 7, 1, 1),
    _LldpStatsRxPortNum_Type()
)
lldpStatsRxPortNum.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    lldpStatsRxPortNum.setStatus("obsolete")
...
lldpRemLocalPortNum = _LldpRemLocalPortNum_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 1, 1, 2),
    _LldpRemLocalPortNum_Type()
)
lldpRemLocalPortNum.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    lldpRemLocalPortNum.setStatus("obsolete")
...
lldpRemIndex = _LldpRemIndex_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 1, 1, 3),
    _LldpRemIndex_Type()
)
lldpRemIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    lldpRemIndex.setStatus("obsolete")
...
lldpRemSysCapSupported = _LldpRemSysCapSupported_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 1, 1, 11),
    _LldpRemSysCapSupported_Type()
)
lldpRemSysCapSupported.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpRemSysCapSupported.setStatus("obsolete")
...
lldpRemSysCapEnabled = _LldpRemSysCapEnabled_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 1, 1, 12),
    _LldpRemSysCapEnabled_Type()
)
lldpRemSysCapEnabled.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpRemSysCapEnabled.setStatus("obsolete")
_LldpRemManAddrTable_Object = MibTable
lldpRemManAddrTable = _LldpRemManAddrTable_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 2)
)
if mibBuilder.loadTexts:
    lldpRemManAddrTable.setStatus("obsolete")
_LldpRemManAddrEntry_Object = MibTableRow
lldpRemManAddrEntry = _LldpRemManAddrEntry_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 2, 1)
)
lldpRemManAddrEntry.setIndexNames(
    (0, "LLDP-STD-MIB", "lldpRemTimeMark"),
    (0, "LLDP-STD-MIB", "lldpRemLocalPortNum"),
    (0, "LLDP-STD-MIB", "lldpRemIndex"),
    (0, "LLDP-STD-MIB", "lldpRemManAddrSubtype"),
    (0, "LLDP-STD-MIB", "lldpRemManAddr"),
)
if mibBuilder.loadTexts:
    lldpRemManAddrEntry.setStatus("obsolete")
...
lldpRemUnknownTLVType = _LldpRemUnknownTLVType_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 3, 1, 1),
    _LldpRemUnknownTLVType_Type()
)
lldpRemUnknownTLVType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpRemUnknownTLVType.setStatus("obsolete")
...
lldpRemUnknownTLVInfo = _LldpRemUnknownTLVInfo_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 3, 1, 2),
    _LldpRemUnknownTLVInfo_Type()
)
lldpRemUnknownTLVInfo.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpRemUnknownTLVInfo.setStatus("obsolete")
_LldpRemOrgDefInfoTable_Object = MibTable
lldpRemOrgDefInfoTable = _LldpRemOrgDefInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 4)
)
if mibBuilder.loadTexts:
    lldpRemOrgDefInfoTable.setStatus("obsolete")
_LldpRemOrgDefInfoEntry_Object = MibTableRow
lldpRemOrgDefInfoEntry = _LldpRemOrgDefInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 4, 1)
)
lldpRemOrgDefInfoEntry.setIndexNames(
    (0, "LLDP-STD-MIB", "lldpRemTimeMark"),
    (0, "LLDP-STD-MIB", "lldpRemLocalPortNum"),
    (0, "LLDP-STD-MIB", "lldpRemIndex"),
    (0, "LLDP-STD-MIB", "lldpRemOrgDefInfoOUI"),
    (0, "LLDP-STD-MIB", "lldpRemOrgDefInfoSubtype"),
    (0, "LLDP-STD-MIB", "lldpRemOrgDefInfoIndex"),
)
if mibBuilder.loadTexts:
    lldpRemOrgDefInfoEntry.setStatus("obsolete")
...
lldpRemOrgDefInfoOUI = _LldpRemOrgDefInfoOUI_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 4, 1, 1),
    _LldpRemOrgDefInfoOUI_Type()
)
lldpRemOrgDefInfoOUI.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpRemOrgDefInfoOUI.setStatus("obsolete")
...
lldpRemOrgDefInfoSubtype = _LldpRemOrgDefInfoSubtype_Object(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 1, 4, 4, 1, 2),
    _LldpRemOrgDefInfoSubtype_Type()
)
lldpRemOrgDefInfoSubtype.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lldpRemOrgDefInfoSubtype.setStatus("obsolete")
...
lldpConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 2, 2, 1)
)
lldpConfigGroup.setObjects(
    ("LLDP-STD-MIB", "lldpPortConfigAdminStatus")
)
if mibBuilder.loadTexts:
    lldpConfigGroup.setStatus("obsolete")

lldpConfigRxGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 2, 2, 2)
)
lldpConfigRxGroup.setObjects(
      *(("LLDP-STD-MIB", "lldpNotificationInterval"),
        ("LLDP-STD-MIB", "lldpPortConfigNotificationEnable"))
)
if mibBuilder.loadTexts:
    lldpConfigRxGroup.setStatus("obsolete")

lldpConfigTxGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 2, 2, 3)
)
lldpConfigTxGroup.setObjects(
      *(("LLDP-STD-MIB", "lldpMessageTxInterval"),
        ("LLDP-STD-MIB", "lldpMessageTxHoldMultiplier"),
        ("LLDP-STD-MIB", "lldpReinitDelay"),
        ("LLDP-STD-MIB", "lldpTxDelay"),
        ("LLDP-STD-MIB", "lldpPortConfigTLVsTxEnable"),
        ("LLDP-STD-MIB", "lldpConfigManAddrPortsTxEnable"))
)
if mibBuilder.loadTexts:
    lldpConfigTxGroup.setStatus("obsolete")

lldpStatsRxGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 2, 2, 4)
)
lldpStatsRxGroup.setObjects(
      *(("LLDP-STD-MIB", "lldpStatsRemTablesLastChangeTime"),
        ("LLDP-STD-MIB", "lldpStatsRemTablesInserts"),
        ("LLDP-STD-MIB", "lldpStatsRemTablesDeletes"),
        ("LLDP-STD-MIB", "lldpStatsRemTablesDrops"),
        ("LLDP-STD-MIB", "lldpStatsRemTablesAgeouts"),
        ("LLDP-STD-MIB", "lldpStatsRxPortFramesDiscardedTotal"),
        ("LLDP-STD-MIB", "lldpStatsRxPortFramesErrors"),
        ("LLDP-STD-MIB", "lldpStatsRxPortFramesTotal"),
        ("LLDP-STD-MIB", "lldpStatsRxPortTLVsDiscardedTotal"),
        ("LLDP-STD-MIB", "lldpStatsRxPortTLVsUnrecognizedTotal"),
        ("LLDP-STD-MIB", "lldpStatsRxPortAgeoutsTotal"))
)
if mibBuilder.loadTexts:
    lldpStatsRxGroup.setStatus("obsolete")

lldpStatsTxGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 2, 2, 5)
)
lldpStatsTxGroup.setObjects(
    ("LLDP-STD-MIB", "lldpStatsTxPortFramesTotal")
)
if mibBuilder.loadTexts:
    lldpStatsTxGroup.setStatus("obsolete")

lldpLocSysGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 2, 2, 6)
)
lldpLocSysGroup.setObjects(
      *(("LLDP-STD-MIB", "lldpLocChassisIdSubtype"),
        ("LLDP-STD-MIB", "lldpLocChassisId"),
        ("LLDP-STD-MIB", "lldpLocPortIdSubtype"),
        ("LLDP-STD-MIB", "lldpLocPortId"),
        ("LLDP-STD-MIB", "lldpLocPortDesc"),
        ("LLDP-STD-MIB", "lldpLocSysDesc"),
        ("LLDP-STD-MIB", "lldpLocSysName"),
        ("LLDP-STD-MIB", "lldpLocSysCapSupported"),
        ("LLDP-STD-MIB", "lldpLocSysCapEnabled"),
        ("LLDP-STD-MIB", "lldpLocManAddrLen"),
        ("LLDP-STD-MIB", "lldpLocManAddrIfSubtype"),
        ("LLDP-STD-MIB", "lldpLocManAddrIfId"),
        ("LLDP-STD-MIB", "lldpLocManAddrOID"))
)
if mibBuilder.loadTexts:
    lldpLocSysGroup.setStatus("obsolete")

lldpRemSysGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 2, 2, 7)
)
lldpRemSysGroup.setObjects(
      *(("LLDP-STD-MIB", "lldpRemChassisIdSubtype"),
        ("LLDP-STD-MIB", "lldpRemChassisId"),
        ("LLDP-STD-MIB", "lldpRemPortIdSubtype"),
        ("LLDP-STD-MIB", "lldpRemPortId"),
        ("LLDP-STD-MIB", "lldpRemPortDesc"),
        ("LLDP-STD-MIB", "lldpRemSysName"),
        ("LLDP-STD-MIB", "lldpRemSysDesc"),
        ("LLDP-STD-MIB", "lldpRemSysCapSupported"),
        ("LLDP-STD-MIB", "lldpRemSysCapEnabled"),
        ("LLDP-STD-MIB", "lldpRemManAddrIfSubtype"),
        ("LLDP-STD-MIB", "lldpRemManAddrIfId"),
        ("LLDP-STD-MIB", "lldpRemManAddrOID"),
        ("LLDP-STD-MIB", "lldpRemUnknownTLVInfo"),
        ("LLDP-STD-MIB", "lldpRemOrgDefInfo"))
)
if mibBuilder.loadTexts:
    lldpRemSysGroup.setStatus("obsolete")


# Notification objects

lldpRemTablesChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 0, 0, 1)
)
...
lldpNotificationsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 2, 2, 8)
)
lldpNotificationsGroup.setObjects(
    ("LLDP-STD-MIB", "lldpRemTablesChange")
)
if mibBuilder.loadTexts:
...
lldpCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 8886, 6, 1, 57, 1, 2, 1, 1)
)
lldpCompliance.setObjects(
      *(("LLDP-STD-MIB", "lldpConfigGroup"),
        ("LLDP-STD-MIB", "lldpConfigRxGroup"),
        ("LLDP-STD-MIB", "lldpConfigTxGroup"),
        ("LLDP-STD-MIB", "lldpStatsRxGroup"),
        ("LLDP-STD-MIB", "lldpStatsTxGroup"),
        ("LLDP-STD-MIB", "lldpLocSysGroup"),
        ("LLDP-STD-MIB", "lldpRemSysGroup"),
        ("LLDP-STD-MIB", "lldpNotificationsGroup"))
)
if mibBuilder.loadTexts:
