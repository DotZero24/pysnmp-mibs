...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-UNIFIED-COMPUTING-POWER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:40:58 2025
...
cucsPowerBudgetPowerCapSupportEnabled = _CucsPowerBudgetPowerCapSupportEnabled_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 1, 1, 38),
    _CucsPowerBudgetPowerCapSupportEnabled_Type()
)
cucsPowerBudgetPowerCapSupportEnabled.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerBudgetPowerCapSupportEnabled.setStatus("current")
...
cucsPowerGroupMaxReqPower = _CucsPowerGroupMaxReqPower_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 4, 1, 20),
    _CucsPowerGroupMaxReqPower_Type()
)
cucsPowerGroupMaxReqPower.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerGroupMaxReqPower.setStatus("current")
...
cucsPowerFIMemberTable = _CucsPowerFIMemberTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 15)
)
if mibBuilder.loadTexts:
    cucsPowerFIMemberTable.setStatus("current")
_CucsPowerFIMemberEntry_Object = MibTableRow
cucsPowerFIMemberEntry = _CucsPowerFIMemberEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 15, 1)
)
cucsPowerFIMemberEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-POWER-MIB", "cucsPowerFIMemberInstanceId"),
)
if mibBuilder.loadTexts:
    cucsPowerFIMemberEntry.setStatus("current")
_CucsPowerFIMemberInstanceId_Type = CucsManagedObjectId
_CucsPowerFIMemberInstanceId_Object = MibTableColumn
cucsPowerFIMemberInstanceId = _CucsPowerFIMemberInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 15, 1, 1),
    _CucsPowerFIMemberInstanceId_Type()
)
cucsPowerFIMemberInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsPowerFIMemberInstanceId.setStatus("current")
_CucsPowerFIMemberDn_Type = CucsManagedObjectDn
_CucsPowerFIMemberDn_Object = MibTableColumn
cucsPowerFIMemberDn = _CucsPowerFIMemberDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 15, 1, 2),
    _CucsPowerFIMemberDn_Type()
)
cucsPowerFIMemberDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerFIMemberDn.setStatus("current")
_CucsPowerFIMemberRn_Type = SnmpAdminString
_CucsPowerFIMemberRn_Object = MibTableColumn
cucsPowerFIMemberRn = _CucsPowerFIMemberRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 15, 1, 3),
    _CucsPowerFIMemberRn_Type()
)
cucsPowerFIMemberRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerFIMemberRn.setStatus("current")
_CucsPowerFIMemberFiId_Type = CucsNetworkSwitchId
_CucsPowerFIMemberFiId_Object = MibTableColumn
cucsPowerFIMemberFiId = _CucsPowerFIMemberFiId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 15, 1, 4),
    _CucsPowerFIMemberFiId_Type()
)
cucsPowerFIMemberFiId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerFIMemberFiId.setStatus("current")
_CucsPowerFIMemberId_Type = Gauge32
_CucsPowerFIMemberId_Object = MibTableColumn
cucsPowerFIMemberId = _CucsPowerFIMemberId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 15, 1, 5),
    _CucsPowerFIMemberId_Type()
)
cucsPowerFIMemberId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerFIMemberId.setStatus("current")
_CucsPowerFIMemberOperState_Type = CucsPowerMemberState
_CucsPowerFIMemberOperState_Object = MibTableColumn
cucsPowerFIMemberOperState = _CucsPowerFIMemberOperState_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 15, 1, 6),
    _CucsPowerFIMemberOperState_Type()
)
cucsPowerFIMemberOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerFIMemberOperState.setStatus("current")
_CucsPowerFexMemberTable_Object = MibTable
cucsPowerFexMemberTable = _CucsPowerFexMemberTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 16)
)
if mibBuilder.loadTexts:
    cucsPowerFexMemberTable.setStatus("current")
_CucsPowerFexMemberEntry_Object = MibTableRow
cucsPowerFexMemberEntry = _CucsPowerFexMemberEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 16, 1)
)
cucsPowerFexMemberEntry.setIndexNames(
    (0, "CISCO-UNIFIED-COMPUTING-POWER-MIB", "cucsPowerFexMemberInstanceId"),
)
if mibBuilder.loadTexts:
    cucsPowerFexMemberEntry.setStatus("current")
_CucsPowerFexMemberInstanceId_Type = CucsManagedObjectId
_CucsPowerFexMemberInstanceId_Object = MibTableColumn
cucsPowerFexMemberInstanceId = _CucsPowerFexMemberInstanceId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 16, 1, 1),
    _CucsPowerFexMemberInstanceId_Type()
)
cucsPowerFexMemberInstanceId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    cucsPowerFexMemberInstanceId.setStatus("current")
_CucsPowerFexMemberDn_Type = CucsManagedObjectDn
_CucsPowerFexMemberDn_Object = MibTableColumn
cucsPowerFexMemberDn = _CucsPowerFexMemberDn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 16, 1, 2),
    _CucsPowerFexMemberDn_Type()
)
cucsPowerFexMemberDn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerFexMemberDn.setStatus("current")
_CucsPowerFexMemberRn_Type = SnmpAdminString
_CucsPowerFexMemberRn_Object = MibTableColumn
cucsPowerFexMemberRn = _CucsPowerFexMemberRn_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 16, 1, 3),
    _CucsPowerFexMemberRn_Type()
)
cucsPowerFexMemberRn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerFexMemberRn.setStatus("current")
_CucsPowerFexMemberId_Type = Gauge32
_CucsPowerFexMemberId_Object = MibTableColumn
cucsPowerFexMemberId = _CucsPowerFexMemberId_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 16, 1, 4),
    _CucsPowerFexMemberId_Type()
)
cucsPowerFexMemberId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerFexMemberId.setStatus("current")
_CucsPowerFexMemberOperState_Type = CucsPowerMemberState
_CucsPowerFexMemberOperState_Object = MibTableColumn
cucsPowerFexMemberOperState = _CucsPowerFexMemberOperState_Object(
    (1, 3, 6, 1, 4, 1, 9, 9, 719, 1, 39, 16, 1, 5),
    _CucsPowerFexMemberOperState_Type()
)
cucsPowerFexMemberOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cucsPowerFexMemberOperState.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"cucsPowerObjects": cucsPowerObjects,
       ...
       "cucsPowerBudgetPowerCapSupportEnabled": cucsPowerBudgetPowerCapSupportEnabled,
       ...
       "cucsPowerGroupMaxReqPower": cucsPowerGroupMaxReqPower,
       ...
       "cucsPowerFIMemberTable": cucsPowerFIMemberTable,
       "cucsPowerFIMemberEntry": cucsPowerFIMemberEntry,
       "cucsPowerFIMemberInstanceId": cucsPowerFIMemberInstanceId,
       "cucsPowerFIMemberDn": cucsPowerFIMemberDn,
       "cucsPowerFIMemberRn": cucsPowerFIMemberRn,
       "cucsPowerFIMemberFiId": cucsPowerFIMemberFiId,
       "cucsPowerFIMemberId": cucsPowerFIMemberId,
       "cucsPowerFIMemberOperState": cucsPowerFIMemberOperState,
       "cucsPowerFexMemberTable": cucsPowerFexMemberTable,
       "cucsPowerFexMemberEntry": cucsPowerFexMemberEntry,
       "cucsPowerFexMemberInstanceId": cucsPowerFexMemberInstanceId,
       "cucsPowerFexMemberDn": cucsPowerFexMemberDn,
       "cucsPowerFexMemberRn": cucsPowerFexMemberRn,
       "cucsPowerFexMemberId": cucsPowerFexMemberId,
       "cucsPowerFexMemberOperState": cucsPowerFexMemberOperState}
)
