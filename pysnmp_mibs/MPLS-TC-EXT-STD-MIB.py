...
mibBuilder.exportSymbols("MPLS-TC-EXT-STD-MIB", MplsIccId=MplsIccId, PYSNMP_MODULE_ID=mplsTcExtStdMIB, mplsTcExtStdMIB=mplsTcExtStdMIB, MplsGlobalId=MplsGlobalId, MplsNodeId=MplsNodeId, MplsCcId=MplsCcId)
