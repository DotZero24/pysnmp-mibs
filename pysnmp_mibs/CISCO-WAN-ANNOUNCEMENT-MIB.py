...
mibBuilder.exportSymbols("CISCO-WAN-ANNOUNCEMENT-MIB", cwAnnPrefixPath=cwAnnPrefixPath, cwAnnounceControlGroup=cwAnnounceControlGroup, cwAnnounceNotificationPrefix=cwAnnounceNotificationPrefix, cwAnnounceEntry=cwAnnounceEntry, cwAnnMaximumSize=cwAnnMaximumSize, cwAnnounceGrpMIBObjects=cwAnnounceGrpMIBObjects, cwAnnounceMIBConformance=cwAnnounceMIBConformance, cwAnnPreferenceCodec=cwAnnPreferenceCodec, cwAnnounceNotifications=cwAnnounceNotifications, PYSNMP_MODULE_ID=ciscoWanAnnouncementMIB, cwAnnFileCodec=cwAnnFileCodec, cwAnnounceTableGroup=cwAnnounceTableGroup, announceMIBCompliance=announceMIBCompliance, cwAnnounceMIBGroups=cwAnnounceMIBGroups, cwAnnounceControlGrp=cwAnnounceControlGrp, cwAnnFileStatus=cwAnnFileStatus, cwAnnounceMIBCompliances=cwAnnounceMIBCompliances, ciscoWanAnnouncementMIB=ciscoWanAnnouncementMIB, cwAnnounceTable=cwAnnounceTable, cwAnnAgeTime=cwAnnAgeTime, cwAnnounceGeneric=cwAnnounceGeneric, cwAnnReqTimeout=cwAnnReqTimeout, cwAnnFileServerName=cwAnnFileServerName, AnnCodecType=AnnCodecType, cwAnnounceNumber=cwAnnounceNumber, cwAnnRowStatus=cwAnnRowStatus, cwAnnounceTableGrp=cwAnnounceTableGrp, cwAnnFileName=cwAnnFileName)
