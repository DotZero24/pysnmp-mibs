...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/zhone/ZHONE-COM-VOICE-DSP-MIB
...
zhoneVoice, zhoneShelfIndex, zhoneSlotIndex, zhoneModules = mibBuilder.importSymbols("Zhone", "zhoneVoice", "zhoneShelfIndex", "zhoneSlotIndex", "zhoneModules")
...
mibBuilder.exportSymbols("ZHONE-COM-VOICE-DSP-MIB", channelPktsLost=channelPktsLost, zhoneVoiceDsp=zhoneVoiceDsp, channelCcrpShelf=channelCcrpShelf, channelActiveCodec=channelActiveCodec, channelCcrpSlot=channelCcrpSlot, channelTimeAlive=channelTimeAlive, voiceDspTraps=voiceDspTraps, channelTrunkCtrpSlot=channelTrunkCtrpSlot, redundancyOverSubscriptionType=redundancyOverSubscriptionType, channelBytesReceived=channelBytesReceived, channelInterArrvJitter=channelInterArrvJitter, channelJitterBufferSize=channelJitterBufferSize, jitterBufferSize=jitterBufferSize, channelPktCtrpShelf=channelPktCtrpShelf, voiceDspHiWaterChannelCount=voiceDspHiWaterChannelCount, voiceDspChannelPktsLoss=voiceDspChannelPktsLoss, jitterBufferType=jitterBufferType, voiceDspDefaultConfiguration=voiceDspDefaultConfiguration, voiceDspMaxChannelOnBoard=voiceDspMaxChannelOnBoard, silenceSuppressionType=silenceSuppressionType, voiceDspActiveChannelCount=voiceDspActiveChannelCount, echoCancellationType=echoCancellationType, channelId=channelId, echoReturnLoss=echoReturnLoss, channelBytesSent=channelBytesSent, pktsLostThreshold=pktsLostThreshold, voiceDspStatusTable=voiceDspStatusTable, channelPktsReceived=channelPktsReceived, voiceDspReset=voiceDspReset, voiceDspStatusEntry=voiceDspStatusEntry, interArrvJitThreshold=interArrvJitThreshold, channelPktsSent=channelPktsSent, channelPktCtrpSlot=channelPktCtrpSlot, channelTrunkCtrpShelf=channelTrunkCtrpShelf, comVoiceDsp=comVoiceDsp, channelStatusEntry=channelStatusEntry, PYSNMP_MODULE_ID=comVoiceDsp, voiceDspTrapsPrefix=voiceDspTrapsPrefix, voiceDspResetCount=voiceDspResetCount, channelVoiceSessionIdHigh=channelVoiceSessionIdHigh, channelVoiceSessionIdLow=channelVoiceSessionIdLow, voiceDspChannelInterArrvJitterTrigger=voiceDspChannelInterArrvJitterTrigger, channelStatusTable=channelStatusTable)
