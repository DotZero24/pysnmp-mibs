...
zhoneSlotIndex, zhoneModules, zhoneShelfIndex, zhoneVoice = mibBuilder.importSymbols("Zhone", "zhoneSlotIndex", "zhoneModules", "zhoneShelfIndex", "zhoneVoice")
...
mibBuilder.exportSymbols("ZHONE-COM-VOICE-DSP-MIB", pktsLostThreshold=pktsLostThreshold, voiceDspChannelPktsLoss=voiceDspChannelPktsLoss, silenceSuppressionType=silenceSuppressionType, PYSNMP_MODULE_ID=comVoiceDsp, voiceDspStatusEntry=voiceDspStatusEntry, voiceDspReset=voiceDspReset, channelBytesSent=channelBytesSent, channelVoiceSessionIdLow=channelVoiceSessionIdLow, channelCcrpSlot=channelCcrpSlot, comVoiceDsp=comVoiceDsp, channelBytesReceived=channelBytesReceived, channelStatusEntry=channelStatusEntry, channelTimeAlive=channelTimeAlive, channelId=channelId, channelInterArrvJitter=channelInterArrvJitter, echoCancellationType=echoCancellationType, channelStatusTable=channelStatusTable, jitterBufferSize=jitterBufferSize, voiceDspStatusTable=voiceDspStatusTable, channelPktCtrpShelf=channelPktCtrpShelf, channelVoiceSessionIdHigh=channelVoiceSessionIdHigh, redundancyOverSubscriptionType=redundancyOverSubscriptionType, voiceDspTrapsPrefix=voiceDspTrapsPrefix, channelPktCtrpSlot=channelPktCtrpSlot, channelActiveCodec=channelActiveCodec, channelJitterBufferSize=channelJitterBufferSize, voiceDspActiveChannelCount=voiceDspActiveChannelCount, channelPktsSent=channelPktsSent, voiceDspTraps=voiceDspTraps, jitterBufferType=jitterBufferType, channelTrunkCtrpShelf=channelTrunkCtrpShelf, voiceDspMaxChannelOnBoard=voiceDspMaxChannelOnBoard, echoReturnLoss=echoReturnLoss, zhoneVoiceDsp=zhoneVoiceDsp, channelPktsLost=channelPktsLost, channelTrunkCtrpSlot=channelTrunkCtrpSlot, channelPktsReceived=channelPktsReceived, voiceDspHiWaterChannelCount=voiceDspHiWaterChannelCount, voiceDspChannelInterArrvJitterTrigger=voiceDspChannelInterArrvJitterTrigger, voiceDspDefaultConfiguration=voiceDspDefaultConfiguration, interArrvJitThreshold=interArrvJitThreshold, channelCcrpShelf=channelCcrpShelf, voiceDspResetCount=voiceDspResetCount)
