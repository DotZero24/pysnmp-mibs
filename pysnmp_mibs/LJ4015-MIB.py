#
# PySNMP MIB module LJ4015-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/hp/LJ4015-MIB
...
phd1_model = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 5, 1, 1), OctetString()).setLabel("phd1-model").setMaxAccess("readonly")
if mibBuilder.loadTexts: phd1_model.setStatus('optional')
phd1_manufacturing_info = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 5, 1, 2), OctetString()).setLabel("phd1-manufacturing-info").setMaxAccess("readonly")
if mibBuilder.loadTexts: phd1_manufacturing_info.setStatus('optional')
phd1_type = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 4, 5, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(2, 10, 11, 13))).clone(namedValues=NamedValues(("eUnknown", 2), ("eInputPHD", 10), ("eOutputPHD", 11), ("eBindingPHD", 13)))).setLabel("phd1-type").setMaxAccess("readonly")
...
tray2_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 2, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 10, 15, 17, 18, 24, 25, 26, 45, 101))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eFoolscap", 10), ("eStatement", 15), ("eROC16K", 17), ("eJISExecutive", 18), ("eISOandJISA6", 24), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45), ("eCustom", 101)))).setLabel("tray2-media-size-loaded").setMaxAccess("readwrite")
...
tray3_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 3, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 10, 17, 18, 25, 26, 45, 101, 32764))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eFoolscap", 10), ("eROC16K", 17), ("eJISExecutive", 18), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45), ("eCustom", 101), ("eAnyCustomSize", 32764)))).setLabel("tray3-media-size-loaded").setMaxAccess("readwrite")
...
tray5_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 5, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 10, 17, 18, 25, 26, 45, 101, 32764))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eFoolscap", 10), ("eROC16K", 17), ("eJISExecutive", 18), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45), ("eCustom", 101), ("eAnyCustomSize", 32764)))).setLabel("tray5-media-size-loaded").setMaxAccess("readwrite")
...
tray6_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 6, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 10, 17, 18, 25, 26, 45, 101, 32764))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eFoolscap", 10), ("eROC16K", 17), ("eJISExecutive", 18), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45), ("eCustom", 101), ("eAnyCustomSize", 32764)))).setLabel("tray6-media-size-loaded").setMaxAccess("readwrite")
...
tray7_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 7, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 10, 17, 18, 25, 26, 45, 101, 32764))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eFoolscap", 10), ("eROC16K", 17), ("eJISExecutive", 18), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45), ("eCustom", 101), ("eAnyCustomSize", 32764)))).setLabel("tray7-media-size-loaded").setMaxAccess("readwrite")
...
supplies_replace_action_at_setting = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 1, 25), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("eStopAtLow", 1), ("eStopAtOut", 2), ("eOverrideAtOut", 3)))).setLabel("supplies-replace-action-at-setting").setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("LJ4015-MIB", error44=error44, intray6=intray6, error46_date_time=error46_date_time, error7_time_stamp=error7_time_stamp, error34_code=error34_code, media_info=media_info, control_panel_display=control_panel_display, printed_media_simplex_count=printed_media_simplex_count, default_lines_per_page=default_lines_per_page, media_names_enabled=media_names_enabled, held_job_control=held_job_control, held_job_security=held_job_security, media15=media15, imaging=imaging, error46=error46, consumables_1=consumables_1, destination_bin_usage_count=destination_bin_usage_count, fw_rom_revision=fw_rom_revision, error16_time_stamp=error16_time_stamp, media_number_of_type_supported=media_number_of_type_supported, error20=error20, error2_date_time=error2_date_time, media13=media13, fw_rom_datecode=fw_rom_datecode, media9_engine_media_mode=media9_engine_media_mode, media12_engine_media_mode=media12_engine_media_mode, job_info_attr_13=job_info_attr_13, settings_job=settings_job, error19_date_time=error19_date_time, error15_code=error15_code, media19_page_count=media19_page_count, simm1_bank2_capacity=simm1_bank2_capacity, job_info_size=job_info_size, mio1_manufacturing_info=mio1_manufacturing_info, autocleaning_page_enable=autocleaning_page_enable, error32=error32, media4=media4, firmware_download_write_status_supported=firmware_download_write_status_supported, held_job_delete=held_job_delete, errorlog=errorlog, settings_io=settings_io, media18_short_name=media18_short_name, printed_media_dimplex_count=printed_media_dimplex_count, error38_time_stamp=error38_time_stamp, media10_page_count=media10_page_count, accounting=accounting, error4=error4, media_types=media_types, error33_time_stamp=error33_time_stamp, custom_paper_feed_dim=custom_paper_feed_dim, print_meter=print_meter, printer_accounting=printer_accounting, error44_time_stamp=error44_time_stamp, error9=error9, media10_short_name=media10_short_name, destination_bin_accounting=destination_bin_accounting, job_info_requested_originals=job_info_requested_originals, simm3_bank2=simm3_bank2, media4_short_name=media4_short_name, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, error48_time_stamp=error48_time_stamp, consumable_string=consumable_string, tray5_media_size_loaded=tray5_media_size_loaded, media18_engine_media_mode=media18_engine_media_mode, device=device, marking_agent_density=marking_agent_density, simm4_bank=simm4_bank, outbin2_error_info=outbin2_error_info, error47=error47, finisher_image_rotation=finisher_image_rotation, usage_instructions_line3=usage_instructions_line3, job_info_attr_10=job_info_attr_10, tray6_phd=tray6_phd, default_horizontal_black_resolution=default_horizontal_black_resolution, simm2_bank2=simm2_bank2, error40=error40, web_server=web_server, media1_engine_media_mode=media1_engine_media_mode, override_media_name=override_media_name, source_subsystem=source_subsystem, job_info_accounting_color_usage_log=job_info_accounting_color_usage_log, error4_date_time=error4_date_time, media16=media16, error5_date_time=error5_date_time, error39_time_stamp=error39_time_stamp, error15=error15, error23_time_stamp=error23_time_stamp, tray5_phd=tray5_phd, job_info_attr_15=job_info_attr_15, media14_page_count=media14_page_count, phd2_manufacturing_info=phd2_manufacturing_info, error21_code=error21_code, simm5_type=simm5_type, error24_code=error24_code, error39_date_time=error39_date_time, held_job_pin=held_job_pin, media16_engine_media_mode=media16_engine_media_mode, background_status_msg_line1_part1=background_status_msg_line1_part1, form_feed_needed=form_feed_needed, simm3_bank1=simm3_bank1, job_info_attr_8=job_info_attr_8, error29_time_stamp=error29_time_stamp, tray3_phd=tray3_phd, error18_code=error18_code, upgradable_devices=upgradable_devices, error41_time_stamp=error41_time_stamp, media2_short_name=media2_short_name, printed_media_simplex_charge=printed_media_simplex_charge, tray_prompt=tray_prompt, error14_code=error14_code, date_display=date_display, media12_short_name=media12_short_name, error50_date_time=error50_date_time, destination_subsystem=destination_subsystem, error12_code=error12_code, media11_short_name=media11_short_name, error1_code=error1_code, error47_date_time=error47_date_time, ews_request_control_panel_supplies_status=ews_request_control_panel_supplies_status, on_off_line=on_off_line, error5=error5, job_info_accounting_black_dots=job_info_accounting_black_dots, error21=error21, error48=error48, error5_time_stamp=error5_time_stamp, simm4=simm4, error30_time_stamp=error30_time_stamp, intray1=intray1, job_info_outcome=job_info_outcome, error26=error26, model_name=model_name, error8_date_time=error8_date_time, job_info_attr_5=job_info_attr_5, consumables_life=consumables_life, source_tray_usage_total=source_tray_usage_total, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, printed_media_duplex_charge=printed_media_duplex_charge, error33_code=error33_code, mass_storage_resource_changed=mass_storage_resource_changed, usb_vendor_id=usb_vendor_id, overflow_bin=overflow_bin, auto_continue=auto_continue, webserver_proc_sub=webserver_proc_sub, phd2_device_specific_command=phd2_device_specific_command, pcl_default_font_number=pcl_default_font_number, settings_print_media=settings_print_media, media8=media8, usb_product_description=usb_product_description, consumable_status_tls_max_value=consumable_status_tls_max_value, error36_date_time=error36_date_time, error10_code=error10_code, form_feed=form_feed, hold_job_timeout=hold_job_timeout, simm2_capacity=simm2_capacity, error21_time_stamp=error21_time_stamp, os_execute_file=os_execute_file, pdf_print_errors=pdf_print_errors, consumable_pages_printed_with_supply=consumable_pages_printed_with_supply, pcl_default_font_source=pcl_default_font_source, job_info=job_info, simm3=simm3, media5_short_name=media5_short_name, mio4=mio4, device_name=device_name, consumable_status_web_service_access_data=consumable_status_web_service_access_data, error11=error11, error28_time_stamp=error28_time_stamp, error37_code=error37_code, status_system=status_system, error13=error13, settings_prt_eng=settings_prt_eng, intray3=intray3, simm2_type=simm2_type, error30_date_time=error30_date_time, asset_number=asset_number, usage_average_toner_coverage=usage_average_toner_coverage, settings_web_server=settings_web_server, consumables=consumables, device_configure=device_configure, default_bits_per_pixel=default_bits_per_pixel, mio1_type=mio1_type, ph2=ph2, error20_time_stamp=error20_time_stamp, media3=media3, media7_short_name=media7_short_name, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, device_system=device_system, simm2_bank=simm2_bank, media_modes=media_modes, usage_instructions_line1=usage_instructions_line1, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, media3_page_count=media3_page_count, print_media=print_media, media2_page_count=media2_page_count, postscript_print_errors=postscript_print_errors, error31=error31, job_info_name1=job_info_name1, collated_originals_support=collated_originals_support, override_media_size=override_media_size, usb_serial_number=usb_serial_number, error45_time_stamp=error45_time_stamp, media18_page_count=media18_page_count, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, upgradable_devices_write_time=upgradable_devices_write_time, media18_name=media18_name, tray1_media_size_loaded=tray1_media_size_loaded, phd2_capacity=phd2_capacity, error35_date_time=error35_date_time, error45_code=error45_code, media11_name=media11_name, error33=error33, error50=error50, job_info_accounting_finishing_options=job_info_accounting_finishing_options, upgradable_devices_name=upgradable_devices_name, pdl_pcl=pdl_pcl, io_timeout=io_timeout, error17=error17, media10=media10, device_configure_printer_parameters=device_configure_printer_parameters, consumable_status=consumable_status, media19_short_name=media19_short_name, media9=media9, ports=ports, job_info_accounting_media_size=job_info_accounting_media_size, error41_code=error41_code, id=id, simm2=simm2, error18_time_stamp=error18_time_stamp, duplex_blank_pages=duplex_blank_pages, autocleaning_page_frequency=autocleaning_page_frequency, simm4_bank1_type=simm4_bank1_type, simm5_bank=simm5_bank, intrays=intrays, job_info_change_id=job_info_change_id, port1_parallel_speed=port1_parallel_speed, error26_code=error26_code, localization_countries_supported=localization_countries_supported, job_info_attr_12=job_info_attr_12, error10=error10, phd2=phd2, status_mass_storage_bd=status_mass_storage_bd, pcl_default_font_height=pcl_default_font_height, media18=media18, simm5_bank2_type=simm5_bank2_type, reprint=reprint, firmware_download_name=firmware_download_name, control_panel_display_contents_crc=control_panel_display_contents_crc, error31_time_stamp=error31_time_stamp, error19_time_stamp=error19_time_stamp, media14_engine_media_mode=media14_engine_media_mode, error16_code=error16_code, supply_after_out_state=supply_after_out_state, outbin2_maximum_binding=outbin2_maximum_binding, error30=error30)
mibBuilder.exportSymbols("LJ4015-MIB", resource_manager=resource_manager, error23_date_time=error23_date_time, error49_code=error49_code, media6_short_name=media6_short_name, current_job_parsing_id=current_job_parsing_id, usb_host_supported=usb_host_supported, error22_code=error22_code, phd1_model=phd1_model, held_job=held_job, settings_intray=settings_intray, error37_date_time=error37_date_time, postscript_total_page_count=postscript_total_page_count, default_ret=default_ret, error16_date_time=error16_date_time, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, media17_name=media17_name, error44_code=error44_code, simm5_capacity=simm5_capacity, consumable_life_usage_units=consumable_life_usage_units, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, job_info_page_count_current_original=job_info_page_count_current_original, error34_time_stamp=error34_time_stamp, tray4_media_size_loaded=tray4_media_size_loaded, job_info_name2=job_info_name2, error28_code=error28_code, remote_upgrade_enable=remote_upgrade_enable, error7=error7, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, error28_date_time=error28_date_time, usb_driver_name=usb_driver_name, rpc_bind_protocol_address=rpc_bind_protocol_address, phd1=phd1, error39_code=error39_code, media16_short_name=media16_short_name, consumable_reorder_url=consumable_reorder_url, ph=ph, error36=error36, error37_time_stamp=error37_time_stamp, localization_languages_supported=localization_languages_supported, simm1_bank2_type=simm1_bank2_type, port1=port1, simm5_bank1_type=simm5_bank1_type, simm5_bank1_capacity=simm5_bank1_capacity, error25_time_stamp=error25_time_stamp, media14=media14, perm_store_init_occurred=perm_store_init_occurred, error43_date_time=error43_date_time, mio4_type=mio4_type, media17_short_name=media17_short_name, error1=error1, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, media11=media11, service_id=service_id, error42_date_time=error42_date_time, error38_code=error38_code, held_job_retention=held_job_retention, error46_code=error46_code, non_assured_oht_page_count=non_assured_oht_page_count, media5_name=media5_name, print_density=print_density, job_input_auto_continue_mode=job_input_auto_continue_mode, media11_page_count=media11_page_count, usb_manufacturer_name=usb_manufacturer_name, media9_page_count=media9_page_count, error32_time_stamp=error32_time_stamp, error8_code=error8_code, error33_date_time=error33_date_time, printed_modes_total_count=printed_modes_total_count, phd1_capacity=phd1_capacity, time_display=time_display, job_info_physical_outbins_used=job_info_physical_outbins_used, supply_out_device_state=supply_out_device_state, simm4_bank2_type=simm4_bank2_type, io_switch=io_switch, error32_code=error32_code, error41_date_time=error41_date_time, error16=error16, media16_page_count=media16_page_count, remote_procedure_call=remote_procedure_call, simm4_bank2_capacity=simm4_bank2_capacity, error19=error19, error31_date_time=error31_date_time, consumable_status_page_count_b5_executive=consumable_status_page_count_b5_executive, simm1_type=simm1_type, media1_short_name=media1_short_name, usb_device_kind=usb_device_kind, error35_code=error35_code, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, media17_page_count=media17_page_count, job_output_auto_continue_timeout=job_output_auto_continue_timeout, media10_engine_media_mode=media10_engine_media_mode, consumable_notification_status=consumable_notification_status, background_message2=background_message2, serial_number=serial_number, error42=error42, file_system_erase_mode=file_system_erase_mode, settings_file_system=settings_file_system, error29_date_time=error29_date_time, job_info_attr_14=job_info_attr_14, consumable_string_information_reset=consumable_string_information_reset, job_info_attr_11=job_info_attr_11, error36_time_stamp=error36_time_stamp, ram_disk_size=ram_disk_size, error50_code=error50_code, held_job_quantity=held_job_quantity, job_being_parsed=job_being_parsed, simm1_bank1_type=simm1_bank1_type, error30_code=error30_code, pysmi_continue=pysmi_continue, media_names_available=media_names_available, simm1_bank=simm1_bank, error29=error29, intray5=intray5, destination_bin_usage=destination_bin_usage, upgradable_devices_current_state=upgradable_devices_current_state, simm5_bank2=simm5_bank2, settings_ph=settings_ph, processing_subsystem=processing_subsystem, background_message1=background_message1, settings_rpc=settings_rpc, media15_engine_media_mode=media15_engine_media_mode, pdl_pdf=pdl_pdf, error1_time_stamp=error1_time_stamp, outbin2_phd=outbin2_phd, consumable_maintenance_pages_remaining=consumable_maintenance_pages_remaining, sleep_mode=sleep_mode, spooler=spooler, error8=error8, energy_star=energy_star, media17_engine_media_mode=media17_engine_media_mode, source_tray_usage=source_tray_usage, error11_time_stamp=error11_time_stamp, media13_short_name=media13_short_name, error24=error24, error25_date_time=error25_date_time, media3_short_name=media3_short_name, job_info_attr_7=job_info_attr_7, media2=media2, mio=mio, job_info_attribute=job_info_attribute, job_info_pages_in_original=job_info_pages_in_original, direct_connect_ports_enable=direct_connect_ports_enable, pdl_postscript=pdl_postscript, error22=error22, default_vmi=default_vmi, printed_modes_accounting=printed_modes_accounting, file_system3=file_system3, tray6_media_size_loaded=tray6_media_size_loaded, simm1_bank1=simm1_bank1, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, tray1_phd=tray1_phd, simm1=simm1, error34_date_time=error34_date_time, file_systems=file_systems, mass_storage_resource_change_counter=mass_storage_resource_change_counter, error34=error34, outbin2_override_mode=outbin2_override_mode, media17=media17, error29_code=error29_code, file_system3_initialize_volume=file_system3_initialize_volume, error25_code=error25_code, pcl_total_page_count=pcl_total_page_count, media4_name=media4_name, error17_time_stamp=error17_time_stamp, consumable_status_web_service_access_control=consumable_status_web_service_access_control, default_vertical_black_resolution=default_vertical_black_resolution, usage_instructions_line4=usage_instructions_line4, error24_time_stamp=error24_time_stamp, outbin1_override_mode=outbin1_override_mode, simm=simm, usage_instructions_line2=usage_instructions_line2, media10_name=media10_name, cancel_job=cancel_job, media8_short_name=media8_short_name, error3_code=error3_code, error50_time_stamp=error50_time_stamp, file_system2_initialize_volume=file_system2_initialize_volume, simm4_bank1=simm4_bank1, simm1_bank1_capacity=simm1_bank1_capacity, media1_page_count=media1_page_count, error27_date_time=error27_date_time, settings_outbin=settings_outbin, status_pdl=status_pdl, web_server_url=web_server_url, printer_average=printer_average, engine_media_modes_supported1=engine_media_modes_supported1, job_info_accounting=job_info_accounting, error18_date_time=error18_date_time, job_info_printed_originals=job_info_printed_originals, media2_engine_media_mode=media2_engine_media_mode, intray2=intray2, error43_code=error43_code, usage_printer_total_charge=usage_printer_total_charge, job_info_attr_16=job_info_attr_16, error10_date_time=error10_date_time, simm2_bank2_type=simm2_bank2_type, intray4=intray4, media1=media1, custom_paper_xfeed_dim=custom_paper_xfeed_dim, error3=error3, error38_date_time=error38_date_time, tray4_phd=tray4_phd, media11_engine_media_mode=media11_engine_media_mode, tray3_media_size_loaded=tray3_media_size_loaded, ram_disk_mode=ram_disk_mode, error8_time_stamp=error8_time_stamp, media3_name=media3_name, error12_time_stamp=error12_time_stamp, error31_code=error31_code, error22_date_time=error22_date_time, error18=error18, rpc_bound_protocol_address=rpc_bound_protocol_address, tray7_media_size_loaded=tray7_media_size_loaded, media15_name=media15_name, error36_code=error36_code, error40_date_time=error40_date_time, job_info_io_source=job_info_io_source, error49_time_stamp=error49_time_stamp, media8_engine_media_mode=media8_engine_media_mode, error13_code=error13_code, error9_time_stamp=error9_time_stamp, simm4_bank2=simm4_bank2, error12_date_time=error12_date_time, mass_storage_block_driver=mass_storage_block_driver, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, error6_date_time=error6_date_time, error25=error25, intray7=intray7, default_media_name=default_media_name, web_server_security=web_server_security, firmware_download_current_state=firmware_download_current_state, error21_date_time=error21_date_time, file_system_external_access_capabilities=file_system_external_access_capabilities, display=display, media5_engine_media_mode=media5_engine_media_mode, mio4_model_name=mio4_model_name, default_page_protect=default_page_protect, error2_code=error2_code, media12_page_count=media12_page_count, pcl_default_font_width=pcl_default_font_width, host_application_available_memory=host_application_available_memory, error_log_clear=error_log_clear, consumable_maintenance_interval=consumable_maintenance_interval, error14_date_time=error14_date_time, job_info_attr_9=job_info_attr_9, error13_time_stamp=error13_time_stamp, media3_engine_media_mode=media3_engine_media_mode, error3_date_time=error3_date_time, active_print_jobs=active_print_jobs, error45_date_time=error45_date_time, media_counts=media_counts, media12_name=media12_name, pdl=pdl, media5_page_count=media5_page_count)
mibBuilder.exportSymbols("LJ4015-MIB", intray=intray, simm1_capacity=simm1_capacity, control_panel_button_press=control_panel_button_press, error11_date_time=error11_date_time, error44_date_time=error44_date_time, file_system_delete_files=file_system_delete_files, error14_time_stamp=error14_time_stamp, simm2_bank1_capacity=simm2_bank1_capacity, printed_modes_usage=printed_modes_usage, mio1=mio1, error42_code=error42_code, mass_storage_resources=mass_storage_resources, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, job_info_accounting_media_type=job_info_accounting_media_type, settings_mass_storage_bd=settings_mass_storage_bd, media4_engine_media_mode=media4_engine_media_mode, phd=phd, media13_page_count=media13_page_count, settings_webserver=settings_webserver, error9_date_time=error9_date_time, clearable_warning=clearable_warning, error15_date_time=error15_date_time, job_info_stage=job_info_stage, control_panel_display_graphical_contents=control_panel_display_graphical_contents, error3_time_stamp=error3_time_stamp, input_tray_auto_select=input_tray_auto_select, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, media7_engine_media_mode=media7_engine_media_mode, settings_pdl=settings_pdl, error11_code=error11_code, status_rpc=status_rpc, media12=media12, error6_time_stamp=error6_time_stamp, media15_page_count=media15_page_count, media7=media7, media1_name=media1_name, media5=media5, simm4_type=simm4_type, media15_short_name=media15_short_name, mio1_model_name=mio1_model_name, control_panel_supplies_status_message=control_panel_supplies_status_message, simm3_capacity=simm3_capacity, error32_date_time=error32_date_time, error43_time_stamp=error43_time_stamp, supplies_replace_action_at_setting=supplies_replace_action_at_setting, background_message=background_message, media13_name=media13_name, job_info_attr_1=job_info_attr_1, error20_date_time=error20_date_time, held_job_info=held_job_info, outbin1=outbin1, mio1_ip_address=mio1_ip_address, media7_name=media7_name, interface=interface, error47_time_stamp=error47_time_stamp, destination_bin_usage_total=destination_bin_usage_total, device_location=device_location, error2=error2, error43=error43, operating_system=operating_system, media6_engine_media_mode=media6_engine_media_mode, job_info_pages_printed=job_info_pages_printed, job_info_accounting_job_type=job_info_accounting_job_type, consumable_status_printer_design_compatibility=consumable_status_printer_design_compatibility, simm5_bank2_capacity=simm5_bank2_capacity, error5_code=error5_code, hp=hp, error46_time_stamp=error46_time_stamp, error47_code=error47_code, error37=error37, default_media_size=default_media_size, error6=error6, media6_name=media6_name, simm1_bank2=simm1_bank2, error35=error35, file_system4_initialize_volume=file_system4_initialize_volume, file_system2=file_system2, media6=media6, phd2_model=phd2_model, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, error45=error45, error28=error28, simm3_type=simm3_type, held_job_job_name=held_job_job_name, consumable_current_state=consumable_current_state, upgradable_devices_version=upgradable_devices_version, supply_out_action_support=supply_out_action_support, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, error23=error23, job_input_auto_continue_timeout=job_input_auto_continue_timeout, tray2_phd=tray2_phd, print_engine_revision=print_engine_revision, north_edge_offset=north_edge_offset, usage_staple_count=usage_staple_count, install_date=install_date, simm3_bank=simm3_bank, error27_code=error27_code, file_system_wipe_disk=file_system_wipe_disk, DisplayString=DisplayString, media13_engine_media_mode=media13_engine_media_mode, media9_short_name=media9_short_name, firmware_download_version=firmware_download_version, simm3_bank1_capacity=simm3_bank1_capacity, consumable_string_information=consumable_string_information, outbins=outbins, background_status_msg_line2_part1=background_status_msg_line2_part1, mio4_ip_address=mio4_ip_address, configurable_low_threshold_setting=configurable_low_threshold_setting, display_status=display_status, default_copies=default_copies, autocleaning_page_size=autocleaning_page_size, media4_page_count=media4_page_count, job_info_attr_2=job_info_attr_2, media6_page_count=media6_page_count, media8_name=media8_name, error15_time_stamp=error15_time_stamp, settings_system=settings_system, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, consumable_life_low_threshold=consumable_life_low_threshold, simm2_bank1=simm2_bank1, error26_time_stamp=error26_time_stamp, error40_code=error40_code, status_prt_eng=status_prt_eng, held_job_user_name=held_job_user_name, consumables_status=consumables_status, simm2_bank2_capacity=simm2_bank2_capacity, phd1_type=phd1_type, netPMLmgmt=netPMLmgmt, error48_date_time=error48_date_time, held_job_enable=held_job_enable, job_info_attr_3=job_info_attr_3, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, cold_reset_media_size=cold_reset_media_size, media19=media19, error48_code=error48_code, io=io, media8_page_count=media8_page_count, media9_name=media9_name, printed_media_duplex_count=printed_media_duplex_count, error9_code=error9_code, printed_media_combined_total=printed_media_combined_total, error49_date_time=error49_date_time, error7_date_time=error7_date_time, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, usb_interface=usb_interface, duplex_page_count=duplex_page_count, file_system4=file_system4, job=job, error39=error39, error35_time_stamp=error35_time_stamp, maximum_ram_disk_memory=maximum_ram_disk_memory, error17_code=error17_code, source_tray_accounting=source_tray_accounting, error10_time_stamp=error10_time_stamp, error23_code=error23_code, mio4_manufacturing_info=mio4_manufacturing_info, simm3_bank2_capacity=simm3_bank2_capacity, printed_media_usage=printed_media_usage, error17_date_time=error17_date_time, job_info_attr_6=job_info_attr_6, ph_devices=ph_devices, file_system_max_open_files=file_system_max_open_files, error14=error14, show_address=show_address, marking_agent_density_setting=marking_agent_density_setting, phd2_type=phd2_type, job_info_attr_4=job_info_attr_4, dfa_data_in_nvram=dfa_data_in_nvram, error13_date_time=error13_date_time, usb=usb, printed_modes_usage_total=printed_modes_usage_total, error1_date_time=error1_date_time, simm4_bank1_capacity=simm4_bank1_capacity, simm3_bank2_type=simm3_bank2_type, error41=error41, consumable_status_partnumber=consumable_status_partnumber, media_size_count=media_size_count, firmware_download=firmware_download, error49=error49, tray2_media_size_loaded=tray2_media_size_loaded, media16_name=media16_name, formatter_serial_number=formatter_serial_number, default_custom_paper_feed_dim=default_custom_paper_feed_dim, media14_short_name=media14_short_name, outbin2=outbin2, media19_engine_media_mode=media19_engine_media_mode, usb_product_id=usb_product_id, error2_time_stamp=error2_time_stamp, tray7_phd=tray7_phd, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, media2_name=media2_name, error42_time_stamp=error42_time_stamp, error19_code=error19_code, source_tray_usage_count=source_tray_usage_count, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, error38=error38, error7_code=error7_code, firmware_download_write_time=firmware_download_write_time, file_system=file_system, error24_date_time=error24_date_time, error27_time_stamp=error27_time_stamp, held_job_set_queue_size=held_job_set_queue_size, port1_parallel_bidirectionality=port1_parallel_bidirectionality, simm5_bank1=simm5_bank1, job_info_pages_processed=job_info_pages_processed, error4_time_stamp=error4_time_stamp, date_and_time=date_and_time, simm4_capacity=simm4_capacity, error6_code=error6_code, simm3_bank1_type=simm3_bank1_type, file_system_wipe_disk_status=file_system_wipe_disk_status, error20_code=error20_code, media14_name=media14_name, held_job_print=held_job_print, print_engine=print_engine, mopy_mode=mopy_mode, simm2_bank1_type=simm2_bank1_type, error12=error12, media7_page_count=media7_page_count, error27=error27, model_number=model_number, error40_time_stamp=error40_time_stamp, settings_spooler=settings_spooler, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, media19_name=media19_name, cartridge_out_override_control=cartridge_out_override_control, outbin=outbin, phd1_manufacturing_info=phd1_manufacturing_info, media_size=media_size, error4_code=error4_code, error26_date_time=error26_date_time, job_info_outbins_used=job_info_outbins_used, default_custom_paper_dim_unit=default_custom_paper_dim_unit, job_info_state=job_info_state, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, printed_media_total_charge=printed_media_total_charge, error22_time_stamp=error22_time_stamp, tray_disable_use_instead=tray_disable_use_instead, simm5=simm5)
