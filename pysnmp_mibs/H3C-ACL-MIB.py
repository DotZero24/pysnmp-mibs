...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-ACL-MIB
...
_H3cAclAdvancedEstablish_Type.__name__ = "TruthValue"
...
_H3cAclIDSDenyTime_Type.__name__ = "Unsigned32"
...
class _H3cAclMib2ResourceThreshold_Type(Integer32):
    """Custom type h3cAclMib2ResourceThreshold based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cAclMib2ResourceThreshold_Type.__name__ = "Integer32"
_H3cAclMib2ResourceThreshold_Object = MibScalar
h3cAclMib2ResourceThreshold = _H3cAclMib2ResourceThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 1, 5),
    _H3cAclMib2ResourceThreshold_Type()
)
h3cAclMib2ResourceThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cAclMib2ResourceThreshold.setStatus("current")


class _H3cAclMib2ResourceLogInterval_Type(Integer32):
    """Custom type h3cAclMib2ResourceLogInterval based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cAclMib2ResourceLogInterval_Type.__name__ = "Integer32"
_H3cAclMib2ResourceLogInterval_Object = MibScalar
h3cAclMib2ResourceLogInterval = _H3cAclMib2ResourceLogInterval_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 1, 6),
    _H3cAclMib2ResourceLogInterval_Type()
)
h3cAclMib2ResourceLogInterval.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cAclMib2ResourceLogInterval.setStatus("current")
...
class _H3cAclMib2EntityIndex_Type(Integer32):
    """Custom type h3cAclMib2EntityIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 2147483647),
    )
...
_H3cAclMib2EntityIndex_Type.__name__ = "Integer32"
...
class _H3cAclMib2CharacteristicsIndex_Type(Integer32):
    """Custom type h3cAclMib2CharacteristicsIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 2147483647),
    )
...
_H3cAclMib2CharacteristicsIndex_Type.__name__ = "Integer32"
...
_H3cAclNumberGroupCountClear_Type.__name__ = "CounterClear"
...
_H3cAclNamedGroupTable_Object = MibTable
h3cAclNamedGroupTable = _H3cAclNamedGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4)
)
if mibBuilder.loadTexts:
    h3cAclNamedGroupTable.setStatus("current")
_H3cAclNamedGroupEntry_Object = MibTableRow
h3cAclNamedGroupEntry = _H3cAclNamedGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4, 1)
)
h3cAclNamedGroupEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cAclNumberGroupType"),
    (0, "H3C-ACL-MIB", "h3cAclNamedGroupCategory"),
    (0, "H3C-ACL-MIB", "h3cAclNamedGroupName"),
)
if mibBuilder.loadTexts:
    h3cAclNamedGroupEntry.setStatus("current")


class _H3cAclNamedGroupCategory_Type(Integer32):
    """Custom type h3cAclNamedGroupCategory based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_H3cAclNamedGroupCategory_Type.__name__ = "Integer32"
_H3cAclNamedGroupCategory_Object = MibTableColumn
h3cAclNamedGroupCategory = _H3cAclNamedGroupCategory_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4, 1, 1),
    _H3cAclNamedGroupCategory_Type()
)
h3cAclNamedGroupCategory.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cAclNamedGroupCategory.setStatus("current")


class _H3cAclNamedGroupName_Type(OctetString):
    """Custom type h3cAclNamedGroupName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cAclNamedGroupName_Type.__name__ = "OctetString"
_H3cAclNamedGroupName_Object = MibTableColumn
h3cAclNamedGroupName = _H3cAclNamedGroupName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4, 1, 2),
    _H3cAclNamedGroupName_Type()
)
h3cAclNamedGroupName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cAclNamedGroupName.setStatus("current")
_H3cAclNamedGroupRowStatus_Type = RowStatus
_H3cAclNamedGroupRowStatus_Object = MibTableColumn
h3cAclNamedGroupRowStatus = _H3cAclNamedGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4, 1, 3),
    _H3cAclNamedGroupRowStatus_Type()
)
h3cAclNamedGroupRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedGroupRowStatus.setStatus("current")


class _H3cAclNamedGroupMatchOrder_Type(Integer32):
    """Custom type h3cAclNamedGroupMatchOrder based on Integer32"""
    defaultValue = 1
...
_H3cAclNamedGroupMatchOrder_Type.__name__ = "Integer32"
_H3cAclNamedGroupMatchOrder_Object = MibTableColumn
h3cAclNamedGroupMatchOrder = _H3cAclNamedGroupMatchOrder_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4, 1, 4),
    _H3cAclNamedGroupMatchOrder_Type()
)
h3cAclNamedGroupMatchOrder.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedGroupMatchOrder.setStatus("current")


class _H3cAclNamedGroupStep_Type(Integer32):
    """Custom type h3cAclNamedGroupStep based on Integer32"""
    defaultValue = 5
...
_H3cAclNamedGroupStep_Type.__name__ = "Integer32"
_H3cAclNamedGroupStep_Object = MibTableColumn
h3cAclNamedGroupStep = _H3cAclNamedGroupStep_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4, 1, 5),
    _H3cAclNamedGroupStep_Type()
)
h3cAclNamedGroupStep.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedGroupStep.setStatus("current")


class _H3cAclNamedGroupDescription_Type(OctetString):
    """Custom type h3cAclNamedGroupDescription based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 127),
    )
...
_H3cAclNamedGroupDescription_Type.__name__ = "OctetString"
_H3cAclNamedGroupDescription_Object = MibTableColumn
h3cAclNamedGroupDescription = _H3cAclNamedGroupDescription_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4, 1, 6),
    _H3cAclNamedGroupDescription_Type()
)
h3cAclNamedGroupDescription.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedGroupDescription.setStatus("current")


class _H3cAclNamedGroupCountClear_Type(CounterClear):
    """Custom type h3cAclNamedGroupCountClear based on CounterClear"""
    defaultValue = 2


_H3cAclNamedGroupCountClear_Type.__name__ = "CounterClear"
_H3cAclNamedGroupCountClear_Object = MibTableColumn
h3cAclNamedGroupCountClear = _H3cAclNamedGroupCountClear_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4, 1, 7),
    _H3cAclNamedGroupCountClear_Type()
)
h3cAclNamedGroupCountClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cAclNamedGroupCountClear.setStatus("current")
_H3cAclNamedGroupRuleCounter_Type = Counter32
_H3cAclNamedGroupRuleCounter_Object = MibTableColumn
h3cAclNamedGroupRuleCounter = _H3cAclNamedGroupRuleCounter_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 1, 4, 1, 8),
    _H3cAclNamedGroupRuleCounter_Type()
)
h3cAclNamedGroupRuleCounter.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cAclNamedGroupRuleCounter.setStatus("current")
...
class _H3cAclIPAclBasicSrcAny_Type(TruthValue):
    """Custom type h3cAclIPAclBasicSrcAny based on TruthValue"""
    defaultValue = 1


_H3cAclIPAclBasicSrcAny_Type.__name__ = "TruthValue"
...
class _H3cAclIPAclBasicFragmentFlag_Type(FragmentFlag):
    """Custom type h3cAclIPAclBasicFragmentFlag based on FragmentFlag"""
    defaultValue = 0


_H3cAclIPAclBasicFragmentFlag_Type.__name__ = "FragmentFlag"
...
class _H3cAclIPAclBasicLog_Type(TruthValue):
    """Custom type h3cAclIPAclBasicLog based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclBasicLog_Type.__name__ = "TruthValue"
...
class _H3cAclIPAclBasicCountClear_Type(CounterClear):
    """Custom type h3cAclIPAclBasicCountClear based on CounterClear"""
    defaultValue = 2


_H3cAclIPAclBasicCountClear_Type.__name__ = "CounterClear"
...
class _H3cAclIPAclBasicEnable_Type(TruthValue):
    """Custom type h3cAclIPAclBasicEnable based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclBasicEnable_Type.__name__ = "TruthValue"
...
_H3cAclIPAclBasicCounting_Type.__name__ = "TruthValue"
...
_H3cAclIPAclBasicRouteTypeAny_Type.__name__ = "TruthValue"
...
_H3cAclIPAclAdvancedAddrFlag_Type.__name__ = "AddressFlag"
...
_H3cAclIPAclAdvancedSrcAny_Type.__name__ = "TruthValue"
...
class _H3cAclIPAclAdvancedSrcOp_Type(PortOp):
    """Custom type h3cAclIPAclAdvancedSrcOp based on PortOp"""
    defaultValue = 0


_H3cAclIPAclAdvancedSrcOp_Type.__name__ = "PortOp"
...
_H3cAclIPAclAdvancedDestAny_Type.__name__ = "TruthValue"
...
class _H3cAclIPAclAdvancedDestOp_Type(PortOp):
    """Custom type h3cAclIPAclAdvancedDestOp based on PortOp"""
    defaultValue = 0


_H3cAclIPAclAdvancedDestOp_Type.__name__ = "PortOp"
...
_H3cAclIPAclAdvancedDscp_Type.__name__ = "DSCPValue"
...
_H3cAclIPAclAdvancedFragmentFlag_Type.__name__ = "FragmentFlag"
...
_H3cAclIPAclAdvancedLog_Type.__name__ = "TruthValue"
...
_H3cAclIPAclAdvancedCountClear_Type.__name__ = "CounterClear"
...
_H3cAclIPAclAdvancedEnable_Type.__name__ = "TruthValue"
...
_H3cAclIPAclAdvancedCounting_Type.__name__ = "TruthValue"
...
_H3cAclIPAclAdvancedRouteTypeAny_Type.__name__ = "TruthValue"
...
_H3cAclIPAclAdvancedSrcSuffix_Type = Unsigned32
_H3cAclIPAclAdvancedSrcSuffix_Object = MibTableColumn
h3cAclIPAclAdvancedSrcSuffix = _H3cAclIPAclAdvancedSrcSuffix_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 3, 1, 43),
    _H3cAclIPAclAdvancedSrcSuffix_Type()
)
h3cAclIPAclAdvancedSrcSuffix.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclAdvancedSrcSuffix.setStatus("current")
_H3cAclIPAclAdvancedDestSuffix_Type = Unsigned32
_H3cAclIPAclAdvancedDestSuffix_Object = MibTableColumn
h3cAclIPAclAdvancedDestSuffix = _H3cAclIPAclAdvancedDestSuffix_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 3, 1, 44),
    _H3cAclIPAclAdvancedDestSuffix_Type()
)
h3cAclIPAclAdvancedDestSuffix.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclAdvancedDestSuffix.setStatus("current")
_H3cAclIPAclNamedBscTable_Object = MibTable
h3cAclIPAclNamedBscTable = _H3cAclIPAclNamedBscTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4)
)
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscTable.setStatus("current")
_H3cAclIPAclNamedBscEntry_Object = MibTableRow
h3cAclIPAclNamedBscEntry = _H3cAclIPAclNamedBscEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1)
)
h3cAclIPAclNamedBscEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cAclNumberGroupType"),
    (0, "H3C-ACL-MIB", "h3cAclNamedGroupName"),
    (0, "H3C-ACL-MIB", "h3cAclIPAclBasicRuleIndex"),
)
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscEntry.setStatus("current")
_H3cAclIPAclNamedBscRowStatus_Type = RowStatus
_H3cAclIPAclNamedBscRowStatus_Object = MibTableColumn
h3cAclIPAclNamedBscRowStatus = _H3cAclIPAclNamedBscRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 1),
    _H3cAclIPAclNamedBscRowStatus_Type()
)
h3cAclIPAclNamedBscRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscRowStatus.setStatus("current")
_H3cAclIPAclNamedBscAct_Type = RuleAction
_H3cAclIPAclNamedBscAct_Object = MibTableColumn
h3cAclIPAclNamedBscAct = _H3cAclIPAclNamedBscAct_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 2),
    _H3cAclIPAclNamedBscAct_Type()
)
h3cAclIPAclNamedBscAct.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscAct.setStatus("current")
_H3cAclIPAclNamedBscSrcAddrType_Type = InetAddressType
_H3cAclIPAclNamedBscSrcAddrType_Object = MibTableColumn
h3cAclIPAclNamedBscSrcAddrType = _H3cAclIPAclNamedBscSrcAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 3),
    _H3cAclIPAclNamedBscSrcAddrType_Type()
)
h3cAclIPAclNamedBscSrcAddrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscSrcAddrType.setStatus("current")
_H3cAclIPAclNamedBscSrcAddr_Type = InetAddress
_H3cAclIPAclNamedBscSrcAddr_Object = MibTableColumn
h3cAclIPAclNamedBscSrcAddr = _H3cAclIPAclNamedBscSrcAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 4),
    _H3cAclIPAclNamedBscSrcAddr_Type()
)
h3cAclIPAclNamedBscSrcAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscSrcAddr.setStatus("current")
_H3cAclIPAclNamedBscSrcPrefix_Type = InetAddressPrefixLength
_H3cAclIPAclNamedBscSrcPrefix_Object = MibTableColumn
h3cAclIPAclNamedBscSrcPrefix = _H3cAclIPAclNamedBscSrcPrefix_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 5),
    _H3cAclIPAclNamedBscSrcPrefix_Type()
)
h3cAclIPAclNamedBscSrcPrefix.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscSrcPrefix.setStatus("current")


class _H3cAclIPAclNamedBscSrcAny_Type(TruthValue):
    """Custom type h3cAclIPAclNamedBscSrcAny based on TruthValue"""
    defaultValue = 1


_H3cAclIPAclNamedBscSrcAny_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedBscSrcAny_Object = MibTableColumn
h3cAclIPAclNamedBscSrcAny = _H3cAclIPAclNamedBscSrcAny_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 6),
    _H3cAclIPAclNamedBscSrcAny_Type()
)
h3cAclIPAclNamedBscSrcAny.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscSrcAny.setStatus("current")
_H3cAclIPAclNamedBscSrcWild_Type = IpAddress
_H3cAclIPAclNamedBscSrcWild_Object = MibTableColumn
h3cAclIPAclNamedBscSrcWild = _H3cAclIPAclNamedBscSrcWild_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 7),
    _H3cAclIPAclNamedBscSrcWild_Type()
)
h3cAclIPAclNamedBscSrcWild.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscSrcWild.setStatus("current")


class _H3cAclIPAclNamedBscTRangeName_Type(OctetString):
    """Custom type h3cAclIPAclNamedBscTRangeName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclIPAclNamedBscTRangeName_Type.__name__ = "OctetString"
_H3cAclIPAclNamedBscTRangeName_Object = MibTableColumn
h3cAclIPAclNamedBscTRangeName = _H3cAclIPAclNamedBscTRangeName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 8),
    _H3cAclIPAclNamedBscTRangeName_Type()
)
h3cAclIPAclNamedBscTRangeName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscTRangeName.setStatus("current")


class _H3cAclIPAclNamedBscFragmentFlag_Type(FragmentFlag):
    """Custom type h3cAclIPAclNamedBscFragmentFlag based on FragmentFlag"""
    defaultValue = 0


_H3cAclIPAclNamedBscFragmentFlag_Type.__name__ = "FragmentFlag"
_H3cAclIPAclNamedBscFragmentFlag_Object = MibTableColumn
h3cAclIPAclNamedBscFragmentFlag = _H3cAclIPAclNamedBscFragmentFlag_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 9),
    _H3cAclIPAclNamedBscFragmentFlag_Type()
)
h3cAclIPAclNamedBscFragmentFlag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscFragmentFlag.setStatus("current")


class _H3cAclIPAclNamedBscLog_Type(TruthValue):
    """Custom type h3cAclIPAclNamedBscLog based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclNamedBscLog_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedBscLog_Object = MibTableColumn
h3cAclIPAclNamedBscLog = _H3cAclIPAclNamedBscLog_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 10),
    _H3cAclIPAclNamedBscLog_Type()
)
h3cAclIPAclNamedBscLog.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscLog.setStatus("current")
_H3cAclIPAclNamedBscCount_Type = Unsigned32
_H3cAclIPAclNamedBscCount_Object = MibTableColumn
h3cAclIPAclNamedBscCount = _H3cAclIPAclNamedBscCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 11),
    _H3cAclIPAclNamedBscCount_Type()
)
h3cAclIPAclNamedBscCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscCount.setStatus("current")


class _H3cAclIPAclNamedBscCountClear_Type(CounterClear):
    """Custom type h3cAclIPAclNamedBscCountClear based on CounterClear"""
    defaultValue = 2


_H3cAclIPAclNamedBscCountClear_Type.__name__ = "CounterClear"
_H3cAclIPAclNamedBscCountClear_Object = MibTableColumn
h3cAclIPAclNamedBscCountClear = _H3cAclIPAclNamedBscCountClear_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 12),
    _H3cAclIPAclNamedBscCountClear_Type()
)
h3cAclIPAclNamedBscCountClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscCountClear.setStatus("current")


class _H3cAclIPAclNamedBscEnable_Type(TruthValue):
    """Custom type h3cAclIPAclNamedBscEnable based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclNamedBscEnable_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedBscEnable_Object = MibTableColumn
h3cAclIPAclNamedBscEnable = _H3cAclIPAclNamedBscEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 13),
    _H3cAclIPAclNamedBscEnable_Type()
)
h3cAclIPAclNamedBscEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscEnable.setStatus("current")


class _H3cAclIPAclNamedBscVpnInstName_Type(OctetString):
    """Custom type h3cAclIPAclNamedBscVpnInstName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclIPAclNamedBscVpnInstName_Type.__name__ = "OctetString"
_H3cAclIPAclNamedBscVpnInstName_Object = MibTableColumn
h3cAclIPAclNamedBscVpnInstName = _H3cAclIPAclNamedBscVpnInstName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 14),
    _H3cAclIPAclNamedBscVpnInstName_Type()
)
h3cAclIPAclNamedBscVpnInstName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscVpnInstName.setStatus("current")


class _H3cAclIPAclNamedBscComment_Type(OctetString):
    """Custom type h3cAclIPAclNamedBscComment based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 127),
    )
...
_H3cAclIPAclNamedBscComment_Type.__name__ = "OctetString"
_H3cAclIPAclNamedBscComment_Object = MibTableColumn
h3cAclIPAclNamedBscComment = _H3cAclIPAclNamedBscComment_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 15),
    _H3cAclIPAclNamedBscComment_Type()
)
h3cAclIPAclNamedBscComment.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscComment.setStatus("current")


class _H3cAclIPAclNamedBscCounting_Type(TruthValue):
    """Custom type h3cAclIPAclNamedBscCounting based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclNamedBscCounting_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedBscCounting_Object = MibTableColumn
h3cAclIPAclNamedBscCounting = _H3cAclIPAclNamedBscCounting_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 16),
    _H3cAclIPAclNamedBscCounting_Type()
)
h3cAclIPAclNamedBscCounting.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscCounting.setStatus("current")


class _H3cAclIPAclNamedBscRouteTypeAny_Type(TruthValue):
    """Custom type h3cAclIPAclNamedBscRouteTypeAny based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclNamedBscRouteTypeAny_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedBscRouteTypeAny_Object = MibTableColumn
h3cAclIPAclNamedBscRouteTypeAny = _H3cAclIPAclNamedBscRouteTypeAny_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 17),
    _H3cAclIPAclNamedBscRouteTypeAny_Type()
)
h3cAclIPAclNamedBscRouteTypeAny.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscRouteTypeAny.setStatus("current")


class _H3cAclIPAclNamedBscRouteTypeValue_Type(Integer32):
    """Custom type h3cAclIPAclNamedBscRouteTypeValue based on Integer32"""
    defaultValue = 65535
...
_H3cAclIPAclNamedBscRouteTypeValue_Type.__name__ = "Integer32"
_H3cAclIPAclNamedBscRouteTypeValue_Object = MibTableColumn
h3cAclIPAclNamedBscRouteTypeValue = _H3cAclIPAclNamedBscRouteTypeValue_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 4, 1, 18),
    _H3cAclIPAclNamedBscRouteTypeValue_Type()
)
h3cAclIPAclNamedBscRouteTypeValue.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedBscRouteTypeValue.setStatus("current")
_H3cAclIPAclNamedAdvTable_Object = MibTable
h3cAclIPAclNamedAdvTable = _H3cAclIPAclNamedAdvTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5)
)
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvTable.setStatus("current")
_H3cAclIPAclNamedAdvEntry_Object = MibTableRow
h3cAclIPAclNamedAdvEntry = _H3cAclIPAclNamedAdvEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1)
)
h3cAclIPAclNamedAdvEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cAclNumberGroupType"),
    (0, "H3C-ACL-MIB", "h3cAclNamedGroupName"),
    (0, "H3C-ACL-MIB", "h3cAclIPAclAdvancedRuleIndex"),
)
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvEntry.setStatus("current")
_H3cAclIPAclNamedAdvRowStatus_Type = RowStatus
_H3cAclIPAclNamedAdvRowStatus_Object = MibTableColumn
h3cAclIPAclNamedAdvRowStatus = _H3cAclIPAclNamedAdvRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 1),
    _H3cAclIPAclNamedAdvRowStatus_Type()
)
h3cAclIPAclNamedAdvRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvRowStatus.setStatus("current")
_H3cAclIPAclNamedAdvAct_Type = RuleAction
_H3cAclIPAclNamedAdvAct_Object = MibTableColumn
h3cAclIPAclNamedAdvAct = _H3cAclIPAclNamedAdvAct_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 2),
    _H3cAclIPAclNamedAdvAct_Type()
)
h3cAclIPAclNamedAdvAct.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvAct.setStatus("current")


class _H3cAclIPAclNamedAdvProtocol_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvProtocol based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_H3cAclIPAclNamedAdvProtocol_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvProtocol_Object = MibTableColumn
h3cAclIPAclNamedAdvProtocol = _H3cAclIPAclNamedAdvProtocol_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 3),
    _H3cAclIPAclNamedAdvProtocol_Type()
)
h3cAclIPAclNamedAdvProtocol.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvProtocol.setStatus("current")


class _H3cAclIPAclNamedAdvAddrFlag_Type(AddressFlag):
    """Custom type h3cAclIPAclNamedAdvAddrFlag based on AddressFlag"""
    defaultValue = 0


_H3cAclIPAclNamedAdvAddrFlag_Type.__name__ = "AddressFlag"
_H3cAclIPAclNamedAdvAddrFlag_Object = MibTableColumn
h3cAclIPAclNamedAdvAddrFlag = _H3cAclIPAclNamedAdvAddrFlag_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 4),
    _H3cAclIPAclNamedAdvAddrFlag_Type()
)
h3cAclIPAclNamedAdvAddrFlag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvAddrFlag.setStatus("current")
_H3cAclIPAclNamedAdvSrcAddrType_Type = InetAddressType
_H3cAclIPAclNamedAdvSrcAddrType_Object = MibTableColumn
h3cAclIPAclNamedAdvSrcAddrType = _H3cAclIPAclNamedAdvSrcAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 5),
    _H3cAclIPAclNamedAdvSrcAddrType_Type()
)
h3cAclIPAclNamedAdvSrcAddrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvSrcAddrType.setStatus("current")
_H3cAclIPAclNamedAdvSrcAddr_Type = InetAddress
_H3cAclIPAclNamedAdvSrcAddr_Object = MibTableColumn
h3cAclIPAclNamedAdvSrcAddr = _H3cAclIPAclNamedAdvSrcAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 6),
    _H3cAclIPAclNamedAdvSrcAddr_Type()
)
h3cAclIPAclNamedAdvSrcAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvSrcAddr.setStatus("current")
_H3cAclIPAclNamedAdvSrcPrefix_Type = InetAddressPrefixLength
_H3cAclIPAclNamedAdvSrcPrefix_Object = MibTableColumn
h3cAclIPAclNamedAdvSrcPrefix = _H3cAclIPAclNamedAdvSrcPrefix_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 7),
    _H3cAclIPAclNamedAdvSrcPrefix_Type()
)
h3cAclIPAclNamedAdvSrcPrefix.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvSrcPrefix.setStatus("current")


class _H3cAclIPAclNamedAdvSrcAny_Type(TruthValue):
    """Custom type h3cAclIPAclNamedAdvSrcAny based on TruthValue"""
    defaultValue = 1


_H3cAclIPAclNamedAdvSrcAny_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedAdvSrcAny_Object = MibTableColumn
h3cAclIPAclNamedAdvSrcAny = _H3cAclIPAclNamedAdvSrcAny_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 8),
    _H3cAclIPAclNamedAdvSrcAny_Type()
)
h3cAclIPAclNamedAdvSrcAny.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvSrcAny.setStatus("current")
_H3cAclIPAclNamedAdvSrcWild_Type = IpAddress
_H3cAclIPAclNamedAdvSrcWild_Object = MibTableColumn
h3cAclIPAclNamedAdvSrcWild = _H3cAclIPAclNamedAdvSrcWild_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 9),
    _H3cAclIPAclNamedAdvSrcWild_Type()
)
h3cAclIPAclNamedAdvSrcWild.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvSrcWild.setStatus("current")


class _H3cAclIPAclNamedAdvSrcOp_Type(PortOp):
    """Custom type h3cAclIPAclNamedAdvSrcOp based on PortOp"""
    defaultValue = 0


_H3cAclIPAclNamedAdvSrcOp_Type.__name__ = "PortOp"
_H3cAclIPAclNamedAdvSrcOp_Object = MibTableColumn
h3cAclIPAclNamedAdvSrcOp = _H3cAclIPAclNamedAdvSrcOp_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 10),
    _H3cAclIPAclNamedAdvSrcOp_Type()
)
h3cAclIPAclNamedAdvSrcOp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvSrcOp.setStatus("current")


class _H3cAclIPAclNamedAdvSrcPort1_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvSrcPort1 based on Integer32"""
    defaultValue = 0
...
_H3cAclIPAclNamedAdvSrcPort1_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvSrcPort1_Object = MibTableColumn
h3cAclIPAclNamedAdvSrcPort1 = _H3cAclIPAclNamedAdvSrcPort1_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 11),
    _H3cAclIPAclNamedAdvSrcPort1_Type()
)
h3cAclIPAclNamedAdvSrcPort1.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvSrcPort1.setStatus("current")


class _H3cAclIPAclNamedAdvSrcPort2_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvSrcPort2 based on Integer32"""
    defaultValue = 65535
...
_H3cAclIPAclNamedAdvSrcPort2_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvSrcPort2_Object = MibTableColumn
h3cAclIPAclNamedAdvSrcPort2 = _H3cAclIPAclNamedAdvSrcPort2_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 12),
    _H3cAclIPAclNamedAdvSrcPort2_Type()
)
h3cAclIPAclNamedAdvSrcPort2.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvSrcPort2.setStatus("current")
_H3cAclIPAclNamedAdvDstAddrType_Type = InetAddressType
_H3cAclIPAclNamedAdvDstAddrType_Object = MibTableColumn
h3cAclIPAclNamedAdvDstAddrType = _H3cAclIPAclNamedAdvDstAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 13),
    _H3cAclIPAclNamedAdvDstAddrType_Type()
)
h3cAclIPAclNamedAdvDstAddrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDstAddrType.setStatus("current")
_H3cAclIPAclNamedAdvDstAddr_Type = InetAddress
_H3cAclIPAclNamedAdvDstAddr_Object = MibTableColumn
h3cAclIPAclNamedAdvDstAddr = _H3cAclIPAclNamedAdvDstAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 14),
    _H3cAclIPAclNamedAdvDstAddr_Type()
)
h3cAclIPAclNamedAdvDstAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDstAddr.setStatus("current")
_H3cAclIPAclNamedAdvDstPrefix_Type = InetAddressPrefixLength
_H3cAclIPAclNamedAdvDstPrefix_Object = MibTableColumn
h3cAclIPAclNamedAdvDstPrefix = _H3cAclIPAclNamedAdvDstPrefix_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 15),
    _H3cAclIPAclNamedAdvDstPrefix_Type()
)
h3cAclIPAclNamedAdvDstPrefix.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDstPrefix.setStatus("current")


class _H3cAclIPAclNamedAdvDstAny_Type(TruthValue):
    """Custom type h3cAclIPAclNamedAdvDstAny based on TruthValue"""
    defaultValue = 1


_H3cAclIPAclNamedAdvDstAny_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedAdvDstAny_Object = MibTableColumn
h3cAclIPAclNamedAdvDstAny = _H3cAclIPAclNamedAdvDstAny_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 16),
    _H3cAclIPAclNamedAdvDstAny_Type()
)
h3cAclIPAclNamedAdvDstAny.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDstAny.setStatus("current")
_H3cAclIPAclNamedAdvDstWild_Type = IpAddress
_H3cAclIPAclNamedAdvDstWild_Object = MibTableColumn
h3cAclIPAclNamedAdvDstWild = _H3cAclIPAclNamedAdvDstWild_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 17),
    _H3cAclIPAclNamedAdvDstWild_Type()
)
h3cAclIPAclNamedAdvDstWild.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDstWild.setStatus("current")


class _H3cAclIPAclNamedAdvDstOp_Type(PortOp):
    """Custom type h3cAclIPAclNamedAdvDstOp based on PortOp"""
    defaultValue = 0


_H3cAclIPAclNamedAdvDstOp_Type.__name__ = "PortOp"
_H3cAclIPAclNamedAdvDstOp_Object = MibTableColumn
h3cAclIPAclNamedAdvDstOp = _H3cAclIPAclNamedAdvDstOp_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 18),
    _H3cAclIPAclNamedAdvDstOp_Type()
)
h3cAclIPAclNamedAdvDstOp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDstOp.setStatus("current")


class _H3cAclIPAclNamedAdvDstPort1_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvDstPort1 based on Integer32"""
    defaultValue = 0
...
_H3cAclIPAclNamedAdvDstPort1_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvDstPort1_Object = MibTableColumn
h3cAclIPAclNamedAdvDstPort1 = _H3cAclIPAclNamedAdvDstPort1_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 19),
    _H3cAclIPAclNamedAdvDstPort1_Type()
)
h3cAclIPAclNamedAdvDstPort1.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDstPort1.setStatus("current")


class _H3cAclIPAclNamedAdvDstPort2_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvDstPort2 based on Integer32"""
    defaultValue = 65535
...
_H3cAclIPAclNamedAdvDstPort2_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvDstPort2_Object = MibTableColumn
h3cAclIPAclNamedAdvDstPort2 = _H3cAclIPAclNamedAdvDstPort2_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 20),
    _H3cAclIPAclNamedAdvDstPort2_Type()
)
h3cAclIPAclNamedAdvDstPort2.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDstPort2.setStatus("current")


class _H3cAclIPAclNamedAdvIcmpType_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvIcmpType based on Integer32"""
    defaultValue = 65535
...
_H3cAclIPAclNamedAdvIcmpType_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvIcmpType_Object = MibTableColumn
h3cAclIPAclNamedAdvIcmpType = _H3cAclIPAclNamedAdvIcmpType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 21),
    _H3cAclIPAclNamedAdvIcmpType_Type()
)
h3cAclIPAclNamedAdvIcmpType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvIcmpType.setStatus("current")


class _H3cAclIPAclNamedAdvIcmpCode_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvIcmpCode based on Integer32"""
    defaultValue = 65535
...
_H3cAclIPAclNamedAdvIcmpCode_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvIcmpCode_Object = MibTableColumn
h3cAclIPAclNamedAdvIcmpCode = _H3cAclIPAclNamedAdvIcmpCode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 22),
    _H3cAclIPAclNamedAdvIcmpCode_Type()
)
h3cAclIPAclNamedAdvIcmpCode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvIcmpCode.setStatus("current")


class _H3cAclIPAclNamedAdvPrecedence_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvPrecedence based on Integer32"""
    defaultValue = 255
...
_H3cAclIPAclNamedAdvPrecedence_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvPrecedence_Object = MibTableColumn
h3cAclIPAclNamedAdvPrecedence = _H3cAclIPAclNamedAdvPrecedence_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 23),
    _H3cAclIPAclNamedAdvPrecedence_Type()
)
h3cAclIPAclNamedAdvPrecedence.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvPrecedence.setStatus("current")


class _H3cAclIPAclNamedAdvTos_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvTos based on Integer32"""
    defaultValue = 255
...
_H3cAclIPAclNamedAdvTos_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvTos_Object = MibTableColumn
h3cAclIPAclNamedAdvTos = _H3cAclIPAclNamedAdvTos_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 24),
    _H3cAclIPAclNamedAdvTos_Type()
)
h3cAclIPAclNamedAdvTos.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvTos.setStatus("current")


class _H3cAclIPAclNamedAdvDscp_Type(DSCPValue):
    """Custom type h3cAclIPAclNamedAdvDscp based on DSCPValue"""
    defaultValue = 255


_H3cAclIPAclNamedAdvDscp_Type.__name__ = "DSCPValue"
_H3cAclIPAclNamedAdvDscp_Object = MibTableColumn
h3cAclIPAclNamedAdvDscp = _H3cAclIPAclNamedAdvDscp_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 25),
    _H3cAclIPAclNamedAdvDscp_Type()
)
h3cAclIPAclNamedAdvDscp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDscp.setStatus("current")


class _H3cAclIPAclNamedAdvTRangeName_Type(OctetString):
    """Custom type h3cAclIPAclNamedAdvTRangeName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclIPAclNamedAdvTRangeName_Type.__name__ = "OctetString"
_H3cAclIPAclNamedAdvTRangeName_Object = MibTableColumn
h3cAclIPAclNamedAdvTRangeName = _H3cAclIPAclNamedAdvTRangeName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 26),
    _H3cAclIPAclNamedAdvTRangeName_Type()
)
h3cAclIPAclNamedAdvTRangeName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvTRangeName.setStatus("current")


class _H3cAclIPAclNamedAdvTCPFlag_Type(TCPFlag):
    """Custom type h3cAclIPAclNamedAdvTCPFlag based on TCPFlag"""
    defaultValue = 0


_H3cAclIPAclNamedAdvTCPFlag_Type.__name__ = "TCPFlag"
_H3cAclIPAclNamedAdvTCPFlag_Object = MibTableColumn
h3cAclIPAclNamedAdvTCPFlag = _H3cAclIPAclNamedAdvTCPFlag_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 27),
    _H3cAclIPAclNamedAdvTCPFlag_Type()
)
h3cAclIPAclNamedAdvTCPFlag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvTCPFlag.setStatus("current")


class _H3cAclIPAclNamedAdvFragmentFlag_Type(FragmentFlag):
    """Custom type h3cAclIPAclNamedAdvFragmentFlag based on FragmentFlag"""
    defaultValue = 0


_H3cAclIPAclNamedAdvFragmentFlag_Type.__name__ = "FragmentFlag"
_H3cAclIPAclNamedAdvFragmentFlag_Object = MibTableColumn
h3cAclIPAclNamedAdvFragmentFlag = _H3cAclIPAclNamedAdvFragmentFlag_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 28),
    _H3cAclIPAclNamedAdvFragmentFlag_Type()
)
h3cAclIPAclNamedAdvFragmentFlag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvFragmentFlag.setStatus("current")


class _H3cAclIPAclNamedAdvLog_Type(TruthValue):
    """Custom type h3cAclIPAclNamedAdvLog based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclNamedAdvLog_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedAdvLog_Object = MibTableColumn
h3cAclIPAclNamedAdvLog = _H3cAclIPAclNamedAdvLog_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 29),
    _H3cAclIPAclNamedAdvLog_Type()
)
h3cAclIPAclNamedAdvLog.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvLog.setStatus("current")
_H3cAclIPAclNamedAdvCount_Type = Unsigned32
_H3cAclIPAclNamedAdvCount_Object = MibTableColumn
h3cAclIPAclNamedAdvCount = _H3cAclIPAclNamedAdvCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 30),
    _H3cAclIPAclNamedAdvCount_Type()
)
h3cAclIPAclNamedAdvCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvCount.setStatus("current")


class _H3cAclIPAclNamedAdvCountClear_Type(CounterClear):
    """Custom type h3cAclIPAclNamedAdvCountClear based on CounterClear"""
    defaultValue = 2


_H3cAclIPAclNamedAdvCountClear_Type.__name__ = "CounterClear"
_H3cAclIPAclNamedAdvCountClear_Object = MibTableColumn
h3cAclIPAclNamedAdvCountClear = _H3cAclIPAclNamedAdvCountClear_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 31),
    _H3cAclIPAclNamedAdvCountClear_Type()
)
h3cAclIPAclNamedAdvCountClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvCountClear.setStatus("current")


class _H3cAclIPAclNamedAdvEnable_Type(TruthValue):
    """Custom type h3cAclIPAclNamedAdvEnable based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclNamedAdvEnable_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedAdvEnable_Object = MibTableColumn
h3cAclIPAclNamedAdvEnable = _H3cAclIPAclNamedAdvEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 32),
    _H3cAclIPAclNamedAdvEnable_Type()
)
h3cAclIPAclNamedAdvEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvEnable.setStatus("current")


class _H3cAclIPAclNamedAdvVpnInstName_Type(OctetString):
    """Custom type h3cAclIPAclNamedAdvVpnInstName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclIPAclNamedAdvVpnInstName_Type.__name__ = "OctetString"
_H3cAclIPAclNamedAdvVpnInstName_Object = MibTableColumn
h3cAclIPAclNamedAdvVpnInstName = _H3cAclIPAclNamedAdvVpnInstName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 33),
    _H3cAclIPAclNamedAdvVpnInstName_Type()
)
h3cAclIPAclNamedAdvVpnInstName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvVpnInstName.setStatus("current")


class _H3cAclIPAclNamedAdvComment_Type(OctetString):
    """Custom type h3cAclIPAclNamedAdvComment based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 127),
    )
...
_H3cAclIPAclNamedAdvComment_Type.__name__ = "OctetString"
_H3cAclIPAclNamedAdvComment_Object = MibTableColumn
h3cAclIPAclNamedAdvComment = _H3cAclIPAclNamedAdvComment_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 34),
    _H3cAclIPAclNamedAdvComment_Type()
)
h3cAclIPAclNamedAdvComment.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvComment.setStatus("current")
_H3cAclIPAclNamedAdvReflective_Type = TruthValue
_H3cAclIPAclNamedAdvReflective_Object = MibTableColumn
h3cAclIPAclNamedAdvReflective = _H3cAclIPAclNamedAdvReflective_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 35),
    _H3cAclIPAclNamedAdvReflective_Type()
)
h3cAclIPAclNamedAdvReflective.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvReflective.setStatus("current")


class _H3cAclIPAclNamedAdvCounting_Type(TruthValue):
    """Custom type h3cAclIPAclNamedAdvCounting based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclNamedAdvCounting_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedAdvCounting_Object = MibTableColumn
h3cAclIPAclNamedAdvCounting = _H3cAclIPAclNamedAdvCounting_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 36),
    _H3cAclIPAclNamedAdvCounting_Type()
)
h3cAclIPAclNamedAdvCounting.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvCounting.setStatus("current")


class _H3cAclIPAclNamedAdvTCPFlagMask_Type(Bits):
    """Custom type h3cAclIPAclNamedAdvTCPFlagMask based on Bits"""
    namedValues = NamedValues(
        *(("tcpack", 0),
          ("tcpfin", 1),
          ("tcppsh", 2),
...
_H3cAclIPAclNamedAdvTCPFlagMask_Type.__name__ = "Bits"
_H3cAclIPAclNamedAdvTCPFlagMask_Object = MibTableColumn
h3cAclIPAclNamedAdvTCPFlagMask = _H3cAclIPAclNamedAdvTCPFlagMask_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 37),
    _H3cAclIPAclNamedAdvTCPFlagMask_Type()
)
h3cAclIPAclNamedAdvTCPFlagMask.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvTCPFlagMask.setStatus("current")


class _H3cAclIPAclNamedAdvTCPFlagValue_Type(Bits):
    """Custom type h3cAclIPAclNamedAdvTCPFlagValue based on Bits"""
    namedValues = NamedValues(
        *(("tcpack", 0),
          ("tcpfin", 1),
          ("tcppsh", 2),
...
_H3cAclIPAclNamedAdvTCPFlagValue_Type.__name__ = "Bits"
_H3cAclIPAclNamedAdvTCPFlagValue_Object = MibTableColumn
h3cAclIPAclNamedAdvTCPFlagValue = _H3cAclIPAclNamedAdvTCPFlagValue_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 38),
    _H3cAclIPAclNamedAdvTCPFlagValue_Type()
)
h3cAclIPAclNamedAdvTCPFlagValue.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvTCPFlagValue.setStatus("current")


class _H3cAclIPAclNamedAdvRouteTypeAny_Type(TruthValue):
    """Custom type h3cAclIPAclNamedAdvRouteTypeAny based on TruthValue"""
    defaultValue = 2


_H3cAclIPAclNamedAdvRouteTypeAny_Type.__name__ = "TruthValue"
_H3cAclIPAclNamedAdvRouteTypeAny_Object = MibTableColumn
h3cAclIPAclNamedAdvRouteTypeAny = _H3cAclIPAclNamedAdvRouteTypeAny_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 39),
    _H3cAclIPAclNamedAdvRouteTypeAny_Type()
)
h3cAclIPAclNamedAdvRouteTypeAny.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvRouteTypeAny.setStatus("current")


class _H3cAclIPAclNamedAdvRouteTypeValue_Type(Integer32):
    """Custom type h3cAclIPAclNamedAdvRouteTypeValue based on Integer32"""
    defaultValue = 65535
...
_H3cAclIPAclNamedAdvRouteTypeValue_Type.__name__ = "Integer32"
_H3cAclIPAclNamedAdvRouteTypeValue_Object = MibTableColumn
h3cAclIPAclNamedAdvRouteTypeValue = _H3cAclIPAclNamedAdvRouteTypeValue_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 40),
    _H3cAclIPAclNamedAdvRouteTypeValue_Type()
)
h3cAclIPAclNamedAdvRouteTypeValue.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvRouteTypeValue.setStatus("current")


class _H3cAclIPAclNamedAdvFlowLabel_Type(Unsigned32):
    """Custom type h3cAclIPAclNamedAdvFlowLabel based on Unsigned32"""
    defaultValue = 4294967295
...
_H3cAclIPAclNamedAdvFlowLabel_Type.__name__ = "Unsigned32"
_H3cAclIPAclNamedAdvFlowLabel_Object = MibTableColumn
h3cAclIPAclNamedAdvFlowLabel = _H3cAclIPAclNamedAdvFlowLabel_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 41),
    _H3cAclIPAclNamedAdvFlowLabel_Type()
)
h3cAclIPAclNamedAdvFlowLabel.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvFlowLabel.setStatus("current")
_H3cAclIPAclNamedAdvSrcSuffix_Type = Unsigned32
_H3cAclIPAclNamedAdvSrcSuffix_Object = MibTableColumn
h3cAclIPAclNamedAdvSrcSuffix = _H3cAclIPAclNamedAdvSrcSuffix_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 42),
    _H3cAclIPAclNamedAdvSrcSuffix_Type()
)
h3cAclIPAclNamedAdvSrcSuffix.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvSrcSuffix.setStatus("current")
_H3cAclIPAclNamedAdvDstSuffix_Type = Unsigned32
_H3cAclIPAclNamedAdvDstSuffix_Object = MibTableColumn
h3cAclIPAclNamedAdvDstSuffix = _H3cAclIPAclNamedAdvDstSuffix_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 2, 5, 1, 43),
    _H3cAclIPAclNamedAdvDstSuffix_Type()
)
h3cAclIPAclNamedAdvDstSuffix.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIPAclNamedAdvDstSuffix.setStatus("current")
...
class _H3cAclMACCos_Type(Integer32):
    """Custom type h3cAclMACCos based on Integer32"""
    defaultValue = 255
...
_H3cAclMACCos_Type.__name__ = "Integer32"
...
class _H3cAclMACCountClear_Type(CounterClear):
    """Custom type h3cAclMACCountClear based on CounterClear"""
    defaultValue = 2


_H3cAclMACCountClear_Type.__name__ = "CounterClear"
...
_H3cAclMACEnable_Type.__name__ = "TruthValue"
...
_H3cAclMACLog_Type.__name__ = "TruthValue"
...
_H3cAclMACCounting_Type.__name__ = "TruthValue"
...
_H3cAclNamedMACTable_Object = MibTable
h3cAclNamedMACTable = _H3cAclNamedMACTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2)
)
if mibBuilder.loadTexts:
    h3cAclNamedMACTable.setStatus("current")
_H3cAclNamedMACEntry_Object = MibTableRow
h3cAclNamedMACEntry = _H3cAclNamedMACEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1)
)
h3cAclNamedMACEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cAclNumberGroupType"),
    (0, "H3C-ACL-MIB", "h3cAclNamedGroupName"),
    (0, "H3C-ACL-MIB", "h3cAclMACRuleIndex"),
)
if mibBuilder.loadTexts:
    h3cAclNamedMACEntry.setStatus("current")
_H3cAclNamedMACRowStatus_Type = RowStatus
_H3cAclNamedMACRowStatus_Object = MibTableColumn
h3cAclNamedMACRowStatus = _H3cAclNamedMACRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 1),
    _H3cAclNamedMACRowStatus_Type()
)
h3cAclNamedMACRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACRowStatus.setStatus("current")
_H3cAclNamedMACAct_Type = RuleAction
_H3cAclNamedMACAct_Object = MibTableColumn
h3cAclNamedMACAct = _H3cAclNamedMACAct_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 2),
    _H3cAclNamedMACAct_Type()
)
h3cAclNamedMACAct.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACAct.setStatus("current")


class _H3cAclNamedMACTypeCode_Type(OctetString):
    """Custom type h3cAclNamedMACTypeCode based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclNamedMACTypeCode_Type.__name__ = "OctetString"
_H3cAclNamedMACTypeCode_Object = MibTableColumn
h3cAclNamedMACTypeCode = _H3cAclNamedMACTypeCode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 3),
    _H3cAclNamedMACTypeCode_Type()
)
h3cAclNamedMACTypeCode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACTypeCode.setStatus("current")


class _H3cAclNamedMACTypeMask_Type(OctetString):
    """Custom type h3cAclNamedMACTypeMask based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclNamedMACTypeMask_Type.__name__ = "OctetString"
_H3cAclNamedMACTypeMask_Object = MibTableColumn
h3cAclNamedMACTypeMask = _H3cAclNamedMACTypeMask_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 4),
    _H3cAclNamedMACTypeMask_Type()
)
h3cAclNamedMACTypeMask.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACTypeMask.setStatus("current")
_H3cAclNamedMACSrcMac_Type = MacAddress
_H3cAclNamedMACSrcMac_Object = MibTableColumn
h3cAclNamedMACSrcMac = _H3cAclNamedMACSrcMac_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 5),
    _H3cAclNamedMACSrcMac_Type()
)
h3cAclNamedMACSrcMac.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACSrcMac.setStatus("current")
_H3cAclNamedMACSrcMacWild_Type = MacAddress
_H3cAclNamedMACSrcMacWild_Object = MibTableColumn
h3cAclNamedMACSrcMacWild = _H3cAclNamedMACSrcMacWild_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 6),
    _H3cAclNamedMACSrcMacWild_Type()
)
h3cAclNamedMACSrcMacWild.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACSrcMacWild.setStatus("current")
_H3cAclNamedMACDstMac_Type = MacAddress
_H3cAclNamedMACDstMac_Object = MibTableColumn
h3cAclNamedMACDstMac = _H3cAclNamedMACDstMac_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 7),
    _H3cAclNamedMACDstMac_Type()
)
h3cAclNamedMACDstMac.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACDstMac.setStatus("current")
_H3cAclNamedMACDstMacWild_Type = MacAddress
_H3cAclNamedMACDstMacWild_Object = MibTableColumn
h3cAclNamedMACDstMacWild = _H3cAclNamedMACDstMacWild_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 8),
    _H3cAclNamedMACDstMacWild_Type()
)
h3cAclNamedMACDstMacWild.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACDstMacWild.setStatus("current")


class _H3cAclNamedMACLsapCode_Type(OctetString):
    """Custom type h3cAclNamedMACLsapCode based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclNamedMACLsapCode_Type.__name__ = "OctetString"
_H3cAclNamedMACLsapCode_Object = MibTableColumn
h3cAclNamedMACLsapCode = _H3cAclNamedMACLsapCode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 9),
    _H3cAclNamedMACLsapCode_Type()
)
h3cAclNamedMACLsapCode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACLsapCode.setStatus("current")


class _H3cAclNamedMACLsapMask_Type(OctetString):
    """Custom type h3cAclNamedMACLsapMask based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclNamedMACLsapMask_Type.__name__ = "OctetString"
_H3cAclNamedMACLsapMask_Object = MibTableColumn
h3cAclNamedMACLsapMask = _H3cAclNamedMACLsapMask_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 10),
    _H3cAclNamedMACLsapMask_Type()
)
h3cAclNamedMACLsapMask.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACLsapMask.setStatus("current")


class _H3cAclNamedMACCos_Type(Integer32):
    """Custom type h3cAclNamedMACCos based on Integer32"""
    defaultValue = 255
...
_H3cAclNamedMACCos_Type.__name__ = "Integer32"
_H3cAclNamedMACCos_Object = MibTableColumn
h3cAclNamedMACCos = _H3cAclNamedMACCos_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 11),
    _H3cAclNamedMACCos_Type()
)
h3cAclNamedMACCos.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACCos.setStatus("current")


class _H3cAclNamedMACTimeRangeName_Type(OctetString):
    """Custom type h3cAclNamedMACTimeRangeName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclNamedMACTimeRangeName_Type.__name__ = "OctetString"
_H3cAclNamedMACTimeRangeName_Object = MibTableColumn
h3cAclNamedMACTimeRangeName = _H3cAclNamedMACTimeRangeName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 12),
    _H3cAclNamedMACTimeRangeName_Type()
)
h3cAclNamedMACTimeRangeName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACTimeRangeName.setStatus("current")
_H3cAclNamedMACCount_Type = Unsigned32
_H3cAclNamedMACCount_Object = MibTableColumn
h3cAclNamedMACCount = _H3cAclNamedMACCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 13),
    _H3cAclNamedMACCount_Type()
)
h3cAclNamedMACCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cAclNamedMACCount.setStatus("current")


class _H3cAclNamedMACCountClear_Type(CounterClear):
    """Custom type h3cAclNamedMACCountClear based on CounterClear"""
    defaultValue = 2


_H3cAclNamedMACCountClear_Type.__name__ = "CounterClear"
_H3cAclNamedMACCountClear_Object = MibTableColumn
h3cAclNamedMACCountClear = _H3cAclNamedMACCountClear_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 14),
    _H3cAclNamedMACCountClear_Type()
)
h3cAclNamedMACCountClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cAclNamedMACCountClear.setStatus("current")


class _H3cAclNamedMACEnable_Type(TruthValue):
    """Custom type h3cAclNamedMACEnable based on TruthValue"""
    defaultValue = 2


_H3cAclNamedMACEnable_Type.__name__ = "TruthValue"
_H3cAclNamedMACEnable_Object = MibTableColumn
h3cAclNamedMACEnable = _H3cAclNamedMACEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 15),
    _H3cAclNamedMACEnable_Type()
)
h3cAclNamedMACEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cAclNamedMACEnable.setStatus("current")


class _H3cAclNamedMACComment_Type(OctetString):
    """Custom type h3cAclNamedMACComment based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 127),
    )
...
_H3cAclNamedMACComment_Type.__name__ = "OctetString"
_H3cAclNamedMACComment_Object = MibTableColumn
h3cAclNamedMACComment = _H3cAclNamedMACComment_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 16),
    _H3cAclNamedMACComment_Type()
)
h3cAclNamedMACComment.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACComment.setStatus("current")


class _H3cAclNamedMACLog_Type(TruthValue):
    """Custom type h3cAclNamedMACLog based on TruthValue"""
    defaultValue = 2


_H3cAclNamedMACLog_Type.__name__ = "TruthValue"
_H3cAclNamedMACLog_Object = MibTableColumn
h3cAclNamedMACLog = _H3cAclNamedMACLog_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 17),
    _H3cAclNamedMACLog_Type()
)
h3cAclNamedMACLog.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACLog.setStatus("current")


class _H3cAclNamedMACCounting_Type(TruthValue):
    """Custom type h3cAclNamedMACCounting based on TruthValue"""
    defaultValue = 2


_H3cAclNamedMACCounting_Type.__name__ = "TruthValue"
_H3cAclNamedMACCounting_Object = MibTableColumn
h3cAclNamedMACCounting = _H3cAclNamedMACCounting_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 3, 2, 1, 18),
    _H3cAclNamedMACCounting_Type()
)
h3cAclNamedMACCounting.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedMACCounting.setStatus("current")
...
_H3cAclEnUserEnable_Type.__name__ = "TruthValue"
...
_H3cAclEnUserLog_Type.__name__ = "TruthValue"
...
_H3cAclEnUserCounting_Type.__name__ = "TruthValue"
...
_H3cAclNamedUserTable_Object = MibTable
h3cAclNamedUserTable = _H3cAclNamedUserTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4)
)
if mibBuilder.loadTexts:
    h3cAclNamedUserTable.setStatus("current")
_H3cAclNamedUserEntry_Object = MibTableRow
h3cAclNamedUserEntry = _H3cAclNamedUserEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1)
)
h3cAclNamedUserEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cAclNumberGroupType"),
    (0, "H3C-ACL-MIB", "h3cAclNamedGroupName"),
    (0, "H3C-ACL-MIB", "h3cAclEnUserRuleIndex"),
)
if mibBuilder.loadTexts:
    h3cAclNamedUserEntry.setStatus("current")
_H3cAclNamedUserRowStatus_Type = RowStatus
_H3cAclNamedUserRowStatus_Object = MibTableColumn
h3cAclNamedUserRowStatus = _H3cAclNamedUserRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 1),
    _H3cAclNamedUserRowStatus_Type()
)
h3cAclNamedUserRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserRowStatus.setStatus("current")
_H3cAclNamedUserAct_Type = RuleAction
_H3cAclNamedUserAct_Object = MibTableColumn
h3cAclNamedUserAct = _H3cAclNamedUserAct_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 2),
    _H3cAclNamedUserAct_Type()
)
h3cAclNamedUserAct.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserAct.setStatus("current")


class _H3cAclNamedUserStartString_Type(OctetString):
    """Custom type h3cAclNamedUserStartString based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclNamedUserStartString_Type.__name__ = "OctetString"
_H3cAclNamedUserStartString_Object = MibTableColumn
h3cAclNamedUserStartString = _H3cAclNamedUserStartString_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 3),
    _H3cAclNamedUserStartString_Type()
)
h3cAclNamedUserStartString.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserStartString.setStatus("current")


class _H3cAclNamedUserL2String_Type(OctetString):
    """Custom type h3cAclNamedUserL2String based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclNamedUserL2String_Type.__name__ = "OctetString"
_H3cAclNamedUserL2String_Object = MibTableColumn
h3cAclNamedUserL2String = _H3cAclNamedUserL2String_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 4),
    _H3cAclNamedUserL2String_Type()
)
h3cAclNamedUserL2String.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserL2String.setStatus("current")


class _H3cAclNamedUserMplsString_Type(OctetString):
    """Custom type h3cAclNamedUserMplsString based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclNamedUserMplsString_Type.__name__ = "OctetString"
_H3cAclNamedUserMplsString_Object = MibTableColumn
h3cAclNamedUserMplsString = _H3cAclNamedUserMplsString_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 5),
    _H3cAclNamedUserMplsString_Type()
)
h3cAclNamedUserMplsString.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserMplsString.setStatus("current")


class _H3cAclNamedUserIPv4String_Type(OctetString):
    """Custom type h3cAclNamedUserIPv4String based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclNamedUserIPv4String_Type.__name__ = "OctetString"
_H3cAclNamedUserIPv4String_Object = MibTableColumn
h3cAclNamedUserIPv4String = _H3cAclNamedUserIPv4String_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 6),
    _H3cAclNamedUserIPv4String_Type()
)
h3cAclNamedUserIPv4String.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserIPv4String.setStatus("current")


class _H3cAclNamedUserIPv6String_Type(OctetString):
    """Custom type h3cAclNamedUserIPv6String based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclNamedUserIPv6String_Type.__name__ = "OctetString"
_H3cAclNamedUserIPv6String_Object = MibTableColumn
h3cAclNamedUserIPv6String = _H3cAclNamedUserIPv6String_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 7),
    _H3cAclNamedUserIPv6String_Type()
)
h3cAclNamedUserIPv6String.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserIPv6String.setStatus("current")


class _H3cAclNamedUserL4String_Type(OctetString):
    """Custom type h3cAclNamedUserL4String based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclNamedUserL4String_Type.__name__ = "OctetString"
_H3cAclNamedUserL4String_Object = MibTableColumn
h3cAclNamedUserL4String = _H3cAclNamedUserL4String_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 8),
    _H3cAclNamedUserL4String_Type()
)
h3cAclNamedUserL4String.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserL4String.setStatus("current")


class _H3cAclNamedUserL5String_Type(OctetString):
    """Custom type h3cAclNamedUserL5String based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclNamedUserL5String_Type.__name__ = "OctetString"
_H3cAclNamedUserL5String_Object = MibTableColumn
h3cAclNamedUserL5String = _H3cAclNamedUserL5String_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 9),
    _H3cAclNamedUserL5String_Type()
)
h3cAclNamedUserL5String.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserL5String.setStatus("current")


class _H3cAclNamedUserTimeRangeName_Type(OctetString):
    """Custom type h3cAclNamedUserTimeRangeName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_H3cAclNamedUserTimeRangeName_Type.__name__ = "OctetString"
_H3cAclNamedUserTimeRangeName_Object = MibTableColumn
h3cAclNamedUserTimeRangeName = _H3cAclNamedUserTimeRangeName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 10),
    _H3cAclNamedUserTimeRangeName_Type()
)
h3cAclNamedUserTimeRangeName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserTimeRangeName.setStatus("current")
_H3cAclNamedUserCount_Type = Unsigned32
_H3cAclNamedUserCount_Object = MibTableColumn
h3cAclNamedUserCount = _H3cAclNamedUserCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 11),
    _H3cAclNamedUserCount_Type()
)
h3cAclNamedUserCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cAclNamedUserCount.setStatus("current")
_H3cAclNamedUserCountClear_Type = CounterClear
_H3cAclNamedUserCountClear_Object = MibTableColumn
h3cAclNamedUserCountClear = _H3cAclNamedUserCountClear_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 12),
    _H3cAclNamedUserCountClear_Type()
)
h3cAclNamedUserCountClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cAclNamedUserCountClear.setStatus("current")


class _H3cAclNamedUserEnable_Type(TruthValue):
    """Custom type h3cAclNamedUserEnable based on TruthValue"""
    defaultValue = 2


_H3cAclNamedUserEnable_Type.__name__ = "TruthValue"
_H3cAclNamedUserEnable_Object = MibTableColumn
h3cAclNamedUserEnable = _H3cAclNamedUserEnable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 13),
    _H3cAclNamedUserEnable_Type()
)
h3cAclNamedUserEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cAclNamedUserEnable.setStatus("current")


class _H3cAclNamedUserComment_Type(OctetString):
    """Custom type h3cAclNamedUserComment based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 127),
    )
...
_H3cAclNamedUserComment_Type.__name__ = "OctetString"
_H3cAclNamedUserComment_Object = MibTableColumn
h3cAclNamedUserComment = _H3cAclNamedUserComment_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 14),
    _H3cAclNamedUserComment_Type()
)
h3cAclNamedUserComment.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserComment.setStatus("current")


class _H3cAclNamedUserLog_Type(TruthValue):
    """Custom type h3cAclNamedUserLog based on TruthValue"""
    defaultValue = 2


_H3cAclNamedUserLog_Type.__name__ = "TruthValue"
_H3cAclNamedUserLog_Object = MibTableColumn
h3cAclNamedUserLog = _H3cAclNamedUserLog_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 15),
    _H3cAclNamedUserLog_Type()
)
h3cAclNamedUserLog.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserLog.setStatus("current")


class _H3cAclNamedUserCounting_Type(TruthValue):
    """Custom type h3cAclNamedUserCounting based on TruthValue"""
    defaultValue = 2


_H3cAclNamedUserCounting_Type.__name__ = "TruthValue"
_H3cAclNamedUserCounting_Object = MibTableColumn
h3cAclNamedUserCounting = _H3cAclNamedUserCounting_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 4, 4, 1, 16),
    _H3cAclNamedUserCounting_Type()
)
h3cAclNamedUserCounting.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclNamedUserCounting.setStatus("current")
...
class _H3cAclPortRange_Type(OctetString):
    """Custom type h3cAclPortRange based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclPortRange_Type.__name__ = "OctetString"
...
_H3cAclIntervalGroup_ObjectIdentity = ObjectIdentity
h3cAclIntervalGroup = _H3cAclIntervalGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 6)
)
_H3cAclIntervalTable_Object = MibTable
h3cAclIntervalTable = _H3cAclIntervalTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 6, 1)
)
if mibBuilder.loadTexts:
    h3cAclIntervalTable.setStatus("current")
_H3cAclIntervalEntry_Object = MibTableRow
h3cAclIntervalEntry = _H3cAclIntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 6, 1, 1)
)
h3cAclIntervalEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cAclIntervalType"),
)
if mibBuilder.loadTexts:
    h3cAclIntervalEntry.setStatus("current")


class _H3cAclIntervalType_Type(Integer32):
    """Custom type h3cAclIntervalType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cAclIntervalType_Type.__name__ = "Integer32"
_H3cAclIntervalType_Object = MibTableColumn
h3cAclIntervalType = _H3cAclIntervalType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 6, 1, 1, 1),
    _H3cAclIntervalType_Type()
)
h3cAclIntervalType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cAclIntervalType.setStatus("current")


class _H3cAclIntervalValue_Type(Integer32):
    """Custom type h3cAclIntervalValue based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cAclIntervalValue_Type.__name__ = "Integer32"
_H3cAclIntervalValue_Object = MibTableColumn
h3cAclIntervalValue = _H3cAclIntervalValue_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 6, 1, 1, 2),
    _H3cAclIntervalValue_Type()
)
h3cAclIntervalValue.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIntervalValue.setStatus("current")
_H3cAclIntervalRowStatus_Type = RowStatus
_H3cAclIntervalRowStatus_Object = MibTableColumn
h3cAclIntervalRowStatus = _H3cAclIntervalRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 2, 6, 1, 1, 3),
    _H3cAclIntervalRowStatus_Type()
)
h3cAclIntervalRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cAclIntervalRowStatus.setStatus("current")
...
_H3cPfilterApplyHardCount_Type.__name__ = "TruthValue"
...
h3cPfilterAclGroupRunInfoEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cPfilterRunApplyObjType"),
    (0, "H3C-ACL-MIB", "h3cPfilterRunApplyObjIndex"),
    (0, "H3C-ACL-MIB", "h3cPfilterRunApplyDirection"),
    (0, "H3C-ACL-MIB", "h3cPfilterRunApplyAclType"),
    (0, "H3C-ACL-MIB", "h3cPfilterRunApplyAclIndex"),
)
if mibBuilder.loadTexts:
    h3cPfilterAclGroupRunInfoEntry.setStatus("current")


class _H3cPfilterRunApplyObjType_Type(Integer32):
    """Custom type h3cPfilterRunApplyObjType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilterRunApplyObjType_Type.__name__ = "Integer32"
_H3cPfilterRunApplyObjType_Object = MibTableColumn
h3cPfilterRunApplyObjType = _H3cPfilterRunApplyObjType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 1),
    _H3cPfilterRunApplyObjType_Type()
)
h3cPfilterRunApplyObjType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilterRunApplyObjType.setStatus("current")


class _H3cPfilterRunApplyObjIndex_Type(Integer32):
    """Custom type h3cPfilterRunApplyObjIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 2147483647),
    )
...
_H3cPfilterRunApplyObjIndex_Type.__name__ = "Integer32"
_H3cPfilterRunApplyObjIndex_Object = MibTableColumn
h3cPfilterRunApplyObjIndex = _H3cPfilterRunApplyObjIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 2),
    _H3cPfilterRunApplyObjIndex_Type()
)
h3cPfilterRunApplyObjIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilterRunApplyObjIndex.setStatus("current")
_H3cPfilterRunApplyDirection_Type = DirectionType
_H3cPfilterRunApplyDirection_Object = MibTableColumn
h3cPfilterRunApplyDirection = _H3cPfilterRunApplyDirection_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 3),
    _H3cPfilterRunApplyDirection_Type()
)
h3cPfilterRunApplyDirection.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilterRunApplyDirection.setStatus("current")


class _H3cPfilterRunApplyAclType_Type(Integer32):
    """Custom type h3cPfilterRunApplyAclType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilterRunApplyAclType_Type.__name__ = "Integer32"
_H3cPfilterRunApplyAclType_Object = MibTableColumn
h3cPfilterRunApplyAclType = _H3cPfilterRunApplyAclType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 4),
    _H3cPfilterRunApplyAclType_Type()
)
h3cPfilterRunApplyAclType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilterRunApplyAclType.setStatus("current")


class _H3cPfilterRunApplyAclIndex_Type(Integer32):
    """Custom type h3cPfilterRunApplyAclIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cPfilterRunApplyAclIndex_Type.__name__ = "Integer32"
_H3cPfilterRunApplyAclIndex_Object = MibTableColumn
h3cPfilterRunApplyAclIndex = _H3cPfilterRunApplyAclIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 5),
    _H3cPfilterRunApplyAclIndex_Type()
)
h3cPfilterRunApplyAclIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilterRunApplyAclIndex.setStatus("current")
...
h3cPfilterAclGroupCountStatus = _H3cPfilterAclGroupCountStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 7),
...
h3cPfilterAclGroupPermitPkts = _H3cPfilterAclGroupPermitPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 8),
...
h3cPfilterAclGroupPermitBytes = _H3cPfilterAclGroupPermitBytes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 9),
...
h3cPfilterAclGroupDenyPkts = _H3cPfilterAclGroupDenyPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 10),
...
h3cPfilterAclGroupDenyBytes = _H3cPfilterAclGroupDenyBytes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 3, 1, 11),
...
_H3cPfilter2ApplyTable_Object = MibTable
h3cPfilter2ApplyTable = _H3cPfilter2ApplyTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6)
)
if mibBuilder.loadTexts:
    h3cPfilter2ApplyTable.setStatus("current")
_H3cPfilter2ApplyEntry_Object = MibTableRow
h3cPfilter2ApplyEntry = _H3cPfilter2ApplyEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1)
)
h3cPfilter2ApplyEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cPfilter2ApplyObjType"),
    (0, "H3C-ACL-MIB", "h3cPfilter2ApplyObjIndex"),
    (0, "H3C-ACL-MIB", "h3cPfilter2ApplyDirection"),
    (0, "H3C-ACL-MIB", "h3cPfilter2ApplyAclType"),
    (0, "H3C-ACL-MIB", "h3cPfilter2ApplyAclIndex"),
)
if mibBuilder.loadTexts:
    h3cPfilter2ApplyEntry.setStatus("current")


class _H3cPfilter2ApplyObjType_Type(Integer32):
    """Custom type h3cPfilter2ApplyObjType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilter2ApplyObjType_Type.__name__ = "Integer32"
_H3cPfilter2ApplyObjType_Object = MibTableColumn
h3cPfilter2ApplyObjType = _H3cPfilter2ApplyObjType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1, 1),
    _H3cPfilter2ApplyObjType_Type()
)
h3cPfilter2ApplyObjType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cPfilter2ApplyObjType.setStatus("current")


class _H3cPfilter2ApplyObjIndex_Type(Integer32):
    """Custom type h3cPfilter2ApplyObjIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 2147483647),
    )
...
_H3cPfilter2ApplyObjIndex_Type.__name__ = "Integer32"
_H3cPfilter2ApplyObjIndex_Object = MibTableColumn
h3cPfilter2ApplyObjIndex = _H3cPfilter2ApplyObjIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1, 2),
    _H3cPfilter2ApplyObjIndex_Type()
)
h3cPfilter2ApplyObjIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cPfilter2ApplyObjIndex.setStatus("current")
_H3cPfilter2ApplyDirection_Type = DirectionType
_H3cPfilter2ApplyDirection_Object = MibTableColumn
h3cPfilter2ApplyDirection = _H3cPfilter2ApplyDirection_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1, 3),
    _H3cPfilter2ApplyDirection_Type()
)
h3cPfilter2ApplyDirection.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cPfilter2ApplyDirection.setStatus("current")


class _H3cPfilter2ApplyAclType_Type(Integer32):
    """Custom type h3cPfilter2ApplyAclType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilter2ApplyAclType_Type.__name__ = "Integer32"
_H3cPfilter2ApplyAclType_Object = MibTableColumn
h3cPfilter2ApplyAclType = _H3cPfilter2ApplyAclType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1, 4),
    _H3cPfilter2ApplyAclType_Type()
)
h3cPfilter2ApplyAclType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cPfilter2ApplyAclType.setStatus("current")


class _H3cPfilter2ApplyAclIndex_Type(OctetString):
    """Custom type h3cPfilter2ApplyAclIndex based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 63),
    )
...
_H3cPfilter2ApplyAclIndex_Type.__name__ = "OctetString"
_H3cPfilter2ApplyAclIndex_Object = MibTableColumn
h3cPfilter2ApplyAclIndex = _H3cPfilter2ApplyAclIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1, 5),
    _H3cPfilter2ApplyAclIndex_Type()
)
h3cPfilter2ApplyAclIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cPfilter2ApplyAclIndex.setStatus("current")


class _H3cPfilter2ApplyHardCount_Type(TruthValue):
    """Custom type h3cPfilter2ApplyHardCount based on TruthValue"""
    defaultValue = 2


_H3cPfilter2ApplyHardCount_Type.__name__ = "TruthValue"
_H3cPfilter2ApplyHardCount_Object = MibTableColumn
h3cPfilter2ApplyHardCount = _H3cPfilter2ApplyHardCount_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1, 6),
    _H3cPfilter2ApplyHardCount_Type()
)
h3cPfilter2ApplyHardCount.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cPfilter2ApplyHardCount.setStatus("current")
_H3cPfilter2ApplySequence_Type = Unsigned32
_H3cPfilter2ApplySequence_Object = MibTableColumn
h3cPfilter2ApplySequence = _H3cPfilter2ApplySequence_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1, 7),
    _H3cPfilter2ApplySequence_Type()
)
h3cPfilter2ApplySequence.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2ApplySequence.setStatus("current")


class _H3cPfilter2ApplyCountClear_Type(CounterClear):
    """Custom type h3cPfilter2ApplyCountClear based on CounterClear"""
    defaultValue = 2


_H3cPfilter2ApplyCountClear_Type.__name__ = "CounterClear"
_H3cPfilter2ApplyCountClear_Object = MibTableColumn
h3cPfilter2ApplyCountClear = _H3cPfilter2ApplyCountClear_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1, 8),
    _H3cPfilter2ApplyCountClear_Type()
)
h3cPfilter2ApplyCountClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPfilter2ApplyCountClear.setStatus("current")
_H3cPfilter2ApplyRowStatus_Type = RowStatus
_H3cPfilter2ApplyRowStatus_Object = MibTableColumn
h3cPfilter2ApplyRowStatus = _H3cPfilter2ApplyRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 6, 1, 9),
    _H3cPfilter2ApplyRowStatus_Type()
)
h3cPfilter2ApplyRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    h3cPfilter2ApplyRowStatus.setStatus("current")
_H3cPfilter2AclGroupRunInfoTable_Object = MibTable
h3cPfilter2AclGroupRunInfoTable = _H3cPfilter2AclGroupRunInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7)
)
if mibBuilder.loadTexts:
    h3cPfilter2AclGroupRunInfoTable.setStatus("current")
_H3cPfilter2AclGroupRunInfoEntry_Object = MibTableRow
h3cPfilter2AclGroupRunInfoEntry = _H3cPfilter2AclGroupRunInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1)
)
h3cPfilter2AclGroupRunInfoEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyObjType"),
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyObjIndex"),
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyDirection"),
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyAclType"),
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyAclIndex"),
)
if mibBuilder.loadTexts:
    h3cPfilter2AclGroupRunInfoEntry.setStatus("current")


class _H3cPfilter2RunApplyObjType_Type(Integer32):
    """Custom type h3cPfilter2RunApplyObjType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilter2RunApplyObjType_Type.__name__ = "Integer32"
_H3cPfilter2RunApplyObjType_Object = MibTableColumn
h3cPfilter2RunApplyObjType = _H3cPfilter2RunApplyObjType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 1),
    _H3cPfilter2RunApplyObjType_Type()
)
h3cPfilter2RunApplyObjType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilter2RunApplyObjType.setStatus("current")


class _H3cPfilter2RunApplyObjIndex_Type(Integer32):
    """Custom type h3cPfilter2RunApplyObjIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 2147483647),
    )
...
_H3cPfilter2RunApplyObjIndex_Type.__name__ = "Integer32"
_H3cPfilter2RunApplyObjIndex_Object = MibTableColumn
h3cPfilter2RunApplyObjIndex = _H3cPfilter2RunApplyObjIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 2),
    _H3cPfilter2RunApplyObjIndex_Type()
)
h3cPfilter2RunApplyObjIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilter2RunApplyObjIndex.setStatus("current")
_H3cPfilter2RunApplyDirection_Type = DirectionType
_H3cPfilter2RunApplyDirection_Object = MibTableColumn
h3cPfilter2RunApplyDirection = _H3cPfilter2RunApplyDirection_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 3),
    _H3cPfilter2RunApplyDirection_Type()
)
h3cPfilter2RunApplyDirection.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilter2RunApplyDirection.setStatus("current")


class _H3cPfilter2RunApplyAclType_Type(Integer32):
    """Custom type h3cPfilter2RunApplyAclType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilter2RunApplyAclType_Type.__name__ = "Integer32"
_H3cPfilter2RunApplyAclType_Object = MibTableColumn
h3cPfilter2RunApplyAclType = _H3cPfilter2RunApplyAclType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 4),
    _H3cPfilter2RunApplyAclType_Type()
)
h3cPfilter2RunApplyAclType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilter2RunApplyAclType.setStatus("current")


class _H3cPfilter2RunApplyAclIndex_Type(OctetString):
    """Custom type h3cPfilter2RunApplyAclIndex based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 63),
    )
...
_H3cPfilter2RunApplyAclIndex_Type.__name__ = "OctetString"
_H3cPfilter2RunApplyAclIndex_Object = MibTableColumn
h3cPfilter2RunApplyAclIndex = _H3cPfilter2RunApplyAclIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 5),
    _H3cPfilter2RunApplyAclIndex_Type()
)
h3cPfilter2RunApplyAclIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilter2RunApplyAclIndex.setStatus("current")


class _H3cPfilter2AclGroupStatus_Type(Integer32):
    """Custom type h3cPfilter2AclGroupStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilter2AclGroupStatus_Type.__name__ = "Integer32"
_H3cPfilter2AclGroupStatus_Object = MibTableColumn
h3cPfilter2AclGroupStatus = _H3cPfilter2AclGroupStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 6),
    _H3cPfilter2AclGroupStatus_Type()
)
h3cPfilter2AclGroupStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclGroupStatus.setStatus("current")


class _H3cPfilter2AclGroupCountStatus_Type(Integer32):
    """Custom type h3cPfilter2AclGroupCountStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilter2AclGroupCountStatus_Type.__name__ = "Integer32"
_H3cPfilter2AclGroupCountStatus_Object = MibTableColumn
h3cPfilter2AclGroupCountStatus = _H3cPfilter2AclGroupCountStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 7),
    _H3cPfilter2AclGroupCountStatus_Type()
)
h3cPfilter2AclGroupCountStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclGroupCountStatus.setStatus("current")
_H3cPfilter2AclGroupPermitPkts_Type = Counter64
_H3cPfilter2AclGroupPermitPkts_Object = MibTableColumn
h3cPfilter2AclGroupPermitPkts = _H3cPfilter2AclGroupPermitPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 8),
    _H3cPfilter2AclGroupPermitPkts_Type()
)
h3cPfilter2AclGroupPermitPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclGroupPermitPkts.setStatus("current")
_H3cPfilter2AclGroupPermitBytes_Type = Counter64
_H3cPfilter2AclGroupPermitBytes_Object = MibTableColumn
h3cPfilter2AclGroupPermitBytes = _H3cPfilter2AclGroupPermitBytes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 9),
    _H3cPfilter2AclGroupPermitBytes_Type()
)
h3cPfilter2AclGroupPermitBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclGroupPermitBytes.setStatus("current")
_H3cPfilter2AclGroupDenyPkts_Type = Counter64
_H3cPfilter2AclGroupDenyPkts_Object = MibTableColumn
h3cPfilter2AclGroupDenyPkts = _H3cPfilter2AclGroupDenyPkts_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 10),
    _H3cPfilter2AclGroupDenyPkts_Type()
)
h3cPfilter2AclGroupDenyPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclGroupDenyPkts.setStatus("current")
_H3cPfilter2AclGroupDenyBytes_Type = Counter64
_H3cPfilter2AclGroupDenyBytes_Object = MibTableColumn
h3cPfilter2AclGroupDenyBytes = _H3cPfilter2AclGroupDenyBytes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 7, 1, 11),
    _H3cPfilter2AclGroupDenyBytes_Type()
)
h3cPfilter2AclGroupDenyBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclGroupDenyBytes.setStatus("current")
_H3cPfilter2AclRuleRunInfoTable_Object = MibTable
h3cPfilter2AclRuleRunInfoTable = _H3cPfilter2AclRuleRunInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 8)
)
if mibBuilder.loadTexts:
    h3cPfilter2AclRuleRunInfoTable.setStatus("current")
_H3cPfilter2AclRuleRunInfoEntry_Object = MibTableRow
h3cPfilter2AclRuleRunInfoEntry = _H3cPfilter2AclRuleRunInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 8, 1)
)
h3cPfilter2AclRuleRunInfoEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyObjType"),
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyObjIndex"),
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyDirection"),
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyAclType"),
    (0, "H3C-ACL-MIB", "h3cPfilter2RunApplyAclIndex"),
    (0, "H3C-ACL-MIB", "h3cPfilter2AclRuleIndex"),
)
if mibBuilder.loadTexts:
    h3cPfilter2AclRuleRunInfoEntry.setStatus("current")


class _H3cPfilter2AclRuleIndex_Type(Integer32):
    """Custom type h3cPfilter2AclRuleIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65534),
    )
...
_H3cPfilter2AclRuleIndex_Type.__name__ = "Integer32"
_H3cPfilter2AclRuleIndex_Object = MibTableColumn
h3cPfilter2AclRuleIndex = _H3cPfilter2AclRuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 8, 1, 1),
    _H3cPfilter2AclRuleIndex_Type()
)
h3cPfilter2AclRuleIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cPfilter2AclRuleIndex.setStatus("current")


class _H3cPfilter2AclRuleStatus_Type(Integer32):
    """Custom type h3cPfilter2AclRuleStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilter2AclRuleStatus_Type.__name__ = "Integer32"
_H3cPfilter2AclRuleStatus_Object = MibTableColumn
h3cPfilter2AclRuleStatus = _H3cPfilter2AclRuleStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 8, 1, 2),
    _H3cPfilter2AclRuleStatus_Type()
)
h3cPfilter2AclRuleStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclRuleStatus.setStatus("current")


class _H3cPfilter2AclRuleCountStatus_Type(Integer32):
    """Custom type h3cPfilter2AclRuleCountStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilter2AclRuleCountStatus_Type.__name__ = "Integer32"
_H3cPfilter2AclRuleCountStatus_Object = MibTableColumn
h3cPfilter2AclRuleCountStatus = _H3cPfilter2AclRuleCountStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 8, 1, 3),
    _H3cPfilter2AclRuleCountStatus_Type()
)
h3cPfilter2AclRuleCountStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclRuleCountStatus.setStatus("current")
_H3cPfilter2AclRuleMatchPackets_Type = Counter64
_H3cPfilter2AclRuleMatchPackets_Object = MibTableColumn
h3cPfilter2AclRuleMatchPackets = _H3cPfilter2AclRuleMatchPackets_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 8, 1, 4),
    _H3cPfilter2AclRuleMatchPackets_Type()
)
h3cPfilter2AclRuleMatchPackets.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclRuleMatchPackets.setStatus("current")
_H3cPfilter2AclRuleMatchBytes_Type = Counter64
_H3cPfilter2AclRuleMatchBytes_Object = MibTableColumn
h3cPfilter2AclRuleMatchBytes = _H3cPfilter2AclRuleMatchBytes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 8, 1, 5),
    _H3cPfilter2AclRuleMatchBytes_Type()
)
h3cPfilter2AclRuleMatchBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2AclRuleMatchBytes.setStatus("current")
_H3cPfilter2StatisticSumTable_Object = MibTable
h3cPfilter2StatisticSumTable = _H3cPfilter2StatisticSumTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 9)
)
if mibBuilder.loadTexts:
    h3cPfilter2StatisticSumTable.setStatus("current")
_H3cPfilter2StatisticSumEntry_Object = MibTableRow
h3cPfilter2StatisticSumEntry = _H3cPfilter2StatisticSumEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 9, 1)
)
h3cPfilter2StatisticSumEntry.setIndexNames(
    (0, "H3C-ACL-MIB", "h3cPfilter2SumDirection"),
    (0, "H3C-ACL-MIB", "h3cPfilter2SumAclType"),
    (0, "H3C-ACL-MIB", "h3cPfilter2SumAclIndex"),
    (0, "H3C-ACL-MIB", "h3cPfilter2SumRuleIndex"),
)
if mibBuilder.loadTexts:
    h3cPfilter2StatisticSumEntry.setStatus("current")
_H3cPfilter2SumDirection_Type = DirectionType
_H3cPfilter2SumDirection_Object = MibTableColumn
h3cPfilter2SumDirection = _H3cPfilter2SumDirection_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 9, 1, 1),
    _H3cPfilter2SumDirection_Type()
)
h3cPfilter2SumDirection.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilter2SumDirection.setStatus("current")


class _H3cPfilter2SumAclType_Type(Integer32):
    """Custom type h3cPfilter2SumAclType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_H3cPfilter2SumAclType_Type.__name__ = "Integer32"
_H3cPfilter2SumAclType_Object = MibTableColumn
h3cPfilter2SumAclType = _H3cPfilter2SumAclType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 9, 1, 2),
    _H3cPfilter2SumAclType_Type()
)
h3cPfilter2SumAclType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilter2SumAclType.setStatus("current")


class _H3cPfilter2SumAclIndex_Type(OctetString):
    """Custom type h3cPfilter2SumAclIndex based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 63),
    )
...
_H3cPfilter2SumAclIndex_Type.__name__ = "OctetString"
_H3cPfilter2SumAclIndex_Object = MibTableColumn
h3cPfilter2SumAclIndex = _H3cPfilter2SumAclIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 9, 1, 3),
    _H3cPfilter2SumAclIndex_Type()
)
h3cPfilter2SumAclIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilter2SumAclIndex.setStatus("current")


class _H3cPfilter2SumRuleIndex_Type(Integer32):
    """Custom type h3cPfilter2SumRuleIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65534),
    )
...
_H3cPfilter2SumRuleIndex_Type.__name__ = "Integer32"
_H3cPfilter2SumRuleIndex_Object = MibTableColumn
h3cPfilter2SumRuleIndex = _H3cPfilter2SumRuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 9, 1, 4),
    _H3cPfilter2SumRuleIndex_Type()
)
h3cPfilter2SumRuleIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    h3cPfilter2SumRuleIndex.setStatus("current")
_H3cPfilter2SumRuleMatchPackets_Type = Counter64
_H3cPfilter2SumRuleMatchPackets_Object = MibTableColumn
h3cPfilter2SumRuleMatchPackets = _H3cPfilter2SumRuleMatchPackets_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 9, 1, 5),
    _H3cPfilter2SumRuleMatchPackets_Type()
)
h3cPfilter2SumRuleMatchPackets.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2SumRuleMatchPackets.setStatus("current")
_H3cPfilter2SumRuleMatchBytes_Type = Counter64
_H3cPfilter2SumRuleMatchBytes_Object = MibTableColumn
h3cPfilter2SumRuleMatchBytes = _H3cPfilter2SumRuleMatchBytes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 3, 9, 1, 6),
    _H3cPfilter2SumRuleMatchBytes_Type()
)
h3cPfilter2SumRuleMatchBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cPfilter2SumRuleMatchBytes.setStatus("current")
...
class _H3cPfilterDirection_Type(OctetString):
    """Custom type h3cPfilterDirection based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cPfilterDirection_Type.__name__ = "OctetString"
...
class _H3cPfilterAction_Type(OctetString):
    """Custom type h3cPfilterAction based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cPfilterAction_Type.__name__ = "OctetString"
...
class _H3cMACfilterSourceMac_Type(OctetString):
    """Custom type h3cMACfilterSourceMac based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cMACfilterSourceMac_Type.__name__ = "OctetString"
...
class _H3cMACfilterDestinationMac_Type(OctetString):
    """Custom type h3cMACfilterDestinationMac based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cMACfilterDestinationMac_Type.__name__ = "OctetString"
...
class _H3cPfilterReceiveInterface_Type(OctetString):
    """Custom type h3cPfilterReceiveInterface based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cPfilterReceiveInterface_Type.__name__ = "OctetString"
...
class _H3cAclPacketIfName_Type(OctetString):
    """Custom type h3cAclPacketIfName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclPacketIfName_Type.__name__ = "OctetString"
_H3cAclPacketIfName_Object = MibScalar
h3cAclPacketIfName = _H3cAclPacketIfName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 9),
    _H3cAclPacketIfName_Type()
)
h3cAclPacketIfName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketIfName.setStatus("current")
_H3cAclPacketDirection_Type = DirectionType
_H3cAclPacketDirection_Object = MibScalar
h3cAclPacketDirection = _H3cAclPacketDirection_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 10),
    _H3cAclPacketDirection_Type()
)
h3cAclPacketDirection.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketDirection.setStatus("current")


class _H3cAclPacketBAGG_Type(Integer32):
    """Custom type h3cAclPacketBAGG based on Integer32"""
    defaultValue = 0
...
_H3cAclPacketBAGG_Type.__name__ = "Integer32"
_H3cAclPacketBAGG_Object = MibScalar
h3cAclPacketBAGG = _H3cAclPacketBAGG_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 11),
    _H3cAclPacketBAGG_Type()
)
h3cAclPacketBAGG.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketBAGG.setStatus("current")


class _H3cAclPacketVlanID_Type(Integer32):
    """Custom type h3cAclPacketVlanID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cAclPacketVlanID_Type.__name__ = "Integer32"
_H3cAclPacketVlanID_Object = MibScalar
h3cAclPacketVlanID = _H3cAclPacketVlanID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 12),
    _H3cAclPacketVlanID_Type()
)
h3cAclPacketVlanID.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketVlanID.setStatus("current")


class _H3cAclPacketSrcIP_Type(OctetString):
    """Custom type h3cAclPacketSrcIP based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclPacketSrcIP_Type.__name__ = "OctetString"
_H3cAclPacketSrcIP_Object = MibScalar
h3cAclPacketSrcIP = _H3cAclPacketSrcIP_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 13),
    _H3cAclPacketSrcIP_Type()
)
h3cAclPacketSrcIP.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketSrcIP.setStatus("current")


class _H3cAclPacketDstIP_Type(OctetString):
    """Custom type h3cAclPacketDstIP based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_H3cAclPacketDstIP_Type.__name__ = "OctetString"
_H3cAclPacketDstIP_Object = MibScalar
h3cAclPacketDstIP = _H3cAclPacketDstIP_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 14),
    _H3cAclPacketDstIP_Type()
)
h3cAclPacketDstIP.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketDstIP.setStatus("current")


class _H3cAclPacketProtocol_Type(Integer32):
    """Custom type h3cAclPacketProtocol based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_H3cAclPacketProtocol_Type.__name__ = "Integer32"
_H3cAclPacketProtocol_Object = MibScalar
h3cAclPacketProtocol = _H3cAclPacketProtocol_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 15),
    _H3cAclPacketProtocol_Type()
)
h3cAclPacketProtocol.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketProtocol.setStatus("current")


class _H3cAclPacketDscp_Type(DSCPValue):
    """Custom type h3cAclPacketDscp based on DSCPValue"""
    defaultValue = 255


_H3cAclPacketDscp_Type.__name__ = "DSCPValue"
_H3cAclPacketDscp_Object = MibScalar
h3cAclPacketDscp = _H3cAclPacketDscp_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 16),
    _H3cAclPacketDscp_Type()
)
h3cAclPacketDscp.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketDscp.setStatus("current")


class _H3cAclPacketFlowLabel_Type(Unsigned32):
    """Custom type h3cAclPacketFlowLabel based on Unsigned32"""
    defaultValue = 4294967295
...
_H3cAclPacketFlowLabel_Type.__name__ = "Unsigned32"
_H3cAclPacketFlowLabel_Object = MibScalar
h3cAclPacketFlowLabel = _H3cAclPacketFlowLabel_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 17),
    _H3cAclPacketFlowLabel_Type()
)
h3cAclPacketFlowLabel.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketFlowLabel.setStatus("current")


class _H3cAclPacketIcmpIgmpType_Type(Integer32):
    """Custom type h3cAclPacketIcmpIgmpType based on Integer32"""
    defaultValue = 65535
...
_H3cAclPacketIcmpIgmpType_Type.__name__ = "Integer32"
_H3cAclPacketIcmpIgmpType_Object = MibScalar
h3cAclPacketIcmpIgmpType = _H3cAclPacketIcmpIgmpType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 18),
    _H3cAclPacketIcmpIgmpType_Type()
)
h3cAclPacketIcmpIgmpType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketIcmpIgmpType.setStatus("current")


class _H3cAclPacketIcmpIgmpCode_Type(Integer32):
    """Custom type h3cAclPacketIcmpIgmpCode based on Integer32"""
    defaultValue = 65535
...
_H3cAclPacketIcmpIgmpCode_Type.__name__ = "Integer32"
_H3cAclPacketIcmpIgmpCode_Object = MibScalar
h3cAclPacketIcmpIgmpCode = _H3cAclPacketIcmpIgmpCode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 19),
    _H3cAclPacketIcmpIgmpCode_Type()
)
h3cAclPacketIcmpIgmpCode.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketIcmpIgmpCode.setStatus("current")


class _H3cAclPacketTcpFlags_Type(Integer32):
    """Custom type h3cAclPacketTcpFlags based on Integer32"""
    defaultValue = 255
...
_H3cAclPacketTcpFlags_Type.__name__ = "Integer32"
_H3cAclPacketTcpFlags_Object = MibScalar
h3cAclPacketTcpFlags = _H3cAclPacketTcpFlags_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 20),
    _H3cAclPacketTcpFlags_Type()
)
h3cAclPacketTcpFlags.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketTcpFlags.setStatus("current")


class _H3cAclPacketSrcPort_Type(Integer32):
    """Custom type h3cAclPacketSrcPort based on Integer32"""
    defaultValue = 0
...
_H3cAclPacketSrcPort_Type.__name__ = "Integer32"
_H3cAclPacketSrcPort_Object = MibScalar
h3cAclPacketSrcPort = _H3cAclPacketSrcPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 21),
    _H3cAclPacketSrcPort_Type()
)
h3cAclPacketSrcPort.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketSrcPort.setStatus("current")


class _H3cAclPacketDstPort_Type(Integer32):
    """Custom type h3cAclPacketDstPort based on Integer32"""
    defaultValue = 65535
...
_H3cAclPacketDstPort_Type.__name__ = "Integer32"
_H3cAclPacketDstPort_Object = MibScalar
h3cAclPacketDstPort = _H3cAclPacketDstPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 22),
    _H3cAclPacketDstPort_Type()
)
h3cAclPacketDstPort.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketDstPort.setStatus("current")
_H3cAclPacketSrcMacAddr_Type = MacAddress
_H3cAclPacketSrcMacAddr_Object = MibScalar
h3cAclPacketSrcMacAddr = _H3cAclPacketSrcMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 23),
    _H3cAclPacketSrcMacAddr_Type()
)
h3cAclPacketSrcMacAddr.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketSrcMacAddr.setStatus("current")
_H3cAclPacketDstMacAddr_Type = MacAddress
_H3cAclPacketDstMacAddr_Object = MibScalar
h3cAclPacketDstMacAddr = _H3cAclPacketDstMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 24),
    _H3cAclPacketDstMacAddr_Type()
)
h3cAclPacketDstMacAddr.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketDstMacAddr.setStatus("current")


class _H3cAclPacketMacTypeLen_Type(Integer32):
    """Custom type h3cAclPacketMacTypeLen based on Integer32"""
    defaultValue = 0
...
_H3cAclPacketMacTypeLen_Type.__name__ = "Integer32"
_H3cAclPacketMacTypeLen_Object = MibScalar
h3cAclPacketMacTypeLen = _H3cAclPacketMacTypeLen_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 25),
    _H3cAclPacketMacTypeLen_Type()
)
h3cAclPacketMacTypeLen.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketMacTypeLen.setStatus("current")


class _H3cAclPacketVlanPCP_Type(Integer32):
    """Custom type h3cAclPacketVlanPCP based on Integer32"""
    defaultValue = 255
...
_H3cAclPacketVlanPCP_Type.__name__ = "Integer32"
_H3cAclPacketVlanPCP_Object = MibScalar
h3cAclPacketVlanPCP = _H3cAclPacketVlanPCP_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 4, 26),
    _H3cAclPacketVlanPCP_Type()
)
h3cAclPacketVlanPCP.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclPacketVlanPCP.setStatus("current")
...
_H3cAclTrapObjects_ObjectIdentity = ObjectIdentity
h3cAclTrapObjects = _H3cAclTrapObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 6)
)


class _H3cAclResourceTypeName_Type(OctetString):
    """Custom type h3cAclResourceTypeName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cAclResourceTypeName_Type.__name__ = "OctetString"
_H3cAclResourceTypeName_Object = MibScalar
h3cAclResourceTypeName = _H3cAclResourceTypeName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 6, 1),
    _H3cAclResourceTypeName_Type()
)
h3cAclResourceTypeName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclResourceTypeName.setStatus("current")


class _H3cAclResourceUsage_Type(Integer32):
    """Custom type h3cAclResourceUsage based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cAclResourceUsage_Type.__name__ = "Integer32"
_H3cAclResourceUsage_Object = MibScalar
h3cAclResourceUsage = _H3cAclResourceUsage_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 6, 2),
    _H3cAclResourceUsage_Type()
)
h3cAclResourceUsage.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclResourceUsage.setStatus("current")
_H3cAclResourceUsedEntries_Type = Integer32
_H3cAclResourceUsedEntries_Object = MibScalar
h3cAclResourceUsedEntries = _H3cAclResourceUsedEntries_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 6, 3),
    _H3cAclResourceUsedEntries_Type()
)
h3cAclResourceUsedEntries.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclResourceUsedEntries.setStatus("current")
_H3cAclResourceTotalEntries_Type = Integer32
_H3cAclResourceTotalEntries_Object = MibScalar
h3cAclResourceTotalEntries = _H3cAclResourceTotalEntries_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 6, 4),
    _H3cAclResourceTotalEntries_Type()
)
h3cAclResourceTotalEntries.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclResourceTotalEntries.setStatus("current")
_H3cAclResourceChassisID_Type = Integer32
_H3cAclResourceChassisID_Object = MibScalar
h3cAclResourceChassisID = _H3cAclResourceChassisID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 6, 5),
    _H3cAclResourceChassisID_Type()
)
h3cAclResourceChassisID.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclResourceChassisID.setStatus("current")
_H3cAclResourceSlotID_Type = Integer32
_H3cAclResourceSlotID_Object = MibScalar
h3cAclResourceSlotID = _H3cAclResourceSlotID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 6, 6),
    _H3cAclResourceSlotID_Type()
)
h3cAclResourceSlotID.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    h3cAclResourceSlotID.setStatus("current")
_H3cAclTrap_ObjectIdentity = ObjectIdentity
h3cAclTrap = _H3cAclTrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 7)
)
_H3cAclTrapPrefix_ObjectIdentity = ObjectIdentity
h3cAclTrapPrefix = _H3cAclTrapPrefix_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 7, 0)
)
...
h3cAclRuleMatchCount = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 5, 0, 2)
)
h3cAclRuleMatchCount.setObjects(
      *(("H3C-ACL-MIB", "h3cPfilter2ApplyObjType"),
        ("H3C-ACL-MIB", "h3cPfilter2ApplyObjIndex"),
        ("H3C-ACL-MIB", "h3cPfilter2ApplyDirection"),
        ("H3C-ACL-MIB", "h3cPfilter2ApplyAclType"),
        ("H3C-ACL-MIB", "h3cPfilter2ApplyAclIndex"),
        ("H3C-ACL-MIB", "h3cPfilter2AclRuleIndex"),
        ("H3C-ACL-MIB", "h3cPfilter2AclRuleMatchPackets"))
)
if mibBuilder.loadTexts:
    h3cAclRuleMatchCount.setStatus(
        "current"
    )

h3cAclFirstIPv4PktCaptured = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 5, 0, 3)
)
h3cAclFirstIPv4PktCaptured.setObjects(
      *(("H3C-ACL-MIB", "h3cPfilter2ApplyAclIndex"),
        ("H3C-ACL-MIB", "h3cPfilter2AclRuleIndex"),
        ("H3C-ACL-MIB", "h3cAclPacketIfName"),
        ("H3C-ACL-MIB", "h3cAclPacketDirection"),
        ("H3C-ACL-MIB", "h3cAclPacketBAGG"),
        ("H3C-ACL-MIB", "h3cAclPacketVlanID"),
        ("H3C-ACL-MIB", "h3cAclPacketSrcIP"),
        ("H3C-ACL-MIB", "h3cAclPacketDstIP"),
        ("H3C-ACL-MIB", "h3cAclPacketProtocol"),
        ("H3C-ACL-MIB", "h3cAclPacketDscp"),
        ("H3C-ACL-MIB", "h3cAclPacketIcmpIgmpType"),
        ("H3C-ACL-MIB", "h3cAclPacketIcmpIgmpCode"),
        ("H3C-ACL-MIB", "h3cAclPacketTcpFlags"),
        ("H3C-ACL-MIB", "h3cAclPacketSrcPort"),
        ("H3C-ACL-MIB", "h3cAclPacketDstPort"))
)
if mibBuilder.loadTexts:
    h3cAclFirstIPv4PktCaptured.setStatus(
        "current"
    )

h3cAclFirstIPv6PktCaptured = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 5, 0, 4)
)
h3cAclFirstIPv6PktCaptured.setObjects(
      *(("H3C-ACL-MIB", "h3cPfilter2ApplyAclIndex"),
        ("H3C-ACL-MIB", "h3cPfilter2AclRuleIndex"),
        ("H3C-ACL-MIB", "h3cAclPacketIfName"),
        ("H3C-ACL-MIB", "h3cAclPacketDirection"),
...
if mibBuilder.loadTexts:
    h3cAclFirstIPv6PktCaptured.setStatus(
        "current"
    )

h3cAclFirstEthernetPktCaptured = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 5, 0, 5)
)
h3cAclFirstEthernetPktCaptured.setObjects(
      *(("H3C-ACL-MIB", "h3cPfilter2ApplyAclIndex"),
        ("H3C-ACL-MIB", "h3cPfilter2AclRuleIndex"),
        ("H3C-ACL-MIB", "h3cAclPacketIfName"),
        ("H3C-ACL-MIB", "h3cAclPacketDirection"),
        ("H3C-ACL-MIB", "h3cAclPacketBAGG"),
        ("H3C-ACL-MIB", "h3cAclPacketVlanID"),
        ("H3C-ACL-MIB", "h3cAclPacketSrcMacAddr"),
        ("H3C-ACL-MIB", "h3cAclPacketDstMacAddr"),
        ("H3C-ACL-MIB", "h3cAclPacketMacTypeLen"),
        ("H3C-ACL-MIB", "h3cAclPacketVlanPCP"))
)
if mibBuilder.loadTexts:
    h3cAclFirstEthernetPktCaptured.setStatus(
        "current"
    )

h3cAclResourceTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 8, 7, 0, 1)
)
h3cAclResourceTrap.setObjects(
      *(("H3C-ACL-MIB", "h3cAclResourceTypeName"),
        ("H3C-ACL-MIB", "h3cAclResourceUsage"),
        ("H3C-ACL-MIB", "h3cAclResourceUsedEntries"),
        ("H3C-ACL-MIB", "h3cAclResourceTotalEntries"),
        ("H3C-ACL-MIB", "h3cAclMib2ResourceThreshold"),
        ("H3C-ACL-MIB", "h3cAclResourceChassisID"),
        ("H3C-ACL-MIB", "h3cAclResourceSlotID"))
)
if mibBuilder.loadTexts:
    h3cAclResourceTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"RuleAction": RuleAction,
       ...
       "h3cAclMib2ResourceThreshold": h3cAclMib2ResourceThreshold,
       "h3cAclMib2ResourceLogInterval": h3cAclMib2ResourceLogInterval,
       ...
       "h3cAclNamedGroupTable": h3cAclNamedGroupTable,
       "h3cAclNamedGroupEntry": h3cAclNamedGroupEntry,
       "h3cAclNamedGroupCategory": h3cAclNamedGroupCategory,
       "h3cAclNamedGroupName": h3cAclNamedGroupName,
       "h3cAclNamedGroupRowStatus": h3cAclNamedGroupRowStatus,
       "h3cAclNamedGroupMatchOrder": h3cAclNamedGroupMatchOrder,
       "h3cAclNamedGroupStep": h3cAclNamedGroupStep,
       "h3cAclNamedGroupDescription": h3cAclNamedGroupDescription,
       "h3cAclNamedGroupCountClear": h3cAclNamedGroupCountClear,
       "h3cAclNamedGroupRuleCounter": h3cAclNamedGroupRuleCounter,
       ...
       "h3cAclIPAclAdvancedSrcSuffix": h3cAclIPAclAdvancedSrcSuffix,
       "h3cAclIPAclAdvancedDestSuffix": h3cAclIPAclAdvancedDestSuffix,
       "h3cAclIPAclNamedBscTable": h3cAclIPAclNamedBscTable,
       "h3cAclIPAclNamedBscEntry": h3cAclIPAclNamedBscEntry,
       "h3cAclIPAclNamedBscRowStatus": h3cAclIPAclNamedBscRowStatus,
       "h3cAclIPAclNamedBscAct": h3cAclIPAclNamedBscAct,
       "h3cAclIPAclNamedBscSrcAddrType": h3cAclIPAclNamedBscSrcAddrType,
       "h3cAclIPAclNamedBscSrcAddr": h3cAclIPAclNamedBscSrcAddr,
       "h3cAclIPAclNamedBscSrcPrefix": h3cAclIPAclNamedBscSrcPrefix,
       "h3cAclIPAclNamedBscSrcAny": h3cAclIPAclNamedBscSrcAny,
       "h3cAclIPAclNamedBscSrcWild": h3cAclIPAclNamedBscSrcWild,
       "h3cAclIPAclNamedBscTRangeName": h3cAclIPAclNamedBscTRangeName,
       "h3cAclIPAclNamedBscFragmentFlag": h3cAclIPAclNamedBscFragmentFlag,
       "h3cAclIPAclNamedBscLog": h3cAclIPAclNamedBscLog,
       "h3cAclIPAclNamedBscCount": h3cAclIPAclNamedBscCount,
       "h3cAclIPAclNamedBscCountClear": h3cAclIPAclNamedBscCountClear,
       "h3cAclIPAclNamedBscEnable": h3cAclIPAclNamedBscEnable,
       "h3cAclIPAclNamedBscVpnInstName": h3cAclIPAclNamedBscVpnInstName,
       "h3cAclIPAclNamedBscComment": h3cAclIPAclNamedBscComment,
       "h3cAclIPAclNamedBscCounting": h3cAclIPAclNamedBscCounting,
       "h3cAclIPAclNamedBscRouteTypeAny": h3cAclIPAclNamedBscRouteTypeAny,
       "h3cAclIPAclNamedBscRouteTypeValue": h3cAclIPAclNamedBscRouteTypeValue,
       "h3cAclIPAclNamedAdvTable": h3cAclIPAclNamedAdvTable,
       "h3cAclIPAclNamedAdvEntry": h3cAclIPAclNamedAdvEntry,
       "h3cAclIPAclNamedAdvRowStatus": h3cAclIPAclNamedAdvRowStatus,
       "h3cAclIPAclNamedAdvAct": h3cAclIPAclNamedAdvAct,
       "h3cAclIPAclNamedAdvProtocol": h3cAclIPAclNamedAdvProtocol,
       "h3cAclIPAclNamedAdvAddrFlag": h3cAclIPAclNamedAdvAddrFlag,
       "h3cAclIPAclNamedAdvSrcAddrType": h3cAclIPAclNamedAdvSrcAddrType,
       "h3cAclIPAclNamedAdvSrcAddr": h3cAclIPAclNamedAdvSrcAddr,
       "h3cAclIPAclNamedAdvSrcPrefix": h3cAclIPAclNamedAdvSrcPrefix,
       "h3cAclIPAclNamedAdvSrcAny": h3cAclIPAclNamedAdvSrcAny,
       "h3cAclIPAclNamedAdvSrcWild": h3cAclIPAclNamedAdvSrcWild,
       "h3cAclIPAclNamedAdvSrcOp": h3cAclIPAclNamedAdvSrcOp,
       "h3cAclIPAclNamedAdvSrcPort1": h3cAclIPAclNamedAdvSrcPort1,
       "h3cAclIPAclNamedAdvSrcPort2": h3cAclIPAclNamedAdvSrcPort2,
       "h3cAclIPAclNamedAdvDstAddrType": h3cAclIPAclNamedAdvDstAddrType,
       "h3cAclIPAclNamedAdvDstAddr": h3cAclIPAclNamedAdvDstAddr,
       "h3cAclIPAclNamedAdvDstPrefix": h3cAclIPAclNamedAdvDstPrefix,
       "h3cAclIPAclNamedAdvDstAny": h3cAclIPAclNamedAdvDstAny,
       "h3cAclIPAclNamedAdvDstWild": h3cAclIPAclNamedAdvDstWild,
       "h3cAclIPAclNamedAdvDstOp": h3cAclIPAclNamedAdvDstOp,
       "h3cAclIPAclNamedAdvDstPort1": h3cAclIPAclNamedAdvDstPort1,
       "h3cAclIPAclNamedAdvDstPort2": h3cAclIPAclNamedAdvDstPort2,
       "h3cAclIPAclNamedAdvIcmpType": h3cAclIPAclNamedAdvIcmpType,
       "h3cAclIPAclNamedAdvIcmpCode": h3cAclIPAclNamedAdvIcmpCode,
       "h3cAclIPAclNamedAdvPrecedence": h3cAclIPAclNamedAdvPrecedence,
       "h3cAclIPAclNamedAdvTos": h3cAclIPAclNamedAdvTos,
       "h3cAclIPAclNamedAdvDscp": h3cAclIPAclNamedAdvDscp,
       "h3cAclIPAclNamedAdvTRangeName": h3cAclIPAclNamedAdvTRangeName,
       "h3cAclIPAclNamedAdvTCPFlag": h3cAclIPAclNamedAdvTCPFlag,
       "h3cAclIPAclNamedAdvFragmentFlag": h3cAclIPAclNamedAdvFragmentFlag,
       "h3cAclIPAclNamedAdvLog": h3cAclIPAclNamedAdvLog,
       "h3cAclIPAclNamedAdvCount": h3cAclIPAclNamedAdvCount,
       "h3cAclIPAclNamedAdvCountClear": h3cAclIPAclNamedAdvCountClear,
       "h3cAclIPAclNamedAdvEnable": h3cAclIPAclNamedAdvEnable,
       "h3cAclIPAclNamedAdvVpnInstName": h3cAclIPAclNamedAdvVpnInstName,
       "h3cAclIPAclNamedAdvComment": h3cAclIPAclNamedAdvComment,
       "h3cAclIPAclNamedAdvReflective": h3cAclIPAclNamedAdvReflective,
       "h3cAclIPAclNamedAdvCounting": h3cAclIPAclNamedAdvCounting,
       "h3cAclIPAclNamedAdvTCPFlagMask": h3cAclIPAclNamedAdvTCPFlagMask,
       "h3cAclIPAclNamedAdvTCPFlagValue": h3cAclIPAclNamedAdvTCPFlagValue,
       "h3cAclIPAclNamedAdvRouteTypeAny": h3cAclIPAclNamedAdvRouteTypeAny,
       "h3cAclIPAclNamedAdvRouteTypeValue": h3cAclIPAclNamedAdvRouteTypeValue,
       "h3cAclIPAclNamedAdvFlowLabel": h3cAclIPAclNamedAdvFlowLabel,
       "h3cAclIPAclNamedAdvSrcSuffix": h3cAclIPAclNamedAdvSrcSuffix,
       "h3cAclIPAclNamedAdvDstSuffix": h3cAclIPAclNamedAdvDstSuffix,
       ...
       "h3cAclNamedMACTable": h3cAclNamedMACTable,
       "h3cAclNamedMACEntry": h3cAclNamedMACEntry,
       "h3cAclNamedMACRowStatus": h3cAclNamedMACRowStatus,
       "h3cAclNamedMACAct": h3cAclNamedMACAct,
       "h3cAclNamedMACTypeCode": h3cAclNamedMACTypeCode,
       "h3cAclNamedMACTypeMask": h3cAclNamedMACTypeMask,
       "h3cAclNamedMACSrcMac": h3cAclNamedMACSrcMac,
       "h3cAclNamedMACSrcMacWild": h3cAclNamedMACSrcMacWild,
       "h3cAclNamedMACDstMac": h3cAclNamedMACDstMac,
       "h3cAclNamedMACDstMacWild": h3cAclNamedMACDstMacWild,
       "h3cAclNamedMACLsapCode": h3cAclNamedMACLsapCode,
       "h3cAclNamedMACLsapMask": h3cAclNamedMACLsapMask,
       "h3cAclNamedMACCos": h3cAclNamedMACCos,
       "h3cAclNamedMACTimeRangeName": h3cAclNamedMACTimeRangeName,
       "h3cAclNamedMACCount": h3cAclNamedMACCount,
       "h3cAclNamedMACCountClear": h3cAclNamedMACCountClear,
       "h3cAclNamedMACEnable": h3cAclNamedMACEnable,
       "h3cAclNamedMACComment": h3cAclNamedMACComment,
       "h3cAclNamedMACLog": h3cAclNamedMACLog,
       "h3cAclNamedMACCounting": h3cAclNamedMACCounting,
       ...
       "h3cAclNamedUserTable": h3cAclNamedUserTable,
       "h3cAclNamedUserEntry": h3cAclNamedUserEntry,
       "h3cAclNamedUserRowStatus": h3cAclNamedUserRowStatus,
       "h3cAclNamedUserAct": h3cAclNamedUserAct,
       "h3cAclNamedUserStartString": h3cAclNamedUserStartString,
       "h3cAclNamedUserL2String": h3cAclNamedUserL2String,
       "h3cAclNamedUserMplsString": h3cAclNamedUserMplsString,
       "h3cAclNamedUserIPv4String": h3cAclNamedUserIPv4String,
       "h3cAclNamedUserIPv6String": h3cAclNamedUserIPv6String,
       "h3cAclNamedUserL4String": h3cAclNamedUserL4String,
       "h3cAclNamedUserL5String": h3cAclNamedUserL5String,
       "h3cAclNamedUserTimeRangeName": h3cAclNamedUserTimeRangeName,
       "h3cAclNamedUserCount": h3cAclNamedUserCount,
       "h3cAclNamedUserCountClear": h3cAclNamedUserCountClear,
       "h3cAclNamedUserEnable": h3cAclNamedUserEnable,
       "h3cAclNamedUserComment": h3cAclNamedUserComment,
       "h3cAclNamedUserLog": h3cAclNamedUserLog,
       "h3cAclNamedUserCounting": h3cAclNamedUserCounting,
       ...
       "h3cAclIntervalGroup": h3cAclIntervalGroup,
       "h3cAclIntervalTable": h3cAclIntervalTable,
       "h3cAclIntervalEntry": h3cAclIntervalEntry,
       "h3cAclIntervalType": h3cAclIntervalType,
       "h3cAclIntervalValue": h3cAclIntervalValue,
       "h3cAclIntervalRowStatus": h3cAclIntervalRowStatus,
       ...
       "h3cPfilterRunApplyObjType": h3cPfilterRunApplyObjType,
       "h3cPfilterRunApplyObjIndex": h3cPfilterRunApplyObjIndex,
       "h3cPfilterRunApplyDirection": h3cPfilterRunApplyDirection,
       "h3cPfilterRunApplyAclType": h3cPfilterRunApplyAclType,
       "h3cPfilterRunApplyAclIndex": h3cPfilterRunApplyAclIndex,
       ...
       "h3cPfilter2ApplyTable": h3cPfilter2ApplyTable,
       "h3cPfilter2ApplyEntry": h3cPfilter2ApplyEntry,
       "h3cPfilter2ApplyObjType": h3cPfilter2ApplyObjType,
       "h3cPfilter2ApplyObjIndex": h3cPfilter2ApplyObjIndex,
       "h3cPfilter2ApplyDirection": h3cPfilter2ApplyDirection,
       "h3cPfilter2ApplyAclType": h3cPfilter2ApplyAclType,
       "h3cPfilter2ApplyAclIndex": h3cPfilter2ApplyAclIndex,
       "h3cPfilter2ApplyHardCount": h3cPfilter2ApplyHardCount,
       "h3cPfilter2ApplySequence": h3cPfilter2ApplySequence,
       "h3cPfilter2ApplyCountClear": h3cPfilter2ApplyCountClear,
       "h3cPfilter2ApplyRowStatus": h3cPfilter2ApplyRowStatus,
       "h3cPfilter2AclGroupRunInfoTable": h3cPfilter2AclGroupRunInfoTable,
       "h3cPfilter2AclGroupRunInfoEntry": h3cPfilter2AclGroupRunInfoEntry,
       "h3cPfilter2RunApplyObjType": h3cPfilter2RunApplyObjType,
       "h3cPfilter2RunApplyObjIndex": h3cPfilter2RunApplyObjIndex,
       "h3cPfilter2RunApplyDirection": h3cPfilter2RunApplyDirection,
       "h3cPfilter2RunApplyAclType": h3cPfilter2RunApplyAclType,
       "h3cPfilter2RunApplyAclIndex": h3cPfilter2RunApplyAclIndex,
       "h3cPfilter2AclGroupStatus": h3cPfilter2AclGroupStatus,
       "h3cPfilter2AclGroupCountStatus": h3cPfilter2AclGroupCountStatus,
       "h3cPfilter2AclGroupPermitPkts": h3cPfilter2AclGroupPermitPkts,
       "h3cPfilter2AclGroupPermitBytes": h3cPfilter2AclGroupPermitBytes,
       "h3cPfilter2AclGroupDenyPkts": h3cPfilter2AclGroupDenyPkts,
       "h3cPfilter2AclGroupDenyBytes": h3cPfilter2AclGroupDenyBytes,
       "h3cPfilter2AclRuleRunInfoTable": h3cPfilter2AclRuleRunInfoTable,
       "h3cPfilter2AclRuleRunInfoEntry": h3cPfilter2AclRuleRunInfoEntry,
       "h3cPfilter2AclRuleIndex": h3cPfilter2AclRuleIndex,
       "h3cPfilter2AclRuleStatus": h3cPfilter2AclRuleStatus,
       "h3cPfilter2AclRuleCountStatus": h3cPfilter2AclRuleCountStatus,
       "h3cPfilter2AclRuleMatchPackets": h3cPfilter2AclRuleMatchPackets,
       "h3cPfilter2AclRuleMatchBytes": h3cPfilter2AclRuleMatchBytes,
       "h3cPfilter2StatisticSumTable": h3cPfilter2StatisticSumTable,
       "h3cPfilter2StatisticSumEntry": h3cPfilter2StatisticSumEntry,
       "h3cPfilter2SumDirection": h3cPfilter2SumDirection,
       "h3cPfilter2SumAclType": h3cPfilter2SumAclType,
       "h3cPfilter2SumAclIndex": h3cPfilter2SumAclIndex,
       "h3cPfilter2SumRuleIndex": h3cPfilter2SumRuleIndex,
       "h3cPfilter2SumRuleMatchPackets": h3cPfilter2SumRuleMatchPackets,
       "h3cPfilter2SumRuleMatchBytes": h3cPfilter2SumRuleMatchBytes,
       ...
       "h3cAclPacketIfName": h3cAclPacketIfName,
       "h3cAclPacketDirection": h3cAclPacketDirection,
       "h3cAclPacketBAGG": h3cAclPacketBAGG,
       "h3cAclPacketVlanID": h3cAclPacketVlanID,
       "h3cAclPacketSrcIP": h3cAclPacketSrcIP,
       "h3cAclPacketDstIP": h3cAclPacketDstIP,
       "h3cAclPacketProtocol": h3cAclPacketProtocol,
       "h3cAclPacketDscp": h3cAclPacketDscp,
       "h3cAclPacketFlowLabel": h3cAclPacketFlowLabel,
       "h3cAclPacketIcmpIgmpType": h3cAclPacketIcmpIgmpType,
       "h3cAclPacketIcmpIgmpCode": h3cAclPacketIcmpIgmpCode,
       "h3cAclPacketTcpFlags": h3cAclPacketTcpFlags,
       "h3cAclPacketSrcPort": h3cAclPacketSrcPort,
       "h3cAclPacketDstPort": h3cAclPacketDstPort,
       "h3cAclPacketSrcMacAddr": h3cAclPacketSrcMacAddr,
       "h3cAclPacketDstMacAddr": h3cAclPacketDstMacAddr,
       "h3cAclPacketMacTypeLen": h3cAclPacketMacTypeLen,
       "h3cAclPacketVlanPCP": h3cAclPacketVlanPCP,
       "h3cAclPacketfilterTrap": h3cAclPacketfilterTrap,
       "h3cPfilterTrapPrefix": h3cPfilterTrapPrefix,
       "h3cMACfilterTrap": h3cMACfilterTrap,
       "h3cAclRuleMatchCount": h3cAclRuleMatchCount,
       "h3cAclFirstIPv4PktCaptured": h3cAclFirstIPv4PktCaptured,
       "h3cAclFirstIPv6PktCaptured": h3cAclFirstIPv6PktCaptured,
       "h3cAclFirstEthernetPktCaptured": h3cAclFirstEthernetPktCaptured,
       "h3cAclTrapObjects": h3cAclTrapObjects,
       "h3cAclResourceTypeName": h3cAclResourceTypeName,
       "h3cAclResourceUsage": h3cAclResourceUsage,
       "h3cAclResourceUsedEntries": h3cAclResourceUsedEntries,
       "h3cAclResourceTotalEntries": h3cAclResourceTotalEntries,
       "h3cAclResourceChassisID": h3cAclResourceChassisID,
       "h3cAclResourceSlotID": h3cAclResourceSlotID,
       "h3cAclTrap": h3cAclTrap,
       "h3cAclTrapPrefix": h3cAclTrapPrefix,
       "h3cAclResourceTrap": h3cAclResourceTrap}
)
