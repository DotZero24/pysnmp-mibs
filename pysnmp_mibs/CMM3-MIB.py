...
whispModules, whispBox, whispCMM = mibBuilder.importSymbols("WHISP-GLOBAL-REG-MIB", "whispModules", "whispBox", "whispCMM")
...
mibBuilder.exportSymbols("CMM3-MIB", managementStatus=managementStatus, lan1SubnetMask=lan1SubnetMask, snmpTrap10=snmpTrap10, fullAccessStatus=fullAccessStatus, upTime=upTime, uplinkStatus=uplinkStatus, eventLog=eventLog, port8VlanConf=port8VlanConf, port2Config=port2Config, port8Uplink=port8Uplink, port1Config=port1Config, trackingMode=trackingMode, port8PwrReset=port8PwrReset, cmmUserEntry=cmmUserEntry, rxMulticastPkts=rxMulticastPkts, txMulticastPkts=txMulticastPkts, cmmUserTable=cmmUserTable, pkts1024to1522Octets=pkts1024to1522Octets, pkts128to255Octets=pkts128to255Octets, snmpTrap4=snmpTrap4, snmpCommunityString=snmpCommunityString, entryIndex=entryIndex, snmpAccessSubnet3=snmpAccessSubnet3, port2PwrReset=port2PwrReset, displayOnlyStatus=displayOnlyStatus, linkSpeed=linkSpeed, mirrorCapturePort=mirrorCapturePort, allowedIPAccess2=allowedIPAccess2, mirSrcTxEnable=mirSrcTxEnable, gpsRestartCount=gpsRestartCount, txOctets=txOctets, port1VlanConf=port1VlanConf, port2Management=port2Management, port7PwrReset=port7PwrReset, syncStatus=syncStatus, cmmControls=cmmControls, rxExcessSizeDisc=rxExcessSizeDisc, port6PowerCtr=port6PowerCtr, port8PowerCtr=port8PowerCtr, port4VlanConf=port4VlanConf, txDropPkts=txDropPkts, port4PwrReset=port4PwrReset, port2Uplink=port2Uplink, snmpAccessSubnet5=snmpAccessSubnet5, cmmSwitchMirrorSrcPortsEntry=cmmSwitchMirrorSrcPortsEntry, accessLevel=accessLevel, duplexStatus=duplexStatus, gpsSatellitesTracked=gpsSatellitesTracked, port6Config=port6Config, port3Description=port3Description, snmpTrap8=snmpTrap8, rxUndersizePkts=rxUndersizePkts, port7Config=port7Config, longitude=longitude, snmpTrap5=snmpTrap5, mirSrcRxEnable=mirSrcRxEnable, portIndex=portIndex, pkts65to127Octets=pkts65to127Octets, displayOnlyAccess=displayOnlyAccess, txCollisions=txCollisions, snmpTrap6=snmpTrap6, systemTime=systemTime, allowedIPAccess3=allowedIPAccess3, cmmStatus=cmmStatus, txUnicastPkts=txUnicastPkts, port5Config=port5Config, rxUnicastPkts=rxUnicastPkts, powerStatus=powerStatus, cmmSwitchGroup=cmmSwitchGroup, port1PwrReset=port1PwrReset, cmmSwitchTable=cmmSwitchTable, cmmConfigGroup=cmmConfigGroup, port7Description=port7Description, txBroadcastPkts=txBroadcastPkts, rxJabbers=rxJabbers, port5PowerCtr=port5PowerCtr, cmmUserTableGroup=cmmUserTableGroup, reboot=reboot, rxOctets=rxOctets, webAutoUpdate=webAutoUpdate, port3Uplink=port3Uplink, port4Description=port4Description, port6Management=port6Management, ntpLog=ntpLog, PYSNMP_MODULE_ID=cmmIIIMibModule, rxDropPkts=rxDropPkts, portNumber=portNumber, txExcessiveCollision=txExcessiveCollision, port5VlanConf=port5VlanConf, port4Management=port4Management, gpsTimingPulse=gpsTimingPulse, port5Description=port5Description, rxBroadcastPkts=rxBroadcastPkts, snmpAccessSubnet9=snmpAccessSubnet9, gpsSatellitesVisible=gpsSatellitesVisible, txLateCollision=txLateCollision, port5Management=port5Management, snmpTrap3=snmpTrap3, cmmSwitchMirrorSrcPortsTable=cmmSwitchMirrorSrcPortsTable, verifyGPSChecksum=verifyGPSChecksum, port6PwrReset=port6PwrReset, port2PowerCtr=port2PowerCtr, port5Uplink=port5Uplink, latitude=latitude, snmpReadOnly=snmpReadOnly, cmmSwitchEntry=cmmSwitchEntry, gpsReInitCount=gpsReInitCount, port3PowerCtr=port3PowerCtr, fullAccess=fullAccess, snmpAccessSubnet8=snmpAccessSubnet8, lan1Ip=lan1Ip, port1Uplink=port1Uplink, port7Uplink=port7Uplink, port3VlanConf=port3VlanConf, pldVersion=pldVersion, port4Config=port4Config, cmmGroups=cmmGroups, port6Uplink=port6Uplink, snmpTrap2=snmpTrap2, gpsInvalidMsg=gpsInvalidMsg, deviceType=deviceType, cmmStatusGroup=cmmStatusGroup, port6VlanConf=port6VlanConf, snmpTrap7=snmpTrap7, port3Management=port3Management, ipAccessFilterEnable=ipAccessFilterEnable, height=height, txSingleCollision=txSingleCollision, snmpAccessSubnet4=snmpAccessSubnet4, snmpTrap9=snmpTrap9, rxSAChanges=rxSAChanges, gpsTime=gpsTime, pkts512to1023Octets=pkts512to1023Octets, port7VlanConf=port7VlanConf, clearEventLog=clearEventLog, port8Management=port8Management, siteInfoViewable=siteInfoViewable, cmmGPSGroup=cmmGPSGroup, txFrameInDisc=txFrameInDisc, port8Description=port8Description, cmmPortTable=cmmPortTable, snmpTrap1=snmpTrap1, port5PwrReset=port5PwrReset, cmm3SnmpGPSSyncTrapEnable=cmm3SnmpGPSSyncTrapEnable, port1Management=port1Management, portMirrorEnable=portMirrorEnable, txPausePkts=txPausePkts, snmpAccessSubnet=snmpAccessSubnet, txMultipleCollision=txMultipleCollision, port2Description=port2Description, port3Config=port3Config, userLoginName=userLoginName, cmmIIIMibModule=cmmIIIMibModule, rxFCSErrors=rxFCSErrors, rxSymbolErrors=rxSymbolErrors, port4Uplink=port4Uplink, vlanTagId=vlanTagId, vlanTagEnable=vlanTagEnable, port2VlanConf=port2VlanConf, port7Management=port7Management, gpsTrackingMode=gpsTrackingMode, cmmConfig=cmmConfig, port3PwrReset=port3PwrReset, port1PowerCtr=port1PowerCtr, gpsAntennaConnection=gpsAntennaConnection, gpsDate=gpsDate, userPswd=userPswd, port7PowerCtr=port7PowerCtr, pkts256to511Octets=pkts256to511Octets, sessionTimeout=sessionTimeout, gpsReceiverInfo=gpsReceiverInfo, macAddress=macAddress, gpsLongitude=gpsLongitude, port4PowerCtr=port4PowerCtr, gpsLatitude=gpsLatitude, allowedIPAccess1=allowedIPAccess1, linkStatus=linkStatus, rxAlignmentErrors=rxAlignmentErrors, snmpAccessSubnet7=snmpAccessSubnet7, port6Description=port6Description, satellitesVisible=satellitesVisible, cmmPortEntry=cmmPortEntry, rxGoodOctets=rxGoodOctets, snmpAccessSubnet2=snmpAccessSubnet2, rebootIfRequired=rebootIfRequired, mirSrcPortNumber=mirSrcPortNumber, port8Config=port8Config, rxPausePkts=rxPausePkts, snmpAccessSubnet10=snmpAccessSubnet10, softwareVersion=softwareVersion, snmpAccessSubnet6=snmpAccessSubnet6, cmmGps=cmmGps, satellitesTracked=satellitesTracked, port1Description=port1Description, cmmSwitch=cmmSwitch, cmmEventLog=cmmEventLog, rxFragments=rxFragments, txDeferredTransmit=txDeferredTransmit, rxOversizePkts=rxOversizePkts, defaultGateway=defaultGateway, pkts64Octets=pkts64Octets, gpsHeight=gpsHeight)
