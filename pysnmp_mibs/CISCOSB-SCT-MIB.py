...
rlSctCpuRateEnabled=_RlSctCpuRateEnabled_Object((1,3,6,1,4,1,9,6,1,101,203,1),_RlSctCpuRateEnabled_Type())
...
rlSctCpuRate=_RlSctCpuRate_Object((1,3,6,1,4,1,9,6,1,101,203,2),_RlSctCpuRate_Type())
rlSctCpuRate.setMaxAccess('read-only')
if mibBuilder.loadTexts:rlSctCpuRate.setStatus(_A)
mibBuilder.exportSymbols('CISCOSB-SCT-MIB',**{'rlSctMib':rlSctMib,'rlSctCpuRateEnabled':rlSctCpuRateEnabled,'rlSctCpuRate':rlSctCpuRate})