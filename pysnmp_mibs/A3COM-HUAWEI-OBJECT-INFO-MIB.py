...
_D='OctetString'
_C='not-accessible'
_B='A3COM-HUAWEI-OBJECT-INFO-MIB'
_A='current'
...
h3cObjectInformation=_H3cObjectInformation_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,55,1))
_H3cObjectInfoTable_Object=MibTable
h3cObjectInfoTable=_H3cObjectInfoTable_Object((1,3,6,1,4,1,43,45,1,10,2,55,1,1))
if mibBuilder.loadTexts:h3cObjectInfoTable.setStatus(_A)
_H3cObjectInfoEntry_Object=MibTableRow
h3cObjectInfoEntry=_H3cObjectInfoEntry_Object((1,3,6,1,4,1,43,45,1,10,2,55,1,1,1))
...
h3cObjectInfoOID=_H3cObjectInfoOID_Object((1,3,6,1,4,1,43,45,1,10,2,55,1,1,1,1),_H3cObjectInfoOID_Type())
...
h3cObjectInfoType=_H3cObjectInfoType_Object((1,3,6,1,4,1,43,45,1,10,2,55,1,1,1,2),_H3cObjectInfoType_Type())
...
h3cObjectInfoTypeExtension=_H3cObjectInfoTypeExtension_Object((1,3,6,1,4,1,43,45,1,10,2,55,1,1,1,3),_H3cObjectInfoTypeExtension_Type())
...
h3cObjectInfoValue=_H3cObjectInfoValue_Object((1,3,6,1,4,1,43,45,1,10,2,55,1,1,1,4),_H3cObjectInfoValue_Type())
...
h3cObjectInfoMIBConformance=_H3cObjectInfoMIBConformance_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,55,2))
_H3cObjectInfoMIBCompliances_ObjectIdentity=ObjectIdentity
h3cObjectInfoMIBCompliances=_H3cObjectInfoMIBCompliances_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,55,2,1))
_H3cObjectInfoMIBGroups_ObjectIdentity=ObjectIdentity
h3cObjectInfoMIBGroups=_H3cObjectInfoMIBGroups_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,55,2,2))
h3cObjectInfoTableGroup=ObjectGroup((1,3,6,1,4,1,43,45,1,10,2,55,2,2,1))
h3cObjectInfoTableGroup.setObjects((_B,_I))
if mibBuilder.loadTexts:h3cObjectInfoTableGroup.setStatus(_A)
h3cObjectInfoMIBCompliance=ModuleCompliance((1,3,6,1,4,1,43,45,1,10,2,55,2,1,1))
