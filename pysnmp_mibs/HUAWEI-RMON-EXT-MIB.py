# SNMP MIB module (HUAWEI-RMON-EXT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/HUAWEI-RMON-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:20:16 2025
...
prialarmEntry.setIndexNames(
    (0, "HUAWEI-RMON-EXT-MIB", "prialarmIndex"),
)
if mibBuilder.loadTexts:
...
hwrmonEnableTableEntry = _HwrmonEnableTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 1, 3, 4, 5, 1)
)
hwrmonEnableTableEntry.setIndexNames(
    (0, "HUAWEI-RMON-EXT-MIB", "hwrmonEnableIfIndex"),
)
if mibBuilder.loadTexts:
...
pririsingAlarm.setObjects(
      *(("HUAWEI-RMON-EXT-MIB", "prialarmIndex"),
        ("HUAWEI-RMON-EXT-MIB", "prialarmSympol"),
        ("HUAWEI-RMON-EXT-MIB", "prialarmSampleType"),
        ("HUAWEI-RMON-EXT-MIB", "prialarmValue"),
        ("HUAWEI-RMON-EXT-MIB", "prialarmRisingThreshold"))
)
if mibBuilder.loadTexts:
...
prifallingAlarm.setObjects(
      *(("HUAWEI-RMON-EXT-MIB", "prialarmIndex"),
        ...
        ("HUAWEI-RMON-EXT-MIB", "prialarmSampleType"),
        ("HUAWEI-RMON-EXT-MIB", "prialarmValue"),
        ("HUAWEI-RMON-EXT-MIB", "prialarmFallingThreshold"))
)
if mibBuilder.loadTexts:
