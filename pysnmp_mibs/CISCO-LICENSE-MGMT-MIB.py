...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LICENSE-MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:25 2025
...
_ClmgmtLicenseActionEntPhysicalIndex_Type.__name__ = "PhysicalIndexOrZero"
...
_ClmgmtLicenseActionTransferProtocol_Type.__name__ = "ClmgmtLicenseTransferProtocol"
...
_ClmgmtLicenseServerAddressType_Type.__name__ = "InetAddressType"
...
class _ClmgmtLicenseServerAddress_Type(InetAddress):
    """Custom type clmgmtLicenseServerAddress based on InetAddress"""
    defaultValue = OctetString("")


_ClmgmtLicenseServerAddress_Type.__name__ = "InetAddress"
...
_ClmgmtLicenseStore_Type.__name__ = "Unsigned32"
...
_ClmgmtLicenseActionLicenseIndex_Type.__name__ = "ClmgmtLicenseIndexOrZero"
...
_ClmgmtLicenseStopOnFailure_Type.__name__ = "TruthValue"
...
_ClmgmtLicenseActionStorageType_Type.__name__ = "StorageType"
...
_ClmgmtLicenseAcceptEULA_Type.__name__ = "TruthValue"
...
_ClmgmtDevCredEntPhysicalIndex_Type.__name__ = "PhysicalIndexOrZero"
...
_ClmgmtDevCredTransferProtocol_Type.__name__ = "ClmgmtLicenseTransferProtocol"
...
_ClmgmtDevCredServerAddressType_Type.__name__ = "InetAddressType"
...
class _ClmgmtDevCredServerAddress_Type(InetAddress):
    """Custom type clmgmtDevCredServerAddress based on InetAddress"""
    defaultValue = OctetString("")


_ClmgmtDevCredServerAddress_Type.__name__ = "InetAddress"
...
_ClmgmtDevCredStorageType_Type.__name__ = "StorageType"
...
_ClmgmtLicenseUsageNotifEnable_Type.__name__ = "TruthValue"
...
_ClmgmtLicenseDeploymentNotifEnable_Type.__name__ = "TruthValue"
...
_ClmgmtLicenseErrorNotifEnable_Type.__name__ = "TruthValue"
...
ciscoLicenseMgmtCompliance.setObjects(
      *(("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseDeploymentGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseDeviceInformationGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseInformationGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicensableFeatureInformationGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseDevCredGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseNotificationEnableGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseUsageNotifGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseDeploymentNotifGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseErrorNotifGroup"),
...
ciscoLicenseMgmtComplianceRev1.setObjects(
      *(("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseDeploymentGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseDeviceInformationGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseInformationGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicensableFeatureInformationGroup"),
        ...
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseErrorNotifGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseStoreInformationGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseSubscriptionGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseSubscriptionUsageNotifGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseRTUGroup"),
        ("CISCO-LICENSE-MGMT-MIB", "clmgmtLicenseRTUUsageNotifGroup"))
)
if mibBuilder.loadTexts:
