...
PhysicalIndexOrZero, entPhysicalIndex = mibBuilder.importSymbols("ENTITY-MIB", "PhysicalIndexOrZero", "entPhysicalIndex")
...
mibBuilder.exportSymbols("CISCO-LICENSE-MGMT-MIB", clmgmtLicenseUsageCountAboutToExceed=clmgmtLicenseUsageCountAboutToExceed, clmgmtLicenseActionTransferProtocol=clmgmtLicenseActionTransferProtocol, clmgmtLicenseStopOnFailure=clmgmtLicenseStopOnFailure, ciscoLicenseMgmtMIBNotifs=ciscoLicenseMgmtMIBNotifs, clmgmtLicenseDeviceInfoTable=clmgmtLicenseDeviceInfoTable, clmgmtLicenseEvalRTUTransition=clmgmtLicenseEvalRTUTransition, clmgmtLicenseExpired=clmgmtLicenseExpired, clmgmtLicenseDevCredGroup=clmgmtLicenseDevCredGroup, clmgmtDevCredServerUsername=clmgmtDevCredServerUsername, clmgmtLicenseInfoTable=clmgmtLicenseInfoTable, ciscoLicenseMgmtCompliances=ciscoLicenseMgmtCompliances, clmgmtLicenseNotifObjects=clmgmtLicenseNotifObjects, clmgmtLicenseActionResultTable=clmgmtLicenseActionResultTable, clmgmtFeatureIndex=clmgmtFeatureIndex, clmgmtLicenseDeviceInfoEntry=clmgmtLicenseDeviceInfoEntry, clmgmtLicenseDeploymentNotifEnable=clmgmtLicenseDeploymentNotifEnable, clmgmtFeatureStartDate=clmgmtFeatureStartDate, clmgmtLicenseFile=clmgmtLicenseFile, PYSNMP_MODULE_ID=ciscoLicenseMgmtMIB, clmgmtLicensableFeatureEntry=clmgmtLicensableFeatureEntry, ClmgmtLicenseIndex=ClmgmtLicenseIndex, clmgmtLicenseInfoEntry=clmgmtLicenseInfoEntry, clmgmtLicenseSubscriptionUsageNotifGroup=clmgmtLicenseSubscriptionUsageNotifGroup, clmgmtLicenseNumber=clmgmtLicenseNumber, clmgmtLicenseFeatureName=clmgmtLicenseFeatureName, clmgmtLicenseEULAStatus=clmgmtLicenseEULAStatus, clmgmtLicenseEULAFile=clmgmtLicenseEULAFile, clmgmtLicenseStoreInfoTable=clmgmtLicenseStoreInfoTable, clmgmtLicenseBackupFile=clmgmtLicenseBackupFile, clmgmtLicenseStoreTotalSize=clmgmtLicenseStoreTotalSize, clmgmtLicenseSubscriptionGroup=clmgmtLicenseSubscriptionGroup, ClmgmtLicenseActionFailCause=ClmgmtLicenseActionFailCause, ciscoLicenseMgmtMIBObjects=ciscoLicenseMgmtMIBObjects, clmgmtLicenseIndex=clmgmtLicenseIndex, clmgmtLicenseUsageNotifEnable=clmgmtLicenseUsageNotifEnable, clmgmtFeaturePeriodUsed=clmgmtFeaturePeriodUsed, ClmgmtLicenseActionState=ClmgmtLicenseActionState, clmgmtLicenseServerPassword=clmgmtLicenseServerPassword, clmgmtDevCredExportActionEntry=clmgmtDevCredExportActionEntry, clmgmtLicenseActionEntPhysicalIndex=clmgmtLicenseActionEntPhysicalIndex, clmgmtDevCredServerPassword=clmgmtDevCredServerPassword, clmgmtLicenseValidityPeriod=clmgmtLicenseValidityPeriod, clmgmtLicenseNotEnforced=clmgmtLicenseNotEnforced, clmgmtLicenseComments=clmgmtLicenseComments, clmgmtDevCredExportActionTable=clmgmtDevCredExportActionTable, clmgmtLicenseActionStorageType=clmgmtLicenseActionStorageType, clmgmtLicenseValidityPeriodRemaining=clmgmtLicenseValidityPeriodRemaining, clmgmtLicenseCleared=clmgmtLicenseCleared, clmgmtLicenseExpiryWarning=clmgmtLicenseExpiryWarning, clmgmtLicenseSubscriptionExtExpiryWarning=clmgmtLicenseSubscriptionExtExpiryWarning, clmgmtLicensePeriodUsed=clmgmtLicensePeriodUsed, clmgmtLicenseUsageNotifGroup=clmgmtLicenseUsageNotifGroup, clmgmtFeatureValidityPeriodRemaining=clmgmtFeatureValidityPeriodRemaining, clmgmtLicenseUsageCountRemaining=clmgmtLicenseUsageCountRemaining, clmgmtLicenseDeviceInformationGroup=clmgmtLicenseDeviceInformationGroup, clmgmtLicenseRehostTicketFile=clmgmtLicenseRehostTicketFile, clmgmtLicenseStoreIndex=clmgmtLicenseStoreIndex, clmgmtLicenseStoreName=clmgmtLicenseStoreName, clmgmtDevCredServerAddressType=clmgmtDevCredServerAddressType, clmgmtLicenseRTUGroup=clmgmtLicenseRTUGroup, clmgmtDevCredExportFile=clmgmtDevCredExportFile, clmgmtLicenseUsageCountExceeded=clmgmtLicenseUsageCountExceeded, clmgmtLicenseInformationGroup=clmgmtLicenseInformationGroup, clmgmtLicenseActionLicenseIndex=clmgmtLicenseActionLicenseIndex, clmgmtLicenseIndivActionState=clmgmtLicenseIndivActionState, clmgmtLicenseActionState=clmgmtLicenseActionState, clmgmtNextFreeDevCredExportActionIndex=clmgmtNextFreeDevCredExportActionIndex, clmgmtDevCredCommand=clmgmtDevCredCommand, clmgmtLicenseStore=clmgmtLicenseStore, clmgmtLicenseAcceptEULA=clmgmtLicenseAcceptEULA, clmgmtDefaultLicenseStore=clmgmtDefaultLicenseStore, clmgmtLicenseMaxUsageCount=clmgmtLicenseMaxUsageCount, clmgmtLicenseActionEntry=clmgmtLicenseActionEntry, clmgmtLicenseRevoked=clmgmtLicenseRevoked, clmgmtLicenseActionRowStatus=clmgmtLicenseActionRowStatus, ciscoLicenseMgmtMIB=ciscoLicenseMgmtMIB, clmgmtLicenseStartDate=clmgmtLicenseStartDate, clmgmtLicenseServerAddress=clmgmtLicenseServerAddress, clmgmtLicenseType=clmgmtLicenseType, clmgmtLicensableFeatureInformationGroup=clmgmtLicensableFeatureInformationGroup, clmgmtLicenseAction=clmgmtLicenseAction, ClmgmtLicenseTransferProtocol=ClmgmtLicenseTransferProtocol, clmgmtLicenseActionResultEntry=clmgmtLicenseActionResultEntry, ciscoLicenseMgmtComplianceRev1=ciscoLicenseMgmtComplianceRev1, clmgmtFeatureWhatIsCounted=clmgmtFeatureWhatIsCounted, clmgmtLicensePermissionTicketFile=clmgmtLicensePermissionTicketFile, clmgmtDevCredExportActionIndex=clmgmtDevCredExportActionIndex, clmgmtLicenseActionFailCause=clmgmtLicenseActionFailCause, clmgmtLicenseStoreUsed=clmgmtLicenseStoreUsed, clmgmtLicenseFeatureVersion=clmgmtLicenseFeatureVersion, clmgmtLicensableFeatureTable=clmgmtLicensableFeatureTable, clmgmtLicenseEULAAccepted=clmgmtLicenseEULAAccepted, clmgmtLicenseCounted=clmgmtLicenseCounted, clmgmtLicenseStoreInfoEntry=clmgmtLicenseStoreInfoEntry, clmgmtLicenseStatus=clmgmtLicenseStatus, clmgmtLicenseDeviceInformation=clmgmtLicenseDeviceInformation, clmgmtDevCredServerAddress=clmgmtDevCredServerAddress, clmgmtLicenseStoreSizeRemaining=clmgmtLicenseStoreSizeRemaining, clmgmtDevCredEntPhysicalIndex=clmgmtDevCredEntPhysicalIndex, clmgmtLicenseConfiguration=clmgmtLicenseConfiguration, clmgmtLicenseServerAddressType=clmgmtLicenseServerAddressType, clmgmtLicenseServerUsername=clmgmtLicenseServerUsername, clmgmtFeatureName=clmgmtFeatureName, clmgmtLicenseActionIndex=clmgmtLicenseActionIndex, clmgmtLicenseStoreInformationGroup=clmgmtLicenseStoreInformationGroup, ciscoLicenseMgmtGroups=ciscoLicenseMgmtGroups, clmgmtLicenseInformation=clmgmtLicenseInformation, clmgmtLicenseSubscriptionExpired=clmgmtLicenseSubscriptionExpired, clmgmtLicenseIndivActionFailCause=clmgmtLicenseIndivActionFailCause, clmgmtLicenseErrorNotifEnable=clmgmtLicenseErrorNotifEnable, clmgmtLicenseDeploymentNotifGroup=clmgmtLicenseDeploymentNotifGroup, clmgmtFeatureVersion=clmgmtFeatureVersion, ciscoLicenseMgmtCompliance=ciscoLicenseMgmtCompliance, ciscoLicenseMgmtMIBConform=ciscoLicenseMgmtMIBConform, clmgmtLicenseJobQPosition=clmgmtLicenseJobQPosition, clmgmtLicenseNotificationEnableGroup=clmgmtLicenseNotificationEnableGroup, clmgmtLicenseExpiredPeriod=clmgmtLicenseExpiredPeriod, clmgmtLicenseErrorNotifGroup=clmgmtLicenseErrorNotifGroup, clmgmtLicenseActionTable=clmgmtLicenseActionTable, clmgmtLicenseDeploymentGroup=clmgmtLicenseDeploymentGroup, ClmgmtLicenseIndexOrZero=ClmgmtLicenseIndexOrZero, clmgmtDevCredCommandState=clmgmtDevCredCommandState, clmgmtFeatureEndDate=clmgmtFeatureEndDate, clmgmtDevCredStorageType=clmgmtDevCredStorageType, clmgmtDevCredRowStatus=clmgmtDevCredRowStatus, clmgmtNextFreeLicenseActionIndex=clmgmtNextFreeLicenseActionIndex, clmgmtLicenseInstalled=clmgmtLicenseInstalled, clmgmtDevCredCommandFailCause=clmgmtDevCredCommandFailCause, clmgmtLicenseEndDate=clmgmtLicenseEndDate, clmgmtLicenseSubscriptionExpiryWarning=clmgmtLicenseSubscriptionExpiryWarning, clmgmtDevCredTransferProtocol=clmgmtDevCredTransferProtocol, clmgmtLicenseEvalRTUTransitionWarning=clmgmtLicenseEvalRTUTransitionWarning, clmgmtLicenseRTUUsageNotifGroup=clmgmtLicenseRTUUsageNotifGroup)
