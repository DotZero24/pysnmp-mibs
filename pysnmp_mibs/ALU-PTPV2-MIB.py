...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:19:49 2025
...
TmnxHwIndexOrZero, TmnxPortAdminStatus, TmnxChassisIndex, tmnxChassisIndex, TmnxSETSRefSource = mibBuilder.importSymbols("TIMETRA-CHASSIS-MIB", "TmnxHwIndexOrZero", "TmnxPortAdminStatus", "TmnxChassisIndex", "tmnxChassisIndex", "TmnxSETSRefSource")
TItemDescription, TNamedItemOrEmpty, TmnxAdminState = mibBuilder.importSymbols("TIMETRA-TC-MIB", "TItemDescription", "TNamedItemOrEmpty", "TmnxAdminState")
...
mibBuilder.exportSymbols("ALU-PTPV2-MIB", aluPtpPortDSEntry=aluPtpPortDSEntry, aluPtpPeerBadDomainDisc=aluPtpPeerBadDomainDisc, aluPtpPeerClkRecAlgTable=aluPtpPeerClkRecAlgTable, aluPtpPortNumPeers=aluPtpPortNumPeers, aluPtpClockOperFreqSource=aluPtpClockOperFreqSource, aluPtpPeerDiscoveryChange=aluPtpPeerDiscoveryChange, aluPtpConformance=aluPtpConformance, aluPtpPeerTotalShortIntvlMinutes=aluPtpPeerTotalShortIntvlMinutes, aluPtpPeerMaxShortIntvlMinutes=aluPtpPeerMaxShortIntvlMinutes, aluPtpPeerIntvlUpdateTime=aluPtpPeerIntvlUpdateTime, aluPtpNotifyRowPointer=aluPtpNotifyRowPointer, aluPtpNotifyRowDescription=aluPtpNotifyRowDescription, aluPtpClockTwoStepFlag=aluPtpClockTwoStepFlag, aluPtpPortClockIndex=aluPtpPortClockIndex, aluPtpPeerRecClkStatsTable=aluPtpPeerRecClkStatsTable, aluPtpPeerUcGrantDelayRespTx=aluPtpPeerUcGrantDelayRespTx, aluPtpFreqRecPacketLossCnt=aluPtpFreqRecPacketLossCnt, Alu1588ActivePtpPortIndex=Alu1588ActivePtpPortIndex, aluPtpPeerIntvlValidData=aluPtpPeerIntvlValidData, aluPtpClockRecoveryState=aluPtpClockRecoveryState, aluPtpClockParentStats=aluPtpClockParentStats, aluPtpClockId=aluPtpClockId, aluPtpComp7705=aluPtpComp7705, aluPtpClockTimePropertyDSEntry=aluPtpClockTimePropertyDSEntry, aluPtpClockGMPriority2=aluPtpClockGMPriority2, Alu1588PtpMasterIndex=Alu1588PtpMasterIndex, aluPtpPeerFollowUpMsgTx=aluPtpPeerFollowUpMsgTx, aluPtpPeerCurrent1MinPhaseErrorStdDevNs=aluPtpPeerCurrent1MinPhaseErrorStdDevNs, aluPtpPeerPacketStatsTable=aluPtpPeerPacketStatsTable, aluPtpPeerUcReqAnnoTx=aluPtpPeerUcReqAnnoTx, aluPtpPortV4v0Group=aluPtpPortV4v0Group, aluPtpPeerUcCancelAckDelayRespTx=aluPtpPeerUcCancelAckDelayRespTx, aluPtpClockSlaveOnly=aluPtpClockSlaveOnly, aluPtpClockParentId=aluPtpClockParentId, aluPtpGroups=aluPtpGroups, aluPtpPeerUcNegRejectsDelayResp=aluPtpPeerUcNegRejectsDelayResp, aluPtpClockForwardWeight=aluPtpClockForwardWeight, aluPtpClockStepsRemoved=aluPtpClockStepsRemoved, aluPtpPortIndex=aluPtpPortIndex, aluPtpPortDSLogSyncInterval=aluPtpPortDSLogSyncInterval, aluPtpPeerUcReqDelayRespTxTimeout=aluPtpPeerUcReqDelayRespTxTimeout, aluPtpComp7705V7v0=aluPtpComp7705V7v0, aluPtpPeerUcReqDelayRespRx=aluPtpPeerUcReqDelayRespRx, aluPtpPeerUcCancelAnnoTx=aluPtpPeerUcCancelAnnoTx, aluPtpPeerTotalUdpGeneralMsgTx=aluPtpPeerTotalUdpGeneralMsgTx, aluPtpPeerDiscovered=aluPtpPeerDiscovered, aluPtpPeerUcReqSyncRxTimeout=aluPtpPeerUcReqSyncRxTimeout, aluPtpPeerIntvlPhaseErrorStdDevNs=aluPtpPeerIntvlPhaseErrorStdDevNs, aluPtpClockNumberPorts=aluPtpClockNumberPorts, aluPtpLocalPriorityGroup=aluPtpLocalPriorityGroup, aluPtpFreqRecLossResetCnt=aluPtpFreqRecLossResetCnt, aluPtpClockTimeRefPriority=aluPtpClockTimeRefPriority, aluPtpClockNotifyIndex=aluPtpClockNotifyIndex, aluPtpClockDefaultDSEntry=aluPtpClockDefaultDSEntry, aluPtpClockParentDSEntry=aluPtpClockParentDSEntry, aluPtpPeerIntvlClockIndex=aluPtpPeerIntvlClockIndex, aluPtpPeerUcGrantDenySyncTx=aluPtpPeerUcGrantDenySyncTx, aluPtpPortDSDelayMechanism=aluPtpPortDSDelayMechanism, aluPtpPeerBadVersionDisc=aluPtpPeerBadVersionDisc, aluPtpClockLocalPriority=aluPtpClockLocalPriority, aluPtpClockMaxNumber=aluPtpClockMaxNumber, aluPtpPeerUcReqSyncTxTimeout=aluPtpPeerUcReqSyncTxTimeout, aluPtpPeerUcGrantSyncRejected=aluPtpPeerUcGrantSyncRejected, Alu1588PtpFreqSource=Alu1588PtpFreqSource, aluPtpPeerPacketStatsEntry=aluPtpPeerPacketStatsEntry, aluPtpPeerCurrent24HourFreqOffsetStdDevPpb=aluPtpPeerCurrent24HourFreqOffsetStdDevPpb, aluPtpPeerIntvlIndex=aluPtpPeerIntvlIndex, Alu1588PtpLogInterval=Alu1588PtpLogInterval, Alu1588ActivePtpMasterIndex=Alu1588ActivePtpMasterIndex, aluPtpPeerUcNegRejectsSync=aluPtpPeerUcNegRejectsSync, aluPtpPeerCurrent1MinFreqOffsetStdDevPpb=aluPtpPeerCurrent1MinFreqOffsetStdDevPpb, aluPtpClockVariance=aluPtpClockVariance, aluPtpClockClass=aluPtpClockClass, aluPtpClockAccuracy=aluPtpClockAccuracy, aluPtpClockIndex=aluPtpClockIndex, aluPtpPortUcNegotiate=aluPtpPortUcNegotiate, aluPtpClockDynamicChange=aluPtpClockDynamicChange, aluPtpFreqRecExcessFreqErrCnt=aluPtpFreqRecExcessFreqErrCnt, aluPtpPortNotifyIndex=aluPtpPortNotifyIndex, aluPtpPortTable=aluPtpPortTable, aluPtpClockType=aluPtpClockType, aluPtpPeerIntvlPortIndex=aluPtpPeerIntvlPortIndex, aluPtpPeerUcReqAnnoTxTimeout=aluPtpPeerUcReqAnnoTxTimeout, aluPtpPeerUcGrantDelayRespRejected=aluPtpPeerUcGrantDelayRespRejected, aluPtpPeerUcReqDelayRespRxTimeout=aluPtpPeerUcReqDelayRespRxTimeout, aluPtpPeerTotalMinutesIn24Hour=aluPtpPeerTotalMinutesIn24Hour, aluPtpFreqRecAcquiringCount=aluPtpFreqRecAcquiringCount, aluPtpPeerUcCancelAnnoRx=aluPtpPeerUcCancelAnnoRx, aluPtpClockGMAccuracy=aluPtpClockGMAccuracy, aluPtpPeerUcCancelAckAnnoRx=aluPtpPeerUcCancelAckAnnoRx, aluPtpPeerUcGrantDenyDelayRespTx=aluPtpPeerUcGrantDenyDelayRespTx, aluPtpPeerClockIndex=aluPtpPeerClockIndex, aluPtpPeerCurrent1MinValidData=aluPtpPeerCurrent1MinValidData, aluPtpClockParentPortNum=aluPtpClockParentPortNum, aluPtpClockUseNodeTime=aluPtpClockUseNodeTime, aluPtpClockEntry=aluPtpClockEntry, aluPtpClockLeap59=aluPtpClockLeap59, aluPtpClockV6v1Group=aluPtpClockV6v1Group, aluPtpPeerRecClkStatsShortIntvlTable=aluPtpPeerRecClkStatsShortIntvlTable, aluPtpFreqRecPdvStepCnt=aluPtpFreqRecPdvStepCnt, aluPtpClockRecovClkChange=aluPtpClockRecovClkChange, aluPtpPeerDelayReqMsgRx=aluPtpPeerDelayReqMsgRx, aluPtpClockV4v0Group=aluPtpClockV4v0Group, aluPtpV8v0Groups=aluPtpV8v0Groups, aluPtpClockCurUtcOffset=aluPtpClockCurUtcOffset, aluPtpPeerUcReqAnnoRx=aluPtpPeerUcReqAnnoRx, aluPtpPortDSTable=aluPtpPortDSTable, Alu1588PtpClockId=Alu1588PtpClockId, aluPtpClockTxWhileUncertain=aluPtpClockTxWhileUncertain, aluPtpClockGMClockId=aluPtpClockGMClockId, aluPtpPeerIpAddrType=aluPtpPeerIpAddrType, Alu1588PtpClockRecoveryState=Alu1588PtpClockRecoveryState, aluPtpPeerUcReqDelayRespTx=aluPtpPeerUcReqDelayRespTx, aluPtpPeerUcGrantDenyAnnoTx=aluPtpPeerUcGrantDenyAnnoTx, aluPtpNotificationV4v0Group=aluPtpNotificationV4v0Group, aluPtpClockTimeSource=aluPtpClockTimeSource, aluPtpV9v0Groups=aluPtpV9v0Groups, aluPtpFreqRecTripCnt=aluPtpFreqRecTripCnt, Alu1588PtpPortIndex=Alu1588PtpPortIndex, aluPtpPeer=aluPtpPeer, aluPtpClock=aluPtpClock, aluPtpPortDSAnnoRxTimeout=aluPtpPortDSAnnoRxTimeout, aluPtpMIBConformance=aluPtpMIBConformance, aluPtpPeerDelayReqMsgTx=aluPtpPeerDelayReqMsgTx, aluPtpMasterChange=aluPtpMasterChange, aluPtpClockFreqTraceable=aluPtpClockFreqTraceable, aluPtpClockAdminFreqSource=aluPtpClockAdminFreqSource, aluPtpPeerClkRecAlgEntry=aluPtpPeerClkRecAlgEntry, aluPtpPeerLastChanged=aluPtpPeerLastChanged, aluPtpNotificationObjects=aluPtpNotificationObjects, aluPtpPortAdminState=aluPtpPortAdminState, aluPtpPeerSyncMsgRx=aluPtpPeerSyncMsgRx, Alu1588PtpSyncCertaintyState=Alu1588PtpSyncCertaintyState, aluPtpPortDSPortState=aluPtpPortDSPortState, aluPtpPeerStepRemovedGreaterThan255Disc=aluPtpPeerStepRemovedGreaterThan255Disc, aluPtpPeerSignalingMsgTx=aluPtpPeerSignalingMsgTx, aluPtpV2Module=aluPtpV2Module, aluPtpClockDynamicPeers=aluPtpClockDynamicPeers, AluPtpPriority=AluPtpPriority, aluPtpPeerTotalUdpGeneralMsgRx=aluPtpPeerTotalUdpGeneralMsgRx, aluPtpPeerUcGrantDelayRespRx=aluPtpPeerUcGrantDelayRespRx, aluPtpPeerSignalingMsgRx=aluPtpPeerSignalingMsgRx, aluPtpPeerDelayRespMsgTx=aluPtpPeerDelayRespMsgTx, aluPtpUcMasterEntry=aluPtpUcMasterEntry, aluPtpPort=aluPtpPort, aluPtpPeerFollowUpMsgRx=aluPtpPeerFollowUpMsgRx, Alu1588PtpClockType=Alu1588PtpClockType, aluPtpPeerOutOfOrderSyncPktRx=aluPtpPeerOutOfOrderSyncPktRx, Alu1588PtpPortState=Alu1588PtpPortState, aluPtpClockGMVariance=aluPtpClockGMVariance, aluPtpPortDSMasterOnly=aluPtpPortDSMasterOnly, aluPtpPeerUcGrantAnnoRx=aluPtpPeerUcGrantAnnoRx, aluPtpClockParentDSTable=aluPtpClockParentDSTable, aluPtpPeerTotalUdpEventMsgRx=aluPtpPeerTotalUdpEventMsgRx, Alu1588PtpProfile=Alu1588PtpProfile, aluPtpPeerPacketLastUpdateTime=aluPtpPeerPacketLastUpdateTime, aluPtpPeerUcReqAnnoRxTimeout=aluPtpPeerUcReqAnnoRxTimeout, aluPtpClockTimeTraceable=aluPtpClockTimeTraceable, aluPtpLocalPtpPeerIndex=aluPtpLocalPtpPeerIndex, aluPtpPeerUcCancelAckSyncRx=aluPtpPeerUcCancelAckSyncRx, aluPtpClockPriority1=aluPtpClockPriority1, aluPtpParentSyncCertaintyState=aluPtpParentSyncCertaintyState, aluPtpClockLeap61=aluPtpClockLeap61, aluPtpPortDSVersionNumber=aluPtpPortDSVersionNumber, aluPtpPeerIntvlPhaseErrorMeanNs=aluPtpPeerIntvlPhaseErrorMeanNs, aluPtpFreqRecPhaseTrackCount=aluPtpFreqRecPhaseTrackCount, aluPtpPortEntry=aluPtpPortEntry, aluPtpComp7705V9v0=aluPtpComp7705V9v0, aluPtpPeerUcCancelAckDelayRespRx=aluPtpPeerUcCancelAckDelayRespRx, aluPtpClockCurrentDSEntry=aluPtpClockCurrentDSEntry, PYSNMP_MODULE_ID=aluPtpV2Module, aluPtpClockAdminState=aluPtpClockAdminState, aluPtpPeerSyncMsgTx=aluPtpPeerSyncMsgTx, aluPtpClockPriority2=aluPtpClockPriority2, aluPtpObjs=aluPtpObjs, aluPtpComp7705V4v0=aluPtpComp7705V4v0, aluPtpPeerSyncCertainty=aluPtpPeerSyncCertainty, aluPtpPeerRecClkStatsEntry=aluPtpPeerRecClkStatsEntry, aluPtpPeerIntvlPhaseErrorMeanPpb=aluPtpPeerIntvlPhaseErrorMeanPpb, aluPtpClockGMPriority1=aluPtpClockGMPriority1, aluPtpClockV5v0Group=aluPtpClockV5v0Group, aluPtpClockNoMaster=aluPtpClockNoMaster, aluPtpSyncCertNotifObjsGroup=aluPtpSyncCertNotifObjsGroup, aluPtpClockCurrentDSTable=aluPtpClockCurrentDSTable, aluPtpUcMasterTable=aluPtpUcMasterTable, aluPtpFreqRecGapResetCnt=aluPtpFreqRecGapResetCnt, aluPtpPeerCurrent1MinFreqOffsetMeanPpb=aluPtpPeerCurrent1MinFreqOffsetMeanPpb, aluPtpPeerUcGrantSyncTx=aluPtpPeerUcGrantSyncTx, aluPtpPeerCurrent1MinPhaseErrorMeanPpb=aluPtpPeerCurrent1MinPhaseErrorMeanPpb, aluPtpPeerIpAddr=aluPtpPeerIpAddr, aluPtpPeerUcReqSyncRx=aluPtpPeerUcReqSyncRx, aluPtpPeerUcCancelDelayRespTx=aluPtpPeerUcCancelDelayRespTx, aluPtpPeerAlternateMasterDisc=aluPtpPeerAlternateMasterDisc, aluPtpClockSyncCertaintyState=aluPtpClockSyncCertaintyState, aluPtpPeerUcCancelDelayRespRx=aluPtpPeerUcCancelDelayRespRx, aluPtpPeerCurrent24HourFreqOffsetMeanPpb=aluPtpPeerCurrent24HourFreqOffsetMeanPpb, aluPtpPortStateChange=aluPtpPortStateChange, aluPtpClockTable=aluPtpClockTable, aluPtpClockParentVariance=aluPtpClockParentVariance, aluPtpPeerDescription=aluPtpPeerDescription, aluPtpPeerUcReqSyncTx=aluPtpPeerUcReqSyncTx, aluPtpNotifyPrefix=aluPtpNotifyPrefix, aluPtpNotification=aluPtpNotification, aluPtpPeerCurrent1MinPhaseErrorMeanNs=aluPtpPeerCurrent1MinPhaseErrorMeanNs, aluPtpFreqRecVarTooHighCnt=aluPtpFreqRecVarTooHighCnt, aluPtpClockHw=aluPtpClockHw, aluPtpFreqRecLockedCount=aluPtpFreqRecLockedCount, aluPtpClockTimePropertyDSTable=aluPtpClockTimePropertyDSTable, aluPtpPeerNotifyIndex=aluPtpPeerNotifyIndex, aluPtpNotifyObjsV4v0Group=aluPtpNotifyObjsV4v0Group, aluPtpSyncCertaintyGroup=aluPtpSyncCertaintyGroup, aluPtpClockRowStatus=aluPtpClockRowStatus, aluPtpClockProfile=aluPtpClockProfile, aluPtpPortDSLogAnnoInterval=aluPtpPortDSLogAnnoInterval, aluPtpClockDomain=aluPtpClockDomain, aluPtpPeerIndex=aluPtpPeerIndex, aluPtpClockPtpTimescale=aluPtpClockPtpTimescale, aluPtpPeerUcCancelSyncRx=aluPtpPeerUcCancelSyncRx, aluPtpPeerRecClkStatsShortIntvlEntry=aluPtpPeerRecClkStatsShortIntvlEntry, aluPtpFreqRecHoldOverCount=aluPtpFreqRecHoldOverCount, AluPtpTimeSource=AluPtpTimeSource, Alu1588PtpClockStepType=Alu1588PtpClockStepType, aluPtpPeerAnnounceMsgRx=aluPtpPeerAnnounceMsgRx, aluPtpPortDSLocalPriority=aluPtpPortDSLocalPriority, aluPtpCompliances=aluPtpCompliances, aluPtpClockIpInterface=aluPtpClockIpInterface, AluPtpPortNumber=AluPtpPortNumber, aluPtpPeerStatsV4v0Group=aluPtpPeerStatsV4v0Group, aluPtpPeerUcGrantAnnoTx=aluPtpPeerUcGrantAnnoTx, aluPtpPeerUcNegRejectsAnno=aluPtpPeerUcNegRejectsAnno, aluPtpPeerTotalUdpEventMsgTx=aluPtpPeerTotalUdpEventMsgTx, aluPtpPeerDuplicateMsgDisc=aluPtpPeerDuplicateMsgDisc, aluPtpPeerV4v0Group=aluPtpPeerV4v0Group, aluPtpLocalPtpPortIndex=aluPtpLocalPtpPortIndex, aluPtpPeerDelayRespMsgRx=aluPtpPeerDelayRespMsgRx, aluPtpPeerUcCancelAckSyncTx=aluPtpPeerUcCancelAckSyncTx, aluPtpPeerRecLastUpdateTime=aluPtpPeerRecLastUpdateTime, aluPtpPeerUcGrantAnnoRejected=aluPtpPeerUcGrantAnnoRejected, aluPtpPeerIntvlNumber=aluPtpPeerIntvlNumber, aluPtpFreqRecFreeRunCount=aluPtpFreqRecFreeRunCount, aluPtpClockGMClass=aluPtpClockGMClass, aluPtpClockSyncCertaintyChange=aluPtpClockSyncCertaintyChange, aluPtpPeerStatsV9v0Group=aluPtpPeerStatsV9v0Group, aluPtpPeerUcCancelAckAnnoTx=aluPtpPeerUcCancelAckAnnoTx, aluPtpPeerAnnounceMsgTx=aluPtpPeerAnnounceMsgTx, aluPtpClockCurUtcOffsetValid=aluPtpClockCurUtcOffsetValid, aluPtpPeerPortIndex=aluPtpPeerPortIndex, Alu1588PtpClockIndex=Alu1588PtpClockIndex, aluPtpClockV7v0Group=aluPtpClockV7v0Group, aluPtpPortDSPortNum=aluPtpPortDSPortNum, aluPtpPeerUcGrantSyncRx=aluPtpPeerUcGrantSyncRx, aluPtpClockRecoveryV6v0Group=aluPtpClockRecoveryV6v0Group, aluPtpComp7705V8v0=aluPtpComp7705V8v0, aluPtpComp7705V6v1=aluPtpComp7705V6v1)
mibBuilder.exportSymbols("ALU-PTPV2-MIB", aluPtpClockDefaultDSTable=aluPtpClockDefaultDSTable, aluPtpPeerUcCancelSyncTx=aluPtpPeerUcCancelSyncTx)
