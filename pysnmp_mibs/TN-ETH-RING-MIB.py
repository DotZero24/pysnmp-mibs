...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TN-ETH-RING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:51:19 2025
...
if mibBuilder.loadTexts:
    tnEthRingCcmHoldDownTime.setUnits("centiseconds")
...
class _TnEthRingState_Type(Integer32):
    """Custom type tnEthRingState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TnEthRingState_Type.__name__ = "Integer32"
_TnEthRingState_Object = MibTableColumn
tnEthRingState = _TnEthRingState_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 72, 1, 1, 1, 20),
    _TnEthRingState_Type()
)
tnEthRingState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnEthRingState.setStatus("current")


class _TnEthRingAlmProfName_Type(OctetString):
    """Custom type tnEthRingAlmProfName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TnEthRingAlmProfName_Type.__name__ = "OctetString"
_TnEthRingAlmProfName_Object = MibTableColumn
tnEthRingAlmProfName = _TnEthRingAlmProfName_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 72, 1, 1, 1, 21),
    _TnEthRingAlmProfName_Type()
)
tnEthRingAlmProfName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnEthRingAlmProfName.setStatus("current")
...
class _TnEthRingPortState_Type(Integer32):
    """Custom type tnEthRingPortState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
    ...
    namedValues = NamedValues(
        *(("portDisabled", 0),
          ("portNormal", 1),
          ("portForcedSwitched", 2),
          ("portManualSwitched", 3),
          ("portFailedSF", 4),
          ("na", 5))
    )


_TnEthRingPortState_Type.__name__ = "Integer32"
_TnEthRingPortState_Object = MibTableColumn
tnEthRingPortState = _TnEthRingPortState_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 72, 1, 3, 1, 13),
    _TnEthRingPortState_Type()
)
tnEthRingPortState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tnEthRingPortState.setStatus("current")


class _TnEthRingPathAlmProfName_Type(OctetString):
    """Custom type tnEthRingPathAlmProfName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 40),
    )
...
_TnEthRingPathAlmProfName_Type.__name__ = "OctetString"
_TnEthRingPathAlmProfName_Object = MibTableColumn
tnEthRingPathAlmProfName = _TnEthRingPathAlmProfName_Object(
    (1, 3, 6, 1, 4, 1, 7483, 6, 1, 2, 72, 1, 3, 1, 14),
    _TnEthRingPathAlmProfName_Type()
)
tnEthRingPathAlmProfName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tnEthRingPathAlmProfName.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"TnEthRingIndex": TnEthRingIndex,
       ...
       "tnEthRingState": tnEthRingState,
       "tnEthRingAlmProfName": tnEthRingAlmProfName,
       ...
       "tnEthRingPortState": tnEthRingPortState,
       "tnEthRingPathAlmProfName": tnEthRingPathAlmProfName,
