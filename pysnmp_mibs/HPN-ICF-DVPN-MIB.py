...
mibBuilder.exportSymbols("HPN-ICF-DVPN-MIB", hpnicfDvpnPoRefTimes=hpnicfDvpnPoRefTimes, hpnicfDvpnClServerPriIpType=hpnicfDvpnClServerPriIpType, hpnicfDvpnDomainRedirectNum=hpnicfDvpnDomainRedirectNum, hpnicfDvpnSessionDelNotification=hpnicfDvpnSessionDelNotification, hpnicfDvpnPolicyGroup=hpnicfDvpnPolicyGroup, hpnicfDvpnSessionLocalPriIp=hpnicfDvpnSessionLocalPriIp, hpnicfDvpnNotification=hpnicfDvpnNotification, hpnicfDvpnSessionUserName=hpnicfDvpnSessionUserName, hpnicfDvpnLocalDeviceId=hpnicfDvpnLocalDeviceId, hpnicfDvpnSessionHisGroup=hpnicfDvpnSessionHisGroup, hpnicfDvpnDomainInfoTable=hpnicfDvpnDomainInfoTable, hpnicfDvpnClUserName=hpnicfDvpnClUserName, hpnicfDvpnInputPkt=hpnicfDvpnInputPkt, hpnicfDvpnSessionPeerDeviceId=hpnicfDvpnSessionPeerDeviceId, PYSNMP_MODULE_ID=hpnicfDvpn, hpnicfDvpnPoSaSeconds=hpnicfDvpnPoSaSeconds, hpnicfDvpnMapUserName=hpnicfDvpnMapUserName, hpnicfDvpnSessionLocalPubIpType=hpnicfDvpnSessionLocalPubIpType, hpnicfDvpnMapDelNotification=hpnicfDvpnMapDelNotification, hpnicfDvpnMibGroups=hpnicfDvpnMibGroups, hpnicfDvpnSessionHisReset=hpnicfDvpnSessionHisReset, hpnicfDvpnSessionHisPeerPriIPType=hpnicfDvpnSessionHisPeerPriIPType, hpnicfDvpnSessionHisLastDownTime=hpnicfDvpnSessionHisLastDownTime, hpnicfDvpnMapNumber=hpnicfDvpnMapNumber, hpnicfDvpnDomainDropPkt=hpnicfDvpnDomainDropPkt, hpnicfDvpnTunnelClientRegType=hpnicfDvpnTunnelClientRegType, hpnicfDvpnMapPeerPublicIp=hpnicfDvpnMapPeerPublicIp, hpnicfDvpnMibCompliances=hpnicfDvpnMibCompliances, hpnicfDvpnMapTable=hpnicfDvpnMapTable, hpnicfDvpnSessionHisFirstUpTime=hpnicfDvpnSessionHisFirstUpTime, hpnicfDvpnServerPreSharedKey=hpnicfDvpnServerPreSharedKey, hpnicfDvpnSessionState=hpnicfDvpnSessionState, hpnicfDvpnSessionTrapEnable=hpnicfDvpnSessionTrapEnable, hpnicfDvpnDomainOutputErrorPkt=hpnicfDvpnDomainOutputErrorPkt, hpnicfDvpnSessionEntry=hpnicfDvpnSessionEntry, hpnicfDvpnMapType=hpnicfDvpnMapType, hpnicfDvpnTunnelTable=hpnicfDvpnTunnelTable, hpnicfDvpnSessionType=hpnicfDvpnSessionType, hpnicfDvpnSessionHisOnlineNumber=hpnicfDvpnSessionHisOnlineNumber, hpnicfDvpnSessionHisTable=hpnicfDvpnSessionHisTable, hpnicfDvpnClPreShareKey=hpnicfDvpnClPreShareKey, hpnicfDvpnMapPeerPriIpType=hpnicfDvpnMapPeerPriIpType, hpnicfDvpnSessionHisLastUpTime=hpnicfDvpnSessionHisLastUpTime, hpnicfDvpnDomainInputPkt=hpnicfDvpnDomainInputPkt, hpnicfDvpnSessionLocalPriIpType=hpnicfDvpnSessionLocalPriIpType, hpnicfDvpnDomainOutputPkt=hpnicfDvpnDomainOutputPkt, hpnicfDvpnSessionHisOnlineFlag=hpnicfDvpnSessionHisOnlineFlag, hpnicfDvpnMapControlId=hpnicfDvpnMapControlId, hpnicfDvpnPoUserDefAAADomain=hpnicfDvpnPoUserDefAAADomain, hpnicfDvpnTunnelInterfaceType=hpnicfDvpnTunnelInterfaceType, hpnicfDvpnDomainInfoEntry=hpnicfDvpnDomainInfoEntry, hpnicfDvpnMibConformance=hpnicfDvpnMibConformance, hpnicfDvpnPoSessionKeepTime=hpnicfDvpnPoSessionKeepTime, hpnicfDvpnClassRowStatus=hpnicfDvpnClassRowStatus, hpnicfDvpnSessionPeerPubIp=hpnicfDvpnSessionPeerPubIp, hpnicfDvpnSessionHisPeerPriIP=hpnicfDvpnSessionHisPeerPriIP, hpnicfDvpnMapPeerPublicIpType=hpnicfDvpnMapPeerPublicIpType, hpnicfDvpnSessionInitiator=hpnicfDvpnSessionInitiator, hpnicfDvpnClassGroup=hpnicfDvpnClassGroup, hpnicfDvpnSessionPeerPriIp=hpnicfDvpnSessionPeerPriIp, hpnicfDvpnMapAgeTime=hpnicfDvpnMapAgeTime, hpnicfDvpnOutputPkt=hpnicfDvpnOutputPkt, hpnicfDvpnDropPkt=hpnicfDvpnDropPkt, hpnicfDvpnGlobalGroup=hpnicfDvpnGlobalGroup, hpnicfDvpnSessionGroup=hpnicfDvpnSessionGroup, hpnicfDvpnMapEntry=hpnicfDvpnMapEntry, hpnicfDvpnEncryptErrorPkt=hpnicfDvpnEncryptErrorPkt, DvpnCommunicateType=DvpnCommunicateType, hpnicfDvpnMapGroup=hpnicfDvpnMapGroup, hpnicfDvpnSessionPeerPubIpType=hpnicfDvpnSessionPeerPubIpType, hpnicfDvpnCurrentDeviceRole=hpnicfDvpnCurrentDeviceRole, hpnicfDvpnSessionNumber=hpnicfDvpnSessionNumber, hpnicfDvpnMapState=hpnicfDvpnMapState, hpnicfDvpnSessionPeerUdpPort=hpnicfDvpnSessionPeerUdpPort, hpnicfDvpnSessionHisRcvPkt=hpnicfDvpnSessionHisRcvPkt, hpnicfDvpnMibCompliance=hpnicfDvpnMibCompliance, hpnicfDvpnPolicyEntry=hpnicfDvpnPolicyEntry, hpnicfDvpnSessionPeerType=hpnicfDvpnSessionPeerType, hpnicfDvpnMibGlobal=hpnicfDvpnMibGlobal, hpnicfDvpnMapBuildTime=hpnicfDvpnMapBuildTime, hpnicfDvpnSessionBuildNotification=hpnicfDvpnSessionBuildNotification, hpnicfDvpnTunnelEntry=hpnicfDvpnTunnelEntry, hpnicfDvpnClassEntry=hpnicfDvpnClassEntry, hpnicfDvpnSessionHisPeerDeviceId=hpnicfDvpnSessionHisPeerDeviceId, hpnicfDvpnSessionTable=hpnicfDvpnSessionTable, hpnicfDvpnClassTable=hpnicfDvpnClassTable, hpnicfDvpnClPasswd=hpnicfDvpnClPasswd, hpnicfDvpnGlobalAuthenClientType=hpnicfDvpnGlobalAuthenClientType, hpnicfDvpnSessionHisEntry=hpnicfDvpnSessionHisEntry, hpnicfDvpnDomainEncryptErrorPkt=hpnicfDvpnDomainEncryptErrorPkt, hpnicfDvpnTunnelDvpnId=hpnicfDvpnTunnelDvpnId, hpnicfDvpnClAuthenServerType=hpnicfDvpnClAuthenServerType, hpnicfDvpnMapLocalPriIp=hpnicfDvpnMapLocalPriIp, hpnicfDvpnTunnelClass=hpnicfDvpnTunnelClass, hpnicfDvpnClientRegisterRetry=hpnicfDvpnClientRegisterRetry, hpnicfDvpnPolicyName=hpnicfDvpnPolicyName, hpnicfDvpnSessionHisSendPkt=hpnicfDvpnSessionHisSendPkt, hpnicfDvpnNotificationGroup=hpnicfDvpnNotificationGroup, hpnicfDvpnMapPeerDeviceId=hpnicfDvpnMapPeerDeviceId, hpnicfDvpnTunnelGroup=hpnicfDvpnTunnelGroup, hpnicfDvpnMapTrapEnable=hpnicfDvpnMapTrapEnable, hpnicfDvpnPolicyTable=hpnicfDvpnPolicyTable, hpnicfDvpnMapPeerPriIp=hpnicfDvpnMapPeerPriIp, DvpnAlgorithmSuite=DvpnAlgorithmSuite, hpnicfDvpn=hpnicfDvpn, hpnicfDvpnSessionHisAgeTime=hpnicfDvpnSessionHisAgeTime, hpnicfDvpnMapBuildNotification=hpnicfDvpnMapBuildNotification, hpnicfDvpnMapLocalPublicIpType=hpnicfDvpnMapLocalPublicIpType, hpnicfDvpnClientNumber=hpnicfDvpnClientNumber, hpnicfDvpnMibTableTroop=hpnicfDvpnMibTableTroop, hpnicfDvpnClassNumber=hpnicfDvpnClassNumber, hpnicfDvpnDomainInfoGroup=hpnicfDvpnDomainInfoGroup, hpnicfDvpnMapLocalPublicIp=hpnicfDvpnMapLocalPublicIp, hpnicfDvpnClassName=hpnicfDvpnClassName, hpnicfDvpnPoSessionIdleTime=hpnicfDvpnPoSessionIdleTime, hpnicfDvpnClientRegisterInterval=hpnicfDvpnClientRegisterInterval, hpnicfDvpnTunnelAcl=hpnicfDvpnTunnelAcl, hpnicfDvpnClServerPublicIpType=hpnicfDvpnClServerPublicIpType, hpnicfDvpnPoAuthenClientType=hpnicfDvpnPoAuthenClientType, hpnicfDvpnClServerPublicIp=hpnicfDvpnClServerPublicIp, hpnicfDvpnClearDomainAllConection=hpnicfDvpnClearDomainAllConection, hpnicfDvpnPoRowStatus=hpnicfDvpnPoRowStatus, hpnicfDvpnClientRegisterDumb=hpnicfDvpnClientRegisterDumb, hpnicfDvpnClearDvpnStaInfo=hpnicfDvpnClearDvpnStaInfo, hpnicfDvpnDomainSessionNum=hpnicfDvpnDomainSessionNum, hpnicfDvpnGlobalUserDefAAADomain=hpnicfDvpnGlobalUserDefAAADomain, hpnicfDvpnSessionBuildTime=hpnicfDvpnSessionBuildTime, hpnicfDvpnClPwdEncrypted=hpnicfDvpnClPwdEncrypted, hpnicfDvpnMapUdpPort=hpnicfDvpnMapUdpPort, hpnicfDvpnMapIndex=hpnicfDvpnMapIndex, hpnicfDvpnServiceEnable=hpnicfDvpnServiceEnable, hpnicfDvpnSessionDvpnId=hpnicfDvpnSessionDvpnId, hpnicfDvpnDomainID=hpnicfDvpnDomainID, hpnicfDvpnOutputErrorPkt=hpnicfDvpnOutputErrorPkt, hpnicfDvpnTotalRedirectNumber=hpnicfDvpnTotalRedirectNumber, hpnicfDvpnPoSessionAlgorithmSuite=hpnicfDvpnPoSessionAlgorithmSuite, hpnicfDvpnClServerPriIp=hpnicfDvpnClServerPriIp, hpnicfDvpnClAlgorithmSuite=hpnicfDvpnClAlgorithmSuite, hpnicfDvpnMibNotification=hpnicfDvpnMibNotification, hpnicfDvpnVersion=hpnicfDvpnVersion, hpnicfDvpnMapLocalPriIpType=hpnicfDvpnMapLocalPriIpType, hpnicfDvpnMibObjects=hpnicfDvpnMibObjects, hpnicfDvpnPoDataAlgorithmSuite=hpnicfDvpnPoDataAlgorithmSuite, hpnicfDvpnDomainNumber=hpnicfDvpnDomainNumber, hpnicfDvpnSessionPeerPriIpType=hpnicfDvpnSessionPeerPriIpType, hpnicfDvpnSessionLocalPubIp=hpnicfDvpnSessionLocalPubIp, hpnicfDvpnTunnelPolicy=hpnicfDvpnTunnelPolicy, hpnicfDvpnSessionHisDvpnID=hpnicfDvpnSessionHisDvpnID, hpnicfDvpnPoSessionSetupInterval=hpnicfDvpnPoSessionSetupInterval, hpnicfDvpnMapDvpnId=hpnicfDvpnMapDvpnId)
