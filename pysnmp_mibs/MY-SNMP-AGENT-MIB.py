...
mySnmpAgentMIBObjects=_MySnmpAgentMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,5,1))
_MySnmpCommunityObjects_ObjectIdentity=ObjectIdentity
mySnmpCommunityObjects=_MySnmpCommunityObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,5,1,1))
_MyCommunityMaxNum_Type=Integer32
_MyCommunityMaxNum_Object=MibScalar
myCommunityMaxNum=_MyCommunityMaxNum_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,1,1),_MyCommunityMaxNum_Type())
myCommunityMaxNum.setMaxAccess(_D)
if mibBuilder.loadTexts:myCommunityMaxNum.setStatus(_A)
_MyCommunityTable_Object=MibTable
myCommunityTable=_MyCommunityTable_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,1,2))
if mibBuilder.loadTexts:myCommunityTable.setStatus(_A)
_MyCommunityEntry_Object=MibTableRow
myCommunityEntry=_MyCommunityEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,1,2,1))
...
myCommunityName=_MyCommunityName_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,1,2,1,1),_MyCommunityName_Type())
...
myCommunityWritable=_MyCommunityWritable_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,1,2,1,2),_MyCommunityWritable_Type())
...
myCommunityUserIpAddr=_MyCommunityUserIpAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,1,2,1,3),_MyCommunityUserIpAddr_Type())
...
myCommunityEnableIpAddrAuthen=_MyCommunityEnableIpAddrAuthen_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,1,2,1,4),_MyCommunityEnableIpAddrAuthen_Type())
...
myCommunityStatus=_MyCommunityStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,1,2,1,5),_MyCommunityStatus_Type())
...
mySnmpTrapObjects=_MySnmpTrapObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,5,1,2))
_MyTrapDstMaxNumber_Type=Integer32
_MyTrapDstMaxNumber_Object=MibScalar
myTrapDstMaxNumber=_MyTrapDstMaxNumber_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,1),_MyTrapDstMaxNumber_Type())
myTrapDstMaxNumber.setMaxAccess(_D)
if mibBuilder.loadTexts:myTrapDstMaxNumber.setStatus(_A)
_MyTrapDstTable_Object=MibTable
myTrapDstTable=_MyTrapDstTable_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,2))
if mibBuilder.loadTexts:myTrapDstTable.setStatus(_A)
_MyTrapDstEntry_Object=MibTableRow
myTrapDstEntry=_MyTrapDstEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,2,1))
...
myTrapDstAddr=_MyTrapDstAddr_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,2,1,1),_MyTrapDstAddr_Type())
...
myTrapDstCommunity=_MyTrapDstCommunity_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,2,1,2),_MyTrapDstCommunity_Type())
...
myTrapDstSendTrapClass=_MyTrapDstSendTrapClass_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,2,1,3),_MyTrapDstSendTrapClass_Type())
...
myTrapDstEntryStatus=_MyTrapDstEntryStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,2,1,4),_MyTrapDstEntryStatus_Type())
...
myTrapActionTable=_MyTrapActionTable_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,3))
if mibBuilder.loadTexts:myTrapActionTable.setStatus(_A)
_MyTrapActionEntry_Object=MibTableRow
myTrapActionEntry=_MyTrapActionEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,3,1))
...
myTrapType=_MyTrapType_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,3,1,1),_MyTrapType_Type())
...
myTrapAction=_MyTrapAction_Object((1,3,6,1,4,1,4881,1,1,10,2,5,1,2,3,1,2),_MyTrapAction_Type())
...
mySnmpAgentMIBConformance=_MySnmpAgentMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,5,2))
_MySnmpAgentMIBCompliances_ObjectIdentity=ObjectIdentity
mySnmpAgentMIBCompliances=_MySnmpAgentMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,5,2,1))
_MySnmpAgentMIBGroups_ObjectIdentity=ObjectIdentity
mySnmpAgentMIBGroups=_MySnmpAgentMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,5,2,2))
myCommunityMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,5,2,2,1))
...
mySnmpTrapMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,5,2,2,2))
...
mySnmpAgentMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,5,2,1,1))
