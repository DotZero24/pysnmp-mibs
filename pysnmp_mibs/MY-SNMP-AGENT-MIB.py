...
# Notes
# -----
# ASN.1 source file://mibs/ruijie/MY-SNMP-AGENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:35:22 2025
...
mySnmpAgentMIBCompliance.setObjects(
      *(("MY-SNMP-AGENT-MIB", "myCommunityMIBGroup"),
        ("MY-SNMP-AGENT-MIB", "mySnmpTrapMIBGroup"))
)
if mibBuilder.loadTexts:
