...
tcaValue, evtDateAndTime, evtDescription, evtCodeType, tcaDateAndTime, tcaMontype, condReportType, tcaIntervalType, tcaThreshold, evtObjectType, condSeverity, condObjectType, opticalLayer, condDateAndTime, olCondNotifications, olEvtNotifications, condCodeType, trapSeqNum, condServiceAffecting, condDescription = mibBuilder.importSymbols("BTI-7000-MIB", "tcaValue", "evtDateAndTime", "evtDescription", "evtCodeType", "tcaDateAndTime", "tcaMontype", "condReportType", "tcaIntervalType", "tcaThreshold", "evtObjectType", "condSeverity", "condObjectType", "opticalLayer", "condDateAndTime", "olCondNotifications", "olEvtNotifications", "condCodeType", "trapSeqNum", "condServiceAffecting", "condDescription")
btiModules, = mibBuilder.importSymbols("BTI-MIB", "btiModules")
PMIntervalType, BERType, CpType, FiberType, FixedX100, OperStatus, PMValidity, FixedX10, OperStatQlfr, HoursAndMinutes, AdminStatus, InitializeCmd = mibBuilder.importSymbols("BTI-TC-MIB", "PMIntervalType", "BERType", "CpType", "FiberType", "FixedX100", "OperStatus", "PMValidity", "FixedX10", "OperStatQlfr", "HoursAndMinutes", "AdminStatus", "InitializeCmd")
...
mibBuilder.exportSymbols("BTI-OL-MIB", wchPortTypeIdx=wchPortTypeIdx, olPortHistPMLossTxValidity=olPortHistPMLossTxValidity, olPortCrntPMOPTAvgTimeStamp=olPortCrntPMOPTAvgTimeStamp, odccEntry=odccEntry, wchHistPMOPRMaxInitialize=wchHistPMOPRMaxInitialize, olPortHistPMOPTValidity=olPortHistPMOPTValidity, olOSCTcaEvt=olOSCTcaEvt, olOSCCrntPMSESSInitialize=olOSCCrntPMSESSInitialize, wchCustom1=wchCustom1, olOSCOpticalBackReflOutOfSpecClear=olOSCOpticalBackReflOutOfSpecClear, wdmId=wdmId, eqptConnRowStatus=eqptConnRowStatus, olPortAPSDClear=olPortAPSDClear, olOSCCrntPMOPTTimeStamp=olOSCCrntPMOPTTimeStamp, eqptConnSrcSlotIdx=eqptConnSrcSlotIdx, wchHistPMOPTMaxValue=wchHistPMOPTMaxValue, olPortHistPMOPTTimeStamp=olPortHistPMOPTTimeStamp, wchXCSrcChannelIdx=wchXCSrcChannelIdx, olPortCrntPMOPTValue=olPortCrntPMOPTValue, olPortFrequency=olPortFrequency, wchOperStatus=wchOperStatus, eqptConnSrcCpTypeIdx=eqptConnSrcCpTypeIdx, olPortTypeIdx=olPortTypeIdx, wchXCEntry=wchXCEntry, olPortPowerOutOfSpecRxCond=olPortPowerOutOfSpecRxCond, olPortPowerOutOfSpecRxClear=olPortPowerOutOfSpecRxClear, wchHistPMShelfIdx=wchHistPMShelfIdx, wchHistPMOPTMaxValidity=wchHistPMOPTMaxValidity, olPortCondNotifications=olPortCondNotifications, wchHistPMOPTValue=wchHistPMOPTValue, olPortHistPMOPRStdDevValue=olPortHistPMOPRStdDevValue, olPortCrntPMLossRxTimeStamp=olPortCrntPMLossRxTimeStamp, olOSCCrntPMIntervalTypeIdx=olOSCCrntPMIntervalTypeIdx, wdmInvalidBoostAmpOperCnfgClear=wdmInvalidBoostAmpOperCnfgClear, olPortHistPMOPRMinValue=olPortHistPMOPRMinValue, olPortCrntPMTypeIdx=olPortCrntPMTypeIdx, olOSCHistPMSESSInitialize=olOSCHistPMSESSInitialize, olOSCHistPMSESSValidity=olOSCHistPMSESSValidity, olPortConnectionMismatchClear=olPortConnectionMismatchClear, olGroupRowStatus=olGroupRowStatus, wchHistPMOPRTimeStamp=wchHistPMOPRTimeStamp, olOSCId=olOSCId, olOSCExpFEIPAddr=olOSCExpFEIPAddr, wdmCustom3=wdmCustom3, olEqptCpTypeIdx=olEqptCpTypeIdx, wchAutoEnableTimer=wchAutoEnableTimer, wchGrid=wchGrid, olOSCActAutoEnableTimer=olOSCActAutoEnableTimer, olOSCHistPMTable=olOSCHistPMTable, olEqptEntry=olEqptEntry, olPortHistPMIntervalTypeIdx=olPortHistPMIntervalTypeIdx, wchPowerRxHighFailCond=wchPowerRxHighFailCond, olOSCCondNotifications=olOSCCondNotifications, olOSCPMThresholdCpTypeIdx=olOSCPMThresholdCpTypeIdx, wchXCDstSlotIdx=wchXCDstSlotIdx, wdmOperStatus=wdmOperStatus, wchXCDstChannelIdx=wchXCDstChannelIdx, wchHistPMOPRMinInitialize=wchHistPMOPRMinInitialize, wchCrntPMOPRMaxTimeStamp=wchCrntPMOPRMaxTimeStamp, odccAdminStatus=odccAdminStatus, eqptConnDstShelfIdx=eqptConnDstShelfIdx, olPortHistPMInitializeAll=olPortHistPMInitializeAll, olPortShelfIdx=olPortShelfIdx, wchXCSrcPortIdx=wchXCSrcPortIdx, olPortEvtNotifications=olPortEvtNotifications, olOSCHistPMOPTValue=olOSCHistPMOPTValue, wdmEvtNotifications=wdmEvtNotifications, olEqptDegreeNum=olEqptDegreeNum, olPortCustom3=olPortCustom3, olOSCHistPMSEFSSInitialize=olOSCHistPMSEFSSInitialize, olPortCrntPMEntry=olPortCrntPMEntry, olOSCCrntPMCVSValidity=olOSCCrntPMCVSValidity, olGroupTable=olGroupTable, olGroupCustom3=olGroupCustom3, wchXCRowStatus=wchXCRowStatus, olPortHistPMOPTMaxTimeStamp=olPortHistPMOPTMaxTimeStamp, olPortCrntPMShelfIdx=olPortCrntPMShelfIdx, wdmActAutoEnableTimer=wdmActAutoEnableTimer, odccRowStatus=odccRowStatus, wdmShelfIdx=wdmShelfIdx, olOSCEqlzContCommCond=olOSCEqlzContCommCond, wchHistPMOPTMinValue=wchHistPMOPTMinValue, olOSCExpFEGrp=olOSCExpFEGrp, olOSCPMThresholdESSValue=olOSCPMThresholdESSValue, olPortHistPMLossRxValidity=olPortHistPMLossRxValidity, olPortHistPMLossTxTimeStamp=olPortHistPMLossTxTimeStamp, eqptConnType=eqptConnType, wchEvtNotifications=wchEvtNotifications, olOSCPMThresholdEntry=olOSCPMThresholdEntry, wchCustom2=wchCustom2, olOSCCrntPMCVSInitialize=olOSCCrntPMCVSInitialize, olOSCOpticalBackReflHighThClear=olOSCOpticalBackReflHighThClear, olOSCHistPMIntervalTypeIdx=olOSCHistPMIntervalTypeIdx, wchActAutoEnableTimer=wchActAutoEnableTimer, wchLossOfLightRxClear=wchLossOfLightRxClear, olPortCrntPMOPTStdDevTimeStamp=olPortCrntPMOPTStdDevTimeStamp, olGroupId=olGroupId, olPortHistPMOPTMinValidity=olPortHistPMOPTMinValidity, olPortHistPMOPTStdDevTimeStamp=olPortHistPMOPTStdDevTimeStamp, olOSCExpFEDegr=olOSCExpFEDegr, wchPowerOutOfSpecRxCond=wchPowerOutOfSpecRxCond, olOSCFEGrpType=olOSCFEGrpType, olOSCCrntPMOPTValidity=olOSCCrntPMOPTValidity, olPortCrntPMLossTxValidity=olPortCrntPMLossTxValidity, olPortStatusChangeEvt=olPortStatusChangeEvt, olOSCHistPMOBRValidity=olOSCHistPMOBRValidity, wchHistPMCpTypeIdx=wchHistPMCpTypeIdx, olOSCPMThresholdSlotIdx=olOSCPMThresholdSlotIdx, olPortHistPMOPRMinValidity=olPortHistPMOPRMinValidity, wdmSlotIdx=wdmSlotIdx, olPortCrntPMLossRxValue=olPortCrntPMLossRxValue, wchCrntPMOPTMinTimeStamp=wchCrntPMOPTMinTimeStamp, olOSCHistPMOPTTimeStamp=olOSCHistPMOPTTimeStamp, olOSCHistPMEntry=olOSCHistPMEntry, olOSCSlotIdx=olOSCSlotIdx, olPortCrntPMOPRAvgTimeStamp=olPortCrntPMOPRAvgTimeStamp, olPortChannelCountDeficiencyCond=olPortChannelCountDeficiencyCond, olGroupMerge=olGroupMerge, wchHistPMOPRMaxValidity=wchHistPMOPRMaxValidity, olOSCHistPMIntervalIdx=olOSCHistPMIntervalIdx, olPortHistPMOPTMinValue=olPortHistPMOPTMinValue, olGroupEntry=olGroupEntry, olPortHistPMOPRMinTimeStamp=olPortHistPMOPRMinTimeStamp, olPortHistPMOPTMaxValue=olPortHistPMOPTMaxValue, wdmInvalidMidAmpOperCnfgClear=wdmInvalidMidAmpOperCnfgClear, olOSCHistPMOBRTimeStamp=olOSCHistPMOBRTimeStamp, olOSCPMThresholdShelfIdx=olOSCPMThresholdShelfIdx, olPortCrntPMLossTxValue=olPortCrntPMLossTxValue, wchOperStatQlfr=wchOperStatQlfr, wchHistPMPortTypeIdx=wchHistPMPortTypeIdx, eqptConnDstCpTypeIdx=eqptConnDstCpTypeIdx, olOSCHistPMCVSInitialize=olOSCHistPMCVSInitialize, odccCpTypeIdx=odccCpTypeIdx, olPortCrntPMOPRMaxTimeStamp=olPortCrntPMOPRMaxTimeStamp, olPortCrntPMOPTMinValidity=olPortCrntPMOPTMinValidity, olOSCCrntPMShelfIdx=olOSCCrntPMShelfIdx, olOSCFESysName=olOSCFESysName, olPortExpCnxDegree=olPortExpCnxDegree, wchId=wchId, wdmInvalidPreAmpOperCnfgCond=wdmInvalidPreAmpOperCnfgCond, wchHistPMOPTMaxTimeStamp=wchHistPMOPTMaxTimeStamp, olOSCHistPMSlotIdx=olOSCHistPMSlotIdx, wchIdx=wchIdx, olPortId=olPortId, olPortCrntPMOPTMinValue=olPortCrntPMOPTMinValue, eqptConnEntry=eqptConnEntry, wchCrntPMOPRMaxValue=wchCrntPMOPRMaxValue, olPortCrntPMOPTStdDevValidity=olPortCrntPMOPTStdDevValidity, olOSCCrntPMSEFSSValidity=olOSCCrntPMSEFSSValidity, wchCrntPMOPRValue=wchCrntPMOPRValue, wdmStatusChangeEvt=wdmStatusChangeEvt, olPortOperStatus=olPortOperStatus, wchCrntPMOPTMaxValue=wchCrntPMOPTMaxValue, wchAISClear=wchAISClear, wdmOperStatQlfr=wdmOperStatQlfr, wdmCustom1=wdmCustom1, olPortHistPMLossRxTimeStamp=olPortHistPMLossRxTimeStamp, olOSCCrntPMSlotIdx=olOSCCrntPMSlotIdx, olPortCrntPMOPRValidity=olPortCrntPMOPRValidity, wchCpTypeIdx=wchCpTypeIdx, eqptConnTable=eqptConnTable, olPortCrntPMCpTypeIdx=olPortCrntPMCpTypeIdx, olGroupIdx=olGroupIdx, olOSCHistPMOPRValidity=olOSCHistPMOPRValidity, olOSCRowStatus=olOSCRowStatus, odccLineIdx=odccLineIdx, olPortHistPMOPTAvgValidity=olPortHistPMOPTAvgValidity, olOSCHistPMSESSTimeStamp=olOSCHistPMSESSTimeStamp, eqptConnSrcShelfIdx=eqptConnSrcShelfIdx, olGroupType=olGroupType, olOSCShelfIdx=olOSCShelfIdx, olOSCCrntPMSESSValue=olOSCCrntPMSESSValue, olPortLossRxOutOfSpecClear=olPortLossRxOutOfSpecClear, wdmFiberType=wdmFiberType, wchCrntPMOPTTimeStamp=wchCrntPMOPTTimeStamp, wchHistPMOPTMinValidity=wchHistPMOPTMinValidity, olOSCHistPMESSTimeStamp=olOSCHistPMESSTimeStamp, wchHistPMOPRMinValidity=wchHistPMOPRMinValidity, olPortCrntPMOPTMaxValidity=olPortCrntPMOPTMaxValidity, olPortCrntPMOPRMaxValidity=olPortCrntPMOPRMaxValidity, olOSCCrntPMESSValidity=olOSCCrntPMESSValidity, olPortHistPMOPRMaxValidity=olPortHistPMOPRMaxValidity, wchXCDstPortTypeIdx=wchXCDstPortTypeIdx, wdmAdminStatus=wdmAdminStatus, olPortCrntPMOPTAvgValue=olPortCrntPMOPTAvgValue, olOSCLossOfFrameClear=olOSCLossOfFrameClear, olEqptRowStatus=olEqptRowStatus, olPortHistPMOPRStdDevTimeStamp=olPortHistPMOPRStdDevTimeStamp, olPortHistPMTypeIdx=olPortHistPMTypeIdx, eqptConnDstPortTypeIdx=eqptConnDstPortTypeIdx, wdmLineIdx=wdmLineIdx, wdmRowStatus=wdmRowStatus, olOSCCrntPMCpTypeIdx=olOSCCrntPMCpTypeIdx, wchPowerOutOfSpecTxClear=wchPowerOutOfSpecTxClear, olPortHistPMOPTAvgTimeStamp=olPortHistPMOPTAvgTimeStamp, OlPortType=OlPortType, wchCrntPMPortTypeIdx=wchCrntPMPortTypeIdx, wchHistPMOPTMinTimeStamp=wchHistPMOPTMinTimeStamp, wchXCSrcSlotIdx=wchXCSrcSlotIdx, olPortCrntPMLossTxTimeStamp=olPortCrntPMLossTxTimeStamp, olOSCLossOfLightRxClear=olOSCLossOfLightRxClear, wchCrntPMOPTMinInitialize=wchCrntPMOPTMinInitialize, wchHistPMOPTMaxInitialize=wchHistPMOPTMaxInitialize, olPortPayloadMissingIndClear=olPortPayloadMissingIndClear, olPortIdx=olPortIdx, olPortHistPMOPRStdDevValidity=olPortHistPMOPRStdDevValidity, olOSCCrntPMOPRValue=olOSCCrntPMOPRValue, wchXCTable=wchXCTable, olOSCOperStatQlfr=olOSCOperStatQlfr, wchHistPMTable=wchHistPMTable, wchHistPMOPTMinInitialize=wchHistPMOPTMinInitialize, wchXCServiceName=wchXCServiceName, wchTable=wchTable, wchUnequippedClear=wchUnequippedClear, olOSCCrntPMSESSTimeStamp=olOSCCrntPMSESSTimeStamp, olOSCFEDegr=olOSCFEDegr, olOSCCustom2=olOSCCustom2, olPortWavelength=olPortWavelength, olPortSlotIdx=olPortSlotIdx, olEqptTable=olEqptTable, olOSCHistPMSESSValue=olOSCHistPMSESSValue, olPortHistPMSlotIdx=olPortHistPMSlotIdx, wchHistPMOPTValidity=wchHistPMOPTValidity, wchCrntPMIntervalTypeIdx=wchCrntPMIntervalTypeIdx, wchCrntPMOPTMaxTimeStamp=wchCrntPMOPTMaxTimeStamp, olPortHistPMTable=olPortHistPMTable, wchPowerOutOfSpecTxCond=wchPowerOutOfSpecTxCond, olPortActCnxDegree=olPortActCnxDegree, olPortLossRxHighThCond=olPortLossRxHighThCond, olOSCCpTypeIdx=olOSCCpTypeIdx, olPortHistPMOPTStdDevValidity=olPortHistPMOPTStdDevValidity, olOSCOpticalBackReflHighThCond=olOSCOpticalBackReflHighThCond, olOSCPMThresholdUASSValue=olOSCPMThresholdUASSValue, wchHistPMOPRMinValue=wchHistPMOPRMinValue, olOSCFEIPAddr=olOSCFEIPAddr, eqptConnDstIdx=eqptConnDstIdx, olPortHistPMOPTValue=olPortHistPMOPTValue, wchHistPMIntervalIdx=wchHistPMIntervalIdx, olOSCHistPMLineIdx=olOSCHistPMLineIdx, olOSCFarEndNodeCnfgInconsistentClear=olOSCFarEndNodeCnfgInconsistentClear, olOSCTable=olOSCTable, olPortCustom1=olPortCustom1, olPortCrntPMLossRxValidity=olPortCrntPMLossRxValidity, olPortCrntPMOPTMinTimeStamp=olPortCrntPMOPTMinTimeStamp, wchHistPMOPRMinTimeStamp=wchHistPMOPRMinTimeStamp, wchEntry=wchEntry, wchHistPMSlotIdx=wchHistPMSlotIdx, olPortCrntPMOPTValidity=olPortCrntPMOPTValidity, olGroupMergePrimary=olGroupMergePrimary, olOSCHistPMESSValidity=olOSCHistPMESSValidity, wchHistPMOPRMaxValue=wchHistPMOPRMaxValue, olPortHistPMOPTAvgValue=olPortHistPMOPTAvgValue, olPortHistPMIdx=olPortHistPMIdx, olPortLossOfLightRxClear=olPortLossOfLightRxClear)
mibBuilder.exportSymbols("BTI-OL-MIB", wchCrntPMTable=wchCrntPMTable, olOSCHistPMUASSValidity=olOSCHistPMUASSValidity, wchShelfIdx=wchShelfIdx, olOSCFarEndNodeCnfgInconsistentCond=olOSCFarEndNodeCnfgInconsistentCond, wchCrntPMOPRMaxInitialize=wchCrntPMOPRMaxInitialize, wchPortIdx=wchPortIdx, olOSCCrntPMOPRTimeStamp=olOSCCrntPMOPRTimeStamp, olOSCLineIdx=olOSCLineIdx, olPortCrntPMTable=olPortCrntPMTable, wchCrntPMOPTMaxInitialize=wchCrntPMOPTMaxInitialize, olOSCCrntPMSESSValidity=olOSCCrntPMSESSValidity, olPortConnectionMismatchCond=olPortConnectionMismatchCond, olOSCHistPMCVSTimeStamp=olOSCHistPMCVSTimeStamp, wchPowerOutOfSpecRxClear=wchPowerOutOfSpecRxClear, wchAdminStatus=wchAdminStatus, wchCrntPMOPTValue=wchCrntPMOPTValue, olOSCCrntPMSEFSSValue=olOSCCrntPMSEFSSValue, wdmAutoEnableTimer=wdmAutoEnableTimer, olPortHistPMOPRAvgTimeStamp=olPortHistPMOPRAvgTimeStamp, olPortTable=olPortTable, olOSCPMThresholdCVSValue=olOSCPMThresholdCVSValue, wchUnequippedCond=wchUnequippedCond, wchWavelength=wchWavelength, wdmEntry=wdmEntry, wdmNumChannels=wdmNumChannels, olPortCrntPMOPTMaxValue=olPortCrntPMOPTMaxValue, olPortHistPMOPTStdDevValue=olPortHistPMOPTStdDevValue, wchCrntPMOPRTimeStamp=wchCrntPMOPRTimeStamp, olOSCFarEndIdMismatchCond=olOSCFarEndIdMismatchCond, olOSCSpanContCommCond=olOSCSpanContCommCond, olPortCpTypeIdx=olPortCpTypeIdx, wchLossOfLightRxCond=wchLossOfLightRxCond, odccTable=odccTable, wchBitrate=wchBitrate, wdmCpTypeIdx=wdmCpTypeIdx, olPortCrntPMSlotIdx=olPortCrntPMSlotIdx, wdmInvalidBoostAmpOperCnfgCond=wdmInvalidBoostAmpOperCnfgCond, olOSCPMThresholdSESSValue=olOSCPMThresholdSESSValue, wchCrntPMOPRMinInitialize=wchCrntPMOPRMinInitialize, wchCrntPMEntry=wchCrntPMEntry, olPortHistPMOPRMaxValue=olPortHistPMOPRMaxValue, odccSlotIdx=odccSlotIdx, olPortCrntPMOPRStdDevValidity=olPortCrntPMOPRStdDevValidity, olPortHistPMEntry=olPortHistPMEntry, olPortHistPMOPRAvgValue=olPortHistPMOPRAvgValue, olPortBackwardDefectIndCond=olPortBackwardDefectIndCond, eqptConnSrcIdx=eqptConnSrcIdx, olPortRowStatus=olPortRowStatus, olPortCrntPMInitializeAll=olPortCrntPMInitializeAll, wchLossOfLightTxCond=wchLossOfLightTxCond, olOSCCrntPMUASSTimeStamp=olOSCCrntPMUASSTimeStamp, olPortCrntPMOPRMaxValue=olPortCrntPMOPRMaxValue, olOSCCrntPMLineIdx=olOSCCrntPMLineIdx, olOSCCrntPMESSInitialize=olOSCCrntPMESSInitialize, wdmSpanLossRxHighTh=wdmSpanLossRxHighTh, wchCustom3=wchCustom3, olOSCCrntPMCVSValue=olOSCCrntPMCVSValue, wchLossOfLightTxClear=wchLossOfLightTxClear, wchFrequency=wchFrequency, olPortChannelCountDeficiencyClear=olPortChannelCountDeficiencyClear, olOSCHistPMSEFSSTimeStamp=olOSCHistPMSEFSSTimeStamp, PYSNMP_MODULE_ID=olMib, wchHistPMOPTTimeStamp=wchHistPMOPTTimeStamp, wchCrntPMCpTypeIdx=wchCrntPMCpTypeIdx, wchXCSrcPortTypeIdx=wchXCSrcPortTypeIdx, olPortOperStatQlfr=olPortOperStatQlfr, olOSCLossOfLightRxCond=olOSCLossOfLightRxCond, olOSCCustom1=olOSCCustom1, olOSCHistPMCVSValue=olOSCHistPMCVSValue, olPerformance=olPerformance, olPortHistPMOPRAvgValidity=olPortHistPMOPRAvgValidity, wdmSpanLossSpecMax=wdmSpanLossSpecMax, wchHistPMPortIdx=wchHistPMPortIdx, olOSCHistPMSEFSSValue=olOSCHistPMSEFSSValue, olPortCrntPMOPRValue=olPortCrntPMOPRValue, wchHistPMOPRValue=wchHistPMOPRValue, olOSCLossOfLightTxCond=olOSCLossOfLightTxCond, olOSCAdminStatus=olOSCAdminStatus, wdmSpanLength=wdmSpanLength, olOSCHistPMSEFSSValidity=olOSCHistPMSEFSSValidity, olPortCrntPMOPTAvgValidity=olPortCrntPMOPTAvgValidity, wdmTable=wdmTable, wchCrntPMOPTMinValue=wchCrntPMOPTMinValue, wchXCSrcCpTypeIdx=wchXCSrcCpTypeIdx, olOSCExpFESysName=olOSCExpFESysName, olOSCCrntPMTable=olOSCCrntPMTable, olOSCCrntPMSEFSSTimeStamp=olOSCCrntPMSEFSSTimeStamp, olOSCHistPMUASSTimeStamp=olOSCHistPMUASSTimeStamp, olEqptShelfIdx=olEqptShelfIdx, olPortRemoteId=olPortRemoteId, olOSCEntry=olOSCEntry, wchRowStatus=wchRowStatus, olOSCCrntPMEntry=olOSCCrntPMEntry, olEqptSlotIdx=olEqptSlotIdx, olPortHistPMOPRValue=olPortHistPMOPRValue, olOSCFEIMMon=olOSCFEIMMon, eqptConnDstSlotIdx=eqptConnDstSlotIdx, wchXCDstCpTypeIdx=wchXCDstCpTypeIdx, olPortCrntPMOPRAvgValidity=olPortCrntPMOPRAvgValidity, olOSCCrntPMOBRTimeStamp=olOSCCrntPMOBRTimeStamp, olOSCLossOfFrameCond=olOSCLossOfFrameCond, olOSCPMThresholdLineIdx=olOSCPMThresholdLineIdx, olPortConnectionValidationTimeoutClear=olPortConnectionValidationTimeoutClear, wchCrntPMOPTMinValidity=wchCrntPMOPTMinValidity, olMib=olMib, olOSCCrntPMUASSValue=olOSCCrntPMUASSValue, olOSCHistPMESSValue=olOSCHistPMESSValue, wchCrntPMOPTMaxValidity=wchCrntPMOPTMaxValidity, olOSCOpticalBackReflOutOfSpecCond=olOSCOpticalBackReflOutOfSpecCond, wchCrntPMSlotIdx=wchCrntPMSlotIdx, olPortCrntPMOPRMinValidity=olPortCrntPMOPRMinValidity, olOSCPMThresholdSEFSSValue=olOSCPMThresholdSEFSSValue, wchXCSrcShelfIdx=wchXCSrcShelfIdx, wchCrntPMOPTValidity=wchCrntPMOPTValidity, olOSCCrntPMESSTimeStamp=olOSCCrntPMESSTimeStamp, olPortHistPMLossTxValue=olPortHistPMLossTxValue, olOSCCrntPMSEFSSInitialize=olOSCCrntPMSEFSSInitialize, wchHistPMEntry=wchHistPMEntry, olPortBackwardDefectIndClear=olPortBackwardDefectIndClear, olOSCCrntPMESSValue=olOSCCrntPMESSValue, wdmInvalidPreAmpOperCnfgClear=wdmInvalidPreAmpOperCnfgClear, olOSCHistPMUASSValue=olOSCHistPMUASSValue, olPortHistPMOPRValidity=olPortHistPMOPRValidity, olPortHistPMOPTMinTimeStamp=olPortHistPMOPTMinTimeStamp, olPortCrntPMOPRMinValue=olPortCrntPMOPRMinValue, wchCondNotifications=wchCondNotifications, olGroupMergeCmd=olGroupMergeCmd, olPortCrntPMIdx=olPortCrntPMIdx, olPortHistPMShelfIdx=olPortHistPMShelfIdx, olPortLossOfLightRxCond=olPortLossOfLightRxCond, olOSCCrntPMCVSTimeStamp=olOSCCrntPMCVSTimeStamp, olPortCrntPMOPRMinTimeStamp=olPortCrntPMOPRMinTimeStamp, wchHistPMOPRMaxTimeStamp=wchHistPMOPRMaxTimeStamp, olPortCrntPMOPTStdDevValue=olPortCrntPMOPTStdDevValue, olOSCHistPMShelfIdx=olOSCHistPMShelfIdx, olOSCHistPMOPTValidity=olOSCHistPMOPTValidity, wchCrntPMOPRMinValue=wchCrntPMOPRMinValue, olPortLossRxOutOfSpecCond=olPortLossRxOutOfSpecCond, olPortPayloadMissingIndCond=olPortPayloadMissingIndCond, olOSCEqlzContCommClear=olOSCEqlzContCommClear, olOSCSpanContCommClear=olOSCSpanContCommClear, olPortHistPMOPRTimeStamp=olPortHistPMOPRTimeStamp, wdmCondNotifications=wdmCondNotifications, wchCrntPMIdx=wchCrntPMIdx, olOSCHistPMESSInitialize=olOSCHistPMESSInitialize, wchXCDstPortIdx=wchXCDstPortIdx, wchPowerRxHighFailClear=wchPowerRxHighFailClear, wchPowerOutOfSpecRxHighCond=wchPowerOutOfSpecRxHighCond, olGroupCustom1=olGroupCustom1, wchHistPMIdx=wchHistPMIdx, wchAISCond=wchAISCond, olOSCAutoEnableTimer=olOSCAutoEnableTimer, olOSCCrntPMUASSInitialize=olOSCCrntPMUASSInitialize, wchCrntPMOPRMinTimeStamp=wchCrntPMOPRMinTimeStamp, wdmInvalidMidAmpOperCnfgCond=wdmInvalidMidAmpOperCnfgCond, olOSCFEGrp=olOSCFEGrp, olPortHistPMCpTypeIdx=olPortHistPMCpTypeIdx, olOSCHistPMOPRTimeStamp=olOSCHistPMOPRTimeStamp, wchHistPMOPRValidity=wchHistPMOPRValidity, olOSCEvtNotifications=olOSCEvtNotifications, olPortCrntPMIntervalTypeIdx=olPortCrntPMIntervalTypeIdx, wchHistPMIntervalTypeIdx=wchHistPMIntervalTypeIdx, wchSlotIdx=wchSlotIdx, eqptConnSrcPortTypeIdx=eqptConnSrcPortTypeIdx, olPortCrntPMOPRAvgValue=olPortCrntPMOPRAvgValue, wchPowerOutOfSpecRxLowCond=wchPowerOutOfSpecRxLowCond, olOSCHistPMCpTypeIdx=olOSCHistPMCpTypeIdx, olPortCrntPMOPRStdDevTimeStamp=olPortCrntPMOPRStdDevTimeStamp, wchCrntPMOPRMaxValidity=wchCrntPMOPRMaxValidity, olOSCCrntPMOBRValidity=olOSCCrntPMOBRValidity, wdmCustom2=wdmCustom2, wchCrntPMShelfIdx=wchCrntPMShelfIdx, olOSCHistPMCVSValidity=olOSCHistPMCVSValidity, olOSCCrntPMOBRValue=olOSCCrntPMOBRValue, wchCrntPMPortIdx=wchCrntPMPortIdx, olOSCPMThresholdTable=olOSCPMThresholdTable, olOSCCustom3=olOSCCustom3, olEqptGroupNum=olEqptGroupNum, olOSCHistPMOBRValue=olOSCHistPMOBRValue, olPortConnectionValidationTimeoutCond=olPortConnectionValidationTimeoutCond, odccShelfIdx=odccShelfIdx, olPortHistPMIntervalIdx=olPortHistPMIntervalIdx, wchCrntPMOPRValidity=wchCrntPMOPRValidity, olGroupCustom2=olGroupCustom2, olPortCustom2=olPortCustom2, olOSCLossOfLightTxClear=olOSCLossOfLightTxClear, olPortCrntPMOPTTimeStamp=olPortCrntPMOPTTimeStamp, olOSCCrntPMOPRValidity=olOSCCrntPMOPRValidity, olOSCFarEndIdMismatchClear=olOSCFarEndIdMismatchClear, olOSCCrntPMOPTValue=olOSCCrntPMOPTValue, olOSCCrntPMUASSValidity=olOSCCrntPMUASSValidity, olPortHistPMLossRxValue=olPortHistPMLossRxValue, olPortHistPMOPRMaxTimeStamp=olPortHistPMOPRMaxTimeStamp, wchStatusChangeEvt=wchStatusChangeEvt, olOSCHistPMUASSInitialize=olOSCHistPMUASSInitialize, olOSCStatusChangeEvt=olOSCStatusChangeEvt, olOSCOperStatus=olOSCOperStatus, wchCrntPMOPRMinValidity=wchCrntPMOPRMinValidity, olPortDWDMType=olPortDWDMType, olPortGrid=olPortGrid, olOSCPMThresholdIntervalTypeIdx=olOSCPMThresholdIntervalTypeIdx, wchXCDstShelfIdx=wchXCDstShelfIdx, wchPowerOutOfSpecRxHighClear=wchPowerOutOfSpecRxHighClear, olPortHistPMOPTMaxValidity=olPortHistPMOPTMaxValidity, olPortCrntPMOPRTimeStamp=olPortCrntPMOPRTimeStamp, olPortCrntPMOPRStdDevValue=olPortCrntPMOPRStdDevValue, OlGroupType=OlGroupType, olPortAPSDCond=olPortAPSDCond, olPortEntry=olPortEntry, olPortCrntPMOPTMaxTimeStamp=olPortCrntPMOPTMaxTimeStamp, olPortLossRxHighThClear=olPortLossRxHighThClear, olGroupMergeSecondary=olGroupMergeSecondary, olOSCHistPMOPRValue=olOSCHistPMOPRValue, wchPowerOutOfSpecRxLowClear=wchPowerOutOfSpecRxLowClear)
