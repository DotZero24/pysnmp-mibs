...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/bti/BTI-OL-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:25:05 2025
...
olEvtNotifications, condReportType, condSeverity, evtObjectType, condCodeType, tcaIntervalType, tcaValue, evtDescription, olCondNotifications, condServiceAffecting, tcaMontype, evtDateAndTime, condDescription, tcaDateAndTime, condObjectType, opticalLayer, condDateAndTime, tcaThreshold, trapSeqNum, evtCodeType = mibBuilder.importSymbols("BTI-7000-MIB", "olEvtNotifications", "condReportType", "condSeverity", "evtObjectType", "condCodeType", "tcaIntervalType", "tcaValue", "evtDescription", "olCondNotifications", "condServiceAffecting", "tcaMontype", "evtDateAndTime", "condDescription", "tcaDateAndTime", "condObjectType", "opticalLayer", "condDateAndTime", "tcaThreshold", "trapSeqNum", "evtCodeType")
btiModules, = mibBuilder.importSymbols("BTI-MIB", "btiModules")
FiberType, FixedX10, AdminStatus, OperStatQlfr, HoursAndMinutes, FixedX100, PMValidity, OperStatus, InitializeCmd, CpType, PMIntervalType, BERType = mibBuilder.importSymbols("BTI-TC-MIB", "FiberType", "FixedX10", "AdminStatus", "OperStatQlfr", "HoursAndMinutes", "FixedX100", "PMValidity", "OperStatus", "InitializeCmd", "CpType", "PMIntervalType", "BERType")
...
mibBuilder.exportSymbols("BTI-OL-MIB", odccLineIdx=odccLineIdx, olOSCCrntPMOPRValidity=olOSCCrntPMOPRValidity, olOSCPMThresholdEntry=olOSCPMThresholdEntry, olPortHistPMOPTStdDevValidity=olPortHistPMOPTStdDevValidity, wchHistPMPortIdx=wchHistPMPortIdx, wchHistPMSlotIdx=wchHistPMSlotIdx, wchCrntPMOPTMinValue=wchCrntPMOPTMinValue, olPortHistPMOPTValidity=olPortHistPMOPTValidity, wchCrntPMOPTMaxInitialize=wchCrntPMOPTMaxInitialize, olOSCHistPMSEFSSInitialize=olOSCHistPMSEFSSInitialize, wchHistPMTable=wchHistPMTable, olOSCSpanContCommClear=olOSCSpanContCommClear, wchHistPMOPRMinTimeStamp=wchHistPMOPRMinTimeStamp, wchPortIdx=wchPortIdx, olGroupIdx=olGroupIdx, olPortHistPMIntervalTypeIdx=olPortHistPMIntervalTypeIdx, wchFrequency=wchFrequency, olOSCPMThresholdIntervalTypeIdx=olOSCPMThresholdIntervalTypeIdx, olOSCCrntPMUASSValue=olOSCCrntPMUASSValue, olPortExpCnxDegree=olPortExpCnxDegree, olOSCFEGrpType=olOSCFEGrpType, wchHistPMOPRValidity=wchHistPMOPRValidity, wchPowerOutOfSpecRxHighClear=wchPowerOutOfSpecRxHighClear, wchHistPMOPRMinValue=wchHistPMOPRMinValue, olOSCSpanContCommCond=olOSCSpanContCommCond, olOSCHistPMSlotIdx=olOSCHistPMSlotIdx, olPortCrntPMTable=olPortCrntPMTable, olOSCLossOfFrameCond=olOSCLossOfFrameCond, wchPowerRxHighFailCond=wchPowerRxHighFailCond, olPortCrntPMOPRStdDevValue=olPortCrntPMOPRStdDevValue, wchCrntPMPortTypeIdx=wchCrntPMPortTypeIdx, wchPowerOutOfSpecRxClear=wchPowerOutOfSpecRxClear, olPortTable=olPortTable, olPortHistPMOPTValue=olPortHistPMOPTValue, wchCrntPMOPRMinInitialize=wchCrntPMOPRMinInitialize, wchPowerRxHighFailClear=wchPowerRxHighFailClear, olPortHistPMInitializeAll=olPortHistPMInitializeAll, wchHistPMOPRMaxValidity=wchHistPMOPRMaxValidity, wchHistPMOPTMinValidity=wchHistPMOPTMinValidity, olOSCFEDegr=olOSCFEDegr, olOSCHistPMESSTimeStamp=olOSCHistPMESSTimeStamp, olOSCHistPMIntervalTypeIdx=olOSCHistPMIntervalTypeIdx, olPortRowStatus=olPortRowStatus, olOSCOpticalBackReflOutOfSpecClear=olOSCOpticalBackReflOutOfSpecClear, olPortCrntPMShelfIdx=olPortCrntPMShelfIdx, olPortConnectionMismatchCond=olPortConnectionMismatchCond, wchCrntPMOPTTimeStamp=wchCrntPMOPTTimeStamp, olOSCOperStatQlfr=olOSCOperStatQlfr, wchHistPMOPTMaxValue=wchHistPMOPTMaxValue, wchLossOfLightTxClear=wchLossOfLightTxClear, olOSCCrntPMESSInitialize=olOSCCrntPMESSInitialize, wchXCDstCpTypeIdx=wchXCDstCpTypeIdx, wchXCDstChannelIdx=wchXCDstChannelIdx, olGroupCustom2=olGroupCustom2, olOSCEvtNotifications=olOSCEvtNotifications, olOSCCrntPMSESSValidity=olOSCCrntPMSESSValidity, wchHistPMOPRMaxValue=wchHistPMOPRMaxValue, olPortRemoteId=olPortRemoteId, olGroupEntry=olGroupEntry, wdmNumChannels=wdmNumChannels, olOSCCrntPMSESSInitialize=olOSCCrntPMSESSInitialize, wchPortTypeIdx=wchPortTypeIdx, wdmSpanLossSpecMax=wdmSpanLossSpecMax, eqptConnSrcCpTypeIdx=eqptConnSrcCpTypeIdx, olOSCPMThresholdCpTypeIdx=olOSCPMThresholdCpTypeIdx, wchPowerOutOfSpecRxLowCond=wchPowerOutOfSpecRxLowCond, olOSCPMThresholdESSValue=olOSCPMThresholdESSValue, olOSCCrntPMSEFSSInitialize=olOSCCrntPMSEFSSInitialize, OlPortType=OlPortType, wchEvtNotifications=wchEvtNotifications, wdmRowStatus=wdmRowStatus, olPortHistPMIdx=olPortHistPMIdx, olPortBackwardDefectIndClear=olPortBackwardDefectIndClear, olOSCHistPMCVSValue=olOSCHistPMCVSValue, olOSCHistPMEntry=olOSCHistPMEntry, olOSCHistPMCpTypeIdx=olOSCHistPMCpTypeIdx, wchHistPMIntervalIdx=wchHistPMIntervalIdx, wchXCDstPortIdx=wchXCDstPortIdx, olPortTypeIdx=olPortTypeIdx, wdmInvalidPreAmpOperCnfgClear=wdmInvalidPreAmpOperCnfgClear, olPortCrntPMOPTMaxValue=olPortCrntPMOPTMaxValue, eqptConnTable=eqptConnTable, wchXCSrcCpTypeIdx=wchXCSrcCpTypeIdx, olOSCFarEndNodeCnfgInconsistentClear=olOSCFarEndNodeCnfgInconsistentClear, olPortCrntPMOPTTimeStamp=olPortCrntPMOPTTimeStamp, wchCrntPMOPTMinTimeStamp=wchCrntPMOPTMinTimeStamp, olOSCHistPMOBRTimeStamp=olOSCHistPMOBRTimeStamp, wchHistPMPortTypeIdx=wchHistPMPortTypeIdx, olOSCCrntPMCVSTimeStamp=olOSCCrntPMCVSTimeStamp, olGroupCustom3=olGroupCustom3, olOSCPMThresholdSESSValue=olOSCPMThresholdSESSValue, olPortHistPMLossRxValidity=olPortHistPMLossRxValidity, olPortHistPMOPRValue=olPortHistPMOPRValue, olPortFrequency=olPortFrequency, wchWavelength=wchWavelength, olPortHistPMOPRMinValue=olPortHistPMOPRMinValue, olGroupCustom1=olGroupCustom1, olOSCHistPMOBRValidity=olOSCHistPMOBRValidity, olPortHistPMLossTxValue=olPortHistPMLossTxValue, olPortStatusChangeEvt=olPortStatusChangeEvt, olOSCCrntPMOBRValidity=olOSCCrntPMOBRValidity, wchCrntPMOPTMinValidity=wchCrntPMOPTMinValidity, olPortLossRxOutOfSpecCond=olPortLossRxOutOfSpecCond, eqptConnDstPortTypeIdx=eqptConnDstPortTypeIdx, olPortHistPMOPTMaxValidity=olPortHistPMOPTMaxValidity, olPortConnectionValidationTimeoutCond=olPortConnectionValidationTimeoutCond, wchCrntPMSlotIdx=wchCrntPMSlotIdx, olOSCCrntPMUASSValidity=olOSCCrntPMUASSValidity, wdmInvalidMidAmpOperCnfgCond=wdmInvalidMidAmpOperCnfgCond, olOSCShelfIdx=olOSCShelfIdx, wchCrntPMOPRMaxValidity=wchCrntPMOPRMaxValidity, odccTable=odccTable, olOSCTable=olOSCTable, wchPowerOutOfSpecTxCond=wchPowerOutOfSpecTxCond, olGroupMergePrimary=olGroupMergePrimary, wchHistPMIdx=wchHistPMIdx, olPortCrntPMOPRMinTimeStamp=olPortCrntPMOPRMinTimeStamp, wdmInvalidPreAmpOperCnfgCond=wdmInvalidPreAmpOperCnfgCond, olOSCHistPMSESSValue=olOSCHistPMSESSValue, olOSCCrntPMLineIdx=olOSCCrntPMLineIdx, wchRowStatus=wchRowStatus, olOSCCrntPMOPRTimeStamp=olOSCCrntPMOPRTimeStamp, wchHistPMOPRMaxInitialize=wchHistPMOPRMaxInitialize, wchShelfIdx=wchShelfIdx, olOSCCrntPMOBRTimeStamp=olOSCCrntPMOBRTimeStamp, eqptConnRowStatus=eqptConnRowStatus, olPortCrntPMOPRStdDevTimeStamp=olPortCrntPMOPRStdDevTimeStamp, olOSCCrntPMCVSInitialize=olOSCCrntPMCVSInitialize, olPortHistPMOPRStdDevValue=olPortHistPMOPRStdDevValue, olPortCrntPMOPTMinTimeStamp=olPortCrntPMOPTMinTimeStamp, olOSCEqlzContCommCond=olOSCEqlzContCommCond, olPortCrntPMOPTStdDevValidity=olPortCrntPMOPTStdDevValidity, wchHistPMOPRMaxTimeStamp=wchHistPMOPRMaxTimeStamp, eqptConnSrcIdx=eqptConnSrcIdx, olPortCrntPMIdx=olPortCrntPMIdx, olOSCCrntPMSESSValue=olOSCCrntPMSESSValue, wchCrntPMPortIdx=wchCrntPMPortIdx, wchPowerOutOfSpecRxHighCond=wchPowerOutOfSpecRxHighCond, wdmLineIdx=wdmLineIdx, olPortWavelength=olPortWavelength, olOSCHistPMOPTTimeStamp=olOSCHistPMOPTTimeStamp, olEqptGroupNum=olEqptGroupNum, olPortCrntPMOPTMinValue=olPortCrntPMOPTMinValue, olPortOperStatus=olPortOperStatus, olPortHistPMLossTxTimeStamp=olPortHistPMLossTxTimeStamp, olPortLossOfLightRxCond=olPortLossOfLightRxCond, olOSCId=olOSCId, wchCustom2=wchCustom2, olOSCHistPMOPTValue=olOSCHistPMOPTValue, PYSNMP_MODULE_ID=olMib, olOSCAdminStatus=olOSCAdminStatus, olPortHistPMOPTAvgValidity=olPortHistPMOPTAvgValidity, wchCrntPMCpTypeIdx=wchCrntPMCpTypeIdx, wdmAutoEnableTimer=wdmAutoEnableTimer, wchTable=wchTable, olPortHistPMOPRMaxValidity=olPortHistPMOPRMaxValidity, olOSCHistPMSEFSSValidity=olOSCHistPMSEFSSValidity, eqptConnSrcSlotIdx=eqptConnSrcSlotIdx, wdmFiberType=wdmFiberType, wchHistPMOPRMinValidity=wchHistPMOPRMinValidity, wdmInvalidBoostAmpOperCnfgCond=wdmInvalidBoostAmpOperCnfgCond, wchCrntPMOPTMaxValidity=wchCrntPMOPTMaxValidity, olOSCHistPMCVSValidity=olOSCHistPMCVSValidity, olEqptSlotIdx=olEqptSlotIdx, wchOperStatus=wchOperStatus, wchIdx=wchIdx, olOSCCrntPMCVSValidity=olOSCCrntPMCVSValidity, olPortHistPMShelfIdx=olPortHistPMShelfIdx, olOSCHistPMUASSInitialize=olOSCHistPMUASSInitialize, wchGrid=wchGrid, olPortCrntPMOPTValue=olPortCrntPMOPTValue, wchCrntPMOPRTimeStamp=wchCrntPMOPRTimeStamp, olPortPayloadMissingIndCond=olPortPayloadMissingIndCond, wchLossOfLightTxCond=wchLossOfLightTxCond, wchCrntPMEntry=wchCrntPMEntry, olPortCrntPMInitializeAll=olPortCrntPMInitializeAll, olOSCCrntPMOPTValidity=olOSCCrntPMOPTValidity, olPortHistPMCpTypeIdx=olPortHistPMCpTypeIdx, olOSCOperStatus=olOSCOperStatus, olPortHistPMOPRMaxValue=olPortHistPMOPRMaxValue, olOSCPMThresholdLineIdx=olOSCPMThresholdLineIdx, olPortHistPMOPTMinValidity=olPortHistPMOPTMinValidity, odccAdminStatus=odccAdminStatus, wchXCSrcPortTypeIdx=wchXCSrcPortTypeIdx, olOSCExpFESysName=olOSCExpFESysName, olPortHistPMOPRMinValidity=olPortHistPMOPRMinValidity, olOSCCrntPMSlotIdx=olOSCCrntPMSlotIdx, olPortHistPMIntervalIdx=olPortHistPMIntervalIdx, olOSCHistPMSEFSSTimeStamp=olOSCHistPMSEFSSTimeStamp, olPortHistPMOPRAvgValidity=olPortHistPMOPRAvgValidity, wdmInvalidBoostAmpOperCnfgClear=wdmInvalidBoostAmpOperCnfgClear, wchStatusChangeEvt=wchStatusChangeEvt, olOSCCrntPMUASSTimeStamp=olOSCCrntPMUASSTimeStamp, olPortCrntPMOPTAvgValidity=olPortCrntPMOPTAvgValidity, wchCrntPMIdx=wchCrntPMIdx, olPortHistPMOPTMaxTimeStamp=olPortHistPMOPTMaxTimeStamp, olOSCCustom2=olOSCCustom2, olPortCrntPMOPTMaxTimeStamp=olPortCrntPMOPTMaxTimeStamp, wdmShelfIdx=wdmShelfIdx, wchCrntPMOPRValidity=wchCrntPMOPRValidity, olOSCHistPMUASSTimeStamp=olOSCHistPMUASSTimeStamp, olPortCrntPMOPTValidity=olPortCrntPMOPTValidity, olPortLossRxHighThClear=olPortLossRxHighThClear, olOSCLossOfFrameClear=olOSCLossOfFrameClear, olOSCFarEndIdMismatchClear=olOSCFarEndIdMismatchClear, wdmCustom2=wdmCustom2, olPortConnectionValidationTimeoutClear=olPortConnectionValidationTimeoutClear, eqptConnType=eqptConnType, wchId=wchId, wdmCustom1=wdmCustom1, wchOperStatQlfr=wchOperStatQlfr, olPortCrntPMLossRxValidity=olPortCrntPMLossRxValidity, olPortCustom3=olPortCustom3, wchLossOfLightRxClear=wchLossOfLightRxClear, olPortHistPMOPTAvgValue=olPortHistPMOPTAvgValue, olGroupMergeSecondary=olGroupMergeSecondary, olPortPowerOutOfSpecRxCond=olPortPowerOutOfSpecRxCond, olPortBackwardDefectIndCond=olPortBackwardDefectIndCond, olPortCrntPMLossRxValue=olPortCrntPMLossRxValue, wchCpTypeIdx=wchCpTypeIdx, olPortHistPMSlotIdx=olPortHistPMSlotIdx, olOSCFarEndIdMismatchCond=olOSCFarEndIdMismatchCond, olPortPowerOutOfSpecRxClear=olPortPowerOutOfSpecRxClear, olPortCrntPMOPTMinValidity=olPortCrntPMOPTMinValidity, wchXCSrcPortIdx=wchXCSrcPortIdx, olOSCCrntPMUASSInitialize=olOSCCrntPMUASSInitialize, olOSCFESysName=olOSCFESysName, olOSCCrntPMOPRValue=olOSCCrntPMOPRValue, olOSCCrntPMSEFSSTimeStamp=olOSCCrntPMSEFSSTimeStamp, olPortHistPMOPRValidity=olPortHistPMOPRValidity, olPortEntry=olPortEntry, olPortHistPMOPTMinValue=olPortHistPMOPTMinValue, olOSCOpticalBackReflOutOfSpecCond=olOSCOpticalBackReflOutOfSpecCond, olMib=olMib, olOSCCrntPMSEFSSValue=olOSCCrntPMSEFSSValue, wchXCSrcShelfIdx=wchXCSrcShelfIdx, wchActAutoEnableTimer=wchActAutoEnableTimer, olOSCHistPMUASSValue=olOSCHistPMUASSValue, olPortCrntPMOPRMaxValidity=olPortCrntPMOPRMaxValidity, olPortCrntPMOPRAvgValue=olPortCrntPMOPRAvgValue, olOSCHistPMIntervalIdx=olOSCHistPMIntervalIdx, olOSCHistPMOPTValidity=olOSCHistPMOPTValidity, eqptConnSrcShelfIdx=eqptConnSrcShelfIdx, olOSCHistPMESSValue=olOSCHistPMESSValue, olPortIdx=olPortIdx, olOSCFEIMMon=olOSCFEIMMon, wchCrntPMOPRMaxTimeStamp=wchCrntPMOPRMaxTimeStamp, wdmActAutoEnableTimer=wdmActAutoEnableTimer, olPortCrntPMSlotIdx=olPortCrntPMSlotIdx, olOSCCrntPMCVSValue=olOSCCrntPMCVSValue, olOSCCrntPMSESSTimeStamp=olOSCCrntPMSESSTimeStamp, wchAISClear=wchAISClear, wdmOperStatQlfr=wdmOperStatQlfr, olOSCCrntPMSEFSSValidity=olOSCCrntPMSEFSSValidity)
mibBuilder.exportSymbols("BTI-OL-MIB", olOSCHistPMESSInitialize=olOSCHistPMESSInitialize, olOSCCondNotifications=olOSCCondNotifications, olOSCExpFEIPAddr=olOSCExpFEIPAddr, olPortCrntPMOPRStdDevValidity=olPortCrntPMOPRStdDevValidity, wchXCDstShelfIdx=wchXCDstShelfIdx, olOSCHistPMSEFSSValue=olOSCHistPMSEFSSValue, wchCrntPMTable=wchCrntPMTable, olPortCrntPMOPTStdDevValue=olPortCrntPMOPTStdDevValue, olOSCTcaEvt=olOSCTcaEvt, wchCrntPMOPRMinValidity=wchCrntPMOPRMinValidity, olOSCPMThresholdSlotIdx=olOSCPMThresholdSlotIdx, wdmTable=wdmTable, olPortHistPMLossRxValue=olPortHistPMLossRxValue, eqptConnDstSlotIdx=eqptConnDstSlotIdx, olPortCrntPMOPRValidity=olPortCrntPMOPRValidity, olOSCPMThresholdSEFSSValue=olOSCPMThresholdSEFSSValue, wchHistPMShelfIdx=wchHistPMShelfIdx, wchHistPMOPTMaxInitialize=wchHistPMOPTMaxInitialize, olOSCPMThresholdUASSValue=olOSCPMThresholdUASSValue, olGroupMergeCmd=olGroupMergeCmd, wchCondNotifications=wchCondNotifications, eqptConnSrcPortTypeIdx=eqptConnSrcPortTypeIdx, olPortCrntPMOPTStdDevTimeStamp=olPortCrntPMOPTStdDevTimeStamp, wchSlotIdx=wchSlotIdx, olGroupMerge=olGroupMerge, olPortCondNotifications=olPortCondNotifications, olPortChannelCountDeficiencyCond=olPortChannelCountDeficiencyCond, olPortCrntPMOPRTimeStamp=olPortCrntPMOPRTimeStamp, olGroupType=olGroupType, olPortCrntPMTypeIdx=olPortCrntPMTypeIdx, olOSCHistPMOPRTimeStamp=olOSCHistPMOPRTimeStamp, olPortShelfIdx=olPortShelfIdx, olOSCCustom3=olOSCCustom3, olOSCCrntPMShelfIdx=olOSCCrntPMShelfIdx, wchHistPMOPTMinTimeStamp=wchHistPMOPTMinTimeStamp, olOSCCrntPMESSValidity=olOSCCrntPMESSValidity, olOSCHistPMESSValidity=olOSCHistPMESSValidity, olOSCCrntPMESSValue=olOSCCrntPMESSValue, olOSCCrntPMESSTimeStamp=olOSCCrntPMESSTimeStamp, olOSCCustom1=olOSCCustom1, wchLossOfLightRxCond=wchLossOfLightRxCond, wdmSlotIdx=wdmSlotIdx, olPortHistPMEntry=olPortHistPMEntry, olEqptTable=olEqptTable, olPortAPSDClear=olPortAPSDClear, olEqptCpTypeIdx=olEqptCpTypeIdx, olPortCrntPMOPRMinValue=olPortCrntPMOPRMinValue, olOSCLineIdx=olOSCLineIdx, olPortHistPMOPTStdDevTimeStamp=olPortHistPMOPTStdDevTimeStamp, wchCrntPMOPTMinInitialize=wchCrntPMOPTMinInitialize, odccEntry=odccEntry, olPortLossRxOutOfSpecClear=olPortLossRxOutOfSpecClear, olPortCrntPMLossRxTimeStamp=olPortCrntPMLossRxTimeStamp, olEqptShelfIdx=olEqptShelfIdx, wchXCSrcSlotIdx=wchXCSrcSlotIdx, olOSCCrntPMOBRValue=olOSCCrntPMOBRValue, wchCrntPMOPTMaxValue=wchCrntPMOPTMaxValue, olPortPayloadMissingIndClear=olPortPayloadMissingIndClear, olPortCustom1=olPortCustom1, olGroupTable=olGroupTable, olOSCActAutoEnableTimer=olOSCActAutoEnableTimer, olPortCrntPMOPRMaxValue=olPortCrntPMOPRMaxValue, wchHistPMEntry=wchHistPMEntry, olPortHistPMOPTMinTimeStamp=olPortHistPMOPTMinTimeStamp, wchAdminStatus=wchAdminStatus, olPortCrntPMCpTypeIdx=olPortCrntPMCpTypeIdx, olOSCCrntPMOPTTimeStamp=olOSCCrntPMOPTTimeStamp, odccShelfIdx=odccShelfIdx, olOSCPMThresholdCVSValue=olOSCPMThresholdCVSValue, olOSCLossOfLightTxCond=olOSCLossOfLightTxCond, wchHistPMOPRValue=wchHistPMOPRValue, olOSCCrntPMIntervalTypeIdx=olOSCCrntPMIntervalTypeIdx, olPortOperStatQlfr=olPortOperStatQlfr, olPortCrntPMOPTMaxValidity=olPortCrntPMOPTMaxValidity, wchCrntPMOPTMaxTimeStamp=wchCrntPMOPTMaxTimeStamp, olPortGrid=olPortGrid, olPortAPSDCond=olPortAPSDCond, olPortCrntPMLossTxValue=olPortCrntPMLossTxValue, olOSCOpticalBackReflHighThClear=olOSCOpticalBackReflHighThClear, wchCrntPMOPTValidity=wchCrntPMOPTValidity, wchPowerOutOfSpecTxClear=wchPowerOutOfSpecTxClear, olPerformance=olPerformance, wchCustom1=wchCustom1, olOSCHistPMTable=olOSCHistPMTable, olOSCHistPMShelfIdx=olOSCHistPMShelfIdx, olOSCEqlzContCommClear=olOSCEqlzContCommClear, olPortCrntPMOPRMinValidity=olPortCrntPMOPRMinValidity, eqptConnEntry=eqptConnEntry, odccSlotIdx=odccSlotIdx, olPortHistPMOPRTimeStamp=olPortHistPMOPRTimeStamp, olOSCHistPMOPRValidity=olOSCHistPMOPRValidity, wchEntry=wchEntry, wchAISCond=wchAISCond, wchCrntPMOPRMinTimeStamp=wchCrntPMOPRMinTimeStamp, olPortCrntPMLossTxValidity=olPortCrntPMLossTxValidity, wchHistPMIntervalTypeIdx=wchHistPMIntervalTypeIdx, olOSCPMThresholdShelfIdx=olOSCPMThresholdShelfIdx, olPortHistPMOPRMinTimeStamp=olPortHistPMOPRMinTimeStamp, olPortHistPMOPRStdDevTimeStamp=olPortHistPMOPRStdDevTimeStamp, olOSCLossOfLightRxCond=olOSCLossOfLightRxCond, olOSCStatusChangeEvt=olOSCStatusChangeEvt, wchXCServiceName=wchXCServiceName, olOSCHistPMSESSInitialize=olOSCHistPMSESSInitialize, wchHistPMOPTTimeStamp=wchHistPMOPTTimeStamp, wchUnequippedClear=wchUnequippedClear, olPortCpTypeIdx=olPortCpTypeIdx, olPortId=olPortId, wdmCpTypeIdx=wdmCpTypeIdx, wchXCDstPortTypeIdx=wchXCDstPortTypeIdx, olPortHistPMOPRAvgValue=olPortHistPMOPRAvgValue, olOSCPMThresholdTable=olOSCPMThresholdTable, olOSCLossOfLightRxClear=olOSCLossOfLightRxClear, wdmCustom3=wdmCustom3, olPortHistPMOPTTimeStamp=olPortHistPMOPTTimeStamp, wdmSpanLength=wdmSpanLength, olPortHistPMOPRMaxTimeStamp=olPortHistPMOPRMaxTimeStamp, wchHistPMOPRMinInitialize=wchHistPMOPRMinInitialize, wchXCSrcChannelIdx=wchXCSrcChannelIdx, olOSCAutoEnableTimer=olOSCAutoEnableTimer, olOSCEntry=olOSCEntry, olPortHistPMTypeIdx=olPortHistPMTypeIdx, olEqptEntry=olEqptEntry, wchHistPMOPTMinValue=wchHistPMOPTMinValue, olPortCrntPMLossTxTimeStamp=olPortCrntPMLossTxTimeStamp, olOSCCrntPMCpTypeIdx=olOSCCrntPMCpTypeIdx, wdmEntry=wdmEntry, odccCpTypeIdx=odccCpTypeIdx, wdmOperStatus=wdmOperStatus, olPortSlotIdx=olPortSlotIdx, olPortDWDMType=olPortDWDMType, wdmStatusChangeEvt=wdmStatusChangeEvt, wchPowerOutOfSpecRxLowClear=wchPowerOutOfSpecRxLowClear, olOSCCrntPMOPTValue=olOSCCrntPMOPTValue, wchCrntPMOPRMaxValue=wchCrntPMOPRMaxValue, olOSCCrntPMEntry=olOSCCrntPMEntry, olGroupId=olGroupId, olOSCHistPMUASSValidity=olOSCHistPMUASSValidity, olPortCrntPMOPTAvgValue=olPortCrntPMOPTAvgValue, olPortEvtNotifications=olPortEvtNotifications, olOSCExpFEGrp=olOSCExpFEGrp, olOSCRowStatus=olOSCRowStatus, olOSCFEGrp=olOSCFEGrp, wchCrntPMOPRValue=wchCrntPMOPRValue, olOSCFEIPAddr=olOSCFEIPAddr, eqptConnDstIdx=eqptConnDstIdx, olPortHistPMOPTAvgTimeStamp=olPortHistPMOPTAvgTimeStamp, olOSCFarEndNodeCnfgInconsistentCond=olOSCFarEndNodeCnfgInconsistentCond, olOSCExpFEDegr=olOSCExpFEDegr, olOSCLossOfLightTxClear=olOSCLossOfLightTxClear, wchCustom3=wchCustom3, odccRowStatus=odccRowStatus, wchHistPMOPTValidity=wchHistPMOPTValidity, wdmId=wdmId, olPortLossRxHighThCond=olPortLossRxHighThCond, olPortCrntPMOPRValue=olPortCrntPMOPRValue, olPortHistPMOPTStdDevValue=olPortHistPMOPTStdDevValue, eqptConnDstShelfIdx=eqptConnDstShelfIdx, wdmSpanLossRxHighTh=wdmSpanLossRxHighTh, olGroupRowStatus=olGroupRowStatus, olOSCOpticalBackReflHighThCond=olOSCOpticalBackReflHighThCond, olPortCrntPMOPRAvgTimeStamp=olPortCrntPMOPRAvgTimeStamp, wdmCondNotifications=wdmCondNotifications, olOSCCpTypeIdx=olOSCCpTypeIdx, olPortHistPMLossTxValidity=olPortHistPMLossTxValidity, olPortLossOfLightRxClear=olPortLossOfLightRxClear, olPortCrntPMOPRMaxTimeStamp=olPortCrntPMOPRMaxTimeStamp, wchHistPMCpTypeIdx=wchHistPMCpTypeIdx, wchXCRowStatus=wchXCRowStatus, olPortHistPMOPTMaxValue=olPortHistPMOPTMaxValue, olPortChannelCountDeficiencyClear=olPortChannelCountDeficiencyClear, olEqptDegreeNum=olEqptDegreeNum, wchXCDstSlotIdx=wchXCDstSlotIdx, olPortCustom2=olPortCustom2, eqptConnDstCpTypeIdx=eqptConnDstCpTypeIdx, OlGroupType=OlGroupType, wdmEvtNotifications=wdmEvtNotifications, wchCrntPMOPRMaxInitialize=wchCrntPMOPRMaxInitialize, wchCrntPMOPRMinValue=wchCrntPMOPRMinValue, olOSCHistPMOPRValue=olOSCHistPMOPRValue, wchHistPMOPTValue=wchHistPMOPTValue, wchHistPMOPTMaxValidity=wchHistPMOPTMaxValidity, olPortHistPMLossRxTimeStamp=olPortHistPMLossRxTimeStamp, olOSCSlotIdx=olOSCSlotIdx, olPortActCnxDegree=olPortActCnxDegree, olPortCrntPMOPRAvgValidity=olPortCrntPMOPRAvgValidity, wdmAdminStatus=wdmAdminStatus, olOSCCrntPMTable=olOSCCrntPMTable, wchHistPMOPRTimeStamp=wchHistPMOPRTimeStamp, wchPowerOutOfSpecRxCond=wchPowerOutOfSpecRxCond, olPortHistPMOPRAvgTimeStamp=olPortHistPMOPRAvgTimeStamp, olOSCHistPMOBRValue=olOSCHistPMOBRValue, olPortHistPMTable=olPortHistPMTable, olOSCHistPMCVSTimeStamp=olOSCHistPMCVSTimeStamp, wchBitrate=wchBitrate, olOSCHistPMSESSValidity=olOSCHistPMSESSValidity, olPortCrntPMOPTAvgTimeStamp=olPortCrntPMOPTAvgTimeStamp, wchXCEntry=wchXCEntry, olPortConnectionMismatchClear=olPortConnectionMismatchClear, olPortHistPMOPRStdDevValidity=olPortHistPMOPRStdDevValidity, olOSCHistPMSESSTimeStamp=olOSCHistPMSESSTimeStamp, olOSCHistPMCVSInitialize=olOSCHistPMCVSInitialize, olPortCrntPMIntervalTypeIdx=olPortCrntPMIntervalTypeIdx, wchXCTable=wchXCTable, olOSCHistPMLineIdx=olOSCHistPMLineIdx, wchUnequippedCond=wchUnequippedCond, olEqptRowStatus=olEqptRowStatus, wchCrntPMShelfIdx=wchCrntPMShelfIdx, olPortCrntPMEntry=olPortCrntPMEntry, wchCrntPMIntervalTypeIdx=wchCrntPMIntervalTypeIdx, wchHistPMOPTMinInitialize=wchHistPMOPTMinInitialize, wchCrntPMOPTValue=wchCrntPMOPTValue, wdmInvalidMidAmpOperCnfgClear=wdmInvalidMidAmpOperCnfgClear, wchHistPMOPTMaxTimeStamp=wchHistPMOPTMaxTimeStamp, wchAutoEnableTimer=wchAutoEnableTimer)
