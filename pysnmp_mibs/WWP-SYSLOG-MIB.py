...
mibBuilder.exportSymbols("WWP-SYSLOG-MIB", PYSNMP_MODULE_ID=wwpSyslogMib, wwpSyslogServerCustomPrefix=wwpSyslogServerCustomPrefix, wwpSyslogMib=wwpSyslogMib, wwpSyslogServerPort=wwpSyslogServerPort, wwpSyslogServerIPAddress=wwpSyslogServerIPAddress, wwpSyslogServerStatus=wwpSyslogServerStatus, wwpSyslogServerIndex=wwpSyslogServerIndex, wwpSyslog=wwpSyslog, wwpSyslogServerTable=wwpSyslogServerTable, wwpSyslogObjects=wwpSyslogObjects, wwpSyslogSeverity=wwpSyslogSeverity, wwpSyslogServerEntry=wwpSyslogServerEntry)
