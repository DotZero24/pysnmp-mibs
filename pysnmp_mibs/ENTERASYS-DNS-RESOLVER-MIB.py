...
mibBuilder.exportSymbols("ENTERASYS-DNS-RESOLVER-MIB", etsysDnsResolverQuaternaryServerAddr=etsysDnsResolverQuaternaryServerAddr, etsysDnsResolverIpv4DnsZone=etsysDnsResolverIpv4DnsZone, etsysDnsResolverTertiaryServerAddrType=etsysDnsResolverTertiaryServerAddrType, etsysDnsResolverGroups=etsysDnsResolverGroups, etsysDnsResolverEnableStatus=etsysDnsResolverEnableStatus, etsysDnsResolverCompliances=etsysDnsResolverCompliances, etsysDnsResolverQueryRetries=etsysDnsResolverQueryRetries, etsysDnsResolverSystem=etsysDnsResolverSystem, etsysDnsResolverPrimaryServerAddrType=etsysDnsResolverPrimaryServerAddrType, etsysDnsResolverQuaternaryGroup=etsysDnsResolverQuaternaryGroup, etsysDnsResolverDomainName=etsysDnsResolverDomainName, etsysDnsResolverObjects=etsysDnsResolverObjects, etsysDnsResolverServerPortNumber=etsysDnsResolverServerPortNumber, etsysDnsResolverPrimaryServerAddr=etsysDnsResolverPrimaryServerAddr, etsysDnsResolverServiceType=etsysDnsResolverServiceType, etsysDnsResolverMIB=etsysDnsResolverMIB, etsysDnsResolverIpv6DnsZone=etsysDnsResolverIpv6DnsZone, etsysDnsResolverSecondaryServerAddr=etsysDnsResolverSecondaryServerAddr, etsysDnsResolverSecondaryGroup=etsysDnsResolverSecondaryGroup, etsysDnsResolverQueryTimeout=etsysDnsResolverQueryTimeout, etsysDnsResolverSecondaryServerAddrType=etsysDnsResolverSecondaryServerAddrType, etsysDnsResolverConformance=etsysDnsResolverConformance, PYSNMP_MODULE_ID=etsysDnsResolverMIB, etsysDnsResolverPrimaryGroup=etsysDnsResolverPrimaryGroup, etsysDnsResolverTertiaryGroup=etsysDnsResolverTertiaryGroup, etsysDnsResolverCompliance=etsysDnsResolverCompliance, etsysDnsResolverTertiaryServerAddr=etsysDnsResolverTertiaryServerAddr, etsysDnsResolverQuaternaryServerAddrType=etsysDnsResolverQuaternaryServerAddrType)
