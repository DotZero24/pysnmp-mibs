...
mibBuilder.exportSymbols("MITEL-MIB", mitelIdInterfaces=mitelIdInterfaces, mitelPropCommon=mitelPropCommon, mitelPropApplications=mitelPropApplications, mitelIdTerminals=mitelIdTerminals, mitelComplMitel=mitelComplMitel, PYSNMP_MODULE_ID=mitel, mitelPropUtilities=mitelPropUtilities, mitelIdMgmtPlatforms=mitelIdMgmtPlatforms, mitelIfTblType=mitelIfTblType, mitelExtensions=mitelExtensions, mitelIdCsMc2=mitelIdCsMc2, mitelPropHardware=mitelPropHardware, mitel=mitel, mitelConfGroups=mitelConfGroups, mitelIfTable=mitelIfTable, mitelGrpCmnInterfaces=mitelGrpCmnInterfaces, mitelIdCtiPlatforms=mitelIdCtiPlatforms, mitelIdCsIpera3000=mitelIdCsIpera3000, mitelGrpCs2000=mitelGrpCs2000, mitelGrpCommon=mitelGrpCommon, mitelPropNotifications=mitelPropNotifications, mitelConfAgents=mitelConfAgents, mitelConformance=mitelConformance, mitelIdApplicationPlatforms=mitelIdApplicationPlatforms, MitelIfType=MitelIfType, mitelIdCs2000Light=mitelIdCs2000Light, mitelConfCompliances=mitelConfCompliances, mitelIdentification=mitelIdentification, mitelIdCallServers=mitelIdCallServers, mitelExperimental=mitelExperimental, mitelAppCallServer=mitelAppCallServer, mitelProprietary=mitelProprietary, mitelIfNumber=mitelIfNumber, mitelGrpIpera3000=mitelGrpIpera3000, mitelPropProtocols=mitelPropProtocols, mitelIfTableEntry=mitelIfTableEntry, mitelPropReset=mitelPropReset, mitelPropTransmission=mitelPropTransmission, MitelNotifyTransportType=MitelNotifyTransportType, mitelExtInterfaces=mitelExtInterfaces)
