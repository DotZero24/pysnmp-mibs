...
mibBuilder.exportSymbols("CISCO-FC-SPAN-MIB", cspanSessionIndex=cspanSessionIndex, cspanVsanFilterVsans2k=cspanVsanFilterVsans2k, SessionIndex=SessionIndex, PYSNMP_MODULE_ID=ciscoFcSpanMIB, cspanSourcesVsanCfgTable=cspanSourcesVsanCfgTable, cspanSourcesVsanCfgVsans2k=cspanSourcesVsanCfgVsans2k, cspanSessionRowStatus=cspanSessionRowStatus, cspanVsanFilterOpEntry=cspanVsanFilterOpEntry, cspanSourcesIfEntry=cspanSourcesIfEntry, ciscoFcSpanMIBGroups=ciscoFcSpanMIBGroups, ciscoFcSpanMIB=ciscoFcSpanMIB, cspanSourceVsanCfgGroup=cspanSourceVsanCfgGroup, cspanSessionInactiveReason=cspanSessionInactiveReason, cspanSourcesVsanTable=cspanSourcesVsanTable, cspanSourcesVsanCfgSessIndex=cspanSourcesVsanCfgSessIndex, ciscoFcSpanMIBCompliance=ciscoFcSpanMIBCompliance, cspanConfiguration=cspanConfiguration, cspanVsanFilterVsans4k=cspanVsanFilterVsans4k, cspanVsanFilterSessIndex=cspanVsanFilterSessIndex, cspanVsanFilterOpVsans2k=cspanVsanFilterOpVsans2k, cspanVsanFilterOpTable=cspanVsanFilterOpTable, cspanVsanFilterEntry=cspanVsanFilterEntry, cspanSourceVsanGroup=cspanSourceVsanGroup, cspanSessionTable=cspanSessionTable, cspanVsanFilterOpSessIndex=cspanVsanFilterOpSessIndex, ciscoFcSpanMIBConformance=ciscoFcSpanMIBConformance, cspanVsanFilterGroup=cspanVsanFilterGroup, cspanSourcesIfIndex=cspanSourcesIfIndex, cspanSourcesDirection=cspanSourcesDirection, cspanSourcesVsans2k=cspanSourcesVsans2k, cspanSourcesVsans4k=cspanSourcesVsans4k, cspanSourcesVsanCfgEntry=cspanSourcesVsanCfgEntry, cspanVsanFilterOpVsans4k=cspanVsanFilterOpVsans4k, cspanSessionEntry=cspanSessionEntry, cspanMaxSessions=cspanMaxSessions, ciscoSpanMIBObjects=ciscoSpanMIBObjects, cspanSourceIfGroup=cspanSourceIfGroup, cspanSessionAdminStatus=cspanSessionAdminStatus, cspanVsanFilterTable=cspanVsanFilterTable, cspanVsanFilterOpGroup=cspanVsanFilterOpGroup, cspanSourcesVsanEntry=cspanSourcesVsanEntry, cspanSourcesIfTable=cspanSourcesIfTable, cspanSessionDestIfIndex=cspanSessionDestIfIndex, cspanSourcesVsanCfgCommand=cspanSourcesVsanCfgCommand, cspanSourcesVsanCfgVsans4k=cspanSourcesVsanCfgVsans4k, ciscoFcSpanMIBCompliances=ciscoFcSpanMIBCompliances, cspanSessionOperStatus=cspanSessionOperStatus, cspanVsanFilterOpCommand=cspanVsanFilterOpCommand, cspanSourcesRowStatus=cspanSourcesRowStatus, cspanSessionsGroup=cspanSessionsGroup, cspanScalarsGroup=cspanScalarsGroup)
