...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-FC-SPAN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:21:34 2025
...
ciscoFcSpanMIBCompliance.setObjects(
      *(("CISCO-FC-SPAN-MIB", "cspanScalarsGroup"),
        ("CISCO-FC-SPAN-MIB", "cspanSessionsGroup"),
        ("CISCO-FC-SPAN-MIB", "cspanSourceIfGroup"),
        ("CISCO-FC-SPAN-MIB", "cspanSourceVsanGroup"),
        ("CISCO-FC-SPAN-MIB", "cspanSourceVsanCfgGroup"),
        ("CISCO-FC-SPAN-MIB", "cspanVsanFilterGroup"),
        ("CISCO-FC-SPAN-MIB", "cspanVsanFilterOpGroup"))
)
if mibBuilder.loadTexts:
