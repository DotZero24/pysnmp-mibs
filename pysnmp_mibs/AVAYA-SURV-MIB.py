...
mibBuilder.exportSymbols("AVAYA-SURV-MIB", avSurvTrunkSigGroupRefNumber=avSurvTrunkSigGroupRefNumber, avSurvDialInsertDigits=avSurvDialInsertDigits, avSurvEndDLTimeStamp=avSurvEndDLTimeStamp, avSurvSigGroupChannelSelection=avSurvSigGroupChannelSelection, avSurvDs1RowStatus=avSurvDs1RowStatus, avSurvDialType=avSurvDialType, avSurvDs1Table=avSurvDs1Table, avSurvStationSwitchHookFlash=avSurvStationSwitchHookFlash, avSurvSlotConfigBoardType=avSurvSlotConfigBoardType, avSurvIpCodecSetModemMode=avSurvIpCodecSetModemMode, avSurvFacId=avSurvFacId, avSurvTrunkGroupCbcParameter=avSurvTrunkGroupCbcParameter, avSurvDs1ChannelNumbering=avSurvDs1ChannelNumbering, avSurvDs1SlotNumberId=avSurvDs1SlotNumberId, avSurvTrunkGroupIncomingDestination=avSurvTrunkGroupIncomingDestination, avSurvDs1BitRate=avSurvDs1BitRate, avSurvIncomingRoutingGroupRefNumber=avSurvIncomingRoutingGroupRefNumber, avSurvFacEntry=avSurvFacEntry, avSurvIncomingRoutingIndex=avSurvIncomingRoutingIndex, avSurvTrunkEntry=avSurvTrunkEntry, avSurvNfasRowStatus=avSurvNfasRowStatus, avSurvIpVoiceCodecSetIndex=avSurvIpVoiceCodecSetIndex, avSurvTrunkGroupTable=avSurvTrunkGroupTable, avSurvSlotConfigNumberId=avSurvSlotConfigNumberId, avSurvTrunkGroupJapanDisconnect=avSurvTrunkGroupJapanDisconnect, avSurvAdminState=avSurvAdminState, avSurvStationIndex=avSurvStationIndex, avSurvStationInterfaceIndex=avSurvStationInterfaceIndex, avSurvTrunkGroupCbc=avSurvTrunkGroupCbc, avSurvIpCodecSetModemRedundancy=avSurvIpCodecSetModemRedundancy, avSurvNfasInterfaceId=avSurvNfasInterfaceId, avSurvTrunkGroupRowStatus=avSurvTrunkGroupRowStatus, avSurvTrunkGroupIncomingDialTone=avSurvTrunkGroupIncomingDialTone, avSurvDialIndex=avSurvDialIndex, avSurvTrunkGroupCbcServiceFeature=avSurvTrunkGroupCbcServiceFeature, avSurvDs1Interface=avSurvDs1Interface, avSurvStationTrunkDest=avSurvStationTrunkDest, avSurvNotification=avSurvNotification, avSurvFacType=avSurvFacType, avSurvArsTable=avSurvArsTable, avSurvBriIndex=avSurvBriIndex, avSurvDialMaximumLength=avSurvDialMaximumLength, avSurvDs1InterfaceCompanding=avSurvDs1InterfaceCompanding, avSurvSlotConfigIndex=avSurvSlotConfigIndex, avSurvBriTeiAssignment=avSurvBriTeiAssignment, avSurvDs1CountryProtocol=avSurvDs1CountryProtocol, avSurvTrunkGroupType=avSurvTrunkGroupType, avSurvTrunkGroupDidDigitsInsert=avSurvTrunkGroupDidDigitsInsert, avSurvStationTable=avSurvStationTable, avSurvTrunkGroupCodesetDisplay=avSurvTrunkGroupCodesetDisplay, avSurvConfig=avSurvConfig, avSurvSigGroupIndex=avSurvSigGroupIndex, avSurvSigGroupRowStatus=avSurvSigGroupRowStatus, avSurvStationName=avSurvStationName, avSurvSigGroupAssociatedSignaling=avSurvSigGroupAssociatedSignaling, avSurvBriEntry=avSurvBriEntry, avSurvBriBearerCapability=avSurvBriBearerCapability, avSurvTrunkGroupDs1Supervision=avSurvTrunkGroupDs1Supervision, avSurvDs1Entry=avSurvDs1Entry, avSurvBriInterfaceCompanding=avSurvBriInterfaceCompanding, avSurvBriEndpointInit=avSurvBriEndpointInit, avSurvInactive=avSurvInactive, avSurvDialGroupRefNumber=avSurvDialGroupRefNumber, avSurvPimLockout=avSurvPimLockout, avSurvTrunkGroupName=avSurvTrunkGroupName, avSurvTrunkGroupDial=avSurvTrunkGroupDial, avSurvDs1SignalingMode=avSurvDs1SignalingMode, avSurvIpCodecSetFaxRedundancy=avSurvIpCodecSetFaxRedundancy, avSurvTrunkGroupR2MFCSignaling=avSurvTrunkGroupR2MFCSignaling, avSurvDialMinimumLength=avSurvDialMinimumLength, avSurvTrunkGroupNum=avSurvTrunkGroupNum, avSurvTrunkSlotPort=avSurvTrunkSlotPort, avSurvNfasInterface=avSurvNfasInterface, avSurvTrunkGroupChannelPreference=avSurvTrunkGroupChannelPreference, avSurvDialString=avSurvDialString, avSurvDs1Connect=avSurvDs1Connect, avSurvFacIndex=avSurvFacIndex, avSurvBriSpidB=avSurvBriSpidB, avSurvIpVoiceCodecSetEntry=avSurvIpVoiceCodecSetEntry, avSurvIncomingRoutingMatchPattern=avSurvIncomingRoutingMatchPattern, avSurvIpVoiceCodecSetTable=avSurvIpVoiceCodecSetTable, avSurvSlotConfigRowStatus=avSurvSlotConfigRowStatus, avSurvStatus=avSurvStatus, avSurvDialAction=avSurvDialAction, avSurvIpVoiceCodecSetSilence=avSurvIpVoiceCodecSetSilence, avSurvNfasSigGroupRefNumber=avSurvNfasSigGroupRefNumber, avSurvSlotConfigTable=avSurvSlotConfigTable, avSurvSlotConfigEntry=avSurvSlotConfigEntry, avSurvFacTable=avSurvFacTable, avSurvDialDeleteDigits=avSurvDialDeleteDigits, avSurvStationIpAddressRegistered=avSurvStationIpAddressRegistered, avSurvIncomingRoutingDeleteDigits=avSurvIncomingRoutingDeleteDigits, avSurvFacRowStatus=avSurvFacRowStatus, avSurvTrunkGroupTAC=avSurvTrunkGroupTAC, PYSNMP_MODULE_ID=avSurvMib, avSurvStationEntry=avSurvStationEntry, avSurvStationExpansionModule=avSurvStationExpansionModule, avSurvIncomingRoutingTable=avSurvIncomingRoutingTable, avSurvIpCodecSetEncryptPriority3=avSurvIpCodecSetEncryptPriority3, avSurvTrunkGroupDidSupervision=avSurvTrunkGroupDidSupervision, avSurvActive=avSurvActive, avSurvArsEntry=avSurvArsEntry, avSurvIncomingRoutingMode=avSurvIncomingRoutingMode, avSurvTrunkGroupTrunkHunt=avSurvTrunkGroupTrunkHunt, avSurvTrunkGroupSendName=avSurvTrunkGroupSendName, avSurvTrunkGroupSendCallingNumber=avSurvTrunkGroupSendCallingNumber, avSurvTrunkGroupDidDigitTreatment=avSurvTrunkGroupDidDigitTreatment, avSurvIpCodecSetTtyMode=avSurvIpCodecSetTtyMode, avSurvIpCodecSetTtyRedundancy=avSurvIpCodecSetTtyRedundancy, avSurvGatewayNumber=avSurvGatewayNumber, avSurvBriDirectoryNumberA=avSurvBriDirectoryNumberA, avSurvNfasEntry=avSurvNfasEntry, avSurvDs1Index=avSurvDs1Index, avSurvIpCodecSetConfig=avSurvIpCodecSetConfig, avSurvBriLayer1Stable=avSurvBriLayer1Stable, avSurvBriSlotPortNumberId=avSurvBriSlotPortNumberId, avSurvIpCodecSetEncryptPriority1=avSurvIpCodecSetEncryptPriority1, avSurvIpCodecSetClearChanMode=avSurvIpCodecSetClearChanMode, avSurvTrunkInterfaceIndex=avSurvTrunkInterfaceIndex, avSurvDs1Name=avSurvDs1Name, avSurvIpVoiceCodecSetType=avSurvIpVoiceCodecSetType, avSurvStationType=avSurvStationType, avSurvNotificationSeverity=avSurvNotificationSeverity, avSurvDs1BearerCapability=avSurvDs1BearerCapability, avSurvBriSide=avSurvBriSide, avSurvIpVoiceCodecSetFrames=avSurvIpVoiceCodecSetFrames, avSurvBriDirectoryNumberB=avSurvBriDirectoryNumberB, avSurvIpCodecSetFaxMode=avSurvIpCodecSetFaxMode, avSurvBriSpidA=avSurvBriSpidA, avSurvTrunkRowStatus=avSurvTrunkRowStatus, avSurvStationCOR=avSurvStationCOR, avSurvTrunkGroupDigitHandling=avSurvTrunkGroupDigitHandling, avSurvIpVoiceCodecSetRowStatus=avSurvIpVoiceCodecSetRowStatus, avSurvTrunkGroupEntry=avSurvTrunkGroupEntry, avSurvTrunkGroupRefNumber=avSurvTrunkGroupRefNumber, avSurvBriName=avSurvBriName, avSurvTrunkGroupBusyDisconnect=avSurvTrunkGroupBusyDisconnect, avSurvDs1ProtocolVersion=avSurvDs1ProtocolVersion, avSurvStationExt=avSurvStationExt, avSurvDs1LongTimer=avSurvDs1LongTimer, avSurvDs1Side=avSurvDs1Side, avSurvDateFormat=avSurvDateFormat, avSurvAttendantExtension=avSurvAttendantExtension, avSurvBriRowStatus=avSurvBriRowStatus, avSurvIpCodecSetEncryptPriority2=avSurvIpCodecSetEncryptPriority2, avSurvSigGroupTable=avSurvSigGroupTable, avSurvNfasTable=avSurvNfasTable, avSurvStationSlotPort=avSurvStationSlotPort, avSurvIncomingRoutingLength=avSurvIncomingRoutingLength, avSurvEnabled=avSurvEnabled, avSurvIpVoiceCodecSetPriority=avSurvIpVoiceCodecSetPriority, avSurvTrunkTable=avSurvTrunkTable, avSurvBriTable=avSurvBriTable, avSurvBriCountryProtocol=avSurvBriCountryProtocol, avSurvIpCodecSetClearChanRedundancy=avSurvIpCodecSetClearChanRedundancy, avSurvAttendantAccessCode=avSurvAttendantAccessCode, avSurvBriInterface=avSurvBriInterface, avSurvMaxIPReg=avSurvMaxIPReg, avSurvIncomingRoutingEntry=avSurvIncomingRoutingEntry, avSurvMib=avSurvMib, avSurvSigGroupPrimaryDChannel=avSurvSigGroupPrimaryDChannel, avSurvIncomingRoutingInsertDigits=avSurvIncomingRoutingInsertDigits, avSurvTrunkIndex=avSurvTrunkIndex, avSurvNfasIndex=avSurvNfasIndex, avSurvIncomingRoutingRowStatus=avSurvIncomingRoutingRowStatus, avSurvDisabled=avSurvDisabled, avSurvStationRowStatus=avSurvStationRowStatus, avSurvTrunkGroupCodesetNational=avSurvTrunkGroupCodesetNational, avSurvDialRowStatus=avSurvDialRowStatus, avSurvConfigCommand=avSurvConfigCommand, avSurvTrunkGroupNumberingFormat=avSurvTrunkGroupNumberingFormat, avSurvSigGroupEntry=avSurvSigGroupEntry, avSurvIpVoiceCodecSetNum=avSurvIpVoiceCodecSetNum)
