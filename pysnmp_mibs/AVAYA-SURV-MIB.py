...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/avaya/AVAYA-SURV-MIB
...
mibBuilder.exportSymbols("AVAYA-SURV-MIB", avSurvBriTable=avSurvBriTable, avSurvBriDirectoryNumberB=avSurvBriDirectoryNumberB, avSurvDialGroupRefNumber=avSurvDialGroupRefNumber, avSurvTrunkGroupRefNumber=avSurvTrunkGroupRefNumber, avSurvNfasInterfaceId=avSurvNfasInterfaceId, avSurvTrunkGroupIncomingDestination=avSurvTrunkGroupIncomingDestination, avSurvFacTable=avSurvFacTable, avSurvDs1SignalingMode=avSurvDs1SignalingMode, avSurvDs1LongTimer=avSurvDs1LongTimer, avSurvIpCodecSetFaxRedundancy=avSurvIpCodecSetFaxRedundancy, avSurvBriIndex=avSurvBriIndex, avSurvTrunkGroupEntry=avSurvTrunkGroupEntry, avSurvTrunkGroupIncomingDialTone=avSurvTrunkGroupIncomingDialTone, avSurvIncomingRoutingEntry=avSurvIncomingRoutingEntry, avSurvBriSpidA=avSurvBriSpidA, avSurvIpCodecSetModemMode=avSurvIpCodecSetModemMode, avSurvAttendantAccessCode=avSurvAttendantAccessCode, avSurvSlotConfigTable=avSurvSlotConfigTable, avSurvDs1RowStatus=avSurvDs1RowStatus, avSurvSlotConfigBoardType=avSurvSlotConfigBoardType, avSurvSigGroupAssociatedSignaling=avSurvSigGroupAssociatedSignaling, avSurvDs1BitRate=avSurvDs1BitRate, avSurvTrunkGroupChannelPreference=avSurvTrunkGroupChannelPreference, avSurvIpCodecSetTtyMode=avSurvIpCodecSetTtyMode, avSurvBriTeiAssignment=avSurvBriTeiAssignment, avSurvTrunkGroupDigitHandling=avSurvTrunkGroupDigitHandling, avSurvTrunkSlotPort=avSurvTrunkSlotPort, avSurvBriSide=avSurvBriSide, avSurvDialIndex=avSurvDialIndex, avSurvTrunkGroupJapanDisconnect=avSurvTrunkGroupJapanDisconnect, avSurvActive=avSurvActive, avSurvIpVoiceCodecSetPriority=avSurvIpVoiceCodecSetPriority, avSurvArsTable=avSurvArsTable, avSurvDs1ProtocolVersion=avSurvDs1ProtocolVersion, avSurvTrunkGroupType=avSurvTrunkGroupType, avSurvIpVoiceCodecSetIndex=avSurvIpVoiceCodecSetIndex, avSurvNfasInterface=avSurvNfasInterface, avSurvDialInsertDigits=avSurvDialInsertDigits, avSurvNfasEntry=avSurvNfasEntry, avSurvPimLockout=avSurvPimLockout, avSurvBriLayer1Stable=avSurvBriLayer1Stable, avSurvTrunkGroupCodesetNational=avSurvTrunkGroupCodesetNational, avSurvInactive=avSurvInactive, avSurvTrunkGroupTrunkHunt=avSurvTrunkGroupTrunkHunt, avSurvTrunkGroupCbcServiceFeature=avSurvTrunkGroupCbcServiceFeature, avSurvDialMinimumLength=avSurvDialMinimumLength, avSurvSlotConfigNumberId=avSurvSlotConfigNumberId, avSurvFacRowStatus=avSurvFacRowStatus, avSurvIncomingRoutingGroupRefNumber=avSurvIncomingRoutingGroupRefNumber, avSurvTrunkGroupNumberingFormat=avSurvTrunkGroupNumberingFormat, avSurvNotificationSeverity=avSurvNotificationSeverity, avSurvDateFormat=avSurvDateFormat, avSurvIncomingRoutingMode=avSurvIncomingRoutingMode, avSurvTrunkEntry=avSurvTrunkEntry, avSurvIpVoiceCodecSetSilence=avSurvIpVoiceCodecSetSilence, avSurvSigGroupTable=avSurvSigGroupTable, avSurvNfasIndex=avSurvNfasIndex, avSurvIncomingRoutingIndex=avSurvIncomingRoutingIndex, avSurvStationTrunkDest=avSurvStationTrunkDest, avSurvDs1CountryProtocol=avSurvDs1CountryProtocol, avSurvArsEntry=avSurvArsEntry, avSurvStationTable=avSurvStationTable, avSurvFacType=avSurvFacType, avSurvDs1ChannelNumbering=avSurvDs1ChannelNumbering, avSurvIncomingRoutingDeleteDigits=avSurvIncomingRoutingDeleteDigits, avSurvMaxIPReg=avSurvMaxIPReg, avSurvTrunkGroupTable=avSurvTrunkGroupTable, avSurvTrunkGroupCodesetDisplay=avSurvTrunkGroupCodesetDisplay, avSurvTrunkGroupCbc=avSurvTrunkGroupCbc, avSurvTrunkGroupCbcParameter=avSurvTrunkGroupCbcParameter, avSurvIpCodecSetEncryptPriority2=avSurvIpCodecSetEncryptPriority2, avSurvDs1Entry=avSurvDs1Entry, avSurvBriSlotPortNumberId=avSurvBriSlotPortNumberId, avSurvStationIpAddressRegistered=avSurvStationIpAddressRegistered, avSurvDisabled=avSurvDisabled, avSurvDs1Index=avSurvDs1Index, avSurvDs1Name=avSurvDs1Name, avSurvConfigCommand=avSurvConfigCommand, avSurvStationType=avSurvStationType, avSurvAdminState=avSurvAdminState, avSurvStationEntry=avSurvStationEntry, avSurvTrunkGroupDidDigitTreatment=avSurvTrunkGroupDidDigitTreatment, avSurvTrunkGroupSendCallingNumber=avSurvTrunkGroupSendCallingNumber, avSurvIpVoiceCodecSetFrames=avSurvIpVoiceCodecSetFrames, avSurvBriEntry=avSurvBriEntry, avSurvDialType=avSurvDialType, avSurvStationRowStatus=avSurvStationRowStatus, avSurvNfasSigGroupRefNumber=avSurvNfasSigGroupRefNumber, avSurvSigGroupEntry=avSurvSigGroupEntry, avSurvIpCodecSetTtyRedundancy=avSurvIpCodecSetTtyRedundancy, avSurvStationSlotPort=avSurvStationSlotPort, avSurvNotification=avSurvNotification, avSurvSlotConfigIndex=avSurvSlotConfigIndex, avSurvNfasTable=avSurvNfasTable, avSurvEnabled=avSurvEnabled, avSurvIpVoiceCodecSetNum=avSurvIpVoiceCodecSetNum, avSurvSlotConfigRowStatus=avSurvSlotConfigRowStatus, avSurvTrunkGroupSendName=avSurvTrunkGroupSendName, avSurvDialDeleteDigits=avSurvDialDeleteDigits, avSurvIpCodecSetEncryptPriority3=avSurvIpCodecSetEncryptPriority3, avSurvStationSwitchHookFlash=avSurvStationSwitchHookFlash, avSurvTrunkTable=avSurvTrunkTable, avSurvTrunkGroupDial=avSurvTrunkGroupDial, avSurvBriDirectoryNumberA=avSurvBriDirectoryNumberA, avSurvTrunkSigGroupRefNumber=avSurvTrunkSigGroupRefNumber, avSurvIpCodecSetConfig=avSurvIpCodecSetConfig, avSurvStationIndex=avSurvStationIndex, avSurvIpCodecSetFaxMode=avSurvIpCodecSetFaxMode, avSurvIpVoiceCodecSetType=avSurvIpVoiceCodecSetType, avSurvIncomingRoutingLength=avSurvIncomingRoutingLength, avSurvTrunkIndex=avSurvTrunkIndex, avSurvEndDLTimeStamp=avSurvEndDLTimeStamp, avSurvDs1SlotNumberId=avSurvDs1SlotNumberId, avSurvTrunkGroupDidSupervision=avSurvTrunkGroupDidSupervision, avSurvIpVoiceCodecSetTable=avSurvIpVoiceCodecSetTable, avSurvDialMaximumLength=avSurvDialMaximumLength, avSurvStationExt=avSurvStationExt, avSurvSlotConfigEntry=avSurvSlotConfigEntry, avSurvSigGroupChannelSelection=avSurvSigGroupChannelSelection, avSurvSigGroupRowStatus=avSurvSigGroupRowStatus, avSurvDialRowStatus=avSurvDialRowStatus, avSurvConfig=avSurvConfig, avSurvStationName=avSurvStationName, avSurvBriEndpointInit=avSurvBriEndpointInit, avSurvDs1Side=avSurvDs1Side, avSurvStationExpansionModule=avSurvStationExpansionModule, avSurvStationInterfaceIndex=avSurvStationInterfaceIndex, avSurvTrunkGroupDs1Supervision=avSurvTrunkGroupDs1Supervision, avSurvDs1Connect=avSurvDs1Connect, avSurvIpCodecSetClearChanMode=avSurvIpCodecSetClearChanMode, avSurvAttendantExtension=avSurvAttendantExtension, avSurvFacId=avSurvFacId, avSurvTrunkGroupBusyDisconnect=avSurvTrunkGroupBusyDisconnect, avSurvTrunkGroupRowStatus=avSurvTrunkGroupRowStatus, avSurvBriInterfaceCompanding=avSurvBriInterfaceCompanding, avSurvIncomingRoutingTable=avSurvIncomingRoutingTable, avSurvSigGroupPrimaryDChannel=avSurvSigGroupPrimaryDChannel, avSurvTrunkGroupTAC=avSurvTrunkGroupTAC, avSurvIncomingRoutingMatchPattern=avSurvIncomingRoutingMatchPattern, avSurvBriName=avSurvBriName, avSurvDs1InterfaceCompanding=avSurvDs1InterfaceCompanding, avSurvBriBearerCapability=avSurvBriBearerCapability, avSurvStatus=avSurvStatus, avSurvGatewayNumber=avSurvGatewayNumber, avSurvBriInterface=avSurvBriInterface, avSurvDs1BearerCapability=avSurvDs1BearerCapability, avSurvTrunkGroupName=avSurvTrunkGroupName, avSurvTrunkGroupDidDigitsInsert=avSurvTrunkGroupDidDigitsInsert, avSurvDs1Interface=avSurvDs1Interface, avSurvBriSpidB=avSurvBriSpidB, avSurvIpVoiceCodecSetRowStatus=avSurvIpVoiceCodecSetRowStatus, avSurvIpCodecSetModemRedundancy=avSurvIpCodecSetModemRedundancy, PYSNMP_MODULE_ID=avSurvMib, avSurvDialString=avSurvDialString, avSurvDialAction=avSurvDialAction, avSurvMib=avSurvMib, avSurvIpCodecSetEncryptPriority1=avSurvIpCodecSetEncryptPriority1, avSurvIpCodecSetClearChanRedundancy=avSurvIpCodecSetClearChanRedundancy, avSurvTrunkGroupNum=avSurvTrunkGroupNum, avSurvIpVoiceCodecSetEntry=avSurvIpVoiceCodecSetEntry, avSurvSigGroupIndex=avSurvSigGroupIndex, avSurvTrunkRowStatus=avSurvTrunkRowStatus, avSurvNfasRowStatus=avSurvNfasRowStatus, avSurvTrunkGroupR2MFCSignaling=avSurvTrunkGroupR2MFCSignaling, avSurvTrunkInterfaceIndex=avSurvTrunkInterfaceIndex, avSurvFacEntry=avSurvFacEntry, avSurvBriRowStatus=avSurvBriRowStatus, avSurvStationCOR=avSurvStationCOR, avSurvFacIndex=avSurvFacIndex, avSurvDs1Table=avSurvDs1Table, avSurvBriCountryProtocol=avSurvBriCountryProtocol, avSurvIncomingRoutingInsertDigits=avSurvIncomingRoutingInsertDigits, avSurvIncomingRoutingRowStatus=avSurvIncomingRoutingRowStatus)
