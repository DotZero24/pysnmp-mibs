...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-MGX82XX-ENVMON-MIB
...
cmEnvmonCompliance.setObjects(
      *(("CISCO-MGX82XX-ENVMON-MIB", "cmEnvmonInfoGroup"),
        ("CISCO-MGX82XX-ENVMON-MIB", "cmEnvmonGeneralGroup"))
)
if mibBuilder.loadTexts:
