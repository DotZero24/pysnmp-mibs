# SNMP MIB module (DLINK-3100-QOS-CLI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-3100-QOS-CLI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:52:38 2025
...
rlQosCliQosMode = _RlQosCliQosMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 1),
...
rlQosCliBasicModeCfg = _RlQosCliBasicModeCfg_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 2),
...
rlQosMaxNumOfAce = _RlQosMaxNumOfAce_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 3),
...
rlQosOffsetIndex = _RlQosOffsetIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 4, 1, 1),
...
rlQosOffsetType = _RlQosOffsetType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 4, 1, 2),
...
rlQosOffsetValue = _RlQosOffsetValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 4, 1, 3),
...
rlQosOffsetMask = _RlQosOffsetMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 4, 1, 4),
...
rlQosOffsetPattern = _RlQosOffsetPattern_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 4, 1, 5),
...
rlQosOffsetTuplePointer = _RlQosOffsetTuplePointer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 4, 1, 6),
...
rlQosOffsetStatus = _RlQosOffsetStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 4, 1, 7),
...
rlQosTupleIndex = _RlQosTupleIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 5, 1, 1),
...
rlQosTupleType = _RlQosTupleType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 5, 1, 2),
...
rlQosTupleValue1 = _RlQosTupleValue1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 5, 1, 3),
...
rlQosTupleValue2 = _RlQosTupleValue2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 5, 1, 4),
...
rlQosTupleStatus = _RlQosTupleStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 5, 1, 5),
...
rlQosAceIndex = _RlQosAceIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 1),
    _RlQosAceIndex_Type()
)
...
rlQosAceAction = _RlQosAceAction_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 2),
...
rlQosAceType = _RlQosAceType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 3),
    _RlQosAceType_Type()
)
...
rlQosAceTuple1 = _RlQosAceTuple1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 4),
...
rlQosAceTuple2 = _RlQosAceTuple2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 5),
...
rlQosAceTuple3 = _RlQosAceTuple3_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 6),
...
rlQosAceTuple4 = _RlQosAceTuple4_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 7),
...
rlQosAceTuple5 = _RlQosAceTuple5_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 8),
...
rlQosAceTuple6 = _RlQosAceTuple6_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 9),
...
rlQosAceTuple7 = _RlQosAceTuple7_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 10),
...
rlQosAceTuple8 = _RlQosAceTuple8_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 11),
...
rlQosAceAccount = _RlQosAceAccount_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 12),
...
rlQosAceStatus = _RlQosAceStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 6, 1, 13),
...
rlQosAclIndex = _RlQosAclIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 7, 1, 1),
    _RlQosAclIndex_Type()
)
...
rlQosAclName = _RlQosAclName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 7, 1, 2),
    _RlQosAclName_Type()
)
...
rlQosAclType = _RlQosAclType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 7, 1, 3),
    _RlQosAclType_Type()
)
...
rlQosAclStatus = _RlQosAclStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 7, 1, 4),
...
rlQosAclAceRefTable = _RlQosAclAceRefTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 8)
)
if mibBuilder.loadTexts:
...
rlQosAclAceRefEntry = _RlQosAclAceRefEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 8, 1)
)
rlQosAclAceRefEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosAclAceRefAcePointer"),
)
if mibBuilder.loadTexts:
...
rlQosAclAceRefAcePointer = _RlQosAclAceRefAcePointer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 8, 1, 1),
...
rlQosAclAceRefAclPointer = _RlQosAclAceRefAclPointer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 8, 1, 2),
...
rlQosAclAceRefStatus = _RlQosAclAceRefStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 8, 1, 3),
...
rlQosClassMapIndex = _RlQosClassMapIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 1),
...
rlQosClassMapName = _RlQosClassMapName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 2),
...
rlQosClassMapType = _RlQosClassMapType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 3),
...
rlQosClassMapAction = _RlQosClassMapAction_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 4),
...
rlQosClassMapMarkValue = _RlQosClassMapMarkValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 5),
...
rlQosClassMapPolicer = _RlQosClassMapPolicer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 6),
...
rlQosClassMapMatch1 = _RlQosClassMapMatch1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 7),
...
rlQosClassMapMatch2 = _RlQosClassMapMatch2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 8),
...
class _RlQosClassMapMarkVlan_Type(BinaryStatus):
    """Custom type rlQosClassMapMarkVlan based on BinaryStatus"""
    defaultValue = 1


_RlQosClassMapMarkVlan_Type.__name__ = "BinaryStatus"
_RlQosClassMapMarkVlan_Object = MibTableColumn
rlQosClassMapMarkVlan = _RlQosClassMapMarkVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 9),
...
rlQosClassMapNewVlan = _RlQosClassMapNewVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 10),
...
class _RlQosClassMapNewPort_Type(Integer32):
    """Custom type rlQosClassMapNewPort based on Integer32"""
    defaultValue = 0


_RlQosClassMapNewPort_Type.__name__ = "Integer32"
_RlQosClassMapNewPort_Object = MibTableColumn
rlQosClassMapNewPort = _RlQosClassMapNewPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 11),
...
class _RlQosClassMapCopyPort_Type(Integer32):
    """Custom type rlQosClassMapCopyPort based on Integer32"""
    defaultValue = 0


_RlQosClassMapCopyPort_Type.__name__ = "Integer32"
_RlQosClassMapCopyPort_Object = MibTableColumn
rlQosClassMapCopyPort = _RlQosClassMapCopyPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 12),
...
rlQosClassMapStatus = _RlQosClassMapStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 13),
...
rlQosClassMapMatch3 = _RlQosClassMapMatch3_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 9, 1, 14),
...
rlQosPolicerIndex = _RlQosPolicerIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 10, 1, 1),
...
rlQosPolicerName = _RlQosPolicerName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 10, 1, 2),
...
rlQosPolicerType = _RlQosPolicerType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 10, 1, 3),
...
rlQosPolicerCir = _RlQosPolicerCir_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 10, 1, 4),
...
rlQosPolicerCbs = _RlQosPolicerCbs_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 10, 1, 5),
...
rlQosPolicerAction = _RlQosPolicerAction_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 10, 1, 6),
...
rlQosPolicerCasPointerRemVal = _RlQosPolicerCasPointerRemVal_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 10, 1, 7),
...
rlQosPolicerStatus = _RlQosPolicerStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 10, 1, 8),
...
rlQosPolicyMapTable = _RlQosPolicyMapTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 11)
)
if mibBuilder.loadTexts:
...
rlQosPolicyMapEntry = _RlQosPolicyMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 11, 1)
)
rlQosPolicyMapEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosPolicyMapIndex"),
)
if mibBuilder.loadTexts:
...
rlQosPolicyMapIndex = _RlQosPolicyMapIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 11, 1, 1),
...
rlQosPolicyMapName = _RlQosPolicyMapName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 11, 1, 2),
...
rlQosPolicyMapStatus = _RlQosPolicyMapStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 11, 1, 3),
...
rlQosPolicyClassRefTable = _RlQosPolicyClassRefTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 12)
)
if mibBuilder.loadTexts:
...
rlQosPolicyClassRefEntry = _RlQosPolicyClassRefEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 12, 1)
)
rlQosPolicyClassRefEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosPolicyClassRefClassPointer"),
)
if mibBuilder.loadTexts:
...
rlQosPolicyClassRefClassPointer = _RlQosPolicyClassRefClassPointer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 12, 1, 1),
...
rlQosPolicyClassRefPolicyPointer = _RlQosPolicyClassRefPolicyPointer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 12, 1, 2),
...
rlQosPolicyClassRefStatus = _RlQosPolicyClassRefStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 12, 1, 3),
...
rlIfIndex = _RlIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 1),
    _RlIfIndex_Type()
)
...
rlIfType = _RlIfType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 2),
    _RlIfType_Type()
)
...
rlQosIfPolicyMapPointerIn = _RlQosIfPolicyMapPointerIn_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 3),
...
rlQosIfPolicyMapPointerOut = _RlQosIfPolicyMapPointerOut_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 4),
...
rlQosIfTrustActive = _RlQosIfTrustActive_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 5),
...
rlQosPortShaperStatus = _RlQosPortShaperStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 6),
...
rlQosCirPortShaper = _RlQosCirPortShaper_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 7),
...
rlQosCbsPortShaper = _RlQosCbsPortShaper_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 8),
...
rlQosIfProfilePointer = _RlQosIfProfilePointer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 9),
...
rlQosQueueProfilePointer = _RlQosQueueProfilePointer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 10),
...
rlQosQueueShapeProfilePointer = _RlQosQueueShapeProfilePointer_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 11),
...
rlQosAclDefaultAction = _RlQosAclDefaultAction_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 12),
...
rlQosIfPolicyMapStatus = _RlQosIfPolicyMapStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 13),
...
rlQosIfAclIn = _RlQosIfAclIn_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 14),
    _RlQosIfAclIn_Type()
)
...
rlQosIfAclOut = _RlQosIfAclOut_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 15),
    _RlQosIfAclOut_Type()
)
...
rlQosIfPolicerIn = _RlQosIfPolicerIn_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 16),
...
rlQosPortRateLimitStatus = _RlQosPortRateLimitStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 17),
...
rlQosCirPortRateLimit = _RlQosCirPortRateLimit_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 18),
...
rlQosCbsPortRateLimit = _RlQosCbsPortRateLimit_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 19),
...
rlQosIfIpv6AclIn = _RlQosIfIpv6AclIn_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 20),
...
rlQosIfIpv6AclOut = _RlQosIfIpv6AclOut_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 13, 1, 21),
...
rlQosIfProfileCfgTable = _RlQosIfProfileCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14)
)
if mibBuilder.loadTexts:
...
rlQosIfProfileCfgEntry = _RlQosIfProfileCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1)
)
rlQosIfProfileCfgEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlIfProfileName"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosQueueId"),
)
if mibBuilder.loadTexts:
...
rlIfProfileName = _RlIfProfileName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 1),
...
rlQosQueueId = _RlQosQueueId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 2),
    _RlQosQueueId_Type()
)
...
rlQosTdThersholdDp0 = _RlQosTdThersholdDp0_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 3),
...
rlQosTdThersholdDp1 = _RlQosTdThersholdDp1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 4),
...
rlQosTdThersholdDp2 = _RlQosTdThersholdDp2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 5),
...
rlQosRedMinDp0 = _RlQosRedMinDp0_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 6),
...
rlQosRedMaxDp0 = _RlQosRedMaxDp0_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 7),
...
rlQosRedProbDp0 = _RlQosRedProbDp0_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 8),
...
rlQosRedMinDp1 = _RlQosRedMinDp1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 9),
...
rlQosRedMaxDp1 = _RlQosRedMaxDp1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 10),
...
rlQosRedProbDp1 = _RlQosRedProbDp1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 11),
...
rlQosRedMinDp2 = _RlQosRedMinDp2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 12),
...
rlQosRedMaxDp2 = _RlQosRedMaxDp2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 13),
...
rlQosRedProbDp2 = _RlQosRedProbDp2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 14),
...
rlQosRedQweight = _RlQosRedQweight_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 15),
...
rlQosIfprofileStatus = _RlQosIfprofileStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 14, 1, 16),
...
rlQosDscpMutationTable = _RlQosDscpMutationTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 15)
)
if mibBuilder.loadTexts:
...
rlQosDscpMutationEntry = _RlQosDscpMutationEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 15, 1)
)
rlQosDscpMutationEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosOldDscp"),
)
if mibBuilder.loadTexts:
...
rlQosOldDscp = _RlQosOldDscp_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 15, 1, 1),
    _RlQosOldDscp_Type()
)
...
rlQosNewDscp = _RlQosNewDscp_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 15, 1, 2),
    _RlQosNewDscp_Type()
)
...
rlQosDscpRemarkTable = _RlQosDscpRemarkTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 16)
)
if mibBuilder.loadTexts:
...
rlQosDscpRemarkEntry = _RlQosDscpRemarkEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 16, 1)
)
rlQosDscpRemarkEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosRmOldDscp"),
)
if mibBuilder.loadTexts:
...
rlQosRmOldDscp = _RlQosRmOldDscp_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 16, 1, 1),
...
rlQosRmNewDscp = _RlQosRmNewDscp_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 16, 1, 2),
...
rlQosCosIndex = _RlQosCosIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 17, 1, 1),
    _RlQosCosIndex_Type()
)
...
rlQosCosQueueId = _RlQosCosQueueId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 17, 1, 2),
...
rlQosDscpQueueTable = _RlQosDscpQueueTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 18)
)
if mibBuilder.loadTexts:
...
rlQosDscpQueueEntry = _RlQosDscpQueueEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 18, 1)
)
rlQosDscpQueueEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosDscpIndex"),
)
if mibBuilder.loadTexts:
...
rlQosDscpIndex = _RlQosDscpIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 18, 1, 1),
...
rlQosQueueNum = _RlQosQueueNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 18, 1, 2),
    _RlQosQueueNum_Type()
)
...
rlQosTcpPortQueueTable = _RlQosTcpPortQueueTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 19)
)
if mibBuilder.loadTexts:
...
rlQosTcpPortQueueEntry = _RlQosTcpPortQueueEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 19, 1)
)
rlQosTcpPortQueueEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosTcpPort"),
)
if mibBuilder.loadTexts:
...
rlQosTcpPort = _RlQosTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 19, 1, 1),
    _RlQosTcpPort_Type()
)
...
rlQosTcpQueueValue = _RlQosTcpQueueValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 19, 1, 2),
...
rlQosTcpPortQueueStatus = _RlQosTcpPortQueueStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 19, 1, 3),
...
rlQosUdpPortQueueTable = _RlQosUdpPortQueueTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 20)
)
if mibBuilder.loadTexts:
...
rlQosUdpPortQueueEntry = _RlQosUdpPortQueueEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 20, 1)
)
rlQosUdpPortQueueEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosUdpPort"),
)
if mibBuilder.loadTexts:
...
rlQosUdpPort = _RlQosUdpPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 20, 1, 1),
    _RlQosUdpPort_Type()
)
...
rlQosUdpQueueValue = _RlQosUdpQueueValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 20, 1, 2),
...
rlQosUdpPortQueueStatus = _RlQosUdpPortQueueStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 20, 1, 3),
...
rlQosEfQueueId = _RlQosEfQueueId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 21, 1, 1),
...
rlQosEfState = _RlQosEfState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 21, 1, 2),
    _RlQosEfState_Type()
)
...
rlQosEfPriority = _RlQosEfPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 21, 1, 3),
...
rlQosQueueProfileTable = _RlQosQueueProfileTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22)
)
if mibBuilder.loadTexts:
...
rlQosQueueProfileEntry = _RlQosQueueProfileEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1)
)
rlQosQueueProfileEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQueueProfileName"),
)
if mibBuilder.loadTexts:
...
rlQueueProfileName = _RlQueueProfileName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 1),
...
rlQosTypeQueue1 = _RlQosTypeQueue1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 2),
...
rlQosValueQueue1 = _RlQosValueQueue1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 3),
...
rlQosTypeQueue2 = _RlQosTypeQueue2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 4),
...
rlQosValueQueue2 = _RlQosValueQueue2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 5),
...
rlQosTypeQueue3 = _RlQosTypeQueue3_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 6),
...
rlQosValueQueue3 = _RlQosValueQueue3_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 7),
...
rlQosTypeQueue4 = _RlQosTypeQueue4_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 8),
...
rlQosValueQueue4 = _RlQosValueQueue4_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 9),
...
rlQosTypeQueue5 = _RlQosTypeQueue5_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 10),
...
rlQosValueQueue5 = _RlQosValueQueue5_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 11),
...
rlQosTypeQueue6 = _RlQosTypeQueue6_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 12),
...
rlQosValueQueue6 = _RlQosValueQueue6_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 13),
...
rlQosTypeQueue7 = _RlQosTypeQueue7_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 14),
...
rlQosValueQueue7 = _RlQosValueQueue7_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 15),
...
rlQosTypeQueue8 = _RlQosTypeQueue8_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 16),
...
rlQosValueQueue8 = _RlQosValueQueue8_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 17),
...
rlQosQueueProfileStatus = _RlQosQueueProfileStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 18),
...
rlQosNumOfIfConnections = _RlQosNumOfIfConnections_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 22, 1, 19),
...
rlQosQueueShapeProfileTable = _RlQosQueueShapeProfileTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23)
)
if mibBuilder.loadTexts:
...
rlQosQueueShapeProfileEntry = _RlQosQueueShapeProfileEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1)
)
rlQosQueueShapeProfileEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosQueueShapeIndex"),
)
if mibBuilder.loadTexts:
...
rlQosQueueShapeIndex = _RlQosQueueShapeIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 1),
...
rlQosCirQueue1 = _RlQosCirQueue1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 2),
...
rlQosCbsQueue1 = _RlQosCbsQueue1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 3),
...
rlQosCirQueue2 = _RlQosCirQueue2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 4),
...
rlQosCbsQueue2 = _RlQosCbsQueue2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 5),
...
rlQosCirQueue3 = _RlQosCirQueue3_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 6),
...
rlQosCbsQueue3 = _RlQosCbsQueue3_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 7),
...
rlQosCirQueue4 = _RlQosCirQueue4_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 8),
...
rlQosCbsQueue4 = _RlQosCbsQueue4_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 9),
...
rlQosCirQueue5 = _RlQosCirQueue5_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 10),
...
rlQosCbsQueue5 = _RlQosCbsQueue5_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 11),
...
rlQosCirQueue6 = _RlQosCirQueue6_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 12),
...
rlQosCbsQueue6 = _RlQosCbsQueue6_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 13),
...
rlQosCirQueue7 = _RlQosCirQueue7_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 14),
...
rlQosCbsQueue7 = _RlQosCbsQueue7_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 15),
...
rlQosCirQueue8 = _RlQosCirQueue8_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 16),
...
rlQosCbsQueue8 = _RlQosCbsQueue8_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 17),
...
rlQosQueueShapeProfileStatus = _RlQosQueueShapeProfileStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 23, 1, 18),
...
rlQosAclCounterTable = _RlQosAclCounterTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 24)
)
if mibBuilder.loadTexts:
...
rlQosAclCounterEntry = _RlQosAclCounterEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 24, 1)
)
rlQosAclCounterEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosAclCounterInterface"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosAclCounterAclIndex"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosAclCounterAceIndex"),
)
if mibBuilder.loadTexts:
...
rlQosAclCounterInterface = _RlQosAclCounterInterface_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 24, 1, 1),
...
rlQosAclCounterAclIndex = _RlQosAclCounterAclIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 24, 1, 2),
...
rlQosAclCounterAceIndex = _RlQosAclCounterAceIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 24, 1, 3),
...
rlQosAclCounterValue = _RlQosAclCounterValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 24, 1, 4),
...
rlQosFreeIndexesTable = _RlQosFreeIndexesTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 25)
)
if mibBuilder.loadTexts:
...
rlQosFreeIndexesEntry = _RlQosFreeIndexesEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 25, 1)
)
rlQosFreeIndexesEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosFreeIndexesTableId"),
)
if mibBuilder.loadTexts:
...
rlQosFreeIndexesTableId = _RlQosFreeIndexesTableId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 25, 1, 1),
...
rlQosFreeIndexesValue = _RlQosFreeIndexesValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 25, 1, 2),
...
rlQosNamesToIndexesTable = _RlQosNamesToIndexesTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 26)
)
if mibBuilder.loadTexts:
...
rlQosNamesToIndexesEntry = _RlQosNamesToIndexesEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 26, 1)
)
rlQosNamesToIndexesEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosNamesToIndexesTableId"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosNamesToIndexesName"),
)
if mibBuilder.loadTexts:
...
rlQosNamesToIndexesTableId = _RlQosNamesToIndexesTableId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 26, 1, 1),
...
rlQosNamesToIndexesName = _RlQosNamesToIndexesName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 26, 1, 2),
...
rlQosNamesToIndexesValue = _RlQosNamesToIndexesValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 26, 1, 3),
...
rlQosStackControlQueue = _RlQosStackControlQueue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 27),
...
rlQosStackControlCos = _RlQosStackControlCos_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 28),
...
rlQosCosQueueDefaultMapTable = _RlQosCosQueueDefaultMapTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 29)
)
if mibBuilder.loadTexts:
...
rlQosCosQueueDefaultMapEntry = _RlQosCosQueueDefaultMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 29, 1)
)
rlQosCosQueueDefaultMapEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosCosQueueDefaultMapVpt"),
)
if mibBuilder.loadTexts:
...
rlQosCosQueueDefaultMapVpt = _RlQosCosQueueDefaultMapVpt_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 29, 1, 1),
...
rlQosCosQueueDefaultMapQueueId = _RlQosCosQueueDefaultMapQueueId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 29, 1, 2),
...
rlQosPredefBlockAclTable = _RlQosPredefBlockAclTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 30)
)
if mibBuilder.loadTexts:
...
rlQosPredefBlockAclEntry = _RlQosPredefBlockAclEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 30, 1)
)
rlQosPredefBlockAclEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosPredefBlockAclIfIndex"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosPredefBlockAclIfType"),
)
if mibBuilder.loadTexts:
...
rlQosPredefBlockAclIfIndex = _RlQosPredefBlockAclIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 30, 1, 1),
...
rlQosPredefBlockAclIfType = _RlQosPredefBlockAclIfType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 30, 1, 2),
...
rlQosPredefBlockAclMask = _RlQosPredefBlockAclMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 30, 1, 3),
...
rlQosPredefBlockAclStatus = _RlQosPredefBlockAclStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 30, 1, 4),
...
rlQosAceTidxTable = _RlQosAceTidxTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31)
)
if mibBuilder.loadTexts:
    rlQosAceTidxTable.setStatus("current")
_RlQosAceTidxEntry_Object = MibTableRow
rlQosAceTidxEntry = _RlQosAceTidxEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1)
)
rlQosAceTidxEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosAceTidxAclIndex"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosAceTidxIndex"),
)
if mibBuilder.loadTexts:
...
rlQosAceTidxAclIndex = _RlQosAceTidxAclIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 1),
...
rlQosAceTidxIndex = _RlQosAceTidxIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 2),
...
rlQosAceTidxAction = _RlQosAceTidxAction_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 3),
...
rlQosAceTidxType = _RlQosAceTidxType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 4),
...
rlQosAceTidxTuple1 = _RlQosAceTidxTuple1_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 5),
...
rlQosAceTidxTuple2 = _RlQosAceTidxTuple2_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 6),
...
rlQosAceTidxTuple3 = _RlQosAceTidxTuple3_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 7),
...
rlQosAceTidxTuple4 = _RlQosAceTidxTuple4_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 8),
...
rlQosAceTidxTuple5 = _RlQosAceTidxTuple5_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 9),
...
rlQosAceTidxTuple6 = _RlQosAceTidxTuple6_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 10),
...
rlQosAceTidxTuple7 = _RlQosAceTidxTuple7_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 11),
...
rlQosAceTidxTuple8 = _RlQosAceTidxTuple8_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 12),
...
rlQosAceTidxAccount = _RlQosAceTidxAccount_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 13),
...
rlQosAceTidxStatus = _RlQosAceTidxStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 14),
...
rlQosAceTidxTimeRange = _RlQosAceTidxTimeRange_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 15),
...
rlQosAceTidxTimeRangeIsActive = _RlQosAceTidxTimeRangeIsActive_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 31, 1, 16),
...
rlQosMibVersion = _RlQosMibVersion_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 32),
...
rlQosDscpQueueDefaultMapTable = _RlQosDscpQueueDefaultMapTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 33)
)
if mibBuilder.loadTexts:
...
rlQosDscpQueueDefaultMapEntry = _RlQosDscpQueueDefaultMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 33, 1)
)
rlQosDscpQueueDefaultMapEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosDscpQueueDefaultMapDscp"),
)
if mibBuilder.loadTexts:
...
rlQosDscpQueueDefaultMapDscp = _RlQosDscpQueueDefaultMapDscp_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 33, 1, 1),
...
rlQosDscpQueueDefaultMapQueueId = _RlQosDscpQueueDefaultMapQueueId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 33, 1, 2),
...
rlQosDscp = _RlQosDscp_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 34, 1, 1),
    _RlQosDscp_Type()
)
...
rlQosDp = _RlQosDp_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 34, 1, 2),
    _RlQosDp_Type()
)
...
rlQosPortPolicyStatisticsEntry = _RlQosPortPolicyStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 1, 1)
)
rlQosPortPolicyStatisticsEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlIfIndex"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlIfType"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosPortPolicyStatisticsCntrType"),
)
if mibBuilder.loadTexts:
...
rlQosPortPolicyStatisticsCntrType = _RlQosPortPolicyStatisticsCntrType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 1, 1, 1),
...
rlQosPortPolicyStatisticsCntrNumOfBits = _RlQosPortPolicyStatisticsCntrNumOfBits_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 1, 1, 2),
...
rlQosPortPolicyStatisticsEnableCounting = _RlQosPortPolicyStatisticsEnableCounting_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 1, 1, 3),
...
rlQosPortPolicyStatisticsCounterValue = _RlQosPortPolicyStatisticsCounterValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 1, 1, 4),
...
rlQosSinglePolicerStatisticsTable = _RlQosSinglePolicerStatisticsTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 2)
)
if mibBuilder.loadTexts:
...
rlQosSinglePolicerStatisticsEntry = _RlQosSinglePolicerStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 2, 1)
)
...
rlQosSinglePolicerStatisticsInProfileCounterValue = _RlQosSinglePolicerStatisticsInProfileCounterValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 2, 1, 1),
...
rlQosSinglePolicerStatisticsInProfileCntrNumOfBits = _RlQosSinglePolicerStatisticsInProfileCntrNumOfBits_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 2, 1, 2),
...
rlQosSinglePolicerStatisticsOutProfileCounterValue = _RlQosSinglePolicerStatisticsOutProfileCounterValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 2, 1, 3),
...
rlQosSinglePolicerStatisticsOutProfileCntrNumOfBits = _RlQosSinglePolicerStatisticsOutProfileCntrNumOfBits_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 2, 1, 4),
...
rlQosSinglePolicerStatisticsStatus = _RlQosSinglePolicerStatisticsStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 2, 1, 5),
...
rlQosAggregatePolicerStatisticsTable = _RlQosAggregatePolicerStatisticsTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 3)
)
if mibBuilder.loadTexts:
...
rlQosAggregatePolicerStatisticsEntry = _RlQosAggregatePolicerStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 3, 1)
)
...
rlQosAggregatePolicerStatisticsInProfileCounterValue = _RlQosAggregatePolicerStatisticsInProfileCounterValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 3, 1, 1),
...
rlQosAggregatePolicerStatisticsInProfileCntrNumOfBits = _RlQosAggregatePolicerStatisticsInProfileCntrNumOfBits_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 3, 1, 2),
...
rlQosAggregatePolicerStatisticsOutProfileCounterValue = _RlQosAggregatePolicerStatisticsOutProfileCounterValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 3, 1, 3),
...
rlQosAggregatePolicerStatisticsOutProfileCntrNumOfBits = _RlQosAggregatePolicerStatisticsOutProfileCntrNumOfBits_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 3, 1, 4),
...
rlQosAggregatePolicerStatisticsStatus = _RlQosAggregatePolicerStatisticsStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 3, 1, 5),
...
rlQosOutQueueStatisticsTable = _RlQosOutQueueStatisticsTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4)
)
if mibBuilder.loadTexts:
...
rlQosOutQueueStatisticsEntry = _RlQosOutQueueStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1)
)
rlQosOutQueueStatisticsEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosOutQueueStatisticsCountrID"),
)
if mibBuilder.loadTexts:
...
rlQosOutQueueStatisticsCountrID = _RlQosOutQueueStatisticsCountrID_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 1),
...
rlQosOutQueueStatisticsIfIndexList = _RlQosOutQueueStatisticsIfIndexList_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 2),
...
rlQosOutQueueStatisticsPortAll = _RlQosOutQueueStatisticsPortAll_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 3),
...
rlQosOutQueueStatisticsVlan = _RlQosOutQueueStatisticsVlan_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 4),
...
rlQosOutQueueStatisticsVlanAll = _RlQosOutQueueStatisticsVlanAll_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 5),
...
rlQosOutQueueStatisticsQueue = _RlQosOutQueueStatisticsQueue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 6),
...
rlQosOutQueueStatisticsQueueAll = _RlQosOutQueueStatisticsQueueAll_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 7),
...
rlQosOutQueueStatisticsDP = _RlQosOutQueueStatisticsDP_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 8),
...
rlQosOutQueueStatisticsDPAll = _RlQosOutQueueStatisticsDPAll_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 9),
...
rlQosOutQueueStatisticsCounterTailDropValue = _RlQosOutQueueStatisticsCounterTailDropValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 10),
...
rlQosOutQueueStatisticsCounterAllValue = _RlQosOutQueueStatisticsCounterAllValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 11),
...
rlQosOutQueueStatisticsCntrNumOfBits = _RlQosOutQueueStatisticsCntrNumOfBits_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 12),
...
rlQosOutQueueStatisticsStatus = _RlQosOutQueueStatisticsStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 4, 1, 13),
...
rlQosGlobalStatisticsCntrsTable = _RlQosGlobalStatisticsCntrsTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 5)
)
if mibBuilder.loadTexts:
...
rlQosGlobalStatisticsCntrsEntry = _RlQosGlobalStatisticsCntrsEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 5, 1)
)
rlQosGlobalStatisticsCntrsEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosGlobalStatisticsCntrsType"),
)
if mibBuilder.loadTexts:
...
rlQosGlobalStatisticsCntrsType = _RlQosGlobalStatisticsCntrsType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 5, 1, 1),
...
rlQosGlobalStatisticsCntrsNumOfBits = _RlQosGlobalStatisticsCntrsNumOfBits_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 5, 1, 2),
...
rlQosGlobalStatisticsCntrsCounterValue = _RlQosGlobalStatisticsCntrsCounterValue_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 5, 1, 3),
...
rlQosGlobalStatisticsStatus = _RlQosGlobalStatisticsStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 5, 1, 4),
...
rlQosClearCounters = _RlQosClearCounters_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 35, 6),
...
rlQosClassifierUtilizationEntry = _RlQosClassifierUtilizationEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 36, 1, 1)
)
rlQosClassifierUtilizationEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosClassifierUtilizationUnitId"),
)
if mibBuilder.loadTexts:
...
rlQosClassifierUtilizationUnitId = _RlQosClassifierUtilizationUnitId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 36, 1, 1, 1),
...
rlQosClassifierUtilizationPercent = _RlQosClassifierUtilizationPercent_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 36, 1, 1, 2),
...
rlQosClassifierUtilizationRulesNumber = _RlQosClassifierUtilizationRulesNumber_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 36, 1, 1, 3),
...
rlQosClassifierUtilizationSystem = _RlQosClassifierUtilizationSystem_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 36, 2),
...
rlQosClassifierRulesNumberUtilizationSystem = _RlQosClassifierRulesNumberUtilizationSystem_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 36, 3),
...
rlQosPortToProfileMappingTable = _RlQosPortToProfileMappingTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 37)
)
if mibBuilder.loadTexts:
...
rlQosPortToProfileMappingEntry = _RlQosPortToProfileMappingEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 37, 1)
)
rlQosPortToProfileMappingEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosPort"),
)
if mibBuilder.loadTexts:
...
rlQosPort = _RlQosPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 37, 1, 1),
    _RlQosPort_Type()
)
...
rlQosProfileName = _RlQosProfileName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 37, 1, 2),
...
rlQosTimeBasedAclTable = _RlQosTimeBasedAclTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 38)
)
if mibBuilder.loadTexts:
    rlQosTimeBasedAclTable.setStatus("current")
_RlQosTimeBasedAclEntry_Object = MibTableRow
rlQosTimeBasedAclEntry = _RlQosTimeBasedAclEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 38, 1)
)
rlQosTimeBasedAclEntry.setIndexNames(
    (1, "DLINK-3100-QOS-CLI-MIB", "rlQosTimeBasedAclRangeName"),
)
if mibBuilder.loadTexts:
    rlQosTimeBasedAclEntry.setStatus("current")


class _RlQosTimeBasedAclRangeName_Type(DisplayString):
    """Custom type rlQosTimeBasedAclRangeName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_RlQosTimeBasedAclRangeName_Type.__name__ = "DisplayString"
_RlQosTimeBasedAclRangeName_Object = MibTableColumn
rlQosTimeBasedAclRangeName = _RlQosTimeBasedAclRangeName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 38, 1, 1),
    _RlQosTimeBasedAclRangeName_Type()
)
rlQosTimeBasedAclRangeName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    rlQosTimeBasedAclRangeName.setStatus("current")


class _RlQosTimeBasedAclAbsStart_Type(DisplayString):
    """Custom type rlQosTimeBasedAclAbsStart based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_RlQosTimeBasedAclAbsStart_Type.__name__ = "DisplayString"
_RlQosTimeBasedAclAbsStart_Object = MibTableColumn
rlQosTimeBasedAclAbsStart = _RlQosTimeBasedAclAbsStart_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 38, 1, 2),
    _RlQosTimeBasedAclAbsStart_Type()
)
rlQosTimeBasedAclAbsStart.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlQosTimeBasedAclAbsStart.setStatus("current")


class _RlQosTimeBasedAclAbsEnd_Type(DisplayString):
    """Custom type rlQosTimeBasedAclAbsEnd based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 14),
    )
...
_RlQosTimeBasedAclAbsEnd_Type.__name__ = "DisplayString"
_RlQosTimeBasedAclAbsEnd_Object = MibTableColumn
rlQosTimeBasedAclAbsEnd = _RlQosTimeBasedAclAbsEnd_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 38, 1, 3),
    _RlQosTimeBasedAclAbsEnd_Type()
)
rlQosTimeBasedAclAbsEnd.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlQosTimeBasedAclAbsEnd.setStatus("current")
_RlQosTimeBasedAclStatus_Type = RowStatus
_RlQosTimeBasedAclStatus_Object = MibTableColumn
rlQosTimeBasedAclStatus = _RlQosTimeBasedAclStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 38, 1, 4),
    _RlQosTimeBasedAclStatus_Type()
)
rlQosTimeBasedAclStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlQosTimeBasedAclStatus.setStatus("current")
_RlQosTimeBasedAclPeriodicTable_Object = MibTable
rlQosTimeBasedAclPeriodicTable = _RlQosTimeBasedAclPeriodicTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 39)
)
if mibBuilder.loadTexts:
    rlQosTimeBasedAclPeriodicTable.setStatus("current")
_RlQosTimeBasedAclPeriodicEntry_Object = MibTableRow
rlQosTimeBasedAclPeriodicEntry = _RlQosTimeBasedAclPeriodicEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 39, 1)
)
rlQosTimeBasedAclPeriodicEntry.setIndexNames(
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosTimeBasedAclPeriodicName"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosTimeBasedAclPeriodicWeekList"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosTimeBasedAclPeriodicStart"),
    (0, "DLINK-3100-QOS-CLI-MIB", "rlQosTimeBasedAclPeriodicEnd"),
)
if mibBuilder.loadTexts:
    rlQosTimeBasedAclPeriodicEntry.setStatus("current")


class _RlQosTimeBasedAclPeriodicName_Type(DisplayString):
    """Custom type rlQosTimeBasedAclPeriodicName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_RlQosTimeBasedAclPeriodicName_Type.__name__ = "DisplayString"
_RlQosTimeBasedAclPeriodicName_Object = MibTableColumn
rlQosTimeBasedAclPeriodicName = _RlQosTimeBasedAclPeriodicName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 39, 1, 1),
    _RlQosTimeBasedAclPeriodicName_Type()
)
rlQosTimeBasedAclPeriodicName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    rlQosTimeBasedAclPeriodicName.setStatus("current")
...
rlQosTimeBasedAclPeriodicWeekList = _RlQosTimeBasedAclPeriodicWeekList_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 39, 1, 2),
    _RlQosTimeBasedAclPeriodicWeekList_Type()
)
rlQosTimeBasedAclPeriodicWeekList.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlQosTimeBasedAclPeriodicWeekList.setStatus("current")


class _RlQosTimeBasedAclPeriodicStart_Type(DisplayString):
    """Custom type rlQosTimeBasedAclPeriodicStart based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_RlQosTimeBasedAclPeriodicStart_Type.__name__ = "DisplayString"
_RlQosTimeBasedAclPeriodicStart_Object = MibTableColumn
rlQosTimeBasedAclPeriodicStart = _RlQosTimeBasedAclPeriodicStart_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 39, 1, 3),
    _RlQosTimeBasedAclPeriodicStart_Type()
)
rlQosTimeBasedAclPeriodicStart.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlQosTimeBasedAclPeriodicStart.setStatus("current")


class _RlQosTimeBasedAclPeriodicEnd_Type(DisplayString):
    """Custom type rlQosTimeBasedAclPeriodicEnd based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 7),
    )
...
_RlQosTimeBasedAclPeriodicEnd_Type.__name__ = "DisplayString"
_RlQosTimeBasedAclPeriodicEnd_Object = MibTableColumn
rlQosTimeBasedAclPeriodicEnd = _RlQosTimeBasedAclPeriodicEnd_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 39, 1, 4),
    _RlQosTimeBasedAclPeriodicEnd_Type()
)
rlQosTimeBasedAclPeriodicEnd.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlQosTimeBasedAclPeriodicEnd.setStatus("current")
_RlQosTimeBasedAclPeriodicStatus_Type = RowStatus
_RlQosTimeBasedAclPeriodicStatus_Object = MibTableColumn
rlQosTimeBasedAclPeriodicStatus = _RlQosTimeBasedAclPeriodicStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 39, 1, 5),
    _RlQosTimeBasedAclPeriodicStatus_Type()
)
rlQosTimeBasedAclPeriodicStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlQosTimeBasedAclPeriodicStatus.setStatus("current")
...
rlQosCPUSafeGuardEnable = _RlQosCPUSafeGuardEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 40),
...
rlQosTcamUpdateSemaphore = _RlQosTcamUpdateSemaphore_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 88, 41),
    _RlQosTcamUpdateSemaphore_Type()
)
rlQosTcamUpdateSemaphore.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlQosTcamUpdateSemaphore.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ClassOffsetType": ClassOffsetType,
       ...
       "rlQosTimeBasedAclTable": rlQosTimeBasedAclTable,
       "rlQosTimeBasedAclEntry": rlQosTimeBasedAclEntry,
       "rlQosTimeBasedAclRangeName": rlQosTimeBasedAclRangeName,
       "rlQosTimeBasedAclAbsStart": rlQosTimeBasedAclAbsStart,
       "rlQosTimeBasedAclAbsEnd": rlQosTimeBasedAclAbsEnd,
       "rlQosTimeBasedAclStatus": rlQosTimeBasedAclStatus,
       "rlQosTimeBasedAclPeriodicTable": rlQosTimeBasedAclPeriodicTable,
       "rlQosTimeBasedAclPeriodicEntry": rlQosTimeBasedAclPeriodicEntry,
       "rlQosTimeBasedAclPeriodicName": rlQosTimeBasedAclPeriodicName,
       "rlQosTimeBasedAclPeriodicWeekList": rlQosTimeBasedAclPeriodicWeekList,
       "rlQosTimeBasedAclPeriodicStart": rlQosTimeBasedAclPeriodicStart,
       "rlQosTimeBasedAclPeriodicEnd": rlQosTimeBasedAclPeriodicEnd,
       "rlQosTimeBasedAclPeriodicStatus": rlQosTimeBasedAclPeriodicStatus,
       "rlQosCPUSafeGuardEnable": rlQosCPUSafeGuardEnable,
       "rlQosTcamUpdateSemaphore": rlQosTcamUpdateSemaphore}
)
