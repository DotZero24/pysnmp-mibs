...
mibBuilder.exportSymbols("AT-ISDN-MIB", ccDetailsInAnyFlag=ccDetailsInAnyFlag, ccDetailsPriority=ccDetailsPriority, ccCallLogDuration=ccCallLogDuration, ccActiveCallDataRate=ccActiveCallDataRate, ccActiveCallTable=ccActiveCallTable, ccActiveCallUserModule=ccActiveCallUserModule, ccDetailsInSetupCliCheckList=ccDetailsInSetupCliCheckList, ccBchannelPriority=ccBchannelPriority, ccDetailsRemoteName=ccDetailsRemoteName, ccBchannelCallType=ccBchannelCallType, ccDetailsAlternateNumber=ccDetailsAlternateNumber, ccDetailsDirection=ccDetailsDirection, ccCliListEntry=ccCliListEntry, ccDetailsRetryT2=ccDetailsRetryT2, ccDetailsTable=ccDetailsTable, ccDetailsInSetupUserSearch=ccDetailsInSetupUserSearch, ccCallLogRemoteNumber=ccCallLogRemoteNumber, ccDetailsUsername=ccDetailsUsername, ccAttachmentUserInstance=ccAttachmentUserInstance, ccActiveCallDirection=ccActiveCallDirection, ccCliListListIndex=ccCliListListIndex, ccAttachmentDetailsIndex=ccAttachmentDetailsIndex, ccAttachmentActiveCallIndex=ccAttachmentActiveCallIndex, ccDetailsName=ccDetailsName, cc=cc, ccDetailsCallbackDelay=ccDetailsCallbackDelay, ccDetailsDataRate=ccDetailsDataRate, ccCallLogState=ccCallLogState, ccCallLogEntry=ccCallLogEntry, ccActiveCallIfIndex=ccActiveCallIfIndex, ccAttachmentEntry=ccAttachmentEntry, ccAttachmentTable=ccAttachmentTable, ccDetailsEnabled=ccDetailsEnabled, ccActiveCallState=ccActiveCallState, ccActiveCallBchannelIndex=ccActiveCallBchannelIndex, ccDetailsOutSubaddress=ccDetailsOutSubaddress, ccAttachmentEntryIndex=ccAttachmentEntryIndex, ccDetailsPassword=ccDetailsPassword, ccCliListEntryIndex=ccCliListEntryIndex, ccBchannelDirection=ccBchannelDirection, ccDetailsCallback=ccDetailsCallback, ccDetailsPppTemplate=ccDetailsPppTemplate, ccActiveCallUserInstance=ccActiveCallUserInstance, ccDetailsCallingNumber=ccDetailsCallingNumber, ccDetailsKeepup=ccDetailsKeepup, ccDetailsInSetupCliSearchList=ccDetailsInSetupCliSearchList, ccDetailsOutSetupUser=ccDetailsOutSetupUser, ccDetailsCalledNumber=ccDetailsCalledNumber, ccActiveCallIndex=ccActiveCallIndex, ccDetailsInSetupCliSearch=ccDetailsInSetupCliSearch, ccBchannelAllocated=ccBchannelAllocated, ccBchannelEntry=ccBchannelEntry, ccBchannelActiveCallIndex=ccBchannelActiveCallIndex, ccCallLogIndex=ccCallLogIndex, ccBchannelIfIndex=ccBchannelIfIndex, ccDetailsLoginType=ccDetailsLoginType, ccDetailsUserType=ccDetailsUserType, ccDetailsIndex=ccDetailsIndex, ccDetailsUserModule=ccDetailsUserModule, ccDetailsOutSetupCli=ccDetailsOutSetupCli, ccDetailsInSetupUserCheck=ccDetailsInSetupUserCheck, ccCallLogName=ccCallLogName, ccDetailsInSetupCalledSubCheck=ccDetailsInSetupCalledSubCheck, ccBchannelChannelIndex=ccBchannelChannelIndex, ccDetailsRetryT1=ccDetailsRetryT1, ccDetailsInSetupCalledSubSearch=ccDetailsInSetupCalledSubSearch, ccDetailsEntry=ccDetailsEntry, ccDetailsHoldupTime=ccDetailsHoldupTime, ccDetailsPreferredIfIndex=ccDetailsPreferredIfIndex, ccDetailsPrecedence=ccDetailsPrecedence, ccActiveCallDetailsIndex=ccActiveCallDetailsIndex, ccDetailsRetryN1=ccDetailsRetryN1, ccCliListNumber=ccCliListNumber, ccDetailsNumberAttachments=ccDetailsNumberAttachments, ccDetailsRequiredIfIndex=ccDetailsRequiredIfIndex, PYSNMP_MODULE_ID=cc, ccCliListTable=ccCliListTable, ccDetailsOutSetupCalledSub=ccDetailsOutSetupCalledSub, ccCallLogTable=ccCallLogTable, ccDetailsRetryN2=ccDetailsRetryN2, ccDetailsInSetupCliCheck=ccDetailsInSetupCliCheck, ccActiveCallEntry=ccActiveCallEntry, ccBchannelTable=ccBchannelTable, ccCallLogDirection=ccCallLogDirection, ccDetailsBumpDelay=ccDetailsBumpDelay, ccCallLogTimeStarted=ccCallLogTimeStarted)
