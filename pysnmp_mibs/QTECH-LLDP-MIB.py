...
qtechLldpMIB=ModuleIdentity((1,3,6,1,4,1,27514,1,1,10,2,32))
if mibBuilder.loadTexts:qtechLldpMIB.setRevisions(('2003-04-01 00:00',))
_LldpMibObjects_ObjectIdentity=ObjectIdentity
lldpMibObjects=_LldpMibObjects_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,32,1))
_LldpConfig_ObjectIdentity=ObjectIdentity
lldpConfig=_LldpConfig_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,32,1,1))
...
lldpAdminStatus=_LldpAdminStatus_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,1,1),_LldpAdminStatus_Type())
...
lldpOperStatus=_LldpOperStatus_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,1,2),_LldpOperStatus_Type())
...
lldpMessageTxInterval=_LldpMessageTxInterval_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,1,3),_LldpMessageTxInterval_Type())
...
lldpMessageTxHoldTime=_LldpMessageTxHoldTime_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,1,4),_LldpMessageTxHoldTime_Type())
...
lldpDeviceID=_LldpDeviceID_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,1,5),_LldpDeviceID_Type())
lldpDeviceID.setMaxAccess(_B)
if mibBuilder.loadTexts:lldpDeviceID.setStatus(_A)
_LldpSuppressTable_Object=MibTable
lldpSuppressTable=_LldpSuppressTable_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,1,6))
if mibBuilder.loadTexts:lldpSuppressTable.setStatus(_A)
_LldpSuppressEntry_Object=MibTableRow
lldpSuppressEntry=_LldpSuppressEntry_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,1,6,1))
...
lldpSuppressPortIfIndex=_LldpSuppressPortIfIndex_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,1,6,1,1),_LldpSuppressPortIfIndex_Type())
...
lldpSuppressPortStatus=_LldpSuppressPortStatus_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,1,6,1,2),_LldpSuppressPortStatus_Type())
...
lldpStats=_LldpStats_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,32,1,2))
_LldpStatsTable_Object=MibTable
lldpStatsTable=_LldpStatsTable_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,2,1))
if mibBuilder.loadTexts:lldpStatsTable.setStatus(_A)
_LldpStatsEntry_Object=MibTableRow
lldpStatsEntry=_LldpStatsEntry_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,2,1,1))
...
lldpStatsPortIfIndex=_LldpStatsPortIfIndex_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,2,1,1,1),_LldpStatsPortIfIndex_Type())
...
lldpStatsInGoodPkts=_LldpStatsInGoodPkts_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,2,1,1,2),_LldpStatsInGoodPkts_Type())
...
lldpStatsInErrors=_LldpStatsInErrors_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,2,1,1,3),_LldpStatsInErrors_Type())
...
lldpStatsOutPkts=_LldpStatsOutPkts_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,2,1,1,4),_LldpStatsOutPkts_Type())
...
lldpStatsClear=_LldpStatsClear_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,2,1,1,5),_LldpStatsClear_Type())
...
lldpRcvObjects=_LldpRcvObjects_ObjectIdentity((1,3,6,1,4,1,27514,1,1,10,2,32,1,3))
_LldpRcvTable_Object=MibTable
lldpRcvTable=_LldpRcvTable_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1))
if mibBuilder.loadTexts:lldpRcvTable.setStatus(_A)
_LldpRcvEntry_Object=MibTableRow
lldpRcvEntry=_LldpRcvEntry_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1))
...
lldpRcvIfIndex=_LldpRcvIfIndex_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,1),_LldpRcvIfIndex_Type())
...
lldpRcvDeviceID=_LldpRcvDeviceID_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,2),_LldpRcvDeviceID_Type())
...
lldpRcvMgmtAddress=_LldpRcvMgmtAddress_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,3),_LldpRcvMgmtAddress_Type())
...
lldpRcvPortIDSubtype=_LldpRcvPortIDSubtype_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,4),_LldpRcvPortIDSubtype_Type())
...
lldpRcvPortInfo=_LldpRcvPortInfo_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,5),_LldpRcvPortInfo_Type())
...
lldpRcvClusterMode=_LldpRcvClusterMode_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,6),_LldpRcvClusterMode_Type())
...
lldpRcvClusterStatus=_LldpRcvClusterStatus_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,7),_LldpRcvClusterStatus_Type())
...
lldpRcvClusterName=_LldpRcvClusterName_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,8),_LldpRcvClusterName_Type())
...
lldpRcvHostName=_LldpRcvHostName_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,9),_LldpRcvHostName_Type())
...
lldpRcvCommandAddress=_LldpRcvCommandAddress_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,1,1,10),_LldpRcvCommandAddress_Type())
...
lldpRcvTableClear=_LldpRcvTableClear_Object((1,3,6,1,4,1,27514,1,1,10,2,32,1,3,2),_LldpRcvTableClear_Type())
