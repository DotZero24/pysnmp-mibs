...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/paradyne/PDN-SPECTRUMMGMT-MIB
...
ifIndex, ifType = mibBuilder.importSymbols("IF-MIB", "ifIndex", "ifType")
...
mibBuilder.exportSymbols("PDN-SPECTRUMMGMT-MIB", pdnNewSpecMgmtObjects=pdnNewSpecMgmtObjects, spectrumMgmtAllowedSpeedsMin1=spectrumMgmtAllowedSpeedsMin1, pdnSpecMgmtObjects=pdnSpecMgmtObjects, newSpectrumMgmtConfEntry=newSpectrumMgmtConfEntry, newSpectrumMgmtGeneralConfigTable=newSpectrumMgmtGeneralConfigTable, newSpectrumMgmtXturMax2TxRate=newSpectrumMgmtXturMax2TxRate, pdnSpecMgmtCompliances=pdnSpecMgmtCompliances, newSpectrumMgmtXtucMin1TxRate=newSpectrumMgmtXtucMin1TxRate, newSpectrumMgmtLoopMeasurementMethod=newSpectrumMgmtLoopMeasurementMethod, newSpectrumMgmtXturMin2TxRate=newSpectrumMgmtXturMin2TxRate, newSpectrumMgmtMinEWL=newSpectrumMgmtMinEWL, pdnEWLModeGroup=pdnEWLModeGroup, newSpectrumMgmtConfLoopLength=newSpectrumMgmtConfLoopLength, pdnLoopLengthModeGroup=pdnLoopLengthModeGroup, newSpectrumMgmtXturMin1TxRate=newSpectrumMgmtXturMin1TxRate, newSpectrumMgmtEWLUnits=newSpectrumMgmtEWLUnits, newSpectrumMgmtXtucMaxTxPower=newSpectrumMgmtXtucMaxTxPower, newSpectrumMgmtGeneralConfigEntry=newSpectrumMgmtGeneralConfigEntry, pdnLineInfoGroup=pdnLineInfoGroup, pdnSpecMgmtGroups=pdnSpecMgmtGroups, pdnSpecMgmtConformance=pdnSpecMgmtConformance, newSpectrumMgmtXturMaxTxPower=newSpectrumMgmtXturMaxTxPower, spectrumMgmtEntry=spectrumMgmtEntry, spectrumMgmtCountryCode=spectrumMgmtCountryCode, pdnSpectrumMgmt=pdnSpectrumMgmt, newSpectrumMgmtXtucMax2TxRate=newSpectrumMgmtXtucMax2TxRate, pdnGeneralConfigGroup=pdnGeneralConfigGroup, newSpectrumMgmtXtucMax1TxRate=newSpectrumMgmtXtucMax1TxRate, newSpectrumMgmtMaxEWL=newSpectrumMgmtMaxEWL, PYSNMP_MODULE_ID=pdnSpectrumMgmt, spectrumMgmtLineLength=spectrumMgmtLineLength, newSpectrumMgmtConfQuadMode=newSpectrumMgmtConfQuadMode, spectrumMgmtAllowedSpeedsMin2=spectrumMgmtAllowedSpeedsMin2, spectrumMgmtAllowedSpeedsMax2=spectrumMgmtAllowedSpeedsMax2, newSpectrumMgmtLineInfoEntry=newSpectrumMgmtLineInfoEntry, newSpectrumMgmtMode=newSpectrumMgmtMode, pdnSpecMgmtCompliance=pdnSpecMgmtCompliance, pdnSpectrumMgmtDeprecatedGroup=pdnSpectrumMgmtDeprecatedGroup, newSpectrumMgmtXtucMin2TxRate=newSpectrumMgmtXtucMin2TxRate, newSpectrumMgmtConfEWL=newSpectrumMgmtConfEWL, newSpectrumMgmtXturMax1TxRate=newSpectrumMgmtXturMax1TxRate, spectrumMgmtEWL=spectrumMgmtEWL, newSpectrumMgmtLineInfoTable=newSpectrumMgmtLineInfoTable, spectrumMgmtAllowedSpeedsMax1=spectrumMgmtAllowedSpeedsMax1, newSpectrumMgmtConfTable=newSpectrumMgmtConfTable, newSpectrumMgmtSelection=newSpectrumMgmtSelection, pdnQuadModeGroup=pdnQuadModeGroup, spectrumMgmtTable=spectrumMgmtTable)
