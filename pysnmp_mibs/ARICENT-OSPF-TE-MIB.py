...
futOspfTeGeneralGroup=_FutOspfTeGeneralGroup_ObjectIdentity((1,3,6,1,4,1,2076,72,1))
...
futOspfTeAdminStatus=_FutOspfTeAdminStatus_Object((1,3,6,1,4,1,2076,72,1,1),_FutOspfTeAdminStatus_Type())
...
futOspfTeTraceLevel=_FutOspfTeTraceLevel_Object((1,3,6,1,4,1,2076,72,1,2),_FutOspfTeTraceLevel_Type())
...
futOspfTeCspfRunCnt=_FutOspfTeCspfRunCnt_Object((1,3,6,1,4,1,2076,72,1,3),_FutOspfTeCspfRunCnt_Type())
...
futOspfTeLsdbTable=_FutOspfTeLsdbTable_Object((1,3,6,1,4,1,2076,72,2))
if mibBuilder.loadTexts:futOspfTeLsdbTable.setStatus(_A)
_FutOspfTeLsdbEntry_Object=MibTableRow
futOspfTeLsdbEntry=_FutOspfTeLsdbEntry_Object((1,3,6,1,4,1,2076,72,2,1))
...
futOspfTeLsdbAreaId=_FutOspfTeLsdbAreaId_Object((1,3,6,1,4,1,2076,72,2,1,1),_FutOspfTeLsdbAreaId_Type())
...
futOspfTeLsdbType=_FutOspfTeLsdbType_Object((1,3,6,1,4,1,2076,72,2,1,2),_FutOspfTeLsdbType_Type())
...
futOspfTeLsdbLsid=_FutOspfTeLsdbLsid_Object((1,3,6,1,4,1,2076,72,2,1,3),_FutOspfTeLsdbLsid_Type())
...
futOspfTeLsdbRouterId=_FutOspfTeLsdbRouterId_Object((1,3,6,1,4,1,2076,72,2,1,4),_FutOspfTeLsdbRouterId_Type())
...
futOspfTeLsdbChecksum=_FutOspfTeLsdbChecksum_Object((1,3,6,1,4,1,2076,72,2,1,5),_FutOspfTeLsdbChecksum_Type())
...
futOspfTeLsdbAdvertisement=_FutOspfTeLsdbAdvertisement_Object((1,3,6,1,4,1,2076,72,2,1,6),_FutOspfTeLsdbAdvertisement_Type())
...
futOspfTeType9LsdbTable=_FutOspfTeType9LsdbTable_Object((1,3,6,1,4,1,2076,72,3))
if mibBuilder.loadTexts:futOspfTeType9LsdbTable.setStatus(_A)
_FutOspfTeType9LsdbEntry_Object=MibTableRow
futOspfTeType9LsdbEntry=_FutOspfTeType9LsdbEntry_Object((1,3,6,1,4,1,2076,72,3,1))
...
futOspfTeType9LsdbIfIpAddress=_FutOspfTeType9LsdbIfIpAddress_Object((1,3,6,1,4,1,2076,72,3,1,1),_FutOspfTeType9LsdbIfIpAddress_Type())
...
futOspfTeType9LsdbIfIndex=_FutOspfTeType9LsdbIfIndex_Object((1,3,6,1,4,1,2076,72,3,1,2),_FutOspfTeType9LsdbIfIndex_Type())
...
futOspfTeType9LsdbLsid=_FutOspfTeType9LsdbLsid_Object((1,3,6,1,4,1,2076,72,3,1,3),_FutOspfTeType9LsdbLsid_Type())
...
futOspfTeType9LsdbRouterId=_FutOspfTeType9LsdbRouterId_Object((1,3,6,1,4,1,2076,72,3,1,4),_FutOspfTeType9LsdbRouterId_Type())
...
futOspfTeType9LsdbChecksum=_FutOspfTeType9LsdbChecksum_Object((1,3,6,1,4,1,2076,72,3,1,5),_FutOspfTeType9LsdbChecksum_Type())
...
futOspfTeType9LsdbAdvertisement=_FutOspfTeType9LsdbAdvertisement_Object((1,3,6,1,4,1,2076,72,3,1,6),_FutOspfTeType9LsdbAdvertisement_Type())
...
futOspfTeAreaTable=_FutOspfTeAreaTable_Object((1,3,6,1,4,1,2076,72,4))
if mibBuilder.loadTexts:futOspfTeAreaTable.setStatus(_A)
_FutOspfTeAreaEntry_Object=MibTableRow
futOspfTeAreaEntry=_FutOspfTeAreaEntry_Object((1,3,6,1,4,1,2076,72,4,1))
...
futOspfTeAreaId=_FutOspfTeAreaId_Object((1,3,6,1,4,1,2076,72,4,1,1),_FutOspfTeAreaId_Type())
...
futOspfTeAreaLsaCount=_FutOspfTeAreaLsaCount_Object((1,3,6,1,4,1,2076,72,4,1,2),_FutOspfTeAreaLsaCount_Type())
...
futOspfTeType10AreaCksumSum=_FutOspfTeType10AreaCksumSum_Object((1,3,6,1,4,1,2076,72,4,1,3),_FutOspfTeType10AreaCksumSum_Type())
...
futOspfTeType2AreaCksumSum=_FutOspfTeType2AreaCksumSum_Object((1,3,6,1,4,1,2076,72,4,1,4),_FutOspfTeType2AreaCksumSum_Type())
...
futOspfTeIfTable=_FutOspfTeIfTable_Object((1,3,6,1,4,1,2076,72,5))
if mibBuilder.loadTexts:futOspfTeIfTable.setStatus(_A)
_FutOspfTeIfEntry_Object=MibTableRow
futOspfTeIfEntry=_FutOspfTeIfEntry_Object((1,3,6,1,4,1,2076,72,5,1))
...
futOspfTeIfIpAddress=_FutOspfTeIfIpAddress_Object((1,3,6,1,4,1,2076,72,5,1,1),_FutOspfTeIfIpAddress_Type())
...
futOspfTeAddressLessIf=_FutOspfTeAddressLessIf_Object((1,3,6,1,4,1,2076,72,5,1,2),_FutOspfTeAddressLessIf_Type())
...
futOspfTeIfAreaId=_FutOspfTeIfAreaId_Object((1,3,6,1,4,1,2076,72,5,1,3),_FutOspfTeIfAreaId_Type())
...
futOspfTeIfType=_FutOspfTeIfType_Object((1,3,6,1,4,1,2076,72,5,1,4),_FutOspfTeIfType_Type())
...
futOspfTeIfMetric=_FutOspfTeIfMetric_Object((1,3,6,1,4,1,2076,72,5,1,5),_FutOspfTeIfMetric_Type())
...
futOspfTeIfMaxBw=_FutOspfTeIfMaxBw_Object((1,3,6,1,4,1,2076,72,5,1,6),_FutOspfTeIfMaxBw_Type())
...
futOspfTeIfMaxReservBw=_FutOspfTeIfMaxReservBw_Object((1,3,6,1,4,1,2076,72,5,1,7),_FutOspfTeIfMaxReservBw_Type())
...
futOspfTeIfRsrcClassColor=_FutOspfTeIfRsrcClassColor_Object((1,3,6,1,4,1,2076,72,5,1,8),_FutOspfTeIfRsrcClassColor_Type())
...
futOspfTeIfOperStat=_FutOspfTeIfOperStat_Object((1,3,6,1,4,1,2076,72,5,1,9),_FutOspfTeIfOperStat_Type())
...
futOspfTeIfLinkId=_FutOspfTeIfLinkId_Object((1,3,6,1,4,1,2076,72,5,1,10),_FutOspfTeIfLinkId_Type())
...
futOspfTeIfRemoteIpAddr=_FutOspfTeIfRemoteIpAddr_Object((1,3,6,1,4,1,2076,72,5,1,11),_FutOspfTeIfRemoteIpAddr_Type())
...
futOspfTeIfProtectionType=_FutOspfTeIfProtectionType_Object((1,3,6,1,4,1,2076,72,5,1,12),_FutOspfTeIfProtectionType_Type())
...
futOspfTeIfSrlg=_FutOspfTeIfSrlg_Object((1,3,6,1,4,1,2076,72,5,1,13),_FutOspfTeIfSrlg_Type())
...
futOspfTeIfDescriptorTable=_FutOspfTeIfDescriptorTable_Object((1,3,6,1,4,1,2076,72,6))
if mibBuilder.loadTexts:futOspfTeIfDescriptorTable.setStatus(_A)
_FutOspfTeIfDescriptorEntry_Object=MibTableRow
futOspfTeIfDescriptorEntry=_FutOspfTeIfDescriptorEntry_Object((1,3,6,1,4,1,2076,72,6,1))
...
futOspfTeIfDescrIpAddress=_FutOspfTeIfDescrIpAddress_Object((1,3,6,1,4,1,2076,72,6,1,1),_FutOspfTeIfDescrIpAddress_Type())
...
futOspfTeIfDescrAddressLessIf=_FutOspfTeIfDescrAddressLessIf_Object((1,3,6,1,4,1,2076,72,6,1,2),_FutOspfTeIfDescrAddressLessIf_Type())
...
futOspfTeIfDescrId=_FutOspfTeIfDescrId_Object((1,3,6,1,4,1,2076,72,6,1,3),_FutOspfTeIfDescrId_Type())
...
futOspfTeIfDescrSwithingCap=_FutOspfTeIfDescrSwithingCap_Object((1,3,6,1,4,1,2076,72,6,1,4),_FutOspfTeIfDescrSwithingCap_Type())
...
futOspfTeIfDescrEncodingType=_FutOspfTeIfDescrEncodingType_Object((1,3,6,1,4,1,2076,72,6,1,5),_FutOspfTeIfDescrEncodingType_Type())
...
futOspfTeIfDescrMinLSPBandwidth=_FutOspfTeIfDescrMinLSPBandwidth_Object((1,3,6,1,4,1,2076,72,6,1,6),_FutOspfTeIfDescrMinLSPBandwidth_Type())
...
futOspfTeIfDescrMTU=_FutOspfTeIfDescrMTU_Object((1,3,6,1,4,1,2076,72,6,1,7),_FutOspfTeIfDescrMTU_Type())
...
futOspfTeIfDescrIndication=_FutOspfTeIfDescrIndication_Object((1,3,6,1,4,1,2076,72,6,1,8),_FutOspfTeIfDescrIndication_Type())
...
futOspfTeIfSwDescrMaxBwTable=_FutOspfTeIfSwDescrMaxBwTable_Object((1,3,6,1,4,1,2076,72,7))
if mibBuilder.loadTexts:futOspfTeIfSwDescrMaxBwTable.setStatus(_A)
_FutOspfTeIfSwDescrMaxBwEntry_Object=MibTableRow
futOspfTeIfSwDescrMaxBwEntry=_FutOspfTeIfSwDescrMaxBwEntry_Object((1,3,6,1,4,1,2076,72,7,1))
...
futOspfTeIfSwDescrMaxBwPriority=_FutOspfTeIfSwDescrMaxBwPriority_Object((1,3,6,1,4,1,2076,72,7,1,1),_FutOspfTeIfSwDescrMaxBwPriority_Type())
...
futOspfTeIfSwDescrMaxLSPBandwidth=_FutOspfTeIfSwDescrMaxLSPBandwidth_Object((1,3,6,1,4,1,2076,72,7,1,2),_FutOspfTeIfSwDescrMaxLSPBandwidth_Type())
...
futOspfTeIfBandwidthTable=_FutOspfTeIfBandwidthTable_Object((1,3,6,1,4,1,2076,72,8))
if mibBuilder.loadTexts:futOspfTeIfBandwidthTable.setStatus(_A)
_FutOspfTeIfBandwidthEntry_Object=MibTableRow
futOspfTeIfBandwidthEntry=_FutOspfTeIfBandwidthEntry_Object((1,3,6,1,4,1,2076,72,8,1))
...
futOspfTeIfBandwidthPriority=_FutOspfTeIfBandwidthPriority_Object((1,3,6,1,4,1,2076,72,8,1,1),_FutOspfTeIfBandwidthPriority_Type())
...
futOspfTeIfUnreservedBandwidth=_FutOspfTeIfUnreservedBandwidth_Object((1,3,6,1,4,1,2076,72,8,1,2),_FutOspfTeIfUnreservedBandwidth_Type())
