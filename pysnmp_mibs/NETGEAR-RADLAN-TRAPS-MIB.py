...
_E='NETGEAR-RADLAN-BRIDGEMIBOBJECTS-MIB'
_D='current'
_C='rndErrorSeverity'
_B='rndErrorDesc'
_A='NETGEAR-RADLAN-DEVICEPARAMS-MIB'
...
rsIpZhrReqStaticConnNotAccepted=NotificationType((1,3,6,1,4,1,4526,17,0,71))
...
rldot1dStpPortStateNotForwarding=NotificationType((1,3,6,1,4,1,4526,17,0,152))
...
rldot1xPortStatusUnauthorizedTrap=NotificationType((1,3,6,1,4,1,4526,17,0,185))
...
rldot1xSupplicantMacUnauthorizedTrap=NotificationType((1,3,6,1,4,1,4526,17,0,204))
