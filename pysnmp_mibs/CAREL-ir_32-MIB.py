# SNMP MIB module (CAREL-ir_32-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/carel/CAREL-ir_32-MIB
...
if mibBuilder.loadTexts:
    set_fan_off_rel.setUnits("R C/F x10")
