...
mibBuilder.exportSymbols("COLUBRIS-TOOLS-MIB", PYSNMP_MODULE_ID=colubrisToolsMIB, traceToolConfig=traceToolConfig, traceNotificationEnabled=traceNotificationEnabled, traceStatusNotification=traceStatusNotification, tracePacketSize=tracePacketSize, colubrisToolsNotificationGroup=colubrisToolsNotificationGroup, colubrisToolsMIBCompliance=colubrisToolsMIBCompliance, colubrisToolsMIBGroups=colubrisToolsMIBGroups, traceInterface=traceInterface, colubrisToolsMIBCompliances=colubrisToolsMIBCompliances, colubrisToolsMIBObjects=colubrisToolsMIBObjects, colubrisToolsMIBConformance=colubrisToolsMIBConformance, traceCaptureDestination=traceCaptureDestination, colubrisToolsMIBNotificationPrefix=colubrisToolsMIBNotificationPrefix, colubrisToolsMIBGroup=colubrisToolsMIBGroup, colubrisToolsMIBNotifications=colubrisToolsMIBNotifications, traceNumberOfPackets=traceNumberOfPackets, traceCaptureFilter=traceCaptureFilter, colubrisToolsMIB=colubrisToolsMIB, traceTimeout=traceTimeout, traceCaptureDestinationURL=traceCaptureDestinationURL, traceCaptureStatus=traceCaptureStatus)
