...
mibBuilder.exportSymbols("ONEACCESS-SYS-MIB", oacSysIMSysMainCPU=oacSysIMSysMainCPU, oacExpIMSysHwcManufacturer=oacExpIMSysHwcManufacturer, oacSysStartCaused=oacSysStartCaused, oacExpIMSysFactoryProductSalesCode=oacExpIMSysFactoryProductSalesCode, oacExpIMSysHwcIndex=oacExpIMSysHwcIndex, oacSysMemoryTotal=oacSysMemoryTotal, oacSysIMSysMainBootDateCreation=oacSysIMSysMainBootDateCreation, oacSysCpuUsedValue=oacSysCpuUsedValue, oacExpIMSysHwcManufacturedDate=oacExpIMSysHwcManufacturedDate, oacSysCpuStatistics=oacSysCpuStatistics, oacExpIMSysHwcSerialNumber=oacExpIMSysHwcSerialNumber, oacSysCpuUsedOneMinuteValue=oacSysCpuUsedOneMinuteValue, OASysHwcType=OASysHwcType, oacSysCpuUsedCoreType=oacSysCpuUsedCoreType, oacExpIMSysHwcProductName=oacExpIMSysHwcProductName, oacExpIMSysHardwareDescription=oacExpIMSysHardwareDescription, oacExpIMSysHwcType=oacExpIMSysHwcType, oacExpIMSysFactorySupplierID=oacExpIMSysFactorySupplierID, oacExpIMSysFactory=oacExpIMSysFactory, oacSysCpuUsedCoresTable=oacSysCpuUsedCoresTable, oacSysCpuUsed=oacSysCpuUsed, oacExpIMSysFactoryHwRevision=oacExpIMSysFactoryHwRevision, oacSysIMSysMainBoard=oacSysIMSysMainBoard, oacSysIMSysMainBSPVersion=oacSysIMSysMainBSPVersion, oacSysCpuUsedIndex=oacSysCpuUsedIndex, oacSysIMSysMainManufacturedIdentity=oacSysIMSysMainManufacturedIdentity, oacExpIMSysHwComponentsTable=oacExpIMSysHwComponentsTable, oacSysMemoryAllocated=oacSysMemoryAllocated, oacExpIMSysHwComponentsEntry=oacExpIMSysHwComponentsEntry, oacExpIMSysHwComponents=oacExpIMSysHwComponents, oacSysIMSysMainIdentifier=oacSysIMSysMainIdentifier, oacSysLastRebootCause=oacSysLastRebootCause, oacExpIMSysHwcDescription=oacExpIMSysHwcDescription, PYSNMP_MODULE_ID=oacSysMIBModule, oacSysIMSysMainManufacturedDate=oacSysIMSysMainManufacturedDate, oacSysMemoryUsed=oacSysMemoryUsed, OASysHwcClass=OASysHwcClass, OASysCoreType=OASysCoreType, oacSysCpuUsedCoresEntry=oacSysCpuUsedCoresEntry, oacExpIMSysHwComponentsCount=oacExpIMSysHwComponentsCount, oacSysMemStatistics=oacSysMemStatistics, oacSysIMSysMainBootVersion=oacSysIMSysMainBootVersion, oacExpIMSysStatistics=oacExpIMSysStatistics, oacExpIMSysHwcClass=oacExpIMSysHwcClass, oacSysSecureCrashlogCount=oacSysSecureCrashlogCount, oacSysMemoryFree=oacSysMemoryFree, oacSysMIBModule=oacSysMIBModule, oacSysCpuUsedCoresCount=oacSysCpuUsedCoresCount)
