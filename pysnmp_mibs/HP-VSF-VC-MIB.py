...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-VSF-VC-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:38:07 2025
...
class _HpicfVsfVCMemberCount_Type(Integer32):
    """Custom type hpicfVsfVCMemberCount based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_HpicfVsfVCMemberCount_Type.__name__ = "Integer32"
_HpicfVsfVCMemberCount_Object = MibScalar
hpicfVsfVCMemberCount = _HpicfVsfVCMemberCount_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 1, 1, 15),
    _HpicfVsfVCMemberCount_Type()
)
hpicfVsfVCMemberCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpicfVsfVCMemberCount.setStatus("current")


class _HpicfVsfVCActiveMemberCount_Type(Integer32):
    """Custom type hpicfVsfVCActiveMemberCount based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 8),
    )
...
_HpicfVsfVCActiveMemberCount_Type.__name__ = "Integer32"
_HpicfVsfVCActiveMemberCount_Object = MibScalar
hpicfVsfVCActiveMemberCount = _HpicfVsfVCActiveMemberCount_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 1, 1, 16),
    _HpicfVsfVCActiveMemberCount_Type()
)
hpicfVsfVCActiveMemberCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpicfVsfVCActiveMemberCount.setStatus("current")
...
if mibBuilder.loadTexts:
    hpicfVsfVCConfigScalarGroup1.setStatus("deprecated")

hpicfVsfVCConfigScalarGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 2, 2, 9)
)
hpicfVsfVCConfigScalarGroup2.setObjects(
      *(("HP-VSF-VC-MIB", "hpicfVsfVCDomainId"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCOperStatus"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCAdminStatus"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCTopology"),
        ...
        ("HP-VSF-VC-MIB", "hpicfVsfMADVlanConnectivity"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCPortSpeed"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCMemberCount"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCActiveMemberCount"))
)
if mibBuilder.loadTexts:
    hpicfVsfVCConfigScalarGroup2.setStatus("current")
...
hpicfVsfVCStackTopoChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 0, 7)
)
hpicfVsfVCStackTopoChange.setObjects(
      *(("HP-VSF-VC-MIB", "hpicfVsfVCMemberIdForTrap"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCTopology"))
)
if mibBuilder.loadTexts:
    hpicfVsfVCStackTopoChange.setStatus(
        "current"
    )
...
hpicfVsfVCNotificationsGroup1 = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 2, 2, 8)
)
hpicfVsfVCNotificationsGroup1.setObjects(
      *(("HP-VSF-VC-MIB", "hpicfVsfVCCommanderChange"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCMemberChange"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCMemberStatusChange"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCStackTopoChange"))
)
if mibBuilder.loadTexts:
    hpicfVsfVCNotificationsGroup1.setStatus(
        "current"
    )
...
hpicfVsfVCMibCompliance.setObjects(
      *(("HP-VSF-VC-MIB", "hpicfVsfVCConfigScalarGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCMemberTableGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCLinkTableGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCNotificationsGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCStatusScalarGroup"),
...
hpicfVsfVCMibCompliance1.setObjects(
      *(("HP-VSF-VC-MIB", "hpicfVsfVCConfigScalarGroup1"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCMemberTableGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCLinkTableGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCNotificationsGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCStatusScalarGroup"),
...
hpicfVsfVCMibCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 2, 1, 3)
)
hpicfVsfVCMibCompliance2.setObjects(
      *(("HP-VSF-VC-MIB", "hpicfVsfVCConfigScalarGroup1"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCMemberTableGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCLinkTableGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCNotificationsGroup1"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCStatusScalarGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCPortTableGroup"))
)
if mibBuilder.loadTexts:
    hpicfVsfVCMibCompliance2.setStatus(
        "deprecated"
    )

hpicfVsfVCMibCompliance3 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 2, 1, 4)
)
hpicfVsfVCMibCompliance3.setObjects(
      *(("HP-VSF-VC-MIB", "hpicfVsfVCConfigScalarGroup2"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCMemberTableGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCLinkTableGroup"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCNotificationsGroup1"),
        ("HP-VSF-VC-MIB", "hpicfVsfVCStatusScalarGroup"),
...
if mibBuilder.loadTexts:
    hpicfVsfVCMibCompliance3.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpicfVsfVCMIB": hpicfVsfVCMIB,
       ...
       "hpicfVsfVCStackTopoChange": hpicfVsfVCStackTopoChange,
       ...
       "hpicfVsfVCMemberCount": hpicfVsfVCMemberCount,
       "hpicfVsfVCActiveMemberCount": hpicfVsfVCActiveMemberCount,
       ...
       "hpicfVsfVCMibCompliance2": hpicfVsfVCMibCompliance2,
       "hpicfVsfVCMibCompliance3": hpicfVsfVCMibCompliance3,
       ...
       "hpicfVsfVCNotificationsGroup1": hpicfVsfVCNotificationsGroup1,
       "hpicfVsfVCConfigScalarGroup2": hpicfVsfVCConfigScalarGroup2}
)
