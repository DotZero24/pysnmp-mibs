...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/hp/HP-VSF-VC-MIB
...
hpicfVsfVCMIB.setRevisions(('2021-01-22 00:00', '2020-09-29 00:00', '2020-09-21 00:00', '2016-06-22 00:00', '2016-05-09 00:00', '2015-03-04 00:00',))
if mibBuilder.loadTexts: hpicfVsfVCMIB.setLastUpdated('202101220000Z')
...
hpicfVsfVCMemberCount = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 1, 1, 15), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 8))).setMaxAccess("readonly")
if mibBuilder.loadTexts: hpicfVsfVCMemberCount.setStatus('current')
hpicfVsfVCActiveMemberCount = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 1, 1, 16), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 8))).setMaxAccess("readonly")
if mibBuilder.loadTexts: hpicfVsfVCActiveMemberCount.setStatus('current')
...
hpicfVsfVCStackTopoChange = NotificationType((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 0, 7)).setObjects(("HP-VSF-VC-MIB", "hpicfVsfVCMemberIdForTrap"), ("HP-VSF-VC-MIB", "hpicfVsfVCTopology"))
if mibBuilder.loadTexts: hpicfVsfVCStackTopoChange.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfVsfVCNotificationsGroup = hpicfVsfVCNotificationsGroup.setStatus('deprecated')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfVsfVCConfigScalarGroup1 = hpicfVsfVCConfigScalarGroup1.setStatus('deprecated')
hpicfVsfVCNotificationsGroup1 = NotificationGroup((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 2, 2, 8)).setObjects(("HP-VSF-VC-MIB", "hpicfVsfVCCommanderChange"), ("HP-VSF-VC-MIB", "hpicfVsfVCMemberChange"), ("HP-VSF-VC-MIB", "hpicfVsfVCMemberStatusChange"), ("HP-VSF-VC-MIB", "hpicfVsfVCStackTopoChange"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfVsfVCNotificationsGroup1 = hpicfVsfVCNotificationsGroup1.setStatus('current')
hpicfVsfVCConfigScalarGroup2 = ObjectGroup((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 2, 2, 9)).setObjects(("HP-VSF-VC-MIB", "hpicfVsfVCDomainId"), ("HP-VSF-VC-MIB", "hpicfVsfVCOperStatus"), ("HP-VSF-VC-MIB", "hpicfVsfVCAdminStatus"), ("HP-VSF-VC-MIB", "hpicfVsfVCTopology"), ("HP-VSF-VC-MIB", "hpicfVsfVCTrapEnable"), ("HP-VSF-VC-MIB", "hpicfVsfLldpMADEnable"), ("HP-VSF-VC-MIB", "hpicfVsfVCOobmMADEnable"), ("HP-VSF-VC-MIB", "hpicfVsfVCLldpMADDeviceIpType"), ("HP-VSF-VC-MIB", "hpicfVsfVCLldpMADDeviceIpAddr"), ("HP-VSF-VC-MIB", "hpicfVsfVCLldpMADSnmpVersion"), ("HP-VSF-VC-MIB", "hpicfVsfVCLldpMADSnmpCommunity"), ("HP-VSF-VC-MIB", "hpicfVsfMADVlan"), ("HP-VSF-VC-MIB", "hpicfVsfMADVlanConnectivity"), ("HP-VSF-VC-MIB", "hpicfVsfVCPortSpeed"), ("HP-VSF-VC-MIB", "hpicfVsfVCMemberCount"), ("HP-VSF-VC-MIB", "hpicfVsfVCActiveMemberCount"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfVsfVCConfigScalarGroup2 = hpicfVsfVCConfigScalarGroup2.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfVsfVCMibCompliance1 = hpicfVsfVCMibCompliance1.setStatus('deprecated')
hpicfVsfVCMibCompliance2 = ModuleCompliance((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 2, 1, 3)).setObjects(("HP-VSF-VC-MIB", "hpicfVsfVCConfigScalarGroup1"), ("HP-VSF-VC-MIB", "hpicfVsfVCMemberTableGroup"), ("HP-VSF-VC-MIB", "hpicfVsfVCLinkTableGroup"), ("HP-VSF-VC-MIB", "hpicfVsfVCNotificationsGroup1"), ("HP-VSF-VC-MIB", "hpicfVsfVCStatusScalarGroup"), ("HP-VSF-VC-MIB", "hpicfVsfVCPortTableGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfVsfVCMibCompliance2 = hpicfVsfVCMibCompliance2.setStatus('deprecated')
hpicfVsfVCMibCompliance3 = ModuleCompliance((1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 116, 2, 1, 4)).setObjects(("HP-VSF-VC-MIB", "hpicfVsfVCConfigScalarGroup2"), ("HP-VSF-VC-MIB", "hpicfVsfVCMemberTableGroup"), ("HP-VSF-VC-MIB", "hpicfVsfVCLinkTableGroup"), ("HP-VSF-VC-MIB", "hpicfVsfVCNotificationsGroup1"), ("HP-VSF-VC-MIB", "hpicfVsfVCStatusScalarGroup"), ("HP-VSF-VC-MIB", "hpicfVsfVCPortTableGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    hpicfVsfVCMibCompliance3 = hpicfVsfVCMibCompliance3.setStatus('current')
mibBuilder.exportSymbols("HP-VSF-VC-MIB", hpicfVsfVCMemberTable=hpicfVsfVCMemberTable, hpicfVsfVCMemberOsVersion=hpicfVsfVCMemberOsVersion, hpicfVsfVCLinkMemberId=hpicfVsfVCLinkMemberId, PYSNMP_MODULE_ID=hpicfVsfVCMIB, hpicfVsfVCLldpMADDeviceMAC=hpicfVsfVCLldpMADDeviceMAC, hpicfVsfVCTopology=hpicfVsfVCTopology, hpicfVsfVCMemberMacAddr=hpicfVsfVCMemberMacAddr, hpicfVsfVCTrapEnable=hpicfVsfVCTrapEnable, hpicfVsfVCMibCompliance3=hpicfVsfVCMibCompliance3, hpicfVsfVCLinkIdForTrap=hpicfVsfVCLinkIdForTrap, hpicfVsfVCMibCompliance=hpicfVsfVCMibCompliance, hpicfVsfVCOobmMADEnable=hpicfVsfVCOobmMADEnable, hpicfVsfVCMemberSerialNum=hpicfVsfVCMemberSerialNum, hpicfVsfVCDomainId=hpicfVsfVCDomainId, hpicfVsfVCMemberReboot=hpicfVsfVCMemberReboot, hpicfVsfVCLldpMADProbePortSet=hpicfVsfVCLldpMADProbePortSet, hpicfVsfVCMemberStatusChange=hpicfVsfVCMemberStatusChange, hpicfVsfVCPortOperStatus=hpicfVsfVCPortOperStatus, hpicfVsfVCMemberUpTime=hpicfVsfVCMemberUpTime, hpicfVsfVCMemberShutdown=hpicfVsfVCMemberShutdown, hpicfVsfVCMIB=hpicfVsfVCMIB, hpicfVsfVCCompliances=hpicfVsfVCCompliances, hpicfVsfVCConfigScalarGroup1=hpicfVsfVCConfigScalarGroup1, hpicfVsfVCPeerLinkId=hpicfVsfVCPeerLinkId, hpicfVsfVCLldpMADDeviceIpAddr=hpicfVsfVCLldpMADDeviceIpAddr, hpicfVsfVCMemberEntry=hpicfVsfVCMemberEntry, hpicfVsfVCLinkEntry=hpicfVsfVCLinkEntry, hpicfVsfVCLldpMADActiveFragment=hpicfVsfVCLldpMADActiveFragment, hpicfVsfVCLinkName=hpicfVsfVCLinkName, hpicfVsfVCLldpMADProbeResponseRcvd=hpicfVsfVCLldpMADProbeResponseRcvd, hpicfVsfVCOperStatus=hpicfVsfVCOperStatus, hpicfVsfVCMemberProductName=hpicfVsfVCMemberProductName, hpicfVsfVCConfig=hpicfVsfVCConfig, hpicfVsfVCMibCompliance1=hpicfVsfVCMibCompliance1, hpicfVsfVCLldpMADSnmpCommunity=hpicfVsfVCLldpMADSnmpCommunity, hpicfVsfVCNotificationsGroup1=hpicfVsfVCNotificationsGroup1, hpicfVsfVCPeerMemberId=hpicfVsfVCPeerMemberId, hpicfVsfVCLldpMADProbeOriginator=hpicfVsfVCLldpMADProbeOriginator, hpicfVsfVCPortTable=hpicfVsfVCPortTable, hpicfVsfVCGroups=hpicfVsfVCGroups, hpicfVsfVCLldpMADProbeRequestsSent=hpicfVsfVCLldpMADProbeRequestsSent, hpicfVsfVCConformance=hpicfVsfVCConformance, hpicfVsfVCLinkOperStatus=hpicfVsfVCLinkOperStatus, hpicfVsfVCPortSpeed=hpicfVsfVCPortSpeed, hpicfVsfVCLinkId=hpicfVsfVCLinkId, hpicfVsfVCNotifications=hpicfVsfVCNotifications, hpicfVsfVCConfigScalarGroup2=hpicfVsfVCConfigScalarGroup2, hpicfVsfVCMemberCpuUtil=hpicfVsfVCMemberCpuUtil, hpicfVsfVCPortEntry=hpicfVsfVCPortEntry, hpicfVsfVCLldpMADSplitStatus=hpicfVsfVCLldpMADSplitStatus, hpicfVsfVCLinkPortList=hpicfVsfVCLinkPortList, hpicfVsfVCCommanderChange=hpicfVsfVCCommanderChange, hpicfVsfVCNotificationsGroup=hpicfVsfVCNotificationsGroup, hpicfVsfVCLldpMADReadinessStatus=hpicfVsfVCLldpMADReadinessStatus, hpicfVsfVCMemberRenumber=hpicfVsfVCMemberRenumber, hpicfVsfVCMemberFreeMemory=hpicfVsfVCMemberFreeMemory, hpicfVsfVCPortOperStatusErrorStr=hpicfVsfVCPortOperStatusErrorStr, hpicfVsfVCMemberProductId=hpicfVsfVCMemberProductId, hpicfVsfVCLinkTableGroup=hpicfVsfVCLinkTableGroup, hpicfVsfVCStatus=hpicfVsfVCStatus, hpicfVsfLldpMADEnable=hpicfVsfLldpMADEnable, hpicfVsfVCMemberCount=hpicfVsfVCMemberCount, hpicfVsfVCLldpMADDeviceIpType=hpicfVsfVCLldpMADDeviceIpType, hpicfVsfVCMemberId=hpicfVsfVCMemberId, hpicfVsfVCMemberTotalMemory=hpicfVsfVCMemberTotalMemory, hpicfVsfVCLldpMADTrunkIfIndex=hpicfVsfVCLldpMADTrunkIfIndex, hpicfVsfVCMibCompliance2=hpicfVsfVCMibCompliance2, hpicfVsfVCMemberEntryStatus=hpicfVsfVCMemberEntryStatus, hpicfVsfVCMemberAdminPriority=hpicfVsfVCMemberAdminPriority, hpicfVsfVCStatusScalarGroup=hpicfVsfVCStatusScalarGroup, hpicfVsfVCMemberBootRomVersion=hpicfVsfVCMemberBootRomVersion, hpicfVsfVCMemberBootImage=hpicfVsfVCMemberBootImage, hpicfVsfVCActiveMemberCount=hpicfVsfVCActiveMemberCount, hpicfVsfVCMemberEntPhysicalIndex=hpicfVsfVCMemberEntPhysicalIndex, hpicfVsfVCLldpMADConnectivity=hpicfVsfVCLldpMADConnectivity, hpicfVsfVCStackTopoChange=hpicfVsfVCStackTopoChange, hpicfVsfVCObjects=hpicfVsfVCObjects, hpicfVsfVCAdminStatus=hpicfVsfVCAdminStatus, hpicfVsfMADVlan=hpicfVsfMADVlan, hpicfVsfVCMemberIdForTrap=hpicfVsfVCMemberIdForTrap, hpicfVsfVCConfigScalarGroup=hpicfVsfVCConfigScalarGroup, hpicfVsfVCLinkPortStartState=hpicfVsfVCLinkPortStartState, hpicfVsfMADVlanConnectivity=hpicfVsfMADVlanConnectivity, hpicfVsfVCLldpMADVlanId=hpicfVsfVCLldpMADVlanId, hpicfVsfVCMemberState=hpicfVsfVCMemberState, hpicfVsfVCLinkTable=hpicfVsfVCLinkTable, hpicfVsfVCLinkEntryStatus=hpicfVsfVCLinkEntryStatus, hpicfVsfVCPortTableGroup=hpicfVsfVCPortTableGroup, hpicfVsfVCLldpMADSnmpVersion=hpicfVsfVCLldpMADSnmpVersion, hpicfVsfVCMemberChange=hpicfVsfVCMemberChange, hpicfVsfVCMemberSysOid=hpicfVsfVCMemberSysOid, hpicfVsfVCMemberTableGroup=hpicfVsfVCMemberTableGroup)
