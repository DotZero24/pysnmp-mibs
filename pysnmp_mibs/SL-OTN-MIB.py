...
mibBuilder.exportSymbols("SL-OTN-MIB", slOTNCurrentPmIndex=slOTNCurrentPmIndex, slOTNConfigOTUkDAPIReceived=slOTNConfigOTUkDAPIReceived, slOTNConfigEntry=slOTNConfigEntry, slOTN=slOTN, slOTNConfigOTUkTIMKillEnabled=slOTNConfigOTUkTIMKillEnabled, slOTNConfigODUkSAPIReceived=slOTNConfigODUkSAPIReceived, slOTNMsiDisable=slOTNMsiDisable, slOTNCurrentPmFecCe=slOTNCurrentPmFecCe, slOTNCurrentPmFecCerMantFE=slOTNCurrentPmFecCerMantFE, slOTNConfigOTUkTIMDetEnabled=slOTNConfigOTUkTIMDetEnabled, slOTNConfigODUkSAPIToTransmit=slOTNConfigODUkSAPIToTransmit, slOTNPm=slOTNPm, slOTNCurrentPmFecCerExpFE=slOTNCurrentPmFecCerExpFE, slOTNConfigODUkSAPIToExpect=slOTNConfigODUkSAPIToExpect, OTNTraceMessage=OTNTraceMessage, slOTNConfigFECEnabled=slOTNConfigFECEnabled, PYSNMP_MODULE_ID=slOTN, slOTNConfigOTUkSAPIToTransmit=slOTNConfigOTUkSAPIToTransmit, slOTNConfigOTUkSAPIToExpect=slOTNConfigOTUkSAPIToExpect, slOTNConfigODUkDAPIToExpect=slOTNConfigODUkDAPIToExpect, slOTNCurrentPmFecCerMant=slOTNCurrentPmFecCerMant, slOTNCurrentPmFecCerValid=slOTNCurrentPmFecCerValid, OTNTrafficRate=OTNTrafficRate, slOTNConfigODUkDAPIReceived=slOTNConfigODUkDAPIReceived, slOTNConfigOTUkDAPIToExpect=slOTNConfigOTUkDAPIToExpect, slOTNConfigOTUkSAPIReceived=slOTNConfigOTUkSAPIReceived, slOTNCurrentPmTable=slOTNCurrentPmTable, slOTNConfig=slOTNConfig, slOTNConfigInbandGCC=slOTNConfigInbandGCC, slOTNConfigLineIndex=slOTNConfigLineIndex, slOTNConfigOTUkDAPIToTransmit=slOTNConfigOTUkDAPIToTransmit, slOTNCurrentPmEntry=slOTNCurrentPmEntry, slOTNCurrentPmFecCerValidFE=slOTNCurrentPmFecCerValidFE, slOTNConfigODUkTIMKillEnabled=slOTNConfigODUkTIMKillEnabled, slOTNConfigTable=slOTNConfigTable, slOTNConfigOperationMode=slOTNConfigOperationMode, slOTNTraps=slOTNTraps, slOTNConfigODUkTIMDetEnabled=slOTNConfigODUkTIMDetEnabled, slOTNCurrentPmReset=slOTNCurrentPmReset, slOTNConfigStuffingEnabled=slOTNConfigStuffingEnabled, slOTNCurrentPmFecCerExp=slOTNCurrentPmFecCerExp, slOTNConfigODUkDAPIToTransmit=slOTNConfigODUkDAPIToTransmit, OTNOperationMode=OTNOperationMode)
