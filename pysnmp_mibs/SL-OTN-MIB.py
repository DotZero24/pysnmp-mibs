...
# Notes
# -----
# ASN.1 source file://mibs/smartoptics/SL-OTN-MIB
...
slOTNMsiDisable = _SlOTNMsiDisable_Object(
    (1, 3, 6, 1, 4, 1, 4515, 1, 1, 15, 1, 1, 1, 22),
    _SlOTNMsiDisable_Type()
)
slOTNMsiDisable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    slOTNMsiDisable.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"OTNTraceMessage": OTNTraceMessage,
       ...
       "slOTNMsiDisable": slOTNMsiDisable,
       "slOTNPm": slOTNPm,
