...
sunSeaProxyMIBStatusFile=_SunSeaProxyMIBStatusFile_Object((1,3,6,1,4,1,42,2,15,1),_SunSeaProxyMIBStatusFile_Type())
sunSeaProxyMIBStatusFile.setMaxAccess(_C)
if mibBuilder.loadTexts:sunSeaProxyMIBStatusFile.setStatus(_A)
_SunSeaProxyMIBResourceConfigFile_Type=DisplayString
_SunSeaProxyMIBResourceConfigFile_Object=MibScalar
sunSeaProxyMIBResourceConfigFile=_SunSeaProxyMIBResourceConfigFile_Object((1,3,6,1,4,1,42,2,15,2),_SunSeaProxyMIBResourceConfigFile_Type())
sunSeaProxyMIBResourceConfigFile.setMaxAccess(_C)
if mibBuilder.loadTexts:sunSeaProxyMIBResourceConfigFile.setStatus(_A)
_SunSeaProxyMIBConfigurationDir_Type=DisplayString
_SunSeaProxyMIBConfigurationDir_Object=MibScalar
sunSeaProxyMIBConfigurationDir=_SunSeaProxyMIBConfigurationDir_Object((1,3,6,1,4,1,42,2,15,3),_SunSeaProxyMIBConfigurationDir_Type())
sunSeaProxyMIBConfigurationDir.setMaxAccess(_C)
if mibBuilder.loadTexts:sunSeaProxyMIBConfigurationDir.setStatus(_A)
_SunSeaProxyMIBTrapPort_Type=Integer32
_SunSeaProxyMIBTrapPort_Object=MibScalar
sunSeaProxyMIBTrapPort=_SunSeaProxyMIBTrapPort_Object((1,3,6,1,4,1,42,2,15,4),_SunSeaProxyMIBTrapPort_Type())
sunSeaProxyMIBTrapPort.setMaxAccess(_C)
if mibBuilder.loadTexts:sunSeaProxyMIBTrapPort.setStatus(_A)
...
sunSeaProxyMIBPollInterval=_SunSeaProxyMIBPollInterval_Object((1,3,6,1,4,1,42,2,15,6),_SunSeaProxyMIBPollInterval_Type())
sunSeaProxyMIBPollInterval.setMaxAccess(_C)
if mibBuilder.loadTexts:sunSeaProxyMIBPollInterval.setStatus(_A)
_SunSeaProxyMIBMaxAgentTimeOut_Type=Integer32
_SunSeaProxyMIBMaxAgentTimeOut_Object=MibScalar
sunSeaProxyMIBMaxAgentTimeOut=_SunSeaProxyMIBMaxAgentTimeOut_Object((1,3,6,1,4,1,42,2,15,7),_SunSeaProxyMIBMaxAgentTimeOut_Type())
sunSeaProxyMIBMaxAgentTimeOut.setMaxAccess(_C)
if mibBuilder.loadTexts:sunSeaProxyMIBMaxAgentTimeOut.setStatus(_A)
