...
myTrafficCtrlMIB=ModuleIdentity((1,3,6,1,4,1,4881,1,1,10,2,14))
...
myTrafficCtrlMIBObjects=_MyTrafficCtrlMIBObjects_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,14,1))
_MyPtTrafficCtrlTable_Object=MibTable
myPtTrafficCtrlTable=_MyPtTrafficCtrlTable_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1))
if mibBuilder.loadTexts:myPtTrafficCtrlTable.setStatus(_A)
_MyPtTrafficCtrlEntry_Object=MibTableRow
myPtTrafficCtrlEntry=_MyPtTrafficCtrlEntry_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1,1))
...
myPtTrafficCtrlIfIndex=_MyPtTrafficCtrlIfIndex_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1,1,1),_MyPtTrafficCtrlIfIndex_Type())
...
myPtProtectedPortStatus=_MyPtProtectedPortStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1,1,2),_MyPtProtectedPortStatus_Type())
...
myPtBroadcastStormControlStatus=_MyPtBroadcastStormControlStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1,1,3),_MyPtBroadcastStormControlStatus_Type())
...
myPtMulticastStormControlStatus=_MyPtMulticastStormControlStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1,1,4),_MyPtMulticastStormControlStatus_Type())
...
myPtUnicastStormControlStatus=_MyPtUnicastStormControlStatus_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1,1,5),_MyPtUnicastStormControlStatus_Type())
...
myPtBroadcastStormControlLevel=_MyPtBroadcastStormControlLevel_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1,1,6),_MyPtBroadcastStormControlLevel_Type())
...
myPtMulticastStormControlLevel=_MyPtMulticastStormControlLevel_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1,1,7),_MyPtMulticastStormControlLevel_Type())
...
myPtUnicastStormControlLevel=_MyPtUnicastStormControlLevel_Object((1,3,6,1,4,1,4881,1,1,10,2,14,1,1,1,8),_MyPtUnicastStormControlLevel_Type())
...
myPtTrafficCtrlTraps=_MyPtTrafficCtrlTraps_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,14,2))
...
stormViolationAlarmType=_StormViolationAlarmType_Object((1,3,6,1,4,1,4881,1,1,10,2,14,2,1),_StormViolationAlarmType_Type())
...
myPtTrafficCtrlMIBConformance=_MyPtTrafficCtrlMIBConformance_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,14,3))
_MyPtTrafficCtrlMIBCompliances_ObjectIdentity=ObjectIdentity
myPtTrafficCtrlMIBCompliances=_MyPtTrafficCtrlMIBCompliances_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,14,3,1))
_MyPtTrafficCtrlMIBGroups_ObjectIdentity=ObjectIdentity
myPtTrafficCtrlMIBGroups=_MyPtTrafficCtrlMIBGroups_ObjectIdentity((1,3,6,1,4,1,4881,1,1,10,2,14,3,2))
myPtTrafficCtrlMIBGroup=ObjectGroup((1,3,6,1,4,1,4881,1,1,10,2,14,3,2,1))
...
stormViolationAlarm=NotificationType((1,3,6,1,4,1,4881,1,1,10,2,14,2,2))
stormViolationAlarm.setObjects(*((_F,_G),(_B,_Q)))
if mibBuilder.loadTexts:stormViolationAlarm.setStatus(_A)
myPtTrafficCtrlMIBCompliance=ModuleCompliance((1,3,6,1,4,1,4881,1,1,10,2,14,3,1,1))
