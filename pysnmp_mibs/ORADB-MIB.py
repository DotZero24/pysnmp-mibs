...
mibBuilder.exportSymbols("ORADB-MIB", oraDbSGADatabaseBuffers=oraDbSGADatabaseBuffers, oraDbConfigDbBlockBuffers=oraDbConfigDbBlockBuffers, oraDbSGAEntry=oraDbSGAEntry, oraDbConfigDbBlockCkptBatch=oraDbConfigDbBlockCkptBatch, oraDbConfigSortAreaRetainedSize=oraDbConfigSortAreaRetainedSize, oraDbConfigTransactions=oraDbConfigTransactions, oraDbDataFileDiskReadTimeTicks=oraDbDataFileDiskReadTimeTicks, oraDbSysTableScanRows=oraDbSysTableScanRows, oraDbDataFileDiskWriteTimeTicks=oraDbDataFileDiskWriteTimeTicks, oraDbSysParseCount=oraDbSysParseCount, oraDbSysFreeBufferRequested=oraDbSysFreeBufferRequested, oraDbConfigTable=oraDbConfigTable, oraDbSysConsistentChanges=oraDbSysConsistentChanges, DateAndTime=DateAndTime, oraDbTablespaceName=oraDbTablespaceName, oraDbConfigDbBlockSize=oraDbConfigDbBlockSize, oraDbSysTableFetchContinuedRow=oraDbSysTableFetchContinuedRow, oraDbConfigSerializable=oraDbConfigSerializable, oraDbSysRedoSyncWrites=oraDbSysRedoSyncWrites, oraDbTablespaceIndex=oraDbTablespaceIndex, oraDbSysTableScansShort=oraDbSysTableScansShort, oraDbSysRedoLogSpaceRequests=oraDbSysRedoLogSpaceRequests, TruthValue=TruthValue, oraDbSGAVariableSize=oraDbSGAVariableSize, oraDbConfigMaxRollbackSegments=oraDbConfigMaxRollbackSegments, oracle=oracle, oraDbLibraryCacheReloads=oraDbLibraryCacheReloads, oraDbLibraryCacheSumGets=oraDbLibraryCacheSumGets, oraDbConfigProcesses=oraDbConfigProcesses, oraDbDataFileDiskReads=oraDbDataFileDiskReads, oraDbSGATable=oraDbSGATable, oraDbConfigMTSMaxServers=oraDbConfigMTSMaxServers, oraDbConfigTransactionsPerRollback=oraDbConfigTransactionsPerRollback, oraDbLibraryCacheTable=oraDbLibraryCacheTable, oraDbTablespaceLargestAvailableChunk=oraDbTablespaceLargestAvailableChunk, oraDbLibraryCacheSumPinHits=oraDbLibraryCacheSumPinHits, oraDbMIB=oraDbMIB, oraDbLibraryCacheGets=oraDbLibraryCacheGets, oraDbConfigLogFiles=oraDbConfigLogFiles, oraDbConfigSessions=oraDbConfigSessions, oraDbLibraryCacheSumGetHits=oraDbLibraryCacheSumGetHits, oraDbSysSortsRows=oraDbSysSortsRows, oraDbLibraryCacheEntry=oraDbLibraryCacheEntry, oraDbConfigDbMultiBlockReadCount=oraDbConfigDbMultiBlockReadCount, oraDbConfigDistLockTimeout=oraDbConfigDistLockTimeout, oraDbTablespaceState=oraDbTablespaceState, oraDbSysRedoEntries=oraDbSysRedoEntries, oraDbConfigLogCheckpointTimeout=oraDbConfigLogCheckpointTimeout, oraDbSysWriteRequests=oraDbSysWriteRequests, oraDbLibraryCacheSumTable=oraDbLibraryCacheSumTable, oraDbSysTableScansLong=oraDbSysTableScansLong, oraDbDataFileEntry=oraDbDataFileEntry, oraDbLibraryCacheGetHits=oraDbLibraryCacheGetHits, oraDbLibraryCachePins=oraDbLibraryCachePins, oraDbSysSortsDisk=oraDbSysSortsDisk, oraDbSysTableScanBlocks=oraDbSysTableScanBlocks, oraDbLibraryCacheSumEntry=oraDbLibraryCacheSumEntry, oraDbConfigMTSServers=oraDbConfigMTSServers, oraDbConfigDistRecoveryConnectHold=oraDbConfigDistRecoveryConnectHold, oraDbSysTableFetchRowid=oraDbSysTableFetchRowid, oraDbLibraryCacheIndex=oraDbLibraryCacheIndex, oraDbTablespaceSizeAllocated=oraDbTablespaceSizeAllocated, oraDbConfigSharedPool=oraDbConfigSharedPool, oraDbDataFileDiskWrites=oraDbDataFileDiskWrites, oraDbLibraryCacheSumInvalidations=oraDbLibraryCacheSumInvalidations, oraDbConfigSortAreaSize=oraDbConfigSortAreaSize, oraDbDataFileDiskWrittenBlocks=oraDbDataFileDiskWrittenBlocks, oraDbConfigOpenLinks=oraDbConfigOpenLinks, oraDbConfigMTSMaxDispatchers=oraDbConfigMTSMaxDispatchers, oraDbConfigOptimizerMode=oraDbConfigOptimizerMode, oraDbSysUserRollbacks=oraDbSysUserRollbacks, oraDbLibraryCacheNameSpace=oraDbLibraryCacheNameSpace, oraDbSysPhysReads=oraDbSysPhysReads, oraDbLibraryCacheSumReloads=oraDbLibraryCacheSumReloads, oraDbTablespaceTable=oraDbTablespaceTable, oraDbLibraryCacheSumPins=oraDbLibraryCacheSumPins, oraDbSysConsistentGets=oraDbSysConsistentGets, oraDbDataFileIndex=oraDbDataFileIndex, oraDbConfigLogBuffer=oraDbConfigLogBuffer, oraDbObjects=oraDbObjects, oraDbDataFileName=oraDbDataFileName, oraDbSGARedoBuffers=oraDbSGARedoBuffers, oraDbConfigDbFileSimWrites=oraDbConfigDbFileSimWrites, oraDbSysUserCommits=oraDbSysUserCommits, oraDbTablespaceSizeUsed=oraDbTablespaceSizeUsed, oraDbConfigDistTransactions=oraDbConfigDistTransactions, oraDbSysDbBlockGets=oraDbSysDbBlockGets, oraDbConfigEntry=oraDbConfigEntry, oraDbSysUserCalls=oraDbSysUserCalls, oraDbLibraryCachePinHits=oraDbLibraryCachePinHits, oraDbSGAFixedSize=oraDbSGAFixedSize, oraDbConfigLogCheckpointInterval=oraDbConfigLogCheckpointInterval, oraDbDataFileSizeAllocated=oraDbDataFileSizeAllocated, oraDbSysPhysWrites=oraDbSysPhysWrites, oraDbConfigOpenCursors=oraDbConfigOpenCursors, oraDbConfigLogArchiveBufferSize=oraDbConfigLogArchiveBufferSize, oraDbLibraryCacheInvalidations=oraDbLibraryCacheInvalidations, oraDbSysEntry=oraDbSysEntry, oraDbSysFreeBufferInspected=oraDbSysFreeBufferInspected, oraDbDataFileDiskReadBlocks=oraDbDataFileDiskReadBlocks, oraDbSysSortsMemory=oraDbSysSortsMemory, oraDbTablespaceEntry=oraDbTablespaceEntry, oraDbSysDbBlockChanges=oraDbSysDbBlockChanges, oraDbDataFileTable=oraDbDataFileTable, oraDbConfigLogArchiveBuffers=oraDbConfigLogArchiveBuffers, oraDbSysTable=oraDbSysTable)
