# SNMP MIB module (RADLAN-CLI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-CLI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:11:10 2025
...
rlCLIremoteCLIcommandsEntry.setIndexNames(
    (0, "RADLAN-CLI-MIB", "rlCLIremoteCLIcommandIndex"),
    (0, "RADLAN-CLI-MIB", "rlCLIremoteCLIcommandPartNumber"),
)
if mibBuilder.loadTexts:
...
rlCLIremoteCLIoutputsEntry.setIndexNames(
    (0, "RADLAN-CLI-MIB", "rlCLIremoteCLIoutputRowIndex"),
    (0, "RADLAN-CLI-MIB", "rlCLIremoteCLIoutputRowPartNumber"),
)
if mibBuilder.loadTexts:
