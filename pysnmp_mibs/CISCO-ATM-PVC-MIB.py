...
mibBuilder.exportSymbols("CISCO-ATM-PVC-MIB", ciscoAtmPvcMIB=ciscoAtmPvcMIB, capvcVPI=capvcVPI, ciscoAtmPvcMIBConformance=ciscoAtmPvcMIBConformance, capvcFrequency=capvcFrequency, ciscoAtmPvcMIBCompliances=ciscoAtmPvcMIBCompliances, ciscoAtmPvcCreateBindGroup=ciscoAtmPvcCreateBindGroup, capvcTable=capvcTable, capvcType=capvcType, capvcVCI=capvcVCI, capvcVlanId=capvcVlanId, capvcPort=capvcPort, capvcVCD=capvcVCD, capvcOAM=capvcOAM, capvcPCR=capvcPCR, ciscoAtmPvcMIBCompliance=ciscoAtmPvcMIBCompliance, PYSNMP_MODULE_ID=ciscoAtmPvcMIB, ciscoAtmPvcMIBGroup=ciscoAtmPvcMIBGroup, ciscoAtmPvcMIBObjects=ciscoAtmPvcMIBObjects, capvcEntry=capvcEntry, capvcRowStatus=capvcRowStatus, ciscoAtmPvcMIBGroups=ciscoAtmPvcMIBGroups)
