...
mibBuilder.exportSymbols("OLD-CISCO-VINES-MIB", vinesIfTable=vinesIfTable, vinesFormaterror=vinesFormaterror, vinesHopcount=vinesHopcount, vinesIfRxNotEnabledCnt=vinesIfRxNotEnabledCnt, vinesEchoOut=vinesEchoOut, vinesIfTxBcastHelperedCnt=vinesIfTxBcastHelperedCnt, vinesCksumerr=vinesCksumerr, vinesIfRxIcpIllegalCnt=vinesIfRxIcpIllegalCnt, vinesIfRxEchoCnt=vinesIfRxEchoCnt, vinesIcpOut=vinesIcpOut, vinesIfRxBcastHelperedCnt=vinesIfRxBcastHelperedCnt, vinesIfTxRtp0Cnt=vinesIfTxRtp0Cnt, vinesIfRxProxyReplyCnt=vinesIfRxProxyReplyCnt, vinesMetricOut=vinesMetricOut, vinesBcastfwd=vinesBcastfwd, vinesForwarded=vinesForwarded, vinesIfRxChecksumErrorCnt=vinesIfRxChecksumErrorCnt, vinesInput=vinesInput, vinesIfRxArpIllegalCnt=vinesIfRxArpIllegalCnt, vinesIfTxArp3Cnt=vinesIfTxArp3Cnt, vinesIfRxRtp1Cnt=vinesIfRxRtp1Cnt, vinesIfFastokay=vinesIfFastokay, vinesIfRxMacEchoCnt=vinesIfRxMacEchoCnt, vinesIfAccesslist=vinesIfAccesslist, vinesIfTxUnicastCnt=vinesIfTxUnicastCnt, vinesIfTxFailedDownCnt=vinesIfTxFailedDownCnt, vinesIfRxRtp5Cnt=vinesIfRxRtp5Cnt, vinesIfTxNotBcastPpchargeCnt=vinesIfTxNotBcastPpchargeCnt, vinesIfTxArp1Cnt=vinesIfTxArp1Cnt, vinesBcastout=vinesBcastout, vinesIcpIn=vinesIcpIn, vinesIfRouteCache=vinesIfRouteCache, vinesIfTxArp0Cnt=vinesIfTxArp0Cnt, vinesUnknown=vinesUnknown, vinesIfRxLocalDestCnt=vinesIfRxLocalDestCnt, vinesEchoIn=vinesEchoIn, vinesMacEchoIn=vinesMacEchoIn, vinesIfRxForwardedCnt=vinesIfRxForwardedCnt, vinesIfTxRtp6Cnt=vinesIfTxRtp6Cnt, vinesLocaldest=vinesLocaldest, vinesIfRxIcpMetricCnt=vinesIfRxIcpMetricCnt, vinesIfServerless=vinesIfServerless, vinesIfRxBcastDuplicateCnt=vinesIfRxBcastDuplicateCnt, vinesBcastin=vinesBcastin, vinesIfRxIpcCnt=vinesIfRxIpcCnt, vinesSubNet=vinesSubNet, vinesIfTxFailedAccessCnt=vinesIfTxFailedAccessCnt, vinesIfLineup=vinesIfLineup, vinesIfRxArp3Cnt=vinesIfRxArp3Cnt, vinesIfRxIpcUnknownCnt=vinesIfRxIpcUnknownCnt, vinesIfTxRtp4Cnt=vinesIfTxRtp4Cnt, vinesIfEnctype=vinesIfEnctype, vinesIfTxNotBcastNotgt4800Cnt=vinesIfTxNotBcastNotgt4800Cnt, vinesIfRxIpUnknownCnt=vinesIfRxIpUnknownCnt, vinesOutput=vinesOutput, vinesIfTxIcpMetricCnt=vinesIfTxIcpMetricCnt, vinesIfTxSppCnt=vinesIfTxSppCnt, vinesIfTxProxyCnt=vinesIfTxProxyCnt, vinesIfRxZeroHopCountCnt=vinesIfRxZeroHopCountCnt, vinesIfTxIpcCnt=vinesIfTxIpcCnt, vinesIfTxRtp3Cnt=vinesIfTxRtp3Cnt, vinesIfRxRtp2Cnt=vinesIfRxRtp2Cnt, vinesNocharges=vinesNocharges, vinesNoroute=vinesNoroute, vinesClient=vinesClient, vinesIfRxNoRouteCnt=vinesIfRxNoRouteCnt, vinesIfPropagate=vinesIfPropagate, vinesIfRxFormatErrorCnt=vinesIfRxFormatErrorCnt, vinesIfRxRtp4Cnt=vinesIfRxRtp4Cnt, vinesIfRxRtp3Cnt=vinesIfRxRtp3Cnt, vinesNotgt4800=vinesNotgt4800, vinesIfTxEchoCnt=vinesIfTxEchoCnt, vinesIfRxRtp0Cnt=vinesIfRxRtp0Cnt, vinesIfRxRtpIllegalCnt=vinesIfRxRtpIllegalCnt, vinesIfTableEntry=vinesIfTableEntry, vinesIfRxBcastForwardedCnt=vinesIfRxBcastForwardedCnt, vinesIfSplitDisabled=vinesIfSplitDisabled, vinesIfTxRtp2Cnt=vinesIfTxRtp2Cnt, vinesIfTxNotBcastNotlanCnt=vinesIfTxNotBcastNotlanCnt, vinesIfTxBcastForwardedCnt=vinesIfTxBcastForwardedCnt, vinesIfTxFailedEncapsCnt=vinesIfTxFailedEncapsCnt, vinesMacEchoOut=vinesMacEchoOut, vinesIfTxNotBcastToSourceCnt=vinesIfTxNotBcastToSourceCnt, vinesIfRxRtp6Cnt=vinesIfRxRtp6Cnt, vinesIfArpEnabled=vinesIfArpEnabled, vinesIfTxForwardedCnt=vinesIfTxForwardedCnt, vinesIfTxIcpErrorCnt=vinesIfTxIcpErrorCnt, vinesIfRxBcastinCnt=vinesIfRxBcastinCnt, vinesIfInputRouterFilter=vinesIfInputRouterFilter, vinesIfRxArp0Cnt=vinesIfRxArp0Cnt, vinesIfTxArp2Cnt=vinesIfTxArp2Cnt, vinesIfInputNetworkFilter=vinesIfInputNetworkFilter, vinesIfTxRtp1Cnt=vinesIfTxRtp1Cnt, vinesIfRxArp2Cnt=vinesIfRxArp2Cnt, vinesNotlan=vinesNotlan, vinesProxyReplyCnt=vinesProxyReplyCnt, tmpvines=tmpvines, vinesIfRedirectInterval=vinesIfRedirectInterval, vinesIfRxSppCnt=vinesIfRxSppCnt, vinesNet=vinesNet, vinesIfOutputNetworkFilter=vinesIfOutputNetworkFilter, vinesIfTxMacEchoCnt=vinesIfTxMacEchoCnt, vinesIfRxIcpErrorCnt=vinesIfRxIcpErrorCnt, vinesIfRxArp1Cnt=vinesIfRxArp1Cnt, vinesIfTxBcastCnt=vinesIfTxBcastCnt, vinesIfMetric=vinesIfMetric, vinesIfTxRtp5Cnt=vinesIfTxRtp5Cnt, vinesEncapsfailed=vinesEncapsfailed, vinesProxyCnt=vinesProxyCnt)
