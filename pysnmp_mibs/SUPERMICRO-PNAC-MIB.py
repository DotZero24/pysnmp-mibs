_T='fsPnacTrapAuthSessionStatus'
_S='fsPnacAuthSessionPortStatus'
_R='fsPnacAuthSessionPortNumber'
_Q='fsPnacPaePortStatus'
_P='fsPnacTrapAuthSessionEntry'
_O='fsPnacASUserConfigUserName'
_N='initialize'
_M='RemoteAuthServerType'
_L='fsPnacPaePortNumber'
_K='dot1xAuthOperControlledDirections'
_J='IEEE8021-PAE-MIB'
_I='OctetString'
_H='fsPnacAuthSessionSuppAddress'
_G='not-accessible'
_F='DisplayString'
_E='SUPERMICRO-PNAC-MIB'
_D='Integer32'
_C='read-write'
_B='read-only'
_A='current'
...
PaeControlledPortStatus,dot1xAuthOperControlledDirections=mibBuilder.importSymbols(_J,'PaeControlledPortStatus',_K)
...
fsPnacPaeSystem=_FsPnacPaeSystem_ObjectIdentity((1,3,6,1,4,1,10876,101,1,64,1))
...
fsPnacSystemControl=_FsPnacSystemControl_Object((1,3,6,1,4,1,10876,101,1,64,1,1),_FsPnacSystemControl_Type())
...
fsPnacTraceOption=_FsPnacTraceOption_Object((1,3,6,1,4,1,10876,101,1,64,1,2),_FsPnacTraceOption_Type())
...
fsPnacAuthenticServer=_FsPnacAuthenticServer_Object((1,3,6,1,4,1,10876,101,1,64,1,3),_FsPnacAuthenticServer_Type())
...
fsPnacNasId=_FsPnacNasId_Object((1,3,6,1,4,1,10876,101,1,64,1,4),_FsPnacNasId_Type())
fsPnacNasId.setMaxAccess(_C)
if mibBuilder.loadTexts:fsPnacNasId.setStatus(_A)
_FsPnacPaePortTable_Object=MibTable
fsPnacPaePortTable=_FsPnacPaePortTable_Object((1,3,6,1,4,1,10876,101,1,64,1,5))
if mibBuilder.loadTexts:fsPnacPaePortTable.setStatus(_A)
_FsPnacPaePortEntry_Object=MibTableRow
fsPnacPaePortEntry=_FsPnacPaePortEntry_Object((1,3,6,1,4,1,10876,101,1,64,1,5,1))
fsPnacPaePortEntry.setIndexNames((0,_E,_L))
...
fsPnacPaePortNumber=_FsPnacPaePortNumber_Object((1,3,6,1,4,1,10876,101,1,64,1,5,1,1),_FsPnacPaePortNumber_Type())
...
fsPnacPaePortAuthMode=_FsPnacPaePortAuthMode_Object((1,3,6,1,4,1,10876,101,1,64,1,5,1,2),_FsPnacPaePortAuthMode_Type())
...
fsPnacPaePortSupplicantCount=_FsPnacPaePortSupplicantCount_Object((1,3,6,1,4,1,10876,101,1,64,1,5,1,3),_FsPnacPaePortSupplicantCount_Type())
...
fsPnacPaePortUserName=_FsPnacPaePortUserName_Object((1,3,6,1,4,1,10876,101,1,64,1,5,1,4),_FsPnacPaePortUserName_Type())
...
fsPnacPaePortPassword=_FsPnacPaePortPassword_Object((1,3,6,1,4,1,10876,101,1,64,1,5,1,5),_FsPnacPaePortPassword_Type())
...
fsPnacPaePortStatus=_FsPnacPaePortStatus_Object((1,3,6,1,4,1,10876,101,1,64,1,5,1,6),_FsPnacPaePortStatus_Type())
fsPnacPaePortStatus.setMaxAccess(_B)
if mibBuilder.loadTexts:fsPnacPaePortStatus.setStatus(_A)
class _FsPnacModuleOperStatus_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*(('enabled',1),('disabled',2)))
_FsPnacModuleOperStatus_Type.__name__=_D
_FsPnacModuleOperStatus_Object=MibScalar
fsPnacModuleOperStatus=_FsPnacModuleOperStatus_Object((1,3,6,1,4,1,10876,101,1,64,1,6),_FsPnacModuleOperStatus_Type())
...
_FsPnacRemoteAuthServerType_Type.__name__=_M
_FsPnacRemoteAuthServerType_Object=MibScalar
fsPnacRemoteAuthServerType=_FsPnacRemoteAuthServerType_Object((1,3,6,1,4,1,10876,101,1,64,1,7),_FsPnacRemoteAuthServerType_Type())
...
fsPnacPaeAuthenticator=_FsPnacPaeAuthenticator_ObjectIdentity((1,3,6,1,4,1,10876,101,1,64,2))
_FsPnacAuthSessionTable_Object=MibTable
fsPnacAuthSessionTable=_FsPnacAuthSessionTable_Object((1,3,6,1,4,1,10876,101,1,64,2,1))
if mibBuilder.loadTexts:fsPnacAuthSessionTable.setStatus(_A)
_FsPnacAuthSessionEntry_Object=MibTableRow
fsPnacAuthSessionEntry=_FsPnacAuthSessionEntry_Object((1,3,6,1,4,1,10876,101,1,64,2,1,1))
fsPnacAuthSessionEntry.setIndexNames((0,_E,_H))
...
fsPnacAuthSessionSuppAddress=_FsPnacAuthSessionSuppAddress_Object((1,3,6,1,4,1,10876,101,1,64,2,1,1,1),_FsPnacAuthSessionSuppAddress_Type())
...
fsPnacAuthSessionIdentifier=_FsPnacAuthSessionIdentifier_Object((1,3,6,1,4,1,10876,101,1,64,2,1,1,2),_FsPnacAuthSessionIdentifier_Type())
fsPnacAuthSessionIdentifier.setMaxAccess(_B)
if mibBuilder.loadTexts:fsPnacAuthSessionIdentifier.setStatus(_A)
class _FsPnacAuthSessionAuthPaeState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7,8,9)));namedValues=NamedValues(*((_N,1),('disconnected',2),('connecting',3),('authenticating',4),('authenticated',5),('aborting',6),('held',7),('forceAuth',8),('forceUnauth',9)))
_FsPnacAuthSessionAuthPaeState_Type.__name__=_D
_FsPnacAuthSessionAuthPaeState_Object=MibTableColumn
fsPnacAuthSessionAuthPaeState=_FsPnacAuthSessionAuthPaeState_Object((1,3,6,1,4,1,10876,101,1,64,2,1,1,3),_FsPnacAuthSessionAuthPaeState_Type())
fsPnacAuthSessionAuthPaeState.setMaxAccess(_B)
if mibBuilder.loadTexts:fsPnacAuthSessionAuthPaeState.setStatus(_A)
class _FsPnacAuthSessionBackendAuthState_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7)));namedValues=NamedValues(*(('request',1),('response',2),('success',3),('fail',4),('timeout',5),('idle',6),(_N,7)))
_FsPnacAuthSessionBackendAuthState_Type.__name__=_D
_FsPnacAuthSessionBackendAuthState_Object=MibTableColumn
fsPnacAuthSessionBackendAuthState=_FsPnacAuthSessionBackendAuthState_Object((1,3,6,1,4,1,10876,101,1,64,2,1,1,4),_FsPnacAuthSessionBackendAuthState_Type())
...
fsPnacAuthSessionPortStatus=_FsPnacAuthSessionPortStatus_Object((1,3,6,1,4,1,10876,101,1,64,2,1,1,5),_FsPnacAuthSessionPortStatus_Type())
...
fsPnacAuthSessionPortNumber=_FsPnacAuthSessionPortNumber_Object((1,3,6,1,4,1,10876,101,1,64,2,1,1,6),_FsPnacAuthSessionPortNumber_Type())
...
fsPnacAuthSessionInitialize=_FsPnacAuthSessionInitialize_Object((1,3,6,1,4,1,10876,101,1,64,2,1,1,7),_FsPnacAuthSessionInitialize_Type())
fsPnacAuthSessionInitialize.setMaxAccess(_C)
if mibBuilder.loadTexts:fsPnacAuthSessionInitialize.setStatus(_A)
_FsPnacAuthSessionReauthenticate_Type=TruthValue
_FsPnacAuthSessionReauthenticate_Object=MibTableColumn
fsPnacAuthSessionReauthenticate=_FsPnacAuthSessionReauthenticate_Object((1,3,6,1,4,1,10876,101,1,64,2,1,1,8),_FsPnacAuthSessionReauthenticate_Type())
fsPnacAuthSessionReauthenticate.setMaxAccess(_C)
if mibBuilder.loadTexts:fsPnacAuthSessionReauthenticate.setStatus(_A)
_FsPnacAuthSessionStatsTable_Object=MibTable
fsPnacAuthSessionStatsTable=_FsPnacAuthSessionStatsTable_Object((1,3,6,1,4,1,10876,101,1,64,2,2))
if mibBuilder.loadTexts:fsPnacAuthSessionStatsTable.setStatus(_A)
_FsPnacAuthSessionStatsEntry_Object=MibTableRow
fsPnacAuthSessionStatsEntry=_FsPnacAuthSessionStatsEntry_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1))
fsPnacAuthSessionStatsEntry.setIndexNames((0,_E,_H))
...
fsPnacAuthSessionOctetsRx=_FsPnacAuthSessionOctetsRx_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1,1),_FsPnacAuthSessionOctetsRx_Type())
...
fsPnacAuthSessionOctetsTx=_FsPnacAuthSessionOctetsTx_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1,2),_FsPnacAuthSessionOctetsTx_Type())
...
fsPnacAuthSessionFramesRx=_FsPnacAuthSessionFramesRx_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1,3),_FsPnacAuthSessionFramesRx_Type())
...
fsPnacAuthSessionFramesTx=_FsPnacAuthSessionFramesTx_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1,4),_FsPnacAuthSessionFramesTx_Type())
...
fsPnacAuthSessionId=_FsPnacAuthSessionId_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1,5),_FsPnacAuthSessionId_Type())
...
fsPnacAuthSessionAuthenticMethod=_FsPnacAuthSessionAuthenticMethod_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1,6),_FsPnacAuthSessionAuthenticMethod_Type())
...
fsPnacAuthSessionTime=_FsPnacAuthSessionTime_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1,7),_FsPnacAuthSessionTime_Type())
...
fsPnacAuthSessionTerminateCause=_FsPnacAuthSessionTerminateCause_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1,8),_FsPnacAuthSessionTerminateCause_Type())
...
fsPnacAuthSessionUserName=_FsPnacAuthSessionUserName_Object((1,3,6,1,4,1,10876,101,1,64,2,2,1,9),_FsPnacAuthSessionUserName_Type())
...
fsPnacAuthServer=_FsPnacAuthServer_ObjectIdentity((1,3,6,1,4,1,10876,101,1,64,3))
_FsPnacASUserConfigTable_Object=MibTable
fsPnacASUserConfigTable=_FsPnacASUserConfigTable_Object((1,3,6,1,4,1,10876,101,1,64,3,1))
if mibBuilder.loadTexts:fsPnacASUserConfigTable.setStatus(_A)
_FsPnacASUserConfigEntry_Object=MibTableRow
fsPnacASUserConfigEntry=_FsPnacASUserConfigEntry_Object((1,3,6,1,4,1,10876,101,1,64,3,1,1))
fsPnacASUserConfigEntry.setIndexNames((0,_E,_O))
...
_FsPnacASUserConfigUserName_Type.__name__=_I
_FsPnacASUserConfigUserName_Object=MibTableColumn
fsPnacASUserConfigUserName=_FsPnacASUserConfigUserName_Object((1,3,6,1,4,1,10876,101,1,64,3,1,1,1),_FsPnacASUserConfigUserName_Type())
...
fsPnacASUserConfigPassword=_FsPnacASUserConfigPassword_Object((1,3,6,1,4,1,10876,101,1,64,3,1,1,2),_FsPnacASUserConfigPassword_Type())
...
fsPnacASUserConfigAuthProtocol=_FsPnacASUserConfigAuthProtocol_Object((1,3,6,1,4,1,10876,101,1,64,3,1,1,3),_FsPnacASUserConfigAuthProtocol_Type())
...
fsPnacASUserConfigAuthTimeout=_FsPnacASUserConfigAuthTimeout_Object((1,3,6,1,4,1,10876,101,1,64,3,1,1,4),_FsPnacASUserConfigAuthTimeout_Type())
...
fsPnacASUserConfigPortList=_FsPnacASUserConfigPortList_Object((1,3,6,1,4,1,10876,101,1,64,3,1,1,5),_FsPnacASUserConfigPortList_Type())
...
fsPnacASUserConfigPermission=_FsPnacASUserConfigPermission_Object((1,3,6,1,4,1,10876,101,1,64,3,1,1,6),_FsPnacASUserConfigPermission_Type())
...
fsPnacASUserConfigRowStatus=_FsPnacASUserConfigRowStatus_Object((1,3,6,1,4,1,10876,101,1,64,3,1,1,7),_FsPnacASUserConfigRowStatus_Type())
...
fsPnacTrapObjects=_FsPnacTrapObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,1,64,4))
_FsPnacTrapAuthSessionTable_Object=MibTable
fsPnacTrapAuthSessionTable=_FsPnacTrapAuthSessionTable_Object((1,3,6,1,4,1,10876,101,1,64,4,1))
if mibBuilder.loadTexts:fsPnacTrapAuthSessionTable.setStatus(_A)
_FsPnacTrapAuthSessionEntry_Object=MibTableRow
fsPnacTrapAuthSessionEntry=_FsPnacTrapAuthSessionEntry_Object((1,3,6,1,4,1,10876,101,1,64,4,1,1))
...
fsPnacTrapAuthSessionStatus=_FsPnacTrapAuthSessionStatus_Object((1,3,6,1,4,1,10876,101,1,64,4,1,1,1),_FsPnacTrapAuthSessionStatus_Type())
...
fsPnacNotifications=_FsPnacNotifications_ObjectIdentity((1,3,6,1,4,1,10876,101,1,64,5))
_FsPnacHwFailureTrap_ObjectIdentity=ObjectIdentity
fsPnacHwFailureTrap=_FsPnacHwFailureTrap_ObjectIdentity((1,3,6,1,4,1,10876,101,1,64,5,0))
fsPnacAuthSessionEntry.registerAugmentions((_E,_P))
fsPnacTrapAuthSessionEntry.setIndexNames(*fsPnacAuthSessionEntry.getIndexNames())
fsPnacPortBasedHwFailureTrap=NotificationType((1,3,6,1,4,1,10876,101,1,64,5,0,1))
fsPnacPortBasedHwFailureTrap.setObjects(*((_E,_Q),(_J,_K)))
if mibBuilder.loadTexts:fsPnacPortBasedHwFailureTrap.setStatus(_A)
fsPnacMacBasedHwFailureTrap=NotificationType((1,3,6,1,4,1,10876,101,1,64,5,0,2))
fsPnacMacBasedHwFailureTrap.setObjects(*((_E,_R),(_E,_S),(_E,_T)))
if mibBuilder.loadTexts:fsPnacMacBasedHwFailureTrap.setStatus(_A)
mibBuilder.exportSymbols(_E,**{'AuthenticMethod':AuthenticMethod,_M:RemoteAuthServerType,'PermissionType':PermissionType,'fspnac':fspnac,'fsPnacPaeSystem':fsPnacPaeSystem,'fsPnacSystemControl':fsPnacSystemControl,'fsPnacTraceOption':fsPnacTraceOption,'fsPnacAuthenticServer':fsPnacAuthenticServer,'fsPnacNasId':fsPnacNasId,'fsPnacPaePortTable':fsPnacPaePortTable,'fsPnacPaePortEntry':fsPnacPaePortEntry,_L:fsPnacPaePortNumber,'fsPnacPaePortAuthMode':fsPnacPaePortAuthMode,'fsPnacPaePortSupplicantCount':fsPnacPaePortSupplicantCount,'fsPnacPaePortUserName':fsPnacPaePortUserName,'fsPnacPaePortPassword':fsPnacPaePortPassword,_Q:fsPnacPaePortStatus,'fsPnacModuleOperStatus':fsPnacModuleOperStatus,'fsPnacRemoteAuthServerType':fsPnacRemoteAuthServerType,'fsPnacPaeAuthenticator':fsPnacPaeAuthenticator,'fsPnacAuthSessionTable':fsPnacAuthSessionTable,'fsPnacAuthSessionEntry':fsPnacAuthSessionEntry,_H:fsPnacAuthSessionSuppAddress,'fsPnacAuthSessionIdentifier':fsPnacAuthSessionIdentifier,'fsPnacAuthSessionAuthPaeState':fsPnacAuthSessionAuthPaeState,'fsPnacAuthSessionBackendAuthState':fsPnacAuthSessionBackendAuthState,_S:fsPnacAuthSessionPortStatus,_R:fsPnacAuthSessionPortNumber,'fsPnacAuthSessionInitialize':fsPnacAuthSessionInitialize,'fsPnacAuthSessionReauthenticate':fsPnacAuthSessionReauthenticate,'fsPnacAuthSessionStatsTable':fsPnacAuthSessionStatsTable,'fsPnacAuthSessionStatsEntry':fsPnacAuthSessionStatsEntry,'fsPnacAuthSessionOctetsRx':fsPnacAuthSessionOctetsRx,'fsPnacAuthSessionOctetsTx':fsPnacAuthSessionOctetsTx,'fsPnacAuthSessionFramesRx':fsPnacAuthSessionFramesRx,'fsPnacAuthSessionFramesTx':fsPnacAuthSessionFramesTx,'fsPnacAuthSessionId':fsPnacAuthSessionId,'fsPnacAuthSessionAuthenticMethod':fsPnacAuthSessionAuthenticMethod,'fsPnacAuthSessionTime':fsPnacAuthSessionTime,'fsPnacAuthSessionTerminateCause':fsPnacAuthSessionTerminateCause,'fsPnacAuthSessionUserName':fsPnacAuthSessionUserName,'fsPnacAuthServer':fsPnacAuthServer,'fsPnacASUserConfigTable':fsPnacASUserConfigTable,'fsPnacASUserConfigEntry':fsPnacASUserConfigEntry,_O:fsPnacASUserConfigUserName,'fsPnacASUserConfigPassword':fsPnacASUserConfigPassword,'fsPnacASUserConfigAuthProtocol':fsPnacASUserConfigAuthProtocol,'fsPnacASUserConfigAuthTimeout':fsPnacASUserConfigAuthTimeout,'fsPnacASUserConfigPortList':fsPnacASUserConfigPortList,'fsPnacASUserConfigPermission':fsPnacASUserConfigPermission,'fsPnacASUserConfigRowStatus':fsPnacASUserConfigRowStatus,'fsPnacTrapObjects':fsPnacTrapObjects,'fsPnacTrapAuthSessionTable':fsPnacTrapAuthSessionTable,_P:fsPnacTrapAuthSessionEntry,_T:fsPnacTrapAuthSessionStatus,'fsPnacNotifications':fsPnacNotifications,'fsPnacHwFailureTrap':fsPnacHwFailureTrap,'fsPnacPortBasedHwFailureTrap':fsPnacPortBasedHwFailureTrap,'fsPnacMacBasedHwFailureTrap':fsPnacMacBasedHwFailureTrap})