# SNMP MIB module (Dell-VRTX-MIR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-VRTX-MIR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:05 2025
...
rlMirInterfaceEntry.setIndexNames(
    (0, "Dell-VRTX-MIR-MIB", "rlMirInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
rlMirVlanBaseReservedPortsEntry.setIndexNames(
    (0, "Dell-VRTX-MIR-MIB", "rlMirVlanBaseReservedPortsIfIndex"),
)
if mibBuilder.loadTexts:
...
rlMirVlanBaseLogicalPortsEntry.setIndexNames(
    (0, "Dell-VRTX-MIR-MIB", "rlMirVlanBaseLogicalPortsIfIndex"),
)
if mibBuilder.loadTexts:
