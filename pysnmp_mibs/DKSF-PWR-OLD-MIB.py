...
mibBuilder.exportSymbols("DKSF-PWR-OLD-MIB", npRelHumTrap=npRelHumTrap, npGsm=npGsm, npPwrTable=npPwrTable, npIoTrap=npIoTrap, npSmokeReset=npSmokeReset, npRelHumSensor=npRelHumSensor, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSensorStatusH=npRelHumSensorStatusH, npGsmRegistration=npGsmRegistration, npGsmSendSms=npGsmSendSms, npPwrMemo=npPwrMemo, npIoTrapPrefix=npIoTrapPrefix, npBatteryChg=npBatteryChg, npReboot=npReboot, npBatteryPok=npBatteryPok, npGsmFailed=npGsmFailed, npRelHumTrapPrefix=npRelHumTrapPrefix, npRelay=npRelay, lightcom=lightcom, npIrPlayCmd=npIrPlayCmd, npThermoTrapHigh=npThermoTrapHigh, npIr=npIr, npThermoTraps=npThermoTraps, npPwrRepeatingResetsCounter=npPwrRepeatingResetsCounter, npGsmTrapPrefix=npGsmTrapPrefix, npSmoke=npSmoke, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTraps=npSmokeTraps, npThermoTrapValue=npThermoTrapValue, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTraps=npRelHumTraps, npIoMemo=npIoMemo, npIrReset=npIrReset, npThermoTrapMemo=npThermoTrapMemo, npGsmTrap=npGsmTrap, npForcedReboot=npForcedReboot, npSmokeTrap=npSmokeTrap, npIoTrapLineN=npIoTrapLineN, npRelayMode=npRelayMode, npBatteryLevel=npBatteryLevel, npPwrEntry=npPwrEntry, npPwrResetsCounter=npPwrResetsCounter, npThermoTrapLow=npThermoTrapLow, npThermoMemo=npThermoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npThermoLow=npThermoLow, npThermoSensorN=npThermoSensorN, npIoTrapMemo=npIoTrapMemo, npRelHumSensorValueT=npRelHumSensorValueT, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npRelayStartReset=npRelayStartReset, npGsmTraps=npGsmTraps, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTable=npThermoTable, npRelayEntry=npRelayEntry, npBatteryInfo=npBatteryInfo, npRelayFlip=npRelayFlip, npIoLevelIn=npIoLevelIn, npRelHumSensorValueT100=npRelHumSensorValueT100, npPwrChannelN=npPwrChannelN, npIrStatus=npIrStatus, npRelayState=npRelayState, npSmokeEntry=npSmokeEntry, npRelayPowered=npRelayPowered, npRelHumSensorStatus=npRelHumSensorStatus, npIrCtrl=npIrCtrl, npThermoHigh=npThermoHigh, npIoPulseCounter=npIoPulseCounter, PYSNMP_MODULE_ID=netPing8Pwr, npThermoEntry=npThermoEntry, npSmokeMemo=npSmokeMemo, npIoTable=npIoTable, npIoEntry=npIoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npGsmStrength=npGsmStrength, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayMemo=npRelayMemo, npThermoTrapStatus=npThermoTrapStatus, npIoLevelOut=npIoLevelOut, npThermoValue=npThermoValue, npSoftReboot=npSoftReboot, npRelayN=npRelayN, npResetStack=npResetStack, npRelHumidity=npRelHumidity, npPwr=npPwr, npThermoStatus=npThermoStatus, npSmokeStatus=npSmokeStatus, npSmokeSensorN=npSmokeSensorN, netPing8Pwr=netPing8Pwr, npBattery=npBattery, npSmokePower=npSmokePower, npThermoTrap=npThermoTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayTable=npRelayTable, npPwrStartReset=npPwrStartReset, npIoTraps=npIoTraps, npSmokeTable=npSmokeTable, npGsmInfo=npGsmInfo, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npIo=npIo, npRelHumSensorValueH=npRelHumSensorValueH)
