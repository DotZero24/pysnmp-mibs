# SNMP MIB module (DKSF-PWR-OLD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netping/DKSF-PWR-OLD-MIB
...
netPing8Pwr = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 25728, 48)
)
if mibBuilder.loadTexts:
    netPing8Pwr.setRevisions(
        ("2015-08-13 00:00",
         "2015-06-18 00:00",
         "2015-05-28 00:00",
         "2015-05-06 00:00",
...
npPwrEntry.setIndexNames(
    (0, "DKSF-PWR-OLD-MIB", "npPwrChannelN"),
)
if mibBuilder.loadTexts:
...
npSmokeEntry.setIndexNames(
    (0, "DKSF-PWR-OLD-MIB", "npSmokeSensorN"),
)
if mibBuilder.loadTexts:
...
npThermoEntry.setIndexNames(
    (0, "DKSF-PWR-OLD-MIB", "npThermoSensorN"),
)
if mibBuilder.loadTexts:
...
npGsmTrap.setObjects(
      *(("DKSF-PWR-OLD-MIB", "npGsmFailed"),
        ("DKSF-PWR-OLD-MIB", "npGsmRegistration"),
        ("DKSF-PWR-OLD-MIB", "npGsmStrength"))
)
if mibBuilder.loadTexts:
    npGsmTrap.setStatus(
        "current"
...
npSmokeTrap.setObjects(
      *(("DKSF-PWR-OLD-MIB", "npSmokeTrapSensorN"),
        ("DKSF-PWR-OLD-MIB", "npSmokeTrapStatus"),
        ("DKSF-PWR-OLD-MIB", "npSmokeTrapMemo"))
)
if mibBuilder.loadTexts:
...
npRelHumTrap.setObjects(
      *(("DKSF-PWR-OLD-MIB", "npRelHumSensorStatusH"),
        ("DKSF-PWR-OLD-MIB", "npRelHumSensorValueH"),
        ("DKSF-PWR-OLD-MIB", "npRelHumSafeRangeHigh"),
        ("DKSF-PWR-OLD-MIB", "npRelHumSafeRangeLow"))
)
if mibBuilder.loadTexts:
...
npThermoTrap.setObjects(
      *(("DKSF-PWR-OLD-MIB", "npThermoTrapSensorN"),
        ("DKSF-PWR-OLD-MIB", "npThermoTrapValue"),
        ("DKSF-PWR-OLD-MIB", "npThermoTrapStatus"),
        ("DKSF-PWR-OLD-MIB", "npThermoTrapLow"),
        ("DKSF-PWR-OLD-MIB", "npThermoTrapHigh"),
        ("DKSF-PWR-OLD-MIB", "npThermoTrapMemo"))
)
if mibBuilder.loadTexts:
...
npIoTrap.setObjects(
      *(("DKSF-PWR-OLD-MIB", "npIoTrapLineN"),
        ("DKSF-PWR-OLD-MIB", "npIoTrapLevelIn"),
        ("DKSF-PWR-OLD-MIB", "npIoTrapMemo"))
)
if mibBuilder.loadTexts:
    npIoTrap.setStatus(
        "current"
