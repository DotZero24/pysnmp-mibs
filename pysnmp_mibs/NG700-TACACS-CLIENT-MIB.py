_G='read-create'
_F='agentTacacsServerIpAddress'
_E='NG700-TACACS-CLIENT-MIB'
_D='OctetString'
_C='Unsigned32'
_B='read-write'
_A='current'
...
agentTacacsClientObjects=_AgentTacacsClientObjects_ObjectIdentity((1,3,6,1,4,1,4526,11,18,1))
_AgentTacacsGlobalConfigGroup_ObjectIdentity=ObjectIdentity
agentTacacsGlobalConfigGroup=_AgentTacacsGlobalConfigGroup_ObjectIdentity((1,3,6,1,4,1,4526,11,18,1,1))
...
agentTacacsGlobalTimeout=_AgentTacacsGlobalTimeout_Object((1,3,6,1,4,1,4526,11,18,1,1,1),_AgentTacacsGlobalTimeout_Type())
...
agentTacacsGlobalKey=_AgentTacacsGlobalKey_Object((1,3,6,1,4,1,4526,11,18,1,1,2),_AgentTacacsGlobalKey_Type())
...
agentTacacsSourceInterface=_AgentTacacsSourceInterface_Object((1,3,6,1,4,1,4526,11,18,1,1,3),_AgentTacacsSourceInterface_Type())
...
agentTacacsServerTable=_AgentTacacsServerTable_Object((1,3,6,1,4,1,4526,11,18,1,2))
if mibBuilder.loadTexts:agentTacacsServerTable.setStatus(_A)
_AgentTacacsServerEntry_Object=MibTableRow
agentTacacsServerEntry=_AgentTacacsServerEntry_Object((1,3,6,1,4,1,4526,11,18,1,2,1))
agentTacacsServerEntry.setIndexNames((0,_E,_F))
...
agentTacacsServerIpAddress=_AgentTacacsServerIpAddress_Object((1,3,6,1,4,1,4526,11,18,1,2,1,1),_AgentTacacsServerIpAddress_Type())
...
agentTacacsPortNumber=_AgentTacacsPortNumber_Object((1,3,6,1,4,1,4526,11,18,1,2,1,2),_AgentTacacsPortNumber_Type())
...
agentTacacsTimeOut=_AgentTacacsTimeOut_Object((1,3,6,1,4,1,4526,11,18,1,2,1,3),_AgentTacacsTimeOut_Type())
...
agentTacacsKey=_AgentTacacsKey_Object((1,3,6,1,4,1,4526,11,18,1,2,1,4),_AgentTacacsKey_Type())
...
agentTacacsPriority=_AgentTacacsPriority_Object((1,3,6,1,4,1,4526,11,18,1,2,1,5),_AgentTacacsPriority_Type())
...
agentTacacsServerStatus=_AgentTacacsServerStatus_Object((1,3,6,1,4,1,4526,11,18,1,2,1,6),_AgentTacacsServerStatus_Type())
agentTacacsServerStatus.setMaxAccess(_G)
...
agentTacacsServerIpAddrType=_AgentTacacsServerIpAddrType_Object((1,3,6,1,4,1,4526,11,18,1,2,1,7),_AgentTacacsServerIpAddrType_Type())
agentTacacsServerIpAddrType.setMaxAccess(_G)
if mibBuilder.loadTexts:agentTacacsServerIpAddrType.setStatus(_A)
mibBuilder.exportSymbols(_E,**{'agentTacacsClientMIB':agentTacacsClientMIB,'agentTacacsClientObjects':agentTacacsClientObjects,'agentTacacsGlobalConfigGroup':agentTacacsGlobalConfigGroup,'agentTacacsGlobalTimeout':agentTacacsGlobalTimeout,'agentTacacsGlobalKey':agentTacacsGlobalKey,'agentTacacsSourceInterface':agentTacacsSourceInterface,'agentTacacsServerTable':agentTacacsServerTable,'agentTacacsServerEntry':agentTacacsServerEntry,_F:agentTacacsServerIpAddress,'agentTacacsPortNumber':agentTacacsPortNumber,'agentTacacsTimeOut':agentTacacsTimeOut,'agentTacacsKey':agentTacacsKey,'agentTacacsPriority':agentTacacsPriority,'agentTacacsServerStatus':agentTacacsServerStatus,'agentTacacsServerIpAddrType':agentTacacsServerIpAddrType})