# SNMP MIB module (NG700-TACACS-CLIENT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NG700-TACACS-CLIENT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:15 2025
...
agentTacacsServerEntry = _AgentTacacsServerEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 11, 18, 1, 2, 1)
)
agentTacacsServerEntry.setIndexNames(
    (0, "NG700-TACACS-CLIENT-MIB", "agentTacacsServerIpAddress"),
)
if mibBuilder.loadTexts:
...
agentTacacsServerIpAddress = _AgentTacacsServerIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 4526, 11, 18, 1, 2, 1, 1),
...
agentTacacsPortNumber = _AgentTacacsPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 4526, 11, 18, 1, 2, 1, 2),
...
agentTacacsTimeOut = _AgentTacacsTimeOut_Object(
    (1, 3, 6, 1, 4, 1, 4526, 11, 18, 1, 2, 1, 3),
...
agentTacacsKey = _AgentTacacsKey_Object(
    (1, 3, 6, 1, 4, 1, 4526, 11, 18, 1, 2, 1, 4),
...
agentTacacsPriority = _AgentTacacsPriority_Object(
    (1, 3, 6, 1, 4, 1, 4526, 11, 18, 1, 2, 1, 5),
...
agentTacacsServerStatus = _AgentTacacsServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 11, 18, 1, 2, 1, 6),
...
agentTacacsServerIpAddrType = _AgentTacacsServerIpAddrType_Object(
    (1, 3, 6, 1, 4, 1, 4526, 11, 18, 1, 2, 1, 7),
