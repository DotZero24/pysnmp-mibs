...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-DATA-COLLECTION-MIB
...
ModuleIdentity, Counter64, Unsigned32, zeroDotZero, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Counter32, ObjectIdentity, MibIdentifier, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "zeroDotZero", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "Integer32", "Bits", "TimeTicks", "IpAddress")
DisplayString, VariablePointer, RowPointer, RowStatus, DateAndTime, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "VariablePointer", "RowPointer", "RowStatus", "DateAndTime", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-DATA-COLLECTION-MIB", cdcDGBaseObjectSubtree=cdcDGBaseObjectSubtree, cdcVFileAdminStatus=cdcVFileAdminStatus, cdcVFileMgmtTimeToLive=cdcVFileMgmtTimeToLive, cdcFileXferComplete=cdcFileXferComplete, cdcVFileCollectionError=cdcVFileCollectionError, cdcNotificationGroup=cdcNotificationGroup, cdcFileXfer=cdcFileXfer, cdcVFilePersistentStorage=cdcVFilePersistentStorage, ciscoDataCollMIBObjects=ciscoDataCollMIBObjects, cdcVFileMaxSizeHitsLimit=cdcVFileMaxSizeHitsLimit, cdcVFileCurrentSize=cdcVFileCurrentSize, cdcVFileIndex=cdcVFileIndex, cdcDGInstanceTable=cdcDGInstanceTable, cdcDataGroup=cdcDataGroup, ciscoDataCollMIBConformance=ciscoDataCollMIBConformance, cdcDGBaseObjectList=cdcDGBaseObjectList, ciscoDataCollectionMIB=ciscoDataCollectionMIB, cdcDGBaseObjectRowStatus=cdcDGBaseObjectRowStatus, cdcVFileCollectMode=cdcVFileCollectMode, cdcVFileMgmtIndex=cdcVFileMgmtIndex, cdcFileXferConfPriUrl=cdcFileXferConfPriUrl, cdcVFileOperStatus=cdcVFileOperStatus, cdcDGPollPeriod=cdcDGPollPeriod, CdcFileFormat=CdcFileFormat, cdcDGIndex=cdcDGIndex, cdcVFile=cdcVFile, cdcDataSelectionGroup=cdcDataSelectionGroup, cdcVFileDescription=cdcVFileDescription, cdcDGInstanceGrpIndex=cdcDGInstanceGrpIndex, cdcDGInstanceOid=cdcDGInstanceOid, ciscoDataCollMIBCompliances=ciscoDataCollMIBCompliances, cdcDGInstanceRowStatus=cdcDGInstanceRowStatus, cdcDGInstanceOtherPtr=cdcDGInstanceOtherPtr, cdcDGBaseObjectTable=cdcDGBaseObjectTable, ciscoDataCollMIBNotifs=ciscoDataCollMIBNotifs, cdcDGContextName=cdcDGContextName, cdcVFileMgmtEntry=cdcVFileMgmtEntry, cdcFileXferConfEntry=cdcFileXferConfEntry, CdcRowInstanceId=CdcRowInstanceId, ciscoDataCollMIBGroups=ciscoDataCollMIBGroups, cdcFileXferConfSecUrl=cdcFileXferConfSecUrl, cdcVFileMgmtLastXferURL=cdcVFileMgmtLastXferURL, cdcVFileMgmtCommand=cdcVFileMgmtCommand, cdcVFileErrorCode=cdcVFileErrorCode, CdcFileXferStatus=CdcFileXferStatus, cdcFileXferConfSuccessEnable=cdcFileXferConfSuccessEnable, cdcDGBaseObjectEntry=cdcDGBaseObjectEntry, cdcDGTargetTag=cdcDGTargetTag, cdcVFileCollectionPeriod=cdcVFileCollectionPeriod, cdcDGType=cdcDGType, cdcVFileEntry=cdcVFileEntry, cdcFileXferConfTable=cdcFileXferConfTable, CdcUrl=CdcUrl, cdcDGInstanceEntry=cdcDGInstanceEntry, cdcDGObjectGrpIndex=cdcDGObjectGrpIndex, cdcDGInstanceNumRepititions=cdcDGInstanceNumRepititions, cdcFileXferConfRetryCount=cdcFileXferConfRetryCount, cdcVFileCommand=cdcVFileCommand, cdcVFileFormat=cdcVFileFormat, cdcDGTable=cdcDGTable, cdcDGVFileIndex=cdcDGVFileIndex, cdcVFileCollectionErrorEnable=cdcVFileCollectionErrorEnable, cdcVFileTable=cdcVFileTable, cdcFileXferConfRetryPeriod=cdcFileXferConfRetryPeriod, cdcFileXferGroup=cdcFileXferGroup, cdcVFileMgmtXferURL=cdcVFileMgmtXferURL, cdcDGInstanceIndex=cdcDGInstanceIndex, cdcVFileGroup=cdcVFileGroup, cdcDGInstanceType=cdcDGInstanceType, CdcCollectionSubtree=CdcCollectionSubtree, cdcVFileRetentionPeriod=cdcVFileRetentionPeriod, cdcDGRowStatus=cdcDGRowStatus, cdcDGInstanceOidEnd=cdcDGInstanceOidEnd, cdcDGComment=cdcDGComment, cdcVFileMaxSize=cdcVFileMaxSize, cdcVFileName=cdcVFileName, cdcVFileRowStatus=cdcVFileRowStatus, PYSNMP_MODULE_ID=ciscoDataCollectionMIB, ciscoDataCollMIBCompliance=ciscoDataCollMIBCompliance, cdcDGBaseObjectGrpIndex=cdcDGBaseObjectGrpIndex, cdcVFileMgmtTimestamp=cdcVFileMgmtTimestamp, cdcVFileMgmtTable=cdcVFileMgmtTable, CdcCollectionList=CdcCollectionList, cdcVFileMgmtName=cdcVFileMgmtName, cdcDGObject=cdcDGObject, cdcDGInstGrpIndex=cdcDGInstGrpIndex, cdcDGBaseObjectIndex=cdcDGBaseObjectIndex, cdcVFileMgmtLastXferStatus=cdcVFileMgmtLastXferStatus, cdcDGEntry=cdcDGEntry, cdcFileXferConfFailureEnable=cdcFileXferConfFailureEnable)
