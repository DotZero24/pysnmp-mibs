...
RowStatus, DateAndTime, TextualConvention, VariablePointer, RowPointer, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TextualConvention", "VariablePointer", "RowPointer", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-DATA-COLLECTION-MIB", cdcVFileGroup=cdcVFileGroup, cdcDGEntry=cdcDGEntry, cdcDGInstanceTable=cdcDGInstanceTable, cdcVFileCollectionErrorEnable=cdcVFileCollectionErrorEnable, cdcDGInstanceRowStatus=cdcDGInstanceRowStatus, cdcDGType=cdcDGType, cdcDGBaseObjectRowStatus=cdcDGBaseObjectRowStatus, CdcCollectionSubtree=CdcCollectionSubtree, cdcDGInstanceGrpIndex=cdcDGInstanceGrpIndex, cdcVFileIndex=cdcVFileIndex, cdcDGBaseObjectList=cdcDGBaseObjectList, cdcDGRowStatus=cdcDGRowStatus, cdcDGBaseObjectSubtree=cdcDGBaseObjectSubtree, cdcNotificationGroup=cdcNotificationGroup, cdcDGObject=cdcDGObject, cdcDGInstanceOtherPtr=cdcDGInstanceOtherPtr, cdcVFileMgmtLastXferURL=cdcVFileMgmtLastXferURL, cdcDGInstanceOidEnd=cdcDGInstanceOidEnd, cdcDGTargetTag=cdcDGTargetTag, cdcDGContextName=cdcDGContextName, cdcVFileMgmtTable=cdcVFileMgmtTable, cdcFileXferConfRetryCount=cdcFileXferConfRetryCount, cdcVFileMgmtTimestamp=cdcVFileMgmtTimestamp, cdcVFileCollectMode=cdcVFileCollectMode, cdcVFileOperStatus=cdcVFileOperStatus, cdcDGVFileIndex=cdcDGVFileIndex, cdcFileXfer=cdcFileXfer, cdcVFileMgmtXferURL=cdcVFileMgmtXferURL, cdcFileXferConfRetryPeriod=cdcFileXferConfRetryPeriod, ciscoDataCollMIBCompliances=ciscoDataCollMIBCompliances, ciscoDataCollMIBCompliance=ciscoDataCollMIBCompliance, cdcVFileMgmtEntry=cdcVFileMgmtEntry, cdcDGBaseObjectGrpIndex=cdcDGBaseObjectGrpIndex, cdcDataSelectionGroup=cdcDataSelectionGroup, ciscoDataCollMIBNotifs=ciscoDataCollMIBNotifs, PYSNMP_MODULE_ID=ciscoDataCollectionMIB, cdcDGBaseObjectIndex=cdcDGBaseObjectIndex, cdcFileXferGroup=cdcFileXferGroup, cdcDGInstanceNumRepititions=cdcDGInstanceNumRepititions, cdcVFileMaxSizeHitsLimit=cdcVFileMaxSizeHitsLimit, cdcVFileAdminStatus=cdcVFileAdminStatus, cdcVFileCommand=cdcVFileCommand, cdcVFileCollectionPeriod=cdcVFileCollectionPeriod, cdcDGTable=cdcDGTable, cdcVFileEntry=cdcVFileEntry, cdcFileXferConfEntry=cdcFileXferConfEntry, ciscoDataCollectionMIB=ciscoDataCollectionMIB, cdcDGIndex=cdcDGIndex, CdcRowInstanceId=CdcRowInstanceId, cdcDGPollPeriod=cdcDGPollPeriod, CdcCollectionList=CdcCollectionList, cdcFileXferConfSuccessEnable=cdcFileXferConfSuccessEnable, cdcVFileTable=cdcVFileTable, cdcVFilePersistentStorage=cdcVFilePersistentStorage, cdcVFileRetentionPeriod=cdcVFileRetentionPeriod, cdcVFileRowStatus=cdcVFileRowStatus, cdcVFileMgmtCommand=cdcVFileMgmtCommand, cdcVFileMgmtIndex=cdcVFileMgmtIndex, cdcVFileCollectionError=cdcVFileCollectionError, cdcDataGroup=cdcDataGroup, cdcDGInstanceIndex=cdcDGInstanceIndex, cdcDGInstanceOid=cdcDGInstanceOid, CdcFileFormat=CdcFileFormat, cdcVFileMgmtName=cdcVFileMgmtName, ciscoDataCollMIBConformance=ciscoDataCollMIBConformance, cdcVFileFormat=cdcVFileFormat, cdcDGInstanceEntry=cdcDGInstanceEntry, cdcFileXferConfPriUrl=cdcFileXferConfPriUrl, cdcFileXferComplete=cdcFileXferComplete, cdcDGInstanceType=cdcDGInstanceType, cdcVFileMaxSize=cdcVFileMaxSize, cdcVFileCurrentSize=cdcVFileCurrentSize, cdcDGBaseObjectTable=cdcDGBaseObjectTable, cdcVFileMgmtLastXferStatus=cdcVFileMgmtLastXferStatus, cdcFileXferConfTable=cdcFileXferConfTable, cdcVFileErrorCode=cdcVFileErrorCode, cdcFileXferConfFailureEnable=cdcFileXferConfFailureEnable, cdcDGInstGrpIndex=cdcDGInstGrpIndex, ciscoDataCollMIBGroups=ciscoDataCollMIBGroups, CdcUrl=CdcUrl, cdcVFileName=cdcVFileName, cdcDGObjectGrpIndex=cdcDGObjectGrpIndex, cdcDGBaseObjectEntry=cdcDGBaseObjectEntry, cdcDGComment=cdcDGComment, cdcVFile=cdcVFile, cdcVFileMgmtTimeToLive=cdcVFileMgmtTimeToLive, CdcFileXferStatus=CdcFileXferStatus, ciscoDataCollMIBObjects=ciscoDataCollMIBObjects, cdcVFileDescription=cdcVFileDescription, cdcFileXferConfSecUrl=cdcFileXferConfSecUrl)
