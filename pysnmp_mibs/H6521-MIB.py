# SNMP MIB module (H6521-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/comet/H6521-MIB
...
trapTest.setObjects(
      *(("H6521-MIB", "sensorName"),
        ("H6521-MIB", "messageString"))
)
if mibBuilder.loadTexts:
    trapTest.setStatus(
        ""
