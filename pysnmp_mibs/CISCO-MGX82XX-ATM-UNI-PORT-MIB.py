...
mibBuilder.exportSymbols("CISCO-MGX82XX-ATM-UNI-PORT-MIB", axisAtmNetPrefixOperStatus=axisAtmNetPrefixOperStatus, atmNetPrefixGroup=atmNetPrefixGroup, axisAtmNetPrefixPort=axisAtmNetPrefixPort, axisAtmAddressStatus=axisAtmAddressStatus, PYSNMP_MODULE_ID=ciscoMgx82xxAtmUniPortMIB, atmNetPrefixEntry=atmNetPrefixEntry, axisAtmNetPrefixPrefix=axisAtmNetPrefixPrefix, atmAddressTable=atmAddressTable, atmAddressGroup=atmAddressGroup, cmauPortCompliance=cmauPortCompliance, atmNetPrefixTable=atmNetPrefixTable, cmauAtmAddressGroup=cmauAtmAddressGroup, ciscoMgx82xxAtmUniPortMIB=ciscoMgx82xxAtmUniPortMIB, axisAtmAddressAtmAddress=axisAtmAddressAtmAddress, cmauPortMIBConformance=cmauPortMIBConformance, axisAtmAddressPort=axisAtmAddressPort, atmAddressEntry=atmAddressEntry, cmauNetPrefixGroup=cmauNetPrefixGroup, cmauPortMIBGroups=cmauPortMIBGroups, axisAtmNetPrefixAdminStatus=axisAtmNetPrefixAdminStatus, cmauPortMIBCompliances=cmauPortMIBCompliances)
