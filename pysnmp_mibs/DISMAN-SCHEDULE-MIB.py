...
RowStatus, DateAndTime, TextualConvention, VariablePointer, StorageType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TextualConvention", "VariablePointer", "StorageType", "DisplayString")
...
mibBuilder.exportSymbols("DISMAN-SCHEDULE-MIB", schedMIB=schedMIB, schedAdminStatus=schedAdminStatus, schedType=schedType, schedName=schedName, schedLastFailure=schedLastFailure, schedGroup=schedGroup, SnmpPduErrorStatus=SnmpPduErrorStatus, schedCompliance=schedCompliance, schedContextName=schedContextName, schedDay=schedDay, schedGroups=schedGroups, schedOwner=schedOwner, schedTriggers=schedTriggers, schedWeekDay=schedWeekDay, schedTraps=schedTraps, schedHour=schedHour, schedActionFailure=schedActionFailure, schedInterval=schedInterval, schedLastFailed=schedLastFailed, schedRowStatus=schedRowStatus, schedEntry=schedEntry, schedNotificationsGroup=schedNotificationsGroup, schedCompliances=schedCompliances, schedVariable=schedVariable, schedTable=schedTable, schedFailures=schedFailures, schedMonth=schedMonth, schedDescr=schedDescr, schedGroup2=schedGroup2, schedValue=schedValue, schedCompliance2=schedCompliance2, schedLocalTime=schedLocalTime, schedCalendarGroup=schedCalendarGroup, PYSNMP_MODULE_ID=schedMIB, schedMinute=schedMinute, schedOperStatus=schedOperStatus, schedStorageType=schedStorageType, schedObjects=schedObjects, schedConformance=schedConformance, schedNotifications=schedNotifications)
