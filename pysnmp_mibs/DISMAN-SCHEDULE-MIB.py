...
DisplayString, VariablePointer, RowStatus, StorageType, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "VariablePointer", "RowStatus", "StorageType", "DateAndTime", "TextualConvention")
...
mibBuilder.exportSymbols("DISMAN-SCHEDULE-MIB", PYSNMP_MODULE_ID=schedMIB, schedCompliance2=schedCompliance2, schedTriggers=schedTriggers, schedValue=schedValue, schedContextName=schedContextName, schedLocalTime=schedLocalTime, schedNotificationsGroup=schedNotificationsGroup, schedHour=schedHour, schedActionFailure=schedActionFailure, schedAdminStatus=schedAdminStatus, schedGroup2=schedGroup2, schedOperStatus=schedOperStatus, schedMIB=schedMIB, schedNotifications=schedNotifications, schedDescr=schedDescr, schedType=schedType, schedConformance=schedConformance, schedTable=schedTable, schedTraps=schedTraps, schedMonth=schedMonth, SnmpPduErrorStatus=SnmpPduErrorStatus, schedDay=schedDay, schedLastFailed=schedLastFailed, schedStorageType=schedStorageType, schedCompliances=schedCompliances, schedCompliance=schedCompliance, schedOwner=schedOwner, schedEntry=schedEntry, schedVariable=schedVariable, schedRowStatus=schedRowStatus, schedFailures=schedFailures, schedName=schedName, schedMinute=schedMinute, schedGroups=schedGroups, schedInterval=schedInterval, schedObjects=schedObjects, schedGroup=schedGroup, schedWeekDay=schedWeekDay, schedLastFailure=schedLastFailure, schedCalendarGroup=schedCalendarGroup)
