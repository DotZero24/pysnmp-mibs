...
# Notes
# -----
# ASN.1 source file://mibs/aruba/ARUBA-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:23:12 2025
...
_A9240_base_ObjectIdentity = ObjectIdentity
a9240_base = _A9240_base_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 1, 59)
)
_A9240_silver_ObjectIdentity = ObjectIdentity
a9240_silver = _A9240_silver_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 1, 60)
)
_A9240_gold_ObjectIdentity = ObjectIdentity
a9240_gold = _A9240_gold_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 1, 61)
)
_A9114_ObjectIdentity = ObjectIdentity
a9114 = _A9114_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 1, 62)
)
...
_Ap635_ObjectIdentity = ObjectIdentity
ap635 = _Ap635_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 2, 125)
)
_Ap655_ObjectIdentity = ObjectIdentity
ap655 = _Ap655_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 2, 126)
)
_Ap584_ObjectIdentity = ObjectIdentity
ap584 = _Ap584_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 2, 127)
)
_Ap585_ObjectIdentity = ObjectIdentity
ap585 = _Ap585_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 2, 128)
)
_Ap587_ObjectIdentity = ObjectIdentity
ap587 = _Ap587_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 2, 129)
)
_Ap585EX_ObjectIdentity = ObjectIdentity
ap585EX = _Ap585EX_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 2, 130)
)
_Ap587EX_ObjectIdentity = ObjectIdentity
ap587EX = _Ap587EX_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 2, 131)
)
_Ap615_ObjectIdentity = ObjectIdentity
ap615 = _Ap615_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 2, 134)
)
_Ap503_ObjectIdentity = ObjectIdentity
ap503 = _Ap503_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 14823, 1, 2, 137)
)
...
mibBuilder.exportSymbols(
    ...
    **{"aruba": aruba,
       ...
       "a9012": a9012,
       "a9004-lte": a9004_lte,
       "a9240-base": a9240_base,
       "a9240-silver": a9240_silver,
       "a9240-gold": a9240_gold,
       "a9114": a9114,
