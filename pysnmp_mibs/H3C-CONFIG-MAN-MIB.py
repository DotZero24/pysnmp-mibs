# SNMP MIB module (H3C-CONFIG-MAN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-CONFIG-MAN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:17:52 2025
...
h3cCfgLogIndex = _H3cCfgLogIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 1),
...
h3cCfgLogTime = _H3cCfgLogTime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 2),
    _H3cCfgLogTime_Type()
)
...
h3cCfgLogSrcCmd = _H3cCfgLogSrcCmd_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 3),
...
h3cCfgLogSrcData = _H3cCfgLogSrcData_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 4),
...
h3cCfgLogDesData = _H3cCfgLogDesData_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 5),
...
h3cCfgLogTerminalType = _H3cCfgLogTerminalType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 6),
...
h3cCfgLogTerminalUser = _H3cCfgLogTerminalUser_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 7),
...
h3cCfgLogTerminalNum = _H3cCfgLogTerminalNum_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 8),
...
h3cCfgLogTerminalLocation = _H3cCfgLogTerminalLocation_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 9),
...
h3cCfgLogVirHost = _H3cCfgLogVirHost_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 11),
...
h3cCfgLogUserName = _H3cCfgLogUserName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 12),
...
h3cCfgLogServerAddress = _H3cCfgLogServerAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 13),
...
h3cCfgLogFile = _H3cCfgLogFile_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 14),
    _H3cCfgLogFile_Type()
)
...
h3cCfgLogCmdSrcAddrType = _H3cCfgLogCmdSrcAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 15),
...
h3cCfgLogCmdSrcAddrRev = _H3cCfgLogCmdSrcAddrRev_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 16),
...
h3cCfgLogCmdSrcAddrVPNName = _H3cCfgLogCmdSrcAddrVPNName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 17),
...
h3cCfgLogServerAddrType = _H3cCfgLogServerAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 18),
...
h3cCfgLogServerAddrRev = _H3cCfgLogServerAddrRev_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 19),
...
h3cCfgLogServerAddrVPNName = _H3cCfgLogServerAddrVPNName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 1, 7, 1, 20),
...
h3cCfgOperateIndex = _H3cCfgOperateIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 1),
...
h3cCfgOperateType = _H3cCfgOperateType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 2),
...
h3cCfgOperateProtocol = _H3cCfgOperateProtocol_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 3),
...
h3cCfgOperateFileName = _H3cCfgOperateFileName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 4),
...
h3cCfgOperateServerAddress = _H3cCfgOperateServerAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 5),
...
h3cCfgOperateUserName = _H3cCfgOperateUserName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 6),
...
h3cCfgOperateUserPassword = _H3cCfgOperateUserPassword_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 7),
...
_H3cCfgOperateEndNotificationSwitch_Type.__name__ = "TruthValue"
...
h3cCfgOperateEndNotificationSwitch = _H3cCfgOperateEndNotificationSwitch_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 8),
...
h3cCfgOperateRowStatus = _H3cCfgOperateRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 9),
...
h3cCfgOperateServerPort = _H3cCfgOperateServerPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 10),
...
h3cCfgOperateSrvAddrType = _H3cCfgOperateSrvAddrType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 11),
...
h3cCfgOperateSrvAddrRev = _H3cCfgOperateSrvAddrRev_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 12),
...
h3cCfgOperateSrvVPNName = _H3cCfgOperateSrvVPNName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 4, 1, 13),
...
h3cCfgOperateResultEntry = _H3cCfgOperateResultEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1)
)
h3cCfgOperateResultEntry.setIndexNames(
    (0, "H3C-CONFIG-MAN-MIB", "h3cCfgOperateResultIndex"),
)
if mibBuilder.loadTexts:
...
h3cCfgOperateResultIndex = _H3cCfgOperateResultIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 1),
...
h3cCfgOperateResultOptIndex = _H3cCfgOperateResultOptIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 2),
...
h3cCfgOperateResultOpType = _H3cCfgOperateResultOpType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 3),
...
h3cCfgOperateState = _H3cCfgOperateState_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 4),
...
h3cCfgOperateTime = _H3cCfgOperateTime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 5),
...
h3cCfgOperateEndTime = _H3cCfgOperateEndTime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 6),
...
h3cCfgOperFailReason = _H3cCfgOperFailReason_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 7),
...
class _H3cCfgOperateFailCmd_Type(DisplayString):
    """Custom type h3cCfgOperateFailCmd based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cCfgOperateFailCmd_Type.__name__ = "DisplayString"
_H3cCfgOperateFailCmd_Object = MibTableColumn
h3cCfgOperateFailCmd = _H3cCfgOperateFailCmd_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 8),
    _H3cCfgOperateFailCmd_Type()
)
h3cCfgOperateFailCmd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cCfgOperateFailCmd.setStatus("current")


class _H3cCfgOperateFailCmdView_Type(DisplayString):
    """Custom type h3cCfgOperateFailCmdView based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cCfgOperateFailCmdView_Type.__name__ = "DisplayString"
_H3cCfgOperateFailCmdView_Object = MibTableColumn
h3cCfgOperateFailCmdView = _H3cCfgOperateFailCmdView_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 9),
    _H3cCfgOperateFailCmdView_Type()
)
h3cCfgOperateFailCmdView.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cCfgOperateFailCmdView.setStatus("current")


class _H3cCfgOperateFailCmdReason_Type(DisplayString):
    """Custom type h3cCfgOperateFailCmdReason based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_H3cCfgOperateFailCmdReason_Type.__name__ = "DisplayString"
_H3cCfgOperateFailCmdReason_Object = MibTableColumn
h3cCfgOperateFailCmdReason = _H3cCfgOperateFailCmdReason_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 5, 1, 10),
    _H3cCfgOperateFailCmdReason_Type()
)
h3cCfgOperateFailCmdReason.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cCfgOperateFailCmdReason.setStatus("current")
_H3cCfgExecuteOperate_ObjectIdentity = ObjectIdentity
h3cCfgExecuteOperate = _H3cCfgExecuteOperate_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6)
)
...
h3cCfgExecuteOperateResultEntryLimit = _H3cCfgExecuteOperateResultEntryLimit_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6, 1),
...
h3cCfgExecuteResultTable = _H3cCfgExecuteResultTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6, 2)
)
if mibBuilder.loadTexts:
...
h3cCfgExecuteResultEntry = _H3cCfgExecuteResultEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6, 2, 1)
)
h3cCfgExecuteResultEntry.setIndexNames(
    (0, "H3C-CONFIG-MAN-MIB", "h3cCfgExecuteResultIndex"),
)
if mibBuilder.loadTexts:
...
h3cCfgExecuteResultIndex = _H3cCfgExecuteResultIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6, 2, 1, 1),
...
h3cCfgExecuteResultOptIndex = _H3cCfgExecuteResultOptIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6, 2, 1, 2),
...
h3cCfgExecuteResultOpType = _H3cCfgExecuteResultOpType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6, 2, 1, 3),
...
h3cCfgExecuteState = _H3cCfgExecuteState_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6, 2, 1, 4),
...
h3cCfgExecuteTime = _H3cCfgExecuteTime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6, 2, 1, 5),
...
h3cCfgExecuteEndTime = _H3cCfgExecuteEndTime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 6, 2, 1, 6),
...
class _H3cCfgReset2_Type(Integer32):
    """Custom type h3cCfgReset2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_H3cCfgReset2_Type.__name__ = "Integer32"
_H3cCfgReset2_Object = MibScalar
h3cCfgReset2 = _H3cCfgReset2_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 1, 2, 8),
    _H3cCfgReset2_Type()
)
h3cCfgReset2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cCfgReset2.setStatus("current")
...
h3cConfigManNotifications = _H3cConfigManNotifications_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 2)
)
_H3cConfigManConformance_ObjectIdentity = ObjectIdentity
h3cConfigManConformance = _H3cConfigManConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 3)
)
_H3cConfigManCompliances_ObjectIdentity = ObjectIdentity
h3cConfigManCompliances = _H3cConfigManCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 3, 1)
)
_H3cConfigManGroups_ObjectIdentity = ObjectIdentity
h3cConfigManGroups = _H3cConfigManGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 3, 2)
)

# Managed Objects groups

h3cCfgManLogGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 3, 2, 1)
)
h3cCfgManLogGroup.setObjects(
      *(("H3C-CONFIG-MAN-MIB", "h3cCfgRunModifiedLast"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgRunSavedLast"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgStartModifiedLast"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogLimitedEntries"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogDeletedEntries"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogTime"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogSrcCmd"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogTerminalType"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogTerminalNum"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogTerminalUser"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogTerminalLocation"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogCmdSrcAddress"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogVirHost"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogServerAddress"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogFile"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogUserName"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogWantBackup"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogSrcData"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgLogDesData"))
)
if mibBuilder.loadTexts:
    h3cCfgManLogGroup.setStatus("current")

h3cCfgOperateGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 3, 2, 2)
)
h3cCfgOperateGroup.setObjects(
      *(("H3C-CONFIG-MAN-MIB", "h3cCfgOperateGlobalEntryLimit"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateEntryAgeOutTime"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateType"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateProtocol"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateFileName"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateServerAddress"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateUserName"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateUserPassword"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateTime"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateEndNotificationSwitch"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateResultGlobalEntryLimit"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateState"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateRowStatus"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateResultOptIndex"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateResultOpType"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateEndTime"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperFailReason"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateServerPort"))
)
if mibBuilder.loadTexts:
...
h3cCfgInvalidConfigFile = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 2, 3)
)
h3cCfgInvalidConfigFile.setObjects(
      *(("H3C-CONFIG-MAN-MIB", "h3cCfgOperateType"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateFileName"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgFirstTrapTime"))
)
if mibBuilder.loadTexts:
...
h3cCfgManNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 3, 2, 3)
)
h3cCfgManNotificationGroup.setObjects(
      *(("H3C-CONFIG-MAN-MIB", "h3cCfgManEventlog"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateCompletion"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgInvalidConfigFile"))
)
if mibBuilder.loadTexts:
...
h3cConfigManCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 4, 3, 1, 1)
)
h3cConfigManCompliance.setObjects(
      *(("H3C-CONFIG-MAN-MIB", "h3cCfgManLogGroup"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgOperateGroup"),
        ("H3C-CONFIG-MAN-MIB", "h3cCfgManNotificationGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ConfigOperationType": ConfigOperationType,
       ...
       "h3cCfgOperateFailCmd": h3cCfgOperateFailCmd,
       "h3cCfgOperateFailCmdView": h3cCfgOperateFailCmdView,
       "h3cCfgOperateFailCmdReason": h3cCfgOperateFailCmdReason,
