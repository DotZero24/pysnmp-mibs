...
# Notes
# -----
# ASN.1 source file://mibs/zyxel/ZYXEL-DHCP-RELAY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:01:27 2025
...
zyxelDhcpRelayVlanRelaySourceAddressTable = _ZyxelDhcpRelayVlanRelaySourceAddressTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 18, 1, 2, 7)
)
if mibBuilder.loadTexts:
    zyxelDhcpRelayVlanRelaySourceAddressTable.setStatus("current")
_ZyxelDhcpRelayVlanRelaySourceAddressEntry_Object = MibTableRow
zyxelDhcpRelayVlanRelaySourceAddressEntry = _ZyxelDhcpRelayVlanRelaySourceAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 18, 1, 2, 7, 1)
)
zyxelDhcpRelayVlanRelaySourceAddressEntry.setIndexNames(
    (0, "ZYXEL-DHCP-RELAY-MIB", "zyDhcpRelayVlanRelayRemoteServerServeVid"),
)
if mibBuilder.loadTexts:
    zyxelDhcpRelayVlanRelaySourceAddressEntry.setStatus("current")
_ZyDhcpRelayVlanRelaySourceAddress_Type = IpAddress
_ZyDhcpRelayVlanRelaySourceAddress_Object = MibTableColumn
zyDhcpRelayVlanRelaySourceAddress = _ZyDhcpRelayVlanRelaySourceAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 18, 1, 2, 7, 1, 1),
    _ZyDhcpRelayVlanRelaySourceAddress_Type()
)
zyDhcpRelayVlanRelaySourceAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    zyDhcpRelayVlanRelaySourceAddress.setStatus("current")
_ZyxelDhcpRelayStatus_ObjectIdentity = ObjectIdentity
zyxelDhcpRelayStatus = _ZyxelDhcpRelayStatus_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 18, 2)
)
_ZyxelDhcpRelayVlanRelayInfo_ObjectIdentity = ObjectIdentity
zyxelDhcpRelayVlanRelayInfo = _ZyxelDhcpRelayVlanRelayInfo_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 18, 2, 1)
)
_ZyxelDhcpRelayVlanRelaySourceAddressInfoTable_Object = MibTable
zyxelDhcpRelayVlanRelaySourceAddressInfoTable = _ZyxelDhcpRelayVlanRelaySourceAddressInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 18, 2, 1, 1)
)
if mibBuilder.loadTexts:
    zyxelDhcpRelayVlanRelaySourceAddressInfoTable.setStatus("current")
_ZyxelDhcpRelayVlanRelaySourceAddressInfoEntry_Object = MibTableRow
zyxelDhcpRelayVlanRelaySourceAddressInfoEntry = _ZyxelDhcpRelayVlanRelaySourceAddressInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 18, 2, 1, 1, 1)
)
zyxelDhcpRelayVlanRelaySourceAddressInfoEntry.setIndexNames(
    (0, "ZYXEL-DHCP-RELAY-MIB", "zyDhcpRelayVlanRelayRemoteServerServeVid"),
)
if mibBuilder.loadTexts:
    zyxelDhcpRelayVlanRelaySourceAddressInfoEntry.setStatus("current")
_ZyDhcpRelayVlanRelayCurrentSourceAddress_Type = IpAddress
_ZyDhcpRelayVlanRelayCurrentSourceAddress_Object = MibTableColumn
zyDhcpRelayVlanRelayCurrentSourceAddress = _ZyDhcpRelayVlanRelayCurrentSourceAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 15, 3, 18, 2, 1, 1, 1, 1),
    _ZyDhcpRelayVlanRelayCurrentSourceAddress_Type()
)
zyDhcpRelayVlanRelayCurrentSourceAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    zyDhcpRelayVlanRelayCurrentSourceAddress.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"zyxelDhcpRelay": zyxelDhcpRelay,
       ...
       "zyxelDhcpRelayVlanRelaySourceAddressTable": zyxelDhcpRelayVlanRelaySourceAddressTable,
       "zyxelDhcpRelayVlanRelaySourceAddressEntry": zyxelDhcpRelayVlanRelaySourceAddressEntry,
       "zyDhcpRelayVlanRelaySourceAddress": zyDhcpRelayVlanRelaySourceAddress,
       "zyxelDhcpRelayStatus": zyxelDhcpRelayStatus,
       "zyxelDhcpRelayVlanRelayInfo": zyxelDhcpRelayVlanRelayInfo,
       "zyxelDhcpRelayVlanRelaySourceAddressInfoTable": zyxelDhcpRelayVlanRelaySourceAddressInfoTable,
       "zyxelDhcpRelayVlanRelaySourceAddressInfoEntry": zyxelDhcpRelayVlanRelaySourceAddressInfoEntry,
       "zyDhcpRelayVlanRelayCurrentSourceAddress": zyDhcpRelayVlanRelayCurrentSourceAddress}
)
