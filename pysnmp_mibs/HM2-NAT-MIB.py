...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-NAT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:53:36 2025
...
_Hm2DnatRulePendingActions_Type.__name__ = "TruthValue"
...
_Hm2DnatCommitPendingActions_Type.__name__ = "HmActionValue"
...
_Hm2DnatLog_Type.__name__ = "TruthValue"
...
_Hm2DnatTrap_Type.__name__ = "TruthValue"
...
class _Hm2DnatIfmPriority_Type(Unsigned32):
    """Custom type hm2DnatIfmPriority based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 6500),
    )


_Hm2DnatIfmPriority_Type.__name__ = "Unsigned32"
...
_Hm21to1RulePendingActions_Type.__name__ = "TruthValue"
...
_Hm21to1CommitPendingActions_Type.__name__ = "HmActionValue"
...
_Hm21to1PublicIntf_Type.__name__ = "InterfaceIndexOrZero"
...
_Hm21to1Log_Type.__name__ = "TruthValue"
...
_Hm21to1Trap_Type.__name__ = "TruthValue"
...
_Hm21to1IngressIntf_Type.__name__ = "InterfaceIndexOrZero"
...
_Hm21to1EgressIntf_Type.__name__ = "InterfaceIndexOrZero"
...
class _Hm21to1Priority_Type(Unsigned32):
    ...
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 6500),
    )


_Hm21to1Priority_Type.__name__ = "Unsigned32"
...
_Hm21to1StorageType_Type.__name__ = "StorageType"
...
_Hm2MasqRulePendingActions_Type.__name__ = "TruthValue"
...
_Hm2MasqCommitPendingActions_Type.__name__ = "HmActionValue"
...
_Hm2MasqLog_Type.__name__ = "TruthValue"
...
_Hm2MasqTrap_Type.__name__ = "TruthValue"
...
_Hm2MasqIpsecExempt_Type.__name__ = "TruthValue"
...
class _Hm2MasqIfmPriority_Type(Unsigned32):
    """Custom type hm2MasqIfmPriority based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 6500),
    )
...
_Hm2MasqIfmPriority_Type.__name__ = "Unsigned32"
...
_Hm2DoubleNatRulePendingActions_Type.__name__ = "TruthValue"
...
_Hm2DoubleNatCommitPendingActions_Type.__name__ = "HmActionValue"
...
_Hm2DonatLog_Type.__name__ = "TruthValue"
...
_Hm2DonatTrap_Type.__name__ = "TruthValue"
...
class _Hm2DonatIfmPriority_Type(Unsigned32):
    """Custom type hm2DonatIfmPriority based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 6500),
    )
...
_Hm2DonatIfmPriority_Type.__name__ = "Unsigned32"
...
hm2NatSNMPExtensionGroup = _Hm2NatSNMPExtensionGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5)
)
_Hm2NatSNMPExtensionEgressInterfaceInvalid_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionEgressInterfaceInvalid = _Hm2NatSNMPExtensionEgressInterfaceInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 1)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionEgressInterfaceInvalid.setStatus("current")
_Hm2NatSNMPExtensionIngressInterfaceInvalid_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionIngressInterfaceInvalid = _Hm2NatSNMPExtensionIngressInterfaceInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 2)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionIngressInterfaceInvalid.setStatus("current")
_Hm2NatSNMPExtensionIPsecExemptInvalid_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionIPsecExemptInvalid = _Hm2NatSNMPExtensionIPsecExemptInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 3)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionIPsecExemptInvalid.setStatus("current")
_Hm2NatSNMPExtensionLocalExternalIPInvalid_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionLocalExternalIPInvalid = _Hm2NatSNMPExtensionLocalExternalIPInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 4)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionLocalExternalIPInvalid.setStatus("current")
_Hm2NatSNMPExtensionLocalInternalIPInvalid_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionLocalInternalIPInvalid = _Hm2NatSNMPExtensionLocalInternalIPInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 5)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionLocalInternalIPInvalid.setStatus("current")
_Hm2NatSNMPExtensionNewDestAddrInvalid_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionNewDestAddrInvalid = _Hm2NatSNMPExtensionNewDestAddrInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 6)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionNewDestAddrInvalid.setStatus("current")
_Hm2NatSNMPExtensionNewDestPortInvalid_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionNewDestPortInvalid = _Hm2NatSNMPExtensionNewDestPortInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 7)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionNewDestPortInvalid.setStatus("current")
_Hm2NatSNMPExtensionRemoteExternalIPInvalid_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionRemoteExternalIPInvalid = _Hm2NatSNMPExtensionRemoteExternalIPInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 8)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionRemoteExternalIPInvalid.setStatus("current")
_Hm2NatSNMPExtensionRemoteInternalIPInvalid_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionRemoteInternalIPInvalid = _Hm2NatSNMPExtensionRemoteInternalIPInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 9)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionRemoteInternalIPInvalid.setStatus("current")
_Hm2NatSNMPExtensionBadDestAddr_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionBadDestAddr = _Hm2NatSNMPExtensionBadDestAddr_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 10)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionBadDestAddr.setStatus("current")
_Hm2NatSNMPExtensionBadNewDestAddr_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionBadNewDestAddr = _Hm2NatSNMPExtensionBadNewDestAddr_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 11)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionBadNewDestAddr.setStatus("current")
_Hm2NatSNMPExtensionDestAndNewDestAddrSubnetError_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionDestAndNewDestAddrSubnetError = _Hm2NatSNMPExtensionDestAndNewDestAddrSubnetError_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 12)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionDestAndNewDestAddrSubnetError.setStatus("current")
_Hm2NatSNMPExtensionBadRuleParameter_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionBadRuleParameter = _Hm2NatSNMPExtensionBadRuleParameter_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 13)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionBadRuleParameter.setStatus("current")
_Hm2NatSNMPExtensionIngressAndEgressIntfEqualError_ObjectIdentity = ObjectIdentity
hm2NatSNMPExtensionIngressAndEgressIntfEqualError = _Hm2NatSNMPExtensionIngressAndEgressIntfEqualError_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 80, 5, 14)
)
if mibBuilder.loadTexts:
    hm2NatSNMPExtensionIngressAndEgressIntfEqualError.setStatus("current")
...
hm2NatCompliance.setObjects(
      *(("HM2-NAT-MIB", "hm2NatGeneralGroup"),
        ("HM2-NAT-MIB", "hm2NatNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"hm2NatMib": hm2NatMib,
       ...
       "hm2NatSNMPExtensionGroup": hm2NatSNMPExtensionGroup,
       ...
       "hm2NatSNMPExtensionIPsecExemptInvalid": hm2NatSNMPExtensionIPsecExemptInvalid,
       "hm2NatSNMPExtensionLocalExternalIPInvalid": hm2NatSNMPExtensionLocalExternalIPInvalid,
       "hm2NatSNMPExtensionLocalInternalIPInvalid": hm2NatSNMPExtensionLocalInternalIPInvalid,
       "hm2NatSNMPExtensionNewDestAddrInvalid": hm2NatSNMPExtensionNewDestAddrInvalid,
       "hm2NatSNMPExtensionNewDestPortInvalid": hm2NatSNMPExtensionNewDestPortInvalid,
       "hm2NatSNMPExtensionRemoteExternalIPInvalid": hm2NatSNMPExtensionRemoteExternalIPInvalid,
       "hm2NatSNMPExtensionRemoteInternalIPInvalid": hm2NatSNMPExtensionRemoteInternalIPInvalid,
       "hm2NatSNMPExtensionBadDestAddr": hm2NatSNMPExtensionBadDestAddr,
       "hm2NatSNMPExtensionBadNewDestAddr": hm2NatSNMPExtensionBadNewDestAddr,
       "hm2NatSNMPExtensionDestAndNewDestAddrSubnetError": hm2NatSNMPExtensionDestAndNewDestAddrSubnetError,
       "hm2NatSNMPExtensionBadRuleParameter": hm2NatSNMPExtensionBadRuleParameter,
       "hm2NatSNMPExtensionIngressAndEgressIntfEqualError": hm2NatSNMPExtensionIngressAndEgressIntfEqualError}
)
