# SNMP MIB module (H3C-FTM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-FTM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:18:35 2025
...
h3cFtmIndex = _H3cFtmIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 1, 1, 1, 1, 1, 1),
    _H3cFtmIndex_Type()
)
...
h3cFtmUnitID = _H3cFtmUnitID_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 1, 1, 1, 1, 1, 2),
    _H3cFtmUnitID_Type()
)
...
h3cFtmUnitName = _H3cFtmUnitName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 1, 1, 1, 1, 1, 3),
...
h3cFtmUnitRole = _H3cFtmUnitRole_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 1, 1, 1, 1, 1, 4),
...
h3cFtmNumberMode = _H3cFtmNumberMode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 1, 1, 1, 1, 1, 5),
...
h3cFtmUnitIDChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 1, 1, 3, 1)
)
h3cFtmUnitIDChange.setObjects(
      *(("H3C-FTM-MIB", "h3cFtmIndex"),
        ("H3C-FTM-MIB", "h3cFtmUnitID"))
)
if mibBuilder.loadTexts:
...
h3cFtmNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 1, 1, 2, 2, 2)
)
h3cFtmNotificationGroup.setObjects(
      *(("H3C-FTM-MIB", "h3cFtmUnitIDChange"),
        ("H3C-FTM-MIB", "h3cFtmUnitNameChange"))
)
if mibBuilder.loadTexts:
...
h3cFtmMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 1, 1, 2, 1, 1)
)
h3cFtmMIBCompliance.setObjects(
      *(("H3C-FTM-MIB", "h3cFtmConfigGroup"),
        ("H3C-FTM-MIB", "h3cFtmNotificationGroup"))
)
if mibBuilder.loadTexts:
