...
mibBuilder.exportSymbols("IBM-OSA-MIB", ibmOsaExpTRActiveSpeedMode=ibmOsaExpTRActiveSpeedMode, ibmOsaExpTRDisabledStatus=ibmOsaExpTRDisabledStatus, ibmOsaExpTRFunctionalAddr=ibmOsaExpTRFunctionalAddr, ibmOSAExpPEMulticastData=ibmOSAExpPEMulticastData, ibmOsaExpTRRcvCongestionCount=ibmOsaExpTRRcvCongestionCount, ibmOsaExpATMConfigServerATMAddr=ibmOsaExpATMConfigServerATMAddr, ibmOsaExpATMForwardDelayTime=ibmOsaExpATMForwardDelayTime, ibmOSAExpPerfTable=ibmOSAExpPerfTable, ibmOsaExpATMControlTimeout=ibmOsaExpATMControlTimeout, ibmOsaExpTREarlyTokenRelease=ibmOsaExpTREarlyTokenRelease, ibmOsaExpTRLineErrorCount=ibmOsaExpTRLineErrorCount, ibmOsaExpEthInUnknownIPFrames=ibmOsaExpEthInUnknownIPFrames, ibmOsaExpATMConfigLESATMAddress=ibmOsaExpATMConfigLESATMAddress, ibmOsaExpATMProxyClient=ibmOsaExpATMProxyClient, ibmOSAMib=ibmOSAMib, ibmOsaExpATMLePDUOctetsOutbound=ibmOsaExpATMLePDUOctetsOutbound, ibmOsaExpATMSVCFailures=ibmOsaExpATMSVCFailures, ibmOSAExpTRGroup=ibmOSAExpTRGroup, ibmOsaExpATMActualMaxDataFrmSz=ibmOsaExpATMActualMaxDataFrmSz, ibmOSAExpChannelPCIBusUtilHour=ibmOSAExpChannelPCIBusUtilHour, ibmOSAExpPerfDataLP9=ibmOSAExpPerfDataLP9, ibmOSAExpPerfDataLP7=ibmOSAExpPerfDataLP7, ibmOSAExpPEEntry=ibmOSAExpPEEntry, ibmOSAExpPerfDataLP1=ibmOSAExpPerfDataLP1, ibmOSAExpChannelProcUtilHour=ibmOSAExpChannelProcUtilHour, ibmOsaExpEthMacAddrActive=ibmOsaExpEthMacAddrActive, ibmOsaExpATMConfigELANName=ibmOsaExpATMConfigELANName, ibm=ibm, ibmOSAExpPerfDataLP10=ibmOSAExpPerfDataLP10, ibmOsaExpATMAgingTime=ibmOsaExpATMAgingTime, ibmOsaExpATMControlDistributeVPI=ibmOsaExpATMControlDistributeVPI, ibmOSAExpChannelTable=ibmOSAExpChannelTable, ibmOSAExpPEIPEntries=ibmOSAExpPEIPEntries, ibmOsaExpTRLanTrafficState=ibmOsaExpTRLanTrafficState, ibmOsaExpATMLeARPRepliesOut=ibmOsaExpATMLeARPRepliesOut, ibmOsaExpTRSingleStationCount=ibmOsaExpTRSingleStationCount, ibmOsaExpATMActualLESATMAddress=ibmOsaExpATMActualLESATMAddress, ibmOsaExpATMControlDirectVCI=ibmOsaExpATMControlDirectVCI, ibmOSAMibCompliance=ibmOSAMibCompliance, ibmOsaExpATMPortNumber=ibmOsaExpATMPortNumber, ibmOsaExpATMControlFramesIn=ibmOsaExpATMControlFramesIn, ibmOsaExpEthInGroupFrames=ibmOsaExpEthInGroupFrames, ibmOsaExpATMControlDistIntfc=ibmOsaExpATMControlDistIntfc, ibmOSAExpChannelPCIBusUtil5Min=ibmOSAExpChannelPCIBusUtil5Min, ibmOsaExpTRRemoveReceivedCount=ibmOsaExpTRRemoveReceivedCount, ibmOsaExpTRACErrorCount=ibmOsaExpTRACErrorCount, ibmOsaExpATMActualELANName=ibmOsaExpATMActualELANName, ibmOSAExpChannelHdwLevel=ibmOSAExpChannelHdwLevel, ibmOsaExpEthMacAddrBurntIn=ibmOsaExpEthMacAddrBurntIn, ibmOsaExpATMIBMEnhancedMode=ibmOsaExpATMIBMEnhancedMode, ibmOsaExpATMMaxUnknownFrameCount=ibmOsaExpATMMaxUnknownFrameCount, ibmOSAExpChannelGroup=ibmOSAExpChannelGroup, ibmOSAExpTRPortTable=ibmOSAExpTRPortTable, ibmOsaExpATMMulticastSendVPI=ibmOsaExpATMMulticastSendVPI, ibmOsaExpTRConfigName=ibmOsaExpTRConfigName, ibmOsaExpTRLobeWireFaultCount=ibmOsaExpTRLobeWireFaultCount, ibmOsaExpTRFrameCopyErrorCount=ibmOsaExpTRFrameCopyErrorCount, ibmOsaExpTRTransmitBeaconCount=ibmOsaExpTRTransmitBeaconCount, ibmOsaExpATMClientIdentifier=ibmOsaExpATMClientIdentifier, ibmOsaExpATMLePDUOctetsInbound=ibmOsaExpATMLePDUOctetsInbound, ibmOsaExpTRPortType=ibmOsaExpTRPortType, ibmOsaExpATMTopologyChange=ibmOsaExpATMTopologyChange, ibmOSAExpEthGroup=ibmOSAExpEthGroup, ibmOsaExpTRConfigSpeedMode=ibmOsaExpTRConfigSpeedMode, ibmOsaExpEthActiveSpeedMode=ibmOsaExpEthActiveSpeedMode, ibmOsaExpATMConfigMode=ibmOsaExpATMConfigMode, ibmOsaExpTRSoftErrorCount=ibmOsaExpTRSoftErrorCount, ibmOSAExpChannelNumber=ibmOSAExpChannelNumber, ibmOSAExpPEArpActiveEntries=ibmOSAExpPEArpActiveEntries, ibmOsaExpTRLostFrameErrorCount=ibmOsaExpTRLostFrameErrorCount, ibmOsaExpATMVCCTimeoutPeriod=ibmOsaExpATMVCCTimeoutPeriod, ibmOsaExpATMMltcstSendVCCAvgRate=ibmOsaExpATMMltcstSendVCCAvgRate, ibmOsaExpATMMcastSendVCCPeakRate=ibmOsaExpATMMcastSendVCCPeakRate, ibmOSAMibGroups=ibmOSAMibGroups, ibmOSAExpPerfDataLP0=ibmOSAExpPerfDataLP0, PYSNMP_MODULE_ID=ibmOSAMib, ibmOSAExpPerfGroup=ibmOSAExpPerfGroup, ibmOSAExpPerfDataLP15=ibmOSAExpPerfDataLP15, ibmOSAExpPerfEntry=ibmOSAExpPerfEntry, ibmOsaExpEthUserData=ibmOsaExpEthUserData, ibmOSAExpPETable=ibmOSAExpPETable, ibmOsaExpATMMulticastSendIntfc=ibmOsaExpATMMulticastSendIntfc, ibmOsaExpEthPortNumber=ibmOsaExpEthPortNumber, ibmOsaExpATMPortName=ibmOsaExpATMPortName, ibmOSAExpPerfDataLP6=ibmOSAExpPerfDataLP6, ibmOsaExpATMUserData=ibmOsaExpATMUserData, ibmOsaExpEthDisabledStatus=ibmOsaExpEthDisabledStatus, ibmOsaExpATMActualLanType=ibmOsaExpATMActualLanType, ibmOSAExpPerfDataLP14=ibmOSAExpPerfDataLP14, ibmOSAMibCompliances=ibmOSAMibCompliances, ibmOsaExpTRPacketsTransmitted=ibmOsaExpTRPacketsTransmitted, ibmOsaExpATMPortType=ibmOsaExpATMPortType, ibmOsaExpATMConnectCompleteTimer=ibmOsaExpATMConnectCompleteTimer, ibmOsaExpTRPortNumber=ibmOsaExpTRPortNumber, ibmOSAExpEthPortTable=ibmOSAExpEthPortTable, ibmOSAExpTRPortEntry=ibmOSAExpTRPortEntry, ibmOsaExpATMMulticastSendVCI=ibmOsaExpATMMulticastSendVCI, ibmOSAExpATMPortTable=ibmOSAExpATMPortTable, ibmOsaExpTRServiceMode=ibmOsaExpTRServiceMode, ibmOSAExpChannelNodeDesc=ibmOSAExpChannelNodeDesc, ibmOSAExpPEGroup=ibmOSAExpPEGroup, ibmOSAExpChannelSubType=ibmOSAExpChannelSubType, ibmOsaExpATMConfigSource=ibmOsaExpATMConfigSource, ibmOsaExpATMLeARPRequestsOut=ibmOsaExpATMLeARPRequestsOut, ibmOsaExpATMErrLePDUDiscIn=ibmOsaExpATMErrLePDUDiscIn, ibmOSAExpChannelProcCodeLevel=ibmOSAExpChannelProcCodeLevel, ibmOsaExpEthPortName=ibmOsaExpEthPortName, ibmOsaExpTRGroupAddrTable=ibmOsaExpTRGroupAddrTable, ibmOSAExpChannelShared=ibmOSAExpChannelShared, ibmOsaExpATMMulticastForwardVPI=ibmOsaExpATMMulticastForwardVPI, ibmOsaExpTRFullDuplexErrorCount=ibmOsaExpTRFullDuplexErrorCount, ibmOsaExpEthServiceMode=ibmOsaExpEthServiceMode, ibmOSAExpPEMulticastEntries=ibmOSAExpPEMulticastEntries, ibmOsaExpTRBurstErrorCount=ibmOsaExpTRBurstErrorCount, ibmOsaExpEthInPackets=ibmOsaExpEthInPackets, ibmOsaExpTRRingOpenStatus=ibmOsaExpTRRingOpenStatus, ibmOsaExpATMLastFailureRespCode=ibmOsaExpATMLastFailureRespCode, ibmOsaExpATMNonErrLePDUDiscIn=ibmOsaExpATMNonErrLePDUDiscIn, ibmOSAMibObjects=ibmOSAMibObjects, ibmOSAExpChannelProcUtil1Min=ibmOSAExpChannelProcUtil1Min, ibmOsaExpTRAbortTransErrorCount=ibmOsaExpTRAbortTransErrorCount, ibmOsaExpATMFlushTimeout=ibmOsaExpATMFlushTimeout, ibmOsaExpATMMaxUnknownFrameTime=ibmOsaExpATMMaxUnknownFrameTime, ibmOsaExpATMErrLePDUDiscOut=ibmOsaExpATMErrLePDUDiscOut, ibmOsaExpEthGroupAddrTable=ibmOsaExpEthGroupAddrTable, ibmOsaExpATMExpectedARPRespTime=ibmOsaExpATMExpectedARPRespTime, ibmOsaExpTRMacAddrActive=ibmOsaExpTRMacAddrActive, ibmOsaExpATMMltcstSendVCCType=ibmOsaExpATMMltcstSendVCCType, ibmOSAExpPerfDataLP8=ibmOSAExpPerfDataLP8, ibmOsaExpTRRingState=ibmOsaExpTRRingState, ibmOsaExpTRInternalErrorCount=ibmOsaExpTRInternalErrorCount, ibmOsaExpATMLeARPRepliesIn=ibmOsaExpATMLeARPRepliesIn, ibmOSAExpChannelPCIBusUtil1Min=ibmOSAExpChannelPCIBusUtil1Min, ibmOsaExpTRMacAddrBurntIn=ibmOsaExpTRMacAddrBurntIn, ibmOsaExpATMPathSwitchingDelay=ibmOsaExpATMPathSwitchingDelay, ibmOSAExpChannelEntry=ibmOSAExpChannelEntry, ibmOsaExpTRUpstreamNeighbor=ibmOsaExpTRUpstreamNeighbor, ibmOsaExpATMConfigLanType=ibmOsaExpATMConfigLanType, ibmOsaExpEthConfigName=ibmOsaExpEthConfigName, ibmOsaExpTRPacketsReceived=ibmOsaExpTRPacketsReceived, ibmOSAExpATMGroup=ibmOSAExpATMGroup, ibmOSAExpPerfDataLP4=ibmOSAExpPerfDataLP4, ibmOsaExpATMMulticastForwardVCI=ibmOsaExpATMMulticastForwardVCI, ibmOsaExpTRBeaconingAddress=ibmOsaExpTRBeaconingAddress, ibmOsaExpATMLastFailureState=ibmOsaExpATMLastFailureState, ibmOsaExpATMMaxRetryCount=ibmOsaExpATMMaxRetryCount, ibmOsaExpEthConfigSpeedMode=ibmOsaExpEthConfigSpeedMode, ibmOsaExpTRUserData=ibmOsaExpTRUserData, ibmOsaExpATMServiceMode=ibmOsaExpATMServiceMode, ibmOsaExpATMConfigDirectIntfc=ibmOsaExpATMConfigDirectIntfc, ibmOsaExpATMControlDirectVPI=ibmOsaExpATMControlDirectVPI, ibmOsaExpATMConfigName=ibmOsaExpATMConfigName, ibmOSAMibConformance=ibmOSAMibConformance, ibmOsaExpATMDisabledStatus=ibmOsaExpATMDisabledStatus, ibmOsaExpATMMacAddrBurntIn=ibmOsaExpATMMacAddrBurntIn, ibmOsaExpTRRingStatus=ibmOsaExpTRRingStatus, ibmOsaExpEthInBroadcastFrames=ibmOsaExpEthInBroadcastFrames, ibmOsaExpEthLanTrafficState=ibmOsaExpEthLanTrafficState, ibmOsaExpTRPortName=ibmOsaExpTRPortName, ibmOsaExpATMControlDirectIntfc=ibmOsaExpATMControlDirectIntfc, ibmOsaExpATMClientCurrentState=ibmOsaExpATMClientCurrentState, ibmOSAExpPerfDataLP13=ibmOSAExpPerfDataLP13, ibmOsaExpATMLeARPRequestsIn=ibmOsaExpATMLeARPRequestsIn, ibmOsaExpATMConfigMaxDataFrmSz=ibmOsaExpATMConfigMaxDataFrmSz, ibmOsaExpEthOutPackets=ibmOsaExpEthOutPackets, ibmOSAExpPEMaxSizeArpCache=ibmOSAExpPEMaxSizeArpCache, ibmOsaExpATMClientATMAddress=ibmOsaExpATMClientATMAddress, ibmOsaExpTRTokenErrorCount=ibmOsaExpTRTokenErrorCount, ibmOsaExpATMProtocol=ibmOsaExpATMProtocol, ibmOSAExpPerfDataLP11=ibmOSAExpPerfDataLP11, ibmOSAExpPerfDataLP12=ibmOSAExpPerfDataLP12, ibmOsaExpTRAllowAccessPriority=ibmOsaExpTRAllowAccessPriority, ibmOsaExpEthPortType=ibmOsaExpEthPortType, ibmOSAExpPerfDataLP5=ibmOSAExpPerfDataLP5, ibmProd=ibmProd, ibmOsaExpTRRecoveryCounter=ibmOsaExpTRRecoveryCounter, ibmOsaExpTRSignalLossErrorCount=ibmOsaExpTRSignalLossErrorCount, ibmOsaExpATMGroupMacAddrTable=ibmOsaExpATMGroupMacAddrTable, ibmOSAExpATMPortEntry=ibmOSAExpATMPortEntry, ibmOSAExpPEArpPendingEntries=ibmOSAExpPEArpPendingEntries, ibmOSAExpPerfDataLP2=ibmOSAExpPerfDataLP2, ibmOsaExpATMNonErrLePDUDiscOut=ibmOsaExpATMNonErrLePDUDiscOut, ibmOsaExpATMConfigDirectVPI=ibmOsaExpATMConfigDirectVPI, ibmOSAExpEthPortEntry=ibmOSAExpEthPortEntry, ibmOsaExpATMLeVersion=ibmOsaExpATMLeVersion, ibmOSAExpChannelProcUtil5Min=ibmOSAExpChannelProcUtil5Min, ibmOsaExpATMControlFramesOut=ibmOsaExpATMControlFramesOut, ibmOSAExpChannelType=ibmOSAExpChannelType, ibmOsaExpATMLanTrafficState=ibmOsaExpATMLanTrafficState, ibmOSAExpPerfDataLP3=ibmOSAExpPerfDataLP3, ibmOsaExpATMConfigDirectVCI=ibmOsaExpATMConfigDirectVCI, ibmOsaExpATMLocalSegmentID=ibmOsaExpATMLocalSegmentID, ibmOsaExpATMMulticastFwdIntfc=ibmOsaExpATMMulticastFwdIntfc, ibmOsaExpATMControlDistributeVCI=ibmOsaExpATMControlDistributeVCI, ibmOsaExpTRHardErrorCount=ibmOsaExpTRHardErrorCount, ibmOsaExpATMMacAddrActive=ibmOsaExpATMMacAddrActive, ibmOsaExpATMBestEffortPeakRate=ibmOsaExpATMBestEffortPeakRate)
