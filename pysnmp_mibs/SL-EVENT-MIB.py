...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/smartoptics/SL-EVENT-MIB
...
if mibBuilder.loadTexts: slEventMib.setOrganization('SmartOptics AS')
class SlGenEventType(TextualConvention, Integer32):
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))
    namedValues = NamedValues(("swUpgradeEvent", 1), ("remoteUnitFailEvent", 2), ("alsOperStatus", 3), ("opticalPowerDrop", 4), ("userLoginLogout", 5))
...
slEventTrap = NotificationType((1, 3, 6, 1, 4, 1, 4515, 1, 3, 22, 2, 2)).setObjects(("SL-EVENT-MIB", "slEventIfIndex"), ("SL-EVENT-MIB", "slEventType"), ("SL-EVENT-MIB", "slEventVal"), ("SL-EVENT-MIB", "slEventUser"), ("SL-MAIN-MIB", "slmTrapLogId"))
if mibBuilder.loadTexts: slEventTrap.setStatus('current')
slEventTrap0 = NotificationType((1, 3, 6, 1, 4, 1, 4515, 1, 3, 22, 2, 0, 2)).setObjects(("SL-EVENT-MIB", "slEventIfIndex"), ("SL-EVENT-MIB", "slEventType"), ("SL-EVENT-MIB", "slEventVal"), ("SL-EVENT-MIB", "slEventUser"), ("SL-MAIN-MIB", "slmTrapLogId"))
if mibBuilder.loadTexts: slEventTrap0.setStatus('current')
slEventInventoryTrap = NotificationType((1, 3, 6, 1, 4, 1, 4515, 1, 3, 22, 2, 3)).setObjects(("SL-EVENT-MIB", "slEventInventoryIfIndex"), ("SL-EVENT-MIB", "slEventInventoryAction"), ("SL-EVENT-MIB", "slEventInventoryType"), ("SL-EVENT-MIB", "slEventInventorySerial"), ("SL-EVENT-MIB", "slEventInventoryPartnum"), ("SL-MAIN-MIB", "slmTrapLogId"))
if mibBuilder.loadTexts: slEventInventoryTrap.setStatus('current')
slEventInventoryTrap0 = NotificationType((1, 3, 6, 1, 4, 1, 4515, 1, 3, 22, 2, 0, 3)).setObjects(("SL-EVENT-MIB", "slEventInventoryIfIndex"), ("SL-EVENT-MIB", "slEventInventoryAction"), ("SL-EVENT-MIB", "slEventInventoryType"), ("SL-EVENT-MIB", "slEventInventorySerial"), ("SL-EVENT-MIB", "slEventInventoryPartnum"), ("SL-MAIN-MIB", "slmTrapLogId"))
if mibBuilder.loadTexts: slEventInventoryTrap0.setStatus('current')
slGenEventTrap = NotificationType((1, 3, 6, 1, 4, 1, 4515, 1, 3, 22, 2, 4)).setObjects(("SL-EVENT-MIB", "slGenEventIfIndex"), ("SL-EVENT-MIB", "slGenEventType"), ("SL-EVENT-MIB", "slGenEventVal"), ("SL-EVENT-MIB", "slGenEventUser"), ("SL-MAIN-MIB", "slmTrapLogId"))
if mibBuilder.loadTexts: slGenEventTrap.setStatus('current')
slGenEventTrap0 = NotificationType((1, 3, 6, 1, 4, 1, 4515, 1, 3, 22, 2, 0, 4)).setObjects(("SL-EVENT-MIB", "slGenEventIfIndex"), ("SL-EVENT-MIB", "slGenEventType"), ("SL-EVENT-MIB", "slGenEventVal"), ("SL-EVENT-MIB", "slGenEventUser"), ("SL-MAIN-MIB", "slmTrapLogId"))
if mibBuilder.loadTexts: slGenEventTrap0.setStatus('current')
mibBuilder.exportSymbols("SL-EVENT-MIB", SlEventInventoryAction=SlEventInventoryAction, slGenEventConfigTable=slGenEventConfigTable, slEventInventoryAction=slEventInventoryAction, slGenEventTrap=slGenEventTrap, slEventInventoryType=slEventInventoryType, slEventInventoryTable=slEventInventoryTable, slEventInventoryTrap=slEventInventoryTrap, slEventMib=slEventMib, slGenEventType=slGenEventType, slEventTraps=slEventTraps, slGenEventTid=slGenEventTid, slEventInventoryPartnum=slEventInventoryPartnum, slGenEventTrap0=slGenEventTrap0, SlGenEventType=SlGenEventType, slEventTraps0=slEventTraps0, slEventTrap=slEventTrap, slEventUser=slEventUser, slGenEventUser=slGenEventUser, SlEventInventoryType=SlEventInventoryType, slEventTid=slEventTid, slEventConfig=slEventConfig, slEventIfIndex=slEventIfIndex, slEventInventoryIfIndex=slEventInventoryIfIndex, slGenEventVal=slGenEventVal, slEventVal=slEventVal, slGenEventIfIndex=slGenEventIfIndex, slEventTrap0=slEventTrap0, slEventCtag=slEventCtag, slEventInventoryTrap0=slEventInventoryTrap0, slEventInventoryEntry=slEventInventoryEntry, slEventType=slEventType, SlEventType=SlEventType, PYSNMP_MODULE_ID=slEventMib, slEventConfigEntry=slEventConfigEntry, slEventInventorySerial=slEventInventorySerial, slEventConfigTable=slEventConfigTable, slGenEventCtag=slGenEventCtag, slGenEventConfigEntry=slGenEventConfigEntry)
