...
mibBuilder.exportSymbols("SL-EVENT-MIB", slGenEventCtag=slGenEventCtag, slGenEventType=slGenEventType, slEventVal=slEventVal, slEventInventorySerial=slEventInventorySerial, slEventConfigEntry=slEventConfigEntry, slEventUser=slEventUser, slEventCtag=slEventCtag, slEventInventoryEntry=slEventInventoryEntry, slEventTrap0=slEventTrap0, PYSNMP_MODULE_ID=slEventMib, slGenEventTid=slGenEventTid, slEventTrap=slEventTrap, slEventMib=slEventMib, slEventConfigTable=slEventConfigTable, slGenEventConfigEntry=slGenEventConfigEntry, SlEventInventoryAction=SlEventInventoryAction, slEventInventoryPartnum=slEventInventoryPartnum, slEventInventoryType=slEventInventoryType, slEventInventoryTrap=slEventInventoryTrap, slEventInventoryTable=slEventInventoryTable, slEventInventoryAction=slEventInventoryAction, slGenEventConfigTable=slGenEventConfigTable, slGenEventTrap=slGenEventTrap, slEventInventoryTrap0=slEventInventoryTrap0, slGenEventTrap0=slGenEventTrap0, slGenEventIfIndex=slGenEventIfIndex, slEventConfig=slEventConfig, SlEventType=SlEventType, slEventIfIndex=slEventIfIndex, slEventTid=slEventTid, slGenEventUser=slGenEventUser, SlEventInventoryType=SlEventInventoryType, slEventTraps=slEventTraps, SlGenEventType=SlGenEventType, slEventType=slEventType, slGenEventVal=slGenEventVal, slEventTraps0=slEventTraps0, slEventInventoryIfIndex=slEventInventoryIfIndex)
