...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-TRAP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:20:08 2025
...
class _H3cPeriodicalTrapSwitch2_Type(Integer32):
    """Custom type h3cPeriodicalTrapSwitch2 based on Integer32"""
    defaultValue = 1
...
_H3cPeriodicalTrapSwitch2_Type.__name__ = "Integer32"
_H3cPeriodicalTrapSwitch2_Object = MibScalar
h3cPeriodicalTrapSwitch2 = _H3cPeriodicalTrapSwitch2_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 38, 1, 6, 1, 3),
    _H3cPeriodicalTrapSwitch2_Type()
)
h3cPeriodicalTrapSwitch2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cPeriodicalTrapSwitch2.setStatus("current")
...
class _H3cTrapConfigSwitch2_Type(Integer32):
    """Custom type h3cTrapConfigSwitch2 based on Integer32"""
    defaultValue = 1
...
_H3cTrapConfigSwitch2_Type.__name__ = "Integer32"
_H3cTrapConfigSwitch2_Object = MibTableColumn
h3cTrapConfigSwitch2 = _H3cTrapConfigSwitch2_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 38, 1, 8, 1, 1, 5),
    _H3cTrapConfigSwitch2_Type()
)
h3cTrapConfigSwitch2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    h3cTrapConfigSwitch2.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"h3cTrap": h3cTrap,
       ...
       "h3cPeriodicalTrapSwitch2": h3cPeriodicalTrapSwitch2,
       ...
       "h3cTrapConfigSwitch2": h3cTrapConfigSwitch2}
)
