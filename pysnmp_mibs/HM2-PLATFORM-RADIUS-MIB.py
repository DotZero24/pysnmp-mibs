...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-PLATFORM-RADIUS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:56:06 2025
...
_Hm2AgentRadiusAccountingMode_Type.__name__ = "HmEnabledStatus"
...
_Hm2AgentRadiusStatsClear_Type.__name__ = "HmEnabledStatus"
...
_Hm2AgentRadiusSourceIPAddr_Type.__name__ = "IpAddress"
...
_Hm2AgentRadiusNasIpAddress_Type.__name__ = "IpAddress"
...
_Hm2AgentAuthorizationNetworkRadiusMode_Type.__name__ = "HmEnabledStatus"
...
_Hm2AgentRadiusSourceInterface_Type.__name__ = "InterfaceIndexOrZero"
...
hm2SNMPExtensionRadiusGroup = _Hm2SNMPExtensionRadiusGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2)
)
_Hm2SNMPExtensionRadiusVLANAssignModeInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusVLANAssignModeInvalid = _Hm2SNMPExtensionRadiusVLANAssignModeInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 1)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusVLANAssignModeInvalid.setStatus("current")
_Hm2SNMPExtensionRadiusServerDeadTimeInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusServerDeadTimeInvalid = _Hm2SNMPExtensionRadiusServerDeadTimeInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 2)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusServerDeadTimeInvalid.setStatus("current")
_Hm2SNMPExtensionRadiusServerSecretInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusServerSecretInvalid = _Hm2SNMPExtensionRadiusServerSecretInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 3)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusServerSecretInvalid.setStatus("current")
_Hm2SNMPExtensionRadiusServerPrimaryModeInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusServerPrimaryModeInvalid = _Hm2SNMPExtensionRadiusServerPrimaryModeInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 4)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusServerPrimaryModeInvalid.setStatus("current")
_Hm2SNMPExtensionRadiusServerNameInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusServerNameInvalid = _Hm2SNMPExtensionRadiusServerNameInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 5)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusServerNameInvalid.setStatus("current")
_Hm2SNMPExtensionRadiusRetransmitInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusRetransmitInvalid = _Hm2SNMPExtensionRadiusRetransmitInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 6)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusRetransmitInvalid.setStatus("current")
_Hm2SNMPExtensionRadiusTimeoutInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusTimeoutInvalid = _Hm2SNMPExtensionRadiusTimeoutInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 7)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusTimeoutInvalid.setStatus("current")
_Hm2SNMPExtensionRadiusNASIPAddrInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusNASIPAddrInvalid = _Hm2SNMPExtensionRadiusNASIPAddrInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 8)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusNASIPAddrInvalid.setStatus("current")
_Hm2SNMPExtensionRadiusServerMSGAuthInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusServerMSGAuthInvalid = _Hm2SNMPExtensionRadiusServerMSGAuthInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 9)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusServerMSGAuthInvalid.setStatus("current")
_Hm2SNMPExtensionRadiusServerUsageTypeInvalid_ObjectIdentity = ObjectIdentity
hm2SNMPExtensionRadiusServerUsageTypeInvalid = _Hm2SNMPExtensionRadiusServerUsageTypeInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 12, 8, 2, 10)
)
if mibBuilder.loadTexts:
    hm2SNMPExtensionRadiusServerUsageTypeInvalid.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hm2PlatformRadius": hm2PlatformRadius,
       ...
       "hm2SNMPExtensionRadiusGroup": hm2SNMPExtensionRadiusGroup,
       "hm2SNMPExtensionRadiusVLANAssignModeInvalid": hm2SNMPExtensionRadiusVLANAssignModeInvalid,
       "hm2SNMPExtensionRadiusServerDeadTimeInvalid": hm2SNMPExtensionRadiusServerDeadTimeInvalid,
       "hm2SNMPExtensionRadiusServerSecretInvalid": hm2SNMPExtensionRadiusServerSecretInvalid,
       "hm2SNMPExtensionRadiusServerPrimaryModeInvalid": hm2SNMPExtensionRadiusServerPrimaryModeInvalid,
       "hm2SNMPExtensionRadiusServerNameInvalid": hm2SNMPExtensionRadiusServerNameInvalid,
       "hm2SNMPExtensionRadiusRetransmitInvalid": hm2SNMPExtensionRadiusRetransmitInvalid,
       "hm2SNMPExtensionRadiusTimeoutInvalid": hm2SNMPExtensionRadiusTimeoutInvalid,
       "hm2SNMPExtensionRadiusNASIPAddrInvalid": hm2SNMPExtensionRadiusNASIPAddrInvalid,
       "hm2SNMPExtensionRadiusServerMSGAuthInvalid": hm2SNMPExtensionRadiusServerMSGAuthInvalid,
       "hm2SNMPExtensionRadiusServerUsageTypeInvalid": hm2SNMPExtensionRadiusServerUsageTypeInvalid}
)
