...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-FIREWALL-MIB
...
if mibBuilder.loadTexts: ciscoFirewallMIB.setLastUpdated('202010010000Z')
...
mibBuilder.exportSymbols("CISCO-FIREWALL-MIB", cfwConnectionPerSecondPeak=cfwConnectionPerSecondPeak, ciscoFirewallMIBNotificationGroupRev1=ciscoFirewallMIBNotificationGroupRev1, cfwBufferStatValue=cfwBufferStatValue, PYSNMP_MODULE_ID=ciscoFirewallMIB, AuthenticationEvent=AuthenticationEvent, ciscoFirewallMIBCompliance=ciscoFirewallMIBCompliance, cfwNetEventService=cfwNetEventService, cfwBufferStatsTable=cfwBufferStatsTable, cfwNetEventInterface=cfwNetEventInterface, cfwStatus=cfwStatus, cfwConnNotification=cfwConnNotification, cfwConnectionStatType=cfwConnectionStatType, ContentInspectionEvent=ContentInspectionEvent, ciscoFirewallMIBGroups=ciscoFirewallMIBGroups, cfwEvents=cfwEvents, cfwBasicSecurityEventType=cfwBasicSecurityEventType, cfwNetEventDstIpAddress=cfwNetEventDstIpAddress, cfwConnectionStatDescription=cfwConnectionStatDescription, AccessEvent=AccessEvent, cfwNetEventsTable=cfwNetEventsTable, GenericEvent=GenericEvent, cfwSecurityNotification=cfwSecurityNotification, cfwAuthNotification=cfwAuthNotification, cfwNetEventDescription=cfwNetEventDescription, cfwConnectionStatEntry=cfwConnectionStatEntry, cfwConnectionStatTable=cfwConnectionStatTable, ciscoFirewallMIBConformance=ciscoFirewallMIBConformance, cfwBasicEventsEntry=cfwBasicEventsEntry, ConnectionEvent=ConnectionEvent, ciscoFirewallMIB=ciscoFirewallMIB, cfwBasicConnectionEventType=cfwBasicConnectionEventType, cfwHardwareInformation=cfwHardwareInformation, cfwBasicAccessEventType=cfwBasicAccessEventType, ciscoFirewallMIBEventsGroup=ciscoFirewallMIBEventsGroup, ciscoFirewallMIBComplianceRev1=ciscoFirewallMIBComplianceRev1, ciscoFirewallMIBStatisticsGroup=ciscoFirewallMIBStatisticsGroup, cfwBasicEventIndex=cfwBasicEventIndex, cfwHardwareStatusValue=cfwHardwareStatusValue, ciscoFirewallMIBObjects=ciscoFirewallMIBObjects, HardwareStatus=HardwareStatus, cfwBasicEventDescription=cfwBasicEventDescription, cfwBasicEventsTableLastRow=cfwBasicEventsTableLastRow, cfwConnectionStatService=cfwConnectionStatService, cfwBasicAuthenticationEventType=cfwBasicAuthenticationEventType, cfwNetEventServiceInformation=cfwNetEventServiceInformation, Hardware=Hardware, cfwBufferStatsEntry=cfwBufferStatsEntry, SecurityEvent=SecurityEvent, cfwNetEventsTableLastRow=cfwNetEventsTableLastRow, ciscoFirewallMIBNotifications=ciscoFirewallMIBNotifications, cfwBasicEventDetailsTableRow=cfwBasicEventDetailsTableRow, cfwNetEventSrcIpPort=cfwNetEventSrcIpPort, cfwNetEventInsideSrcIpPort=cfwNetEventInsideSrcIpPort, ciscoFirewallMIBCompliances=ciscoFirewallMIBCompliances, Services=Services, cfwNetEvents=cfwNetEvents, cfwNetEventsEntry=cfwNetEventsEntry, ciscoFirewallMIBNotificationGroup=ciscoFirewallMIBNotificationGroup, cfwBasicEventTime=cfwBasicEventTime, cfwAccessNotification=cfwAccessNotification, cfwHardwareStatusDetail=cfwHardwareStatusDetail, cfwBasicGenericEventType=cfwBasicGenericEventType, cfwNetEventSrcIpAddress=cfwNetEventSrcIpAddress, ciscoFirewallMIBNotificationPrefix=ciscoFirewallMIBNotificationPrefix, cfwNetEventInsideDstIpPort=cfwNetEventInsideDstIpPort, cfwBufferStatSize=cfwBufferStatSize, cfwNetEventIdentity=cfwNetEventIdentity, cfwBasicContentInspEventType=cfwBasicContentInspEventType, cfwNetEventIndex=cfwNetEventIndex, cfwGenericNotification=cfwGenericNotification, cfwNetEventInsideDstIpAddress=cfwNetEventInsideDstIpAddress, cfwHardwareStatusTable=cfwHardwareStatusTable, cfwBufferStatType=cfwBufferStatType, cfwNetEventInsideSrcIpAddress=cfwNetEventInsideSrcIpAddress, cfwConnectionStatCount=cfwConnectionStatCount, cfwHardwareType=cfwHardwareType, cfwNetEventDstIpPort=cfwNetEventDstIpPort, cfwConnectionPerSecond=cfwConnectionPerSecond, cfwBufferStatInformation=cfwBufferStatInformation, ConnectionStat=ConnectionStat, cfwHardwareStatusEntry=cfwHardwareStatusEntry, cfwContentInspectNotification=cfwContentInspectNotification, cfwBasicEvents=cfwBasicEvents, cfwBasicEventsTable=cfwBasicEventsTable, cfwSystem=cfwSystem, ResourceStatistics=ResourceStatistics, cfwStatistics=cfwStatistics, cfwConnectionStatValue=cfwConnectionStatValue)
