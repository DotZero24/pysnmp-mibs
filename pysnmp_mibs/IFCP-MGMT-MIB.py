...
# Notes
# -----
# ASN.1 source file://mibs/rfc/IFCP-MGMT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:22:16 2025
...
_IfcpLclGtwyInstAddrTransMode_Type.__name__ = "IfcpAddressMode"
...
_IfcpLclGtwyInstFcBrdcstSupport_Type.__name__ = "TruthValue"
...
_IfcpLclGtwyInstDefaultIpTOV_Type.__name__ = "IfcpIpTOVorZero"
...
_IfcpLclGtwyInstDefaultLTInterval_Type.__name__ = "IfcpLTIorZero"
...
_IfcpLclGtwyInstStorageType_Type.__name__ = "StorageType"
...
class _IfcpSessionLclNpWwun_Type(FcNameIdOrZero):
    """Custom type ifcpSessionLclNpWwun based on FcNameIdOrZero"""
    defaultValue = OctetString("")


_IfcpSessionLclNpWwun_Type.__name__ = "FcNameIdOrZero"
...
class _IfcpSessionRmtNpWwun_Type(FcNameIdOrZero):
    """Custom type ifcpSessionRmtNpWwun based on FcNameIdOrZero"""
    defaultValue = OctetString("")


_IfcpSessionRmtNpWwun_Type.__name__ = "FcNameIdOrZero"
...
_IfcpSessionRmtPrtlTcpPort_Type.__name__ = "InetPortNumber"
...
_IfcpSessionStorageType_Type.__name__ = "StorageType"
...
ifcpGatewayCompliance.setObjects(
      *(("IFCP-MGMT-MIB", "ifcpLclGatewayGroup"),
        ("IFCP-MGMT-MIB", "ifcpLclGatewaySessionGroup"),
        ("IFCP-MGMT-MIB", "ifcpLclGatewaySessionStatsGroup"),
        ("IFCP-MGMT-MIB", "ifcpLclGatewaySessionLcStatsGroup"))
)
if mibBuilder.loadTexts:
...
ifcpGatewayComplianceNoTranslation.setObjects(
      *(("IFCP-MGMT-MIB", "ifcpLclGatewayGroup"),
        ("IFCP-MGMT-MIB", "ifcpLclGatewaySessionGroupNoTranslation"),
        ("IFCP-MGMT-MIB", "ifcpLclGatewaySessionStatsGroup"),
        ("IFCP-MGMT-MIB", "ifcpLclGatewaySessionLcStatsGroup"))
)
if mibBuilder.loadTexts:
