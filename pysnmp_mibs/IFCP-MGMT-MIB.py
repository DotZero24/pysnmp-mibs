...
TextualConvention, StorageType, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "StorageType", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("IFCP-MGMT-MIB", ifcpLclGtwyInstNumActiveSessions=ifcpLclGtwyInstNumActiveSessions, ifcpSessionRmtNpFcid=ifcpSessionRmtNpFcid, ifcpSessionIpTOV=ifcpSessionIpTOV, ifcpLclGtwyInstVersionMin=ifcpLclGtwyInstVersionMin, ifcpSessionRmtPrtlIfAddrType=ifcpSessionRmtPrtlIfAddrType, ifcpLclGtwyInstAddrTransMode=ifcpLclGtwyInstAddrTransMode, ifcpLclGtwyInstDefaultIpTOV=ifcpLclGtwyInstDefaultIpTOV, ifcpSessionDuration=ifcpSessionDuration, ifcpSessionRxOctets=ifcpSessionRxOctets, ifcpSessionHeaderCRCErrors=ifcpSessionHeaderCRCErrors, ifcpLclGtwyInstDefaultLTInterval=ifcpLclGtwyInstDefaultLTInterval, ifcpSessionLclPrtlIfIndex=ifcpSessionLclPrtlIfIndex, ifcpSessionLclNpFcid=ifcpSessionLclNpFcid, ifcpSessionLcStatsTable=ifcpSessionLcStatsTable, ifcpSessionLclNpWwun=ifcpSessionLclNpWwun, ifcpSessionLcTxOctets=ifcpSessionLcTxOctets, IfcpAddressMode=IfcpAddressMode, ifcpSessionRmtNpWwun=ifcpSessionRmtNpWwun, ifcpSessionTxFrames=ifcpSessionTxFrames, ifcpLclGtwyInstFcBrdcstSupport=ifcpLclGtwyInstFcBrdcstSupport, ifcpLclGatewaySessionLcStatsGroup=ifcpLclGatewaySessionLcStatsGroup, ifcpLclGatewaySessionGroupNoTranslation=ifcpLclGatewaySessionGroupNoTranslation, PYSNMP_MODULE_ID=ifcpMgmtMIB, ifcpSessionTxOctets=ifcpSessionTxOctets, ifcpSessionRmtPrtlIfAddr=ifcpSessionRmtPrtlIfAddr, ifcpSessionRmtNpFcidAlias=ifcpSessionRmtNpFcidAlias, ifcpSessionStatsTable=ifcpSessionStatsTable, ifcpGatewayComplianceNoTranslation=ifcpGatewayComplianceNoTranslation, IfcpIpTOVorZero=IfcpIpTOVorZero, ifcpLclGatewaySessionGroup=ifcpLclGatewaySessionGroup, ifcpLclGtwyInstStorageType=ifcpLclGtwyInstStorageType, ifcpSessionLcRxFrames=ifcpSessionLcRxFrames, ifcpSessionRmtLTIntvl=ifcpSessionRmtLTIntvl, ifcpSessionLcRxOctets=ifcpSessionLcRxOctets, ifcpSessionStaleFrames=ifcpSessionStaleFrames, ifcpLclGtwyInstDescr=ifcpLclGtwyInstDescr, ifcpSessionLcTxFrames=ifcpSessionLcTxFrames, IfcpLTIorZero=IfcpLTIorZero, ifcpSessionIndex=ifcpSessionIndex, ifcpSessionLclPrtlTcpPort=ifcpSessionLclPrtlTcpPort, ifcpSessionLcFcPayloadCRCErrors=ifcpSessionLcFcPayloadCRCErrors, IfcpSessionStates=IfcpSessionStates, ifcpLclGtwyInstTable=ifcpLclGtwyInstTable, ifcpSessionLclLTIntvl=ifcpSessionLclLTIntvl, ifcpSessionRxFrames=ifcpSessionRxFrames, ifcpSessionLcStatsEntry=ifcpSessionLcStatsEntry, ifcpSessionLcStaleFrames=ifcpSessionLcStaleFrames, ifcpSessionLcOtherErrors=ifcpSessionLcOtherErrors, ifcpGatewayObjects=ifcpGatewayObjects, ifcpGatewayConformance=ifcpGatewayConformance, ifcpSessionLclPrtlAddrType=ifcpSessionLclPrtlAddrType, ifcpLclGatewayInfo=ifcpLclGatewayInfo, ifcpSessionOtherErrors=ifcpSessionOtherErrors, ifcpCompliances=ifcpCompliances, ifcpMgmtMIB=ifcpMgmtMIB, ifcpSessionAttributesTable=ifcpSessionAttributesTable, ifcpLclGtwyInstEntry=ifcpLclGtwyInstEntry, ifcpLclGtwyInstVersionMax=ifcpLclGtwyInstVersionMax, ifcpSessionAttributesEntry=ifcpSessionAttributesEntry, ifcpSessionLclPrtlAddr=ifcpSessionLclPrtlAddr, ifcpLclGtwyInstIndex=ifcpLclGtwyInstIndex, ifcpSessionRmtPrtlTcpPort=ifcpSessionRmtPrtlTcpPort, ifcpSessionBound=ifcpSessionBound, ifcpSessionStorageType=ifcpSessionStorageType, ifcpSessionStatsEntry=ifcpSessionStatsEntry, ifcpSessionState=ifcpSessionState, ifcpSessionFcPayloadCRCErrors=ifcpSessionFcPayloadCRCErrors, ifcpNportSessionInfo=ifcpNportSessionInfo, ifcpGroups=ifcpGroups, ifcpLclGatewaySessionStatsGroup=ifcpLclGatewaySessionStatsGroup, ifcpSessionLcHeaderCRCErrors=ifcpSessionLcHeaderCRCErrors, ifcpLclGtwyInstPhyIndex=ifcpLclGtwyInstPhyIndex, ifcpLclGatewayGroup=ifcpLclGatewayGroup, ifcpSessionDiscontinuityTime=ifcpSessionDiscontinuityTime, ifcpGatewayCompliance=ifcpGatewayCompliance)
