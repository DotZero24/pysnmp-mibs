...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-ENTITY-EXT-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:18:49 2025
...
h3cEntityExtCpuUsageRecoverThreshold = _H3cEntityExtCpuUsageRecoverThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 1, 1, 1, 31),
...
h3cEntityExtMemSizeRev = _H3cEntityExtMemSizeRev_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 1, 1, 1, 32),
    _H3cEntityExtMemSizeRev_Type()
)
h3cEntityExtMemSizeRev.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtMemSizeRev.setStatus("current")
if mibBuilder.loadTexts:
    h3cEntityExtMemSizeRev.setUnits("bytes")


class _H3cEntityExtCpuUsageIn1Minute_Type(Integer32):
    """Custom type h3cEntityExtCpuUsageIn1Minute based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_H3cEntityExtCpuUsageIn1Minute_Type.__name__ = "Integer32"
_H3cEntityExtCpuUsageIn1Minute_Object = MibTableColumn
h3cEntityExtCpuUsageIn1Minute = _H3cEntityExtCpuUsageIn1Minute_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 1, 1, 1, 33),
    _H3cEntityExtCpuUsageIn1Minute_Type()
)
h3cEntityExtCpuUsageIn1Minute.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtCpuUsageIn1Minute.setStatus("current")


class _H3cEntityExtCpuUsageIn5Minutes_Type(Integer32):
    """Custom type h3cEntityExtCpuUsageIn5Minutes based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_H3cEntityExtCpuUsageIn5Minutes_Type.__name__ = "Integer32"
_H3cEntityExtCpuUsageIn5Minutes_Object = MibTableColumn
h3cEntityExtCpuUsageIn5Minutes = _H3cEntityExtCpuUsageIn5Minutes_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 1, 1, 1, 34),
    _H3cEntityExtCpuUsageIn5Minutes_Type()
)
h3cEntityExtCpuUsageIn5Minutes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtCpuUsageIn5Minutes.setStatus("current")
...
h3cEntityExtVoltageObjects = _H3cEntityExtVoltageObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5)
)
_H3cEntityExtVoltageTable_Object = MibTable
h3cEntityExtVoltageTable = _H3cEntityExtVoltageTable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5, 1)
)
if mibBuilder.loadTexts:
    h3cEntityExtVoltageTable.setStatus("current")
_H3cEntityExtVoltageEntry_Object = MibTableRow
h3cEntityExtVoltageEntry = _H3cEntityExtVoltageEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5, 1, 1)
)
h3cEntityExtVoltageEntry.setIndexNames(
    (0, "H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
)
if mibBuilder.loadTexts:
    h3cEntityExtVoltageEntry.setStatus("current")
_H3cEntityExtCurrentVoltage_Type = Integer32
_H3cEntityExtCurrentVoltage_Object = MibTableColumn
h3cEntityExtCurrentVoltage = _H3cEntityExtCurrentVoltage_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5, 1, 1, 1),
    _H3cEntityExtCurrentVoltage_Type()
)
h3cEntityExtCurrentVoltage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtCurrentVoltage.setStatus("current")
_H3cEntityExtNominalVoltage_Type = Integer32
_H3cEntityExtNominalVoltage_Object = MibTableColumn
h3cEntityExtNominalVoltage = _H3cEntityExtNominalVoltage_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5, 1, 1, 2),
    _H3cEntityExtNominalVoltage_Type()
)
h3cEntityExtNominalVoltage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtNominalVoltage.setStatus("current")


class _H3cEntityExtVoltageState_Type(Integer32):
    """Custom type h3cEntityExtVoltageState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_H3cEntityExtVoltageState_Type.__name__ = "Integer32"
_H3cEntityExtVoltageState_Object = MibTableColumn
h3cEntityExtVoltageState = _H3cEntityExtVoltageState_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5, 1, 1, 3),
    _H3cEntityExtVoltageState_Type()
)
h3cEntityExtVoltageState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtVoltageState.setStatus("current")
_H3cEntityExtVoltageMajorLowThreshold_Type = Integer32
_H3cEntityExtVoltageMajorLowThreshold_Object = MibTableColumn
h3cEntityExtVoltageMajorLowThreshold = _H3cEntityExtVoltageMajorLowThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5, 1, 1, 4),
    _H3cEntityExtVoltageMajorLowThreshold_Type()
)
h3cEntityExtVoltageMajorLowThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtVoltageMajorLowThreshold.setStatus("current")
_H3cEntityExtVoltageFatalLowThreshold_Type = Integer32
_H3cEntityExtVoltageFatalLowThreshold_Object = MibTableColumn
h3cEntityExtVoltageFatalLowThreshold = _H3cEntityExtVoltageFatalLowThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5, 1, 1, 5),
    _H3cEntityExtVoltageFatalLowThreshold_Type()
)
h3cEntityExtVoltageFatalLowThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtVoltageFatalLowThreshold.setStatus("current")
_H3cEntityExtVoltageMajorHighThreshold_Type = Integer32
_H3cEntityExtVoltageMajorHighThreshold_Object = MibTableColumn
h3cEntityExtVoltageMajorHighThreshold = _H3cEntityExtVoltageMajorHighThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5, 1, 1, 6),
    _H3cEntityExtVoltageMajorHighThreshold_Type()
)
h3cEntityExtVoltageMajorHighThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtVoltageMajorHighThreshold.setStatus("current")
_H3cEntityExtVoltageFatalHighThreshold_Type = Integer32
_H3cEntityExtVoltageFatalHighThreshold_Object = MibTableColumn
h3cEntityExtVoltageFatalHighThreshold = _H3cEntityExtVoltageFatalHighThreshold_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 1, 5, 1, 1, 7),
    _H3cEntityExtVoltageFatalHighThreshold_Type()
)
h3cEntityExtVoltageFatalHighThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    h3cEntityExtVoltageFatalHighThreshold.setStatus("current")
...
h3cEntityExtGroup.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ...
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtCpuUsageRecoverThreshold"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtMemSizeRev"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtCpuUsageIn1Minute"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtCpuUsageIn5Minutes"))
)
if mibBuilder.loadTexts:
...
h3cEntityExtMemUsageThresholdOverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 2, 0, 35)
)
h3cEntityExtMemUsageThresholdOverTrap.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtMemUsage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtMemUsageThreshold"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtMemSizeRev"),
...
if mibBuilder.loadTexts:
    h3cEntityExtMemUsageThresholdOverTrap.setStatus(
        "current"
    )

h3cEntityExtMemUsageThresholdRecoverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 2, 0, 36)
)
h3cEntityExtMemUsageThresholdRecoverTrap.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtMemUsage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtMemUsageThreshold"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtMemSizeRev"),
...
if mibBuilder.loadTexts:
    h3cEntityExtMemUsageThresholdRecoverTrap.setStatus(
        "current"
    )

h3cEntityExtVoltageNormal = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 2, 0, 37)
)
h3cEntityExtVoltageNormal.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtCurrentVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtNominalVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtVoltageMajorLowThreshold"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtVoltageMajorHighThreshold"))
)
if mibBuilder.loadTexts:
    h3cEntityExtVoltageNormal.setStatus(
        "current"
    )

h3cEntityExtVoltageLower = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 2, 0, 38)
)
h3cEntityExtVoltageLower.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtCurrentVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtNominalVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtVoltageMajorLowThreshold"))
...
if mibBuilder.loadTexts:
    h3cEntityExtVoltageLower.setStatus(
        "current"
    )

h3cEntityExtVoltageTooLow = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 2, 0, 39)
)
h3cEntityExtVoltageTooLow.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtCurrentVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtNominalVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtVoltageFatalLowThreshold"))
)
if mibBuilder.loadTexts:
    h3cEntityExtVoltageTooLow.setStatus(
        "current"
    )

h3cEntityExtVoltageHigher = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 2, 0, 40)
)
h3cEntityExtVoltageHigher.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtCurrentVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtNominalVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtVoltageMajorHighThreshold"))
...
if mibBuilder.loadTexts:
    h3cEntityExtVoltageHigher.setStatus(
        "current"
    )

h3cEntityExtVoltageTooHigh = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 2, 0, 41)
)
h3cEntityExtVoltageTooHigh.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtCurrentVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtNominalVoltage"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtVoltageFatalHighThreshold"))
)
if mibBuilder.loadTexts:
    h3cEntityExtVoltageTooHigh.setStatus(
        "current"
    )

h3cEntityExtSFPAlarmOnEx = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 2, 0, 42)
)
h3cEntityExtSFPAlarmOnEx.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("ENTITY-MIB", "entPhysicalName"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtAdminStatus"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtAlarmLight"),
...
if mibBuilder.loadTexts:
    h3cEntityExtSFPAlarmOnEx.setStatus(
        "current"
    )

h3cEntityExtSFPAlarmOffEx = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 6, 2, 0, 43)
)
h3cEntityExtSFPAlarmOffEx.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtPhysicalIndex"),
        ("ENTITY-MIB", "entPhysicalName"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtAdminStatus"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtAlarmLight"),
...
if mibBuilder.loadTexts:
    h3cEntityExtSFPAlarmOffEx.setStatus(
        "current"
    )
...
h3cEntityExtNotificationGroup.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtTemperatureThresholdNotification"),
        ...
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtMemUsageThresholdOverTrap"),
        ...
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtVoltageLower"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtVoltageHigher"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtVoltageTooHigh"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtSFPAlarmOnEx"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtSFPAlarmOffEx"))
)
if mibBuilder.loadTexts:
...
h3cEntityExtCompliance.setObjects(
      *(("H3C-ENTITY-EXT-MIB", "h3cEntityExtGroup"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtNotificationGroup"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtManuGroup"),
        ("H3C-ENTITY-EXT-MIB", "h3cEntityExtPowerGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"H3cAdminState": H3cAdminState,
       ...
       "h3cEntityExtMemSizeRev": h3cEntityExtMemSizeRev,
       "h3cEntityExtCpuUsageIn1Minute": h3cEntityExtCpuUsageIn1Minute,
       "h3cEntityExtCpuUsageIn5Minutes": h3cEntityExtCpuUsageIn5Minutes,
       ...
       "h3cEntityExtVoltageObjects": h3cEntityExtVoltageObjects,
       "h3cEntityExtVoltageTable": h3cEntityExtVoltageTable,
       "h3cEntityExtVoltageEntry": h3cEntityExtVoltageEntry,
       "h3cEntityExtCurrentVoltage": h3cEntityExtCurrentVoltage,
       "h3cEntityExtNominalVoltage": h3cEntityExtNominalVoltage,
       ...
       "h3cEntityExtVoltageFatalLowThreshold": h3cEntityExtVoltageFatalLowThreshold,
       "h3cEntityExtVoltageMajorHighThreshold": h3cEntityExtVoltageMajorHighThreshold,
       "h3cEntityExtVoltageFatalHighThreshold": h3cEntityExtVoltageFatalHighThreshold,
       ...
       "h3cEntityExtMemUsageThresholdOverTrap": h3cEntityExtMemUsageThresholdOverTrap,
       "h3cEntityExtMemUsageThresholdRecoverTrap": h3cEntityExtMemUsageThresholdRecoverTrap,
       "h3cEntityExtVoltageNormal": h3cEntityExtVoltageNormal,
       "h3cEntityExtVoltageLower": h3cEntityExtVoltageLower,
       "h3cEntityExtVoltageTooLow": h3cEntityExtVoltageTooLow,
       "h3cEntityExtVoltageHigher": h3cEntityExtVoltageHigher,
       "h3cEntityExtVoltageTooHigh": h3cEntityExtVoltageTooHigh,
       "h3cEntityExtSFPAlarmOnEx": h3cEntityExtSFPAlarmOnEx,
       "h3cEntityExtSFPAlarmOffEx": h3cEntityExtSFPAlarmOffEx,
