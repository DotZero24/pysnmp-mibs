...
mibBuilder.exportSymbols("A3COM-HUAWEI-NQA-MIB", hwNqaStatJitterSumOfNegDS=hwNqaStatJitterSumOfNegDS, hwNqaStatReactOwnerIndex=hwNqaStatReactOwnerIndex, hwNqaUdpServerPort=hwNqaUdpServerPort, hwNqaJitterStatsSumOfNegativesSD=hwNqaJitterStatsSumOfNegativesSD, hwNqaStatResMinDelaySD=hwNqaStatResMinDelaySD, hwNqaJitterStatsOperOfMOS=hwNqaJitterStatsOperOfMOS, hwNqaStatJitterMinOfPosDS=hwNqaStatJitterMinOfPosDS, hwNqaStatJitterSumOfNegSD=hwNqaStatJitterSumOfNegSD, hwNqaMOSOverThreshold=hwNqaMOSOverThreshold, hwNqaStatResIpTargetAddress=hwNqaStatResIpTargetAddress, hwNqaJitterStatsMaxOfPositivesDS=hwNqaJitterStatsMaxOfPositivesDS, hwNqaResultsNumOfDelayDS=hwNqaResultsNumOfDelayDS, hwNqaResultsMinDelayDS=hwNqaResultsMinDelayDS, hwNqaJitterStatsSum2NegativesDS=hwNqaJitterStatsSum2NegativesDS, hwNqaReactCheckedNum=hwNqaReactCheckedNum, hwNqaStatReactCheckedNum=hwNqaStatReactCheckedNum, hwNqaStatJitterAveNegSD=hwNqaStatJitterAveNegSD, hwNqaCtlEntry=hwNqaCtlEntry, hwNqaStatJitterPacketLossSD=hwNqaStatJitterPacketLossSD, hwNqaStatResStartTime=hwNqaStatResStartTime, hwNqaReactTestName=hwNqaReactTestName, hwNqaStatResSum2DelayDS=hwNqaStatResSum2DelayDS, hwNqaCtlBeginTime=hwNqaCtlBeginTime, hwNqaCtlHistoryKeptTime=hwNqaCtlHistoryKeptTime, hwNqaJitterStatsNumOfPositivesDS=hwNqaJitterStatsNumOfPositivesDS, hwNqaStatResMaxDelayDS=hwNqaStatResMaxDelayDS, hwNqaStatJitterMinOfNegSD=hwNqaStatJitterMinOfNegSD, hwNqaStatJitterMaxOfICPIF=hwNqaStatJitterMaxOfICPIF, hwNqaJitterStatsMaxOfNegativesSD=hwNqaJitterStatsMaxOfNegativesSD, hwNqaStatResIpTargetAddressType=hwNqaStatResIpTargetAddressType, hwNqaResultsRttStatsErrors=hwNqaResultsRttStatsErrors, hwNqaStatJitterIndex=hwNqaStatJitterIndex, hwNqaReactItemIndex=hwNqaReactItemIndex, hwNqaStatisticsCtlEntry=hwNqaStatisticsCtlEntry, hwNqaCtlVPNInstance=hwNqaCtlVPNInstance, hwNqaCtlTTL=hwNqaCtlTTL, hwNqaStatResRttNoConnections=hwNqaStatResRttNoConnections, hwNqaStatResNumOfDelayDS=hwNqaStatResNumOfDelayDS, hwNqaStatResMaxDelaySD=hwNqaStatResMaxDelaySD, hwNqaJitterStatsPacketLossSD=hwNqaJitterStatsPacketLossSD, hwNqaResultsSumDelaySD=hwNqaResultsSumDelaySD, hwNqaJitterStatsMinOfNegativesDS=hwNqaJitterStatsMinOfNegativesDS, hwNqaJitterStatsAvePositivesSD=hwNqaJitterStatsAvePositivesSD, hwNqaReactThresholdNum=hwNqaReactThresholdNum, hwNqaJitterStatsSumOfPositivesDS=hwNqaJitterStatsSumOfPositivesDS, hwNqaStatJitterSumOfSquareNegDS=hwNqaStatJitterSumOfSquareNegDS, hwNqaJitterStatsMinOfNegativesSD=hwNqaJitterStatsMinOfNegativesSD, hwNqajitter=hwNqajitter, hwNqaTcpServerEntry=hwNqaTcpServerEntry, hwNqaStatResNumOfDelaySD=hwNqaStatResNumOfDelaySD, hwNqaImplementationTypeDomains=hwNqaImplementationTypeDomains, hwNqa=hwNqa, hwNqaStatReactTestName=hwNqaStatReactTestName, hwNqaResultsSumDelayDS=hwNqaResultsSumDelayDS, hwNqaStatJitterNumOfPosDS=hwNqaStatJitterNumOfPosDS, hwNqaProbeTimeOverThreshold=hwNqaProbeTimeOverThreshold, hwNqaJitterSDOverThreshold=hwNqaJitterSDOverThreshold, hwNqaStatResProbeResponses=hwNqaStatResProbeResponses, hwNqaTcpconnect=hwNqaTcpconnect, hwNqaStatJitterMaxOfPosDS=hwNqaStatJitterMaxOfPosDS, hwNqaJitterStatsSum2PositivesSD=hwNqaJitterStatsSum2PositivesSD, hwNqaReactThresholdLowerLimit=hwNqaReactThresholdLowerLimit, hwNqaReactThresholdConsecNum=hwNqaReactThresholdConsecNum, hwNqaStatResSumDelayDS=hwNqaStatResSumDelayDS, hwNqaCtlStatisticsInterval=hwNqaCtlStatisticsInterval, hwNqaStatisticsCtlTable=hwNqaStatisticsCtlTable, hwNqaResultsNumOfDelaySD=hwNqaResultsNumOfDelaySD, hwNqaTcpServerIpAddress=hwNqaTcpServerIpAddress, hwNqaJitterStatsSum2NegativesSD=hwNqaJitterStatsSum2NegativesSD, hwNqaAgentEnable=hwNqaAgentEnable, hwNqaResultsRttNoConnections=hwNqaResultsRttNoConnections, hwNqaJitterStatsSumOfPositivesSD=hwNqaJitterStatsSumOfPositivesSD, hwNqaJitterStatsSumOfNegativesDS=hwNqaJitterStatsSumOfNegativesDS, hwNqaReactActionType=hwNqaReactActionType, hwNqaResultsMaxDelayDS=hwNqaResultsMaxDelayDS, hwNqaTcpServerPort=hwNqaTcpServerPort, hwNqaReactCurrentStatus=hwNqaReactCurrentStatus, hwNqaStatsMaxGroupNumber=hwNqaStatsMaxGroupNumber, hwNqaStatResRttSumOfSquares=hwNqaStatResRttSumOfSquares, hwNqaNotifications=hwNqaNotifications, hwNqaTcpServerTable=hwNqaTcpServerTable, hwNqaStatResRttSequenceErrors=hwNqaStatResRttSequenceErrors, hwNqaObjects=hwNqaObjects, hwNqaJitterStatsMinOfPositivesSD=hwNqaJitterStatsMinOfPositivesSD, hwNqaStatJitterMaxOfNegSD=hwNqaStatJitterMaxOfNegSD, hwNqaStatResSum2DelaySD=hwNqaStatResSum2DelaySD, hwNqaStatResRttNumDisconnects=hwNqaStatResRttNumDisconnects, hwNqaStatResInterval=hwNqaStatResInterval, hwNqaCtlICPIFAdvFactor=hwNqaCtlICPIFAdvFactor, hwNqaCtlHistoryEnable=hwNqaCtlHistoryEnable, hwNqaJitterStatsTable=hwNqaJitterStatsTable, hwNqaStatJitterMaxOfPosSD=hwNqaStatJitterMaxOfPosSD, hwNqaResultsRttTimeouts=hwNqaResultsRttTimeouts, hwNqaJitterStatsPacketLossDS=hwNqaJitterStatsPacketLossDS, hwNqaStatResMinRtt=hwNqaStatResMinRtt, hwNqaJitterStatsOperOfICPIF=hwNqaJitterStatsOperOfICPIF, hwNqaftp=hwNqaftp, hwNqaResultsLostPacketRatio=hwNqaResultsLostPacketRatio, hwNqaStatResLostPacketRatio=hwNqaStatResLostPacketRatio, hwNqaStatResRttTimeouts=hwNqaStatResRttTimeouts, hwNqaStatJitterMinOfNegDS=hwNqaStatJitterMinOfNegDS, hwNqaResultsRttDrops=hwNqaResultsRttDrops, hwNqaJitterStatsSum2PositivesDS=hwNqaJitterStatsSum2PositivesDS, hwNqaUdpServerEntry=hwNqaUdpServerEntry, hwNqaGroupStatsJitterEntry=hwNqaGroupStatsJitterEntry, hwNqaCtlHttpOperationString=hwNqaCtlHttpOperationString, hwNqaJitterStatsMaxOfPositivesSD=hwNqaJitterStatsMaxOfPositivesSD, hwNqaResultsSum2DelayDS=hwNqaResultsSum2DelayDS, hwNqaStatResRttErrors=hwNqaStatResRttErrors, hwNqaStatJitterAvePosSD=hwNqaStatJitterAvePosSD, hwNqaStatJitterSumOfPosSD=hwNqaStatJitterSumOfPosSD, hwNqaResultsTable=hwNqaResultsTable, hwNqaStatJitterNumOfNegDS=hwNqaStatJitterNumOfNegDS, hwNqaUdpServerRowStatus=hwNqaUdpServerRowStatus, hwNqaStatJitterSumOfPosDS=hwNqaStatJitterSumOfPosDS, hwNqaCtlTable=hwNqaCtlTable, hwNqaCtlJitterAdminNumPackets=hwNqaCtlJitterAdminNumPackets, hwNqaStatJitterMinOfMOS=hwNqaStatJitterMinOfMOS, hwNqaResultsMaxDelaySD=hwNqaResultsMaxDelaySD, hwNqaUdpServerTable=hwNqaUdpServerTable, hwNqaTcpServerRowStatus=hwNqaTcpServerRowStatus, hwNqaCtlTargetPort=hwNqaCtlTargetPort, hwNqaStatReactThresholdNum=hwNqaStatReactThresholdNum, hwNqaStatResRttSum=hwNqaStatResRttSum, hwNqaStatResMaxRtt=hwNqaStatResMaxRtt, hwNqaJitterStatsAvePositivesDS=hwNqaJitterStatsAvePositivesDS, hwNqaReactThresholdUpperLimit=hwNqaReactThresholdUpperLimit, hwNqadlsw=hwNqadlsw, hwNqaStatResSumDelaySD=hwNqaStatResSumDelaySD, hwNqaCtlSourcePort=hwNqaCtlSourcePort, hwNqaJitterStatsAveNegativesSD=hwNqaJitterStatsAveNegativesSD, hwNqaHttp=hwNqaHttp, hwNqaReactionEntry=hwNqaReactionEntry, hwNqaStatJitterPktLossUnknown=hwNqaStatJitterPktLossUnknown, hwNqaReactOwnerIndex=hwNqaReactOwnerIndex, hwNqaStatJitterSumOfSquarePosDS=hwNqaStatJitterSumOfSquarePosDS, hwNqaStatResPacketLateArrival=hwNqaStatResPacketLateArrival, hwNqaStatisticsReactionTable=hwNqaStatisticsReactionTable, hwNqaStatJitterAveNegDS=hwNqaStatJitterAveNegDS, hwNqaStatisticsReactionEntry=hwNqaStatisticsReactionEntry, hwNqaStatJitterMaxOfMOS=hwNqaStatJitterMaxOfMOS, hwNqaResultsPacketLateArrival=hwNqaResultsPacketLateArrival, hwNqaUdpEcho=hwNqaUdpEcho, hwNqaMIBVersion=hwNqaMIBVersion, hwNqaCtlHttpOperationType=hwNqaCtlHttpOperationType, hwNqaResultsRttNumDisconnects=hwNqaResultsRttNumDisconnects, hwNqaCtlFtpOperationString=hwNqaCtlFtpOperationString, hwNqaJitterStatsNumOfNegativesDS=hwNqaJitterStatsNumOfNegativesDS, hwNqaJitterStatsNumOfPositivesSD=hwNqaJitterStatsNumOfPositivesSD, hwNqaCtlJitterAdminInterval=hwNqaCtlJitterAdminInterval, hwNqaStatJitterSumOfSquarePosSD=hwNqaStatJitterSumOfSquarePosSD, hwNqaStatJitterAvePosDS=hwNqaStatJitterAvePosDS, hwNqaStatJitterNumOfPosSD=hwNqaStatJitterNumOfPosSD, hwNqaCtlFtpOperationType=hwNqaCtlFtpOperationType, hwNqaStatResSentProbes=hwNqaStatResSentProbes, PYSNMP_MODULE_ID=hwNqa, hwNqaJitterStatsNumOfRTT=hwNqaJitterStatsNumOfRTT, hwNqaUdpServerIpAddress=hwNqaUdpServerIpAddress, hwNqaReactThresholdAccumNum=hwNqaReactThresholdAccumNum, hwNqaServerEnable=hwNqaServerEnable, hwNqadhcp=hwNqadhcp, hwNqaJitterStatsEntry=hwNqaJitterStatsEntry, hwNqaStatisticsResultsEntry=hwNqaStatisticsResultsEntry, hwNqaResultsRttSum=hwNqaResultsRttSum, hwNqaReactThresholdType=hwNqaReactThresholdType, hwNqaJitterStatsMinOfPositivesDS=hwNqaJitterStatsMinOfPositivesDS, hwNqaResultsRttSequenceErrors=hwNqaResultsRttSequenceErrors, hwNqaStatJitterNumOfNegSD=hwNqaStatJitterNumOfNegSD, hwNqaReactionTable=hwNqaReactionTable, hwNqaResultsMinDelaySD=hwNqaResultsMinDelaySD, hwNqaStatReactItemIndex=hwNqaStatReactItemIndex, hwNqaJitterStatsMaxOfNegativesDS=hwNqaJitterStatsMaxOfNegativesDS, hwNqaStatisticsResultsTable=hwNqaStatisticsResultsTable, hwNqaStatJitterMinOfPosSD=hwNqaStatJitterMinOfPosSD, hwNqaStatJitterSumOfSquareNegSD=hwNqaStatJitterSumOfSquareNegSD, hwNqaJitterRTTOverThreshold=hwNqaJitterRTTOverThreshold, hwNqaProbeFailure=hwNqaProbeFailure, hwNqaStatJitterMaxOfNegDS=hwNqaStatJitterMaxOfNegDS, hwNqaResultsSum2DelaySD=hwNqaResultsSum2DelaySD, hwNqaCtlStatisticsKeptTime=hwNqaCtlStatisticsKeptTime, hwNqaStatJitterMinOfICPIF=hwNqaStatJitterMinOfICPIF, hwNqaCtlFtpPassword=hwNqaCtlFtpPassword, hwNqaICPIFOverThreshold=hwNqaICPIFOverThreshold, hwNqaStatResRttDrops=hwNqaStatResRttDrops, hwNqaStatResMinDelayDS=hwNqaStatResMinDelayDS, hwNqaCtlLifeTime=hwNqaCtlLifeTime, hwNqaJitterStatsAveNegativesDS=hwNqaJitterStatsAveNegativesDS, hwNqaReactCheckedElement=hwNqaReactCheckedElement, hwNqaCtlFtpUsername=hwNqaCtlFtpUsername, hwNqaCtlCodecType=hwNqaCtlCodecType, hwNqaResultsRttBusies=hwNqaResultsRttBusies, hwNqaStatResIndex=hwNqaStatResIndex, hwNqaReactRowStatus=hwNqaReactRowStatus, hwNqaStatJitterPacketLossDS=hwNqaStatJitterPacketLossDS, hwNqaJitterStatsNumOfNegativesSD=hwNqaJitterStatsNumOfNegativesSD, hwNqaStatResAverageRtt=hwNqaStatResAverageRtt, hwNqaStatReactIndex=hwNqaStatReactIndex, hwNqaJitterDSOverThreshold=hwNqaJitterDSOverThreshold, hwNqaStatResRttBusies=hwNqaStatResRttBusies, hwNqaGroupStatsJitterTable=hwNqaGroupStatsJitterTable, hwNqaJitterPacketLoss=hwNqaJitterPacketLoss, hwNqaCtlStatisticsGroupNumber=hwNqaCtlStatisticsGroupNumber, hwNqaJitterStatsPktLossUnknown=hwNqaJitterStatsPktLossUnknown, hwNqaResultsEntry=hwNqaResultsEntry)
