...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-VISM-ATM-TRUNK-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:36:00 2025
...
_VismAal2CidVad_Type.__name__ = "TruthValue"
...
_VismAal2CidDtmfTransport_Type.__name__ = "TruthValue"
...
_VismAal2CidEcanEnable_Type.__name__ = "TruthValue"
...
_VismAal2CidICSEnable_Type.__name__ = "TruthValue"
...
cvismAtmTrunkCompliance.setObjects(
      *(("CISCO-VISM-ATM-TRUNK-MIB", "ciscoVismBearerConnGroup"),
        ("CISCO-VISM-ATM-TRUNK-MIB", "ciscoVismAAl2CidGroup"))
)
if mibBuilder.loadTexts:
...
cvismAtmTrunkComplianceRev1.setObjects(
      *(("CISCO-VISM-ATM-TRUNK-MIB", "ciscoVismBearerConnGroup"),
        ("CISCO-VISM-ATM-TRUNK-MIB", "ciscoVismAAl2CidGroupRev1"))
)
if mibBuilder.loadTexts:
...
cvismAtmTrunkComplianceRev2.setObjects(
      *(("CISCO-VISM-ATM-TRUNK-MIB", "ciscoVismBearerConnGroupRev1"),
        ("CISCO-VISM-ATM-TRUNK-MIB", "ciscoVismAAl2CidGroupRev1"))
)
if mibBuilder.loadTexts:
