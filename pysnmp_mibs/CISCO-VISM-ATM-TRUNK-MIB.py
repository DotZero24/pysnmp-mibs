...
mibBuilder.exportSymbols("CISCO-VISM-ATM-TRUNK-MIB", bearerConnGrp=bearerConnGrp, vismAal2CidType3Redundancy=vismAal2CidType3Redundancy, bearerRcvdPkts=bearerRcvdPkts, cvismAtmTrunkMIBGroups=cvismAtmTrunkMIBGroups, vismAal2CidProfileNum=vismAal2CidProfileNum, bearerCntClrButton=bearerCntClrButton, vismAal2CidICSEnable=vismAal2CidICSEnable, bearerCurrentExtRAIXmtCnts=bearerCurrentExtRAIXmtCnts, bearerCurrentRcvCellRate=bearerCurrentRcvCellRate, bearerCid=bearerCid, vismAal2CidAdminState=vismAal2CidAdminState, cvismAtmTrunkComplianceRev1=cvismAtmTrunkComplianceRev1, cvismAtmTrunkCompliance=cvismAtmTrunkCompliance, bearerCurrentConnAISCnts=bearerCurrentConnAISCnts, bearerSentPkts=bearerSentPkts, bearerAal2ConnRDICnts=bearerAal2ConnRDICnts, vismAal2CidCnfTable=vismAal2CidCnfTable, vismAal2CidEcanEnable=vismAal2CidEcanEnable, bearerLatency=bearerLatency, bearerAal2ExtAISCnts=bearerAal2ExtAISCnts, vismAal2CidGrp=vismAal2CidGrp, ciscoVismBearerConnGroupRev1=ciscoVismBearerConnGroupRev1, bearerPeakRcvCellRate=bearerPeakRcvCellRate, bearerConnEntry=bearerConnEntry, bearerSentOctets=bearerSentOctets, vismAal2CnfPktPeriod=vismAal2CnfPktPeriod, ciscoVismAAl2CidGroupRev1=ciscoVismAAl2CidGroupRev1, bearerAal2ExtRAICnts=bearerAal2ExtRAICnts, vismAal2CidState=vismAal2CidState, vismAal2CidNum=vismAal2CidNum, bearerAal2ConnAISCnts=bearerAal2ConnAISCnts, vismAal2CidProfileType=vismAal2CidProfileType, bearerCurrentExtAISRcvCnts=bearerCurrentExtAISRcvCnts, vismAal2CidFailReason=vismAal2CidFailReason, vismAal2CidEntry=vismAal2CidEntry, bearerEndptNum=bearerEndptNum, vismAal2EndptNum=vismAal2EndptNum, bearerCurrentExtAISXmtCnts=bearerCurrentExtAISXmtCnts, vismAal2CidRowStatus=vismAal2CidRowStatus, cvismAtmTrunkMIBConformance=cvismAtmTrunkMIBConformance, bearerCurrentConnRDICnts=bearerCurrentConnRDICnts, PYSNMP_MODULE_ID=ciscoVismAtmTrunkMIB, vismAal2CidCasTransport=vismAal2CidCasTransport, vismAal2CidCodecType=vismAal2CidCodecType, bearerRcvdOctets=bearerRcvdOctets, bearerCurrentExtRAIRcvCnts=bearerCurrentExtRAIRcvCnts, bearerLostPkts=bearerLostPkts, bearerPeakXmtCellRate=bearerPeakXmtCellRate, vismAal2CidLcn=vismAal2CidLcn, ciscoVismAtmTrunkMIB=ciscoVismAtmTrunkMIB, ciscoVismBearerConnGroup=ciscoVismBearerConnGroup, bearerLcn=bearerLcn, bearerJitter=bearerJitter, vismAal2CidVad=vismAal2CidVad, bearerConnTable=bearerConnTable, bearerCurrentXmtCellRate=bearerCurrentXmtCellRate, cvismAtmTrunkComplianceRev2=cvismAtmTrunkComplianceRev2, vismAal2CidDtmfTransport=vismAal2CidDtmfTransport, ciscoVismAAl2CidGroup=ciscoVismAAl2CidGroup, cvismAtmTrunkMIBCompliances=cvismAtmTrunkMIBCompliances, vismAal2InitVadTimer=vismAal2InitVadTimer)
