# SNMP MIB module (RADLAN-Physicaldescription-old-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/RADLAN-Physicaldescription-old-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:30 2025
...
rlPhdModuleEntry.setIndexNames(
    (0, "RADLAN-Physicaldescription-old-MIB", "rlPhdModuleStackUnit"),
    (0, "RADLAN-Physicaldescription-old-MIB", "rlPhdModuleIndex"),
)
if mibBuilder.loadTexts:
...
rlPhdPortsEntry.setIndexNames(
    (0, "RADLAN-Physicaldescription-old-MIB", "rlPhdPortsIfIndex"),
)
if mibBuilder.loadTexts:
...
rlPhdStackEntry.setIndexNames(
    (0, "RADLAN-Physicaldescription-old-MIB", "rlPhdStackUnit"),
)
if mibBuilder.loadTexts:
...
rlPhdStackOrderEntry.setIndexNames(
    (0, "RADLAN-Physicaldescription-old-MIB", "rlPhdStackOrderCurrentUnitPosition"),
)
if mibBuilder.loadTexts:
...
rlPhdUnitGenParamEntry.setIndexNames(
    (0, "RADLAN-Physicaldescription-old-MIB", "rlPhdUnitGenParamStackUnit"),
)
if mibBuilder.loadTexts:
...
rlPhdUnitEnvParamEntry.setIndexNames(
    (0, "RADLAN-Physicaldescription-old-MIB", "rlPhdUnitEnvParamStackUnit"),
)
if mibBuilder.loadTexts:
...
rlPhdPoeEntry.setIndexNames(
    (0, "RADLAN-Physicaldescription-old-MIB", "rlPhdPoeStackUnit"),
)
if mibBuilder.loadTexts:
...
rlCascadeAfterResetEntry.setIndexNames(
    (0, "RADLAN-Physicaldescription-old-MIB", "rlCascadeIfIndexAfterReset"),
)
if mibBuilder.loadTexts:
