...
mibBuilder.exportSymbols("HPN-ICF-NS-MIB", hpnicfNSProcessSlotEntry=hpnicfNSProcessSlotEntry, hpnicfNSProcessSlotTable=hpnicfNSProcessSlotTable, hpnicfNSState=hpnicfNSState, hpnicfNSExportInformationTable=hpnicfNSExportInformationTable, hpnicfNSACLNumber=hpnicfNSACLNumber, hpnicfNSConfigRowStatus=hpnicfNSConfigRowStatus, hpnicfNSConfigEntry=hpnicfNSConfigEntry, hpnicfNSStatusEntry=hpnicfNSStatusEntry, hpnicfNSResetFlag=hpnicfNSResetFlag, hpnicfNSMPLSTotalStreamNumber=hpnicfNSMPLSTotalStreamNumber, hpnicfNSExportNum=hpnicfNSExportNum, hpnicfNSResetTime=hpnicfNSResetTime, hpnicfNSExportFail=hpnicfNSExportFail, hpnicfNSTemplateTimeout=hpnicfNSTemplateTimeout, hpnicfNSMPLSTotalPacketNumber=hpnicfNSMPLSTotalPacketNumber, hpnicfNSHostIPAddr=hpnicfNSHostIPAddr, hpnicfNSMPLSActiveStreamNumber=hpnicfNSMPLSActiveStreamNumber, hpnicfNSSourceIfIndex=hpnicfNSSourceIfIndex, hpnicfNSStatusTable=hpnicfNSStatusTable, PYSNMP_MODULE_ID=hpnicfNS, hpnicfNSExportInformationEntry=hpnicfNSExportInformationEntry, hpnicfNSSlot=hpnicfNSSlot, hpnicfNSInactiveTime=hpnicfNSInactiveTime, hpnicfNSExportType=hpnicfNSExportType, hpnicfNSDirect=hpnicfNSDirect, hpnicfNSAsType=hpnicfNSAsType, hpnicfNSMibScalarObjects=hpnicfNSMibScalarObjects, hpnicfNSSrcIpAddr=hpnicfNSSrcIpAddr, hpnicfNSTotalStreamNumber=hpnicfNSTotalStreamNumber, hpnicfNSHostPort=hpnicfNSHostPort, hpnicfNSAggregationType=hpnicfNSAggregationType, hpnicfNSTotalPacketNumber=hpnicfNSTotalPacketNumber, hpnicfNSMPLSTotalOctetNumber=hpnicfNSMPLSTotalOctetNumber, hpnicfNSExportSlot=hpnicfNSExportSlot, hpnicfNSExportConfigTable=hpnicfNSExportConfigTable, hpnicfNSActiveStreamNumber=hpnicfNSActiveStreamNumber, hpnicfNSTotalOctetNumber=hpnicfNSTotalOctetNumber, hpnicfNSDestSlot=hpnicfNSDestSlot, hpnicfNSExportConfigEntry=hpnicfNSExportConfigEntry, hpnicfNSExportVlanOrIfIndex=hpnicfNSExportVlanOrIfIndex, hpnicfNS=hpnicfNS, hpnicfNSExportStream=hpnicfNSExportStream, hpnicfNSMibObjects=hpnicfNSMibObjects, hpnicfNSActiveTime=hpnicfNSActiveTime, hpnicfNSProcessSlot=hpnicfNSProcessSlot, hpnicfNSVersion=hpnicfNSVersion, hpnicfNSTemplateRefreshRate=hpnicfNSTemplateRefreshRate, hpnicfNSACLName=hpnicfNSACLName, hpnicfNSACLRule=hpnicfNSACLRule, hpnicfNSConfigTable=hpnicfNSConfigTable, hpnicfNSSourceSlot=hpnicfNSSourceSlot)
