...
mibBuilder.exportSymbols("ACMEPACKET-TC", apTextualConventions=apTextualConventions, ApServerStatus=ApServerStatus, PYSNMP_MODULE_ID=apTextualConventions, ApDiamResultCode=ApDiamResultCode, ApHardwareModuleFamily=ApHardwareModuleFamily, ApRedundancyState=ApRedundancyState, ApPhyPortType=ApPhyPortType, ApTransportType=ApTransportType, ApPresence=ApPresence, ApPercentage=ApPercentage)
