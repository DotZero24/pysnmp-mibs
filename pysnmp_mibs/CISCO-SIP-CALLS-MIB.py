...
# Produced by pysmi-1.1.12 at Thu Sep 11 10:12:13 2025
...
mibBuilder.exportSymbols("CISCO-SIP-CALLS-MIB", cSipCallActiveGroup=cSipCallActiveGroup, cSipMediaStreamType=cSipMediaStreamType, cSipMediaStreamsTable=cSipMediaStreamsTable, cSipCallActiveType=cSipCallActiveType, ciscoSipCallsMIBNotifs=ciscoSipCallsMIBNotifs, cSipCallActiveDestResIpAddr=cSipCallActiveDestResIpAddr, cSipCallsMIBCompliance=cSipCallsMIBCompliance, cSipCallActiveSigSrcIpAddr=cSipCallActiveSigSrcIpAddr, cSipMediaStreamDtmfPayloadType=cSipMediaStreamDtmfPayloadType, cSipMediaStreamsEntry=cSipMediaStreamsEntry, cSipCallsMIBCompliances=cSipCallsMIBCompliances, cSipCallsMIBConformance=cSipCallsMIBConformance, cSipMediaStreamState=cSipMediaStreamState, cSipCallActiveTable=cSipCallActiveTable, cSipCallActiveId=cSipCallActiveId, cSipCallActiveDestReqPort=cSipCallActiveDestReqPort, cSipCallActiveSigSrcIpAddrType=cSipCallActiveSigSrcIpAddrType, cSipUACActiveCalls=cSipUACActiveCalls, cSipCallActiveDestReqIpAddrType=cSipCallActiveDestReqIpAddrType, cSipMediaStreamIndex=cSipMediaStreamIndex, cSipMediaStreamSrcPort=cSipMediaStreamSrcPort, cSipCallActiveMediaStreams=cSipCallActiveMediaStreams, cSipCallActiveState=cSipCallActiveState, cSipMediaStreamSrcIpAddr=cSipMediaStreamSrcIpAddr, cSipMediaStreamCodecPayloadType=cSipMediaStreamCodecPayloadType, cSipCallActiveMediaStreamsActive=cSipCallActiveMediaStreamsActive, cSipMediaStreamNegotdDtmfRelay=cSipMediaStreamNegotdDtmfRelay, cSipCallActiveDestResPort=cSipCallActiveDestResPort, CSipCallState=CSipCallState, cSipMediaStreamGroup=cSipMediaStreamGroup, cSipCallActiveCalledNumber=cSipCallActiveCalledNumber, cSipMediaStreamDestPort=cSipMediaStreamDestPort, cSipCallsMIBGroups=cSipCallsMIBGroups, CSipCallSubstate=CSipCallSubstate, cSipUASActiveCalls=cSipUASActiveCalls, ciscoSipCallsMIB=ciscoSipCallsMIB, cSipCallActiveDestIpAddr=cSipCallActiveDestIpAddr, cSipCallActive=cSipCallActive, cSipMediaStreamNegotdCodec=cSipMediaStreamNegotdCodec, cSipMediaStreamCallId=cSipMediaStreamCallId, cSipMediaStreamDestIpAddr=cSipMediaStreamDestIpAddr, cSipCallActiveDestReqIpAddr=cSipCallActiveDestReqIpAddr, cSipCallActiveDestResIpAddrType=cSipCallActiveDestResIpAddrType, cSipMediaStreamSrcIpAddrType=cSipMediaStreamSrcIpAddrType, ciscoSipCallsMIBObjects=ciscoSipCallsMIBObjects, cSipCallActiveSubstate=cSipCallActiveSubstate, cSipCallActiveCallingNumber=cSipCallActiveCallingNumber, cSipCallActiveEntry=cSipCallActiveEntry, PYSNMP_MODULE_ID=ciscoSipCallsMIB, cSipCallActiveDestIpAddrType=cSipCallActiveDestIpAddrType, cSipMediaStreamDestIpAddrType=cSipMediaStreamDestIpAddrType)
