...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-DHCPV4-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:32:42 2025
...
_HpicfDhcpv4ServerPoolLeaseTime_Type.__name__ = "Unsigned32"
...
_HpicfDhcpv4ConflictsLog_Type.__name__ = "TruthValue"
...
_HpicfDhcpv4TrapEnable_Type.__name__ = "TruthValue"
...
hpicfDhcpv4ServerCompliance.setObjects(
      *(("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerBaseGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerLeaseDataBaseGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerBootpCountersGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerCounterGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerPoolGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerRangeGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerOptionGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerBindingGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerConflictGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerNotifyObjectsGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
hpicfDhcpv4ServerCompliance1.setObjects(
      *(("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerBaseGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerBootpCountersGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerCounterGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerPoolGroup"),
        ...
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerNotifyObjectsGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerNotificationsGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerLeaseDataBaseGroup1"))
)
if mibBuilder.loadTexts:
...
hpicfDhcpv4ServerCompliance2.setObjects(
      *(("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerBootpCountersGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerCounterGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerPoolGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerRangeGroup"),
        ...
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerNotificationsGroup"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerLeaseDataBaseGroup1"),
        ("HP-ICF-DHCPV4-SERVER-MIB", "hpicfDhcpv4ServerBaseGroup1"))
)
if mibBuilder.loadTexts:
