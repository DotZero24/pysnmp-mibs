# SNMP MIB module (DGS3312SR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DGS3312SR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:45:40 2025
...
swL2PortInfoEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2PortInfoPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortCtrlEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2PortCtrlPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2QOSBandwidthControlEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2QOSBandwidthPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2QOSSchedulingEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2QOSSchedulingClassIndex"),
)
if mibBuilder.loadTexts:
...
swL2QOS8021pUserPriorityEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2QOS8021pUserPriorityIndex"),
)
if mibBuilder.loadTexts:
...
swL2QOS8021pDefaultPriorityEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2QOS8021pDefaultPriorityIndex"),
)
if mibBuilder.loadTexts:
...
swL2PortSecurityControlEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2PortSecurityPortIndex"),
)
if mibBuilder.loadTexts:
...
swL2TrunkCtrlEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2TrunkIndex"),
)
if mibBuilder.loadTexts:
...
swL2IGMPCtrlEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2IGMPCtrlVid"),
)
if mibBuilder.loadTexts:
...
swL2IGMPQueryInfoEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2IGMPInfoVid"),
)
if mibBuilder.loadTexts:
...
swL2IGMPInfoEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2IGMPVid"),
    (0, "DGS3312SR-MIB", "swL2IGMPGroupIpAddr"),
)
if mibBuilder.loadTexts:
...
swL2TrafficCtrlEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2TrafficCtrlGroupIndex"),
)
if mibBuilder.loadTexts:
...
swL2TrafficSegEntry.setIndexNames(
    (0, "DGS3312SR-MIB", "swL2TrafficSegPort"),
)
if mibBuilder.loadTexts:
...
swL2macNotification.setObjects(
    ("DGS3312SR-MIB", "swL2macNotifyInfo")
)
if mibBuilder.loadTexts:
...
swL2porttypechg.setObjects(
      *(("DGS3312SR-MIB", "swL2PortInfoPortIndex"),
        ("DGS3312SR-MIB", "swL2PortInfoType"))
)
if mibBuilder.loadTexts:
