...
mibBuilder.exportSymbols("FILTER-MIB", swFilterDhcpServerTrapState=swFilterDhcpServerTrapState, swFilterDhcpPermitEntry=swFilterDhcpPermitEntry, swFilterDhcpPorts=swFilterDhcpPorts, swFilterNotifyPrefix=swFilterNotifyPrefix, swFilterDhcpPortIndex=swFilterDhcpPortIndex, swFilterDhcpPortTable=swFilterDhcpPortTable, swFilterDhcp=swFilterDhcp, swFilterDhcpServerTrapLogState=swFilterDhcpServerTrapLogState, swFilterDetectedport=swFilterDetectedport, swFilterDhcpClientMac=swFilterDhcpClientMac, swFilterDhcpStatus=swFilterDhcpStatus, swFilterNotify=swFilterNotify, swFilterNotificationBindings=swFilterNotificationBindings, swFilterDhcpPortEntry=swFilterDhcpPortEntry, swFilterDhcpServerIllegalSerLogSuppressDuration=swFilterDhcpServerIllegalSerLogSuppressDuration, swFilterDetectedIP=swFilterDetectedIP, PYSNMP_MODULE_ID=swFilterMIB, swFilterDhcpServerLogState=swFilterDhcpServerLogState, swFilterDhcpPermitTable=swFilterDhcpPermitTable, swFilterDhcpPortState=swFilterDhcpPortState, swFilterDhcpServerIP=swFilterDhcpServerIP, swFilterMIB=swFilterMIB, PortList=PortList, swFilterDetectedTrap=swFilterDetectedTrap)
