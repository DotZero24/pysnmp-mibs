# SNMP MIB module (NETGEAR-QOS-ISCSI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-QOS-ISCSI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:26:22 2025
...
agentIscsiFlowAccelerationTargetConfigEntry = _AgentIscsiFlowAccelerationTargetConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 3, 5, 2, 1)
)
agentIscsiFlowAccelerationTargetConfigEntry.setIndexNames(
    (0, "NETGEAR-QOS-ISCSI-MIB", "agentIscsiFlowAccelerationTargetConfigTcpPort"),
    (0, "NETGEAR-QOS-ISCSI-MIB", "agentIscsiFlowAccelerationTargetConfigAddr"),
)
if mibBuilder.loadTexts:
...
agentIscsiFlowAccelerationSessionEntry = _AgentIscsiFlowAccelerationSessionEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 3, 5, 3, 1)
)
agentIscsiFlowAccelerationSessionEntry.setIndexNames(
    (0, "NETGEAR-QOS-ISCSI-MIB", "agentIscsiFlowAccelerationSessionIndex"),
)
if mibBuilder.loadTexts:
...
agentIscsiFlowAccelerationConnectionEntry = _AgentIscsiFlowAccelerationConnectionEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 3, 5, 4, 1)
)
agentIscsiFlowAccelerationConnectionEntry.setIndexNames(
    (0, "NETGEAR-QOS-ISCSI-MIB", "agentIscsiFlowAccelerationConnectionIndex"),
)
if mibBuilder.loadTexts:
