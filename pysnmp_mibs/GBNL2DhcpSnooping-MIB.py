...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/gcom/GBNL2DhcpSnooping-MIB
...
mibBuilder.exportSymbols("GBNL2DhcpSnooping-MIB", dhcpsnoopingOnOff=dhcpsnoopingOnOff, dhcpsnoopingVlanTable=dhcpsnoopingVlanTable, portIndex=portIndex, portMaxNum=portMaxNum, gbnL3DhcpSnooping=gbnL3DhcpSnooping, dhcpsnoopingPortEntry=dhcpsnoopingPortEntry, dhcpsnoopingPortTable=dhcpsnoopingPortTable, dhcpsnoopingVlanEntry=dhcpsnoopingVlanEntry, vlanMaxNum=vlanMaxNum, portIpSourceGuardMode=portIpSourceGuardMode, vlanIndex=vlanIndex, portTrustMode=portTrustMode, PYSNMP_MODULE_ID=gbnL3DhcpSnooping)
