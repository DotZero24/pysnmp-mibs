...
mibBuilder.exportSymbols("GBNL2DhcpSnooping-MIB", portIpSourceGuardMode=portIpSourceGuardMode, portTrustMode=portTrustMode, portMaxNum=portMaxNum, dhcpsnoopingPortTable=dhcpsnoopingPortTable, dhcpsnoopingPortEntry=dhcpsnoopingPortEntry, dhcpsnoopingOnOff=dhcpsnoopingOnOff, dhcpsnoopingVlanTable=dhcpsnoopingVlanTable, vlanIndex=vlanIndex, gbnL3DhcpSnooping=gbnL3DhcpSnooping, portIndex=portIndex, PYSNMP_MODULE_ID=gbnL3DhcpSnooping, vlanMaxNum=vlanMaxNum, dhcpsnoopingVlanEntry=dhcpsnoopingVlanEntry)
