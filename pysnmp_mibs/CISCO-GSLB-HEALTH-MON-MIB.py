...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-GSLB-HEALTH-MON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:32:14 2025
...
_CghMonKalNotifEnable_Type.__name__ = "TruthValue"
...
_CghMonNsQueryDomainName_Type.__name__ = "SnmpAdminString"
...
_CghMonCappHash_Type.__name__ = "SnmpAdminString"
...
_CghMonHttpHeadPath_Type.__name__ = "SnmpAdminString"
...
_CghMonHttpHeadConnTermMethod_Type.__name__ = "CiscoGslbTerminationMethod"
...
_CghMonTcpConnTermMethod_Type.__name__ = "CiscoGslbTerminationMethod"
...
_CghMonKalParameterStorageType_Type.__name__ = "StorageType"
...
_CghMonKalPrimaryTargetType_Type.__name__ = "InetAddressType"
...
class _CghMonKalPrimaryTarget_Type(InetAddress):
    """Custom type cghMonKalPrimaryTarget based on InetAddress"""
    defaultValue = OctetString("")


_CghMonKalPrimaryTarget_Type.__name__ = "InetAddress"
...
_CghMonKalEnable_Type.__name__ = "TruthValue"
...
_CghMonKalDelay_Type.__name__ = "Unsigned32"
...
_CghMonKalKalapType_Type.__name__ = "CiscoGslbKalapType"
...
class _CghMonKalTagName_Type(SnmpAdminString):
    """Custom type cghMonKalTagName based on SnmpAdminString"""
    defaultValue = OctetString("")


_CghMonKalTagName_Type.__name__ = "SnmpAdminString"
...
_CghMonKalCappSecure_Type.__name__ = "TruthValue"
...
class _CghMonKalHostTag_Type(SnmpAdminString):
    """Custom type cghMonKalHostTag based on SnmpAdminString"""
    defaultValue = OctetString("")


_CghMonKalHostTag_Type.__name__ = "SnmpAdminString"
...
_CghMonKalSecondaryTargetType_Type.__name__ = "InetAddressType"
...
class _CghMonKalSecondaryTarget_Type(InetAddress):
    """Custom type cghMonKalSecondaryTarget based on InetAddress"""
    defaultValue = OctetString("")


_CghMonKalSecondaryTarget_Type.__name__ = "InetAddress"
...
_CghMonKalStorageType_Type.__name__ = "StorageType"
...
_CghMonKalShAnsStoragetype_Type.__name__ = "StorageType"
...
ciscoGslbHealthMonMIBCompliance.setObjects(
      *(("CISCO-GSLB-HEALTH-MON-MIB", "ciscoGslbGeneralConfigGroup"),
        ("CISCO-GSLB-HEALTH-MON-MIB", "ciscoGslbKalParameterGroup"),
        ("CISCO-GSLB-HEALTH-MON-MIB", "ciscoGslbKalConfigGroup"),
        ("CISCO-GSLB-HEALTH-MON-MIB", "ciscoGslbKalStatsGroup"),
        ("CISCO-GSLB-HEALTH-MON-MIB", "ciscoGslbKalNotifControlGroup"),
        ("CISCO-GSLB-HEALTH-MON-MIB", "ciscoGslbKalNotifObjectsGroup"),
        ("CISCO-GSLB-HEALTH-MON-MIB", "ciscoGslbKalNotificationGroup"),
        ("CISCO-GSLB-HEALTH-MON-MIB", "ciscoGslbGeneralConfigRateLimitGroup"))
)
if mibBuilder.loadTexts:
