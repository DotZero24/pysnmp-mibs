...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-FEATURE-CONTROL-MIB
...
ciscoFeatureCtrlMIB.setRevisions(('2021-09-21 00:00', '2020-03-17 00:00', '2016-11-16 00:00', '2016-10-25 00:00', '2016-03-11 00:00', '2015-10-09 00:00', '2014-12-24 00:00', '2014-04-09 00:00', '2013-07-29 00:00', '2013-05-28 00:00', '2012-03-22 00:00', '2011-06-09 00:00', '2009-08-11 00:00', '2008-12-05 00:00', '2008-06-27 00:00', '2008-06-12 00:00', '2008-03-13 00:00', '2007-05-04 00:00', '2007-01-22 00:00', '2005-12-27 00:00', '2004-12-28 00:00', '2004-07-06 00:00', '2003-11-22 00:00',))
if mibBuilder.loadTexts: ciscoFeatureCtrlMIB.setLastUpdated('202109210000Z')
...
mibBuilder.exportSymbols("CISCO-FEATURE-CONTROL-MIB", cfcFeatureCtrlTag2=cfcFeatureCtrlTag2, cfcFeatureCtrlLastFailureReason=cfcFeatureCtrlLastFailureReason, CiscoFeatureActionResult=CiscoFeatureActionResult, ciscoFeatOpStatusChange=ciscoFeatOpStatusChange, ciscoFeatureCtrlMIB=ciscoFeatureCtrlMIB, cfcFeatureCtrlOpStatusReason2=cfcFeatureCtrlOpStatusReason2, cfcFeatureSetEntry=cfcFeatureSetEntry, cfcFeatureCtrlIndex2=cfcFeatureCtrlIndex2, cfcFeatureCtrlLastFailureReason2=cfcFeatureCtrlLastFailureReason2, ciscoFeatureOpStatusChange=ciscoFeatureOpStatusChange, cfcFeatureSetNotifEnable=cfcFeatureSetNotifEnable, ciscoFeatureCtrlMIBCompliances=ciscoFeatureCtrlMIBCompliances, cfcFeatureSetOpStatusReason=cfcFeatureSetOpStatusReason, cfcFeatureCtrlInstanceNum2=cfcFeatureCtrlInstanceNum2, ciscoFeatureCtrlMIBNotifs=ciscoFeatureCtrlMIBNotifs, cfcFeatureGroupRev=cfcFeatureGroupRev, cfcFeatureCtrlName=cfcFeatureCtrlName, cfcFeatureCtrlIndex=cfcFeatureCtrlIndex, ciscoFeatureCtrlMIBConformance=ciscoFeatureCtrlMIBConformance, ciscoFeatureCtrlMIBCompliance=ciscoFeatureCtrlMIBCompliance, cfcNotificationGroupRev=cfcNotificationGroupRev, cfcFeatureGroup=cfcFeatureGroup, cfcFeatureCtrlLastActionResult2=cfcFeatureCtrlLastActionResult2, cfcFeatureCtrl2Entry=cfcFeatureCtrl2Entry, cfcFeatureCtrlOpStatus=cfcFeatureCtrlOpStatus, ciscoFeatureCtrlMIBGroups=ciscoFeatureCtrlMIBGroups, cfcNotificationGroup=cfcNotificationGroup, ciscoFeatureSetCtrlMIBComplianceRev1=ciscoFeatureSetCtrlMIBComplianceRev1, cfcFeatureCtrlLastAction=cfcFeatureCtrlLastAction, CiscoOptionalFeatureSet=CiscoOptionalFeatureSet, cfcFeature=cfcFeature, cfcFeatureSetAction=cfcFeatureSetAction, CiscoFeatureStatus=CiscoFeatureStatus, cfcFeatureCtrlOpStatus2=cfcFeatureCtrlOpStatus2, ciscoFeatureCtrlMIBObjects=ciscoFeatureCtrlMIBObjects, cfcFeatureSetNotificationGroup=cfcFeatureSetNotificationGroup, cfcFeatureCtrlLastAction2=cfcFeatureCtrlLastAction2, ciscoFeatureCtrlMIBComplianceRev=ciscoFeatureCtrlMIBComplianceRev, cfcFeatureCtrlTable=cfcFeatureCtrlTable, cfcFeatureCtrlAction2=cfcFeatureCtrlAction2, cfcFeatureCtrlLastActionResult=cfcFeatureCtrlLastActionResult, ciscoFeatureSetOpStatusChange=ciscoFeatureSetOpStatusChange, cfcFeatureCtrl2Table=cfcFeatureCtrl2Table, cfcFeatureSetNotificationCtrlGroup=cfcFeatureSetNotificationCtrlGroup, cfcFeatureSetName=cfcFeatureSetName, cfcFeatureSetGroup=cfcFeatureSetGroup, cfcFeatureSetIndex=cfcFeatureSetIndex, CiscoOptionalFeature=CiscoOptionalFeature, cfcFeatureSetOpStatus=cfcFeatureSetOpStatus, cfcFeatureSetTable=cfcFeatureSetTable, CiscoFeatureAction=CiscoFeatureAction, cfcFeatureSetLastFailureReason=cfcFeatureSetLastFailureReason, cfcFeatureCtrlAction=cfcFeatureCtrlAction, cfcNotifControl=cfcNotifControl, cfcFeatureSetLastActionResult=cfcFeatureSetLastActionResult, cfcFeatureCtrlOpStatusReason=cfcFeatureCtrlOpStatusReason, cfcFeatureCtrlEntry=cfcFeatureCtrlEntry, cfcFeatureSetLastAction=cfcFeatureSetLastAction, cfcFeatureCtrlName2=cfcFeatureCtrlName2, PYSNMP_MODULE_ID=ciscoFeatureCtrlMIB)
