...
agentInventoryUnitEntry, agentInventoryUnitNumber = mibBuilder.importSymbols("DNOS-INVENTORY-MIB", "agentInventoryUnitEntry", "agentInventoryUnitNumber")
