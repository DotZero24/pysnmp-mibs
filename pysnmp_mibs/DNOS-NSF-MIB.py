...
agentNsfTraps=_AgentNsfTraps_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,0))
_AgentNsfUnitTable_Object=MibTable
agentNsfUnitTable=_AgentNsfUnitTable_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,1))
if mibBuilder.loadTexts:agentNsfUnitTable.setStatus(_A)
_AgentNsfUnitEntry_Object=MibTableRow
agentNsfUnitEntry=_AgentNsfUnitEntry_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,1,1))
...
agentNsfUnitSupport=_AgentNsfUnitSupport_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,1,1,1),_AgentNsfUnitSupport_Type())
...
agentNsfGroup=_AgentNsfGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,2))
...
agentNsfAdminStatus=_AgentNsfAdminStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,2,1),_AgentNsfAdminStatus_Type())
...
agentNsfOperStatus=_AgentNsfOperStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,2,2),_AgentNsfOperStatus_Type())
...
agentNsfLastStartupReason=_AgentNsfLastStartupReason_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,2,3),_AgentNsfLastStartupReason_Type())
...
agentNsfTimeSinceLastRestart=_AgentNsfTimeSinceLastRestart_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,2,4),_AgentNsfTimeSinceLastRestart_Type())
...
agentNsfRestartInProgress=_AgentNsfRestartInProgress_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,2,5),_AgentNsfRestartInProgress_Type())
...
agentNsfWarmRestartReady=_AgentNsfWarmRestartReady_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,2,6),_AgentNsfWarmRestartReady_Type())
...
agentNsfBackupConfigurationAge=_AgentNsfBackupConfigurationAge_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,2,7),_AgentNsfBackupConfigurationAge_Type())
...
agentNsfInitiateFailover=_AgentNsfInitiateFailover_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,2,8),_AgentNsfInitiateFailover_Type())
...
agentCheckpointStatsGroup=_AgentCheckpointStatsGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,3))
...
agentCheckpointClearStatistics=_AgentCheckpointClearStatistics_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,3,1),_AgentCheckpointClearStatistics_Type())
...
agentCheckpointMessages=_AgentCheckpointMessages_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,3,2),_AgentCheckpointMessages_Type())
...
agentCheckpointBytes=_AgentCheckpointBytes_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,3,3),_AgentCheckpointBytes_Type())
...
agentCheckpointTimeSinceCountersCleared=_AgentCheckpointTimeSinceCountersCleared_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,3,4),_AgentCheckpointTimeSinceCountersCleared_Type())
...
agentCheckpointMessageRateInterval=_AgentCheckpointMessageRateInterval_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,3,5),_AgentCheckpointMessageRateInterval_Type())
...
agentCheckpointMessageRate=_AgentCheckpointMessageRate_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,3,6),_AgentCheckpointMessageRate_Type())
...
agentCheckpointHighestMessageRate=_AgentCheckpointHighestMessageRate_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,3,7),_AgentCheckpointHighestMessageRate_Type())
...
agentNsfOspfGroup=_AgentNsfOspfGroup_ObjectIdentity((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,4))
...
agentNsfOspfSupportMode=_AgentNsfOspfSupportMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,4,1),_AgentNsfOspfSupportMode_Type())
...
agentNsfOspfRestartInterval=_AgentNsfOspfRestartInterval_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,4,2),_AgentNsfOspfRestartInterval_Type())
...
agentNsfOspfRestartStatus=_AgentNsfOspfRestartStatus_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,4,3),_AgentNsfOspfRestartStatus_Type())
...
agentNsfOspfRestartAge=_AgentNsfOspfRestartAge_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,4,4),_AgentNsfOspfRestartAge_Type())
...
agentNsfOspfRestartExitReason=_AgentNsfOspfRestartExitReason_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,4,5),_AgentNsfOspfRestartExitReason_Type())
...
agentNsfOspfHelperSupportMode=_AgentNsfOspfHelperSupportMode_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,4,6),_AgentNsfOspfHelperSupportMode_Type())
...
agentNsfOspfHelperStrictLSAChecking=_AgentNsfOspfHelperStrictLSAChecking_Object((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,4,7),_AgentNsfOspfHelperStrictLSAChecking_Type())
...
agentNsfStackRestartComplete=NotificationType((1,3,6,1,4,1,674,10895,5000,2,6132,1,1,46,0,1))
