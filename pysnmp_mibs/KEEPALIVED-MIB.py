...
# Notes
# -----
# ASN.1 source file://mibs/keepalived/KEEPALIVED-MIB
...
globalCompliances.setObjects(
    ("KEEPALIVED-MIB", "globalGroup")
)
if mibBuilder.loadTexts:
...
vrrpCompliances.setObjects(
      *(("KEEPALIVED-MIB", "vrrpScriptGroup"),
        ("KEEPALIVED-MIB", "vrrpSyncGroup"),
        ("KEEPALIVED-MIB", "vrrpInstanceGroup"),
        ("KEEPALIVED-MIB", "vrrpTrapsGroup"))
)
if mibBuilder.loadTexts:
...
checkCompliances.setObjects(
      *(("KEEPALIVED-MIB", "virtualServerGroupGroup"),
        ("KEEPALIVED-MIB", "virtualServerGroup"),
        ("KEEPALIVED-MIB", "realServerGroup"),
        ("KEEPALIVED-MIB", "checkTrapsGroup"))
)
if mibBuilder.loadTexts:
