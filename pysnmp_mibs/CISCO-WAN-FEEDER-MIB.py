...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-WAN-FEEDER-MIB
...
mibBuilder.exportSymbols("CISCO-WAN-FEEDER-MIB", cwfRemotePort=cwfRemotePort, PYSNMP_MODULE_ID=ciscoWanFeederMIB, cwfMIBConformance=cwfMIBConformance, cwfFeederEntry=cwfFeederEntry, cwfMIBObjects=cwfMIBObjects, cwfLMIType=cwfLMIType, cwfFeederIfNum=cwfFeederIfNum, cwfNetIP=cwfNetIP, cwfRemoteSlot=cwfRemoteSlot, cwfFeederNodeAlarm=cwfFeederNodeAlarm, cwfFeederGroup=cwfFeederGroup, cwfFeederGroup2=cwfFeederGroup2, cwfLMIOperStatus=cwfLMIOperStatus, cwfFeederTable=cwfFeederTable, cwfMIBCompliance=cwfMIBCompliance, cwfFeederRowStatus=cwfFeederRowStatus, cwfFeederType=cwfFeederType, cwfFeederName=cwfFeederName, cwfLanIP=cwfLanIP, cwfModelNumber=cwfModelNumber, cwfMIBCompliances=cwfMIBCompliances, cwfMIBGroups=cwfMIBGroups, cwfFeeder=cwfFeeder, cwfLMIAdminStatus=cwfLMIAdminStatus, cwfRemoteShelf=cwfRemoteShelf, ciscoWanFeederMIB=ciscoWanFeederMIB, cwfMIBCompliance2=cwfMIBCompliance2)
