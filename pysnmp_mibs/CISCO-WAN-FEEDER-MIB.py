...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-WAN-FEEDER-MIB
...
cwfMIBCompliance.setObjects(
    ("CISCO-WAN-FEEDER-MIB", "cwfFeederGroup")
)
if mibBuilder.loadTexts:
...
cwfMIBCompliance2.setObjects(
    ("CISCO-WAN-FEEDER-MIB", "cwfFeederGroup2")
)
if mibBuilder.loadTexts:
