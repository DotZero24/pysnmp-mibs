...
h3cMPMObject=_H3cMPMObject_ObjectIdentity((1,3,6,1,4,1,2011,10,2,51,1))
_H3cMPortGroupLimitMinNumber_Type=Unsigned32
_H3cMPortGroupLimitMinNumber_Object=MibScalar
h3cMPortGroupLimitMinNumber=_H3cMPortGroupLimitMinNumber_Object((1,3,6,1,4,1,2011,10,2,51,1,1),_H3cMPortGroupLimitMinNumber_Type())
...
h3cMPortGroupLimitMaxNumber=_H3cMPortGroupLimitMaxNumber_Object((1,3,6,1,4,1,2011,10,2,51,1,2),_H3cMPortGroupLimitMaxNumber_Type())
...
h3cMPMTable=_H3cMPMTable_ObjectIdentity((1,3,6,1,4,1,2011,10,2,51,2))
_H3cMPortGroupJoinTable_Object=MibTable
h3cMPortGroupJoinTable=_H3cMPortGroupJoinTable_Object((1,3,6,1,4,1,2011,10,2,51,2,1))
if mibBuilder.loadTexts:h3cMPortGroupJoinTable.setStatus(_A)
_H3cMPortGroupJoinEntry_Object=MibTableRow
h3cMPortGroupJoinEntry=_H3cMPortGroupJoinEntry_Object((1,3,6,1,4,1,2011,10,2,51,2,1,1))
...
h3cMPortGroupJoinVlanID=_H3cMPortGroupJoinVlanID_Object((1,3,6,1,4,1,2011,10,2,51,2,1,1,1),_H3cMPortGroupJoinVlanID_Type())
...
h3cMPortGroupJoinAddressType=_H3cMPortGroupJoinAddressType_Object((1,3,6,1,4,1,2011,10,2,51,2,1,1,2),_H3cMPortGroupJoinAddressType_Type())
...
h3cMPortGroupJoinAddress=_H3cMPortGroupJoinAddress_Object((1,3,6,1,4,1,2011,10,2,51,2,1,1,3),_H3cMPortGroupJoinAddress_Type())
...
h3cMPortGroupJoinStatus=_H3cMPortGroupJoinStatus_Object((1,3,6,1,4,1,2011,10,2,51,2,1,1,4),_H3cMPortGroupJoinStatus_Type())
...
h3cMPortGroupTable=_H3cMPortGroupTable_Object((1,3,6,1,4,1,2011,10,2,51,2,2))
if mibBuilder.loadTexts:h3cMPortGroupTable.setStatus(_A)
_H3cMPortGroupEntry_Object=MibTableRow
h3cMPortGroupEntry=_H3cMPortGroupEntry_Object((1,3,6,1,4,1,2011,10,2,51,2,2,1))
...
h3cMPortGroupVlanID=_H3cMPortGroupVlanID_Object((1,3,6,1,4,1,2011,10,2,51,2,2,1,1),_H3cMPortGroupVlanID_Type())
...
h3cMPortGroupAddressType=_H3cMPortGroupAddressType_Object((1,3,6,1,4,1,2011,10,2,51,2,2,1,2),_H3cMPortGroupAddressType_Type())
...
h3cMPortGroupAddress=_H3cMPortGroupAddress_Object((1,3,6,1,4,1,2011,10,2,51,2,2,1,3),_H3cMPortGroupAddress_Type())
...
h3cMPortConfigTable=_H3cMPortConfigTable_Object((1,3,6,1,4,1,2011,10,2,51,2,3))
if mibBuilder.loadTexts:h3cMPortConfigTable.setStatus(_A)
_H3cMPortConfigEntry_Object=MibTableRow
h3cMPortConfigEntry=_H3cMPortConfigEntry_Object((1,3,6,1,4,1,2011,10,2,51,2,3,1))
...
h3cMPortConfigVlanID=_H3cMPortConfigVlanID_Object((1,3,6,1,4,1,2011,10,2,51,2,3,1,1),_H3cMPortConfigVlanID_Type())
...
h3cMPortGroupLimitNumber=_H3cMPortGroupLimitNumber_Object((1,3,6,1,4,1,2011,10,2,51,2,3,1,2),_H3cMPortGroupLimitNumber_Type())
...
h3cMPortFastLeaveStatus=_H3cMPortFastLeaveStatus_Object((1,3,6,1,4,1,2011,10,2,51,2,3,1,3),_H3cMPortFastLeaveStatus_Type())
...
h3cMPortGroupPolicyParameter=_H3cMPortGroupPolicyParameter_Object((1,3,6,1,4,1,2011,10,2,51,2,3,1,4),_H3cMPortGroupPolicyParameter_Type())
...
h3cMPortConfigRowStatus=_H3cMPortConfigRowStatus_Object((1,3,6,1,4,1,2011,10,2,51,2,3,1,5),_H3cMPortConfigRowStatus_Type())
...
h3cMPortGroupLimitReplace=_H3cMPortGroupLimitReplace_Object((1,3,6,1,4,1,2011,10,2,51,2,3,1,6),_H3cMPortGroupLimitReplace_Type())
...
h3cHostStaticJoinTable=_H3cHostStaticJoinTable_Object((1,3,6,1,4,1,2011,10,2,51,2,4))
if mibBuilder.loadTexts:h3cHostStaticJoinTable.setStatus(_A)
_H3cHostStaticJoinEntry_Object=MibTableRow
h3cHostStaticJoinEntry=_H3cHostStaticJoinEntry_Object((1,3,6,1,4,1,2011,10,2,51,2,4,1))
...
h3cHostStaticJoinVlanID=_H3cHostStaticJoinVlanID_Object((1,3,6,1,4,1,2011,10,2,51,2,4,1,1),_H3cHostStaticJoinVlanID_Type())
...
h3cHostStaticJoinAddressType=_H3cHostStaticJoinAddressType_Object((1,3,6,1,4,1,2011,10,2,51,2,4,1,2),_H3cHostStaticJoinAddressType_Type())
...
h3cHostStaticJoinAddress=_H3cHostStaticJoinAddress_Object((1,3,6,1,4,1,2011,10,2,51,2,4,1,3),_H3cHostStaticJoinAddress_Type())
...
h3cHostStaticJoinStatus=_H3cHostStaticJoinStatus_Object((1,3,6,1,4,1,2011,10,2,51,2,4,1,4),_H3cHostStaticJoinStatus_Type())
