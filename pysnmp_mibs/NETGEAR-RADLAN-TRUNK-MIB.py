# SNMP MIB module (NETGEAR-RADLAN-TRUNK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-TRUNK-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:27:47 2025
...
rlDot3adAggBalanceEntry = _RlDot3adAggBalanceEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 65, 2, 1)
)
rlDot3adAggBalanceEntry.setIndexNames(
    (0, "IEEE8023-LAG-MIB", "dot3adAggIndex"),
    (0, "NETGEAR-RADLAN-TRUNK-MIB", "rlDot3adAggBalanceForwardType"),
)
if mibBuilder.loadTexts:
