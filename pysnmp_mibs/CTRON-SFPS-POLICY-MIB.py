...
mibBuilder.exportSymbols("CTRON-SFPS-POLICY-MIB", sfpsMatrixInfoTableIndex=sfpsMatrixInfoTableIndex, HexInteger=HexInteger, sfpsMatrixInfoAddrType=sfpsMatrixInfoAddrType, sfpsMatrixInfoFlagMask=sfpsMatrixInfoFlagMask, sfpsServiceCenterPolicyMetric=sfpsServiceCenterPolicyMetric, sfpsMatrixColId=sfpsMatrixColId, sfpsMatrixInfoIndex1Load=sfpsMatrixInfoIndex1Load, sfpsMatrixInfoAddrHash=sfpsMatrixInfoAddrHash, sfpsServiceCenterPolicyTable=sfpsServiceCenterPolicyTable, sfpsMatrixUser2Load=sfpsMatrixUser2Load, sfpsServiceCenterPolicyResponses=sfpsServiceCenterPolicyResponses, sfpsMatrixRowId=sfpsMatrixRowId, sfpsMatrixUser1Type=sfpsMatrixUser1Type, sfpsMatrixInfoVerb=sfpsMatrixInfoVerb, sfpsMatrixUser2Type=sfpsMatrixUser2Type, sfpsMatrixInfoDefFlood=sfpsMatrixInfoDefFlood, sfpsMatrixInfoFilter1Tag=sfpsMatrixInfoFilter1Tag, sfpsMatrixUser1Load=sfpsMatrixUser1Load, sfpsMatrixInfoIndex2Load=sfpsMatrixInfoIndex2Load, sfpsVMMatrixRowIndex=sfpsVMMatrixRowIndex, sfpsServiceCenterPolicyOperStatus=sfpsServiceCenterPolicyOperStatus, sfpsMatrixInfoIndex2Tag=sfpsMatrixInfoIndex2Tag, sfpsMatrixInfoFilter1Load=sfpsMatrixInfoFilter1Load, sfpsMatrixInfoFilter2Tag=sfpsMatrixInfoFilter2Tag, sfpsMatrixEntry=sfpsMatrixEntry, sfpsMatrixInfoAddrValue=sfpsMatrixInfoAddrValue, sfpsServiceCenterPolicyName=sfpsServiceCenterPolicyName, sfpsMatrixInfoDefConnect=sfpsMatrixInfoDefConnect, sfpsMatrixConnect=sfpsMatrixConnect, sfpsServiceCenterPolicyHashLeaf=sfpsServiceCenterPolicyHashLeaf, sfpsMatrixInfoMatrixFlag=sfpsMatrixInfoMatrixFlag, sfpsMatrixInfoIndex1Tag=sfpsMatrixInfoIndex1Tag, sfpsMatrixInfoTable=sfpsMatrixInfoTable, sfpsServiceCenterPolicyEntry=sfpsServiceCenterPolicyEntry, sfpsMatrixInfoFilter2Load=sfpsMatrixInfoFilter2Load, sfpsVMMatrixAction=sfpsVMMatrixAction, sfpsServiceCenterPolicyAdminStatus=sfpsServiceCenterPolicyAdminStatus, sfpsVMMatrixCellIndexMask=sfpsVMMatrixCellIndexMask, sfpsMatrixTable=sfpsMatrixTable, sfpsServiceCenterPolicyRequests=sfpsServiceCenterPolicyRequests, sfpsMatrixFlood=sfpsMatrixFlood, sfpsServiceCenterPolicyStatusTime=sfpsServiceCenterPolicyStatusTime, sfpsMatrixInfoEntry=sfpsMatrixInfoEntry, sfpsMatrixInfoHashIndex=sfpsMatrixInfoHashIndex)
