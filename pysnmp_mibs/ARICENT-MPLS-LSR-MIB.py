...
fsMplsLsrMIB=ModuleIdentity((1,3,6,1,4,1,2076,13,13))
if mibBuilder.loadTexts:fsMplsLsrMIB.setRevisions(('2012-09-05 00:00',))
_FsMplsLsrNotifications_ObjectIdentity=ObjectIdentity
fsMplsLsrNotifications=_FsMplsLsrNotifications_ObjectIdentity((1,3,6,1,4,1,2076,13,13,0))
_FsMplsLsrObjects_ObjectIdentity=ObjectIdentity
fsMplsLsrObjects=_FsMplsLsrObjects_ObjectIdentity((1,3,6,1,4,1,2076,13,13,1))
_FsMplsLsrScalarObjects_ObjectIdentity=ObjectIdentity
fsMplsLsrScalarObjects=_FsMplsLsrScalarObjects_ObjectIdentity((1,3,6,1,4,1,2076,13,13,1,1))
...
fsMplsLsrRfc6428CompatibleCodePoint=_FsMplsLsrRfc6428CompatibleCodePoint_Object((1,3,6,1,4,1,2076,13,13,1,1,1),_FsMplsLsrRfc6428CompatibleCodePoint_Type())
...
fsMplsInSegmentTable=_FsMplsInSegmentTable_Object((1,3,6,1,4,1,2076,13,13,1,2))
if mibBuilder.loadTexts:fsMplsInSegmentTable.setStatus(_A)
_FsMplsInSegmentEntry_Object=MibTableRow
fsMplsInSegmentEntry=_FsMplsInSegmentEntry_Object((1,3,6,1,4,1,2076,13,13,1,2,1))
...
fsMplsInSegmentDirection=_FsMplsInSegmentDirection_Object((1,3,6,1,4,1,2076,13,13,1,2,1,1),_FsMplsInSegmentDirection_Type())
...
fsMplsOutSegmentTable=_FsMplsOutSegmentTable_Object((1,3,6,1,4,1,2076,13,13,1,3))
if mibBuilder.loadTexts:fsMplsOutSegmentTable.setStatus(_A)
_FsMplsOutSegmentEntry_Object=MibTableRow
fsMplsOutSegmentEntry=_FsMplsOutSegmentEntry_Object((1,3,6,1,4,1,2076,13,13,1,3,1))
...
fsMplsOutSegmentDirection=_FsMplsOutSegmentDirection_Object((1,3,6,1,4,1,2076,13,13,1,3,1,1),_FsMplsOutSegmentDirection_Type())
...
fsMplsLsrConformance=_FsMplsLsrConformance_ObjectIdentity((1,3,6,1,4,1,2076,13,13,2))
