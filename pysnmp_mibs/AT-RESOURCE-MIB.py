...
mibBuilder.exportSymbols("AT-RESOURCE-MIB", rscResourceId=rscResourceId, rscBoardBay=rscBoardBay, rscStkId=rscStkId, rscBoardEntry=rscBoardEntry, hostInfoDRAM=hostInfoDRAM, rscBoardID=rscBoardID, resource=resource, hostInfoUptime=hostInfoUptime, rscBoardSerialNumber=rscBoardSerialNumber, hostInfoBootloaderVersion=hostInfoBootloaderVersion, PYSNMP_MODULE_ID=resource, rscBoardRevision=rscBoardRevision, hostInfoFlash=hostInfoFlash, hostInfoTable=hostInfoTable, rscBoardType=rscBoardType, rscBoardTable=rscBoardTable, hostInfoEntry=hostInfoEntry, rscBoardName=rscBoardName)
