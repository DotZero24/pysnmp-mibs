# SNMP MIB module (ALCATEL-ENT1-TIMETRA-MPLS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-TIMETRA-MPLS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:08:47 2025
...
vRtrMplsLspEntry.setIndexNames(
    ...
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspIndex"),
)
if mibBuilder.loadTexts:
...
vRtrMplsTunnelCHopEntry.setIndexNames(
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopListIndex"),
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopIndex"),
)
if mibBuilder.loadTexts:
...
vRtrMplsAdminGroupEntry.setIndexNames(
    (0, "ALCATEL-ENT1-TIMETRA-VRTR-MIB", "vRtrID"),
    (1, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsAdminGroupName"),
)
if mibBuilder.loadTexts:
...
vRtrMplsFSGroupEntry.setIndexNames(
    (0, "ALCATEL-ENT1-TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsFSGroupName"),
)
if mibBuilder.loadTexts:
...
vRtrMplsFSGroupParamsEntry.setIndexNames(
    (0, "ALCATEL-ENT1-TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsFSGroupName"),
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsFSGroupParamsFromAddr"),
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsFSGroupParamsToAddr"),
)
if mibBuilder.loadTexts:
...
vRtrMplsLabelRangeEntry.setIndexNames(
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLabelType"),
)
if mibBuilder.loadTexts:
...
vRtrMplsStaticLSPLabelEntry.setIndexNames(
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsStaticLSPLabel"),
)
if mibBuilder.loadTexts:
...
vRtrMplsStaticSvcLabelEntry.setIndexNames(
    (0, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsStaticSvcLabel"),
)
if mibBuilder.loadTexts:
...
vRtrMplsSrlgGrpEntry.setIndexNames(
    (0, "ALCATEL-ENT1-TIMETRA-VRTR-MIB", "vRtrID"),
    (1, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsSrlgGrpName"),
)
if mibBuilder.loadTexts:
...
vRtrMplsIfSrlgGrpEntry.setIndexNames(
    (0, "ALCATEL-ENT1-TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "ALCATEL-ENT1-TIMETRA-VRTR-MIB", "vRtrIfIndex"),
    (1, "ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfSrlgGrpName"),
)
if mibBuilder.loadTexts:
...
tmnxMplsLspPathGroup.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathTableSpinlock"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathRowStatus"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathLastChange"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathType"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathCos"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathProperties"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathBandwidth"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathBwProtect"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathPreference"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathCosSource"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathClassOfService"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathSetupPriority"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathHoldPriority"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathRecord"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathHopLimit"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathSharing"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathAdminState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathOperState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathInheritance"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathLspId"),
        ...
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathNegotiatedMTU"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathFailCode"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathFailNodeAddr"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathAdminGroupInclude"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathAdminGroupExclude"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathAdaptive"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathOptimizeTimer"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathNextOptimize"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathOperBandwidth"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathMBBState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathResignal"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathTunnelCRHopListIndex"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathOperMTU"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathRecordLabel"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathTimeUp"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathTimeDown"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathRetryAttempts"),
...
tmnxMplsXCGroup.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsXCIndex"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsInSegmentIfIndex"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsInSegmentLabel"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsOutSegmentIndex"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsERHopTunnelIndex"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsARHopTunnelIndex"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsRsvpSessionIndex"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsXCFailCode"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsXCCHopTableIndex"))
)
if mibBuilder.loadTexts:
...
tmnxMplsIfGroup.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfAdminState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfOperState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfAdminGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfTxPktCount"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfRxPktCount"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfTxOctetCount"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfRxOctetCount"))
)
if mibBuilder.loadTexts:
...
tmnxMplsTunnelARHopGroup.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelARHopProtection"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelARHopRecordLabel"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelARHopRouterId"))
)
if mibBuilder.loadTexts:
...
tmnxMplsTunnelCHopGroup.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopAddrType"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopIpv4Addr"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopIpv4PrefixLen"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopIpv6Addr"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopIpv6PrefixLen"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopAsNumber"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopLspId"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsTunnelCHopStrictOrLoose"))
)
if mibBuilder.loadTexts:
...
tmnxMplsAdminGroupGroup.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsAdminGroupRowStatus"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsAdminGroupValue"))
)
if mibBuilder.loadTexts:
...
tmnxMplsFSGroupGroup.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsFSGroupRowStatus"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsFSGroupCost"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsFSGroupParamsRowStatus"))
)
if mibBuilder.loadTexts:
...
tmnxMplsNotifyObjsGroup.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspNotificationReasonCode"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathNotificationReasonCode"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsNotifyRow"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspIndex"))
)
if mibBuilder.loadTexts:
...
tmnxMplsGlobalR2r1Group.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralLastChange"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralAdminState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralOperState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralPropagateTtl"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralTE"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralNewLspIndex"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralOptimizeTimer"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralFRObject"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralResignalTimer"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralStaticLspOriginate"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralStaticLspTransit"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralStaticLspTerminate"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDynamicLspOriginate"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDynamicLspTransit"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDynamicLspTerminate"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDetourLspOriginate"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDetourLspTransit"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDetourLspTerminate"))
)
if mibBuilder.loadTexts:
...
tmnxMplsLspR2r1Group.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspRowStatus"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspLastChange"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspName"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspAdminState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspOperState"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspFromAddr"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspToAddr"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspType"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspOutSegIndx"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspRetryTimer"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspRetryLimit"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspMetric"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspDecrementTtl"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspCspf"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspFastReroute"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspFRHopLimit"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspFRBandwidth"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspClassOfService"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspSetupPriority"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspHoldPriority"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspRecord"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPreference"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspBandwidth"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspBwProtect"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspHopLimit"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspNegotiatedMTU"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspRsvpResvStyle"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspRsvpAdspec"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspFRMethod"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspFRNodeProtect"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspAdminGroupInclude"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspAdminGroupExclude"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspAdaptive"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspInheritance"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspOptimizeTimer"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspOperFastReroute"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspFRObject"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspOctets"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPackets"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspAge"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspTimeUp"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspTimeDown"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPrimaryTimeUp"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspTransitions"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspLastTransition"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathChanges"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspLastPathChange"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspConfiguredPaths"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspStandbyPaths"),
...
tmnxMplsLabelRangeGroup.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLabelRangeMin"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLabelRangeMax"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLabelRangeAging"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLabelRangeAvailable"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsStaticLSPLabelOwner"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsStaticSvcLabelOwner"))
)
if mibBuilder.loadTexts:
...
tmnxMplsGlobalV5v0Group.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralLastChange"),
        ...
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDetourLspTransit"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDetourLspTerminate"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralHoldTimer"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDynamicBypass"))
)
if mibBuilder.loadTexts:
...
tmnxMplsLspV5v0Group.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspRowStatus"),
        ...
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspStandbyPaths"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspOperationalPaths"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspHoldTimer"))
)
if mibBuilder.loadTexts:
...
tmnxMplsGlobalV6v0Group.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralLastChange"),
        ...
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralHoldTimer"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralDynamicBypass"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralNextResignal"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralOperDownReason"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralSrlgFrr"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsGeneralSrlgFrrStrict"))
)
if mibBuilder.loadTexts:
...
tmnxMplsSrlgV6v0Group.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsSrlgGrpTableLastChanged"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsSrlgGrpRowStatus"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsSrlgGrpLastChanged"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsSrlgGrpValue"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfSrlgGrpTblLastChanged"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfSrlgGrpRowStatus"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfSrlgGrpLastChanged"))
)
if mibBuilder.loadTexts:
...
tmnxMplsIfV6v0Group.setObjects(
    ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfTeMetric")
)
if mibBuilder.loadTexts:
...
tmnxMplsLspV6v0Group.setObjects(
    ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspCspfTeMetricEnabled")
)
if mibBuilder.loadTexts:
...
tmnxMplsNotificationR2r1Group.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsStateChange"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsIfStateChange"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspUp"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspDown"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathUp"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathDown"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathRerouted"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "vRtrMplsLspPathResignaled"))
)
if mibBuilder.loadTexts:
...
tmnxMplsV3v0Compliance.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsGlobalR2r1Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsLspR2r1Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsLspPathGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsXCGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsIfGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsTunnelARHopGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsTunnelCHopGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsAdminGroupGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsNotificationR2r1Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsLabelRangeGroup"))
)
if mibBuilder.loadTexts:
...
tmnxMplsV5v0Compliance.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsGlobalV5v0Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsLspV5v0Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsLspPathGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsXCGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsIfGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsTunnelARHopGroup"),
...
tmnxMplsV6v0Compliance.setObjects(
      *(("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsGlobalV6v0Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsLspV5v0Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsLspPathGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsXCGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsIfGroup"),
        ...
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsNotificationR2r1Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsLabelRangeGroup"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsSrlgV6v0Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsIfV6v0Group"),
        ("ALCATEL-ENT1-TIMETRA-MPLS-MIB", "tmnxMplsLspV6v0Group"))
)
if mibBuilder.loadTexts:
