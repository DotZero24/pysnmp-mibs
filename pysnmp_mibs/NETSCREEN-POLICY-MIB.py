...
mibBuilder.exportSymbols("NETSCREEN-POLICY-MIB", nsPlySchedule=nsPlySchedule, nsPlyCountEnable=nsPlyCountEnable, nsPlyName=nsPlyName, nsPlyLogEnable=nsPlyLogEnable, nsPlySrcZone=nsPlySrcZone, nsPlyService=nsPlyService, nsPlyMonBytePerMin=nsPlyMonBytePerMin, nsPlyId=nsPlyId, nsPlyTable=nsPlyTable, nsPlyDSEnable=nsPlyDSEnable, nsPlyServiceName=nsPlyServiceName, nsPlyMonPackPerSec=nsPlyMonPackPerSec, nsPlyTrafficShapeEnable=nsPlyTrafficShapeEnable, PYSNMP_MODULE_ID=netscreenPolicyMibModule, nsPlyActiveStatus=nsPlyActiveStatus, nsPlyDipId=nsPlyDipId, nsPlyMonTotalByte=nsPlyMonTotalByte, nsPlyL2tpTunnel=nsPlyL2tpTunnel, nsPlyMonTable=nsPlyMonTable, nsPlyMonSessionPerSec=nsPlyMonSessionPerSec, nsPlyAlarmBPS=nsPlyAlarmBPS, nsPlyEntry=nsPlyEntry, nsPlyFixPort=nsPlyFixPort, nsPlyMonEntry=nsPlyMonEntry, nsPlyDstAddr=nsPlyDstAddr, nsPlyMonTotalSession=nsPlyMonTotalSession, nsPlyVsys=nsPlyVsys, nsPlySrcAddr=nsPlySrcAddr, nsPlyTrafficPriority=nsPlyTrafficPriority, nsPlyMonTotalPacket=nsPlyMonTotalPacket, nsPlyMonSessionPerMin=nsPlyMonSessionPerMin, nsPlyMonId=nsPlyMonId, nsPlyVpnTunnel=nsPlyVpnTunnel, nsPlyDstZone=nsPlyDstZone, nsPlyAuth=nsPlyAuth, nsPlyAlarmBPM=nsPlyAlarmBPM, nsPlyMonPackPerMin=nsPlyMonPackPerMin, nsPlyMonBytePerSec=nsPlyMonBytePerSec, nsPlyAction=nsPlyAction, nsPlyNat=nsPlyNat, netscreenPolicyMibModule=netscreenPolicyMibModule, nsPlyMonVsys=nsPlyMonVsys)
