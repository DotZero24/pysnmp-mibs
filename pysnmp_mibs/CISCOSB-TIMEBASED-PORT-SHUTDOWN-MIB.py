...
_G='CISCOSB-TIMEBASED-PORT-SHUTDOWN-MIB'
_F='read-only'
_E='DisplayString'
_D='Integer32'
_C='ifIndex'
...
rlTimeBasedPortVersion=_RlTimeBasedPortVersion_Object((1,3,6,1,4,1,9,6,1,101,208,1),_RlTimeBasedPortVersion_Type())
...
rlTimeBasedPortTable=_RlTimeBasedPortTable_Object((1,3,6,1,4,1,9,6,1,101,208,2))
if mibBuilder.loadTexts:rlTimeBasedPortTable.setStatus(_A)
_RlTimeBasedPortEntry_Object=MibTableRow
rlTimeBasedPortEntry=_RlTimeBasedPortEntry_Object((1,3,6,1,4,1,9,6,1,101,208,2,1))
...
rlTimeBasedPortTimeRangeName=_RlTimeBasedPortTimeRangeName_Object((1,3,6,1,4,1,9,6,1,101,208,2,1,1),_RlTimeBasedPortTimeRangeName_Type())
...
rlTimeBasedPortAction=_RlTimeBasedPortAction_Object((1,3,6,1,4,1,9,6,1,101,208,2,1,2),_RlTimeBasedPortAction_Type())
...
rlTimeBasedPortActive=_RlTimeBasedPortActive_Object((1,3,6,1,4,1,9,6,1,101,208,2,1,3),_RlTimeBasedPortActive_Type())
...
rlTimeBasedPortRowStatus=_RlTimeBasedPortRowStatus_Object((1,3,6,1,4,1,9,6,1,101,208,2,1,4),_RlTimeBasedPortRowStatus_Type())
