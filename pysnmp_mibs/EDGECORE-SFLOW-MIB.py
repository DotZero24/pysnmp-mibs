...
rlsFlowStatisticsTable=_RlsFlowStatisticsTable_Object((1,3,6,1,4,1,259,10,1,14,89,147,1))
if mibBuilder.loadTexts:rlsFlowStatisticsTable.setStatus(_A)
_RlsFlowStatisticsEntry_Object=MibTableRow
rlsFlowStatisticsEntry=_RlsFlowStatisticsEntry_Object((1,3,6,1,4,1,259,10,1,14,89,147,1,1))
...
rlsFlowDataSource=_RlsFlowDataSource_Object((1,3,6,1,4,1,259,10,1,14,89,147,1,1,1),_RlsFlowDataSource_Type())
...
rlsFlowStatisticsSampledPackets=_RlsFlowStatisticsSampledPackets_Object((1,3,6,1,4,1,259,10,1,14,89,147,1,1,2),_RlsFlowStatisticsSampledPackets_Type())
...
rlsFlowStatisticsDatagramSent=_RlsFlowStatisticsDatagramSent_Object((1,3,6,1,4,1,259,10,1,14,89,147,1,1,3),_RlsFlowStatisticsDatagramSent_Type())
...
rlsFlowStatisticsAction=_RlsFlowStatisticsAction_Object((1,3,6,1,4,1,259,10,1,14,89,147,1,1,4),_RlsFlowStatisticsAction_Type())
...
rlsFlowStatisticsReset=_RlsFlowStatisticsReset_Object((1,3,6,1,4,1,259,10,1,14,89,147,2),_RlsFlowStatisticsReset_Type())
