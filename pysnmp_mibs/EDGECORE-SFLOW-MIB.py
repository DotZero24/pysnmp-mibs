# SNMP MIB module (EDGECORE-SFLOW-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/edgecore/EDGECORE-SFLOW-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:53:18 2025
...
rlsFlowStatisticsTable = _RlsFlowStatisticsTable_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 147, 1)
)
if mibBuilder.loadTexts:
...
rlsFlowStatisticsEntry = _RlsFlowStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 147, 1, 1)
)
rlsFlowStatisticsEntry.setIndexNames(
    (0, "EDGECORE-SFLOW-MIB", "rlsFlowDataSource"),
)
if mibBuilder.loadTexts:
...
rlsFlowDataSource = _RlsFlowDataSource_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 147, 1, 1, 1),
...
rlsFlowStatisticsSampledPackets = _RlsFlowStatisticsSampledPackets_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 147, 1, 1, 2),
...
rlsFlowStatisticsDatagramSent = _RlsFlowStatisticsDatagramSent_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 147, 1, 1, 3),
...
rlsFlowStatisticsAction = _RlsFlowStatisticsAction_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 147, 1, 1, 4),
...
rlsFlowStatisticsReset = _RlsFlowStatisticsReset_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 147, 2),
