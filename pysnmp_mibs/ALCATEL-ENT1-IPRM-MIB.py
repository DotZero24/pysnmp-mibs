# SNMP MIB module (ALCATEL-ENT1-IPRM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-IPRM-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:10:33 2025
...
alaIprmRouteEntry.setIndexNames(
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteDest"),
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteMask"),
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteTos"),
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteNextHop"),
)
if mibBuilder.loadTexts:
...
alaIprmStaticRouteEntry.setIndexNames(
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticRouteDest"),
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticRouteMask"),
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticRouteNextHop"),
)
if mibBuilder.loadTexts:
...
_AlaIprmStaticAllBfd_Type.__name__ = "AlaIprmAdminStatus"
...
alaIprmRouteTargetEntry.setIndexNames(
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteTarget"),
)
if mibBuilder.loadTexts:
...
alaIprmRtPrefTableEntry.setIndexNames(
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmRtPrefEntryType"),
)
if mibBuilder.loadTexts:
...
alaIprmImportVrfEntry.setIndexNames(
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmImportVrfName"),
)
if mibBuilder.loadTexts:
...
alaIprmImportIsidEntry.setIndexNames(
    (0, "ALCATEL-ENT1-IPRM-MIB", "alaIprmImportIsid"),
)
if mibBuilder.loadTexts:
...
alaIprmConfigMIBGroup.setObjects(
      *(("ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteProto"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteMetric"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmRoutePriority"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticRouteMetric"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticRouteStatus"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticRouteBfdStatus"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticRouteType"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticRouteTag"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticRouteName"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmStaticAllBfd"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmPrimaryAddress"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmRouterId"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteDistinguisher"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteTargetType"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmRouteTargetRowStatus"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmRtPrefEntryValue"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmExportRouteMap"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmImportVrfRouteMap"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmImportVrfRowStatus"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmImportIsidRouteMap"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmImportIsidRowStatus"),
        ("ALCATEL-ENT1-IPRM-MIB", "alaIprmExportToAllVrfsRouteMap"))
)
if mibBuilder.loadTexts:
...
alaIprmCompliance.setObjects(
    ("ALCATEL-ENT1-IPRM-MIB", "alaIprmConfigMIBGroup")
)
if mibBuilder.loadTexts:
