...
h3cPortSecurityLeaf=_H3cPortSecurityLeaf_ObjectIdentity((1,3,6,1,4,1,2011,10,2,26,1,1))
...
h3cSecurePortSecurityControl=_H3cSecurePortSecurityControl_Object((1,3,6,1,4,1,2011,10,2,26,1,1,1),_H3cSecurePortSecurityControl_Type())
...
h3cSecurePortVlanMembershipList=_H3cSecurePortVlanMembershipList_Object((1,3,6,1,4,1,2011,10,2,26,1,1,2),_H3cSecurePortVlanMembershipList_Type())
...
h3cSecureRalmObjects=_H3cSecureRalmObjects_ObjectIdentity((1,3,6,1,4,1,2011,10,2,26,1,1,4))
...
h3cSecureRalmDefaultSessionTime=_H3cSecureRalmDefaultSessionTime_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,1),_H3cSecureRalmDefaultSessionTime_Type())
...
h3cSecureRalmHoldoffTime=_H3cSecureRalmHoldoffTime_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,2),_H3cSecureRalmHoldoffTime_Type())
...
h3cSecureRalmReauthenticate=_H3cSecureRalmReauthenticate_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,3),_H3cSecureRalmReauthenticate_Type())
...
h3cSecureRalmAuthMode=_H3cSecureRalmAuthMode_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,4),_H3cSecureRalmAuthMode_Type())
...
h3cSecureRalmAuthUsername=_H3cSecureRalmAuthUsername_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,5),_H3cSecureRalmAuthUsername_Type())
...
h3cSecureRalmAuthPassword=_H3cSecureRalmAuthPassword_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,6),_H3cSecureRalmAuthPassword_Type())
h3cSecureRalmAuthPassword.setMaxAccess(_C)
if mibBuilder.loadTexts:h3cSecureRalmAuthPassword.setStatus(_A)
class _H3cSecureRalmAuthDomain_Type(DisplayString):subtypeSpec=DisplayString.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(1,255))
_H3cSecureRalmAuthDomain_Type.__name__=_J
_H3cSecureRalmAuthDomain_Object=MibScalar
h3cSecureRalmAuthDomain=_H3cSecureRalmAuthDomain_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,7),_H3cSecureRalmAuthDomain_Type())
h3cSecureRalmAuthDomain.setMaxAccess(_C)
if mibBuilder.loadTexts:h3cSecureRalmAuthDomain.setStatus(_A)
class _H3cSecureRalmAuthOfflineTime_Type(Integer32):defaultValue=300;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(60,2147483647))
_H3cSecureRalmAuthOfflineTime_Type.__name__=_E
_H3cSecureRalmAuthOfflineTime_Object=MibScalar
h3cSecureRalmAuthOfflineTime=_H3cSecureRalmAuthOfflineTime_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,8),_H3cSecureRalmAuthOfflineTime_Type())
...
h3cSecureRalmAuthServerTimeoutTime=_H3cSecureRalmAuthServerTimeoutTime_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,9),_H3cSecureRalmAuthServerTimeoutTime_Type())
...
h3cSecureMacControl=_H3cSecureMacControl_Object((1,3,6,1,4,1,2011,10,2,26,1,1,4,10),_H3cSecureMacControl_Type())
...
h3cPortSecurityTables=_H3cPortSecurityTables_ObjectIdentity((1,3,6,1,4,1,2011,10,2,26,1,2))
_H3cSecurePortTable_Object=MibTable
h3cSecurePortTable=_H3cSecurePortTable_Object((1,3,6,1,4,1,2011,10,2,26,1,2,1))
if mibBuilder.loadTexts:h3cSecurePortTable.setStatus(_A)
_H3cSecurePortEntry_Object=MibTableRow
h3cSecurePortEntry=_H3cSecurePortEntry_Object((1,3,6,1,4,1,2011,10,2,26,1,2,1,1))
...
h3cSecurePortMode=_H3cSecurePortMode_Object((1,3,6,1,4,1,2011,10,2,26,1,2,1,1,1),_H3cSecurePortMode_Type())
...
h3cSecureNeedToKnowMode=_H3cSecureNeedToKnowMode_Object((1,3,6,1,4,1,2011,10,2,26,1,2,1,1,2),_H3cSecureNeedToKnowMode_Type())
...
h3cSecureIntrusionAction=_H3cSecureIntrusionAction_Object((1,3,6,1,4,1,2011,10,2,26,1,2,1,1,3),_H3cSecureIntrusionAction_Type())
...
h3cSecureNumberAddresses=_H3cSecureNumberAddresses_Object((1,3,6,1,4,1,2011,10,2,26,1,2,1,1,4),_H3cSecureNumberAddresses_Type())
...
h3cSecureNumberAddressesStored=_H3cSecureNumberAddressesStored_Object((1,3,6,1,4,1,2011,10,2,26,1,2,1,1,5),_H3cSecureNumberAddressesStored_Type())
...
h3cSecureMaximumAddresses=_H3cSecureMaximumAddresses_Object((1,3,6,1,4,1,2011,10,2,26,1,2,1,1,6),_H3cSecureMaximumAddresses_Type())
...
h3cSecureAddressTable=_H3cSecureAddressTable_Object((1,3,6,1,4,1,2011,10,2,26,1,2,2))
if mibBuilder.loadTexts:h3cSecureAddressTable.setStatus(_A)
_H3cSecureAddressEntry_Object=MibTableRow
h3cSecureAddressEntry=_H3cSecureAddressEntry_Object((1,3,6,1,4,1,2011,10,2,26,1,2,2,1))
...
h3cSecureAddrMAC=_H3cSecureAddrMAC_Object((1,3,6,1,4,1,2011,10,2,26,1,2,2,1,1),_H3cSecureAddrMAC_Type())
...
h3cSecureAddrVlanID=_H3cSecureAddrVlanID_Object((1,3,6,1,4,1,2011,10,2,26,1,2,2,1,2),_H3cSecureAddrVlanID_Type())
...
h3cSecureAddrMACStatus=_H3cSecureAddrMACStatus_Object((1,3,6,1,4,1,2011,10,2,26,1,2,2,1,3),_H3cSecureAddrMACStatus_Type())
...
h3cSecureAddrRowStatus=_H3cSecureAddrRowStatus_Object((1,3,6,1,4,1,2011,10,2,26,1,2,2,1,4),_H3cSecureAddrRowStatus_Type())
...
h3cSecureOUITable=_H3cSecureOUITable_Object((1,3,6,1,4,1,2011,10,2,26,1,2,3))
if mibBuilder.loadTexts:h3cSecureOUITable.setStatus(_A)
_H3cSecureOUIEntry_Object=MibTableRow
h3cSecureOUIEntry=_H3cSecureOUIEntry_Object((1,3,6,1,4,1,2011,10,2,26,1,2,3,1))
...
h3cSecureOUIIndex=_H3cSecureOUIIndex_Object((1,3,6,1,4,1,2011,10,2,26,1,2,3,1,1),_H3cSecureOUIIndex_Type())
...
h3cSecureOUI=_H3cSecureOUI_Object((1,3,6,1,4,1,2011,10,2,26,1,2,3,1,2),_H3cSecureOUI_Type())
...
h3cSecureOUIRowStatus=_H3cSecureOUIRowStatus_Object((1,3,6,1,4,1,2011,10,2,26,1,2,3,1,3),_H3cSecureOUIRowStatus_Type())
...
h3cSecureBindingTable=_H3cSecureBindingTable_Object((1,3,6,1,4,1,2011,10,2,26,1,2,4))
if mibBuilder.loadTexts:h3cSecureBindingTable.setStatus(_A)
_H3cSecureBindingEntry_Object=MibTableRow
h3cSecureBindingEntry=_H3cSecureBindingEntry_Object((1,3,6,1,4,1,2011,10,2,26,1,2,4,1))
...
h3cSecureBindingIndex=_H3cSecureBindingIndex_Object((1,3,6,1,4,1,2011,10,2,26,1,2,4,1,1),_H3cSecureBindingIndex_Type())
...
h3cSecureBindingPort=_H3cSecureBindingPort_Object((1,3,6,1,4,1,2011,10,2,26,1,2,4,1,2),_H3cSecureBindingPort_Type())
...
h3cSecureBindingAddrMAC=_H3cSecureBindingAddrMAC_Object((1,3,6,1,4,1,2011,10,2,26,1,2,4,1,3),_H3cSecureBindingAddrMAC_Type())
...
h3cSecureBindingAddrIp=_H3cSecureBindingAddrIp_Object((1,3,6,1,4,1,2011,10,2,26,1,2,4,1,4),_H3cSecureBindingAddrIp_Type())
...
h3cSecureBindingRowStatus=_H3cSecureBindingRowStatus_Object((1,3,6,1,4,1,2011,10,2,26,1,2,4,1,5),_H3cSecureBindingRowStatus_Type())
...
h3cSecureAssignTable=_H3cSecureAssignTable_Object((1,3,6,1,4,1,2011,10,2,26,1,2,5))
if mibBuilder.loadTexts:h3cSecureAssignTable.setStatus(_A)
_H3cSecureAssignEntry_Object=MibTableRow
h3cSecureAssignEntry=_H3cSecureAssignEntry_Object((1,3,6,1,4,1,2011,10,2,26,1,2,5,1))
...
h3cSecureAssignEnable=_H3cSecureAssignEnable_Object((1,3,6,1,4,1,2011,10,2,26,1,2,5,1,1),_H3cSecureAssignEnable_Type())
...
h3cSecureVlanAssignment=_H3cSecureVlanAssignment_Object((1,3,6,1,4,1,2011,10,2,26,1,2,5,1,2),_H3cSecureVlanAssignment_Type())
...
h3cSecureRalmLogon=NotificationType((1,3,6,1,4,1,2011,10,2,26,1,3,7))
h3cSecureRalmLogon.setObjects(*((_D,_F),(_B,_G),(_B,_M),(_B,_N),(_B,_K)))
if mibBuilder.loadTexts:h3cSecureRalmLogon.setStatus(_A)
h3cSecureRalmLogoff=NotificationType((1,3,6,1,4,1,2011,10,2,26,1,3,8))
