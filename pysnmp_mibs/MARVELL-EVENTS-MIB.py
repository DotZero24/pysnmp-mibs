...
if mibBuilder.loadTexts:rlEventsMib.setRevisions(('2010-09-11 00:00',))
...
rlPortEvents=_RlPortEvents_ObjectIdentity((1,3,6,1,4,1,89,150,1))
...
rlAutoSmartPortAdminStatus=_RlAutoSmartPortAdminStatus_Object((1,3,6,1,4,1,89,150,1,1),_RlAutoSmartPortAdminStatus_Type())
...
rlAutoSmartPortOperStatus=_RlAutoSmartPortOperStatus_Object((1,3,6,1,4,1,89,150,1,2),_RlAutoSmartPortOperStatus_Type())
...
rlAutoSmartPortLastVoiceVlanStatus=_RlAutoSmartPortLastVoiceVlanStatus_Object((1,3,6,1,4,1,89,150,1,3),_RlAutoSmartPortLastVoiceVlanStatus_Type())
...
rlAutoSmartPortLastVoiceVlanId=_RlAutoSmartPortLastVoiceVlanId_Object((1,3,6,1,4,1,89,150,1,4),_RlAutoSmartPortLastVoiceVlanId_Type())
...
rlAutoSmartPortLearningProtocols=_RlAutoSmartPortLearningProtocols_Object((1,3,6,1,4,1,89,150,1,5),_RlAutoSmartPortLearningProtocols_Type())
...
rlAutoSmartPortTypesTable=_RlAutoSmartPortTypesTable_Object((1,3,6,1,4,1,89,150,1,6))
if mibBuilder.loadTexts:rlAutoSmartPortTypesTable.setStatus(_A)
_RlAutoSmartPortTypesEntry_Object=MibTableRow
rlAutoSmartPortTypesEntry=_RlAutoSmartPortTypesEntry_Object((1,3,6,1,4,1,89,150,1,6,1))
...
rlAutoSmartPortTypesType=_RlAutoSmartPortTypesType_Object((1,3,6,1,4,1,89,150,1,6,1,1),_RlAutoSmartPortTypesType_Type())
...
rlAutoSmartPortTypeStatus=_RlAutoSmartPortTypeStatus_Object((1,3,6,1,4,1,89,150,1,6,1,2),_RlAutoSmartPortTypeStatus_Type())
...
rlAutoSmartPortMacro=_RlAutoSmartPortMacro_Object((1,3,6,1,4,1,89,150,1,6,1,3),_RlAutoSmartPortMacro_Type())
...
rlAutoSmartPortTypesRevertToDefaultMacro=_RlAutoSmartPortTypesRevertToDefaultMacro_Object((1,3,6,1,4,1,89,150,1,6,1,4),_RlAutoSmartPortTypesRevertToDefaultMacro_Type())
...
rlAutoSmartPortTypesRevertToDefaultParams=_RlAutoSmartPortTypesRevertToDefaultParams_Object((1,3,6,1,4,1,89,150,1,6,1,5),_RlAutoSmartPortTypesRevertToDefaultParams_Type())
...
rlAutoSmartPortTypesBuiltinMacro=_RlAutoSmartPortTypesBuiltinMacro_Object((1,3,6,1,4,1,89,150,1,6,1,6),_RlAutoSmartPortTypesBuiltinMacro_Type())
...
rlAutoSmartPortMacrosParamTable=_RlAutoSmartPortMacrosParamTable_Object((1,3,6,1,4,1,89,150,1,7))
if mibBuilder.loadTexts:rlAutoSmartPortMacrosParamTable.setStatus(_A)
_RlAutoSmartPortMacrosParamEntry_Object=MibTableRow
rlAutoSmartPortMacrosParamEntry=_RlAutoSmartPortMacrosParamEntry_Object((1,3,6,1,4,1,89,150,1,7,1))
...
rlAutoSmartPortMacroType=_RlAutoSmartPortMacroType_Object((1,3,6,1,4,1,89,150,1,7,1,1),_RlAutoSmartPortMacroType_Type())
...
rlAutoSmartPortMacrosParamName=_RlAutoSmartPortMacrosParamName_Object((1,3,6,1,4,1,89,150,1,7,1,2),_RlAutoSmartPortMacrosParamName_Type())
...
rlAutoSmartPortMacrosParamOrder=_RlAutoSmartPortMacrosParamOrder_Object((1,3,6,1,4,1,89,150,1,7,1,3),_RlAutoSmartPortMacrosParamOrder_Type())
...
rlAutoSmartPortMacrosParamValue=_RlAutoSmartPortMacrosParamValue_Object((1,3,6,1,4,1,89,150,1,7,1,4),_RlAutoSmartPortMacrosParamValue_Type())
...
rlAutoSmartPortPortsTable=_RlAutoSmartPortPortsTable_Object((1,3,6,1,4,1,89,150,1,8))
if mibBuilder.loadTexts:rlAutoSmartPortPortsTable.setStatus(_A)
_RlAutoSmartPortPortsEntry_Object=MibTableRow
rlAutoSmartPortPortsEntry=_RlAutoSmartPortPortsEntry_Object((1,3,6,1,4,1,89,150,1,8,1))
...
rlAutoSmartPortPort=_RlAutoSmartPortPort_Object((1,3,6,1,4,1,89,150,1,8,1,1),_RlAutoSmartPortPort_Type())
...
rlAutoSmartPortPortStatus=_RlAutoSmartPortPortStatus_Object((1,3,6,1,4,1,89,150,1,8,1,2),_RlAutoSmartPortPortStatus_Type())
...
rlAutoSmartPortPortType=_RlAutoSmartPortPortType_Object((1,3,6,1,4,1,89,150,1,8,1,3),_RlAutoSmartPortPortType_Type())
...
rlAutoSmartPortPersistency=_RlAutoSmartPortPersistency_Object((1,3,6,1,4,1,89,150,1,8,1,4),_RlAutoSmartPortPersistency_Type())
...
rlAutoSmartPortLearntPortType=_RlAutoSmartPortLearntPortType_Object((1,3,6,1,4,1,89,150,1,8,1,5),_RlAutoSmartPortLearntPortType_Type())
...
rlAutoSmartPortPortAcquiringType=_RlAutoSmartPortPortAcquiringType_Object((1,3,6,1,4,1,89,150,1,8,1,6),_RlAutoSmartPortPortAcquiringType_Type())
...
rlAutoSmartPortLastActivatedMacro=_RlAutoSmartPortLastActivatedMacro_Object((1,3,6,1,4,1,89,150,1,8,1,7),_RlAutoSmartPortLastActivatedMacro_Type())
...
rlAutoSmartPortFailedCommandNumber=_RlAutoSmartPortFailedCommandNumber_Object((1,3,6,1,4,1,89,150,1,8,1,8),_RlAutoSmartPortFailedCommandNumber_Type())
...
rlAutoSmartPortSetLearntPortType=_RlAutoSmartPortSetLearntPortType_Object((1,3,6,1,4,1,89,150,1,8,1,9),_RlAutoSmartPortSetLearntPortType_Type())
...
rlAutoSmartPortParamsTable=_RlAutoSmartPortParamsTable_Object((1,3,6,1,4,1,89,150,1,9))
if mibBuilder.loadTexts:rlAutoSmartPortParamsTable.setStatus(_A)
_RlAutoSmartPortParamsEntry_Object=MibTableRow
rlAutoSmartPortParamsEntry=_RlAutoSmartPortParamsEntry_Object((1,3,6,1,4,1,89,150,1,9,1))
...
rlAutoSmartPortIfIndex=_RlAutoSmartPortIfIndex_Object((1,3,6,1,4,1,89,150,1,9,1,1),_RlAutoSmartPortIfIndex_Type())
...
rlAutoSmartPortParamName=_RlAutoSmartPortParamName_Object((1,3,6,1,4,1,89,150,1,9,1,2),_RlAutoSmartPortParamName_Type())
...
rlAutoSmartPortParamOrder=_RlAutoSmartPortParamOrder_Object((1,3,6,1,4,1,89,150,1,9,1,3),_RlAutoSmartPortParamOrder_Type())
...
rlAutoSmartPortParamValue=_RlAutoSmartPortParamValue_Object((1,3,6,1,4,1,89,150,1,9,1,4),_RlAutoSmartPortParamValue_Type())
...
rlAutoSmartTrunkRefreshTable=_RlAutoSmartTrunkRefreshTable_Object((1,3,6,1,4,1,89,150,1,10))
if mibBuilder.loadTexts:rlAutoSmartTrunkRefreshTable.setStatus(_A)
_RlAutoSmartTrunkRefreshEntry_Object=MibTableRow
rlAutoSmartTrunkRefreshEntry=_RlAutoSmartTrunkRefreshEntry_Object((1,3,6,1,4,1,89,150,1,10,1))
...
rlAutoSmartTrunkRefreshSmartPortType=_RlAutoSmartTrunkRefreshSmartPortType_Object((1,3,6,1,4,1,89,150,1,10,1,1),_RlAutoSmartTrunkRefreshSmartPortType_Type())
...
rlAutoSmartTrunkRefreshIfIndex=_RlAutoSmartTrunkRefreshIfIndex_Object((1,3,6,1,4,1,89,150,1,10,1,2),_RlAutoSmartTrunkRefreshIfIndex_Type())
...
rlAutoSmartTrunkRefreshRowStatus=_RlAutoSmartTrunkRefreshRowStatus_Object((1,3,6,1,4,1,89,150,1,10,1,3),_RlAutoSmartTrunkRefreshRowStatus_Type())
...
rlAutoSmartBusy=_RlAutoSmartBusy_Object((1,3,6,1,4,1,89,150,1,11),_RlAutoSmartBusy_Type())
