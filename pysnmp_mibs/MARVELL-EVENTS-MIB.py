# SNMP MIB module (MARVELL-EVENTS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/radlan/MARVELL-EVENTS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 22:10:54 2025
...
rlAutoSmartPortTypesEntry = _RlAutoSmartPortTypesEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 150, 1, 6, 1)
)
rlAutoSmartPortTypesEntry.setIndexNames(
    (0, "MARVELL-EVENTS-MIB", "rlAutoSmartPortTypesType"),
)
if mibBuilder.loadTexts:
...
rlAutoSmartPortMacrosParamEntry = _RlAutoSmartPortMacrosParamEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 150, 1, 7, 1)
)
rlAutoSmartPortMacrosParamEntry.setIndexNames(
    (0, "MARVELL-EVENTS-MIB", "rlAutoSmartPortTypesType"),
    (0, "MARVELL-EVENTS-MIB", "rlAutoSmartPortMacroType"),
    (1, "MARVELL-EVENTS-MIB", "rlAutoSmartPortMacrosParamName"),
)
if mibBuilder.loadTexts:
...
rlAutoSmartPortPortsEntry = _RlAutoSmartPortPortsEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 150, 1, 8, 1)
)
rlAutoSmartPortPortsEntry.setIndexNames(
    (0, "MARVELL-EVENTS-MIB", "rlAutoSmartPortPort"),
)
if mibBuilder.loadTexts:
...
rlAutoSmartPortParamsEntry = _RlAutoSmartPortParamsEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 150, 1, 9, 1)
)
rlAutoSmartPortParamsEntry.setIndexNames(
    (0, "MARVELL-EVENTS-MIB", "rlAutoSmartPortIfIndex"),
    (1, "MARVELL-EVENTS-MIB", "rlAutoSmartPortParamName"),
)
if mibBuilder.loadTexts:
...
rlAutoSmartTrunkRefreshEntry = _RlAutoSmartTrunkRefreshEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 150, 1, 10, 1)
)
rlAutoSmartTrunkRefreshEntry.setIndexNames(
    (0, "MARVELL-EVENTS-MIB", "rlAutoSmartTrunkRefreshSmartPortType"),
    (0, "MARVELL-EVENTS-MIB", "rlAutoSmartTrunkRefreshIfIndex"),
)
if mibBuilder.loadTexts:
