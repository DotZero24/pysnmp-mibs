...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-LWAPP-MESH-LINKTEST-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:27:36 2025
...
ciscoLwappMeshLinkTestMIBCompliance.setObjects(
      *(("CISCO-LWAPP-MESH-LINKTEST-MIB", "ciscoLwappMeshLinkTestConfigGroup"),
        ("CISCO-LWAPP-MESH-LINKTEST-MIB", "ciscoLwappMeshLinkTestRunGroup"))
)
if mibBuilder.loadTexts:
...
ciscoLwappMeshLinkTestMIBComplianceRev1.setObjects(
      *(("CISCO-LWAPP-MESH-LINKTEST-MIB", "ciscoLwappMeshLinkTestConfigGroup"),
        ("CISCO-LWAPP-MESH-LINKTEST-MIB", "ciscoLwappMeshLinkTestRunGroupRev1"))
)
if mibBuilder.loadTexts:
