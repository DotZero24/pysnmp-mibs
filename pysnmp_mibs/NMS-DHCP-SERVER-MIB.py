# SNMP MIB module (NMS-DHCP-SERVER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/bdcom/NMS-DHCP-SERVER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:05:09 2025
...
nmsDhcpIpAddrPoolEntry = _NmsDhcpIpAddrPoolEntry_Object(
    (1, 3, 6, 1, 4, 1, 3320, 9, 355, 2, 1)
)
nmsDhcpIpAddrPoolEntry.setIndexNames(
    (0, "NMS-DHCP-SERVER-MIB", "nmsDhcpIpAddrPoolIndex"),
)
if mibBuilder.loadTexts:
