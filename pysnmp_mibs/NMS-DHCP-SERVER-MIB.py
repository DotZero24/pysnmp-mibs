...
dhcp=_Dhcp_ObjectIdentity((1,3,6,1,4,1,3320,9,355))
...
dhcpServerStatus=_DhcpServerStatus_Object((1,3,6,1,4,1,3320,9,355,1),_DhcpServerStatus_Type())
...
nmsDhcpIpAddrPoolTable=_NmsDhcpIpAddrPoolTable_Object((1,3,6,1,4,1,3320,9,355,2))
if mibBuilder.loadTexts:nmsDhcpIpAddrPoolTable.setStatus(_A)
_NmsDhcpIpAddrPoolEntry_Object=MibTableRow
nmsDhcpIpAddrPoolEntry=_NmsDhcpIpAddrPoolEntry_Object((1,3,6,1,4,1,3320,9,355,2,1))
...
nmsDhcpIpAddrPoolIndex=_NmsDhcpIpAddrPoolIndex_Object((1,3,6,1,4,1,3320,9,355,2,1,1),_NmsDhcpIpAddrPoolIndex_Type())
...
nmsDhcpIpAddrPoolSubNetwork=_NmsDhcpIpAddrPoolSubNetwork_Object((1,3,6,1,4,1,3320,9,355,2,1,2),_NmsDhcpIpAddrPoolSubNetwork_Type())
...
nmsDhcpIpAddrPoolMask=_NmsDhcpIpAddrPoolMask_Object((1,3,6,1,4,1,3320,9,355,2,1,3),_NmsDhcpIpAddrPoolMask_Type())
...
nmsDhcpIpAddrPoolStart=_NmsDhcpIpAddrPoolStart_Object((1,3,6,1,4,1,3320,9,355,2,1,4),_NmsDhcpIpAddrPoolStart_Type())
...
nmsDhcpIpAddrPoolEnd=_NmsDhcpIpAddrPoolEnd_Object((1,3,6,1,4,1,3320,9,355,2,1,5),_NmsDhcpIpAddrPoolEnd_Type())
...
nmsDhcpIpAddrPoolReserveAddrList=_NmsDhcpIpAddrPoolReserveAddrList_Object((1,3,6,1,4,1,3320,9,355,2,1,6),_NmsDhcpIpAddrPoolReserveAddrList_Type())
