# SNMP MIB module (DLINK-3100-SOCKET-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DLINK-3100-SOCKET-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:48:26 2025
...
rlSocketMibVersion = _RlSocketMibVersion_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 85, 1),
...
rlSocketId = _RlSocketId_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 85, 2, 1, 1),
    _RlSocketId_Type()
)
...
rlSocketType = _RlSocketType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 85, 2, 1, 2),
    _RlSocketType_Type()
)
...
rlSocketState = _RlSocketState_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 85, 2, 1, 3),
    _RlSocketState_Type()
)
...
rlSocketBlockMode = _RlSocketBlockMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 85, 2, 1, 4),
...
rlSocketUpTime = _RlSocketUpTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 85, 2, 1, 5),
