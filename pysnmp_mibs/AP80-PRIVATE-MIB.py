...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/aruba/AP80-PRIVATE-MIB
...
MibIdentifier, enterprises, NotificationType, Integer32, Bits, Unsigned32, mgmt, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Counter64, TimeTicks, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "NotificationType", "Integer32", "Bits", "Unsigned32", "mgmt", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Counter64", "TimeTicks", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("AP80-PRIVATE-MIB", enterpriseApFilterControl=enterpriseApFilterControl, DisplayString=DisplayString, dot11StationAuthentication=dot11StationAuthentication, enterpriseApSessionIsForwarding=enterpriseApSessionIsForwarding, dot11MacAddr=dot11MacAddr, enterpriseApSecurityWEPKeyType=enterpriseApSecurityWEPKeyType, enterpriseApSecurityWPAMode=enterpriseApSecurityWPAMode, lineIndex=lineIndex, enterpriseApSecurityWPAPSKType=enterpriseApSecurityWPAPSKType, sysConfigFileVersionChangedTrapEnabled=sysConfigFileVersionChangedTrapEnabled, enterpriseApSecurityEntry=enterpriseApSecurityEntry, dot11StationReAssociation=dot11StationReAssociation, dot118021xSuppPasswd=dot118021xSuppPasswd, wdsApRole=wdsApRole, dot11FilterAddress=dot11FilterAddress, lineStopBits=lineStopBits, password=password, sysSystemDown=sysSystemDown, enterpriseApSNTPDST=enterpriseApSNTPDST, portAutonegotiation=portAutonegotiation, enterpriseApFilterProtocolEntry=enterpriseApFilterProtocolEntry, enterpriseApSys=enterpriseApSys, netConfigDefaultGateway=netConfigDefaultGateway, enterpriseApDNS=enterpriseApDNS, lineParity=lineParity, enterpriseAPVapRadioWPA2PMKSALifeTime=enterpriseAPVapRadioWPA2PMKSALifeTime, dot11AuthenticationRetransmit=dot11AuthenticationRetransmit, enterpriseApAdminPassword=enterpriseApAdminPassword, netConfigHttpPort=netConfigHttpPort, dot11Vap8021xReauthenticationTimeout=dot11Vap8021xReauthenticationTimeout, dot1xAuthFail=dot1xAuthFail, enterpriseApSTPNodeTable=enterpriseApSTPNodeTable, enterpriseApRadioAntennaControlMethod=enterpriseApRadioAntennaControlMethod, arubaAp=arubaAp, localMacAddrAuthSuccess=localMacAddrAuthSuccess, transferStart=transferStart, enterpriseApFilterControlInterClientSTAsCommun=enterpriseApFilterControlInterClientSTAsCommun, enterpriseApWMMAckPolicyIndex=enterpriseApWMMAckPolicyIndex, swOpCodeVer=swOpCodeVer, dot11Vap8021xBroadcastKeyRefreshRate=dot11Vap8021xBroadcastKeyRefreshRate, enterpriseApWMMACKPolicy=enterpriseApWMMACKPolicy, MacAddress=MacAddress, wdsChannelAutoSync=wdsChannelAutoSync, enterpriseAPVapRadioAssocTimeoutInterval=enterpriseAPVapRadioAssocTimeoutInterval, enterpriseApSshServerPort=enterpriseApSshServerPort, enterpriseApRadioSuperMode=enterpriseApRadioSuperMode, dot11FilterStatus=dot11FilterStatus, enterpriseApRadioDataRate=enterpriseApRadioDataRate, wlsrOutDoorApMibModules=wlsrOutDoorApMibModules, srcFile=srcFile, iappStationRoamedFromTrapEnabled=iappStationRoamedFromTrapEnabled, dot118021xSuppIndex=dot118021xSuppIndex, enterpriseApWMMAPParamAdmissionCtrl=enterpriseApWMMAPParamAdmissionCtrl, netConfigDHCPState=netConfigDHCPState, enterpriseApSNTPDSTStartMonth=enterpriseApSNTPDSTStartMonth, enterpriseApSshTelnetServerEnabled=enterpriseApSshTelnetServerEnabled, enterpriseApSNMP=enterpriseApSNMP, enterpriseApFilterUplinkPortMACAddrFilter=enterpriseApFilterUplinkPortMACAddrFilter, enterpriseApAdmin=enterpriseApAdmin, wdsPeerBssid=wdsPeerBssid, dot11InterfaceAGFail=dot11InterfaceAGFail, enterpriseApSTPNodeIndex=enterpriseApSTPNodeIndex, enterpriseApRadio=enterpriseApRadio, sysNotifications=sysNotifications, enterpriseApSessionLastAssociatedTime=enterpriseApSessionLastAssociatedTime, enterpriseApSNTPState=enterpriseApSNTPState, enterpriseApSecurityWPACipher=enterpriseApSecurityWPACipher, iappStationRoamedTo=iappStationRoamedTo, dot11AuthenticationServerTable=dot11AuthenticationServerTable, restartControl=restartControl, lineEntry=lineEntry, enterpriseApLineMgnt=enterpriseApLineMgnt, dot11FilterTable=dot11FilterTable, enterpriseApSessionLastDisassociatedTime=enterpriseApSessionLastDisassociatedTime, enterpriseAPVapRadioAuthTimeoutInterval=enterpriseAPVapRadioAuthTimeoutInterval, uplinkPortMACAddrFilterStatus=uplinkPortMACAddrFilterStatus, enterpriseApSecurityIndex=enterpriseApSecurityIndex, enterpriseAPVapRadioIndex=enterpriseAPVapRadioIndex, enterpriseApSNMPTrapDestinationCommunity=enterpriseApSNMPTrapDestinationCommunity, wdsMasterSlaveMode=wdsMasterSlaveMode, enterpriseApSNMPTrapDestinationIP=enterpriseApSNMPTrapDestinationIP, arubaEnterpriseMibModules=arubaEnterpriseMibModules, dot11InterfaceBFail=dot11InterfaceBFail, enterpriseApSNMPTrapFilters=enterpriseApSNMPTrapFilters, enterpriseApWMMBSSParamTXOPLimit=enterpriseApWMMBSSParamTXOPLimit, enterpriseApSyslogServerTable=enterpriseApSyslogServerTable, dot11AuthenticationServer=dot11AuthenticationServer, dot1xAuthenticatorMacAddr=dot1xAuthenticatorMacAddr, enterpriseApWMMAPParamAIFSN=enterpriseApWMMAPParamAIFSN, enterpriseApSessionTxByteCount=enterpriseApSessionTxByteCount, enterpriseApRadioAntennaMode=enterpriseApRadioAntennaMode, enterpriseApWMMBSSParamAIFSN=enterpriseApWMMBSSParamAIFSN, enterpriseApSTPNodeLinkPortPriority=enterpriseApSTPNodeLinkPortPriority, dot11NotificationTree=dot11NotificationTree, lineTable=lineTable, restartOpCodeFile=restartOpCodeFile, dot11FilterDefault=dot11FilterDefault, iappStationRoamedFrom=iappStationRoamedFrom, portFlowCtrlStatus=portFlowCtrlStatus, enterpriseApWMMAPParamTXOPLimit=enterpriseApWMMAPParamTXOPLimit, enterpriseApRadioFragmentLength=enterpriseApRadioFragmentLength, dot1xMacAddrAuthSuccess=dot1xMacAddrAuthSuccess, enterpriseApSTPHelloTime=enterpriseApSTPHelloTime, portSpeedDpxCfg=portSpeedDpxCfg, dot11StationRequestFail=dot11StationRequestFail, dot11AuthenticationSupplicantEntry=dot11AuthenticationSupplicantEntry, sysNotificationTree=sysNotificationTree, dot1xSuppAuthenticatedTrapEnabled=dot1xSuppAuthenticatedTrapEnabled, enterpriseApSsh=enterpriseApSsh, sysNotificationObjects=sysNotificationObjects, dot11Station=dot11Station, enterpriseApSessionTable=enterpriseApSessionTable, lineSpeed=lineSpeed, sysConfigFileVersionChanged=sysConfigFileVersionChanged, localMacAddrAuthFail=localMacAddrAuthFail, rogueAPDetectedTrapEnabled=rogueAPDetectedTrapEnabled, enterpriseApRadioIndex=enterpriseApRadioIndex, enterpriseApRadioDescription=enterpriseApRadioDescription, enterpriseApSession=enterpriseApSession, enterpriseApSecurityWEPEnabled=enterpriseApSecurityWEPEnabled, enterpriseApWMMAPParamIndex=enterpriseApWMMAPParamIndex, portIndex=portIndex, enterpriseApWMMTable=enterpriseApWMMTable, dot118021xState=dot118021xState, enterpriseAPVapRadioMaxAssoc=enterpriseAPVapRadioMaxAssoc, wdsPeerIndex=wdsPeerIndex, enterpriseApSshServerEnabled=enterpriseApSshServerEnabled, dot11StationAuthenticationTrapEnabled=dot11StationAuthenticationTrapEnabled, fileServer=fileServer, sysSystemDownTrapEnabled=sysSystemDownTrapEnabled, portEntry=portEntry, enterpriseApRadioTransmitKey=enterpriseApRadioTransmitKey, dot118021xBroadcastKeyRefreshRate=dot118021xBroadcastKeyRefreshRate, enterpriseApWMMBSSParamAdmissionCtrl=enterpriseApWMMBSSParamAdmissionCtrl, enterpriseApRadioRTSThreshold=enterpriseApRadioRTSThreshold, enterpriseApRadioAntennaId=enterpriseApRadioAntennaId, dot1xAuthFailTrapEnabled=dot1xAuthFailTrapEnabled, enterpriseApSecurityWPAPmksaLifetime=enterpriseApSecurityWPAPmksaLifetime, enterpriseApWMMAPParamLogCwMin=enterpriseApWMMAPParamLogCwMin, enterpriseApSTPBridgeStatus=enterpriseApSTPBridgeStatus, portFlowCtrlCfg=portFlowCtrlCfg, dot11FilterEntry=dot11FilterEntry, dot11VapAuthMACAuthenticationType=dot11VapAuthMACAuthenticationType, enterpriseApWMMBSSParamIndex=enterpriseApWMMBSSParamIndex, enterpriseApSTPNodeLinkPathCost=enterpriseApSTPNodeLinkPathCost, dot11StationAssociationTrapEnabled=dot11StationAssociationTrapEnabled, enterpriseApRadioAntennaLocation=enterpriseApRadioAntennaLocation, dot1xMacAddrAuthFail=dot1xMacAddrAuthFail, enterpriseApSyslogConsoleState=enterpriseApSyslogConsoleState, enterpriseApSNMPTrapDestinationState=enterpriseApSNMPTrapDestinationState, enterpriseApSNMPCommunityReadOnly=enterpriseApSNMPCommunityReadOnly, enterpriseApVLANState=enterpriseApVLANState, enterpriseApSecurity=enterpriseApSecurity, dot11MACAuthenticationType=dot11MACAuthenticationType, enterpriseApSyslogServerEntry=enterpriseApSyslogServerEntry, enterpriseApDNSPrimaryServer=enterpriseApDNSPrimaryServer, dot11VapAuthenticationTable=dot11VapAuthenticationTable, sntpNotifications=sntpNotifications, nativeVlanIfIndex=nativeVlanIfIndex, enterpriseApRadioClosedSystem=enterpriseApRadioClosedSystem, dot11AuthenticationVLANIDFormat=dot11AuthenticationVLANIDFormat, dot11Vap8021xIndex=dot11Vap8021xIndex, enterpriseApSNTPDSTEndDay=enterpriseApSNTPDSTEndDay, enterpriseApSecuritySharedKeyLen=enterpriseApSecuritySharedKeyLen, enterpriseApSecurityWPAPreAuthentication=enterpriseApSecurityWPAPreAuthentication, netConfigHttpState=netConfigHttpState, netConfigHttpsState=netConfigHttpsState, dot11AuthenticationServerEntry=dot11AuthenticationServerEntry, dot11VapAuthMACAuthenticationTimeout=dot11VapAuthMACAuthenticationTimeout, dot11AuthenticationServerIndex=dot11AuthenticationServerIndex, aruba=aruba, enterpriseApRadioWdsTable=enterpriseApRadioWdsTable, enterpriseApSTPEthernetLinkPathCost=enterpriseApSTPEthernetLinkPathCost, enterpriseApRadioTable=enterpriseApRadioTable, enterpriseApSyslogState=enterpriseApSyslogState, enterpriseApSyslogServerPort=enterpriseApSyslogServerPort, enterpriseApSessionEntry=enterpriseApSessionEntry, enterpriseApRadioState=enterpriseApRadioState, enterpriseApWMMAPParamTable=enterpriseApWMMAPParamTable, uplinkPortMACAddrFilterAddMac=uplinkPortMACAddrFilterAddMac, enterpriseApRadioAutoChannel=enterpriseApRadioAutoChannel, enterpriseApSNMPTrapDestinationEntry=enterpriseApSNMPTrapDestinationEntry, enterpriseApSTPEthernetInterface=enterpriseApSTPEthernetInterface, enterpriseAPdot11=enterpriseAPdot11, enterpriseApSecurityWPAPSK=enterpriseApSecurityWPAPSK, dot1xAuthSuccess=dot1xAuthSuccess, enterpriseApRadioBeaconInterval=enterpriseApRadioBeaconInterval, dot1xMacAddrAuthSuccessTrapEnabled=dot1xMacAddrAuthSuccessTrapEnabled, netConfigIPAddress=netConfigIPAddress, enterpriseApSessionAuthenticated=enterpriseApSessionAuthenticated, enterpriseApNativeVlanEntry=enterpriseApNativeVlanEntry, enterpriseApWMMBSSParamTable=enterpriseApWMMBSSParamTable, pppLogonFail=pppLogonFail, portType=portType, enterpriseApSNTP=enterpriseApSNTP, dot1xMacAddrAuthFailTrapEnabled=dot1xMacAddrAuthFailTrapEnabled, dot11NotificationObjects=dot11NotificationObjects, dot11AuthenticationEntry=dot11AuthenticationEntry, enterpriseAPVapRadioClosedSystem=enterpriseAPVapRadioClosedSystem, portTable=portTable, enterpriseApSyslogLevel=enterpriseApSyslogLevel, sntpNotificationObjects=sntpNotificationObjects, sysRadiusServerChanged=sysRadiusServerChanged, dot11AuthenticationKey=dot11AuthenticationKey, nativeVlanVlanId=nativeVlanVlanId, enterpriseApFilterProtocolState=enterpriseApFilterProtocolState, enterpriseApWMMMode=enterpriseApWMMMode, swSerialNumber=swSerialNumber, swHardwareVer=swHardwareVer, enterpriseApSTPBridgePriority=enterpriseApSTPBridgePriority, enterpriseApRadioDataBeaconRate=enterpriseApRadioDataBeaconRate, uplinkPortMACAddrFilteringTable=uplinkPortMACAddrFilteringTable, dot11AuthenticationMACAddressFormat=dot11AuthenticationMACAddressFormat, pppLogonFailTrapEnabled=pppLogonFailTrapEnabled, enterpriseApPortMgnt=enterpriseApPortMgnt, localMacAddrAuthSuccessTrapEnabled=localMacAddrAuthSuccessTrapEnabled, enterpriseApAdminUser=enterpriseApAdminUser, dot118021xSessionKeyRefreshRate=dot118021xSessionKeyRefreshRate, enterpriseApSyslogServerIPAddress=enterpriseApSyslogServerIPAddress, dot11AuthenticationPort=dot11AuthenticationPort, enterpriseApWMMEntry=enterpriseApWMMEntry, enterpriseAPVapRadio=enterpriseAPVapRadio, enterpriseApWMMAckPolicyEntry=enterpriseApWMMAckPolicyEntry, enterpriseApWMM=enterpriseApWMM, enterpriseApSTP=enterpriseApSTP, sntpServerFailTrapEnabled=sntpServerFailTrapEnabled, enterpriseApSTPBridgeMaxAge=enterpriseApSTPBridgeMaxAge, portCapabilities=portCapabilities, enterpriseApSecurityWPACipherSuite=enterpriseApSecurityWPACipherSuite, enterpriseApSessionStationAddres=enterpriseApSessionStationAddres, possibleRogueAPDetectedTrapEnabled=possibleRogueAPDetectedTrapEnabled, enterpriseApWMMAckPolicyTable=enterpriseApWMMAckPolicyTable, enterpriseAPVapRadioDescription=enterpriseAPVapRadioDescription, enterpriseApSTPRadioInterface=enterpriseApSTPRadioInterface, sysSystemUp=sysSystemUp, iappStationRoamedToTrapEnabled=iappStationRoamedToTrapEnabled, dot11InterfaceBFailTrapEnabled=dot11InterfaceBFailTrapEnabled, enterpriseApSTPBridgeForwardingDelay=enterpriseApSTPBridgeForwardingDelay, deleteMacAddr=deleteMacAddr, userName=userName, dot11MACAuthenticationFilter=dot11MACAuthenticationFilter, dot1xAuthNotInitiatedTrapEnabled=dot1xAuthNotInitiatedTrapEnabled, enterpriseApSessionAssociated=enterpriseApSessionAssociated, enterpriseApFilterControlEthernet=enterpriseApFilterControlEthernet, netConfigHttpsPort=netConfigHttpsPort, localMacAddrAuthFailTrapEnabled=localMacAddrAuthFailTrapEnabled, enterpriseApFilterProtocolTable=enterpriseApFilterProtocolTable, lineDataBits=lineDataBits, enterpriseApSessionKeyType=enterpriseApSessionKeyType, enterpriseApVLANNativeId=enterpriseApVLANNativeId, dot11Vap8021xState=dot11Vap8021xState, enterpriseApSyslog=enterpriseApSyslog, enterpriseApSTPEthernetLinkPortPriority=enterpriseApSTPEthernetLinkPortPriority, dot11ReasonCode=dot11ReasonCode)
mibBuilder.exportSymbols("AP80-PRIVATE-MIB", enterpriseApSessionAssociatedTime=enterpriseApSessionAssociatedTime, iappContextDataSentTrapEnabled=iappContextDataSentTrapEnabled, enterpriseApRadioTurboMode=enterpriseApRadioTurboMode, dot1xAuthSuccessTrapEnabled=dot1xAuthSuccessTrapEnabled, dot11Vap8021xSessionKeyRefreshRate=dot11Vap8021xSessionKeyRefreshRate, enterpriseApSNMPCommunityReadWrite=enterpriseApSNMPCommunityReadWrite, dot11ApIpAddress=dot11ApIpAddress, dot11VapAuthenticationEntry=dot11VapAuthenticationEntry, uplinkPortMACAddr=uplinkPortMACAddr, enterpriseApSessionLastAuthenticatedTime=enterpriseApSessionLastAuthenticatedTime, netConfigSubnetMask=netConfigSubnetMask, dot11StationReAssociationTrapEnabled=dot11StationReAssociationTrapEnabled, dot11AuthenticationAcctPort=dot11AuthenticationAcctPort, enterpriseApFilterProtocolISODesignator=enterpriseApFilterProtocolISODesignator, dot11AckFailuresTrapEnabled=dot11AckFailuresTrapEnabled, uplinkPortMACAddrFilteringEntry=uplinkPortMACAddrFilteringEntry, dot118021xReauthenticationTimeout=dot118021xReauthenticationTimeout, enterpriseApSNTPDSTEndMonth=enterpriseApSNTPDSTEndMonth, transferType=transferType, portSpeedDpxStatus=portSpeedDpxStatus, fileType=fileType, sntpNotificationTree=sntpNotificationTree, swBootRomVer=swBootRomVer, enterpriseApSessionIfIndex=enterpriseApSessionIfIndex, TruthValue=TruthValue, dot1xSupplicantAuthenticated=dot1xSupplicantAuthenticated, enterpriseApWMMBSSParamLogCwMin=enterpriseApWMMBSSParamLogCwMin, enterpriseApSNTPSecondaryServer=enterpriseApSNTPSecondaryServer, portName=portName, dot11FcsErrorsTrapEnabled=dot11FcsErrorsTrapEnabled, enterpriseAPVapRadioState=enterpriseAPVapRadioState, dot1xAuthNotInitiated=dot1xAuthNotInitiated, dot118021xSuppState=dot118021xSuppState, enterpriseApRadioRogueApDetection=enterpriseApRadioRogueApDetection, status=status, enterpriseApRadioRogueApScanNow=enterpriseApRadioRogueApScanNow, enterpriseApVLAN=enterpriseApVLAN, iappContextDataSent=iappContextDataSent, enterpriseApSNTPDSTStartDay=enterpriseApSNTPDSTStartDay, uplinkPortMacAddrIndex=uplinkPortMacAddrIndex, dot11StationRequestFailTrapEnabled=dot11StationRequestFailTrapEnabled, enterpriseApRadioRogueApScanDuration=enterpriseApRadioRogueApScanDuration, dot11FailedTransmitsTrapEnabled=dot11FailedTransmitsTrapEnabled, enterpriseApSyslogServerIndex=enterpriseApSyslogServerIndex, enterpriseApWMMModeIndex=enterpriseApWMMModeIndex, dot11AuthenticationTimeout=dot11AuthenticationTimeout, dot11StationAssociation=dot11StationAssociation, enterpriseApDNSSecondaryServer=enterpriseApDNSSecondaryServer, enterpriseApSessionAssociationId=enterpriseApSessionAssociationId, enterpriseApRadioTransmitPower=enterpriseApRadioTransmitPower, enterpriseApRadioGMode=enterpriseApRadioGMode, enterpriseAPVapRadioEntry=enterpriseAPVapRadioEntry, sysRadiusServerChangedTrapEnabled=sysRadiusServerChangedTrapEnabled, enterpriseApWMMBSSParamLogCwMax=enterpriseApWMMBSSParamLogCwMax, enterpriseApRadioMaxAssoc=enterpriseApRadioMaxAssoc, enterpriseApSTPNodeEntry=enterpriseApSTPNodeEntry, enterpriseApIpMgt=enterpriseApIpMgt, enterpriseApSecurityWPAKeyType=enterpriseApSecurityWPAKeyType, enterpriseApNativeVlanTable=enterpriseApNativeVlanTable, enterpriseApFilterProtocolName=enterpriseApFilterProtocolName, enterpriseApResetMgt=enterpriseApResetMgt, enterpriseApSNTPTimezone=enterpriseApSNTPTimezone, enterpriseApWMMAPParamEntry=enterpriseApWMMAPParamEntry, enterpriseApWMMAPParamLogCwMax=enterpriseApWMMAPParamLogCwMax, destFile=destFile, dot11AuthenticationAcctInterimUpdate=dot11AuthenticationAcctInterimUpdate, enterpriseApSNTPPrimaryServer=enterpriseApSNTPPrimaryServer, enterpriseApRadioMICMode=enterpriseApRadioMICMode, enterpriseApSessionRxByteCount=enterpriseApSessionRxByteCount, dot118021xSuppUser=dot118021xSuppUser, enterpriseApSecurityAuthType=enterpriseApSecurityAuthType, enterpriseApFilterControlAPManage=enterpriseApFilterControlAPManage, enterpriseApRadioChannel=enterpriseApRadioChannel, enterpriseApSNMPTrapDestinationTable=enterpriseApSNMPTrapDestinationTable, enterpriseApSessionTxPacketCount=enterpriseApSessionTxPacketCount, enterpriseApFileTransferMgt=enterpriseApFileTransferMgt, enterpriseAPVapRadioTransmitKey=enterpriseAPVapRadioTransmitKey, enterpriseApRadioWdsEntry=enterpriseApRadioWdsEntry, dot11RequestType=dot11RequestType, sysSystemUpTrapEnabled=sysSystemUpTrapEnabled, enterpriseApRadioAntennaGainReduction=enterpriseApRadioAntennaGainReduction, dot11InterfaceAGFailTrapEnabled=dot11InterfaceAGFailTrapEnabled, sntpServerFail=sntpServerFail, enterpriseApSNMPTrapDestinationIndex=enterpriseApSNMPTrapDestinationIndex, enterpriseApRadioRogueApScanInterval=enterpriseApRadioRogueApScanInterval, enterpriseApSecurityTable=enterpriseApSecurityTable, enterpriseApSessionRxPacketCount=enterpriseApSessionRxPacketCount, enterpriseApRadioWds=enterpriseApRadioWds, enterpriseApSyslogServerState=enterpriseApSyslogServerState, dot11AuthenticationSupplicantTable=dot11AuthenticationSupplicantTable, enterpriseApWMMBSSParamEntry=enterpriseApWMMBSSParamEntry, nativeVlanSsidNumber=nativeVlanSsidNumber, enterpriseApFilterProtocolIndex=enterpriseApFilterProtocolIndex, enterpriseApRadioEntry=enterpriseApRadioEntry, dot11Notifications=dot11Notifications, enterpriseApRadioWdsPeerTable=enterpriseApRadioWdsPeerTable, enterpriseApRadioWdsPeerEntry=enterpriseApRadioWdsPeerEntry, enterpriseAPVapRadioTable=enterpriseAPVapRadioTable)
