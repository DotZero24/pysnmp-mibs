...
if mibBuilder.loadTexts:bgp4V2TC.setRevisions(('2010-02-01 00:00',))
...
mibBuilder.exportSymbols('FOUNDRY-BGP4V2-TC-MIB',**{'Bgp4V2IdentifierTC':Bgp4V2IdentifierTC,'Bgp4V2AddressFamilyIdentifierTC':Bgp4V2AddressFamilyIdentifierTC,'Bgp4V2SubsequentAddressFamilyIdentifierTC':Bgp4V2SubsequentAddressFamilyIdentifierTC,'bgp4V2TC':bgp4V2TC})