...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SECURE-SHELL-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:34:23 2025
...
_CssServiceActivation_Type.__name__ = "TruthValue"
...
ciscoSecureShellMIBCompliance.setObjects(
    ("CISCO-SECURE-SHELL-MIB", "cssConfigurationGroup")
)
if mibBuilder.loadTexts:
...
ciscoSecureShellMIBComplianceRv1.setObjects(
    ("CISCO-SECURE-SHELL-MIB", "cssConfigurationGroupRev1")
)
if mibBuilder.loadTexts:
...
ciscoSecureShellMIBComplianceRv2.setObjects(
    ("CISCO-SECURE-SHELL-MIB", "cssConfigurationGroupRev1")
)
if mibBuilder.loadTexts:
...
ciscoSecureShellMIBComplianceRv3.setObjects(
      *(("CISCO-SECURE-SHELL-MIB", "cssConfigurationGroupRev1"),
        ("CISCO-SECURE-SHELL-MIB", "cssConfigurationGroupSupp1"))
)
if mibBuilder.loadTexts:
