...
# Notes
# -----
# ASN.1 source file://mibs/hp/CPQSTSYS-MIB
...
class _CpqSsBoxInitiatorSasAddress_Type(DisplayString):
    """Custom type cpqSsBoxInitiatorSasAddress based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqSsBoxInitiatorSasAddress_Type.__name__ = "DisplayString"
_CpqSsBoxInitiatorSasAddress_Object = MibTableColumn
cpqSsBoxInitiatorSasAddress = _CpqSsBoxInitiatorSasAddress_Object(
    (1, 3, 6, 1, 4, 1, 232, 8, 2, 1, 1, 24),
    _CpqSsBoxInitiatorSasAddress_Type()
)
cpqSsBoxInitiatorSasAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSsBoxInitiatorSasAddress.setStatus("mandatory")


class _CpqSsBoxTargetSasAddress_Type(DisplayString):
    """Custom type cpqSsBoxTargetSasAddress based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 16),
    )
...
_CpqSsBoxTargetSasAddress_Type.__name__ = "DisplayString"
_CpqSsBoxTargetSasAddress_Object = MibTableColumn
cpqSsBoxTargetSasAddress = _CpqSsBoxTargetSasAddress_Object(
    (1, 3, 6, 1, 4, 1, 232, 8, 2, 1, 1, 25),
    _CpqSsBoxTargetSasAddress_Type()
)
cpqSsBoxTargetSasAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSsBoxTargetSasAddress.setStatus("mandatory")


class _CpqSsBoxLocalManageIpAddress_Type(DisplayString):
    """Custom type cpqSsBoxLocalManageIpAddress based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqSsBoxLocalManageIpAddress_Type.__name__ = "DisplayString"
_CpqSsBoxLocalManageIpAddress_Object = MibTableColumn
cpqSsBoxLocalManageIpAddress = _CpqSsBoxLocalManageIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 232, 8, 2, 1, 1, 26),
    _CpqSsBoxLocalManageIpAddress_Type()
)
cpqSsBoxLocalManageIpAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSsBoxLocalManageIpAddress.setStatus("mandatory")


class _CpqSsBoxPartnerManageIpAddress_Type(DisplayString):
    """Custom type cpqSsBoxPartnerManageIpAddress based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_CpqSsBoxPartnerManageIpAddress_Type.__name__ = "DisplayString"
_CpqSsBoxPartnerManageIpAddress_Object = MibTableColumn
cpqSsBoxPartnerManageIpAddress = _CpqSsBoxPartnerManageIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 232, 8, 2, 1, 1, 27),
    _CpqSsBoxPartnerManageIpAddress_Type()
)
cpqSsBoxPartnerManageIpAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSsBoxPartnerManageIpAddress.setStatus("mandatory")


class _CpqSsBoxConnectionStatus_Type(Integer32):
    """Custom type cpqSsBoxConnectionStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSsBoxConnectionStatus_Type.__name__ = "Integer32"
_CpqSsBoxConnectionStatus_Object = MibTableColumn
cpqSsBoxConnectionStatus = _CpqSsBoxConnectionStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 8, 2, 1, 1, 28),
    _CpqSsBoxConnectionStatus_Type()
)
cpqSsBoxConnectionStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSsBoxConnectionStatus.setStatus("mandatory")


class _CpqSsBoxTargetBasedManagement_Type(Integer32):
    """Custom type cpqSsBoxTargetBasedManagement based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSsBoxTargetBasedManagement_Type.__name__ = "Integer32"
_CpqSsBoxTargetBasedManagement_Object = MibTableColumn
cpqSsBoxTargetBasedManagement = _CpqSsBoxTargetBasedManagement_Object(
    (1, 3, 6, 1, 4, 1, 232, 8, 2, 1, 1, 29),
    _CpqSsBoxTargetBasedManagement_Type()
)
cpqSsBoxTargetBasedManagement.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSsBoxTargetBasedManagement.setStatus("mandatory")


class _CpqSsBoxGSIStatus_Type(Integer32):
    """Custom type cpqSsBoxGSIStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSsBoxGSIStatus_Type.__name__ = "Integer32"
_CpqSsBoxGSIStatus_Object = MibTableColumn
cpqSsBoxGSIStatus = _CpqSsBoxGSIStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 8, 2, 1, 1, 30),
    _CpqSsBoxGSIStatus_Type()
)
cpqSsBoxGSIStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSsBoxGSIStatus.setStatus("mandatory")


class _CpqSsBoxGSIMessages_Type(DisplayString):
    """Custom type cpqSsBoxGSIMessages based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqSsBoxGSIMessages_Type.__name__ = "DisplayString"
_CpqSsBoxGSIMessages_Object = MibTableColumn
cpqSsBoxGSIMessages = _CpqSsBoxGSIMessages_Object(
    (1, 3, 6, 1, 4, 1, 232, 8, 2, 1, 1, 31),
    _CpqSsBoxGSIMessages_Type()
)
cpqSsBoxGSIMessages.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSsBoxGSIMessages.setStatus("mandatory")
...
cpqSsConnectionStatusChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 8032)
)
cpqSsConnectionStatusChange.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTSYS-MIB", "cpqSsBoxCntlrHwLocation"),
        ("CPQSTSYS-MIB", "cpqSsBoxCntlrIndex"),
        ...
        ("CPQSTSYS-MIB", "cpqSsBoxModel"),
        ("CPQSTSYS-MIB", "cpqSsBoxSerialNumber"),
        ("CPQSTSYS-MIB", "cpqSsBoxConnectionStatus"),
        ("CPQSTSYS-MIB", "cpqSsBoxLocationString"),
        ("CPQSTSYS-MIB", "cpqSsBoxTargetSasAddress"),
        ("CPQSTSYS-MIB", "cpqSsBoxLocalManageIpAddress"))
)
if mibBuilder.loadTexts:
    cpqSsConnectionStatusChange.setStatus(
        ""
    )

cpqSsGSIStatusChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 8033)
)
cpqSsGSIStatusChange.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTSYS-MIB", "cpqSsBoxCntlrHwLocation"),
        ("CPQSTSYS-MIB", "cpqSsBoxCntlrIndex"),
        ...
        ("CPQSTSYS-MIB", "cpqSsBoxModel"),
        ("CPQSTSYS-MIB", "cpqSsBoxSerialNumber"),
        ("CPQSTSYS-MIB", "cpqSsBoxGSIStatus"),
        ("CPQSTSYS-MIB", "cpqSsBoxGSIMessages"),
        ("CPQSTSYS-MIB", "cpqSsBoxLocationString"))
)
if mibBuilder.loadTexts:
    cpqSsGSIStatusChange.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"cpqSs2FanStatusChange": cpqSs2FanStatusChange,
       ...
       "cpqSsConnectionStatusChange": cpqSsConnectionStatusChange,
       "cpqSsGSIStatusChange": cpqSsGSIStatusChange,
       ...
       "cpqSsBoxInitiatorSasAddress": cpqSsBoxInitiatorSasAddress,
       "cpqSsBoxTargetSasAddress": cpqSsBoxTargetSasAddress,
       "cpqSsBoxLocalManageIpAddress": cpqSsBoxLocalManageIpAddress,
       "cpqSsBoxPartnerManageIpAddress": cpqSsBoxPartnerManageIpAddress,
       "cpqSsBoxConnectionStatus": cpqSsBoxConnectionStatus,
       "cpqSsBoxTargetBasedManagement": cpqSsBoxTargetBasedManagement,
       "cpqSsBoxGSIStatus": cpqSsBoxGSIStatus,
       "cpqSsBoxGSIMessages": cpqSsBoxGSIMessages,
