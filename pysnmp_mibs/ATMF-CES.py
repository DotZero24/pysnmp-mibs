...
# Notes
# -----
# ASN.1 source file://mibs/zhone/ATMF-CES
...
atmfCESCompliance.setObjects(
      *(("ATMF-CES", "atmfCESBasicConfigGroup"),
        ("ATMF-CES", "atmfCESBasicStatsGroup"),
        ("ATMF-CES", "atmfCESStructConfigGroup"),
        ("ATMF-CES", "atmfCESStructStatsGroup"),
        ("ATMF-CES", "atmfCESSvcConfigGroup"))
)
if mibBuilder.loadTexts:
