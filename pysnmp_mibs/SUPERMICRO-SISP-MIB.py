...
fssisp=ModuleIdentity((1,3,6,1,4,1,10876,101,2,20))
if mibBuilder.loadTexts:fssisp.setRevisions(('2012-09-05 00:00',))
_FsSispSystemGroup_ObjectIdentity=ObjectIdentity
fsSispSystemGroup=_FsSispSystemGroup_ObjectIdentity((1,3,6,1,4,1,10876,101,2,20,1))
...
fsSispSystemControl=_FsSispSystemControl_Object((1,3,6,1,4,1,10876,101,2,20,1,1),_FsSispSystemControl_Type())
...
fsSispConfig=_FsSispConfig_ObjectIdentity((1,3,6,1,4,1,10876,101,2,20,2))
_FsSispPortTable_Object=MibTable
fsSispPortTable=_FsSispPortTable_Object((1,3,6,1,4,1,10876,101,2,20,2,1))
if mibBuilder.loadTexts:fsSispPortTable.setStatus(_A)
_FsSispPortEntry_Object=MibTableRow
fsSispPortEntry=_FsSispPortEntry_Object((1,3,6,1,4,1,10876,101,2,20,2,1,1))
...
fsSispPortIndex=_FsSispPortIndex_Object((1,3,6,1,4,1,10876,101,2,20,2,1,1,1),_FsSispPortIndex_Type())
...
fsSispPortCtrlStatus=_FsSispPortCtrlStatus_Object((1,3,6,1,4,1,10876,101,2,20,2,1,1,2),_FsSispPortCtrlStatus_Type())
...
fsSispPortMapTable=_FsSispPortMapTable_Object((1,3,6,1,4,1,10876,101,2,20,2,2))
if mibBuilder.loadTexts:fsSispPortMapTable.setStatus(_A)
_FsSispPortMapEntry_Object=MibTableRow
fsSispPortMapEntry=_FsSispPortMapEntry_Object((1,3,6,1,4,1,10876,101,2,20,2,2,1))
...
fsSispPortMapContextId=_FsSispPortMapContextId_Object((1,3,6,1,4,1,10876,101,2,20,2,2,1,1),_FsSispPortMapContextId_Type())
...
fsSispPortMapSharedPort=_FsSispPortMapSharedPort_Object((1,3,6,1,4,1,10876,101,2,20,2,2,1,2),_FsSispPortMapSharedPort_Type())
...
fsSispPortMapHlPortId=_FsSispPortMapHlPortId_Object((1,3,6,1,4,1,10876,101,2,20,2,2,1,3),_FsSispPortMapHlPortId_Type())
...
fsSispPortMapRowStatus=_FsSispPortMapRowStatus_Object((1,3,6,1,4,1,10876,101,2,20,2,2,1,4),_FsSispPortMapRowStatus_Type())
...
fsSispInfo=_FsSispInfo_ObjectIdentity((1,3,6,1,4,1,10876,101,2,20,3))
_FsSispCxtClassificationTable_Object=MibTable
fsSispCxtClassificationTable=_FsSispCxtClassificationTable_Object((1,3,6,1,4,1,10876,101,2,20,3,1))
if mibBuilder.loadTexts:fsSispCxtClassificationTable.setStatus(_A)
_FsSispCxtClassificationEntry_Object=MibTableRow
fsSispCxtClassificationEntry=_FsSispCxtClassificationEntry_Object((1,3,6,1,4,1,10876,101,2,20,3,1,1))
...
fsSispCxtClassificationVlanId=_FsSispCxtClassificationVlanId_Object((1,3,6,1,4,1,10876,101,2,20,3,1,1,1),_FsSispCxtClassificationVlanId_Type())
...
fsSispCxtClassificationCxtId=_FsSispCxtClassificationCxtId_Object((1,3,6,1,4,1,10876,101,2,20,3,1,1,2),_FsSispCxtClassificationCxtId_Type())
