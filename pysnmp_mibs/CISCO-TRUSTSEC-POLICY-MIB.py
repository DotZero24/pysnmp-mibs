...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-TRUSTSEC-POLICY-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:43:29 2025
...
_CtspVlanConfigStorageType_Type.__name__ = "StorageType"
...
_CtspConfigSgaclMappingStorageType_Type.__name__ = "StorageType"
...
_CtspConfigSgaclMonitor_Type.__name__ = "CtsSgaclMonitorMode"
...
_CtspIpSgtStorageType_Type.__name__ = "StorageType"
...
_CtspIfSgtStorageType_Type.__name__ = "StorageType"
...
_CtspVlanSgtStorageType_Type.__name__ = "StorageType"
...
ciscoTrustSecPolicyMIBCompliance.setObjects(
      *(("CISCO-TRUSTSEC-POLICY-MIB", "ctspGlobalSgaclEnforcementGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspOperSgaclMappingGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspDownloadedSgaclMappingGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspIpSwStatisticsGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspDefSwStatisticsGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspVlanConfigGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspConfigSgaclMappingGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspIpHwStatisticsGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspDefHwStatisticsGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspSgaclIpv4DropNetflowMonitorGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspSgaclIpv6DropNetflowMonitorGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspPeerPolicyGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspPeerPolicyActionGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspLayer3TransportGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspIpSgtMappingGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspIfL3PolicyConfigGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspSgtPolicyGroup"))
)
if mibBuilder.loadTexts:
...
ciscoTrustSecPolicyMIBComplianceRev2.setObjects(
      *(("CISCO-TRUSTSEC-POLICY-MIB", "ctspGlobalSgaclEnforcementGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspOperSgaclMappingGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspDownloadedSgaclMappingGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspIpSwStatisticsGroup"),
        ...
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspIfL3PolicyConfigGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspSgtPolicyGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspIfSgtMappingGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspVlanSgtMappingGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspSgtCachingGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspSgaclMonitorGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspSgaclMonitorStatisticGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspNotifCtrlGroup"),
        ("CISCO-TRUSTSEC-POLICY-MIB", "ctspNotifGroup"),
