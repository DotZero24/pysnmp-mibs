...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-TRUSTSEC-POLICY-MIB
...
CtsSecurityGroupTag, CtsSgaclMonitorMode, CtsAclNameOrEmpty, CtsGenerationId, CtsAclList, CtsAclListOrEmpty, CtsAclName = mibBuilder.importSymbols("CISCO-TRUSTSEC-TC-MIB", "CtsSecurityGroupTag", "CtsSgaclMonitorMode", "CtsAclNameOrEmpty", "CtsGenerationId", "CtsAclList", "CtsAclListOrEmpty", "CtsAclName")
...
mibBuilder.exportSymbols("CISCO-TRUSTSEC-POLICY-MIB", ctspDownloadedDefSgtPolicyLifeTime=ctspDownloadedDefSgtPolicyLifeTime, ctspVlanConfigSgaclEnforcement=ctspVlanConfigSgaclEnforcement, ctspIfSgtStorageType=ctspIfSgtStorageType, ctspConfigSgaclMappingStorageType=ctspConfigSgaclMappingStorageType, ctspDownloadedSgaclMappingEntry=ctspDownloadedSgaclMappingEntry, ctspDownloadedDefSgtPolicySgtGenId=ctspDownloadedDefSgtPolicySgtGenId, ctspPeerPolicyUpdatedNotif=ctspPeerPolicyUpdatedNotif, ctspConfigSgaclMappingEntry=ctspConfigSgaclMappingEntry, ctspIpSgtStorageType=ctspIpSgtStorageType, ctspOldPeerSgt=ctspOldPeerSgt, ctspDefDownloadedSgaclIndex=ctspDefDownloadedSgaclIndex, ctspOperSgaclMappingEntry=ctspOperSgaclMappingEntry, ctspOperSgaclConfigSource=ctspOperSgaclConfigSource, ctspIpSgtRowStatus=ctspIpSgtRowStatus, ctspSgtCachingMode=ctspSgtCachingMode, ctspIpSwStatisticsGroup=ctspIpSwStatisticsGroup, ctspIfL3PolicyConfigGroup=ctspIfL3PolicyConfigGroup, ctspAllPeerPolicyAction=ctspAllPeerPolicyAction, ctspStatsIpHwDropPkts=ctspStatsIpHwDropPkts, ctspDownloadedSgaclDestSgt=ctspDownloadedSgaclDestSgt, ctspDefSwStatisticsGroup=ctspDefSwStatisticsGroup, ciscoTrustSecPolicyMIB=ciscoTrustSecPolicyMIB, ctspOperSgaclIndex=ctspOperSgaclIndex, ctspSgaclIpv4DropNetflowMonitorGroup=ctspSgaclIpv4DropNetflowMonitorGroup, ctspConfigSgaclMappingRowStatus=ctspConfigSgaclMappingRowStatus, ctspPeerTrustState=ctspPeerTrustState, ctspDownloadedSgaclGenId=ctspDownloadedSgaclGenId, ctspVlanConfigTable=ctspVlanConfigTable, ctspVlanSgtMappings=ctspVlanSgtMappings, ctspSgtStatsEntry=ctspSgtStatsEntry, ctspVlanConfigIndex=ctspVlanConfigIndex, ctspDownloadedSgtPolicySgt=ctspDownloadedSgtPolicySgt, ctspSgaclMonitorStatisticGroup=ctspSgaclMonitorStatisticGroup, ctspDefOperationalSgaclName=ctspDefOperationalSgaclName, ctspStatsDestSgt=ctspStatsDestSgt, ctspDownloadedSgtPolicyAction=ctspDownloadedSgtPolicyAction, ctspIpSgtAddressLength=ctspIpSgtAddressLength, ctspAuthorizationSgaclFailInfo=ctspAuthorizationSgaclFailInfo, ctspIpSgtIpAddress=ctspIpSgtIpAddress, ctspIpSgtAddressType=ctspIpSgtAddressType, ctspIfSgtMappingInfoEntry=ctspIfSgtMappingInfoEntry, ctspPeerPolicyActionGroup=ctspPeerPolicyActionGroup, ctspConfigSgaclMappingSourceSgt=ctspConfigSgaclMappingSourceSgt, ctspSgaclIpv4DropNetflowMonitor=ctspSgaclIpv4DropNetflowMonitor, ctspGlobalSgaclEnforcementGroup=ctspGlobalSgaclEnforcementGroup, ctspVlanSgtMappingGroup=ctspVlanSgtMappingGroup, ciscoTrustSecPolicyMIBCompliances=ciscoTrustSecPolicyMIBCompliances, ctspIfSgtValue=ctspIfSgtValue, ctspDefIpSwPermitPkts=ctspDefIpSwPermitPkts, ctspSgtPolicy=ctspSgtPolicy, ctspConfigSgaclMappingGroup=ctspConfigSgaclMappingGroup, ctspDefOperSgaclMonitor=ctspDefOperSgaclMonitor, ctspDownloadedSgaclMonitor=ctspDownloadedSgaclMonitor, ctspDefDownloadedSgaclName=ctspDefDownloadedSgaclName, ctspIfL3PolicyConfigTable=ctspIfL3PolicyConfigTable, ciscoTrustSecPolicyMIBObjects=ciscoTrustSecPolicyMIBObjects, ctspDownloadedDefSgtPolicyAction=ctspDownloadedDefSgtPolicyAction, ctspVlanSgtMappingTable=ctspVlanSgtMappingTable, ctspConfigSgaclMappingTable=ctspConfigSgaclMappingTable, ctspIpSgtSource=ctspIpSgtSource, ctspSgtCachingGroup=ctspSgtCachingGroup, ctspPeerPolicyUpdatedNotifEnable=ctspPeerPolicyUpdatedNotifEnable, ctspNotifCtrlGroup=ctspNotifCtrlGroup, ctspDefOperSgaclMappingTable=ctspDefOperSgaclMappingTable, ctspIpSgtMappingTable=ctspIpSgtMappingTable, ctspDefConfigIpv6Sgacls=ctspDefConfigIpv6Sgacls, ctspNotifsControl=ctspNotifsControl, ctspSgtPolicyGroup=ctspSgtPolicyGroup, ctspNotifInfoGroup=ctspNotifInfoGroup, ctspPeerPolicyTable=ctspPeerPolicyTable, ctspStatsIpSwPermitPkts=ctspStatsIpSwPermitPkts, ctspPeerSgtGenId=ctspPeerSgtGenId, ctspSgaclEnforcementEnable=ctspSgaclEnforcementEnable, ctspIfL3Ipv6PolicyEnabled=ctspIfL3Ipv6PolicyEnabled, ctspDefOperSgaclIndex=ctspDefOperSgaclIndex, ctspSgaclMonitorEnable=ctspSgaclMonitorEnable, ctspPeerName=ctspPeerName, ctspVlanConfigRowStatus=ctspVlanConfigRowStatus, ctspLayer3PolicyTable=ctspLayer3PolicyTable, ctspStatsSourceSgt=ctspStatsSourceSgt, ctspDefDownloadedSgaclMappingTable=ctspDefDownloadedSgaclMappingTable, ctspDefConfigIpv4SgaclsMonitor=ctspDefConfigIpv4SgaclsMonitor, ctspLayer3PolicyEntry=ctspLayer3PolicyEntry, ctspStatsIpSwMonitorPkts=ctspStatsIpSwMonitorPkts, ctspStatsIpTrafficType=ctspStatsIpTrafficType, ctspDefDownloadedIpTrafficType=ctspDefDownloadedIpTrafficType, ctspDefStatsTable=ctspDefStatsTable, ctspOperSgaclMappingSource=ctspOperSgaclMappingSource, ctspDefIpHwPermitPkts=ctspDefIpHwPermitPkts, ctspConfigSgaclMappingSgaclName=ctspConfigSgaclMappingSgaclName, ciscoTrustSecPolicyMIBCompliance=ciscoTrustSecPolicyMIBCompliance, ctspSgaclMonitorGroup=ctspSgaclMonitorGroup, ctspIfSgtRowStatus=ctspIfSgtRowStatus, ctspDownloadedSgaclName=ctspDownloadedSgaclName, ctspIpSgtMappings=ctspIpSgtMappings, ctspPeerPolicyLifeTime=ctspPeerPolicyLifeTime, ctspDefIpSwMonitorPkts=ctspDefIpSwMonitorPkts, ctspDefIpHwDropPkts=ctspDefIpHwDropPkts, ctspDownloadedDefSgtPolicyType=ctspDownloadedDefSgtPolicyType, ctspPeerPolicyEntry=ctspPeerPolicyEntry, ctspIfSgtMappingEntry=ctspIfSgtMappingEntry, ctspIfL3PolicyConfigEntry=ctspIfL3PolicyConfigEntry, ctspAllSgtPolicyAction=ctspAllSgtPolicyAction, ctspIfSgtMappingInfoTable=ctspIfSgtMappingInfoTable, ctspVlanSgtMappingEntry=ctspVlanSgtMappingEntry, ctspConfigSgaclMappingDestSgt=ctspConfigSgaclMappingDestSgt, ctspLayer3PolicyDownloaded=ctspLayer3PolicyDownloaded, ctspIfL3Ipv4PolicyEnabled=ctspIfL3Ipv4PolicyEnabled, ctspOperSgaclMonitor=ctspOperSgaclMonitor, ctspIfSgtMappingTable=ctspIfSgtMappingTable, ctspSgacl=ctspSgacl, ctspDownloadedSgaclMappingGroup=ctspDownloadedSgaclMappingGroup, ctspSgaclStatistics=ctspSgaclStatistics, ctspDefConfigIpv6SgaclsMonitor=ctspDefConfigIpv6SgaclsMonitor, ctspDownloadedIpTrafficType=ctspDownloadedIpTrafficType, ctspPeerPolicy=ctspPeerPolicy, ctspDefHwStatisticsGroup=ctspDefHwStatisticsGroup, ctspDefIpSwDropPkts=ctspDefIpSwDropPkts, ctspIpSgtMappingEntry=ctspIpSgtMappingEntry, ctspDownloadedSgaclMappingTable=ctspDownloadedSgaclMappingTable, ctspSgtCachingVlansFirst2K=ctspSgtCachingVlansFirst2K, ctspAuthorizationSgaclFailReason=ctspAuthorizationSgaclFailReason, ctspSgaclGlobals=ctspSgaclGlobals, ctspDefConfigIpv4Sgacls=ctspDefConfigIpv4Sgacls, ciscoTrustSecPolicyMIBConformance=ciscoTrustSecPolicyMIBConformance, ctspDefIpTrafficType=ctspDefIpTrafficType, ctspVlanSgtMappingIndex=ctspVlanSgtMappingIndex, ctspStatsIpHwMonitorPkts=ctspStatsIpHwMonitorPkts, ctspVlanSgtRowStatus=ctspVlanSgtRowStatus, ctspVlanSgtStorageType=ctspVlanSgtStorageType, ctspIpSgtVrfName=ctspIpSgtVrfName, ctspDownloadedSgtPolicyEntry=ctspDownloadedSgtPolicyEntry, ctspNotifGroup=ctspNotifGroup, ctspOperIpTrafficType=ctspOperIpTrafficType, ctspLayer3PolicyType=ctspLayer3PolicyType, ctspDefOperSgaclMappingEntry=ctspDefOperSgaclMappingEntry, ctspConfigSgaclMonitor=ctspConfigSgaclMonitor, ctspOperSgaclMappingGroup=ctspOperSgaclMappingGroup, ctspDefOperSgaclConfigSource=ctspDefOperSgaclConfigSource, ctspIfSgtMappings=ctspIfSgtMappings, ciscoTrustSecPolicyMIBGroups=ciscoTrustSecPolicyMIBGroups, ctspVlanConfigGroup=ctspVlanConfigGroup, ctspIpHwStatisticsGroup=ctspIpHwStatisticsGroup, ctspLayer3PolicyIpTrafficType=ctspLayer3PolicyIpTrafficType, PYSNMP_MODULE_ID=ciscoTrustSecPolicyMIB, ctspSgaclIpv6DropNetflowMonitorGroup=ctspSgaclIpv6DropNetflowMonitorGroup, ctspDefStatsEntry=ctspDefStatsEntry, ctspNotifsOnlyInfo=ctspNotifsOnlyInfo, ctspPeerPolicyAction=ctspPeerPolicyAction, ctspDownloadedSgtPolicyLifeTime=ctspDownloadedSgtPolicyLifeTime, ctspSgtStatsTable=ctspSgtStatsTable, ctspIfSgtMappingGroup=ctspIfSgtMappingGroup, ctspPeerPolicyGroup=ctspPeerPolicyGroup, ctspIfSgName=ctspIfSgName, ctspDownloadedDefSgtPolicyTable=ctspDownloadedDefSgtPolicyTable, ctspDefOperIpTrafficType=ctspDefOperIpTrafficType, ctspDownloadedSgtPolicyTable=ctspDownloadedSgtPolicyTable, ctspVlanConfigStorageType=ctspVlanConfigStorageType, ctspDefIpHwMonitorPkts=ctspDefIpHwMonitorPkts, ctspConfigSgaclMappingIpTrafficType=ctspConfigSgaclMappingIpTrafficType, ctspDownloadedSgtPolicySgtGenId=ctspDownloadedSgtPolicySgtGenId, ctspLayer3PolicyOperational=ctspLayer3PolicyOperational, ctspLayer3PolicyLocalConfig=ctspLayer3PolicyLocalConfig, ctspVlanSviActive=ctspVlanSviActive, ctspLayer3TransportGroup=ctspLayer3TransportGroup, ctspDefDownloadedSgaclMonitor=ctspDefDownloadedSgaclMonitor, ciscoTrustSecPolicyMIBNotifs=ciscoTrustSecPolicyMIBNotifs, ctspSgaclIpv6DropNetflowMonitor=ctspSgaclIpv6DropNetflowMonitor, ctspDefOperationalSgaclGenId=ctspDefOperationalSgaclGenId, ctspDefDownloadedSgaclGenId=ctspDefDownloadedSgaclGenId, ctspOperSgaclDestSgt=ctspOperSgaclDestSgt, ctspSgtCachingVlansSecond2K=ctspSgtCachingVlansSecond2K, ctspOperationalSgaclName=ctspOperationalSgaclName, ctspAuthorizationSgaclFailNotif=ctspAuthorizationSgaclFailNotif, ctspDownloadedDefSgtPolicyEntry=ctspDownloadedDefSgtPolicyEntry, ctspSgtCaching=ctspSgtCaching, ctspOperationalSgaclGenId=ctspOperationalSgaclGenId, ctspSgaclMappings=ctspSgaclMappings, ctspDownloadedSgaclIndex=ctspDownloadedSgaclIndex, ctspDefDownloadedSgaclMappingEntry=ctspDefDownloadedSgaclMappingEntry, ctspOperSgaclMappingTable=ctspOperSgaclMappingTable, ctspIpSgtMappingGroup=ctspIpSgtMappingGroup, ctspStatsIpSwDropPkts=ctspStatsIpSwDropPkts, ciscoTrustSecPolicyMIBComplianceRev2=ciscoTrustSecPolicyMIBComplianceRev2, ctspDownloadedSgtPolicyLastUpdate=ctspDownloadedSgtPolicyLastUpdate, ctspPeerPolicyLastUpdate=ctspPeerPolicyLastUpdate, ctspDownloadedDefSgtPolicyLastUpdate=ctspDownloadedDefSgtPolicyLastUpdate, ctspIpSgtValue=ctspIpSgtValue, ctspVlanConfigEntry=ctspVlanConfigEntry, ctspPeerSgt=ctspPeerSgt, ctspDefOperSgaclMappingSource=ctspDefOperSgaclMappingSource, ctspVlanConfigVrfName=ctspVlanConfigVrfName, ctspDownloadedSgaclSourceSgt=ctspDownloadedSgaclSourceSgt, ctspVlanSgtMapValue=ctspVlanSgtMapValue, ctspAuthorizationSgaclFailNotifEnable=ctspAuthorizationSgaclFailNotifEnable, ctspL3IPMStatus=ctspL3IPMStatus, ctspStatsIpHwPermitPkts=ctspStatsIpHwPermitPkts, ctspOperSgaclSourceSgt=ctspOperSgaclSourceSgt, ctspLayer3Transport=ctspLayer3Transport)
