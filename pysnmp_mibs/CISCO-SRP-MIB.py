...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-SRP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:23:03 2025
...
srpCompliance.setObjects(
      *(("CISCO-SRP-MIB", "srpIfGroup"),
        ("CISCO-SRP-MIB", "srpMACSideGroup"),
        ("CISCO-SRP-MIB", "srpRingTopologyMapGroup"),
        ("CISCO-SRP-MIB", "srpRingCountersCurrentGroup"),
        ("CISCO-SRP-MIB", "srpRingCountersIntervalGroup"),
        ("CISCO-SRP-MIB", "srpHostCountersCurrentGroup"),
        ("CISCO-SRP-MIB", "srpHostCountersIntervalGroup"),
        ("CISCO-SRP-MIB", "srpErrCntCurrGroup"),
        ("CISCO-SRP-MIB", "srpErrCntIntGroup"),
        ("CISCO-SRP-MIB", "srpNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
srpComplianceOld.setObjects(
      *(("CISCO-SRP-MIB", "srpMACCountersGroup"),
        ("CISCO-SRP-MIB", "srpErrorsCountersCurrentGroup"),
        ("CISCO-SRP-MIB", "srpErrorsCountersIntervalGroup"))
)
if mibBuilder.loadTexts:
