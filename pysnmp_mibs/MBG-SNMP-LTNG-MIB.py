...
mibBuilder.exportSymbols("MBG-SNMP-LTNG-MIB", mbgLtNgPtpAvail=mbgLtNgPtpAvail, mbgLtNgCfgNtpServerIP=mbgLtNgCfgNtpServerIP, mbgLtNgRefclockMrsInfo=mbgLtNgRefclockMrsInfo, mbgLtNgCfgTrapRefSrcLimitExceeded=mbgLtNgCfgTrapRefSrcLimitExceeded, mbgLtNgCfgTrapNetworkUp=mbgLtNgCfgTrapNetworkUp, mbgLtNgCfgEthernetDomain=mbgLtNgCfgEthernetDomain, mbgLtNgCfgPtp=mbgLtNgCfgPtp, mbgLtNgTrapCertificateExpired=mbgLtNgTrapCertificateExpired, mbgLtNgRefclockGpsTdop=mbgLtNgRefclockGpsTdop, mbgLtNgPtpTableEntry=mbgLtNgPtpTableEntry, mbgLtNgCfgPhysicalIfTable=mbgLtNgCfgPhysicalIfTable, mbgLtNgCfgNtpClientMonitoring=mbgLtNgCfgNtpClientMonitoring, mbgLtNgCfgNtpManyUseAutokey=mbgLtNgCfgNtpManyUseAutokey, mbgLtNgCfgTrapFdmError=mbgLtNgCfgTrapFdmError, mbgLtNgCfgPtpGateway=mbgLtNgCfgPtpGateway, mbgLtNgNumberOfRefclocks=mbgLtNgNumberOfRefclocks, mbgLtNgNtpMrsOffset=mbgLtNgNtpMrsOffset, mbgLtNgCfgPtpPriority1=mbgLtNgCfgPtpPriority1, mbgLtNgTrapIMSError=mbgLtNgTrapIMSError, mbgLtNgNumberOfClusters=mbgLtNgNumberOfClusters, mbgLtNgCfgSNMP=mbgLtNgCfgSNMP, mbgLtNgRefclockTable=mbgLtNgRefclockTable, mbgLtNgSysFanError=mbgLtNgSysFanError, mbgLtNgCfgSnmpRetries=mbgLtNgCfgSnmpRetries, mbgLtNgTrapFdmError=mbgLtNgTrapFdmError, mbgLtNgTrapXmrRefReconnect=mbgLtNgTrapXmrRefReconnect, mbgLtNgTrapReceiverSync=mbgLtNgTrapReceiverSync, mbgLtNgCfgPtpVlanPriority=mbgLtNgCfgPtpVlanPriority, mbgLtNgCfgEthernetIpv4Gateway=mbgLtNgCfgEthernetIpv4Gateway, mbgLtNgCfgFrontPanel=mbgLtNgCfgFrontPanel, mbgLtNgTrapAntennaShortCircuit=mbgLtNgTrapAntennaShortCircuit, mbgLtNgRefclockSubstate=mbgLtNgRefclockSubstate, mbgLtNgTrapTrustedSourceOk=mbgLtNgTrapTrustedSourceOk, mbgLtNgPtpClockAccuracy=mbgLtNgPtpClockAccuracy, mbgLtNgTrapHttpsSelfSignedCertificateInUse=mbgLtNgTrapHttpsSelfSignedCertificateInUse, mbgLtNgCfgPtpIpv6Address=mbgLtNgCfgPtpIpv6Address, mbgLtNgCfgPtpDelayReqInterval=mbgLtNgCfgPtpDelayReqInterval, mbgLtNgCfgPtpEnableVlan=mbgLtNgCfgPtpEnableVlan, mbgLtNgTrapNotifications=mbgLtNgTrapNotifications, mbgLtNgNtpVersion=mbgLtNgNtpVersion, mbgLtNgClusterMasterPriority=mbgLtNgClusterMasterPriority, mbgLtNgTrapSynceInputQualityLevelChanged=mbgLtNgTrapSynceInputQualityLevelChanged, mbgLtNgCfgVirtualIfServiceNtp=mbgLtNgCfgVirtualIfServiceNtp, mbgLtNgCfgNtpManySymKey=mbgLtNgCfgNtpManySymKey, mbgLtNgTrapSHSTimeLimitWarning=mbgLtNgTrapSHSTimeLimitWarning, mbgLtNgCfgNtpSpoofLocalTime=mbgLtNgCfgNtpSpoofLocalTime, mbgLtNgCfgSyslog=mbgLtNgCfgSyslog, mbgLtNgCfgPtpOpMode=mbgLtNgCfgPtpOpMode, mbgLtNgClusterIndex=mbgLtNgClusterIndex, mbgLtNgCfgSnmpV3AuthPassphrase=mbgLtNgCfgSnmpV3AuthPassphrase, mbgLtNgCfgPtpDelayMechanism=mbgLtNgCfgPtpDelayMechanism, mbgLtNgCfgVirtualIfServiceFpc=mbgLtNgCfgVirtualIfServiceFpc, mbgLtNgCfgPtpIpv6Avail=mbgLtNgCfgPtpIpv6Avail, mbgLtNgCfgVirtualIfClusterIpv4Addr=mbgLtNgCfgVirtualIfClusterIpv4Addr, mbgLtNgCommands=mbgLtNgCommands, mbgLtNgCfgSnmpV3UserName=mbgLtNgCfgSnmpV3UserName, mbgLtNgCfgPtpDisableSsh=mbgLtNgCfgPtpDisableSsh, mbgLtNgCfgPtpVlanId=mbgLtNgCfgPtpVlanId, mbgLtNgEthPortLinkIndex=mbgLtNgEthPortLinkIndex, mbgLtNgRefclockXmrPriority9=mbgLtNgRefclockXmrPriority9, mbgLtNgCfgPtpSyncEAvail=mbgLtNgCfgPtpSyncEAvail, mbgLtNgRefclockGpsLongitude=mbgLtNgRefclockGpsLongitude, mbgLtNgRefclockXmrPriority3=mbgLtNgRefclockXmrPriority3, mbgLtNgCfgTrapPtpError=mbgLtNgCfgTrapPtpError, mbgLtNgCfgVirtualIfServiceHttps=mbgLtNgCfgVirtualIfServiceHttps, mbgLtNgCfgSnmpV3UserRights=mbgLtNgCfgSnmpV3UserRights, mbgLtNgCfgTrapPtpStateChanged=mbgLtNgCfgTrapPtpStateChanged, mbgLtNgCfgNtpEnableClientCounterDuration=mbgLtNgCfgNtpEnableClientCounterDuration, mbgLtNgRefclockXmrPriority4=mbgLtNgRefclockXmrPriority4, mbgLtNgCfgEmailTo=mbgLtNgCfgEmailTo, mbgLtNgRefclockGpsIndex=mbgLtNgRefclockGpsIndex, mbgLtNgCfgTrapPowerSupplyDown=mbgLtNgCfgTrapPowerSupplyDown, mbgLtNgCfgVirtualIfIpv6RoutAdd=mbgLtNgCfgVirtualIfIpv6RoutAdd, mbgLtNgCfgTrapNotWarmedUp=mbgLtNgCfgTrapNotWarmedUp, mbgLtNgTrapNTPStopped=mbgLtNgTrapNTPStopped, mbgLtNgCfgEmail=mbgLtNgCfgEmail, mbgLtNgRefclockXmrPriority1=mbgLtNgRefclockXmrPriority1, mbgLtNgTrapLeapSecondAnnounced=mbgLtNgTrapLeapSecondAnnounced, mbgLtNgCfgVirtualIfServiceSsh=mbgLtNgCfgVirtualIfServiceSsh, mbgLtNgCfgVirtualIfServiceHttp=mbgLtNgCfgVirtualIfServiceHttp, mbgLtNgCfgSnmpTrapRecCommunity=mbgLtNgCfgSnmpTrapRecCommunity, mbgLtNgCfgNtp=mbgLtNgCfgNtp, mbgLtNgCfgPtpMessageDuration=mbgLtNgCfgPtpMessageDuration, mbgLtNgCfgPtpMode=mbgLtNgCfgPtpMode, mbgLtNgSysPowerSupply=mbgLtNgSysPowerSupply, mbgLtNgCfgLoginAccess=mbgLtNgCfgLoginAccess, mbgLtNgTrapPowerSupplyUp=mbgLtNgTrapPowerSupplyUp, mbgLtNgCfgVirtualIfServiceDaytime=mbgLtNgCfgVirtualIfServiceDaytime, mbgLtNgClusterPortState=mbgLtNgClusterPortState, mbgLtNgTrapSHSTimeLimitOk=mbgLtNgTrapSHSTimeLimitOk, mbgLtNgCfgVirtualIfVlanPrio=mbgLtNgCfgVirtualIfVlanPrio, mbgLtNgSysFanTableEntry=mbgLtNgSysFanTableEntry, mbgLtNgCfgNumberOfPhysicalIf=mbgLtNgCfgNumberOfPhysicalIf, mbgLtNgCfgSnmpLocation=mbgLtNgCfgSnmpLocation, mbgLtNgCfgPtpIndex=mbgLtNgCfgPtpIndex, mbgLtNgCfgRepetitions=mbgLtNgCfgRepetitions, mbgLtNgCfgPtpIpv6Mode=mbgLtNgCfgPtpIpv6Mode, mbgLtNgTrapSufficientSystemResources=mbgLtNgTrapSufficientSystemResources, mbgLtNgCfgPtpNetworkProtocol=mbgLtNgCfgPtpNetworkProtocol, mbgLtNgRefclockMrsTableEntry=mbgLtNgRefclockMrsTableEntry, mbgLtNgCfgActivateChangesAsStartup=mbgLtNgCfgActivateChangesAsStartup, mbgLtNgCfgPtpHybridMode=mbgLtNgCfgPtpHybridMode, mbgLtNgCfgSnmpTrapRecAddr=mbgLtNgCfgSnmpTrapRecAddr, mbgLtNgNtpCCTotalRequests=mbgLtNgNtpCCTotalRequests, mbgLtNgPtpDelayAsymmetry=mbgLtNgPtpDelayAsymmetry, mbgLtNgCfgNtpMaxClientOffset=mbgLtNgCfgNtpMaxClientOffset, mbgLtNgCfgNtpServerKey=mbgLtNgCfgNtpServerKey, mbgLtNgNtpCCTotalRequestsLastHour=mbgLtNgNtpCCTotalRequestsLastHour, mbgLtNgClusterClockClass=mbgLtNgClusterClockClass, mbgLtNgSerialNumber=mbgLtNgSerialNumber, mbgLtNgTrapNTPNotSync=mbgLtNgTrapNTPNotSync, mbgLtNgInfo=mbgLtNgInfo, mbgLtNgCfgSyslogLoglevel=mbgLtNgCfgSyslogLoglevel, mbgLtNgCfgEthernetNameserver1=mbgLtNgCfgEthernetNameserver1, mbgLtNgCfgSnmpTrapRecIndex=mbgLtNgCfgSnmpTrapRecIndex, mbgLtNgRefclockXmrPriority7=mbgLtNgRefclockXmrPriority7, mbgLtNgFdmNomFreq=mbgLtNgFdmNomFreq, mbgLtNgCfgSshShellTimeout=mbgLtNgCfgSshShellTimeout, mbgLtNgClusterTableEntry=mbgLtNgClusterTableEntry, mbgLtNgCfgVirtualIfVlanTag=mbgLtNgCfgVirtualIfVlanTag, mbgLtNgPtpUtcOffset=mbgLtNgPtpUtcOffset, mbgLtNgFdm=mbgLtNgFdm, mbgLtNgEthPortLinkTable=mbgLtNgEthPortLinkTable, mbgLtNgRefclockIndex=mbgLtNgRefclockIndex, mbgLtNgCfgPtpSyncEInputSsm=mbgLtNgCfgPtpSyncEInputSsm, mbgLtNgTrapXmrLimitExceeded=mbgLtNgTrapXmrLimitExceeded, mbgLtNgClusterMasterSerial=mbgLtNgClusterMasterSerial, mbgLtNgNtpRefclockName=mbgLtNgNtpRefclockName, mbgLtNgTrapNTPSync=mbgLtNgTrapNTPSync, mbgLtNgPtpPortState=mbgLtNgPtpPortState, mbgLtNgObjectsGroup=mbgLtNgObjectsGroup, mbgLtNgCfgSnmpV3AuthProtocol=mbgLtNgCfgSnmpV3AuthProtocol, mbgLtNgTrapOscillatorNotWarmedUp=mbgLtNgTrapOscillatorNotWarmedUp, mbgLtNgCfgSnmpTrapRecVersion=mbgLtNgCfgSnmpTrapRecVersion, mbgLtNgSysNumberOfFans=mbgLtNgSysNumberOfFans, mbgLtNgCfgEthernetGenClusterIp=mbgLtNgCfgEthernetGenClusterIp, mbgLtNgCfgSnmpV3PrivPassphrase=mbgLtNgCfgSnmpV3PrivPassphrase, mbgLtNgCfgSnmpV3SecurityLevel=mbgLtNgCfgSnmpV3SecurityLevel, mbgLtNgCfgNtpMaxClientStratum=mbgLtNgCfgNtpMaxClientStratum, mbgLtNgRefclockGpsPos=mbgLtNgRefclockGpsPos, mbgLtNgTrapEsiItuLimitsViolated=mbgLtNgTrapEsiItuLimitsViolated, mbgLtNgCfgVirtualIfLabel=mbgLtNgCfgVirtualIfLabel, mbgLtNgCfgVirtualIfIpv4DnsFromDhcp=mbgLtNgCfgVirtualIfIpv4DnsFromDhcp, mbgLtNgPtpPortLinkup=mbgLtNgPtpPortLinkup, mbgLtNgPtpClockClass=mbgLtNgPtpClockClass, mbgLtNgCfgNtpMultiAddr=mbgLtNgCfgNtpMultiAddr, mbgLtNgSysTemperature=mbgLtNgSysTemperature, mbgLtNgFdmFreqDev=mbgLtNgFdmFreqDev, mbgLtNgCfgNtpServerMinpoll=mbgLtNgCfgNtpServerMinpoll, mbgLtNgRefclockLeapSecondDate=mbgLtNgRefclockLeapSecondDate, mbgLtNgCfgWebLanguage=mbgLtNgCfgWebLanguage, mbgLtNgCfgPtpOutput2=mbgLtNgCfgPtpOutput2, mbgLtNgRefclockMaxStatusA=mbgLtNgRefclockMaxStatusA, mbgLtNgSysFanTable=mbgLtNgSysFanTable, mbgLtNgFdmFreq=mbgLtNgFdmFreq, mbgLtNgCfgTrapPtpNetworkUp=mbgLtNgCfgTrapPtpNetworkUp, mbgLtNgPtpNumberOfModules=mbgLtNgPtpNumberOfModules, mbgLtNgCfgVirtualIfServiceFtp=mbgLtNgCfgVirtualIfServiceFtp, mbgLtNgNtpMrs=mbgLtNgNtpMrs, mbgLtNgCfgTrapRefclockSynchronized=mbgLtNgCfgTrapRefclockSynchronized, mbgLtNgPtpIndex=mbgLtNgPtpIndex, mbgLtNgCfgPtpHostname=mbgLtNgCfgPtpHostname, mbgLtNgCfgVirtualIfClusterPrio=mbgLtNgCfgVirtualIfClusterPrio, mbgLtNgCfgTrapNtpNotSync=mbgLtNgCfgTrapNtpNotSync, mbgLtNgCfgVirtualIfIpv4Netmask=mbgLtNgCfgVirtualIfIpv4Netmask, mbgLtNgCfgPtpUcastMstAddr=mbgLtNgCfgPtpUcastMstAddr, mbgLtNgCfgWmailAddress2=mbgLtNgCfgWmailAddress2, mbgLtNgNtp=mbgLtNgNtp, mbgLtNgCfgEmailFrom=mbgLtNgCfgEmailFrom, mbgLtNgTrapPtpError=mbgLtNgTrapPtpError, mbgLtNgSysNumberOfPowerSupplies=mbgLtNgSysNumberOfPowerSupplies, mbgLtNgClusterReconfigurationState=mbgLtNgClusterReconfigurationState, mbgLtNgTrapNetworkDown=mbgLtNgTrapNetworkDown, mbgLtNgCfgPtpSyncInterval=mbgLtNgCfgPtpSyncInterval, PYSNMP_MODULE_ID=mbgLantimeNG, mbgLtNgCfgTrapTrigger=mbgLtNgCfgTrapTrigger, mbgLtNgCfgVirtualIfIpv4GatewayFromDhcp=mbgLtNgCfgVirtualIfIpv4GatewayFromDhcp, mbgLtNgTrapOscillatorWarmedUp=mbgLtNgTrapOscillatorWarmedUp, mbgLtNgRefclockAdditionalInfo=mbgLtNgRefclockAdditionalInfo, mbgLtNgTrapTrustedSourceError=mbgLtNgTrapTrustedSourceError, mbgLtNgRefclockGpsUtcOffset=mbgLtNgRefclockGpsUtcOffset, mbgLtNgTrapLowSystemResources=mbgLtNgTrapLowSystemResources, mbgLtNgTrapSHSTimeLimitError=mbgLtNgTrapSHSTimeLimitError, mbgLtNgSystemHardware=mbgLtNgSystemHardware, mbgLtNgCfgVirtualIfVlan=mbgLtNgCfgVirtualIfVlan, mbgLtNgCfgPtpDscpClass=mbgLtNgCfgPtpDscpClass, mbgLtNgCfgNtpLocalClkStratum=mbgLtNgCfgNtpLocalClkStratum, mbgLtNgTrapPtpStateChanged=mbgLtNgTrapPtpStateChanged, mbgLtNgCfgNtpTable=mbgLtNgCfgNtpTable, mbgLtNgTrapReceiverNotSync=mbgLtNgTrapReceiverNotSync, mbgLtNgTrapNetworkUp=mbgLtNgTrapNetworkUp, mbgLtNgCfgVirtualIfIpv6Dhcp=mbgLtNgCfgVirtualIfIpv6Dhcp, mbgLtNgNtpClientCounter=mbgLtNgNtpClientCounter, mbgLtNgCfgDisableRootLogin=mbgLtNgCfgDisableRootLogin, mbgLtNgNtpMrsServer=mbgLtNgNtpMrsServer, mbgLtNgCfgPhysicalIfIndex=mbgLtNgCfgPhysicalIfIndex, mbgLtNgSnmpSubagentVersion=mbgLtNgSnmpSubagentVersion, mbgLtNgTrapXheRubOk=mbgLtNgTrapXheRubOk, mbgLtNgRefclockXmrPriority10=mbgLtNgRefclockXmrPriority10, mbgLtNgCfgEthernetHostname=mbgLtNgCfgEthernetHostname, mbgLtNgCfgVirtualIfServiceSnmp=mbgLtNgCfgVirtualIfServiceSnmp, mbgLtNgCfgRepeatEvent=mbgLtNgCfgRepeatEvent, mbgLtNgCfgNtpIndex=mbgLtNgCfgNtpIndex, mbgLtNgCfgSshKeyLength=mbgLtNgCfgSshKeyLength, mbgLtNgCfgTrapWarmedUp=mbgLtNgCfgTrapWarmedUp, mbgLtNgCfgVP100Display1SN=mbgLtNgCfgVP100Display1SN, mbgLtNgCfgSystem=mbgLtNgCfgSystem, mbgLtNgNtpStratum=mbgLtNgNtpStratum, mbgLtNgCfgNtpTableEntry=mbgLtNgCfgNtpTableEntry, mbgLtNgTrapMrsSourceOk=mbgLtNgTrapMrsSourceOk, mbgLtNgCfgVirtualIfIpv4AddrFromDhcp=mbgLtNgCfgVirtualIfIpv4AddrFromDhcp, mbgLtNgCfgTrapNormalOperation=mbgLtNgCfgTrapNormalOperation, mbgLtNgCfgPhysicalIfIpv6Mode=mbgLtNgCfgPhysicalIfIpv6Mode, mbgLtNgCfgVP100Display2Addr=mbgLtNgCfgVP100Display2Addr, mbgLtNgTraps=mbgLtNgTraps, mbgLtNgCfgSnmpV3Context=mbgLtNgCfgSnmpV3Context, mbgLtNgCfgTrapAntennaFaulty=mbgLtNgCfgTrapAntennaFaulty, mbgLtNgPtpTimeSource=mbgLtNgPtpTimeSource, mbgLtNgCfgPtpIpv4=mbgLtNgCfgPtpIpv4, mbgLtNgCfgPtpDomainNumber=mbgLtNgCfgPtpDomainNumber, mbgLtNgTrapNTPOffsetLimitOk=mbgLtNgTrapNTPOffsetLimitOk, mbgLtNgCfgWinpopup=mbgLtNgCfgWinpopup, mbgLtNgCfgPhysicalIfIndicateLink=mbgLtNgCfgPhysicalIfIndicateLink, mbgLtNgCfgPtpTable=mbgLtNgCfgPtpTable, mbgLtNgMisc=mbgLtNgMisc, mbgLtNgConfig=mbgLtNgConfig, mbgLtNgTrapClusterFalsetickerCleared=mbgLtNgTrapClusterFalsetickerCleared, mbgLtNgCfgPhysicalIfBondingGroup=mbgLtNgCfgPhysicalIfBondingGroup, mbgLtNgPtpOffsetFromGM=mbgLtNgPtpOffsetFromGM, mbgLtNgTrapPowerConsumptionOk=mbgLtNgTrapPowerConsumptionOk, mbgLtNgPtpPathDelay=mbgLtNgPtpPathDelay, mbgLtNgClusterTable=mbgLtNgClusterTable, mbgLtNgTrapAntennaFaulty=mbgLtNgTrapAntennaFaulty, mbgLtNgCfgNtpBroadInterval=mbgLtNgCfgNtpBroadInterval, mbgLtNgCfgVirtualIfIpv4Addr=mbgLtNgCfgVirtualIfIpv4Addr, mbgLtNgCfgEmailSmarthostAuthUser=mbgLtNgCfgEmailSmarthostAuthUser, mbgLtNgPtpTimeSeconds=mbgLtNgPtpTimeSeconds, mbgLtNgCfgNtpLocalTrustedKeys=mbgLtNgCfgNtpLocalTrustedKeys, mbgLtNgGroups=mbgLtNgGroups, mbgLtNgCfgNtpMultiUseAutokey=mbgLtNgCfgNtpMultiUseAutokey, mbgLtNgCfgEmailSmarthostAuthPw=mbgLtNgCfgEmailSmarthostAuthPw, mbgLtNgNtpCCTotalRequestsCurrentDay=mbgLtNgNtpCCTotalRequestsCurrentDay, mbgLtNgTrapsGroup=mbgLtNgTrapsGroup, mbgLtNgCfgNtpBroadAddr=mbgLtNgCfgNtpBroadAddr, mbgLtNgCfgNtpEnableManycast=mbgLtNgCfgNtpEnableManycast, mbgLtNgCfgSecurity=mbgLtNgCfgSecurity, mbgLtNgCompliance=mbgLtNgCompliance, mbgLtNgCfgTrapNtpSync=mbgLtNgCfgTrapNtpSync, mbgLtNgCfgPtpSyncEEnabled=mbgLtNgCfgPtpSyncEEnabled, mbgLtNgTrapImsPortError=mbgLtNgTrapImsPortError, mbgLtNgNtpRefclockOffset=mbgLtNgNtpRefclockOffset, mbgLtNgCfgTrapServerBoot=mbgLtNgCfgTrapServerBoot, mbgLtNgCfgLockFrontPanel=mbgLtNgCfgLockFrontPanel, mbgLtNgCfgPtpSyncEOutputSsm=mbgLtNgCfgPtpSyncEOutputSsm)
mibBuilder.exportSymbols("MBG-SNMP-LTNG-MIB", mbgLtNgTrapNormalOperation=mbgLtNgTrapNormalOperation, mbgLtNgCfgVirtualIfServiceTime=mbgLtNgCfgVirtualIfServiceTime, mbgLtNgTrapImsPortOk=mbgLtNgTrapImsPortOk, mbgLtNgCfgVP100Display1Addr=mbgLtNgCfgVP100Display1Addr, mbgLtNgRefclockXmrSyncTo=mbgLtNgRefclockXmrSyncTo, mbgLtNgCfgDisplay=mbgLtNgCfgDisplay, mbgLtNgRefclockGpsTableEntry=mbgLtNgRefclockGpsTableEntry, mbgLtNgCfgTrapSecRefclockSynchronized=mbgLtNgCfgTrapSecRefclockSynchronized, mbgLtNgCmdSetTime=mbgLtNgCmdSetTime, mbgLtNgCfgPtpNameserver1=mbgLtNgCfgPtpNameserver1, mbgLtNgCfgSnmpWriteCommunity=mbgLtNgCfgSnmpWriteCommunity, mbgLtNgCfgNtpBMIndex=mbgLtNgCfgNtpBMIndex, mbgLtNgRefclockGpsLatitude=mbgLtNgRefclockGpsLatitude, mbgLtNgTrapConfigChanged=mbgLtNgTrapConfigChanged, mbgLtNgCfgNtpMultiInterval=mbgLtNgCfgNtpMultiInterval, mbgLtNgCfgVirtualIfCluster=mbgLtNgCfgVirtualIfCluster, mbgLtNgNtpCCDuration=mbgLtNgNtpCCDuration, mbgLtNgTrapClusterFalsetickerDetected=mbgLtNgTrapClusterFalsetickerDetected, mbgLtNgCfgNtpServerIburst=mbgLtNgCfgNtpServerIburst, mbgLtNgTrapFailLockUserBanned=mbgLtNgTrapFailLockUserBanned, mbgLtNgTrapSecondaryRecNotSync=mbgLtNgTrapSecondaryRecNotSync, mbgLtNgCfgTrapRefSrcReconnected=mbgLtNgCfgTrapRefSrcReconnected, mbgLtNgCfgVirtualIfMac=mbgLtNgCfgVirtualIfMac, mbgLtNgSysPsStatus=mbgLtNgSysPsStatus, mbgLtNgTrapFanDown=mbgLtNgTrapFanDown, mbgLtNgCfgNtpBMTableEntry=mbgLtNgCfgNtpBMTableEntry, mbgLtNgRefclockState=mbgLtNgRefclockState, mbgLtNgCfgPtpSyncEGbitCopperMode=mbgLtNgCfgPtpSyncEGbitCopperMode, mbgLtNgTrapPowerSupplyFailure=mbgLtNgTrapPowerSupplyFailure, mbgLtNgCfgNtpBMTable=mbgLtNgCfgNtpBMTable, mbgLtNgPtpTable=mbgLtNgPtpTable, mbgLtNgConformance=mbgLtNgConformance, mbgLtNgRefclockTimeDiff=mbgLtNgRefclockTimeDiff, mbgLtNgCfgTrapShsTimeLimitWarning=mbgLtNgCfgTrapShsTimeLimitWarning, mbgLtNgFirmwareVersion=mbgLtNgFirmwareVersion, mbgLtNgRefclockStatusA=mbgLtNgRefclockStatusA, mbgLtNgSysPsIndex=mbgLtNgSysPsIndex, mbgLtNgCfgTrapNetworkDown=mbgLtNgCfgTrapNetworkDown, mbgLtNgSysFanStatus=mbgLtNgSysFanStatus, mbgLtNgCfgVirtualIfIpv4NetmaskFromDhcp=mbgLtNgCfgVirtualIfIpv4NetmaskFromDhcp, mbgLtNgPtpLocalMac=mbgLtNgPtpLocalMac, mbgLtNgCfgEthernetNameserver2=mbgLtNgCfgEthernetNameserver2, mbgLtNgCfgPtpDisableMgmtMsgs=mbgLtNgCfgPtpDisableMgmtMsgs, mbgLtNgCfgSsh=mbgLtNgCfgSsh, mbgLtNgCfgVirtualIfIpv6Addr=mbgLtNgCfgVirtualIfIpv6Addr, mbgLtNgCfgVP100Display2SN=mbgLtNgCfgVP100Display2SN, mbgLtNgCfgEmailSmarthostAddr=mbgLtNgCfgEmailSmarthostAddr, mbgLtNgNtpCCTodaysClients=mbgLtNgNtpCCTodaysClients, mbgLtNgTrapTestNotification=mbgLtNgTrapTestNotification, mbgLtNgCfgVirtualIfIndex=mbgLtNgCfgVirtualIfIndex, mbgLtNgCfgNtpManyAddr=mbgLtNgCfgNtpManyAddr, mbgLtNgCfgSnmpEnabledVersion=mbgLtNgCfgSnmpEnabledVersion, mbgLtNgTrapAntennaReconnect=mbgLtNgTrapAntennaReconnect, mbgLtNgSubagentTimeticks=mbgLtNgSubagentTimeticks, mbgLtNgRefclockXmrPriority6=mbgLtNgRefclockXmrPriority6, mbgLtNgCfgPtpSyncEQltLvlSelEnable=mbgLtNgCfgPtpSyncEQltLvlSelEnable, mbgLtNgRefclockTableEntry=mbgLtNgRefclockTableEntry, mbgLtNgTrapReceiverNotResponding=mbgLtNgTrapReceiverNotResponding, mbgLtNgCfgPtpMiscEnable1Step=mbgLtNgCfgPtpMiscEnable1Step, mbgLtNgCfgSnmpTrapRecTable=mbgLtNgCfgSnmpTrapRecTable, mbgLtNgCfgPtpSyncESdhNwOption=mbgLtNgCfgPtpSyncESdhNwOption, mbgLtNgCfgEmailSmarthostPort=mbgLtNgCfgEmailSmarthostPort, mbgLtNgCfgTrapFanDown=mbgLtNgCfgTrapFanDown, mbgLtNgCfgTrapLowSystemResources=mbgLtNgCfgTrapLowSystemResources, mbgLtNgCfgTrapLeapSecAnnounced=mbgLtNgCfgTrapLeapSecAnnounced, mbgLtNgTrapPowerRedundancyNotAvail=mbgLtNgTrapPowerRedundancyNotAvail, mbgLtNgEthPortLinkState=mbgLtNgEthPortLinkState, mbgLtNgTrapXmrRefChanged=mbgLtNgTrapXmrRefChanged, mbgLtNgCfgWmailAddress1=mbgLtNgCfgWmailAddress1, mbgLtNgTrapPowerRedundancyAvail=mbgLtNgTrapPowerRedundancyAvail, mbgLtNgCfgTrapRefSrcDisconnected=mbgLtNgCfgTrapRefSrcDisconnected, mbgLtNgCfgEthernetIpv6Gateway=mbgLtNgCfgEthernetIpv6Gateway, mbgLtNgNtpCCStartedAt=mbgLtNgNtpCCStartedAt, mbgLtNgClusterIsFalseticker=mbgLtNgClusterIsFalseticker, mbgLtNgSysTempCelsius=mbgLtNgSysTempCelsius, mbgLtNgCfgSnmpTrapRecTableEntry=mbgLtNgCfgSnmpTrapRecTableEntry, mbgLtNgRefclockGpsTable=mbgLtNgRefclockGpsTable, mbgLtNgCfgPhysicalIfTableEntry=mbgLtNgCfgPhysicalIfTableEntry, mbgLtNgCfgNotifications=mbgLtNgCfgNotifications, mbgLtNgRefclockGpsAltitude=mbgLtNgRefclockGpsAltitude, mbgLtNgCfgTrapRefclockNotResponding=mbgLtNgCfgTrapRefclockNotResponding, mbgLtNgRefclockStatusB=mbgLtNgRefclockStatusB, mbgLtNgCfgWalldisplay=mbgLtNgCfgWalldisplay, mbgLtNgTrapClusterMasterChanged=mbgLtNgTrapClusterMasterChanged, mbgLtNgCfgPtpProfile=mbgLtNgCfgPtpProfile, mbgLtNgCfgTrapShsTimeLimitError=mbgLtNgCfgTrapShsTimeLimitError, mbgLtNgRefclock=mbgLtNgRefclock, mbgLtNgTrapMrsSourceInvalid=mbgLtNgTrapMrsSourceInvalid, mbgLtNgCfgVirtualIfIpv4Dhcp=mbgLtNgCfgVirtualIfIpv4Dhcp, mbgLtNgCfgEmailSmarthostAuth=mbgLtNgCfgEmailSmarthostAuth, mbgLtNgRefclockUsage=mbgLtNgRefclockUsage, mbgLtNgCfgTrapNtpStopped=mbgLtNgCfgTrapNtpStopped, mbgLtNgCfgTrapAntennaReconnect=mbgLtNgCfgTrapAntennaReconnect, mbgLtNgCfgTrapSecRefclockNotResponding=mbgLtNgCfgTrapSecRefclockNotResponding, mbgLtNgPtp=mbgLtNgPtp, mbgLtNgTrapHeartbeat=mbgLtNgTrapHeartbeat, mbgLtNgCfgPtpAnnounceInterval=mbgLtNgCfgPtpAnnounceInterval, mbgLtNgCfgTrapPowerSupplyUp=mbgLtNgCfgTrapPowerSupplyUp, mbgLtNgTrapXheRubError=mbgLtNgTrapXheRubError, mbgLtNgPtpGrandmasterUuid=mbgLtNgPtpGrandmasterUuid, mbgLtNgCfgNtpServerMaxpoll=mbgLtNgCfgNtpServerMaxpoll, mbgLtNgNtpCCNumberOfClients=mbgLtNgNtpCCNumberOfClients, mbgLtNgTrapPtpPortConnected=mbgLtNgTrapPtpPortConnected, mbgLtNgCfgSnmpV3PrivProtocol=mbgLtNgCfgSnmpV3PrivProtocol, mbgLtNgNtpCurrentState=mbgLtNgNtpCurrentState, mbgLtNgRefclockXmrPriority8=mbgLtNgRefclockXmrPriority8, mbgLtNgTrapNTPClientAlarm=mbgLtNgTrapNTPClientAlarm, mbgLtNgCfgNtpMultiSymKey=mbgLtNgCfgNtpMultiSymKey, mbgLtNgCfgTrapNtpClientLimitExceeded=mbgLtNgCfgTrapNtpClientLimitExceeded, mbgLtNgCompliances=mbgLtNgCompliances, mbgLtNgCfgPtpIpv6McastScope=mbgLtNgCfgPtpIpv6McastScope, mbgLtNgCfgPhysicalIfNetLinkMode=mbgLtNgCfgPhysicalIfNetLinkMode, mbgLtNgCfgTrapRefclockNotSynchronized=mbgLtNgCfgTrapRefclockNotSynchronized, mbgLtNgCfgDisableUsbPort=mbgLtNgCfgDisableUsbPort, mbgLtNgCmdExecute=mbgLtNgCmdExecute, mbgLtNgCfgSnmpReadCommunity=mbgLtNgCfgSnmpReadCommunity, mbgLtNgCfgSnmpTimeout=mbgLtNgCfgSnmpTimeout, mbgLtNgCfgGeneral=mbgLtNgCfgGeneral, mbgLtNgCfgPtpNetmask=mbgLtNgCfgPtpNetmask, mbgLtNgClusterMasterIp=mbgLtNgClusterMasterIp, mbgLtNgCfgEthernet=mbgLtNgCfgEthernet, mbgLtNgCfgPtpTableEntry=mbgLtNgCfgPtpTableEntry, mbgLtNgRefclockXmrPriority2=mbgLtNgRefclockXmrPriority2, mbgLtNgCfgPtpTimescale=mbgLtNgCfgPtpTimescale, mbgLtNgSysPsTable=mbgLtNgSysPsTable, mbgLtNgCpuSerialNumber=mbgLtNgCpuSerialNumber, mbgLantimeNG=mbgLantimeNG, mbgLtNgCfgNtpTimeScale=mbgLtNgCfgNtpTimeScale, mbgLtNgCfgSnmpContact=mbgLtNgCfgSnmpContact, mbgLtNgClusterCommunicationIp=mbgLtNgClusterCommunicationIp, mbgLtNgCfgTrapAntennaShortCircuit=mbgLtNgCfgTrapAntennaShortCircuit, mbgLtNgTrapIMSOk=mbgLtNgTrapIMSOk, mbgLtNgTrapPowerConsumptionExceeded=mbgLtNgTrapPowerConsumptionExceeded, mbgLtNgPtpDelayMec=mbgLtNgPtpDelayMec, mbgLtNgSysFanIndex=mbgLtNgSysFanIndex, mbgLtNgCfgVirtualIfIpv4BroadcastFromDhcp=mbgLtNgCfgVirtualIfIpv4BroadcastFromDhcp, mbgLtNgCfgNtpEnableMulticast=mbgLtNgCfgNtpEnableMulticast, mbgLtNgCfgTrapSecRefclockNotSynchronized=mbgLtNgCfgTrapSecRefclockNotSynchronized, mbgLtNgTrapEsiItuLimitsadhered=mbgLtNgTrapEsiItuLimitsadhered, mbgLtNgSysFan=mbgLtNgSysFan, mbgLtNgTrapFDMOk=mbgLtNgTrapFDMOk, mbgLtNgCfgPtpMcastTtl=mbgLtNgCfgPtpMcastTtl, mbgLtNgTrapXmrRefDisconnect=mbgLtNgTrapXmrRefDisconnect, mbgLtNgCfgNtpBroadUseAutokey=mbgLtNgCfgNtpBroadUseAutokey, mbgLtNgTrapServerBoot=mbgLtNgTrapServerBoot, mbgLtNgCfgNumberOfVirtualIf=mbgLtNgCfgNumberOfVirtualIf, mbgLtNgCfgVirtualIfServiceTelnet=mbgLtNgCfgVirtualIfServiceTelnet, mbgLtNgCfgNtpBroadSymKey=mbgLtNgCfgNtpBroadSymKey, mbgLtNgCfgPtpDomainname=mbgLtNgCfgPtpDomainname, mbgLtNgCfgAllowNetworkDiscovery=mbgLtNgCfgAllowNetworkDiscovery, mbgLtNgCfgVirtualIfIpv4DomainFromDhcp=mbgLtNgCfgVirtualIfIpv4DomainFromDhcp, mbgLtNgCfgNtpTrusttime=mbgLtNgCfgNtpTrusttime, mbgLtNgCfgEthernetGenClusterPort=mbgLtNgCfgEthernetGenClusterPort, mbgLtNgCfgPtpAnnRcptTmout=mbgLtNgCfgPtpAnnRcptTmout, mbgLtNgCfgEnableFrontPanelLight=mbgLtNgCfgEnableFrontPanelLight, mbgLtNgCfgTrapConfigChanged=mbgLtNgCfgTrapConfigChanged, mbgLtNgTrapPtpPortDisconnected=mbgLtNgTrapPtpPortDisconnected, mbgLtNgTrapNTPOffsetLimitExceeded=mbgLtNgTrapNTPOffsetLimitExceeded, mbgLtNgSysPsTableEntry=mbgLtNgSysPsTableEntry, mbgLtNgCluster=mbgLtNgCluster, mbgLtNgPtpGrandmasterMac=mbgLtNgPtpGrandmasterMac, mbgLtNgRefclockXmrPriority5=mbgLtNgRefclockXmrPriority5, mbgLtNgCfgNtpServerAutokey=mbgLtNgCfgNtpServerAutokey, mbgLtNgTrapMessage=mbgLtNgTrapMessage, mbgLtNgCfgVirtualIfTable=mbgLtNgCfgVirtualIfTable, mbgLtNgPtpTsuTime=mbgLtNgPtpTsuTime, mbgLtNgPtpDomain=mbgLtNgPtpDomain, mbgLtNgCfgPhysicalIfMac=mbgLtNgCfgPhysicalIfMac, mbgLtNgCfgPtpPriority2=mbgLtNgCfgPtpPriority2, mbgLtNgCfgPtpEnableDhcp=mbgLtNgCfgPtpEnableDhcp, mbgLtNgTrapSecondaryRecNotResp=mbgLtNgTrapSecondaryRecNotResp, mbgLtNgCfgPtpOutput1=mbgLtNgCfgPtpOutput1, mbgLtNgPtpMode=mbgLtNgPtpMode, mbgLtNgNtpCCTotalRequestsLastMinute=mbgLtNgNtpCCTotalRequestsLastMinute, mbgLtNgRefclockMaxStatusB=mbgLtNgRefclockMaxStatusB, mbgLtNgCfgNtpDisableLocalClk=mbgLtNgCfgNtpDisableLocalClk, mbgLtNgClusterClockStatus=mbgLtNgClusterClockStatus, mbgLtNgRefclockType=mbgLtNgRefclockType, mbgLtNgRefclockGpsPdop=mbgLtNgRefclockGpsPdop, mbgLtNgTrapSecondaryRecSync=mbgLtNgTrapSecondaryRecSync, mbgLantimeNGStatus=mbgLantimeNGStatus, mbgLtNgCfgVirtualIfClusterIpv4Netmask=mbgLtNgCfgVirtualIfClusterIpv4Netmask, mbgLtNgCfgSyslogServerAddr=mbgLtNgCfgSyslogServerAddr, mbgLtNgCfgNtpEnableClientCounter=mbgLtNgCfgNtpEnableClientCounter, mbgLtNgCfgVirtualIfAssigned=mbgLtNgCfgVirtualIfAssigned, mbgLtNgCfgTrapPtpNetworkDown=mbgLtNgCfgTrapPtpNetworkDown, mbgLtNgTrapFanUp=mbgLtNgTrapFanUp, mbgLtNgCfgTrapFanUp=mbgLtNgCfgTrapFanUp, mbgLtNgCfgVirtualIfTableEntry=mbgLtNgCfgVirtualIfTableEntry, mbgLtNgPtpSysTime=mbgLtNgPtpSysTime, mbgLtNgCfgVirtualIfIpv6LinkLocal=mbgLtNgCfgVirtualIfIpv6LinkLocal, mbgLtNgEthPortLinkTableEntry=mbgLtNgEthPortLinkTableEntry, mbgLtNgCfgPtpNameserver2=mbgLtNgCfgPtpNameserver2)
