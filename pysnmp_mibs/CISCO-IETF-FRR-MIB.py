...
MplsTunnelAffinity, MplsLsrIdentifier, MplsTunnelInstanceIndex, MplsTunnelIndex, MplsBitRate = mibBuilder.importSymbols("MPLS-TC-STD-MIB", "MplsTunnelAffinity", "MplsLsrIdentifier", "MplsTunnelInstanceIndex", "MplsTunnelIndex", "MplsBitRate")
...
mibBuilder.exportSymbols("CISCO-IETF-FRR-MIB", cmplsFrrDetourIncoming=cmplsFrrDetourIncoming, cmplsFrr1to1Objects=cmplsFrr1to1Objects, cmplsFrrConformance=cmplsFrrConformance, cmplsFrrFacRouteProtectedTunIndex=cmplsFrrFacRouteProtectedTunIndex, cmplsFrrDetourOriginating=cmplsFrrDetourOriginating, cmplsFrrActProtectedLSPs=cmplsFrrActProtectedLSPs, cmplsFrrLogEventDuration=cmplsFrrLogEventDuration, cmplsFrrFacRouteProtectedTunIngressLSRId=cmplsFrrFacRouteProtectedTunIngressLSRId, cmplsFrrFacRouteProtectedTunStatus=cmplsFrrFacRouteProtectedTunStatus, cmplsFrrNotifGroup=cmplsFrrNotifGroup, cmplsFrrConfProtectingTuns=cmplsFrrConfProtectingTuns, cmplsFrrLogIndex=cmplsFrrLogIndex, cmplsFrrFacRouteProtectingTunProtectionType=cmplsFrrFacRouteProtectingTunProtectionType, cmplsFrrConstHoldingPrio=cmplsFrrConstHoldingPrio, cmplsFrrSwitchover=cmplsFrrSwitchover, cmplsFrrActProtectedTuns=cmplsFrrActProtectedTuns, cmplsFrrNotif=cmplsFrrNotif, MplsFrrDetourIndex=MplsFrrDetourIndex, cmplsFrrConstIfIndex=cmplsFrrConstIfIndex, cmplsFrrConstSetupPrio=cmplsFrrConstSetupPrio, cmplsFrrConstInclAllAffinity=cmplsFrrConstInclAllAffinity, cmplsFrrFacRouteProtectedIfIndex=cmplsFrrFacRouteProtectedIfIndex, cmplsFrrConstInclAnyAffinity=cmplsFrrConstInclAnyAffinity, cmplsFrrFacRouteProtectingTunResvBw=cmplsFrrFacRouteProtectingTunResvBw, cmplsFrrGroups=cmplsFrrGroups, cmplsFrrConstHopLimit=cmplsFrrConstHopLimit, cmplsFrrCompliances=cmplsFrrCompliances, cmplsFrrConstNumProtectedTunOnIf=cmplsFrrConstNumProtectedTunOnIf, cmplsFrrConstRowStatus=cmplsFrrConstRowStatus, cmplsFrrGeneralObjects=cmplsFrrGeneralObjects, cmplsFrrLogEventReasonString=cmplsFrrLogEventReasonString, cmplsFrrFacRouteDBGroup=cmplsFrrFacRouteDBGroup, cmplsFrrNumOfConfIfs=cmplsFrrNumOfConfIfs, cmplsFrrConstBandwidth=cmplsFrrConstBandwidth, cmplsFrrProtected=cmplsFrrProtected, cmplsFrrDetourOutgoing=cmplsFrrDetourOutgoing, cmplsFrrUnProtected=cmplsFrrUnProtected, cmplsFrrConstTunnelIndex=cmplsFrrConstTunnelIndex, cmplsFrrLogInterface=cmplsFrrLogInterface, cmplsFrrModuleCompliance=cmplsFrrModuleCompliance, cmplsFrrLogGroup=cmplsFrrLogGroup, cmplsFrrModuleComplianceRev1=cmplsFrrModuleComplianceRev1, cmplsFrrConstProtectionMethod=cmplsFrrConstProtectionMethod, cmplsFrrNotifMaxRate=cmplsFrrNotifMaxRate, cmplsFrrConstEntry=cmplsFrrConstEntry, cmplsFrrConstExclAllAffinity=cmplsFrrConstExclAllAffinity, cmplsFrrFacRouteProtectingTunIndex=cmplsFrrFacRouteProtectingTunIndex, PYSNMP_MODULE_ID=cmplsFrrMIB, cmplsFrrLogEventType=cmplsFrrLogEventType, cmplsFrrConstTunnelInstance=cmplsFrrConstTunnelInstance, cmplsFrrNotifsEnabled=cmplsFrrNotifsEnabled, cmplsFrrActProtectedIfs=cmplsFrrActProtectedIfs, cmplsFrrFacObjects=cmplsFrrFacObjects, cmplsFrrNotifGroupRev1=cmplsFrrNotifGroupRev1, cmplsFrrLogTableMaxEntries=cmplsFrrLogTableMaxEntries, cmplsFrrFacRouteProtectedTunEgressLSRId=cmplsFrrFacRouteProtectedTunEgressLSRId, cmplsFrrMIB=cmplsFrrMIB, cmplsFrrLogEntry=cmplsFrrLogEntry, cmplsFrrConstTable=cmplsFrrConstTable, cmplsFrrFacRouteDBEntry=cmplsFrrFacRouteDBEntry, cmplsFrrScalarGroup=cmplsFrrScalarGroup, cmplsFrrConstNumProtectingTunOnIf=cmplsFrrConstNumProtectingTunOnIf, cmplsFrrLogEventTime=cmplsFrrLogEventTime, cmplsFrrFacRouteProtectedTunInstance=cmplsFrrFacRouteProtectedTunInstance, cmplsFrrFacRouteDBTable=cmplsFrrFacRouteDBTable, cmplsFrrConstGroup=cmplsFrrConstGroup, cmplsFrrLogTableCurrEntries=cmplsFrrLogTableCurrEntries, cmplsFrrScalars=cmplsFrrScalars, cmplsFrrLogTable=cmplsFrrLogTable, cmplsFrrObjects=cmplsFrrObjects)
