...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-IETF-FRR-MIB
...
MplsBitRate, MplsTunnelAffinity, MplsTunnelIndex, MplsLsrIdentifier, MplsTunnelInstanceIndex = mibBuilder.importSymbols("MPLS-TC-STD-MIB", "MplsBitRate", "MplsTunnelAffinity", "MplsTunnelIndex", "MplsLsrIdentifier", "MplsTunnelInstanceIndex")
...
mibBuilder.exportSymbols("CISCO-IETF-FRR-MIB", cmplsFrrProtected=cmplsFrrProtected, cmplsFrrConstTunnelInstance=cmplsFrrConstTunnelInstance, cmplsFrrActProtectedTuns=cmplsFrrActProtectedTuns, cmplsFrrNotifMaxRate=cmplsFrrNotifMaxRate, cmplsFrrConstExclAllAffinity=cmplsFrrConstExclAllAffinity, cmplsFrrConstRowStatus=cmplsFrrConstRowStatus, cmplsFrrModuleComplianceRev1=cmplsFrrModuleComplianceRev1, cmplsFrrFacRouteProtectedTunEgressLSRId=cmplsFrrFacRouteProtectedTunEgressLSRId, cmplsFrrFacRouteDBGroup=cmplsFrrFacRouteDBGroup, cmplsFrrModuleCompliance=cmplsFrrModuleCompliance, cmplsFrrDetourIncoming=cmplsFrrDetourIncoming, cmplsFrrLogEventDuration=cmplsFrrLogEventDuration, cmplsFrrDetourOutgoing=cmplsFrrDetourOutgoing, cmplsFrrConstNumProtectedTunOnIf=cmplsFrrConstNumProtectedTunOnIf, cmplsFrrLogEventReasonString=cmplsFrrLogEventReasonString, cmplsFrrNotifGroup=cmplsFrrNotifGroup, cmplsFrrConstInclAllAffinity=cmplsFrrConstInclAllAffinity, cmplsFrrActProtectedLSPs=cmplsFrrActProtectedLSPs, cmplsFrrLogGroup=cmplsFrrLogGroup, cmplsFrrNotifGroupRev1=cmplsFrrNotifGroupRev1, cmplsFrrLogTableCurrEntries=cmplsFrrLogTableCurrEntries, cmplsFrrConformance=cmplsFrrConformance, cmplsFrrLogEntry=cmplsFrrLogEntry, cmplsFrrNotif=cmplsFrrNotif, cmplsFrrGeneralObjects=cmplsFrrGeneralObjects, cmplsFrrConstHopLimit=cmplsFrrConstHopLimit, cmplsFrrLogTable=cmplsFrrLogTable, cmplsFrrFacRouteProtectedTunInstance=cmplsFrrFacRouteProtectedTunInstance, cmplsFrrCompliances=cmplsFrrCompliances, cmplsFrrScalarGroup=cmplsFrrScalarGroup, cmplsFrrUnProtected=cmplsFrrUnProtected, cmplsFrr1to1Objects=cmplsFrr1to1Objects, cmplsFrrLogEventType=cmplsFrrLogEventType, cmplsFrrScalars=cmplsFrrScalars, cmplsFrrDetourOriginating=cmplsFrrDetourOriginating, MplsFrrDetourIndex=MplsFrrDetourIndex, cmplsFrrConstProtectionMethod=cmplsFrrConstProtectionMethod, cmplsFrrFacRouteProtectingTunResvBw=cmplsFrrFacRouteProtectingTunResvBw, cmplsFrrFacRouteDBTable=cmplsFrrFacRouteDBTable, cmplsFrrLogIndex=cmplsFrrLogIndex, cmplsFrrFacRouteProtectedIfIndex=cmplsFrrFacRouteProtectedIfIndex, PYSNMP_MODULE_ID=cmplsFrrMIB, cmplsFrrNotifsEnabled=cmplsFrrNotifsEnabled, cmplsFrrGroups=cmplsFrrGroups, cmplsFrrConstEntry=cmplsFrrConstEntry, cmplsFrrConstTable=cmplsFrrConstTable, cmplsFrrActProtectedIfs=cmplsFrrActProtectedIfs, cmplsFrrConstGroup=cmplsFrrConstGroup, cmplsFrrConfProtectingTuns=cmplsFrrConfProtectingTuns, cmplsFrrFacObjects=cmplsFrrFacObjects, cmplsFrrConstTunnelIndex=cmplsFrrConstTunnelIndex, cmplsFrrFacRouteProtectedTunIndex=cmplsFrrFacRouteProtectedTunIndex, cmplsFrrMIB=cmplsFrrMIB, cmplsFrrNumOfConfIfs=cmplsFrrNumOfConfIfs, cmplsFrrFacRouteProtectedTunIngressLSRId=cmplsFrrFacRouteProtectedTunIngressLSRId, cmplsFrrLogInterface=cmplsFrrLogInterface, cmplsFrrFacRouteProtectingTunProtectionType=cmplsFrrFacRouteProtectingTunProtectionType, cmplsFrrConstNumProtectingTunOnIf=cmplsFrrConstNumProtectingTunOnIf, cmplsFrrSwitchover=cmplsFrrSwitchover, cmplsFrrLogTableMaxEntries=cmplsFrrLogTableMaxEntries, cmplsFrrFacRouteDBEntry=cmplsFrrFacRouteDBEntry, cmplsFrrFacRouteProtectingTunIndex=cmplsFrrFacRouteProtectingTunIndex, cmplsFrrConstBandwidth=cmplsFrrConstBandwidth, cmplsFrrConstInclAnyAffinity=cmplsFrrConstInclAnyAffinity, cmplsFrrLogEventTime=cmplsFrrLogEventTime, cmplsFrrConstIfIndex=cmplsFrrConstIfIndex, cmplsFrrConstHoldingPrio=cmplsFrrConstHoldingPrio, cmplsFrrConstSetupPrio=cmplsFrrConstSetupPrio, cmplsFrrFacRouteProtectedTunStatus=cmplsFrrFacRouteProtectedTunStatus, cmplsFrrObjects=cmplsFrrObjects)
