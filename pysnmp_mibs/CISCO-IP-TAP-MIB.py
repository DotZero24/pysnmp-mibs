...
mibBuilder.exportSymbols("CISCO-IP-TAP-MIB", citapStreamInterface=citapStreamInterface, citapStreamDestinationAddress=citapStreamDestinationAddress, citapStreamVRF=citapStreamVRF, ciscoIpTapMIBConform=ciscoIpTapMIBConform, ciscoIpTapStreamComplianceGroup=ciscoIpTapStreamComplianceGroup, PYSNMP_MODULE_ID=ciscoIpTapMIB, ciscoIpTapMIB=ciscoIpTapMIB, citapStreamEncodePacket=citapStreamEncodePacket, citapStreamSourceL4PortMax=citapStreamSourceL4PortMax, citapStreamAddrType=citapStreamAddrType, citapStreamTosByte=citapStreamTosByte, ciscoIpTapMIBCompliance=ciscoIpTapMIBCompliance, citapStreamDestinationLength=citapStreamDestinationLength, citapStreamProtocol=citapStreamProtocol, ciscoIpTapMIBGroups=ciscoIpTapMIBGroups, ciscoIpTapMIBNotifs=ciscoIpTapMIBNotifs, citapStreamSourceL4PortMin=citapStreamSourceL4PortMin, citapStreamCapabilities=citapStreamCapabilities, citapStreamFlowId=citapStreamFlowId, citapStreamSourceLength=citapStreamSourceLength, ciscoIpTapMIBCompliances=ciscoIpTapMIBCompliances, citapStreamStatus=citapStreamStatus, citapStreamTosByteMask=citapStreamTosByteMask, citapStreamDestL4PortMax=citapStreamDestL4PortMax, citapStreamSourceAddress=citapStreamSourceAddress, citapStreamDestL4PortMin=citapStreamDestL4PortMin, ciscoIpTapMIBObjects=ciscoIpTapMIBObjects, citapStreamEntry=citapStreamEntry, citapStreamTable=citapStreamTable)
