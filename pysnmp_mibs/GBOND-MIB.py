...
HCPerfTimeElapsed, HCPerfCurrentCount, HCPerfIntervalThreshold, HCPerfInvalidIntervals, HCPerfIntervalCount, HCPerfValidIntervals, HCPerfTotalCount = mibBuilder.importSymbols("HC-PerfHist-TC-MIB", "HCPerfTimeElapsed", "HCPerfCurrentCount", "HCPerfIntervalThreshold", "HCPerfInvalidIntervals", "HCPerfIntervalCount", "HCPerfValidIntervals", "HCPerfTotalCount")
...
mibBuilder.exportSymbols("GBOND-MIB", gBondPortCapCapacity=gBondPortCapCapacity, gBondMIB=gBondMIB, gBondPortCapPeerCapacity=gBondPortCapPeerCapacity, gBondPortPm1DayIntervalSES=gBondPortPm1DayIntervalSES, gBondPortStatOperScheme=gBondPortStatOperScheme, gBondPortPm15MinIntervalUAS=gBondPortPm15MinIntervalUAS, gBondPortPmCurSES=gBondPortPmCurSES, gBondPortCapTable=gBondPortCapTable, gBondPm1DayGroup=gBondPm1DayGroup, gBondPort=gBondPort, gBondPortStatUpDataRate=gBondPortStatUpDataRate, gBondPortPmCur15MinUAS=gBondPortPmCur15MinUAS, gBondPortPm1DayIntervalValid=gBondPortPm1DayIntervalValid, gBondPortPm15MinIntervalValid=gBondPortPm15MinIntervalValid, gBondPortStatSide=gBondPortStatSide, gBondBasicGroup=gBondBasicGroup, gBondPortPm1DayIntervalMoniTime=gBondPortPm1DayIntervalMoniTime, GBondPm1DayIntervalThreshold=GBondPm1DayIntervalThreshold, gBondPortPm15MinIntervalMoniTime=gBondPortPm15MinIntervalMoniTime, gBondPortPm1DayIntervalUAS=gBondPortPm1DayIntervalUAS, gBondPortConfThreshLowUpRate=gBondPortConfThreshLowUpRate, gBondPortPmTcaProfileName=gBondPortPmTcaProfileName, gBondPortConfPmTcaConfProfile=gBondPortConfPmTcaConfProfile, gBondPortConfDiscoveryCode=gBondPortConfDiscoveryCode, gBondPortStatFltStatus=gBondPortStatFltStatus, gBondPortPmCurES=gBondPortPmCurES, gBondPortConfLowRateCrossingEnable=gBondPortConfLowRateCrossingEnable, gBondPortPmTcaProfileRowStatus=gBondPortPmTcaProfileRowStatus, gBondCompliances=gBondCompliances, gBondPortPmCurEntry=gBondPortPmCurEntry, gBondPortPm1DayIntervalES=gBondPortPm1DayIntervalES, gBondPortPmTcaProfileThresh15MinES=gBondPortPmTcaProfileThresh15MinES, gBondPortPmCur1DayES=gBondPortPmCur1DayES, gBondBce=gBondBce, gBondCompliance=gBondCompliance, gBondPortStatDnDataRate=gBondPortStatDnDataRate, gBondConformance=gBondConformance, gBondPortStatPeerOperScheme=gBondPortStatPeerOperScheme, PYSNMP_MODULE_ID=gBondMIB, gBondPortPmCur1DayInvalidIntervals=gBondPortPmCur1DayInvalidIntervals, gBondPortPmTcaProfileEntry=gBondPortPmTcaProfileEntry, gBondPmTcaConfGroup=gBondPmTcaConfGroup, gBondPortPmTcaProfileThresh1DayES=gBondPortPmTcaProfileThresh1DayES, gBondPortPmCur1DaySES=gBondPortPmCur1DaySES, gBondPortConfPeerAdminScheme=gBondPortConfPeerAdminScheme, gBondPortPm15MinIntervalSES=gBondPortPm15MinIntervalSES, gBondPortConfAdminScheme=gBondPortConfAdminScheme, gBondPortConfTable=gBondPortConfTable, gBondPortPmCur1DayUAS=gBondPortPmCur1DayUAS, gBondPmTca1DayESCrossing=gBondPmTca1DayESCrossing, gBondPortConfEntry=gBondPortConfEntry, gBondPortPmTcaProfileTable=gBondPortPmTcaProfileTable, gBondPortStatEntry=gBondPortStatEntry, gBondPortPmCur15MinES=gBondPortPmCur15MinES, gBondBceConfEntry=gBondBceConfEntry, gBondPortPm15MinTable=gBondPortPm15MinTable, gBondPortPmCurTable=gBondPortPmCurTable, gBondPmTca15MinSESCrossing=gBondPmTca15MinSESCrossing, gBondPortCapPeerSchemesSupported=gBondPortCapPeerSchemesSupported, gBondBceConfTable=gBondBceConfTable, gBondPortStatNumBCEs=gBondPortStatNumBCEs, gBondPortPM=gBondPortPM, gBondPortPm1DayEntry=gBondPortPm1DayEntry, gBondPortCapSchemesSupported=gBondPortCapSchemesSupported, gBondPortPmCur15MinInvalidIntervals=gBondPortPmCur15MinInvalidIntervals, gBondPortPmCur15MinTimeElapsed=gBondPortPmCur15MinTimeElapsed, gBondDiscoveryGroup=gBondDiscoveryGroup, gBondPortConfTargetUpDataRate=gBondPortConfTargetUpDataRate, gBondPmCurGroup=gBondPmCurGroup, gBondPortPm15MinIntervalES=gBondPortPm15MinIntervalES, gBondTcaNotificationGroup=gBondTcaNotificationGroup, gBondPortPmCur1DayValidIntervals=gBondPortPmCur1DayValidIntervals, gBondPmTca15MinESCrossing=gBondPmTca15MinESCrossing, gBondPmTca1DayUASCrossing=gBondPmTca1DayUASCrossing, gBondPortPmCur1DayTimeElapsed=gBondPortPmCur1DayTimeElapsed, gBondPortPmTcaProfileThresh1DayUAS=gBondPortPmTcaProfileThresh1DayUAS, gBondPm15MinGroup=gBondPm15MinGroup, gBondPortConfPmTcaEnable=gBondPortConfPmTcaEnable, gBondBceConfRemoteDiscoveryCode=gBondBceConfRemoteDiscoveryCode, gBondPmTca1DaySESCrossing=gBondPmTca1DaySESCrossing, gBondPortPmTcaProfileThresh15MinSES=gBondPortPmTcaProfileThresh15MinSES, gBondPortConfTargetDnDataRate=gBondPortConfTargetDnDataRate, gBondObjects=gBondObjects, gBondPortPmTcaProfileThresh1DaySES=gBondPortPmTcaProfileThresh1DaySES, gBondPortPm15MinIntervalIndex=gBondPortPm15MinIntervalIndex, gBondPortPmCur15MinSES=gBondPortPmCur15MinSES, gBondPortPmCurUAS=gBondPortPmCurUAS, gBondPortPm1DayTable=gBondPortPm1DayTable, gBondMultiSchemeGroup=gBondMultiSchemeGroup, gBondLowUpRateCrossing=gBondLowUpRateCrossing, gBondTcaConfGroup=gBondTcaConfGroup, gBondLowDnRateCrossing=gBondLowDnRateCrossing, gBondPortPmCur15MinValidIntervals=gBondPortPmCur15MinValidIntervals, gBondPortPmTcaProfileThresh15MinUAS=gBondPortPmTcaProfileThresh15MinUAS, gBondPortPm1DayIntervalIndex=gBondPortPm1DayIntervalIndex, gBondPmTcaNotificationGroup=gBondPmTcaNotificationGroup, gBondPmTca15MinUASCrossing=gBondPmTca15MinUASCrossing, gBondPortStatTable=gBondPortStatTable, gBondPortCapEntry=gBondPortCapEntry, gBondPortConfThreshLowDnRate=gBondPortConfThreshLowDnRate, gBondPortNotifications=gBondPortNotifications, gBondGroups=gBondGroups, gBondPortPm15MinEntry=gBondPortPm15MinEntry)
