# SNMP MIB module (NETGEAR-IPV6-LOOPBACK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-IPV6-LOOPBACK-MIB
...
agentLoopbackIpv6PrefixEntry = _AgentLoopbackIpv6PrefixEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 23, 1, 1, 1)
)
agentLoopbackIpv6PrefixEntry.setIndexNames(
    (0, "NETGEAR-LOOPBACK-MIB", "agentLoopbackID"),
    (0, "NETGEAR-IPV6-LOOPBACK-MIB", "agentLoopbackIpv6PrefixPrefix"),
    (0, "NETGEAR-IPV6-LOOPBACK-MIB", "agentLoopbackIpv6PrefixPrefixLen"),
)
if mibBuilder.loadTexts:
...
agentLoopbackIpv6PrefixPrefix = _AgentLoopbackIpv6PrefixPrefix_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 23, 1, 1, 1, 1),
...
agentLoopbackIpv6PrefixPrefixLen = _AgentLoopbackIpv6PrefixPrefixLen_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 23, 1, 1, 1, 2),
...
agentLoopbackIpv6PrefixStatus = _AgentLoopbackIpv6PrefixStatus_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 23, 1, 1, 1, 3),
