...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsXCAdminStatus=mplsXCAdminStatus, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsOutSegmentUp=mplsOutSegmentUp, mplsXCGroup=mplsXCGroup, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInSegmentDown=mplsInSegmentDown, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsInSegmentLabel=mplsInSegmentLabel, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsXCEntry=mplsXCEntry, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInSegmentTable=mplsInSegmentTable, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, PYSNMP_MODULE_ID=mplsLsrMIB, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, MplsBitRate=MplsBitRate, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsXCTrapEnable=mplsXCTrapEnable, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsPerfGroup=mplsPerfGroup, MplsLSPID=MplsLSPID, mplsLabelStackIndex=mplsLabelStackIndex, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsXCIndex=mplsXCIndex, mplsOutSegmentDown=mplsOutSegmentDown, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsLsrCompliances=mplsLsrCompliances, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, MplsBurstSize=MplsBurstSize, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInSegmentNPop=mplsInSegmentNPop, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsTrafficParamTable=mplsTrafficParamTable, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, MplsLabel=MplsLabel, MplsBufferSize=MplsBufferSize, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsXCLspId=mplsXCLspId, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsLsrGroups=mplsLsrGroups, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsInSegmentPackets=mplsInSegmentPackets, mplsLsrConformance=mplsLsrConformance, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsLsrNotifications=mplsLsrNotifications, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInSegmentOwner=mplsInSegmentOwner, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsXCOwner=mplsXCOwner, mplsLabelStackGroup=mplsLabelStackGroup, mplsLsrMIB=mplsLsrMIB, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsOutSegmentTable=mplsOutSegmentTable, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInSegmentOctets=mplsInSegmentOctets, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsXCUp=mplsXCUp, mplsInSegmentUp=mplsInSegmentUp, mplsXCDown=mplsXCDown, mplsLabelStackLabel=mplsLabelStackLabel, mplsInSegmentErrors=mplsInSegmentErrors, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsInterfaceConfIndex=mplsInterfaceConfIndex, MplsObjectOwner=MplsObjectOwner, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsXCIsPersistent=mplsXCIsPersistent, mplsXCTable=mplsXCTable, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsLsrObjects=mplsLsrObjects, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsXCOperStatus=mplsXCOperStatus, mplsLabelStackEntry=mplsLabelStackEntry, mplsXCIndexNext=mplsXCIndexNext, mplsLabelStackTable=mplsLabelStackTable, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsXCStorageType=mplsXCStorageType, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsInSegmentGroup=mplsInSegmentGroup, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsXCRowStatus=mplsXCRowStatus, mplsOutSegmentErrors=mplsOutSegmentErrors)
