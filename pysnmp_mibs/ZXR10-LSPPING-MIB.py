...
mibBuilder.exportSymbols("ZXR10-LSPPING-MIB", lspPingResultSentPkts=lspPingResultSentPkts, DisplayString=DisplayString, lsppingNotifications=lsppingNotifications, lspPingLdpPrefix=lspPingLdpPrefix, lspPingResultTable=lspPingResultTable, lspPingResultRoundTripMaxTime=lspPingResultRoundTripMaxTime, lspPingResultEntryOwner=lspPingResultEntryOwner, lsppingTrapResult=lsppingTrapResult, lspPingResultSerial=lspPingResultSerial, lspPingResultRoundWobbleMinTime=lspPingResultRoundWobbleMinTime, lspPingType=lspPingType, lspPingRosStatus=lspPingRosStatus, lspPingAtomDesAddr=lspPingAtomDesAddr, lspPingResultEntry=lspPingResultEntry, lspPingResultRoundTripMinTime=lspPingResultRoundTripMinTime, lspPingTimeOut=lspPingTimeOut, lspPingSerial=lspPingSerial, lspPingAtomVcid=lspPingAtomVcid, lspPingTrapOncompletion=lspPingTrapOncompletion, lspPingTable=lspPingTable, lspPingIfOption=lspPingIfOption, lspPingPacketCount=lspPingPacketCount, lspPingResultRoundTripAvgTime=lspPingResultRoundTripAvgTime, lspPingMplsTeTunnelIfName=lspPingMplsTeTunnelIfName, lspPingDataLen=lspPingDataLen, lspPingResultRcvPkts=lspPingResultRcvPkts, lspPingEntry=lspPingEntry, lspPingResultRoundWobbleMaxTime=lspPingResultRoundWobbleMaxTime, zxr10LspPingMIB=zxr10LspPingMIB, lspPingResultRoundWobbleAvgTime=lspPingResultRoundWobbleAvgTime, lspPingLdpPrefixlen=lspPingLdpPrefixlen, lspPingEntryOwner=lspPingEntryOwner)
