...
# ASN.1 source file:///Users/rob/code/pysnmp-mibs/mibs/cisco/CISCO-IGMP-SNOOPING-MIB
# Produced by pysmi-1.1.12 at Thu Sep 11 10:11:20 2025
...
mibBuilder.exportSymbols("CISCO-IGMP-SNOOPING-MIB", cisQuerierGlobalConfigGroup=cisQuerierGlobalConfigGroup, cisMcastRouterConfigGroup=cisMcastRouterConfigGroup, cisTopoChangeFloodQueryCount=cisTopoChangeFloodQueryCount, cisIgmpQuerierEnabled=cisIgmpQuerierEnabled, cisInterfaceStatsTable=cisInterfaceStatsTable, cisVlanFilterLimitExclAccessGrp=cisVlanFilterLimitExclAccessGrp, cisVlanFilterAccessGroup=cisVlanFilterAccessGroup, cisAddressAliasingMode=cisAddressAliasingMode, cisGlobalTcnGroup=cisGlobalTcnGroup, cisMcastRouterConfigStorageType=cisMcastRouterConfigStorageType, cisVlanConfigGroup2=cisVlanConfigGroup2, cisQuerierAddress=cisQuerierAddress, cisExtConfig2Group=cisExtConfig2Group, cisMulticastGroupConfCeVlanIndex=cisMulticastGroupConfCeVlanIndex, cisInterfaceStatsEntry=cisInterfaceStatsEntry, cisMulticastGroupConfPortRange=cisMulticastGroupConfPortRange, cisMcastRouterConfigVlanIndex=cisMcastRouterConfigVlanIndex, cisIfTopoChangeFloodEnabled=cisIfTopoChangeFloodEnabled, cisSystemInfo=cisSystemInfo, cisMulticastGroupConfStorageType=cisMulticastGroupConfStorageType, cisL2EntryLimitGroup=cisL2EntryLimitGroup, CisIgmpVersion=CisIgmpVersion, cisMulticastGroupTable=cisMulticastGroupTable, cisIgmpSnoopingMIBCompliance3=cisIgmpSnoopingMIBCompliance3, cisRouterAlertCheckEnabled=cisRouterAlertCheckEnabled, cisMcastGroupIgmpVersion=cisMcastGroupIgmpVersion, cisV3ToIncluded=cisV3ToIncluded, cisFilterStatsVlanNumber=cisFilterStatsVlanNumber, cisFilterMinVersionDenied=cisFilterMinVersionDenied, cisMcastGroupExcludeHostCount=cisMcastGroupExcludeHostCount, cisMulticastGroupConfigEntry=cisMulticastGroupConfigEntry, cisVlanExplicitTrackingEnabled=cisVlanExplicitTrackingEnabled, cisRxOtherPackets=cisRxOtherPackets, cisRateLimitGroup=cisRateLimitGroup, cisVlanExplicitTrackingCfgGroup=cisVlanExplicitTrackingCfgGroup, cisIfAccessGroupEntry=cisIfAccessGroupEntry, PYSNMP_MODULE_ID=ciscoIgmpSnoopingMIB, cisMulticastGroupConfSourceAddress=cisMulticastGroupConfSourceAddress, cisFilterLimitDenied=cisFilterLimitDenied, cisIfConfigInfo=cisIfConfigInfo, cisIfLimitRowStatus=cisIfLimitRowStatus, cisFallbackTime=cisFallbackTime, cisEntryTrackingLimit=cisEntryTrackingLimit, cisMcastGroupEntry=cisMcastGroupEntry, cisMcastGroupInfoGroup=cisMcastGroupInfoGroup, cisVlanFilterConfigEntry=cisVlanFilterConfigEntry, cisFilterTotalLimitDenied=cisFilterTotalLimitDenied, cisTimeToLiveConfigGroup=cisTimeToLiveConfigGroup, cisLastMemberQueryInterval=cisLastMemberQueryInterval, cisSourceOnlyAgeTimerInSecGroup=cisSourceOnlyAgeTimerInSecGroup, cisVlanReportSuppressionEnabled=cisVlanReportSuppressionEnabled, cisQuerierVersion=cisQuerierVersion, cisIgmpSnoopingMIBCompliance2=cisIgmpSnoopingMIBCompliance2, cisQuerierQueryInterval=cisQuerierQueryInterval, cisL2EntryLimit=cisL2EntryLimit, cisIfAccessGroupsChannelsAllowed=cisIfAccessGroupsChannelsAllowed, cisSourceOnlyLimitGroup=cisSourceOnlyLimitGroup, cisIfConfigTable=cisIfConfigTable, cisIfLimitTotalGroup=cisIfLimitTotalGroup, cisRateLimitInfo=cisRateLimitInfo, cisMospf2RateLimit=cisMospf2RateLimit, cisIfAccessGroupTable=cisIfAccessGroupTable, cisIgmpQuerierQueryInterval=cisIgmpQuerierQueryInterval, cisMcastGroupAddressType=cisMcastGroupAddressType, cisMcastGroupTable=cisMcastGroupTable, cisMcastGroupAddress=cisMcastGroupAddress, cisTxReports=cisTxReports, cisVlanIndex=cisVlanIndex, cisExplicitTrackingInfo=cisExplicitTrackingInfo, cisV3Allows=cisV3Allows, cisIgmpQuerierInfoGroup=cisIgmpQuerierInfoGroup, cisPimV2RateLimit=cisPimV2RateLimit, cisV3ProcessEnabledAdminStatus=cisV3ProcessEnabledAdminStatus, cisVlanLastMemberQueryCount=cisVlanLastMemberQueryCount, cisTrackingLimitGroup=cisTrackingLimitGroup, cisRateLimit=cisRateLimit, cisVlanRobustnessVariable=cisVlanRobustnessVariable, cisGeneralQueryRateLimit=cisGeneralQueryRateLimit, cisRxLeaves=cisRxLeaves, cisIfAccessGroupRowStatus=cisIfAccessGroupRowStatus, cisIfLimitTotalEntry=cisIfLimitTotalEntry, cisV3Blocks=cisV3Blocks, cisVlanRouterAlertCheckEnabled=cisVlanRouterAlertCheckEnabled, cisGlobalIgmpV3ConfigGroup=cisGlobalIgmpV3ConfigGroup, cisIgmpQuerierTcnQueryInterval=cisIgmpQuerierTcnQueryInterval, cisIfLimitTable=cisIfLimitTable, cisQuerierGlobalTcnQueryCountGroup=cisQuerierGlobalTcnQueryCountGroup, cisRobustnessVariable=cisRobustnessVariable, cisVlanConfigTable=cisVlanConfigTable, cisLeaveQueryConfigGroup=cisLeaveQueryConfigGroup, cisIfAccessGroupGroup=cisIfAccessGroupGroup, cisIfLimitStorageType=cisIfLimitStorageType, cisMcastGroupVlanIndex=cisMcastGroupVlanIndex, cisIfAccessGroupVlan=cisIfAccessGroupVlan, cisIgmpQuerierTcnQueryPending=cisIgmpQuerierTcnQueryPending, cisIgmpSnoopingMIBCompliance=cisIgmpSnoopingMIBCompliance, cisIgmpQuerierTimerExpiry=cisIgmpQuerierTimerExpiry, cisVlanConfigEntry=cisVlanConfigEntry, cisVlanConfigGroup=cisVlanConfigGroup, cisMulticastGroupCeVlanIndex=cisMulticastGroupCeVlanIndex, cisStatsGroup=cisStatsGroup, cisMulticastGroupSourceAddress=cisMulticastGroupSourceAddress, ciscoIgmpSnoopingNotification=ciscoIgmpSnoopingNotification, ciscoIgmpSnoopingMIBObject=ciscoIgmpSnoopingMIBObject, cisRxGroupSpecificQueries=cisRxGroupSpecificQueries, cisRxReports=cisRxReports, cisIgmpQuerierMaxResponseTime=cisIgmpQuerierMaxResponseTime, cisMcastRouterConfigTable=cisMcastRouterConfigTable, cisMcastRouterConfigRowStatus=cisMcastRouterConfigRowStatus, cisMulticastGroupIgmpVersion=cisMulticastGroupIgmpVersion, cisMulticastGroupConfigTable=cisMulticastGroupConfigTable, cisIfLimitTotalExcludeAccessGrp=cisIfLimitTotalExcludeAccessGrp, cisFastLeaveEnabled=cisFastLeaveEnabled, cisVlanLeaveQueryInterval=cisVlanLeaveQueryInterval, cisIgmpQuerierAdminAddress=cisIgmpQuerierAdminAddress, cisSourceOnlyEntryAgingTime=cisSourceOnlyEntryAgingTime, cisMulticastGroupAddress=cisMulticastGroupAddress, cisMulticastGroupPortListTable=cisMulticastGroupPortListTable, cisVlanFilterMinVersionAllowed=cisVlanFilterMinVersionAllowed, cisMulticastGroupEntry=cisMulticastGroupEntry, cisIfLimitMax=cisIfLimitMax, cisIfLimitExcludeAccessGrp=cisIfLimitExcludeAccessGrp, cisIgmpQuerierTable=cisIgmpQuerierTable, cisMospf1RateLimit=cisMospf1RateLimit, cisV3Compliance=cisV3Compliance, cisExtConfig1Group=cisExtConfig1Group, cisVlanIgmpSnoopingOperMode=cisVlanIgmpSnoopingOperMode, cisMcastRouterCfgTable=cisMcastRouterCfgTable, cisMcastRouterType=cisMcastRouterType, cisMIBConformance=cisMIBConformance, cisVlanFastLeaveEnabled=cisVlanFastLeaveEnabled, cisSourceOnlyEntryAgeTime=cisSourceOnlyEntryAgeTime, cisVlanFilterLimitMax=cisVlanFilterLimitMax, cisVlanExplicitTrackingLimit=cisVlanExplicitTrackingLimit, cisMcastGroupFilterMode=cisMcastGroupFilterMode, cisTxGeneralQueries=cisTxGeneralQueries, cisMcastGroupIncludeHostCount=cisMcastGroupIncludeHostCount, cisRateLimitGroup2=cisRateLimitGroup2, cisTopoChangeQuerySolicitEnabled=cisTopoChangeQuerySolicitEnabled, cisIgmpQuerierAdminAddressType=cisIgmpQuerierAdminAddressType, cisVlanIgmpSnoopingLearningMode=cisVlanIgmpSnoopingLearningMode, cisV3ProcessEnabledOperStatus=cisV3ProcessEnabledOperStatus, cisMcastRouterVlanIndex=cisMcastRouterVlanIndex, cisIfLimitTotalStorageType=cisIfLimitTotalStorageType, cisFilteringInfo=cisFilteringInfo, cisQuerierTimerExpiry=cisQuerierTimerExpiry, cisMulticastGroupInfoGroup=cisMulticastGroupInfoGroup, cisRxTopoNotifications=cisRxTopoNotifications, cisMulticastGroupPortRangeIndex=cisMulticastGroupPortRangeIndex, cisVlanFilterConfigGroup=cisVlanFilterConfigGroup, cisMcastGroupPortList=cisMcastGroupPortList, cisIgmpQuerierVlanIndex=cisIgmpQuerierVlanIndex, cisMulticastGroupConfAddress=cisMulticastGroupConfAddress, cisIgmpQuerierConfigGroup=cisIgmpQuerierConfigGroup, cisIgmpQuerierEntry=cisIgmpQuerierEntry, cisFilterStatsEntry=cisFilterStatsEntry, cisQuerierMaxResponseTime=cisQuerierMaxResponseTime, cisIgmpQuerierAddress=cisIgmpQuerierAddress, cisIfLimitVlanNumber=cisIfLimitVlanNumber, cisMulticastRouterInfo=cisMulticastRouterInfo, cisMulticastGroupAddressType=cisMulticastGroupAddressType, cisIfLimitTotalLimitMax=cisIfLimitTotalLimitMax, cisIfLimitTotalRowStatus=cisIfLimitTotalRowStatus, cisRxGeneralQueries=cisRxGeneralQueries, cisQuerierAddressType=cisQuerierAddressType, cisVlanExplicitTrackingTable=cisVlanExplicitTrackingTable, cisMcastRouterRowStatus=cisMcastRouterRowStatus, cisReportSuppressionEnabled=cisReportSuppressionEnabled, cisIfLimitGroup=cisIfLimitGroup, cisFastBlockEnabled=cisFastBlockEnabled, cisBaseConfigGroup=cisBaseConfigGroup, cisIfLimitTotalTable=cisIfLimitTotalTable, cisIgmpQuerierConfigExtGroup=cisIgmpQuerierConfigExtGroup, cisSystemV3Group=cisSystemV3Group, cisSourceOnlyLearningEnabled=cisSourceOnlyLearningEnabled, cisLeaveQueryType=cisLeaveQueryType, cisOperMode=cisOperMode, cisSystemV2Group=cisSystemV2Group, cisMulticastGroupPortListEntry=cisMulticastGroupPortListEntry, cisV3SnoopingSupport=cisV3SnoopingSupport, cisV2Compliance=cisV2Compliance, cisV3IsIncluded=cisV3IsIncluded, cisIgmpQuerierState=cisIgmpQuerierState, cisGlobalIgmpV3InfoGroup=cisGlobalIgmpV3InfoGroup, cisQuerierConfigInfo=cisQuerierConfigInfo, cisFilterAccessGroupDenied=cisFilterAccessGroupDenied, cisIfLimitEntry=cisIfLimitEntry, cisStatisticsInfo=cisStatisticsInfo, cisV3StatsGroup=cisV3StatsGroup, cisDvmrpRateLimit=cisDvmrpRateLimit, cisSourceOnlyPercentageScanLimit=cisSourceOnlyPercentageScanLimit, cisMulticastGroupConfPortList=cisMulticastGroupConfPortList, cisTimeToLiveCheckEnabled=cisTimeToLiveCheckEnabled, cisVlanTimeToLiveCheckEnabled=cisVlanTimeToLiveCheckEnabled, cisVlanExplicitTrackingEntry=cisVlanExplicitTrackingEntry, cisFilterStatsTable=cisFilterStatsTable, cisV3IsExcluded=cisV3IsExcluded, cisMulticastGroupPortInfoGroup=cisMulticastGroupPortInfoGroup, cisQuerierTcnQueryPendingGroup=cisQuerierTcnQueryPendingGroup, cisIfConfigEntry=cisIfConfigEntry, CisIgmpMode=CisIgmpMode, cisMulticastGroupSourceExpires=cisMulticastGroupSourceExpires, cisMulticastGroupConfRowStatus=cisMulticastGroupConfRowStatus, cisMcastRouterConfigRouterType=cisMcastRouterConfigRouterType, cisRxInvalidPackets=cisRxInvalidPackets, cisMulticastRouterConfigGroup=cisMulticastRouterConfigGroup, cisMulticastGroupConfAddressType=cisMulticastGroupConfAddressType, cisRxMACGeneralQueries=cisRxMACGeneralQueries, cisGlobalSourceOnlyLearnGroup=cisGlobalSourceOnlyLearnGroup, cisMulticastGroupPortList=cisMulticastGroupPortList, cisIgmpQuerierVersion=cisIgmpQuerierVersion, cisIgmpSnoopingEnabled=cisIgmpSnoopingEnabled, cisVlanFilterConfigTable=cisVlanFilterConfigTable, cisQuerierTcnQueryInterval=cisQuerierTcnQueryInterval, cisMulticastGroupConfVlanIndex=cisMulticastGroupConfVlanIndex, cisIgmpQuerierAddressType=cisIgmpQuerierAddressType, cisAdminMode=cisAdminMode, cisTxLeaves=cisTxLeaves, cisMulticastGroupGroupType=cisMulticastGroupGroupType, cisV3ToExcluded=cisV3ToExcluded, cisIfConfigGroup=cisIfConfigGroup, cisMulticastGroupSourceUpTime=cisMulticastGroupSourceUpTime, cisSourceOnlyLearningLimit=cisSourceOnlyLearningLimit, ciscoIgmpSnoopingMIB=ciscoIgmpSnoopingMIB, cisIgmpQuerierTcnQueryCount=cisIgmpQuerierTcnQueryCount, cisVlanConfigInfo=cisVlanConfigInfo, cisMcastRouterCfgEntry=cisMcastRouterCfgEntry, cisQuerierTcnQueryCount=cisQuerierTcnQueryCount, cisMcastRouterConfigEntry=cisMcastRouterConfigEntry, cisIgmpQuerierInterface=cisIgmpQuerierInterface, cisMulticastGroupInclHostCount=cisMulticastGroupInclHostCount, cisRouterAlertConfigGroup=cisRouterAlertConfigGroup, cisFilterStatisticsGroup=cisFilterStatisticsGroup, cisRxValidPackets=cisRxValidPackets, cisMIBCompliances=cisMIBCompliances, cisVlanIgmpSnoopingEnabled=cisVlanIgmpSnoopingEnabled, cisMIBGroups=cisMIBGroups, cisMulticastGroupVlanIndex=cisMulticastGroupVlanIndex, cisSystemGroup=cisSystemGroup, cisQuerierEnabled=cisQuerierEnabled, cisResourceLimitInfo=cisResourceLimitInfo, cisIgmpQuerierAdminVersion=cisIgmpQuerierAdminVersion, cisMulticastGroupInfo=cisMulticastGroupInfo, cisMulticastGroupConfigGroup=cisMulticastGroupConfigGroup, cisIfAccessGroupStorageType=cisIfAccessGroupStorageType, cisRobustnessConfigGroup=cisRobustnessConfigGroup, cisLastMemberQueryCount=cisLastMemberQueryCount, cisMulticastGroupExclHostCount=cisMulticastGroupExclHostCount, cisTxGroupSpecificQueries=cisTxGroupSpecificQueries)
