# SNMP MIB module (A3COM-HUAWEI-VOSIP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/A3COM-HUAWEI-VOSIP-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:44:31 2025
...
h3cVoSIP = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12)
)
...
h3cSIPClientMIB = _H3cSIPClientMIB_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1)
)
...
h3cSIPClientConfigObjects = _H3cSIPClientConfigObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1)
)
...
h3cSIPID = _H3cSIPID_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 1),
    _H3cSIPID_Type()
)
...
h3cSIPPasswordType = _H3cSIPPasswordType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 2),
...
h3cSIPPassword = _H3cSIPPassword_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 3),
...
h3cSIPSourceIPAddressType = _H3cSIPSourceIPAddressType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 4),
...
h3cSIPSourceIP = _H3cSIPSourceIP_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 5),
...
h3cSIPRegisterMode = _H3cSIPRegisterMode_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 6),
...
h3cSIPRegisterPhoneNumber = _H3cSIPRegisterPhoneNumber_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 7),
...
h3cSIPRegisterEnable = _H3cSIPRegisterEnable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 8),
...
h3cSIPTrapsControl = _H3cSIPTrapsControl_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 9),
...
h3cSIPStatisticClear = _H3cSIPStatisticClear_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 1, 10),
...
h3cSIPServerConfigTable = _H3cSIPServerConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 2)
)
if mibBuilder.loadTexts:
...
h3cSIPServerConfigEntry = _H3cSIPServerConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 2, 1)
)
h3cSIPServerConfigEntry.setIndexNames(
    (0, "A3COM-HUAWEI-VOSIP-MIB", "h3cSIPServerIPAddressType"),
    (0, "A3COM-HUAWEI-VOSIP-MIB", "h3cSIPServerIPAddress"),
    (0, "A3COM-HUAWEI-VOSIP-MIB", "h3cSIPServerPort"),
)
if mibBuilder.loadTexts:
...
h3cSIPServerIPAddressType = _H3cSIPServerIPAddressType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 2, 1, 1),
...
h3cSIPServerIPAddress = _H3cSIPServerIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 2, 1, 2),
...
h3cSIPServerPort = _H3cSIPServerPort_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 2, 1, 3),
...
h3cSIPServerType = _H3cSIPServerType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 2, 1, 4),
...
h3cSIPAcceptType = _H3cSIPAcceptType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 2, 1, 5),
...
h3cSIPServerStatus = _H3cSIPServerStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 2, 1, 6),
...
h3cSIPMsgIndex = _H3cSIPMsgIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 3, 1, 1),
...
h3cSIPMsgName = _H3cSIPMsgName_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 3, 1, 2),
    _H3cSIPMsgName_Type()
)
...
h3cSIPMsgSend = _H3cSIPMsgSend_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 3, 1, 3),
    _H3cSIPMsgSend_Type()
)
...
h3cSIPMsgOKSend = _H3cSIPMsgOKSend_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 3, 1, 4),
...
h3cSIPMsgReceive = _H3cSIPMsgReceive_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 3, 1, 5),
...
h3cSIPMsgOKReceive = _H3cSIPMsgOKReceive_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 3, 1, 6),
...
h3cSIPMsgResponseStatTable = _H3cSIPMsgResponseStatTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 4)
)
if mibBuilder.loadTexts:
...
h3cSIPMsgResponseStatEntry = _H3cSIPMsgResponseStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 4, 1)
)
h3cSIPMsgResponseStatEntry.setIndexNames(
    (0, "A3COM-HUAWEI-VOSIP-MIB", "h3cSIPMsgResponseIndex"),
)
if mibBuilder.loadTexts:
...
h3cSIPMsgResponseIndex = _H3cSIPMsgResponseIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 4, 1, 1),
...
h3cSIPMsgResponseCode = _H3cSIPMsgResponseCode_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 4, 1, 2),
...
h3cSIPResCodeRecvCount = _H3cSIPResCodeRecvCount_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 4, 1, 3),
...
h3cSIPResCodeSendCount = _H3cSIPResCodeSendCount_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 1, 4, 1, 4),
...
h3cSIPTrapStubObjects = _H3cSIPTrapStubObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 3)
)
...
h3cSIPRegisterFailReason = _H3cSIPRegisterFailReason_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 3, 1),
...
h3cSIPAuthenReqMethod = _H3cSIPAuthenReqMethod_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 3, 2),
...
h3cSIPClientNotifications = _H3cSIPClientNotifications_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 4)
)
...
h3cSIPRegisterFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 4, 1)
)
h3cSIPRegisterFailure.setObjects(
      *(("A3COM-HUAWEI-VOSIP-MIB", "h3cSIPID"),
        ("A3COM-HUAWEI-VOSIP-MIB", "h3cSIPServerIPAddressType"),
        ("A3COM-HUAWEI-VOSIP-MIB", "h3cSIPServerIPAddress"),
        ("A3COM-HUAWEI-VOSIP-MIB", "h3cSIPServerPort"),
        ("A3COM-HUAWEI-VOSIP-MIB", "h3cSIPRegisterFailReason"))
)
if mibBuilder.loadTexts:
...
h3cSIPAuthenticateFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 4, 2)
)
h3cSIPAuthenticateFailure.setObjects(
      *(("A3COM-HUAWEI-VOSIP-MIB", "h3cSIPID"),
        ("A3COM-HUAWEI-VOSIP-MIB", "h3cSIPAuthenReqMethod"))
)
if mibBuilder.loadTexts:
...
h3cSIPServerSwitch = NotificationType(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 10, 2, 39, 12, 4, 3)
)
if mibBuilder.loadTexts:
