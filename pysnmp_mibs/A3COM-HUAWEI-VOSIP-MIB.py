...
h3cSIPClientMIB=_H3cSIPClientMIB_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,12,1))
_H3cSIPClientConfigObjects_ObjectIdentity=ObjectIdentity
h3cSIPClientConfigObjects=_H3cSIPClientConfigObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1))
...
h3cSIPID=_H3cSIPID_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,1),_H3cSIPID_Type())
...
h3cSIPPasswordType=_H3cSIPPasswordType_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,2),_H3cSIPPasswordType_Type())
...
h3cSIPPassword=_H3cSIPPassword_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,3),_H3cSIPPassword_Type())
...
h3cSIPSourceIPAddressType=_H3cSIPSourceIPAddressType_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,4),_H3cSIPSourceIPAddressType_Type())
...
h3cSIPSourceIP=_H3cSIPSourceIP_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,5),_H3cSIPSourceIP_Type())
...
h3cSIPRegisterMode=_H3cSIPRegisterMode_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,6),_H3cSIPRegisterMode_Type())
...
h3cSIPRegisterPhoneNumber=_H3cSIPRegisterPhoneNumber_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,7),_H3cSIPRegisterPhoneNumber_Type())
...
h3cSIPRegisterEnable=_H3cSIPRegisterEnable_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,8),_H3cSIPRegisterEnable_Type())
...
h3cSIPTrapsControl=_H3cSIPTrapsControl_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,9),_H3cSIPTrapsControl_Type())
...
h3cSIPStatisticClear=_H3cSIPStatisticClear_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,1,10),_H3cSIPStatisticClear_Type())
...
h3cSIPServerConfigTable=_H3cSIPServerConfigTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,2))
if mibBuilder.loadTexts:h3cSIPServerConfigTable.setStatus(_A)
_H3cSIPServerConfigEntry_Object=MibTableRow
h3cSIPServerConfigEntry=_H3cSIPServerConfigEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,2,1))
...
h3cSIPServerIPAddressType=_H3cSIPServerIPAddressType_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,2,1,1),_H3cSIPServerIPAddressType_Type())
...
h3cSIPServerIPAddress=_H3cSIPServerIPAddress_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,2,1,2),_H3cSIPServerIPAddress_Type())
...
h3cSIPServerPort=_H3cSIPServerPort_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,2,1,3),_H3cSIPServerPort_Type())
...
h3cSIPServerType=_H3cSIPServerType_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,2,1,4),_H3cSIPServerType_Type())
...
h3cSIPAcceptType=_H3cSIPAcceptType_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,2,1,5),_H3cSIPAcceptType_Type())
...
h3cSIPServerStatus=_H3cSIPServerStatus_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,2,1,6),_H3cSIPServerStatus_Type())
...
h3cSIPMsgStatTable=_H3cSIPMsgStatTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,3))
if mibBuilder.loadTexts:h3cSIPMsgStatTable.setStatus(_A)
_H3cSIPMsgStatEntry_Object=MibTableRow
h3cSIPMsgStatEntry=_H3cSIPMsgStatEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,3,1))
...
h3cSIPMsgIndex=_H3cSIPMsgIndex_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,3,1,1),_H3cSIPMsgIndex_Type())
...
h3cSIPMsgName=_H3cSIPMsgName_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,3,1,2),_H3cSIPMsgName_Type())
...
h3cSIPMsgSend=_H3cSIPMsgSend_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,3,1,3),_H3cSIPMsgSend_Type())
...
h3cSIPMsgOKSend=_H3cSIPMsgOKSend_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,3,1,4),_H3cSIPMsgOKSend_Type())
...
h3cSIPMsgReceive=_H3cSIPMsgReceive_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,3,1,5),_H3cSIPMsgReceive_Type())
...
h3cSIPMsgOKReceive=_H3cSIPMsgOKReceive_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,3,1,6),_H3cSIPMsgOKReceive_Type())
...
h3cSIPMsgResponseStatTable=_H3cSIPMsgResponseStatTable_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,4))
if mibBuilder.loadTexts:h3cSIPMsgResponseStatTable.setStatus(_A)
_H3cSIPMsgResponseStatEntry_Object=MibTableRow
h3cSIPMsgResponseStatEntry=_H3cSIPMsgResponseStatEntry_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,4,1))
...
h3cSIPMsgResponseIndex=_H3cSIPMsgResponseIndex_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,4,1,1),_H3cSIPMsgResponseIndex_Type())
...
h3cSIPMsgResponseCode=_H3cSIPMsgResponseCode_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,4,1,2),_H3cSIPMsgResponseCode_Type())
...
h3cSIPResCodeRecvCount=_H3cSIPResCodeRecvCount_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,4,1,3),_H3cSIPResCodeRecvCount_Type())
...
h3cSIPResCodeSendCount=_H3cSIPResCodeSendCount_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,1,4,1,4),_H3cSIPResCodeSendCount_Type())
...
h3cSIPTrapStubObjects=_H3cSIPTrapStubObjects_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,12,3))
...
h3cSIPRegisterFailReason=_H3cSIPRegisterFailReason_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,3,1),_H3cSIPRegisterFailReason_Type())
...
h3cSIPAuthenReqMethod=_H3cSIPAuthenReqMethod_Object((1,3,6,1,4,1,43,45,1,10,2,39,12,3,2),_H3cSIPAuthenReqMethod_Type())
...
h3cSIPClientNotifications=_H3cSIPClientNotifications_ObjectIdentity((1,3,6,1,4,1,43,45,1,10,2,39,12,4))
h3cSIPRegisterFailure=NotificationType((1,3,6,1,4,1,43,45,1,10,2,39,12,4,1))
h3cSIPRegisterFailure.setObjects(*((_B,_L),(_B,_H),(_B,_I),(_B,_J),(_B,_P)))
if mibBuilder.loadTexts:h3cSIPRegisterFailure.setStatus(_A)
h3cSIPAuthenticateFailure=NotificationType((1,3,6,1,4,1,43,45,1,10,2,39,12,4,2))
