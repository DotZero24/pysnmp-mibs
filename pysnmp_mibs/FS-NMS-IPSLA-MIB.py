...
nmsIpslaJitterObjects=_NmsIpslaJitterObjects_ObjectIdentity((1,3,6,1,4,1,52642,9,102,1))
_IpslaJitterTable_Object=MibTable
ipslaJitterTable=_IpslaJitterTable_Object((1,3,6,1,4,1,52642,9,102,1,1))
if mibBuilder.loadTexts:ipslaJitterTable.setStatus(_C)
_NmsIpslaJitterEntry_Object=MibTableRow
nmsIpslaJitterEntry=_NmsIpslaJitterEntry_Object((1,3,6,1,4,1,52642,9,102,1,1,1))
...
nmsIpslaJobEntryIndex=_NmsIpslaJobEntryIndex_Object((1,3,6,1,4,1,52642,9,102,1,1,1,1),_NmsIpslaJobEntryIndex_Type())
...
nmsIpslaJobSuccesses=_NmsIpslaJobSuccesses_Object((1,3,6,1,4,1,52642,9,102,1,1,1,2),_NmsIpslaJobSuccesses_Type())
...
nmsIpslaJobFailures=_NmsIpslaJobFailures_Object((1,3,6,1,4,1,52642,9,102,1,1,1,3),_NmsIpslaJobFailures_Type())
...
nmsIpslaJitterSamples=_NmsIpslaJitterSamples_Object((1,3,6,1,4,1,52642,9,102,1,1,1,4),_NmsIpslaJitterSamples_Type())
...
nmsIpslaJitterSrc2DstMin=_NmsIpslaJitterSrc2DstMin_Object((1,3,6,1,4,1,52642,9,102,1,1,1,5),_NmsIpslaJitterSrc2DstMin_Type())
...
nmsIpslaJitterSrc2DstMax=_NmsIpslaJitterSrc2DstMax_Object((1,3,6,1,4,1,52642,9,102,1,1,1,6),_NmsIpslaJitterSrc2DstMax_Type())
...
nmsIpslaJitterSrc2DstAvg=_NmsIpslaJitterSrc2DstAvg_Object((1,3,6,1,4,1,52642,9,102,1,1,1,7),_NmsIpslaJitterSrc2DstAvg_Type())
...
nmsIpslaJitterDst2SrcMin=_NmsIpslaJitterDst2SrcMin_Object((1,3,6,1,4,1,52642,9,102,1,1,1,8),_NmsIpslaJitterDst2SrcMin_Type())
...
nmsIpslaJitterDst2SrcMax=_NmsIpslaJitterDst2SrcMax_Object((1,3,6,1,4,1,52642,9,102,1,1,1,9),_NmsIpslaJitterDst2SrcMax_Type())
...
nmsIpslaJitterDst2SrcAvg=_NmsIpslaJitterDst2SrcAvg_Object((1,3,6,1,4,1,52642,9,102,1,1,1,10),_NmsIpslaJitterDst2SrcAvg_Type())
...
nmsIpslaJitterRttMin=_NmsIpslaJitterRttMin_Object((1,3,6,1,4,1,52642,9,102,1,1,1,11),_NmsIpslaJitterRttMin_Type())
...
nmsIpslaJitterRttMax=_NmsIpslaJitterRttMax_Object((1,3,6,1,4,1,52642,9,102,1,1,1,12),_NmsIpslaJitterRttMax_Type())
...
nmsIpslaJitterRttAvg=_NmsIpslaJitterRttAvg_Object((1,3,6,1,4,1,52642,9,102,1,1,1,13),_NmsIpslaJitterRttAvg_Type())
...
nmsIpslaEchoObjects=_NmsIpslaEchoObjects_ObjectIdentity((1,3,6,1,4,1,52642,9,102,2))
_IpslaEchoTable_Object=MibTable
ipslaEchoTable=_IpslaEchoTable_Object((1,3,6,1,4,1,52642,9,102,2,1))
if mibBuilder.loadTexts:ipslaEchoTable.setStatus(_C)
_NmsIpslaEchoEntry_Object=MibTableRow
nmsIpslaEchoEntry=_NmsIpslaEchoEntry_Object((1,3,6,1,4,1,52642,9,102,2,1,1))
...
nmsIpslaEchoTargetPort=_NmsIpslaEchoTargetPort_Object((1,3,6,1,4,1,52642,9,102,2,1,1,1),_NmsIpslaEchoTargetPort_Type())
...
nmsIpslaEchoSourcePort=_NmsIpslaEchoSourcePort_Object((1,3,6,1,4,1,52642,9,102,2,1,1,2),_NmsIpslaEchoSourcePort_Type())
...
nmsIpslaEchoRtt=_NmsIpslaEchoRtt_Object((1,3,6,1,4,1,52642,9,102,2,1,1,3),_NmsIpslaEchoRtt_Type())
...
nmsIpslaEchoProbeSent=_NmsIpslaEchoProbeSent_Object((1,3,6,1,4,1,52642,9,102,2,1,1,4),_NmsIpslaEchoProbeSent_Type())
...
nmsIpslaEchoProbeCompletion=_NmsIpslaEchoProbeCompletion_Object((1,3,6,1,4,1,52642,9,102,2,1,1,5),_NmsIpslaEchoProbeCompletion_Type())
