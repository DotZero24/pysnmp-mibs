...
alaVrrp3Notifications=_AlaVrrp3Notifications_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,28,2,0))
_AlaVrrp3Operations_ObjectIdentity=ObjectIdentity
alaVrrp3Operations=_AlaVrrp3Operations_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,28,2,1))
...
alaVrrp3NotificationCntl=_AlaVrrp3NotificationCntl_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,1),_AlaVrrp3NotificationCntl_Type())
...
alaVrrp3OperTable=_AlaVrrp3OperTable_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2))
if mibBuilder.loadTexts:alaVrrp3OperTable.setStatus(_B)
_AlaVrrp3OperEntry_Object=MibTableRow
alaVrrp3OperEntry=_AlaVrrp3OperEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1))
...
alaVrrp3OperIpVersion=_AlaVrrp3OperIpVersion_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,1),_AlaVrrp3OperIpVersion_Type())
...
alaVrrp3OperVrId=_AlaVrrp3OperVrId_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,2),_AlaVrrp3OperVrId_Type())
...
alaVrrp3OperVirtualMacAddr=_AlaVrrp3OperVirtualMacAddr_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,3),_AlaVrrp3OperVirtualMacAddr_Type())
...
alaVrrp3OperState=_AlaVrrp3OperState_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,4),_AlaVrrp3OperState_Type())
...
alaVrrp3OperAdminState=_AlaVrrp3OperAdminState_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,5),_AlaVrrp3OperAdminState_Type())
...
alaVrrp3OperPriority=_AlaVrrp3OperPriority_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,6),_AlaVrrp3OperPriority_Type())
...
alaVrrp3OperVersion=_AlaVrrp3OperVersion_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,7),_AlaVrrp3OperVersion_Type())
...
alaVrrp3OperIpAddrCount=_AlaVrrp3OperIpAddrCount_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,8),_AlaVrrp3OperIpAddrCount_Type())
...
alaVrrp3OperMasterIpAddrType=_AlaVrrp3OperMasterIpAddrType_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,9),_AlaVrrp3OperMasterIpAddrType_Type())
...
alaVrrp3OperMasterIpAddr=_AlaVrrp3OperMasterIpAddr_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,10),_AlaVrrp3OperMasterIpAddr_Type())
...
alaVrrp3OperPrimaryIpAddrType=_AlaVrrp3OperPrimaryIpAddrType_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,11),_AlaVrrp3OperPrimaryIpAddrType_Type())
...
alaVrrp3OperPrimaryIpAddr=_AlaVrrp3OperPrimaryIpAddr_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,12),_AlaVrrp3OperPrimaryIpAddr_Type())
...
alaVrrp3OperAdvInterval=_AlaVrrp3OperAdvInterval_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,13),_AlaVrrp3OperAdvInterval_Type())
...
alaVrrp3OperPreemptMode=_AlaVrrp3OperPreemptMode_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,14),_AlaVrrp3OperPreemptMode_Type())
...
alaVrrp3OperAcceptMode=_AlaVrrp3OperAcceptMode_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,15),_AlaVrrp3OperAcceptMode_Type())
...
alaVrrp3OperUpTime=_AlaVrrp3OperUpTime_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,16),_AlaVrrp3OperUpTime_Type())
...
alaVrrp3OperRowStatus=_AlaVrrp3OperRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,2,1,17),_AlaVrrp3OperRowStatus_Type())
...
alaVrrp3AssoIpAddrTable=_AlaVrrp3AssoIpAddrTable_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,3))
if mibBuilder.loadTexts:alaVrrp3AssoIpAddrTable.setStatus(_B)
_AlaVrrp3AssoIpAddrEntry_Object=MibTableRow
alaVrrp3AssoIpAddrEntry=_AlaVrrp3AssoIpAddrEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,3,1))
...
alaVrrp3AssoIpAddrType=_AlaVrrp3AssoIpAddrType_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,3,1,1),_AlaVrrp3AssoIpAddrType_Type())
alaVrrp3AssoIpAddrType.setMaxAccess(_J)
if mibBuilder.loadTexts:alaVrrp3AssoIpAddrType.setStatus(_B)
class _AlaVrrp3AssoIpAddr_Type(InetAddress):subtypeSpec=InetAddress.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueSizeConstraint(4,16))
_AlaVrrp3AssoIpAddr_Type.__name__=_K
_AlaVrrp3AssoIpAddr_Object=MibTableColumn
alaVrrp3AssoIpAddr=_AlaVrrp3AssoIpAddr_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,3,1,2),_AlaVrrp3AssoIpAddr_Type())
...
alaVrrp3AssoIpAddrRowStatus=_AlaVrrp3AssoIpAddrRowStatus_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,3,1,3),_AlaVrrp3AssoIpAddrRowStatus_Type())
...
alaVrrp3TrapNewMasterReason=_AlaVrrp3TrapNewMasterReason_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,4),_AlaVrrp3TrapNewMasterReason_Type())
...
alaVrrp3TrapProtoErrReason=_AlaVrrp3TrapProtoErrReason_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,1,5),_AlaVrrp3TrapProtoErrReason_Type())
...
alaVrrp3Statistics=_AlaVrrp3Statistics_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,28,2,2))
_AlaVrrp3RouterChecksumErrors_Type=Counter32
_AlaVrrp3RouterChecksumErrors_Object=MibScalar
alaVrrp3RouterChecksumErrors=_AlaVrrp3RouterChecksumErrors_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,1),_AlaVrrp3RouterChecksumErrors_Type())
...
alaVrrp3RouterVersionErrors=_AlaVrrp3RouterVersionErrors_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,2),_AlaVrrp3RouterVersionErrors_Type())
...
alaVrrp3RouterVrIdErrors=_AlaVrrp3RouterVrIdErrors_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,3),_AlaVrrp3RouterVrIdErrors_Type())
...
alaVrrp3RouterStatsTable=_AlaVrrp3RouterStatsTable_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4))
if mibBuilder.loadTexts:alaVrrp3RouterStatsTable.setStatus(_B)
_AlaVrrp3RouterStatsEntry_Object=MibTableRow
alaVrrp3RouterStatsEntry=_AlaVrrp3RouterStatsEntry_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1))
...
alaVrrp3StatsBecomeMaster=_AlaVrrp3StatsBecomeMaster_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,1),_AlaVrrp3StatsBecomeMaster_Type())
...
alaVrrp3StatsAdvertiseRcvd=_AlaVrrp3StatsAdvertiseRcvd_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,2),_AlaVrrp3StatsAdvertiseRcvd_Type())
...
alaVrrp3StatsAdvIntervalErrors=_AlaVrrp3StatsAdvIntervalErrors_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,3),_AlaVrrp3StatsAdvIntervalErrors_Type())
...
alaVrrp3StatsIpTtlErrors=_AlaVrrp3StatsIpTtlErrors_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,4),_AlaVrrp3StatsIpTtlErrors_Type())
...
alaVrrp3StatsPriZeroPktsRcvd=_AlaVrrp3StatsPriZeroPktsRcvd_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,5),_AlaVrrp3StatsPriZeroPktsRcvd_Type())
...
alaVrrp3StatsPriZeroPktsSent=_AlaVrrp3StatsPriZeroPktsSent_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,6),_AlaVrrp3StatsPriZeroPktsSent_Type())
...
alaVrrp3StatsInvldTypePktsRcvd=_AlaVrrp3StatsInvldTypePktsRcvd_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,7),_AlaVrrp3StatsInvldTypePktsRcvd_Type())
...
alaVrrp3StatsAddressListErrors=_AlaVrrp3StatsAddressListErrors_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,8),_AlaVrrp3StatsAddressListErrors_Type())
...
alaVrrp3StatsInvldAuthType=_AlaVrrp3StatsInvldAuthType_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,9),_AlaVrrp3StatsInvldAuthType_Type())
...
alaVrrp3StatsPacketLengthErrors=_AlaVrrp3StatsPacketLengthErrors_Object((1,3,6,1,4,1,6486,801,1,2,1,28,2,2,4,1,10),_AlaVrrp3StatsPacketLengthErrors_Type())
...
alaVrrp3Conformance=_AlaVrrp3Conformance_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,28,2,3))
_AlaVrrp3MIBCompliances_ObjectIdentity=ObjectIdentity
alaVrrp3MIBCompliances=_AlaVrrp3MIBCompliances_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,28,2,3,1))
_AlaVrrp3MIBGroups_ObjectIdentity=ObjectIdentity
alaVrrp3MIBGroups=_AlaVrrp3MIBGroups_ObjectIdentity((1,3,6,1,4,1,6486,801,1,2,1,28,2,3,2))
alaVrrp3OperGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,28,2,3,2,1))
...
alaVrrp3StatsGroup=ObjectGroup((1,3,6,1,4,1,6486,801,1,2,1,28,2,3,2,2))
