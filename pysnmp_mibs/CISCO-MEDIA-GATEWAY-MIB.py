...
mibBuilder.exportSymbols("CISCO-MEDIA-GATEWAY-MIB", cmgwV23Enabled=cmgwV23Enabled, cMediaGwStats=cMediaGwStats, cmgwIpConfigVpi=cmgwIpConfigVpi, cMediaGwCcCfgAal2SvcNamePrefix=cMediaGwCcCfgAal2SvcNamePrefix, cMediaGwRscStatsTable=cMediaGwRscStatsTable, cMediaGwCcCfgRtpNamePrefix=cMediaGwCcCfgRtpNamePrefix, cMediaGwCcCfgNsePayload=cMediaGwCcCfgNsePayload, cmgwLifNumber=cmgwLifNumber, cmgwConfigDomainNameIndex=cmgwConfigDomainNameIndex, cmgwPhysicalIndex=cmgwPhysicalIndex, cMediaGwCcCfgDefBearerTraffic=cMediaGwCcCfgDefBearerTraffic, cmgwDnsIpGroup=cmgwDnsIpGroup, cmgwConfigDomainNameEntity=cmgwConfigDomainNameEntity, cmgwDomainName=cmgwDomainName, cmgwSignalMgcProtocolPort=cmgwSignalMgcProtocolPort, cMediaGwIpGroup=cMediaGwIpGroup, cmgwIpConfigRowStatus=cmgwIpConfigRowStatus, cMediaGwGroupExtra=cMediaGwGroupExtra, cMediaGwMIBCompliance=cMediaGwMIBCompliance, cMediaGwCcCfgDescrInfoEnabled=cMediaGwCcCfgDescrInfoEnabled, cmgwDnsIp=cmgwDnsIp, cmgwGraceTime=cmgwGraceTime, cmgwIpConfigAddrType=cmgwIpConfigAddrType, cmgwConfigDomainNameRowStatus=cmgwConfigDomainNameRowStatus, cMediaGwRscStatsEntry=cMediaGwRscStatsEntry, cmgwIpConfigAddress=cmgwIpConfigAddress, cmgwRscMinimumUtilization=cmgwRscMinimumUtilization, cMediaGwCallControlConfigEntry=cMediaGwCallControlConfigEntry, cMediaGwCcCfgDefRtpNamePrefix=cMediaGwCcCfgDefRtpNamePrefix, cmgwSignalProtocolGroupRev3=cmgwSignalProtocolGroupRev3, CCallControlProfileIndexOrZero=CCallControlProfileIndexOrZero, cmgwCallControlGroupRev2=cmgwCallControlGroupRev2, cMediaGwDomainNameConfigTable=cMediaGwDomainNameConfigTable, cMediaGwMIBComplianceRev4=cMediaGwMIBComplianceRev4, cMediaGwDnsIpConfigEntry=cMediaGwDnsIpConfigEntry, cmgwSignalProtocolPreference=cmgwSignalProtocolPreference, cmgwCallControlGroup=cmgwCallControlGroup, cMediaGwCcCfgVbdJitterDelayMode=cMediaGwCcCfgVbdJitterDelayMode, cmgwRscStatsIndex=cmgwRscStatsIndex, cMediaGwGroup=cMediaGwGroup, cmgwSignalProtocolVersion=cmgwSignalProtocolVersion, cMediaGwGroupRev1=cMediaGwGroupRev1, cMediaGwDomainNameConfigEntry=cMediaGwDomainNameConfigEntry, cMediaGwCcCfgAal1SvcNamePrefix=cMediaGwCcCfgAal1SvcNamePrefix, cmgwIpConfigVci=cmgwIpConfigVci, ciscoMediaGatewayMIBNotifs=ciscoMediaGatewayMIBNotifs, CVoiceTonePlanIndexOrZero=CVoiceTonePlanIndexOrZero, cmgwSignalProtocolEntry=cmgwSignalProtocolEntry, cmgwSignalProtocolConfigVer=cmgwSignalProtocolConfigVer, cMediaGwMIBConformance=cMediaGwMIBConformance, cMediaGwMIBComplianceRev5=cMediaGwMIBComplianceRev5, cmgwVtMappingMode=cmgwVtMappingMode, cMediaGwCallControlConfigTable=cMediaGwCallControlConfigTable, cmgwIpConfigSubnetMask=cmgwIpConfigSubnetMask, cmgwConfigDomainName=cmgwConfigDomainName, cMediaGwGroupRev2=cMediaGwGroupRev2, cMediaGwConfig=cMediaGwConfig, cMediaGwCcCfgVbdJitterMinDelay=cMediaGwCcCfgVbdJitterMinDelay, cmgwDnsIpIndex=cmgwDnsIpIndex, GatewayLifNumber=GatewayLifNumber, cMediaGwEntry=cMediaGwEntry, cMediaGwMIBComplianceRev3=cMediaGwMIBComplianceRev3, CCallControlProfileIndex=CCallControlProfileIndex, cmgwSignalProtocolTable=cmgwSignalProtocolTable, cMediaGwRscStatsGroup=cMediaGwRscStatsGroup, cmgwIpConfigIfIndex=cmgwIpConfigIfIndex, cMediaGwDnsIpConfigTable=cMediaGwDnsIpConfigTable, cmgwLifTable=cmgwLifTable, cMediaGwCcCfgVbdJitterMaxDelay=cMediaGwCcCfgVbdJitterMaxDelay, CVoiceTonePlanIndex=CVoiceTonePlanIndex, cMediaGwCcCfgNseRespTimer=cMediaGwCcCfgNseRespTimer, cMediaGwCcCfgClusterEnabled=cMediaGwCcCfgClusterEnabled, cmgwLifEntry=cmgwLifEntry, cmgwDnsIpType=cmgwDnsIpType, cmgwSignalProtocol=cmgwSignalProtocol, cMediaGwTable=cMediaGwTable, cmgwDomainNameGroup=cmgwDomainNameGroup, cmgwRscAverageUtilization=cmgwRscAverageUtilization, cmgwAdminState=cmgwAdminState, cmgwIpConfigForRemoteMapping=cmgwIpConfigForRemoteMapping, cMediaGwMIBCompliances=cMediaGwMIBCompliances, cmgwSignalProtocolGroupRev2=cmgwSignalProtocolGroupRev2, cMediaGwIpConfigEntry=cMediaGwIpConfigEntry, ciscoMediaGatewayMIB=ciscoMediaGatewayMIB, cMediaGwMIBGroups=cMediaGwMIBGroups, cmgwServiceState=cmgwServiceState, cmgwCallControlGroupRev1=cmgwCallControlGroupRev1, CGwServiceState=CGwServiceState, cmgwSrcFilterEnabled=cmgwSrcFilterEnabled, cmgwIpConfigDefaultGwIp=cmgwIpConfigDefaultGwIp, PYSNMP_MODULE_ID=ciscoMediaGatewayMIB, cMediaGwCcCfgDefaultTonePlanId=cMediaGwCcCfgDefaultTonePlanId, cMediaGwCcCfgVbdJitterNomDelay=cMediaGwCcCfgVbdJitterNomDelay, cmgwRscMaximumUtilization=cmgwRscMaximumUtilization, cMediaGwCcCfgControlTos=cMediaGwCcCfgControlTos, cmgwLawInterceptEnabled=cmgwLawInterceptEnabled, cMediaGwMIBComplianceRev2=cMediaGwMIBComplianceRev2, cMediaGwIpConfigTable=cMediaGwIpConfigTable, cmgwSignalProtocolGroup=cmgwSignalProtocolGroup, cmgwLifPvcCount=cmgwLifPvcCount, cmgwIpConfigIndex=cmgwIpConfigIndex, cmgwSignalProtocolPort=cmgwSignalProtocolPort, ciscoMediaGatewayMIBObjects=ciscoMediaGatewayMIBObjects, cmgwSignalProtocolIndex=cmgwSignalProtocolIndex, cMediaGwCcCfgDsNamePrefix=cMediaGwCcCfgDsNamePrefix, CCallControlJitterDelayMode=CCallControlJitterDelayMode, cmgwIndex=cmgwIndex, cMediaGwCcCfgNtePayload=cMediaGwCcCfgNtePayload, cmgwRscSinceLastReset=cmgwRscSinceLastReset, cMediaGwMIBComplianceRev1=cMediaGwMIBComplianceRev1, cmgwDnsDomainName=cmgwDnsDomainName, cmgwDnsIpRowStatus=cmgwDnsIpRowStatus, cmgwSignalProtocolGroupRev1=cmgwSignalProtocolGroupRev1, cmgwLifVoiceIfCount=cmgwLifVoiceIfCount, cMediaGwCcCfgBearerTos=cMediaGwCcCfgBearerTos, cmgwLifGroup=cmgwLifGroup, CGwAdminState=CGwAdminState)
