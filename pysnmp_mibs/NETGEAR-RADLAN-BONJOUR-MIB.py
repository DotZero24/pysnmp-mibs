# SNMP MIB module (NETGEAR-RADLAN-BONJOUR-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/netgear/NETGEAR-RADLAN-BONJOUR-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:25:48 2025
...
rlBonjourStatusEntry = _RlBonjourStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 114, 2, 1)
)
rlBonjourStatusEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-BONJOUR-MIB", "rlBonjourStatusServiceName"),
    (0, "NETGEAR-RADLAN-BONJOUR-MIB", "rlBonjourStatusIPInterfaceType"),
    (0, "NETGEAR-RADLAN-BONJOUR-MIB", "rlBonjourStatusIPInterfaceAddr"),
)
if mibBuilder.loadTexts:
...
rlBonjourStateEntry = _RlBonjourStateEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 17, 114, 3, 1)
)
rlBonjourStateEntry.setIndexNames(
    (0, "NETGEAR-RADLAN-BONJOUR-MIB", "rlBonjourStateServiceName"),
    (0, "NETGEAR-RADLAN-BONJOUR-MIB", "rlBonjourStateL2Interface"),
)
if mibBuilder.loadTexts:
