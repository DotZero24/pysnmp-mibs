# SNMP MIB module (ARICENT-DHCPv6-RELAY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/aricent/ARICENT-DHCPv6-RELAY-MIB
...
class _FsDhcp6RlyPDRouteControl_Type(Integer32):
    """Custom type fsDhcp6RlyPDRouteControl based on Integer32"""
    defaultValue = 1
...
fsDhcp6RlyIfIndex = _FsDhcp6RlyIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 1),
...
fsDhcp6RlyIfHopThreshold = _FsDhcp6RlyIfHopThreshold_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 3),
...
fsDhcp6RlyIfInformIn = _FsDhcp6RlyIfInformIn_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 4),
...
fsDhcp6RlyIfRelayForwIn = _FsDhcp6RlyIfRelayForwIn_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 5),
...
fsDhcp6RlyIfRelayReplyIn = _FsDhcp6RlyIfRelayReplyIn_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 6),
...
fsDhcp6RlyIfInvalidPktIn = _FsDhcp6RlyIfInvalidPktIn_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 10),
...
fsDhcp6RlyIfCounterRest = _FsDhcp6RlyIfCounterRest_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 11),
...
fsDhcp6RlyIfRowStatus = _FsDhcp6RlyIfRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 12),
...
fsDhcp6RlyIfRemoteIdOption = _FsDhcp6RlyIfRemoteIdOption_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 13),
...
fsDhcp6RlyIfRemoteIdDUID = _FsDhcp6RlyIfRemoteIdDUID_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 14),
...
fsDhcp6RlyIfRemoteIdOptionValue = _FsDhcp6RlyIfRemoteIdOptionValue_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 15),
...
fsDhcp6RlyIfRemoteIdUserDefined = _FsDhcp6RlyIfRemoteIdUserDefined_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 16),
...
fsDhcp6RlyIfRelayForwOut = _FsDhcp6RlyIfRelayForwOut_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 17),
    _FsDhcp6RlyIfRelayForwOut_Type()
)
fsDhcp6RlyIfRelayForwOut.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsDhcp6RlyIfRelayForwOut.setStatus("current")
_FsDhcp6RlyIfRelayReplyOut_Type = Counter32
_FsDhcp6RlyIfRelayReplyOut_Object = MibTableColumn
fsDhcp6RlyIfRelayReplyOut = _FsDhcp6RlyIfRelayReplyOut_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 18),
    _FsDhcp6RlyIfRelayReplyOut_Type()
)
fsDhcp6RlyIfRelayReplyOut.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fsDhcp6RlyIfRelayReplyOut.setStatus("current")


class _FsDhcp6RlyIfRelayState_Type(Integer32):
    """Custom type fsDhcp6RlyIfRelayState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_FsDhcp6RlyIfRelayState_Type.__name__ = "Integer32"
_FsDhcp6RlyIfRelayState_Object = MibTableColumn
fsDhcp6RlyIfRelayState = _FsDhcp6RlyIfRelayState_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 1, 1, 19),
    _FsDhcp6RlyIfRelayState_Type()
)
fsDhcp6RlyIfRelayState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    fsDhcp6RlyIfRelayState.setStatus("current")
_FsDhcp6RlySrvAddressTable_Object = MibTable
fsDhcp6RlySrvAddressTable = _FsDhcp6RlySrvAddressTable_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 2)
)
if mibBuilder.loadTexts:
...
fsDhcp6RlySrvAddressEntry = _FsDhcp6RlySrvAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 2, 1)
)
fsDhcp6RlySrvAddressEntry.setIndexNames(
    (0, "ARICENT-DHCPv6-RELAY-MIB", "fsDhcp6RlyInIfIndex"),
    (0, "ARICENT-DHCPv6-RELAY-MIB", "fsDhcp6RlySrvAddress"),
)
if mibBuilder.loadTexts:
...
fsDhcp6RlyInIfIndex = _FsDhcp6RlyInIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 2, 1, 1),
...
fsDhcp6RlySrvAddress = _FsDhcp6RlySrvAddress_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 2, 1, 2),
...
fsDhcp6RlySrvAddressRowStatus = _FsDhcp6RlySrvAddressRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 2, 1, 3),
...
fsDhcp6RlyOutIfEntry = _FsDhcp6RlyOutIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 3, 1)
)
fsDhcp6RlyOutIfEntry.setIndexNames(
    (0, "ARICENT-DHCPv6-RELAY-MIB", "fsDhcp6RlyInIfIndex"),
    (0, "ARICENT-DHCPv6-RELAY-MIB", "fsDhcp6RlySrvAddress"),
    (0, "ARICENT-DHCPv6-RELAY-MIB", "fsDhcp6RlyOutIfIndex"),
)
if mibBuilder.loadTexts:
...
fsDhcp6RlyOutIfIndex = _FsDhcp6RlyOutIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 3, 1, 1),
...
fsDhcp6RlyOutIfRowStatus = _FsDhcp6RlyOutIfRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 2, 3, 1, 2),
...
fsDhcp6RlyRlyInvalidPacketTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 29601, 2, 41, 0, 1)
)
fsDhcp6RlyRlyInvalidPacketTrap.setObjects(
      *(("ARICENT-DHCPv6-RELAY-MIB", "fsDhcp6RlyTrapInvalidMsgType"),
        ("ARICENT-DHCPv6-RELAY-MIB", "fsDhcp6RlyTrapIfIndex"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"fsdhcpv6rly": fsdhcpv6rly,
       ...
       "fsDhcp6RlyIfRelayForwOut": fsDhcp6RlyIfRelayForwOut,
       "fsDhcp6RlyIfRelayReplyOut": fsDhcp6RlyIfRelayReplyOut,
       "fsDhcp6RlyIfRelayState": fsDhcp6RlyIfRelayState,
