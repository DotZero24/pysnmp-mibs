...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/samsung/SAMSUNG-PRINTER-EXT-MIB
...
prtInterpreterEntry, prtChannelEntry, prtOutputEntry, prtGeneralEntry, prtInterpreterIndex, prtInputEntry, PresentOnOff = mibBuilder.importSymbols("Printer-MIB", "prtInterpreterEntry", "prtChannelEntry", "prtOutputEntry", "prtGeneralEntry", "prtInterpreterIndex", "prtInputEntry", "PresentOnOff")
...
mibBuilder.exportSymbols("SAMSUNG-PRINTER-EXT-MIB", scmPrtIPPCollatedCopiesUBound=scmPrtIPPCollatedCopiesUBound, scmPrtMarkerTonerSave=scmPrtMarkerTonerSave, scmPrtKS5843Simple=scmPrtKS5843Simple, scmPrtMarkerTonerSaveOptions=scmPrtMarkerTonerSaveOptions, scmPrtIPPJobMediaSheetsSupportedLBound=scmPrtIPPJobMediaSheetsSupportedLBound, scmPrtCount=scmPrtCount, scmPrtIPPNumberUp=scmPrtIPPNumberUp, scmPrtGeneralPrncolorPPM=scmPrtGeneralPrncolorPPM, scmPrtMarkerDensityOptions=scmPrtMarkerDensityOptions, scmPrtAlertAlarmShortage=scmPrtAlertAlarmShortage, scmPrtChannelSimple=scmPrtChannelSimple, PYSNMP_MODULE_ID=scmPrintMIB, scmPrtInterpLineTerm=scmPrtInterpLineTerm, scmPrtIPPColorSupported=scmPrtIPPColorSupported, scmPrtIPPJobKOctetsProcessed=scmPrtIPPJobKOctetsProcessed, scmPrtIPPJobKOctetsSupportedLBound=scmPrtIPPJobKOctetsSupportedLBound, scmPrtGeneral=scmPrtGeneral, scmPrtOutputTable=scmPrtOutputTable, scmPrtConfiguratioinGroup=scmPrtConfiguratioinGroup, scmPrtGeneralGroup=scmPrtGeneralGroup, scmPrtMarkerSrtOptions=scmPrtMarkerSrtOptions, scmPrtKSSMTopMargin=scmPrtKSSMTopMargin, scmPrtMarkerMarginUnit=scmPrtMarkerMarginUnit, scmPrtMarkerResolutionOptions=scmPrtMarkerResolutionOptions, scmPrtIPPCollatedCopies=scmPrtIPPCollatedCopies, scmPrtConsoleDisplayBufferLcdLangType=scmPrtConsoleDisplayBufferLcdLangType, scmPrtKS5843FontOptions=scmPrtKS5843FontOptions, scmPrtCountColorant=scmPrtCountColorant, scmPrtIPPJobSheets=scmPrtIPPJobSheets, scmPrtConfigurationTable=scmPrtConfigurationTable, scmPrtInputPaperTypeOptions=scmPrtInputPaperTypeOptions, scmPrtConsoleDisplayBufferSimple=scmPrtConsoleDisplayBufferSimple, scmPrtPCLCourierOptions=scmPrtPCLCourierOptions, scmPrtMarkerTonerOutAction=scmPrtMarkerTonerOutAction, scmPrtCountDrumImageCountReset=scmPrtCountDrumImageCountReset, scmPrtAlert=scmPrtAlert, scmPrtCountUnit=scmPrtCountUnit, scmPrtOperationTable=scmPrtOperationTable, scmPrtIPPJobImpressionsSupportedUBound=scmPrtIPPJobImpressionsSupportedUBound, scmPrtInputPaperSize=scmPrtInputPaperSize, scmPrtSerialBobuxonOptions=scmPrtSerialBobuxonOptions, scmPrtIPPJobImpressionsCompleted=scmPrtIPPJobImpressionsCompleted, scmPrtMarkerDensity=scmPrtMarkerDensity, scmPrtBaseRowStatus=scmPrtBaseRowStatus, scmPrtCountPickupMPReset=scmPrtCountPickupMPReset, scmPrtOperationEntry=scmPrtOperationEntry, scmPrtIPP=scmPrtIPP, scmPrtInputTrayPriority=scmPrtInputTrayPriority, scmPrtCountMediaSize=scmPrtCountMediaSize, scmPrtConfigurationAltitudeAction=scmPrtConfigurationAltitudeAction, scmPrtBaseIndex=scmPrtBaseIndex, scmPrtAlertAlarmShortageOptions=scmPrtAlertAlarmShortageOptions, scmPrtMIBGroups=scmPrtMIBGroups, scmPrtCountTwoRollerReset=scmPrtCountTwoRollerReset, scmPrtConfigurationSimple=scmPrtConfigurationSimple, scmPrtKSSMFont=scmPrtKSSMFont, scmPrtPCL=scmPrtPCL, scmPrtSerial=scmPrtSerial, scmPrtGeneralPrnSerialNo=scmPrtGeneralPrnSerialNo, scmPrtIPPFinishingsSupported=scmPrtIPPFinishingsSupported, scmPrtBaseGroup=scmPrtBaseGroup, scmPrtInputUseCustomSize=scmPrtInputUseCustomSize, scmPrtPCLSimple=scmPrtPCLSimple, scmPrtGeneralPrnOSFWVer=scmPrtGeneralPrnOSFWVer, scmPrtPCLTable=scmPrtPCLTable, scmPrtConfigurationJam2Recover=scmPrtConfigurationJam2Recover, scmPrtSerialEntry=scmPrtSerialEntry, scmPrtPCLWideA4=scmPrtPCLWideA4, scmPrtOutputPassword=scmPrtOutputPassword, scmPrtKSSMCPIOptions=scmPrtKSSMCPIOptions, scmPrtPCLAppendCROptions=scmPrtPCLAppendCROptions, scmPrtOperationOpcCleanOptions=scmPrtOperationOpcCleanOptions, scmPrtMarker=scmPrtMarker, scmPrtPCLAppendCR=scmPrtPCLAppendCR, scmPrtOutputNextIndex=scmPrtOutputNextIndex, scmPrtPCLGroup=scmPrtPCLGroup, scmPrtCountValue=scmPrtCountValue, scmPrtKSSM=scmPrtKSSM, scmPrtKSSMCPI=scmPrtKSSMCPI, scmPrtKSSMSimple=scmPrtKSSMSimple, scmPrtCountPickupTray2Reset=scmPrtCountPickupTray2Reset, scmPrtOperationPrintFontRequest=scmPrtOperationPrintFontRequest, scmPrtOperationMenuClearOptions=scmPrtOperationMenuClearOptions, scmPrtPCLSymbolSet=scmPrtPCLSymbolSet, scmPrtGeneralPrnPSFWVer=scmPrtGeneralPrnPSFWVer, scmPrtMarkerTonerOutActionOptions=scmPrtMarkerTonerOutActionOptions, scmPrtCountTransferImageCount=scmPrtCountTransferImageCount, scmPrtInterpreterSimple=scmPrtInterpreterSimple, scmPrtInputGroup=scmPrtInputGroup, scmPrtOutput=scmPrtOutput, scmPrtChannel=scmPrtChannel, scmPrtCountTwoRollerCount=scmPrtCountTwoRollerCount, scmPrtMarkerTable=scmPrtMarkerTable, scmPrtSerialGroup=scmPrtSerialGroup, scmPrtCountIndex=scmPrtCountIndex, scmPrtBaseEntry=scmPrtBaseEntry, scmPrtGeneralTable=scmPrtGeneralTable, scmPrtCountFuserImageCount=scmPrtCountFuserImageCount, scmPrtMarkerGroup=scmPrtMarkerGroup, scmPrtOutputEntry=scmPrtOutputEntry, scmPrtGeneralPrnPCL5CeVer=scmPrtGeneralPrnPCL5CeVer, scmPrtInterpOrientation=scmPrtInterpOrientation, scmPrtConfigurationAutoCountOptions=scmPrtConfigurationAutoCountOptions, scmPrtGeneralPrnMainSystemVer=scmPrtGeneralPrnMainSystemVer, scmPrtPCLTopMargin=scmPrtPCLTopMargin, scmPrtMarkerResolution=scmPrtMarkerResolution, scmPrtMarkerEntry=scmPrtMarkerEntry, scmPrtIPPPageRangesSupported=scmPrtIPPPageRangesSupported, scmPrtKS5843Lines=scmPrtKS5843Lines, scmPrtOperationFuserCleanOptions=scmPrtOperationFuserCleanOptions, scmPrintMIB=scmPrintMIB, scmPrtChannelTable=scmPrtChannelTable, scmPrtPCLCourier=scmPrtPCLCourier, scmPrtConfigurationPowerSaveOptions=scmPrtConfigurationPowerSaveOptions, scmPrtIPPJobKOctetsSupportedUBound=scmPrtIPPJobKOctetsSupportedUBound, scmPrtInputNextPrtInputIndex=scmPrtInputNextPrtInputIndex, scmPrtOperationJobCancel=scmPrtOperationJobCancel, scmPrtAlertGroup=scmPrtAlertGroup, scmPrtInterpRowStatus=scmPrtInterpRowStatus, scmPrtSerialBobuxon=scmPrtSerialBobuxon, scmPrtIPPSimple=scmPrtIPPSimple, scmPrtInputCustDimFeedDirDecl=scmPrtInputCustDimFeedDirDecl, scmPrtConsoleDisplayBufferLcdLangTypeOptions=scmPrtConsoleDisplayBufferLcdLangTypeOptions, scmPrtSerialNbaudRate=scmPrtSerialNbaudRate, scmPrtOperationTestPrtRequest=scmPrtOperationTestPrtRequest, scmPrtCountResolution=scmPrtCountResolution, scmPrtSerialBrOptions=scmPrtSerialBrOptions, scmPrtConfigurationPowerSave=scmPrtConfigurationPowerSave, scmPrtInterpreterTable=scmPrtInterpreterTable, scmPrtConsoleDisplayBufferGroup=scmPrtConsoleDisplayBufferGroup, scmPrtOutputFinishier=scmPrtOutputFinishier, scmPrtIPPJobMediaSheetsCompleted=scmPrtIPPJobMediaSheetsCompleted, scmPrtInputPaperSizeOptions=scmPrtInputPaperSizeOptions, scmPrtOperarionMenuClear=scmPrtOperarionMenuClear, scmPrtBaseTable=scmPrtBaseTable, scmPrtInterpreterEntry=scmPrtInterpreterEntry, scmPrtGeneralEntry=scmPrtGeneralEntry, scmPrtIPPFinishings=scmPrtIPPFinishings, scmPrtMIBCompliance=scmPrtMIBCompliance, scmPrtKSSMAutoWrap=scmPrtKSSMAutoWrap, scmPrtMarkerSmetModeOptions=scmPrtMarkerSmetModeOptions, scmPrtInputSimple=scmPrtInputSimple, scmPrtKS5843Topmargin=scmPrtKS5843Topmargin, scmPrtInput=scmPrtInput, scmPrtGeneralPrnModelDescr=scmPrtGeneralPrnModelDescr, scmPrtInputTrayNumOptions=scmPrtInputTrayNumOptions, scmPrtMarkerTonerColor=scmPrtMarkerTonerColor, scmPrtKSSMCodeOptions=scmPrtKSSMCodeOptions, scmPrtCountPickupTray1Reset=scmPrtCountPickupTray1Reset, scmPrtPCLEntry=scmPrtPCLEntry, scmPrtCountTable=scmPrtCountTable, scmPrtKS5843Font=scmPrtKS5843Font, scmPrtInputTrayNum=scmPrtInputTrayNum, scmPrtMarkerShortEdgeBindingMargin=scmPrtMarkerShortEdgeBindingMargin, scmPrtInputCustDimXFeedDirDecl=scmPrtInputCustDimXFeedDirDecl, scmPrtSerialTable=scmPrtSerialTable, scmPrtConsoleDisplayBuffer=scmPrtConsoleDisplayBuffer, scmPrtGeneralPrnModelVer=scmPrtGeneralPrnModelVer, scmPrtPCLPointSize=scmPrtPCLPointSize, scmPrtBase=scmPrtBase, scmPrtConfigurationIndex=scmPrtConfigurationIndex, scmPrtInterpProcessBarcodes=scmPrtInterpProcessBarcodes, scmPrtKS5843cpi=scmPrtKS5843cpi, scmPrtKSSMAutoWrapOptions=scmPrtKSSMAutoWrapOptions, scmPrtKSSMSiteMode=scmPrtKSSMSiteMode, scmPrtIPPNumberUpOptions=scmPrtIPPNumberUpOptions, scmPrtIPPCollatedCopiesLBound=scmPrtIPPCollatedCopiesLBound, scmPrtPCLLeftMargin=scmPrtPCLLeftMargin, scmPrtPCLFormLine=scmPrtPCLFormLine, scmPrtKSSMCode=scmPrtKSSMCode, scmPrtGeneralPrnScanFWVer=scmPrtGeneralPrnScanFWVer, scmPrtCountDuplex=scmPrtCountDuplex, scmPrtGeneralPrnPCLFWVer=scmPrtGeneralPrnPCLFWVer, scmPrtInputLockTray=scmPrtInputLockTray, scmPrtInterpOrientationOptions=scmPrtInterpOrientationOptions, scmPrtGeneralRowStatus=scmPrtGeneralRowStatus, scmPrtOutputRowStatus=scmPrtOutputRowStatus, scmPrtMarkerTonerIndex=scmPrtMarkerTonerIndex, scmPrtInterpreterEmulationOptions=scmPrtInterpreterEmulationOptions, scmPrtKS5843AutoWrap=scmPrtKS5843AutoWrap, scmPrtMarkerLongEdgeBindingMargin=scmPrtMarkerLongEdgeBindingMargin, scmPrtCountFuserImageCountReset=scmPrtCountFuserImageCountReset, scmPrtKS5843Code=scmPrtKS5843Code, scmPrtGeneralSimple=scmPrtGeneralSimple, scmPrtCountGroup=scmPrtCountGroup, scmPrtGeneralPrnSPLVer=scmPrtGeneralPrnSPLVer, scmPrtKS5843Sitemode=scmPrtKS5843Sitemode, scmPrtGeneralPrnVendor=scmPrtGeneralPrnVendor, scmPrtMarkerduplexLeftMargin=scmPrtMarkerduplexLeftMargin, scmPrtMarkerTonerLevel=scmPrtMarkerTonerLevel, scmPrtKS5843AutoWrapOptions=scmPrtKS5843AutoWrapOptions, scmPrtKSSMGroup=scmPrtKSSMGroup, scmPrtChannelGroup=scmPrtChannelGroup, scmPrtOperationOpcClean=scmPrtOperationOpcClean, scmPrtOperation=scmPrtOperation, scmPrtGeneralPrnKS5895Ver=scmPrtGeneralPrnKS5895Ver, scmPrtCountTransferImageCountReset=scmPrtCountTransferImageCountReset, scmPrtInputLockTrayOptions=scmPrtInputLockTrayOptions, scmPrtIPPPrintQualityOptions=scmPrtIPPPrintQualityOptions, scmPrtCountType=scmPrtCountType, scmPrtOutputTrayTimeout=scmPrtOutputTrayTimeout, scmPrtChannelRowStatus=scmPrtChannelRowStatus, scmPrtPCLPitch=scmPrtPCLPitch, scmPrtKS5843Zoom=scmPrtKS5843Zoom, scmPrtOperationFuserClean=scmPrtOperationFuserClean, scmPrtCountDeviceType=scmPrtCountDeviceType, scmPrtChannelEOJTimeout=scmPrtChannelEOJTimeout, scmPrtMarkerSmetMode=scmPrtMarkerSmetMode, scmPrtKS5843Group=scmPrtKS5843Group, scmPrtGeneralPrnKSSMVer=scmPrtGeneralPrnKSSMVer, scmPrtMIBConformance=scmPrtMIBConformance, scmPrtOperationIndex=scmPrtOperationIndex, scmPrtInterpreterEmulation=scmPrtInterpreterEmulation, scmPrtPCLFont=scmPrtPCLFont, scmPrtIPPJobImpressionsSupportedLBound=scmPrtIPPJobImpressionsSupportedLBound, scmPrtKSSMLines=scmPrtKSSMLines, scmPrtCountSimple=scmPrtCountSimple, scmPrtCountEntry=scmPrtCountEntry, scmPrtGeneralPrnManufacture=scmPrtGeneralPrnManufacture, scmPrtConfigurationEntry=scmPrtConfigurationEntry, scmPrtSerialIndex=scmPrtSerialIndex, scmPrtOperationPrintBlackOnly=scmPrtOperationPrintBlackOnly, scmPrtOutputGroup=scmPrtOutputGroup, scmPrtOutputTrayTimeoutSupport=scmPrtOutputTrayTimeoutSupport, scmPrtMarkerSrt=scmPrtMarkerSrt, scmPrtIPPGroup=scmPrtIPPGroup, scmPrtMarkerTonerColorDescription=scmPrtMarkerTonerColorDescription, scmPrtGeneralPrnKS5843Ver=scmPrtGeneralPrnKS5843Ver, scmPrtCountDrumImageCount=scmPrtCountDrumImageCount, scmPrtCountPickupTray1Count=scmPrtCountPickupTray1Count, scmPrtInputTable=scmPrtInputTable, scmPrtCountPickupTray2Count=scmPrtCountPickupTray2Count, scmPrtKSSMZoom=scmPrtKSSMZoom, scmPrtPCLWideA4Options=scmPrtPCLWideA4Options, scmPrtKS5843=scmPrtKS5843, scmPrtOutputFinishierOptions=scmPrtOutputFinishierOptions, scmPrtMarkerduplexTopMargin=scmPrtMarkerduplexTopMargin, scmPrtOperationGroup=scmPrtOperationGroup, scmPrtInterpreterCopyNum=scmPrtInterpreterCopyNum, scmPrtConfigurationAltitudeActionOptions=scmPrtConfigurationAltitudeActionOptions, scmPrtOperationSimple=scmPrtOperationSimple, scmPrtInputTraySwitchOptions=scmPrtInputTraySwitchOptions, scmPrtGeneralPrnModelName=scmPrtGeneralPrnModelName, scmPrtPCLIndex=scmPrtPCLIndex, scmPrtGeneralPrnEpsonVer=scmPrtGeneralPrnEpsonVer, scmPrtInterpJobCopiesDefault=scmPrtInterpJobCopiesDefault, scmPrtMediaPath=scmPrtMediaPath, scmPrtConfiguration=scmPrtConfiguration, scmPrtKSSMFontOptions=scmPrtKSSMFontOptions, scmPrtConfigurationJam2RecOptions=scmPrtConfigurationJam2RecOptions, scmPrtInputPaperType=scmPrtInputPaperType, scmPrtInterpreterGroup=scmPrtInterpreterGroup, scmPrtGeneralPrnEngFWVer=scmPrtGeneralPrnEngFWVer, scmPrtIPPJobMediaSheetsSupportedUBound=scmPrtIPPJobMediaSheetsSupportedUBound)
mibBuilder.exportSymbols("SAMSUNG-PRINTER-EXT-MIB", scmPrtKS5843CodeOptions=scmPrtKS5843CodeOptions, scmPrtGeneralPrnPCL5eVer=scmPrtGeneralPrnPCL5eVer, scmPrtSerialSimple=scmPrtSerialSimple, scmPrtChannelEntry=scmPrtChannelEntry, scmPrtInputRowStatus=scmPrtInputRowStatus, scmPrtAlertSimple=scmPrtAlertSimple, scmPrtInputEntry=scmPrtInputEntry, scmPrtInterpreter=scmPrtInterpreter, scmPrtOutputOffsetStackingType=scmPrtOutputOffsetStackingType, scmPrtMarkerSimple=scmPrtMarkerSimple, scmPrtConfigurationAutocont=scmPrtConfigurationAutocont, scmPrtKS5843cpiOptions=scmPrtKS5843cpiOptions, scmPrtInputTraySwitch=scmPrtInputTraySwitch, scmPrtCountPickupMPCount=scmPrtCountPickupMPCount, scmPrtIPPPrintQuality=scmPrtIPPPrintQuality, scmPrtGeneralPrnSCFFWVer=scmPrtGeneralPrnSCFFWVer)
