...
prtInputEntry, PresentOnOff, prtGeneralEntry, prtInterpreterIndex, prtChannelEntry, prtOutputEntry, prtInterpreterEntry = mibBuilder.importSymbols("Printer-MIB", "prtInputEntry", "PresentOnOff", "prtGeneralEntry", "prtInterpreterIndex", "prtChannelEntry", "prtOutputEntry", "prtInterpreterEntry")
samsungCommonMIB, = mibBuilder.importSymbols("SAMSUNG-COMMON-MIB", "samsungCommonMIB")
Cardinal32, Ordinal32 = mibBuilder.importSymbols("SAMSUNG-GENERAL-TC", "Cardinal32", "Ordinal32")
...
mibBuilder.exportSymbols("SAMSUNG-PRINTER-EXT-MIB", scmPrtConsoleDisplayBuffer=scmPrtConsoleDisplayBuffer, scmPrtSerialGroup=scmPrtSerialGroup, scmPrtOutputPassword=scmPrtOutputPassword, scmPrtSerialBrOptions=scmPrtSerialBrOptions, scmPrtKSSMSimple=scmPrtKSSMSimple, scmPrtKSSMFontOptions=scmPrtKSSMFontOptions, scmPrtCountGroup=scmPrtCountGroup, scmPrtInputNextPrtInputIndex=scmPrtInputNextPrtInputIndex, scmPrtSerialNbaudRate=scmPrtSerialNbaudRate, scmPrtKSSMGroup=scmPrtKSSMGroup, scmPrtChannelEOJTimeout=scmPrtChannelEOJTimeout, scmPrtConsoleDisplayBufferGroup=scmPrtConsoleDisplayBufferGroup, scmPrtMediaPath=scmPrtMediaPath, scmPrtCountType=scmPrtCountType, scmPrtCountUnit=scmPrtCountUnit, scmPrtOutputGroup=scmPrtOutputGroup, scmPrtPCLPitch=scmPrtPCLPitch, scmPrtIPPJobMediaSheetsSupportedUBound=scmPrtIPPJobMediaSheetsSupportedUBound, scmPrtCountSimple=scmPrtCountSimple, scmPrtInputPaperType=scmPrtInputPaperType, scmPrtCountTransferImageCountReset=scmPrtCountTransferImageCountReset, scmPrtPCLAppendCR=scmPrtPCLAppendCR, scmPrtConfigurationTable=scmPrtConfigurationTable, scmPrtMarkerResolutionOptions=scmPrtMarkerResolutionOptions, scmPrtKS5843Topmargin=scmPrtKS5843Topmargin, scmPrtGeneralPrnManufacture=scmPrtGeneralPrnManufacture, scmPrtInputLockTray=scmPrtInputLockTray, scmPrtInputRowStatus=scmPrtInputRowStatus, scmPrtSerialTable=scmPrtSerialTable, scmPrtCountDrumImageCountReset=scmPrtCountDrumImageCountReset, scmPrtCountFuserImageCount=scmPrtCountFuserImageCount, scmPrtGeneralPrnModelName=scmPrtGeneralPrnModelName, scmPrtOperationPrintBlackOnly=scmPrtOperationPrintBlackOnly, scmPrtConfigurationPowerSaveOptions=scmPrtConfigurationPowerSaveOptions, scmPrtCountResolution=scmPrtCountResolution, scmPrtMarkerResolution=scmPrtMarkerResolution, scmPrtGeneralRowStatus=scmPrtGeneralRowStatus, scmPrtBaseEntry=scmPrtBaseEntry, scmPrtMarkerSmetModeOptions=scmPrtMarkerSmetModeOptions, scmPrtKS5843cpiOptions=scmPrtKS5843cpiOptions, scmPrtGeneralPrnModelVer=scmPrtGeneralPrnModelVer, scmPrtKSSMFont=scmPrtKSSMFont, scmPrtOperarionMenuClear=scmPrtOperarionMenuClear, scmPrtIPPFinishings=scmPrtIPPFinishings, scmPrtMIBGroups=scmPrtMIBGroups, scmPrtOutputEntry=scmPrtOutputEntry, scmPrtOutputTrayTimeout=scmPrtOutputTrayTimeout, scmPrtAlert=scmPrtAlert, scmPrtBaseGroup=scmPrtBaseGroup, scmPrtIPPFinishingsSupported=scmPrtIPPFinishingsSupported, scmPrtGeneralPrnPSFWVer=scmPrtGeneralPrnPSFWVer, scmPrtKS5843AutoWrapOptions=scmPrtKS5843AutoWrapOptions, scmPrtCountPickupTray1Count=scmPrtCountPickupTray1Count, scmPrtGeneralPrnKSSMVer=scmPrtGeneralPrnKSSMVer, scmPrtGeneralSimple=scmPrtGeneralSimple, scmPrtInterpreterEmulation=scmPrtInterpreterEmulation, scmPrtKSSMTopMargin=scmPrtKSSMTopMargin, scmPrtPCLCourierOptions=scmPrtPCLCourierOptions, scmPrtMarkerDensity=scmPrtMarkerDensity, scmPrtPCLSimple=scmPrtPCLSimple, scmPrtCountEntry=scmPrtCountEntry, scmPrtInputTrayNumOptions=scmPrtInputTrayNumOptions, scmPrtPCLTable=scmPrtPCLTable, scmPrtInterpreter=scmPrtInterpreter, scmPrtGeneralPrnSCFFWVer=scmPrtGeneralPrnSCFFWVer, scmPrtPCL=scmPrtPCL, scmPrtInterpProcessBarcodes=scmPrtInterpProcessBarcodes, scmPrtCountIndex=scmPrtCountIndex, scmPrtIPPJobSheets=scmPrtIPPJobSheets, scmPrtBase=scmPrtBase, scmPrtPCLPointSize=scmPrtPCLPointSize, scmPrtOperationFuserClean=scmPrtOperationFuserClean, scmPrtKSSMCode=scmPrtKSSMCode, scmPrtConsoleDisplayBufferSimple=scmPrtConsoleDisplayBufferSimple, scmPrtPCLFormLine=scmPrtPCLFormLine, scmPrtKS5843FontOptions=scmPrtKS5843FontOptions, scmPrtOutputNextIndex=scmPrtOutputNextIndex, scmPrtInputPaperTypeOptions=scmPrtInputPaperTypeOptions, scmPrtMarkerSimple=scmPrtMarkerSimple, scmPrtGeneralPrnScanFWVer=scmPrtGeneralPrnScanFWVer, scmPrtCountTable=scmPrtCountTable, scmPrtConfigurationJam2Recover=scmPrtConfigurationJam2Recover, scmPrtInterpreterEmulationOptions=scmPrtInterpreterEmulationOptions, scmPrtMarkerTable=scmPrtMarkerTable, scmPrtMarkerTonerColor=scmPrtMarkerTonerColor, scmPrtGeneralPrnVendor=scmPrtGeneralPrnVendor, scmPrtBaseRowStatus=scmPrtBaseRowStatus, scmPrtOutputOffsetStackingType=scmPrtOutputOffsetStackingType, scmPrtConfigurationJam2RecOptions=scmPrtConfigurationJam2RecOptions, scmPrtKS5843Lines=scmPrtKS5843Lines, scmPrtGeneralPrnMainSystemVer=scmPrtGeneralPrnMainSystemVer, scmPrtMarkerGroup=scmPrtMarkerGroup, scmPrtSerial=scmPrtSerial, scmPrtInputGroup=scmPrtInputGroup, scmPrtInterpreterTable=scmPrtInterpreterTable, scmPrtConfiguratioinGroup=scmPrtConfiguratioinGroup, scmPrtGeneralPrnModelDescr=scmPrtGeneralPrnModelDescr, scmPrtGeneralPrncolorPPM=scmPrtGeneralPrncolorPPM, scmPrtIPPJobMediaSheetsSupportedLBound=scmPrtIPPJobMediaSheetsSupportedLBound, scmPrtIPPCollatedCopies=scmPrtIPPCollatedCopies, scmPrtAlertAlarmShortageOptions=scmPrtAlertAlarmShortageOptions, scmPrtAlertAlarmShortage=scmPrtAlertAlarmShortage, scmPrtInputEntry=scmPrtInputEntry, scmPrtOutputTable=scmPrtOutputTable, scmPrtInputTrayPriority=scmPrtInputTrayPriority, scmPrtPCLSymbolSet=scmPrtPCLSymbolSet, scmPrtMarkerTonerOutActionOptions=scmPrtMarkerTonerOutActionOptions, PYSNMP_MODULE_ID=scmPrintMIB, scmPrtInterpOrientation=scmPrtInterpOrientation, scmPrtGeneralPrnOSFWVer=scmPrtGeneralPrnOSFWVer, scmPrtMarkerSrt=scmPrtMarkerSrt, scmPrtOperationFuserCleanOptions=scmPrtOperationFuserCleanOptions, scmPrtOutputTrayTimeoutSupport=scmPrtOutputTrayTimeoutSupport, scmPrtGeneralPrnEngFWVer=scmPrtGeneralPrnEngFWVer, scmPrtOperationOpcClean=scmPrtOperationOpcClean, scmPrtGeneralPrnSerialNo=scmPrtGeneralPrnSerialNo, scmPrtInputTraySwitchOptions=scmPrtInputTraySwitchOptions, scmPrtKS5843Group=scmPrtKS5843Group, scmPrtKS5843cpi=scmPrtKS5843cpi, scmPrtMIBCompliance=scmPrtMIBCompliance, scmPrtPCLFont=scmPrtPCLFont, scmPrtAlertSimple=scmPrtAlertSimple, scmPrtOutputFinishierOptions=scmPrtOutputFinishierOptions, scmPrtChannel=scmPrtChannel, scmPrtInterpreterGroup=scmPrtInterpreterGroup, scmPrtMarkerEntry=scmPrtMarkerEntry, scmPrtGeneralPrnKS5895Ver=scmPrtGeneralPrnKS5895Ver, scmPrtPCLAppendCROptions=scmPrtPCLAppendCROptions, scmPrtInput=scmPrtInput, scmPrtPCLWideA4Options=scmPrtPCLWideA4Options, scmPrtIPPPrintQuality=scmPrtIPPPrintQuality, scmPrtConfigurationAutoCountOptions=scmPrtConfigurationAutoCountOptions, scmPrtIPPJobImpressionsCompleted=scmPrtIPPJobImpressionsCompleted, scmPrintMIB=scmPrintMIB, scmPrtGeneralGroup=scmPrtGeneralGroup, scmPrtCount=scmPrtCount, scmPrtCountPickupTray1Reset=scmPrtCountPickupTray1Reset, scmPrtIPPCollatedCopiesLBound=scmPrtIPPCollatedCopiesLBound, scmPrtInputPaperSizeOptions=scmPrtInputPaperSizeOptions, scmPrtInterpJobCopiesDefault=scmPrtInterpJobCopiesDefault, scmPrtInputCustDimFeedDirDecl=scmPrtInputCustDimFeedDirDecl, scmPrtMarkerduplexLeftMargin=scmPrtMarkerduplexLeftMargin, scmPrtPCLCourier=scmPrtPCLCourier, scmPrtIPPNumberUp=scmPrtIPPNumberUp, scmPrtChannelTable=scmPrtChannelTable, scmPrtIPPGroup=scmPrtIPPGroup, scmPrtMarkerTonerLevel=scmPrtMarkerTonerLevel, scmPrtMarkerTonerColorDescription=scmPrtMarkerTonerColorDescription, scmPrtIPPJobKOctetsSupportedUBound=scmPrtIPPJobKOctetsSupportedUBound, scmPrtPCLWideA4=scmPrtPCLWideA4, scmPrtInputUseCustomSize=scmPrtInputUseCustomSize, scmPrtOperationOpcCleanOptions=scmPrtOperationOpcCleanOptions, scmPrtCountTwoRollerReset=scmPrtCountTwoRollerReset, scmPrtGeneralPrnSPLVer=scmPrtGeneralPrnSPLVer, scmPrtOperationIndex=scmPrtOperationIndex, scmPrtOperationTable=scmPrtOperationTable, scmPrtConfigurationEntry=scmPrtConfigurationEntry, scmPrtInputTrayNum=scmPrtInputTrayNum, scmPrtIPPPageRangesSupported=scmPrtIPPPageRangesSupported, scmPrtBaseIndex=scmPrtBaseIndex, scmPrtGeneralPrnKS5843Ver=scmPrtGeneralPrnKS5843Ver, scmPrtPCLEntry=scmPrtPCLEntry, scmPrtIPPJobKOctetsProcessed=scmPrtIPPJobKOctetsProcessed, scmPrtChannelSimple=scmPrtChannelSimple, scmPrtMarkerduplexTopMargin=scmPrtMarkerduplexTopMargin, scmPrtSerialEntry=scmPrtSerialEntry, scmPrtMarker=scmPrtMarker, scmPrtMarkerSrtOptions=scmPrtMarkerSrtOptions, scmPrtInputSimple=scmPrtInputSimple, scmPrtOperation=scmPrtOperation, scmPrtCountMediaSize=scmPrtCountMediaSize, scmPrtInputLockTrayOptions=scmPrtInputLockTrayOptions, scmPrtChannelGroup=scmPrtChannelGroup, scmPrtKSSMZoom=scmPrtKSSMZoom, scmPrtChannelRowStatus=scmPrtChannelRowStatus, scmPrtKS5843=scmPrtKS5843, scmPrtInputCustDimXFeedDirDecl=scmPrtInputCustDimXFeedDirDecl, scmPrtSerialIndex=scmPrtSerialIndex, scmPrtKS5843AutoWrap=scmPrtKS5843AutoWrap, scmPrtGeneralTable=scmPrtGeneralTable, scmPrtIPPNumberUpOptions=scmPrtIPPNumberUpOptions, scmPrtIPPCollatedCopiesUBound=scmPrtIPPCollatedCopiesUBound, scmPrtConsoleDisplayBufferLcdLangType=scmPrtConsoleDisplayBufferLcdLangType, scmPrtConsoleDisplayBufferLcdLangTypeOptions=scmPrtConsoleDisplayBufferLcdLangTypeOptions, scmPrtKS5843CodeOptions=scmPrtKS5843CodeOptions, scmPrtConfigurationSimple=scmPrtConfigurationSimple, scmPrtMarkerMarginUnit=scmPrtMarkerMarginUnit, scmPrtInterpreterEntry=scmPrtInterpreterEntry, scmPrtMarkerDensityOptions=scmPrtMarkerDensityOptions, scmPrtOutput=scmPrtOutput, scmPrtOperationTestPrtRequest=scmPrtOperationTestPrtRequest, scmPrtConfigurationPowerSave=scmPrtConfigurationPowerSave, scmPrtCountPickupMPReset=scmPrtCountPickupMPReset, scmPrtSerialBobuxonOptions=scmPrtSerialBobuxonOptions, scmPrtCountDrumImageCount=scmPrtCountDrumImageCount, scmPrtCountTransferImageCount=scmPrtCountTransferImageCount, scmPrtKSSMSiteMode=scmPrtKSSMSiteMode, scmPrtInputPaperSize=scmPrtInputPaperSize, scmPrtKSSMAutoWrapOptions=scmPrtKSSMAutoWrapOptions, scmPrtMarkerTonerSave=scmPrtMarkerTonerSave, scmPrtAlertGroup=scmPrtAlertGroup, scmPrtSerialSimple=scmPrtSerialSimple, scmPrtSerialBobuxon=scmPrtSerialBobuxon, scmPrtCountDuplex=scmPrtCountDuplex, scmPrtKSSMLines=scmPrtKSSMLines, scmPrtInputTable=scmPrtInputTable, scmPrtOperationEntry=scmPrtOperationEntry, scmPrtPCLIndex=scmPrtPCLIndex, scmPrtMIBConformance=scmPrtMIBConformance, scmPrtInterpreterCopyNum=scmPrtInterpreterCopyNum, scmPrtConfiguration=scmPrtConfiguration, scmPrtGeneralPrnPCLFWVer=scmPrtGeneralPrnPCLFWVer, scmPrtOperationMenuClearOptions=scmPrtOperationMenuClearOptions, scmPrtKS5843Code=scmPrtKS5843Code, scmPrtOperationSimple=scmPrtOperationSimple, scmPrtInterpRowStatus=scmPrtInterpRowStatus, scmPrtMarkerTonerSaveOptions=scmPrtMarkerTonerSaveOptions, scmPrtConfigurationAutocont=scmPrtConfigurationAutocont, scmPrtGeneralPrnEpsonVer=scmPrtGeneralPrnEpsonVer, scmPrtMarkerShortEdgeBindingMargin=scmPrtMarkerShortEdgeBindingMargin, scmPrtMarkerTonerIndex=scmPrtMarkerTonerIndex, scmPrtPCLGroup=scmPrtPCLGroup, scmPrtKS5843Font=scmPrtKS5843Font, scmPrtIPPColorSupported=scmPrtIPPColorSupported, scmPrtBaseTable=scmPrtBaseTable, scmPrtInterpLineTerm=scmPrtInterpLineTerm, scmPrtMarkerLongEdgeBindingMargin=scmPrtMarkerLongEdgeBindingMargin, scmPrtCountValue=scmPrtCountValue, scmPrtKSSMCodeOptions=scmPrtKSSMCodeOptions, scmPrtKSSMCPIOptions=scmPrtKSSMCPIOptions, scmPrtIPPJobImpressionsSupportedUBound=scmPrtIPPJobImpressionsSupportedUBound, scmPrtKSSMAutoWrap=scmPrtKSSMAutoWrap, scmPrtIPPPrintQualityOptions=scmPrtIPPPrintQualityOptions, scmPrtIPPJobImpressionsSupportedLBound=scmPrtIPPJobImpressionsSupportedLBound, scmPrtIPPJobKOctetsSupportedLBound=scmPrtIPPJobKOctetsSupportedLBound, scmPrtMarkerSmetMode=scmPrtMarkerSmetMode, scmPrtGeneralPrnPCL5eVer=scmPrtGeneralPrnPCL5eVer, scmPrtCountPickupMPCount=scmPrtCountPickupMPCount, scmPrtPCLLeftMargin=scmPrtPCLLeftMargin, scmPrtOperationJobCancel=scmPrtOperationJobCancel, scmPrtKS5843Sitemode=scmPrtKS5843Sitemode, scmPrtMarkerTonerOutAction=scmPrtMarkerTonerOutAction, scmPrtKS5843Simple=scmPrtKS5843Simple, scmPrtOutputRowStatus=scmPrtOutputRowStatus, scmPrtOperationGroup=scmPrtOperationGroup, scmPrtGeneralEntry=scmPrtGeneralEntry, scmPrtCountTwoRollerCount=scmPrtCountTwoRollerCount, scmPrtCountPickupTray2Reset=scmPrtCountPickupTray2Reset, scmPrtGeneralPrnPCL5CeVer=scmPrtGeneralPrnPCL5CeVer, scmPrtKSSM=scmPrtKSSM, scmPrtChannelEntry=scmPrtChannelEntry, scmPrtInputTraySwitch=scmPrtInputTraySwitch, scmPrtConfigurationIndex=scmPrtConfigurationIndex, scmPrtConfigurationAltitudeAction=scmPrtConfigurationAltitudeAction)
mibBuilder.exportSymbols("SAMSUNG-PRINTER-EXT-MIB", scmPrtConfigurationAltitudeActionOptions=scmPrtConfigurationAltitudeActionOptions, scmPrtCountColorant=scmPrtCountColorant, scmPrtGeneral=scmPrtGeneral, scmPrtCountFuserImageCountReset=scmPrtCountFuserImageCountReset, scmPrtKS5843Zoom=scmPrtKS5843Zoom, scmPrtCountPickupTray2Count=scmPrtCountPickupTray2Count, scmPrtInterpOrientationOptions=scmPrtInterpOrientationOptions, scmPrtPCLTopMargin=scmPrtPCLTopMargin, scmPrtInterpreterSimple=scmPrtInterpreterSimple, scmPrtKSSMCPI=scmPrtKSSMCPI, scmPrtIPP=scmPrtIPP, scmPrtIPPJobMediaSheetsCompleted=scmPrtIPPJobMediaSheetsCompleted, scmPrtIPPSimple=scmPrtIPPSimple, scmPrtOperationPrintFontRequest=scmPrtOperationPrintFontRequest, scmPrtCountDeviceType=scmPrtCountDeviceType, scmPrtOutputFinishier=scmPrtOutputFinishier)
