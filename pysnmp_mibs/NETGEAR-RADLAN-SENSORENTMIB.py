...
_C='NETGEAR-RADLAN-SENSORENTMIB'
_B='read-only'
_A='current'
...
rlEntPhySensorTable=_RlEntPhySensorTable_Object((1,3,6,1,4,1,4526,17,83,3))
if mibBuilder.loadTexts:rlEntPhySensorTable.setStatus(_A)
_RlEntPhySensorEntry_Object=MibTableRow
rlEntPhySensorEntry=_RlEntPhySensorEntry_Object((1,3,6,1,4,1,4526,17,83,3,1))
...
rlEnvPhySensorMinValue=_RlEnvPhySensorMinValue_Object((1,3,6,1,4,1,4526,17,83,3,1,1),_RlEnvPhySensorMinValue_Type())
...
rlEnvPhySensorMaxValue=_RlEnvPhySensorMaxValue_Object((1,3,6,1,4,1,4526,17,83,3,1,2),_RlEnvPhySensorMaxValue_Type())
...
rlEnvPhySensorTestValue=_RlEnvPhySensorTestValue_Object((1,3,6,1,4,1,4526,17,83,3,1,3),_RlEnvPhySensorTestValue_Type())
