...
h3cVOIPH225StatTable=_H3cVOIPH225StatTable_Object((1,3,6,1,4,1,2011,10,2,39,11,1))
if mibBuilder.loadTexts:h3cVOIPH225StatTable.setStatus(_A)
_H3cVOIPH225StatEntry_Object=MibTableRow
h3cVOIPH225StatEntry=_H3cVOIPH225StatEntry_Object((1,3,6,1,4,1,2011,10,2,39,11,1,1))
...
h3cH225MsgIndex=_H3cH225MsgIndex_Object((1,3,6,1,4,1,2011,10,2,39,11,1,1,1),_H3cH225MsgIndex_Type())
...
h3cH225MsgName=_H3cH225MsgName_Object((1,3,6,1,4,1,2011,10,2,39,11,1,1,2),_H3cH225MsgName_Type())
...
h3cH225MsgSend=_H3cH225MsgSend_Object((1,3,6,1,4,1,2011,10,2,39,11,1,1,3),_H3cH225MsgSend_Type())
...
h3cH225MsgReceive=_H3cH225MsgReceive_Object((1,3,6,1,4,1,2011,10,2,39,11,1,1,4),_H3cH225MsgReceive_Type())
...
h3cVOIPH245StatTable=_H3cVOIPH245StatTable_Object((1,3,6,1,4,1,2011,10,2,39,11,2))
if mibBuilder.loadTexts:h3cVOIPH245StatTable.setStatus(_A)
_H3cVOIPH245StatEntry_Object=MibTableRow
h3cVOIPH245StatEntry=_H3cVOIPH245StatEntry_Object((1,3,6,1,4,1,2011,10,2,39,11,2,1))
...
h3cH245MsgIndex=_H3cH245MsgIndex_Object((1,3,6,1,4,1,2011,10,2,39,11,2,1,1),_H3cH245MsgIndex_Type())
...
h3cH245MsgName=_H3cH245MsgName_Object((1,3,6,1,4,1,2011,10,2,39,11,2,1,2),_H3cH245MsgName_Type())
...
h3cH245MsgSend=_H3cH245MsgSend_Object((1,3,6,1,4,1,2011,10,2,39,11,2,1,3),_H3cH245MsgSend_Type())
...
h3cH245MsgReceive=_H3cH245MsgReceive_Object((1,3,6,1,4,1,2011,10,2,39,11,2,1,4),_H3cH245MsgReceive_Type())
...
h3cVOIPRasStatTable=_H3cVOIPRasStatTable_Object((1,3,6,1,4,1,2011,10,2,39,11,3))
if mibBuilder.loadTexts:h3cVOIPRasStatTable.setStatus(_A)
_H3cVOIPRasStatEntry_Object=MibTableRow
h3cVOIPRasStatEntry=_H3cVOIPRasStatEntry_Object((1,3,6,1,4,1,2011,10,2,39,11,3,1))
...
h3cRasMsgIndex=_H3cRasMsgIndex_Object((1,3,6,1,4,1,2011,10,2,39,11,3,1,1),_H3cRasMsgIndex_Type())
...
h3cRasMsgName=_H3cRasMsgName_Object((1,3,6,1,4,1,2011,10,2,39,11,3,1,2),_H3cRasMsgName_Type())
...
h3cRasMsgSend=_H3cRasMsgSend_Object((1,3,6,1,4,1,2011,10,2,39,11,3,1,3),_H3cRasMsgSend_Type())
...
h3cRasMsgReceive=_H3cRasMsgReceive_Object((1,3,6,1,4,1,2011,10,2,39,11,3,1,4),_H3cRasMsgReceive_Type())
