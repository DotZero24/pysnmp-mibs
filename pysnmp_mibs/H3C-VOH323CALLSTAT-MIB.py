# SNMP MIB module (H3C-VOH323CALLSTAT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-VOH323CALLSTAT-MIB
...
h3cVOIPH225StatEntry = _H3cVOIPH225StatEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 1, 1)
)
h3cVOIPH225StatEntry.setIndexNames(
    (0, "H3C-VOH323CALLSTAT-MIB", "h3cH225MsgIndex"),
)
if mibBuilder.loadTexts:
...
h3cH225MsgIndex = _H3cH225MsgIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 1, 1, 1),
...
h3cH225MsgName = _H3cH225MsgName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 1, 1, 2),
...
h3cH225MsgSend = _H3cH225MsgSend_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 1, 1, 3),
...
h3cH225MsgReceive = _H3cH225MsgReceive_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 1, 1, 4),
...
h3cVOIPH245StatEntry = _H3cVOIPH245StatEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 2, 1)
)
h3cVOIPH245StatEntry.setIndexNames(
    (0, "H3C-VOH323CALLSTAT-MIB", "h3cH245MsgIndex"),
)
if mibBuilder.loadTexts:
...
h3cH245MsgIndex = _H3cH245MsgIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 2, 1, 1),
...
h3cH245MsgName = _H3cH245MsgName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 2, 1, 2),
...
h3cH245MsgSend = _H3cH245MsgSend_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 2, 1, 3),
...
h3cH245MsgReceive = _H3cH245MsgReceive_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 2, 1, 4),
...
h3cVOIPRasStatEntry = _H3cVOIPRasStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 3, 1)
)
h3cVOIPRasStatEntry.setIndexNames(
    (0, "H3C-VOH323CALLSTAT-MIB", "h3cRasMsgIndex"),
)
if mibBuilder.loadTexts:
...
h3cRasMsgIndex = _H3cRasMsgIndex_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 3, 1, 1),
...
h3cRasMsgName = _H3cRasMsgName_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 3, 1, 2),
    _H3cRasMsgName_Type()
)
...
h3cRasMsgSend = _H3cRasMsgSend_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 3, 1, 3),
    _H3cRasMsgSend_Type()
)
...
h3cRasMsgReceive = _H3cRasMsgReceive_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 39, 11, 3, 1, 4),
