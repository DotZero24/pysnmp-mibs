# SNMP MIB module (GENERIC-3COM-VLAN-MIB-1-0-7) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/a3com/GENERIC-3COM-VLAN-MIB-1-0-7
# Produced by pysmi-1.6.2 at Fri Oct 10 20:45:58 2025
...
class A3ComVlanLayer3Type(Integer32):
    """Custom type A3ComVlanLayer3Type based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
class A3ComVlanModeType(Integer32):
    """Custom type A3ComVlanModeType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
a3ComVlanGlobalMappingEntry.setIndexNames(
    (0, "GENERIC-3COM-VLAN-MIB-1-0-7", "a3ComVlanGlobalMappingIdentifier"),
)
if mibBuilder.loadTexts:
...
a3ComVlanGlobalMappingIdentifier.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
a3ComVlanIfEntry.setIndexNames(
    (0, "GENERIC-3COM-VLAN-MIB-1-0-7", "a3ComVlanIfIndex"),
)
if mibBuilder.loadTexts:
...
a3ComVlanIfIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
a3ComVlanIfModeType = _A3ComVlanIfModeType_Object(
    (1, 3, 6, 1, 4, 1, 43, 10, 1, 14, 1, 2, 1, 7),
    _A3ComVlanIfModeType_Type()
)
a3ComVlanIfModeType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    a3ComVlanIfModeType.setStatus("mandatory")
...
a3ComVlanProtocolTable = _A3ComVlanProtocolTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 10, 1, 14, 2, 2)
)
if mibBuilder.loadTexts:
    a3ComVlanProtocolTable.setStatus("mandatory")
_A3ComVlanProtocolEntry_Object = MibTableRow
a3ComVlanProtocolEntry = _A3ComVlanProtocolEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 10, 1, 14, 2, 2, 1)
)
a3ComVlanProtocolEntry.setIndexNames(
    (0, "GENERIC-3COM-VLAN-MIB-1-0-7", "a3ComVlanProtocolIfIndex"),
    (0, "GENERIC-3COM-VLAN-MIB-1-0-7", "a3ComVlanProtocolIndex"),
)
if mibBuilder.loadTexts:
    a3ComVlanProtocolEntry.setStatus("mandatory")
_A3ComVlanProtocolIfIndex_Type = Integer32
_A3ComVlanProtocolIfIndex_Object = MibTableColumn
a3ComVlanProtocolIfIndex = _A3ComVlanProtocolIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 10, 1, 14, 2, 2, 1, 1),
    _A3ComVlanProtocolIfIndex_Type()
)
a3ComVlanProtocolIfIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    a3ComVlanProtocolIfIndex.setStatus("mandatory")
_A3ComVlanProtocolIndex_Type = A3ComVlanLayer3Type
_A3ComVlanProtocolIndex_Object = MibTableColumn
a3ComVlanProtocolIndex = _A3ComVlanProtocolIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 10, 1, 14, 2, 2, 1, 2),
    _A3ComVlanProtocolIndex_Type()
)
a3ComVlanProtocolIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    a3ComVlanProtocolIndex.setStatus("mandatory")
_A3ComVlanProtocolStatus_Type = RowStatus
_A3ComVlanProtocolStatus_Object = MibTableColumn
a3ComVlanProtocolStatus = _A3ComVlanProtocolStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 10, 1, 14, 2, 2, 1, 3),
    _A3ComVlanProtocolStatus_Type()
)
a3ComVlanProtocolStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    a3ComVlanProtocolStatus.setStatus("mandatory")
...
a3ComVlanEncapsIfEntry.setIndexNames(
    (0, "GENERIC-3COM-VLAN-MIB-1-0-7", "a3ComVlanEncapsIfIndex"),
)
if mibBuilder.loadTexts:
...
a3ComVlanEncapsIfIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"RowStatus": RowStatus,
       ...
       "A3ComVlanLayer3Type": A3ComVlanLayer3Type,
       "A3ComVlanModeType": A3ComVlanModeType,
       ...
       "a3ComVlanIfModeType": a3ComVlanIfModeType,
       ...
       "a3ComVlanProtocolTable": a3ComVlanProtocolTable,
       "a3ComVlanProtocolEntry": a3ComVlanProtocolEntry,
       "a3ComVlanProtocolIfIndex": a3ComVlanProtocolIfIndex,
       "a3ComVlanProtocolIndex": a3ComVlanProtocolIndex,
       "a3ComVlanProtocolStatus": a3ComVlanProtocolStatus,
