...
mibBuilder.exportSymbols("APCODEC-MIB", apCodecRealmCountG726_32=apCodecRealmCountG726_32, apCodecPairADigitType=apCodecPairADigitType, apCodecRealmCountH261=apCodecRealmCountH261, apCodecPairBIndex=apCodecPairBIndex, apCodecRealmCountT38=apCodecRealmCountT38, apCodecTranscodingResourcesHigh=apCodecTranscodingResourcesHigh, apCodecConformance=apCodecConformance, apCodecIndex=apCodecIndex, apCodecRealmCountOther=apCodecRealmCountOther, apCodecRealmCountPCMU=apCodecRealmCountPCMU, apCodecPairAPValue=apCodecPairAPValue, apCodecPairBPValue=apCodecPairBPValue, apCodecTranscodingInUsePercentHigh=apCodecTranscodingInUsePercentHigh, apCodecRealmCountGSM=apCodecRealmCountGSM, apCodecRealmStatsObjectsGroup=apCodecRealmStatsObjectsGroup, apCodecTranscodingResourcesTotal=apCodecTranscodingResourcesTotal, apCodecName=apCodecName, apCodecRealmCountH263=apCodecRealmCountH263, apCodecPairTranscodingCurrent=apCodecPairTranscodingCurrent, apCodecRealmCountG729=apCodecRealmCountG729, apCodecEntry=apCodecEntry, apCodecRealmCountG726_40=apCodecRealmCountG726_40, apCodecRealmCountG726_24=apCodecRealmCountG726_24, apCodecTranscodingRealmStatsTable=apCodecTranscodingRealmStatsTable, apCodecTranscodingRealmStatsEntry=apCodecTranscodingRealmStatsEntry, apCodecNotificationsGroups=apCodecNotificationsGroups, apCodecTranscodingStatsGroup=apCodecTranscodingStatsGroup, apCodecPairStatsEntry=apCodecPairStatsEntry, apCodecRealmCountAMR=apCodecRealmCountAMR, apCodecTranscodingResourceMIBObjects=apCodecTranscodingResourceMIBObjects, apCodecRealmCountG726_16=apCodecRealmCountG726_16, apCodecCompliances=apCodecCompliances, apCodecNotifications=apCodecNotifications, apCodecTable=apCodecTable, apCodecGroups=apCodecGroups, apCodecMIBObjects=apCodecMIBObjects, apCodecTranscodingInUsePercentCurrent=apCodecTranscodingInUsePercentCurrent, apCodecPairAIndex=apCodecPairAIndex, apCodecRealmCountG722=apCodecRealmCountG722, apCodecPairStatsTable=apCodecPairStatsTable, PYSNMP_MODULE_ID=apCodecModule, apCodecRealmCountG723=apCodecRealmCountG723, apCodecRealmStatsEntry=apCodecRealmStatsEntry, apCodecRealmSessionsTransrated=apCodecRealmSessionsTransrated, apCodecRealmStatsTable=apCodecRealmStatsTable, apCodecPairBDigitType=apCodecPairBDigitType, apCodecNotificationObjects=apCodecNotificationObjects, apCodecRealmCountG728=apCodecRealmCountG728, apCodecRealmCountPCMA=apCodecRealmCountPCMA, apCodecRealmStatsObjectsGroup2=apCodecRealmStatsObjectsGroup2, apCodecTranscodingResourcesCurrent=apCodecTranscodingResourcesCurrent, apCodecRealmSessionsTransparent=apCodecRealmSessionsTransparent, apCodecNotificationPrefix=apCodecNotificationPrefix, apCodecPairTranscodingHigh=apCodecPairTranscodingHigh, apCodecTranscodingMIBObjects=apCodecTranscodingMIBObjects, apCodecRealmCountEVRC=apCodecRealmCountEVRC, apCodecMediaProcessingObjectsGroup=apCodecMediaProcessingObjectsGroup, apCodecRealmCountILBC=apCodecRealmCountILBC, ApCodecDigitTypes=ApCodecDigitTypes, apCodecRealmSessionsTranscoded=apCodecRealmSessionsTranscoded, apCodecModule=apCodecModule)
