# SNMP MIB module (CISCOSB-rlMacMulticast-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/ciscosb/CISCOSB-rlMacMulticast-MIB
...
rlIgmpSnoopVlanEntry.setIndexNames(
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopVlanTag"),
)
if mibBuilder.loadTexts:
...
rlIgmpSnoopMulticastTvEntry.setIndexNames(
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMulticastTvVID"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMulticastTvGroup"),
)
if mibBuilder.loadTexts:
...
class _RlIgmpSnoopMulticastTvCount_Type(Integer32):
    """Custom type rlIgmpSnoopMulticastTvCount based on Integer32"""
    defaultValue = 1

    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 268435456),
    )


_RlIgmpSnoopMulticastTvCount_Type.__name__ = "Integer32"
_RlIgmpSnoopMulticastTvCount_Object = MibTableColumn
rlIgmpSnoopMulticastTvCount = _RlIgmpSnoopMulticastTvCount_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 2, 10, 1, 4),
    _RlIgmpSnoopMulticastTvCount_Type()
)
rlIgmpSnoopMulticastTvCount.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlIgmpSnoopMulticastTvCount.setStatus("current")
...
rlIgmpSnoopMembershipEntry.setIndexNames(
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMembershipVlanTag"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMembershipGroupIpAddress"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMembershipSourceIpAddress"),
)
if mibBuilder.loadTexts:
...
rlIgmpSnoopQuerierVlanEntry.setIndexNames(
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopQuerierVlanTag"),
)
if mibBuilder.loadTexts:
...
rlIgmpSnoopQuerierElectionEnable = _RlIgmpSnoopQuerierElectionEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 2, 12, 1, 8),
...
rlIgmpMldSnoopMembershipEntry.setIndexNames(
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipVlanTag"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipGroupIpAddressType"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipGroupIpAddress"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipSourceIpAddressType"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipSourceIpAddress"),
)
if mibBuilder.loadTexts:
...
rlIgmpMldSnoopVlanEntry.setIndexNames(
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopVlanInetAddressType"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopVlanTag"),
)
if mibBuilder.loadTexts:
...
rlIgmpMldSnoopMulticastTvEntry.setIndexNames(
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMulticastTvInetAddressType"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMulticastTvVID"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMulticastTvGroupAddressType"),
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMulticastTvGroup"),
)
if mibBuilder.loadTexts:
...
rlMldSnoopQuerierVlanEntry.setIndexNames(
    (0, "CISCOSB-rlMacMulticast-MIB", "rlMldSnoopQuerierVlanTag"),
)
if mibBuilder.loadTexts:
...
rlMldSnoopQuerierElectionEnable = _RlMldSnoopQuerierElectionEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 10),
...
rlIgmpMldSnoopQuerierGlobalAddressEntry = _RlIgmpMldSnoopQuerierGlobalAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 9, 1)
)
rlIgmpMldSnoopQuerierGlobalAddressEntry.setIndexNames(
    (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopQuerierGlobalAddressIPVersion"),
)
if mibBuilder.loadTexts:
...
rlIgmpMldSnoopQuerierGlobalAddressIPVersion = _RlIgmpMldSnoopQuerierGlobalAddressIPVersion_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 9, 1, 1),
...
rlIgmpMldSnoopQuerierGlobalAddressType = _RlIgmpMldSnoopQuerierGlobalAddressType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 9, 1, 2),
...
rlIgmpMldSnoopQuerierGlobalAddress = _RlIgmpMldSnoopQuerierGlobalAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 9, 1, 3),
...
mibBuilder.exportSymbols(
    ...
    **{"IgmpVersion": IgmpVersion,
       ...
       "rlIgmpSnoopMulticastTvCount": rlIgmpSnoopMulticastTvCount,
