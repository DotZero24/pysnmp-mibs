#
# PySNMP MIB module CISCOSB-rlMacMulticast-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/ciscosb/CISCOSB-rlMacMulticast-MIB
...
rlIgmpSnoopVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 2, 7, 1), ).setIndexNames((0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopVlanTag"))
...
rlIgmpSnoopMulticastTvEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 2, 10, 1), ).setIndexNames((0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMulticastTvVID"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMulticastTvGroup"))
...
rlIgmpSnoopMulticastTvCount = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 2, 10, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 268435456)).clone(1)).setMaxAccess("readwrite")
if mibBuilder.loadTexts: rlIgmpSnoopMulticastTvCount.setStatus('current')
...
rlIgmpSnoopMembershipEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 2, 11, 1), ).setIndexNames((0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMembershipVlanTag"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMembershipGroupIpAddress"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopMembershipSourceIpAddress"))
...
rlIgmpSnoopQuerierVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 2, 12, 1), ).setIndexNames((0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpSnoopQuerierVlanTag"))
...
rlIgmpSnoopQuerierElectionEnable = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 2, 12, 1, 8), TruthValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: rlIgmpSnoopQuerierElectionEnable.setStatus('current')
rlIgmpSnoopQuerierEnable = MibScalar((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 2, 13), TruthValue()).setMaxAccess("readwrite")
...
rlIgmpMldSnoopMembershipEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 4, 1), ).setIndexNames((0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipVlanTag"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipGroupIpAddressType"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipGroupIpAddress"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipSourceIpAddressType"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMembershipSourceIpAddress"))
...
rlIgmpMldSnoopVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 5, 1), ).setIndexNames((0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopVlanInetAddressType"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopVlanTag"))
...
rlIgmpMldSnoopVlanAdminLastMemberQueryCount = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 5, 1, 28), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 7))).setMaxAccess("readwrite")
...
rlIgmpMldSnoopMulticastTvEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 6, 1), ).setIndexNames((0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMulticastTvInetAddressType"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMulticastTvVID"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMulticastTvGroupAddressType"), (0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopMulticastTvGroup"))
...
rlMldSnoopQuerierVlanTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7), )
if mibBuilder.loadTexts: rlMldSnoopQuerierVlanTable.setStatus('current')
rlMldSnoopQuerierVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1), ).setIndexNames((0, "CISCOSB-rlMacMulticast-MIB", "rlMldSnoopQuerierVlanTag"))
if mibBuilder.loadTexts: rlMldSnoopQuerierVlanEntry.setStatus('current')
rlMldSnoopQuerierVlanTag = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 1), VlanIndex()).setMaxAccess("readonly")
if mibBuilder.loadTexts: rlMldSnoopQuerierVlanTag.setStatus('current')
rlMldSnoopQuerierAdminEnable = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 2), TruthValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: rlMldSnoopQuerierAdminEnable.setStatus('current')
rlMldSnoopQuerierOperEnable = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 3), TruthValue()).setMaxAccess("readonly")
if mibBuilder.loadTexts: rlMldSnoopQuerierOperEnable.setStatus('current')
rlMldSnoopQuerierAdminAddrInetAddressType = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 4), InetAddressType()).setMaxAccess("readonly")
if mibBuilder.loadTexts: rlMldSnoopQuerierAdminAddrInetAddressType.setStatus('current')
rlMldSnoopQuerierAdminAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 5), InetAddress()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: rlMldSnoopQuerierAdminAddr.setStatus('current')
rlMldSnoopQuerierOperAddrInetAddressType = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 6), InetAddressType()).setMaxAccess("readonly")
if mibBuilder.loadTexts: rlMldSnoopQuerierOperAddrInetAddressType.setStatus('current')
rlMldSnoopQuerierOperAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 7), InetAddress()).setMaxAccess("readonly")
if mibBuilder.loadTexts: rlMldSnoopQuerierOperAddr.setStatus('current')
rlMldSnoopQuerierAdminVersionNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 8), MldVersion()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: rlMldSnoopQuerierAdminVersionNumber.setStatus('current')
rlMldSnoopQuerierOperVersionNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 9), MldVersion()).setMaxAccess("readonly")
if mibBuilder.loadTexts: rlMldSnoopQuerierOperVersionNumber.setStatus('current')
rlMldSnoopQuerierElectionEnable = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 7, 1, 10), TruthValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: rlMldSnoopQuerierElectionEnable.setStatus('current')
rlMldSnoopQuerierEnable = MibScalar((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 8), TruthValue()).setMaxAccess("readwrite")
if mibBuilder.loadTexts: rlMldSnoopQuerierEnable.setStatus('current')
rlIgmpMldSnoopQuerierGlobalAddressTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 9), )
if mibBuilder.loadTexts: rlIgmpMldSnoopQuerierGlobalAddressTable.setStatus('current')
rlIgmpMldSnoopQuerierGlobalAddressEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 9, 1), ).setIndexNames((0, "CISCOSB-rlMacMulticast-MIB", "rlIgmpMldSnoopQuerierGlobalAddressIPVersion"))
if mibBuilder.loadTexts: rlIgmpMldSnoopQuerierGlobalAddressEntry.setStatus('current')
rlIgmpMldSnoopQuerierGlobalAddressIPVersion = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 9, 1, 1), InetVersion())
if mibBuilder.loadTexts: rlIgmpMldSnoopQuerierGlobalAddressIPVersion.setStatus('current')
rlIgmpMldSnoopQuerierGlobalAddressType = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 9, 1, 2), InetAddressType()).setMaxAccess("readonly")
if mibBuilder.loadTexts: rlIgmpMldSnoopQuerierGlobalAddressType.setStatus('current')
rlIgmpMldSnoopQuerierGlobalAddress = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 55, 5, 9, 1, 3), InetAddress()).setMaxAccess("readwrite")
