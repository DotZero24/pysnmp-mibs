...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-CIRCUIT-GROUP-MIB
...
rbnCCircuitGroupCompliance.setObjects(
      *(("RBN-CIRCUIT-GROUP-MIB", "rbnCctGrpStatsGroup"),
        ("RBN-CIRCUIT-GROUP-MIB", "rbnCctGrpQStatsGroup"),
        ("RBN-CIRCUIT-GROUP-MIB", "rbnCctGrpPolicyStatsGroup"))
)
if mibBuilder.loadTexts:
