...
myAddressMIBObjects=_MyAddressMIBObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,22,1))
_MyAddressManagementObjects_ObjectIdentity=ObjectIdentity
myAddressManagementObjects=_MyAddressManagementObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,22,1,1))
_MyDynamicAddressCurrentNum_Type=Integer32
_MyDynamicAddressCurrentNum_Object=MibScalar
myDynamicAddressCurrentNum=_MyDynamicAddressCurrentNum_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,1),_MyDynamicAddressCurrentNum_Type())
...
myStaticAddressCurrentNum=_MyStaticAddressCurrentNum_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,2),_MyStaticAddressCurrentNum_Type())
...
myFilterAddressCurrentNum=_MyFilterAddressCurrentNum_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,3),_MyFilterAddressCurrentNum_Type())
...
myAddressAvailableNum=_MyAddressAvailableNum_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,4),_MyAddressAvailableNum_Type())
...
myMacAddressTable=_MyMacAddressTable_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,5))
if mibBuilder.loadTexts:myMacAddressTable.setStatus(_A)
_MyMacAddressEntry_Object=MibTableRow
myMacAddressEntry=_MyMacAddressEntry_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,5,1))
...
myMacAddressFdbId=_MyMacAddressFdbId_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,5,1,1),_MyMacAddressFdbId_Type())
...
myMacAddress=_MyMacAddress_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,5,1,2),_MyMacAddress_Type())
...
myMacAddressPort=_MyMacAddressPort_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,5,1,3),_MyMacAddressPort_Type())
...
myMacAddressType=_MyMacAddressType_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,5,1,4),_MyMacAddressType_Type())
...
myMacAddressStatus=_MyMacAddressStatus_Object((1,3,6,1,4,1,171,10,97,2,22,1,1,5,1,5),_MyMacAddressStatus_Type())
...
myAddressNotificationObjects=_MyAddressNotificationObjects_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,22,1,2))
_MyMacNotiGlobalEnabled_Type=EnabledStatus
_MyMacNotiGlobalEnabled_Object=MibScalar
myMacNotiGlobalEnabled=_MyMacNotiGlobalEnabled_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,1),_MyMacNotiGlobalEnabled_Type())
...
myMacNotificationInterval=_MyMacNotificationInterval_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,2),_MyMacNotificationInterval_Type())
...
myMacNotiHisTableMaxLength=_MyMacNotiHisTableMaxLength_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,3),_MyMacNotiHisTableMaxLength_Type())
...
myMacNotiHisTableCurrentLength=_MyMacNotiHisTableCurrentLength_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,4),_MyMacNotiHisTableCurrentLength_Type())
...
myMacNotiHisTable=_MyMacNotiHisTable_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,5))
if mibBuilder.loadTexts:myMacNotiHisTable.setStatus(_A)
_MyMacNotiHisEntry_Object=MibTableRow
myMacNotiHisEntry=_MyMacNotiHisEntry_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,5,1))
...
myMacNotiHisIndex=_MyMacNotiHisIndex_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,5,1,1),_MyMacNotiHisIndex_Type())
...
myMacNotiHisMacChangedMsg=_MyMacNotiHisMacChangedMsg_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,5,1,2),_MyMacNotiHisMacChangedMsg_Type())
...
myMacNotiHisTimestamp=_MyMacNotiHisTimestamp_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,5,1,3),_MyMacNotiHisTimestamp_Type())
...
myMacNotiIfCfgTable=_MyMacNotiIfCfgTable_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,6))
if mibBuilder.loadTexts:myMacNotiIfCfgTable.setStatus(_A)
_MyMacNotiIfCfgEntry_Object=MibTableRow
myMacNotiIfCfgEntry=_MyMacNotiIfCfgEntry_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,6,1))
...
myMacNotiIfIndex=_MyMacNotiIfIndex_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,6,1,1),_MyMacNotiIfIndex_Type())
...
myIfMacAddrLearntEnable=_MyIfMacAddrLearntEnable_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,6,1,2),_MyIfMacAddrLearntEnable_Type())
...
myIfMacAddrRemovedEnable=_MyIfMacAddrRemovedEnable_Object((1,3,6,1,4,1,171,10,97,2,22,1,2,6,1,3),_MyIfMacAddrRemovedEnable_Type())
...
myAddressTraps=_MyAddressTraps_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,22,2))
_MyAddressMIBConformance_ObjectIdentity=ObjectIdentity
myAddressMIBConformance=_MyAddressMIBConformance_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,22,3))
_MyAddressMIBCompliances_ObjectIdentity=ObjectIdentity
myAddressMIBCompliances=_MyAddressMIBCompliances_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,22,3,1))
_MyAddressMIBGroups_ObjectIdentity=ObjectIdentity
myAddressMIBGroups=_MyAddressMIBGroups_ObjectIdentity((1,3,6,1,4,1,171,10,97,2,22,3,2))
myMacAddressMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,22,3,2,1))
...
myAddressNotificationMIBGroup=ObjectGroup((1,3,6,1,4,1,171,10,97,2,22,3,2,2))
...
macChangedNotification=NotificationType((1,3,6,1,4,1,171,10,97,2,22,2,1))
macChangedNotification.setObjects((_B,_K))
if mibBuilder.loadTexts:macChangedNotification.setStatus(_A)
myAddressMIBCompliance=ModuleCompliance((1,3,6,1,4,1,171,10,97,2,22,3,1,1))
