# SNMP MIB module (DES7200-ADDRESS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/d-link/DES7200-ADDRESS-MIB
...
myMacAddressEntry.setIndexNames(
    (0, "DES7200-ADDRESS-MIB", "myMacAddressFdbId"),
    (0, "DES7200-ADDRESS-MIB", "myMacAddress"),
)
if mibBuilder.loadTexts:
...
myMacNotiHisEntry.setIndexNames(
    (0, "DES7200-ADDRESS-MIB", "myMacNotiHisIndex"),
)
if mibBuilder.loadTexts:
...
myMacNotiIfCfgEntry.setIndexNames(
    (0, "DES7200-ADDRESS-MIB", "myMacNotiIfIndex"),
)
if mibBuilder.loadTexts:
...
_MyIfMacAddrLearntEnable_Type.__name__ = "EnabledStatus"
...
_MyIfMacAddrRemovedEnable_Type.__name__ = "EnabledStatus"
...
myMacAddressMIBGroup.setObjects(
      *(("DES7200-ADDRESS-MIB", "myDynamicAddressCurrentNum"),
        ("DES7200-ADDRESS-MIB", "myStaticAddressCurrentNum"),
        ("DES7200-ADDRESS-MIB", "myFilterAddressCurrentNum"),
        ("DES7200-ADDRESS-MIB", "myAddressAvailableNum"),
        ("DES7200-ADDRESS-MIB", "myMacAddressFdbId"),
        ("DES7200-ADDRESS-MIB", "myMacAddress"),
        ("DES7200-ADDRESS-MIB", "myMacAddressPort"),
        ("DES7200-ADDRESS-MIB", "myMacAddressType"),
        ("DES7200-ADDRESS-MIB", "myMacAddressStatus"))
)
if mibBuilder.loadTexts:
...
myAddressNotificationMIBGroup.setObjects(
      *(("DES7200-ADDRESS-MIB", "myMacNotiGlobalEnabled"),
        ("DES7200-ADDRESS-MIB", "myMacNotificationInterval"),
        ("DES7200-ADDRESS-MIB", "myMacNotiHisTableMaxLength"),
        ("DES7200-ADDRESS-MIB", "myMacNotiHisTableCurrentLength"),
        ("DES7200-ADDRESS-MIB", "myMacNotiHisIndex"),
        ("DES7200-ADDRESS-MIB", "myMacNotiHisMacChangedMsg"),
        ("DES7200-ADDRESS-MIB", "myMacNotiHisTimestamp"),
        ("DES7200-ADDRESS-MIB", "myMacNotiIfIndex"),
        ("DES7200-ADDRESS-MIB", "myIfMacAddrLearntEnable"),
        ("DES7200-ADDRESS-MIB", "myIfMacAddrRemovedEnable"))
)
if mibBuilder.loadTexts:
...
myAddressMIBCompliance.setObjects(
      *(("DES7200-ADDRESS-MIB", "myMacAddressMIBGroup"),
        ("DES7200-ADDRESS-MIB", "myAddressNotificationMIBGroup"))
)
if mibBuilder.loadTexts:
