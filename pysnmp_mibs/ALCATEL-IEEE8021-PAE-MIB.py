...
# Notes
# -----
# ASN.1 source file://mibs/nokia/ALCATEL-IEEE8021-PAE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:55:59 2025
...
class _AlxDot1xAuthRadiusPlcy_Type(TPolicyStatementNameOrEmpty):
    """Custom type alxDot1xAuthRadiusPlcy based on TPolicyStatementNameOrEmpty"""
    defaultValue = OctetString("")


_AlxDot1xAuthRadiusPlcy_Type.__name__ = "TPolicyStatementNameOrEmpty"
...
class _AlxDot1xAuthRadiusServerPlcyAuth_Type(TNamedItemOrEmpty):
    """Custom type alxDot1xAuthRadiusServerPlcyAuth based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_AlxDot1xAuthRadiusServerPlcyAuth_Type.__name__ = "TNamedItemOrEmpty"
_AlxDot1xAuthRadiusServerPlcyAuth_Object = MibTableColumn
alxDot1xAuthRadiusServerPlcyAuth = _AlxDot1xAuthRadiusServerPlcyAuth_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 3, 2, 3, 1, 1, 1, 51),
    _AlxDot1xAuthRadiusServerPlcyAuth_Type()
)
alxDot1xAuthRadiusServerPlcyAuth.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alxDot1xAuthRadiusServerPlcyAuth.setStatus("current")


class _AlxDot1xAuthRadiusServerPlcyAcct_Type(TNamedItemOrEmpty):
    """Custom type alxDot1xAuthRadiusServerPlcyAcct based on TNamedItemOrEmpty"""
    defaultValue = OctetString("")


_AlxDot1xAuthRadiusServerPlcyAcct_Type.__name__ = "TNamedItemOrEmpty"
_AlxDot1xAuthRadiusServerPlcyAcct_Object = MibTableColumn
alxDot1xAuthRadiusServerPlcyAcct = _AlxDot1xAuthRadiusServerPlcyAcct_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 3, 2, 3, 1, 1, 1, 53),
    _AlxDot1xAuthRadiusServerPlcyAcct_Type()
)
alxDot1xAuthRadiusServerPlcyAcct.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alxDot1xAuthRadiusServerPlcyAcct.setStatus("current")
...
_AlxDot1xRadiusPlcySrceAddr_Type.__name__ = "IpAddress"
...
_AlxDot1xRadiusPlcyAdminState_Type.__name__ = "ServiceAdminStatus"
...
alxDot1xAuthConfigV20v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 3, 1, 3, 1, 2, 2)
)
alxDot1xAuthConfigV20v0Group.setObjects(
      *(("ALCATEL-IEEE8021-PAE-MIB", "alxDot1xAuthRadiusServerPlcyAuth"),
        ("ALCATEL-IEEE8021-PAE-MIB", "alxDot1xAuthRadiusServerPlcyAcct"))
)
if mibBuilder.loadTexts:
    alxDot1xAuthConfigV20v0Group.setStatus("current")
...
alxDot1xAuthenticatorCompliance.setObjects(
      *(("ALCATEL-IEEE8021-PAE-MIB", "alxDot1xAuthConfigGroup"),
        ("ALCATEL-IEEE8021-PAE-MIB", "alxDot1xRadiusPlcyGroup"))
)
if mibBuilder.loadTexts:
...
alxDot1xAuthV20v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 3, 1, 3, 1, 1, 2)
)
alxDot1xAuthV20v0Compliance.setObjects(
      *(("ALCATEL-IEEE8021-PAE-MIB", "alxDot1xAuthConfigGroup"),
        ("ALCATEL-IEEE8021-PAE-MIB", "alxDot1xAuthConfigV20v0Group"),
        ("ALCATEL-IEEE8021-PAE-MIB", "alxDot1xRadiusPlcyGroup"))
)
if mibBuilder.loadTexts:
    alxDot1xAuthV20v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"AlxDot1xRadiusServerType": AlxDot1xRadiusServerType,
       ...
       "alxDot1xAuthConfigV20v0Group": alxDot1xAuthConfigV20v0Group,
       ...
       "alxDot1xAuthRadiusServerPlcyAuth": alxDot1xAuthRadiusServerPlcyAuth,
       "alxDot1xAuthRadiusServerPlcyAcct": alxDot1xAuthRadiusServerPlcyAcct,
