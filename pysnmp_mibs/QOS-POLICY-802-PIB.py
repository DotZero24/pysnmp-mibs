...
RowStatus, TextualConvention, StorageType, PhysAddress, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "StorageType", "PhysAddress", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("QOS-POLICY-802-PIB", qos802AclDefinitionAceOrder=qos802AclDefinitionAceOrder, qosPolicy802PibCompliance=qosPolicy802PibCompliance, QosIeee802Cos=QosIeee802Cos, qos802AclDefinitionLabel=qos802AclDefinitionLabel, qos802AceId=qos802AceId, qos802DomainConfig=qos802DomainConfig, qos802DscpMappingTable=qos802DscpMappingTable, qos802DscpMappingGroup=qos802DscpMappingGroup, qosPolicy802PibConformance=qosPolicy802PibConformance, qos802AceSrcAddrMask=qos802AceSrcAddrMask, qos802CosToDscpDscp=qos802CosToDscpDscp, qos802CosToDscpGroup=qos802CosToDscpGroup, qos802AceTable=qos802AceTable, qos802CosToDscpTable=qos802CosToDscpTable, qos802AceEtherType=qos802AceEtherType, qos802CosToDscpCos=qos802CosToDscpCos, qos802DscpMappingStorageType=qos802DscpMappingStorageType, qos802CosToDscpEntry=qos802CosToDscpEntry, qos802CosToDscpStorageType=qos802CosToDscpStorageType, qos802Qos=qos802Qos, qos802DscpMappingStatus=qos802DscpMappingStatus, qos802AceEntry=qos802AceEntry, qos802AclDefinitionStorageType=qos802AclDefinitionStorageType, qos802AclDefinitionAceId=qos802AclDefinitionAceId, qos802AcePermit=qos802AcePermit, qos802AceDstAddrMask=qos802AceDstAddrMask, PYSNMP_MODULE_ID=qosPolicy802Pib, qos802DscpMappingId=qos802DscpMappingId, qos802AceVlanTagRequired=qos802AceVlanTagRequired, qos802AceDstAddr=qos802AceDstAddr, qos802AceStatus=qos802AceStatus, qos802AclDefinitionGroup=qos802AclDefinitionGroup, qos802CosToDscpId=qos802CosToDscpId, qos802CosToDscpStatus=qos802CosToDscpStatus, qos802AceUserPriority=qos802AceUserPriority, qos802AclDefinitionStatus=qos802AclDefinitionStatus, qosPolicy802PibCompliances=qosPolicy802PibCompliances, qosPolicy802PibClasses=qosPolicy802PibClasses, qosPolicy802PibGroups=qosPolicy802PibGroups, qosPolicy802Pib=qosPolicy802Pib, qos802AceGroup=qos802AceGroup, qos802AceVlanId=qos802AceVlanId, qos802DscpMappingDscp=qos802DscpMappingDscp, qos802AceStorageType=qos802AceStorageType, qos802AceSrcAddr=qos802AceSrcAddr, qos802DscpMappingEntry=qos802DscpMappingEntry, qos802AclDefinitionEntry=qos802AclDefinitionEntry, qos802AclDefinitionTable=qos802AclDefinitionTable, qos802AclDefinitionAclId=qos802AclDefinitionAclId, qos802DscpMapping802Cos=qos802DscpMapping802Cos, qos802AclDefinitionId=qos802AclDefinitionId)
