...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/accedian/ACD-FILTER-MIB
...
acdFilter.setRevisions(('2015-06-18 01:00', '2013-02-13 01:00', '2011-10-10 01:00', '2010-11-10 01:00', '2008-05-01 01:00', '2006-08-06 01:00',))
if mibBuilder.loadTexts: acdFilter.setLastUpdated('201506180100Z')
...
class AcdFilterOperatorEqualRangeOnly(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("equalTo", 3), ("range", 4))

class AcdFilterVlanType(TextualConvention, Integer32):
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))
    namedValues = NamedValues(("cvlan", 1), ("svlan", 2), ("both", 3), ("tvlan", 4), ("any", 5))
...
acdSmapIPv4FilterSrcPortLast = MibTableColumn((1, 3, 6, 1, 4, 1, 22420, 2, 2, 4, 1, 58), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: acdSmapIPv4FilterSrcPortLast.setStatus('current')
acdSmapIPv4FilterSrcPortOper = MibTableColumn((1, 3, 6, 1, 4, 1, 22420, 2, 2, 4, 1, 59), AcdFilterOperatorEqualRangeOnly().clone('equalTo')).setMaxAccess("readcreate")
if mibBuilder.loadTexts: acdSmapIPv4FilterSrcPortOper.setStatus('current')
acdSmapIPv4FilterDstPortLast = MibTableColumn((1, 3, 6, 1, 4, 1, 22420, 2, 2, 4, 1, 60), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: acdSmapIPv4FilterDstPortLast.setStatus('current')
acdSmapIPv4FilterDstPortOper = MibTableColumn((1, 3, 6, 1, 4, 1, 22420, 2, 2, 4, 1, 61), AcdFilterOperatorEqualRangeOnly().clone('equalTo')).setMaxAccess("readcreate")
if mibBuilder.loadTexts: acdSmapIPv4FilterDstPortOper.setStatus('current')
...
mibBuilder.exportSymbols("ACD-FILTER-MIB", acdSmapL2FilterVlan1IdLast=acdSmapL2FilterVlan1IdLast, acdSmapL2FilterEtype=acdSmapL2FilterEtype, acdSmapL2FilterDscp=acdSmapL2FilterDscp, acdSmapIPv4FilterVlan2CfiEn=acdSmapIPv4FilterVlan2CfiEn, acdIPv4FilterProtoEn=acdIPv4FilterProtoEn, acdFilterTableTid=acdFilterTableTid, acdL2FilterVlan2Prior=acdL2FilterVlan2Prior, acdL2FilterMacDstEn=acdL2FilterMacDstEn, acdIPv4FilterIHLEn=acdIPv4FilterIHLEn, acdIPv4FilterIcmpCodeEn=acdIPv4FilterIcmpCodeEn, acdL2FilterVlan1PriorEn=acdL2FilterVlan1PriorEn, acdSmapL2FilterVlan1PriorOper=acdSmapL2FilterVlan1PriorOper, acdL2FilterEtype=acdL2FilterEtype, acdSmapL2FilterDscpLast=acdSmapL2FilterDscpLast, acdSmapIPv4FilterSrcEn=acdSmapIPv4FilterSrcEn, acdSmapIPv4FilterVlan1PriorEn=acdSmapIPv4FilterVlan1PriorEn, acdSmapL2FilterMacSrcMask=acdSmapL2FilterMacSrcMask, acdSmapL2FilterGroup=acdSmapL2FilterGroup, acdSmapL2FilterTableLastChangeTid=acdSmapL2FilterTableLastChangeTid, acdSmapIPv4FilterDstEn=acdSmapIPv4FilterDstEn, acdIPv4FilterDstMask=acdIPv4FilterDstMask, acdL2FilterMacDst=acdL2FilterMacDst, acdSmapIPv4FilterVlan1IdOper=acdSmapIPv4FilterVlan1IdOper, PYSNMP_MODULE_ID=acdFilter, acdL2FilterMacDstMask=acdL2FilterMacDstMask, acdIPv4FilterSrcPort=acdIPv4FilterSrcPort, acdSmapL2FilterVlan1CfiEn=acdSmapL2FilterVlan1CfiEn, acdSmapIPv4FilterVlan1IdLast=acdSmapIPv4FilterVlan1IdLast, acdSmapIPv4FilterGroup=acdSmapIPv4FilterGroup, acdSmapIPv4FilterVlan1Id=acdSmapIPv4FilterVlan1Id, acdSmapL2FilterVlan2CfiEn=acdSmapL2FilterVlan2CfiEn, acdSmapIPv4FilterPre=acdSmapIPv4FilterPre, acdIPv4FilterECN=acdIPv4FilterECN, acdFilterCompliance=acdFilterCompliance, acdSmapL2FilterVlan1Type=acdSmapL2FilterVlan1Type, acdIPv4FilterIcmpType=acdIPv4FilterIcmpType, acdL2FilterVlan1Prior=acdL2FilterVlan1Prior, acdSmapIPv4FilterDstPort=acdSmapIPv4FilterDstPort, acdSmapIPv4FilterEntry=acdSmapIPv4FilterEntry, acdSmapL2FilterPre=acdSmapL2FilterPre, acdSmapL2FilterMacDst=acdSmapL2FilterMacDst, acdSmapL2FilterVlan2Prior=acdSmapL2FilterVlan2Prior, acdSmapL2FilterMacDstEn=acdSmapL2FilterMacDstEn, acdIPv4FilterDscp=acdIPv4FilterDscp, acdL2FilterMacSrcMask=acdL2FilterMacSrcMask, acdSmapL2FilterVlan2Type=acdSmapL2FilterVlan2Type, acdSmapIPv4FilterID=acdSmapIPv4FilterID, acdSmapL2FilterRowStatus=acdSmapL2FilterRowStatus, acdFilterCompliances=acdFilterCompliances, acdSmapL2FilterMacSrc=acdSmapL2FilterMacSrc, acdSmapIPv4FilterDstPortEn=acdSmapIPv4FilterDstPortEn, acdSmapL2FilterVlan1IdEn=acdSmapL2FilterVlan1IdEn, acdSmapL2FilterVlan1Prior=acdSmapL2FilterVlan1Prior, acdSmapL2FilterVlan2PriorLast=acdSmapL2FilterVlan2PriorLast, acdSmapL2FilterEtypeEn=acdSmapL2FilterEtypeEn, acdL2FilterVlan1Id=acdL2FilterVlan1Id, acdSmapIPv4FilterECNEn=acdSmapIPv4FilterECNEn, acdSmapIPv4FilterVlan2IdEn=acdSmapIPv4FilterVlan2IdEn, acdSmapIPv4FilterPreOper=acdSmapIPv4FilterPreOper, acdSmapIPv4FilterIHL=acdSmapIPv4FilterIHL, acdL2FilterMacSrcEn=acdL2FilterMacSrcEn, acdSmapL2FilterVlan1PriorLast=acdSmapL2FilterVlan1PriorLast, acdSmapIPv4FilterVlan1Type=acdSmapIPv4FilterVlan1Type, acdSmapIPv4FilterRowStatus=acdSmapIPv4FilterRowStatus, acdSmapIPv4FilterVlan2Id=acdSmapIPv4FilterVlan2Id, acdSmapL2FilterPreOper=acdSmapL2FilterPreOper, acdSmapIPv4FilterVlan1CfiEn=acdSmapIPv4FilterVlan1CfiEn, acdIPv4FilterIcmpCode=acdIPv4FilterIcmpCode, acdSmapIPv4FilterDstMask=acdSmapIPv4FilterDstMask, acdSmapIPv4FilterTTLEn=acdSmapIPv4FilterTTLEn, acdL2FilterTable=acdL2FilterTable, acdSmapIPv4FilterIpCosEn=acdSmapIPv4FilterIpCosEn, acdSmapL2FilterVlan2Cfi=acdSmapL2FilterVlan2Cfi, acdSmapL2FilterIpCosEn=acdSmapL2FilterIpCosEn, acdSmapIPv4FilterVlan2PriorOper=acdSmapIPv4FilterVlan2PriorOper, acdSmapIPv4FilterDscpLast=acdSmapIPv4FilterDscpLast, acdSmapIPv4FilterVlan2Prior=acdSmapIPv4FilterVlan2Prior, acdIPv4FilterECNEn=acdIPv4FilterECNEn, acdSmapIPv4FilterSrcPort=acdSmapIPv4FilterSrcPort, acdIPv4FilterProto=acdIPv4FilterProto, acdIPv4FilterDscpEn=acdIPv4FilterDscpEn, acdIPv4FilterIcmpTypeEn=acdIPv4FilterIcmpTypeEn, acdSmapIPv4FilterVlan1PriorLast=acdSmapIPv4FilterVlan1PriorLast, acdIPv4FilterTTL=acdIPv4FilterTTL, acdSmapIPv4FilterTTL=acdSmapIPv4FilterTTL, acdL2FilterVlan1Cfi=acdL2FilterVlan1Cfi, acdIPv4FilterEntry=acdIPv4FilterEntry, acdL2FilterGroup=acdL2FilterGroup, acdSmapL2FilterName=acdSmapL2FilterName, acdSmapIPv4FilterProtoEn=acdSmapIPv4FilterProtoEn, acdFilterConformance=acdFilterConformance, acdFilterTidGroup=acdFilterTidGroup, acdSmapL2FilterVlan1PriorEn=acdSmapL2FilterVlan1PriorEn, acdSmapIPv4FilterVlan1Cfi=acdSmapIPv4FilterVlan1Cfi, acdSmapL2FilterVlan1TypeEn=acdSmapL2FilterVlan1TypeEn, acdSmapIPv4FilterName=acdSmapIPv4FilterName, acdL2FilterEntry=acdL2FilterEntry, acdSmapIPv4FilterSrcPortOper=acdSmapIPv4FilterSrcPortOper, acdSmapL2FilterVlan2Id=acdSmapL2FilterVlan2Id, acdSmapL2FilterMacSrcEn=acdSmapL2FilterMacSrcEn, acdSmapIPv4FilterDscp=acdSmapIPv4FilterDscp, acdSmapIPv4FilterECN=acdSmapIPv4FilterECN, acdIPv4FilterName=acdIPv4FilterName, acdSmapIPv4FilterDst=acdSmapIPv4FilterDst, acdL2FilterVlan2CfiEn=acdL2FilterVlan2CfiEn, acdSmapL2FilterVlan1Id=acdSmapL2FilterVlan1Id, acdL2FilterEtypeEn=acdL2FilterEtypeEn, acdSmapL2FilterVlan2IdEn=acdSmapL2FilterVlan2IdEn, acdFilterMIBObjects=acdFilterMIBObjects, acdL2FilterName=acdL2FilterName, acdIPv4FilterDst=acdIPv4FilterDst, acdSmapL2FilterID=acdSmapL2FilterID, acdFilterNotifications=acdFilterNotifications, acdSmapL2FilterVlan2PriorEn=acdSmapL2FilterVlan2PriorEn, acdIPv4FilterSrcMask=acdIPv4FilterSrcMask, acdIPv4FilterSrcEn=acdIPv4FilterSrcEn, acdSmapIPv4FilterVlan2Type=acdSmapIPv4FilterVlan2Type, acdIPv4FilterRowStatus=acdIPv4FilterRowStatus, acdIPv4FilterID=acdIPv4FilterID, acdSmapIPv4FilterDstPortLast=acdSmapIPv4FilterDstPortLast, acdIPv4FilterDstEn=acdIPv4FilterDstEn, acdSmapIPv4FilterSrcMask=acdSmapIPv4FilterSrcMask, acdIPv4FilterSrcPortEn=acdIPv4FilterSrcPortEn, acdIPv4FilterTTLEn=acdIPv4FilterTTLEn, acdSmapL2FilterVlan2TypeEn=acdSmapL2FilterVlan2TypeEn, AcdFilterVlanType=AcdFilterVlanType, acdSmapIPv4FilterVlan2IdLast=acdSmapIPv4FilterVlan2IdLast, acdSmapIPv4FilterSrcPortEn=acdSmapIPv4FilterSrcPortEn, acdSmapIPv4FilterIcmpType=acdSmapIPv4FilterIcmpType, acdSmapIPv4FilterIcmpCode=acdSmapIPv4FilterIcmpCode, acdSmapL2FilterMacDstMask=acdSmapL2FilterMacDstMask, acdSmapIPv4FilterIpCosMode=acdSmapIPv4FilterIpCosMode, acdSmapIPv4FilterVlan2PriorLast=acdSmapIPv4FilterVlan2PriorLast, acdSmapL2FilterTable=acdSmapL2FilterTable, acdSmapIPv4FilterProto=acdSmapIPv4FilterProto, acdSmapL2FilterVlan2IdLast=acdSmapL2FilterVlan2IdLast, acdSmapIPv4FilterDstPortOper=acdSmapIPv4FilterDstPortOper, acdSmapIPv4FilterVlan2TypeEn=acdSmapIPv4FilterVlan2TypeEn, acdSmapIPv4FilterVlan2PriorEn=acdSmapIPv4FilterVlan2PriorEn, acdSmapIPv4FilterVlan2Cfi=acdSmapIPv4FilterVlan2Cfi, acdSmapIPv4FilterPreLast=acdSmapIPv4FilterPreLast, acdSmapL2FilterEntry=acdSmapL2FilterEntry, acdSmapL2FilterVlan2IdOper=acdSmapL2FilterVlan2IdOper, AcdFilterOperator=AcdFilterOperator, acdSmapIPv4FilterIHLEn=acdSmapIPv4FilterIHLEn, acdL2FilterID=acdL2FilterID, acdSmapIPv4FilterIcmpTypeEn=acdSmapIPv4FilterIcmpTypeEn, acdL2FilterVlan1CfiEn=acdL2FilterVlan1CfiEn, acdL2FilterVlan2PriorEn=acdL2FilterVlan2PriorEn, acdSmapIPv4FilterVlan1IdEn=acdSmapIPv4FilterVlan1IdEn, acdIPv4FilterGroup=acdIPv4FilterGroup, acdL2FilterMacSrc=acdL2FilterMacSrc, acdL2FilterVlan2IdEn=acdL2FilterVlan2IdEn, acdSmapL2FilterVlan2PriorOper=acdSmapL2FilterVlan2PriorOper, acdFilter=acdFilter, acdSmapIPv4FilterTableLastChangeTid=acdSmapIPv4FilterTableLastChangeTid, acdSmapL2FilterVlan1IdOper=acdSmapL2FilterVlan1IdOper, acdSmapIPv4FilterVlan1TypeEn=acdSmapIPv4FilterVlan1TypeEn, acdSmapL2FilterPreLast=acdSmapL2FilterPreLast, AcdFilterOperatorEqualRangeOnly=AcdFilterOperatorEqualRangeOnly, acdSmapL2FilterVlan1Cfi=acdSmapL2FilterVlan1Cfi, acdSmapIPv4FilterVlan2IdOper=acdSmapIPv4FilterVlan2IdOper, acdIPv4FilterDstPortEn=acdIPv4FilterDstPortEn, acdSmapIPv4FilterTable=acdSmapIPv4FilterTable, acdSmapIPv4FilterVlan1PriorOper=acdSmapIPv4FilterVlan1PriorOper, acdIPv4FilterSrc=acdIPv4FilterSrc, acdSmapL2FilterDscpOper=acdSmapL2FilterDscpOper, acdSmapIPv4FilterSrcPortLast=acdSmapIPv4FilterSrcPortLast, acdFilterGroups=acdFilterGroups, acdL2FilterVlan2Id=acdL2FilterVlan2Id, acdIPv4FilterDstPort=acdIPv4FilterDstPort, acdSmapIPv4FilterSrc=acdSmapIPv4FilterSrc, acdSmapIPv4FilterDscpOper=acdSmapIPv4FilterDscpOper, acdL2FilterRowStatus=acdL2FilterRowStatus, acdIPv4FilterIHL=acdIPv4FilterIHL, acdSmapIPv4FilterIcmpCodeEn=acdSmapIPv4FilterIcmpCodeEn, acdSmapL2FilterIpCosMode=acdSmapL2FilterIpCosMode, acdL2FilterVlan1IdEn=acdL2FilterVlan1IdEn, acdSmapIPv4FilterVlan1Prior=acdSmapIPv4FilterVlan1Prior, acdL2FilterVlan2Cfi=acdL2FilterVlan2Cfi, acdIPv4FilterTable=acdIPv4FilterTable)
