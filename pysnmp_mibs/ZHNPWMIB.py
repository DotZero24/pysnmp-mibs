...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/zhone/ZHNPWMIB
# Produced by pysmi-1.1.12 at Mon Aug  4 17:04:22 2025
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, transmission, Unsigned32, Integer32, Gauge32, ModuleIdentity, TimeTicks, NotificationType, Counter32, Bits, IpAddress, iso, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "transmission", "Unsigned32", "Integer32", "Gauge32", "ModuleIdentity", "TimeTicks", "NotificationType", "Counter32", "Bits", "IpAddress", "iso", "ObjectIdentity", "Counter64")
TimeStamp, RowStatus, MacAddress, StorageType, TextualConvention, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "MacAddress", "StorageType", "TextualConvention", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("ZHNPWMIB", zhnPwLocalLMBits=zhnPwLocalLMBits, zhnPeerPingRequest=zhnPeerPingRequest, PYSNMP_MODULE_ID=zhnPwMib, zhnPwAdaptState=zhnPwAdaptState, zhnPwSourceIPAddr=zhnPwSourceIPAddr, zhnPwSourceIPMask=zhnPwSourceIPMask, zhnPwMib=zhnPwMib, zhnPwSourceGateway=zhnPwSourceGateway, zhnPwIsdn=zhnPwIsdn, zhnPwMappedIfName=zhnPwMappedIfName, zhnPwPeerGateway=zhnPwPeerGateway, zhnPwTable=zhnPwTable, zhnPwAdaptTime=zhnPwAdaptTime, zhnPeerPingStatus=zhnPeerPingStatus, zhnPwMibGroups=zhnPwMibGroups, zhnPwConformance=zhnPwConformance, zhnPwLocalRBit=zhnPwLocalRBit, zhnPwNotifications=zhnPwNotifications, zhnPwAdaptSourceActual=zhnPwAdaptSourceActual, zhnPwT1E1Mode=zhnPwT1E1Mode, zhnPwVlanID=zhnPwVlanID, zhnPwPeerMask=zhnPwPeerMask, zhnPwLopAction=zhnPwLopAction, zhnPwRemoteRBit=zhnPwRemoteRBit, zhnPwOuterLabel=zhnPwOuterLabel, zhnPwRxRaiAction=zhnPwRxRaiAction, zhnPwEntry=zhnPwEntry, zhnPwRtpHeaderMode=zhnPwRtpHeaderMode, zhnPwClkAcquisitionLevel=zhnPwClkAcquisitionLevel, zhnPwPeerMACMode=zhnPwPeerMACMode, zhnPwAutoAdclEnable=zhnPwAutoAdclEnable, zhnPwObjects=zhnPwObjects, zhnPwRemoteLMBits=zhnPwRemoteLMBits, zhnPwAdaptPllMode=zhnPwAdaptPllMode, zhnPwMibConformance=zhnPwMibConformance, zhnPeerPingName=zhnPeerPingName, zhnPwPeerMAC=zhnPwPeerMAC, zhnPwIndex=zhnPwIndex, zhnPwMibScalars=zhnPwMibScalars, zhnPwUdpDstPort=zhnPwUdpDstPort, zhnPwClearTotalStats=zhnPwClearTotalStats, zhnPwMibCompliances=zhnPwMibCompliances, zhnPwRxAisAction=zhnPwRxAisAction, PwClearStatisticsTC=PwClearStatisticsTC, zhnPwVlanPriority=zhnPwVlanPriority, zhnPwMibCompliance=zhnPwMibCompliance, zhnPwActualPayloadSize=zhnPwActualPayloadSize, zhnPwMibGroup=zhnPwMibGroup)
