...
mibBuilder.exportSymbols("ZHNPWMIB", zhnPwNotifications=zhnPwNotifications, zhnPwMibConformance=zhnPwMibConformance, zhnPwPeerMAC=zhnPwPeerMAC, zhnPwMibGroups=zhnPwMibGroups, zhnPwObjects=zhnPwObjects, zhnPwLopAction=zhnPwLopAction, zhnPwPeerGateway=zhnPwPeerGateway, zhnPwLocalLMBits=zhnPwLocalLMBits, zhnPwIsdn=zhnPwIsdn, zhnPwClearTotalStats=zhnPwClearTotalStats, zhnPwSourceGateway=zhnPwSourceGateway, zhnPwConformance=zhnPwConformance, zhnPwAdaptSourceActual=zhnPwAdaptSourceActual, zhnPwMibCompliance=zhnPwMibCompliance, zhnPwRxAisAction=zhnPwRxAisAction, zhnPeerPingStatus=zhnPeerPingStatus, zhnPwVlanPriority=zhnPwVlanPriority, zhnPwEntry=zhnPwEntry, zhnPwSourceIPAddr=zhnPwSourceIPAddr, zhnPwMib=zhnPwMib, zhnPwRemoteRBit=zhnPwRemoteRBit, zhnPwOuterLabel=zhnPwOuterLabel, zhnPwMibCompliances=zhnPwMibCompliances, zhnPwRemoteLMBits=zhnPwRemoteLMBits, zhnPeerPingName=zhnPeerPingName, zhnPwAdaptState=zhnPwAdaptState, zhnPeerPingRequest=zhnPeerPingRequest, zhnPwTable=zhnPwTable, zhnPwSourceIPMask=zhnPwSourceIPMask, zhnPwMappedIfName=zhnPwMappedIfName, zhnPwActualPayloadSize=zhnPwActualPayloadSize, zhnPwUdpDstPort=zhnPwUdpDstPort, zhnPwClkAcquisitionLevel=zhnPwClkAcquisitionLevel, zhnPwMibGroup=zhnPwMibGroup, zhnPwLocalRBit=zhnPwLocalRBit, zhnPwAdaptTime=zhnPwAdaptTime, zhnPwPeerMACMode=zhnPwPeerMACMode, zhnPwMibScalars=zhnPwMibScalars, PwClearStatisticsTC=PwClearStatisticsTC, zhnPwRxRaiAction=zhnPwRxRaiAction, zhnPwAutoAdclEnable=zhnPwAutoAdclEnable, zhnPwRtpHeaderMode=zhnPwRtpHeaderMode, zhnPwIndex=zhnPwIndex, zhnPwAdaptPllMode=zhnPwAdaptPllMode, zhnPwT1E1Mode=zhnPwT1E1Mode, zhnPwPeerMask=zhnPwPeerMask, PYSNMP_MODULE_ID=zhnPwMib, zhnPwVlanID=zhnPwVlanID)
