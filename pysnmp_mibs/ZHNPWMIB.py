...
mibBuilder.exportSymbols("ZHNPWMIB", zhnPwRemoteLMBits=zhnPwRemoteLMBits, zhnPwRxAisAction=zhnPwRxAisAction, zhnPwAutoAdclEnable=zhnPwAutoAdclEnable, zhnPwEntry=zhnPwEntry, zhnPwMibCompliance=zhnPwMibCompliance, zhnPwMibGroup=zhnPwMibGroup, zhnPwLopAction=zhnPwLopAction, zhnPwActualPayloadSize=zhnPwActualPayloadSize, zhnPwClkAcquisitionLevel=zhnPwClkAcquisitionLevel, zhnPeerPingStatus=zhnPeerPingStatus, zhnPwLocalLMBits=zhnPwLocalLMBits, zhnPeerPingName=zhnPeerPingName, zhnPwMibCompliances=zhnPwMibCompliances, PYSNMP_MODULE_ID=zhnPwMib, zhnPwT1E1Mode=zhnPwT1E1Mode, zhnPwRemoteRBit=zhnPwRemoteRBit, zhnPwLocalRBit=zhnPwLocalRBit, zhnPwMappedIfName=zhnPwMappedIfName, zhnPwPeerMACMode=zhnPwPeerMACMode, zhnPwObjects=zhnPwObjects, zhnPwMibGroups=zhnPwMibGroups, zhnPwIsdn=zhnPwIsdn, zhnPwNotifications=zhnPwNotifications, zhnPwPeerMask=zhnPwPeerMask, zhnPwRxRaiAction=zhnPwRxRaiAction, zhnPwClearTotalStats=zhnPwClearTotalStats, zhnPwOuterLabel=zhnPwOuterLabel, zhnPwAdaptState=zhnPwAdaptState, zhnPwTable=zhnPwTable, zhnPwVlanPriority=zhnPwVlanPriority, zhnPwAdaptSourceActual=zhnPwAdaptSourceActual, zhnPwUdpDstPort=zhnPwUdpDstPort, zhnPwConformance=zhnPwConformance, zhnPwSourceIPAddr=zhnPwSourceIPAddr, zhnPwMibScalars=zhnPwMibScalars, zhnPwIndex=zhnPwIndex, zhnPwPeerMAC=zhnPwPeerMAC, zhnPwMib=zhnPwMib, zhnPwPeerGateway=zhnPwPeerGateway, zhnPwRtpHeaderMode=zhnPwRtpHeaderMode, zhnPwAdaptTime=zhnPwAdaptTime, zhnPeerPingRequest=zhnPeerPingRequest, zhnPwVlanID=zhnPwVlanID, zhnPwSourceGateway=zhnPwSourceGateway, zhnPwAdaptPllMode=zhnPwAdaptPllMode, zhnPwMibConformance=zhnPwMibConformance, PwClearStatisticsTC=PwClearStatisticsTC, zhnPwSourceIPMask=zhnPwSourceIPMask)
