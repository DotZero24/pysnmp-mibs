...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-IETF-VDSL-LINE-MIB
...
cvdslLineMibCompliance.setObjects(
      *(("CISCO-IETF-VDSL-LINE-MIB", "cvdslGroup"),
        ("CISCO-IETF-VDSL-LINE-MIB", "cvdslMCMGroup"),
        ("CISCO-IETF-VDSL-LINE-MIB", "cvdslSCMGroup"))
)
if mibBuilder.loadTexts:
