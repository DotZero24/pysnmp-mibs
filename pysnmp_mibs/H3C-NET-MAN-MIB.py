# SNMP MIB module (H3C-NET-MAN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/h3c/H3C-NET-MAN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:17:50 2025
...
h3cNMIpAddressType = _H3cNMIpAddressType_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 90, 3, 1, 1),
...
h3cNMIpAddress = _H3cNMIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 90, 3, 1, 2),
...
h3cNMCustomBuildInfo = _H3cNMCustomBuildInfo_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 90, 3, 1, 3),
...
h3cNMSerialNum = _H3cNMSerialNum_Object(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 90, 3, 1, 4),
...
h3cIpAddrChangeNotify = NotificationType(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 90, 3, 2, 0, 1)
)
...
h3cNMNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 90, 4, 2, 2)
)
h3cNMNotificationGroup.setObjects(
    ("H3C-NET-MAN-MIB", "h3cIpAddrChangeNotify")
)
if mibBuilder.loadTexts:
...
h3cNetManCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 2011, 10, 2, 90, 4, 1, 1)
)
h3cNetManCompliance.setObjects(
      *(("H3C-NET-MAN-MIB", "h3cNMMonitorGroup"),
        ("H3C-NET-MAN-MIB", "h3cNMNotificationGroup"))
)
if mibBuilder.loadTexts:
