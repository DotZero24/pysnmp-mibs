...
# Notes
# -----
# ASN.1 source file://mibs/ericsson/RBN-CARDMON-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:17:18 2025
...
rbnCardMonMIBCompliance.setObjects(
      *(("RBN-CARDMON-MIB", "rbnCardMonMIBObjectGroup"),
        ("RBN-CARDMON-MIB", "rbnCardMonMIBNotificationGroup"))
)
if mibBuilder.loadTexts:
...
rbnCardMonMIBCompliance2.setObjects(
      *(("RBN-CARDMON-MIB", "rbnCardMonMIBObjectGroup"),
        ("RBN-CARDMON-MIB", "rbnCardMonMIBNotificationGroup"),
        ("RBN-CARDMON-MIB", "rbnCardStatsMIBObjectGroup"))
)
if mibBuilder.loadTexts:
...
rbnCardMonMIBCompliance3.setObjects(
      *(("RBN-CARDMON-MIB", "rbnCardMonMIBObjectGroup2"),
        ("RBN-CARDMON-MIB", "rbnCardMonMIBNotificationGroup"),
        ("RBN-CARDMON-MIB", "rbnCardStatsMIBObjectGroup"))
)
if mibBuilder.loadTexts:
...
rbnCardMonMIBCompliance4.setObjects(
      *(("RBN-CARDMON-MIB", "rbnCardMonMIBObjectGroup2"),
        ("RBN-CARDMON-MIB", "rbnCardMonMIBNotificationGroup"),
        ("RBN-CARDMON-MIB", "rbnCardStatsMIBObjectGroup2"))
)
if mibBuilder.loadTexts:
