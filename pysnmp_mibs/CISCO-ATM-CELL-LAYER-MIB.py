...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-ATM-CELL-LAYER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:37:38 2025
...
_CaclHecCosetEnable_Type.__name__ = "TruthValue"
...
_CaclPayloadScramblingEnable_Type.__name__ = "TruthValue"
...
caclMIBCompliance.setObjects(
      *(("CISCO-ATM-CELL-LAYER-MIB", "caclMIBGroup"),
        ("CISCO-ATM-CELL-LAYER-MIB", "caclATMSwitchStatsMIBGroup"),
        ("CISCO-ATM-CELL-LAYER-MIB", "caclATMEndSyatemStatsMIBGroup"),
        ("CISCO-ATM-CELL-LAYER-MIB", "caclHighSpeedATMMIBGroup"))
)
if mibBuilder.loadTexts:
...
caclMIBCompliance1.setObjects(
      *(("CISCO-ATM-CELL-LAYER-MIB", "caclMIBGroup"),
        ("CISCO-ATM-CELL-LAYER-MIB", "caclATMSwitchStatsMIBGroup1"),
        ("CISCO-ATM-CELL-LAYER-MIB", "caclATMStatsMIBGroup"),
        ("CISCO-ATM-CELL-LAYER-MIB", "caclHighSpeedATMMIBGroup1"),
        ("CISCO-ATM-CELL-LAYER-MIB", "caclIntervalStatsMIBGroup1"),
        ("CISCO-ATM-CELL-LAYER-MIB", "caclHCIntervalStatsMIBGroup"))
)
if mibBuilder.loadTexts:
