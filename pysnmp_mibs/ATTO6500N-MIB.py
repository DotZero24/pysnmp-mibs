...
# Notes
# -----
# ASN.1 source file://mibs/atto/ATTO6500N-MIB
...
bridgeBasicCompliance.setObjects(
      *(("ATTO6500N-MIB", "bridgeIdentityBasicGroup"),
        ("ATTO6500N-MIB", "bridgeChassisBasicGroup"),
        ("ATTO6500N-MIB", "bridgFcPortInfoBasicGroup"),
        ("ATTO6500N-MIB", "bridgeFcPortStatisicsBasicGroup"),
        ("ATTO6500N-MIB", "bridgeSasPortInfoBasicGroup"),
        ("ATTO6500N-MIB", "bridgeSasPortStatisicsBasicGroup"),
        ("ATTO6500N-MIB", "bridgeConfigBasicGroup"),
        ("ATTO6500N-MIB", "bridgeTrapInfoBasicGroup"),
        ("ATTO6500N-MIB", "bridgeTrapsBasicGroup"))
)
if mibBuilder.loadTexts:
