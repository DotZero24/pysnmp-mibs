...
TimeInterval, DateAndTime, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "DateAndTime", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("ATTO6500N-MIB", sasQSFPIndex=sasQSFPIndex, fcSFPInfoEntry=fcSFPInfoEntry, temperatureLowAlertSetting=temperatureLowAlertSetting, fcPortStatisticsEntry=fcPortStatisticsEntry, vendorID=vendorID, sasPhyStatisticsTable=sasPhyStatisticsTable, fcSFPSerialNum=fcSFPSerialNum, fcStatsRxWords=fcStatsRxWords, fcStatsErrPrimitive=fcStatsErrPrimitive, sasPortPhy1State=sasPortPhy1State, secondaryFirmwareRevision=secondaryFirmwareRevision, fcStatsErrLipCount=fcStatsErrLipCount, bridgeConfig=bridgeConfig, fcPortAdminState=fcPortAdminState, fcPortPortNumber=fcPortPortNumber, trapClientTable=trapClientTable, bridgeName=bridgeName, bridgeTemperatureWarning=bridgeTemperatureWarning, attoMgmt=attoMgmt, sasPortPhy2State=sasPortPhy2State, dramSingleBitErrorCount=dramSingleBitErrorCount, bridgePorts=bridgePorts, sasPortPhy4State=sasPortPhy4State, sasPortDataRateNegotiated=sasPortDataRateNegotiated, sasPortDataRateCapability=sasPortDataRateCapability, chassisTemperature=chassisTemperature, QSFPTech=QSFPTech, sasPhyStatsErrInvalidCRC=sasPhyStatsErrInvalidCRC, bridgeConfigBasicGroup=bridgeConfigBasicGroup, bridgeIdentityBasicGroup=bridgeIdentityBasicGroup, fcSFPVendor=fcSFPVendor, fcStatsTimeSinceReset=fcStatsTimeSinceReset, sasPortInfoTable=sasPortInfoTable, fcSFPInfoTable=fcSFPInfoTable, modelName=modelName, bridgeMIBCompliances=bridgeMIBCompliances, fcStatsErrInvalidTxWords=fcStatsErrInvalidTxWords, bridgeUniqueId=bridgeUniqueId, trapsEnabled=trapsEnabled, sasPhyStatsTimeSinceReset=sasPhyStatsTimeSinceReset, trapClientPort=trapClientPort, trapClientEntry=trapClientEntry, fcStatsErrInvalidCRC=fcStatsErrInvalidCRC, fcPortConnModeNegotiated=fcPortConnModeNegotiated, sasPortInfoEntry=sasPortInfoEntry, fcStatsTxWords=fcStatsTxWords, temperatureHighAlertSetting=temperatureHighAlertSetting, fcStatsErrNOSCount=fcStatsErrNOSCount, primaryFirmwareBuildDate=primaryFirmwareBuildDate, PHYStatus=PHYStatus, sasQSFPVendor=sasQSFPVendor, fcStatsErrLinkFailure=fcStatsErrLinkFailure, chassisTemperatureStatus=chassisTemperatureStatus, lastReboot=lastReboot, sasPhyStatsErrPhyReset=sasPhyStatsErrPhyReset, bridgeSasPortStatisicsBasicGroup=bridgeSasPortStatisicsBasicGroup, sasPortOperationalState=sasPortOperationalState, attotech=attotech, uptime=uptime, chassisThroughputStatus=chassisThroughputStatus, bridgeSasPortInfoBasicGroup=bridgeSasPortInfoBasicGroup, fcStatsErrSignalLoss=fcStatsErrSignalLoss, secondaryFirmwareBuildDate=secondaryFirmwareBuildDate, fcPortOperationalState=fcPortOperationalState, sasPhyStatsErrLinkChanged=sasPhyStatsErrLinkChanged, bridgeThroughputWarning=bridgeThroughputWarning, fcPortPeerName=fcPortPeerName, PYSNMP_MODULE_ID=bridge, bridgeTrapInfo=bridgeTrapInfo, sasPhyStatsErrInvalidDwords=sasPhyStatsErrInvalidDwords, sasQSFPSerialNum=sasQSFPSerialNum, hardwareVersion=hardwareVersion, trapClientFilter=trapClientFilter, DisplayWWN=DisplayWWN, fcStatsIndex=fcStatsIndex, bridgeMIBGroups=bridgeMIBGroups, sasPhyStatsIndex=sasPhyStatsIndex, fcStatsErrLossOfSync=fcStatsErrLossOfSync, trapClientIndex=trapClientIndex, sasQSFPInfoTable=sasQSFPInfoTable, attoModules=attoModules, attoProducts=attoProducts, fcPortConnModeConfigured=fcPortConnModeConfigured, minimumOperatingTemp=minimumOperatingTemp, serialNumber=serialNumber, sasPortAddress=sasPortAddress, bridgeTraps=bridgeTraps, sasPortPhy3State=sasPortPhy3State, snmpUpdatesEnabled=snmpUpdatesEnabled, bridgeTrapsBasicGroup=bridgeTrapsBasicGroup, fcPortIndex=fcPortIndex, sasPortAdminState=sasPortAdminState, sasPortTransition=sasPortTransition, bridgFcPortInfoBasicGroup=bridgFcPortInfoBasicGroup, fcPortDataRateCapability=fcPortDataRateCapability, fcPortInfoEntry=fcPortInfoEntry, bridgeIdentity=bridgeIdentity, sasPhyStatisticsEntry=sasPhyStatisticsEntry, fcPortDataRateConfigured=fcPortDataRateConfigured, bridge=bridge, lastRebootReason=lastRebootReason, primaryFirmwareRevision=primaryFirmwareRevision, trapClientIpAddress=trapClientIpAddress, attoAgentCapability=attoAgentCapability, sasQSFPPartNum=sasQSFPPartNum, trapMaxClients=trapMaxClients, bridgeMIBConformance=bridgeMIBConformance, sasPhyStatsErrLossOfSync=sasPhyStatsErrLossOfSync, fcSFPIndex=fcSFPIndex, bridgeTrapInfoBasicGroup=bridgeTrapInfoBasicGroup, maximumOperatingTemp=maximumOperatingTemp, sasQSFPType=sasQSFPType, sasQSFPInfoEntry=sasQSFPInfoEntry, bridgeFcPortStatisicsBasicGroup=bridgeFcPortStatisicsBasicGroup, fcPortPortName=fcPortPortName, fcPortTransition=fcPortTransition, sasPhyStatsErrDisparityCount=sasPhyStatsErrDisparityCount, bridgeBasicCompliance=bridgeBasicCompliance, fcPortStatisticsTable=fcPortStatisticsTable, fcSFPDataRateCapability=fcSFPDataRateCapability, sasPortIndex=sasPortIndex, bridgeChassisBasicGroup=bridgeChassisBasicGroup, fcPortNodeName=fcPortNodeName, fcSFPPartNum=fcSFPPartNum, fcPortDataRateNegotiated=fcPortDataRateNegotiated, sasPortPortNumber=sasPortPortNumber, bridgeChassis=bridgeChassis, fcPortInfoTable=fcPortInfoTable)
