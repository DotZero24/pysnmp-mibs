#
# PySNMP MIB module BROADCOM-POWER-ETHERNET-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/broadcom/BROADCOM-POWER-ETHERNET-MIB
...
fastPathpowerEthernetMIB.setRevisions(('2007-08-19 12:00', '2007-05-23 00:00', '2003-11-10 12:00',))
...
pethPsePortEntry.registerAugmentions(("BROADCOM-POWER-ETHERNET-MIB", "agentPethPsePortEntry"))
...
agentPethPowerLimitType = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 15, 1, 1, 1, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("dot3af", 1), ("user", 2)))).setMaxAccess("readwrite")
...
agentPethFaultStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 4413, 1, 1, 15, 1, 1, 1, 9), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4))).clone(namedValues=NamedValues(("none", 0), ("mpsAbsent", 1), ("short", 2), ("overload", 3), ("powerDenied", 4)))).setMaxAccess("readonly")
...
pethMainPseEntry.registerAugmentions(("BROADCOM-POWER-ETHERNET-MIB", "agentPethMainPseEntry"))
...
pethMainPseEntry.registerAugmentions(("BROADCOM-POWER-ETHERNET-MIB", "agentPethPseEntry"))
