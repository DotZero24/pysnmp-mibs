...
if mibBuilder.loadTexts:ssh.setRevisions(('2012-09-05 00:00',))
_SshGeneralGroup_ObjectIdentity=ObjectIdentity
sshGeneralGroup=_SshGeneralGroup_ObjectIdentity((1,3,6,1,4,1,2076,97,1))
...
sshVersionCompatibility=_SshVersionCompatibility_Object((1,3,6,1,4,1,2076,97,1,1),_SshVersionCompatibility_Type())
sshVersionCompatibility.setMaxAccess(_A)
if mibBuilder.loadTexts:sshVersionCompatibility.setStatus(_B)
class _SshCipherList_Type(Integer32):defaultValue=181
_SshCipherList_Type.__name__=_C
_SshCipherList_Object=MibScalar
sshCipherList=_SshCipherList_Object((1,3,6,1,4,1,2076,97,1,2),_SshCipherList_Type())
sshCipherList.setMaxAccess(_A)
if mibBuilder.loadTexts:sshCipherList.setStatus(_B)
class _SshMacList_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,3))
_SshMacList_Type.__name__=_C
_SshMacList_Object=MibScalar
sshMacList=_SshMacList_Object((1,3,6,1,4,1,2076,97,1,3),_SshMacList_Type())
...
sshTrace=_SshTrace_Object((1,3,6,1,4,1,2076,97,1,4),_SshTrace_Type())
...
sshStatus=_SshStatus_Object((1,3,6,1,4,1,2076,97,1,5),_SshStatus_Type())
sshStatus.setMaxAccess(_A)
if mibBuilder.loadTexts:sshStatus.setStatus(_B)
class _SshTransportMaxAllowedBytes_Type(Integer32):defaultValue=32768;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,32768))
_SshTransportMaxAllowedBytes_Type.__name__=_C
_SshTransportMaxAllowedBytes_Object=MibScalar
sshTransportMaxAllowedBytes=_SshTransportMaxAllowedBytes_Object((1,3,6,1,4,1,2076,97,1,6),_SshTransportMaxAllowedBytes_Type())
...
sshSrvBindAddr=_SshSrvBindAddr_Object((1,3,6,1,4,1,2076,97,1,7),_SshSrvBindAddr_Type())
