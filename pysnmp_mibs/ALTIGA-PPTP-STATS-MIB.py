...
mibBuilder.exportSymbols("ALTIGA-PPTP-STATS-MIB", alPptpStatsTunnelPeerMaxChan=alPptpStatsTunnelPeerMaxChan, PYSNMP_MODULE_ID=altigaPptpStatsMibModule, alPptpStatsSessionMaximumSpeed=alPptpStatsSessionMaximumSpeed, alPptpStatsTunnelRowStatus=alPptpStatsTunnelRowStatus, alPptpStatsPayloadSendOctets=alPptpStatsPayloadSendOctets, alPptpStatsTunnelTable=alPptpStatsTunnelTable, alPptpStatsPayloadRecvOctets=alPptpStatsPayloadRecvOctets, alPptpStatsSessionDatastreamId=alPptpStatsSessionDatastreamId, alPptpStatsSessionSendZLB=alPptpStatsSessionSendZLB, alPptpStatsControlSendPackets=alPptpStatsControlSendPackets, alPptpStatsControlSendOctets=alPptpStatsControlSendOctets, alPptpStatsTunnelPeerIpAddr=alPptpStatsTunnelPeerIpAddr, alPptpStatsTunnelLocalIpAddr=alPptpStatsTunnelLocalIpAddr, alPptpStatsSessionPeerCallId=alPptpStatsSessionPeerCallId, alPptpStatsSessionSerial=alPptpStatsSessionSerial, alPptpStatsSessionPeerPpd=alPptpStatsSessionPeerPpd, alPptpStatsSessionRecvOctets=alPptpStatsSessionRecvOctets, altigaPptpStatsGroup=altigaPptpStatsGroup, alPptpStatsSessionOutOfSequence=alPptpStatsSessionOutOfSequence, alPptpStatsSessionSendPackets=alPptpStatsSessionSendPackets, alPptpStatsLocalFraming=alPptpStatsLocalFraming, alPptpStatsSessionPeerFlowOff=alPptpStatsSessionPeerFlowOff, alPptpStatsMaxTunnels=alPptpStatsMaxTunnels, altigaPptpStatsMibModule=altigaPptpStatsMibModule, alPptpStatsPayloadRecvPackets=alPptpStatsPayloadRecvPackets, alPptpStatsSessionFramingType=alPptpStatsSessionFramingType, alPptpStatsSessionPhysicalChannel=alPptpStatsSessionPhysicalChannel, altigaPptpStatsMibCompliances=altigaPptpStatsMibCompliances, alPptpStatsControlRecvPackets=alPptpStatsControlRecvPackets, alPptpStatsSessionMinimumSpeed=alPptpStatsSessionMinimumSpeed, alPptpStatsSessionRecvPackets=alPptpStatsSessionRecvPackets, alPptpStatsTunnelPeerFramingCap=alPptpStatsTunnelPeerFramingCap, alPptpStatsSessionAckTimeouts=alPptpStatsSessionAckTimeouts, alPptpStatsSessionRecvZLB=alPptpStatsSessionRecvZLB, alPptpStatsPayloadRecvDiscards=alPptpStatsPayloadRecvDiscards, alPptpStatsActiveSessions=alPptpStatsActiveSessions, alPptpStatsSessionEntry=alPptpStatsSessionEntry, alPptpStatsSessionUserName=alPptpStatsSessionUserName, alPptpStatsTunnelActiveSessions=alPptpStatsTunnelActiveSessions, alPptpStatsSessionRecvDiscards=alPptpStatsSessionRecvDiscards, alPptpStatsPayloadSendPackets=alPptpStatsPayloadSendPackets, alPptpStatsSessionLocalWindowSize=alPptpStatsSessionLocalWindowSize, alPptpStatsSessionLocalFlowOff=alPptpStatsSessionLocalFlowOff, alPptpStatsSessionConnectSpeed=alPptpStatsSessionConnectSpeed, alPptpStatsMaxSessions=alPptpStatsMaxSessions, alPptpStatsSessionLocalCallId=alPptpStatsSessionLocalCallId, alPptpStatsSessionOutOfWindow=alPptpStatsSessionOutOfWindow, alPptpStatsSessionTunnelPeerIpAddr=alPptpStatsSessionTunnelPeerIpAddr, alPptpStatsActiveTunnels=alPptpStatsActiveTunnels, alPptpStatsTunnelEntry=alPptpStatsTunnelEntry, alPptpStatsTunnelPeerVendorName=alPptpStatsTunnelPeerVendorName, alPptpStatsLocalProtVers=alPptpStatsLocalProtVers, alPptpStatsTunnelDatastreamId=alPptpStatsTunnelDatastreamId, alPptpStatsLocalFirmwareRev=alPptpStatsLocalFirmwareRev, alPptpStatsTotalTunnels=alPptpStatsTotalTunnels, alPptpStatsTunnelPeerBearerCap=alPptpStatsTunnelPeerBearerCap, alPptpStatsControlRecvOctets=alPptpStatsControlRecvOctets, altigaPptpStatsMibCompliance=altigaPptpStatsMibCompliance, alPptpStatsSessionPeerWindowSize=alPptpStatsSessionPeerWindowSize, alPptpStatsTotalSessions=alPptpStatsTotalSessions, alPptpStatsControlRecvDiscards=alPptpStatsControlRecvDiscards, alPptpStatsTunnelPeerFirmwareRev=alPptpStatsTunnelPeerFirmwareRev, alPptpStatsSessionSendOctets=alPptpStatsSessionSendOctets, alPptpStatsSessionBearerType=alPptpStatsSessionBearerType, alPptpStatsLocalBearer=alPptpStatsLocalBearer, alPptpStatsTunnelPeerHostName=alPptpStatsTunnelPeerHostName, alPptpStatsSessionRowStatus=alPptpStatsSessionRowStatus, alPptpStatsSessionLocalPpd=alPptpStatsSessionLocalPpd, alStatsPptpGlobal=alStatsPptpGlobal, alPptpStatsSessionTable=alPptpStatsSessionTable, altigaPptpStatsMibConformance=altigaPptpStatsMibConformance, alPptpStatsTunnelPeerProtVers=alPptpStatsTunnelPeerProtVers)
