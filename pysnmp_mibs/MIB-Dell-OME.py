...
# Notes
# -----
# ASN.1 source file://mibs/dell/MIB-Dell-OME
# Produced by pysmi-1.6.2 at Fri Oct 10 21:07:59 2025
...
omeAlertDataSources = _OmeAlertDataSources_Object(
    (1, 3, 6, 1, 4, 1, 674, 11000, 1000, 100, 1, 4),
    _OmeAlertDataSources_Type()
)
omeAlertDataSources.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    omeAlertDataSources.setStatus("mandatory")
_OmeRawAlertInfo_Type = DellString
_OmeRawAlertInfo_Object = MibScalar
omeRawAlertInfo = _OmeRawAlertInfo_Object(
    (1, 3, 6, 1, 4, 1, 674, 11000, 1000, 100, 1, 5),
    _OmeRawAlertInfo_Type()
)
omeRawAlertInfo.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    omeRawAlertInfo.setStatus("mandatory")
...
omeAlertUnknownStatus.setObjects(
      *(("MIB-Dell-OME", "omeAlertMessage"),
        ("MIB-Dell-OME", "omeAlertDevice"),
        ("MIB-Dell-OME", "omeAlertDataSources"),
        ("MIB-Dell-OME", "omeRawAlertInfo"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"DellString": DellString,
       ...
       "omeAlertDataSources": omeAlertDataSources,
       "omeRawAlertInfo": omeRawAlertInfo}
)
