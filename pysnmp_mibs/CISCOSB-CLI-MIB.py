...
rlCliMibVersion=_RlCliMibVersion_Object((1,3,6,1,4,1,9,6,1,101,52,1),_RlCliMibVersion_Type())
...
rlCliPassword=_RlCliPassword_Object((1,3,6,1,4,1,9,6,1,101,52,2),_RlCliPassword_Type())
...
rlCliTimer=_RlCliTimer_Object((1,3,6,1,4,1,9,6,1,101,52,3),_RlCliTimer_Type())
...
rlCliFileEnable=_RlCliFileEnable_Object((1,3,6,1,4,1,9,6,1,101,52,4),_RlCliFileEnable_Type())
...
rlCliFileEnableAfterReset=_RlCliFileEnableAfterReset_Object((1,3,6,1,4,1,9,6,1,101,52,5),_RlCliFileEnableAfterReset_Type())
...
rlCLIremoteCLIsupport=_RlCLIremoteCLIsupport_ObjectIdentity((1,3,6,1,4,1,9,6,1,101,52,6))
class _RlCLIremoteCLIcommand_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2,3,4,5,6,7)));namedValues=NamedValues(*(('takeRemoteCLI',1),('releaseRemoteCLI',2),('applySentCLI',3),('deleteCommandsCLI',4),('setEchoModeCLI',5),('unsetEchoModeCLI',6),('applySentDebugCommands',7)))
_RlCLIremoteCLIcommand_Type.__name__=_D
_RlCLIremoteCLIcommand_Object=MibScalar
rlCLIremoteCLIcommand=_RlCLIremoteCLIcommand_Object((1,3,6,1,4,1,9,6,1,101,52,6,1),_RlCLIremoteCLIcommand_Type())
...
rlCLIremoteCLIexecutionState=_RlCLIremoteCLIexecutionState_Object((1,3,6,1,4,1,9,6,1,101,52,6,2),_RlCLIremoteCLIexecutionState_Type())
...
rlCLIremoteCLIexecutionCommandIndex=_RlCLIremoteCLIexecutionCommandIndex_Object((1,3,6,1,4,1,9,6,1,101,52,6,3),_RlCLIremoteCLIexecutionCommandIndex_Type())
...
rlCLIremoteCLImode=_RlCLIremoteCLImode_Object((1,3,6,1,4,1,9,6,1,101,52,6,4),_RlCLIremoteCLImode_Type())
...
rlCLIremoteCLIcommandsTable=_RlCLIremoteCLIcommandsTable_Object((1,3,6,1,4,1,9,6,1,101,52,6,5))
if mibBuilder.loadTexts:rlCLIremoteCLIcommandsTable.setStatus(_A)
_RlCLIremoteCLIcommandsEntry_Object=MibTableRow
rlCLIremoteCLIcommandsEntry=_RlCLIremoteCLIcommandsEntry_Object((1,3,6,1,4,1,9,6,1,101,52,6,5,1))
...
rlCLIremoteCLIcommandIndex=_RlCLIremoteCLIcommandIndex_Object((1,3,6,1,4,1,9,6,1,101,52,6,5,1,1),_RlCLIremoteCLIcommandIndex_Type())
...
rlCLIremoteCLIcommandPartNumber=_RlCLIremoteCLIcommandPartNumber_Object((1,3,6,1,4,1,9,6,1,101,52,6,5,1,2),_RlCLIremoteCLIcommandPartNumber_Type())
...
rlCLIremoteCLIcommandPart=_RlCLIremoteCLIcommandPart_Object((1,3,6,1,4,1,9,6,1,101,52,6,5,1,3),_RlCLIremoteCLIcommandPart_Type())
...
rlCLIremoteCLIcommandStatus=_RlCLIremoteCLIcommandStatus_Object((1,3,6,1,4,1,9,6,1,101,52,6,5,1,4),_RlCLIremoteCLIcommandStatus_Type())
...
rlCLIremoteCLIactivationStatus=_RlCLIremoteCLIactivationStatus_Object((1,3,6,1,4,1,9,6,1,101,52,6,5,1,5),_RlCLIremoteCLIactivationStatus_Type())
...
rlCLIremoteCLIoutputsTable=_RlCLIremoteCLIoutputsTable_Object((1,3,6,1,4,1,9,6,1,101,52,6,6))
if mibBuilder.loadTexts:rlCLIremoteCLIoutputsTable.setStatus(_A)
_RlCLIremoteCLIoutputsEntry_Object=MibTableRow
rlCLIremoteCLIoutputsEntry=_RlCLIremoteCLIoutputsEntry_Object((1,3,6,1,4,1,9,6,1,101,52,6,6,1))
...
rlCLIremoteCLIoutputRowIndex=_RlCLIremoteCLIoutputRowIndex_Object((1,3,6,1,4,1,9,6,1,101,52,6,6,1,1),_RlCLIremoteCLIoutputRowIndex_Type())
...
rlCLIremoteCLIoutputRowPartNumber=_RlCLIremoteCLIoutputRowPartNumber_Object((1,3,6,1,4,1,9,6,1,101,52,6,6,1,2),_RlCLIremoteCLIoutputRowPartNumber_Type())
...
rlCLIremoteCLIoutputRowPart=_RlCLIremoteCLIoutputRowPart_Object((1,3,6,1,4,1,9,6,1,101,52,6,6,1,3),_RlCLIremoteCLIoutputRowPart_Type())
...
rlCLIremoteCLIoutputRowStatus=_RlCLIremoteCLIoutputRowStatus_Object((1,3,6,1,4,1,9,6,1,101,52,6,6,1,4),_RlCLIremoteCLIoutputRowStatus_Type())
...
rlCLIremoteCLIoutputCommandNumber=_RlCLIremoteCLIoutputCommandNumber_Object((1,3,6,1,4,1,9,6,1,101,52,6,6,1,5),_RlCLIremoteCLIoutputCommandNumber_Type())
...
rlCLIremoteCLIinstance=_RlCLIremoteCLIinstance_Object((1,3,6,1,4,1,9,6,1,101,52,6,7),_RlCLIremoteCLIinstance_Type())
