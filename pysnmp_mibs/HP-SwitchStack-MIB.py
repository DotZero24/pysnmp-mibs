...
mibBuilder.exportSymbols("HP-SwitchStack-MIB", hpStackStatsMemberOperStatus=hpStackStatsMemberOperStatus, hpSwitchVirtualStackMibConformance=hpSwitchVirtualStackMibConformance, hpSwitchStackMemberSwitchNum=hpSwitchStackMemberSwitchNum, hpSwitchVirtualStackMibCompliance=hpSwitchVirtualStackMibCompliance, hpSwitchVirtualStackMibGroups=hpSwitchVirtualStackMibGroups, hpSwitchStackConfigMemberTable=hpSwitchStackConfigMemberTable, hpStackStatsMgmtIpAddr=hpStackStatsMgmtIpAddr, hpDiscoverStatsCandidateDeviceType=hpDiscoverStatsCandidateDeviceType, hpSwitchDiscoveryConfig=hpSwitchDiscoveryConfig, hpDiscoverStatsCandidatesTable=hpDiscoverStatsCandidatesTable, hpSwitchStackAutoJoin=hpSwitchStackAutoJoin, hpDiscoverStatsCandidateEntry=hpDiscoverStatsCandidateEntry, hpDiscoverStatsSwitchStatus=hpDiscoverStatsSwitchStatus, PYSNMP_MODULE_ID=hpSwitchVirtualStackMib, hpDiscoverStatsEntry=hpDiscoverStatsEntry, hpSwitchStackMemberEntryStatus=hpSwitchStackMemberEntryStatus, hpDiscoverStatsCandidateSystemName=hpDiscoverStatsCandidateSystemName, hpSwitchDiscoveryTransmissionInterval=hpSwitchDiscoveryTransmissionInterval, hpSwitchDiscoveryAdminStatus=hpSwitchDiscoveryAdminStatus, hpStackStatsMembersTable=hpStackStatsMembersTable, hpStackStatsMemberEntry=hpStackStatsMemberEntry, hpStackStatsMemberSystemName=hpStackStatsMemberSystemName, hpDiscoverStatsCandidateMacAddr=hpDiscoverStatsCandidateMacAddr, hpSwitchStackAdminStatus=hpSwitchStackAdminStatus, hpSwitchStackConfigGroup1=hpSwitchStackConfigGroup1, hpStackStatsMembersUnreachable=hpStackStatsMembersUnreachable, hpSwitchStackConfigGroup=hpSwitchStackConfigGroup, hpStackStats=hpStackStats, hpDiscoverStatsSwitchSystemName=hpDiscoverStatsSwitchSystemName, hpSwitchStackPropagate=hpSwitchStackPropagate, hpStackStatsMemberMacAddr=hpStackStatsMemberMacAddr, hpDiscoverStatsSwitchIndex=hpDiscoverStatsSwitchIndex, hpSwitchStackMemberPasswordLong=hpSwitchStackMemberPasswordLong, hpSwitchStackCommandAddr=hpSwitchStackCommandAddr, hpStackStatsMemberID=hpStackStatsMemberID, hpSwitchDiscoverConfigGroup=hpSwitchDiscoverConfigGroup, hpSwitchStackConfigMemberEntry=hpSwitchStackConfigMemberEntry, hpSwitchStackMemberMacAddr=hpSwitchStackMemberMacAddr, hpSwitchVirtualStackMibCompliance1=hpSwitchVirtualStackMibCompliance1, hpDiscoverStatsSwitchStackName=hpDiscoverStatsSwitchStackName, hpStackStatsMemberSwitchIndx=hpStackStatsMemberSwitchIndx, hpSwitchVirtualStackMibCompliances=hpSwitchVirtualStackMibCompliances, hpStackStatsStackingStatus=hpStackStatsStackingStatus, hpSwitchVirtualStackMib=hpSwitchVirtualStackMib, hpSwitchStackStatsGroup=hpSwitchStackStatsGroup, hpStackStatsMembersNum=hpStackStatsMembersNum, hpSwitchStackConfig=hpSwitchStackConfig, hpDiscoverStatsSwitchMacAddr=hpDiscoverStatsSwitchMacAddr, hpSwitchStackAutoGrab=hpSwitchStackAutoGrab, hpSwitchStackName=hpSwitchStackName, hpDiscoverStatsGroup=hpDiscoverStatsGroup, hpSwitchStackMemberPassword=hpSwitchStackMemberPassword, hpStackStatsName=hpStackStatsName, hpStackStatsMemberDeviceType=hpStackStatsMemberDeviceType, hpDiscoverStatsTable=hpDiscoverStatsTable)
