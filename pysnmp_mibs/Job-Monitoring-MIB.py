...
mibBuilder.exportSymbols("Job-Monitoring-MIB", jmJobIDEntry=jmJobIDEntry, jmMIBCompliance=jmMIBCompliance, JmJobServiceTypesTC=JmJobServiceTypesTC, JmPrinterResolutionTC=JmPrinterResolutionTC, JmJobStateReasons3TC=JmJobStateReasons3TC, jmJob=jmJob, jmAttributeGroup=jmAttributeGroup, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, jmAttributeTypeIndex=jmAttributeTypeIndex, jmAttributeValueAsInteger=jmAttributeValueAsInteger, jmJobOwner=jmJobOwner, jmJobIDGroup=jmJobIDGroup, jmGeneralJobPersistence=jmGeneralJobPersistence, jmAttributeTable=jmAttributeTable, JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, JmBooleanTC=JmBooleanTC, jmGeneralEntry=jmGeneralEntry, jmAttributeEntry=jmAttributeEntry, jmJobID=jmJobID, PYSNMP_MODULE_ID=jobmonMIB, JmMediumTypeTC=JmMediumTypeTC, jmJobTable=jmJobTable, JmJobStateReasons1TC=JmJobStateReasons1TC, JmPrintQualityTC=JmPrintQualityTC, JmUTF8StringTC=JmUTF8StringTC, jmGeneralJobSetName=jmGeneralJobSetName, jmAttributeInstanceIndex=jmAttributeInstanceIndex, JmTonerEconomyTC=JmTonerEconomyTC, JmJobStringTC=JmJobStringTC, jmMIBGroups=jmMIBGroups, jobmonMIBObjects=jobmonMIBObjects, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, jmJobIDJobIndex=jmJobIDJobIndex, jmJobEntry=jmJobEntry, jmJobSubmissionID=jmJobSubmissionID, jmGeneralTable=jmGeneralTable, jmAttribute=jmAttribute, jmJobImpressionsCompleted=jmJobImpressionsCompleted, jmJobIDJobSetIndex=jmJobIDJobSetIndex, jmJobStateReasons1=jmJobStateReasons1, JmAttributeTypeTC=JmAttributeTypeTC, jmGeneralAttributePersistence=jmGeneralAttributePersistence, JmTimeStampTC=JmTimeStampTC, jmGeneral=jmGeneral, jmJobState=jmJobState, jobmonMIBNotifications=jobmonMIBNotifications, JmJobStateReasons4TC=JmJobStateReasons4TC, jmGeneralJobSetIndex=jmGeneralJobSetIndex, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, JmJobStateTC=JmJobStateTC, jmMIBConformance=jmMIBConformance, JmJobCollationTypeTC=JmJobCollationTypeTC, jmGeneralGroup=jmGeneralGroup, jmJobGroup=jmJobGroup, jmJobIndex=jmJobIndex, jobmonMIB=jobmonMIB, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, jmJobKOctetsProcessed=jmJobKOctetsProcessed, jmJobIDTable=jmJobIDTable, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, JmJobStateReasons2TC=JmJobStateReasons2TC, JmFinishingTC=JmFinishingTC, jmAttributeValueAsOctets=jmAttributeValueAsOctets)
