...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/adva/F3-SYNC-MIB
...
SecondaryState, AdminState, F3DisplayString, OperationalState = mibBuilder.importSymbols("CM-COMMON-MIB", "SecondaryState", "AdminState", "F3DisplayString", "OperationalState")
...
RowStatus, DateAndTime, TextualConvention, StorageType, VariablePointer, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TextualConvention", "StorageType", "VariablePointer", "TruthValue", "DisplayString")
f3SyncMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 2544, 1, 12, 12))
f3SyncMIB.setRevisions(('2010-03-25 00:00',))
if mibBuilder.loadTexts: f3SyncMIB.setLastUpdated('201304240000Z')
if mibBuilder.loadTexts: f3SyncMIB.setOrganization('ADVA Optical Networking')
...
class TimeHoldoverPerformance(TextualConvention, Integer32):
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7))
    namedValues = NamedValues(("time-500ns", 1), ("time-1000ns", 2), ("time-1500ns", 3), ("time-5000ns", 4), ("time-10000ns", 5), ("time-0ns", 6), ("time-100ns", 7))
...
f3TimeClockFrequencyClockMode = MibTableColumn((1, 3, 6, 1, 4, 1, 2544, 1, 12, 12, 1, 3, 1, 23), TimeClockMode()).setMaxAccess("readonly")
...
f3SyncObjectGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 2544, 1, 12, 12, 2, 2, 1)).setObjects(("F3-SYNC-MIB", "f3SyncIndex"), ("F3-SYNC-MIB", "f3SyncAdminState"), ("F3-SYNC-MIB", "f3SyncOperationalState"), ("F3-SYNC-MIB", "f3SyncSecondaryState"), ("F3-SYNC-MIB", "f3SyncNetworkClockType"), ("F3-SYNC-MIB", "f3SyncSelectedReference"), ("F3-SYNC-MIB", "f3SyncClockMode"), ("F3-SYNC-MIB", "f3SyncQL"), ("F3-SYNC-MIB", "f3SyncAlias"), ("F3-SYNC-MIB", "f3SyncDomain"), ("F3-SYNC-MIB", "f3SyncSelectionMode"), ("F3-SYNC-MIB", "f3SyncWaitToRestoreTime"), ("F3-SYNC-MIB", "f3SyncOperationSyncRef"), ("F3-SYNC-MIB", "f3SyncOperationType"), ("F3-SYNC-MIB", "f3SyncRefIndex"), ("F3-SYNC-MIB", "f3SyncRefReference"), ("F3-SYNC-MIB", "f3SyncRefPriority"), ("F3-SYNC-MIB", "f3SyncRefStatus"), ("F3-SYNC-MIB", "f3SyncRefState"), ("F3-SYNC-MIB", "f3SyncRefReceivedQL"), ("F3-SYNC-MIB", "f3SyncRefStorageType"), ("F3-SYNC-MIB", "f3SyncRefRowStatus"), ("F3-SYNC-MIB", "f3SyncRefAlias"), ("F3-SYNC-MIB", "f3SyncRefEffectiveQL"), ("F3-SYNC-MIB", "f3SyncRefOperationType"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    f3SyncObjectGroup = f3SyncObjectGroup.setStatus('current')
f3TimeClockObjectGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 2544, 1, 12, 12, 2, 2, 2)).setObjects(("F3-SYNC-MIB", "f3TimeClockIndex"), ("F3-SYNC-MIB", "f3TimeClockAlias"), ("F3-SYNC-MIB", "f3TimeClockAdminState"), ("F3-SYNC-MIB", "f3TimeClockOperationalState"), ("F3-SYNC-MIB", "f3TimeClockSecondaryState"), ("F3-SYNC-MIB", "f3TimeClockSelectedReference"), ("F3-SYNC-MIB", "f3TimeClockClockMode"), ("F3-SYNC-MIB", "f3TimeClockClockClass"), ("F3-SYNC-MIB", "f3TimeClockSelectionMode"), ("F3-SYNC-MIB", "f3TimeClockWaitToRestoreTime"), ("F3-SYNC-MIB", "f3TimeClockOperationTimeClockRef"), ("F3-SYNC-MIB", "f3TimeClockOperationType"), ("F3-SYNC-MIB", "f3TimeClockLeap59"), ("F3-SYNC-MIB", "f3TimeClockLeap61"), ("F3-SYNC-MIB", "f3TimeClockTimeTraceAbilityStatus"), ("F3-SYNC-MIB", "f3TimeClockExpectedQL"), ("F3-SYNC-MIB", "f3TimeClockCurrentQL"), ("F3-SYNC-MIB", "f3TimeClockSyncRefCandidate"), ("F3-SYNC-MIB", "f3TimeClockTimeHoldoverPerformance"), ("F3-SYNC-MIB", "f3TimeClockUtcOffset"), ("F3-SYNC-MIB", "f3TimeClockCurrentTimeOfDay"), ("F3-SYNC-MIB", "f3TimeClockRefIndex"), ("F3-SYNC-MIB", "f3TimeClockRefAlias"), ("F3-SYNC-MIB", "f3TimeClockRefReference"), ("F3-SYNC-MIB", "f3TimeClockRefPriority"), ("F3-SYNC-MIB", "f3TimeClockRefStatus"), ("F3-SYNC-MIB", "f3TimeClockRefState"), ("F3-SYNC-MIB", "f3TimeClockRefOperationType"), ("F3-SYNC-MIB", "f3TimeClockRefStorageType"), ("F3-SYNC-MIB", "f3TimeClockRefRowStatus"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    f3TimeClockObjectGroup = f3TimeClockObjectGroup.setStatus('current')
mibBuilder.exportSymbols("F3-SYNC-MIB", f3SyncSelectionMode=f3SyncSelectionMode, f3SyncRefStorageType=f3SyncRefStorageType, f3SyncTable=f3SyncTable, f3TimeClockTable=f3TimeClockTable, f3TimeClockFrequencyClockMode=f3TimeClockFrequencyClockMode, f3TimeClockRefAlias=f3TimeClockRefAlias, f3TimeClockOperationType=f3TimeClockOperationType, f3SyncIndex=f3SyncIndex, PYSNMP_MODULE_ID=f3SyncMIB, f3SyncRefEntry=f3SyncRefEntry, f3SyncRefStatus=f3SyncRefStatus, f3TimeClockLeap61=f3TimeClockLeap61, f3TimeClockTimeHoldoverPerformance=f3TimeClockTimeHoldoverPerformance, f3TimeClockSecondaryState=f3TimeClockSecondaryState, f3TimeClockClockMode=f3TimeClockClockMode, f3SyncObjectGroup=f3SyncObjectGroup, f3TimeClockRefReference=f3TimeClockRefReference, f3SyncRefIndex=f3SyncRefIndex, TimeClockMode=TimeClockMode, SSMQualityLevel=SSMQualityLevel, f3SyncOperationType=f3SyncOperationType, f3TimeClockRefOperationType=f3TimeClockRefOperationType, f3TimeClockWaitToRestoreTime=f3TimeClockWaitToRestoreTime, SyncDomainType=SyncDomainType, TimeHoldoverPerformance=TimeHoldoverPerformance, f3TimeClockOperationTimeClockRef=f3TimeClockOperationTimeClockRef, f3TimeClockClockClass=f3TimeClockClockClass, SyncRefState=SyncRefState, f3TimeClockAlias=f3TimeClockAlias, f3SyncRefPriority=f3SyncRefPriority, HoldoverAccuracy=HoldoverAccuracy, f3SyncOperationSyncRef=f3SyncOperationSyncRef, f3SyncRefOperationType=f3SyncRefOperationType, f3SyncQL=f3SyncQL, f3SyncSecondaryState=f3SyncSecondaryState, f3TimeClockEntry=f3TimeClockEntry, f3SyncNetworkClockType=f3SyncNetworkClockType, f3TimeClockRefIndex=f3TimeClockRefIndex, f3SyncRefEffectiveQL=f3SyncRefEffectiveQL, f3SyncGroups=f3SyncGroups, SyncOperationType=SyncOperationType, f3TimeClockOperationalState=f3TimeClockOperationalState, f3TimeClockRefTable=f3TimeClockRefTable, f3SyncCompliance=f3SyncCompliance, TimeSource=TimeSource, f3TimeClockRefState=f3TimeClockRefState, NetworkClockType=NetworkClockType, SquelchControl=SquelchControl, f3TimeClockRefRowStatus=f3TimeClockRefRowStatus, f3TimeClockRefStorageType=f3TimeClockRefStorageType, f3SyncRefRowStatus=f3SyncRefRowStatus, f3SyncRefState=f3SyncRefState, f3SyncSelectedReference=f3SyncSelectedReference, f3TimeClockRefStatus=f3TimeClockRefStatus, f3SyncConformance=f3SyncConformance, f3SyncClockMode=f3SyncClockMode, f3TimeClockRefEntry=f3TimeClockRefEntry, f3TimeClockSelectedReference=f3TimeClockSelectedReference, f3SyncObjects=f3SyncObjects, f3TimeClockIndex=f3TimeClockIndex, f3TimeClockObjectGroup=f3TimeClockObjectGroup, ClockMode=ClockMode, SyncSelectionMode=SyncSelectionMode, f3SyncRefAlias=f3SyncRefAlias, f3SyncEntry=f3SyncEntry, SyncRefStatus=SyncRefStatus, f3TimeClockSelectionMode=f3TimeClockSelectionMode, f3SyncDomain=f3SyncDomain, f3TimeClockFrequencyReference=f3TimeClockFrequencyReference, f3TimeClockAdminState=f3TimeClockAdminState, f3TimeClockExpectedQL=f3TimeClockExpectedQL, f3TimeClockLeap59=f3TimeClockLeap59, f3SyncAdminState=f3SyncAdminState, f3SyncMIB=f3SyncMIB, f3SyncRefReceivedQL=f3SyncRefReceivedQL, f3TimeClockSyncRefCandidate=f3TimeClockSyncRefCandidate, f3TimeClockRefPriority=f3TimeClockRefPriority, TimeTraceAbilityStatus=TimeTraceAbilityStatus, f3SyncAlias=f3SyncAlias, f3SyncRefTable=f3SyncRefTable, f3SyncOperationalState=f3SyncOperationalState, f3TimeClockCurrentTimeOfDay=f3TimeClockCurrentTimeOfDay, f3TimeClockCurrentQL=f3TimeClockCurrentQL, f3TimeClockUtcOffset=f3TimeClockUtcOffset, f3SyncWaitToRestoreTime=f3SyncWaitToRestoreTime, f3SyncRefReference=f3SyncRefReference, f3SyncCompliances=f3SyncCompliances, f3TimeClockTimeTraceAbilityStatus=f3TimeClockTimeTraceAbilityStatus)
