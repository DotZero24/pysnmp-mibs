...
# ASN.1 source file:///Users/rob/Code/pysnmp-mibs/mibs/cisco/CISCO-ERR-DISABLE-MIB
# Produced by pysmi-1.1.12 at Wed Oct  8 10:26:31 2025
...
if mibBuilder.loadTexts: ciscoErrDisableMIB.setLastUpdated('201911280000Z')
...
mibBuilder.exportSymbols("CISCO-ERR-DISABLE-MIB", cErrDisableFeatureDetectShutdownVlan=cErrDisableFeatureDetectShutdownVlan, ciscoErrDisableNotifGroup=ciscoErrDisableNotifGroup, cErrDisableNotificationsPrefix=cErrDisableNotificationsPrefix, ciscoErrDisableShutdownVlanGroup=ciscoErrDisableShutdownVlanGroup, cErrDisableIfObjects=cErrDisableIfObjects, cErrDisableFeatureEntry=cErrDisableFeatureEntry, ciscoErrDisableIfStatusGroup=ciscoErrDisableIfStatusGroup, cErrDisableFeatureTable=cErrDisableFeatureTable, ciscoErrDisableNotifCfgGroup=ciscoErrDisableNotifCfgGroup, cErrDisableFeatureObjects=cErrDisableFeatureObjects, ciscoErrDisableMIBGroups=ciscoErrDisableMIBGroups, cErrDisableFeatureRecoveryEnable=cErrDisableFeatureRecoveryEnable, ciscoErrDisableMIBCompliance=ciscoErrDisableMIBCompliance, ciscoErrDisableGlobalCfgGroup=ciscoErrDisableGlobalCfgGroup, ciscoErrDisableMIBCompliances=ciscoErrDisableMIBCompliances, cErrDisableFeatureConfigurable=cErrDisableFeatureConfigurable, cErrDisableInterfaceEventRev1=cErrDisableInterfaceEventRev1, cErrDisableInterfaceEvent=cErrDisableInterfaceEvent, cErrDisableIfStatusCause=cErrDisableIfStatusCause, cErrDisableIfStatusTimeToRecover=cErrDisableIfStatusTimeToRecover, cErrDisableGlobalObjects=cErrDisableGlobalObjects, ciscoErrDisableMIBComplianceRev1=ciscoErrDisableMIBComplianceRev1, cErrDisableFeatureFlapTimePeriod=cErrDisableFeatureFlapTimePeriod, cErrDisableFeatureRecoveryInterval=cErrDisableFeatureRecoveryInterval, cErrDisableFeatureMaxFlapCount=cErrDisableFeatureMaxFlapCount, cErrDisableIfStatusEntry=cErrDisableIfStatusEntry, cErrDisableFeatureIndex=cErrDisableFeatureIndex, cErrDisableFeatureDetectEnable=cErrDisableFeatureDetectEnable, cErrDisableIfStatusVlanIndex=cErrDisableIfStatusVlanIndex, ciscoErrDisableMIBComplianceRev2=ciscoErrDisableMIBComplianceRev2, ciscoErrDisableFeatureFlapGroup=ciscoErrDisableFeatureFlapGroup, ciscoErrDisableMIBConform=ciscoErrDisableMIBConform, cErrDisableNotifRate=cErrDisableNotifRate, ciscoErrDisableFeatureCfgGroup=ciscoErrDisableFeatureCfgGroup, ciscoErrDisableMIBNotifs=ciscoErrDisableMIBNotifs, cErrDisableIfStatusTable=cErrDisableIfStatusTable, CErrDisableFeatureID=CErrDisableFeatureID, cErrDisableNotifEnable=cErrDisableNotifEnable, cErrDisableRecoveryInterval=cErrDisableRecoveryInterval, ciscoErrDisableMIBObjects=ciscoErrDisableMIBObjects, ciscoErrDisableMIB=ciscoErrDisableMIB, PYSNMP_MODULE_ID=ciscoErrDisableMIB, ciscoErrDisableNotifGroupRev1=ciscoErrDisableNotifGroupRev1)
