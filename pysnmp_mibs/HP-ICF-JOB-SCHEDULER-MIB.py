...
# Notes
# -----
# ASN.1 source file://mibs/hp/HP-ICF-JOB-SCHEDULER-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:36:50 2025
...
hpicfJobSchedulerMIBCompliance.setObjects(
    ("HP-ICF-JOB-SCHEDULER-MIB", "hpicfJobSchedulerGroup")
)
if mibBuilder.loadTexts:
...
hpicfJobSchedulerMIBCompliance1.setObjects(
    ("HP-ICF-JOB-SCHEDULER-MIB", "hpicfJobSchedulerGroup1")
)
if mibBuilder.loadTexts:
...
hpicfJobSchedulerMIBCompliance2.setObjects(
    ("HP-ICF-JOB-SCHEDULER-MIB", "hpicfJobSchedulerGroup2")
)
if mibBuilder.loadTexts:
...
hpicfJobSchedulerMIBCompliance3.setObjects(
    ("HP-ICF-JOB-SCHEDULER-MIB", "hpicfJobSchedulerGroup3")
)
if mibBuilder.loadTexts:
