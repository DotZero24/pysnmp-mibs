...
# Produced by pysmi-1.6.2 at Fri Oct 10 22:13:51 2025
...
ruckusZDWLANAssocNumSta = _RuckusZDWLANAssocNumSta_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 2, 2, 1, 1, 1, 1, 1, 20),
    _RuckusZDWLANAssocNumSta_Type()
)
ruckusZDWLANAssocNumSta.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ruckusZDWLANAssocNumSta.setStatus("current")
...
ruckusZDWLANStaAvgSNR = _RuckusZDWLANStaAvgSNR_Object(
    (1, 3, 6, 1, 4, 1, 25053, 1, 2, 2, 1, 1, 3, 1, 1, 9),
    _RuckusZDWLANStaAvgSNR_Type()
)
ruckusZDWLANStaAvgSNR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ruckusZDWLANStaAvgSNR.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ruckusZDWLANMIB": ruckusZDWLANMIB,
       ...
       "ruckusZDWLANAssocNumSta": ruckusZDWLANAssocNumSta,
       ...
       "ruckusZDWLANStaAvgSNR": ruckusZDWLANStaAvgSNR,
