...
mibBuilder.exportSymbols("ROHC-MIB", rohcInstanceMRRU=rohcInstanceMRRU, rohcContextProfile=rohcContextProfile, rohcChannelEntry=rohcChannelEntry, rohcCompliance=rohcCompliance, rohcContextActivationTime=rohcContextActivationTime, rohcInstanceType=rohcInstanceType, rohcInstanceIRs=rohcInstanceIRs, rohcStatisticsGroup=rohcStatisticsGroup, PYSNMP_MODULE_ID=rohcMIB, rohcContextDecompressorDepth=rohcContextDecompressorDepth, RohcChannelIdentifier=RohcChannelIdentifier, rohcInstanceVendor=rohcInstanceVendor, rohcProfileVersion=rohcProfileVersion, rohcContextStatisticsGroup=rohcContextStatisticsGroup, rohcContextLastPacketsMeanSize=rohcContextLastPacketsMeanSize, rohcContextDecompressorFailures=rohcContextDecompressorFailures, rohcChannelFeedbackFor=rohcChannelFeedbackFor, rohcProfileEntry=rohcProfileEntry, rohcInstancePackets=rohcInstancePackets, rohcContextCID=rohcContextCID, rohcCompliances=rohcCompliances, rohcObjects=rohcObjects, rohcContextLastHeadersRatio=rohcContextLastHeadersRatio, rohcContextEntry=rohcContextEntry, rohcContextLastHeadersMeanSize=rohcContextLastHeadersMeanSize, rohcContextCIDState=rohcContextCIDState, rohcChannelDescr=rohcChannelDescr, rohcChannelStatus=rohcChannelStatus, rohcInstanceGroup=rohcInstanceGroup, rohcProfileNegotiated=rohcProfileNegotiated, rohcInstanceLargeCIDs=rohcInstanceLargeCIDs, RohcCompressionRatio=RohcCompressionRatio, RohcChannelIdentifierOrZero=RohcChannelIdentifierOrZero, rohcInstanceIRDYNs=rohcInstanceIRDYNs, rohcInstanceContextsTotal=rohcInstanceContextsTotal, rohcProfileTable=rohcProfileTable, rohcContextStorageTime=rohcContextStorageTime, rohcInstanceContextsCurrent=rohcInstanceContextsCurrent, rohcContextDeactivationTime=rohcContextDeactivationTime, rohcInstanceEntry=rohcInstanceEntry, rohcProfileDescr=rohcProfileDescr, rohcContextFeedbacks=rohcContextFeedbacks, rohcContextAllHeadersMeanSize=rohcContextAllHeadersMeanSize, rohcGroups=rohcGroups, rohcInstanceVersion=rohcInstanceVersion, rohcInstanceContextStorageTime=rohcInstanceContextStorageTime, rohcInstanceCompressionRatio=rohcInstanceCompressionRatio, rohcContextPackets=rohcContextPackets, rohcChannelType=rohcChannelType, rohcContextDecompressorRepairs=rohcContextDecompressorRepairs, rohcContextIRs=rohcContextIRs, rohcInstanceDescr=rohcInstanceDescr, rohcChannelID=rohcChannelID, rohcInstanceFeedbacks=rohcInstanceFeedbacks, rohcInstanceStatus=rohcInstanceStatus, rohcInstanceObjects=rohcInstanceObjects, rohcProfileVendor=rohcProfileVendor, rohcInstanceClockRes=rohcInstanceClockRes, rohcConformance=rohcConformance, rohcInstanceFBChannelID=rohcInstanceFBChannelID, rohcContextIRDYNs=rohcContextIRDYNs, rohcContextAllPacketsRatio=rohcContextAllPacketsRatio, rohcContextAllHeadersRatio=rohcContextAllHeadersRatio, rohcInstanceTable=rohcInstanceTable, rohcChannelTable=rohcChannelTable, rohcContextGroup=rohcContextGroup, rohcTimerGroup=rohcTimerGroup, rohcMIB=rohcMIB, rohcContextAllPacketsMeanSize=rohcContextAllPacketsMeanSize, rohcProfile=rohcProfile, rohcContextTable=rohcContextTable, rohcInstanceMaxCID=rohcInstanceMaxCID, rohcContextLastPacketsRatio=rohcContextLastPacketsRatio)
