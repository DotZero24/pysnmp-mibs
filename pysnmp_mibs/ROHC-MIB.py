...
# Notes
# -----
# ASN.1 source file://mibs/rfc/ROHC-MIB
...
_RohcInstanceContextStorageTime_Type.__name__ = "TimeInterval"
...
_RohcContextActivationTime_Type.__name__ = "DateAndTime"
...
_RohcContextDeactivationTime_Type.__name__ = "DateAndTime"
...
rohcCompliance.setObjects(
      *(("ROHC-MIB", "rohcInstanceGroup"),
        ("ROHC-MIB", "rohcContextGroup"),
        ("ROHC-MIB", "rohcStatisticsGroup"),
        ("ROHC-MIB", "rohcTimerGroup"),
        ("ROHC-MIB", "rohcContextStatisticsGroup"))
)
if mibBuilder.loadTexts:
