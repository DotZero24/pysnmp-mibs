...
agentBonjourObjects=_AgentBonjourObjects_ObjectIdentity((1,3,6,1,4,1,4526,10,71,1))
_AgentBonjourGlobal_ObjectIdentity=ObjectIdentity
agentBonjourGlobal=_AgentBonjourGlobal_ObjectIdentity((1,3,6,1,4,1,4526,10,71,1,1))
...
agentBonjourAdminMode=_AgentBonjourAdminMode_Object((1,3,6,1,4,1,4526,10,71,1,1,1),_AgentBonjourAdminMode_Type())
agentBonjourAdminMode.setMaxAccess('read-write')
if mibBuilder.loadTexts:agentBonjourAdminMode.setStatus('current')
mibBuilder.exportSymbols('NETGEAR-BONJOUR-MIB',**{'fastPathBonjour':fastPathBonjour,'agentBonjourObjects':agentBonjourObjects,'agentBonjourGlobal':agentBonjourGlobal,'agentBonjourAdminMode':agentBonjourAdminMode})