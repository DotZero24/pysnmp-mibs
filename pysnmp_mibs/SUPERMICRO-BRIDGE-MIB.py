...
futureBridgeMIB=ModuleIdentity((1,3,6,1,4,1,10876,101,1,26))
...
dot1dFutureBridge=_Dot1dFutureBridge_ObjectIdentity((1,3,6,1,4,1,10876,101,1,26,1))
_Dot1dFutureBase_ObjectIdentity=ObjectIdentity
dot1dFutureBase=_Dot1dFutureBase_ObjectIdentity((1,3,6,1,4,1,10876,101,1,26,1,1))
...
dot1dBridgeSystemControl=_Dot1dBridgeSystemControl_Object((1,3,6,1,4,1,10876,101,1,26,1,1,1),_Dot1dBridgeSystemControl_Type())
...
dot1dBaseBridgeStatus=_Dot1dBaseBridgeStatus_Object((1,3,6,1,4,1,10876,101,1,26,1,1,2),_Dot1dBaseBridgeStatus_Type())
...
dot1dBaseBridgeCRCStatus=_Dot1dBaseBridgeCRCStatus_Object((1,3,6,1,4,1,10876,101,1,26,1,1,3),_Dot1dBaseBridgeCRCStatus_Type())
...
dot1dBaseBridgeDebug=_Dot1dBaseBridgeDebug_Object((1,3,6,1,4,1,10876,101,1,26,1,1,4),_Dot1dBaseBridgeDebug_Type())
...
dot1dBaseBridgeTrace=_Dot1dBaseBridgeTrace_Object((1,3,6,1,4,1,10876,101,1,26,1,1,5),_Dot1dBaseBridgeTrace_Type())
...
dot1dBaseBridgeMaxFwdDbEntries=_Dot1dBaseBridgeMaxFwdDbEntries_Object((1,3,6,1,4,1,10876,101,1,26,1,1,6),_Dot1dBaseBridgeMaxFwdDbEntries_Type())
...
dot1dFutureBasePortTable=_Dot1dFutureBasePortTable_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7))
if mibBuilder.loadTexts:dot1dFutureBasePortTable.setStatus(_A)
_Dot1dFutureBasePortEntry_Object=MibTableRow
dot1dFutureBasePortEntry=_Dot1dFutureBasePortEntry_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7,1))
...
dot1dFutureBasePort=_Dot1dFutureBasePort_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7,1,1),_Dot1dFutureBasePort_Type())
...
dot1dBasePortAdminStatus=_Dot1dBasePortAdminStatus_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7,1,2),_Dot1dBasePortAdminStatus_Type())
...
dot1dBasePortOperStatus=_Dot1dBasePortOperStatus_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7,1,3),_Dot1dBasePortOperStatus_Type())
...
dot1dBasePortBcastStatus=_Dot1dBasePortBcastStatus_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7,1,4),_Dot1dBasePortBcastStatus_Type())
...
dot1dBasePortFilterNumber=_Dot1dBasePortFilterNumber_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7,1,5),_Dot1dBasePortFilterNumber_Type())
...
dot1dBasePortMcastNumber=_Dot1dBasePortMcastNumber_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7,1,6),_Dot1dBasePortMcastNumber_Type())
...
dot1dBasePortBcastOutFrames=_Dot1dBasePortBcastOutFrames_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7,1,7),_Dot1dBasePortBcastOutFrames_Type())
...
dot1dBasePortMcastOutFrames=_Dot1dBasePortMcastOutFrames_Object((1,3,6,1,4,1,10876,101,1,26,1,1,7,1,8),_Dot1dBasePortMcastOutFrames_Type())
...
dot1dFutureTp=_Dot1dFutureTp_ObjectIdentity((1,3,6,1,4,1,10876,101,1,26,1,2))
_Dot1dFutureTpPortTable_Object=MibTable
dot1dFutureTpPortTable=_Dot1dFutureTpPortTable_Object((1,3,6,1,4,1,10876,101,1,26,1,2,1))
if mibBuilder.loadTexts:dot1dFutureTpPortTable.setStatus(_A)
_Dot1dFutureTpPortEntry_Object=MibTableRow
dot1dFutureTpPortEntry=_Dot1dFutureTpPortEntry_Object((1,3,6,1,4,1,10876,101,1,26,1,2,1,1))
...
dot1dFutureTpPort=_Dot1dFutureTpPort_Object((1,3,6,1,4,1,10876,101,1,26,1,2,1,1,1),_Dot1dFutureTpPort_Type())
...
dot1dTpPortInProtoDiscards=_Dot1dTpPortInProtoDiscards_Object((1,3,6,1,4,1,10876,101,1,26,1,2,1,1,2),_Dot1dTpPortInProtoDiscards_Type())
...
dot1dTpPortInFilterDiscards=_Dot1dTpPortInFilterDiscards_Object((1,3,6,1,4,1,10876,101,1,26,1,2,1,1,3),_Dot1dTpPortInFilterDiscards_Type())
...
dot1dTpPortProtocolFilterMask=_Dot1dTpPortProtocolFilterMask_Object((1,3,6,1,4,1,10876,101,1,26,1,2,1,1,4),_Dot1dTpPortProtocolFilterMask_Type())
...
dot1dFilter=_Dot1dFilter_ObjectIdentity((1,3,6,1,4,1,10876,101,1,26,1,3))
_Dot1dFilterTable_Object=MibTable
dot1dFilterTable=_Dot1dFilterTable_Object((1,3,6,1,4,1,10876,101,1,26,1,3,1))
if mibBuilder.loadTexts:dot1dFilterTable.setStatus(_A)
_Dot1dFilterEntry_Object=MibTableRow
dot1dFilterEntry=_Dot1dFilterEntry_Object((1,3,6,1,4,1,10876,101,1,26,1,3,1,1))
...
dot1dFilterNumber=_Dot1dFilterNumber_Object((1,3,6,1,4,1,10876,101,1,26,1,3,1,1,1),_Dot1dFilterNumber_Type())
...
dot1dFilterSrcAddress=_Dot1dFilterSrcAddress_Object((1,3,6,1,4,1,10876,101,1,26,1,3,1,1,2),_Dot1dFilterSrcAddress_Type())
...
dot1dFilterSrcMask=_Dot1dFilterSrcMask_Object((1,3,6,1,4,1,10876,101,1,26,1,3,1,1,3),_Dot1dFilterSrcMask_Type())
...
dot1dFilterDstAddress=_Dot1dFilterDstAddress_Object((1,3,6,1,4,1,10876,101,1,26,1,3,1,1,4),_Dot1dFilterDstAddress_Type())
...
dot1dFilterDstMask=_Dot1dFilterDstMask_Object((1,3,6,1,4,1,10876,101,1,26,1,3,1,1,5),_Dot1dFilterDstMask_Type())
...
dot1dFilterPermiss=_Dot1dFilterPermiss_Object((1,3,6,1,4,1,10876,101,1,26,1,3,1,1,6),_Dot1dFilterPermiss_Type())
...
dot1dMcast=_Dot1dMcast_ObjectIdentity((1,3,6,1,4,1,10876,101,1,26,1,4))
_Dot1dMcastTable_Object=MibTable
dot1dMcastTable=_Dot1dMcastTable_Object((1,3,6,1,4,1,10876,101,1,26,1,4,1))
if mibBuilder.loadTexts:dot1dMcastTable.setStatus(_A)
_Dot1dMcastEntry_Object=MibTableRow
dot1dMcastEntry=_Dot1dMcastEntry_Object((1,3,6,1,4,1,10876,101,1,26,1,4,1,1))
...
dot1dMlistNumber=_Dot1dMlistNumber_Object((1,3,6,1,4,1,10876,101,1,26,1,4,1,1,1),_Dot1dMlistNumber_Type())
...
dot1dMcastMacaddress=_Dot1dMcastMacaddress_Object((1,3,6,1,4,1,10876,101,1,26,1,4,1,1,2),_Dot1dMcastMacaddress_Type())
...
dot1dMcastPermiss=_Dot1dMcastPermiss_Object((1,3,6,1,4,1,10876,101,1,26,1,4,1,1,3),_Dot1dMcastPermiss_Type())
