# SNMP MIB module (ALVARION-DEVICE-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alvarion/ALVARION-DEVICE-MIB
...
alvarionDeviceMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23)
)
...
alvarionDeviceMIBObjects = _AlvarionDeviceMIBObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1)
)
_CoDeviceConfigGroup_ObjectIdentity = ObjectIdentity
coDeviceConfigGroup = _CoDeviceConfigGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 1)
)


class _CoDeviceStateChangeNotificationEnabled_Type(AlvarionNotificationEnable):
    """Custom type coDeviceStateChangeNotificationEnabled based on AlvarionNotificationEnable"""
    defaultValue = 2


_CoDeviceStateChangeNotificationEnabled_Type.__name__ = "AlvarionNotificationEnable"
...
coDeviceStateChangeNotificationEnabled = _CoDeviceStateChangeNotificationEnabled_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 1, 1),
...
class _CoDeviceAuthorizationFailureNotificationEnabled_Type(AlvarionNotificationEnable):
    """Custom type coDeviceAuthorizationFailureNotificationEnabled based on AlvarionNotificationEnable"""
    defaultValue = 1


_CoDeviceAuthorizationFailureNotificationEnabled_Type.__name__ = "AlvarionNotificationEnable"
...
coDeviceAuthorizationFailureNotificationEnabled = _CoDeviceAuthorizationFailureNotificationEnabled_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 1, 2),
...
class _CoDeviceSecurityFailureNotificationEnabled_Type(AlvarionNotificationEnable):
    """Custom type coDeviceSecurityFailureNotificationEnabled based on AlvarionNotificationEnable"""
    defaultValue = 1


_CoDeviceSecurityFailureNotificationEnabled_Type.__name__ = "AlvarionNotificationEnable"
...
coDeviceSecurityFailureNotificationEnabled = _CoDeviceSecurityFailureNotificationEnabled_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 1, 3),
...
class _CoDeviceFirmwareFailureNotificationEnabled_Type(AlvarionNotificationEnable):
    """Custom type coDeviceFirmwareFailureNotificationEnabled based on AlvarionNotificationEnable"""
    defaultValue = 1


_CoDeviceFirmwareFailureNotificationEnabled_Type.__name__ = "AlvarionNotificationEnable"
...
coDeviceFirmwareFailureNotificationEnabled = _CoDeviceFirmwareFailureNotificationEnabled_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 1, 4),
...
class _CoDeviceConfigurationFailureNotificationEnabled_Type(AlvarionNotificationEnable):
    """Custom type coDeviceConfigurationFailureNotificationEnabled based on AlvarionNotificationEnable"""
    defaultValue = 1


_CoDeviceConfigurationFailureNotificationEnabled_Type.__name__ = "AlvarionNotificationEnable"
...
coDeviceConfigurationFailureNotificationEnabled = _CoDeviceConfigurationFailureNotificationEnabled_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 1, 5),
...
coDeviceDiscoveryEntry = _CoDeviceDiscoveryEntry_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1)
)
...
coDevDisIndex = _CoDevDisIndex_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 1),
    _CoDevDisIndex_Type()
)
...
coDevDisSerialNumber = _CoDevDisSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 2),
...
coDevDisMacAddress = _CoDevDisMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 3),
...
coDevDisIpAddress = _CoDevDisIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 4),
...
coDevDisState = _CoDevDisState_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 5),
    _CoDevDisState_Type()
)
...
coDevDisSystemName = _CoDevDisSystemName_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 6),
...
coDevDisLocation = _CoDevDisLocation_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 7),
...
coDevDisContact = _CoDevDisContact_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 8),
...
coDevDisGroupName = _CoDevDisGroupName_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 9),
...
coDevDisConnectionTime = _CoDevDisConnectionTime_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 2, 1, 1, 10),
...
coDevInfoProductType = _CoDevInfoProductType_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 3, 1, 1, 1),
...
coDevInfoProductName = _CoDevInfoProductName_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 3, 1, 1, 2),
...
coDevInfoFirmwareRevision = _CoDevInfoFirmwareRevision_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 3, 1, 1, 3),
...
coDevInfoBootRevision = _CoDevInfoBootRevision_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 3, 1, 1, 4),
...
coDevInfoHardwareRevision = _CoDevInfoHardwareRevision_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 3, 1, 1, 5),
...
coDeviceStatusEntry = _CoDeviceStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1)
)
if mibBuilder.loadTexts:
...
coDevStUpTime = _CoDevStUpTime_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 1),
    _CoDevStUpTime_Type()
)
...
coDevStLoadAverage1Min = _CoDevStLoadAverage1Min_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 2),
...
coDevStLoadAverage5Min = _CoDevStLoadAverage5Min_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 3),
...
coDevStLoadAverage15Min = _CoDevStLoadAverage15Min_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 4),
...
coDevStCpuUseNow = _CoDevStCpuUseNow_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 5),
...
coDevStCpuUse5Sec = _CoDevStCpuUse5Sec_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 6),
...
coDevStCpuUse10Sec = _CoDevStCpuUse10Sec_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 7),
...
coDevStCpuUse20Sec = _CoDevStCpuUse20Sec_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 8),
...
coDevStRamTotal = _CoDevStRamTotal_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 9),
...
coDevStRamFree = _CoDevStRamFree_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 10),
...
coDevStRamBuffer = _CoDevStRamBuffer_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 11),
...
coDevStRamCached = _CoDevStRamCached_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 12),
...
coDevStStorageUsePermanent = _CoDevStStorageUsePermanent_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 13),
...
coDevStStorageUseTemporary = _CoDevStStorageUseTemporary_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 1, 4, 1, 1, 14),
...
alvarionDeviceMIBNotificationPrefix = _AlvarionDeviceMIBNotificationPrefix_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 2)
)
_AlvarionDeviceMIBNotifications_ObjectIdentity = ObjectIdentity
alvarionDeviceMIBNotifications = _AlvarionDeviceMIBNotifications_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 2, 0)
)
_AlvarionDeviceMIBConformance_ObjectIdentity = ObjectIdentity
alvarionDeviceMIBConformance = _AlvarionDeviceMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 3)
)
_AlvarionDeviceMIBCompliances_ObjectIdentity = ObjectIdentity
alvarionDeviceMIBCompliances = _AlvarionDeviceMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 3, 1)
)
_AlvarionDeviceMIBGroups_ObjectIdentity = ObjectIdentity
alvarionDeviceMIBGroups = _AlvarionDeviceMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 3, 2)
)
...
alvarionDeviceConfigMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 3, 2, 1)
)
alvarionDeviceConfigMIBGroup.setObjects(
      *(("ALVARION-DEVICE-MIB", "coDeviceStateChangeNotificationEnabled"),
        ("ALVARION-DEVICE-MIB", "coDeviceAuthorizationFailureNotificationEnabled"),
        ("ALVARION-DEVICE-MIB", "coDeviceSecurityFailureNotificationEnabled"),
        ("ALVARION-DEVICE-MIB", "coDeviceFirmwareFailureNotificationEnabled"),
        ("ALVARION-DEVICE-MIB", "coDeviceConfigurationFailureNotificationEnabled"))
)
if mibBuilder.loadTexts:
    alvarionDeviceConfigMIBGroup.setStatus("current")

alvarionDeviceDiscoveryMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 3, 2, 2)
)
alvarionDeviceDiscoveryMIBGroup.setObjects(
      *(("ALVARION-DEVICE-MIB", "coDevDisSerialNumber"),
        ("ALVARION-DEVICE-MIB", "coDevDisMacAddress"),
        ("ALVARION-DEVICE-MIB", "coDevDisIpAddress"),
        ("ALVARION-DEVICE-MIB", "coDevDisState"),
        ("ALVARION-DEVICE-MIB", "coDevDisSystemName"),
        ("ALVARION-DEVICE-MIB", "coDevDisLocation"),
        ("ALVARION-DEVICE-MIB", "coDevDisContact"),
        ("ALVARION-DEVICE-MIB", "coDevDisGroupName"),
        ("ALVARION-DEVICE-MIB", "coDevDisConnectionTime"))
)
if mibBuilder.loadTexts:
    alvarionDeviceDiscoveryMIBGroup.setStatus("current")

alvarionDeviceInformationMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 3, 2, 3)
)
alvarionDeviceInformationMIBGroup.setObjects(
      *(("ALVARION-DEVICE-MIB", "coDevInfoProductType"),
        ("ALVARION-DEVICE-MIB", "coDevInfoProductName"),
        ("ALVARION-DEVICE-MIB", "coDevInfoFirmwareRevision"),
        ("ALVARION-DEVICE-MIB", "coDevInfoBootRevision"),
        ("ALVARION-DEVICE-MIB", "coDevInfoHardwareRevision"))
)
if mibBuilder.loadTexts:
    alvarionDeviceInformationMIBGroup.setStatus("current")

alvarionDeviceStatusMIBGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 3, 2, 4)
)
alvarionDeviceStatusMIBGroup.setObjects(
      *(("ALVARION-DEVICE-MIB", "coDevStUpTime"),
        ("ALVARION-DEVICE-MIB", "coDevStLoadAverage1Min"),
        ("ALVARION-DEVICE-MIB", "coDevStLoadAverage5Min"),
        ("ALVARION-DEVICE-MIB", "coDevStLoadAverage15Min"),
        ("ALVARION-DEVICE-MIB", "coDevStCpuUseNow"),
        ("ALVARION-DEVICE-MIB", "coDevStCpuUse5Sec"),
        ("ALVARION-DEVICE-MIB", "coDevStCpuUse10Sec"),
        ("ALVARION-DEVICE-MIB", "coDevStCpuUse20Sec"),
        ("ALVARION-DEVICE-MIB", "coDevStRamTotal"),
        ("ALVARION-DEVICE-MIB", "coDevStRamFree"),
        ("ALVARION-DEVICE-MIB", "coDevStRamBuffer"),
        ("ALVARION-DEVICE-MIB", "coDevStRamCached"),
        ("ALVARION-DEVICE-MIB", "coDevStStorageUsePermanent"),
        ("ALVARION-DEVICE-MIB", "coDevStStorageUseTemporary"))
)
if mibBuilder.loadTexts:
    alvarionDeviceStatusMIBGroup.setStatus("current")


# Notification objects

coDeviceStateChangeNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 2, 0, 1)
)
...
coDeviceAuthorizationFailureNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 2, 0, 2)
)
...
coDeviceSecurityFailureNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 2, 0, 3)
)
...
coDeviceFirmwareFailureNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 2, 0, 4)
)
...
coDeviceConfigurationFailureNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 2, 0, 5)
)
...
alvarionDeviceNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 3, 2, 5)
)
alvarionDeviceNotificationGroup.setObjects(
      *(("ALVARION-DEVICE-MIB", "coDeviceStateChangeNotification"),
        ("ALVARION-DEVICE-MIB", "coDeviceAuthorizationFailureNotification"),
        ("ALVARION-DEVICE-MIB", "coDeviceSecurityFailureNotification"),
        ("ALVARION-DEVICE-MIB", "coDeviceFirmwareFailureNotification"),
        ("ALVARION-DEVICE-MIB", "coDeviceConfigurationFailureNotification"))
)
if mibBuilder.loadTexts:
    alvarionDeviceNotificationGroup.setStatus(
        "current"
    )
...
alvarionDeviceMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 12394, 1, 10, 5, 23, 3, 1, 1)
)
alvarionDeviceMIBCompliance.setObjects(
      *(("ALVARION-DEVICE-MIB", "alvarionDeviceConfigMIBGroup"),
        ("ALVARION-DEVICE-MIB", "alvarionDeviceDiscoveryMIBGroup"),
        ("ALVARION-DEVICE-MIB", "alvarionDeviceInformationMIBGroup"),
        ("ALVARION-DEVICE-MIB", "alvarionDeviceStatusMIBGroup"),
        ("ALVARION-DEVICE-MIB", "alvarionDeviceNotificationGroup"))
)
if mibBuilder.loadTexts:
    alvarionDeviceMIBCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    "ALVARION-DEVICE-MIB",
    **{"alvarionDeviceMIB": alvarionDeviceMIB,
       "alvarionDeviceMIBObjects": alvarionDeviceMIBObjects,
       ...
       "alvarionDeviceMIBNotificationPrefix": alvarionDeviceMIBNotificationPrefix,
       "alvarionDeviceMIBNotifications": alvarionDeviceMIBNotifications,
       ...
       "alvarionDeviceMIBGroups": alvarionDeviceMIBGroups,
       "alvarionDeviceConfigMIBGroup": alvarionDeviceConfigMIBGroup,
       "alvarionDeviceDiscoveryMIBGroup": alvarionDeviceDiscoveryMIBGroup,
       "alvarionDeviceInformationMIBGroup": alvarionDeviceInformationMIBGroup,
       "alvarionDeviceStatusMIBGroup": alvarionDeviceStatusMIBGroup,
       "alvarionDeviceNotificationGroup": alvarionDeviceNotificationGroup}
)
