...
if mibBuilder.loadTexts:f10BpStatsMib.setRevisions(('2013-05-22 12:48',))
_F10BpStatsLinkBundleObjects_ObjectIdentity=ObjectIdentity
f10BpStatsLinkBundleObjects=_F10BpStatsLinkBundleObjects_ObjectIdentity((1,3,6,1,4,1,6027,3,24,1))
...
f10BpStatsObjects=_F10BpStatsObjects_ObjectIdentity((1,3,6,1,4,1,6027,3,24,2))
...
class _BpCosStatsCOSNumber_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,15))
...
f10BpStatsAlarms=_F10BpStatsAlarms_ObjectIdentity((1,3,6,1,4,1,6027,3,24,3))
