...
mibBuilder.exportSymbols("BLUECOAT-SG-PROXY-MIB", sgProxyStorage=sgProxyStorage, sgProxyVersion=sgProxyVersion, sgProxyHttpByteRateAll=sgProxyHttpByteRateAll, sgProxyHttpMedianServiceTimeMiss=sgProxyHttpMedianServiceTimeMiss, sgProxyHttpFirstByteAll=sgProxyHttpFirstByteAll, sgProxyCpuIdlePerCent=sgProxyCpuIdlePerCent, sgProxyCpuCoreIdleTime=sgProxyCpuCoreIdleTime, sgProxyHttpMedianServiceTimePartialHit=sgProxyHttpMedianServiceTimePartialHit, sgProxyHttpMedianServiceTimeAll=sgProxyHttpMedianServiceTimeAll, sgProxyHttpClientPartialHits=sgProxyHttpClientPartialHits, sgProxyHttpServerConnectionsIdle=sgProxyHttpServerConnectionsIdle, sgProxyHttp=sgProxyHttp, sgProxyCpuBusyTime=sgProxyCpuBusyTime, sgProxyHttpByteRateHit=sgProxyHttpByteRateHit, sgProxyHttpMedian=sgProxyHttpMedian, sgProxyHttpServerOutBytes=sgProxyHttpServerOutBytes, sgProxyHttpServerRequests=sgProxyHttpServerRequests, sgProxyHttpResponseTime=sgProxyHttpResponseTime, sgProxyHttpFirstBytePartialHit=sgProxyHttpFirstBytePartialHit, PYSNMP_MODULE_ID=bluecoatSGProxyMIB, sgProxyHttpClientRequests=sgProxyHttpClientRequests, sgProxyHttpFirstByteHit=sgProxyHttpFirstByteHit, sgProxyHttpClient=sgProxyHttpClient, sgProxyCache=sgProxyCache, sgProxyHttpServer=sgProxyHttpServer, sgProxyMemCacheUsage=sgProxyMemCacheUsage, sgProxyCpuCoreUpTime=sgProxyCpuCoreUpTime, sgProxyHttpTotalFetchTimePartialHit=sgProxyHttpTotalFetchTimePartialHit, sgProxyHttpResponse=sgProxyHttpResponse, sgProxyCpuIdleTimeSinceLastAccess=sgProxyCpuIdleTimeSinceLastAccess, sgProxyHttpClientConnections=sgProxyHttpClientConnections, sgProxySoftware=sgProxySoftware, sgProxyHttpByteRatePartialHit=sgProxyHttpByteRatePartialHit, sgProxyCpuIdleTime=sgProxyCpuIdleTime, sgProxyCpuCoreIdlePerCent=sgProxyCpuCoreIdlePerCent, sgProxyHttpMedianServiceTimeHit=sgProxyHttpMedianServiceTimeHit, sgProxyHttpResponseFirstByte=sgProxyHttpResponseFirstByte, sgProxyHttpResponseSizeAll=sgProxyHttpResponseSizeAll, sgProxyHttpServerConnectionsActive=sgProxyHttpServerConnectionsActive, sgProxyHttpMedianServiceTable=sgProxyHttpMedianServiceTable, sgProxyCpuBusyTimeSinceLastAccess=sgProxyCpuBusyTimeSinceLastAccess, sgProxyHttpServerInBytes=sgProxyHttpServerInBytes, sgProxyCpuCoreTableEntry=sgProxyCpuCoreTableEntry, sgProxyHttpResponseSizePartialHit=sgProxyHttpResponseSizePartialHit, sgProxyMemSysUsage=sgProxyMemSysUsage, sgProxyHttpConnections=sgProxyHttpConnections, sgProxyCpuBusyPerCent=sgProxyCpuBusyPerCent, sgProxyHttpClientErrors=sgProxyHttpClientErrors, sgProxyHttpMedianServiceTime=sgProxyHttpMedianServiceTime, sgProxyAdmin=sgProxyAdmin, sgProxyHttpResponseSizeHit=sgProxyHttpResponseSizeHit, sgProxyHttpClientRequestRate=sgProxyHttpClientRequestRate, sgProxyHttpServiceTimePartialHit=sgProxyHttpServiceTimePartialHit, sgProxyHttpTotalFetchTimeAll=sgProxyHttpTotalFetchTimeAll, sgProxyMemoryPressure=sgProxyMemoryPressure, sgProxyHttpClientOutBytes=sgProxyHttpClientOutBytes, sgProxyNumObjects=sgProxyNumObjects, sgProxyHttpClientMisses=sgProxyHttpClientMisses, sgProxyHttpTotalFetchTimeHit=sgProxyHttpTotalFetchTimeHit, sgProxyHttpMedianServiceEntry=sgProxyHttpMedianServiceEntry, sgProxyHttpClientConnectionsIdle=sgProxyHttpClientConnectionsIdle, sgProxyCpuCoreTable=sgProxyCpuCoreTable, sgProxySerialNumber=sgProxySerialNumber, sgProxyHttpResponseByteRate=sgProxyHttpResponseByteRate, sgProxyHttpTotalFetchTimeMiss=sgProxyHttpTotalFetchTimeMiss, sgProxyCpu=sgProxyCpu, sgProxyCpuUpTimeSinceLastAccess=sgProxyCpuUpTimeSinceLastAccess, sgProxySystem=sgProxySystem, sgProxyCpuCoreIdleTimeSinceLastAccess=sgProxyCpuCoreIdleTimeSinceLastAccess, sgProxyDnsMedianServiceTime=sgProxyDnsMedianServiceTime, sgProxyCpuCoreBusyTimeSinceLastAccess=sgProxyCpuCoreBusyTimeSinceLastAccess, sgProxyHttpServiceTimeMiss=sgProxyHttpServiceTimeMiss, sgProxyConfig=sgProxyConfig, sgProxyHttpServiceTimeAll=sgProxyHttpServiceTimeAll, sgProxyHttpServiceTimeHit=sgProxyHttpServiceTimeHit, sgProxyCpuCoreBusyTime=sgProxyCpuCoreBusyTime, sgProxyCpuCoreUpTimeSinceLastAccess=sgProxyCpuCoreUpTimeSinceLastAccess, sgProxyMemory=sgProxyMemory, sgProxyHttpClientConnectionsActive=sgProxyHttpClientConnectionsActive, sgProxyHttpClientByteHitRate=sgProxyHttpClientByteHitRate, sgProxyHttpClientHits=sgProxyHttpClientHits, sgProxyHttpFirstByteMiss=sgProxyHttpFirstByteMiss, sgProxyHttpServerConnections=sgProxyHttpServerConnections, sgProxyCpuUpTime=sgProxyCpuUpTime, sgProxyHttpServerErrors=sgProxyHttpServerErrors, sgProxyHttpClientInBytes=sgProxyHttpClientInBytes, sgProxyCpuCoreBusyPerCent=sgProxyCpuCoreBusyPerCent, bluecoatSGProxyMIB=bluecoatSGProxyMIB, sgProxyHttpResponseSizeMiss=sgProxyHttpResponseSizeMiss, sgProxyCpuCoreIndex=sgProxyCpuCoreIndex, sgProxyHttpResponseSize=sgProxyHttpResponseSize, sgProxyHttpClientHitRate=sgProxyHttpClientHitRate, sgProxyMemAvailable=sgProxyMemAvailable, sgProxyHttpPerf=sgProxyHttpPerf, sgProxyHttpByteRateMiss=sgProxyHttpByteRateMiss)
