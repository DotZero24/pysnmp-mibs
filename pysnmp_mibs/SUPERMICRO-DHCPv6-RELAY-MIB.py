...
_N='disabled'
_M='enabled'
_L='fsDhcp6RlyTrapIfIndex'
_K='fsDhcp6RlySrvAddress'
_J='fsDhcp6RlyInIfIndex'
_I='read-create'
_H='OctetString'
_G='not-accessible'
_F='DisplayString'
_E='read-only'
_D='SUPERMICRO-DHCPv6-RELAY-MIB'
_C='Integer32'
_B='read-write'
_A='current'
...
fsDhcp6RlyNotify=_FsDhcp6RlyNotify_ObjectIdentity((1,3,6,1,4,1,10876,101,2,41,0))
_FsDhcp6RlySystem_ObjectIdentity=ObjectIdentity
fsDhcp6RlySystem=_FsDhcp6RlySystem_ObjectIdentity((1,3,6,1,4,1,10876,101,2,41,1))
...
fsDhcp6RlyDebugTrace=_FsDhcp6RlyDebugTrace_Object((1,3,6,1,4,1,10876,101,2,41,1,1),_FsDhcp6RlyDebugTrace_Type())
...
fsDhcp6RlyTrapAdminControl=_FsDhcp6RlyTrapAdminControl_Object((1,3,6,1,4,1,10876,101,2,41,1,2),_FsDhcp6RlyTrapAdminControl_Type())
fsDhcp6RlyTrapAdminControl.setMaxAccess(_B)
if mibBuilder.loadTexts:fsDhcp6RlyTrapAdminControl.setStatus(_A)
class _FsDhcp6RlySysLogAdminStatus_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_M,1),(_N,2)))
_FsDhcp6RlySysLogAdminStatus_Type.__name__=_C
_FsDhcp6RlySysLogAdminStatus_Object=MibScalar
fsDhcp6RlySysLogAdminStatus=_FsDhcp6RlySysLogAdminStatus_Object((1,3,6,1,4,1,10876,101,2,41,1,3),_FsDhcp6RlySysLogAdminStatus_Type())
...
fsDhcp6RlyListenPort=_FsDhcp6RlyListenPort_Object((1,3,6,1,4,1,10876,101,2,41,1,4),_FsDhcp6RlyListenPort_Type())
...
fsDhcp6RlyClientTransmitPort=_FsDhcp6RlyClientTransmitPort_Object((1,3,6,1,4,1,10876,101,2,41,1,5),_FsDhcp6RlyClientTransmitPort_Type())
...
fsDhcp6RlyServerTransmitPort=_FsDhcp6RlyServerTransmitPort_Object((1,3,6,1,4,1,10876,101,2,41,1,6),_FsDhcp6RlyServerTransmitPort_Type())
fsDhcp6RlyServerTransmitPort.setMaxAccess(_B)
if mibBuilder.loadTexts:fsDhcp6RlyServerTransmitPort.setStatus(_A)
class _FsDhcp6RlyOption37Control_Type(Integer32):defaultValue=2;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(1,2)));namedValues=NamedValues(*((_M,1),(_N,2)))
_FsDhcp6RlyOption37Control_Type.__name__=_C
_FsDhcp6RlyOption37Control_Object=MibScalar
fsDhcp6RlyOption37Control=_FsDhcp6RlyOption37Control_Object((1,3,6,1,4,1,10876,101,2,41,1,7),_FsDhcp6RlyOption37Control_Type())
...
fsDhcp6RlyConfig=_FsDhcp6RlyConfig_ObjectIdentity((1,3,6,1,4,1,10876,101,2,41,2))
_FsDhcp6RlyIfTable_Object=MibTable
fsDhcp6RlyIfTable=_FsDhcp6RlyIfTable_Object((1,3,6,1,4,1,10876,101,2,41,2,1))
if mibBuilder.loadTexts:fsDhcp6RlyIfTable.setStatus(_A)
_FsDhcp6RlyIfEntry_Object=MibTableRow
fsDhcp6RlyIfEntry=_FsDhcp6RlyIfEntry_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1))
...
fsDhcp6RlyIfIndex=_FsDhcp6RlyIfIndex_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,1),_FsDhcp6RlyIfIndex_Type())
...
fsDhcp6RlyIfHopThreshold=_FsDhcp6RlyIfHopThreshold_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,3),_FsDhcp6RlyIfHopThreshold_Type())
fsDhcp6RlyIfHopThreshold.setMaxAccess(_I)
...
fsDhcp6RlyIfInformIn=_FsDhcp6RlyIfInformIn_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,4),_FsDhcp6RlyIfInformIn_Type())
...
fsDhcp6RlyIfRelayForwIn=_FsDhcp6RlyIfRelayForwIn_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,5),_FsDhcp6RlyIfRelayForwIn_Type())
...
fsDhcp6RlyIfRelayReplyIn=_FsDhcp6RlyIfRelayReplyIn_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,6),_FsDhcp6RlyIfRelayReplyIn_Type())
...
fsDhcp6RlyIfInvalidPktIn=_FsDhcp6RlyIfInvalidPktIn_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,10),_FsDhcp6RlyIfInvalidPktIn_Type())
...
fsDhcp6RlyIfCounterRest=_FsDhcp6RlyIfCounterRest_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,11),_FsDhcp6RlyIfCounterRest_Type())
fsDhcp6RlyIfCounterRest.setMaxAccess(_I)
...
fsDhcp6RlyIfRowStatus=_FsDhcp6RlyIfRowStatus_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,12),_FsDhcp6RlyIfRowStatus_Type())
fsDhcp6RlyIfRowStatus.setMaxAccess(_I)
...
fsDhcp6RlyIfRemoteIdOption=_FsDhcp6RlyIfRemoteIdOption_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,13),_FsDhcp6RlyIfRemoteIdOption_Type())
...
fsDhcp6RlyIfRemoteIdDUID=_FsDhcp6RlyIfRemoteIdDUID_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,14),_FsDhcp6RlyIfRemoteIdDUID_Type())
...
fsDhcp6RlyIfRemoteIdOptionValue=_FsDhcp6RlyIfRemoteIdOptionValue_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,15),_FsDhcp6RlyIfRemoteIdOptionValue_Type())
...
fsDhcp6RlyIfRemoteIdUserDefined=_FsDhcp6RlyIfRemoteIdUserDefined_Object((1,3,6,1,4,1,10876,101,2,41,2,1,1,16),_FsDhcp6RlyIfRemoteIdUserDefined_Type())
...
fsDhcp6RlySrvAddressTable=_FsDhcp6RlySrvAddressTable_Object((1,3,6,1,4,1,10876,101,2,41,2,2))
if mibBuilder.loadTexts:fsDhcp6RlySrvAddressTable.setStatus(_A)
_FsDhcp6RlySrvAddressEntry_Object=MibTableRow
fsDhcp6RlySrvAddressEntry=_FsDhcp6RlySrvAddressEntry_Object((1,3,6,1,4,1,10876,101,2,41,2,2,1))
fsDhcp6RlySrvAddressEntry.setIndexNames((0,_D,_J),(0,_D,_K))
...
fsDhcp6RlyInIfIndex=_FsDhcp6RlyInIfIndex_Object((1,3,6,1,4,1,10876,101,2,41,2,2,1,1),_FsDhcp6RlyInIfIndex_Type())
...
fsDhcp6RlySrvAddress=_FsDhcp6RlySrvAddress_Object((1,3,6,1,4,1,10876,101,2,41,2,2,1,2),_FsDhcp6RlySrvAddress_Type())
...
fsDhcp6RlySrvAddressRowStatus=_FsDhcp6RlySrvAddressRowStatus_Object((1,3,6,1,4,1,10876,101,2,41,2,2,1,3),_FsDhcp6RlySrvAddressRowStatus_Type())
...
fsDhcp6RlyOutIfTable=_FsDhcp6RlyOutIfTable_Object((1,3,6,1,4,1,10876,101,2,41,2,3))
if mibBuilder.loadTexts:fsDhcp6RlyOutIfTable.setStatus(_A)
_FsDhcp6RlyOutIfEntry_Object=MibTableRow
fsDhcp6RlyOutIfEntry=_FsDhcp6RlyOutIfEntry_Object((1,3,6,1,4,1,10876,101,2,41,2,3,1))
fsDhcp6RlyOutIfEntry.setIndexNames((0,_D,_J),(0,_D,_K),(0,_D,_P))
...
fsDhcp6RlyOutIfIndex=_FsDhcp6RlyOutIfIndex_Object((1,3,6,1,4,1,10876,101,2,41,2,3,1,1),_FsDhcp6RlyOutIfIndex_Type())
...
fsDhcp6RlyOutIfRowStatus=_FsDhcp6RlyOutIfRowStatus_Object((1,3,6,1,4,1,10876,101,2,41,2,3,1,2),_FsDhcp6RlyOutIfRowStatus_Type())
...
fsDhcp6RlyTraps=_FsDhcp6RlyTraps_ObjectIdentity((1,3,6,1,4,1,10876,101,2,41,3))
_FsDhcp6RlyTrapIfIndex_Type=Integer32
_FsDhcp6RlyTrapIfIndex_Object=MibScalar
fsDhcp6RlyTrapIfIndex=_FsDhcp6RlyTrapIfIndex_Object((1,3,6,1,4,1,10876,101,2,41,3,1),_FsDhcp6RlyTrapIfIndex_Type())
