...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-RADIUS-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:42:14 2025
...
_CrRadiusServerAddrType_Type.__name__ = "InetAddressType"
...
_CrRadiusServerAuthPort_Type.__name__ = "CiscoPort"
...
_CrRadiusServerAcctPort_Type.__name__ = "CiscoPort"
...
_CrRadiusServerKey_Type.__name__ = "CiscoRadiusAuthKey"
...
_CrRadiusServerRTTNormNotifEnable_Type.__name__ = "TruthValue"
...
_CrRadiusServerRTTHiNotifEnable_Type.__name__ = "TruthValue"
...
_CrRadiusServerRetransNormNotifEnable_Type.__name__ = "TruthValue"
...
_CrRadiusServerRetransHiNotifEnable_Type.__name__ = "TruthValue"
...
ciscoRadiusMIBCompliance.setObjects(
    ("CISCO-RADIUS-MIB", "crmConfigurationGroup")
)
if mibBuilder.loadTexts:
...
ciscoRadiusMIBCompliance2.setObjects(
      *(("CISCO-RADIUS-MIB", "crmConfigurationGroup"),
        ("CISCO-RADIUS-MIB", "crmAttributesGroup"),
        ("CISCO-RADIUS-MIB", "crmKeepAliveGroup"),
        ("CISCO-RADIUS-MIB", "crmAutoInitializeConfigGroup"),
        ("CISCO-RADIUS-MIB", "crmAttributesGroup2"))
)
if mibBuilder.loadTexts:
...
ciscoRadiusMIBCompliance3.setObjects(
      *(("CISCO-RADIUS-MIB", "crmConfigurationGroup"),
        ("CISCO-RADIUS-MIB", "crmAttributesGroup"),
        ("CISCO-RADIUS-MIB", "crmKeepAliveGroup"),
        ("CISCO-RADIUS-MIB", "crmAutoInitializeConfigGroup"),
        ("CISCO-RADIUS-MIB", "crmAttributesGroup2"),
        ("CISCO-RADIUS-MIB", "crmVlanConfigGroup"),
        ("CISCO-RADIUS-MIB", "crmRadiusKeepAliveUserGroup"))
)
if mibBuilder.loadTexts:
...
ciscoRadiusMIBCompliance4.setObjects(
      *(("CISCO-RADIUS-MIB", "crmConfigurationGroup"),
        ("CISCO-RADIUS-MIB", "crmConfigurationGroupSup1"),
        ("CISCO-RADIUS-MIB", "crmRadiusServerNotifGroup"),
        ("CISCO-RADIUS-MIB", "crmRadiusServerNotifCntlGroup"),
        ("CISCO-RADIUS-MIB", "crmAttributesGroup"),
        ("CISCO-RADIUS-MIB", "crmKeepAliveGroup"),
        ("CISCO-RADIUS-MIB", "crmAutoInitializeConfigGroup"),
        ("CISCO-RADIUS-MIB", "crmAttributesGroup2"),
