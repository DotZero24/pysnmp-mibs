...
CiscoPort, TimeIntervalSec, TimeIntervalMin = mibBuilder.importSymbols("CISCO-TC", "CiscoPort", "TimeIntervalSec", "TimeIntervalMin")
...
mibBuilder.exportSymbols("CISCO-RADIUS-MIB", crmAttributesGroup2=crmAttributesGroup2, crRadiusServerRetransNormNotif=crRadiusServerRetransNormNotif, crRadiusKeepAliveInterval=crRadiusKeepAliveInterval, PYSNMP_MODULE_ID=ciscoRadiusMIB, crRadiusAuthKey=crRadiusAuthKey, crRadiusGenericConfig=crRadiusGenericConfig, crVlanGroupVlansHigh=crVlanGroupVlansHigh, crmAutoInitializeConfigGroup=crmAutoInitializeConfigGroup, crmConfigurationGroupSup1=crmConfigurationGroupSup1, crRadiusServerAddrType=crRadiusServerAddrType, crmKeepAliveGroup=crmKeepAliveGroup, crRadiusKeepAliveUserName=crRadiusKeepAliveUserName, crRadiusKeepAliveServerStatus=crRadiusKeepAliveServerStatus, crRadiusLoginAuthentication=crRadiusLoginAuthentication, CiscoRadiusRetransPercent=CiscoRadiusRetransPercent, crRadiusAttributesConfig=crRadiusAttributesConfig, crRadiusServerRetransNormNotifEnable=crRadiusServerRetransNormNotifEnable, crRadiusKeepAliveEnabled=crRadiusKeepAliveEnabled, crVlanGroupTable=crVlanGroupTable, ciscoRadiusMIBCompliance3=ciscoRadiusMIBCompliance3, crRadiusServerRTTNormNotifEnable=crRadiusServerRTTNormNotifEnable, CiscoRadiusRoundTripTimePercent=CiscoRadiusRoundTripTimePercent, crRadiusVlanConfigGroup=crRadiusVlanConfigGroup, crmConfigurationGroup=crmConfigurationGroup, crRadiusServerRTTThldHi=crRadiusServerRTTThldHi, crRadiusFramedIpAddrIncluded=crRadiusFramedIpAddrIncluded, crRadiusKeepAliveServerEntry=crRadiusKeepAliveServerEntry, crRadiusKeepAliveConfig=crRadiusKeepAliveConfig, crRadiusServerNotifCntl=crRadiusServerNotifCntl, ciscoRadiusMIBObjects=ciscoRadiusMIBObjects, crRadiusServerIndex=crRadiusServerIndex, crRadiusServerRTTHiNotifEnable=crRadiusServerRTTHiNotifEnable, crRadiusServerRowStatus=crRadiusServerRowStatus, crRadiusTimeout=crRadiusTimeout, crRadiusServerRetransThldHi=crRadiusServerRetransThldHi, crRadiusServerType=crRadiusServerType, crmRadiusKeepAliveUserGroup=crmRadiusKeepAliveUserGroup, crRadiusKeepAliveServerTable=crRadiusKeepAliveServerTable, crRadiusDeadtime=crRadiusDeadtime, ciscoRadiusMIBGroups=ciscoRadiusMIBGroups, crRadiusServerKey=crRadiusServerKey, crRadiusAccountingLogMaxSize=crRadiusAccountingLogMaxSize, crRadiusServerAuthPort=crRadiusServerAuthPort, crVlanGroupEntry=crVlanGroupEntry, ciscoRadiusMIB=ciscoRadiusMIB, crRadiusServerTableMaxEntries=crRadiusServerTableMaxEntries, ciscoRadiusMIBNotifications=ciscoRadiusMIBNotifications, crRadiusServerMode=crRadiusServerMode, crmRadiusServerNotifGroup=crmRadiusServerNotifGroup, ciscoRadiusMIBCompliance2=ciscoRadiusMIBCompliance2, crRadiusAccountingMethod=crRadiusAccountingMethod, crmAttributesGroup=crmAttributesGroup, ciscoRadiusMIBCompliance4=ciscoRadiusMIBCompliance4, crmVlanConfigGroup=crmVlanConfigGroup, ciscoRadiusMIBConformance=ciscoRadiusMIBConformance, crRadiusServerRTTNormNotif=crRadiusServerRTTNormNotif, crRadiusServerRTTHiNotif=crRadiusServerRTTHiNotif, ciscoRadiusMIBCompliances=ciscoRadiusMIBCompliances, crRadiusServerAcctPort=crRadiusServerAcctPort, crRadiusFramedMtu=crRadiusFramedMtu, crRadiusServerRetransHiNotif=crRadiusServerRetransHiNotif, crVlanGroupVlansLow=crVlanGroupVlansLow, crRadiusServerEntry=crRadiusServerEntry, crRadiusServerConfig=crRadiusServerConfig, crRadiusPortAutoInitialize=crRadiusPortAutoInitialize, crmRadiusServerNotifCntlGroup=crmRadiusServerNotifCntlGroup, crRadiusServerRTTThldNorm=crRadiusServerRTTThldNorm, crRadiusRetransmits=crRadiusRetransmits, crVlanGroupName=crVlanGroupName, crRadiusServerRetransHiNotifEnable=crRadiusServerRetransHiNotifEnable, crVlanGroupRowStatus=crVlanGroupRowStatus, crRadiusVlanAssignmentEnabled=crRadiusVlanAssignmentEnabled, ciscoRadiusMIBCompliance=ciscoRadiusMIBCompliance, crRadiusServerRetransThldNorm=crRadiusServerRetransThldNorm, crRadiusServerAddr=crRadiusServerAddr, CiscoRadiusAuthKey=CiscoRadiusAuthKey, crRadiusServerTable=crRadiusServerTable)
