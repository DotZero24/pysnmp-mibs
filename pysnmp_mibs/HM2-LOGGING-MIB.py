...
mibBuilder.exportSymbols("HM2-LOGGING-MIB", hm2LogCounterFlashDescription=hm2LogCounterFlashDescription, hm2LogEmailToAddrAddress=hm2LogEmailToAddrAddress, hm2LogEmailNonUrgentSeverity=hm2LogEmailNonUrgentSeverity, hm2LogSyslogGroup=hm2LogSyslogGroup, hm2LogPersistFilesMax=hm2LogPersistFilesMax, hm2LogTempHistRangeMin=hm2LogTempHistRangeMin, hm2LogPersistentFileIndex=hm2LogPersistentFileIndex, hm2LogCounterFlashEntry=hm2LogCounterFlashEntry, hm2LogSyslogServerEntry=hm2LogSyslogServerEntry, hm2LogEmailNumEmailsSent=hm2LogEmailNumEmailsSent, hm2LogCounterFlashCount=hm2LogCounterFlashCount, hm2LogEmailClientTlsCipherSuites=hm2LogEmailClientTlsCipherSuites, hm2LogAuditGroup=hm2LogAuditGroup, hm2LogEmailToAddrMessageIndex=hm2LogEmailToAddrMessageIndex, hm2LogCliCommandsAdminStatus=hm2LogCliCommandsAdminStatus, hm2LogCliCommandsLoggingGroup=hm2LogCliCommandsLoggingGroup, hm2LogTempHistEntry=hm2LogTempHistEntry, hm2LogPersistMaxFileSize=hm2LogPersistMaxFileSize, hm2LogCounterFlashTable=hm2LogCounterFlashTable, hm2LogEmailSubjectMessageType=hm2LogEmailSubjectMessageType, hm2LogTempHistRangeMax=hm2LogTempHistRangeMax, hm2LogEmailSmtpAddrDescr=hm2LogEmailSmtpAddrDescr, hm2LogSNMPSyslogConfigFailed=hm2LogSNMPSyslogConfigFailed, hm2LogSyslogServerLevelUpto=hm2LogSyslogServerLevelUpto, hm2LogEmailSmtpSecurity=hm2LogEmailSmtpSecurity, hm2LogEmailToAddressTable=hm2LogEmailToAddressTable, hm2LogHumHistIndex=hm2LogHumHistIndex, hm2LogEmailSmtpAddrType=hm2LogEmailSmtpAddrType, hm2LogSnmpLoggingGroup=hm2LogSnmpLoggingGroup, PYSNMP_MODULE_ID=hm2LoggingMib, hm2LogPersistentFileTable=hm2LogPersistentFileTable, hm2LogEmailSubjectEntry=hm2LogEmailSubjectEntry, hm2LogPersistentFileSize=hm2LogPersistentFileSize, hm2LogEmailClientTlsVersions=hm2LogEmailClientTlsVersions, hm2LogTempHistTable=hm2LogTempHistTable, hm2LogPersistentFileName=hm2LogPersistentFileName, hm2LogHumMaximum=hm2LogHumMaximum, hm2LogEmailSubjectTable=hm2LogEmailSubjectTable, hm2LogHumHistEntry=hm2LogHumHistEntry, hm2LogConsoleLoggingGroup=hm2LogConsoleLoggingGroup, hm2LogEmailSmtpAddr=hm2LogEmailSmtpAddr, hm2LogSnmpLogGetRequest=hm2LogSnmpLogGetRequest, hm2LogSyslogClientTlsVersions=hm2LogSyslogClientTlsVersions, hm2LogEmailMailServerEntry=hm2LogEmailMailServerEntry, hm2LogAuditTrailComment=hm2LogAuditTrailComment, hm2LogSyslogServerTransportType=hm2LogSyslogServerTransportType, hm2LogSyslogServerIPAddrType=hm2LogSyslogServerIPAddrType, hm2LogEmailAdminStatus=hm2LogEmailAdminStatus, hm2LogEmailSubjectEntryStatus=hm2LogEmailSubjectEntryStatus, hm2LogEmailTestMessageBody=hm2LogEmailTestMessageBody, hm2LogBufferdLogLevelThreshold=hm2LogBufferdLogLevelThreshold, hm2LogSNMPMinSeverityInvalid=hm2LogSNMPMinSeverityInvalid, hm2LogPersistLevelUpto=hm2LogPersistLevelUpto, hm2LogPersistentGroup=hm2LogPersistentGroup, hm2LoggingMib=hm2LoggingMib, hm2LogEmailTestMessageType=hm2LogEmailTestMessageType, hm2LogEmailSmtpPort=hm2LogEmailSmtpPort, hm2LogAuditStartNextSector=hm2LogAuditStartNextSector, hm2LogSyslogAdminStatus=hm2LogSyslogAdminStatus, hm2LogEmailUrgentSeverity=hm2LogEmailUrgentSeverity, hm2LogTempVariationCount=hm2LogTempVariationCount, hm2LogSnmpLogSetSeverity=hm2LogSnmpLogSetSeverity, hm2LogSnmpLogSetRequest=hm2LogSnmpLogSetRequest, hm2LogEmailSmtpTimeout=hm2LogEmailSmtpTimeout, hm2LoggingMibObjects=hm2LoggingMibObjects, hm2LogSyslogServerUdpPort=hm2LogSyslogServerUdpPort, hm2LogHumHistTime=hm2LogHumHistTime, hm2LogConsoleSeverityFilter=hm2LogConsoleSeverityFilter, hm2LogSnmpLogGetSeverity=hm2LogSnmpLogGetSeverity, hm2LogCounterFlashBlock=hm2LogCounterFlashBlock, hm2LogEmailMailServerTable=hm2LogEmailMailServerTable, hm2LogEmailToAddrMessageType=hm2LogEmailToAddrMessageType, HmAgentLogSeverity=HmAgentLogSeverity, hm2LogEmailFromAddress=hm2LogEmailFromAddress, hm2LogSyslogClientTlsCipherSuites=hm2LogSyslogClientTlsCipherSuites, hm2LogSyslogServerIPAddr=hm2LogSyslogServerIPAddr, hm2LogSyslogServerTable=hm2LogSyslogServerTable, hm2LogTempHistIndex=hm2LogTempHistIndex, hm2LogEmailSubject=hm2LogEmailSubject, hm2LogEmailSmtpAddrIndex=hm2LogEmailSmtpAddrIndex, hm2LogEmailSmtpPassword=hm2LogEmailSmtpPassword, hm2LogEmailNumEmailFailures=hm2LogEmailNumEmailFailures, hm2LogEmailSendFailed=hm2LogEmailSendFailed, hm2LogTempMinimum=hm2LogTempMinimum, hm2LogTemperatureGroup=hm2LogTemperatureGroup, hm2LogHumHistRangeMin=hm2LogHumHistRangeMin, hm2LogHumidityGroup=hm2LogHumidityGroup, hm2LogEmailSmtpLoginID=hm2LogEmailSmtpLoginID, hm2LogEmailAlertGroup=hm2LogEmailAlertGroup, hm2LogTempMaximum=hm2LogTempMaximum, hm2LogEmailToAddrEntryStatus=hm2LogEmailToAddrEntryStatus, hm2LogEmailTimeOfLastMailSent=hm2LogEmailTimeOfLastMailSent, hm2LogSNMPExtensionGroup=hm2LogSNMPExtensionGroup, hm2LogCounterFlashValue=hm2LogCounterFlashValue, hm2LogEmailToAddressEntry=hm2LogEmailToAddressEntry, hm2LogHumHistRangeMax=hm2LogHumHistRangeMax, hm2LogSyslogServerLogType=hm2LogSyslogServerLogType, hm2LogPersistAdminStatus=hm2LogPersistAdminStatus, hm2LogBufferedLoggingGroup=hm2LogBufferedLoggingGroup, hm2LogHumHistTable=hm2LogHumHistTable, hm2LogHumMinimum=hm2LogHumMinimum, hm2LogEmailLogDuration=hm2LogEmailLogDuration, hm2LoggingMibNotifications=hm2LoggingMibNotifications, hm2LogSyslogServerRowStatus=hm2LogSyslogServerRowStatus, hm2LogPersistentFileEntry=hm2LogPersistentFileEntry, hm2LogEmailAction=hm2LogEmailAction, hm2LogSyslogServerIndex=hm2LogSyslogServerIndex, hm2LogConsoleAdminStatus=hm2LogConsoleAdminStatus, hm2LogEmailSmtpEntryStatus=hm2LogEmailSmtpEntryStatus, hm2LogCounterOperatingHours=hm2LogCounterOperatingHours, hm2LogTempHistTime=hm2LogTempHistTime, hm2LogCounterGroup=hm2LogCounterGroup)
