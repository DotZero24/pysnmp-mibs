...
# Notes
# -----
# ASN.1 source file://mibs/hirschmann/HM2-LOGGING-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 18:55:17 2025
...
_Hm2LogSnmpLogGetRequest_Type.__name__ = "HmEnabledStatus"
...
_Hm2LogSnmpLogSetRequest_Type.__name__ = "HmEnabledStatus"
...
_Hm2LogSnmpLogGetSeverity_Type.__name__ = "HmAgentLogSeverity"
...
_Hm2LogSnmpLogSetSeverity_Type.__name__ = "HmAgentLogSeverity"
...
_Hm2LogCliCommandsAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2LogConsoleAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2LogConsoleSeverityFilter_Type.__name__ = "HmAgentLogSeverity"
...
_Hm2LogBufferdLogLevelThreshold_Type.__name__ = "HmAgentLogSeverity"
...
_Hm2LogSyslogAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2LogSyslogClientTlsVersions_Type.__name__ = "Hm2TlsVersions"
...
_Hm2LogSyslogClientTlsCipherSuites_Type.__name__ = "Hm2TlsCipherSuites"
...
_Hm2LogSyslogServerIPAddrType_Type.__name__ = "InetAddressType"
...
_Hm2LogSyslogServerIPAddr_Type.__name__ = "InetAddress"
...
_Hm2LogSyslogServerUdpPort_Type.__name__ = "InetPortNumber"
...
_Hm2LogSyslogServerLevelUpto_Type.__name__ = "HmAgentLogSeverity"
...
_Hm2LogPersistAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2LogPersistMaxFileSize_Type.__name__ = "Integer32"
...
_Hm2LogPersistFilesMax_Type.__name__ = "Integer32"
...
_Hm2LogPersistLevelUpto_Type.__name__ = "HmAgentLogSeverity"
...
_Hm2LogEmailAdminStatus_Type.__name__ = "HmEnabledStatus"
...
_Hm2LogEmailUrgentSeverity_Type.__name__ = "HmAgentLogSeverity"
...
_Hm2LogEmailNonUrgentSeverity_Type.__name__ = "HmAgentLogSeverity"
...
_Hm2LogEmailSmtpAddrType_Type.__name__ = "InetAddressType"
...
_Hm2LogEmailSmtpAddr_Type.__name__ = "InetAddress"
...
_Hm2LogEmailSmtpPort_Type.__name__ = "InetPortNumber"
...
_Hm2LogEmailClientTlsVersions_Type.__name__ = "Hm2TlsVersions"
...
_Hm2LogEmailClientTlsCipherSuites_Type.__name__ = "Hm2TlsCipherSuites"
...
hm2LogHumidityGroup = _Hm2LogHumidityGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 1, 11)
)


class _Hm2LogHumMinimum_Type(Unsigned32):
    """Custom type hm2LogHumMinimum based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hm2LogHumMinimum_Type.__name__ = "Unsigned32"
_Hm2LogHumMinimum_Object = MibScalar
hm2LogHumMinimum = _Hm2LogHumMinimum_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 1, 11, 1),
    _Hm2LogHumMinimum_Type()
)
hm2LogHumMinimum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2LogHumMinimum.setStatus("current")
if mibBuilder.loadTexts:
    hm2LogHumMinimum.setUnits("percent")


class _Hm2LogHumMaximum_Type(Unsigned32):
    """Custom type hm2LogHumMaximum based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_Hm2LogHumMaximum_Type.__name__ = "Unsigned32"
_Hm2LogHumMaximum_Object = MibScalar
hm2LogHumMaximum = _Hm2LogHumMaximum_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 1, 11, 2),
    _Hm2LogHumMaximum_Type()
)
hm2LogHumMaximum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2LogHumMaximum.setStatus("current")
if mibBuilder.loadTexts:
    hm2LogHumMaximum.setUnits("percent")
_Hm2LogHumHistTable_Object = MibTable
hm2LogHumHistTable = _Hm2LogHumHistTable_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 1, 11, 10)
)
if mibBuilder.loadTexts:
    hm2LogHumHistTable.setStatus("current")
_Hm2LogHumHistEntry_Object = MibTableRow
hm2LogHumHistEntry = _Hm2LogHumHistEntry_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 1, 11, 10, 1)
)
hm2LogHumHistEntry.setIndexNames(
    (0, "HM2-LOGGING-MIB", "hm2LogHumHistIndex"),
)
if mibBuilder.loadTexts:
    hm2LogHumHistEntry.setStatus("current")
_Hm2LogHumHistIndex_Type = Unsigned32
_Hm2LogHumHistIndex_Object = MibTableColumn
hm2LogHumHistIndex = _Hm2LogHumHistIndex_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 1, 11, 10, 1, 1),
    _Hm2LogHumHistIndex_Type()
)
hm2LogHumHistIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hm2LogHumHistIndex.setStatus("current")


class _Hm2LogHumHistRangeMin_Type(Unsigned32):
    """Custom type hm2LogHumHistRangeMin based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_Hm2LogHumHistRangeMin_Type.__name__ = "Unsigned32"
_Hm2LogHumHistRangeMin_Object = MibTableColumn
hm2LogHumHistRangeMin = _Hm2LogHumHistRangeMin_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 1, 11, 10, 1, 2),
    _Hm2LogHumHistRangeMin_Type()
)
hm2LogHumHistRangeMin.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2LogHumHistRangeMin.setStatus("current")
if mibBuilder.loadTexts:
    hm2LogHumHistRangeMin.setUnits("percent")


class _Hm2LogHumHistRangeMax_Type(Unsigned32):
    """Custom type hm2LogHumHistRangeMax based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_Hm2LogHumHistRangeMax_Type.__name__ = "Unsigned32"
_Hm2LogHumHistRangeMax_Object = MibTableColumn
hm2LogHumHistRangeMax = _Hm2LogHumHistRangeMax_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 1, 11, 10, 1, 3),
    _Hm2LogHumHistRangeMax_Type()
)
hm2LogHumHistRangeMax.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2LogHumHistRangeMax.setStatus("current")
if mibBuilder.loadTexts:
    hm2LogHumHistRangeMax.setUnits("percent")
_Hm2LogHumHistTime_Type = Unsigned32
_Hm2LogHumHistTime_Object = MibTableColumn
hm2LogHumHistTime = _Hm2LogHumHistTime_Object(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 1, 11, 10, 1, 4),
    _Hm2LogHumHistTime_Type()
)
hm2LogHumHistTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hm2LogHumHistTime.setStatus("current")
if mibBuilder.loadTexts:
    hm2LogHumHistTime.setUnits("minutes")
_Hm2LogSNMPExtensionGroup_ObjectIdentity = ObjectIdentity
hm2LogSNMPExtensionGroup = _Hm2LogSNMPExtensionGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 3)
)
_Hm2LogSNMPSyslogConfigFailed_ObjectIdentity = ObjectIdentity
hm2LogSNMPSyslogConfigFailed = _Hm2LogSNMPSyslogConfigFailed_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 3, 1)
)
if mibBuilder.loadTexts:
    hm2LogSNMPSyslogConfigFailed.setStatus("current")
_Hm2LogSNMPMinSeverityInvalid_ObjectIdentity = ObjectIdentity
hm2LogSNMPMinSeverityInvalid = _Hm2LogSNMPMinSeverityInvalid_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 248, 11, 23, 3, 2)
)
if mibBuilder.loadTexts:
    hm2LogSNMPMinSeverityInvalid.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"HmAgentLogSeverity": HmAgentLogSeverity,
       ...
       "hm2LogHumidityGroup": hm2LogHumidityGroup,
       "hm2LogHumMinimum": hm2LogHumMinimum,
       "hm2LogHumMaximum": hm2LogHumMaximum,
       "hm2LogHumHistTable": hm2LogHumHistTable,
       "hm2LogHumHistEntry": hm2LogHumHistEntry,
       "hm2LogHumHistIndex": hm2LogHumHistIndex,
       "hm2LogHumHistRangeMin": hm2LogHumHistRangeMin,
       "hm2LogHumHistRangeMax": hm2LogHumHistRangeMax,
       "hm2LogHumHistTime": hm2LogHumHistTime,
       "hm2LogSNMPExtensionGroup": hm2LogSNMPExtensionGroup,
