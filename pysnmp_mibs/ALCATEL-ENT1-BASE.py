# SNMP MIB module (ALCATEL-ENT1-BASE) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/alcatel-ent1/ALCATEL-ENT1-BASE
...
softentIND1AppMon = _SoftentIND1AppMon_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 81)
)
if mibBuilder.loadTexts:
    softentIND1AppMon.setStatus("current")
_SoftentIND1Lbd_ObjectIdentity = ObjectIdentity
softentIND1Lbd = _SoftentIND1Lbd_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 82)
)
if mibBuilder.loadTexts:
    softentIND1Lbd.setStatus("current")
_SoftentIND1AutoConfig_ObjectIdentity = ObjectIdentity
softentIND1AutoConfig = _SoftentIND1AutoConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 83)
)
if mibBuilder.loadTexts:
    softentIND1AutoConfig.setStatus("current")
_SoftentIND1VMSnooping_ObjectIdentity = ObjectIdentity
softentIND1VMSnooping = _SoftentIND1VMSnooping_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 84)
)
if mibBuilder.loadTexts:
    softentIND1VMSnooping.setStatus("current")
_SoftentIND1PPPoEIA_ObjectIdentity = ObjectIdentity
softentIND1PPPoEIA = _SoftentIND1PPPoEIA_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 85)
)
if mibBuilder.loadTexts:
    softentIND1PPPoEIA.setStatus("current")
_SoftentIND1EventScripting_ObjectIdentity = ObjectIdentity
softentIND1EventScripting = _SoftentIND1EventScripting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 86)
)
if mibBuilder.loadTexts:
    softentIND1EventScripting.setStatus("current")
_SoftentIND1LldpTrust_ObjectIdentity = ObjectIdentity
softentIND1LldpTrust = _SoftentIND1LldpTrust_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 87)
)
if mibBuilder.loadTexts:
    softentIND1LldpTrust.setStatus("current")
_SoftentIND1TCAM_ObjectIdentity = ObjectIdentity
softentIND1TCAM = _SoftentIND1TCAM_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 88)
)
if mibBuilder.loadTexts:
    softentIND1TCAM.setStatus("current")
_SoftentIND1PrivateVlan_ObjectIdentity = ObjectIdentity
softentIND1PrivateVlan = _SoftentIND1PrivateVlan_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 89)
)
if mibBuilder.loadTexts:
    softentIND1PrivateVlan.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"alcatel": alcatel,
       ...
       "softentIND1AppMon": softentIND1AppMon,
       "softentIND1Lbd": softentIND1Lbd,
       "softentIND1AutoConfig": softentIND1AutoConfig,
       "softentIND1VMSnooping": softentIND1VMSnooping,
       "softentIND1PPPoEIA": softentIND1PPPoEIA,
       "softentIND1EventScripting": softentIND1EventScripting,
       "softentIND1LldpTrust": softentIND1LldpTrust,
       "softentIND1TCAM": softentIND1TCAM,
       "softentIND1PrivateVlan": softentIND1PrivateVlan,
