# SNMP MIB module (DELL-POWER-ETHERNET-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/DELL-POWER-ETHERNET-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:09:35 2025
...
agentPethPowerLimitMin = _AgentPethPowerLimitMin_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 15, 1, 1, 1, 11),
...
agentPethPowerLimitMax = _AgentPethPowerLimitMax_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 15, 1, 1, 1, 12),
...
class _AgentPethPowerClassifications_Type(Integer32):
    """Custom type agentPethPowerClassifications based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AgentPethPowerClassifications_Type.__name__ = "Integer32"
_AgentPethPowerClassifications_Object = MibTableColumn
agentPethPowerClassifications = _AgentPethPowerClassifications_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 15, 1, 1, 1, 13),
    _AgentPethPowerClassifications_Type()
)
agentPethPowerClassifications.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    agentPethPowerClassifications.setStatus("current")
...
agentPethPseThresholdPower = _AgentPethPseThresholdPower_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 15, 1, 3, 1, 6),
...
mibBuilder.exportSymbols(
    ...
    **{"fastPathpowerEthernetMIB": fastPathpowerEthernetMIB,
       ...
       "agentPethPowerClassifications": agentPethPowerClassifications,
