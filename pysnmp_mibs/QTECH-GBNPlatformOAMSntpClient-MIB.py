...
_G='DisplayString'
_F='Unsigned32'
_E='QTECH-GBNPlatformOAMSntpClient-MIB'
_D='read-only'
_C='Integer32'
_B='read-write'
_A='current'
...
gbnPlatformOAMSntpClient=ModuleIdentity((1,3,6,1,4,1,27514,1,2,1,1,8))
...
sntpClientGeneral=_SntpClientGeneral_ObjectIdentity((1,3,6,1,4,1,27514,1,2,1,1,8,1))
...
sntpClientMode=_SntpClientMode_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,1),_SntpClientMode_Type())
...
sntpClientPollInterval=_SntpClientPollInterval_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,2),_SntpClientPollInterval_Type())
...
sntpClientRetransInterval=_SntpClientRetransInterval_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,3),_SntpClientRetransInterval_Type())
...
sntpClientRetransTimes=_SntpClientRetransTimes_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,4),_SntpClientRetransTimes_Type())
...
sntpClientServer=_SntpClientServer_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,5),_SntpClientServer_Type())
...
sntpClientSynthFlag=_SntpClientSynthFlag_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,6),_SntpClientSynthFlag_Type())
...
sntpClientState=_SntpClientState_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,7),_SntpClientState_Type())
...
sntpClientLastSynthTime=_SntpClientLastSynthTime_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,8),_SntpClientLastSynthTime_Type())
...
sntpClientLastSynthErrno=_SntpClientLastSynthErrno_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,9),_SntpClientLastSynthErrno_Type())
...
sntpClientAdminStatus=_SntpClientAdminStatus_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,10),_SntpClientAdminStatus_Type())
...
sntpClientBcastDelay=_SntpClientBcastDelay_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,11),_SntpClientBcastDelay_Type())
...
sntpClientMcastTtl=_SntpClientMcastTtl_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,12),_SntpClientMcastTtl_Type())
...
sntpClientAuthFlag=_SntpClientAuthFlag_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,13),_SntpClientAuthFlag_Type())
...
sntpClientUniKeyID=_SntpClientUniKeyID_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,14),_SntpClientUniKeyID_Type())
...
sntpClientAnyKeyID=_SntpClientAnyKeyID_Object((1,3,6,1,4,1,27514,1,2,1,1,8,1,15),_SntpClientAnyKeyID_Type())
...
sntpClientValidServerTable=_SntpClientValidServerTable_Object((1,3,6,1,4,1,27514,1,2,1,1,8,2))
if mibBuilder.loadTexts:sntpClientValidServerTable.setStatus(_A)
_SntpClientValidServerEntry_Object=MibTableRow
sntpClientValidServerEntry=_SntpClientValidServerEntry_Object((1,3,6,1,4,1,27514,1,2,1,1,8,2,1))
...
sntpClientValidServerNet=_SntpClientValidServerNet_Object((1,3,6,1,4,1,27514,1,2,1,1,8,2,1,1),_SntpClientValidServerNet_Type())
...
sntpClientValidServerMask=_SntpClientValidServerMask_Object((1,3,6,1,4,1,27514,1,2,1,1,8,2,1,2),_SntpClientValidServerMask_Type())
...
sntpClientValidServerRowStatus=_SntpClientValidServerRowStatus_Object((1,3,6,1,4,1,27514,1,2,1,1,8,2,1,3),_SntpClientValidServerRowStatus_Type())
...
sntpAuthKeyTable=_SntpAuthKeyTable_Object((1,3,6,1,4,1,27514,1,2,1,1,8,3))
if mibBuilder.loadTexts:sntpAuthKeyTable.setStatus(_A)
_SntpAuthKeyEntry_Object=MibTableRow
sntpAuthKeyEntry=_SntpAuthKeyEntry_Object((1,3,6,1,4,1,27514,1,2,1,1,8,3,1))
...
sntpAuthKeyId=_SntpAuthKeyId_Object((1,3,6,1,4,1,27514,1,2,1,1,8,3,1,1),_SntpAuthKeyId_Type())
...
sntpAuthKeyValue=_SntpAuthKeyValue_Object((1,3,6,1,4,1,27514,1,2,1,1,8,3,1,2),_SntpAuthKeyValue_Type())
...
sntpAuthKeyTrustFlag=_SntpAuthKeyTrustFlag_Object((1,3,6,1,4,1,27514,1,2,1,1,8,3,1,3),_SntpAuthKeyTrustFlag_Type())
...
sntpAuthKeyRowStatus=_SntpAuthKeyRowStatus_Object((1,3,6,1,4,1,27514,1,2,1,1,8,3,1,4),_SntpAuthKeyRowStatus_Type())
