...
# Notes
# -----
# ASN.1 source file://mibs/peplink/PEPLINK-BALANCE-MIB
...
balCompliance.setObjects(
      *(("PEPLINK-BALANCE-MIB", "balSystemGroup"),
        ("PEPLINK-BALANCE-MIB", "balLinkGroup"),
        ("PEPLINK-BALANCE-MIB", "balWanGroup"),
        ("PEPLINK-BALANCE-MIB", "balSetGroup"))
)
if mibBuilder.loadTexts:
