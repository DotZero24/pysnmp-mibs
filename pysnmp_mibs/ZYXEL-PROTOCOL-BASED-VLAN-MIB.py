...
mibBuilder.exportSymbols("ZYXEL-PROTOCOL-BASED-VLAN-MIB", zyProtocolBasedVlanName=zyProtocolBasedVlanName, zyProtocolBasedVlanPacketType=zyProtocolBasedVlanPacketType, zyProtocolBasedVlanMaxNumberOfVlans=zyProtocolBasedVlanMaxNumberOfVlans, zyxelProtocolBasedVlanTable=zyxelProtocolBasedVlanTable, zyProtocolBasedVlanPriority=zyProtocolBasedVlanPriority, zyxelProtocolBasedVlan=zyxelProtocolBasedVlan, zyProtocolBasedVlanEthernetType=zyProtocolBasedVlanEthernetType, zyxelProtocolBasedVlanEntry=zyxelProtocolBasedVlanEntry, PYSNMP_MODULE_ID=zyxelProtocolBasedVlan, zyProtocolBasedVlanVid=zyProtocolBasedVlanVid, zyxelProtocolBasedVlanSetup=zyxelProtocolBasedVlanSetup, zyProtocolBasedVlanRowStatus=zyProtocolBasedVlanRowStatus)
