...
# Notes
# -----
# ASN.1 source file://mibs/nokia/TIMETRA-MC-REDUNDANCY-MIB
...
(tmnxDiamNodeOriginHost,
 tmnxDiamPlcyName) = mibBuilder.importSymbols(
...
class _TmnxMcPeerSyncL2tp_Type(TruthValue):
    """Custom type tmnxMcPeerSyncL2tp based on TruthValue"""
    defaultValue = 2


_TmnxMcPeerSyncL2tp_Type.__name__ = "TruthValue"
_TmnxMcPeerSyncL2tp_Object = MibTableColumn
tmnxMcPeerSyncL2tp = _TmnxMcPeerSyncL2tp_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 2, 1, 32),
    _TmnxMcPeerSyncL2tp_Type()
)
tmnxMcPeerSyncL2tp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncL2tp.setStatus("current")


class _TmnxMcPeerSyncDiameterProxy_Type(TruthValue):
    """Custom type tmnxMcPeerSyncDiameterProxy based on TruthValue"""
    defaultValue = 2


_TmnxMcPeerSyncDiameterProxy_Type.__name__ = "TruthValue"
_TmnxMcPeerSyncDiameterProxy_Object = MibTableColumn
tmnxMcPeerSyncDiameterProxy = _TmnxMcPeerSyncDiameterProxy_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 2, 1, 33),
    _TmnxMcPeerSyncDiameterProxy_Type()
)
tmnxMcPeerSyncDiameterProxy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncDiameterProxy.setStatus("current")


class _TmnxMcPeerSyncPimSnpgSap_Type(TruthValue):
    """Custom type tmnxMcPeerSyncPimSnpgSap based on TruthValue"""
    defaultValue = 2


_TmnxMcPeerSyncPimSnpgSap_Type.__name__ = "TruthValue"
_TmnxMcPeerSyncPimSnpgSap_Object = MibTableColumn
tmnxMcPeerSyncPimSnpgSap = _TmnxMcPeerSyncPimSnpgSap_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 2, 1, 34),
    _TmnxMcPeerSyncPimSnpgSap_Type()
)
tmnxMcPeerSyncPimSnpgSap.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncPimSnpgSap.setStatus("current")


class _TmnxMcPeerSyncPimSnpgSdp_Type(TruthValue):
    """Custom type tmnxMcPeerSyncPimSnpgSdp based on TruthValue"""
    defaultValue = 2


_TmnxMcPeerSyncPimSnpgSdp_Type.__name__ = "TruthValue"
_TmnxMcPeerSyncPimSnpgSdp_Object = MibTableColumn
tmnxMcPeerSyncPimSnpgSdp = _TmnxMcPeerSyncPimSnpgSdp_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 2, 1, 35),
    _TmnxMcPeerSyncPimSnpgSdp_Type()
)
tmnxMcPeerSyncPimSnpgSdp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncPimSnpgSdp.setStatus("current")


class _TmnxMcPeerSyncDiameterNode_Type(TruthValue):
    """Custom type tmnxMcPeerSyncDiameterNode based on TruthValue"""
    defaultValue = 2


_TmnxMcPeerSyncDiameterNode_Type.__name__ = "TruthValue"
_TmnxMcPeerSyncDiameterNode_Object = MibTableColumn
tmnxMcPeerSyncDiameterNode = _TmnxMcPeerSyncDiameterNode_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 2, 1, 36),
    _TmnxMcPeerSyncDiameterNode_Type()
)
tmnxMcPeerSyncDiameterNode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncDiameterNode.setStatus("current")


class _TmnxMcPeerSyncNat_Type(TruthValue):
    """Custom type tmnxMcPeerSyncNat based on TruthValue"""
    defaultValue = 2


_TmnxMcPeerSyncNat_Type.__name__ = "TruthValue"
_TmnxMcPeerSyncNat_Object = MibTableColumn
tmnxMcPeerSyncNat = _TmnxMcPeerSyncNat_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 2, 1, 37),
    _TmnxMcPeerSyncNat_Type()
)
tmnxMcPeerSyncNat.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncNat.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxMcLagConfigKeepALiveIvl.setUnits("deciseconds")
...
if mibBuilder.loadTexts:
    tmnxSrrpOperKeepAliveInterval.setUnits("hundreds of milliseconds")
...
class _TmnxSrrpOperDomain_Type(TNamedItemOrEmpty):
    """Custom type tmnxSrrpOperDomain based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxSrrpOperDomain_Type.__name__ = "TNamedItemOrEmpty"
_TmnxSrrpOperDomain_Object = MibTableColumn
tmnxSrrpOperDomain = _TmnxSrrpOperDomain_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 9, 1, 25),
    _TmnxSrrpOperDomain_Type()
)
tmnxSrrpOperDomain.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSrrpOperDomain.setStatus("obsolete")


class _TmnxSrrpOperDomainColor_Type(Unsigned32):
    """Custom type tmnxSrrpOperDomainColor based on Unsigned32"""
    defaultValue = 0
...
_TmnxSrrpOperDomainColor_Type.__name__ = "Unsigned32"
_TmnxSrrpOperDomainColor_Object = MibTableColumn
tmnxSrrpOperDomainColor = _TmnxSrrpOperDomainColor_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 9, 1, 26),
    _TmnxSrrpOperDomainColor_Type()
)
tmnxSrrpOperDomainColor.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxSrrpOperDomainColor.setStatus("obsolete")
...
class _TmnxMcRingInbCtrlIfServiceName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxMcRingInbCtrlIfServiceName based on TLNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxMcRingInbCtrlIfServiceName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxMcRingInbCtrlIfServiceName_Object = MibTableColumn
tmnxMcRingInbCtrlIfServiceName = _TmnxMcRingInbCtrlIfServiceName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 14, 1, 23),
    _TmnxMcRingInbCtrlIfServiceName_Type()
)
tmnxMcRingInbCtrlIfServiceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcRingInbCtrlIfServiceName.setStatus("current")
...
class _TmnxMcRingNodeRncvSapServiceName_Type(TLNamedItemOrEmpty):
    """Custom type tmnxMcRingNodeRncvSapServiceName based on TLNamedItemOrEmpty"""
    defaultValue = OctetString("")


_TmnxMcRingNodeRncvSapServiceName_Type.__name__ = "TLNamedItemOrEmpty"
_TmnxMcRingNodeRncvSapServiceName_Object = MibTableColumn
tmnxMcRingNodeRncvSapServiceName = _TmnxMcRingNodeRncvSapServiceName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 18, 1, 13),
    _TmnxMcRingNodeRncvSapServiceName_Type()
)
tmnxMcRingNodeRncvSapServiceName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcRingNodeRncvSapServiceName.setStatus("current")


class _TmnxMcRingNodeRncvEncapType_Type(TmnxPortEncapType):
    """Custom type tmnxMcRingNodeRncvEncapType based on TmnxPortEncapType"""
    defaultValue = 0

    subtypeSpec = TmnxPortEncapType.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
              2,
...
_TmnxMcRingNodeRncvEncapType_Type.__name__ = "TmnxPortEncapType"
_TmnxMcRingNodeRncvEncapType_Object = MibTableColumn
tmnxMcRingNodeRncvEncapType = _TmnxMcRingNodeRncvEncapType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 18, 1, 14),
    _TmnxMcRingNodeRncvEncapType_Type()
)
tmnxMcRingNodeRncvEncapType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcRingNodeRncvEncapType.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfTblLastChgd.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfTable.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfEntry.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfSvcId.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfIfName.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfDestIpType.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfDestIp.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfRowStatus.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfLastChanged.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfSrcIpType.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfSrcIp.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxSrrpAssoBfdIntfSessOperState.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    tmnxMcPeerEPKeepAliveIntvl.setUnits("deciseconds")
...
if mibBuilder.loadTexts:
    tMcPeerIPsecKeepAliveIntvl.setUnits("deciseconds")
...
_TmnxMcOmcrDomainTable_Object = MibTable
tmnxMcOmcrDomainTable = _TmnxMcOmcrDomainTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 45, 1)
)
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainTable.setStatus("obsolete")
_TmnxMcOmcrDomainEntry_Object = MibTableRow
tmnxMcOmcrDomainEntry = _TmnxMcOmcrDomainEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 45, 1, 1)
)
tmnxMcOmcrDomainEntry.setIndexNames(
    (1, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainName"),
)
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainEntry.setStatus("obsolete")
_TmnxMcOmcrDomainName_Type = TNamedItem
_TmnxMcOmcrDomainName_Object = MibTableColumn
tmnxMcOmcrDomainName = _TmnxMcOmcrDomainName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 45, 1, 1, 1),
    _TmnxMcOmcrDomainName_Type()
)
tmnxMcOmcrDomainName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainName.setStatus("obsolete")
_TmnxMcOmcrDomainLastMgmtChange_Type = TimeStamp
_TmnxMcOmcrDomainLastMgmtChange_Object = MibTableColumn
tmnxMcOmcrDomainLastMgmtChange = _TmnxMcOmcrDomainLastMgmtChange_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 45, 1, 1, 2),
    _TmnxMcOmcrDomainLastMgmtChange_Type()
)
tmnxMcOmcrDomainLastMgmtChange.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainLastMgmtChange.setStatus("obsolete")
_TmnxMcOmcrDomainRowStatus_Type = RowStatus
_TmnxMcOmcrDomainRowStatus_Object = MibTableColumn
tmnxMcOmcrDomainRowStatus = _TmnxMcOmcrDomainRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 45, 1, 1, 3),
    _TmnxMcOmcrDomainRowStatus_Type()
)
tmnxMcOmcrDomainRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainRowStatus.setStatus("obsolete")


class _TmnxMcOmcrDomainDescription_Type(TItemDescription):
    """Custom type tmnxMcOmcrDomainDescription based on TItemDescription"""
    defaultValue = OctetString("")


_TmnxMcOmcrDomainDescription_Type.__name__ = "TItemDescription"
_TmnxMcOmcrDomainDescription_Object = MibTableColumn
tmnxMcOmcrDomainDescription = _TmnxMcOmcrDomainDescription_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 45, 1, 1, 4),
    _TmnxMcOmcrDomainDescription_Type()
)
tmnxMcOmcrDomainDescription.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainDescription.setStatus("obsolete")


class _TmnxMcOmcrDomainHoldDownTime_Type(Unsigned32):
    """Custom type tmnxMcOmcrDomainHoldDownTime based on Unsigned32"""
    defaultValue = 0
...
_TmnxMcOmcrDomainHoldDownTime_Type.__name__ = "Unsigned32"
_TmnxMcOmcrDomainHoldDownTime_Object = MibTableColumn
tmnxMcOmcrDomainHoldDownTime = _TmnxMcOmcrDomainHoldDownTime_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 45, 1, 1, 5),
    _TmnxMcOmcrDomainHoldDownTime_Type()
)
tmnxMcOmcrDomainHoldDownTime.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainHoldDownTime.setStatus("obsolete")
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainHoldDownTime.setUnits("seconds")


class _TmnxMcOmcrDomainState_Type(Integer32):
    """Custom type tmnxMcOmcrDomainState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TmnxMcOmcrDomainState_Type.__name__ = "Integer32"
_TmnxMcOmcrDomainState_Object = MibTableColumn
tmnxMcOmcrDomainState = _TmnxMcOmcrDomainState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 45, 1, 1, 6),
    _TmnxMcOmcrDomainState_Type()
)
tmnxMcOmcrDomainState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainState.setStatus("obsolete")
...
_TmnxMcOmcrDomainTableLastCh_Type = TimeStamp
_TmnxMcOmcrDomainTableLastCh_Object = MibScalar
tmnxMcOmcrDomainTableLastCh = _TmnxMcOmcrDomainTableLastCh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 46),
    _TmnxMcOmcrDomainTableLastCh_Type()
)
tmnxMcOmcrDomainTableLastCh.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcOmcrDomainTableLastCh.setStatus("obsolete")
...
_TmnxMcL2tpTable_Object = MibTable
tmnxMcL2tpTable = _TmnxMcL2tpTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 49)
)
if mibBuilder.loadTexts:
    tmnxMcL2tpTable.setStatus("current")
_TmnxMcL2tpEntry_Object = MibTableRow
tmnxMcL2tpEntry = _TmnxMcL2tpEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 49, 1)
)
tmnxMcL2tpEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpOperID"),
)
if mibBuilder.loadTexts:
    tmnxMcL2tpEntry.setStatus("current")
_TmnxMcL2tpRowStatus_Type = RowStatus
_TmnxMcL2tpRowStatus_Object = MibTableColumn
tmnxMcL2tpRowStatus = _TmnxMcL2tpRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 49, 1, 2),
    _TmnxMcL2tpRowStatus_Type()
)
tmnxMcL2tpRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcL2tpRowStatus.setStatus("current")
_TmnxMcL2tpLastChanged_Type = TimeStamp
_TmnxMcL2tpLastChanged_Object = MibTableColumn
tmnxMcL2tpLastChanged = _TmnxMcL2tpLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 49, 1, 3),
    _TmnxMcL2tpLastChanged_Type()
)
tmnxMcL2tpLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcL2tpLastChanged.setStatus("current")
_TmnxMcL2tpPeerIpAddrType_Type = InetAddressType
_TmnxMcL2tpPeerIpAddrType_Object = MibTableColumn
tmnxMcL2tpPeerIpAddrType = _TmnxMcL2tpPeerIpAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 49, 1, 4),
    _TmnxMcL2tpPeerIpAddrType_Type()
)
tmnxMcL2tpPeerIpAddrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcL2tpPeerIpAddrType.setStatus("current")


class _TmnxMcL2tpPeerIpAddr_Type(InetAddress):
    """Custom type tmnxMcL2tpPeerIpAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_TmnxMcL2tpPeerIpAddr_Type.__name__ = "InetAddress"
_TmnxMcL2tpPeerIpAddr_Object = MibTableColumn
tmnxMcL2tpPeerIpAddr = _TmnxMcL2tpPeerIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 49, 1, 5),
    _TmnxMcL2tpPeerIpAddr_Type()
)
tmnxMcL2tpPeerIpAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcL2tpPeerIpAddr.setStatus("current")
_TmnxMcL2tpSyncTag_Type = TNamedItem
_TmnxMcL2tpSyncTag_Object = MibTableColumn
tmnxMcL2tpSyncTag = _TmnxMcL2tpSyncTag_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 49, 1, 6),
    _TmnxMcL2tpSyncTag_Type()
)
tmnxMcL2tpSyncTag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcL2tpSyncTag.setStatus("current")
_TmnxMcL2tpTableLastChanged_Type = TimeStamp
_TmnxMcL2tpTableLastChanged_Object = MibScalar
tmnxMcL2tpTableLastChanged = _TmnxMcL2tpTableLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 50),
    _TmnxMcL2tpTableLastChanged_Type()
)
tmnxMcL2tpTableLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcL2tpTableLastChanged.setStatus("current")
_TmnxMcTrkSrrpTable_Object = MibTable
tmnxMcTrkSrrpTable = _TmnxMcTrkSrrpTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 51)
)
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpTable.setStatus("current")
_TmnxMcTrkSrrpEntry_Object = MibTableRow
tmnxMcTrkSrrpEntry = _TmnxMcTrkSrrpEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 51, 1)
)
tmnxMcTrkSrrpEntry.setIndexNames(
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcTrkSrrpPeerAddrType"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcTrkSrrpPeerAddr"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcTrkSrrpId"),
)
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpEntry.setStatus("current")
_TmnxMcTrkSrrpPeerAddrType_Type = InetAddressType
_TmnxMcTrkSrrpPeerAddrType_Object = MibTableColumn
tmnxMcTrkSrrpPeerAddrType = _TmnxMcTrkSrrpPeerAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 51, 1, 1),
    _TmnxMcTrkSrrpPeerAddrType_Type()
)
tmnxMcTrkSrrpPeerAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpPeerAddrType.setStatus("current")


class _TmnxMcTrkSrrpPeerAddr_Type(InetAddress):
    """Custom type tmnxMcTrkSrrpPeerAddr based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(4, 4),
        ValueSizeConstraint(16, 16),
...
_TmnxMcTrkSrrpPeerAddr_Type.__name__ = "InetAddress"
_TmnxMcTrkSrrpPeerAddr_Object = MibTableColumn
tmnxMcTrkSrrpPeerAddr = _TmnxMcTrkSrrpPeerAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 51, 1, 2),
    _TmnxMcTrkSrrpPeerAddr_Type()
)
tmnxMcTrkSrrpPeerAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpPeerAddr.setStatus("current")
_TmnxMcTrkSrrpId_Type = Unsigned32
_TmnxMcTrkSrrpId_Object = MibTableColumn
tmnxMcTrkSrrpId = _TmnxMcTrkSrrpId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 51, 1, 3),
    _TmnxMcTrkSrrpId_Type()
)
tmnxMcTrkSrrpId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpId.setStatus("current")
_TmnxMcTrkSrrpRowStatus_Type = RowStatus
_TmnxMcTrkSrrpRowStatus_Object = MibTableColumn
tmnxMcTrkSrrpRowStatus = _TmnxMcTrkSrrpRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 51, 1, 4),
    _TmnxMcTrkSrrpRowStatus_Type()
)
tmnxMcTrkSrrpRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpRowStatus.setStatus("current")
_TmnxMcTrkSrrpLastCh_Type = TimeStamp
_TmnxMcTrkSrrpLastCh_Object = MibTableColumn
tmnxMcTrkSrrpLastCh = _TmnxMcTrkSrrpLastCh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 51, 1, 5),
    _TmnxMcTrkSrrpLastCh_Type()
)
tmnxMcTrkSrrpLastCh.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpLastCh.setStatus("current")


class _TmnxMcTrkSrrpL2tpTuStart_Type(Unsigned32):
    """Custom type tmnxMcTrkSrrpL2tpTuStart based on Unsigned32"""
    defaultValue = 0
...
_TmnxMcTrkSrrpL2tpTuStart_Type.__name__ = "Unsigned32"
_TmnxMcTrkSrrpL2tpTuStart_Object = MibTableColumn
tmnxMcTrkSrrpL2tpTuStart = _TmnxMcTrkSrrpL2tpTuStart_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 51, 1, 6),
    _TmnxMcTrkSrrpL2tpTuStart_Type()
)
tmnxMcTrkSrrpL2tpTuStart.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpL2tpTuStart.setStatus("current")


class _TmnxMcTrkSrrpL2tpTuEnd_Type(Unsigned32):
    """Custom type tmnxMcTrkSrrpL2tpTuEnd based on Unsigned32"""
    defaultValue = 0
...
_TmnxMcTrkSrrpL2tpTuEnd_Type.__name__ = "Unsigned32"
_TmnxMcTrkSrrpL2tpTuEnd_Object = MibTableColumn
tmnxMcTrkSrrpL2tpTuEnd = _TmnxMcTrkSrrpL2tpTuEnd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 51, 1, 7),
    _TmnxMcTrkSrrpL2tpTuEnd_Type()
)
tmnxMcTrkSrrpL2tpTuEnd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpL2tpTuEnd.setStatus("current")
_TmnxMcTrkSrrpTableLastChanged_Type = TimeStamp
_TmnxMcTrkSrrpTableLastChanged_Object = MibScalar
tmnxMcTrkSrrpTableLastChanged = _TmnxMcTrkSrrpTableLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 52),
    _TmnxMcTrkSrrpTableLastChanged_Type()
)
tmnxMcTrkSrrpTableLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcTrkSrrpTableLastChanged.setStatus("current")
_TmnxMcDiamPrxTable_Object = MibTable
tmnxMcDiamPrxTable = _TmnxMcDiamPrxTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 54)
)
if mibBuilder.loadTexts:
    tmnxMcDiamPrxTable.setStatus("current")
_TmnxMcDiamPrxEntry_Object = MibTableRow
tmnxMcDiamPrxEntry = _TmnxMcDiamPrxEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 54, 1)
)
tmnxMcDiamPrxEntry.setIndexNames(
    (0, "TIMETRA-DIAMETER-MIB", "tmnxDiamPlcyName"),
)
if mibBuilder.loadTexts:
    tmnxMcDiamPrxEntry.setStatus("current")
_TmnxMcDiamPrxRowStatus_Type = RowStatus
_TmnxMcDiamPrxRowStatus_Object = MibTableColumn
tmnxMcDiamPrxRowStatus = _TmnxMcDiamPrxRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 54, 1, 2),
    _TmnxMcDiamPrxRowStatus_Type()
)
tmnxMcDiamPrxRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcDiamPrxRowStatus.setStatus("current")
_TmnxMcDiamPrxLastChanged_Type = TimeStamp
_TmnxMcDiamPrxLastChanged_Object = MibTableColumn
tmnxMcDiamPrxLastChanged = _TmnxMcDiamPrxLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 54, 1, 3),
    _TmnxMcDiamPrxLastChanged_Type()
)
tmnxMcDiamPrxLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcDiamPrxLastChanged.setStatus("current")


class _TmnxMcDiamPrxPeerIpAddrType_Type(InetAddressType):
    """Custom type tmnxMcDiamPrxPeerIpAddrType based on InetAddressType"""
    defaultValue = 0


_TmnxMcDiamPrxPeerIpAddrType_Type.__name__ = "InetAddressType"
_TmnxMcDiamPrxPeerIpAddrType_Object = MibTableColumn
tmnxMcDiamPrxPeerIpAddrType = _TmnxMcDiamPrxPeerIpAddrType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 54, 1, 4),
    _TmnxMcDiamPrxPeerIpAddrType_Type()
)
tmnxMcDiamPrxPeerIpAddrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcDiamPrxPeerIpAddrType.setStatus("current")


class _TmnxMcDiamPrxPeerIpAddr_Type(InetAddress):
    """Custom type tmnxMcDiamPrxPeerIpAddr based on InetAddress"""
    defaultHexValue = ""
...
_TmnxMcDiamPrxPeerIpAddr_Type.__name__ = "InetAddress"
_TmnxMcDiamPrxPeerIpAddr_Object = MibTableColumn
tmnxMcDiamPrxPeerIpAddr = _TmnxMcDiamPrxPeerIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 54, 1, 5),
    _TmnxMcDiamPrxPeerIpAddr_Type()
)
tmnxMcDiamPrxPeerIpAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcDiamPrxPeerIpAddr.setStatus("current")


class _TmnxMcDiamPrxSyncTag_Type(TNamedItemOrEmpty):
    """Custom type tmnxMcDiamPrxSyncTag based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxMcDiamPrxSyncTag_Type.__name__ = "TNamedItemOrEmpty"
_TmnxMcDiamPrxSyncTag_Object = MibTableColumn
tmnxMcDiamPrxSyncTag = _TmnxMcDiamPrxSyncTag_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 54, 1, 6),
    _TmnxMcDiamPrxSyncTag_Type()
)
tmnxMcDiamPrxSyncTag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcDiamPrxSyncTag.setStatus("current")
_TmnxMcDiamPrxTableLastChanged_Type = TimeStamp
_TmnxMcDiamPrxTableLastChanged_Object = MibScalar
tmnxMcDiamPrxTableLastChanged = _TmnxMcDiamPrxTableLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 55),
    _TmnxMcDiamPrxTableLastChanged_Type()
)
tmnxMcDiamPrxTableLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcDiamPrxTableLastChanged.setStatus("current")
_TmnxMcRedBgpEvpnMHObjs_ObjectIdentity = ObjectIdentity
tmnxMcRedBgpEvpnMHObjs = _TmnxMcRedBgpEvpnMHObjs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 56)
)


class _TmnxMcRedBgpEvpnMHBootTimer_Type(Integer32):
    """Custom type tmnxMcRedBgpEvpnMHBootTimer based on Integer32"""
    defaultValue = 10
...
_TmnxMcRedBgpEvpnMHBootTimer_Type.__name__ = "Integer32"
_TmnxMcRedBgpEvpnMHBootTimer_Object = MibScalar
tmnxMcRedBgpEvpnMHBootTimer = _TmnxMcRedBgpEvpnMHBootTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 56, 1),
    _TmnxMcRedBgpEvpnMHBootTimer_Type()
)
tmnxMcRedBgpEvpnMHBootTimer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxMcRedBgpEvpnMHBootTimer.setStatus("current")
if mibBuilder.loadTexts:
    tmnxMcRedBgpEvpnMHBootTimer.setUnits("seconds")


class _TmnxMcRedBgpEvpnMHEsActTimer_Type(Integer32):
    """Custom type tmnxMcRedBgpEvpnMHEsActTimer based on Integer32"""
    defaultValue = 3
...
_TmnxMcRedBgpEvpnMHEsActTimer_Type.__name__ = "Integer32"
_TmnxMcRedBgpEvpnMHEsActTimer_Object = MibScalar
tmnxMcRedBgpEvpnMHEsActTimer = _TmnxMcRedBgpEvpnMHEsActTimer_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 56, 2),
    _TmnxMcRedBgpEvpnMHEsActTimer_Type()
)
tmnxMcRedBgpEvpnMHEsActTimer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tmnxMcRedBgpEvpnMHEsActTimer.setStatus("current")
if mibBuilder.loadTexts:
    tmnxMcRedBgpEvpnMHEsActTimer.setUnits("seconds")
_TmnxMcRedBgpEvpnMHBootTimerRem_Type = Integer32
_TmnxMcRedBgpEvpnMHBootTimerRem_Object = MibScalar
tmnxMcRedBgpEvpnMHBootTimerRem = _TmnxMcRedBgpEvpnMHBootTimerRem_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 56, 3),
    _TmnxMcRedBgpEvpnMHBootTimerRem_Type()
)
tmnxMcRedBgpEvpnMHBootTimerRem.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcRedBgpEvpnMHBootTimerRem.setStatus("current")
if mibBuilder.loadTexts:
    tmnxMcRedBgpEvpnMHBootTimerRem.setUnits("seconds")
_TmnxMcPeerSyncSdpTable_Object = MibTable
tmnxMcPeerSyncSdpTable = _TmnxMcPeerSyncSdpTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 57)
)
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpTable.setStatus("current")
_TmnxMcPeerSyncSdpEntry_Object = MibTableRow
tmnxMcPeerSyncSdpEntry = _TmnxMcPeerSyncSdpEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 57, 1)
)
tmnxMcPeerSyncSdpEntry.setIndexNames(
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerIpType"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerIpAddr"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncSdpId"),
)
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpEntry.setStatus("current")
_TmnxMcPeerSyncSdpId_Type = SdpId
_TmnxMcPeerSyncSdpId_Object = MibTableColumn
tmnxMcPeerSyncSdpId = _TmnxMcPeerSyncSdpId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 57, 1, 1),
    _TmnxMcPeerSyncSdpId_Type()
)
tmnxMcPeerSyncSdpId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpId.setStatus("current")
_TmnxMcPeerSyncSdpRowStatus_Type = RowStatus
_TmnxMcPeerSyncSdpRowStatus_Object = MibTableColumn
tmnxMcPeerSyncSdpRowStatus = _TmnxMcPeerSyncSdpRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 57, 1, 2),
    _TmnxMcPeerSyncSdpRowStatus_Type()
)
tmnxMcPeerSyncSdpRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpRowStatus.setStatus("current")


class _TmnxMcPeerSyncSdpSyncTag_Type(TNamedItemOrEmpty):
    """Custom type tmnxMcPeerSyncSdpSyncTag based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxMcPeerSyncSdpSyncTag_Type.__name__ = "TNamedItemOrEmpty"
_TmnxMcPeerSyncSdpSyncTag_Object = MibTableColumn
tmnxMcPeerSyncSdpSyncTag = _TmnxMcPeerSyncSdpSyncTag_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 57, 1, 3),
    _TmnxMcPeerSyncSdpSyncTag_Type()
)
tmnxMcPeerSyncSdpSyncTag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpSyncTag.setStatus("current")
_TmnxMcPeerSyncSdpVcIdRangeTable_Object = MibTable
tmnxMcPeerSyncSdpVcIdRangeTable = _TmnxMcPeerSyncSdpVcIdRangeTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 58)
)
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpVcIdRangeTable.setStatus("current")
_TmnxMcPeerSyncSdpVcIdRangeEntry_Object = MibTableRow
tmnxMcPeerSyncSdpVcIdRangeEntry = _TmnxMcPeerSyncSdpVcIdRangeEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 58, 1)
)
tmnxMcPeerSyncSdpVcIdRangeEntry.setIndexNames(
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerIpType"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerIpAddr"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncSdpId"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncSdpVcIdMin"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncSdpVcIdMax"),
)
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpVcIdRangeEntry.setStatus("current")
_TmnxMcPeerSyncSdpVcIdMin_Type = Unsigned32
_TmnxMcPeerSyncSdpVcIdMin_Object = MibTableColumn
tmnxMcPeerSyncSdpVcIdMin = _TmnxMcPeerSyncSdpVcIdMin_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 58, 1, 1),
    _TmnxMcPeerSyncSdpVcIdMin_Type()
)
tmnxMcPeerSyncSdpVcIdMin.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpVcIdMin.setStatus("current")
_TmnxMcPeerSyncSdpVcIdMax_Type = Unsigned32
_TmnxMcPeerSyncSdpVcIdMax_Object = MibTableColumn
tmnxMcPeerSyncSdpVcIdMax = _TmnxMcPeerSyncSdpVcIdMax_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 58, 1, 2),
    _TmnxMcPeerSyncSdpVcIdMax_Type()
)
tmnxMcPeerSyncSdpVcIdMax.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpVcIdMax.setStatus("current")
_TmnxMcPeerSyncSdpVcIdRowStatus_Type = RowStatus
_TmnxMcPeerSyncSdpVcIdRowStatus_Object = MibTableColumn
tmnxMcPeerSyncSdpVcIdRowStatus = _TmnxMcPeerSyncSdpVcIdRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 58, 1, 3),
    _TmnxMcPeerSyncSdpVcIdRowStatus_Type()
)
tmnxMcPeerSyncSdpVcIdRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpVcIdRowStatus.setStatus("current")
_TmnxMcPeerSyncSdpVcIdSyncTag_Type = TNamedItem
_TmnxMcPeerSyncSdpVcIdSyncTag_Object = MibTableColumn
tmnxMcPeerSyncSdpVcIdSyncTag = _TmnxMcPeerSyncSdpVcIdSyncTag_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 58, 1, 4),
    _TmnxMcPeerSyncSdpVcIdSyncTag_Type()
)
tmnxMcPeerSyncSdpVcIdSyncTag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcPeerSyncSdpVcIdSyncTag.setStatus("current")
_TSrrpAssoBfdIntfSvcTblLastChgd_Type = TimeStamp
_TSrrpAssoBfdIntfSvcTblLastChgd_Object = MibScalar
tSrrpAssoBfdIntfSvcTblLastChgd = _TSrrpAssoBfdIntfSvcTblLastChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 59),
    _TSrrpAssoBfdIntfSvcTblLastChgd_Type()
)
tSrrpAssoBfdIntfSvcTblLastChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcTblLastChgd.setStatus("current")
_TSrrpAssoBfdIntfSvcTable_Object = MibTable
tSrrpAssoBfdIntfSvcTable = _TSrrpAssoBfdIntfSvcTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60)
)
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcTable.setStatus("current")
_TSrrpAssoBfdIntfSvcEntry_Object = MibTableRow
tSrrpAssoBfdIntfSvcEntry = _TSrrpAssoBfdIntfSvcEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1)
)
tSrrpAssoBfdIntfSvcEntry.setIndexNames(
    (0, "TIMETRA-VRTR-MIB", "vRtrID"),
    (0, "TIMETRA-VRTR-MIB", "vRtrIfIndex"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpOperID"),
)
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcEntry.setStatus("current")
_TSrrpAssoBfdIntfSvcSvcId_Type = TmnxServId
_TSrrpAssoBfdIntfSvcSvcId_Object = MibTableColumn
tSrrpAssoBfdIntfSvcSvcId = _TSrrpAssoBfdIntfSvcSvcId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 2),
    _TSrrpAssoBfdIntfSvcSvcId_Type()
)
tSrrpAssoBfdIntfSvcSvcId.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcSvcId.setStatus("current")
_TSrrpAssoBfdIntfSvcIfName_Type = TNamedItem
_TSrrpAssoBfdIntfSvcIfName_Object = MibTableColumn
tSrrpAssoBfdIntfSvcIfName = _TSrrpAssoBfdIntfSvcIfName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 3),
    _TSrrpAssoBfdIntfSvcIfName_Type()
)
tSrrpAssoBfdIntfSvcIfName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcIfName.setStatus("current")
_TSrrpAssoBfdIntfSvcDestIpType_Type = InetAddressType
_TSrrpAssoBfdIntfSvcDestIpType_Object = MibTableColumn
tSrrpAssoBfdIntfSvcDestIpType = _TSrrpAssoBfdIntfSvcDestIpType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 4),
    _TSrrpAssoBfdIntfSvcDestIpType_Type()
)
tSrrpAssoBfdIntfSvcDestIpType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcDestIpType.setStatus("current")


class _TSrrpAssoBfdIntfSvcDestIp_Type(InetAddress):
    """Custom type tSrrpAssoBfdIntfSvcDestIp based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_TSrrpAssoBfdIntfSvcDestIp_Type.__name__ = "InetAddress"
_TSrrpAssoBfdIntfSvcDestIp_Object = MibTableColumn
tSrrpAssoBfdIntfSvcDestIp = _TSrrpAssoBfdIntfSvcDestIp_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 5),
    _TSrrpAssoBfdIntfSvcDestIp_Type()
)
tSrrpAssoBfdIntfSvcDestIp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcDestIp.setStatus("current")
_TSrrpAssoBfdIntfSvcRowStatus_Type = RowStatus
_TSrrpAssoBfdIntfSvcRowStatus_Object = MibTableColumn
tSrrpAssoBfdIntfSvcRowStatus = _TSrrpAssoBfdIntfSvcRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 6),
    _TSrrpAssoBfdIntfSvcRowStatus_Type()
)
tSrrpAssoBfdIntfSvcRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcRowStatus.setStatus("current")
_TSrrpAssoBfdIntfSvcLastChgd_Type = TimeStamp
_TSrrpAssoBfdIntfSvcLastChgd_Object = MibTableColumn
tSrrpAssoBfdIntfSvcLastChgd = _TSrrpAssoBfdIntfSvcLastChgd_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 7),
    _TSrrpAssoBfdIntfSvcLastChgd_Type()
)
tSrrpAssoBfdIntfSvcLastChgd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcLastChgd.setStatus("current")
_TSrrpAssoBfdIntfSvcSrcIpType_Type = InetAddressType
_TSrrpAssoBfdIntfSvcSrcIpType_Object = MibTableColumn
tSrrpAssoBfdIntfSvcSrcIpType = _TSrrpAssoBfdIntfSvcSrcIpType_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 8),
    _TSrrpAssoBfdIntfSvcSrcIpType_Type()
)
tSrrpAssoBfdIntfSvcSrcIpType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcSrcIpType.setStatus("current")


class _TSrrpAssoBfdIntfSvcSrcIp_Type(InetAddress):
    """Custom type tSrrpAssoBfdIntfSvcSrcIp based on InetAddress"""
    subtypeSpec = InetAddress.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 0),
        ValueSizeConstraint(4, 4),
...
_TSrrpAssoBfdIntfSvcSrcIp_Type.__name__ = "InetAddress"
_TSrrpAssoBfdIntfSvcSrcIp_Object = MibTableColumn
tSrrpAssoBfdIntfSvcSrcIp = _TSrrpAssoBfdIntfSvcSrcIp_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 9),
    _TSrrpAssoBfdIntfSvcSrcIp_Type()
)
tSrrpAssoBfdIntfSvcSrcIp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcSrcIp.setStatus("current")
_TSrrpAssoBfdIntfSvcSessOperState_Type = TmnxSrrpAssoBfdIntfSessOperState
_TSrrpAssoBfdIntfSvcSessOperState_Object = MibTableColumn
tSrrpAssoBfdIntfSvcSessOperState = _TSrrpAssoBfdIntfSvcSessOperState_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 10),
    _TSrrpAssoBfdIntfSvcSessOperState_Type()
)
tSrrpAssoBfdIntfSvcSessOperState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcSessOperState.setStatus("current")


class _TSrrpAssoBfdIntfSvcName_Type(TLNamedItemOrEmpty):
    """Custom type tSrrpAssoBfdIntfSvcName based on TLNamedItemOrEmpty"""
    defaultHexValue = ""


_TSrrpAssoBfdIntfSvcName_Type.__name__ = "TLNamedItemOrEmpty"
_TSrrpAssoBfdIntfSvcName_Object = MibTableColumn
tSrrpAssoBfdIntfSvcName = _TSrrpAssoBfdIntfSvcName_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 60, 1, 11),
    _TSrrpAssoBfdIntfSvcName_Type()
)
tSrrpAssoBfdIntfSvcName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tSrrpAssoBfdIntfSvcName.setStatus("current")
_TmnxMcRedNatGrpTableLastChanged_Type = TimeStamp
_TmnxMcRedNatGrpTableLastChanged_Object = MibScalar
tmnxMcRedNatGrpTableLastChanged = _TmnxMcRedNatGrpTableLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 63),
    _TmnxMcRedNatGrpTableLastChanged_Type()
)
tmnxMcRedNatGrpTableLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcRedNatGrpTableLastChanged.setStatus("current")
_TmnxMcRedNatObjs_ObjectIdentity = ObjectIdentity
tmnxMcRedNatObjs = _TmnxMcRedNatObjs_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 64)
)
_TmnxMcRedNatGrpTable_Object = MibTable
tmnxMcRedNatGrpTable = _TmnxMcRedNatGrpTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 64, 1)
)
if mibBuilder.loadTexts:
    tmnxMcRedNatGrpTable.setStatus("current")
_TmnxMcRedNatGrpEntry_Object = MibTableRow
tmnxMcRedNatGrpEntry = _TmnxMcRedNatGrpEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 64, 1, 1)
)
tmnxMcRedNatGrpEntry.setIndexNames(
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerIpType"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerIpAddr"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedNatGrpId"),
)
if mibBuilder.loadTexts:
    tmnxMcRedNatGrpEntry.setStatus("current")
_TmnxMcRedNatGrpId_Type = TmnxNatIsaGrpId
_TmnxMcRedNatGrpId_Object = MibTableColumn
tmnxMcRedNatGrpId = _TmnxMcRedNatGrpId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 64, 1, 1, 1),
    _TmnxMcRedNatGrpId_Type()
)
tmnxMcRedNatGrpId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    tmnxMcRedNatGrpId.setStatus("current")
_TmnxMcRedNatGrpLastCh_Type = TimeStamp
_TmnxMcRedNatGrpLastCh_Object = MibTableColumn
tmnxMcRedNatGrpLastCh = _TmnxMcRedNatGrpLastCh_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 64, 1, 1, 2),
    _TmnxMcRedNatGrpLastCh_Type()
)
tmnxMcRedNatGrpLastCh.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcRedNatGrpLastCh.setStatus("current")
_TmnxMcRedNatGrpRowStatus_Type = RowStatus
_TmnxMcRedNatGrpRowStatus_Object = MibTableColumn
tmnxMcRedNatGrpRowStatus = _TmnxMcRedNatGrpRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 64, 1, 1, 3),
    _TmnxMcRedNatGrpRowStatus_Type()
)
tmnxMcRedNatGrpRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcRedNatGrpRowStatus.setStatus("current")


class _TmnxMcRedNatGrpSyncTag_Type(TNamedItemOrEmpty):
    """Custom type tmnxMcRedNatGrpSyncTag based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxMcRedNatGrpSyncTag_Type.__name__ = "TNamedItemOrEmpty"
_TmnxMcRedNatGrpSyncTag_Object = MibTableColumn
tmnxMcRedNatGrpSyncTag = _TmnxMcRedNatGrpSyncTag_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 64, 1, 1, 11),
    _TmnxMcRedNatGrpSyncTag_Type()
)
tmnxMcRedNatGrpSyncTag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcRedNatGrpSyncTag.setStatus("current")
_TmnxMcDiamNdTable_Object = MibTable
tmnxMcDiamNdTable = _TmnxMcDiamNdTable_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 67)
)
if mibBuilder.loadTexts:
    tmnxMcDiamNdTable.setStatus("current")
_TmnxMcDiamNdEntry_Object = MibTableRow
tmnxMcDiamNdEntry = _TmnxMcDiamNdEntry_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 67, 1)
)
tmnxMcDiamNdEntry.setIndexNames(
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerIpType"),
    (0, "TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerIpAddr"),
    (0, "TIMETRA-DIAMETER-MIB", "tmnxDiamNodeOriginHost"),
)
if mibBuilder.loadTexts:
    tmnxMcDiamNdEntry.setStatus("current")
_TmnxMcDiamNdRowStatus_Type = RowStatus
_TmnxMcDiamNdRowStatus_Object = MibTableColumn
tmnxMcDiamNdRowStatus = _TmnxMcDiamNdRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 67, 1, 2),
    _TmnxMcDiamNdRowStatus_Type()
)
tmnxMcDiamNdRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcDiamNdRowStatus.setStatus("current")
_TmnxMcDiamNdLastChanged_Type = TimeStamp
_TmnxMcDiamNdLastChanged_Object = MibTableColumn
tmnxMcDiamNdLastChanged = _TmnxMcDiamNdLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 67, 1, 3),
    _TmnxMcDiamNdLastChanged_Type()
)
tmnxMcDiamNdLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcDiamNdLastChanged.setStatus("current")


class _TmnxMcDiamNdSyncTag_Type(TNamedItemOrEmpty):
    """Custom type tmnxMcDiamNdSyncTag based on TNamedItemOrEmpty"""
    defaultHexValue = ""


_TmnxMcDiamNdSyncTag_Type.__name__ = "TNamedItemOrEmpty"
_TmnxMcDiamNdSyncTag_Object = MibTableColumn
tmnxMcDiamNdSyncTag = _TmnxMcDiamNdSyncTag_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 67, 1, 4),
    _TmnxMcDiamNdSyncTag_Type()
)
tmnxMcDiamNdSyncTag.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    tmnxMcDiamNdSyncTag.setStatus("current")
_TmnxMcDiamNdTableLastChanged_Type = TimeStamp
_TmnxMcDiamNdTableLastChanged_Object = MibScalar
tmnxMcDiamNdTableLastChanged = _TmnxMcDiamNdTableLastChanged_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 1, 68),
    _TmnxMcDiamNdTableLastChanged_Type()
)
tmnxMcDiamNdTableLastChanged.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmnxMcDiamNdTableLastChanged.setStatus("current")
...
_TMcPeerIPsecTnlGrpMasterStateChR_Type = DisplayString
_TMcPeerIPsecTnlGrpMasterStateChR_Object = MibScalar
tMcPeerIPsecTnlGrpMasterStateChR = _TMcPeerIPsecTnlGrpMasterStateChR_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 3, 18),
    _TMcPeerIPsecTnlGrpMasterStateChR_Type()
)
tMcPeerIPsecTnlGrpMasterStateChR.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tMcPeerIPsecTnlGrpMasterStateChR.setStatus("current")
_TmnxMcNotifyServiceId_Type = TmnxServId
_TmnxMcNotifyServiceId_Object = MibScalar
tmnxMcNotifyServiceId = _TmnxMcNotifyServiceId_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 3, 19),
    _TmnxMcNotifyServiceId_Type()
)
tmnxMcNotifyServiceId.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxMcNotifyServiceId.setStatus("current")
_TmnxMcNotifyTruthValue_Type = TruthValue
_TmnxMcNotifyTruthValue_Object = MibScalar
tmnxMcNotifyTruthValue = _TmnxMcNotifyTruthValue_Object(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 2, 40, 3, 20),
    _TmnxMcNotifyTruthValue_Type()
)
tmnxMcNotifyTruthValue.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    tmnxMcNotifyTruthValue.setStatus("current")
...
if mibBuilder.loadTexts:
    tmnxMcPeerMobileKeepAlvIntvl.setUnits("deciseconds")
...
tmnxMcRingV6v0Group.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncMcRing"),
        ...
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRingNodeRncvEncapType"),
...
if mibBuilder.loadTexts:
    tmnxSrrpV6v1Group.setStatus("obsolete")
...
tmnxMcWarmStandbyGroup.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerWarmStandby"),
        ...
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainTableLastCh"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainLastMgmtChange"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainDescription"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainHoldDownTime"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainState"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpOperDomain"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpOperDomainColor"))
)
if mibBuilder.loadTexts:
    tmnxMcWarmStandbyGroup.setStatus("obsolete")
...
tmnxMcRedundancyV13v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 2, 27)
)
tmnxMcRedundancyV13v0Group.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncL2tp"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncDiameterProxy"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcL2tpRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcL2tpLastChanged"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcL2tpPeerIpAddrType"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcL2tpPeerIpAddr"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcL2tpSyncTag"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcL2tpTableLastChanged"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcTrkSrrpRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcTrkSrrpLastCh"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcTrkSrrpL2tpTuStart"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcTrkSrrpL2tpTuEnd"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcTrkSrrpTableLastChanged"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamPrxRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamPrxLastChanged"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamPrxPeerIpAddrType"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamPrxPeerIpAddr"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamPrxSyncTag"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamPrxTableLastChanged"))
)
if mibBuilder.loadTexts:
    tmnxMcRedundancyV13v0Group.setStatus("current")

tmnxMcRedBgpEvpnGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 2, 28)
)
tmnxMcRedBgpEvpnGroup.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedBgpEvpnMHBootTimer"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedBgpEvpnMHEsActTimer"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedBgpEvpnMHBootTimerRem"))
)
if mibBuilder.loadTexts:
    tmnxMcRedBgpEvpnGroup.setStatus("current")
...
tmnxMcRedundancyV14v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 2, 30)
)
tmnxMcRedundancyV14v0Group.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncPimSnpgSap"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncPimSnpgSdp"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncSdpRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncSdpSyncTag"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncSdpVcIdRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncSdpVcIdSyncTag"))
)
if mibBuilder.loadTexts:
    tmnxMcRedundancyV14v0Group.setStatus("current")

tmnxMcRedundancyV16v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 2, 31)
)
tmnxMcRedundancyV16v0Group.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRingInbCtrlIfServiceName"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRingNodeRncvSapServiceName"))
)
if mibBuilder.loadTexts:
    tmnxMcRedundancyV16v0Group.setStatus("current")

tmnxSrrpPolicySvcNameGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 2, 32)
)
tmnxSrrpPolicySvcNameGroup.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcName"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcSvcId"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcIfName"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcDestIpType"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcDestIp"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcLastChgd"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcSrcIpType"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcSrcIp"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcSessOperState"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcName"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tSrrpAssoBfdIntfSvcTblLastChgd"))
)
if mibBuilder.loadTexts:
    tmnxSrrpPolicySvcNameGroup.setStatus("current")

tmnxMcWarmStandbyV19v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 2, 33)
)
tmnxMcWarmStandbyV19v0Group.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerWarmStandby"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerRemoteWarmStandby"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrStatFailed"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrStatFailure"),
...
if mibBuilder.loadTexts:
    tmnxMcWarmStandbyV19v0Group.setStatus("current")

tmnxMcRedundancyV19v0Group = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 2, 34)
)
tmnxMcRedundancyV19v0Group.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedNatGrpTableLastChanged"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedNatGrpLastCh"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedNatGrpRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedNatGrpSyncTag"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncDiameterNode"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcPeerSyncNat"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamNdRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamNdLastChanged"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamNdSyncTag"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcDiamNdTableLastChanged"))
)
if mibBuilder.loadTexts:
    tmnxMcRedundancyV19v0Group.setStatus("current")
...
tmnxMcNotifyObjsGroup.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcNotifyNumber"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tMcPeerIPsecTnlGrpMasterStateChR"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcNotifyTruthValue"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcNotifyServiceId"))
)
if mibBuilder.loadTexts:
    tmnxMcNotifyObjsGroup.setStatus("current")

tmnxMcObsoletedObjsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 2, 100)
)
tmnxMcObsoletedObjsGroup.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainTableLastCh"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainLastMgmtChange"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcOmcrDomainDescription"),
...
if mibBuilder.loadTexts:
    tmnxMcObsoletedObjsGroup.setStatus("current")

tmnxSrrpBfdObsoletedGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 2, 101)
)
tmnxSrrpBfdObsoletedGroup.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpAssoBfdIntfTblLastChgd"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpAssoBfdIntfRowStatus"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpAssoBfdIntfLastChanged"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpAssoBfdIntfSrcIpType"),
...
if mibBuilder.loadTexts:
    tmnxSrrpBfdObsoletedGroup.setStatus("current")
...
tmnxSrrpPrivRetailMismatch = NotificationType(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 3, 40, 0, 41)
)
tmnxSrrpPrivRetailMismatch.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpOperFlags"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcNotifyServiceId"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcNotifyTruthValue"))
)
if mibBuilder.loadTexts:
    tmnxSrrpPrivRetailMismatch.setStatus(
        "current"
    )
...
tmnxMcNotificationV20v0Group = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 3, 9)
)
tmnxMcNotificationV20v0Group.setObjects(
    ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpPrivRetailMismatch")
)
if mibBuilder.loadTexts:
    tmnxMcNotificationV20v0Group.setStatus(
        "current"
    )
...
tmnxMcRedV13v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 1, 25)
)
tmnxMcRedV13v0Compliance.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV9v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV10v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV12v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV13v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpV5v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpV6v1Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancySrrpNotifGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpNotifV6v1Group"),
        ...
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpV10v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpNotificationV10v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedBgpEvpnGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedBgpMHSiteGroup"))
)
if mibBuilder.loadTexts:
    tmnxMcRedV13v0Compliance.setStatus(
        "obsolete"
    )

tmnxMcRedV14v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 1, 26)
)
tmnxMcRedV14v0Compliance.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV9v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV10v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV12v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV13v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV14v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpV5v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpV6v1Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancySrrpNotifGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpNotifV6v1Group"),
...
if mibBuilder.loadTexts:
    tmnxMcRedV14v0Compliance.setStatus(
        "obsolete"
    )

tmnxMcRedV16v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 1, 27)
)
tmnxMcRedV16v0Compliance.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV9v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV10v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV12v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV13v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV14v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV16v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpV5v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpV6v1Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancySrrpNotifGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpNotifV6v1Group"),
        ...
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedBgpEvpnGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedBgpMHSiteGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpPolicySvcNameGroup"))
)
if mibBuilder.loadTexts:
    tmnxMcRedV16v0Compliance.setStatus(
        "obsolete"
    )

tmnxMcRedV19v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 1, 28)
)
tmnxMcRedV19v0Compliance.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV9v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV10v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV12v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV13v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV14v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV16v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV19v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpV5v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancySrrpNotifGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpNotifV6v1Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRingV6v0Group"),
        ...
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedBgpMHSiteGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxSrrpPolicySvcNameGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcWarmStandbyV19v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcObsoletedObjsGroup"))
)
if mibBuilder.loadTexts:
    tmnxMcRedV19v0Compliance.setStatus(
        "obsolete"
    )

tmnxMcRedV20v0Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 6527, 3, 1, 1, 40, 1, 29)
)
tmnxMcRedV20v0Compliance.setObjects(
      *(("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV9v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV10v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV12v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcRedundancyV13v0Group"),
        ...
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcWarmStandbyV19v0Group"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcObsoletedObjsGroup"),
        ("TIMETRA-MC-REDUNDANCY-MIB", "tmnxMcNotificationV20v0Group"))
)
if mibBuilder.loadTexts:
    tmnxMcRedV20v0Compliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TmnxMcsClientApp": TmnxMcsClientApp,
       ...
       "TMcIPsecActivityState": TMcIPsecActivityState,
       ...
       "tmnxMcRedV13v0Compliance": tmnxMcRedV13v0Compliance,
       "tmnxMcRedV14v0Compliance": tmnxMcRedV14v0Compliance,
       "tmnxMcRedV16v0Compliance": tmnxMcRedV16v0Compliance,
       "tmnxMcRedV19v0Compliance": tmnxMcRedV19v0Compliance,
       "tmnxMcRedV20v0Compliance": tmnxMcRedV20v0Compliance,
       ...
       "tmnxMcRedundancyV13v0Group": tmnxMcRedundancyV13v0Group,
       "tmnxMcRedBgpEvpnGroup": tmnxMcRedBgpEvpnGroup,
       "tmnxMcRedBgpMHSiteGroup": tmnxMcRedBgpMHSiteGroup,
       "tmnxMcRedundancyV14v0Group": tmnxMcRedundancyV14v0Group,
       "tmnxMcRedundancyV16v0Group": tmnxMcRedundancyV16v0Group,
       "tmnxSrrpPolicySvcNameGroup": tmnxSrrpPolicySvcNameGroup,
       "tmnxMcWarmStandbyV19v0Group": tmnxMcWarmStandbyV19v0Group,
       "tmnxMcRedundancyV19v0Group": tmnxMcRedundancyV19v0Group,
       "tmnxMcNotifyObjsGroup": tmnxMcNotifyObjsGroup,
       "tmnxMcObsoletedObjsGroup": tmnxMcObsoletedObjsGroup,
       "tmnxSrrpBfdObsoletedGroup": tmnxSrrpBfdObsoletedGroup,
       ...
       "tmnxMcNotificationV20v0Group": tmnxMcNotificationV20v0Group,
       ...
       "tmnxMcPeerSyncL2tp": tmnxMcPeerSyncL2tp,
       "tmnxMcPeerSyncDiameterProxy": tmnxMcPeerSyncDiameterProxy,
       "tmnxMcPeerSyncPimSnpgSap": tmnxMcPeerSyncPimSnpgSap,
       "tmnxMcPeerSyncPimSnpgSdp": tmnxMcPeerSyncPimSnpgSdp,
       "tmnxMcPeerSyncDiameterNode": tmnxMcPeerSyncDiameterNode,
       "tmnxMcPeerSyncNat": tmnxMcPeerSyncNat,
       ...
       "tmnxSrrpOperDomain": tmnxSrrpOperDomain,
       "tmnxSrrpOperDomainColor": tmnxSrrpOperDomainColor,
       ...
       "tmnxMcRingType": tmnxMcRingType,
       "tmnxMcRingInbCtrlIfServiceName": tmnxMcRingInbCtrlIfServiceName,
       ...
       "tmnxMcRingNodeRncvSapServiceName": tmnxMcRingNodeRncvSapServiceName,
       "tmnxMcRingNodeRncvEncapType": tmnxMcRingNodeRncvEncapType,
       ...
       "tmnxMcOmcrDomainTable": tmnxMcOmcrDomainTable,
       "tmnxMcOmcrDomainEntry": tmnxMcOmcrDomainEntry,
       "tmnxMcOmcrDomainName": tmnxMcOmcrDomainName,
       "tmnxMcOmcrDomainLastMgmtChange": tmnxMcOmcrDomainLastMgmtChange,
       "tmnxMcOmcrDomainRowStatus": tmnxMcOmcrDomainRowStatus,
       "tmnxMcOmcrDomainDescription": tmnxMcOmcrDomainDescription,
       "tmnxMcOmcrDomainHoldDownTime": tmnxMcOmcrDomainHoldDownTime,
       "tmnxMcOmcrDomainState": tmnxMcOmcrDomainState,
       ...
       "tmnxMcOmcrDomainTableLastCh": tmnxMcOmcrDomainTableLastCh,
       ...
       "tmnxMcL2tpTable": tmnxMcL2tpTable,
       "tmnxMcL2tpEntry": tmnxMcL2tpEntry,
       "tmnxMcL2tpRowStatus": tmnxMcL2tpRowStatus,
       "tmnxMcL2tpLastChanged": tmnxMcL2tpLastChanged,
       "tmnxMcL2tpPeerIpAddrType": tmnxMcL2tpPeerIpAddrType,
       "tmnxMcL2tpPeerIpAddr": tmnxMcL2tpPeerIpAddr,
       "tmnxMcL2tpSyncTag": tmnxMcL2tpSyncTag,
       "tmnxMcL2tpTableLastChanged": tmnxMcL2tpTableLastChanged,
       "tmnxMcTrkSrrpTable": tmnxMcTrkSrrpTable,
       "tmnxMcTrkSrrpEntry": tmnxMcTrkSrrpEntry,
       "tmnxMcTrkSrrpPeerAddrType": tmnxMcTrkSrrpPeerAddrType,
       "tmnxMcTrkSrrpPeerAddr": tmnxMcTrkSrrpPeerAddr,
       "tmnxMcTrkSrrpId": tmnxMcTrkSrrpId,
       "tmnxMcTrkSrrpRowStatus": tmnxMcTrkSrrpRowStatus,
       "tmnxMcTrkSrrpLastCh": tmnxMcTrkSrrpLastCh,
       "tmnxMcTrkSrrpL2tpTuStart": tmnxMcTrkSrrpL2tpTuStart,
       "tmnxMcTrkSrrpL2tpTuEnd": tmnxMcTrkSrrpL2tpTuEnd,
       "tmnxMcTrkSrrpTableLastChanged": tmnxMcTrkSrrpTableLastChanged,
       "tmnxMcDiamPrxTable": tmnxMcDiamPrxTable,
       "tmnxMcDiamPrxEntry": tmnxMcDiamPrxEntry,
       "tmnxMcDiamPrxRowStatus": tmnxMcDiamPrxRowStatus,
       "tmnxMcDiamPrxLastChanged": tmnxMcDiamPrxLastChanged,
       "tmnxMcDiamPrxPeerIpAddrType": tmnxMcDiamPrxPeerIpAddrType,
       "tmnxMcDiamPrxPeerIpAddr": tmnxMcDiamPrxPeerIpAddr,
       "tmnxMcDiamPrxSyncTag": tmnxMcDiamPrxSyncTag,
       "tmnxMcDiamPrxTableLastChanged": tmnxMcDiamPrxTableLastChanged,
       "tmnxMcRedBgpEvpnMHObjs": tmnxMcRedBgpEvpnMHObjs,
       "tmnxMcRedBgpEvpnMHBootTimer": tmnxMcRedBgpEvpnMHBootTimer,
       "tmnxMcRedBgpEvpnMHEsActTimer": tmnxMcRedBgpEvpnMHEsActTimer,
       "tmnxMcRedBgpEvpnMHBootTimerRem": tmnxMcRedBgpEvpnMHBootTimerRem,
       "tmnxMcPeerSyncSdpTable": tmnxMcPeerSyncSdpTable,
       "tmnxMcPeerSyncSdpEntry": tmnxMcPeerSyncSdpEntry,
       "tmnxMcPeerSyncSdpId": tmnxMcPeerSyncSdpId,
       "tmnxMcPeerSyncSdpRowStatus": tmnxMcPeerSyncSdpRowStatus,
       "tmnxMcPeerSyncSdpSyncTag": tmnxMcPeerSyncSdpSyncTag,
       "tmnxMcPeerSyncSdpVcIdRangeTable": tmnxMcPeerSyncSdpVcIdRangeTable,
       "tmnxMcPeerSyncSdpVcIdRangeEntry": tmnxMcPeerSyncSdpVcIdRangeEntry,
       "tmnxMcPeerSyncSdpVcIdMin": tmnxMcPeerSyncSdpVcIdMin,
       "tmnxMcPeerSyncSdpVcIdMax": tmnxMcPeerSyncSdpVcIdMax,
       "tmnxMcPeerSyncSdpVcIdRowStatus": tmnxMcPeerSyncSdpVcIdRowStatus,
       "tmnxMcPeerSyncSdpVcIdSyncTag": tmnxMcPeerSyncSdpVcIdSyncTag,
       "tSrrpAssoBfdIntfSvcTblLastChgd": tSrrpAssoBfdIntfSvcTblLastChgd,
       "tSrrpAssoBfdIntfSvcTable": tSrrpAssoBfdIntfSvcTable,
       "tSrrpAssoBfdIntfSvcEntry": tSrrpAssoBfdIntfSvcEntry,
       "tSrrpAssoBfdIntfSvcSvcId": tSrrpAssoBfdIntfSvcSvcId,
       "tSrrpAssoBfdIntfSvcIfName": tSrrpAssoBfdIntfSvcIfName,
       "tSrrpAssoBfdIntfSvcDestIpType": tSrrpAssoBfdIntfSvcDestIpType,
       "tSrrpAssoBfdIntfSvcDestIp": tSrrpAssoBfdIntfSvcDestIp,
       "tSrrpAssoBfdIntfSvcRowStatus": tSrrpAssoBfdIntfSvcRowStatus,
       "tSrrpAssoBfdIntfSvcLastChgd": tSrrpAssoBfdIntfSvcLastChgd,
       "tSrrpAssoBfdIntfSvcSrcIpType": tSrrpAssoBfdIntfSvcSrcIpType,
       "tSrrpAssoBfdIntfSvcSrcIp": tSrrpAssoBfdIntfSvcSrcIp,
       "tSrrpAssoBfdIntfSvcSessOperState": tSrrpAssoBfdIntfSvcSessOperState,
       "tSrrpAssoBfdIntfSvcName": tSrrpAssoBfdIntfSvcName,
       "tmnxMcRedNatGrpTableLastChanged": tmnxMcRedNatGrpTableLastChanged,
       "tmnxMcRedNatObjs": tmnxMcRedNatObjs,
       "tmnxMcRedNatGrpTable": tmnxMcRedNatGrpTable,
       "tmnxMcRedNatGrpEntry": tmnxMcRedNatGrpEntry,
       "tmnxMcRedNatGrpId": tmnxMcRedNatGrpId,
       "tmnxMcRedNatGrpLastCh": tmnxMcRedNatGrpLastCh,
       "tmnxMcRedNatGrpRowStatus": tmnxMcRedNatGrpRowStatus,
       "tmnxMcRedNatGrpSyncTag": tmnxMcRedNatGrpSyncTag,
       "tmnxMcDiamNdTable": tmnxMcDiamNdTable,
       "tmnxMcDiamNdEntry": tmnxMcDiamNdEntry,
       "tmnxMcDiamNdRowStatus": tmnxMcDiamNdRowStatus,
       "tmnxMcDiamNdLastChanged": tmnxMcDiamNdLastChanged,
       "tmnxMcDiamNdSyncTag": tmnxMcDiamNdSyncTag,
       ...
       "tMcPeerIPsecTnlGrpMasterStateChR": tMcPeerIPsecTnlGrpMasterStateChR,
       "tmnxMcNotifyServiceId": tmnxMcNotifyServiceId,
       "tmnxMcNotifyTruthValue": tmnxMcNotifyTruthValue,
       ...
       "tmnxSrrpPrivRetailMismatch": tmnxSrrpPrivRetailMismatch,
