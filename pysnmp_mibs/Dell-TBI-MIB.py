# SNMP MIB module (Dell-TBI-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/dell/Dell-TBI-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 21:10:13 2025
...
rlTBITimeRangeEntry.setIndexNames(
    (1, "Dell-TBI-MIB", "rlTBITimeRangeName"),
)
if mibBuilder.loadTexts:
...
rlTBIPeriodicEntry.setIndexNames(
    (0, "Dell-TBI-MIB", "rlTBIPeriodicTimeRangeName"),
    (0, "Dell-TBI-MIB", "rlTBIPeriodicWeekDayList"),
    (0, "Dell-TBI-MIB", "rlTBIPeriodicStart"),
    (0, "Dell-TBI-MIB", "rlTBIPeriodicEnd"),
)
if mibBuilder.loadTexts:
