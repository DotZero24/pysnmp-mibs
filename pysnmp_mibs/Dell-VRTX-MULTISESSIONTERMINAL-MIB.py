...
mibBuilder.exportSymbols('Dell-VRTX-MULTISESSIONTERMINAL-MIB',**{'rlMultiSessionTerminal':rlMultiSessionTerminal,'rlTerminalDebugModePassword':rlTerminalDebugModePassword})