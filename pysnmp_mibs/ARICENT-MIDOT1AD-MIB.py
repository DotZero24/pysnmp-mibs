...
dot1adMIProviderBridge=_Dot1adMIProviderBridge_ObjectIdentity((1,3,6,1,4,1,2076,133,1))
_Dot1adMIPortTable_Object=MibTable
dot1adMIPortTable=_Dot1adMIPortTable_Object((1,3,6,1,4,1,2076,133,1,1))
if mibBuilder.loadTexts:dot1adMIPortTable.setStatus(_A)
_Dot1adMIPortEntry_Object=MibTableRow
dot1adMIPortEntry=_Dot1adMIPortEntry_Object((1,3,6,1,4,1,2076,133,1,1,1))
dot1adMIPortEntry.setIndexNames((0,_C,_F))
...
dot1adMIPortNum=_Dot1adMIPortNum_Object((1,3,6,1,4,1,2076,133,1,1,1,1),_Dot1adMIPortNum_Type())
...
dot1adMIPortPcpSelectionRow=_Dot1adMIPortPcpSelectionRow_Object((1,3,6,1,4,1,2076,133,1,1,1,2),_Dot1adMIPortPcpSelectionRow_Type())
dot1adMIPortPcpSelectionRow.setMaxAccess(_B)
...
dot1adMIPortUseDei=_Dot1adMIPortUseDei_Object((1,3,6,1,4,1,2076,133,1,1,1,3),_Dot1adMIPortUseDei_Type())
dot1adMIPortUseDei.setMaxAccess(_B)
...
dot1adMIPortReqDropEncoding=_Dot1adMIPortReqDropEncoding_Object((1,3,6,1,4,1,2076,133,1,1,1,4),_Dot1adMIPortReqDropEncoding_Type())
dot1adMIPortReqDropEncoding.setMaxAccess(_B)
if mibBuilder.loadTexts:dot1adMIPortReqDropEncoding.setStatus(_A)
class _Dot1adMIPortSVlanPriorityType_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*(('none',0),('fixed',1),('copy',2)))
_Dot1adMIPortSVlanPriorityType_Type.__name__=_D
_Dot1adMIPortSVlanPriorityType_Object=MibTableColumn
dot1adMIPortSVlanPriorityType=_Dot1adMIPortSVlanPriorityType_Object((1,3,6,1,4,1,2076,133,1,1,1,5),_Dot1adMIPortSVlanPriorityType_Type())
dot1adMIPortSVlanPriorityType.setMaxAccess(_B)
if mibBuilder.loadTexts:dot1adMIPortSVlanPriorityType.setStatus(_A)
class _Dot1adMIPortSVlanPriority_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,7))
_Dot1adMIPortSVlanPriority_Type.__name__=_D
_Dot1adMIPortSVlanPriority_Object=MibTableColumn
dot1adMIPortSVlanPriority=_Dot1adMIPortSVlanPriority_Object((1,3,6,1,4,1,2076,133,1,1,1,6),_Dot1adMIPortSVlanPriority_Type())
dot1adMIPortSVlanPriority.setMaxAccess(_B)
if mibBuilder.loadTexts:dot1adMIPortSVlanPriority.setStatus(_A)
_Dot1adMIVidTranslationTable_Object=MibTable
dot1adMIVidTranslationTable=_Dot1adMIVidTranslationTable_Object((1,3,6,1,4,1,2076,133,1,2))
if mibBuilder.loadTexts:dot1adMIVidTranslationTable.setStatus(_A)
_Dot1adMIVidTranslationEntry_Object=MibTableRow
dot1adMIVidTranslationEntry=_Dot1adMIVidTranslationEntry_Object((1,3,6,1,4,1,2076,133,1,2,1))
dot1adMIVidTranslationEntry.setIndexNames((0,_C,_F),(0,_C,_J))
...
dot1adMIVidTranslationLocalVid=_Dot1adMIVidTranslationLocalVid_Object((1,3,6,1,4,1,2076,133,1,2,1,1),_Dot1adMIVidTranslationLocalVid_Type())
...
dot1adMIVidTranslationRelayVid=_Dot1adMIVidTranslationRelayVid_Object((1,3,6,1,4,1,2076,133,1,2,1,2),_Dot1adMIVidTranslationRelayVid_Type())
dot1adMIVidTranslationRelayVid.setMaxAccess(_B)
...
dot1adMIVidTranslationRowStatus=_Dot1adMIVidTranslationRowStatus_Object((1,3,6,1,4,1,2076,133,1,2,1,3),_Dot1adMIVidTranslationRowStatus_Type())
...
dot1adMICVidRegistrationTable=_Dot1adMICVidRegistrationTable_Object((1,3,6,1,4,1,2076,133,1,3))
if mibBuilder.loadTexts:dot1adMICVidRegistrationTable.setStatus(_A)
_Dot1adMICVidRegistrationEntry_Object=MibTableRow
dot1adMICVidRegistrationEntry=_Dot1adMICVidRegistrationEntry_Object((1,3,6,1,4,1,2076,133,1,3,1))
dot1adMICVidRegistrationEntry.setIndexNames((0,_C,_F),(0,_C,_L))
...
dot1adMICVidRegistrationCVid=_Dot1adMICVidRegistrationCVid_Object((1,3,6,1,4,1,2076,133,1,3,1,1),_Dot1adMICVidRegistrationCVid_Type())
...
dot1adMICVidRegistrationSVid=_Dot1adMICVidRegistrationSVid_Object((1,3,6,1,4,1,2076,133,1,3,1,2),_Dot1adMICVidRegistrationSVid_Type())
dot1adMICVidRegistrationSVid.setMaxAccess(_B)
...
dot1adMICVidRegistrationUntaggedPep=_Dot1adMICVidRegistrationUntaggedPep_Object((1,3,6,1,4,1,2076,133,1,3,1,3),_Dot1adMICVidRegistrationUntaggedPep_Type())
dot1adMICVidRegistrationUntaggedPep.setMaxAccess(_B)
...
dot1adMICVidRegistrationUntaggedCep=_Dot1adMICVidRegistrationUntaggedCep_Object((1,3,6,1,4,1,2076,133,1,3,1,4),_Dot1adMICVidRegistrationUntaggedCep_Type())
dot1adMICVidRegistrationUntaggedCep.setMaxAccess(_B)
...
dot1adMICVidRegistrationRowStatus=_Dot1adMICVidRegistrationRowStatus_Object((1,3,6,1,4,1,2076,133,1,3,1,5),_Dot1adMICVidRegistrationRowStatus_Type())
dot1adMICVidRegistrationRowStatus.setMaxAccess(_K)
if mibBuilder.loadTexts:dot1adMICVidRegistrationRowStatus.setStatus(_A)
class _Dot1adMICVidRegistrationSVlanPriorityType_Type(Integer32):defaultValue=1;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(SingleValueConstraint(*(0,1,2)));namedValues=NamedValues(*(('none',0),('fixed',1),('copy',2)))
_Dot1adMICVidRegistrationSVlanPriorityType_Type.__name__=_D
_Dot1adMICVidRegistrationSVlanPriorityType_Object=MibTableColumn
dot1adMICVidRegistrationSVlanPriorityType=_Dot1adMICVidRegistrationSVlanPriorityType_Object((1,3,6,1,4,1,2076,133,1,3,1,6),_Dot1adMICVidRegistrationSVlanPriorityType_Type())
dot1adMICVidRegistrationSVlanPriorityType.setMaxAccess(_B)
if mibBuilder.loadTexts:dot1adMICVidRegistrationSVlanPriorityType.setStatus(_A)
class _Dot1adMICVidRegistrationSVlanPriority_Type(Integer32):defaultValue=0;subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(0,7))
_Dot1adMICVidRegistrationSVlanPriority_Type.__name__=_D
_Dot1adMICVidRegistrationSVlanPriority_Object=MibTableColumn
dot1adMICVidRegistrationSVlanPriority=_Dot1adMICVidRegistrationSVlanPriority_Object((1,3,6,1,4,1,2076,133,1,3,1,7),_Dot1adMICVidRegistrationSVlanPriority_Type())
dot1adMICVidRegistrationSVlanPriority.setMaxAccess(_B)
if mibBuilder.loadTexts:dot1adMICVidRegistrationSVlanPriority.setStatus(_A)
_Dot1adMIPepTable_Object=MibTable
dot1adMIPepTable=_Dot1adMIPepTable_Object((1,3,6,1,4,1,2076,133,1,4))
if mibBuilder.loadTexts:dot1adMIPepTable.setStatus(_A)
_Dot1adMIPepEntry_Object=MibTableRow
dot1adMIPepEntry=_Dot1adMIPepEntry_Object((1,3,6,1,4,1,2076,133,1,4,1))
dot1adMIPepEntry.setIndexNames((0,_C,_F),(0,_C,_H))
if mibBuilder.loadTexts:dot1adMIPepEntry.setStatus(_A)
_Dot1adMIPepPvid_Type=VlanId
_Dot1adMIPepPvid_Object=MibTableColumn
dot1adMIPepPvid=_Dot1adMIPepPvid_Object((1,3,6,1,4,1,2076,133,1,4,1,1),_Dot1adMIPepPvid_Type())
dot1adMIPepPvid.setMaxAccess(_B)
...
dot1adMIPepDefaultUserPriority=_Dot1adMIPepDefaultUserPriority_Object((1,3,6,1,4,1,2076,133,1,4,1,2),_Dot1adMIPepDefaultUserPriority_Type())
dot1adMIPepDefaultUserPriority.setMaxAccess(_B)
...
dot1adMIPepAccptableFrameTypes=_Dot1adMIPepAccptableFrameTypes_Object((1,3,6,1,4,1,2076,133,1,4,1,3),_Dot1adMIPepAccptableFrameTypes_Type())
dot1adMIPepAccptableFrameTypes.setMaxAccess(_B)
...
dot1adMIPepIngressFiltering=_Dot1adMIPepIngressFiltering_Object((1,3,6,1,4,1,2076,133,1,4,1,4),_Dot1adMIPepIngressFiltering_Type())
dot1adMIPepIngressFiltering.setMaxAccess(_B)
...
dot1adMIServicePriorityRegenerationTable=_Dot1adMIServicePriorityRegenerationTable_Object((1,3,6,1,4,1,2076,133,1,5))
...
dot1adMIServicePriorityRegenerationEntry=_Dot1adMIServicePriorityRegenerationEntry_Object((1,3,6,1,4,1,2076,133,1,5,1))
dot1adMIServicePriorityRegenerationEntry.setIndexNames((0,_C,_F),(0,_C,_H),(0,_C,_M))
...
dot1adMIServicePriorityRegenReceivedPriority=_Dot1adMIServicePriorityRegenReceivedPriority_Object((1,3,6,1,4,1,2076,133,1,5,1,1),_Dot1adMIServicePriorityRegenReceivedPriority_Type())
...
dot1adMIServicePriorityRegenRegeneratedPriority=_Dot1adMIServicePriorityRegenRegeneratedPriority_Object((1,3,6,1,4,1,2076,133,1,5,1,2),_Dot1adMIServicePriorityRegenRegeneratedPriority_Type())
dot1adMIServicePriorityRegenRegeneratedPriority.setMaxAccess(_B)
...
dot1adMIPcpDecodingTable=_Dot1adMIPcpDecodingTable_Object((1,3,6,1,4,1,2076,133,1,6))
if mibBuilder.loadTexts:dot1adMIPcpDecodingTable.setStatus(_A)
_Dot1adMIPcpDecodingEntry_Object=MibTableRow
dot1adMIPcpDecodingEntry=_Dot1adMIPcpDecodingEntry_Object((1,3,6,1,4,1,2076,133,1,6,1))
dot1adMIPcpDecodingEntry.setIndexNames((0,_C,_F),(0,_C,_N),(0,_C,_O))
...
dot1adMIPcpDecodingPcpSelRow=_Dot1adMIPcpDecodingPcpSelRow_Object((1,3,6,1,4,1,2076,133,1,6,1,1),_Dot1adMIPcpDecodingPcpSelRow_Type())
...
dot1adMIPcpDecodingPcpValue=_Dot1adMIPcpDecodingPcpValue_Object((1,3,6,1,4,1,2076,133,1,6,1,2),_Dot1adMIPcpDecodingPcpValue_Type())
...
dot1adMIPcpDecodingPriority=_Dot1adMIPcpDecodingPriority_Object((1,3,6,1,4,1,2076,133,1,6,1,3),_Dot1adMIPcpDecodingPriority_Type())
dot1adMIPcpDecodingPriority.setMaxAccess(_B)
...
dot1adMIPcpDecodingDropEligible=_Dot1adMIPcpDecodingDropEligible_Object((1,3,6,1,4,1,2076,133,1,6,1,4),_Dot1adMIPcpDecodingDropEligible_Type())
dot1adMIPcpDecodingDropEligible.setMaxAccess(_B)
if mibBuilder.loadTexts:dot1adMIPcpDecodingDropEligible.setStatus(_A)
_Dot1adMIPcpEncodingTable_Object=MibTable
dot1adMIPcpEncodingTable=_Dot1adMIPcpEncodingTable_Object((1,3,6,1,4,1,2076,133,1,7))
if mibBuilder.loadTexts:dot1adMIPcpEncodingTable.setStatus(_A)
_Dot1adMIPcpEncodingEntry_Object=MibTableRow
dot1adMIPcpEncodingEntry=_Dot1adMIPcpEncodingEntry_Object((1,3,6,1,4,1,2076,133,1,7,1))
dot1adMIPcpEncodingEntry.setIndexNames((0,_C,_F),(0,_C,_P),(0,_C,_Q),(0,_C,_R))
...
dot1adMIPcpEncodingPcpSelRow=_Dot1adMIPcpEncodingPcpSelRow_Object((1,3,6,1,4,1,2076,133,1,7,1,1),_Dot1adMIPcpEncodingPcpSelRow_Type())
...
dot1adMIPcpEncodingPriority=_Dot1adMIPcpEncodingPriority_Object((1,3,6,1,4,1,2076,133,1,7,1,2),_Dot1adMIPcpEncodingPriority_Type())
...
dot1adMIPcpEncodingDropEligible=_Dot1adMIPcpEncodingDropEligible_Object((1,3,6,1,4,1,2076,133,1,7,1,3),_Dot1adMIPcpEncodingDropEligible_Type())
