...
_A3='vplsConfigStorageType'
_A2='vplsConfigServiceType'
_A1='vplsConfigMtu'
...
_R='StorageType'
_Q='SnmpAdminString'
_P='vplsConfigFwdFullLowWatermark'
_O='vplsConfigFwdFullHighWatermark'
_N='fsL2VpnPwRedGroupIndex'
_M='vplsConfigVpnId'
_L='Bits'
_K='OctetString'
_J='vplsConfigIndex'
...
DisplayString,PhysAddress,RowStatus,StorageType,TextualConvention,TruthValue=mibBuilder.importSymbols('SNMPv2-TC',_b,'PhysAddress','RowStatus',_R,'TextualConvention',_I)
...
vplsNotifications=_VplsNotifications_ObjectIdentity((1,3,6,1,4,1,10876,101,2,72,0))
_VplsObjects_ObjectIdentity=ObjectIdentity
vplsObjects=_VplsObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,2,72,1))
_VplsConfigIndexNext_Type=Unsigned32
_VplsConfigIndexNext_Object=MibScalar
vplsConfigIndexNext=_VplsConfigIndexNext_Object((1,3,6,1,4,1,10876,101,2,72,1,1),_VplsConfigIndexNext_Type())
...
vplsConfigTable=_VplsConfigTable_Object((1,3,6,1,4,1,10876,101,2,72,1,2))
if mibBuilder.loadTexts:vplsConfigTable.setStatus(_A)
_VplsConfigEntry_Object=MibTableRow
vplsConfigEntry=_VplsConfigEntry_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1))
...
vplsConfigIndex=_VplsConfigIndex_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,1),_VplsConfigIndex_Type())
...
_VplsConfigName_Type.__name__=_Q
_VplsConfigName_Object=MibTableColumn
vplsConfigName=_VplsConfigName_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,2),_VplsConfigName_Type())
...
_VplsConfigDescr_Type.__name__=_Q
_VplsConfigDescr_Object=MibTableColumn
vplsConfigDescr=_VplsConfigDescr_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,3),_VplsConfigDescr_Type())
...
vplsConfigAdminStatus=_VplsConfigAdminStatus_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,4),_VplsConfigAdminStatus_Type())
...
vplsConfigMacLearning=_VplsConfigMacLearning_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,6),_VplsConfigMacLearning_Type())
...
vplsConfigDiscardUnknownDest=_VplsConfigDiscardUnknownDest_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,7),_VplsConfigDiscardUnknownDest_Type())
...
vplsConfigMacAging=_VplsConfigMacAging_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,8),_VplsConfigMacAging_Type())
...
vplsConfigFwdFullHighWatermark=_VplsConfigFwdFullHighWatermark_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,10),_VplsConfigFwdFullHighWatermark_Type())
...
vplsConfigFwdFullLowWatermark=_VplsConfigFwdFullLowWatermark_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,11),_VplsConfigFwdFullLowWatermark_Type())
...
vplsConfigRowStatus=_VplsConfigRowStatus_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,12),_VplsConfigRowStatus_Type())
...
vplsConfigMtu=_VplsConfigMtu_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,13),_VplsConfigMtu_Type())
...
vplsConfigVpnId=_VplsConfigVpnId_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,14),_VplsConfigVpnId_Type())
...
vplsConfigServiceType=_VplsConfigServiceType_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,15),_VplsConfigServiceType_Type())
vplsConfigServiceType.setMaxAccess(_C)
if mibBuilder.loadTexts:vplsConfigServiceType.setStatus(_A)
class _VplsConfigStorageType_Type(StorageType):defaultValue=2
_VplsConfigStorageType_Type.__name__=_R
_VplsConfigStorageType_Object=MibTableColumn
vplsConfigStorageType=_VplsConfigStorageType_Object((1,3,6,1,4,1,10876,101,2,72,1,2,1,16),_VplsConfigStorageType_Type())
...
vplsStatusTable=_VplsStatusTable_Object((1,3,6,1,4,1,10876,101,2,72,1,3))
if mibBuilder.loadTexts:vplsStatusTable.setStatus(_A)
_VplsStatusEntry_Object=MibTableRow
vplsStatusEntry=_VplsStatusEntry_Object((1,3,6,1,4,1,10876,101,2,72,1,3,1))
...
vplsStatusOperStatus=_VplsStatusOperStatus_Object((1,3,6,1,4,1,10876,101,2,72,1,3,1,1),_VplsStatusOperStatus_Type())
...
vplsStatusPeerCount=_VplsStatusPeerCount_Object((1,3,6,1,4,1,10876,101,2,72,1,3,1,2),_VplsStatusPeerCount_Type())
...
vplsPwBindTable=_VplsPwBindTable_Object((1,3,6,1,4,1,10876,101,2,72,1,4))
if mibBuilder.loadTexts:vplsPwBindTable.setStatus(_A)
_VplsPwBindEntry_Object=MibTableRow
vplsPwBindEntry=_VplsPwBindEntry_Object((1,3,6,1,4,1,10876,101,2,72,1,4,1))
...
vplsPwBindConfigType=_VplsPwBindConfigType_Object((1,3,6,1,4,1,10876,101,2,72,1,4,1,1),_VplsPwBindConfigType_Type())
...
vplsPwBindType=_VplsPwBindType_Object((1,3,6,1,4,1,10876,101,2,72,1,4,1,2),_VplsPwBindType_Type())
...
vplsPwBindRowStatus=_VplsPwBindRowStatus_Object((1,3,6,1,4,1,10876,101,2,72,1,4,1,3),_VplsPwBindRowStatus_Type())
...
_VplsPwBindStorageType_Type.__name__=_R
_VplsPwBindStorageType_Object=MibTableColumn
vplsPwBindStorageType=_VplsPwBindStorageType_Object((1,3,6,1,4,1,10876,101,2,72,1,4,1,4),_VplsPwBindStorageType_Type())
...
vplsBgpADConfigTable=_VplsBgpADConfigTable_Object((1,3,6,1,4,1,10876,101,2,72,1,5))
if mibBuilder.loadTexts:vplsBgpADConfigTable.setStatus(_A)
_VplsBgpADConfigEntry_Object=MibTableRow
vplsBgpADConfigEntry=_VplsBgpADConfigEntry_Object((1,3,6,1,4,1,10876,101,2,72,1,5,1))
...
vplsBgpADConfigRouteDistinguisher=_VplsBgpADConfigRouteDistinguisher_Object((1,3,6,1,4,1,10876,101,2,72,1,5,1,1),_VplsBgpADConfigRouteDistinguisher_Type())
...
vplsBgpADConfigPrefix=_VplsBgpADConfigPrefix_Object((1,3,6,1,4,1,10876,101,2,72,1,5,1,2),_VplsBgpADConfigPrefix_Type())
...
vplsBgpADConfigVplsId=_VplsBgpADConfigVplsId_Object((1,3,6,1,4,1,10876,101,2,72,1,5,1,3),_VplsBgpADConfigVplsId_Type())
...
vplsBgpADConfigRowStatus=_VplsBgpADConfigRowStatus_Object((1,3,6,1,4,1,10876,101,2,72,1,5,1,4),_VplsBgpADConfigRowStatus_Type())
...
vplsBgpRteTargetTable=_VplsBgpRteTargetTable_Object((1,3,6,1,4,1,10876,101,2,72,1,6))
if mibBuilder.loadTexts:vplsBgpRteTargetTable.setStatus(_A)
_VplsBgpRteTargetEntry_Object=MibTableRow
vplsBgpRteTargetEntry=_VplsBgpRteTargetEntry_Object((1,3,6,1,4,1,10876,101,2,72,1,6,1))
...
vplsBgpRteTargetIndex=_VplsBgpRteTargetIndex_Object((1,3,6,1,4,1,10876,101,2,72,1,6,1,1),_VplsBgpRteTargetIndex_Type())
...
vplsBgpRteTargetRTType=_VplsBgpRteTargetRTType_Object((1,3,6,1,4,1,10876,101,2,72,1,6,1,2),_VplsBgpRteTargetRTType_Type())
...
vplsBgpRteTargetRT=_VplsBgpRteTargetRT_Object((1,3,6,1,4,1,10876,101,2,72,1,6,1,3),_VplsBgpRteTargetRT_Type())
...
vplsBgpRteTargetRTRowStatus=_VplsBgpRteTargetRTRowStatus_Object((1,3,6,1,4,1,10876,101,2,72,1,6,1,4),_VplsBgpRteTargetRTRowStatus_Type())
...
vplsStatusNotifEnable=_VplsStatusNotifEnable_Object((1,3,6,1,4,1,10876,101,2,72,1,7),_VplsStatusNotifEnable_Type())
...
vplsNotificationMaxRate=_VplsNotificationMaxRate_Object((1,3,6,1,4,1,10876,101,2,72,1,8),_VplsNotificationMaxRate_Type())
...
vplsConformance=_VplsConformance_ObjectIdentity((1,3,6,1,4,1,10876,101,2,72,2))
_VplsCompliances_ObjectIdentity=ObjectIdentity
vplsCompliances=_VplsCompliances_ObjectIdentity((1,3,6,1,4,1,10876,101,2,72,2,1))
_VplsGroups_ObjectIdentity=ObjectIdentity
vplsGroups=_VplsGroups_ObjectIdentity((1,3,6,1,4,1,10876,101,2,72,2,2))
_PwRedundancyScalar_ObjectIdentity=ObjectIdentity
pwRedundancyScalar=_PwRedundancyScalar_ObjectIdentity((1,3,6,1,4,1,10876,101,2,72,3))
...
fsL2VpnPwRedundancyStatus=_FsL2VpnPwRedundancyStatus_Object((1,3,6,1,4,1,10876,101,2,72,3,1),_FsL2VpnPwRedundancyStatus_Type())
...
fsL2VpnPwRedNegotiationTimeOut=_FsL2VpnPwRedNegotiationTimeOut_Object((1,3,6,1,4,1,10876,101,2,72,3,2),_FsL2VpnPwRedNegotiationTimeOut_Type())
...
fsL2VpnPwRedundancySyncFailNotifyEnable=_FsL2VpnPwRedundancySyncFailNotifyEnable_Object((1,3,6,1,4,1,10876,101,2,72,3,3),_FsL2VpnPwRedundancySyncFailNotifyEnable_Type())
...
fsL2VpnPwRedundancyPwStatusNotifyEnable=_FsL2VpnPwRedundancyPwStatusNotifyEnable_Object((1,3,6,1,4,1,10876,101,2,72,3,4),_FsL2VpnPwRedundancyPwStatusNotifyEnable_Type())
...
pwRedundancyObjects=_PwRedundancyObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,2,72,4))
_FsL2VpnPwRedTraps_ObjectIdentity=ObjectIdentity
fsL2VpnPwRedTraps=_FsL2VpnPwRedTraps_ObjectIdentity((1,3,6,1,4,1,10876,101,2,72,4,0))
_FsL2VpnPwRedGroupTable_Object=MibTable
fsL2VpnPwRedGroupTable=_FsL2VpnPwRedGroupTable_Object((1,3,6,1,4,1,10876,101,2,72,4,1))
if mibBuilder.loadTexts:fsL2VpnPwRedGroupTable.setStatus(_A)
_FsL2VpnPwRedGroupEntry_Object=MibTableRow
fsL2VpnPwRedGroupEntry=_FsL2VpnPwRedGroupEntry_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1))
fsL2VpnPwRedGroupEntry.setIndexNames((0,_B,_N))
...
fsL2VpnPwRedGroupIndex=_FsL2VpnPwRedGroupIndex_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,1),_FsL2VpnPwRedGroupIndex_Type())
...
fsL2VpnPwRedGroupProtType=_FsL2VpnPwRedGroupProtType_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,2),_FsL2VpnPwRedGroupProtType_Type())
...
fsL2VpnPwRedGroupReversionType=_FsL2VpnPwRedGroupReversionType_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,3),_FsL2VpnPwRedGroupReversionType_Type())
...
fsL2VpnPwRedGroupContentionResolutionMethod=_FsL2VpnPwRedGroupContentionResolutionMethod_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,4),_FsL2VpnPwRedGroupContentionResolutionMethod_Type())
...
fsL2VpnPwRedGroupMasterSlaveMode=_FsL2VpnPwRedGroupMasterSlaveMode_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,5),_FsL2VpnPwRedGroupMasterSlaveMode_Type())
...
fsL2VpnPwRedGroupDualHomeApps=_FsL2VpnPwRedGroupDualHomeApps_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,6),_FsL2VpnPwRedGroupDualHomeApps_Type())
...
fsL2VpnPwRedGroupName=_FsL2VpnPwRedGroupName_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,7),_FsL2VpnPwRedGroupName_Type())
...
fsL2VpnPwRedGroupStatus=_FsL2VpnPwRedGroupStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,8),_FsL2VpnPwRedGroupStatus_Type())
...
fsL2VpnPwRedGroupOperActivePw=_FsL2VpnPwRedGroupOperActivePw_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,9),_FsL2VpnPwRedGroupOperActivePw_Type())
...
fsL2VpnPwRedGroupWtrTimer=_FsL2VpnPwRedGroupWtrTimer_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,10),_FsL2VpnPwRedGroupWtrTimer_Type())
...
fsL2VpnPwRedGroupAdminCmd=_FsL2VpnPwRedGroupAdminCmd_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,11),_FsL2VpnPwRedGroupAdminCmd_Type())
...
fsL2VpnPwRedGroupAdminActivePw=_FsL2VpnPwRedGroupAdminActivePw_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,12),_FsL2VpnPwRedGroupAdminActivePw_Type())
...
fsL2VpnPwRedGroupAdminCmdStatus=_FsL2VpnPwRedGroupAdminCmdStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,13),_FsL2VpnPwRedGroupAdminCmdStatus_Type())
...
fsL2VpnPwRedGroupRowStatus=_FsL2VpnPwRedGroupRowStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,1,1,14),_FsL2VpnPwRedGroupRowStatus_Type())
...
fsL2VpnPwRedNodeTable=_FsL2VpnPwRedNodeTable_Object((1,3,6,1,4,1,10876,101,2,72,4,2))
if mibBuilder.loadTexts:fsL2VpnPwRedNodeTable.setStatus(_A)
_FsL2VpnPwRedNodeEntry_Object=MibTableRow
fsL2VpnPwRedNodeEntry=_FsL2VpnPwRedNodeEntry_Object((1,3,6,1,4,1,10876,101,2,72,4,2,1))
fsL2VpnPwRedNodeEntry.setIndexNames((0,_B,_N),(0,_B,_f),(0,_B,_g))
...
fsL2VpnPwRedNodeAddrType=_FsL2VpnPwRedNodeAddrType_Object((1,3,6,1,4,1,10876,101,2,72,4,2,1,1),_FsL2VpnPwRedNodeAddrType_Type())
...
fsL2VpnPwRedNodeAddr=_FsL2VpnPwRedNodeAddr_Object((1,3,6,1,4,1,10876,101,2,72,4,2,1,2),_FsL2VpnPwRedNodeAddr_Type())
...
fsL2VpnPwRedNodeLocalLdpID=_FsL2VpnPwRedNodeLocalLdpID_Object((1,3,6,1,4,1,10876,101,2,72,4,2,1,3),_FsL2VpnPwRedNodeLocalLdpID_Type())
...
fsL2VpnPwRedNodeLocalLdpEntityIndex=_FsL2VpnPwRedNodeLocalLdpEntityIndex_Object((1,3,6,1,4,1,10876,101,2,72,4,2,1,4),_FsL2VpnPwRedNodeLocalLdpEntityIndex_Type())
...
fsL2VpnPwRedNodePeerLdpID=_FsL2VpnPwRedNodePeerLdpID_Object((1,3,6,1,4,1,10876,101,2,72,4,2,1,5),_FsL2VpnPwRedNodePeerLdpID_Type())
...
fsL2VpnPwRedNodeStatus=_FsL2VpnPwRedNodeStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,2,1,6),_FsL2VpnPwRedNodeStatus_Type())
...
fsL2VpnPwRedNodeRowStatus=_FsL2VpnPwRedNodeRowStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,2,1,7),_FsL2VpnPwRedNodeRowStatus_Type())
...
fsL2VpnPwRedPwTable=_FsL2VpnPwRedPwTable_Object((1,3,6,1,4,1,10876,101,2,72,4,3))
if mibBuilder.loadTexts:fsL2VpnPwRedPwTable.setStatus(_A)
_FsL2VpnPwRedPwEntry_Object=MibTableRow
fsL2VpnPwRedPwEntry=_FsL2VpnPwRedPwEntry_Object((1,3,6,1,4,1,10876,101,2,72,4,3,1))
fsL2VpnPwRedPwEntry.setIndexNames((0,_B,_N),(0,_B,_h))
...
fsL2VpnPwRedPwIndex=_FsL2VpnPwRedPwIndex_Object((1,3,6,1,4,1,10876,101,2,72,4,3,1,1),_FsL2VpnPwRedPwIndex_Type())
...
fsL2VpnPwRedPwPreferance=_FsL2VpnPwRedPwPreferance_Object((1,3,6,1,4,1,10876,101,2,72,4,3,1,2),_FsL2VpnPwRedPwPreferance_Type())
...
fsL2VpnPwRedPwLocalStatus=_FsL2VpnPwRedPwLocalStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,3,1,3),_FsL2VpnPwRedPwLocalStatus_Type())
...
fsL2VpnPwRedPwRemoteStatus=_FsL2VpnPwRedPwRemoteStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,3,1,4),_FsL2VpnPwRedPwRemoteStatus_Type())
...
fsL2VpnPwRedPwOperStatus=_FsL2VpnPwRedPwOperStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,3,1,5),_FsL2VpnPwRedPwOperStatus_Type())
...
fsL2VpnPwRedPwRowStatus=_FsL2VpnPwRedPwRowStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,3,1,6),_FsL2VpnPwRedPwRowStatus_Type())
...
fsL2VpnPwRedIccpPwTable=_FsL2VpnPwRedIccpPwTable_Object((1,3,6,1,4,1,10876,101,2,72,4,4))
if mibBuilder.loadTexts:fsL2VpnPwRedIccpPwTable.setStatus(_A)
_FsL2VpnPwRedIccpPwEntry_Object=MibTableRow
fsL2VpnPwRedIccpPwEntry=_FsL2VpnPwRedIccpPwEntry_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1))
...
fsL2VpnPwRedIccpPwRgIndex=_FsL2VpnPwRedIccpPwRgIndex_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,1),_FsL2VpnPwRedIccpPwRgIndex_Type())
...
fsL2VpnPwRedIccpPwHeadLsr=_FsL2VpnPwRedIccpPwHeadLsr_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,2),_FsL2VpnPwRedIccpPwHeadLsr_Type())
...
fsL2VpnPwRedIccpPwFecType=_FsL2VpnPwRedIccpPwFecType_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,3),_FsL2VpnPwRedIccpPwFecType_Type())
...
fsL2VpnPwRedIccpPwTailLsr=_FsL2VpnPwRedIccpPwTailLsr_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,4),_FsL2VpnPwRedIccpPwTailLsr_Type())
...
fsL2VpnPwRedIccpPwGroup=_FsL2VpnPwRedIccpPwGroup_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,5),_FsL2VpnPwRedIccpPwGroup_Type())
...
fsL2VpnPwRedIccpPwId=_FsL2VpnPwRedIccpPwId_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,6),_FsL2VpnPwRedIccpPwId_Type())
...
fsL2VpnPwRedIccpPwAgiType=_FsL2VpnPwRedIccpPwAgiType_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,7),_FsL2VpnPwRedIccpPwAgiType_Type())
...
fsL2VpnPwRedIccpPwAgi=_FsL2VpnPwRedIccpPwAgi_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,8),_FsL2VpnPwRedIccpPwAgi_Type())
...
fsL2VpnPwRedIccpPwLocalAiiType=_FsL2VpnPwRedIccpPwLocalAiiType_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,9),_FsL2VpnPwRedIccpPwLocalAiiType_Type())
...
fsL2VpnPwRedIccpPwLocalAii=_FsL2VpnPwRedIccpPwLocalAii_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,10),_FsL2VpnPwRedIccpPwLocalAii_Type())
...
fsL2VpnPwRedIccpPwRemoteAiiType=_FsL2VpnPwRedIccpPwRemoteAiiType_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,11),_FsL2VpnPwRedIccpPwRemoteAiiType_Type())
...
fsL2VpnPwRedIccpPwRemoteAii=_FsL2VpnPwRedIccpPwRemoteAii_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,12),_FsL2VpnPwRedIccpPwRemoteAii_Type())
...
fsL2VpnPwRedIccpPwRoId=_FsL2VpnPwRedIccpPwRoId_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,13),_FsL2VpnPwRedIccpPwRoId_Type())
...
fsL2VpnPwRedIccpPwPriority=_FsL2VpnPwRedIccpPwPriority_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,14),_FsL2VpnPwRedIccpPwPriority_Type())
...
fsL2VpnPwRedIccpPwStatus=_FsL2VpnPwRedIccpPwStatus_Object((1,3,6,1,4,1,10876,101,2,72,4,4,1,15),_FsL2VpnPwRedIccpPwStatus_Type())
...
fsL2VpnPwRedTestObjects=_FsL2VpnPwRedTestObjects_ObjectIdentity((1,3,6,1,4,1,10876,101,2,72,4,5))
...
fsL2VpnPwRedSimulateFailure=_FsL2VpnPwRedSimulateFailure_Object((1,3,6,1,4,1,10876,101,2,72,4,5,1),_FsL2VpnPwRedSimulateFailure_Type())
...
fsL2VpnPwRedSimulateFailureForNbr=_FsL2VpnPwRedSimulateFailureForNbr_Object((1,3,6,1,4,1,10876,101,2,72,4,5,2),_FsL2VpnPwRedSimulateFailureForNbr_Type())
fsL2VpnPwRedSimulateFailureForNbr.setMaxAccess(_H)
if mibBuilder.loadTexts:fsL2VpnPwRedSimulateFailureForNbr.setStatus(_A)
vplsGroup=ObjectGroup((1,3,6,1,4,1,10876,101,2,72,2,2,1))
vplsGroup.setObjects(*((_B,_u),(_B,_v),(_B,_T),(_B,_w),(_B,_x),(_B,_y),(_B,_M),(_B,_O),(_B,_P),(_B,_z),(_B,_A0),(_B,_A1),(_B,_A2),(_B,_A3),(_B,_U),(_B,_A4),(_B,_A5),(_B,_A6)))
if mibBuilder.loadTexts:vplsGroup.setStatus(_A)
vplsPwBindGroup=ObjectGroup((1,3,6,1,4,1,10876,101,2,72,2,2,2))
vplsPwBindGroup.setObjects(*((_B,_A7),(_B,_A8),(_B,_A9),(_B,_AA)))
if mibBuilder.loadTexts:vplsPwBindGroup.setStatus(_A)
vplsStatusChanged=NotificationType((1,3,6,1,4,1,10876,101,2,72,0,1))
vplsStatusChanged.setObjects(*((_B,_M),(_B,_T),(_B,_U)))
if mibBuilder.loadTexts:vplsStatusChanged.setStatus(_A)
vplsFwdFullAlarmRaised=NotificationType((1,3,6,1,4,1,10876,101,2,72,0,2))
vplsFwdFullAlarmRaised.setObjects(*((_B,_M),(_B,_O),(_B,_P)))
if mibBuilder.loadTexts:vplsFwdFullAlarmRaised.setStatus(_A)
vplsFwdFullAlarmCleared=NotificationType((1,3,6,1,4,1,10876,101,2,72,0,3))
vplsFwdFullAlarmCleared.setObjects(*((_B,_M),(_B,_O),(_B,_P)))
if mibBuilder.loadTexts:vplsFwdFullAlarmCleared.setStatus(_A)
fsL2VpnPwRedSyncFail=NotificationType((1,3,6,1,4,1,10876,101,2,72,4,0,1))
fsL2VpnPwRedSyncFail.setObjects(*((_B,_AB),(_B,_AC)))
if mibBuilder.loadTexts:fsL2VpnPwRedSyncFail.setStatus(_A)
fsL2VpnPwRedPwStatus=NotificationType((1,3,6,1,4,1,10876,101,2,72,4,0,2))
fsL2VpnPwRedPwStatus.setObjects(*((_B,_AD),(_B,_AE)))
if mibBuilder.loadTexts:fsL2VpnPwRedPwStatus.setStatus(_A)
vplsNotificationGroup=NotificationGroup((1,3,6,1,4,1,10876,101,2,72,2,2,3))
vplsNotificationGroup.setObjects(*((_B,_AF),(_B,_AG),(_B,_AH)))
if mibBuilder.loadTexts:vplsNotificationGroup.setStatus(_A)
vplsModuleFullCompliance=ModuleCompliance((1,3,6,1,4,1,10876,101,2,72,2,1,1))
vplsModuleFullCompliance.setObjects(*((_B,_V),(_B,_W),(_B,_X)))
if mibBuilder.loadTexts:vplsModuleFullCompliance.setStatus(_A)
vplsModuleReadOnlyCompliance=ModuleCompliance((1,3,6,1,4,1,10876,101,2,72,2,1,2))
