# SNMP MIB module (SUPERMICRO-L2VPN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/supermicro/SUPERMICRO-L2VPN-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:04:13 2025
...
vplsConfigIndex = _VplsConfigIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 1),
...
vplsConfigName = _VplsConfigName_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 2),
...
vplsConfigDescr = _VplsConfigDescr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 3),
...
vplsConfigAdminStatus = _VplsConfigAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 4),
...
vplsConfigMacLearning = _VplsConfigMacLearning_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 6),
...
vplsConfigDiscardUnknownDest = _VplsConfigDiscardUnknownDest_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 7),
...
vplsConfigMacAging = _VplsConfigMacAging_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 8),
...
vplsConfigFwdFullHighWatermark = _VplsConfigFwdFullHighWatermark_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 10),
...
vplsConfigFwdFullLowWatermark = _VplsConfigFwdFullLowWatermark_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 11),
...
vplsConfigRowStatus = _VplsConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 12),
...
vplsConfigMtu = _VplsConfigMtu_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 13),
    _VplsConfigMtu_Type()
)
...
vplsConfigVpnId = _VplsConfigVpnId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 14),
...
vplsConfigServiceType = _VplsConfigServiceType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 15),
...
vplsConfigStorageType = _VplsConfigStorageType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 2, 1, 16),
...
vplsStatusOperStatus = _VplsStatusOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 3, 1, 1),
...
vplsStatusPeerCount = _VplsStatusPeerCount_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 3, 1, 2),
...
vplsPwBindConfigType = _VplsPwBindConfigType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 4, 1, 1),
...
vplsPwBindType = _VplsPwBindType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 4, 1, 2),
...
vplsPwBindRowStatus = _VplsPwBindRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 4, 1, 3),
...
vplsPwBindStorageType = _VplsPwBindStorageType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 4, 1, 4),
...
vplsBgpADConfigTable = _VplsBgpADConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 5)
)
if mibBuilder.loadTexts:
...
vplsBgpADConfigEntry = _VplsBgpADConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 5, 1)
)
...
vplsBgpADConfigRouteDistinguisher = _VplsBgpADConfigRouteDistinguisher_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 5, 1, 1),
...
vplsBgpADConfigPrefix = _VplsBgpADConfigPrefix_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 5, 1, 2),
...
vplsBgpADConfigVplsId = _VplsBgpADConfigVplsId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 5, 1, 3),
...
vplsBgpADConfigRowStatus = _VplsBgpADConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 5, 1, 4),
...
vplsBgpRteTargetTable = _VplsBgpRteTargetTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 6)
)
if mibBuilder.loadTexts:
...
vplsBgpRteTargetEntry = _VplsBgpRteTargetEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 6, 1)
)
vplsBgpRteTargetEntry.setIndexNames(
    (0, "SUPERMICRO-L2VPN-MIB", "vplsConfigIndex"),
    (0, "SUPERMICRO-L2VPN-MIB", "vplsBgpRteTargetIndex"),
)
if mibBuilder.loadTexts:
...
vplsBgpRteTargetIndex = _VplsBgpRteTargetIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 6, 1, 1),
...
vplsBgpRteTargetRTType = _VplsBgpRteTargetRTType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 6, 1, 2),
...
vplsBgpRteTargetRT = _VplsBgpRteTargetRT_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 6, 1, 3),
...
vplsBgpRteTargetRTRowStatus = _VplsBgpRteTargetRTRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 6, 1, 4),
...
vplsStatusNotifEnable = _VplsStatusNotifEnable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 7),
...
vplsNotificationMaxRate = _VplsNotificationMaxRate_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 1, 8),
...
vplsGroups = _VplsGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 2, 2)
)
...
fsL2VpnPwRedundancyPwStatusNotifyEnable = _FsL2VpnPwRedundancyPwStatusNotifyEnable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 3, 4),
...
fsL2VpnPwRedGroupEntry = _FsL2VpnPwRedGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1)
)
fsL2VpnPwRedGroupEntry.setIndexNames(
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedGroupIndex"),
)
if mibBuilder.loadTexts:
...
fsL2VpnPwRedGroupIndex = _FsL2VpnPwRedGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 1),
...
fsL2VpnPwRedGroupProtType = _FsL2VpnPwRedGroupProtType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 2),
...
fsL2VpnPwRedGroupDualHomeApps = _FsL2VpnPwRedGroupDualHomeApps_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 6),
...
fsL2VpnPwRedGroupName = _FsL2VpnPwRedGroupName_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 7),
...
fsL2VpnPwRedGroupStatus = _FsL2VpnPwRedGroupStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 8),
...
fsL2VpnPwRedGroupOperActivePw = _FsL2VpnPwRedGroupOperActivePw_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 9),
...
fsL2VpnPwRedGroupWtrTimer = _FsL2VpnPwRedGroupWtrTimer_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 10),
...
fsL2VpnPwRedGroupAdminCmd = _FsL2VpnPwRedGroupAdminCmd_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 11),
...
fsL2VpnPwRedGroupAdminActivePw = _FsL2VpnPwRedGroupAdminActivePw_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 12),
...
fsL2VpnPwRedGroupAdminCmdStatus = _FsL2VpnPwRedGroupAdminCmdStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 13),
...
fsL2VpnPwRedGroupRowStatus = _FsL2VpnPwRedGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 1, 1, 14),
...
fsL2VpnPwRedNodeTable = _FsL2VpnPwRedNodeTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 2)
)
if mibBuilder.loadTexts:
...
fsL2VpnPwRedNodeEntry = _FsL2VpnPwRedNodeEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 2, 1)
)
fsL2VpnPwRedNodeEntry.setIndexNames(
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedGroupIndex"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedNodeAddrType"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedNodeAddr"),
)
if mibBuilder.loadTexts:
...
fsL2VpnPwRedNodeAddrType = _FsL2VpnPwRedNodeAddrType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 2, 1, 1),
...
fsL2VpnPwRedNodeAddr = _FsL2VpnPwRedNodeAddr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 2, 1, 2),
...
fsL2VpnPwRedNodeLocalLdpID = _FsL2VpnPwRedNodeLocalLdpID_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 2, 1, 3),
...
fsL2VpnPwRedNodeLocalLdpEntityIndex = _FsL2VpnPwRedNodeLocalLdpEntityIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 2, 1, 4),
...
fsL2VpnPwRedNodePeerLdpID = _FsL2VpnPwRedNodePeerLdpID_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 2, 1, 5),
...
fsL2VpnPwRedNodeStatus = _FsL2VpnPwRedNodeStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 2, 1, 6),
...
fsL2VpnPwRedNodeRowStatus = _FsL2VpnPwRedNodeRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 2, 1, 7),
...
fsL2VpnPwRedPwTable = _FsL2VpnPwRedPwTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 3)
)
if mibBuilder.loadTexts:
...
fsL2VpnPwRedPwEntry = _FsL2VpnPwRedPwEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 3, 1)
)
fsL2VpnPwRedPwEntry.setIndexNames(
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedGroupIndex"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedPwIndex"),
)
if mibBuilder.loadTexts:
...
fsL2VpnPwRedPwIndex = _FsL2VpnPwRedPwIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 3, 1, 1),
...
fsL2VpnPwRedPwPreferance = _FsL2VpnPwRedPwPreferance_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 3, 1, 2),
...
fsL2VpnPwRedPwLocalStatus = _FsL2VpnPwRedPwLocalStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 3, 1, 3),
...
fsL2VpnPwRedPwRemoteStatus = _FsL2VpnPwRedPwRemoteStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 3, 1, 4),
...
fsL2VpnPwRedPwRowStatus = _FsL2VpnPwRedPwRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 3, 1, 6),
...
fsL2VpnPwRedIccpPwTable = _FsL2VpnPwRedIccpPwTable_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4)
)
if mibBuilder.loadTexts:
...
fsL2VpnPwRedIccpPwEntry = _FsL2VpnPwRedIccpPwEntry_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1)
)
fsL2VpnPwRedIccpPwEntry.setIndexNames(
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwRgIndex"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwHeadLsr"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwFecType"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwTailLsr"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwGroup"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwId"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwAgiType"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwAgi"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwLocalAiiType"),
    (0, "SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedIccpPwLocalAii"),
...
fsL2VpnPwRedIccpPwRgIndex = _FsL2VpnPwRedIccpPwRgIndex_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 1),
...
fsL2VpnPwRedIccpPwHeadLsr = _FsL2VpnPwRedIccpPwHeadLsr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 2),
...
fsL2VpnPwRedIccpPwFecType = _FsL2VpnPwRedIccpPwFecType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 3),
...
fsL2VpnPwRedIccpPwTailLsr = _FsL2VpnPwRedIccpPwTailLsr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 4),
...
fsL2VpnPwRedIccpPwGroup = _FsL2VpnPwRedIccpPwGroup_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 5),
...
fsL2VpnPwRedIccpPwId = _FsL2VpnPwRedIccpPwId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 6),
...
fsL2VpnPwRedIccpPwAgiType = _FsL2VpnPwRedIccpPwAgiType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 7),
...
fsL2VpnPwRedIccpPwAgi = _FsL2VpnPwRedIccpPwAgi_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 8),
...
fsL2VpnPwRedIccpPwLocalAiiType = _FsL2VpnPwRedIccpPwLocalAiiType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 9),
...
fsL2VpnPwRedIccpPwLocalAii = _FsL2VpnPwRedIccpPwLocalAii_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 10),
...
fsL2VpnPwRedIccpPwRemoteAiiType = _FsL2VpnPwRedIccpPwRemoteAiiType_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 11),
...
fsL2VpnPwRedIccpPwRemoteAii = _FsL2VpnPwRedIccpPwRemoteAii_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 12),
...
fsL2VpnPwRedIccpPwRoId = _FsL2VpnPwRedIccpPwRoId_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 13),
...
fsL2VpnPwRedIccpPwPriority = _FsL2VpnPwRedIccpPwPriority_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 14),
...
fsL2VpnPwRedIccpPwStatus = _FsL2VpnPwRedIccpPwStatus_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 4, 1, 15),
...
fsL2VpnPwRedTestObjects = _FsL2VpnPwRedTestObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 5)
)
...
fsL2VpnPwRedSimulateFailure = _FsL2VpnPwRedSimulateFailure_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 5, 1),
...
fsL2VpnPwRedSimulateFailureForNbr = _FsL2VpnPwRedSimulateFailureForNbr_Object(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 5, 2),
...
vplsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 2, 2, 1)
)
vplsGroup.setObjects(
      *(("SUPERMICRO-L2VPN-MIB", "vplsConfigName"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigDescr"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigAdminStatus"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigMacLearning"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigDiscardUnknownDest"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigMacAging"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigVpnId"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigFwdFullHighWatermark"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigFwdFullLowWatermark"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigRowStatus"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigIndexNext"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigMtu"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigServiceType"),
        ("SUPERMICRO-L2VPN-MIB", "vplsConfigStorageType"),
        ("SUPERMICRO-L2VPN-MIB", "vplsStatusOperStatus"),
        ("SUPERMICRO-L2VPN-MIB", "vplsStatusPeerCount"),
        ("SUPERMICRO-L2VPN-MIB", "vplsStatusNotifEnable"),
        ("SUPERMICRO-L2VPN-MIB", "vplsNotificationMaxRate"))
)
if mibBuilder.loadTexts:
    vplsGroup.setStatus("current")

vplsPwBindGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 2, 2, 2)
)
vplsPwBindGroup.setObjects(
      *(("SUPERMICRO-L2VPN-MIB", "vplsPwBindConfigType"),
        ("SUPERMICRO-L2VPN-MIB", "vplsPwBindType"),
        ("SUPERMICRO-L2VPN-MIB", "vplsPwBindRowStatus"),
        ("SUPERMICRO-L2VPN-MIB", "vplsPwBindStorageType"))
)
if mibBuilder.loadTexts:
...
vplsStatusChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 0, 1)
)
...
vplsFwdFullAlarmRaised = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 0, 2)
)
...
vplsFwdFullAlarmCleared = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 0, 3)
)
...
fsL2VpnPwRedSyncFail = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 0, 1)
)
fsL2VpnPwRedSyncFail.setObjects(
      *(("SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedGroupAdminActivePw"),
        ("SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedGroupOperActivePw"))
)
if mibBuilder.loadTexts:
...
fsL2VpnPwRedPwStatus = NotificationType(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 4, 0, 2)
)
fsL2VpnPwRedPwStatus.setObjects(
      *(("SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedPwLocalStatus"),
        ("SUPERMICRO-L2VPN-MIB", "fsL2VpnPwRedPwRemoteStatus"))
)
if mibBuilder.loadTexts:
...
vplsNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 2, 2, 3)
)
vplsNotificationGroup.setObjects(
      *(("SUPERMICRO-L2VPN-MIB", "vplsStatusChanged"),
        ("SUPERMICRO-L2VPN-MIB", "vplsFwdFullAlarmRaised"),
        ("SUPERMICRO-L2VPN-MIB", "vplsFwdFullAlarmCleared"))
)
if mibBuilder.loadTexts:
...
vplsModuleFullCompliance.setObjects(
      *(("SUPERMICRO-L2VPN-MIB", "vplsGroup"),
        ("SUPERMICRO-L2VPN-MIB", "vplsPwBindGroup"),
        ("SUPERMICRO-L2VPN-MIB", "vplsNotificationGroup"))
)
if mibBuilder.loadTexts:
...
vplsModuleReadOnlyCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 10876, 101, 2, 72, 2, 1, 2)
)
