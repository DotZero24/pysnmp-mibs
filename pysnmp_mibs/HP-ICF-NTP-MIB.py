...
mibBuilder.exportSymbols("HP-ICF-NTP-MIB", hpicfNtpStatusReferenceTimeFrac=hpicfNtpStatusReferenceTimeFrac, hpicfNtpConfigCompliances=hpicfNtpConfigCompliances, hpicfNtpAssoOriginTimeSec=hpicfNtpAssoOriginTimeSec, hpicfNtpAuthenticationKeyTable=hpicfNtpAuthenticationKeyTable, hpicfNtpStatusReferenceTimeSec=hpicfNtpStatusReferenceTimeSec, hpicfNtpInetConfigServerTable=hpicfNtpInetConfigServerTable, hpicfNtpServerNameResolvAddress=hpicfNtpServerNameResolvAddress, hpicfNtpInetServerNameRowStatus=hpicfNtpInetServerNameRowStatus, hpicfNtpAssociationSampleGroup=hpicfNtpAssociationSampleGroup, hpicfNtpInetServerAddress=hpicfNtpInetServerAddress, hpicfNtpInetServerInfoTable=hpicfNtpInetServerInfoTable, hpicfNtpAssoXmtTimeSec=hpicfNtpAssoXmtTimeSec, hpicfNtpfiltDelaySample=hpicfNtpfiltDelaySample, hpicfNtpStatusRootDispersion=hpicfNtpStatusRootDispersion, hpicfNtpConfigMode=hpicfNtpConfigMode, hpicfNtpServerNameCfgCompliance=hpicfNtpServerNameCfgCompliance, hpicfNtpAuthenticationKeyValue=hpicfNtpAuthenticationKeyValue, hpicfNtpConfigConformance=hpicfNtpConfigConformance, hpicfNtpServerNameResolvAddType=hpicfNtpServerNameResolvAddType, hpicfNtpAuthenticationConfigCompliance=hpicfNtpAuthenticationConfigCompliance, hpicfNtpServerNameAssoBurst=hpicfNtpServerNameAssoBurst, hpicfNtpConfig=hpicfNtpConfig, hpicfNtpAssoDrift=hpicfNtpAssoDrift, hpicfNtpConfigScalars=hpicfNtpConfigScalars, hpicfNtpInetConfigCompliance=hpicfNtpInetConfigCompliance, hpicfNtpStatusRootDelay=hpicfNtpStatusRootDelay, hpicfNtpInetServerName=hpicfNtpInetServerName, hpicfNtpAssoPeerReach=hpicfNtpAssoPeerReach, hpicfNtpGlobal=hpicfNtpGlobal, hpicfNtpAuthenticationKeyEncrypted=hpicfNtpAuthenticationKeyEncrypted, hpicfNtpAssoSampleId=hpicfNtpAssoSampleId, hpicfNtpAssolastPollreq=hpicfNtpAssolastPollreq, hpicfNtpServerNameAssoIsOobm=hpicfNtpServerNameAssoIsOobm, hpicfNtpAssoCurrentMode=hpicfNtpAssoCurrentMode, hpicfNtpStatusClockOffset=hpicfNtpStatusClockOffset, hpicfNtpAssoRootDelay=hpicfNtpAssoRootDelay, hpicfNtpAssoOurPollInterval=hpicfNtpAssoOurPollInterval, hpicfNtpMIB=hpicfNtpMIB, hpicfNtpInetServerNameTable=hpicfNtpInetServerNameTable, hpicfNtpInetServerNameAuthKeyId=hpicfNtpInetServerNameAuthKeyId, hpicfNtpAuthenticationKeyId=hpicfNtpAuthenticationKeyId, hpicfNtpAuthenticationKeyIdConfigGroup=hpicfNtpAuthenticationKeyIdConfigGroup, hpicfNtpAuthenticationKeyRowStatus=hpicfNtpAuthenticationKeyRowStatus, hpicfNtpServerConfigCompliance=hpicfNtpServerConfigCompliance, hpicfNtpConfigServerNamePollMinInterval=hpicfNtpConfigServerNamePollMinInterval, hpicfNtpAssoBurst=hpicfNtpAssoBurst, hpicfNtpAssoSampleEntry=hpicfNtpAssoSampleEntry, hpicfNtpInetServerNameCfgGroup=hpicfNtpInetServerNameCfgGroup, hpicfNtpConfigGroups=hpicfNtpConfigGroups, hpicfNtpAssoRecvTimeFrac=hpicfNtpAssoRecvTimeFrac, hpicfNtpAssoRootDispersion=hpicfNtpAssoRootDispersion, hpicfNtpConfigPollMaxInterval=hpicfNtpConfigPollMaxInterval, hpicfNtpAssoRecvTimeSec=hpicfNtpAssoRecvTimeSec, hpicfNtpInetServerConfigGroup=hpicfNtpInetServerConfigGroup, hpicfNtpInetServerRowStatus=hpicfNtpInetServerRowStatus, hpicfNtpInetServerAuthKeyId=hpicfNtpInetServerAuthKeyId, hpicfNtpAssoPeerDispersion=hpicfNtpAssoPeerDispersion, hpicfNtpInetServerAddressType=hpicfNtpInetServerAddressType, hpicfNtpAuthenticationKeyAuthMode=hpicfNtpAuthenticationKeyAuthMode, hpicfNtpAuthenticationKeyTrusted=hpicfNtpAuthenticationKeyTrusted, hpicfNtpAssoXmtTimeFrac=hpicfNtpAssoXmtTimeFrac, hpicfNtpInetServerInfoEntry=hpicfNtpInetServerInfoEntry, hpicfNtpInetConfigServerEntry=hpicfNtpInetConfigServerEntry, hpicfNtpAssoSampleTable=hpicfNtpAssoSampleTable, hpicfNtpAssoPrecision=hpicfNtpAssoPrecision, hpicfNtpAuthenticationKeyEntry=hpicfNtpAuthenticationKeyEntry, hpicfNtpServerNameIndex=hpicfNtpServerNameIndex, hpicfNtpAssoPeerPollInterval=hpicfNtpAssoPeerPollInterval, hpicfNtpConfigPollMinInterval=hpicfNtpConfigPollMinInterval, hpicfNtpIpv6MulticastTable=hpicfNtpIpv6MulticastTable, hpicfNtpAssoSampleCompliance=hpicfNtpAssoSampleCompliance, hpicfNtpfiltOffsetSample=hpicfNtpfiltOffsetSample, hpicfNtpIpv6MulticastEntry=hpicfNtpIpv6MulticastEntry, hpicfNtpIpv6MulticastStatus=hpicfNtpIpv6MulticastStatus, hpicfNtpMaxAssociation=hpicfNtpMaxAssociation, PYSNMP_MODULE_ID=hpicfNtpMIB, hpicfNtpAssoIsOobm=hpicfNtpAssoIsOobm, hpicfNtpConfigGroup=hpicfNtpConfigGroup, hpicfNtpAssoOriginTimeFrac=hpicfNtpAssoOriginTimeFrac, hpicfNtpServerNameResolveStatus=hpicfNtpServerNameResolveStatus, hpicfNtpConfigServerNamePollMaxInterval=hpicfNtpConfigServerNamePollMaxInterval, hpicfNtpInetServerNameEntry=hpicfNtpInetServerNameEntry, hpicfNtpAdminStatus=hpicfNtpAdminStatus, hpicfNtpIpv6Multicast=hpicfNtpIpv6Multicast)
