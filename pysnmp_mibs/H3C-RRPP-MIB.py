...
if mibBuilder.loadTexts:h3cRrpp.setRevisions(('2016-01-26 00:00',))
...
h3cRrppScalarGroup=_H3cRrppScalarGroup_ObjectIdentity((1,3,6,1,4,1,2011,10,2,45,1))
_H3cRrppEnableStatus_Type=EnabledStatus
_H3cRrppEnableStatus_Object=MibScalar
h3cRrppEnableStatus=_H3cRrppEnableStatus_Object((1,3,6,1,4,1,2011,10,2,45,1,1),_H3cRrppEnableStatus_Type())
...
h3cRrppPassword=_H3cRrppPassword_Object((1,3,6,1,4,1,2011,10,2,45,1,2),_H3cRrppPassword_Type())
...
h3cRrppPasswordType=_H3cRrppPasswordType_Object((1,3,6,1,4,1,2011,10,2,45,1,3),_H3cRrppPasswordType_Type())
...
h3cRrppProtectVlanConfigMode=_H3cRrppProtectVlanConfigMode_Object((1,3,6,1,4,1,2011,10,2,45,1,4),_H3cRrppProtectVlanConfigMode_Type())
...
h3cRrppTable=_H3cRrppTable_ObjectIdentity((1,3,6,1,4,1,2011,10,2,45,2))
_H3cRrppDomainTable_Object=MibTable
h3cRrppDomainTable=_H3cRrppDomainTable_Object((1,3,6,1,4,1,2011,10,2,45,2,1))
if mibBuilder.loadTexts:h3cRrppDomainTable.setStatus(_A)
_H3cRrppDomainEntry_Object=MibTableRow
h3cRrppDomainEntry=_H3cRrppDomainEntry_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1))
h3cRrppDomainEntry.setIndexNames((0,_C,_F))
if mibBuilder.loadTexts:h3cRrppDomainEntry.setStatus(_A)
class _H3cRrppDomainID_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,128))
_H3cRrppDomainID_Type.__name__=_D
_H3cRrppDomainID_Object=MibTableColumn
h3cRrppDomainID=_H3cRrppDomainID_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1,1),_H3cRrppDomainID_Type())
...
h3cRrppDomainControlVlanID=_H3cRrppDomainControlVlanID_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1,2),_H3cRrppDomainControlVlanID_Type())
...
h3cRrppDomainHelloTime=_H3cRrppDomainHelloTime_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1,3),_H3cRrppDomainHelloTime_Type())
...
h3cRrppDomainFailTime=_H3cRrppDomainFailTime_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1,4),_H3cRrppDomainFailTime_Type())
...
h3cRrppDomainRowStatus=_H3cRrppDomainRowStatus_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1,5),_H3cRrppDomainRowStatus_Type())
...
h3cRrppDomainInstanceListLow=_H3cRrppDomainInstanceListLow_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1,6),_H3cRrppDomainInstanceListLow_Type())
...
h3cRrppDomainInstanceListHigh=_H3cRrppDomainInstanceListHigh_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1,7),_H3cRrppDomainInstanceListHigh_Type())
...
h3cRrppDomainProtectVlanListLow=_H3cRrppDomainProtectVlanListLow_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1,8),_H3cRrppDomainProtectVlanListLow_Type())
...
h3cRrppDomainProtectVlanListHigh=_H3cRrppDomainProtectVlanListHigh_Object((1,3,6,1,4,1,2011,10,2,45,2,1,1,9),_H3cRrppDomainProtectVlanListHigh_Type())
...
h3cRrppRingTable=_H3cRrppRingTable_Object((1,3,6,1,4,1,2011,10,2,45,2,2))
if mibBuilder.loadTexts:h3cRrppRingTable.setStatus(_A)
_H3cRrppRingEntry_Object=MibTableRow
h3cRrppRingEntry=_H3cRrppRingEntry_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1))
h3cRrppRingEntry.setIndexNames((0,_C,_F),(0,_C,_G))
if mibBuilder.loadTexts:h3cRrppRingEntry.setStatus(_A)
class _H3cRrppRingID_Type(Integer32):subtypeSpec=Integer32.subtypeSpec;subtypeSpec+=ConstraintsUnion(ValueRangeConstraint(1,128))
_H3cRrppRingID_Type.__name__=_D
_H3cRrppRingID_Object=MibTableColumn
h3cRrppRingID=_H3cRrppRingID_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1,1),_H3cRrppRingID_Type())
...
h3cRrppRingEnableStatus=_H3cRrppRingEnableStatus_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1,2),_H3cRrppRingEnableStatus_Type())
...
h3cRrppRingActive=_H3cRrppRingActive_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1,3),_H3cRrppRingActive_Type())
...
h3cRrppRingState=_H3cRrppRingState_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1,4),_H3cRrppRingState_Type())
...
h3cRrppRingNodeMode=_H3cRrppRingNodeMode_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1,5),_H3cRrppRingNodeMode_Type())
...
h3cRrppRingPrimaryPort=_H3cRrppRingPrimaryPort_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1,6),_H3cRrppRingPrimaryPort_Type())
...
h3cRrppRingSecondaryPort=_H3cRrppRingSecondaryPort_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1,7),_H3cRrppRingSecondaryPort_Type())
...
h3cRrppRingLevel=_H3cRrppRingLevel_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1,8),_H3cRrppRingLevel_Type())
...
h3cRrppRingRowStatus=_H3cRrppRingRowStatus_Object((1,3,6,1,4,1,2011,10,2,45,2,2,1,9),_H3cRrppRingRowStatus_Type())
...
h3cRrppPortTable=_H3cRrppPortTable_Object((1,3,6,1,4,1,2011,10,2,45,2,3))
if mibBuilder.loadTexts:h3cRrppPortTable.setStatus(_A)
_H3cRrppPortEntry_Object=MibTableRow
h3cRrppPortEntry=_H3cRrppPortEntry_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1))
...
h3cRrppPortID=_H3cRrppPortID_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,1),_H3cRrppPortID_Type())
...
h3cRrppPortRole=_H3cRrppPortRole_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,2),_H3cRrppPortRole_Type())
...
h3cRrppPortState=_H3cRrppPortState_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,3),_H3cRrppPortState_Type())
...
h3cRrppPortRXError=_H3cRrppPortRXError_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,4),_H3cRrppPortRXError_Type())
...
h3cRrppPortRXHello=_H3cRrppPortRXHello_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,5),_H3cRrppPortRXHello_Type())
...
h3cRrppPortRXLinkUp=_H3cRrppPortRXLinkUp_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,6),_H3cRrppPortRXLinkUp_Type())
...
h3cRrppPortRXLinkDown=_H3cRrppPortRXLinkDown_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,7),_H3cRrppPortRXLinkDown_Type())
...
h3cRrppPortRXCommonFlush=_H3cRrppPortRXCommonFlush_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,8),_H3cRrppPortRXCommonFlush_Type())
...
h3cRrppPortRXCompleteFlush=_H3cRrppPortRXCompleteFlush_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,9),_H3cRrppPortRXCompleteFlush_Type())
...
h3cRrppPortTXHello=_H3cRrppPortTXHello_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,10),_H3cRrppPortTXHello_Type())
...
h3cRrppPortTXLinkUp=_H3cRrppPortTXLinkUp_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,11),_H3cRrppPortTXLinkUp_Type())
...
h3cRrppPortTXLinkDown=_H3cRrppPortTXLinkDown_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,12),_H3cRrppPortTXLinkDown_Type())
...
h3cRrppPortTXCommonFlush=_H3cRrppPortTXCommonFlush_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,13),_H3cRrppPortTXCommonFlush_Type())
...
h3cRrppPortTXCompleteFlush=_H3cRrppPortTXCompleteFlush_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,14),_H3cRrppPortTXCompleteFlush_Type())
...
h3cRrppPortRXEdgeHello=_H3cRrppPortRXEdgeHello_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,15),_H3cRrppPortRXEdgeHello_Type())
...
h3cRrppPortRXMajorFault=_H3cRrppPortRXMajorFault_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,16),_H3cRrppPortRXMajorFault_Type())
...
h3cRrppPortTXEdgeHello=_H3cRrppPortTXEdgeHello_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,17),_H3cRrppPortTXEdgeHello_Type())
...
h3cRrppPortTXMajorFault=_H3cRrppPortTXMajorFault_Object((1,3,6,1,4,1,2011,10,2,45,2,3,1,18),_H3cRrppPortTXMajorFault_Type())
...
h3cRrppNotifications=_H3cRrppNotifications_ObjectIdentity((1,3,6,1,4,1,2011,10,2,45,3))
h3cRrppRingRecover=NotificationType((1,3,6,1,4,1,2011,10,2,45,3,1))
h3cRrppRingRecover.setObjects(*((_C,_F),(_C,_G)))
if mibBuilder.loadTexts:h3cRrppRingRecover.setStatus(_A)
h3cRrppRingFail=NotificationType((1,3,6,1,4,1,2011,10,2,45,3,2))
h3cRrppRingFail.setObjects(*((_C,_F),(_C,_G)))
if mibBuilder.loadTexts:h3cRrppRingFail.setStatus(_A)
h3cRrppMultiMaster=NotificationType((1,3,6,1,4,1,2011,10,2,45,3,3))
h3cRrppMultiMaster.setObjects(*((_C,_F),(_C,_G)))
if mibBuilder.loadTexts:h3cRrppMultiMaster.setStatus(_A)
h3cRrppMajorFault=NotificationType((1,3,6,1,4,1,2011,10,2,45,3,4))
