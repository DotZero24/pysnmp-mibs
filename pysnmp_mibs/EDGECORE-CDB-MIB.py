...
rlStartupCDBChanged=_RlStartupCDBChanged_Object((1,3,6,1,4,1,259,10,1,14,89,94,1),_RlStartupCDBChanged_Type())
...
rlManualReboot=_RlManualReboot_Object((1,3,6,1,4,1,259,10,1,14,89,94,2),_RlManualReboot_Type())
rlManualReboot.setMaxAccess(_A)
if mibBuilder.loadTexts:rlManualReboot.setStatus(_B)
mibBuilder.exportSymbols('EDGECORE-CDB-MIB',**{'rlCDB':rlCDB,'rlStartupCDBChanged':rlStartupCDBChanged,'rlManualReboot':rlManualReboot})