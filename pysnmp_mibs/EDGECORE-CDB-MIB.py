# SNMP MIB module (EDGECORE-CDB-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs/edgecore/EDGECORE-CDB-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 19:52:19 2025
...
rlStartupCDBChanged = _RlStartupCDBChanged_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 94, 1),
...
rlManualReboot = _RlManualReboot_Object(
    (1, 3, 6, 1, 4, 1, 259, 10, 1, 14, 89, 94, 2),
