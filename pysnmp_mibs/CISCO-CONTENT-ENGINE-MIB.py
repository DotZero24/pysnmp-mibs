...
# Notes
# -----
# ASN.1 source file://mibs/cisco/CISCO-CONTENT-ENGINE-MIB
# Produced by pysmi-1.6.2 at Fri Oct 10 20:31:41 2025
...
ciscoContentEngineMIBCompliance.setObjects(
      *(("CISCO-CONTENT-ENGINE-MIB", "cceHttpReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceHttpPerfGroup"))
)
if mibBuilder.loadTexts:
...
ciscoContentEngineMIBComplianceRev1.setObjects(
      *(("CISCO-CONTENT-ENGINE-MIB", "cceHttpReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceHttpPerfGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceCseReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceCseHCGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceCsePerfGroup"))
)
if mibBuilder.loadTexts:
...
ciscoContentEngineMIBComplianceRev2.setObjects(
      *(("CISCO-CONTENT-ENGINE-MIB", "cceHttpReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceHttpPerfGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceCseReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceCseHCGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceCsePerfGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceWmtReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceWmtPerfGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceWmtHCGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceRpReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceAlarmInfoGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceHttpHCReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceRpHCReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceNotificationGroupRev1"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceNotificationInfoGroup"))
)
if mibBuilder.loadTexts:
...
ciscoContentEngineMIBComplianceRev3.setObjects(
      *(("CISCO-CONTENT-ENGINE-MIB", "cceHttpReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceHttpPerfGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceCseReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceCseHCGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceCsePerfGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceWmtReqGroupRev1"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceWmtPerfGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceWmtHCGroupRev1"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceRpReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceAlarmInfoGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceHttpHCReqGroup"),
        ("CISCO-CONTENT-ENGINE-MIB", "cceRpHCReqGroup"),
